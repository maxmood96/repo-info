...
```console
$ docker pull nginx@sha256:ef20a491d1110a62f42dd421d14d20f0e90d1f9edd98ca739c30e737751b31e1
```
...
### `nginx:1.30.3-alpine3.23-slim` - linux; amd64
...
### `nginx:1.30.3-alpine3.23-slim` - unknown; unknown
...
### `nginx:1.30.3-alpine3.23-slim` - linux; arm variant v6
...
### `nginx:1.30.3-alpine3.23-slim` - linux; arm variant v7
...
### `nginx:1.30.3-alpine3.23-slim` - linux; arm64 variant v8
...
### `nginx:1.30.3-alpine3.23-slim` - linux; 386
...
### `nginx:1.30.3-alpine3.23-slim` - linux; ppc64le
...
### `nginx:1.30.3-alpine3.23-slim` - linux; s390x
