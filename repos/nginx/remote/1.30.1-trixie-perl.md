...
```console
$ docker pull nginx@sha256:648780c11f9bd1e8cf7d8139b0258125d1cf72ede65726d1d81c1465af694031
```
...
### `nginx:1.30.1-trixie-perl` - linux; amd64
...
### `nginx:1.30.1-trixie-perl` - unknown; unknown
...
### `nginx:1.30.1-trixie-perl` - linux; arm variant v5
...
### `nginx:1.30.1-trixie-perl` - linux; arm variant v7
...
### `nginx:1.30.1-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.30.1-trixie-perl` - linux; 386
...
### `nginx:1.30.1-trixie-perl` - linux; ppc64le
...
### `nginx:1.30.1-trixie-perl` - linux; s390x
