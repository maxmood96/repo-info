...
```console
$ docker pull nginx@sha256:4ce52b8130aea0b592feff31ee34fd3a0ddfa770815da4671cacaef8251574ba
```
...
### `nginx:1.21.1-alpine-perl` - linux; amd64
...
### `nginx:1.21.1-alpine-perl` - linux; arm variant v6
...
### `nginx:1.21.1-alpine-perl` - linux; arm variant v7
...
### `nginx:1.21.1-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.21.1-alpine-perl` - linux; ppc64le
...
### `nginx:1.21.1-alpine-perl` - linux; s390x
