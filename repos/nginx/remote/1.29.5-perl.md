...
```console
$ docker pull nginx@sha256:df2e86e886350edabacdcadbd3dc9243f6311b34c717f46b535ae8d07d2e3733
```
...
### `nginx:1.29.5-perl` - unknown; unknown
...
### `nginx:1.29.5-perl` - linux; arm variant v5
...
### `nginx:1.29.5-perl` - linux; arm variant v7
...
### `nginx:1.29.5-perl` - linux; arm64 variant v8
...
### `nginx:1.29.5-perl` - linux; ppc64le
