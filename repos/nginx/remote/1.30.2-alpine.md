...
```console
$ docker pull nginx@sha256:5c2df657831d8110a6f1dc333b33831c87abedf393658afa579edd28f8becf2b
```
...
### `nginx:1.30.2-alpine` - linux; amd64
...
### `nginx:1.30.2-alpine` - unknown; unknown
...
### `nginx:1.30.2-alpine` - linux; arm variant v6
...
### `nginx:1.30.2-alpine` - linux; arm variant v7
...
### `nginx:1.30.2-alpine` - linux; arm64 variant v8
...
### `nginx:1.30.2-alpine` - linux; ppc64le
...
### `nginx:1.30.2-alpine` - linux; s390x
