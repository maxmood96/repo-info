...
### `nginx:mainline-alpine3.21` - linux; amd64
...
### `nginx:mainline-alpine3.21` - unknown; unknown
...
### `nginx:mainline-alpine3.21` - linux; arm variant v6
...
### `nginx:mainline-alpine3.21` - linux; arm variant v7
...
### `nginx:mainline-alpine3.21` - linux; arm64 variant v8
...
### `nginx:mainline-alpine3.21` - linux; 386
...
### `nginx:mainline-alpine3.21` - linux; ppc64le
...
### `nginx:mainline-alpine3.21` - linux; riscv64
...
### `nginx:mainline-alpine3.21` - linux; s390x
