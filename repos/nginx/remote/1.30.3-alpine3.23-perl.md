...
```console
$ docker pull nginx@sha256:bdeedad4a6c03bef698113103e45f886484bb70af410c0f2731157a78c4e8be7
```
...
### `nginx:1.30.3-alpine3.23-perl` - linux; amd64
...
### `nginx:1.30.3-alpine3.23-perl` - unknown; unknown
...
### `nginx:1.30.3-alpine3.23-perl` - linux; arm variant v6
...
### `nginx:1.30.3-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.30.3-alpine3.23-perl` - linux; arm64 variant v8
...
### `nginx:1.30.3-alpine3.23-perl` - linux; 386
...
### `nginx:1.30.3-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.30.3-alpine3.23-perl` - linux; s390x
