...
### `nginx:1.31.1-perl` - unknown; unknown
...
### `nginx:1.31.1-perl` - linux; arm variant v5
...
### `nginx:1.31.1-perl` - linux; arm variant v7
...
### `nginx:1.31.1-perl` - linux; arm64 variant v8
...
### `nginx:1.31.1-perl` - linux; ppc64le
...
### `nginx:1.31.1-perl` - linux; riscv64
