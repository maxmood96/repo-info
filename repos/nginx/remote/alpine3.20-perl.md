...
```console
$ docker pull nginx@sha256:84f1f5335c5dd63496b9a796fc68cc918d5abc2722f71086049db7726862584f
```
...
```console
$ docker pull nginx@sha256:2f4506251d7e300e705b7d7084d12813e81eb614c664ffac5300def272835f47
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.2 MB (28200718 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4a64d24c6b8d962e8845d5c43f243ba46e1dfcda5b649db38bbfbb2696697d4`
...
-	Layers:
	...
	-	`sha256:35b039ba2bc54667ad0fdce04367ea93ed097b0506cda323e280e1ed31f29b31`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6e47a06bc3e9d7248700c8b1d314d95ec724afaf279237bc59a27720d7f25b1c`  
		Last Modified: Thu, 15 Aug 2024 20:50:05 GMT  
		Size: 9.6 MB (9623818 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:cb72532791a3866adcf0917343bb9c4fb05cd10e90305a7e1beaaa351eeaddbd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.7 MB (1734190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a65859a9dde153000394b122676caf33f7b3904544e71cc70ea05205b5b19c9f`

```dockerfile
```

-	Layers:
	-	`sha256:4151cdcfa81002407f2e99f19a243fba24d41667497521fe7a7f572c893daea0`  
		Last Modified: Thu, 15 Aug 2024 20:50:04 GMT  
		Size: 1.7 MB (1713266 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7f4fbba0913c352e0f082a11e1cb9598ac466f38f0804cf49ee93cee51b1a3dc`  
		Last Modified: Thu, 15 Aug 2024 20:50:04 GMT  
...
```console
$ docker pull nginx@sha256:3586795bbe35128e2df4d17a857d1b4f7547ba34ef36a1734c46ac1b09fc8fb1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.2 MB (25230409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35f324c14dc862ee740f060748bf9b4f2971839b4cdd81ad1681a9a5fefe3c7e`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:d95b3a9c96dcb1aefae4a462801de225108aa8cc2cbfe053f2972cb3226aa311`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c1576d75d254627ddb6ad80d6f8aad442a3de89b942ddc7c3f61bffea64b5030`  
		Last Modified: Thu, 15 Aug 2024 20:50:04 GMT  
		Size: 8.8 MB (8800298 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:e82639196de87cfd4c5b1905e3a7209d0234d234f3d127c99ea7d1d3c51ddae5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.8 KB (20841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0397d66d675db1da60eb87b245a5a81c368439b8d792e52122f86240a7cb47c`

```dockerfile
```

-	Layers:
	-	`sha256:1b8fe2eab68cc1b699d742f458bee1e084932ea3b3d28bd587b5def6f55e7285`  
		Last Modified: Thu, 15 Aug 2024 20:50:03 GMT  
...
```console
$ docker pull nginx@sha256:3ea6c8711749699d187eefdd7eb571407a81a5a31757783d2219bb4a9dbf3863
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.2 MB (25182081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3d505797ebf99515b27013edbe385abab9b4509fd46df5f3961b732ba72c03f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:fc7e93d6f7aeabedecc342faebdf62b65e1ce9fe83c242bfcfe83a4648e713c0`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:74a07a1d18875543a0557c41e4668b0827137aed9567400988fa7e7a8511ba4f`  
		Last Modified: Thu, 15 Aug 2024 20:50:20 GMT  
		Size: 8.6 MB (8625186 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:339db79d285e3073f44488e8ba7a0ec0b1a9a2b9a5c37fd877b9edad2ef4d20a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.7 MB (1737273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:896b54e186e56882ee7018f1eaf131eff9ea988ac5824d4c59abf3ff7681aa40`

```dockerfile
```

-	Layers:
	-	`sha256:56d4170e1f5136496e6f285786f3ff6d3012b1f7ca9ee74ec661c5c91c08f4a7`  
		Last Modified: Thu, 15 Aug 2024 20:50:20 GMT  
		Size: 1.7 MB (1716214 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b587c248ef290145fff71bc414dc4616b9f2205f52cbc6962057b6458ac2c6a3`  
...
```console
$ docker pull nginx@sha256:b2eb440f4ad33f41dc3d28dc4f5a49f02e910ac9062002323b0fdafc0f1d8cd9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.2 MB (29196378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae574bddf0f95b57067e69b8ab39dd332441b123b34c71d66e007a1227647018`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:19d4cc012d61e46b1580d554dba4494083d1ea8795e0baa076c3790d617a9c1d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:980041ff0644f0dd8bae1ee04f5665f89681c427d03552c4eab5eb87f8b9b15a`  
		Last Modified: Thu, 15 Aug 2024 20:49:51 GMT  
		Size: 9.6 MB (9592015 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:1a2dc7a96d1dff23df29839b0eaa14a39033e96539c0e4a556d2261df82d3af9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.7 MB (1734789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6a9071d3744f08613b56b893f90602676fb0e24f191414114ea53594c283af7`

```dockerfile
```

-	Layers:
	-	`sha256:d81fdfe5a3dcff8c3abb89c870def23b8db4af179b157189c15cf35dcdc0d7a4`  
		Last Modified: Thu, 15 Aug 2024 20:49:51 GMT  
		Size: 1.7 MB (1713396 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6cb65cffe210ce3255c9284fc780884487aa1c3d627eb5db68c65c8e7eb40077`  
		Last Modified: Thu, 15 Aug 2024 20:49:51 GMT  
...
```console
$ docker pull nginx@sha256:8b4e40905524087261f714c580c43863bbb908c3ad1b1026be00e714724f064e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.7 MB (26705678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ccabc63c7f2e29b1db7ab3839aa6b0cbf7b4c36f6b898f6def582308c41a992`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:7bf66fdce7d60e5e2aa10eeed8ec841664b7090be317f7bed019f59637584480`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:abbf959347241ade8c020fdabca9eedb306dfeede928292855739dd3cd0cb7c8`  
		Last Modified: Thu, 15 Aug 2024 21:49:51 GMT  
		Size: 9.1 MB (9064891 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:34ad5598d9d456d239d9f5fd8cd86b6e0bfb40a8b7d20fb2012919b004ea8451
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.7 MB (1734069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f75defb834b0cfa7b5fe1bfd1a65cfbe8f3e11c5f2c257039ede2688ed6edd19`

```dockerfile
```

-	Layers:
	-	`sha256:61f6e26683eed0cf9c746ca0cdd900e5d0e0fc7df84f2fd1a1efb66d595817ca`  
		Last Modified: Thu, 15 Aug 2024 21:49:50 GMT  
		Size: 1.7 MB (1713207 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0fa949a934674b4f0b114c5253e612cc7bd2381ea42dbdeca20518982a414b4f`  
		Last Modified: Thu, 15 Aug 2024 21:49:50 GMT  
...
```console
$ docker pull nginx@sha256:9e18de9b02ae54a4453611ca22ad60fbc4a9766f15808f1b9fcc61247b4d6c2a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.2 MB (29235034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d63ce74143d976b29c9fc9e4f84b05dcb5ad13562a8353f7561f4d47de187b79`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:9b8dad6734ed5ef0299fade13770f6357c00c31be81dc99c67900dc27e14e1b9`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:35bd67c0a0800f28b3e9122a9ca70e1b9e4fb397f77aed5eee27faa3b8b4b6b8`  
		Last Modified: Thu, 15 Aug 2024 20:50:10 GMT  
		Size: 10.2 MB (10174138 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:alpine3.20-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:654a11abd1f24cc45b44b52f44cea286ed4cd24c9e2c3c899a61bd34eb2a27dc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.7 MB (1732247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b3a9169f9b9838cdcffd1ce2923216ed16de8a95d86f3b4cd8cd14cbcb4bf2a`

```dockerfile
```

-	Layers:
	-	`sha256:c81947a503161cfbc1d2c9d749cb33afb6de10f49905bf39ce35384c33fde6d6`  
		Last Modified: Thu, 15 Aug 2024 20:50:10 GMT  
		Size: 1.7 MB (1711310 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0a21de9c1f755a01726f29067ca684640b2cd41c2a9df4aa4a1d1ba45b467b00`  
		Last Modified: Thu, 15 Aug 2024 20:50:09 GMT  
