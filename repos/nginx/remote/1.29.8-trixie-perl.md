...
```console
$ docker pull nginx@sha256:6a3dd5dba2062dd05bc161251c8ee0cd8f20e801b70c9243d13a770514a0bd56
```
...
### `nginx:1.29.8-trixie-perl` - linux; amd64
...
### `nginx:1.29.8-trixie-perl` - unknown; unknown
...
### `nginx:1.29.8-trixie-perl` - linux; arm variant v5
...
### `nginx:1.29.8-trixie-perl` - linux; arm variant v7
...
### `nginx:1.29.8-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.29.8-trixie-perl` - linux; 386
...
### `nginx:1.29.8-trixie-perl` - linux; ppc64le
...
### `nginx:1.29.8-trixie-perl` - linux; s390x
