...
```console
$ docker pull nginx@sha256:0c5d96dc61c5c3646c1284495a1b32914f0f7f55fa4b7dcf5600b60e8c969a7b
```
...
### `nginx:1.29.8-alpine` - linux; amd64
...
### `nginx:1.29.8-alpine` - unknown; unknown
...
### `nginx:1.29.8-alpine` - linux; arm variant v6
...
### `nginx:1.29.8-alpine` - linux; arm variant v7
...
### `nginx:1.29.8-alpine` - linux; arm64 variant v8
...
### `nginx:1.29.8-alpine` - linux; ppc64le
...
### `nginx:1.29.8-alpine` - linux; riscv64
...
### `nginx:1.29.8-alpine` - linux; s390x
