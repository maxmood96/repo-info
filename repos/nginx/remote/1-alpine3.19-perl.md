...
```console
$ docker pull nginx@sha256:fbc04e5c20282c715fc350ea0868eefaab704efb61d679a2e93787993dfae35c
```
...
### `nginx:1-alpine3.19-perl` - linux; amd64
...
### `nginx:1-alpine3.19-perl` - linux; arm variant v7
...
### `nginx:1-alpine3.19-perl` - linux; arm64 variant v8
...
### `nginx:1-alpine3.19-perl` - linux; ppc64le
...
### `nginx:1-alpine3.19-perl` - linux; s390x
