...
### `nginx:1.29.0-perl` - unknown; unknown
...
### `nginx:1.29.0-perl` - linux; arm variant v5
...
### `nginx:1.29.0-perl` - linux; arm variant v7
...
### `nginx:1.29.0-perl` - linux; arm64 variant v8
...
### `nginx:1.29.0-perl` - linux; mips64le
...
### `nginx:1.29.0-perl` - linux; ppc64le
