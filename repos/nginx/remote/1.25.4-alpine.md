...
```console
$ docker pull nginx@sha256:c84cfc41ddfde5c3590458e34a2837958d757d28441c3678a37c953e7b940a05
```
...
### `nginx:1.25.4-alpine` - linux; amd64
...
### `nginx:1.25.4-alpine` - unknown; unknown
...
### `nginx:1.25.4-alpine` - linux; arm variant v6
...
### `nginx:1.25.4-alpine` - linux; arm64 variant v8
...
### `nginx:1.25.4-alpine` - linux; ppc64le
