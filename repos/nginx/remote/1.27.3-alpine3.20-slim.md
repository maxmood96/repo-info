...
### `nginx:1.27.3-alpine3.20-slim` - linux; amd64
...
### `nginx:1.27.3-alpine3.20-slim` - unknown; unknown
...
### `nginx:1.27.3-alpine3.20-slim` - linux; arm variant v6
...
### `nginx:1.27.3-alpine3.20-slim` - linux; arm variant v7
...
### `nginx:1.27.3-alpine3.20-slim` - linux; arm64 variant v8
...
### `nginx:1.27.3-alpine3.20-slim` - linux; 386
...
### `nginx:1.27.3-alpine3.20-slim` - linux; ppc64le
...
### `nginx:1.27.3-alpine3.20-slim` - linux; riscv64
...
### `nginx:1.27.3-alpine3.20-slim` - linux; s390x
