...
```console
$ docker pull nginx@sha256:8e647584efaa8b986b5dbaf63f85fb6ee7db22cf9d71f6d853290ffe0f88da2c
```
...
### `nginx:1-alpine3.19` - linux; amd64
...
### `nginx:1-alpine3.19` - unknown; unknown
...
### `nginx:1-alpine3.19` - linux; arm variant v6
...
### `nginx:1-alpine3.19` - linux; arm variant v7
...
### `nginx:1-alpine3.19` - linux; arm64 variant v8
...
### `nginx:1-alpine3.19` - linux; ppc64le
...
### `nginx:1-alpine3.19` - linux; s390x
