...
### `nginx:1.25.0-bullseye` - linux; amd64
...
### `nginx:1.25.0-bullseye` - linux; arm variant v5
...
### `nginx:1.25.0-bullseye` - linux; arm variant v7
...
### `nginx:1.25.0-bullseye` - linux; arm64 variant v8
...
### `nginx:1.25.0-bullseye` - linux; 386
...
### `nginx:1.25.0-bullseye` - linux; mips64le
...
### `nginx:1.25.0-bullseye` - linux; ppc64le
...
### `nginx:1.25.0-bullseye` - linux; s390x
