...
```console
$ docker pull nginx@sha256:693a770f813911452bb68ea113ff5894398d14b7385e0b8bc6f8e36c24adc10a
```
...
### `nginx:1.30.2-alpine3.23-perl` - linux; amd64
...
### `nginx:1.30.2-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.30.2-alpine3.23-perl` - linux; 386
...
### `nginx:1.30.2-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.30.2-alpine3.23-perl` - linux; riscv64
...
### `nginx:1.30.2-alpine3.23-perl` - linux; s390x
