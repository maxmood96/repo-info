...
```console
$ docker pull nginx@sha256:182cd121d15bb6c89f580619252692c2495f0fad399776810c1bd3e0afa44c8b
```
...
### `nginx:1.26.1-alpine-slim` - linux; amd64
...
### `nginx:1.26.1-alpine-slim` - unknown; unknown
...
### `nginx:1.26.1-alpine-slim` - linux; arm variant v6
...
### `nginx:1.26.1-alpine-slim` - linux; arm variant v7
...
### `nginx:1.26.1-alpine-slim` - linux; 386
...
### `nginx:1.26.1-alpine-slim` - linux; ppc64le
...
### `nginx:1.26.1-alpine-slim` - linux; s390x
