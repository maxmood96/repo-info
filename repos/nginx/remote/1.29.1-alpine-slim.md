...
```console
$ docker pull nginx@sha256:904b648603e4a215bdbb1b91f0ecd4625f47941e41f71340bdafe763c3865760
```
...
### `nginx:1.29.1-alpine-slim` - linux; amd64
...
### `nginx:1.29.1-alpine-slim` - unknown; unknown
...
### `nginx:1.29.1-alpine-slim` - linux; arm variant v6
...
### `nginx:1.29.1-alpine-slim` - linux; arm variant v7
...
### `nginx:1.29.1-alpine-slim` - linux; arm64 variant v8
...
### `nginx:1.29.1-alpine-slim` - linux; 386
...
### `nginx:1.29.1-alpine-slim` - linux; ppc64le
...
### `nginx:1.29.1-alpine-slim` - linux; s390x
