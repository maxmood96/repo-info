...
### `nginx:1-alpine3.20` - linux; amd64
...
### `nginx:1-alpine3.20` - unknown; unknown
...
### `nginx:1-alpine3.20` - linux; arm variant v6
...
### `nginx:1-alpine3.20` - linux; arm variant v7
...
### `nginx:1-alpine3.20` - linux; arm64 variant v8
...
### `nginx:1-alpine3.20` - linux; ppc64le
...
### `nginx:1-alpine3.20` - linux; riscv64
...
### `nginx:1-alpine3.20` - linux; s390x
