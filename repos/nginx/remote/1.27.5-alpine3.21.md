...
```console
$ docker pull nginx@sha256:971ed5966804f3e938f75b3cb01b0281c41ed1bfb47cda3d31b4bc5b00c44729
```
...
### `nginx:1.27.5-alpine3.21` - linux; amd64
...
### `nginx:1.27.5-alpine3.21` - unknown; unknown
...
### `nginx:1.27.5-alpine3.21` - linux; arm variant v6
...
### `nginx:1.27.5-alpine3.21` - linux; arm variant v7
...
### `nginx:1.27.5-alpine3.21` - linux; arm64 variant v8
...
### `nginx:1.27.5-alpine3.21` - linux; 386
...
### `nginx:1.27.5-alpine3.21` - linux; ppc64le
...
### `nginx:1.27.5-alpine3.21` - linux; s390x
