...
### `nginx:1.31.0-trixie` - linux; amd64
...
### `nginx:1.31.0-trixie` - unknown; unknown
...
### `nginx:1.31.0-trixie` - linux; arm variant v5
...
### `nginx:1.31.0-trixie` - linux; arm variant v7
...
### `nginx:1.31.0-trixie` - linux; arm64 variant v8
...
### `nginx:1.31.0-trixie` - linux; ppc64le
...
### `nginx:1.31.0-trixie` - linux; riscv64
...
### `nginx:1.31.0-trixie` - linux; s390x
