...
```console
$ docker pull nginx@sha256:fe6a88e2829f4bb80ade915bded14a876a7779271dd3a79e9ce15417ed7198b4
```
...
### `nginx:1.25.5-bookworm` - linux; amd64
...
### `nginx:1.25.5-bookworm` - unknown; unknown
...
### `nginx:1.25.5-bookworm` - linux; arm variant v7
...
### `nginx:1.25.5-bookworm` - linux; arm64 variant v8
...
### `nginx:1.25.5-bookworm` - linux; 386
...
### `nginx:1.25.5-bookworm` - linux; mips64le
...
### `nginx:1.25.5-bookworm` - linux; ppc64le
...
### `nginx:1.25.5-bookworm` - linux; s390x
