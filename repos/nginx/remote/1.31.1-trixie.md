...
```console
$ docker pull nginx@sha256:0a0818182f39b9853d2b259d5a18a2e02808f05e2221bea43725aaea6ee94a86
```
...
### `nginx:1.31.1-trixie` - linux; amd64
...
### `nginx:1.31.1-trixie` - unknown; unknown
...
### `nginx:1.31.1-trixie` - linux; arm variant v5
...
### `nginx:1.31.1-trixie` - linux; arm variant v7
...
### `nginx:1.31.1-trixie` - linux; arm64 variant v8
...
### `nginx:1.31.1-trixie` - linux; ppc64le
...
### `nginx:1.31.1-trixie` - linux; s390x
