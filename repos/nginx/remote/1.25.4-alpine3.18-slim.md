...
```console
$ docker pull nginx@sha256:d6091779d65947a1a2a985ce479fe3de53e141765d22d8253310aa60ab65308e
```
...
### `nginx:1.25.4-alpine3.18-slim` - linux; amd64
...
### `nginx:1.25.4-alpine3.18-slim` - unknown; unknown
...
### `nginx:1.25.4-alpine3.18-slim` - linux; arm variant v6
...
### `nginx:1.25.4-alpine3.18-slim` - linux; arm64 variant v8
...
### `nginx:1.25.4-alpine3.18-slim` - linux; 386
...
### `nginx:1.25.4-alpine3.18-slim` - linux; ppc64le
