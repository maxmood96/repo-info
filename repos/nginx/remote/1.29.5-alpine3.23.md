...
```console
$ docker pull nginx@sha256:05fcc6f6c80dc65c0f241f250677aad26e0962d118abaa65a513796862ff915d
```
...
### `nginx:1.29.5-alpine3.23` - linux; amd64
...
### `nginx:1.29.5-alpine3.23` - unknown; unknown
...
### `nginx:1.29.5-alpine3.23` - linux; arm variant v6
...
### `nginx:1.29.5-alpine3.23` - linux; arm variant v7
...
### `nginx:1.29.5-alpine3.23` - linux; arm64 variant v8
...
### `nginx:1.29.5-alpine3.23` - linux; 386
...
### `nginx:1.29.5-alpine3.23` - linux; ppc64le
...
### `nginx:1.29.5-alpine3.23` - linux; s390x
