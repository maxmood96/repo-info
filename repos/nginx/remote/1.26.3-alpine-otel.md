...
```console
$ docker pull nginx@sha256:02a1e29f7b93e643c5d5ca202ab50616222aacc4a84a9522ea85bb5e50bb079a
```
...
### `nginx:1.26.3-alpine-otel` - linux; amd64

```console
$ docker pull nginx@sha256:3c98ec9d274122dce833b9e072c8807fc02e95cbdce3589400aae64c3724fc81
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.4 MB (33426578 bytes)**  
...
-	Layers:
	...
	-	`sha256:5ab072e0bc4f67351f9c935c8834e3e1bcacb0e013a124ef309607d6210f218d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:73c3c469a504cde2e117640af1d6e325f68088f7e6cd1f9e5a51f2869dacba6a`  
		Last Modified: Wed, 16 Apr 2025 17:15:24 GMT  
		Size: 12.8 MB (12845653 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.26.3-alpine-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:cf944828b7886806dbf414f7baf10a59b781cad3a719d3824ea782d47e4b1fef
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.0 MB (1046069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3f935a9f9befb9e356aca774c619b858bdb22815724bcbd811fde78e2440f6c`

```dockerfile
```

-	Layers:
	-	`sha256:9442af8b83d3a90617cf98d271dd0171aea09ff089c32407c6dbb0b2503893d7`  
		Last Modified: Wed, 16 Apr 2025 17:15:24 GMT  
		Size: 1.0 MB (1026004 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b4c2d44421e455b8b28a0a5acded432f3e13d4fcda2dc51f75da251bfd36d410`  
		Last Modified: Wed, 16 Apr 2025 17:15:24 GMT  
		Size: 20.1 KB (20065 bytes)  
		MIME: application/vnd.in-toto+json

### `nginx:1.26.3-alpine-otel` - linux; arm64 variant v8

```console
$ docker pull nginx@sha256:500e566304d519d66a1a22381e6c5899230f997024bbc3e180b7831c206fd6a4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34162594 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b266c7559fa216bf7e70b7b978edbfb36f98c48dc9e6e3854e9eb89bc968b64f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:1ee6408ae620ef4a046179fb57fbd4f6fcb7c0bb4e3d8de3c49334a1facdfea6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a57cfc54870b142ac0f60cfc821f4e199cae9c6e2dff7473bf706c7ce40441a3`  
		Last Modified: Wed, 16 Apr 2025 17:15:48 GMT  
		Size: 12.5 MB (12548999 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.26.3-alpine-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:6ccbf9b106bf62f56af70c55566f54db33e6b2114045e6e2a65bf0951ac56ab7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.0 MB (1046277 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f828ce34a678dceec9734b413528304487d8a85492debb354d2780dcade08548`

```dockerfile
```

-	Layers:
	-	`sha256:ffc07434f5e0abb2114c8b7596bd72c2daff773205c2c968d0788c9aa4c33673`  
		Last Modified: Wed, 16 Apr 2025 17:15:47 GMT  
		Size: 1.0 MB (1026084 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:cf843a979fdbc2877b5e894a69115b66c3346d3066d31137e09c6648debf8681`  
		Last Modified: Wed, 16 Apr 2025 17:15:47 GMT  
