...
### `nginx:1.29.1-alpine3.22-perl` - linux; amd64
...
### `nginx:1.29.1-alpine3.22-perl` - unknown; unknown
...
### `nginx:1.29.1-alpine3.22-perl` - linux; arm variant v6
...
### `nginx:1.29.1-alpine3.22-perl` - linux; arm variant v7
...
### `nginx:1.29.1-alpine3.22-perl` - linux; arm64 variant v8
...
### `nginx:1.29.1-alpine3.22-perl` - linux; 386
...
### `nginx:1.29.1-alpine3.22-perl` - linux; ppc64le
...
### `nginx:1.29.1-alpine3.22-perl` - linux; riscv64
...
### `nginx:1.29.1-alpine3.22-perl` - linux; s390x
