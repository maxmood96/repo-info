...
### `nginx:1.25-alpine3.17` - linux; amd64
...
### `nginx:1.25-alpine3.17` - linux; arm variant v6
...
### `nginx:1.25-alpine3.17` - linux; arm variant v7
...
### `nginx:1.25-alpine3.17` - linux; arm64 variant v8
...
### `nginx:1.25-alpine3.17` - linux; 386
...
### `nginx:1.25-alpine3.17` - linux; ppc64le
...
### `nginx:1.25-alpine3.17` - linux; s390x
