...
```console
$ docker pull nginx@sha256:842785ec7ce7800f1f378cd115661f78dfce99362766a1f62292121819a8ed73
```
...
```console
$ docker pull nginx@sha256:99eef4f052dc53c405b5c79d7d1d5478ac4c07e735857b9635171e95d7b41191
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.9 MB (26889924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a7477ec046a5c0ebc7f67b61e93ff8a29ab2df86445603b96d36d9947002998`
...
-	Layers:
	...
	-	`sha256:a2eb5282fbec00fa3d13849dafbfd7f416b69059e527e5653b84f1d9245b8eb0`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bb38cfca6ad8768840160ef47f6d4a9ad0332b7068244d5ffd50f03a92fe2fae`  
		Last Modified: Tue, 26 Nov 2024 22:07:34 GMT  
		Size: 4.1 MB (4107679 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1-alpine-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:80a8816c2d78cc2d69bf254f7cd18c3b22367b5a1315ac963c5b0d2500ef1d04
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **894.8 KB (894825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ef2a1b9599ab8f3fb4fd6ac35855a290f265a92c78fd2393bdb9bba56e77bf4`

```dockerfile
```

-	Layers:
	-	`sha256:93281251e1a861a0dc6db35e9da2069fbd1ddd0d969521ecf02660b3a4a63534`  
		Last Modified: Tue, 26 Nov 2024 22:07:33 GMT  
		Size: 873.5 KB (873475 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e482198723a656bcad3f531cd171effcdf16c7a6a6492209f9b5ce41a62394ed`  
		Last Modified: Tue, 26 Nov 2024 22:07:33 GMT  
...
```console
$ docker pull nginx@sha256:04cb0ed1acbd994f3c6b091f5f43177aed3ecd3dda71afed10f055c15ab37009
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.2 MB (28186947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78aeed325f1b30538dcf0aa584c390f44c251600bf5da63b8e3322c05169b0d0`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:4d87255a9251d4b20f86e205ad3b9df9aa83c038dc4b8fca7cb1a1b99360f979`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8f118684fd87fee3907b2131864ba0e36bf7399715ed8593a7c2ad67c99c155e`  
		Last Modified: Tue, 26 Nov 2024 22:08:00 GMT  
		Size: 4.0 MB (3960498 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1-alpine-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:0f05a731359094b127887f91a834893507d3acccffbeffcd6cd4459face4d39e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **895.1 KB (895129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:679d7aa931cadb1305431d35098fef5dc39a61a625bfa12f68650bd257ef38f2`

```dockerfile
```

-	Layers:
	-	`sha256:ca640b154ea043d4f37b8c89a8e65c56e5ce7123c23a2e6eacbe54ebda1d2aa8`  
		Last Modified: Tue, 26 Nov 2024 22:07:59 GMT  
		Size: 873.6 KB (873603 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:062f61ebda8ae47d3ec7426bcbbf7b101ab291fc791d1618a4cf739dba143143`  
		Last Modified: Tue, 26 Nov 2024 22:07:59 GMT  
