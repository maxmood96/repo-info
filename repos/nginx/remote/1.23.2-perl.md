...
```console
$ docker pull nginx@sha256:3975ca816132804dc0711da6a5bc54861a2c8a9d2016ac4d2302c407813e2f73
```
...
### `nginx:1.23.2-perl` - linux; arm variant v7
...
### `nginx:1.23.2-perl` - linux; mips64le
