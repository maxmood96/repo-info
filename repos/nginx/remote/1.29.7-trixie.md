...
### `nginx:1.29.7-trixie` - linux; amd64
...
### `nginx:1.29.7-trixie` - unknown; unknown
...
### `nginx:1.29.7-trixie` - linux; arm variant v5
...
### `nginx:1.29.7-trixie` - linux; arm variant v7
...
### `nginx:1.29.7-trixie` - linux; arm64 variant v8
...
### `nginx:1.29.7-trixie` - linux; ppc64le
...
### `nginx:1.29.7-trixie` - linux; riscv64
...
### `nginx:1.29.7-trixie` - linux; s390x
