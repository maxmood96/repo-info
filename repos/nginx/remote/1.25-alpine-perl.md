...
```console
$ docker pull nginx@sha256:eec46d17b50b7cff5b2ce9e8ab439c769bb32af46f04d0cdb54d8892886e90a9
```
...
```console
$ docker pull nginx@sha256:f965f55654e0be8f3d95ebac9991f8088defbc8dcf36c303776b831f34dfbe92
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.1 MB (24104166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56afa6ec798f67d4f50292b624452c6aeba3f2ac7447f1b80cfd97452a30879f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:659beac667c8c6b36c9ead849a738648f2da66033b0926037697383a9902a582`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:427bd04d55a1ef9be37c96e83f8cf5a5d1cb277fea1a49cf375fed7c3750c221`  
		Last Modified: Tue, 19 Mar 2024 17:57:32 GMT  
		Size: 8.3 MB (8339620 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.25-alpine-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:3ba29808df925a9962594387f7397c4bf7dda82f9c17301ff4769d75fba1a86a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.0 KB (23985 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11295afe5b69908c27a70a3581b76a5ac489ee144d6dccdfe8527b09a87a2cf0`

```dockerfile
```

-	Layers:
	-	`sha256:166cdab86ae3e4022890c1bc3495dec4e5ec85e21b039c46a7a0372ac30c033a`  
		Last Modified: Tue, 19 Mar 2024 17:57:31 GMT  
...
```console
$ docker pull nginx@sha256:1710ae5cab0fce46864d5313b42474581802c7a713cdcc668a67e7e2e7136258
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.9 MB (26850532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88ff71ba1229e7a337f281de381a448a06cf2e66274345ec4eee55565697e539`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:fb93ba75aaeb7055e1a29a461edd31744d4e7c726c588ab6a190b60bfe5d9f67`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e1a432a5029aec1364b7f54c06d3876c629edbeee45548effab66a9d25f045cd`  
		Last Modified: Mon, 18 Mar 2024 02:27:04 GMT  
		Size: 9.5 MB (9538029 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.25-alpine-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:638d15c0c19844e13bd3a765e789c82c30b88706d6ca4afde90851b6a014d604
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.1 MB (2092449 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f257545cf723cef01e62041fbca1660663c18e9418027a03b365bcc4435969b6`

```dockerfile
```

-	Layers:
	-	`sha256:f974a0c9257f192252e3c575b8dcb5b7df72ccc4452c628808bc6aeb84638fec`  
		Last Modified: Mon, 18 Mar 2024 02:27:04 GMT  
		Size: 2.1 MB (2068373 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:500a1df20966139ac5fe3e7f4f42574daa552a8b42823d66d75b4c4fe4130642`  
		Last Modified: Mon, 18 Mar 2024 02:27:04 GMT  
