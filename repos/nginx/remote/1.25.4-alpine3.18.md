...
### `nginx:1.25.4-alpine3.18` - linux; amd64
...
### `nginx:1.25.4-alpine3.18` - unknown; unknown
...
### `nginx:1.25.4-alpine3.18` - linux; arm variant v6
...
### `nginx:1.25.4-alpine3.18` - linux; arm variant v7
...
### `nginx:1.25.4-alpine3.18` - linux; arm64 variant v8
...
### `nginx:1.25.4-alpine3.18` - linux; 386
...
### `nginx:1.25.4-alpine3.18` - linux; ppc64le
...
### `nginx:1.25.4-alpine3.18` - linux; s390x
