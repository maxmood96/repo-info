...
```console
$ docker pull nginx@sha256:3306ec00d7be7a01781fba7ffac0340e296cac79db5d74bbc17fdeed1d9e6556
```
...
### `nginx:1.31.0-alpine-perl` - linux; amd64
...
### `nginx:1.31.0-alpine-perl` - unknown; unknown
...
### `nginx:1.31.0-alpine-perl` - linux; arm variant v6
...
### `nginx:1.31.0-alpine-perl` - linux; arm variant v7
...
### `nginx:1.31.0-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.31.0-alpine-perl` - linux; 386
...
### `nginx:1.31.0-alpine-perl` - linux; ppc64le
...
### `nginx:1.31.0-alpine-perl` - linux; s390x
