...
```console
$ docker pull nginx@sha256:0d1b1f0656a7cb1e2e8135bb1ea99d889ee5d3345fc20388da3f555ad77cf2dc
```
...
### `nginx:1.29.5` - linux; arm variant v5
...
### `nginx:1.29.5` - linux; arm variant v7
...
### `nginx:1.29.5` - linux; arm64 variant v8
