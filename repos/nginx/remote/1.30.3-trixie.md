...
### `nginx:1.30.3-trixie` - linux; amd64
...
### `nginx:1.30.3-trixie` - unknown; unknown
...
### `nginx:1.30.3-trixie` - linux; arm variant v5
...
### `nginx:1.30.3-trixie` - linux; arm variant v7
...
### `nginx:1.30.3-trixie` - linux; arm64 variant v8
...
### `nginx:1.30.3-trixie` - linux; ppc64le
...
### `nginx:1.30.3-trixie` - linux; riscv64
...
### `nginx:1.30.3-trixie` - linux; s390x
