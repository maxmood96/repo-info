...
```console
$ docker pull nginx@sha256:582c496ccf79d8aa6f8203a79d32aaf7ffd8b13362c60a701a2f9ac64886c93d
```
...
### `nginx:1.29.8-alpine3.23` - linux; amd64
...
### `nginx:1.29.8-alpine3.23` - unknown; unknown
...
### `nginx:1.29.8-alpine3.23` - linux; arm variant v6
...
### `nginx:1.29.8-alpine3.23` - linux; arm variant v7
...
### `nginx:1.29.8-alpine3.23` - linux; arm64 variant v8
...
### `nginx:1.29.8-alpine3.23` - linux; 386
...
### `nginx:1.29.8-alpine3.23` - linux; ppc64le
...
### `nginx:1.29.8-alpine3.23` - linux; riscv64
...
### `nginx:1.29.8-alpine3.23` - linux; s390x
