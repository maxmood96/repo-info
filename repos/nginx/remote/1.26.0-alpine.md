...
### `nginx:1.26.0-alpine` - linux; amd64
...
### `nginx:1.26.0-alpine` - unknown; unknown
...
### `nginx:1.26.0-alpine` - linux; arm variant v6
...
### `nginx:1.26.0-alpine` - linux; arm variant v7
...
### `nginx:1.26.0-alpine` - linux; arm64 variant v8
...
### `nginx:1.26.0-alpine` - linux; ppc64le
...
### `nginx:1.26.0-alpine` - linux; s390x
