...
```console
$ docker pull nginx@sha256:62daff8f66c47ab067293472f9f6291c93a802928d82f1b78e6e06278930e4be
```
...
### `nginx:1.28.3-alpine` - linux; amd64
...
### `nginx:1.28.3-alpine` - unknown; unknown
...
### `nginx:1.28.3-alpine` - linux; arm variant v6
...
### `nginx:1.28.3-alpine` - linux; arm variant v7
...
### `nginx:1.28.3-alpine` - linux; arm64 variant v8
...
### `nginx:1.28.3-alpine` - linux; ppc64le
...
### `nginx:1.28.3-alpine` - linux; s390x
