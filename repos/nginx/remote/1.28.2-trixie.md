...
### `nginx:1.28.2-trixie` - linux; amd64
...
### `nginx:1.28.2-trixie` - unknown; unknown
...
### `nginx:1.28.2-trixie` - linux; arm variant v5
...
### `nginx:1.28.2-trixie` - linux; arm variant v7
...
### `nginx:1.28.2-trixie` - linux; arm64 variant v8
...
### `nginx:1.28.2-trixie` - linux; ppc64le
...
### `nginx:1.28.2-trixie` - linux; riscv64
...
### `nginx:1.28.2-trixie` - linux; s390x
