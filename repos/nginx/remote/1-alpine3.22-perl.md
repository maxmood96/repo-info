...
```console
$ docker pull nginx@sha256:93c5e480552abdb030bd643ba8ac4163103e9efb70d4cf98a33fbe9b10cb647a
```
...
### `nginx:1-alpine3.22-perl` - linux; amd64
...
### `nginx:1-alpine3.22-perl` - unknown; unknown
...
### `nginx:1-alpine3.22-perl` - linux; arm variant v6
...
### `nginx:1-alpine3.22-perl` - linux; arm variant v7
...
### `nginx:1-alpine3.22-perl` - linux; arm64 variant v8
...
### `nginx:1-alpine3.22-perl` - linux; 386
...
### `nginx:1-alpine3.22-perl` - linux; ppc64le
...
### `nginx:1-alpine3.22-perl` - linux; riscv64

```console
$ docker pull nginx@sha256:af517586809120ef7d6c15bec4329a1989cdd77868a956c73acccf31090d0ae0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.7 MB (29664294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94a8b498df91649fe77d1b9c5ed4c93fa81ed7a4bdae57454bf1041af1e7705f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:3479ee55c6b106ee15ad3b1047fefa7e9512ef3c5fed3cb7075b32f07a40776c`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6f43646cec16defe0673672997dbb4a915e4def653c16cdd2022ee0e124cd49b`  
		Last Modified: Wed, 15 Oct 2025 03:09:12 GMT  
		Size: 9.3 MB (9272644 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1-alpine3.22-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:27ab5936bf815dae1afbed0c5a3e0169fe7c06c29247147abf7e376ee618c13c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.8 MB (1829436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:968bf37a7d2a6bcc9d47bdefb2b97748d0a1e15fce41a2aab1d37840080c8528`

```dockerfile
```

-	Layers:
	-	`sha256:64c99035edbc7a113be4e58b3320ad8769cadc25e2c84851ff3036b3630b936e`  
		Last Modified: Wed, 15 Oct 2025 05:50:39 GMT  
		Size: 1.8 MB (1808391 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f7885c2123ab7253263b0604d7af5d26a023633b8c5f241467faa13086e3e7b0`  
		Last Modified: Wed, 15 Oct 2025 05:50:40 GMT  
		Size: 21.0 KB (21045 bytes)  
		MIME: application/vnd.in-toto+json

### `nginx:1-alpine3.22-perl` - linux; s390x
