...
### `nginx:1.29.1-perl` - unknown; unknown
...
### `nginx:1.29.1-perl` - linux; arm variant v5
...
### `nginx:1.29.1-perl` - linux; arm variant v7
...
### `nginx:1.29.1-perl` - linux; arm64 variant v8
...
### `nginx:1.29.1-perl` - linux; mips64le
...
### `nginx:1.29.1-perl` - linux; ppc64le
