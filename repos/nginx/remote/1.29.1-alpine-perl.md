...
```console
$ docker pull nginx@sha256:078dfcbce9bcf7589870b871fe10d6febd2b06816af09cb6dcc22c9673b9fb14
```
...
### `nginx:1.29.1-alpine-perl` - linux; amd64
...
### `nginx:1.29.1-alpine-perl` - unknown; unknown
...
### `nginx:1.29.1-alpine-perl` - linux; arm variant v6
...
### `nginx:1.29.1-alpine-perl` - linux; arm variant v7
...
### `nginx:1.29.1-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.29.1-alpine-perl` - linux; 386
...
### `nginx:1.29.1-alpine-perl` - linux; ppc64le
...
### `nginx:1.29.1-alpine-perl` - linux; s390x
