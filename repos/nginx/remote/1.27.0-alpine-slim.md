...
```console
$ docker pull nginx@sha256:f8e869187a27097f4df6be09a87fb9b38f180529e52514d27d0c624bf6ba3c7b
```
...
### `nginx:1.27.0-alpine-slim` - linux; amd64
...
### `nginx:1.27.0-alpine-slim` - unknown; unknown
...
### `nginx:1.27.0-alpine-slim` - linux; arm variant v6
...
### `nginx:1.27.0-alpine-slim` - linux; arm variant v7
...
### `nginx:1.27.0-alpine-slim` - linux; 386
...
### `nginx:1.27.0-alpine-slim` - linux; ppc64le
...
### `nginx:1.27.0-alpine-slim` - linux; s390x
