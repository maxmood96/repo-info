...
```console
$ docker pull nginx@sha256:9f00a7a92624975cdd964ec71fbb86bf91dc117e86436a9a91fa7b5cdb9615d1
```
...
### `nginx:1.30.3-alpine` - linux; amd64
...
### `nginx:1.30.3-alpine` - unknown; unknown
...
### `nginx:1.30.3-alpine` - linux; arm variant v6
...
### `nginx:1.30.3-alpine` - linux; arm variant v7
...
### `nginx:1.30.3-alpine` - linux; arm64 variant v8
...
### `nginx:1.30.3-alpine` - linux; ppc64le
...
### `nginx:1.30.3-alpine` - linux; riscv64
...
### `nginx:1.30.3-alpine` - linux; s390x
