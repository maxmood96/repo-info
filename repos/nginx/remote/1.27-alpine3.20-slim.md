...
```console
$ docker pull nginx@sha256:a0025f7fbf6b39e5e21a404bd683f89a0a91d3320ffbecffa4bc7426d22d1e29
```
...
### `nginx:1.27-alpine3.20-slim` - linux; amd64
...
### `nginx:1.27-alpine3.20-slim` - unknown; unknown
...
### `nginx:1.27-alpine3.20-slim` - linux; arm variant v6
...
### `nginx:1.27-alpine3.20-slim` - linux; arm variant v7
...
### `nginx:1.27-alpine3.20-slim` - linux; arm64 variant v8
...
### `nginx:1.27-alpine3.20-slim` - linux; ppc64le
...
### `nginx:1.27-alpine3.20-slim` - linux; s390x
