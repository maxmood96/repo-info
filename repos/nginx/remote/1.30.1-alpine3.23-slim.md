...
### `nginx:1.30.1-alpine3.23-slim` - linux; amd64
...
### `nginx:1.30.1-alpine3.23-slim` - linux; arm variant v6
...
### `nginx:1.30.1-alpine3.23-slim` - linux; arm variant v7
...
### `nginx:1.30.1-alpine3.23-slim` - linux; 386
...
### `nginx:1.30.1-alpine3.23-slim` - linux; ppc64le
...
### `nginx:1.30.1-alpine3.23-slim` - linux; riscv64
