...
```console
$ docker pull nginx@sha256:c41a994789a430dd5626d836315e35f4837f5bc93e0224f0f25cfc7513d69162
```
...
### `nginx:1.29.6-alpine-perl` - linux; amd64
...
### `nginx:1.29.6-alpine-perl` - unknown; unknown
...
### `nginx:1.29.6-alpine-perl` - linux; arm variant v6
...
### `nginx:1.29.6-alpine-perl` - linux; arm variant v7
...
### `nginx:1.29.6-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.29.6-alpine-perl` - linux; 386
...
### `nginx:1.29.6-alpine-perl` - linux; ppc64le
...
### `nginx:1.29.6-alpine-perl` - linux; s390x
