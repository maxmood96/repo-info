...
### `nginx:1.19.5-perl` - linux; arm variant v7
...
### `nginx:1.19.5-perl` - linux; arm64 variant v8
...
### `nginx:1.19.5-perl` - linux; mips64le
...
### `nginx:1.19.5-perl` - linux; ppc64le
