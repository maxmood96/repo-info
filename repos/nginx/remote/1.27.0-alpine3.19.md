...
```console
$ docker pull nginx@sha256:5c0c2272256857e486cf9fe2983db41c0e14c72476f5ebedf474289fd9ca8627
```
...
```console
$ docker pull nginx@sha256:ef48f80cbef636b4d5d45d246335d81193b2bb7fb25676051789837ffd3c574a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.2 MB (18229687 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a919d7cf510c9ded6af71f79b921ad42b5e45050fe899e51955bf7089ff2fce2`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:8c9d582e576e438978638cc56d70149cf1c96a5166b153584ec8368483e71a17
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.3 MB (1251743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed4ecfc005ddad1d4a74ab2d3ff477a8b2d347990a11d8b7ebad7b0dfa551949`

```dockerfile
```

-	Layers:
	-	`sha256:4a6aacd1a0e82d8e8aa8b8dd366bb766fdca1ec42d6776ac6a0e61a801d9471b`  
		Last Modified: Fri, 21 Jun 2024 07:36:07 GMT  
		Size: 1.2 MB (1230344 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7e337d016bc2f4f2c1c49b3d0a3df4a2802adbe3300f943408ea2a388dc65f4b`  
		Last Modified: Fri, 21 Jun 2024 07:36:07 GMT  
