...
### `nginx:1.27.3-alpine` - linux; amd64
...
### `nginx:1.27.3-alpine` - unknown; unknown
...
### `nginx:1.27.3-alpine` - linux; arm variant v6
...
### `nginx:1.27.3-alpine` - linux; arm variant v7
...
### `nginx:1.27.3-alpine` - linux; arm64 variant v8
...
### `nginx:1.27.3-alpine` - linux; ppc64le
...
### `nginx:1.27.3-alpine` - linux; riscv64
...
### `nginx:1.27.3-alpine` - linux; s390x
