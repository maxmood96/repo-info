...
```console
$ docker pull nginx@sha256:adf0b8367df9e71e892a287023b6a337efa5278df338a7d25d1d6a24e03eec0c
```
...
### `nginx:1.27.5-alpine-perl` - linux; amd64
...
### `nginx:1.27.5-alpine-perl` - unknown; unknown
...
### `nginx:1.27.5-alpine-perl` - linux; arm variant v6
...
### `nginx:1.27.5-alpine-perl` - linux; arm variant v7
...
### `nginx:1.27.5-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.27.5-alpine-perl` - linux; 386
...
### `nginx:1.27.5-alpine-perl` - linux; ppc64le
...
### `nginx:1.27.5-alpine-perl` - linux; s390x
