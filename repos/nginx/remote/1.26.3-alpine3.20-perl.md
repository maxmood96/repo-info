...
### `nginx:1.26.3-alpine3.20-perl` - linux; amd64
...
### `nginx:1.26.3-alpine3.20-perl` - unknown; unknown
...
### `nginx:1.26.3-alpine3.20-perl` - linux; arm variant v6
...
### `nginx:1.26.3-alpine3.20-perl` - linux; arm variant v7
...
### `nginx:1.26.3-alpine3.20-perl` - linux; arm64 variant v8
...
### `nginx:1.26.3-alpine3.20-perl` - linux; 386
...
### `nginx:1.26.3-alpine3.20-perl` - linux; ppc64le
...
### `nginx:1.26.3-alpine3.20-perl` - linux; riscv64
...
### `nginx:1.26.3-alpine3.20-perl` - linux; s390x
