...
### `nginx:1.31.0-trixie-perl` - linux; amd64
...
### `nginx:1.31.0-trixie-perl` - unknown; unknown
...
### `nginx:1.31.0-trixie-perl` - linux; arm variant v5
...
### `nginx:1.31.0-trixie-perl` - linux; arm variant v7
...
### `nginx:1.31.0-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.31.0-trixie-perl` - linux; 386
...
### `nginx:1.31.0-trixie-perl` - linux; ppc64le
...
### `nginx:1.31.0-trixie-perl` - linux; riscv64
...
### `nginx:1.31.0-trixie-perl` - linux; s390x
