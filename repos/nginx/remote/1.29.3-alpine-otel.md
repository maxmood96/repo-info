...
```console
$ docker pull nginx@sha256:95f86c9dff242d7f62874cd13b7b46f91471ae937af3d7569949c118533f6629
```
...
### `nginx:1.29.3-alpine-otel` - linux; amd64
...
### `nginx:1.29.3-alpine-otel` - unknown; unknown
