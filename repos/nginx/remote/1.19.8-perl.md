...
```console
$ docker pull nginx@sha256:1119f6367b529ad5fbfc0f1fd0c4e560914cdc187f400a0cde77824c621aaf14
```
...
### `nginx:1.19.8-perl` - linux; arm variant v5
...
### `nginx:1.19.8-perl` - linux; arm variant v7
...
### `nginx:1.19.8-perl` - linux; arm64 variant v8
...
### `nginx:1.19.8-perl` - linux; mips64le
...
### `nginx:1.19.8-perl` - linux; ppc64le
