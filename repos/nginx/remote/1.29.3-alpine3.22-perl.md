...
```console
$ docker pull nginx@sha256:5b1bea1a92007073b81cfd793dbd176d40d10376bd4378da6b3bc53127b7bf06
```
...
### `nginx:1.29.3-alpine3.22-perl` - linux; amd64
...
### `nginx:1.29.3-alpine3.22-perl` - unknown; unknown
...
### `nginx:1.29.3-alpine3.22-perl` - linux; arm variant v6
...
### `nginx:1.29.3-alpine3.22-perl` - linux; arm variant v7
...
### `nginx:1.29.3-alpine3.22-perl` - linux; arm64 variant v8
...
### `nginx:1.29.3-alpine3.22-perl` - linux; 386
...
### `nginx:1.29.3-alpine3.22-perl` - linux; ppc64le
...
### `nginx:1.29.3-alpine3.22-perl` - linux; s390x
