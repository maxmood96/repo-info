...
```console
$ docker pull nginx@sha256:d05439fd0896b9912b6a129e8570328ed51554a16032baa1b6051f3eba459cf3
```
...
### `nginx:1.29.5-alpine3.23-slim` - linux; amd64
...
### `nginx:1.29.5-alpine3.23-slim` - unknown; unknown
...
### `nginx:1.29.5-alpine3.23-slim` - linux; arm variant v6
...
### `nginx:1.29.5-alpine3.23-slim` - linux; arm variant v7
...
### `nginx:1.29.5-alpine3.23-slim` - linux; arm64 variant v8
...
### `nginx:1.29.5-alpine3.23-slim` - linux; 386
...
### `nginx:1.29.5-alpine3.23-slim` - linux; ppc64le
...
### `nginx:1.29.5-alpine3.23-slim` - linux; s390x
