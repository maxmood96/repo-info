...
```console
$ docker pull nginx@sha256:dfd4ee12828fc2ef70fbcf9d09c88e10567034c7d731f01277358a8ffad803d7
```
...
### `nginx:1.28.3-alpine-perl` - linux; amd64
...
### `nginx:1.28.3-alpine-perl` - unknown; unknown
...
### `nginx:1.28.3-alpine-perl` - linux; arm variant v6
...
### `nginx:1.28.3-alpine-perl` - linux; arm variant v7
...
### `nginx:1.28.3-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.28.3-alpine-perl` - linux; 386
...
### `nginx:1.28.3-alpine-perl` - linux; ppc64le
...
### `nginx:1.28.3-alpine-perl` - linux; s390x
