...
### `nginx:1.29.0-bookworm` - linux; amd64
...
### `nginx:1.29.0-bookworm` - unknown; unknown
...
### `nginx:1.29.0-bookworm` - linux; arm variant v5
...
### `nginx:1.29.0-bookworm` - linux; arm variant v7
...
### `nginx:1.29.0-bookworm` - linux; arm64 variant v8
...
### `nginx:1.29.0-bookworm` - linux; 386
...
### `nginx:1.29.0-bookworm` - linux; mips64le
...
### `nginx:1.29.0-bookworm` - linux; ppc64le
...
### `nginx:1.29.0-bookworm` - linux; s390x
