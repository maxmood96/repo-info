...
```console
$ docker pull nginx@sha256:4f43eb8881f4ebc406e2155e34f199bfe6b1adc87be7084fac223ce41a53bb80
```
...
### `nginx:1.29.6-perl` - unknown; unknown
...
### `nginx:1.29.6-perl` - linux; arm variant v5
...
### `nginx:1.29.6-perl` - linux; arm variant v7
...
### `nginx:1.29.6-perl` - linux; arm64 variant v8
...
### `nginx:1.29.6-perl` - linux; ppc64le
