...
```console
$ docker pull nginx@sha256:75cad0ed4b9ea94413143f700eea1a71635806207ffb901b577c436a06ff4acd
```
...
### `nginx:1.29-bookworm` - linux; amd64
...
### `nginx:1.29-bookworm` - unknown; unknown
...
### `nginx:1.29-bookworm` - linux; arm variant v5
...
### `nginx:1.29-bookworm` - linux; arm variant v7
...
### `nginx:1.29-bookworm` - linux; arm64 variant v8
...
### `nginx:1.29-bookworm` - linux; mips64le
...
### `nginx:1.29-bookworm` - linux; ppc64le
...
### `nginx:1.29-bookworm` - linux; s390x
