...
### `nginx:1.31-alpine3.23` - linux; amd64
...
### `nginx:1.31-alpine3.23` - unknown; unknown
...
### `nginx:1.31-alpine3.23` - linux; arm variant v6
...
### `nginx:1.31-alpine3.23` - linux; arm variant v7
...
### `nginx:1.31-alpine3.23` - linux; arm64 variant v8
...
### `nginx:1.31-alpine3.23` - linux; 386
...
### `nginx:1.31-alpine3.23` - linux; ppc64le
...
### `nginx:1.31-alpine3.23` - linux; riscv64
...
### `nginx:1.31-alpine3.23` - linux; s390x
