...
```console
$ docker pull nginx@sha256:978ce1f2e08242ce6ac1661be2e1ecd68a1763a737db75277b546aa7f19f4165
```
...
### `nginx:1.30.0-alpine3.23-perl` - linux; amd64
...
### `nginx:1.30.0-alpine3.23-perl` - unknown; unknown
...
### `nginx:1.30.0-alpine3.23-perl` - linux; arm variant v6
...
### `nginx:1.30.0-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.30.0-alpine3.23-perl` - linux; arm64 variant v8
...
### `nginx:1.30.0-alpine3.23-perl` - linux; 386
...
### `nginx:1.30.0-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.30.0-alpine3.23-perl` - linux; s390x
