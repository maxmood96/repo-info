...
```console
$ docker pull nginx@sha256:8a9fa07e0c64a97e84c455650f51989a25ec7f76343e48cab55bf4bb986e291d
```
...
### `nginx:1.29.5-alpine3.23-perl` - linux; amd64
...
### `nginx:1.29.5-alpine3.23-perl` - unknown; unknown
...
### `nginx:1.29.5-alpine3.23-perl` - linux; arm variant v6
...
### `nginx:1.29.5-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.29.5-alpine3.23-perl` - linux; arm64 variant v8
...
### `nginx:1.29.5-alpine3.23-perl` - linux; 386
...
### `nginx:1.29.5-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.29.5-alpine3.23-perl` - linux; s390x
