...
```console
$ docker pull nginx@sha256:679a96b4bd1d0297f5b2b7266b3a52ec5cafb1b96a251094586dcb9dc98d7375
```
...
### `nginx:1.28.3-trixie` - linux; amd64
...
### `nginx:1.28.3-trixie` - unknown; unknown
...
### `nginx:1.28.3-trixie` - linux; arm variant v5
...
### `nginx:1.28.3-trixie` - linux; arm variant v7
...
### `nginx:1.28.3-trixie` - linux; arm64 variant v8
...
### `nginx:1.28.3-trixie` - linux; ppc64le
...
### `nginx:1.28.3-trixie` - linux; s390x
