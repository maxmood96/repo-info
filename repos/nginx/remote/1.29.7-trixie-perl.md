...
```console
$ docker pull nginx@sha256:e374fdc245098ac78c2f1e79f17e846d71af29a6acaf63e08e2a8c2d14e779ea
```
...
### `nginx:1.29.7-trixie-perl` - linux; amd64
...
### `nginx:1.29.7-trixie-perl` - unknown; unknown
...
### `nginx:1.29.7-trixie-perl` - linux; arm variant v5
...
### `nginx:1.29.7-trixie-perl` - linux; arm variant v7
...
### `nginx:1.29.7-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.29.7-trixie-perl` - linux; 386
...
### `nginx:1.29.7-trixie-perl` - linux; ppc64le
...
### `nginx:1.29.7-trixie-perl` - linux; riscv64
...
### `nginx:1.29.7-trixie-perl` - linux; s390x
