...
```console
$ docker pull nginx@sha256:d9911e5ac94c1905ffd34a582d01430224aed6954cb4a788b7877114bf0c1cb1
```
...
```console
$ docker pull nginx@sha256:f8f80aa8c02f8f09f51a51596081a7af98f5f6cd74f5a29b418c9e1e4115008a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.6 MB (57607048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8116c3350204643a74c2ade31db21eb265ef427d8a2433809f4df8905f18af01`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:24412bb9aad9f966bbade0f13f57b70ee015c63ca1d1d25993c1345f43c9f0fb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.9 MB (2867403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f02cfe710cef6b05d20d174a7f4c55ed9374296fe1cbb8506650407de59cc571`

```dockerfile
```

-	Layers:
	-	`sha256:d47eb82c47b24f1d915418426cb033e39bec92f332a63f948d1a3f1c00627f02`  
		Last Modified: Wed, 25 Mar 2026 03:59:09 GMT  
		Size: 2.8 MB (2833404 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:40aad7e6fa3e97869c484be140eabe98f61c3a98bfe76793f4645f8b28cde7d7`  
		Last Modified: Wed, 25 Mar 2026 03:59:09 GMT  
		Size: 34.0 KB (33999 bytes)  
		MIME: application/vnd.in-toto+json
