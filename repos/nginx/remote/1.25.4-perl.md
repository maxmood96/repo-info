...
```console
$ docker pull nginx@sha256:b455b84a67760b1cb8426240dc9c49f2099a211e9cff99d2efc8b05722638777
```
...
### `nginx:1.25.4-perl` - unknown; unknown
...
### `nginx:1.25.4-perl` - linux; arm variant v5
...
### `nginx:1.25.4-perl` - linux; arm variant v7
...
### `nginx:1.25.4-perl` - linux; arm64 variant v8
...
### `nginx:1.25.4-perl` - linux; mips64le

```console
$ docker pull nginx@sha256:03743694bff9c78f49f75606337bc283a3b264078a343038019804335260ad36
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.6 MB (77582253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb395604131a8131704f1bf2b2c9169dec0d251f88147703a4e4b4ecab2ffd60`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:8f0e66186cdc1ab6312a17d72f99cc08409a44fcc21b2e5cc5fc2821cc6b7f13`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:17fd839c832fce0ea05f2bfb2a000f7dc2b4df22c31bb0492c127b1022458f0c`  
		Last Modified: Fri, 12 Apr 2024 10:24:13 GMT  
		Size: 11.4 MB (11406548 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.25.4-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:bb75ff6626b3f61bb076224d9d7cae3e8db0d2d6f88221356ba3c706fbe215f9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.5 KB (24480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:748f26d5e12fe12668cb6393df1b53818479fe31b0043c5cd14ad63898f97a0b`

```dockerfile
```

-	Layers:
	-	`sha256:86829f54a2c2f147245ced83be51c9c76f410bc8a175b92922903e596d21322d`  
		Last Modified: Fri, 12 Apr 2024 10:24:11 GMT  
		Size: 24.5 KB (24480 bytes)  
		MIME: application/vnd.in-toto+json

### `nginx:1.25.4-perl` - linux; ppc64le
...
### `nginx:1.25.4-perl` - linux; s390x

```console
$ docker pull nginx@sha256:ce56e27406497ba6780edc7c7b8e2dcb10300285f00d2897f5927de4acea06e5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.2 MB (77210496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46af45028e6661b42524a374f60d047353d1d226abadc8ae51c424b38cdbb013`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:13a6d6e1b73abdd9e6260c0a1aa793d100f2cd8724569c55105fd335e08ad1c9`  
		...
		Size: 1.4 KB (1399 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:10066bc839a97bde456947dd39443b24f478ff1a0235698dd83a0b69a4deb122`  
		Last Modified: Sun, 14 Apr 2024 12:01:31 GMT  
		Size: 12.4 MB (12391317 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:1.25.4-perl` - unknown; unknown

```console
$ docker pull nginx@sha256:e57c59158ba26c7d1f6d899c84d9c2d6b91d2a59db12567ffb0ff83078a29d0e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.2 MB (4249546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92af766dbd91d2edc518d941628f2e151b4a84ec0d475b9b9b27e9f692ab4712`

```dockerfile
```

-	Layers:
	-	`sha256:5472d50ddbeef820c84a75be6e99122d6f3c0cc82eb8b2e634f481499d90b890`  
		Last Modified: Sun, 14 Apr 2024 12:01:31 GMT  
		Size: 4.2 MB (4224971 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ec5de2baca7d8f89cb5205821c2e3743bfeb543e11a544666029da64c44d8685`  
		Last Modified: Sun, 14 Apr 2024 12:01:30 GMT  
