...
```console
$ docker pull nginx@sha256:5fe1916b86db2ce0194b3bae79ffbf2ede51f999ba12033ff209bc039c51561e
```
...
### `nginx:1.31.1-alpine3.23-perl` - linux; amd64
...
### `nginx:1.31.1-alpine3.23-perl` - unknown; unknown
...
### `nginx:1.31.1-alpine3.23-perl` - linux; arm variant v6
...
### `nginx:1.31.1-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.31.1-alpine3.23-perl` - linux; arm64 variant v8
...
### `nginx:1.31.1-alpine3.23-perl` - linux; 386
...
### `nginx:1.31.1-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.31.1-alpine3.23-perl` - linux; s390x
