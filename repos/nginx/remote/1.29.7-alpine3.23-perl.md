...
```console
$ docker pull nginx@sha256:e2e7b6b54ad96a1ce8611a821ffe544995ce2324a07119a16e2cf8d2db1d211d
```
...
### `nginx:1.29.7-alpine3.23-perl` - linux; amd64
...
### `nginx:1.29.7-alpine3.23-perl` - unknown; unknown
...
### `nginx:1.29.7-alpine3.23-perl` - linux; arm variant v6
...
### `nginx:1.29.7-alpine3.23-perl` - linux; arm variant v7
...
### `nginx:1.29.7-alpine3.23-perl` - linux; arm64 variant v8
...
### `nginx:1.29.7-alpine3.23-perl` - linux; 386
...
### `nginx:1.29.7-alpine3.23-perl` - linux; ppc64le
...
### `nginx:1.29.7-alpine3.23-perl` - linux; s390x
