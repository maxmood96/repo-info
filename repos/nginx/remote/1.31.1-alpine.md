...
### `nginx:1.31.1-alpine` - linux; amd64
...
### `nginx:1.31.1-alpine` - unknown; unknown
...
### `nginx:1.31.1-alpine` - linux; arm variant v6
...
### `nginx:1.31.1-alpine` - linux; arm variant v7
...
### `nginx:1.31.1-alpine` - linux; arm64 variant v8
...
### `nginx:1.31.1-alpine` - linux; ppc64le
...
### `nginx:1.31.1-alpine` - linux; riscv64
...
### `nginx:1.31.1-alpine` - linux; s390x
