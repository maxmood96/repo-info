...
```console
$ docker pull nginx@sha256:af01f3bbc59df413e5c0fac20198189e7e3a49c0a99f1931d10313aff6730cf4
```
...
### `nginx:1.28.2-trixie-perl` - linux; amd64
...
### `nginx:1.28.2-trixie-perl` - unknown; unknown
...
### `nginx:1.28.2-trixie-perl` - linux; arm variant v5
...
### `nginx:1.28.2-trixie-perl` - linux; arm variant v7
...
### `nginx:1.28.2-trixie-perl` - linux; arm64 variant v8
...
### `nginx:1.28.2-trixie-perl` - linux; 386
...
### `nginx:1.28.2-trixie-perl` - linux; ppc64le
...
### `nginx:1.28.2-trixie-perl` - linux; s390x
