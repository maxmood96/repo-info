...
### `nginx:1.25.5-alpine3.19` - linux; amd64
...
### `nginx:1.25.5-alpine3.19` - unknown; unknown
...
### `nginx:1.25.5-alpine3.19` - linux; arm variant v6
...
### `nginx:1.25.5-alpine3.19` - linux; arm variant v7
...
### `nginx:1.25.5-alpine3.19` - linux; arm64 variant v8
...
### `nginx:1.25.5-alpine3.19` - linux; 386
...
### `nginx:1.25.5-alpine3.19` - linux; ppc64le
...
### `nginx:1.25.5-alpine3.19` - linux; s390x
