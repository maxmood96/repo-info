...
```console
$ docker pull nginx@sha256:18d8e812c83379aa57b181e72f1583570ca0e4145505ab93615aadfa5dc56c41
```
...
### `nginx:1.25.2-perl` - linux; arm variant v5
...
### `nginx:1.25.2-perl` - linux; arm variant v7
...
### `nginx:1.25.2-perl` - linux; arm64 variant v8
...
### `nginx:1.25.2-perl` - linux; mips64le
...
### `nginx:1.25.2-perl` - linux; ppc64le
