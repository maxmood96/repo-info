...
### `nginx:1.29.1-alpine3.22` - linux; amd64
...
### `nginx:1.29.1-alpine3.22` - unknown; unknown
...
### `nginx:1.29.1-alpine3.22` - linux; arm variant v6
...
### `nginx:1.29.1-alpine3.22` - linux; arm variant v7
...
### `nginx:1.29.1-alpine3.22` - linux; arm64 variant v8
...
### `nginx:1.29.1-alpine3.22` - linux; 386
...
### `nginx:1.29.1-alpine3.22` - linux; ppc64le
...
### `nginx:1.29.1-alpine3.22` - linux; riscv64
...
### `nginx:1.29.1-alpine3.22` - linux; s390x
