...
```console
$ docker pull nginx@sha256:5e46f6f392a50b44a59e0b45888bd17eab04cae199e5135083d9eed959eedbb0
```
...
### `nginx:mainline-alpine3.23-slim` - linux; amd64
...
### `nginx:mainline-alpine3.23-slim` - unknown; unknown
...
### `nginx:mainline-alpine3.23-slim` - linux; arm variant v6
...
### `nginx:mainline-alpine3.23-slim` - linux; arm variant v7
...
### `nginx:mainline-alpine3.23-slim` - linux; arm64 variant v8

```console
$ docker pull nginx@sha256:7a251f08c5b97f73f438090b5d7e32edd63d012f05cdbf76c26852323317cd14
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.1 MB (6075105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4f7ef15b758021c8b061df7107cd6f63971466ab9f09aab176eae8e0f507d9d`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:ae3af9eb820d0da0c5715086f2401706eca572944f34b34ea93fcd86d4e217f3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **505.2 KB (505231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:985c542d8a8b643cf94c04d751fd5c8709ade1e79727127d1cac4bbc4766cea2`

```dockerfile
```

-	Layers:
	-	`sha256:a45f42a9f7de7bf89b6b5f470c891ca84b0e06fe9335c26c0d4602def40b2bc1`  
		Last Modified: Tue, 10 Mar 2026 20:52:00 GMT  
		Size: 473.5 KB (473462 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f07d2ece87e5080dda82476f77480a4b89de3e5749ec2a37061d902535f3b5f9`  
		Last Modified: Tue, 10 Mar 2026 20:52:00 GMT  
		Size: 31.8 KB (31769 bytes)  
		MIME: application/vnd.in-toto+json

### `nginx:mainline-alpine3.23-slim` - linux; 386
...
### `nginx:mainline-alpine3.23-slim` - linux; ppc64le
...
### `nginx:mainline-alpine3.23-slim` - linux; riscv64

```console
$ docker pull nginx@sha256:f1496d3de549fe50e0d6b1aae6bea7134e64d5a264b3b3263bce1f0b0d02ca49
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.5 MB (5489343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5875efece8fd7b58bc7c25f9b73ff44a0c8e1ecb035a9130a23f728959642648`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:48c3509e569a44614aade6707a3bba84f94c63870117cf7556577732364237c1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **502.3 KB (502346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df4aaf5c7d93326c188c7bb8d0da9a2f0625f8b53fffb2991518d921234312e4`

```dockerfile
```

-	Layers:
	-	`sha256:e62ee09ff21f8129f517070e0c5b594d84c3e37e0cd8f3349bc0aa171cff7927`  
		Last Modified: Fri, 06 Feb 2026 01:10:53 GMT  
		Size: 473.4 KB (473399 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c07e3bd2649819181f388cfcc35847a93038ccf169eb7c37c4fbf960e90b2690`  
		Last Modified: Fri, 06 Feb 2026 01:10:53 GMT  
		Size: 28.9 KB (28947 bytes)  
		MIME: application/vnd.in-toto+json

### `nginx:mainline-alpine3.23-slim` - linux; s390x
