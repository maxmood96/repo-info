...
```console
$ docker pull nginx@sha256:81f4cbfd65622c0f0dd1b4b4219f71c70637b00b1b97b37464f1827d01cd2df0
```
...
```console
$ docker pull nginx@sha256:4875c9f9ef0b2983214be83b72e7d4f33c144fec6a4282fb9d11bc94dfec2931
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.8 MB (18806461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46a0d1c9e5e50b2ab2407355d16c635940637a56fb27849f2d631de94e2475c3`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:fc6433f8fed60d6261abfc4f2258708cc96e1f5e009e4c1c5548fb4c288ee2b4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.3 MB (18314407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8483cbb306e17eada00e49e89571372106dd1ebdce0266f0c8695cd04b19323`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
