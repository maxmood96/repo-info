...
```console
$ docker pull nginx@sha256:27831cd2056cc4ce168afa70df85ae1f6e3224ea8536940c0dedf0ca5e79de67
```
...
```console
$ docker pull nginx@sha256:62b0ebd387a8906cef0731b5ecb8489615d1f536a422a794371991f601a92f78
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.8 MB (15762456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99c4506e00e414d4db7a4166d8284c54991cbc2cd5bf06b4cdf5a538c6c24255`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:5ae047693141f468e8467083b2a745fcb59666d68bcf10390509f49afd94fdfc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.0 KB (23986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e934900db1f83930514ec719156cb9f84975e75f36a997b01eb749184a0a71d1`

```dockerfile
```

-	Layers:
	-	`sha256:8574d5c689bbd9c9a1a17703a475ecbbcb88cf3ca6d2009cb6c6c3ab8ffa5d25`  
		Last Modified: Tue, 30 Jan 2024 23:21:52 GMT  
