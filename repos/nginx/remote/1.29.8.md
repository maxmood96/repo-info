...
```console
$ docker pull nginx@sha256:99eb48cf8f9d7f74924fcf087882bd09fc0e816db40333f216cd5bac005b95ea
```
...
### `nginx:1.29.8` - linux; arm variant v5
...
### `nginx:1.29.8` - linux; arm variant v7
...
### `nginx:1.29.8` - linux; arm64 variant v8
