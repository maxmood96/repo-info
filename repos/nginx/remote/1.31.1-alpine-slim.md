## `nginx:1.31.1-alpine-slim`

```console
$ docker pull nginx@sha256:3fe7a344f234ac4b84817896c9294ffae74eae03fc1ad0ff502457fef5cebef8
```
...
### `nginx:1.31.1-alpine-slim` - linux; amd64
...
### `nginx:1.31.1-alpine-slim` - unknown; unknown
...
### `nginx:1.31.1-alpine-slim` - linux; arm variant v6
...
### `nginx:1.31.1-alpine-slim` - linux; arm variant v7
...
### `nginx:1.31.1-alpine-slim` - linux; arm64 variant v8
...
### `nginx:1.31.1-alpine-slim` - linux; 386
...
### `nginx:1.31.1-alpine-slim` - linux; ppc64le
...
### `nginx:1.31.1-alpine-slim` - linux; riscv64
...
### `nginx:1.31.1-alpine-slim` - linux; s390x
