...
```console
$ docker pull nginx@sha256:84c8aa3f998ea15a155545749d745ff976decf0c4117f334f47c9f42f945c4ea
```
...
### `nginx:1.25.4-alpine-perl` - linux; arm variant v6
...
### `nginx:1.25.4-alpine-perl` - linux; arm variant v7
