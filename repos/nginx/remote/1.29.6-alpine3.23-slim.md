...
```console
$ docker pull nginx@sha256:f4eadeef8cdf58386d9a4ab32cf9afff53b58e176d3309e78259427d62195c71
```
...
### `nginx:1.29.6-alpine3.23-slim` - linux; amd64
...
### `nginx:1.29.6-alpine3.23-slim` - unknown; unknown
...
### `nginx:1.29.6-alpine3.23-slim` - linux; arm variant v6
...
### `nginx:1.29.6-alpine3.23-slim` - linux; arm variant v7
...
### `nginx:1.29.6-alpine3.23-slim` - linux; arm64 variant v8
...
### `nginx:1.29.6-alpine3.23-slim` - linux; 386
...
### `nginx:1.29.6-alpine3.23-slim` - linux; ppc64le
...
### `nginx:1.29.6-alpine3.23-slim` - linux; s390x
