...
```console
$ docker pull nginx@sha256:bbab0f3cc1bbdb35c745818409ca7457d0959194c08e8554150e51c418a91ca1
```
...
### `nginx:1.28.2-alpine` - linux; amd64
...
### `nginx:1.28.2-alpine` - unknown; unknown
...
### `nginx:1.28.2-alpine` - linux; arm variant v6
...
### `nginx:1.28.2-alpine` - linux; arm variant v7
...
### `nginx:1.28.2-alpine` - linux; arm64 variant v8
...
### `nginx:1.28.2-alpine` - linux; ppc64le
...
### `nginx:1.28.2-alpine` - linux; s390x
