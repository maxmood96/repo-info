...
```console
$ docker pull nginx@sha256:a9719995288b7785814da2c7722c17efc2b25b2256aa15623a94340fdeef7c83
```
...
```console
$ docker pull nginx@sha256:7c5ed9802c21911e71b220c9b34732cca3fbbd2dd070b18d9a76dffd7d15c8dc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 MB (34100003 bytes)**  
...
-	Layers:
	...
	-	`sha256:a53100808f8943a9ff14b4843807b4141cca47498c4283d6aab09b76d9f77413`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:603a4f4169d9a52b492d124a139d90f51a9aea6a1d036b78b71e39f51a262556`  
		Last Modified: Thu, 06 Feb 2025 03:56:39 GMT  
		Size: 13.3 MB (13291330 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:mainline-alpine3.21-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:34ef9000a86a41c1a2cb41c1cdb439f9424cf2d318380e74aceb191bb7fe1397
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1051024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03667011439165f455aaf3b204922629a3bf45e70863a80d5be189bd6f184882`

```dockerfile
```

-	Layers:
	-	`sha256:81cc04a9722772b7ae57bbeaa029981f6237b77c7762a89edfd31d86a697f47f`  
		Last Modified: Thu, 06 Feb 2025 05:01:54 GMT  
		Size: 1.0 MB (1029666 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4d5c23099954a0b5918b349f35303f78679d6cbf8820a93ae1694291b2ef3340`  
		Last Modified: Thu, 06 Feb 2025 05:01:55 GMT  
...
```console
$ docker pull nginx@sha256:fec3d472cf546ed241148e0c2e51dbf05eae5efa69f0a60fc57d22fbd3dbdae0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.4 MB (34429527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a53441a0e63d9bfdbc80910ebfadfcac9a395569d4f33d5dc241136ee5352b52`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
-	Layers:
	...
	-	`sha256:8b08ab47bab0bd7dbf941ba6ef384fb95ebe848fda99f72c41a059d86e825e5f`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9f49a59957a77e0b28d5ec7cb2c24b87a5b47d5d3d85b2853703cb904e2fe587`  
		Last Modified: Thu, 06 Feb 2025 04:18:02 GMT  
		Size: 12.8 MB (12773349 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `nginx:mainline-alpine3.21-otel` - unknown; unknown

```console
$ docker pull nginx@sha256:63ab8ca971e64d1cce11aa0af8515115555750f222deafe050604d2b4753027b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1051328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31d6f115d843f12e56a6061b2a291216753c899dc4a54e675a729627c435671b`

```dockerfile
```

-	Layers:
	-	`sha256:15d0613d2074d312e5745f7bf272949f377e8400a6dc52bdded73f53eccf0687`  
		Last Modified: Thu, 06 Feb 2025 06:00:18 GMT  
		Size: 1.0 MB (1029794 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:eba3aae1cb47e0b26394704aa1203baf366b8954558f0e7775cdc9d69beabcf0`  
		Last Modified: Thu, 06 Feb 2025 06:00:19 GMT  
