...
```console
nginx-1.27.1-r1 description:
High performance web server

nginx-1.27.1-r1 webpage:
https://nginx.org/

nginx-1.27.1-r1 installed size:
2615 KiB

nginx-1.27.1-r1 license:
...
```console
nginx-module-geoip-1.27.1-r2 description:
nginx GeoIP dynamic modules

nginx-module-geoip-1.27.1-r2 webpage:
https://nginx.org/

nginx-module-geoip-1.27.1-r2 installed size:
74 KiB

nginx-module-geoip-1.27.1-r2 license:
2-clause BSD-like license
...
```console
nginx-module-image-filter-1.27.1-r2 description:
nginx image filter dynamic module

nginx-module-image-filter-1.27.1-r2 webpage:
https://nginx.org/

nginx-module-image-filter-1.27.1-r2 installed size:
56 KiB

nginx-module-image-filter-1.27.1-r2 license:
2-clause BSD-like license
...
```console
nginx-module-njs-1.27.1.0.8.5-r1 description:
nginx njs dynamic modules

nginx-module-njs-1.27.1.0.8.5-r1 webpage:
https://nginx.org/

nginx-module-njs-1.27.1.0.8.5-r1 installed size:
4841 KiB

nginx-module-njs-1.27.1.0.8.5-r1 license:
2-clause BSD-like license
...
```console
nginx-module-xslt-1.27.1-r2 description:
nginx xslt dynamic module

nginx-module-xslt-1.27.1-r2 webpage:
https://nginx.org/

nginx-module-xslt-1.27.1-r2 installed size:
56 KiB

nginx-module-xslt-1.27.1-r2 license:
2-clause BSD-like license
