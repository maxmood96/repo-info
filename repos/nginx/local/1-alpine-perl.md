...
```console
nginx-module-perl-1.19.9-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.19.9-r1 webpage:
https://nginx.org/

nginx-module-perl-1.19.9-r1 installed size:
159744

nginx-module-perl-1.19.9-r1 license:
2-clause BSD-like license
