...
- Created: `2026-01-09T19:05:56.842483023Z`
- Virtual Size: ~ 102.37 Mb  
...
```console
nginx-module-perl-1.29.4-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.29.4-r1 webpage:
https://nginx.org/

nginx-module-perl-1.29.4-r1 installed size:
85 KiB

nginx-module-perl-1.29.4-r1 license:
2-clause BSD-like license
