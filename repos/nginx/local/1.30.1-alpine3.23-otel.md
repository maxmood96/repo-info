...
- Created: `2026-05-19T21:32:19.737682461Z`
...
```console
nginx-module-otel-1.30.1.0.1.2-r1 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.30.1.0.1.2-r1 webpage:
https://nginx.org/

nginx-module-otel-1.30.1.0.1.2-r1 installed size:
708 KiB

nginx-module-otel-1.30.1.0.1.2-r1 license:
2-clause BSD-like license
