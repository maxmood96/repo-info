...
- Created: `2021-02-17T23:53:17.944579454Z`
- Virtual Size: ~ 57.17 Mb  
...
```console
nginx-module-perl-1.19.7-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.19.7-r1 webpage:
https://nginx.org/

nginx-module-perl-1.19.7-r1 installed size:
159744

nginx-module-perl-1.19.7-r1 license:
2-clause BSD-like license
