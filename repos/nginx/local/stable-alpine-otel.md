...
```console
nginx-module-otel-1.26.1.0.1.0-r2 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.26.1.0.1.0-r2 webpage:
https://nginx.org/

nginx-module-otel-1.26.1.0.1.0-r2 installed size:
6612 KiB

nginx-module-otel-1.26.1.0.1.0-r2 license:
2-clause BSD-like license
