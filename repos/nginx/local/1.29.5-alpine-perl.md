...
- Created: `2026-02-05T01:10:42.068667593Z`
- Virtual Size: ~ 102.59 Mb  
...
```console
nginx-module-perl-1.29.5-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.29.5-r1 webpage:
https://nginx.org/

nginx-module-perl-1.29.5-r1 installed size:
85 KiB

nginx-module-perl-1.29.5-r1 license:
2-clause BSD-like license
