...
- Created: `2026-02-05T01:11:26.218276197Z`
...
```console
nginx-module-perl-1.28.2-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.28.2-r1 webpage:
https://nginx.org/

nginx-module-perl-1.28.2-r1 installed size:
85 KiB

nginx-module-perl-1.28.2-r1 license:
2-clause BSD-like license
