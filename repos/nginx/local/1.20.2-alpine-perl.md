...
- Created: `2021-11-16T18:22:46.720218105Z`
...
```console
nginx-module-perl-1.20.2-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.20.2-r1 webpage:
https://nginx.org/

nginx-module-perl-1.20.2-r1 installed size:
156 KiB

nginx-module-perl-1.20.2-r1 license:
2-clause BSD-like license
