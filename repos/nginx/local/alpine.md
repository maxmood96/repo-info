...
```console
aom-libs-3.7.1-r0 description:
Alliance for Open Media (AOM) AV1 codec SDK (libraries)

aom-libs-3.7.1-r0 webpage:
https://aomedia.org/

aom-libs-3.7.1-r0 installed size:
7396 KiB

aom-libs-3.7.1-r0 license:
...
```console
geoip-1.6.12-r5 description:
Lookup countries by IP addresses

geoip-1.6.12-r5 webpage:
http://www.maxmind.com/app/ip-location

geoip-1.6.12-r5 installed size:
252 KiB
...
```console
libavif-1.0.3-r0 description:
Library for encoding and decoding .avif files

libavif-1.0.3-r0 webpage:
https://aomediacodec.github.io/av1-avif/

libavif-1.0.3-r0 installed size:
164 KiB

libavif-1.0.3-r0 license:
BSD-2-Clause
...
```console
libdav1d-1.3.0-r1 description:
small and fast AV1 Decoder (libraries)

libdav1d-1.3.0-r1 webpage:
https://code.videolan.org/videolan/dav1d

libdav1d-1.3.0-r1 installed size:
1680 KiB

libdav1d-1.3.0-r1 license:
BSD-2-Clause
...
```console
libedit-20230828.3.1-r3 description:
BSD line editing library

libedit-20230828.3.1-r3 webpage:
https://www.thrysoee.dk/editline

libedit-20230828.3.1-r3 installed size:
188 KiB

libedit-20230828.3.1-r3 license:
BSD-3-Clause
...
```console
libgd-2.3.3-r8 description:
Library for the dynamic creation of images by programmers (libraries)

libgd-2.3.3-r8 webpage:
https://libgd.github.io/

libgd-2.3.3-r8 installed size:
356 KiB

libgd-2.3.3-r8 license:
custom
...
```console
libice-1.1.1-r5 description:
X11 Inter-Client Exchange library

libice-1.1.1-r5 webpage:
https://xorg.freedesktop.org/

libice-1.1.1-r5 installed size:
100 KiB

libice-1.1.1-r5 license:
X11
...
```console
libsm-1.2.4-r3 description:
X11 Session Management library

libsm-1.2.4-r3 webpage:
https://xorg.freedesktop.org/

libsm-1.2.4-r3 installed size:
48 KiB

libsm-1.2.4-r3 license:
MIT
...
```console
libuuid-2.39.3-r0 description:
DCE compatible Universally Unique Identifier library

libuuid-2.39.3-r0 webpage:
https://git.kernel.org/cgit/utils/util-linux/util-linux.git

libuuid-2.39.3-r0 installed size:
40 KiB
...
```console
libxslt-1.1.39-r0 description:
XML stylesheet transformation library

libxslt-1.1.39-r0 webpage:
http://xmlsoft.org/XSLT/

libxslt-1.1.39-r0 installed size:
356 KiB

libxslt-1.1.39-r0 license:
X11
...
```console
libxt-1.3.0-r4 description:
X11 toolkit intrinsics library

libxt-1.3.0-r4 webpage:
https://xorg.freedesktop.org/

libxt-1.3.0-r4 installed size:
360 KiB

libxt-1.3.0-r4 license:
MIT
