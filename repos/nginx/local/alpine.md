...
- Created: `2023-08-09T02:15:48.864288331Z`
...
```console
geoip-1.6.12-r3 description:
Lookup countries by IP addresses

geoip-1.6.12-r3 webpage:
http://www.maxmind.com/app/ip-location

geoip-1.6.12-r3 installed size:
268 KiB

geoip-1.6.12-r3 license:
GPL
...
```console
libavif-0.11.1-r0 description:
Library for encoding and decoding .avif files

libavif-0.11.1-r0 webpage:
https://aomediacodec.github.io/av1-avif/

libavif-0.11.1-r0 installed size:
144 KiB

libavif-0.11.1-r0 license:
BSD-2-Clause
...
```console
libdav1d-1.0.0-r2 description:
small and fast AV1 Decoder (libraries)

libdav1d-1.0.0-r2 webpage:
https://code.videolan.org/videolan/dav1d

libdav1d-1.0.0-r2 installed size:
1628 KiB

libdav1d-1.0.0-r2 license:
BSD-2-Clause
...
```console
libedit-20221030.3.1-r0 description:
BSD line editing library

libedit-20221030.3.1-r0 webpage:
https://www.thrysoee.dk/editline

libedit-20221030.3.1-r0 installed size:
204 KiB

libedit-20221030.3.1-r0 license:
BSD-3-Clause
...
```console
libgd-2.3.3-r3 description:
Library for the dynamic creation of images by programmers (libraries)

libgd-2.3.3-r3 webpage:
https://libgd.github.io/

libgd-2.3.3-r3 installed size:
388 KiB

libgd-2.3.3-r3 license:
custom
...
```console
libice-1.0.10-r1 description:
X11 Inter-Client Exchange library

libice-1.0.10-r1 webpage:
http://xorg.freedesktop.org/

libice-1.0.10-r1 installed size:
104 KiB

libice-1.0.10-r1 license:
X11
...
```console
libsm-1.2.3-r1 description:
X11 Session Management library

libsm-1.2.3-r1 webpage:
https://xorg.freedesktop.org/

libsm-1.2.3-r1 installed size:
48 KiB

libsm-1.2.3-r1 license:
MIT
