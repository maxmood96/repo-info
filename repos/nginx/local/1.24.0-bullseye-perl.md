...
- Created: `2023-11-21T09:06:24.473744018Z`
...
### `dpkg` source package: `base-files=11.1+deb11u8`
...
### `dpkg` source package: `geoip=1.6.12-7`

Binary Packages:

- `libgeoip1:amd64=1.6.12-7`
...
```console
$ apt-get source -qq --print-uris geoip=1.6.12-7
'http://deb.debian.org/debian/pool/main/g/geoip/geoip_1.6.12-7.dsc' geoip_1.6.12-7.dsc 1837 SHA256:f25a9f484b754b2708032411041639bce058253d33d960d40740c369a141de26
...
'http://deb.debian.org/debian/pool/main/g/geoip/geoip_1.6.12-7.debian.tar.xz' geoip_1.6.12-7.debian.tar.xz 37960 SHA256:9dcd7c8dc1b90735955e516ed34d071dfe44057b97b301f02d86a5c0bb1c10bd
```

Other potentially useful URLs:

- https://sources.debian.net/src/geoip/1.6.12-7/ (for browsing the source)
- https://sources.debian.net/src/geoip/1.6.12-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/geoip/1.6.12-7/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `gettext=0.21-4`
...
```console
$ apt-get source -qq --print-uris gettext=0.21-4
'http://deb.debian.org/debian/pool/main/g/gettext/gettext_0.21-4.dsc' gettext_0.21-4.dsc 2219 SHA256:14d3b61087489802bfc1563f0b24f6de4976fca29fb520ec5e3e2c1e39cda5a4
...
'http://deb.debian.org/debian/pool/main/g/gettext/gettext_0.21-4.debian.tar.xz' gettext_0.21-4.debian.tar.xz 36684 SHA256:317f7c1fa318a8dff1eb6f18936ae0ad5922bef5c78108fadb4939b33cd49ccc
```

Other potentially useful URLs:

- https://sources.debian.net/src/gettext/0.21-4/ (for browsing the source)
- https://sources.debian.net/src/gettext/0.21-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gettext/0.21-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `glibc=2.31-13+deb11u7`
...
```console
$ apt-get source -qq --print-uris glibc=2.31-13+deb11u7
'http://deb.debian.org/debian-security/pool/updates/main/g/glibc/glibc_2.31-13%2bdeb11u7.dsc' glibc_2.31-13+deb11u7.dsc 8347 SHA256:ef256773d8984fa49f21675aeedc8f34a24a5efbb9146df2d3a7b7324dd01ea6
...
'http://deb.debian.org/debian-security/pool/updates/main/g/glibc/glibc_2.31-13%2bdeb11u7.debian.tar.xz' glibc_2.31-13+deb11u7.debian.tar.xz 960160 SHA256:4e656c6c048f8549a48164e492bbbf4cffd9b6ff3a6cf77bf3cba72544934fd8
```

Other potentially useful URLs:

- https://sources.debian.net/src/glibc/2.31-13+deb11u7/ (for browsing the source)
- https://sources.debian.net/src/glibc/2.31-13+deb11u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glibc/2.31-13+deb11u7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libxml2=2.9.10+dfsg-6.7+deb11u4`
...
```console
$ apt-get source -qq --print-uris libxml2=2.9.10+dfsg-6.7+deb11u4
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.9.10%2bdfsg-6.7%2bdeb11u4.dsc' libxml2_2.9.10+dfsg-6.7+deb11u4.dsc 2859 SHA256:db8806a35ae170159cf267bb83296f1fd6310dedab53450e4d3f5e8af2937c4a
...
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.9.10%2bdfsg-6.7%2bdeb11u4.debian.tar.xz' libxml2_2.9.10+dfsg-6.7+deb11u4.debian.tar.xz 41904 SHA256:62037376765cc8e5961771d758b8efa9fddce3cce6fd67c31bc111ddff656654
```

Other potentially useful URLs:

- https://sources.debian.net/src/libxml2/2.9.10+dfsg-6.7+deb11u4/ (for browsing the source)
- https://sources.debian.net/src/libxml2/2.9.10+dfsg-6.7+deb11u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libxml2/2.9.10+dfsg-6.7+deb11u4/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian-security/pool/updates/main/libx/libxpm/libxpm_3.5.12-1.1%2bdeb11u1.dsc' libxpm_3.5.12-1.1+deb11u1.dsc 2133 SHA256:60b0c50c28421fa96ea6d7eba22c1c6907dee9b27bf3470afb7693561e898fe8
'http://deb.debian.org/debian-security/pool/updates/main/libx/libxpm/libxpm_3.5.12.orig.tar.gz' libxpm_3.5.12.orig.tar.gz 529302 SHA256:2523acc780eac01db5163267b36f5b94374bfb0de26fc0b5a7bee76649fd8501
'http://deb.debian.org/debian-security/pool/updates/main/libx/libxpm/libxpm_3.5.12-1.1%2bdeb11u1.diff.gz' libxpm_3.5.12-1.1+deb11u1.diff.gz 22644 SHA256:2fda4c61290da26da7a643f001c9996c8533b2741b62a3d2cd0ee81900d484d4
```
...
### `dpkg` source package: `nginx-module-perl=1.24.0-1~bullseye`

Binary Packages:

- `nginx-module-perl=1.24.0-1~bullseye`
...
### `dpkg` source package: `tzdata=2021a-1+deb11u10`
...
```console
$ apt-get source -qq --print-uris tzdata=2021a-1+deb11u10
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2021a-1%2bdeb11u10.dsc' tzdata_2021a-1+deb11u10.dsc 2273 SHA256:3dcc2aa8317ef9249109c3bb99fe03cbac4fe046990f5f221b1e3f1af281f892
...
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2021a-1%2bdeb11u10.debian.tar.xz' tzdata_2021a-1+deb11u10.debian.tar.xz 124508 SHA256:7c1d5c37261cd7cf5868c59e7aa5868a553a98792680f2475ef9756eaf1ccdce
```

Other potentially useful URLs:

- https://sources.debian.net/src/tzdata/2021a-1+deb11u10/ (for browsing the source)
- https://sources.debian.net/src/tzdata/2021a-1+deb11u10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tzdata/2021a-1+deb11u10/ (for access to the source package after it no longer exists in the archive)
