...
```console
nginx-1.28.0-r1 description:
High performance web server

nginx-1.28.0-r1 webpage:
https://nginx.org/

nginx-1.28.0-r1 installed size:
2647 KiB

nginx-1.28.0-r1 license:
...
```console
nginx-module-geoip-1.28.0-r1 description:
nginx GeoIP dynamic modules

nginx-module-geoip-1.28.0-r1 webpage:
https://nginx.org/

nginx-module-geoip-1.28.0-r1 installed size:
62 KiB

nginx-module-geoip-1.28.0-r1 license:
2-clause BSD-like license
...
```console
nginx-module-image-filter-1.28.0-r1 description:
nginx image filter dynamic module

nginx-module-image-filter-1.28.0-r1 webpage:
https://nginx.org/

nginx-module-image-filter-1.28.0-r1 installed size:
46 KiB

nginx-module-image-filter-1.28.0-r1 license:
2-clause BSD-like license
...
```console
nginx-module-njs-1.28.0.0.8.10-r1 description:
nginx njs dynamic modules

nginx-module-njs-1.28.0.0.8.10-r1 webpage:
https://nginx.org/

nginx-module-njs-1.28.0.0.8.10-r1 installed size:
9224 KiB

nginx-module-njs-1.28.0.0.8.10-r1 license:
2-clause BSD-like license
...
```console
nginx-module-perl-1.28.0-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.28.0-r1 webpage:
https://nginx.org/

nginx-module-perl-1.28.0-r1 installed size:
85 KiB

nginx-module-perl-1.28.0-r1 license:
2-clause BSD-like license
...
```console
nginx-module-xslt-1.28.0-r1 description:
nginx xslt dynamic module

nginx-module-xslt-1.28.0-r1 webpage:
https://nginx.org/

nginx-module-xslt-1.28.0-r1 installed size:
46 KiB

nginx-module-xslt-1.28.0-r1 license:
2-clause BSD-like license
