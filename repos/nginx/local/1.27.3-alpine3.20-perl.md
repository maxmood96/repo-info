...
```console
nginx-module-perl-1.27.3-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.27.3-r1 webpage:
https://nginx.org/

nginx-module-perl-1.27.3-r1 installed size:
103 KiB

nginx-module-perl-1.27.3-r1 license:
2-clause BSD-like license
