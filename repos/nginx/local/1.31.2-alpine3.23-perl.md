...
- Created: `2026-06-17T23:22:23.227989781Z`
- Virtual Size: ~ 108.92 Mb  
...
```console
nginx-module-perl-1.31.2-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.31.2-r1 webpage:
https://nginx.org/

nginx-module-perl-1.31.2-r1 installed size:
85 KiB

nginx-module-perl-1.31.2-r1 license:
2-clause BSD-like license
