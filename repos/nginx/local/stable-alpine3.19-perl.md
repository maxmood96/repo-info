...
- Image ID: `sha256:27f43866f4acebdd803d68756fe078e55628500879476dfa3103e97100344316`
...
```console
nginx-1.26.1-r2 description:
High performance web server

nginx-1.26.1-r2 webpage:
https://nginx.org/

nginx-1.26.1-r2 installed size:
2720 KiB

nginx-1.26.1-r2 license:
...
```console
nginx-module-geoip-1.26.1-r2 description:
nginx GeoIP dynamic modules

nginx-module-geoip-1.26.1-r2 webpage:
https://nginx.org/

nginx-module-geoip-1.26.1-r2 installed size:
100 KiB

nginx-module-geoip-1.26.1-r2 license:
2-clause BSD-like license
...
```console
nginx-module-image-filter-1.26.1-r2 description:
nginx image filter dynamic module

nginx-module-image-filter-1.26.1-r2 webpage:
https://nginx.org/

nginx-module-image-filter-1.26.1-r2 installed size:
84 KiB

nginx-module-image-filter-1.26.1-r2 license:
2-clause BSD-like license
...
```console
nginx-module-njs-1.26.1.0.8.4-r2 description:
nginx njs dynamic modules

nginx-module-njs-1.26.1.0.8.4-r2 webpage:
https://nginx.org/

nginx-module-njs-1.26.1.0.8.4-r2 installed size:
4756 KiB

nginx-module-njs-1.26.1.0.8.4-r2 license:
2-clause BSD-like license
...
```console
nginx-module-perl-1.26.1-r2 description:
nginx Perl dynamic module

nginx-module-perl-1.26.1-r2 webpage:
https://nginx.org/

nginx-module-perl-1.26.1-r2 installed size:
156 KiB

nginx-module-perl-1.26.1-r2 license:
2-clause BSD-like license
...
```console
nginx-module-xslt-1.26.1-r2 description:
nginx xslt dynamic module

nginx-module-xslt-1.26.1-r2 webpage:
https://nginx.org/

nginx-module-xslt-1.26.1-r2 installed size:
84 KiB

nginx-module-xslt-1.26.1-r2 license:
2-clause BSD-like license
