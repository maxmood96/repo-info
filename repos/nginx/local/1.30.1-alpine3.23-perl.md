...
```console
geoip-1.6.12-r6 description:
Lookup countries by IP addresses

geoip-1.6.12-r6 webpage:
...
```console
libgd-2.3.3-r10 description:
Library for the dynamic creation of images by programmers (libraries)

libgd-2.3.3-r10 webpage:
https://libgd.github.io/

libgd-2.3.3-r10 installed size:
344 KiB

libgd-2.3.3-r10 license:
GD
...
```console
nginx-module-perl-1.30.1-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.30.1-r1 webpage:
https://nginx.org/

nginx-module-perl-1.30.1-r1 installed size:
85 KiB

nginx-module-perl-1.30.1-r1 license:
2-clause BSD-like license
...
```console
perl-5.42.2-r0 description:
Larry Wall's Practical Extraction and Report Language

perl-5.42.2-r0 webpage:
https://www.perl.org/

perl-5.42.2-r0 installed size:
38 MiB

perl-5.42.2-r0 license:
