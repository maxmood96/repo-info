...
- Created: `2023-10-21T02:43:17.788034104Z`
- Virtual Size: ~ 42.60 Mb  
...
```console
libavif-0.11.1-r2 description:
Library for encoding and decoding .avif files

libavif-0.11.1-r2 webpage:
https://aomediacodec.github.io/av1-avif/

libavif-0.11.1-r2 installed size:
152 KiB

libavif-0.11.1-r2 license:
BSD-2-Clause
...
```console
libdav1d-1.2.1-r0 description:
small and fast AV1 Decoder (libraries)

libdav1d-1.2.1-r0 webpage:
https://code.videolan.org/videolan/dav1d

libdav1d-1.2.1-r0 installed size:
1680 KiB

libdav1d-1.2.1-r0 license:
BSD-2-Clause
...
```console
libgd-2.3.3-r7 description:
Library for the dynamic creation of images by programmers (libraries)

libgd-2.3.3-r7 webpage:
https://libgd.github.io/

libgd-2.3.3-r7 installed size:
360 KiB

libgd-2.3.3-r7 license:
custom
...
```console
libice-1.1.1-r2 description:
X11 Inter-Client Exchange library

libice-1.1.1-r2 webpage:
https://xorg.freedesktop.org/

libice-1.1.1-r2 installed size:
100 KiB

libice-1.1.1-r2 license:
X11
...
```console
libsm-1.2.4-r1 description:
X11 Session Management library

libsm-1.2.4-r1 webpage:
https://xorg.freedesktop.org/

libsm-1.2.4-r1 installed size:
48 KiB

libsm-1.2.4-r1 license:
MIT
...
```console
libxpm-3.5.16-r1 description:
X11 pixmap library

libxpm-3.5.16-r1 webpage:
https://xorg.freedesktop.org/

libxpm-3.5.16-r1 installed size:
136 KiB

libxpm-3.5.16-r1 license:
X11
...
```console
libxslt-1.1.38-r0 description:
XML stylesheet transformation library

libxslt-1.1.38-r0 webpage:
http://xmlsoft.org/XSLT/

libxslt-1.1.38-r0 installed size:
360 KiB

libxslt-1.1.38-r0 license:
X11
...
```console
libxt-1.3.0-r2 description:
X11 toolkit intrinsics library

libxt-1.3.0-r2 webpage:
https://xorg.freedesktop.org/

libxt-1.3.0-r2 installed size:
364 KiB

libxt-1.3.0-r2 license:
MIT
