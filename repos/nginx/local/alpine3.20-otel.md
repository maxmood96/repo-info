...
```console
nginx-module-otel-1.27.1.0.1.0-r1 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.27.1.0.1.0-r1 webpage:
https://nginx.org/

nginx-module-otel-1.27.1.0.1.0-r1 installed size:
6600 KiB

nginx-module-otel-1.27.1.0.1.0-r1 license:
2-clause BSD-like license
