...
```console
nginx-module-perl-1.26.0-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.26.0-r1 webpage:
https://nginx.org/

nginx-module-perl-1.26.0-r1 installed size:
156 KiB

nginx-module-perl-1.26.0-r1 license:
2-clause BSD-like license
