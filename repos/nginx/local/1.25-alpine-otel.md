...
```console
nginx-module-njs-1.25.5.0.8.4-r1 description:
nginx njs dynamic modules

nginx-module-njs-1.25.5.0.8.4-r1 webpage:
https://nginx.org/

nginx-module-njs-1.25.5.0.8.4-r1 installed size:
4756 KiB

nginx-module-njs-1.25.5.0.8.4-r1 license:
2-clause BSD-like license
...
```console
nginx-module-otel-1.25.5.0.1.0-r1 description:
nginx OpenTelemetry dynamic module

nginx-module-otel-1.25.5.0.1.0-r1 webpage:
https://nginx.org/

nginx-module-otel-1.25.5.0.1.0-r1 installed size:
6612 KiB

nginx-module-otel-1.25.5.0.1.0-r1 license:
2-clause BSD-like license
