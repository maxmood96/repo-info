...
```console
nginx-module-perl-1.27.0-r2 description:
nginx Perl dynamic module

nginx-module-perl-1.27.0-r2 webpage:
https://nginx.org/

nginx-module-perl-1.27.0-r2 installed size:
156 KiB

nginx-module-perl-1.27.0-r2 license:
2-clause BSD-like license
