...
- Created: `2021-12-29T19:29:29.08519221Z`
...
```console
nginx-module-perl-1.21.5-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.21.5-r1 webpage:
https://nginx.org/

nginx-module-perl-1.21.5-r1 installed size:
156 KiB

nginx-module-perl-1.21.5-r1 license:
2-clause BSD-like license
