...
### `gradle:8.14.1-jdk24-noble` - linux; amd64
...
### `gradle:8.14.1-jdk24-noble` - unknown; unknown
...
### `gradle:8.14.1-jdk24-noble` - linux; arm64 variant v8
...
### `gradle:8.14.1-jdk24-noble` - linux; ppc64le
...
### `gradle:8.14.1-jdk24-noble` - linux; riscv64
...
### `gradle:8.14.1-jdk24-noble` - linux; s390x
