...
### `gradle:8.10.0-jdk22-jammy` - linux; amd64
...
### `gradle:8.10.0-jdk22-jammy` - unknown; unknown
...
### `gradle:8.10.0-jdk22-jammy` - linux; arm64 variant v8
...
### `gradle:8.10.0-jdk22-jammy` - linux; ppc64le
...
### `gradle:8.10.0-jdk22-jammy` - linux; s390x
