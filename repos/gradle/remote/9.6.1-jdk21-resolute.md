...
### `gradle:9.6.1-jdk21-resolute` - linux; amd64
...
### `gradle:9.6.1-jdk21-resolute` - unknown; unknown
...
### `gradle:9.6.1-jdk21-resolute` - linux; arm64 variant v8
...
### `gradle:9.6.1-jdk21-resolute` - linux; ppc64le
...
### `gradle:9.6.1-jdk21-resolute` - linux; s390x
