...
```console
$ docker pull gradle@sha256:232acbc19e676b34f4b4c6ed5993e7952524fcce706200874a8972ecfe7a3c68
```
...
```console
$ docker pull gradle@sha256:766951d29491bad6d81c035223a419e25896104fe87026fbbc2a7f303d482095
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **376.9 MB (376882759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:846629455755dcfe1b287d8b09b026fca4dad8bd224adbf8ac744f9bae52d504`
...
-	Layers:
	...
	-	`sha256:d86465bff3842a5d2ae6136edb2eabd81ab6efed940af298c30942cb58c43678`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:859e365b2ef88b4586d06bbe29028fb232ae81b014c6d76b81db761cd02a3e18`  
		Last Modified: Sat, 02 Dec 2023 06:21:24 GMT  
		Size: 132.5 MB (132544680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c791b94870cb1aee902676390cb3d512ef1ca3d2d0200d7eace4cc3c52a861b`  
		Last Modified: Sat, 02 Dec 2023 06:21:17 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:6b7d26acc02cc5271752e312572a026edef4dedafdd2711ffbce6f86460222f0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **373.8 MB (373845386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:032c1615460ccedb659b5652b0389dbcf7b221e0473b761e42938c3e91223247`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Sat, 02 Dec 2023 07:45:31 GMT
ENV GRADLE_VERSION=8.5
# Sat, 02 Dec 2023 07:45:31 GMT
ARG GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
# Sat, 02 Dec 2023 07:45:36 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 07:45:37 GMT
USER gradle
# Sat, 02 Dec 2023 07:45:38 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Sat, 02 Dec 2023 07:45:38 GMT
USER root
...
-	Layers:
	...
	-	`sha256:4732723b67bd4175948ef9fa32c607fb3a3e3bd0133033a598496188ed6070f0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc63e3e9af0396187d1b606d9fefde3730a13ee020469ba1454a8c58def9db5e`  
		Last Modified: Sat, 02 Dec 2023 07:50:44 GMT  
		Size: 132.5 MB (132544661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bf11d5e3b413648760f2fffe7d229c6c8353f87d377bf39e1d1436bb37d8c6b`  
		Last Modified: Sat, 02 Dec 2023 07:50:36 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:bab931ee545113116407e011d593461ca0ea5a9fdb59e5a43c66049a6f618115
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **374.6 MB (374622441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:041bff26396386c1163dd0e73b64c75fdf8531d094fe83c4fa50d53e3642f2ad`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 05:46:42 GMT
USER gradle
# Sat, 02 Dec 2023 05:46:43 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Sat, 02 Dec 2023 05:46:43 GMT
USER root
...
-	Layers:
	...
	-	`sha256:b56489d67fba3377c2504db76aad64fa82764f9c976c9244239d69f4931f6263`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9483ca9bccaf42572ef41281ded5913c7f26805b25c8c161892939fa27109c1d`  
		Last Modified: Sat, 02 Dec 2023 05:52:39 GMT  
		Size: 132.5 MB (132544690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26cf7444f7a70c8c4cc809f7296714165ea3482b761926abdee5fca2688d3cd3`  
		Last Modified: Sat, 02 Dec 2023 05:52:33 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:47dcc7d0b8ae96ef214ae74028212bfb70ddced9f918f54ddbc71fad67f9eb32
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **363.9 MB (363926360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff7faf0d7399a9ffc5391dbcc6d5b9f3332169ba223a1ad857e251f5e4558049`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Sat, 02 Dec 2023 07:13:27 GMT
ENV GRADLE_VERSION=8.5
# Sat, 02 Dec 2023 07:13:28 GMT
ARG GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
# Sat, 02 Dec 2023 07:13:52 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 07:14:05 GMT
USER gradle
# Sat, 02 Dec 2023 07:14:07 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Sat, 02 Dec 2023 07:14:08 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:c2ac9a8099b80f03ab41f2a6abb56be962a29d8fa25f2132e365c2ed652b3cfb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0243f0aa69897700894fde0a1a36a2d4b2bedbac4945e7f0e4cc7cd054dfbc46`  
		Last Modified: Sat, 02 Dec 2023 07:22:08 GMT  
		Size: 132.5 MB (132544663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7ef0c75db3e20bb16851123c3ead9ae5664a2b51fa5a204659d97534846c4f9`  
		Last Modified: Sat, 02 Dec 2023 07:22:03 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
