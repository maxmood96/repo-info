...
```console
$ docker pull gradle@sha256:150f26f67be4258a43d137800621ef9446391b7994bf7923d36aa8d4afde28f3
```
...
```console
$ docker pull gradle@sha256:26163f2c4217747c6cf629767334d4154418601a8f86a70150009abdc31625d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **413.6 MB (413551383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70fc4bb3030332c8cd580a3a653980107c672f124cd814ee942e1a3b70a6065f`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 26 Aug 2022 02:58:09 GMT
ENV GRADLE_VERSION=7.5.1
# Fri, 26 Aug 2022 02:58:09 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Fri, 26 Aug 2022 02:58:16 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:d5bf920092f1bd7357654ef01c4f01bc03bb82b916d04bcfa32621731e4615c4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c84a23afd8adc9e0eea78a7cde0ee3448f2322e04a56760cf8dca441674b7b0d`  
		Last Modified: Fri, 26 Aug 2022 03:09:32 GMT  
...
```console
$ docker pull gradle@sha256:da050b0d6848e66c4bc5ea5e09b089a055eeede1192c7805a0b4c960cbb16a20
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **441.2 MB (441193815 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a4fe8bc012b6f9ba74a2e1ac6f2314c1ad4ca3d0e24e2d72897452a3c4b1bbb`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 02 Sep 2022 06:19:24 GMT
ENV GRADLE_VERSION=7.5.1
# Fri, 02 Sep 2022 06:19:24 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Fri, 02 Sep 2022 06:19:34 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b98ad9b43bf1952fb0a4466c14b928a92c8e8fa34625215ac47312b6ac859e5d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ee5fbea40a70e4335e811875f0563948b76f92b6b16146ec1b2e1d25965cffb`  
		Last Modified: Fri, 02 Sep 2022 06:33:03 GMT  
...
```console
$ docker pull gradle@sha256:1c480645565158c1e851f990d4ac4de286ca5bf2180d328f1b566cd05351e9d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **411.9 MB (411935735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36af4bc8ea34ccbf076bb5fa49e4c94915b50d5b4dbcdd6f102e15b4e6b061b4`
-	Default Command: `["gradle"]`
...
ENV GRADLE_VERSION=7.5.1
# Fri, 02 Sep 2022 02:30:36 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Fri, 02 Sep 2022 02:30:48 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:bff983ab6ab62b5fec5ae88a87ab15c1daf5d3ba0b3e4c9bf0ae07b8b0cfdb76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3243099cb35bd85f43c7a8af4d6761c9d1a1557694a919947ba271428e4e833c`  
