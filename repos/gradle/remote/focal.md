...
```console
$ docker pull gradle@sha256:03dd4f2a4cefb9f697f1951f8ed27cae2a3712841dee46134f5051f0ed45e71d
```
...
```console
$ docker pull gradle@sha256:696ebc4b81704e8e9fcaf004faa3800d47da8f678026080b9dfa8ba807dde749
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.8 MB (426807584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fd1b3447ff1c0112d46713d208c23d7c8db9359a7bba5a92ede6f36add4c5f7`
...
-	Layers:
	...
	-	`sha256:9cf6852eadfb5ca048ed11a12941582af6aa0f2c5bbb657c1d17da0432cca956`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a14130c89a38ee3e5bb357a8f6d3316684982085a78bba6e9fcdea7000da0e9`  
		Last Modified: Wed, 24 Aug 2022 19:58:15 GMT  
		Size: 4.4 KB (4359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5498af269e9ff5d9625381495b4dc3210ab5718e704d8090d82d564e9d0e63d3`  
		Last Modified: Wed, 24 Aug 2022 19:58:26 GMT  
		Size: 65.3 MB (65306672 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04ec8667a5fed7f425f107de1a247e9e9865fed6c45efd9823099b685d552b1a`  
		Last Modified: Wed, 24 Aug 2022 19:58:22 GMT  
...
```console
$ docker pull gradle@sha256:d576c0a715224b82a2e6beb571389f35393bcee1586dfa9e24ec5070a3bfbac1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **424.6 MB (424640233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7186bd2964c4a6a9121d8cbe8d7f3796bea124462cfddd22f3be515b60915e92`
-	Default Command: `["gradle"]`
...
# Wed, 24 Aug 2022 19:42:33 GMT
CMD ["jshell"]
# Wed, 24 Aug 2022 20:30:43 GMT
CMD ["gradle"]
# Wed, 24 Aug 2022 20:30:44 GMT
ENV GRADLE_HOME=/opt/gradle
# Wed, 24 Aug 2022 20:30:45 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln --symbolic /home/gradle/.gradle /root/.gradle
# Wed, 24 Aug 2022 20:30:46 GMT
VOLUME [/home/gradle/.gradle]
# Wed, 24 Aug 2022 20:30:47 GMT
WORKDIR /home/gradle
# Wed, 24 Aug 2022 20:31:10 GMT
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Aug 2022 20:31:11 GMT
ENV GRADLE_VERSION=7.5.1
# Wed, 24 Aug 2022 20:31:12 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
...
-	Layers:
	...
	-	`sha256:e16045745fcc8bef66b5a239924807d14f1343126bbcc5a7608dcb0ca4e176d5`  
		...
		Size: 157.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c61cff4bba7de632f0aef6fd400268c8859c33d2ad19b28b17a2b93d2b4d719e`  
		Last Modified: Wed, 24 Aug 2022 20:39:04 GMT  
		Size: 4.3 KB (4312 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9db3ec1d0f66d4d3fcde7602095c26ed9b9a56c546ea4bca0c430728af2dd348`  
		Last Modified: Wed, 24 Aug 2022 20:39:15 GMT  
		Size: 65.0 MB (65035742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c7cdf5d470742c80117432240d4cb3c132a562ee78d281b3c2958d80698a3c1`  
...
```console
$ docker pull gradle@sha256:f4f77d1488a8c496e91528d40f7ba56e3032bb7fec01472b6aaf665d5bb00bf5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **441.2 MB (441210787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c156958093bcfa2d2ac5f5420ba2135a8e578b67de93616b4e797c31d2e84e1`
-	Default Command: `["gradle"]`
...
ENV GRADLE_HOME=/opt/gradle
# Wed, 24 Aug 2022 19:54:58 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln --symbolic /home/gradle/.gradle /root/.gradle
# Wed, 24 Aug 2022 19:54:58 GMT
VOLUME [/home/gradle/.gradle]
# Wed, 24 Aug 2022 19:54:58 GMT
WORKDIR /home/gradle
# Wed, 24 Aug 2022 19:55:34 GMT
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Aug 2022 19:55:37 GMT
ENV GRADLE_VERSION=7.5.1
# Wed, 24 Aug 2022 19:55:38 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Wed, 24 Aug 2022 19:55:47 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:a8d8ea5bf84cb93b097a093c290ca6e3a3cdabc138dd90a108efe88b53d91873`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bdef4337ddd4969e1feef1329b099a542df8d2805b27ce6ccd5b51c12d12e08`  
		Last Modified: Wed, 24 Aug 2022 20:05:04 GMT  
		Size: 4.4 KB (4361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b8e0f1df063783c0549df50752110a62124353039096ca0b8f3be9ab68996e8`  
		Last Modified: Wed, 24 Aug 2022 20:05:24 GMT  
		Size: 73.7 MB (73709223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:922e8dbf05f7b8e99d0cc513305897444cfd1cfa95481f2a0cf0d0d1cf2c875b`  
		Last Modified: Wed, 24 Aug 2022 20:05:14 GMT  
...
```console
$ docker pull gradle@sha256:49c248899b04913be9239809dbcab22e0342ecfcd9701534ac03077655511cce
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.0 MB (411952489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42944b3e214f8177160b53dac3e359d9c7d25a3b7f807b4cb3b2316263fe3abe`
-	Default Command: `["gradle"]`
...
# Wed, 24 Aug 2022 19:43:46 GMT
CMD ["jshell"]
# Wed, 24 Aug 2022 21:38:35 GMT
CMD ["gradle"]
# Wed, 24 Aug 2022 21:38:35 GMT
ENV GRADLE_HOME=/opt/gradle
# Wed, 24 Aug 2022 21:38:36 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln --symbolic /home/gradle/.gradle /root/.gradle
# Wed, 24 Aug 2022 21:38:36 GMT
VOLUME [/home/gradle/.gradle]
# Wed, 24 Aug 2022 21:38:36 GMT
WORKDIR /home/gradle
# Wed, 24 Aug 2022 21:38:52 GMT
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Aug 2022 21:38:55 GMT
ENV GRADLE_VERSION=7.5.1
# Wed, 24 Aug 2022 21:38:55 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Wed, 24 Aug 2022 21:39:00 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:8c0be7b8f4b78afd41a7aaa410d49855ab51cc1b35cadebdf386a7b6a950268a`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c418b7a3e8c3ad5903b0a218f0be35c2e8c314aa5460a272f0a7a3ffcd8b0f56`  
		Last Modified: Wed, 24 Aug 2022 21:45:12 GMT  
		Size: 4.4 KB (4364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e072bfe6290a9f5e0c5e83128aa8f4bfba3aae3ce097ce2b64b887de650bdb4e`  
		Last Modified: Wed, 24 Aug 2022 21:45:21 GMT  
		Size: 64.5 MB (64502096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9fe09106efa9cebef556b3ef3dca64acd50f9e3c7402d635c8946c6b4698090`  
		Last Modified: Wed, 24 Aug 2022 21:45:17 GMT  
		Size: 120.7 MB (120657621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
