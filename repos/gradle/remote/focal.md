...
```console
$ docker pull gradle@sha256:bad3c398ef0b30e1f1b782ca63e32dc8e329cccd5cba12d2be1e26284b2dc49d
```
...
```console
$ docker pull gradle@sha256:913057966cfd0135c66c74b9a1368061c1065ccf2d2ac08b7aa5f517976a5200
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **435.5 MB (435542631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dccf98a750aa567b97d226335bbcd92d071b530a48ed83da6aed68dfbaac49ee`
...
-	Layers:
	...
	-	`sha256:fb4c250472e0d747484cd1fa358adfa3b9cc23b4e05cb1062e1c34d6ea185821`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf422cfcbc5c4eb254bacc9642213e6cd009e6e035d2dfc056cddef4f6890dcc`  
		Last Modified: Wed, 05 Jul 2023 12:49:35 GMT  
		Size: 128.7 MB (128721370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:bb4871deb456b72f927af709cccc012bb00108b0c2e87ebe4b1f21dfb3380bf2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **420.5 MB (420500241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6053d2b733fc28a733c3fe59055b282fac1a6b4381cad45c166a2c1d51e8ef4b`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 05 Jul 2023 10:46:36 GMT
ENV GRADLE_VERSION=8.2
# Wed, 05 Jul 2023 10:46:37 GMT
ARG GRADLE_DOWNLOAD_SHA256=38f66cd6eef217b4c35855bb11ea4e9fbc53594ccccb5fb82dfd317ef8c2c5a3
# Wed, 05 Jul 2023 10:46:43 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=38f66cd6eef217b4c35855bb11ea4e9fbc53594ccccb5fb82dfd317ef8c2c5a3
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:4255167c0354646bcad208cfb3eab7a3771f751a79fa1784df6e5fb5c26e5401`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d4adbadc38cc9dc3cd71f55eca6c450d63372cf7203e203dcdd15c86f909666`  
		Last Modified: Wed, 05 Jul 2023 10:51:32 GMT  
		Size: 128.7 MB (128721404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
