...
```console
$ docker pull gradle@sha256:9edeae174f35c04e44ba151c9472552d99961d32daf71423810b279d9e64ae8e
```
...
```console
$ docker pull gradle@sha256:0d31446d1142d79d254fb9571ab016e46e8def790fd17e5cee3edeeb212ff678
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **435.5 MB (435548345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdb8eaf358a6aa0e73444def4fe6d8635a347bdf2b506328436f3b37a8c76b29`
...
-	Layers:
	...
	-	`sha256:fb4c250472e0d747484cd1fa358adfa3b9cc23b4e05cb1062e1c34d6ea185821`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:224c3635114e7d4c58d1950d1d6a9be032e484865bd0509f329c4db521f534c5`  
		Last Modified: Thu, 13 Jul 2023 20:26:06 GMT  
...
```console
$ docker pull gradle@sha256:7685e16278c1699ef928e333a4b8270368ed59e79e381bb5c8b9aa38dbbdbd5d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **422.5 MB (422543469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcae1e569f8309f5f22ded7ed540c34d8fcdcb715cc09ba26336d520520ceb0b`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 13 Jul 2023 22:31:33 GMT
ENV GRADLE_VERSION=8.2.1
# Thu, 13 Jul 2023 22:31:33 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 13 Jul 2023 22:31:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:4d7687bb611cdfa6c07e72b289db35fe34190cb074a5a6cc104408c7e80ae4f0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aadfc83212b74b8ff0a883cfbd384a978bd8ccc32c734e1dca9cd4e9562510bf`  
		Last Modified: Thu, 13 Jul 2023 22:35:53 GMT  
...
```console
$ docker pull gradle@sha256:f825164659b28e58a719d3e5d1b975806419d567da30766aef697b8865fecae1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **433.4 MB (433446061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7993534267dad9510feaa021ab8599c896337592d8ed352ee3f44eca8d29b658`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 13 Jul 2023 20:49:10 GMT
ENV GRADLE_VERSION=8.2.1
# Thu, 13 Jul 2023 20:49:10 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 13 Jul 2023 20:49:15 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:1e46c96ef3ad4ee6788a88c40dd994718cbb111a62aef03bbe9bb401a02ace01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:116e2d30b28cb0d08f7d53c4e1bc8b6796ce0df62db18a33efd18bdecc7aca4b`  
		Last Modified: Thu, 13 Jul 2023 20:53:12 GMT  
		Size: 128.7 MB (128727137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:focal` - linux; ppc64le

```console
$ docker pull gradle@sha256:e3d3aa916798406c5f17469d5e86ea9b1a8a41cebc19a41868d67688ba034261
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **450.0 MB (449975449 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48f28a82d991568ad95f31be724823d8ec1ca7d3a3010caa624a853a99bc54c4`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 13 Jul 2023 20:37:55 GMT
ENV GRADLE_VERSION=8.2.1
# Thu, 13 Jul 2023 20:37:56 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 13 Jul 2023 20:38:11 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:5a0774af6f224ff5fd1f42fe1df7a6193e5d8ea6e502c2e25284e659a2fdc8cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:208c83fa2c276e65e341950873dd775f577b620f7860df7f2d01a8f30e64afdd`  
		Last Modified: Thu, 13 Jul 2023 20:45:59 GMT  
		Size: 128.7 MB (128727098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:focal` - linux; s390x

```console
$ docker pull gradle@sha256:06dbedaa1773b3d5dc22208ff1f1745287462a03263fc00a8413db63cc0619e0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **420.5 MB (420505918 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8da2f18e3ca0dcbcd9134946cbc5968c8a41a2b9be41f537a3244d47cffa2422`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 13 Jul 2023 21:29:13 GMT
ENV GRADLE_VERSION=8.2.1
# Thu, 13 Jul 2023 21:29:14 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 13 Jul 2023 21:29:20 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:4255167c0354646bcad208cfb3eab7a3771f751a79fa1784df6e5fb5c26e5401`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65c8da8bc7dc65f91da9be5eff5086837afcd0598243a1f3149bd44e77a9edac`  
		Last Modified: Thu, 13 Jul 2023 21:32:41 GMT  
