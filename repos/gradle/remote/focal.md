...
```console
$ docker pull gradle@sha256:75ad07344ddd64c54e3626a3f3a9cb78711567b696678a73b59a21a1d7d1d2b7
```
...
```console
$ docker pull gradle@sha256:cd0d5d9a87f3ec869bd92021b64c9c78137593b65412d7f857d4ec3aa6df8119
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **388.2 MB (388245726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d34b75f4e6c5feb258a3452a2cac560ba38a3287891d615216aae382828be35b`
...
-	Layers:
	...
	-	`sha256:59a3346fd5ac10e552d2898a098618cd3b9b308780092ab7a5ff2ed4029f3000`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66dcf8d80a3fd2ef13f937f0f37ab9ab028900c84839775abe2b961c1fb70f8f`  
		Last Modified: Tue, 15 Aug 2023 23:27:56 GMT  
		Size: 128.7 MB (128727083 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:focal` - linux; arm variant v7

```console
$ docker pull gradle@sha256:25759dafb490891b76abe5ebebbbca55edb6418c9242b52648af882528e85eef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **375.4 MB (375448698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3098d19e13bae18ac1ee2c9a5f0d7579cbbfcefd1c95846c1a0a45b4e925151`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Thu, 17 Aug 2023 03:31:03 GMT
USER gradle
# Thu, 17 Aug 2023 03:31:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
...
-	Layers:
	...
	-	`sha256:f7aafef95896788bc9aa68b74308d766f6e08c020cb8a4bddf016391b56b00f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:977220c10e91aa1e719a3711b89647188781ca4c0bca322ad0a1682fb68f3f4c`  
		Last Modified: Thu, 17 Aug 2023 03:36:52 GMT  
		Size: 128.7 MB (128727075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b717a57601f8f736213e44f2f139e618bb72b045978f71a19d140ae7460c2ae`  
		Last Modified: Thu, 17 Aug 2023 03:36:44 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:2b238583e4a168bb9fe8d06a99b17579a38d6a8f99c8e38babe59ec14de552b2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **386.1 MB (386101264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3bdf39503836e807920515f8ba6090ee12f91b35f7edb44e2156d345226b37f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Mon, 14 Aug 2023 18:48:02 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 17 Aug 2023 01:13:08 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 17 Aug 2023 01:13:09 GMT
USER gradle
# Thu, 17 Aug 2023 01:13:10 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 17 Aug 2023 01:13:10 GMT
USER root
...
-	Layers:
	...
	-	`sha256:0a1d1a1bd044ce2a68bdf2bb1e88e261584f845faccfc09ed15afa4f11b154bb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665eb58e4f5fad1ca813f3bedf9f918ab72b37ff10efe068da1d4eb335ec7ca2`  
		Last Modified: Thu, 17 Aug 2023 01:19:59 GMT  
		Size: 128.7 MB (128727026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ce4771651a6fd217bfed896e551f1f75ef80ac3a375f7b1aaee53ba60d30ff8`  
		Last Modified: Thu, 17 Aug 2023 01:19:53 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:832cee63493979f13aaffb6ee01c39dcce51d4d018920b4cf4e057f65e3f5778
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **403.1 MB (403084394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b38583c3ef342265388a05fce8f5cf99a2120b266d2ab404204d75311f2aa30e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:d18036e4c5a33a78c0133d17d92a733929d14bbea0a06ee78b7be6ec66754aaa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:048d61fef5623c9309945608eba148c3e406365abff056b93553652b39b5d48d`  
		Last Modified: Tue, 15 Aug 2023 23:25:08 GMT  
		Size: 128.7 MB (128727108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:focal` - linux; s390x

```console
$ docker pull gradle@sha256:cd1e36f8aa196024aa7938043f8cfa06355aae20de24e5882a2d41039698de19
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **374.9 MB (374901137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a648e7e184260736aa1482248f26cf62107053104e84ced104813645713776c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Mon, 14 Aug 2023 18:33:52 GMT
ARG GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
# Thu, 17 Aug 2023 00:43:40 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 17 Aug 2023 00:43:44 GMT
USER gradle
# Thu, 17 Aug 2023 00:43:46 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=03ec176d388f2aa99defcadc3ac6adf8dd2bce5145a129659537c0874dea5ad1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 17 Aug 2023 00:43:46 GMT
USER root
...
-	Layers:
	...
	-	`sha256:e738b5f9932890ebe90ffa2b7da39a4df5da33689fd488d2bfccbf85dc9d4a35`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a8ee251869ea5d3c5491d11123ea1d1355cbda9759403a60aa1b7d80ee80545`  
		Last Modified: Thu, 17 Aug 2023 00:48:49 GMT  
		Size: 128.7 MB (128727003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c4d47cab9f0586e9289acce986af5b25caa21ab1f5ec7d1709721d02ed9239d`  
		Last Modified: Thu, 17 Aug 2023 00:48:41 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
