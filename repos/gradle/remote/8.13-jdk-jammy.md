...
```console
$ docker pull gradle@sha256:269adf741c65e2f4fae480e4007ee331fe44a84f6e70be1aa42fd6aa2a2bc2a8
```
...
### `gradle:8.13-jdk-jammy` - linux; amd64
...
### `gradle:8.13-jdk-jammy` - unknown; unknown
...
### `gradle:8.13-jdk-jammy` - linux; arm64 variant v8
...
### `gradle:8.13-jdk-jammy` - linux; ppc64le
...
### `gradle:8.13-jdk-jammy` - linux; s390x
