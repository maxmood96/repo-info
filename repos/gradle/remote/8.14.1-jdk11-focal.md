## `gradle:8.14.1-jdk11-focal`

```console
$ docker pull gradle@sha256:e41547fc4e86a0a2626a3405ae9112191a69ffe6abe4c1e1a77161952d2dc3d8
```
...
### `gradle:8.14.1-jdk11-focal` - linux; amd64
...
### `gradle:8.14.1-jdk11-focal` - unknown; unknown
...
### `gradle:8.14.1-jdk11-focal` - linux; arm64 variant v8
...
### `gradle:8.14.1-jdk11-focal` - linux; ppc64le
...
### `gradle:8.14.1-jdk11-focal` - linux; s390x
