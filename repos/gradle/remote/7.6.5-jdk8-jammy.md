## `gradle:7.6.5-jdk8-jammy`

```console
$ docker pull gradle@sha256:741877ec0bbd83772fb92b71b636433fb9ae90ed6d546d9ea53ba2a3dc757912
```
...
### `gradle:7.6.5-jdk8-jammy` - linux; amd64
...
### `gradle:7.6.5-jdk8-jammy` - unknown; unknown
...
### `gradle:7.6.5-jdk8-jammy` - linux; arm64 variant v8
...
### `gradle:7.6.5-jdk8-jammy` - linux; ppc64le
