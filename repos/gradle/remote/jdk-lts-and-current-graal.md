...
```console
$ docker pull gradle@sha256:05627a2d0ff00eedd5c53103a73b937224b9e5b8febbaa24a5272a50fa9955fb
```
...
```console
$ docker pull gradle@sha256:afd46122e0b0a2f14acab1826b1ac89a3fd0e07015726b35a03212614957f0f5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **688.9 MB (688881971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b58f534792d50e4c05cccb16d5d757607cf7b706ff4264c440f15519de046ae1`
...
-	Layers:
	...
	-	`sha256:1c24335ddd46023ff99bd665bd8ea6798464f7bbf501718edcf2eb4696e5f408`  
		...
		Size: 387.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3a0d3db593b42c57b2a6a3760dfb98c362afb8ef1722f9a422c8f6f9b19bc7a0`  
		Last Modified: Tue, 19 May 2026 18:55:50 GMT  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6e2a10ea471ae2bd920ecba3d115513d5498f1f0df91318c053e5ea1abd28264`  
		Last Modified: Tue, 19 May 2026 18:55:59 GMT  
		Size: 166.2 MB (166168466 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b772ff707b5e0bc097bc565d2c9eca33b7d34109618551652b71a6ebcdc252b1`  
		Last Modified: Tue, 19 May 2026 18:56:03 GMT  
		Size: 340.9 MB (340894214 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:eab42a6da0214eaff2f0413520ad46b25f507831a81c550678212b27c97f79ee`  
		Last Modified: Tue, 19 May 2026 18:55:58 GMT  
		Size: 140.2 MB (140236985 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6b87efe99cf075625cb5fc5d76a7c6c2e86e225e5fd2a0f6b0086060b2f4cc0a`  
		Last Modified: Tue, 19 May 2026 18:55:51 GMT  
...
```console
$ docker pull gradle@sha256:e9baff5b4ba9ccb3ddcff29f5c1f65d322eae0b87c104117e4c2195d1a473f3c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **11.2 MB (11187589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6667be6440c3e3d5f738c3990215729ed0083cf9112e131e50c1da5a43a048e3`

```dockerfile
```

-	Layers:
	-	`sha256:da64f14e0afcfe59e7ae73c1d73e429c97811b34b43478b2bb72d701fcf883fe`  
		Last Modified: Tue, 19 May 2026 18:55:51 GMT  
		Size: 11.1 MB (11147973 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0ada798a96de35653cb81b27cd2e829e08ab6ddc8ecdcbf6a918181623714829`  
		Last Modified: Tue, 19 May 2026 18:55:50 GMT  
...
```console
$ docker pull gradle@sha256:0343f193a2cd72439be350047dc79dbd5066a7e40df3934dabeae6a5c14447bc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **656.3 MB (656298256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9817a251d9dd5087be4d760b21dda4f420b2bd97f3eb1b05efe0f5114a37c4f2`
-	Default Command: `["gradle"]`
...
# Tue, 19 May 2026 18:54:27 GMT
ENV JAVA_CURRENT_HOME=/opt/java/graalvm25
# Tue, 19 May 2026 18:54:38 GMT
RUN set -o errexit -o nounset     && mkdir /opt/java         && echo "Downloading LTS GraalVM"     && JAVA_LTS_VERSION=25.0.2     && GRAALVM_LTS_AMD64_DOWNLOAD_SHA256=e0be791c8fda4d03b6b0a0cb824fef3149736170057b3a515252b44419606af0     && GRAALVM_LTS_AARCH64_DOWNLOAD_SHA256=b4580d9f223d0a4b3a1757e58b18ff4c1db950e67e105fc5cb741457d2384a71     && ARCHITECTURE=$(dpkg --print-architecture)     && if [ "${ARCHITECTURE}" = "amd64" ]; then GRAALVM_ARCHITECTURE=linux-x64; fi     && if [ "${ARCHITECTURE}" = "arm64" ]; then GRAALVM_ARCHITECTURE=linux-aarch64; fi     && GRAALVM_PKG=https://github.com/graalvm/graalvm-ce-builds/releases/download/jdk-${JAVA_LTS_VERSION}/graalvm-community-jdk-${JAVA_LTS_VERSION}_${GRAALVM_ARCHITECTURE}_bin.tar.gz     && wget --no-verbose --output-document=graalvm.tar.gz "${GRAALVM_PKG}"         && echo "Checking LTS GraalVM download hash"     && if [ "${ARCHITECTURE}" = "amd64" ]; then GRAALVM_DOWNLOAD_SHA256="${GRAALVM_LTS_AMD64_DOWNLOAD_SHA256}"; fi     && if [ "${ARCHITECTURE}" = "arm64" ]; then GRAALVM_DOWNLOAD_SHA256="${GRAALVM_LTS_AARCH64_DOWNLOAD_SHA256}"; fi     && echo "${GRAALVM_DOWNLOAD_SHA256} *graalvm.tar.gz" | sha256sum --check -         && echo "Installing LTS GraalVM"     && tar --extract --gunzip --file graalvm.tar.gz     && rm graalvm.tar.gz     && mv graalvm-* "${JAVA_LTS_HOME}"         && echo "Downloading current GraalVM"     && JAVA_CURRENT_VERSION=25.0.2     && GRAALVM_CURRENT_AMD64_DOWNLOAD_SHA256=e0be791c8fda4d03b6b0a0cb824fef3149736170057b3a515252b44419606af0     && GRAALVM_CURRENT_AARCH64_DOWNLOAD_SHA256=b4580d9f223d0a4b3a1757e58b18ff4c1db950e67e105fc5cb741457d2384a71     && if [ "${JAVA_LTS_VERSION}" != "${JAVA_CURRENT_VERSION}" ]; then       ARCHITECTURE=$(dpkg --print-architecture)       && if [ "${ARCHITECTURE}" = "amd64" ]; then GRAALVM_ARCHITECTURE=linux-x64; fi       && if [ "${ARCHITECTURE}" = "arm64" ]; then GRAALVM_ARCHITECTURE=linux-aarch64; fi       && GRAALVM_PKG=https://github.com/graalvm/graalvm-ce-builds/releases/download/jdk-${JAVA_CURRENT_VERSION}/graalvm-community-jdk-${JAVA_CURRENT_VERSION}_${GRAALVM_ARCHITECTURE}_bin.tar.gz       && wget --no-verbose --output-document=graalvm.tar.gz "${GRAALVM_PKG}"             && echo "Checking current GraalVM download hash"       && if [ "${ARCHITECTURE}" = "amd64" ]; then GRAALVM_DOWNLOAD_SHA256="${GRAALVM_CURRENT_AMD64_DOWNLOAD_SHA256}"; fi       && if [ "${ARCHITECTURE}" = "arm64" ]; then GRAALVM_DOWNLOAD_SHA256="${GRAALVM_CURRENT_AARCH64_DOWNLOAD_SHA256}"; fi       && echo "${GRAALVM_DOWNLOAD_SHA256} *graalvm.tar.gz" | sha256sum --check -             && echo "Installing current GraalVM"       && tar --extract --gunzip --file graalvm.tar.gz       && rm graalvm.tar.gz       && mv graalvm-* "${JAVA_CURRENT_HOME}";     fi         && echo "Default Java to LTS GraalVM"     && ln --symbolic "${JAVA_LTS_HOME}" /opt/java/graalvm     && for bin in "$JAVA_LTS_HOME/bin/"*; do         base="$(basename "$bin")";         [ ! -e "/usr/bin/$base" ];         update-alternatives --install "/usr/bin/${base}" "${base}" "${bin}" 1;     done         && echo "Testing GraalVM installation"     && java --version     && javac --version     && native-image --version # buildkit
# Tue, 19 May 2026 18:54:38 GMT
ENV GRADLE_VERSION=9.5.1
# Tue, 19 May 2026 18:54:38 GMT
ARG GRADLE_DOWNLOAD_SHA256=bafc141b619ad6350fd975fc903156dd5c151998cc8b058e8c1044ab5f7b031f
# Tue, 19 May 2026 18:54:40 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bafc141b619ad6350fd975fc903156dd5c151998cc8b058e8c1044ab5f7b031f
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Tue, 19 May 2026 18:54:40 GMT
USER gradle
# Tue, 19 May 2026 18:54:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bafc141b619ad6350fd975fc903156dd5c151998cc8b058e8c1044ab5f7b031f
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --stacktrace --debug --version # buildkit
# Tue, 19 May 2026 18:54:41 GMT
USER root
...
-	Layers:
	...
	-	`sha256:4a7720058461eb4ae40ed203b9874ab3248bd34ffb9948193e99245229fdbd6f`  
		...
		Size: 390.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bcb3099c7b63e214160840d78a1c3a0cdd797f5a7cde53517d392fcfe5f3713c`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6b7886a774080efe42bebed68bf56c9893426ae70650000a62625a5363e26d89`  
		Last Modified: Tue, 19 May 2026 18:55:29 GMT  
		Size: 159.3 MB (159314610 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f6e9f27022902218fe2ea13fb7036e82adfb9c3fd30011715a02a42f9abef563`  
		Last Modified: Tue, 19 May 2026 18:55:34 GMT  
		Size: 316.0 MB (315986539 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b017cb649f7fe222240d1c5ae2e16968cf87d5d48bd001a95d351bbc410c6d6d`  
		Last Modified: Tue, 19 May 2026 18:55:29 GMT  
		Size: 140.2 MB (140236983 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b3ab3b0cf0be6d7de5cc2e0a8558004e1ef3cf2272b5818b53fc29acc50c252f`  
...
```console
$ docker pull gradle@sha256:630a046a44dbcef2e8ebcebeb8c47fda45e6816a6dfa50ffcae1e90648826a26
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **11.2 MB (11225729 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f7d98a6653c2403937e2d5a19f728790a6be85d4fffe0ce7d90292895fdaa63`

```dockerfile
```

-	Layers:
	-	`sha256:c7b78d1851125318bd2fd560366e2bf90003851952af83af919203652f82d979`  
		Last Modified: Tue, 19 May 2026 18:55:22 GMT  
		Size: 11.2 MB (11185804 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:88ab53966b1acc9b3a11d7bfabd14d3f3f3bd5631aa28946c1ff29177d78ff11`  
		Last Modified: Tue, 19 May 2026 18:55:21 GMT  
