...
```console
$ docker pull gradle@sha256:b18bdba062004ef0197f18bf59ce8933839c11e7533d84e02b77eb8beea8a781
```
...
```console
$ docker pull gradle@sha256:5e82babbcd7da60dce5bbdd0a209886e26ed3f2996dd6ece717f857fd9c63c21
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.9 MB (362928303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:542526cc541fe97fde076d093d323ccdd52a3d6c07165fee2f874f9a9ac6485c`
...
-	Layers:
	...
	-	`sha256:2c9f6a443f2e48c5b7a8753b2bda25c47c1c2555903fb80ef89c5624f74f2749`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63a25c06f5354937eceddd36b114f9086a6687c503b1fd5ded24208a065f8135`  
		Last Modified: Tue, 06 Feb 2024 08:36:12 GMT  
		Size: 122.7 MB (122730246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e71f987a6c1a8dbf0b17eebb715528d18fdd34cda426a4bc0148e57646a58bdd`  
		Last Modified: Tue, 06 Feb 2024 08:36:06 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:b6a179de89a332d83e091bf8f9174864575a6884b0eb514fa7f49b505da1f5f5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **357.1 MB (357120900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca6bee781279f74c3865a8e464c5e64da6f165fc91cb1c13af9314d9f8cb18a2`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Tue, 06 Feb 2024 00:23:39 GMT
ENV GRADLE_VERSION=7.6.4
# Tue, 06 Feb 2024 00:23:39 GMT
ARG GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
# Tue, 06 Feb 2024 00:23:43 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Tue, 06 Feb 2024 00:23:43 GMT
USER gradle
# Tue, 06 Feb 2024 00:23:45 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Tue, 06 Feb 2024 00:23:45 GMT
USER root
...
-	Layers:
	...
	-	`sha256:34f03196e7f3c00b5ce2782d6bb9563cb7722a1ade90a364f6f56eb832fed91d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78cb0faa62416c07f0dbf41b999fe8914322281b2732a4cd984f1432531e522a`  
		Last Modified: Tue, 06 Feb 2024 00:26:30 GMT  
		Size: 122.7 MB (122730219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe64c04f374775b60ada939b051c08c93167309be10dc683f0b8b788c45e3c3f`  
		Last Modified: Tue, 06 Feb 2024 00:26:26 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
