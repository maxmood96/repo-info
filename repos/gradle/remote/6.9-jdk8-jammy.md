...
```console
$ docker pull gradle@sha256:9076f188f55791354fd2814d35722de1515fd86bb98945ada2b991b224bc4bdf
```
...
```console
$ docker pull gradle@sha256:daab2d465f3105f5bdf7664b0bd39e3b9021c92305e5a397bfcffdebbabffdd9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.2 MB (306188955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2799485042f7f6aa9e48bfa2b1bcaec43cb63be0f3df261f981142ccac1f459`
...
-	Layers:
	...
	-	`sha256:9c16d3da2ff34da89e5f59b2568fb548bb087f4d92fe58b78e5192aa7a2af329`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ebb74f013e99639c4a7fe7122c495ae0141dfb8feaa3ce312fd0145b7ae598f`  
		Last Modified: Sat, 02 Sep 2023 03:39:32 GMT  
		Size: 107.7 MB (107696586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:132b3e4727708f048e8619f51ddb8b95cf8ce5b0d9b30ffc16afb0b6b2b9309b`  
		Last Modified: Sat, 02 Sep 2023 03:39:27 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:021934ce892b0f07ce0847427cd7bc27f02c1bcb3d72a2541650131b6f41e72a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300340257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95fcd659eba271ced65a6f8a36598ff0ec6c740815f57e2b98ad4cfd957be5db`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Sat, 02 Sep 2023 00:16:54 GMT
ENV GRADLE_VERSION=6.9.4
# Sat, 02 Sep 2023 00:16:54 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Sat, 02 Sep 2023 00:16:58 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Sep 2023 00:16:58 GMT
USER gradle
# Sat, 02 Sep 2023 00:16:59 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
...
-	Layers:
	...
	-	`sha256:6bd2a512fae6756b2b0e48f8764b3319ea2e07974d0f0b2dc81a8b64bc042806`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a7c60f9f85b601893ef495b74bc1e584558ca83c7828d60a82c4d857201b8db`  
		Last Modified: Sat, 02 Sep 2023 00:22:06 GMT  
		Size: 107.7 MB (107696602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73c8f5ca9df7adfe8c2f6a71ca80c7c6cc8f4867711a663b460021ccf1cbb7f3`  
		Last Modified: Sat, 02 Sep 2023 00:21:59 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:295e9f0485bdb061314ee98df57133dac990b38dcefcb0b46cdf93168b5e79f4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.8 MB (302756157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f491b3081ae41fa3524c49f7d95a127b5de1b8a0ba1b9a1ff1db43fcb59e35c1`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 01 Sep 2023 23:38:18 GMT
ENV GRADLE_VERSION=6.9.4
# Fri, 01 Sep 2023 23:38:18 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Fri, 01 Sep 2023 23:38:21 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 01 Sep 2023 23:38:21 GMT
USER gradle
# Fri, 01 Sep 2023 23:38:22 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 01 Sep 2023 23:38:22 GMT
USER root
...
-	Layers:
	...
	-	`sha256:052d0ade204d5b5fb793763f68cb8debf55d5daa80e17f9e427ff721f0c7040d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fe2ced8b9e31f20dc4cbc264889593981657584b95248933c46194bd807d5e6`  
		Last Modified: Fri, 01 Sep 2023 23:43:36 GMT  
		Size: 107.7 MB (107696569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49f0adb1a4a0f3f3654cdd7fbea691210cd2c360b85c6188b588eb1edad5921e`  
		Last Modified: Fri, 01 Sep 2023 23:43:31 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
