...
### `gradle:8.11.0-jdk8-focal` - linux; amd64
...
### `gradle:8.11.0-jdk8-focal` - unknown; unknown
...
### `gradle:8.11.0-jdk8-focal` - linux; arm variant v7
...
### `gradle:8.11.0-jdk8-focal` - linux; arm64 variant v8
...
### `gradle:8.11.0-jdk8-focal` - linux; ppc64le
