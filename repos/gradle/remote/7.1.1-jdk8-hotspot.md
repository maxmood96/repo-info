...
```console
$ docker pull gradle@sha256:896d67647793c20bacb9018e33643bf1e091be7cfc3e188a899da74d4bfffbb4
```
...
### `gradle:7.1.1-jdk8-hotspot` - linux; amd64
...
### `gradle:7.1.1-jdk8-hotspot` - linux; arm64 variant v8
...
### `gradle:7.1.1-jdk8-hotspot` - linux; s390x
