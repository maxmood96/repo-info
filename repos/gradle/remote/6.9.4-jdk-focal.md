...
```console
$ docker pull gradle@sha256:b39bcd90d5c40e6eb7338573776c8adb9994583a19fe3bc4fb18b58036b349ca
```
...
```console
$ docker pull gradle@sha256:8ecd06756abd70ff54b22e2c67954635e9bfaa87fea212e3c98eeff719ee1cac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.7 MB (354696252 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bcc44c84f097a4eafa321587867445335684dd8e876c7131cb6e69d9037632f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Jan 2024 21:39:29 GMT
USER gradle
# Wed, 24 Jan 2024 21:39:30 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Jan 2024 21:39:30 GMT
USER root
...
-	Layers:
	...
	-	`sha256:5466f7b856f6b2d976b9f5df064366404ad7007a31033e0bccdde2493d1949e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fce9d67f4c14959d54d3d1b744a8e6e13c035e0cc8c79b27a5d847449e820c4a`  
		Last Modified: Wed, 24 Jan 2024 21:49:09 GMT  
		Size: 107.7 MB (107696541 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e32f2fded46104b216e10ab6d1a96997cc8764c434a9fb94824bc39f13d5c5e`  
		Last Modified: Wed, 24 Jan 2024 21:49:02 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:61d72f07f61b666fa31b58552eb2814e5393f3db134727f635df6e93c13013ad
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **382.2 MB (382195309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a52ab67db2fc03591d856b136c0ac2d12f64069e1415924a6516c7e3343bea32`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Jan 2024 21:43:52 GMT
ENV GRADLE_VERSION=6.9.4
# Wed, 24 Jan 2024 21:43:53 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 24 Jan 2024 21:43:59 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Jan 2024 21:44:01 GMT
USER gradle
# Wed, 24 Jan 2024 21:44:03 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
...
-	Layers:
	...
	-	`sha256:df7e4353400b46d13ddd2292e8e2550ba8a87281c6ca3eceb23853cf88bf70ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b56437e85f79802375f8028ba7d6d3742e913c4b2ddd31af30328079cf36b2b3`  
		Last Modified: Wed, 24 Jan 2024 21:54:59 GMT  
		Size: 107.7 MB (107696523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2cd7e0abdb3ad9508a74fcff274b4f1067cdbd088fc13845de31cf742a341f6`  
		Last Modified: Wed, 24 Jan 2024 21:54:54 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
