...
```console
$ docker pull gradle@sha256:d66af29d774ed8ea13f98cf30c8093e2e3e61deec0a9100d3f14ac2937b1e619
```
...
```console
$ docker pull gradle@sha256:f480a8fe164dabc03d16e6a97091d7c88634bdf5ab35057eaa329bcb64fdf7ca
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.3 MB (367316214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8feb3f5384c5c7025509bdbef09e86dc11192840450bbda02c74e7180d205903`
...
-	Layers:
	...
	-	`sha256:b32021f4d6e864c468b0dab236daf36a5e1cbb8ba3fd8da255abc341bf7248b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd7e84005666672d240ef537cccbb348291ee457a9abf02afc3fabb862a42c48`  
		Last Modified: Wed, 24 Jan 2024 23:34:03 GMT  
		Size: 107.7 MB (107696562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba1ab1f8f1afbf03ee8fe803e918ffcffa052b2b9d50c88ab7654047ce949d64`  
		Last Modified: Wed, 24 Jan 2024 23:33:57 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:d663920a968d67bab9c9f9558affd673b8f7f50a7d53553d49777be2522faa0b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **365.2 MB (365240171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9138dd2dff63786065d4e51b63e44960db8989720b4a87ceb88e9e323133d53`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Jan 2024 23:12:19 GMT
ENV GRADLE_VERSION=6.9.4
# Wed, 24 Jan 2024 23:12:20 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 24 Jan 2024 23:12:23 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Jan 2024 23:12:23 GMT
USER gradle
# Wed, 24 Jan 2024 23:12:24 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Jan 2024 23:12:24 GMT
USER root
...
-	Layers:
	...
	-	`sha256:e2a6170171703528aed1309f2a373441c8d0f49986af11de053a37e8883f4de6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:921898f6aa07e6a4b18d53119cab37d2433c286bf6d83a4be57dc985f1f6d8e5`  
		Last Modified: Wed, 24 Jan 2024 23:21:51 GMT  
		Size: 107.7 MB (107696520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d9a816f59152c1b2d3be3bb1a202904cfcd2ae92874c0db8d8f2bf8766c8581`  
		Last Modified: Wed, 24 Jan 2024 23:21:46 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
