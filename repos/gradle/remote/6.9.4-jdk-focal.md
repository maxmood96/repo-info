...
```console
$ docker pull gradle@sha256:9f7e94167ce2dbb7f5c4656a0c0a9a61263b2a52c38a00943bec45a22e528282
```
...
```console
$ docker pull gradle@sha256:27aa8ffa9fbf7f3edb1591b59be68cfc2dd7511b268985f0fee8f7fd46f86f1f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.9 MB (353875277 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53216f09e361ba38d00d7fd19c73e22e4db636117bd150907a9c5e8921943096`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
ENV GRADLE_VERSION=6.9.4
# Thu, 25 Jan 2024 20:39:56 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 25 Jan 2024 20:40:01 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
...
-	Layers:
	...
	-	`sha256:8e55bf03390a7aaf473c1439ef7b0ae0f5ba785aed99df7147e02f0d6cf77805`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce74baafbc0c562aaef0ed8d695fe7145a784431e529009003b798110c4c4547`  
		Last Modified: Thu, 25 Jan 2024 20:46:07 GMT  
		Size: 107.7 MB (107696528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99307f3b36ca4c7d655247e0d7fac2e018ee01b80122b6f2b9b88f161ca65d33`  
		Last Modified: Thu, 25 Jan 2024 20:46:02 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
