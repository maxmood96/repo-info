...
### `gradle:9.5.0-jdk-25-and-26-alpine` - linux; amd64
...
### `gradle:9.5.0-jdk-25-and-26-alpine` - unknown; unknown
...
### `gradle:9.5.0-jdk-25-and-26-alpine` - linux; arm64 variant v8
