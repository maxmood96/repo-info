...
### `gradle:7.6-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:7.6-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:7.6-jdk-lts-and-current-alpine` - linux; arm64 variant v8
