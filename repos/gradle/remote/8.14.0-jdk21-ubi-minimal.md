...
### `gradle:8.14.0-jdk21-ubi-minimal` - linux; amd64
...
### `gradle:8.14.0-jdk21-ubi-minimal` - unknown; unknown
...
### `gradle:8.14.0-jdk21-ubi-minimal` - linux; arm64 variant v8
...
### `gradle:8.14.0-jdk21-ubi-minimal` - linux; ppc64le
...
### `gradle:8.14.0-jdk21-ubi-minimal` - linux; s390x
