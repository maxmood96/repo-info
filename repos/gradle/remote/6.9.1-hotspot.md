...
```console
$ docker pull gradle@sha256:c0ab1b8d011fda54c0599929ae27f1485f242ee550f0aa370dae730647d5385b
```
...
### `gradle:6.9.1-hotspot` - linux; amd64
...
### `gradle:6.9.1-hotspot` - linux; arm64 variant v8
...
### `gradle:6.9.1-hotspot` - linux; ppc64le
...
### `gradle:6.9.1-hotspot` - linux; s390x
