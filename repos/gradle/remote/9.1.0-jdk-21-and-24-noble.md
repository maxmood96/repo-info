...
### `gradle:9.1.0-jdk-21-and-24-noble` - linux; amd64
...
### `gradle:9.1.0-jdk-21-and-24-noble` - unknown; unknown
...
### `gradle:9.1.0-jdk-21-and-24-noble` - linux; arm64 variant v8
...
### `gradle:9.1.0-jdk-21-and-24-noble` - linux; ppc64le
...
### `gradle:9.1.0-jdk-21-and-24-noble` - linux; riscv64
...
### `gradle:9.1.0-jdk-21-and-24-noble` - linux; s390x
