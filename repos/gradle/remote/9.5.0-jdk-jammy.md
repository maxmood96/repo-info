...
### `gradle:9.5.0-jdk-jammy` - linux; amd64
...
### `gradle:9.5.0-jdk-jammy` - unknown; unknown
...
### `gradle:9.5.0-jdk-jammy` - linux; arm64 variant v8
...
### `gradle:9.5.0-jdk-jammy` - linux; ppc64le
...
### `gradle:9.5.0-jdk-jammy` - linux; s390x
