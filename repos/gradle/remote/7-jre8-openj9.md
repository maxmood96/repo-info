...
```console
$ docker pull gradle@sha256:97f378d4f087a6da5a5c0e7d328fbea6d3e6c60bacdcfc21c6bf65eec8de8f8d
```
...
```console
$ docker pull gradle@sha256:0ab492dc71229d1cde34274eaeb083652c57b327ee5085dca2a4935f535e1e6c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **276.4 MB (276413469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2cf8725602acf8857ece3b1b879532ca8f9e66f54c9b90a4e934ede986ef9f4`
...
-	Layers:
	...
	-	`sha256:73cfee65191ba760364e769aec12e2950979a1801352e984983a9c6970b70da6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20f657a45e85780c999d472cb6b84a2ddc081984890c334a3408baab962def29`  
		Last Modified: Fri, 02 Jul 2021 17:47:32 GMT  
...
```console
$ docker pull gradle@sha256:2bc9e5f2e7fc24bcd9a8701695b4255b4b1330ed3380822a9ce65743c748d437
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.5 MB (270528690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:428b1f49cef793a13c21a1d01926aac694de6df2992dfa255ca545400ab88b06`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 02 Jul 2021 17:58:00 GMT
ENV GRADLE_VERSION=7.1.1
# Fri, 02 Jul 2021 17:58:00 GMT
ARG GRADLE_DOWNLOAD_SHA256=bf8b869948901d422e9bb7d1fa61da6a6e19411baa7ad6ee929073df85d6365d
# Fri, 02 Jul 2021 17:58:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bf8b869948901d422e9bb7d1fa61da6a6e19411baa7ad6ee929073df85d6365d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:14c1c2a1207df201dde0cdb22cb3f50a7197a4deb7ac77ca7f954e69d055dd1f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19f9bc3c0700209c5f2c4c45bd6c20e914a9d943d87fa56c53e718b5b87ce76a`  
		Last Modified: Fri, 02 Jul 2021 18:13:15 GMT  
...
```console
$ docker pull gradle@sha256:144e9d6819683ec4981181f09ccc027d1e5e55daddf0089374f4d2d9e90edbf4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.4 MB (273379612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb751edc6b61641374ae04cef41135a30dd5a858d2c42f0f31b07c7947f3c00b`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 02 Jul 2021 18:19:02 GMT
ENV GRADLE_VERSION=7.1.1
# Fri, 02 Jul 2021 18:19:03 GMT
ARG GRADLE_DOWNLOAD_SHA256=bf8b869948901d422e9bb7d1fa61da6a6e19411baa7ad6ee929073df85d6365d
# Fri, 02 Jul 2021 18:19:20 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bf8b869948901d422e9bb7d1fa61da6a6e19411baa7ad6ee929073df85d6365d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b68d51adeac06af2a5ef955c7273b769498490215bcbaa96bdcfa3ab6723f1ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6432ffb5b712573161eaa404ff127636a98d5ad3424aed9c819125200cf7f3`  
		Last Modified: Fri, 02 Jul 2021 19:24:38 GMT  
		Size: 112.3 MB (112253289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
