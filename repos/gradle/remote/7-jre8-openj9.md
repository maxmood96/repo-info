...
```console
$ docker pull gradle@sha256:01420d3fb7b5004f81001fb2f1197b9ccc7f56abafe03595176cf434a9964969
```
...
```console
$ docker pull gradle@sha256:23e7a3a88288d193dc6a502214b08bfcf695fb6b343e349a3a634f05366da220
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **276.7 MB (276691385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27427b1867225deefed05de3b2f9e8dac3f0452d16b553386df27cf6d3c42271`
...
-	Layers:
	...
	-	`sha256:341f19781235934b83491f11f2bacc0d9fbd2ad78b50ac45f168411d8905ddb5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aad38e642e38a8965f2d1d8f60546e4a97e9b957d967c67913fc14faa641a5cc`  
		Last Modified: Mon, 10 May 2021 18:55:01 GMT  
		Size: 112.6 MB (112575740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:cd4a9a8dae9dfe60edf2a375ce3082f36470c697bf1b997bf29aefd02e5a8250
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.0 MB (291009518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93e2009a361b2a0ca6e4da7a098e345100f9dd41c4ea1cb88aadb1aa6666149f`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 19:22:43 GMT
ENV GRADLE_VERSION=7.0
# Mon, 10 May 2021 19:22:46 GMT
ARG GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
# Mon, 10 May 2021 19:24:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:17b4c057cd938f75b3f73bd058ac70c50e2ba218afa411a0217f4fb48824e9bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c665261131f741776011c76f7fa507d2cb6dd39dbe7b98af1756b0742865e19d`  
		Last Modified: Mon, 10 May 2021 20:27:21 GMT  
...
```console
$ docker pull gradle@sha256:70a2284417d048637f12b1b540f8dbe39d23db4f1938b1beb0877dfa8678eab4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.7 MB (273700936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5b9811fa7404c6d6d1454e621dd45b0da6d5551c87547b006d2526843c5c014`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 18:38:34 GMT
ENV GRADLE_VERSION=7.0
# Mon, 10 May 2021 18:38:35 GMT
ARG GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
# Mon, 10 May 2021 18:38:52 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:7cc0a5b85bfbe6073d39988d4b6c351146f5d94c5b14e3cedfc15d89ec5fe109`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:296f17f344b243650f41ed7fe5221b62f9a1ee87c8488d1c3c223a1798852dbd`  
		Last Modified: Mon, 10 May 2021 19:39:54 GMT  
