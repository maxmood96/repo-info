...
```console
$ docker pull gradle@sha256:bb04621785bfb09e72a91e1f7eb3a761de4485ca0582db70067f1146ff69b2fa
```
...
```console
$ docker pull gradle@sha256:f03ab82d6881f942e420f15d5accecc4e4a839e9a094781a2fb5a79c40354d3e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **276.2 MB (276200198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eaedc7981afcad707a124629e279f8a4dfa688443f23c272cda59840e9a08fbb`
...
-	Layers:
	...
	-	`sha256:341f19781235934b83491f11f2bacc0d9fbd2ad78b50ac45f168411d8905ddb5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac8d34e28188224f23a60b0f087395669a9996e722cf4587b44d50319604c292`  
		Last Modified: Tue, 11 May 2021 01:16:25 GMT  
		Size: 112.1 MB (112084553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7-jre8-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:8c2b556bc8860bcecf29d21ca8f717fa3ad12b1fdd8a05a65ffcf425aa5878e5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.4 MB (270368469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6de01e71253dac6828f68ae243dc26d52e59a7c2fbcf1aa29ea46fc6b57096b7`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 01:13:36 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 01:13:37 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
# Tue, 11 May 2021 01:14:28 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:dc45ac09412e0c09adc21915aacbfdab9a25f4a55ab9b0ed180e280ebc4e957b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ecb8a8a694d6ef46199c4cbdf01ddddb5cb48533d7f35341df9a6edf7535fec`  
		Last Modified: Tue, 11 May 2021 01:26:59 GMT  
...
```console
$ docker pull gradle@sha256:464da952ee17ace33b24cc058f9f49ab33bd3269e92ba1ade680beda704185dc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.5 MB (290518325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a9eec537d714a07c58de64476363c12c841d759c7ac9637970e78c4ff35cffa`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 01:34:07 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 01:34:13 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
# Tue, 11 May 2021 01:35:25 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:17b4c057cd938f75b3f73bd058ac70c50e2ba218afa411a0217f4fb48824e9bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:671ec8536faef541d54998a5216b7e760bb4a6e8f048d0cc589e12f62ed9fc3e`  
		Last Modified: Tue, 11 May 2021 01:51:22 GMT  
		Size: 112.1 MB (112084559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7-jre8-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:7e163459520e48090b1481a85f262fcf954c8e22e79fa50328eec4835ec5ea7d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.2 MB (273209762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5256c084984d5dd66d92264344fc3c4171c67bc06221e0e2c56db703713a0085`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 00:22:23 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 00:22:23 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
# Tue, 11 May 2021 00:22:35 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:7cc0a5b85bfbe6073d39988d4b6c351146f5d94c5b14e3cedfc15d89ec5fe109`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:766dfb67f3b2ddccc057c6f4586f1c9e71dd0b8075d0ff9fbb652492a8a239b6`  
		Last Modified: Tue, 11 May 2021 00:30:48 GMT  
		Size: 112.1 MB (112084575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
