...
```console
$ docker pull gradle@sha256:ef80faff173ad431151fa4e9f2eeec627d631ff86b2ea2710318549cd775ac1f
```
...
```console
$ docker pull gradle@sha256:a0f5475ffc2ccfebc9e35867f8e1969125a19fc5cecf39f8e7233dc7006714a0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.6 MB (278611977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:072c3250634d1c256e9a355d0341f1b4676401835eff1048d3053ad026f28663`
...
-	Layers:
	...
	-	`sha256:18149d34e6e297d4ceaf3ae26556295e1710e913ba08717e93eaa9069c6b29b5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eddcb795cebf8e8f81ed59fe0ae67f49fc88b9b2904675b76952a8aead92439a`  
		Last Modified: Tue, 31 Aug 2021 07:22:29 GMT  
		Size: 114.4 MB (114373892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:72c1036c8694f0594ab7746ff53a030affa4386cb1fd7a9add58dc700e04249c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.9 MB (292875024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5efa2a0d78c7a1fe0750aab8ad426841e46f186951548680cf1678962c8d6d42`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 31 Aug 2021 08:16:06 GMT
ENV GRADLE_VERSION=7.2
# Tue, 31 Aug 2021 08:16:15 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Tue, 31 Aug 2021 08:16:47 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:1dfb55dd4ec2edc8849be0f26a43615497975d9c174da6ec798e684b29ee964d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddef326fc3220d1ac9e6ea08086ca20ff4812a8c2c7161b8639341e7424144da`  
		Last Modified: Tue, 31 Aug 2021 09:08:17 GMT  
...
```console
$ docker pull gradle@sha256:20786fcd7de18398b1c6499fa583075d6834ec44a1732aacb7b975d85dcd9eb5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.4 MB (275405296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:883f1b77800b91c2047b8f543b790708280dd6a33c68cff084f74ff0889d1442`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 01 Oct 2021 02:54:01 GMT
ENV GRADLE_VERSION=7.2
# Fri, 01 Oct 2021 02:54:02 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
...
-	Layers:
	...
	-	`sha256:2f23690807155259272b22c7d27f5a7428f49b51b15f46d1c51d712ef26f85c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4171281bdf66380dbdf6c803b700462afe89f6bcdce01115a1952025f8a4a3b`  
		Last Modified: Fri, 01 Oct 2021 03:08:24 GMT  
		Size: 114.4 MB (114373831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
