...
```console
$ docker pull gradle@sha256:da806f99544f34f0e369d2ea75f4da7d1e82722367df5a09a94cad3b0481666a
```
...
```console
$ docker pull gradle@sha256:8485103d95a92741a7f86f5878cddb931bf5c8fa98fe276632efa00f85488084
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.6 MB (272550238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81ae954f217b1451d155b1b035968ca201798ba8a9199a914806d16e8a2f578e`
...
-	Layers:
	...
	-	`sha256:9e5396020e45ab7345f8c641a6215af60d9287abe2594a793afe6efca868db50`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9af7a82d00df1e17f637f3fdf7b8f5c0ccef5418f769c33e20c4214af449c84`  
		Last Modified: Wed, 25 Jan 2023 20:23:54 GMT  
...
```console
$ docker pull gradle@sha256:89b345f7232129a948a311c6896d2900e91d6c2062423fcb570aa3f7149f2d96
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.9 MB (269874056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eae100459989c9d361fed9ee6466c83e52ba53fb7bcabfd3cccdb9ae033ccc47`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 25 Jan 2023 20:42:24 GMT
ENV GRADLE_VERSION=6.9.3
# Wed, 25 Jan 2023 20:42:24 GMT
ARG GRADLE_DOWNLOAD_SHA256=dcf350b8ae1aa192fc299aed6efc77b43825d4fedb224c94118ae7faf5fb035d
# Wed, 25 Jan 2023 20:42:27 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dcf350b8ae1aa192fc299aed6efc77b43825d4fedb224c94118ae7faf5fb035d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:4be158d41dd76d978e70c66fb601a8dcdf83a81e5edb6a90e9cc52e821d913c2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8750eb57ac9294a6c67aca277d4278896dd520b5a47b08a7e9f1362843f6bd83`  
		Last Modified: Wed, 25 Jan 2023 20:46:45 GMT  
...
```console
$ docker pull gradle@sha256:f4e89a34240b59ca4f0dd8ce47c9db1e4bf3c82109717dd097de6a0d75138a54
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.4 MB (284418344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08fbe87cb3986c6c529f4e334141d6b06b740f25041f9b6fe3d35c21d178f77b`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:0a1913cfc7adbc900c9222cb6b970610ae8dadb85b94e8154433c70ac8d32410`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c4a6b2952b9dfd50a1166e9c310861c36b2a296aa353a925ca2c7f29e408fbc`  
		Last Modified: Wed, 25 Jan 2023 20:34:31 GMT  
