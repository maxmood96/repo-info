...
```console
$ docker pull gradle@sha256:7965ea4a12084c5b8385b5096fef5485642fd5cf548d877676a0da76cde6fcce
```
...
```console
$ docker pull gradle@sha256:c337aa39140051a09786373e33b63111a06cacf5d144a73359b6df3978d23820
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.3 MB (322273404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ab72c7bfb4688629e388517d5c1072b6c1a1028de0cb298f35d9f8221d152d8`
...
-	Layers:
	...
	-	`sha256:64e16ceb3faeef5b75f49dc2e0444af8af94ab74256c047cb6c3439dc88227a1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f27e98d8b73528d2e6da2070065a4c10741dadd4fb24df9225d742e81dad618e`  
		Last Modified: Wed, 06 Mar 2024 09:58:31 GMT  
		Size: 107.7 MB (107696538 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46234fc48d74e4e43b3ac5ed5b877a27d701709fdda1727338ce94a2c268bd00`  
		Last Modified: Wed, 06 Mar 2024 09:58:26 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:e178afd40428bebdf108765272e2bad7ed211f6836458eb5ea0d47bf42773efc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.6 MB (319620430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0d42ce6e8e4c20f6b4973fef7d49517bc749637254a4c50df66d5cbf3361f9a`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 06 Mar 2024 13:47:36 GMT
ENV GRADLE_VERSION=6.9.4
# Wed, 06 Mar 2024 13:47:36 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 06 Mar 2024 13:47:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 13:47:40 GMT
USER gradle
# Wed, 06 Mar 2024 13:47:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 13:47:41 GMT
USER root
...
-	Layers:
	...
	-	`sha256:07beb2fcf504cd37abedb055c58c230d800158b80975d37b83d546b7b0f76900`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a705ab3b300f6a4786f1a2e212221243041bc2911788d6deb45bd037444bedf5`  
		Last Modified: Wed, 06 Mar 2024 13:56:17 GMT  
		Size: 107.7 MB (107696576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e67639d8f44cc2ba4cbca82480be331757b9b5ea86de5d6fdfbadead624b0a9`  
		Last Modified: Wed, 06 Mar 2024 13:56:13 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:fd876701799a90594a55f5821091cbe783dc6218aa4a4efdaede6c591247f756
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.1 MB (334143292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12cfb6b04bfba2cb098ed5016d18e32fe6b267153a722fa9398ef1929accc668`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Wed, 06 Mar 2024 04:03:21 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 06 Mar 2024 04:03:27 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 04:03:29 GMT
USER gradle
# Wed, 06 Mar 2024 04:03:31 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 04:03:32 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:f5f489262ae3dde1d568533f16578e5fdbccdbb4308da681da05b17938af2443`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a37b914f82401e2c2a054efe066788477a596b44fa89eb1909c1dd4826eee030`  
		Last Modified: Wed, 06 Mar 2024 04:13:32 GMT  
		Size: 107.7 MB (107696563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f1e5c41fb04f9f7074c76be8777f70e78f6e480a49560233737cea5b3d18817`  
		Last Modified: Wed, 06 Mar 2024 04:13:27 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
