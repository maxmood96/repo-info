...
```console
$ docker pull gradle@sha256:39d59555d0a54de0e1f7e1af0a3b8ec2803868439215402cf6d555ed2e5f4492
```
...
```console
$ docker pull gradle@sha256:67bca55296c4e6ede5b520aa6f67072a86cd5fa8de891bf26677d0100b5a6474
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.3 MB (322265941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d6c25e58c3f2b4b0f6b7b0fc38f108699daceb0971aeae4c51065f085fc2b2c`
...
-	Layers:
	...
	-	`sha256:dd7c41b28b114546fe59aff41f0ca5ce4fb7dfe078893c1acaf02b99c7bc6a1c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dff3e6f4fc0789301160393fcf4e912b1d972fff9cacffae5b04035c9d73f48a`  
		Last Modified: Thu, 18 Jan 2024 19:19:05 GMT  
		Size: 107.7 MB (107696565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24bf837580a3f5287d51d0386a9b35a3aadf536065cd41c53ba142dbad35fcf2`  
		Last Modified: Thu, 18 Jan 2024 19:19:00 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:43fca2156acf6cf7297c3deb1de673a67f9371616ef93662b1d95e97ddbac843
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.6 MB (319612164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85db1e0cc558d1f2f5e78324570ee2e84b5e507c981943a9d0e5ac6630f88214`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Thu, 18 Jan 2024 19:03:39 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 18 Jan 2024 19:03:43 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 18 Jan 2024 19:03:43 GMT
USER gradle
# Thu, 18 Jan 2024 19:03:44 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 18 Jan 2024 19:03:44 GMT
USER root
...
-	Layers:
	...
	-	`sha256:ff5b6d50072f4715c3c4b84fb38e6b451fc07f8b41002e268833a8cb9e9179d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db46a88d63dbf086861c237c6d91da9f2dc3c7487d2206aef5193bd84a45c697`  
		Last Modified: Thu, 18 Jan 2024 19:10:29 GMT  
		Size: 107.7 MB (107696570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a494e5aea481fec566e760ebb2fe77c6ec40b20759bdf592f3213fc1deb3b995`  
