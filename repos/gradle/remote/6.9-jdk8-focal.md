...
```console
$ docker pull gradle@sha256:268bd421300d8f58660fbfdbd7cf2967f61b2d37045148306dac0a613a8e7284
```
...
```console
$ docker pull gradle@sha256:ff94992cf2385e45b7a6d887766c1c81d1bbe8fc6547e73e28f24ab0bf2bcc52
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.3 MB (307285905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17a61df3edc234e41b30175060ab6370650b04fc54095f9330aebbfa52977cb6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Wed, 24 Jan 2024 21:38:49 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 24 Jan 2024 21:38:53 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Jan 2024 21:38:54 GMT
USER gradle
# Wed, 24 Jan 2024 21:38:55 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Jan 2024 21:38:55 GMT
USER root
...
-	Layers:
	...
	-	`sha256:af93f6824f35b7b27553df3a31e89d3b158650dd9e0ae8aa533fde417eda52c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c8e0440a5da9db72e06cb149cc017cb4a2df4989f54cd53b6ca0978f0a6e917`  
		Last Modified: Wed, 24 Jan 2024 21:47:24 GMT  
		Size: 107.7 MB (107696525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ff9aac13df6185cc03754edb19b2be089803d831663c4968e9e8064f9a42869`  
		Last Modified: Wed, 24 Jan 2024 21:47:17 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:909f5b28caf63eec65b11093d928645d42c377663ed4df2bd38e84ae14abbb09
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.6 MB (319611059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f04f8d0ff8732963c3f7d8bc27ee00377736b53fcf3ff51487045b1817ad334`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Jan 2024 23:11:53 GMT
ENV GRADLE_VERSION=6.9.4
# Wed, 24 Jan 2024 23:11:53 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 24 Jan 2024 23:11:56 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Jan 2024 23:11:56 GMT
USER gradle
# Wed, 24 Jan 2024 23:11:57 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Jan 2024 23:11:58 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:2f5653299c76fcee3e753d633d719f3165386dbdbde824ed2181333572879692`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6be78a1f5c0a3853ab8385f8a332cd3906cd6a878f59003cea56e9b5fa799737`  
		Last Modified: Wed, 24 Jan 2024 23:20:13 GMT  
		Size: 107.7 MB (107696578 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbae98dba1c687d30a500188dd20ba51f6320eeb31f5bbce4a5c7fec3f9bba61`  
		Last Modified: Wed, 24 Jan 2024 23:20:09 GMT  
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
