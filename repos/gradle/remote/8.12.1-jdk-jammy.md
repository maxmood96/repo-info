...
### `gradle:8.12.1-jdk-jammy` - linux; amd64
...
### `gradle:8.12.1-jdk-jammy` - unknown; unknown
...
### `gradle:8.12.1-jdk-jammy` - linux; arm64 variant v8
...
### `gradle:8.12.1-jdk-jammy` - linux; ppc64le
...
### `gradle:8.12.1-jdk-jammy` - linux; s390x
