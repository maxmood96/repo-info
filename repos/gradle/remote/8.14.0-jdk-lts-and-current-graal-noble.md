...
### `gradle:8.14.0-jdk-lts-and-current-graal-noble` - linux; amd64
...
### `gradle:8.14.0-jdk-lts-and-current-graal-noble` - unknown; unknown
...
### `gradle:8.14.0-jdk-lts-and-current-graal-noble` - linux; arm64 variant v8
