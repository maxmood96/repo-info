...
```console
$ docker pull gradle@sha256:0bf873ee2eb53bc6716d735434abfd197c2bcc637c1ba496adba1fd0c714a299
```
...
### `gradle:6.9.1-jre8-openj9` - linux; amd64
...
### `gradle:6.9.1-jre8-openj9` - linux; arm64 variant v8
...
### `gradle:6.9.1-jre8-openj9` - linux; ppc64le
...
### `gradle:6.9.1-jre8-openj9` - linux; s390x
