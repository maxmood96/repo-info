...
### `gradle:7.6-jdk-lts-and-current-corretto` - linux; amd64
...
### `gradle:7.6-jdk-lts-and-current-corretto` - unknown; unknown
...
### `gradle:7.6-jdk-lts-and-current-corretto` - linux; arm64 variant v8
