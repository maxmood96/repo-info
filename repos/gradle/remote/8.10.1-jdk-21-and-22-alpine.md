...
```console
$ docker pull gradle@sha256:2658ce645505458a679ede5765572a316033bd4722b144edd9a38fa2c1ae28b0
```
...
### `gradle:8.10.1-jdk-21-and-22-alpine` - linux; amd64
...
### `gradle:8.10.1-jdk-21-and-22-alpine` - unknown; unknown
