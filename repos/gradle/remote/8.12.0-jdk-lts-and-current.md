...
### `gradle:8.12.0-jdk-lts-and-current` - linux; amd64
...
### `gradle:8.12.0-jdk-lts-and-current` - unknown; unknown
...
### `gradle:8.12.0-jdk-lts-and-current` - linux; arm64 variant v8
