...
```console
$ docker pull gradle@sha256:d269f7476c026712b3c45121e1a7416884e73c6be64e079503e5a0d0926c5b91
```
...
```console
$ docker pull gradle@sha256:390412a43b065a8c52fe83a3e255dba2f2e58aba0871aabe5d7e16d999662765
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **373.0 MB (373015702 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c85816d20ea6e3e8064eb99dadbf8e0f6661c7ef1b419bdd758ddab35fe68eb9`
...
# Wed, 06 Mar 2024 09:45:24 GMT
USER gradle
# Wed, 06 Mar 2024 09:45:25 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 09:45:26 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:991de3913e62f448405c8fe4b44916fd590d8c96a0e93fd8d4dd6f083cfdd2fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab45b811956970d8f4655a79eadc9d529253e9b3b6ca0fc39455ef47d0fd7bf5`  
		Last Modified: Wed, 06 Mar 2024 09:52:14 GMT  
		Size: 132.8 MB (132815734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4ad3b442234b1bcd423fc39e49e48bb3fbb5a5ab8a9be5cde1efc8e3324a2b4`  
		Last Modified: Wed, 06 Mar 2024 09:52:07 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:226ac1c284f602807ee8b3d1c997154c1df29da558de0355d38237e113e136a6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.6 MB (368601102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:893f76948a2fabc2a531a486919a5fbace4f86abe35352b87f407e06b07269e0`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 25 Mar 2024 18:40:00 GMT
ENV GRADLE_VERSION=8.7
# Mon, 25 Mar 2024 18:40:00 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Mon, 25 Mar 2024 18:40:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Mon, 25 Mar 2024 18:40:05 GMT
USER gradle
# Mon, 25 Mar 2024 18:40:06 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Mon, 25 Mar 2024 18:40:06 GMT
USER root
...
-	Layers:
	...
	-	`sha256:6e121c83092f3491c163fbdd11f438cf3fb6c411bbb57cda870fc05378fd1472`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0b275d1dd94430e7dda4783e31c5b09c2151de3299563c95d05e88730bb9862`  
		Last Modified: Mon, 25 Mar 2024 18:43:30 GMT  
		Size: 134.2 MB (134209932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75d411709dadf4d157c33d5fc53c7a4a446b520cfac333999857bac9484deeb0`  
		Last Modified: Mon, 25 Mar 2024 18:43:25 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
