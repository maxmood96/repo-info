...
```console
$ docker pull gradle@sha256:f4917a3fbb6b2cea8a1a982016c8b42114ed28994afe730d2dc4d15111bda276
```
...
```console
$ docker pull gradle@sha256:a7e04b38e953c86f99e1cd7f134738c0ea5eabe812f7da8cf11cb78a838f3fb3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **417.0 MB (416952319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f22d6e8c55ec8f1396760a499aa3e99903e86c459937597f97bd108166870cd0`
...
-	Layers:
	...
	-	`sha256:575ad575010bdd62fb094d9affbd505736358b966521226c1f9333f6494e7372`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c85799d2945aef6d7076ff44f5ab1fdfac1dbbef3c94499d5aab3b54f796b33d`  
		Last Modified: Thu, 16 Mar 2023 06:23:18 GMT  
...
```console
$ docker pull gradle@sha256:4dc925acc3604fc5af7d811eb1660ad696e6550e5a7baa7312032a913d0421cc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **402.7 MB (402677937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc0c928a530aaad7925518a66e72cbb4c42d6d9a8aa0f010be431b9399f9e653`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:26:21 GMT
ENV GRADLE_VERSION=8.0.2
# Thu, 16 Mar 2023 05:26:21 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Thu, 16 Mar 2023 05:26:26 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:dcfb76dcb3e552e10d5b0a5d724e72d42fd69c6ef14480e4e52bc8de1fe4d839`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2d2e9b22003c7e6605d701f9a4f2305ba37aa4deeaf35b6468caf3f257e11d6`  
		Last Modified: Thu, 16 Mar 2023 05:37:47 GMT  
		Size: 124.1 MB (124141199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8-jdk11` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:5c356591a3b0b5c870585741d0fea0e5803a2545550c6ce54dc8e8a5a143d069
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **411.2 MB (411188993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:933ab18c03bf366fac078db0e6bbc64711636196e39a2d43edb6405ab2ecc4fc`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:20:59 GMT
ENV GRADLE_VERSION=8.0.2
# Thu, 16 Mar 2023 05:20:59 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Thu, 16 Mar 2023 05:21:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:c801fc027f8d1811fd4c0088f5878ce7011eef9008e726d569ffad4ae738e2b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1934a99968cee7882a557694ffb672efa4c6584872dee952a4fc13741fb161cf`  
		Last Modified: Thu, 16 Mar 2023 05:27:48 GMT  
...
```console
$ docker pull gradle@sha256:77474ceb9aa84a3ce418b69d2984a619f260c20d2d287c04b643d9720ffe5201
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **409.2 MB (409242563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38e7fb587c0c4e6763f2c4dfc7be797f8d8944fdac3c7825a6151c2ecda57ea5`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 03 Mar 2023 23:23:13 GMT
ENV GRADLE_VERSION=8.0.2
# Fri, 03 Mar 2023 23:23:13 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Fri, 03 Mar 2023 23:23:24 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:f5dee8e8527366b1ecd4e78b8e57773ce2cd66e8a43d50b4622c24b6e8d19e76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04bf361176ef846b4fed17e76692766c69ed128ab54fc04fae827baeaa12b3c4`  
		Last Modified: Fri, 03 Mar 2023 23:35:14 GMT  
...
```console
$ docker pull gradle@sha256:ed9bd504d6005889f6e63025bed44ec47eade4dc042ebbd82447582b481f26fd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **388.4 MB (388384650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e739e1f16111359a567ced59d3878b35b5dcca1dce3511e85716a57fc2374ca7`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 03 Mar 2023 23:48:49 GMT
ENV GRADLE_VERSION=8.0.2
# Fri, 03 Mar 2023 23:48:50 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
...
-	Layers:
	...
	-	`sha256:740285858c4e51374df25d2de747e6226085e37410c4af635a8fd384ba90d5bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3358abf1411fcb8b4b37831c47f6aebfcd032d9823b9c5a3d7f3b61965e3b1a5`  
		Last Modified: Fri, 03 Mar 2023 23:56:18 GMT  
