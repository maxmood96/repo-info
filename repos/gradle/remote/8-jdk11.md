...
```console
$ docker pull gradle@sha256:ebe1562312cf25e5755fda1850da8fda4c2857596ac1f4c5f4fde6c87911aebc
```
...
```console
$ docker pull gradle@sha256:eeda50718346abd2df3583cc0a7121a127e86159fd56986a4ceb7b98f2792cc1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **421.7 MB (421735938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5e9fb37b36cc95a9f09146090675296d556e78fb1bbb4f390b45bce324c2c68`
...
-	Layers:
	...
	-	`sha256:452bcfc1d2122a92727efa5c226ada632c463d7c029ea58b5079b9de14918c4a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:960981c920f101e3087e0792d7d3cd594d10f7054221f1d0e737cf504523a14c`  
		Last Modified: Wed, 05 Jul 2023 12:47:38 GMT  
		Size: 128.7 MB (128721388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:d9f65254cd0d87f8889a667802c5d4104686655eacda268c7bcb50ee290d9a6d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **393.2 MB (393172218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ac00eb33090e2e28975ae88bd3fd244abe7955abc6e18217d7caac680703d6b`
-	Default Command: `["gradle"]`
...
# Tue, 04 Jul 2023 16:24:57 GMT
CMD ["jshell"]
# Wed, 05 Jul 2023 10:43:00 GMT
CMD ["gradle"]
# Wed, 05 Jul 2023 10:43:00 GMT
ENV GRADLE_HOME=/opt/gradle
# Wed, 05 Jul 2023 10:43:01 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln --symbolic /home/gradle/.gradle /root/.gradle
# Wed, 05 Jul 2023 10:43:01 GMT
VOLUME [/home/gradle/.gradle]
# Wed, 05 Jul 2023 10:43:01 GMT
WORKDIR /home/gradle
# Wed, 05 Jul 2023 10:43:36 GMT
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 05 Jul 2023 10:43:40 GMT
ENV GRADLE_VERSION=8.2
# Wed, 05 Jul 2023 10:43:40 GMT
ARG GRADLE_DOWNLOAD_SHA256=38f66cd6eef217b4c35855bb11ea4e9fbc53594ccccb5fb82dfd317ef8c2c5a3
# Wed, 05 Jul 2023 10:43:48 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=38f66cd6eef217b4c35855bb11ea4e9fbc53594ccccb5fb82dfd317ef8c2c5a3
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:22e53aaa85f731103c9080ead3eee9dc33008596b812976cc4ef17b685852a16`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e138abceeeffadb7f2779c14662be87c660d0d70e638fa9dc8cabb792ec687f`  
		Last Modified: Wed, 05 Jul 2023 10:50:08 GMT  
		Size: 4.4 KB (4368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cd133b5f888483b647a3a973299babefb53a90d8164db5d707d5ae3fb61dc6c`  
		Last Modified: Wed, 05 Jul 2023 10:50:16 GMT  
		Size: 51.3 MB (51258034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23cff8c6f9232aaf19c77fbe0d0ec78c603c561105b37611ee232580c6ab4bb0`  
		Last Modified: Wed, 05 Jul 2023 10:50:13 GMT  
		Size: 128.7 MB (128721389 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
