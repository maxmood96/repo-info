...
### `gradle:9.5-jdk17-resolute` - linux; amd64
...
### `gradle:9.5-jdk17-resolute` - unknown; unknown
...
### `gradle:9.5-jdk17-resolute` - linux; arm variant v7
...
### `gradle:9.5-jdk17-resolute` - linux; arm64 variant v8
...
### `gradle:9.5-jdk17-resolute` - linux; ppc64le
...
### `gradle:9.5-jdk17-resolute` - linux; s390x
