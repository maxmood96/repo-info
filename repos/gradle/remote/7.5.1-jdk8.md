...
```console
$ docker pull gradle@sha256:33bcd60d26ed79e8504008e68d397153eb9a6b53f975aa1a9387878d08842a3d
```
...
```console
$ docker pull gradle@sha256:e3bce9091e4f595cf80b9204cd7ea4b23cc29ebb77b8f8f14e77ac27d8c89e52
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.3 MB (318298364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f4c3e603768d9de18973ba0fb1c3d39118f95f9edec3fc296ea3020d69066dc`
...
-	Layers:
	...
	-	`sha256:84b3adaa6d5dd28ab7811ba313d65814059b59f5996ef6e13cada9155b3ecbf3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c88bdd44062e6be0d82db6de79be24884e5b0563736390e29276988c6394b834`  
		Last Modified: Wed, 26 Oct 2022 22:23:16 GMT  
...
```console
$ docker pull gradle@sha256:c7d934895a056fdd7818d450c41a8a814ae2b6d6499968e01231ef7ea13e08ad
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.2 MB (312156501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a9f66a86d863de8bf8d5db1cdcb74559182eeb63f91d546589e4e991b753b90`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:45834c73bac78eb4b19dae3c578fcd482bcf471f49e9df5a20d17b0d0b8ce3aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47eb95b09495b4ad2aac08c4741b8d6353e1c209a1e510771e55f76ae0e1bc8c`  
		Last Modified: Fri, 07 Oct 2022 05:43:37 GMT  
...
```console
$ docker pull gradle@sha256:a22771af55e1a99488b21e82b562a78e4ae440067364f27c25b536219ec391a4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.9 MB (314893159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aab20f480ab6e978881c7a675b86438987fec9edcd30ef80f7870e27b10cc549`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 26 Oct 2022 16:17:18 GMT
ENV GRADLE_VERSION=7.5.1
# Wed, 26 Oct 2022 16:17:18 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Wed, 26 Oct 2022 16:17:22 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:cb7381a3a4216b4ef77df0e0181e7af7733fdd9624eef8fe4ec384b0dbba5948`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1607bd26d4c48ba239f2dd152479fdc619509f68b7130d3543a090a770c82eae`  
		Last Modified: Wed, 26 Oct 2022 16:22:22 GMT  
...
```console
$ docker pull gradle@sha256:0a621beb6da34e039b489ea9113979405579f3d5966581dec4d0a67b09c22d88
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.1 MB (326120264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86e74ae278be1cbfa444ff90c772e6e3847f95ea45c6c2179f25af09859ed7b0`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 26 Oct 2022 01:34:37 GMT
ENV GRADLE_VERSION=7.5.1
# Wed, 26 Oct 2022 01:34:38 GMT
ARG GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
# Wed, 26 Oct 2022 01:34:48 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f6b8596b10cce501591e92f229816aa4046424f3b24d771751b06779d58c8ec4
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:debf2a39302a670a381f8d0d657f0c0266f77a865a38a83aafa8dfd0f345dea5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd7fd0428f89ada56902d4a333da9db4c6511346cad091a7f685fa0839c5f3d1`  
		Last Modified: Wed, 26 Oct 2022 01:46:16 GMT  
