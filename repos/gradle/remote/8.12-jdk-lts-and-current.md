## `gradle:8.12-jdk-lts-and-current`
...
### `gradle:8.12-jdk-lts-and-current` - linux; amd64
...
### `gradle:8.12-jdk-lts-and-current` - unknown; unknown
...
### `gradle:8.12-jdk-lts-and-current` - linux; arm64 variant v8
...
### `gradle:8.12-jdk-lts-and-current` - linux; ppc64le
...
### `gradle:8.12-jdk-lts-and-current` - linux; riscv64
...
### `gradle:8.12-jdk-lts-and-current` - linux; s390x
