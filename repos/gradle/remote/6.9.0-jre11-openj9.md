...
```console
$ docker pull gradle@sha256:170357e6810f18bf537202f11f85b2ac00545581541309d179c4572ed1de6db4
```
...
### `gradle:6.9.0-jre11-openj9` - linux; amd64

```console
$ docker pull gradle@sha256:73c8d02e945c79c3d585ec799daebb60e65346cd5d2608661bdf067ed920020b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.8 MB (266792266 bytes)**  
...
-	Layers:
	...
	-	`sha256:24772b9e1bda53178b82f0ccf7d5b3455ec7dda179fad7929876e7bf0368a918`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32ce5456a7e623c245552d7a3a41bf0b53e62bade28b14f14479dc15db791800`  
		Last Modified: Mon, 10 May 2021 19:03:12 GMT  
		Size: 108.1 MB (108149224 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9.0-jre11-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:c0bebc3a52465d2b20b72daa2b2a7ef4f8a4251a7873efeaa4e92b542a23c1be
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.3 MB (261315634 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4c5ccab63eebd90a23784731105b17fdeb6675aef48a6a22aadd2ae1b25e097`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 17:57:57 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 17:57:58 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 17:58:24 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b1a85ebec960097502b9cc29817290b52ba4fcfa20a803be4bc3cad7d02a105e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7388e90d9efb173c078a3243f3653f1c4411dd2d209b55ee9d3a07535406fdf`  
		Last Modified: Mon, 10 May 2021 18:08:53 GMT  
		Size: 108.1 MB (108149299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9.0-jre11-openj9` - linux; ppc64le

```console
$ docker pull gradle@sha256:94cad7524b6ef2b6baf889069e4aeeb91d2dee22af98749cf9e8e6d2dc7b969d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **281.0 MB (281011032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4188fc235bfacac57955042dc877471c00202a735f6cb243a16818ef0560e102`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 20:06:20 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 20:06:25 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 20:08:12 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:ad338b28fa05fb670b7ee42c7f5ec606be3904c8e5364b4f9dc0354526bcd67c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:175224b562e15829069e850ca4ee56999a609789d323133809bf0de9ebc4401e`  
		Last Modified: Mon, 10 May 2021 20:41:26 GMT  
		Size: 108.1 MB (108149244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9.0-jre11-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:e84d55d9a2627ad303f9b843b5e4206d2f19d1489fbc65750102c78eaf6c027c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.5 MB (263547964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7caf7afd15a8c75e0c1164f6ac6fa3d5725135fbdb019d0f6777a993e6526f3a`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 18:50:27 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 18:50:28 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 18:50:48 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:39eff1002243d6babbd64dc2a9147d65f149e890cd7ba5f501560bbdeaf510d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:659cb93887038afb1bb2c1dde538e1468a380ceb79171e060feebcb0198c0632`  
		Last Modified: Mon, 10 May 2021 20:18:58 GMT  
		Size: 108.1 MB (108149244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
