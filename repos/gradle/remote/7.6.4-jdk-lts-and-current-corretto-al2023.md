...
### `gradle:7.6.4-jdk-lts-and-current-corretto-al2023` - linux; amd64
...
### `gradle:7.6.4-jdk-lts-and-current-corretto-al2023` - unknown; unknown
...
### `gradle:7.6.4-jdk-lts-and-current-corretto-al2023` - linux; arm64 variant v8
