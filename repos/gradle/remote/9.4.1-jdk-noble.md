...
### `gradle:9.4.1-jdk-noble` - linux; amd64
...
### `gradle:9.4.1-jdk-noble` - unknown; unknown
...
### `gradle:9.4.1-jdk-noble` - linux; arm64 variant v8
...
### `gradle:9.4.1-jdk-noble` - linux; ppc64le
...
### `gradle:9.4.1-jdk-noble` - linux; riscv64
...
### `gradle:9.4.1-jdk-noble` - linux; s390x
