...
### `gradle:8.12-jdk17-noble` - linux; amd64
...
### `gradle:8.12-jdk17-noble` - unknown; unknown
...
### `gradle:8.12-jdk17-noble` - linux; arm variant v7
...
### `gradle:8.12-jdk17-noble` - linux; arm64 variant v8
...
### `gradle:8.12-jdk17-noble` - linux; ppc64le
...
### `gradle:8.12-jdk17-noble` - linux; riscv64
...
### `gradle:8.12-jdk17-noble` - linux; s390x
