...
### `gradle:jdk-graal-resolute` - linux; amd64
...
### `gradle:jdk-graal-resolute` - unknown; unknown
...
### `gradle:jdk-graal-resolute` - linux; arm64 variant v8
