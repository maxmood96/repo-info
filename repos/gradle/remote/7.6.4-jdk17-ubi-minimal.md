...
### `gradle:7.6.4-jdk17-ubi-minimal` - linux; amd64
...
### `gradle:7.6.4-jdk17-ubi-minimal` - unknown; unknown
...
### `gradle:7.6.4-jdk17-ubi-minimal` - linux; arm64 variant v8
...
### `gradle:7.6.4-jdk17-ubi-minimal` - linux; ppc64le
...
### `gradle:7.6.4-jdk17-ubi-minimal` - linux; s390x
