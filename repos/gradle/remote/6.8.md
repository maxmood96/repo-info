...
```console
$ docker pull gradle@sha256:9f6cc23298a3067f1ea36a1199cdc7af21d0993dcfd6c00e6ba585a0e460a76a
```
...
### `gradle:6.8` - linux; amd64

```console
$ docker pull gradle@sha256:a1e3c7ac78b871e1d30ac98dc454229cee48ef283178399824111a4303839b35
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.5 MB (321453574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aefd9b19df413cde54b1d0fb24ff43835b93392a94504383036597f2b6b89a9`
...
-	Layers:
	...
	-	`sha256:a711e484c1fade34b66d95dc430f07a570ea9df7420e4a949fe116d8d698d86c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd1a8f8bdcc2cf89d99dc783b2c30f6b4e8946407c07c20fa51c9a98605eea5a`  
		Last Modified: Tue, 27 Apr 2021 22:41:47 GMT  
		Size: 107.9 MB (107863093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.8` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:50fcd1cf8fb23a3b314f6d06dee94b70f12de367cf208a1ceac4568c71c85d0f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.1 MB (319070549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d83eb1859ebd94a5cefd6a32059c6526ddd43c3b22cd8cb77007b8e4030b5c5`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 27 Apr 2021 22:50:59 GMT
ENV GRADLE_VERSION=6.8.3
# Tue, 27 Apr 2021 22:51:00 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Tue, 27 Apr 2021 22:51:08 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b8460414230ba9223a3c2e4c38495a386d6330a32aec045db90d5a98086c78a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:715f029edbcd94d2f48586ddcc15a4304b52515fd3a54b4ee5849e7c1fe3f724`  
		Last Modified: Tue, 27 Apr 2021 23:00:55 GMT  
		Size: 107.9 MB (107863108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.8` - linux; ppc64le

```console
$ docker pull gradle@sha256:70bc9e7afa345ab11286cee93898495c45509cf2dab072b67814c75f08b9feea
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.2 MB (333211179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:105577f4cebaab06627114cdfc90e24755e3212a56a27746c7b1c443130aeb3f`
-	Default Command: `["gradle"]`
...
ENV GRADLE_VERSION=6.8.3
# Wed, 28 Apr 2021 00:01:09 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Wed, 28 Apr 2021 00:02:27 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:9cff8be530181a8d780cc2e7f853c2beaa058223ab416cba7443d2941ce65d43`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a44012b21347ebeeec96d0faadb44f149d104c28793af8d585b27c553389f01`  
		Last Modified: Wed, 28 Apr 2021 00:45:25 GMT  
		Size: 107.9 MB (107863104 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.8` - linux; s390x

```console
$ docker pull gradle@sha256:1c921e031a63c9797859f2975effce9ca82d75e51fa2497f20c40d8d0d97652b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.1 MB (314071523 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e141ed8f28ca670bd09674c333888bc930047d8a9ff8b8f8c425388ff2e53d1`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 27 Apr 2021 22:58:46 GMT
ENV GRADLE_VERSION=6.8.3
# Tue, 27 Apr 2021 22:58:46 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Tue, 27 Apr 2021 22:58:53 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:6eced7c5116746a03d8dd44008574b7b6fc6373017c96ebc1ab263f0040e542b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f815e50a63229a417f5ddc3add5505b2716e6b99fd0ec71967ff411ab21933a`  
		Last Modified: Tue, 27 Apr 2021 23:09:54 GMT  
		Size: 107.9 MB (107863063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
