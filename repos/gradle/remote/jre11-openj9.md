...
```console
$ docker pull gradle@sha256:b65ea0572c241cd01cf88b007f866c960e08d641a1300922d6c92de4ab0248fb
```
...
```console
$ docker pull gradle@sha256:2840c1703285126564a2ccd560c1d75dc28951761b41464239988b9b21990712
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.7 MB (270727595 bytes)**  
...
-	Layers:
	...
	-	`sha256:24772b9e1bda53178b82f0ccf7d5b3455ec7dda179fad7929876e7bf0368a918`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:944f108cdaff19a03e362a398156c87abaee371eba823eaea4f777c77fd315d6`  
		Last Modified: Tue, 11 May 2021 01:17:25 GMT  
...
```console
$ docker pull gradle@sha256:26d97fea255437f07ca01a58552b27d920ab4caf4f928a100d9e5656d7b4bd07
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.3 MB (265250871 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea5058e0021b1e70072a3b86d804dd1824693807a85bd80b7a7a06435415e985`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 01:15:57 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 01:16:01 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
# Tue, 11 May 2021 01:16:53 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b1a85ebec960097502b9cc29817290b52ba4fcfa20a803be4bc3cad7d02a105e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a811607ce11380f6307d9ba38ae2ca7810d1ba683ad88d54695cc50a8e259ea`  
		Last Modified: Tue, 11 May 2021 01:27:58 GMT  
...
```console
$ docker pull gradle@sha256:d9fa078fc9f7d19c553b0ded5230bf0398fa9982e29312df4d47dd1f3d68daf4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.9 MB (284946359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b43781b025cc762c2666cc30081fd7c967fc909d2913ef9fae689c3583554f9d`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 01:37:32 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 01:37:42 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
# Tue, 11 May 2021 01:38:49 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:ad338b28fa05fb670b7ee42c7f5ec606be3904c8e5364b4f9dc0354526bcd67c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28be9f4b79c3eb63ce06c5e1cbc5be089bfaec97cfeefc3b87bb91555bc50047`  
		Last Modified: Tue, 11 May 2021 01:52:27 GMT  
...
```console
$ docker pull gradle@sha256:caa002710b3ef6bb000bcbee386e1798b984746b892e14c738989503c27148ab
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.5 MB (267483268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cda2b30fe6e2a897c0b7572ab0bd5b01c7ac98890e5b1fabf890f29bb3cbfe07`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 11 May 2021 00:23:10 GMT
ENV GRADLE_VERSION=7.0.1
# Tue, 11 May 2021 00:23:11 GMT
ARG GRADLE_DOWNLOAD_SHA256=dccda8aa069563c8ba2f6cdfd0777df0e34a5b4d15138ca8b9757e94f4e8a8cb
...
-	Layers:
	...
	-	`sha256:39eff1002243d6babbd64dc2a9147d65f149e890cd7ba5f501560bbdeaf510d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e724c9a7b51beeac2136a0a078a9bb1e818dcc40c2e806147bb39f3caed3c8c`  
		Last Modified: Tue, 11 May 2021 00:31:29 GMT  
		Size: 112.1 MB (112084548 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
