...
```console
$ docker pull gradle@sha256:9598387b1051d9bdec43ab82f032da6a0a785129bac3ba679bb6a1e379b8dd82
```
...
### `gradle:9.5.0-jdk26-ubi` - linux; amd64
...
### `gradle:9.5.0-jdk26-ubi` - unknown; unknown
...
### `gradle:9.5.0-jdk26-ubi` - linux; arm64 variant v8
...
### `gradle:9.5.0-jdk26-ubi` - linux; ppc64le
...
### `gradle:9.5.0-jdk26-ubi` - linux; s390x
