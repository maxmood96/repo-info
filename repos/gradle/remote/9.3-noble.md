...
```console
$ docker pull gradle@sha256:34ac44f5ffc170a7b26b3de5816baecd9e37b5f1e48a13fdbc3160633bb551d8
```
...
### `gradle:9.3-noble` - unknown; unknown
...
### `gradle:9.3-noble` - linux; arm64 variant v8
...
### `gradle:9.3-noble` - linux; ppc64le
...
### `gradle:9.3-noble` - linux; riscv64
