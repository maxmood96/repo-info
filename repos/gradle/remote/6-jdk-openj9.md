...
```console
$ docker pull gradle@sha256:3f33365338181373b57b6822af23e94dedc87773deea69934263c074f2883191
```
...
### `gradle:6-jdk-openj9` - linux; amd64

```console
$ docker pull gradle@sha256:e7a6a720daa063d571ea1b48a4589cf8bfbca6f3320e9ef7f196b4fd8a96eaf2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.0 MB (338950580 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66226cc7dad092ad4ff99adf0e9140e82cb1a49f4828885b9f3ff92ce3d709a6`
...
-	Layers:
	...
	-	`sha256:5abcaa0de3a4beba8cc8664060a147dc57ec98efc27ff1862926747c8fa7df0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d65277a0dfe275809a0504d5fc18457737fd24bcece7fabc499226bdd8c7fd9`  
		Last Modified: Mon, 10 May 2021 19:01:15 GMT  
		Size: 108.1 MB (108149238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6-jdk-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:a20c314d392bbcb7cc4320eee54936606343c03c8e6dfcf54b42b42a6de8435a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.2 MB (333184875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8972f272228f142dc9a3dc1fa1ac423b34513e08778bfe3e60d79054a2f4c2a`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 15 Jun 2021 17:48:53 GMT
ENV GRADLE_VERSION=6.9
# Tue, 15 Jun 2021 17:48:53 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Tue, 15 Jun 2021 17:48:57 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:cd1242aa5c60b76e0b87652c56a259d9673c79d657a1ff26fe40b713f73e4a8f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efb69f17385d36b9b2f833c7687331fb3aa9c6a47c5ea8cca4b6424a2fb0c187`  
		Last Modified: Tue, 15 Jun 2021 18:08:31 GMT  
		Size: 108.1 MB (108149245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6-jdk-openj9` - linux; ppc64le

```console
$ docker pull gradle@sha256:a631dcbb1d03d751570ab90e2737e399405ea4a27582a1056723bef0ea1d1dd4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.4 MB (353399604 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9470f3c5cd041fd00631aa83265b26ba66c22743b4b01fed1270f0be9a2e5f6f`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 19:59:47 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 19:59:55 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 20:01:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:8c7f86dc8d51245591f9fa9720a8727e5e943b645a2e1cb2d2da3072dc5baf8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb07ba8ca28da7ef458c05efbed82092cb8a3d5dd1d0f03c15ec8b8b7339aa40`  
		Last Modified: Mon, 10 May 2021 20:38:55 GMT  
		Size: 108.1 MB (108149264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6-jdk-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:45485d7799009680b2d8ac0765ebfd418e4d585bb976dce8696254c28931285f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.9 MB (335859136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08abb935f64225a74b2df83fb2c371027ecce1f4ba3294fa51423dde1b3904f1`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 18:48:59 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 18:49:00 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 18:49:19 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:6d9ecf0aeeb0b2b502cfce6a0d2d0a5e049dcd10047704049abc1b58c0e76ee6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7d4995b7356e535c8c0a9499a8beacc4e9bbe357ad20febf31f065722628c4f`  
		Last Modified: Mon, 10 May 2021 20:16:39 GMT  
