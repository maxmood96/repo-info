...
### `gradle:8.13.0-jdk23-ubi` - linux; amd64
...
### `gradle:8.13.0-jdk23-ubi` - unknown; unknown
...
### `gradle:8.13.0-jdk23-ubi` - linux; arm64 variant v8
...
### `gradle:8.13.0-jdk23-ubi` - linux; ppc64le
...
### `gradle:8.13.0-jdk23-ubi` - linux; s390x
