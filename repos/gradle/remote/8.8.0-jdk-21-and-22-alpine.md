## `gradle:8.8.0-jdk-21-and-22-alpine`
...
### `gradle:8.8.0-jdk-21-and-22-alpine` - linux; amd64
...
### `gradle:8.8.0-jdk-21-and-22-alpine` - unknown; unknown
...
### `gradle:8.8.0-jdk-21-and-22-alpine` - linux; arm64 variant v8
