...
### `gradle:9.1-jdk-lts-and-current-graal-noble` - linux; amd64
...
### `gradle:9.1-jdk-lts-and-current-graal-noble` - unknown; unknown
...
### `gradle:9.1-jdk-lts-and-current-graal-noble` - linux; arm64 variant v8
