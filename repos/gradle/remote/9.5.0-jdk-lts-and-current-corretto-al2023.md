...
### `gradle:9.5.0-jdk-lts-and-current-corretto-al2023` - linux; amd64
...
### `gradle:9.5.0-jdk-lts-and-current-corretto-al2023` - unknown; unknown
...
### `gradle:9.5.0-jdk-lts-and-current-corretto-al2023` - linux; arm64 variant v8
