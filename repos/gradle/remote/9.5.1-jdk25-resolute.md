...
### `gradle:9.5.1-jdk25-resolute` - linux; amd64
...
### `gradle:9.5.1-jdk25-resolute` - unknown; unknown
...
### `gradle:9.5.1-jdk25-resolute` - linux; arm64 variant v8
...
### `gradle:9.5.1-jdk25-resolute` - linux; ppc64le
...
### `gradle:9.5.1-jdk25-resolute` - linux; s390x
