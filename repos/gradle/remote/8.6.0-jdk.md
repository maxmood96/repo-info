...
```console
$ docker pull gradle@sha256:27ed98487dd9c155d555955084dfd33f32d9f7ac5a90a79b1323ab002a1a8b6e
```
...
### `gradle:8.6.0-jdk` - linux; amd64

```console
$ docker pull gradle@sha256:06a233bd47b63daa969cf0b93479bcea4a3d4fcb65d5f442c4a8c4c47604e15f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **377.2 MB (377182068 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:716c875ae7818e3fd247efeaa7f5b57fec54f6346f504f0684ee365574f4a722`
...
# Wed, 06 Mar 2024 09:46:25 GMT
USER gradle
# Wed, 06 Mar 2024 09:46:26 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
...
-	Layers:
	...
	-	`sha256:e38d172182efb8d6099b9376afc363370ff89159d62a8e7e63984a9c43edc521`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a1cdd43f5c2ac0406a0562a1fabc253b88f8b25c9dd341db255e7bc090d9d68`  
		Last Modified: Wed, 06 Mar 2024 09:53:13 GMT  
		Size: 132.8 MB (132815741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65ba38f32ffbef1ec532d3080832cdb0045b4b35c06174ed53552716ad66fe3f`  
		Last Modified: Wed, 06 Mar 2024 09:53:03 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.6.0-jdk` - linux; arm variant v7
...
### `gradle:8.6.0-jdk` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:9172219ab1a3a7e20caf8356107fec7c1a3a9b209ede68d9b6d43228348d6bec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **374.9 MB (374928514 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58487da5b029dfe20440f0f918a0724dc8edc5f1184a5a916024542b696549b4`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Wed, 06 Mar 2024 04:03:51 GMT
CMD ["jshell"]
# Wed, 06 Mar 2024 13:45:21 GMT
CMD ["gradle"]
# Wed, 06 Mar 2024 13:45:21 GMT
ENV GRADLE_HOME=/opt/gradle
# Wed, 06 Mar 2024 13:45:22 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln --symbolic /home/gradle/.gradle /root/.gradle
# Wed, 06 Mar 2024 13:45:22 GMT
VOLUME [/home/gradle/.gradle]
# Wed, 06 Mar 2024 13:45:22 GMT
WORKDIR /home/gradle
# Wed, 06 Mar 2024 13:45:35 GMT
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 06 Mar 2024 13:45:36 GMT
ENV GRADLE_VERSION=8.6
# Wed, 06 Mar 2024 13:45:36 GMT
ARG GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
# Wed, 06 Mar 2024 13:45:40 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 13:45:41 GMT
USER gradle
# Wed, 06 Mar 2024 13:45:42 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 13:45:42 GMT
USER root
...
-	Layers:
	...
	-	`sha256:50fe6d0cba0c42ed36093ce41b42d12fc8af90e931e78c10fe6842aba9127d31`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:354743dc12a3ea6a9c7ccfda25b04e2310b8d1246cd8f509ec420092402d2ca5`  
		Last Modified: Wed, 06 Mar 2024 13:51:00 GMT  
		Size: 4.4 KB (4368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80c6f699bed74dee0803b97130e88be1cefca116acf88dbc41f2fa9a2011042a`  
		Last Modified: Wed, 06 Mar 2024 13:51:07 GMT  
		Size: 51.1 MB (51125057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd4a805964753a66f2c5ecbcd4f68ddce2b7db29c76af773b4dda45df60c358f`  
		Last Modified: Wed, 06 Mar 2024 13:51:06 GMT  
		Size: 132.8 MB (132815737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:442ae3e73389055a51d8ecf22e626ec9730f2d23e3bd40b49a6d891474f17ed0`  
		Last Modified: Wed, 06 Mar 2024 13:51:01 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.6.0-jdk` - linux; ppc64le
