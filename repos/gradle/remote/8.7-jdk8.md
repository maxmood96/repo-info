...
```console
$ docker pull gradle@sha256:c2a0e1787c589dc60db3e21f56b5ad054214e621e61d80605285cd5b16e0e033
```
...
```console
$ docker pull gradle@sha256:2c6fc54533cc10cc2b3b3ba5a93338e3a2d959e57815c4086f39abc74ec71354
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.4 MB (327358134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:700c4c2ac9654e228d6d1b31e98428ecaf3295c2f97a011c87c2e1bb6b3680d6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 24 Apr 2024 18:46:00 GMT
ENV GRADLE_VERSION=8.7
# Wed, 24 Apr 2024 18:46:00 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Wed, 24 Apr 2024 18:46:05 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Apr 2024 18:46:06 GMT
USER gradle
# Wed, 24 Apr 2024 18:46:07 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Apr 2024 18:46:07 GMT
USER root
...
-	Layers:
	...
	-	`sha256:97b4763adf1abf212dffcb446af5f87343c2479dbba75cfd086756854cc65278`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d61b1ff40bf00762023b3c587c1fc185952c94f1969e4c51753aee98c898eebd`  
		Last Modified: Wed, 24 Apr 2024 18:52:30 GMT  
		Size: 134.2 MB (134209821 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d8cab03f0793eb50987e3e175226242188dd24a333bf0eb5ea25de5a51c16cb`  
		Last Modified: Wed, 24 Apr 2024 18:52:23 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:f91a832c764565ef8122e1b9c52d6cf58a2e44e7bc563d11f1ac6023fe4b456e
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.3 MB (340314609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02fff7872e3366322f93ad705643fb90a09fbe96e228ff356c9afff28622ffd8`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 24 Apr 2024 18:12:49 GMT
USER gradle
# Wed, 24 Apr 2024 18:12:52 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 24 Apr 2024 18:12:53 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:30084e1abb0ed3e9855725e92b2caf4893950dd8f1dc6c0d46be881bde9966f3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f42fd9f07c3128b28b8326d86171006d1bb76c9271dcdb3038cfae5d6ef87356`  
		Last Modified: Wed, 24 Apr 2024 18:26:01 GMT  
		Size: 134.2 MB (134209830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90384f5f8c15b9192f2270c65f47969c1dd3ee04c64247580500f75e7902e7b4`  
		Last Modified: Wed, 24 Apr 2024 18:25:54 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
