...
```console
$ docker pull gradle@sha256:3dc6d76940e3b1ce773325041600772f57b8c26049f6f7457dbe38400b0a7128
```
...
```console
$ docker pull gradle@sha256:ececd9be7d664fa486dca140e0fe3826956bd39f6ccc2575580349abacb3a807
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.2 MB (287244471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f95a1e44ac6fd81e6bb1f0928752e4ecc8b57e1f16c8909f0189a60403bb7e49`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 31 Aug 2021 08:29:03 GMT
ENV GRADLE_VERSION=7.2
# Tue, 31 Aug 2021 08:29:14 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Tue, 31 Aug 2021 08:30:09 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:a82b62a786f6076eec398b04e79c458bf3de9801d56fce3f23f707721a74de28`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97fc6e63c0ea16fb4fc88e2687107fdd0ce544de0d05977744564c37027f88e2`  
		Last Modified: Tue, 31 Aug 2021 09:12:56 GMT  
...
```console
$ docker pull gradle@sha256:034c36f3eaddfa944795abbdb18caf08e3891e316c3ad3ef3bd2f0b454e9450b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.8 MB (269763739 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4d17a21c4b34be55c727be51cd4a68c2c7a9f6ce9d3c22078455406127e0a69`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:bb886b3d857bda5b80879330412876dc4dfcaf100967ca78a56f5a7b5198aa0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b7723a1b5e1f028176eee9fcd393b92d37f10b9b5c07c963ced3b1aaf97b39`  
		Last Modified: Fri, 01 Oct 2021 03:09:12 GMT  
		Size: 114.4 MB (114373817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
