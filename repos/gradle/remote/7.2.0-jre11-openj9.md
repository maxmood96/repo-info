...
```console
$ docker pull gradle@sha256:f35c1c26069f3dec906a4a188f62fbd0c48f6bc5a335e1ab197dd090eca2f862
```
...
### `gradle:7.2.0-jre11-openj9` - linux; amd64

```console
$ docker pull gradle@sha256:cc0df5e8a0f1523717ea6fbecc55653797c9765f6c7828260b36392d7914a0dc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.1 MB (273064952 bytes)**  
...
-	Layers:
	...
	-	`sha256:a821ab76f58ac85124fc8e90d6d13f0b8b7518535a1d4aeed3a7e6f9a8a943c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ecdb4e5ff494b96f7aea7e17eab10b1e6818792c42cd990aa403248349879b9`  
		Last Modified: Tue, 31 Aug 2021 07:23:37 GMT  
		Size: 114.4 MB (114373824 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.2.0-jre11-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:5f2119702af341b625a12a66f94abd88ca9d332df3553980f50252284e846677
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.5 MB (267532343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:462ecdb73360572eba7850d9a9574acf0dd991527980bdb839acfa91d884d49a`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 18:43:18 GMT
ENV GRADLE_VERSION=7.2
# Wed, 18 Aug 2021 18:43:18 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Wed, 18 Aug 2021 18:43:23 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:99cb72bc556e25604936746292902d84bceb2e28455f532720edc7586a6e6507`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:192b0f52dd599ef2434ea464eaffa2a35ce69deb6b2c2a271075be13812e5a5b`  
		Last Modified: Wed, 18 Aug 2021 18:58:47 GMT  
		Size: 114.4 MB (114373891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.2.0-jre11-openj9` - linux; ppc64le

```console
$ docker pull gradle@sha256:aff2895ebb07920fe03d343853711e83d6a74c9e598fab6356bb97ed953d985f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.3 MB (287286499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:328a0e88416feffee6092102826e9229eace15c2fd2eef3fe5e77fe836bc54ae`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Thu, 19 Aug 2021 07:24:07 GMT
ENV GRADLE_VERSION=7.2
# Thu, 19 Aug 2021 07:24:09 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Thu, 19 Aug 2021 07:24:27 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:6cd944adc7b316c7a6c4f5045f5bcac223b4e71661d49fde4928c2e670e3db7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edd62f555d40590bb46382bf15fe870bedc345179946886bea1a83e7c4d9cd15`  
		Last Modified: Thu, 19 Aug 2021 07:58:53 GMT  
		Size: 114.4 MB (114373823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.2.0-jre11-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:0a745c371808a7843ca9836cb978d523a83d7fd9686c6c218a5d6e96a1885743
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.8 MB (269786481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddc2a801acddddacc0aec73bfb916d0f15674c05c774ef96935af9dd89edcbc1`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 31 Aug 2021 03:52:51 GMT
ENV GRADLE_VERSION=7.2
# Tue, 31 Aug 2021 03:52:51 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Tue, 31 Aug 2021 03:53:00 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:9a1cfd80c16b6fc4a9407a9a444d013355a1e0eab1995cb23b2a04d672b3647c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59ed424e5d2b04662f892a51262cd3bc7f124144ce03d5f2b9da732d9bdeafd5`  
		Last Modified: Tue, 31 Aug 2021 04:09:29 GMT  
		Size: 114.4 MB (114373829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
