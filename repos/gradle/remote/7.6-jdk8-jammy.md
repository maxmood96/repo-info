...
```console
$ docker pull gradle@sha256:a5d39e8a356209cf0cc3e7c56c76b82bdf79be88126435b2fa10fface2dd9ef4
```
...
```console
$ docker pull gradle@sha256:bd38ee168e40eb13b91afda7716d2700c2e0ffb95bcd0260fbddd5de517529b6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **271.0 MB (271035901 bytes)**  
...
-	Layers:
	...
	-	`sha256:724ffdb1cfa52d3a01c460bd1d49dede40109c2e89f6dd9fa40e938aed3b7fb2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edffd85d7095c66d81a553613f171b83412e553e54bbe62c7f0a71748ac33b99`  
		Last Modified: Thu, 16 Mar 2023 06:26:56 GMT  
		Size: 122.1 MB (122077280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.6-jdk8-jammy` - linux; arm variant v7

```console
$ docker pull gradle@sha256:3df60ec87c64b2170d18e0cd42d388c3bab18e63249bdd5ec52dc14bcc1f94d5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.0 MB (264957212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a4f004fef121940947071d3e5551e2fe75109f89c4183489b52d56d72c5c6a3`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:29:01 GMT
ENV GRADLE_VERSION=7.6.1
# Thu, 16 Mar 2023 05:29:01 GMT
ARG GRADLE_DOWNLOAD_SHA256=6147605a23b4eff6c334927a86ff3508cb5d6722cd624c97ded4c2e8640f1f87
# Thu, 16 Mar 2023 05:29:06 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=6147605a23b4eff6c334927a86ff3508cb5d6722cd624c97ded4c2e8640f1f87
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:ac09796f942409b81e8cba41885810659b407b87f3f775036e63ac1dfb6bae09`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cff766f89269d873b0393a41e027d2145da36f2707e330a0a943961514aba839`  
		Last Modified: Thu, 16 Mar 2023 05:42:15 GMT  
...
```console
$ docker pull gradle@sha256:e64de6f3727ad6e888a3b4165a63a34b2bc38566e2a3985d8b2d63ba231e3903
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.6 MB (267604797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8079ea28bb06b13bb46e32955659c1527c54f53f36123e0b5aa89cb1d2b73710`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:23:06 GMT
ENV GRADLE_VERSION=7.6.1
# Thu, 16 Mar 2023 05:23:06 GMT
ARG GRADLE_DOWNLOAD_SHA256=6147605a23b4eff6c334927a86ff3508cb5d6722cd624c97ded4c2e8640f1f87
# Thu, 16 Mar 2023 05:23:09 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=6147605a23b4eff6c334927a86ff3508cb5d6722cd624c97ded4c2e8640f1f87
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:3bafd97b700bad98d32b8a65233bf3009cc1252d350505dca5304adc6a43931e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:718733ac3f0159ebccb7063b4e2709b0bd2d046ff1c72b3e07d2c03e574faad4`  
		Last Modified: Thu, 16 Mar 2023 05:31:15 GMT  
		Size: 122.1 MB (122077272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
