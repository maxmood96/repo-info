...
```console
$ docker pull gradle@sha256:a471e39499aee40bfbe5949a36e4b33218975fcfe9e45876823aa2a2dcb104fd
```
...
```console
$ docker pull gradle@sha256:8aa4e44538f9f3905c4b6e27f09b61f22055aad5ac88d85491fae35c0b673470
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.7 MB (325730760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdfd839d4e0ff78a38d5d43e97a429aea2a170a8428dd51789af6be3eb3b8d65`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 01 Oct 2021 04:28:21 GMT
ENV GRADLE_VERSION=7.2
# Fri, 01 Oct 2021 04:28:21 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Fri, 01 Oct 2021 04:28:26 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:adeb6005fec38d705896efb760bc23a8ded68e7864b462cad4dc06648ec26036`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6163315ee2fcaea1a4845bc8022039989b2275688bbecd9abda497c9cf8cadaa`  
		Last Modified: Fri, 01 Oct 2021 04:39:24 GMT  
...
```console
$ docker pull gradle@sha256:c53e38a9a050067ce2a6403b21d16b4ca7a31e01f590276e25ae8915963ca057
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.7 MB (320716883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a30e631b807168524306f012c83d5b277e21e47156c58f1b11992835c5c275a3`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 01 Oct 2021 02:49:35 GMT
ENV GRADLE_VERSION=7.2
# Fri, 01 Oct 2021 02:49:35 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Fri, 01 Oct 2021 02:49:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:aca746c7dbbcdc277cd4c5205705d3e9a44da11e1416a2ac67af7c0396630fe2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26f87b97f720c55244c7dbf4484fecd4142005a30e46a62e05002cf42de0b441`  
		Last Modified: Fri, 01 Oct 2021 03:04:01 GMT  
