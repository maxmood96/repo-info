...
### `gradle:9.3.1-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:9.3.1-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:9.3.1-jdk-lts-and-current-alpine` - linux; arm64 variant v8
