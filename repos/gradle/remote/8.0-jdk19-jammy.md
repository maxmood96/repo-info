...
```console
$ docker pull gradle@sha256:d040ce8b19598f35c877802b5063bf53330d24d0361ffe1035218baad42d48dd
```
...
### `gradle:8.0-jdk19-jammy` - linux; amd64
...
### `gradle:8.0-jdk19-jammy` - linux; arm variant v7
...
### `gradle:8.0-jdk19-jammy` - linux; arm64 variant v8
...
### `gradle:8.0-jdk19-jammy` - linux; ppc64le
...
### `gradle:8.0-jdk19-jammy` - linux; s390x
