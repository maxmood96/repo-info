...
### `gradle:7.6.4-jdk-21-and-23-alpine` - linux; amd64
...
### `gradle:7.6.4-jdk-21-and-23-alpine` - unknown; unknown
...
### `gradle:7.6.4-jdk-21-and-23-alpine` - linux; arm64 variant v8
