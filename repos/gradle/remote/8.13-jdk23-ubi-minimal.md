...
### `gradle:8.13-jdk23-ubi-minimal` - linux; amd64
...
### `gradle:8.13-jdk23-ubi-minimal` - unknown; unknown
...
### `gradle:8.13-jdk23-ubi-minimal` - linux; arm64 variant v8
...
### `gradle:8.13-jdk23-ubi-minimal` - linux; ppc64le
...
### `gradle:8.13-jdk23-ubi-minimal` - linux; s390x
