...
```console
$ docker pull gradle@sha256:2393dec859bbec3d0bbd7e87d745fe70794bf3b3704e9e40ef4f45dc8e4e05fe
```
...
### `gradle:8.12.0-jdk-lts-and-current-graal` - linux; amd64
...
### `gradle:8.12.0-jdk-lts-and-current-graal` - unknown; unknown
