...
```console
$ docker pull gradle@sha256:f98d1be1a77a514a4224b809790b4579d9b8ba37fdd9e0be9417c31e880ab5bf
```
...
```console
$ docker pull gradle@sha256:c1dfc055cf9476db706979aa8a03e2bca17735407ab05f4cc73da9fe5caad957
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.9 MB (269864728 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d963651e85b7732e1970084ef3d6404f4743aafadcdebdd201ce659caca32c23`
...
-	Layers:
	...
	-	`sha256:b116ea1671b949c05cdd61165817cf0812f9cd1b95f9961596b85ff7aa02bc65`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:167acbc01bdaf356ff2308ff6b56fa1712be33ae769520e36b9c2f2d7c00ee38`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e95532ddf18ca05d77a518699584b3e1f8be482066f8ca76e3b19fdbc2d8a89b`  
		Last Modified: Thu, 05 Feb 2026 01:12:56 GMT  
		Size: 50.7 MB (50743198 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cc1b793c7e85f01e61f131163c6919ee827b2f17394bea03702e4ca0fa7109ee`  
		Last Modified: Thu, 05 Feb 2026 01:12:56 GMT  
		Size: 107.7 MB (107696668 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b5524aa6bcb248752fc60b92295786b7d6ee6600183b41097f2b85141d65fe71`  
		Last Modified: Thu, 05 Feb 2026 01:12:52 GMT  
...
```console
$ docker pull gradle@sha256:c56fc1510afda96130c44d3c23cdb0e70ed24e7f0007b5ced744ae1e70aba38c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5441285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f199a4a817d9f3657c556005d7e4b995808de8dbad1697234d308b89289a603`

```dockerfile
```

-	Layers:
	-	`sha256:9693a4106893ac162d706d34f25ae9a5e6d6c49c1d3a83dbb3ea71b7df66592a`  
		Last Modified: Thu, 05 Feb 2026 01:12:52 GMT  
		Size: 5.4 MB (5417766 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:cc7fb5d8555bf8a80071ff60028e1f6e9a44f741bf7c3ade640c5d4e983c8f3e`  
		Last Modified: Thu, 05 Feb 2026 01:12:52 GMT  
...
```console
$ docker pull gradle@sha256:5b1115baefbbc0270363c5a9ca2a32c8c8efcaf11eb0227742f4e658729a0008
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.9 MB (266911111 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d6cb28f517b3983e1ddaf92c6d799ccd3e70cab80a5e6a890cf5f9dbd2e13d2`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Thu, 05 Feb 2026 01:12:48 GMT
WORKDIR /home/gradle
# Thu, 05 Feb 2026 01:12:53 GMT
RUN set -o errexit -o nounset     && microdnf install -y         make                 findutils                 unzip         which                 git         git-lfs         subversion     && microdnf clean all         && echo "Testing common utilities"     && which awk     && which curl     && which cut     && which grep     && which gunzip     && which sha256sum     && which sed     && which tar     && which tr     && which unzip     && which wget         && echo "Testing VCSes"     && which git     && which git-lfs     && which svn # buildkit
# Thu, 05 Feb 2026 01:12:53 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 05 Feb 2026 01:12:53 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 05 Feb 2026 01:12:56 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Thu, 05 Feb 2026 01:12:56 GMT
USER gradle
...
-	Layers:
	...
	-	`sha256:d5b6118e74098b30e329df142e45cf1671d58dfdbbec53782a0b0c0cde424380`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c310e64f041705f512b7f81be504861d98a214ddc0f58dd2bf0be6387595c8ba`  
		Last Modified: Thu, 05 Feb 2026 01:13:12 GMT  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:323c3c10815d2c5d346403cb3eaa0e96109b177a13ab310e466f4ef0a95127a6`  
		Last Modified: Thu, 05 Feb 2026 01:13:17 GMT  
		Size: 50.0 MB (49989764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6a989294761811693379948de6a1db2be087db1163babe0eddf70984ae807b58`  
		Last Modified: Thu, 05 Feb 2026 01:13:17 GMT  
		Size: 107.7 MB (107696665 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1cf579d3121ff4337b8c5b214ef3ca5e9557043bd5b19f420975a8d7b3341332`  
		Last Modified: Thu, 05 Feb 2026 01:13:13 GMT  
...
```console
$ docker pull gradle@sha256:14fa3e130960f401e972c22f08e1cbffe834de3129ec0de251c7d2c1107571b4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5441562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4f4ce737858fed8b855963a63bcd5aeee850d25372861c14b3144e9972748ab`

```dockerfile
```

-	Layers:
	-	`sha256:223785ec250f735592e351e7334a38b23d6c06d800ffbbe4c417d8312f7f2a29`  
		Last Modified: Thu, 05 Feb 2026 01:13:13 GMT  
		Size: 5.4 MB (5417870 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d261a14d90df78fe2472478a7e8ef0c9a4cb4ebd60afc7c9f4f5e1395e4d3194`  
		Last Modified: Thu, 05 Feb 2026 01:13:13 GMT  
...
```console
$ docker pull gradle@sha256:e5ce5a156cf0c34ca6d92d7a6b7cdb0c0ed97a4d0a0cf89f1ee1365440ba8e25
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.2 MB (275152710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b09c9456ea7892fe493036bccc58a33408beb1791f61a927dd4e3a2e20c61472`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Thu, 05 Feb 2026 02:24:29 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 05 Feb 2026 02:27:23 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Thu, 05 Feb 2026 02:27:23 GMT
USER gradle
# Thu, 05 Feb 2026 02:27:25 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version # buildkit
# Thu, 05 Feb 2026 02:27:25 GMT
USER root
...
-	Layers:
	...
	-	`sha256:dd0ba1a6eae47877c39cb9066738eb79c4efc1c419130808a273755900347155`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5a72fe2f7a4c71545346eb7b6fc062fecae183bd43884f2a2068bc9f657e50dc`  
		Last Modified: Thu, 05 Feb 2026 02:27:57 GMT  
		Size: 107.7 MB (107696637 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a6023c8f933f617d3d0550153c6f6024d2b3e692f92dc969f5a487a7a9ff37e`  
		Last Modified: Thu, 05 Feb 2026 02:27:54 GMT  
...
```console
$ docker pull gradle@sha256:97f5016b2d04265fee52678037b21ab6c1fb2474694d7e27af2abf2ae0c0f912
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5439298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9bea4136f0511055ba9a296611e9c5eb29ae16935aae29655785a2d666c18de`

```dockerfile
```

-	Layers:
	-	`sha256:ea8406c714080292008c7e69b819bc7a1c0b46a788bd2e56b019521183f135f1`  
		Last Modified: Thu, 05 Feb 2026 02:27:54 GMT  
		Size: 5.4 MB (5415682 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ca5e832512fa58e59c0bc5e0e4eabc91e2114b2a4fbd20b4a9a8d95b248b913e`  
		Last Modified: Thu, 05 Feb 2026 02:27:54 GMT  
