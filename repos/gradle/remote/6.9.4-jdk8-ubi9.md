...
```console
$ docker pull gradle@sha256:3f6413910d9b4f80c7814460a740ab8032a26097d0e9858da7028dc2ed21d5c3
```
...
```console
$ docker pull gradle@sha256:74ededfb7c6138562880f72fb40735047aa659ddbd7706021ecfbb01e0090651
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.6 MB (275610342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df1ba8820ed7fb9e335f660fcd5e5e5ae5a2ca25fb08e148877cbda5fc717127`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Tue, 12 May 2026 01:19:09 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Tue, 12 May 2026 01:20:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Tue, 12 May 2026 01:20:02 GMT
USER gradle
# Tue, 12 May 2026 01:20:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version # buildkit
# Tue, 12 May 2026 01:20:04 GMT
USER root
...
-	Layers:
	...
	-	`sha256:77d050dcf9096fa55659a0ceb0663c93250b7be0c82217c6d2a12703bef0875d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ab53f0592e680125afb42eb9fead114fc481046ad124248c81207e8302ec5cbf`  
		Last Modified: Tue, 12 May 2026 01:20:34 GMT  
		Size: 107.7 MB (107696667 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9386893d435d24de9b514fc21d644feacb6ea2ffd9116cb87fd7c32364752a4b`  
		Last Modified: Tue, 12 May 2026 01:20:31 GMT  
...
```console
$ docker pull gradle@sha256:7e9c38090038d00f72b73d9906ccc6df2191f24ba6097da9b906e9c847ab19cc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5439195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfefc87c8a67979754af9bc5cc8421f8920d9e9e42b3704e2ea2d32c33a1b880`

```dockerfile
```

-	Layers:
	-	`sha256:7e22df6f07b63d5bc53ae90866811fea4c1f763326c96061d937fa0ec4429bc5`  
		Last Modified: Tue, 12 May 2026 01:20:31 GMT  
		Size: 5.4 MB (5415579 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1bd8f2aae0ea0b6975adda0d799c0f8f2fe4a2dbe150459f480a66ae48c736a3`  
		Last Modified: Tue, 12 May 2026 01:20:31 GMT  
