## `gradle:8.14.2-jdk-alpine`

```console
$ docker pull gradle@sha256:66ea6ad35a70f4e22c62591e8dde896d94eb6fe325d4b0926e3a91ebe51f5fd5
```
...
### `gradle:8.14.2-jdk-alpine` - linux; amd64
...
### `gradle:8.14.2-jdk-alpine` - unknown; unknown
