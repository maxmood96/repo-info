...
```console
$ docker pull gradle@sha256:f8db760401d1a02c6fb565209942c637a53833755d1e418b303ad9e9d570e212
```
...
```console
$ docker pull gradle@sha256:c69de07e5b0a955c9559de91dccec1d5f948774fff31f3b4c009ed1cd931aa05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.0 MB (348997300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be0104fd360cf9572500c206b0af16fdb9111137f35bb203ba8526a5ca21034d`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Sat, 02 Dec 2023 07:47:37 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Sat, 02 Dec 2023 07:47:42 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 07:47:42 GMT
USER gradle
# Sat, 02 Dec 2023 07:47:43 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Sat, 02 Dec 2023 07:47:43 GMT
USER root
...
-	Layers:
	...
	-	`sha256:4732723b67bd4175948ef9fa32c607fb3a3e3bd0133033a598496188ed6070f0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c2a9c8cc68d412f3b5fec4799145c65338aa337138a1bc082363ab39caf4794`  
		Last Modified: Sat, 02 Dec 2023 07:56:24 GMT  
		Size: 107.7 MB (107696575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2e07270b0ceb56383a4ca0000043692c9a37755f0f49a4e1c197c99beec467f`  
		Last Modified: Sat, 02 Dec 2023 07:56:18 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:6f0d58dfd52000f8fc1fbe39c28491a89f25fe8bc3468e97039c953448dbbc50
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.1 MB (339078273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73263ccad8a762b62a94318811392f47d79b2aa40db860d6be4568fbcaf440d5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Sat, 02 Dec 2023 07:19:29 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 07:19:35 GMT
USER gradle
# Sat, 02 Dec 2023 07:19:36 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Sat, 02 Dec 2023 07:19:36 GMT
USER root
...
-	Layers:
	...
	-	`sha256:c2ac9a8099b80f03ab41f2a6abb56be962a29d8fa25f2132e365c2ed652b3cfb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd49fb4414fc2d2865a8607956b75bd840740ccc267f5ba9e4284f4f88842381`  
		Last Modified: Sat, 02 Dec 2023 07:24:54 GMT  
		Size: 107.7 MB (107696577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22f48368ebd8aa8063c2f9c578565d228f9e5768d16fa860012fe55bdad9e2e7`  
		Last Modified: Sat, 02 Dec 2023 07:24:49 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
