...
```console
$ docker pull gradle@sha256:c8e7d9d3d926e1448ff69ccb958fb033cf9923a9d656bb97c9ca7df78ada2abf
```
...
```console
$ docker pull gradle@sha256:90bf3a96bb34b50724a67ecada19ca13839a2d89ebe8c950524d95d1169ef6c8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.9 MB (351930831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864ff4ba7d8a8d6d6c41d654ef7e15124e12938571da18ed6f61427eb52b34fb`
...
# Fri, 13 Oct 2023 06:08:48 GMT
ENV GRADLE_VERSION=6.9.4
# Fri, 13 Oct 2023 06:08:49 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Fri, 13 Oct 2023 06:08:52 GMT
...
-	Layers:
	...
	-	`sha256:691c4b5667f2352bd59b5dca69475a804ce2f1c57198330ca7c365ae2aa297af`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f522ac1ae1bd0769964d09b1455b10fb188877899013fb853b9280639b949a7`  
		Last Modified: Fri, 13 Oct 2023 06:20:00 GMT  
		Size: 107.7 MB (107696570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15e46eb945f0b87f2478e47b30d30f4a9e6581da11a76994776a00e4b54cbf9e`  
		Last Modified: Fri, 13 Oct 2023 06:19:54 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:5e63dc0df38850a57a8df476399411eb9cd90f880573cab5818b31e98ee14bb3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.8 MB (348755216 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c54dba87e857d10a6bc8b4cc46e8279d4549efdd5de16321290050b07b36a0a1`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 13 Oct 2023 04:09:18 GMT
ENV GRADLE_VERSION=6.9.4
# Fri, 13 Oct 2023 04:09:19 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Fri, 13 Oct 2023 04:09:23 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 13 Oct 2023 04:09:23 GMT
USER gradle
# Fri, 13 Oct 2023 04:09:24 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 13 Oct 2023 04:09:25 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:9d59d6f34cc0ca2d158f023020b40f5264dfc8dde1e303caaf6ec17128e8757a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb69f39f9f33b4203969c7946d1af946f6af6d298de99f059634a99aea518dd4`  
		Last Modified: Fri, 13 Oct 2023 04:19:13 GMT  
		Size: 107.7 MB (107696570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:268ad10eb74ac9f0ae435b79b523ade98c4b3451681d6161d234d2eb88bc8f5e`  
		Last Modified: Fri, 13 Oct 2023 04:19:05 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:f871417f24d99e922a48fd492ba741cc3f5ae63f455b726a247b21fb6ef00e12
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349628508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8296396e703de100367cd5820601258c4a493fea877c3b515b817a5ae83dc673`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 13 Oct 2023 03:41:42 GMT
ENV GRADLE_VERSION=6.9.4
# Fri, 13 Oct 2023 03:41:42 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Fri, 13 Oct 2023 03:41:45 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 13 Oct 2023 03:41:46 GMT
USER gradle
# Fri, 13 Oct 2023 03:41:47 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 13 Oct 2023 03:41:47 GMT
USER root
...
-	Layers:
	...
	-	`sha256:d7b1defe4d802a1b5939c3f1294fdca91b9e5d0f1f1d4f56dedd0b3a53ab9120`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48edad47283b9de250ef2906fa5359839fb1d7db17c60a85d216fa81bbb410da`  
		Last Modified: Fri, 13 Oct 2023 03:50:43 GMT  
		Size: 107.7 MB (107696584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce7f21d2b20475e0d54be1f21b6e8526f38ab372e4cc87f7087b7c066b0a8bb2`  
		Last Modified: Fri, 13 Oct 2023 03:50:38 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:cd5a3a20879e5a71188e33511973f8933dd5aa8a8953314dca358432cea559c8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.3 MB (362294453 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e90798ca53b9cc5d62184c4d30b91067f508768df454a3bba10e3be747702bd2`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 13 Oct 2023 10:50:47 GMT
ENV GRADLE_VERSION=6.9.4
# Fri, 13 Oct 2023 10:50:49 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Fri, 13 Oct 2023 10:50:57 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 13 Oct 2023 10:50:59 GMT
USER gradle
# Fri, 13 Oct 2023 10:51:01 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 13 Oct 2023 10:51:02 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:7880632dc8a206539280f3bbe48abaddd0620ed5957c39aec10386646710ae0f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81078d521bce65992d85c6910dba5b90e9e9643de82f8a9cbb57886fe12d20d7`  
		Last Modified: Fri, 13 Oct 2023 11:01:08 GMT  
		Size: 107.7 MB (107696534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03e6b8011302c8847e8dba8a94b0425eeeff1f30929a9456a4a0e1f4bf914682`  
		Last Modified: Fri, 13 Oct 2023 11:01:00 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:4cf34d775bb017acaf82d5d5ee002c3f3a04d03a3527dcc60fbfcb0e38aba4a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.1 MB (339107654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:388015d4785bc09f40007c7c4fecd466f7ad19b2f8e7a2ee715f844ef73efe34`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 13 Oct 2023 12:03:24 GMT
USER gradle
# Fri, 13 Oct 2023 12:03:25 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 13 Oct 2023 12:03:25 GMT
USER root
...
-	Layers:
	...
	-	`sha256:565cd0ef76bc9e957853bedb3d4bf7b4aeb0d72cd86fa6318b503b5ba821c3ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdb6023f9fa53f73a0fa7c832a9fb30b585b98eb26c6e277f100a69b14411d6c`  
		Last Modified: Fri, 13 Oct 2023 12:09:07 GMT  
		Size: 107.7 MB (107696568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bba1a62acf75c158b2f8807753e57cf59ada91e311a46575b55b7d861faeb696`  
		Last Modified: Fri, 13 Oct 2023 12:08:54 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
