...
```console
$ docker pull gradle@sha256:cc967641a7948ed943f527951f659ea57229b4fb2b5a35a9489a167e39f5e157
```
...
```console
$ docker pull gradle@sha256:8e729b97dbcdbec377a5bf16e25e8ed7acf7f9d4aaf6ff54824ed93c8ee7bf91
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.3 MB (348278947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c94bbe3d05aba76fd2aa77b413f0a11a32b47e6c025d7a5f6ecce348a81686b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 31 Aug 2023 20:38:57 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 31 Aug 2023 20:38:57 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 31 Aug 2023 20:39:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 31 Aug 2023 20:39:02 GMT
USER gradle
# Thu, 31 Aug 2023 20:39:03 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 31 Aug 2023 20:39:03 GMT
USER root
...
-	Layers:
	...
	-	`sha256:f9e686092250a111125d1ecdd7c258629ac8ffc5b8957a214aa95a7a5e3cc3e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06e56adfb7b3fe91922e8c82e4f6b83bbce053ecc3be48d5af2c6e0994463647`  
		Last Modified: Thu, 31 Aug 2023 20:45:44 GMT  
		Size: 107.7 MB (107696571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a541551b8bb219b5dfb52e6192ae166b715f452108e10e7ab9332b14fc10297`  
		Last Modified: Thu, 31 Aug 2023 20:45:36 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:37c77e352ab53b4e0f52f23c9420f9f16f3f6cdeb5683efecf243c47fafacfab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349635659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:416e06085c1003577145c9218cd0805813d1f78719043cec6187fe5fef8c9e37`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:3afcdce9dbf140058a530d4f5e565116b60ba029b682128f6f0bff92aa549ca9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9d40b367314a0d1741a6958287e86e7cb01bd5f60dcd7d04615c25e8cf15129`  
		Last Modified: Thu, 31 Aug 2023 21:23:11 GMT  
		Size: 107.7 MB (107696579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7017d38efef29f76ce25de91caf7b79f5c3d1d0cfc1f8b359f72f07b37bc40fd`  
		Last Modified: Thu, 31 Aug 2023 21:23:06 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
