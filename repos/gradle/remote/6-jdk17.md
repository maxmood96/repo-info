...
```console
$ docker pull gradle@sha256:2ad5da6adfafd59bd7f31c2412ed0794036a5b3f84956a024461f81f2b4b96e5
```
...
```console
$ docker pull gradle@sha256:5fb2dbb93257974377ee76922e4060d33f462be50c9e1ef73924328702738afe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.9 MB (351935584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d60b4bcc97d80b6582e7290608cfadc96d2a8e716b1fb6e40ffb678ddf9cac96`
...
-	Layers:
	...
	-	`sha256:820089eab7e5c1feb10fcb5b4013d25fc745225b9057bfde2adb18b4161ebbf1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2cd323c241a61891186e66bc276926ad957414cc9a34e480e42dccc97106b47`  
		Last Modified: Thu, 17 Aug 2023 10:06:39 GMT  
		Size: 107.7 MB (107696558 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b717f5d1128ef3d445ab2807f6cb118c6cb0496b81595a5e22dd9af2d4335641`  
		Last Modified: Thu, 17 Aug 2023 10:06:33 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:6b5b10872770269713ee6b503b5c9f082e4a3b5b419d3b4d9c5291350201c3b5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.3 MB (348277344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ecdbd4b96d58c72828fd1b6ec39a7888f6788ed5def0cca3c5d2e7dca0d1244`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 17 Aug 2023 03:32:33 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 17 Aug 2023 03:32:33 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 17 Aug 2023 03:32:37 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 17 Aug 2023 03:32:38 GMT
USER gradle
# Thu, 17 Aug 2023 03:32:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 17 Aug 2023 03:32:39 GMT
USER root
...
-	Layers:
	...
	-	`sha256:d54e38899cbe7bed1327c8f7e1996fee83d02ca4a64b7d63e792d039fc590626`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035a74ae0219d7545051e00c1c2fa15d885d230f87e7679217b8619b5111b94b`  
		Last Modified: Thu, 17 Aug 2023 03:41:30 GMT  
		Size: 107.7 MB (107696586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dec9b5915004f6c73a43f09376ef144e97db60572b7dc691c5b25f8134ad0de`  
		Last Modified: Thu, 17 Aug 2023 03:41:24 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:67013855839e704fc1972d371b1f78c9088d6961fff6ddc1decf53bf036f3244
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349632733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d47d85fcdff11e2fea46aa840ea65b8d2785da2529314e406f5d31ca77280a5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 17 Aug 2023 01:16:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 17 Aug 2023 01:16:02 GMT
USER gradle
# Thu, 17 Aug 2023 01:16:03 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 17 Aug 2023 01:16:03 GMT
USER root
...
-	Layers:
	...
	-	`sha256:0c484970394358c05ab63b50addda4d962150411fb692e285effeb3bbae0f5da`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a383bd7f244d0e15cb681b57df91a25f8e631479a17b7e81b3899ee83f45b4c9`  
		Last Modified: Thu, 17 Aug 2023 01:24:23 GMT  
		Size: 107.7 MB (107696583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e58416aa87cc9d3b492182e731f6a1a3db8d113af0a6801e1f39bc0029eecfe`  
		Last Modified: Thu, 17 Aug 2023 01:24:18 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:2200d927f906e57236f43e675998c584032c4b538cfe5eb29fa5750d9e7e2814
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.3 MB (362346017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e07196f1999123d850af166cb98711c15fa23e73caa727041ef8b37ca6195ee6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 17 Aug 2023 10:58:10 GMT
USER gradle
# Thu, 17 Aug 2023 10:58:12 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 17 Aug 2023 10:58:12 GMT
USER root
...
-	Layers:
	...
	-	`sha256:245b673b0f996f71be3c0d83a541fb8eb3ca98f341f704d96a3e003315aed7d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:289473c0911bd8a61bd2b95ab6ddc6d2410ef098964f543febc837439bc04b54`  
		Last Modified: Thu, 17 Aug 2023 11:14:47 GMT  
		Size: 107.7 MB (107696582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0326cbe53c5a52c29ef3fd2e960f2c9e279a1a5face1ae9fdddf1fd56c201cd7`  
		Last Modified: Thu, 17 Aug 2023 11:14:38 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:297b0deb9e5aed020155e8902f7aac0888d16fafae1bfc82b88b6e01b89501f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.1 MB (339110496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c48dc1652de4e5c4d408e731025c1939eb1fd0af1ca29f5cf71349fff9a79db`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 31 Aug 2023 20:10:32 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 31 Aug 2023 20:10:32 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 31 Aug 2023 20:10:38 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 31 Aug 2023 20:10:40 GMT
USER gradle
# Thu, 31 Aug 2023 20:10:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 31 Aug 2023 20:10:41 GMT
USER root
...
-	Layers:
	...
	-	`sha256:06c8d1bb65a3994bbe3501f2e2da6a921ec9373e019b01672d2cd3784054522c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0534c7bced197364aee1c0cdd4e789af3113b9b885c27f3954dc506ef9f1979`  
		Last Modified: Thu, 31 Aug 2023 20:15:34 GMT  
		Size: 107.7 MB (107696587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd74bf3902ee7ddbfe571f0cbe6b41eb8c2432b6bd37652e22783eb3dab779ae`  
		Last Modified: Thu, 31 Aug 2023 20:15:27 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
