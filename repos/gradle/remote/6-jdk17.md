...
```console
$ docker pull gradle@sha256:ee8cc0fb5efdd577ff4844e129c765199677920f5fbfeea84c0a25c11ef23806
```
...
```console
$ docker pull gradle@sha256:460a9a07f8d7d6607a12b8331bc86b515562269b13eb06cb173dd499e1789af9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **352.1 MB (352062889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebc6976207a0a2ae96b52c8d2681d9a7bcf6a05cc748b4bb7dbac0df198439ed`
...
-	Layers:
	...
	-	`sha256:e38d172182efb8d6099b9376afc363370ff89159d62a8e7e63984a9c43edc521`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2166b52eaef36c5db0e08064b5bbb65e4707655f654b745cb3d748544bca0459`  
		Last Modified: Wed, 06 Mar 2024 09:59:23 GMT  
		Size: 107.7 MB (107696562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:724ab29deccf071fe85c592e0634c58289fc5fdfd35f99db366e156971b715d0`  
		Last Modified: Wed, 06 Mar 2024 09:59:18 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:529ebfe8c1e5681777a3b28bbd045ceb86910dae774e37cd1cbeeae641624fe8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.8 MB (349809339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4417232f4725acee6657a984146c4e97c0a018f00133cdcfcd74fb77bda75535`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 06 Mar 2024 13:47:59 GMT
ENV GRADLE_VERSION=6.9.4
# Wed, 06 Mar 2024 13:47:59 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Wed, 06 Mar 2024 13:48:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 13:48:03 GMT
USER gradle
# Wed, 06 Mar 2024 13:48:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 13:48:04 GMT
USER root
...
-	Layers:
	...
	-	`sha256:80c6f699bed74dee0803b97130e88be1cefca116acf88dbc41f2fa9a2011042a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2ec0d595a216fe4c569c39797c9bd6b85e86e895ff3577cdea217e26aebe2f0`  
		Last Modified: Wed, 06 Mar 2024 13:57:07 GMT  
		Size: 107.7 MB (107696565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e8a30e5e8846723bf1de6110802501ca9ab555981590072fdbbf93c1baa6c00`  
		Last Modified: Wed, 06 Mar 2024 13:57:02 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
