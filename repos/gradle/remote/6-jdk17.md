...
```console
$ docker pull gradle@sha256:cabb656cf02a3be215c369274dc088a2a05e25496d6fa5107d53b5f77d0abb10
```
...
```console
$ docker pull gradle@sha256:b095ed0aee829c3c3e266b1c1c3a14bd0b7547065b773e13d2d56d3f593d9726
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.0 MB (349980049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c1acafc55a3fc727503e64576dd4dc4392b15dea8aec0635741b7cdceb97a11`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 02 May 2024 06:06:10 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 02 May 2024 06:06:10 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 02 May 2024 06:06:13 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 02 May 2024 06:06:14 GMT
USER gradle
# Thu, 02 May 2024 06:06:14 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 02 May 2024 06:06:15 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:6c7adae58574dbf3e16a7f041fed1955c8d7f813af6bdfa1509ac6ad5508795e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52c4e372a8274a25f612fb51ba9c01e43a0d848e89f0a805909f679f61da730`  
		Last Modified: Thu, 02 May 2024 06:15:06 GMT  
		Size: 107.7 MB (107696565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed9b549e68ab8332420239a1cd32f6553a7b4c2bf17b896b7757ba05f53af629`  
		Last Modified: Thu, 02 May 2024 06:14:58 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:89ff368c41a5b87699ed1e43882ae7d1c863a576d8dadcaf396d6d7843b2f6ba
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.5 MB (362484873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:813c8999cd1bf57ff4af3fe99840e397584bacb09cef97dc6de95055f8d4494a`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 02 May 2024 05:27:43 GMT
ENV GRADLE_VERSION=6.9.4
# Thu, 02 May 2024 05:27:43 GMT
ARG GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
# Thu, 02 May 2024 05:27:50 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 02 May 2024 05:27:52 GMT
USER gradle
# Thu, 02 May 2024 05:27:54 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=3e240228538de9f18772a574e99a0ba959e83d6ef351014381acd9631781389a
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 02 May 2024 05:27:55 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:ca811e73b679e8400699b2f278b58bf52ab70bd4e9c6415d950a644009f429e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48d04ad5235d181e32ebf31aa48b5d4e8f3f32205dad750d0380d042111ab985`  
		Last Modified: Thu, 02 May 2024 05:37:03 GMT  
		Size: 107.7 MB (107696575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04f85c2ed16fb4d16748b277bcf073ae2f1a6ff94649b31eb564be262e960b40`  
		Last Modified: Thu, 02 May 2024 05:37:00 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
