...
```console
$ docker pull gradle@sha256:6e45c647ceadfb197292380685efbf7519b2f42ae6a8236437edececdc42d01c
```
...
### `gradle:7.0-jdk11-openj9` - linux; amd64

```console
$ docker pull gradle@sha256:e4e8b84952236f3ed7c356fd9910308c57300a07556795d66987d0a8d75fd64f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **424.2 MB (424216645 bytes)**  
...
-	Layers:
	...
	-	`sha256:784a2832d2a836eb7d79fcdfa3038e0254a24f05b1020efa1de102b91c21e1da`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40f717f30559a733fc795fb226c435ad6b36b27103a6f3e5a5e66e2e1b8b6a26`  
		Last Modified: Tue, 27 Apr 2021 22:39:37 GMT  
		Size: 4.4 KB (4363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e2f7493d8e3f46b905760c999991730035e727416a2f8d8df2d19772be2dfa`  
		Last Modified: Tue, 27 Apr 2021 22:39:49 GMT  
		Size: 65.6 MB (65610678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8f6cc1facff59efa3d34acdb97a1f860790369c7e1cff5daa172291cd3c2c24`  
		Last Modified: Tue, 27 Apr 2021 22:39:43 GMT  
		Size: 112.6 MB (112575727 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.0-jdk11-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:dedbe8e00b3779d12cf6c7b8458af45394ac9a122edf651518cf315fbc3d5e03
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **419.0 MB (418992053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed5abf0d27f4427399f3b92184d9e9eb1f9b25944cace84653d20b55ee33ed5c`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 12 Apr 2021 17:48:28 GMT
ENV GRADLE_VERSION=7.0
# Mon, 12 Apr 2021 17:48:29 GMT
ARG GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
# Mon, 12 Apr 2021 17:48:42 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:8c33a04d804de32be74a63552a65ae0cc2b081d1d826aa313f7757c524505ffa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d94711f87a332f0eb5ef8422f99689f8eb87811a5083868d47fdbb898aa04c0`  
		Last Modified: Mon, 12 Apr 2021 17:59:47 GMT  
		Size: 112.6 MB (112575750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.0-jdk11-openj9` - linux; ppc64le

```console
$ docker pull gradle@sha256:14d3032642355754ac8aedefd46a217817d58cd4170557cf24b69092e517d502
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **439.5 MB (439454798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2bc4a25970d5e8f24a35d6c0d89e46d42dc549ad4f1f49068cf965400912fd7a`
-	Default Command: `["gradle"]`
...
CMD ["jshell"]
# Tue, 27 Apr 2021 23:31:42 GMT
CMD ["gradle"]
# Tue, 27 Apr 2021 23:31:48 GMT
ENV GRADLE_HOME=/opt/gradle
# Tue, 27 Apr 2021 23:32:12 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln -s /home/gradle/.gradle /root/.gradle
# Tue, 27 Apr 2021 23:32:18 GMT
VOLUME [/home/gradle/.gradle]
# Tue, 27 Apr 2021 23:32:27 GMT
WORKDIR /home/gradle
# Tue, 27 Apr 2021 23:36:10 GMT
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 27 Apr 2021 23:36:22 GMT
ENV GRADLE_VERSION=7.0
# Tue, 27 Apr 2021 23:36:26 GMT
ARG GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
# Tue, 27 Apr 2021 23:37:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:0b4ba7dfbeb4268dd7bacfe16a6c81d5e396a18d6a5df9f4b575dcd6b94f36f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51caee00a15feca501aff6ca24e8a0c4738d00bd899debb32367b2a2af389dcb`  
		Last Modified: Wed, 28 Apr 2021 00:37:54 GMT  
		Size: 4.4 KB (4377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b467ecfe87a558b13211299faed7741ad5507172b68afd1952e0a4b41f4c568`  
		Last Modified: Wed, 28 Apr 2021 00:39:30 GMT  
		Size: 74.0 MB (73973619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe15e051de40d70f834a6b219bf55d53ff659438d99429d2d38c3b5748c7ca11`  
		Last Modified: Wed, 28 Apr 2021 00:38:29 GMT  
		Size: 112.6 MB (112575766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7.0-jdk11-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:c49691834f1556e0a3fd5343dcd906348faf328189bbcd168241c02afa4dabd6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **420.5 MB (420543487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8aca04253a782252b9599f50afce32a22716a82deb9f42844ecad1cc9b0b2304`
-	Default Command: `["gradle"]`
...
CMD ["jshell"]
# Tue, 27 Apr 2021 22:54:28 GMT
CMD ["gradle"]
# Tue, 27 Apr 2021 22:54:29 GMT
ENV GRADLE_HOME=/opt/gradle
# Tue, 27 Apr 2021 22:54:30 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln -s /home/gradle/.gradle /root/.gradle
# Tue, 27 Apr 2021 22:54:30 GMT
VOLUME [/home/gradle/.gradle]
# Tue, 27 Apr 2021 22:54:30 GMT
WORKDIR /home/gradle
# Tue, 27 Apr 2021 22:55:02 GMT
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 27 Apr 2021 22:55:09 GMT
ENV GRADLE_VERSION=7.0
# Tue, 27 Apr 2021 22:55:09 GMT
ARG GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
# Tue, 27 Apr 2021 22:55:17 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=eb8b89184261025b0430f5b2233701ff1377f96da1ef5e278af6ae8bac5cc305
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:82a9dcd5840f369a40d4e645c9407f7f69cfb05e41fa2cb2ba49a3d4df4ef740`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec105f399f98b4a8b7bb8adec6e56a98b526b7d6b31d695484130f2490d2310f`  
		Last Modified: Tue, 27 Apr 2021 23:08:12 GMT  
		Size: 4.4 KB (4365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f45a06364fa89c725ef0d8a16a77339c605a0a581295574602dc87961a15956`  
		Last Modified: Tue, 27 Apr 2021 23:08:22 GMT  
		Size: 64.8 MB (64816879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:258c0aff3aa1fd25db92e45aa23967c082c3e8f22cc9bc87c1702e621b504fd3`  
		Last Modified: Tue, 27 Apr 2021 23:08:18 GMT  
		Size: 112.6 MB (112575733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
