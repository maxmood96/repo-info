...
### `gradle:9.2.1-noble` - linux; amd64
...
### `gradle:9.2.1-noble` - unknown; unknown
...
### `gradle:9.2.1-noble` - linux; arm64 variant v8
...
### `gradle:9.2.1-noble` - linux; ppc64le
...
### `gradle:9.2.1-noble` - linux; riscv64
...
### `gradle:9.2.1-noble` - linux; s390x
