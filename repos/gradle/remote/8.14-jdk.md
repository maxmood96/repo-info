...
```console
$ docker pull gradle@sha256:a8741ddd2055e9948af8082598ef7b44e6077be246f03a79d42204ffdd6153b1
```
...
```console
$ docker pull gradle@sha256:b5cbc01e89fe8b55dd88dd6dde182ece6c5a3993bed4876ba73512c095fe78ba
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **418.4 MB (418366770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfb576016e58bd148d88f829dd4c7f1df502e06ffbb3b55b4cc097a2d2254550`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Tue, 02 Jun 2026 23:51:13 GMT
ARG GRADLE_DOWNLOAD_SHA256=6f74b601422d6d6fc4e1f9a1ab6522f642c2fdcbc15ae33ebd30ba3d7198e854
# Wed, 03 Jun 2026 00:18:05 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=6f74b601422d6d6fc4e1f9a1ab6522f642c2fdcbc15ae33ebd30ba3d7198e854
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Wed, 03 Jun 2026 00:18:05 GMT
USER gradle
# Wed, 03 Jun 2026 00:18:11 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=6f74b601422d6d6fc4e1f9a1ab6522f642c2fdcbc15ae33ebd30ba3d7198e854
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --stacktrace --debug --version # buildkit
# Wed, 03 Jun 2026 00:18:11 GMT
USER root
...
-	Layers:
	...
	-	`sha256:90c87c2ebb0c259a47aed17af416fb79508aa8bcac23ade28a873e42e0db6f78`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c6456c401d81bb495c982af44bb58a4306af541a72189ea15c84d069e66774c8`  
		Last Modified: Wed, 03 Jun 2026 00:23:32 GMT  
		Size: 138.1 MB (138068539 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:13c3f3a6fe674dfcec6181295e0bc921cff9d44d65570a50af16fdd47fc199c9`  
		Last Modified: Wed, 03 Jun 2026 00:23:11 GMT  
...
```console
$ docker pull gradle@sha256:32eb8331e2e7beadbd02129449ba9f9032dc187c22b03001203055e81a03924c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.5 MB (7538202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4195d9d8c7656bde4b1d3aed0d4fad05c059825ce1287bfe9afd79c426cb0c74`

```dockerfile
```

-	Layers:
	-	`sha256:d61b3ea2d8ba2e3818fb976a7e7f6bcf56ed6b310255c766f9b9846ae8ca833b`  
		Last Modified: Wed, 03 Jun 2026 00:23:12 GMT  
		Size: 7.5 MB (7510121 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:09bb8bc137edaec4f0edbb2a98e132d4c5c2d4b60a8fc98479ed8e83287b8a15`  
		Last Modified: Wed, 03 Jun 2026 00:23:11 GMT  
		Size: 28.1 KB (28081 bytes)  
		MIME: application/vnd.in-toto+json
