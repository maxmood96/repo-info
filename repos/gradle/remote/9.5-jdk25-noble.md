...
### `gradle:9.5-jdk25-noble` - linux; amd64
...
### `gradle:9.5-jdk25-noble` - unknown; unknown
...
### `gradle:9.5-jdk25-noble` - linux; arm64 variant v8
...
### `gradle:9.5-jdk25-noble` - linux; ppc64le
...
### `gradle:9.5-jdk25-noble` - linux; riscv64
...
### `gradle:9.5-jdk25-noble` - linux; s390x
