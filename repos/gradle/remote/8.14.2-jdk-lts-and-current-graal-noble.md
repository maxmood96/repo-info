## `gradle:8.14.2-jdk-lts-and-current-graal-noble`
...
### `gradle:8.14.2-jdk-lts-and-current-graal-noble` - linux; amd64
...
### `gradle:8.14.2-jdk-lts-and-current-graal-noble` - unknown; unknown
...
### `gradle:8.14.2-jdk-lts-and-current-graal-noble` - linux; arm64 variant v8
