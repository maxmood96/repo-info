...
### `gradle:9.0-jdk21-ubi-minimal` - linux; amd64
...
### `gradle:9.0-jdk21-ubi-minimal` - unknown; unknown
...
### `gradle:9.0-jdk21-ubi-minimal` - linux; arm64 variant v8
...
### `gradle:9.0-jdk21-ubi-minimal` - linux; ppc64le
...
### `gradle:9.0-jdk21-ubi-minimal` - linux; s390x
