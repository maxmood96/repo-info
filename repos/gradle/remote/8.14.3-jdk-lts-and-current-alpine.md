...
### `gradle:8.14.3-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:8.14.3-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:8.14.3-jdk-lts-and-current-alpine` - linux; arm64 variant v8
