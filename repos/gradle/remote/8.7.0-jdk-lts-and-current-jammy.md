...
### `gradle:8.7.0-jdk-lts-and-current-jammy` - linux; amd64
...
### `gradle:8.7.0-jdk-lts-and-current-jammy` - unknown; unknown
...
### `gradle:8.7.0-jdk-lts-and-current-jammy` - linux; arm64 variant v8
