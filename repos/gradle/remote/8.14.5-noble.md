...
### `gradle:8.14.5-noble` - linux; amd64
...
### `gradle:8.14.5-noble` - unknown; unknown
...
### `gradle:8.14.5-noble` - linux; arm64 variant v8
...
### `gradle:8.14.5-noble` - linux; ppc64le
...
### `gradle:8.14.5-noble` - linux; riscv64
...
### `gradle:8.14.5-noble` - linux; s390x
