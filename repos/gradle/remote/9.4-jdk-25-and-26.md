...
### `gradle:9.4-jdk-25-and-26` - linux; amd64
...
### `gradle:9.4-jdk-25-and-26` - unknown; unknown
...
### `gradle:9.4-jdk-25-and-26` - linux; arm64 variant v8
...
### `gradle:9.4-jdk-25-and-26` - linux; ppc64le
...
### `gradle:9.4-jdk-25-and-26` - linux; riscv64
...
### `gradle:9.4-jdk-25-and-26` - linux; s390x
