...
### `gradle:7.6.4-jdk-lts-and-current` - linux; amd64
...
### `gradle:7.6.4-jdk-lts-and-current` - unknown; unknown
...
### `gradle:7.6.4-jdk-lts-and-current` - linux; arm64 variant v8
...
### `gradle:7.6.4-jdk-lts-and-current` - linux; ppc64le
...
### `gradle:7.6.4-jdk-lts-and-current` - linux; riscv64
...
### `gradle:7.6.4-jdk-lts-and-current` - linux; s390x
