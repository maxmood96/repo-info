## `gradle:9.5.1-jdk-lts-and-current-resolute`
...
### `gradle:9.5.1-jdk-lts-and-current-resolute` - linux; amd64
...
### `gradle:9.5.1-jdk-lts-and-current-resolute` - unknown; unknown
...
### `gradle:9.5.1-jdk-lts-and-current-resolute` - linux; arm64 variant v8
...
### `gradle:9.5.1-jdk-lts-and-current-resolute` - linux; ppc64le
...
### `gradle:9.5.1-jdk-lts-and-current-resolute` - linux; s390x
