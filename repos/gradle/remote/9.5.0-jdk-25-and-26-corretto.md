...
### `gradle:9.5.0-jdk-25-and-26-corretto` - linux; amd64
...
### `gradle:9.5.0-jdk-25-and-26-corretto` - unknown; unknown
...
### `gradle:9.5.0-jdk-25-and-26-corretto` - linux; arm64 variant v8
