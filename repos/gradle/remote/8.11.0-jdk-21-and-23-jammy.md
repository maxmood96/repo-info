...
### `gradle:8.11.0-jdk-21-and-23-jammy` - linux; amd64
...
### `gradle:8.11.0-jdk-21-and-23-jammy` - unknown; unknown
...
### `gradle:8.11.0-jdk-21-and-23-jammy` - linux; arm64 variant v8
