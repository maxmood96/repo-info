...
### `gradle:9.5.0-jdk-25-and-26-noble` - linux; amd64
...
### `gradle:9.5.0-jdk-25-and-26-noble` - unknown; unknown
...
### `gradle:9.5.0-jdk-25-and-26-noble` - linux; arm64 variant v8
...
### `gradle:9.5.0-jdk-25-and-26-noble` - linux; ppc64le
...
### `gradle:9.5.0-jdk-25-and-26-noble` - linux; riscv64
...
### `gradle:9.5.0-jdk-25-and-26-noble` - linux; s390x
