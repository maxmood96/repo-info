...
### `gradle:9.4.1-jdk25-ubi` - linux; amd64
...
### `gradle:9.4.1-jdk25-ubi` - unknown; unknown
...
### `gradle:9.4.1-jdk25-ubi` - linux; arm64 variant v8
...
### `gradle:9.4.1-jdk25-ubi` - linux; ppc64le
...
### `gradle:9.4.1-jdk25-ubi` - linux; s390x
