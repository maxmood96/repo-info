...
### `gradle:8.12.1-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:8.12.1-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:8.12.1-jdk-lts-and-current-alpine` - linux; arm64 variant v8
