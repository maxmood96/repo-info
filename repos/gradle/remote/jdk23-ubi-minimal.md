...
### `gradle:jdk23-ubi-minimal` - linux; amd64
...
### `gradle:jdk23-ubi-minimal` - unknown; unknown
...
### `gradle:jdk23-ubi-minimal` - linux; arm64 variant v8
...
### `gradle:jdk23-ubi-minimal` - linux; ppc64le
...
### `gradle:jdk23-ubi-minimal` - linux; s390x
