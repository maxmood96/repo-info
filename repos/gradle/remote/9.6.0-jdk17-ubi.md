...
### `gradle:9.6.0-jdk17-ubi` - linux; amd64
...
### `gradle:9.6.0-jdk17-ubi` - unknown; unknown
...
### `gradle:9.6.0-jdk17-ubi` - linux; arm64 variant v8
...
### `gradle:9.6.0-jdk17-ubi` - linux; ppc64le
...
### `gradle:9.6.0-jdk17-ubi` - linux; s390x
