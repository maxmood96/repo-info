...
```console
$ docker pull gradle@sha256:4939d0dee4b6bf9d8a55fb78d13f43a69cbfc9269de001e7ed2980090a26e302
```
...
```console
$ docker pull gradle@sha256:98afdb7606d146acd91e7d5eccda34679cd80dfa6e2e04964029e23def124f96
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **419.5 MB (419504069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9331e5998c93c8ccdd6d2f05c2f1d650740394a7abd634e4c022007778e4f56`
...
-	Layers:
	...
	-	`sha256:88e2f7493d8e3f46b905760c999991730035e727416a2f8d8df2d19772be2dfa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e94a0c58f4a244cca2bea88069cd80cc7d5dce97f5442d1bbf91fe493ba37b8e`  
		Last Modified: Tue, 27 Apr 2021 22:46:03 GMT  
		Size: 107.9 MB (107863151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.8-jdk11-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:90972f249e5616fa06df38bfdbac5966baf901c85730ed0f8946f3e31c9166fc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **414.3 MB (414279510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba5c6722c2d3c601bbf3ea69698c5eeb2000be7cbc28b5796d7c89adf489f213`
-	Default Command: `["gradle"]`
...
ENV GRADLE_VERSION=6.8.3
# Tue, 27 Apr 2021 22:52:58 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Tue, 27 Apr 2021 22:53:10 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:8c33a04d804de32be74a63552a65ae0cc2b081d1d826aa313f7757c524505ffa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1681a86fda427147d4b0eeaac8cba4c560b7e163e28bea5fa3d0b84943332761`  
		Last Modified: Tue, 27 Apr 2021 23:04:34 GMT  
		Size: 107.9 MB (107863207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.8-jdk11-openj9` - linux; ppc64le

```console
$ docker pull gradle@sha256:5f9c9df74974e803fc3522bb99ee3b8a0c9655adf3efb3d810b57f6d965f191e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **434.7 MB (434742174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f468433d66712467604144bffe9e3acec8e74a02bfee992bdefe4cbaa19056e`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Wed, 28 Apr 2021 00:12:31 GMT
ENV GRADLE_VERSION=6.8.3
# Wed, 28 Apr 2021 00:12:35 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Wed, 28 Apr 2021 00:13:48 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:5b467ecfe87a558b13211299faed7741ad5507172b68afd1952e0a4b41f4c568`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abf63d5a3eead8a38ce14714f47400f0807cf5317abebbc50cd62e1a482892b0`  
		Last Modified: Wed, 28 Apr 2021 00:51:13 GMT  
...
```console
$ docker pull gradle@sha256:7325e04c2241b6633f2560e8fe83e46a09e71456e398e19d6d3414bb8a38ea87
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **415.8 MB (415830844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecb30635cddf5fdf1b70f2e24c1e2eaf819cd16aa7e74045f8a7d21aa1626937`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 27 Apr 2021 23:00:30 GMT
ENV GRADLE_VERSION=6.8.3
# Tue, 27 Apr 2021 23:00:30 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Tue, 27 Apr 2021 23:00:40 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:5f45a06364fa89c725ef0d8a16a77339c605a0a581295574602dc87961a15956`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feeafad685a2605fefb1bd27d2a58470837dfaceeb3e7f710b567d2a9c1202f0`  
		Last Modified: Tue, 27 Apr 2021 23:12:16 GMT  
		Size: 107.9 MB (107863090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
