...
### `gradle:8.14.0-jdk11-ubi` - linux; amd64
...
### `gradle:8.14.0-jdk11-ubi` - unknown; unknown
...
### `gradle:8.14.0-jdk11-ubi` - linux; arm64 variant v8
...
### `gradle:8.14.0-jdk11-ubi` - linux; ppc64le
...
### `gradle:8.14.0-jdk11-ubi` - linux; s390x
