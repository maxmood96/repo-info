...
### `gradle:6.9.4-jdk21-noble` - linux; amd64
...
### `gradle:6.9.4-jdk21-noble` - unknown; unknown
...
### `gradle:6.9.4-jdk21-noble` - linux; arm64 variant v8
...
### `gradle:6.9.4-jdk21-noble` - linux; ppc64le
...
### `gradle:6.9.4-jdk21-noble` - linux; riscv64
...
### `gradle:6.9.4-jdk21-noble` - linux; s390x
