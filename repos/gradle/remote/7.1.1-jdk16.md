...
```console
$ docker pull gradle@sha256:75a6836f22da33d05233907c178f891918def377dac660fc7095275eec1af524
```
...
### `gradle:7.1.1-jdk16` - linux; amd64
...
### `gradle:7.1.1-jdk16` - linux; arm variant v7
...
### `gradle:7.1.1-jdk16` - linux; arm64 variant v8
...
### `gradle:7.1.1-jdk16` - linux; s390x
