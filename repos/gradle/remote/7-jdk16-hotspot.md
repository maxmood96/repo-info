...
```console
$ docker pull gradle@sha256:10e4bfb4422058b002ce9949433e4fc5b1d0d65453e5ae9f46e1d0c9f20c94ab
```
...
### `gradle:7-jdk16-hotspot` - linux; amd64
...
### `gradle:7-jdk16-hotspot` - linux; arm variant v7
...
### `gradle:7-jdk16-hotspot` - linux; arm64 variant v8
...
### `gradle:7-jdk16-hotspot` - linux; ppc64le
...
### `gradle:7-jdk16-hotspot` - linux; s390x
