...
```console
$ docker pull gradle@sha256:9cb4d7080b495d9e030342e4a3d1bdd015d1ee4a475cf97b2e49f379d871edf1
```
...
### `gradle:8.11.0-jdk21-corretto` - linux; amd64
...
### `gradle:8.11.0-jdk21-corretto` - unknown; unknown
...
### `gradle:8.11.0-jdk21-corretto` - linux; arm64 variant v8
