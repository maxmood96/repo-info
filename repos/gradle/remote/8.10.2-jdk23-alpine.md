...
```console
$ docker pull gradle@sha256:5c4280c7f32b44fb15edc21108c5dbfd0c9c56162499bc1386cb52b25a754130
```
...
### `gradle:8.10.2-jdk23-alpine` - linux; amd64
...
### `gradle:8.10.2-jdk23-alpine` - unknown; unknown
...
### `gradle:8.10.2-jdk23-alpine` - linux; arm64 variant v8
