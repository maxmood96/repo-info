...
```console
$ docker pull gradle@sha256:ba66503320f10b0c10f60c5441ea5d65f36fb425b74f9a8829d9ae431dfdeccd
```
...
```console
$ docker pull gradle@sha256:255e918a53b408def76046885308bb98ab3f42dc4db856d932e48d2ef81e64a4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.0 MB (425995179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:678fd3623ef2b8d5bcaf2ac7bc343d21e21dab3cdd5d605d843a72cd24ff8849`
...
-	Layers:
	...
	-	`sha256:67f6de7fb466ced5ee0ec4f5b88f321d92001491736ffeceb5f8e4e03d452ec9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dfbdd80d8ed094af70a212bbace75f60e20163ecf62062f62674750d229d96f`  
		Last Modified: Tue, 31 Aug 2021 07:28:45 GMT  
...
```console
$ docker pull gradle@sha256:ee08b4e2c94ce72bc3449f994ed1e1340f6f5885073a3dfcb17b1376d869fd3e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **440.9 MB (440905843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2cdc02ea376650e1e99b225b3d275b33fdc0ed2b8e3e71a0acb0152472d376c`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 31 Aug 2021 08:44:57 GMT
ENV GRADLE_VERSION=6.9.1
# Tue, 31 Aug 2021 08:45:01 GMT
ARG GRADLE_DOWNLOAD_SHA256=8c12154228a502b784f451179846e518733cf856efc7d45b2e6691012977b2fe
# Tue, 31 Aug 2021 08:45:23 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=8c12154228a502b784f451179846e518733cf856efc7d45b2e6691012977b2fe
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:797c70ce25ea916093e212b9c715b98b3f16aff086cf88ea692c3266c13f20fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ed2c38c9fa6857b16eac22225156f0e7c688a49ccc45f3e8fc4b82b3e7a884f`  
		Last Modified: Tue, 31 Aug 2021 09:25:39 GMT  
		Size: 107.7 MB (107689943 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9-jdk11-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:5f6cc74cea4f774735d51ee930985b4c021bab15e808cba19d8823df77e3af51
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **422.0 MB (421982162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e1bd89c3fe5fa604c695aba2124ed9a00d51762b6287f21539004557baccf48`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Fri, 01 Oct 2021 02:58:11 GMT
ENV GRADLE_VERSION=6.9.1
# Fri, 01 Oct 2021 02:58:12 GMT
ARG GRADLE_DOWNLOAD_SHA256=8c12154228a502b784f451179846e518733cf856efc7d45b2e6691012977b2fe
# Fri, 01 Oct 2021 02:58:16 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=8c12154228a502b784f451179846e518733cf856efc7d45b2e6691012977b2fe
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:5a55c31fd47c38b7f67c1d749f3ad72c53ff6810e2c71d62308f01e07ce24eab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8311b651243360a7f970ff68a312560219a262a30fb585682601bf8c3de6db94`  
		Last Modified: Fri, 01 Oct 2021 03:12:52 GMT  
