...
```console
$ docker pull gradle@sha256:348472b692f3bbed8a6302b7ca827469e6452fa3efccfbab136dc8c2495f488e
```
...
```console
$ docker pull gradle@sha256:5b4bfe35ce267f29030f03a72257eb80b04eef2b9b02cc5f5b557c299b35aad4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.3 MB (426281314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15c347367788fc6ab0cd8f806d4ccb399e84f0538a41ffc74f21ad35031d4b33`
...
-	Layers:
	...
	-	`sha256:5135e5df95bdffc85ee75a7e232a361c4184036044390f472e9968f1009a6a01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7ec09fb9a09d64f533a7db7c8d536be7f0aa6cc84ce9659e9ac6e9ea7caac1e`  
		Last Modified: Mon, 10 May 2021 19:02:52 GMT  
		Size: 108.1 MB (108149243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9-jdk11-openj9` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:f833f566f9de96c96514346cdc4fa593ee93272db72b9f5901aec9539bbde47e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **414.6 MB (414565542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de6f85b928e049e54f2c145864f01b38a63b30ba96a8bcd6dcc2571c910836d2`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 17:57:14 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 17:57:15 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 17:57:44 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:8c33a04d804de32be74a63552a65ae0cc2b081d1d826aa313f7757c524505ffa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:137c658031b8b91fe7378d7cfc09dd6f4a658800be59be6b77bbd0cfff7131ec`  
		Last Modified: Mon, 10 May 2021 18:08:32 GMT  
...
```console
$ docker pull gradle@sha256:2586e230ef4d7748f62c8354cb99cc19451afaa4a214cb7cb3c749924ea79d34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **441.3 MB (441338261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b13af1f109615c689c8f0ec87dcf6cd2904a996fb8fe06b81d3fadcd558b06c`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 20:04:10 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 20:04:16 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 20:06:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:b7a202990c6a2324eff44abc680e74e77296273edb6ac7b2d61216d5c1f26b42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74d0d361d9bf866e5034c1b7ab794690ab439be254db9cfb7301b076e29b6cc1`  
		Last Modified: Mon, 10 May 2021 20:40:46 GMT  
		Size: 108.1 MB (108149269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9-jdk11-openj9` - linux; s390x

```console
$ docker pull gradle@sha256:d92c334fb283eb1f45400afe48052fc0643eb23edee3cd342f241425a4b9cf41
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **422.6 MB (422578097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2024ec55fe6a21a9099216b3253a0df6806064002194c1d5559688edbe92f6e`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:6d6b279e8a028d60b5283f8b9394b1500729554a4f033926ddf26ac06ba961ef`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:264b4b954def91e62cc7b095aa7bf810d68f803fffd18a5ebf978fb005f4db84`  
		Last Modified: Mon, 10 May 2021 20:18:39 GMT  
		Size: 108.1 MB (108149225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
