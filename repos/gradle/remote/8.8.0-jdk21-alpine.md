...
```console
$ docker pull gradle@sha256:53d1c47546b562892fa4d130058d7a0a77d4b1ffa1074091453c15a3b26c2029
```
...
### `gradle:8.8.0-jdk21-alpine` - linux; amd64
...
### `gradle:8.8.0-jdk21-alpine` - unknown; unknown
