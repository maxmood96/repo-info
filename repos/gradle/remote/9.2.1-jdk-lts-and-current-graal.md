...
### `gradle:9.2.1-jdk-lts-and-current-graal` - linux; amd64
...
### `gradle:9.2.1-jdk-lts-and-current-graal` - unknown; unknown
...
### `gradle:9.2.1-jdk-lts-and-current-graal` - linux; arm64 variant v8
