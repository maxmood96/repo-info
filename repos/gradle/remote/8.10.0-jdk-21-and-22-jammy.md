...
### `gradle:8.10.0-jdk-21-and-22-jammy` - linux; amd64
...
### `gradle:8.10.0-jdk-21-and-22-jammy` - unknown; unknown
...
### `gradle:8.10.0-jdk-21-and-22-jammy` - linux; arm64 variant v8
