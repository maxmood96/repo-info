...
```console
$ docker pull gradle@sha256:b2146b8c962a756d477513e002a7b1779b8d25e35fbc61eeeeff5ced627e2e01
```
...
```console
$ docker pull gradle@sha256:9620865af4f35026abfc9680603449296f832ea79da9a7f4e79d00989ccddcee
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **436.3 MB (436263811 bytes)**  
...
# Tue, 31 Aug 2021 02:34:30 GMT
CMD ["jshell"]
# Tue, 31 Aug 2021 07:11:42 GMT
CMD ["gradle"]
# Tue, 31 Aug 2021 07:11:42 GMT
ENV GRADLE_HOME=/opt/gradle
# Tue, 31 Aug 2021 07:11:43 GMT
...
-	Layers:
	...
	-	`sha256:b42504b025f1aab77ba9df4476e7f003fdfd15fdae44c4cb2a901772d9868913`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b7c11fbdbe1fe5513c1e7859c89bb476f0c6955b5ccc663b8da7753e031923a`  
		Last Modified: Tue, 31 Aug 2021 07:23:58 GMT  
		Size: 4.4 KB (4359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85cf16eaad1913d623b3f85fef2129a26ef8fef39de832712b1964e85c1f6bba`  
		Last Modified: Tue, 31 Aug 2021 07:24:10 GMT  
		Size: 65.6 MB (65625649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e9f86b40b2c3b9883779ddf2bf2f735b2f39c8a7dae615566eb091c6be764a`  
		Last Modified: Tue, 31 Aug 2021 07:24:05 GMT  
...
```console
$ docker pull gradle@sha256:ee08349332cfb183288fe70618f4949a2ce6b29a9b7a53c52f1aa3faebcde178
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.9 MB (431945640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d6b643d92a978cd55238a1e75d41b569451e5035d7b502a6b2ab594b8224174`
-	Default Command: `["gradle"]`
...
CMD ["jshell"]
# Tue, 31 Aug 2021 03:53:15 GMT
CMD ["gradle"]
# Tue, 31 Aug 2021 03:53:15 GMT
ENV GRADLE_HOME=/opt/gradle
# Tue, 31 Aug 2021 03:53:16 GMT
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln -s /home/gradle/.gradle /root/.gradle
# Tue, 31 Aug 2021 03:53:16 GMT
VOLUME [/home/gradle/.gradle]
# Tue, 31 Aug 2021 03:53:16 GMT
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 31 Aug 2021 03:53:46 GMT
ENV GRADLE_VERSION=7.2
# Tue, 31 Aug 2021 03:53:46 GMT
ARG GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
# Tue, 31 Aug 2021 03:53:52 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=f581709a9c35e9cb92e16f585d2c4bc99b2b1a5f85d2badbd3dc6bff59e1e6dd
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:f59d2079e058460bb9a620678cc312578648d1b3d6dcbf05627123041b283dc6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3484813ffa1f81c7fc48d63a807e7c33714b1a75364c24928439cf9bfff82e9f`  
		Last Modified: Tue, 31 Aug 2021 04:09:45 GMT  
		Size: 4.4 KB (4363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b508318dd50445d4932abbc7aedec1ad6926ff69c9b96107792880f08f4c019`  
		Last Modified: Tue, 31 Aug 2021 04:09:55 GMT  
		Size: 64.8 MB (64833073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df8cb653e8a895b37c1d48ed0517c2cf7d3af8a7e11a7c48096ef148d74c26ba`  
		Last Modified: Tue, 31 Aug 2021 04:09:50 GMT  
		Size: 114.4 MB (114373916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
