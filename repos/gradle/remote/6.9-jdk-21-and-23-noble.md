...
### `gradle:6.9-jdk-21-and-23-noble` - linux; amd64
...
### `gradle:6.9-jdk-21-and-23-noble` - unknown; unknown
...
### `gradle:6.9-jdk-21-and-23-noble` - linux; arm64 variant v8
...
### `gradle:6.9-jdk-21-and-23-noble` - linux; ppc64le
...
### `gradle:6.9-jdk-21-and-23-noble` - linux; riscv64
...
### `gradle:6.9-jdk-21-and-23-noble` - linux; s390x
