...
```console
$ docker pull gradle@sha256:4f1a7bc2589a83a05e9808d4cbf9c65daeb085747dc4fecf67b680b3d3a2323d
```
...
-	Layers:
	...
	-	`sha256:e028f1fbe8d6904317da428d57ee0a07c615d782657c1e0a4172083fc9b544f4`  
		Last Modified: Fri, 14 Nov 2025 10:16:55 GMT  
...
```console
$ docker pull gradle@sha256:62fdd3ac4a98000cb652def1dd1bab389a7098178dc575a8f4c0aad420b59222
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.7 MB (296654533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52a3b8c6aa19f5d3dbeae9c9e2ebb51f453ad52df2650cc0460e7c8de6a37e17`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Fri, 14 Nov 2025 08:10:47 GMT
ARG GRADLE_DOWNLOAD_SHA256=673d9776f303bc7048fc3329d232d6ebf1051b07893bd9d11616fad9a8673be0
# Fri, 14 Nov 2025 08:13:53 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=673d9776f303bc7048fc3329d232d6ebf1051b07893bd9d11616fad9a8673be0
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle # buildkit
# Fri, 14 Nov 2025 08:13:53 GMT
USER gradle
# Fri, 14 Nov 2025 08:13:55 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=673d9776f303bc7048fc3329d232d6ebf1051b07893bd9d11616fad9a8673be0
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version # buildkit
# Fri, 14 Nov 2025 08:13:55 GMT
USER root
...
-	Layers:
	...
	-	`sha256:49f046a9e3404391a0e476f1c9e80b468ba9826378570a8950a3ce5c46e1a45b`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2f314d2d15edef08bc1f11a4ac6637b2d15f8b9d10f5bc0373d219688046fbb4`  
		Last Modified: Fri, 14 Nov 2025 08:14:28 GMT  
		Size: 128.5 MB (128469430 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9fc42b57cb6f479f4fbbee58dcd6ff41c11ace8df06fa3a4df93c34a0c9541c2`  
		Last Modified: Fri, 14 Nov 2025 08:14:33 GMT  
...
```console
$ docker pull gradle@sha256:b62fd5df1d36d961cfbc2fd57d5374f6126b09b826eb4b0cac383dd008064696
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.5 MB (5456487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:621b1d3dee77e532baebbd1c3d6a862fe23194ef717895ad5a57f24a4ba3e534`

```dockerfile
```

-	Layers:
	-	`sha256:580618362fbf586ddd1503abc6129c5ed968369e2cb18381e7b31b0244ca1b81`  
		Last Modified: Fri, 14 Nov 2025 09:19:08 GMT  
		Size: 5.4 MB (5432829 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:96c8900f098cc79cb002e15bf82888e15771f9d21cfa383f5f0a63f3335b4322`  
		Last Modified: Fri, 14 Nov 2025 09:19:09 GMT  
