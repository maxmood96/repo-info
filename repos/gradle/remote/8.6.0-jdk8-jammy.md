...
```console
$ docker pull gradle@sha256:7af5968b7ae347d41e68f7e222947f6e022937da4aa180bb3484cba65cbca3c7
```
...
```console
$ docker pull gradle@sha256:173f3c3d478f1fad31a15fabc137a699e695450e4698e7b36f4750b1b810801c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.0 MB (325973421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f618c0df14a5d5946beb720dfbfd180b1972c791213c825219e9b1302a164a0a`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 16 Feb 2024 10:13:51 GMT
ENV GRADLE_VERSION=8.6
# Fri, 16 Feb 2024 10:13:51 GMT
ARG GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
# Fri, 16 Feb 2024 10:13:59 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 16 Feb 2024 10:14:00 GMT
USER gradle
# Fri, 16 Feb 2024 10:14:03 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9631d53cf3e74bfa726893aee1f8994fee4e060c401335946dba2156f440f24c
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 16 Feb 2024 10:14:03 GMT
USER root
...
-	Layers:
	...
	-	`sha256:414aeaff037e7c852566b2f6c3547c5220e39ff25869d93eccbd4722502c20d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bf04b585b18693d34ff97b9ed2b55105560b1cf099030f51cbbb982b2ace3b3`  
		Last Modified: Fri, 16 Feb 2024 10:20:06 GMT  
		Size: 132.8 MB (132815761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a815fa8e654643d6c0a71d2251c12843d80ef56e77f7ba5c67574911913c5eb`  
		Last Modified: Fri, 16 Feb 2024 10:19:51 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
