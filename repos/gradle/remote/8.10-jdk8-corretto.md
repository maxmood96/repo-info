...
```console
$ docker pull gradle@sha256:bbecdcfdbf8c41ace7ad73fd836799452a821c965fc883b5f0597181bff0ecaa
```
...
### `gradle:8.10-jdk8-corretto` - linux; amd64
...
### `gradle:8.10-jdk8-corretto` - unknown; unknown
...
### `gradle:8.10-jdk8-corretto` - linux; arm64 variant v8
