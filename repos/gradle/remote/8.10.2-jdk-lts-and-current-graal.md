...
```console
$ docker pull gradle@sha256:890180b6d78f69e1cc12eede3d5e0d3f70f27234f6237a3338b248ff1105cf1f
```
...
### `gradle:8.10.2-jdk-lts-and-current-graal` - linux; amd64
...
### `gradle:8.10.2-jdk-lts-and-current-graal` - unknown; unknown
