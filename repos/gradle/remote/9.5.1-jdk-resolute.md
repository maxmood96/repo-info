...
### `gradle:9.5.1-jdk-resolute` - linux; amd64
...
### `gradle:9.5.1-jdk-resolute` - unknown; unknown
...
### `gradle:9.5.1-jdk-resolute` - linux; arm64 variant v8
...
### `gradle:9.5.1-jdk-resolute` - linux; ppc64le
...
### `gradle:9.5.1-jdk-resolute` - linux; s390x
