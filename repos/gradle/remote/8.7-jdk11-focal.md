...
```console
$ docker pull gradle@sha256:626b9ebea8104d28c77927959271bcc38f676175b0a52176af9ba5f42c4ae4af
```
...
```console
$ docker pull gradle@sha256:9adb0bb4f0cb3127663113e2fcf2cd2a26b4d13ce426383b27e3627f4b0dc68c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **390.5 MB (390471518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc96bbd7832f2ce022a1ded6a1ad02bfd0c3c94cb8a1f72e9c820908cd2ccc13`
...
-	Layers:
	...
	-	`sha256:f2bebe18bcaa1ca373e4a5b3a163939a9ebadf37106608260ee387bc7719d60e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45e121252155b06484646eb77d326af696f4938252d79c154f8006363dfd7401`  
		Last Modified: Mon, 25 Mar 2024 20:07:42 GMT  
		Size: 134.2 MB (134209885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2880f125df50de78cf261d099f4ce7544c4957593ae0d8576b311c47fa912526`  
		Last Modified: Mon, 25 Mar 2024 20:07:36 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:5c2724253cf565017548d79027439992bb3adaaa5b6d14379fd55adc0b4fff60
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **372.4 MB (372388296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e414ae73cc5ae070ac05e3ff79e92cc01e0394a9f200e1e3ce6fa268f71f67f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 25 Mar 2024 18:58:34 GMT
ENV GRADLE_VERSION=8.7
# Mon, 25 Mar 2024 18:58:34 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Mon, 25 Mar 2024 18:58:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Mon, 25 Mar 2024 18:58:40 GMT
USER gradle
# Mon, 25 Mar 2024 18:58:41 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Mon, 25 Mar 2024 18:58:41 GMT
USER root
...
-	Layers:
	...
	-	`sha256:c3f782b90c03587467466afd21f4223d4d21e5df7c85344252391bf8808a4df4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b750cb955b725df25e927a1ff7e00696b31b657ee3f9b95eab422a9d56fefc91`  
		Last Modified: Mon, 25 Mar 2024 19:02:08 GMT  
		Size: 134.2 MB (134209928 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7e953062bbade1dba50b8a012494c8b773db964a53576263d59056e41f33feb`  
		Last Modified: Mon, 25 Mar 2024 19:02:00 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:1af9851906004e2fb688292c2c8591823097de2778737bfe33bf6a1a3c25215c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **385.4 MB (385444550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68a43bc7ac7a80097938edcc7046291e0e615acfca97483683cb55a09dc44335`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 25 Mar 2024 18:40:08 GMT
ENV GRADLE_VERSION=8.7
# Mon, 25 Mar 2024 18:40:08 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Mon, 25 Mar 2024 18:40:12 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Mon, 25 Mar 2024 18:40:13 GMT
USER gradle
# Mon, 25 Mar 2024 18:40:14 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Mon, 25 Mar 2024 18:40:14 GMT
USER root
...
-	Layers:
	...
	-	`sha256:b0d061446d99cc5d943ddf7c1cc60a2b0f9ff91bd4f003953577247d8e64f86c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2888ca4de107f27b44f911b2051ca86ecb0bd8b303a30f19f4e64459b33aca7`  
		Last Modified: Mon, 25 Mar 2024 18:43:58 GMT  
		Size: 134.2 MB (134209897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93bbe68479948c6fdeb8353ae21ac90420aed04d674d07c3bbcc729a03ad390b`  
		Last Modified: Mon, 25 Mar 2024 18:43:52 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:8074691c568ad53c5146e0fcd19a8c99def4354e6f2fc1d1fc4102fd1a76f764
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **392.0 MB (391997334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f96c383cb9ae1844ffd8f69ebe9f2ec8057eee83119b8805fd36957b802a3c88`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 25 Mar 2024 19:26:30 GMT
ENV GRADLE_VERSION=8.7
# Mon, 25 Mar 2024 19:26:32 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Mon, 25 Mar 2024 19:26:40 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Mon, 25 Mar 2024 19:26:44 GMT
USER gradle
# Mon, 25 Mar 2024 19:26:49 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Mon, 25 Mar 2024 19:26:50 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:a2a4795a60e34bc67b0d66806b9f5c6de704042704e8151739e43fe3953bf881`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73cf91604e23f2eace7e7e22304618393b2404124de3f5313426aa86117ebec9`  
		Last Modified: Mon, 25 Mar 2024 19:31:04 GMT  
		Size: 134.2 MB (134209880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d31c746703fa04da32901ee8a2198218a00ba1670bd830bb448d64d38c98477b`  
		Last Modified: Mon, 25 Mar 2024 19:30:57 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:5b9beb99afcd0f08ce90653777ae2a5a43e188b20e63224f88ceb245dfd99555
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.1 MB (368093529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2cd7b8c97a8d13012af000d04cb5feaf48305aed12ebfc048706810b6715a76`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 25 Mar 2024 19:00:49 GMT
ENV GRADLE_VERSION=8.7
# Mon, 25 Mar 2024 19:00:49 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Mon, 25 Mar 2024 19:01:01 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Mon, 25 Mar 2024 19:01:03 GMT
USER gradle
# Mon, 25 Mar 2024 19:01:05 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Mon, 25 Mar 2024 19:01:05 GMT
USER root
...
-	Layers:
	...
	-	`sha256:1f9198c9a2311075c0c1a94f12d31121204d8ff907c20aaf5b048b122161edae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a02f2b5d2d73ba84a408cc1231efefdc5ad3cf555faf68c70424fc53bc2a6ac2`  
		Last Modified: Mon, 25 Mar 2024 19:17:55 GMT  
		Size: 134.2 MB (134209909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f59eb1911b469d41d89a8bbca39c4cf3d7e58ea626efb2449fa0664aed503bc1`  
		Last Modified: Mon, 25 Mar 2024 19:17:45 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
