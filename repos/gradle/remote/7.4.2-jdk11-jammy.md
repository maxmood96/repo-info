...
```console
$ docker pull gradle@sha256:d49372ac9ef98e3bf5a645ca26506725d7924a3e5679d12fefccde166d43f0e2
```
...
### `gradle:7.4.2-jdk11-jammy` - linux; amd64
...
### `gradle:7.4.2-jdk11-jammy` - linux; arm variant v7
...
### `gradle:7.4.2-jdk11-jammy` - linux; arm64 variant v8
...
### `gradle:7.4.2-jdk11-jammy` - linux; s390x
