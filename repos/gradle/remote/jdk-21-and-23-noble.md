...
### `gradle:jdk-21-and-23-noble` - linux; amd64
...
### `gradle:jdk-21-and-23-noble` - unknown; unknown
...
### `gradle:jdk-21-and-23-noble` - linux; arm64 variant v8
...
### `gradle:jdk-21-and-23-noble` - linux; ppc64le
...
### `gradle:jdk-21-and-23-noble` - linux; riscv64
...
### `gradle:jdk-21-and-23-noble` - linux; s390x
