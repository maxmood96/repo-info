...
```console
$ docker pull gradle@sha256:46fe3be0de545d1279752ce3be676fd6626d5d4d8d7539fdfecbb5e3463d824e
```
...
### `gradle:6.4-jdk14` - linux; arm variant v7
...
### `gradle:6.4-jdk14` - linux; arm64 variant v8
...
### `gradle:6.4-jdk14` - linux; ppc64le
