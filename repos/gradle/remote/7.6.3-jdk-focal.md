...
```console
$ docker pull gradle@sha256:c5530c48e31cf2ddd5b0755cc3160b13c8475c560737ba9cc01c2891e2bf6c7b
```
...
```console
$ docker pull gradle@sha256:e53d23e192edbb33f7032effd104e837de0b75ccafdc4e6f80671c898fd54de3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **381.9 MB (381863278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57824d927f653fe01321f381680fa0a379c97623afc5537f284865a49511d989`
...
-	Layers:
	...
	-	`sha256:da0d48edda3162fb6460f10c2e3975967a87ceb95ccba78074f899d9afcb8dfc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7a5dbb9259a713006b8678a59cce7359087a7646a30e4d5869936ff5b4c97cf`  
		Last Modified: Fri, 06 Oct 2023 01:28:14 GMT  
		Size: 122.3 MB (122346935 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85bb36d3e8a586fb9a533b56afbb0e156d1e8e776bae467193625f80ad03eb6`  
		Last Modified: Fri, 06 Oct 2023 01:28:05 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:b2e9768e6666c151de04b9d432ae0e3390bf083d51986b201393fd2e122cfc0e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **396.7 MB (396703625 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:005533b613eaf6ef232e07263cc31c90b7b04d8f91548f197b7bb0da212d8a38`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 06 Oct 2023 01:33:26 GMT
ENV GRADLE_VERSION=7.6.3
# Fri, 06 Oct 2023 01:33:26 GMT
ARG GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
# Fri, 06 Oct 2023 01:33:37 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 06 Oct 2023 01:33:39 GMT
USER gradle
# Fri, 06 Oct 2023 01:33:42 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 06 Oct 2023 01:33:43 GMT
USER root
```
...
-	Layers:
	...
	-	`sha256:80d8e227f6042ba8be31bb84f0fea42f4ee01ae3573571856105cbc06117b23c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7af8419ac80b98365ffa6cd09556dee113b374ff9146710de778f639a11491b5`  
		Last Modified: Fri, 06 Oct 2023 01:43:31 GMT  
		Size: 122.3 MB (122346946 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e5a77b770cff496cb292ea1cd8c7fc43f8ce94fc8def39e96b2e134dcb2874`  
		Last Modified: Fri, 06 Oct 2023 01:43:21 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:844d4bce9417b55c59e94a1c3afccccfa1b41455921572da8e5a0e8eeaa7b2ed
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.5 MB (368523549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23acd0002b51c4920fa859e22bfdf477f9a62e64f8e5a4b4209f1771785f924e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:7eb1acb507ae360e0a628ad589e732c58236bf8597614a114f182196dccf2027`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e579c976ef76abf01ccc7e08fa8b0ec7f0d3437a2eb973fe9ec43e76ea8fcf`  
		Last Modified: Mon, 09 Oct 2023 16:28:26 GMT  
		Size: 122.3 MB (122346996 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035eeaff6962c695bee2468e682b4542c6dc5ab68ac1516f638cca6c9b00be3a`  
		Last Modified: Mon, 09 Oct 2023 16:28:13 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
