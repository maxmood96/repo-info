## `gradle:8.14.2-jdk-lts-and-current-graal`

```console
$ docker pull gradle@sha256:7d831509598be901bf2465c0899b7f1ffe3070fc47bdc4e740222223b06b8bf2
```
...
### `gradle:8.14.2-jdk-lts-and-current-graal` - linux; amd64
...
### `gradle:8.14.2-jdk-lts-and-current-graal` - unknown; unknown
