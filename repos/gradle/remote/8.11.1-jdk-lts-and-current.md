...
### `gradle:8.11.1-jdk-lts-and-current` - linux; amd64
...
### `gradle:8.11.1-jdk-lts-and-current` - unknown; unknown
...
### `gradle:8.11.1-jdk-lts-and-current` - linux; arm64 variant v8
