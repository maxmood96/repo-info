...
### `gradle:9.4.1-jdk-25-and-25-corretto` - linux; amd64
...
### `gradle:9.4.1-jdk-25-and-25-corretto` - unknown; unknown
...
### `gradle:9.4.1-jdk-25-and-25-corretto` - linux; arm64 variant v8
