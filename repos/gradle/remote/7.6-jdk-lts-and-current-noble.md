...
### `gradle:7.6-jdk-lts-and-current-noble` - linux; amd64
...
### `gradle:7.6-jdk-lts-and-current-noble` - unknown; unknown
...
### `gradle:7.6-jdk-lts-and-current-noble` - linux; arm64 variant v8
...
### `gradle:7.6-jdk-lts-and-current-noble` - linux; ppc64le
...
### `gradle:7.6-jdk-lts-and-current-noble` - linux; riscv64
...
### `gradle:7.6-jdk-lts-and-current-noble` - linux; s390x
