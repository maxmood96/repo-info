...
### `gradle:7.6.4-jdk21-jammy` - linux; amd64
...
### `gradle:7.6.4-jdk21-jammy` - unknown; unknown
...
### `gradle:7.6.4-jdk21-jammy` - linux; arm64 variant v8
...
### `gradle:7.6.4-jdk21-jammy` - linux; ppc64le
...
### `gradle:7.6.4-jdk21-jammy` - linux; s390x
