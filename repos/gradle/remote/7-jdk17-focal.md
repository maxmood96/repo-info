...
```console
$ docker pull gradle@sha256:fe97a58035acea9a6059e09044c87fecd5c9a99e5e18269f9b82d1205855518f
```
...
```console
$ docker pull gradle@sha256:fb7d0b2896bb80bbf6a7b139085f1310dfd4d53b29571b8d191135dbb95f15d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **369.1 MB (369065756 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f09c8a19b359c2d7222b392a6b60e31a62a21f49d345caff220bee7f7e48868`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 31 Aug 2023 20:38:29 GMT
ENV GRADLE_VERSION=7.6.2
# Thu, 31 Aug 2023 20:38:29 GMT
ARG GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
# Thu, 31 Aug 2023 20:38:34 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 31 Aug 2023 20:38:34 GMT
USER gradle
# Thu, 31 Aug 2023 20:38:35 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 31 Aug 2023 20:38:35 GMT
USER root
...
-	Layers:
	...
	-	`sha256:96804c45f52a3e523a4888371a0f0a893437c1186c849f4d2c858d09f5823292`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3b23343dbd96325e9248e4662c6cd096a98dae366ad766aab5b58cb98701d22`  
		Last Modified: Thu, 31 Aug 2023 20:44:23 GMT  
		Size: 122.3 MB (122344559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0efe5d9249b35f755d0da4f15bb898a15b3b95f5ce50cf4d311c5ecd0ae79e48`  
		Last Modified: Thu, 31 Aug 2023 20:44:16 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:a6e1f8e4dd3460591b6573ed0099075145a619bec8cbf012032f94d20bd0bc7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **379.7 MB (379721170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df83752781182bae724e7e92adebc9fa793844d37c9c3a5d59b5e72464462954`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 31 Aug 2023 21:16:08 GMT
ENV GRADLE_VERSION=7.6.2
# Thu, 31 Aug 2023 21:16:08 GMT
ARG GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
# Thu, 31 Aug 2023 21:16:12 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 31 Aug 2023 21:16:12 GMT
USER gradle
# Thu, 31 Aug 2023 21:16:13 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 31 Aug 2023 21:16:13 GMT
USER root
...
-	Layers:
	...
	-	`sha256:e8813e5672b7a18524a007fbf954787bb6cc77eb7f661368786674b309b1fff3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8658c8d218eba0cf07cde02ce02200d62b1fd1d21d07e12e758c0120259cbc98`  
		Last Modified: Thu, 31 Aug 2023 21:21:54 GMT  
		Size: 122.3 MB (122344556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0c20691e6f57ede83087dd2e88cbeb053fe07544edab382b04d385dbc40a5be`  
		Last Modified: Thu, 31 Aug 2023 21:21:47 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
