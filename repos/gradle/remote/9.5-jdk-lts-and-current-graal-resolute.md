## `gradle:9.5-jdk-lts-and-current-graal-resolute`
...
### `gradle:9.5-jdk-lts-and-current-graal-resolute` - linux; amd64
...
### `gradle:9.5-jdk-lts-and-current-graal-resolute` - unknown; unknown
...
### `gradle:9.5-jdk-lts-and-current-graal-resolute` - linux; arm64 variant v8
