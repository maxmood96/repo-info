...
### `gradle:7.6.5-jdk-jammy` - linux; amd64
...
### `gradle:7.6.5-jdk-jammy` - unknown; unknown
...
### `gradle:7.6.5-jdk-jammy` - linux; arm variant v7
...
### `gradle:7.6.5-jdk-jammy` - linux; arm64 variant v8
...
### `gradle:7.6.5-jdk-jammy` - linux; ppc64le
...
### `gradle:7.6.5-jdk-jammy` - linux; s390x
