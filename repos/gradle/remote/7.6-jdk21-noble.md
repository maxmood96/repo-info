...
### `gradle:7.6-jdk21-noble` - linux; amd64
...
### `gradle:7.6-jdk21-noble` - unknown; unknown
...
### `gradle:7.6-jdk21-noble` - linux; arm64 variant v8
...
### `gradle:7.6-jdk21-noble` - linux; ppc64le
...
### `gradle:7.6-jdk21-noble` - linux; riscv64
...
### `gradle:7.6-jdk21-noble` - linux; s390x
