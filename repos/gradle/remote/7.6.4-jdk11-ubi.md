...
### `gradle:7.6.4-jdk11-ubi` - linux; amd64
...
### `gradle:7.6.4-jdk11-ubi` - unknown; unknown
...
### `gradle:7.6.4-jdk11-ubi` - linux; arm64 variant v8
...
### `gradle:7.6.4-jdk11-ubi` - linux; ppc64le
...
### `gradle:7.6.4-jdk11-ubi` - linux; s390x
