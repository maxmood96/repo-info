...
```console
$ docker pull gradle@sha256:640c7c269ef351225838ef7eef643b490fa61aa6f340e4f8e06b548d5d3d8aff
```
...
```console
$ docker pull gradle@sha256:a82b62f97d53f44cdd2d3bc8f9942abbc7b992138b6fb152ce9d320f6c327bf0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **383.8 MB (383775211 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84790f17b2e4fead1f272e6fe0ef2029615487d766a3b90a46e3e891555f4592`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 02 Feb 2024 09:47:50 GMT
ENV GRADLE_VERSION=8.5
# Fri, 02 Feb 2024 09:47:50 GMT
ARG GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
# Fri, 02 Feb 2024 09:47:54 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 02 Feb 2024 09:47:55 GMT
USER gradle
# Fri, 02 Feb 2024 09:47:56 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 02 Feb 2024 09:47:56 GMT
USER root
...
-	Layers:
	...
	-	`sha256:535b908b00c364f721ccf9f66bc76e1e044a0aff13e2c17e4cb1fa4bf189032a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72d22625a69d3c604f1986cb9c68d5276fc54964f5abcc873c24274bee44ea49`  
		Last Modified: Fri, 02 Feb 2024 09:53:48 GMT  
		Size: 132.5 MB (132544731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f3f497c9bc49f744c0c5ba0c9883e469c68259072e82b31b4c7a5893ebbccc4`  
		Last Modified: Fri, 02 Feb 2024 09:53:42 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:0e95cf5bc43d84a0ffa27ee8ddb5570e0cb01cb897bf3e6960155e25d51ea284
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **366.4 MB (366426752 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d622ced72476d2990a593f79fe5f5c3c7c572b1f34bf0334d8688530e8729cc`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 02 Feb 2024 09:08:53 GMT
ENV GRADLE_VERSION=8.5
# Fri, 02 Feb 2024 09:08:53 GMT
ARG GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
# Fri, 02 Feb 2024 09:09:00 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Fri, 02 Feb 2024 09:09:03 GMT
USER gradle
# Fri, 02 Feb 2024 09:09:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Fri, 02 Feb 2024 09:09:04 GMT
USER root
...
-	Layers:
	...
	-	`sha256:82bac0b14a95377bb0a84099cb3bb2f395dadd62bfb0776fd640e2714343b828`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:121d76e969ce33512ad784d8f6436a9481c8072e6bd4a11f8bb6d80422fc1f14`  
		Last Modified: Fri, 02 Feb 2024 09:26:27 GMT  
		Size: 132.5 MB (132544694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78972d64efda8f7c44a3fb8d723343333972603bbc29d62175cc85cad909e221`  
		Last Modified: Fri, 02 Feb 2024 09:26:20 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
