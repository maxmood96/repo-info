...
### `gradle:8.14.1-jdk21-jammy` - linux; amd64
...
### `gradle:8.14.1-jdk21-jammy` - unknown; unknown
...
### `gradle:8.14.1-jdk21-jammy` - linux; arm64 variant v8
...
### `gradle:8.14.1-jdk21-jammy` - linux; ppc64le
...
### `gradle:8.14.1-jdk21-jammy` - linux; s390x
