...
### `gradle:9.1-jdk-lts-and-current-corretto` - linux; amd64
...
### `gradle:9.1-jdk-lts-and-current-corretto` - unknown; unknown
...
### `gradle:9.1-jdk-lts-and-current-corretto` - linux; arm64 variant v8
