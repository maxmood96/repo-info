## `gradle:8.12.0-jdk21-graal-jammy`

```console
$ docker pull gradle@sha256:886e1911155d9b54901243dcefa9008e18cdc3bbcdaf866409b6a4a0437f2313
```
...
### `gradle:8.12.0-jdk21-graal-jammy` - linux; amd64
...
### `gradle:8.12.0-jdk21-graal-jammy` - unknown; unknown
