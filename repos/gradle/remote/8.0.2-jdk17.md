...
```console
$ docker pull gradle@sha256:7d5637d4d37df78ffec071b949e4705d0da64a7fa42b178d94efaaafdf20209a
```
...
### `gradle:8.0.2-jdk17` - linux; amd64

```console
$ docker pull gradle@sha256:93e09b55c0ffbda35f7105510227409a55eb9242f1f723467d4a81c8670cc357
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **415.5 MB (415457139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:046a3066e7b2aeac8b9e2b46ef50ca075b1d3bffe80819a2e6324ecf3fc6a4df`
...
-	Layers:
	...
	-	`sha256:f052889b9cf4bbd6d3738ce47988305c9ca466d2332083415a8bfd1a97b37d3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbb056ff961afa9c6c002ce4134fc960f4c4948940edb2bb5cfa82f3f28fc419`  
		Last Modified: Thu, 16 Mar 2023 06:24:13 GMT  
		Size: 124.1 MB (124141194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.0.2-jdk17` - linux; arm variant v7

```console
$ docker pull gradle@sha256:af6aa53db9caa07b5839ab83800d1390964ac474cb9ca056dfddebd551fc5961
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **411.3 MB (411292529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59bd9dc967d0737dbc6fa280da962660c64e527c7e10a6202ebe490f67a50b2e`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:27:20 GMT
ENV GRADLE_VERSION=8.0.2
# Thu, 16 Mar 2023 05:27:20 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Thu, 16 Mar 2023 05:27:25 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:174d675ca8eeaab6ed8c3ebe03456088b8f47dc375eb55e0416f691614e21da6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05399118793b912dd65a68efd9133c59ce65f2c2c0ec0c4342f17f95cde6e0c3`  
		Last Modified: Thu, 16 Mar 2023 05:38:52 GMT  
		Size: 124.1 MB (124141163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.0.2-jdk17` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:f24bb2ad62ecce7feb4b7b89b260eb5065de18ba2e72077318316b10f83ed44e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **413.2 MB (413220305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8cbd6700e3a40b8c75bcd548ba34e2c740d76a64554a742b46f2b3fe8f82891`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 16 Mar 2023 05:21:45 GMT
ENV GRADLE_VERSION=8.0.2
# Thu, 16 Mar 2023 05:21:45 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Thu, 16 Mar 2023 05:21:49 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:a2b1692fbe1b8fa5e387da653507df5822629c290762e64c81a863bf0c686cad`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:103c3ba35491db8317ab43f2bbf7b32507eafa80ff082c863e4467c146066a92`  
		Last Modified: Thu, 16 Mar 2023 05:28:38 GMT  
		Size: 124.1 MB (124141204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.0.2-jdk17` - linux; ppc64le

```console
$ docker pull gradle@sha256:63fa3e5445e5d5d651d9ce1be68244a1cd6c5873c666dbc2e3899f03bdea1635
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **425.6 MB (425594628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31932aa2676a55bbbfb6a60c36174b759901890fb58d032ec0507b01cc7914dc`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 03 Mar 2023 23:23:50 GMT
ENV GRADLE_VERSION=8.0.2
# Fri, 03 Mar 2023 23:23:50 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Fri, 03 Mar 2023 23:24:02 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:0b581e38707a3f8f83b4a41218c3908bf4d4d543ca9eb47d6daebf45659ac8c7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8fac14b816678543460206bc1db137230aa1f8f43fdeb97abce97fc6c6f25f3`  
		Last Modified: Fri, 03 Mar 2023 23:36:22 GMT  
		Size: 124.1 MB (124141176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:8.0.2-jdk17` - linux; s390x

```console
$ docker pull gradle@sha256:f6199fcd8067e67e4a1e075a0b50fbaa77094b102ecaa01b3cf9edac5d0edffd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **401.0 MB (400994452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b35bc95b1d0e5391aebc0489e2753f976b20746badeb31570919d427aaccc282`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Fri, 03 Mar 2023 23:49:21 GMT
ENV GRADLE_VERSION=8.0.2
# Fri, 03 Mar 2023 23:49:21 GMT
ARG GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
# Fri, 03 Mar 2023 23:49:28 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=ff7bf6a86f09b9b2c40bb8f48b25fc19cf2b2664fd1d220cd7ab833ec758d0d7
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:25ec6d8b4c5c42591371bfce6af48d7880f11be5901ef51e2a8330458d1835a7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a68d0b82d26a65b6e31cb57d51cb12fb05f5f288981435f01d5cd4d22a53db80`  
		Last Modified: Fri, 03 Mar 2023 23:56:57 GMT  
		Size: 124.1 MB (124141249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
