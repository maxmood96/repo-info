## `gradle:9.0.0-jdk-lts-and-current-alpine`
...
### `gradle:9.0.0-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:9.0.0-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:9.0.0-jdk-lts-and-current-alpine` - linux; arm64 variant v8
