...
```console
$ docker pull gradle@sha256:da89087d6f60ab749409fd5ed7bb5bcac4fb85519e8ac7d756efa367325327aa
```
...
```console
$ docker pull gradle@sha256:faac3777c0e28fe6bb25742198c8d24c9452d600763dcbf618a3e1b170e158d3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.9 MB (336917053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78854f47ed7f7b870d83cb0a82ff421b04664a159d0fd90b101a20556d52dc54`
...
-	Layers:
	...
	-	`sha256:288004dbfc2e2472de0ec7518d950355107652e2e5a5ef268875a8745c34cb01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1ab7dad7dc8f38d0787822bfd4f76a00810f970e7050172a376316fe08254fa`  
		Last Modified: Sat, 02 Dec 2023 06:26:47 GMT  
		Size: 122.3 MB (122346903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da4087738542a060b3d089ad8beb206b505ee39f367f7251c2e3d8fd3fbb4ed9`  
		Last Modified: Sat, 02 Dec 2023 06:26:41 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:7bf14195f5ceb48c4b38fa0cb571c347fd794366e28c14d22e6350156255c99f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.9 MB (321933927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:096601c698b23056113cf8557549594fc125884f46011f5c4183f77cc35a78fc`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Sat, 02 Dec 2023 07:46:19 GMT
ENV GRADLE_VERSION=7.6.3
# Sat, 02 Dec 2023 07:46:19 GMT
ARG GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
# Sat, 02 Dec 2023 07:46:24 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Sat, 02 Dec 2023 07:46:24 GMT
USER gradle
...
-	Layers:
	...
	-	`sha256:43121860d48c3d5412582d64fa44480dcf96e7f88b082a6af2642b7fcf177576`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:160efe4a6c5bd3bed104814d04a4ec120a729ccf063eac1ca3d90e33a2a31f68`  
		Last Modified: Sat, 02 Dec 2023 07:52:49 GMT  
		Size: 122.3 MB (122346903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be34c60a98658d68e3298f7f906205edae90bffc91b3af02c8161b505c6f4e78`  
		Last Modified: Sat, 02 Dec 2023 07:52:42 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:4797ab35055652530021c1ed52d373a665666b9bc3dcec238e5db4eae6857774
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.3 MB (334262966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7be38e6e0a6731adcad8356bca8826a9b89b8135f7506adf006d003b22d9298b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Sat, 02 Dec 2023 05:48:42 GMT
ENV GRADLE_VERSION=7.6.3
# Sat, 02 Dec 2023 05:48:42 GMT
ARG GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
# Sat, 02 Dec 2023 05:48:45 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=740c2e472ee4326c33bf75a5c9f5cd1e69ecf3f9b580f6e236c86d1f3d98cfac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
...
-	Layers:
	...
	-	`sha256:fa450e0b41fcaf76e7052269e5d350fdc4a7f1308c919f91602d3018c5e7a97d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8045326d8bb10933c09013025fea3aad2059e8b50d079cc27a7329fdc01a6427`  
		Last Modified: Sat, 02 Dec 2023 05:55:23 GMT  
		Size: 122.3 MB (122346910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8efe199e6df5fdaf25fa37a06655a1e4d9b96b910ac3863ea206cf558c50223e`  
		Last Modified: Sat, 02 Dec 2023 05:55:18 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
