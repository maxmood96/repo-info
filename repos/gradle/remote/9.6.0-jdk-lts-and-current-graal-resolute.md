...
### `gradle:9.6.0-jdk-lts-and-current-graal-resolute` - linux; amd64
...
### `gradle:9.6.0-jdk-lts-and-current-graal-resolute` - unknown; unknown
...
### `gradle:9.6.0-jdk-lts-and-current-graal-resolute` - linux; arm64 variant v8
