...
### `gradle:8.12.1-noble` - linux; amd64
...
### `gradle:8.12.1-noble` - unknown; unknown
...
### `gradle:8.12.1-noble` - linux; arm64 variant v8
...
### `gradle:8.12.1-noble` - linux; ppc64le
...
### `gradle:8.12.1-noble` - linux; riscv64
...
### `gradle:8.12.1-noble` - linux; s390x
