...
### `gradle:8.14.2-jdk8-jammy` - linux; amd64
...
### `gradle:8.14.2-jdk8-jammy` - unknown; unknown
...
### `gradle:8.14.2-jdk8-jammy` - linux; arm variant v7
...
### `gradle:8.14.2-jdk8-jammy` - linux; arm64 variant v8
...
### `gradle:8.14.2-jdk8-jammy` - linux; ppc64le
