...
### `gradle:8.14.0-jdk-lts-and-current-graal` - linux; amd64
...
### `gradle:8.14.0-jdk-lts-and-current-graal` - unknown; unknown
...
### `gradle:8.14.0-jdk-lts-and-current-graal` - linux; arm64 variant v8
