...
```console
$ docker pull gradle@sha256:85d7d75002bc57946fb3822ddf8e2ddd9d8541b5834bdfc025bde1b22a2b5b77
```
...
### `gradle:9.5.0-jdk21-ubi` - linux; amd64
...
### `gradle:9.5.0-jdk21-ubi` - unknown; unknown
...
### `gradle:9.5.0-jdk21-ubi` - linux; arm64 variant v8
...
### `gradle:9.5.0-jdk21-ubi` - linux; ppc64le
...
### `gradle:9.5.0-jdk21-ubi` - linux; s390x
