...
```console
$ docker pull gradle@sha256:6b84a884c4379f290a0027e0e74f4fab26146eca13f41ef341676c8fc4bb8a0b
```
...
### `gradle:6.9.0-jdk` - linux; amd64

```console
$ docker pull gradle@sha256:1801bf795a1962d0549ab1a3bb97ece18c838a017f4842b122709f01525506c8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.9 MB (321890876 bytes)**  
...
-	Layers:
	...
	-	`sha256:936bc560e474fee4c9ad34dcbebfe7a9ee1f05756aee014fbb67801fac1e2992`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f57a1a23c95b233b0d46bef72b0feadd0621a1a1bcd4940881ae552b6e558281`  
		Last Modified: Mon, 10 May 2021 18:58:07 GMT  
		Size: 108.1 MB (108149191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9.0-jdk` - linux; arm64 variant v8

```console
$ docker pull gradle@sha256:1921d27dd82b55244cf731cd4711153e69a53199a975bd3099df93d677014e39
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.5 MB (319456795 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e270e39af5b02f3b37991614fc8565d1f885fc586aa56b3a3d94e7849c54242`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Tue, 15 Jun 2021 17:47:54 GMT
ENV GRADLE_VERSION=6.9
# Tue, 15 Jun 2021 17:47:55 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Tue, 15 Jun 2021 17:47:59 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:15bbd8318c32b3d0e9a70d7fbff846e54acc08bcfe569708acbd8ffd2d0df8d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f56caa4279df6f2319716ceb25a8d05bcec2cb8fa8ee1aadf959fe5400f9d50`  
		Last Modified: Tue, 15 Jun 2021 18:05:08 GMT  
		Size: 108.1 MB (108149200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:6.9.0-jdk` - linux; ppc64le
...
### `gradle:6.9.0-jdk` - linux; s390x

```console
$ docker pull gradle@sha256:29d71d9a65bc398cb51594d42832adfe45983853b421c9136ab551ecd3f26e32
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.5 MB (314491360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7c669dda75074a1846e4acab91ccb3be15e09a47a8a3ae46a1ce227f8518d10`
-	Default Command: `["gradle"]`
...
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Mon, 10 May 2021 18:46:40 GMT
ENV GRADLE_VERSION=6.9
# Mon, 10 May 2021 18:46:41 GMT
ARG GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
# Mon, 10 May 2021 18:47:01 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=765442b8069c6bee2ea70713861c027587591c6b1df2c857a23361512560894e
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:0d660cc5571b24d0e67cc69a531fa44001ca3cb9b3361792bcb7e2a381de1042`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c41f83fe307ecdca93b5248cc43dd7d1b5ae6331e01b8043dd54ada41f29fc9b`  
		Last Modified: Mon, 10 May 2021 19:54:57 GMT  
		Size: 108.1 MB (108149197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
