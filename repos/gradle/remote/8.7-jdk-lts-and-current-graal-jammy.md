...
### `gradle:8.7-jdk-lts-and-current-graal-jammy` - linux; amd64
...
### `gradle:8.7-jdk-lts-and-current-graal-jammy` - unknown; unknown
...
### `gradle:8.7-jdk-lts-and-current-graal-jammy` - linux; arm64 variant v8
