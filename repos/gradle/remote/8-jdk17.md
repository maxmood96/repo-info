...
```console
$ docker pull gradle@sha256:813e7292334f11ee55a7bde94689d70a47603f021b322a6bd9bb6e08b855c025
```
...
```console
$ docker pull gradle@sha256:d6df3362b725c15446bd004e16a70b3f2f66319c69906a18f93df31b87d26346
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **376.5 MB (376493283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:056e54adb57dbc128118bfbb28dfb05a762fc3c7d11cb1dacafa6f16de7ce6d9`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 02 May 2024 06:03:52 GMT
ENV GRADLE_VERSION=8.7
# Thu, 02 May 2024 06:03:52 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Thu, 02 May 2024 06:03:56 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 02 May 2024 06:03:57 GMT
USER gradle
# Thu, 02 May 2024 06:03:58 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 02 May 2024 06:03:58 GMT
USER root
...
-	Layers:
	...
	-	`sha256:6c7adae58574dbf3e16a7f041fed1955c8d7f813af6bdfa1509ac6ad5508795e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a700054ec1fac788e161deef7aae5048d059fef325d7d2593206e114bf33edb`  
		Last Modified: Thu, 02 May 2024 06:09:17 GMT  
		Size: 134.2 MB (134209800 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a4acc84ef015070f1543d3f882f4446b60765d079bcae7ad5672a14515e6a2c`  
		Last Modified: Thu, 02 May 2024 06:09:12 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:bf2851c3e13fb9aca3e754918ecc57c82d8a502dd5da43a7ad1974d1583d56bd
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **389.0 MB (388998054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c24aeb265db3615c8e25180c77fba1b8d8d7c0647f63cf5e648e2ea24aa909f2`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Thu, 02 May 2024 05:23:03 GMT
ENV GRADLE_VERSION=8.7
# Thu, 02 May 2024 05:23:04 GMT
ARG GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
# Thu, 02 May 2024 05:23:11 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Thu, 02 May 2024 05:23:14 GMT
USER gradle
# Thu, 02 May 2024 05:23:17 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=544c35d6bd849ae8a5ed0bcea39ba677dc40f49df7d1835561582da2009b961d
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Thu, 02 May 2024 05:23:17 GMT
USER root
...
-	Layers:
	...
	-	`sha256:ca811e73b679e8400699b2f278b58bf52ab70bd4e9c6415d950a644009f429e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:890252d77d1229e8dc9ff6e313d2c5a663e035c31a28bddafcc0b165d0aad0da`  
		Last Modified: Thu, 02 May 2024 05:31:31 GMT  
		Size: 134.2 MB (134209756 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbdd1c44c02e1ff41f2b693e75fc8ae01680a4cc510fb9d0a9591f1dd466577d`  
		Last Modified: Thu, 02 May 2024 05:31:23 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
