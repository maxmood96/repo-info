...
```console
$ docker pull gradle@sha256:986db46ad250b9374086e352a1ab82b69b5754ec8149b93821a777b4a86ad93a
```
...
```console
$ docker pull gradle@sha256:549bbdc8a385d7af5023d4954b392e3f164fb68de9e362d9ff3275ff4360c64f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.8 MB (364843030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:570015cc3efcdb9056b0ef808ac7b0c72e6bed9d100866d889bf5e477e8dff96`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 06 Mar 2024 13:47:13 GMT
ENV GRADLE_VERSION=7.6.4
# Wed, 06 Mar 2024 13:47:13 GMT
ARG GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
# Wed, 06 Mar 2024 13:47:17 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 13:47:17 GMT
USER gradle
# Wed, 06 Mar 2024 13:47:18 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 13:47:18 GMT
USER root
...
-	Layers:
	...
	-	`sha256:80c6f699bed74dee0803b97130e88be1cefca116acf88dbc41f2fa9a2011042a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23d1c3f0b672b9f2e321e383fd6870b81f62956d34e52589b8daa34f3cacc170`  
		Last Modified: Wed, 06 Mar 2024 13:54:39 GMT  
		Size: 122.7 MB (122730256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd826c59901116f67ab5da09a082e3d1ef5dc7384f4961b675466fd6405650a0`  
		Last Modified: Wed, 06 Mar 2024 13:54:34 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:53205b89eab88a9320f57a76a1faf677875d837b77b099af2aa9b9d2487eea3a
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **377.4 MB (377394325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc0f30769be18b252391ec46d1cef27c60a1fbb8cf6b096f2377e6843b25e19e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
# Wed, 06 Mar 2024 04:02:28 GMT
ARG GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
# Wed, 06 Mar 2024 04:02:35 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 04:02:37 GMT
USER gradle
# Wed, 06 Mar 2024 04:02:39 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 04:02:39 GMT
USER root
...
-	Layers:
	...
	-	`sha256:23f1221c199effc5ba20370ea48c1c064c70504de8d052d78d838f5d5653047d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52ae94cfca1e1ab655bb24a3c0006e85c883125e2a5cbd7562cb3a0374539235`  
		Last Modified: Wed, 06 Mar 2024 04:11:39 GMT  
		Size: 122.7 MB (122730201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03aaf3f7ed4a2d05c0c2d69a42bb7e9fdc0f2c67ae27fb0109d35b2a6ec4dbc5`  
		Last Modified: Wed, 06 Mar 2024 04:11:33 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull gradle@sha256:d498a3eda5740253397038363829a5d5eab4431d157fcc52805cd1ccb841acc9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.1 MB (354124029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90f5a7521d80d3622fee746b573e5775d4d64e717f3228a4504ce43dc0c31c00`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Wed, 06 Mar 2024 06:36:56 GMT
ENV GRADLE_VERSION=7.6.4
# Wed, 06 Mar 2024 06:36:56 GMT
ARG GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
# Wed, 06 Mar 2024 06:37:01 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking Gradle download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle
# Wed, 06 Mar 2024 06:37:03 GMT
USER gradle
# Wed, 06 Mar 2024 06:37:04 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=bed1da33cca0f557ab13691c77f38bb67388119e4794d113e051039b80af9bb1
RUN set -o errexit -o nounset     && echo "Testing Gradle installation"     && gradle --version
# Wed, 06 Mar 2024 06:37:04 GMT
USER root
...
-	Layers:
	...
	-	`sha256:e57f09fd953870013f6c861e996cebc1201c322cf62495dd5f5624f075879082`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6aeec61a6480b33868caebe038fda47edea420bb3573462f0f8999792061a98e`  
		Last Modified: Wed, 06 Mar 2024 06:47:54 GMT  
		Size: 122.7 MB (122730269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acae1b021349466f2514ab074fef53c31df162cc08eecfa478c6ca2c8f4dbfb9`  
		Last Modified: Wed, 06 Mar 2024 06:47:48 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
