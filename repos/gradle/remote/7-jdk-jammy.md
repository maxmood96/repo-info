...
```console
$ docker pull gradle@sha256:45e06721001366e097384dfa97f6f6e1d11f712c077200299db170179e5764c9
```
...
```console
$ docker pull gradle@sha256:a28e0103d644ab4e00b74e35d5fd30912df8cd7f2b6c7c1f82814d904a7db187
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **366.6 MB (366583464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fe9b1ca9884d5835375bd434333c291a6784b9af7d3dbd0b9747f34dad035f1`
...
-	Layers:
	...
	-	`sha256:820089eab7e5c1feb10fcb5b4013d25fc745225b9057bfde2adb18b4161ebbf1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06f0d07fc655e4b691f212535cc3a7810aa00c72ff7844687228a2339247cb1e`  
		Last Modified: Wed, 16 Aug 2023 17:48:10 GMT  
...
```console
$ docker pull gradle@sha256:2d5815565d79e2b0def7969574eb6ed4a4e6122a0aa588f8a33bdc40f4423c40
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.3 MB (364280632 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb317bda985b890bdae3b4ebb9b3466d1ff0623643d9043d37a13370e06e24b9`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:0c484970394358c05ab63b50addda4d962150411fb692e285effeb3bbae0f5da`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f085a3411b1f498136d00ee10f36f018fd18bd7cbf336cc958e7f83c9d0b5019`  
		Last Modified: Wed, 16 Aug 2023 18:33:38 GMT  
...
```console
$ docker pull gradle@sha256:cf90812659b9ec9a5751fcbc76e4b36b0e2e793e3f80b1756a34aa53cd597102
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **377.1 MB (377092720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0481701df531201032aba4ae07ef8fe343259e0870559cf49e6f2a09ed147104`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && apt-get update     && apt-get install --yes --no-install-recommends         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm --recursive --force /var/lib/apt/lists/*         && echo "Testing VCSes"     && which bzr     && which git     && which git-lfs     && which hg     && which svn
# Mon, 14 Aug 2023 19:16:42 GMT
ENV GRADLE_VERSION=7.6.2
# Mon, 14 Aug 2023 19:16:42 GMT
ARG GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
# Mon, 14 Aug 2023 19:16:54 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=a01b6587e15fe7ed120a0ee299c25982a1eee045abd6a9dd5e216b2f628ef9ac
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:c7276e78f0d140175c7971d32357278d585cc91b27c3ca1f5df91c24cb10e4b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75b4a9e0457284df9d5cabc69e6836c726822f3b2810a8077f0a5c943034e599`  
		Last Modified: Mon, 14 Aug 2023 19:29:44 GMT  
		Size: 122.3 MB (122344637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `gradle:7-jdk-jammy` - linux; s390x

```console
$ docker pull gradle@sha256:9918b7fed32e61725e6c8adab50e95da3acf3b0bd2aa0415468387338d6bc218
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.8 MB (353756003 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6e41f9f4c3a2d17184d0648a712f514b78b037e0c353f4ddffaba9cdc36dd69`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:3aae415a3e0c5a3a5c2c6285728c367050c5bb036c8575f577045fd89de3cfe4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc5650d7917a704b352ff961c826f52032e7b043a8e3e3b339397682d7452697`  
		Last Modified: Wed, 16 Aug 2023 17:40:05 GMT  
