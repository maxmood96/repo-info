...
```console
$ docker pull gradle@sha256:b0a947e70dc3f7ccc7d35b3a3317af6a68aa82d56dbcc52cebc54ddc28f99696
```
...
```console
$ docker pull gradle@sha256:1d54fbb30586719ea1789f5bf3b35ef8b4f46ce1a1e7e238fac95f42633886b0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.7 MB (367730535 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:910e1386b293b247a45f992561e4eb4df60d6e232f8875e0e049663483beee7c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["gradle"]`
...
-	Layers:
	...
	-	`sha256:a9e52afb7a8b9b24b78a4e088da1e3ffc15fa528778b06547981afd47e3678cb`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a004396e85edbdb5ebacf805a1f246e1936e6093afd21849ae67207a626aabeb`  
		Last Modified: Wed, 23 Apr 2025 18:15:03 GMT  
		Size: 122.7 MB (122730529 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:aa938bf39607ecef9dc652d441b3bdefa1f50302e92c624db9bd9bc03ab7cc6e`  
...
```console
$ docker pull gradle@sha256:229cb3e3d280f2c12540ab3026a44b7018e9353057109d389c8365cf8645121a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7439420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5883165dda81559c9ab1d9da4480e09808f6867b80add0530495373eb26a469`

```dockerfile
```

-	Layers:
	-	`sha256:8d8880b5264ad0e82de363e406de164dc3918682f96ff467652cfcf548aa3857`  
		Last Modified: Wed, 23 Apr 2025 18:15:00 GMT  
		Size: 7.4 MB (7416162 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:285dd95d8ff0e25e4e6a3fc79caa570b2e8a354ed710dc57135a14d746182d2b`  
