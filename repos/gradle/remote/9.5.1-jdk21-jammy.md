...
### `gradle:9.5.1-jdk21-jammy` - linux; amd64
...
### `gradle:9.5.1-jdk21-jammy` - unknown; unknown
...
### `gradle:9.5.1-jdk21-jammy` - linux; arm64 variant v8
...
### `gradle:9.5.1-jdk21-jammy` - linux; ppc64le
...
### `gradle:9.5.1-jdk21-jammy` - linux; s390x
