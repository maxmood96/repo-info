...
```console
$ docker pull gradle@sha256:59b9e439fcc818b43538aabfda996b175515cb0461688ade02549501a15befac
```
...
### `gradle:6.8-openj9` - linux; arm64 variant v8
...
```console
$ docker pull gradle@sha256:8145bf8f2511d1c6caf6d2915b966f42ed3c80a98c94dd44bbfa13fa29a6326a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.0 MB (351015725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:653fa235ea0069f3d202e05002a57a19dbd38476c35f0844aa01f81cc49ba1c2`
-	Default Command: `["gradle"]`
...
RUN set -o errexit -o nounset     && echo "Adding gradle user and group"     && groupadd --system --gid 1000 gradle     && useradd --system --gid gradle --uid 1000 --shell /bin/bash --create-home gradle     && mkdir /home/gradle/.gradle     && chown --recursive gradle:gradle /home/gradle         && echo "Symlinking root Gradle cache to gradle Gradle cache"     && ln -s /home/gradle/.gradle /root/.gradle
# Tue, 27 Apr 2021 23:18:32 GMT
VOLUME [/home/gradle/.gradle]
# Tue, 27 Apr 2021 23:18:37 GMT
WORKDIR /home/gradle
# Tue, 27 Apr 2021 23:22:40 GMT
RUN apt-get update     && apt-get install --yes --no-install-recommends         fontconfig         unzip         wget                 bzr         git         git-lfs         mercurial         openssh-client         subversion     && rm -rf /var/lib/apt/lists/*
# Wed, 28 Apr 2021 00:09:08 GMT
ENV GRADLE_VERSION=6.8.3
# Wed, 28 Apr 2021 00:09:11 GMT
ARG GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
# Wed, 28 Apr 2021 00:10:27 GMT
# ARGS: GRADLE_DOWNLOAD_SHA256=7faa7198769f872826c8ef4f1450f839ec27f0b4d5d1e51bade63667cbccd205
RUN set -o errexit -o nounset     && echo "Downloading Gradle"     && wget --no-verbose --output-document=gradle.zip "https://services.gradle.org/distributions/gradle-${GRADLE_VERSION}-bin.zip"         && echo "Checking download hash"     && echo "${GRADLE_DOWNLOAD_SHA256} *gradle.zip" | sha256sum --check -         && echo "Installing Gradle"     && unzip gradle.zip     && rm gradle.zip     && mv "gradle-${GRADLE_VERSION}" "${GRADLE_HOME}/"     && ln --symbolic "${GRADLE_HOME}/bin/gradle" /usr/bin/gradle         && echo "Testing Gradle installation"     && gradle --version
```
...
-	Layers:
	...
	-	`sha256:a36974c5caa4183fa5ad4525d1a01b72d26812b04ae369d57c4b1f8a3c73387c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:500ae9d7d4eb9490e06191e3dba5c7ed55c2fc2d0491545be0c934014e69a97b`  
		Last Modified: Wed, 28 Apr 2021 00:33:48 GMT  
		Size: 4.4 KB (4380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a536a1124b88cc47a44706a6745707314809b899d22b9848c1bddf9e217ac45`  
		Last Modified: Wed, 28 Apr 2021 00:35:34 GMT  
		Size: 74.0 MB (73973798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa016e7f5487b579f5a9d024219c0ac236fde3969e9b98d2576d0531e4f0a135`  
		Last Modified: Wed, 28 Apr 2021 00:49:27 GMT  
		Size: 107.9 MB (107863148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
