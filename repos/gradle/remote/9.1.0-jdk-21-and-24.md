...
### `gradle:9.1.0-jdk-21-and-24` - linux; amd64
...
### `gradle:9.1.0-jdk-21-and-24` - unknown; unknown
...
### `gradle:9.1.0-jdk-21-and-24` - linux; arm64 variant v8
...
### `gradle:9.1.0-jdk-21-and-24` - linux; ppc64le
...
### `gradle:9.1.0-jdk-21-and-24` - linux; riscv64
...
### `gradle:9.1.0-jdk-21-and-24` - linux; s390x
