## `gradle:9.0.0-jdk-21-and-24-alpine`
...
### `gradle:9.0.0-jdk-21-and-24-alpine` - linux; amd64
...
### `gradle:9.0.0-jdk-21-and-24-alpine` - unknown; unknown
...
### `gradle:9.0.0-jdk-21-and-24-alpine` - linux; arm64 variant v8
