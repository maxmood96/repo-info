## `gradle:8.8.0-jdk-lts-and-current-alpine`
...
### `gradle:8.8.0-jdk-lts-and-current-alpine` - linux; amd64
...
### `gradle:8.8.0-jdk-lts-and-current-alpine` - unknown; unknown
...
### `gradle:8.8.0-jdk-lts-and-current-alpine` - linux; arm64 variant v8
