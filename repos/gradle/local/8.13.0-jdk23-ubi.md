...
### `rpm` package: `git-lfs-3.4.1-4.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url git-lfs-3.4.1-4.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-lfs-3.4.1-4.el9_5.src.rpm
```
