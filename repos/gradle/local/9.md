...
- Created: `2026-06-22T18:05:58.166764996Z`
- Virtual Size: ~ 790.71 Mb  
...
### `dpkg` source package: `breezy=3.3.21-1build1`
...
```console
$ apt-get source -qq --print-uris breezy=3.3.21-1build1
'http://archive.ubuntu.com/ubuntu/pool/universe/b/breezy/breezy_3.3.21.orig.tar.gz' breezy_3.3.21.orig.tar.gz 9385932 SHA256:6a8edaddc6ea4e225d18cd8e9247fbd022d02278380b6fb4d304c8227cc3fba9
'http://archive.ubuntu.com/ubuntu/pool/universe/b/breezy/breezy_3.3.21-1build1.debian.tar.xz' breezy_3.3.21-1build1.debian.tar.xz 76208 SHA256:7051e92848f3a6f2a2d535a226b2b5135e03e87463639b24f82a9dfb744c6df5
'http://archive.ubuntu.com/ubuntu/pool/universe/b/breezy/breezy_3.3.21-1build1.dsc' breezy_3.3.21-1build1.dsc 3090 SHA256:15a640dfbfdb17eb3896a51fb305963bf7533cc3ee9a630d7b1e67e438fb7563
```
...
### `dpkg` source package: `configobj=5.0.9-1build1`
...
```console
$ apt-get source -qq --print-uris configobj=5.0.9-1build1
'http://archive.ubuntu.com/ubuntu/pool/main/c/configobj/configobj_5.0.9.orig.tar.gz' configobj_5.0.9.orig.tar.gz 98246 SHA256:2bd70f9ce7912679c4ba9c80da289877906db0ca6bd02c3ab545d660e9b60d4f
'http://archive.ubuntu.com/ubuntu/pool/main/c/configobj/configobj_5.0.9-1build1.debian.tar.xz' configobj_5.0.9-1build1.debian.tar.xz 7080 SHA256:9d263c56f6475c236ee18b56f25d7617e405c69dcb40d6b2ffdd8266c0478433
'http://archive.ubuntu.com/ubuntu/pool/main/c/configobj/configobj_5.0.9-1build1.dsc' configobj_5.0.9-1build1.dsc 2358 SHA256:06779d009a9fc43b93bcb64de7b5e9c32302f5e591b47c44c5c92e6a1cd81401
```
...
### `dpkg` source package: `dulwich=1.1.0-3`
...
```console
$ apt-get source -qq --print-uris dulwich=1.1.0-3
'http://archive.ubuntu.com/ubuntu/pool/universe/d/dulwich/dulwich_1.1.0-3.dsc' dulwich_1.1.0-3.dsc 2245 SHA256:8c063db6d8ab10084b80f40ab655e7290e181f37c36dbcb5a6bb3f237dd3adc2
'http://archive.ubuntu.com/ubuntu/pool/universe/d/dulwich/dulwich_1.1.0.orig.tar.gz' dulwich_1.1.0.orig.tar.gz 1171020 SHA256:97bd7c95a392881f2ae5d1bb775c4614ba34cf50df08653db00ad105b889fb59
'http://archive.ubuntu.com/ubuntu/pool/universe/d/dulwich/dulwich_1.1.0-3.debian.tar.xz' dulwich_1.1.0-3.debian.tar.xz 10188 SHA256:06da5c9394271a72dfa971a712d7299382f3c9d72181ccca040de8de39a84787
```
...
### `dpkg` source package: `git-lfs=3.7.1-1`
...
```console
$ apt-get source -qq --print-uris git-lfs=3.7.1-1
'http://archive.ubuntu.com/ubuntu/pool/universe/g/git-lfs/git-lfs_3.7.1-1.dsc' git-lfs_3.7.1-1.dsc 2778 SHA256:06b9064f2975613c5fce17e96e768657f27c59825d19b86d0a3c37be9a1725b8
'http://archive.ubuntu.com/ubuntu/pool/universe/g/git-lfs/git-lfs_3.7.1.orig.tar.gz' git-lfs_3.7.1.orig.tar.gz 713950 SHA256:0e83566a9e2477e03627e7fd6bf81f01fadbf93dcaf6abd2686fca90f6bac7dd
'http://archive.ubuntu.com/ubuntu/pool/universe/g/git-lfs/git-lfs_3.7.1-1.debian.tar.xz' git-lfs_3.7.1-1.debian.tar.xz 4732 SHA256:661101b49b4e39175703e93a5c2b6bb27468d2242867ad422516b55a0fc91771
```
...
### `dpkg` source package: `patiencediff=0.2.13-1build6`
...
```console
$ apt-get source -qq --print-uris patiencediff=0.2.13-1build6
'http://archive.ubuntu.com/ubuntu/pool/universe/p/patiencediff/patiencediff_0.2.13.orig.tar.gz' patiencediff_0.2.13.orig.tar.gz 25865 SHA256:c4acceb3918ec612e7818a11de83db4b797d561fe957feed4f3d9acadacbd1cd
'http://archive.ubuntu.com/ubuntu/pool/universe/p/patiencediff/patiencediff_0.2.13-1build6.debian.tar.xz' patiencediff_0.2.13-1build6.debian.tar.xz 43388 SHA256:cc027d7669ac004d874bfc03fc466324ecc68af494a0eda579d803ca5ae14b34
'http://archive.ubuntu.com/ubuntu/pool/universe/p/patiencediff/patiencediff_0.2.13-1build6.dsc' patiencediff_0.2.13-1build6.dsc 2135 SHA256:cd6a977d5fc4aaac2756544b7e3776b47890887dae7c3e1788290c5ff2d0f58f
```
...
### `dpkg` source package: `python-fastbencode=0.3.8-1build1`
...
```console
$ apt-get source -qq --print-uris python-fastbencode=0.3.8-1build1
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-fastbencode/python-fastbencode_0.3.8.orig.tar.gz' python-fastbencode_0.3.8.orig.tar.gz 20352 SHA256:5e68a01eca1fbedc95d8d93860ce0ffd1685962db0e4bbda0d9622cbd4f931d9
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-fastbencode/python-fastbencode_0.3.8-1build1.debian.tar.xz' python-fastbencode_0.3.8-1build1.debian.tar.xz 37304 SHA256:0be538cf453d7a50326c9595a7f49b90dd38998867cc63075303d4fa912f4367
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-fastbencode/python-fastbencode_0.3.8-1build1.dsc' python-fastbencode_0.3.8-1build1.dsc 2302 SHA256:2ce7f2d7491774dab72b57a9fc0f13ea7254f254bb2a0574f49089466ca2cd45
```

### `dpkg` source package: `python-merge3=0.0.8-1build1`
...
```console
$ apt-get source -qq --print-uris python-merge3=0.0.8-1build1
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-merge3/python-merge3_0.0.8.orig.tar.gz' python-merge3_0.0.8.orig.tar.gz 15772 SHA256:850dee369a4973591bf65e130d0485dc5b35b0cec131a227644ab907ef61334c
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-merge3/python-merge3_0.0.8-1build1.debian.tar.xz' python-merge3_0.0.8-1build1.debian.tar.xz 624260 SHA256:5bf7552cf382e7616a8ba9a76481f873f5bdc47b4121ad753862c10d90f13581
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-merge3/python-merge3_0.0.8-1build1.dsc' python-merge3_0.0.8-1build1.dsc 2056 SHA256:4f41ce6c079b86b9514a05e7710b06a9ad9e81d5254d54ddbdd071e4ba66afe7
```

### `dpkg` source package: `python-tzlocal=5.3.1-2`
...
```console
$ apt-get source -qq --print-uris python-tzlocal=5.3.1-2
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-tzlocal/python-tzlocal_5.3.1-2.dsc' python-tzlocal_5.3.1-2.dsc 2199 SHA256:f2d6f129ea0ce6d92522e3f17cd74af12e3c7a7d6f75a8e6c3175c351a5139bd
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-tzlocal/python-tzlocal_5.3.1.orig.tar.gz' python-tzlocal_5.3.1.orig.tar.gz 26331 SHA256:3db2c8d811992bb88472aaf7d9bf2d5108367cf959b6b7fe38e3c2b31e7ac91c
'http://archive.ubuntu.com/ubuntu/pool/universe/p/python-tzlocal/python-tzlocal_5.3.1-2.debian.tar.xz' python-tzlocal_5.3.1-2.debian.tar.xz 3656 SHA256:63b03cdf50ea1064cbabfb660aa5ec39ace11b67b621da8cc7824b6860f194f4
```

### `dpkg` source package: `python-urllib3=2.6.3-1ubuntu1.1`
...
```console
$ apt-get source -qq --print-uris python-urllib3=2.6.3-1ubuntu1.1
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-urllib3/python-urllib3_2.6.3.orig.tar.gz' python-urllib3_2.6.3.orig.tar.gz 435556 SHA512:663c83a78908dac9bb05c7ac833183c2fdc2969d0662d21dd8751ba13c51880ee264f7804760f33ebdabfd1c1f04a5d44171a420396de6ae582f9789801b141c
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-urllib3/python-urllib3_2.6.3-1ubuntu1.1.debian.tar.xz' python-urllib3_2.6.3-1ubuntu1.1.debian.tar.xz 41660 SHA512:9530ac9d01af6ff1ff3ab907e781e4ded83bdc985d0e492fc01661885ffe9109c0341693079f2bb57b6b8a5f9c928116fb74a7e6e334701e0b037d6e1b6a0669
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-urllib3/python-urllib3_2.6.3-1ubuntu1.1.dsc' python-urllib3_2.6.3-1ubuntu1.1.dsc 2966 SHA512:72eb9c48be3d5189a04cf9ece7374dce8c68d43f396f40adf0151307e0b69f71e29d6733fe67266f52ec2e8f5d16b96b29e3d79c8d4843e5f34f521a4a6be418
```
...
Licenses: (parsed from: `/usr/share/doc/libpython3.14/copyright`, `/usr/share/doc/libpython3.14-minimal/copyright`, `/usr/share/doc/libpython3.14-stdlib/copyright`, `/usr/share/doc/python3.14/copyright`, `/usr/share/doc/python3.14-minimal/copyright`)
