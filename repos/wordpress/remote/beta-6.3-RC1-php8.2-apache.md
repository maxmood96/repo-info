...
```console
$ docker pull wordpress@sha256:e49bd28f1eef9bc19ac351e179d0240ca8b603e45ea266032db67ee420b618f1
```
...
### `wordpress:beta-6.3-RC1-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.2-apache` - linux; ppc64le
