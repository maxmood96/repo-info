...
```console
$ docker pull wordpress@sha256:8792216e34ab60ab68abdd8aedffc4760c3edfaba6ab7ab824d1ed920ec2a221
```
...
```console
$ docker pull wordpress@sha256:91dc9137f7fe9c40bf9e7a86776f034b6707388b9073bdacb2fdfdd3740d11b4
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.7 MB (61721746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:557a351bb01f6daabbcd313bfa333a33fa6e9c96a95926674f013f09933eedb2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 Dec 2019 23:14:19 GMT
ENV WORDPRESS_VERSION=5.3.1
# Fri, 13 Dec 2019 23:14:20 GMT
ENV WORDPRESS_SHA1=3c635c9f6546782e0bb315784d4663d0e47f872e
# Fri, 13 Dec 2019 23:14:26 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 13 Dec 2019 23:14:27 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 13 Dec 2019 23:14:27 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 13 Dec 2019 23:14:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d868d2e9851aedbc45728f87732e7f80ca46ab4c892d9742a405e29f2c2981d4`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f452a0e757249f04914819864b7c275b3847a87d0616bcb2f5e999f06479852`  
		Last Modified: Fri, 13 Dec 2019 23:19:14 GMT  
		Size: 12.2 MB (12227473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f1b22c87589df82c8b6b696d396eac0342cf43280433646b3ce4da9c6071578`  
		Last Modified: Fri, 13 Dec 2019 23:19:08 GMT  
