...
```console
$ docker pull wordpress@sha256:ec2856c7bfcfda0f98f687470baa7b82e07e9a3ff7101e8f69271fd18c512459
```
...
### `wordpress:6.3.0` - linux; arm variant v5
...
### `wordpress:6.3.0` - linux; arm variant v7
...
### `wordpress:6.3.0` - linux; arm64 variant v8
...
### `wordpress:6.3.0` - linux; mips64le
