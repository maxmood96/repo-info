...
```console
$ docker pull wordpress@sha256:99f99c0428fc970cd683d3dd2c1aaad020037a27cbe8e287e7a7eba3bebb5fff
```
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; amd64
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; 386
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-6.9.1-RC1-php8.4-apache` - linux; s390x
