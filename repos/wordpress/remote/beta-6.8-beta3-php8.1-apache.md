...
```console
$ docker pull wordpress@sha256:869f9cfb76e5280f00d437a5594bd3289d66ab99358fce5a3818d86205ced53f
```
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.8-beta3-php8.1-apache` - linux; s390x
