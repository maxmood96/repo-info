...
```console
$ docker pull wordpress@sha256:92c324ebbada6ed3d7a97100dc2fba819822ea033785043b6bf99014e0dd7c1e
```
...
### `wordpress:6.2.1-php8.0` - linux; amd64
...
### `wordpress:6.2.1-php8.0` - linux; arm variant v7
...
### `wordpress:6.2.1-php8.0` - linux; 386
...
### `wordpress:6.2.1-php8.0` - linux; ppc64le
