...
```console
$ docker pull wordpress@sha256:7a2b624e6fc5f436a342d6a03e1ca1970662d375b28cb3e01bac092d4003b698
```
...
```console
$ docker pull wordpress@sha256:25e21565f11e3d4d675d27e073743b51ea00ad7974893e9b431c9e0d00bbe526
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.0 MB (257011392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14fea9681ce1db5ca2087ef23f272fefa7bda394c41d5a7f4f868aa60ec6de8`
...
-	Layers:
	...
	-	`sha256:d9ab1bb14267995a1bc0b1bad71a711514ae7169bb291e4f6beb84e75882c4bb`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aabc30231d1306023c27f06d688497deb38bbc55b75fb00a1b7518554d309c07`  
		Last Modified: Thu, 12 Oct 2023 19:30:09 GMT  
		Size: 27.0 MB (27048681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e66713278f30de3bbec7123764418b95b36b12c901841de6f77cd0e77d6cbaa`  
		Last Modified: Thu, 12 Oct 2023 19:30:07 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3fbab12512efae377527eb121476ee1ed5085e96ac80407a4e23ccf91c4274f`  
		Last Modified: Thu, 12 Oct 2023 19:30:06 GMT  
...
```console
$ docker pull wordpress@sha256:a1d24f3b762080b319adff0dee91a79065bb400ba6dd6be3b247d64a7097fc4c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.2 MB (227220663 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adb4a1f3943bb02ced3cd7303d9bc6cc6d738ff67f95078e5db27efab7ee6fcb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:28cdc3ba2e082d21090827644242f8a9562a7ef18dc2e6dc627dfb7f888e744a`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e79333fe7e76ff4cbf5610c5d28d22cfaf36f5e0d9c865da733f5a01abd0ac4`  
		Last Modified: Thu, 12 Oct 2023 09:41:13 GMT  
		Size: 27.0 MB (27048652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42c1ddfd6642d02afb37d67bb88c7111ed166761f08b0852339bff856ffe5fe8`  
		Last Modified: Thu, 12 Oct 2023 09:41:09 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc3d4093e0ed28cf1aa522c785cbb6d6cbed7e4a6dd461205316d728c446bc53`  
		Last Modified: Thu, 12 Oct 2023 09:41:09 GMT  
...
```console
$ docker pull wordpress@sha256:f325dcf34ba533c50f0221d7095b81ebf4371dc591cfda483a68c7910a20fc7e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.1 MB (216115606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09d9bf3159e1c239bec4979fd3ce964d4a817be1519e5e95df0fca2fe3321d21`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 12 Oct 2023 06:55:11 GMT
RUN set -eux; 	version='6.4-beta3'; 	sha1='4a7afbbbfc06f6601bd00dc6287a268b82650ca5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 12 Oct 2023 06:55:11 GMT
VOLUME [/var/www/html]
# Thu, 12 Oct 2023 06:55:12 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 12 Oct 2023 06:55:12 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 12 Oct 2023 06:55:12 GMT
...
-	Layers:
	...
	-	`sha256:7c66d9a645314b66085987c477bb6e7b4f60e8aba08d3d98348966431a39cd03`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3053b4950310c4c8ebc2aa98c2a2ef77eded2ab0e5e95d1e8dcb44910098e818`  
		Last Modified: Thu, 12 Oct 2023 07:03:33 GMT  
		Size: 27.0 MB (27048648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:034db0c0763bed5ec7af5939e6c8340de70092a65677b08a8175691880be4cc8`  
		Last Modified: Thu, 12 Oct 2023 07:03:28 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57153e3485a1528f62adf37e2bac7855b8d2bc3a9a9c5d97eb7e2f0c964a03b3`  
		Last Modified: Thu, 12 Oct 2023 07:03:28 GMT  
...
```console
$ docker pull wordpress@sha256:d27ad3dca3e30ee5f15cda1dc80f3f1f5a6b5dc859e33054d4e8ff6ff46e6e87
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.3 MB (248348015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e2684a486a4588b186fe3b739eefca50a172198dc3e6b0506c4c23a8fa6fd10`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:31460147674b021de00399f69d4a13d96866cd0fd0e365850b4218fc4ad707fe`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17c0b8d1f05b0cc7830952ba394c16ea85965a6552c74c175509e05c4a4caec`  
		Last Modified: Thu, 12 Oct 2023 19:29:58 GMT  
		Size: 27.0 MB (27048649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aadd434ef2cd2f791cec48ba9ce9a71f2feecb6a2c58943fca1bdc4f8ce3e58`  
		Last Modified: Thu, 12 Oct 2023 19:29:56 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6889aa320bd4caa8e6c4c442ef7a0b2246812b8eacca38ef9a42cbe01cf8a6b0`  
		Last Modified: Thu, 12 Oct 2023 19:29:56 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:072f4ea1bb7012ec2cbfbe3e98f41c47276bab88f60bc782ef8840c279f427ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.6 MB (255556349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfbd82fcc3579850103ac42df143439dd54f33bb3d46fc360b4cdf7f9814bbf5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 12 Oct 2023 19:09:06 GMT
RUN set -eux; 	version='6.4-beta3'; 	sha1='4a7afbbbfc06f6601bd00dc6287a268b82650ca5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 12 Oct 2023 19:09:07 GMT
VOLUME [/var/www/html]
# Thu, 12 Oct 2023 19:09:07 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 12 Oct 2023 19:09:07 GMT
...
-	Layers:
	...
	-	`sha256:57eb6f2874bde9906546fec26a0539a081e76e2a79de33ccc9695796d207d48c`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feb3ec37131ab73ca9d60730e01afb2046dcc0f0dc3636472c20cd33bec07537`  
		Last Modified: Thu, 12 Oct 2023 19:17:55 GMT  
		Size: 27.0 MB (27048684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be852f4b3aafd4fe67337e61c4d3f6c346cc60f53e4cd4a8632db5e5408debe6`  
		Last Modified: Thu, 12 Oct 2023 19:17:49 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8a0ae463e203bf80da87ea25688e9cee4f89f5fabd526bd60e3c9b1ecbefdf4`  
		Last Modified: Thu, 12 Oct 2023 19:17:49 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:939dac614d318040eb07c8857f3630139eb617174d44ad37a80c9fa333a04ef9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.9 MB (228914653 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ef5ccec441be0cc66186bd92b1de1a0b8d15f2a2f6598cfd47465096b22e897`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 Oct 2023 00:18:56 GMT
RUN set -eux; 	version='6.4-beta3'; 	sha1='4a7afbbbfc06f6601bd00dc6287a268b82650ca5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 11 Oct 2023 00:19:02 GMT
VOLUME [/var/www/html]
# Wed, 11 Oct 2023 00:19:06 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 11 Oct 2023 00:19:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 11 Oct 2023 00:19:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 11 Oct 2023 00:19:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9032e4211a635f03f5b5fd09ef364d10b10dc55fa45ffcb90fe047a6a2842a9f`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43a07fb7333ace71a2d41faf3a1e99890f89beba024d11a6cee3deef3884b7f3`  
		Last Modified: Wed, 11 Oct 2023 00:25:12 GMT  
		Size: 27.0 MB (27046212 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7bd78a011c98a840bdd77a0abab447218b10941fed178c921ac950b660c4f8f`  
		Last Modified: Wed, 11 Oct 2023 00:24:58 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcde1af6bfa3f89b6d4074d93e26d766af628519a605cc076da6cea11a49b98b`  
		Last Modified: Wed, 11 Oct 2023 00:24:58 GMT  
...
```console
$ docker pull wordpress@sha256:bc9765e2ce4698ec5d54bf24f04a7f496a080dc6c47702a2a96d002868472be9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.1 MB (262130126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf595f3f2bfa564ef63cd11f3ff015276bc2cef7b3d3f8e8ebc43084f93881be`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 Oct 2023 00:43:10 GMT
RUN set -eux; 	version='6.4-beta3'; 	sha1='4a7afbbbfc06f6601bd00dc6287a268b82650ca5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 11 Oct 2023 00:43:12 GMT
VOLUME [/var/www/html]
# Wed, 11 Oct 2023 00:43:12 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 11 Oct 2023 00:43:12 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 11 Oct 2023 00:43:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 11 Oct 2023 00:43:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5f20e7c34cc41f17c04090efc4041b1f7ac3306d7d17f020fde1f33e45a0d4d3`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cc009a89a7b5a60e4a0640591292e21bf32b9dcd678df7ae02582d1facd7729`  
		Last Modified: Wed, 11 Oct 2023 00:49:35 GMT  
		Size: 27.0 MB (27048657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8465eb1e0e018ee51cb328dec6ef2793300d4ede6638d39871c19ece7d513673`  
		Last Modified: Wed, 11 Oct 2023 00:49:29 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36538dac4f9e7f84acfb9c8ef5b91433220b2480a7e29101904e9d45de7bd11e`  
		Last Modified: Wed, 11 Oct 2023 00:49:29 GMT  
...
```console
$ docker pull wordpress@sha256:66f79b89c0155f7ed592d475d552b0c00c82f97231d195a8d5ac924f7936d0b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.1 MB (227140776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cac33780ea6053e06d206745e7b5383d752613813271766a4b4c3da8d220f9c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 12:16:32 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 Oct 2023 01:08:02 GMT
RUN set -eux; 	version='6.4-beta3'; 	sha1='4a7afbbbfc06f6601bd00dc6287a268b82650ca5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 11 Oct 2023 01:08:04 GMT
VOLUME [/var/www/html]
# Wed, 11 Oct 2023 01:08:04 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 11 Oct 2023 01:08:04 GMT
...
-	Layers:
	...
	-	`sha256:6b6b406eccfe0c42347325c4f3041945cc52c89dfd98f847ee63b576c4d575bf`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f53712dda1d37d7a071887d261e8402c66fb70c5306cd18f8bacc94d87d0dc9`  
		Last Modified: Wed, 11 Oct 2023 01:26:01 GMT  
		Size: 27.0 MB (27048682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0fff8e79efe5888ec7f9bd00c761c8b558a51ac6f62d3067d3057329644abdb`  
		Last Modified: Wed, 11 Oct 2023 01:25:58 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10d8c149be50bab78a288b13b42ca4e1a5c3e96d0991a89017493762dcb4be31`  
		Last Modified: Wed, 11 Oct 2023 01:25:58 GMT  
