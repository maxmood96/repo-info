...
```console
$ docker pull wordpress@sha256:a43f5a1d3191c1f1582db0727edbb4a748f3e11f7668678c71eba95c59e802fb
```
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; amd64
...
### `wordpress:beta-6.7.2-RC2-apache` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; 386
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC2-apache` - linux; s390x
