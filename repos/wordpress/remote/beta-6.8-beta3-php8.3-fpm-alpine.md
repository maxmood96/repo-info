...
```console
$ docker pull wordpress@sha256:dcec2e786e92509f00e8056e18e5cd0520d4cdd73eff860d0daf54db23c9f92b
```
...
### `wordpress:beta-6.8-beta3-php8.3-fpm-alpine` - linux; arm64 variant v8
