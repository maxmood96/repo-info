...
```console
$ docker pull wordpress@sha256:b1e228eab38c8319c6668d71719ffe0dd1490550c599ca140ba8ffa9aafdfe6d
```
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta2-php8.3-fpm` - linux; s390x
