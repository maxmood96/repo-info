...
```console
$ docker pull wordpress@sha256:e3456cc389d3c8f79e11e7a9bd36d896c67339a3ff7855c1bb291fda4da965f4
```
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; amd64
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:7c8566f83143c2c97e18c855bbc020ca19fe5f34653628278279ef7d3277fa54
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179620444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31e1a618123665ce8d259bd357b80f90fcd9db20239015f2a8888bade7b49c68`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 08 Dec 2021 21:47:26 GMT
RUN set -eux; 	version='5.9-beta2'; 	sha1='3a06a65dcb29fb465c3cbf90bf694ded9d680592'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 08 Dec 2021 21:47:27 GMT
VOLUME [/var/www/html]
# Wed, 08 Dec 2021 21:47:28 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Wed, 08 Dec 2021 21:47:28 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 08 Dec 2021 21:47:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 08 Dec 2021 21:47:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f562faa5259c9f04273b8e67e04128da580e69bd77b36f6f57e860cb576a02e1`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0b81df3124b6fdde5f1506721c79e271c1859277b8dd516238960b2a75461cf`  
		Last Modified: Wed, 08 Dec 2021 22:08:48 GMT  
		Size: 19.5 MB (19462444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cae535a4efd88c76deb6e7700175540e7e7a21481484d82e0950e48d83e1312`  
		Last Modified: Wed, 08 Dec 2021 22:08:34 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d6f14fbb3f159d908c5835dc182feff978467c645ee9cb0726150ad30d6a08c`  
		Last Modified: Wed, 08 Dec 2021 22:08:34 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:eedc8d93ba2c37b9c7b68605b8c12908d18d811b2100bdc72f7e231e656b92ea
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.3 MB (203316515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4434f56396fcadd96f45354d8e76485dbae1c582364cf707ff3a19d734e50321`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 03 Dec 2021 14:38:29 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 08 Dec 2021 22:27:25 GMT
RUN set -eux; 	version='5.9-beta2'; 	sha1='3a06a65dcb29fb465c3cbf90bf694ded9d680592'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 08 Dec 2021 22:27:26 GMT
VOLUME [/var/www/html]
# Wed, 08 Dec 2021 22:27:27 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Wed, 08 Dec 2021 22:27:28 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 08 Dec 2021 22:27:28 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 08 Dec 2021 22:27:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c670a8b23a531a96bd6890d3cc795f3cb2a3989be1754fcb4e80293a3804512e`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2efa2783ecbb0cd6e299d35feac26ded6aac06c880fd5d572bd534fcfeef637`  
		Last Modified: Wed, 08 Dec 2021 22:40:31 GMT  
		Size: 19.5 MB (19461625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da5cbf6c69c851ba51eb271381e3cbf005e68a156ceb5022e8baf2654962c31c`  
		Last Modified: Wed, 08 Dec 2021 22:40:27 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36437ba7a7cbb49fca871b01a6b1f3b98bf9418c06a4625e3d659fefc643c7e2`  
		Last Modified: Wed, 08 Dec 2021 22:40:27 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; 386
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php7.4-fpm` - linux; s390x
