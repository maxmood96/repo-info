...
```console
$ docker pull wordpress@sha256:d98fa11ab7db9d7758bf712db503cb8ded3ce9b3dfeedb32ec2d36f7cf7b930c
```
...
### `wordpress:beta-6.3.1-php8.2` - linux; amd64

```console
$ docker pull wordpress@sha256:afb551bf02ab79b2bc470511679151f09fe9ce45b78f6a4d19f3488b60a7f303
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.8 MB (256848611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e5ea29a8dfb36f13aa4edc7cf878423699de0bda355b4ed5f14e495860de025`
...
-	Layers:
	...
	-	`sha256:67a84e712041164b1dcc0d9472dbfcb204188c65978db040ccce4f9b4f976ea7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58a5cdd39e1e4cd0b31bcc098f13c556b724b6e805eb89d1e3300c3bfcdc0cd8`  
		Last Modified: Thu, 24 Aug 2023 20:38:51 GMT  
		Size: 23.3 MB (23273483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d04cb9baa0e675b3c79bbebfef847a94c7bff6fb6cb86f19324b5ee6ad7dd0c`  
		Last Modified: Thu, 24 Aug 2023 20:38:47 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c46db581fc72feed97058a6283cb3dba48462f13264aecef7de98efce8a05e8`  
		Last Modified: Thu, 24 Aug 2023 20:38:47 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-php8.2` - linux; arm variant v5
...
### `wordpress:beta-6.3.1-php8.2` - linux; arm variant v7
...
### `wordpress:beta-6.3.1-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-6.3.1-php8.2` - linux; 386

```console
$ docker pull wordpress@sha256:912596ddef9d3d39d735ecd7679e9360c038d09f588e6cda77bda147afb992d5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.6 MB (255578610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd2e107417ffe864b602b6ff16ead0117ff673088164cbc29d8c35e6d4f26325`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 19:51:48 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:51:49 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:51:49 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:51:49 GMT
...
-	Layers:
	...
	-	`sha256:11a9d841cd0229b02f686f30f8f9a864505bbdf0c4a8a9c2e6768989d924ba56`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a9c30d91ad85990cc93f5ad98391f487225ad04bc44e718d4d7e28ec9d79394`  
		Last Modified: Thu, 24 Aug 2023 19:57:41 GMT  
		Size: 23.3 MB (23273482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3de66457531aea86dda98875441857a005ee33de77e71891f70d795b880bbbb3`  
		Last Modified: Thu, 24 Aug 2023 19:57:35 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1efd05329371e78c66faa492a77eb97722fcfb828315ab9782e7844d9d2c8c8`  
		Last Modified: Thu, 24 Aug 2023 19:57:35 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-php8.2` - linux; mips64le

```console
$ docker pull wordpress@sha256:182491147954a58053583932da798702543713032be8442eeff912f295d918c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.7 MB (228724698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:330f1a05c4a809bac26ff5342f218becb982992321297e1df830132ab9751048`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 20:12:12 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:12:17 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:12:21 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:12:26 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 20:12:30 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Aug 2023 20:12:35 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:56dbcb91d8a848b56274c878818c5f1e3ea8a9d3a2069973611f24f74835c902`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8965b6aa50c969b5dc42fb79352d537e726740a2e6acf8e82ced12d51b00a00`  
		Last Modified: Thu, 24 Aug 2023 20:19:14 GMT  
		Size: 23.3 MB (23273556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e844c01f0b88d393b80ba6947b78c7351374f5da4eae4f757a73d6953ed9a940`  
		Last Modified: Thu, 24 Aug 2023 20:19:01 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f6f64ce2e948316d5e0c9ffb199bf271313f71d78fd10b598ccae08a197eaa0`  
		Last Modified: Thu, 24 Aug 2023 20:19:01 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-php8.2` - linux; ppc64le

```console
$ docker pull wordpress@sha256:abffb5b95b4ab1138aad2bf93fe1b3b8d66f842a4b596c875783e204d88a49a3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.5 MB (262493863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab10e81e5494242211cc778faed7e51a379558f5691be37d3b050d36e9a4cbc0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 20:19:16 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:19:18 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:19:18 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:19:18 GMT
...
-	Layers:
	...
	-	`sha256:13c1e0f5dba2455416c7e3c79d23ca241eb6d99ea57593a29c6eaf3a11c3ea8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b7a8cb3c772713648a1b6753802b111c7bf4010c753d1772364494146d72915`  
		Last Modified: Thu, 24 Aug 2023 20:28:09 GMT  
		Size: 23.3 MB (23273483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6ed6186c224a1d31d52cfe615eb24ca2e0564f3efe70d8d70b5ea33d38588eb`  
		Last Modified: Thu, 24 Aug 2023 20:28:04 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55879edc937d203483f170013a8b6f53bd179a1bb35963543459091b5736ddbf`  
		Last Modified: Thu, 24 Aug 2023 20:28:04 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-php8.2` - linux; s390x
