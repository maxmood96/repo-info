## `wordpress:beta-6.7-RC5-php8.1-apache`

```console
$ docker pull wordpress@sha256:d2e5700fb3a677bf825e6805d2d08682582cb4b1acf4b8bd7e538f0d62ae109f
```
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.7-RC5-php8.1-apache` - linux; s390x
