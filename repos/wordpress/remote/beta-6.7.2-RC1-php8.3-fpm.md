...
```console
$ docker pull wordpress@sha256:22d1cbe4b1b70139ad0fa4e176f598b6b386ce299eafe38d39d08c18c50d23df
```
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; 386
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC1-php8.3-fpm` - linux; ppc64le
