...
```console
$ docker pull wordpress@sha256:638be6f92455531d2ba610feaa0a21bad6887daf73eba136a8dfc1ea8df562df
```
...
### `wordpress:beta-6.3-RC3-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC3-apache` - linux; 386
...
### `wordpress:beta-6.3-RC3-apache` - linux; mips64le
