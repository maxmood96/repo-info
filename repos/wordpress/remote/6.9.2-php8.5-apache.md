...
```console
$ docker pull wordpress@sha256:cf6211b9c75a09019e7d75e38306a50220429b0b01c493b33dc86b6989e6d911
```
...
### `wordpress:6.9.2-php8.5-apache` - linux; amd64
...
### `wordpress:6.9.2-php8.5-apache` - unknown; unknown
...
### `wordpress:6.9.2-php8.5-apache` - linux; arm variant v5
...
### `wordpress:6.9.2-php8.5-apache` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.5-apache` - linux; 386
...
### `wordpress:6.9.2-php8.5-apache` - linux; ppc64le
...
### `wordpress:6.9.2-php8.5-apache` - linux; s390x
