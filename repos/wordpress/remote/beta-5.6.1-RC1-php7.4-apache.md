## `wordpress:beta-5.6.1-RC1-php7.4-apache`

```console
$ docker pull wordpress@sha256:49718c7f7c9cfdaf5d02ea1f4a56925f1cf7c88db05df73c016239f4d6f347da
```
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; amd64
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; 386
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; mips64le
...
### `wordpress:beta-5.6.1-RC1-php7.4-apache` - linux; s390x
