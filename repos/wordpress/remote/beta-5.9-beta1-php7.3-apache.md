...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-php7.3-apache` - linux; s390x
