...
```console
$ docker pull wordpress@sha256:d70a63ee205e14bbfab6ed5e032802c924c78d9f7e6fe7aa638189c6d47a0f56
```
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.4-fpm` - linux; s390x
