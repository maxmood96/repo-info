...
```console
$ docker pull wordpress@sha256:4a5417228fb32c0e49e080c0144930297229c5f9b59328cd53e61364fd45f87e
```
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.7-RC1-fpm-alpine` - linux; s390x
