...
### `wordpress:beta-6.5-RC1-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.5-RC1-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC1-php8.2-apache` - linux; ppc64le
