...
```console
$ docker pull wordpress@sha256:16bce2d9ebb31145e021bf70a2f5e586ca0ccdecbd3a3383f98284184fe91fa4
```
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.5-fpm` - linux; s390x
