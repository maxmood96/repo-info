...
### `wordpress:beta-5.9.3-RC1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.9.3-RC1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.3-RC1-php8.0-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9.3-RC1-php8.0-fpm` - linux; s390x
