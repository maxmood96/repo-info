...
### `wordpress:6.8.0-php8.2` - linux; amd64
...
### `wordpress:6.8.0-php8.2` - unknown; unknown
...
### `wordpress:6.8.0-php8.2` - linux; arm variant v5
...
### `wordpress:6.8.0-php8.2` - linux; arm variant v7
...
### `wordpress:6.8.0-php8.2` - linux; arm64 variant v8
...
### `wordpress:6.8.0-php8.2` - linux; 386
...
### `wordpress:6.8.0-php8.2` - linux; mips64le
...
### `wordpress:6.8.0-php8.2` - linux; ppc64le
...
### `wordpress:6.8.0-php8.2` - linux; s390x
