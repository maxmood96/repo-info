...
```console
$ docker pull wordpress@sha256:52ae45d4133828a68cb999fd664ac33ce780ec7506e439b3d9b3ea67acc62533
```
...
```console
$ docker pull wordpress@sha256:0ca109c6e01c3885e20a3148529ccae673d1a701ec80804d31322c74b75ff6f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.6 MB (93569343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2af7cfdbe8f8c2dea55294d8066b58315c0a6e5a6f882db00f1c4e20b9f7d5d9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b7547b1249d64683371ac7d169a8db208dd4aae2976762da5745657061d9b2c1`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a96ba8614b58aa94704a262d497b9dfa05a4aea415b1c8e80bd893f7abb88635`  
		Last Modified: Wed, 19 Jul 2023 21:39:27 GMT  
		Size: 23.3 MB (23268868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ae8b759a7927438814d086ad8f830f20f0ba729f950b63e9217659f1bf0f0d8`  
		Last Modified: Wed, 19 Jul 2023 21:39:23 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47981f0424d29d802163849e1655dab9bde5a2263d727f683d2c79909452e333`  
		Last Modified: Wed, 19 Jul 2023 21:39:23 GMT  
...
```console
$ docker pull wordpress@sha256:610428bde1712cb5c04fbb058171bb8f82b09d82082e171ec74f6fd9e2568418
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100492110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3adf8477bc64b14e0b4298b090c162517711553e9556dc640988f404aec45133`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:215e71e4e181e25df6417d2a43405040c823d608e5c6f3aa460ca38bef24651a`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a59675e11e8df5356b3eec76f3f5644da10d8f60cf2d77f6ae624f9492b16456`  
		Last Modified: Wed, 19 Jul 2023 22:33:36 GMT  
		Size: 23.3 MB (23268853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:799e7c03c42bbf39d69f2247f29e3a968c369838c80972f47fd84029475260e5`  
		Last Modified: Wed, 19 Jul 2023 22:33:33 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e10d90b83138989523dc1fb8d11516b0032b5f1039be59432bd5a739942b944`  
		Last Modified: Wed, 19 Jul 2023 22:33:33 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:1f3e1b310667562ff9c1c1a8401afba0b3366550725060ae981a650b6756f20a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.5 MB (108503284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:533876cdcd024112fb41e32c6d9312bb3b823b6b14a7622d0c87aaae109bec4b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 19 Jul 2023 21:54:34 GMT
RUN set -eux; 	version='6.3-RC1'; 	sha1='e8c51f48b05d78f6e32e1350e9ee2d551f052a93'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 19 Jul 2023 21:54:36 GMT
VOLUME [/var/www/html]
# Wed, 19 Jul 2023 21:54:36 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 19 Jul 2023 21:54:36 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 Jul 2023 21:54:37 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 Jul 2023 21:54:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:063ba6ffe5e07dc4c6785868f7831a156b03658edf1e3a500bb6c76c1d6c1ced`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30fb192bc0738636ae73a836339b9df16cb290987cc11626bd4343967453ea63`  
		Last Modified: Wed, 19 Jul 2023 22:01:11 GMT  
		Size: 23.3 MB (23268870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b865fd4b0c397950a7a4c066dab14737dd49417102a68608027ed104df85b66c`  
		Last Modified: Wed, 19 Jul 2023 22:01:05 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebdbfad2fb2c8b716239fb6f554d78e7cd063bd20a3887abafb064035acb3bc4`  
		Last Modified: Wed, 19 Jul 2023 22:01:05 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:52fc58a87c3489050f1236a1609b91889a7622125898c7222346a2db4f00472d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.2 MB (92181179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71d70ae94d739a9b6eb4bf6af3ea42f47ecf995a576c4110fde60d858aa13719`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 20 Jul 2023 04:32:32 GMT
RUN set -eux; 	version='6.3-RC1'; 	sha1='e8c51f48b05d78f6e32e1350e9ee2d551f052a93'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 20 Jul 2023 04:32:33 GMT
VOLUME [/var/www/html]
# Thu, 20 Jul 2023 04:32:34 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 20 Jul 2023 04:32:34 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 20 Jul 2023 04:32:34 GMT
...
-	Layers:
	...
	-	`sha256:14a1a7f31870f68ad4bb3b7cbf4365ec7276c126899b390eb5bde2033a433962`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ca7078489182062c31921183619134d94763f91a9c7f7d093d45a4e6850a07a`  
		Last Modified: Thu, 20 Jul 2023 04:37:10 GMT  
		Size: 23.3 MB (23268873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d662f3966be928dde5f8f3acabf82cebe96d9fb372c71d1e36651cb433f21e96`  
		Last Modified: Thu, 20 Jul 2023 04:37:07 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7568d60e6501c1fe8e1245b41caa027a91e52ea0b677d8eef816e0adad60b3fd`  
		Last Modified: Thu, 20 Jul 2023 04:37:08 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
