...
```console
$ docker pull wordpress@sha256:256b79304a382f554b268562dd4d2e7de3801d5fc3bb8ab0c09e9ec1c7a4b1e5
```
...
```console
$ docker pull wordpress@sha256:7da5bb0d2d2b7de621fe4f591cb650aea6d43771ee17f442b3ceeb58e6521897
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.7 MB (102707580 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10ded617c89b4c8484876f66f571a60250002c4294a3d6f7f4052c8b07b7ff8b`
...
-	Layers:
	...
	-	`sha256:29b584b2dbe5deea00333f618434b017cb77447c76f97af24c66a92346fce47a`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6c1f7cb869f5a5270333940832071263d9d686382194b0b61ef7e17f189650f`  
		Last Modified: Tue, 04 Jul 2023 02:33:23 GMT  
		Size: 23.2 MB (23239399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57730487102092e562e3f339f820980ad616e38d811b90175deb385c418385a5`  
		Last Modified: Tue, 04 Jul 2023 02:33:20 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3d83877b9cfd53c896770cd041d2d32d208821a18a0086dae0095e1eba7278c`  
		Last Modified: Tue, 04 Jul 2023 02:33:20 GMT  
...
```console
$ docker pull wordpress@sha256:099501adbc6ffe1097cf3cb10ada98d1d7c834e46114853fa4766957105831f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.7 MB (96734983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e50acbc700aeeb836691a9c6aa7525edde8fd297a87e06a2764f6c02e6afa00`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 04 Jul 2023 01:09:36 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 04 Jul 2023 01:09:37 GMT
VOLUME [/var/www/html]
# Tue, 04 Jul 2023 01:09:37 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 04 Jul 2023 01:09:37 GMT
...
-	Layers:
	...
	-	`sha256:6ab04a0cf507388948902231d53bf00daceaecd4df52da4c24713a024654fc2d`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d16c54aa2253eecd9c67a57d199f58017c7beff2b7cbf9f487c157cdb2739ae4`  
		Last Modified: Tue, 04 Jul 2023 01:10:39 GMT  
		Size: 23.2 MB (23239401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0966d421b07c4733deaf97ef951f80c1fec775b23e5e42f7e9154b63b30fea81`  
		Last Modified: Tue, 04 Jul 2023 01:10:35 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5992935f75b0fbd2cf26a53a5c4cc920abd221bf320dd6776e4795590e84111`  
		Last Modified: Tue, 04 Jul 2023 01:10:35 GMT  
...
```console
$ docker pull wordpress@sha256:ce0e9edc347fa118d1eb531d08b322fb3ae28d767ec63460d1cdc30981837102
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.5 MB (93539872 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1335459ca7e41d224bac0d3783774abbbe32db8617271488f3f0d611b6191d86`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b7547b1249d64683371ac7d169a8db208dd4aae2976762da5745657061d9b2c1`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c5d8b4f8a6178af2ead0afdd782c7b5c7996abd6dc9c9a267aa90e32a888de`  
		Last Modified: Tue, 04 Jul 2023 04:45:48 GMT  
		Size: 23.2 MB (23239402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec5f3e3ad4dd92051bebef428a0a5f18cb7957fc44275bcfa40b3837136a2e0d`  
		Last Modified: Tue, 04 Jul 2023 04:45:44 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43cdce335ae8a06dd87167c066a0c58f661851a37415ae488c168dd731178836`  
		Last Modified: Tue, 04 Jul 2023 04:45:44 GMT  
...
```console
$ docker pull wordpress@sha256:a385ccc905a7b527a614978ee45720e5cba610c9372ff84efbb7beab8f7b6246
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100483041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52c4d273ec2f101ed3bf2900a009e6a4c09538740577ef60bfb81cffaea292d7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:215e71e4e181e25df6417d2a43405040c823d608e5c6f3aa460ca38bef24651a`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:170dce386eb498ef9e1603058a73e80925a616e63ef4a205f8b29a68ba4e0463`  
		Last Modified: Thu, 13 Jul 2023 20:07:30 GMT  
		Size: 23.3 MB (23259786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:744f7223c2f6fb1150a17d4705b603fc46b1384717c9077139c4ede9d42268e6`  
		Last Modified: Thu, 13 Jul 2023 20:07:28 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ac7b117d711ccb24b36ab31f15ada7b29ace7762e667362d7d8270b34ce21c7`  
		Last Modified: Thu, 13 Jul 2023 20:07:28 GMT  
...
```console
$ docker pull wordpress@sha256:23160db41708f7f04f5e7a3a00ee64f4e6d57b0bd7d5fb58de61fcf2ae67b61d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.9 MB (101905926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3dde202a5cda1a15391a5cc2b192eb999f467b96c10b06280716bb12ea6d218`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:8094b1f425e810c7964725cc7d71613fc22c722e64657762ea8edbd55798de88`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd55b2a66ad8d464fce4b78756fcacba15fb60e265022f4ee74677d688bea859`  
		Last Modified: Thu, 13 Jul 2023 19:43:03 GMT  
		Size: 23.3 MB (23259799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d11af56b778d5b6e12cef9ee1b34d5a34d37f9f43d210db7c1e7f3430cc4a548`  
		Last Modified: Thu, 13 Jul 2023 19:42:59 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd00e5a8740980927a944a8937feb925f602f7c4e915cae5ed172e9f68412297`  
		Last Modified: Thu, 13 Jul 2023 19:42:59 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:6a56917c1d2eafc6e7c18f02321a164e6f204b01a78e48d6bd59017049f0d96e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.5 MB (108473821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dde2595de0e3b76ac776c1c0f66ecde2a8ef804b6dd9a11a856cf5a95188c202`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 04 Jul 2023 02:42:14 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 04 Jul 2023 02:42:15 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 04 Jul 2023 02:42:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:063ba6ffe5e07dc4c6785868f7831a156b03658edf1e3a500bb6c76c1d6c1ced`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d129fb176ed5be3ef379e546ceb3c099e1887bc319a1f5208edc68d457d37da`  
		Last Modified: Tue, 04 Jul 2023 02:48:57 GMT  
		Size: 23.2 MB (23239402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35d206f0ea44e356f7e5a456b45a2fefeea8162c783363a4c61d97da18c65b33`  
		Last Modified: Tue, 04 Jul 2023 02:48:52 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9c490a1b8288ae3c47418b5042c4f1d5d49e70cfe59b51e7c3313f235054773`  
		Last Modified: Tue, 04 Jul 2023 02:48:52 GMT  
...
```console
$ docker pull wordpress@sha256:65ee0fdaa6b049c663060dccd85f31b8537c74e5e134c623908d49300408d864
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.2 MB (92151696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a31d8e6390d6e75732598854d617f26be536a6b7d917bacb11fa48ef304d8a6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 04 Jul 2023 02:25:38 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 04 Jul 2023 02:25:40 GMT
VOLUME [/var/www/html]
# Tue, 04 Jul 2023 02:25:40 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 04 Jul 2023 02:25:40 GMT
...
-	Layers:
	...
	-	`sha256:14a1a7f31870f68ad4bb3b7cbf4365ec7276c126899b390eb5bde2033a433962`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a48ab16b0563e9218d9d1485a139c85b699bb80d9860dbc6b2fa23c3a07a0dcc`  
		Last Modified: Tue, 04 Jul 2023 02:29:44 GMT  
		Size: 23.2 MB (23239389 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aee9d6266f6d796c8e548ec0a46baf6d75caa03667ddf97a9612700d25428527`  
		Last Modified: Tue, 04 Jul 2023 02:29:41 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc9dbc1c5834db2075146055dc68df6cd1669d645390dd1605bb0b1ac676ee46`  
		Last Modified: Tue, 04 Jul 2023 02:29:41 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
