...
```console
$ docker pull wordpress@sha256:c0d25ef1b16707342862d563be3a86fe2e899e03b30396532c0fab20ffd12923
```
...
### `wordpress:6.9.2-php8.4-apache` - linux; amd64
...
### `wordpress:6.9.2-php8.4-apache` - unknown; unknown
...
### `wordpress:6.9.2-php8.4-apache` - linux; arm variant v5
...
### `wordpress:6.9.2-php8.4-apache` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.4-apache` - linux; 386
...
### `wordpress:6.9.2-php8.4-apache` - linux; ppc64le
...
### `wordpress:6.9.2-php8.4-apache` - linux; s390x
