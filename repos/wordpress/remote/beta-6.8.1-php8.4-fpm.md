...
```console
$ docker pull wordpress@sha256:7d57f9c5a1143a544b2233f1a7e1e65da00b8f6c6d00e272384b977c7c75dff7
```
...
### `wordpress:beta-6.8.1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.8.1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.8.1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.8.1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.8.1-php8.4-fpm` - linux; s390x
