...
```console
$ docker pull wordpress@sha256:c6020f016c91993c5974a1a99cee05924b5907a56d3e0d59a38ed488295ce3a5
```
...
### `wordpress:beta-6.3-php8.1-fpm` - linux; amd64

```console
$ docker pull wordpress@sha256:f6cf5f00b6aba03e3d0de4d3cfbae01407fdee7280932ef4d0bc19040e2211f4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.7 MB (252654155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0ab27a27f616b434509b36ff2dcab27266a0ef79c88ca344a29d19bef854018`
...
-	Layers:
	...
	-	`sha256:733ec4f597cf45896ee4bd133d52333d33891ecbbe494aa7fd059cb67d34f161`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:855303024fa1a7758fe6c70126f54f8ce56e00b22d920c36314883627d27e5d6`  
		Last Modified: Tue, 11 Jul 2023 04:03:03 GMT  
		Size: 23.2 MB (23239525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5760cbe62cc5634642946b8bcaff1b4aaba7c9e0f222fe5a6e3c38c96f65d53c`  
		Last Modified: Tue, 11 Jul 2023 04:03:00 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a74ffd5883396ba22bf4fddefe3dcf504419ec4e807d60eac30f1aaf306c201`  
		Last Modified: Tue, 11 Jul 2023 04:03:00 GMT  
		Size: 1.7 KB (1726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-php8.1-fpm` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:0257e57e41b436886a8b6b271f7c858c08c7de64277e43d7065fd81fc40deda2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.8 MB (211831593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc004075823d7afff5f36cba601487772cd3655fd2a431d0c4abe4529e38e31a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 03:35:55 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 03:44:18 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 03:44:19 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 03:44:19 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 03:44:19 GMT
...
-	Layers:
	...
	-	`sha256:2f04d8ceea2f1068a468bfcf4e445dccc558f74ec61d5ea8516eacceacad7ba9`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62baeafc45534139e62faff60ce37a8deadb82cf5386d1459dbaef8ce076f548`  
		Last Modified: Tue, 11 Jul 2023 03:49:48 GMT  
		Size: 23.2 MB (23239522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02005ac3f2324135e5acf5afe74fb8b539ec3e4f279c19f36c1e695d60d9f4f3`  
		Last Modified: Tue, 11 Jul 2023 03:49:45 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d6e5414271090ba191ebf497ad9df802e01bfcf4507cf386dcb42a9737b294`  
		Last Modified: Tue, 11 Jul 2023 03:49:44 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:43c891c13f89d1c3a0678beca9979f34cc32bc0572ea80e209fd304be59c0a6e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.0 MB (243968340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d767e4a5e93f1091ebc54588e5df16fc68721af9196b0a946cea59e9945769e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:96d26a991893f128a60476f81de896278355f7dcec8e833853894b877b18f5a7`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5763769cc8fcb197e895a40d633a09ece79ce326522499ad85c0811781ac4cab`  
		Last Modified: Thu, 13 Jul 2023 20:08:30 GMT  
		Size: 23.3 MB (23258178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:594b6f3f2003b8567ea8251c9570a9cf6df8406ca16348af1b118312d51d958a`  
		Last Modified: Thu, 13 Jul 2023 20:08:27 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96d4afd0b0a529b26ee20d47d0fae584795b86ca56d205ccd3a5eca540e73af9`  
		Last Modified: Thu, 13 Jul 2023 20:08:27 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; 386

```console
$ docker pull wordpress@sha256:ad4f93c1b01820a54c318d5152ab219fe767c240512ed64267d153e893606001
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.2 MB (251182058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aeb474d4d2485ad71962d42f85643f5ef82f71e46d139e22a2ae2d664c47cce6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 04:07:55 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jul 2023 19:39:22 GMT
RUN set -eux; 	version='6.3-beta4'; 	sha1='6995c76ab278839e52938e9e620475e12d8d3158'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 13 Jul 2023 19:39:23 GMT
VOLUME [/var/www/html]
# Thu, 13 Jul 2023 19:39:23 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 13 Jul 2023 19:39:23 GMT
...
-	Layers:
	...
	-	`sha256:5b1762a3a60dc6ceba108cc7ea9052fde36ebb662d76d1cdf3be5389ef43bae6`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99cdbd82a080e364240320d0eba1a1753ec11c9a0d48e607afb665f62cf5e132`  
		Last Modified: Thu, 13 Jul 2023 19:44:04 GMT  
		Size: 23.3 MB (23258177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3758076bbe5d007dab27d9be8ac2789131b725ea90f852897ec83c15179d401`  
		Last Modified: Thu, 13 Jul 2023 19:44:00 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:681070c0d2a96a8c075d3fa757afe95e4e3554d166da92b9b09728d083d5caaa`  
		Last Modified: Thu, 13 Jul 2023 19:44:00 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; mips64le

```console
$ docker pull wordpress@sha256:378ea9f39982853116addcbf96849759a33383c6c19faec2de5fbdf75f6deb96
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.6 MB (224612053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28e1cdacfe8dccef508926bf73e73911a2bb5deabc47f964d409d3ccaae7aa97`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jul 2023 20:13:17 GMT
RUN set -eux; 	version='6.3-beta4'; 	sha1='6995c76ab278839e52938e9e620475e12d8d3158'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 13 Jul 2023 20:13:22 GMT
VOLUME [/var/www/html]
# Thu, 13 Jul 2023 20:13:26 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 13 Jul 2023 20:13:30 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 Jul 2023 20:13:35 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jul 2023 20:13:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c07608a210f14cbb5a554bf0974393ff34104ffd01593041aef69fce67f2cabe`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ba74eb6e090e49062cb96948e9cd131d2e10fe7f4c5b93eb80743e3f48e868c`  
		Last Modified: Thu, 13 Jul 2023 20:19:50 GMT  
		Size: 23.3 MB (23256748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f1f71bf41c7384d8ba3c7d3269f156bcdd10edf91eca9b5f6e6085a6f6f1745`  
		Last Modified: Thu, 13 Jul 2023 20:19:36 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f3a92cccf1615dc3bb4ee8e48172ae64756be61b9e51938fdccc6a2acd06ef5`  
		Last Modified: Thu, 13 Jul 2023 20:19:37 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; ppc64le

```console
$ docker pull wordpress@sha256:1f0c3e5d37de32cb39e0b01f60a3b15e532849c05689fb4dd94ce3b59adcd839
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.8 MB (257762509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9548f2a043fe4a200f9b5fb2f1e662871de587eb1be7c855967ed8a2c816b09`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 07:24:52 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:24:54 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:24:55 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:24:55 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 07:24:55 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 07:24:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:20f58e8720ff4d84ed202cda28dddf50e30b23c3e3be5155b9c1fc21de055de9`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c9d0dddda57af745bce1d0bb54148d87876203c18527d0bec4b786f24f9b528`  
		Last Modified: Tue, 11 Jul 2023 07:34:39 GMT  
		Size: 23.2 MB (23239515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3784705ae44ba958e6ae1142b9a668ba505d0cb148d38c5ec4e660e9682e8bac`  
		Last Modified: Tue, 11 Jul 2023 07:34:34 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ce904e85f8f43292d2be2f9c33f5fcea2e9862cd81b86d252dfdef43b25c0eb`  
		Last Modified: Tue, 11 Jul 2023 07:34:34 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-php8.1-fpm` - linux; s390x

```console
$ docker pull wordpress@sha256:802c99dad7892c76d0ee1cfd3ef1ac70487c202f8f06812c1aa427a7b6bacd39
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.8 MB (222825916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce2e36991d6706057ec23bfc4a01770257912032dbb0b6d8c74acad0c5cf3dba`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 07:37:08 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 07:46:37 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:46:39 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:46:39 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:46:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 07:46:40 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 07:46:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2890da3b441b5d607122d91c953452e6e4d26b15b82c84e08cb7044acda47d6a`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2056aac16074123be763ded18ac4fe9693405d1f49db427bb40ba9460004874`  
		Last Modified: Tue, 11 Jul 2023 07:51:59 GMT  
		Size: 23.2 MB (23239539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71533df0c88cdb3969aa81580e04ee02c7a9ccd11b480460dc21961effee1066`  
		Last Modified: Tue, 11 Jul 2023 07:51:56 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e77f446d10b88866c966a6eec65f5ac99e73f2d26457d7a42c043c7f10c83d2`  
		Last Modified: Tue, 11 Jul 2023 07:51:56 GMT  
