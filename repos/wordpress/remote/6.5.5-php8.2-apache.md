...
```console
$ docker pull wordpress@sha256:5619699cc28e56512ad8b95a6cffc5bcdfa00645b22d848948c0ea8493a7aa3d
```
...
### `wordpress:6.5.5-php8.2-apache` - linux; amd64
...
### `wordpress:6.5.5-php8.2-apache` - unknown; unknown
...
### `wordpress:6.5.5-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.5.5-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.5.5-php8.2-apache` - linux; 386
...
### `wordpress:6.5.5-php8.2-apache` - linux; mips64le
...
### `wordpress:6.5.5-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.5.5-php8.2-apache` - linux; s390x
