...
```console
$ docker pull wordpress@sha256:c968fe84227ed8670deb9c249463e7e88a7e54a84f81a29f54c46bb253a62f40
```
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; ppc64le
...
### `wordpress:beta-6.0.1-php8.0-fpm` - linux; s390x
