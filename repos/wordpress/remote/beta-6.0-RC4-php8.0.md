## `wordpress:beta-6.0-RC4-php8.0`

```console
$ docker pull wordpress@sha256:220d0bcf065ef3d0e284511a2fa3a01857efdfd50405601398460831276b9add
```
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; amd64
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; arm variant v7
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; 386
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; mips64le
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; ppc64le
...
### `wordpress:beta-6.0-RC4-php8.0` - linux; s390x
