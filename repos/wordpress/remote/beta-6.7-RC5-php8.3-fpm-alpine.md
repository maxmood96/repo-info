...
```console
$ docker pull wordpress@sha256:22462a53b1e127f26bafe37fb7a80aa2e42d8eddb14504e195c61110d281f5cd
```
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.7-RC5-php8.3-fpm-alpine` - linux; s390x
