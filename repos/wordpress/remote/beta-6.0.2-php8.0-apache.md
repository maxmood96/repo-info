...
```console
$ docker pull wordpress@sha256:6c6645dba19761ee8d9cb0934bd0c95be14334c80943584d7ecb833430135628
```
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-6.0.2-php8.0-apache` - linux; s390x
