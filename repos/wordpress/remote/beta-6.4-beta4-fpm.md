## `wordpress:beta-6.4-beta4-fpm`

```console
$ docker pull wordpress@sha256:bb6910d0b6a8b4ea5cecd10294e91d368f691815a632839218e9e932eafc83e9
```
...
### `wordpress:beta-6.4-beta4-fpm` - linux; amd64
...
### `wordpress:beta-6.4-beta4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta4-fpm` - linux; 386
...
### `wordpress:beta-6.4-beta4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.4-beta4-fpm` - linux; s390x
