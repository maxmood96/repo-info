...
```console
$ docker pull wordpress@sha256:6460c4b109d8b34007d9839f2ffd94db9ee62efa103efbda572aeba39fda5f26
```
...
### `wordpress:6.0.2-apache` - linux; amd64
...
### `wordpress:6.0.2-apache` - linux; arm variant v5
...
### `wordpress:6.0.2-apache` - linux; arm variant v7
...
### `wordpress:6.0.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.0.2-apache` - linux; 386
...
### `wordpress:6.0.2-apache` - linux; mips64le
...
### `wordpress:6.0.2-apache` - linux; ppc64le
...
### `wordpress:6.0.2-apache` - linux; s390x
