...
```console
$ docker pull wordpress@sha256:ef1f9214f037f53a0bf07d7bff842f207ba5c887d797fd1a4f4a9d5b215ae53c
```
...
### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; amd64

```console
$ docker pull wordpress@sha256:e836893b5b2e1def4cd7a248b5168c65e9868878beb2c30ab4fb01b7f8f302d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.0 MB (83038788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0fdb6f16b0b979c5c23ae383e182c9a8fdbadda9ec27b6bfb6db7dbd96c8a7a`
...
-	Layers:
	...
	-	`sha256:72c0770db5140814b8b34485fda80f210fee6560ce93ed4d75f2ecd32de6b490`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51a01f4b10ecfc5f3f1b00116fe3c1c9a08e75d66c225fee95dcd1fe43b83031`  
		Last Modified: Sat, 06 Mar 2021 02:40:56 GMT  
		Size: 15.5 MB (15457390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d7685ba9d8aa0d21ff7c1df7c014f4deb1c2ff95328ee83fc8471f295c947bd`  
		Last Modified: Sat, 06 Mar 2021 02:40:53 GMT  
		Size: 4.0 KB (3963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:cf04ecc25748ee96050d4fc16787163e08e81f70537ca21b370ff575f1e23b71
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.7 MB (83738343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b467bece69d731582f168d7b5c8eeecfe8dcc3ad6998def17cc6e5598683c297`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 06 Mar 2021 01:18:20 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 06 Mar 2021 01:18:21 GMT
VOLUME [/var/www/html]
# Sat, 06 Mar 2021 01:18:21 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Sat, 06 Mar 2021 01:18:21 GMT
...
-	Layers:
	...
	-	`sha256:18d01c05b81a4c27314382738c8fe5edd391b26ce085cd1d90aa68a71f5cd21e`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:357ca98691aef0f14f8a64932256489edbf7270f6952d284ae4337ca2c230a45`  
		Last Modified: Sat, 06 Mar 2021 01:36:46 GMT  
		Size: 15.5 MB (15457389 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e3c1ac85dc0068376ccf12545e8cd23a5e629d1b4e2a943d6bb47117bca93ae`  
		Last Modified: Sat, 06 Mar 2021 01:36:39 GMT  
		Size: 4.0 KB (3963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; ppc64le

```console
$ docker pull wordpress@sha256:7ea7714a447271e09332878ddf60bff584686abd8fe60ddf933cce57fc4a31fe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.5 MB (84450909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0dd7a377c4b6f19ea50f1ea77596dc0685f2b86f61f8567af90866e950a468c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 23 Feb 2021 01:59:47 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 23 Feb 2021 01:59:53 GMT
VOLUME [/var/www/html]
# Tue, 23 Feb 2021 01:59:58 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Tue, 23 Feb 2021 02:00:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 23 Feb 2021 02:00:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0466bf00e4af5a1fda72baacbe3474b21aa4c95f491b627f1dd3996bf5246fad`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91421396f529dddc669a31f141c64a0f2774681a4541829cd5ce4911f7bab9e7`  
		Last Modified: Tue, 23 Feb 2021 02:08:03 GMT  
		Size: 15.5 MB (15457370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db9d8214b13057837bd3567265f5946ced94628017b7f1815ec4c73d93eb143b`  
		Last Modified: Tue, 23 Feb 2021 02:08:00 GMT  
		Size: 4.0 KB (3965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.2-php7.3-fpm-alpine` - linux; s390x
