...
```console
$ docker pull wordpress@sha256:5e5075affb7f65616786480033121b152b810da3de76e2f29a819b9940fb1a6d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.7 MB (44657089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54a679c019263ed7d9f1af9c8295e616ef645c2c04c031ae04cbddfca633b250`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
# Fri, 01 Oct 2021 00:59:20 GMT
ENV WORDPRESS_CLI_SHA512=08dd9035fda1d529807380d5b757839e2809e289eb1a698fe33e7e21a1431d3f77c551c2b2db5adc55083d5075ea4137407994111890f765e790a97e6d9ca7af
# Fri, 01 Oct 2021 00:59:31 GMT
RUN set -ex; 		apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -o /usr/local/bin/wp.gpg -fL "https://github.com/wp-cli/wp-cli/releases/download/v${WORDPRESS_CLI_VERSION}/wp-cli-${WORDPRESS_CLI_VERSION}.phar.gpg"; 		GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$WORDPRESS_CLI_GPG_KEY"; 	gpg --batch --decrypt --output /usr/local/bin/wp /usr/local/bin/wp.gpg; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" /usr/local/bin/wp.gpg; unset GNUPGHOME; 		echo "$WORDPRESS_CLI_SHA512 */usr/local/bin/wp" | sha512sum -c -; 	chmod +x /usr/local/bin/wp; 		apk del --no-network .fetch-deps; 		wp --allow-root --version
# Fri, 01 Oct 2021 00:59:32 GMT
VOLUME [/var/www/html]
# Fri, 01 Oct 2021 00:59:32 GMT
COPY file:b6efa5ff0423d61c2df0c8941b896844a8272d8516cdda0fcae8daaf56baac18 in /usr/local/bin/ 
# Fri, 01 Oct 2021 00:59:32 GMT
...
-	Layers:
	...
	-	`sha256:2e8a03b65491efcd8271777d351fe43fdf83771b301703cb24023526006864ce`  
		...
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7d60a97a85010575ba19efdff17140961b71191eea073302f9bc186022cae8d`  
		Last Modified: Fri, 01 Oct 2021 01:10:50 GMT  
		Size: 4.9 MB (4897745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d45971c76434f53ce4833966e22dd1b3ab24f5825823b2d99cf1f55264966fc9`  
		Last Modified: Fri, 01 Oct 2021 01:10:49 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be946d7ad94ebad0f866ee9af83ed3977603e0f75d066bef3f2fd93cf2be0c74`  
		Last Modified: Fri, 01 Oct 2021 01:10:50 GMT  
		Size: 1.3 MB (1315606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b19ce1b549457bb76d6973fd0703abed3c5dae6c9cf7afe705d8efae25b29df9`  
		Last Modified: Fri, 01 Oct 2021 01:10:49 GMT  
		Size: 411.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:eb98554e686149a024ac9ba12421351fcb0e351aafd314078bf15608e5940d70
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.2 MB (46197195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32b3605c8ddc21768cad19c4b584725441688c6e7583d347c9bb4f353b2b51d3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
WORKDIR /var/www/html
# Fri, 24 Sep 2021 18:10:12 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 24 Sep 2021 18:10:18 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 24 Sep 2021 18:10:21 GMT
ENV WORDPRESS_CLI_GPG_KEY=63AF7AA15067C05616FDDD88A3A2E8F226F0BC06
# Fri, 24 Sep 2021 18:10:23 GMT
ENV WORDPRESS_CLI_VERSION=2.5.0
# Fri, 24 Sep 2021 18:10:28 GMT
ENV WORDPRESS_CLI_SHA512=08dd9035fda1d529807380d5b757839e2809e289eb1a698fe33e7e21a1431d3f77c551c2b2db5adc55083d5075ea4137407994111890f765e790a97e6d9ca7af
# Fri, 24 Sep 2021 18:10:45 GMT
RUN set -ex; 		apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -o /usr/local/bin/wp.gpg -fL "https://github.com/wp-cli/wp-cli/releases/download/v${WORDPRESS_CLI_VERSION}/wp-cli-${WORDPRESS_CLI_VERSION}.phar.gpg"; 		GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$WORDPRESS_CLI_GPG_KEY"; 	gpg --batch --decrypt --output /usr/local/bin/wp /usr/local/bin/wp.gpg; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" /usr/local/bin/wp.gpg; unset GNUPGHOME; 		echo "$WORDPRESS_CLI_SHA512 */usr/local/bin/wp" | sha512sum -c -; 	chmod +x /usr/local/bin/wp; 		apk del --no-network .fetch-deps; 		wp --allow-root --version
# Fri, 24 Sep 2021 18:10:52 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 18:10:55 GMT
COPY file:b6efa5ff0423d61c2df0c8941b896844a8272d8516cdda0fcae8daaf56baac18 in /usr/local/bin/ 
# Fri, 24 Sep 2021 18:11:01 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 24 Sep 2021 18:11:10 GMT
USER www-data
# Fri, 24 Sep 2021 18:11:14 GMT
CMD ["wp" "shell"]
```
...
-	Layers:
	...
	-	`sha256:b988d8f87c2db384f8f39680588a3def0e15862b549578d05ac5ba0f3933a23f`  
		...
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:045f58d1aca9c03c04682337888b449c7f50455c031bd5c00b57d57498ceb975`  
		Last Modified: Fri, 24 Sep 2021 18:27:22 GMT  
		Size: 4.9 MB (4907419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c344419be3379c730d4b609eea960d652470b61919f0cc5587a4c3ca7dcce58`  
		Last Modified: Fri, 24 Sep 2021 18:27:21 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63f5c36b587bf073dea6f6a930697237103719baec0c632e3724a2454d5cb943`  
		Last Modified: Fri, 24 Sep 2021 18:27:21 GMT  
		Size: 1.3 MB (1315109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c2c138262bcf96d22d56583dc48bee20b5ab89c2406243db979bcdc37616da7`  
		Last Modified: Fri, 24 Sep 2021 18:27:21 GMT  
		Size: 412.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
