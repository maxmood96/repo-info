...
```console
$ docker pull wordpress@sha256:2559881be228994070bfea71a2496d7bc57ebef16f804795ee52d002aa10987b
```
...
### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; amd64

```console
$ docker pull wordpress@sha256:af7c3f5de78c45153b1327761c084cfece0f57bdf5f920f9c739073a7991affd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.6 MB (103573802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71350271a7a4bbcf6be9f9e7abdb4ea36f57dff325342858de6dd036c1a507e5`
...
-	Layers:
	...
	-	`sha256:0a2575dd96758d28e0969749cd174aaaa2def743f8bdae64389403951adb8ce5`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67500eab9f59633128581083841c872e8f22e03c0f210df9654363f45167876e`  
		Last Modified: Tue, 11 Jul 2023 04:04:29 GMT  
		Size: 23.2 MB (23239383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52acf3ecd0af46f90bc7960a48d986a1e6f653fd746179a91523a1e03dd201b`  
		Last Modified: Tue, 11 Jul 2023 04:04:26 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51413437874e346272c7c89b397ebca597523035ff47bd663dab67268f486ee8`  
		Last Modified: Tue, 11 Jul 2023 04:04:26 GMT  
...
```console
$ docker pull wordpress@sha256:eb121f0d7fcea8ff82dd72a97b47f5b71f88fe74820736c9428fcb437fbb9d3f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.8 MB (97833611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0c7aea4dcf954fae9a753c4dc57eb1641ebf9f9cf33e10aaa37ecd41d9b6596`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3b298e593216349c27749cce3e6a98766dbdcdc36cddba1e060b9600b985e8a1`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90596e12b87c6bd0a2a0d629fca3ae619a920a002888ea3bcedc1cdcd4a7e524`  
		Last Modified: Tue, 11 Jul 2023 00:06:05 GMT  
		Size: 23.2 MB (23239382 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc06a3497258066650f0e0400887e5cd0de1d2b923253ef293ccb29f67f4d981`  
		Last Modified: Tue, 11 Jul 2023 00:06:00 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9159a4071c2da501794d62884907115a5732e577ea99d27735cf5dcadb0ebd27`  
		Last Modified: Tue, 11 Jul 2023 00:06:00 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:cf871f078c9aed33dca948b28c79b24bce1c542967ceb213755cf30509bc2def
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.5 MB (94535466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4062872df28210e6c9bfceac1b238becb6882198ff2e62cc531004169b0a6da6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 03:44:45 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 03:44:45 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 03:44:45 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 03:44:46 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 03:44:46 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 03:44:46 GMT
...
-	Layers:
	...
	-	`sha256:936dbfbf58e5613ae1ab84d40412dce4099c8f941b44c963ccf9c8d54a89f20b`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5391d07216f6da818cd20ceacd8d5fe9b75edcb224677d37c31a8f5dff40cc6`  
		Last Modified: Tue, 11 Jul 2023 03:51:11 GMT  
		Size: 23.2 MB (23239380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bcf2a2a8b8b0111fb9378549983969fc8364d95994f8a398a9feca6aa9b85ed`  
		Last Modified: Tue, 11 Jul 2023 03:51:08 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:190dae82598836e996e2971db876e25b1600bcc6caea8461a8c38470ad47cd66`  
		Last Modified: Tue, 11 Jul 2023 03:51:08 GMT  
		Size: 1.7 KB (1727 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:a7f7abfbebf1292b643cfffef59d3c854daf5c8dfbdb97b1518245d0d7264767
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.8 MB (102826715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:414230e19eef1689162f87ed63b21b562d0af568d963eb4eba511763bc451bd5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 04:22:19 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 04:22:20 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 04:22:20 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 04:22:20 GMT
...
-	Layers:
	...
	-	`sha256:9560eda727c3643def96da41e38fdf3dab6015706fcebf3e292d796833aaa086`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:563ab2cf4f4ac1a0f565e733c392cac52cbd32a0f671706e11fd29ef0563490a`  
		Last Modified: Tue, 11 Jul 2023 04:28:44 GMT  
		Size: 23.2 MB (23239378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4854bb1afdb47fcf4f4405e9608e80c754c8f96e838978ff35fa8eab966f30e0`  
		Last Modified: Tue, 11 Jul 2023 04:28:42 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:330dbce3c51e96448f0cb39bafa618f465cb4b4cd6bf2012e603cd36eec1a864`  
		Last Modified: Tue, 11 Jul 2023 04:28:42 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:24dab789a014622395f1639fb91fa55939773d4fc2c1a87ab3872d77b89c0ae0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100525975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cfb0749a4229b5a750bc8ceb5d7d2811fce295e882002e302cc61fdfea686da`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d64e5c3355d7f8f43eefd3685a9d9782df0580a201e9daea490333ba325efc93`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de81b291c57aae17404e1bfb88d381b61fbd04637616bf98982608a6956b86ad`  
		Last Modified: Tue, 11 Jul 2023 04:25:34 GMT  
		Size: 23.2 MB (23239388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a796a87a73e4b5ed23d57bc76d4c6f4f15510d45a9790449b58326455da5e4e`  
		Last Modified: Tue, 11 Jul 2023 04:25:29 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32f95f4e33b5cd46c7db29819e13f41fa709128d7c3ad6184a8e1547cc91805e`  
		Last Modified: Tue, 11 Jul 2023 04:25:29 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; ppc64le

```console
$ docker pull wordpress@sha256:231728823f5034a285b78a58b0be4f97a1cc23797953fb37c1620c9175f70abb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.1 MB (109066413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed61826c3c4f3c32ec4810457d5ba75f3525b4789a89d8530f378a3fb43a304c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 07:25:52 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:25:54 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:25:55 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:25:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 07:25:57 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 07:25:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b9e5499443238dfaf1062d5c42544d4926a2cdb6d351a369ad7acad6b256a964`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1321c090b875d5002049192ff5032a5212a2990a4b4eac3b42c3be414dd0bd4`  
		Last Modified: Tue, 11 Jul 2023 07:36:50 GMT  
		Size: 23.2 MB (23239392 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:283f45a680180919ef90cd57aac9cbdf9fe5cf55307bc5894bf816319eb1bc75`  
		Last Modified: Tue, 11 Jul 2023 07:36:45 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cecf502743b58914db8fb4e28c76fb861bd0ebe18fb14917f401abbf49bac405`  
		Last Modified: Tue, 11 Jul 2023 07:36:45 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta3-php8.2-fpm-alpine` - linux; s390x

```console
$ docker pull wordpress@sha256:0115fcb98a81c08b46e341bf316a83d0c8341d0a7ee69677319ec5ec4b532130
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102489531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5955837387a1918b16ad885177255b1d1608e5af97c3fc8d298c4c1d30985658`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 07:43:21 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 07:47:22 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:47:24 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:47:24 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:47:24 GMT
...
-	Layers:
	...
	-	`sha256:88b8f02734ddeeaba30a57f7b41ae8feff51b5d2914ca0c12e8f7c7a9b4b2efc`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:675bd22e898981e8a9a8157d9047b8b3b26a39c0e7fb12fd0e8e09ad8bbbc549`  
		Last Modified: Tue, 11 Jul 2023 07:52:50 GMT  
		Size: 23.2 MB (23239383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:803acbd5ddff4ab62d6568d3ac33595ea66069f8730d270a23f302ca1c66c23d`  
		Last Modified: Tue, 11 Jul 2023 07:52:47 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7454d980581fe09962ad993b1e64d81e88c5a000155a6d0818f2499eb8d9827d`  
		Last Modified: Tue, 11 Jul 2023 07:52:47 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
