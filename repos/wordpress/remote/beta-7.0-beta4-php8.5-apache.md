...
```console
$ docker pull wordpress@sha256:5c8e964227cd4462e870096ecd99c536af051a6dd9f6df1eafb182d44e606aaa
```
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.5-apache` - linux; s390x
