...
```console
$ docker pull wordpress@sha256:28582269d824b1e2a8eed850b4edd2d66272abb6478510de3b6fdef4457d26b1
```
...
### `wordpress:6.9.1-php8.3-fpm` - linux; amd64
...
### `wordpress:6.9.1-php8.3-fpm` - unknown; unknown
...
### `wordpress:6.9.1-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:6.9.1-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.3-fpm` - linux; 386
...
### `wordpress:6.9.1-php8.3-fpm` - linux; ppc64le
...
### `wordpress:6.9.1-php8.3-fpm` - linux; s390x
