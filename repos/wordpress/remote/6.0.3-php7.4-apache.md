...
```console
$ docker pull wordpress@sha256:9b4eab880d7d5bf6a0d1aea43146e0e2e22dcf7781004276cfd64510ecec47aa
```
...
### `wordpress:6.0.3-php7.4-apache` - linux; amd64
...
### `wordpress:6.0.3-php7.4-apache` - linux; arm variant v5
...
### `wordpress:6.0.3-php7.4-apache` - linux; arm variant v7
...
### `wordpress:6.0.3-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:6.0.3-php7.4-apache` - linux; 386
...
### `wordpress:6.0.3-php7.4-apache` - linux; mips64le
...
### `wordpress:6.0.3-php7.4-apache` - linux; ppc64le
...
### `wordpress:6.0.3-php7.4-apache` - linux; s390x
