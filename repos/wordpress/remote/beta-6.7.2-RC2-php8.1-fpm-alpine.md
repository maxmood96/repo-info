...
```console
$ docker pull wordpress@sha256:98e7557d1656a9d88ef1b41fbe771ea352cb773f2f944a189e25847b0d16f2dd
```
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm-alpine` - linux; s390x
