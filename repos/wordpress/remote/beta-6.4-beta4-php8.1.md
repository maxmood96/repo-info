## `wordpress:beta-6.4-beta4-php8.1`

```console
$ docker pull wordpress@sha256:9afc909513e98e0ad8966dd65ed3f29143d30f9f2c60a7f41e5d6ea9d0183524
```
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; amd64
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; 386
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.4-beta4-php8.1` - linux; s390x
