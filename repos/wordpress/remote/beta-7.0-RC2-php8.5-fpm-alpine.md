...
```console
$ docker pull wordpress@sha256:4af83d10fdf6c54d5056fd0a7f407a54b974c9baee5989ff54260527976d31f0
```
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-RC2-php8.5-fpm-alpine` - linux; s390x
