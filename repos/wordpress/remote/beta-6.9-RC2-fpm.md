...
```console
$ docker pull wordpress@sha256:4626154c7e9f0f944dfe61465b9c1d613cbc7e275637bd9ba81d09121cb5ebef
```
...
### `wordpress:beta-6.9-RC2-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC2-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-fpm` - linux; s390x
