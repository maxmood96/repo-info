...
```console
$ docker pull wordpress@sha256:034cdb26154a5158e4fa53c32da253ff27d7a9c1cd3ae6216b2318a8081fb5fe
```
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; amd64
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; 386
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-php7.3` - linux; s390x
