...
### `wordpress:6.3.2-php8.0` - linux; amd64
...
### `wordpress:6.3.2-php8.0` - linux; arm variant v5
...
### `wordpress:6.3.2-php8.0` - linux; arm variant v7
...
### `wordpress:6.3.2-php8.0` - linux; arm64 variant v8
...
### `wordpress:6.3.2-php8.0` - linux; 386
...
### `wordpress:6.3.2-php8.0` - linux; mips64le
...
### `wordpress:6.3.2-php8.0` - linux; ppc64le
...
### `wordpress:6.3.2-php8.0` - linux; s390x
