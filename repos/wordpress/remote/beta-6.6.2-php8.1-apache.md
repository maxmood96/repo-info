...
```console
$ docker pull wordpress@sha256:16d3e7e19785de32cc6d945e4ab7804da38e6a9083fd354591693b14bce1b74e
```
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.6.2-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.6.2-php8.1-apache` - linux; s390x
