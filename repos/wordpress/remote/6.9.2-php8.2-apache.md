...
```console
$ docker pull wordpress@sha256:54823c5eb18810d268f95d2717e5b82a52c557de00d400c2a5db6b2893087424
```
...
### `wordpress:6.9.2-php8.2-apache` - linux; amd64
...
### `wordpress:6.9.2-php8.2-apache` - unknown; unknown
...
### `wordpress:6.9.2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.9.2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.2-apache` - linux; 386
...
### `wordpress:6.9.2-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.9.2-php8.2-apache` - linux; s390x
