...
```console
$ docker pull wordpress@sha256:88806c8cafb3ffe975c68c7020e8b92d6572aa788d5adf875f8a7af9c502aa07
```
...
```console
$ docker pull wordpress@sha256:c84b1afd093768244f3652db3cbf8de005350c63eefe8bd55d36c2916f4eb4bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.4 MB (107388300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13e795cbfbd260db8e4bf3797f68713b681adf10da1d7c5923fd5aec1bb8b115`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 14 May 2022 03:40:33 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 14 May 2022 03:40:42 GMT
VOLUME [/var/www/html]
# Sat, 14 May 2022 03:40:44 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Sat, 14 May 2022 03:40:46 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 14 May 2022 03:40:49 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 14 May 2022 03:40:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e6c68b11996601fb64e784c17146a2ae721ac984d37466cec3912bfdb8747d88`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daca9d5e8c8e6f411d15428da898057bdf07f0eab0863d7b3cb571331650a388`  
		Last Modified: Sat, 14 May 2022 03:57:11 GMT  
		Size: 18.6 MB (18553871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ba0bf1b7807608826b0ecbc427c6e4877d5c9a001eadd9242cbd02cd1daa70b`  
		Last Modified: Sat, 14 May 2022 03:57:07 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47838745e6690678297f2782155f8f72b352821674efe003095249309f770fae`  
		Last Modified: Sat, 14 May 2022 03:57:07 GMT  
...
```console
$ docker pull wordpress@sha256:fbf5ca97a884160a10687275e41ec6623f729790f6eca0ed95d06575cf9c4645
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.4 MB (96433409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7946c3285fb5e43fbf46886633acaf0ecab7ceb64f39c878b24bde7d8ddbf213`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 14 May 2022 01:48:40 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 14 May 2022 01:48:42 GMT
VOLUME [/var/www/html]
# Sat, 14 May 2022 01:48:43 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Sat, 14 May 2022 01:48:43 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 14 May 2022 01:48:43 GMT
...
-	Layers:
	...
	-	`sha256:b93484a6df4ac88d27011642cc82450106442e4291544170449e450e9bc9af78`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:873503df25e6afb1ccca67c8086d41c17ff9c666ced82ed3f76484537d0d091b`  
		Last Modified: Sat, 14 May 2022 02:12:25 GMT  
		Size: 18.6 MB (18553886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1da84f35f8bdbdfbf1c522b67872c8a6797e57793cf596d974762b3b2173df5`  
		Last Modified: Sat, 14 May 2022 02:12:25 GMT  
		Size: 2.3 KB (2335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06048c35c8bf7ef38cc79aa34734ca315f67a373da6926bd637a2512d93e9f07`  
		Last Modified: Sat, 14 May 2022 02:12:25 GMT  
