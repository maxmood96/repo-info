...
```console
$ docker pull wordpress@sha256:afefbdfa8d0cff6a46c39e75e98d654b764d9d2e9e8dd8eafe0afb468b4ad532
```
...
### `wordpress:beta-6.8-RC1-fpm` - linux; amd64
...
### `wordpress:beta-6.8-RC1-fpm` - unknown; unknown
...
### `wordpress:beta-6.8-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.8-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.8-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-RC1-fpm` - linux; 386
...
### `wordpress:beta-6.8-RC1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.8-RC1-fpm` - linux; s390x
