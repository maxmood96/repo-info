...
```console
$ docker pull wordpress@sha256:99b85c037598d2f2047ffaedc7c8e95cce9b3c64f89132ddd5511efdc1d4605d
```
...
```console
$ docker pull wordpress@sha256:d1eb459491aab4c3043024c93d3464b70db85ec2a2ec6177003ed17fbe0b60eb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.7 MB (227745990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c2c966db4aa2812aee93763ffc53fdedb74a9e4f666d9785653bffd8b1e0149`
...
-	Layers:
	...
	-	`sha256:1e377d3ada5b3a62e739a77e9d410a903c7767f78a4b2c3515e6e5628a7d92d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74d16ae3ae54ffacc12c8ebb888c8db08bf9a0c027b42397091ae83df32e3ec3`  
		Last Modified: Wed, 14 Jun 2023 09:13:25 GMT  
		Size: 1.6 MB (1584006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0a7c5a4e6f2e677ef31963f8b3cb96ffc85ca2d9a655ad8be2fd409e88c478e`  
		Last Modified: Wed, 14 Jun 2023 09:13:24 GMT  
		Size: 364.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e311fd5817ca3c22e9f3ffb20aa92d182acba295ca810935c344db15ec529da2`  
		Last Modified: Wed, 14 Jun 2023 09:13:23 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a04720422ca238f69b1e7bce9302707fd2762adc588f6bc142cb1d6585d26e3`  
		Last Modified: Wed, 14 Jun 2023 09:13:23 GMT  
		Size: 19.1 KB (19147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56ddfa9ed2a208b90cd13e7f835e07a146c20e243886848b62373a9a3094d0d6`  
		Last Modified: Wed, 14 Jun 2023 09:13:26 GMT  
		Size: 22.8 MB (22846513 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a0c8627e7deb2486bb072f87c0faf40c9bc53f564dbad5b8d8a9f510b797ed4`  
		Last Modified: Wed, 14 Jun 2023 09:13:23 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f57035db186f86752726439011f63d1d96f42b0393bfe49dd3fa14565eb316f5`  
		Last Modified: Wed, 14 Jun 2023 09:13:23 GMT  
...
```console
$ docker pull wordpress@sha256:5895c737b9d479bfc6b9ed452c9a6ff6dc060edd65bcd9a8375d41fce2beb78e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.2 MB (191153625 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:149559dd3399157478448c34595f1cb4ac3453e114b3f123e3bea7bff921e956`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 08:58:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libicu-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 14 Jun 2023 08:58:27 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 14 Jun 2023 08:58:27 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 14 Jun 2023 08:58:28 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
...
-	Layers:
	...
	-	`sha256:48d57d609783d6d1459a5d27bf898b5842177216e10e974a6cc1f873e626fbe4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22d960174c60e0469252cd5d510e05552b7525d6b4634f0e148f3e203636a955`  
		Last Modified: Wed, 14 Jun 2023 09:05:29 GMT  
		Size: 1.5 MB (1452494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dbaf47c7dfbf7b134a0c17d2a8a4e4af2962db7afe4e0142669bb2b667d9adc`  
		Last Modified: Wed, 14 Jun 2023 09:05:28 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:113686ba2695f54a3963f03ffcae515f2e3ebf8ef8943b3f8b6d29bdef6cbfaf`  
		Last Modified: Wed, 14 Jun 2023 09:05:26 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c33d987643871f2e7ad1d5614954c3118c7294112a3bc0a1bf4752a137d7405`  
		Last Modified: Wed, 14 Jun 2023 09:05:26 GMT  
		Size: 19.1 KB (19147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6b169be697a87315d241cc0621e49e07cf0418cc1824c6ca91c895223cf8bfa`  
		Last Modified: Wed, 14 Jun 2023 09:05:30 GMT  
		Size: 22.8 MB (22846521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1de71ba25cfc4ebb72e082603e289a4bef2d40bf0e3c227156be8d083bbad0ee`  
		Last Modified: Wed, 14 Jun 2023 09:05:26 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21e95b351b8043a5f34495ca154dd403fdd06b74143049b6199685533ab80d7f`  
		Last Modified: Wed, 14 Jun 2023 09:05:27 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:c77e85be00323073c48f675acfcf0692a30925b2bdb1ad8ada191f8db24991cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.1 MB (227095889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1834d8b3e60cbc105f56a6785a88c20b147d018afa22e2f33d3865ebb6170a7f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 07:52:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libicu-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 14 Jun 2023 07:52:26 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 14 Jun 2023 07:52:27 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 14 Jun 2023 07:52:28 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 14 Jun 2023 07:52:31 GMT
RUN set -eux; 	version='6.2.2'; 	sha1='a355d1b975405a391c4a78f988d656b375683fb2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 14 Jun 2023 07:52:32 GMT
VOLUME [/var/www/html]
# Wed, 14 Jun 2023 07:52:32 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 14 Jun 2023 07:52:32 GMT
...
-	Layers:
	...
	-	`sha256:7c0b17f6eb97e2efdc624a36276164c4a7c51429f391b1d5bceb6a91c8c9f6b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6536d6663bcc9140d1ad5ce5893ec4c9fb6cf4a6f0b8d2f54767d7edb0ad491`  
		Last Modified: Wed, 14 Jun 2023 08:01:12 GMT  
		Size: 1.6 MB (1574030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5156f2f83286200b1754d8c6e7eec2274d80b0c43f3b948faaad335b2407524e`  
		Last Modified: Wed, 14 Jun 2023 08:01:12 GMT  
		Size: 360.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3afac9d591b1e42a98cc611e81f322d23bc3e1fc9f30ff3487845a978a755809`  
		Last Modified: Wed, 14 Jun 2023 08:01:10 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0687972cd447104e98c331fd6aa0a22aad5e9eef4fe74fc2037055f3627df053`  
		Last Modified: Wed, 14 Jun 2023 08:01:10 GMT  
		Size: 19.1 KB (19148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29fefdb58407cb86f6cea106e4fc769b91bf5deb3abb31320fd65c9e8ce17318`  
		Last Modified: Wed, 14 Jun 2023 08:01:15 GMT  
		Size: 22.8 MB (22846523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f79987fc4937aa6ff4be6ff17a0af5cb7ed99e53c7cb20d83fe2dcc65d52be9`  
		Last Modified: Wed, 14 Jun 2023 08:01:10 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d15e402c0a6ac407f23df7d74a3b2aef8fcc44ffb4990314943cfb5fa758fb1e`  
		Last Modified: Wed, 14 Jun 2023 08:01:10 GMT  
