...
```console
$ docker pull wordpress@sha256:061c3cfd3f8fc73d56253543b6f4b3e3a081138a1f15b285fd437bcd46544ec4
```
...
```console
$ docker pull wordpress@sha256:c527373640d4c5c592bc6db072e117b3e05a790157089ecd59b0cbb41a7798aa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.7 MB (218740223 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:271111b7b27f03d21e1303a508dd17cf0834803fe70c8d69bf2f9d86cfa5559b`
...
-	Layers:
	...
	-	`sha256:b99b1337d219d3b1d223c6c47c8188ed5f7cde2096b391317835fa5d50c98e4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:578232bef7d4c57bd9f1ec2033cc309c66730809aae3c14a5db94a6a0d4f03bf`  
		Last Modified: Sat, 13 May 2023 03:42:20 GMT  
		Size: 22.8 MB (22844417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e6a6cf275687f15fcc381d542828cbe8988b4de95d884b93c4d0490282c0649`  
		Last Modified: Sat, 13 May 2023 03:42:17 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5451bf93e7bd6aff3763ad7b12120473048cfc0ce9af7afe82941f07978e1ee`  
		Last Modified: Sat, 13 May 2023 03:42:17 GMT  
...
```console
$ docker pull wordpress@sha256:14820fbdc70318b03c69eb55d03f56405c63c2e349862da4112de1c74504674e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.5 MB (194526946 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f964b816df7ba05f772e28db553071f295dadc21a49b7482b01bc5323ce3e2f7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 13 May 2023 00:19:54 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 13 May 2023 00:19:59 GMT
RUN set -eux; 	version='6.2'; 	sha1='6fcc4c21b107a355e3df0798851d41e0d85f0e6d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 13 May 2023 00:19:59 GMT
VOLUME [/var/www/html]
# Sat, 13 May 2023 00:19:59 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 13 May 2023 00:20:00 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 13 May 2023 00:20:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 13 May 2023 00:20:00 GMT
...
-	Layers:
	...
	-	`sha256:50ae3abc262476942fcbb43cc12cb122287b662f0b998020ca79e909199c6ce9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:671c371e47b4ef695a36ffa686131d33b0c787e51d237f3158ebe0f74622f0d5`  
		Last Modified: Sat, 13 May 2023 00:23:25 GMT  
		Size: 22.8 MB (22844430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5f4b1a84f946784106afa49fbc39f05cf65b28f097b6bae91333b2c66df4b50`  
		Last Modified: Sat, 13 May 2023 00:23:21 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5fe254578d5279c235431111c373e835b5bd902fbde31a68a00dab1cdc7fcad`  
		Last Modified: Sat, 13 May 2023 00:23:20 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:dd7a3bd53e1a337cf05d3c7a40951b2a609803b1da9ae8fecb96d191c5a61fc3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.4 MB (185384280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd95de82949f76817bd2152ecf9aeb086e9036ebffcb9faf8259b3da0df6428f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6daeb9086356f7f8827f2f575bda04891f6cb3ebdd144f6f9c24334638c9dfa4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e08052c178bd18204ed13c4191adc4c854cc1b96bcb3bd8f3d0ad8b12ea9c233`  
		Last Modified: Sat, 13 May 2023 01:44:13 GMT  
		Size: 22.8 MB (22844422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c9c117e9da657bd4ea98ee4880a4fca38cb738f0ad75e64a81c479b3f613381`  
		Last Modified: Sat, 13 May 2023 01:44:09 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c609124d748f89a1db2ab0e3f675e63ab1d3c1761de7fefebbfbbbd429a672b`  
		Last Modified: Sat, 13 May 2023 01:44:09 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:09108f9898035f7f5c7bece30bfbf9cad3efa6b0373fe9ad9fba7f384e2b4164
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.6 MB (210612139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82611560a273533e21f60ea009c541caad7234d498cb8385f3f9c28ddf7e25ea`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 13 May 2023 03:39:27 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 13 May 2023 03:39:31 GMT
RUN set -eux; 	version='6.2'; 	sha1='6fcc4c21b107a355e3df0798851d41e0d85f0e6d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 13 May 2023 03:39:31 GMT
VOLUME [/var/www/html]
# Sat, 13 May 2023 03:39:32 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 13 May 2023 03:39:32 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 13 May 2023 03:39:32 GMT
...
-	Layers:
	...
	-	`sha256:dc5099fc1da4d8634350d69a358a6a168448dc4eb0cea1bef510bf5fc5047dea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f648d9fe5e022897e77e9d38c7fcaf1e06e1c765c7202c1c91ca5beb302eb2a`  
		Last Modified: Sat, 13 May 2023 03:44:19 GMT  
		Size: 22.8 MB (22844428 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d751bcef9235cc19bf16548a06d388846f8accfcf28d3c27d564c9380f844e74`  
		Last Modified: Sat, 13 May 2023 03:44:16 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf48912069075819063f4bb4b2c3b036ca960b5bc3689dd093adc9267e1d5e0c`  
		Last Modified: Sat, 13 May 2023 03:44:16 GMT  
...
```console
$ docker pull wordpress@sha256:249b310366aa7dae3ffbc57536fb7dbf7584ff1732e64add455450c9121bb30b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.1 MB (221113782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b86fd31af054b1cbe54147779be5e8a773d14d5507a0013a2580252e22275bb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:ce97125ccbe270f9e84c75bcf80b1f93a7070e0aff3dcdb58467ad0975af157b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32bee2932b6d9f6f26cec720f5aa16904fe27dab9500451c668935e95120d032`  
		Last Modified: Sat, 13 May 2023 03:37:37 GMT  
		Size: 22.8 MB (22844424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42ebfad5cb96cbd3a9f4e173480529a5fa62f7747a229ccf7b6ae266c5af2b9c`  
		Last Modified: Sat, 13 May 2023 03:37:31 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0104b951289739a92205d565b943127ba2dd586e7ada14e41539c31e61f8594`  
		Last Modified: Sat, 13 May 2023 03:37:31 GMT  
...
```console
$ docker pull wordpress@sha256:f814aad804dfd108a41a2b9822ef8a9e21fb32ce5a5980cd14e0a7558860088c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.5 MB (193461917 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:287846b4393e0fa201c30b759a153a715c6d981b225af7717fbbadb8b537547d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 13 May 2023 04:11:24 GMT
RUN set -eux; 	version='6.2'; 	sha1='6fcc4c21b107a355e3df0798851d41e0d85f0e6d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 13 May 2023 04:11:29 GMT
VOLUME [/var/www/html]
# Sat, 13 May 2023 04:11:33 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 13 May 2023 04:11:37 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 13 May 2023 04:11:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:a1dcddd00345593915a0503d12090a30ef670e51ff144be12c1f625104535446`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:168adb8ca2f8d68c358ff224ac66d0a8f4835bda33fcebf83424392dd3626c99`  
		Last Modified: Sat, 13 May 2023 04:25:00 GMT  
		Size: 22.8 MB (22843901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7339bd7f8b2658aac5637e2f9ab3d117a7bdc83940237f582c609e488872e3f`  
		Last Modified: Sat, 13 May 2023 04:24:45 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:307391a3989a387dc82ec80d0134b686abebd3c0c1c6a8a7b502c6209c77604c`  
		Last Modified: Sat, 13 May 2023 04:24:46 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:c21ac523f7d342c17f8095c07846a9ac0841ca76abac3676f33633e90c8cb8a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.5 MB (219513959 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07f0d013244cd47590329c0c57fea185eeb9c218f72b3011abca8a0755d7147c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:59f2f51a578252236885447649ba1d13549a7c0ec68beb60e8c786653fddec8c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:104c444917d039a1136d1469cdbd57d0b92d5f0dc88213321acc438191f4f0e4`  
		Last Modified: Sat, 13 May 2023 04:09:12 GMT  
		Size: 22.8 MB (22844423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c135d2b2aec741f618019175714ba4035bb2182ca6fc7879b2f86b714d4a68d7`  
		Last Modified: Sat, 13 May 2023 04:09:07 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c664c95356ed80543a7fc2a0216f439f8dda250da770d0dbbaa1717561114040`  
		Last Modified: Sat, 13 May 2023 04:09:06 GMT  
...
```console
$ docker pull wordpress@sha256:c334311a85988601ec3b65e2ffc4d4c6029ce470b743f2d00e59c31c52f35154
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193847178 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6192af8a273ae22ab889ce45074fab5027a6a721259fdfe69cd4aa4980fb7f6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 13 May 2023 08:20:13 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 13 May 2023 08:20:18 GMT
RUN set -eux; 	version='6.2'; 	sha1='6fcc4c21b107a355e3df0798851d41e0d85f0e6d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 13 May 2023 08:20:20 GMT
VOLUME [/var/www/html]
# Sat, 13 May 2023 08:20:20 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 13 May 2023 08:20:20 GMT
...
-	Layers:
	...
	-	`sha256:0ac2270a8485f5323c92753518e9c4921c9478d80ee0b695cc7486fc8ab6f3d1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de247dce3f3192b3e16734dbdc378f0438419bcb11d6c6a25b24815206bfcc7d`  
		Last Modified: Sat, 13 May 2023 08:27:04 GMT  
		Size: 22.8 MB (22844424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cccf7eb81d8de8a2fe0f03ae846f1676a637c88fa31f871ed2f819ecb8717903`  
		Last Modified: Sat, 13 May 2023 08:27:01 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:203dd4d660136aa00f2f6491cad07188828c52250462e9c785b3edf1e77c8c07`  
		Last Modified: Sat, 13 May 2023 08:27:01 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
