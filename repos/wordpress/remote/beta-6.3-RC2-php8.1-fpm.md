...
```console
$ docker pull wordpress@sha256:3ac498a1a6d4d47bb04bd85e57199d01f4400cc0974f43c5f2f8b221d3921471
```
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.3-RC2-php8.1-fpm` - linux; s390x
