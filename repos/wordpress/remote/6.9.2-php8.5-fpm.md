...
```console
$ docker pull wordpress@sha256:0121c31996d059a5d58d59f4916f4cf015ab96f150f885b8784433806a60c073
```
...
### `wordpress:6.9.2-php8.5-fpm` - linux; amd64
...
### `wordpress:6.9.2-php8.5-fpm` - unknown; unknown
...
### `wordpress:6.9.2-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:6.9.2-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.5-fpm` - linux; 386
...
### `wordpress:6.9.2-php8.5-fpm` - linux; ppc64le
...
### `wordpress:6.9.2-php8.5-fpm` - linux; s390x
