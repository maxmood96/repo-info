...
```console
$ docker pull wordpress@sha256:3366419bce46a720dec5fe77b13325c2b803d3b726c445766241c4bcd80ade00
```
...
### `wordpress:6.8.3-php8.2-apache` - linux; amd64
...
### `wordpress:6.8.3-php8.2-apache` - unknown; unknown
...
### `wordpress:6.8.3-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.8.3-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.8.3-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.8.3-php8.2-apache` - linux; 386
...
### `wordpress:6.8.3-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.8.3-php8.2-apache` - linux; s390x
