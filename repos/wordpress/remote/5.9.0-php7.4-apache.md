## `wordpress:5.9.0-php7.4-apache`

```console
$ docker pull wordpress@sha256:a39a1209e462907a3002d805407f2e6c7bf95bf2e6fc598da9d590b9b493a33f
```
...
### `wordpress:5.9.0-php7.4-apache` - linux; arm variant v5
...
### `wordpress:5.9.0-php7.4-apache` - linux; arm variant v7
...
### `wordpress:5.9.0-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:5.9.0-php7.4-apache` - linux; 386
...
### `wordpress:5.9.0-php7.4-apache` - linux; ppc64le
...
### `wordpress:5.9.0-php7.4-apache` - linux; s390x
