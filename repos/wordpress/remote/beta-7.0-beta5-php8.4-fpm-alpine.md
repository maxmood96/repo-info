...
```console
$ docker pull wordpress@sha256:8b95ee9cf95cffcffc2b56984106a47b46ad70a5caed302a03dfe2605400e94b
```
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-beta5-php8.4-fpm-alpine` - linux; s390x
