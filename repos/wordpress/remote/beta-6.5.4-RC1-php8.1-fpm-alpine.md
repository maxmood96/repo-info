...
```console
$ docker pull wordpress@sha256:9f51e814ec9041cf219960d4134344e0a8a796adccbb39c33cc36a7805796dcf
```
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5.4-RC1-php8.1-fpm-alpine` - linux; s390x
