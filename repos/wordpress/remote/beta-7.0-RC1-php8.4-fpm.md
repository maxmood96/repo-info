...
```console
$ docker pull wordpress@sha256:a324ce50d1996aae6f67acec7da066843769643f01f23d741ba8ee24185d3c7b
```
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC1-php8.4-fpm` - linux; s390x
