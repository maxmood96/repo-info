## `wordpress:beta-6.1.1-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:577e78bb138a82d64c396511ee33db942e699e2e5e6ea99a388bfa888dc91428
```
...
### `wordpress:beta-6.1.1-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.1.1-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.1.1-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.1.1-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.1.1-php7.4-fpm-alpine` - linux; ppc64le
