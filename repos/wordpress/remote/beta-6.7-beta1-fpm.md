...
### `wordpress:beta-6.7-beta1-fpm` - linux; amd64
...
### `wordpress:beta-6.7-beta1-fpm` - unknown; unknown
...
### `wordpress:beta-6.7-beta1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7-beta1-fpm` - linux; 386
...
### `wordpress:beta-6.7-beta1-fpm` - linux; mips64le
