...
### `wordpress:beta-6.7-beta1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.7-beta1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-beta1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.7-beta1-fpm` - linux; s390x
