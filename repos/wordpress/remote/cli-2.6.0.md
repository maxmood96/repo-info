...
```console
$ docker pull wordpress@sha256:0e08a4f6619bfc10f06651258a86345e4e3311bc53d198a66ab05905d30f9120
```
...
```console
$ docker pull wordpress@sha256:985818db419cfe7d3becf2d1110816b4b9c4fe8b03a0cf2115cc3cfa5ae914c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.4 MB (45428676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:392a892942cb838c9af902b4876e9879f68855fdc6f64aa185a5861eccb3c57f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
# Thu, 29 Sep 2022 16:35:59 GMT
CMD ["php" "-a"]
# Fri, 30 Sep 2022 05:54:40 GMT
RUN apk add --no-cache 		bash 		less 		mysql-client
# Fri, 30 Sep 2022 05:54:40 GMT
RUN set -ex; 	mkdir -p /var/www/html; 	chown -R www-data:www-data /var/www/html
# Fri, 30 Sep 2022 05:54:40 GMT
WORKDIR /var/www/html
# Fri, 30 Sep 2022 05:55:47 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Fri, 30 Sep 2022 05:55:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Sep 2022 05:55:48 GMT
ENV WORDPRESS_CLI_GPG_KEY=63AF7AA15067C05616FDDD88A3A2E8F226F0BC06
# Fri, 30 Sep 2022 05:55:48 GMT
...
-	Layers:
	...
	-	`sha256:92ad13a1fee0dcf2beea6f3def0dd613b9f87c771fc46df05c9f42c938e254e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8211819c7bc8a6c86ec09a8a419dbd983e66fa3062234574012cce0f486f0720`  
		Last Modified: Fri, 30 Sep 2022 06:09:55 GMT  
		Size: 8.7 MB (8706633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b325d86ae54b139c4be0dc38e18146e60bb1e3e29953f86fc91fa14fdd8907b7`  
		Last Modified: Fri, 30 Sep 2022 06:09:51 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed670845ced0b9468fcb3c1be9e9cd3a438be5d2a8fed57e7358811f9cc98fb9`  
		Last Modified: Fri, 30 Sep 2022 06:09:52 GMT  
		Size: 7.5 MB (7466693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ebd5c171204e39d16636a5e80632b6fee5cb53bea9b0f61a7d8340b3c0f91cd`  
		Last Modified: Fri, 30 Sep 2022 06:09:51 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb482f6e5b177aa9c8c12fc4f558843af42b387f6dbbada265f3de17b751f484`  
		Last Modified: Fri, 30 Sep 2022 06:09:51 GMT  
		Size: 1.4 MB (1383730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ca7fcc5ecd439075b8af24ed022068445788e384bd203977898eb30053457c2`  
		Last Modified: Fri, 30 Sep 2022 06:09:51 GMT  
		Size: 410.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:b78f2b353c55e837181fea68802b0d0c76dc0ef6f064c4aefb71b2d07a03bc80
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50566310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b05188f5cd4366cf29da69a0ff2a27f52f3de42d388851e1ed16f82eb6d9d7c2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
# Thu, 29 Sep 2022 18:00:48 GMT
RUN set -ex; 	mkdir -p /var/www/html; 	chown -R www-data:www-data /var/www/html
# Thu, 29 Sep 2022 18:00:49 GMT
WORKDIR /var/www/html
# Thu, 29 Sep 2022 18:01:41 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 29 Sep 2022 18:01:41 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 18:01:42 GMT
ENV WORDPRESS_CLI_GPG_KEY=63AF7AA15067C05616FDDD88A3A2E8F226F0BC06
# Thu, 29 Sep 2022 18:01:43 GMT
ENV WORDPRESS_CLI_VERSION=2.6.0
# Thu, 29 Sep 2022 18:01:44 GMT
ENV WORDPRESS_CLI_SHA512=d73f9161a1f03b8ecaac7b196b6051fe847b3c402b9c92b1f6f3acbe5b1cf91f7260c0e499b8947bab75920ecec918b39533ca65fa5a1fd3eb6ce7b8e2c58e7d
# Thu, 29 Sep 2022 18:01:47 GMT
RUN set -ex; 		apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -o /usr/local/bin/wp.gpg -fL "https://github.com/wp-cli/wp-cli/releases/download/v${WORDPRESS_CLI_VERSION}/wp-cli-${WORDPRESS_CLI_VERSION}.phar.gpg"; 		GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$WORDPRESS_CLI_GPG_KEY"; 	gpg --batch --decrypt --output /usr/local/bin/wp /usr/local/bin/wp.gpg; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" /usr/local/bin/wp.gpg; unset GNUPGHOME; 		echo "$WORDPRESS_CLI_SHA512 */usr/local/bin/wp" | sha512sum -c -; 	chmod +x /usr/local/bin/wp; 		apk del --no-network .fetch-deps; 		wp --allow-root --version
# Thu, 29 Sep 2022 18:01:48 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 18:01:50 GMT
COPY file:b6efa5ff0423d61c2df0c8941b896844a8272d8516cdda0fcae8daaf56baac18 in /usr/local/bin/ 
# Thu, 29 Sep 2022 18:01:50 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 18:01:51 GMT
USER www-data
# Thu, 29 Sep 2022 18:01:52 GMT
CMD ["wp" "shell"]
```
...
-	Layers:
	...
	-	`sha256:bb12a36c64cbfb3c767dd4fd03be6b4e66283a30a3e7a020b42e7cc5fbc80c47`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ab7945aa2f320bbcae3a69864413761f96e8cef2df01df11a20dc327400a4e`  
		Last Modified: Thu, 29 Sep 2022 18:11:17 GMT  
		Size: 9.6 MB (9574861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccbbeb4ef38dfac52a5de3473b3660a7c1fcfd05e241c345741810c9cfdfa2d8`  
		Last Modified: Thu, 29 Sep 2022 18:11:16 GMT  
		Size: 8.8 MB (8768554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c708b7c4b6fb347bde69687f696afb77fc392150254865552bf94b1f0c7430f2`  
		Last Modified: Thu, 29 Sep 2022 18:11:15 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ee2ab6bf519f1b7975ad8266e98911e5ac14f68b14adacad5a5e3c779673932`  
		Last Modified: Thu, 29 Sep 2022 18:11:15 GMT  
		Size: 1.4 MB (1383461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3019af9934f0be0154a6191f8525740927e6f25425ef98456690a9306cd9af77`  
		Last Modified: Thu, 29 Sep 2022 18:11:15 GMT  
		Size: 406.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
