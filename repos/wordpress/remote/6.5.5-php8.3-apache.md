...
```console
$ docker pull wordpress@sha256:b169413474aa68d08fac257b83de9c7dc13d7fc0101c8a26358f3db3978522d0
```
...
### `wordpress:6.5.5-php8.3-apache` - linux; amd64
...
### `wordpress:6.5.5-php8.3-apache` - unknown; unknown
...
### `wordpress:6.5.5-php8.3-apache` - linux; arm variant v5
...
### `wordpress:6.5.5-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:6.5.5-php8.3-apache` - linux; 386
...
### `wordpress:6.5.5-php8.3-apache` - linux; mips64le
...
### `wordpress:6.5.5-php8.3-apache` - linux; ppc64le
...
### `wordpress:6.5.5-php8.3-apache` - linux; s390x
