...
```console
$ docker pull wordpress@sha256:0cf39028f6490a70ddbc5392d2a39918704bebd35e8cf1e033be03a156e157a6
```
...
### `wordpress:6.0.0-fpm-alpine` - linux; amd64
...
### `wordpress:6.0.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.0.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.0.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.0.0-fpm-alpine` - linux; 386
...
### `wordpress:6.0.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.0.0-fpm-alpine` - linux; s390x
