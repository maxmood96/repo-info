...
```console
$ docker pull wordpress@sha256:9a8f49be164c949346ad21aa3fe908ef10577f2dddee8c8d2b04c6ad41873c3a
```
...
```console
$ docker pull wordpress@sha256:d1916f720a390b9991e3d189653532a6dc39edd2606486299f15deb20a667b25
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.7 MB (259744206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e18fb1ee1e451e89b4ba339b440967c593660c3644a99f9ad02119b23980a67a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' + # buildkit
# Tue, 18 Nov 2025 22:17:28 GMT
RUN set -eux; 	version='6.8.3'; 	sha1='fd56bcdc15f1877e45dce67942ea75949ed650e8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Tue, 18 Nov 2025 22:17:28 GMT
VOLUME [/var/www/html]
# Tue, 18 Nov 2025 22:17:28 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Tue, 18 Nov 2025 22:17:29 GMT
COPY docker-entrypoint.sh /usr/local/bin/ # buildkit
# Tue, 18 Nov 2025 22:17:29 GMT
RUN ln -svfT docker-entrypoint.sh /usr/local/bin/docker-ensure-installed.sh # buildkit
# Tue, 18 Nov 2025 22:17:29 GMT
...
-	Layers:
	...
	-	`sha256:cf78e68642942940ce67967641d2052a482916f7285bb5d0f5aa3b0be3f85075`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:949caeb092251e8bccbd1a977c379879478526c86a979322d85f5169e796da40`  
		Last Modified: Tue, 18 Nov 2025 22:18:21 GMT  
		Size: 26.9 MB (26899837 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2cb55ac1ee5836e00b145b4e579025c3ccd4d3781198ffc56d05cab6cdea36f7`  
		Last Modified: Tue, 18 Nov 2025 22:18:19 GMT  
		Size: 2.4 KB (2441 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:77d463ccb73f3086655327bcaad47c1d102f78d1f75ce379cfd2034487394e7a`  
		Last Modified: Tue, 18 Nov 2025 22:18:19 GMT  
		Size: 1.8 KB (1770 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:023f0ead7f7d44a5439a0e86354854df6ff0d1269e687cce15a6700b2e9b5a8b`  
		Last Modified: Tue, 18 Nov 2025 22:18:19 GMT  
		Size: 196.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:f2bb30d9d54da1372855b418d7123cd3632e0f99916b0c089d4e05eac9ec737a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.7 MB (8742512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:167db9bb5d6cd6be7c46c53165772c935b91f52d2ac0eedbafccc3645357592f`

```dockerfile
```

-	Layers:
	-	`sha256:f9593d0a2ac5341c032183338ce7f7f8986c743f05d450495a43938103c54eaf`  
		Last Modified: Tue, 18 Nov 2025 23:14:21 GMT  
		Size: 8.7 MB (8674660 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b836616ebad0559b2d377e33c1e0c7c7c0f5e3a88d0ca0b2bc61b73611260249`  
		Last Modified: Tue, 18 Nov 2025 23:14:22 GMT  
