...
```console
$ docker pull wordpress@sha256:dd149ce1ddf0bd9d7f42d6313d213ae86e48a712a71973b0f69ebcad9372f08a
```
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-beta1-php8.4-fpm-alpine` - linux; s390x
