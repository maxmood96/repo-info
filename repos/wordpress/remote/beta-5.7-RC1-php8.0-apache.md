...
```console
$ docker pull wordpress@sha256:c192c197046723022302c57f4c5148d37508815669d3e9f4705942b069d0ae51
```
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; amd64
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; 386
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-5.7-RC1-php8.0-apache` - linux; s390x
