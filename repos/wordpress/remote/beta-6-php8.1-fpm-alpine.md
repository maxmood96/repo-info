...
```console
$ docker pull wordpress@sha256:f00a9863cae10715bfff5659d4ed14ad9dc40b683e13c133afa18572a7479c3f
```
...
```console
$ docker pull wordpress@sha256:000630667293929572fa6a185303d6fdacb4622709b0d301cf145a8e584feca1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.2 MB (103186373 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c957a5cef72eea3cc5a653c343855e1e0bee82e4d89c400ec4a3d8a7b00b50d`
...
-	Layers:
	...
	-	`sha256:712cfa1e7a2c1cd2cb0bff8139d0268eb692000351dcc620647d83e560400bfb`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fbf5c203d930abbb39424968a4ff6b07b46947460f9a75fe4bfd40592489bab`  
		Last Modified: Thu, 24 Aug 2023 20:38:30 GMT  
		Size: 23.3 MB (23274974 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aae194afaed84159484419ecfd1e89cb785f04a4dfa48e7f66a9e89f426d6284`  
		Last Modified: Thu, 24 Aug 2023 20:38:27 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ef10a1cdf45abd8b70e81b0b71161aa5ed5777e63ccfae2e14c1dd8e7a53629`  
		Last Modified: Thu, 24 Aug 2023 20:38:27 GMT  
...
```console
$ docker pull wordpress@sha256:32de8fddc34d295ef596d9c43f5a3405c0648e0b0ed844291aba7fea66cee951
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.2 MB (100152263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2a48d70f6cd40044d71e9451dce2c8261dcb15a3340fbb71542c9b4c24c9846`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 19:51:40 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:51:41 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:51:41 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:51:41 GMT
...
-	Layers:
	...
	-	`sha256:2ff700dcc98bbf9c60182b868178f51bd1e0eae695b1bbe2cb354b4d0d58c716`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3676f7ffd7236d967bfae51094f0becc11bba80e9eda891a5f4102c5a524b1ff`  
		Last Modified: Thu, 24 Aug 2023 19:57:18 GMT  
		Size: 23.3 MB (23274957 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1d1acacc747e417e93127120e43b7ba022af467ea2f19b4011d6144db6aebd4`  
		Last Modified: Thu, 24 Aug 2023 19:57:12 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0799e30716a076a76112f9dc6d5ace9a0e0689a6edf9474ce8f3ce120a474d13`  
		Last Modified: Thu, 24 Aug 2023 19:57:12 GMT  
...
```console
$ docker pull wordpress@sha256:50246916679520fe4cbf886ae43d177728543cb914dfe635d621d03b4144f5b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.7 MB (108675403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:384f4e63846082193c8a906489b7d732b66edc840342af1f5a74c5e9eb985980`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 20:19:04 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:19:06 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:19:06 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:19:06 GMT
...
-	Layers:
	...
	-	`sha256:367f483737b3709b98412a69b4da2882ee27eb7f465646e3e283c88daf41710b`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e7e55bc4e1b0583b89f80529ad3dda138f3797950ca0f50ff87ad658df76317`  
		Last Modified: Thu, 24 Aug 2023 20:27:37 GMT  
		Size: 23.3 MB (23274972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14d162245fb172a74b345de3c0e2ab5bb92d4a64762d92652b10d357fcc84969`  
		Last Modified: Thu, 24 Aug 2023 20:27:32 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18675484385f2529775dcdb242f3433336a7470c669643dbf80063a90e53fe11`  
		Last Modified: Thu, 24 Aug 2023 20:27:32 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
