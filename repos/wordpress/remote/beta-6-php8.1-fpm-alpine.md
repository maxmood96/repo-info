...
```console
$ docker pull wordpress@sha256:f0d7baf872458f5b06457bcbbe3bf513dbf4c9688249290cf636574cf8940b9c
```
...
```console
$ docker pull wordpress@sha256:0035eb56ce3263f5f2b71127fc3e19423e146e87f26f5540fbd0260333d500e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.8 MB (102833022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5073094f19e7cbe6a0b0651f889bc695095d53f39bf83ca077f111f67849110`
...
-	Layers:
	...
	-	`sha256:af2de495e9e290bf2f6f5fe48edae0dac9ea999d2f241b06e1549b260a59a090`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:198975b667e06d929392e121ae594707a8e6f5cca894cea42c6d1ac59f058ff3`  
		Last Modified: Fri, 17 Mar 2023 01:30:12 GMT  
		Size: 22.8 MB (22846247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78faa84c4f588eacb9c6c80cc31beea4457a14d69b88a33650f05f8107a93ad6`  
		Last Modified: Fri, 17 Mar 2023 01:30:09 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5c1ddc7589ed31bd3eef60afb94b4b426e58be88a581c780e1682cd8dae7c83`  
		Last Modified: Fri, 17 Mar 2023 01:30:09 GMT  
...
```console
$ docker pull wordpress@sha256:c154ce5edc3dea99f60c167422bcca7252e6f779a305254631d6b4cc495c9d53
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.4 MB (96350423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04d6fb31150c27a453b6a1e051486006c31ec138b89a322a5e6aa15b13a7b361`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:aee0f3c611147cf40f8f064c82e030358a9ef35f748a21cc318c33fbcc0f80cd`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b04c86745232c3b7a56d6d0e3c783ad897701518593760097c65119dc776c96`  
		Last Modified: Thu, 16 Mar 2023 23:28:30 GMT  
		Size: 22.8 MB (22846255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:533b22f7027c1ce61a28d2df9527b4cc18247b66d69ca45eca3c55ef6488b9d7`  
		Last Modified: Thu, 16 Mar 2023 23:28:26 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e50460e64807932a004afbc57fa753aa0aff6a02c686aff93242a5fc9c69a0d6`  
		Last Modified: Thu, 16 Mar 2023 23:28:26 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:cf841f52e4685bd602eb1f1b4f5452c9f68d064df5ae92c87d7b87f22f0b9d39
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.7 MB (101721328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2aa71ad79f45c935584164c3a46d285528dcdcca31ff97aa7435de7ee711c161`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 04:55:26 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 16 Mar 2023 01:37:24 GMT
RUN set -eux; 	version='6.2-RC2'; 	sha1='275008d535aa34e840dd8f6913cdb64b6006a9a5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 16 Mar 2023 01:37:24 GMT
VOLUME [/var/www/html]
# Thu, 16 Mar 2023 01:37:24 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 16 Mar 2023 01:37:25 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 16 Mar 2023 01:37:25 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 16 Mar 2023 01:37:25 GMT
...
-	Layers:
	...
	-	`sha256:0175d620a00c42be27eacda1edde08882b954240c9dcc203c6927e136c218e64`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f5e5e8bd146517f74ec3183dfecdec56f3bc3ff1c17128c48cb0069b88f3fbf`  
		Last Modified: Thu, 16 Mar 2023 01:47:03 GMT  
		Size: 22.8 MB (22846246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85a9043932b9699e99b973ed77e028c56842708d7e8b6583c45edc0bc3e3a209`  
		Last Modified: Thu, 16 Mar 2023 01:46:58 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:418c7777bb06b4bf445868418281385b65a51ef198e72176cd25c1a85104ce8b`  
		Last Modified: Thu, 16 Mar 2023 01:46:58 GMT  
