...
```console
$ docker pull wordpress@sha256:5e16f05437702072995248e2b1e14973a695077fbf3c5d861261703332def2d8
```
...
```console
$ docker pull wordpress@sha256:42c816efe13ca5b46c00488e726a5901c857bd45aad5c37ddb3e6889d5238c83
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.3 MB (97331550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e02c9654fb82fa79c1dc7ace06fb3dbce233b8917f3cbe0a7b160f8826b70f5f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:fe99031dab12d5ee8b3d16c2fa8a539380deff4f615303a822a350eafe89488a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e88382be1709e08867217c5db0e4d0814c866646c642fc5d1a3f3800f3def1`  
		Last Modified: Thu, 27 Jul 2023 22:51:06 GMT  
		Size: 23.3 MB (23270560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc6c95066fcb6506040a6152c55a63108129af91018d21b019ffeb5086695f27`  
		Last Modified: Thu, 27 Jul 2023 22:51:02 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc04d60d91225faff18c94e105fa9ad9f8b3a10714d45c07fba5516b69e776c1`  
		Last Modified: Thu, 27 Jul 2023 22:51:02 GMT  
...
```console
$ docker pull wordpress@sha256:d2372b6860869587de727fb42dc1d301569148aafb540184185e9f1ead5cab67
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.0 MB (102021888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:351cac5639dbc765adf22ea428cf6e4de33e01b66c8628bbec80a2d06d082051`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 07:38:28 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 20 Jul 2023 04:33:13 GMT
RUN set -eux; 	version='6.3-RC1'; 	sha1='e8c51f48b05d78f6e32e1350e9ee2d551f052a93'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 20 Jul 2023 04:33:15 GMT
VOLUME [/var/www/html]
# Thu, 20 Jul 2023 04:33:15 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 20 Jul 2023 04:33:16 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 20 Jul 2023 04:33:16 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 20 Jul 2023 04:33:16 GMT
...
-	Layers:
	...
	-	`sha256:9c9e8a0e3f4b84b651669588cf3d9e460eddc2b5a5deaa7babf8585d61145c89`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5e27392333cfa629ccfa7edfb58105a7026c7af682f900e009aad457b29d0bd`  
		Last Modified: Thu, 20 Jul 2023 04:37:57 GMT  
		Size: 23.3 MB (23268852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:107882475d7a008b2f33c72510eeef42e712ac16d15ebd7e67e03adc7ab7023c`  
		Last Modified: Thu, 20 Jul 2023 04:37:54 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a8d37d189700cfb1bff90ae5a7d33a7df43bb44a12a48615dd099f0b9ca4bc0`  
		Last Modified: Thu, 20 Jul 2023 04:37:54 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
