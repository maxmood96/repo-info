...
```console
$ docker pull wordpress@sha256:5eb7758979fe17f4990a9534d3ec487a06e0273749f22c6d8bf536c801ca43da
```
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; amd64
...
### `wordpress:beta-6.8.1-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; 386
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; mips64le
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-6.8.1-php8.3-apache` - linux; s390x
