...
```console
$ docker pull wordpress@sha256:129b9ff2391dcac643105aa4738ce22cf4e9b7d32d47573dfe4301fc8fe5d5d1
```
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; amd64
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; arm variant v5
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; 386
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; mips64le
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; ppc64le
...
### `wordpress:beta-6.0.2-RC1-php7.4` - linux; s390x
