...
```console
$ docker pull wordpress@sha256:bdd44ce9333af0f22f2ab2d2cf83c53bb3512bffbd48149eee8e919fb2b5209b
```
...
```console
$ docker pull wordpress@sha256:2404bce188b5489a6a68edfdd78d7e527808a46888ccd4c6c9c5179387003628
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.7 MB (210688036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44901edb40303c2fe24ebaf57c69e2afe2ae39dfd70b08703341ae2186515071`
...
-	Layers:
	...
	-	`sha256:76bffc8f585d27d311bfd688f39e6980473fa83961e63f76f6c8f3a6d67ad1eb`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e54f40881da82209dfc7374829c3e22348572d37f70f0676216793ec4ffdf194`  
		Last Modified: Wed, 26 Oct 2022 19:19:11 GMT  
		Size: 21.0 MB (20996768 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a31e280d6b4aa3cc23491fb71d89d45fef65cea89998a5ddd739c2afa4e45080`  
		Last Modified: Wed, 26 Oct 2022 19:19:08 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0756344c40383ad87bd13e58ece1f79a7d9fec7b6293048976ed883ecf5f18a7`  
		Last Modified: Wed, 26 Oct 2022 19:19:08 GMT  
...
```console
$ docker pull wordpress@sha256:542e91f5459530d59be7f1811af7468aff1a668d4d77ca2eb47051a8a901f97f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.7 MB (185689840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df6d7dcd4562e15c5c24480eadd9ffe3b8c329ccac98454070bc20306cfd28ed`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 26 Oct 2022 17:54:55 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 26 Oct 2022 17:54:59 GMT
VOLUME [/var/www/html]
# Wed, 26 Oct 2022 17:55:03 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 26 Oct 2022 17:55:07 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 26 Oct 2022 17:55:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 26 Oct 2022 17:55:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:26500014e3211be98428968a8e5524ad75ef0ad1ab8f819fe19b64f9ec179111`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a189a1e4d44576d7296f56512a469a8e550650aba36d240b1216c44385b7874`  
		Last Modified: Wed, 26 Oct 2022 18:38:33 GMT  
		Size: 21.0 MB (20999811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b8ca24e1d9ed4f26de8b8b32c1a04501c6119f2f209dc4519cffe2087e999ca`  
		Last Modified: Wed, 26 Oct 2022 18:38:19 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c6c002d17c826672ce696567176eebb9215dde0fdcbaba74342267ba0d66bb4`  
		Last Modified: Wed, 26 Oct 2022 18:38:19 GMT  
