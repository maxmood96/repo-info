...
```console
$ docker pull wordpress@sha256:cf14085c9a50c553658477f6b819df29a8aecdbcd567252a186a3cc66e90d255
```
...
```console
$ docker pull wordpress@sha256:654f20cb3d1e4b0fa8855836286fc104fc4dbaaec48a8c8c66b3ba6a5969ed74
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.6 MB (210612058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f42b73d3cfd6931effa80118b7e2c31f6bcf9411f3964f1e8e7c4228886cab0`
...
-	Layers:
	...
	-	`sha256:00323a44232901fd11a097903e9aa8830ce0d8b58b24a810a48dc1344a3763ec`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a6dbbfb480da2cf5ca3bcd2bad5dd08766a490b5c43b118c9d11c2ccf4a1415`  
		Last Modified: Tue, 23 Aug 2022 23:51:56 GMT  
		Size: 21.0 MB (20994564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cd8a4cb346f47a3ed1a12ab828c5c9be80ae5e2db90c2492464ef1da6c9e7dd`  
		Last Modified: Tue, 23 Aug 2022 23:51:53 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:166cd822797b76a24f803b8959ecc61ca2c0cc4bfe485707418142e3fecaef7a`  
		Last Modified: Tue, 23 Aug 2022 23:51:53 GMT  
...
```console
$ docker pull wordpress@sha256:24d866869da3c1a10951ed0a4afb01145a9bf13a62e3aaa2c4fa18383bacb5d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.1 MB (187051498 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f473adebd8b28142bf66135899db16e8b6ae37529fac22257f4404fa5708a613`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Aug 2022 00:34:57 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Aug 2022 00:35:02 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 24 Aug 2022 00:35:03 GMT
VOLUME [/var/www/html]
# Wed, 24 Aug 2022 00:35:03 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 24 Aug 2022 00:35:03 GMT
...
-	Layers:
	...
	-	`sha256:3e761c4a4a84e40c4016b6b25ab47c22ffaa7ab1e24d614bcc50dfcefd700144`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e45f70d566cc47e962cc1b58b28f6735f43417e1e7a49de96dfa44f1d218760`  
		Last Modified: Wed, 24 Aug 2022 00:53:05 GMT  
		Size: 21.0 MB (20994565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d771205f160010a5f81ce15f10ed4b74b78db1b49049e6078ecbfd637303a476`  
		Last Modified: Wed, 24 Aug 2022 00:52:58 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bb9d781bdc10a2ef062d12c3cfb3a9fb2640791b319b19c390500ffb2907061`  
		Last Modified: Wed, 24 Aug 2022 00:52:58 GMT  
...
```console
$ docker pull wordpress@sha256:e12fb7697007007c8dca1b310b898ac2741dbc0df41ba034e5b457051a5d8b72
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.2 MB (178168094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc4d20bae740042e2eaf1e8e8390a14cdd6cfaa7e622779dd17c09e67c4761f5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:37204bfa66c844bbe040faac21a3155b7f61bb1f1cf3ea84d41a1df8f529741a`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef0a441833e73aa966f04a2b5b3df02a68a208ddafaeabd1145ed2336a6ab0d9`  
		Last Modified: Tue, 23 Aug 2022 12:27:41 GMT  
		Size: 21.0 MB (20994557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aafa23c506a05d411dedf73a42c5967957386d4bbfc5c66d33d802b1821c0718`  
		Last Modified: Tue, 23 Aug 2022 12:27:32 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0fceae2a04cebbbb9c033728242452869be75d15f512c6c1a03a53b1f9d0397`  
		Last Modified: Tue, 23 Aug 2022 12:27:32 GMT  
...
```console
$ docker pull wordpress@sha256:d78af330f0a39f46416861246455708bb59071b37a688ab796a052f6655f4f86
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.4 MB (201422004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:382da67f4047fc20c4e58902614319fe02bc3cd61cf20bce82ec2935578944c5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Aug 2022 01:51:31 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 24 Aug 2022 01:51:31 GMT
VOLUME [/var/www/html]
# Wed, 24 Aug 2022 01:51:33 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 24 Aug 2022 01:51:34 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 24 Aug 2022 01:51:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 24 Aug 2022 01:51:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d17ff779d27bd330c229558a1adb5bbb1dbebbcede1fed896aac0c800cf082d`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b247989ae36d122736f44b08cf8e6f321dd096822a7170b189421943b772b38`  
		Last Modified: Wed, 24 Aug 2022 02:08:09 GMT  
		Size: 21.0 MB (20995792 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:418af483a120d7eb0d13bdc8d6ff2f9e6a9a35d1be2ee0dde34bd51664b2c12a`  
		Last Modified: Wed, 24 Aug 2022 02:08:05 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b57c7cf87d93984bb2d21b295246f57056b3477fc7aca4d048c9ac6da5b2045`  
		Last Modified: Wed, 24 Aug 2022 02:08:05 GMT  
...
```console
$ docker pull wordpress@sha256:052082796fef52164990c4b1d78d9920c70f846a68665e8629f07898c93f5c6f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.9 MB (211945092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:331a2287bd76e934c792869aebc7b8ce9d0fd17db98849047f434e09f34b27c4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 23 Aug 2022 20:47:40 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 23 Aug 2022 20:47:41 GMT
VOLUME [/var/www/html]
# Tue, 23 Aug 2022 20:47:42 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 23 Aug 2022 20:47:43 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 23 Aug 2022 20:47:43 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 23 Aug 2022 20:47:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:aabc58ce794f976ae539779dc8f470d9ec8cc2e48ab4f66af5594da2eb92c026`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a0dbf99ee7459bfbfcac57d33a2a49413f5f24d472468f64d0b75c08645917`  
		Last Modified: Tue, 23 Aug 2022 20:59:08 GMT  
		Size: 21.0 MB (20995764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76eeb67a32c6d98ff3589b1cda072e5085ff7d21cd0f72b877777b5a5a44e187`  
		Last Modified: Tue, 23 Aug 2022 20:59:04 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d22d8e51f03d82973e14e5bafdcc0ba43b60b38b425c8ac731a290211e6c3042`  
		Last Modified: Tue, 23 Aug 2022 20:59:04 GMT  
...
```console
$ docker pull wordpress@sha256:1968068b1e97ef7133b5dbc36795792bd8941f4e63dff3faef8659882874fe77
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.7 MB (185685081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a0b4e121b40480c6957b1c47a6a64099fda67612d671bf56816971c2b071893`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Aug 2022 02:02:46 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 24 Aug 2022 02:02:51 GMT
VOLUME [/var/www/html]
# Wed, 24 Aug 2022 02:02:55 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 24 Aug 2022 02:02:59 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 24 Aug 2022 02:03:03 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 24 Aug 2022 02:03:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f06d8e32b82cfe591011c1d2aecd96cb0b64957e84fe820308647e0d44b43d54`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7278434df6399a4fbfff66b42750a5d36f41a38db527f787a7a2a31c726aeb79`  
		Last Modified: Wed, 24 Aug 2022 02:49:18 GMT  
		Size: 21.0 MB (20995768 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b18434c38afcbee70bafb4f9eea515d0b3309590fdee3c593038535f6c0c3b04`  
		Last Modified: Wed, 24 Aug 2022 02:49:04 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fada7c61405ea60bfcf76895303279a38112a54ca776f963df6daf591f1599ad`  
		Last Modified: Wed, 24 Aug 2022 02:49:04 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:05e31fdc76a27fd441f79aa0adc9b5c6f5bc5b36260c9d4e37ff3cb15953038b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.2 MB (211166982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9afdb28999948b1fd5ddb5a9efb739d03adde22e74bd4e6f23113b5936cdd08`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 23 Aug 2022 19:40:08 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 23 Aug 2022 19:40:10 GMT
VOLUME [/var/www/html]
# Tue, 23 Aug 2022 19:40:10 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 23 Aug 2022 19:40:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 23 Aug 2022 19:40:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 23 Aug 2022 19:40:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:08b39ebb515ac583888e01803edea2a4e530f96441c10dbb5a8ebe37568940e2`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97774f60bc513b0fd4f0178321174f61754278d04f9bc92a040f8c05ce3233f9`  
		Last Modified: Tue, 23 Aug 2022 19:57:23 GMT  
		Size: 21.0 MB (20994563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f03ca06c766e4fb3ac70d738798a6d4edfc305e9adbdb0c188c4c06aef1c05f`  
		Last Modified: Tue, 23 Aug 2022 19:57:17 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a297532f8620595f34dc427ed1e2d6bc44f24e5f5b3b9f3921b3a56f9fc259a`  
		Last Modified: Tue, 23 Aug 2022 19:57:17 GMT  
