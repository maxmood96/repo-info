...
```console
$ docker pull wordpress@sha256:e92536c6d91f072021d4416b9e9235e182d7f18f07eec396764126cfa45d0f8d
```
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; 386
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC2-php8.3-fpm` - linux; s390x
