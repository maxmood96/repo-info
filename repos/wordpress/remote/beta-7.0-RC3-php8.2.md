...
```console
$ docker pull wordpress@sha256:7364ca7fb9956a4bda0b01a3aa482dabaaf732ae282e34d01805fef364fc489e
```
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.2` - unknown; unknown
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.2` - linux; s390x
