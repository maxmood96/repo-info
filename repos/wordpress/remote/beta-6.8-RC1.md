...
```console
$ docker pull wordpress@sha256:8848a2aaafff5a3ee8aa70ff9fa12741d9f981e650c8659e21cbd0400ec5bf77
```
...
### `wordpress:beta-6.8-RC1` - linux; amd64
...
### `wordpress:beta-6.8-RC1` - unknown; unknown
...
### `wordpress:beta-6.8-RC1` - linux; arm variant v5
...
### `wordpress:beta-6.8-RC1` - linux; arm variant v7
...
### `wordpress:beta-6.8-RC1` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-RC1` - linux; 386
...
### `wordpress:beta-6.8-RC1` - linux; ppc64le
...
### `wordpress:beta-6.8-RC1` - linux; s390x
