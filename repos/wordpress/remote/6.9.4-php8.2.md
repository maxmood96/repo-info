...
```console
$ docker pull wordpress@sha256:882035e4aa61d8f42c8b4a1c95814df910a1425e22e4f7b4ab047b34adf328bc
```
...
### `wordpress:6.9.4-php8.2` - linux; amd64
...
### `wordpress:6.9.4-php8.2` - unknown; unknown
...
### `wordpress:6.9.4-php8.2` - linux; arm variant v5
...
### `wordpress:6.9.4-php8.2` - linux; arm variant v7
...
### `wordpress:6.9.4-php8.2` - linux; arm64 variant v8
...
### `wordpress:6.9.4-php8.2` - linux; 386
...
### `wordpress:6.9.4-php8.2` - linux; ppc64le
...
### `wordpress:6.9.4-php8.2` - linux; s390x
