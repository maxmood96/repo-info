...
```console
$ docker pull wordpress@sha256:5a7917901fe016c8b2b9b9de92ffacc016dc7c3b42b833ad504fd2075e0a3a6d
```
...
### `wordpress:6.5.2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:6.5.2-php8.3-fpm` - linux; mips64le
...
### `wordpress:6.5.2-php8.3-fpm` - linux; s390x
