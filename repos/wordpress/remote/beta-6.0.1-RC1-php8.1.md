## `wordpress:beta-6.0.1-RC1-php8.1`

```console
$ docker pull wordpress@sha256:8abc24b062046e7b9815bdf565ea50326475334c9e211fd75c10d01cab5472e7
```
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; amd64
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; 386
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; mips64le

```console
$ docker pull wordpress@sha256:1ff0e7573f9c29e551bb7e4c11abdc43c4c54dd14cad08d20ada5cc9d05451a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191322484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2420a8202e915372f909ba11cb2fbd8f3da389d1024dc6b38980210ac1afeb68`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Mon, 11 Jul 2022 18:54:13 GMT
RUN set -eux; 	version='6.0.1-RC1'; 	sha1='37b555bc69bb4b15d079a0b597059fce5a16efd4'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Mon, 11 Jul 2022 18:54:17 GMT
VOLUME [/var/www/html]
# Mon, 11 Jul 2022 18:54:21 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Mon, 11 Jul 2022 18:54:25 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Mon, 11 Jul 2022 18:54:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Mon, 11 Jul 2022 18:54:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8af650e67f733dfd681c2a0ca5e8407886c2b983f567067f21b698e66b7752d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c44b316f41eb47b3f6c7ac26a5852e183e66c137db4bd5b82d9c0ce66fa38f1`  
		Last Modified: Mon, 11 Jul 2022 19:01:04 GMT  
		Size: 21.0 MB (20995565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:924ed24ee3924180e33319cc120c0f8c53830216e2e763200efe896ee9fb111d`  
		Last Modified: Mon, 11 Jul 2022 19:00:51 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e1ee377e061e3b226040bc1d645bdd5ea3d84e386b9b147cfa9535e7a58106e`  
		Last Modified: Mon, 11 Jul 2022 19:00:51 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.0.1-RC1-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.0.1-RC1-php8.1` - linux; s390x
