...
```console
$ docker pull wordpress@sha256:b925f670e81c9edaa111eadd56883b6b7ddcbe2f2545cb744113cfc5a07dd1e2
```
...
### `wordpress:beta-6.4-php8.3` - linux; amd64
...
### `wordpress:beta-6.4-php8.3` - unknown; unknown
...
### `wordpress:beta-6.4-php8.3` - linux; arm variant v5
...
### `wordpress:beta-6.4-php8.3` - linux; arm variant v7
...
### `wordpress:beta-6.4-php8.3` - linux; arm64 variant v8
...
### `wordpress:beta-6.4-php8.3` - linux; 386
...
### `wordpress:beta-6.4-php8.3` - linux; ppc64le
...
### `wordpress:beta-6.4-php8.3` - linux; s390x
