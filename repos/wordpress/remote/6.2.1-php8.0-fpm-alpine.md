...
### `wordpress:6.2.1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:6.2.1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.2.1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:6.2.1-php8.0-fpm-alpine` - linux; ppc64le
