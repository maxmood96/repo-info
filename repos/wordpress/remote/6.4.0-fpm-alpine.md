...
### `wordpress:6.4.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.4.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.4.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.4.0-fpm-alpine` - linux; 386
...
### `wordpress:6.4.0-fpm-alpine` - linux; s390x
