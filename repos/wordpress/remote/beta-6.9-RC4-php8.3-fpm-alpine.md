...
```console
$ docker pull wordpress@sha256:60b6fd67689fea821eda8b11e2723b7adb878deeb72dbd9d5ed7b95220682ff5
```
...
### `wordpress:beta-6.9-RC4-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC4-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC4-php8.3-fpm-alpine` - linux; s390x
