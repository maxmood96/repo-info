...
```console
$ docker pull wordpress@sha256:ff331ff27009fa01b72430033dcff3069331325e677cf10d1f1f22b4973e8627
```
...
```console
$ docker pull wordpress@sha256:3a960d500bc6f02b8eeb1555583d5331e2854b102c725797a9eb442965936c62
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188367099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ff528a6257d3f11b79f48fc0e2efa91ccda532de34fb518fd4258b552a4495e`
...
-	Layers:
	...
	-	`sha256:9d18afd88d9835b61728472261cc88f75d530281886b1afaa0a43b3fd951d31b`  
		Last Modified: Thu, 13 May 2021 19:16:40 GMT  
		Size: 15.6 MB (15587075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcca469c6eb9fa663bf2491d9d4d2580e3a7a813254ff1d0da4b71b0f7ebce79`  
		Last Modified: Wed, 19 May 2021 23:47:08 GMT  
		Size: 2.4 KB (2359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2380b04c4de656fc508df2d8cd2e613936e2dc571d8b90d22945036469e6fba`  
		Last Modified: Wed, 19 May 2021 23:47:08 GMT  
...
```console
$ docker pull wordpress@sha256:9dbd24b1afbf2c54c7b82ead8a4fe00b41efc21cc1ab1dc3a445bd6c6b16f2e2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.1 MB (165126133 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91ae5ace30763c2760f0273f5d0b5bfe9911ca9538fc554052f082e01b5c64af`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 13 May 2021 19:32:16 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 19:32:18 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 21:30:07 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 21:30:08 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 21:30:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:57ea5ec68aea89e01e5a06036728d7b3e0f0ad5f87ab7252c1b941e26d081ff6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2d41aab921d54fc035fb53337970cd760283a833e67721277696ff124d7392c`  
		Last Modified: Thu, 13 May 2021 19:35:29 GMT  
		Size: 15.6 MB (15587074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4d4e7a8de63592b7ecdb4992e4624558e870c2dc7648218df7dda78c4d06628`  
		Last Modified: Wed, 19 May 2021 21:31:48 GMT  
		Size: 2.4 KB (2365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54b813e2ad665456338d7ee118da2c8b0a103a2ea075a4eda1ed28bf1298c31d`  
		Last Modified: Wed, 19 May 2021 21:31:48 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:6b4728bcdfac48f1f38ea0c11f87a47fd7246b849dd0b68a4e97dd13adf93198
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161190405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:715531adad6df67d1f0441ce02aa9819a8c5ccde4e740aed36eae3a5300d5a59`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 13 May 2021 19:08:48 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 19:08:49 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 22:17:31 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 22:17:32 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 22:17:33 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 22:17:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:45a6942cdfa4041fb4f62f8f76a0e282454df0a48987867508c08b69b13d833f`  
		...
		Size: 19.5 KB (19481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9b6ab24fe88309ae633b224c3437d749ff738fd1144d0acd3eee486c5c2de3c`  
		Last Modified: Thu, 13 May 2021 19:13:13 GMT  
		Size: 15.6 MB (15587073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b93bb7acf89dd540816f55a7ee8a3efb612e6f5a94966a0ec7e5adbf2a0d1e7`  
		Last Modified: Wed, 19 May 2021 22:21:33 GMT  
		Size: 2.4 KB (2362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87f5f91a60be26a615d9ac9150e6c63b4e55be16ff7918ac7ad86960c6f0c050`  
		Last Modified: Wed, 19 May 2021 22:21:33 GMT  
...
```console
$ docker pull wordpress@sha256:0063663e2057125928816791fa6fbd5de82e414c4f932c29ee0c35b6be5f0f53
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.9 MB (178855177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40e83301e4890c5f149cb978cb14aba10c959df6d7c811370730a75122801fff`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 13 May 2021 20:50:21 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 20:50:24 GMT
VOLUME [/var/www/html]
# Thu, 13 May 2021 20:50:25 GMT
COPY --chown=www-data:www-datafile:4bf3e33874fc7286d57546f67c8371a0c4b9a02171c1d835cc588fc3cee4aa07 in /usr/src/wordpress/ 
# Thu, 13 May 2021 20:50:27 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 May 2021 20:50:28 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 May 2021 20:50:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:407657ab065e8d96c3d9dcdd2b8fedff2ec9f4cbe6a9d6dec7bf89a4bee247b7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2360cfba8423dbe485e59f2c95ccfa94ec4f6ade1fc46092763487d3b570024`  
		Last Modified: Thu, 13 May 2021 20:54:45 GMT  
		Size: 15.6 MB (15587077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:952a6500787a5782a17c95a127d9915fcb397fb66b5fd6ca508108eada68726c`  
		Last Modified: Thu, 13 May 2021 20:54:41 GMT  
		Size: 2.3 KB (2331 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b3ced6c70cb0f98f3352403524beb2217105f20d39b557b6ecffccff1f7c0a7`  
		Last Modified: Thu, 13 May 2021 20:54:40 GMT  
...
```console
$ docker pull wordpress@sha256:f86030f8329e47d2a426442c2dfcf87525d870e2a08a0b0ff681fc803c6cd6fe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.9 MB (193924657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ceba329d5e229fd5441a7223f73a5d69c5c7d73fda6197c517f8b89c76354b58`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 13 May 2021 18:41:39 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 18:41:40 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 21:06:56 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 21:06:57 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 21:06:57 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 21:06:57 GMT
...
-	Layers:
	...
	-	`sha256:3965cf978d19118705eccd69931c310a7b35779aef16f06d6aba2ed00f4c39d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ba55b9b9e88d4767b312ccb94f1c2a6826b7e67ae52a566c95cba4d7406e229`  
		Last Modified: Thu, 13 May 2021 18:46:57 GMT  
		Size: 15.6 MB (15587072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917f9fb27aced4fb52f306028b196acd0dbf4231ee9454ff620e4b1ecbe6302b`  
		Last Modified: Wed, 19 May 2021 21:11:40 GMT  
		Size: 2.4 KB (2365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aadac2157eb133b3ca7881c67c59a4862004d340e3d46d4b6315f1ad18e34c5b`  
		Last Modified: Wed, 19 May 2021 21:11:40 GMT  
...
```console
$ docker pull wordpress@sha256:3a2f2f92245a4ba75c48f6982ee03829a93593e89bab98442f24f11a270728a9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.3 MB (169287688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84a83717cf3d6fa74f6610e94603e07e3b8bcd6ab3b5bbd49bd99f02e238c70d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 13 May 2021 18:09:04 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 18:09:05 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 21:07:37 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 21:07:37 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 21:07:38 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 21:07:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c98ee6d3a0f1e072af97cfb568872ff0ef14e4a6850b025c3b2f6332a501d75f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fd7e7d0e0ea4d5532c1fef582723234544a4208fce30e076416d279fb1a80eb`  
		Last Modified: Thu, 13 May 2021 18:11:06 GMT  
		Size: 15.6 MB (15586929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba16cf6ae4a7311224889d484c907322120f878d0c319e88f7a5bf65a412b9c2`  
		Last Modified: Wed, 19 May 2021 21:08:37 GMT  
		Size: 2.4 KB (2363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a10e7d098f9ad2e3b57fbdff54fe78d69c6d4bfbd96c241ccceba8e6f4ac099a`  
		Last Modified: Wed, 19 May 2021 21:08:37 GMT  
...
```console
$ docker pull wordpress@sha256:16b26715c5e268c987be416d3e64a6cd7a5705a7003a9f0e52fa3b09920f2fa3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.2 MB (200165924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0880b5d4455dac176fa7691d1aa1e112c5615d83d0f98451efaf9d7238dc851f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Wed, 19 May 2021 22:45:59 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 22:46:02 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 22:46:07 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 22:46:13 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:72d53100d6e849b1fd9ec652ef623d65bd27d659ffedf1591529079bc7e2e3d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0475b3ed42ad674486bebc7750a7f0d99344a505df9c82c57aee66c71915f418`  
		Last Modified: Wed, 19 May 2021 22:57:22 GMT  
		Size: 2.4 KB (2361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ea58af45941db62adec38688dde315f3f228e5c150d2b54aa7e72b0f0b47adc`  
		Last Modified: Wed, 19 May 2021 22:57:22 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:666cdd6376b28616cda45c41d79d36e7c45869f005cf4d83f032c64180832862
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.6 MB (172550952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28566fa58f2a0b89f2cf89d7ed4cd4ac91fa9e6043563c9f6dd0a5cfb75da418`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Wed, 19 May 2021 23:32:14 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 23:32:15 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 23:32:15 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 23:32:15 GMT
...
-	Layers:
	...
	-	`sha256:c13a89b51cef0e10f244098028d4ebe1bb6ae48bcce88a71a0440143e9818c96`  
		...
		Size: 15.6 MB (15587077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:660c33195509f1945d2ba201397645c5f97a2edec5917d66236000f962ea4ce7`  
		Last Modified: Wed, 19 May 2021 23:35:48 GMT  
		Size: 2.4 KB (2366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19129352c96af13c1dccc86b73ce174391ca3f6613d63cbec4ec96288af160a5`  
		Last Modified: Wed, 19 May 2021 23:35:47 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
