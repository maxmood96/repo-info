...
```console
$ docker pull wordpress@sha256:c2433ece5d2d1fca7b696a4b4e03e77160b0aaac7771bf9c8b3971ca43ff3ead
```
...
```console
$ docker pull wordpress@sha256:ed998894079a02a6c9b620ba8fcc025362376a3cc9988a37c780d6e38075368b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188344573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa58a354af433fb6e8ef2d65c6138ed679065542b3a3c3618694e945c71eb67a`
...
-	Layers:
	...
	-	`sha256:47c48169dcd41dbcf54af2fabfa19528d9cffb0cf211274831e6dc28cf284841`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19b34857b09760be75d2a94d0f7dcd5e76cfcb42e6e62ee391a838bc898a7be7`  
		Last Modified: Sun, 11 Apr 2021 06:12:33 GMT  
		Size: 15.6 MB (15584417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6170f4e89d76e89c0030b2a0fa5311dbed3f9d4cd4327aa3b818f6ef947d7e5b`  
		Last Modified: Sun, 11 Apr 2021 06:12:30 GMT  
		Size: 2.3 KB (2270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb2df5e413d651c16df429a2ee32b796eddeaca1d36d3a8e396bd0fd6a647856`  
		Last Modified: Sun, 11 Apr 2021 06:12:30 GMT  
...
```console
$ docker pull wordpress@sha256:4a34fc3d46b67a7dc410cb63b280d71315bc1a62789be01775b2b1e180bf4c5d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161171779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21c7135d91b621a22ef71d46a806bbd3f765544686d96c3c3991bcdbb31a5734`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	version='5.7'; 	sha1='76d1332cfcbc5f8b17151b357999d1f758faf897'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sun, 11 Apr 2021 03:32:23 GMT
VOLUME [/var/www/html]
# Sun, 11 Apr 2021 03:32:24 GMT
COPY --chown=www-data:www-datafile:9beb76b36e5a8771e2d474e3ff2f225e755dc51e60553800642ac1aeed4e7df4 in /usr/src/wordpress/ 
# Sun, 11 Apr 2021 03:32:24 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sun, 11 Apr 2021 03:32:25 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sun, 11 Apr 2021 03:32:27 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e9a9a086f655f3e0fdb2ef394ff2b1925bbc56e2103233b16a9993cb28053b34`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c51e074e25b0f49bd4d6e09fb22b755ed8b699b387bbca30b5c88d00dc56a8ea`  
		Last Modified: Sun, 11 Apr 2021 03:53:19 GMT  
		Size: 15.6 MB (15584420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a0ae6f55a8ed2982de0743d24d58d2be1dd41459fb13812bbbd3b3590f1a73`  
		Last Modified: Sun, 11 Apr 2021 03:53:13 GMT  
		Size: 2.3 KB (2274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a9e73d7b4d503984502e759d586fa4a06115a2b1e8b45e7bf5a5620009c2abc`  
		Last Modified: Sun, 11 Apr 2021 03:53:12 GMT  
...
```console
$ docker pull wordpress@sha256:af53e67d94f322fc51edf4879dea0708829d244e79194e517f210c658bf7f659
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.8 MB (178831202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4404b93e4c556d001b89fbe9969ba3ad483444930e1d8df1833c93522ba6c9c2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sun, 11 Apr 2021 03:08:50 GMT
RUN set -eux; 	version='5.7'; 	sha1='76d1332cfcbc5f8b17151b357999d1f758faf897'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sun, 11 Apr 2021 03:08:52 GMT
VOLUME [/var/www/html]
# Sun, 11 Apr 2021 03:08:53 GMT
COPY --chown=www-data:www-datafile:9beb76b36e5a8771e2d474e3ff2f225e755dc51e60553800642ac1aeed4e7df4 in /usr/src/wordpress/ 
# Sun, 11 Apr 2021 03:08:54 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sun, 11 Apr 2021 03:08:55 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sun, 11 Apr 2021 03:08:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:99fc57d9a1eeb61306d89de99323a9ec5c9acf7c7bccd88be9540b7cff03b939`  
		...
		Size: 19.5 KB (19478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecd34a43e3d8088738155e919a5377cd54eeb211fc41086e17cb8ce8c0f321d9`  
		Last Modified: Sun, 11 Apr 2021 03:28:24 GMT  
		Size: 15.6 MB (15584435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9c61f3e851bb38412756d42e5306c4bd0d52b3c75d5f7c55f305c0cd14f2aaa`  
		Last Modified: Sun, 11 Apr 2021 03:28:19 GMT  
		Size: 2.3 KB (2275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0702b1352a862642962e5848032b10e6d3f8850227d2164820f6b139b456b261`  
		Last Modified: Sun, 11 Apr 2021 03:28:19 GMT  
...
```console
$ docker pull wordpress@sha256:eab8166ba07c2b4dd47568af54c26b83fa0e78d311370293a4d653e7b243413f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.1 MB (200146205 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24f39883c11c5519383dbe0a2568431a958a1109f04ba4416d462eeffb834d1c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sun, 11 Apr 2021 03:40:34 GMT
RUN set -eux; 	version='5.7'; 	sha1='76d1332cfcbc5f8b17151b357999d1f758faf897'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sun, 11 Apr 2021 03:40:37 GMT
VOLUME [/var/www/html]
# Sun, 11 Apr 2021 03:40:39 GMT
COPY --chown=www-data:www-datafile:9beb76b36e5a8771e2d474e3ff2f225e755dc51e60553800642ac1aeed4e7df4 in /usr/src/wordpress/ 
# Sun, 11 Apr 2021 03:40:40 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sun, 11 Apr 2021 03:40:42 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sun, 11 Apr 2021 03:40:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d863be10fb3802fb492fae0ba920f7d1c4f0885f048b9e124e266b139e2fd5e6`  
		...
		Size: 19.5 KB (19478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:925dbf4c90e1776ee92031e3a547a265ca17fe3b1fe165edf19818dbd33b5bbf`  
		Last Modified: Sun, 11 Apr 2021 04:23:41 GMT  
		Size: 15.6 MB (15584418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c074c74de0ac20fe3bbf4003f8ff6fb33de2765557586c4ff2a464be271e63c5`  
		Last Modified: Sun, 11 Apr 2021 04:23:37 GMT  
		Size: 2.3 KB (2274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1126341d85ede96cca37a5b0cc12bdfcde552c131083b9ef7816cd0b09af230b`  
		Last Modified: Sun, 11 Apr 2021 04:23:37 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
