...
```console
$ docker pull wordpress@sha256:cf4586263a6da612ebcbde648789b34f3333a6beba0ab24fbe9b9208416b7ec7
```
...
```console
$ docker pull wordpress@sha256:f841c4d4a57ba9261d449cbe7eebf18a5761775df259f5a2a8acaa6d5e384833
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **214.6 MB (214595146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21b1833683d39d1753295a3e186486926e867b38fbf8c9e51da957d4bbe98b15`
...
-	Layers:
	...
	-	`sha256:5a4b786a36b3fa97e392dd900530e1fd8d264406f04e5e13d2ed47924fa298d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffb537aadd96ac2a139ef03ad1a35e116972115aef00752ab03f9c6cbf487a9f`  
		Last Modified: Wed, 25 May 2022 22:35:59 GMT  
		Size: 21.0 MB (20990157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:173e492463b70bb434573d7595524e3ff062a5ffe3cdc0528a40c5401e8941e0`  
		Last Modified: Wed, 25 May 2022 22:35:56 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce74d87f9410ff8fa17b2e8c5eafd110bbe3131fd40b21515fe2041ca542190c`  
		Last Modified: Wed, 25 May 2022 22:35:55 GMT  
...
```console
$ docker pull wordpress@sha256:297245b2d312a542451bdb5b8d0016e6b853e0c3f54f1476cc7750619811679a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181674931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8613a9c772f564c5098bbf355065a0794307e2545f8e315df09d3fc9d4156cd5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 25 May 2022 23:53:47 GMT
RUN set -eux; 	version='6.0'; 	sha1='7a5a6d0591771e730b05c49d0c3fc134624d0491'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 25 May 2022 23:53:48 GMT
VOLUME [/var/www/html]
# Wed, 25 May 2022 23:53:48 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 25 May 2022 23:53:49 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 25 May 2022 23:53:49 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 25 May 2022 23:53:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f824ce3326f69f70b820d44a54e4d233d684a439ff121559b66c7884475496e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e1b4c49e068e1fed2f1b75ed8055a2c04575873faeca2adfd75f6fa97baa96f`  
		Last Modified: Thu, 26 May 2022 00:19:44 GMT  
		Size: 21.0 MB (20990146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f59a5500b3d7d2f8745e987d4ccce413159ec2493dce901eda937befd3572beb`  
		Last Modified: Thu, 26 May 2022 00:19:28 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b6737619505a77c483890e1cbb539e4483f7765e8503fbd94d2e70a3fc431a8`  
		Last Modified: Thu, 26 May 2022 00:19:28 GMT  
...
```console
$ docker pull wordpress@sha256:2efcdb71d778a56319b67642da82f0b3389d13535cfa83c31cd3366f80027275
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189509682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5172d646d2cd8078717e715af88f0d5c6df885d897c3cc3bd594fe16d360bc51`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 25 May 2022 20:15:44 GMT
RUN set -eux; 	version='6.0'; 	sha1='7a5a6d0591771e730b05c49d0c3fc134624d0491'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 25 May 2022 20:15:49 GMT
VOLUME [/var/www/html]
# Wed, 25 May 2022 20:15:53 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 25 May 2022 20:15:57 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 25 May 2022 20:16:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 25 May 2022 20:16:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:15db0805ab35c03dfa0e5e005ff9498ca6c16bb1cb2eaa080ad35cfb577632f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd538569dcf280f55e02e8eed8fd85bc61100d84c160bd35c5503c6ea4953323`  
		Last Modified: Wed, 25 May 2022 20:20:54 GMT  
		Size: 21.0 MB (20989508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c1496b76d99221e47d2e34c0bfc15874ac6b5a5e0065e41e1fcd3e0d435f55a`  
		Last Modified: Wed, 25 May 2022 20:20:41 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e757305dda5d7d11edaf2e53fad70ebc8b9c9eb83cdd0d87ac3db81cddbc0203`  
		Last Modified: Wed, 25 May 2022 20:20:41 GMT  
...
```console
$ docker pull wordpress@sha256:41281d00233a0f4944a7013cdf2e6332046aa7d6b476190d35f959cfa12464e8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.7 MB (215723420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec0dfad825d6950f44cf12d1543c1ec7048dc04a70416775cc30099927d89223`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 26 May 2022 01:06:53 GMT
RUN set -eux; 	version='6.0'; 	sha1='7a5a6d0591771e730b05c49d0c3fc134624d0491'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 26 May 2022 01:07:00 GMT
VOLUME [/var/www/html]
# Thu, 26 May 2022 01:07:03 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 26 May 2022 01:07:04 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 26 May 2022 01:07:08 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 26 May 2022 01:07:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:568acc9db6589e79d02e8c10c67aadc1067b5fbdb60cd46e75af3903a0e75cbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a89a59edf71ec35f7ad97d3ab07c4de87a8efd2be95beb79e1ff58aff34be11`  
		Last Modified: Thu, 26 May 2022 01:48:39 GMT  
		Size: 21.0 MB (20990162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60ea178f3aa02aeb453cdb93bf1305f6713cb8da6fa5b74a0416368e88691822`  
		Last Modified: Thu, 26 May 2022 01:48:35 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a405e37f465ddf0b10f45ed0d9fc5f07423d03fddba282c59e2a09682da88898`  
		Last Modified: Thu, 26 May 2022 01:48:35 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
