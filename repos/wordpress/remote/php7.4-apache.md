...
```console
$ docker pull wordpress@sha256:c8353943d03d65ecc9e1f550f99179fe0845a5a446d5e7257f22d05983d4ceb5
```
...
```console
$ docker pull wordpress@sha256:524eab063bb612d7bd44ce792c6f72a1a773d08c0e95dd8e134fb9238e49f0ed
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184949377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2da59c54a06a069eb6830f4d2f125840f9672e964e3de62a752825e16b392ce8`
...
-	Layers:
	...
	-	`sha256:d09f106f9e1625e1db80599760c55981dea8adda3067095c98df5bfad4da724d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ce4312168baefe9336b92ed73fe4e3733280ca655027f665da1684381582b09`  
		Last Modified: Fri, 07 Aug 2020 03:06:21 GMT  
		Size: 12.1 MB (12082651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01f0fe2819ef4a997b555a23a90afe6826cbc35c8b8c538ca005d21919993238`  
		Last Modified: Fri, 07 Aug 2020 03:06:16 GMT  
...
```console
$ docker pull wordpress@sha256:1fedd8d12e4b32472d375ee801811fb1b3f5f8b57e53a95b01eff46af572fdf9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161734635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:985a7fc5f92b2916f0a61d4c7ca42d57a577e629e1a9cc5cc41edeadaaa7b6b0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 07 Aug 2020 04:57:45 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 04:58:05 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 04:58:42 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 04:58:43 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 04:58:44 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 04:58:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 04:58:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:92c9f7a7b591bacd2658cc05278237e06cec2b485e2d02d37a1148f7f6783d20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fa4787cebb18fc55c58086a3320d39f0242863f5056eeea3c6f089dc21f925b`  
		Last Modified: Fri, 07 Aug 2020 05:06:39 GMT  
		Size: 12.1 MB (12082662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d70e8b64a3c8bd8954c993c2c05c36fa5ecf34f637fcb55ec21ea994377fb68`  
		Last Modified: Fri, 07 Aug 2020 05:06:33 GMT  
...
```console
$ docker pull wordpress@sha256:2090cfc2548abd333d432757dd1d150f9034bf9e887bbaa3a0bf84aad08b64c0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190514265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce4089e7d094e4d5413d7ddbd1e7a74efb813e80b710673cbe764697b9e44479`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Aug 2020 02:34:29 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 02:34:30 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 02:34:39 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 02:34:39 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 02:34:39 GMT
...
-	Layers:
	...
	-	`sha256:d8206c44b5405ec1935633a1977fd77e796535efa8efe67aa88c7de64623c999`  
		...
		Size: 19.5 KB (19476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:673fe8d8a5460c3f5ce5cb233d92de8cfb1839f6c3502f2917c91bd11e4af3f2`  
		Last Modified: Fri, 07 Aug 2020 02:44:20 GMT  
		Size: 12.1 MB (12082654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df28ba4917c4c1f83a02db748bd52afb4bb088e8e9d82375177b036de11c86b8`  
		Last Modified: Fri, 07 Aug 2020 02:44:14 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:e9d789d1c8aeb79c6837c7bc83e174fd7ddd69c84df632661a49ecc066eed702
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165873690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a362ca9b9adece4a6ed548951e1e99f39b9135b35288fdb629ee28cbeba48f7c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Thu, 06 Aug 2020 23:17:17 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Aug 2020 23:17:18 GMT
VOLUME [/var/www/html]
# Thu, 06 Aug 2020 23:17:18 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Thu, 06 Aug 2020 23:17:18 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Aug 2020 23:17:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:df365b595579ddab6cdc59027ce7a0cc6aeca63c9b90934bd80ac047588e4bb7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b1642cfac4d3e1af26781a14df25429d9481dda2449db7710b47e3dcad56e1f`  
		Last Modified: Thu, 06 Aug 2020 23:23:40 GMT  
		Size: 12.1 MB (12082644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fe5654304a423220ffb7e5d60f6a272484d42307341cf8e9b69275d5b8a77ed`  
		Last Modified: Thu, 06 Aug 2020 23:23:28 GMT  
