...
```console
$ docker pull wordpress@sha256:f6d0ebb86aa8d0d8e634fb25726a9429dd013e11bc8d594870746b06fdfa62f1
```
...
```console
$ docker pull wordpress@sha256:2d35dbf6c4ab27576f1370ff60f901f076e671edd87498498a107f2341a471df
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158580176 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c09a044334d4da223449576afdf11dac06b2feb2d2079525e8979aae17971699`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 02 Sep 2020 04:14:07 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 04:16:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 04:17:03 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Sep 2020 04:17:29 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 02 Sep 2020 04:17:48 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 19:55:58 GMT
ENV WORDPRESS_VERSION=5.5.1
# Wed, 02 Sep 2020 19:56:16 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
...
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 19:57:23 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 19:57:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:893960d5594c6a6d37cd955d5f4f6d4a2a46d841c9406a0d2194360a78f5891b`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:557c6302086a16720d1d177a4cd08dcc24795bfab0540f61cd80ec08b4111af7`  
		Last Modified: Wed, 02 Sep 2020 04:44:06 GMT  
		Size: 15.9 MB (15857105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:450802238c31c8e146fc49f4a77460065e23bc390bf41a15d0e4df905941e0f4`  
		Last Modified: Wed, 02 Sep 2020 04:44:02 GMT  
		Size: 7.3 MB (7330022 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38661546db9797de03de3d497ac07086a68ec1dea2295c89b5fb483a5de432bc`  
		Last Modified: Wed, 02 Sep 2020 04:43:58 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a6b1b19b3acd213ee52aa09e7628717b63e4a420ea9ccf13e2d34db3d4fa515`  
		Last Modified: Wed, 02 Sep 2020 04:43:57 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7f9b674e854bac6c34d98fbfbef254b188f81422d7d4eb298f6791d3307e291`  
		Last Modified: Wed, 02 Sep 2020 04:43:58 GMT  
		Size: 19.5 KB (19481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac9f0e971077b6a835afe695661ae071f48a43075e21413d24e63b6053f00b3a`  
		Last Modified: Wed, 02 Sep 2020 20:06:04 GMT  
		Size: 12.8 MB (12846283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4092e441df5468c427204271e8df8ffd1b322767a1936e9b0b3beddcd217bfc2`  
		Last Modified: Wed, 02 Sep 2020 20:05:57 GMT  
...
```console
$ docker pull wordpress@sha256:490db570a5d3aefbc042ac50f3a44c3bacac6cb6e27d10b08e0d5e19be54fcd8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176214292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fc80d794ebb488ef462a10116a30b71dac3d1c49b450d5d5552642ab513b25c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 18:45:33 GMT
ENV WORDPRESS_VERSION=5.5.1
# Wed, 02 Sep 2020 18:45:33 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Wed, 02 Sep 2020 18:45:38 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 18:45:40 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 18:45:40 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 18:45:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 18:45:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1d7f8e5066a52d70206ad6617582913e19c1b7d894bd0689aee33804db772b70`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea3c1e397b776e82d63ad63420bddcb826b8c8abfe68ddabff1e3fc7ed5baec9`  
		Last Modified: Wed, 02 Sep 2020 18:49:35 GMT  
		Size: 12.8 MB (12846282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:624e4172ded19747ff404987bbafda9f0c639ca05a9f319e650f82bd8b0bd3d3`  
		Last Modified: Wed, 02 Sep 2020 18:49:31 GMT  
...
```console
$ docker pull wordpress@sha256:d0c70b847f21337da48593e8980d3e46d9a1a45a255c636ae6817ab400e10eb7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191278624 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1f8471d793909dc6a106bbe7db19f483ef5fe505fdd988a7baadfb37e214838`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 18:40:10 GMT
ENV WORDPRESS_VERSION=5.5.1
# Wed, 02 Sep 2020 18:40:10 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Wed, 02 Sep 2020 18:40:19 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 18:40:19 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 18:40:20 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 18:40:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 18:40:20 GMT
...
-	Layers:
	...
	-	`sha256:e8b5c28b87e286cb2f78f4c55e0d4a4de35c500af7ab2d6a0c278c27d2223638`  
		...
		Size: 19.5 KB (19478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97a80876fa63c008d4f07abe7318efa1fc19b12ffc458a05e808317fb8af007c`  
		Last Modified: Wed, 02 Sep 2020 18:43:14 GMT  
		Size: 12.8 MB (12846225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b144038b49dc93f571bfbc57822473a10f151d6cd03db8a85670e6c6b5bc804`  
		Last Modified: Wed, 02 Sep 2020 18:43:10 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
