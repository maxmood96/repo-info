...
```console
$ docker pull wordpress@sha256:8466ee94d8b327df06a1a918194634dc7b761efc3aa69ff9991085b0aee16ca5
```
...
```console
$ docker pull wordpress@sha256:125db505f660d931985c36bc6718eb5b7f5a7cef7d2fd58e6afb3792e664ee36
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188412611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6135f8ca1aebde1331d3a28e2630e341080070bdfc5c5c9a8851ed0c8142285`
...
-	Layers:
	...
	-	`sha256:5b6f5a04183fa6c75ef443b2c5a645a8be9f1a8d8677dbb19f08ffeafd1daa5d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d783d65d0806167dc8ceba7a9c6d7d6f3e6d805e8c4c84217f618913044fff1c`  
		Last Modified: Thu, 04 Feb 2021 23:28:38 GMT  
		Size: 15.3 MB (15267085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e88bbd03cab78fd754abfdfdf2491e0f98567e6d1cffac44638d2b58f0b9ebd`  
		Last Modified: Thu, 04 Feb 2021 23:28:30 GMT  
...
```console
$ docker pull wordpress@sha256:aef6b60a6c958556596fc061f32663e5b576b70968518d1af2414ad06613062a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161220461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d73bc121bbc2e5bd6d612b23b1631ab7f47ec3519d960eae8678d0f73973a4e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 04 Feb 2021 22:11:35 GMT
RUN set -eux; 	version='5.6'; 	sha1='db8b75bfc9de27490434b365c12fd805ca6784ce'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Feb 2021 22:11:37 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 22:11:38 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Thu, 04 Feb 2021 22:11:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Feb 2021 22:11:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a81bb52b6392cb4ff55585f9d5b6959a0cef2e63ad836e650e80b3ea5865c103`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e12e0d77afb7328f790f219b9cb71a69d3057bb9f1f2ce529d04af40dc227bf2`  
		Last Modified: Thu, 04 Feb 2021 22:33:34 GMT  
		Size: 15.3 MB (15267129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca652a12e2b0af342e9df13d07a43cfd4b3700e379485feecf06dcb46f5244af`  
		Last Modified: Thu, 04 Feb 2021 22:33:29 GMT  
...
```console
$ docker pull wordpress@sha256:51934c657baf15b1be45d0f981c7313e25df161b8c1d663d40c77f36bbbd26af
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (193983447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01a0997c4c00b2c046e2259ceef0a10b51b37a271ec46930ea0678fd02e9ad46`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 04 Feb 2021 23:52:35 GMT
RUN set -eux; 	version='5.6'; 	sha1='db8b75bfc9de27490434b365c12fd805ca6784ce'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Feb 2021 23:52:35 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 23:52:36 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Thu, 04 Feb 2021 23:52:36 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Feb 2021 23:52:36 GMT
...
-	Layers:
	...
	-	`sha256:4e0b2bc16bb1daaab07f2c8fbc65942b79547ca281ad2e0bfaafd84e25b3a9d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfe99adef4e11b41ef35aa45d7138de1573e6599f168732f9c0054f11ce5901c`  
		Last Modified: Fri, 05 Feb 2021 00:07:18 GMT  
		Size: 15.3 MB (15267096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e20ec3aeb773ebe69b93abe21da4c0bc5159cb4b6019c34305343822a38650`  
		Last Modified: Fri, 05 Feb 2021 00:07:11 GMT  
		Size: 4.0 KB (3961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
