...
```console
$ docker pull wordpress@sha256:249d7a5fe282ccc86beb3164adbdc2138ec3fd34d152dba4b3b132d7b6df6601
```
...
```console
$ docker pull wordpress@sha256:f409e23204d1c124f69a13ce4f0402c169e71e1a88d5cf2b422c791fe5dd2919
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.7 MB (185713380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:026a70371c941e67a997f21d0cb42a26fb6c379ec64ef559fbec041a590d5353`
...
-	Layers:
	...
	-	`sha256:5e36ed3f63b00ff9013b0025b8cf6e95e8fcf323019b1497ab0cfb028e8edf98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfdac20bfc12a26a87814cc9fed2a29831d1739794487d36971eeb6b52a32207`  
		Last Modified: Wed, 02 Sep 2020 18:26:20 GMT  
		Size: 12.8 MB (12846228 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5221e8aad98a2500497b5f5680fb5f6a177ffe3f63d320b8fddb95729e9c643e`  
		Last Modified: Wed, 02 Sep 2020 18:26:16 GMT  
...
```console
$ docker pull wordpress@sha256:0363b56ce003488cd6db685bb6761e1bc09f79e82fdedef026f87d2309d4178c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162500337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d23b76e6b89ffa820e9669a7fcafd03f3f4978fe02a4c1a3e3747f7438811e72`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 18:58:56 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 18:59:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 18:59:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:31126a1f829ac1eb0c013369a610bba95d69c327aced1ff1c1c24b842977f8a5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6558edfb96fb47f9cb52f26bbddee99a69960158b7b6d33097ea3ea0a9b2020c`  
		Last Modified: Wed, 02 Sep 2020 19:04:45 GMT  
		Size: 12.8 MB (12846275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21c2049d8778e92ce63634cfd9d8f11786fe5391a8b0ce11ad75de1b202309e2`  
		Last Modified: Wed, 02 Sep 2020 19:04:41 GMT  
...
```console
$ docker pull wordpress@sha256:04faaa441c1b266afeeecc15536e7c89205f0820c43e35d4f3929b0b79ce222d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166639881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42e330ad39a427d6cee713984910c2ee0d9bbcbb52e41c59a4df5db3a98cb502`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 19:08:03 GMT
ENV WORDPRESS_VERSION=5.5.1
# Wed, 02 Sep 2020 19:08:04 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Wed, 02 Sep 2020 19:08:11 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 19:08:11 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 19:08:11 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 19:08:12 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 19:08:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ee0a006e359ae0d8e622f192284789477b2c398303080fb797ba9e585828135e`  
		...
		Size: 19.5 KB (19481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09c5b0b85f6cc5ff23cc2f9dae30327acff5a644798ef3f4f12bf6caadb10119`  
		Last Modified: Wed, 02 Sep 2020 19:10:38 GMT  
		Size: 12.8 MB (12846221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:705b61cd36674ce75c1991b81035f97dfca78ac485b98a946351e8be75bf14b6`  
		Last Modified: Wed, 02 Sep 2020 19:10:28 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
