...
```console
$ docker pull wordpress@sha256:8e0e83b3feee510eae7b7d68bac74d1accd7af9760c384e3fcfc6c8683c9a5ed
```
...
```console
$ docker pull wordpress@sha256:6fdadc264dc489343fabdad4feb7460fc5e82aae0cb4915c0bfe815b8fd90af9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157814967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd53ffd596db354e05eed558ce94e725468ea3cc9afe63e5c2eef3d296b0f54b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 07 Aug 2020 08:06:24 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 08:06:24 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 08:06:31 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 08:06:32 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 08:06:33 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 08:06:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 08:06:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f94343ca0f89abcbf51faa49a1ee11c5af35f070ccc5a66848bf48d770e400fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2cc02ef5bffe4e22a7a366026a5594b36dab48e7e9631fab77026739c5475b3`  
		Last Modified: Fri, 07 Aug 2020 08:19:33 GMT  
		Size: 12.1 MB (12082657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5924e4252eac1213583ec9191efb3727125dfdad43c9ec8c3bce39fd94ad34cc`  
		Last Modified: Fri, 07 Aug 2020 08:19:28 GMT  
...
```console
$ docker pull wordpress@sha256:dd2ae21eeb6a04e93f1f4bcec785060b2247337ef38e3d091b88428f9a7c37a1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.8 MB (196754195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a83b04690b2f4b23dfb50b8596e22eb92e4ada2d784c087facdb1202e6706d8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 07 Aug 2020 06:23:32 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 06:23:37 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 06:23:58 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 06:24:05 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 06:24:09 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 06:24:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 06:24:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:910355e1766a7ff9c734ac813df7f4314a89e1169acdf35e44d2682c46e18473`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07088f97d45bfcdb160f6a540e14e63a90a6c89ead8ba1d5f1006972f42dfe07`  
		Last Modified: Fri, 07 Aug 2020 07:31:23 GMT  
		Size: 12.1 MB (12082662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:873c892103f1411c1fb56fc69839c15bf86831f828645a4641d97a69d3f81995`  
		Last Modified: Fri, 07 Aug 2020 07:31:19 GMT  
		Size: 4.2 KB (4153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
