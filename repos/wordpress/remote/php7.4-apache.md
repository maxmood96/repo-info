...
```console
$ docker pull wordpress@sha256:8aebfe805c0ee1383b38dad832a5023a3a2ac3260e934e11f85f721a4a14912f
```
...
```console
$ docker pull wordpress@sha256:180a40309ae5a0041360e35880187d2cb6d9365b015a3f944ffa2c6869e13213
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158569015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9128af317569c4f02030f28f8dd5dc26202f560c80302f0482fc263b310ef159`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 04:17:50 GMT
ENV WORDPRESS_VERSION=5.5
# Wed, 02 Sep 2020 04:17:52 GMT
ENV WORDPRESS_SHA1=03fe1a139b3cd987cc588ba95fab2460cba2a89e
# Wed, 02 Sep 2020 04:18:21 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 04:18:26 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 04:18:35 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 04:18:40 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 04:18:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c7f9b674e854bac6c34d98fbfbef254b188f81422d7d4eb298f6791d3307e291`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:809c281e5432fae81b00a91beb02727beb796e6ac013f286b6bbcd8de454422a`  
		Last Modified: Wed, 02 Sep 2020 04:44:03 GMT  
		Size: 12.8 MB (12835122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:564a7fd78e9713e04164d51a2112641cb5c64c098d51ee90b8dc63df75a270ae`  
		Last Modified: Wed, 02 Sep 2020 04:43:58 GMT  
...
```console
$ docker pull wordpress@sha256:710b802f25717c9dea893fbb29b1893c9632c3cd0d42aba6d22a466dd122394b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169939055 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f769975283db09e7de4e3d2f75f05cda83ad10b9ffadf7a6f7e04c77ce33cc3a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 02 Sep 2020 18:42:52 GMT
ENV WORDPRESS_VERSION=5.5.1
# Wed, 02 Sep 2020 18:42:52 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Wed, 02 Sep 2020 18:42:54 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 18:42:55 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 18:42:56 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 18:42:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 18:42:56 GMT
...
-	Layers:
	...
	-	`sha256:eb288181bc6a50e037cf2bc896d09a052fb7b998f96d0992e3189eaa4f6c993d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41803babb1617df642d9e4f87515faa9aeaab8b04e1bd1302cd665e93b09260`  
		Last Modified: Wed, 02 Sep 2020 18:45:45 GMT  
		Size: 12.8 MB (12846272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30652f2ac2b651ac0c130638a06541a02e3d79af4a9be680e6fdf6d0095c410d`  
		Last Modified: Wed, 02 Sep 2020 18:45:43 GMT  
		Size: 4.2 KB (4153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
