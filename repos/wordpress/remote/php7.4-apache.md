...
```console
$ docker pull wordpress@sha256:70dc938025a8ac94af9b5ebdebb9639926f5a2d30f6df9bfe9904c2981a28f37
```
...
```console
$ docker pull wordpress@sha256:63c4100a4cd06c82ea824ede6f07f2a0f0a3bba6983dc9ccdaa573e3c9dfadc1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **214.7 MB (214677763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3c91b2b9a23e1eaa1d6d5f492001913086f00b22c3b14f27de385e21cfa7612`
...
-	Layers:
	...
	-	`sha256:1f4f8b7b699728c78da8a30c255723a6af5e04c896c14b88244117fb9b3f7804`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c0e2688a78ab3443eb5f7f36cf1778699b81516235d7a3387c3c8efe9e6cc2f`  
		Last Modified: Wed, 26 Oct 2022 19:18:03 GMT  
		Size: 21.0 MB (20996763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58df18f04c268d915d130059459420c07b00a99df0b1c74fd88256926f523e2f`  
		Last Modified: Wed, 26 Oct 2022 19:17:59 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21e8f4a20ab656b51c31919a568f43c344f1dd2b9052a43737eec0196227073b`  
		Last Modified: Wed, 26 Oct 2022 19:17:59 GMT  
...
```console
$ docker pull wordpress@sha256:358f5d6050d13619c846af1082294c06dfd90b02b896108f69f8cab608a51369
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.8 MB (190822291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31ae27a1ee39b841719c42466f57e564e70a263f15fe6e496983049fa984aae2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 25 Oct 2022 19:31:59 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 25 Oct 2022 19:31:59 GMT
VOLUME [/var/www/html]
# Tue, 25 Oct 2022 19:32:00 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 25 Oct 2022 19:32:00 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 25 Oct 2022 19:32:01 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 25 Oct 2022 19:32:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cfe155af18c3d39c2f7950e2c34e23d40c2a6de4af9f91213ec30af1d276c4aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62557ca9629c5181f8b295aa25022bb87818c724f3dc203c90b443fbcc473493`  
		Last Modified: Tue, 25 Oct 2022 19:52:37 GMT  
		Size: 21.0 MB (20996690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:135a299102e47ec021b6cc92fedbffe39b98f4e8eb1ce154a19bdc95f49717dd`  
		Last Modified: Tue, 25 Oct 2022 19:52:32 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a28c20541fca9c66ccab9b0d1bd14fe59bc7616746a63c041251b5b571e336a4`  
		Last Modified: Tue, 25 Oct 2022 19:52:32 GMT  
...
```console
$ docker pull wordpress@sha256:4a6344f420e1405d4bba4a08fe8b7fdf5fc0ad0fcb52ab67e5df713e05032621
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181692708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a07e9594d81efd51b9bf6e7e88e29c2c8a48a7aba0d04cd7d4498d02b1d3176`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:33330a75c1171ce8692107d864202fc9158b442dba7d2f08315e042a3301702a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:519d2152fb9c89ceac8ddd8981651845ee834ac49343709ed9523db129644761`  
		Last Modified: Tue, 18 Oct 2022 20:18:13 GMT  
		Size: 21.0 MB (20996765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08ec411e18188d9c95204455206e426be9317191c239c11c47b78f0a04099133`  
		Last Modified: Tue, 18 Oct 2022 20:18:09 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:951f768daee6ca5fa5a4f5f7c4685d6fb992dba5b874f75fa9f8efd4199a608f`  
		Last Modified: Tue, 18 Oct 2022 20:18:09 GMT  
...
```console
$ docker pull wordpress@sha256:2d47355c02bf7bae65b5c9e61556bda46f8b9e12e8c72b6a1e4b2b2afea37f94
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.3 MB (206276383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dac734c0a174146cd226167957dbeb9331af805ffae2f00a6c15157bd195231c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:f0c78b4e77b9798e6ab8ac2d10a625ef9003b325aec738456129b93a3e59cd9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ec0348bb99fb881a5aeee38f2af9f83c4ab6865ecfdc010e6200439765bbccd`  
		Last Modified: Wed, 26 Oct 2022 13:41:10 GMT  
		Size: 21.0 MB (20996765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abbcfbde8d8e8607c975e1887e7b7c5ce56f0342cda58bbdaeed5f9dd754618f`  
		Last Modified: Wed, 26 Oct 2022 13:41:08 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f5866a37c1379ecb4fbada3a11fecbc876ad164495279d61c25ef94c766286c`  
		Last Modified: Wed, 26 Oct 2022 13:41:08 GMT  
...
```console
$ docker pull wordpress@sha256:cbc6e8c4b4d33b273a798c07cca703f1ee6121c14c53c5484dfabeaa716b194e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.2 MB (216173924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db805347a7d2fdf38a07c5e906fcb69522785ad22aa696c69d8107755c1529f8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 25 Oct 2022 21:39:10 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 25 Oct 2022 21:39:11 GMT
VOLUME [/var/www/html]
# Tue, 25 Oct 2022 21:39:12 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 25 Oct 2022 21:39:13 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 25 Oct 2022 21:39:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 25 Oct 2022 21:39:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3bdfe5f6ac3eccd615e75075cca12a139dd3ead52811cec000f560b640f205f1`  
		...
		Size: 19.5 KB (19494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c69df463d00524a7226547db207a482d744bb2b2d98c2eb7b5bf50e166ca2ff8`  
		Last Modified: Tue, 25 Oct 2022 21:54:57 GMT  
		Size: 21.0 MB (20999782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:639e185af950b998ab4c3337d3e4f94236ebdab0f8ed7ab93f82cdc53046115a`  
		Last Modified: Tue, 25 Oct 2022 21:54:54 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917db649d3dc79f8eebc0d66428db9d83d1e72af31b56f0100ad2f2d013b5886`  
		Last Modified: Tue, 25 Oct 2022 21:54:54 GMT  
...
```console
$ docker pull wordpress@sha256:25df8ab1d7a6da140b574df32d6f165a11273e81cb6e9af4cc31498e7e137b1e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189537026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce4b1a04b5b08cfa1fad5dd67bdc1223c95b34529698dc633bb5a7dc3ba59a71`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 26 Oct 2022 17:45:54 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 26 Oct 2022 17:45:59 GMT
VOLUME [/var/www/html]
# Wed, 26 Oct 2022 17:46:03 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 26 Oct 2022 17:46:06 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 26 Oct 2022 17:46:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:6f9f967d4a65a7e94146f90f329aad4b04f45d048c0a35ff028bb8ad34b9b821`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81c7b2e801db6ad14898c0626c868bc903b39fd1f6644969bf87c71a751bf967`  
		Last Modified: Wed, 26 Oct 2022 18:37:08 GMT  
		Size: 21.0 MB (20999802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7415301551ee16eebdf5a04a6df6d6bf2ef4953c48492bb3831c97617796d8f4`  
		Last Modified: Wed, 26 Oct 2022 18:36:53 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b6141ea33c6a8cf046edcd6e1587f5021ce30b015ea6504b767d8e70f7cab6`  
		Last Modified: Wed, 26 Oct 2022 18:36:53 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:e50f2e1c1e2f8759709c2bebf0a69206ffcd2ba4287da3de0e5800762ec1dc4f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.8 MB (215750409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:961beae76945cb2e55bbf62f37f629a4ef582bf7b527ac04d7477e9ef25b43ee`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 25 Oct 2022 23:17:27 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 25 Oct 2022 23:17:29 GMT
VOLUME [/var/www/html]
# Tue, 25 Oct 2022 23:17:30 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 25 Oct 2022 23:17:30 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 25 Oct 2022 23:17:30 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 25 Oct 2022 23:17:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d757f376f07a6f5c077e7dd63a0d04f4844565a7b79ff765ee11d567a782a029`  
		...
		Size: 19.5 KB (19497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:947514ea5705b92005c4656c69ce6f1e9bfc14061b9dfe71b0c7ecba32880e9b`  
		Last Modified: Tue, 25 Oct 2022 23:40:58 GMT  
		Size: 21.0 MB (20996765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec4441cd16cd7b3e5d0ea36449b708042e38bd224b3d9e33a4f50ca241249b2b`  
		Last Modified: Tue, 25 Oct 2022 23:40:53 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74373954716fbc9f9b67738a2798caeb9f76f2122ce7b7ac93a5b15bdfb9fae1`  
		Last Modified: Tue, 25 Oct 2022 23:40:53 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:7f64dd9555eceb31c324ce75b44dcba0a65003e66cbb0fac809a42910021cd2e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.1 MB (190126398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3400b82ce64f506297a2c7e39e00238dceaf3d77e90bb7059989e3b478e3fa7e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 25 Oct 2022 16:14:13 GMT
RUN set -eux; 	version='6.0.3'; 	sha1='9ab0d521aac7042cf09946f17ec86dc65b182201'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 25 Oct 2022 16:14:15 GMT
VOLUME [/var/www/html]
# Tue, 25 Oct 2022 16:14:15 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 25 Oct 2022 16:14:15 GMT
...
-	Layers:
	...
	-	`sha256:aece84053ad04c7f7c2817807d477dbe92d9b030e70d0777c8bc68a2bf702a09`  
		...
		Size: 19.5 KB (19499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7beb16a75f403ea79d68fd9becaa41da456612fcad84a29060a8477211095daa`  
		Last Modified: Tue, 25 Oct 2022 16:30:53 GMT  
		Size: 21.0 MB (20996766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9e820cc9a88fb4ea85450599b793267ba84caf00e70db8332b1e33a670ab69d`  
		Last Modified: Tue, 25 Oct 2022 16:30:49 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa9cf1f1e816a3675edd9e79ed790235e8a6e8e5eb47968c8df8f95fddc15ead`  
		Last Modified: Tue, 25 Oct 2022 16:30:49 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
