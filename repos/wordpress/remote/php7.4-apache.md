...
```console
$ docker pull wordpress@sha256:a5ffdd3c3e0a586d2fc64f25c355cbef6d12e1741a8a135079cabf9cae32bacc
```
...
```console
$ docker pull wordpress@sha256:7b75055282588b0e030e9d71bb48a47387c4e46365b673f7d9522924fa5df0a8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.9 MB (182919372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:563e52c9aea8e8872271b749afb4e28430f6b06089464ec1b7db037e525ca071`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Feb 2022 03:48:40 GMT
VOLUME [/var/www/html]
# Fri, 18 Feb 2022 03:48:41 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 18 Feb 2022 03:48:41 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 18 Feb 2022 03:48:42 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 18 Feb 2022 03:48:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cb2114d1d2027953c943a27214f7a7e0403d11df8d53f19ad54ed874a49354da`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9bb0ecfb6dc3c890551b7fd0710d0180227d886778cabeee91f9943defc3536`  
		Last Modified: Fri, 18 Feb 2022 04:09:12 GMT  
		Size: 19.0 MB (18953206 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60b7a786cf9405fbfd61fb026b02235e5de548fb1f059e10d501806f235a85ba`  
		Last Modified: Fri, 18 Feb 2022 04:08:58 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f241c936a91679c1b3d3d98c2be0fc44ad0c1728b6bb0687235fc8e663eabcda`  
		Last Modified: Fri, 18 Feb 2022 04:08:58 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d083d3317d44be734271c393006a2dce2b92e1dce8cd10e87cd21703e9990b61
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.9 MB (206900860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0068e0b829d505075f18f734f75f70ad4ae58eb82537af2f949add8631fbfb79`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Feb 2022 01:02:35 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 24 Feb 2022 01:02:35 GMT
VOLUME [/var/www/html]
# Thu, 24 Feb 2022 01:02:37 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 24 Feb 2022 01:02:38 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Feb 2022 01:02:38 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Feb 2022 01:02:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8d5325b327f0afec1bce205733e7ee4d71c5511957131c7a0e1b127570d1cc97`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7d4027f3e5e0f480bacdff8557187ce7590d9c2a7c36df0464027f2d1f30b73`  
		Last Modified: Thu, 24 Feb 2022 01:11:42 GMT  
		Size: 18.6 MB (18551989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c161bbf6eee3b40e05e73468818d2d5f49e88ccfb6d207e9babf90029879cc`  
		Last Modified: Thu, 24 Feb 2022 01:11:39 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c387af19685748c53cd4e067b3215a708e190cfd25ea1a8eed0eeda8695447a`  
		Last Modified: Thu, 24 Feb 2022 01:11:39 GMT  
...
```console
$ docker pull wordpress@sha256:ef59b96b2e53012c0ffd4dead33b8cc5deaa36dcf3ab34d6052f356a301d9330
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.9 MB (218907436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7875a997e0197ddea46ce4a8c395c958e8e831f64e8348358c4a94e77580dde4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 17 Feb 2022 23:16:40 GMT
RUN set -eux; 	version='5.9'; 	sha1='4e9a256f5cbcfba26108a1a9ebdb31f2ab29af9f'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 17 Feb 2022 23:16:40 GMT
VOLUME [/var/www/html]
# Thu, 17 Feb 2022 23:16:41 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 17 Feb 2022 23:16:41 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 17 Feb 2022 23:16:41 GMT
...
-	Layers:
	...
	-	`sha256:eb15f0a1770863a3ca50ecac38050df48ae65bfe59a3ae4eec6c009ae4faab6c`  
		...
		Size: 19.5 KB (19506 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71d0e04a1c395850819e9a9cf1432d3360799e6b7ee2a9222771abf68648d6af`  
		Last Modified: Thu, 17 Feb 2022 23:27:50 GMT  
		Size: 19.0 MB (18953207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce6e12cc3b1e43391db4380c3ea73be3239502ba291f327324a26432c6ac2cb9`  
		Last Modified: Thu, 17 Feb 2022 23:27:44 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95724bbd148a2abf0dc49bee73389de0419ffc10e67f3617e920c26730e9d317`  
		Last Modified: Thu, 17 Feb 2022 23:27:44 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:4c92d588911e6533c89c44c5a213a85f6ec51d5cb98da673f90a74bfbfe6790b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.2 MB (191236295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4aa5068ae547cf722e734247c2375050feedb943ee846c7a5ebec37801643a1f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Feb 2022 22:02:27 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Feb 2022 00:29:26 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 24 Feb 2022 00:29:27 GMT
VOLUME [/var/www/html]
# Thu, 24 Feb 2022 00:29:28 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 24 Feb 2022 00:29:28 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Feb 2022 00:29:28 GMT
...
-	Layers:
	...
	-	`sha256:6b3d7c25459d98983edd502af985a17ca10d3c6fbc10df0c21ab1c8c818425ec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6adcacce99699465264a71ca12b6eb0d277c55ca3280b2598633ada709da4b8e`  
		Last Modified: Thu, 24 Feb 2022 00:35:37 GMT  
		Size: 18.5 MB (18549301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1103205c52fe57e3afbbb9137b5a534f5e0f58dccd9139e1a70e201cd104342`  
		Last Modified: Thu, 24 Feb 2022 00:35:34 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6ecf0796bb834ce670a50fb46f53cdeefdf99d33930a6bbcb8db19c7a76c1d7`  
		Last Modified: Thu, 24 Feb 2022 00:35:34 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
