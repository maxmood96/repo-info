...
```console
$ docker pull wordpress@sha256:d6bf5596a2c06c44276ae1793992951756758eebc7a7c88f77dcf1825ee13404
```
...
```console
$ docker pull wordpress@sha256:6ca8f6f30dced20649b4b200a33c33602651d71cf05195e2e9b647b807614448
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185310138 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f638cdcd3bec8f7c518d788f5549a6435437de8592536e56727a1bc229abbad`
...
# Fri, 24 Jan 2020 12:39:51 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 12:41:17 GMT
...
-	Layers:
	...
	-	`sha256:2c5f5a133ffa16237d6c9c6b688b818fd5784bd9319063c2aadeddf07e18cd72`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35029e85e0be97d544e4f3893c73210f74cc12a593d3fab5d9c714c22582dc55`  
		Last Modified: Fri, 24 Jan 2020 12:50:52 GMT  
		Size: 16.7 MB (16704919 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:896c488c0fcbb9f282e8bdd8347750836e18d30cdcaddeb9ed011c40af68cb28`  
		Last Modified: Fri, 24 Jan 2020 12:50:56 GMT  
		Size: 9.5 MB (9537873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbb80ead0413309d92361c68573e175e9c3aaa330b2fafeea61298111ee5bd32`  
		Last Modified: Fri, 24 Jan 2020 12:50:42 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cade3594c888fddf4ca8a280b79dee97c86a069ef106d019a7e4dd9dec46fc10`  
		Last Modified: Fri, 24 Jan 2020 12:50:42 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:705cbbc6644ae232abedeec7e01f289c8f065dbd4e18d72d63a163cbc40aa9fc`  
		Last Modified: Fri, 24 Jan 2020 12:50:42 GMT  
		Size: 19.5 KB (19478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5292019044c94d1a176f537879b2d4bc7d6333b7ff9281d3443f23115c53c5ae`  
		Last Modified: Fri, 24 Jan 2020 12:50:53 GMT  
		Size: 12.2 MB (12227882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4e6cc81aa20fdbebaa06daafe21f9a7614d28084a0387cb597d382b69c8f5aa`  
		Last Modified: Fri, 24 Jan 2020 12:50:43 GMT  
...
```console
$ docker pull wordpress@sha256:d56ba1d55a14e1abb22dde7843d35aada766363e077e7b037d77ce4d1e881b21
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162071906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe679adbcc55eac6580cf40cb3a5643cbb96b3835fec208f05a4b81d3f804844`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 24 Jan 2020 00:28:05 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 00:32:54 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 00:32:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Jan 2020 00:32:59 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 24 Jan 2020 00:33:01 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 24 Jan 2020 00:33:02 GMT
VOLUME [/var/www/html]
# Fri, 24 Jan 2020 00:33:04 GMT
ENV WORDPRESS_VERSION=5.3.2
# Fri, 24 Jan 2020 00:33:05 GMT
ENV WORDPRESS_SHA1=fded476f112dbab14e3b5acddd2bcfa550e7b01b
# Fri, 24 Jan 2020 00:33:15 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 24 Jan 2020 00:33:17 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 24 Jan 2020 00:33:21 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 24 Jan 2020 00:33:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:793a93f156decbeefb63597950af8d1654223a03f4fadaad3dd394440e679c35`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c1e511303c449cdde3febf075c3135f4f5d7aaaca021f95ee1b5cf3f5bf1519`  
		Last Modified: Fri, 24 Jan 2020 00:40:47 GMT  
		Size: 16.3 MB (16279803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:319f7e0f7af3af3820c02544fbf6ad0ec4a4d89318e41880c84810c8eb44364c`  
		Last Modified: Fri, 24 Jan 2020 00:40:43 GMT  
		Size: 8.4 MB (8405929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41af95d8c3598a193f2a0339413fe74b06c4fe493940764dbd56fe7b6f2e87f`  
		Last Modified: Fri, 24 Jan 2020 00:40:38 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a0e2d29efee48028d6198ee3f199fcc5d73c82c6e2cf5b1a6448ad9779f4ff8`  
		Last Modified: Fri, 24 Jan 2020 00:40:38 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22a253f0d28e9dc09f002a7f0cf54c53004c5f76a896e5d25169b65eecb701c9`  
		Last Modified: Fri, 24 Jan 2020 00:40:38 GMT  
		Size: 19.5 KB (19476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f2f8551f240f44b295f5e404f67976529909daab4128965504471bfb423e9c4`  
		Last Modified: Fri, 24 Jan 2020 00:40:43 GMT  
		Size: 12.2 MB (12227877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d95cd5da267ea175e7fdf53e244e02f39dd6b0445f75368b26e68f57afea9c7`  
		Last Modified: Fri, 24 Jan 2020 00:40:38 GMT  
...
```console
$ docker pull wordpress@sha256:4143dd05dc4a7653c53d7b654c34f692752baf4c9bb91a3c7d433064ef2ccd00
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158128604 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29121f19dec930bf92737c27463aafa10a80f71b27f70c8489e76d6f0badd20e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Jan 2020 21:22:18 GMT
CMD ["apache2-foreground"]
# Fri, 24 Jan 2020 04:03:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 04:06:37 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 04:06:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Jan 2020 04:06:42 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 24 Jan 2020 04:06:44 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 24 Jan 2020 04:06:45 GMT
VOLUME [/var/www/html]
# Fri, 24 Jan 2020 04:06:46 GMT
ENV WORDPRESS_VERSION=5.3.2
# Fri, 24 Jan 2020 04:06:47 GMT
ENV WORDPRESS_SHA1=fded476f112dbab14e3b5acddd2bcfa550e7b01b
# Fri, 24 Jan 2020 04:06:54 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 24 Jan 2020 04:06:55 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 24 Jan 2020 04:06:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 24 Jan 2020 04:06:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4f459699e5baef7c02d958aede1c6a880e72acde48b44e5a80de9bc067110ebe`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e323533ec4a2e8f95df4c18966092f8a7036e69c49d31a813f90eed89f65fe52`  
		Last Modified: Fri, 24 Jan 2020 04:21:54 GMT  
		Size: 15.9 MB (15855320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21239ea5ffab1ae737bf1c9bf33eb631c22dc2fee05c267c1d7890d58e0a31f5`  
		Last Modified: Fri, 24 Jan 2020 04:21:51 GMT  
		Size: 7.6 MB (7553696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a0d045ab677c5f2ed11baacfd86ef649794e80b0423b3661cb72a4d135df06`  
		Last Modified: Fri, 24 Jan 2020 04:21:46 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94e8824c5d9c1956afa655aef67568ea82295c1003c7300fc2a35028768b8e17`  
		Last Modified: Fri, 24 Jan 2020 04:21:46 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acb0faffd01bea653bc9db14d8f40d015588d9c93e6264b0ea848bce4c36d14e`  
		Last Modified: Fri, 24 Jan 2020 04:21:46 GMT  
		Size: 19.5 KB (19484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e1fa5f5875e11063ade1c7d0a2733ec6a341325b64782b74ee40777a2f49825`  
		Last Modified: Fri, 24 Jan 2020 04:21:52 GMT  
		Size: 12.2 MB (12227883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bb0f3c7756ce6e295bc95a8573a9d9c6fea640d0dfaa710082b753b2c52f4ff`  
		Last Modified: Fri, 24 Jan 2020 04:21:46 GMT  
...
```console
$ docker pull wordpress@sha256:a7e142d5ea4480d3b641e8de178137e74388f6be463d5f7dd2d939d943aaaa34
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.9 MB (190876732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f551e53a75ea1366f4dad3220445d4c6b9f78a2233058019288e28d7bdac5ed7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Jan 2020 22:58:39 GMT
CMD ["apache2-foreground"]
# Fri, 24 Jan 2020 08:00:53 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 08:02:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jan 2020 08:02:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Jan 2020 08:02:59 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 24 Jan 2020 08:03:00 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 24 Jan 2020 08:03:00 GMT
VOLUME [/var/www/html]
# Fri, 24 Jan 2020 08:03:01 GMT
ENV WORDPRESS_VERSION=5.3.2
# Fri, 24 Jan 2020 08:03:01 GMT
ENV WORDPRESS_SHA1=fded476f112dbab14e3b5acddd2bcfa550e7b01b
# Fri, 24 Jan 2020 08:03:04 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 24 Jan 2020 08:03:04 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 24 Jan 2020 08:03:04 GMT
...
-	Layers:
	...
	-	`sha256:81f18e665f31035e14aaa049c28f8d343f886a06b1abe1a8f48b55cec5e874d2`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9856d400bfa6b2c70045f5997db1f955b4f50bf6e2fee1b4dd5722ca064d07e`  
		Last Modified: Fri, 24 Jan 2020 08:16:50 GMT  
		Size: 17.0 MB (17022666 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cf26ee276910f61fe670189407868a27d6a616ee143f88e92a1d2a3b83b6c41`  
		Last Modified: Fri, 24 Jan 2020 08:16:46 GMT  
		Size: 8.8 MB (8820341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2527c9baf70fb3747d95f0ad992a87696b2f7e3f26dbd6ead4247f60407ec615`  
		Last Modified: Fri, 24 Jan 2020 08:16:39 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:997a97328b57ddb87c5769046f976eecdae2dc1461243aab933274ae5112a25e`  
		Last Modified: Fri, 24 Jan 2020 08:16:39 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f996851365de2622ea507c15d25e13a69b67a6aae4de1b7ff6ccc51063c1a1e4`  
		Last Modified: Fri, 24 Jan 2020 08:16:40 GMT  
		Size: 19.5 KB (19476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6f520507a71dae003022f335345011bccd7355e5f0d142990c09cf2c2d727ef`  
		Last Modified: Fri, 24 Jan 2020 08:16:49 GMT  
		Size: 12.2 MB (12227881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a556ad0f42c36dcbc2c16b310dde2f5b81eb7150653b3b184e61cda4b100d58`  
		Last Modified: Fri, 24 Jan 2020 08:16:40 GMT  
		Size: 3.9 KB (3895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
