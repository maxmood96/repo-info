...
```console
$ docker pull wordpress@sha256:6c16044659506f93592c359d703e50662ced6fca3dab95bb8c85df0b934b72dc
```
...
```console
$ docker pull wordpress@sha256:125101efeee4b4593e203f67d8cc818df422093a6014e6e4d35444fb3b92305b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188427870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93e30c912e4a6df1b66872d5c10a405e52fce1f01bf62c04dd7e1bb23f192fb3`
...
-	Layers:
	...
	-	`sha256:011e53c9540e645c8f8b8f7120158dd3f9fcb60eb41b1da86797b8834292f205`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45160605795e8f0dd522d65cba11de102bfbd0e16b4599cd8fbb840423d7bf24`  
		Last Modified: Sat, 06 Mar 2021 02:36:56 GMT  
		Size: 16.7 MB (16705190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44b3eb9a2a25f286d74a976a54d749267d579dd24a5fc07e937c909021c03c9c`  
		Last Modified: Sat, 06 Mar 2021 02:36:54 GMT  
		Size: 9.3 MB (9284288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90ad17332e5ea1cadc8e4827aa9463c24f4f395ba0fae817cf252c28c9820b4c`  
		Last Modified: Sat, 06 Mar 2021 02:36:48 GMT  
		Size: 370.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ca4596a16985af5f381cec8d048d593bd448baf21e819c68ee5fe1104e42f8a`  
		Last Modified: Sat, 06 Mar 2021 02:36:48 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b1e84b0fb3395ccfca90a4bc8a115a733a9c77ccde535c9d3e89790c1a5dc08`  
		Last Modified: Sat, 06 Mar 2021 02:36:49 GMT  
		Size: 19.5 KB (19484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6709d8e693cb42570d2b19b5be3939ca135b88cfb50222d75aee6f8dc33a4c90`  
		Last Modified: Sat, 06 Mar 2021 02:36:52 GMT  
		Size: 15.5 MB (15455638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbf7d8edfc582386a31461b450ebbad2af27b58c8ce6b40b95485ee71dedb89d`  
		Last Modified: Sat, 06 Mar 2021 02:36:48 GMT  
...
```console
$ docker pull wordpress@sha256:ad4f015965023ca7deac1009282391b73302307082502c2a5db8d0f7f7770b9b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (193987403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8a30d9564fee8960bcdb225030b21d72596add992ac7362fffd891203eb0fb9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 09 Feb 2021 13:42:35 GMT
CMD ["apache2-foreground"]
# Sat, 06 Mar 2021 01:08:50 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 06 Mar 2021 01:10:14 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 06 Mar 2021 01:10:16 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 06 Mar 2021 01:10:17 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 06 Mar 2021 01:10:19 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 06 Mar 2021 01:10:24 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 06 Mar 2021 01:10:25 GMT
VOLUME [/var/www/html]
# Sat, 06 Mar 2021 01:10:25 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Sat, 06 Mar 2021 01:10:25 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 06 Mar 2021 01:10:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b62234f9ff20856627afd2c02b9a54a37f5daa9331c193cf16048c38ed8277bd`  
		...
		Size: 890.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad7f39b940d22566715a7cf95aa289a76d935fdadd267563c935cc630648a990`  
		Last Modified: Sat, 06 Mar 2021 01:32:09 GMT  
		Size: 17.0 MB (17024468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:facb820a946645bf5ac8889f3d576ba056d0d11dbb2bd536f2ccdce4a700c3a7`  
		Last Modified: Sat, 06 Mar 2021 01:32:07 GMT  
		Size: 8.6 MB (8557673 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a82391e0e61d00cdeba935386b2e2701b387f85a10af3e94680fc4f76924ca9`  
		Last Modified: Sat, 06 Mar 2021 01:32:01 GMT  
		Size: 374.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cba7bf96ac4dd0fe28045ff384183085c49e6d70794b9d0646de9742852b860e`  
		Last Modified: Sat, 06 Mar 2021 01:32:01 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bc8464c15416d3a15a45b2a6cf1576f69d22dbc45655eb830974477c1e6578f`  
		Last Modified: Sat, 06 Mar 2021 01:32:01 GMT  
		Size: 19.5 KB (19482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ce69fdc4998f86270c2b7e3351447f26f25ff87dd8db2597346e668c0411431`  
		Last Modified: Sat, 06 Mar 2021 01:32:06 GMT  
		Size: 15.5 MB (15455623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff42079c0ebcd0167b6bd290137da9d3d298bf923b4a8c01a78fa9cfd370f593`  
		Last Modified: Sat, 06 Mar 2021 01:32:01 GMT  
