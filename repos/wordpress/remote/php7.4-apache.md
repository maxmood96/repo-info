...
```console
$ docker pull wordpress@sha256:067faf74230013a6efd5c05052bffafb189ba0629addbdc698d8f467b4263833
```
...
```console
$ docker pull wordpress@sha256:7669214f21ccbc2eda8b96b0a374697f7ee076ec6eb5c05a8c20cacb8655188c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.2 MB (185180886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd017cbd2ffc877e21b6b586312c5c269118d28c0f5a0787b12275ef552d5c68`
...
-	Layers:
	...
	-	`sha256:222f784d0415c442c3b0d68daf813d95170339f708a659b80299e48195c0ed92`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96657f2cdfe6a4493123ca6848e43b0b4aa216f0634aaa00773cd81ed0b7267f`  
		Last Modified: Fri, 17 Apr 2020 07:50:46 GMT  
		Size: 16.7 MB (16704985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa100f6d6f98da2e6172e8e2ebeb750c1fb503b4cfe25aaf34fa03b4c1c048bd`  
		Last Modified: Fri, 17 Apr 2020 07:50:44 GMT  
		Size: 9.5 MB (9538560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13f4db649e25c59a1c8182fed3dd68a392ccb7de08b232033860b83a4d925ec1`  
		Last Modified: Fri, 17 Apr 2020 07:50:37 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63da8d14c67b83679933b94ca206f2b962717d6f7a19cc7fb492e1290bf19723`  
		Last Modified: Fri, 17 Apr 2020 07:50:37 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80d8ad48a2a660792f799275225bffff8c3b1650c472951a78e6192da852b88d`  
		Last Modified: Fri, 17 Apr 2020 07:50:37 GMT  
		Size: 19.5 KB (19472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e5c26df4fdf364bd8c2840ec13e0cd1582e4a57a83fc3d5405227bba4d5adfd`  
		Last Modified: Fri, 17 Apr 2020 07:50:43 GMT  
		Size: 12.1 MB (12072169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05dacb4808929b0e344f84baf94383f00e409c7dee9f198ecd606685e0a593d4`  
		Last Modified: Fri, 17 Apr 2020 07:50:38 GMT  
...
```console
$ docker pull wordpress@sha256:ec854789a1789a9e4f6a5c2c983780b2f8f7661a54a9ad14d7c215059e41d8df
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161921316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6b50a0a036c82fd376b26a876f15c262136d50ed57d65993be7f54333e632c9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 17 Apr 2020 10:40:58 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 10:44:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 10:44:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 10:44:17 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 10:44:19 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 10:44:20 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 10:44:21 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 10:44:22 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 10:44:28 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 10:44:32 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 10:44:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:3460e571585e6849711b3ea4f4b254cb7830f0a5833fedbb7e22a24d4d99fa16`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:746b75d4f7d87b1d94b2f64c92922b7c941c9d7a405ce529a5d28c6f65c9d9a4`  
		Last Modified: Fri, 17 Apr 2020 10:52:33 GMT  
		Size: 16.3 MB (16279714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b710da3d818b3be819878388138c5b4f06245398b02889de5f9c72c9487286de`  
		Last Modified: Fri, 17 Apr 2020 10:52:29 GMT  
		Size: 8.4 MB (8402545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7f1094fd85eb801d1449b3282a1d804b336b1d1b21fac51a92a1189ac785eb5`  
		Last Modified: Fri, 17 Apr 2020 10:52:25 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c4d2407a34bcd7430a44b76155e3ae951a4a76d548c6e12b82e9758ba36a369`  
		Last Modified: Fri, 17 Apr 2020 10:52:25 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f40b4327706498718a9ba37cce2025347bba06031f340ff9f1874f598e377e6b`  
		Last Modified: Fri, 17 Apr 2020 10:52:25 GMT  
		Size: 19.5 KB (19486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:406de1a1aa6d0ce5ca3764c9dd4430c4f5d86abfcf5a0ef1e2a2c941f6a27b36`  
		Last Modified: Fri, 17 Apr 2020 10:52:31 GMT  
		Size: 12.1 MB (12072221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df707f5c7ed5445102495429a290bc51c495d3949d80c07d789ee5ccd045d99d`  
		Last Modified: Fri, 17 Apr 2020 10:52:25 GMT  
...
```console
$ docker pull wordpress@sha256:adebe443f095c12cc715dc98ea91acf9dd8d6232eaf76d57f605268cc8bc4891
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158006622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b18ca8f9c1a329b01d90f266acab01d82a91f9023d49936050f02833e8e0dc3a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 17 Apr 2020 11:55:22 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 11:58:23 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 11:58:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 11:58:27 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 11:58:29 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 11:58:30 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 11:58:31 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 11:58:32 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 11:58:37 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 11:58:38 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 11:58:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:bc8ebe8535e9263681b10d1f6b1b1b4f0fb30fc1359ebe222557bd6b3799061e`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed6c0c8976da5bd08adc04c18e4492365412c64cd6e7d99064154267a39c74a6`  
		Last Modified: Fri, 17 Apr 2020 12:11:47 GMT  
		Size: 15.9 MB (15855427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:051e3ec2070a50b0445c8faf18a7d967ccc8068f984905b0a1b910e036a1726e`  
		Last Modified: Fri, 17 Apr 2020 12:11:43 GMT  
		Size: 7.6 MB (7555450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87599a88ac7a5ccdb666a60567b9a7c8abed8e75aae3b26e62cc88b04b26371d`  
		Last Modified: Fri, 17 Apr 2020 12:11:40 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0f9dac38f654d9a05eaea47587c4b027fb7df097e6ed4322c57fb1ea83916be`  
		Last Modified: Fri, 17 Apr 2020 12:11:40 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83e99c913d8b8ed0e448a7e50f33a5bb45e0191fe05f0e6ae498c023bdfbea8a`  
		Last Modified: Fri, 17 Apr 2020 12:11:40 GMT  
		Size: 19.5 KB (19474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94dc6e4e7bd8e48750d1fc3bc26164d355b51b11398785dda140e2cd0b9f9f82`  
		Last Modified: Fri, 17 Apr 2020 12:11:45 GMT  
		Size: 12.1 MB (12072226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52af61885a30c5dddd34056c9c35ceed4289d441ce92e8aef9e9331aad8a6f93`  
		Last Modified: Fri, 17 Apr 2020 12:11:40 GMT  
		Size: 3.9 KB (3891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:3fc27aa1dc5f1e8b70065d3314d9dc3388c0da174589737df739e2034e2c2a77
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175668585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e40629937276965813dd82a956bc82c11199c98fc14ecf814cedb0a373cc6e5f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 12:44:25 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 12:44:26 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 12:44:28 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 12:44:29 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 12:44:34 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 12:44:35 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 12:44:35 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 17 Apr 2020 12:44:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:df12fcc652750a58e4fa9b3c2f3b9b31d002f4e2513d5ddc2bac29ee593c265f`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03453873c7ba2915a67268f76227f50ad18bafb5fad6880a8df36e802722424a`  
		Last Modified: Fri, 17 Apr 2020 12:57:15 GMT  
		Size: 16.6 MB (16649269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2375c221afe2c0512d598084dbf7d576c7210e22983260397dbb55422cc725c7`  
		Last Modified: Fri, 17 Apr 2020 12:57:12 GMT  
		Size: 8.0 MB (7955003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2f2425268790ee601410137a1ee913c310612e3fb8fd71476289cb2f120c187`  
		Last Modified: Fri, 17 Apr 2020 12:57:08 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d19f6ecf717f52c3141c51684d46e00e01b4319fa633357b024240b674c1233e`  
		Last Modified: Fri, 17 Apr 2020 12:57:08 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7809fd4e16875ce3e663884379945531f5d774e5b04b134cb2ae86e396569a96`  
		Last Modified: Fri, 17 Apr 2020 12:57:08 GMT  
		Size: 19.5 KB (19476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f3188f53137de4116c3560b30e17fcbea571e77dc2f0f502d487d98fe05544`  
		Last Modified: Fri, 17 Apr 2020 12:57:13 GMT  
		Size: 12.1 MB (12072226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51600d51169197a34b3a961aed65dcb4d2b4c1def8b7ea951e85c25893569bd1`  
		Last Modified: Fri, 17 Apr 2020 12:57:08 GMT  
...
```console
$ docker pull wordpress@sha256:f31a0caebfe5130926905f6c981a77ac2459da74a766077f094b9080bb098cd0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190733348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd819db7c278cb021a49723704e7a52cc286ab0dc6d9bfc79048779249161798`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 17 Apr 2020 12:40:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:43:37 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:43:38 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 12:43:40 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 12:43:42 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 12:43:42 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 12:43:42 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 12:43:43 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
...
-	Layers:
	...
	-	`sha256:40f14a8701296acfc3ad8c5761a1429ff48a1aaa7fab44154e6111dc396c63d5`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d92967ed483918bc5b5febd9a1f18f01d669885a05adba39c05f29578a6f60c4`  
		Last Modified: Fri, 17 Apr 2020 12:56:31 GMT  
		Size: 17.0 MB (17022806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0a38db7c9e9bdfc98710c57539812f899f6b46f761e0164102a819b354d4d0c`  
		Last Modified: Fri, 17 Apr 2020 12:56:25 GMT  
		Size: 8.8 MB (8816354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:437721877827e466d7c684941054b460e71d9af15c7d5f8bde2f1d311a1729e3`  
		Last Modified: Fri, 17 Apr 2020 12:56:16 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81ab0d079b77a3f7f0c6d7d024821b2fcedcc6fb8365ccc52aa33d215d78cd38`  
		Last Modified: Fri, 17 Apr 2020 12:56:16 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:288f8515b7170ee61d73c39656feb9ae622c751915739b89c8cfd1785b6910be`  
		Last Modified: Fri, 17 Apr 2020 12:56:16 GMT  
		Size: 19.5 KB (19479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a6f629761ce5aac1d99e95dc06f9699929da47d5772e54ea2fd44f296964775`  
		Last Modified: Fri, 17 Apr 2020 12:56:29 GMT  
		Size: 12.1 MB (12072164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9212a74ea5cffb03f445edcfca335c65b04dd366f4e53e133a865a2d789063a`  
		Last Modified: Fri, 17 Apr 2020 12:56:16 GMT  
...
```console
$ docker pull wordpress@sha256:dedb4c190ecfd66f6c5899cdb7a1688d9f9d45191abe6770252a6a1c628e014d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.0 MB (197018369 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98314111df14a66a674fbd999479c11cde9575116bd0b478c41514d7df1919b3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 17 Apr 2020 04:14:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 04:22:13 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 04:22:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 04:22:27 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 04:22:35 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 04:22:40 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 04:22:43 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 04:22:45 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 04:22:53 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 04:22:56 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 04:22:59 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:b0bb0498e1163c8dbc7b63bc6eaa184f5ea3cbcb46c507b3ad2abb5d50e425ec`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61578e0e3b383367f88878d6e4cf14e129af3fe331e384c6829b9f2ba270d9f1`  
		Last Modified: Fri, 17 Apr 2020 04:34:45 GMT  
		Size: 17.5 MB (17456161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:716a998ce91d57dd168f466478b1869fca656cda5c44a750ffd7d97cf9bf2db3`  
		Last Modified: Fri, 17 Apr 2020 04:34:44 GMT  
		Size: 9.4 MB (9410622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cba101c70c3d8b53116fa0f33dd16f7fbc63f25b048a0df424d91ec95e26bea`  
		Last Modified: Fri, 17 Apr 2020 04:34:37 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:070058b2fc4129154723c876f27eea9edb9866df3944bf2ae8ab87759d5a763e`  
		Last Modified: Fri, 17 Apr 2020 04:34:36 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a511b91472d82d26faf1fe9f5bd04e641c35f2a80953cfce2d3b608536ce543`  
		Last Modified: Fri, 17 Apr 2020 04:34:37 GMT  
		Size: 19.5 KB (19476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a67ed935d85785e5051929a671d7f3a1bc1400a5d5459fe421ffb0186750bdfc`  
		Last Modified: Fri, 17 Apr 2020 04:34:41 GMT  
		Size: 12.1 MB (12072215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1c5e37aef93a6bea4a700d89caddebf61204a41e1b24e8dca7747f9ee096598`  
		Last Modified: Fri, 17 Apr 2020 04:34:37 GMT  
...
```console
$ docker pull wordpress@sha256:378474a2c0cd9c73e7cb9ed40b0f5d6595a52fbd39233c13981622be677f0c80
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.4 MB (169373359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89ea323d315d9bd8aed69e0fd8e344a713277c8a383387a55b4f1945105abe00`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:40:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:40:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 12:40:04 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 12:40:04 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 17 Apr 2020 12:40:05 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 12:40:05 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 12:40:05 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 12:40:07 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 12:40:08 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 12:40:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 17 Apr 2020 12:40:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:241168eeea0fc22619028673bdaada8a84b0fb788b5100d474ac16a06fd76da1`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0919ea1a3effaa5a39eb7aa5c35b06398c9a7bddbe857c4c1a315fea1afd64d7`  
		Last Modified: Fri, 17 Apr 2020 12:47:52 GMT  
		Size: 16.6 MB (16627631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98bd6dcd9eda977714d11bf00cc654f60a27157b2af48263d797012be73edc35`  
		Last Modified: Fri, 17 Apr 2020 12:47:51 GMT  
		Size: 8.1 MB (8097151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65060d2c83c30a60399526aef373d71c2b7e425e4e78170e3bf5385ce434a2e0`  
		Last Modified: Fri, 17 Apr 2020 12:47:48 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b01e441d905fbb31e5af700e6b313437afb1e40f70e0e074bb278d1fc08ee52b`  
		Last Modified: Fri, 17 Apr 2020 12:47:48 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:816373c9321ef214e9440906a80a2f65b7032f42ffee824d14b1502671e16336`  
		Last Modified: Fri, 17 Apr 2020 12:47:53 GMT  
		Size: 19.5 KB (19471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e4afd43e30dba6d26e06a510397b8acf48c40c655f8a62408947f152698bf58`  
		Last Modified: Fri, 17 Apr 2020 12:47:56 GMT  
		Size: 12.1 MB (12072226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd5b986319c40803fc163903e5a2e5f8cf01da2e283a53ac7204faa9595eb750`  
		Last Modified: Fri, 17 Apr 2020 12:47:48 GMT  
		Size: 3.9 KB (3896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
