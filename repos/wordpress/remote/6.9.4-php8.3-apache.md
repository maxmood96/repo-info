...
```console
$ docker pull wordpress@sha256:2db426f22d4fe6474b4eed3f020bca2d22b9e97a68c8d53ac48386900880c0f6
```
...
### `wordpress:6.9.4-php8.3-apache` - linux; amd64
...
### `wordpress:6.9.4-php8.3-apache` - unknown; unknown
...
### `wordpress:6.9.4-php8.3-apache` - linux; arm variant v5
...
### `wordpress:6.9.4-php8.3-apache` - linux; arm variant v7
...
### `wordpress:6.9.4-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.4-php8.3-apache` - linux; 386
...
### `wordpress:6.9.4-php8.3-apache` - linux; ppc64le
...
### `wordpress:6.9.4-php8.3-apache` - linux; riscv64
...
### `wordpress:6.9.4-php8.3-apache` - linux; s390x
