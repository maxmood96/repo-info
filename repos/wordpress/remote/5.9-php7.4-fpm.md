...
### `wordpress:5.9-php7.4-fpm` - linux; amd64
...
### `wordpress:5.9-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:5.9-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:5.9-php7.4-fpm` - linux; 386
...
### `wordpress:5.9-php7.4-fpm` - linux; mips64le
...
### `wordpress:5.9-php7.4-fpm` - linux; ppc64le
