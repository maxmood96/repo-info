...
```console
$ docker pull wordpress@sha256:b660aa9049e0ca8b56f162570a4d6b4f6d9a4b3a732fc9aef932ab20ffb46b0a
```
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC2-php8.2-fpm-alpine` - linux; s390x
