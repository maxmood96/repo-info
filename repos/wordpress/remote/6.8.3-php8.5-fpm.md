...
```console
$ docker pull wordpress@sha256:fc006c1ef6c1e483f4693c77eee5a0dfff2a1cf65fc8fa211290b5c58b919ebb
```
...
### `wordpress:6.8.3-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:6.8.3-php8.5-fpm` - linux; ppc64le
...
### `wordpress:6.8.3-php8.5-fpm` - linux; s390x
