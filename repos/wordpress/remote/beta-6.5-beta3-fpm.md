...
```console
$ docker pull wordpress@sha256:e94658d1961fe2a859cf7c6429772f92b60e333583b20cc586e02b43e68af0b3
```
...
### `wordpress:beta-6.5-beta3-fpm` - linux; amd64
...
### `wordpress:beta-6.5-beta3-fpm` - unknown; unknown
...
### `wordpress:beta-6.5-beta3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta3-fpm` - linux; 386
...
### `wordpress:beta-6.5-beta3-fpm` - linux; mips64le
...
### `wordpress:beta-6.5-beta3-fpm` - linux; s390x
