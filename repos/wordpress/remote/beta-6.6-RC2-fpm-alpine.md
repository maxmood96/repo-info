...
```console
$ docker pull wordpress@sha256:2a6a7f9b0a7d92799a83dac149a556d641e4b87821b2953ebe049c7baa930ae5
```
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.6-RC2-fpm-alpine` - linux; s390x
