...
```console
$ docker pull wordpress@sha256:d3885569b5b8cefe0cf9b4f8a012a5437b3d0a16ea7595788721fdd2c0d391a3
```
...
```console
$ docker pull wordpress@sha256:cb377c4881347fabc01d4152fa6aafa23e24159e19fca5d9602595f9d4d9f00a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.1 MB (104116708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8873b4fff5a65bfd82debb33c14294ab436ef4a5c93b46a1eeb71ead7d11f5e5`
...
-	Layers:
	...
	-	`sha256:2c97bce0d46d386d0a94ae167bc5db3fec82d1b40a34494aea548139cb0e10ac`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c547782fa4cab262de3a0eb789ef638b4690076443b87d6d96b26324baa06a5`  
		Last Modified: Fri, 11 Mar 2022 15:38:55 GMT  
		Size: 18.6 MB (18550498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a6b4e48c406717fdfbf4b489e05c2c3dc4922bc6d2cc0221f14679753cba54b`  
		Last Modified: Fri, 11 Mar 2022 15:38:52 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf864ac3fbcaa2f090aebf7af05082acd5454ff28f2a3fbafaf58f0f12368a70`  
		Last Modified: Fri, 11 Mar 2022 15:38:52 GMT  
...
```console
$ docker pull wordpress@sha256:7e5cc3fbb31c8267bd866caa3322842e3e6b62fcafaf40352053a9aa74f310e0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.7 MB (96738403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2e1390ed8d4e9a22a32c2327bdcda570ae9491c17477c2eef54da81389550d7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Mar 2022 19:22:09 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 11 Mar 2022 19:22:10 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 19:22:11 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 11 Mar 2022 19:22:11 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 11 Mar 2022 19:22:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 11 Mar 2022 19:22:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:984bce8c217d3cc82dfa232668a9aa519b04cab047614043d7f0f0de2cfb4526`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:683c2adc423432136e01980fb2609de4fb783aa43332f837cd91029c44728f2c`  
		Last Modified: Fri, 11 Mar 2022 20:00:47 GMT  
		Size: 18.6 MB (18550500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f21de485e831eab7e29b2ede3358c312dcae2a716981ecd07c0dab25f2a5567c`  
		Last Modified: Fri, 11 Mar 2022 20:00:33 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba6bfdc57eeba668c015804020c3ac847a9d6fb959c5072adac79cd609f3c7ab`  
		Last Modified: Fri, 11 Mar 2022 20:00:33 GMT  
...
```console
$ docker pull wordpress@sha256:b36a711a2b98fb61420b5564e859d05bb4fac7225016b0c189169ba0e8c3db5b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.1 MB (105088619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc40da3a1a72d9de9a0eee09663c054a67a22a53aeb290d62fa34899a44c4097`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:949e1b4b5f8147b4427da6cfc125b29b509802a9c6217772ffb5f810e9f3ca5a`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f9049f5d9c1db5480fc51fd8f0f71b98388f53f6d0b8ed9a0583ce5dc61c1a1`  
		Last Modified: Fri, 11 Mar 2022 18:40:04 GMT  
		Size: 18.6 MB (18550497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fe30f563f428c644fb63ebcffa1434c3fe05f1bbb315abc5d7c0e0f3b290cf8`  
		Last Modified: Fri, 11 Mar 2022 18:39:59 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dfb5d79126677b1dfc8bfd29afe27986eb4b55eb0a29d2b7db8856e90198416`  
		Last Modified: Fri, 11 Mar 2022 18:39:59 GMT  
...
```console
$ docker pull wordpress@sha256:b0b21da6b87322a1489fe55c1d51ba8ffa7d9244cb1a4beb5f2c67ec3f02b30e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.9 MB (105880318 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd964121889fcaa96341f33e4e36c42db1f76371fcc499021eedd164edd9714b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Mar 2022 21:28:25 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 11 Mar 2022 21:28:29 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 21:28:30 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 11 Mar 2022 21:28:31 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 11 Mar 2022 21:28:33 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 11 Mar 2022 21:28:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:81dd1b5d6ce25a3404e1d35002cad3d3e54922391329415c2fc6422f819164a1`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d393981b303fc196e7ce09d5a5c2f11571cb4b95f138c298dc123d0329825cd2`  
		Last Modified: Fri, 11 Mar 2022 22:20:30 GMT  
		Size: 18.6 MB (18550497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06c5b73dae271893edb4d5ab06a183faee44b5b197b2c6b7b2c42768fd34d22a`  
		Last Modified: Fri, 11 Mar 2022 22:20:27 GMT  
		Size: 2.3 KB (2335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39ecf29fc3e2799c5d11951813223e37f9d5ce105a77109e2de076f76c401c8b`  
		Last Modified: Fri, 11 Mar 2022 22:20:27 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
