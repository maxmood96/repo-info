...
```console
$ docker pull wordpress@sha256:430ccd1b9dee115446f2c4fa7fc4423bc10afc999bf7cafbd2808a054e784360
```
...
```console
$ docker pull wordpress@sha256:4a30efc61d97d65dd220a2f255dbfaf54d551e06c16c89f82d0a4a234cd36115
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.7 MB (99669525 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00a3975adf4e92f3ff79a855418781c0948ef137062aa46a445649bf82cec36b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Feb 2022 01:48:47 GMT
VOLUME [/var/www/html]
# Sat, 19 Feb 2022 01:48:48 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Sat, 19 Feb 2022 01:48:48 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:178970e3a4ee9c1cc25984e2512d11c19a77a7c6db0d643285f6a69fe6fa5d13`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00f089cba14c84d06d0cc2ed77666da160345a423a9658b1e7751c02229912c6`  
		Last Modified: Sat, 19 Feb 2022 02:33:46 GMT  
		Size: 19.0 MB (18954916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3c23c7da0c40e106cc86eda07b45616d9199fd7093f960c209730e202351967`  
		Last Modified: Sat, 19 Feb 2022 02:33:32 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9546437a83657cf3e4d4970c7ece190ebf1347ffebda0240c936337200fc77b3`  
		Last Modified: Sat, 19 Feb 2022 02:33:32 GMT  
...
```console
$ docker pull wordpress@sha256:e9bc68472c40d2772c20c04d3771d16dfe527592004c66556ff4b190f4e7711f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.1 MB (105106914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd0214d71b18ca1c6c409a9a5830064b66491570a233105e185e915386f6a4ca`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Feb 2022 01:06:44 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 24 Feb 2022 01:06:44 GMT
VOLUME [/var/www/html]
# Thu, 24 Feb 2022 01:06:46 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 24 Feb 2022 01:06:47 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Feb 2022 01:06:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Feb 2022 01:06:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5c24c13bfea2207c2aaa48d5e1c8ee6c59e47968e5f907f98281dfb0256cb278`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe64ecf4c99da8f7511051d764d2b6f043ca13d6185504fb9f0300f350cee564`  
		Last Modified: Thu, 24 Feb 2022 01:16:50 GMT  
		Size: 18.6 MB (18551797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c80eaa52d109e1c56bbf4f4f57cd237877cd0503902e36ebaa55fbb29e5f967b`  
		Last Modified: Thu, 24 Feb 2022 01:16:47 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fb47ba327bf22e403ac24f114016ba2794df41e469e6c2f1c956e2e8faa55fe`  
		Last Modified: Thu, 24 Feb 2022 01:16:47 GMT  
...
```console
$ docker pull wordpress@sha256:f93681b8301c0103eecddfd19c18a08e3961d3be857bb215b51dea1a9f411647
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.6 MB (108601387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ba7843e984dc074a55fd0e77fce76d2fd4aaaf2b8f026d2be2224dae6628989`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Feb 2022 03:06:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 19 Feb 2022 03:06:49 GMT
RUN set -eux; 	version='5.9'; 	sha1='4e9a256f5cbcfba26108a1a9ebdb31f2ab29af9f'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 19 Feb 2022 03:06:49 GMT
VOLUME [/var/www/html]
# Sat, 19 Feb 2022 03:06:50 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Sat, 19 Feb 2022 03:06:50 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 19 Feb 2022 03:06:50 GMT
...
-	Layers:
	...
	-	`sha256:e484b70a668f28183de9eb18bea2cf3f755e7f818fe18c8ec59fe768a960a464`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef2fb33a0c8c18368f46dcbb99390896f9345607da455ad1169e168262e8441a`  
		Last Modified: Sat, 19 Feb 2022 03:28:19 GMT  
		Size: 19.0 MB (18954913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d72b24b23239bd49030f434b73029ea5dacb0b919d827a08ae4edaf20b5dc111`  
		Last Modified: Sat, 19 Feb 2022 03:28:13 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff8166df49111231bf741fc5f833a1d5c09aa63f197bcb5fe0ec2bf655306b60`  
		Last Modified: Sat, 19 Feb 2022 03:28:13 GMT  
...
```console
$ docker pull wordpress@sha256:3a621c49f706dae0886bc7593c872cf832cae0b29202b22ad728162ebbf3c7d2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.8 MB (97768827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:670b942fd612ea6d6b1e59d546f423a0cc7378f4e48922d816ab469ac4748cc8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Feb 2022 01:36:57 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Feb 2022 00:31:20 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 24 Feb 2022 00:31:22 GMT
VOLUME [/var/www/html]
# Thu, 24 Feb 2022 00:31:22 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 24 Feb 2022 00:31:22 GMT
...
-	Layers:
	...
	-	`sha256:53712e08fcf0b0ff25756fdae184821561ceef64c5f74aaa6207b39199054cb6`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c34f093af6a76b706c6cd336afdc384cf6536da4a43ac0eb685183cc231809a7`  
		Last Modified: Thu, 24 Feb 2022 00:38:36 GMT  
		Size: 18.6 MB (18550506 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d21631c6bc6fec7eb1832a6fc781eacb989a3a1d842578bb71a0429bc8184c66`  
		Last Modified: Thu, 24 Feb 2022 00:38:33 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5a27c4c296780d7054f34648ca6d7847ccc3037430ebad016b78ba50b330e20`  
		Last Modified: Thu, 24 Feb 2022 00:38:33 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
