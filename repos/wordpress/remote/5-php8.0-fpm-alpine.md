...
```console
$ docker pull wordpress@sha256:b386863d022f64bc3e23c6723205c42eac8b9a088528a734d23b0f01836fe570
```
...
```console
$ docker pull wordpress@sha256:6c0772094a68a194f511fd62182a13628f54d54f1ce6de1722a254ba52750b89
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.6 MB (86598795 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32c668338963edce16ac0460027a80285937c7c30263ff7f2b889ecb9b6582c4`
...
-	Layers:
	...
	-	`sha256:7a5dbcbdda3ed8803e5d25d7e500c518174563fe82d884ac20445e3029d45753`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b6505679e07a7d4530573ba0813744a6af08cf4030bf9cfa813c20083b1b14e`  
		Last Modified: Fri, 01 Oct 2021 01:17:10 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a142ecc60158414518f68aa93d2773745c91a5af4c16baec7108ceaeb696b439`  
		Last Modified: Fri, 01 Oct 2021 01:17:10 GMT  
...
```console
$ docker pull wordpress@sha256:316b110d80a4b5f43016d5653032e7afcba0a9f9f14d07f19aab3bb3c591b4cd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **82.8 MB (82791116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64063395735a977415caada6c4171abc4e27d18136ac626f918ebb7ef2c26b46`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 30 Sep 2021 23:04:31 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Thu, 30 Sep 2021 23:04:33 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 30 Sep 2021 23:04:35 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 30 Sep 2021 23:04:43 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 30 Sep 2021 23:04:44 GMT
VOLUME [/var/www/html]
# Thu, 30 Sep 2021 23:04:44 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 30 Sep 2021 23:04:45 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 30 Sep 2021 23:04:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 30 Sep 2021 23:04:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d81a549c7bf8a43b6de0efd3b59ede665021cf57f8f96613b26a23b1d2b7f727`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22287ff29dfc0ed103df39079479335ec974e5d0d3a69174e3b9672b2f7b3536`  
		Last Modified: Thu, 30 Sep 2021 23:15:37 GMT  
		Size: 1.1 MB (1127947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbaad3d7b78f41729969cdad711e1ccef4beb41d06eba7774e6137ee6ee0cd23`  
		Last Modified: Thu, 30 Sep 2021 23:15:35 GMT  
		Size: 63.9 KB (63926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9e81c9bb117fa82cfd420968cc520be04a87ebbdd7d7823d00232ec76e8b8a3`  
		Last Modified: Thu, 30 Sep 2021 23:15:35 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbbad31de58474687566c65d5f97dc4a8b4a0cccae43fab4b42d715f59626e41`  
		Last Modified: Thu, 30 Sep 2021 23:15:42 GMT  
		Size: 14.9 MB (14915901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73ec61b50ccc7dec4b11d59fcc2afeaa0d805f96ad20c3e1d459f1606594a50b`  
		Last Modified: Thu, 30 Sep 2021 23:15:35 GMT  
		Size: 2.4 KB (2353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc471bfd47c602e4ef2503129d030e0440db458ec74b4d1895f03cb9eefa6fe`  
		Last Modified: Thu, 30 Sep 2021 23:15:35 GMT  
...
```console
$ docker pull wordpress@sha256:cd601bf26ac60c7849b524ee8c84fa8f0d4b913e24e5e52aee0de833cc120760
```
...
-	Total Size: **79.4 MB (79409540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e36a45eaebc8a963c92431f7c5414bb4761c65bd5ca0827762838e5ac3dc92b0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Oct 2021 03:16:22 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Sat, 02 Oct 2021 03:16:23 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 02 Oct 2021 03:16:23 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 02 Oct 2021 03:16:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ff7158a76daca97e77175542890be6310d168bb466b93dfbc96853ea2fb36684`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b53cd9479066d59c0c77910f5270a1bf415fda986427bd9a141699e684413d51`  
		Last Modified: Sat, 02 Oct 2021 03:36:04 GMT  
		Size: 2.4 KB (2356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9624bc885e81cfcb1728fae877b4a13c11c5f56f57030aa93194a7c8218b2807`  
		Last Modified: Sat, 02 Oct 2021 03:36:05 GMT  
...
```console
$ docker pull wordpress@sha256:7e2f6a9b9925f4eb5617a5cd2670fc9f0735715e71c6c98a9a3e43487638892d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.4 MB (84435756 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed4604dc34df1fc4fba8c8e7375336ab466c5e1a9eaa16c2d21b5028f77688d1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 01 Oct 2021 00:58:18 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 01 Oct 2021 00:58:19 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 01 Oct 2021 00:58:20 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 01 Oct 2021 00:58:22 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 01 Oct 2021 00:58:23 GMT
VOLUME [/var/www/html]
# Fri, 01 Oct 2021 00:58:23 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Fri, 01 Oct 2021 00:58:23 GMT
...
-	Layers:
	...
	-	`sha256:2fc55cdf675862d9f45afdc01324358e292106d3ec0d3e228edc9781f1ec00a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5e1aebb20252d8625e3725fd5f94bad61ecd9ff4eaa1ef52c19b363997d01a8`  
		Last Modified: Fri, 01 Oct 2021 01:10:28 GMT  
		Size: 1.2 MB (1178186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:797721e1fa4d1ba8f28c3451994d7b56abd94768a532125d2a1283f6eceb2905`  
		Last Modified: Fri, 01 Oct 2021 01:10:26 GMT  
		Size: 64.0 KB (63972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b9273a39a00f9403701a519822a176533e0b25ef6000a06c45e9c31197c7ee5`  
		Last Modified: Fri, 01 Oct 2021 01:10:26 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c90342d71273d26d1617d62c3a9795673f003727cf0e246f21e87ab7a3db3b4`  
		Last Modified: Fri, 01 Oct 2021 01:10:29 GMT  
		Size: 14.9 MB (14915920 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28c86175ec9bbc059903425b5c06c022e507917e04812b760e690e804614825b`  
		Last Modified: Fri, 01 Oct 2021 01:10:26 GMT  
		Size: 2.4 KB (2353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcbf9893e7e7e04693d0cb7441ea665d63018052628070f16c8332f136885c51`  
		Last Modified: Fri, 01 Oct 2021 01:10:26 GMT  
...
```console
$ docker pull wordpress@sha256:f0317fa588116a4e8e6ba9141c2b1a1d056f807f63bb1db46d05a066e31df5a4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.6 MB (87634298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edc79622622329b60931d9edd0ddfca3d98b57f86ad88f030b1ecd7514235fe9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 01 Oct 2021 02:07:12 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 01 Oct 2021 02:07:14 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 01 Oct 2021 02:07:15 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
...
-	Layers:
	...
	-	`sha256:670927b2a5d5030e8a3a6e28f44baab97d62e7779bced87146df080aeff0f6ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76d7eda196dea33d186581ba55bf1717426cf69d7cc79725738534c6de25a15b`  
		Last Modified: Fri, 01 Oct 2021 02:20:12 GMT  
		Size: 1.2 MB (1214087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a81a7b74a8b322136e09d818f82f37319688cbad4a27f97befe470bad6eca3d9`  
		Last Modified: Fri, 01 Oct 2021 02:20:10 GMT  
		Size: 63.9 KB (63898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f831ef4233e45ce5d7492d525f39edfcaa458a03a085ac913e1cb2743fcd251`  
		Last Modified: Fri, 01 Oct 2021 02:20:10 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8207b1cab35151053238ee99dc81380a71d8e9b8526acb16297bac071deaf179`  
		Last Modified: Fri, 01 Oct 2021 02:20:14 GMT  
		Size: 14.9 MB (14915897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a252a155875663d2cde48ab62e99673c2c1e7b84fd8685ac1d6e56951495adf7`  
		Last Modified: Fri, 01 Oct 2021 02:20:10 GMT  
		Size: 2.4 KB (2355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a073a1f79d8ea2b0e5d998f8cb13bc846066e2424dd47611821ce5c78954cc36`  
		Last Modified: Fri, 01 Oct 2021 02:20:10 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d0ac0eda70f5efaaa94a707ebccb57514ad7d8a58c920428ab42c7c53cac8ff7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.9 MB (87902552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e18104d9ab3a6ed66aab4fc03ac4f6af6e1f645228a7680588d5c10bcefeb13d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 24 Sep 2021 18:07:07 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 24 Sep 2021 18:07:15 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 18:07:30 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 24 Sep 2021 18:08:01 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 24 Sep 2021 18:08:05 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 18:08:08 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Fri, 24 Sep 2021 18:08:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 24 Sep 2021 18:08:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 24 Sep 2021 18:08:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8ebd6422f919ed37388e1c29a8700121c8556a8e161f4c3c9b594b648679b0b7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dc59174f2637533132a5c5cd3cf3e44b1da4d60c42d023f260d914e71b59b81`  
		Last Modified: Fri, 24 Sep 2021 18:26:52 GMT  
		Size: 1.3 MB (1258200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f141f32c5ccf3fcff00cdbb510968f3d1bcf942ed9216788aced960c1b465ad7`  
		Last Modified: Fri, 24 Sep 2021 18:26:49 GMT  
		Size: 64.0 KB (63973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87336737c3c251c01629f6066906e776676f3f8a5cebfb42fcdbe9936463c177`  
		Last Modified: Fri, 24 Sep 2021 18:26:49 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:879bf556649643a6e683518939b197d096d4f8f1a53933ee71e4bb3649ba9fcf`  
		Last Modified: Fri, 24 Sep 2021 18:26:52 GMT  
		Size: 14.9 MB (14915915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:867079d00045e58e1cafa30de207696b13bf29ee7e55fe983fa71f742b84bd96`  
		Last Modified: Fri, 24 Sep 2021 18:26:49 GMT  
		Size: 2.4 KB (2357 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6df13558d2c3edef017f6459eb9e554a6415329d550c39e1ee00747c779fc522`  
		Last Modified: Fri, 24 Sep 2021 18:26:49 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:fc28ceff58d5bdb3d92033806ddfbba46ad2780b4ff1ce29452d2214a31dc475
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.8 MB (76842097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e134e1922e97bdf8f4b6f9a597e540e5e2a5ed0feb0a1af7cfa11e0db92997e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 30 Sep 2021 22:05:14 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Thu, 30 Sep 2021 22:05:15 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 30 Sep 2021 22:05:16 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 30 Sep 2021 22:05:19 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 30 Sep 2021 22:05:20 GMT
VOLUME [/var/www/html]
# Thu, 30 Sep 2021 22:05:20 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 30 Sep 2021 22:05:20 GMT
...
-	Layers:
	...
	-	`sha256:8eca5f0b4c710072f596648a00646c58cc12e1640e6358bfb30d88c81ca189f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac518fb7c0d253540bbd9d4466e4f3cae8b63118abeae2bfa3ad37e80252b84`  
		Last Modified: Thu, 30 Sep 2021 22:13:33 GMT  
		Size: 1.2 MB (1190147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4aa499bf8cd02947d854de156ff5c3551ea77afa8a05b39a7d17ae3419c90f78`  
		Last Modified: Thu, 30 Sep 2021 22:13:32 GMT  
		Size: 57.7 KB (57697 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a84e1913dbd430eb08b6b55b56e3b0bf8c6fbebba2f56cb550f567c6e3ecf9b`  
		Last Modified: Thu, 30 Sep 2021 22:13:32 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc4bf9ee5caaddfc3d5ab65dcda11459e421c7437e179180b4b52f1a131ccefc`  
		Last Modified: Thu, 30 Sep 2021 22:13:34 GMT  
		Size: 14.9 MB (14915913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ef44cae02c674f67be0a024285991d5a8502c32ef5f28b86c39ec53447aefef`  
		Last Modified: Thu, 30 Sep 2021 22:13:32 GMT  
		Size: 2.4 KB (2354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49046959053e620273fe3c522e99f7710be9e4282e6c0c090fdeb12411246bf8`  
		Last Modified: Thu, 30 Sep 2021 22:13:33 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
