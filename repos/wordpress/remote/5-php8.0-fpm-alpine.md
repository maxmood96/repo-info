...
```console
$ docker pull wordpress@sha256:0ed8bdfbedd9d61d29cfedc929787cb20f599255b54aabe968b0990cd1736e5b
```
...
```console
$ docker pull wordpress@sha256:f47e24aec13f6ff7ba37009a7d216d87564b2b8e32d4ac1c51536ed64eb1e9d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.4 MB (103369952 bytes)**  
...
-	Layers:
	...
	-	`sha256:1a4a896551df891808a1830beb963cceabeabbb8f39363e6f18eb0ad69b50c60`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f65bc3cc631e17063de502dc2a74d50044e44d7596a655225115c0f9e52dc2d`  
		Last Modified: Thu, 03 Mar 2022 18:22:50 GMT  
		Size: 41.2 MB (41158146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfb6f05d902f31c31c72fdafe28da175a8ab80b60dcc2e6e2a76984564191839`  
		Last Modified: Thu, 03 Mar 2022 18:22:46 GMT  
		Size: 15.4 MB (15370922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7350aa2fb24f4a752942e48c8584b4d68435a9104ce469d87c99c109997b6cd5`  
		Last Modified: Thu, 03 Mar 2022 18:22:41 GMT  
		Size: 65.1 KB (65064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91735c2c723ccf02b842870ae3c84d61df9e8b661cb9cfaa06925b0e7f7d93d1`  
		Last Modified: Thu, 03 Mar 2022 18:22:41 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:642227f3e08965c3157f9545f5365599ca88f61026e2f20a67a9203451b9ecce`  
		Last Modified: Thu, 03 Mar 2022 18:22:44 GMT  
		Size: 18.6 MB (18550509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c2a7a8ed3e0fe299e1ed73717472f259abf527f2523b6124ebea0f5d65a1e4d`  
		Last Modified: Thu, 03 Mar 2022 18:22:41 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6712b0514a125c40a899568a911014c8aea4d86f36fdb92dcc26597297313f7`  
		Last Modified: Thu, 03 Mar 2022 18:22:41 GMT  
...
```console
$ docker pull wordpress@sha256:27f96e08b7ed8742a62b8584af866b5432dc59b14d293ac15602d651b9faa865
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.0 MB (99971144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9db63bf110c76bb8819027401eec903d8e74eb4aa251867535fe318ab68bdbe`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Mar 2022 06:26:07 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 11 Mar 2022 06:26:08 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 06:26:08 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 11 Mar 2022 06:26:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 11 Mar 2022 06:26:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 11 Mar 2022 06:26:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2f23a65929f81fbcf09364cbb409ce902ac21cb2781a14012aa7f0902f793167`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:126b787887cb6f27441d1c98fb8cccf7a13d76519d07b0bb9390488166878c50`  
		Last Modified: Fri, 11 Mar 2022 06:46:39 GMT  
		Size: 18.6 MB (18550495 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1912d7f12dc2d4637562a1c7d6526d3e1dc8234ef056baad0beeb8f3f7bd15b`  
		Last Modified: Fri, 11 Mar 2022 06:46:25 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42929cb2463855a4db40b4ac5d9419ac3827106e7396ab4a27617c5bc9e2909b`  
		Last Modified: Fri, 11 Mar 2022 06:46:25 GMT  
...
```console
$ docker pull wordpress@sha256:c1e62497de7d6d2a1d425d161092271334635d42f4fbc872730c575982ba38cb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.0 MB (96008837 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5435e4fb02ea139f9539c2755cc37cb98248eaded626ca5ecd4e93f317ac5cf5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 13:32:49 GMT
CMD ["php-fpm"]
# Thu, 03 Mar 2022 22:15:39 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 03 Mar 2022 22:17:44 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 03 Mar 2022 22:17:46 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 22:17:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 03 Mar 2022 22:17:56 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 03 Mar 2022 22:17:56 GMT
VOLUME [/var/www/html]
# Thu, 03 Mar 2022 22:17:57 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 03 Mar 2022 22:17:57 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 03 Mar 2022 22:17:58 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 03 Mar 2022 22:17:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c368901f69b334740b7056ace22e08b28a705341d442da0592ed97ad6920998d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20cdd8c1d50a3b358120d0c7daa4dee32ceb7d5b395766a90fece4000f220a22`  
		Last Modified: Thu, 03 Mar 2022 22:54:42 GMT  
		Size: 36.8 MB (36810366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b28fe78cf218a7ee6af1889330506704fdb837e011c05a4bcaa57c0d08717575`  
		Last Modified: Thu, 03 Mar 2022 22:54:29 GMT  
		Size: 14.9 MB (14912628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0af94eb31527753ec6aa909d3907019e9fd620574538fcc922a61c5da48826b4`  
		Last Modified: Thu, 03 Mar 2022 22:54:19 GMT  
		Size: 65.0 KB (65045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:745e9f50dc00f96eb1670ccf7088851102384b26a4643753f5282475b476d2d9`  
		Last Modified: Thu, 03 Mar 2022 22:54:19 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66175a5b119eac7ae15a2004da5edbdcbc87fc2b32bffc1631dfb7db9650470d`  
		Last Modified: Thu, 03 Mar 2022 22:54:33 GMT  
		Size: 18.6 MB (18550504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e9d7d743f9b554908f71471643237ce9fc5940f94bcb5772996d87ba41248e3`  
		Last Modified: Thu, 03 Mar 2022 22:54:20 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a536d5ee93601e96311e88c0a3cd3a4b6cee93768f6b28bdabdca2de401960b5`  
		Last Modified: Thu, 03 Mar 2022 22:54:19 GMT  
...
```console
$ docker pull wordpress@sha256:6734f885b12f688a50d0d4db2817cfde3d684f9f36bb6b3485c4e045480bb44e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.1 MB (102129584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9e5ba68cf02ffe949e444c26b5a5ba4d19cdec72f148cc39e73d00fc77ba5b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 11 Mar 2022 14:10:40 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 14:10:42 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 11 Mar 2022 14:10:43 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 11 Mar 2022 14:10:43 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 11 Mar 2022 14:10:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:104da3eac1ed0fb14dbb164c0693a7f4185a262f83f72c1de505b5b8ad9e0268`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:858e269babf977711167166a34190d6b5eca8a97615e06dfb95f1456b9cf196f`  
		Last Modified: Fri, 11 Mar 2022 14:31:47 GMT  
		Size: 18.6 MB (18551802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bd3e05fb84f0fd15f156ab80a88f611510a83d0e9ce250cc5273e8cae534c4b`  
		Last Modified: Fri, 11 Mar 2022 14:31:44 GMT  
		Size: 2.3 KB (2334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b15240d6035a70432ce428467418ef50c20bf358d938a2ddd112084709d8a4a0`  
		Last Modified: Fri, 11 Mar 2022 14:31:44 GMT  
...
```console
$ docker pull wordpress@sha256:9f27f94a42b908b4276a73d1bed47bf23f70fe7aae560b7c3d8bb25d88f5b3e0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.3 MB (104341860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e76910e3b3de46543d0a748f3fbb03dc10ebdaa0b4c3f3415cd84e84771116c8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 02 Mar 2022 21:49:36 GMT
CMD ["php-fpm"]
# Thu, 03 Mar 2022 09:28:43 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 03 Mar 2022 09:30:58 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 03 Mar 2022 09:31:00 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 09:31:02 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 03 Mar 2022 09:31:08 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 03 Mar 2022 09:31:09 GMT
VOLUME [/var/www/html]
# Thu, 03 Mar 2022 09:31:09 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 03 Mar 2022 09:31:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 03 Mar 2022 09:31:10 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 03 Mar 2022 09:31:10 GMT
...
-	Layers:
	...
	-	`sha256:d5fe973d10aaa42bc1a7196c9265c0acad65bb3b27c9444228c61d91ebb3067e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47e4cedc05777246ce98f37a4991840d9e8a7cdca1b96d609eadf6273bdfeffa`  
		Last Modified: Thu, 03 Mar 2022 10:03:31 GMT  
		Size: 41.6 MB (41568325 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdce37f845cc057ad8fc8b4737d0769cd049f74fd045a7fadc4ba75a50f798b2`  
		Last Modified: Thu, 03 Mar 2022 10:03:22 GMT  
		Size: 15.6 MB (15575980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77cce6e7ac185ebf5de23daa8da99a4bf491f75603b3da6d7a97af00f4a0abb`  
		Last Modified: Thu, 03 Mar 2022 10:03:12 GMT  
		Size: 65.0 KB (65037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0f4d7769d83e067415a9b0f474144e49065520b2cfedfe1c642039cced36615`  
		Last Modified: Thu, 03 Mar 2022 10:03:12 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:299fd54a3a8803ebe325f64221417baf885443a672595a2c4539911d220416d9`  
		Last Modified: Thu, 03 Mar 2022 10:03:22 GMT  
		Size: 18.6 MB (18550497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13555b854463f6c1682d6c979e0933ecc1fe8039a7e53d22742e4d78ccb28871`  
		Last Modified: Thu, 03 Mar 2022 10:03:12 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c9177558c0a6eaa057a549fdebf6877df0794fc1fe3a94f0acae0c24e1162ed`  
		Last Modified: Thu, 03 Mar 2022 10:03:12 GMT  
...
```console
$ docker pull wordpress@sha256:de6c6c45b5cf39d6d4f623999f1767093a82cc325a60eac96221484bc8e50dfe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.1 MB (105128087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15fb0abf38e4b40a1e3d59cc5b73f8b049a2192545c62ad6bd0ab3b12e953a71`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 03 Mar 2022 13:39:45 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 03 Mar 2022 13:41:21 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 03 Mar 2022 13:41:30 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 13:41:36 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
...
# Thu, 03 Mar 2022 13:41:51 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 03 Mar 2022 13:41:55 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 03 Mar 2022 13:42:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 03 Mar 2022 13:42:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:82aad80aa5c9a78040dcf21503d6fea93e79a7687ea357ea45318efdf79afa11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26e2aab829c3c884ce8f8db8605056be1fb8e6892318ed57a2f781e9ec4aee8d`  
		Last Modified: Thu, 03 Mar 2022 14:34:08 GMT  
		Size: 42.3 MB (42338138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12bea8a7f5f176ed1151ed2d01c220a8b41cc6fc6d77e3c7649bac8ed95c797d`  
		Last Modified: Thu, 03 Mar 2022 14:34:02 GMT  
		Size: 15.6 MB (15572047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:952acf62c3870ab347aeb6515dbd568d6ce27462f4123a36c5d66b9b0ac9c878`  
		Last Modified: Thu, 03 Mar 2022 14:33:57 GMT  
		Size: 65.0 KB (64998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4df9579e175dfeb1be7d3b275aaa69c92bb1e775f6a77422ba990391ae91f6f`  
		Last Modified: Thu, 03 Mar 2022 14:33:57 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8d9df4f25d05c9ccfb7666bba70b5568f5dc1a6f4d4728848429f7114f3c36a`  
		Last Modified: Thu, 03 Mar 2022 14:34:01 GMT  
		Size: 18.6 MB (18550502 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04d73ca9dcafcc3e98e872cbcd19e1bf25ceeb468a3865b1246db8ca9f2e96c6`  
		Last Modified: Thu, 03 Mar 2022 14:33:57 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11a0302c7dc78476b66f7fc0d203c63896c64059e0199580e3cb027d611458d7`  
		Last Modified: Thu, 03 Mar 2022 14:33:57 GMT  
...
```console
$ docker pull wordpress@sha256:4703d1806e0efda33a2d0d90fc4f6e803203f205c354b855021ffc40eead714b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.0 MB (94967532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c77b0bb5197885d67f9470364901941038125f3c2dddfe419396f14585186b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Mar 2022 06:06:37 GMT
RUN set -eux; 	version='5.9.1'; 	sha1='15746f848cd388e270bae612dccd0c83fa613259'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 11 Mar 2022 06:06:39 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 06:06:39 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 11 Mar 2022 06:06:39 GMT
...
-	Layers:
	...
	-	`sha256:5bef70b7d1ec99d21a433dea54f1fa41445b377502ca054e7f70e137f1420ba1`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:172bdb790ec8acf3b5df978b0a6178d5d9c050e7f111618e42e3eb2a5bf5a21a`  
		Last Modified: Fri, 11 Mar 2022 06:23:14 GMT  
		Size: 18.6 MB (18550501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a80a0d0522fdd1914d90df7f5ee06eec84d09158dc8183822594f0fe4adf86c`  
		Last Modified: Fri, 11 Mar 2022 06:23:12 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d3ff4c924e0083b03bdad65d7f82cc8e5aa0d4f572d7b1e3e551931de3a9f7f`  
		Last Modified: Fri, 11 Mar 2022 06:23:12 GMT  
		Size: 1.7 KB (1726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
