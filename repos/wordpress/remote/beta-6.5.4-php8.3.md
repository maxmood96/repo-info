...
### `wordpress:beta-6.5.4-php8.3` - linux; amd64
...
### `wordpress:beta-6.5.4-php8.3` - unknown; unknown
...
### `wordpress:beta-6.5.4-php8.3` - linux; arm variant v5
...
### `wordpress:beta-6.5.4-php8.3` - linux; arm variant v7
...
### `wordpress:beta-6.5.4-php8.3` - linux; arm64 variant v8
...
### `wordpress:beta-6.5.4-php8.3` - linux; 386
...
### `wordpress:beta-6.5.4-php8.3` - linux; mips64le
...
### `wordpress:beta-6.5.4-php8.3` - linux; ppc64le
...
### `wordpress:beta-6.5.4-php8.3` - linux; s390x
