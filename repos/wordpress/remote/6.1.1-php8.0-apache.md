...
```console
$ docker pull wordpress@sha256:6f09394d272bbe2fcbd5e6f63e82770d44d35795a0018567b1d98ad276098f73
```
...
```console
$ docker pull wordpress@sha256:9b41c3d9afe1b2bd5cd8fb0a17d316bead4c497cf9856061077696a21e060395
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.1 MB (217137147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29cf1d10dc09b90d6fd82193703ca780374a11389ac012c0d7da9f11f7ce07c4`
...
-	Layers:
	...
	-	`sha256:8447bcc57bc912e3247919e096413c50d98f4311c080392376086ca3f52ca42b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:645182ee3d9e3255a5d433e661e530499dee497afc4f16277d61b4ac000035f8`  
		Last Modified: Wed, 15 Feb 2023 01:19:40 GMT  
		Size: 22.6 MB (22578023 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2035a210545d0b189c9642a4cd57bdaf7d7ab75ae20858ba852a05315da24a25`  
		Last Modified: Wed, 15 Feb 2023 01:19:36 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97c6208e32813b5c7cbc9227433e220de896fc30313cd87c5983d2f9ecf65be2`  
		Last Modified: Wed, 15 Feb 2023 01:19:36 GMT  
...
```console
$ docker pull wordpress@sha256:82fd06ae7d02dc4bd758916cd4bd1ef234998a435eac1c4cc413e12ac8812853
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.4 MB (208398834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5631d0b2ff30fef2ed53492810641daf9b22291194cf015e3a0d07aba7147ef0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e6b274ceef4104d7c5c625e28f3664ac4e0f11a1c5f8e0d37f660d52fa0b45f0`  
		...
		Size: 19.5 KB (19496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e7aeaa3d84739c6a46c178f36f4487011b41ffdb031a95ceb23e2b483655720`  
		Last Modified: Wed, 15 Feb 2023 02:03:25 GMT  
		Size: 22.6 MB (22578024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d06a51b997a526d084fbe4d47532d064c3cc6324f97af048820fb874bce281d`  
		Last Modified: Wed, 15 Feb 2023 02:03:22 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0492a29d33cd0e4c9f6b20acfd2d7300abda0f0efc43ff289f34e4118b68467a`  
		Last Modified: Wed, 15 Feb 2023 02:03:22 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:19cb73a2a7fe96d08dd2faccf8f4dc4b4d5d015ae395789ebb55a6559cf9e1ef
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.9 MB (217873799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d68d3b1a407cd2663b80076421aa88810b6a280f9ff98678878c6b0f0c8e84de`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 15 Feb 2023 03:31:42 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Feb 2023 03:34:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libicu-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 15 Feb 2023 03:34:51 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 03:34:52 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 15 Feb 2023 03:34:53 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 15 Feb 2023 03:34:59 GMT
RUN set -eux; 	version='6.1.1'; 	sha1='80f0f829645dec07c68bcfe0a0a1e1d563992fcb'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 15 Feb 2023 03:35:01 GMT
VOLUME [/var/www/html]
# Wed, 15 Feb 2023 03:35:01 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 15 Feb 2023 03:35:02 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 15 Feb 2023 03:35:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 15 Feb 2023 03:35:02 GMT
...
-	Layers:
	...
	-	`sha256:1435d3d2c036c3598a80c124483b5e0177ce1f7800e51e38a08c92be87e4a542`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1b0ea9313c36221bce72d40b8094c024824e7997a8a5194b65a9dcbdb9ad067`  
		Last Modified: Wed, 15 Feb 2023 04:15:11 GMT  
		Size: 19.8 MB (19822712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf7ae5c17e0730b7bd96be3ca523c1f6b30af743acfd3565bd8531d2c4485f86`  
		Last Modified: Wed, 15 Feb 2023 04:15:08 GMT  
		Size: 10.8 MB (10774411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:331acbf8879d9d2b28cd879fd61388f9bbc6cf62577c2c66e95eed0b1043c494`  
		Last Modified: Wed, 15 Feb 2023 04:15:06 GMT  
		Size: 361.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e8a1187c0baa01166386c5d33d57b34b364a67ad47b4f833d61142b95e5049`  
		Last Modified: Wed, 15 Feb 2023 04:15:03 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b304a57b20149fb94e11fbfcee183d9d6b52ecc988519ae636ad983e5d8195d8`  
		Last Modified: Wed, 15 Feb 2023 04:15:03 GMT  
		Size: 19.5 KB (19502 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c27140ba8dda6d8ff25998e80c914066055eae51c051fec27a07b6bbb4970205`  
		Last Modified: Wed, 15 Feb 2023 04:15:08 GMT  
		Size: 22.6 MB (22578023 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4625264a15635b701036ca664d4eb40989a8c3c1358e5e46df06aded719d9114`  
		Last Modified: Wed, 15 Feb 2023 04:15:03 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37ffc40d76c3f3188379f095117d6cd2a0f75973f338b519048130fd6cc27d69`  
		Last Modified: Wed, 15 Feb 2023 04:15:03 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
