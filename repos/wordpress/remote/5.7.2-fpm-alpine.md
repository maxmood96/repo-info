...
```console
$ docker pull wordpress@sha256:d60d285798eff8b90d5348f3a6b504b96ff1b46aae075a45b8ed5802326a27a5
```
...
```console
$ docker pull wordpress@sha256:440e744954d1c2f520d76c51061c78493f7c8ab8d97f98813831de3b733ecb7e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.9 MB (80946217 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36ce4f3e8d81e3b0d7b5e15bab3ccdb81f4328c8d51207c72b2f74ef1083a893`
...
# Thu, 13 May 2021 19:14:30 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 23:45:07 GMT
...
-	Layers:
	...
	-	`sha256:2a8637c90f73db5fddff70142cc9d38b0596bf88dfd2c97e2e417b84e201a205`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51a27532fdb35f7c4b146b5f9cbfdf3bf66dabd6925dff0d32cf75692377ad93`  
		Last Modified: Fri, 07 May 2021 01:52:50 GMT  
		Size: 35.0 MB (34992040 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b117e793a29cd503ac25e7044208f01fc7e5ec2ce418d79c34b8e5dd0e098ac`  
		Last Modified: Fri, 07 May 2021 01:52:44 GMT  
		Size: 1.1 MB (1068655 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4b15c761ed7a1a1b66e44a3f27a1eb046edda8144eef68f6f78207a862055b1`  
		Last Modified: Fri, 07 May 2021 01:52:41 GMT  
		Size: 63.4 KB (63405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:553437590a5d00fa444cf10c148712ebd9574d05b8a530143e80e12f83c9e46d`  
		Last Modified: Fri, 07 May 2021 01:52:41 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73d852f65d2dc8e4cad39be2ef6c82544ba234cfb064c57028ce3bdd7e762e5b`  
		Last Modified: Thu, 13 May 2021 19:18:26 GMT  
		Size: 15.6 MB (15589101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d95ac3969e45fc30b4e8801ec13da4c91aea117c25245e79812f881c7edb7d5f`  
		Last Modified: Wed, 19 May 2021 23:48:44 GMT  
		Size: 2.4 KB (2364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ecc12b1363ab6b4a45a921246c28bb2d08b187e2a73d7d11dee19e3868f3b12`  
		Last Modified: Wed, 19 May 2021 23:48:44 GMT  
...
```console
$ docker pull wordpress@sha256:ef56def30c828992356d4bfb2b8be92b2ddd55f28e621e2f95dc60fb7522acbd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.4 MB (77432233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fcf1b133ccb68e49d297b4e51b1706060386bb07a07ad868451f9aa489f6319`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 19:02:35 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 19:02:37 GMT
VOLUME [/var/www/html]
# Thu, 13 May 2021 19:02:38 GMT
COPY --chown=www-data:www-datafile:4bf3e33874fc7286d57546f67c8371a0c4b9a02171c1d835cc588fc3cee4aa07 in /usr/src/wordpress/ 
# Thu, 13 May 2021 19:02:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 May 2021 19:02:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 May 2021 19:02:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6ae8b529dd1037756f8054241045ee3272fc78f3fcd9e7a5991412a6fe50dbcd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99afdecd34920b20665d8221f053c6b8fe11998d9e360f5ad145645324c188bc`  
		Last Modified: Thu, 13 May 2021 19:04:28 GMT  
		Size: 15.6 MB (15589102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbc48dc7a692025271986fcd631cbc2e38673f84ec32f9e0bd0035a7989620e1`  
		Last Modified: Thu, 13 May 2021 19:04:22 GMT  
		Size: 2.3 KB (2333 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8f75d39f1e6adac972487d13226710bd477438be3801eed5ff1ceb0779f5c20`  
		Last Modified: Thu, 13 May 2021 19:04:23 GMT  
...
```console
$ docker pull wordpress@sha256:c1b127303e18867c65f95a4733ee9791c829e596e6d572c4c0f957a160e20fe6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.6 MB (74561302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33d3bce5b4457ff8358aa1df5e10a2df16143f904082eb97a3cb86bf5d199b7f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 07 May 2021 01:38:56 GMT
RUN set -eux; 	apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick 	;
# Fri, 07 May 2021 01:40:04 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 07 May 2021 01:40:07 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 May 2021 01:40:09 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 19:09:36 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 19:09:38 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 22:17:53 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 22:17:54 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 22:17:55 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:ae1bfa065004bd823bdad3b1cdb4372178b438fa695b20818a9fe8059d9404a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c541d1a5b725ec74775fe75b8952257051b7c5932082a81a21a1f8dc5bb1810`  
		Last Modified: Fri, 07 May 2021 01:45:18 GMT  
		Size: 31.1 MB (31084121 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb462077d6cfe87a7abfaca90ecb82395e5a026c657aa642742b5afd8a1dcc9a`  
		Last Modified: Fri, 07 May 2021 01:45:09 GMT  
		Size: 972.3 KB (972339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:965283e41da7ed7c3dfddfa18fb0d8307cfa978ae295ba865f62e495492d2649`  
		Last Modified: Fri, 07 May 2021 01:45:07 GMT  
		Size: 63.5 KB (63526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cda0f51ed11678091b0fa43b8fd7478f4e3f60ec26e410207a291dc578a351a9`  
		Last Modified: Fri, 07 May 2021 01:45:07 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a6363e6429a8771cdab542f0854f02762652be215234abae5cca45517e71f02`  
		Last Modified: Thu, 13 May 2021 19:14:15 GMT  
		Size: 15.6 MB (15589102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25ef2f4df5984a439ebbd83043eff0ecf899e80d78d0c4da999e666431c550eb`  
		Last Modified: Wed, 19 May 2021 22:22:22 GMT  
		Size: 2.4 KB (2368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a92b6dd0c3f072567b158472395f6f7cb5ab8cc96b5c1a07e3f118f06edba62c`  
		Last Modified: Wed, 19 May 2021 22:22:22 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:5e33351924e31513867641b2abcec789914fffb850d3c40c9bfac56193e5c2db
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **79.2 MB (79200090 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cde1f27843752328c7c82fce786bdc2769aaae7e672cb8a762d7762a34f98aa3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 20:51:08 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 20:51:10 GMT
VOLUME [/var/www/html]
# Thu, 13 May 2021 20:51:11 GMT
COPY --chown=www-data:www-datafile:4bf3e33874fc7286d57546f67c8371a0c4b9a02171c1d835cc588fc3cee4aa07 in /usr/src/wordpress/ 
# Thu, 13 May 2021 20:51:13 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 May 2021 20:51:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 May 2021 20:51:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:578736e56c2cadbcb7a1127dc7469fd0c47a13cd1d14ad51eb7b7c8ace53b7f1`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38b5491e6dd10ddf1212951192b61b15955d96ffc5d5f16962c85f72e0a11626`  
		Last Modified: Thu, 13 May 2021 20:55:43 GMT  
		Size: 15.6 MB (15589096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:349b6c294c4b59f0a3c29143055a70390e459c6b9b3542a973190cdf55faf29e`  
		Last Modified: Thu, 13 May 2021 20:55:38 GMT  
		Size: 2.3 KB (2334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed26c782e660eeb95e978f5ad785e8290acef0cb7954c95448c2714df75fa1ab`  
		Last Modified: Thu, 13 May 2021 20:55:38 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:f245820f2cf7b45553f00614c4e6cec8e269688a10f6fb6dcbde118ae4ed1df1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.7 MB (81699753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d87aeb83216fa39fba82374b3295c06f9fbed421771f9f7680a903e67dbbabc3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 May 2021 21:18:52 GMT
CMD ["php-fpm"]
# Fri, 07 May 2021 01:30:53 GMT
RUN set -eux; 	apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick 	;
# Fri, 07 May 2021 01:31:42 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 07 May 2021 01:31:44 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 May 2021 01:31:45 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 18:42:14 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 18:42:14 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 21:07:20 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 21:07:21 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 21:07:21 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 21:07:21 GMT
...
-	Layers:
	...
	-	`sha256:6e79afa7deb1971c1f91a7f111a8c87c6f138f6055654992487da70e86e2465c`  
		...
		Size: 8.4 KB (8444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c866d8758aa22bfd5f0c2bbc5c4aa8f3e05e3f865f3c16630625d7ca0348e996`  
		Last Modified: Fri, 07 May 2021 01:39:15 GMT  
		Size: 35.3 MB (35260322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33142f980cc8521105ef95702c611345248d7e8ec32b053835c55ea48937e838`  
		Last Modified: Fri, 07 May 2021 01:39:07 GMT  
		Size: 1.1 MB (1067154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:469cd2f79c982ac073d637000635d51be366e3929892dda3dd2f6ec5cbd0515d`  
		Last Modified: Fri, 07 May 2021 01:39:04 GMT  
		Size: 63.4 KB (63390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77ce112f290b1444b25a5a89dc241caac1eed11d350cf1c13b5c38f4b0ae308e`  
		Last Modified: Fri, 07 May 2021 01:39:04 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96089a0070f81a2e374e2c5a4c5dbfb8c0ce5c6d64aeef55b66c44e6bb2c9dc7`  
		Last Modified: Thu, 13 May 2021 18:49:05 GMT  
		Size: 15.6 MB (15589084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c0b1df251392256f2fe8830908e022f5cf89c7dd34d495fca5a8bacce09ff41`  
		Last Modified: Wed, 19 May 2021 21:13:40 GMT  
		Size: 2.4 KB (2365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eede12a3276f7b38219aaba0edcafe174efb6cb03744d5187fb1f539f6476c87`  
		Last Modified: Wed, 19 May 2021 21:13:40 GMT  
...
```console
$ docker pull wordpress@sha256:49feafabac11764726c874cc64763e7ca6f79c825329a74f7ecad7f46550afdb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **82.3 MB (82324899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b539d777a77ac8366ad3a5fe106c972025349c34bee5fccc83cbb7e28697160b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 07 May 2021 07:27:12 GMT
RUN set -eux; 	apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick 	;
# Fri, 07 May 2021 07:28:51 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 07 May 2021 07:29:16 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 May 2021 07:29:53 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 21:32:06 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 21:32:15 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 22:47:02 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 22:47:03 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 22:47:10 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 22:47:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a031148851f0f2eb48d2d7a895aab2358912820f554dcc44b7503f8d094f7aa7`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f76210d38f1e92366c606ee871f4bb78a647c807746a623c9c6d4061e00f4a99`  
		Last Modified: Fri, 07 May 2021 07:41:15 GMT  
		Size: 35.3 MB (35251549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd7f14246dbe68bf799600b1d5f15e5cda93aafcbc1d7b2162932539bcda96d5`  
		Last Modified: Fri, 07 May 2021 07:41:06 GMT  
		Size: 1.1 MB (1104146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18b0b72d97b076159eee589ac7c9d8a1bf697156f54aabc2e72bea2c444b1981`  
		Last Modified: Fri, 07 May 2021 07:41:03 GMT  
		Size: 63.5 KB (63467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e42ab523049e8922cc29dbdd34994a39d13e5cf7a84cd2358263a5168d600c2`  
		Last Modified: Fri, 07 May 2021 07:41:02 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8967824b8cd1c54c0b937f30d48f515041b117a4738f2eba4df7dd0966e7d067`  
		Last Modified: Thu, 13 May 2021 21:42:06 GMT  
		Size: 15.6 MB (15589096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e2f270994b1f704e4e742f8a00b4b0e6f2f03567cfef1cc0d6fe90f4da5720e`  
		Last Modified: Wed, 19 May 2021 22:59:01 GMT  
		Size: 2.4 KB (2365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c00a7cd89a1541136c19749fdfc1e981741436627ca8c150196f849c724f74ca`  
		Last Modified: Wed, 19 May 2021 22:59:01 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:5fd17c2f1b3bb3972ff248bb433d7f1f85cfe48d12f72889f026f38b8ab238fe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.3 MB (71322365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ba5a850dc4defee57db42138fd69b05695992e71625ff966432af3742793bb3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 07 May 2021 01:46:12 GMT
RUN set -eux; 	apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick 	;
# Fri, 07 May 2021 01:47:58 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 07 May 2021 01:48:00 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 May 2021 01:48:03 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 May 2021 19:04:26 GMT
RUN set -eux; 	version='5.7.2'; 	sha1='c97c037d942e974eb8524213a505268033aff6c8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 May 2021 19:04:28 GMT
VOLUME [/var/www/html]
# Wed, 19 May 2021 23:32:31 GMT
COPY --chown=www-data:www-datafile:7cb64bfb1cb4a39163cb87790960d0113a2145a8bfbeef0119d5151706ddaed8 in /usr/src/wordpress/ 
# Wed, 19 May 2021 23:32:32 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 19 May 2021 23:32:32 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 May 2021 23:32:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0d9b73bac8c38b5b1e4dcd5a7ecaab78236c4731cc1e6bef7b9c520b7998e264`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82d6a9942877d30e0d0c15c73b3cd77349f9f6d9fafca90ccdc0a4b33f63fa1f`  
		Last Modified: Fri, 07 May 2021 01:53:57 GMT  
		Size: 26.2 MB (26185000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3796680ca3ea9856e58b38b1e5688db82c1d4cff4bce77288830b34d4ae277c9`  
		Last Modified: Fri, 07 May 2021 01:53:53 GMT  
		Size: 1.0 MB (1049490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30882a88bec2163924ead8784002283143ddca44697f7a0d81710776a30fcee2`  
		Last Modified: Fri, 07 May 2021 01:53:51 GMT  
		Size: 57.1 KB (57088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea9be29a5c9d2c42efedfa244a0932c73f845a7d4973ef765898781e5e64e442`  
		Last Modified: Fri, 07 May 2021 01:53:51 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3175ce5575abac24449ebaab35606a8cd07561917da14d6c04104828bfbca000`  
		Last Modified: Thu, 13 May 2021 19:08:37 GMT  
		Size: 15.6 MB (15589103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80369770c90af7f34216d2130ec0827b2dce660a7d831cc2d60206b9ae6cfbed`  
		Last Modified: Wed, 19 May 2021 23:36:36 GMT  
		Size: 2.4 KB (2366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b59311846042320fa77586bf2f806af875c97896f859d543a9931db0708bfe62`  
		Last Modified: Wed, 19 May 2021 23:36:36 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
