...
```console
$ docker pull wordpress@sha256:56aeb8d4c58a850fe88a997647ab6a03435b04c1118c756916bc34415566cb29
```
...
### `wordpress:6.5.3-php8.3-fpm` - linux; amd64
...
### `wordpress:6.5.3-php8.3-fpm` - unknown; unknown
...
### `wordpress:6.5.3-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:6.5.3-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:6.5.3-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:6.5.3-php8.3-fpm` - linux; 386
...
### `wordpress:6.5.3-php8.3-fpm` - linux; ppc64le
...
### `wordpress:6.5.3-php8.3-fpm` - linux; s390x
