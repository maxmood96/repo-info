...
```console
$ docker pull wordpress@sha256:6816981617735165701d278edd76adc4f5b1c9ee5326678ffd12095981907292
```
...
### `wordpress:6.5.2-php8.1-fpm` - linux; mips64le
...
### `wordpress:6.5.2-php8.1-fpm` - linux; s390x
