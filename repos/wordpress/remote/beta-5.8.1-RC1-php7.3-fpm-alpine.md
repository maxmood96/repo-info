## `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine`

```console
$ docker pull wordpress@sha256:65bc4991f6a849277aa2c37a4ba26349550d7ac01f82c0de6ded9262fa57be9c
```
...
### `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.8.1-RC1-php7.3-fpm-alpine` - linux; s390x
