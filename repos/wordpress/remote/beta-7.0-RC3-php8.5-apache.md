...
```console
$ docker pull wordpress@sha256:14f1158600d4752e3ece5698fb996be126c7f98a25ba8365a084065543f48783
```
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - unknown; unknown
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.5-apache` - linux; s390x
