...
### `wordpress:6.8.3-php8.5-apache` - linux; arm64 variant v8
...
### `wordpress:6.8.3-php8.5-apache` - linux; ppc64le
...
### `wordpress:6.8.3-php8.5-apache` - linux; riscv64
...
### `wordpress:6.8.3-php8.5-apache` - linux; s390x
