...
```console
$ docker pull wordpress@sha256:13f900d83e92fb8966aad25797f1533ec6fa6fbe1ef7bf4c098537383e45e72a
```
...
```console
$ docker pull wordpress@sha256:65b1d142e7a20e2dc280d7e41f9a56d5ec8016d90a6f25c708f90bf6372436f6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **214.4 MB (214449280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d23ac36c1ddf115a233a657dee0e2d4b14b401a4ea9e3e5fcdc55bbdf75265f1`
...
-	Layers:
	...
	-	`sha256:3587093fa6da1514fb9f7dad084865b4cc3ad0e9bd20f9645035760047acd754`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97a9beed63592aa41e0adb99958a5ba6d16e889baeab78863ccef0ca779f68be`  
		Last Modified: Tue, 15 Nov 2022 04:03:20 GMT  
		Size: 22.6 MB (22577944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fecc5ae212a77ab458248ae65800ffbdabec73f1ce9526d3105326c6fe69b8c`  
		Last Modified: Tue, 15 Nov 2022 04:03:17 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00759c6e06e42b9a0c358a0750ca1df6db9b30f393a8e1e641794ce89d91f8b4`  
		Last Modified: Tue, 15 Nov 2022 04:03:17 GMT  
...
```console
$ docker pull wordpress@sha256:8c485c96f362c2f2e057a5f95a15fb82c4dd40582124ae26831bdacad8b5722a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190463680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:698fcf16991fd5f342898ea2c794067f0a65c839aec9d673a0ef10d9fcdb0016`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 15 Nov 2022 05:22:47 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 15 Nov 2022 05:24:43 GMT
RUN set -eux; 	version='6.1.1-RC1'; 	sha1='12f4e8c6685f79e5ecc418949cfca48934dc3c78'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 15 Nov 2022 05:24:44 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 05:24:44 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 15 Nov 2022 05:24:44 GMT
...
-	Layers:
	...
	-	`sha256:e9b0576324623a5c57058dfa258f754cb9439fb518e6e437c1ead771fd3ba590`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6986443a64c36f0625a958599fedb7df7865976bc674ec9313a4a0cfce40f287`  
		Last Modified: Tue, 15 Nov 2022 05:37:58 GMT  
		Size: 22.6 MB (22577849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a85c7749709ecd7e2fea574fc3b86632f2b9731ce48e245e66bc0f30befcb650`  
		Last Modified: Tue, 15 Nov 2022 05:37:54 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b84472dabed8d70ea25c85a3498449bcc55c39e1ebc6dfb666f8b5d1fdd8c4`  
		Last Modified: Tue, 15 Nov 2022 05:37:54 GMT  
...
```console
$ docker pull wordpress@sha256:2633b6d564f4a91b070a52da3e48a28d8a35b4abd3763dbea8f63187f45d4345
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.5 MB (181542207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67dab45aa8d9a3fc3b49f05ba31dd573a3b49b976e156396533fa71c398ee725`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:71d7983742198f46dace1252d8fe9472aae318145fb57dcbfc054284b60bf2cc`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:534ac7b46af7550b9d8c9d1f9c53b100fb28714e63276adab14775cbe1cd6490`  
		Last Modified: Tue, 15 Nov 2022 03:41:37 GMT  
		Size: 22.6 MB (22577865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e5799d67cc022a03e88167026f4aac9e7de9430c77bdce24aa645225ee04a5c`  
		Last Modified: Tue, 15 Nov 2022 03:41:32 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:786bd52c80523c3f091a801cbff312c5b3d12e1a97e4f7865e83bca08759fe44`  
		Last Modified: Tue, 15 Nov 2022 03:41:32 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:69825c4eb15c174be640ddf7c4056ecba2f7a87d2ee3988461d9f03aec508edd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.7 MB (215698969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:514b5bc1ccc9a08e5e5bb6bbf2b130dde655f10c76d2d900894118679e547837`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 02 Nov 2022 01:00:48 GMT
VOLUME [/var/www/html]
# Wed, 02 Nov 2022 01:00:49 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 02 Nov 2022 01:00:50 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 02 Nov 2022 01:00:50 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Nov 2022 01:00:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dbb473dad7df182b8420f156b57073f3e94b9b3a3a0bbe9dcf7d3a00255548c6`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b646a019720f4c25e88f9e5b15c621b164cf093289e84d79749cc5249f6aa121`  
		Last Modified: Wed, 02 Nov 2022 01:11:32 GMT  
		Size: 22.6 MB (22577738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3cbb67b1140896c7bd00d6d567af85c58bf20410238b6a1959b9d4e97fced9a`  
		Last Modified: Wed, 02 Nov 2022 01:11:29 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a45706739c583517c18ab34542dafd490c9bf1c0c53367768b2a0179b793b04`  
		Last Modified: Wed, 02 Nov 2022 01:11:29 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:3216528f2abb271ff3846baba8f09796da54a02cbf06805e1ab1caa5560f5af1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189113151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95d71718765386ac334251ac94f8988c705f819ff9a67e2c7b9631d36d69d4e3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 15 Nov 2022 04:04:00 GMT
RUN set -eux; 	version='6.1.1-RC1'; 	sha1='12f4e8c6685f79e5ecc418949cfca48934dc3c78'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 15 Nov 2022 04:04:04 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 04:04:08 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 15 Nov 2022 04:04:12 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 15 Nov 2022 04:04:16 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 15 Nov 2022 04:04:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8a98d55cd6af7a2d8233d19209a82148cf0730f96cbcba414a654ece178d6d87`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fcf618fb00502873b18118da849383e0adb4e01a8f2befddd1e70632705f8fb`  
		Last Modified: Tue, 15 Nov 2022 04:10:37 GMT  
		Size: 22.6 MB (22579899 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4833df3db7ccf169b57dcabb5d0f636ca775c4f4321b1719b009e1a5004c4cc`  
		Last Modified: Tue, 15 Nov 2022 04:10:23 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54a1f3fd570b39866c51c381910fbd2132a1a6ad385d3d8eba595cfa4cb1409d`  
		Last Modified: Tue, 15 Nov 2022 04:10:23 GMT  
...
```console
$ docker pull wordpress@sha256:ca9bd32008c945bbdb5adf1523e7bc0f5767aeb2dbd9a473892d701287b76293
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **214.6 MB (214644513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4e624632a3e5c08ebfd8de3bd25c211ef0f99e9d0dbfb9503c97c54a44244b7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 15 Nov 2022 04:01:27 GMT
RUN set -eux; 	version='6.1.1-RC1'; 	sha1='12f4e8c6685f79e5ecc418949cfca48934dc3c78'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 15 Nov 2022 04:01:28 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 04:01:29 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 15 Nov 2022 04:01:29 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 15 Nov 2022 04:01:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 15 Nov 2022 04:01:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0b922a71b7ba2670174e326abee4d5554deefe2d2ed7f72413767c905c4de569`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5db6a89e734c73b27edbf7a1fe29c117f6462350623d5290b6eacada3e01f54e`  
		Last Modified: Tue, 15 Nov 2022 04:14:03 GMT  
		Size: 22.6 MB (22577944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:029347320f9716d0d6327c2ed07406ad4a14622d0fabb58c58997f9aacd3daba`  
		Last Modified: Tue, 15 Nov 2022 04:13:57 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71f193ee47530962bcf7f5988790017fd1cf89259c229d82b339b62777e8a918`  
		Last Modified: Tue, 15 Nov 2022 04:13:57 GMT  
