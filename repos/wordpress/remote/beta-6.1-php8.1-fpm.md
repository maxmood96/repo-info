...
```console
$ docker pull wordpress@sha256:310774f80e65e4ee67ece393b9091ba2d2a5cccfb385f3ba2ff9272200478216
```
...
```console
$ docker pull wordpress@sha256:03913e0e4f4845f3605f0cce7facd585b3331bab14f47dc5921489b8ca2e521d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.3 MB (215276162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1f4e615e6d9dfc4d14742a5c8e7b9cddfc1aa6b19fd51805354203b90c79b45`
...
-	Layers:
	...
	-	`sha256:84e51df440265dbb821501d2e5a9e1f947ac3d0e2b61a18db93937e6ca2048bc`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:623e19c667768451f1ba1bd8aa70cf4b33bd6aa1fac34b6baa595d33017653a0`  
		Last Modified: Thu, 29 Sep 2022 20:58:44 GMT  
		Size: 23.4 MB (23378902 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2759958a5ee924904dd5198708657220c057eba06a44e529bb034ef4d5f35d44`  
		Last Modified: Thu, 29 Sep 2022 20:58:42 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc2bc895b8d4cbcdd899f5449093b2aaa2deb407cdde35def5ea3b3870482683`  
		Last Modified: Thu, 29 Sep 2022 20:58:41 GMT  
...
```console
$ docker pull wordpress@sha256:ad107cdd1ae781ae53444417f3f8c555a3c046c35e8b1612dd339a9fb69c7898
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191300646 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c62a0e59fbd30d153941c2d07f7196b6d5f7c1803f78fce734a43d020b19719`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 21:04:03 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 21:05:46 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 21:05:47 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 21:05:47 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 21:05:47 GMT
...
-	Layers:
	...
	-	`sha256:3740d968284dba47531f5d8462de29509453fa1f3ef9661efbdbae1acbc3a15f`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22363726367909cbb569c465d58566e728a828bb80ad4d82f0a1599370c8735c`  
		Last Modified: Thu, 29 Sep 2022 21:15:00 GMT  
		Size: 23.4 MB (23378914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a265f24e9803a2f94bb89b59494c6d763179c289d173373dc099d551a1451425`  
		Last Modified: Thu, 29 Sep 2022 21:14:51 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e123084d9bc7c105a1f96bc5851dd6676cf56934ec68fe4ca8197406a870ea9a`  
		Last Modified: Thu, 29 Sep 2022 21:14:52 GMT  
...
```console
$ docker pull wordpress@sha256:839022dbf1f6d9735c7543cdf81e9c6ba76dd285b254333ce98af0779f761616
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182316222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f37541dac3fc138951f2e1f75221d424f5e28f1aa2916fd749fc5063d116200b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:63a8bec5cd4e65de5fad95c19fece2ba09aecf4abaf6a7bb1101aa38faafece2`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:869f753fb7e6b633d795ce9fd1928355e191b25d05b59fd21d658a155405f202`  
		Last Modified: Wed, 28 Sep 2022 02:30:21 GMT  
		Size: 23.4 MB (23378908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:027204e4eda694b05df60445637da4bc7bd0d21d5d8bc69748593a2afe3f95f6`  
		Last Modified: Wed, 28 Sep 2022 02:30:15 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f75641e4e71c3a66ef477d1531fd49c65989a6a6c72f99621c42142eaa23f8be`  
		Last Modified: Wed, 28 Sep 2022 02:30:15 GMT  
...
```console
$ docker pull wordpress@sha256:af8ec974f3210a275a44e6794a3c16a8db861efaa9b638ae2c272e68537b21f3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.5 MB (206504130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4091f45f59db20fe79c1e4bf52c1b13716935494656cd4df85926cc32a560a3d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 22:54:33 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 22:54:34 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 22:54:35 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 22:54:36 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:54:36 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 22:54:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:06c1faa83c74032869f315d7189a4d41984eb65340fed3380b06164c96bee635`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3ad4f00bdccb8becef123084bcc269ff08f9b63a665ebbb077d0f0c613d66ee`  
		Last Modified: Thu, 29 Sep 2022 23:02:46 GMT  
		Size: 23.4 MB (23379267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:844f7b7227f2d894cf3f03654f8be4f08f5bdac16e00fa94a112fe8e594ad6c3`  
		Last Modified: Thu, 29 Sep 2022 23:02:42 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e02644af5b18379184fe131b87b719dfbf44af93a0d75ade9f0da83f226eea00`  
		Last Modified: Thu, 29 Sep 2022 23:02:42 GMT  
...
```console
$ docker pull wordpress@sha256:cfa81e19bcff80d243f1380f94497e353d53f27d89276ae5f22a61b756b82987
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.7 MB (216737631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6dc7ef26f14f69f10dfdec0a341a132aaec0b974e03a796b2942f9314878a60`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 22:06:04 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 22:06:05 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 22:06:06 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 22:06:07 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:06:07 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:3d359ccce70dba5b7d241a17eef334dce3ff597d26064aca7de2d0bb29a48e86`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ec7c15f00082258e4681240ce209450d34c4e1c88d4a50569baa8183abff40e`  
		Last Modified: Thu, 29 Sep 2022 22:14:56 GMT  
		Size: 23.4 MB (23379261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb0eaeff1399adedd406cd0f91b53f9cf19cea4e061860f175bf18d19bf87839`  
		Last Modified: Thu, 29 Sep 2022 22:14:52 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4982ea12d88fbe9ee8661511b253e3b95f054e2fb6e01f92eff23c9ff3de746`  
		Last Modified: Thu, 29 Sep 2022 22:14:52 GMT  
...
```console
$ docker pull wordpress@sha256:9e331fe8581dd8cf2fe569c0d99d798d97a9ac1340a18610c86c8e34939e5e08
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.2 MB (190151981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fbe3148055513fef0d6b4ba093a3b53cdcb69c93de44d8d6c6d4a78153b7e2b8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 21:27:39 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 21:27:44 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 21:27:48 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 21:27:52 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 21:27:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 21:28:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d697dea9854d149ff0df821433c2aad45428cb4fb8ac69ec206e282dbf616812`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9316e82a09292f331c38b021070315e1251e536d0475d650a95da5bf018cce8`  
		Last Modified: Thu, 29 Sep 2022 21:31:58 GMT  
		Size: 23.4 MB (23379257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92b947a572696a6b6c54eb7478ca12bf87ee865df4ec9b46c0e31ea9f3682f07`  
		Last Modified: Thu, 29 Sep 2022 21:31:44 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb0b37e650842a77130878749e7bb96adc75ddefe88ceae3311b505aa86d15f8`  
		Last Modified: Thu, 29 Sep 2022 21:31:44 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:852ccf387930d91c97ae416d096325984129b42de4215d71975f65e1fcdba689
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.5 MB (215475507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ca465786ddaf9b364eed3b9274e5327189fbf04a24396fb00ec4bbd53759aac`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Sep 2022 04:34:51 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Sep 2022 04:34:52 GMT
VOLUME [/var/www/html]
# Fri, 30 Sep 2022 04:34:52 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 30 Sep 2022 04:34:53 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 30 Sep 2022 04:34:53 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Sep 2022 04:34:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:aab530372294b4b129e35eacdcd5cb713b9dd973045370824d084583235a04df`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd7a225eba04076c857d4f50e0ac481487b49d08ccbced4280e11856ff68f796`  
		Last Modified: Fri, 30 Sep 2022 04:44:33 GMT  
		Size: 23.4 MB (23378901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:830c5024dc0ad1f04a83a102a0adcbb654063562b22489d5ffe8946083e116b2`  
		Last Modified: Fri, 30 Sep 2022 04:44:28 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8aaf5847ac6552dbe99e3f9ec2c0ebfde628556143356b9a41edcb337838d125`  
		Last Modified: Fri, 30 Sep 2022 04:44:28 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d9ff5cfe83687aef279071cdb00352178731007aa4d19f40be261f9415405bb3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190465386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a4f74b9e0f737e5bbd645c2f8ab62b66a574d95429c666618e1066512317bc4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 21:12:05 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 21:15:52 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 21:15:54 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 21:15:54 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 21:15:54 GMT
...
-	Layers:
	...
	-	`sha256:1879cfc315ea7ef2d9410663ab57c23b4a3621239e9608ccddbe3568400f01f2`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aee8297d8df88ec080538b2ccebcce1b1dc40fa6df267a62a5e47895963fbc66`  
		Last Modified: Thu, 29 Sep 2022 21:23:25 GMT  
		Size: 23.4 MB (23378899 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92baef471bd937164ae269ab90e091144f86b8a21b05b60262aad491476bfd2a`  
		Last Modified: Thu, 29 Sep 2022 21:23:22 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bf5fe18ea96b5fd03072a8484a64436f87596ed9431f8156460c740932e6509`  
		Last Modified: Thu, 29 Sep 2022 21:23:22 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
