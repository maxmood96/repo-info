...
```console
$ docker pull wordpress@sha256:ee01d64fc944d95903eda316cb74ce26b01dc1dab95a7d9865d77e45ab428857
```
...
```console
$ docker pull wordpress@sha256:314e7c864f3e62b330549d53c4a3a2e1912462e450f5b53061f3f3aa06304cef
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.3 MB (215297658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38a20708f1dc6e88eb4b839ea2b0f8bca22499f38925fca5305929dc4f0b7572`
...
-	Layers:
	...
	-	`sha256:8c534d7c65c35d8f889a09171fa45627bbeede682740477380a11bf0cf02a4bd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bd5de9709de5d24ff4d43380154ef8c2d582edc5af9f199afc956c47e8f6df7`  
		Last Modified: Thu, 06 Oct 2022 02:15:00 GMT  
		Size: 23.4 MB (23384469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9909c033ef307e8251612cb3b697d16777244450052a9f4e451332ef6ee3da08`  
		Last Modified: Thu, 06 Oct 2022 02:14:57 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44385d1d02717af4678105b2d9cf67ba57695b55208166256e3a06b630294e0e`  
		Last Modified: Thu, 06 Oct 2022 02:14:57 GMT  
...
```console
$ docker pull wordpress@sha256:b665a3cc431f8bcdf2139d9ea9a9055541626edc30192e02ef686997858c9069
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191318294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:259c83e498da2abcf675d518f82043f58b211b185fad0cbda6dadbcc212cb73b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:cdec040491ed084078fc2d7821dcb651d846bab9fa4a19e850a77bb7cceb470e`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:892b3fe06b30e0391ab8cdcb8391a1b863b6fef1c7964e50197aa561ecd7d608`  
		Last Modified: Thu, 06 Oct 2022 00:02:04 GMT  
		Size: 23.4 MB (23384477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15538dd366168013c2d8800154efd1c1853529245a04a39a1f83579aedd5dbc6`  
		Last Modified: Thu, 06 Oct 2022 00:01:56 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:120eafc8d8ec1ac4020d8ff2c3b56c135ced5f2edcb467d51721e776cc25c9dd`  
		Last Modified: Thu, 06 Oct 2022 00:01:56 GMT  
...
```console
$ docker pull wordpress@sha256:9bef07594a44f5feb37da5deb0cc337077ad5a47888d9dc767bd179b85dd6c31
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.4 MB (182396089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c413b6adc05c2a2a3218414befd30f3be5a167e7eb71c1d8aeb9c68020e9e6d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Oct 2022 22:16:38 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Oct 2022 22:16:38 GMT
VOLUME [/var/www/html]
# Thu, 06 Oct 2022 22:16:39 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 06 Oct 2022 22:16:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Oct 2022 22:16:39 GMT
...
-	Layers:
	...
	-	`sha256:dab9b564ed410016f1f81365757ffae9a7467612e4af419e065449be48818fd5`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:221f8c7de59e2a32bd2ccd1cac869e27d5f24a48d1f3f03855f4bc776b772745`  
		Last Modified: Thu, 06 Oct 2022 22:37:47 GMT  
		Size: 23.4 MB (23384474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ca9f4afed346019f427f2b9f2edd41b62fc5b6ba9b892ac38ef0c863a631fdd`  
		Last Modified: Thu, 06 Oct 2022 22:37:40 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e6eaf267ba4a8f7cb2dca58c3f9d1f47958011e1729c90b6f0802537a01ca19`  
		Last Modified: Thu, 06 Oct 2022 22:37:40 GMT  
...
```console
$ docker pull wordpress@sha256:b62532ce1a2cd2b4f9ed33ad5b52be1e68d14ed8b4cb14774a62b753bd1bcf7c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.3 MB (206319118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22692dc77dede12a5f47118e851c53c18b87a96e84d30cab51b6a834afd6b225`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Oct 2022 01:19:31 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Oct 2022 01:19:31 GMT
VOLUME [/var/www/html]
# Thu, 06 Oct 2022 01:19:33 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 06 Oct 2022 01:19:34 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Oct 2022 01:19:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Oct 2022 01:19:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9ae134ecc83a94bcfcff77eabedd67124c279ed68ea714074d32a1f74db2b963`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7af79abf9d6574469109d7747d3e27cc08d7691cc65b322ee4b793a831b5cd81`  
		Last Modified: Thu, 06 Oct 2022 01:33:29 GMT  
		Size: 23.4 MB (23388640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8dec181fa4585c9413bc27ccc43fa687f96ec2b3b97f4d537f6d553064d8cd4b`  
		Last Modified: Thu, 06 Oct 2022 01:33:26 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ebdea7f4867958b06660d640aa2ae5350f0ca7655a5930c4059a4a8a63860e9`  
		Last Modified: Thu, 06 Oct 2022 01:33:26 GMT  
...
```console
$ docker pull wordpress@sha256:32f386903892711ca88f939a96538fc5dc388d2b40e6dc1454530d21a48ffddc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.6 MB (216554298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99cb791af0b7337e404623ea447a508de61c0525b00ecbc880b37861c2c18830`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 05 Oct 2022 17:47:41 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Oct 2022 23:47:45 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 05 Oct 2022 23:47:45 GMT
VOLUME [/var/www/html]
# Wed, 05 Oct 2022 23:47:47 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 05 Oct 2022 23:47:48 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 05 Oct 2022 23:47:48 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 05 Oct 2022 23:47:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e4521587d4e06ada45207dcc21a1076ec450c93bd2c8c2ef99f257bf13b04f9d`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ff9ddaf6e2da9e6634ebbe94dc121fa935f84d3cad7dcc5a7cb9fcfced2ff05`  
		Last Modified: Wed, 05 Oct 2022 23:58:21 GMT  
		Size: 23.4 MB (23388655 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adf8378b582d49e944f341bafb3948faf532d928193240bb5a634b93ba879370`  
		Last Modified: Wed, 05 Oct 2022 23:58:17 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc6af869697c93e1749cf5db0476adcb0a96b60ebd0cc8c1a94244e7e4966686`  
		Last Modified: Wed, 05 Oct 2022 23:58:17 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:3f72b69653264b2eae3836b087aea1444974db9e846a11376f7f963dd89a1ab1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.0 MB (189970439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:362df100465f61de27040dc0c7b6a8bd7454a6b508a293a156e028e45f0e1727`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Oct 2022 11:53:58 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Oct 2022 11:54:02 GMT
VOLUME [/var/www/html]
# Thu, 06 Oct 2022 11:54:06 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 06 Oct 2022 11:54:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Oct 2022 11:54:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Oct 2022 11:54:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:66872f9f053720c6bccce87f2a8ef5beb3f8680d6025b642f100ffadd5310a4d`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:190fec68bbea3527bf16ce1f8a8bae6d1988120da97d96598ca2c406813ffb36`  
		Last Modified: Thu, 06 Oct 2022 12:05:27 GMT  
		Size: 23.4 MB (23388641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e10212b01ffa1a5ed59b788e08e1ada990f125262c89e2334e58c37e78e89f3`  
		Last Modified: Thu, 06 Oct 2022 12:05:14 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a561afba529abe5b86250a8f90a526c7c46f1ec77397e0406677c98966075e78`  
		Last Modified: Thu, 06 Oct 2022 12:05:14 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:99f08ec5fa6b91dd5e36ccb1c06f4bc6cbe5c14e082f0ce2ca7ced3b2b7a5dd7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.5 MB (215494645 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:936779829ac2167523d07a441338b77b1f79cc7844e3ee33100d79a1a75b6d44`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Oct 2022 03:22:22 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Oct 2022 03:22:23 GMT
VOLUME [/var/www/html]
# Thu, 06 Oct 2022 03:22:24 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 06 Oct 2022 03:22:24 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Oct 2022 03:22:24 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Oct 2022 03:22:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1dd96afe8756087b178fee9a0241413818f2bc679e0af0d3d3a25b447449f93a`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e8b4241319e77191986d94f1e8d2c45804ff0283997ab12c30345e2f59d8384`  
		Last Modified: Thu, 06 Oct 2022 03:34:06 GMT  
		Size: 23.4 MB (23384478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34ba64eb655022bd27741ec9d84a3b9409e457b97d4cf9f7dcccfa556a85d6e4`  
		Last Modified: Thu, 06 Oct 2022 03:34:00 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75a91a6033c15c83e72c724700f9c0a6fc1416224760f9479c51c29ddb3f11f6`  
		Last Modified: Thu, 06 Oct 2022 03:34:00 GMT  
...
```console
$ docker pull wordpress@sha256:55ae855c1f55076687603d2d6974bfd37200dc05f4ef4b5013d347efeebc4552
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190486186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9bf5f61e616882723487d4452f49c04f71077819ec5b7bb10461848f57a8431`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Oct 2022 00:02:22 GMT
RUN set -eux; 	version='6.1-beta3'; 	sha1='d4c0385a0458cd4db15f6c9db971f597423cc363'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Oct 2022 00:02:25 GMT
VOLUME [/var/www/html]
# Thu, 06 Oct 2022 00:02:25 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 06 Oct 2022 00:02:25 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Oct 2022 00:02:26 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Oct 2022 00:02:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:24793b3e401dbb713be5fc9da1f909f36dd6643818655c2813b7256953c1b961`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5be89bb9f6e8295cb2fec1e650847ba54e2f1f8bd95e841214ed595f4d703d14`  
		Last Modified: Thu, 06 Oct 2022 00:11:45 GMT  
		Size: 23.4 MB (23384476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:984b1e44db3f0987c41692d3764487007cc0e3e4cdfc6edfd3dcb82f5eb1631e`  
		Last Modified: Thu, 06 Oct 2022 00:11:42 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:829c95c59badf805bf4b6b240e068a8dc97b61eb40df30ddb83cc6ce1e94999d`  
		Last Modified: Thu, 06 Oct 2022 00:11:42 GMT  
