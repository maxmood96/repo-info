...
```console
$ docker pull wordpress@sha256:c0a18431975e4402f330b38b3307f39ea214d147704498c65076bb721f0be233
```
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-beta3-php8.3-fpm-alpine` - linux; s390x
