...
### `wordpress:6.6.1-apache` - linux; arm variant v7
...
### `wordpress:6.6.1-apache` - linux; arm64 variant v8
...
### `wordpress:6.6.1-apache` - linux; mips64le
...
### `wordpress:6.6.1-apache` - linux; ppc64le
...
### `wordpress:6.6.1-apache` - linux; s390x
