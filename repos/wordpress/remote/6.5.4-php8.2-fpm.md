...
### `wordpress:6.5.4-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:6.5.4-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:6.5.4-php8.2-fpm` - linux; mips64le
...
### `wordpress:6.5.4-php8.2-fpm` - linux; ppc64le
...
### `wordpress:6.5.4-php8.2-fpm` - linux; s390x
