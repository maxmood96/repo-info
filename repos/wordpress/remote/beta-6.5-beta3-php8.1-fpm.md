...
```console
$ docker pull wordpress@sha256:b7cd8bb1b1896ec60486fa79aecf004c5e2358550f521c5839cb41b70f185c59
```
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - unknown; unknown
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.5-beta3-php8.1-fpm` - linux; s390x
