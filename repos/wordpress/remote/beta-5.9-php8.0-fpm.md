...
```console
$ docker pull wordpress@sha256:7ad64ff3c0eb2cf4e014bfc60c51ba3212d6af9a81ed5d51539e05efb6c4d6a7
```
...
```console
$ docker pull wordpress@sha256:348ce826f8c6336e2cbebfbfcd7ca5e4f88c8754df736c7f90fa40c4f8a83646
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.8 MB (213758293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4477b39983f5a9ea1fa1220e9fdfd4ba07b5ddbc98b964d547924c9ee2ce87d`
...
-	Layers:
	...
	-	`sha256:fb4ace6e7d3abc32eafa30e1373c23e957232285ace7198fb3defec235bc436e`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c40a515d2efbb65c698e6ea2c79649b40c7a2d338a5eadd59e59058c66d25d3a`  
		Last Modified: Wed, 12 Jan 2022 23:35:32 GMT  
		Size: 19.5 MB (19523365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4469d1b7cd9e90817dab08a6daf5c61b03fbd04aa2123038015da2415df92fe`  
		Last Modified: Wed, 12 Jan 2022 23:35:28 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:923c5ce9dfd97626e7194bcb21e989cc7dfe6ec73a6c4f139467d493d446d92f`  
		Last Modified: Wed, 12 Jan 2022 23:35:28 GMT  
...
```console
$ docker pull wordpress@sha256:2f12328ac6a6848de23563611cb8709c95806f61a0de5eebb05613fbebc79bc4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189540769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6aa447c66dea7d1bab62d5120e24e909c2ea41704053150467584948bfb6f49b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:01:12 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:01:13 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:01:13 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:01:14 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:01:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 12 Jan 2022 23:01:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5e57ff76b03c101de8f9767574a06f00d518e45074b7c48691ec5606c4eaca01`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05776628a96d7f45d9f27b61647978cdfbcbffdbf81b2aa4563b511295895433`  
		Last Modified: Wed, 12 Jan 2022 23:18:07 GMT  
		Size: 19.5 MB (19523354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c46a54196b17edc2ec9dc1d6464b206ebfa5d4a32c3f886b85303b8cfb58ff`  
		Last Modified: Wed, 12 Jan 2022 23:17:52 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ff0c123a8f6b5f5971e3b49e3d410ce216d3b1ad81cf28e8f1b2b02c1bf4db4`  
		Last Modified: Wed, 12 Jan 2022 23:17:52 GMT  
...
```console
$ docker pull wordpress@sha256:a106dd290ca8c0d13fa0d01824bde70b7e7133d160d07d841bcd17b6aed373bf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180446780 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2373349cf3b555ed27eb30e07563705877b50046912706ea0b6135b6228a7474`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jan 2022 00:07:16 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 Jan 2022 00:07:17 GMT
VOLUME [/var/www/html]
# Thu, 13 Jan 2022 00:07:17 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 13 Jan 2022 00:07:18 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 Jan 2022 00:07:18 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jan 2022 00:07:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2b29e2cdb786a6dfd216533c6a117abdd8f92e01ebeaa65bd83e88a3af784e2c`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf59452cfaf22d0e082d06b7b238d47de47c3fc6a42c488eb4772ebacc6cc119`  
		Last Modified: Thu, 13 Jan 2022 00:32:09 GMT  
		Size: 19.5 MB (19523365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e0609f3420853b26343c16c8e26245ba4915c2af0e48b0641bbdf0856b77e2`  
		Last Modified: Thu, 13 Jan 2022 00:31:55 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c721cdf82774a9ee16d41dc4341a02f86b564aefa283ab3f3fc98a0969ebf30`  
		Last Modified: Thu, 13 Jan 2022 00:31:54 GMT  
...
```console
$ docker pull wordpress@sha256:0f3140b979bdce576b457e650695e72b79fd7075a6b4b8797fbf885afee05dcd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.4 MB (204357562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5cc20fe4020c7158b59e0929a9c2e887903bb9cb6615933d95c197e55fc5c11`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:54:32 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:54:33 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:54:34 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:54:35 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:54:35 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 12 Jan 2022 23:54:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:955163c00485f52bb9dcae32bf59fc93eac7f255db76b51002cfae7b5c3f9801`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e42ef13110addbc7cc8e218b8ac20ef8c6de5068b87cc40bf49401b121d6b2b6`  
		Last Modified: Thu, 13 Jan 2022 00:09:34 GMT  
		Size: 19.5 MB (19524532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b647fed4f7930a3e96578477a90f204a0342dceb414cfd8abb0b26bfe9a5798a`  
		Last Modified: Thu, 13 Jan 2022 00:09:31 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0578e6273456a0ae62624f8044e119bcc7d85c1b99d3cd65764e0ffa6987dc82`  
		Last Modified: Thu, 13 Jan 2022 00:09:31 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d138a737522226644d0fb5e402d73121eed56b0abb44abe2df6772d6816a16e6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.0 MB (216004464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb9e93966cc1b8c0284316750b7418426582e7b8acc2ecc82509ca49160353bd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 22:49:46 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 22:49:47 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 22:49:47 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 22:49:47 GMT
...
-	Layers:
	...
	-	`sha256:4fab5a68053639182b78792e96077db3560371c32c8dbff9e5a3632fcd7e739f`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfaa6e45635943ca4b77f99e4bace90bbaf7b46292acbb9005d37b9dfac3244d`  
		Last Modified: Wed, 12 Jan 2022 23:04:04 GMT  
		Size: 19.5 MB (19523354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:663cd961d619a8533e90f5aa777ef4ebfa1152a57d2d8ec1b747b43775e448f5`  
		Last Modified: Wed, 12 Jan 2022 23:04:00 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19bfb06c764057da7d2170790a0063e2c93c73faa94041bd4649d58a4f5ff825`  
		Last Modified: Wed, 12 Jan 2022 23:04:00 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:996ad16b768867ac14522ca33413758c8e68513378d555ed69ecd06114bbdc18
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.2 MB (189165738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81402cf3b5d44b7fcaf7ab7774118a9bbeda30ca16a022294baf516b0433491a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:16:08 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:16:08 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:16:09 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:16:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:16:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 12 Jan 2022 23:16:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:95d1b36bc6c8216e4857bf4a7da4d9b9ba4981fef0acf09f2cc7bd11eed3cc57`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b5c9f07a46905de78d7fcbee7e69991904d2a27015232307ca75a679e5d015c`  
		Last Modified: Wed, 12 Jan 2022 23:23:04 GMT  
		Size: 19.5 MB (19523298 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa4a22b20c004c3a7be204c2372fa464ab3107c5d62a7bad1d0cc5e9cd82590d`  
		Last Modified: Wed, 12 Jan 2022 23:22:52 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:957d58fb6862ed7661ed71da5662166752a6d77afa117ac196447c1ff733dc1b`  
		Last Modified: Wed, 12 Jan 2022 23:22:52 GMT  
...
```console
$ docker pull wordpress@sha256:eefd596c1a9a0c02e59092c97da5987c4cf52853cd70e045a9ea056c1c2ae5e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **214.3 MB (214278417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1afba6d2f91647fb1ea69d09251c2cb5ecd4186a70774f664f49263973d81f2b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jan 2022 00:05:09 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 Jan 2022 00:05:20 GMT
VOLUME [/var/www/html]
# Thu, 13 Jan 2022 00:05:24 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 13 Jan 2022 00:05:26 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 Jan 2022 00:05:30 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jan 2022 00:05:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e101f507f25547d118834c5162f67b586655bb8ef1be4e8408593163246a7290`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fba1e23396cf1a36d24d302816bba391823c23f70271630e5ffc041ef92cdb48`  
		Last Modified: Thu, 13 Jan 2022 00:21:57 GMT  
		Size: 19.5 MB (19523347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afbed10a06a4496fab5074d764b4c522223fe7da525cfaa12d3bb0019f4b72c0`  
		Last Modified: Thu, 13 Jan 2022 00:21:53 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07a06d867dd4642382d4add8bbd4981d556cd1e623892ac473160219fd322be2`  
		Last Modified: Thu, 13 Jan 2022 00:21:53 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:9293a2de662743ba47001aa6e056eba658b306b8c19c8a37bf283b24e083ea0e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188780820 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdd95d90250294a60bf584f98c8bca6c7c3b02219bf76bdff3ab5a556da1182a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 21 Dec 2021 18:01:56 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:04:28 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:04:29 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:04:29 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:04:29 GMT
...
-	Layers:
	...
	-	`sha256:e1cc207efd79bccb00d71fa36e487752d82c2f00361ff2d1ded12fb1773393af`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f396bbc94931a8e206d147c526d5742c74a39f10a8c0ac96985475f68269be7`  
		Last Modified: Wed, 12 Jan 2022 23:16:17 GMT  
		Size: 19.5 MB (19523362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3695cfed9e3ff1fb05adb6639ba4e1c45d3be32f567c62d6ab07615f19db9e7`  
		Last Modified: Wed, 12 Jan 2022 23:16:14 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b53e03a7eee62d92b8f39cac8e2e24896a6b514b1a8166cd53871e8e0acafca`  
		Last Modified: Wed, 12 Jan 2022 23:16:14 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
