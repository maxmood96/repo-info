...
```console
$ docker pull wordpress@sha256:1ea05f6cd8df616d133865e37cf810ec07a965d3dff6f8308a505d63ea193f31
```
...
```console
$ docker pull wordpress@sha256:76dbbb02f70a332bd911e69775fed36241743d01a03d86ea2766c41d9c5aad01
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.4 MB (190439103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecb6919e0d302885e76868b2e60a2674d26310de579b2b32dcdf56ec557d5a32`
...
-	Layers:
	...
	-	`sha256:0886910e733b80a5cb828a6f2214978047774190f3b512524b980bc576a10b75`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b88dd5fdfb955a1b9dddf3070bb6e38bbde4a156395a0443b5dd68bc0860074e`  
		Last Modified: Thu, 04 Feb 2021 23:29:47 GMT  
		Size: 15.3 MB (15267089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fba9de5fd19db32f4af92bd8b5c177d79e0e40d22c608e7b543975d0a4f0e9f7`  
		Last Modified: Thu, 04 Feb 2021 23:29:41 GMT  
...
```console
$ docker pull wordpress@sha256:df5990a09a19e92513b350fb8854c8ba5c4cffbeded59e82e5400a9e1ee2c575
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.2 MB (163180430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb6cd10ab697b8d739b531a528244be58d9e104e480885cb92424e8e27b7d277`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 04 Feb 2021 22:20:08 GMT
RUN set -eux; 	version='5.6'; 	sha1='db8b75bfc9de27490434b365c12fd805ca6784ce'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Feb 2021 22:20:10 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 22:20:11 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Thu, 04 Feb 2021 22:20:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Feb 2021 22:20:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bc96b6ce3d6ac4b27e817aec427321a732302099270d429abe509c80079c905f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:359d25cb2c1abf6125129661c43cc6ad4ad84ba1ee3e20bafdae559812235c55`  
		Last Modified: Thu, 04 Feb 2021 22:35:07 GMT  
		Size: 15.3 MB (15267124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1c042a75327e69557b471859b9791e01e159b448910af2a807d2a55843f9a0b`  
		Last Modified: Thu, 04 Feb 2021 22:35:02 GMT  
...
```console
$ docker pull wordpress@sha256:ae0614c91897dd997ec386499e22a016e714b1107d33d277aa3cf2dd509b3122
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180844690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5a54a58f993c952836a79de32363f5a05e4badc79d592431617545c60d09d98`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 04 Feb 2021 21:17:15 GMT
RUN set -eux; 	version='5.6'; 	sha1='db8b75bfc9de27490434b365c12fd805ca6784ce'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Feb 2021 21:17:17 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 21:17:17 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Thu, 04 Feb 2021 21:17:18 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Feb 2021 21:17:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fb4784978501b3a7d12c990e7d70d942bdcfac61b58dad7e5fc2f4844e718aeb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41c4c9e95553b6047c736ebb44ab47ec67e5b9bc5026b39764003a527e35e9e2`  
		Last Modified: Thu, 04 Feb 2021 21:34:13 GMT  
		Size: 15.3 MB (15267123 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73d132309f5f6706ab864135c125c729a29bed7200cdc8bcb9cecdb869ab6a6b`  
		Last Modified: Thu, 04 Feb 2021 21:34:09 GMT  
...
```console
$ docker pull wordpress@sha256:e294e792ddee29165636efbf0f17f72b7702c5b19bdb6b073fd599c72a84e620
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.0 MB (195991218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:443e05bcc2b901b0e9884112926bce21fa4115f7aa30514769d40b7e96999f06`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:15f6b34165d485f55473338f23defa9895015ad8b67840743c0e44f649d682fa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bf2f3a7bfad741a0d3be6540be0e10c5d93c70ffbbe552e1d05ab9d3db93d50`  
		Last Modified: Fri, 05 Feb 2021 00:08:25 GMT  
		Size: 15.3 MB (15267094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cf3842a3a33c69a7dcf129d5e513279607c15da40afa7df1327ea1bcbb55c19`  
		Last Modified: Fri, 05 Feb 2021 00:08:19 GMT  
		Size: 4.0 KB (3961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
