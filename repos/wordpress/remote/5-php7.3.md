...
```console
$ docker pull wordpress@sha256:765ec4af9e7d484e51c68e2f7d61acb1372ffbc7373b449db9b13dcc86385b02
```
...
```console
$ docker pull wordpress@sha256:c3cedf9f7fad402295b9830e0bb70e62b039f9b35b553e61d30bcd948b1f516f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190459263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db23a4a321c8f2c3f2280f44d3b9b0dec9ef793fd7cc2e96f8a00cffdf7e14bb`
...
-	Layers:
	...
	-	`sha256:84027da7b6b1939cdbdce5365f2feac6be72db33a979282b3050e60a81c25537`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee72192839cc3f7c6d7b6d0bd36f57810d31372621a5c663006faef61a63276a`  
		Last Modified: Sat, 06 Mar 2021 02:39:43 GMT  
		Size: 15.5 MB (15455624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60bf255844ecc87ea62bc4655fe05da8ce249e34d7131520b23ee08dcf17e9e1`  
		Last Modified: Sat, 06 Mar 2021 02:39:38 GMT  
...
```console
$ docker pull wordpress@sha256:0cdcddcab2b5c402de327f20f061b14ab284c8b14ae1855c2d7612fe760cfd54
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.0 MB (195984396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9de02721068655b4eab5d34c00d5f6ce0e110a1cb7a3a9df7c9cfb5b42be1758`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Sat, 06 Mar 2021 01:15:21 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 06 Mar 2021 01:15:21 GMT
VOLUME [/var/www/html]
# Sat, 06 Mar 2021 01:15:22 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Sat, 06 Mar 2021 01:15:22 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 06 Mar 2021 01:15:22 GMT
...
-	Layers:
	...
	-	`sha256:cedb3a63339115c7e986ae2c89653510c8f1badc85ebb2af420b2528f01a606c`  
		...
		Size: 19.5 KB (19473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eeec9dadfd15eaaf92dc3cbd70061d0ed597a9327a8453f2e301905b0a870f4e`  
		Last Modified: Sat, 06 Mar 2021 01:35:15 GMT  
		Size: 15.5 MB (15455632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01e4be185695c320421f35881068ff5e022fa27c0877460c0e271c94a7b3987e`  
		Last Modified: Sat, 06 Mar 2021 01:35:09 GMT  
