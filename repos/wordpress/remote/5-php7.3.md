...
```console
$ docker pull wordpress@sha256:4e197ff09368bc389b756291bfa3cd96d3e321f8e54b0a3e47a9dc9f580a23e9
```
...
```console
$ docker pull wordpress@sha256:26572e99828e183035abcdf1530dc5ae86cc94a4da67c2bc83825cdf9edc592f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.8 MB (159813562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c6396aaf995357d2b0bf3139f815c3c42d8ecf5a3c73c10d4bbdddb01f646d9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 07 Aug 2020 07:57:47 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 07:57:48 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 07:57:53 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 07:57:54 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 07:57:55 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 07:57:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 07:57:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f4371850f380e5da2fe5e83ddecb6aa3bfb1aa452eda244db07f1ee5afa77bec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bdbeb86d3edd3d4d7581043543600ef15c9205f1a56314df77eff5bc61ac9cd`  
		Last Modified: Fri, 07 Aug 2020 08:18:16 GMT  
		Size: 12.1 MB (12082660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8efe2aa7915c2a0be446a0b054b504139e78a3a877b1392d508e1f5ffe3c9e6`  
		Last Modified: Fri, 07 Aug 2020 08:18:10 GMT  
...
```console
$ docker pull wordpress@sha256:dc07dcd3abbf2957efdac055f7a34c30376b20c1fca1287eb63e03f5d1943db0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.8 MB (198836343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:795acfd12437a85843944552d6e11f7883968505b63a9c0cad50db2ea11cf05c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 07 Aug 2020 05:41:49 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 05:41:51 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 05:42:06 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 05:42:18 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 05:42:20 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 05:42:24 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 05:42:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2047db064ba369a467b35f94111d22c268ad04905ce8f1f7b8628be6ca945c4d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d89731aeba520b7be03077400f3082e3e15ddd65f4cee986187929f9f7b83992`  
		Last Modified: Fri, 07 Aug 2020 07:29:28 GMT  
		Size: 12.1 MB (12082663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e20842ff6961379b2834dc8d44a164a471f8919f04ba1d5c809332cafa736c0b`  
		Last Modified: Fri, 07 Aug 2020 07:29:23 GMT  
		Size: 4.2 KB (4154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
