...
```console
$ docker pull wordpress@sha256:d36059a2a2906d50e90bf12ca25591f89f84f0f19e72bb70f7f2dc0dd1f417b9
```
...
```console
$ docker pull wordpress@sha256:6d2845cb14fd8ced7d00b2d56dc778b0583e1f552ab16159623079a19c434df1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.9 MB (213919769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8122c48d8135670e8d76ffef9342b0428b751d2fb778ea553e781dae204a0668`
...
-	Layers:
	...
	-	`sha256:dd168d5120416d81bc420a5df6d2eb36c5712c4838a5dfd3a603877c964b9455`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f6024c142bf3853171ae60a76a617117b73f5681498244f17ea1b9f453a2bf5`  
		Last Modified: Fri, 03 Dec 2021 19:03:04 GMT  
		Size: 14.9 MB (14915750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5472c800e23befcd43ad5f83b03102c1c779dfca835f507e7aa96ed32e4d336b`  
		Last Modified: Fri, 03 Dec 2021 19:03:00 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a209c05da8454cde8c420184fe56d1e4e39600b6742431e87dd641de3dd7891`  
		Last Modified: Fri, 03 Dec 2021 19:03:00 GMT  
...
```console
$ docker pull wordpress@sha256:6aa59226e423011a18664c8569c128b57dd59900a9070a856c82ecb12a6471ba
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189749079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad4f27703f7f877efe3827b9b2099017fc0a65fd5b66c3af525c2cb1c9183e73`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 03 Dec 2021 11:11:54 GMT
RUN set -eux; 	version='5.8.2'; 	sha1='c3b1b59553eafbf301c83b14c5eeae4cf1c86044'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 03 Dec 2021 11:11:55 GMT
VOLUME [/var/www/html]
# Fri, 03 Dec 2021 11:11:56 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Fri, 03 Dec 2021 11:11:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:52d855c3b8531860abd44f666a0817fcd958f04dadd4c3568c79fe326ff5fc24`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7f8ee9862ead1ba22e8c652680421b67e814b948e4053aefc6f293891bb84af`  
		Last Modified: Fri, 03 Dec 2021 11:48:39 GMT  
		Size: 14.9 MB (14915754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aff8495c8d36d7e6d1a3106ceb36e354279f43999422c6ea4e68a0b4d2e606a`  
		Last Modified: Fri, 03 Dec 2021 11:48:28 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c601704df0110891f3582c344cfea66607e27dccdd3230c919316a95fff0bc7`  
		Last Modified: Fri, 03 Dec 2021 11:48:27 GMT  
...
```console
$ docker pull wordpress@sha256:41f34daa4d8d20d9e88d6b13db85e734953e2074a1f0bc19558305d8421c5899
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.5 MB (204534429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b139c11b4c435219f51d1c263d754ef4e42a937bac52664371ad8fbe807e184c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 03 Dec 2021 14:40:38 GMT
RUN set -eux; 	version='5.8.2'; 	sha1='c3b1b59553eafbf301c83b14c5eeae4cf1c86044'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 03 Dec 2021 14:40:39 GMT
VOLUME [/var/www/html]
# Fri, 03 Dec 2021 14:40:40 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Fri, 03 Dec 2021 14:40:41 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 03 Dec 2021 14:40:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 03 Dec 2021 14:40:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9dc40be1dbb2c4920d47cc6302870d2327ff63bbd4cd905f71c00d24bfe148c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff37c427360b762c5ed50dfd65074aa2653fbdff7703e1df790e320d62be28e3`  
		Last Modified: Fri, 03 Dec 2021 15:07:27 GMT  
		Size: 14.9 MB (14913392 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16b07bc9b707358ef1adc80b30e29d6f0f00254bcdfc2a037cf76b32c90c1451`  
		Last Modified: Fri, 03 Dec 2021 15:07:23 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cb60b41a5e5249f6c9f910515fe1b48bc10d606ef84b176823dfd88db234ddf`  
		Last Modified: Fri, 03 Dec 2021 15:07:24 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:777ae6cb127a28723f5492217cdd0598b91660ff2108a911074dc952572a6c2b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.4 MB (216380422 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88511e2715c70cf48fad1a3c1152b98d9f1390f24d4d5d356bc8e1230f647675`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:038f1714b2ed57e8732d4f61f71f6aa0868dbb73f622bfbe4742ce19f26a0875`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f11fd4ce915f677c4eb860e7cac21db15380ad85b23f658cf22ccf68c624d57`  
		Last Modified: Fri, 03 Dec 2021 11:42:02 GMT  
		Size: 14.9 MB (14915755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eb3131a80fe0f7068a2582f3dc9490bddea5b9ef13756df8ee276275f1712dc`  
		Last Modified: Fri, 03 Dec 2021 11:41:56 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:959b44c814ed26d962b4e361fc4fde1906cbdd0e48086a7f94a15be9cdce6ec9`  
		Last Modified: Fri, 03 Dec 2021 11:41:56 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
