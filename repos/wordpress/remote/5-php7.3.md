...
```console
$ docker pull wordpress@sha256:7a0ae0f2bf8cbbaa6d439ebaefa5c8545645d1457bab5dec7ee65ab9b5db1c79
```
...
```console
$ docker pull wordpress@sha256:801706d20744d79f389bcd85872a98cb5339c6a98b460c28621929e6346bf8a6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (163955460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fec1a327a6b6ea0c478c97606209f409d514d87cee681b6cb05bcbf01aebfb0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 05 Jun 2020 23:31:47 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Jun 2020 23:34:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Jun 2020 23:34:56 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Jun 2020 23:34:58 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 05 Jun 2020 23:35:02 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Fri, 05 Jun 2020 23:35:04 GMT
VOLUME [/var/www/html]
# Fri, 05 Jun 2020 23:35:07 GMT
ENV WORDPRESS_VERSION=5.4.1
# Fri, 05 Jun 2020 23:35:10 GMT
ENV WORDPRESS_SHA1=9800c231828eb5cd76ba0b8aa6c1a74dfca2daff
# Fri, 05 Jun 2020 23:35:18 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 05 Jun 2020 23:35:19 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 05 Jun 2020 23:35:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 05 Jun 2020 23:35:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4a36b27e98151e0c9265ab39f9df2ab04d5d78fdc46923fcc0063b326307389e`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71f48b555d3810e6f4fa3c0b0d645e26382323d76f740a0ab7c21883d9cfd217`  
		Last Modified: Fri, 05 Jun 2020 23:48:47 GMT  
		Size: 16.3 MB (16279122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e04244c04308a7e94dad174a4374fd9a992b4b7ba7e7199cf3e26a928a90853`  
		Last Modified: Fri, 05 Jun 2020 23:48:43 GMT  
		Size: 8.4 MB (8377232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23a463ffa177b4290bab3805a4bfc1e76e66321e6b1fec6a44c28647fce13ce9`  
		Last Modified: Fri, 05 Jun 2020 23:48:39 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e532c971abb56b86e6636b1ad2f7beceaa9c30ab07c81ef681efe5d8f8e3001f`  
		Last Modified: Fri, 05 Jun 2020 23:48:39 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5340e2e1d427d25fde11348f963b039cbac65feb8c3a419d7de18cb46ce8971`  
		Last Modified: Fri, 05 Jun 2020 23:48:39 GMT  
		Size: 19.5 KB (19482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:640dfcde464283eb47400f5fbe4f1fbaf716d47255c98f530f245619ff02c41e`  
		Last Modified: Fri, 05 Jun 2020 23:48:44 GMT  
		Size: 12.1 MB (12079496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b51a3c78eb7fee7a43e5e43ded1c91ef4c12bb147e000de0a3d9743926e5dd0f`  
		Last Modified: Fri, 05 Jun 2020 23:48:39 GMT  
		Size: 3.9 KB (3894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
