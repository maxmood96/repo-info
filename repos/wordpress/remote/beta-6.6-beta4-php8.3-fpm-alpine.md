...
```console
$ docker pull wordpress@sha256:1fb884c7829859f66a1d3fbbab6e4fb24eb2c6dbca2ccc23641d7ab7628d8cea
```
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.6-beta4-php8.3-fpm-alpine` - linux; s390x
