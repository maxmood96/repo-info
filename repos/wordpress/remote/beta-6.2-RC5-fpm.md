...
### `wordpress:beta-6.2-RC5-fpm` - linux; amd64
...
### `wordpress:beta-6.2-RC5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC5-fpm` - linux; 386
...
### `wordpress:beta-6.2-RC5-fpm` - linux; mips64le
...
### `wordpress:beta-6.2-RC5-fpm` - linux; ppc64le
...
### `wordpress:beta-6.2-RC5-fpm` - linux; s390x
