...
```console
$ docker pull wordpress@sha256:01f19c34ea6bb89039ba43d8c32412c343d3251c8f2715ef7918f39b1ac9a99e
```
...
### `wordpress:7.0.0-php8.2-fpm` - linux; amd64
...
### `wordpress:7.0.0-php8.2-fpm` - unknown; unknown
...
### `wordpress:7.0.0-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:7.0.0-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:7.0.0-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.0-php8.2-fpm` - linux; 386
...
### `wordpress:7.0.0-php8.2-fpm` - linux; ppc64le
...
### `wordpress:7.0.0-php8.2-fpm` - linux; riscv64
...
### `wordpress:7.0.0-php8.2-fpm` - linux; s390x
