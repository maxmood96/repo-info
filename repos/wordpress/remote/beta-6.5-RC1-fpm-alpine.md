...
```console
$ docker pull wordpress@sha256:24f190b1dd6e7c7778a7795d865d293cdf6fea22d6fa61f7c0399377fea3f4e8
```
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC1-fpm-alpine` - linux; ppc64le
