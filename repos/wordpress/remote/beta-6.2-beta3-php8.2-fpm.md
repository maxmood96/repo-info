...
```console
$ docker pull wordpress@sha256:6bf158086a3db7e7f939cea8eb7a36559b4881fb7be8dfb36f40866da1d844d8
```
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; mips64le
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.2-beta3-php8.2-fpm` - linux; s390x
