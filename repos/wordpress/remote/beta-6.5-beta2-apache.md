...
```console
$ docker pull wordpress@sha256:bac65cdef95a801c57b96af51a0e55462bb7182d487eea790fec7dfef9263b18
```
...
### `wordpress:beta-6.5-beta2-apache` - linux; amd64
...
### `wordpress:beta-6.5-beta2-apache` - unknown; unknown
...
### `wordpress:beta-6.5-beta2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-apache` - linux; 386
...
### `wordpress:beta-6.5-beta2-apache` - linux; mips64le
...
### `wordpress:beta-6.5-beta2-apache` - linux; s390x
