...
```console
$ docker pull wordpress@sha256:78f0d310ce4d8b94d14948851b591d70ec8ace2de3efcd2111b5a3fe93dc8664
```
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; amd64
...
### `wordpress:beta-6.6.1-RC1-fpm` - unknown; unknown
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; 386
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; mips64le
...
### `wordpress:beta-6.6.1-RC1-fpm` - linux; ppc64le
