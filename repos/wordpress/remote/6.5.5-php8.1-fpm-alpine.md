...
```console
$ docker pull wordpress@sha256:740784c6b585bb51faaf59cc02443705b04f65fb3dfa4e0cefb3af920f512c11
```
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; riscv64
...
### `wordpress:6.5.5-php8.1-fpm-alpine` - linux; s390x
