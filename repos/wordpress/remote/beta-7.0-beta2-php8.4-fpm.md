...
```console
$ docker pull wordpress@sha256:cae40a8829fa32d8cb12cd8bf82a41516387974a8fd6540cad749cb304015900
```
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta2-php8.4-fpm` - linux; s390x
