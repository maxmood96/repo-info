...
```console
$ docker pull wordpress@sha256:43c098b1bbc849b7a787b6811acbdefe7a8f5a6291accfce7fe1d790268c0d88
```
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC4-fpm-alpine` - linux; s390x
