...
### `wordpress:beta-6.7-beta1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.7-beta1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-beta1-apache` - linux; ppc64le
...
### `wordpress:beta-6.7-beta1-apache` - linux; s390x
