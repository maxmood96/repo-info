## `wordpress:beta-6.1-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:244593a756e9d5110197f4c4b88de3b4fbe85308020a6b60a5b5011253e38dce
```
...
### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; amd64

```console
$ docker pull wordpress@sha256:1a56304d9da1078fb73b2d5f027fd7721801cb5036a5797c016db24ab6ff8959
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.2 MB (102159110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8791c166bf319b4299e3ba213cf800715f19d9479c37bd12c8c1cb48c6a85ca1`
...
-	Layers:
	...
	-	`sha256:bcfa10af734d4a937415686d2c4f971361b85339b1d22591f3bb752f00fc75ed`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99744c1af5a74e120ff90452f5e2e77b37f5f3b62244225bf1900fa01e8088d9`  
		Last Modified: Thu, 29 Sep 2022 16:34:05 GMT  
		Size: 23.4 MB (23379911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d51e57e268398e5912b0f26fa046be971eafe8eedb0cd87c88ba8a3d34f0d1b4`  
		Last Modified: Thu, 29 Sep 2022 16:34:02 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6aedd8a039289e51d8f98b45e1dc82f03b935e1039abfc2ecd8faf7068f818bb`  
		Last Modified: Thu, 29 Sep 2022 16:34:02 GMT  
		Size: 1.7 KB (1727 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; arm variant v6

```console
$ docker pull wordpress@sha256:cfe24ba71d772f3c7cd9ed1da7ee6287cb5a5921366ca5d7562759326584f61b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.5 MB (96528762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2226ac3d915cbe0ee51e79dde3bd9489652ef50d74985925307433b1ca88c448`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 17:26:07 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 17:30:01 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 17:30:01 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 17:30:01 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 17:30:02 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 17:30:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 17:30:02 GMT
...
-	Layers:
	...
	-	`sha256:83dce8a5d6e62276acac67a20b2ad2c68693d95bce486571e70a0b94c3ce8d65`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4741c1646bd5b724c0415793ee9fe22e85d07a94d4fd330423a8ba001ef82315`  
		Last Modified: Thu, 29 Sep 2022 17:35:09 GMT  
		Size: 23.4 MB (23379924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bc5e1047720b051d3fd75ef80cc88e09572384d36147760106adce114affcc3`  
		Last Modified: Thu, 29 Sep 2022 17:35:02 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6de39b980387704f2ed103e24fe2c1d89742a1781e83ecdc7c7b3b4ce428f423`  
		Last Modified: Thu, 29 Sep 2022 17:35:02 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:7e7860d64fab9d4b78cebd0567f81a4326ceed6e36cd2b1b83b59d99b8d96287
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.3 MB (93310084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d36a2a41898d9221698627364201d1c7d39105d2f15097501dea6fec559168c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 16:51:03 GMT
CMD ["php-fpm"]
# Fri, 30 Sep 2022 05:47:30 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 30 Sep 2022 05:48:37 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Fri, 30 Sep 2022 05:48:38 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Sep 2022 05:48:39 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Sep 2022 05:59:33 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Sep 2022 05:59:34 GMT
VOLUME [/var/www/html]
# Fri, 30 Sep 2022 05:59:34 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 30 Sep 2022 05:59:34 GMT
...
-	Layers:
	...
	-	`sha256:f00ec3db54254fcb259a2833078c3a9b4e9016b38b4f5fc4cc51dd7ef2437932`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d703a7d4a5ecbf26fc78a629ef16d9d2491b0067e5a3cb8c097fb0680b6f946`  
		Last Modified: Fri, 30 Sep 2022 06:07:13 GMT  
		Size: 41.2 MB (41240392 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9d0099792a4b12b1612ef1def71b9f30a8384c48eae7b0868b964bf8cd1caf2`  
		Last Modified: Fri, 30 Sep 2022 06:07:08 GMT  
		Size: 3.8 MB (3849504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1d2cbfd0de73d760a86d6461d361d36a673773a398efe5b8cc003d3e1fdd883`  
		Last Modified: Fri, 30 Sep 2022 06:07:04 GMT  
		Size: 65.7 KB (65693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cbb25e9f9128188df7d1b74b3046dcf6e37ba4c892c464c3e1e9a822a5a147b`  
		Last Modified: Fri, 30 Sep 2022 06:07:04 GMT  
		Size: 386.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0585de6f49fc8a6f724c6e93a7a14b2f58e497c5dd40ed79a957c5e8557f5a60`  
		Last Modified: Fri, 30 Sep 2022 06:13:06 GMT  
		Size: 23.4 MB (23379916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25718788d239b5352d4c8152e5b0c533518fa351e22bd046879afceeecf338ae`  
		Last Modified: Fri, 30 Sep 2022 06:13:01 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30fba442fce8d4a45bd8a8bc1e220360a324361d158be21c2a27fced3fcb04a1`  
		Last Modified: Fri, 30 Sep 2022 06:13:01 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:810a5f412f836aaa46a6dc09cf05dd013a671d14d643f6189d2c7c03ccb92263
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.3 MB (100251366 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e791555896509f7ab631f9e3818d7b9f0e20aa6eb5abe0baa7b4effe838f0b8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 29 Sep 2022 18:01:10 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 29 Sep 2022 18:02:09 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 29 Sep 2022 18:02:11 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 18:02:11 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 18:05:22 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 18:05:22 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 18:05:24 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 18:05:25 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 18:05:25 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 18:05:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0eb21fc3fd21f9c062e4b17175d188d1ee8088057503124e1b7718202d3671b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b8485aa86ea48617c4df0b42be581701d5a6d571974576a9d930f05c21ec2a1`  
		Last Modified: Thu, 29 Sep 2022 18:12:19 GMT  
		Size: 46.1 MB (46105478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:910a875f46d7a6deeb703a66806dac898d1b26a0abaf6e835931025adbb969c9`  
		Last Modified: Thu, 29 Sep 2022 18:12:12 GMT  
		Size: 4.3 MB (4268427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b13636068e66be9a84c2c6184784db3bd84c5f82a99afacd1680bb07ccd0206`  
		Last Modified: Thu, 29 Sep 2022 18:12:10 GMT  
		Size: 65.6 KB (65631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3885c334ae5151f97af2ac1fdca9a8056be7e6dba61cb74173ad512a2df2d90`  
		Last Modified: Thu, 29 Sep 2022 18:12:10 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8ba59aaeaadd65252ddcf12d78414c9d11eecab844e6ba7302ad7193b91ab09`  
		Last Modified: Thu, 29 Sep 2022 18:15:52 GMT  
		Size: 23.4 MB (23381081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7bb95605ae19bea3948d09e24eaf3ce4f896786fa15b7daef29ff9d97a58015`  
		Last Modified: Thu, 29 Sep 2022 18:15:48 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:debef3eef78e57f2cd8b3725b189e718e123b3b65b03923111874325730fc813`  
		Last Modified: Thu, 29 Sep 2022 18:15:48 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:f31671946b31b843c8854c7c5f89bfead461818e8e3230c23371729b7cddecbb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.4 MB (101399887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09248b40af9122b70b8114a317ba38c929ac65c7718d3e7bdb58b80544ca6a58`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:98d1a24b6ade4f63ed322c5aa7deec27841ce68d13c1683f747b8a222c0ac4dc`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56f17670fe8cb322ec0ceba95bd064ae4e4a3467d48730319b46696e37ce7c2a`  
		Last Modified: Thu, 29 Sep 2022 18:13:55 GMT  
		Size: 23.4 MB (23381071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27d4b84b216c9cd5fd191ff1da7180d5c4b87adf61e74467dee1edb73c35301a`  
		Last Modified: Thu, 29 Sep 2022 18:13:52 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5eab9737d2c453831f6aab19e5d2fdbbf0b67bb1e73c7c751ad7705f8b38c3f5`  
		Last Modified: Thu, 29 Sep 2022 18:13:52 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull wordpress@sha256:0599ea6ee31d2033c0690d475f5720b985cc88f9082b632d0e8543a8e230d112
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.2 MB (108240794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e647b66dc7831b0e10b11b5b32846e4e861efdfa99c9a6913e21ddbb4b25e745`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 14:45:31 GMT
CMD ["php-fpm"]
# Thu, 29 Sep 2022 17:58:46 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 29 Sep 2022 18:00:17 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 29 Sep 2022 18:00:20 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 18:00:21 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
...
-	Layers:
	...
	-	`sha256:631bafaf0c011d2b30460f00ebf2219ad7ad958ed90d0497d88d4f8da8e3ee0e`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:542d931cce255de548c00d44c48eb6045ad4f5a4fe3eb7c527e1dda1b475b688`  
		Last Modified: Thu, 29 Sep 2022 18:12:07 GMT  
		Size: 52.8 MB (52764042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a26c3453c28443e4cf52383f2afe3cd211292704cbef5392fbb499fe55139a99`  
		Last Modified: Thu, 29 Sep 2022 18:11:56 GMT  
		Size: 4.5 MB (4500547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c966fd4d68428abb9fb6dda74f6811dd41f4b0dc9c4f4896f3908921cbce88f7`  
		Last Modified: Thu, 29 Sep 2022 18:11:52 GMT  
		Size: 65.7 KB (65709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0c2017ece546cee426df21a6bfc4f6f806117950661aa8d696e354477aaa4a6`  
		Last Modified: Thu, 29 Sep 2022 18:11:52 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70bd3463777bd4aa0bf88fd0b7c26dc111176e7277c64349e0f1aac8f6150447`  
		Last Modified: Thu, 29 Sep 2022 18:16:24 GMT  
		Size: 23.4 MB (23379924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b8ea03bbb3a69b691d6a415bd09a1e8e3d803a959abb029ec45ddef915d0600`  
		Last Modified: Thu, 29 Sep 2022 18:16:19 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df2bcb0ba65e2233bbefefac16a335eca7c09cbd3360278d7792048d850680bf`  
		Last Modified: Thu, 29 Sep 2022 18:16:19 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.1-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull wordpress@sha256:0797f5d3a6ee49e2ad7c34b480ac31861dcc05bb28b5aa711e44a8eb4a6b955e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.9 MB (91930943 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:514b29b0df1ea89de87e505ad80c102457f31ca27dd6e87040d58ea4cf7aa677`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 17:11:07 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 17:11:08 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 17:11:09 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 17:11:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 17:11:09 GMT
...
-	Layers:
	...
	-	`sha256:9b24cf4cfe24cdfc0617b6e9713e0a4885320d350e7dcaa183608e0e680f9de4`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2538f222e00bb48a57588c5d784eb1935517401ee74cdfde39b0acc47fe5a54f`  
		Last Modified: Thu, 29 Sep 2022 17:20:28 GMT  
		Size: 23.4 MB (23379916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71f034044bbe4544f11358230aba0c95d99fa9ae30428a68d8128cb3c2507972`  
		Last Modified: Thu, 29 Sep 2022 17:20:26 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cae9025d6797cbf3f908a4ad0cc1516bcbe5aac397608bf9f09039e0e8607028`  
		Last Modified: Thu, 29 Sep 2022 17:20:26 GMT  
