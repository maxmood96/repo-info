...
```console
$ docker pull wordpress@sha256:b343225628c88c54a158f60ebd0bf8bd0e3ec1c9eb8601d429574e5cdf51eecc
```
...
### `wordpress:beta-6.5.4-fpm` - linux; amd64
...
### `wordpress:beta-6.5.4-fpm` - unknown; unknown
...
### `wordpress:beta-6.5.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.5.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5.4-fpm` - linux; 386
...
### `wordpress:beta-6.5.4-fpm` - linux; mips64le
...
### `wordpress:beta-6.5.4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.5.4-fpm` - linux; s390x
