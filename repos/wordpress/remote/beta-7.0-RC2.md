...
```console
$ docker pull wordpress@sha256:ab6065ce0ef1d91e93c3665ec39e6ed401d3a897158526232f6b6663283f2b46
```
...
### `wordpress:beta-7.0-RC2` - linux; amd64
...
### `wordpress:beta-7.0-RC2` - unknown; unknown
...
### `wordpress:beta-7.0-RC2` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC2` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC2` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC2` - linux; 386
...
### `wordpress:beta-7.0-RC2` - linux; ppc64le
...
### `wordpress:beta-7.0-RC2` - linux; s390x
