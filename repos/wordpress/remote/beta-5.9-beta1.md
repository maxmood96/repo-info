...
```console
$ docker pull wordpress@sha256:8190752691d13d891ed469b45b09bb90f429b2fabf0b41737d6387910e49a888
```
...
### `wordpress:beta-5.9-beta1` - linux; amd64
...
### `wordpress:beta-5.9-beta1` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1` - linux; 386
...
### `wordpress:beta-5.9-beta1` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1` - linux; s390x
