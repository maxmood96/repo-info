## `wordpress:beta-5.9-beta4-php8.1-fpm-alpine`

```console
$ docker pull wordpress@sha256:94bc410a40e7be553211696d664874fea6199af9650c3d164b374f2d7ff5cf76
```
...
### `wordpress:beta-5.9-beta4-php8.1-fpm-alpine` - linux; arm variant v6
