...
```console
$ docker pull wordpress@sha256:86104e17e9d1f60b5462334e103f02909530b04856ff6487b8c1d9a8fdd1cf53
```
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.5-fpm` - linux; s390x
