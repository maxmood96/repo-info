...
```console
$ docker pull wordpress@sha256:f206a35b0ef61e14423f6f08c1a73a918413693eca9346035d4fa2398692f4ea
```
...
```console
$ docker pull wordpress@sha256:50e465b0aa6085bc79e710335a3a17199a886f065060677e574512563d134a3a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.1 MB (209141605 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:329b76a6170fefb333edab6029f4403e078577fdbec695543370eeb2e82bdd80`
...
-	Layers:
	...
	-	`sha256:1e91a848751c2055433c55285ac5f416229da6ad20a2759b0e1e9d4eae1dc3a9`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19fb3944b0a4eee158e2c7279abb44cc4c32f81b4a5d8d28e928644ffb581ed7`  
		Last Modified: Thu, 14 Apr 2022 09:09:50 GMT  
		Size: 18.6 MB (18602849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:573ec1d36dd824085f3f60e985b938242e0c010b360a58116bc0c5d7a4a759b4`  
		Last Modified: Thu, 14 Apr 2022 09:09:48 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:341e9a89c1cf77719e6a6cb47c728407348819b663387eebb34e1bdc0ea2595f`  
		Last Modified: Thu, 14 Apr 2022 09:09:47 GMT  
...
```console
$ docker pull wordpress@sha256:0c78453706e61411d1cb23f97baa4261b809cd6e6a19a59386ccf2a48e953a30
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.2 MB (185231492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:778bc62e2a2d3ece1a5090fec9e5c72f992556fde483b3f91ca950363acd3e43`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 14 Apr 2022 08:16:54 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 14 Apr 2022 08:16:55 GMT
VOLUME [/var/www/html]
# Thu, 14 Apr 2022 08:16:55 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 14 Apr 2022 08:16:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 14 Apr 2022 08:16:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 14 Apr 2022 08:16:56 GMT
...
-	Layers:
	...
	-	`sha256:68e80947dc73b01d4866facde41e8c995d739fb0fdee6c3e8841b6245b5d12e3`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ac64b5ae480e1d943caeb30546b04576038320d5f7c5893a1862ab9982cdb99`  
		Last Modified: Thu, 14 Apr 2022 08:29:02 GMT  
		Size: 18.6 MB (18602846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e1ba91fe35eb5ae870a9571944662c96c9ac6d224fb6d7a5c42fec5f96b099`  
		Last Modified: Thu, 14 Apr 2022 08:28:48 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595cb6de14b7483b77f6f5b9476f8f5691cea13242b16426864192f78d44d325`  
		Last Modified: Thu, 14 Apr 2022 08:28:48 GMT  
...
```console
$ docker pull wordpress@sha256:25b1f9e25c2418f27cdabf371d5043304e066b4c6e7537cf1550a3dbaae09f7c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176343526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99187a12726208c2f6fb0994d6b7efa584652b9440fc7ff5a4b03f3e58874836`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 14 Apr 2022 18:12:51 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 14 Apr 2022 18:12:52 GMT
VOLUME [/var/www/html]
# Thu, 14 Apr 2022 18:12:53 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 14 Apr 2022 18:12:53 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 14 Apr 2022 18:12:53 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 14 Apr 2022 18:12:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1e89060447d3fed1c28d88fc38da5172f33655824f86353775f267b29826a687`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb42cfd40b801ab6a335f50f7be88818e9e23be5f664e17623d6739a51305aa7`  
		Last Modified: Thu, 14 Apr 2022 18:31:50 GMT  
		Size: 18.6 MB (18602837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:827a7644a0dfcbb0c5ba5c083bb6acec0a1c19a2d2700c91ec21fec34f67f62b`  
		Last Modified: Thu, 14 Apr 2022 18:31:36 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d17a81e4c6b68270d5806f73f86edc288268d4ef32f0bc0e0fde364fc1f31ff3`  
		Last Modified: Thu, 14 Apr 2022 18:31:36 GMT  
...
```console
$ docker pull wordpress@sha256:0e38177e0ad39777243737010f2047953e7a1ecced8e01186dbef6c46a847173
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.4 MB (210441532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a01c5ee1c9cd202a50cd50000add5c1afe568162a232f4255702ed9d1c7c30b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 14 Apr 2022 06:12:08 GMT
VOLUME [/var/www/html]
# Thu, 14 Apr 2022 06:12:10 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 14 Apr 2022 06:12:11 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 14 Apr 2022 06:12:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 14 Apr 2022 06:12:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b1c4252c4f7874282a35c368662ffb7fa31793fb86dbd245696782fa679d4f7f`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c547ccdede7e271b1c2f29e88af41efec7e4136b93e5550a904cc4568a2bccba`  
		Last Modified: Thu, 14 Apr 2022 06:22:05 GMT  
		Size: 18.6 MB (18606829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7ba31d447dbde0c2bb0252b362a1cf7f2a68ced222bf7e0dbf80682131455c0`  
		Last Modified: Thu, 14 Apr 2022 06:22:02 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8785cf23a4c5e7a36d9fd031bf29a5653e630d5da3c1fced39da63596147da13`  
		Last Modified: Thu, 14 Apr 2022 06:22:02 GMT  
...
```console
$ docker pull wordpress@sha256:6c2b82c39d8b8ef1a32f03ba5c84e2568691a149d5c53178a7d4c1355e4cdb03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.9 MB (183871713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cc12050a60cdd9f2bd698d5dbc78f43290854d743f6db6aa39b7e79877bd17c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 14 Apr 2022 16:29:22 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 14 Apr 2022 16:29:27 GMT
VOLUME [/var/www/html]
# Thu, 14 Apr 2022 16:29:31 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 14 Apr 2022 16:29:35 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 14 Apr 2022 16:29:40 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 14 Apr 2022 16:29:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4664a6f2cbd684299114c919f47a8d27491ad9fb2ad63822c3525378f3e1964c`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0636748bf5baea9493f0d17cc1148f9ef29b0c7756d8707f36c67b133ee4af41`  
		Last Modified: Thu, 14 Apr 2022 16:35:46 GMT  
		Size: 18.6 MB (18606862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85b0fed3fe1d70f31f687f728d1b0ce857a8df1ff39ac11894d265f13da8e4ee`  
		Last Modified: Thu, 14 Apr 2022 16:35:34 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9588a30419f6e79721b689f1eb66a1bc9202802cc0e800c94aaaa4e3b9cb87fe`  
		Last Modified: Thu, 14 Apr 2022 16:35:34 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d9bdf0171ead254065343b251b2f51aba6e74012bd7f502840c90a211b694239
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.4 MB (209364735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6118e9c1fed33fc591822ab124341cc8c32f245ae09767886cea62d86c8dd331`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 14 Apr 2022 10:34:50 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 14 Apr 2022 10:34:54 GMT
VOLUME [/var/www/html]
# Thu, 14 Apr 2022 10:34:55 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 14 Apr 2022 10:34:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 14 Apr 2022 10:34:58 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 14 Apr 2022 10:35:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bbf1d013944b4247068e9b67122ddb3df6bb6fc0bc80ede8c947f918436d698a`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184f15c3b1e4383b89d61725f9d473e33215b36e41c2c99e1e91c66437e7a9d4`  
		Last Modified: Thu, 14 Apr 2022 10:45:35 GMT  
		Size: 18.6 MB (18602824 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d95b8fb2eb4ab51f302d1fb3ad5ef309f4e1db5060b19dfc4effc5bd4e715be7`  
		Last Modified: Thu, 14 Apr 2022 10:45:32 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4df573229cd1b6541861ef873cce3d1faba328bb16acafbc5ba616eeab8b88bb`  
		Last Modified: Thu, 14 Apr 2022 10:45:31 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
