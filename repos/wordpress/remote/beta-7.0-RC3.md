...
```console
$ docker pull wordpress@sha256:b38e8bef513006e686e3f1e77e9b97e618eb7b9472230facbacfde74dc6bcfab
```
...
### `wordpress:beta-7.0-RC3` - linux; amd64
...
### `wordpress:beta-7.0-RC3` - unknown; unknown
...
### `wordpress:beta-7.0-RC3` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3` - linux; 386
...
### `wordpress:beta-7.0-RC3` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3` - linux; s390x
