...
```console
$ docker pull wordpress@sha256:bbc10044601546d698050ec00258d1339efced89b4e56b403c5c0f4ebd985087
```
...
```console
$ docker pull wordpress@sha256:5c0a118cdbb7eda73268f9f0cfae6621d92a313c8ea073adc01d1c562b6f5a90
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.6 MB (256550152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9c67deab1b25df1b7a4ee8d81f5aede6cffaecf553346ee6a72e1a657b8de6d`
...
-	Layers:
	...
	-	`sha256:1c17c9cb2588d0b151b0985a8dbb290626af5d77eb2d21156e9eef603ff7614d`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc603491c4504b0df5b3ba8108c6b3355b8af54c0557d20ad11d41b92529c47d`  
		Last Modified: Wed, 01 Nov 2023 21:16:20 GMT  
		Size: 27.0 MB (27047110 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88597d46ac75370ddd77823bb25202372676a8bbc0375f5e5c66c1f9de64927e`  
		Last Modified: Wed, 01 Nov 2023 21:16:17 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dd27fc2b7a0a88e77b1abc216873c1bf69ab484ae5a9bc7332dd72c33083a61`  
		Last Modified: Wed, 01 Nov 2023 21:16:17 GMT  
...
```console
$ docker pull wordpress@sha256:e47b0237ce048b8639a09dba5e23545a51e2d88d4dcc693a149b79de9dafc38f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.6 MB (215643841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7db50d6b7d3eff74f8c79895d15b99ffe471128ff578ae6c196b38043fbd2e0c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:dceb7615c3505d7b2b4bd458ac5bf318e1725972c0ac5e5a46b9678d07b92e99`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:943b70b31e9d5842133814c012afbda41de2ce7bf68262ae9fd35dddd3756372`  
		Last Modified: Wed, 01 Nov 2023 20:49:15 GMT  
		Size: 27.0 MB (27047107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c862820c6674534e5512f56bb9d12d6af5cf80ac8cfefe43a9b099aff1b0c89`  
		Last Modified: Wed, 01 Nov 2023 20:49:09 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:481d917327f981761f761c1b8a43d3833ebb77178906801a773a9a1f38e3f732`  
		Last Modified: Wed, 01 Nov 2023 20:49:09 GMT  
...
```console
$ docker pull wordpress@sha256:f31b7f89fd4f29d5ef3fff7319423705d4f364ec711e89bb47eb2a1781eabfb9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.9 MB (247859093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88ecba506600ae4777cc6843bbe1a1a598886508243bcc0687231f169fd4ee78`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 01 Nov 2023 19:32:01 GMT
RUN set -eux; 	version='6.4-RC2'; 	sha1='2861ce299c6b64f09042a06a9e8cae96ba5451f6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 01 Nov 2023 19:32:02 GMT
VOLUME [/var/www/html]
# Wed, 01 Nov 2023 19:32:02 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 01 Nov 2023 19:32:02 GMT
...
-	Layers:
	...
	-	`sha256:c38fd7b518e9937ad13b326317a2a7cf1ad8f7f046562e54763854fdd5cf8ab0`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc0c0e36d2960418ef574a2d24a3efe4fac9fc4d1dee58df13921ea659c16999`  
		Last Modified: Wed, 01 Nov 2023 19:39:27 GMT  
		Size: 27.0 MB (27047105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:891f5555437a49790c47a46fa9e33115fae6d265362580b5f3474cdf93332881`  
		Last Modified: Wed, 01 Nov 2023 19:39:24 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25793482975603f29d552ab40b90c06e3d41613fbc8f12adf3fe71bb0a56873f`  
		Last Modified: Wed, 01 Nov 2023 19:39:24 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:67e0cd28113ef358e6945bd960bb5b342470f4286f1b308a0134c7ad43aaeef3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.1 MB (255071013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9809bb02046dce663251c3ba89b0849fe701990794c858dba1d415a9e9ef2006`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 17:20:51 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libicu-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 01 Nov 2023 17:20:52 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:20:53 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 01 Nov 2023 17:25:58 GMT
RUN set -eux; 	version='6.4-RC2'; 	sha1='2861ce299c6b64f09042a06a9e8cae96ba5451f6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 01 Nov 2023 17:25:58 GMT
VOLUME [/var/www/html]
...
-	Layers:
	...
	-	`sha256:c9da030efe1067c6342d756b633290c3cb0222ac88c68b4447f9fc4f91b57c2d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfdf7d8be552c7af81c3514f5750607d7eb4103d86cd73c80365f8245d4d9279`  
		Last Modified: Wed, 01 Nov 2023 17:30:09 GMT  
		Size: 26.8 MB (26837190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60244335eba39f7157b52e1566efffcb369c374dacc8fb810e866dc04c12fe3`  
		Last Modified: Wed, 01 Nov 2023 17:30:10 GMT  
		Size: 29.2 MB (29232211 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917ea6f3647b67d5f0f751a738ad7822beaee32a2e20323594881b93930c18da`  
		Last Modified: Wed, 01 Nov 2023 17:30:00 GMT  
		Size: 364.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:963873359c093dd39901e4b6f7f7e426d620c008cac3867b4f8a23ac75e5e177`  
		Last Modified: Wed, 01 Nov 2023 17:30:00 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e961bd824d696e5dbe49b06276d677a6cae7f4ddd8d8f555b7194b5c2d83e45`  
		Last Modified: Wed, 01 Nov 2023 17:33:59 GMT  
		Size: 27.0 MB (27047111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a264cadf3392e71170cde7e92916a883f217b5068418851d1d7baa9a8b331f7`  
		Last Modified: Wed, 01 Nov 2023 17:33:54 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e24087517c078d4d9f1999f43cdc86af7b40292c1d97993c1ab3018e81a26008`  
		Last Modified: Wed, 01 Nov 2023 17:33:54 GMT  
...
```console
$ docker pull wordpress@sha256:4ad60fa13b242301d6813181eefbe425ee38733ac7c35530648321a5e8b54a05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.3 MB (228270268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d01e4fc7058fc8a34480b9ab0fc5aacc8c95585de0ee40c42e3783406ff53c3e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Nov 2023 00:00:01 GMT
RUN set -eux; 	version='6.4-RC2'; 	sha1='2861ce299c6b64f09042a06a9e8cae96ba5451f6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 02 Nov 2023 00:00:06 GMT
VOLUME [/var/www/html]
# Thu, 02 Nov 2023 00:00:10 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 02 Nov 2023 00:00:14 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 02 Nov 2023 00:00:19 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 02 Nov 2023 00:00:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:74a310ce64acf0b41e3c06d182c260f67ab300bcdf25a38254b2579706c38449`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f915ed99cb0020075ca606a3f3f2b39d0032d749709892341de908f2b807374c`  
		Last Modified: Thu, 02 Nov 2023 00:12:03 GMT  
		Size: 27.0 MB (27045014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9d54ee2312f539ee1213caae00dbc40d2e43ef79b28c2edb7e6b1565ec5a763`  
		Last Modified: Thu, 02 Nov 2023 00:11:48 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82be21a2de41953c6a327793a148b68ebc2aca06bd1703b3c5662c6eeb9f1c75`  
		Last Modified: Thu, 02 Nov 2023 00:11:48 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a71089b0c9a802bc77a4787c01cc193baf80b289d5f104d10f6235eba05e224f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.7 MB (261658713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccb12ccd2a880114875f4190b3072dfc47e4c8059465a68b2af430ea97e978f2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Nov 2023 00:04:41 GMT
RUN set -eux; 	version='6.4-RC2'; 	sha1='2861ce299c6b64f09042a06a9e8cae96ba5451f6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 02 Nov 2023 00:04:44 GMT
VOLUME [/var/www/html]
# Thu, 02 Nov 2023 00:04:44 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 02 Nov 2023 00:04:44 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 02 Nov 2023 00:04:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 02 Nov 2023 00:04:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:191afd8f2eb5a8df65638c881249d5369b296295d7c9d7cd2d14c5b26cf69e24`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:005d13b148fbaecc607ea4b9cf46d73d93afed6331dad0fbf353a0b9f3bc6cd3`  
		Last Modified: Thu, 02 Nov 2023 00:12:45 GMT  
		Size: 27.0 MB (27047101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b12b95fb7a197437d6cefae45d457895a3eab31e20ae5d5d7eb87316dbbc9b00`  
		Last Modified: Thu, 02 Nov 2023 00:12:41 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d409a196c8f1b41f48e1e770caf4d7f0e4c31f99c35e5a6ec4017afe92641e56`  
		Last Modified: Thu, 02 Nov 2023 00:12:41 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
