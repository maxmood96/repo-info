...
```console
$ docker pull wordpress@sha256:76550b48d1207c2e64337a5e0e5d8066d663fa3418dd21dd60ea7973f9886b6d
```
...
### `wordpress:5.9.3-fpm-alpine` - linux; amd64
...
### `wordpress:5.9.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.9.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.9.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.9.3-fpm-alpine` - linux; 386
...
### `wordpress:5.9.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:5.9.3-fpm-alpine` - linux; s390x
