...
```console
$ docker pull wordpress@sha256:f5b7c482762f3a2ab400f0678971c9004fa0c7c9c51201eff96c20ca84a81833
```
...
### `wordpress:6.5.5-php8.1-apache` - linux; arm variant v5
...
### `wordpress:6.5.5-php8.1-apache` - unknown; unknown
...
### `wordpress:6.5.5-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:6.5.5-php8.1-apache` - linux; 386
...
### `wordpress:6.5.5-php8.1-apache` - linux; mips64le
...
### `wordpress:6.5.5-php8.1-apache` - linux; ppc64le
...
### `wordpress:6.5.5-php8.1-apache` - linux; s390x
