## `wordpress:beta-6.3-beta2-fpm-alpine`

```console
$ docker pull wordpress@sha256:b83eddb2aad3f9b05440232fc70b5a3d55435442dcad68e0bd7be9b403ee90f0
```
...
### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; amd64

```console
$ docker pull wordpress@sha256:08b8eb6e469703ba0bf3c10936eb9c0b74c3998bc0820471088a81c33d79357a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.7 MB (102700191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28ea3834b063283940381320bc280df4d84dabd623af2b3ff9d4b98993619a2f`
...
-	Layers:
	...
	-	`sha256:29b584b2dbe5deea00333f618434b017cb77447c76f97af24c66a92346fce47a`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbd52ddbe70c7f578b8d9ff5c0f2e4d509dbe831b0f245d7227a5dba0f79f7c5`  
		Last Modified: Fri, 30 Jun 2023 23:40:35 GMT  
		Size: 23.2 MB (23232007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06f9f13f54e4ec768bc709de7c490295abdabbbcb4edce65f4ddf2ea791a7a57`  
		Last Modified: Fri, 30 Jun 2023 23:40:32 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59420f14fbb8f74461c6a8f9626d5388ac43b54434b09e79c94ab00aaf5cdb70`  
		Last Modified: Fri, 30 Jun 2023 23:40:32 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; arm variant v6

```console
$ docker pull wordpress@sha256:079422c52981a7f03ad458f53188f3c172e51a091323a5e141e7f0d06c671a5a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.7 MB (96727592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1357878c8e42d3551198d71ad054d0cb2e441afc75703a6b3133a90a128fd8b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Jun 2023 22:58:32 GMT
RUN set -eux; 	version='6.3-beta2'; 	sha1='316eb10ef2e80c76c0ed68ebc0b328fe97192d8d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 30 Jun 2023 22:58:33 GMT
VOLUME [/var/www/html]
# Fri, 30 Jun 2023 22:58:33 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 30 Jun 2023 22:58:33 GMT
...
-	Layers:
	...
	-	`sha256:6ab04a0cf507388948902231d53bf00daceaecd4df52da4c24713a024654fc2d`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08868f48c003b485df36a3ede89912aa4b0fdbe2fd3d030c098d60b3bc67288b`  
		Last Modified: Fri, 30 Jun 2023 22:59:36 GMT  
		Size: 23.2 MB (23232008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aeef4db1d85513ba26ddbbb935f8e2b4bf692211262483cf0691090e50dad6a`  
		Last Modified: Fri, 30 Jun 2023 22:59:32 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d0125bb19d7134a1cb168ed114fce4db046065d44712af0b1ac9c3645c966d4`  
		Last Modified: Fri, 30 Jun 2023 22:59:32 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:293b04de87451f5955f305416f09bbbf17c87e612ae666a391cab73bb98ffe84
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.5 MB (93532457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c668737b59000e4f9639ad8fe9713a3dee21222bcd884f58283f571a58206084`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 09:51:33 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Jun 2023 23:26:16 GMT
RUN set -eux; 	version='6.3-beta2'; 	sha1='316eb10ef2e80c76c0ed68ebc0b328fe97192d8d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 30 Jun 2023 23:26:16 GMT
VOLUME [/var/www/html]
# Fri, 30 Jun 2023 23:26:16 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 30 Jun 2023 23:26:17 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 30 Jun 2023 23:26:17 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Jun 2023 23:26:17 GMT
...
-	Layers:
	...
	-	`sha256:b7547b1249d64683371ac7d169a8db208dd4aae2976762da5745657061d9b2c1`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53273ee146a25379be42231d378314053e726afdd13a16df3373137574983afc`  
		Last Modified: Fri, 30 Jun 2023 23:30:11 GMT  
		Size: 23.2 MB (23231987 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23427e02db77bf2ccab9824e25eaa84eda85b906f54fcd484a79ef9ed7893965`  
		Last Modified: Fri, 30 Jun 2023 23:30:07 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61e98f6d599595646c7446bd5fc7db63476b81ff0a68eb385df26c56ac1b99ba`  
		Last Modified: Fri, 30 Jun 2023 23:30:07 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:54abb3004db0cde918c7e64baf4b43f531356d1a3412d93233fd4a8bd0ccfbaa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100455254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6383100f757ce5890a36919f12b2017d33307b96338aabad968d03b9960cb7f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 01 Jul 2023 00:18:03 GMT
RUN set -eux; 	version='6.3-beta2'; 	sha1='316eb10ef2e80c76c0ed68ebc0b328fe97192d8d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 01 Jul 2023 00:18:04 GMT
VOLUME [/var/www/html]
# Sat, 01 Jul 2023 00:18:04 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 01 Jul 2023 00:18:04 GMT
...
-	Layers:
	...
	-	`sha256:215e71e4e181e25df6417d2a43405040c823d608e5c6f3aa460ca38bef24651a`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f486151046e33c2084fc746e7b592384144930c168d34371f1b1cfdbcc46294e`  
		Last Modified: Sat, 01 Jul 2023 00:21:56 GMT  
		Size: 23.2 MB (23232003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08a15f36e51a0a95d941c1c188d6f5b514fd40ba316c086e6f8bca364e05d6b4`  
		Last Modified: Sat, 01 Jul 2023 00:21:53 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2516d37392942eb7a6aa0e475f274c958ae6276469aee299e0526fd97bbdde58`  
		Last Modified: Sat, 01 Jul 2023 00:21:53 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:968bcdad22135322e53555cc2b8489fd7652d6222c6c0caf2bcb476ed72302a6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.9 MB (101878127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9c328c328ab428f83b4a89fb0a216c7bd36ab09b53205e996fad06a10c3f2bd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:8094b1f425e810c7964725cc7d71613fc22c722e64657762ea8edbd55798de88`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4497fa6080d85d2c02846986b8791e41ec6912cfeb64b96e677e3b8aef23d2c`  
		Last Modified: Fri, 30 Jun 2023 23:43:03 GMT  
		Size: 23.2 MB (23232005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:218858049168c28885ab5edfee50dc530d785b073c4bc31c51917e62695d55d3`  
		Last Modified: Fri, 30 Jun 2023 23:42:58 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d57c2f1384578a7c21321ad9af2af6ca950119714d1a57383ca4d2c8779790b5`  
		Last Modified: Fri, 30 Jun 2023 23:42:58 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; ppc64le

```console
$ docker pull wordpress@sha256:8720a34b5e74ceaded0c14f1839087544e5348d609dbf3d487b44ab02699b906
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.5 MB (108466396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71bdc13697c7a50c16b9917ad91465a36e46568057d6706f5ce841afac0c51ed`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Jun 2023 23:45:29 GMT
RUN set -eux; 	version='6.3-beta2'; 	sha1='316eb10ef2e80c76c0ed68ebc0b328fe97192d8d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 30 Jun 2023 23:45:31 GMT
VOLUME [/var/www/html]
# Fri, 30 Jun 2023 23:45:31 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 30 Jun 2023 23:45:31 GMT
...
-	Layers:
	...
	-	`sha256:063ba6ffe5e07dc4c6785868f7831a156b03658edf1e3a500bb6c76c1d6c1ced`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dd0abe742a76dd584c384b506728eea69bdf5abdd172d5bfa43d8af22fa8660`  
		Last Modified: Fri, 30 Jun 2023 23:52:55 GMT  
		Size: 23.2 MB (23231984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f53e09657c7f1f73d3927dd1321fc9fe761243698683f97031ca153c7b27360`  
		Last Modified: Fri, 30 Jun 2023 23:52:50 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d92f4bff66fddef803f17ef5145f81cfb7a6a5962a16d0b89c3c0789d1958c27`  
		Last Modified: Fri, 30 Jun 2023 23:52:50 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3-beta2-fpm-alpine` - linux; s390x

```console
$ docker pull wordpress@sha256:25b654e95a86dad260ea3bf56b9c2ee1a8fc8341e1f496ae1e80ef026e3d3700
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.1 MB (92144294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff4cc029ddb36a52b8caeda40577a801421ce13309eaf4c8bca7a89816447deb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Jun 2023 23:50:43 GMT
RUN set -eux; 	version='6.3-beta2'; 	sha1='316eb10ef2e80c76c0ed68ebc0b328fe97192d8d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 30 Jun 2023 23:50:44 GMT
VOLUME [/var/www/html]
# Fri, 30 Jun 2023 23:50:44 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 30 Jun 2023 23:50:44 GMT
...
-	Layers:
	...
	-	`sha256:14a1a7f31870f68ad4bb3b7cbf4365ec7276c126899b390eb5bde2033a433962`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9018a5b8f27ad22b0f897d340c75e303fe2caf235d41a7ec9cfbea249c22c8e`  
		Last Modified: Fri, 30 Jun 2023 23:54:25 GMT  
		Size: 23.2 MB (23231989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8a7000eb2d91377163fcea57a66195df3854d97a8d84bf0e0ffa273ad42b7c3`  
		Last Modified: Fri, 30 Jun 2023 23:54:22 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:492ff4a4071cf9fe7d9a5b71898891dc248c6654118d8999a23b9cf44dd9bd5d`  
		Last Modified: Fri, 30 Jun 2023 23:54:21 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
