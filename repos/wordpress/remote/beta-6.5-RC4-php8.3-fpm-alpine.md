...
```console
$ docker pull wordpress@sha256:052be4b4a27e4dccb09b9d4ee156a318ba3c606b55dc2747ec51e6657bd4c1b6
```
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC4-php8.3-fpm-alpine` - linux; s390x
