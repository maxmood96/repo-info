...
```console
$ docker pull wordpress@sha256:9c2ae97143b80dcfc147684ad0b17934fbe6dd7c6e65962304f3e0298a3009d6
```
...
```console
$ docker pull wordpress@sha256:6c374aac5ee0ba82d0b4dc1333bb6fdff8cef7b17ef9c559b55106122af021c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.2 MB (208166588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:099a96a4f657f36682d528ac177f22f8c07615a5aa00246c3f984e04d56f52f7`
...
-	Layers:
	...
	-	`sha256:10b5d8c5996f7901996a1c7900276157009644a0dfab4fb1a48f20f5ff1cb980`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d2587598493f3085bc78d5136d30f805ad0d549e083ebd70423d45ee6729fa4`  
		Last Modified: Thu, 12 May 2022 04:11:19 GMT  
		Size: 18.6 MB (18553306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae6b551d7e6315663bd8d7c4b951bd3fba5e4383813708b177f53775f3101671`  
		Last Modified: Thu, 12 May 2022 04:11:16 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e844301a5ce778f5a687370e6119193213446a49edb409146fc135fe2db60e7`  
		Last Modified: Thu, 12 May 2022 04:11:16 GMT  
...
```console
$ docker pull wordpress@sha256:63f0b7e8035f14a3f0abeacd663ed6b3dc00036667552bf5548652beed437c68
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184613787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9a7c36c830835a0b661faa788557ee55297cc2f8aa80f05fdf59743a0802593`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 12 May 2022 01:47:12 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 12 May 2022 01:47:13 GMT
VOLUME [/var/www/html]
# Thu, 12 May 2022 01:47:14 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 12 May 2022 01:47:14 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 12 May 2022 01:47:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 12 May 2022 01:47:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:abc36adc5a59fd1292fdbe422f4fbb3b61e8da8fc4ce200f36f4b8b0020b6a36`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cddd878a29d59a98b52e0590e2bb934919cd5afcf6cc5bc4adc9d619d24becd6`  
		Last Modified: Thu, 12 May 2022 02:17:48 GMT  
		Size: 18.6 MB (18553309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:782ed06865918672c49a52420429f3d3f1aa87f4c72a4c43af7b995b74186e50`  
		Last Modified: Thu, 12 May 2022 02:17:34 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8bfdf749cb8b6585cf4e4a94cdd9cd1ec20a33a5ce6c661c9f830d83a8566cc`  
		Last Modified: Thu, 12 May 2022 02:17:34 GMT  
...
```console
$ docker pull wordpress@sha256:0f9136df062efedb2f4deeade3e6871e9e81517cb195d313a34633be9893158f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175727041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83ed67de8034e7dcc8593bd02abe4aeff19b0ebc8e09410b593832b28eaaf7c9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 12 May 2022 12:58:06 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 12 May 2022 12:58:06 GMT
VOLUME [/var/www/html]
# Thu, 12 May 2022 12:58:07 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 12 May 2022 12:58:07 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 12 May 2022 12:58:08 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 12 May 2022 12:58:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bd52c769eec2bf243d886129c1ae63db83316648c18f104999c4f60b24da4426`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f67ce159c27be8967757c79cee073074e1ff8839e58d60ff957df66f8e1d767a`  
		Last Modified: Thu, 12 May 2022 13:32:28 GMT  
		Size: 18.6 MB (18553326 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51f2e542bb137f8a9ddf79df63228c332cb438945fbe7044ceaf0c4040d37964`  
		Last Modified: Thu, 12 May 2022 13:32:14 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d19f2ce9366a62c106d3cc89630c1f35e9f1c28d337254f5a2bd2726aec4a90`  
		Last Modified: Thu, 12 May 2022 13:32:14 GMT  
...
```console
$ docker pull wordpress@sha256:b53414eb14501876ef0cb5d8f6adb5c49f51be6c5c6aaf78d5b7767583f73c76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.0 MB (198982335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:640cf424d648c4714f16a298a8b0322ba8d3676b3e59df4f3161321145ed223f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 May 2022 23:32:46 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 11 May 2022 23:32:46 GMT
VOLUME [/var/www/html]
# Wed, 11 May 2022 23:32:48 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 11 May 2022 23:32:49 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 11 May 2022 23:32:49 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 11 May 2022 23:32:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:86891ac30129bf86ff7bdb23e70e5f311885940106a1150269a22e402be31e3f`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:439385a0cb6b47505d5c892871d49177ef9bcda47f7b3d598b6cdfd04af42a39`  
		Last Modified: Wed, 11 May 2022 23:47:49 GMT  
		Size: 18.6 MB (18553776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fb296dd203c203788184bb1a4cab5e2cf1a8c0275590ed27979870932afdacb`  
		Last Modified: Wed, 11 May 2022 23:47:46 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ae25cca0fd277dee2e0190f79c132f1eb3f31e73a5b92a68ebc6c0e8aa9751c`  
		Last Modified: Wed, 11 May 2022 23:47:46 GMT  
...
```console
$ docker pull wordpress@sha256:a2edd8bd0b4f9ee5bc1019cd9b648f2c769e966cc94c6d4c04101d509288f73d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.5 MB (209500415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b64bf5e1b8e845089a28a38ad51402a4e846c9c378d01f9cf5e1c3194c4e17a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 May 2022 18:01:53 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 11 May 2022 18:01:53 GMT
VOLUME [/var/www/html]
# Wed, 11 May 2022 18:01:55 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 11 May 2022 18:01:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 11 May 2022 18:01:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 11 May 2022 18:01:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a554659c837798ea99b8b08cf83d81051c789d41389e27299954c84392da5a51`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10f273e1601e9d29cbc898eebc8075c1b07bf9908c4ddab11ec4be67e2885c1e`  
		Last Modified: Wed, 11 May 2022 18:17:37 GMT  
		Size: 18.6 MB (18553794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5492137e5809303ff6502cefda32ba04ee85be5a6f899d637b27d49b291f4ee`  
		Last Modified: Wed, 11 May 2022 18:17:34 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0de2c3e203dfe6e7241d0bbdcec9102675ec26d26b5dbc0a1072af288da8ae78`  
		Last Modified: Wed, 11 May 2022 18:17:34 GMT  
...
```console
$ docker pull wordpress@sha256:bee9a6b00264b0ab5e9fe7fc2e4aaa30df5ae6120d4c8a8b0f96c6fc050d6eaa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183240912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:693860c6a7218af87b21b4b8895bdcda122ca4bebac01c5eae05cf028d217360`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 13 May 2022 05:37:23 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 13 May 2022 05:37:28 GMT
VOLUME [/var/www/html]
# Fri, 13 May 2022 05:37:31 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 13 May 2022 05:37:35 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 13 May 2022 05:37:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 13 May 2022 05:37:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:43046e51b0009c799fe4bc7ceed1c51ac0629a3dabdeed072d7ca00ae634f5ab`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cd503ef42970f4d307038d8c5c1fba7fe602297a866ca5e3aa5ae24f9a209cf`  
		Last Modified: Fri, 13 May 2022 06:23:55 GMT  
		Size: 18.6 MB (18553796 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae8aa9feac49ff356f938b9fb635e768d4c431a8153d2f1927fe83977ea1bf0b`  
		Last Modified: Fri, 13 May 2022 06:23:42 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a7a1fb00d861f453cea588135480d1d7954103d30e159332e7f29f7e20fa56`  
		Last Modified: Fri, 13 May 2022 06:23:42 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:f4b9df2c5331652fec4dff65f08dde4c5998cb64406c626dd4fb403a80954354
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.7 MB (208722320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:713964d7f3b9ee8d505c8c9848228b629f9ad3a20e95cadf717756906c796e20`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 12 May 2022 20:02:23 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 12 May 2022 20:02:32 GMT
VOLUME [/var/www/html]
# Thu, 12 May 2022 20:02:36 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 12 May 2022 20:02:40 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 12 May 2022 20:02:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 12 May 2022 20:02:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b56041a73feeb6c542a74b88641a72de9973166fe986035f4d4148f2e38dfbc6`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a454fd63dcbe346229cd7bc3582066dba5d6eccf32590e60afb6c93318905c56`  
		Last Modified: Thu, 12 May 2022 21:09:30 GMT  
		Size: 18.6 MB (18553309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa981ad28a788f3c54c2fb93234e3c998b48207f60d8f38afd4231c833a8678f`  
		Last Modified: Thu, 12 May 2022 21:09:25 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b2c12c7242298fc05cd414fa327e6541cdb55668e981269b629f072bfe56115`  
		Last Modified: Thu, 12 May 2022 21:09:26 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:29955983c4f72d72f6a123000c0797cfb2d070b0f7ce8d80621a37ee987313a7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.8 MB (183782038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24ca827740b6053b51006df6e6accaee4acf6bcd5305913e65ed30c53d7b79e8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 11 May 2022 19:20:53 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 11 May 2022 19:20:55 GMT
RUN set -eux; 	version='5.9.3'; 	sha1='cab576e112c45806c474b3cbe0d1263a2a879adf'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 11 May 2022 19:20:56 GMT
VOLUME [/var/www/html]
# Wed, 11 May 2022 19:20:57 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 11 May 2022 19:20:57 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 11 May 2022 19:20:57 GMT
...
-	Layers:
	...
	-	`sha256:0463eb872c50dbbb28fbc5bbc283c46fee128fc70d0fd8f76482ab5b3e3a8a26`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c88fd4b8392da6fa26347ed6f90443da6364dce831565a6afb598de526ef3c98`  
		Last Modified: Wed, 11 May 2022 19:37:38 GMT  
		Size: 18.6 MB (18553323 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e66c91068e2a13ac6e427eb2af9e4e1bbda89c4a53bcaed4552dacfe2b516cf8`  
		Last Modified: Wed, 11 May 2022 19:37:36 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5bfb7049f0d883e1d251742bca596534dc323d4220779ea4f56a58102021349`  
		Last Modified: Wed, 11 May 2022 19:37:36 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
