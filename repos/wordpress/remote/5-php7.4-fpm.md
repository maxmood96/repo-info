...
```console
$ docker pull wordpress@sha256:ed53b5b70349b1835ef61366452e7f341957ae4934d54109230646bc530cc66c
```
...
```console
$ docker pull wordpress@sha256:cd8e37cfe64312bf08fbca201b79e6e5ef6880950eac544efc4bc184146c5726
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181884075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90e480da85d0d1b0aa15b501a7aaeabf6aef5e052e7f75313f1dc6d1200d528d`
...
# Tue, 27 Oct 2020 01:17:06 GMT
CMD ["php-fpm"]
# Tue, 27 Oct 2020 04:14:26 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 04:15:37 GMT
...
# Tue, 27 Oct 2020 04:15:38 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 04:15:39 GMT
...
-	Layers:
	...
	-	`sha256:3680ef4ceb8f7e3b847e4422b7b49ae67062a6ca31c95f844ea4772529ddacc0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65cf3840f474ec3f9d15dfaac721f38d4c1963fcd11d4a8708cc8313e9e7f5e9`  
		Last Modified: Tue, 27 Oct 2020 04:22:39 GMT  
		Size: 16.8 MB (16848739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:663babdadfa84bba0e4996ba542f3b72c24d3cbcd2fd4c779bc06859dc11633c`  
		Last Modified: Tue, 27 Oct 2020 04:22:35 GMT  
		Size: 9.3 MB (9261530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c1c21a3e7cc7efd19db2729144b9aa150543d92a4714bc4bb216f4e68041890`  
		Last Modified: Tue, 27 Oct 2020 04:22:33 GMT  
		Size: 380.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:182954769eb12467cef341aa67a555c97e496f4493bc164f1dd24cb5cdd9a751`  
		Last Modified: Tue, 27 Oct 2020 04:22:33 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df036c59bf386abc058b15e0a7c644d10476e17fc9188f8d228f85464165f16c`  
		Last Modified: Tue, 27 Oct 2020 04:22:37 GMT  
		Size: 12.8 MB (12846251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d981fcb0912251a721884db080626393a5edaef710976589e28f6f1269d2f3ca`  
		Last Modified: Tue, 27 Oct 2020 04:22:32 GMT  
...
```console
$ docker pull wordpress@sha256:bb9df0ee74a3a4d310dcc1594c09cc9eae371d32dc2fa93a51c31fa5ad5b14ee
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158826654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acc2fcec2137ed573b3905ef51f378bc78c656ad87529cb9e68fd5dbc68e16a7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 03:22:33 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:25:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:25:42 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 03:25:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 03:25:45 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 03:25:45 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 03:25:50 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 03:25:51 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 03:25:53 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 03:25:54 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 03:25:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0714333872691c75db07b545d87641654c0271097e8a3c4fcf1459564e367321`  
		...
		Size: 8.5 KB (8456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fff3f574551cec1873f744015319db43e0c24f15abd5ccec2c0b24e25009a7c`  
		Last Modified: Tue, 27 Oct 2020 03:29:04 GMT  
		Size: 16.4 MB (16404406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17b2ac421fad13bd1d57e7b5cad675b8020f503f1bf8d08598424000c5f6ac6f`  
		Last Modified: Tue, 27 Oct 2020 03:29:10 GMT  
		Size: 8.1 MB (8137861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:884e1eb8c732b0f7b271b0381d26ae481d362ca1835e3eaac42cf6d9cc773d2c`  
		Last Modified: Tue, 27 Oct 2020 03:28:56 GMT  
		Size: 380.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5fa9449cb48bd81589dd80be6a6d956a24443c7d7d842f7170f70a778c67803`  
		Last Modified: Tue, 27 Oct 2020 03:28:56 GMT  
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4c3407e60eb47e8479d97be4c2395c3e82b57dc15034a1dd5a0fdd91b07acd5`  
		Last Modified: Tue, 27 Oct 2020 03:29:02 GMT  
		Size: 12.8 MB (12846319 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3705e24885d4d383d3b2aa870120b2340dcd64107d4fb769298509c5bd4abb34`  
		Last Modified: Tue, 27 Oct 2020 03:28:55 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:79aedeb0ca752b6c22211259620c5c7d70d84d9ce07ad790e4459ac1584e1514
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155127058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d6b35b441d4316a21ddd6bf98505051bf019548c77a0b073ebc92b4552cce05`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 04:26:10 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 04:28:51 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 04:28:54 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 04:28:55 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 04:28:56 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 04:28:57 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 04:29:02 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 04:29:04 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 04:29:04 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 04:29:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 04:29:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5b50e0119effe4c2848897696ae9989586c8fa3ecd8504d80dd59923e1b43207`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3cd017707a8eb487592a33a328c75ecf2127b4b2af83e2a59494f2c63df26f2`  
		Last Modified: Tue, 27 Oct 2020 04:39:56 GMT  
		Size: 16.0 MB (15955406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa00dfb558fdab84305e8bd7abe0cd1f33439f0dd00a71fb83d5b0fde295b8ad`  
		Last Modified: Tue, 27 Oct 2020 04:39:50 GMT  
		Size: 7.3 MB (7307956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:494980a97779495a0ce37432c655633f30baeeda48e4237ae5cc7a09a23413b6`  
		Last Modified: Tue, 27 Oct 2020 04:39:47 GMT  
		Size: 379.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58a7bacea155845dbe65dc2e78cd1457ba3dfff922d8c24465098fdb9cb93192`  
		Last Modified: Tue, 27 Oct 2020 04:39:49 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25661ca4f79f890cf9f0eb68aa90618ba0c51602232e1e99eab7db199d48dabc`  
		Last Modified: Tue, 27 Oct 2020 04:39:54 GMT  
		Size: 12.8 MB (12846318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9082286eb241d04218c69e39e7b22fb0f9627256726ac828681ce7080c5cb86`  
		Last Modified: Tue, 27 Oct 2020 04:39:48 GMT  
...
```console
$ docker pull wordpress@sha256:cdc479034e625102d5b729dcb22464bc2c853f5d92e9bceec7e82f4f0a77614e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172440903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d701cd21e30201b0c3c4446af58a8a12f3b1da211829e5d2ba4d9a02db242d6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 05:39:38 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 05:42:00 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 05:42:02 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 05:42:05 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 05:42:05 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 05:42:06 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 05:42:10 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 05:42:11 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 05:42:11 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 05:42:12 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 05:42:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:38bba6be9090ca26f48fe85c8a9662b593e1cf50643ba4464bbf70aaaad3c757`  
		...
		Size: 8.5 KB (8455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd07c5b56c2e137a53e1f73bee33847c32a6caa52869b3c38e7d01a567ea1a7f`  
		Last Modified: Tue, 27 Oct 2020 05:52:04 GMT  
		Size: 16.8 MB (16782729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:154a609dcdd712bade64daecd5f4e267548119a8b3a45b533a0a2a9332de1751`  
		Last Modified: Tue, 27 Oct 2020 05:51:58 GMT  
		Size: 7.7 MB (7677664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:915db7dd4ac3f5b1b5e014eb9829f9982427ba19edb04ce5c5950ec927d5cc65`  
		Last Modified: Tue, 27 Oct 2020 05:51:56 GMT  
		Size: 380.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48fae22ab80bc8c625983fcadd50b8c9ce1f3c74a3ddc11df6a06c22f742875e`  
		Last Modified: Tue, 27 Oct 2020 05:51:56 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bb1ce8c413973a766078442ffd2220d6bb628e95a229bec0dae0dccf173710d`  
		Last Modified: Tue, 27 Oct 2020 05:52:00 GMT  
		Size: 12.8 MB (12846305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a331a2727989a1b531c4b5d916090abedf9010d629c66ff104ca713ec7824377`  
		Last Modified: Tue, 27 Oct 2020 05:51:56 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a5ac5986ad6e5da17646cd2aaece8186204fa04faabef16b9c3326948218b090
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.3 MB (187251994 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bbdf02a5ed12df5f0c02ebd9fab32fb68079c02ad75ad460e5ce10d8768dc32`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 03:50:52 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:52:21 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:52:22 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 03:52:23 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 03:52:23 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 03:52:24 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 03:52:35 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 03:52:35 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 03:52:35 GMT
...
-	Layers:
	...
	-	`sha256:3a450314a4ba46608969f8eb9b2c199733e724d834c828db15f32807dcb3ec63`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:508e6cbf33120c4bb5298af7cea6fd66109095c294208ac07c6f04cd44e7a72d`  
		Last Modified: Tue, 27 Oct 2020 04:01:20 GMT  
		Size: 17.2 MB (17164613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6722d2e3b03e26532582206cfded29c20c90c2a85587379b159b5818fd12decb`  
		Last Modified: Tue, 27 Oct 2020 04:01:15 GMT  
		Size: 8.5 MB (8532883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:922990319dbad83240f3093ceffc405c275ab1afd40ee7813f982e6aaae78cab`  
		Last Modified: Tue, 27 Oct 2020 04:01:10 GMT  
		Size: 380.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34768946b724685d8f1b0429d02d401c2ab6088af52bc829de7564ecf32aaf3c`  
		Last Modified: Tue, 27 Oct 2020 04:01:10 GMT  
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:332653c416c05a4eda4ca2fb63671ac97fa1b7540a33a0178a13c862d4b45c71`  
		Last Modified: Tue, 27 Oct 2020 04:01:18 GMT  
		Size: 12.8 MB (12846253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d680e162445df54abca24c59b4fcdaf0f8d7d246625b08d55794494a29584393`  
		Last Modified: Tue, 27 Oct 2020 04:01:10 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a40d8223abc4d423d14448cc0bec9c83a7ec4b9fba0ac69885f85ecdb9527106
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162939517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0958b10a8b5d0ad0ab6a95719ef0f44c9c05539d8fc308a63418ba79288d4185`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 03:04:32 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:07:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:07:50 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 03:07:52 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 03:07:53 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 03:07:53 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 03:08:00 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 03:08:01 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 03:08:01 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 03:08:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 03:08:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d00f8b251954dc070a2b8218d1e1e4eb38cc6e9f587108d8af81b50dc0fa2336`  
		...
		Size: 8.5 KB (8456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d5dd5df6048c610a22b0f7de2832e3ba76530e52e7afddda35da5e9c7f99309`  
		Last Modified: Tue, 27 Oct 2020 03:12:19 GMT  
		Size: 16.7 MB (16675063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ca2d41172f6e41ee07208ac36a3ba29627bef79077b39fb8eb672ca62c81954`  
		Last Modified: Tue, 27 Oct 2020 03:12:09 GMT  
		Size: 7.7 MB (7717351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c48c254abaa99f7e2839d341edf65b4970964f9279fc2ca48700d54901c7672`  
		Last Modified: Tue, 27 Oct 2020 03:12:02 GMT  
		Size: 379.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ee271557ac354bec0e6e59a77729c983223779a6484c984a695f5f728883ea6`  
		Last Modified: Tue, 27 Oct 2020 03:12:02 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c99147db234cd25cbf3c7b5df2214be293255470d8393adf4beef229a4e60ed`  
		Last Modified: Tue, 27 Oct 2020 03:12:14 GMT  
		Size: 12.8 MB (12846266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e02506d7cde2157ee580c33430543701dedf6a6c8bdbb71f7f966dea7ad76cf7`  
		Last Modified: Tue, 27 Oct 2020 03:12:03 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:259e6c7d9b0dc6b3f152c962e26018e6f42e61f4a299c3a7fbe5dbb2495a241e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.2 MB (193215940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6055d2c20ecb1b5fad1f0147e11b7831c68b4a5e84e66541be15c611756dea76`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 10:50:25 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 10:57:28 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 10:57:37 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 10:57:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 10:57:49 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 10:57:51 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 10:57:59 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 10:58:03 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 10:58:05 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 10:58:06 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 10:58:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f7f2d1223fc121324c6b0272a2d384a3cb54946b69ef25c58cd60e1e581a69d1`  
		...
		Size: 8.5 KB (8454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26d38a989a25896cd5cd7b9e0ae8f657d20c1fee9ffce3e20de6d47250183706`  
		Last Modified: Tue, 27 Oct 2020 11:14:40 GMT  
		Size: 17.6 MB (17628955 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b269352e311b856f6c7073b4590aa6650f947c395758eab7cf3f8132614a007c`  
		Last Modified: Tue, 27 Oct 2020 11:14:34 GMT  
		Size: 9.1 MB (9093701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:892e02c1b915146ce242d1225206fe499e73fd13bd8724e18b40096e4564e5b3`  
		Last Modified: Tue, 27 Oct 2020 11:14:32 GMT  
		Size: 380.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f0ee843b6490cdf29daa49753b20183b37bd17c7424d58b29a56cfcc7ac7cbd`  
		Last Modified: Tue, 27 Oct 2020 11:14:33 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1902d6baf4e0c5581392228645bef389c55323eab4729adfdbf1012469b56b35`  
		Last Modified: Tue, 27 Oct 2020 11:14:35 GMT  
		Size: 12.8 MB (12846319 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0473f9dc855445904a65511bfedf44276c29d9310c650e352d3883b8285b3a9f`  
		Last Modified: Tue, 27 Oct 2020 11:14:32 GMT  
...
```console
$ docker pull wordpress@sha256:7ccb2798df22428850e51571e2559cba975d42727f6b4ec7f912a817e257b95c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166152023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32528741f781c8966b647b279835e22fa86ed435e78cd03b12ed3f8d8de4d303`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 03:38:21 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:39:30 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 03:39:32 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 03:39:33 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 27 Oct 2020 03:39:33 GMT
ENV WORDPRESS_VERSION=5.5.1
# Tue, 27 Oct 2020 03:39:34 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Tue, 27 Oct 2020 03:39:37 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 27 Oct 2020 03:39:39 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 03:39:39 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Tue, 27 Oct 2020 03:39:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 27 Oct 2020 03:39:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:235fa68fd1aab62b2ea4d5a7e21f49afe9dfe86cb7e616b9890f557fe9de3e1d`  
		...
		Size: 8.5 KB (8456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:992f86d1b6942f38ef0d792fa041d313641de920b3ee50773772755aa562d04b`  
		Last Modified: Tue, 27 Oct 2020 03:47:04 GMT  
		Size: 16.8 MB (16776457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ceab364c4536acb1c305e0d5bd707c6e429a337c608fc76296cf3cd911a8081d`  
		Last Modified: Tue, 27 Oct 2020 03:47:00 GMT  
		Size: 7.8 MB (7822621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:572dd3c2d1d969dd73d96bde5fa0a76969d3e5a3019e09ed3b2a4d273c1c7f6e`  
		Last Modified: Tue, 27 Oct 2020 03:46:59 GMT  
		Size: 379.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4bfbfaaa24bea23b5ebd344be372c8aa769d6841310d64ee7e920a7c9c41e4f`  
		Last Modified: Tue, 27 Oct 2020 03:46:59 GMT  
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09d030d9e8ed55fd6cbe1262550ce9eae6d1096b203d74001bfcda41813d8907`  
		Last Modified: Tue, 27 Oct 2020 03:47:01 GMT  
		Size: 12.8 MB (12846317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6c2b56e77cb20da12d77efebd06e96ec122ee9efd347433f32ec06d9bf7fdd4`  
		Last Modified: Tue, 27 Oct 2020 03:46:58 GMT  
