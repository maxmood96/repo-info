...
```console
$ docker pull wordpress@sha256:f9e4b3bf6953feb17f4d8a1f55cfa8816ac1706959fda4cd8daedbd605cf243b
```
...
```console
$ docker pull wordpress@sha256:98e9e16e4750740454b035a063692fb03c38567c4bdbfeaf3be3ea234b93e95b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.2 MB (184166544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44b31407ea7b0809e3c1a161e7ab676465fb629192e4c3673ff1e7bb0d868a3b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 20 Nov 2021 01:28:44 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 20 Nov 2021 01:28:46 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 20 Nov 2021 01:28:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 20 Nov 2021 01:28:56 GMT
RUN set -eux; 	version='5.8.2'; 	sha1='c3b1b59553eafbf301c83b14c5eeae4cf1c86044'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 20 Nov 2021 01:28:57 GMT
VOLUME [/var/www/html]
# Sat, 20 Nov 2021 01:28:57 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Sat, 20 Nov 2021 01:28:58 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 20 Nov 2021 01:28:58 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 20 Nov 2021 01:28:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0ccd0621510b220bb80c2d23dd7f7140d24945c692524552aff6dcbeea36a224`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e8712816ee5c55a0974486fea3a091a7a03ad7e80e7224e70db9e9a1ebf8384`  
		Last Modified: Sat, 20 Nov 2021 01:51:43 GMT  
		Size: 18.7 MB (18654682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45cb0e21bbd79904f2aa257232adb9fb44b004dcc2d13c37627f19d3641c6417`  
		Last Modified: Sat, 20 Nov 2021 01:51:36 GMT  
		Size: 9.5 MB (9505326 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:804b430d7298ad742cb0184a1aa795557fa4e93f4702608df6e41419c53527f8`  
		Last Modified: Sat, 20 Nov 2021 01:51:29 GMT  
		Size: 377.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbdd2cc8dc3f6076e695968959e9cca606b6d51c230527060289321d74245f8a`  
		Last Modified: Sat, 20 Nov 2021 01:51:29 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0570c4bb6a27ddfbc74cef9d6b1ac8436b6d4053bde3cd45b874b32d2e79c60`  
		Last Modified: Sat, 20 Nov 2021 01:51:42 GMT  
		Size: 14.9 MB (14915758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08281f371b51df1fcb143e7bfe42a1299adc129c785e90e774d6164679925068`  
		Last Modified: Sat, 20 Nov 2021 01:51:29 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b804cff51bf77e30118405ff18f3716450be5a39709e4b1a5f5155a08260f44`  
		Last Modified: Sat, 20 Nov 2021 01:51:29 GMT  
...
```console
$ docker pull wordpress@sha256:8a977e0517bbf62448558e29aaf2408ed8e2977f711f52d5bc7a08a501fc5c78
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.8 MB (198768224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1a82dadfab6e8d662161cdbb33aac0e4eec83ea5f0be35674a7f3f36153fdc8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 20 Nov 2021 02:22:36 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 20 Nov 2021 02:23:46 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 20 Nov 2021 02:23:47 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 20 Nov 2021 02:23:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 20 Nov 2021 02:24:07 GMT
RUN set -eux; 	version='5.8.2'; 	sha1='c3b1b59553eafbf301c83b14c5eeae4cf1c86044'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 20 Nov 2021 02:24:08 GMT
VOLUME [/var/www/html]
# Sat, 20 Nov 2021 02:24:09 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Sat, 20 Nov 2021 02:24:10 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 20 Nov 2021 02:24:10 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 20 Nov 2021 02:24:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1cafbf04bbbc95088052b91a2872e3ae3b03557420d9c68f70b7a0e3528a1cc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc3114b244e809204b548de6f06c6a90370ba595056b3d6edc19768a2e04c4ea`  
		Last Modified: Sat, 20 Nov 2021 02:44:42 GMT  
		Size: 19.1 MB (19055640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef94e2e46139db75d0c9588bc34ca16edb5741a586895603966544da6a572e31`  
		Last Modified: Sat, 20 Nov 2021 02:44:39 GMT  
		Size: 8.9 MB (8882844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9df5957dafe061e34913bc12f47543a882d49b43afd9e79bed2ec06c185eff8c`  
		Last Modified: Sat, 20 Nov 2021 02:44:36 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03f891a00a310c63083de89046f5106aa10da183987e6b73b95d16f154b0b881`  
		Last Modified: Sat, 20 Nov 2021 02:44:36 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db3211099e8a2ea226317ed2e808e522c22830ec2dc23b98db866ce320e31d74`  
		Last Modified: Sat, 20 Nov 2021 02:44:38 GMT  
		Size: 14.9 MB (14913392 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b30b6184fdca45ef03a590e9c91e4f724bb250930a01efa2ea51de32e5553b6`  
		Last Modified: Sat, 20 Nov 2021 02:44:36 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4dc95fb36c974670a5d32c6fbb509cedb809678c63f5045f26846b67252e840`  
		Last Modified: Sat, 20 Nov 2021 02:44:36 GMT  
...
```console
$ docker pull wordpress@sha256:69df7622c77abcba7ca9b1dee1f54ddd380f517904c86d9808be4db5c5fe5fa7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.3 MB (210308565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:286c27fdd82c15bc1ee50563a30d45df785c69b35d7f13aa6076e7b4126ad337`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e2a016e27f99e8ca7ddec26f5ae51b17d796f20e882d1966feea0d21b50dbd3b`  
		...
		Size: 8.4 KB (8448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc1b40a4ed2ef11db52fc330c17b12fb534d365028c33bd73a35825a109ac1ad`  
		Last Modified: Sat, 20 Nov 2021 03:21:02 GMT  
		Size: 19.5 MB (19457993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e8c2739923f5ce7084f031abf3325d25a59fcee052b5811a91840c9ff8e40da`  
		Last Modified: Sat, 20 Nov 2021 03:21:00 GMT  
		Size: 10.4 MB (10397910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1041461d530d92bcb0cd86eabfffd871c2d0d5a2acb99d61e4eb37273be1aadb`  
		Last Modified: Sat, 20 Nov 2021 03:20:54 GMT  
		Size: 378.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77f9b39487bf2a6001fed482bfda762ada67518a3061911f816b5e6995640dc`  
		Last Modified: Sat, 20 Nov 2021 03:20:54 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df5826800034b08027cdf26697ed168eb9fa5956d8492d609e3f863aeec27b24`  
		Last Modified: Sat, 20 Nov 2021 03:20:58 GMT  
		Size: 14.9 MB (14915759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e16ebf7697bdab7d388ee5404a356d35ca757410f3bafc7cdc97484265f448f6`  
		Last Modified: Sat, 20 Nov 2021 03:20:54 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b63c5a1258ad183291c8454db6c74b59f00b032c6dec592f04823048d13e1b4`  
		Last Modified: Sat, 20 Nov 2021 03:20:54 GMT  
