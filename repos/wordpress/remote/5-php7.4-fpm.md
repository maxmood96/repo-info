...
```console
$ docker pull wordpress@sha256:7943fdcdde815d7dccb4eca5f3f8000ddb788ab58c356d8053b29b13b1be0b6c
```
...
```console
$ docker pull wordpress@sha256:919ecc1396ec0e7c682562a91925c1188b14142979065e8b6b502f7af165118d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181098781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5f6c141ebfab5229b6363d35a0d6898d94978efad610774bf914e3aeed46a10`
...
# Thu, 06 Aug 2020 19:21:55 GMT
CMD ["php-fpm"]
# Fri, 07 Aug 2020 02:57:16 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 02:58:41 GMT
...
-	Layers:
	...
	-	`sha256:ee0267baff3c005cd5d01e6bc6a768fc507740ada433e137179f744612228b2a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b619b6306237eb59e95b4ef998a333cc7946d2163b08c387ca5a8e0633356dc`  
		Last Modified: Fri, 07 Aug 2020 03:06:42 GMT  
		Size: 16.8 MB (16847427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b3dafe7f008fd8ae02eada33b45d0e5b29de2a04a8b91a58e4ccc11c6e03dcd`  
		Last Modified: Fri, 07 Aug 2020 03:06:40 GMT  
		Size: 9.3 MB (9260615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:687205cc8f003780b39954c638fdeb5546a9e4111d70ceea514e30c2d81f0c2c`  
		Last Modified: Fri, 07 Aug 2020 03:06:36 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:229dca45ad17b48ccf047a381baac9da45bc444fbf746c1dc8a5c19266ea793d`  
		Last Modified: Fri, 07 Aug 2020 03:06:36 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3215bad746dca5dbda9684a115f2fdfd0457d7b22db970af8e23bbcb040c883e`  
		Last Modified: Fri, 07 Aug 2020 03:06:41 GMT  
		Size: 12.1 MB (12082654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74599ff0a47af19984b09f407c2fc2e6666802faf2278fa4c7fc675b96f6fd28`  
		Last Modified: Fri, 07 Aug 2020 03:06:36 GMT  
...
```console
$ docker pull wordpress@sha256:33186e59c370c7b38428e266ab31f6166ffef1a6e210c277da66633f2b5df0f1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158050162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d0450045887689241ecf7f65042e2e5e36f130aae7b0867981961aed4c412ee`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Aug 2020 05:03:48 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 05:03:49 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 05:03:57 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 05:03:59 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 05:04:00 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 05:04:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 05:04:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:16aaa2c34a2540553d99bac8b31b40d63ea4f77ee6ce124735ae7b529acae74b`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ce1fb411417cad0b60cd86b21f3717bb957f8116f00f542d7648e80481cf359`  
		Last Modified: Fri, 07 Aug 2020 05:07:15 GMT  
		Size: 12.1 MB (12082662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbb72d33e4f32cea9a55b74093433ed06fba4fc8d8adaf8d507f80b152664cf5`  
		Last Modified: Fri, 07 Aug 2020 05:07:10 GMT  
...
```console
$ docker pull wordpress@sha256:2c29a96efea2adf57a5e2e63e5cb50d6c899978ee29f41a4f315da3983284938
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.4 MB (154350332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:257aac05481263bc1608d654780ebbd1a37e2449edf0edb0fb9014afc274f681`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Aug 2020 08:09:38 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 08:09:38 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 08:09:44 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 08:09:46 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 08:09:46 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 08:09:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 08:09:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a4d7abb88c3b5a43f4b5c71c711c015029a73a1800f06bbb415a68ac37ed1255`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d069badf3ba32e064492e1eac4a5788a8b8427c729f91bb4a5f7d033cc82cccc`  
		Last Modified: Fri, 07 Aug 2020 08:20:11 GMT  
		Size: 12.1 MB (12082659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e61bfc9ac0893784363263c9579f9eaa4819e1b09833441965e86e02bb743d`  
		Last Modified: Fri, 07 Aug 2020 08:20:05 GMT  
		Size: 4.2 KB (4154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:bff0f7810a03f144eacaeba3d523f34a7714822d74df126de72111559fcd5294
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171652675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99abc280035d411dbe5cf780a14bf2b33fe85771308e2d1c5b762234052ab951`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 07 Aug 2020 05:41:17 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 05:43:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 05:43:43 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 05:43:45 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Aug 2020 05:43:45 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 05:43:46 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 05:43:51 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 05:43:52 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 05:43:53 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 05:43:54 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 05:43:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1b8321b0a1375c6c8e52d9216cb3ec97facb14974d1323a9043e73169c2a7210`  
		...
		Size: 8.5 KB (8451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9dccb1c91694630ea5b60d65a08c1e745424930421dba0a385578c197d5390e`  
		Last Modified: Fri, 07 Aug 2020 05:55:03 GMT  
		Size: 16.8 MB (16778778 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92142e0f466485675a1c4825cac3ecaf8f9bb3dd27c05c8c905277c7786fa5ae`  
		Last Modified: Fri, 07 Aug 2020 05:54:58 GMT  
		Size: 7.7 MB (7677749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30cef1a26b73811bf97164bf6ebe9adf6e6a46ebbc8d42d352267b12bd937d6c`  
		Last Modified: Fri, 07 Aug 2020 05:54:55 GMT  
		Size: 409.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d86c1477511382fdbca07512eb5caaddf1aedcff21a743cc7d575d3c6439572`  
		Last Modified: Fri, 07 Aug 2020 05:54:56 GMT  
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4c2258d5d02723a3b1c7eb7e33e8568dcbbcdd43c2d6f3e3c542a2526b72f7d`  
		Last Modified: Fri, 07 Aug 2020 05:55:00 GMT  
		Size: 12.1 MB (12082662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dae437881bfb43d3a2ec79fd67f5d9f9c73e331c4867c517b0507cc8880d335`  
		Last Modified: Fri, 07 Aug 2020 05:54:55 GMT  
		Size: 4.2 KB (4154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:8f5c6f8ff8faa97cc8075f6b79c555a88a96a012e489ec5ac4fcdb432fea78f4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.5 MB (186473272 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c2d63d2244bdb7a3c57461c2c81795fcf0a7ec4d7397a6e84bd364b06a753d9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 19:25:51 GMT
CMD ["php-fpm"]
# Fri, 07 Aug 2020 02:34:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 02:36:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 02:36:27 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 02:36:28 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Aug 2020 02:36:28 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 02:36:28 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 02:36:38 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 02:36:38 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 02:36:38 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 02:36:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 02:36:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ffc8c7d267102efe52f5789b9b0a17f2f9a2d3b93150d9578f62277713b036d0`  
		...
		Size: 8.4 KB (8449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a6d1dd633ee479905d072475b61549c49196920c7ea0f50103a6078275e6960`  
		Last Modified: Fri, 07 Aug 2020 02:44:51 GMT  
		Size: 17.2 MB (17163680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:807c8e41c9677e90800e0397db65bdbde1fd59a124db677ec40b6d0ce8769e09`  
		Last Modified: Fri, 07 Aug 2020 02:44:45 GMT  
		Size: 8.5 MB (8531822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da1eb48a1e03c58dae16f08c819d38b874673f2f4b166b6bf7d6d0c57fb51e8e`  
		Last Modified: Fri, 07 Aug 2020 02:44:39 GMT  
		Size: 409.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3995483d01ebeb14b657e68ec15e4ec91bfa817465b5746f5103542cc2d07a3d`  
		Last Modified: Fri, 07 Aug 2020 02:44:39 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5441de61cba18d5148dac1d8ee485e8b1f1c8daf2e37d3b1664ed70a410b42d7`  
		Last Modified: Fri, 07 Aug 2020 02:44:49 GMT  
		Size: 12.1 MB (12082644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd1369935e093d67e90b70974ab6835e7c1547b3330c83edaef429ac516fc839`  
		Last Modified: Fri, 07 Aug 2020 02:44:39 GMT  
...
```console
$ docker pull wordpress@sha256:b0a3d456c43d813f8c62b3b1b39df02d560a2c3b9cb6bc4373d514a1371e5ad3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.2 MB (162167412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c2d1fef4925bb7c3edb99ae31c286f4a6d00f4daafd2cc364b5bcecbe4ef841`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 23:21:06 GMT
ENV WORDPRESS_VERSION=5.4.2
# Thu, 06 Aug 2020 23:21:07 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Thu, 06 Aug 2020 23:21:14 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Aug 2020 23:21:14 GMT
VOLUME [/var/www/html]
# Thu, 06 Aug 2020 23:21:15 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Thu, 06 Aug 2020 23:21:15 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Aug 2020 23:21:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b0b2e92203f84ccf50b7af8b494f209b44fa563e411ab1405f23aa9b88489efe`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce55413ea2a6eae461efa4dee575c312223b37b5351b1e0333d9682fdb5202ba`  
		Last Modified: Thu, 06 Aug 2020 23:24:57 GMT  
		Size: 12.1 MB (12082663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c120f9083944290f8eeea08b4be7d4177579ddcb2ec57ed47f1aff060504549c`  
		Last Modified: Thu, 06 Aug 2020 23:24:45 GMT  
...
```console
$ docker pull wordpress@sha256:785a0de9a2c73120d38b215c6553b60f9d0ec66f6536b7a785b3eedd6a3ae6db
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.4 MB (192445161 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8bd86998f6d417b07a8b439d72124b44a5d1cf463ccd803dccd5e2716210b15`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 07 Aug 2020 06:30:53 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 07:07:01 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 07:07:24 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 07:07:40 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Aug 2020 07:07:48 GMT
ENV WORDPRESS_VERSION=5.4.2
# Fri, 07 Aug 2020 07:08:01 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Fri, 07 Aug 2020 07:08:29 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 07 Aug 2020 07:08:55 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 07:09:19 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 07 Aug 2020 07:09:32 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 07 Aug 2020 07:09:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6445a5e893a4471d8835b1e55bf9c4c9a4526c6793129039c7f1726248bfdbdc`  
		...
		Size: 8.5 KB (8452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7327449de378a0e05c0fd41e9dba7ba9ec0a9437a82df307844207d8ac4fe96f`  
		Last Modified: Fri, 07 Aug 2020 07:32:44 GMT  
		Size: 17.6 MB (17629276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13dbb759e1786a8af3cd4de0aa856cd9a42379188f20ad8a6538ad00cd540b7e`  
		Last Modified: Fri, 07 Aug 2020 07:32:26 GMT  
		Size: 9.1 MB (9098136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91d03b9b7fac1b56945b45ef4824097be82a1b6517dadb6b8a0de0cd909e50c7`  
		Last Modified: Fri, 07 Aug 2020 07:32:23 GMT  
		Size: 409.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b1098c4417355640907019a955a9408e4091c2d983b469be4cc99568238a99d`  
		Last Modified: Fri, 07 Aug 2020 07:32:23 GMT  
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8e22bb004a86ec528463e47afb16757d951179ed738ae5d8f4960f023b8ffd8`  
		Last Modified: Fri, 07 Aug 2020 07:32:28 GMT  
		Size: 12.1 MB (12082659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6a9889635af4e188022c2fae9dbcf479b9369b3ccf259ce4ad2a21cd742b96e`  
		Last Modified: Fri, 07 Aug 2020 07:32:23 GMT  
...
```console
$ docker pull wordpress@sha256:e553ba4c2c733c263e28eafff0c4ba1ddb9a216d617d5813423afa915aa3279c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165379266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:837fc67a05e02454a674255a86e59cc0856c9693b080070248997f0423506d68`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 20:55:08 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Aug 2020 20:55:09 GMT
ENV WORDPRESS_VERSION=5.4.2
# Thu, 06 Aug 2020 20:55:09 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Thu, 06 Aug 2020 20:55:11 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 06 Aug 2020 20:55:12 GMT
VOLUME [/var/www/html]
# Thu, 06 Aug 2020 20:55:12 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Thu, 06 Aug 2020 20:55:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Aug 2020 20:55:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:215fc5d91432bac011c6807a051554e61abc6b15fcfd19ce30ff09d9209766e3`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19e92e069ef155efb1edbfc361361e4a5aca569377ea4c3050b11d84ef1eb0e4`  
		Last Modified: Thu, 06 Aug 2020 21:00:52 GMT  
		Size: 12.1 MB (12082664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e52a536813c642656f7a5f62c51fd5cbc1b974481d53ebd6571909b58e6b808f`  
		Last Modified: Thu, 06 Aug 2020 21:00:49 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
