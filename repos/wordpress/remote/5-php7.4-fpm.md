...
```console
$ docker pull wordpress@sha256:6266fa7149d3a3bf965630924365e9f7a2b3139f6ee07e92c7fba5fbbc5ea93e
```
...
```console
$ docker pull wordpress@sha256:82256e878d4671ff0095e6bae36febe14c2f888b2537526b60f4dbfbe27b79fa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175843811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a48a7d5d5a5d33755d1e216b2ecbcd4927499071bca5f4557a7a04db99f8986`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 08 Oct 2021 00:29:02 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Fri, 08 Oct 2021 00:29:02 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 08 Oct 2021 00:29:03 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 08 Oct 2021 00:29:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b49f4d4317cfef58d4770652d46b7f3bca2216dad88608a59e74150904b00a20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1c262111da6e2bcfe748e28f1ae3c9d6999479212c8e7c45952387a2ba8e113`  
		Last Modified: Fri, 08 Oct 2021 00:38:42 GMT  
		Size: 2.4 KB (2356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bb2bbac7548580ba4292acc298d368078b9879f25f59952c31e2767f564fc62`  
		Last Modified: Fri, 08 Oct 2021 00:38:42 GMT  
...
```console
$ docker pull wordpress@sha256:4641ef328ac5412ffd7f1b61cdeb7d13fb0919a86813559bdeda8b37f7d7b70c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.1 MB (211118518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70559ea1cd5a58545f3a325678a1aab6bb5fa5656e833943a1016a869759d1c8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Oct 2021 20:17:28 GMT
CMD ["php-fpm"]
# Wed, 13 Oct 2021 06:30:43 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 06:32:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 06:32:07 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Oct 2021 06:32:08 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 13 Oct 2021 06:32:13 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 13 Oct 2021 06:32:14 GMT
VOLUME [/var/www/html]
# Wed, 13 Oct 2021 06:32:14 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Wed, 13 Oct 2021 06:32:14 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 13 Oct 2021 06:32:15 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 13 Oct 2021 06:32:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b540658df6b7989925cc8e981a36449b2341f7597278e195a9c810a1e935eaa7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f23a4176fcaae3ce84ff375308d47972e8a18296c82a5353bfb2b722540bd940`  
		Last Modified: Wed, 13 Oct 2021 06:48:22 GMT  
		Size: 19.5 MB (19457902 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b6322d890ed6b5d7e9e8a2384c289133b99e097393c8eb7d2577fb65a5aa39b`  
		Last Modified: Wed, 13 Oct 2021 06:48:18 GMT  
		Size: 10.4 MB (10427239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99d261be46669e7dd31e65625b240b339b3af260682ea5c20d9ca27a5e74b159`  
		Last Modified: Wed, 13 Oct 2021 06:48:09 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b01fc4ce755fc90618601f3869d07bf40fe37086405b7b766b255af0d5dcea5`  
		Last Modified: Wed, 13 Oct 2021 06:48:09 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c00b245d058d8c88e4e7e0d207e2a115c3cb4f94cbcb5cb9d51749a71788522`  
		Last Modified: Wed, 13 Oct 2021 06:48:18 GMT  
		Size: 14.9 MB (14915603 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79534c30da0b883f62c18de09eda5a4beed86fc51fd73f2206f68e360f65296e`  
		Last Modified: Wed, 13 Oct 2021 06:48:09 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a91b82fa1571d9440c8cb637fa929001df5de69916f5ee1347e11f232bc6a1e3`  
		Last Modified: Wed, 13 Oct 2021 06:48:09 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:e00c9d7365892b213ee5c5f6e22d602d9b607999d27549946bc0e8bf4b0fd8b5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.5 MB (209516932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59f9bdf515443c94b73a982bfe5e31140842a8d7b409debd0086569804287607`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 07 Oct 2021 23:29:34 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Thu, 07 Oct 2021 23:29:35 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 07 Oct 2021 23:29:37 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 07 Oct 2021 23:29:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:70fb8f6e73ff1ee2a9001959c761db3c9299cfbd3ec739636b5833aa5db5f9ef`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75a3c445f434a6e2adda42b0cfa8711737ece3af0ff664f8633dc26015ba124c`  
		Last Modified: Thu, 07 Oct 2021 23:35:55 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d30fd5c4d1d735bbd3b2194b660a8e38ccc27bb8cd829b5e06efcd90b788079`  
		Last Modified: Thu, 07 Oct 2021 23:35:55 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:5d79d46a5659ac10bfe6aacb5c99e3904632de3d4475000ada9827f131d48ee3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.0 MB (184003967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9bcd1d8491c5320c1e522d8954a99602bdb71e84a2072a5074d329c135b86d4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 12 Oct 2021 09:21:25 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Oct 2021 09:22:13 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Oct 2021 09:22:14 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Oct 2021 09:22:14 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 12 Oct 2021 09:22:17 GMT
RUN set -eux; 	version='5.8.1'; 	sha1='21e50add5a51cd9a18610244c942c08f7abeccd8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 12 Oct 2021 09:22:18 GMT
VOLUME [/var/www/html]
# Tue, 12 Oct 2021 09:22:18 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Tue, 12 Oct 2021 09:22:18 GMT
...
-	Layers:
	...
	-	`sha256:5be0e4ea1fbc38600d7ddbe0a22729b6d9e7e54c644dc926cb4264552304d4e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f36ee9feed55120948933f8c2ae690adff1754b41590563aff69ee36c9edda5c`  
		Last Modified: Tue, 12 Oct 2021 09:31:06 GMT  
		Size: 19.0 MB (19028404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad687c6804a5be75eb6b051bc7296ee895e6df0363e556c90c53dcb2a1d98d0b`  
		Last Modified: Tue, 12 Oct 2021 09:31:04 GMT  
		Size: 9.2 MB (9173580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ef8e0aaa9936c036f5a972706dc30223902cc44675067666ffcef0949e9d0bf`  
		Last Modified: Tue, 12 Oct 2021 09:31:02 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64474218ced79b8061fd9724af576bf8c0073953ad8e82e8b4c0504ddb77d592`  
		Last Modified: Tue, 12 Oct 2021 09:31:02 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:829386eed31687127f30472db510ffb3290e31d51ecc808c073e233b66a9e86a`  
		Last Modified: Tue, 12 Oct 2021 09:31:04 GMT  
		Size: 14.9 MB (14915595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be9c829567b6d657a2d36035c65615d0eaa64da613659dc2b4aac720edc7deb3`  
		Last Modified: Tue, 12 Oct 2021 09:31:02 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09bcc20722542fd5e02f8c7d9397039cf1dbaa6f0a9bc3c1faace8705f72b45c`  
		Last Modified: Tue, 12 Oct 2021 09:31:02 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
