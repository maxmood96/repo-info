...
```console
$ docker pull wordpress@sha256:00b0476e5bf2151f243bd685ddcd1b4f2c73d4e1ad56cfacf8865419d91605f0
```
...
```console
$ docker pull wordpress@sha256:917626afaf94e861dcd8f75ad694cc18e90c5579401c292579380b3560faf69c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184587688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aaef3955a5ea14c379fc2fb36e6813bf8eec7de25c0b964cb866c7ce50516e71`
...
-	Layers:
	...
	-	`sha256:bb09cc23c8ddc9e144889375761cf671c7c7c24cf1a9a53fd7f3ff5129587554`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:955cea8f075f8bb2ca54351e1ae7475ccbad03e9cb7ebb32beb1533453ccd482`  
		Last Modified: Sat, 06 Mar 2021 08:33:43 GMT  
		Size: 15.5 MB (15455624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9df7a7f4319e48a3a0cc708e2c138621a5d959c45b3d3e73b9b769766b3e2b13`  
		Last Modified: Sat, 06 Mar 2021 08:33:40 GMT  
...
```console
$ docker pull wordpress@sha256:3639293017d1bfc4ea6bdeb84e3f2616dbf01a8fcc9a92789bf74214e747f66d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.9 MB (176896866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df0eb2756a0fe79eee318159139a1f09c3d773cadd31e54e74090575cfbd8bba`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 05 Mar 2021 03:21:02 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 05 Mar 2021 03:21:03 GMT
VOLUME [/var/www/html]
# Fri, 05 Mar 2021 03:21:04 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Fri, 05 Mar 2021 03:21:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 05 Mar 2021 03:21:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b8f810d5576e639580d3d021363aeeff0206f835c935441d9569969c1216d9ff`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a5a789ebf23955f278995d06e302007f4953f63c7cff61582f25b781f7283a6`  
		Last Modified: Fri, 05 Mar 2021 03:36:28 GMT  
		Size: 15.5 MB (15455631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6d0fdc4979eeb46114db16c07437d095ce76a255f9709df997302f4e7618fae`  
		Last Modified: Fri, 05 Mar 2021 03:36:24 GMT  
...
```console
$ docker pull wordpress@sha256:e20ecc0d8f1f858d173f0d66d9a499b61d9fa51f85be157d3bdcb72fd10bd5fa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.0 MB (189964586 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:badcef8af9af0f262aeb3ab2d8975eaacc5e924cfc556f99180d30b69d234882`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 06 Mar 2021 07:27:04 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 06 Mar 2021 07:27:04 GMT
VOLUME [/var/www/html]
# Sat, 06 Mar 2021 07:27:05 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Sat, 06 Mar 2021 07:27:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 06 Mar 2021 07:27:05 GMT
...
-	Layers:
	...
	-	`sha256:15e5d07a9012ff36fd7d74fd1be231036ce0e0097f164302b7dc77f82383f382`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0246b1a97c8a25662494ac18cb80c6e91b25fbb7a53a8e8ad9e936437ee75b76`  
		Last Modified: Sat, 06 Mar 2021 07:49:27 GMT  
		Size: 15.5 MB (15455622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b15006ffd7f04f45cacb84ea0c3a0b0e44ec071ae78b4a3aa5290e0822df92ab`  
		Last Modified: Sat, 06 Mar 2021 07:49:22 GMT  
		Size: 4.0 KB (3959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:9bbd27147108df1dcc1b9346260b72822627679e34ce5c7d5ba2eaf8d95c6dc6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.9 MB (197916129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b99f39935afbc145cb9066a2ccddf7bc29d7fbe6805ed51c4d5a8636dac64bf5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 05 Mar 2021 07:10:10 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 05 Mar 2021 07:10:17 GMT
VOLUME [/var/www/html]
# Fri, 05 Mar 2021 07:10:21 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Fri, 05 Mar 2021 07:10:28 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 05 Mar 2021 07:10:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bda4148e724bdb63943c81914f3d0fbbc16513da79b52e6504a4b9ef631a479f`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:550e01fe5d1e287e21d91d11784045ec522ddb493b3e0b243934cdca3c65425d`  
		Last Modified: Fri, 05 Mar 2021 07:39:50 GMT  
		Size: 15.5 MB (15455637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:986d53099ae418e0f952fc3a9a07363aeaacc60a16bf276075251d87d0ff2b1a`  
		Last Modified: Fri, 05 Mar 2021 07:39:47 GMT  
