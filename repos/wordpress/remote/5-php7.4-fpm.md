...
```console
$ docker pull wordpress@sha256:f2987e9988ea70b2b5fb437e742f09556e6ab8974ca5449772cf836956e9a661
```
...
```console
$ docker pull wordpress@sha256:153b587ec37a1f61c200848903e8ab6b274bee1f10022d56a04e4620b1c4087d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184564455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56694c1362395a2fc42b514a54f19281ae5f5a47df882dab380317d232928402`
...
-	Layers:
	...
	-	`sha256:6507f817124f061b22be697c48d9cf00c7bf97e5c004e130ff3f4474b15b13e6`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f43bcabf7d2a28e289efb8900d041c80b268e85bc765513aaf819a05fe30901`  
		Last Modified: Fri, 05 Feb 2021 05:17:23 GMT  
		Size: 15.5 MB (15455745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a56470a4dc450050c7b7bcd07fe9e01a6a83cdd628c4001882392cc5812ac914`  
		Last Modified: Fri, 05 Feb 2021 05:17:19 GMT  
...
```console
$ docker pull wordpress@sha256:98d03c8121315eedc86fac13a486e762357b48c93e61f655a6f6eed4c62077ac
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168828591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18df64c0f7a397e0ef0af85e8f98a584a5f8fbb9b24829cf9562a13a5c6b09fa`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Feb 2021 18:10:16 GMT
CMD ["php-fpm"]
# Fri, 05 Feb 2021 04:41:23 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Feb 2021 04:43:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Feb 2021 04:43:14 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Feb 2021 04:43:15 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 05 Feb 2021 04:43:23 GMT
RUN set -eux; 	version='5.6.1'; 	sha1='19ec00acb177da27533edf5500f911f9d97c047a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 05 Feb 2021 04:43:25 GMT
VOLUME [/var/www/html]
# Fri, 05 Feb 2021 04:43:25 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Fri, 05 Feb 2021 04:43:26 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 05 Feb 2021 04:43:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:646966913793e821d0741d25c6cf5f263941cbffe38626f56bc018a793e29e53`  
		...
		Size: 8.4 KB (8450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ace8b7a5d9286219fcc653a5820eaaaa377b87af3a432711b532e93507ed3d1`  
		Last Modified: Fri, 05 Feb 2021 05:11:36 GMT  
		Size: 16.8 MB (16769045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c42407a93891ad1edab998217d1bdc3ef466955c38b15f1b5e3f121fbcb79f57`  
		Last Modified: Fri, 05 Feb 2021 05:11:19 GMT  
		Size: 7.8 MB (7822839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:025a8ddbf0b3129972a7fe3734ec6396786d9ddf1d9a8fce9c7232dc50c2673c`  
		Last Modified: Fri, 05 Feb 2021 05:11:19 GMT  
		Size: 379.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b9a930463131d27026231c0c53ec06145fcd524af52cc0ca9207bf705779825`  
		Last Modified: Fri, 05 Feb 2021 05:11:19 GMT  
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ffe7cd3dea457299b6f1e7b4b2c07d092e2a044067124257955e1669d0fdf22`  
		Last Modified: Fri, 05 Feb 2021 05:11:19 GMT  
		Size: 15.5 MB (15455840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47f8a491a8524653e7ff82ce7ea1dd8991bae57c1256db34efba016dd94ec031`  
		Last Modified: Fri, 05 Feb 2021 05:11:19 GMT  
		Size: 4.0 KB (3962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
