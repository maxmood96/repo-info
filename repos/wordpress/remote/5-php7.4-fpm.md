...
```console
$ docker pull wordpress@sha256:4b7b4db0993d837369612d13984c1ff0c66d621eb630001bfd4f808df5ce9fa1
```
...
```console
$ docker pull wordpress@sha256:4e3dd4574d06e668f5dd715bce180a902ace65453c2ac2529155e9258c91e1cd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158845473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47a6e3b533a8e8acbd20a623930ca34e7cd248cc6b0526931f085dc4703d3e4a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV WORDPRESS_VERSION=5.5.1
# Fri, 30 Oct 2020 01:44:57 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 30 Oct 2020 01:45:03 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Oct 2020 01:45:04 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 01:45:05 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 30 Oct 2020 01:45:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Oct 2020 01:45:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b5188ae1df1a3ae28d5bc904efc2a73ecb08df0cd25629ee938d36695c3a5167`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:794d415ba1e9042fd73e1a9a087136d121707b51acf9b74a72ef6849a0e8fced`  
		Last Modified: Fri, 30 Oct 2020 01:47:29 GMT  
		Size: 12.8 MB (12846318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd0c063b8baef59942d830922361409372388ed8cb0fe71ac2c577ab40b8d7e6`  
		Last Modified: Fri, 30 Oct 2020 01:47:23 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:fc73634f407a73fada40e3fa0cccdcbfe0489fdaeab3cdf22de7cfff2aaf5c85
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155142934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:689d284f8745773bc6813cdae5aef2abcade8ab58715d0f07b6bb766373e0f16`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Oct 2020 02:40:07 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 30 Oct 2020 02:40:07 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 30 Oct 2020 02:40:13 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Oct 2020 02:40:15 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 02:40:15 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 30 Oct 2020 02:40:16 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Oct 2020 02:40:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:97ad5303b2239222388a54a73e468551910ae1f10e79bee35f5e65572438036e`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6bd3375e2f5e2b9445921bb5b115a3580b604e52574f981663bc4c28a8a2582`  
		Last Modified: Fri, 30 Oct 2020 02:47:56 GMT  
		Size: 12.8 MB (12846311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7d09b7c35d8dda8cbf64c1878fe9e6cd69220006150dbf7affe2bf2a587705c`  
		Last Modified: Fri, 30 Oct 2020 02:47:50 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:d6eade0b1d4f6dd9281fea6ea28eca5fe3799709ac59f6e869f4a61cc2d8b91b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172456125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82405ad3e55969d1b2aba0c68675ea7aadeaa8d33db6f949501216541eceeaee`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 30 Oct 2020 03:18:27 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 03:20:51 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 03:20:53 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Oct 2020 03:20:55 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Oct 2020 03:20:56 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 30 Oct 2020 03:20:57 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 30 Oct 2020 03:21:01 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Oct 2020 03:21:02 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 03:21:03 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 30 Oct 2020 03:21:03 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Oct 2020 03:21:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d583621bccc23439f1f1f04f971c478d7c0ea3a6375705827472ea05f2e11271`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb370d5e15455d1b13aefb5d3ae05def116e8a6b951cbee5a0040d10870e11a8`  
		Last Modified: Fri, 30 Oct 2020 03:29:11 GMT  
		Size: 16.8 MB (16782702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec541a91981675f9d78c20cb1478c8deb54f891220cfe7b96283ef389aba89d0`  
		Last Modified: Fri, 30 Oct 2020 03:29:05 GMT  
		Size: 7.7 MB (7677748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f57ca5fa723bff8ee0c6605d40c66851ca0007fa1da6f44389aa7ffe00550991`  
		Last Modified: Fri, 30 Oct 2020 03:29:04 GMT  
		Size: 378.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d13f350ccac922631cb7f502a2f11813e936c30e0c07dabafdf6081fe1e6516`  
		Last Modified: Fri, 30 Oct 2020 03:29:04 GMT  
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89f2c29a60298472bd62f94e8b50ae21ddd1bd9e156847c068d3fddfbdebd277`  
		Last Modified: Fri, 30 Oct 2020 03:29:07 GMT  
		Size: 12.8 MB (12846320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8831b4230116d74040878041a0ce401c5985a7c210db2cc5cb3a510dfd3b4a05`  
		Last Modified: Fri, 30 Oct 2020 03:29:03 GMT  
...
```console
$ docker pull wordpress@sha256:71e079148549a8d614c85b7484ef271a3db2e1b39699247c1ccd92b322f7f843
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (162957994 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94cc45acb0bf8675767620ed6c37487a3d296435773c687f0174a35cdd64788c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Oct 2020 00:51:21 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 30 Oct 2020 00:51:29 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Oct 2020 00:51:29 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 00:51:30 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 30 Oct 2020 00:51:30 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Oct 2020 00:51:30 GMT
...
-	Layers:
	...
	-	`sha256:9ef245a26d2d501c21bc540690459e52cd1f05f8aa165ad0e1f24aa0e018ae02`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc5776dcde2a10e5f0b67da70a14825a6e5699ea8ded8ee783c3a90934af9540`  
		Last Modified: Fri, 30 Oct 2020 00:55:20 GMT  
		Size: 12.8 MB (12846266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b846e937a2ca0f6ddbf444ea6494c711e9f18017bd4a69beab3913fc0b80b88a`  
		Last Modified: Fri, 30 Oct 2020 00:55:07 GMT  
...
```console
$ docker pull wordpress@sha256:0abf5b1e847be49ab985adcc5350a8394e3920d48366b156466149fdfa47c5f1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166171101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d18f13c1f32cbb36adbde8f7516c461eab0ab7d69c07479e5996ea67ee9324d6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Oct 2020 22:17:07 GMT
CMD ["php-fpm"]
# Fri, 30 Oct 2020 02:19:39 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 02:21:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:1de02b7c9cead7332dcc7cf4ce46dbb8685f95a52d281eca09316d83b8793d89`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:630a6e5c0795f46acb18c85035bc893b43e81775f30d6d3913b96176e7daba6c`  
		Last Modified: Fri, 30 Oct 2020 02:28:14 GMT  
		Size: 16.8 MB (16776477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85b538f51eb9203829df99e1f5780508528490504f1b41f4736245d73dadb49f`  
		Last Modified: Fri, 30 Oct 2020 02:28:10 GMT  
		Size: 7.8 MB (7822847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:777558583c69a2f0db52589e18f84fa44fbb745773ae5a085b9957b3d53ec616`  
		Last Modified: Fri, 30 Oct 2020 02:28:08 GMT  
		Size: 375.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f03da7a0ef5fd5629f00b7d55507fe82d4098c68de083dff06b42b9e3239fbf`  
		Last Modified: Fri, 30 Oct 2020 02:28:10 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:479a9a433aae45f08fbd7f000e81f9d58ce9bf7d588ce808aaf73b95f04790ea`  
		Last Modified: Fri, 30 Oct 2020 02:28:11 GMT  
		Size: 12.8 MB (12846317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad3427cba7a6a06d9c052432ca0b5bf763e9eb11719ecc8fbe557747b87e50a2`  
		Last Modified: Fri, 30 Oct 2020 02:28:09 GMT  
		Size: 4.1 KB (4147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
