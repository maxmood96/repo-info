...
```console
$ docker pull wordpress@sha256:4cba9f91c273dc3a91b7a1a826f20efb64a9d90e5bf9f142899db422fe09f6fc
```
...
### `wordpress:6.5-php8.2-apache` - linux; amd64
...
### `wordpress:6.5-php8.2-apache` - unknown; unknown
...
### `wordpress:6.5-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.5-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.5-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.5-php8.2-apache` - linux; 386
...
### `wordpress:6.5-php8.2-apache` - linux; mips64le
...
### `wordpress:6.5-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.5-php8.2-apache` - linux; s390x
