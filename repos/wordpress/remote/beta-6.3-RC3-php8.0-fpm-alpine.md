...
```console
$ docker pull wordpress@sha256:26ad74fc881a7a9147cac3b60888431c3b3c9ee10bc2d9975affba5970220c29
```
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; 386
