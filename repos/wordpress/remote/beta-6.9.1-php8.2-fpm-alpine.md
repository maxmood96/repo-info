...
```console
$ docker pull wordpress@sha256:ed7dea1ba9868315c1d52bf647847c9bb3a1e790626fd46d2efc18a37df07d83
```
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9.1-php8.2-fpm-alpine` - linux; s390x
