...
```console
$ docker pull wordpress@sha256:064fa36867544c031c69214cd9f56ceab88b4cb8e7ba35105ac2a6c050004209
```
...
### `wordpress:beta-6.9-beta1-apache` - linux; amd64
...
### `wordpress:beta-6.9-beta1-apache` - unknown; unknown
...
### `wordpress:beta-6.9-beta1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.9-beta1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta1-apache` - linux; 386
...
### `wordpress:beta-6.9-beta1-apache` - linux; ppc64le
