...
```console
$ docker pull wordpress@sha256:f91d228a679ebcc56c37ef538b8230d855b1ff22e73c90e335ef41b177804afd
```
...
### `wordpress:beta-6.9-beta3-fpm` - linux; amd64
...
### `wordpress:beta-6.9-beta3-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-beta3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-beta3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta3-fpm` - linux; 386
...
### `wordpress:beta-6.9-beta3-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-beta3-fpm` - linux; s390x
