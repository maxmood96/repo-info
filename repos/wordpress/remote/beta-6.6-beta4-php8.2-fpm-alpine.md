...
```console
$ docker pull wordpress@sha256:133b7b0d8d64bf30e104bd1ddfb35e000643a5fdb2a38aed292513be414a3e8c
```
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.6-beta4-php8.2-fpm-alpine` - linux; s390x
