...
```console
$ docker pull wordpress@sha256:e9a115cac7913b00781e27f2aeda086008e9fb09587bf919400e469cbda56f89
```
...
### `wordpress:7.0.0-php8.2-apache` - linux; amd64
...
### `wordpress:7.0.0-php8.2-apache` - unknown; unknown
...
### `wordpress:7.0.0-php8.2-apache` - linux; arm variant v5
...
### `wordpress:7.0.0-php8.2-apache` - linux; arm variant v7
...
### `wordpress:7.0.0-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:7.0.0-php8.2-apache` - linux; 386
...
### `wordpress:7.0.0-php8.2-apache` - linux; ppc64le
...
### `wordpress:7.0.0-php8.2-apache` - linux; riscv64
...
### `wordpress:7.0.0-php8.2-apache` - linux; s390x
