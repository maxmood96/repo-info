...
```console
$ docker pull wordpress@sha256:428fed08936238ac5dccdf83a207b131869af477c83590e942c37776668d6559
```
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; amd64
...
### `wordpress:beta-7.0-RC1-php8.5` - unknown; unknown
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; 386
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; ppc64le
...
### `wordpress:beta-7.0-RC1-php8.5` - linux; s390x
