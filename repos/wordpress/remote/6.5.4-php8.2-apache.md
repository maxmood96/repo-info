...
```console
$ docker pull wordpress@sha256:3a396c7e4f13a3aa3c840d539c448db1be58a317c3f6d0f755a962ffc28fad33
```
...
### `wordpress:6.5.4-php8.2-apache` - linux; amd64
...
### `wordpress:6.5.4-php8.2-apache` - unknown; unknown
...
### `wordpress:6.5.4-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.5.4-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.5.4-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.5.4-php8.2-apache` - linux; 386
...
### `wordpress:6.5.4-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.5.4-php8.2-apache` - linux; s390x
