...
```console
$ docker pull wordpress@sha256:a1987ce2ceca037e21fe1a39a46d72d42cd32e590e1ea9a341b9c995f3b79598
```
...
```console
$ docker pull wordpress@sha256:d16ab49e43b48979479e8b03ea6c6f781b91bff5bf9d4aa1e79a94a4a7868cbc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.9 MB (163939419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51121d495948492803c1dddf20e10511050f68c38d35f1cabf0922f51c24a4ce`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Tue, 09 Jun 2020 14:56:44 GMT
ENV WORDPRESS_VERSION=5.4.1
# Tue, 09 Jun 2020 14:56:45 GMT
ENV WORDPRESS_SHA1=9800c231828eb5cd76ba0b8aa6c1a74dfca2daff
# Tue, 09 Jun 2020 14:56:51 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Tue, 09 Jun 2020 14:56:52 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Tue, 09 Jun 2020 14:56:53 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 09 Jun 2020 14:56:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5fb0404c56439bdc3fbe3515ac23f8a15822dbd4c970cfe58633d0d583f725c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6575d04f11336f64ce12f5e95afde823f6a66b301463f253e098c8601dd3f6c`  
		Last Modified: Tue, 09 Jun 2020 15:21:45 GMT  
		Size: 12.1 MB (12079468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea5e8687d2b22b2fe6157b4d861976c32f1c0674e1714b8050e61cc85487f893`  
		Last Modified: Tue, 09 Jun 2020 15:21:39 GMT  
...
```console
$ docker pull wordpress@sha256:b66fc8b33c831b43aa16e29293d186144a18ee9e81377eddc5ce972145d2daa9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171446806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:258c6157cca400e742dbc4bc46b6cd2cba2100711f7f4d7a47ac72a43107d675`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 09 Jun 2020 17:02:31 GMT
ENV WORDPRESS_SHA1=9800c231828eb5cd76ba0b8aa6c1a74dfca2daff
# Tue, 09 Jun 2020 17:02:34 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Tue, 09 Jun 2020 17:02:35 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Tue, 09 Jun 2020 17:02:35 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 09 Jun 2020 17:02:35 GMT
...
-	Layers:
	...
	-	`sha256:001919268ac0a7ad687468dc13c0446e8e03ca07546ed884fec3e6c054e5b68c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eff702c6f3dee0ec24ec46b0afcdcf26124ea4aaee8b0aea28ef06aaa38e125a`  
		Last Modified: Tue, 09 Jun 2020 17:13:33 GMT  
		Size: 12.1 MB (12079454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c13c281ef00072c723435fc888b72517d30d0683a87b0d9716d02ae55d217401`  
		Last Modified: Tue, 09 Jun 2020 17:13:35 GMT  
