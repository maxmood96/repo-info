...
```console
$ docker pull wordpress@sha256:c59344c093c0d1c42e478d1145931de0b92064877ed3bdca68b716b6dff3e524
```
...
### `wordpress:beta-5.7-RC1-apache` - linux; amd64
...
### `wordpress:beta-5.7-RC1-apache` - linux; arm variant v5
...
### `wordpress:beta-5.7-RC1-apache` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC1-apache` - linux; 386
...
### `wordpress:beta-5.7-RC1-apache` - linux; mips64le
...
### `wordpress:beta-5.7-RC1-apache` - linux; s390x
