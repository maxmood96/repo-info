...
```console
$ docker pull wordpress@sha256:ac5584994cb64bdbdeb6a7bf87fedcc5fdda315f8f58ccbcc680aa22aeec5a84
```
...
### `wordpress:beta-6.6-RC2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6-RC2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.6-RC2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-RC2-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-6.6-RC2-php8.3-fpm` - linux; s390x
