...
### `wordpress:beta-6.4.3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.4.3-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.4.3-php8.1-fpm-alpine` - linux; s390x
