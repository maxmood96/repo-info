...
```console
$ docker pull wordpress@sha256:4a7f88213a38cc73ea6b776121e536038ec5cd41457bf5b07df2ad6c5bbe3615
```
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; amd64
...
### `wordpress:beta-6.5-RC2-php8.1` - unknown; unknown
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; 386
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; mips64le
...
### `wordpress:beta-6.5-RC2-php8.1` - linux; ppc64le
