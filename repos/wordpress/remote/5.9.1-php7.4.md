...
```console
$ docker pull wordpress@sha256:92c00c2a7c7fd4c2da21aa6faf8ee9a97332ed2f72a26b2842c4e50eb65e96b6
```
...
### `wordpress:5.9.1-php7.4` - linux; amd64
...
### `wordpress:5.9.1-php7.4` - linux; arm variant v5
...
### `wordpress:5.9.1-php7.4` - linux; arm64 variant v8
...
### `wordpress:5.9.1-php7.4` - linux; mips64le
...
### `wordpress:5.9.1-php7.4` - linux; ppc64le
...
### `wordpress:5.9.1-php7.4` - linux; s390x
