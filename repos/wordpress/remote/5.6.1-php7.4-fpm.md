...
```console
$ docker pull wordpress@sha256:346aa36ab3b2c243e7d72cf1519dcf05ccb363d4674db9297d1887e39ca897c6
```
...
### `wordpress:5.6.1-php7.4-fpm` - linux; amd64
...
### `wordpress:5.6.1-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:5.6.1-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:5.6.1-php7.4-fpm` - linux; 386
...
### `wordpress:5.6.1-php7.4-fpm` - linux; mips64le
...
### `wordpress:5.6.1-php7.4-fpm` - linux; s390x
