...
### `wordpress:beta-6.5-RC3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC3-fpm` - unknown; unknown
...
### `wordpress:beta-6.5-RC3-fpm` - linux; 386
...
### `wordpress:beta-6.5-RC3-fpm` - linux; mips64le
...
### `wordpress:beta-6.5-RC3-fpm` - linux; ppc64le
