...
```console
$ docker pull wordpress@sha256:c5a6dc7a3a2b88902a227b67ebb32acaec2f3d1ba31379d5838f4f69dc206751
```
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.4.3-php8.2-fpm-alpine` - linux; s390x
