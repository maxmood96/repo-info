...
```console
$ docker pull wordpress@sha256:d8c65b79f0d41be0a3665d28e6de3b566e5fc5d3dd24b12433f62b3c36236614
```
...
### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:0676b0a53839a461464e872cffb6fee5afda518366dd78acb8f85cb32a1ae4cb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.8 MB (92790807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ed71003b06beadca8f5106d7ba338796a487e9210d1adf97febe1b339d25ce3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Sep 2022 05:54:16 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 30 Sep 2022 05:54:20 GMT
RUN set -eux; 	version='6.0.2'; 	sha1='9348f0757c21504d085a6c866ccbb86573b39d6f'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 30 Sep 2022 05:54:20 GMT
VOLUME [/var/www/html]
# Fri, 30 Sep 2022 05:54:21 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Fri, 30 Sep 2022 05:54:21 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 30 Sep 2022 05:54:21 GMT
...
-	Layers:
	...
	-	`sha256:b01d03c3c98cb6506bf566911cb8d7b12759057dfedb2f6936a6ed701cde9493`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0bf60802e5f58e3299541945210fd2c64c20cad2646210cc34acbd5215ad392`  
		Last Modified: Fri, 30 Sep 2022 06:09:24 GMT  
		Size: 21.0 MB (20995573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03108b8b74cf8190262413b3d8dadd75292fcea1521d9a879268fec08f3d02a2`  
		Last Modified: Fri, 30 Sep 2022 06:09:19 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a4af9d1604040685c704c5c4067a878617e51930d2be5348ebb089956960e79`  
		Last Modified: Fri, 30 Sep 2022 06:09:19 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:b7ca0c8efeb4f1183d2535b4978da26874acb27a90ce1402bab64423952c2fab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.3 MB (101266529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc0aab5e29bc015cb112247cc4c2ec6027191ef942bcca28c8557eeff64a263d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 22:03:03 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 22:03:05 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 22:03:06 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:03:06 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 22:03:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2b2f7c2a3ffd62cbcc79f5a65b2ee6cf95b1060c885b6292d0e919db76ff9917`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5829031dcbb970b262b4e4e0bbe54ed21a730fdc037e982c1b300a4463dda004`  
		Last Modified: Thu, 29 Sep 2022 22:12:42 GMT  
		Size: 21.0 MB (20999006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5e5366e09a3a4c7663d6c013f75ec1df5800abddc0265e7803de2f21ffeac9d`  
		Last Modified: Thu, 29 Sep 2022 22:12:39 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e52354275fb13b693fc0f043ce620097c5c0c377bcd93e9a0501c5fa3112cf6`  
		Last Modified: Thu, 29 Sep 2022 22:12:38 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.0.2-php8.1-fpm-alpine` - linux; s390x
