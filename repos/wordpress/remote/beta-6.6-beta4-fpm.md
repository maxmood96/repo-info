...
```console
$ docker pull wordpress@sha256:86ec4a15d9ed1712d2dd1f9290d0a00eaab4f180ec3056c3402810fc21d94487
```
...
### `wordpress:beta-6.6-beta4-fpm` - linux; amd64
...
### `wordpress:beta-6.6-beta4-fpm` - unknown; unknown
...
### `wordpress:beta-6.6-beta4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6-beta4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-beta4-fpm` - linux; 386
...
### `wordpress:beta-6.6-beta4-fpm` - linux; mips64le
...
### `wordpress:beta-6.6-beta4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.6-beta4-fpm` - linux; s390x
