...
### `wordpress:5.3.1-php7.4-apache` - linux; amd64
...
### `wordpress:5.3.1-php7.4-apache` - linux; arm variant v7
...
### `wordpress:5.3.1-php7.4-apache` - linux; 386
...
### `wordpress:5.3.1-php7.4-apache` - linux; ppc64le
