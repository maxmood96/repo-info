...
```console
$ docker pull wordpress@sha256:5c191db76160bb484d72beb31ce2954524047fa1b22c214c5acb80de718f656c
```
...
### `wordpress:beta-6.5-apache` - linux; amd64
...
### `wordpress:beta-6.5-apache` - unknown; unknown
...
### `wordpress:beta-6.5-apache` - linux; arm variant v5
...
### `wordpress:beta-6.5-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-apache` - linux; 386
...
### `wordpress:beta-6.5-apache` - linux; mips64le
...
### `wordpress:beta-6.5-apache` - linux; ppc64le
...
### `wordpress:beta-6.5-apache` - linux; s390x
