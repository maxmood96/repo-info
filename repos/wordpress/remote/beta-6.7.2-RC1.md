...
### `wordpress:beta-6.7.2-RC1` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC1` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC1` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC1` - linux; ppc64le
...
### `wordpress:beta-6.7.2-RC1` - linux; s390x
