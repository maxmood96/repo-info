...
```console
$ docker pull wordpress@sha256:32b04818d35625eec47a37e5ade9ccbc19fa83cf81d02f9b7652b830d62646c1
```
...
### `wordpress:beta-6.7-RC2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.7-RC2-fpm` - unknown; unknown
...
### `wordpress:beta-6.7-RC2-fpm` - linux; s390x
