...
```console
$ docker pull wordpress@sha256:790564183caf118dbf0c46efc860e19c78dd2e08df9d7d3d92f0f06da2c07af9
```
...
### `wordpress:beta-6.5-beta2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-beta2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-php8.1-fpm-alpine` - linux; s390x
