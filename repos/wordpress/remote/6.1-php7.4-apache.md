...
```console
$ docker pull wordpress@sha256:99ab985611f9a317de8cfdc13d2e0bf79035280d5e9ceab51079439e5dc5472a
```
...
### `wordpress:6.1-php7.4-apache` - linux; amd64
...
### `wordpress:6.1-php7.4-apache` - linux; arm variant v5
...
### `wordpress:6.1-php7.4-apache` - linux; arm variant v7
...
### `wordpress:6.1-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:6.1-php7.4-apache` - linux; 386
...
### `wordpress:6.1-php7.4-apache` - linux; mips64le
...
### `wordpress:6.1-php7.4-apache` - linux; ppc64le
...
### `wordpress:6.1-php7.4-apache` - linux; s390x
