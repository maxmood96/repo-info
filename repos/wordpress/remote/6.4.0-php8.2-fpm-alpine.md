## `wordpress:6.4.0-php8.2-fpm-alpine`

```console
$ docker pull wordpress@sha256:e798cace2a5f1010a20ca21cae0be1bdec84d81bbaa522008308d7b094ff533d
```
...
### `wordpress:6.4.0-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.4.0-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.4.0-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.4.0-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:6.4.0-php8.2-fpm-alpine` - linux; s390x
