...
### `wordpress:beta-6.5-RC3-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.5-RC3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.5-RC3-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC3-php8.2-fpm` - linux; s390x
