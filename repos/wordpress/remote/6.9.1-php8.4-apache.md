...
### `wordpress:6.9.1-php8.4-apache` - linux; amd64
...
### `wordpress:6.9.1-php8.4-apache` - unknown; unknown
...
### `wordpress:6.9.1-php8.4-apache` - linux; arm variant v5
...
### `wordpress:6.9.1-php8.4-apache` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.4-apache` - linux; 386
...
### `wordpress:6.9.1-php8.4-apache` - linux; ppc64le
...
### `wordpress:6.9.1-php8.4-apache` - linux; riscv64
...
### `wordpress:6.9.1-php8.4-apache` - linux; s390x
