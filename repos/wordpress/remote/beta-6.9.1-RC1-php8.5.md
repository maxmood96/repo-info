...
```console
$ docker pull wordpress@sha256:e9936b8a4f61a534e2ebd1b75afd988a4f4769c3ca6577e9d07aa9ee90de9950
```
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; amd64
...
### `wordpress:beta-6.9.1-RC1-php8.5` - unknown; unknown
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; arm variant v5
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; 386
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; ppc64le
...
### `wordpress:beta-6.9.1-RC1-php8.5` - linux; s390x
