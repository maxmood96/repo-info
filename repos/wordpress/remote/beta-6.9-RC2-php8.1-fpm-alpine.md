...
```console
$ docker pull wordpress@sha256:f324aaefcd3b187f14481892863056e979a2e2db3eff0ac7939e875a563ba155
```
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-php8.1-fpm-alpine` - linux; s390x
