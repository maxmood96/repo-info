## `wordpress:beta-6.0-RC3-fpm`

```console
$ docker pull wordpress@sha256:053cae83e5d58837301385cce53245e1c9ada2e50932d61b9cd6ece0d3825503
```
...
### `wordpress:beta-6.0-RC3-fpm` - linux; amd64
...
### `wordpress:beta-6.0-RC3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC3-fpm` - linux; 386
...
### `wordpress:beta-6.0-RC3-fpm` - linux; mips64le
...
### `wordpress:beta-6.0-RC3-fpm` - linux; s390x
