...
```console
$ docker pull wordpress@sha256:9cb6a888870803c8504a42baf80366a12e160b5e2a135263a1733ca18b69a3b2
```
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC3-php8.1-fpm` - linux; s390x
