...
```console
$ docker pull wordpress@sha256:e3be26c15faad24fa175e30db4d3df4248e05454a7bfd71a470d5b9b5c97d0af
```
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; amd64
...
### `wordpress:beta-6.9.1-RC1-fpm` - unknown; unknown
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; 386
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9.1-RC1-fpm` - linux; s390x
