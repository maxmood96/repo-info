...
```console
$ docker pull wordpress@sha256:7740e3245b0e08c3f044bbdd5f68f36807b68f4b1053b34c0d1aa693a5e1d2d9
```
...
```console
$ docker pull wordpress@sha256:9e74f012541b5011295f76abd996b4083dc334fe1c387a80198572502162838f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.3 MB (103251061 bytes)**  
...
-	Layers:
	...
	-	`sha256:058ca99062a412f462f8ffa388d6f0ca3f2bc112d9dbe0b7e643a2e8e155ba90`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a5c078f00a69b291f75d17411e2d76401427edfbe18fdf1a04c7d642e82fa7e`  
		Last Modified: Mon, 04 Sep 2023 15:36:06 GMT  
		Size: 23.3 MB (23275175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2418013f7601dd0edaa1a84822f74f6ff6c2be1e2e474af3f89bb68862759069`  
		Last Modified: Mon, 04 Sep 2023 15:36:03 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9914ef3f538480d16cbe889b4e5d1ab850fafa631d974a0758deb0580d270804`  
		Last Modified: Mon, 04 Sep 2023 15:36:03 GMT  
...
```console
$ docker pull wordpress@sha256:1681495f4feebd3b3fca8f7f511d5143ede9ea6413d058f0b8225b1f95a1442d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.5 MB (97515347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cf29fa4521c4a1b97e5f93919c2d90a4cc991c62c730c75f8e93332bcc98fff`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Sep 2023 02:50:54 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 29 Sep 2023 02:51:00 GMT
RUN set -eux; 	version='6.3.1'; 	sha1='052777aef40e7f627c63c8a26eefe37b843a44df'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 29 Sep 2023 02:51:00 GMT
VOLUME [/var/www/html]
# Fri, 29 Sep 2023 02:51:01 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 29 Sep 2023 02:51:01 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Fri, 29 Sep 2023 02:51:01 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 29 Sep 2023 02:51:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8ffa85ce9fcece0cf33a4db9d553937bdc3fc46ee6612249088e4b4973da0613`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c26114b45dd73b4f9dbc02e4f9cfc73f3a1c1a12648fa4adbdf22bf71b5ce52d`  
		Last Modified: Fri, 29 Sep 2023 02:55:36 GMT  
		Size: 23.3 MB (23275173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:476373345656bcc3ebca28f61b3e5ff3661f8881259730a8850c7f0425037f53`  
		Last Modified: Fri, 29 Sep 2023 02:55:31 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aaee324878a7f55e738c9eb9a6087e4064e7d2668a7876c84b7a466ce9df7bf`  
		Last Modified: Fri, 29 Sep 2023 02:55:31 GMT  
...
```console
$ docker pull wordpress@sha256:ca70d1d9f650daf8a94df1fff861fb83bfb51a1970c3c059da210c2efb5bb7a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.2 MB (94225766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46516a365fd76d06372e42ca4bdf27cd9f07ff4833400045e7d19a4c44555f31`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Sep 2023 04:12:12 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 29 Sep 2023 04:12:16 GMT
RUN set -eux; 	version='6.3.1'; 	sha1='052777aef40e7f627c63c8a26eefe37b843a44df'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 29 Sep 2023 04:12:17 GMT
VOLUME [/var/www/html]
# Fri, 29 Sep 2023 04:12:17 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 29 Sep 2023 04:12:17 GMT
...
-	Layers:
	...
	-	`sha256:5761e2dca3d972bdd2f4b61532bef318b1ff584af2da0e1aa760fef7c61c544f`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:932cc96f22b845181c90f1590c89746f1edb1187954c7043b81b6b07865fdba2`  
		Last Modified: Fri, 29 Sep 2023 04:17:48 GMT  
		Size: 23.3 MB (23275173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e421b94c42adfbe4720ea786172572cd263ed46b637dafd9b98e59eceef65324`  
		Last Modified: Fri, 29 Sep 2023 04:17:44 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d03b2aeb618446506b79644bf26940f610b836ccebd60f26997de2c4f10a6b09`  
		Last Modified: Fri, 29 Sep 2023 04:17:44 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:7e68758b25c9ca74f7771bf9deda47af4ae19f1416b0453adcc2736a15606831
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102528874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e68b2fc5416b5f4cc4e1e88156ed6b8209e7df150caf8a6e99711b915ef9cd1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:644848c43bc28e21d5f8dde70057864a9b655a2fe28fe491164dc5218e5074a7`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b1629f5565cbefb2035085996522e77057e6a2588c4bec578d0bfbd979b2e35`  
		Last Modified: Fri, 29 Sep 2023 04:02:14 GMT  
		Size: 23.3 MB (23275171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:898eb616f3b2459ad5d22cc523143b2ae9b66229472991a3ef057ee34b09d67e`  
		Last Modified: Fri, 29 Sep 2023 04:02:10 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:832ab3b2785daab77e24df75c0d415854eb02d953316d733e8b1e1e184d10902`  
		Last Modified: Fri, 29 Sep 2023 04:02:10 GMT  
...
```console
$ docker pull wordpress@sha256:3e29ab46d8558e4a81e491e2230b038d7a532ce50e41d3da3cc2ff3bcd260246
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.2 MB (100217261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91f9db18a0264a92261e64856dbb220f89cedfd329c76aff4e9b2400a011b0e6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:cc3dd41109bc5177db772efb81810d1bdf80658d7f550d552fab3094750535a7`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11431e907cdd3ec1f5367669d29bf90810517ccaad1cb9055a2b78ab1a0bc35c`  
		Last Modified: Sat, 02 Sep 2023 10:48:51 GMT  
		Size: 23.3 MB (23275169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4172053e3f08a1c14277b5f5dfc8ebc26875369930705f284de571c006e98844`  
		Last Modified: Sat, 02 Sep 2023 10:48:45 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:784ded8b06d51cbd12045ecbf66f1a441aff46e1294e804d7d47d7a4daec2352`  
		Last Modified: Sat, 02 Sep 2023 10:48:45 GMT  
...
```console
$ docker pull wordpress@sha256:9d7c07650596a1d429c7adc300964bf923a75c231344324ecc3b5db710198508
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.8 MB (108757011 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47e9b0285ff8bc933f56ce82bca06f6e1d018d1e10d5c09af2f033a1bbac79f9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 29 Sep 2023 04:23:13 GMT
RUN set -eux; 	version='6.3.1'; 	sha1='052777aef40e7f627c63c8a26eefe37b843a44df'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 29 Sep 2023 04:23:18 GMT
VOLUME [/var/www/html]
# Fri, 29 Sep 2023 04:23:20 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
...
-	Layers:
	...
	-	`sha256:d18ae9bc0e9a759f99d4e9cb063496bbc9b69d0f88458cded857031745dec58c`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e65a0ecd2fba86bad9b98fc89f304fb30f896f3ad4c5d81007a624f6e8b910`  
		Last Modified: Fri, 29 Sep 2023 04:33:18 GMT  
		Size: 23.3 MB (23275174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7386272d066cc6da45be88df38f5066ad771271555730e05d12fc842f3f2ccd4`  
		Last Modified: Fri, 29 Sep 2023 04:33:10 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de218378309e25981511feca4b976faaa824fb6e265442fb788d025317b4ad8a`  
		Last Modified: Fri, 29 Sep 2023 04:33:11 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
