...
```console
$ docker pull wordpress@sha256:705cd2da04d739f8d59942f9a9ae6e967f5df8b6346a0207fbe94cff7b0faf9e
```
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; amd64
...
### `wordpress:beta-7.0-beta5-php8.4` - unknown; unknown
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; 386
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; ppc64le
...
### `wordpress:beta-7.0-beta5-php8.4` - linux; s390x
