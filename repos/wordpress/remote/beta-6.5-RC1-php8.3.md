...
```console
$ docker pull wordpress@sha256:8aba80aa381373d265c7ac9f32b444bd2bec5ba6708f9b1a01c7c5c86e257908
```
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; amd64
...
### `wordpress:beta-6.5-RC1-php8.3` - unknown; unknown
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; arm variant v5
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; 386
...
### `wordpress:beta-6.5-RC1-php8.3` - linux; ppc64le
