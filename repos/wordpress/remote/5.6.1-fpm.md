...
```console
$ docker pull wordpress@sha256:5099d99ccad641a02d84bbce29a35d1384ef9e6a1e68e95bd635cddd3a136d13
```
...
### `wordpress:5.6.1-fpm` - linux; amd64
...
### `wordpress:5.6.1-fpm` - linux; ppc64le
...
### `wordpress:5.6.1-fpm` - linux; s390x
