...
```console
$ docker pull wordpress@sha256:fbf29181389b316c4bccde5ee16499cafbc211278238ce695141211be3737d71
```
...
```console
$ docker pull wordpress@sha256:a06a787820895dd55c0fe8552b5a9b395063f34880385b7cea2aa4c46d985b56
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186912898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fabb34543eb56f3e7d0914dd723ba55fa14cb652936739506c8bea4488393a50`
...
# Wed, 05 Aug 2020 20:41:04 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Aug 2020 20:42:23 GMT
...
-	Layers:
	...
	-	`sha256:eb86126ffc554f0acfe9f6a42120e9e6c5c4c2b0d2867b26ce3227ae7a60b151`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4fb83b837570f50cc3e90ffb489152710aba8c5069d29a29e6f848b477caf23`  
		Last Modified: Wed, 05 Aug 2020 20:52:25 GMT  
		Size: 16.7 MB (16704199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:203ee4683f8e6c887951ee57feba1aa69404d0b874ee2e20a0a69c8f601d8233`  
		Last Modified: Wed, 05 Aug 2020 20:52:23 GMT  
		Size: 9.3 MB (9266842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c12456cb044f2360a3f706a0bb27c40f14d6aa1ba99b2c95ea4a5884282e2e21`  
		Last Modified: Wed, 05 Aug 2020 20:52:20 GMT  
		Size: 407.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34335ec4e9a91e7e6e9f4fdcb7e86c370e8da9036fca16526402d51c80319d8e`  
		Last Modified: Wed, 05 Aug 2020 20:52:20 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7781fd3f2974f535debfdb0f92775569a50844b1342f084330dbb62a127a291`  
		Last Modified: Wed, 05 Aug 2020 20:52:20 GMT  
		Size: 19.5 KB (19469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ab79c0afc374fc7d5244a080096af916807e017e03623766e507a47b7824461`  
		Last Modified: Wed, 05 Aug 2020 20:52:24 GMT  
		Size: 12.1 MB (12082656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88b30c20be484f309581f1f777399d719f96c4fbbe83db76e8c1ef39d455204f`  
		Last Modified: Wed, 05 Aug 2020 20:52:20 GMT  
...
```console
$ docker pull wordpress@sha256:82e378c743ab53876f2b95a9e4f4e5cebc12ccbd2d1dc5db3d8146d42903feea
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177316404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f28b46c51f8eef4b41a192ba84c062a47f5b55d774dfb7fe364852dc4ab34077`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 05 Aug 2020 12:01:19 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Aug 2020 12:03:54 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Aug 2020 12:03:56 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 05 Aug 2020 12:03:58 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Aug 2020 12:04:01 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 05 Aug 2020 12:04:01 GMT
ENV WORDPRESS_VERSION=5.4.2
# Wed, 05 Aug 2020 12:04:02 GMT
ENV WORDPRESS_SHA1=e5631f812232fbd45d3431783d3db2e0d5670d2d
# Wed, 05 Aug 2020 12:04:06 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 05 Aug 2020 12:04:07 GMT
VOLUME [/var/www/html]
# Wed, 05 Aug 2020 12:04:08 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 05 Aug 2020 12:04:08 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 05 Aug 2020 12:04:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d6375ea88ed5bee2b2a5036f86b44a80eba6789794057ee74ca6f62c8c781870`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34417610bea91e1e093d4d0eae43a13fce5899ac2211445ceb105317e114a37c`  
		Last Modified: Wed, 05 Aug 2020 12:21:04 GMT  
		Size: 16.6 MB (16648982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7c6c1e942b17c8006b8374a3c5bb6bd894a0d57c4ae44bf10c78e740bafb5e`  
		Last Modified: Wed, 05 Aug 2020 12:21:01 GMT  
		Size: 7.7 MB (7682716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2155f3db4e2f8f0a89cbed977888c9f01f05d22b57d932f55fb4c65506ab3128`  
		Last Modified: Wed, 05 Aug 2020 12:20:57 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1d78b26563deee488e5bd85a27e44b8be6fe4862052b5700c918f4e17b7e55b`  
		Last Modified: Wed, 05 Aug 2020 12:20:57 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acdac56c858704ca4456a28574d66538699294b8c9625a92d084870b9d1a327d`  
		Last Modified: Wed, 05 Aug 2020 12:20:57 GMT  
		Size: 19.5 KB (19494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:393d34aedcc3e4072afb52d7304336047aa68331decc8c0b44d173e9d8b1da5a`  
		Last Modified: Wed, 05 Aug 2020 12:21:01 GMT  
		Size: 12.1 MB (12082658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ffdc86ef452e4f603c3eaee9c469b1bf0c92643aa544c83a784f62c8498409b`  
		Last Modified: Wed, 05 Aug 2020 12:20:57 GMT  
