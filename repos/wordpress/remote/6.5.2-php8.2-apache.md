...
```console
$ docker pull wordpress@sha256:49af2b2edc7a209f472993f373e3340bff07ec6486c750b4d6f2681275818b65
```
...
### `wordpress:6.5.2-php8.2-apache` - linux; amd64
...
### `wordpress:6.5.2-php8.2-apache` - unknown; unknown
...
### `wordpress:6.5.2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.5.2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.5.2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.5.2-php8.2-apache` - linux; 386
...
### `wordpress:6.5.2-php8.2-apache` - linux; mips64le
...
### `wordpress:6.5.2-php8.2-apache` - linux; ppc64le
