...
```console
$ docker pull wordpress@sha256:dc5bc0f3d2e09505e84ad1f797593589779621c0a57b3d3b1050b3313cd4d755
```
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; riscv64
...
### `wordpress:beta-7.0-RC1-php8.3-fpm` - linux; s390x
