...
```console
$ docker pull wordpress@sha256:ca13dfe912378f481e1bd3cfbfb248297021f8aae704c6013cbf4e88ab49efbe
```
...
### `wordpress:6.5.4-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.5.4-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.5.4-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.5.4-php8.3-fpm-alpine` - linux; s390x
