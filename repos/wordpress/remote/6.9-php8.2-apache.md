...
```console
$ docker pull wordpress@sha256:d18cc831be975e0566e194c8dc0cce3caca6537d8d404b2f83ccca412317b452
```
...
### `wordpress:6.9-php8.2-apache` - linux; amd64
...
### `wordpress:6.9-php8.2-apache` - unknown; unknown
...
### `wordpress:6.9-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.9-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.9-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.9-php8.2-apache` - linux; 386
...
### `wordpress:6.9-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.9-php8.2-apache` - linux; riscv64
...
### `wordpress:6.9-php8.2-apache` - linux; s390x
