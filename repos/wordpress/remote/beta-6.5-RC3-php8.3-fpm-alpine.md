...
```console
$ docker pull wordpress@sha256:0bdf82e17d1a9cb4a2f5d0531407e95715edb5e3400221d9249ca0daf769bf2d
```
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC3-php8.3-fpm-alpine` - linux; s390x
