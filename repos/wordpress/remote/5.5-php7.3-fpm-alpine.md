...
```console
$ docker pull wordpress@sha256:47b13f4700add4b082d4f4acce40ccc4efa2f8a8edb414cd40b47117f5f69af1
```
...
```console
$ docker pull wordpress@sha256:02e22623aad924a2244f1a6c92badb501c997e686332d7ebc05e3fed48601726
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.2 MB (74213197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f3c162bdca878b47a726896a7b9340384e5188d47cd2e3dcab2651b4a207bd8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 02 Sep 2020 04:12:21 GMT
ENV WORDPRESS_VERSION=5.5
# Wed, 02 Sep 2020 04:12:28 GMT
ENV WORDPRESS_SHA1=03fe1a139b3cd987cc588ba95fab2460cba2a89e
# Wed, 02 Sep 2020 04:12:52 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 04:12:57 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 04:13:06 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 04:13:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 04:13:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:628c20f3aa13ca8fc95f167e5258a99e98273f8ea6a62cf1d767e999fa2a3dbd`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9167823a68fe8cf720835e44c0707f15e8eee52d8dfd285422347d5507a74b5a`  
		Last Modified: Wed, 02 Sep 2020 04:43:43 GMT  
		Size: 12.8 MB (12836948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:062da10a51e80662716b5415e1337a6872758cfc72792fb995314cf546dca230`  
		Last Modified: Wed, 02 Sep 2020 04:43:37 GMT  
...
```console
$ docker pull wordpress@sha256:d91a9d1ae664867c684731df923d1689b3ae541ec8180c1b97912b3af62b879a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.9 MB (81916220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b6f0beb9d753bc09ef15a190f450844f66ec151961de75641bd9c30ad6a42cb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 02 Sep 2020 01:12:21 GMT
ENV WORDPRESS_VERSION=5.5
# Wed, 02 Sep 2020 01:12:26 GMT
ENV WORDPRESS_SHA1=03fe1a139b3cd987cc588ba95fab2460cba2a89e
# Wed, 02 Sep 2020 01:12:37 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 01:12:43 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 01:12:44 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 01:12:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 01:12:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dc9ec9c74bd7d8a35d52b2089fa16da4daaa0bfbd2dd6b3d0e4f24809745ef3f`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5465cf5a0d56d244eb41afe99a819d2ed02f53a8f237231d20f8b58164148894`  
		Last Modified: Wed, 02 Sep 2020 01:49:45 GMT  
		Size: 12.8 MB (12836944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfd278a314fbf3f65c32c6b7bf416d6cd6d1797a7d8e3d519b56276749b3c5f5`  
		Last Modified: Wed, 02 Sep 2020 01:49:41 GMT  
		Size: 4.1 KB (4149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
