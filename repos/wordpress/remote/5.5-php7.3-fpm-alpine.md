...
```console
$ docker pull wordpress@sha256:ded87ad46614a4db40d6905825800a8340970bad0f62aeb626be2ee837d01e35
```
...
```console
$ docker pull wordpress@sha256:ced798a6c6302803a1e7447cd89f1a28cb9087d9a47aaffddc577290e6d9f417
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.2 MB (80152202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6613b41e6ac9cd18f92c6ad004abbe63b5cb15b510199f4a59b4b06ed78f57f2`
...
-	Layers:
	...
	-	`sha256:f2eb1c332f90407ddce6f5aea47429e6eb8d3d07fde4e8c508d325233f10299e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab2a56af8e112731239645d7c0666bae8a13b836da4f28c8f778e808570c47d9`  
		Last Modified: Fri, 04 Sep 2020 01:13:33 GMT  
		Size: 32.9 MB (32898930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:789a65fe3bf5123a3f8dae3f59885ac9355928dcd9b0acab3fade64ee445ae79`  
		Last Modified: Fri, 04 Sep 2020 01:13:27 GMT  
		Size: 3.2 MB (3156518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f205972f5d30784db54e9f8e1e10974152ca22bcc5825a3217d9f31c6cb66330`  
		Last Modified: Fri, 04 Sep 2020 01:13:26 GMT  
		Size: 62.5 KB (62473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cb6ed0a01e8d802738e22ad96e58db166b7781f14b8bba2cf4b04fa866e85aa`  
		Last Modified: Fri, 04 Sep 2020 01:13:26 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cf88567f3e158335a8ff22e2d06c0ce0516de1142d52a188ee63eb53664b9a0`  
		Last Modified: Fri, 04 Sep 2020 01:13:30 GMT  
		Size: 12.8 MB (12848366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e61eb605c34b425f26fee7f6e82598ec4119365d9a3681cfae906d2a8777478`  
		Last Modified: Fri, 04 Sep 2020 01:13:26 GMT  
...
```console
$ docker pull wordpress@sha256:de9309893340f3a655d47b33adc339c86b9b79c0b8f0effa506d174446836642
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.8 MB (76794845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6deffe70f9e1e140f115c42202b26aa2123e13a623718fa312e8f9cdf6d87c0d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 03 Sep 2020 23:20:49 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Thu, 03 Sep 2020 23:22:41 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Thu, 03 Sep 2020 23:23:13 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 23:23:41 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 03 Sep 2020 23:23:45 GMT
ENV WORDPRESS_VERSION=5.5.1
# Thu, 03 Sep 2020 23:23:50 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Thu, 03 Sep 2020 23:24:24 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 03 Sep 2020 23:24:31 GMT
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 23:24:43 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Thu, 03 Sep 2020 23:24:46 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 03 Sep 2020 23:24:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:21aa2cb659e611a03615e2fc4c858e742dde55f4fe018228fd50a62d527f6e95`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba1ae450e42951b283584021e245f573891629c1e595de7a23c1fbd091671cf1`  
		Last Modified: Thu, 03 Sep 2020 23:40:41 GMT  
		Size: 31.1 MB (31128837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d44935709e2e84470baedfbbd66c5accca105e2dd7ed4505660dff2e62364b0c`  
		Last Modified: Thu, 03 Sep 2020 23:40:31 GMT  
		Size: 2.8 MB (2845293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cffa4a00a93e5ae54a98267bfc25eeb09289c69b5c5a2a39e7f511ec302c1eb`  
		Last Modified: Thu, 03 Sep 2020 23:40:29 GMT  
		Size: 62.5 KB (62549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:297b8b4066fbee4ffbe8220bfbf501f5df27b230018a69fb60a1fb24ede0652c`  
		Last Modified: Thu, 03 Sep 2020 23:40:29 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68eb8f90dec638e1341a517e806cb7a6e2120feefd4888c344da619420a1b680`  
		Last Modified: Thu, 03 Sep 2020 23:40:33 GMT  
		Size: 12.8 MB (12848422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed33a2c40df86e6f018d3711367d7d9d962d90dc249be28140afc258eaaab900`  
		Last Modified: Thu, 03 Sep 2020 23:40:28 GMT  
...
```console
$ docker pull wordpress@sha256:22065584ff037a4c62df8b473194fc137d3581cd52794247319cccd48923e3c0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.2 MB (74236677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43a871a7c504559bf106f8cd29ff82f0ad1adbf249eef1cb35719ee1126e1589`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Sep 2020 05:25:10 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Fri, 04 Sep 2020 05:26:17 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 04 Sep 2020 05:26:20 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 05:26:22 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 04 Sep 2020 05:26:23 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 04 Sep 2020 05:26:24 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 04 Sep 2020 05:26:30 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 04 Sep 2020 05:26:31 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 05:26:33 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 04 Sep 2020 05:26:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 04 Sep 2020 05:26:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4e535e0efc5cdededbedcbbb1d07f4013a36b13f59f3121802d3acfabf299786`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:938c4dad148103c44c083ee68d2b34a1ac69d1965a5c2e8ef85de6e7decba78a`  
		Last Modified: Fri, 04 Sep 2020 05:42:28 GMT  
		Size: 29.6 MB (29610941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49ca8838ea379b0ceb0985f2564ec0388d4d90c2c4c901abc62f3c0df32bd45c`  
		Last Modified: Fri, 04 Sep 2020 05:42:17 GMT  
		Size: 3.0 MB (2982952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeb289e85da8b2ac9122206ed98d949f59dcd805e294c4d91592169ca73e169a`  
		Last Modified: Fri, 04 Sep 2020 05:42:17 GMT  
		Size: 62.5 KB (62482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da0ea9f3b7acaeedf65b93b8ea4b47ed8743bf2519aecd66acd8c1ccd7cdb21c`  
		Last Modified: Fri, 04 Sep 2020 05:42:17 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e897122695c85afa5c015658c5171f3ccd696df45c8e4ba1b8891be0b80bd59d`  
		Last Modified: Fri, 04 Sep 2020 05:42:22 GMT  
		Size: 12.8 MB (12848450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ec2dc74e572252eb3c06bd3333d5096dbfc6beee31531c440451a1317138ae0`  
		Last Modified: Fri, 04 Sep 2020 05:42:17 GMT  
...
```console
$ docker pull wordpress@sha256:e7ff9dee6fa79848a9da44c6a94ebe55d7dc8eaff5c18fe15bd3564a23b8875e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **78.9 MB (78888941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a543d6ed832c3915eaef8e0276b1455dad4a97e9da6cccb087675e2039c86ad`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Sep 2020 02:05:52 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Fri, 04 Sep 2020 02:07:28 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 04 Sep 2020 02:07:47 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 02:08:02 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 04 Sep 2020 02:08:07 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 04 Sep 2020 02:08:14 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 04 Sep 2020 02:08:41 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 04 Sep 2020 02:08:48 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 02:08:53 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 04 Sep 2020 02:09:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 04 Sep 2020 02:09:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8f71ee337983119d9ddac11ed0883afddc881e4f3c51b91419e637a029acf522`  
		...
		Size: 8.4 KB (8416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d83d01366c28170f5a6492b337fa84026f1209fb1a156991944244e5ccacbbed`  
		Last Modified: Fri, 04 Sep 2020 02:33:46 GMT  
		Size: 32.0 MB (32030583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2c506581e64d871408fb4254567df6586723aeb30dd561eae4934c5b9067db8`  
		Last Modified: Fri, 04 Sep 2020 02:33:35 GMT  
		Size: 3.1 MB (3108426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3174304bddcded6f94caea23643131d97b4e674ea94bf587b45bf43865b674a4`  
		Last Modified: Fri, 04 Sep 2020 02:33:36 GMT  
		Size: 62.5 KB (62451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ba5d2ffcdf41afe58142b776485634cc8e8bca62eca396f13884ffdfa4511d5`  
		Last Modified: Fri, 04 Sep 2020 02:33:35 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1672b759517c27c3a800b7bceaab5ae7605d249c968c4220c564dfd2c6074066`  
		Last Modified: Fri, 04 Sep 2020 02:33:41 GMT  
		Size: 12.8 MB (12848410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c99cf537b6eb6647bd770e44d240ebef8ed6fd001d396dc3a398cc46349b42bc`  
		Last Modified: Fri, 04 Sep 2020 02:33:35 GMT  
...
```console
$ docker pull wordpress@sha256:9d8d9755d34d471eb23dba54f2ebc9c9aff9ad62108d593faa90db0b2946ee2d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.5 MB (81456028 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f381b7559ec8b1e39955d1f9dd043721331bff84fd3a973982e770107c325e1b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Sep 2020 01:42:47 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Fri, 04 Sep 2020 01:43:32 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 04 Sep 2020 01:43:34 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 01:43:34 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 04 Sep 2020 01:43:34 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 04 Sep 2020 01:43:35 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 04 Sep 2020 01:43:44 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 04 Sep 2020 01:43:44 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 01:43:44 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 04 Sep 2020 01:43:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 04 Sep 2020 01:43:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:139c440a934a35b37d8e2ffa8355995da406ff58b71b8c8c98845c99f93e0c73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1723deb12a9c8d5ec71f0f06a97a5947bf683b91ab90f1977ea706198287efa9`  
		Last Modified: Fri, 04 Sep 2020 01:52:34 GMT  
		Size: 33.8 MB (33800524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bfae1cddbfcd9eb26acf79f08ab85f3f868221984d87a15deee321abac8baa1`  
		Last Modified: Fri, 04 Sep 2020 01:52:25 GMT  
		Size: 3.1 MB (3107175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c12d565ae31764caa2d482dd29fe5de7fcc377f5e6ae62f919a983ca8121540`  
		Last Modified: Fri, 04 Sep 2020 01:52:24 GMT  
		Size: 62.4 KB (62449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b76563e0d48565398cf5252ea3d60958ad45beb847e4bcbf9be4d17a91770df1`  
		Last Modified: Fri, 04 Sep 2020 01:52:24 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45943bfb94deadbcd54ee9ff7687cd85a68dbb16cc767ec4032c52d5786ff6e9`  
		Last Modified: Fri, 04 Sep 2020 01:52:29 GMT  
		Size: 12.8 MB (12848365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00eea5737df4eb57f609b3bc19a4b6ca843f7892db90d980bd0b5dd7206b087`  
		Last Modified: Fri, 04 Sep 2020 01:52:24 GMT  
...
```console
$ docker pull wordpress@sha256:740f3845029d0ad7001cf47835fa253b77209e0ed9430d97e3fcc19bb770da5f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.9 MB (81940190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c281c9cbd494436d4072f9a9efe9d3954df5eaf9565c30bd89e8ab5a76ac628`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Sep 2020 06:49:28 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Fri, 04 Sep 2020 06:50:40 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 04 Sep 2020 06:50:53 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 06:51:05 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 04 Sep 2020 06:51:09 GMT
ENV WORDPRESS_VERSION=5.5.1
# Fri, 04 Sep 2020 06:51:11 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Fri, 04 Sep 2020 06:51:22 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Fri, 04 Sep 2020 06:51:26 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 06:51:28 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Fri, 04 Sep 2020 06:51:31 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 04 Sep 2020 06:51:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:24fdeaa8eaac8caaa8d97ee9f5fdcc2dd410e41280258590df3f92f0c7df36f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:064fabee12fd8e454196b65a6ca54a5bae1204345227d9148e6317166ea29a2f`  
		Last Modified: Fri, 04 Sep 2020 07:23:16 GMT  
		Size: 33.7 MB (33681616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50ab490bfb5709dad54c6f0493c1f62f1fe85beb5296967d8618a9c64a2d453b`  
		Last Modified: Fri, 04 Sep 2020 07:23:02 GMT  
		Size: 3.1 MB (3097028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67728131783d5803bb7f5c4981220c73f0cd9225a492593d9df2bc9167bb67fa`  
		Last Modified: Fri, 04 Sep 2020 07:23:02 GMT  
		Size: 62.5 KB (62476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c382e1eb888d7be22a60cdf4ed94d082197d1db93f4cac8b2be572138b2fbb3f`  
		Last Modified: Fri, 04 Sep 2020 07:23:02 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b48b25a79b6fa68f45cda29304c1c967497e3c317c3bbe4ff3fcf7104c7d31e`  
		Last Modified: Fri, 04 Sep 2020 07:23:04 GMT  
		Size: 12.8 MB (12848415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68b6decded279c36d7c5979bb625914533e98fad5dcb0d6b8edb3f18558e9688`  
		Last Modified: Fri, 04 Sep 2020 07:23:02 GMT  
...
```console
$ docker pull wordpress@sha256:36ca1f1403fd08f7021bae03f30cdbaa0d1a59183a340b7750870258c30ed6b4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.0 MB (71028711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cf7a96ef4364d804d08ce9ea7c4f6ce708f0012a6a85720a0c83ba233cc2e2b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 03 Sep 2020 21:53:23 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript 		imagemagick
# Thu, 03 Sep 2020 21:53:53 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Thu, 03 Sep 2020 21:53:55 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 21:53:55 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 03 Sep 2020 21:53:56 GMT
ENV WORDPRESS_VERSION=5.5.1
# Thu, 03 Sep 2020 21:53:56 GMT
ENV WORDPRESS_SHA1=d3316a4ffff2a12cf92fde8bfdd1ff8691e41931
# Thu, 03 Sep 2020 21:53:58 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 03 Sep 2020 21:53:59 GMT
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 21:54:00 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Thu, 03 Sep 2020 21:54:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 03 Sep 2020 21:54:00 GMT
...
-	Layers:
	...
	-	`sha256:a4c72b9c1e81052b135aa6d9a7a3f69b4da440a83d13ce52fada71311271f15d`  
		...
		Size: 8.4 KB (8415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98cc304c5f3fa434f962055c6362efa659bf8a259fbe9845cb3afd2d29572250`  
		Last Modified: Thu, 03 Sep 2020 22:01:08 GMT  
		Size: 24.9 MB (24901460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4181500a01b855c4f2ba699975d6f2c86710d91a7f04e6aa9c0e26e4dfa9558`  
		Last Modified: Thu, 03 Sep 2020 22:01:03 GMT  
		Size: 2.9 MB (2907202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0342895c3fb05c0f5d551647a980d7b0d737d041264311b09b781b0fe3b05636`  
		Last Modified: Thu, 03 Sep 2020 22:01:02 GMT  
		Size: 56.1 KB (56093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c34e5c887c94dffddd2d56ff6390e71352daccc4c2196babc25a0ea5240f2ae0`  
		Last Modified: Thu, 03 Sep 2020 22:01:02 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1026d16567f64d8a2247105c9ca3ee693adbd1f7de4fa579f244f6d919fb50b0`  
		Last Modified: Thu, 03 Sep 2020 22:01:05 GMT  
		Size: 12.8 MB (12848415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc0287f3766d3ed60c056c36965e92dc8823a86e1951c1a17951f098852c65c9`  
		Last Modified: Thu, 03 Sep 2020 22:01:02 GMT  
