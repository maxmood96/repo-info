## `wordpress:beta-6.0-RC3-php8.1-apache`

```console
$ docker pull wordpress@sha256:8e2f34fec1e3be7a44d88faac3f5c2b833552933c983fd7b6657daad0efaa07c
```
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.0-RC3-php8.1-apache` - linux; s390x
