...
```console
$ docker pull wordpress@sha256:91423d65009ce91abce55f373f7f26a8843771137d0a36800e70539b9b55b601
```
...
### `wordpress:6.9.2-fpm-alpine` - linux; amd64
...
### `wordpress:6.9.2-fpm-alpine` - unknown; unknown
...
### `wordpress:6.9.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.9.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.9.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.9.2-fpm-alpine` - linux; 386
...
### `wordpress:6.9.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.9.2-fpm-alpine` - linux; s390x
