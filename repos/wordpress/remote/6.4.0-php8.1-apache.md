...
### `wordpress:6.4.0-php8.1-apache` - linux; arm variant v5
...
### `wordpress:6.4.0-php8.1-apache` - linux; arm variant v7
...
### `wordpress:6.4.0-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:6.4.0-php8.1-apache` - linux; 386
...
### `wordpress:6.4.0-php8.1-apache` - linux; mips64le
...
### `wordpress:6.4.0-php8.1-apache` - linux; s390x
