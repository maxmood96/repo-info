...
```console
$ docker pull wordpress@sha256:7ecf804399bad53b497d6e2b603a0f3a546ccdcc39efc4e62e4de1f2be173d7d
```
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.9.2-php8.5-fpm-alpine` - linux; s390x
