...
```console
$ docker pull wordpress@sha256:0983dc82e3f6271041904688cba6395067d45b808bbf158f534045a63a17a79b
```
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.5-beta2-php8.1-apache` - linux; s390x
