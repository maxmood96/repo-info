...
### `wordpress:beta-5.9-RC1-fpm` - linux; amd64
...
### `wordpress:beta-5.9-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.9-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-RC1-fpm` - linux; 386
...
### `wordpress:beta-5.9-RC1-fpm` - linux; ppc64le
