...
```console
$ docker pull wordpress@sha256:91a1f451aa437af1541c78cdade080962cc62aaa32c76a3f118fe816475be373
```
...
### `wordpress:beta-6.7-RC5-php8.3` - linux; arm variant v5
...
### `wordpress:beta-6.7-RC5-php8.3` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC5-php8.3` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC5-php8.3` - linux; ppc64le
...
### `wordpress:beta-6.7-RC5-php8.3` - linux; s390x
