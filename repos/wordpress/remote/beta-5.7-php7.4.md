...
```console
$ docker pull wordpress@sha256:4e7de24c73cccd01dc897e18fb15e32ae3e7b64addf985c47299760ac59ec6a7
```
...
### `wordpress:beta-5.7-php7.4` - linux; amd64
...
### `wordpress:beta-5.7-php7.4` - linux; arm variant v5
...
### `wordpress:beta-5.7-php7.4` - linux; arm variant v7
...
### `wordpress:beta-5.7-php7.4` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-php7.4` - linux; 386
...
### `wordpress:beta-5.7-php7.4` - linux; mips64le
...
### `wordpress:beta-5.7-php7.4` - linux; ppc64le
...
### `wordpress:beta-5.7-php7.4` - linux; s390x
