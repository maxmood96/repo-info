...
```console
$ docker pull wordpress@sha256:3c4d81e2eb75415f5527373acf402e5c1d8d55ab0db185a2a3b5352a566f8de1
```
...
```console
$ docker pull wordpress@sha256:9d003f1c17071a213e057cf185006ada4ecaed124ee3c366720856d8228f191e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184637766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f38519f7c044e93cb30a91e0c796b9e622176f07976fd74a51be5d0df7fb44e`
...
-	Layers:
	...
	-	`sha256:897972b6b4fd5fa8218437b471b036238682991338d40c75a7bdf3eea8f6efa6`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4317a3f7a6a71ab59404684ab64bb22480e96c52058375714f8ccbee1882e49b`  
		Last Modified: Wed, 03 Feb 2021 21:44:42 GMT  
		Size: 15.5 MB (15547411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:681f56054d879b178e9dfe594e1d54193f4c9ea649d0eae370b341efbca083c2`  
		Last Modified: Wed, 03 Feb 2021 21:44:39 GMT  
		Size: 2.1 KB (2097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa89fc9b5dc40894f0e2bc66f0b9274b2961738c6f39d0ef20239e2723236e00`  
		Last Modified: Wed, 03 Feb 2021 21:44:39 GMT  
...
```console
$ docker pull wordpress@sha256:c9c873022ea1cef2f64cdcc62edbbbec81f6df96664da16adc97a0905d55b625
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157888346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cac981f06b8e9e732f9c6a7aa0e33a503dc8a55c77969b49f17bfc447e429c80`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 03 Feb 2021 22:53:41 GMT
RUN set -eux; 	version='5.7-beta1'; 	sha1='abff1a094f816136e9a5c2da0ba7b2e188fb304d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 03 Feb 2021 22:53:42 GMT
VOLUME [/var/www/html]
# Wed, 03 Feb 2021 22:53:43 GMT
COPY --chown=www-data:www-datafile:0c72cdf4bfc53e48a50a27b4181a810916f30eb16f37044bd4298ee8328646d5 in /usr/src/wordpress/ 
# Wed, 03 Feb 2021 22:53:44 GMT
COPY file:eb627edb8cc2c73847c3ec2586b852ebd606f4562928fd73ce4c5efc0763085d in /usr/local/bin/ 
# Wed, 03 Feb 2021 22:53:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 03 Feb 2021 22:53:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:de1e5c57e24bb63146aeb0dc1870c443df571900bd3391559ffc0051c52ebabf`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08861be41404ab6a6178d97fa5f8280b2268303bafb191d6402cb6b01ef5983d`  
		Last Modified: Wed, 03 Feb 2021 22:58:48 GMT  
		Size: 15.5 MB (15547500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32299416cd3d8e65abf8bf6eda2496e8859b7e2cb18d654b90348816dbefc532`  
		Last Modified: Wed, 03 Feb 2021 22:58:41 GMT  
		Size: 2.1 KB (2096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec59b3d0c4fe669deec6d6b0ad31dcb42b0abb8751a411ed2be81935c0960116`  
		Last Modified: Wed, 03 Feb 2021 22:58:41 GMT  
		Size: 1.6 KB (1640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:222b8e4f418ccaa55d2f5a2eacb967ee710814847d676f20fc130e701fcc1fbc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165722870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4ce3cef97ade8fdd23122cd6367f76ea485a1c5ad806a073b2156fdb46232ae`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 04 Feb 2021 19:43:49 GMT
RUN set -eux; 	version='5.7-beta1'; 	sha1='abff1a094f816136e9a5c2da0ba7b2e188fb304d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Feb 2021 19:43:49 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 19:43:50 GMT
COPY --chown=www-data:www-datafile:0c72cdf4bfc53e48a50a27b4181a810916f30eb16f37044bd4298ee8328646d5 in /usr/src/wordpress/ 
# Thu, 04 Feb 2021 19:43:50 GMT
COPY file:eb627edb8cc2c73847c3ec2586b852ebd606f4562928fd73ce4c5efc0763085d in /usr/local/bin/ 
# Thu, 04 Feb 2021 19:43:51 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Feb 2021 19:43:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:654cc2eb7cbcc10758078765421d0e0c389b905bb977504cc9f514704a006fff`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80695069f4e82da3bd783ac9eb18e45bb01b8d511322c7f736ce500d71640a1d`  
		Last Modified: Thu, 04 Feb 2021 19:50:54 GMT  
		Size: 15.5 MB (15547410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:278be44f696543e07c9460f9fc081d9f381d71879d5a9dfd5c112e613f64afc3`  
		Last Modified: Thu, 04 Feb 2021 19:50:42 GMT  
		Size: 2.1 KB (2095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fffa1583aea2f4df1b80a0ce2bff6f0daecff5b720da95ef8f6fdd28dbb91a80`  
		Last Modified: Thu, 04 Feb 2021 19:50:43 GMT  
...
```console
$ docker pull wordpress@sha256:0638d527f76b0aaf096870d993a1d116f2afad3d422d42bc949e40566fae29d1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.0 MB (195991983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73f98ccd025d1badce510557262b330c25e2715f4b18846d3d789ac29914e382`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 03 Feb 2021 22:14:47 GMT
RUN set -eux; 	version='5.7-beta1'; 	sha1='abff1a094f816136e9a5c2da0ba7b2e188fb304d'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 03 Feb 2021 22:15:01 GMT
VOLUME [/var/www/html]
# Wed, 03 Feb 2021 22:15:05 GMT
COPY --chown=www-data:www-datafile:0c72cdf4bfc53e48a50a27b4181a810916f30eb16f37044bd4298ee8328646d5 in /usr/src/wordpress/ 
# Wed, 03 Feb 2021 22:15:14 GMT
COPY file:eb627edb8cc2c73847c3ec2586b852ebd606f4562928fd73ce4c5efc0763085d in /usr/local/bin/ 
# Wed, 03 Feb 2021 22:15:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 03 Feb 2021 22:15:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3445f53198174ff1fa4776a525ff42e95f5f0fd87dfac5a66e7062a232775612`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6154ddb9be81ba1153d6a9932214e415ac2d44bd35b1ec420ec9e9e70daad20`  
		Last Modified: Wed, 03 Feb 2021 22:26:55 GMT  
		Size: 15.5 MB (15547500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe75b9fc7d5e31992bb8905ba4378f0d7a53078181af6f464315bc686e266a22`  
		Last Modified: Wed, 03 Feb 2021 22:26:52 GMT  
		Size: 2.1 KB (2094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:088c223b743eaa8c3203b8720969e094089f2044e794cbae77aa3f55c3fdfb52`  
		Last Modified: Wed, 03 Feb 2021 22:26:52 GMT  
		Size: 1.6 KB (1637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
