...
### `wordpress:beta-6.5-RC1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC1-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC1-php8.1-fpm-alpine` - linux; ppc64le
