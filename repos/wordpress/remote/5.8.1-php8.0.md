...
```console
$ docker pull wordpress@sha256:77d169b791cfa347b1dbe7d83b263d6a22b211009b620d90ddea06ae4f25700c
```
...
### `wordpress:5.8.1-php8.0` - linux; amd64
...
### `wordpress:5.8.1-php8.0` - linux; arm64 variant v8
...
### `wordpress:5.8.1-php8.0` - linux; 386
...
### `wordpress:5.8.1-php8.0` - linux; mips64le
...
### `wordpress:5.8.1-php8.0` - linux; ppc64le
...
### `wordpress:5.8.1-php8.0` - linux; s390x
