## `wordpress:beta-5.6.1-php7.3-fpm-alpine`

```console
$ docker pull wordpress@sha256:faeae62be4d447536b7a6d03ff2a45ee7a8beaba6386e8c3763b15e88e879293
```
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.6.1-php7.3-fpm-alpine` - linux; s390x
