...
```console
$ docker pull wordpress@sha256:00eb75d17dc7297008b61917bfbcb9517bf742948ef64b28e7869bb81635c7ec
```
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.6.2-RC1-php8.2-fpm` - linux; s390x
