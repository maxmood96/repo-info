...
```console
$ docker pull wordpress@sha256:ec763c32279656ed3f9bd5f39d5ef93624c2decfc4353cf82bb828df76b58a67
```
...
### `wordpress:6.7.1-php8.1-apache` - linux; amd64
...
### `wordpress:6.7.1-php8.1-apache` - unknown; unknown
...
### `wordpress:6.7.1-php8.1-apache` - linux; arm variant v5
...
### `wordpress:6.7.1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:6.7.1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:6.7.1-php8.1-apache` - linux; 386
...
### `wordpress:6.7.1-php8.1-apache` - linux; mips64le
...
### `wordpress:6.7.1-php8.1-apache` - linux; ppc64le
