...
```console
$ docker pull wordpress@sha256:e3a5972ec7efba02980631d830d533c59a88d48ca0866892e1d3f1cc861a324f
```
...
### `wordpress:6.9.1-php8.4` - linux; amd64
...
### `wordpress:6.9.1-php8.4` - unknown; unknown
...
### `wordpress:6.9.1-php8.4` - linux; arm variant v5
...
### `wordpress:6.9.1-php8.4` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.4` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.4` - linux; 386
...
### `wordpress:6.9.1-php8.4` - linux; ppc64le
...
### `wordpress:6.9.1-php8.4` - linux; s390x
