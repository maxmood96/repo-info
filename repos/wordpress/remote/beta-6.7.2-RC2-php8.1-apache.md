...
```console
$ docker pull wordpress@sha256:2c31c87eedbb676d12aaff5decffd543a44d08f2e68741cb3018941a3f04afc8
```
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC2-php8.1-apache` - linux; s390x
