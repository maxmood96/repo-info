...
```console
$ docker pull wordpress@sha256:5889d83f3908d3fc5dbded281bd18f5ab18d91fdb7abbd2a9918e06cb9cc94c4
```
...
```console
$ docker pull wordpress@sha256:bff2721328a81f69be4c86ad7eccb087a135949ad7d6830e947b3c66b2ed6c5e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.9 MB (212932231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e0f13a672f61b5f308a882e33b7d49a8e42ab2e26a390834cc38bd40a203b0e`
...
# Thu, 18 Nov 2021 22:25:37 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 22:26:47 GMT
...
-	Layers:
	...
	-	`sha256:57d2474097f53e65f1cb0e8875e41eac4c608d70e2fd197b942067bccc6da564`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba9bc21fe7f41e649187750a97031d6490a5235939d3ebf35926e70715448093`  
		Last Modified: Thu, 18 Nov 2021 22:36:21 GMT  
		Size: 19.0 MB (18982503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6c5a4dcc4f2066dae1c422a4989ec4a2daa648b05b17e3236a28c5bf702c5f9`  
		Last Modified: Thu, 18 Nov 2021 22:36:19 GMT  
		Size: 11.2 MB (11193222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fec599c81b9cad92b7f9679c121eef107fa2b44887e4adaf4c3c7ecd1a014f2`  
		Last Modified: Thu, 18 Nov 2021 22:36:17 GMT  
		Size: 374.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba369c33a24df13b1d49b1db73a34a4c1f90cb9b9f0cb91cf9dfb8690daf2ab2`  
		Last Modified: Thu, 18 Nov 2021 22:36:14 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54f557b411ea0069960e1c6f5b68ccbb4b0bff00e9dd6e3e6aa8a9662a59d23d`  
		Last Modified: Thu, 18 Nov 2021 22:36:15 GMT  
		Size: 19.5 KB (19501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:088cfdeabbfc7da20b70ffb4a9c49b3062ed417a64294687b824328c5d764e8f`  
		Last Modified: Thu, 18 Nov 2021 22:36:17 GMT  
		Size: 14.9 MB (14915747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d88cc7428d7e7b467ec627bb6e618d3c4dc8facae3578eb6c31fd6f4b1de5cc`  
		Last Modified: Thu, 18 Nov 2021 22:36:14 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db66800d60dbb95b60a20d160607e9fb78fdb3b419388d30b6e894e5c0d5d437`  
		Last Modified: Thu, 18 Nov 2021 22:36:15 GMT  
...
```console
$ docker pull wordpress@sha256:124007a089e8888dfff272385c517b969ff5730fc7148a074c771c85ceb3e3af
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.2 MB (188183825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fefaccf16ec66a3c4ee89e343441cc4c1ac41487d3a660a6860974408eba0525`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 18 Nov 2021 21:33:48 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 21:37:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.5.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 21:37:14 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 21:37:16 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 18 Nov 2021 21:37:18 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 18 Nov 2021 21:37:27 GMT
RUN set -eux; 	version='5.8.2'; 	sha1='c3b1b59553eafbf301c83b14c5eeae4cf1c86044'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 18 Nov 2021 21:37:28 GMT
VOLUME [/var/www/html]
# Thu, 18 Nov 2021 21:37:28 GMT
COPY --chown=www-data:www-datafile:76be5fadb2e2d2b7a74d2770397579cd1402963fdca23912220f983ef906f582 in /usr/src/wordpress/ 
# Thu, 18 Nov 2021 21:37:29 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 18 Nov 2021 21:37:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 18 Nov 2021 21:37:30 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:179d72f6f8df999d703dd3fe5ee263ea0e56dfe3a88af7b3270ff1a64a37815a`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42e6b17d853206c9d4534713f2667577e6dd5b5638453f97dc19367df1047653`  
		Last Modified: Thu, 18 Nov 2021 21:46:39 GMT  
		Size: 18.8 MB (18795653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9e1dd0912d72bffde5734a89bbf23db0bb9a190e3e5fda3570cbf044fc715e7`  
		Last Modified: Thu, 18 Nov 2021 21:46:30 GMT  
		Size: 9.1 MB (9118566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc53ae44b380e09c2e0f21ebaa47c867faa07c28a5d28507c8cb6c4c41d1c696`  
		Last Modified: Thu, 18 Nov 2021 21:46:22 GMT  
		Size: 375.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90e7d2581a5021f07671f9c1775c12790ff92a8d286770be500e7051cf520b11`  
		Last Modified: Thu, 18 Nov 2021 21:46:20 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a415d4d1812a0c4047d65038accab4764bd8746124d8532962353878a5102839`  
		Last Modified: Thu, 18 Nov 2021 21:46:20 GMT  
		Size: 19.5 KB (19512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b158c42f4b46dad72b1c24bd98925d1757dd817e28e237641fb26601a139b526`  
		Last Modified: Thu, 18 Nov 2021 21:46:34 GMT  
		Size: 14.9 MB (14915721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8355ab557f37a386163ae6c514bc01d51a94de292ae9282cc5b743ae5aa02114`  
		Last Modified: Thu, 18 Nov 2021 21:46:20 GMT  
		Size: 2.4 KB (2352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09aaefa98c022f7c44c3f0c12d6172d5633dd7e42d125de70d50ed2571b4b9fe`  
		Last Modified: Thu, 18 Nov 2021 21:46:20 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
