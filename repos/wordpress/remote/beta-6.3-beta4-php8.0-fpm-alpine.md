## `wordpress:beta-6.3-beta4-php8.0-fpm-alpine`

```console
$ docker pull wordpress@sha256:3f4d40367b203eb8f4c781651cef7e38c1cef5c9f389a1d043ada07afda12d50
```
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; 386
