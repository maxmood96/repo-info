...
```console
$ docker pull wordpress@sha256:0d0ddd8639cc0204be8918abbc7c5e7ba2c77a51a531da0aa6cbf02ea5861e3d
```
...
### `wordpress:beta-6.3.1-apache` - linux; amd64

```console
$ docker pull wordpress@sha256:17d1b62b51434388c12d5a3c579ce7e668124fcedb36493d502034be659b5960
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **233.0 MB (232953731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e44b15ee068ce255babdda72af6d47eef245b02de6d72c152df2e9cd3bf06a4b`
...
-	Layers:
	...
	-	`sha256:2022415de1c1c501662ca4c5a5d35e0a7d871733e781ea177943e7d92630a7bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b71c2e16097bd731c5de2ec380b7163b6dafb3b8754b9d2c8e92f40b2ccb4b7d`  
		Last Modified: Thu, 24 Aug 2023 20:35:12 GMT  
		Size: 23.3 MB (23273472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac69b9204cd85004e44bf72637382a2285c7e66f7736c10313c4d8a061a5bbf2`  
		Last Modified: Thu, 24 Aug 2023 20:35:08 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8b8273948827adbef183655262b070175e24887f48d3a8e679f142b1f29d8b5`  
		Last Modified: Thu, 24 Aug 2023 20:35:08 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; arm variant v5

```console
$ docker pull wordpress@sha256:5e9b34c0c542af521b68eb12fdb721bbb97bf925ec893fd85f603c6c450e3cf9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.0 MB (208017276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d252d265572341a5221d44a383048bc5193167ebe536045a574217ecb51bad3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 19:48:43 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:48:43 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:48:44 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:48:44 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 19:48:44 GMT
...
-	Layers:
	...
	-	`sha256:7efa549f0958facb1a2b098a20fa44b14c6d93f723925f8e0c43a24a307a03e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:422284a0156f81db72c7e5d603dbeabcf05c2f5e773164d41b86c24598df8775`  
		Last Modified: Thu, 24 Aug 2023 19:50:19 GMT  
		Size: 23.3 MB (23273484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1eb58ec1bf8db18ce2e41c64ffc2733e37823fff9d9b525f12ded479f8d34b9`  
		Last Modified: Thu, 24 Aug 2023 19:50:15 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc6d9fec5bcedfefa0de9713d5aafcf028d31484aebb06a2da2175633125f6c8`  
		Last Modified: Thu, 24 Aug 2023 19:50:15 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:f93c2cce2c50b79c731d4b72b26dc47fd96098fe26d876382cf45434dfdc4465
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.2 MB (198207923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33f3ed0280678b363eaccb9b2706133bf5a609c84d6a8a6706959ccbacb7c69e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Aug 2023 00:30:48 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 20:22:07 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:22:08 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:22:08 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:22:08 GMT
...
-	Layers:
	...
	-	`sha256:87c620779bf96568478b50d040fa278767608450a0e0ab7ab38189172db6049d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44159c9b821b510644812f22c201cacd8ab3c97c107a22a229b8c12dd138ee6f`  
		Last Modified: Thu, 24 Aug 2023 20:24:39 GMT  
		Size: 23.3 MB (23273486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5af65f2f88955898484cf6a68549650a8146d1d9dfc81cd8fce6c1e48c7b02da`  
		Last Modified: Thu, 24 Aug 2023 20:24:35 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daacb0a0996b518c698f7f4cef5bfd8ce6cae413b7043837a140fe70a24af799`  
		Last Modified: Thu, 24 Aug 2023 20:24:35 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:62840bfa5fa84f4688ef7eac375c434fa1e58f9e64fa38d9004802d7767907b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.3 MB (224305383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc0540bcfa74d4020c84f83a09a096d4c4214a21c49edbc2f0347021f7fa38ad`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e50cd7dfdb0da0c89de0957e6f240aea2a644bed1a4e2bb3fb28cbb0862381e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8dce15c56f2f39ea598a1ce0449725775043a7523dc8bfbfc36dc3e3e040e6b`  
		Last Modified: Thu, 24 Aug 2023 20:17:47 GMT  
		Size: 23.3 MB (23273483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:310b74ee7b797a00383d1c0f6178d6d8b3b7945644a00d575c5bdc1347c2e631`  
		Last Modified: Thu, 24 Aug 2023 20:17:44 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1e90496afee05e63293678b91b98fdc0714c9c7d931d4f1e549777179bacf20`  
		Last Modified: Thu, 24 Aug 2023 20:17:44 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; 386

```console
$ docker pull wordpress@sha256:4b9a5ff05a7104907ce322ec0596a3c054050cb9b5e61c059b3357555f130e7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.6 MB (235560201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7eb22786280ea3412fc19483e396e550532a7a4e5e321d12dca3d0ad355e4f4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:648122a8a3a2c1d5d4470ac917e3deab03437dc54e4b8e1fe0b5e466a68e55d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68dfd1ab3019d9e49dbe4fd0ccda80857ffae28ace8d30acd706d2a9cc5c9e06`  
		Last Modified: Thu, 24 Aug 2023 19:53:47 GMT  
		Size: 23.3 MB (23273481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1867d8dff70c17140bccd536ffbe043d0ef7777afdd601ffc98cd4794af22e6f`  
		Last Modified: Thu, 24 Aug 2023 19:53:42 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f577301a5139ebf22483d980f9abcb1eab15313564f2d574b01c0e518b2e9696`  
		Last Modified: Thu, 24 Aug 2023 19:53:42 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; mips64le

```console
$ docker pull wordpress@sha256:0cfd26eb836454df5031a781b07f4b49b6abcf02c41e3e100afc3444a5eba10b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.1 MB (207117817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d3e6afef648ceba55f066b925832d1d1de437f82f6e4292f3772f09f3274c96`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 20:08:41 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:08:47 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:08:52 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:08:56 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 20:09:01 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:87630504f78b24fa5114c3d6e18974f4adc1a046b21833e1738172c922eedaac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8706dfc825cb67b6c27df7480da9dcbc85d16f0b874688f4434001eb2ca785ac`  
		Last Modified: Thu, 24 Aug 2023 20:15:09 GMT  
		Size: 23.3 MB (23273564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de581d723136adf8a277bac41be541d0f5df8bc71a0d0e83729c6e77fcb781a9`  
		Last Modified: Thu, 24 Aug 2023 20:14:56 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2820da5e7d08e6888e787c7baaccb3bb1087332b0012c65a1867d677d1abdc3`  
		Last Modified: Thu, 24 Aug 2023 20:14:56 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; ppc64le

```console
$ docker pull wordpress@sha256:4ba65d14af66fbb2011fea721cc8767c779bb44c298a96b01889410f3ec153d9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.6 MB (234615552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36e690438b2a048b37d2276f8ce1b91432ae6a8425b348a4a2e228ba06bd2489`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 20:17:55 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:17:56 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:17:57 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:17:57 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 20:17:57 GMT
...
-	Layers:
	...
	-	`sha256:24afedd4cf249c1012586002550a6def6ef1041aa860ffba27212df352252140`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4070c8724d5b0ea5e8e90cd84603b737688e3a8b35e87419115b6d58b1dc510`  
		Last Modified: Thu, 24 Aug 2023 20:22:12 GMT  
		Size: 23.3 MB (23273477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74c594eda3a809255c0b6a7ce759cef7ef58c4a2916f196fce8afb23eb9fd80d`  
		Last Modified: Thu, 24 Aug 2023 20:22:02 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7120213bbdd84fc100e4cdb410acf8697f069806cefe4d1d66434b213585992f`  
		Last Modified: Thu, 24 Aug 2023 20:22:02 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.3.1-apache` - linux; s390x

```console
$ docker pull wordpress@sha256:059d6673e2772343a2e6fcd913e11a3fc1b42c3bb7f13f95efea69169a774c26
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.9 MB (206937186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66ab951294a902d58cb6b4b845a4f5f1a930f95cd9cbc6e6b4e8c317897250fe`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Aug 2023 20:24:05 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Thu, 24 Aug 2023 19:44:12 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:44:14 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:44:14 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:44:14 GMT
...
-	Layers:
	...
	-	`sha256:8345d268b8348405f52a67549de747f62893470af549d91456fb9928e232f2b0`  
		...
		Size: 19.5 KB (19492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bbfae3eed5c5aee4f3a340b799ed69c085784bf4fcb9066ff08b3d625ae150b`  
		Last Modified: Thu, 24 Aug 2023 19:47:39 GMT  
		Size: 23.3 MB (23273489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76c355631c2f40576841655b047f30de52c52c85e4a8668704e4b821dd0be4b3`  
		Last Modified: Thu, 24 Aug 2023 19:47:36 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:540233a9761fd8441bc038c42e133e4032e59865a16d62fa18df7e08546dc3c5`  
		Last Modified: Thu, 24 Aug 2023 19:47:36 GMT  
