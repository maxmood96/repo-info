...
```console
$ docker pull wordpress@sha256:163e7d42feb41be13d0ac4a7e0e811b5849ed736dbd27eb9e52ea6e45b9bf22f
```
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.7-RC5-php8.2-fpm-alpine` - linux; s390x
