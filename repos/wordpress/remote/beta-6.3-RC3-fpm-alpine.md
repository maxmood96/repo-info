...
### `wordpress:beta-6.3-RC3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.3-RC3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC3-fpm-alpine` - linux; 386
