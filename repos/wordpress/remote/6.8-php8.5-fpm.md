...
### `wordpress:6.8-php8.5-fpm` - linux; amd64
...
### `wordpress:6.8-php8.5-fpm` - unknown; unknown
...
### `wordpress:6.8-php8.5-fpm` - linux; arm variant v5
...
### `wordpress:6.8-php8.5-fpm` - linux; arm variant v7
...
### `wordpress:6.8-php8.5-fpm` - linux; arm64 variant v8
...
### `wordpress:6.8-php8.5-fpm` - linux; 386
...
### `wordpress:6.8-php8.5-fpm` - linux; ppc64le
...
### `wordpress:6.8-php8.5-fpm` - linux; riscv64
...
### `wordpress:6.8-php8.5-fpm` - linux; s390x
