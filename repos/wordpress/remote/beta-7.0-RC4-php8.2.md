...
```console
$ docker pull wordpress@sha256:f3e1536f108dddbaa2050f557c489cf0d7a85a05edd644bba7572964075803d1
```
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; amd64
...
### `wordpress:beta-7.0-RC4-php8.2` - unknown; unknown
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; 386
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; ppc64le
...
### `wordpress:beta-7.0-RC4-php8.2` - linux; s390x
