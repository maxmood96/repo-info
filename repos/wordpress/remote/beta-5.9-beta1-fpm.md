...
```console
$ docker pull wordpress@sha256:d99184ffedf2a657ad0ac61359a08213695d9bf94139e73c3b7957eb80cd3015
```
...
### `wordpress:beta-5.9-beta1-fpm` - linux; amd64
...
### `wordpress:beta-5.9-beta1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-fpm` - linux; 386
...
### `wordpress:beta-5.9-beta1-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-fpm` - linux; s390x
