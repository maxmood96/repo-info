...
```console
$ docker pull wordpress@sha256:d2de5ee96aab52516c8d458aa33fa8740f1edacd8e7f0297b684a59bbe827e88
```
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.0.2-RC1-php8.1-fpm-alpine` - linux; s390x
