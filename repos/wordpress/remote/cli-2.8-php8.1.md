...
```console
$ docker pull wordpress@sha256:33befa96c3153321700a5316e50b799e758da559a0ca0306da02e2e5611defd3
```
...
```console
$ docker pull wordpress@sha256:94fde4d719129a527cfbf8c7bc3f229d4c6b36ac9c42fb25ece114cbb5a65ff8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.7 MB (61664527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:329b1a14567a43f2f956af8a1e8d1b4a2fcb8dae713cbbaa467ff77727ece853`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
# Fri, 04 Aug 2023 23:34:38 GMT
CMD ["php" "-a"]
# Sat, 05 Aug 2023 02:16:55 GMT
RUN apk add --no-cache 		bash 		less 		mysql-client
# Sat, 05 Aug 2023 02:16:55 GMT
RUN set -ex; 	mkdir -p /var/www/html; 	chown -R www-data:www-data /var/www/html
# Sat, 05 Aug 2023 02:16:55 GMT
WORKDIR /var/www/html
# Sat, 05 Aug 2023 02:17:43 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 05 Aug 2023 02:17:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 05 Aug 2023 02:17:44 GMT
ENV WORDPRESS_CLI_GPG_KEY=63AF7AA15067C05616FDDD88A3A2E8F226F0BC06
# Sat, 05 Aug 2023 02:17:44 GMT
...
-	Layers:
	...
	-	`sha256:bff8277d508eceb97a97fad7a787534de8740076586c40658e2ca6c7c446e0de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40424f344e8b9fcf46ca7ff7ffc7e136856b674d2266f2d87b90354717670eab`  
		Last Modified: Sat, 05 Aug 2023 02:21:18 GMT  
		Size: 17.9 MB (17942439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ef8eb21211764fc82115b115c39f4c40e1a73c72caad8ab8de59c3a230fa90a`  
		Last Modified: Thu, 15 Jun 2023 10:00:29 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b008775f19557da941ab3e9e587eb665e0367f55945764137deeea6be06261c`  
		Last Modified: Sat, 05 Aug 2023 02:21:17 GMT  
		Size: 8.1 MB (8130179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79e7bb7b7d21264babe6a6c4182d5da52102b73c3500ddcbbc9f569228e4f258`  
		Last Modified: Sat, 05 Aug 2023 02:21:14 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96967d21861a52e368a658867e40f68b8aa58f0131f1945f7f8d3684dcf8269c`  
		Last Modified: Sat, 05 Aug 2023 02:21:15 GMT  
		Size: 1.5 MB (1513104 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ef193092d77aa308b311317a4e628bc362b13a6fdc492f356ac0b8094b292d7`  
		Last Modified: Sat, 05 Aug 2023 02:21:14 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:2a4d5951696b8c59831bdb8a6bc85109bf7d468ab13d4ae881ea2450f0bb6b20
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **66.7 MB (66717510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a701e079546fa0419171b691bef0da0066ea889ac293fc394167570d6eb19ab`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["wp","shell"]`
...
# Fri, 04 Aug 2023 23:55:23 GMT
CMD ["php" "-a"]
# Sat, 05 Aug 2023 03:25:49 GMT
RUN apk add --no-cache 		bash 		less 		mysql-client
# Sat, 05 Aug 2023 03:25:49 GMT
RUN set -ex; 	mkdir -p /var/www/html; 	chown -R www-data:www-data /var/www/html
# Sat, 05 Aug 2023 03:25:49 GMT
WORKDIR /var/www/html
# Sat, 05 Aug 2023 03:26:57 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 05 Aug 2023 03:26:57 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 05 Aug 2023 03:26:57 GMT
...
# Sat, 05 Aug 2023 03:26:57 GMT
ENV WORDPRESS_CLI_VERSION=2.8.1
# Sat, 05 Aug 2023 03:26:58 GMT
ENV WORDPRESS_CLI_SHA512=c1d40ee90b330ca1f8ddbed14b938b41ec5d9ff723c7c1cf3f41a2d9a1b271079a51a37ea3d1c9aa9c628fdd43449dba3995a8de150a68abbd505b06b91d9d2b
# Sat, 05 Aug 2023 03:27:01 GMT
RUN set -ex; 		apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -o /usr/local/bin/wp.gpg -fL "https://github.com/wp-cli/wp-cli/releases/download/v${WORDPRESS_CLI_VERSION}/wp-cli-${WORDPRESS_CLI_VERSION}.phar.gpg"; 		GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$WORDPRESS_CLI_GPG_KEY"; 	gpg --batch --decrypt --output /usr/local/bin/wp /usr/local/bin/wp.gpg; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" /usr/local/bin/wp.gpg; unset GNUPGHOME; 		echo "$WORDPRESS_CLI_SHA512 */usr/local/bin/wp" | sha512sum -c -; 	chmod +x /usr/local/bin/wp; 		apk del --no-network .fetch-deps; 		wp --allow-root --version
# Sat, 05 Aug 2023 03:27:01 GMT
VOLUME [/var/www/html]
# Sat, 05 Aug 2023 03:27:01 GMT
...
-	Layers:
	...
	-	`sha256:f755e1fc01dafa3cf83ee846414fd2871007a57f78f7a29533975842c438c922`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab9add565d47bd066184e96e1e77e2054bf1f841ee746a26f8526d72d05c9c0b`  
		Last Modified: Sat, 05 Aug 2023 03:30:34 GMT  
		Size: 18.7 MB (18673740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30c436562bd45c9d9781de392ad7c315016c97ab2efd56c0ccb2d81cc7ec9931`  
		Last Modified: Thu, 15 Jun 2023 11:05:53 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e12590c27f1bfbbe15abbe54f416950b8d99c6ca643450f06f66f24f40f29876`  
		Last Modified: Sat, 05 Aug 2023 03:30:31 GMT  
		Size: 8.9 MB (8893565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c93866ac3a69817451c7c0ec8fd9c580a02055264ca4e8d9125ed34ebbbb3ce1`  
		Last Modified: Sat, 05 Aug 2023 03:30:29 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ff64db8df1a435b36aafb5af5acb15ebe5c6a7b02ded1f4fdb6b4506460e3e8`  
		Last Modified: Sat, 05 Aug 2023 03:30:29 GMT  
		Size: 1.5 MB (1513099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e15386785c10ac831aedc1e2b3ba7b38087f4ec341e73bfbc246d3d528912f0`  
		Last Modified: Sat, 05 Aug 2023 03:30:29 GMT  
		Size: 406.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
