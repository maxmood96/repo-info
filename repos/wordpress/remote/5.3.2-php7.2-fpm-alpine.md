...
```console
$ docker pull wordpress@sha256:1d7e6916ed8d661e8c87ff9283fb1d9851405f947e4317b19fb0a29c62810e75
```
...
```console
$ docker pull wordpress@sha256:9ac30d0f04af885cb870fa3a440af668b38bf0852130c6a7ac82a7238a9198c4
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.7 MB (63747750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2037cd825699454a09de298d9876461abdca3e55cf2dce0e4b447873dbb86be0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 20 Dec 2019 02:21:49 GMT
ENV WORDPRESS_VERSION=5.3.2
# Fri, 20 Dec 2019 02:21:50 GMT
ENV WORDPRESS_SHA1=fded476f112dbab14e3b5acddd2bcfa550e7b01b
# Fri, 20 Dec 2019 02:21:57 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 20 Dec 2019 02:22:00 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 20 Dec 2019 02:22:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 20 Dec 2019 02:22:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2b05186bd70578d8ff9fd019d10d86a00f702d4e6d38fa2d1913873d5414fd56`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e03f52fea436c9dbcccf7608abeaf369a8a841ef620ee1303ff68f2134cae4cd`  
		Last Modified: Fri, 20 Dec 2019 02:27:47 GMT  
		Size: 12.2 MB (12229114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5566bd08d9053535175bb3779b3f038bffb55139d03d7ca965364326958c370`  
		Last Modified: Fri, 20 Dec 2019 02:27:41 GMT  
...
```console
$ docker pull wordpress@sha256:5fd8a2f965ce994895d81de63d2ce95931f113e02ee9678c43c37af9bf293702
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **67.7 MB (67748200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a899c5835cede72d87568bc0bda9dcf9f78d7bbe7f845d86b13f16b69b68756`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 20 Dec 2019 02:34:36 GMT
ENV WORDPRESS_VERSION=5.3.2
# Fri, 20 Dec 2019 02:34:37 GMT
ENV WORDPRESS_SHA1=fded476f112dbab14e3b5acddd2bcfa550e7b01b
# Fri, 20 Dec 2019 02:34:42 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 20 Dec 2019 02:34:44 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 20 Dec 2019 02:34:44 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 20 Dec 2019 02:34:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a7e7d8c13eefbffcaa2b63504ad3c8d30a217dcc94a051ae216eb77a395c1f5b`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7455432c202ac2734c5d2934483cfdf477b5890618d14030288fe7a7b170dbf`  
		Last Modified: Fri, 20 Dec 2019 02:39:23 GMT  
		Size: 12.2 MB (12229104 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d46981db97d506ced18f17ba2012220c05b7bd2e4a00346a9cfb57175b5fe5c9`  
		Last Modified: Fri, 20 Dec 2019 02:39:19 GMT  
