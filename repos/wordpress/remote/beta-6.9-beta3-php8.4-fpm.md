...
```console
$ docker pull wordpress@sha256:fb5413124b65cc402562fa912d2b60a81a1f54936c23963c018b837d8f7833ee
```
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; 386
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-beta3-php8.4-fpm` - linux; s390x
