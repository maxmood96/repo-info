## `wordpress:beta-5.8.1-fpm-alpine`

```console
$ docker pull wordpress@sha256:1281fdd90cd1ec447aa52e8865c412a30d120616655e9ef521b97e304efe7ed2
```
...
### `wordpress:beta-5.8.1-fpm-alpine` - linux; amd64

```console
$ docker pull wordpress@sha256:16eb2a62b7f82451d57f625f9ded13bee6d7b5aa998ec60d50bdd956f345821f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **85.2 MB (85211517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13395bf4016e9209c73a110e0f10d8e901abfa3045f7f5c044a61b52c9fb29df`
...
-	Layers:
	...
	-	`sha256:2130aad584bc6a0f596ac5dec72d5ff46bc95a235eba067edc4b2411a19c457e`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0064cc54fd432ee7ec0fa1a1ae5f88b5b760b1d7efc976ee7f012cd356ae5ab8`  
		Last Modified: Thu, 02 Sep 2021 21:27:48 GMT  
		Size: 14.9 MB (14915141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9d9993ef4458741ddef45afceaa73c0b8fb8b242280971d3d7fc0d4d1b7f3c0`  
		Last Modified: Thu, 02 Sep 2021 21:27:45 GMT  
		Size: 2.4 KB (2359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1064e42642cc731b637ee16ece8a58a42f545056a42095c77e9b30e4249a7ed5`  
		Last Modified: Thu, 02 Sep 2021 21:27:45 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.8.1-fpm-alpine` - linux; arm variant v6

```console
$ docker pull wordpress@sha256:13511fd82e380df65ded8d10400dbbf0e8dc6a83b0b50b3727270c9f6276f501
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.7 MB (81749144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80bfca91e063503f6649f54f46c4be977e3f2101c3312a8be36414f0e45e87db`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Sep 2021 19:56:53 GMT
RUN set -eux; 	version='5.8.1-RC1'; 	sha1='a88cb0846d1385958d88b8fb93d36585c985e916'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 02 Sep 2021 19:56:54 GMT
VOLUME [/var/www/html]
# Thu, 02 Sep 2021 19:56:55 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 02 Sep 2021 19:56:55 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 02 Sep 2021 19:56:56 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 02 Sep 2021 19:56:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b51bc4277f650d6957bcefd90d131375519df932e4bd1f0d28db410b52ce424e`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3b70f141cef23896771ebfee5d5566e0c83e49617a11a049d9d21c431f979cc`  
		Last Modified: Thu, 02 Sep 2021 20:02:38 GMT  
		Size: 14.9 MB (14915124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928ae95dc38208c11705dbcacaa12d31c98bbb41c298bd749e8342e979c8bbec`  
		Last Modified: Thu, 02 Sep 2021 20:02:26 GMT  
		Size: 2.4 KB (2358 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3333809c8854081b02db90776e0ddd920c833f2d9539af36d82dd6965f1ac159`  
		Last Modified: Thu, 02 Sep 2021 20:02:26 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.8.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:4d2afb7fb657f368ed93cbca6cdde005ec61229129609c34b2995060ce75f1c8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.4 MB (83380557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f257a743f7b7e86c0dae143f48ae43fba3f1122dea041fd72bc866e314ad428`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Sep 2021 20:38:29 GMT
RUN set -eux; 	version='5.8.1-RC1'; 	sha1='a88cb0846d1385958d88b8fb93d36585c985e916'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 02 Sep 2021 20:38:30 GMT
VOLUME [/var/www/html]
# Thu, 02 Sep 2021 20:38:30 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 02 Sep 2021 20:38:30 GMT
...
-	Layers:
	...
	-	`sha256:bf72ada3fb25dba279d1ef2ff52c83177c71c80863d10a4e11e329abdc5c09fd`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:283c8be780317236e0a2c67df7593d196e87c82e9195d9e100ceb436d2f178bf`  
		Last Modified: Thu, 02 Sep 2021 20:48:46 GMT  
		Size: 14.9 MB (14915120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85703792e57c74ae4e1ce3fa8dac1fb1b4b2b1b780b6116d4c071e3200ba71f8`  
		Last Modified: Thu, 02 Sep 2021 20:48:43 GMT  
		Size: 2.4 KB (2359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fb160c009d9cc1d4520ef39fced4750dbc418e52b8654c8776f59c9fb30cc79`  
		Last Modified: Thu, 02 Sep 2021 20:48:43 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.8.1-fpm-alpine` - linux; 386

```console
$ docker pull wordpress@sha256:f7a5933bf480a401b7d656f5e04b55622e1117638a3752b6b2e480fa1581add2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.2 MB (86232680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:700e30a4388485163492e3b5a6bc616b41b0c098937c29f1ea6866ce890cb4e1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Sep 2021 21:17:28 GMT
RUN set -eux; 	version='5.8.1-RC1'; 	sha1='a88cb0846d1385958d88b8fb93d36585c985e916'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 02 Sep 2021 21:17:28 GMT
VOLUME [/var/www/html]
# Thu, 02 Sep 2021 21:17:28 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 02 Sep 2021 21:17:29 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 02 Sep 2021 21:17:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 02 Sep 2021 21:17:29 GMT
...
-	Layers:
	...
	-	`sha256:20f33058307cf9a35c60de057b3bdbaf6c713eeeb684922b9bdb9dcb8cf003c7`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af9be3eb91f75cc6a78e5a104269fdae4ea4585e7d384abdf974147661696f86`  
		Last Modified: Thu, 02 Sep 2021 21:28:17 GMT  
		Size: 14.9 MB (14915140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19fb19d24e7aa75f0237ab2f1b8c00a91034f81fcf9bab94f6957cc59c89c5dc`  
		Last Modified: Thu, 02 Sep 2021 21:28:13 GMT  
		Size: 2.4 KB (2358 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd41b57dd57dbd76097433cc3530d4e4e71fb40d6693789341eefd4e12d86ca8`  
		Last Modified: Thu, 02 Sep 2021 21:28:13 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-5.8.1-fpm-alpine` - linux; s390x

```console
$ docker pull wordpress@sha256:0f665d12170ec32dc0acc278b8d7d76340f961391bb22b3190ae4f9896f7acc2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.8 MB (75770309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f05d0dff4a2d5d63650c01a6630304ee1eabe2bf3aa16fb4f8950124aa86ead8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 02 Sep 2021 20:53:58 GMT
RUN set -eux; 	version='5.8.1-RC1'; 	sha1='a88cb0846d1385958d88b8fb93d36585c985e916'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 02 Sep 2021 20:54:02 GMT
VOLUME [/var/www/html]
# Thu, 02 Sep 2021 20:54:03 GMT
COPY --chown=www-data:www-datafile:2708a2c2ddd7102be41b667427e2ff8a8f87e2fe99f16c5d6508102164a04563 in /usr/src/wordpress/ 
# Thu, 02 Sep 2021 20:54:03 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:77bf6289b9fe2fe5582a3ded3c3d0b8b7268c20e635d04ac2b4ae66134f7efe3`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bba0b5cf2b8ba35ab6549e8b8439face104a3f1aff5386311e99ede26d416bf`  
		Last Modified: Thu, 02 Sep 2021 21:05:21 GMT  
		Size: 14.9 MB (14915134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:601eed5963c8f377d2dfe09a305f40f74b50a70e85e6c5aec3e58c0a21f513f9`  
		Last Modified: Thu, 02 Sep 2021 21:05:19 GMT  
		Size: 2.4 KB (2356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f504ae5b0c97cff83594d508edbb0816f443c9a585140d2ebc69087fdaf05b4`  
		Last Modified: Thu, 02 Sep 2021 21:05:19 GMT  
