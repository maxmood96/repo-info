...
```console
$ docker pull wordpress@sha256:811b16dcf8d4c1ba27b3e7c230febe0b64731efe7d4df3b8dd6f277fac25e7cd
```
...
```console
$ docker pull wordpress@sha256:585a5eed97fc66269608106fb10535ab5f65fdbb5a1ba203c3553c566e0ffc76
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.7 MB (257737779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8990e373bc7215bcc9d4a56be0fee9c846e6e12f292f914da5884b5048469b43`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	{ 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > "$PHP_INI_DIR/conf.d/error-logging.ini" # buildkit
# Wed, 25 Feb 2026 02:39:11 GMT
RUN set -eux; 	version='6.9.1'; 	sha1='2914d37c00597e6216a88f90e22b1b4c7bbd09e8'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Wed, 25 Feb 2026 02:39:12 GMT
VOLUME [/var/www/html]
# Wed, 25 Feb 2026 02:39:12 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Wed, 25 Feb 2026 02:39:12 GMT
COPY docker-entrypoint.sh /usr/local/bin/ # buildkit
# Wed, 25 Feb 2026 02:39:13 GMT
RUN ln -svfT docker-entrypoint.sh /usr/local/bin/docker-ensure-installed.sh # buildkit
# Wed, 25 Feb 2026 02:39:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 25 Feb 2026 02:39:13 GMT
...
-	Layers:
	...
	-	`sha256:0cb9de606f065b68efd868636aa1662f5d12b9c34cd913b6f8ead2897311f640`  
		...
		Size: 396.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:48e33fa0931ce41979042dd2928cff1ec0c8d12447fecd4af7d1c08a6127f3cf`  
		Last Modified: Wed, 25 Feb 2026 02:39:54 GMT  
		Size: 27.0 MB (27030959 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:617f424088133b3dbd80fc440c5f780e721eee7fa4c9c8046778eeea54dfa908`  
		Last Modified: Wed, 25 Feb 2026 02:39:52 GMT  
		Size: 2.4 KB (2442 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3d517af4fa6e90acc21e28114250b62ad259bc8ac77a69d232da260d743d5577`  
		Last Modified: Wed, 25 Feb 2026 02:39:53 GMT  
		Size: 1.8 KB (1770 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bdb36bf24ed26a3b4faa282457b50a49310c92c8a030613208e4905a324b753e`  
		Last Modified: Wed, 25 Feb 2026 02:39:53 GMT  
		Size: 196.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:4d4ec7f888faec49f124cebd92fdc07c17048dc36cf3b42aadc4e1b8365a2adb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.2 MB (8227195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c80d3d7cb6a894f2e90172492ef26fb80768ef4c524137f81cca9888cf9a6b8`

```dockerfile
```

-	Layers:
	-	`sha256:de841b34ebd294daa5c790e4038c9f55ac47796242a72c82f9051f6672558ff0`  
		Last Modified: Wed, 25 Feb 2026 02:39:50 GMT  
		Size: 8.2 MB (8173457 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6744aaa7cbeca948c011d2040dd03331199f729792d671607a728709132b61bf`  
		Last Modified: Wed, 25 Feb 2026 02:39:50 GMT  
...
```console
$ docker pull wordpress@sha256:5badd54bbeed0e9ac760ba7925018f0dae292fdc28768140b08d2ad0dc11835e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **283.4 MB (283449167 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dd3690f90842ceb8b911777f423f9cb45ff61c993e8c650ef8b2882ef0a5e2b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:bcabec5c6589254e3991925f1884abe656bc62fefe797fd40a31e7a9cb5ccf25`  
		...
		Size: 398.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1ea9e67269dc939ccb03f2e4bd2e286d3fd650884843cd5d24250bc1e180db52`  
		Last Modified: Sat, 28 Feb 2026 17:02:38 GMT  
		Size: 27.0 MB (27030967 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:671ac50d76dd377462daaa2d967dc2e3ef4d603d571d730036c774a024a9c173`  
		Last Modified: Sat, 28 Feb 2026 17:02:28 GMT  
		Size: 2.4 KB (2441 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:95bbcdcb94916abfc22a3af7f259a00fd8ffe34ff136678a238e15a6231affde`  
		Last Modified: Sat, 28 Feb 2026 17:02:31 GMT  
		Size: 1.8 KB (1771 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2fa684396f2c91287826bf0c1c0d013015a37fd97938bb6c6aba9068abbcabb8`  
		Last Modified: Sat, 28 Feb 2026 17:02:33 GMT  
		Size: 198.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:a95b4706f07d285e292b44b0f5400c5f46c515732191969f5fbc9b93283068b0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.3 MB (8292118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:521214682d6b04a2b45ff9e28df42c8ed39dd32558199ff0251f2c4586439572`

```dockerfile
```

-	Layers:
	-	`sha256:985003e19193206b99376b71a205ac9c74ec9ee6f162dfc535e3eb373f36de55`  
		Last Modified: Sat, 28 Feb 2026 17:02:28 GMT  
		Size: 8.2 MB (8238380 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bb8d2d9a6974a0ca768f0ac7756425bda963be1f9a8ce11130886f0d0f672642`  
		Last Modified: Sat, 28 Feb 2026 17:02:25 GMT  
		Size: 53.7 KB (53738 bytes)  
		MIME: application/vnd.in-toto+json
