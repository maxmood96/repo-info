...
```console
$ docker pull wordpress@sha256:14c11325bf0ca5a47ca5af410e60548195798ed4a0299bc518825f6fdb05a109
```
...
```console
$ docker pull wordpress@sha256:7c9c717e38af74841450b3bc6419f5c9ddd759dcfef8c9031514a6634fac4e50
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.6 MB (213578787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0ad444ec2e7c8cf3b13ad67daaef3a81acae8aed14d11554767f769de90ab75`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6abc1e9e1e58fadb480bfb09c4442768038ac097c0ea0bf260dbcc9556e2d5c1`  
		...
		Size: 2.4 KB (2437 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:333f0b259d695424ce455c8c1ac79595937731528e223584f2d52e9bdd52973d`  
		Last Modified: Fri, 27 Jun 2025 21:17:59 GMT  
		Size: 1.7 KB (1726 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:f850c3a9eb5711e191232ce41579a2a358714abbd3853cf97770b8a3a919a00b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.7 MB (7707175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38b5cab99823d22badd2d291180ac2415130565c80ebc91d693f062717bdf804`

```dockerfile
```

-	Layers:
	-	`sha256:bed1afa768dbbe8b008a4e0812b0c55f4ba929ada8a651f420b7348706b19e67`  
		Last Modified: Thu, 26 Jun 2025 04:13:00 GMT  
		Size: 7.7 MB (7658583 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8ed3542bc2a8b47687d2d3322c638eb684ca8e69b5d7d07a72d25149b3101f7a`  
		Last Modified: Thu, 26 Jun 2025 04:13:00 GMT  
