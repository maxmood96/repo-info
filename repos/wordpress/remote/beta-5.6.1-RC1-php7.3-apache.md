...
```console
$ docker pull wordpress@sha256:7fd1ae5e4d61099d206de526d9847076ac502d5939a36686c83d272c03e86165
```
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.6.1-RC1-php7.3-apache` - linux; s390x
