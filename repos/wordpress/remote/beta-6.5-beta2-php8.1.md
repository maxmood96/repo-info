...
### `wordpress:beta-6.5-beta2-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-php8.1` - linux; mips64le
...
### `wordpress:beta-6.5-beta2-php8.1` - linux; s390x
