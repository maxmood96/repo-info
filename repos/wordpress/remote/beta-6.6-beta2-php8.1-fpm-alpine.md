...
```console
$ docker pull wordpress@sha256:bfb9d9536ed3aae6b8a339c82a89f6aa5f6a417e6ca99548ed2f0975eddef8df
```
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.6-beta2-php8.1-fpm-alpine` - linux; s390x
