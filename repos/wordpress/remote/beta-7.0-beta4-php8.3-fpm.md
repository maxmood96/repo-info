...
```console
$ docker pull wordpress@sha256:46571974f90b9c1cad90d6cc4dccef1aae8690f4d38df430528262220cb3b141
```
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.3-fpm` - linux; s390x
