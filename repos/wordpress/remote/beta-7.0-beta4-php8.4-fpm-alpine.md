...
```console
$ docker pull wordpress@sha256:4e3d2f412d848e955452a5b506f8fd5d78cdaf35e7250dd8b92468afc4679b7e
```
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.4-fpm-alpine` - linux; s390x
