## `wordpress:5.6.0-php7.4-fpm`

```console
$ docker pull wordpress@sha256:c3347c761fe3168c2f2170d6f7a2328c66d8cd588ba74bad6fa0024bb5a8a4dc
```
...
### `wordpress:5.6.0-php7.4-fpm` - linux; amd64
...
### `wordpress:5.6.0-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:5.6.0-php7.4-fpm` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:9d5da7643353d7097a7efc753b96289f452e1179d95d32f22bbc7567ee0d3b2a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.6 MB (157592240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5206a9744e132064cfbfff0544cae1c4c0a0c954426011321044d7726bcdd076`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 12 Dec 2020 03:35:30 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 03:38:24 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 03:38:30 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 12 Dec 2020 03:38:35 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 12 Dec 2020 03:38:36 GMT
ENV WORDPRESS_VERSION=5.6
# Sat, 12 Dec 2020 03:38:37 GMT
ENV WORDPRESS_SHA1=db8b75bfc9de27490434b365c12fd805ca6784ce
# Sat, 12 Dec 2020 03:38:44 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 12 Dec 2020 03:38:45 GMT
VOLUME [/var/www/html]
# Sat, 12 Dec 2020 03:38:46 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Sat, 12 Dec 2020 03:38:50 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 12 Dec 2020 03:38:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ddc5f56815a7ca8ec7ca153e15dc97b1b9cda2c9ad3a4bde651c3ceb06842f4a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdbe38d25df33a44d2544ef5fc3dffe33201f2354b7dfffd7e3910b587b9aa75`  
		Last Modified: Sat, 12 Dec 2020 03:50:39 GMT  
		Size: 16.0 MB (15958438 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:533a90bdc669c798c07b8bd8e39c56b03adfde9e1e972723e94c4ea79d1f328f`  
		Last Modified: Sat, 12 Dec 2020 03:50:33 GMT  
		Size: 7.3 MB (7307982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60657e31e807372482f29b0ec2efa645469b0426dba7528a8bfb31c692e22090`  
		Last Modified: Sat, 12 Dec 2020 03:50:31 GMT  
		Size: 379.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39321843d8a4ed26c79b18a322f422ba02b5acda925e318a05df21e1614bb2e9`  
		Last Modified: Sat, 12 Dec 2020 03:50:31 GMT  
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efa7fd25dda0a6aa4be0c24508478df36e525572b9bbf733922e6faa5d0c52b6`  
		Last Modified: Sat, 12 Dec 2020 03:50:37 GMT  
		Size: 15.3 MB (15266953 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79b28fb282aca7225734081bdd662faaf1ceae9db45f447f6a23ee0b26df011c`  
		Last Modified: Sat, 12 Dec 2020 03:50:31 GMT  
		Size: 4.2 KB (4152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.0-php7.4-fpm` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:4314c66554b43446831a1cac56242cf217313ca7336db0496c873cc5f6778998
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.9 MB (174914746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:803d0896931c4a9dc99635e511294c074290b801895131e7e5683e165a1544b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 12 Dec 2020 03:28:51 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 03:31:44 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 03:31:51 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 12 Dec 2020 03:31:54 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 12 Dec 2020 03:31:56 GMT
ENV WORDPRESS_VERSION=5.6
# Sat, 12 Dec 2020 03:31:57 GMT
ENV WORDPRESS_SHA1=db8b75bfc9de27490434b365c12fd805ca6784ce
# Sat, 12 Dec 2020 03:32:03 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 12 Dec 2020 03:32:05 GMT
VOLUME [/var/www/html]
# Sat, 12 Dec 2020 03:32:06 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Sat, 12 Dec 2020 03:32:07 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 12 Dec 2020 03:32:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f5f3c6ef182783b7779353f0cdfb09e318beb1474e4bbd557162f6d3fefa25aa`  
		...
		Size: 8.4 KB (8450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:935f12c8d92bfa677bf2ef573ac116bda1ac551edbb0ddf7fa70302d0db850f7`  
		Last Modified: Sat, 12 Dec 2020 03:44:32 GMT  
		Size: 16.8 MB (16795103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6085855544ce8ecebd7eda3f8d3f45772625463a048a1e8ffd412ed01fb38175`  
		Last Modified: Sat, 12 Dec 2020 03:44:27 GMT  
		Size: 7.7 MB (7677844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1d9772aaf6186c6a13c3e5b65adfceddf4e61448cd89ea06e363b5e42d2b95e`  
		Last Modified: Sat, 12 Dec 2020 03:44:24 GMT  
		Size: 375.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36b1c6983c286123c12ec7d7c1f874b5332b93669825d61911677b4f86318c16`  
		Last Modified: Sat, 12 Dec 2020 03:44:24 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02ee36fc57082e4d448025cdb5670b66ba7a431abede068d8cc987d7a179b0c4`  
		Last Modified: Sat, 12 Dec 2020 03:44:29 GMT  
		Size: 15.3 MB (15266956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e42684ee5c7d31ae4cd50ab1a9583a9615f1e9657a86964ea81725ec425cdba`  
		Last Modified: Sat, 12 Dec 2020 03:44:25 GMT  
		Size: 4.2 KB (4153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.0-php7.4-fpm` - linux; 386

```console
$ docker pull wordpress@sha256:316b84778b78b74f26bf537dac922dcdd0c7b3991a69d24bc69ff81fc2148dda
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189707302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e5a33a1ce18480c8504f705eecc8b3142de25ef2457c4081e9c93ec6cd96dca`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Dec 2020 07:03:34 GMT
CMD ["php-fpm"]
# Sat, 12 Dec 2020 05:13:45 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 05:16:07 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libmagickwand-dev 		libpng-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 05:16:09 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 12 Dec 2020 05:16:10 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 12 Dec 2020 05:16:11 GMT
ENV WORDPRESS_VERSION=5.6
# Sat, 12 Dec 2020 05:16:11 GMT
ENV WORDPRESS_SHA1=db8b75bfc9de27490434b365c12fd805ca6784ce
# Sat, 12 Dec 2020 05:16:17 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 12 Dec 2020 05:16:18 GMT
VOLUME [/var/www/html]
# Sat, 12 Dec 2020 05:16:18 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Sat, 12 Dec 2020 05:16:19 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 12 Dec 2020 05:16:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6f96f3e9a44520e108bd1bb2360d8e3f21b31c0f4c8414c01e8e1fc5d291b80e`  
		...
		Size: 8.4 KB (8450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a48e72d247b41e88f0eb9b5f96a93580352ef7e5fdaaf787483f6e91de20a97f`  
		Last Modified: Sat, 12 Dec 2020 05:29:18 GMT  
		Size: 17.2 MB (17165472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02966fe14d03d7bf17d6e1bb1638757b2d5c66b9fb42701b5625a2f5f31c7a6c`  
		Last Modified: Sat, 12 Dec 2020 05:29:10 GMT  
		Size: 8.5 MB (8533016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94dd52fa47f6a64c14260d43acf5b6b29e22dedb914fd7129b614d7a9451b755`  
		Last Modified: Sat, 12 Dec 2020 05:29:01 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d62aa8ba8c90d1b5593f2dfec942837c4b9f6866ad9d92ed9d430c264e71f512`  
		Last Modified: Sat, 12 Dec 2020 05:29:01 GMT  
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:760f967d547b9c6c2c7b24ca2474ec6244d9146d35a085a7f1f136937e95d933`  
		Last Modified: Sat, 12 Dec 2020 05:29:18 GMT  
		Size: 15.3 MB (15266905 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35aaf0a7182fb5a1b3131692da923d27b0953b12a0f9c39ab01d4123fa0b80d2`  
		Last Modified: Sat, 12 Dec 2020 05:29:01 GMT  
		Size: 4.2 KB (4154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.6.0-php7.4-fpm` - linux; mips64le
...
### `wordpress:5.6.0-php7.4-fpm` - linux; ppc64le
...
### `wordpress:5.6.0-php7.4-fpm` - linux; s390x
