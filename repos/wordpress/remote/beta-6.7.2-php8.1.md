...
```console
$ docker pull wordpress@sha256:e0175cf8aa97dfdf1e4147806623ea2c51932625eefb2230529965ff15e54c17
```
...
### `wordpress:beta-6.7.2-php8.1` - linux; amd64
...
### `wordpress:beta-6.7.2-php8.1` - unknown; unknown
...
### `wordpress:beta-6.7.2-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-php8.1` - linux; 386
...
### `wordpress:beta-6.7.2-php8.1` - linux; mips64le
...
### `wordpress:beta-6.7.2-php8.1` - linux; ppc64le
