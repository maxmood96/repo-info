...
```console
$ docker pull wordpress@sha256:e9fffa4399f31051c855902e095ff82840e68bb51beb8f3595361df68c16d6df
```
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9.1-RC1-php8.4-fpm-alpine` - linux; s390x
