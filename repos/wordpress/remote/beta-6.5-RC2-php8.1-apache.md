...
### `wordpress:beta-6.5-RC2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC2-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.5-RC2-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.5-RC2-php8.1-apache` - linux; s390x
