...
### `wordpress:7.0-fpm` - unknown; unknown
...
### `wordpress:7.0-fpm` - linux; arm variant v5
...
### `wordpress:7.0-fpm` - linux; arm variant v7
...
### `wordpress:7.0-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0-fpm` - linux; ppc64le
...
### `wordpress:7.0-fpm` - linux; riscv64
