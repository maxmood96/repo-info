...
```console
$ docker pull wordpress@sha256:634c37da07be91405ec9cf31e48f896aa773c6765bd2aba51fcc44c234373da3
```
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC3-php8.4-fpm` - linux; s390x
