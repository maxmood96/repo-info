## `wordpress:beta-6.9.1-php8.3-apache`

```console
$ docker pull wordpress@sha256:b4c1c836a584c6a37b93a1832666e857652da348eba1c82e520467591c29794d
```
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; amd64
...
### `wordpress:beta-6.9.1-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; 386
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; ppc64le

```console
$ docker pull wordpress@sha256:cedb90db5cff12fff2e5b5d6e3ecd68470864ff524de6219febfdf3399c74df8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.9 MB (259913929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd0bad5b0e931491d7f8c77a8c707d80ef8b48e82e604818a050a77979484ddb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' + # buildkit
# Tue, 03 Feb 2026 10:31:38 GMT
RUN set -eux; 	version='6.9.1-RC1'; 	sha1='08c58aff842212d7476604399e2f36e14aa3a672'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Tue, 03 Feb 2026 10:31:39 GMT
VOLUME [/var/www/html]
# Tue, 03 Feb 2026 10:31:39 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Tue, 03 Feb 2026 10:31:39 GMT
...
-	Layers:
	...
	-	`sha256:ad2e204bc4b792e23987530afb2e5c21c858dcdfd0b6f9075de16366cb98330e`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0a3ffb3718813ddbb459bc0be8c81b52b16866b97ac200145a08d4f488a96bda`  
		Last Modified: Tue, 03 Feb 2026 10:32:13 GMT  
		Size: 27.0 MB (27030813 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:81ae0742d5bfcb90fdd08bbf092c2aa55b894f2bb741e264c103caffd2dbe4e4`  
		Last Modified: Tue, 03 Feb 2026 10:32:12 GMT  
		Size: 2.4 KB (2441 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2cc0811cc5630f791d858e837a1983ecf8cdc547ce08c01a25ef7908d3e0b71c`  
		Last Modified: Tue, 03 Feb 2026 10:32:12 GMT  
		Size: 1.8 KB (1769 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d25d64c71c07da3eb592ab8c0822719ef5da5336fb8dd72c85d9820c8bf64cd4`  
		Last Modified: Tue, 03 Feb 2026 10:32:12 GMT  
		Size: 198.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:ff846e5368011a803ea68908f56cddc62df2b21aeab0857e63ffddcb7c14105f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.7 MB (8746030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60506c211d52b407d3ac84fd17908080d3f14653f03da93464d8e313fb83f316`

```dockerfile
```

-	Layers:
	-	`sha256:761718a0e46a1a3a6c78c80d8946ac9b9a1569f8faf467fe5d123cfae645a189`  
		Last Modified: Tue, 03 Feb 2026 10:32:12 GMT  
		Size: 8.7 MB (8676613 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2a9d325fc1968e062db2804e327c9fb34575e85c1e63312f79f761d30e03b870`  
		Last Modified: Tue, 03 Feb 2026 10:32:12 GMT  
		Size: 69.4 KB (69417 bytes)  
		MIME: application/vnd.in-toto+json

### `wordpress:beta-6.9.1-php8.3-apache` - linux; riscv64
...
### `wordpress:beta-6.9.1-php8.3-apache` - linux; s390x
