...
```console
$ docker pull wordpress@sha256:88564014a1c536c77511479511ebc2a11b342afc1ef108407b487d2c6645c742
```
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-php7.3-fpm-alpine` - linux; s390x
