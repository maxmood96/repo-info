## `wordpress:beta-6.2-RC5-php8.2`

```console
$ docker pull wordpress@sha256:5566bed852a4d6789e33fea834798ce793f7ae414f71e146c5ae007eb48f9fde
```
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; amd64
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; 386
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; mips64le
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; ppc64le
...
### `wordpress:beta-6.2-RC5-php8.2` - linux; s390x
