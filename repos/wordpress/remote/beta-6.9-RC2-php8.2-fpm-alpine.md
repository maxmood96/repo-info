...
```console
$ docker pull wordpress@sha256:b1f1d7ee3ff52b48d5c9733bba9f072b9b93333bbb7154ada104a00efbe3a930
```
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-php8.2-fpm-alpine` - linux; s390x
