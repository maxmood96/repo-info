...
```console
$ docker pull wordpress@sha256:d17ccec6b0204e45792b3d37d565809d5a5389683880068f0d95d6a6ecb70659
```
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.9.1-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9.1-php8.2-fpm` - linux; s390x
