...
```console
$ docker pull wordpress@sha256:3e3585f7ab89517acef484584bf33e6f3a06fe5109aca6066f2edefd893c1d82
```
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - unknown; unknown
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.4-apache` - linux; s390x
