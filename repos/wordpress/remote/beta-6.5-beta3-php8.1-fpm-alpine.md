...
```console
$ docker pull wordpress@sha256:f3d5b782a4d397364c8894e84a5362a1aadf3b1520d964870fa10b37bd4e13bf
```
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-beta3-php8.1-fpm-alpine` - linux; s390x
