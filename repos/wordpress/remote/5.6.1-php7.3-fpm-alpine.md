...
```console
$ docker pull wordpress@sha256:11594e33d2b5c1c21e80d6af07d0909b6fdd563f432fa423fd669fcb9ddc9e14
```
...
### `wordpress:5.6.1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:5.6.1-php7.3-fpm-alpine` - linux; s390x
