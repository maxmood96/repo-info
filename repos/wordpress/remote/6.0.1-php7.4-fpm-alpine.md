...
```console
$ docker pull wordpress@sha256:44cac8b4b58707a1300c1abc07ef1bebfcf770fe795f58742f6dd4f97903561a
```
...
### `wordpress:6.0.1-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.0.1-php7.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.0.1-php7.4-fpm-alpine` - linux; s390x
