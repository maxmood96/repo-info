...
```console
$ docker pull wordpress@sha256:1906b0ee5177903db2e9dfe82b2bf0739e7271e07290f281052afa18e843063e
```
...
```console
$ docker pull wordpress@sha256:affca7e19984946f1549ad92c9ccd71fcdd4caa35246fe717cfc4b0d3156a60f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.9 MB (93899405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22186857726f4d2ec62a7cab36543f994ed00c49eaabf975f64d6ed37d74af14`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Aug 2022 02:45:59 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 11 Aug 2022 02:46:03 GMT
RUN set -eux; 	version='6.0.1'; 	sha1='a1c02b6b754d74c08a70d5a8b604bdb72f1b276a'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 11 Aug 2022 02:46:03 GMT
VOLUME [/var/www/html]
# Thu, 11 Aug 2022 02:46:04 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 11 Aug 2022 02:46:04 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 11 Aug 2022 02:46:04 GMT
...
-	Layers:
	...
	-	`sha256:0d2f7688f09354e17bb68e22d04b6dcbe18b77713e0dad7480b62a9adb71b399`  
		...
		Size: 386.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ed8179d123b67bdc56ec78df987800f9c89915d7fbeac92459bf4c4b7f1ccaf`  
		Last Modified: Thu, 11 Aug 2022 02:57:46 GMT  
		Size: 21.0 MB (20994682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aba383accc10250f9d0801f904289d99308635fed680c8383b7ed976a45d03f9`  
		Last Modified: Thu, 11 Aug 2022 02:57:37 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41b736c4113b908c5f1794325d10991246f9d92821b722f6e2cc5196f667d74c`  
		Last Modified: Thu, 11 Aug 2022 02:57:38 GMT  
...
```console
$ docker pull wordpress@sha256:51af76e5beeb01595564fe0c63b8ffec5dc216c5a218fb9ac0c19c214a421448
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.7 MB (90707901 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:737468036fe8d0487b3c9e8086e068add86a5edfa654039dfa1101a1db5ac025`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f726da5f18e7cf614bca5c879880269ea35ca61c5a07c0d1d6e75a52518d4cb2`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff9a7238268b5f4875f17c90aaaf780a80d6196c25e43f798c3800d6a7508fa4`  
		Last Modified: Thu, 11 Aug 2022 06:45:10 GMT  
		Size: 21.0 MB (20994670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cddb02be2694840cc7fbcddc36734808cf826f2518fd1a409b42e5fb6fb88c44`  
		Last Modified: Thu, 11 Aug 2022 06:45:05 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f65568eb52b54f613b1c8e5adc0b0d05561b99d1118bb441be548fdea3a7688`  
		Last Modified: Thu, 11 Aug 2022 06:45:05 GMT  
