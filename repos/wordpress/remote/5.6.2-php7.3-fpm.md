...
```console
$ docker pull wordpress@sha256:0611151f82b37191e46a201c897973940e6a7db015d81b7e758d5ddb77bb060d
```
...
```console
$ docker pull wordpress@sha256:fc4c3977a6507b30bbfc978482dc315f20f441f5bd0acf049405a774b3a41ded
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186583766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d90ff5c15621212b8c37a7f53f5c2da78b70cc7e9f8338e9cc035e676ff79efc`
...
-	Layers:
	...
	-	`sha256:3564cef1339647cfe60666648a0a7cda0dcd8b13ae3f9316334b484ba29658f0`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbdc5d05b1e75f70566d9d1ccd9fff51fa377d4ee4666af5faa222bc1cae36db`  
		Last Modified: Sat, 06 Mar 2021 02:40:32 GMT  
		Size: 15.5 MB (15455627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac7ce7511ea6d13b00d87ab9133b2cab807008977969111b17031367ed52a1a`  
		Last Modified: Sat, 06 Mar 2021 02:40:23 GMT  
...
```console
$ docker pull wordpress@sha256:d8a3a3f682e13d0297946723a6ce4702c7229ea28e8d9694c86d5dbaf9790615
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.9 MB (191917093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c50711512c364deb28c41de46373e495262a6a677a3230196faca4b02975228`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 06 Mar 2021 01:17:01 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Sat, 06 Mar 2021 01:17:01 GMT
VOLUME [/var/www/html]
# Sat, 06 Mar 2021 01:17:01 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Sat, 06 Mar 2021 01:17:02 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 06 Mar 2021 01:17:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b357ece81dd40ea53444ffbe3896bd04d4d626f8902ffe2416ae6da7adad4e16`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:921cd00ced75e9f8125bfe60d6b4f73bfdfb8f994b3d6c1bc17f05682825dbe7`  
		Last Modified: Sat, 06 Mar 2021 01:36:11 GMT  
		Size: 15.5 MB (15455625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8b3f3c920af8d0b9bac5dbdce7b7a251cbfa14982461394fc41c2fb5ef3081a`  
		Last Modified: Sat, 06 Mar 2021 01:36:04 GMT  
		Size: 4.0 KB (3963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `wordpress:5.6.2-php7.3-fpm` - linux; ppc64le

```console
$ docker pull wordpress@sha256:4a1240db3545cc65130b861118dfd351034aeba2000b7b5de5d8107b73b65df1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.0 MB (197951182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23644d3589b88722f95ff52ee8ba8f17f01dbb371f1eb7a1890956f378401a2c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 23 Feb 2021 01:59:08 GMT
RUN set -eux; 	version='5.6.2'; 	sha1='8d19761595182c25d107813b55b911a22e7c809b'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 23 Feb 2021 01:59:13 GMT
VOLUME [/var/www/html]
# Tue, 23 Feb 2021 01:59:14 GMT
COPY file:21c61c8c5411c6f288a3a044c8f9622540460def171cd20ff6e83aa721350821 in /usr/local/bin/ 
# Tue, 23 Feb 2021 01:59:18 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 23 Feb 2021 01:59:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:085f5fb2305fc3c2a9e92b53f20035d46838404c75313fa898fd042a116557a9`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dbd48ac4d444a6053f2ac06def7ac1a395ff8c1f755802872d13f6ae32ae8e3`  
		Last Modified: Tue, 23 Feb 2021 02:07:42 GMT  
		Size: 15.5 MB (15455616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:037071e3dca3dba6286a642dda6260334d720c9727b06ebe89e5d56efce5969e`  
		Last Modified: Tue, 23 Feb 2021 02:07:38 GMT  
		Size: 4.0 KB (3960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
