...
```console
$ docker pull wordpress@sha256:0cd432a76ada7ed7290563cae0a2e64fed8b29b51944881c15ba2d66afd9c106
```
...
```console
$ docker pull wordpress@sha256:47dc2854a06c880d5671d938220f0aa233ad7b3eee9cbf53be530a4809fa56eb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.5 MB (92524984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ba9cac5889d5120bc9fb4207cf4a4be3fc3bb5c11a3d8c40f30105161934a36`
...
-	Layers:
	...
	-	`sha256:bf2d369cdfae8bfe42844acb6d283c2d6582f2c798f79019bfe7982c77b2dffe`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69d59bd3496f0c2017f9d44a56ce4c87dd0b79038d8674b780185bce55ea8c83`  
		Last Modified: Wed, 12 Jan 2022 23:36:07 GMT  
		Size: 19.5 MB (19524159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f55dfb9eec7ed9f6ab98b08a729c490164033315b7db4ae0c3449f807a02cc57`  
		Last Modified: Wed, 12 Jan 2022 23:36:04 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4af45cdadc0e9c7fc7da343c8dcea8ad71c1a001c3575d72abeadcb68d6839ce`  
		Last Modified: Wed, 12 Jan 2022 23:36:04 GMT  
...
```console
$ docker pull wordpress@sha256:dcbf48149832adc21c8d740a69c2908e8797b9af4dbd7199f6882ca07ee9ff22
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.5 MB (88496502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:537ade5d85e337732ef81adc6e4f8022fa8baf4e93ebe19c7ae01980ecd93bba`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:19:26 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:19:27 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:19:27 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:19:28 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:19:29 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 12 Jan 2022 23:19:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e923e14c8939f2dd216f97418803a1063d1a59da0dbb851dea1f6390e2069b04`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:947c26692fc60212e09b28340d7e6f9addc8d0b0fb9dd336415ec60ee071a39d`  
		Last Modified: Wed, 12 Jan 2022 23:26:54 GMT  
		Size: 19.5 MB (19524158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba7964e4104d4a37c37d368b8042592cbd36aa903eaded903140396eb726fd3e`  
		Last Modified: Wed, 12 Jan 2022 23:26:40 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:573f5f8485ff53a3da75edd2d74f64dbcdb6f539c1cffb36b210ad685365740b`  
		Last Modified: Wed, 12 Jan 2022 23:26:40 GMT  
...
```console
$ docker pull wordpress@sha256:ec0eb452b21090351cdedfa70bf8851a7c7baa60980ccd4448bc0d1d935fc0e7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **85.3 MB (85293506 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2598ab1ee38ee4862d39532740a44e7f51cb20ca89d8f98863e6040a03e3f81a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jan 2022 00:07:42 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 Jan 2022 00:07:43 GMT
VOLUME [/var/www/html]
# Thu, 13 Jan 2022 00:07:44 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 13 Jan 2022 00:07:44 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 Jan 2022 00:07:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jan 2022 00:07:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bb5e4094e691cf0eb00e12c8e031a45a58b6ff1f9b7f88b7f814dac0c78b6840`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56f86ea4a289b8b6391e0fe6c1d057f33b868154a45129700ffcd2396e01f926`  
		Last Modified: Thu, 13 Jan 2022 00:32:54 GMT  
		Size: 19.5 MB (19524173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c5600d2ca89c7d32547d4d6c274f8e033ff21bb3e27ea5ae34aade9ccf04873`  
		Last Modified: Thu, 13 Jan 2022 00:32:38 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3489d6f532b6384fc6a934d9c21e675eef5685e2a19bc711dd56c3d4d5046edf`  
		Last Modified: Thu, 13 Jan 2022 00:32:38 GMT  
...
```console
$ docker pull wordpress@sha256:6b37c296f76ccb36accc199e6215467eea8e2f98a187ccf05370fbbb134fa80a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.6 MB (90589479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:334f3ba0d89521d2e8bbf037da243daf06439291ab5661cbaa7134e5e951c7a9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 18 Dec 2021 06:15:49 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:54:55 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:54:56 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:54:57 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:54:58 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:54:58 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 12 Jan 2022 23:54:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:61773c0369f155044feedd7378f2f312b70f8d3d159a678891e3f44b78f20c3a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7d58e123c58ff4923dbcc764cec0443237966281973c4b25329f706ae497966`  
		Last Modified: Thu, 13 Jan 2022 00:09:57 GMT  
		Size: 19.5 MB (19524584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b512071bc41736d2bf1cfe02fb0c91a789aa580792405b6c2965d8e66e0a6e4`  
		Last Modified: Thu, 13 Jan 2022 00:09:54 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1854864386ed01fd49834bc7deb294bcd3f39cc4c9895267b6aba21ee18a51cb`  
		Last Modified: Thu, 13 Jan 2022 00:09:54 GMT  
...
```console
$ docker pull wordpress@sha256:6aad2e01e0041966d1c7c89ff2daa2920662c7f2f7bd1571b90d86b7dea247a8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.4 MB (93376106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:903bba1df282d124a831cb9cd41633a2071904e2d43ea96607fb76ddc1efeda3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6e9d9db1eb271830319fa2746a9d992554d3567acd3cade2b78f334192484be7`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47fe1469e4bb5a480345bdbda0001a31b0223c6c6ea9d0f5a53ef1238d4eb4d1`  
		Last Modified: Wed, 12 Jan 2022 23:04:31 GMT  
		Size: 19.5 MB (19524165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fcc31cbfe7be11e5d0b08b5525eb9f67a39cbfce728b0d6d2d3360a3e4b46bf`  
		Last Modified: Wed, 12 Jan 2022 23:04:26 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d977cff0482f459360374c4c824dc6f75a546b269663ce158515b4a8be1561a`  
		Last Modified: Wed, 12 Jan 2022 23:04:26 GMT  
...
```console
$ docker pull wordpress@sha256:a1ddd437d7fdecb42935c2737ef8206183e5809a2117fe4be3260c40fe0f7cb2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.5 MB (94531614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:017d35dcf5cc55da2bf22fa16eab9b3a3e09c4ab0434e76bbed4e9e02d53c99a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 13 Jan 2022 00:06:05 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 13 Jan 2022 00:06:33 GMT
VOLUME [/var/www/html]
# Thu, 13 Jan 2022 00:06:37 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 13 Jan 2022 00:06:38 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 13 Jan 2022 00:06:46 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jan 2022 00:06:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d7675f4197ea7980011370a90b4297acd503a1a5d711ffb7f86dfd0b61ab924`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b08e0e8fef6ed1acef96134e8aef895e1bbc8b9285ddac76cd9b808d0828002b`  
		Last Modified: Thu, 13 Jan 2022 00:22:23 GMT  
		Size: 19.5 MB (19524159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4c4409bb2ccad671c1acac16b6c6b0c0ff1a75ecfc9c30076b7fbc24b3a3dec`  
		Last Modified: Thu, 13 Jan 2022 00:22:19 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6732112401949148855e38a8b2734c81dd77cc94dca8e47db6f50fdeed3398a`  
		Last Modified: Thu, 13 Jan 2022 00:22:19 GMT  
...
```console
$ docker pull wordpress@sha256:8484f91027905ddd51aefdf455e41f2d06639cf737de5acf05b770f8f810ee00
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.3 MB (83274717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e7bb4821be4518ee57c1c53c8eb778ce115cc6241babb0aeff58424ee9ab2df`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 12 Jan 2022 23:04:40 GMT
RUN set -eux; 	version='5.9-RC2'; 	sha1='169b60d57d34c55d0b8bdfc122e0810d61b781a6'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 12 Jan 2022 23:04:41 GMT
VOLUME [/var/www/html]
# Wed, 12 Jan 2022 23:04:42 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 12 Jan 2022 23:04:42 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 12 Jan 2022 23:04:42 GMT
...
-	Layers:
	...
	-	`sha256:1b7cc576b4fcdf4725b85a14554d1fdfbf8a1bce5ab2c1fee2dbdb33473dbe20`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61fe1bbd61bb0e4ee52414b5655c2955e586ad7a736e6fedd2d99b1df86e720b`  
		Last Modified: Wed, 12 Jan 2022 23:16:32 GMT  
		Size: 19.5 MB (19524169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1609ae2808aaf291e8f40a66a811166f3c1827a4772ca5d33b4aa42aad5313f`  
		Last Modified: Wed, 12 Jan 2022 23:16:29 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2325720c9f9e860a2dd97889e4529503b2c959fc7005f3bfcc3a6893237bfdbb`  
		Last Modified: Wed, 12 Jan 2022 23:16:30 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
