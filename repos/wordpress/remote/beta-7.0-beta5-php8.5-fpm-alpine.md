...
```console
$ docker pull wordpress@sha256:fe346e0cdd9a140033442eb400c03a1c176080dc58c14fc22dd80ca021805503
```
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-beta5-php8.5-fpm-alpine` - linux; s390x
