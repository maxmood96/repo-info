...
```console
$ docker pull wordpress@sha256:d663ad485ca10c16e45adaf509d1b1ec544f8ed97faa69f6511725a0536c5236
```
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; amd64
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; mips64le
...
### `wordpress:beta-6.1.1-RC1-apache` - linux; ppc64le
