...
```console
$ docker pull wordpress@sha256:7f9c1451f78089606828113d7c63afb45ebc24b39cf8799ae01862519ce03144
```
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC2-php8.1-fpm` - linux; s390x
