...
```console
$ docker pull wordpress@sha256:aae837cbaa04925fc87d0e663e69702d67f0f8b5e0c363f8d4b82b9e47e52333
```
...
```console
$ docker pull wordpress@sha256:3535de551dc4f3d2c0d7df5c47e7aeee2d96bc70910f3755c6c11cfc728b84cf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.6 MB (77616437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:765674f843b0bdc14237ff069744bec7e1f6b18bf8d549ac7162178da1d1e901`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eb627edb8cc2c73847c3ec2586b852ebd606f4562928fd73ce4c5efc0763085d in /usr/local/bin/ 
# Thu, 04 Mar 2021 20:27:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Mar 2021 20:27:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3407701b8eba5df5edfe0f2cd6da729977e455b588a60269040526bafb43c467`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d18b2cde9c0d8903a2cacd422f2456c56ba296b29049fa3e394ff52c74ad4549`  
		Last Modified: Thu, 04 Mar 2021 20:29:25 GMT  
		Size: 15.6 MB (15582851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:039bcfe3b28fdfea94446027f7025a25650a5132d7f561821032c2c6473f5a4d`  
		Last Modified: Thu, 04 Mar 2021 20:29:19 GMT  
		Size: 2.1 KB (2096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9888ffc39d2c4efb43d14b87ba1988ce192b845f5d1d60a1333d100dd4d18fd0`  
		Last Modified: Thu, 04 Mar 2021 20:29:19 GMT  
...
```console
$ docker pull wordpress@sha256:5895d9a69984030f57b1941a83f6630355e1672ed1bfaef148600758e721345d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.5 MB (71549052 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2faf9e9ee4c6a756cfef5486341e21b94c3f9445b45d347314b96cc3afe03af1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 04 Mar 2021 20:19:17 GMT
RUN set -eux; 	version='5.7-RC2'; 	sha1='17bfade655b05b624fcd9c0d45abf61cf526b82e'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 04 Mar 2021 20:19:18 GMT
VOLUME [/var/www/html]
# Thu, 04 Mar 2021 20:19:18 GMT
COPY --chown=www-data:www-datafile:0c72cdf4bfc53e48a50a27b4181a810916f30eb16f37044bd4298ee8328646d5 in /usr/src/wordpress/ 
# Thu, 04 Mar 2021 20:19:18 GMT
COPY file:eb627edb8cc2c73847c3ec2586b852ebd606f4562928fd73ce4c5efc0763085d in /usr/local/bin/ 
# Thu, 04 Mar 2021 20:19:19 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 04 Mar 2021 20:19:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f1cb6acb747283d61db044cc11bdd4edca5739c7068594ce1401419c0ccb127d`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f641b83fae1ee7f58407a5f45d341715d97abed4165b00a8748e7e4c3b6beb26`  
		Last Modified: Thu, 04 Mar 2021 20:23:11 GMT  
		Size: 15.6 MB (15582852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:876fddbebc3389d933b43c7c3ffcd80be49089c34ae8742b0153d9b1ede9675c`  
		Last Modified: Thu, 04 Mar 2021 20:23:07 GMT  
		Size: 2.1 KB (2094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5521bb25db8df1a12f15867948f429f0bc3e917dfe291361e0096884e5e582c8`  
		Last Modified: Thu, 04 Mar 2021 20:23:07 GMT  
		Size: 1.6 KB (1636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
