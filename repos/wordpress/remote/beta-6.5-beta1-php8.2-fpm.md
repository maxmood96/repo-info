...
### `wordpress:beta-6.5-beta1-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta1-php8.2-fpm` - linux; mips64le
...
### `wordpress:beta-6.5-beta1-php8.2-fpm` - linux; s390x
