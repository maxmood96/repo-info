## `wordpress:beta-5.7-beta2-fpm`

```console
$ docker pull wordpress@sha256:a56741f9c52ba8fc8173a6ae551786ea7f8dc60fc602dd6a4bdfe2b0c9be6d42
```
...
### `wordpress:beta-5.7-beta2-fpm` - linux; amd64
...
### `wordpress:beta-5.7-beta2-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta2-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta2-fpm` - linux; 386
...
### `wordpress:beta-5.7-beta2-fpm` - linux; mips64le
...
### `wordpress:beta-5.7-beta2-fpm` - linux; ppc64le
...
### `wordpress:beta-5.7-beta2-fpm` - linux; s390x
