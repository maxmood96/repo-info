...
```console
$ docker pull wordpress@sha256:00a6b3725dc1507507b2eea7c3c922a18dce2206762ffa2de92ba5e718ddfa01
```
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.4` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.4` - linux; s390x
