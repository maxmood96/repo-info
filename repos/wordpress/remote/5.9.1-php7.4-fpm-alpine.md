...
```console
$ docker pull wordpress@sha256:1e3e5b1f33ba70b54e6dd1b46821690dc5ea91c76ffa27e2d2450e530acfc34f
```
...
### `wordpress:5.9.1-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:5.9.1-php7.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.9.1-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.9.1-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:5.9.1-php7.4-fpm-alpine` - linux; s390x
