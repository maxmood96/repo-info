...
```console
$ docker pull wordpress@sha256:37d1f6ea46b353fe5564c1bfd4690fd3e9e3603dcc56d03bf3087b010c1419dd
```
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; amd64
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - unknown; unknown
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; 386
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; ppc64le
...
### `wordpress:beta-7.0-beta2-php8.2-apache` - linux; s390x
