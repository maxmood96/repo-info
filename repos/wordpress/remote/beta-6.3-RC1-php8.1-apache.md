...
```console
$ docker pull wordpress@sha256:5f5484f8219d9354d088333b4f3f767b6b6eda9b624bc193ef4c38279ee39025
```
...
### `wordpress:beta-6.3-RC1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.1-apache` - linux; ppc64le
