...
```console
$ docker pull wordpress@sha256:69dee2fec5bffdddf99844f1a44d30a22eefb3033ba49b85efc7ef3a9256361a
```
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC4-php8.1-fpm-alpine` - linux; s390x
