...
```console
$ docker pull wordpress@sha256:7ad24795f5548abfc1781c5dc75ad7131ec63c9847ab666afdcea1af5ed68c68
```
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; amd64
...
### `wordpress:beta-6.8-RC1-php8.4` - unknown; unknown
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; arm variant v5
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; arm variant v7
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; 386
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; ppc64le
...
### `wordpress:beta-6.8-RC1-php8.4` - linux; s390x
