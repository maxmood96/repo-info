...
```console
$ docker pull wordpress@sha256:96331f5ce923c9070c08820df1d01c75039277ed2fd45bc40c774f034955ad4b
```
...
```console
$ docker pull wordpress@sha256:8e4b56df76f9386f9478ec87bf239b548265420ed0d832eae4fc69c0985b95c8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.0 MB (257991914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b7c3e01230dfc2f2874bfb9b068210ce765f00aada67ac22a4cb381c9f4978a`
...
-	Layers:
	...
	-	`sha256:ccd458eb15c3de4d7a72a067265ba33f837efebc69d9e4e0f9a8a52907efec76`  
		...
		Size: 894.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:77fc495efb133871e004f5c153fe228dfd17911ec3e6d7a7cc9c848ecf0daf65`  
		Last Modified: Tue, 12 Mar 2024 23:59:44 GMT  
		Size: 26.3 MB (26254074 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:003327e6fdad745c7170ad602685303010b37d4d882e480440e6866ac4292c13`  
		Last Modified: Tue, 12 Mar 2024 23:59:45 GMT  
		Size: 29.0 MB (28970070 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0ee3ec6c9cdea7d0d71c9acc7c6fcd8429e5035e9bc0463b4c94904d399fd9e1`  
		Last Modified: Tue, 12 Mar 2024 23:59:44 GMT  
		Size: 363.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2318cc8eb9b653486defa27aa87d9f3cde5defe31b2c6178a70f99b30901f2da`  
		Last Modified: Tue, 12 Mar 2024 23:59:44 GMT  
		Size: 392.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d502985cbadf2b69a2fb44c1dc70bf19614ed0b74d289cf681d444b4f1604611`  
		Last Modified: Tue, 12 Mar 2024 23:59:45 GMT  
		Size: 19.2 KB (19158 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:71c569fb02b061186a92e0a1dcef4fff86ec792adc05b184e9f827693f9720c3`  
		Last Modified: Tue, 12 Mar 2024 23:59:45 GMT  
		Size: 24.5 MB (24522518 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2e55e533a05c9148cc9b9c613c683cf0432be47c0dd198c7159d50a8a8f7b74d`  
		Last Modified: Tue, 12 Mar 2024 23:59:45 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:63fbe3bf37ad31accab4e8361b8d1663300dde72733116a1e5486325cfadcde8`  
...
```console
$ docker pull wordpress@sha256:1cba3e1987d7ae34cc4e4695e1801214d2ea44f75a919cf12f8945332b5b9b58
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **9.0 MB (9026214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73c856497e26720a5d306c2ae9afcbb12c2ff5ecb809a969a01a71a7684864b7`

```dockerfile
```

-	Layers:
	-	`sha256:f2dae4f44e735ac5da5a83fd6a8a5fa012b4f7c4ecdf0df5013a4cb84e32994c`  
		Last Modified: Tue, 12 Mar 2024 23:59:44 GMT  
		Size: 9.0 MB (8964493 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7455726c7c2faf890eccd3d6c014736aab23e99b7d0db0e7e003058288469705`  
		Last Modified: Tue, 12 Mar 2024 23:59:44 GMT  
...
```console
$ docker pull wordpress@sha256:4177fc87219e04956ebfdd1aa680e84bff00e6f14b733e135762daf5aa4423ba
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.0 MB (227962581 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3036ce90c88916e0b31633abe0ec0a8c5779f47f5494f0f35f98fec4feed1eb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Mar 2024 02:18:26 GMT
ENV PHP_SHA256=b0a996276fe21fe9ca8f993314c8bc02750f464c7b0343f056fb0894a8dfa9d1
# Tue, 12 Mar 2024 02:18:40 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 12 Mar 2024 02:18:40 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Tue, 12 Mar 2024 02:21:27 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Tue, 12 Mar 2024 02:21:27 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Tue, 12 Mar 2024 02:21:28 GMT
RUN docker-php-ext-enable sodium
# Tue, 12 Mar 2024 02:21:28 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 12 Mar 2024 02:21:28 GMT
...
-	Layers:
	...
	-	`sha256:9f0e204872c8036178546d2a2dda9c32bda9325af26fd404f646ede63d043155`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2bc3c3df86a3363e2d006656265c6cbee41184efb144b28db40758810a846173`  
		Last Modified: Wed, 13 Mar 2024 00:00:59 GMT  
		Size: 24.5 MB (24522512 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0245593eb212db7446494183d64c488c8348613fb5a7bedcfff10ac553967c33`  
		Last Modified: Wed, 13 Mar 2024 00:00:58 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:51e241ad62c8857f38ecaca3317e3267ec13ddccdc679a5ebe746865fb5aefa4`  
		Last Modified: Wed, 13 Mar 2024 00:00:58 GMT  
...
```console
$ docker pull wordpress@sha256:2765844aceb47c1553bba68b21577f855dc3f471ccd6426f22669db0510ed97e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.8 MB (8831910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f56f60b6c5e5acf71cb253c031f89cd6290aa8cf620af1f0ce7ec3e44d66960`

```dockerfile
```

-	Layers:
	-	`sha256:57e43f436274250d966e97686d7700d892f9d9bdbb152ad2df08dec55c6c0edd`  
		Last Modified: Wed, 13 Mar 2024 00:00:58 GMT  
		Size: 8.8 MB (8772140 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1994e218485cf0528eb068401feb3ade4bed0d575ea30bce14dcd2de721be0be`  
...
```console
$ docker pull wordpress@sha256:f50a2ffe61f7a7c3ffca209a914c9a3aef18553b8f8519a3704dd46c2df91504
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.6 MB (216649392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0227c91ab67a4fdd473a77db5a871e0a22dc0a77890e26a6539356d4a26d7109`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:050d48c7c2c12b34753f4eca848d7022c4c2393af13720354cc89bd50322eb69`  
		...
		Size: 19.2 KB (19158 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5cd76691d95c02c0f715cc94ad852f9fb5a2429b1f50b2c71f79190d0c333db1`  
		Last Modified: Wed, 13 Mar 2024 10:42:28 GMT  
		Size: 24.5 MB (24522525 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:54d1852a161fd1cb040850842d43a1607395a1b51858e3f40cf994cbebe15f05`  
		Last Modified: Wed, 13 Mar 2024 10:42:27 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9c7f36943333749a83826ad3545b617a6c9bc25136591bdade37fa9d01c8e141`  
		Last Modified: Wed, 13 Mar 2024 10:42:27 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:cae1c2dfac866df89e514f9b0170cdd3e034d7a9791a63e0dee25aa56b0ab8f1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.8 MB (8836648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29ed293bed7856b58ad16577caa4c55c6469b7e1a0c8be8d2dbbad394dcbdd4a`

```dockerfile
```

-	Layers:
	-	`sha256:0db03fff7dd9272bf090a91d035960c704760d975587fa85276f1e1dfb2770be`  
		Last Modified: Wed, 13 Mar 2024 10:42:26 GMT  
		Size: 8.8 MB (8776878 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2626a1535a844cdc8d78fbb1070683b6cc280b1a88ed2df94affeff128558aba`  
		Last Modified: Wed, 13 Mar 2024 10:42:26 GMT  
		Size: 59.8 KB (59770 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull wordpress@sha256:0b05b45f06c3d4b1ecfbfe3b848b439e0157b398eafca588be11afbf01180b3e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.4 MB (249364822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca25bfbb4c50b82c8e4a6dce15bc28944c6b7fc7a7ebda5f976cb3740c89a0f8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:a3026096af0f683709fef5d03f0cf7bf87ae890540865773fd7b6cd92ca5356e`  
		...
		Size: 19.2 KB (19157 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8754c69421d6ff2bbfb746e7f25746b49cb1a937a7868bf3e1ad4dcf588b1718`  
		Last Modified: Wed, 13 Mar 2024 08:38:12 GMT  
		Size: 24.5 MB (24522529 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:49b3bdf5b835e98aa7e14268dc79c0982fc30089b6efb8db1e3575c38919a601`  
		Last Modified: Wed, 13 Mar 2024 08:38:11 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3119b426abfc73a8397bcda3e03aca6aaf9ac31dc97af383e36ccf1cadd68914`  
		Last Modified: Wed, 13 Mar 2024 08:38:11 GMT  
		Size: 1.7 KB (1727 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:260676232d8ee5b4d808d92a357647ed1ff3c72eb46b128067af4f9f6b90cc18
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **9.1 MB (9052897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8350f490fc831a39decb9852edbe11c10fff88a17b9743d3c2ecde61a5c892b`

```dockerfile
```

-	Layers:
	-	`sha256:f7ea364b36f7bd3f252ab1563451437d162121627e8f3d6f0b7eef047a005ed2`  
		Last Modified: Wed, 13 Mar 2024 08:38:11 GMT  
		Size: 9.0 MB (8993277 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3b76d252648d66350639067557055d90d188a835b2bf500bbaf14d3fbba11265`  
		Last Modified: Wed, 13 Mar 2024 08:38:11 GMT  
...
```console
$ docker pull wordpress@sha256:cb7b333a346d65a3d9b09658a9ce032e0cf39c906c2064950b1ef73ade9cab79
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.7 MB (256734460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7a1cc0ce80abb5421770adc5f40fbc16783314f7d8d2dfce708a8d572127a7f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:d229f7a2878344570c073f6282260893ee1073f30e1c3a67cc1d7797a0a7deea`  
		...
		Size: 892.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:19f2c404e343a439f47db07044de6f2ba38385de10128706ead71320cd83a9b9`  
		Last Modified: Tue, 12 Mar 2024 23:59:56 GMT  
		Size: 26.7 MB (26700574 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bf88ca8546f29c5e5432e1dfeb60925123d467224a4ce2f8cb6fb9a4811112b9`  
		Last Modified: Tue, 12 Mar 2024 23:59:56 GMT  
		Size: 28.3 MB (28340991 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8fbfe0990e27562eef1d428b00dafec7e16fe86c7ad5170ae56c3eeb58677ee3`  
		Last Modified: Tue, 12 Mar 2024 23:59:55 GMT  
		Size: 358.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f55340025038bd443704dcd60dec2155101523e3fc25275f757efcadefc4baed`  
		Last Modified: Tue, 12 Mar 2024 23:59:55 GMT  
		Size: 391.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:38d765f4e8343c67ec83d9d83a2de30ed0ecccdf5168d8d7816e68d340f0556e`  
		Last Modified: Tue, 12 Mar 2024 23:59:56 GMT  
		Size: 19.2 KB (19160 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5197ec6d7f4b165937d2f8f2631f62b92090687474079ef0c1c164e310922266`  
		Last Modified: Tue, 12 Mar 2024 23:59:57 GMT  
		Size: 24.5 MB (24522526 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:832abcd9aeea28c375752a2510db25c32c2ebb9dd6c7a87dc1d29e2dd4b16c32`  
		Last Modified: Tue, 12 Mar 2024 23:59:57 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7980c56cac009c07a6712fead75e74168a2ff9ec8b0752c1a43489af2a3e97dc`  
		Last Modified: Tue, 12 Mar 2024 23:59:57 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:8758d5db625478c1e18675f0262a99521ff89e4a77ff93f001a1217d20e082e0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **9.0 MB (9006082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3cdcdb9efe138a0f7d24c9820c1f74edf82441a360481dd92755569c08da9ca`

```dockerfile
```

-	Layers:
	-	`sha256:aba16d5e3a73c55f0908d34e186e8eb0dec4652a271d0131e83dd4300deb361f`  
		Last Modified: Tue, 12 Mar 2024 23:59:55 GMT  
		Size: 8.9 MB (8944420 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bf8a76c2afe24c57417a436550421d10bf6f91201fbf8b9e4e2c9830decb764c`  
		Last Modified: Tue, 12 Mar 2024 23:59:55 GMT  
...
```console
$ docker pull wordpress@sha256:eb017a7a904a9ae0285e3618643ca4f68c7377539f74f4ffd1955c8fc9c06d02
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.1 MB (230077317 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4121dd21e6942a7cc6e80d806d6c4d11c06fa4d6ae465bf3c27d05e40e4d49b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Tue, 12 Mar 2024 09:31:19 GMT
ENV PHP_VERSION=8.3.3
# Tue, 12 Mar 2024 09:31:23 GMT
ENV PHP_URL=https://www.php.net/distributions/php-8.3.3.tar.xz PHP_ASC_URL=https://www.php.net/distributions/php-8.3.3.tar.xz.asc
# Tue, 12 Mar 2024 09:31:27 GMT
ENV PHP_SHA256=b0a996276fe21fe9ca8f993314c8bc02750f464c7b0343f056fb0894a8dfa9d1
# Tue, 12 Mar 2024 09:32:17 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 12 Mar 2024 09:32:20 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Tue, 12 Mar 2024 09:47:40 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Tue, 12 Mar 2024 09:47:44 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Tue, 12 Mar 2024 09:47:50 GMT
RUN docker-php-ext-enable sodium
# Tue, 12 Mar 2024 09:47:54 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 12 Mar 2024 09:47:57 GMT
STOPSIGNAL SIGWINCH
# Tue, 12 Mar 2024 09:48:00 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Tue, 12 Mar 2024 09:48:04 GMT
WORKDIR /var/www/html
# Tue, 12 Mar 2024 09:48:07 GMT
EXPOSE 80
# Tue, 12 Mar 2024 09:48:11 GMT
CMD ["apache2-foreground"]
# Tue, 12 Mar 2024 19:03:10 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 12 Mar 2024 19:03:10 GMT
...
-	Layers:
	...
	-	`sha256:1575bb47c829a13fb21165f4b1975fa8fa15788f4ff72db764cd177daea7cd5d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:596504b6fb6c4dd216aeec2c4cf8d5baf909a1747793e6654071a6b12a910d04`  
		Last Modified: Thu, 14 Mar 2024 08:20:21 GMT  
		Size: 24.5 MB (24522518 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2d878fb72ea6868519bfd24c63cda40ae44eaf9cd2724cad481ff93d6338bbef`  
		Last Modified: Thu, 14 Mar 2024 08:20:19 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:93274d908fa12c9bad0c9bcea434bc919498737df2731cb9fe16d0f57252e2c0`  
		Last Modified: Thu, 14 Mar 2024 08:20:19 GMT  
...
```console
$ docker pull wordpress@sha256:70d916614c03d0186e36b53a7709c71af994cc2709d476d20a51c55c42b7b062
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.5 KB (59495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef7cd39306f76d07ac9c5f0b72fc66d7b1e1c32977d33a90a4f5be03c9774897`

```dockerfile
```

-	Layers:
	-	`sha256:cb17a1c016e3d7ab4a102c6972c1c50efd26469c42ead5858f0affa7dab32e15`  
		Last Modified: Thu, 14 Mar 2024 08:20:18 GMT  
...
```console
$ docker pull wordpress@sha256:52f467da66194b2dec77da927ff73d7beb5929d3b8ef8caeffab89a5dc6e8b2b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.6 MB (263642609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71874112cd7ff81c26ddcd810800630d6f78683d065d7b65a92e81c86ea8b0d5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:821d36c491ced8cc1b8ee3b36805afc49e86887601ddc5a8d3a4e0c4ff46b486`  
		...
		Size: 19.2 KB (19157 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:218023b8afcc693c99fa54bab3878a080c6b46cd6c77582a91d5e44909d9fdea`  
		Last Modified: Wed, 13 Mar 2024 09:53:47 GMT  
		Size: 24.5 MB (24522526 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3f68977a2c7cda62867d870c26ec30f74dbc76568ced72f48b81ae25064cd28b`  
		Last Modified: Wed, 13 Mar 2024 09:53:46 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7adab6f451baf0d53cbf0c6e07639817adf83f852c7b908a633d95359cbc5e9a`  
		Last Modified: Wed, 13 Mar 2024 09:53:46 GMT  
		Size: 1.7 KB (1727 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:aebb2239be0546c08d5c62b848b28468ffa5581bb9f6a802732aab3232fdc3c5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **9.0 MB (9003499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe6756359b4211a1ec1484a3e0cd2a6ae63aadccf900b1aa901c5079eeeac833`

```dockerfile
```

-	Layers:
	-	`sha256:eb0b6e9f6851bf3259a0196c327c5dca0fffdb1302fe9553fe27a66c8a5163d9`  
		Last Modified: Wed, 13 Mar 2024 09:53:46 GMT  
		Size: 8.9 MB (8943815 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f50e9b4fdcebfc47c1dff8e45f78115a32340ea55c3becf15880d23158eb207c`  
		Last Modified: Wed, 13 Mar 2024 09:53:46 GMT  
