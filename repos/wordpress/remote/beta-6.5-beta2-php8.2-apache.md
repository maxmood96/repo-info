...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - unknown; unknown
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; mips64le
...
### `wordpress:beta-6.5-beta2-php8.2-apache` - linux; s390x
