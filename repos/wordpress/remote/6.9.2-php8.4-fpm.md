...
```console
$ docker pull wordpress@sha256:3fd22ca0aa29e25b5cb01e61bc62bf4f3ef1d489ec19da104c1b4b8f57d75625
```
...
### `wordpress:6.9.2-php8.4-fpm` - linux; amd64
...
### `wordpress:6.9.2-php8.4-fpm` - unknown; unknown
...
### `wordpress:6.9.2-php8.4-fpm` - linux; arm variant v5
...
### `wordpress:6.9.2-php8.4-fpm` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.4-fpm` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.4-fpm` - linux; 386
...
### `wordpress:6.9.2-php8.4-fpm` - linux; ppc64le
...
### `wordpress:6.9.2-php8.4-fpm` - linux; s390x
