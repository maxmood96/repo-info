...
```console
$ docker pull wordpress@sha256:a5399da7b218233b377a6d8a510590ec6be0502961b3a9864509e4e16974519a
```
...
### `wordpress:beta-7.0-beta4-apache` - linux; amd64
...
### `wordpress:beta-7.0-beta4-apache` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-apache` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta4-apache` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-apache` - linux; 386
...
### `wordpress:beta-7.0-beta4-apache` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-apache` - linux; s390x
