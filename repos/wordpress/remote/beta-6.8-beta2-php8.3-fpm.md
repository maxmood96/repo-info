...
```console
$ docker pull wordpress@sha256:458cdcaf372f77a17eebd57b233a05f7f58b88eacf9f16f31d9879832aca90fc
```
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; 386
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-6.8-beta2-php8.3-fpm` - linux; s390x
