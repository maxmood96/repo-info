...
### `wordpress:beta-6.6.2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6.2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.6.2-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.6.2-php8.3-fpm` - linux; s390x
