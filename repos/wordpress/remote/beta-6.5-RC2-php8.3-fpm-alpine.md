...
```console
$ docker pull wordpress@sha256:e5970a04208e3b62c6f1382cbc0aa86b332f3d514343375a348f4201d980d001
```
...
### `wordpress:beta-6.5-RC2-php8.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-RC2-php8.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC2-php8.3-fpm-alpine` - linux; ppc64le
