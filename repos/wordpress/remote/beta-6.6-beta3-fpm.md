...
```console
$ docker pull wordpress@sha256:4b88d7141677dcbc3c6edad47682770d126da808a1dd509dfa83aba85614f44f
```
...
### `wordpress:beta-6.6-beta3-fpm` - linux; amd64
...
### `wordpress:beta-6.6-beta3-fpm` - unknown; unknown
...
### `wordpress:beta-6.6-beta3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.6-beta3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.6-beta3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.6-beta3-fpm` - linux; 386
...
### `wordpress:beta-6.6-beta3-fpm` - linux; mips64le
...
### `wordpress:beta-6.6-beta3-fpm` - linux; s390x
