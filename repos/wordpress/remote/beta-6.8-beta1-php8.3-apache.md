...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; amd64
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; 386
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; mips64le
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-6.8-beta1-php8.3-apache` - linux; s390x
