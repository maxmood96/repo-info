...
```console
$ docker pull wordpress@sha256:5177ff15dd06e9e4ec2fdedafcd2e1931eac226dda2b0c0d30730a6c47aa71f0
```
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-beta2-php8.4-fpm-alpine` - linux; s390x
