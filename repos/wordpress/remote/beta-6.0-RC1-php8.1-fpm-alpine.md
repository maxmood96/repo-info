...
### `wordpress:beta-6.0-RC1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0-RC1-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.0-RC1-php8.1-fpm-alpine` - linux; ppc64le
