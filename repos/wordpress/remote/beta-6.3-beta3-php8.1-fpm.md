...
### `wordpress:beta-6.3-beta3-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-beta3-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.3-beta3-php8.1-fpm` - linux; mips64le
