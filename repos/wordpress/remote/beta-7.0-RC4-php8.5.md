...
### `wordpress:beta-7.0-RC4-php8.5` - linux; amd64
...
### `wordpress:beta-7.0-RC4-php8.5` - unknown; unknown
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; 386
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; ppc64le
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; riscv64
...
### `wordpress:beta-7.0-RC4-php8.5` - linux; s390x
