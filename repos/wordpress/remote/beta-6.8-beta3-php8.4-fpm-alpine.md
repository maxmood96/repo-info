...
```console
$ docker pull wordpress@sha256:f10cdbebd3b56fdb1f4d0b1d0f88113a228c168eefb01efaa9700256c96828b8
```
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.8-beta3-php8.4-fpm-alpine` - linux; s390x
