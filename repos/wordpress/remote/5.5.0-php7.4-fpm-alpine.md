## `wordpress:5.5.0-php7.4-fpm-alpine`

```console
$ docker pull wordpress@sha256:4dff06f1665ab750ebb374396a2155b36193e53b1f820457a006d501451561de
```
...
### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull wordpress@sha256:1912a5b9822483778548c9282c9976f7307de8088b5efbc7f0025f80fd9aa3e7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.2 MB (72231969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7beec16c3f21fdb5c50dd627a12d6a20cda6e2619b741bfb63a4e2b07371285`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 02 Sep 2020 04:27:20 GMT
ENV WORDPRESS_VERSION=5.5
# Wed, 02 Sep 2020 04:27:25 GMT
ENV WORDPRESS_SHA1=03fe1a139b3cd987cc588ba95fab2460cba2a89e
# Wed, 02 Sep 2020 04:27:57 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 04:28:03 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 04:28:12 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 04:28:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 04:28:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1e198ca3b6b380c686bf2fdf8a4e04f6bf531a2f9b5679c565dd2513672c7ebc`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2f7aa0799b26e24515cdb0f6c72d6fe1b09dbac3ea87d49ac99ac71edff44f1`  
		Last Modified: Wed, 02 Sep 2020 04:45:04 GMT  
		Size: 12.8 MB (12836954 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0febc78f6b762b0f626875798fa2e1e4cbdc3d4f252778c8c0276534d6401c36`  
		Last Modified: Wed, 02 Sep 2020 04:44:58 GMT  
		Size: 4.1 KB (4148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:3d3e9fcf486966d30396d19c5af582c5e3aaa34e4dad5cc09f8791e26d4af93b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v1+json`
-	Total Size: **76.9 MB (76889514 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `b4f1df81c0a34eec0fc63a20cbec91a8e7a783d465af189cae0c41e5fa75b106`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull wordpress@sha256:0ccf5c71b1e73887c61b818a4b529713d18563083380b61039d01c6c9b4eb241
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **79.8 MB (79838481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57d270735782fa9d13af0840c7490a091c71501eb7c375ccd75703bfbaf1c378`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 02 Sep 2020 01:36:37 GMT
ENV WORDPRESS_VERSION=5.5
# Wed, 02 Sep 2020 01:36:43 GMT
ENV WORDPRESS_SHA1=03fe1a139b3cd987cc588ba95fab2460cba2a89e
# Wed, 02 Sep 2020 01:36:55 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 02 Sep 2020 01:36:59 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 01:37:01 GMT
COPY file:f56966eeac957656aead5cb65d1531bfe029ddac03ee3ffefdafd2f0d4252925 in /usr/local/bin/ 
# Wed, 02 Sep 2020 01:37:03 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 02 Sep 2020 01:37:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1fcc3291cf5f2464905047f4a1d5aad5bb56e0a47674e900ca2c4e59d6510f0b`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dd371f6758725ff6a45351164772b8e17cf39e78e5ade135c5db48ed492ebb9`  
		Last Modified: Wed, 02 Sep 2020 01:52:01 GMT  
		Size: 12.8 MB (12836931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ef877809e068635221e0677f94edb670c93f70350dfed1b989737e830daa8a6`  
		Last Modified: Wed, 02 Sep 2020 01:51:57 GMT  
		Size: 4.1 KB (4149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:5.5.0-php7.4-fpm-alpine` - linux; s390x
