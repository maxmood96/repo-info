...
### `wordpress:beta-5.7-RC3` - linux; amd64
...
### `wordpress:beta-5.7-RC3` - linux; arm variant v5
...
### `wordpress:beta-5.7-RC3` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC3` - linux; 386
...
### `wordpress:beta-5.7-RC3` - linux; ppc64le
...
### `wordpress:beta-5.7-RC3` - linux; s390x
