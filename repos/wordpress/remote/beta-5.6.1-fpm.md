## `wordpress:beta-5.6.1-fpm`

```console
$ docker pull wordpress@sha256:af2992e83f9dc8875fb1fc68d7373388c1699731595a107704f17a57abddd636
```
...
### `wordpress:beta-5.6.1-fpm` - linux; amd64
...
### `wordpress:beta-5.6.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.6.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.6.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.6.1-fpm` - linux; 386
...
### `wordpress:beta-5.6.1-fpm` - linux; mips64le
...
### `wordpress:beta-5.6.1-fpm` - linux; s390x
