...
```console
$ docker pull wordpress@sha256:f6d0e6648032e979ac4b73c42863f84adc3db0fa6187789393fea2b1a67fbb53
```
...
### `wordpress:6.2.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.2.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.2.0-fpm-alpine` - linux; 386
...
### `wordpress:6.2.0-fpm-alpine` - linux; s390x
