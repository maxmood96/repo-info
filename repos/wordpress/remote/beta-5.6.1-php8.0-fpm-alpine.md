...
```console
$ docker pull wordpress@sha256:2c547cd78a6d8832b2a5a4c39d7d06481ed1a8506ef8f1e4ecb346ff5c2851c1
```
...
### `wordpress:beta-5.6.1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.6.1-php8.0-fpm-alpine` - linux; 386
