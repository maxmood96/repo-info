...
```console
$ docker pull wordpress@sha256:79a0412ade666d9dee9e9f84b585ed46892b9f9e9a5321920b356641cb9c32b7
```
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-fpm-alpine` - linux; s390x
