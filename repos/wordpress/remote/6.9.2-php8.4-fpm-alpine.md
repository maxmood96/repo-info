...
```console
$ docker pull wordpress@sha256:91ca9e160da7d54f0b91b19d642ab5cb29ae768fb079576886a3be13e2ebfac9
```
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; amd64
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - unknown; unknown
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; 386
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.9.2-php8.4-fpm-alpine` - linux; s390x
