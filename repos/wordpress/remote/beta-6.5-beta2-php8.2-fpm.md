...
```console
$ docker pull wordpress@sha256:1f8407652cfcfd65f9cea2f7381942194a2f293cabbb101134cdb104c917c1d2
```
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; mips64le
...
### `wordpress:beta-6.5-beta2-php8.2-fpm` - linux; s390x
