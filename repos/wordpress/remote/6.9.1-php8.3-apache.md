...
```console
$ docker pull wordpress@sha256:e1ff1eb9b04d0835df95449d179dca7253fca00c8171698c2b413f507e6bbeaa
```
...
### `wordpress:6.9.1-php8.3-apache` - linux; amd64
...
### `wordpress:6.9.1-php8.3-apache` - unknown; unknown
...
### `wordpress:6.9.1-php8.3-apache` - linux; arm variant v5
...
### `wordpress:6.9.1-php8.3-apache` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.3-apache` - linux; 386
...
### `wordpress:6.9.1-php8.3-apache` - linux; ppc64le
...
### `wordpress:6.9.1-php8.3-apache` - linux; s390x
