...
```console
$ docker pull wordpress@sha256:31f0b1bc49d383e4f845e8fdaa1e298011789f952b21a58a9230aeac1880e21e
```
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-beta2-php8.2-fpm` - linux; s390x
