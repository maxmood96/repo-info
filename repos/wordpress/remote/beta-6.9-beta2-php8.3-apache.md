...
```console
$ docker pull wordpress@sha256:1e028dc6687d1d190914486e1757fcdb895d0f7e4114eaf1830cd06055fbc65c
```
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; amd64
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; 386
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-6.9-beta2-php8.3-apache` - linux; s390x
