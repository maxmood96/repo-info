...
```console
$ docker pull wordpress@sha256:7bc6d365cb424a39731b0edab74cb7c2749a80d4d481e46c44fb47d236d88f1a
```
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-RC3-php8.2-fpm-alpine` - linux; s390x
