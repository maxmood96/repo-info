...
```console
$ docker pull wordpress@sha256:8b8b10a09bd070e53e994979cc8b3438eb048aaf6020de423f25ff650601785b
```
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.2-fpm` - linux; s390x
