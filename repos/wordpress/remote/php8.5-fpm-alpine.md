...
```console
$ docker pull wordpress@sha256:1b343c1314f9922358f7c592897da667e7877fe56fb275a414096becc6025bd5
```
...
```console
$ docker pull wordpress@sha256:36f5321ddfa63ae2b013fe5f732505be5112394c26ce9ba029c24b4d544ce281
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.4 MB (109363294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47bcfc68812816b88386be0c0690381bd6b4260ebbdb57e43a8a459ee8e55380`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	{ 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > "$PHP_INI_DIR/conf.d/error-logging.ini" # buildkit
# Fri, 08 May 2026 22:28:47 GMT
RUN set -eux; 	version='6.9.4'; 	sha1='018542f4c3e15db0d8e38aaf0fcf1b5dc56dbb79'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Fri, 08 May 2026 22:28:48 GMT
VOLUME [/var/www/html]
# Fri, 08 May 2026 22:28:48 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Fri, 08 May 2026 22:28:48 GMT
...
-	Layers:
	...
	-	`sha256:48f789858e50aaf2c2a5f108eae34a6728a0feed8c9b04854475b0bc38963f80`  
		...
		Size: 393.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bee12b6b8c442f7bc89011ad0c3fb2bd6077fa0083557753c9f5be85a938a7d8`  
		Last Modified: Fri, 08 May 2026 22:29:14 GMT  
		Size: 27.0 MB (27032011 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c6ee2411b7983c37662a76e59c5633a6afc501fc5b57dac10520371903417abf`  
		Last Modified: Fri, 08 May 2026 22:29:13 GMT  
		Size: 2.4 KB (2438 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:141056c8468a5868a766ee45940792fa9c99a556b21ba70a804d82d49afd3dc9`  
		Last Modified: Fri, 08 May 2026 22:29:14 GMT  
		Size: 1.8 KB (1765 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5bb0bd3764fff5347795bb6f8af8ef2ade13443caa157c4822b13adab3c26f15`  
		Last Modified: Fri, 08 May 2026 22:29:15 GMT  
		Size: 194.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:65ec5e682e87c85920fa34a1aa202f49ab33eef2e18a5d66a871e3642082f74d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.2 MB (1168542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a99c29fb5a89f2f060d31d535de9bce08039545a0c66366e297961f8d6cdd6c`

```dockerfile
```

-	Layers:
	-	`sha256:c3ab8c25a4840cbcb880149667e18a82abe02ffdb1b8d371babb355d6fd159a4`  
		Last Modified: Fri, 08 May 2026 22:29:12 GMT  
		Size: 1.1 MB (1118185 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ead9e39568c921262fa285290554221e3eb18eaad2918bc61ccd5bb6933de8a8`  
		Last Modified: Fri, 08 May 2026 22:29:12 GMT  
...
```console
$ docker pull wordpress@sha256:768e9494eb18032f02fd138cba51e5e03a07659bd20ea4284d69f623f961b6be
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.4 MB (104363329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34f1efe88e727ed44d0d791291915fca10875910828ebe2a45be8812e43871fd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	{ 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > "$PHP_INI_DIR/conf.d/error-logging.ini" # buildkit
# Mon, 11 May 2026 00:05:05 GMT
RUN set -eux; 	version='6.9.4'; 	sha1='018542f4c3e15db0d8e38aaf0fcf1b5dc56dbb79'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Mon, 11 May 2026 00:05:06 GMT
VOLUME [/var/www/html]
# Mon, 11 May 2026 00:05:06 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Mon, 11 May 2026 00:05:06 GMT
...
-	Layers:
	...
	-	`sha256:81bd535899f0024d3e8c0fc3019740d7821ae87e05dc5227dbb7f2d3c85cfc39`  
		...
		Size: 397.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2b2e4c258e22bd8d70f5e47a5c4b43d1b7d6519ca6233d1759d9cf0765645a92`  
		Last Modified: Mon, 11 May 2026 00:07:08 GMT  
		Size: 27.0 MB (27032010 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a07ce4019929f7c0e0e2f8598e46fd2afea1bdf0ee0e2e234b8897d2ddb193e4`  
		Last Modified: Mon, 11 May 2026 00:07:01 GMT  
		Size: 2.4 KB (2441 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:87cf73fa872b1ec46bb43d7cb2bad5153ab241584b77d953e63608dca5d11e62`  
		Last Modified: Mon, 11 May 2026 00:07:03 GMT  
		Size: 1.8 KB (1769 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:031258c857a5b65f17146e5d75c3c146673e6c406fad58f2b02f04433534cc33`  
		Last Modified: Mon, 11 May 2026 00:07:03 GMT  
		Size: 198.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:ee837c50a1f257081cc2aba9776ca1b62958ea9f54f629987fb1917ae1898110
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.2 MB (1168538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:770774beda7e3f60c0a7b57391f78c1a07dea4631610fb33614d6cc3a279a4cb`

```dockerfile
```

-	Layers:
	-	`sha256:2147858de6c97998a38e1e10b34fdba96e31e8bafd71dc0e599154381565bf34`  
		Last Modified: Mon, 11 May 2026 00:06:59 GMT  
		Size: 1.1 MB (1118181 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:256a0680deff3fd84e8e3ebf383339796b65a9422e5ab0384c207589df8476a2`  
		Last Modified: Mon, 11 May 2026 00:06:58 GMT  
		Size: 50.4 KB (50357 bytes)  
		MIME: application/vnd.in-toto+json
