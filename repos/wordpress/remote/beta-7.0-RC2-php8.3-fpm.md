...
```console
$ docker pull wordpress@sha256:7661880036234bf8fb7e638f29f71db55341e9e64a81c85725110c0e57d1aff1
```
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC2-php8.3-fpm` - linux; s390x
