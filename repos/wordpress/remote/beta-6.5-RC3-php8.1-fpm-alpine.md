...
```console
$ docker pull wordpress@sha256:f6e63cbcb61b82caa3b849e7ce0f6699fc02c61926d8bd5fe036a22f866dde3d
```
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC3-php8.1-fpm-alpine` - linux; s390x
