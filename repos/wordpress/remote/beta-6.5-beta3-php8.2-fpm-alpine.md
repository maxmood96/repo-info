...
```console
$ docker pull wordpress@sha256:5e533ca9a531c5373d1f6079c985e93f525572447fb971e33fe21a75f8859392
```
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-beta3-php8.2-fpm-alpine` - linux; s390x
