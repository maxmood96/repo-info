...
```console
$ docker pull wordpress@sha256:e4bf367494c02e4bd8a0fee005dd5f2bb79e71402168fcf3b9d7f279ed242dcc
```
...
### `wordpress:6.9.1-php8.2-apache` - linux; amd64
...
### `wordpress:6.9.1-php8.2-apache` - unknown; unknown
...
### `wordpress:6.9.1-php8.2-apache` - linux; arm variant v5
...
### `wordpress:6.9.1-php8.2-apache` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.2-apache` - linux; 386
...
### `wordpress:6.9.1-php8.2-apache` - linux; ppc64le
...
### `wordpress:6.9.1-php8.2-apache` - linux; s390x
