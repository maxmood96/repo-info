...
```console
$ docker pull wordpress@sha256:67f4ac51d0d0476b7e466c3ad191bd1c0dbd64aebb6fc70519888b5a5d88171b
```
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; amd64
...
### `wordpress:beta-6.9-RC2-php8.1` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; 386
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-php8.1` - linux; s390x
