...
```console
$ docker pull wordpress@sha256:6336e83b61a43a5d3646b558cb84be107d2491948e5938f5c3c893db79f3e457
```
...
```console
$ docker pull wordpress@sha256:f92b3e62822cdf50f704f9ab57fc1102c07d557032ccda6f7d45a584f7e5d9f3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.1 MB (209091091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e50c6e4c52594e946f56ad84a22842c4d783f6a2c7ef78fb7673abd3e308e030`
...
-	Layers:
	...
	-	`sha256:1e91a848751c2055433c55285ac5f416229da6ad20a2759b0e1e9d4eae1dc3a9`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d8896fe4967804e7881cf99c3d968958a7f69ace1a3c4111267c753f7c1e51f`  
		Last Modified: Wed, 30 Mar 2022 10:56:22 GMT  
		Size: 18.6 MB (18552330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f41585cd7ca3779e9e494bdaed9910caf55d5eff29ca2f30f4ba9aaf3ca7416`  
		Last Modified: Wed, 30 Mar 2022 10:56:19 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b664a835f619be76f3f4d0a1cd9f79103d2124ec978f8e3b1bf31738e10b411`  
		Last Modified: Wed, 30 Mar 2022 10:56:19 GMT  
...
```console
$ docker pull wordpress@sha256:91e70c12ec7d7732f11c98ad93b9212f8911bc2ce96b7f71db342561214e273b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.2 MB (185180993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14850e4eb4e9c4cfd52002d753dbb2fb84af23c92b9cfc864f3ea154944160e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 30 Mar 2022 09:19:03 GMT
RUN set -eux; 	version='5.9.2'; 	sha1='19653440effafce0f768a1ba5092710717835bdc'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 30 Mar 2022 09:19:03 GMT
VOLUME [/var/www/html]
# Wed, 30 Mar 2022 09:19:04 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 30 Mar 2022 09:19:04 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 30 Mar 2022 09:19:05 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 30 Mar 2022 09:19:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:68e80947dc73b01d4866facde41e8c995d739fb0fdee6c3e8841b6245b5d12e3`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2995251d3eca09fd4be036f7e9976393cf458c7f3899a3367bb503972e232902`  
		Last Modified: Wed, 30 Mar 2022 09:35:35 GMT  
		Size: 18.6 MB (18552343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c17f0bb4ab6f7257477dff6998249f05a8ede62fc9d1f3a38dc156911b1e929`  
		Last Modified: Wed, 30 Mar 2022 09:35:21 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a087ac7dec480e51140500d9db00e8aead51b3822cda20b11721dc43ee2a0b8`  
		Last Modified: Wed, 30 Mar 2022 09:35:22 GMT  
...
```console
$ docker pull wordpress@sha256:978b10af13124b2c711236162c892b18bbdd50d76e5bfc4dae2a2f9a115f7b97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176293031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5d3cf17fbd92c4c268b184e8dab3f9cee2121a3bc9d599a289eb1ed4ad02c67`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 29 Mar 2022 19:23:58 GMT
RUN set -eux; 	version='5.9.2'; 	sha1='19653440effafce0f768a1ba5092710717835bdc'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 29 Mar 2022 19:23:59 GMT
VOLUME [/var/www/html]
# Tue, 29 Mar 2022 19:23:59 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 29 Mar 2022 19:24:00 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 29 Mar 2022 19:24:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 29 Mar 2022 19:24:00 GMT
...
-	Layers:
	...
	-	`sha256:1e89060447d3fed1c28d88fc38da5172f33655824f86353775f267b29826a687`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:065155f57b00a4f17c10a3b7ff43efbe7bf97b65ec0d949172efcc6c3abbb9f5`  
		Last Modified: Tue, 29 Mar 2022 19:59:59 GMT  
		Size: 18.6 MB (18552340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cdabb35ee4c5f5c94f5865696134b398a2aa881db168c8fc98f2e4afa854740`  
		Last Modified: Tue, 29 Mar 2022 19:59:45 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3bc592885dd2554401b542fe6f0c8f9ee5f26dd8f2a58fdc0cf64935597e0f0`  
		Last Modified: Tue, 29 Mar 2022 19:59:45 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:5ba9380f1510842a939a09b3a2d6f5f32a9fdda6aae2a2d36084189ebeec0bbf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.8 MB (183818081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c46ea5d5c48ff9b3b11a27803808f15cd198681605d867c33ee838b99f7d6476`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 31 Mar 2022 08:51:04 GMT
RUN set -eux; 	version='5.9.2'; 	sha1='19653440effafce0f768a1ba5092710717835bdc'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 31 Mar 2022 08:51:08 GMT
VOLUME [/var/www/html]
# Thu, 31 Mar 2022 08:51:12 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 31 Mar 2022 08:51:16 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 31 Mar 2022 08:51:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 31 Mar 2022 08:51:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4664a6f2cbd684299114c919f47a8d27491ad9fb2ad63822c3525378f3e1964c`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:577d1ab64a110e73e8132435e979dd941dce1c27569c173e61507c78c92c4d9f`  
		Last Modified: Thu, 31 Mar 2022 09:14:11 GMT  
		Size: 18.6 MB (18553225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:192da42ca58998655b863209d768613d584704b6808e7845a884462b47d70fb6`  
		Last Modified: Thu, 31 Mar 2022 09:13:58 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42bc21cbda086fb10a9ad6f4bdd1837f58d5b526129d4417c3829ff97cd76851`  
		Last Modified: Thu, 31 Mar 2022 09:13:58 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:7a3bfb401cb58306060032a7d088b81bff767942c0c076019c046b970f67b67d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.3 MB (209314249 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34c6020b815165ea88f27c96ccede8496dfc8e159a15bda4e2e90de11d46cc7b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 30 Mar 2022 16:33:21 GMT
RUN set -eux; 	version='5.9.2'; 	sha1='19653440effafce0f768a1ba5092710717835bdc'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 30 Mar 2022 16:33:25 GMT
VOLUME [/var/www/html]
# Wed, 30 Mar 2022 16:33:26 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 30 Mar 2022 16:33:27 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 30 Mar 2022 16:33:32 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 30 Mar 2022 16:33:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bbf1d013944b4247068e9b67122ddb3df6bb6fc0bc80ede8c947f918436d698a`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a664f7b9e5e8437a5c2f8e2c6d79c4f2b75226e7243e023bed341d35b5403f06`  
		Last Modified: Wed, 30 Mar 2022 17:30:10 GMT  
		Size: 18.6 MB (18552338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71543f523817a6988e4117c9ab2527dda0cfa849c1fdbd5bf3ad59ed9d9446e6`  
		Last Modified: Wed, 30 Mar 2022 17:30:07 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:283f0bb5e2f8b3835cb7a0914b8a39ce6d9408d810124557c90e0d77c431d4d2`  
		Last Modified: Wed, 30 Mar 2022 17:30:07 GMT  
