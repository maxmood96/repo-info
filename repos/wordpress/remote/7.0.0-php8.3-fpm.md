...
### `wordpress:7.0.0-php8.3-fpm` - linux; amd64
...
### `wordpress:7.0.0-php8.3-fpm` - unknown; unknown
...
### `wordpress:7.0.0-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:7.0.0-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:7.0.0-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:7.0.0-php8.3-fpm` - linux; 386
...
### `wordpress:7.0.0-php8.3-fpm` - linux; ppc64le
...
### `wordpress:7.0.0-php8.3-fpm` - linux; riscv64
...
### `wordpress:7.0.0-php8.3-fpm` - linux; s390x
