...
```console
$ docker pull wordpress@sha256:5903b26dd0d4f93ad07e496332697cafdada4cc1164507604355b158d848f7c2
```
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-6.3-RC1-php8.0-fpm` - linux; ppc64le
