...
```console
$ docker pull wordpress@sha256:c86219f7c10557719361de883c80df0a3d362d31e06c36cb8b41a36fcc90de9b
```
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.9.2-php8.2-fpm-alpine` - linux; s390x
