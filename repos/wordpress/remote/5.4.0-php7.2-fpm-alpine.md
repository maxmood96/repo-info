...
```console
$ docker pull wordpress@sha256:d1bacb4430dd5f5f0058f2d520df7e6ca72c56d275e67c53001951543b21e2d8
```
...
```console
$ docker pull wordpress@sha256:c71bf8c617f054c4b29d26375a01b82c308a238b85dec85f0b7e975d1549cd90
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.0 MB (69003234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d5206e0664571b3fe58749edd8158331289e78dec1c349738812b835271ef4b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Apr 2020 03:23:59 GMT
RUN apk add --no-cache 		bash 		sed 		ghostscript
# Sat, 18 Apr 2020 03:25:19 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Sat, 18 Apr 2020 03:25:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 18 Apr 2020 03:25:29 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 18 Apr 2020 03:25:32 GMT
VOLUME [/var/www/html]
# Sat, 18 Apr 2020 03:25:35 GMT
ENV WORDPRESS_VERSION=5.4
# Sat, 18 Apr 2020 03:25:38 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Sat, 18 Apr 2020 03:25:46 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Sat, 18 Apr 2020 03:25:48 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Sat, 18 Apr 2020 03:25:51 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 18 Apr 2020 03:25:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:42412bad6e824310e82a446a88d8b4bce4bb1ec5a254bde35843d8934db89771`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01a3b676fce38d10b4fb8b3f8ec88f867bfd6e3a2b11d021fe8ffcb956be5fcf`  
		Last Modified: Sat, 18 Apr 2020 04:15:00 GMT  
		Size: 19.6 MB (19588163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b4a0df307b02329b00437bdd72c4a12bc1555bffcda529d734042e179f545b7`  
		Last Modified: Sat, 18 Apr 2020 04:14:53 GMT  
		Size: 5.6 MB (5573351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f13ee0c11e7991282ae432563b9e6f1d0e752a617807361e7f7edbb688728a44`  
		Last Modified: Sat, 18 Apr 2020 04:14:49 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd09b9eb3758fcf2f1eced2467d8090499e15db1dc1106a8e722d38fca9c5b3d`  
		Last Modified: Sat, 18 Apr 2020 04:14:47 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ec4d7d383b374e11824200ceb78c989eff0232b6c08f6cc6bd8e89febf6e109`  
		Last Modified: Sat, 18 Apr 2020 04:15:00 GMT  
		Size: 12.1 MB (12072531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c1484d9fc73b942a6a9953d8fafbda7c1ad23992173c987dca68355f163fed`  
		Last Modified: Sat, 18 Apr 2020 04:14:48 GMT  
