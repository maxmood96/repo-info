...
```console
$ docker pull wordpress@sha256:b9f4fda9b8dca81b31308afe5ec2f6988b6e0af7f2068aaba1e09ddb5a67cc14
```
...
```console
$ docker pull wordpress@sha256:34dedf414018823caad03dfb4976e058be252dcacd7b2a1cd2f36ddaedc0e47b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **65.5 MB (65532624 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:719ab8b2fcd50d97a6c1e0049c7c5eedc5f9f73b3966b10aa31be103d95b29df`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN apk add --no-cache 		bash 		sed 		ghostscript
# Fri, 17 Apr 2020 10:28:27 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 17 Apr 2020 10:28:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 10:28:31 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 10:28:32 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 10:28:32 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 10:28:33 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 10:28:39 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 10:28:40 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 10:28:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 17 Apr 2020 10:28:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:11d03d3139233774c8475989d10132d28fddfecb6214d2ab7ab1541fa53c570e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:032ff3d8a58119538fd0d1e7169b2489badb4c39dcf57d549b28bf2d431211f6`  
		Last Modified: Fri, 17 Apr 2020 10:40:05 GMT  
		Size: 18.5 MB (18535569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95247b43f9bcf8d6ea020b4fbb048f7ca76d3865b71f679216d76c5bd4f5b8eb`  
		Last Modified: Fri, 17 Apr 2020 10:39:58 GMT  
		Size: 5.4 MB (5424176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acf933592f914b049faea7b1830e37daea36ece5d9822b996066c5bd10c379bc`  
		Last Modified: Fri, 17 Apr 2020 10:39:56 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4dd6b9f33ae0801c1793fccf44bc1e92b7b33c2497d107589c593afb3d94ef2`  
		Last Modified: Fri, 17 Apr 2020 10:39:56 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20a4753af6a1677bd6bea1b6e5eb619ef27038915f626cad681d1eba1a6819a3`  
		Last Modified: Fri, 17 Apr 2020 10:40:03 GMT  
		Size: 12.1 MB (12072532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96f99625dbd667926f6940cd0914bf38d8857b9444d9c62e1dcaaf906e4989e5`  
		Last Modified: Fri, 17 Apr 2020 10:39:56 GMT  
		Size: 3.9 KB (3892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:54f50e087e65a05d1c12cddea18db0d531abbfa561b47d11e91496dc8341b107
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.4 MB (68418254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a761a0f86cbff3c0e09dbe148b037e6d5550eac2ffc2e849389d0e1893d329e2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN apk add --no-cache 		bash 		sed 		ghostscript
# Fri, 17 Apr 2020 12:33:13 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 	; 		docker-php-ext-configure gd --with-freetype-dir=/usr --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		mysqli 		opcache 		zip 	; 	pecl install imagick-3.4.4; 	docker-php-ext-enable imagick; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del .build-deps
# Fri, 17 Apr 2020 12:33:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 12:33:15 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 17 Apr 2020 12:33:16 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 12:33:16 GMT
ENV WORDPRESS_VERSION=5.4
# Fri, 17 Apr 2020 12:33:16 GMT
ENV WORDPRESS_SHA1=d5f1e6d7cadd72c11d086a2e1ede0a72f23d993e
# Fri, 17 Apr 2020 12:33:21 GMT
RUN set -ex; 	curl -o wordpress.tar.gz -fSL "https://wordpress.org/wordpress-${WORDPRESS_VERSION}.tar.gz"; 	echo "$WORDPRESS_SHA1 *wordpress.tar.gz" | sha1sum -c -; 	tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 	chown -R www-data:www-data /usr/src/wordpress
# Fri, 17 Apr 2020 12:33:22 GMT
COPY file:d93be233af180b81b8838a1d00e9f930eb82172c751ffaafb4732db4a09a7534 in /usr/local/bin/ 
# Fri, 17 Apr 2020 12:33:22 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 17 Apr 2020 12:33:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0d84c4ec0834965b10e9f109fe4428b15f307c1caecb6eae934522db9e931b56`  
		...
		Size: 7.8 KB (7783 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c37596740c046d1455fbd57ebd626ba7e5125b2d3b46df6a91ce2b0965589602`  
		Last Modified: Fri, 17 Apr 2020 12:54:38 GMT  
		Size: 19.5 MB (19518861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bca584a9e30965290c1f1497a256f89aa131de879ecd81d8a9f79a8993c1148`  
		Last Modified: Fri, 17 Apr 2020 12:54:32 GMT  
		Size: 5.6 MB (5603152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb80e15f1be519a7b58dd38ae38f8eaba44d5494cd6c7750d446cca68ed88abf`  
		Last Modified: Fri, 17 Apr 2020 12:54:31 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:861c8127029a3555a6070e225dc7381b5e19c03b64f865feb0a9e4339c4068f7`  
		Last Modified: Fri, 17 Apr 2020 12:54:30 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09c038236b889796addc9264d8f5e3f3eb8ef5baf691dbf1710f579688d79317`  
		Last Modified: Fri, 17 Apr 2020 12:54:37 GMT  
		Size: 12.1 MB (12072465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfafd135430558353ce0a3a2abf3f086344a418aa986978c8fb83476207dc129`  
		Last Modified: Fri, 17 Apr 2020 12:54:30 GMT  
