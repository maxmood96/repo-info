...
```console
$ docker pull wordpress@sha256:db398b78f5ec204cd2943944f43eeaaddcffcc2558394109c1b02e95a8ce0c89
```
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.0-fpm-alpine` - linux; ppc64le
