...
```console
$ docker pull wordpress@sha256:e432bd1302ff9c073bbfc52dc41d60cefcab0f21548dcf5951dd1e1e71184b93
```
...
```console
$ docker pull wordpress@sha256:01c52d83c5d4fe16d9d4be3e5a38806b9941200863e00884f33806fa83b1d0a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.2 MB (229158751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8ab8dc2c4d6b7a60df0b2bd5e0c06e96555235492d0f1392776a810089fc74d`
...
-	Layers:
	...
	-	`sha256:9fe8d7beff3a72add27671cbacf583914a30526aff94ff6fc8b2144ac81c396a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4d4660aaab71d3e690611ecbaf42df747fcc430cb7f26e35f782243d04a7af`  
		Last Modified: Thu, 24 Aug 2023 20:36:26 GMT  
		Size: 23.3 MB (23273485 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17cf0c8f2765df199ead784eadc8a414d12fdaa68d08f93cb83762f5d065a1aa`  
		Last Modified: Thu, 24 Aug 2023 20:36:23 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:865498fe76273d1b77be32b10fed77c840a8bb4a3fb6ecc3ac23cc81f24d59b1`  
		Last Modified: Thu, 24 Aug 2023 20:36:23 GMT  
...
```console
$ docker pull wordpress@sha256:d4cd31ea5b393df465e35216d25062cef6c16e5c32eaf50f4ba0bb1dfa6a4c20
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.4 MB (204426311 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31b6587f6212da42266ec206f17260dce4a7e8b84249ca018b7bee702a74e5f1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:4f574fc03a2a0442a633be15955b2abb5696b1ef8d5c637c4fed97986c37efbc`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b445010192897c4558ca22310fe43c776378d613f746ec45ef961e02d967e1a`  
		Last Modified: Thu, 24 Aug 2023 19:51:27 GMT  
		Size: 23.3 MB (23273465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b0955fc162afc81b5ebc8aa244de8d276c1dad6c38e56e800897a75694a84cf`  
		Last Modified: Thu, 24 Aug 2023 19:51:23 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:614a1310c5b4a19ba3baee9797798a6372a074d00df94fd9c3da23f34e7f3a93`  
		Last Modified: Thu, 24 Aug 2023 19:51:24 GMT  
...
```console
$ docker pull wordpress@sha256:01c91d06e4aaed3684f2874255c5da4c542c50c4964f50c08df1138a8f85f66f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.8 MB (194830839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5239a326cffcc3a415cd918ddaab3aa5b53729e5c7af227ffa9620ad69b5f660`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Aug 2023 00:32:22 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 20:22:14 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:22:15 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:22:15 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:22:15 GMT
...
-	Layers:
	...
	-	`sha256:8fd4a921bc2507b06bd4a1142e80ea6472ed0b6fa085870a4eb14616ac94b20c`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d225ffb9b682d54ef5f0a6f4f597ca10f461babc82fcb4c2571676ee61b10bcf`  
		Last Modified: Thu, 24 Aug 2023 20:25:48 GMT  
		Size: 23.3 MB (23273480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25e0b1f5f887b4f9afe464effae23c0fbefc0d0bd093ee2b52901be113050788`  
		Last Modified: Thu, 24 Aug 2023 20:25:44 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:effeb39279ca5344df4d2af22c35e6ef0991f0816a2a06a196f19f421cbb8fb5`  
		Last Modified: Thu, 24 Aug 2023 20:25:44 GMT  
...
```console
$ docker pull wordpress@sha256:8b692508f7ea3d63f0c5f8bbe56617467d7c0f5ef3ba49a0d71eac1b5e5620bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.5 MB (220529940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a199a96096d4c8bc8e7a02429ecc9247495307677451ab60fc00a01d515d5da3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6262f7e749be874b4dddaf90e297691204bfc9d81a2d092c638e0999608f9423`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05affb9216b97ef830a9188f337044fde51c22381095a9aca3447545c7eb6393`  
		Last Modified: Thu, 24 Aug 2023 20:18:51 GMT  
		Size: 23.3 MB (23273469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:117125c2598162dafd8c331bc6679edfb747b9c1e94ffd487969ffd32f684e79`  
		Last Modified: Thu, 24 Aug 2023 20:18:48 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3eb9d8dbcba85409045509f3eed2aadbf2415eb22b75a885251f2b139ff2d6e`  
		Last Modified: Thu, 24 Aug 2023 20:18:48 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:f11706ac88b24df9d79d4c568e9308896236c416753a085985748226e5fc0b3b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.5 MB (231542900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4eee89f3207f174aba0a6583a508656e46f6df1bc4737c8490e73d0b8a8df5d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 18:16:13 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 19:51:08 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:51:08 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:51:08 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:51:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 19:51:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Aug 2023 19:51:09 GMT
...
-	Layers:
	...
	-	`sha256:620454d9e13e44b4fd2b308bc707d457a0e4a8b06ef8808bc5e12cf58d5f6b0c`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbaca4003621325ec796135cdfd29aed23297526b7621147e29723d291bd1172`  
		Last Modified: Thu, 24 Aug 2023 19:54:58 GMT  
		Size: 23.3 MB (23273470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f88c2a8c889a9e4972352c8ad71c47066545a03641954280d2f2921c2120e053`  
		Last Modified: Thu, 24 Aug 2023 19:54:53 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa446753e6df4cdfaf9a46e39285a5534ade18a5a6bf491530457a51bdcfc311`  
		Last Modified: Thu, 24 Aug 2023 19:54:53 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:30937846fe010b3a4e0e8d8c562738983a30a3d00f64bdd4ce681b24729a4401
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203432677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8077f66c01c27b8aedaa53cafbad7a0cf0d425ba892d9f6df8a6217d3fd5d575`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 20:09:36 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:09:41 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:09:45 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:09:49 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 20:09:54 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Aug 2023 20:09:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8b464c72fc2ffefef491f8150d8fa7acc6fa9428a4840463a0efe4bbcd1af66e`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9cbf205252bf43e4ec2109b4005af45b01c6e444380e086cd79f01d000dc85b`  
		Last Modified: Thu, 24 Aug 2023 20:16:42 GMT  
		Size: 23.3 MB (23273555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afdaca9627b84673b11ed43207ec3bca1c986f8b45ce977ef5b1cdf757fc159d`  
		Last Modified: Thu, 24 Aug 2023 20:16:29 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3468e1a3dea0d2041b67da90ed97322103edc18fafda2a359bf1175135c0740a`  
		Last Modified: Thu, 24 Aug 2023 20:16:29 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:223f3ab93cc621cc2ae56e690a991960be692490f8bcce5c0fb54ca3c9e4ed89
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.3 MB (230259748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:011cce5af2e47031f8eada099217578b4606398319be335c5b62c22be00e2e09`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 20:18:07 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 20:18:09 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 20:18:09 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 20:18:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 20:18:10 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Aug 2023 20:18:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c49552e295a2652e851367a12cbe304a4fe28d91e73124af066311befdcff599`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd0b0d26a6ace13c488932f6761217bfb57402bc3631bf5c22e3997863da078`  
		Last Modified: Thu, 24 Aug 2023 20:24:05 GMT  
		Size: 23.3 MB (23273481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f75b79c6ad2009208b7a4ba803586a859364b7ec39e115bccbee4935102a5e9`  
		Last Modified: Thu, 24 Aug 2023 20:24:00 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f64dde2abc186ed5bc68823688f0d276a1bee0750333a5018869e2fcd53fad0`  
		Last Modified: Thu, 24 Aug 2023 20:24:00 GMT  
...
```console
$ docker pull wordpress@sha256:75a6a016ecd03e24caad0150b4e1b13d3a5ca9b82ea60367fcc6127896b55f32
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.2 MB (203217930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae2505ce6894fbf05fc4df1078576bf355125bc9bbee6c37250d4459d41cc3aa`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 24 Aug 2023 19:44:25 GMT
RUN set -eux; 	version='6.3.1-RC1'; 	sha1='96a6252111985afaf2121607dcf9ba82aabf8445'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 24 Aug 2023 19:44:26 GMT
VOLUME [/var/www/html]
# Thu, 24 Aug 2023 19:44:26 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 24 Aug 2023 19:44:26 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 24 Aug 2023 19:44:27 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 24 Aug 2023 19:44:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b3005d0da38fc8b910a45ae412394a370b51e703d33b3de9bff57c152fb19f04`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:585bcaaa9d252d57798ac7cfd38d342895504f6a298ac74bbb14c6e307d0d131`  
		Last Modified: Thu, 24 Aug 2023 19:48:10 GMT  
		Size: 23.3 MB (23273469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bc9251d472084b6770a76abe1953762954732974fef2cbb60f2392218c10178`  
		Last Modified: Thu, 24 Aug 2023 19:48:07 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1319ff319e0e8c68ed97da28be4293918722b893c2af99ef8fb6c9cf679aa7d9`  
		Last Modified: Thu, 24 Aug 2023 19:48:08 GMT  
