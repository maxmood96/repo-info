...
```console
$ docker pull wordpress@sha256:187b7873eef4219540c811df1b11123d4dbc9c75df5ed6c31692cc6cfcedd9c4
```
...
```console
$ docker pull wordpress@sha256:e7127964bdef821e6b580330bee34573d8082e4fc969aea6503acfb2a8a3a76f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.5 MB (180547585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0b08bc4d9a7049db8473ebe2195de0729f0c4721e51f81613fc01360cb0c820`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:693f214b85a7664d6bf32cbdf74107994af2da25e6d5a9f02b4dcd500ff3ce27`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1748c86a56a5f31b90d454ac26935ab1bb133a6027706893db2d80f7c1275fc`  
		Last Modified: Fri, 30 Sep 2022 06:12:23 GMT  
		Size: 23.4 MB (23378911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b742b2dbbeabc1920c2fdcb53d22ae3b57f9e946566b1f1f5022da010b7851d`  
		Last Modified: Fri, 30 Sep 2022 06:12:17 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fca464e585c326ed11c533d0560ef2a31c73f485e9ac65c124fe2fcc51087989`  
		Last Modified: Fri, 30 Sep 2022 06:12:17 GMT  
...
```console
$ docker pull wordpress@sha256:abd6424b75cb96d8ac30adc8476f1c9a0c67b8aa46c935c4ac9cccd9479bcd6b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188258822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b28df8a041abc55608fe9c38f6a54f0fb3b3f5e3ffac874b6f49d2913112270f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 29 Sep 2022 18:40:00 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 29 Sep 2022 18:40:05 GMT
VOLUME [/var/www/html]
# Thu, 29 Sep 2022 18:40:09 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Thu, 29 Sep 2022 18:40:13 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 29 Sep 2022 18:40:17 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 29 Sep 2022 18:40:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dc87556ded132802bf5304746023e0a9c522252d651d6fa3206b60f766cc2c94`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86eb2c199f4abe13adc6eb5087c7dcc8af811d107488c410e639867c044a09e8`  
		Last Modified: Thu, 29 Sep 2022 18:45:49 GMT  
		Size: 23.4 MB (23379253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f6f62ca86d1e75882119d450eae30ea1f97424e5baa69d79f6de6e34d278f65`  
		Last Modified: Thu, 29 Sep 2022 18:45:35 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b72f86d87e5fafc2d5a4a1d524e4f7efc134bac813d5a35fb8cbc0b89d701b66`  
		Last Modified: Thu, 29 Sep 2022 18:45:35 GMT  
...
```console
$ docker pull wordpress@sha256:b8bc893fb85bbaf0c3afc528664f7f13b77592c688c514ff405d9099626515be
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.6 MB (213554202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95df440b4d0eac1b06f5735ba4f88167d7d861e345ffbb525d7e1e2941dd3378`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Oct 2022 16:15:37 GMT
RUN set -eux; 	version='6.1-beta2'; 	sha1='aeeadf6e108e32073c7b38627924b6ed9173ce63'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 05 Oct 2022 16:15:38 GMT
VOLUME [/var/www/html]
# Wed, 05 Oct 2022 16:15:38 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Wed, 05 Oct 2022 16:15:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 05 Oct 2022 16:15:39 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 05 Oct 2022 16:15:39 GMT
...
-	Layers:
	...
	-	`sha256:4eae2d16a22ab43baa82182a0af67b57e3584cb9bcd3c0a7955253a20dbe62f1`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a107e28e8f4a1bd793ed233dd8caafcb2109f7e89d798020f9de7e5f87fedff`  
		Last Modified: Wed, 05 Oct 2022 16:29:08 GMT  
		Size: 23.4 MB (23378898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dd2c0b94cdef35b05d08dc34febb6976721c956fabb325332e1b3baf03557c5`  
		Last Modified: Wed, 05 Oct 2022 16:29:03 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd4342df868565874710b5bf49b6fba4345ff933612f06d4a6f89c6f85975964`  
		Last Modified: Wed, 05 Oct 2022 16:29:03 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
