...
```console
$ docker pull wordpress@sha256:e483b78ba5b81c883c37dcb94feae0a0e4818fbdec308c2461c171ed96078a07
```
...
```console
$ docker pull wordpress@sha256:2c073f0a26898624c5f9a44702c2bdcf331606f95dd94137563050b6c07aa32a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.4 MB (255430948 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a631615ba218ebaf9ff2427a95f86af10e243a0dcbfa9abcfe185a335440d3a9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	{ 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > "$PHP_INI_DIR/conf.d/error-logging.ini" # buildkit
# Tue, 03 Feb 2026 10:31:42 GMT
RUN set -eux; 	version='6.9.1-RC1'; 	sha1='08c58aff842212d7476604399e2f36e14aa3a672'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Tue, 03 Feb 2026 10:31:43 GMT
VOLUME [/var/www/html]
# Tue, 03 Feb 2026 10:31:43 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Tue, 03 Feb 2026 10:31:43 GMT
...
-	Layers:
	...
	-	`sha256:b7d4e3f18e344d78027c0546799d746d930b375bdaeb2e2e1b89acab1f4f183f`  
		...
		Size: 394.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:addcf672cf8cbe7efdab3bca04d040922db918b3c52f12bcfb334df2d7f7b466`  
		Last Modified: Tue, 03 Feb 2026 10:32:14 GMT  
		Size: 27.0 MB (27030822 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6867e7d5bcf9b7cce80efd345eab630354442c03e0649962678845361377d367`  
		Last Modified: Tue, 03 Feb 2026 10:32:14 GMT  
		Size: 2.4 KB (2441 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2c100f79214ebe99e0785f0f0bcbeb32ecc0d14e5b712ded607cc73963ecfc35`  
		Last Modified: Tue, 03 Feb 2026 10:32:14 GMT  
		Size: 1.8 KB (1770 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b7e7147db987a43dabb3e1afebb98d499786168b4f2825811870441a4ca93253`  
		Last Modified: Tue, 03 Feb 2026 10:32:14 GMT  
		Size: 199.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:c24917e86978ee80f005e345fe2d7450bc252e7044d6d5bcbfdb5ca3ed5f8a8f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.2 MB (8205280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fcda9339a533c2f8ae6427ad39677eb6d316f1ad3aeb7146e115f52b593e3dd`

```dockerfile
```

-	Layers:
	-	`sha256:676dd662b29b79317659dffb8dd33e72fa63aae19d2739118ab88ead54681e6f`  
		Last Modified: Tue, 03 Feb 2026 10:32:14 GMT  
		Size: 8.2 MB (8151216 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:005cbe1871511b7dcef374935b526c0f1f8d0a375dc38e770e120c6ab9128e10`  
