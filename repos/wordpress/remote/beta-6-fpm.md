...
```console
$ docker pull wordpress@sha256:8bbfacc3ea58efecf774fbf52ddd00e7197481e4e219abc912a9b341bc9d6405
```
...
```console
$ docker pull wordpress@sha256:07e4496db64fa2f858846af180309ec02206ee4abba513d6fb713b28328dc2af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.4 MB (208357095 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7492de836a6714afe1b2714faf83b4a8933eb6d75aad747ab3e1a65066dfa480`
...
-	Layers:
	...
	-	`sha256:464bffa7d3e46bcc8078f2fe3c1311a6d9fa73506210ea6354c269a54561e6d8`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06dbcef9428b774858b7d057840fd74eb1d3730f118e832c7d112497c16d9a92`  
		Last Modified: Tue, 19 Apr 2022 05:16:06 GMT  
		Size: 18.6 MB (18602827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5515901dbd7686196545330d9138f6cfa55ffb7a3298baf6f968abd879fe7b2`  
		Last Modified: Tue, 19 Apr 2022 05:16:03 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:445a9770e0cdc86b604b3b64497ef3bf72eaa11ff585b2857ae981b518382985`  
		Last Modified: Tue, 19 Apr 2022 05:16:03 GMT  
...
```console
$ docker pull wordpress@sha256:e38a6ec3d1adf77c983759298c4a7fd1532ec2d94f9843a3e7d6c52d8a7e8092
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.8 MB (184801281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb08cc7322c36a05c10f7e8d34382b9f2b5d23e6b6b6dfa4f259de6ef16a3c1c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 19 Apr 2022 07:07:58 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 19 Apr 2022 07:07:59 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 07:07:59 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 19 Apr 2022 07:08:00 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 19 Apr 2022 07:08:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 19 Apr 2022 07:08:00 GMT
...
-	Layers:
	...
	-	`sha256:61802fc82df88f5b841caa70b88406f9cdf562d297c3120d5dfa4d564ca1449e`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af771d9d0eac88cacc9b32b232893c5353f483c2dc2b4734813dc3f560e9982b`  
		Last Modified: Tue, 19 Apr 2022 07:23:51 GMT  
		Size: 18.6 MB (18602842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58fef6eb51e1975ae7c8f6f8c21261eddda6005f17d16e34d9a88c109f4cd5ff`  
		Last Modified: Tue, 19 Apr 2022 07:23:37 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b59a84084669e51c70c2c8b006f2a94392993c3350d7862ab353304aac937279`  
		Last Modified: Tue, 19 Apr 2022 07:23:37 GMT  
...
```console
$ docker pull wordpress@sha256:e791fb36183d6d22cc673dfdbb703378d8802cb236bcd45eeef4234638155836
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.2 MB (199190377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a00710c32a9569dbde05138f749bfc1c648708b6ecd22ff769fe0f5c31b0515`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 19 Apr 2022 06:14:44 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 19 Apr 2022 06:14:44 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 06:14:46 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 19 Apr 2022 06:14:47 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 19 Apr 2022 06:14:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 19 Apr 2022 06:14:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7cb96003b23c3dd75a5c5e886b6b38947c95f05a6bd9319a238966651c636d06`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c47ef2e5383c6ce7055f439b584297a4e846a417318a92d748192011e354d7b`  
		Last Modified: Tue, 19 Apr 2022 06:29:07 GMT  
		Size: 18.6 MB (18606858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b1264e025f737ef5d4844532d33000873d8609d062ddce9cbdf78fca8a8ba63`  
		Last Modified: Tue, 19 Apr 2022 06:29:04 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43c7264786feaa2127af1ec61e037e4d4e7d1bc29ef5668b2e1763c838f648d1`  
		Last Modified: Tue, 19 Apr 2022 06:29:04 GMT  
...
```console
$ docker pull wordpress@sha256:9e38a943737a4e55b11de8a207b6161dab8f05b67f32353bbedbff336b0628b3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.7 MB (209720035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:113b796b38da0d3756f7c31e95992f5193ed56277e027ca9d730c0f9cb1f3faf`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 19 Apr 2022 08:27:43 GMT
RUN set -eux; 	version='6.0-beta1'; 	sha1='1c5397d566600a91cacd0de8264758a3c91911f2'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Tue, 19 Apr 2022 08:27:43 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 08:27:45 GMT
COPY --chown=www-data:www-datafile:f95ddeaad9b50ddddf288560052a9de4f33fa6297ea70870e396f6d99c482b7a in /usr/src/wordpress/ 
# Tue, 19 Apr 2022 08:27:46 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 19 Apr 2022 08:27:46 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 19 Apr 2022 08:27:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d37780ba803ba6a4e1ef3c02784cf6225446a71e7344259a50573ef6c1e85d88`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f84f74a5cdc8bf596fca21cd84a2e34a35f38878e6c8453b60aec92deebca58`  
		Last Modified: Tue, 19 Apr 2022 08:43:13 GMT  
		Size: 18.6 MB (18606822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc326bc8e74df62011a757abd7bf3d21c49c6ce197eee45d37e8417424d90380`  
		Last Modified: Tue, 19 Apr 2022 08:43:10 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735c9d13239e737e02dac175b0a9c7e280ba051c198e752c77de5f3c408c22f4`  
		Last Modified: Tue, 19 Apr 2022 08:43:10 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:944c8aee85af91b2095bfa18c2fffa70453a518cc636e47764d4777dad9a37bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.0 MB (183986809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fca3127d1ebf2a90ca8e24861227e392ef5be34d522df489c567cd6b76f53702`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:68aa6a3cc851b77f4f9cb08a9908481a5c2bb46eec2c72c7d7f55f3e815c767d`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c04ffbfdd145cfc997e69ee0a6e52a32a25e966e7bbb2fc5eca115e14de07e27`  
		Last Modified: Tue, 19 Apr 2022 05:54:58 GMT  
		Size: 18.6 MB (18602850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99829fc67c3c9216f48f50fc37a6f1287eeec3719f6b305bf85ba4b6117efeb5`  
		Last Modified: Tue, 19 Apr 2022 05:54:56 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7273313c061bfd37f367c2e9d9a83722a029d69ffc3f4efe2c1c13bbbf96304`  
		Last Modified: Tue, 19 Apr 2022 05:54:56 GMT  
