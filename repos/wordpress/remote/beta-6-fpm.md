...
```console
$ docker pull wordpress@sha256:0a44fea17b33e01411b65192e33d81ee0efe1b4febc966ae5041ff38ca97af2d
```
...
```console
$ docker pull wordpress@sha256:009ef4a3dbf013f9d3e678c39a442b742d88284c06b719a6c141676113126201
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189434320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19e5469d0004d4ff49886d27f08550276b42a2f038310861baa41f581f297923`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:a0cb4fd1aead2d82581f83a98c16e0bd74c57d5e624f3df1b4f55f40240a7c5a`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff89ee77e2155d73644c6ecf51a3e2410d23fd04859f3221a049fe278faa2fc5`  
		Last Modified: Thu, 23 Mar 2023 07:49:07 GMT  
		Size: 22.8 MB (22844497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8066f049b66556ce46edb8a38795270b5f094aaf5f250b8d94736cd27ef8c2a`  
		Last Modified: Thu, 23 Mar 2023 07:49:03 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cee3302a7cf1c14b79a9865c53b5214e34d1abeb51ecd3daacc2418943e758f8`  
		Last Modified: Thu, 23 Mar 2023 07:49:03 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:48cad4d617f8418858f095948e06157d45f78426d2678db3971cc128dc239968
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.6 MB (180563777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c54e5525e53308bdc22ebc21eb54afac008e77190ef177d480f5ebc89f31fcf6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 04:56:52 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 07:57:59 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 07:57:59 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 07:57:59 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 07:58:00 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 23 Mar 2023 07:58:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 23 Mar 2023 07:58:00 GMT
...
-	Layers:
	...
	-	`sha256:327a2a2446a0dfce3e200a0d43f977f48f0b609821baedcf435acde580173bea`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5dc58bf85cc98331dccf4b3274daed820091f09717825089af28b90cfbd7824`  
		Last Modified: Thu, 23 Mar 2023 08:01:00 GMT  
		Size: 22.8 MB (22844507 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c665f6e4b9c7165521dc28e2309258c5ec398bb17951fb663270d4e7b1bcb56`  
		Last Modified: Thu, 23 Mar 2023 08:00:57 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c73854102346789de202f4d6c571d9e1d373cee54ccf5e5d2392ee4780f08954`  
		Last Modified: Thu, 23 Mar 2023 08:00:57 GMT  
...
```console
$ docker pull wordpress@sha256:01437955b716c0256277962ff656d64b1e42af86fe82855f9ee4d0dae91c9656
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.7 MB (204708059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f523d6ec814090d2b7069296ff254498797e73938d5260202780be33e89ab1f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3a3f0ac9b35bd369aa3ac77dc4d4426fa444ea417982860f811976f32581774b`  
		...
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e02fa209b23013d29322355f5085670ba416e3febfd5b8a3cdb40c6aba25cd4`  
		Last Modified: Thu, 23 Mar 2023 05:47:32 GMT  
		Size: 22.8 MB (22844503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03d336d59d5697361550d3e44fff945f34440eb112dcc2d67854858af526d311`  
		Last Modified: Thu, 23 Mar 2023 05:47:29 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:799f25c5fb690da758d182564b54bb9a87ed7de70a9db98b99bf91e9b9dd4068`  
		Last Modified: Thu, 23 Mar 2023 05:47:29 GMT  
...
```console
$ docker pull wordpress@sha256:27d12f5377bc90c05623402b34f4410db591d2855aa3d7278995cfaee92ad15e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.5 MB (215526663 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22cda2943dd73f72dedc25de974c3b2bb832a6adb49847b1755832a0cf6fc9bd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9dbc5192dc2f5b8b01b893141d93ae142e7675d7acc3485965f5bebb43f615b8`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e73388c3411b7421c016ec15c092c56229970261db018395561e4198117bb44`  
		Last Modified: Thu, 23 Mar 2023 08:45:14 GMT  
		Size: 22.8 MB (22844500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fd0ff17aa885cfa611919b5bf019f8c11da864151f75048e345d7def51b66ea`  
		Last Modified: Thu, 23 Mar 2023 08:45:10 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:691393c8b84e3f2e5a33eecb699e6264373f6836e75267f17f9a0b6689b22809`  
		Last Modified: Thu, 23 Mar 2023 08:45:10 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:fcd4db420d605abf00b8fc877342693c18b48474cbd6aaef57e62a8c088faa48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188060006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b33aa69c7db1ddac5cebc82eac7d252fad58e45f1e876e655d405884bf3a9d53`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 04:49:38 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 04:49:42 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 04:49:46 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 04:49:50 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 23 Mar 2023 04:49:54 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 23 Mar 2023 04:49:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8b1c576571b394d2f8c223eae58054ad596c74141a4ee1c7a660ccfaaa60f283`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58d6e008934d8d43597d57befcc56539b8cf62253a3a92bb12bc8b6e22e71cd2`  
		Last Modified: Thu, 23 Mar 2023 04:56:00 GMT  
		Size: 22.8 MB (22843771 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e1ed9b19433b3f399f6b804dc1e3a231ade640d101926826b2dc363260d7b8c`  
		Last Modified: Thu, 23 Mar 2023 04:55:47 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70d13b5b9896d2342127a60002d53a9a58127bc80cb5cf98599b50ae16787237`  
		Last Modified: Thu, 23 Mar 2023 04:55:47 GMT  
...
```console
$ docker pull wordpress@sha256:a4647aa91eb38a50845d79b4fc7af9f30aac65d7e5491904a11721559f575fa5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188614660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c8f477561573061accf7290b14efc93ac0631d49ef2770a5bb53f349ec828d6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 06:59:21 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 06:59:23 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 06:59:23 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 06:59:23 GMT
...
-	Layers:
	...
	-	`sha256:38c71dd5a4dc4f73c7ac47f9d3fa9d9e4a04f827226a3ecde325939796bf4928`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afcbf63bb11e65616770ee418cf5189fa61bcb54c3e0a49a1d430ca22d252ec5`  
		Last Modified: Thu, 23 Mar 2023 07:02:19 GMT  
		Size: 22.8 MB (22844507 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a85554276085be7b769c392f252b63bc7f33330564d20341cc8e25b18b4b3b28`  
		Last Modified: Thu, 23 Mar 2023 07:02:16 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3d69a376c685a9c0500c8e852398392d8bf442095dc7dd3179277468765bce5`  
		Last Modified: Thu, 23 Mar 2023 07:02:16 GMT  
		Size: 1.7 KB (1734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
