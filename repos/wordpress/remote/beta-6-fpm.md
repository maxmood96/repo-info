...
```console
$ docker pull wordpress@sha256:8a0ba2837bfbe96c3b40b4c6c319e1f7e325f0492c51b9a97b355bffd994720f
```
...
```console
$ docker pull wordpress@sha256:12e5590bc7ee537a8d81b2e86e5cc0f3516899062b2ae85bd5737ee3db2e35d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.1 MB (229099165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6eae3417668a6b45a11ea5c9677591aa77c63c051ff70067fae0ff666b909af`
...
-	Layers:
	...
	-	`sha256:0412ac5d1bceb2c5556591a3d5b939d7af00c2486ab5b7a6fb9d77a71cc679de`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6b953da51169fc2f6ed79f5f8e2ddc0011bd45b63bd25773d2af4b3f5c35875`  
		Last Modified: Wed, 05 Jul 2023 08:04:35 GMT  
		Size: 23.2 MB (23239515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6dcf96523d4f515d5b267738b7bdadbcfd0fdd3606cda4050c876d58888992b`  
		Last Modified: Wed, 05 Jul 2023 08:04:32 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb481b04e1b3e1c62c8061a148260c2815a6070d62a7623edcb736e4366e95eb`  
		Last Modified: Wed, 05 Jul 2023 08:04:32 GMT  
...
```console
$ docker pull wordpress@sha256:0398a08e305acf741b502bf1e2578d0fc975435a73e53264e8fde2779d38d0fa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.4 MB (204371930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e36106b979b957e9bb1a46286428c695b93a0d9f3e5f3ba65ab58fa15fb70892`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 04 Jul 2023 20:19:01 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 04 Jul 2023 20:19:02 GMT
VOLUME [/var/www/html]
# Tue, 04 Jul 2023 20:19:02 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 04 Jul 2023 20:19:02 GMT
...
-	Layers:
	...
	-	`sha256:0443eff3f209aac61f3fead44490e8f2977e3128d3d3f8af6809cf7613d698a6`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c573e3999ef63a3f47f9dd4476cd80203380eaf9d3ad39d18b757a28fd40fb0`  
		Last Modified: Tue, 04 Jul 2023 20:24:30 GMT  
		Size: 23.2 MB (23239521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d64094f4d77d2d6b3b30d280f86569135ed4e3a9123f7e1e67b62c4ba4131a5`  
		Last Modified: Tue, 04 Jul 2023 20:24:26 GMT  
		Size: 2.3 KB (2341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d78d5477f1ddcc9f00b8390c2ec63c438d939aa0c4455a12e2bfc7a4405048c3`  
		Last Modified: Tue, 04 Jul 2023 20:24:26 GMT  
...
```console
$ docker pull wordpress@sha256:6d301abd61c1ba1ea3e1217f5f1be2a0eac7122e6b988047a643ec10021445e0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.8 MB (194772122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f40c4a8b066a03fbd5681d1c8b365ed4920023b92afa7ed79824258a1be730f6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 05 Jul 2023 03:11:29 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Jul 2023 03:18:54 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 05 Jul 2023 03:18:55 GMT
VOLUME [/var/www/html]
# Wed, 05 Jul 2023 03:18:55 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 05 Jul 2023 03:18:55 GMT
...
-	Layers:
	...
	-	`sha256:5ea895bfd9172d1b469878209a19a071cfaa079677a53806616e27cfa4827b5a`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6512f882ea7e995745f6fdce1b33a09b120255d66adfb4279bb41a4c8fb8aa7`  
		Last Modified: Wed, 05 Jul 2023 03:24:56 GMT  
		Size: 23.2 MB (23239523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8721bf713e8d6a3a29c080aa459a55657315a51b677b09b1a0b97e932449f6a`  
		Last Modified: Wed, 05 Jul 2023 03:24:53 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2eab9b0592d4b0142bf1b51a9c5e126425a5bf5f36c1eaa0698709827edeff5c`  
		Last Modified: Wed, 05 Jul 2023 03:24:53 GMT  
...
```console
$ docker pull wordpress@sha256:576b5d3bfc10d8a71613866923c3b1f8b9bbfa8b9e68f1151dbd856dbad2df5e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.5 MB (220476289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58cf29fc0f3f254caa4c9bca98f766bb1fa9e213f489a1aaab9ae53dd8836075`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2a4e25cd1c75bc0b9755a45899398175c3cf6ae6a883649a446b3aa3520979d6`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc0a09af5218e774b8aa813e34f739dbb19ab1d191f6b6a9d21eb130010b11ea`  
		Last Modified: Wed, 05 Jul 2023 02:39:35 GMT  
		Size: 23.2 MB (23239515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59a4aa0a098d44351ccdc21117ffb7e17452fd9cb8377b124fe7fa65d743d348`  
		Last Modified: Wed, 05 Jul 2023 02:39:32 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a0cf57dc593129438f2dccb25f98baece07b0a5f0b21e79819a9888866113e3`  
		Last Modified: Wed, 05 Jul 2023 02:39:32 GMT  
		Size: 1.7 KB (1726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:90ba7709562703f16f48fc078a834da823ab37e36a3ecbed0b843c0e093240d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.5 MB (231486281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12b64f157ea78c273876c9e252f85b53fde91313f99e2f9d7a6f77456c0d5613`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Jul 2023 05:19:29 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 05 Jul 2023 05:19:30 GMT
VOLUME [/var/www/html]
# Wed, 05 Jul 2023 05:19:30 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 05 Jul 2023 05:19:30 GMT
...
-	Layers:
	...
	-	`sha256:f0c4a209930ba802d91868c175413109aaf324bfbf87cd5f5fe2a2533732e4f3`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48ad35ccbe65f89d072397db2f0034253800942052f8053684f5150b42d9441e`  
		Last Modified: Wed, 05 Jul 2023 05:25:53 GMT  
		Size: 23.2 MB (23239519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21d40503eeb8e5c887d701768c3fcf9e9417be6460e9e8d881abfe5dfe7bd49a`  
		Last Modified: Wed, 05 Jul 2023 05:25:48 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c27dba9a6c7dd11680156c877974aa2b9e468fc1ad7e34929b26acb3fb9b93b8`  
		Last Modified: Wed, 05 Jul 2023 05:25:48 GMT  
...
```console
$ docker pull wordpress@sha256:e2de51b1fdfa74d1bb76bfeea1b6bab5e616240ee8477d4fae9d8c71a5bddd44
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203378511 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7a2def700b610843a46c18a3b7db1ed2ade81cefdfa160ef371c8f77deace4e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 06 Jul 2023 03:28:56 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 06 Jul 2023 03:29:01 GMT
VOLUME [/var/www/html]
# Thu, 06 Jul 2023 03:29:05 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 06 Jul 2023 03:29:09 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 06 Jul 2023 03:29:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 06 Jul 2023 03:29:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e684cf02de0931f7367aed6a6c3647f4eda6c0cda6f6a8ce2c4bac6fcae5f62a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b9ca811c0320fa0a75c16c387ca84e2b41ba5d6c7f5e8e44302bf131a4be3ed`  
		Last Modified: Thu, 06 Jul 2023 03:40:34 GMT  
		Size: 23.2 MB (23242403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae454b93f9446d7cb06bca4c0a243d1bb1cc690d530f9b01ad43bca4ded22c38`  
		Last Modified: Thu, 06 Jul 2023 03:40:21 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a01f24d52d1f84c60a5cec4a69c337dbbc740b367bf26784e125396913b73dbd`  
		Last Modified: Thu, 06 Jul 2023 03:40:21 GMT  
...
```console
$ docker pull wordpress@sha256:0eab9d7be8766612da2c242a1524542a1b40a3c94d2a1f5f950501c9fa85d201
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.2 MB (230202165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a3f29202f3b7ec373cb3eca5539c49690fba12a51cd3b0359ed5b948d80f12b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 05 Jul 2023 15:24:31 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Wed, 05 Jul 2023 15:24:33 GMT
VOLUME [/var/www/html]
# Wed, 05 Jul 2023 15:24:34 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 05 Jul 2023 15:24:35 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 05 Jul 2023 15:24:36 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 05 Jul 2023 15:24:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:66443dedb89b76b9f3304f5c6495233ad3243f35e7fd3dae2a012a101618a060`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24d19e987099c640aaa99075ae8c9643a05ce24ab4bad9b0ea7773baba9767d3`  
		Last Modified: Wed, 05 Jul 2023 15:35:21 GMT  
		Size: 23.2 MB (23239519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ab54d0c997627bf5ea28a3259cf5352c9ce7bfc1a34dde92498ae7f6bf0f66d`  
		Last Modified: Wed, 05 Jul 2023 15:35:15 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8e8ff34bc09ec6c6652867df3c22db4a45bd550b0bd6b87e79a12e7cafce48a`  
		Last Modified: Wed, 05 Jul 2023 15:35:15 GMT  
...
```console
$ docker pull wordpress@sha256:8bc8c8ad58b35d71fc7b7be39053a390fe60b7e3f85a725c6e2273206bd70b16
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.2 MB (203160445 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48b5b18daeb972f4ba4e45520fc24510fed9f7ddb9fa6c91932d45ffd44c9d06`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e668654a2397f3c47fd9ee499a2f6b951d0ad4e771b24e8b2fc4dd7d4e795812`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2fe9ca7a87de96baf3924c614e75cdd053f9134283221d09360fc93e2721c9a`  
		Last Modified: Tue, 04 Jul 2023 18:18:00 GMT  
		Size: 23.2 MB (23239525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0bdee4ccf2e486144f12eefddb062d0e01b2b59ccdb0b2f8bff2a2d3f13a58f`  
		Last Modified: Tue, 04 Jul 2023 18:17:57 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbec6f7214686bcf9d7d691cc63cd8a3d914b897f5b818a1a1bc5711a22d5ecd`  
		Last Modified: Tue, 04 Jul 2023 18:17:57 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
