...
```console
$ docker pull wordpress@sha256:fe85e03ef535dc20645a21debe7b99c7cbadc980df3a7e27c0422b2e42a503e7
```
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; 386
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-6.7-RC5-php8.3-fpm` - linux; s390x
