...
```console
$ docker pull wordpress@sha256:5c29a4821eedea11ef35c44338fcd099eeac65b4a03159c747b982850ac9c13c
```
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-php8.2-fpm` - linux; s390x
