...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-RC1-php8.1-apache` - linux; ppc64le
