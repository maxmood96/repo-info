...
```console
$ docker pull wordpress@sha256:5483a1da3353f0f53a1a7f7b6ef9d585120726ea409918691ab3ff1bf36429fe
```
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.9-beta2-php8.1-fpm-alpine` - linux; s390x
