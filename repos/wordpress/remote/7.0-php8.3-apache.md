...
### `wordpress:7.0-php8.3-apache` - linux; amd64
...
### `wordpress:7.0-php8.3-apache` - unknown; unknown
...
### `wordpress:7.0-php8.3-apache` - linux; arm variant v5
...
### `wordpress:7.0-php8.3-apache` - linux; arm variant v7
...
### `wordpress:7.0-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:7.0-php8.3-apache` - linux; 386
...
### `wordpress:7.0-php8.3-apache` - linux; ppc64le
...
### `wordpress:7.0-php8.3-apache` - linux; riscv64
...
### `wordpress:7.0-php8.3-apache` - linux; s390x
