...
```console
$ docker pull wordpress@sha256:d02875d43cff2853c5c58025e46b56a448e79efe8b4552c5bd283404e8a55edc
```
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.7.2-php8.1-fpm-alpine` - linux; s390x
