...
```console
$ docker pull wordpress@sha256:51cfb9e0badddf2c45bf39cd2a9d14cc85207a3282f16b263fcf073ac5040575
```
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-6.7.2-RC1-php8.1-apache` - linux; ppc64le
