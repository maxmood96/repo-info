...
```console
$ docker pull wordpress@sha256:5a002d3fc0d6653d76efa60407c640065ffbde450a8e19f5e5f06078843f68e4
```
...
```console
$ docker pull wordpress@sha256:41e25925fa56e99115f23eb72a5b6ef73dcf1a99159df5931094494001cb3f44
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.5 MB (244491191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5818b5b6dc591812c348b86b2e74cacf188fd0218f4d47d0ffac61dcc94f754a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:73021f2c9daaf9ecf1d772b8c1611c6abe2f476fe1d6bab3b8be982290bf1f2d`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df66aa68a90dd54d0564f7a35cd908fa60989f9a39a37a39fe8a6d7f1b1e1fe`  
		Last Modified: Wed, 19 Jul 2023 22:35:35 GMT  
		Size: 23.3 MB (23267728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a33cf0b1926a8c6833add8445b8bc48c6817b05ec170e0c7939f1efbee26814e`  
		Last Modified: Wed, 19 Jul 2023 22:35:32 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55822625b6596eeba83c48b629efacd97e0520ad67aa09b970ea43d2c71348be`  
		Last Modified: Wed, 19 Jul 2023 22:35:32 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:4035a97c096aa47789d3bee0297349e4d1c748ad3eec4ea87631e83623c49c2d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.3 MB (223346306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f809c572f4a2a20c391d86fb54de7ec95397a01ef6d23d9a66ebcbcb8bb3df18`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 20 Jul 2023 04:33:38 GMT
RUN set -eux; 	version='6.3-RC1'; 	sha1='e8c51f48b05d78f6e32e1350e9ee2d551f052a93'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 20 Jul 2023 04:33:40 GMT
VOLUME [/var/www/html]
# Thu, 20 Jul 2023 04:33:41 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 20 Jul 2023 04:33:41 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 20 Jul 2023 04:33:41 GMT
...
-	Layers:
	...
	-	`sha256:55ee96cd8b014fd3737b853c394bc535030edda52e507d8923e34879c26452fd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a4d4ba58ff9a2f6e2e128b052d4dae33e4d8b35f7c6cfb1e8088d7e62f04186`  
		Last Modified: Thu, 20 Jul 2023 04:38:26 GMT  
		Size: 23.3 MB (23267702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0737e8ad1d41d7e5d974bb0b0207544b20b78758ed9ba9cdb84247c26d6dd649`  
		Last Modified: Thu, 20 Jul 2023 04:38:23 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:569ddb7ee5c3795065ac8b0a225dc707c4a37ab537f2e432c0f60f37fdcf16b2`  
		Last Modified: Thu, 20 Jul 2023 04:38:23 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
