...
```console
$ docker pull wordpress@sha256:076c99caf5cafacad577e23676e584d28b5ad0791cac3e8a400be3d8ae5f4e5f
```
...
```console
$ docker pull wordpress@sha256:ca9ea5b5de88e387d3603511d36c2cf49e0f520369def0c4672590c19c061b5b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.1 MB (253147889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57467e64a4b325e9d6f33e7c4a086a84f0f00cf089c184365009919bd49521e8`
...
-	Layers:
	...
	-	`sha256:29a0ead86c63551cfbe8b333dcb4af4b1c5fd33ebb4bf5dc78b3a33f04a3eb88`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbdfdb5e83388de33a28cb82e91cbdd9dbf708b79837f89adcab0bd6282cc99d`  
		Last Modified: Tue, 11 Jul 2023 04:04:11 GMT  
		Size: 23.2 MB (23239519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49469c058f9670de4c5b8043e28a4d1f7e4a3f7dd30c9b0d1481d08ba3eb8aaf`  
		Last Modified: Tue, 11 Jul 2023 04:04:08 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f61a99f51a2b9c0ba46031c3d654e329c2898c87bfe57fad6c9c9a2887efd5f6`  
		Last Modified: Tue, 11 Jul 2023 04:04:08 GMT  
...
```console
$ docker pull wordpress@sha256:58d72e7d46b4f9e41c686c7ca88fcdda9ad7128802f9aa19186416ccb7b1b80d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.4 MB (223436129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da940b17756a37b5eb42d16daae71edbed478d11123c2a0efd2f92b69a3e7619`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:070319afd45d0b1fd8758707b751082fbfafde7f15bbeb0ed733956e36a6c8fd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9e2f124b859271a8e961ba08f2cfb60eb0893ad84066f22eeee3572112eca85`  
		Last Modified: Tue, 11 Jul 2023 01:20:19 GMT  
		Size: 23.2 MB (23239524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:574b80e8f07dd5eb6659a1deac8688b2b35c8039d23f61e25bf2de169902455e`  
		Last Modified: Tue, 11 Jul 2023 01:20:15 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a93c93f22d0dd01fd4469120216e69aee45091999f73846330088d67be0d8ea5`  
		Last Modified: Tue, 11 Jul 2023 01:20:15 GMT  
...
```console
$ docker pull wordpress@sha256:c57adab19211b8c42418caedee5521bc7cdc9ab36b59a9e1d681f3eae8110bd3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.3 MB (212329812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df3615c5ca8fea42db8162db2b22af15f96d7c3790f63bbd7a1433047d17229e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 03:44:38 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 03:44:38 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 03:44:39 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 03:44:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 03:44:39 GMT
...
-	Layers:
	...
	-	`sha256:0e66a13826d990f8c5ccb7f9c3abbcffc4481d681a673598e39ec08d52cfeab0`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:002063e93c55e851a7bfe1353bcb65d5c7b042a7c8f01fee2d55b6c8d2b0a51d`  
		Last Modified: Tue, 11 Jul 2023 03:50:53 GMT  
		Size: 23.2 MB (23239516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75d0bb4e884246a993ccb58eb0795a523d95731fa1d4bde116d7d1d93f51dbbf`  
		Last Modified: Tue, 11 Jul 2023 03:50:49 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8b2e5471e7f4f237e133e91933863a4520ba3b462e9f6a95f201f48754aa146`  
		Last Modified: Tue, 11 Jul 2023 03:50:49 GMT  
...
```console
$ docker pull wordpress@sha256:01673bf2d6a3b036ac4870718b6166175c06ec477597aae525095508f90f2f28
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.5 MB (244462982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8c6af96f02a0d83ee83d6d7e44554add990d6d410ae60da84b12fc5075e5c42`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 04:18:33 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 04:22:13 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 04:22:14 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 04:22:14 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 04:22:14 GMT
...
-	Layers:
	...
	-	`sha256:73021f2c9daaf9ecf1d772b8c1611c6abe2f476fe1d6bab3b8be982290bf1f2d`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfd54ce2efc16339481e4549ef83ef1748c0a0d12147e332726764db0b615e85`  
		Last Modified: Tue, 11 Jul 2023 04:28:28 GMT  
		Size: 23.2 MB (23239524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc006c33f886b85315d198c51fe0290ff9cd1f3e1adce8f63f5d8c1414c03d0a`  
		Last Modified: Tue, 11 Jul 2023 04:28:26 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:513348d1d5c842a5781fb747825fadd8930fde9d52aaa6284c14d7479f03db3e`  
		Last Modified: Tue, 11 Jul 2023 04:28:26 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:65ddc9493c7774c0af7f3b9e473b9bd0e072d1fa23a07fabf58d042a70959b5d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.7 MB (251674497 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93c8574b4ab21f704fed21d32e962a5546ba0e741c784b09ee0cc831ccc74c5f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:659548291adc84e25cf5311879cf38212b6dc5b21e1f563e7592234b7197e43c`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5e7d0fae196dabdf44bfaa73824dfcc4a71cd3cfd202879f0dd7d0c22c24e91`  
		Last Modified: Tue, 11 Jul 2023 04:25:15 GMT  
		Size: 23.2 MB (23239520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a566a7b21d0f3b1cb09e69eb438eff841383eb6e057aa24193a1ff9b99317333`  
		Last Modified: Tue, 11 Jul 2023 04:25:11 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:860535aff04a141228209d506b3e43ad4eafedcd37dc015d59ac24de88987235`  
		Last Modified: Tue, 11 Jul 2023 04:25:10 GMT  
...
```console
$ docker pull wordpress@sha256:92ffca5352bfdcb5ed99a339e11715baae1990adae74fa3efce119f4fcd6c579
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.1 MB (225082283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fce5ad82cab2d0069be431787d5b99fd01829e04c70b781b96fd94c58498951`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 06:49:28 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 06:49:34 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 06:49:38 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 06:49:42 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 06:49:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 06:49:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1b22b5a517b8f9334706395b9e5139d90ffc44f7fa10c8d2a9b1c12f9216389a`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6134cc80562abe6daa7c8265f435f7aa357cd15dfed100ac34679182772554`  
		Last Modified: Tue, 11 Jul 2023 06:56:23 GMT  
		Size: 23.2 MB (23242404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8f7853de2944a32d63e774b49a166a578887702ad685a2b8c292e585d003409`  
		Last Modified: Tue, 11 Jul 2023 06:56:09 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a25ed4059d1491b526723d3c1d2766658479cbbadb3b8348ba2ec4a18efad33`  
		Last Modified: Tue, 11 Jul 2023 06:56:09 GMT  
		Size: 1.7 KB (1729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a43abbbacf06711e4d26d71f29b37331096498b545f0ec13d1eee286c5186fd8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.3 MB (258312995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e8e54028e1b3612e47e281abe566d940999cce70d274d21fcc67c5188c50bf6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:25:39 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:25:39 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:25:39 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 07:25:40 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 07:25:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:01f4de7900f5b2edafb119b113031ef2594024a6a67b8148890a9e839473567a`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e51bd7bee22e6af74bad3301534e2ed43877309ada85009b532d0f2777f86148`  
		Last Modified: Tue, 11 Jul 2023 07:36:23 GMT  
		Size: 23.2 MB (23239517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f52594e9b536e6dd1d8a9866affd3632a1e696eed932a202627d4413a8c380f`  
		Last Modified: Tue, 11 Jul 2023 07:36:17 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:366d37d02ece2c80b02f46adb5153ba12b5b740593a92df2d284106bcff19c32`  
		Last Modified: Tue, 11 Jul 2023 07:36:17 GMT  
		Size: 1.7 KB (1728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a51a33dfe12bb9cacf4015dc7ed0c6ad152e98f8966c3fedf85a853374f55403
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.3 MB (223318125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:326253b5973d6da84b87ebb2d4545638358e50a63d8c3861dfbd07b973799da4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 11 Jul 2023 07:47:11 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 11 Jul 2023 07:47:12 GMT
VOLUME [/var/www/html]
# Tue, 11 Jul 2023 07:47:12 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 11 Jul 2023 07:47:13 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Tue, 11 Jul 2023 07:47:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jul 2023 07:47:13 GMT
...
-	Layers:
	...
	-	`sha256:55ee96cd8b014fd3737b853c394bc535030edda52e507d8923e34879c26452fd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7f4e70655bd3291c5fb155eadd3589d86432f937fdd0bbf9a91d6a97598e5b4`  
		Last Modified: Tue, 11 Jul 2023 07:52:39 GMT  
		Size: 23.2 MB (23239520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c19a83c30693b929acd9879303112fe4175365d51a56a6cf3b29a7c016a027e`  
		Last Modified: Tue, 11 Jul 2023 07:52:36 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:945bcbcd408ef55f690f244724f907c7322cdbac044406c17050f677cb392268`  
		Last Modified: Tue, 11 Jul 2023 07:52:36 GMT  
