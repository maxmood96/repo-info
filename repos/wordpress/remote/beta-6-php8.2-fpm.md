...
```console
$ docker pull wordpress@sha256:7dcb4551b67da249179d1166a177628e9a659d3b30f596aeaccb9eaf777759ed
```
...
```console
$ docker pull wordpress@sha256:864d3d4a8ef59341a411efb0deddc47baaf5eea4348d40ecb5686fb94cbbd1e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.1 MB (254083345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e99a8e90ab1b24d6f9adca1c32f8c7992c1d497e0e89f3765fe5cbc98497fcc`
...
-	Layers:
	...
	-	`sha256:1f0e22f80e7e2f0f9eda741e6a3be2d6763509e123aa1fba04b56d1ae396d71d`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69b9d90ad95467c79efb7308c69d52feac33795109a307ba1191ae47d2d825dd`  
		Last Modified: Tue, 04 Jul 2023 02:35:38 GMT  
		Size: 23.2 MB (23239522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9ddd90bf6fa417f9d19a1097ecd8a7668e2e9fd63c7777b50685c62a3dcdd9a`  
		Last Modified: Tue, 04 Jul 2023 02:35:35 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1753283d5000ba92440065ec918126d046f4b52f81877b8a7e49aab6105ff0a9`  
		Last Modified: Tue, 04 Jul 2023 02:35:35 GMT  
...
```console
$ docker pull wordpress@sha256:b8ec524e4bd327ff6b5107248629dcdb5c26f65400d1a46866b1d2012833783a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.2 MB (213168593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:484633e45bd7e829bbe899adaab5f1674a9f3f83b1b3c3ff022f8fa40acc5362`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2fe2681d7488ca2bfe22ffc5c7d37c9b3d179d18e39520057fbcbd9f4cb5b5c2`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc79aa3351df33a2a9e114c2b3463769aee1b2582637e9f491cdcff885689f47`  
		Last Modified: Tue, 04 Jul 2023 04:47:56 GMT  
		Size: 23.2 MB (23239516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a8119ab7e7b933e86cc34a81bbd1fb24df2a4faec9bc1cd3541844c292e0683`  
		Last Modified: Tue, 04 Jul 2023 04:47:52 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a7f43488b42108ef43c85932719d3d8aba1854feacb49211d2b3428cf31b009`  
		Last Modified: Tue, 04 Jul 2023 04:47:52 GMT  
...
```console
$ docker pull wordpress@sha256:b71bbd7dbb14218ada661a4bd706f9cdb8014aa3c6fc7e32c04e7c2a6b751c97
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.4 MB (245387202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7eb786bc2ffbf37df7a54f78ff6a9760b9ee94dc49bcc71260c7f77fde78c60`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 04 Jul 2023 02:53:37 GMT
RUN set -eux; 	version='6.3-beta3'; 	sha1='ccb285b4287824e719dcee60da0a072bedae9484'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Tue, 04 Jul 2023 02:53:38 GMT
VOLUME [/var/www/html]
# Tue, 04 Jul 2023 02:53:38 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Tue, 04 Jul 2023 02:53:38 GMT
...
-	Layers:
	...
	-	`sha256:191a0e00f46c6bd22465923795f1907a4700e391bde07e7d951ee08089894e61`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9df87bab842560a97f5c28eb1fe4b39d4057ebdb3e02bf118215c6bc9fbd9e04`  
		Last Modified: Tue, 04 Jul 2023 02:58:46 GMT  
		Size: 23.2 MB (23239533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebc81fb441d480f3d3a9ae6fe072567ad158ecae8db26861c9173822d6061e38`  
		Last Modified: Tue, 04 Jul 2023 02:58:43 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3fc12ada910c6368b7f5f03c96c33fd3a929f05b8079da32bb5e6ead5cb7e35`  
		Last Modified: Tue, 04 Jul 2023 02:58:43 GMT  
...
```console
$ docker pull wordpress@sha256:15f7d62ab06ca749c493ec44dba62539fe20648e17b483f3fc75afc637418026
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.6 MB (252644124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:122ee71e455b37ade8b0ed82fe5d25c3db31f294b91231eca821311a49a9cd1a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:5d9bce982354b58bd75c1a0c5942becb4bdb0581985c0c67aa30931b6aa436dd`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4db7933b8302734bd1882490a2376f051c0e9272d751c8c1fa8a0309f72818e`  
		Last Modified: Tue, 04 Jul 2023 05:25:18 GMT  
		Size: 23.2 MB (23239516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:476f8df935a84258c713b9b6db9bc36e471f0343de0c92ee0eb9ed612c2cecc3`  
		Last Modified: Tue, 04 Jul 2023 05:25:13 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35dd40de8cff0935c8efe5aac90211d320b9fa5d5f43ecfa3b045274b62ab4fd`  
		Last Modified: Tue, 04 Jul 2023 05:25:13 GMT  
