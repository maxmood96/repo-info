...
```console
$ docker pull wordpress@sha256:7c2fb362f468c85b205695f74f59dfbdda02b67a8dc6f4da8d3d185991c9b2c9
```
...
```console
$ docker pull wordpress@sha256:63bed9d4054cd1f656e0b2707e94d3e3209bbafa41d17a90cbe992ea22a7945f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.2 MB (191242039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d05fda530447eb9d0e282773ae9bf889c9e8e5a08ef628c0af0041d64a68de1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:08bd164bba624a6260ac9c75a947aa1fefc79893de1ddf223318db1e83e95480`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c7444c60c8ad081d6260b896d6c541ea0172648ff4b76c935fc519365633a9f`  
		Last Modified: Thu, 23 Mar 2023 07:50:54 GMT  
		Size: 22.8 MB (22844506 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edd369481d5374ab210a813deb8943ee4aca59422e846f6c170aa51e33098a06`  
		Last Modified: Thu, 23 Mar 2023 07:50:49 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82a828a80893d4589dfc4ea478b1e6fcfe2b92a5a9f7918f9baf52e0217c6e97`  
		Last Modified: Thu, 23 Mar 2023 07:50:49 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:a36930d3dd4c61e19e17ed02a35aeb5391f0ebc776a44f57ddb2101ab8404f0b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182291593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f2430829004c07e2c565f76a2074d471c77b328b6459bf7a06d19bfd5cb358f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:59f585284d45a2ad80cc4f6377065bb9243a06c371cda1bd1eb2dfb125e21961`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bed9ff0392249253940b36de6dba447457ed0542746dda0b7f9d3262eabd6a33`  
		Last Modified: Thu, 23 Mar 2023 08:03:31 GMT  
		Size: 22.8 MB (22844496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2f6bf1cbfe25f2cffc3ab46d1fa3963d23e21ad1fa4cd540b4fa9de89d0c1c5`  
		Last Modified: Thu, 23 Mar 2023 08:03:27 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff7dc24f52bc7ead750fa92ebe71855fee4f54498e141e25b5eebb8d48920fb0`  
		Last Modified: Thu, 23 Mar 2023 08:03:27 GMT  
...
```console
$ docker pull wordpress@sha256:76deccc1f7aaa44cf2411021f95a0d83ddb7a6c1bcbe8abc847cee7b377df84d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.1 MB (207134883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f58ae6b5c054f6757daac9365f6ed79a79c4f8a30056cbcca30b09da62a83c2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 05:45:20 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 05:45:20 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 05:45:20 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 05:45:21 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 23 Mar 2023 05:45:21 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 23 Mar 2023 05:45:21 GMT
...
-	Layers:
	...
	-	`sha256:1753a33026902a51aa16cc6eecc07778cc134aedadb2776cebea68ec24017889`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffd4cbb41862ef679b860fe7d1e721abc443cb9d392d144f9ccb93fbad27e425`  
		Last Modified: Thu, 23 Mar 2023 05:49:54 GMT  
		Size: 22.8 MB (22844495 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6e0b542d39a878fb30d669c6863a0bb9b4bfe697baa43039f45a9eaba5a8784`  
		Last Modified: Thu, 23 Mar 2023 05:49:51 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eb25c1c12facd78302028b74cc7325be0ba61f316e163492acdfe502ea180dc`  
		Last Modified: Thu, 23 Mar 2023 05:49:51 GMT  
...
```console
$ docker pull wordpress@sha256:36f1d2332bcd4fb5573bea1c6e2fce70ec40a2c173faa6bef94c425f289c76a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.4 MB (190385601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8058345bdbd3947c8018b2fb4b861ebd7e3f30fa383d9739e126e5f587cb2e7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 07:00:16 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 07:00:17 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 07:00:18 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 07:00:18 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 23 Mar 2023 07:00:18 GMT
...
-	Layers:
	...
	-	`sha256:9429b23a2911cb21ea67cdabf3479e5728acf71abf1200275f82650597517014`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:920e0ae9adfc009ebfb4aea74ce5160e9fce135adc943cd6cab2362f5b8fd6a1`  
		Last Modified: Thu, 23 Mar 2023 07:03:40 GMT  
		Size: 22.8 MB (22844496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5c8247278d161892fb7d56ec18ca83dd73495119f95b51f3941decb1b87aa6b`  
		Last Modified: Thu, 23 Mar 2023 07:03:38 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1317ba7ca021581dad0960de9eab898aeea070a1df6d8a5b6d20dee78b12b66`  
		Last Modified: Thu, 23 Mar 2023 07:03:38 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
