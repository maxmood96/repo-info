...
```console
$ docker pull wordpress@sha256:6a433920a3b1e2936c1d2e1266ead9aed53e722d110ef5b0eb382fa280d8a2f9
```
...
### `wordpress:5.6-php7.4` - linux; amd64
...
### `wordpress:5.6-php7.4` - linux; arm variant v5
...
### `wordpress:5.6-php7.4` - linux; arm variant v7
...
### `wordpress:5.6-php7.4` - linux; arm64 variant v8
...
### `wordpress:5.6-php7.4` - linux; 386
...
### `wordpress:5.6-php7.4` - linux; mips64le
...
### `wordpress:5.6-php7.4` - linux; ppc64le
...
### `wordpress:5.6-php7.4` - linux; s390x
