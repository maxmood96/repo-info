...
```console
$ docker pull wordpress@sha256:f482afdf65e2f12fd43cdeaeae038942a4a1a024b6d1bcc1da4a25338acce9b8
```
...
### `wordpress:beta-6.5-RC2-apache` - linux; amd64
...
### `wordpress:beta-6.5-RC2-apache` - unknown; unknown
...
### `wordpress:beta-6.5-RC2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.5-RC2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC2-apache` - linux; 386
...
### `wordpress:beta-6.5-RC2-apache` - linux; mips64le
...
### `wordpress:beta-6.5-RC2-apache` - linux; ppc64le
