...
```console
$ docker pull wordpress@sha256:ef359be8d196889919490ea2f965e2ab5f66e586f8dcfaa3283bb912e5ba8968
```
...
### `wordpress:beta-6.3-beta4-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-beta4-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.3-beta4-php8.2-apache` - linux; mips64le
