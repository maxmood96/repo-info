...
```console
$ docker pull wordpress@sha256:e2c4ba21a4b37107e50ea8e3e3e933c74f13c2bcff94794c870926503d7d317f
```
...
### `wordpress:beta-6.2-RC3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC3-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC3-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.2-RC3-php8.2-fpm` - linux; s390x
