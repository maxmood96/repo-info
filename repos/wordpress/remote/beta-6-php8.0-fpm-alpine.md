...
```console
$ docker pull wordpress@sha256:375969ddbb0513ac9b32b02263014704e9b25fc8125fd8e5ed032d58ef708682
```
...
```console
$ docker pull wordpress@sha256:e8aaa5ac4c19bef1d15ec5ffe26970c74fe979fcbf7f03fba142e16272661492
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.6 MB (106555860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ae61947b8a1bda68097987ca4f2e7353bb36651b0ba2f640ccf9003543fe6b3`
...
-	Layers:
	...
	-	`sha256:7ece4111b4ea623c238d4354a7a97dec31b8116ab2498ce09d90c78a3e897403`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee74461dd8ef4e6d753742afd895e65e46522618386dc20888a57b69acd749ba`  
		Last Modified: Thu, 19 Oct 2023 06:54:04 GMT  
		Size: 27.1 MB (27056184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b1c8e155f714552542fa5085108b131e206c10a63a8fd3e1314749ea6375c4c`  
		Last Modified: Thu, 19 Oct 2023 06:54:00 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:422f5f6e03fff00e8261fc4e64bc58d4bd2e4db49c961a950f2f8798a01ea428`  
		Last Modified: Thu, 19 Oct 2023 06:54:00 GMT  
...
```console
$ docker pull wordpress@sha256:213dece14ced773f783c10e1d9c52dfa87a339aa17eecf29dbd746e49409acf3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.6 MB (100578827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb80cbfa485c3dbc6601b55c1535b233c70463949c8e70f891899a9d0a13de4c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 19 Oct 2023 03:54:49 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 19 Oct 2023 04:00:48 GMT
RUN set -eux; 	version='6.4-RC1'; 	sha1='51e151dbd5922ae05e365a1cf1818b374a9d45c1'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 19 Oct 2023 04:00:49 GMT
VOLUME [/var/www/html]
# Thu, 19 Oct 2023 04:00:49 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 19 Oct 2023 04:00:49 GMT
...
-	Layers:
	...
	-	`sha256:b80032f4b8561cff1449c981adb23a767f234bf6686b4e70f019f6933732d41c`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8083a9dfb0f5038d92c5886f7be981599b1fbf00cf93ec1856d78cadc9f3291`  
		Last Modified: Thu, 19 Oct 2023 04:04:09 GMT  
		Size: 27.1 MB (27056160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ff12a73151edd2619780fb596d30dcaa04cabb9cb41ff3332d54b2732162f6a`  
		Last Modified: Thu, 19 Oct 2023 04:04:05 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94dd285e68f1de8ef8f8fe320f76dddf2d71915fda86ea2ed72967be6878fe61`  
		Last Modified: Thu, 19 Oct 2023 04:04:05 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:b3e86f1612916139d8b8b33d5737c9e77c9c512e9c890350c437aca0db2f09d9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.4 MB (97380539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b29ce8fb6c023080a21da97000104e3883b5d92f03256257fae9ab2999c0ff92`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 19 Oct 2023 05:36:59 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 19 Oct 2023 05:37:55 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 19 Oct 2023 05:37:56 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 19 Oct 2023 05:37:57 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 19 Oct 2023 05:44:14 GMT
RUN set -eux; 	version='6.4-RC1'; 	sha1='51e151dbd5922ae05e365a1cf1818b374a9d45c1'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 19 Oct 2023 05:44:14 GMT
VOLUME [/var/www/html]
# Thu, 19 Oct 2023 05:44:14 GMT
...
-	Layers:
	...
	-	`sha256:465e43f20a263a037b861386b5a952dc8fc7aa66b73b0bd9577499b76d393f09`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c25ed924073882bf154d601cc7f04f3efa753ab48735bc173681d6c11a7b1edc`  
		Last Modified: Thu, 19 Oct 2023 05:46:22 GMT  
		Size: 41.1 MB (41143834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4a31bd949f8bbd8ac4c7030c9f8098f4ca890172453a2a8170435f9211db06a`  
		Last Modified: Thu, 19 Oct 2023 05:46:16 GMT  
		Size: 3.9 MB (3857342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91a5b75710b1820c1f906637c84e57a51212599fb32a738c550a1f43ffd22306`  
		Last Modified: Thu, 19 Oct 2023 05:46:14 GMT  
		Size: 65.8 KB (65780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:272fc256c154e6b95b7c2285b4407bef9541431252927742a8810a8fec0f5775`  
		Last Modified: Thu, 19 Oct 2023 05:46:14 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c37e55afea6ab3737ba28403a4ed259cc0c03d2cc28a2faa4776dfd181065a46`  
		Last Modified: Thu, 19 Oct 2023 05:50:19 GMT  
		Size: 27.1 MB (27056169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5804102cc629c025c5c517bc62e13d5d012bb72ba61f4e9dc328b5417329b528`  
		Last Modified: Thu, 19 Oct 2023 05:50:15 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:077c69ca913820d22450019aecabeea0acc9ad40b580a3e2ddd47ac133b51443`  
		Last Modified: Thu, 19 Oct 2023 05:50:15 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:23e171d542b73859d247fa56a989800fc32b8b4327f086556099fd20f83173ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.3 MB (104307339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40446ff8451b351c532d2db6b9c82ba6044fccbc248378520bb248ec17db4a63`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b4277382a3f00fc6f25e20e919b6ce91fdc48572f9c39fdec81f0119d9be8537`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29fcd7a8417758995c208b7cd86b49f7f9f1b77c4a2ec2b996ab3faa209fb35c`  
		Last Modified: Thu, 19 Oct 2023 02:39:45 GMT  
		Size: 27.1 MB (27056178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f45eddb70996dfceaccd09b96ddc644d6dd02025a2f4bc30f78d1554dab0500`  
		Last Modified: Thu, 19 Oct 2023 02:39:42 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981943f76a4a2c1f01ae34eca8f64915bd05c1dd35b3500dbb1fd007b001d995`  
		Last Modified: Thu, 19 Oct 2023 02:39:43 GMT  
...
```console
$ docker pull wordpress@sha256:5b4182f336243cd2c335af00c588743f165e49545fecde28297709cd678882a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.7 MB (105729541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eaf315aa5fc9433def0a53180f120bd79416b701ff6d856d3e260ca74383792d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 19 Oct 2023 01:48:47 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 19 Oct 2023 01:57:33 GMT
RUN set -eux; 	version='6.4-RC1'; 	sha1='51e151dbd5922ae05e365a1cf1818b374a9d45c1'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 19 Oct 2023 01:57:33 GMT
VOLUME [/var/www/html]
# Thu, 19 Oct 2023 01:57:33 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 19 Oct 2023 01:57:34 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 19 Oct 2023 01:57:34 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 19 Oct 2023 01:57:34 GMT
...
-	Layers:
	...
	-	`sha256:e19ac98857fa85f40932d2f0bda71ccbcd22e1af8b75e918df2335672aff4e1a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:223e0b10ee861ea75473e06fbd9bef63247889a84ec3eeee252fb91481944c52`  
		Last Modified: Thu, 19 Oct 2023 02:04:58 GMT  
		Size: 27.1 MB (27056168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:920ff9327df2d1a1832d67e235caba4d4a05500e3a76719a287d7e40f324d197`  
		Last Modified: Thu, 19 Oct 2023 02:04:53 GMT  
		Size: 2.3 KB (2344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df7635c10de9c75b8777b8b8b3b3f74d346050e341edb0943175975fa07937db`  
		Last Modified: Thu, 19 Oct 2023 02:04:53 GMT  
...
```console
$ docker pull wordpress@sha256:b520c374266e2df3f737553a8b7cd76c144bc7e00b777be413e042f3467cba43
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **112.3 MB (112316370 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3094a41fe383673d3596491cca24235abf9cd694da56257ec1e6c1c57f29747d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 02:57:19 GMT
CMD ["php-fpm"]
# Thu, 19 Oct 2023 07:05:33 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Thu, 19 Oct 2023 07:06:39 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		freetype-dev 		icu-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-install -j "$(nproc)" 		bcmath 		exif 		gd 		intl 		mysqli 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .wordpress-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 19 Oct 2023 07:06:42 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 19 Oct 2023 07:06:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 19 Oct 2023 07:15:08 GMT
RUN set -eux; 	version='6.4-RC1'; 	sha1='51e151dbd5922ae05e365a1cf1818b374a9d45c1'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 19 Oct 2023 07:15:11 GMT
VOLUME [/var/www/html]
# Thu, 19 Oct 2023 07:15:11 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 19 Oct 2023 07:15:11 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 19 Oct 2023 07:15:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 19 Oct 2023 07:15:14 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d7deddf1e5e205c996e7916651eaed2abd075d90c3735cd6a00ba446058caafa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c56869b586983df8272cd05ef609a1ca77dcc6c3143279e594e323889bd07f0`  
		Last Modified: Thu, 19 Oct 2023 07:17:45 GMT  
		Size: 52.6 MB (52649970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8221e6f972d37f361ab7a86e3f556354d82926a2bf4d1e996cf57311195f5463`  
		Last Modified: Thu, 19 Oct 2023 07:17:38 GMT  
		Size: 4.5 MB (4506841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da7e41490b087146a63beacff38c249c762278af7656c4f5e9d80d218f68048`  
		Last Modified: Thu, 19 Oct 2023 07:17:35 GMT  
		Size: 65.8 KB (65776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ff4dbc160623d6b64a9de129575ad09e1e1eb2df8b13eb21735088520382021`  
		Last Modified: Thu, 19 Oct 2023 07:17:35 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ffb2bd5bc892169b2e0aed0b649c6647ab175cada296442a1ba1aa36c28f061`  
		Last Modified: Thu, 19 Oct 2023 07:22:06 GMT  
		Size: 27.1 MB (27056168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfba54e668d3650acdeb35128a1c1fe13fc31afbdbd8c20c11e98eab83c161e6`  
		Last Modified: Thu, 19 Oct 2023 07:22:02 GMT  
		Size: 2.3 KB (2343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:782f66e6ea16a1530baacd48243972691c38fdf5dff3e659003281e4d69396e3`  
		Last Modified: Thu, 19 Oct 2023 07:22:02 GMT  
		Size: 1.7 KB (1731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:504bade7a225fa087ae6ead3f32e859450dae400a9b8487da51d4b9b12ccb640
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.0 MB (95993288 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cebdda9d48a748a97804e207d754597a3e8c41f448266ec0e7e6babf51ee604`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 19 Oct 2023 02:23:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 19 Oct 2023 02:30:31 GMT
RUN set -eux; 	version='6.4-RC1'; 	sha1='51e151dbd5922ae05e365a1cf1818b374a9d45c1'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 19 Oct 2023 02:30:33 GMT
VOLUME [/var/www/html]
# Thu, 19 Oct 2023 02:30:33 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 19 Oct 2023 02:30:33 GMT
...
-	Layers:
	...
	-	`sha256:d36fc08e9bb0d088e291075525edd3242cd8cf8c5a21451a7e35525c411bb087`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3434abf90628c1c26fe2f17308a8c6c2787aebb851e66ecdddafe820bc19557`  
		Last Modified: Thu, 19 Oct 2023 02:36:24 GMT  
		Size: 27.1 MB (27056168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2735a102facdfd7592445eab9f5b6f3a7e7b2d4d2b148864f16bc1c5d828a94f`  
		Last Modified: Thu, 19 Oct 2023 02:36:21 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa089d4fa8df8bc982576b2dc5d5b76286b739884dec443233011753d9b58bb7`  
		Last Modified: Thu, 19 Oct 2023 02:36:21 GMT  
