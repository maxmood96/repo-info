...
```console
$ docker pull wordpress@sha256:60172ff1904622097a0fd8a342f0587b8270672a61f610326c54c55ea0a98255
```
...
```console
$ docker pull wordpress@sha256:d8dff452d3eb860c405efef9820ef9bd69a98202b319e677083bcf29404292ce
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.3 MB (102269256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36e04f1eb804b536d0c56394955655181435f1f851e2496c037fe1e16bebcee3`
...
-	Layers:
	...
	-	`sha256:d5263635f787281e593f6d33a3cfe8f5abd9e92c7eb6be697f0f79dc9ae42746`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18d7dd5a0a0b29e7b4895b3a1583cfd7fb9261a2e8f4cf20392fe361fdba9f19`  
		Last Modified: Fri, 24 Mar 2023 01:02:09 GMT  
		Size: 22.8 MB (22845865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66964e6126cdc8a63cbd657b806a1bace723ac2068696272b0f202efa98dc2f3`  
		Last Modified: Fri, 24 Mar 2023 01:02:06 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:036209ba31cf114399e3326ca97043a149efa30611fdbb0e55ec3ad763e5f69e`  
		Last Modified: Fri, 24 Mar 2023 01:02:06 GMT  
...
```console
$ docker pull wordpress@sha256:60cb35b7e80b530c29796b97290a7904192bc60d6a868dc06f17403ae2a314ef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.3 MB (96296780 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da7549a33432300af31da1576354556e04489cee1aa3af533f74b1f81395627c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 22:52:58 GMT
RUN set -eux; 	version='6.2-RC4'; 	sha1='e8b707c77232e3e278a9dec9b3394446e4c4067c'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 22:52:59 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 22:52:59 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 22:52:59 GMT
...
-	Layers:
	...
	-	`sha256:3eaaac0bb3d23297181b0cd887382963e69e031194870b84dc64ded802475594`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63edb3ef15f12185c41410df79408aacba1b12935d055e985511c2e7d551e65a`  
		Last Modified: Thu, 23 Mar 2023 22:54:02 GMT  
		Size: 22.8 MB (22845883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9153dcfc80825b0757a368eb3c78775314c705a03ee87568df8d02ca881ee2c1`  
		Last Modified: Thu, 23 Mar 2023 22:53:59 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93f37d0eb2b3fe5fa946671a464f1c482fcbb3280f300dac4871e67a3013009a`  
		Last Modified: Thu, 23 Mar 2023 22:53:59 GMT  
...
```console
$ docker pull wordpress@sha256:93f718ce65f5fa4736c0239187ba33a06fed3cdafd77c35356f0cc2448d4c12e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.1 MB (93100697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c582ecfc502fc7b61ba1da25225d5c41155e2f536e5e43c5654f68372a403c8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 23:46:16 GMT
RUN set -eux; 	version='6.2-RC4'; 	sha1='e8b707c77232e3e278a9dec9b3394446e4c4067c'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 23:46:17 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 23:46:17 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 23:46:17 GMT
...
-	Layers:
	...
	-	`sha256:a2f050672aef96ecdf9f7f612566898e84bac31e067fe5f66e16809a394453b4`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:612d17bd57bafcff9233fa1b8d89c912a43ce3560c37f4af8a39bd436685d0b1`  
		Last Modified: Thu, 23 Mar 2023 23:49:34 GMT  
		Size: 22.8 MB (22845861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f56584e3f122c1e397ff776348cad01d0331d437f031452b335273461de549f3`  
		Last Modified: Thu, 23 Mar 2023 23:49:30 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a135c54fc26df2bd2ed122758216a4e97df012024a5034be8dcbf426aaf2b5ba`  
		Last Modified: Thu, 23 Mar 2023 23:49:30 GMT  
...
```console
$ docker pull wordpress@sha256:fc496a46962a7f731f58487f983ae6826e7e4a024bf29ade2725acd4f10ad572
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.0 MB (100015092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb4a3b63079492e49b63d0cd3ed2ccc72089881305a9c3b6e984f66b6fd7f654`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c18b025f3ab235ec6c7a4b13c9ed6b55602e85408bec4b475180a584d09d1f6b`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f0398ae4e300b07edd39415f61163b18e7df2d324b6d5a179540764ba7ebd5b`  
		Last Modified: Thu, 23 Mar 2023 23:09:55 GMT  
		Size: 22.8 MB (22845862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51709f93731174e6816f08566f7bc7d76dbad7aa5876ce861f1792df7b20a7a0`  
		Last Modified: Thu, 23 Mar 2023 23:09:53 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7410f9747bb3a74c35a1122660849dd73536dfcced2ad1bedfe25126816bffb`  
		Last Modified: Thu, 23 Mar 2023 23:09:53 GMT  
...
```console
$ docker pull wordpress@sha256:1cbf0400c99c1b731180300d0d0f65fdb7bb9282aae0ec0056fae7d5f4b33818
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.4 MB (101438384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:612aa26b963f2cb3e2570f629e86d84e7f6646cbf4b46aad41cd4e31496d557f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:558b5eb2da9d3f22bbb57680204ae5d5e0ccf5192759463506975cbdbeebac01`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3e22167c31f87ae863cd5a2656addc25add7ab613de975b10ab7a0c81befa46`  
		Last Modified: Thu, 23 Mar 2023 08:45:43 GMT  
		Size: 22.8 MB (22845947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86262504c261a8629b3136fa6f0b9a451d91c369fde82735a0e7fb2a95540ca2`  
		Last Modified: Thu, 23 Mar 2023 08:45:39 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07cc856ade19afdb29a1d65413a4803fee25d6c54a7037216e96e01167b2b15f`  
		Last Modified: Thu, 23 Mar 2023 08:45:39 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:ab9d81e0bb36de8f22b373a91e923e1bdc9ce64463b31988f2fe4f86f5b66976
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.0 MB (108042932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e542ecb2079e0050ad17245caadc294cf6ae88b6ee47246a7526c26fc1890d2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 09:35:20 GMT
RUN set -eux; 	version='6.2-RC3'; 	sha1='fbcbc9ec78398affc8c3b67b99257e6128d51284'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 09:35:21 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 09:35:21 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 09:35:22 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 23 Mar 2023 09:35:22 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 23 Mar 2023 09:35:22 GMT
...
-	Layers:
	...
	-	`sha256:fb1e8a65aa06d042c81dceff2805ed3e4f5705efa79d6a7e692fae8a67ed6204`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf7ab0f365a65a3d372d9c59467fa31bf292f3c78ed57432e0c9cc3ef369107b`  
		Last Modified: Thu, 23 Mar 2023 09:39:35 GMT  
		Size: 22.8 MB (22845951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87de83ed455f15e7c5d0817bac3f796bd5aa0f8cbb0cbcf96949b36f632633a1`  
		Last Modified: Thu, 23 Mar 2023 09:39:29 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4965497788d4cf07ebb89068ca1aacc4f0b912433b13ae22ebddadf6482d228`  
		Last Modified: Thu, 23 Mar 2023 09:39:29 GMT  
...
```console
$ docker pull wordpress@sha256:5da83a087c94fe9be4a29389a03637827fb59b6701e900ce293fad285fffac9c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.7 MB (91710602 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc832418c0f7a7474c31b6fa1b8750e4913999bc2880eeb9e608a8e1e6497928`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 23 Mar 2023 22:48:25 GMT
RUN set -eux; 	version='6.2-RC4'; 	sha1='e8b707c77232e3e278a9dec9b3394446e4c4067c'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Thu, 23 Mar 2023 22:48:26 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 22:48:26 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 23 Mar 2023 22:48:26 GMT
...
-	Layers:
	...
	-	`sha256:84d4836f5610c4454d5d4e7ea51f330faf042cfc2bae1e2641e4a5c4947d1956`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6e59b9eb581a18a2e8394656adbabddb0d8091501dc8369b9d82e0fd4244633`  
		Last Modified: Thu, 23 Mar 2023 22:51:20 GMT  
		Size: 22.8 MB (22845882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1ddbe2f709c309abcf3a7f399a13213924522f254f05f6da9d7bf7a005383e5`  
		Last Modified: Thu, 23 Mar 2023 22:51:16 GMT  
		Size: 2.4 KB (2351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b27a3035b9e1787ba862f2e8fd60360c3729459e32afa06ab4e917784a561d0`  
		Last Modified: Thu, 23 Mar 2023 22:51:17 GMT  
