...
```console
$ docker pull wordpress@sha256:ea42e65069d39392528bb541f0b062dbd59d822b8a09468201b092b9312eb349
```
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; amd64
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; arm variant v5

```console
$ docker pull wordpress@sha256:a8af7ad9a93ba69815e9a862a8f30b30b3a674e8747efa25d6d0feb81013dba2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.4 MB (194439021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e48324b2507e52235aced20c6d80c4f31d3f71ccc130869ea8af07d2b25ef9e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 14:22:21 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPTrustedProxy 10.0.0.0/8'; 		echo 'RemoteIPTrustedProxy 172.16.0.0/12'; 		echo 'RemoteIPTrustedProxy 192.168.0.0/16'; 		echo 'RemoteIPTrustedProxy 169.254.0.0/16'; 		echo 'RemoteIPTrustedProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Wed, 15 Mar 2023 23:51:30 GMT
RUN set -eux; 	version='6.2-RC2'; 	sha1='275008d535aa34e840dd8f6913cdb64b6006a9a5'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 777 wp-content
# Wed, 15 Mar 2023 23:51:30 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 23:51:30 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Wed, 15 Mar 2023 23:51:31 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Wed, 15 Mar 2023 23:51:31 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 15 Mar 2023 23:51:31 GMT
...
-	Layers:
	...
	-	`sha256:2dc460cbac7fdfb17b9dbe30eaaf0d56e17302ef854985ebb9b0033fb52ffb0a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0cc9dbcc79228387c7d86e2013d7a662146704631d4fb7f4287c7690a0626ef`  
		Last Modified: Wed, 15 Mar 2023 23:58:06 GMT  
		Size: 22.8 MB (22844686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ca9fbdaf0e3a92c51733d20fb9891d98137cf5e81518622b5f42b1d4c39de97`  
		Last Modified: Wed, 15 Mar 2023 23:58:02 GMT  
		Size: 2.4 KB (2350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f080ecc692ff2683fafc1e5ecb164013f17c54d4188b6efe2202499a052fe03`  
		Last Modified: Wed, 15 Mar 2023 23:58:02 GMT  
		Size: 1.7 KB (1736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.2-RC2-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; arm64 variant v8

```console
$ docker pull wordpress@sha256:8da7638997dc3b1c158f85fb0baefb077245d884d259950392f1d23f9f57b2d5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.5 MB (210516682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95500ddfd5fce703906d48d0b4ae62c60a8ff6fb2c50d1027dd906105c0e77c3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:3f8a2932b992f316fe83dc5313e05ea627aa32f538736e5ff39120f435701d75`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef73be1ee25279b9cc818469b36937541e8ea89cb2843b1cf48d217ef3366e2f`  
		Last Modified: Thu, 16 Mar 2023 01:34:15 GMT  
		Size: 22.8 MB (22844685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f50f18786b87176511c162eaf4a5231a5d7d6ac2cf82c14253d0de4cd55324a6`  
		Last Modified: Thu, 16 Mar 2023 01:34:13 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0963ecf3f9aa1aa6d567fb675fbccf29bb99336545d5487c05ba8b49087211e3`  
		Last Modified: Thu, 16 Mar 2023 01:34:13 GMT  
		Size: 1.7 KB (1735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `wordpress:beta-6.2-RC2-php8.1` - linux; 386
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; mips64le
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.2-RC2-php8.1` - linux; s390x
