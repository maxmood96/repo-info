...
```console
$ docker pull wordpress@sha256:cf76f5b0104416e457fa9ad7c46a9108f5a7b03c32e9ec3458602f969d673d4e
```
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC2-php8.1-fpm` - linux; s390x
