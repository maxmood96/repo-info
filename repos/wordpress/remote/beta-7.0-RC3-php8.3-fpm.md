...
```console
$ docker pull wordpress@sha256:e4582a288843f969df5ee10edbb24b651094bde1e4328c24512c23766c0a8297
```
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; amd64
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; 386
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-7.0-RC3-php8.3-fpm` - linux; s390x
