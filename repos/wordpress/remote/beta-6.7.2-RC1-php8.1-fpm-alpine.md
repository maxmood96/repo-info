...
```console
$ docker pull wordpress@sha256:e466b8d089d7fdd3742664417c67e8a5332ff8d5a924938cf5cc12765b52a2f8
```
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.7.2-RC1-php8.1-fpm-alpine` - linux; riscv64
