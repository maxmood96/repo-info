...
```console
$ docker pull wordpress@sha256:ef142a79fcfc0801e6930f5952ecf66b61fd32c7f338584cbdc534cacd49b424
```
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - unknown; unknown
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; mips64le
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; ppc64le
...
### `wordpress:beta-6.7-beta3-php8.3-fpm` - linux; s390x
