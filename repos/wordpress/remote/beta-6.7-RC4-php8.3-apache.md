...
```console
$ docker pull wordpress@sha256:f7b80b2d0a99731d74a39eebd8b100d079114df3aa9d7e9a4ff2de60288c9735
```
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; amd64
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - unknown; unknown
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; 386
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; mips64le
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; ppc64le
...
### `wordpress:beta-6.7-RC4-php8.3-apache` - linux; s390x
