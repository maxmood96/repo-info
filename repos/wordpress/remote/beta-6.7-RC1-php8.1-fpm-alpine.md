...
```console
$ docker pull wordpress@sha256:1214093d1fbb9d34139c7d36029f7f6a1f1e9e4a4ae932fe1383dc39eb04bdab
```
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; riscv64
...
### `wordpress:beta-6.7-RC1-php8.1-fpm-alpine` - linux; s390x
