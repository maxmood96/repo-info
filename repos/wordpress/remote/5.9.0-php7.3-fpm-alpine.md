...
### `wordpress:5.9.0-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:5.9.0-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.9.0-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.9.0-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:5.9.0-php7.3-fpm-alpine` - linux; ppc64le
