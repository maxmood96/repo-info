...
```console
$ docker pull wordpress@sha256:8d9500622216730fb0cdd37de41a67ed1fc666bd1b671ff38e6d95071707c548
```
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; mips64le
...
### `wordpress:beta-6.3-RC1-php8.0` - linux; ppc64le
