## `wordpress:beta-6.2-RC3-php8.0-fpm`

```console
$ docker pull wordpress@sha256:c68b48a83682ca4ee5d120eda655a2130fd218778e55af3e93c3607a74837fae
```
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-6.2-RC3-php8.0-fpm` - linux; s390x
