...
```console
$ docker pull wordpress@sha256:1277b7933e10d39f482b962c1ea420c37aabfef174518bf2fed377521301c544
```
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.5-RC3-php8.2-fpm-alpine` - linux; s390x
