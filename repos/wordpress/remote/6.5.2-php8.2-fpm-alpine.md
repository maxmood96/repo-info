...
```console
$ docker pull wordpress@sha256:533c4d0c8121cd88eaf22c18c68408cdb3a79981e8616088e39e4727def46038
```
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:6.5.2-php8.2-fpm-alpine` - linux; ppc64le
