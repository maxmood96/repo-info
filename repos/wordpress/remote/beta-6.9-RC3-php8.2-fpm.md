...
```console
$ docker pull wordpress@sha256:f6d75ec46793e5e4ebd4bf9470835d90a50738c74aa0d752ef4d39476ce51560
```
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; amd64
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - unknown; unknown
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; 386
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; ppc64le
...
### `wordpress:beta-6.9-RC3-php8.2-fpm` - linux; s390x
