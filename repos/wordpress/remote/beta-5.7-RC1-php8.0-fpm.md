...
```console
$ docker pull wordpress@sha256:770eb3eaf059ea3462d7c9712be3d02b7321db0bc80d8fb387c0538ce42330e8
```
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; 386
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-5.7-RC1-php8.0-fpm` - linux; s390x
