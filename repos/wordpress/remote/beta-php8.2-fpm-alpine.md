...
```console
$ docker pull wordpress@sha256:3dd900e5aacab4ad51ce20452a38e7114f969f1c4e4ab3423a841a693a2d076e
```
...
```console
$ docker pull wordpress@sha256:125d7ef358e0f11c66e89fb612b609d17255e4ca2bcfd5691081257ec26848f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.0 MB (107958977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4aa67a69d71fd84b03785b1b8728b4ac3a40e5ad846b4b9d7755c7e81cb1ae3`
...
-	Layers:
	...
	-	`sha256:216c2b401c031a9171dcd999376d6566fc7f71993f88159b3d41b714c22014ce`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1810d501cf634fef577cf0f86dbb571f1156fa0f98a735c3bf24a60885c853ad`  
		Last Modified: Sat, 30 Sep 2023 07:52:59 GMT  
		Size: 27.5 MB (27475269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:944e59a9ebffebe5fd81986726286cb6f5f3efa9db89127c1173b733c6858c5c`  
		Last Modified: Sat, 30 Sep 2023 07:52:56 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a5265ea200a4a93c056f5eed5c44ba9ed153d6961a1dc951cbf79b1e36bea5a`  
		Last Modified: Sat, 30 Sep 2023 07:52:56 GMT  
...
```console
$ docker pull wordpress@sha256:2d3c4c0908bef6a233e3b873e9f5abaf94830d04c171a8b92151ac06185a9b9d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.2 MB (102241320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d18b03798f1859ad77423ac6605a124cfa1bc2efb618729facbd95a682f27445`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b67a787072a97a07ba31564ba2ca37ff54275fe1d81c7c7bf49a7278fb3609a4`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0da2aaa6955c0c5c6e39aabd5bd5b20864222c45e7c8c03346ac47a5dfa92542`  
		Last Modified: Sat, 30 Sep 2023 04:01:46 GMT  
		Size: 27.5 MB (27475278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ffa922be55b31a47698c04832bacf1222aae85e5e6b1a80fb437a4bc299ff8c`  
		Last Modified: Sat, 30 Sep 2023 04:01:42 GMT  
		Size: 2.3 KB (2346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:401f36bd3cce122324e943b5adb39d39a926375817bd0c900ce45a782244e411`  
		Last Modified: Sat, 30 Sep 2023 04:01:42 GMT  
...
```console
$ docker pull wordpress@sha256:098a1f94a46029863127f0defc4f96c7d1a7645750a26f30da553c32d1152cf8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.9 MB (98921400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79104352646f7934f700f58fec85647e713c8b7dfe2508e162fec206d7f94c64`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 30 Sep 2023 07:31:35 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 30 Sep 2023 07:31:36 GMT
VOLUME [/var/www/html]
# Sat, 30 Sep 2023 07:31:36 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 30 Sep 2023 07:31:36 GMT
...
-	Layers:
	...
	-	`sha256:ab66e1c1768db647de7a515fa84aade4f3ac3c12d859421292f8169005c7cadf`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0aa7f5c6b8fd528b4e90169c144ff8aa19335b54dd4959ff4091d772c329d2c7`  
		Last Modified: Sat, 30 Sep 2023 07:38:01 GMT  
		Size: 27.5 MB (27475273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2740abc0126932d407bc94664676fe0108cc5d51168648a7f73066bd2a1a02d`  
		Last Modified: Sat, 30 Sep 2023 07:37:57 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85e731d2fe29d54a91b18c384136914f01a870e7467f84aac228918a10c8cab5`  
		Last Modified: Sat, 30 Sep 2023 07:37:57 GMT  
...
```console
$ docker pull wordpress@sha256:bca240b51986dfbb91a89e152f62decdd3a74d944b74fccd5c001f63f7494656
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107232382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:699a4772e5d84a58670f3768e0432a31daa1dd280b7095fef95907a58b8a410a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 07:08:46 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 30 Sep 2023 07:11:37 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 30 Sep 2023 07:11:37 GMT
VOLUME [/var/www/html]
# Sat, 30 Sep 2023 07:11:38 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 30 Sep 2023 07:11:38 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 30 Sep 2023 07:11:38 GMT
...
-	Layers:
	...
	-	`sha256:9b277b1a62bb94beb74df88eb038d0d8675efd1b3ba098c5508b1573b319fa14`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:993890a9cdcff982b02bb59b2c98930f4a7f1e5c260a8cc44fb84aca450120e9`  
		Last Modified: Sat, 30 Sep 2023 07:18:09 GMT  
		Size: 27.5 MB (27475267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd1c79e8cbc2a1417b00096f346b7704f7eec821e73ebea4f51dc4a1beefeb6f`  
		Last Modified: Sat, 30 Sep 2023 07:18:06 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:531e8003330f0a5c8930c6883773855d711441fab8e5295f62f093234b78bc26`  
		Last Modified: Sat, 30 Sep 2023 07:18:06 GMT  
...
```console
$ docker pull wordpress@sha256:ecb0ccaf5417f944ffddb5a4356c8102008c59f5477fb43e9c7849bcf0f13d6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104947463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15ff850bd64cb9318afde6e25736f65685f383ad36d1fe1b82c8d825da70d678`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 08:49:42 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 30 Sep 2023 08:53:51 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 30 Sep 2023 08:53:52 GMT
VOLUME [/var/www/html]
# Sat, 30 Sep 2023 08:53:52 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 30 Sep 2023 08:53:52 GMT
...
-	Layers:
	...
	-	`sha256:98d34ef9c45e2898a68dbd05e2ba46e4b21145a394c7779067766b9a6edc5662`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e61ed225d69efe0363b8965e26aeee3ee22f1390b75d3551741e652016cb6ee`  
		Last Modified: Sat, 30 Sep 2023 09:01:19 GMT  
		Size: 27.5 MB (27475268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57811444667f912095c4e434af9d495e1f52c276357e4706bcd5e852d16ac657`  
		Last Modified: Sat, 30 Sep 2023 09:01:14 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981affd45223e873823ebe83c025d05bf633f36f3ed1307283175712b8883bc4`  
		Last Modified: Sat, 30 Sep 2023 09:01:14 GMT  
...
```console
$ docker pull wordpress@sha256:51703be1669fad5c01ca535c160a508d876c54c1500b3ef92771f55e96f0996a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.5 MB (113494391 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca18a33c7bd4f980ac3d3a42409650acae12a7bd7151d05cd570b57e9e6b2b59`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 30 Sep 2023 06:53:34 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Sat, 30 Sep 2023 06:53:37 GMT
VOLUME [/var/www/html]
# Sat, 30 Sep 2023 06:53:37 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Sat, 30 Sep 2023 06:53:37 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Sat, 30 Sep 2023 06:53:38 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Sat, 30 Sep 2023 06:53:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8116120f3c056121328040cad122a2e286eec46b39eda1ae3835d14621975bbb`  
		...
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0bd8a8a87150d9f3cf87d84e71bb9b6d4cba44f9f0bedec6893235c641137ce`  
		Last Modified: Sat, 30 Sep 2023 07:03:13 GMT  
		Size: 27.5 MB (27475280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47b0a69c591931825742356484e659474c60045409176048533b179a2ad4db57`  
		Last Modified: Sat, 30 Sep 2023 07:03:07 GMT  
		Size: 2.3 KB (2347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8bbea471ffeb46e4414b55d2e4ee349ecc61396b6f676c478fa9f8b22f69e49`  
		Last Modified: Sat, 30 Sep 2023 07:03:07 GMT  
...
```console
$ docker pull wordpress@sha256:73877365fa1f7a01726a8498ca5f62b74a40c4c02172170b5900aef9cc7ff52a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.9 MB (106894505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed814b7e3015b108fbd57f680fd9f662ddbfab18ca8be03b5860b32e9b90ff17`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 29 Sep 2023 06:22:47 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Fri, 29 Sep 2023 06:22:49 GMT
VOLUME [/var/www/html]
# Fri, 29 Sep 2023 06:22:49 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Fri, 29 Sep 2023 06:22:49 GMT
...
-	Layers:
	...
	-	`sha256:12e7a3a1cfb21734f0551f214fb038b620b7202e13218be219f0398f45dd0127`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9afbe1beb8d32f8e3f5904262ca2dc663b1ba660ccf23c9e77385e03e9a2c5df`  
		Last Modified: Fri, 29 Sep 2023 06:29:21 GMT  
		Size: 27.5 MB (27475254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6fc6d35f5f8593ebc2f6f08da638606259f8a06e10d9c5f2f48272df9f54036`  
		Last Modified: Fri, 29 Sep 2023 06:29:18 GMT  
		Size: 2.3 KB (2349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f877b8e23d53a9d57fb4224db39f237e1f54a03c6de43f06db496b2683f8737`  
		Last Modified: Fri, 29 Sep 2023 06:29:18 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
