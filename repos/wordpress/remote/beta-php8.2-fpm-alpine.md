...
```console
$ docker pull wordpress@sha256:a3085769f8247d3895c1c4c1f98bb2e000da8afa9bd103298bbb00e4c555184c
```
...
```console
$ docker pull wordpress@sha256:469f3c0e8362e7e5437cd52f3e6191c95c52bf63c9de47a2422e57994afed145
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.8 MB (93834954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:812d95a038b67786088608d1bccc13445f5743b9c63904a62550165669ee5af4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:608354dd11e9dca2d2f9f2bcb6b50fd4a63d20ea9ee6f70a580dcd38cfb8701b`  
		...
		Size: 393.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7359dc798f4d15c7d18eef92037517e1a1dcc810cade2e3307ab9a9a23370009`  
		Last Modified: Wed, 29 Oct 2025 15:44:24 GMT  
		Size: 27.0 MB (27005849 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a4aae9f4b6d78f554f732e8f0baddc3f6f1e2082788f6f41149997fcc15fd60b`  
		Last Modified: Wed, 29 Oct 2025 15:44:21 GMT  
		Size: 2.4 KB (2443 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ad419a363d78d8684e92f9fb5a4b375abcb74429d1582daad6eeed2ae0bd142a`  
		Last Modified: Wed, 29 Oct 2025 15:44:21 GMT  
		Size: 1.8 KB (1770 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fd150babde204b1dcb5a378d4be20585f225f77335cfd346351485413e0407a2`  
		Last Modified: Wed, 29 Oct 2025 15:44:21 GMT  
		Size: 199.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:e280dcc5b38993b378e9c0db348ccc08e28ba2026a23330e2c65b429a83229f6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1130398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2db04ee4204b4d2940fee7e3ff03bb527df5f3fcbe97a3b6b020ed4827f4664c`

```dockerfile
```

-	Layers:
	-	`sha256:113a7d70a3f03cfd4733b5c0eb4860f563b3a2e3dfc119e17c41085a9f7cf367`  
		Last Modified: Wed, 29 Oct 2025 16:15:07 GMT  
		Size: 1.1 MB (1078610 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f7fda9a325f3e93b45c99ea7430e78d3b25389d05a7797faf57716fae12d5dab`  
		Last Modified: Wed, 29 Oct 2025 16:15:08 GMT  
		Size: 51.8 KB (51788 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull wordpress@sha256:5b81817b6aeb1b4cd7273e165f23ce2efd28c018cfd13b88f302f5a8027594e7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.5 MB (97535511 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e372d3621c664463043bb9dc55315b25c092360e9a2899668d03375abd9298fe`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini # buildkit
# Wed, 05 Nov 2025 07:02:19 GMT
RUN set -eux; 	version='6.9-beta3'; 	sha1='99d53b1eb30e5502f89996db538b5c9fc56987e0'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content # buildkit
# Wed, 05 Nov 2025 07:02:20 GMT
VOLUME [/var/www/html]
# Wed, 05 Nov 2025 07:02:20 GMT
COPY --chown=www-data:www-data wp-config-docker.php /usr/src/wordpress/ # buildkit
# Wed, 05 Nov 2025 07:02:20 GMT
...
-	Layers:
	...
	-	`sha256:dcc5d762e93da8ac307fe4253453c8ccb8d41b9262bf46b5a42ebd08ca2659cd`  
		...
		Size: 393.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b1e914e40a793b203ae0b0ba2abc30be5e0859ced1c0061ad4be46ab14c5374c`  
		Last Modified: Wed, 05 Nov 2025 07:02:53 GMT  
		Size: 27.0 MB (27011614 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:472e3d8385e9e808c3e90245de2052db7376a36d9d3a57d471284bac65cb5361`  
		Last Modified: Wed, 05 Nov 2025 07:02:51 GMT  
		Size: 2.4 KB (2444 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5046ea11ccc3c05e57dee88cd8183e615f2f438811b32bbc15ff1609a8ced089`  
		Last Modified: Wed, 05 Nov 2025 07:02:50 GMT  
		Size: 1.8 KB (1767 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5ae0eb8aaf7b4a8bc859bd133aa3f2f0877fd9f87227faa27654d3d9be2a857a`  
		Last Modified: Wed, 05 Nov 2025 07:02:50 GMT  
		Size: 197.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:ba5bea2a8795cf5911b22b1f352e70d64e316f2be87706ff2d77947d4d5cc37c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1130312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4a2ac3e084f592f201da6b02919e1f416d0a20be1ab8d2e91a5ce9ad4eab41e`

```dockerfile
```

-	Layers:
	-	`sha256:5edb68ebb9d3b5eebf196af474f470cf2e7da2fb400ac94ec10fffd3c6194d98`  
		Last Modified: Wed, 05 Nov 2025 08:15:01 GMT  
		Size: 1.1 MB (1078580 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:321ca6c2eb5d669b5936c90b04095c99c4f9ecda57668c7d3e9e69a40a27c1ca`  
		Last Modified: Wed, 05 Nov 2025 08:15:02 GMT  
