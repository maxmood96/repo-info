...
### `wordpress:beta-6.0-beta1-apache` - linux; amd64
...
### `wordpress:beta-6.0-beta1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta1-apache` - linux; 386
...
### `wordpress:beta-6.0-beta1-apache` - linux; mips64le
...
### `wordpress:beta-6.0-beta1-apache` - linux; ppc64le
