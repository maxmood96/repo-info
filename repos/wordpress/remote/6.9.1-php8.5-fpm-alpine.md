...
```console
$ docker pull wordpress@sha256:a29a78ab205ce5319af529b7f1a2c7f5d82bc3e401163b8c98348bc8ed8ef410
```
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; amd64
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - unknown; unknown
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; 386
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; riscv64
...
### `wordpress:6.9.1-php8.5-fpm-alpine` - linux; s390x
