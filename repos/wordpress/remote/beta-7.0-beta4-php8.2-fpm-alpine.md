...
```console
$ docker pull wordpress@sha256:7a2605ed6432be8b42ab4d89f3d4f5e2e95cf119e53e62a94e8cbe5b755173f5
```
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-7.0-beta4-php8.2-fpm-alpine` - linux; s390x
