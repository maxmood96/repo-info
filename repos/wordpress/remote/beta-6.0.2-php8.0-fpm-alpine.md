...
```console
$ docker pull wordpress@sha256:136a7a4f0ebcc76806c87ce630d7ba9d639409279f62d1b2dff2ceee67a00d28
```
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.0.2-php8.0-fpm-alpine` - linux; s390x
