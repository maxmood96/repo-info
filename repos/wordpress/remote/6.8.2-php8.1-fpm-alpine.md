...
```console
$ docker pull wordpress@sha256:f26ff237bdf032c297a37e363df9c3f7e0d36ca86858f83c8ee9a2456a412366
```
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - unknown; unknown
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; 386
...
-	Layers:
	...
	-	`sha256:1c5b7fdfe492c97ff1a2e7c5b01c5a074eaa91586bb989f62d76274afc6adb0d`  
		Last Modified: Wed, 13 Aug 2025 21:09:21 GMT  
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; riscv64

```console
$ docker pull wordpress@sha256:38069f344c41b7891f3fb7cf400387315eb8c536b849d7a7b5fa52bd7c3ba2ef
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.3 MB (92315732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f42abc439985ce552b7f546f0d8c9a4f8774bed987bb75bd45f33206ac9ba07b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:1c1ad52ad375abd4255d74b2e2ab3597632f98bd5c809165daa7054296a35cd4`  
		...
		Size: 393.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d552d484c77f9655e6dd865abff2e429d0bde993dbb82de28c865249863432f2`  
		Last Modified: Wed, 06 Aug 2025 17:05:06 GMT  
		Size: 26.9 MB (26899191 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:51079f2f49e416b0bb5e742e243ebe1e89477e6c7f291cdf7a0a0d5b7797d6e0`  
		Last Modified: Wed, 06 Aug 2025 17:05:04 GMT  
		Size: 2.4 KB (2435 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:81fb9b5bbd1600f2a66af5d7f6a815b31a20126f3da88ef29b049f2091052899`  
		Last Modified: Wed, 06 Aug 2025 17:05:04 GMT  
		Size: 1.8 KB (1764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0bbac335ecacfc3b67b77de23a02b7a4e4308c6da2b45aff2eaacc02206df1b1`  
		Last Modified: Wed, 06 Aug 2025 17:05:04 GMT  
		Size: 194.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull wordpress@sha256:121046948f2c2a2cd458adef4f5a61ce8fcfead738d6d461399900be442b06f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1121954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1b094139f20798ea550896b6f007d7c4aa1c68f6d96f28193ccb73dd4785efd`

```dockerfile
```

-	Layers:
	-	`sha256:d4706becb2ceed816acea7975f1fd79d3ba0011297574043c820345dcbd8bc05`  
		Last Modified: Wed, 06 Aug 2025 19:12:49 GMT  
		Size: 1.1 MB (1070173 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fd1591db55d638a06720265cf7df01cd3ba02644b1186082958e66aba4058dfa`  
		Last Modified: Wed, 06 Aug 2025 19:12:50 GMT  
		Size: 51.8 KB (51781 bytes)  
		MIME: application/vnd.in-toto+json

### `wordpress:6.8.2-php8.1-fpm-alpine` - linux; s390x
