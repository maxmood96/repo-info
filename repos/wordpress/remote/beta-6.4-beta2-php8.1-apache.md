## `wordpress:beta-6.4-beta2-php8.1-apache`

```console
$ docker pull wordpress@sha256:50fc234502eb23865eea23e952643566ac6cc88dee23cb31641c379c20a31e43
```
...
### `wordpress:beta-6.4-beta2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta2-php8.1-apache` - linux; mips64le
