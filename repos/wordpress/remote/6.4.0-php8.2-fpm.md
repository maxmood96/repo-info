## `wordpress:6.4.0-php8.2-fpm`

```console
$ docker pull wordpress@sha256:61faee9201fc51da56e1ec62a3b80770ea0eefea8163e5d01d838e0e19af3b8e
```
...
### `wordpress:6.4.0-php8.2-fpm` - linux; arm variant v5
...
### `wordpress:6.4.0-php8.2-fpm` - linux; arm variant v7
...
### `wordpress:6.4.0-php8.2-fpm` - linux; arm64 variant v8
...
### `wordpress:6.4.0-php8.2-fpm` - linux; 386
...
### `wordpress:6.4.0-php8.2-fpm` - linux; mips64le
...
### `wordpress:6.4.0-php8.2-fpm` - linux; s390x
