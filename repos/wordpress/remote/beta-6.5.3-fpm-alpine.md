## `wordpress:beta-6.5.3-fpm-alpine`

```console
$ docker pull wordpress@sha256:f86a66bc6906333739e973d565cad0b7ac043b697a5932b2d681e35fe0ecd3ce
```
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.5.3-fpm-alpine` - unknown; unknown
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.5.3-fpm-alpine` - linux; s390x
