...
```console
$ docker pull wordpress@sha256:cbeda3b338818bd52561ecfc1977b74182f96fe58cff38971322c3356a07bcb1
```
...
### `wordpress:beta-5.7-RC1-fpm` - linux; amd64
...
### `wordpress:beta-5.7-RC1-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.7-RC1-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC1-fpm` - linux; 386
...
### `wordpress:beta-5.7-RC1-fpm` - linux; mips64le
...
### `wordpress:beta-5.7-RC1-fpm` - linux; s390x
