...
### `wordpress:5.5-php7.4-apache` - linux; amd64
...
### `wordpress:5.5-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:5.5-php7.4-apache` - linux; 386
...
### `wordpress:5.5-php7.4-apache` - linux; ppc64le
