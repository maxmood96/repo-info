...
```console
$ docker pull wordpress@sha256:3e3f42fd0c3e4427f4beb12e0a39f63a8d852f55c265d0fdcc519278290d0cf8
```
...
```console
$ docker pull wordpress@sha256:25b8d7e5e3b9fb7f62917fc674d1172b2a81fe208f985161b20fde3c6c2d78e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.7 MB (224705874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cff0947b18f00f4a1927c809f2418bff53ad89ce9c7d7f896272d121f67b23c5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2eb4db7de5f25b0204f3e6a9c962225a76b2bd9a279abb3a279e7b4a85f82754`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88fac85b1fdaadc8cbec219ccd47c5e7475d272569266e47cb151a6229e5ec79`  
		Last Modified: Thu, 28 Sep 2023 01:09:31 GMT  
		Size: 27.5 MB (27474079 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e1c78d017dba3b130d08fa1f7cec6eabbc6f5151d9850ea12e0f751bb589ad7`  
		Last Modified: Thu, 28 Sep 2023 01:09:28 GMT  
		Size: 2.3 KB (2348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd8b578fc0b2135fc6c5afadf855aca0fce88c42175d144821fb8da29fd4c155`  
		Last Modified: Thu, 28 Sep 2023 01:09:28 GMT  
		Size: 1.7 KB (1732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull wordpress@sha256:4b05b3d0ff70cc8980e9e79e785af302229aaa101fdd00427efc1e3ba4f4a29a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.4 MB (207410080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39fe3e9e002b8f1c193c3bf1fd305fe0c773cb551b0485007aacd2baef0b6e0b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Sep 2023 14:40:29 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 28 Sep 2023 00:51:56 GMT
RUN set -eux; 	version='6.4-beta1'; 	sha1='ddfc7c4cfc3cfd2ac1347f65b547ae63573b8d59'; 		curl -o wordpress.tar.gz -fL "https://wordpress.org/wordpress-$version.tar.gz"; 	echo "$sha1 *wordpress.tar.gz" | sha1sum -c -; 		tar -xzf wordpress.tar.gz -C /usr/src/; 	rm wordpress.tar.gz; 		[ ! -e /usr/src/wordpress/.htaccess ]; 	{ 		echo '# BEGIN WordPress'; 		echo ''; 		echo 'RewriteEngine On'; 		echo 'RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]'; 		echo 'RewriteBase /'; 		echo 'RewriteRule ^index\.php$ - [L]'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-f'; 		echo 'RewriteCond %{REQUEST_FILENAME} !-d'; 		echo 'RewriteRule . /index.php [L]'; 		echo ''; 		echo '# END WordPress'; 	} > /usr/src/wordpress/.htaccess; 		chown -R www-data:www-data /usr/src/wordpress; 	mkdir wp-content; 	for dir in /usr/src/wordpress/wp-content/*/ cache; do 		dir="$(basename "${dir%/}")"; 		mkdir "wp-content/$dir"; 	done; 	chown -R www-data:www-data wp-content; 	chmod -R 1777 wp-content
# Thu, 28 Sep 2023 00:51:57 GMT
VOLUME [/var/www/html]
# Thu, 28 Sep 2023 00:51:58 GMT
COPY --chown=www-data:www-datafile:d38fd3c0db552e13465e83c5d7bbd85c7c3d036bf1285495988cc4ab2ffaf7f5 in /usr/src/wordpress/ 
# Thu, 28 Sep 2023 00:51:58 GMT
COPY file:5be6bcc31206cb827f037769d89fd092037ed61a1e10d6cae7939a37055beb4c in /usr/local/bin/ 
# Thu, 28 Sep 2023 00:51:58 GMT
...
-	Layers:
	...
	-	`sha256:306b7888db142d10fc3372cb231b28d0ed59d126b04a1974b500fa90a99298a7`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef2162d3ea815e9a51b387af9d35c78d638d19ad2529dc1cc60d3f5108d22e5c`  
		Last Modified: Thu, 28 Sep 2023 00:56:18 GMT  
		Size: 27.5 MB (27474076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cd452c6c2789cde9afa36ac4c65de69c56f7d4445af149614f937377ac137f1`  
		Last Modified: Thu, 28 Sep 2023 00:56:14 GMT  
		Size: 2.3 KB (2345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c56be93b4465e94f6bd3708e89a33c9590f88b2b4fe285d3ab636447712cf168`  
		Last Modified: Thu, 28 Sep 2023 00:56:14 GMT  
		Size: 1.7 KB (1730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
