...
- Created: `2026-05-08T20:45:00.319853054Z`
- Virtual Size: ~ 649.54 Mb  
...
### `dpkg` source package: `imagemagick=8:6.9.11.60+dfsg-1.6+deb12u9`

Binary Packages:

- `imagemagick=8:6.9.11.60+dfsg-1.6+deb12u9`
- `imagemagick-6-common=8:6.9.11.60+dfsg-1.6+deb12u9`
- `imagemagick-6.q16=8:6.9.11.60+dfsg-1.6+deb12u9`
- `libmagickcore-6.q16-6:amd64=8:6.9.11.60+dfsg-1.6+deb12u9`
- `libmagickwand-6.q16-6:amd64=8:6.9.11.60+dfsg-1.6+deb12u9`
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.9.11.60+dfsg-1.6+deb12u9
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.11.60%2bdfsg-1.6%2bdeb12u9.dsc' imagemagick_6.9.11.60+dfsg-1.6+deb12u9.dsc 5105 SHA256:5dec0ef2e65a0ec5c2a68915def537296c53a3906e6eb01c1174d6c531da749c
...
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.11.60%2bdfsg-1.6%2bdeb12u9.debian.tar.xz' imagemagick_6.9.11.60+dfsg-1.6+deb12u9.debian.tar.xz 324340 SHA256:f6f3ae9f565fc3e4af376653d5b1750194d4734b12af1ca417f8303791b61b07
```

Other potentially useful URLs:

- https://sources.debian.net/src/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u9/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u9/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `openssh=1:9.2p1-2+deb12u9`
...
```console
$ apt-get source -qq --print-uris openssh=1:9.2p1-2+deb12u9
'http://deb.debian.org/debian-security/pool/updates/main/o/openssh/openssh_9.2p1-2%2bdeb12u9.dsc' openssh_9.2p1-2+deb12u9.dsc 3327 SHA256:d0fa1ecc55cdfc7d82db05d9cedc52ec96d0641c2cd2b283446df5d73e09534e
...
'http://deb.debian.org/debian-security/pool/updates/main/o/openssh/openssh_9.2p1-2%2bdeb12u9.debian.tar.xz' openssh_9.2p1-2+deb12u9.debian.tar.xz 199480 SHA256:bdb378833a7754fcfe23da26c3e3ec2ab27dd5b25f31c9adce400b6811f2a22b
```

Other potentially useful URLs:

- https://sources.debian.net/src/openssh/1:9.2p1-2+deb12u9/ (for browsing the source)
- https://sources.debian.net/src/openssh/1:9.2p1-2+deb12u9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssh/1:9.2p1-2+deb12u9/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian-security/pool/updates/main/p/python-urllib3/python-urllib3_1.26.12-1%2bdeb12u3.dsc' python-urllib3_1.26.12-1+deb12u3.dsc 2499 SHA256:90903b9264067790fa58239bc10cc84d0cdc9e889a51d39663bf104f6de530f0
...
'http://deb.debian.org/debian-security/pool/updates/main/p/python-urllib3/python-urllib3_1.26.12-1%2bdeb12u3.debian.tar.xz' python-urllib3_1.26.12-1+deb12u3.debian.tar.xz 20140 SHA256:d0673891401721305fec795b7df8c0fc1ea1bb5f349766a61f4f7e2a454df09f
```
...
'http://deb.debian.org/debian-security/pool/updates/main/t/tiff/tiff_4.5.0-6%2bdeb12u4.dsc' tiff_4.5.0-6+deb12u4.dsc 2287 SHA256:b32082304d725936078d687303fcf771c9ecf738b505f9a66a29e8ba282c8615
...
'http://deb.debian.org/debian-security/pool/updates/main/t/tiff/tiff_4.5.0-6%2bdeb12u4.debian.tar.xz' tiff_4.5.0-6+deb12u4.debian.tar.xz 31680 SHA256:4ee50a8cdf74a184d94e65a04f3c9de466cb0b74ef5393fb5ca65666fccb864b
```
