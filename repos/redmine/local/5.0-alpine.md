...
```console
breezy-3.3.2-r0 description:
Decentralized revision control system

breezy-3.3.2-r0 webpage:
https://www.breezy-vcs.org/

breezy-3.3.2-r0 installed size:
10 MiB

breezy-3.3.2-r0 license:
GPL-2.0-or-later
...
```console
breezy-pyc-3.3.2-r0 description:
Precompiled Python bytecode for breezy

breezy-pyc-3.3.2-r0 webpage:
https://www.breezy-vcs.org/

breezy-pyc-3.3.2-r0 installed size:
9856 KiB

breezy-pyc-3.3.2-r0 license:
GPL-2.0-or-later
...
```console
bzip2-1.0.8-r5 description:
A high-quality data compression program

bzip2-1.0.8-r5 webpage:
https://sourceware.org/bzip2/

bzip2-1.0.8-r5 installed size:
332 KiB

bzip2-1.0.8-r5 license:
bzip2-1.0.6
...
```console
freetds-1.3.18-r1 description:
Tabular Datastream Library

freetds-1.3.18-r1 webpage:
https://www.freetds.org/

freetds-1.3.18-r1 installed size:
1744 KiB

freetds-1.3.18-r1 license:
...
```console
gmp-dev-6.2.1-r3 description:
free library for arbitrary precision arithmetic (development files)

gmp-dev-6.2.1-r3 webpage:
https://gmplib.org/

gmp-dev-6.2.1-r3 installed size:
1528 KiB

gmp-dev-6.2.1-r3 license:
LGPL-3.0-or-later OR GPL-2.0-or-later
...
```console
libffi-dev-3.4.4-r2 description:
portable, high level programming interface to various calling conventions. (development files)

libffi-dev-3.4.4-r2 webpage:
https://sourceware.org/libffi/

libffi-dev-3.4.4-r2 installed size:
232 KiB

libffi-dev-3.4.4-r2 license:
MIT
...
```console
libgmpxx-6.2.1-r3 description:
C++ support for gmp

libgmpxx-6.2.1-r3 webpage:
https://gmplib.org/

libgmpxx-6.2.1-r3 installed size:
44 KiB

libgmpxx-6.2.1-r3 license:
LGPL-3.0-or-later OR GPL-2.0-or-later
...
```console
linux-headers-6.3-r0 description:
Linux system headers

linux-headers-6.3-r0 webpage:
https://kernel.org/

linux-headers-6.3-r0 installed size:
8056 KiB

linux-headers-6.3-r0 license:
GPL-2.0-only
...
```console
py3-dulwich-0.21.5-r0 description:
python implementation of the Git file formats and protocols

py3-dulwich-0.21.5-r0 webpage:
https://www.dulwich.io/

py3-dulwich-0.21.5-r0 installed size:
1208 KiB

py3-dulwich-0.21.5-r0 license:
...
```console
py3-dulwich-pyc-0.21.5-r0 description:
Precompiled Python bytecode for py3-dulwich

py3-dulwich-pyc-0.21.5-r0 webpage:
https://www.dulwich.io/

py3-dulwich-pyc-0.21.5-r0 installed size:
1376 KiB

py3-dulwich-pyc-0.21.5-r0 license:
GPL-2.0-or-later OR Apache-2.0
...
```console
py3-patiencediff-0.2.13-r1 description:
Patiencediff Python and C implementations

py3-patiencediff-0.2.13-r1 webpage:
https://www.breezy-vcs.org/

py3-patiencediff-0.2.13-r1 installed size:
152 KiB

py3-patiencediff-0.2.13-r1 license:
GPL-2.0-or-later
...
```console
py3-patiencediff-pyc-0.2.13-r1 description:
Precompiled Python bytecode for py3-patiencediff

py3-patiencediff-pyc-0.2.13-r1 webpage:
https://www.breezy-vcs.org/

py3-patiencediff-pyc-0.2.13-r1 installed size:
80 KiB

py3-patiencediff-pyc-0.2.13-r1 license:
GPL-2.0-or-later
...
```console
py3-six-1.16.0-r6 description:
Python 2 and 3 compatibility library

py3-six-1.16.0-r6 webpage:
https://pypi.org/project/six

py3-six-1.16.0-r6 installed size:
60 KiB

py3-six-1.16.0-r6 license:
MIT
...
```console
py3-six-pyc-1.16.0-r6 description:
Precompiled Python bytecode for py3-six

py3-six-pyc-1.16.0-r6 webpage:
https://pypi.org/project/six

py3-six-pyc-1.16.0-r6 installed size:
72 KiB

py3-six-pyc-1.16.0-r6 license:
MIT
...
```console
yaml-dev-0.2.5-r1 description:
YAML 1.1 parser and emitter written in C (development files)

yaml-dev-0.2.5-r1 webpage:
https://pyyaml.org/wiki/LibYAML

yaml-dev-0.2.5-r1 installed size:
80 KiB

yaml-dev-0.2.5-r1 license:
MIT
