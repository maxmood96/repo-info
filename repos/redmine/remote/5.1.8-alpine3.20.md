...
```console
$ docker pull redmine@sha256:1b79b9b5c352862a781887dca04b9fd3c8c47077ab74b71437a0a012790be542
```
...
### `redmine:5.1.8-alpine3.20` - linux; amd64
...
### `redmine:5.1.8-alpine3.20` - unknown; unknown
...
### `redmine:5.1.8-alpine3.20` - linux; arm variant v6
...
### `redmine:5.1.8-alpine3.20` - linux; arm variant v7
...
### `redmine:5.1.8-alpine3.20` - linux; arm64 variant v8
...
### `redmine:5.1.8-alpine3.20` - linux; 386
...
### `redmine:5.1.8-alpine3.20` - linux; ppc64le
...
### `redmine:5.1.8-alpine3.20` - linux; s390x
