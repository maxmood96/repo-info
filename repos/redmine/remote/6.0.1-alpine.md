...
### `redmine:6.0.1-alpine` - linux; amd64
...
### `redmine:6.0.1-alpine` - unknown; unknown
...
### `redmine:6.0.1-alpine` - linux; arm variant v6
...
### `redmine:6.0.1-alpine` - linux; arm variant v7
...
### `redmine:6.0.1-alpine` - linux; arm64 variant v8
...
### `redmine:6.0.1-alpine` - linux; 386
...
### `redmine:6.0.1-alpine` - linux; ppc64le
...
### `redmine:6.0.1-alpine` - linux; riscv64
...
### `redmine:6.0.1-alpine` - linux; s390x
