...
```console
$ docker pull redmine@sha256:e4067116228e0f3bb91894a006fe81521a32ccd31c09997a5eb9b35eb1a4b1a5
```
...
### `redmine:6.1.1-alpine` - linux; amd64
...
### `redmine:6.1.1-alpine` - unknown; unknown
...
### `redmine:6.1.1-alpine` - linux; arm variant v7
...
### `redmine:6.1.1-alpine` - linux; arm64 variant v8
...
### `redmine:6.1.1-alpine` - linux; 386
...
### `redmine:6.1.1-alpine` - linux; ppc64le
...
### `redmine:6.1.1-alpine` - linux; s390x
