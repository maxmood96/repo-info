...
```console
$ docker pull redmine@sha256:2171e3c3f8c436a6fb064519af9144f3eb75d04747b9a8a3dd43819ddfbe004e
```
...
```console
$ docker pull redmine@sha256:b711931646f6b19661bd9d93b9ed7e66f95a84a74b08465849a1ab51846ee19b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.4 MB (206393500 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a75adf95f9326c7c9a6fc499a6dc8e1a30009d0399514aa480d31d31abac426c`
...
```console
$ docker pull redmine@sha256:57171fc6f47612443262a6ececdc8ef07563cbbad9c8bf9e57ae5725cf2acca2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.7 MB (203683336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f8908cbd887e80f5eb9f1c5611b5937d3aca853a044cc6dc4577d5b28452945`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
# Wed, 14 Sep 2022 02:23:14 GMT
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Mon, 03 Oct 2022 22:50:51 GMT
ENV REDMINE_VERSION=4.2.8
# Mon, 03 Oct 2022 22:50:51 GMT
ENV REDMINE_DOWNLOAD_URL=https://www.redmine.org/releases/redmine-4.2.8.tar.gz
# Mon, 03 Oct 2022 22:50:51 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Mon, 03 Oct 2022 22:50:55 GMT
RUN set -eux; 	curl -fL -o redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Mon, 03 Oct 2022 22:53:16 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		default-libmysqlclient-dev 		freetds-dev 		gcc 		libpq-dev 		libsqlite3-dev 		make 		patch 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		gosu redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	gosu redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -v '^/usr/local/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Mon, 03 Oct 2022 22:53:17 GMT
VOLUME [/usr/src/redmine/files]
# Mon, 03 Oct 2022 22:53:17 GMT
COPY file:5ad924c6f87c91325ac6781766e5ad56444f0bea5780e13e8bed5000ee3cfc38 in / 
# Mon, 03 Oct 2022 22:53:17 GMT
...
-	Layers:
	...
	-	`sha256:910976915dc7e36ba585b8d748823e590be6b9ad42bcd05a7ed162d03a0328d3`  
		...
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ec82494b4841455d964b029af98e373222407b4bd46c861296fccab66ee092`  
		Last Modified: Mon, 03 Oct 2022 22:54:55 GMT  
		Size: 3.1 MB (3066584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dae3b1afe258891f66e164a0408e20fba6dd80caec9bdaf3385a70bccf84bd86`  
		Last Modified: Mon, 03 Oct 2022 22:55:02 GMT  
		Size: 52.2 MB (52197829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98f7076fa02c0643025e37ac9155c35c1cf60a2e9feb5d6e2e9d6d3b447dd1f4`  
		Last Modified: Mon, 03 Oct 2022 22:54:53 GMT  
...
```console
$ docker pull redmine@sha256:f5aec879ea8668f66029d5e80fbb493aa36a0c71cb6e7c8ebfc297ef76f9b709
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.1 MB (201114264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7863e8128e283d61b4f39a0d42c7aabbfa6371496c0631bc7e053afbdd1a3287`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Tue, 04 Oct 2022 01:30:11 GMT
ENV REDMINE_VERSION=4.2.8
# Tue, 04 Oct 2022 01:30:11 GMT
ENV REDMINE_DOWNLOAD_URL=https://www.redmine.org/releases/redmine-4.2.8.tar.gz
# Tue, 04 Oct 2022 01:30:12 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Tue, 04 Oct 2022 01:30:16 GMT
RUN set -eux; 	curl -fL -o redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Tue, 04 Oct 2022 01:31:01 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		default-libmysqlclient-dev 		freetds-dev 		gcc 		libpq-dev 		libsqlite3-dev 		make 		patch 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		gosu redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	gosu redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -v '^/usr/local/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 04 Oct 2022 01:31:02 GMT
VOLUME [/usr/src/redmine/files]
# Tue, 04 Oct 2022 01:31:04 GMT
COPY file:5ad924c6f87c91325ac6781766e5ad56444f0bea5780e13e8bed5000ee3cfc38 in / 
# Tue, 04 Oct 2022 01:31:05 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Tue, 04 Oct 2022 01:31:06 GMT
EXPOSE 3000
# Tue, 04 Oct 2022 01:31:06 GMT
CMD ["rails" "server" "-b" "0.0.0.0"]
```
...
-	Layers:
	...
	-	`sha256:3f1b9495c4014f0e3e0338dcb40457d10fdddaa6057d04d3f070828d80d1100e`  
		...
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca243601062d00c074e6512618b3349d4a02b0c313bd4bdd80b835d2cc8fb386`  
		Last Modified: Tue, 04 Oct 2022 01:36:25 GMT  
		Size: 3.1 MB (3066739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa01dcd94375a3db4ade84aea31a163cd6eca0899f033a583ca8817e0675616e`  
		Last Modified: Tue, 04 Oct 2022 01:36:29 GMT  
		Size: 44.8 MB (44811774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c547e2452aec072666e03610eba06894589146b868697a0b90f89f2be82c8717`  
		Last Modified: Tue, 04 Oct 2022 01:36:24 GMT  
		Size: 1.9 KB (1858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull redmine@sha256:d5006780db5fbb10d741c6653198a1d230873cd4badb9aae532048b65642a8d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.6 MB (209572903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ce852b8819abe312572ea64d73ad00c9bfa79d994fd215744fe5f11b18ad89f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Mon, 03 Oct 2022 23:55:13 GMT
ENV REDMINE_VERSION=4.2.8
# Mon, 03 Oct 2022 23:55:13 GMT
ENV REDMINE_DOWNLOAD_URL=https://www.redmine.org/releases/redmine-4.2.8.tar.gz
# Mon, 03 Oct 2022 23:55:14 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Mon, 03 Oct 2022 23:55:18 GMT
RUN set -eux; 	curl -fL -o redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Mon, 03 Oct 2022 23:56:03 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		default-libmysqlclient-dev 		freetds-dev 		gcc 		libpq-dev 		libsqlite3-dev 		make 		patch 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		gosu redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	gosu redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -v '^/usr/local/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Mon, 03 Oct 2022 23:56:04 GMT
VOLUME [/usr/src/redmine/files]
# Mon, 03 Oct 2022 23:56:05 GMT
COPY file:5ad924c6f87c91325ac6781766e5ad56444f0bea5780e13e8bed5000ee3cfc38 in / 
# Mon, 03 Oct 2022 23:56:05 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Mon, 03 Oct 2022 23:56:06 GMT
EXPOSE 3000
# Mon, 03 Oct 2022 23:56:07 GMT
CMD ["rails" "server" "-b" "0.0.0.0"]
```
...
-	Layers:
	...
	-	`sha256:90810b52a6ba9d5b2fd994b172573fffaad35ea069cf5611e37d9a9fc9014da6`  
		...
		Size: 127.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:492aa4f314632e38b97aff31b6f51fdb0ee60b984ca1a5257268de9ba65fca1c`  
		Last Modified: Tue, 04 Oct 2022 00:01:19 GMT  
		Size: 3.1 MB (3066732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:365948cc85ff7f39b63731f853e7e819695d3c9b75cf309760f561ac3f71c399`  
		Last Modified: Tue, 04 Oct 2022 00:01:23 GMT  
		Size: 45.1 MB (45140830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48fba2be9db28dd0976a548ee2b334a11493e4760f304e9f20d72a427ac00a14`  
		Last Modified: Tue, 04 Oct 2022 00:01:18 GMT  
...
```console
$ docker pull redmine@sha256:77363cd974e771984a05550bd6f1d8b3c0bad54187b39291f4938dfa18e74420
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.4 MB (225358949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0824588b9b0544744829882bc570fc5e0a36412418909af9504dcf7bb14abced`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Mon, 03 Oct 2022 23:25:04 GMT
ENV REDMINE_VERSION=4.2.8
# Mon, 03 Oct 2022 23:25:05 GMT
ENV REDMINE_DOWNLOAD_URL=https://www.redmine.org/releases/redmine-4.2.8.tar.gz
# Mon, 03 Oct 2022 23:25:05 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Mon, 03 Oct 2022 23:25:10 GMT
RUN set -eux; 	curl -fL -o redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Mon, 03 Oct 2022 23:28:54 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		default-libmysqlclient-dev 		freetds-dev 		gcc 		libpq-dev 		libsqlite3-dev 		make 		patch 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		gosu redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	gosu redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -v '^/usr/local/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Mon, 03 Oct 2022 23:28:56 GMT
VOLUME [/usr/src/redmine/files]
# Mon, 03 Oct 2022 23:28:56 GMT
COPY file:5ad924c6f87c91325ac6781766e5ad56444f0bea5780e13e8bed5000ee3cfc38 in / 
# Mon, 03 Oct 2022 23:28:57 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Mon, 03 Oct 2022 23:28:57 GMT
EXPOSE 3000
# Mon, 03 Oct 2022 23:28:57 GMT
...
-	Layers:
	...
	-	`sha256:9e3a50214c9e5dff99dfb733aad28aebf228575c96fbdce80e1e8dea59186d37`  
		...
		Size: 158.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a68523414a5704f0aafdda57568f7be62c61810c14769ade99d81c0c9c24d355`  
		Last Modified: Mon, 03 Oct 2022 23:36:49 GMT  
		Size: 3.1 MB (3066578 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bdb1c0eacd2c60edd48f56117915f373fafca3403a68d7bbe964acdded07bac`  
		Last Modified: Mon, 03 Oct 2022 23:36:56 GMT  
		Size: 54.0 MB (54002069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e50003e4cd4ddf73f0b462144c50ab3629fa5202740773ac9410d9f7831c95`  
		Last Modified: Mon, 03 Oct 2022 23:36:47 GMT  
		Size: 1.9 KB (1858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull redmine@sha256:60d6dd956159b318dcfdf7f7ebed19ecf851e0a210eab8550383f428f909a176
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.7 MB (208711065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c93f7ed37f8c71905888c0199ad3d6fd573994ff8b4481695c05644c0c80bbe8`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["rails","server","-b","0.0.0.0"]`
...
RUN set -eux; 	[ ! -d "$HOME" ]; 	mkdir -p "$HOME"; 	chown redmine:redmine "$HOME"; 	chmod 1777 "$HOME"
# Mon, 03 Oct 2022 22:50:40 GMT
ENV REDMINE_VERSION=4.2.8
# Mon, 03 Oct 2022 22:50:40 GMT
ENV REDMINE_DOWNLOAD_URL=https://www.redmine.org/releases/redmine-4.2.8.tar.gz
# Mon, 03 Oct 2022 22:50:40 GMT
ENV REDMINE_DOWNLOAD_SHA256=0b431c052d8fd36b93201dafaf3615cdb8d03460efcf2400e7d32662b2ab6272
# Mon, 03 Oct 2022 22:50:43 GMT
RUN set -eux; 	curl -fL -o redmine.tar.gz "$REDMINE_DOWNLOAD_URL"; 	echo "$REDMINE_DOWNLOAD_SHA256 *redmine.tar.gz" | sha256sum -c -; 	tar -xf redmine.tar.gz --strip-components=1; 	rm redmine.tar.gz files/delete.me log/delete.me; 	mkdir -p log public/plugin_assets sqlite tmp/pdf tmp/pids; 	chown -R redmine:redmine ./; 	echo 'config.logger = Logger.new(STDOUT)' > config/additional_environment.rb; 	chmod -R ugo=rwX config db sqlite; 	find log tmp -type d -exec chmod 1777 '{}' +
# Mon, 03 Oct 2022 22:52:07 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		default-libmysqlclient-dev 		freetds-dev 		gcc 		libpq-dev 		libsqlite3-dev 		make 		patch 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		gosu redmine bundle config --local without 'development test'; 	puma="$(grep -E "^[[:space:]]*gem [:'\"]puma['\",[:space:]].*\$" Gemfile)"; 	{ echo; echo "$puma"; } | sed -re 's/^[[:space:]]+//' >> Gemfile; 	echo '# the following entries only exist to force `bundle install` to pre-install all database adapter dependencies -- they can be safely removed/ignored' > ./config/database.yml; 	for adapter in mysql2 postgresql sqlserver sqlite3; do 		echo "$adapter:" >> ./config/database.yml; 		echo "  adapter: $adapter" >> ./config/database.yml; 	done; 	gosu redmine bundle install --jobs "$(nproc)"; 	rm ./config/database.yml; 	chmod -R ugo=rwX Gemfile.lock "$GEM_HOME"; 	rm -rf ~redmine/.bundle; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -v '^/usr/local/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Mon, 03 Oct 2022 22:52:08 GMT
VOLUME [/usr/src/redmine/files]
# Mon, 03 Oct 2022 22:52:08 GMT
COPY file:5ad924c6f87c91325ac6781766e5ad56444f0bea5780e13e8bed5000ee3cfc38 in / 
# Mon, 03 Oct 2022 22:52:09 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Mon, 03 Oct 2022 22:52:09 GMT
EXPOSE 3000
# Mon, 03 Oct 2022 22:52:09 GMT
...
-	Layers:
	...
	-	`sha256:e4f1b3af4e46190523220be893b4f1d6b806ecf4ff5a0fe232f4469faaa3e56e`  
		...
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18904f06bf333806d4ae32eda449d77b41752b3dc2236b19f97a4dffa633c235`  
		Last Modified: Mon, 03 Oct 2022 22:56:22 GMT  
		Size: 3.1 MB (3066579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a529ba9bce97fa07b7ba50bb0a308555370f4138a19af19856ab9dd37420d064`  
		Last Modified: Mon, 03 Oct 2022 22:56:26 GMT  
		Size: 53.3 MB (53349170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db3f34265668bd121cf3899c93d59a447d439966a337ada0d79ec132697eab9a`  
		Last Modified: Mon, 03 Oct 2022 22:56:21 GMT  
