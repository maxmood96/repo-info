...
```console
$ docker pull redmine@sha256:a3d24d190593bf92e9df58c45c36e434ed6591694acf3de1f3826a5b90048c7b
```
...
### `redmine:6.1.1-alpine3.22` - linux; amd64
...
### `redmine:6.1.1-alpine3.22` - unknown; unknown
...
### `redmine:6.1.1-alpine3.22` - linux; arm variant v7
...
### `redmine:6.1.1-alpine3.22` - linux; arm64 variant v8
...
### `redmine:6.1.1-alpine3.22` - linux; 386
...
### `redmine:6.1.1-alpine3.22` - linux; ppc64le
...
### `redmine:6.1.1-alpine3.22` - linux; s390x
