...
```console
$ docker pull redmine@sha256:38a3c317620d663adc873b38b2524d7fe39cb91c266fc22c8c8cdc79ffbe2f29
```
...
### `redmine:5.1.8-alpine3.21` - linux; amd64
...
### `redmine:5.1.8-alpine3.21` - unknown; unknown
...
### `redmine:5.1.8-alpine3.21` - linux; arm variant v6
...
### `redmine:5.1.8-alpine3.21` - linux; arm variant v7
...
### `redmine:5.1.8-alpine3.21` - linux; arm64 variant v8
...
### `redmine:5.1.8-alpine3.21` - linux; 386
...
### `redmine:5.1.8-alpine3.21` - linux; ppc64le
...
### `redmine:5.1.8-alpine3.21` - linux; s390x
