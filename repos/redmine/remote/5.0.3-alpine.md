...
```console
$ docker pull redmine@sha256:408aa5c9e56d5968df6bdbbb7663d9ca80632e2adaea38024f29de2d3d4fcdd3
```
...
### `redmine:5.0.3-alpine` - linux; amd64
...
### `redmine:5.0.3-alpine` - linux; 386
...
### `redmine:5.0.3-alpine` - linux; ppc64le
