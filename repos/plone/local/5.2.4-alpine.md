...
- Created: `2021-10-06T02:12:56.03983422Z`
- Virtual Size: ~ 498.23 Mb  
...
```console
postgresql-client-13.4-r0 description:
PostgreSQL client

postgresql-client-13.4-r0 webpage:
https://www.postgresql.org/

postgresql-client-13.4-r0 installed size:
2232 KiB

postgresql-client-13.4-r0 license:
PostgreSQL
