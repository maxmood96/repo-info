...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/almalinux-release-8.5-4.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/audit-3.0-0.17.20191104git1c2f876.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/bash-4.4.20-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/crypto-policies-20210617-1.gitc776d3e.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/curl-7.61.1-22.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/elfutils-0.185-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/gawk-4.2.1-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/glib2-2.56.4-156.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/glibc-2.28-164.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/gnutls-3.6.16-4.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/gpgme-1.13.1-9.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/texinfo-6.5-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/json-c-0.13.1-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libarchive-3.3.3-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/util-linux-2.32.1-28.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libcap-2.26-5.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/e2fsprogs-1.45.6-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libdnf-0.63.0-3.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libffi-3.1-22.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/gcc-8.5.0-4.el8_5.alma.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libgcrypt-1.8.5-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libksba-1.3.5-7.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/librepo-1.14.0-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libsolv-0.7.19-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libssh-0.9.4-3.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libxml2-2.9.7-9.el8_4.2.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/openssl-1.1.1k-5.el8_5.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/rpm-4.14.3-19.el8_5.2.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/sed-4.5-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/systemd-239-51.el8_5.3.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/tzdata-2021e-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/xz-5.2.4-3.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/zlib-1.2.11-17.el8.src.rpm
```
