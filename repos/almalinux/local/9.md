...
- Created: `2026-05-04T20:41:38.152624952Z`
...
### `rpm` package: `systemd-252-55.el9_7.8.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-55.el9_7.8.alma.1
...
### `rpm` package: `systemd-pam-252-55.el9_7.8.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-55.el9_7.8.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.8.alma.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-55.el9_7.8.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-55.el9_7.8.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.8.alma.1.src.rpm
```
