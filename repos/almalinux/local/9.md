...
- Created: `2026-01-05T18:21:37.940019691Z`
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python3.9-3.9.25-2.el9_7.src.rpm
```
...
### `rpm` package: `systemd-252-55.el9_7.7.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-55.el9_7.7.alma.1
...
### `rpm` package: `systemd-pam-252-55.el9_7.7.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-55.el9_7.7.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.7.alma.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-55.el9_7.7.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-55.el9_7.7.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.7.alma.1.src.rpm
```
