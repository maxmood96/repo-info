...
- Created: `2025-11-20T18:00:55.697796035Z`
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/binutils-2.35.2-67.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/curl-7.76.1-34.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/expat-2.5.0-5.el9_6.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/glibc-2.34-231.el9_7.2.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gnutls-3.8.3-9.el9.src.rpm
```
...
### `rpm` package: `libdnf-0.69.0-16.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-16.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-16.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python3.9-3.9.23-2.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-16.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-16.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-16.el9.alma.1.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-16.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-16.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-16.el9.alma.1.src.rpm
```
...
### `rpm` package: `systemd-252-55.el9_7.2.alma.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-55.el9_7.2.alma.2
...
### `rpm` package: `systemd-pam-252-55.el9_7.2.alma.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-55.el9_7.2.alma.2
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.2.alma.2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-55.el9_7.2.alma.2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-55.el9_7.2.alma.2.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.2.alma.2.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/tar-1.34-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/vim-8.2.2637-23.el9_7.src.rpm
```
