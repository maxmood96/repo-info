...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/binutils-2.35.2-43.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/cracklib-2.9.6-27.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/dbus-1.12.20-8.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/dbus-broker-28-7.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/elfutils-0.190-2.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/expat-2.5.0-2.el9_4.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/findutils-4.8.0-6.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/gzip-1.12-1.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/hostname-3.23-6.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/ima-evm-utils-1.4-4.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/iputils-20210202-9.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/kmod-28-9.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libcomps-0.1.18-1.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libdb-5.3.28-53.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libeconf-0.4.1-3.el9_2.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libpwquality-1.4.4-8.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libseccomp-2.5.2-2.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libutempter-1.2.1-6.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-3.0.7-27.el9
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/pam-1.5.1-19.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-8.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-8.el9.alma.1
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libdnf-0.69.0-8.el9.alma.1.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-8.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-8.el9.alma.1
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/libdnf-0.69.0-8.el9.alma.1.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/python-pip-21.2.3-8.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/python-setuptools-53.0.0-12.el9.src.rpm
```
...
### `rpm` package: `systemd-252-32.el9_4.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-32.el9_4.alma.1
...
### `rpm` package: `systemd-pam-252-32.el9_4.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-32.el9_4.alma.1
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/systemd-252-32.el9_4.alma.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-32.el9_4.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-32.el9_4.alma.1.noarch
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/systemd-252-32.el9_4.alma.1.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/tar-1.34-6.el9_1.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/tpm2-tss-3.2.2-2.el9.src.rpm
```
...
http://repo.almalinux.org/vault/9.4/BaseOS/Source/Packages/vim-8.2.2637-20.el9_1.src.rpm
```
