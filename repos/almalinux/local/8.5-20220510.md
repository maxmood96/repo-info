...
- Created: `2022-05-11T00:20:11.940264434Z`
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/ca-certificates-2021.2.50-80.0.el8_4.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/cracklib-2.9.6-15.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/curl-7.61.1-22.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/findutils-4.6.0-20.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/gdbm-1.18-1.el8.src.rpm
```
...
### `rpm` package: `glibc-2.28-164.el8_5.3.x86_64`
...
### `rpm` package: `glibc-common-2.28-164.el8_5.3.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and LGPLv2+ with exceptions and GPLv2+ and GPLv2+ with exceptions and BSD and Inner-Net and ISC and Public Domain and GFDL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `glibc-minimal-langpack-2.28-164.el8_5.3.x86_64`
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/gnupg2-2.2.20-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/gnutls-3.6.16-4.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/gzip-1.9-13.el8_5.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/hostname-3.20-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/ima-evm-utils-1.3.2-12.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/less-530-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libgcrypt-1.8.5-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libksba-1.3.5-7.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libnsl2-1.2.0-2.20180605git4a062cf.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libpwquality-1.4.4-3.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libreport-2.9.5-15.el8.alma.1.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libutempter-1.1.6-14.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/openssl-1.1.1k-6.el8_5.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/pcre2-10.32-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/python-setuptools-39.2.0-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/sqlite-3.26.0-15.el8.src.rpm
```

### `rpm` package: `systemd-239-51.el8_5.5.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and MIT and GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `systemd-libs-239-51.el8_5.5.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `systemd-pam-239-51.el8_5.5.x86_64`
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/tar-1.30-5.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/tpm2-tss-2.3.2-4.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/tzdata-2022a-1.el8.src.rpm
```
...
### `rpm` package: `vim-minimal-8.0.1763-16.el8_5.13.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.0.1763-16.el8_5.13
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/vim-8.0.1763-16.el8_5.13.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/xz-5.2.4-3.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/zlib-1.2.11-18.el8_5.src.rpm
```
