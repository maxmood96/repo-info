...
- Created: `2026-05-11T16:41:42.870997949Z`
...
### `rpm` package: `almalinux-gpg-keys-9.7-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url almalinux-gpg-keys-9.7-1.el9
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/almalinux-release-9.7-1.el9.src.rpm
```

### `rpm` package: `almalinux-release-9.7-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url almalinux-release-9.7-1.el9
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/almalinux-release-9.7-1.el9.src.rpm
```

### `rpm` package: `almalinux-repos-9.7-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url almalinux-repos-9.7-1.el9
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/almalinux-release-9.7-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/chkconfig-1.24-2.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/attr-2.5.1-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/audit-3.1.5-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/basesystem-11-13.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/bash-5.1.8-9.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/binutils-2.35.2-67.el9_7.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/coreutils-8.32-39.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/cracklib-2.9.6-27.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/crypto-policies-20250905-1.git377cc42.el9_7.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/curl-7.76.1-35.el9_7.3.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/cyrus-sasl-2.1.27-22.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dbus-1.12.20-8.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dbus-broker-28-7.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-31.el9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-31.el9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dnf-4.14.0-31.el9.alma.1.src.rpm
```

### `rpm` package: `dnf-data-4.14.0-31.el9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.14.0-31.el9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dnf-4.14.0-31.el9.alma.1.src.rpm
```

### `rpm` package: `elfutils-debuginfod-client-0.193-1.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-debuginfod-client-0.193-1.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/elfutils-0.193-1.el9.alma.1.src.rpm
```

### `rpm` package: `elfutils-default-yama-scope-0.193-1.el9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.193-1.el9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/elfutils-0.193-1.el9.alma.1.src.rpm
```

### `rpm` package: `elfutils-libelf-0.193-1.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libelf-0.193-1.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/elfutils-0.193-1.el9.alma.1.src.rpm
```

### `rpm` package: `elfutils-libs-0.193-1.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.193-1.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/elfutils-0.193-1.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/expat-2.5.0-5.el9_7.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/file-5.39-16.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gawk-5.1.0-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/glibc-2.34-231.el9_7.10.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gnutls-3.8.3-10.el9_7.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gpgme-1.15.1-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/grep-3.6-5.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gzip-1.12-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/hostname-3.23-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/ima-evm-utils-1.6.2-2.el9.src.rpm
```

### `rpm` package: `iputils-20210202-15.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-15.el9_7
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/iputils-20210202-15.el9_7.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/json-c-0.14-11.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/kmod-28-11.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/less-590-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libassuan-2.5.5-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libcap-ng-0.8.2-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/e2fsprogs-1.46.5-8.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libcomps-0.1.18-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdb-5.3.28-57.el9_6.src.rpm
```

### `rpm` package: `libdnf-0.69.0-17.el9_7.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-17.el9_7.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-17.el9_7.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libeconf-0.4.1-4.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libevent-2.1.12-8.el9_4.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libffi-3.4.2-8.el9.src.rpm
```

### `rpm` package: `libgcc-11.5.0-11.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-11.5.0-11.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gcc-11.5.0-11.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libgcrypt-1.10.0-11.el9.src.rpm
```

### `rpm` package: `libgomp-11.5.0-11.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-11.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gcc-11.5.0-11.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libgpg-error-1.42-5.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libidn2-2.3.0-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libksba-1.5.1-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libmodulemd-2.13.0-2.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libpwquality-1.4.4-8.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/librepo-1.14.5-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libreport-2.15.2-6.el9.alma.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libseccomp-2.5.2-2.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libselinux-3.6-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libsemanage-3.6-5.el9_6.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libsepol-3.6-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libsigsegv-2.13-4.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libsolv-0.7.24-3.el9.src.rpm
```

### `rpm` package: `libstdc++-11.5.0-11.el9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-11.5.0-11.el9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/gcc-11.5.0-11.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libtasn1-4.16.0-9.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libtool-2.4.6-46.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libunistring-0.9.10-15.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libutempter-1.2.1-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libverto-0.3.2-3.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libyaml-0.2.5-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/zstd-1.5.5-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/lua-5.4.4-4.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/lz4-1.9.3-5.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/mpfr-4.1.0-7.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/ncurses-6.2-12.20210508.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/nettle-3.10.1-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/npth-1.6-8.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/p11-kit-0.25.3-3.el9_5.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/pam-1.5.1-26.el9_6.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/pcre-8.44-4.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/pcre2-10.40-6.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/popt-1.18-8.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python3.9-3.9.25-3.el9_7.3.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python-dateutil-2.9.0.post0-1.el9_7.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dbus-python-1.2.18-2.el9.src.rpm
```

### `rpm` package: `python3-dnf-4.14.0-31.el9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-31.el9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dnf-4.14.0-31.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dnf-plugins-core-4.3.0-24.el9_7.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-17.el9_7.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-17.el9_7.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-17.el9_7.alma.1.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-17.el9_7.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-17.el9_7.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/libdnf-0.69.0-17.el9_7.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python-pip-21.3.1-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/rpm-4.16.1.3-39.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python-setuptools-53.0.0-15.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python-six-1.15.0-9.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python-systemd-234-19.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/readline-8.1-4.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/rootfiles-8.1-35.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/sed-4.8-9.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/setup-2.13.7-10.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/shadow-utils-4.9-15.el9.src.rpm
```
...
### `rpm` package: `systemd-252-55.el9_7.9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-55.el9_7.9.alma.1
...
### `rpm` package: `systemd-pam-252-55.el9_7.9.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-55.el9_7.9.alma.1
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.9.alma.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-55.el9_7.9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-55.el9_7.9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/systemd-252-55.el9_7.9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/tar-1.34-9.el9_7.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/tpm2-tss-3.2.3-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/tzdata-2026a-1.el9.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/vim-8.2.2637-23.el9_7.3.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/xz-5.2.5-8.el9_0.src.rpm
```
...
### `rpm` package: `yum-4.14.0-31.el9.alma.1.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-31.el9.alma.1.noarch
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/dnf-4.14.0-31.el9.alma.1.src.rpm
```
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/zlib-1.2.11-40.el9.src.rpm
```
