...
- Created: `2022-11-01T21:20:06.495132424Z`
- Virtual Size: ~ 190.56 Mb  
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/binutils-2.30-113.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/cryptsetup-2.3.7-2.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/lvm2-2.03.14-3.el8_6.2.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/dnf-4.7.0-8.el8.alma.src.rpm
```
...
### `rpm` package: `expat-2.2.5-8.el8_6.3.x86_64`
...
```console
$ dnf --quiet download --source --url expat-2.2.5-8.el8_6.3
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/expat-2.2.5-8.el8_6.3.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/iputils-20180629-9.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/kmod-25-19.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libcomps-0.1.18-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libseccomp-2.5.2-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libsemanage-2.9-9.el8_6.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/libtirpc-1.1.4-6.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/pam-1.3.1-16.el8_6.1.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/python3-3.6.8-47.el8_6.alma.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/python-pip-9.0.3-22.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/shadow-utils-4.6-16.el8.src.rpm
```
...
### `rpm` package: `systemd-239-58.el8_6.8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-58.el8_6.8
...
### `rpm` package: `systemd-pam-239-58.el8_6.8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-58.el8_6.8
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/systemd-239-58.el8_6.8.src.rpm
```
...
http://repo.almalinux.org/vault/8.6/BaseOS/Source/Packages/vim-8.0.1763-19.el8_6.4.src.rpm
```
