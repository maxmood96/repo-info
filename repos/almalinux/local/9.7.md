...
- Created: `2026-04-28T00:02:40.40229563Z`
...
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/python3.9-3.9.25-3.el9_7.2.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-23.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.el9_7.2
http://vault.almalinux.org/9.7/BaseOS/Source/Packages/vim-8.2.2637-23.el9_7.2.src.rpm
```
