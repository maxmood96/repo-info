...
- Created: `2026-01-29T18:13:28.392879321Z`
- Virtual Size: ~ 93.54 Mb  
...
### `rpm` package: `almalinux-release-8.10-1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url almalinux-release-8.10-1.el8
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/brotli-1.0.6-3.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url bzip2-libs-1.0.6-28.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/bzip2-1.0.6-28.el8_10.src.rpm
```

### `rpm` package: `ca-certificates-2025.2.80_v9.0.304-80.2.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url ca-certificates-2025.2.80_v9.0.304-80.2.el8_10.noarch
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/ca-certificates-2025.2.80_v9.0.304-80.2.el8_10.src.rpm
```
...
### `rpm` package: `coreutils-single-8.30-16.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.30-16.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/coreutils-8.30-16.el8_10.src.rpm
```
...
### `rpm` package: `curl-7.61.1-34.el8_10.9.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.61.1-34.el8_10.9
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/curl-7.61.1-34.el8_10.9.src.rpm
```
...
### `rpm` package: `file-libs-5.33-27.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url file-libs-5.33-27.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/file-5.33-27.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/filesystem-3.8-6.el8.src.rpm
```
...
### `rpm` package: `glibc-2.28-251.el8_10.27.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-251.el8_10.27
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/glibc-2.28-251.el8_10.27.src.rpm
```

### `rpm` package: `glibc-common-2.28-251.el8_10.27.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-251.el8_10.27
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/glibc-2.28-251.el8_10.27.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-251.el8_10.27.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-251.el8_10.27
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/glibc-2.28-251.el8_10.27.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/gmp-6.1.2-11.el8.src.rpm
```

### `rpm` package: `gnupg2-2.2.20-4.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url gnupg2-2.2.20-4.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/gnupg2-2.2.20-4.el8_10.src.rpm
```

### `rpm` package: `gnutls-3.6.16-8.el8_10.4.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.6.16-8.el8_10.4
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/gnutls-3.6.16-8.el8_10.4.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/gobject-introspection-1.56.1-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/gpgme-1.13.1-12.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/grep-3.1-6.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/texinfo-6.5-7.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/json-c-0.13.1-3.el8.src.rpm
```
...
### `rpm` package: `krb5-libs-1.18.2-32.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-32.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/krb5-1.18.2-32.el8_10.src.rpm
```
...
### `rpm` package: `libblkid-2.32.1-47.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libblkid-2.32.1-47.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/util-linux-2.32.1-47.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libcap-2.48-6.el8_9.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libcap-ng-0.7.11-1.el8.src.rpm
```

### `rpm` package: `libcom_err-1.45.6-7.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libcom_err-1.45.6-7.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/e2fsprogs-1.45.6-7.el8_10.src.rpm
```

### `rpm` package: `libcurl-7.61.1-34.el8_10.9.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.61.1-34.el8_10.9
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/curl-7.61.1-34.el8_10.9.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libdb-5.3.28-42.el8_4.src.rpm
```
...
### `rpm` package: `libdnf-0.63.0-21.el8_10.alma.1.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-21.el8_10.alma.1
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libdnf-0.63.0-21.el8_10.alma.1.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libgpg-error-1.31-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libidn2-2.2.0-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libksba-1.3.5-9.el8_7.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libmodulemd-2.13.0-1.el8.src.rpm
```

### `rpm` package: `libmount-2.32.1-47.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libmount-2.32.1-47.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/util-linux-2.32.1-47.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libpeas-1.22.0-6.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libpsl-0.20.2-6.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/librepo-1.14.2-5.el8.src.rpm
```

### `rpm` package: `libselinux-2.9-10.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-2.9-10.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libselinux-2.9-10.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libsepol-2.9-3.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libsigsegv-2.11-5.el8.src.rpm
```

### `rpm` package: `libsmartcols-2.32.1-47.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libsmartcols-2.32.1-47.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/util-linux-2.32.1-47.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libssh-0.9.6-16.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libssh-0.9.6-16.el8_10.src.rpm
```

### `rpm` package: `libssh-config-0.9.6-16.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url libssh-config-0.9.6-16.el8_10.noarch
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libssh-0.9.6-16.el8_10.src.rpm
```
...
### `rpm` package: `libuuid-2.32.1-47.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libuuid-2.32.1-47.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/util-linux-2.32.1-47.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libverto-0.3.2-2.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/libyaml-0.1.7-5.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/zstd-1.4.4-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/microdnf-3.8.0-2.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/mpfr-3.1.6-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/ncurses-6.1-10.20180224.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/nettle-3.4.1-7.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/npth-1.5-4.el8.src.rpm
```

### `rpm` package: `openldap-2.4.46-21.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url openldap-2.4.46-21.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/openldap-2.4.46-21.el8_10.src.rpm
```

### `rpm` package: `openssl-libs-1.1.1k-14.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-1.1.1k-14.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/openssl-1.1.1k-14.el8_10.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/p11-kit-0.23.22-2.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/pcre-8.42-6.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/pcre2-10.32-3.el8_6.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/popt-1.18-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/publicsuffix-list-20180723-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/readline-7.0-10.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/rootfiles-8.1-22.el8.src.rpm
```

### `rpm` package: `rpm-4.14.3-32.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.14.3-32.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/rpm-4.14.3-32.el8_10.src.rpm
```

### `rpm` package: `rpm-libs-4.14.3-32.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.14.3-32.el8_10
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/rpm-4.14.3-32.el8_10.src.rpm
```
...
### `rpm` package: `systemd-libs-239-82.el8_10.13.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.el8_10.13
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/systemd-239-82.el8_10.13.src.rpm
```

### `rpm` package: `tzdata-2025c-1.el8.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2025c-1.el8.noarch
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/tzdata-2025c-1.el8.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/xz-5.2.4-4.el8_6.src.rpm
```
...
http://vault.almalinux.org/8.10/BaseOS/Source/Packages/zlib-1.2.11-25.el8.src.rpm
```
