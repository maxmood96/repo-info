...
- Created: `2024-05-23T19:32:12.578468876Z`
- Virtual Size: ~ 321.13 Mb  
...
```console
openjdk17-jre-headless-17.0.10_p7-r0 description:
Oracle OpenJDK 17 (JRE headless)

openjdk17-jre-headless-17.0.10_p7-r0 webpage:
https://github.com/openjdk/jdk17u

openjdk17-jre-headless-17.0.10_p7-r0 installed size:
171 MiB

openjdk17-jre-headless-17.0.10_p7-r0 license:
