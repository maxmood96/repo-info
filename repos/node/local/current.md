...
- Created: `2026-02-24T21:18:18.692061712Z`
...
### `dpkg` source package: `gdk-pixbuf=2.42.10+dfsg-1+deb12u3`

Binary Packages:

- `gir1.2-gdkpixbuf-2.0:amd64=2.42.10+dfsg-1+deb12u3`
- `libgdk-pixbuf-2.0-0:amd64=2.42.10+dfsg-1+deb12u3`
- `libgdk-pixbuf-2.0-dev:amd64=2.42.10+dfsg-1+deb12u3`
...
```console
$ apt-get source -qq --print-uris gdk-pixbuf=2.42.10+dfsg-1+deb12u3
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.10%2bdfsg-1%2bdeb12u3.dsc' gdk-pixbuf_2.42.10+dfsg-1+deb12u3.dsc 3210 SHA256:810ef1d90b134ddb3f39c20a128f31fd5cb0d8d8697996d8f3bfe5e8f4de0350
...
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.10%2bdfsg-1%2bdeb12u3.debian.tar.xz' gdk-pixbuf_2.42.10+dfsg-1+deb12u3.debian.tar.xz 23752 SHA256:4c7342c8790cee4e6f1007e6772055f7df1c89294d9a1b2ef50cfc8f53f06767
```

Other potentially useful URLs:

- https://sources.debian.net/src/gdk-pixbuf/2.42.10+dfsg-1+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/gdk-pixbuf/2.42.10+dfsg-1+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gdk-pixbuf/2.42.10+dfsg-1+deb12u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `glib2.0=2.74.6-2+deb12u8`
...
- `libglib2.0-dev:amd64=2.74.6-2+deb12u8`
...
```console
$ apt-get source -qq --print-uris glib2.0=2.74.6-2+deb12u8
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.74.6-2%2bdeb12u8.dsc' glib2.0_2.74.6-2+deb12u8.dsc 3669 SHA256:335a778ee3ff24479f11041b1cbb4f23863f72f823d5d88da6ff5374b398890c
...
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.74.6-2%2bdeb12u8.debian.tar.xz' glib2.0_2.74.6-2+deb12u8.debian.tar.xz 151904 SHA256:d1230f82328031e99769d8ec233872ba364cdeffa9ff6b2f83b86277f39c949f
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.74.6-2+deb12u8/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.74.6-2+deb12u8/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.74.6-2+deb12u8/ (for access to the source package after it no longer exists in the archive)
...
- `libmagickcore-6-arch-config:amd64=8:6.9.11.60+dfsg-1.6+deb12u6`
- `libmagickcore-6-headers=8:6.9.11.60+dfsg-1.6+deb12u6`
- `libmagickcore-6.q16-6:amd64=8:6.9.11.60+dfsg-1.6+deb12u6`
- `libmagickcore-6.q16-6-extra:amd64=8:6.9.11.60+dfsg-1.6+deb12u6`
- `libmagickcore-6.q16-dev:amd64=8:6.9.11.60+dfsg-1.6+deb12u6`
...
- `libmagickwand-6.q16-dev:amd64=8:6.9.11.60+dfsg-1.6+deb12u6`
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.9.11.60+dfsg-1.6+deb12u6
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.11.60%2bdfsg-1.6%2bdeb12u6.dsc' imagemagick_6.9.11.60+dfsg-1.6+deb12u6.dsc 5106 SHA256:799fed83cad9abf34645cc9390620c6fe4b01a00544e3f52416a0e2dbdef8b26
...
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.11.60%2bdfsg-1.6%2bdeb12u6.debian.tar.xz' imagemagick_6.9.11.60+dfsg-1.6+deb12u6.debian.tar.xz 279512 SHA256:7519571167b790528dcee982ba97f5e2ac0c685a7b63215e47c72fb673f87920
```

Other potentially useful URLs:

- https://sources.debian.net/src/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u6/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.9.11.60+dfsg-1.6+deb12u6/ (for access to the source package after it no longer exists in the archive)
...
- `libxml2-dev:amd64=2.9.14+dfsg-1.3~deb12u5`
...
'http://deb.debian.org/debian/pool/main/libx/libxslt/libxslt_1.1.35-1%2bdeb12u3.dsc' libxslt_1.1.35-1+deb12u3.dsc 2187 SHA256:f60527764dbce95161371132dcd6acc910661aa56b1f5cb4870b86c372f12391
...
'http://deb.debian.org/debian/pool/main/libx/libxslt/libxslt_1.1.35-1%2bdeb12u3.debian.tar.xz' libxslt_1.1.35-1+deb12u3.debian.tar.xz 29864 SHA256:837cfd5b4d57557523c748fec1bd98554f65a369a43bded82e42a00ee095abbe
```
...
### `dpkg` source package: `linux=6.1.162-1`
...
```console
$ apt-get source -qq --print-uris linux=6.1.162-1
'http://deb.debian.org/debian-security/pool/updates/main/l/linux/linux_6.1.162-1.dsc' linux_6.1.162-1.dsc 399396 SHA256:6a96b1a6eb221d1b1879af5e0d2669b99c9b96386f639b28ae82f0737f5da52a
'http://deb.debian.org/debian-security/pool/updates/main/l/linux/linux_6.1.162.orig.tar.xz' linux_6.1.162.orig.tar.xz 137860740 SHA256:6dc3e1f5ccd1c5da226d7fd42670e2e471398ec1bd5a8848292c491a672c6ad5
'http://deb.debian.org/debian-security/pool/updates/main/l/linux/linux_6.1.162-1.debian.tar.xz' linux_6.1.162-1.debian.tar.xz 1812632 SHA256:da60fd225c47642bdf348f8be30b2aad6b71540dd74a70ae97e23762e31f2d1d
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/6.1.162-1/ (for browsing the source)
- https://sources.debian.net/src/linux/6.1.162-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/6.1.162-1/ (for access to the source package after it no longer exists in the archive)
...
- `libssl-dev:amd64=3.0.18-1~deb12u2`
...
### `dpkg` source package: `postgresql-15=15.16-0+deb12u1`
...
'http://deb.debian.org/debian/pool/main/t/tiff/tiff_4.5.0-6%2bdeb12u3.dsc' tiff_4.5.0-6+deb12u3.dsc 2287 SHA256:078ea18a8b7683291a4586566281e8cbd4926c72340bc2691dd20fcff59e40a7
...
'http://deb.debian.org/debian/pool/main/t/tiff/tiff_4.5.0-6%2bdeb12u3.debian.tar.xz' tiff_4.5.0-6+deb12u3.debian.tar.xz 31356 SHA256:75c8500b9063edc916030e29bbdfc390a9d850d6806d3ec3ef08670d21467c96
```
