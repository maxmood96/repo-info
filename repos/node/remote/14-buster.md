...
```console
$ docker pull node@sha256:5fccd0c6b126b113b87c0554a1263eee321a27de0c67903f204735913a19fa20
```
...
```console
$ docker pull node@sha256:331b96aeaac9c2b34408656516a8b6f6f9ed9849c30e7679828e826e86fae332
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.2 MB (349217509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6ef78e097edae6a83f2c8a95e3637cac9a556bebe815e847d9b95ee9cd3180a`
...
# Tue, 09 Feb 2021 18:40:39 GMT
ENV NODE_VERSION=14.15.4
# Tue, 09 Feb 2021 18:40:46 GMT
...
-	Layers:
	...
	-	`sha256:c4e1a28a83dfcb6c819a088f65b21246efd3478cc0ccfbb9a1b7ae6706a87500`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74d17d37d8e8b8db9ce0fe38f29c0e8b7d96801f6a652edfd0af1b0f2e13ddd9`  
		Last Modified: Tue, 09 Feb 2021 18:51:10 GMT  
		Size: 34.5 MB (34518146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a41c3069efb50f3f5a66104dfe42cb5648640d2fbe36472c4a4900cd4e4fa9a`  
		Last Modified: Tue, 09 Feb 2021 18:51:01 GMT  
		Size: 2.3 MB (2308198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bde5284663c4d824960b8014b5d4d4f1d1c1e1f371d163e404130393112adba`  
		Last Modified: Tue, 09 Feb 2021 18:51:00 GMT  
		Size: 281.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:0215e690a34eb6f3436ed51bf16331a5904f197dc120da8dbe313e4f0297bca5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **372.5 MB (372493825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21ae1e7cf520f74130a5b4c166a52d977bc420ada57d5ae01bcd441873122262`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
ENV NODE_VERSION=14.15.4
# Tue, 09 Feb 2021 13:06:20 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     1C050899334244A8AF75E53792EF661D867B9DFA     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     A48C2BEE680E841632CD4E44F07496B3EB3C1762     108F52B48DB57BB0CC439B2997B01419BD92F80A     B9E2F5981AA6E0CD28160D9FF13993A75599653C   ; do     gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Tue, 09 Feb 2021 13:06:27 GMT
ENV YARN_VERSION=1.22.5
# Tue, 09 Feb 2021 13:06:38 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Tue, 09 Feb 2021 13:06:41 GMT
COPY file:238737301d47304174e4d24f4def935b29b3069c03c72ae8de97d94624382fce in /usr/local/bin/ 
# Tue, 09 Feb 2021 13:06:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 09 Feb 2021 13:06:49 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:0d44c0a7e792f08499b5c905dcab3eb82b1bcdc83880a168f8348d432507204b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5522d4515c246ebd0ea97f189bfc8aad65455cf1731a77b7817861b6db4fd1f`  
		Last Modified: Tue, 09 Feb 2021 13:38:00 GMT  
		Size: 36.4 MB (36411754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e408eae57365bfb43491c959b5744890acf78e117d8b246730d7ac50c30f91f`  
		Last Modified: Tue, 09 Feb 2021 13:37:52 GMT  
		Size: 2.3 MB (2308278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37395a474ffa8a5bc1358644701ac2d1446218928efbe9db5a1424622619780e`  
		Last Modified: Tue, 09 Feb 2021 13:37:51 GMT  
		Size: 282.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
