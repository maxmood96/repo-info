...
```console
$ docker pull node@sha256:fc3d6021cbf284bbd5af699cbddb30872111a2b7aa6f20170631ee7c1266cc8d
```
...
### `node:14.12.0-alpine3.10` - linux; amd64
...
### `node:14.12.0-alpine3.10` - linux; arm variant v6
...
### `node:14.12.0-alpine3.10` - linux; arm variant v7
...
### `node:14.12.0-alpine3.10` - linux; arm64 variant v8
...
### `node:14.12.0-alpine3.10` - linux; s390x
