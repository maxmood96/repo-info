...
```console
$ docker pull node@sha256:c39be8a03811d866e0f5e18fcd2065a914931a3c0830b29403017db3def59d91
```
...
### `node:20.15.0-alpine3.19` - linux; amd64
...
### `node:20.15.0-alpine3.19` - unknown; unknown
...
### `node:20.15.0-alpine3.19` - linux; arm variant v6
...
### `node:20.15.0-alpine3.19` - linux; arm64 variant v8
...
### `node:20.15.0-alpine3.19` - linux; ppc64le
...
### `node:20.15.0-alpine3.19` - linux; s390x
