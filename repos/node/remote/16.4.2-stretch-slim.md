...
### `node:16.4.2-stretch-slim` - linux; amd64
...
### `node:16.4.2-stretch-slim` - linux; arm variant v7
...
### `node:16.4.2-stretch-slim` - linux; arm64 variant v8
