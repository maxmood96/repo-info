...
```console
$ docker pull node@sha256:972ceee06f2b51148faa0d6d871b0979a4ebb7252c48e286a2c43444100d923d
```
...
### `node:22.23.0-trixie-slim` - linux; amd64
...
### `node:22.23.0-trixie-slim` - unknown; unknown
...
### `node:22.23.0-trixie-slim` - linux; arm64 variant v8
...
### `node:22.23.0-trixie-slim` - linux; ppc64le
