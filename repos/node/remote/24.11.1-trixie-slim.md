...
```console
$ docker pull node@sha256:d2af3ec2744b134cbbd7739f3b872e3961b9f5249963711d9b6b5ddc2876bb3e
```
...
### `node:24.11.1-trixie-slim` - linux; amd64
...
### `node:24.11.1-trixie-slim` - unknown; unknown
...
### `node:24.11.1-trixie-slim` - linux; arm64 variant v8
...
### `node:24.11.1-trixie-slim` - linux; ppc64le
