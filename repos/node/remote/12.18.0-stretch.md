...
```console
$ docker pull node@sha256:3cf7a8a06d031526df87d92a9fa0d832862333d615836a423ae36d1ca583ac3f
```
...
### `node:12.18.0-stretch` - linux; amd64
...
### `node:12.18.0-stretch` - linux; arm variant v7
...
### `node:12.18.0-stretch` - linux; arm64 variant v8
...
### `node:12.18.0-stretch` - linux; ppc64le
...
### `node:12.18.0-stretch` - linux; s390x
