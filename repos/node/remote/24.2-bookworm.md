...
### `node:24.2-bookworm` - linux; amd64
...
### `node:24.2-bookworm` - unknown; unknown
...
### `node:24.2-bookworm` - linux; arm64 variant v8
...
### `node:24.2-bookworm` - linux; ppc64le
...
### `node:24.2-bookworm` - linux; s390x
