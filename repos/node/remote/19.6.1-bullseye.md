...
```console
$ docker pull node@sha256:b5a8794bf6f62b5987b205ddca2c28040c08ebc4c8f277b342fb2f14fcd1e3ae
```
...
### `node:19.6.1-bullseye` - linux; amd64
...
### `node:19.6.1-bullseye` - linux; arm64 variant v8
...
### `node:19.6.1-bullseye` - linux; ppc64le
...
### `node:19.6.1-bullseye` - linux; s390x
