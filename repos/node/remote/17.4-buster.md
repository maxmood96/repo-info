...
```console
$ docker pull node@sha256:2acc93fe7799630ea6e33216a64933d3c8a94e845e95d56a340f203c9b31d39a
```
...
### `node:17.4-buster` - linux; arm variant v7
...
### `node:17.4-buster` - linux; arm64 variant v8
...
### `node:17.4-buster` - linux; ppc64le
