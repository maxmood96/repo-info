...
```console
$ docker pull node@sha256:0c4b1219e836193f8ff099c43a36cb6ebf1bfe4a9a391e9f9eca5b4c96fae5b3
```
...
### `node:24.11.1-bookworm` - linux; amd64
...
### `node:24.11.1-bookworm` - unknown; unknown
...
### `node:24.11.1-bookworm` - linux; arm64 variant v8
...
### `node:24.11.1-bookworm` - linux; ppc64le
