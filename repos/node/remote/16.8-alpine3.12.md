...
```console
$ docker pull node@sha256:57acda0eb1d2555a3daef7c67f60f991eec9e9fa36dbf2189dad1f236454b75e
```
...
### `node:16.8-alpine3.12` - linux; amd64
...
### `node:16.8-alpine3.12` - linux; arm variant v6
...
### `node:16.8-alpine3.12` - linux; arm variant v7
...
### `node:16.8-alpine3.12` - linux; arm64 variant v8
...
### `node:16.8-alpine3.12` - linux; ppc64le
