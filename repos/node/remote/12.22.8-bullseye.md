...
```console
$ docker pull node@sha256:a990590bafd0c4341361d49ad4fd3388b76811d62cd57d11c118561d1008c62a
```
...
### `node:12.22.8-bullseye` - linux; amd64
...
### `node:12.22.8-bullseye` - linux; arm variant v7
...
### `node:12.22.8-bullseye` - linux; arm64 variant v8
...
### `node:12.22.8-bullseye` - linux; s390x
