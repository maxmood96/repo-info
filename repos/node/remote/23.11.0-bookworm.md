...
```console
$ docker pull node@sha256:49d489f38031b4078ed348a5ec4ff52975a272c500eedbd30afc349fc830c093
```
...
### `node:23.11.0-bookworm` - linux; amd64
...
### `node:23.11.0-bookworm` - unknown; unknown
...
### `node:23.11.0-bookworm` - linux; arm variant v7
...
### `node:23.11.0-bookworm` - linux; ppc64le
...
### `node:23.11.0-bookworm` - linux; s390x
