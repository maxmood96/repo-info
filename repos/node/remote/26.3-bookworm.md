...
### `node:26.3-bookworm` - linux; amd64
...
### `node:26.3-bookworm` - unknown; unknown
...
### `node:26.3-bookworm` - linux; arm64 variant v8
...
### `node:26.3-bookworm` - linux; ppc64le
...
### `node:26.3-bookworm` - linux; s390x
