...
```console
$ docker pull node@sha256:5898cf83b437e8757d8790d9b1a70b798db83fd4c7a78a8f4053039c6c46c498
```
...
### `node:23.2.0-alpine` - linux; amd64
...
### `node:23.2.0-alpine` - unknown; unknown
...
### `node:23.2.0-alpine` - linux; arm variant v6
...
### `node:23.2.0-alpine` - linux; arm variant v7
...
### `node:23.2.0-alpine` - linux; arm64 variant v8
