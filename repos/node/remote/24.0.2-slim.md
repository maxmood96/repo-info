...
```console
$ docker pull node@sha256:e02bf049e658a07152a45a9f78e2e082abfe475e193db90aa8afb2fddc58df70
```
...
### `node:24.0.2-slim` - unknown; unknown
...
### `node:24.0.2-slim` - linux; arm64 variant v8
...
### `node:24.0.2-slim` - linux; ppc64le
