...
```console
$ docker pull node@sha256:271156a7dea9bd16713f1c140f0cf99f66af5aed306699f26bebadbd1efb3aed
```
...
### `node:25.1.0-alpine3.22` - linux; amd64
...
### `node:25.1.0-alpine3.22` - unknown; unknown
...
### `node:25.1.0-alpine3.22` - linux; arm64 variant v8
