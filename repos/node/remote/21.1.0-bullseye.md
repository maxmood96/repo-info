...
### `node:21.1.0-bullseye` - linux; arm variant v7
...
### `node:21.1.0-bullseye` - linux; arm64 variant v8
...
### `node:21.1.0-bullseye` - linux; ppc64le
...
### `node:21.1.0-bullseye` - linux; s390x
