...
```console
$ docker pull node@sha256:0eac57cde57cee750250965f16f5ff30ee2763b1c664321bdd11428ed2bbc3e0
```
...
### `node:24.13-alpine3.23` - linux; amd64
...
### `node:24.13-alpine3.23` - unknown; unknown
...
### `node:24.13-alpine3.23` - linux; arm64 variant v8
