...
### `node:25.7.0-trixie` - linux; amd64
...
### `node:25.7.0-trixie` - unknown; unknown
...
### `node:25.7.0-trixie` - linux; arm64 variant v8
...
### `node:25.7.0-trixie` - linux; ppc64le
...
### `node:25.7.0-trixie` - linux; s390x
