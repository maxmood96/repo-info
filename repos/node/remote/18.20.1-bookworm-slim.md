...
```console
$ docker pull node@sha256:02122b61a9e91fdae239c675d5d0164bd49f91c6748cb9643c7f6d73b27ad290
```
...
### `node:18.20.1-bookworm-slim` - linux; amd64
...
### `node:18.20.1-bookworm-slim` - linux; arm variant v7
...
### `node:18.20.1-bookworm-slim` - linux; arm64 variant v8
...
### `node:18.20.1-bookworm-slim` - linux; ppc64le
