...
### `node:20.19.5-alpine` - linux; amd64
...
### `node:20.19.5-alpine` - unknown; unknown
...
### `node:20.19.5-alpine` - linux; arm variant v6
...
### `node:20.19.5-alpine` - linux; arm variant v7
...
### `node:20.19.5-alpine` - linux; arm64 variant v8
...
### `node:20.19.5-alpine` - linux; ppc64le
...
### `node:20.19.5-alpine` - linux; s390x
