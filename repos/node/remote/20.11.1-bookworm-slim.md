...
```console
$ docker pull node@sha256:2627008fd3a90a295ab1d4b3a0e9a3a0246321a421e2e2eae060dde3548e50a1
```
...
### `node:20.11.1-bookworm-slim` - linux; amd64
...
### `node:20.11.1-bookworm-slim` - linux; arm64 variant v8
...
### `node:20.11.1-bookworm-slim` - linux; ppc64le
...
### `node:20.11.1-bookworm-slim` - linux; s390x
