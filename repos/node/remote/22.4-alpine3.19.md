...
```console
$ docker pull node@sha256:8aeecd60c705f823fde29e175d8c8e8f123d00a1a9bd5a4320670a02c5527182
```
...
### `node:22.4-alpine3.19` - linux; amd64
...
### `node:22.4-alpine3.19` - unknown; unknown
...
### `node:22.4-alpine3.19` - linux; arm variant v6
...
### `node:22.4-alpine3.19` - linux; arm64 variant v8
...
### `node:22.4-alpine3.19` - linux; s390x
