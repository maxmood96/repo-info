...
```console
$ docker pull node@sha256:062407db625a567b42c175fd93187d186967825b3ad3daa47b402829bf8085dc
```
...
### `node:19.6.1-alpine3.16` - linux; arm64 variant v8
...
### `node:19.6.1-alpine3.16` - linux; ppc64le
...
### `node:19.6.1-alpine3.16` - linux; s390x
