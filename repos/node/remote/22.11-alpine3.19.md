...
```console
$ docker pull node@sha256:c052b8acc38b1ba17b88e020696665410884e0c5d176347b9923b79f5c91bc84
```
...
### `node:22.11-alpine3.19` - linux; amd64
...
### `node:22.11-alpine3.19` - unknown; unknown
...
### `node:22.11-alpine3.19` - linux; arm variant v7
...
### `node:22.11-alpine3.19` - linux; arm64 variant v8
...
### `node:22.11-alpine3.19` - linux; s390x
