...
```console
$ docker pull node@sha256:ada42ccf0bfcf76048110634b16fb081692a73554bee3615c5084e680d90410c
```
...
### `node:25.3.0-slim` - unknown; unknown
...
### `node:25.3.0-slim` - linux; arm64 variant v8
...
### `node:25.3.0-slim` - linux; ppc64le
