...
```console
$ docker pull node@sha256:60f1cf079f9599e733345460a4482ebf3d8534b4d5dea410063540074e1279c0
```
...
### `node:24.15-bookworm` - linux; amd64
...
### `node:24.15-bookworm` - unknown; unknown
...
### `node:24.15-bookworm` - linux; arm64 variant v8
...
### `node:24.15-bookworm` - linux; ppc64le
...
### `node:24.15-bookworm` - linux; s390x
