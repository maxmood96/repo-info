...
### `node:20.19.2-alpine3.22` - linux; amd64
...
### `node:20.19.2-alpine3.22` - unknown; unknown
...
### `node:20.19.2-alpine3.22` - linux; arm variant v6
...
### `node:20.19.2-alpine3.22` - linux; arm variant v7
...
### `node:20.19.2-alpine3.22` - linux; arm64 variant v8
...
### `node:20.19.2-alpine3.22` - linux; ppc64le
...
### `node:20.19.2-alpine3.22` - linux; s390x
