...
```console
$ docker pull node@sha256:7942b337b20b67cd846828242f4e033cc29a83dde0f179b373636f3cbf072ae5
```
...
```console
$ docker pull node@sha256:1734bc2e9e0934e6ca555bdcf8bae3f73c6a790f22911e4ed0ecaa7e68ca9e43
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **436.1 MB (436080266 bytes)**  
...
-	Layers:
	...
	-	`sha256:7c40a3faff76845154c32b7b35d5535b201d3bd04f94a0c408f8e98f9ed98ad6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:58dff343fa57901331af0e7594c461c039d1eecd17e464fe5cd8280b3d0f1861`  
		Last Modified: Tue, 18 Nov 2025 11:21:34 GMT  
		Size: 3.3 KB (3331 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0d13cd8c22cc80bcc09534c3e6bc8ff5ccb613a96adcad0f83ab618cd4c83ae6`  
		Last Modified: Tue, 18 Nov 2025 11:21:41 GMT  
		Size: 56.2 MB (56163843 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:02643ca593aa014aa3b9d4d28475c309df7307a7391f6149c2e136e6498a0c72`  
		Last Modified: Tue, 18 Nov 2025 11:21:34 GMT  
		Size: 1.3 MB (1250678 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:adc6ffcd7ae9aa52112a292f5ad61c3ebd2988ad2261341ecefcacddcf1b3312`  
		Last Modified: Tue, 18 Nov 2025 11:21:34 GMT  
		Size: 448.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull node@sha256:6bce367dccf1041a82e050f8017399a439309ab305f6d6c644cc1aadc4deb016
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17517235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c354c213f75f3e0bbcab8ec505ecca80d8325d05272a2826bdb930bd5b831ea7`

```dockerfile
```

-	Layers:
	-	`sha256:d8432444d76faccd184c2fb5a07751f6ae342222e711ebdd3afd99ab3340ace7`  
		Last Modified: Tue, 18 Nov 2025 16:43:01 GMT  
		Size: 17.5 MB (17494221 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fbb393339e2ce2c49ec2411e84c10bcf6b1dc18c1a7cf1c17351a3c2e187e8b4`  
		Last Modified: Tue, 18 Nov 2025 16:43:02 GMT  
...
```console
$ docker pull node@sha256:ea5de6e261f0223b8b217c4f927b03bc7c9718022e56f750a883a5ff19475fcd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **443.5 MB (443480599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:585f920809851fc44e8b195bbd546daecbac31cffdc5fe8fb63be711e0db49c1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node # buildkit
# Wed, 19 Nov 2025 00:21:59 GMT
ENV NODE_VERSION=25.2.1
# Wed, 19 Nov 2025 00:21:59 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && export GNUPGHOME="$(mktemp -d)"   && set -ex   && for key in     5BE8A3F6C8A5C01D106C0AD820B1A390B168D356     DD792F5973C6DE52C432CBDAC77ABFA00DDBF2B7     CC68F5A3106FF448322E48ED27F5E38D5B0A215F     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     890C08DB8579162FEE0DF9DB8BEAB4DFCF555EF4     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     108F52B48DB57BB0CC439B2997B01419BD92F80A     A363A499291CBBC940DD62E41F10027AF002F8B0   ; do       { gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ||       { gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version   && rm -rf /tmp/* # buildkit
# Wed, 19 Nov 2025 00:21:59 GMT
ENV YARN_VERSION=1.22.22
# Wed, 19 Nov 2025 00:22:02 GMT
RUN set -ex   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     { gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ||     { gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version   && rm -rf /tmp/* # buildkit
# Wed, 19 Nov 2025 00:22:03 GMT
COPY docker-entrypoint.sh /usr/local/bin/ # buildkit
# Wed, 19 Nov 2025 00:22:03 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 19 Nov 2025 00:22:03 GMT
...
-	Layers:
	...
	-	`sha256:f48c55a627d13e75b732a3e01db18c3293f68e4209278cc1cf1faff4d9134e77`  
		...
		Size: 3.3 KB (3326 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:82b4b2be2090fe4cccefee98aabb96d8db5650cb6fb4e4a997fa1d9eb7523736`  
		Last Modified: Wed, 19 Nov 2025 00:24:16 GMT  
		Size: 58.0 MB (58000129 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:391ab7ae671beebf73f869e19ec86a6aff64af6cbe0c8590015a715f7a0225c1`  
		Last Modified: Wed, 19 Nov 2025 00:24:10 GMT  
		Size: 1.3 MB (1250675 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:746fd5629988d11a185e45fd3445eb8d333db07f9d1bc6f9e41c34589a2d7d87`  
		Last Modified: Wed, 19 Nov 2025 00:24:10 GMT  
		Size: 448.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull node@sha256:6741bfbb14e0d25a3ee968cbaedd4d74c542dbfd100d8bd0712300a4d23c491e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17502850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84812822ebae6f1e2beba251c885f4ed503a6f57a611397154e21d5ec372ff1e`

```dockerfile
```

-	Layers:
	-	`sha256:299abefd451f3cd412407a58fe9efe5325b31d516b5cc79b77beef3554bf533b`  
		Last Modified: Wed, 19 Nov 2025 01:40:13 GMT  
		Size: 17.5 MB (17479782 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bd6c119392751e54b631d48475fddca40c0a6db066acc3ae63f379a5692a8af1`  
		Last Modified: Wed, 19 Nov 2025 01:40:15 GMT  
