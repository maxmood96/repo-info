...
```console
$ docker pull node@sha256:95d4fdef5e12916a89f7d56dca6d8099de61df875c3c61106cb53e0ba1a48d44
```
...
### `node:16.17.1-bullseye-slim` - linux; arm variant v7

```console
$ docker pull node@sha256:965d6be6bf45422ab28a68700387b976f53a93834443af39aeb36fcecd8dd0b2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.9 MB (61911893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9014b03801ab051ee6798c86accb35662a1e4a26119753de7c573e206aa8b105`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
### `node:16.17.1-bullseye-slim` - linux; arm64 variant v8

```console
$ docker pull node@sha256:2f30d94bebc66345df4fec9ccbf56cbc20f7dc49f6e0515bbeb134ef07554435
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.3 MB (68327123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fcbd3f5a25b50ebdbaf55c049222c01ed3da2853ad84722a467c2adc2e5163b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
### `node:16.17.1-bullseye-slim` - linux; s390x

```console
$ docker pull node@sha256:196a77073dbbd710d39b6267342eb911b36decd9da8d97d033272da11cfc5efe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **67.7 MB (67659483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee8f755753890aea2a150b13c18d960f832bbd932120957f1a76dd8409e92940`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
