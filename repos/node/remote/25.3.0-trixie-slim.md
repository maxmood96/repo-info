...
```console
$ docker pull node@sha256:58935905b204d4cc7ca24ee70167a19b944e6c0e850348b20d198772fc2759c8
```
...
### `node:25.3.0-trixie-slim` - linux; amd64
...
### `node:25.3.0-trixie-slim` - unknown; unknown
...
### `node:25.3.0-trixie-slim` - linux; arm64 variant v8
...
### `node:25.3.0-trixie-slim` - linux; ppc64le
