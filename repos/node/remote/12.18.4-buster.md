...
```console
$ docker pull node@sha256:1f245aa3a2deed989acca08931fe59cb0df5c57c44d5f20d176a0ba7b80f6729
```
...
### `node:12.18.4-buster` - linux; arm64 variant v8
...
### `node:12.18.4-buster` - linux; ppc64le
...
### `node:12.18.4-buster` - linux; s390x
