...
```console
$ docker pull node@sha256:81fe7ed79dc8fac65bcc692f79836dd2e91775776cd45dacdd979cc219212da3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.7 MB (77717038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e84bb6328a2df451792e04fc2219155f0cbe7a5d81778911f969b372d476b2e3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
# Wed, 22 Apr 2026 03:59:27 GMT
ENV YARN_VERSION=1.22.22
# Wed, 22 Apr 2026 03:59:58 GMT
RUN set -ex   && savedAptMark="$(apt-mark showmanual)"   && apt-get update && apt-get install -y ca-certificates curl wget gnupg dirmngr --no-install-recommends   && rm -rf /var/lib/apt/lists/*   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     { gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ||     { gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && apt-mark auto '.*' > /dev/null   && { [ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; }   && find /usr/local -type f -executable -exec ldd '{}' ';'     | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'     | sort -u     | xargs -r dpkg-query --search     | cut -d: -f1     | sort -u     | xargs -r apt-mark manual   && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false   && yarn --version   && rm -rf /tmp/* # buildkit
# Wed, 22 Apr 2026 03:59:59 GMT
COPY docker-entrypoint.sh /usr/local/bin/ # buildkit
# Wed, 22 Apr 2026 03:59:59 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 22 Apr 2026 03:59:59 GMT
...
-	Layers:
	...
	-	`sha256:4c66b3182a03ed53c12d1811360b71e45eac41f92e49e093da67d09558b66dc3`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6d1fc3f6aa855d28ed70b53a51bf53268086038e7ff5c16125b2122ba935aa3e`  
		Last Modified: Wed, 22 Apr 2026 04:00:29 GMT  
		Size: 43.9 MB (43922111 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5974e23fe685e4d2803576626efb3bbd745c2c4ee880e8fccf83049ab36373fe`  
		Last Modified: Wed, 22 Apr 2026 04:00:26 GMT  
		Size: 1.7 MB (1712757 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b0b2747129c4abdfdcf35284187a42fb73313b45385e59cfe04bdd76f17035dd`  
		Last Modified: Wed, 22 Apr 2026 04:00:28 GMT  
		Size: 449.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull node@sha256:a6ea9cbae39343981774427ba8f5547061592bf5cb8120a3069fa5295e021b2f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.7 MB (2681890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6bde4389a8ef4bfb6f82ee1e083e811f332bf850043c9f400bc378e23faf242`

```dockerfile
```

-	Layers:
	-	`sha256:597463f7fe7075e28ff29796c0fdf1c36234eef4e18e33367b63f287b9400020`  
		Last Modified: Wed, 22 Apr 2026 04:00:26 GMT  
		Size: 2.7 MB (2654890 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:12320b3209d68185108200bb307565b2516a98cba6ec7ce46c081b35112632ca`  
		Last Modified: Wed, 22 Apr 2026 04:00:26 GMT  
