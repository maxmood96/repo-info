...
```console
$ docker pull node@sha256:43a550be5e6e03135ab6285e8c461cb7bad9380845e7f376ad178f6fabe78bdb
```
...
### `node:17.7.1-stretch` - linux; amd64
...
### `node:17.7.1-stretch` - linux; arm variant v7
...
### `node:17.7.1-stretch` - linux; arm64 variant v8
