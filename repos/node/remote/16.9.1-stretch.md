...
```console
$ docker pull node@sha256:b4160df08767564c12d8e9ec974af746fbbf1edc05c4acc51b51c66be0472879
```
...
### `node:16.9.1-stretch` - linux; amd64
...
### `node:16.9.1-stretch` - linux; arm variant v7
...
### `node:16.9.1-stretch` - linux; arm64 variant v8
