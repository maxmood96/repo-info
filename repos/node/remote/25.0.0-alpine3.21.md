...
```console
$ docker pull node@sha256:54a2c8c7113949ec9b177738aaa7188529b73e2cbcf1d572e62bbe4c2e7e4df0
```
...
### `node:25.0.0-alpine3.21` - linux; amd64
...
### `node:25.0.0-alpine3.21` - unknown; unknown
...
### `node:25.0.0-alpine3.21` - linux; arm64 variant v8
...
### `node:25.0.0-alpine3.21` - linux; s390x
