...
```console
$ docker pull node@sha256:f36ed6d02276ecf5e97c8fa676aee66056d8d10c3ee53f1ca65e12f8070f14db
```
...
### `node:24.8-bookworm-slim` - linux; amd64
...
### `node:24.8-bookworm-slim` - unknown; unknown
...
### `node:24.8-bookworm-slim` - linux; arm64 variant v8
...
### `node:24.8-bookworm-slim` - linux; ppc64le
