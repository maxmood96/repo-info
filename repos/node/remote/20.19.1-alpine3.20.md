...
### `node:20.19.1-alpine3.20` - linux; amd64
...
### `node:20.19.1-alpine3.20` - unknown; unknown
...
### `node:20.19.1-alpine3.20` - linux; arm variant v6
...
### `node:20.19.1-alpine3.20` - linux; arm variant v7
...
### `node:20.19.1-alpine3.20` - linux; arm64 variant v8
...
### `node:20.19.1-alpine3.20` - linux; ppc64le
...
### `node:20.19.1-alpine3.20` - linux; s390x
