...
```console
$ docker pull node@sha256:e2b39f7b64281324929257d0f8004fb6cb4bf0fdfb9aa8cedb235a766aec31da
```
...
### `node:22.13.1-alpine3.21` - linux; amd64
...
### `node:22.13.1-alpine3.21` - unknown; unknown
...
### `node:22.13.1-alpine3.21` - linux; arm variant v6
...
### `node:22.13.1-alpine3.21` - linux; arm variant v7
...
### `node:22.13.1-alpine3.21` - linux; arm64 variant v8
...
### `node:22.13.1-alpine3.21` - linux; s390x
