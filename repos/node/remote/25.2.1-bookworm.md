...
### `node:25.2.1-bookworm` - linux; amd64
...
### `node:25.2.1-bookworm` - unknown; unknown
...
### `node:25.2.1-bookworm` - linux; arm64 variant v8
...
### `node:25.2.1-bookworm` - linux; ppc64le
...
### `node:25.2.1-bookworm` - linux; s390x
