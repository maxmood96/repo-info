...
```console
$ docker pull node@sha256:45babd1b4ce0349fb12c4e24bf017b90b96d52806db32e001e3013f341bef0fe
```
...
### `node:24.11.0-trixie-slim` - linux; amd64
...
### `node:24.11.0-trixie-slim` - unknown; unknown
...
### `node:24.11.0-trixie-slim` - linux; arm64 variant v8
...
### `node:24.11.0-trixie-slim` - linux; ppc64le
...
### `node:24.11.0-trixie-slim` - linux; s390x
