...
```console
$ docker pull node@sha256:4252019cc518dadcecfd2a30449fa57bd4d6918ad340b72028bceb9fc8ed763e
```
...
### `node:23.5.0-bullseye-slim` - linux; amd64
...
### `node:23.5.0-bullseye-slim` - unknown; unknown
