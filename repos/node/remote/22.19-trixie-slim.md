...
```console
$ docker pull node@sha256:bd8ce0f31d1c5b27b20b688cb187ec29904e2557073706fc970a6a3f1a86c0c8
```
...
### `node:22.19-trixie-slim` - linux; amd64
...
### `node:22.19-trixie-slim` - unknown; unknown
...
### `node:22.19-trixie-slim` - linux; arm64 variant v8
...
### `node:22.19-trixie-slim` - linux; ppc64le
