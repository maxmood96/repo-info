...
```console
$ docker pull node@sha256:b56cb11a4f124a2cf073b5701f3d2aa59f2ccb12e4d7d5d8353bd928ef01946d
```
...
### `node:24.6-alpine3.21` - linux; amd64
...
### `node:24.6-alpine3.21` - unknown; unknown
...
### `node:24.6-alpine3.21` - linux; arm64 variant v8
