...
```console
$ docker pull node@sha256:915991c703ff1516b61518a03e3540fd25f38332669edd3cf5b6f4c4334ca6c9
```
...
### `node:17.2.0-buster` - linux; amd64
...
### `node:17.2.0-buster` - linux; arm variant v7
...
### `node:17.2.0-buster` - linux; arm64 variant v8
...
### `node:17.2.0-buster` - linux; ppc64le
...
### `node:17.2.0-buster` - linux; s390x
