...
```console
$ docker pull node@sha256:0962c16538b3da4e9a371812d147bc33598e52bf6468edc27e46f773d3c1d693
```
...
### `node:25.2.1-slim` - unknown; unknown
...
### `node:25.2.1-slim` - linux; arm64 variant v8
...
### `node:25.2.1-slim` - linux; ppc64le
