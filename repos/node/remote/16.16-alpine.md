...
### `node:16.16-alpine` - linux; arm variant v6
...
### `node:16.16-alpine` - linux; arm variant v7
...
### `node:16.16-alpine` - linux; arm64 variant v8
...
### `node:16.16-alpine` - linux; ppc64le
