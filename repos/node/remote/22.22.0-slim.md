...
```console
$ docker pull node@sha256:fbec45099b67841ba7d32c74b42c55fd96403e43d0c3181dc049606737f1ee5c
```
...
### `node:22.22.0-slim` - unknown; unknown
...
### `node:22.22.0-slim` - linux; arm variant v7
...
### `node:22.22.0-slim` - linux; arm64 variant v8
...
### `node:22.22.0-slim` - linux; ppc64le
