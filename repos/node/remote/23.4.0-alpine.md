...
### `node:23.4.0-alpine` - linux; amd64
...
### `node:23.4.0-alpine` - unknown; unknown
...
### `node:23.4.0-alpine` - linux; arm variant v6
...
### `node:23.4.0-alpine` - linux; arm variant v7
...
### `node:23.4.0-alpine` - linux; arm64 variant v8
...
### `node:23.4.0-alpine` - linux; s390x
