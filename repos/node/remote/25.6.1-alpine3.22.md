...
```console
$ docker pull node@sha256:c8af94bce6bac00d76200a0f22535d5cb261a58515e0a3c804ebde07ef298970
```
...
### `node:25.6.1-alpine3.22` - linux; amd64
...
### `node:25.6.1-alpine3.22` - unknown; unknown
...
### `node:25.6.1-alpine3.22` - linux; arm64 variant v8
