...
```console
$ docker pull node@sha256:192df4780e30afc63bafda5c05a929a95da48612a519034baa24d71fc79e34ac
```
...
### `node:20.19.1-bookworm-slim` - linux; amd64
...
### `node:20.19.1-bookworm-slim` - unknown; unknown
...
### `node:20.19.1-bookworm-slim` - linux; arm64 variant v8
...
### `node:20.19.1-bookworm-slim` - linux; ppc64le
...
### `node:20.19.1-bookworm-slim` - linux; s390x
