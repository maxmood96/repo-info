...
```console
$ docker pull node@sha256:878e1090f21b55228933660a187509532b8eb295334b6efb99a32419115af640
```
...
### `node:23.3.0-alpine` - linux; arm variant v7
...
### `node:23.3.0-alpine` - linux; s390x
