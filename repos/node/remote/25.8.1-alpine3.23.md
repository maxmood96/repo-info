...
```console
$ docker pull node@sha256:5a29b64a7371c0158f667fa42d554282fcadb6c2f6e392b62819940258dfe333
```
...
### `node:25.8.1-alpine3.23` - linux; amd64
...
### `node:25.8.1-alpine3.23` - unknown; unknown
