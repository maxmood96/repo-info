...
### `node:22.22.2-bookworm-slim` - unknown; unknown
...
### `node:22.22.2-bookworm-slim` - linux; arm variant v7
...
### `node:22.22.2-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.22.2-bookworm-slim` - linux; ppc64le
...
### `node:22.22.2-bookworm-slim` - linux; s390x
