...
```console
$ docker pull node@sha256:f6fb76542613f4c28283b1d2e5aded10a1fa77e5f94336343c5227fbe5b970d3
```
...
### `node:22.5.1-alpine` - linux; amd64
...
### `node:22.5.1-alpine` - unknown; unknown
...
### `node:22.5.1-alpine` - linux; arm64 variant v8
...
### `node:22.5.1-alpine` - linux; s390x
