...
```console
$ docker pull node@sha256:5f2b71c056f3bfb48462f67d1d99fc59e580460e87f88a5fb6f203819c3e74bf
```
...
### `node:22.21.1-alpine3.21` - linux; amd64
...
### `node:22.21.1-alpine3.21` - unknown; unknown
...
### `node:22.21.1-alpine3.21` - linux; arm variant v6
...
### `node:22.21.1-alpine3.21` - linux; arm variant v7
...
### `node:22.21.1-alpine3.21` - linux; arm64 variant v8
