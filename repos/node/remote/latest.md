...
```console
$ docker pull node@sha256:2f19fc56ffa84b02387ffa19f1f70124611270959bca21976293f8647aa3c841
```
...
```console
$ docker pull node@sha256:103c180b9acb9572420690ac4912525d9ac178f9ef5046a4164a6a3f7a6b63f1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.0 MB (361987129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0a69c6687d222f010808578e923c292151ecd0465a4c695e074717d816775d0`
...
# Mon, 05 Oct 2020 18:21:32 GMT
ENV NODE_VERSION=14.13.0
# Mon, 05 Oct 2020 18:21:40 GMT
...
# Mon, 05 Oct 2020 18:21:41 GMT
ENV YARN_VERSION=1.22.5
# Mon, 05 Oct 2020 18:21:44 GMT
...
-	Layers:
	...
	-	`sha256:e5c5821cd8891e4cb78b57e971882385cf3d9541a6071c9ae64263c7ed8152b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f12f5cb9afda2b62619f6bedf2b4e2b8331cd2d38cf12c5a5314d09809cb4b14`  
		Last Modified: Mon, 05 Oct 2020 18:26:03 GMT  
		Size: 34.8 MB (34796869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb6e1d652e5b4d8e169e23deb1971156317a7efd8b500dd3e71a9b9c951e1cb9`  
		Last Modified: Mon, 05 Oct 2020 18:25:58 GMT  
		Size: 2.4 MB (2363721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7feb35879a7911c4806b7e1d22e86efa708cd7418568b42b5162d9590a34084`  
		Last Modified: Mon, 05 Oct 2020 18:25:56 GMT  
		Size: 294.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:2b5ba769ed7fafb4ae101dd995475c2038866001afca0ba64a1ca9a7cb3d70fb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **343.9 MB (343906272 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8db0eec56602e565ae772c6ed475a812714d5c94c2287c5ae36d4a31be8fa2c0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Mon, 05 Oct 2020 20:43:20 GMT
ENV NODE_VERSION=14.13.0
# Mon, 05 Oct 2020 20:43:32 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     A48C2BEE680E841632CD4E44F07496B3EB3C1762     108F52B48DB57BB0CC439B2997B01419BD92F80A     B9E2F5981AA6E0CD28160D9FF13993A75599653C   ; do     gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Mon, 05 Oct 2020 20:43:34 GMT
ENV YARN_VERSION=1.22.5
# Mon, 05 Oct 2020 20:43:39 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Mon, 05 Oct 2020 20:43:40 GMT
COPY file:238737301d47304174e4d24f4def935b29b3069c03c72ae8de97d94624382fce in /usr/local/bin/ 
# Mon, 05 Oct 2020 20:43:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Mon, 05 Oct 2020 20:43:42 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:a10459ed06a37221dbcbe6039ddce6da2562d6ef27bfecfb4f879c180469af2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70352914ff5810435a186eea18f747b4b89ba788e0f8958f07c8887bb9dec76f`  
		Last Modified: Mon, 05 Oct 2020 21:17:25 GMT  
		Size: 34.9 MB (34902406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9233612f117867ecfce93deb148a2d615ccd3f4e95914222e34a33162060cef7`  
		Last Modified: Mon, 05 Oct 2020 21:17:15 GMT  
		Size: 2.4 MB (2363827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b72bf0e0af064e0d21922bf2240429e60f844777b998961f25497a86c5e161d`  
		Last Modified: Mon, 05 Oct 2020 21:17:14 GMT  
		Size: 293.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
