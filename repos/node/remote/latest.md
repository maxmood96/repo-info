...
```console
$ docker pull node@sha256:b8f233200d2966a5586f0384335d2c6306a411a8fc8fe43a1b2849be11649b97
```
...
```console
$ docker pull node@sha256:45f8f5b4ad535ca4a84f12ab1099fe25aec4615355a077ec9ac995a933714d76
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.8 MB (368762851 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14777a723ec41f47fa4cf9d94f718217f8c2fe120e7ae102f56e9e8b4f0beffc`
...
-	Layers:
	...
	-	`sha256:f2930ff7fb6061a0120e0b924ef643796b8d8afe63591a700ccd57efde8f0570`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a7b024a8381db764cc48724c66ef77cf3036f9110ca53a2422a2f381d8daf44`  
		Last Modified: Tue, 11 Jan 2022 21:34:38 GMT  
		Size: 44.5 MB (44465080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22353d05d6e6a35fe0c3bbf9703a769ea0d2dbfe66a71e1dd22acb0b3aa313aa`  
		Last Modified: Tue, 11 Jan 2022 21:34:30 GMT  
		Size: 2.3 MB (2272209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4a00242c622c9caf4eb220e3b8498bd0a94fff6738b55f3ff4c7c8b17e80ec4`  
		Last Modified: Tue, 11 Jan 2022 21:34:29 GMT  
		Size: 452.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:98f38efd4ae5eddf13ef1d8b6b1e280f94240fcf68684881716cd0587a75f1d8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **360.4 MB (360365881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0de64d218932e0be8fb73c891b3d91115541eef923d1bfa81288a480ee40c7e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Tue, 11 Jan 2022 20:34:45 GMT
ENV NODE_VERSION=17.3.1
# Tue, 11 Jan 2022 20:35:02 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     74F12602B6F1C4E913FAA37AD3A89613643B6201     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     A48C2BEE680E841632CD4E44F07496B3EB3C1762     108F52B48DB57BB0CC439B2997B01419BD92F80A     B9E2F5981AA6E0CD28160D9FF13993A75599653C   ; do       gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||       gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Tue, 11 Jan 2022 20:35:03 GMT
ENV YARN_VERSION=1.22.17
# Tue, 11 Jan 2022 20:35:07 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Tue, 11 Jan 2022 20:35:08 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Tue, 11 Jan 2022 20:35:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 11 Jan 2022 20:35:10 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:6bf4ffb24b8e68c48dea37b1e0d3a818ded4842150fa9c3a2a100c4efbf0c88b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d203f5bdf7b84ba8fa76e56e1357a1457e69cc064ce0f2a68d49ec6b810c2b9d`  
		Last Modified: Tue, 11 Jan 2022 23:18:06 GMT  
		Size: 44.6 MB (44593847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea9c843455b257dc04302139b66098ebe563847f4f1ea3d75e3242012f5db8f7`  
		Last Modified: Tue, 11 Jan 2022 23:17:58 GMT  
		Size: 2.3 MB (2272191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e006612027a38a3b68ccfa956010194b6c0cf3031821c47c14b14d34cc23ec6`  
		Last Modified: Tue, 11 Jan 2022 23:17:58 GMT  
		Size: 451.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
