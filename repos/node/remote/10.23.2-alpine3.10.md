...
### `node:10.23.2-alpine3.10` - linux; arm variant v6
...
### `node:10.23.2-alpine3.10` - linux; arm variant v7
...
### `node:10.23.2-alpine3.10` - linux; arm64 variant v8
...
### `node:10.23.2-alpine3.10` - linux; 386
...
### `node:10.23.2-alpine3.10` - linux; ppc64le
...
### `node:10.23.2-alpine3.10` - linux; s390x
