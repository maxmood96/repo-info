...
```console
$ docker pull node@sha256:b410676781397cabae22f81547ddb3e6b975dc04b43626098ce17ea53a447ef1
```
...
### `node:22.21-alpine3.22` - linux; amd64
...
### `node:22.21-alpine3.22` - unknown; unknown
...
### `node:22.21-alpine3.22` - linux; arm variant v6
...
### `node:22.21-alpine3.22` - linux; arm variant v7
...
### `node:22.21-alpine3.22` - linux; arm64 variant v8
