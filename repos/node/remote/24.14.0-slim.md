...
```console
$ docker pull node@sha256:5f5788dfb37df047dddb2e5a6d7544d2fcc994408284518e6fc31edf5233585a
```
...
### `node:24.14.0-slim` - unknown; unknown
...
### `node:24.14.0-slim` - linux; arm64 variant v8
