...
### `node:22.23.0-alpine3.24` - linux; amd64
...
### `node:22.23.0-alpine3.24` - unknown; unknown
...
### `node:22.23.0-alpine3.24` - linux; arm variant v6
...
### `node:22.23.0-alpine3.24` - linux; arm variant v7
...
### `node:22.23.0-alpine3.24` - linux; arm64 variant v8
...
### `node:22.23.0-alpine3.24` - linux; s390x
