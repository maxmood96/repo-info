...
```console
$ docker pull node@sha256:8232385aeb71069fe2ce84ce82fda5d1be0f826c66eeac8b50fe0dcac2fb2e31
```
...
### `node:19.1.0-buster` - linux; amd64
...
### `node:19.1.0-buster` - linux; arm variant v7
...
### `node:19.1.0-buster` - linux; arm64 variant v8
