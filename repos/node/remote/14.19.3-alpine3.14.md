...
```console
$ docker pull node@sha256:fcd884b6b069bd3a398bfd5fd6bb330ebbd358b6089e9d6c631c8121ecbdfb05
```
...
### `node:14.19.3-alpine3.14` - linux; arm variant v7
...
### `node:14.19.3-alpine3.14` - linux; arm64 variant v8
...
### `node:14.19.3-alpine3.14` - linux; ppc64le
