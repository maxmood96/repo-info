...
```console
$ docker pull node@sha256:fefcd73f2fc4f1c1533ec11e016116327e4dd2c06bbbfdb8e314c19ee3323bec
```
...
```console
$ docker pull node@sha256:766acf21205b005aefd3659a3b9d2d2807ffb2fbf83787311b172bfad5f9990f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.6 MB (46613493 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bc78f8574a2dcac01f97f0fd8734130b874b025c0a5d2a9e011b07b768b0372`
...
# Mon, 13 Jan 2020 21:26:54 GMT
ENV NODE_VERSION=10.18.1
# Mon, 13 Jan 2020 21:27:17 GMT
...
-	Layers:
	...
	-	`sha256:2706bdf8025024895de9fff9e48694e4ec349bbdf066da327afbeb8ce6d9956f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eb948e616919c029a78fdd56c12560b0f4a2ada7f8df56473002f358436df60`  
		Last Modified: Mon, 13 Jan 2020 21:30:45 GMT  
		Size: 22.2 MB (22235529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc1a152769d644ce063201aa72fac6ffbb00d0dc5835a2eeeac87a438868f958`  
		Last Modified: Mon, 13 Jan 2020 21:30:41 GMT  
		Size: 1.8 MB (1848919 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4646756d220bc8e498167e06c03f0ec19c6cc4031dcb9005e19c5224abf38bec`  
		Last Modified: Mon, 13 Jan 2020 21:30:41 GMT  
		Size: 294.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:a6c9cbb426d300af9fcbbda8836bff30f099af3e4d984bfe28a5d2cbc211ec08
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.6 MB (46591514 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd1e85ba2e2a1ca77e7d9891893b3890fb646de54eec367d4f4b159a54d0f0bf`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
# Mon, 13 Jan 2020 21:50:29 GMT
ENV YARN_VERSION=1.21.1
# Mon, 13 Jan 2020 21:50:47 GMT
RUN set -ex   && apt-get update && apt-get install -y ca-certificates curl wget gnupg dirmngr --no-install-recommends   && rm -rf /var/lib/apt/lists/*   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && apt-mark auto '.*' > /dev/null   && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Mon, 13 Jan 2020 21:50:47 GMT
COPY file:238737301d47304174e4d24f4def935b29b3069c03c72ae8de97d94624382fce in /usr/local/bin/ 
# Mon, 13 Jan 2020 21:50:47 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Mon, 13 Jan 2020 21:50:48 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:175f7e6e2450f08165d43778b6f6c8db8a96a46b53e535918cf6f2d238ca0c7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34bbd24a0010da5322be17ea129c02e00774efd0038b8a6fd09a06745ccc075a`  
		Last Modified: Mon, 13 Jan 2020 22:25:56 GMT  
		Size: 22.4 MB (22357954 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b074188a2e220ff544363f0d82983cf99323cd97be5ba917d93dc8d7bb3c4c40`  
		Last Modified: Mon, 13 Jan 2020 22:25:53 GMT  
		Size: 1.8 MB (1848968 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff3e809b7a9b08a325b230582b211d237bdfcbbae9aaa5e15f2c3c397a54699b`  
		Last Modified: Mon, 13 Jan 2020 22:25:53 GMT  
		Size: 293.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
