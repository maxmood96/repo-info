...
```console
$ docker pull node@sha256:c65555c2da7fc986a836bb35ddc78f958d9e899c177ddf9d20a7e9dff9cd3164
```
...
### `node:22.16-bookworm` - linux; amd64
...
### `node:22.16-bookworm` - unknown; unknown
...
### `node:22.16-bookworm` - linux; arm64 variant v8
...
### `node:22.16-bookworm` - linux; ppc64le
...
### `node:22.16-bookworm` - linux; s390x
