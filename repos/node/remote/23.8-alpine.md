...
```console
$ docker pull node@sha256:39294518a089659439ad3997e11a4897e4f60bd6e483f9d90ee8b7dd462588fd
```
...
### `node:23.8-alpine` - unknown; unknown
...
### `node:23.8-alpine` - linux; arm variant v6
...
### `node:23.8-alpine` - linux; arm64 variant v8
