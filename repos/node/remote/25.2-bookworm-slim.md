...
```console
$ docker pull node@sha256:ea8182dfd261b282e874d3859e45654c22fcd02aa39554cf6c0231914aed5a8a
```
...
### `node:25.2-bookworm-slim` - linux; amd64
...
### `node:25.2-bookworm-slim` - unknown; unknown
...
### `node:25.2-bookworm-slim` - linux; arm64 variant v8
...
### `node:25.2-bookworm-slim` - linux; ppc64le
