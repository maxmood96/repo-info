...
### `node:22.18-bullseye-slim` - linux; amd64
...
### `node:22.18-bullseye-slim` - unknown; unknown
...
### `node:22.18-bullseye-slim` - linux; arm variant v7
...
### `node:22.18-bullseye-slim` - linux; arm64 variant v8
