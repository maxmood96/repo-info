...
```console
$ docker pull node@sha256:e7507c00b35ccecf4958d99296e3a9ecc69fcd0deccc12067a66b5745c846406
```
...
### `node:20.18.2-alpine` - linux; amd64
...
### `node:20.18.2-alpine` - unknown; unknown
...
### `node:20.18.2-alpine` - linux; arm variant v6
...
### `node:20.18.2-alpine` - linux; arm variant v7
...
### `node:20.18.2-alpine` - linux; arm64 variant v8
...
### `node:20.18.2-alpine` - linux; ppc64le
