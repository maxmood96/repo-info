...
### `node:24.7.0-bookworm-slim` - linux; amd64
...
### `node:24.7.0-bookworm-slim` - unknown; unknown
...
### `node:24.7.0-bookworm-slim` - linux; arm64 variant v8
...
### `node:24.7.0-bookworm-slim` - linux; ppc64le
...
### `node:24.7.0-bookworm-slim` - linux; s390x
