...
```console
$ docker pull node@sha256:5e221f4ebcfdfcf52970144389769c3e2dacbc3f5f352a53de9573ef1586a626
```
...
### `node:14.17.5-bullseye` - linux; amd64

```console
$ docker pull node@sha256:77cffbdd3f6a12418d36bdeacdb04b7bfb4e25fe898839ba3e0398ab2f43aa49
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.2 MB (359169424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b76b5401a9be259e1021bf648599fa957df275d504bc2dd8dedeeef2ee7777e9`
...
# Wed, 18 Aug 2021 09:43:09 GMT
ENV NODE_VERSION=14.17.5
# Wed, 18 Aug 2021 09:43:25 GMT
...
# Wed, 18 Aug 2021 09:43:26 GMT
ENV YARN_VERSION=1.22.5
# Wed, 18 Aug 2021 09:43:29 GMT
...
-	Layers:
	...
	-	`sha256:ed9e7e02662f2c2de4fc49c90feab31894b38d96b4ff46c2f3eeecc4a917ef20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2102824a32338ae6ee350a86c471ae9142db0ee3debf74d6c55b980a97649ac7`  
		Last Modified: Wed, 18 Aug 2021 09:56:30 GMT  
		Size: 34.9 MB (34936361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9073b5c8280566c101aaf93cef4753b8cfe8f8dcb1fd9fe46f5e1b5b7dd1f82`  
		Last Modified: Wed, 18 Aug 2021 09:56:25 GMT  
		Size: 2.3 MB (2277554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f93ec1c1377407eed29f6a9b26dec5669e1289b0e369bbf6956ad4074a1df87`  
		Last Modified: Wed, 18 Aug 2021 09:56:24 GMT  
		Size: 283.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `node:14.17.5-bullseye` - linux; arm variant v7
...
### `node:14.17.5-bullseye` - linux; arm64 variant v8
...
### `node:14.17.5-bullseye` - linux; ppc64le
...
### `node:14.17.5-bullseye` - linux; s390x

```console
$ docker pull node@sha256:1a3e962e941df013099f2e9fc2a6cc137c93ee590fda93a0635c1f1f6506ce70
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.7 MB (332659562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34ddbbbcab21b42c2b8ba8ee8962b3663d556ca4a573b857e767567ccc2143b0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Wed, 18 Aug 2021 03:32:53 GMT
ENV NODE_VERSION=14.17.5
# Wed, 18 Aug 2021 03:33:07 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     74F12602B6F1C4E913FAA37AD3A89613643B6201     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     A48C2BEE680E841632CD4E44F07496B3EB3C1762     108F52B48DB57BB0CC439B2997B01419BD92F80A     B9E2F5981AA6E0CD28160D9FF13993A75599653C   ; do       gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||       gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Wed, 18 Aug 2021 03:33:10 GMT
ENV YARN_VERSION=1.22.5
# Wed, 18 Aug 2021 03:33:12 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Wed, 18 Aug 2021 03:33:13 GMT
COPY file:238737301d47304174e4d24f4def935b29b3069c03c72ae8de97d94624382fce in /usr/local/bin/ 
# Wed, 18 Aug 2021 03:33:13 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 18 Aug 2021 03:33:13 GMT
...
-	Layers:
	...
	-	`sha256:d26cecad52fe3c0fe3ae773dce3340dad79343b48418fd1f17a2689befd68f74`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:284c01b12ca1dec8bfe0376f7de9b081ede640bc9ebe27370d20ad4b07bc0e3a`  
		Last Modified: Wed, 18 Aug 2021 03:44:00 GMT  
		Size: 34.8 MB (34802137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c30894727aa6ee5e01a9a2e57b2c1f5b514c85dc68448aa9d493a242c73f4c`  
		Last Modified: Wed, 18 Aug 2021 03:43:56 GMT  
		Size: 2.3 MB (2280111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1974bc0e77d4db6fe00baa20df9d2c10c343680ffb5261f2071054f8257be671`  
		Last Modified: Wed, 18 Aug 2021 03:43:55 GMT  
		Size: 283.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
