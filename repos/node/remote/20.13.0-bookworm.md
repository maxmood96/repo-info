...
```console
$ docker pull node@sha256:b6e7fef05c7609784c320e5c746aaf8d49221ec0eb3c1242fb673099511b0583
```
...
### `node:20.13.0-bookworm` - linux; amd64
...
### `node:20.13.0-bookworm` - linux; arm variant v7
...
### `node:20.13.0-bookworm` - linux; arm64 variant v8
...
### `node:20.13.0-bookworm` - linux; ppc64le
...
### `node:20.13.0-bookworm` - linux; s390x
