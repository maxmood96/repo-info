...
```console
$ docker pull node@sha256:3f3849dc89f5f5e1b2d11211eab177289e9eca1296a8a149111260813271c549
```
...
### `node:20.10.0-buster-slim` - linux; amd64
...
### `node:20.10.0-buster-slim` - linux; arm64 variant v8
