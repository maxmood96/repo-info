...
```console
$ docker pull node@sha256:6098f8f773e6910b41e7f5b3331d499395b26a376b440b99cdd3c47c62a131a4
```
...
### `node:23.6.1-alpine3.20` - linux; amd64
...
### `node:23.6.1-alpine3.20` - unknown; unknown
...
### `node:23.6.1-alpine3.20` - linux; arm variant v6
...
### `node:23.6.1-alpine3.20` - linux; arm variant v7
...
### `node:23.6.1-alpine3.20` - linux; arm64 variant v8
