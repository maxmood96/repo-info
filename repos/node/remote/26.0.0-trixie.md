...
### `node:26.0.0-trixie` - linux; amd64
...
### `node:26.0.0-trixie` - unknown; unknown
...
### `node:26.0.0-trixie` - linux; arm64 variant v8
...
### `node:26.0.0-trixie` - linux; ppc64le
...
### `node:26.0.0-trixie` - linux; s390x
