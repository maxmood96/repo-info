...
```console
$ docker pull node@sha256:4e9abf0cee96ea2e3ae39facc2256c7963760b0ffbe921a4f54069e612cd0693
```
...
### `node:22.23.0-bookworm-slim` - linux; amd64
...
### `node:22.23.0-bookworm-slim` - unknown; unknown
...
### `node:22.23.0-bookworm-slim` - linux; arm variant v7
...
### `node:22.23.0-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.23.0-bookworm-slim` - linux; ppc64le
