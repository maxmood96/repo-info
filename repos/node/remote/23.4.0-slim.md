...
### `node:23.4.0-slim` - unknown; unknown
...
### `node:23.4.0-slim` - linux; arm variant v7
...
### `node:23.4.0-slim` - linux; arm64 variant v8
...
### `node:23.4.0-slim` - linux; ppc64le
