...
### `node:22.6.0-alpine` - linux; amd64
...
### `node:22.6.0-alpine` - unknown; unknown
...
### `node:22.6.0-alpine` - linux; arm variant v6
...
### `node:22.6.0-alpine` - linux; arm variant v7
...
### `node:22.6.0-alpine` - linux; arm64 variant v8
...
### `node:22.6.0-alpine` - linux; s390x
