...
```console
$ docker pull node@sha256:d6463916de9e0f4ae3e3c1cdda0e6c1df2499d43faff14ae8965338419819014
```
...
### `node:25.3.0-alpine3.22` - linux; amd64
...
### `node:25.3.0-alpine3.22` - unknown; unknown
...
### `node:25.3.0-alpine3.22` - linux; arm64 variant v8
