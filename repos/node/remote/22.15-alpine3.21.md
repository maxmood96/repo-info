...
### `node:22.15-alpine3.21` - linux; amd64
...
### `node:22.15-alpine3.21` - unknown; unknown
...
### `node:22.15-alpine3.21` - linux; arm variant v6
...
### `node:22.15-alpine3.21` - linux; arm variant v7
...
### `node:22.15-alpine3.21` - linux; arm64 variant v8
...
### `node:22.15-alpine3.21` - linux; s390x
