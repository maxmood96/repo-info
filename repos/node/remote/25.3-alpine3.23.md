...
```console
$ docker pull node@sha256:b52b1624ef9626d2595fd0ac167586a4b1d83128c15e0356f55e800e4285b9ab
```
...
### `node:25.3-alpine3.23` - linux; amd64
...
### `node:25.3-alpine3.23` - unknown; unknown
...
### `node:25.3-alpine3.23` - linux; arm64 variant v8
