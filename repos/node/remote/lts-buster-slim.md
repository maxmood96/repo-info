...
```console
$ docker pull node@sha256:08fbaedaa09f60f6f22bcb09849ed4000d02630dc18821b080fb8c847e6723e7
```
...
```console
$ docker pull node@sha256:c1191b756ce671ff1de0c460a6411bd8f938eb56bc86c0e6426a314c5f4db9c5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52702628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef4b60b127deae309eeb4b714961e6e5a8f6f504f60482c0c7150461a897c3f7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
