...
```console
$ docker pull node@sha256:12e2d4e68982ea48a4e5a865987f8aacbb1a5767a346f1279f676ef0f72c8cd2
```
...
```console
$ docker pull node@sha256:7547253cee9d8ecb06940b48a849f09ea915dc5b77c8a523ed0490f5bd471dde
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **64.1 MB (64137210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:604c99969a9dd86439654da79b2561db7f107d198f5c6830fa764b6a3b300b2f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:e13a1e58e025f071024469385946b2e3227acd6c853d8761483277424ebf596f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.6 MB (70573036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9f40c6d2cfcc88bc2cffca84f80301bebf6c610d86c0f230d910e69289fb8b1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:183bad6479bbad6dc5d769af6dc9a5a09deeb1ffce8a5e7d7becc1014ae1c79d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.8 MB (63751079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d36b792ef48c87df004be660dfa88befb8985219cc09d1b1bbbbbd1ebfb5b4d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
