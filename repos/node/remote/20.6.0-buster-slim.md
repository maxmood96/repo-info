## `node:20.6.0-buster-slim`

```console
$ docker pull node@sha256:88344327fc9ca435b2cdb2fa95d64f9525924811476ec5af7fa1e3e965f4271c
```
...
### `node:20.6.0-buster-slim` - linux; amd64
...
### `node:20.6.0-buster-slim` - linux; arm64 variant v8
