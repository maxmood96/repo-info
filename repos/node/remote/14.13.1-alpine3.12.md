...
```console
$ docker pull node@sha256:69ff08d20c734838310b15929aa3eaccc9dfa72340868a112620947c7be16e1f
```
...
### `node:14.13.1-alpine3.12` - linux; ppc64le
...
### `node:14.13.1-alpine3.12` - linux; s390x
