...
```console
$ docker pull node@sha256:5a0ee267363b61866afd1199a9eceabbdc839d162c315e15696b4fb0910ea545
```
...
### `node:22.16.0-bookworm-slim` - linux; amd64
...
### `node:22.16.0-bookworm-slim` - unknown; unknown
...
### `node:22.16.0-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.16.0-bookworm-slim` - linux; ppc64le
...
### `node:22.16.0-bookworm-slim` - linux; s390x
