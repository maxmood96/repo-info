...
```console
$ docker pull node@sha256:7f6d8d5d5b8b9fe704b50227efff60c975c6dd7463b9e8e829c86f952b301af8
```
...
### `node:20.5.0-bullseye` - linux; amd64
...
### `node:20.5.0-bullseye` - linux; arm variant v7
...
### `node:20.5.0-bullseye` - linux; arm64 variant v8
...
### `node:20.5.0-bullseye` - linux; ppc64le
