...
### `node:14.17.5-buster-slim` - linux; arm variant v7
...
### `node:14.17.5-buster-slim` - linux; arm64 variant v8
...
### `node:14.17.5-buster-slim` - linux; ppc64le
...
### `node:14.17.5-buster-slim` - linux; s390x
