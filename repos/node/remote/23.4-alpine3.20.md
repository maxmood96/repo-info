...
### `node:23.4-alpine3.20` - linux; amd64
...
### `node:23.4-alpine3.20` - unknown; unknown
...
### `node:23.4-alpine3.20` - linux; arm variant v6
...
### `node:23.4-alpine3.20` - linux; arm variant v7
...
### `node:23.4-alpine3.20` - linux; arm64 variant v8
...
### `node:23.4-alpine3.20` - linux; s390x
