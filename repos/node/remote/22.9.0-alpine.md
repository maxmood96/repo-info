...
```console
$ docker pull node@sha256:298e7594bec0213ac122ca36f30081a17fa80c571413e5f5a46d61d9c27c41e4
```
...
### `node:22.9.0-alpine` - linux; amd64
...
### `node:22.9.0-alpine` - unknown; unknown
...
### `node:22.9.0-alpine` - linux; arm64 variant v8
...
### `node:22.9.0-alpine` - linux; s390x
