## `node:16.4.1-stretch-slim`

```console
$ docker pull node@sha256:74c73f4f15a3d801004067d5ac2491c6f1a68fce113e02c3c05d5ca3d8afedfc
```
...
### `node:16.4.1-stretch-slim` - linux; amd64
...
### `node:16.4.1-stretch-slim` - linux; arm variant v7
