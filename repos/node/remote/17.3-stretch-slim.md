...
```console
$ docker pull node@sha256:eb56a462015771f777c489ea0611cd5d651f3a3b34d5cc817ff8fc92cd510892
```
...
### `node:17.3-stretch-slim` - linux; amd64
...
### `node:17.3-stretch-slim` - linux; arm variant v7
...
### `node:17.3-stretch-slim` - linux; arm64 variant v8
