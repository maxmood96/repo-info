...
```console
$ docker pull node@sha256:f0636c4597f30a25386d2582e1a8dfb38c6a7f9ad5e28680285f246f3f808a6e
```
...
### `node:22.12.0-alpine3.19` - linux; amd64
...
### `node:22.12.0-alpine3.19` - unknown; unknown
...
### `node:22.12.0-alpine3.19` - linux; arm variant v6
...
### `node:22.12.0-alpine3.19` - linux; arm64 variant v8
...
### `node:22.12.0-alpine3.19` - linux; s390x
