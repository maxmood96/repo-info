...
```console
$ docker pull node@sha256:81d8745aa8d8e5b28a01c0df0ed80f35a5cdf99f91d4a954b3d28defab7fde23
```
...
### `node:12.19.0-alpine3.9` - linux; arm64 variant v8
...
### `node:12.19.0-alpine3.9` - linux; ppc64le
...
### `node:12.19.0-alpine3.9` - linux; s390x
