...
```console
$ docker pull node@sha256:7c9cf587356a5905d0d9c2f013d6ad224cf1f341e642e310ae12affec6023092
```
...
### `node:16.13.2-bullseye` - linux; amd64
...
### `node:16.13.2-bullseye` - linux; arm variant v7
...
### `node:16.13.2-bullseye` - linux; arm64 variant v8
...
### `node:16.13.2-bullseye` - linux; s390x
