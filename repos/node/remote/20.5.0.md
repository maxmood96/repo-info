...
```console
$ docker pull node@sha256:9922238aed5ccecd618468f8c6477766913f4149a86195d34c9a8c4ffcea8de6
```
...
### `node:20.5.0` - linux; arm variant v7
...
### `node:20.5.0` - linux; arm64 variant v8
