...
### `node:19.1.0-alpine3.15` - linux; arm variant v6
...
### `node:19.1.0-alpine3.15` - linux; arm variant v7
...
### `node:19.1.0-alpine3.15` - linux; ppc64le
...
### `node:19.1.0-alpine3.15` - linux; s390x
