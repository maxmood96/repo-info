...
```console
$ docker pull node@sha256:8b1984fab368a1b4e6972cf1f102d7879b242d5c255ec577ce98bbbd73d8571b
```
...
### `node:20.15.1-alpine3.20` - linux; amd64
...
### `node:20.15.1-alpine3.20` - linux; arm variant v6
...
### `node:20.15.1-alpine3.20` - linux; arm64 variant v8
...
### `node:20.15.1-alpine3.20` - linux; s390x
