...
```console
$ docker pull node@sha256:5528af4c56940ee5c089a31313e63d29c240975710c16ce1b752890b3e6ce397
```
...
### `node:18.20.7-alpine` - linux; amd64
...
### `node:18.20.7-alpine` - unknown; unknown
...
### `node:18.20.7-alpine` - linux; arm variant v6
...
### `node:18.20.7-alpine` - linux; arm variant v7
...
### `node:18.20.7-alpine` - linux; arm64 variant v8
...
### `node:18.20.7-alpine` - linux; ppc64le
