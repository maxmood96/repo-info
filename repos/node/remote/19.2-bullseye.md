...
```console
$ docker pull node@sha256:9ffd15932b11bac210bf177d689abdf51495d42177dcbea19034e2befabdf84e
```
...
### `node:19.2-bullseye` - linux; amd64
...
### `node:19.2-bullseye` - linux; arm variant v7
...
### `node:19.2-bullseye` - linux; arm64 variant v8
...
### `node:19.2-bullseye` - linux; ppc64le
...
### `node:19.2-bullseye` - linux; s390x
