...
```console
$ docker pull node@sha256:caa88b52e910ad9864c74b8d3459e728ec36e4cf4b84bb54d3a89a4562a35340
```
...
### `node:20.20.0-alpine3.22` - linux; arm variant v6
...
### `node:20.20.0-alpine3.22` - linux; arm variant v7
...
### `node:20.20.0-alpine3.22` - linux; arm64 variant v8
...
### `node:20.20.0-alpine3.22` - linux; ppc64le
