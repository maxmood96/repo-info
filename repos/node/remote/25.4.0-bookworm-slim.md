...
### `node:25.4.0-bookworm-slim` - linux; amd64
...
### `node:25.4.0-bookworm-slim` - unknown; unknown
...
### `node:25.4.0-bookworm-slim` - linux; arm64 variant v8
...
### `node:25.4.0-bookworm-slim` - linux; ppc64le
...
### `node:25.4.0-bookworm-slim` - linux; s390x
