...
```console
$ docker pull node@sha256:2a4cbdf7a1e37ecf8df8bc8ca60ed8baec3cffd14306a1091d4d04e012432621
```
...
### `node:16.17.1-buster-slim` - linux; amd64
...
### `node:16.17.1-buster-slim` - linux; arm64 variant v8
