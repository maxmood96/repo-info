...
```console
$ docker pull node@sha256:c0f3faa075e7e34d89fcb54ce890c87c8f64d2d9b7060500cef2ca997436229f
```
...
### `node:14.13.1-buster` - linux; ppc64le
...
### `node:14.13.1-buster` - linux; s390x
