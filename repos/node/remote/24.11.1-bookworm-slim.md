...
```console
$ docker pull node@sha256:1df475b6befed0f5b06f8c5d806eebd086fbd5944d8511da3957057d5ff74259
```
...
### `node:24.11.1-bookworm-slim` - linux; amd64
...
### `node:24.11.1-bookworm-slim` - unknown; unknown
...
### `node:24.11.1-bookworm-slim` - linux; arm64 variant v8
...
### `node:24.11.1-bookworm-slim` - linux; ppc64le
