...
```console
$ docker pull node@sha256:e7746e25a021523a7d9d22b981bd2f76c312e4d5fd492aae09f89de9a56fa2ce
```
...
### `node:16.14.1-buster` - linux; arm64 variant v8
...
### `node:16.14.1-buster` - linux; ppc64le
...
### `node:16.14.1-buster` - linux; s390x
