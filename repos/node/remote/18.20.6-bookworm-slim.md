...
### `node:18.20.6-bookworm-slim` - linux; amd64
...
### `node:18.20.6-bookworm-slim` - unknown; unknown
...
### `node:18.20.6-bookworm-slim` - linux; arm variant v7
...
### `node:18.20.6-bookworm-slim` - linux; arm64 variant v8
...
### `node:18.20.6-bookworm-slim` - linux; ppc64le
...
### `node:18.20.6-bookworm-slim` - linux; s390x
