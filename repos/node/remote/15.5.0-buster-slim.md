...
```console
$ docker pull node@sha256:e3779489047a55f165e375dfabf1a54e8e728ef513f8d90251f2ee6fde345b77
```
...
### `node:15.5.0-buster-slim` - linux; amd64
...
### `node:15.5.0-buster-slim` - linux; arm variant v7
...
### `node:15.5.0-buster-slim` - linux; arm64 variant v8
