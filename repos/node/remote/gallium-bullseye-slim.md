...
```console
$ docker pull node@sha256:203cf4c2b8f4d912cac0e101fea531a5aae0116f42928da28f3cc9bd8e50817c
```
...
```console
$ docker pull node@sha256:df952b00df7b88ff5b8a21ce35d8b6ed586489ef08b903d223ce04a5774205b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.5 MB (69451535 bytes)**  
