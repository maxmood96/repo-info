...
```console
$ docker pull node@sha256:399fc1df21b475c08714d4f8f12bddf01f3ce3ae330ef7a39b03fdb986d4e2dc
```
...
### `node:14.17.2-buster` - linux; arm64 variant v8
...
### `node:14.17.2-buster` - linux; s390x
