...
```console
$ docker pull node@sha256:a46754b85d2396a0d335916fe6c7405cfa7b349da60129b94e0f76c82a03ba70
```
...
### `node:22.6-bookworm-slim` - linux; amd64
...
### `node:22.6-bookworm-slim` - unknown; unknown
...
### `node:22.6-bookworm-slim` - linux; arm variant v7
...
### `node:22.6-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.6-bookworm-slim` - linux; ppc64le
