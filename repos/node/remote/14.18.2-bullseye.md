...
### `node:14.18.2-bullseye` - linux; arm variant v7
...
### `node:14.18.2-bullseye` - linux; arm64 variant v8
...
### `node:14.18.2-bullseye` - linux; ppc64le
...
### `node:14.18.2-bullseye` - linux; s390x
