...
### `node:24.17-bookworm` - linux; amd64
...
### `node:24.17-bookworm` - unknown; unknown
...
### `node:24.17-bookworm` - linux; arm64 variant v8
...
### `node:24.17-bookworm` - linux; ppc64le
...
### `node:24.17-bookworm` - linux; s390x
