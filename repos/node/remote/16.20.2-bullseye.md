...
### `node:16.20.2-bullseye` - linux; arm variant v7
...
### `node:16.20.2-bullseye` - linux; arm64 variant v8
...
### `node:16.20.2-bullseye` - linux; ppc64le
...
### `node:16.20.2-bullseye` - linux; s390x
