...
```console
$ docker pull node@sha256:fb198d925db3ac13b88b4a5add7e6cc72469b2485a5d99b219d5038823c443ff
```
...
### `node:14.12.0-buster` - linux; amd64
...
### `node:14.12.0-buster` - linux; arm variant v7
...
### `node:14.12.0-buster` - linux; arm64 variant v8
...
### `node:14.12.0-buster` - linux; s390x
