...
```console
$ docker pull node@sha256:e25b8d478b3498186b171f4c3c64d03024a07abe5983db1538ba5bc1f17c08ce
```
...
### `node:22.14.0-alpine3.20` - linux; arm variant v6
...
### `node:22.14.0-alpine3.20` - linux; arm variant v7
...
### `node:22.14.0-alpine3.20` - linux; arm64 variant v8
