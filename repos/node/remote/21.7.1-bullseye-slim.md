...
```console
$ docker pull node@sha256:0573e93ab1e2a7e2433fefd56010932ea067564a3adb177395455d8847f46646
```
...
### `node:21.7.1-bullseye-slim` - linux; arm variant v7
...
### `node:21.7.1-bullseye-slim` - linux; s390x
