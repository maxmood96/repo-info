...
```console
$ docker pull node@sha256:75a69d970b53add00af55207a61f139c2d68d90173322f224de1938987a14bb6
```
...
### `node:16.14.1-alpine` - linux; arm variant v6
...
### `node:16.14.1-alpine` - linux; arm64 variant v8
...
### `node:16.14.1-alpine` - linux; ppc64le
...
### `node:16.14.1-alpine` - linux; s390x
