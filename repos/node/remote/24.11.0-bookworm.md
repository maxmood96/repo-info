...
### `node:24.11.0-bookworm` - linux; amd64
...
### `node:24.11.0-bookworm` - unknown; unknown
...
### `node:24.11.0-bookworm` - linux; arm64 variant v8
...
### `node:24.11.0-bookworm` - linux; ppc64le
...
### `node:24.11.0-bookworm` - linux; s390x
