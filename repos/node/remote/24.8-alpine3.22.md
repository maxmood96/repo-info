...
```console
$ docker pull node@sha256:537745ad19bd7f1a17d87961c243326ba89d36ef3a47bbb41ec6d1e1333aa634
```
...
### `node:24.8-alpine3.22` - linux; amd64
...
### `node:24.8-alpine3.22` - unknown; unknown
...
### `node:24.8-alpine3.22` - linux; arm64 variant v8
