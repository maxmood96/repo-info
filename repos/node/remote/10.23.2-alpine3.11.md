...
```console
$ docker pull node@sha256:7351c71024245bd1133674ce2a0869c80926712a9e03004a93cf58a066a8ad68
```
...
### `node:10.23.2-alpine3.11` - linux; s390x

```console
$ docker pull node@sha256:58b2967ae97a3f6be6628501b809fd1676b82007eb38e7867e87dea9e2a8a40a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.2 MB (27242358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6b23bb3c073cf94bf57d9051776d066e49bf06649582178d00af7c599d78b03`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
