## `node:10.23.1-alpine3.11`

```console
$ docker pull node@sha256:8176e690b8f3a03dcc1c4a12dc192c5feff834f8aca7c0674aeb132a227f4d6d
```
...
### `node:10.23.1-alpine3.11` - linux; amd64
...
### `node:10.23.1-alpine3.11` - linux; arm variant v6
...
### `node:10.23.1-alpine3.11` - linux; arm variant v7
...
### `node:10.23.1-alpine3.11` - linux; arm64 variant v8
...
### `node:10.23.1-alpine3.11` - linux; 386
...
### `node:10.23.1-alpine3.11` - linux; s390x
