...
### `node:krypton-alpine3.21` - linux; amd64
...
### `node:krypton-alpine3.21` - unknown; unknown
...
### `node:krypton-alpine3.21` - linux; arm64 variant v8
...
### `node:krypton-alpine3.21` - linux; s390x
