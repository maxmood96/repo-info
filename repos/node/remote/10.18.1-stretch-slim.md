...
### `node:10.18.1-stretch-slim` - linux; amd64
...
### `node:10.18.1-stretch-slim` - linux; arm variant v7
...
### `node:10.18.1-stretch-slim` - linux; arm64 variant v8
...
### `node:10.18.1-stretch-slim` - linux; ppc64le
...
### `node:10.18.1-stretch-slim` - linux; s390x
