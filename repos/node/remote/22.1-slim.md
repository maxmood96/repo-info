...
```console
$ docker pull node@sha256:76dfe69ccde4c5269b0198aabb4d7aa784cd35664c9ab415a93cad0cfed9fcb1
```
...
### `node:22.1-slim` - linux; arm variant v7
...
### `node:22.1-slim` - linux; arm64 variant v8
