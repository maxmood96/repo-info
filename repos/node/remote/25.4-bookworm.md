...
### `node:25.4-bookworm` - linux; amd64
...
### `node:25.4-bookworm` - unknown; unknown
...
### `node:25.4-bookworm` - linux; arm64 variant v8
...
### `node:25.4-bookworm` - linux; ppc64le
...
### `node:25.4-bookworm` - linux; s390x
