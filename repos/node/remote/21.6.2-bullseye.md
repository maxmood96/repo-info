...
```console
$ docker pull node@sha256:0848f8c40bbee7aa682b47cbd0d106c677be21cfad79fddc16ebfb97027f6d2c
```
...
### `node:21.6.2-bullseye` - linux; arm64 variant v8
...
### `node:21.6.2-bullseye` - linux; ppc64le
