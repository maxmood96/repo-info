...
```console
$ docker pull node@sha256:09f7192862e11e31ee586e94e2b51274aafa5416e595fc847f1c5cdcfe5ef652
```
...
### `node:25.6.0-alpine` - linux; amd64
...
### `node:25.6.0-alpine` - unknown; unknown
...
### `node:25.6.0-alpine` - linux; arm64 variant v8
