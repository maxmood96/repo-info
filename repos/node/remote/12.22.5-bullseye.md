...
```console
$ docker pull node@sha256:6e0c9bd866414ff4ebf286110a499d34d3cca309136da6c52d0c7a81e059e345
```
...
### `node:12.22.5-bullseye` - linux; amd64
...
### `node:12.22.5-bullseye` - linux; arm variant v7
...
### `node:12.22.5-bullseye` - linux; ppc64le
...
### `node:12.22.5-bullseye` - linux; s390x
