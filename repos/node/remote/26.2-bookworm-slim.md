...
### `node:26.2-bookworm-slim` - linux; amd64
...
### `node:26.2-bookworm-slim` - unknown; unknown
...
### `node:26.2-bookworm-slim` - linux; arm64 variant v8
...
### `node:26.2-bookworm-slim` - linux; ppc64le
...
### `node:26.2-bookworm-slim` - linux; s390x
