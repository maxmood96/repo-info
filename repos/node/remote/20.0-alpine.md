...
```console
$ docker pull node@sha256:e073f7b0b297b8b4391a777ba3c7a6d62da3585ae6bf6944f37e65830073e96b
```
...
### `node:20.0-alpine` - linux; arm variant v6
...
### `node:20.0-alpine` - linux; arm64 variant v8
...
### `node:20.0-alpine` - linux; ppc64le
