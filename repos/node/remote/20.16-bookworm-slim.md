...
```console
$ docker pull node@sha256:8880c258257c2d8fb1bdd780d0695f99b88aa9827c4c584dfe09548070040bc0
```
...
### `node:20.16-bookworm-slim` - linux; amd64
...
### `node:20.16-bookworm-slim` - unknown; unknown
...
### `node:20.16-bookworm-slim` - linux; arm variant v7
...
### `node:20.16-bookworm-slim` - linux; arm64 variant v8
...
### `node:20.16-bookworm-slim` - linux; s390x
