...
### `node:22.3.0-bookworm-slim` - linux; amd64
...
### `node:22.3.0-bookworm-slim` - unknown; unknown
...
### `node:22.3.0-bookworm-slim` - linux; arm variant v7
...
### `node:22.3.0-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.3.0-bookworm-slim` - linux; ppc64le
...
### `node:22.3.0-bookworm-slim` - linux; s390x
