...
```console
$ docker pull node@sha256:1d05ae8a4d16d201ba911ba7bde30d25d079eb7e27feaf7a99fc383b2ff63fc0
```
...
### `node:20.15.0-slim` - unknown; unknown
...
### `node:20.15.0-slim` - linux; arm64 variant v8
...
### `node:20.15.0-slim` - linux; ppc64le
