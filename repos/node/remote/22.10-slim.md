...
```console
$ docker pull node@sha256:e09207f9eca57bc0f93f35f5e252f46ce4c8f86cf2ab4ede5e2a75d1dbc9ae74
```
...
### `node:22.10-slim` - unknown; unknown
...
### `node:22.10-slim` - linux; arm variant v7
...
### `node:22.10-slim` - linux; arm64 variant v8
