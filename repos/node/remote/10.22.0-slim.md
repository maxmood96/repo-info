...
```console
$ docker pull node@sha256:af19127c2967fe0d66fc7de5ae69f22320da829073f096c9b60b5b033608c199
```
...
### `node:10.22.0-slim` - linux; arm variant v7
...
### `node:10.22.0-slim` - linux; arm64 variant v8
...
### `node:10.22.0-slim` - linux; ppc64le
