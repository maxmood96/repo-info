...
```console
$ docker pull node@sha256:07e12b8ad3affc3e2194a3908eb43061057ddd3bb336348bebba3bffb54c6649
```
...
### `node:15.11.0-alpine3.11` - linux; amd64
...
### `node:15.11.0-alpine3.11` - linux; arm variant v6
...
### `node:15.11.0-alpine3.11` - linux; arm variant v7
...
### `node:15.11.0-alpine3.11` - linux; arm64 variant v8
