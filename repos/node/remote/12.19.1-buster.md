...
```console
$ docker pull node@sha256:1de7da2ed55803460c4be2c70d14042d8233d78f493203278b3305d9299117d9
```
...
### `node:12.19.1-buster` - linux; amd64
...
### `node:12.19.1-buster` - linux; arm variant v7
...
### `node:12.19.1-buster` - linux; arm64 variant v8
...
### `node:12.19.1-buster` - linux; s390x
