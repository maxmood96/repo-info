...
```console
$ docker pull node@sha256:7c201b76ab7be1895ac4fb02f2e4fb6952acd6d8ba5dffe2208013015c3661bd
```
...
```console
$ docker pull node@sha256:59cf80e6bc1961bcc2c16fbe03474620f5dfb8877665cbd5601e54198dec1a2c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.7 MB (68684172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64a1be796b5d471eb8a7ba1662e9e4673faa3df54f51d5d0281a335ece311f11`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:453d44bdb681acf3caf3e809f89d8d05d6cf9d7bd189495633ecc0694580f716
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.7 MB (75723003 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b86adc6daba5cb9b0948dc7c44b36d653ea5dea0d23ce898110dc5ebdca5b62`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
