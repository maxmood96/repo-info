...
```console
$ docker pull node@sha256:a8d2de4e612f4cd9235a8f49f830adbfb55f7387bccec4e98c80f2542cc85807
```
...
```console
$ docker pull node@sha256:82f5e3b8e7daa2915374a24dd6051b4c380e16b7b35c2d58825dad82750b3751
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.5 MB (63514654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2875f6ff0571b061ce03f2b207be9a723798bb698639892599735ea9d2902d91`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:1295059f1e119779d1f1dafbe4d1ab963077dd46fe64e94c0b187847b9460d26
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.0 MB (68964906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e83f041483db9bc6aad3052abc73e911756602ec7c8be48b8e2d8e5dc24486ab`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:f9f5712782b204a78cf1c64d743161fef2f1452273e2111ccd18f5702f7ba3f5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.3 MB (68316114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1718d5528e63c2ee6b0a77ee9a6018c867ad74ff4ea18f7f65c7b6fa4219cc34`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
