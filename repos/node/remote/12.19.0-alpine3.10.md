...
```console
$ docker pull node@sha256:c418d3c684d78a8663a9b5ff546fcfc0b19e20a65482a470b3669744a80d51dc
```
...
### `node:12.19.0-alpine3.10` - linux; arm64 variant v8
...
### `node:12.19.0-alpine3.10` - linux; ppc64le
...
### `node:12.19.0-alpine3.10` - linux; s390x
