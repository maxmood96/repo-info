...
```console
$ docker pull node@sha256:5805565d6b5d5cc9aa0bfbd8b355b43cf0c15bdf79fa552b15800f1aa418e49f
```
...
### `node:24.0-alpine3.20` - linux; amd64
...
### `node:24.0-alpine3.20` - unknown; unknown
...
### `node:24.0-alpine3.20` - linux; arm64 variant v8
...
### `node:24.0-alpine3.20` - linux; s390x
