...
```console
$ docker pull node@sha256:7680f9f4fe58bbc883508bf57b329f66590fdf3e44074112653c501ff5b7b155
```
...
### `node:13.8-buster` - linux; arm variant v7
...
### `node:13.8-buster` - linux; arm64 variant v8
...
### `node:13.8-buster` - linux; ppc64le
