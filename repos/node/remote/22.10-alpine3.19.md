...
### `node:22.10-alpine3.19` - linux; amd64
...
### `node:22.10-alpine3.19` - unknown; unknown
...
### `node:22.10-alpine3.19` - linux; arm variant v6
...
### `node:22.10-alpine3.19` - linux; arm variant v7
...
### `node:22.10-alpine3.19` - linux; arm64 variant v8
...
### `node:22.10-alpine3.19` - linux; s390x
