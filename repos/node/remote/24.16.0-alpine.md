...
```console
$ docker pull node@sha256:bd211d5b08003cde22bf3f3fd6ec9d081849b41ede8a94bcd2b6b1fe69060a1c
```
...
### `node:24.16.0-alpine` - linux; amd64
...
### `node:24.16.0-alpine` - unknown; unknown
...
### `node:24.16.0-alpine` - linux; arm64 variant v8
