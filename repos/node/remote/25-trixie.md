...
```console
$ docker pull node@sha256:d025db21ff5c5a8682fa017580f075ff234cfe395596bbb91dfe7fcb5dc78738
```
...
```console
$ docker pull node@sha256:f8a264eb89fb771f7300ba7981e2c06cb2fa350afec804c0debe2157e7cb098e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **437.6 MB (437620229 bytes)**  
...
# Wed, 11 Mar 2026 14:02:25 GMT
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node # buildkit
# Wed, 11 Mar 2026 14:02:34 GMT
...
-	Layers:
	...
	-	`sha256:a793e3c6bce826c77a6bfec52e3e42691937f0e5701d8efa06d32850314d3f30`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:369092f7f4bdae75ab3612b3b37b01d48c73f0f235dd8615a95095aa6876f312`  
		Last Modified: Wed, 11 Mar 2026 14:03:04 GMT  
		Size: 3.3 KB (3326 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:18938970d3bb3ea0267f0176b5c78d5bbcac2ff07348c8a69a13a50191a09f8b`  
		Last Modified: Wed, 11 Mar 2026 14:03:06 GMT  
		Size: 57.6 MB (57648667 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0ce082ed6a9c84681de78e78c04494ba6d1e0eef7848d92bbe7b20abc94d167c`  
		Last Modified: Wed, 11 Mar 2026 14:03:04 GMT  
		Size: 1.3 MB (1250674 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:dada867e96cb7eb2e46d1d8194540e8c5468bb5bf0da7b57dfa21395c700cc63`  
		Last Modified: Wed, 11 Mar 2026 14:03:04 GMT  
		Size: 447.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull node@sha256:f72f7e9ecf8323c629f9eee59629ed04444cb83ad1c7f0f583687b4de3b0f712
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17451752 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e10b93cd5ce7e64b261395c0b69403b5a96299f44843ac05985efc1816cf44a7`

```dockerfile
```

-	Layers:
	-	`sha256:1edf3959ab9a91e728b5b0458b1dc5ec544b16908f98afa7da5974ba749dfdca`  
		Last Modified: Wed, 11 Mar 2026 14:03:05 GMT  
		Size: 17.4 MB (17428739 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d778bc3bea9f529b6cc31e17dea14f9b510f933397e8bf78e1287929421755ed`  
		Last Modified: Wed, 11 Mar 2026 14:03:04 GMT  
...
```console
$ docker pull node@sha256:bc9980b4b96a567eb5ed67e886fa135139c1bb5db9da18d07f1e4109c73406ff
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **427.6 MB (427630068 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e018209e7508350d2cd88b328bdf71f2e71c7c0f36d4ddae3bc2248262e78827`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		autoconf 		automake 		bzip2 		default-libmysqlclient-dev 		dpkg-dev 		file 		g++ 		gcc 		imagemagick 		libbz2-dev 		libc6-dev 		libcurl4-openssl-dev 		libdb-dev 		libevent-dev 		libffi-dev 		libgdbm-dev 		libglib2.0-dev 		libgmp-dev 		libjpeg-dev 		libkrb5-dev 		liblzma-dev 		libmagickcore-dev 		libmagickwand-dev 		libmaxminddb-dev 		libncurses5-dev 		libncursesw5-dev 		libpng-dev 		libpq-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		libtool 		libwebp-dev 		libxml2-dev 		libxslt-dev 		libyaml-dev 		make 		patch 		unzip 		xz-utils 		zlib1g-dev 	; 	apt-get dist-clean # buildkit
# Wed, 11 Mar 2026 14:03:21 GMT
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node # buildkit
# Wed, 11 Mar 2026 14:03:31 GMT
ENV NODE_VERSION=25.8.1
# Wed, 11 Mar 2026 14:03:31 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && export GNUPGHOME="$(mktemp -d)"   && set -ex   && for key in     5BE8A3F6C8A5C01D106C0AD820B1A390B168D356     DD792F5973C6DE52C432CBDAC77ABFA00DDBF2B7     CC68F5A3106FF448322E48ED27F5E38D5B0A215F     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     890C08DB8579162FEE0DF9DB8BEAB4DFCF555EF4     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     108F52B48DB57BB0CC439B2997B01419BD92F80A     A363A499291CBBC940DD62E41F10027AF002F8B0   ; do       { gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ||       { gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version   && rm -rf /tmp/* # buildkit
# Wed, 11 Mar 2026 14:03:31 GMT
ENV YARN_VERSION=1.22.22
# Wed, 11 Mar 2026 14:03:34 GMT
RUN set -ex   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     { gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ||     { gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" && gpg --batch --fingerprint "$key"; } ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version   && rm -rf /tmp/* # buildkit
# Wed, 11 Mar 2026 14:03:34 GMT
COPY docker-entrypoint.sh /usr/local/bin/ # buildkit
# Wed, 11 Mar 2026 14:03:34 GMT
...
-	Layers:
	...
	-	`sha256:201c8c69ba46d9fc7a70eadebc93f11cafc4cb32146aeb3e3cb9076d26ba5ded`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bf5d6d9b07c395126fc29fd2a8f6aee6a0b10127a740d99eb063ca22ce879841`  
		Last Modified: Wed, 11 Mar 2026 14:04:03 GMT  
		Size: 3.3 KB (3327 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9ba46f5c3ff8b86957cbcb14cad61b3b6a0a1759b104b241884d500442246d68`  
		Last Modified: Wed, 11 Mar 2026 14:04:07 GMT  
		Size: 58.0 MB (57950580 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cc02152956e9e537f20fd4aadf3fcb4434f05e6763496f9365f351e0abd772c9`  
		Last Modified: Wed, 11 Mar 2026 14:04:03 GMT  
		Size: 1.3 MB (1250673 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b5549630113eb6fc795f1fc7a85ae8edebf313ab6eea2d4b4b37f1bff80ea920`  
		Last Modified: Wed, 11 Mar 2026 14:04:03 GMT  
		Size: 448.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull node@sha256:04b5082a008f27ef05215ad5bbd395d8571d346df22a05c275ddf77c0261f9ff
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17536217 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54072d919fc53f47c894cc553f0d032460dd471eec5d91f70a1963cef5581ef7`

```dockerfile
```

-	Layers:
	-	`sha256:887e99fdb37af1124bb9f6a3cde61f04fea650a769f94c490b6c13f6e2445f70`  
		Last Modified: Wed, 11 Mar 2026 14:04:05 GMT  
		Size: 17.5 MB (17513057 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d0f4cdec9687637084611b71b945c7fd5f68abb095205b17f98de7b96ad812b6`  
		Last Modified: Wed, 11 Mar 2026 14:04:03 GMT  
