## `node:16.2-stretch-slim`

```console
$ docker pull node@sha256:17894b3080b2c2c52e824f10eb0a704a324300b6cc51b6fb61afd97e7aa8fcf3
```
...
### `node:16.2-stretch-slim` - linux; amd64
...
### `node:16.2-stretch-slim` - linux; arm variant v7
...
### `node:16.2-stretch-slim` - linux; arm64 variant v8
