...
### `node:12.22.5-bullseye-slim` - linux; amd64
...
### `node:12.22.5-bullseye-slim` - linux; arm variant v7
...
### `node:12.22.5-bullseye-slim` - linux; arm64 variant v8
...
### `node:12.22.5-bullseye-slim` - linux; ppc64le
...
### `node:12.22.5-bullseye-slim` - linux; s390x
