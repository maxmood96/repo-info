...
### `node:24.13.1-trixie` - linux; amd64
...
### `node:24.13.1-trixie` - unknown; unknown
...
### `node:24.13.1-trixie` - linux; arm64 variant v8
...
### `node:24.13.1-trixie` - linux; ppc64le
...
### `node:24.13.1-trixie` - linux; s390x
