...
```console
$ docker pull node@sha256:1a8bc4dc4720f0eb2f68d1883fd09f939103bd6df3848e0ffdc919d7fbf4dee1
```
...
### `node:20.16.0-alpine` - linux; amd64
...
### `node:20.16.0-alpine` - unknown; unknown
...
### `node:20.16.0-alpine` - linux; arm variant v6
...
### `node:20.16.0-alpine` - linux; arm variant v7
...
### `node:20.16.0-alpine` - linux; arm64 variant v8
...
### `node:20.16.0-alpine` - linux; s390x
