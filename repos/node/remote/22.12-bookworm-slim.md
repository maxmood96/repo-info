...
```console
$ docker pull node@sha256:af534e18ad023c8dc7a420f636a1617f40887a57d4771a08a1ad045b837947d6
```
...
### `node:22.12-bookworm-slim` - linux; amd64
...
### `node:22.12-bookworm-slim` - unknown; unknown
...
### `node:22.12-bookworm-slim` - linux; arm64 variant v8
...
### `node:22.12-bookworm-slim` - linux; ppc64le
...
### `node:22.12-bookworm-slim` - linux; s390x
