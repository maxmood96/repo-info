...
```console
$ docker pull node@sha256:45073841796801b2e434d177e64ff13f9f7cd7605545271ea1d61b3ad321f106
```
...
### `node:16.12-alpine3.11` - linux; amd64
...
### `node:16.12-alpine3.11` - linux; arm variant v6
...
### `node:16.12-alpine3.11` - linux; arm64 variant v8
...
### `node:16.12-alpine3.11` - linux; s390x
