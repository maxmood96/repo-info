...
```console
$ docker pull node@sha256:7b5d127ed528aea140c88229044212fdda3e2d986aa0273c10e22192ec592814
```
...
### `node:25.6.1-alpine3.23` - linux; amd64
...
### `node:25.6.1-alpine3.23` - unknown; unknown
...
### `node:25.6.1-alpine3.23` - linux; arm64 variant v8
