...
```console
$ docker pull node@sha256:4559b5234c04ce141bd9bb6d73d69fbd6877ae149abc46e3590048ab3243b349
```
...
### `node:24.15-trixie-slim` - linux; amd64
...
### `node:24.15-trixie-slim` - unknown; unknown
...
### `node:24.15-trixie-slim` - linux; arm64 variant v8
...
### `node:24.15-trixie-slim` - linux; ppc64le
...
### `node:24.15-trixie-slim` - linux; s390x
