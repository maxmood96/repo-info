...
```console
$ docker pull node@sha256:737a79aa55f93c43b8a7da16ce96349a82fe3b398b7d5d7c506b7bfe36b7414f
```
...
### `node:16.10.0-buster-slim` - linux; amd64
...
### `node:16.10.0-buster-slim` - linux; arm variant v7
...
### `node:16.10.0-buster-slim` - linux; s390x
