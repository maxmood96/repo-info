...
```console
$ docker pull node@sha256:77f3c4d1f33c17dfa4af4b0add57d86957187873e313c2c37f52831d117645c8
```
...
### `node:24.9-alpine3.22` - linux; amd64
...
### `node:24.9-alpine3.22` - unknown; unknown
...
### `node:24.9-alpine3.22` - linux; arm64 variant v8
...
### `node:24.9-alpine3.22` - linux; s390x
