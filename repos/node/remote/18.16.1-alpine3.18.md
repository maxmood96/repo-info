...
### `node:18.16.1-alpine3.18` - linux; arm variant v6
...
### `node:18.16.1-alpine3.18` - linux; arm variant v7
...
### `node:18.16.1-alpine3.18` - linux; arm64 variant v8
...
### `node:18.16.1-alpine3.18` - linux; ppc64le
...
### `node:18.16.1-alpine3.18` - linux; s390x
