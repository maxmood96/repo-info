...
### `node:22.19-alpine3.22` - linux; amd64
...
### `node:22.19-alpine3.22` - unknown; unknown
...
### `node:22.19-alpine3.22` - linux; arm variant v6
...
### `node:22.19-alpine3.22` - linux; arm variant v7
...
### `node:22.19-alpine3.22` - linux; arm64 variant v8
...
### `node:22.19-alpine3.22` - linux; s390x
