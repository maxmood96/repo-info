...
```console
$ docker pull node@sha256:d5e370afa3a120b6969f57629bcfc29093f8b85b635456a61de556debcec4d79
```
...
### `node:22.5-alpine3.19` - linux; amd64
...
### `node:22.5-alpine3.19` - unknown; unknown
...
### `node:22.5-alpine3.19` - linux; arm variant v6
...
### `node:22.5-alpine3.19` - linux; arm variant v7
...
### `node:22.5-alpine3.19` - linux; arm64 variant v8
...
### `node:22.5-alpine3.19` - linux; s390x
