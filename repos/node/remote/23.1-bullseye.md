...
```console
$ docker pull node@sha256:a24078443f9ac8a3ecc5e6ecb2194ce6997f7083199ac7f35bdce335d6f4b527
```
...
### `node:23.1-bullseye` - linux; amd64
...
### `node:23.1-bullseye` - unknown; unknown
