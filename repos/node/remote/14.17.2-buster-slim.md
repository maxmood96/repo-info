...
```console
$ docker pull node@sha256:415f59555c5327f15c0f1487755f4759fbffc57110a681fb3b4567ad78373937
```
...
### `node:14.17.2-buster-slim` - linux; arm64 variant v8
...
### `node:14.17.2-buster-slim` - linux; s390x
