...
```console
$ docker pull node@sha256:effbd0ea5e7501f488707c8430651c078ae177df0d05a83bd0cce97634ae88f1
```
...
### `node:14.14-buster-slim` - linux; arm64 variant v8
...
### `node:14.14-buster-slim` - linux; s390x
