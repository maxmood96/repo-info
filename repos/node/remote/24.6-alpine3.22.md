## `node:24.6-alpine3.22`

```console
$ docker pull node@sha256:1c4562a706f784ad6ada8d21917442e8b50b3ed3ffbfb208b3ab51518741f479
```
...
### `node:24.6-alpine3.22` - linux; amd64
...
### `node:24.6-alpine3.22` - unknown; unknown
...
### `node:24.6-alpine3.22` - linux; arm64 variant v8
