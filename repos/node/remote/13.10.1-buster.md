...
```console
$ docker pull node@sha256:387f099fea42cdf3d842207ea3147af8e0b2fe6cfc058d55243e828bda2a82d2
```
...
### `node:13.10.1-buster` - linux; arm variant v7
...
### `node:13.10.1-buster` - linux; arm64 variant v8
...
### `node:13.10.1-buster` - linux; s390x
