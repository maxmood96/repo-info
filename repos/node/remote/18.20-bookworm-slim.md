...
```console
$ docker pull node@sha256:9ea28e09082d1aa86750859cefbcca5e0baf49bdcf071fc7bfa490d3ff313403
```
...
```console
$ docker pull node@sha256:f9194abe53cf1be26a03bb233f883fd6673b882d8e889dc9be45bcef8c3946ad
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **67.6 MB (67635862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9782f81fff5b8f614932f69a9430abebe6e3bdbfeecd4fc8feddc69f61747709`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
```console
$ docker pull node@sha256:9bc9d9dd7e4d7a0c828793b5376929884f8b642d86e5ea038579836587919990
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2497086 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e278dc587b730e1b016587b982cd919ad432bb7efe19186cdcabc6203943b83e`

```dockerfile
```

-	Layers:
	-	`sha256:a5e23bf6a510abe4665f58f59c4b349815cc571797f3cd32a828a30b85af7b4d`  
		Last Modified: Fri, 21 Jun 2024 16:10:53 GMT  
		Size: 2.5 MB (2470216 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c2ee544ba31dc95f913955e8d00df8f80e15c4f861f3190be211b9cc58756437`  
		Last Modified: Fri, 21 Jun 2024 16:10:52 GMT  
		Size: 26.9 KB (26870 bytes)  
		MIME: application/vnd.in-toto+json
