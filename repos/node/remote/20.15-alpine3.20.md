...
```console
$ docker pull node@sha256:0ccc08fadfe696f2959f59404ce0d90461c834a7465c4a563c62c0fef4089885
```
...
### `node:20.15-alpine3.20` - linux; amd64
...
### `node:20.15-alpine3.20` - unknown; unknown
...
### `node:20.15-alpine3.20` - linux; arm variant v6
...
### `node:20.15-alpine3.20` - linux; arm64 variant v8
...
### `node:20.15-alpine3.20` - linux; ppc64le
...
### `node:20.15-alpine3.20` - linux; s390x
