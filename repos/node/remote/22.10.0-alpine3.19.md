...
```console
$ docker pull node@sha256:2d9bec91961b5940c835829301aab8a38af56bede38abab2d23003359e41dd84
```
...
### `node:22.10.0-alpine3.19` - linux; amd64
...
### `node:22.10.0-alpine3.19` - unknown; unknown
...
### `node:22.10.0-alpine3.19` - linux; arm variant v6
...
### `node:22.10.0-alpine3.19` - linux; arm64 variant v8
...
### `node:22.10.0-alpine3.19` - linux; s390x
