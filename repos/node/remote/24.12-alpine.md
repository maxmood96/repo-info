...
```console
$ docker pull node@sha256:951203ef9d4e576c355194222fd19c2c7736f91228deb112675414ae3a7c9046
```
...
### `node:24.12-alpine` - unknown; unknown
...
### `node:24.12-alpine` - linux; arm64 variant v8
