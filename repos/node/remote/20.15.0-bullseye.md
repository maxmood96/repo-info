...
```console
$ docker pull node@sha256:d13caa9c51c77c40dce433dc6ab9db3af3664c052417e684a291cad0af04f904
```
...
### `node:20.15.0-bullseye` - linux; amd64
...
### `node:20.15.0-bullseye` - unknown; unknown
...
### `node:20.15.0-bullseye` - linux; arm64 variant v8
...
### `node:20.15.0-bullseye` - linux; ppc64le
...
### `node:20.15.0-bullseye` - linux; s390x
