...
### `node:20.18-alpine3.19` - linux; amd64
...
### `node:20.18-alpine3.19` - unknown; unknown
...
### `node:20.18-alpine3.19` - linux; arm variant v6
...
### `node:20.18-alpine3.19` - linux; arm variant v7
...
### `node:20.18-alpine3.19` - linux; arm64 variant v8
...
### `node:20.18-alpine3.19` - linux; ppc64le
...
### `node:20.18-alpine3.19` - linux; s390x
