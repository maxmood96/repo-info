...
### `node:20.15.1-alpine3.19` - linux; amd64
...
### `node:20.15.1-alpine3.19` - linux; arm variant v6
...
### `node:20.15.1-alpine3.19` - linux; arm variant v7
...
### `node:20.15.1-alpine3.19` - linux; arm64 variant v8
...
### `node:20.15.1-alpine3.19` - linux; s390x
