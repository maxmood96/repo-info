...
```console
$ docker pull node@sha256:4bdb1652bb73a431f62183744469d6f909f6bb1d0d1a0becdf588391d1583092
```
...
### `node:22.13.0-alpine3.20` - linux; amd64
...
### `node:22.13.0-alpine3.20` - unknown; unknown
...
### `node:22.13.0-alpine3.20` - linux; arm variant v6
...
### `node:22.13.0-alpine3.20` - linux; arm64 variant v8
...
### `node:22.13.0-alpine3.20` - linux; s390x
