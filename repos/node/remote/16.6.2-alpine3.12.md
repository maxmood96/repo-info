...
### `node:16.6.2-alpine3.12` - linux; arm variant v6
...
### `node:16.6.2-alpine3.12` - linux; arm variant v7
...
### `node:16.6.2-alpine3.12` - linux; arm64 variant v8
...
### `node:16.6.2-alpine3.12` - linux; ppc64le
...
### `node:16.6.2-alpine3.12` - linux; s390x
