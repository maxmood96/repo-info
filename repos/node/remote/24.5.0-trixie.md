...
### `node:24.5.0-trixie` - linux; amd64
...
### `node:24.5.0-trixie` - unknown; unknown
...
### `node:24.5.0-trixie` - linux; arm64 variant v8
...
### `node:24.5.0-trixie` - linux; ppc64le
...
### `node:24.5.0-trixie` - linux; s390x
