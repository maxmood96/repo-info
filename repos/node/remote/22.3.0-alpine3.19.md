...
```console
$ docker pull node@sha256:8d7348d334454cbd2a9336195a041445dcc63e8b7e54c049de805dc61eba2e6b
```
...
### `node:22.3.0-alpine3.19` - linux; amd64
...
### `node:22.3.0-alpine3.19` - unknown; unknown
...
### `node:22.3.0-alpine3.19` - linux; arm variant v6
...
### `node:22.3.0-alpine3.19` - linux; arm variant v7
...
### `node:22.3.0-alpine3.19` - linux; arm64 variant v8
...
### `node:22.3.0-alpine3.19` - linux; s390x
