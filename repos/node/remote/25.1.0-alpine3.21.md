...
```console
$ docker pull node@sha256:ae5450f1718750a702d6f66ad61d73fbb6d2f654bb3b67f7187e7e2996883832
```
...
### `node:25.1.0-alpine3.21` - linux; amd64
...
### `node:25.1.0-alpine3.21` - unknown; unknown
...
### `node:25.1.0-alpine3.21` - linux; arm64 variant v8
