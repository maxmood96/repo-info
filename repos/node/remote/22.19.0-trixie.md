...
```console
$ docker pull node@sha256:736673f211735567ff0efc17da39573d67e1434fa2f4165852d2ccd3b13f2114
```
...
### `node:22.19.0-trixie` - linux; amd64
...
### `node:22.19.0-trixie` - unknown; unknown
...
### `node:22.19.0-trixie` - linux; arm64 variant v8
...
### `node:22.19.0-trixie` - linux; ppc64le
