...
```console
$ docker pull node@sha256:8537ef3730c911a14b5b2dea441e0bad8705fbf76c218a1af76cbff364c6d3b4
```
...
### `node:14.19.2-bullseye` - linux; ppc64le
...
### `node:14.19.2-bullseye` - linux; s390x
