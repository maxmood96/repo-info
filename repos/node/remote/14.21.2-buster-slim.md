## `node:14.21.2-buster-slim`

```console
$ docker pull node@sha256:bc86c668c28a5bd50572a4e1f291e1a40eb24e452f0ed51363c391dd70668e32
```
...
### `node:14.21.2-buster-slim` - linux; amd64
...
### `node:14.21.2-buster-slim` - linux; arm variant v7
...
### `node:14.21.2-buster-slim` - linux; arm64 variant v8
