...
```console
$ docker pull node@sha256:6e6fdca8006b268936d285a4eadd0bac011b33184b4377c6f1cfc86c222fbb8d
```
...
### `node:10.19.0-alpine3.11` - linux; amd64
...
### `node:10.19.0-alpine3.11` - linux; arm variant v6
...
### `node:10.19.0-alpine3.11` - linux; arm variant v7
...
### `node:10.19.0-alpine3.11` - linux; arm64 variant v8
...
### `node:10.19.0-alpine3.11` - linux; 386
...
### `node:10.19.0-alpine3.11` - linux; ppc64le
...
### `node:10.19.0-alpine3.11` - linux; s390x
