...
```console
$ docker pull node@sha256:88232af703f6bc04030fba3ec474a06818c0490045d4129fe0cf569def888640
```
...
### `node:18.2-buster` - linux; arm variant v7
...
### `node:18.2-buster` - linux; arm64 variant v8
...
### `node:18.2-buster` - linux; ppc64le
