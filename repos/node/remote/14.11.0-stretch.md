...
```console
$ docker pull node@sha256:c8f53c68faa654283d9f152aff3730b1d433a503e109aae5bc1efaa102c2823a
```
...
### `node:14.11.0-stretch` - linux; amd64
...
### `node:14.11.0-stretch` - linux; arm64 variant v8
