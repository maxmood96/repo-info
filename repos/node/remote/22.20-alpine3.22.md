## `node:22.20-alpine3.22`

```console
$ docker pull node@sha256:cb3143549582cc5f74f26f0992cdef4a422b22128cb517f94173a5f910fa4ee7
```
...
### `node:22.20-alpine3.22` - linux; amd64
...
### `node:22.20-alpine3.22` - unknown; unknown
...
### `node:22.20-alpine3.22` - linux; arm variant v6
...
### `node:22.20-alpine3.22` - linux; arm variant v7
...
### `node:22.20-alpine3.22` - linux; arm64 variant v8
...
### `node:22.20-alpine3.22` - linux; s390x
