...
```console
$ docker pull node@sha256:457270b41848e27c03c2e168f01af078938e44dfc3f5620986e792bc0f04b776
```
...
### `node:23.10-alpine3.20` - linux; amd64
...
### `node:23.10-alpine3.20` - unknown; unknown
...
### `node:23.10-alpine3.20` - linux; arm variant v6
...
### `node:23.10-alpine3.20` - linux; arm variant v7
...
### `node:23.10-alpine3.20` - linux; s390x
