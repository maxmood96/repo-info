...
### `node:22.6-bullseye-slim` - linux; amd64
...
### `node:22.6-bullseye-slim` - unknown; unknown
...
### `node:22.6-bullseye-slim` - linux; arm variant v7
...
### `node:22.6-bullseye-slim` - linux; arm64 variant v8
...
### `node:22.6-bullseye-slim` - linux; ppc64le
...
### `node:22.6-bullseye-slim` - linux; s390x
