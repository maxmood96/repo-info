...
```console
$ docker pull node@sha256:9ac0b68cc6512071449ebbff6f2a205471a390eb02be45f7ee2b3d887e25c18f
```
...
### `node:22.6-bookworm` - linux; amd64
...
### `node:22.6-bookworm` - unknown; unknown
...
### `node:22.6-bookworm` - linux; arm variant v7
...
### `node:22.6-bookworm` - linux; arm64 variant v8
...
### `node:22.6-bookworm` - linux; ppc64le
