...
```console
$ docker pull node@sha256:4149a450f71699db7d695eeae3bc443e5aa97a7ff2f3a881a97e88f0d5568ee6
```
...
```console
$ docker pull node@sha256:4efeff1479b0b9b2e3f9a6a8ab6fe7900ae6fa16f91bb3eb14ed1bf3963443fe
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **395.9 MB (395865949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a2e7fdc1e7832aa6a8d991982e2904e589912f27a54ddadfd5af88c1522cb78`
...
# Thu, 13 Jun 2024 04:21:54 GMT
ENV NODE_VERSION=18.20.3
# Thu, 13 Jun 2024 04:22:11 GMT
...
-	Layers:
	...
	-	`sha256:e6762bf379915ae5a1fadf0446b0e676e49dcf5e2cf38b7f11f290fd335f6c14`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48d09b18ce83bfb99b06de2ce7a2a1ec0e2c1a5e48eba7ec7d7a55b36cd5dee4`  
		Last Modified: Thu, 13 Jun 2024 04:30:49 GMT  
		Size: 45.6 MB (45639484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd263d113ea877b444227bbd7fa316ab47dc56b4ee3554908c66fd87da13e732`  
		Last Modified: Thu, 13 Jun 2024 04:30:43 GMT  
		Size: 1.2 MB (1247070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:510b9833addd774be388e533603ddbb4052b92ae791a07dec911e77bd2e3612b`  
		Last Modified: Thu, 13 Jun 2024 04:30:42 GMT  
		Size: 450.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:ac3895c0de7a1a34422e1f8da92029975d8451ad95b9cc6de11f57221032a618
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.1 MB (412076382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93d1dd68318ae93cd91faaf57f9b15b42d6e123a2fcbcc00326634237d938332`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Thu, 13 Jun 2024 02:25:10 GMT
ENV NODE_VERSION=18.20.3
# Thu, 13 Jun 2024 02:25:28 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && export GNUPGHOME="$(mktemp -d)"   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     141F07595B7B3FFE74309A937405533BE57C7D57     74F12602B6F1C4E913FAA37AD3A89613643B6201     DD792F5973C6DE52C432CBDAC77ABFA00DDBF2B7     61FC681DFB92A079F1685E77973F295594EC4689     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     890C08DB8579162FEE0DF9DB8BEAB4DFCF555EF4     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     108F52B48DB57BB0CC439B2997B01419BD92F80A     A363A499291CBBC940DD62E41F10027AF002F8B0     CC68F5A3106FF448322E48ED27F5E38D5B0A215F   ; do       gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||       gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Thu, 13 Jun 2024 02:25:31 GMT
ENV YARN_VERSION=1.22.19
# Thu, 13 Jun 2024 02:25:35 GMT
RUN set -ex   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version   && rm -rf /tmp/*
# Thu, 13 Jun 2024 02:25:36 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Thu, 13 Jun 2024 02:25:36 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 13 Jun 2024 02:25:37 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:1a6d6cfe084ddf1b003231286742070d3474815ec1aab8794c092263bda0b683`  
		...
		Size: 3.3 KB (3346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c64018c29937b01efc1d87d68148abb8b09504d0de17b31455a3aa8cd3a6284`  
		Last Modified: Thu, 13 Jun 2024 02:33:55 GMT  
		Size: 47.7 MB (47726808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7272501ff9a404d152218cd8eab2f157f3ad9e1f77dcc0217cf7f5e1ee7f8915`  
		Last Modified: Thu, 13 Jun 2024 02:33:47 GMT  
		Size: 1.2 MB (1247067 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d6cf1ae2e756a0e692b18c60f73561470b50f27e96fb8836555a5838c1e3d87`  
		Last Modified: Thu, 13 Jun 2024 02:33:46 GMT  
		Size: 451.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
