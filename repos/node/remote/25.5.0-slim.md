...
```console
$ docker pull node@sha256:4d29e9d2ac6c60c8534a52036304e8e32baa20b4eee18957adce0becd27d138f
```
...
### `node:25.5.0-slim` - unknown; unknown
...
### `node:25.5.0-slim` - linux; arm64 variant v8
...
### `node:25.5.0-slim` - linux; ppc64le
