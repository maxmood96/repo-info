...
```console
$ docker pull node@sha256:d3033f2a32cf7224027abfe8a443f71cd3d7eae6e4da7cc33fcd0de419453a40
```
...
### `node:20.18.1-alpine3.19` - linux; amd64
...
### `node:20.18.1-alpine3.19` - unknown; unknown
...
### `node:20.18.1-alpine3.19` - linux; arm variant v6
...
### `node:20.18.1-alpine3.19` - linux; arm variant v7
...
### `node:20.18.1-alpine3.19` - linux; arm64 variant v8
...
### `node:20.18.1-alpine3.19` - linux; ppc64le
