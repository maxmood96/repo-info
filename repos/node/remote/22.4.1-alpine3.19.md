...
```console
$ docker pull node@sha256:67225d40d3fb36314e392846effda04b95c973bf52e44ea064a8e0015c83056e
```
...
### `node:22.4.1-alpine3.19` - linux; amd64
...
### `node:22.4.1-alpine3.19` - unknown; unknown
...
### `node:22.4.1-alpine3.19` - linux; arm variant v6
...
### `node:22.4.1-alpine3.19` - linux; arm variant v7
...
### `node:22.4.1-alpine3.19` - linux; arm64 variant v8
...
### `node:22.4.1-alpine3.19` - linux; s390x
