...
```console
$ docker pull node@sha256:0e51ff2dd61ec61c7faa03d14e8cdd8f80414732a9b936fa0c7161ac60231461
```
...
### `node:13.5.0-alpine` - linux; amd64
...
### `node:13.5.0-alpine` - linux; arm64 variant v8
...
### `node:13.5.0-alpine` - linux; ppc64le
...
### `node:13.5.0-alpine` - linux; s390x
