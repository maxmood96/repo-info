...
```console
$ docker pull node@sha256:653bdfae5f3ea9f259cccbfd1bed8108b08415f03d280c57d8732301b5773c5f
```
...
### `node:22.13-alpine3.21` - linux; amd64
...
### `node:22.13-alpine3.21` - unknown; unknown
...
### `node:22.13-alpine3.21` - linux; arm variant v6
...
### `node:22.13-alpine3.21` - linux; arm variant v7
...
### `node:22.13-alpine3.21` - linux; arm64 variant v8
...
### `node:22.13-alpine3.21` - linux; s390x
