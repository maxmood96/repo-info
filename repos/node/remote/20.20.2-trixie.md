...
### `node:20.20.2-trixie` - linux; amd64
...
### `node:20.20.2-trixie` - unknown; unknown
...
### `node:20.20.2-trixie` - linux; arm64 variant v8
...
### `node:20.20.2-trixie` - linux; ppc64le
...
### `node:20.20.2-trixie` - linux; s390x
