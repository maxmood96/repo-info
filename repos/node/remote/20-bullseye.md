...
```console
$ docker pull node@sha256:9844aa122d98fc760074cb361d2db7b1b76ee87a3c12ef659c365ad5050b1089
```
...
```console
$ docker pull node@sha256:70d61c4289f241e71382043d3e0d9ae4ab864dbe34f47291f391112c5ef12a65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **372.7 MB (372672155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ac675704bf3b2b9dc81f87602d10e4aa5c2cbbb1b497410aa7a3b9733b3f1c3`
...
# Wed, 10 Apr 2024 12:42:32 GMT
ENV NODE_VERSION=20.12.1
# Wed, 10 Apr 2024 12:42:48 GMT
...
# Wed, 10 Apr 2024 12:42:49 GMT
ENV YARN_VERSION=1.22.19
# Wed, 10 Apr 2024 12:42:52 GMT
...
-	Layers:
	...
	-	`sha256:df8f64bc8f142b84348228f979a7c0e4e3ef74188bfc494a6e48537eba3a7b87`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8fa85ee2c83d1342c410f792a7ba9247a10d1f74a41c7e57c64a84ed4f5e0d0`  
		Last Modified: Wed, 10 Apr 2024 12:52:25 GMT  
		Size: 48.0 MB (48032256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eeffc3e7d5e1914614d20ac5d8a03490a2e45508a75602e579ff2db4169d9ffa`  
		Last Modified: Wed, 10 Apr 2024 12:52:18 GMT  
		Size: 2.2 MB (2207112 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0738826efaad47c18723cb08df5f4898e38f50898914905d56c98551541ffdd`  
		Last Modified: Wed, 10 Apr 2024 12:52:17 GMT  
		Size: 452.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:26f29fb75e0f20c1dcae08330d4fa8da116c372394a433639f44696721923d7c
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **383.7 MB (383674247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01cab4c9367da713644868f9d4258a4358b25298d7abc9af51ce31efe1ab1b83`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Wed, 10 Apr 2024 12:34:31 GMT
ENV NODE_VERSION=20.12.1
# Wed, 10 Apr 2024 12:34:52 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && export GNUPGHOME="$(mktemp -d)"   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     141F07595B7B3FFE74309A937405533BE57C7D57     74F12602B6F1C4E913FAA37AD3A89613643B6201     DD792F5973C6DE52C432CBDAC77ABFA00DDBF2B7     61FC681DFB92A079F1685E77973F295594EC4689     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     890C08DB8579162FEE0DF9DB8BEAB4DFCF555EF4     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     108F52B48DB57BB0CC439B2997B01419BD92F80A     A363A499291CBBC940DD62E41F10027AF002F8B0     CC68F5A3106FF448322E48ED27F5E38D5B0A215F   ; do       gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||       gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Wed, 10 Apr 2024 12:34:55 GMT
ENV YARN_VERSION=1.22.19
# Wed, 10 Apr 2024 12:35:00 GMT
RUN set -ex   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Wed, 10 Apr 2024 12:35:01 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Wed, 10 Apr 2024 12:35:01 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 10 Apr 2024 12:35:02 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:a099280dd0f6e916cf68fee48f26196455e6a82f7f4b39e5ecbfcba46385a83b`  
		...
		Size: 4.2 KB (4199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c6cce3764a88da523fb28f207a15d2390b570341d64946f3f78a579fd74c4ed`  
		Last Modified: Wed, 10 Apr 2024 12:46:28 GMT  
		Size: 50.5 MB (50519584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bbe3f1cb4020821ec106fc85bcf69ca8c3ffac734d36529873da97597e55d27`  
		Last Modified: Wed, 10 Apr 2024 12:46:19 GMT  
		Size: 2.2 MB (2207184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ad8b0071a0119f802d189ef5327b4cd861c17ee4f368831c56c92fc08614ae1`  
		Last Modified: Wed, 10 Apr 2024 12:46:18 GMT  
		Size: 451.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
