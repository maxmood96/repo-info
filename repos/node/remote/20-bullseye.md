...
```console
$ docker pull node@sha256:127328164f9b593a2f23725a0525bafce697a6edce92fbf51a255dc6ae70af86
```
...
```console
$ docker pull node@sha256:c185dc32a90354a5e0bfeaa603fe502323653fb1e404522ef1f16d87b799e6eb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.3 MB (329313752 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5194983186c9d5ba81bed8601c78e6d1ba6565b85b26d084418ca59832db4033`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
ENV YARN_VERSION=1.22.19
# Thu, 11 Apr 2024 17:05:20 GMT
RUN set -ex   && export GNUPGHOME="$(mktemp -d)"   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && gpgconf --kill all   && rm -rf "$GNUPGHOME"   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Thu, 11 Apr 2024 17:05:21 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Thu, 11 Apr 2024 17:05:21 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 11 Apr 2024 17:05:21 GMT
...
-	Layers:
	...
	-	`sha256:2ea8ccb7d72fddec93ac0cbd47d8dafc7ad3479b02f81cf5929ca5ed007081ad`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91812a594c5e492888c430099114dc0b526dd8a560b864157d6f10f6002c8cc5`  
		Last Modified: Thu, 11 Apr 2024 18:41:51 GMT  
		Size: 2.2 MB (2199030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbd3452e52faef5221ee60d65a312d9edc1dac946c75fb83112c6eb0a802d12f`  
		Last Modified: Thu, 11 Apr 2024 18:41:50 GMT  
		Size: 453.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:9b646e0befc2074b98743106f565f73598fbfa8b50dd4b45513253bc5bdc3d95
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.1 MB (346098746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fda380ff935d82f96f562a1b838ad970218803f0a9cfe5988af7683382d2cb7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
-	Layers:
	...
	-	`sha256:51820acb8a74b540b6d386e2b8bda59ad0b40621c094230974857cced9ebbb42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44094f047c108e609f9c6c3d1a49aa994133c4dc0395f2a52582e9ef33e7de5f`  
		Last Modified: Thu, 11 Apr 2024 19:18:29 GMT  
		Size: 2.2 MB (2209016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0588e293007c39ae35901dac61aeb7b6f6c0cc302d99664ab876017920140574`  
		Last Modified: Thu, 11 Apr 2024 19:18:28 GMT  
		Size: 452.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
