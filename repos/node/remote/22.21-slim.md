...
```console
$ docker pull node@sha256:d3777a194206dc2f066d7a688881dbdd330dd3fc58734fa14a159d65393d344d
```
...
### `node:22.21-slim` - unknown; unknown
...
### `node:22.21-slim` - linux; arm variant v7
...
### `node:22.21-slim` - linux; arm64 variant v8
