...
```console
$ docker pull node@sha256:d922a9e03df81e73081dbf73566c7e9aa5b96283000d0103a3be94976b138c16
```
...
### `node:24.13.1-alpine3.22` - linux; amd64
...
### `node:24.13.1-alpine3.22` - unknown; unknown
...
### `node:24.13.1-alpine3.22` - linux; arm64 variant v8
