...
### `node:24.9.0-trixie-slim` - linux; amd64
...
### `node:24.9.0-trixie-slim` - unknown; unknown
...
### `node:24.9.0-trixie-slim` - linux; arm64 variant v8
...
### `node:24.9.0-trixie-slim` - linux; ppc64le
...
### `node:24.9.0-trixie-slim` - linux; s390x
