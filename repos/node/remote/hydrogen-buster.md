...
```console
$ docker pull node@sha256:a952b666c0cd9e82647fedcb3a1c6f69566926ac2a5541c16bdcf37d017a65c0
```
...
```console
$ docker pull node@sha256:d6a2767f500dc456b6da073669716a82efc32d48025b87c079796ce57adad19a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.6 MB (359587957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b19ea8d36654057f9f25978ab8c7a04a2d7bec0cef6450a8f00fc384c7745eec`
...
# Wed, 21 Jun 2023 17:26:57 GMT
ENV NODE_VERSION=18.16.1
# Wed, 21 Jun 2023 17:27:11 GMT
...
-	Layers:
	...
	-	`sha256:fef4c88d94e02cc3c1c0c4035fb4b4c3292cfd9596edc87305af0fa30745422d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e4bf9f65f09db811978574dd44c61c4af765d753974379ffd2c9ddedf310b31`  
		Last Modified: Wed, 21 Jun 2023 17:38:42 GMT  
		Size: 45.5 MB (45532158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d4422308350357122e6eb6150e7037855d6dee5e6e95620149d81fae0f64342`  
		Last Modified: Wed, 21 Jun 2023 17:38:36 GMT  
		Size: 2.3 MB (2276313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14449e0f002e49fb547e971725cc92776b696e3ae412b6f3da335df3981afdd5`  
		Last Modified: Wed, 21 Jun 2023 17:38:36 GMT  
		Size: 450.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull node@sha256:808e52ad2d39e727fbcfd2d097a9861a354d055f245ce60fbbc5122d7300ca36
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.2 MB (350244967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f7fd2b12354ae5b7e76affe74f0fada26c5f989a771a300ccf043800fb8801f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node"]`
...
RUN groupadd --gid 1000 node   && useradd --uid 1000 --gid node --shell /bin/bash --create-home node
# Wed, 21 Jun 2023 19:16:35 GMT
ENV NODE_VERSION=18.16.1
# Wed, 21 Jun 2023 19:16:48 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && set -ex   && for key in     4ED778F539E3634C779C87C6D7062848A1AB005C     141F07595B7B3FFE74309A937405533BE57C7D57     74F12602B6F1C4E913FAA37AD3A89613643B6201     DD792F5973C6DE52C432CBDAC77ABFA00DDBF2B7     61FC681DFB92A079F1685E77973F295594EC4689     8FCCA13FEF1D0C2E91008E09770F7A9A5AE15600     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     890C08DB8579162FEE0DF9DB8BEAB4DFCF555EF4     C82FA3AE1CBEDC6BE46B9360C43CEC45C17AB93C     108F52B48DB57BB0CC439B2997B01419BD92F80A   ; do       gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||       gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -fsSLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs   && node --version   && npm --version
# Wed, 21 Jun 2023 19:16:48 GMT
ENV YARN_VERSION=1.22.19
# Wed, 21 Jun 2023 19:16:51 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$key" ||     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key" ;   done   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fsSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn-v$YARN_VERSION/bin/yarnpkg /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && yarn --version
# Wed, 21 Jun 2023 19:16:51 GMT
COPY file:4d192565a7220e135cab6c77fbc1c73211b69f3d9fb37e62857b2c6eb9363d51 in /usr/local/bin/ 
# Wed, 21 Jun 2023 19:16:51 GMT
...
-	Layers:
	...
	-	`sha256:39306f6d5fdc94a315748f96c707d29011dd4dc18e0b370e38bfeb16ca1244d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:798df9b9f8131507bd563c5505b2e1e9e70d6183274b60ff3e8efd2d1b3711ca`  
		Last Modified: Wed, 21 Jun 2023 20:03:42 GMT  
		Size: 45.6 MB (45596852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f404e5c01851242de2c3af20b3b083f045735dd2a5bc8dfd09533d6f59972ec6`  
		Last Modified: Wed, 21 Jun 2023 20:03:37 GMT  
		Size: 2.3 MB (2276077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87eb2f1bcb607f844e5fb1a0400fc3c85db681a69170034a6f5258c3c0af9fd0`  
		Last Modified: Wed, 21 Jun 2023 20:03:36 GMT  
		Size: 450.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
