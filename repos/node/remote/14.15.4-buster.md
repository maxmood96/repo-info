...
```console
$ docker pull node@sha256:728603664fb201e2a5ff0155d866bc493deabb4d8bd7f9d274aa55328b796214
```
...
### `node:14.15.4-buster` - linux; arm variant v7
...
### `node:14.15.4-buster` - linux; arm64 variant v8
...
### `node:14.15.4-buster` - linux; s390x
