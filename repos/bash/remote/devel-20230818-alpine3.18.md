...
### `bash:devel-20230818-alpine3.18` - linux; arm64 variant v8
...
### `bash:devel-20230818-alpine3.18` - linux; 386
...
### `bash:devel-20230818-alpine3.18` - linux; ppc64le
...
### `bash:devel-20230818-alpine3.18` - linux; s390x
