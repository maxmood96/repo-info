...
```console
$ docker pull bash@sha256:00ea42ee300f5be570d155fb39fe1ddc66e44ef0a07fdea27591fb5f316da22d
```
...
### `bash:devel-20221024` - linux; amd64
...
### `bash:devel-20221024` - linux; arm variant v6
...
### `bash:devel-20221024` - linux; arm64 variant v8
...
### `bash:devel-20221024` - linux; ppc64le
...
### `bash:devel-20221024` - linux; s390x
