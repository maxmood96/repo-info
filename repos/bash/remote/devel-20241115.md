...
```console
$ docker pull bash@sha256:365f9c59430c6f4401be5b1e86bf4e841ebdd52c31696219c31f0bd31d50e8a7
```
...
### `bash:devel-20241115` - linux; amd64
...
### `bash:devel-20241115` - unknown; unknown
...
### `bash:devel-20241115` - linux; arm variant v6
...
### `bash:devel-20241115` - linux; arm variant v7
...
### `bash:devel-20241115` - linux; arm64 variant v8
...
### `bash:devel-20241115` - linux; ppc64le
...
### `bash:devel-20241115` - linux; s390x
