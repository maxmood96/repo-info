...
### `bash:devel-20210902` - linux; amd64
...
### `bash:devel-20210902` - linux; arm64 variant v8
...
### `bash:devel-20210902` - linux; ppc64le
...
### `bash:devel-20210902` - linux; s390x
