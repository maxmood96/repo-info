...
### `bash:devel-20240911` - linux; amd64
...
### `bash:devel-20240911` - unknown; unknown
...
### `bash:devel-20240911` - linux; arm variant v6
...
### `bash:devel-20240911` - linux; arm variant v7
...
### `bash:devel-20240911` - linux; arm64 variant v8
...
### `bash:devel-20240911` - linux; ppc64le
...
### `bash:devel-20240911` - linux; riscv64
...
### `bash:devel-20240911` - linux; s390x
