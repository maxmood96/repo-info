...
### `bash:devel-20240927` - linux; amd64
...
### `bash:devel-20240927` - unknown; unknown
...
### `bash:devel-20240927` - linux; arm variant v6
...
### `bash:devel-20240927` - linux; arm variant v7
...
### `bash:devel-20240927` - linux; arm64 variant v8
...
### `bash:devel-20240927` - linux; ppc64le
...
### `bash:devel-20240927` - linux; riscv64
...
### `bash:devel-20240927` - linux; s390x
