...
### `bash:devel-20260428` - linux; amd64
...
### `bash:devel-20260428` - unknown; unknown
...
### `bash:devel-20260428` - linux; arm variant v6
...
### `bash:devel-20260428` - linux; arm variant v7
...
### `bash:devel-20260428` - linux; arm64 variant v8
...
### `bash:devel-20260428` - linux; ppc64le
...
### `bash:devel-20260428` - linux; riscv64
...
### `bash:devel-20260428` - linux; s390x
