...
### `bash:devel-20241028` - linux; amd64
...
### `bash:devel-20241028` - linux; arm variant v6
...
### `bash:devel-20241028` - linux; arm variant v7
...
### `bash:devel-20241028` - linux; arm64 variant v8
...
### `bash:devel-20241028` - linux; riscv64
...
### `bash:devel-20241028` - linux; s390x
