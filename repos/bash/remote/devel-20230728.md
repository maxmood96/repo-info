...
### `bash:devel-20230728` - linux; amd64
...
### `bash:devel-20230728` - linux; arm64 variant v8
...
### `bash:devel-20230728` - linux; ppc64le
...
### `bash:devel-20230728` - linux; s390x
