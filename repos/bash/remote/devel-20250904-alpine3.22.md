...
```console
$ docker pull bash@sha256:28b771afdf6b9316a8f7f6c387a33fe13d843c8c831530dd701637366bb31e0d
```
...
### `bash:devel-20250904-alpine3.22` - linux; arm variant v6
...
### `bash:devel-20250904-alpine3.22` - linux; arm variant v7
