...
### `bash:devel-20260309` - linux; amd64
...
### `bash:devel-20260309` - unknown; unknown
...
### `bash:devel-20260309` - linux; arm variant v6
...
### `bash:devel-20260309` - linux; arm variant v7
...
### `bash:devel-20260309` - linux; arm64 variant v8
...
### `bash:devel-20260309` - linux; ppc64le
...
### `bash:devel-20260309` - linux; riscv64
...
### `bash:devel-20260309` - linux; s390x
