...
### `bash:devel-20240513` - linux; amd64
...
### `bash:devel-20240513` - unknown; unknown
...
### `bash:devel-20240513` - linux; arm variant v6
...
### `bash:devel-20240513` - linux; arm64 variant v8
...
### `bash:devel-20240513` - linux; ppc64le
...
### `bash:devel-20240513` - linux; s390x
