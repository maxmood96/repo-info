...
### `bash:devel-20251017` - linux; amd64
...
### `bash:devel-20251017` - unknown; unknown
...
### `bash:devel-20251017` - linux; arm variant v6
...
### `bash:devel-20251017` - linux; arm variant v7
...
### `bash:devel-20251017` - linux; arm64 variant v8
...
### `bash:devel-20251017` - linux; ppc64le
...
### `bash:devel-20251017` - linux; riscv64
...
### `bash:devel-20251017` - linux; s390x
