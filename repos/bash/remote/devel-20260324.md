...
### `bash:devel-20260324` - linux; amd64
...
### `bash:devel-20260324` - unknown; unknown
...
### `bash:devel-20260324` - linux; arm variant v6
...
### `bash:devel-20260324` - linux; arm variant v7
...
### `bash:devel-20260324` - linux; arm64 variant v8
...
### `bash:devel-20260324` - linux; ppc64le
...
### `bash:devel-20260324` - linux; riscv64
...
### `bash:devel-20260324` - linux; s390x
