...
```console
$ docker pull bash@sha256:6e8796a6ca8a87dc5bf51428d47acb52adc22bdc4160abce89544b33977219d3
```
...
### `bash:devel-20260217` - linux; amd64
...
### `bash:devel-20260217` - unknown; unknown
...
### `bash:devel-20260217` - linux; arm variant v6
...
### `bash:devel-20260217` - linux; arm variant v7
...
### `bash:devel-20260217` - linux; arm64 variant v8
...
### `bash:devel-20260217` - linux; riscv64
...
### `bash:devel-20260217` - linux; s390x
