...
### `bash:5.1.16-alpine3.14` - linux; arm variant v6
...
### `bash:5.1.16-alpine3.14` - linux; arm variant v7
...
### `bash:5.1.16-alpine3.14` - linux; arm64 variant v8
...
### `bash:5.1.16-alpine3.14` - linux; 386
...
### `bash:5.1.16-alpine3.14` - linux; s390x
