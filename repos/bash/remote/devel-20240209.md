...
```console
$ docker pull bash@sha256:58ff935986dbcad8e18cc1a65d466f88248fed1ffa68e95c925e90cbe7f13033
```
...
### `bash:devel-20240209` - linux; amd64
...
### `bash:devel-20240209` - unknown; unknown
...
### `bash:devel-20240209` - linux; arm variant v6
...
### `bash:devel-20240209` - linux; arm64 variant v8
...
### `bash:devel-20240209` - linux; ppc64le
...
### `bash:devel-20240209` - linux; s390x
