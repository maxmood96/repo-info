...
### `bash:devel-20241213` - linux; amd64
...
### `bash:devel-20241213` - unknown; unknown
...
### `bash:devel-20241213` - linux; arm variant v6
...
### `bash:devel-20241213` - linux; arm variant v7
...
### `bash:devel-20241213` - linux; arm64 variant v8
...
### `bash:devel-20241213` - linux; ppc64le
...
### `bash:devel-20241213` - linux; riscv64
...
### `bash:devel-20241213` - linux; s390x
