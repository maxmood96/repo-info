## `bash:devel-20260324-alpine3.23`

```console
$ docker pull bash@sha256:41fd0a6b90a24915a5a510003fff838990cd37d90773046cdacbf1e067f99771
```
...
### `bash:devel-20260324-alpine3.23` - linux; amd64
...
### `bash:devel-20260324-alpine3.23` - unknown; unknown
...
### `bash:devel-20260324-alpine3.23` - linux; arm variant v6
...
### `bash:devel-20260324-alpine3.23` - linux; arm variant v7
...
### `bash:devel-20260324-alpine3.23` - linux; arm64 variant v8
...
### `bash:devel-20260324-alpine3.23` - linux; 386
...
### `bash:devel-20260324-alpine3.23` - linux; ppc64le
...
### `bash:devel-20260324-alpine3.23` - linux; s390x
