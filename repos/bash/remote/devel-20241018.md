...
### `bash:devel-20241018` - linux; amd64
...
### `bash:devel-20241018` - unknown; unknown
...
### `bash:devel-20241018` - linux; arm variant v6
...
### `bash:devel-20241018` - linux; arm variant v7
...
### `bash:devel-20241018` - linux; arm64 variant v8
...
### `bash:devel-20241018` - linux; ppc64le
...
### `bash:devel-20241018` - linux; riscv64
...
### `bash:devel-20241018` - linux; s390x
