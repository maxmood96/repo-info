...
### `bash:devel-20251217` - linux; amd64
...
### `bash:devel-20251217` - unknown; unknown
...
### `bash:devel-20251217` - linux; arm variant v6
...
### `bash:devel-20251217` - linux; arm variant v7
...
### `bash:devel-20251217` - linux; arm64 variant v8
...
### `bash:devel-20251217` - linux; ppc64le
...
### `bash:devel-20251217` - linux; riscv64
...
### `bash:devel-20251217` - linux; s390x
