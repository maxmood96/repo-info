## `bash:devel-20260520-alpine3.23`
...
### `bash:devel-20260520-alpine3.23` - linux; amd64
...
### `bash:devel-20260520-alpine3.23` - unknown; unknown
...
### `bash:devel-20260520-alpine3.23` - linux; arm variant v6
...
### `bash:devel-20260520-alpine3.23` - linux; arm variant v7
...
### `bash:devel-20260520-alpine3.23` - linux; arm64 variant v8
...
### `bash:devel-20260520-alpine3.23` - linux; 386
...
### `bash:devel-20260520-alpine3.23` - linux; ppc64le
...
### `bash:devel-20260520-alpine3.23` - linux; riscv64
...
### `bash:devel-20260520-alpine3.23` - linux; s390x
