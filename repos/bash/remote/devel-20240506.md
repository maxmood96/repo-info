...
```console
$ docker pull bash@sha256:3959f612562c89cf8f9e11b2ce4e21f8d123d95f6da233e4b41ebc3f1adb3dd2
```
...
### `bash:devel-20240506` - linux; amd64
...
### `bash:devel-20240506` - unknown; unknown
...
### `bash:devel-20240506` - linux; arm variant v6
...
### `bash:devel-20240506` - linux; arm64 variant v8
...
### `bash:devel-20240506` - linux; ppc64le
