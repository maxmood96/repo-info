...
### `bash:devel-20210510` - linux; amd64
...
### `bash:devel-20210510` - linux; arm variant v6
...
### `bash:devel-20210510` - linux; arm variant v7
...
### `bash:devel-20210510` - linux; arm64 variant v8
...
### `bash:devel-20210510` - linux; ppc64le
...
### `bash:devel-20210510` - linux; s390x
