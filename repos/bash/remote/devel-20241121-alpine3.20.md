...
### `bash:devel-20241121-alpine3.20` - linux; amd64
...
### `bash:devel-20241121-alpine3.20` - unknown; unknown
...
### `bash:devel-20241121-alpine3.20` - linux; arm variant v6
...
### `bash:devel-20241121-alpine3.20` - linux; arm variant v7
...
### `bash:devel-20241121-alpine3.20` - linux; arm64 variant v8
...
### `bash:devel-20241121-alpine3.20` - linux; 386
...
### `bash:devel-20241121-alpine3.20` - linux; ppc64le
...
### `bash:devel-20241121-alpine3.20` - linux; riscv64
...
### `bash:devel-20241121-alpine3.20` - linux; s390x
