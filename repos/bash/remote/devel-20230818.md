...
```console
$ docker pull bash@sha256:e7876be7eef40a584e60f60cf248d10c93721cad23cba9acbad3c28335a81d35
```
...
### `bash:devel-20230818` - linux; arm64 variant v8
...
### `bash:devel-20230818` - linux; ppc64le
...
### `bash:devel-20230818` - linux; s390x
