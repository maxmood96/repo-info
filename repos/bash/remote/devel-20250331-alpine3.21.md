## `bash:devel-20250331-alpine3.21`

```console
$ docker pull bash@sha256:382c93eb86902a35d1843c783efa00c58be50298fa8fe65f0853db30ec43780a
```
...
### `bash:devel-20250331-alpine3.21` - linux; amd64
...
### `bash:devel-20250331-alpine3.21` - unknown; unknown
...
### `bash:devel-20250331-alpine3.21` - linux; arm variant v7
...
### `bash:devel-20250331-alpine3.21` - linux; arm64 variant v8
...
### `bash:devel-20250331-alpine3.21` - linux; 386
...
### `bash:devel-20250331-alpine3.21` - linux; ppc64le
...
### `bash:devel-20250331-alpine3.21` - linux; riscv64
...
### `bash:devel-20250331-alpine3.21` - linux; s390x
