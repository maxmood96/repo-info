...
```console
$ docker pull bash@sha256:6f08c7458d135b9d07763606138c21306d411a04ac77268379649bb00235bcfe
```
...
### `bash:devel-20260508` - linux; amd64
...
### `bash:devel-20260508` - unknown; unknown
...
### `bash:devel-20260508` - linux; arm variant v6
...
### `bash:devel-20260508` - linux; arm variant v7
...
### `bash:devel-20260508` - linux; arm64 variant v8
...
### `bash:devel-20260508` - linux; ppc64le
...
### `bash:devel-20260508` - linux; riscv64
...
### `bash:devel-20260508` - linux; s390x
