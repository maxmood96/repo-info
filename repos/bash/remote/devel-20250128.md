...
```console
$ docker pull bash@sha256:f56c68a36731e300c84d9e8f8db0ee637e6c84e379bf7cc9620aa61b4d1023db
```
...
### `bash:devel-20250128` - linux; amd64
...
### `bash:devel-20250128` - unknown; unknown
...
### `bash:devel-20250128` - linux; arm variant v6
...
### `bash:devel-20250128` - linux; arm variant v7
...
### `bash:devel-20250128` - linux; ppc64le
...
### `bash:devel-20250128` - linux; riscv64
...
### `bash:devel-20250128` - linux; s390x
