...
### `bash:devel-20240401` - linux; amd64
...
### `bash:devel-20240401` - unknown; unknown
...
### `bash:devel-20240401` - linux; arm variant v6
...
### `bash:devel-20240401` - linux; arm variant v7
...
### `bash:devel-20240401` - linux; arm64 variant v8
...
### `bash:devel-20240401` - linux; ppc64le
...
### `bash:devel-20240401` - linux; s390x
