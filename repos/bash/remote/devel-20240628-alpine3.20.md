## `bash:devel-20240628-alpine3.20`

```console
$ docker pull bash@sha256:4b4650c86b995c30994ee946c3966dbb20a1bb813964e7b9606fb62a169ac75c
```
...
### `bash:devel-20240628-alpine3.20` - linux; amd64
...
### `bash:devel-20240628-alpine3.20` - unknown; unknown
...
### `bash:devel-20240628-alpine3.20` - linux; arm variant v6
...
### `bash:devel-20240628-alpine3.20` - linux; arm variant v7
...
### `bash:devel-20240628-alpine3.20` - linux; arm64 variant v8
...
### `bash:devel-20240628-alpine3.20` - linux; 386
...
### `bash:devel-20240628-alpine3.20` - linux; ppc64le
...
### `bash:devel-20240628-alpine3.20` - linux; s390x
