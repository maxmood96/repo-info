...
### `bash:devel-20211214-alpine3.14` - linux; arm variant v6
...
### `bash:devel-20211214-alpine3.14` - linux; arm64 variant v8
...
### `bash:devel-20211214-alpine3.14` - linux; 386
...
### `bash:devel-20211214-alpine3.14` - linux; s390x
