...
### `bash:5.3-alpha-alpine3.21` - linux; amd64
...
### `bash:5.3-alpha-alpine3.21` - unknown; unknown
...
### `bash:5.3-alpha-alpine3.21` - linux; arm variant v6
...
### `bash:5.3-alpha-alpine3.21` - linux; arm variant v7
...
### `bash:5.3-alpha-alpine3.21` - linux; arm64 variant v8
...
### `bash:5.3-alpha-alpine3.21` - linux; 386
...
### `bash:5.3-alpha-alpine3.21` - linux; ppc64le
...
### `bash:5.3-alpha-alpine3.21` - linux; riscv64
...
### `bash:5.3-alpha-alpine3.21` - linux; s390x
