...
### `bash:devel-20240726` - linux; amd64
...
### `bash:devel-20240726` - unknown; unknown
...
### `bash:devel-20240726` - linux; arm variant v6
...
### `bash:devel-20240726` - linux; arm variant v7
...
### `bash:devel-20240726` - linux; arm64 variant v8
...
### `bash:devel-20240726` - linux; ppc64le
...
### `bash:devel-20240726` - linux; riscv64
...
### `bash:devel-20240726` - linux; s390x
