...
### `bash:devel-20240815` - linux; amd64
...
### `bash:devel-20240815` - unknown; unknown
...
### `bash:devel-20240815` - linux; arm variant v6
...
### `bash:devel-20240815` - linux; arm variant v7
...
### `bash:devel-20240815` - linux; arm64 variant v8
...
### `bash:devel-20240815` - linux; ppc64le
...
### `bash:devel-20240815` - linux; riscv64
...
### `bash:devel-20240815` - linux; s390x
