...
```console
$ docker pull bash@sha256:c13694d6023fedfbd749aa833acdb138daa1fd3be876f29b5ee3233e2aee158d
```
...
### `bash:devel-20240406` - linux; arm64 variant v8
...
### `bash:devel-20240406` - linux; 386

```console
$ docker pull bash@sha256:af62133488e4fcc4a927811d951b61b0b33becf5da32299514e9efb3eaa39ab7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.1 MB (6070764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5aa651dec280e419331f3b9a048c4d7e2f6c7f3d9c027631797c452b3b0d795`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["bash"]`
...
-	Layers:
	-	`sha256:4a0759b5afbffdc507fbb4e32b3a139063c3a5c0829f811973850447f98830ae`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1a179a0f5cd7ebaee8f12050a1e12a600de4d9741ed1f5a4f5e1190a30ad44d4`  
		Last Modified: Tue, 09 Apr 2024 23:50:26 GMT  
		Size: 2.8 MB (2826339 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:de190b45ea2f5d780452d8855b05c993018f6ce3be5cbfec2a6e7191cb24b149`  
		Last Modified: Tue, 09 Apr 2024 23:50:26 GMT  
		Size: 336.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull bash@sha256:0cbb4a055dbedd8fbbac19afea911cd59cb5a4e6dcf1984654e0dee0300b459d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.7 KB (126704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c84aa442798ccb0d8e73c389c5c3d0576d513138e300cec14082308b613cdf27`

```dockerfile
```

-	Layers:
	-	`sha256:6699d85663fc05da9421cadaf6b632c0b5f8df6e138518cb2318833414641457`  
		Last Modified: Tue, 09 Apr 2024 23:50:26 GMT  
		Size: 110.4 KB (110433 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d9a6905aba4f7460568b1be76e9dd7adb988053d8ad30efa96b5c893ed6ac2da`  
		Last Modified: Tue, 09 Apr 2024 23:50:26 GMT  
		Size: 16.3 KB (16271 bytes)  
		MIME: application/vnd.in-toto+json

### `bash:devel-20240406` - linux; ppc64le
...
### `bash:devel-20240406` - linux; s390x

```console
$ docker pull bash@sha256:10e2297da167b14c710aa0524c115e673e07e318e920ec755746f80fac9542bf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.2 MB (6231471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14c3427389e9cbae2718dc592b0889ededc07d38ecbde9ec2d5bf386c9a74ba`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["bash"]`
...
-	Layers:
	-	`sha256:eb8fba61d86413beda3240c40c599041e040e658cd8314e38ee15e67ea57d349`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1d836539f07a6b2e51dc76a07da070bbb5d4b594237734a149dfa2f4b3f08d48`  
		Last Modified: Thu, 11 Apr 2024 05:56:36 GMT  
		Size: 3.0 MB (2988504 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d129312f7b746ff624054de2b785901cd65758ad8ea8842cbdd2a54775b80074`  
		Last Modified: Thu, 11 Apr 2024 05:56:35 GMT  
		Size: 332.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull bash@sha256:a6f8c8264d6621f2ed6f9e428ee4791a18228d39393c8c6ff8f231c7363029c1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.6 KB (124638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d90ac8940cecb21e90f315c4d05103321f06dec48b27af35ae7ed0e4cc26f36d`

```dockerfile
```

-	Layers:
	-	`sha256:5f03cefee0f2c4022fede43582471587cbf62590da9524252a591545f97d833f`  
		Last Modified: Thu, 11 Apr 2024 05:56:35 GMT  
		Size: 108.5 KB (108504 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e62cb54b7d20deaff354fa4cf05b021b9bafd239ed20bb223d36baaf49ce15e5`  
		Last Modified: Thu, 11 Apr 2024 05:56:35 GMT  
