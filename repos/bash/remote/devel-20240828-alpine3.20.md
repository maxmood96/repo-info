## `bash:devel-20240828-alpine3.20`

```console
$ docker pull bash@sha256:dbb3ac5db788830ff5a41afb538a212e11097e597d5414c2ba7d5864847bfb92
```
...
### `bash:devel-20240828-alpine3.20` - linux; amd64
...
### `bash:devel-20240828-alpine3.20` - unknown; unknown
...
### `bash:devel-20240828-alpine3.20` - linux; arm variant v6
...
### `bash:devel-20240828-alpine3.20` - linux; arm variant v7
...
### `bash:devel-20240828-alpine3.20` - linux; arm64 variant v8
...
### `bash:devel-20240828-alpine3.20` - linux; 386
...
### `bash:devel-20240828-alpine3.20` - linux; ppc64le
...
### `bash:devel-20240828-alpine3.20` - linux; riscv64
...
### `bash:devel-20240828-alpine3.20` - linux; s390x
