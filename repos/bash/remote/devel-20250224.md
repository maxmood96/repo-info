...
```console
$ docker pull bash@sha256:6b9df192d1253592c3cf742a123a1bba1727b6c8b785f5643c1995f30b9cd286
```
...
### `bash:devel-20250224` - linux; amd64
...
### `bash:devel-20250224` - unknown; unknown
...
### `bash:devel-20250224` - linux; arm variant v6
...
### `bash:devel-20250224` - linux; arm64 variant v8
...
### `bash:devel-20250224` - linux; ppc64le
...
### `bash:devel-20250224` - linux; riscv64
...
### `bash:devel-20250224` - linux; s390x
