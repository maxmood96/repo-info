...
```console
$ docker pull bash@sha256:fd9ff9f115bdee303e1729ef15970422a8ed26fbe30627b0a529fb0bd7b92286
```
...
### `bash:devel-20260123` - linux; amd64
...
### `bash:devel-20260123` - unknown; unknown
...
### `bash:devel-20260123` - linux; arm variant v6
...
### `bash:devel-20260123` - linux; arm variant v7
...
### `bash:devel-20260123` - linux; arm64 variant v8
...
### `bash:devel-20260123` - linux; ppc64le
...
### `bash:devel-20260123` - linux; s390x
