...
### `bash:devel-20240415` - linux; amd64
...
### `bash:devel-20240415` - unknown; unknown
...
### `bash:devel-20240415` - linux; arm variant v6
...
### `bash:devel-20240415` - linux; arm variant v7
...
### `bash:devel-20240415` - linux; arm64 variant v8
...
### `bash:devel-20240415` - linux; ppc64le
...
### `bash:devel-20240415` - linux; s390x
