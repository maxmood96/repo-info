...
### `bash:devel-20240604` - linux; amd64
...
### `bash:devel-20240604` - unknown; unknown
...
### `bash:devel-20240604` - linux; arm variant v6
...
### `bash:devel-20240604` - linux; arm variant v7
...
### `bash:devel-20240604` - linux; arm64 variant v8
...
### `bash:devel-20240604` - linux; ppc64le
...
### `bash:devel-20240604` - linux; riscv64
...
### `bash:devel-20240604` - linux; s390x
