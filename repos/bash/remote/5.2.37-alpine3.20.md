...
### `bash:5.2.37-alpine3.20` - linux; amd64
...
### `bash:5.2.37-alpine3.20` - unknown; unknown
...
### `bash:5.2.37-alpine3.20` - linux; arm variant v6
...
### `bash:5.2.37-alpine3.20` - linux; arm variant v7
...
### `bash:5.2.37-alpine3.20` - linux; arm64 variant v8
...
### `bash:5.2.37-alpine3.20` - linux; 386
...
### `bash:5.2.37-alpine3.20` - linux; ppc64le
...
### `bash:5.2.37-alpine3.20` - linux; riscv64
...
### `bash:5.2.37-alpine3.20` - linux; s390x
