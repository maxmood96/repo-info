...
```console
$ docker pull bash@sha256:ddd9138fabd15c2bce4305c412effd835014f2563505e6b71d8cbe8acc4afca4
```
...
### `bash:devel-20240202-alpine3.19` - linux; amd64
...
### `bash:devel-20240202-alpine3.19` - linux; arm variant v6
...
### `bash:devel-20240202-alpine3.19` - linux; arm64 variant v8
