...
### `bash:devel-20250331` - linux; amd64
...
### `bash:devel-20250331` - unknown; unknown
...
### `bash:devel-20250331` - linux; arm variant v6
...
### `bash:devel-20250331` - linux; arm variant v7
...
### `bash:devel-20250331` - linux; arm64 variant v8
...
### `bash:devel-20250331` - linux; ppc64le
...
### `bash:devel-20250331` - linux; riscv64
...
### `bash:devel-20250331` - linux; s390x
