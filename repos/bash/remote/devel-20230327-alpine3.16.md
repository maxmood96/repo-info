## `bash:devel-20230327-alpine3.16`
...
### `bash:devel-20230327-alpine3.16` - linux; arm variant v6
...
### `bash:devel-20230327-alpine3.16` - linux; arm variant v7
...
### `bash:devel-20230327-alpine3.16` - linux; s390x
