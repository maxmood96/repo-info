...
```console
$ docker pull bash@sha256:5e799b4803b9c89c6466b500318e0306ac90cfc386e94b0c3322010bd5172d04
```
...
### `bash:devel-20240221-alpine3.19` - linux; amd64
...
### `bash:devel-20240221-alpine3.19` - linux; arm variant v6
...
### `bash:devel-20240221-alpine3.19` - linux; arm variant v7
...
### `bash:devel-20240221-alpine3.19` - linux; arm64 variant v8
...
### `bash:devel-20240221-alpine3.19` - linux; 386
