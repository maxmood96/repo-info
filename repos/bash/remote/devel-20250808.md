...
### `bash:devel-20250808` - linux; amd64
...
### `bash:devel-20250808` - unknown; unknown
...
### `bash:devel-20250808` - linux; arm variant v6
...
### `bash:devel-20250808` - linux; arm variant v7
...
### `bash:devel-20250808` - linux; arm64 variant v8
...
### `bash:devel-20250808` - linux; ppc64le
...
### `bash:devel-20250808` - linux; riscv64
...
### `bash:devel-20250808` - linux; s390x
