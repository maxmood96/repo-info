...
```console
$ docker pull bash@sha256:a7f92ec1eb6f287d0d4d8b3b86e96196ee630cca2bb033255a366a84be23fd6a
```
...
### `bash:devel-20200515` - linux; amd64
...
### `bash:devel-20200515` - linux; arm variant v6
...
### `bash:devel-20200515` - linux; arm variant v7
...
### `bash:devel-20200515` - linux; arm64 variant v8
...
### `bash:devel-20200515` - linux; s390x
