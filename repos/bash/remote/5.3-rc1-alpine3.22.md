...
### `bash:5.3-rc1-alpine3.22` - linux; amd64
...
### `bash:5.3-rc1-alpine3.22` - unknown; unknown
...
### `bash:5.3-rc1-alpine3.22` - linux; arm variant v6
...
### `bash:5.3-rc1-alpine3.22` - linux; arm variant v7
...
### `bash:5.3-rc1-alpine3.22` - linux; arm64 variant v8
...
### `bash:5.3-rc1-alpine3.22` - linux; 386
...
### `bash:5.3-rc1-alpine3.22` - linux; ppc64le
...
### `bash:5.3-rc1-alpine3.22` - linux; riscv64
...
### `bash:5.3-rc1-alpine3.22` - linux; s390x
