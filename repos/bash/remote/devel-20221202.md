...
```console
$ docker pull bash@sha256:59fff757b86f68acaa684ac930c5eb7462e61f780fa0b0a384b9a70240a1c644
```
...
### `bash:devel-20221202` - linux; amd64
...
### `bash:devel-20221202` - linux; arm variant v6
...
### `bash:devel-20221202` - linux; arm64 variant v8
...
### `bash:devel-20221202` - linux; ppc64le
...
### `bash:devel-20221202` - linux; s390x
