...
### `bash:devel-20240221` - linux; amd64
...
### `bash:devel-20240221` - unknown; unknown
...
### `bash:devel-20240221` - linux; arm variant v6
...
### `bash:devel-20240221` - linux; arm variant v7
...
### `bash:devel-20240221` - linux; arm64 variant v8
...
### `bash:devel-20240221` - linux; ppc64le
...
### `bash:devel-20240221` - linux; s390x
