...
```console
$ docker pull bash@sha256:7f453b1c213bea9173225608c11f6ac179673f757f1fb80aad3c537d04198b56
```
...
### `bash:devel-20211213` - linux; arm variant v6
...
### `bash:devel-20211213` - linux; arm variant v7
...
### `bash:devel-20211213` - linux; arm64 variant v8
...
### `bash:devel-20211213` - linux; s390x
