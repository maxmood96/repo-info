...
### `bash:devel-20240920` - linux; arm variant v6
...
### `bash:devel-20240920` - linux; arm variant v7
...
### `bash:devel-20240920` - linux; arm64 variant v8
...
### `bash:devel-20240920` - linux; ppc64le
...
### `bash:devel-20240920` - linux; riscv64
...
### `bash:devel-20240920` - linux; s390x
