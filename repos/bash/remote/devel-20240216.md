...
```console
$ docker pull bash@sha256:81194689002da2e3f853394d50e04c431e1c3db17f0c8076cacc4e2fe6737fb5
```
...
### `bash:devel-20240216` - linux; amd64
...
### `bash:devel-20240216` - unknown; unknown
...
### `bash:devel-20240216` - linux; arm variant v6
...
### `bash:devel-20240216` - linux; arm variant v7
...
### `bash:devel-20240216` - linux; arm64 variant v8
...
### `bash:devel-20240216` - linux; ppc64le
...
### `bash:devel-20240216` - linux; s390x
