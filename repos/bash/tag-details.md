...
-	[`bash:devel-20200720`](#bashdevel-20200720)
...
```console
$ docker pull bash@sha256:e156ab41e7c77e255c1f83473c69d21adc2e30b1b9de0184fdad39676e4258f1
```
...
### `bash:devel-20200720` - linux; amd64
...
### `bash:devel-20200720` - linux; arm variant v6
...
### `bash:devel-20200720` - linux; arm64 variant v8
...
### `bash:devel-20200720` - linux; ppc64le
...
### `bash:devel-20200720` - linux; s390x
