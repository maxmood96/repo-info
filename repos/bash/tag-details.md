...
```console
$ docker pull bash@sha256:3e0d25bcde0d9c71ab4b6c1be828b0e1a582d4ed1f4be01ec1052c19fb1f6527
```
...
```console
$ docker pull bash@sha256:b5056feee124fd87a9847bb80a89cf76edcf425aa9768064e7746ed98db0ecf3
```
