...
- Image ID: `sha256:977112d4ec1d4450a47140cb4ba86f68caf545ebbc8b3b9c641eed7895952960`
- Created: `2025-08-06T19:40:10Z`
- Virtual Size: ~ 738.06 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["bash"]`
- Environment:
  - `PATH=/go/bin:/usr/local/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `GOLANG_VERSION=1.25rc3`
  - `GOTOOLCHAIN=local`
  - `GOPATH=/go`
