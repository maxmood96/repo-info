...
```console
$ docker pull golang@sha256:2202f38cb5d2c94a32d4513145457a0a9f60f65c0fbafe0d2f2cd212fae4e8d3
```
...
### `golang:1.14.4-stretch` - linux; amd64
...
### `golang:1.14.4-stretch` - linux; arm64 variant v8
...
### `golang:1.14.4-stretch` - linux; 386
...
### `golang:1.14.4-stretch` - linux; ppc64le
...
### `golang:1.14.4-stretch` - linux; s390x
