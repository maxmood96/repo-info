...
```console
$ docker pull golang@sha256:81d49e1de26fa223b9ae0b4d5a4065ff8176a7d80aa5ef0bd9f2eee430afe4d7
```
...
### `golang:1.25.7-alpine` - linux; amd64
...
### `golang:1.25.7-alpine` - unknown; unknown
...
### `golang:1.25.7-alpine` - linux; arm variant v6
...
### `golang:1.25.7-alpine` - linux; arm variant v7
...
### `golang:1.25.7-alpine` - linux; arm64 variant v8
...
### `golang:1.25.7-alpine` - linux; 386
...
### `golang:1.25.7-alpine` - linux; ppc64le
...
### `golang:1.25.7-alpine` - linux; s390x
