...
```console
$ docker pull golang@sha256:40414111c6ba46bb0a9fa3cb29f124188f4e95a8970313ffeff0783e0f2d47e0
```
...
### `golang:1.14.6-buster` - linux; amd64
...
### `golang:1.14.6-buster` - linux; arm variant v5
...
### `golang:1.14.6-buster` - linux; arm variant v7
...
### `golang:1.14.6-buster` - linux; arm64 variant v8
...
### `golang:1.14.6-buster` - linux; 386
...
### `golang:1.14.6-buster` - linux; mips64le
...
### `golang:1.14.6-buster` - linux; ppc64le
...
### `golang:1.14.6-buster` - linux; s390x
