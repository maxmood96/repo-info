...
### `golang:1.24.1-alpine3.20` - linux; amd64
...
### `golang:1.24.1-alpine3.20` - unknown; unknown
...
### `golang:1.24.1-alpine3.20` - linux; arm variant v6
...
### `golang:1.24.1-alpine3.20` - linux; arm variant v7
...
### `golang:1.24.1-alpine3.20` - linux; arm64 variant v8
...
### `golang:1.24.1-alpine3.20` - linux; 386
...
### `golang:1.24.1-alpine3.20` - linux; ppc64le
...
### `golang:1.24.1-alpine3.20` - linux; riscv64
...
### `golang:1.24.1-alpine3.20` - linux; s390x
