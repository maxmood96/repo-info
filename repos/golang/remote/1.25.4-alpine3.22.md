...
```console
$ docker pull golang@sha256:d2ede9f3341a67413127cf5366bb25bbad9b0a66e8173cae3a900ab00e84861f
```
...
### `golang:1.25.4-alpine3.22` - linux; amd64
...
### `golang:1.25.4-alpine3.22` - unknown; unknown
...
### `golang:1.25.4-alpine3.22` - linux; arm variant v6
...
### `golang:1.25.4-alpine3.22` - linux; arm variant v7
...
### `golang:1.25.4-alpine3.22` - linux; arm64 variant v8
...
### `golang:1.25.4-alpine3.22` - linux; 386
...
### `golang:1.25.4-alpine3.22` - linux; ppc64le
...
### `golang:1.25.4-alpine3.22` - linux; s390x
