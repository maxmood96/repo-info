...
```console
$ docker pull golang@sha256:549edeb6bc261701642a64103355b4f15f60b68b63ff37746553b01d4d10ab02
```
...
### `golang:1.25.2-bookworm` - linux; arm variant v7
...
### `golang:1.25.2-bookworm` - unknown; unknown
...
### `golang:1.25.2-bookworm` - linux; arm64 variant v8
...
### `golang:1.25.2-bookworm` - linux; 386
...
### `golang:1.25.2-bookworm` - linux; mips64le
...
### `golang:1.25.2-bookworm` - linux; ppc64le
...
### `golang:1.25.2-bookworm` - linux; s390x
