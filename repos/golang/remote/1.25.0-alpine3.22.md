...
### `golang:1.25.0-alpine3.22` - linux; amd64
...
### `golang:1.25.0-alpine3.22` - unknown; unknown
...
### `golang:1.25.0-alpine3.22` - linux; arm variant v6
...
### `golang:1.25.0-alpine3.22` - linux; arm variant v7
...
### `golang:1.25.0-alpine3.22` - linux; arm64 variant v8
...
### `golang:1.25.0-alpine3.22` - linux; 386
...
### `golang:1.25.0-alpine3.22` - linux; ppc64le
...
### `golang:1.25.0-alpine3.22` - linux; riscv64
...
### `golang:1.25.0-alpine3.22` - linux; s390x
