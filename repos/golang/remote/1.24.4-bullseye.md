...
### `golang:1.24.4-bullseye` - linux; amd64
...
### `golang:1.24.4-bullseye` - unknown; unknown
...
### `golang:1.24.4-bullseye` - linux; arm variant v7
...
### `golang:1.24.4-bullseye` - linux; arm64 variant v8
...
### `golang:1.24.4-bullseye` - linux; 386
