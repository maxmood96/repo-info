...
```console
$ docker pull golang@sha256:6ace30adc80ede7b49bb9628268ce96f7d5a74f4bbfa312445372e059b92ea43
```
...
### `golang:1.23.4-alpine3.19` - linux; arm64 variant v8
...
### `golang:1.23.4-alpine3.19` - linux; ppc64le
