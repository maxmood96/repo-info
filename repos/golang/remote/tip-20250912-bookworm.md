...
```console
$ docker pull golang@sha256:075fe8ec589f5b72341ab592e716d0187ce277ecce23909adde0b3876c4550c0
```
...
### `golang:tip-20250912-bookworm` - linux; amd64
...
### `golang:tip-20250912-bookworm` - unknown; unknown
...
### `golang:tip-20250912-bookworm` - linux; arm variant v7
...
### `golang:tip-20250912-bookworm` - linux; arm64 variant v8
...
### `golang:tip-20250912-bookworm` - linux; 386
...
### `golang:tip-20250912-bookworm` - linux; ppc64le
...
### `golang:tip-20250912-bookworm` - linux; s390x
