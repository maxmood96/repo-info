...
### `golang:1.26.3-alpine3.22` - linux; arm variant v6
...
### `golang:1.26.3-alpine3.22` - linux; arm variant v7
...
### `golang:1.26.3-alpine3.22` - linux; ppc64le
...
### `golang:1.26.3-alpine3.22` - linux; riscv64
...
### `golang:1.26.3-alpine3.22` - linux; s390x
