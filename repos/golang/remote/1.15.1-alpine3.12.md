...
```console
$ docker pull golang@sha256:fab380b12bae1b1bbaa4893b273aa00e44fc5b2ea3c775540c5d315276c16006
```
...
### `golang:1.15.1-alpine3.12` - linux; amd64
...
### `golang:1.15.1-alpine3.12` - linux; arm variant v6
...
### `golang:1.15.1-alpine3.12` - linux; arm variant v7
...
### `golang:1.15.1-alpine3.12` - linux; arm64 variant v8
...
### `golang:1.15.1-alpine3.12` - linux; 386
...
### `golang:1.15.1-alpine3.12` - linux; s390x
