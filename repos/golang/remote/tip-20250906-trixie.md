...
### `golang:tip-20250906-trixie` - linux; arm variant v7
...
### `golang:tip-20250906-trixie` - linux; arm64 variant v8
...
### `golang:tip-20250906-trixie` - linux; ppc64le
...
### `golang:tip-20250906-trixie` - linux; riscv64
...
### `golang:tip-20250906-trixie` - linux; s390x
