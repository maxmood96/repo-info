...
```console
$ docker pull golang@sha256:2c9684db68f1b6e76a500fdb1ea9af6288725b7f3ef47aa3265195d3ed5a8326
```
...
### `golang:1.25.3-alpine3.21` - linux; amd64
...
### `golang:1.25.3-alpine3.21` - unknown; unknown
...
### `golang:1.25.3-alpine3.21` - linux; arm variant v6
...
### `golang:1.25.3-alpine3.21` - linux; arm variant v7
...
### `golang:1.25.3-alpine3.21` - linux; arm64 variant v8
...
### `golang:1.25.3-alpine3.21` - linux; 386
...
### `golang:1.25.3-alpine3.21` - linux; ppc64le
...
### `golang:1.25.3-alpine3.21` - linux; s390x
