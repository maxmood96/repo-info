...
```console
$ docker pull golang@sha256:2b85dcbf57258bceaa4599bc29efd92824b19b5f9a93b373b9df0856b8127cba
```
...
### `golang:1.24.4-bookworm` - linux; amd64
...
### `golang:1.24.4-bookworm` - unknown; unknown
...
### `golang:1.24.4-bookworm` - linux; arm variant v7
...
### `golang:1.24.4-bookworm` - linux; arm64 variant v8
...
### `golang:1.24.4-bookworm` - linux; 386
...
### `golang:1.24.4-bookworm` - linux; mips64le
...
### `golang:1.24.4-bookworm` - linux; ppc64le
...
### `golang:1.24.4-bookworm` - linux; s390x
