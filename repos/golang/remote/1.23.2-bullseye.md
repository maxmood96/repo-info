...
### `golang:1.23.2-bullseye` - linux; amd64
...
### `golang:1.23.2-bullseye` - unknown; unknown
...
### `golang:1.23.2-bullseye` - linux; arm variant v7
...
### `golang:1.23.2-bullseye` - linux; arm64 variant v8
...
### `golang:1.23.2-bullseye` - linux; 386
