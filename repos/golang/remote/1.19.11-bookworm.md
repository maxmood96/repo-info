...
```console
$ docker pull golang@sha256:bdebc29b99263efdae3d9a3af11ee8d0b6eeacceb7c9b33e75c4f3da6dead032
```
...
### `golang:1.19.11-bookworm` - linux; amd64
...
### `golang:1.19.11-bookworm` - linux; arm variant v5
...
### `golang:1.19.11-bookworm` - linux; arm variant v7
...
### `golang:1.19.11-bookworm` - linux; arm64 variant v8
...
### `golang:1.19.11-bookworm` - linux; 386
...
### `golang:1.19.11-bookworm` - linux; mips64le
...
### `golang:1.19.11-bookworm` - linux; ppc64le
...
### `golang:1.19.11-bookworm` - linux; s390x
