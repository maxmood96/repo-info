...
```console
$ docker pull golang@sha256:a92c1ab0ec17377c238fc4e21a404e3dc2e5e5bb54d3007ef35d576827da5f63
```
...
### `golang:1.25.0-alpine3.21` - linux; amd64
...
### `golang:1.25.0-alpine3.21` - unknown; unknown
...
### `golang:1.25.0-alpine3.21` - linux; arm variant v6
...
### `golang:1.25.0-alpine3.21` - linux; arm variant v7
...
### `golang:1.25.0-alpine3.21` - linux; arm64 variant v8
...
### `golang:1.25.0-alpine3.21` - linux; 386
...
### `golang:1.25.0-alpine3.21` - linux; ppc64le
...
### `golang:1.25.0-alpine3.21` - linux; s390x
