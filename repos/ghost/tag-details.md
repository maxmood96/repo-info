...
-	[`ghost:5.76.0`](#ghost5760)
-	[`ghost:5.76.0-alpine`](#ghost5760-alpine)
...
```console
$ docker pull ghost@sha256:00443b2dd6579b3890fd3a5edbb47ec29f48c2a98288d2e7274df0d6ffd13246
```
...
```console
$ docker pull ghost@sha256:6e7ab2eacca8073da59c3eb71ee072a0d903c099be13c80f09d5203beb92567f
```
...
```console
$ docker pull ghost@sha256:384b5c7d1a1d985a3acd270b0299d6f3662187767e5a9ce68811bd5a8eb9ceb4
```
...
### `ghost:5.76.0` - linux; arm64 variant v8
...
### `ghost:5.76.0-alpine` - linux; amd64
...
### `ghost:5.76.0-alpine` - unknown; unknown
