...
```console
$ docker pull ghost@sha256:f359befd49f9cea74ce4dcaaa27ac34269a0a05b8026c0e59b534bc5add660f6
```
...
```console
$ docker pull ghost@sha256:9efd6645c9a68d7ec1a07892fcbc5b5bbc3c38a93aea1d1abd098aff68de98de
```
