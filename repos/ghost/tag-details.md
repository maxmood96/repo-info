...
```console
$ docker pull ghost@sha256:e7dd916345142931f51b31abb142868de377cabff96552f1a1f7bda02c9cd17b
```
...
```console
$ docker pull ghost@sha256:e0e3ad114965758e3f2cecb3ed585b3fa5a0bfe63bf944db212649ab35fafe08
```
