...
-	[`ghost:5.119.0`](#ghost51190)
-	[`ghost:5.119.0-alpine`](#ghost51190-alpine)
...
```console
$ docker pull ghost@sha256:535b966925c7e4854b026a6a6334f46eb93a80a7df6778b89077c298516a0fb8
```
...
```console
$ docker pull ghost@sha256:514ecbab78cdaa10d76dff3635f0669b15b4900e2767f51924322f48bd3bfb87
```
...
### `ghost:5.119.0-alpine` - linux; arm variant v7
