...
```console
$ docker pull ghost@sha256:ff3a3db8425d15d4ecd087b71f264f6f84a8923b3adacfd63057707b5e343c60
```
...
```console
$ docker pull ghost@sha256:8fbaf062fa64ddee6de75d00bac82377d8e2f5f4d02fdd1e4ac66dd05c11ac27
```
