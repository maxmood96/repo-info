...
-	[`ghost:4.21`](#ghost421)
-	[`ghost:4.21-alpine`](#ghost421-alpine)
-	[`ghost:4.21.0`](#ghost4210)
-	[`ghost:4.21.0-alpine`](#ghost4210-alpine)
...
```console
$ docker pull ghost@sha256:04c3c06b07c12b048fbc82fd24bceadac206a2f81b1fa165cd52ede9ba3cd405
```
...
```console
$ docker pull ghost@sha256:f73fd3569993cab1f80372979dad73d2dd2d8fb6fd0722272ac5ecb6035f6307
```
...
```console
$ docker pull ghost@sha256:b2ab5e481c4d1ffc526706dcf7a0820f3ab1c75da4d11dabbaf3ab85e53f2e51
```
...
### `ghost:4.21` - linux; arm variant v7
...
### `ghost:4.21` - linux; arm64 variant v8
...
### `ghost:4.21.0` - linux; arm variant v7
...
### `ghost:4.21.0` - linux; arm64 variant v8
