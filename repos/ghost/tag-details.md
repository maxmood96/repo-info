...
```console
$ docker pull ghost@sha256:78d7cc0881f9c88fa95847300ca5fd7e5a3dc691ea9bcf89f19354781e1a96aa
```
...
```console
$ docker pull ghost@sha256:0ef6e4de038078e46d7a3efa4df3952071394796708e9422574dda15b0be4e99
```
