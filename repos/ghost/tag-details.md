...
```console
$ docker pull ghost@sha256:f35d6f1d9f4c48b53dd0d90478c3fe7e032cab75ed978abd4ef13429678afa0e
```
...
### `ghost:5.49.1-alpine` - linux; amd64
...
### `ghost:5.49.1-alpine` - linux; arm variant v6
...
### `ghost:5.49.1-alpine` - linux; arm variant v7
...
### `ghost:5.49.1-alpine` - linux; arm64 variant v8
