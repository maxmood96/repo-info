...
-	[`ghost:5.48`](#ghost548)
-	[`ghost:5.48-alpine`](#ghost548-alpine)
-	[`ghost:5.48.0`](#ghost5480)
-	[`ghost:5.48.0-alpine`](#ghost5480-alpine)
...
```console
$ docker pull ghost@sha256:d155e09fde559c6c2fe703e640876688d88b3f8a1386b7aae32a822bbd9b8d06
```
...
```console
$ docker pull ghost@sha256:f1a576098cde175b6b7b732c45ccbab6636e9f0b32eefab08c99ca721af7d343
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161749271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:181cbee2e1295f58b9bde34217ef86b9270f7d91a831cbca77feb191e7600d8a`
...
# Wed, 17 May 2023 23:24:01 GMT
WORKDIR /var/lib/ghost
# Wed, 17 May 2023 23:24:01 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 17 May 2023 23:24:02 GMT
...
-	Layers:
	...
	-	`sha256:2e54a8ef96f84c995e4c562593b2f24b46426e04f2f94ad44cdd1b38c147d823`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe1a795c44f1e183e3bf06ea60c3064270447b9bf32c535dfdec82740bef34d8`  
		Last Modified: Wed, 17 May 2023 23:26:13 GMT  
		Size: 80.6 MB (80589018 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0570494563df7161c5721ee6cac9c9fc26c3d2a583fd1308d0ae91b704504a7f`  
		Last Modified: Wed, 17 May 2023 23:25:59 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:3f89f805ac9a31f09c671b5defefbed63e7702c72e3e8ce69994849149c758e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.1 MB (166098988 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:449212276ac9725a1ceb8759e938994627d3580b7df8ee18d505b250c140f74d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Thu, 04 May 2023 07:34:24 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 17 May 2023 23:58:33 GMT
ENV GHOST_VERSION=5.48.0
# Thu, 18 May 2023 00:03:15 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Thu, 18 May 2023 00:03:19 GMT
WORKDIR /var/lib/ghost
# Thu, 18 May 2023 00:03:19 GMT
VOLUME [/var/lib/ghost/content]
# Thu, 18 May 2023 00:03:20 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Thu, 18 May 2023 00:03:20 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 18 May 2023 00:03:20 GMT
...
-	Layers:
	...
	-	`sha256:dd4047b65fe1bfe2a939a3e64ace698be72cd7a980c0597073274f2028ee5b5b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:153a25ae655bf8036c51ebee7bdc9fb8f0b7d7b44e5e0520356115ae1d7a1f40`  
		Last Modified: Thu, 18 May 2023 00:11:05 GMT  
		Size: 92.6 MB (92584540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58f2ff20b7378c92dd3c5d631a7f2089c6d9cda9d1d51e40f960498fe35dba47`  
		Last Modified: Thu, 18 May 2023 00:10:43 GMT  
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:6361882431f27487a5ce16d9fcee2d862050ea2d56fb216eeea44859f37d89d7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.3 MB (169318222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab1355a211e4e48a327aa5ca67382938b2fa0b0640d5956d6f1ec1dcefd981b2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Thu, 04 May 2023 04:25:02 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 17 May 2023 23:41:29 GMT
ENV GHOST_VERSION=5.48.0
# Wed, 17 May 2023 23:45:04 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 17 May 2023 23:45:09 GMT
WORKDIR /var/lib/ghost
# Wed, 17 May 2023 23:45:09 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 17 May 2023 23:45:09 GMT
...
-	Layers:
	...
	-	`sha256:cea9df50ec5ce12aa3e80c7dc0946b51f932fcf28087806c8d0380943809f4bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f186b85f8c95318d42fcc8072a1244f5c72f09fe86a8212bee756fe9f4172c`  
		Last Modified: Wed, 17 May 2023 23:49:52 GMT  
		Size: 89.3 MB (89337499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89408ddd5297277fb66205d7e40e90d00bdb7f88a7fc44bc745c6bce74bae82a`  
		Last Modified: Wed, 17 May 2023 23:49:39 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:7ac30a28acc2442303fa2102c65ed5bf8f0f09adebbf005153fab1d4621975f9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165683676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4896f8a43a91493b1a4d0bfa42a60f173fe80c14762b25af2330596f30971d4d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 17 May 2023 23:18:30 GMT
ENV GHOST_VERSION=5.48.0
# Wed, 17 May 2023 23:30:02 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 17 May 2023 23:30:13 GMT
WORKDIR /var/lib/ghost
# Wed, 17 May 2023 23:30:13 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 17 May 2023 23:30:14 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 17 May 2023 23:30:14 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 17 May 2023 23:30:15 GMT
EXPOSE 2368
# Wed, 17 May 2023 23:30:16 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:78adcf338e146ce332c3bb84a40dbd09aa0767e5a8afe3be42915355d74d08ef`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2b1e159656d6b69aa516c477b55a691a4889af90ba4aa5b8ee47aa85ecab316`  
		Last Modified: Wed, 17 May 2023 23:31:04 GMT  
		Size: 78.7 MB (78657627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ac24ac00eda266e54b812bbba53c532481f31ccfce86f03c319a8b9c579f9e`  
		Last Modified: Wed, 17 May 2023 23:30:33 GMT  
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:1e5732895886511e424fb67096b3041e09d6cf25b2c83043169a3b56fcbb2a4c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157838361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46a0e8428e3f8fef7bb0ee5032f2d9c41f15b8935115949279b2753cb2944119`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Fri, 05 May 2023 00:30:39 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 17 May 2023 23:43:11 GMT
ENV GHOST_VERSION=5.48.0
# Wed, 17 May 2023 23:47:47 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 17 May 2023 23:47:57 GMT
WORKDIR /var/lib/ghost
# Wed, 17 May 2023 23:47:57 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 17 May 2023 23:47:57 GMT
...
-	Layers:
	...
	-	`sha256:e59e06f89facbb8fb9665b5045a82f35e011e6f5a341cb4235224cef71b48170`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dc0c1bc68ca4cf5fa2d128a6439e76dd516eda89ea208104345ca70b94d203a`  
		Last Modified: Wed, 17 May 2023 23:48:24 GMT  
		Size: 78.6 MB (78567120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de0f6bb8b293eb89ea5e8ba436dd9be75886b474cf8d5f3bb4aba740adc2d6ed`  
		Last Modified: Wed, 17 May 2023 23:48:09 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `ghost:5.48` - linux; arm variant v7
...
### `ghost:5.48` - linux; arm64 variant v8
...
### `ghost:5.48.0` - linux; arm variant v7
...
### `ghost:5.48.0` - linux; arm64 variant v8
