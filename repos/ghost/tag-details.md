...
-	[`ghost:4.22.0`](#ghost4220)
-	[`ghost:4.22.0-alpine`](#ghost4220-alpine)
...
```console
$ docker pull ghost@sha256:51e5ea78406a0ad787f4b1de0cf53adbb125a9f962dc804086b98a050344d21d
```
...
### `ghost:4.22.0` - linux; arm variant v7
...
### `ghost:4.22.0` - linux; arm64 variant v8
...
### `ghost:4.22.0-alpine` - linux; amd64
