...
```console
$ docker pull ghost@sha256:b695d41b3747ccd4bc01223767597cbc99513a5a794c811521acaa4feb21c33f
```
...
```console
$ docker pull ghost@sha256:540f61aaae4cc521779069ca7b83d367dc55f57b3ebe23a32b10850650a4d7f7
```
