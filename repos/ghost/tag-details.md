...
-	[`ghost:5.54.4`](#ghost5544)
-	[`ghost:5.54.4-alpine`](#ghost5544-alpine)
...
```console
$ docker pull ghost@sha256:6e2825bb69884c33c4c23a410eb6f9517ee34d03ae238428f8a3bd5d825e9019
```
...
### `ghost:5.54.4-alpine` - linux; amd64
...
### `ghost:5.54.4-alpine` - linux; arm variant v6
...
### `ghost:5.54.4-alpine` - linux; arm64 variant v8
