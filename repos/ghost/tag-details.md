...
```console
$ docker pull ghost@sha256:ece9065191ee142866687849300bd5e3f18691204ea65088f04457671182329d
```
...
```console
$ docker pull ghost@sha256:afb977605d91da5d61b6a0071878132d4b61b9297bbe46cca7d76b1e264f0592
```
