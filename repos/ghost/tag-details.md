...
```console
$ docker pull ghost@sha256:b3510355bf0b29f6a323946620e560d9bde06adc6256afb95d5c3516b1f8180c
```
...
```console
$ docker pull ghost@sha256:b51602440ff2168cc8c16aeee9bd0b3a0686e67cbdba7ea6d06e1f8a70318b64
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.2 MB (162246643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c0e3969918277a90a85483ce42edde77383b7a8b23dacf713a21feb51f5e1d0`
...
# Wed, 31 May 2023 02:09:24 GMT
ENV GHOST_VERSION=5.49.2
# Wed, 31 May 2023 02:10:36 GMT
...
# Wed, 31 May 2023 02:10:38 GMT
WORKDIR /var/lib/ghost
# Wed, 31 May 2023 02:10:38 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 31 May 2023 02:10:39 GMT
...
-	Layers:
	...
	-	`sha256:fb852ebc16c4c52537850b26eea84552f872b032491097b4d0edd76550d2ab16`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c40c18a60980f49e5731b19b0c0b2d6d13a63c5f4a1131b9b11eeb083d9de07`  
		Last Modified: Wed, 31 May 2023 02:12:34 GMT  
		Size: 81.1 MB (81062047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:842953a027469d91f4b4e686d4351c516b43e245aac3eef9efd920661f51876d`  
		Last Modified: Wed, 31 May 2023 02:12:20 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:9cc31bc1e335d37c51a207bf1d1cde32968486c43846a694d2f3e55ea1adbdc7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166596652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92dc5bb3dfd242ab214ab58c02572c6e5064301f17edfbf72d7de09b2db84a7b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 31 May 2023 02:08:36 GMT
ENV GHOST_VERSION=5.49.2
# Wed, 31 May 2023 02:13:13 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 31 May 2023 02:13:17 GMT
WORKDIR /var/lib/ghost
# Wed, 31 May 2023 02:13:17 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 31 May 2023 02:13:17 GMT
...
-	Layers:
	...
	-	`sha256:606b40c9e2141a21fff40a296df4e2b7de866225f03a3a24a344379dadb6a615`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4b90833b91d91fea5dccba6f31af58463566d407dd0c4c948f5ae4790838f4a`  
		Last Modified: Wed, 31 May 2023 02:21:06 GMT  
		Size: 93.1 MB (93055674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fb0b95905896bcf2818bde0e440c7b2dfc5678282ce684daced725791db6753`  
		Last Modified: Wed, 31 May 2023 02:20:45 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:c7f851ecd841620e88d87a14e9162e12ef1f096f3c90923275e552800d7c8d13
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166176046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c7e3a1e0ded9dcf0ac1860a1b1f99e1d359ca12afffca6ea991714d18377205`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 31 May 2023 02:23:42 GMT
ENV GHOST_VERSION=5.49.2
# Wed, 31 May 2023 02:33:59 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 31 May 2023 02:34:08 GMT
WORKDIR /var/lib/ghost
# Wed, 31 May 2023 02:34:08 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 31 May 2023 02:34:09 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 31 May 2023 02:34:09 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 31 May 2023 02:34:09 GMT
EXPOSE 2368
# Wed, 31 May 2023 02:34:10 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:3c71372b402b0ecf94829a60e9e50055afd0639e52355835378a62b420967a1c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b08cf12d01332c4716cc4c133a972db645ec166129fbbe25c2401df40313daf`  
		Last Modified: Wed, 31 May 2023 02:34:59 GMT  
		Size: 79.1 MB (79126115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6707001c10753e679d0b3caf36072eebe15659746fefbbe74651f4659ffe6cea`  
		Last Modified: Wed, 31 May 2023 02:34:29 GMT  
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:ba39d5469918d1f46b204458d5c06d2ab0e61e04a147484fdd4e6af6e8387521
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.3 MB (158334569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d502eef16d235559959bec611f4e5b9a85c60f910e174aa7d1ae8c1b1ef9dcd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Tue, 23 May 2023 15:19:50 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 31 May 2023 02:40:27 GMT
ENV GHOST_VERSION=5.49.2
# Wed, 31 May 2023 02:46:30 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		savedAptMark="$(apt-mark showmanual)"; 	aptPurge=; 		installCmd='gosu node ghost install "$GHOST_VERSION" --db mysql --dbhost mysql --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"'; 	if ! eval "$installCmd"; then 		aptPurge=1; 		apt-get update; 		apt-get install -y --no-install-recommends g++ make python3; 		eval "$installCmd"; 	fi; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --no-prompt --ip '::' --port 2368 --url 'http://localhost:2368'; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	packages="$(node -p ' 		var ghost = require("./package.json"); 		var transform = require("./node_modules/@tryghost/image-transform/package.json"); 		[ 			"sharp@" + transform.optionalDependencies["sharp"], 			"sqlite3@" + ghost.optionalDependencies["sqlite3"], 		].join(" ") 	')"; 	if echo "$packages" | grep 'undefined'; then exit 1; fi; 	for package in $packages; do 		installCmd='gosu node yarn add "$package" --force'; 		if ! eval "$installCmd"; then 			aptPurge=1; 			apt-get update; 			apt-get install -y --no-install-recommends g++ make python3; 			case "$package" in 				sharp@*) echo >&2 "sorry: libvips 8.10 in Debian bullseye is not new enough (8.12.2+) for sharp 0.30 😞"; continue ;; 			esac; 						eval "$installCmd --build-from-source"; 		fi; 	done; 		if [ -n "$aptPurge" ]; then 		apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 		rm -rf /var/lib/apt/lists/*; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 31 May 2023 02:46:40 GMT
WORKDIR /var/lib/ghost
# Wed, 31 May 2023 02:46:40 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 31 May 2023 02:46:40 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 31 May 2023 02:46:41 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 31 May 2023 02:46:41 GMT
EXPOSE 2368
# Wed, 31 May 2023 02:46:41 GMT
...
-	Layers:
	...
	-	`sha256:3e10a796041aea9d82993201bc126bae9461a26f2bd4e12617433b2d4f8f34d7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3edf977da9af951f8a6b75c057120f4428ba5dbece9edc25af4a25674e55ec08`  
		Last Modified: Wed, 31 May 2023 02:47:14 GMT  
		Size: 79.0 MB (79041411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:827d944b943771bd77bad3caf6328ab7e769c4116f6eb2d0201d3135dfac56c6`  
		Last Modified: Wed, 31 May 2023 02:46:59 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `ghost:5.49.2` - linux; arm variant v7
