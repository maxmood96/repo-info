...
```console
$ docker pull ghost@sha256:0b50854e0be0f026d5296919358dd16f90dd1cd39a2594bce237a8a2766a211a
```
...
### `ghost:5.67.0` - linux; arm variant v7
...
### `ghost:5.67.0` - linux; arm64 variant v8
