...
```console
$ docker pull ghost@sha256:0fb0de316c9445c0cc30b8cfdc04951351d0489a0984a5b8ae7d1a3eac42a832
```
...
### `ghost:5.85.2-alpine` - linux; arm variant v6
...
### `ghost:5.85.2-alpine` - linux; arm variant v7
