...
```console
$ docker pull ghost@sha256:30391881fa40975b9c5070a8979cd7ed4fdfb1a3aa1bdc1398f9c038e5245f0e
```
...
### `ghost:6.30-bookworm` - linux; amd64
...
### `ghost:6.30-bookworm` - unknown; unknown
...
### `ghost:6.30-bookworm` - linux; arm variant v7
...
### `ghost:6.30-bookworm` - linux; arm64 variant v8
...
### `ghost:6.30-bookworm` - linux; s390x
