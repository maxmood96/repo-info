...
### `ghost:6.42.0-bookworm` - linux; amd64
...
### `ghost:6.42.0-bookworm` - unknown; unknown
...
### `ghost:6.42.0-bookworm` - linux; arm variant v7
...
### `ghost:6.42.0-bookworm` - linux; arm64 variant v8
...
### `ghost:6.42.0-bookworm` - linux; s390x
