...
```console
$ docker pull ghost@sha256:226fbb35073527d2d4cbd922f8395d849461501bafa240f49bc9b8bb54bed134
```
...
### `ghost:3.41.2` - linux; amd64

```console
$ docker pull ghost@sha256:b640a2b734e7dd71e7b4397fc6c79a6969c77c7c9364f3d235c837f79ede7b35
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.3 MB (132251710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfdbb1cff498ccbdcc881a905aafdc53be4a501fab1680cd9b3b80a3e93a675a`
...
# Thu, 28 Jan 2021 00:19:49 GMT
ENV GHOST_VERSION=3.41.2
# Thu, 28 Jan 2021 00:21:13 GMT
...
-	Layers:
	...
	-	`sha256:0f1367af140b9ac9b8a4adb78e4bd0d863acb540a8e174acce76355971dc0908`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c1185d5b68f037a287d80f0618f77c3ec5d73cd08c47a279cabc30fa4824dcf`  
		Last Modified: Thu, 28 Jan 2021 00:23:43 GMT  
		Size: 69.4 MB (69394037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4f873f1787df1ccf45363da921f9bdb44e0b8cdbeb7354de86c720db07930a`  
		Last Modified: Thu, 28 Jan 2021 00:23:26 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `ghost:3.41.2` - linux; arm variant v7
...
### `ghost:3.41.2` - linux; arm64 variant v8

```console
$ docker pull ghost@sha256:168b44760d76f6c8ce8ae7867f24fa0ce9a41670622714a54efb6a63fda6b9b6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.1 MB (116104812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28ff53d20126fa690e656438cab1bad4fd9883eb26afa29df7029f25c03a33fe`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Wed, 13 Jan 2021 00:57:13 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 27 Jan 2021 23:20:48 GMT
ENV GHOST_VERSION=3.41.2
# Wed, 27 Jan 2021 23:27:19 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		gosu node ghost install "$GHOST_VERSION" --db sqlite3 --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --ip 0.0.0.0 --port 2368 --no-prompt --db sqlite3 --url http://localhost:2368 --dbpath "$GHOST_CONTENT/data/ghost.db"; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	sqlite3Version="$(node -p 'require("./package.json").optionalDependencies.sqlite3')"; 	if ! gosu node yarn add "sqlite3@$sqlite3Version" --force; then 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 		apt-get install -y --no-install-recommends g++ gcc libc-dev libvips-dev make python3; 		rm -rf /var/lib/apt/lists/*; 				npm_config_python='python3' gosu node yarn add "sqlite3@$sqlite3Version" --force --build-from-source; 				apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 27 Jan 2021 23:27:30 GMT
WORKDIR /var/lib/ghost
# Wed, 27 Jan 2021 23:27:31 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 27 Jan 2021 23:27:31 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 27 Jan 2021 23:27:32 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 27 Jan 2021 23:27:33 GMT
EXPOSE 2368
# Wed, 27 Jan 2021 23:27:33 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:89741aebff8df781e27b8866909d3fe34737192790b3c3841a6e4ba1e5f1a6b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97081abcbfb1e1fc0c3e9c708210f93cd569cd368f97f486c18457392b11dd38`  
		Last Modified: Wed, 27 Jan 2021 23:43:57 GMT  
		Size: 54.6 MB (54593933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e85f3943dbc09552d253e954bab9945c8de2bd80fb19ca82a451d59c0bed8ce2`  
		Last Modified: Wed, 27 Jan 2021 23:43:33 GMT  
		Size: 550.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `ghost:3.41.2` - linux; ppc64le

```console
$ docker pull ghost@sha256:395181db5921edd642214fd0f94918630fed7fa7f8504ec8237c6b16f1cc7176
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.6 MB (121597493 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dc3129eba80974c4fb9557ca197f4690f21632e0694947df2f5959da109f157`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
ENV GHOST_CONTENT=/var/lib/ghost/content
# Thu, 28 Jan 2021 00:18:31 GMT
ENV GHOST_VERSION=3.41.2
# Thu, 28 Jan 2021 04:18:48 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		gosu node ghost install "$GHOST_VERSION" --db sqlite3 --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --ip 0.0.0.0 --port 2368 --no-prompt --db sqlite3 --url http://localhost:2368 --dbpath "$GHOST_CONTENT/data/ghost.db"; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	sqlite3Version="$(node -p 'require("./package.json").optionalDependencies.sqlite3')"; 	if ! gosu node yarn add "sqlite3@$sqlite3Version" --force; then 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 		apt-get install -y --no-install-recommends g++ gcc libc-dev libvips-dev make python3; 		rm -rf /var/lib/apt/lists/*; 				npm_config_python='python3' gosu node yarn add "sqlite3@$sqlite3Version" --force --build-from-source; 				apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Thu, 28 Jan 2021 04:19:06 GMT
WORKDIR /var/lib/ghost
# Thu, 28 Jan 2021 04:19:11 GMT
VOLUME [/var/lib/ghost/content]
# Thu, 28 Jan 2021 04:19:13 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Thu, 28 Jan 2021 04:19:23 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 28 Jan 2021 04:19:35 GMT
EXPOSE 2368
# Thu, 28 Jan 2021 04:19:46 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:434683f1c1f1bda99b389eb3963edbb08b89612a8511769538b9425503e5c493`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b965b98d95050934dd26bff19f676a5948dd843a8ca7d33dc983dc66b1beb626`  
		Last Modified: Thu, 28 Jan 2021 04:21:33 GMT  
		Size: 55.6 MB (55568135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62b42300cc2cb3e690db74c4108fdc9c579628e93f822b280552a54870f0f42a`  
		Last Modified: Thu, 28 Jan 2021 04:21:14 GMT  
		Size: 550.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `ghost:3.41.2` - linux; s390x

```console
$ docker pull ghost@sha256:c42424f6ec032d7cbd7f4d71dacf0398f727fbfa8a1e39e0675bc7b0f125b6d7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.1 MB (116124324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42a1e95f900f349a664d30f7efe9c76381cf5de7fc0728a67e6baa26566bc522`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Tue, 12 Jan 2021 22:44:26 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 27 Jan 2021 23:45:31 GMT
ENV GHOST_VERSION=3.41.2
# Wed, 27 Jan 2021 23:54:17 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		gosu node ghost install "$GHOST_VERSION" --db sqlite3 --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --ip 0.0.0.0 --port 2368 --no-prompt --db sqlite3 --url http://localhost:2368 --dbpath "$GHOST_CONTENT/data/ghost.db"; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	sqlite3Version="$(node -p 'require("./package.json").optionalDependencies.sqlite3')"; 	if ! gosu node yarn add "sqlite3@$sqlite3Version" --force; then 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 		apt-get install -y --no-install-recommends g++ gcc libc-dev libvips-dev make python3; 		rm -rf /var/lib/apt/lists/*; 				npm_config_python='python3' gosu node yarn add "sqlite3@$sqlite3Version" --force --build-from-source; 				apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 27 Jan 2021 23:54:41 GMT
WORKDIR /var/lib/ghost
# Wed, 27 Jan 2021 23:54:42 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 27 Jan 2021 23:54:43 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 27 Jan 2021 23:54:44 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 27 Jan 2021 23:54:44 GMT
EXPOSE 2368
# Wed, 27 Jan 2021 23:54:45 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:7960084b935e6b64a2e59a4e34af170b7b5700862228f05dfe296ec2f89f67f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9520d9f403e60f2a60d62dd364899ffecef7b25e74217900834ed4478179fdd7`  
		Last Modified: Thu, 28 Jan 2021 00:00:30 GMT  
		Size: 54.6 MB (54580195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1f0b119c8451387e075536906151dff50c049f66dc86f98a799df5fc75039bb`  
		Last Modified: Thu, 28 Jan 2021 00:00:18 GMT  
		Size: 550.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
