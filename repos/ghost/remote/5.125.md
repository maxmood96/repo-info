...
```console
$ docker pull ghost@sha256:b04fda6fc7fc0deee5a88c53b4b0648dba2030a53d165c9e3d20584515f763fe
```
...
### `ghost:5.125` - linux; arm variant v7
...
### `ghost:5.125` - linux; arm64 variant v8
