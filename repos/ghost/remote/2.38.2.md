...
```console
$ docker pull ghost@sha256:2d78a99bc84ebbd9aa8f67f0d47611e2cb9c44e379747252f8b4f92b13f05175
```
...
```console
$ docker pull ghost@sha256:874f6b6853b7d638fc80cde8646e095fe05d4cd7a06c0f7522758bf75dd667d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.6 MB (132618719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b16667de98b482ad75925701edc7219051f6d7e920cd6d1e5b5d167d9f729d10`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 27 Jan 2021 23:34:29 GMT
ENV GHOST_VERSION=2.38.2
# Wed, 27 Jan 2021 23:37:43 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		gosu node ghost install "$GHOST_VERSION" --db sqlite3 --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --ip 0.0.0.0 --port 2368 --no-prompt --db sqlite3 --url http://localhost:2368 --dbpath "$GHOST_CONTENT/data/ghost.db"; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	sqlite3Version="$(node -p 'require("./package.json").optionalDependencies.sqlite3')"; 	if ! gosu node yarn add "sqlite3@$sqlite3Version" --force; then 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 		apt-get install -y --no-install-recommends g++ gcc libc-dev make python3; 		rm -rf /var/lib/apt/lists/*; 				npm_config_python='python3' gosu node yarn add "sqlite3@$sqlite3Version" --force --build-from-source; 				apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 27 Jan 2021 23:37:47 GMT
WORKDIR /var/lib/ghost
# Wed, 27 Jan 2021 23:37:47 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 27 Jan 2021 23:37:48 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 27 Jan 2021 23:37:48 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 27 Jan 2021 23:37:49 GMT
EXPOSE 2368
# Wed, 27 Jan 2021 23:37:50 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:445b1197f00b37829325bc603ed742eb6d4cda0b543962227d1211434c505a8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa9a82256e59530156d530ae478301307353f13897fb7ea044ac740f84548722`  
		Last Modified: Wed, 27 Jan 2021 23:44:59 GMT  
		Size: 73.2 MB (73183174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7676083c12266e748f4b946fb77b6cfcf8892a654355b5049116841d7b0c35d8`  
		Last Modified: Wed, 27 Jan 2021 23:44:40 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ghost@sha256:d70f8ff5546df9ca3c55b3322e6fda137df6c192200df5c8db4f83c1906d9374
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.3 MB (116289517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a518b1866918a0202fbaba8060e4eb3a670b816747f7afe6770936d19ef94d51`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["node","current\/index.js"]`
...
# Wed, 27 Jan 2021 23:56:11 GMT
ENV GHOST_CONTENT=/var/lib/ghost/content
# Wed, 27 Jan 2021 23:56:12 GMT
ENV GHOST_VERSION=2.38.2
# Wed, 27 Jan 2021 23:59:39 GMT
RUN set -eux; 	mkdir -p "$GHOST_INSTALL"; 	chown node:node "$GHOST_INSTALL"; 		gosu node ghost install "$GHOST_VERSION" --db sqlite3 --no-prompt --no-stack --no-setup --dir "$GHOST_INSTALL"; 		cd "$GHOST_INSTALL"; 	gosu node ghost config --ip 0.0.0.0 --port 2368 --no-prompt --db sqlite3 --url http://localhost:2368 --dbpath "$GHOST_CONTENT/data/ghost.db"; 	gosu node ghost config paths.contentPath "$GHOST_CONTENT"; 		gosu node ln -s config.production.json "$GHOST_INSTALL/config.development.json"; 	readlink -f "$GHOST_INSTALL/config.development.json"; 		mv "$GHOST_CONTENT" "$GHOST_INSTALL/content.orig"; 	mkdir -p "$GHOST_CONTENT"; 	chown node:node "$GHOST_CONTENT"; 	chmod 1777 "$GHOST_CONTENT"; 		cd "$GHOST_INSTALL/current"; 	sqlite3Version="$(node -p 'require("./package.json").optionalDependencies.sqlite3')"; 	if ! gosu node yarn add "sqlite3@$sqlite3Version" --force; then 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 		apt-get install -y --no-install-recommends g++ gcc libc-dev make python3; 		rm -rf /var/lib/apt/lists/*; 				npm_config_python='python3' gosu node yarn add "sqlite3@$sqlite3Version" --force --build-from-source; 				apt-mark showmanual | xargs apt-mark auto > /dev/null; 		[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 		apt-get purge -y --auto-remove; 	fi; 		gosu node yarn cache clean; 	gosu node npm cache clean --force; 	npm cache clean --force; 	rm -rv /tmp/yarn* /tmp/v8*
# Wed, 27 Jan 2021 23:59:53 GMT
WORKDIR /var/lib/ghost
# Wed, 27 Jan 2021 23:59:54 GMT
VOLUME [/var/lib/ghost/content]
# Wed, 27 Jan 2021 23:59:54 GMT
COPY file:303989b132b5193e832753e2c7236a4050fdc0fe60a54dc1f0c4a44422a2d1ca in /usr/local/bin 
# Wed, 27 Jan 2021 23:59:55 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 27 Jan 2021 23:59:55 GMT
EXPOSE 2368
# Wed, 27 Jan 2021 23:59:56 GMT
CMD ["node" "current/index.js"]
```
...
-	Layers:
	...
	-	`sha256:e0675f72382e0c51f70214c3f43e7560500a22f5f776d3abc9341be04f4bc63b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b9aa9dfcc5c43d23fdfae2f6bb7c0c02bef0a11e391d431596287ed8358ce14`  
		Last Modified: Thu, 28 Jan 2021 00:00:51 GMT  
		Size: 56.9 MB (56937067 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad2f1e4c792be0bdd98020cf492c905e3621b8e2abc0573d01f0e0353b8fbb37`  
		Last Modified: Thu, 28 Jan 2021 00:00:43 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
