...
```console
$ docker pull ghost@sha256:0da216602e1b0800f7d13f353b996ba9a92fcaa5cc4a1d455fa5a7a807ee0c62
```
...
### `ghost:5.91.0-alpine` - linux; amd64
...
### `ghost:5.91.0-alpine` - unknown; unknown
...
### `ghost:5.91.0-alpine` - linux; arm variant v6
