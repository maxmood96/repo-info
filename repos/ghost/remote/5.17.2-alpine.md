...
```console
$ docker pull ghost@sha256:4422f41fb0f043950094abdb859a6c2059592d09e4c3e54a271181aaec8443fa
```
...
### `ghost:5.17.2-alpine` - linux; arm variant v7
...
### `ghost:5.17.2-alpine` - linux; arm64 variant v8
