...
```console
sapmachine-24-jdk-24.0.1-r0 description:
The SapMachine Java Development Kit

sapmachine-24-jdk-24.0.1-r0 webpage:
https://sapmachine.io

sapmachine-24-jdk-24.0.1-r0 installed size:
378 MiB

sapmachine-24-jdk-24.0.1-r0 license:
