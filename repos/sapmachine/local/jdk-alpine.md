...
- Created: `2026-06-22T20:07:38.0496464Z`
...
```console
nss-3.123.1-r0 description:
Mozilla Network Security Services

nss-3.123.1-r0 webpage:
https://developer.mozilla.org/docs/Mozilla/Projects/NSS

nss-3.123.1-r0 installed size:
3984 KiB

nss-3.123.1-r0 license:
MPL-2.0
...
```console
sapmachine-26-jdk-26.0.1-r0 description:
The SapMachine Java Development Kit

sapmachine-26-jdk-26.0.1-r0 webpage:
https://sapmachine.io

sapmachine-26-jdk-26.0.1-r0 installed size:
345 MiB

sapmachine-26-jdk-26.0.1-r0 license:
