...
- Environment:
  ...
  - `JAVA_HOME=/usr/lib/jvm/java-23-sapmachine-jre`
...
### `apk` package: `sapmachine-23-jre`

```console
sapmachine-23-jre-23.0.2-r0 description:
The SapMachine Java Runtime Environment

sapmachine-23-jre-23.0.2-r0 webpage:
https://sapmachine.io

sapmachine-23-jre-23.0.2-r0 installed size:
152 MiB

sapmachine-23-jre-23.0.2-r0 license:
