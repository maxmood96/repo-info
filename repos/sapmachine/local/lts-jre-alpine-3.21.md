...
- Created: `2025-01-27T13:39:13Z`
- Virtual Size: ~ 183.27 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["jshell"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `JAVA_HOME=/usr/lib/jvm/java-21-sapmachine-jre`
...
```console
alsa-lib-1.2.12-r0 description:
Advanced Linux Sound Architecture (ALSA) library

alsa-lib-1.2.12-r0 webpage:
https://alsa-project.org/

alsa-lib-1.2.12-r0 installed size:
1182 KiB

alsa-lib-1.2.12-r0 license:
LGPL-2.1-or-later
...
```console
sapmachine-21-jre-21.0.6-r0 description:
The SapMachine Java Runtime Environment

sapmachine-21-jre-21.0.6-r0 webpage:
https://sapmachine.io

sapmachine-21-jre-21.0.6-r0 installed size:
152 MiB

sapmachine-21-jre-21.0.6-r0 license:
