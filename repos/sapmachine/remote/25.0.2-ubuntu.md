...
### `sapmachine:25.0.2-ubuntu` - linux; amd64
...
### `sapmachine:25.0.2-ubuntu` - unknown; unknown
...
### `sapmachine:25.0.2-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-ubuntu` - linux; ppc64le
