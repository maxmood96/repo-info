...
### `sapmachine:21.0.10-ubuntu` - linux; amd64
...
### `sapmachine:21.0.10-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.10-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-ubuntu` - linux; ppc64le
