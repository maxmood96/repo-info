## `sapmachine:21.0.11-jre-headless-ubuntu`
...
### `sapmachine:21.0.11-jre-headless-ubuntu` - linux; amd64
...
### `sapmachine:21.0.11-jre-headless-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.11-jre-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.11-jre-headless-ubuntu` - linux; ppc64le
