## `sapmachine:25.0.3-ubuntu-jammy`
...
### `sapmachine:25.0.3-ubuntu-jammy` - linux; amd64
...
### `sapmachine:25.0.3-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:25.0.3-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:25.0.3-ubuntu-jammy` - linux; ppc64le
