## `sapmachine:21.0.7-jdk-headless`
...
### `sapmachine:21.0.7-jdk-headless` - linux; amd64
...
### `sapmachine:21.0.7-jdk-headless` - unknown; unknown
...
### `sapmachine:21.0.7-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:21.0.7-jdk-headless` - linux; ppc64le
