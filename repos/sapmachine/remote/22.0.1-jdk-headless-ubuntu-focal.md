...
### `sapmachine:22.0.1-jdk-headless-ubuntu-focal` - linux; amd64
...
### `sapmachine:22.0.1-jdk-headless-ubuntu-focal` - unknown; unknown
...
### `sapmachine:22.0.1-jdk-headless-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:22.0.1-jdk-headless-ubuntu-focal` - linux; ppc64le
