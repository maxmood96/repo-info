...
### `sapmachine:17.0.17-jdk` - linux; amd64
...
### `sapmachine:17.0.17-jdk` - unknown; unknown
...
### `sapmachine:17.0.17-jdk` - linux; arm64 variant v8
...
### `sapmachine:17.0.17-jdk` - linux; ppc64le
