...
### `sapmachine:24.0.1-jdk` - linux; amd64
...
### `sapmachine:24.0.1-jdk` - unknown; unknown
...
### `sapmachine:24.0.1-jdk` - linux; arm64 variant v8
...
### `sapmachine:24.0.1-jdk` - linux; ppc64le
