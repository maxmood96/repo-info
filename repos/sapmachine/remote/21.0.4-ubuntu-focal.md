...
### `sapmachine:21.0.4-ubuntu-focal` - linux; amd64
...
### `sapmachine:21.0.4-ubuntu-focal` - unknown; unknown
...
### `sapmachine:21.0.4-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:21.0.4-ubuntu-focal` - linux; ppc64le
