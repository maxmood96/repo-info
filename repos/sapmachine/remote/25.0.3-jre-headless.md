## `sapmachine:25.0.3-jre-headless`

```console
$ docker pull sapmachine@sha256:665e8c664064f47255a920587334d8e42a5094cc427f22227eb551a1f84d9527
```
...
### `sapmachine:25.0.3-jre-headless` - linux; amd64
...
### `sapmachine:25.0.3-jre-headless` - unknown; unknown
...
### `sapmachine:25.0.3-jre-headless` - linux; arm64 variant v8
