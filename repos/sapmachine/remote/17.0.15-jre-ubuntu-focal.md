...
### `sapmachine:17.0.15-jre-ubuntu-focal` - linux; amd64
...
### `sapmachine:17.0.15-jre-ubuntu-focal` - unknown; unknown
...
### `sapmachine:17.0.15-jre-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:17.0.15-jre-ubuntu-focal` - linux; ppc64le
