## `sapmachine:24.0.1-jdk-headless`
...
### `sapmachine:24.0.1-jdk-headless` - linux; amd64
...
### `sapmachine:24.0.1-jdk-headless` - unknown; unknown
...
### `sapmachine:24.0.1-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:24.0.1-jdk-headless` - linux; ppc64le
