...
### `sapmachine:21.0.10-ubuntu-noble` - linux; amd64
...
### `sapmachine:21.0.10-ubuntu-noble` - unknown; unknown
...
### `sapmachine:21.0.10-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-ubuntu-noble` - linux; ppc64le
