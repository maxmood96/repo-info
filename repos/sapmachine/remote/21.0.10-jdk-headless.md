...
### `sapmachine:21.0.10-jdk-headless` - linux; amd64
...
### `sapmachine:21.0.10-jdk-headless` - unknown; unknown
...
### `sapmachine:21.0.10-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-jdk-headless` - linux; ppc64le
