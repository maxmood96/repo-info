...
### `sapmachine:17.0.15-jre` - linux; amd64
...
### `sapmachine:17.0.15-jre` - unknown; unknown
...
### `sapmachine:17.0.15-jre` - linux; arm64 variant v8
...
### `sapmachine:17.0.15-jre` - linux; ppc64le
