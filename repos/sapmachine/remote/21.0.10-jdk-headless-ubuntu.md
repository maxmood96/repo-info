...
### `sapmachine:21.0.10-jdk-headless-ubuntu` - linux; amd64
...
### `sapmachine:21.0.10-jdk-headless-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.10-jdk-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-jdk-headless-ubuntu` - linux; ppc64le
