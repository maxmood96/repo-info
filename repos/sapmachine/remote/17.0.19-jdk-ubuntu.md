...
### `sapmachine:17.0.19-jdk-ubuntu` - linux; amd64
...
### `sapmachine:17.0.19-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:17.0.19-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.19-jdk-ubuntu` - linux; ppc64le
