## `sapmachine:17.0.15-jdk-headless`
...
### `sapmachine:17.0.15-jdk-headless` - linux; amd64
...
### `sapmachine:17.0.15-jdk-headless` - unknown; unknown
...
### `sapmachine:17.0.15-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:17.0.15-jdk-headless` - linux; ppc64le
