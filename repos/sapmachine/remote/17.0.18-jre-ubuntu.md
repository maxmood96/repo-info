...
### `sapmachine:17.0.18-jre-ubuntu` - linux; amd64
...
### `sapmachine:17.0.18-jre-ubuntu` - unknown; unknown
...
### `sapmachine:17.0.18-jre-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.18-jre-ubuntu` - linux; ppc64le
