...
### `sapmachine:21.0.8-jre` - linux; amd64
...
### `sapmachine:21.0.8-jre` - unknown; unknown
...
### `sapmachine:21.0.8-jre` - linux; arm64 variant v8
...
### `sapmachine:21.0.8-jre` - linux; ppc64le
