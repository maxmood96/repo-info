...
### `sapmachine:23.0.1-jdk-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:23.0.1-jdk-headless-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:23.0.1-jdk-headless-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:23.0.1-jdk-headless-ubuntu-jammy` - linux; ppc64le
