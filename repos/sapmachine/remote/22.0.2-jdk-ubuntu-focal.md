...
### `sapmachine:22.0.2-jdk-ubuntu-focal` - linux; amd64
...
### `sapmachine:22.0.2-jdk-ubuntu-focal` - unknown; unknown
...
### `sapmachine:22.0.2-jdk-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:22.0.2-jdk-ubuntu-focal` - linux; ppc64le
