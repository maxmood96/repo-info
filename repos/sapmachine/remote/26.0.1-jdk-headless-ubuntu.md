## `sapmachine:26.0.1-jdk-headless-ubuntu`
...
### `sapmachine:26.0.1-jdk-headless-ubuntu` - linux; amd64
...
### `sapmachine:26.0.1-jdk-headless-ubuntu` - unknown; unknown
...
### `sapmachine:26.0.1-jdk-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jdk-headless-ubuntu` - linux; ppc64le
