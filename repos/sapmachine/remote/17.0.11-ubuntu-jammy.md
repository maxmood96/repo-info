...
### `sapmachine:17.0.11-ubuntu-jammy` - linux; amd64
...
### `sapmachine:17.0.11-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:17.0.11-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:17.0.11-ubuntu-jammy` - linux; ppc64le
