...
### `sapmachine:25.0.2-jdk-ubuntu` - linux; amd64
...
### `sapmachine:25.0.2-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:25.0.2-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jdk-ubuntu` - linux; ppc64le
