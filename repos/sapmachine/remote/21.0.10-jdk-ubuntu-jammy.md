...
### `sapmachine:21.0.10-jdk-ubuntu-jammy` - linux; amd64
...
### `sapmachine:21.0.10-jdk-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:21.0.10-jdk-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-jdk-ubuntu-jammy` - linux; ppc64le
