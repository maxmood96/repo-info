...
### `sapmachine:ubuntu-focal` - linux; amd64
...
### `sapmachine:ubuntu-focal` - unknown; unknown
...
### `sapmachine:ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:ubuntu-focal` - linux; ppc64le
