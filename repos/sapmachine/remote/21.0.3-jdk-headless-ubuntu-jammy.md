...
### `sapmachine:21.0.3-jdk-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:21.0.3-jdk-headless-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:21.0.3-jdk-headless-ubuntu-jammy` - linux; ppc64le
