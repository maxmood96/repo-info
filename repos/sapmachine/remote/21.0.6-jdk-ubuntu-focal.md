...
### `sapmachine:21.0.6-jdk-ubuntu-focal` - linux; amd64
...
### `sapmachine:21.0.6-jdk-ubuntu-focal` - unknown; unknown
...
### `sapmachine:21.0.6-jdk-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:21.0.6-jdk-ubuntu-focal` - linux; ppc64le
