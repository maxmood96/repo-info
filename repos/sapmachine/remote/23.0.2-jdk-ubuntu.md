...
### `sapmachine:23.0.2-jdk-ubuntu` - linux; amd64
...
### `sapmachine:23.0.2-jdk-ubuntu` - unknown; unknown
...
### `sapmachine:23.0.2-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:23.0.2-jdk-ubuntu` - linux; ppc64le
