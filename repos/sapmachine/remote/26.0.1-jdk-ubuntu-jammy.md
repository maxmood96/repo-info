## `sapmachine:26.0.1-jdk-ubuntu-jammy`
...
### `sapmachine:26.0.1-jdk-ubuntu-jammy` - linux; amd64
...
### `sapmachine:26.0.1-jdk-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:26.0.1-jdk-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jdk-ubuntu-jammy` - linux; ppc64le
