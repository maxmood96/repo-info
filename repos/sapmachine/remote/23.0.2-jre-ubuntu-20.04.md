...
### `sapmachine:23.0.2-jre-ubuntu-20.04` - linux; amd64
...
### `sapmachine:23.0.2-jre-ubuntu-20.04` - unknown; unknown
...
### `sapmachine:23.0.2-jre-ubuntu-20.04` - linux; arm64 variant v8
...
### `sapmachine:23.0.2-jre-ubuntu-20.04` - linux; ppc64le
