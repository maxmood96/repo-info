...
### `sapmachine:21.0.7-ubuntu` - linux; amd64
...
### `sapmachine:21.0.7-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.7-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.7-ubuntu` - linux; ppc64le
