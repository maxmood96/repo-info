...
### `sapmachine:17.0.18-jre` - linux; amd64
...
### `sapmachine:17.0.18-jre` - unknown; unknown
...
### `sapmachine:17.0.18-jre` - linux; arm64 variant v8
...
### `sapmachine:17.0.18-jre` - linux; ppc64le
