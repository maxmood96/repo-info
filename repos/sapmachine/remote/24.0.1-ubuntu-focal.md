...
### `sapmachine:24.0.1-ubuntu-focal` - linux; amd64
...
### `sapmachine:24.0.1-ubuntu-focal` - unknown; unknown
...
### `sapmachine:24.0.1-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:24.0.1-ubuntu-focal` - linux; ppc64le
