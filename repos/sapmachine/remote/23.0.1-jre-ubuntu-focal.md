...
### `sapmachine:23.0.1-jre-ubuntu-focal` - linux; amd64
...
### `sapmachine:23.0.1-jre-ubuntu-focal` - unknown; unknown
...
### `sapmachine:23.0.1-jre-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:23.0.1-jre-ubuntu-focal` - linux; ppc64le
