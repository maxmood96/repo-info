...
### `sapmachine:25.0.2-jdk-headless` - linux; amd64
...
### `sapmachine:25.0.2-jdk-headless` - unknown; unknown
...
### `sapmachine:25.0.2-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jdk-headless` - linux; ppc64le
