## `sapmachine:26.0.1-jdk-headless`
...
### `sapmachine:26.0.1-jdk-headless` - linux; amd64
...
### `sapmachine:26.0.1-jdk-headless` - unknown; unknown
...
### `sapmachine:26.0.1-jdk-headless` - linux; arm64 variant v8
...
### `sapmachine:26.0.1-jdk-headless` - linux; ppc64le
