...
### `sapmachine:25.0.2-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:25.0.2-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:25.0.2-jdk-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jdk-ubuntu-noble` - linux; ppc64le
