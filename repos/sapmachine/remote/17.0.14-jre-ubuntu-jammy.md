...
```console
$ docker pull sapmachine@sha256:2cf97c0c16f0bcf142189988760212bbc9be1f887c2b2a7fe3e86ee17eb04d63
```
...
### `sapmachine:17.0.14-jre-ubuntu-jammy` - linux; amd64
...
### `sapmachine:17.0.14-jre-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:17.0.14-jre-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:17.0.14-jre-ubuntu-jammy` - linux; ppc64le
