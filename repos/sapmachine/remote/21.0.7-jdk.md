...
### `sapmachine:21.0.7-jdk` - linux; amd64
...
### `sapmachine:21.0.7-jdk` - unknown; unknown
...
### `sapmachine:21.0.7-jdk` - linux; arm64 variant v8
...
### `sapmachine:21.0.7-jdk` - linux; ppc64le
