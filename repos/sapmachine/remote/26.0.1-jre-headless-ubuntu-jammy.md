## `sapmachine:26.0.1-jre-headless-ubuntu-jammy`

```console
$ docker pull sapmachine@sha256:5150b8bbaa0996ec50bb604aae42e4b1622575ad2ea2c0d47dec36e7c653bc1e
```
...
### `sapmachine:26.0.1-jre-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:26.0.1-jre-headless-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:26.0.1-jre-headless-ubuntu-jammy` - linux; arm64 variant v8
