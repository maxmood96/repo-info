...
### `sapmachine:24.0.2-jre` - linux; amd64
...
### `sapmachine:24.0.2-jre` - unknown; unknown
...
### `sapmachine:24.0.2-jre` - linux; arm64 variant v8
...
### `sapmachine:24.0.2-jre` - linux; ppc64le
