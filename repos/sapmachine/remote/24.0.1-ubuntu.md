...
### `sapmachine:24.0.1-ubuntu` - linux; amd64
...
### `sapmachine:24.0.1-ubuntu` - unknown; unknown
...
### `sapmachine:24.0.1-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:24.0.1-ubuntu` - linux; ppc64le
