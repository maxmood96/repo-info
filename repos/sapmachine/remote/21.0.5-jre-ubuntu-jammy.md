...
### `sapmachine:21.0.5-jre-ubuntu-jammy` - linux; amd64
...
### `sapmachine:21.0.5-jre-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:21.0.5-jre-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:21.0.5-jre-ubuntu-jammy` - linux; ppc64le
