## `sapmachine:17.0.19-jdk-headless-ubuntu-jammy`
...
### `sapmachine:17.0.19-jdk-headless-ubuntu-jammy` - linux; amd64
...
### `sapmachine:17.0.19-jdk-headless-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:17.0.19-jdk-headless-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:17.0.19-jdk-headless-ubuntu-jammy` - linux; ppc64le
