...
### `sapmachine:21.0.7-jre` - linux; amd64
...
### `sapmachine:21.0.7-jre` - unknown; unknown
...
### `sapmachine:21.0.7-jre` - linux; arm64 variant v8
...
### `sapmachine:21.0.7-jre` - linux; ppc64le
