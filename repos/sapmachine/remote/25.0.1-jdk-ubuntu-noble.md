## `sapmachine:25.0.1-jdk-ubuntu-noble`

```console
$ docker pull sapmachine@sha256:b915294433190b17d21124f01c2123d4235aa6b823c1847039e9b70cf5bab8e2
```
...
### `sapmachine:25.0.1-jdk-ubuntu-noble` - linux; amd64
...
### `sapmachine:25.0.1-jdk-ubuntu-noble` - unknown; unknown
...
### `sapmachine:25.0.1-jdk-ubuntu-noble` - linux; arm64 variant v8
