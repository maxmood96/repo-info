...
### `sapmachine:21.0.9-jre` - linux; amd64
...
### `sapmachine:21.0.9-jre` - unknown; unknown
...
### `sapmachine:21.0.9-jre` - linux; arm64 variant v8
...
### `sapmachine:21.0.9-jre` - linux; ppc64le
