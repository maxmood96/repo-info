...
### `sapmachine:24-jre-headless` - linux; amd64
...
### `sapmachine:24-jre-headless` - unknown; unknown
...
### `sapmachine:24-jre-headless` - linux; arm64 variant v8
...
### `sapmachine:24-jre-headless` - linux; ppc64le
