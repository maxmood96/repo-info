...
### `sapmachine:23.0.2-jre-headless-ubuntu-focal` - linux; amd64
...
### `sapmachine:23.0.2-jre-headless-ubuntu-focal` - unknown; unknown
...
### `sapmachine:23.0.2-jre-headless-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:23.0.2-jre-headless-ubuntu-focal` - linux; ppc64le
