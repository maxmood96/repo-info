...
### `sapmachine:25.0.2-jre-ubuntu-jammy` - linux; amd64
...
### `sapmachine:25.0.2-jre-ubuntu-jammy` - unknown; unknown
...
### `sapmachine:25.0.2-jre-ubuntu-jammy` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jre-ubuntu-jammy` - linux; ppc64le
