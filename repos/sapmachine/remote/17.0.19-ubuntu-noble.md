## `sapmachine:17.0.19-ubuntu-noble`
...
### `sapmachine:17.0.19-ubuntu-noble` - linux; amd64
...
### `sapmachine:17.0.19-ubuntu-noble` - unknown; unknown
...
### `sapmachine:17.0.19-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:17.0.19-ubuntu-noble` - linux; ppc64le
