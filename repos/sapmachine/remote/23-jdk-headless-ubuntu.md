...
### `sapmachine:23-jdk-headless-ubuntu` - linux; amd64
...
### `sapmachine:23-jdk-headless-ubuntu` - unknown; unknown
...
### `sapmachine:23-jdk-headless-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:23-jdk-headless-ubuntu` - linux; ppc64le
