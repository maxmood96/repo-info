...
### `sapmachine:17.0.17-ubuntu` - linux; amd64
...
### `sapmachine:17.0.17-ubuntu` - unknown; unknown
...
### `sapmachine:17.0.17-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:17.0.17-ubuntu` - linux; ppc64le
