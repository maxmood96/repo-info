...
### `sapmachine:25.0.2-jdk-headless-ubuntu-noble` - linux; amd64
...
### `sapmachine:25.0.2-jdk-headless-ubuntu-noble` - unknown; unknown
...
### `sapmachine:25.0.2-jdk-headless-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jdk-headless-ubuntu-noble` - linux; ppc64le
