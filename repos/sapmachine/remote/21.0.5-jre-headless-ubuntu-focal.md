...
### `sapmachine:21.0.5-jre-headless-ubuntu-focal` - linux; amd64
...
### `sapmachine:21.0.5-jre-headless-ubuntu-focal` - unknown; unknown
...
### `sapmachine:21.0.5-jre-headless-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:21.0.5-jre-headless-ubuntu-focal` - linux; ppc64le
