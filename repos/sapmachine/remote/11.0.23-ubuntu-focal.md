...
### `sapmachine:11.0.23-ubuntu-focal` - linux; amd64
...
### `sapmachine:11.0.23-ubuntu-focal` - unknown; unknown
...
### `sapmachine:11.0.23-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:11.0.23-ubuntu-focal` - linux; ppc64le
