## `sapmachine:25.0.1-ubuntu-noble`
...
### `sapmachine:25.0.1-ubuntu-noble` - linux; amd64
...
### `sapmachine:25.0.1-ubuntu-noble` - unknown; unknown
...
### `sapmachine:25.0.1-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:25.0.1-ubuntu-noble` - linux; ppc64le
