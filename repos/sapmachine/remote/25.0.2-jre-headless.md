...
### `sapmachine:25.0.2-jre-headless` - linux; amd64
...
### `sapmachine:25.0.2-jre-headless` - unknown; unknown
...
### `sapmachine:25.0.2-jre-headless` - linux; arm64 variant v8
...
### `sapmachine:25.0.2-jre-headless` - linux; ppc64le
