...
### `sapmachine:21.0.10-jre-ubuntu` - linux; amd64
...
### `sapmachine:21.0.10-jre-ubuntu` - unknown; unknown
...
### `sapmachine:21.0.10-jre-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-jre-ubuntu` - linux; ppc64le
