...
### `sapmachine:21.0.7-jre-ubuntu-focal` - linux; amd64
...
### `sapmachine:21.0.7-jre-ubuntu-focal` - unknown; unknown
...
### `sapmachine:21.0.7-jre-ubuntu-focal` - linux; arm64 variant v8
...
### `sapmachine:21.0.7-jre-ubuntu-focal` - linux; ppc64le
