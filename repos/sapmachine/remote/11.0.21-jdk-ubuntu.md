...
### `sapmachine:11.0.21-jdk-ubuntu` - linux; amd64
...
### `sapmachine:11.0.21-jdk-ubuntu` - linux; arm64 variant v8
...
### `sapmachine:11.0.21-jdk-ubuntu` - linux; ppc64le
