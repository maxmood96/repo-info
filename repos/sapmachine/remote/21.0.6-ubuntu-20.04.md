...
```console
$ docker pull sapmachine@sha256:617c45f6b2108ade864e16ecdda7ceef58afba28deb0faf173158efc2177c4de
```
...
### `sapmachine:21.0.6-ubuntu-20.04` - linux; amd64
...
### `sapmachine:21.0.6-ubuntu-20.04` - unknown; unknown
...
### `sapmachine:21.0.6-ubuntu-20.04` - linux; arm64 variant v8
...
### `sapmachine:21.0.6-ubuntu-20.04` - linux; ppc64le
