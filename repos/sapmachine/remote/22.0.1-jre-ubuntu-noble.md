...
### `sapmachine:22.0.1-jre-ubuntu-noble` - linux; amd64
...
### `sapmachine:22.0.1-jre-ubuntu-noble` - unknown; unknown
...
### `sapmachine:22.0.1-jre-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:22.0.1-jre-ubuntu-noble` - linux; ppc64le
