...
### `sapmachine:21.0.10-jre-ubuntu-noble` - linux; amd64
...
### `sapmachine:21.0.10-jre-ubuntu-noble` - unknown; unknown
...
### `sapmachine:21.0.10-jre-ubuntu-noble` - linux; arm64 variant v8
...
### `sapmachine:21.0.10-jre-ubuntu-noble` - linux; ppc64le
