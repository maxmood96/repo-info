...
### `sapmachine:24.0.1-jre-ubuntu-20.04` - linux; amd64
...
### `sapmachine:24.0.1-jre-ubuntu-20.04` - unknown; unknown
...
### `sapmachine:24.0.1-jre-ubuntu-20.04` - linux; arm64 variant v8
...
### `sapmachine:24.0.1-jre-ubuntu-20.04` - linux; ppc64le
