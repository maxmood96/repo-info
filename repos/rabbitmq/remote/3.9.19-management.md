...
```console
$ docker pull rabbitmq@sha256:2e50a41d86c83acc8af56cc96f61637d0ccba8b42e6d35ee8b0974033d53ddad
```
...
### `rabbitmq:3.9.19-management` - linux; arm variant v7
...
### `rabbitmq:3.9.19-management` - linux; ppc64le
