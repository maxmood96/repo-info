...
```console
$ docker pull rabbitmq@sha256:b0b9235688f6e697f3106eb70a350b5fa8a3279d0b69f1d89d2fec2f421db8d9
```
...
```console
$ docker pull rabbitmq@sha256:8e5f58e586b4f553c6bb9b3d08fc6afc4defbe969c8770b43e452ac84ec227b9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.3 MB (84284447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdd04ba3453bf3ca974c3a68a6de95e0db02bb24a3ca802e7926f83eeefe1681`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
# Wed, 19 Aug 2020 21:42:26 GMT
CMD ["rabbitmq-server"]
# Wed, 19 Aug 2020 21:42:43 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Wed, 19 Aug 2020 21:42:52 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python3; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Wed, 19 Aug 2020 21:42:53 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:fe4f5ab1775b0bf2ce180e752cc69faf3ffd6ec0daa1c3ac20936bbcfa11c94c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5a0c239738e0a338d3c9b38e1922a75c08af03f171c1048bcd47013608748d5`  
		Last Modified: Wed, 19 Aug 2020 21:43:28 GMT  
		Size: 188.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0a9eb117cd9ab40a84e485ff00e9600c04dfc37a47888855af18afaef9eef49`  
		Last Modified: Wed, 19 Aug 2020 21:43:29 GMT  
		Size: 10.4 MB (10410726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
