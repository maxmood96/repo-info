...
```console
$ docker pull rabbitmq@sha256:9ff082bf90985dadf800d4b52d5afb82573b19feb375d6735ed0b3a38943b648
```
...
```console
$ docker pull rabbitmq@sha256:7295edd7d7af2ee361053b8351206918fa3e2acb07a5b1bd314813298dd4f40b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.9 MB (98858319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee37bc8368242e2e21d594065574da1382215d85fc56a37c5a38e4938f3bcdca`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
-	Layers:
	...
	-	`sha256:120820c6c972ddeb52e1a2a9b832c135c24e5c80e6e259e59e70a88139c71ad3`  
		...
		Size: 834.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47163d7ed067a32bb9498c28dcdfaad3eb30ee3f5a4f027d8fd91e3848bd0957`  
		Last Modified: Tue, 23 Nov 2021 01:56:37 GMT  
		Size: 11.6 MB (11609048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3-management` - linux; ppc64le

```console
$ docker pull rabbitmq@sha256:8cc2968a76945cf24a11a59b89f0ab53191957e06b3cacbe75134c2dfa12c576
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.7 MB (107660987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99cb4f411af374fa39275ad99bac18eb55de9fd13e15e40b43098a4cef3c737b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Sat, 20 Nov 2021 03:43:54 GMT
RUN set eux; 	rabbitmq-plugins enable --offline rabbitmq_management; 	rm -f /etc/rabbitmq/conf.d/management_agent.disable_metrics_collector.conf; 	cp /plugins/rabbitmq_management-*/priv/www/cli/rabbitmqadmin /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; 	apt-get install -y --no-install-recommends python3; 	rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Sat, 20 Nov 2021 03:43:57 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:e02f145ed48ee30bcbb16777b4ccc38694ae0f0e7f63053076e1f5015e4779ac`  
		...
		Size: 832.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f814ac44093918bf3afdf489b8e2d112293a191ff00746f293327b4134dec96`  
		Last Modified: Sat, 20 Nov 2021 03:46:35 GMT  
		Size: 12.6 MB (12603381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3-management` - linux; riscv64

```console
$ docker pull rabbitmq@sha256:993fc283a63974f02443df3af33ba53e3d529684157a2ddc00b7662ca4c43bb1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.1 MB (95095800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8cb3473588fa9c50b2281a1a560134a79cf031cadb98942a0fc0bef2a7d88a3`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Tue, 23 Nov 2021 01:45:49 GMT
RUN set eux; 	rabbitmq-plugins enable --offline rabbitmq_management; 	rm -f /etc/rabbitmq/conf.d/management_agent.disable_metrics_collector.conf; 	cp /plugins/rabbitmq_management-*/priv/www/cli/rabbitmqadmin /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; 	apt-get install -y --no-install-recommends python3; 	rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 23 Nov 2021 01:45:50 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:212c4ce7d3eac4c52b7cb1b9e64432c94b51b4aa504a9b1c8628852377beb6d1`  
		...
		Size: 839.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6745f987e3fd8df635d013514a87bf9e2d656862b1633b239ef90afa6925fae8`  
		Last Modified: Tue, 23 Nov 2021 02:05:49 GMT  
		Size: 10.2 MB (10217477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3-management` - linux; s390x

```console
$ docker pull rabbitmq@sha256:64036079b741302a09c2d862f9b36ccdd289ce633e38da9b946de849c62febec
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.1 MB (98116783 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8541b695f1e5eedaa6832ad9740f40c76c64e6369bc470ae2a4a92165dae36d6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
# Tue, 23 Nov 2021 01:45:32 GMT
CMD ["rabbitmq-server"]
# Tue, 23 Nov 2021 01:45:56 GMT
RUN set eux; 	rabbitmq-plugins enable --offline rabbitmq_management; 	rm -f /etc/rabbitmq/conf.d/management_agent.disable_metrics_collector.conf; 	cp /plugins/rabbitmq_management-*/priv/www/cli/rabbitmqadmin /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; 	apt-get install -y --no-install-recommends python3; 	rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 23 Nov 2021 01:45:57 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:3e56ff6b9b24fe5005347738c854562380ba679d34f007dc62b8fc451831e8b7`  
		...
		Size: 833.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:826b26a834e70feba3a7f33b8225561c3e3a780523921c674c079bc3b6955622`  
		Last Modified: Tue, 23 Nov 2021 01:51:15 GMT  
		Size: 11.3 MB (11259383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
