...
```console
$ docker pull rabbitmq@sha256:8d50ca0761f8466704615f39433a082452279f44478fef2cbf3e0b26a7d6b7ea
```
...
```console
$ docker pull rabbitmq@sha256:1e7a536a01dfc2d50ce6902272f66649b9eb7465282e6349ae42b85860c95fec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.5 MB (94476500 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ea5924cf1a4810e14514ba51a7feff4e2eec5235c9462c1cceff053df712223`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Tue, 22 Mar 2022 23:22:06 GMT
RUN set eux; 	rabbitmq-plugins enable --offline rabbitmq_management; 	rm -f /etc/rabbitmq/conf.d/management_agent.disable_metrics_collector.conf; 	cp /plugins/rabbitmq_management-*/priv/www/cli/rabbitmqadmin /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; 	apt-get install -y --no-install-recommends python3; 	rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 22 Mar 2022 23:22:07 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:1aa0be8f13b830d5f0e3f7d8f92cfa11140466ed5db3bb61a77dd691b763bdd8`  
		...
		Size: 834.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1f4cebdb45fe8caeffc0e95a9a84fd1d66d8394fab4fc79d2be67ce6c3df487`  
		Last Modified: Tue, 22 Mar 2022 23:30:14 GMT  
		Size: 10.5 MB (10522911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull rabbitmq@sha256:8a969517211d46847375d818bd43458bc168310f98a1b11673ea57eaacaa347e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.3 MB (108342746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:246d410eed5703442db4d22c874825f2f970a453f580f27e83dbd22b00016d44`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Wed, 23 Mar 2022 00:14:14 GMT
RUN set eux; 	rabbitmq-plugins enable --offline rabbitmq_management; 	rm -f /etc/rabbitmq/conf.d/management_agent.disable_metrics_collector.conf; 	cp /plugins/rabbitmq_management-*/priv/www/cli/rabbitmqadmin /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; 	apt-get install -y --no-install-recommends python3; 	rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Wed, 23 Mar 2022 00:14:23 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:b84ccbb72ff4e27175d5082089f6e078f7f297174608c0dfe5d6cfa82f4cf940`  
		...
		Size: 834.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87dac7861f4f2dcdcf65244633a880bed24138e8e75bb8aacd85b581b5d02f05`  
		Last Modified: Wed, 23 Mar 2022 00:29:18 GMT  
		Size: 12.6 MB (12594424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3-management` - linux; riscv64

```console
$ docker pull rabbitmq@sha256:3e8c590151f23794257319034d06925d5cb779101d6100a2fd78798ab7d6e752
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.9 MB (95894742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8b9a776fe2f9d3eae64ae4fb7d5621436ca9be694086009fc1ee2b237b40c68`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
-	Layers:
	...
	-	`sha256:827dc239691073d7481106af35cc4c479dcec83ebbfbb77e66604dfcd47c838b`  
		...
		Size: 836.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:caf1ecbac6fbce5396981e02b93efa42c9a92bc5f82741c50e0896e24b37d551`  
		Last Modified: Tue, 22 Mar 2022 22:56:00 GMT  
		Size: 10.2 MB (10220011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
