...
### `rabbitmq:4.0.0-management-alpine` - linux; amd64
...
### `rabbitmq:4.0.0-management-alpine` - unknown; unknown
...
### `rabbitmq:4.0.0-management-alpine` - linux; arm variant v6
...
### `rabbitmq:4.0.0-management-alpine` - linux; arm variant v7
...
### `rabbitmq:4.0.0-management-alpine` - linux; arm64 variant v8
...
### `rabbitmq:4.0.0-management-alpine` - linux; 386
...
### `rabbitmq:4.0.0-management-alpine` - linux; ppc64le
...
### `rabbitmq:4.0.0-management-alpine` - linux; riscv64
...
### `rabbitmq:4.0.0-management-alpine` - linux; s390x
