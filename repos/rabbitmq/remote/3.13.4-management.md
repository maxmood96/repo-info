...
```console
$ docker pull rabbitmq@sha256:71931c8a2284fb75a8e9ae2aeb5d4d81088e8b37c79fcb24a632a98713f421ae
```
...
### `rabbitmq:3.13.4-management` - linux; arm variant v7
...
### `rabbitmq:3.13.4-management` - linux; ppc64le
