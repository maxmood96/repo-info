...
```console
$ docker pull rabbitmq@sha256:cae49893dc90b3b3b24c0385169372fa0d82ca565ac0346d3345a856f1dcdc40
```
...
### `rabbitmq:4.1.2-alpine` - linux; arm64 variant v8
...
### `rabbitmq:4.1.2-alpine` - linux; ppc64le
