...
```console
$ docker pull rabbitmq@sha256:3e5b19296c03840b1a3ef90449355bd74620817e2f69012300a9c55354e1545e
```
...
```console
$ docker pull rabbitmq@sha256:1b8c41eeec041b7942a566794cbe07de3b2762dcd237b2bf89dd998259468611
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.4 MB (71395137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca4a127cc59a8ae86e4317640ed61e8b1186121e0ab0882acd6313c79590c4e6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
```console
$ docker pull rabbitmq@sha256:7b54cb059570e7cfc12320d472d68696193dbb99e364b992fdc8c0370f826fde
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.5 MB (69459897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5842f5d3568946420273394037bff248a9c841fd04ff9b23d4a68d2bea6804b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
