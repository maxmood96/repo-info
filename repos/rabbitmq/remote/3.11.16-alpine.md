...
```console
$ docker pull rabbitmq@sha256:5015d9dacb8258adc593a75008439bb6be54dd810272eaf106fa5bfc4a110a0f
```
...
### `rabbitmq:3.11.16-alpine` - linux; amd64
...
### `rabbitmq:3.11.16-alpine` - linux; arm variant v6
...
### `rabbitmq:3.11.16-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.11.16-alpine` - linux; 386
...
### `rabbitmq:3.11.16-alpine` - linux; ppc64le
...
### `rabbitmq:3.11.16-alpine` - linux; s390x
