...
```console
$ docker pull rabbitmq@sha256:8b99f84c01aabc6d1994d53b46b0bdac80ce1ff4867e79dd44fbc6c3c890edd4
```
...
### `rabbitmq:4.0.1-management-alpine` - linux; amd64
...
### `rabbitmq:4.0.1-management-alpine` - unknown; unknown
...
### `rabbitmq:4.0.1-management-alpine` - linux; arm variant v6
...
### `rabbitmq:4.0.1-management-alpine` - linux; arm variant v7
...
### `rabbitmq:4.0.1-management-alpine` - linux; arm64 variant v8
...
### `rabbitmq:4.0.1-management-alpine` - linux; 386
...
### `rabbitmq:4.0.1-management-alpine` - linux; ppc64le
...
### `rabbitmq:4.0.1-management-alpine` - linux; s390x
