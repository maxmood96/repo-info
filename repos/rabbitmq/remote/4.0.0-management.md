...
### `rabbitmq:4.0.0-management` - linux; amd64
...
### `rabbitmq:4.0.0-management` - unknown; unknown
...
### `rabbitmq:4.0.0-management` - linux; arm variant v7
...
### `rabbitmq:4.0.0-management` - linux; arm64 variant v8
...
### `rabbitmq:4.0.0-management` - linux; ppc64le
...
### `rabbitmq:4.0.0-management` - linux; riscv64
...
### `rabbitmq:4.0.0-management` - linux; s390x
