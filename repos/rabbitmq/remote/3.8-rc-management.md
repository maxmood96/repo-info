...
```console
$ docker pull rabbitmq@sha256:e41d2fa8456325474f67b5785698f07823fff4b076b80733b43799a41a757bdd
```
...
```console
$ docker pull rabbitmq@sha256:3ef54582e551110d6c02fb0bf8541a88745e053e11b20518eb8b88908adbe338
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.3 MB (81266378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76495fbd93c888e5938e0d4962e743308ad1f9aaedc4df371fc397b23e8e1bf3`
...
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:37:37 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:37:51 GMT
...
-	Layers:
	...
	-	`sha256:6517daf6a95bd6e1fbd9a23f80c556262d06f1e1fa56183d7193cac6583e6e6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af585b8f352f4cbbe7271b82f7b7b8b799daa20e7d524dab43309099fdbcac7e`  
		Last Modified: Tue, 14 Jan 2020 23:56:27 GMT  
		Size: 188.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:205afc8d180de03fad7fb6f3e59c08ceaaf3cc595297af13f71316b82e30c631`  
		Last Modified: Tue, 14 Jan 2020 23:56:29 GMT  
		Size: 10.2 MB (10153598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.8-rc-management` - linux; arm variant v7

```console
$ docker pull rabbitmq@sha256:6e5e0b5be96a127a0b4227736e8a54b34f763dfa4d47ff6d3cd49a57fe9b41f7
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.9 MB (74922152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6e10e2dc1f195ca627120ae3fdfa4443f827e4c8b7116438686506a00b85b11`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:07:10 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:07:28 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 14 Jan 2020 23:07:29 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:e6ff82b6e8ddd0f5564abe469185cbc6f4717dc840adc9275f03e584013c575a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34d216cf7fa89cc073c40fd7a8f83e219ba322c6e8aa95f3ba481a28b507625a`  
		Last Modified: Tue, 14 Jan 2020 23:19:26 GMT  
		Size: 189.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69ae74cd168aad82b944b2c143542687d557b8f05710b775ab3b1b6f12ce77b4`  
		Last Modified: Tue, 14 Jan 2020 23:19:29 GMT  
		Size: 9.2 MB (9230537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.8-rc-management` - linux; arm64 variant v8

```console
$ docker pull rabbitmq@sha256:ad086ec50e6d28dedde558d559eb88df9d504bedb42c13c35b638308ef9631a8
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.4 MB (77383827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ae55424e6b76c65cd2b8300e171a36191e17c0f900d8c4023f894a8dc8b760e`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
# Tue, 14 Jan 2020 23:46:21 GMT
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:46:39 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:46:57 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 14 Jan 2020 23:46:58 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:586171e2d32d9a1adb3f4335d99d8a39c78406950cd855f3975f715388fe2a98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:217c0cbbed8a6254c96a21ed1c9d3601ef93f5aeb212541f698d7f4f256e4036`  
		Last Modified: Wed, 15 Jan 2020 00:04:22 GMT  
		Size: 189.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a168c0c6bb2266d50f624c4da55604430344aec69726928d986fdf2beba7a85`  
		Last Modified: Wed, 15 Jan 2020 00:04:25 GMT  
		Size: 9.7 MB (9739194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.8-rc-management` - linux; 386

```console
$ docker pull rabbitmq@sha256:d27e74b84ec2655d153480f0ed98759e364ccf9a7b242406d7cfd0eabfded87b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.7 MB (81705106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10d4dc4f361daba3e517ce97c06da907965609c86b7ab7ec774d3e3ab2184808`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
# Tue, 14 Jan 2020 23:53:26 GMT
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:53:35 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:53:50 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 14 Jan 2020 23:53:50 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:98c1616d1be754d893d31c731f1271e0cd730e6c265a24c46a058eedc0a10c70`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a71c6ffc8dfcbf9aabb1b24370278b66b2ad7cfc954517db8f892889853d5d44`  
		Last Modified: Wed, 15 Jan 2020 00:09:13 GMT  
		Size: 188.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9dbe6e297d1618f95a41194636673452df0dcff82ac8c294b09b45b71fec363`  
		Last Modified: Wed, 15 Jan 2020 00:09:16 GMT  
		Size: 10.3 MB (10263245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.8-rc-management` - linux; s390x

```console
$ docker pull rabbitmq@sha256:b24019ea920ba88b0a364d31737e1a297c51c3eb77d275bbcea0168dacc7e694
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **79.3 MB (79306981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:938cf12b343cd6a097920214b2e21400ef6db1ede954a1d0a92877190b8ee68b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
# Tue, 14 Jan 2020 23:57:40 GMT
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:57:52 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:58:01 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 14 Jan 2020 23:58:01 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:5e0d7a6a53e014703e728192601c6c373a9cb8cf12e298877aa15076485ab1b5`  
		...
		Size: 4.4 KB (4415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e2e0616dae3ca336c925b20a548a8b501f9bff05c599eec73ea063d03db5a66`  
		Last Modified: Wed, 15 Jan 2020 00:05:21 GMT  
		Size: 186.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22a9d820050330d96ee53b3a310afa5a5b96f36e7f1587a9da7418556004e37b`  
		Last Modified: Wed, 15 Jan 2020 00:05:22 GMT  
		Size: 9.8 MB (9797640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
