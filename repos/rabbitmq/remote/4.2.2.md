...
```console
$ docker pull rabbitmq@sha256:b8617d80b554d9b36a276f904d4992508b2bfa763335c1494735f11e35cce907
```
...
### `rabbitmq:4.2.2` - unknown; unknown
...
### `rabbitmq:4.2.2` - linux; arm variant v7
...
### `rabbitmq:4.2.2` - linux; arm64 variant v8
