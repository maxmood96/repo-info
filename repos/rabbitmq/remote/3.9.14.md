...
```console
$ docker pull rabbitmq@sha256:fa318253783f5b0b5e24a3cc78a0e0d5eef0a387b3155486709946f11bf132ff
```
...
### `rabbitmq:3.9.14` - linux; arm variant v7
