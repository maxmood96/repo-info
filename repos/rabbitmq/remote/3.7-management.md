...
```console
$ docker pull rabbitmq@sha256:02344f59ee046a9cf80273b38507afd9cb47370b84df37ab31bafff282854017
```
...
```console
$ docker pull rabbitmq@sha256:f1aa759e050506135292dd049390030f17377862c7ae23459a1912377731c4da
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **73.2 MB (73231087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f962422f14095678b5c446540e36bd1d97076772ef40ba87066c5043671eab6`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Tue, 14 Jan 2020 23:17:36 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Tue, 14 Jan 2020 23:17:54 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Tue, 14 Jan 2020 23:17:55 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:72b4a5246eaa513061c813453c369e2c6df6c316760e167be19889b79b8c1293`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee6099e650d62581a3f37fe1b29beaf763afbcfe2aed849e21d4f1ca990d74ec`  
		Last Modified: Tue, 14 Jan 2020 23:21:49 GMT  
		Size: 189.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a648f7e1e74ec6e5aa7b77706e1c4edd54b46e7c7434472017c1d103a13c1d`  
		Last Modified: Tue, 14 Jan 2020 23:21:52 GMT  
		Size: 9.2 MB (9230856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.7-management` - linux; arm64 variant v8

```console
$ docker pull rabbitmq@sha256:bd5fe9da74996d7a4fa03a75bfdb8c8989a8d5121485aef056e1b5dbe4320d1a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.7 MB (75692659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afc82478f258bd1c0abd665fa750a02ea83e80dffdd7aa51d40be32cddf089c7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Wed, 15 Jan 2020 00:00:27 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Wed, 15 Jan 2020 00:01:05 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
# Wed, 15 Jan 2020 00:01:09 GMT
EXPOSE 15671 15672
```
...
-	Layers:
	...
	-	`sha256:ecf018d00de5c87fee11cce6afa3293ebba2c569f002898869a2f686724c3a75`  
		...
		Size: 4.4 KB (4417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b693019a6c7bddaf1740480f96e302fe3769fa8278fe03c33c5dedb5c916b582`  
		Last Modified: Wed, 15 Jan 2020 00:07:07 GMT  
		Size: 189.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d0b73c89ef3f2add1e48f2ee78947e8eef2d6b57a0609566a4825bdeb17067e`  
		Last Modified: Wed, 15 Jan 2020 00:07:11 GMT  
		Size: 9.7 MB (9739354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `rabbitmq:3.7-management` - linux; 386

```console
$ docker pull rabbitmq@sha256:0a2c5de58a44dc84a4591a0a3a9ecf82bbdc13ea1752d2a796c953a294dff708
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.0 MB (80013849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e2f6d3a8d73499e4c189af031beec55edb72ff4bae557f086eb6750551773ff`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
CMD ["rabbitmq-server"]
# Wed, 15 Jan 2020 00:08:03 GMT
RUN rabbitmq-plugins enable --offline rabbitmq_management
# Wed, 15 Jan 2020 00:08:16 GMT
RUN set -eux; 	erl -noinput -eval ' 		{ ok, AdminBin } = zip:foldl(fun(FileInArchive, GetInfo, GetBin, Acc) -> 			case Acc of 				"" -> 					case lists:suffix("/rabbitmqadmin", FileInArchive) of 						true -> GetBin(); 						false -> Acc 					end; 				_ -> Acc 			end 		end, "", init:get_plain_arguments()), 		io:format("~s", [ AdminBin ]), 		init:stop(). 	' -- /plugins/rabbitmq_management-*.ez > /usr/local/bin/rabbitmqadmin; 	[ -s /usr/local/bin/rabbitmqadmin ]; 	chmod +x /usr/local/bin/rabbitmqadmin; 	apt-get update; apt-get install -y --no-install-recommends python; rm -rf /var/lib/apt/lists/*; 	rabbitmqadmin --version
...
-	Layers:
	...
	-	`sha256:7d081acf461e6e6f184a2ed34dc352724384e426d5df2d36d8dcc870c2889000`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3be783da74b351a4dcb4b8f9d1fadb2dadcf91e797f7d2fb859b73377b1768ef`  
		Last Modified: Wed, 15 Jan 2020 00:11:01 GMT  
		Size: 188.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5814e148fbea0d4a533bfcad5e24fbbc8f53a1bb36601c08e165cdc9b96d4bf3`  
		Last Modified: Wed, 15 Jan 2020 00:11:04 GMT  
		Size: 10.3 MB (10263285 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull rabbitmq@sha256:4e49466d17f884c3d19ce25e3cba577c2f032c02496f2f0548b209a7530f4c53
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.6 MB (77615584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ce7923f2ccb0511298c1dd3d03f78caa20ccbccd76e543cc515219fc8206afb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["rabbitmq-server"]`
...
-	Layers:
	...
	-	`sha256:e976f6142b035963e0d23f1628c429d2cac7a7f73a057d3cc53e2d874615fea6`  
		...
		Size: 4.4 KB (4415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7621627a3241b5a62490e979031340b6334f062a5346036b24fb7fd271d921d8`  
		Last Modified: Wed, 15 Jan 2020 00:06:51 GMT  
		Size: 186.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1faa593a5118aad2da0928705ba05d1da8d373e2e6a1c998e3c9d0ffeebb607`  
		Last Modified: Wed, 15 Jan 2020 00:06:53 GMT  
		Size: 9.8 MB (9797537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
