...
```console
$ docker pull rabbitmq@sha256:df757360e486ff71cf5504c58199a7fbb3f8cc1e75a117151e688c392d2e5646
```
...
### `rabbitmq:3.10.9-management` - linux; arm64 variant v8
...
### `rabbitmq:3.10.9-management` - linux; ppc64le
