...
### `erlang:28.0.4-alpine` - linux; amd64
...
### `erlang:28.0.4-alpine` - unknown; unknown
...
### `erlang:28.0.4-alpine` - linux; arm variant v7
...
### `erlang:28.0.4-alpine` - linux; arm64 variant v8
...
### `erlang:28.0.4-alpine` - linux; 386
...
### `erlang:28.0.4-alpine` - linux; ppc64le
...
### `erlang:28.0.4-alpine` - linux; s390x
