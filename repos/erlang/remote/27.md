...
```console
$ docker pull erlang@sha256:f704022cf4772a7ac0d06c4e0785f65edc98c55141f219f52a2b271522a31023
```
...
```console
$ docker pull erlang@sha256:5f267a6b10042a12a3d38af463783924f033d5ef26cab9b3fed630624b31d336
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **575.9 MB (575878462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80315e33affc8d561d0b5f329dc0f0beb2d07270181a815e98671700cf5fde8e`
-	Default Command: `["erl"]`
...
# Wed, 24 Jun 2026 21:09:32 GMT
ENV REBAR_VERSION=2.6.4
# Wed, 24 Jun 2026 21:09:49 GMT
RUN set -xe 	&& REBAR_DOWNLOAD_URL="https://github.com/rebar/rebar/archive/${REBAR_VERSION}.tar.gz" 	&& REBAR_DOWNLOAD_SHA256="577246bafa2eb2b2c3f1d0c157408650446884555bf87901508ce71d5cc0bd07" 	&& mkdir -p /usr/src/rebar-src 	&& curl -fSL -o rebar-src.tar.gz "$REBAR_DOWNLOAD_URL" 	&& echo "$REBAR_DOWNLOAD_SHA256 rebar-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar-src.tar.gz -C /usr/src/rebar-src --strip-components=1 	&& rm rebar-src.tar.gz 	&& cd /usr/src/rebar-src 	&& ./bootstrap 	&& install -v ./rebar /usr/local/bin/ 	&& rm -rf /usr/src/rebar-src # buildkit
# Wed, 24 Jun 2026 21:11:34 GMT
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="a151dc4a07805490e9f217a099e597ac9774814875f55da2c66545c333fdff64" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src # buildkit
```
...
-	Layers:
	...
	-	`sha256:68ba656eaa0ec82f59f691caf3e23100e075f2bb1dcb718cefa1a8f90df5f5a6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:53b0187d97ba42386169c3668e9ddd29fba1ef625929bda46ff28c1dcea79877`  
		Last Modified: Wed, 24 Jun 2026 21:16:14 GMT  
		Size: 248.8 MB (248758614 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:22337841d7bc49461ada17e53d5df9b2b51d2f5faa991ff50b44f7c19e3a9373`  
		Last Modified: Wed, 24 Jun 2026 21:15:50 GMT  
		Size: 195.7 KB (195706 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:78a1f5e27203abe2b1d54857f44c6f1b12bd904b6824f18cebc828f81c5a7664`  
		Last Modified: Wed, 24 Jun 2026 21:15:50 GMT  
...
```console
$ docker pull erlang@sha256:31e0384b8b4148549ea635e6e9ee0680e2648ccddc4423a339d954ad734337b3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.8 KB (18810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c0ddab292f7fb57cc455d168210ae657806e079627725f7d1548f3e924a5c78`

```dockerfile
```

-	Layers:
	-	`sha256:9db595f14966b6e3bb18dc48c5f35e0ac82708026eda434595c5ae1857692340`  
		Last Modified: Wed, 24 Jun 2026 21:15:50 GMT  
...
```console
$ docker pull erlang@sha256:10d3d599f2785196da0f458b2a85778a91ba37b5d677f61974b52611e68a72ec
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **627.0 MB (627007256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7092b461e2a1007875581d6195e7708cf92d6bc96990b7224eb470e3ac699c4f`
-	Default Command: `["erl"]`
...
```console
$ docker pull erlang@sha256:b127c3f35c28e38c65f1fab918a119ac8bcddedbd34306fa6d0c4a4a953bac3c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.7 MB (23744197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9aa324d71d1483c8610598703b16293931e9537b9c4d6921e9815e55722c1db9`

```dockerfile
```

-	Layers:
	-	`sha256:f282843ac2dd7c789e61b4b87867940663336c0233c0a9efe20b3d667a4432ea`  
		Last Modified: Wed, 24 Jun 2026 12:30:14 GMT  
		Size: 23.7 MB (23725196 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a7324f3442df732998da758bd45b02acd73e07b0ef20b706654d85dfe59fddaf`  
		Last Modified: Wed, 24 Jun 2026 12:30:12 GMT  
