...
```console
$ docker pull erlang@sha256:5b6128cc0594291e9829c0967a05567e98ca22a3e6192b6620237c619d39fd29
```
...
### `erlang:28.4.1` - linux; arm variant v5
...
### `erlang:28.4.1` - linux; arm variant v7
...
### `erlang:28.4.1` - linux; arm64 variant v8
