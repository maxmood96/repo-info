...
### `erlang:28.3.3-slim` - linux; amd64
...
### `erlang:28.3.3-slim` - unknown; unknown
...
### `erlang:28.3.3-slim` - linux; arm64 variant v8
...
### `erlang:28.3.3-slim` - linux; ppc64le
...
### `erlang:28.3.3-slim` - linux; s390x
