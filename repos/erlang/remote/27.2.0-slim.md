...
```console
$ docker pull erlang@sha256:2b500e7fc52d5b352c28f048c913f74edbd72857720c384c4a8f364a2b05a4f2
```
...
### `erlang:27.2.0-slim` - linux; amd64
...
### `erlang:27.2.0-slim` - unknown; unknown
...
### `erlang:27.2.0-slim` - linux; arm variant v5
...
### `erlang:27.2.0-slim` - linux; arm variant v7
...
### `erlang:27.2.0-slim` - linux; arm64 variant v8
...
### `erlang:27.2.0-slim` - linux; mips64le
...
### `erlang:27.2.0-slim` - linux; ppc64le
...
### `erlang:27.2.0-slim` - linux; s390x
