...
```console
$ docker pull erlang@sha256:d644967ebe9fdda181b6bda9a69658cc054226d619b94805d79d75dff603e1b8
```
...
### `erlang:25.0.4-slim` - linux; arm variant v5
...
### `erlang:25.0.4-slim` - linux; mips64le
