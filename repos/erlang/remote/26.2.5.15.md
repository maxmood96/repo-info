...
```console
$ docker pull erlang@sha256:a34a4e42e1b1825a655f3862dda5d322652e874f18ae3b595265c58b7684723b
```
...
```console
$ docker pull erlang@sha256:9b53166d767027246f1007c3db378c901be7b55d6cf344eaec1a29317bd1a16d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **614.7 MB (614707731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4899284d79ab5f5c310047fc6acada7c4bee50ee8fb703833dc98283acc6369`
-	Default Command: `["erl"]`
...
```console
$ docker pull erlang@sha256:2e23c0403c9490a409587ffbec2421d07aa617c240577b35fdfac4660ffdd593
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.1 MB (23125347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e7a8b13ec1b6d8db6f15121c4c2a916fcb932283afacc57f6173c1269919e00`

```dockerfile
```

-	Layers:
	-	`sha256:932783eaed9bc4145607fbc5b0dae15d53ce45f3aefe7a7c33b605b1045d4648`  
		Last Modified: Tue, 18 Nov 2025 16:55:17 GMT  
		Size: 23.1 MB (23106368 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0df8b857b42b1adaeafbac79c4b63326595617c9e590c4034e0277d9b79949ec`  
		Last Modified: Tue, 18 Nov 2025 16:55:18 GMT  
...
```console
$ docker pull erlang@sha256:7f404e38ef5d301477c313751e850f95892aafa5bb58dbdd9e8932fffc0e49ac
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **572.2 MB (572214618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cd5ce49dde35292cb0f6f64d2e652fee0795f2c1adee257bc68f3ecb0bcd031`
-	Default Command: `["erl"]`
...
# Wed, 19 Nov 2025 05:08:53 GMT
ENV REBAR_VERSION=2.6.4
# Wed, 19 Nov 2025 05:09:11 GMT
RUN set -xe 	&& REBAR_DOWNLOAD_URL="https://github.com/rebar/rebar/archive/${REBAR_VERSION}.tar.gz" 	&& REBAR_DOWNLOAD_SHA256="577246bafa2eb2b2c3f1d0c157408650446884555bf87901508ce71d5cc0bd07" 	&& mkdir -p /usr/src/rebar-src 	&& curl -fSL -o rebar-src.tar.gz "$REBAR_DOWNLOAD_URL" 	&& echo "$REBAR_DOWNLOAD_SHA256 rebar-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar-src.tar.gz -C /usr/src/rebar-src --strip-components=1 	&& rm rebar-src.tar.gz 	&& cd /usr/src/rebar-src 	&& ./bootstrap 	&& install -v ./rebar /usr/local/bin/ 	&& rm -rf /usr/src/rebar-src # buildkit
# Wed, 19 Nov 2025 05:10:49 GMT
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="7d3f42dc0e126e18fb73e4366129f11dd37bad14d404f461e0a3129ce8903440" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src # buildkit
```
...
-	Layers:
	...
	-	`sha256:54792da20c74ed4e30224cf94214dd511807467c2d7da651ead9787b6581a9ef`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c1ae8d50d6c671df8045b838961b53348a93884cf131b344894149d3ca49c862`  
		Last Modified: Wed, 19 Nov 2025 08:53:49 GMT  
		Size: 245.3 MB (245287355 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:80cfe2c4dbf25e2da181e70e2a1c54859e75c575a3c80c7445c41ddfcd011826`  
		Last Modified: Wed, 19 Nov 2025 05:15:25 GMT  
		Size: 195.0 KB (194963 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4fee597be53b636f36500e5393e85c6f23a730da247dc60114cfc78ac5d7d660`  
		Last Modified: Wed, 19 Nov 2025 05:15:25 GMT  
		Size: 819.7 KB (819692 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull erlang@sha256:5e8d736801fae27bc883ce0c22d3d7442e004544d247c4ea7fdab5c70ecfcbbf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.8 KB (18836 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58068c885c29f7f4d0ca1ffc20057465de3462f4f3e84dc1a967456682cc32f2`

```dockerfile
```

-	Layers:
	-	`sha256:2e5bb4c17bb777f283305bd42c59c0cafb3adefe544ed1c65ab7736e47d8ed5b`  
		Last Modified: Wed, 19 Nov 2025 08:47:50 GMT  
...
```console
$ docker pull erlang@sha256:530f5f762d1d8b49ef6fc6e4991e325cc5040c7baa4dca42a3341c2f05cc51bb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **623.2 MB (623157335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b59666d504b3c9677f6886217fd2099a96888151ffac10ca00bc433ffa207643`
-	Default Command: `["erl"]`
...
```console
$ docker pull erlang@sha256:014556bc4dcda0dda83107d8e4cf519ad42f176abd4f03297f3ee267c912366f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.1 MB (23080800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dededf900e259ace0bdf33c262ec7afa7b1631b4fddf438295387ee1bc43f054`

```dockerfile
```

-	Layers:
	-	`sha256:e1e6e191631cc7b6689acebe47b9c64e69ead25fc799ecc2177eb4d618277271`  
		Last Modified: Tue, 18 Nov 2025 11:49:24 GMT  
		Size: 23.1 MB (23061773 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:452f17aad7344b21cd2e91e838a3e37d36af1e047b4bec550f6c7998903e64c0`  
		Last Modified: Tue, 18 Nov 2025 11:49:25 GMT  
...
```console
$ docker pull erlang@sha256:a3f5d6f627b91f10f34287229631137cf35281602cbca9e0ccaa87115d9449b5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **576.6 MB (576576494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bb300617190657b6f95e39a85476177cc52f26b2d387bcd64f0ffa8c2e92b5b`
-	Default Command: `["erl"]`
...
```console
$ docker pull erlang@sha256:ffffd9b023ef5b097cb6523846e7807bd8ba67c538d91b02c5030f7a819018e7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.9 MB (22892823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4b6db52d505b65444e39222386ff26ec4b651f28724dff90d1b9377a8e17bc8`

```dockerfile
```

-	Layers:
	-	`sha256:0dd9a85d963d1bbba6a315366b4b6d0d1ec5af3cdd7e96e10a2d6abd953a7963`  
		Last Modified: Tue, 18 Nov 2025 11:49:44 GMT  
		Size: 22.9 MB (22873844 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:acb5322a89ea5788738a60545330e22563f9562577ffec98781b988575bffafc`  
		Last Modified: Tue, 18 Nov 2025 11:49:45 GMT  
		Size: 19.0 KB (18979 bytes)  
		MIME: application/vnd.in-toto+json
