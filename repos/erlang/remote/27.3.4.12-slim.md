...
```console
$ docker pull erlang@sha256:c7d70cfb96287e29aa700edaba4f29af13d766fb01e3739a806fe3b1cfe87c90
```
...
### `erlang:27.3.4.12-slim` - linux; amd64
...
### `erlang:27.3.4.12-slim` - unknown; unknown
...
### `erlang:27.3.4.12-slim` - linux; arm variant v5
...
### `erlang:27.3.4.12-slim` - linux; arm variant v7
...
### `erlang:27.3.4.12-slim` - linux; arm64 variant v8
...
### `erlang:27.3.4.12-slim` - linux; 386
...
### `erlang:27.3.4.12-slim` - linux; ppc64le
...
### `erlang:27.3.4.12-slim` - linux; s390x
