...
```console
$ docker pull erlang@sha256:fa4e2d3043e71366e9eb8e919da01d33ed0ae38a827d7e06ab8379d7303856e9
```
...
### `erlang:21.3.8.24-slim` - unknown; unknown
...
```console
$ docker pull erlang@sha256:bf21e9a285a7b12d6cc8d5ee66461adf6276f00bcd2cabbc845dfdb3b748afef
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100527398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:620e77fa1d07c19a8b07c7d66e43cb64bc3a23b7195bc65a1435ff7f6856e269`
-	Default Command: `["erl"]`
...
-	Layers:
	-	`sha256:66d6e1b7bddcb1c893c2c3e9b1ac8f5fca7c047037ed836079c97c9a917cd989`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:99f184840b84743fb4a86e4a359bb63f6de00eea07b81ae2f908dd3f5574a174`  
		Last Modified: Fri, 31 May 2024 00:25:42 GMT  
		Size: 54.4 MB (54397605 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `erlang:21.3.8.24-slim` - unknown; unknown

```console
$ docker pull erlang@sha256:2bd3e9dec6f1368d28e2083755a29df2b4312a9c50c265c7bc4da3c5b3f850c3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4005304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea8894674c13e5cd17f5c1440500e572dfc024956d2a0461a5e3cd0069861409`

```dockerfile
```

-	Layers:
	-	`sha256:0a4d4e88c33906ceda86c771c20ee5fd878ddb694771dfcf4ae1dcd7040069d7`  
		Last Modified: Fri, 31 May 2024 00:25:41 GMT  
		Size: 4.0 MB (3991918 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:277d64d7bbe2fc8abdf2b9cbaf9ad403e3bb5840230366d91ee7a77bb9ce83dc`  
		Last Modified: Fri, 31 May 2024 00:25:40 GMT  
...
```console
$ docker pull erlang@sha256:9efb12a949b1b365761d366793200207b914277e62168a836b9cd3ff425a41c5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104877419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4734cf0472ff32e327bd265db6d4a42260a4434f5f81afae1d49257b2323a718`
-	Default Command: `["erl"]`
...
-	Layers:
	-	`sha256:0a8090f4fec79fd213192f5f5c31c70546878a20b6c7ca023ff9001fb788f828`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ebc9dcc98ea32a703601230c4fd3c6719d953e627a19d10ac961180a6653093d`  
		Last Modified: Fri, 31 May 2024 08:57:14 GMT  
		Size: 55.4 MB (55424325 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `erlang:21.3.8.24-slim` - unknown; unknown

```console
$ docker pull erlang@sha256:a5b3c91245b7ef06cadfbd1cffb4583ad36a157402afda9575d1f397068faf5c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4003673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8637d65930cf03d548538392d818bf5af931594d63c519cb541c9e5a2c9dcfa`

```dockerfile
```

-	Layers:
	-	`sha256:7da8f04c89643afb1dcd7de6620123595d9127de31d8a2bdb4330bdb468e970b`  
		Last Modified: Fri, 31 May 2024 08:57:13 GMT  
		Size: 4.0 MB (3990054 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6ed53336d408423517cd9b5e7818aa1acfee6053400088e3abbb5da75ae79b1d`  
		Last Modified: Fri, 31 May 2024 08:57:13 GMT  
