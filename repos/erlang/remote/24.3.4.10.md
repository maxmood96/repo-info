...
```console
$ docker pull erlang@sha256:97a0d1b02c11de176eee0dcf580491169ee8d9e8d3a0178105fb1f6c16608018
```
...
### `erlang:24.3.4.10` - linux; arm variant v7
...
### `erlang:24.3.4.10` - linux; mips64le
...
### `erlang:24.3.4.10` - linux; ppc64le
