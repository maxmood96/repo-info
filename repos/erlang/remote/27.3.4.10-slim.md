...
```console
$ docker pull erlang@sha256:2c4e375680b7a9ec6ea6ed603cff31624ec1a65b780dc5d868a1509eb6d12ec8
```
...
### `erlang:27.3.4.10-slim` - linux; arm variant v5
...
### `erlang:27.3.4.10-slim` - linux; 386
...
### `erlang:27.3.4.10-slim` - linux; mips64le
