...
### `erlang:24.2.2-slim` - linux; amd64
...
### `erlang:24.2.2-slim` - linux; arm variant v7
...
### `erlang:24.2.2-slim` - linux; arm64 variant v8
...
### `erlang:24.2.2-slim` - linux; ppc64le
...
### `erlang:24.2.2-slim` - linux; s390x
