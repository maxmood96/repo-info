...
```console
$ docker pull erlang@sha256:124d428a6f8fea0765006dd0c2079ec5c6bee5cc713ffce4b7aa3e15863377d6
```
...
### `erlang:25.3.1` - linux; arm variant v5
...
### `erlang:25.3.1` - linux; arm variant v7
...
### `erlang:25.3.1` - linux; arm64 variant v8
