...
```console
$ docker pull erlang@sha256:c12f2818f84d3031ef533bc0389414e4796012d6e5892d79d71ddb1278a5ff93
```
...
### `erlang:23.1.1-slim` - linux; amd64
...
### `erlang:23.1.1-slim` - linux; ppc64le
