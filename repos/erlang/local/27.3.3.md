...
### `dpkg` source package: `gst-plugins-bad1.0=1.22.0-4+deb12u5`

Binary Packages:

- `libgstreamer-plugins-bad1.0-0:amd64=1.22.0-4+deb12u5`
...
```console
$ apt-get source -qq --print-uris gst-plugins-bad1.0=1.22.0-4+deb12u5
'http://deb.debian.org/debian/pool/main/g/gst-plugins-bad1.0/gst-plugins-bad1.0_1.22.0-4%2bdeb12u5.dsc' gst-plugins-bad1.0_1.22.0-4+deb12u5.dsc 5983 SHA256:89a2321ef9dd9ede9f9b66eba4ac4f6b1118a46c6624e3324a5058b36553225e
...
'http://deb.debian.org/debian/pool/main/g/gst-plugins-bad1.0/gst-plugins-bad1.0_1.22.0-4%2bdeb12u5.debian.tar.xz' gst-plugins-bad1.0_1.22.0-4+deb12u5.debian.tar.xz 43308 SHA256:9a95b9dd88047f1ce99b321b5f91e7a323a09f13b8123937d2cf1d48bc95bbba
```

Other potentially useful URLs:

- https://sources.debian.net/src/gst-plugins-bad1.0/1.22.0-4+deb12u5/ (for browsing the source)
...
- `gstreamer1.0-plugins-good:amd64=1.22.0-5+deb12u2`
...
- https://sources.debian.net/src/gst-plugins-good1.0/1.22.0-5+deb12u2/ (for browsing the source)
- https://sources.debian.net/src/gst-plugins-good1.0/1.22.0-5+deb12u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gst-plugins-good1.0/1.22.0-5+deb12u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libsndfile=1.2.0-1`

Binary Packages:

- `libsndfile1:amd64=1.2.0-1`
...
```console
$ apt-get source -qq --print-uris libsndfile=1.2.0-1
'http://deb.debian.org/debian/pool/main/libs/libsndfile/libsndfile_1.2.0-1.dsc' libsndfile_1.2.0-1.dsc 2386 SHA256:20e0ebd19fbb8c0d1b9b80d2c7228b4e39786dac0892931cd6ba56d36c71a24d
...
'http://deb.debian.org/debian/pool/main/libs/libsndfile/libsndfile_1.2.0-1.debian.tar.xz' libsndfile_1.2.0-1.debian.tar.xz 18256 SHA256:473b7a66a1b573d72807e08e12c9d661446db73f109ce204efe5e005cde68bf1
```

Other potentially useful URLs:

- https://sources.debian.net/src/libsndfile/1.2.0-1/ (for browsing the source)
...
- `libsoup-3.0-0:amd64=3.2.2-2`
- `libsoup-3.0-common=3.2.2-2`
...
```console
$ apt-get source -qq --print-uris libsoup3=3.2.2-2
'http://deb.debian.org/debian/pool/main/libs/libsoup3/libsoup3_3.2.2-2.dsc' libsoup3_3.2.2-2.dsc 3166 SHA256:572cffc8ca06097ada12b42c11c80798626c71b6348f711883771dd3e36c0be1
'http://deb.debian.org/debian/pool/main/libs/libsoup3/libsoup3_3.2.2.orig.tar.xz' libsoup3_3.2.2.orig.tar.xz 1530460 SHA256:83673c685b910fb7d39f1f28eee5afbefb71c05798fc350ac3bf1b885e1efaa1
'http://deb.debian.org/debian/pool/main/libs/libsoup3/libsoup3_3.2.2-2.debian.tar.xz' libsoup3_3.2.2-2.debian.tar.xz 26012 SHA256:7f741a1a2cc091745d953eca7b32376df06b1e1f8b476d20da376fff6396ed01
```

Other potentially useful URLs:

- https://sources.debian.net/src/libsoup3/3.2.2-2/ (for browsing the source)
- https://sources.debian.net/src/libsoup3/3.2.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libsoup3/3.2.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libtheora=1.1.1+dfsg.1-16.1`

Binary Packages:

- `libtheora0:amd64=1.1.1+dfsg.1-16.1+b1`
...
```console
$ apt-get source -qq --print-uris libtheora=1.1.1+dfsg.1-16.1
'http://deb.debian.org/debian/pool/main/libt/libtheora/libtheora_1.1.1%2bdfsg.1-16.1.dsc' libtheora_1.1.1+dfsg.1-16.1.dsc 2540 SHA256:e23398c3f176df004694eb04999492ddf47ec671e1d6ec78259c8faff038f469
...
'http://deb.debian.org/debian/pool/main/libt/libtheora/libtheora_1.1.1%2bdfsg.1-16.1.debian.tar.xz' libtheora_1.1.1+dfsg.1-16.1.debian.tar.xz 11344 SHA256:ea71764d2bfb859af830d1103b840ca627e7e0290fa022a87665baf3d4ea83c1
```

Other potentially useful URLs:

- https://sources.debian.net/src/libtheora/1.1.1+dfsg.1-16.1/ (for browsing the source)
- https://sources.debian.net/src/libtheora/1.1.1+dfsg.1-16.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libtheora/1.1.1+dfsg.1-16.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libvpx=1.12.0-1+deb12u3`

Binary Packages:

- `libvpx7:amd64=1.12.0-1+deb12u3`
...
```console
$ apt-get source -qq --print-uris libvpx=1.12.0-1+deb12u3
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.12.0-1%2bdeb12u3.dsc' libvpx_1.12.0-1+deb12u3.dsc 2277 SHA256:d98b46b957fffb8cd4dc50bab28619b820f4d8a34c8714ba5a2362d035f2e157
...
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.12.0-1%2bdeb12u3.debian.tar.xz' libvpx_1.12.0-1+deb12u3.debian.tar.xz 18916 SHA256:2314687ec4deaa7447c6f4a9d1e6b8ecbc87823a86c1d4cf54a66c1fd97c16d2
```

Other potentially useful URLs:

- https://sources.debian.net/src/libvpx/1.12.0-1+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/libvpx/1.12.0-1+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libvpx/1.12.0-1+deb12u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `webkit2gtk=2.48.1-2~deb12u1`

Binary Packages:

- `libjavascriptcoregtk-4.0-18:amd64=2.48.1-2~deb12u1`
- `libwebkit2gtk-4.0-37:amd64=2.48.1-2~deb12u1`
...
```console
$ apt-get source -qq --print-uris webkit2gtk=2.48.1-2~deb12u1
'http://deb.debian.org/debian/pool/main/w/webkit2gtk/webkit2gtk_2.48.1-2%7edeb12u1.dsc' webkit2gtk_2.48.1-2~deb12u1.dsc 5196 SHA256:bdd9218e8d3f41602b198e4e4276210cbb4e1b4cf31b3d5ed33f102eb4c0d8cf
'http://deb.debian.org/debian/pool/main/w/webkit2gtk/webkit2gtk_2.48.1.orig.tar.xz' webkit2gtk_2.48.1.orig.tar.xz 44168216 SHA256:98efdf21c4cdca0fe0b73ab5a8cb52093b5aa52d9b1b016a93f71dbfa1eb258f
'http://deb.debian.org/debian/pool/main/w/webkit2gtk/webkit2gtk_2.48.1.orig.tar.xz.asc' webkit2gtk_2.48.1.orig.tar.xz.asc 833 SHA256:c85e3fe892ad2d9abf906028a4ea66d028a96b12584255750b7614b5820bad7b
'http://deb.debian.org/debian/pool/main/w/webkit2gtk/webkit2gtk_2.48.1-2%7edeb12u1.debian.tar.xz' webkit2gtk_2.48.1-2~deb12u1.debian.tar.xz 90504 SHA256:e0aad5c10559f0e5269bd7ab40b9ebf5e4bf2fed4b416877b9a0ca468dead0b1
```

Other potentially useful URLs:

- https://sources.debian.net/src/webkit2gtk/2.48.1-2~deb12u1/ (for browsing the source)
- https://sources.debian.net/src/webkit2gtk/2.48.1-2~deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/webkit2gtk/2.48.1-2~deb12u1/ (for access to the source package after it no longer exists in the archive)
