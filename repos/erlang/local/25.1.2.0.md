...
- Created: `2022-11-15T10:46:23.724464324Z`
...
### `dpkg` source package: `at-spi2-core=2.38.0-4`
...
```console
$ apt-get source -qq --print-uris at-spi2-core=2.38.0-4
'http://deb.debian.org/debian/pool/main/a/at-spi2-core/at-spi2-core_2.38.0-4.dsc' at-spi2-core_2.38.0-4.dsc 2730 SHA256:adbde38fbc29d4ea94886ad2461371464ebc1c2fb63b305a6b7e771bdedc5f60
...
'http://deb.debian.org/debian/pool/main/a/at-spi2-core/at-spi2-core_2.38.0-4.debian.tar.xz' at-spi2-core_2.38.0-4.debian.tar.xz 11440 SHA256:940d3f084a418e2b5ddee7d450e966d96824bf938b33a36263ac1b94da682250
```

Other potentially useful URLs:

- https://sources.debian.net/src/at-spi2-core/2.38.0-4/ (for browsing the source)
- https://sources.debian.net/src/at-spi2-core/2.38.0-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/at-spi2-core/2.38.0-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `flac=1.3.3-2+deb11u1`
...
```console
$ apt-get source -qq --print-uris flac=1.3.3-2+deb11u1
'http://deb.debian.org/debian/pool/main/f/flac/flac_1.3.3-2%2bdeb11u1.dsc' flac_1.3.3-2+deb11u1.dsc 2273 SHA256:d52ad5b5101c481e2f186f94cb52ec2082d19faa463066ccdf32522ed771a322
...
'http://deb.debian.org/debian/pool/main/f/flac/flac_1.3.3-2%2bdeb11u1.debian.tar.xz' flac_1.3.3-2+deb11u1.debian.tar.xz 17984 SHA256:d3c8a2b687fe818335e182a40a3e442812f3cf1a381f6592e097a10c25a1a92a
```

Other potentially useful URLs:

- https://sources.debian.net/src/flac/1.3.3-2+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/flac/1.3.3-2+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/flac/1.3.3-2+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/g/gst-plugins-good1.0/gst-plugins-good1.0_1.18.4-2%2bdeb11u1.dsc' gst-plugins-good1.0_1.18.4-2+deb11u1.dsc 3739 SHA256:c35fb5c6cc5fed51a158dd43c9acbdfd261c7690d132fe0792ea6612abf16d1d
...
'http://deb.debian.org/debian/pool/main/g/gst-plugins-good1.0/gst-plugins-good1.0_1.18.4-2%2bdeb11u1.debian.tar.xz' gst-plugins-good1.0_1.18.4-2+deb11u1.debian.tar.xz 37644 SHA256:37260edd5afe7b57e1a7234c20c2f119c575ce775cad6efe88511481257149b5
```
...
### `dpkg` source package: `gtk+3.0=3.24.24-4+deb11u2`
...
```console
$ apt-get source -qq --print-uris gtk+3.0=3.24.24-4+deb11u2
'http://deb.debian.org/debian/pool/main/g/gtk%2b3.0/gtk%2b3.0_3.24.24-4%2bdeb11u2.dsc' gtk+3.0_3.24.24-4+deb11u2.dsc 4145 SHA256:c2134057cd3edfc811efd8630397a48d595d0b6dde57775c11c0126fbecaa2cb
...
'http://deb.debian.org/debian/pool/main/g/gtk%2b3.0/gtk%2b3.0_3.24.24-4%2bdeb11u2.debian.tar.xz' gtk+3.0_3.24.24-4+deb11u2.debian.tar.xz 172116 SHA256:d291ef15582b880ed04588b3911c0b83877757b8663c470fb58abb57035391ec
```

Other potentially useful URLs:

- https://sources.debian.net/src/gtk+3.0/3.24.24-4+deb11u2/ (for browsing the source)
...
- `krb5-multidev:amd64=1.18.3-6+deb11u2`
- `libgssapi-krb5-2:amd64=1.18.3-6+deb11u2`
- `libgssrpc4:amd64=1.18.3-6+deb11u2`
- `libk5crypto3:amd64=1.18.3-6+deb11u2`
- `libkadm5clnt-mit12:amd64=1.18.3-6+deb11u2`
- `libkadm5srv-mit12:amd64=1.18.3-6+deb11u2`
- `libkdb5-10:amd64=1.18.3-6+deb11u2`
- `libkrb5-3:amd64=1.18.3-6+deb11u2`
- `libkrb5-dev:amd64=1.18.3-6+deb11u2`
...
### `dpkg` source package: `libvpx=1.9.0-1`
...
```console
$ apt-get source -qq --print-uris libvpx=1.9.0-1
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.9.0-1.dsc' libvpx_1.9.0-1.dsc 2247 SHA256:304e84aafcc33f4a6cde68929d40abf44960d6c37488a5bc621764fe4d46e196
...
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.9.0-1.debian.tar.xz' libvpx_1.9.0-1.debian.tar.xz 11636 SHA256:72a5973ff25b06097e9947b38f3d78745ac8fc2ea296f314144de5e995b3363e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libvpx/1.9.0-1/ (for browsing the source)
- https://sources.debian.net/src/libvpx/1.9.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libvpx/1.9.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libwpe=1.10.0-2`
...
```console
$ apt-get source -qq --print-uris libwpe=1.10.0-2
'http://deb.debian.org/debian/pool/main/libw/libwpe/libwpe_1.10.0-2.dsc' libwpe_1.10.0-2.dsc 2261 SHA256:d44821134c165e8e26db262739cbb1b93bf023c3eff760c1e88997e3bbf5fe27
'http://deb.debian.org/debian/pool/main/libw/libwpe/libwpe_1.10.0.orig.tar.xz' libwpe_1.10.0.orig.tar.xz 52004 SHA256:2415e270d45e3595ed4052bc105f733744dc2d3677e12ff4a831e5029841084d
'http://deb.debian.org/debian/pool/main/libw/libwpe/libwpe_1.10.0.orig.tar.xz.asc' libwpe_1.10.0.orig.tar.xz.asc 195 SHA256:8276dbd1c10fb4d382dceb9526d0b28eebc827dc4bc2cfb16cadbca1fd7489a3
'http://deb.debian.org/debian/pool/main/libw/libwpe/libwpe_1.10.0-2.debian.tar.xz' libwpe_1.10.0-2.debian.tar.xz 6240 SHA256:8f024c64520aa6d89bc3d296ca58edd43631ac669f67adcced1d8e2514463d02
```

Other potentially useful URLs:

- https://sources.debian.net/src/libwpe/1.10.0-2/ (for browsing the source)
...
### `dpkg` source package: `webkit2gtk=2.38.2-1~deb11u1`

Binary Packages:

- `libjavascriptcoregtk-4.0-18:amd64=2.38.2-1~deb11u1`
...
- https://sources.debian.net/src/webkit2gtk/2.38.2-1~deb11u1/ (for browsing the source)
- https://sources.debian.net/src/webkit2gtk/2.38.2-1~deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/webkit2gtk/2.38.2-1~deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `wpebackend-fdo=1.8.0-1`
...
```console
$ apt-get source -qq --print-uris wpebackend-fdo=1.8.0-1
'http://deb.debian.org/debian/pool/main/w/wpebackend-fdo/wpebackend-fdo_1.8.0-1.dsc' wpebackend-fdo_1.8.0-1.dsc 2435 SHA256:ac1b493f83d322cd859c0a9c9034feec63960fca29ffd8e95f0f36b85e1f63ab
'http://deb.debian.org/debian/pool/main/w/wpebackend-fdo/wpebackend-fdo_1.8.0.orig.tar.xz' wpebackend-fdo_1.8.0.orig.tar.xz 42520 SHA256:9652a99c75fe1c6eab0585b6395f4e104b2427e4d1f42969f1f77df29920d253
'http://deb.debian.org/debian/pool/main/w/wpebackend-fdo/wpebackend-fdo_1.8.0.orig.tar.xz.asc' wpebackend-fdo_1.8.0.orig.tar.xz.asc 195 SHA256:fe68582ba543cf4bc12dfc3b216c6c2119ac8cbda5fc9ab059c309d8e52cac94
'http://deb.debian.org/debian/pool/main/w/wpebackend-fdo/wpebackend-fdo_1.8.0-1.debian.tar.xz' wpebackend-fdo_1.8.0-1.debian.tar.xz 6960 SHA256:45d462d3bfa5ff35c2d4bf6d516fef13125de921b5c37a030f9204a90457dbea
```

Other potentially useful URLs:

- https://sources.debian.net/src/wpebackend-fdo/1.8.0-1/ (for browsing the source)
- https://sources.debian.net/src/wpebackend-fdo/1.8.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/wpebackend-fdo/1.8.0-1/ (for access to the source package after it no longer exists in the archive)
