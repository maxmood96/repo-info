...
```console
$ docker pull postfixadmin@sha256:6120f201470fc724eeecdd01511183514a6ccc896a7fa3c1687014282186b2c4
```
...
```console
$ docker pull postfixadmin@sha256:b38d0625511a152b65e0b32d272e0f539986bc334ab8db057a8fdb19b6089119
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183239658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5150274a54355919b71a56b47f5f4ec62618104385a0817effae796b5cc7648`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 28 Oct 2023 08:18:07 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 28 Oct 2023 08:18:12 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 08:18:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 08:18:48 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 28 Oct 2023 08:18:48 GMT
...
# Sat, 28 Oct 2023 08:18:48 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 28 Oct 2023 08:18:49 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 28 Oct 2023 08:18:50 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 28 Oct 2023 08:18:50 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 28 Oct 2023 08:18:51 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 28 Oct 2023 08:18:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e3eed8e565dabab0bd54db23266d440170bb40629618769a74e67f0fc9a77cbf`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e9b6e75a646e3e5fc02f87972056e767573610dc755aaa21366ca742a3f7d1f`  
		Last Modified: Sat, 28 Oct 2023 08:20:36 GMT  
		Size: 1.3 MB (1282896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3beca0f7957be9f8bca769d1692528dfba3f8f8bc7f8ab6e313e832a3905cc12`  
		Last Modified: Sat, 28 Oct 2023 08:20:36 GMT  
		Size: 1.2 MB (1218222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2af68f162ed6ca2feac069a391eb304aa09ccff0f53f4f53468eb2bfa752166d`  
		Last Modified: Sat, 28 Oct 2023 08:20:35 GMT  
		Size: 8.0 KB (8046 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecd2d8577c543ca19a711fa70b1bdb7e8efc9cbad608ed26775d2cc29081f31f`  
		Last Modified: Sat, 28 Oct 2023 08:20:36 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dc8839897758a7a700f4183e6efcdd1a05eff36c0172c4d7c7dacc3de492885`  
		Last Modified: Sat, 28 Oct 2023 08:20:35 GMT  
...
```console
$ docker pull postfixadmin@sha256:66da874c762d51f8947f566ba10d3b019f0d30e3d93ff84e49565e47b50d4acc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.6 MB (157587244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:602eb0d4ab4300f7db95a5ec2080e63bd7c24efb84581d95bc671f6f826dec83`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 28 Oct 2023 07:10:31 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 07:10:54 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 07:10:54 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 28 Oct 2023 07:10:54 GMT
...
# Sat, 28 Oct 2023 07:10:54 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 28 Oct 2023 07:10:55 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 28 Oct 2023 07:10:56 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 28 Oct 2023 07:10:56 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 28 Oct 2023 07:10:56 GMT
...
-	Layers:
	...
	-	`sha256:ec13ec9fd1aaa6783cc737dc18664d29f9893fb4187a3044c9830b61510bb42e`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf9e20ff65959d0860bb201f99f166c32f5ea546eb313c294ee41a7133ac477d`  
		Last Modified: Sat, 28 Oct 2023 07:12:33 GMT  
		Size: 1.3 MB (1263047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9af6efabe0283274be3df677c64a428671fc3fd9dd06b663afcf8b8fbd74f6a6`  
		Last Modified: Sat, 28 Oct 2023 07:12:33 GMT  
		Size: 1.2 MB (1189609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6e33f5f1729f04c452d401da2c99901c69023a2b728f56efa36f41b045470c9`  
		Last Modified: Sat, 28 Oct 2023 07:12:33 GMT  
		Size: 8.0 KB (8046 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49cfc2eee5e6af5d39ca90ef60d431d181ac4fa9b345f8e29b1037058e3c97f7`  
		Last Modified: Sat, 28 Oct 2023 07:12:33 GMT  
		Size: 1.9 MB (1862684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbb70091241bf24992c40b338e9540ff189fd68b0cc2433a54c8ad239c0ee3f3`  
