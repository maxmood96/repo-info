...
```console
$ docker pull postfixadmin@sha256:684545a0a8c30fb5bd8b61d09fb6fba3bd946b17874a2f00d32933aa09216b21
```
...
```console
$ docker pull postfixadmin@sha256:ec3dc83289794e53bb7ebd3f3864633ff9ef1650f5cb90f8acfce4ed59d83727
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169865065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef21ad260042d392160bf3ed5ce4207264bae652368d8ca30224588e61a5b40a`
...
-	Layers:
	...
	-	`sha256:677f27d944429c7c9753b18f9eea3e082b6c81ccf308b4d89ba0fe03ca06c579`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4231fd5fb39c2de32b21a3c04e094515efaf4b4194a260d9f2eac019ae0c7277`  
		Last Modified: Fri, 24 Mar 2023 00:44:46 GMT  
		Size: 1.3 MB (1284594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2610c9f050c43247bf6d91a78aeafcddcb2faf073f3144b2ac7f9a69d23d749a`  
		Last Modified: Fri, 24 Mar 2023 00:44:46 GMT  
		Size: 1.2 MB (1194672 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a88b1d3208f64222bda49eb851ca251fe5973685660bd7a62d8e76817ab57095`  
		Last Modified: Fri, 24 Mar 2023 00:44:46 GMT  
		Size: 8.2 KB (8219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e42514875b055a7cdabfb06be6d655d16f81a49b5e013d7b5574d3d7818ed1d2`  
		Last Modified: Fri, 24 Mar 2023 00:44:47 GMT  
		Size: 1.9 MB (1862686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5721315b7ee5727133e7fa8905f21657a01fddfbe840abd0fd3531933b79c79f`  
		Last Modified: Fri, 24 Mar 2023 00:44:46 GMT  
...
```console
$ docker pull postfixadmin@sha256:e882f23b76d0a054524db0ed68babe37ea729f991894de5372e0fb88809278ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.6 MB (147621381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5b1ab00932b081cfdb2f1936d3ea33f1949cb651cd9bb99b5bbf36627af04cd`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 25 Mar 2023 09:33:06 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 25 Mar 2023 09:33:11 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 25 Mar 2023 09:33:47 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 25 Mar 2023 09:33:47 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 25 Mar 2023 09:33:47 GMT
...
# Sat, 25 Mar 2023 09:33:47 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 25 Mar 2023 09:33:48 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 25 Mar 2023 09:33:49 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 25 Mar 2023 09:33:49 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 25 Mar 2023 09:33:49 GMT
...
-	Layers:
	...
	-	`sha256:a4885661df8b3a39a722f436924bb15e72e67f3fed6d58139fb4f3eda5c99263`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d92eeed7bfa8b0ceabb25004e7955d0f33cbb936fedfcad0b90df301ae98e43c`  
		Last Modified: Sat, 25 Mar 2023 09:34:49 GMT  
		Size: 1.2 MB (1230458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c75b1716215c02021fa797db3173fcacd6c9dad67c73b5df01f0ffbc511d61c9`  
		Last Modified: Sat, 25 Mar 2023 09:34:49 GMT  
		Size: 1.1 MB (1136093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a70f12191e122730ab949845713ccd077634fb6dd632c02659dfd71934aa08f7`  
		Last Modified: Sat, 25 Mar 2023 09:34:48 GMT  
		Size: 8.2 KB (8218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcd89d98be4040419fd8596b2f8178aca3ca449f9155d8922667417e73c4d3cb`  
		Last Modified: Sat, 25 Mar 2023 09:34:49 GMT  
		Size: 1.9 MB (1862681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec9198b6f69e68ebbf532b9e0208583ed92a6d3758f2285bd9e774ef66c2b00f`  
		Last Modified: Sat, 25 Mar 2023 09:34:48 GMT  
...
```console
$ docker pull postfixadmin@sha256:ebf5961fc48388ea9b04ea5ffdf4f05b42a9084eb19198435fa3e5eb25df0ad4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.8 MB (139794062 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0f305f1e3c8cdd6e2d1c23bf1bd0684c432e2bcad320184c035fd4f26af62a9`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 10:17:04 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 18:58:11 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 23 Mar 2023 18:58:16 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 18:58:46 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 18:58:46 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
...
-	Layers:
	...
	-	`sha256:bf51aedecf9d64442c5e4e4e71fb7f732932942b31937cdf3a8cb71e8476ecc1`  
		...
		Size: 889.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0453529b6b73e37d59dcb9bac7787f2b5557ee9f047d2b34b23c172e7695bf12`  
		Last Modified: Thu, 23 Mar 2023 18:59:42 GMT  
		Size: 1.2 MB (1224817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:722931f5c366d4cc476cb4f513aa95b00c53a002fb45581ff2c3cfbe9ea7e0e1`  
		Last Modified: Thu, 23 Mar 2023 18:59:42 GMT  
		Size: 1.1 MB (1086303 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e48aa75a19725c56ab3d05b955059656c4c1accbc207b753f1fafd2baf2ce45c`  
		Last Modified: Thu, 23 Mar 2023 18:59:42 GMT  
		Size: 8.2 KB (8220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef3b39b4df4462c1eb71e753d716ce94e6eb8b3b0885189ab2596c64b7a43028`  
		Last Modified: Thu, 23 Mar 2023 18:59:42 GMT  
		Size: 1.9 MB (1862683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5ce2a0b0856c8384fc72a4272f21d73e97161195e8a8145eaea551a793f560c`  
		Last Modified: Thu, 23 Mar 2023 18:59:41 GMT  
...
```console
$ docker pull postfixadmin@sha256:65302fbe4fbb6ef6dfc83249a0a19b3d50958847807a3e47932e2dde7bf854ba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.7 MB (163707773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a10259bf6ee47eb70863308694ac9fadbff7fa3fcea2d77bbb1245fe1e876a59`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 12:43:36 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 21:19:18 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 23 Mar 2023 21:19:21 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 21:19:47 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 21:19:47 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 23 Mar 2023 21:19:47 GMT
...
# Thu, 23 Mar 2023 21:19:47 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Thu, 23 Mar 2023 21:19:48 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Thu, 23 Mar 2023 21:19:49 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 23 Mar 2023 21:19:49 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Thu, 23 Mar 2023 21:19:49 GMT
...
-	Layers:
	...
	-	`sha256:24b332af4dbba612c8c37f79fddf86708f0e6a6658e44461f5d19d3866c95a99`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b4f2484522250b671d35c40e58211b6f4f64c9fdbeefe10b51bd54010167be8`  
		Last Modified: Thu, 23 Mar 2023 21:20:36 GMT  
		Size: 1.2 MB (1206643 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:092bbe52fa71f6f8e58220ac6c9d5ae8cf911944db72db28b23f0d1012395102`  
		Last Modified: Thu, 23 Mar 2023 21:20:36 GMT  
		Size: 1.2 MB (1184170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6c38ab300e1e2584b784b97dd746c4a24b2ca8e1ea44a53a73ca9a2c1530317`  
		Last Modified: Thu, 23 Mar 2023 21:20:36 GMT  
		Size: 8.2 KB (8219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:672d440965e0da3fbc854c8a66f2162c9f11b10d7000a702fc389b78e2e71755`  
		Last Modified: Thu, 23 Mar 2023 21:20:36 GMT  
		Size: 1.9 MB (1862682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f847ab81da5e076982ee129a06a4616b1011271abc02a18be6d1056f1fb5c94`  
		Last Modified: Thu, 23 Mar 2023 21:20:36 GMT  
		Size: 1.6 KB (1598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:cfe48befd2edb28945e9565c64741305aef633469a902d7bb44c8f59a355d093
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.6 MB (172627891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9111784773a93f65eac9bcb80e30a36f690765f21911982c736000d1646ff89`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 09:40:37 GMT
CMD ["apache2-foreground"]
# Fri, 24 Mar 2023 01:35:04 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Fri, 24 Mar 2023 01:35:09 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Mar 2023 01:35:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Mar 2023 01:35:40 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Fri, 24 Mar 2023 01:35:40 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 24 Mar 2023 01:35:41 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Fri, 24 Mar 2023 01:35:41 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 24 Mar 2023 01:35:41 GMT
...
-	Layers:
	...
	-	`sha256:6138c0710423b0c5ded2f38e62d8500cea9dbfaba8737aee5f589ebb733562d0`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaaf8bf31b0e9026b36b7edf51b6ac979000a8bce93e07f11bc2f2f2be48686a`  
		Last Modified: Fri, 24 Mar 2023 01:36:42 GMT  
		Size: 1.2 MB (1243790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ba277795d4fe998bdf26afc45927048f5526efa7177123c95576cc6ab8c0151`  
		Last Modified: Fri, 24 Mar 2023 01:36:42 GMT  
		Size: 1.2 MB (1213611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e26857745107b914639bfcd9d0d038e6219cccfe19ed981bd03d3814403a2571`  
		Last Modified: Fri, 24 Mar 2023 01:36:42 GMT  
		Size: 8.2 KB (8216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef49e5f2623bf988d831c5d8d88b8a325902102f5106c4291f37242233799867`  
		Last Modified: Fri, 24 Mar 2023 01:36:42 GMT  
		Size: 1.9 MB (1862683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:292d11d1b6650c79837bfeab3ee961dd3fa79a433197efd29cd647b540be89a7`  
		Last Modified: Fri, 24 Mar 2023 01:36:42 GMT  
...
```console
$ docker pull postfixadmin@sha256:21eb69460a5085231465797ba546db689ce6bef3c11d315bdcc7ae217e7dbe2f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170384343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9cec5bf23c67adce9389f09c67575fcda1b6b7b7aaf992c8494b46d179a3306`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 11:47:19 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 21:48:58 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 23 Mar 2023 21:49:05 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 21:50:04 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 21:50:04 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 23 Mar 2023 21:50:05 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 23 Mar 2023 21:50:05 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Thu, 23 Mar 2023 21:50:05 GMT
...
# Thu, 23 Mar 2023 21:50:05 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Thu, 23 Mar 2023 21:50:06 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Thu, 23 Mar 2023 21:50:09 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 23 Mar 2023 21:50:09 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Thu, 23 Mar 2023 21:50:09 GMT
...
-	Layers:
	...
	-	`sha256:8b497b9024dccd19b90ba521a9a38c98abb835fe114bf626a790dc5c38ee5026`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:361fcbc752480926ae9a9b42dff132ae735cd4b36291c2b07c9266dab6440086`  
		Last Modified: Thu, 23 Mar 2023 21:51:46 GMT  
		Size: 1.2 MB (1186724 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e529ef20f59ae300e740e80170aa79add63da6eced1006bc730e5010bb737d9`  
		Last Modified: Thu, 23 Mar 2023 21:51:45 GMT  
		Size: 1.3 MB (1325111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d889fe0596c090fb6f4ce013eeaa54392950eb1758174bc8e6e9636ae2b8af8`  
		Last Modified: Thu, 23 Mar 2023 21:51:45 GMT  
		Size: 8.2 KB (8227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef3c8c9ae8e62bad5f80fcf66e1ef1e43bc32fdb5d5a12cae92fa53e3c123195`  
		Last Modified: Thu, 23 Mar 2023 21:51:46 GMT  
		Size: 1.9 MB (1862683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d071087e9ef5120c8352c3aa7bd2481092a54bc05422e1c6e89b6504777d424a`  
		Last Modified: Thu, 23 Mar 2023 21:51:45 GMT  
		Size: 1.6 KB (1597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:ea10f5122e92edddbbe97616fa2e144ec291cea4058c3c306c85f3604fd7aec8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.0 MB (147011227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb2105f77f1ccde79e1b9982a29a9b4f5ad105d18d3b7d196451657b454eb0b6`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 08:49:44 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 17:09:22 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 23 Mar 2023 17:09:25 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 17:09:46 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 17:09:46 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 23 Mar 2023 17:09:47 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 23 Mar 2023 17:09:47 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Thu, 23 Mar 2023 17:09:47 GMT
...
# Thu, 23 Mar 2023 17:09:47 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Thu, 23 Mar 2023 17:09:48 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 23 Mar 2023 17:09:49 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Thu, 23 Mar 2023 17:09:49 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Thu, 23 Mar 2023 17:09:49 GMT
...
-	Layers:
	...
	-	`sha256:242e1bcf3c7390f48621873ba0191f2f6ea604fe1f2de7bfd928ee1354f8d51a`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9c7c871f34eb7dcde2c9609048e16e88eb1f6124a1aa6869de0eca3ff1f5db2`  
		Last Modified: Thu, 23 Mar 2023 17:10:43 GMT  
		Size: 1.2 MB (1246058 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dc3602211c4ce5754d5f699619459b123b547a966fa86f78a09dff0039295d1`  
		Last Modified: Thu, 23 Mar 2023 17:10:43 GMT  
		Size: 1.2 MB (1188179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f497ea81a978715f2ab5dd8220deee59f48b8eecbc9b0db9f53f501e189a3497`  
		Last Modified: Thu, 23 Mar 2023 17:10:43 GMT  
		Size: 8.2 KB (8221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d791a6fe7faf4c18166f67675c114eac55768be690b4b3e3c71540e150d60ba8`  
		Last Modified: Thu, 23 Mar 2023 17:10:43 GMT  
		Size: 1.9 MB (1862684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01f281f3e94dd3194da5f57231530eaa6cd949fede316cb9dd218823c9ea325e`  
		Last Modified: Thu, 23 Mar 2023 17:10:43 GMT  
		Size: 1.6 KB (1595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
