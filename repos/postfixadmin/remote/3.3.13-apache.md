...
```console
$ docker pull postfixadmin@sha256:7c1b8798862d79995e04c97af4958bf132258ecf3b7066f44c1f3ceb22a32c9a
```
...
```console
$ docker pull postfixadmin@sha256:82aff399c9b5f5eb5e78ec733d11720415466c83f92f13aaf77f515ee0735f29
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.5 MB (181483972 bytes)**  
...
-	Layers:
	...
	-	`sha256:05d54901538584a1b706fab420ceb876ab947c3c3154697c0f3780038d71d2ea`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97c70a821d4ab78c7c263ded7de89fdef2794b1847eb2f414df92181a3c3a9ee`  
		Last Modified: Sat, 16 Dec 2023 09:28:56 GMT  
		Size: 1.3 MB (1297493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a68d7e5c4b774d21c565149725141f6bdbf1c0f230cc1d47070633768141210`  
		Last Modified: Sat, 16 Dec 2023 09:28:56 GMT  
		Size: 1.2 MB (1199520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5bb5a4cc992f2b3743610a8f240ae5c1f9f2b34db69e6ae36d26c169cedc934`  
		Last Modified: Sat, 16 Dec 2023 09:28:56 GMT  
		Size: 8.0 KB (8038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f05bd2f89f12f4e25d4edd70df4049ef5178e60acd38b869333472f00723ab96`  
		Last Modified: Sat, 16 Dec 2023 09:28:56 GMT  
		Size: 1.9 MB (1862688 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11cb9d1ae507a94cdb8792cf5889f89eb08d32d05dea24abf00fab1f2c313565`  
		Last Modified: Sat, 16 Dec 2023 09:28:56 GMT  
...
```console
$ docker pull postfixadmin@sha256:1b4adf9be43153df96211bbce249cbb1908aaee2b57bef51260bc27e30287963
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155132007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:318bf61f3a0681ae5daa5d7403fee31201649341eb3757802d77c823cfd74829`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 16 Dec 2023 03:54:45 GMT
CMD ["apache2-foreground"]
# Sat, 16 Dec 2023 06:29:22 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 16 Dec 2023 06:29:28 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:30:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:30:02 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 06:30:02 GMT
...
# Sat, 16 Dec 2023 06:30:02 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 16 Dec 2023 06:30:03 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 16 Dec 2023 06:30:04 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 16 Dec 2023 06:30:04 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Sat, 16 Dec 2023 06:30:04 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 16 Dec 2023 06:30:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3b1310d51d1c7a9d224dc7e83424519c5e2e97fdc52e844b72afb12c34b5b06b`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbf94db37813e77a8624b2f82a9fe293621f99037d9c4a73c7a6550091b327eb`  
		Last Modified: Sat, 16 Dec 2023 06:31:07 GMT  
		Size: 1.3 MB (1271209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327ce3bb2bd0d781d2ef5dadeee401d172a68febddd4e7cecd46975baea8aac9`  
		Last Modified: Sat, 16 Dec 2023 06:31:07 GMT  
		Size: 1.1 MB (1139076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b51af8d03b029813cdbba0ab425dddddcb064e990e4da72dc53630dcfef965`  
		Last Modified: Sat, 16 Dec 2023 06:31:07 GMT  
		Size: 8.0 KB (8044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:338dd8392974e77e353a9d9d688d1b3f2dbfee6c05c48768636aa4c7f3cff862`  
		Last Modified: Sat, 16 Dec 2023 06:31:07 GMT  
		Size: 1.9 MB (1862693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aac7f3c21609036dd5f1b853dac39ac08ca3cf0fd7a40d560b2d4a41208ac8ae`  
		Last Modified: Sat, 16 Dec 2023 06:31:08 GMT  
...
```console
$ docker pull postfixadmin@sha256:14e0e7b42f6b54ce4c474e715e238892b722999c0b6228313830a46d3f814e31
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (145977432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf70895e2247a6141ad8c3ec1b078f4302d71c6624c3ea596227f971ab32e9ef`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 16 Dec 2023 05:34:15 GMT
CMD ["apache2-foreground"]
# Sat, 16 Dec 2023 08:45:09 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 16 Dec 2023 08:45:13 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 08:45:42 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 08:45:42 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 08:45:42 GMT
...
# Sat, 16 Dec 2023 08:45:42 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 16 Dec 2023 08:45:43 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 16 Dec 2023 08:45:44 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 16 Dec 2023 08:45:44 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Sat, 16 Dec 2023 08:45:44 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 16 Dec 2023 08:45:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e78e5e230b5785e851780797e07b01235a9d731c2a54ae08342b6c5c1c204f90`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f38f701a52eb416848f83cf719d590e11ac4932ee6b8725c2280681f71cc1e20`  
		Last Modified: Sat, 16 Dec 2023 08:47:17 GMT  
		Size: 1.3 MB (1264030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:041a2da2b90a0bcb48393164fc1cc4b902e5d00dd2b2bc98750a53232c05f322`  
		Last Modified: Sat, 16 Dec 2023 08:47:17 GMT  
		Size: 1.1 MB (1087642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2981bb8566e41ba51a0e346a9f1f3a45da79040fa06f1405c579ee10781e237b`  
		Last Modified: Sat, 16 Dec 2023 08:47:16 GMT  
		Size: 8.0 KB (8047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73071e5e1e2aabc11792924b47b24ac8024788c0aae66ecd2b8baa9115e3490c`  
		Last Modified: Sat, 16 Dec 2023 08:47:17 GMT  
		Size: 1.9 MB (1862690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50c8a884086de12f36ec028b67e601c90fba7eb8159418cbc61622d774210eec`  
		Last Modified: Sat, 16 Dec 2023 08:47:17 GMT  
...
```console
$ docker pull postfixadmin@sha256:9ecd3c44a22674aa488bfa064220305f3f03cf51b95d5cd0b46432e19a3ceb8f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175213723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9724386f1c9f985a4d154146112aa7beed9e79b60858e4df08f2f95235d68dbe`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 16 Dec 2023 05:11:42 GMT
CMD ["apache2-foreground"]
# Sat, 16 Dec 2023 08:40:40 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 16 Dec 2023 08:40:43 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 08:41:07 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 08:41:08 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 08:41:08 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 16 Dec 2023 08:41:08 GMT
...
-	Layers:
	...
	-	`sha256:3531d4e9154bb052e67649be1bbfc88fa39f40af8a215c561a77fa75bd953c33`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37cb02557994d65480c1151dd31350d94665ffb74646f25d6e8c156878a7500a`  
		Last Modified: Sat, 16 Dec 2023 08:42:26 GMT  
		Size: 1.2 MB (1227850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be7392fd7ac9da6dde141bcd931144398362cca41f7f457e4369a7068ed80bbf`  
		Last Modified: Sat, 16 Dec 2023 08:42:26 GMT  
		Size: 1.2 MB (1190234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1c41456e694267582d63f828da1f5dc16f6e9f42785a5026279af47189ba980`  
		Last Modified: Sat, 16 Dec 2023 08:42:25 GMT  
		Size: 8.0 KB (8042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:266cea8fa93c1e4ba3a9589cb0009fcd339318b2b33e13c55595a3c37f7fc0c5`  
		Last Modified: Sat, 16 Dec 2023 08:42:26 GMT  
		Size: 1.9 MB (1862691 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7471a68a03116984eb3190bd9d0ce632d517578f740f3754f912725c41f61910`  
		Last Modified: Sat, 16 Dec 2023 08:42:25 GMT  
		Size: 1.7 KB (1657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:531324d9b944dd0621a8b416ac70b8c08f25750ead0a6384a8005a9616222fde
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.1 MB (186051353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c41be701a763268e7603d6056da168e7449fab7a29dae6bddc029feb09026fba`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 16 Dec 2023 09:59:56 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 16 Dec 2023 10:00:03 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 10:00:52 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 10:00:52 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 10:00:53 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 16 Dec 2023 10:00:53 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 10:00:53 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 16 Dec 2023 10:00:54 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 16 Dec 2023 10:00:55 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 16 Dec 2023 10:00:57 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 16 Dec 2023 10:00:57 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Sat, 16 Dec 2023 10:00:58 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 16 Dec 2023 10:00:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:48dde9dbd39f927f31db14ee05ad0b73ada50e8ba04cc447cc52c27a3acdc8a0`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:582da4818b5144baf34a5e7147ec74a5aae1be16359085b160546c2be17f4f7c`  
		Last Modified: Sat, 16 Dec 2023 10:03:27 GMT  
		Size: 1.2 MB (1215748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffc9c7d15a881e742589670a5ea77c2abefe95057913d78a8639e7fe06f9a29f`  
		Last Modified: Sat, 16 Dec 2023 10:03:27 GMT  
		Size: 1.3 MB (1330296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:548771f6808a7b91cad121394fa7733dc2f7e5fb9d219cb157fce428044f200d`  
		Last Modified: Sat, 16 Dec 2023 10:03:27 GMT  
		Size: 8.0 KB (8036 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:392cae90490b06a85107bca5d003c68f26b777fd65166a5ca1498b918af0fe4f`  
		Last Modified: Sat, 16 Dec 2023 10:03:27 GMT  
		Size: 1.9 MB (1862690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c05000d4dbe7f3940779d191861bc085ce04393a00dcc2e3e2e641f9bb8fb67`  
		Last Modified: Sat, 16 Dec 2023 10:03:27 GMT  
...
```console
$ docker pull postfixadmin@sha256:52a156940489b10d9007683351cea6c29fcba7a7386dd76438a15fe211e877b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155107030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a4eda050f1cfcf867c416b1f9a2938b42031aea28f9432e85e4feef489e88d3`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 16 Dec 2023 06:48:39 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 16 Dec 2023 06:48:42 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:49:04 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:49:04 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 06:49:05 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 16 Dec 2023 06:49:05 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Sat, 16 Dec 2023 06:49:05 GMT
...
-	Layers:
	...
	-	`sha256:b474fee936596b6f0b57f8211fc328ea7e153134112da5fa74f94166d189773f`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6412bfabb4b359da7458e4e231f04e9d3f97bd642b2d529892e0008c7cf05a68`  
		Last Modified: Sat, 16 Dec 2023 06:50:33 GMT  
		Size: 1.3 MB (1262960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49f071b38254f075be07f0e77dcf58022dd1bff1661790fcc09820ddf63ed167`  
		Last Modified: Sat, 16 Dec 2023 06:50:33 GMT  
		Size: 1.2 MB (1189619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7701f3ec6b133e66bbab0e571016be245f98377c9ff670046854eadc42833ae3`  
		Last Modified: Sat, 16 Dec 2023 06:50:32 GMT  
		Size: 8.0 KB (8041 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94b0a692c12372597d95d13fe6451de3ef2941c475fffe9e69fe953940e2288f`  
		Last Modified: Sat, 16 Dec 2023 06:50:33 GMT  
		Size: 1.9 MB (1862691 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09cd67c0cc52c1a66927893d5d4aa87b5d6990a74f599289c71ddcba917c2d67`  
		Last Modified: Sat, 16 Dec 2023 06:50:33 GMT  
		Size: 1.7 KB (1659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
