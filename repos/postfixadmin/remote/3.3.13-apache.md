...
```console
$ docker pull postfixadmin@sha256:a09f19ed869ec1b9a906ffb3c71b2b524dc51f9551ad9f5582534a2c0acc5f3c
```
...
```console
$ docker pull postfixadmin@sha256:929b03a234baf89b02db1403325acb527478458971696aa134a5050527caf80d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169892449 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d463f20088058aa031efc921afcf412a8a210a4a9810dfa5048faf2389e82f3`
...
-	Layers:
	...
	-	`sha256:3cc3365e9023faab084dff2562b31b046201aa10f22ebe394b9b52406040dd14`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22678a231b542300aa35ad461588ef0fa1e78a8ecbf830623357d69864e38f42`  
		Last Modified: Sat, 13 May 2023 03:33:44 GMT  
		Size: 1.3 MB (1284714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7f17dc0bad768897e38eae14a1dc7b62e8ec2c1d9f3dd8bf5cdaef0ed9187b1`  
		Last Modified: Sat, 13 May 2023 03:33:44 GMT  
		Size: 1.2 MB (1194802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b31b6ffe79c81af8686fd2cdaaa5d63e7fc681ee7b152f4cb92ac4732ec5dd0`  
		Last Modified: Sat, 13 May 2023 03:33:43 GMT  
		Size: 8.2 KB (8221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fec1af6a77b8c6a11f346ed65600359f1a41b5694a528028cce8151ec513bc8d`  
		Last Modified: Sat, 13 May 2023 03:33:44 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd8670fc1d2560feb5fae331ce49061d010ff2b7db1b5302a9adb76c43b1585b`  
		Last Modified: Sat, 13 May 2023 03:33:43 GMT  
...
```console
$ docker pull postfixadmin@sha256:dbe3b16b8647f0a22252b1677cf8732e8873b6471320d05192201cbd076bd1b4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.7 MB (147653528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72d3f886f2ea4b64b3ba2d8d6d4686a48fdba81827ef4e8594bfb1574e308329`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 May 2023 23:54:36 GMT
CMD ["apache2-foreground"]
# Sat, 13 May 2023 00:25:19 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 00:25:24 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 00:26:00 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 00:26:00 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 00:26:00 GMT
...
# Sat, 13 May 2023 00:26:00 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 00:26:01 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 00:26:02 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 00:26:02 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 13 May 2023 00:26:02 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 13 May 2023 00:26:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f837302226dc448eaad688653ec5ce7629a17aa98f2931f75fbc29b69194c8cb`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff18b8c998267a04d7fad85433cc14b9946da3b55b4dd7fceab6c1dfe9d66063`  
		Last Modified: Sat, 13 May 2023 00:27:03 GMT  
		Size: 1.2 MB (1230610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42d826b09e3723b4f4f623751497767900497c56ce5f3e2d16fe33056cc3695c`  
		Last Modified: Sat, 13 May 2023 00:27:03 GMT  
		Size: 1.1 MB (1136287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12a59f867991610e2a8d9b8e24c60293d5130eb96e255c532e5326af4d59408f`  
		Last Modified: Sat, 13 May 2023 00:27:02 GMT  
		Size: 8.2 KB (8221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e701a6265261bf5f8cddda57f06911e13179b94bcbdd7a10e1a2a0ef951bbbd8`  
		Last Modified: Sat, 13 May 2023 00:27:03 GMT  
		Size: 1.9 MB (1862699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d74dd0fcca90998f36aa625e5f623566fd04f206f0ce9369a16f4d1660bad8bf`  
		Last Modified: Sat, 13 May 2023 00:27:02 GMT  
...
```console
$ docker pull postfixadmin@sha256:cc0c61237f493034e76239182b70a23e0c665fe32dee0bf09d80c824f6565e90
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.8 MB (139820402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e52ede0100dfdb4c2f6f24b7bb856003db78791ec9e394fc51ef1772c3a9a1e`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 13 May 2023 02:54:05 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 02:54:09 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 02:54:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 02:54:39 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 02:54:39 GMT
...
-	Layers:
	...
	-	`sha256:fc3d283c3c5d2faaa00bd99d6248b48489d03700ab39a2bf9344d274faf36336`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f454c5f6dfde110b478bdb6e15378746a6a303368791ed0022194d40d54355c`  
		Last Modified: Sat, 13 May 2023 02:56:07 GMT  
		Size: 1.2 MB (1224927 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b1acd66d0a94c940e61b3291cbb416fdd900b72ec6892b44b68c3d96fc497c8`  
		Last Modified: Sat, 13 May 2023 02:56:08 GMT  
		Size: 1.1 MB (1086482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5b36a53ade4037c2bd7df9237687c563ff92c1d6fe5145bfb38144b6bd9532c`  
		Last Modified: Sat, 13 May 2023 02:56:07 GMT  
		Size: 8.2 KB (8220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df59161dbba60085f80aa2bcb44d058e985367d0c45cc992206978bc913c3473`  
		Last Modified: Sat, 13 May 2023 02:56:08 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1af1db64227f158b28c9245e9944390caaef73fe4a3c816aae2f3e1a18f6d2e`  
		Last Modified: Sat, 13 May 2023 02:56:07 GMT  
...
```console
$ docker pull postfixadmin@sha256:4ce6f5fb9200da287a7e23a894f58464b780c15fc66194654fa7d3e5b8b7a453
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.7 MB (163737697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c718eafc3615f9645925793c31bb19cf526a7d61f15609646f0d72ff50efd3b`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 03:34:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:35:23 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:35:23 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:35:23 GMT
...
# Sat, 13 May 2023 03:35:23 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 03:35:24 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 03:35:24 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 03:35:25 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 03:35:25 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 13 May 2023 03:35:25 GMT
...
-	Layers:
	...
	-	`sha256:dfeecfdfee94ae50d919ec23bafb500cfb88073c3d4c6743e72ecbb24624fac3`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c386cfba751fcd97a0aff36047c99401a55f8b3b9e1240f3523aeccb75646a5`  
		Last Modified: Sat, 13 May 2023 03:36:48 GMT  
		Size: 1.2 MB (1206785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db806bcd9ae1e56dbaf4007cc5b22c327e18e112f158d82698f112887d5818a4`  
		Last Modified: Sat, 13 May 2023 03:36:48 GMT  
		Size: 1.2 MB (1184287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b04cc6c852c7874bbda710f8d28e9b7c1e5dad98394105ae4bfe14ed5a337cca`  
		Last Modified: Sat, 13 May 2023 03:36:47 GMT  
		Size: 8.2 KB (8219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f6e9f7d2782891e2e5e1beb9e26fba29cec572d07c19c45e6d55e2d6bf2940d`  
		Last Modified: Sat, 13 May 2023 03:36:48 GMT  
		Size: 1.9 MB (1862694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b08c8f7bd2b6de0fed660bea3bda86c6ad90fcee0f25857ecba93e6bc2059f9f`  
		Last Modified: Sat, 13 May 2023 03:36:48 GMT  
...
```console
$ docker pull postfixadmin@sha256:2bc31badfd50a64cdc20e05250677fcbea5aa4258254579563cde8b42b2c8deb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172661552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7229ac31f8688023b7a993f14de881a5e266cb985225c63c500cb328547e3efe`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 03:26:14 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:26:46 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:26:46 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:26:46 GMT
...
# Sat, 13 May 2023 03:26:46 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 03:26:47 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 03:26:48 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 03:26:48 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:a3a7d0fc61e56248263a6828efa8efae74c71c7fe3dc9f6613530bf45101f77b`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f09e8e1f08543776932536558a33c2944a87fac5239f4467e866ecbb04118c7c`  
		Last Modified: Sat, 13 May 2023 03:28:27 GMT  
		Size: 1.2 MB (1243838 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62f889114d6e2954b3b7efbeee908dc570b53a5ec3dda73d09c86d8b8507a1b4`  
		Last Modified: Sat, 13 May 2023 03:28:27 GMT  
		Size: 1.2 MB (1213713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:087188bc71baa1dac41acc8d0c6f308fde2a4c2e74a1b67a79cb55691b8158b4`  
		Last Modified: Sat, 13 May 2023 03:28:26 GMT  
		Size: 8.2 KB (8225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6829c37d819a34ed1ffcda2c19ec7bc17254efea3599c92fca3ce4ca9927eb89`  
		Last Modified: Sat, 13 May 2023 03:28:27 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a3e458a7e3d9f6b20e435fd500e5858546bc2543913e0c9a265fd6c1c44bd55`  
		Last Modified: Sat, 13 May 2023 03:28:26 GMT  
...
```console
$ docker pull postfixadmin@sha256:d90a090bbe9b25ce676461a32af03e4d1055f4f02399dde2e4b3f3ec36b73e41
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.5 MB (146544458 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:666a55e5921f3ef9c602827e0b53f652e2fd0889e0120783f9907bd2fe61c6f7`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 13 May 2023 03:54:31 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 03:54:49 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:56:52 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:56:55 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:56:59 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 03:57:03 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:57:06 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 03:57:10 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 03:57:16 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 03:57:24 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 03:57:27 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 13 May 2023 03:57:31 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 13 May 2023 03:57:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:475cd2f7027c97a745e3e9c2c31d7c56d3c6a6e0a5c419ba6128ba7463424224`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0ba70b37a062c913c22dcea821d2b55cf4a2b8cef3a38a26441a437287ed349`  
		Last Modified: Sat, 13 May 2023 04:00:50 GMT  
		Size: 946.7 KB (946712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f89bcd079b05d242efff1a21ebdbb0df226b55052af2950e3a7890a2d2e2d245`  
		Last Modified: Sat, 13 May 2023 04:00:50 GMT  
		Size: 944.9 KB (944882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:690ad4c33fbb40428ea8f414c229721684527c4d133f4c9bf652203d54937343`  
		Last Modified: Sat, 13 May 2023 04:00:50 GMT  
		Size: 8.2 KB (8233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:489a9f90d54890ce44fd0482fbb6e6448075aae4d53a833c8bac8bdb2db17c06`  
		Last Modified: Sat, 13 May 2023 04:00:51 GMT  
		Size: 1.9 MB (1862556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dad8e62184197e6239d393348ba95fbd4c768af549ed293ca3c1de430646413a`  
		Last Modified: Sat, 13 May 2023 04:00:50 GMT  
...
```console
$ docker pull postfixadmin@sha256:c68fd355115814314eb2429d82ffc4be275010269292c3734208f9c44f391018
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170420428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58ec6f70be03c5530c498ee319228511fece67ca5b3b79cd41c9ad8e80182f86`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 13 May 2023 00:50:46 GMT
CMD ["apache2-foreground"]
# Sat, 13 May 2023 03:46:51 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 03:47:00 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:48:16 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 03:48:17 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:48:17 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 03:48:17 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 03:48:18 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 03:48:18 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 03:48:20 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 03:48:22 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 03:48:23 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 13 May 2023 03:48:23 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 13 May 2023 03:48:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3f33616b5215b612861b229a970c36cabab1aed30584a02f3b6e8502e7a20906`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d5424971881a99fa4122503b6fbf9f17e033309542d5e662443ea902020c713`  
		Last Modified: Sat, 13 May 2023 03:51:31 GMT  
		Size: 1.2 MB (1186702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c53a4a001c82037eb4c3a64e0ac06d46dd8db2a7af69ce200df1237959bccfe1`  
		Last Modified: Sat, 13 May 2023 03:51:31 GMT  
		Size: 1.3 MB (1325095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665440199882a4eab66fe102ba75fddbeef4a5eba647b29ac6d71abbbd9b57b4`  
		Last Modified: Sat, 13 May 2023 03:51:30 GMT  
		Size: 8.2 KB (8226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f70eddaec38e19170c66a4c916346923006d14d3ae2b587c3835e8f6e76e38f`  
		Last Modified: Sat, 13 May 2023 03:51:31 GMT  
		Size: 1.9 MB (1862690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0192b48a671dd87f89ce703ae1db6fd2772ef4fb44cd78a7be9e0cec76f1ab8e`  
		Last Modified: Sat, 13 May 2023 03:51:30 GMT  
		Size: 1.6 KB (1596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:35f1f0c91de449242779c06c63ca4ac219cac676ecbe7b5e96735e66e57d2530
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.0 MB (147048882 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c1ef7778b4a99de9b88a8568f3dce74b75935e3cc935981ceb6025c3917d590`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 13 May 2023 06:34:00 GMT
CMD ["apache2-foreground"]
# Sat, 13 May 2023 08:15:52 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 13 May 2023 08:15:55 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 08:16:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 May 2023 08:16:18 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 08:16:18 GMT
...
# Sat, 13 May 2023 08:16:18 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Sat, 13 May 2023 08:16:19 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Sat, 13 May 2023 08:16:19 GMT
ENV APACHE_DOCUMENT_ROOT=/var/www/html/public
# Sat, 13 May 2023 08:16:19 GMT
RUN set -eu; sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/*.conf; 	sed -ri -e 's!/var/www/!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/apache2.conf /etc/apache2/conf-available/*.conf
# Sat, 13 May 2023 08:16:21 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 13 May 2023 08:16:21 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Sat, 13 May 2023 08:16:21 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 13 May 2023 08:16:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:de16091940dfe1f619996bcbf12e885db893582a307e8e6d6f4dc95f724ab5aa`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9ab7734241db1530e8cddf3543f174f7ac34e5bfcb100b5a18399a190122a6c`  
		Last Modified: Sat, 13 May 2023 08:17:50 GMT  
		Size: 1.2 MB (1246183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d860dd5620f8d1008380fa77dff6d729c22fec9f5cf8351feb6a434782c91b1f`  
		Last Modified: Sat, 13 May 2023 08:17:50 GMT  
		Size: 1.2 MB (1188342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:040ea9eabe987ea822e5584d2c906eca0e9a76fd9a369ff12f5cd79fd41fcc11`  
		Last Modified: Sat, 13 May 2023 08:17:50 GMT  
		Size: 8.2 KB (8221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ea4ba7e17387fe3b2a92f7369155a4b421156b40969677b5ebaa466be9b4c82`  
		Last Modified: Sat, 13 May 2023 08:17:50 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9aa225cb6564c1d0ca4f3d08df6ecac67614e60aedac0c4dd8c73ce5efd78c0`  
		Last Modified: Sat, 13 May 2023 08:17:50 GMT  
		Size: 1.6 KB (1598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
