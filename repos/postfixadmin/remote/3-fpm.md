...
```console
$ docker pull postfixadmin@sha256:6877eff93a0d3a5c30bf5d997c3e9815b0fa0b2ca661e6f9f7f5a07b83ee0b1a
```
...
```console
$ docker pull postfixadmin@sha256:bc950a5937a289a1ad51d20d282c251cb49c56e2cc2c9522a6aa021f0a702565
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.6 MB (177566927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7303420c278b5316172bb5ff295c1c00c54de7d1133402efe354dd0f084e9c5a`
...
-	Layers:
	...
	-	`sha256:5b81ca156c69dad1761318527a88ab791a282f09ca751073a9ac9e749fa1148d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:077875b58d843d367d7872a32a90d21f93358fa5d9fdf9ed5383c12a04f74a5a`  
		Last Modified: Tue, 13 Feb 2024 15:20:14 GMT  
		Size: 1.3 MB (1273268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66fe1dfe751ce713933b5667ae22ee243cb6c2bef705526e079cb7daf01153a3`  
		Last Modified: Tue, 13 Feb 2024 15:20:14 GMT  
		Size: 1.2 MB (1175166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:429e8c5ce5bff4715f1e7cfaa46c49d8b6dd406354a0e4c6d30120e50a701a76`  
		Last Modified: Tue, 13 Feb 2024 15:20:14 GMT  
		Size: 1.9 MB (1862685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d983af00d615b348106b675d22139868c6ef5644e3f5bc5549b87f6427dbfdb7`  
		Last Modified: Tue, 13 Feb 2024 15:20:14 GMT  
...
```console
$ docker pull postfixadmin@sha256:e929e5f92aef6da8c7977928cd34238059cc01707fc2192f45fdcc6d63178ba4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.4 MB (151360271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcb20c10fcf06849f3010427003fec1086cf9bbe863f9ebf8121a6f9aaa030b7`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Feb 2024 12:11:33 GMT
CMD ["php-fpm"]
# Tue, 13 Feb 2024 16:17:05 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Tue, 13 Feb 2024 16:17:12 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 16:18:33 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 16:18:33 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Tue, 13 Feb 2024 16:18:33 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 13 Feb 2024 16:18:34 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Tue, 13 Feb 2024 16:18:34 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 13 Feb 2024 16:18:36 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Tue, 13 Feb 2024 16:18:37 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Tue, 13 Feb 2024 16:18:37 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Tue, 13 Feb 2024 16:18:37 GMT
...
-	Layers:
	...
	-	`sha256:647dff8410ea32ba657bcab4b88a4f07b40a56b13fda7fdcf9bafdad9cde747d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a982a6b4f566fc3b9be165869ab296f101d040f938857df824cbe60b7d21699f`  
		Last Modified: Tue, 13 Feb 2024 16:19:30 GMT  
		Size: 1.2 MB (1246127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcf305ae8e70cffc4b56a18fd23990c5cfa54cf54b201592555b6f24198f7a8d`  
		Last Modified: Tue, 13 Feb 2024 16:19:30 GMT  
		Size: 1.1 MB (1114137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51efc03c07b51a48dd03af1f068acd3dbbdb02298404799c57b88acffd162ad6`  
		Last Modified: Tue, 13 Feb 2024 16:19:31 GMT  
		Size: 1.9 MB (1862682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91e8c9edc009e7d846e671b5b49c5586cae11e68dbfce54438df8262b9130f9c`  
		Last Modified: Tue, 13 Feb 2024 16:19:30 GMT  
...
```console
$ docker pull postfixadmin@sha256:53778c2097dd4873716d50f6bb7d743ea66ebe0755a4466b34cf22b1c621aca6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.4 MB (142448238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a5db0b7c79cf40d0e1cfd442ea148392cf1c15e9483cf6f891b7afa40091842`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Tue, 13 Feb 2024 21:14:16 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 21:15:29 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 21:15:29 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Tue, 13 Feb 2024 21:15:29 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 13 Feb 2024 21:15:30 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Tue, 13 Feb 2024 21:15:30 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
...
-	Layers:
	...
	-	`sha256:7e682b6b79e55d6b39ec04f15d0bd8f7fcf7013bb1893364cd3a21401159810d`  
		...
		Size: 8.9 KB (8879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3ebe127846fff411f1e071eb4cecb66804e23b241ac30a9dea89ba603bcc48b`  
		Last Modified: Tue, 13 Feb 2024 21:16:39 GMT  
		Size: 1.2 MB (1239154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b7adb1ee6f49e57cf57ff292651a93df302d742f50d3be114e47eef73d5a836`  
		Last Modified: Tue, 13 Feb 2024 21:16:39 GMT  
		Size: 1.1 MB (1062253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62a6c000391f674d1d65c5cf11d48a072bf3920baf91fbc165af33179e7456d5`  
		Last Modified: Tue, 13 Feb 2024 21:16:39 GMT  
		Size: 1.9 MB (1862687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f080cae935e0f4d2b212bdab418ebc6c279ad0fafa8e5b82857a85740a15014b`  
		Last Modified: Tue, 13 Feb 2024 21:16:38 GMT  
