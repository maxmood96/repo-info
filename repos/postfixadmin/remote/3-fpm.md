...
```console
$ docker pull postfixadmin@sha256:d2c5662f9f16b805682098cec16c9da9b981789a301abe36e0d872fc528e494d
```
...
```console
$ docker pull postfixadmin@sha256:0312c50cab43b74756607a4c5437a7fe8c8a0e4cf80587c7591cf5231a47dbbd
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159531405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68edac05f12b02c4bb1c86eaa77e2b7c16837b31f0a1b6933add81f0e1833c30`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Fri, 06 Jan 2023 04:41:56 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 04:42:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 04:42:20 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Fri, 06 Jan 2023 04:42:20 GMT
...
-	Layers:
	...
	-	`sha256:dffac7a155630dcba3a09abb6f6355a0d1dab71775b8f04374be6922dea7a01e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d127a1a196740add83bdd9fb5869b8cbe0f602cc94c4da1b8ac0a0bb457c00e9`  
		Last Modified: Fri, 06 Jan 2023 04:43:47 GMT  
		Size: 1.2 MB (1180780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a7bccdb6c1ca3730d0d930a033709732d0961e9c31330ebbc07112ede951ffd`  
		Last Modified: Fri, 06 Jan 2023 04:43:47 GMT  
		Size: 1.2 MB (1158359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a98ae360e0c53357551a0314f89965afadf40b998b6414387f06e9795a50f41`  
		Last Modified: Fri, 06 Jan 2023 04:43:48 GMT  
		Size: 1.9 MB (1862684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:593f390d33573e5d7146b5ec6bcd8aab21ba2735e044418602a69c572ffe8807`  
		Last Modified: Fri, 06 Jan 2023 04:43:47 GMT  
...
```console
$ docker pull postfixadmin@sha256:859785a22b34c34d6a0bbdf2ec1a35154caa772cde048a4d41445e00aae51211
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165569817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a8b3dccebe1c76e5ff9b99dc131bc8446752c2955e91af70ce0995c7824ba3a`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 06 Jan 2023 05:59:28 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Fri, 06 Jan 2023 05:59:35 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 06:00:30 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 06:00:30 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Fri, 06 Jan 2023 06:00:31 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 06 Jan 2023 06:00:31 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Fri, 06 Jan 2023 06:00:31 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 06 Jan 2023 06:00:33 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Fri, 06 Jan 2023 06:00:34 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Fri, 06 Jan 2023 06:00:34 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Fri, 06 Jan 2023 06:00:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5ccc1b044dc1320d1cc9f162d6f31c363f829773933e7c0ba04f72d0e03c1904`  
		...
		Size: 8.7 KB (8733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:809887f7f84afb3001b7fa344896e46c04143f48e850506abab72f0408760cf8`  
		Last Modified: Fri, 06 Jan 2023 06:03:04 GMT  
		Size: 1.2 MB (1160789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc4539e2315e99bad0176f2a2e9cf878219e605156568210c6c0a24f4c32ceb9`  
		Last Modified: Fri, 06 Jan 2023 06:03:05 GMT  
		Size: 1.3 MB (1298765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37d894273ee26d06a5fd1913ccf95fccf25f015291fb6a6e4eccbf32525491f1`  
		Last Modified: Fri, 06 Jan 2023 06:03:05 GMT  
		Size: 1.9 MB (1862685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91d1eed84749c75ee62dae601a4a48e8b49bbe6fdb28fae6112ed5ba7ead6409`  
		Last Modified: Fri, 06 Jan 2023 06:03:04 GMT  
		Size: 1.6 KB (1598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:af572f5b5d929b5a95c3759e44ae71484225961edd7f43715ea1aff8ddf68819
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.9 MB (142876533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:378217b73c8ea45e9290d3f0aa6e071ba2ac25c428c721ca5d8de35bfdf6ccfe`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Fri, 06 Jan 2023 03:56:21 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 03:57:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 03:57:19 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Fri, 06 Jan 2023 03:57:19 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 06 Jan 2023 03:57:20 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Fri, 06 Jan 2023 03:57:21 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Fri, 06 Jan 2023 03:57:24 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Fri, 06 Jan 2023 03:57:24 GMT
COPY file:0330067c04a06041dac55442e16abfe0ed234a7c50cf07812b84b1921c7cb5e3 in /usr/local/bin/ 
# Fri, 06 Jan 2023 03:57:25 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Fri, 06 Jan 2023 03:57:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:653ee40be5ff3bb7219b69989b66139f6fecd93a7ab9c0a762e9e6767a6a2cb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb48375d619d2350a49dfb4da6ec723490eecc8d1aeada70a28dd5e91d48313f`  
		Last Modified: Fri, 06 Jan 2023 04:00:14 GMT  
		Size: 1.2 MB (1220808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4f6428666c4f6d2379bcdb1617d97ed9b9893a9deb2ac4c505c2d9e3dbf01b5`  
		Last Modified: Fri, 06 Jan 2023 04:00:14 GMT  
		Size: 1.2 MB (1162648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:861d7603fdd211a5da3944d13fee7e2730fb54fc3681456b753d8cf132c5372a`  
		Last Modified: Fri, 06 Jan 2023 04:00:14 GMT  
		Size: 1.9 MB (1862687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:814f2f519e3c904f05644de0f3bd19b64da48038d2f7946507255692a20dcf42`  
		Last Modified: Fri, 06 Jan 2023 04:00:14 GMT  
