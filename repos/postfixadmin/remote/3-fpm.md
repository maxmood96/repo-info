...
```console
$ docker pull postfixadmin@sha256:26d912a291865cdb31efa71a9585080403820032b6103a31d4a5c2369f2fbcf9
```
...
```console
$ docker pull postfixadmin@sha256:256c20fcff861c13583f294d87dba84865ce7e341a556e105ba810941c19690c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.9 MB (122942503 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b14eb04223940d0b27594ed3bb86f6a642f50eb318ca86f09091cc96f457b75`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Sat, 27 Mar 2021 14:49:52 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 27 Mar 2021 14:51:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 27 Mar 2021 14:51:07 GMT
ARG POSTFIXADMIN_VERSION=3.3.7
# Sat, 27 Mar 2021 14:51:08 GMT
ARG POSTFIXADMIN_SHA512=c635b885235f2683532ff4fcd6d3e123fa5af8314cfcdbcdf412d7242444bb9c040a6eeb2f6b0669b9f5dd9fc56c53127779727768c68699885cc642717453ca
# Sat, 27 Mar 2021 14:51:10 GMT
ENV POSTFIXADMIN_VERSION=3.3.7
# Sat, 27 Mar 2021 14:51:13 GMT
ENV POSTFIXADMIN_SHA512=c635b885235f2683532ff4fcd6d3e123fa5af8314cfcdbcdf412d7242444bb9c040a6eeb2f6b0669b9f5dd9fc56c53127779727768c68699885cc642717453ca
# Sat, 27 Mar 2021 14:51:21 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Sat, 27 Mar 2021 14:51:22 GMT
COPY file:fdbbe9338cbed384d6b0de0652a7f3fd36623703b7f7ad586b41efefd5ef4bba in /usr/local/bin/ 
# Sat, 27 Mar 2021 14:51:24 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Sat, 27 Mar 2021 14:51:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d12cbd185f34418ee1c056b4b5943e76460833edaf59271b755af8b2b8213527`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1068fe1acd556fd0d7daf2b043cabe85a8369d27983957c1d29ce91f61732909`  
		Last Modified: Sat, 27 Mar 2021 14:52:13 GMT  
		Size: 939.3 KB (939259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19ad1b3f5437917e5c9c1c8a8db7fe74416babeca7062532ed4e7728196329cc`  
		Last Modified: Sat, 27 Mar 2021 14:52:14 GMT  
		Size: 1.1 MB (1057593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f93f46dc152621d1428a4306cba5325295d6240966e1f5457bae563dba76d7c`  
		Last Modified: Sat, 27 Mar 2021 14:52:14 GMT  
		Size: 1.9 MB (1855170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:592f1ace8b55c9f5e7fd30430579826da6bc11a1bccdeee0a7389a81d7344300`  
		Last Modified: Sat, 27 Mar 2021 14:52:13 GMT  
