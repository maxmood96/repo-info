...
```console
$ docker pull postfixadmin@sha256:e1f81578d7159ad2e8535a29c515db9e4dca1096390c648c45f9120c69ebba22
```
...
```console
$ docker pull postfixadmin@sha256:b50e3fc5729a07254959713cbeb5d46a91ebc219f8111b9257e2da0f1260b087
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176220007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9d3b600b949ecb8e41056cc2b609f6d0b7a6257b1c84f28bdee54796945074e`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 May 2024 04:56:53 GMT
CMD ["php-fpm"]
# Tue, 14 May 2024 15:06:07 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Tue, 14 May 2024 15:06:11 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 15:06:46 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 15:06:47 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Tue, 14 May 2024 15:06:47 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 14 May 2024 15:06:47 GMT
...
-	Layers:
	...
	-	`sha256:99fcbefac41d66d65254f2e4b2164a554c788088936a24c1f5bbafd9ab8d539a`  
		...
		Size: 8.9 KB (8883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:820a08718faa0ebb3bd26a82f63f652009516a88bd339ebe9de212eafb3c3f39`  
		Last Modified: Tue, 14 May 2024 15:07:50 GMT  
		Size: 1.3 MB (1259631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0706c773fa9c82cac4ffc824bf02204a39a65584785e1d464e16d2a3d18911d3`  
		Last Modified: Tue, 14 May 2024 15:07:50 GMT  
		Size: 1.2 MB (1194618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a53c43a2c849b819fd80dc5595b7bd4cba8d91757e0282e2c5e9fa3a7e10d3e7`  
		Last Modified: Tue, 14 May 2024 15:07:50 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58f543eaa7f5af65b77cfba95a84517f815e2b548aa4e18d281bb0dfbbac2847`  
		Last Modified: Tue, 14 May 2024 15:07:49 GMT  
		Size: 1.7 KB (1657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postfixadmin@sha256:67dc6f02b7701f044aae50c610f34997f231564265d827546464b957db114304
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.8 MB (151755104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94aeb7dff9508fb29ed8e2f4d49dca712a1595a7fc7be11651475fb788007294`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 14 May 2024 17:06:03 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Tue, 14 May 2024 17:06:22 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 17:08:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 17:08:29 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Tue, 14 May 2024 17:08:32 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 14 May 2024 17:08:36 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Tue, 14 May 2024 17:08:39 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Tue, 14 May 2024 17:08:48 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Tue, 14 May 2024 17:08:51 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Tue, 14 May 2024 17:08:54 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:33c957e259f1bfb59de18f48312563961b9387bcca186ac3cc603378464ddfac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:123c5d91a38acd30e0c6207b75d3be1c1b03cebb9a5f286e9cfe0bc43be1986d`  
		Last Modified: Tue, 14 May 2024 17:10:07 GMT  
		Size: 950.4 KB (950448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea08b9bc42da82b047e974883bbd875b5aa3f27ffb9ca21be1f0839c1aaabb1f`  
		Last Modified: Tue, 14 May 2024 17:10:07 GMT  
		Size: 932.7 KB (932740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a798975241422e7edbd24e4aaf7e16fcb5712bdfe892e2d384424b169a31ebd2`  
		Last Modified: Tue, 14 May 2024 17:10:08 GMT  
		Size: 1.9 MB (1862544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c16fdac1f1a2691eda6868529d9fc81c63d102f9fda6eeda5e86af071f7f8cc`  
		Last Modified: Tue, 14 May 2024 17:10:07 GMT  
		Size: 1.7 KB (1658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
