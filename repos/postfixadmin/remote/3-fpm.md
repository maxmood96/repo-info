...
```console
$ docker pull postfixadmin@sha256:613b1d38c4cdde23b7060f45504d4e139e0ea323f1ad97d5abebf179e0a7454a
```
...
```console
$ docker pull postfixadmin@sha256:f95da5b3334b72d854d3e927581fb6ff017be4e91744506affb8fb3bc187d841
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.4 MB (151361404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8665a6191b2233fc6663358713808367b799f7cb775fac016f82b3c4ef914844`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 11 Jan 2024 23:39:23 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 11 Jan 2024 23:39:29 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:40:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:40:48 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 11 Jan 2024 23:40:49 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 11 Jan 2024 23:40:49 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Thu, 11 Jan 2024 23:40:49 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 11 Jan 2024 23:40:51 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 11 Jan 2024 23:40:51 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Thu, 11 Jan 2024 23:40:52 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Thu, 11 Jan 2024 23:40:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:53374bab99147f083d73fbddc05d5427569ce691fbbbbe2d907dc105fd9681ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e15cc70d6de492e5a0d3227bbbfbcec13d51caaa50fc6cd5111e2b2e1cd08c1`  
		Last Modified: Thu, 11 Jan 2024 23:41:44 GMT  
		Size: 1.2 MB (1245957 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:546ce7ecb6d7223611f2c91b2eba4c78375043c03a36becf1d064a8e97cdbf8f`  
		Last Modified: Thu, 11 Jan 2024 23:41:44 GMT  
		Size: 1.1 MB (1113926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6aab3191e4ddced0a4506a97b8332e46bfd3c7e191b5b507258c09a7cc13117f`  
		Last Modified: Thu, 11 Jan 2024 23:41:44 GMT  
		Size: 1.9 MB (1862689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cab8484590c4ae03e15abe7144e1c1e8ce5f31d32c78422d67e9db66d18ed89b`  
		Last Modified: Thu, 11 Jan 2024 23:41:44 GMT  
...
```console
$ docker pull postfixadmin@sha256:c628971436610383fb8d89f67969fb898c171c38377c4dbc80b19626a94fa57c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.4 MB (142446417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a07717b65772509bfcd6c33f2b28ada224cdb8f9c6054aced5f131a13eaec4d4`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 11 Jan 2024 23:28:34 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 11 Jan 2024 23:28:40 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:29:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:29:54 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 11 Jan 2024 23:29:54 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 11 Jan 2024 23:29:54 GMT
...
# Thu, 11 Jan 2024 23:29:54 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 11 Jan 2024 23:29:57 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 11 Jan 2024 23:29:57 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Thu, 11 Jan 2024 23:29:58 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Thu, 11 Jan 2024 23:29:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b4413e82fb6333c351adc886c2d4b82d0a99caa280f4f33cf1e80cab887ac873`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dcfdfa6363eea7f364a10d38e3687bbeb02bd4998f6c9d1fae40e83216e15b1`  
		Last Modified: Thu, 11 Jan 2024 23:31:02 GMT  
		Size: 1.2 MB (1239028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1947da318a2f46a34fd07c68a49e6b73728a81764620d560ff37edc6e0715b2c`  
		Last Modified: Thu, 11 Jan 2024 23:31:02 GMT  
		Size: 1.1 MB (1062179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c59ff79b91462846ca5dd0b48500f24dd9ab6828281b4c5364fe7d359f652495`  
		Last Modified: Thu, 11 Jan 2024 23:31:02 GMT  
		Size: 1.9 MB (1862692 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb4b8b57cc94476872b5c52f3ce6a72a69042357247b4eda79c173a9d16637ab`  
		Last Modified: Thu, 11 Jan 2024 23:31:01 GMT  
		Size: 1.7 KB (1659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
