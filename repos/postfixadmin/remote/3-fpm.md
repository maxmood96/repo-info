...
```console
$ docker pull postfixadmin@sha256:a1d15f25f3c64aca8f0dbbbbec44e5284cabfddb62dbaee3b5bd7cd82cbf17eb
```
...
```console
$ docker pull postfixadmin@sha256:52a802580633a41eb332502c1f183a0ae672d40befd956abc4803c7f463cbf55
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.3 MB (171273627 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31036b6151b71d655279107461925703bf378a6a3c55e57d1807ba11c65ef1cd`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Feb 2024 02:40:58 GMT
CMD ["php-fpm"]
# Thu, 01 Feb 2024 13:30:04 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 01 Feb 2024 13:30:07 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 13:30:33 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 13:30:33 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 01 Feb 2024 13:30:33 GMT
...
-	Layers:
	...
	-	`sha256:301e5599a74d8eb627173dc8fe53a5a57315fb45c44a4ba6d00689e54d0556ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ff9102f704fe7a00e469b18397de12b4fdcc28cfc6f0daa03017f6ab7251b68`  
		Last Modified: Thu, 01 Feb 2024 13:31:22 GMT  
		Size: 1.2 MB (1204587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d3420a516bd7daddeffcd10dab31f233e90f0c6b33c771326943605c809fc43`  
		Last Modified: Thu, 01 Feb 2024 13:31:21 GMT  
		Size: 1.2 MB (1166446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d1e36d87e06a097234c15576c2802368326abe06c69dcac717344515753f468`  
		Last Modified: Thu, 01 Feb 2024 13:31:21 GMT  
		Size: 1.9 MB (1862690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4863d08e866f132cfee12556e2a8aad08cf80d4a0fd1d5cf23c9800b599f4ea9`  
		Last Modified: Thu, 01 Feb 2024 13:31:21 GMT  
...
```console
$ docker pull postfixadmin@sha256:3f8bde87767426da65ca965b5bd29ce2cd52c5cfd9067b543ed8dd6734a83982
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181624762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:965b8e4dfe7594841a8675fed64af12e2eb215efc8467670ba7f49e682efc4b5`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 01 Feb 2024 11:49:32 GMT
LABEL maintainer=David Goodwin <david@codepoets.co.uk> (@DavidGoodwin)
# Thu, 01 Feb 2024 11:49:37 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		gosu 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 11:50:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 	libc-client2007e-dev 	libkrb5-dev 	libpq-dev 	libsqlite3-dev 	; 		docker-php-ext-configure 		imap --with-imap-ssl --with-kerberos 	; 		docker-php-ext-install -j "$(nproc)" 		imap 		pdo_mysql 		pdo_pgsql 		pdo_sqlite 		pgsql 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 		ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 			apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 11:50:27 GMT
ARG POSTFIXADMIN_VERSION=3.3.13
# Thu, 01 Feb 2024 11:50:27 GMT
ARG POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 01 Feb 2024 11:50:28 GMT
ENV POSTFIXADMIN_VERSION=3.3.13
# Thu, 01 Feb 2024 11:50:28 GMT
ENV POSTFIXADMIN_SHA512=bf7daaa089ee3adc4b557f1a7d0509d78979ef688fb725bab795f5c9d81e8774296245fde0cb184db51e9185cad381682c3ecc0bfadf852388b499a0a95cca64
# Thu, 01 Feb 2024 11:50:31 GMT
RUN set -eu; 	curl -fsSL -o postfixadmin.tar.gz "https://github.com/postfixadmin/postfixadmin/archive/postfixadmin-${POSTFIXADMIN_VERSION}.tar.gz"; 	echo "$POSTFIXADMIN_SHA512 *postfixadmin.tar.gz" | sha512sum -c -; 	mkdir /usr/src/postfixadmin; 	tar -xf postfixadmin.tar.gz -C /usr/src/postfixadmin --strip-components=1; 	rm postfixadmin.tar.gz; 	mkdir -p /usr/src/postfixadmin/templates_c; 	chown -R www-data:www-data /usr/src/postfixadmin
# Thu, 01 Feb 2024 11:50:31 GMT
COPY file:3a0fa0e04f41744e0091faf2c9d63c7be2a0b50e0f9c3db426d10d88d37c2792 in /usr/local/bin/ 
# Thu, 01 Feb 2024 11:50:32 GMT
ENTRYPOINT ["/usr/local/bin/docker-entrypoint.sh"]
# Thu, 01 Feb 2024 11:50:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:eceddf0841f3e7b695603ffffd670d67cc8dabd82827c5630d99a3fd9c2d776e`  
		...
		Size: 8.9 KB (8882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:caaebfe02315ad8970cafe2f00631953740c74978e2f990cad51ebb88698d1cf`  
		Last Modified: Thu, 01 Feb 2024 11:51:35 GMT  
		Size: 1.2 MB (1192256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b7f99ffea9078a740e8cb85b5d7e64a5a3a65722e86d74fb02f087c0297e903`  
		Last Modified: Thu, 01 Feb 2024 11:51:35 GMT  
		Size: 1.3 MB (1307072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd4b21321b27f912a3cf4b8f33e23f6eed8ce205b70737de46d6c2bef016b55a`  
		Last Modified: Thu, 01 Feb 2024 11:51:35 GMT  
		Size: 1.9 MB (1862687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de43f801da8322c46f866210f2da197ae664bb20db5ac4e72847cca829db6d2d`  
		Last Modified: Thu, 01 Feb 2024 11:51:34 GMT  
