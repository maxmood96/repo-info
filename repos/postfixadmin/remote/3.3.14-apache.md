...
```console
$ docker pull postfixadmin@sha256:c8962686d65e2afcf0fac26589911343a5ce290f71ba0f7e053bd9593719895c
```
...
### `postfixadmin:3.3.14-apache` - linux; amd64
...
### `postfixadmin:3.3.14-apache` - unknown; unknown
...
### `postfixadmin:3.3.14-apache` - linux; arm variant v5
...
### `postfixadmin:3.3.14-apache` - linux; arm variant v7
...
### `postfixadmin:3.3.14-apache` - linux; arm64 variant v8
...
### `postfixadmin:3.3.14-apache` - linux; 386
...
### `postfixadmin:3.3.14-apache` - linux; ppc64le
...
### `postfixadmin:3.3.14-apache` - linux; s390x
