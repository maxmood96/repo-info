...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/c/cracklib-2.9.6-27.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/c/cyrus-sasl-2.1.27-21.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/gawk-5.1.0-6.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/gmp-6.2.0-13.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/gnupg2-2.3.3-4.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/gpgme-1.15.1-6.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/grep-3.6-5.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/g/gzip-1.12-1.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/h/hostname-3.23-6.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/j/json-c-0.14-11.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/k/keyutils-1.6.3-1.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libassuan-2.5.5-3.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/a/attr-2.5.1-3.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libcap-ng-0.8.2-7.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libcomps-0.1.18-1.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libffi-3.4.2-8.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libgpg-error-1.42-5.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libidn2-2.3.0-7.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libmodulemd-2.13.0-2.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libpwquality-1.4.4-8.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libreport-2.15.2-6.el9.rocky.0.2.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libsigsegv-2.13-4.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libunistring-0.9.10-15.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libusbx-1.0.26-1.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libutempter-1.2.1-6.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libverto-0.3.2-3.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libxcrypt-4.4.18-3.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/libyaml-0.2.5-7.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/lua-5.4.4-4.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/l/lz4-1.9.3-5.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/m/mpfr-4.1.0-7.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/n/npth-1.6-8.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/p/passwd-0.80-12.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/p/popt-1.18-8.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/r/readline-8.1-4.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/s/sed-4.8-9.el9.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/x/xz-5.2.5-8.el9_0.src.rpm
```
...
http://mirrors.egr.msu.edu/rockylinux/9.7/BaseOS/source/tree/Packages/z/zlib-1.2.11-40.el9.src.rpm
```
