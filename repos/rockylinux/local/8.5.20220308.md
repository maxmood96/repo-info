...
http://la.mirrors.clouvider.net/rocky/8.6/BaseOS/source/tree/Packages/c/curl-7.61.1-22.el8.src.rpm
```
...
http://la.mirrors.clouvider.net/rocky/8.6/BaseOS/source/tree/Packages/l/libgcrypt-1.8.5-6.el8.src.rpm
```
...
http://la.mirrors.clouvider.net/rocky/8.6/BaseOS/source/tree/Packages/x/xz-5.2.4-3.el8.1.src.rpm
```
