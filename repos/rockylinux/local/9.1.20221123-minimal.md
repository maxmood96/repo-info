...
- Created: `2022-12-19T23:20:16.981964637Z`
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/a/audit-3.0.7-103.el9.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/b/bash-5.1.8-5.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url ca-certificates-2022.2.54-90.2.el9.noarch
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/c/ca-certificates-2022.2.54-90.2.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/c/coreutils-8.32-32.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/c/crypto-policies-20220815-1.git0fbe86f.el9.src.rpm
```

### `rpm` package: `curl-7.76.1-19.el9.x86_64`
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/c/curl-7.76.1-19.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url dnf-data-4.12.0-4.el9.noarch
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/d/dnf-4.12.0-4.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/f/file-5.39-10.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/g/glibc-2.34-40.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/g/gnupg2-2.3.3-2.el9_0.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/g/gnutls-3.7.6-12.el9_0.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libarchive-3.5.3-3.el9.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/u/util-linux-2.37.4-9.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/e/e2fsprogs-1.46.5-3.el9.src.rpm
```

### `rpm` package: `libcurl-7.76.1-19.el9.x86_64`
...
### `rpm` package: `libdnf-0.67.0-3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.67.0-3.el9
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libdnf-0.67.0-3.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libevent-2.1.12-6.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/g/gcc-11.3.1-2.1.el9.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libgcrypt-1.10.0-8.el9_0.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libksba-1.5.1-5.el9_0.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/librepo-1.14.2-3.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libselinux-3.4-3.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libsepol-3.4-1.1.el9.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libsolv-0.7.22-1.el9.src.rpm
```
...
### `rpm` package: `libstdc++-11.3.1-2.1.el9.x86_64`
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/libxml2-2.9.13-2.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/l/lua-5.4.2-4.el9_0.3.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/n/nettle-3.8-3.el9_0.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/o/openldap-2.6.2-3.el9.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/o/openssl-3.0.1-43.el9_0.src.rpm
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/p/pcre2-10.40-2.el9.src.rpm
...
### `rpm` package: `rocky-gpg-keys-9.1-1.10.el9.noarch`

Licenses (from `rpm --query`): BSD-3-Clause

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `rocky-release-9.1-1.10.el9.noarch`

Licenses (from `rpm --query`): BSD-3-Clause

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `rocky-repos-9.1-1.10.el9.noarch`
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/r/rpm-4.16.1.3-19.el9_1.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/s/setup-2.13.7-7.el9.src.rpm
```
...
https://mirror2.sandyriver.net/pub/rocky/9.1/BaseOS/source/tree/Packages/z/zlib-1.2.11-34.el9.src.rpm
