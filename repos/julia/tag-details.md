...
```console
$ docker pull julia@sha256:bcb280de4b4609458bbd381098c623afa7fc3c1f5773a4a6bc6cb16234744e66
```
...
```console
$ docker pull julia@sha256:9da5db3839fd6a8fa017074b7db77df1f7708278c3612b669aa0d2a2f76040ac
```
