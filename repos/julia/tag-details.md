...
```console
$ docker pull julia@sha256:15d2451f72959aa8a688f98dcddba7eb14dd18bce7a694abc442aab90ea73ed9
```
...
```console
$ docker pull julia@sha256:6c76c0ec475ecf058f735154be6eea8adda618fb9b32b30758635abf51ca3802
```
