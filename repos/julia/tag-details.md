...
```console
$ docker pull julia@sha256:4cc50ce16ec852d1d2320656fa0e22a16d4bd08359490e21136ffa1b3b8b1ded
```
...
### `julia:1.10.3-alpine3.20` - linux; amd64
...
### `julia:1.10.3-alpine3.20` - unknown; unknown
...
```console
$ docker pull julia@sha256:097758543d1ebf4a58522a1f1f435ba7b8367eb1cf3738b55bcff4a6edc451b3
```
