...
```console
$ docker pull julia@sha256:95c518edf021e7b4672c198fe790a67129efe357fa67391747b739ad24bd6f9b
```
...
```console
$ docker pull julia@sha256:dc484ed1dc638a6be8db82ecf5de499c4f7498d7b8a429bd161b14dbdcc275bd
```
