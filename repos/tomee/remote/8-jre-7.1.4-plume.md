...
```console
$ docker pull tomee@sha256:ed52a087fa4ba9505eca2c60baeb7653d5cc96b66fba9283ca795fa8e747908a
```
...
```console
$ docker pull tomee@sha256:a92122b320c77a71d8440d1430c177221fb51fbf02dcdd4889cc1d0cf6a89358
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183313022 bytes)**  
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:307fbdd25bea63c942bc41f9b10c92cab9bcb44f0d098e9f7882cec10e99a207`  
		Last Modified: Tue, 12 Jul 2022 20:08:15 GMT  
		Size: 65.2 MB (65176948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre-7.1.4-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:ad91d835ab1049d83f0038a13203cc101169af0547013601d2e5731ffa9f11e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.0 MB (180995345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0b29e1da07b78b7c30ca9be697da2534faf2912891fc6990ee552aef454489c`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_BUILD=plume
# Tue, 12 Jul 2022 20:10:26 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:10:27 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:10:28 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33458f47883581223029c6fa6e347d697566a1ed12b046eb070590aedded3a56`  
		Last Modified: Tue, 12 Jul 2022 20:47:16 GMT  
		Size: 65.2 MB (65176416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
