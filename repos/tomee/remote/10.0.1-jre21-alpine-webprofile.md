...
### `tomee:10.0.1-jre21-alpine-webprofile` - linux; amd64
...
### `tomee:10.0.1-jre21-alpine-webprofile` - unknown; unknown
...
### `tomee:10.0.1-jre21-alpine-webprofile` - linux; arm64 variant v8
