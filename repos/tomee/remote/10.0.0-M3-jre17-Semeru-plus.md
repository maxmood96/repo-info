...
### `tomee:10.0.0-M3-jre17-Semeru-plus` - linux; amd64
...
### `tomee:10.0.0-M3-jre17-Semeru-plus` - unknown; unknown
...
### `tomee:10.0.0-M3-jre17-Semeru-plus` - linux; arm64 variant v8
