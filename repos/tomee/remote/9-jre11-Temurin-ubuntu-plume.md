...
```console
$ docker pull tomee@sha256:c035a0da40072193f7fa7b2ce8f87e5f5f19694f47e37a81d8c8bcbff338deff
```
...
```console
$ docker pull tomee@sha256:b588b999e76ac5fc177b459003702bc7b65dac1ce6bf2fbee0c98a9e97035c09
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170758849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc855f48e57205da6d253de8f35b5ed8042c36059b4420c8287e618306863775`
...
# Thu, 28 Jul 2022 17:46:38 GMT
ENV TOMEE_BUILD=plume
# Thu, 28 Jul 2022 17:46:47 GMT
...
-	Layers:
	...
	-	`sha256:3045458856b6031aa376ef8e1ad324e702c15d5ab7cbf26bdaca2efa2a9ce7d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cd46fa5ca85aad6fa2d68b9b02b1804e04094b6a7cd1deff7570d8701528120`  
		Last Modified: Thu, 28 Jul 2022 18:34:36 GMT  
		Size: 78.7 MB (78688592 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Temurin-ubuntu-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:02a63569a8aa25e788044c6ce05159f4de60d47e5ecf47ec832e4e0094c7b48f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167314329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebaf9ea734bd6a0ff91e14d2a2fb9e47088bc75e9ce965bc77bd2bda69a4c03a`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M8
# Thu, 28 Jul 2022 18:41:33 GMT
ENV TOMEE_BUILD=plume
# Thu, 28 Jul 2022 18:41:42 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 28 Jul 2022 18:41:43 GMT
EXPOSE 8080
# Thu, 28 Jul 2022 18:41:43 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:827b5fbc46d7672ff95b86f7b249ab692c508f79cd9695af43b6dd2b3e6b6a78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d271106d0c13d749747791137b04fb954cfdfa68739ca49c56ea31795be2754`  
		Last Modified: Thu, 28 Jul 2022 19:34:09 GMT  
		Size: 78.7 MB (78688023 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
