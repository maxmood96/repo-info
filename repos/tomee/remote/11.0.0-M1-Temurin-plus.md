...
### `tomee:11.0.0-M1-Temurin-plus` - linux; amd64
...
### `tomee:11.0.0-M1-Temurin-plus` - unknown; unknown
...
### `tomee:11.0.0-M1-Temurin-plus` - linux; arm64 variant v8
