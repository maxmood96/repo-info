...
```console
$ docker pull tomee@sha256:36fcca9c8dcbac0a7d76c6c896848b41e1a0e1cdd8ce2c6bf611503968232d54
```
...
### `tomee:9.1-jre11-Semeru-ubuntu-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:3c76d18560118e7049f4876dc7b55d142ec5586f2203609e177fba5dbdfb5231
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167286095 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bf3092456a1f82519269a00a74d602bf195d1b838adb81787c3058d4904205e`
...
# Fri, 02 Feb 2024 14:16:18 GMT
ENV TOMEE_VER=9.1.2
# Fri, 02 Feb 2024 14:16:32 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 02 Feb 2024 14:16:38 GMT
...
-	Layers:
	...
	-	`sha256:fe9bbf1c2cc048dfe156c017bfb82e44474089ba8ebc099a15c31efd3f807919`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7bdf6d219bfb27da912d153f56788961f0a1bddb8fb32f158ec109e1e167286`  
		Last Modified: Fri, 02 Feb 2024 14:53:14 GMT  
		Size: 68.7 MB (68711101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1-jre11-Semeru-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:8a37efb51455e2576b75c1701b90f2473c4b2e3f8f8e0d8c592d1e9c89ceee11
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164196720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89bff29e6e16cd4e395b2a4eb5110acf0fdd6340704c70a6067b27d8f50806b5`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 14 Feb 2024 21:14:49 GMT
ENV TOMEE_VER=9.1.2
# Wed, 14 Feb 2024 21:14:58 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 14 Feb 2024 21:15:05 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 14 Feb 2024 21:15:05 GMT
EXPOSE 8080
# Wed, 14 Feb 2024 21:15:05 GMT
...
-	Layers:
	...
	-	`sha256:bff16f77989bba5e10f9b991d172d18e57baf386506f742a502887544e90e72e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:664d0a67ff23c4ccf8de8c955035a1d86483a3a79d47da49abdba82fa23478fd`  
		Last Modified: Wed, 14 Feb 2024 21:29:56 GMT  
		Size: 68.7 MB (68711196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
