...
### `tomee:10.0-jre21-ubuntu-plus` - linux; amd64
...
### `tomee:10.0-jre21-ubuntu-plus` - unknown; unknown
...
### `tomee:10.0-jre21-ubuntu-plus` - linux; arm64 variant v8
