...
### `tomee:10.0-jre11-Temurin-plus` - linux; amd64
...
### `tomee:10.0-jre11-Temurin-plus` - unknown; unknown
...
### `tomee:10.0-jre11-Temurin-plus` - linux; arm64 variant v8
