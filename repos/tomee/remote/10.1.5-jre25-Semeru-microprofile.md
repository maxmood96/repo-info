...
### `tomee:10.1.5-jre25-Semeru-microprofile` - linux; amd64
...
### `tomee:10.1.5-jre25-Semeru-microprofile` - unknown; unknown
...
### `tomee:10.1.5-jre25-Semeru-microprofile` - linux; arm64 variant v8
