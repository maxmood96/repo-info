...
### `tomee:10.0.0-jre21-Temurin-alpine` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-alpine` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-alpine` - linux; arm64 variant v8
