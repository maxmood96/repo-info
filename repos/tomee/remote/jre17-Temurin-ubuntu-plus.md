...
```console
$ docker pull tomee@sha256:0bb50956be2173d87e8610b1efd7bfb78ef2fa8ee7f84c17671cba5d4eb98bbb
```
...
```console
$ docker pull tomee@sha256:0f85966ddc20bccc3f99cc080dfc3bf5dab943aae8489723a0759d72e581b01e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.8 MB (166752483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdc4d5452bb9176dac29ad85d7307e7ec65ef82792cf1e17ae2d8626fd3e7c56`
...
# Fri, 26 Apr 2024 04:10:37 GMT
ENV TOMEE_VER=9.1.3
# Fri, 26 Apr 2024 04:11:01 GMT
ENV TOMEE_BUILD=plus
# Fri, 26 Apr 2024 04:11:09 GMT
...
-	Layers:
	...
	-	`sha256:9a2107a647c2ce5aa1513cd426d0d9c2d31a1436ebf3f1a64b43af861f362f9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1316ac093d10b771feb5a270d78736f24b16eb956125b7dca9a86f29ff2cdd7`  
		Last Modified: Fri, 26 Apr 2024 04:27:58 GMT  
		Size: 73.5 MB (73482190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre17-Temurin-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:cc538bb0f451791cc29b5ad3e18a9507bc413dc017ec6500883458bbe9a72126
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.1 MB (164100416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d5c3c9652a543ab9a74e707a037b9331ca11d383a772d45c655f595db350174`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.3
# Fri, 26 Apr 2024 03:38:04 GMT
ENV TOMEE_BUILD=plus
# Fri, 26 Apr 2024 03:38:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 26 Apr 2024 03:38:12 GMT
EXPOSE 8080
# Fri, 26 Apr 2024 03:38:12 GMT
...
-	Layers:
	...
	-	`sha256:c5dc82f4983aaf6920ad1a5bc7ce921e515d4009392151dcf479672f63fa1d72`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bfcf3a931037dbd9a7919dcc25f343b93b713c3672a837c555589c1a04768b8`  
		Last Modified: Fri, 26 Apr 2024 03:51:45 GMT  
		Size: 73.5 MB (73482153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
