...
```console
$ docker pull tomee@sha256:f007b8c865e26e18d7c9eb2e0add13866d6b352c5ed8a1963dc534787eb01d33
```
...
```console
$ docker pull tomee@sha256:24e250f0b99f2564b2f0172579a9eab9ab5526dab4d95495ee8b1f4389bdc818
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.1 MB (178133293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67c480dc88e1f04b65f1ccd0722b3986dacbb46187c9922ebf29bff778c8c8e6`
...
ENV TOMEE_VER=9.1.0
# Thu, 31 Aug 2023 21:52:21 GMT
ENV TOMEE_BUILD=plume
# Thu, 31 Aug 2023 21:52:31 GMT
...
-	Layers:
	...
	-	`sha256:49a77cae0303e5eb290e23d90958e8a163b92645521b2ad699b996e40567e578`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e51b5a4a4110c279f2f61931f8e5e800f2e4fe5a37d150ff22926a25958a4e91`  
		Last Modified: Thu, 31 Aug 2023 22:23:30 GMT  
...
```console
$ docker pull tomee@sha256:f7ab9ab4d4f9d1af79c30f086012ec55f0c0fff986c87a36215e8dbbfe96a590
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174341407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aef6f7e8ac2e80064c8e6381d76517a1faa17d2208ad9887c421af03d7fb002`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 16 Aug 2023 17:39:29 GMT
ENV TOMEE_VER=9.1.0
# Wed, 16 Aug 2023 17:39:49 GMT
ENV TOMEE_BUILD=plume
# Wed, 16 Aug 2023 17:39:57 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 16 Aug 2023 17:39:57 GMT
EXPOSE 8080
# Wed, 16 Aug 2023 17:39:57 GMT
...
-	Layers:
	...
	-	`sha256:a683e0116564d6117cea106e8f4410cfe1eec6be5eb4519b438acd377ebddabd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c269326d4ff0aca8ca3836483b6e8ed5fb87e7bdf428b8e46e6afbdbf5c5e75`  
		Last Modified: Wed, 16 Aug 2023 17:55:12 GMT  
		Size: 85.3 MB (85266302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
