...
### `tomee:11.0.0-M1-jre21-ubuntu-plus` - linux; amd64
...
### `tomee:11.0.0-M1-jre21-ubuntu-plus` - unknown; unknown
...
### `tomee:11.0.0-M1-jre21-ubuntu-plus` - linux; arm64 variant v8
