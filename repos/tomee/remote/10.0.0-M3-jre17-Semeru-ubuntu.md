...
### `tomee:10.0.0-M3-jre17-Semeru-ubuntu` - linux; amd64
...
### `tomee:10.0.0-M3-jre17-Semeru-ubuntu` - unknown; unknown
...
### `tomee:10.0.0-M3-jre17-Semeru-ubuntu` - linux; arm64 variant v8
