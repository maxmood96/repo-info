...
### `tomee:10.0.0-M3-jre17-Semeru-webprofile` - linux; amd64
...
### `tomee:10.0.0-M3-jre17-Semeru-webprofile` - unknown; unknown
...
### `tomee:10.0.0-M3-jre17-Semeru-webprofile` - linux; arm64 variant v8
