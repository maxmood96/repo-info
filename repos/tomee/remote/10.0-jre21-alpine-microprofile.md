...
### `tomee:10.0-jre21-alpine-microprofile` - linux; amd64
...
### `tomee:10.0-jre21-alpine-microprofile` - unknown; unknown
...
### `tomee:10.0-jre21-alpine-microprofile` - linux; arm64 variant v8
