...
### `tomee:10.1.3-jre21-webprofile` - linux; amd64
...
### `tomee:10.1.3-jre21-webprofile` - unknown; unknown
...
### `tomee:10.1.3-jre21-webprofile` - linux; arm64 variant v8
