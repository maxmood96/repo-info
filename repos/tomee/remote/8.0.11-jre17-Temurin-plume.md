...
```console
$ docker pull tomee@sha256:490a01f38b10fb5c72808c70cacdaf6ba0409588655a44267596d8eff4ec43bf
```
...
### `tomee:8.0.11-jre17-Temurin-plume` - linux; amd64

```console
$ docker pull tomee@sha256:5e6c1f058fb976a12a5cbe1f0a4af7f00b41bdbcf2f5f0ffe6db616d9d182a19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.7 MB (176717214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c597bd6d6ab3a1178228d777f3acc9cbfa5b794f565a8a3d9eb90323e363003`
...
# Tue, 07 Jun 2022 05:11:07 GMT
ENV TOMEE_BUILD=plume
# Tue, 07 Jun 2022 05:11:15 GMT
...
-	Layers:
	...
	-	`sha256:2024ed319db54955606f82a59f3fa9bc2ecc33041e08ce892b7f570543b95dd6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0695f9451a0c8ef6daa2b183ecf12b520c1ddc786719ffccbe0af2052a87dfdd`  
		Last Modified: Tue, 07 Jun 2022 05:40:24 GMT  
		Size: 77.8 MB (77806331 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre17-Temurin-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:f1cae2c0d7602d164fce26f95cfd1ffab60f3dd6ebc16daf1c133347b6356eb8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175232705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70cf148ab2e2f65604e610f6102c004ec601685ab871cf307a99f5839e48c16f`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 07 Jun 2022 08:28:06 GMT
ENV TOMEE_BUILD=plume
# Tue, 07 Jun 2022 08:28:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 07 Jun 2022 08:28:13 GMT
EXPOSE 8080
# Tue, 07 Jun 2022 08:28:14 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:10becc5c9b8120299bcd09601a48cbbee128533e5e49165824c4fcf17a910bbf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c495d0d386e1b6f805238554eaed279fb83e6974f71bd1d19279374227427f1e`  
		Last Modified: Tue, 07 Jun 2022 09:13:14 GMT  
		Size: 77.8 MB (77805871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
