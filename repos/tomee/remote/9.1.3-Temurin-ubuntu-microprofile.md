...
```console
$ docker pull tomee@sha256:4687a1222cef9e1f2b327da00c2ed81f7a2491d8c32f6dad58d2cbcd6d565866
```
...
```console
$ docker pull tomee@sha256:38dbf346b74c8b8101909c8f73e30f76a3e15956657173531fc0d50665a12e12
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (157030689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cb89785c4966830132b6ce61376b817c3606af1ee942d3e4b5c15d2427dc4aa`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:7a73bbf244d11c785923f155665c9b140d06626724c05dca4cc4ddff3dac6a49`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cfd08f8131bed37edd97ab730aed5b1bef42bb56b64d65c7562c5d809a6b8c01`  
...
```console
$ docker pull tomee@sha256:458371fc59552df7dadf77d3303659fb4e981067df2d8934332905419508ba84
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3881233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:436ed55e0d426e9d3dc735bdc7d599c8899e32e8a7f1d57f7b296522a24ecb5d`

```dockerfile
```

-	Layers:
	-	`sha256:9319a6d037599b81e4e2537df5cce4b7c425cc751bac322baa3745781addb1e2`  
		Last Modified: Wed, 03 Jul 2024 01:01:12 GMT  
		Size: 3.8 MB (3835725 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:deef4e83f6cfb1e9ed032304a4a3185ebd782a4e87ca91debe89545a2660a7c1`  
		Last Modified: Wed, 03 Jul 2024 01:01:11 GMT  
