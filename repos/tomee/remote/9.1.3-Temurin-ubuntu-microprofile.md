...
```console
$ docker pull tomee@sha256:8054c85683259a5ff6e9617419d4080b760f9c9ddce27d5d4227d8e9dc49e388
```
...
```console
$ docker pull tomee@sha256:8c6e2742ed6058d9c1f9ca22d9080af6f120384f9bf4e7d7e997ae350e9d60bc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (157030286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb64872528e8cf670c95c803b384253a93faaecbbd35c470b1f5544808ff7979`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:113056414c6ac224e0827f01bb358c9fb5ea2e1b4201eb29adb397887e423856`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8e85412b232ac259566ac8e7b267bfb2d217024094956b62d0dce4a3ed9008fd`  
		Last Modified: Tue, 17 Sep 2024 06:54:00 GMT  
...
```console
$ docker pull tomee@sha256:0eb86c47ef71525a78f507b222d707e67778832051d53244aaca03e5177ffa83
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3948236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bdcce92124e89319488834324a57de0df88469a01b3d71e3e91e6a27e8a94f9`

```dockerfile
```

-	Layers:
	-	`sha256:ea6c094a5ed760109056dbc5c1106cc6eab0d73cd68cf183b6330f4d3cf4f4d8`  
		Last Modified: Tue, 17 Sep 2024 06:53:58 GMT  
		Size: 3.9 MB (3902722 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e1a7ea8c436a23b985c7d05a0f1018fc9d784e383e8f7cda05f88eda63c5eb47`  
		Last Modified: Tue, 17 Sep 2024 06:53:58 GMT  
