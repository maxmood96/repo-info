...
```console
$ docker pull tomee@sha256:6b8dc63791ab92b7a4065a86698a2d449ff5250263dd07654052b283e2f13e94
```
...
```console
$ docker pull tomee@sha256:7317a97e643154c154d88b8fc00fceffdae8cf8e524256110a720fee782b762b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168361624 bytes)**  
...
# Thu, 02 Mar 2023 11:16:46 GMT
ENV TOMEE_BUILD=plume
# Thu, 02 Mar 2023 11:16:54 GMT
...
-	Layers:
	...
	-	`sha256:6136bf792fbbfa5dd389b81d7a7f93a96e816468c7d27a44bd6238b57786bfbc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:614fa6a3db7587a89f1a088f42b63eb5a865db3840963f4af1a18cfdcc6fb32c`  
		Last Modified: Thu, 02 Mar 2023 11:49:18 GMT  
		Size: 77.9 MB (77891877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre8-Temurin-ubuntu-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:7462449faa39ea2b7bb388ee1c5bff364ebf1c0508749e8c9b8e3a1f4b7ae2b1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165823041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:547612400b6eb125d72e3d77b9ad1141e07615048751dc1af939687560fbd605`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.14
# Thu, 16 Mar 2023 06:53:25 GMT
ENV TOMEE_BUILD=plume
# Thu, 16 Mar 2023 06:53:33 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 16 Mar 2023 06:53:33 GMT
EXPOSE 8080
# Thu, 16 Mar 2023 06:53:33 GMT
...
-	Layers:
	...
	-	`sha256:6183322799d293c72ff6fcdfdc471cecd927639a07a591f3765ccb0d1e2bae41`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f832b538fc5daf46f7addb4a42e75b31bcfda57dbf7b5343ff07e1a654342980`  
