...
```console
$ docker pull tomee@sha256:5eb6413a72ceb6f0bc967516f5294bcfa4ea398e7a38d8f0c98a17e71ada577c
```
...
```console
$ docker pull tomee@sha256:abf3011694a287c288435440d7471418009138fd950589741d0cc39d3f02333f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145609185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a302e93b34ff9a5bac8f6cdb3de307b6b13cf01dfda9118feb2351dc09b04a1`
...
-	Layers:
	...
	-	`sha256:cfb3eda915bfdbfacde75c6fd801af643e3a6128f8b464b8990604234d5ad4f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c5194600858e25d6e56303cce43126ea89a50a1590a09884eeb9ae8fe3d736c`  
		Last Modified: Tue, 24 May 2022 18:04:10 GMT  
		Size: 46.7 MB (46706868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Temurin-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:11fe12a639d9600c57318d72cb011a845397d92f77fdf60c0ece750c6ba62872
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144109222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b46fe8a683b962c3e93269c09bff2590a26063357e6b9d49c1e2426d7707171b`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:44:35 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 24 May 2022 17:44:41 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:44:41 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:44:42 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f17c860bf52d044cbcecddd05b568b319f9d07329e5e44c5fb1653c1e9d4a100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d364eb911f087de6c3fe4880284093ed3139d317f84390968db5af4cebe8379c`  
		Last Modified: Tue, 24 May 2022 18:36:13 GMT  
