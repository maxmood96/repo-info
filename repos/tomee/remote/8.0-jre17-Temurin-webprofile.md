...
```console
$ docker pull tomee@sha256:ed14660b044af8df5776246bf9efc1646d61042e2ab4c0161cf6273a4f97d9d0
```
...
```console
$ docker pull tomee@sha256:b3dcbd29f68b34031d0b3360d444057e5010550cc40876966cc062013f6fd9e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143922083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8529cbe0b3145b08ac46e2feec5274e86d2bae6345a9a0d6974612b3c247179c`
...
-	Layers:
	...
	-	`sha256:4272e119832a0f87f56ab8ce3fff1c21cb33ccd046cedc4835b1a18d02cdaa3e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89d05e35b31ea352bebe3c4b7a4c79966cbdf9591a845ea524053b0f7436d87c`  
		Last Modified: Tue, 16 Apr 2024 09:44:32 GMT  
...
```console
$ docker pull tomee@sha256:88f2b6deea8726370057753d7f86f1b52f16dafbda4def54986b63ac5b0b8b80
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141869901 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6e3891dd71e0a94adc69e0fe207052d0dcdb891c22e42bd43bcee0098f05f86`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 16 Apr 2024 08:01:02 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 16 Apr 2024 08:01:07 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 16 Apr 2024 08:01:08 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 08:01:08 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dcf52f4b7615e09e59ebe6807f29a583929216e5db1811561d5827661c7a2226`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90fcf7c3b6b52a213301c6e168f5357a5ac4286c963b9a7160b23b39b974e252`  
		Last Modified: Tue, 16 Apr 2024 08:10:57 GMT  
