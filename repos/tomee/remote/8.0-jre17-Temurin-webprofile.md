...
```console
$ docker pull tomee@sha256:5a227026e23f0e37986b57cdeda4e5bce9417b965f5b36a489504fef4a04ed57
```
...
### `tomee:8.0-jre17-Temurin-webprofile` - linux; amd64

```console
$ docker pull tomee@sha256:ca582c407fdf5debcda00e69dba4c9fd332cfca490225f935c11c0fee3a20ea7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.7 MB (147668723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94c3d9715fabf85ad78add28657675cb1ac38f9998de347a7b25fe1d1c386316`
...
-	Layers:
	...
	-	`sha256:6595fdf37ffdabb200fa5489a2dabb575b94e902ea8c17a68bd1c669b44e4908`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d94eff3b2eed2f77267f75556a30a04e88f088ab7a596a3ac5c8103903c08d9`  
		Last Modified: Tue, 08 Aug 2023 22:03:21 GMT  
		Size: 49.0 MB (48953474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Temurin-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:a51bdc4d8a2d19e7385a81fd626585443243b6f2413bbb5b7e5a64739945dc62
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.5 MB (146452854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cbe6482588759d1cb6ec0d2697ea4ec012dba5ee0fa461ac63d4c9782d4b9bc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 08 Aug 2023 22:09:46 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 08 Aug 2023 22:09:51 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 08 Aug 2023 22:09:52 GMT
EXPOSE 8080
# Tue, 08 Aug 2023 22:09:52 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6f3c0813d32aceef3db6d1bffad052fe32144754dd83821760e20902f79d6048`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0c1d62b91208c76b5876b1fc0231c8805206bd22cdd22180bd79107ee16b11f`  
