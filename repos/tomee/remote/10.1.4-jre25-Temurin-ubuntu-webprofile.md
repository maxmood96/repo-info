...
```console
$ docker pull tomee@sha256:5edcb6b04b6faab3bc1e799769ba7faf2319c663bd5ad697d7a573e2592bd67e
```
...
### `tomee:10.1.4-jre25-Temurin-ubuntu-webprofile` - linux; amd64
...
### `tomee:10.1.4-jre25-Temurin-ubuntu-webprofile` - unknown; unknown
...
### `tomee:10.1.4-jre25-Temurin-ubuntu-webprofile` - linux; arm64 variant v8
