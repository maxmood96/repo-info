...
```console
$ docker pull tomee@sha256:a0770f38c5f056e1cec62bbb8dbfaf021197ab4c1376e14b71d6ee15341f12a8
```
...
```console
$ docker pull tomee@sha256:e5d7fc95e71d7f75cba4c9e1d46576484676bb42f9d1d3309fa312239ccd70ce
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165571412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:549d18d4d1d12f85b7c46ac17b2177e01647bb88d4abe4053be31acee3f4c0c5`
...
# Wed, 24 Aug 2022 01:28:25 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 24 Aug 2022 01:28:32 GMT
...
-	Layers:
	...
	-	`sha256:386158b4f0dd0154655678f73e7701491cfe87c34f13c95e8b9b491cec0b6be0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a8c2233151d1c1838b252d448524d3ea34e094ea727a645d19a384510a26c92`  
		Last Modified: Wed, 24 Aug 2022 01:55:26 GMT  
...
```console
$ docker pull tomee@sha256:770fd3fb0781be0f33ed817b1f1d207b6691d5fab1027e4b1ef61bcb7d60afbe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161765983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9abd676ca0125e4fb4490cc6a4137d06459ddcba18c48dacaeba10908e224c47`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 10 Aug 2022 22:57:14 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 10 Aug 2022 22:57:21 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 10 Aug 2022 22:57:22 GMT
EXPOSE 8080
# Wed, 10 Aug 2022 22:57:23 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3d46d034af4933bf0f92f2fc9724b29f4d69d77f08303f0228e2bda0a3d90130`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4549eb273f6be7e090e5fa7ae478eadf01ecd4d6bc3b72fa7b318feaafa53d0`  
		Last Modified: Wed, 10 Aug 2022 23:38:51 GMT  
		Size: 65.0 MB (65006861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
