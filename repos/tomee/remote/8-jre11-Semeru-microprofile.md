...
```console
$ docker pull tomee@sha256:d7aafac88bd1783dbc858c8910eac67b1b1f1cf7d87672ddcece5909f2723d51
```
...
```console
$ docker pull tomee@sha256:e9105c9b5022a7c4deefac3cce5d0294c9e45e63c14308c6cceb286046bd8887
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.6 MB (164615338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e6b08ba89f4d27730f196a0096e3d00a0106ced950d191fa25212c20eb9588e`
...
# Wed, 01 Feb 2023 22:33:12 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 01 Feb 2023 22:33:19 GMT
...
-	Layers:
	...
	-	`sha256:08904eade7d07bea16db85ef6976d399b72aea30042a9b34f28def26a9465a77`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2dfff4430a20a66b9c92a9b67a9ea951c00e9abd0e4b0a7bc5d2e5ec2a8060f`  
		Last Modified: Wed, 01 Feb 2023 23:06:43 GMT  
		Size: 63.9 MB (63926281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Semeru-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:c5f5070b5fd815208dbd007a686133d38e18ff0fc7e8785ccfeeba38d871f420
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.1 MB (161071956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1589ea71d0ce316120e78370e338430d0682004ea8bacc83880a0396bcbe296d`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 01 Feb 2023 21:13:29 GMT
ENV TOMEE_VER=8.0.14
# Wed, 01 Feb 2023 21:13:38 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 01 Feb 2023 21:13:45 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 01 Feb 2023 21:13:45 GMT
EXPOSE 8080
# Wed, 01 Feb 2023 21:13:45 GMT
...
-	Layers:
	...
	-	`sha256:da9d531cdc74de55dbc6b37121e684365eb2140e57ea8201f421584e62488c76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad929536c00b9a75f113c9624023b870ff0e2cfacc87fb8bea5337ae838cba01`  
		Last Modified: Wed, 01 Feb 2023 21:41:45 GMT  
		Size: 63.9 MB (63926338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
