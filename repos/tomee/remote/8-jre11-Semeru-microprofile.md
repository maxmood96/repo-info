...
```console
$ docker pull tomee@sha256:e71419ba30ca463620a8358b91b702874650901d69d03ea61a8e15ee01b2f144
```
...
```console
$ docker pull tomee@sha256:3c78326b2f897843bdb000864aa20aaf957d9564a8ccdfa3b21972f20cb31941
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165205648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98cdbdf39cba3e6a031a40df97aab8b7c2539ba81087d9a3c03e27d0300121d3`
...
# Wed, 03 Aug 2022 06:17:56 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 06:18:03 GMT
...
-	Layers:
	...
	-	`sha256:357e57b6e9cdaf2a6484edfe3b3ad8df2feae7a430fc7287b1890cd08bff58b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83d81d77566b26436aa7137525252e546b1c57a96e698571cb4a5d8852dbf5ea`  
		Last Modified: Wed, 03 Aug 2022 07:14:39 GMT  
		Size: 65.0 MB (65007149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Semeru-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:615d0b5a3cecec355bc814bb7a4fa37ff3a307b133575f8294c73857a1fcc4b7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161394591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e835559861fa564be2dbbc389d4fbbfd0a6e126d4d4813cfa415d102f794883d`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:55:12 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 03:55:20 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:55:20 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:55:21 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:62a4538cfa4f8f12902fcff54c49858588874779c97da6c3bfbf64b55e9b191f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37ba4b4d59fc507d87f50905a4d337e16a3aa71b41c5e49317a8e8628ae46ef8`  
		Last Modified: Wed, 03 Aug 2022 05:17:33 GMT  
		Size: 65.0 MB (65006855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
