...
```console
$ docker pull tomee@sha256:09ae4f61601adda8b3b05908c51cb899b769d99e69ac6e9b74f4f2b0acc48ff5
```
...
```console
$ docker pull tomee@sha256:447b4c8a83efcd4da58daa83fe945955674d74c147038cc4ef59178d8d6bbe4c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163410160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f758c5d3ae38eaccf2125968ad6f4d46d4f77e5b2a47ed5da9fe9fcb71c4021`
...
# Sat, 03 Jun 2023 15:27:56 GMT
ENV TOMEE_BUILD=microprofile
# Sat, 03 Jun 2023 15:28:03 GMT
...
-	Layers:
	...
	-	`sha256:a1d863d3973a7d22d3fec0ae2c9a50c70f38b3664e92e39335fabc43fa173e2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4b1831b4d758efa93d70ffaf39f095447141f2c39fca5e3dab2c4bb42cc19fa`  
		Last Modified: Sun, 04 Jun 2023 15:43:34 GMT  
		Size: 63.8 MB (63798754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Semeru-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:21f770af6598e296f31e1e82796b79a3f8c23a66dc240e3b6d4a43e490e9683b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159669835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ddb34ead600521bdc426d879f2d9acd92f7570585b46dd202428e6f857ed747`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 01 Jun 2023 00:34:30 GMT
ENV TOMEE_VER=8.0.15
# Thu, 01 Jun 2023 00:34:39 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 01 Jun 2023 00:34:45 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 01 Jun 2023 00:34:46 GMT
EXPOSE 8080
# Thu, 01 Jun 2023 00:34:46 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:059049a6db670961c0f47b91c8ebcb1a1296a4fadb3365edebc1c95e254ad8a6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4138d25af2fa872c76c0f1eeed4081151056bfff8c4f08b76625b381aa8e960b`  
		Last Modified: Thu, 01 Jun 2023 00:45:44 GMT  
