...
```console
$ docker pull tomee@sha256:8b19927655a4995de4bb677d1666578414e3199c56f09017881f4bdff6b4755f
```
...
```console
$ docker pull tomee@sha256:e149afbf9d1884ba8ddfbe9770a86741500b61b8f9635d3435a648e7427874bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.1 MB (165059822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f3c24653202d3bd40847782956c631c4394ff945b1ee8d942b1885b2b83899e`
...
# Tue, 24 May 2022 17:31:35 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:31:43 GMT
...
-	Layers:
	...
	-	`sha256:2d676fc584e8b40814470a0048d84bd24608b0d3a6ca8c4ad5d0f0b3a56089fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4eec3468dad34f07b64bf730571604bda514fd8172616317764d5c38a4921737`  
		Last Modified: Tue, 24 May 2022 18:32:00 GMT  
		Size: 64.9 MB (64910786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Semeru-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:76a2a94c4cef312252a3338cfb26a157cc834fbf31aac2e80b1c457fa598c9fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161262438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:846807647d3ca97c10429ac1a45cf3ea66998549fa2323fb5216f51649e65e18`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:52:31 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:52:39 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:52:39 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:52:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d93f90e2cd98c9cb80ecb182f3948cb4315b8f4e35a5158640f95663c4a1b4a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e813cff3bc6efb9556b8df0482be9198b6921862427b214836be0d1bb5a19938`  
		Last Modified: Tue, 24 May 2022 18:58:08 GMT  
		Size: 64.9 MB (64910363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
