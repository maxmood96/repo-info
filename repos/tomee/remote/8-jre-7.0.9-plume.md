...
```console
$ docker pull tomee@sha256:a85b153de89d86037ac5e6f7683e9fe3136b935f65d4b524f2368f18e30af864
```
...
```console
$ docker pull tomee@sha256:0d5d45626b84d1075f96a97c80fe45ccd5ac721f03c3b200a253be62a253fa08
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181277174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7e4a3be11db8e9d77b78bc7f61536663221522595e63064ebebae1c572e4201`
...
-	Layers:
	...
	-	`sha256:ea2d194195eb9bca0d12023f813877fbacbb2ba271b22552bdd13e2517eca8df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25563e094eddf32467ad2fce28c270f0cc4c6891168bc18619198a654f54316f`  
		Last Modified: Thu, 23 Jun 2022 23:50:23 GMT  
		Size: 63.1 MB (63132493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre-7.0.9-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:95122ee03079ca4388732e2cc32153465a50f9b9d87ad9d43401c79237a1e9e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.8 MB (178760981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77e5ee976bdcea4964462f421ea057e8a19f5689d198b6813693e8b007dc60a4`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 24 Jun 2022 03:51:20 GMT
ENV TOMEE_VER=7.0.9
# Fri, 24 Jun 2022 03:51:21 GMT
ENV TOMEE_BUILD=plume
# Fri, 24 Jun 2022 03:51:27 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Fri, 24 Jun 2022 03:51:27 GMT
EXPOSE 8080
# Fri, 24 Jun 2022 03:51:28 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9a5817782f9fcaba689dd5d6a4f1cf0c0585d347e521d481b142df6dbfa0feb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24da222a90c89cae6af025b3be8541baeb735469f6e7dc2906de7631a8f091f1`  
		Last Modified: Fri, 24 Jun 2022 04:19:24 GMT  
