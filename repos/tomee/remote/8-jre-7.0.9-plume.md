...
```console
$ docker pull tomee@sha256:d2cc247d7e6acf5a9cfd1377e3c3f156d88269dc836fd9bd085a692f1b5711b4
```
...
```console
$ docker pull tomee@sha256:4f8583557d33e3ef1105f63d18f821b708c857491d2c912f0a572de1154e8672
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181268525 bytes)**  
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3df2f4a15e53671767d9e238dc230ab31d1d24fdb481dd44baa79a7117ff45b4`  
		Last Modified: Tue, 12 Jul 2022 20:07:35 GMT  
		Size: 63.1 MB (63132451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre-7.0.9-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d54905fd2b3bfb35c1e458565fe62e38198322aded50a78ccee0150caeb2f403
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.0 MB (178950902 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c32c38d64bc9c2dde19663daeac92c0b25d18047a53e9ff28abaf200922114cd`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.0.9
# Tue, 12 Jul 2022 20:09:34 GMT
ENV TOMEE_BUILD=plume
# Tue, 12 Jul 2022 20:09:43 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:09:43 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:09:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0038b7ce6517f354757a52a80c05ee848f5b2fafead9f8b7c6b81e5f6b937aa3`  
		Last Modified: Tue, 12 Jul 2022 20:46:30 GMT  
		Size: 63.1 MB (63131973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
