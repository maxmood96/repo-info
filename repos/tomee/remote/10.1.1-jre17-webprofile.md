...
```console
$ docker pull tomee@sha256:325f9b88f292a9eb2f468b4bd6e362d678834de3d047f9491a6321d936403409
```
...
### `tomee:10.1.1-jre17-webprofile` - linux; amd64
...
### `tomee:10.1.1-jre17-webprofile` - unknown; unknown
...
### `tomee:10.1.1-jre17-webprofile` - linux; arm64 variant v8
