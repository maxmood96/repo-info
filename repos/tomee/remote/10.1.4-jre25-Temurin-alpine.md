...
### `tomee:10.1.4-jre25-Temurin-alpine` - linux; amd64
...
### `tomee:10.1.4-jre25-Temurin-alpine` - unknown; unknown
...
### `tomee:10.1.4-jre25-Temurin-alpine` - linux; arm64 variant v8
