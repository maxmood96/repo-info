...
### `tomee:10.0.0-Temurin-alpine-microprofile` - linux; amd64
...
### `tomee:10.0.0-Temurin-alpine-microprofile` - unknown; unknown
...
### `tomee:10.0.0-Temurin-alpine-microprofile` - linux; arm64 variant v8
