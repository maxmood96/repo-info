...
```console
$ docker pull tomee@sha256:b207954557e00dd8b21e7e2afde2b4e558eecb473012e1f396922b01ece3c1c4
```
...
```console
$ docker pull tomee@sha256:1cc3444f2db3c399bc99c96089e557a59e375a5f22778910fca67ecb112d3497
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (174042669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edcb8bdd471ecbf2e3ee8a20d2b062d914af4e1c463b66bc82f67a60478df498`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:07:01 GMT
ENV TOMEE_BUILD=plume
# Wed, 17 Apr 2024 02:07:09 GMT
...
-	Layers:
	...
	-	`sha256:f7dd9f0331c9eee7cc49872f453033add17f946d305ea3d4b51696a3de07b583`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1644b4e8f97f2b589dd8e2f09002a3cae1da76a95046fa37049df66aa5708c6d`  
		Last Modified: Wed, 17 Apr 2024 02:25:43 GMT  
		Size: 81.0 MB (80959043 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1.3-jre11-Temurin-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:237cf1f8880b03a69ca84cd6649f5283f8908d328fa2e155363e5fd8e2941c9a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170259231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a19c295d242a026aaf4b03af2e3dfea00a455aa39c6a9eef5c3ac8ed7a3d8511`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:18:54 GMT
ENV TOMEE_BUILD=plume
# Wed, 17 Apr 2024 02:19:02 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:19:03 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:19:03 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f64c8b56a536742c45f2207ee4608e7416985c2ecc62e3c23da61633a666019a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9363f8020ff88888b97fd66b0980479802be7c2734cc4b5215f82648838ac22`  
		Last Modified: Wed, 17 Apr 2024 02:32:10 GMT  
		Size: 81.0 MB (80959068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
