...
```console
$ docker pull tomee@sha256:e3c93a424fba02f47d7f3097722dbfea9929fc9558d1f139383ba468029073d8
```
...
```console
$ docker pull tomee@sha256:7f1a1b2866c94659643f964918cec36c23cf69844db73e32d1f0f00285474f54
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.8 MB (179826434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:893dfc1facbf6c49df21653e496dde749e5c2fc490a3d9e6343a0647735b0225`
...
# Wed, 17 Apr 2024 02:13:26 GMT
ENV TOMEE_BUILD=plume
# Wed, 17 Apr 2024 02:13:34 GMT
...
-	Layers:
	...
	-	`sha256:865caa1b725d5037c6fcdaaedaf20f5d422c839a67aa9338073abd0f0213164c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f844477caaeafd2ee6c268d5500483cddcc918e51dcfe996ac8d3da98f54330`  
		Last Modified: Wed, 17 Apr 2024 02:52:43 GMT  
		Size: 81.2 MB (81224470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:10.0.0-M1-Semeru-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:b8ecc8826b9d9afc733dc5f602cbf3ea5e5fa21b4baf7e6978a543d82e5d2e1b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.7 MB (176742341 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68894f85fbf331f5c30592caf12b548c5c0e9caba197a4c9a7c8337618d54652`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Wed, 17 Apr 2024 02:22:35 GMT
ENV TOMEE_BUILD=plume
# Wed, 17 Apr 2024 02:22:43 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:22:44 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:22:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5e299225fb1346fb4d387e0035ed922c8b2e555df753ffebfdd752c0dd325b3e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58902ca31a42b5130493c38a3254de2387c1211cbbd53e6b23c1f43baceca4e4`  
		Last Modified: Wed, 17 Apr 2024 02:50:50 GMT  
		Size: 81.2 MB (81224464 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
