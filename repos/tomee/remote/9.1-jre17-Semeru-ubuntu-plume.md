...
```console
$ docker pull tomee@sha256:f8857018e8457bfeb38325375725e6cc72d42b3653bacf7c13b3347417ba8924
```
...
```console
$ docker pull tomee@sha256:789d18ff71ba3f5ac96b928f289500be32b987fbc44a09b610715d3b5ca04f6f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.7 MB (183691151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fae5ee74dd6a2b7cfd0a61066e0100d611dab09e90b615e232427f26e016a8a4`
...
# Wed, 06 Mar 2024 08:13:16 GMT
ENV TOMEE_VER=9.1.2
# Wed, 06 Mar 2024 08:13:40 GMT
ENV TOMEE_BUILD=plume
# Wed, 06 Mar 2024 08:13:48 GMT
...
-	Layers:
	...
	-	`sha256:18fab1a9a5963e3f92929943730a217f99bc30569af047db7702a13d7d5e9882`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c682e6505d059fd5868057198f3cd4c1dfad48972cfe1e9403c433ca7f08fb2`  
		Last Modified: Wed, 06 Mar 2024 08:47:28 GMT  
		Size: 81.8 MB (81839405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1-jre17-Semeru-ubuntu-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:e6f515c15363eeb8efb15010ea6ec61cf872871c05cf5c21f017ec28b5163c1c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177309575 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:415730605e151e374296b6926074979c8bd58c6085c22513af5a6be7084815f9`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 06 Mar 2024 07:00:40 GMT
ENV TOMEE_VER=9.1.2
# Wed, 06 Mar 2024 07:00:58 GMT
ENV TOMEE_BUILD=plume
# Wed, 06 Mar 2024 07:01:06 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 06 Mar 2024 07:01:06 GMT
EXPOSE 8080
# Wed, 06 Mar 2024 07:01:06 GMT
...
-	Layers:
	...
	-	`sha256:0b75d4e5fb09d1fc15715aead800d537a17767a38f96e35f6425cf630e414e98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5968b7a8203b97024a9e26a4aa82d94b0a6aad1d65ad40ca50e8b8dca16502c`  
		Last Modified: Wed, 06 Mar 2024 07:31:49 GMT  
		Size: 81.8 MB (81839459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
