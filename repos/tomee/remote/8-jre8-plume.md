...
```console
$ docker pull tomee@sha256:b91caeb7dfa97fca411be3bd0607b5de8072699425ad53600f983871952f3ca4
```
...
```console
$ docker pull tomee@sha256:b0739f425caa70b0af907133a2529b0df8d70d3acdf7399c592546b037d09faa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.0 MB (195991961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4effc62759224873f098753fcbeb6be8850a56afbffa2e56765d5175e224642f`
...
# Sat, 28 May 2022 22:50:00 GMT
ENV TOMEE_BUILD=plume
# Sat, 28 May 2022 22:50:08 GMT
...
-	Layers:
	...
	-	`sha256:be6b82f19324fc6ca91cc8051e0d1d6daafe99ec8f86dc68ab11a7923bdf9dc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e4b3687cbf2347e5ec7e101423000722068f4f48290b4ad0619f6f548ce0717`  
		Last Modified: Sat, 28 May 2022 23:20:32 GMT  
		Size: 77.8 MB (77806317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:7620f63d985b4f5bcca5dace5ea2bc184c1e43feb118a27aa976a9495c41d863
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.5 MB (193476523 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:294695c2918629831977ca83c35742a5223589516c9b4e6545f77fb0a668f4c1`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 28 May 2022 18:39:21 GMT
ENV TOMEE_VER=8.0.11
# Sat, 28 May 2022 18:40:10 GMT
ENV TOMEE_BUILD=plume
# Sat, 28 May 2022 18:40:16 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 28 May 2022 18:40:17 GMT
EXPOSE 8080
# Sat, 28 May 2022 18:40:18 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:662c395c9e4eaa3e3dd3078eec7c590feac11d047181e64ef1c6aadd57af3b7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:567929bdaa8b65547cef4e8ce3ac0517dfff825b0f294a3dc774aea576389732`  
		Last Modified: Sat, 28 May 2022 19:27:22 GMT  
