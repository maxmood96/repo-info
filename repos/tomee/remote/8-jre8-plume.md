...
```console
$ docker pull tomee@sha256:d4e372d26479fc74ef88deda75b8913bf6b4246dc3833f6e6c3dc4f094245eae
```
...
```console
$ docker pull tomee@sha256:9b9d835381323cdfb0d83d5ef2ba49c6bd09df79840a47a38d64e2fbd5bafc23
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168355002 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7883238ca95905a42174bc5093bc8960eed7bff4d2928aa9069745ba1dbce9ab`
...
# Wed, 01 Feb 2023 22:31:09 GMT
ENV TOMEE_BUILD=plume
# Wed, 01 Feb 2023 22:31:17 GMT
...
-	Layers:
	...
	-	`sha256:2e9cf96506a982441059d03ccf295c794b348ffdc583f6552c081f6bc659d584`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e29a71bfcdd34758cada60489557434732c1a14665b829bdd8fa3f097bd00ab`  
		Last Modified: Wed, 01 Feb 2023 23:00:43 GMT  
...
```console
$ docker pull tomee@sha256:3d242645eeb82db360c2bb67aa24c6a36a0ade5678c8ef68d82bc393669ce50f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165813527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00b3dfe29b0f18e35eb83041a4f62d024bbd9c2aff483373aaac9f0d92eeb865`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 01 Feb 2023 21:11:33 GMT
ENV TOMEE_VER=8.0.14
# Wed, 01 Feb 2023 21:11:56 GMT
ENV TOMEE_BUILD=plume
# Wed, 01 Feb 2023 21:12:04 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 01 Feb 2023 21:12:04 GMT
EXPOSE 8080
# Wed, 01 Feb 2023 21:12:04 GMT
...
-	Layers:
	...
	-	`sha256:4b4459f90fb4548cd04dcbd20ae820add1439c89d20dbfa1f5e1175a3773e440`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3882794b5889430f1ecb2f352173655ea9f26f182f0652e8c0c32cd977c4e19c`  
		Last Modified: Wed, 01 Feb 2023 21:36:07 GMT  
		Size: 77.9 MB (77891813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
