...
```console
$ docker pull tomee@sha256:2189d618c8eb8a19876ff749b72b60cebeb266e302b1bdcb038bcbcb4e6bc264
```
...
```console
$ docker pull tomee@sha256:4507d4a1c27697cece6e5aea569e695682b64519e4a3a8db3bd7dc7cd2e42e7c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.8 MB (166836802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1bcd8f2e356ec0220ee8bebcbdfc8297c696f6b0e3320a3f4da9995e2490393`
...
# Fri, 16 Jun 2023 05:47:54 GMT
ENV TOMEE_BUILD=plume
# Fri, 16 Jun 2023 05:48:02 GMT
...
-	Layers:
	...
	-	`sha256:2ee0d78f660a771823ff187f63ac8ce4cfca1f85902c81decd6fc0e804dfaa69`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8045dc3a6d7dc464b6e9ad40853aaeadda5f23ce408cbfe77f28bc4a9196a8f8`  
		Last Modified: Fri, 16 Jun 2023 06:10:52 GMT  
		Size: 77.7 MB (77746726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:326a01dd695d087981ddf99ba407abbd88851f55295527fc0d61317bb0562a42
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164231140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e61eebd7460a76848ce70098f7609e11775126e18b89284bc8ce823e1119bc8`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 08 Jun 2023 21:49:32 GMT
ENV TOMEE_VER=8.0.15
# Thu, 08 Jun 2023 21:49:51 GMT
ENV TOMEE_BUILD=plume
# Thu, 08 Jun 2023 21:49:59 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 08 Jun 2023 21:50:00 GMT
EXPOSE 8080
# Thu, 08 Jun 2023 21:50:00 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5984eb49c4fceedb6d77fa8bc37bd03bb41ab587473864fc5ee3f9708c7f5bbb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12b7924b824d9a444b687e4801d11caa0713386959b4a3e810c2b8a3b37fde28`  
		Last Modified: Thu, 08 Jun 2023 22:10:23 GMT  
