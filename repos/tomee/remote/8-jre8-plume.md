...
```console
$ docker pull tomee@sha256:dec196ca0c0b07883ed98b97aaacd0889a71781f2302adfca4db35651092de7d
```
...
```console
$ docker pull tomee@sha256:ed2cd886c2da97ad5d3baebfc6ecd6da300b7b689f966b6402906cb40a8df04d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.1 MB (196124421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3087c2f6b535ba0b4c2c5b08dbdba11281b1f36d41a3c4e5a5c76a7badc41f06`
...
# Wed, 03 Aug 2022 06:10:31 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 06:10:39 GMT
...
-	Layers:
	...
	-	`sha256:d6c1233e5d4d541e354284284804409fd3a6c33119570bcde335050811e7a0c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75458c262c4d5bf68dd0716136bd4667e56f0e655716999806698db1aa5c593b`  
		Last Modified: Wed, 03 Aug 2022 06:50:16 GMT  
...
```console
$ docker pull tomee@sha256:fc2f1b22b039e7286ff280c6814de23b01b98add62c8859b791e7bad34669a56
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193822438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ba0d2e13b368ade854f6bcd8b3fb6b5eb301e38c085c6709a92028205ae5545`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 03 Aug 2022 03:44:35 GMT
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:45:27 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 03:45:36 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:45:36 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:45:37 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d692f14098d67c90b5f262356fa14352efa8aacd8cdbb680f6855df453f4deab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:563bf1b8ce4c9d1e6c36a672ab86455ab316817daab1b403f955868f7c2a2b9e`  
		Last Modified: Wed, 03 Aug 2022 04:47:42 GMT  
		Size: 77.9 MB (77947095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
