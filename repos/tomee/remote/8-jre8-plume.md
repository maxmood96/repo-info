...
```console
$ docker pull tomee@sha256:b29ba6c10586ddf130d4dca9d5588a8546e247283f0752da0ae5a22b276cd594
```
...
```console
$ docker pull tomee@sha256:faf02d0ea922dc5e8d9cab87b25bf8b31c757d42a6ac4a193f305f057f2aca79
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.7 MB (168729239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51afaece9f0fddcee7d4d13c51de03094cca21f14f57a2dd86c3b1076a561ee2`
...
# Wed, 06 Mar 2024 08:07:50 GMT
ENV TOMEE_BUILD=plume
# Wed, 06 Mar 2024 08:07:58 GMT
...
-	Layers:
	...
	-	`sha256:f9a092a8e41a29e18108157c85d9970bfea7fd2ac771dcbc6ecea78cb95da5e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d90fa2fc673bff36e901369684f864de70ea68f27493ab253a52e1f491215f3f`  
		Last Modified: Wed, 06 Mar 2024 08:31:56 GMT  
		Size: 79.1 MB (79110545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:8b0a845473ced2331eb7d090f9d4f7febf82d4c50ef66d42d5f0edd9344319c8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166206174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b4bd5ded841e3aa63f4163613166f55f00e7c382bd5c1284835a99ee78ce27b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 28 Mar 2024 03:31:02 GMT
ENV TOMEE_VER=8.0.16
# Thu, 28 Mar 2024 03:31:21 GMT
ENV TOMEE_BUILD=plume
# Thu, 28 Mar 2024 03:31:29 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 28 Mar 2024 03:31:29 GMT
EXPOSE 8080
# Thu, 28 Mar 2024 03:31:29 GMT
...
-	Layers:
	...
	-	`sha256:771515f06d95038f121e5ecccab9cd9be30ab4143f213463301c667b669b3c73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80cdfcf49beb66c54bc0a5d0983fa12c769bd0b9a7ebafce32a20974208f79af`  
		Last Modified: Thu, 28 Mar 2024 03:50:14 GMT  
