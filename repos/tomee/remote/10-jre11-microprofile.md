...
### `tomee:10-jre11-microprofile` - linux; amd64
...
### `tomee:10-jre11-microprofile` - unknown; unknown
...
### `tomee:10-jre11-microprofile` - linux; arm64 variant v8
