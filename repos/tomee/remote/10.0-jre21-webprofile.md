...
### `tomee:10.0-jre21-webprofile` - linux; amd64
...
### `tomee:10.0-jre21-webprofile` - unknown; unknown
...
### `tomee:10.0-jre21-webprofile` - linux; arm64 variant v8
