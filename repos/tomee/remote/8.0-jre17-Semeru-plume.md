...
```console
$ docker pull tomee@sha256:b75f548bc7fc0ee0049daaa4ac995588d645ef57cd93b618ccd92e2fcd530843
```
...
```console
$ docker pull tomee@sha256:57deee8bcfbc8d3eae2bbd88d7f9b9eeccbe116b6e98394b4369effa63245002
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.8 MB (178769263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:936034cda3b9a749dcaabe8b6cdc2d7d381f0a7b97bcbe98c61e0cdd8a687734`
...
# Wed, 03 Aug 2022 06:17:02 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 06:17:09 GMT
...
-	Layers:
	...
	-	`sha256:d19b3724d7a9d7c4cc299c8fa160adce78dad570a8e4551103170ea07da2d6a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:057a4c0ef320ea5dd1fb7f7e2a638566cb0e473ad908721a9946742a15f13205`  
		Last Modified: Wed, 03 Aug 2022 07:12:08 GMT  
		Size: 77.9 MB (77947412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Semeru-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:cff61ba227c1d9f021df074d9f5022ea340f9c570e5748c9ee6ba6e3f02efc67
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174659017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52372bc18fb4fc653d7bb7dbd7376acb1e0e53c60bb4c0e9f6938394c4669419`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Wed, 03 Aug 2022 03:52:55 GMT
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:53:45 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 03:53:53 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:53:53 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:53:54 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0557e9cee0e5f43359d39c868d2bac7ecbf9d096dbb93ed68b2f626daab80c76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3bc564206c2d48a17eda04223a18780cfaaadbb387e536eaa30c9594f42e384`  
		Last Modified: Wed, 03 Aug 2022 05:14:24 GMT  
		Size: 77.9 MB (77947085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
