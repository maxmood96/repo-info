...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-webprofile` - linux; amd64
...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-webprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-webprofile` - linux; arm64 variant v8
