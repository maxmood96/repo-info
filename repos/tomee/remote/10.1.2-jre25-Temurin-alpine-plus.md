...
### `tomee:10.1.2-jre25-Temurin-alpine-plus` - linux; amd64
...
### `tomee:10.1.2-jre25-Temurin-alpine-plus` - unknown; unknown
...
### `tomee:10.1.2-jre25-Temurin-alpine-plus` - linux; arm64 variant v8
