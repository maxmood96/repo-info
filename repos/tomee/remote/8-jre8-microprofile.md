...
```console
$ docker pull tomee@sha256:71bef94c92039d4e343c744484d7e201bc6aefd832ab24e8f2f24d50569ce351
```
...
```console
$ docker pull tomee@sha256:1a05d865e2feef1f93e054af0483c00faf92e51f3f9b6513465b46c28c615014
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183184801 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84c9c491ceb04bcf60e5cb4ad128869599c2e9c9dae7f1cce3d5ff204876a6b1`
...
# Tue, 12 Jul 2022 19:48:23 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 12 Jul 2022 19:48:30 GMT
...
-	Layers:
	...
	-	`sha256:328a462dbeb94adaa833597fb88a7c69599da8bda21803ebf90afbe77fe108ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35fbaf7668abff7c915ce1625fdee8acd2b19d88f54843fc6788216a20348a73`  
		Last Modified: Tue, 12 Jul 2022 20:19:01 GMT  
...
```console
$ docker pull tomee@sha256:a000c3c38a00f9ffc0fffd9f74bbd18284bbbcbedabb26f45cb95e145640349f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180867316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86613f82543a7aa6476a4a6e961c56771298eb0c56ccd00c1775606a308dd401`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Tue, 12 Jul 2022 20:14:14 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 12 Jul 2022 20:14:21 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:14:22 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:14:22 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b603a39eca527db74747044bf67923d17dbeef50122c7c8bd480d5f168906791`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f7ebf971b69b8f0e39aec3c14ab94e91dee87a6dfce7880472aaec989fccf9d`  
		Last Modified: Tue, 12 Jul 2022 20:59:35 GMT  
		Size: 65.0 MB (65006873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
