...
```console
$ docker pull tomee@sha256:32f8e2355fb86661e37fc6ae3bd946c86ebcc94364786e34a1458a4806092503
```
...
```console
$ docker pull tomee@sha256:147b92540414448b60384bcffbbd40175204869c262a625d86950db0bd2a5bb0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152888765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b135fc41bfc196473f256894bc88066e858f09dbaf5608a456fab31393d44892`
...
# Fri, 16 Jun 2023 05:47:44 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 16 Jun 2023 05:47:50 GMT
...
-	Layers:
	...
	-	`sha256:2ee0d78f660a771823ff187f63ac8ce4cfca1f85902c81decd6fc0e804dfaa69`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a895276b5efd48bbb15dc2ee08276ff3af3567963861be1766751415c7515e6`  
		Last Modified: Fri, 16 Jun 2023 06:10:13 GMT  
		Size: 63.8 MB (63798689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:0b8caf81b0b19e4f44dbaeb5de36aad5b949051711af6db00cbe8b7808a83d29
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.3 MB (150283036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ebb672979d2a16d927a9c8e863de9ea699010b447f6cb7bf4cc2dc0ab0c0c95`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 08 Jun 2023 21:49:32 GMT
ENV TOMEE_VER=8.0.15
# Thu, 08 Jun 2023 21:49:42 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 08 Jun 2023 21:49:49 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 08 Jun 2023 21:49:49 GMT
EXPOSE 8080
# Thu, 08 Jun 2023 21:49:49 GMT
...
-	Layers:
	...
	-	`sha256:5984eb49c4fceedb6d77fa8bc37bd03bb41ab587473864fc5ee3f9708c7f5bbb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8af4c88be9e67655d8c515d1397f87654d843b7bea898cf4c19a696191ab8418`  
		Last Modified: Thu, 08 Jun 2023 22:09:44 GMT  
		Size: 63.8 MB (63798648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
