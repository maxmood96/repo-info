...
```console
$ docker pull tomee@sha256:e5de37edfbe3cd3e394f6644994ffff1b59976e5f53f7caadbce223d398c3575
```
...
```console
$ docker pull tomee@sha256:fa10e103f84dcc58f53258c13da080652c28247347e350990d6295bdd6f91aa0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.8 MB (155781343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fcea89a75d2c1d57c93964aa1a10ecc86fdb46498c9a65cfdad4a98ce22df88`
...
# Sat, 02 Dec 2023 10:40:13 GMT
ENV TOMEE_BUILD=microprofile
# Sat, 02 Dec 2023 10:40:21 GMT
...
-	Layers:
	...
	-	`sha256:7314a3ac16a3253a98f16b689a630ab4db3a920ed41381bcfd6c3d32b58d211e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1ac5dab684214cc7721820b893c4674d1a67732c9950b0fc0b9a4e0be5c883d`  
		Last Modified: Sat, 02 Dec 2023 11:03:29 GMT  
		Size: 66.2 MB (66151256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:4bd029c29cc10c55f00a5341f108a59bbe55c4f19461105c1b881163a29710cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153228536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77ee7af08bceb6a63155c79e7e694ffaa3e066d7a2ab0f7233e7f169ff39e808`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 02 Dec 2023 10:56:06 GMT
ENV TOMEE_VER=8.0.16
# Sat, 02 Dec 2023 10:56:19 GMT
ENV TOMEE_BUILD=microprofile
# Sat, 02 Dec 2023 10:56:25 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 02 Dec 2023 10:56:26 GMT
EXPOSE 8080
# Sat, 02 Dec 2023 10:56:26 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:ac2698f813215d9f5774848d58b8c6b0151b4dfdc3a5526e2c2d3367bf3f70db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b428c4bc10139235c94468534e6b55d4b43a75d943af27b280312e4d781f6440`  
		Last Modified: Sat, 02 Dec 2023 11:17:53 GMT  
		Size: 66.2 MB (66151187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
