...
```console
$ docker pull tomee@sha256:81a24a73c0216d4ffd04543e8abc2b854395853f52a8620c2e76dd7f4cdca939
```
...
```console
$ docker pull tomee@sha256:ddbf6cce338e1859dd83d697e1603a857f8c9e3693c3b987871647f41556a992
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.4 MB (154415482 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f75dc4c6bf60a6e933ff96896227ed5b1062f2f9e0ebadbf64476e3086e876ab`
...
# Wed, 26 Apr 2023 22:04:54 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:05:01 GMT
...
-	Layers:
	...
	-	`sha256:f16d3ab743a22f9e8e2dc266fedfd83d967eb82741e85527820f61b1a7138267`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0a46ee2c1241fde656f69db43c6d01366bfed77e5096443390845c027037a0f`  
		Last Modified: Wed, 26 Apr 2023 22:31:47 GMT  
		Size: 63.9 MB (63926270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre8-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:ead943c2b1b6a5aa37576df22aae19865976fae57435a566877d9cb66cf41aa9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.9 MB (151872546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06e8be51bb2da4b550852dcb2aefedcbae1ccc2a91a611eeb5c33d5272f2e142`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 26 Apr 2023 22:12:16 GMT
ENV TOMEE_VER=8.0.14
# Wed, 26 Apr 2023 22:12:25 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:12:31 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 26 Apr 2023 22:12:31 GMT
EXPOSE 8080
# Wed, 26 Apr 2023 22:12:31 GMT
...
-	Layers:
	...
	-	`sha256:9a9ad666f10ca9b52260b174be646dd967274d46f2a0e90d8ffd2f44f87fa230`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac96f3dfd75ee0cedad5cba76a34e3f451a91062549318567479f2da915c85d6`  
		Last Modified: Wed, 26 Apr 2023 22:28:03 GMT  
