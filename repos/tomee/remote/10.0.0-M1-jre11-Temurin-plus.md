...
### `tomee:10.0.0-M1-jre11-Temurin-plus` - linux; amd64
...
### `tomee:10.0.0-M1-jre11-Temurin-plus` - unknown; unknown
...
### `tomee:10.0.0-M1-jre11-Temurin-plus` - linux; arm64 variant v8
