## `tomee:10-jre17-Temurin-plume`

```console
$ docker pull tomee@sha256:25122574ac6da4c3af6154295cfc72b4af20abb1b372705931061f1e7b92c71c
```
...
### `tomee:10-jre17-Temurin-plume` - linux; amd64

```console
$ docker pull tomee@sha256:d6cc181e5a09189a89bd4b98c8aa9b48284837198d0f3ce0ffae8008487a396d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.4 MB (177369199 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b7d49dadff546de74e0f2e73b4dd088016f8284facaab9c732d8879c6bc3b21`
...
-	Layers:
	...
	-	`sha256:736e4d6afbca49f23d2d40fd86019a301d0aab9720f45e118b161621009c3c4d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1fed516698e378d9bc08040992738fb25a51e12e49d7b7de0b8ba8b1eff421aa`  
		Last Modified: Tue, 07 Apr 2026 03:11:59 GMT  
		Size: 171.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:719f4122d5deaa607c43aaf205a0fe499aa1a6cdafd7a9c7e3d53c963d26f148`  
		Last Modified: Tue, 07 Apr 2026 03:11:59 GMT  
		Size: 494.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b4ed973e941415b5ff63e197938239c061332b515ba5c8e9dd232c959a4707bf`  
		Last Modified: Tue, 07 Apr 2026 03:12:00 GMT  
		Size: 75.6 KB (75626 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a7d5c8b9b99f37626517478956cb8fed0e3464359ed9842f895207d00f040476`  
		Last Modified: Tue, 07 Apr 2026 03:12:02 GMT  
		Size: 83.1 MB (83138576 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10-jre17-Temurin-plume` - unknown; unknown

```console
$ docker pull tomee@sha256:04deed9897bdd583760b0706b58a8e37c7134b9b2931abf80ebf7cec3ed9dd0a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3730549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa65d592dff3741ae05d46dd43298b3b1f7c7bb6b9245cf228f33c2d99a9d38d`

```dockerfile
```

-	Layers:
	-	`sha256:5fa29b89c3a77f0f94ee337f022748fee6f2c47c3363e17b7500d28fafd5ef48`  
		Last Modified: Tue, 07 Apr 2026 03:12:00 GMT  
		Size: 3.7 MB (3700110 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7ba188d6440fc9e26f72c6c4278c68ea07fdc680f9b8e12316f0b52290d7e5dc`  
		Last Modified: Tue, 07 Apr 2026 03:11:59 GMT  
		Size: 30.4 KB (30439 bytes)  
		MIME: application/vnd.in-toto+json

### `tomee:10-jre17-Temurin-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:4ade32c17ae292db18d2d459b5f01537274b209c786c26f365d031740a39c88f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.0 MB (176009760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bebe4a9b7375984e70919cc71a96af29eb766cf55b53562475e433c05f701b30`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 07 Apr 2026 01:55:24 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Tue, 07 Apr 2026 03:22:07 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 07 Apr 2026 03:22:07 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg # buildkit
# Tue, 07 Apr 2026 03:22:07 GMT
WORKDIR /usr/local/tomee
# Tue, 07 Apr 2026 03:22:12 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
...
-	Layers:
	...
	-	`sha256:490b2f0a27efac9de4a539111d5469e8f436c673b208448b2c0a4c8b3f91bce6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:44892e7d775f61a91fdb418c26a6f22078ce0048dcbd8c1d2bfefa82ef5e9c24`  
		Last Modified: Tue, 07 Apr 2026 03:22:35 GMT  
		Size: 172.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6fdb34c1397878aea0a54024d34b0d9fdf19cc6b091852af96c9666cb6ed3b13`  
		Last Modified: Tue, 07 Apr 2026 03:22:35 GMT  
		Size: 495.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fe95bc3ef6eb78c28e250002790d0a0bc7779a68af8586f6138e8b9a1caf288e`  
		Last Modified: Tue, 07 Apr 2026 03:22:35 GMT  
		Size: 75.6 KB (75635 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4172329d6b5e295ba171a6cc5ad28eec1fdac87a930a77e77a56a8dfbd3beb37`  
		Last Modified: Tue, 07 Apr 2026 03:22:37 GMT  
		Size: 83.1 MB (83138530 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10-jre17-Temurin-plume` - unknown; unknown

```console
$ docker pull tomee@sha256:a800776f6d2925296106a2c713542287f9d081714ed6e5dc25cfb28aee2a1949
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3731457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2143adef80894d6df9062dd2dc2ba372dc4f7d1a81ad689ba2131981361fc07`

```dockerfile
```

-	Layers:
	-	`sha256:d3516a08270911771f8107cd07552cf14ee15e4c51b220324b4887d7090afc6a`  
		Last Modified: Tue, 07 Apr 2026 03:22:35 GMT  
		Size: 3.7 MB (3700725 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0bef0a4cad8f580828504b50cc89a21c35426f0c30714bf20a05eed413680cde`  
		Last Modified: Tue, 07 Apr 2026 03:22:35 GMT  
