## `tomee:11.0.0-M1-Temurin-ubuntu-plus`
...
### `tomee:11.0.0-M1-Temurin-ubuntu-plus` - linux; amd64
...
### `tomee:11.0.0-M1-Temurin-ubuntu-plus` - unknown; unknown
...
### `tomee:11.0.0-M1-Temurin-ubuntu-plus` - linux; arm64 variant v8
