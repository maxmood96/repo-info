...
```console
$ docker pull tomee@sha256:461b6807996ccb9e28c0bade7e0b4e7fab4058d0c42c0c255b59aa0bf6ad9752
```
...
```console
$ docker pull tomee@sha256:f8a449eede2fa420a0283a5522b69dfa9b8446cc972c05ba7f020791e12bd9c9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152905521 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a78ee4b41cc61eeb7f6ec04381a7ba11c445d889bff4140bdc02190740b6970c`
...
-	Layers:
	...
	-	`sha256:b64b27efe05c99e78338c6c42c756990b02299f4ea656f026b0260253103c183`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b73c37727efcf99ce3b13ec034fcde37404c8c6053992c4d38cf3b9dc007b00`  
		Last Modified: Thu, 25 Jan 2024 02:12:13 GMT  
		Size: 59.8 MB (59814019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1-jre11-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:3733950e4b92667ec7dc01e5bfd1c8b7207fffec5ea5c7b76816bf7e1c3f7346
```
...
-	Total Size: **149.1 MB (149114914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6846478fb9b0ef218a632fc83bccc385249d3bfbc81ad286fcfc11050514829c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 01:59:03 GMT
ENV TOMEE_BUILD=webprofile
# Thu, 25 Jan 2024 01:59:09 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 01:59:10 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:59:10 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c80cb3c25a595fd927d0ea19745849c83bf286fb29bae7621a0af861f3dd4517`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf08c5c4839fd338ff4998eff85c25ee1654a05de7f971dc987d3126154e30ec`  
		Last Modified: Thu, 25 Jan 2024 02:21:28 GMT  
		Size: 59.8 MB (59814070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
