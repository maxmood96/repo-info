...
```console
$ docker pull tomee@sha256:cf6014a9583701b072a126d835b5edbf4c2fe6b020477fb86d86cfb798f2e9fe
```
...
```console
$ docker pull tomee@sha256:e597f2d84882e9b75441b0cce736c5dd275dee3f93656df4384cf55349df15b3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170297414 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94497823328ae4770378f8fd1e020ac90e415235416a891a6c5dbbf54ba7c200`
...
# Thu, 28 Jul 2022 17:45:08 GMT
ENV TOMEE_BUILD=plus
# Thu, 28 Jul 2022 17:45:16 GMT
...
-	Layers:
	...
	-	`sha256:79bc989a93d5e44c7faa2cf908bc6965c81b5e7ea799529ed943177a1d4109e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d251da692c853452f4b2e960883f872f405a4af5ab3ec27a247c97b605d8a1dd`  
		Last Modified: Thu, 28 Jul 2022 18:28:07 GMT  
...
```console
$ docker pull tomee@sha256:9bbf47c87dd1e7e9204324b4c763afe4584776d219f800f0d7ea1b29bb5ea4a2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168817369 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d8e7e1c704ae6b9f316104cee5716605388fef4feef6c4e8d66ccf561f0a434`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M8
# Thu, 28 Jul 2022 18:40:23 GMT
ENV TOMEE_BUILD=plus
# Thu, 28 Jul 2022 18:40:31 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 28 Jul 2022 18:40:31 GMT
EXPOSE 8080
# Thu, 28 Jul 2022 18:40:32 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d36d9336cd78a14f383a82ab7e0a56a72a823e1109638d5a092be5feefb6edf9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d635d4f100d352cdcedfba6b0a842fc54aef23986d200a6ab88d726e26217a4`  
		Last Modified: Thu, 28 Jul 2022 19:30:27 GMT  
		Size: 71.2 MB (71187484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
