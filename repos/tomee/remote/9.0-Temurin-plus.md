...
```console
$ docker pull tomee@sha256:b7d75bd67f6c8fab01f86097202725c002edcb90d98888a2bf8705bf1e8e0ff0
```
...
### `tomee:9.0-Temurin-plus` - linux; amd64

```console
$ docker pull tomee@sha256:ef83a8cbc3395cc9e3e1e9ecdd5853878726a8c3791ef8246444eedc2eb03b7f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180391906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb909519db0c40f9b671050825fd3ef2645f186e3ed1814f25a05f649c5a7e14`
...
# Wed, 26 Apr 2023 22:07:04 GMT
ENV TOMEE_VER=9.0.0
# Wed, 26 Apr 2023 22:07:41 GMT
ENV TOMEE_BUILD=plus
# Wed, 26 Apr 2023 22:07:49 GMT
...
-	Layers:
	...
	-	`sha256:cef880377c26cfc93120103c989837b19352113af5870aec4b01fb91f0e76627`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e989f28313f77456ac18b14a8502b1b807753a9524bd79916e812bf0423b24`  
		Last Modified: Wed, 26 Apr 2023 22:39:20 GMT  
		Size: 82.3 MB (82317049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-Temurin-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:74f90f25aec1cbb647fc5d5119d64f9f4ebc323cca653b34807b8f63d5a09205
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.2 MB (179230967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7031b114f61ab1e558c1f36fe56fd0891a73908366991002103ab3a64dc1201`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 26 Apr 2023 22:13:17 GMT
ENV TOMEE_VER=9.0.0
# Wed, 26 Apr 2023 22:13:50 GMT
ENV TOMEE_BUILD=plus
# Wed, 26 Apr 2023 22:13:58 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 26 Apr 2023 22:13:59 GMT
EXPOSE 8080
# Wed, 26 Apr 2023 22:13:59 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2738f8209b5a622827325051f8dc0db668d07e0f114aeedb6b7d49ba0a8776ed`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:423174eed8ffa2ba6cc3575b42eeea34b300afbe921bdc1f3390ada6bf31c51c`  
		Last Modified: Wed, 26 Apr 2023 22:33:40 GMT  
