...
```console
$ docker pull tomee@sha256:f07d7eaca7164c7f6c18f0c8308cbb449a2a00f4e8fda0ea098412b7b52f0f43
```
...
### `tomee:8.0.15-jre11-plus` - linux; amd64

```console
$ docker pull tomee@sha256:ccbae1a026b2be8ab262c74ab04aaf720fec4454ba2d2a9071f12e53a1330f93
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.5 MB (164545055 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a84c3134510479cd2bb85ce23a62fcac016d9d13b7110b1789f4854f3507f1e8`
...
# Thu, 31 Aug 2023 21:47:48 GMT
ENV TOMEE_BUILD=plus
# Thu, 31 Aug 2023 21:47:56 GMT
...
-	Layers:
	...
	-	`sha256:fd61aaa263cec8b11c97b8c19b8086cc36c283596037716cc3047fb0908d7e1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eecfa618907d9511262219151e77510ea3d69efbb99e133b82c7d19a05d9f3e`  
		Last Modified: Thu, 31 Aug 2023 22:11:01 GMT  
		Size: 69.9 MB (69921748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.15-jre11-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:7cc81a61de105c7f3004f7c41044a8e6e54b769479380427a86e84f7957f30a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161335659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07f39c9d5061e3aeecc9a3255d745b9f97568f7f2ad584ddb0cdd9b4d65c5242`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 08:56:12 GMT
ENV TOMEE_VER=8.0.15
# Fri, 13 Oct 2023 08:56:44 GMT
ENV TOMEE_BUILD=plus
# Fri, 13 Oct 2023 08:56:51 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 08:56:51 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 08:56:51 GMT
...
-	Layers:
	...
	-	`sha256:b54920dd2c641417c595d04d3231d0f66a505f42c85bd4319c7cc8678effe9a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6c27d7a9ae85c6ccf25b3877a5e5a50453cf935bf60ea4993181cfe0daa3f91`  
		Last Modified: Fri, 13 Oct 2023 09:17:39 GMT  
