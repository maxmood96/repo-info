...
```console
$ docker pull tomee@sha256:e8b4934a4310470d31276bd8a5cb9b7ec51a30bfbeb09c7040010d7d052df24c
```
...
### `tomee:8.0.11-jre11-Temurin-ubuntu-webprofile` - linux; amd64

```console
$ docker pull tomee@sha256:6d248eb154c4f5f7e82a49b1c558331ddbd957afd4b365265fd80445d5841353
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.3 MB (138291487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49cfa9b85c7b66dbd2508fbdd0b8529e814af5aa53474a8ff0c48bbefb8b6cf1`
...
-	Layers:
	...
	-	`sha256:57cf12f0c6c9cdb111966d3e0b921d377ea4b3dd8798705d348882a04c7af6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e040dee691e7a6e3152dcd319cd83a9a5976c0e6065b511f64d740c390ca738d`  
		Last Modified: Tue, 24 May 2022 18:15:23 GMT  
		Size: 46.7 MB (46706894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre11-Temurin-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:943265b1dfd4a7a0ec1d6e5a436f76cce94c535e06b8ff4fadfbe1c7b75498be
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.8 MB (134840046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8100555355b19539df7e72a9f7b6990cec8c306ac05d4eab2a55d7f31b576e1`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 May 2022 17:46:54 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:46:55 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 24 May 2022 17:47:01 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:47:01 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:47:02 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:927c739c39c0432ac0180e57913a1ada40c70f17505265af6124faac0e29a1d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad060d38c31e62ffd40831c711b6a5c93502b34f364a16dbccb1e20867050218`  
		Last Modified: Tue, 24 May 2022 18:44:17 GMT  
		Size: 46.7 MB (46706489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
