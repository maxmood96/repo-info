...
```console
$ docker pull tomee@sha256:77648633c0620a5aac9e1634b62cbf27f00816ca25f0433747dbcafa855dbe02
```
...
```console
$ docker pull tomee@sha256:4cfafd86d2e4d5bf2db692060d7d01c26bbe5218bfe8ad74e4eeded05bbd46ab
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.4 MB (193442776 bytes)**  
...
-	Layers:
	...
	-	`sha256:3d06723c9164d68ee9b5406c81d224f3515eeb2b65882b09aa422b55f0a66815`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:aa08f6a645f6a0619fdb90f3ed442e94b5c499a76036110d49eaab7d6dd4c546`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ba3e47c3a021c02346caf53d5901d6069eb6295ed4651dac2cbb4223c1265210`  
		Last Modified: Fri, 01 May 2026 00:15:11 GMT  
		Size: 2.4 MB (2357683 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:21dc6cb05090984aa969e8d57fa85170e9425f86fd25a7c41cd735e86c3acc28`  
		Last Modified: Fri, 01 May 2026 00:15:11 GMT  
		Size: 75.7 KB (75653 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:28cb32543bd42cada03791785b9a1eecd413fddecf3a515dc489c7d2f503cd83`  
...
```console
$ docker pull tomee@sha256:c5b3be9346d8030185fe2416b18f72a57da22dda6ae61c759b8d9f5fce5d1c82
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4285275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6209b7227a8dd77c056d123c985407c8fe65293716b3b0a5ef62e1e001b12cad`

```dockerfile
```

-	Layers:
	-	`sha256:6a32ed923d275f798b5886e5c300e0bfe656fdbab7b9a03208224dc5d714b5eb`  
		Last Modified: Fri, 01 May 2026 00:15:11 GMT  
		Size: 4.3 MB (4255003 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:06c3ad7bf9022b52633e3e61f6b1d4d2c27f93bc71b8e8444b35164d52fb97ac`  
		Last Modified: Fri, 01 May 2026 00:15:11 GMT  
...
```console
$ docker pull tomee@sha256:cf818b9922417a904e07f266af5f274404641dec5976b0ac1b20a71f40db1ae7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (188999132 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f829102e8c60eccd876c5d460545d59fa354d49cbf977b4ed63e90b72905a1cf`
-	Default Command: `["catalina.sh","run"]`
...
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 01 May 2026 00:14:25 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   871638A21A7F2C38066471420306A354336B4F0D   85FBBE98D6C37CDA8A7D8FF9F9FF83A48D339D37   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done # buildkit
# Fri, 01 May 2026 00:14:25 GMT
ENV TOMEE_VER=10.1.4
# Fri, 01 May 2026 00:14:25 GMT
ENV TOMEE_BUILD=plume
# Fri, 01 May 2026 00:14:27 GMT
RUN set -eux; 	ddist() { 		local f="$1"; shift; 		local distFile="$1"; shift; 		local success=; 		local distUrl=; 		for distUrl in 			https://dlcdn.apache.org/ 			https://archive.apache.org/dist/ 		; do 			if curl -fSL "$distUrl$distFile" -o "$f" && [ -s "$f" ]; then 				success=1; 				break; 			fi; 		done; 		[ -n "$success" ]; 	};   ddist tomee.tar.gz.asc tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc   && ddist tomee.tar.gz.sha512 tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512   && ddist apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz* # buildkit
# Fri, 01 May 2026 00:14:27 GMT
EXPOSE map[8080/tcp:{}]
# Fri, 01 May 2026 00:14:27 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4b2d9b0f31af80f7c9daf890cd7a961e18b13903bc0e0cada8a004385c5c0059`  
		Last Modified: Fri, 01 May 2026 00:14:38 GMT  
		Size: 2.3 MB (2347081 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:faeb1b272a54808954c47fb4897747d3639fcd1f7c3e478f1faadb6128cc8c5a`  
		Last Modified: Fri, 01 May 2026 00:14:38 GMT  
		Size: 75.6 KB (75629 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:507c6ba37d07b39ce46fc8af27b8d23abf9a0a59244d422cfdc08f3bd9f5b193`  
		Last Modified: Fri, 01 May 2026 00:14:41 GMT  
...
```console
$ docker pull tomee@sha256:63e236cfe42c4778a5118654b48305135852d2ae6cc11c20bdd36539c0c32249
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4283491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de4e601b0389abc1be6176348c94ede96c27f267653f08455c7cf05a6e68450f`

```dockerfile
```

-	Layers:
	-	`sha256:bcb124b9f52b865f91db2481eea5d4db89b74ec2ae9ac7240a24c042a2dc0287`  
		Last Modified: Fri, 01 May 2026 00:14:38 GMT  
		Size: 4.3 MB (4252926 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fb5ce630e64675054d6ffcdddb7456858dbb3b64a48fd2918aadcc8b6af2a3fb`  
		Last Modified: Fri, 01 May 2026 00:14:38 GMT  
