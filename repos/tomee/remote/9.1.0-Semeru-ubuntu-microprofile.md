...
```console
$ docker pull tomee@sha256:d90cf3c82f285a6e1a89cd8cacdb98db1f843c158435046c11a398bc5ca64a76
```
...
```console
$ docker pull tomee@sha256:b0db5847271e6113986baa4f6bdf3efa3539d1b9ca40df60806d5c8651e098fc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170583906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6ab2db53275181f90fa7d3f8af5fe91f18a834696e090ea3f23e3fe1b6dcc57`
...
-	Layers:
	...
	-	`sha256:6dad3789cafbed6df2cea73cc1181466b75e3e4cc255346994d99234f7547cea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a61015d0909813cdee90ec5716ed298d6bf4c3f0eb417761ad0470b4589f8163`  
		Last Modified: Fri, 13 Oct 2023 12:20:00 GMT  
		Size: 71.9 MB (71869377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1.0-Semeru-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:57bcafab07b76f82a855aa8b1589723229b14f733dfaa4204c4e2602131f2f86
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.4 MB (166372238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:630f984a3ed4269ca4fdc73b2f016687c8ee8902d8307aa0d58b3652ab723fe2`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 09:01:58 GMT
ENV TOMEE_VER=9.1.0
# Fri, 13 Oct 2023 09:02:08 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 13 Oct 2023 09:02:15 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 09:02:16 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 09:02:16 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6b8310db4bce54c27bebf8415fdd92db2389a73e21056da540830acb34c75967`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db2a08d30ea306231a74294c62479a353e497ccdaaf93809a28e31934e932b66`  
		Last Modified: Fri, 13 Oct 2023 09:36:06 GMT  
		Size: 71.9 MB (71869331 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
