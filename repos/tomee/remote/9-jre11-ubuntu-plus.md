...
```console
$ docker pull tomee@sha256:fed3bb0babdef59aeaaf0266647c03a38dc19cec0e4dbee504bcdcd97bbdab09
```
...
```console
$ docker pull tomee@sha256:9fafdb64fa3933d0a7c761ce6209f80a15bd939f88e9ec1ffb5a1f8f2a96596d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.7 MB (166682480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3beb431fcea95066b130098b485f43d8f74095b349f80cc6814347abb1d8338`
...
# Wed, 24 Apr 2024 23:39:15 GMT
ENV TOMEE_VER=9.1.3
# Wed, 24 Apr 2024 23:39:45 GMT
ENV TOMEE_BUILD=plus
# Wed, 24 Apr 2024 23:39:53 GMT
...
-	Layers:
	...
	-	`sha256:0415c35c66e44e2ee30ab3d8d405f45fa24c7d53a0807ab2ef7970083aca22bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d21689998a4be088e3ae0c0d70b66a18027d3f7cf0bd9ff3b45c65d90142761`  
		Last Modified: Wed, 24 Apr 2024 23:56:23 GMT  
		Size: 73.5 MB (73482167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:1e16ccef92383c12cd611e2479fbdc159fb0e2ea27aad43d9a2eaca64a985cb0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162939191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a51a5d0161e8bfc92559f6b918780a9dd120c04f982655d1a3591d7f12dec77c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 24 Apr 2024 21:23:21 GMT
ENV TOMEE_VER=9.1.3
# Wed, 24 Apr 2024 21:23:46 GMT
ENV TOMEE_BUILD=plus
# Wed, 24 Apr 2024 21:23:53 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
...
-	Layers:
	...
	-	`sha256:772be4e25d0774bc05099fc55576bd47451e265fc6e0103c004574c4215b4f2b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d220e78ae1b7509fc686914ccfa4e6cf4e7dade5cf43d374467631b23b0a8dc0`  
		Last Modified: Wed, 24 Apr 2024 21:34:11 GMT  
		Size: 73.5 MB (73482215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
