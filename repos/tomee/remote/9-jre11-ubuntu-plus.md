...
```console
$ docker pull tomee@sha256:71ac455699080a4d3a579a8a3466ead5bafe7372232e14a9ae97e407e8242039
```
...
```console
$ docker pull tomee@sha256:d3a8ec4a58d69c36165dc6281206890b05f89489b827767691980f3d2539edd3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167439526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bda4fbb8c69e24bfab678f566000f6788f4a93ed7e6f8bb1f31e8a8858b10ab9`
...
-	Layers:
	...
	-	`sha256:8323496d26b7d36964b3f4c8b515d41f3de5ff4f0e1079cc5278506c876c0171`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53416c3608cdbfcca08e1246545347c57b5b4f7a40e85c564f456375b61b4568`  
		Last Modified: Wed, 17 Jan 2024 13:38:10 GMT  
...
```console
$ docker pull tomee@sha256:c5476678bb5798b4b5c2dbdc321c6c07cd337a708abd3e4adfe118e7a065f661
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163649825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc1bc25cfc560592f0431e293a0391624520c1c2e6f3e7c37c67a30983b02052`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 12:27:14 GMT
ENV TOMEE_VER=9.1.2
# Wed, 17 Jan 2024 12:27:44 GMT
ENV TOMEE_BUILD=plus
# Wed, 17 Jan 2024 12:27:52 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Jan 2024 12:27:53 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 12:27:53 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:35888ba9e9809975d58d78fb720dbe48edd9d62ae1ba5a0d5f286fc04154a2fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc15c760be8e867aac50477707b7b8c5183c12f752b1112050b92c1985ba1f15`  
		Last Modified: Wed, 17 Jan 2024 13:50:39 GMT  
		Size: 74.3 MB (74347741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
