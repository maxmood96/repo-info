...
```console
$ docker pull tomee@sha256:5d465772f1ed4fc74e06a33228b01aa825fa7be307dfbb310d8b7854627cf0b4
```
...
```console
$ docker pull tomee@sha256:bbf3e8704220dd1b628411fd2574ca0d2f74c42646ebb86f87e5ec653834d08f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167439304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e5d0d1f94af5f86d4a2f30cf022489e87e05ffdb9c9b2a0cc21ad441a56a4fe`
...
# Thu, 25 Jan 2024 21:45:00 GMT
ENV TOMEE_VER=9.1.2
# Thu, 25 Jan 2024 21:45:37 GMT
ENV TOMEE_BUILD=plus
# Thu, 25 Jan 2024 21:45:45 GMT
...
-	Layers:
	...
	-	`sha256:7c652889d8a2b148dba4c0d8b8a8674fbda0b9a5df1660bfb47ca6fca752dc1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4444874b29183ee2820f559a79231bb26d48e41016c362705f8d97174a878c96`  
		Last Modified: Thu, 25 Jan 2024 22:13:36 GMT  
		Size: 74.3 MB (74347793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d900e036bb7b32e8366d18d78c1595c7470d40496e822e5a2276a194b49126c1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163648627 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5554d0777454fd4dbd1ad8b5aff9da60bc9e9df2a29b3c55ca48e5d1c5e1a1c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 23:45:55 GMT
ENV TOMEE_VER=9.1.2
# Thu, 25 Jan 2024 23:46:30 GMT
ENV TOMEE_BUILD=plus
# Thu, 25 Jan 2024 23:46:38 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 23:46:38 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:d0ed31c12a4044c440b1740c94bc9dfd82359f31189f4a5cf69e6539e2db9573`  
		...
		Size: 69.3 KB (69322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:430da667c9359254a2c858fcfa9f368dae24b03d54b4d7d61629ebb5c3fcdccb`  
		Last Modified: Fri, 26 Jan 2024 00:10:29 GMT  
