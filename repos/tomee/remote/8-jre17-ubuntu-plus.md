...
```console
$ docker pull tomee@sha256:73ae3004c045627e1aae530cce6ddb6783156d359e9901d839908550d81718a7
```
...
```console
$ docker pull tomee@sha256:0b643682667fba2118e1ffab8367b26210b09750c1e1e02720b7386d417f0913
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168637826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f722c0149cce4b519a044d3c7d67725eca1f8264bbc919598c0ea67995bd701`
...
# Thu, 31 Aug 2023 21:45:31 GMT
ENV TOMEE_BUILD=plus
# Thu, 31 Aug 2023 21:45:39 GMT
...
-	Layers:
	...
	-	`sha256:6adb21bdb1e7e0da487ab662d7512c70256e874acc2251e2855a3ba33c8404b7`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7398d609951ad27556445bc702f47d323355e83789e53060affae15eacaf402f`  
		Last Modified: Thu, 31 Aug 2023 21:58:57 GMT  
		Size: 221.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da4ab817947bb83965916a9b47c25385d4c5f99aaec5df57768c354c4b95d255`  
		Last Modified: Thu, 31 Aug 2023 21:58:58 GMT  
		Size: 2.2 MB (2198624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04229e403e5bb695bae2d6385f63875fa58b894e0077f502ffa27957f6abae6d`  
		Last Modified: Thu, 31 Aug 2023 21:58:57 GMT  
		Size: 62.9 KB (62924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6efe92436d3101673ee03ea3de5a96968fc274e4e8ca1af72187d05cbc60126e`  
		Last Modified: Thu, 31 Aug 2023 22:03:53 GMT  
		Size: 69.9 MB (69921769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre17-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:6d2a13ca96e80d567d5bc016f31e7a4581dcb5646eb457a7567cacb26d401ea0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167421155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ffd0ce32dfc4eae39e2f52a1fa14acd724d9b976f1454894d2e4a1a8c0eb67a`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 20:32:05 GMT
ENV TOMEE_VER=8.0.15
# Mon, 14 Aug 2023 20:32:36 GMT
ENV TOMEE_BUILD=plus
# Mon, 14 Aug 2023 20:32:43 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Mon, 14 Aug 2023 20:32:44 GMT
EXPOSE 8080
# Mon, 14 Aug 2023 20:32:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9e9b5e7efa830da1cdfc7408dd4a1cbb6838e1f744e595eb5fdad23997a51436`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40144f37d8e34c711fe0a3e66bfff2d2f424aa99e6b34877bed0d8a11387d0a3`  
		Last Modified: Mon, 14 Aug 2023 20:48:28 GMT  
		Size: 69.9 MB (69921729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
