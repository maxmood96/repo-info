...
```console
$ docker pull tomee@sha256:60d814771593d543fe324243d6deb60f309ad20d4d1b89fa0e3e70c9346565c5
```
...
```console
$ docker pull tomee@sha256:0a433f779e70265403f0faffbdf6474358bec4bf9b9ebd2e56afa595f6cdc87c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.9 MB (168891885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:586bd7ede435b374f9d6ec1eb3c769a75aa87f2594017ed0fc92d813d365f6c7`
...
# Tue, 24 May 2022 17:23:36 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:23:44 GMT
...
-	Layers:
	...
	-	`sha256:cfb3eda915bfdbfacde75c6fd801af643e3a6128f8b464b8990604234d5ad4f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3c32a76297eff6edd9dab136b191c22028b9f0aaa7c162437cf39a59922b87f`  
		Last Modified: Tue, 24 May 2022 18:09:47 GMT  
		Size: 70.0 MB (69989568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre17-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:baa2a89c1e1608a6ad7ffc69262fbf831abdbb25839e4bde228981088020bf97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167391933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e9a8dd4d8ff3c7321abaf4273375e352a924e903fe32864735e5bcac8ecce05`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Tue, 24 May 2022 17:44:34 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:46:08 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:46:14 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:46:14 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:46:15 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f17c860bf52d044cbcecddd05b568b319f9d07329e5e44c5fb1653c1e9d4a100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0edc91e4043c4479089dd69679cf0cdfbf81d76185744d17325095b95a3af76`  
		Last Modified: Tue, 24 May 2022 18:42:41 GMT  
