## `tomee:8-jre17-ubuntu-plus`

```console
$ docker pull tomee@sha256:19d411f827d232332fe65e84e22428aa5d79db5f8584b272aae3ba332c17217a
```
...
### `tomee:8-jre17-ubuntu-plus` - linux; amd64

```console
$ docker pull tomee@sha256:8aec4eb1f1eb466500ed6c5447cae86012878b22f7c2c0a3387b50af3e2c6628
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168636998 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bba6ba046b96afc0babb5a669dfadebdf359a98aeb0ab1f767b2477bce1613dd`
...
# Tue, 08 Aug 2023 21:47:50 GMT
ENV TOMEE_BUILD=plus
# Tue, 08 Aug 2023 21:47:58 GMT
...
-	Layers:
	...
	-	`sha256:651eb4cadabafd19b981045a4eaee2d1889b1de3cb54c8ffdfbd85b543570c90`  
		...
		Size: 666.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f604647e65be9dc5a8901038febe9bfbd1ed40f3f3f14a0d2b9b02160544dd2`  
		Last Modified: Tue, 08 Aug 2023 22:03:17 GMT  
		Size: 215.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66f70006b0feb4c6b83bd6d7d2ff6bf15163da8338702a842eb925c432844664`  
		Last Modified: Tue, 08 Aug 2023 22:03:17 GMT  
		Size: 2.2 MB (2198595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6595fdf37ffdabb200fa5489a2dabb575b94e902ea8c17a68bd1c669b44e4908`  
		Last Modified: Tue, 08 Aug 2023 22:03:17 GMT  
		Size: 62.9 KB (62897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:506a9b300063341ca41006b2d3d9870cd3dd8ee77e411e083a1bd2bb1f419c48`  
		Last Modified: Tue, 08 Aug 2023 22:08:22 GMT  
		Size: 69.9 MB (69921749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre17-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:2cccf22af7efdf579aaa7f24b8e26438f649839df2e92da9aedd3f75b32dc50f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167421073 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:951917ffdbb9523e15ef9d546e36c738a8e7acaef8aebdb172e1c8a6716fc851`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 08 Aug 2023 19:42:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 08 Aug 2023 22:09:32 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 08 Aug 2023 22:09:32 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg
# Tue, 08 Aug 2023 22:09:32 GMT
WORKDIR /usr/local/tomee
# Tue, 08 Aug 2023 22:09:38 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/*
# Tue, 08 Aug 2023 22:09:46 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Tue, 08 Aug 2023 22:09:46 GMT
ENV TOMEE_VER=8.0.15
# Tue, 08 Aug 2023 22:10:16 GMT
ENV TOMEE_BUILD=plus
# Tue, 08 Aug 2023 22:10:23 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 08 Aug 2023 22:10:23 GMT
EXPOSE 8080
# Tue, 08 Aug 2023 22:10:24 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:cb83dd6aeb6490d67a07d5b20cddc1338ede9a30ab694cafb0b7d9161dd53e60`  
		...
		Size: 666.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b8c2991189a58bdbff431f952b20312a593983bf22f0bf1651310a264f44fd3`  
		Last Modified: Tue, 08 Aug 2023 22:17:39 GMT  
		Size: 219.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fffa96a93be6200580a38d9a62d2f9c396315fb14047903576b4eda41f1e2b55`  
		Last Modified: Tue, 08 Aug 2023 22:17:40 GMT  
		Size: 2.2 MB (2194367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f3c0813d32aceef3db6d1bffad052fe32144754dd83821760e20902f79d6048`  
		Last Modified: Tue, 08 Aug 2023 22:17:39 GMT  
		Size: 62.9 KB (62931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74372c3b63bd636933371317590e63d3e9b26a0b23b4a60d613fcada1747cd47`  
		Last Modified: Tue, 08 Aug 2023 22:22:42 GMT  
		Size: 69.9 MB (69921733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
