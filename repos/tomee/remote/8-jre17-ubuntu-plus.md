...
```console
$ docker pull tomee@sha256:40aa584975e2f92b80e0ba7079e51263b8b8141667d331c9e7f9f85f8825ff50
```
...
```console
$ docker pull tomee@sha256:33795a28bd5cdea01db243c1bc4c5306c22d865fbfd00ce48a577d24060a7128
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.5 MB (169457400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:116d2a294bf65139df7c4b076ff7812700a017d0300590e050d7f83c862333d3`
...
# Wed, 26 Apr 2023 22:01:13 GMT
ENV TOMEE_BUILD=plus
# Wed, 26 Apr 2023 22:01:20 GMT
...
-	Layers:
	...
	-	`sha256:410ebc8d05843870e5fb81997338e841f7e6f9f18b515026bb3733913fea258b`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:635697107b9e1291830086b11beda28fcf27103301135d48e0d5d369f5c7d633`  
		Last Modified: Wed, 26 Apr 2023 22:17:01 GMT  
		Size: 3.7 MB (3665195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb5d8d00ae9298c29285ba96e290346d1a5c5d36111b448945a73bfeef0bd954`  
		Last Modified: Wed, 26 Apr 2023 22:17:01 GMT  
		Size: 62.9 KB (62932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43378c09677dc0a6819955097d36fab31abf34c6cbbc6560f254c6d814fcb18d`  
		Last Modified: Wed, 26 Apr 2023 22:21:37 GMT  
		Size: 70.0 MB (70045381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre17-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:83560940618c07dfe5791802d8e2f73051d0801493ad44ac58cd55d8a02b23d5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168262744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9b61190fcbae999056cfeecae6d92f2b28b0d663dc0d67f954f41e3e76a16cc`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 26 Apr 2023 22:10:32 GMT
ENV TOMEE_VER=8.0.14
# Wed, 26 Apr 2023 22:11:02 GMT
ENV TOMEE_BUILD=plus
# Wed, 26 Apr 2023 22:11:09 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 26 Apr 2023 22:11:09 GMT
EXPOSE 8080
# Wed, 26 Apr 2023 22:11:09 GMT
...
-	Layers:
	...
	-	`sha256:3c521388f114167e9a5dfb46e691a8b080aa65985a33d40b787766bd76209a94`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c1c035a4c8bf0e0f351465a4ae1473f1ff542fc453c14022f36988c4e11db76`  
		Last Modified: Wed, 26 Apr 2023 22:22:47 GMT  
