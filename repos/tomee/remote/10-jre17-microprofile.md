...
```console
$ docker pull tomee@sha256:d102f2e96a21596232647626eb060616bd30e2750e233669e201f44b7fcbda26
```
...
```console
$ docker pull tomee@sha256:bd3bc2bb5479ed8ed1646bea6b12da91cfa5413812b0664415443a4a444aaa58
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158920825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71c86203eb8a4e7f12d5ef30965bfe79e0add781a18f4b9e1ca3e42c8e6924fd`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:ab8d95c642a3cbc3fcca4ba083749065a07f6780e23924f0569024c258112177`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e30d0ad934f7d1c5861b1fee6695c6d3eb13ed2936d05043638715577f2bc9ed`  
		Last Modified: Wed, 05 Jun 2024 18:11:04 GMT  
		Size: 68.5 MB (68536709 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10-jre17-microprofile` - unknown; unknown

```console
$ docker pull tomee@sha256:1e0b0824a55e5536623fb3a89b7678b03525a7108259f8f038d920605505aaa8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3857172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a94681a23c0aa3e09c0fbb6c55c605c1bc6d2438d99e5f0f3c904fc6faac796`

```dockerfile
```

-	Layers:
	-	`sha256:20fc70714911ef9717fea352bb49c5752f5af2bee4be04d78da6b09da2c5159f`  
		Last Modified: Wed, 05 Jun 2024 18:11:02 GMT  
		Size: 3.8 MB (3824789 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e6d659dc4bcc742f035642991de9025d1f3f32914aa4320058dfde5c827ead08`  
		Last Modified: Wed, 05 Jun 2024 18:11:02 GMT  
