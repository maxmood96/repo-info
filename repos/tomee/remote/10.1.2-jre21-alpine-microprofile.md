...
### `tomee:10.1.2-jre21-alpine-microprofile` - linux; amd64
...
### `tomee:10.1.2-jre21-alpine-microprofile` - unknown; unknown
...
### `tomee:10.1.2-jre21-alpine-microprofile` - linux; arm64 variant v8
