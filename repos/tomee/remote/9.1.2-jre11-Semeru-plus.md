...
```console
$ docker pull tomee@sha256:2097e0ba092d50083cd3c9c7db843d79cb847504c3efef49f0f16ed6a9cf1aaa
```
...
```console
$ docker pull tomee@sha256:b1cdf09f83d9f23d9e063eed86aa8d1430d5e3029059f6a5f53695b908be85b4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.0 MB (173042650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7311ae74d7e0690179c7755c11ffa0234e80ec225261889553341610a5cc4b2`
...
# Wed, 06 Mar 2024 08:14:19 GMT
ENV TOMEE_VER=9.1.2
# Wed, 06 Mar 2024 08:14:55 GMT
ENV TOMEE_BUILD=plus
# Wed, 06 Mar 2024 08:15:02 GMT
...
-	Layers:
	...
	-	`sha256:b1a2200229ac99cc64c75ba628908456c757323aa03be551b214e473145a41b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f387e51e7c5ba40ebc5388cafcf5b21c799a51d2ba1cc34292fd6f6a2f9dcfb7`  
		Last Modified: Wed, 06 Mar 2024 08:49:41 GMT  
		Size: 74.3 MB (74347728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1.2-jre11-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:57a98f4cf7922a2b00bb9c19371fc52eb3f67eaaa52e4a41a8bb3eba55540db1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.8 MB (169817014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b014ef74c1998764a3d39e78ae42671daa6a6d7340bc8ce82c868558b3e283f`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.2
# Wed, 06 Mar 2024 07:02:10 GMT
ENV TOMEE_BUILD=plus
# Wed, 06 Mar 2024 07:02:18 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 06 Mar 2024 07:02:18 GMT
EXPOSE 8080
# Wed, 06 Mar 2024 07:02:18 GMT
...
-	Layers:
	...
	-	`sha256:0a89ef0b620bdbc61910ec1dbb8b1d4605e07bf79bc33e7a598dd3d76b9ebc33`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:661a4a1f6e3e9767f354fbe198dc054e728822a7a11cc9ae97c84814056304a3`  
		Last Modified: Wed, 06 Mar 2024 07:34:02 GMT  
		Size: 74.3 MB (74347754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
