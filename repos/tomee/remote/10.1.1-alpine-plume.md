...
### `tomee:10.1.1-alpine-plume` - linux; amd64
...
### `tomee:10.1.1-alpine-plume` - unknown; unknown
...
### `tomee:10.1.1-alpine-plume` - linux; arm64 variant v8
