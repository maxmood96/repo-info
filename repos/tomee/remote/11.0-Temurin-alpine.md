...
### `tomee:11.0-Temurin-alpine` - linux; amd64
...
### `tomee:11.0-Temurin-alpine` - unknown; unknown
...
### `tomee:11.0-Temurin-alpine` - linux; arm64 variant v8
