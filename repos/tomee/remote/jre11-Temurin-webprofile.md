...
```console
$ docker pull tomee@sha256:a96bfde40bf790942e2e609d1507b6ab61dfa86a1d6c670607cb0f1ae5a91ae5
```
...
```console
$ docker pull tomee@sha256:6ffa75b80e3d11f487e8058f66db9218dcbed747f9deabc62225549bd2e73716
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.8 MB (143826096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bb9be94bfb9d0d57cfee76318feb1dcb1ab3bac89edfbf6ff0d7255428e7692`
...
-	Layers:
	...
	-	`sha256:b793fdb5d3e7244d887b31b479788875238e1eaccf371c3260e358097728a31a`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a75c8ede4def59224a6a12581ea8cc9c432cddff6d6a35a00ef8f786ef8f799`  
		Last Modified: Tue, 16 Apr 2024 09:50:50 GMT  
		Size: 219.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80ef96950ed2665ccf181f627caf9aee15192a9d2334aff01b8ef88369460a8e`  
		Last Modified: Tue, 16 Apr 2024 09:50:51 GMT  
		Size: 2.2 MB (2196287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5ff91a005873c1d0e65b7705b42f02e7289d896d755da394fe1c16442e3218b`  
		Last Modified: Tue, 16 Apr 2024 09:50:50 GMT  
		Size: 69.3 KB (69326 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:610985b12b50dae0cbe96551f217cec16d82bced217a6422d58876106dbcfe99`  
		Last Modified: Tue, 16 Apr 2024 09:50:53 GMT  
		Size: 49.0 MB (48986110 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre11-Temurin-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:978bfcd560b6ca4c22c4786effbbbb552f4fb8f9bf28f65aa751df3f308046fd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.6 MB (140627988 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a5daa4d1dd91ccc677af2e95abe67a31a2a6b1064133b6bd245119a01908ffe`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 11:07:04 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Tue, 16 Apr 2024 08:01:47 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 16 Apr 2024 08:01:47 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg
# Tue, 16 Apr 2024 08:01:48 GMT
WORKDIR /usr/local/tomee
# Tue, 16 Apr 2024 08:01:52 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/*
# Tue, 16 Apr 2024 08:02:02 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   871638A21A7F2C38066471420306A354336B4F0D   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Tue, 16 Apr 2024 08:02:02 GMT
ENV TOMEE_VER=8.0.16
# Tue, 16 Apr 2024 08:02:02 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 16 Apr 2024 08:02:07 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 16 Apr 2024 08:02:07 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 08:02:08 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1d32419daa46e91265a8c77d96bd75e478ec69d6f832bb640ffe47126e9aed24`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7650a0b1f0a550dfef9aceb4dae5e200fdac534eff8aa89377db46801a45b09e`  
		Last Modified: Tue, 16 Apr 2024 08:17:01 GMT  
		Size: 221.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f18f6e26ec18088dd8c3ccbf0dbefd58ed2b194e882b3ad35b781655a5e63142`  
		Last Modified: Tue, 16 Apr 2024 08:17:02 GMT  
		Size: 2.2 MB (2190951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7da4f0f9751de4e06563cd7445f6f281f0922206f3951dc6b3ce4758e73bc5e6`  
		Last Modified: Tue, 16 Apr 2024 08:17:01 GMT  
		Size: 69.3 KB (69317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:001c2b29257cded4f42eb6f8d86a607323d89610c2b13d788f58d1d5926fa48e`  
		Last Modified: Tue, 16 Apr 2024 08:17:04 GMT  
		Size: 49.0 MB (48986126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
