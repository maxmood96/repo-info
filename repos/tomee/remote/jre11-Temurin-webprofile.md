...
```console
$ docker pull tomee@sha256:1e92a3d9293a21296bc3de90e6a6e81550704ae295e7cd3c0f63830d2fac2c8b
```
...
```console
$ docker pull tomee@sha256:a1c5aa85622a8fdf7c2276b60e6f5ac9283eae3f626bbde481bcfb7dbb465977
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152897744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f6175c18029e5b653d59ff69807ccfff688c55488c0719d4fbbf7a8385dc71b`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:07:26 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:07:32 GMT
...
-	Layers:
	...
	-	`sha256:f7dd9f0331c9eee7cc49872f453033add17f946d305ea3d4b51696a3de07b583`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5eb42c5b4431b78428d2db40e3da49230b3d58e071f0686b58360183e9845f3`  
		Last Modified: Wed, 17 Apr 2024 02:28:13 GMT  
		Size: 59.8 MB (59814118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre11-Temurin-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:bcf4797e64f72415d0aa07fded2ba722c5ed05e8f8153a4f2bdf2cd920510c3e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.1 MB (149114223 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c38e143404fcc511f452672d434566f7b36d0f7b9a1ed4aaf2abdc6d680da0d`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:19:18 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:19:24 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:19:24 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:19:25 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f64c8b56a536742c45f2207ee4608e7416985c2ecc62e3c23da61633a666019a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8a136902a3a40f36e5d034680bfc710b51b6814ed6a471dd63db76f7ba659ff`  
		Last Modified: Wed, 17 Apr 2024 02:34:40 GMT  
		Size: 59.8 MB (59814060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
