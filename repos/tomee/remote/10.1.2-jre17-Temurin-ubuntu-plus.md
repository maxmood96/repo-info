...
### `tomee:10.1.2-jre17-Temurin-ubuntu-plus` - linux; amd64
...
### `tomee:10.1.2-jre17-Temurin-ubuntu-plus` - unknown; unknown
...
### `tomee:10.1.2-jre17-Temurin-ubuntu-plus` - linux; arm64 variant v8
