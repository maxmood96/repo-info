...
### `tomee:10.0.0-M1-jre11-Semeru-ubuntu` - linux; amd64
...
### `tomee:10.0.0-M1-jre11-Semeru-ubuntu` - unknown; unknown
...
### `tomee:10.0.0-M1-jre11-Semeru-ubuntu` - linux; arm64 variant v8
