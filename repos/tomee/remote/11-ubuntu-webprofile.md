...
### `tomee:11-ubuntu-webprofile` - linux; amd64
...
### `tomee:11-ubuntu-webprofile` - unknown; unknown
...
### `tomee:11-ubuntu-webprofile` - linux; arm64 variant v8
