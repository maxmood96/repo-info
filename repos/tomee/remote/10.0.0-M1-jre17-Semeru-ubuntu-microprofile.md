...
### `tomee:10.0.0-M1-jre17-Semeru-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0.0-M1-jre17-Semeru-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-jre17-Semeru-ubuntu-microprofile` - linux; arm64 variant v8
