...
```console
$ docker pull tomee@sha256:7f983ee8475d7bfb2241c4c5ccf38e8ebd9e3d815af0e654505e09a048f0d5cf
```
...
```console
$ docker pull tomee@sha256:4d1d71c4b8544b037d98893f6ab08232218479b8fcec8c0a2857c7b1877d1bd5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159535640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfc0ee2c97d772a4ba774bbac7d6937b914ebe5eb67552f12db4ec8dff3dbf63`
...
# Tue, 08 Aug 2023 21:51:57 GMT
ENV TOMEE_BUILD=plus
# Tue, 08 Aug 2023 21:52:04 GMT
...
-	Layers:
	...
	-	`sha256:397a95eb28b9adf9e15c5afa2a4070521ad685e8a73fe6f14044eeb1a4d857df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82aed387ed15f29439d47ccd1d7edaf57d25b546ce9cc7fc2d688cb600e1fb64`  
		Last Modified: Tue, 08 Aug 2023 22:21:46 GMT  
...
```console
$ docker pull tomee@sha256:b5a3829da0e755c3a01fa90d08f9fc88db82bda13ebfe94a85b30355915add25
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (156993913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f1cee6d3982c1af7cbb2732ddae87de37475110ac36554de4e11b97cf356a7a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 08 Aug 2023 22:11:34 GMT
ENV TOMEE_VER=8.0.15
# Tue, 08 Aug 2023 22:12:06 GMT
ENV TOMEE_BUILD=plus
# Tue, 08 Aug 2023 22:12:13 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 08 Aug 2023 22:12:13 GMT
EXPOSE 8080
# Tue, 08 Aug 2023 22:12:13 GMT
...
-	Layers:
	...
	-	`sha256:003090fe0a1c8705031e0599fdca0e63e4fdf94795ec33f8dc4a57ef9f854076`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60ddfa6d5e603de7e9cbcbe58200b2df1429f3c02cd3a046f68139cd592c1c1a`  
		Last Modified: Tue, 08 Aug 2023 22:30:01 GMT  
		Size: 69.9 MB (69921725 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
