...
```console
$ docker pull tomee@sha256:70af779a8c6e0bd939d28332e06e2447dddca9b369acb467826dd77b692ef1e7
```
...
```console
$ docker pull tomee@sha256:706466d3a617f39cc6922e6d2486d1636d9b4fb08fa224b67d4fb14a0e6bbf16
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159535565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a34529c11a6a8359c26b4b75a583e31e72cd9f7f36ce9fe40db54e0fd3fc1340`
...
-	Layers:
	...
	-	`sha256:d1b624f47f8de2735ef3e6657570397693bac64f99d12398ea176142ec5763f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41a628d76d5f54447ebad8d05469aa9440c295e3d4baf86c6eb184f3cc5db0eb`  
		Last Modified: Fri, 13 Oct 2023 12:03:54 GMT  
		Size: 69.9 MB (69921828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre8-Temurin-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:0d16750511425bd05deafff737d7ea770131a3f149985c261f5420537bb27ad1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (156990323 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c03550a029afa01317ad197ad54f2be59fe3ddfab9b391af6ee2fc1931ed51c3`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 08:57:08 GMT
ENV TOMEE_VER=8.0.15
# Fri, 13 Oct 2023 08:57:38 GMT
ENV TOMEE_BUILD=plus
# Fri, 13 Oct 2023 08:57:45 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 08:57:45 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 08:57:45 GMT
...
-	Layers:
	...
	-	`sha256:c09449866ff16cb3deeaa3bb869067284824faad70851f20def8156a9961e8f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d2899e2a647acc6ca4f5e82ce486d307fa9dbf462f17f5600c0b12c7eb7fcc3`  
		Last Modified: Fri, 13 Oct 2023 09:21:07 GMT  
