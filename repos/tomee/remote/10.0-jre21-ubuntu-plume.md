...
### `tomee:10.0-jre21-ubuntu-plume` - linux; amd64
...
### `tomee:10.0-jre21-ubuntu-plume` - unknown; unknown
...
### `tomee:10.0-jre21-ubuntu-plume` - linux; arm64 variant v8
