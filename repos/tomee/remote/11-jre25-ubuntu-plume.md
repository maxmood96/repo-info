...
### `tomee:11-jre25-ubuntu-plume` - linux; amd64
...
### `tomee:11-jre25-ubuntu-plume` - unknown; unknown
...
### `tomee:11-jre25-ubuntu-plume` - linux; arm64 variant v8
