...
### `tomee:10-jre11-webprofile` - linux; amd64
...
### `tomee:10-jre11-webprofile` - unknown; unknown
...
### `tomee:10-jre11-webprofile` - linux; arm64 variant v8
