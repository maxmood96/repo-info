## `tomee:8.0.11-jre8-debian-plus`

```console
$ docker pull tomee@sha256:45009159b93e7cbdcc41407010b8075349742bbf5480d963858a853c51eaf04e
```
...
### `tomee:8.0.11-jre8-debian-plus` - linux; amd64

```console
$ docker pull tomee@sha256:48db6a4b94cddb59b42dbe9c81a13a077a9363e38bb52d7551d439f831389059
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.2 MB (188175185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4aa0955c0dee25b67a49caba447e7e179630a44522c1bdcbfd810b36c458e02`
...
# Sat, 28 May 2022 22:50:14 GMT
ENV TOMEE_BUILD=plus
# Sat, 28 May 2022 22:50:21 GMT
...
-	Layers:
	...
	-	`sha256:be6b82f19324fc6ca91cc8051e0d1d6daafe99ec8f86dc68ab11a7923bdf9dc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8006ac32e1f9d984daa3a020aded9536eff6c07e45c57b78009e8d0b2a61563`  
		Last Modified: Sat, 28 May 2022 23:21:24 GMT  
		Size: 70.0 MB (69989541 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre8-debian-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:427417ab915784ea33022d22d63740d983f7c3c9b0a64f9f83e596f737e81d53
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.7 MB (185659813 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6fbae828c6114a6a5e78888e8464488d1348002fe5508d7887bc91ab6a9fe6b`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 28 May 2022 18:39:21 GMT
ENV TOMEE_VER=8.0.11
# Sat, 28 May 2022 18:40:31 GMT
ENV TOMEE_BUILD=plus
# Sat, 28 May 2022 18:40:38 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 28 May 2022 18:40:39 GMT
EXPOSE 8080
# Sat, 28 May 2022 18:40:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:662c395c9e4eaa3e3dd3078eec7c590feac11d047181e64ef1c6aadd57af3b7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56d4f0c242837c6e8d833f89868f8c3f0eed12a982fd47d2dfd3fc4e6f98403c`  
		Last Modified: Sat, 28 May 2022 19:28:22 GMT  
