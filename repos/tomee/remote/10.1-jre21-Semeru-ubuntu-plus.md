...
```console
$ docker pull tomee@sha256:b19aba944cd69ac89120b4fb22b87bfec06ae0decf556f48d68a6867aec3c4f7
```
...
```console
$ docker pull tomee@sha256:9cb59654cf30007dd6e0276a85ee4a639bd2ae973df73857a77058dffaa03e83
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.4 MB (184421817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8ac6074359cf5fccc0ca023230d4647b247424ffafd9a1f770139c4e4dc180b`
...
-	Layers:
	...
	-	`sha256:5dfc36d8725052581d3c608a4a6a54ee42cff3d5382f43cb464319092cfc3610`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7aaf79501d35ceaaf327c7f151489373f70b580f84a80b5154bb959d88989c0a`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6cbe4cdb86de13d2c1e6ab4d92f84c9f25ee80aa6b437ecd8953fec20e52f618`  
		Last Modified: Mon, 09 Feb 2026 21:15:33 GMT  
		Size: 2.4 MB (2357734 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7dba6c0a34334956a00ddf44d84ca8a12f0967781739afeb15e8fd925fbb6764`  
		Last Modified: Mon, 09 Feb 2026 21:15:33 GMT  
		Size: 75.6 KB (75635 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:aaf8c3bd62e08cd9cc91d277539d6f8a4eeabd016d84c3af30a084f8625ec2b5`  
		Last Modified: Mon, 09 Feb 2026 21:15:35 GMT  
		Size: 75.0 MB (75016864 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10.1-jre21-Semeru-ubuntu-plus` - unknown; unknown

```console
$ docker pull tomee@sha256:4704dfbdb4c1ec73fc0ae6f9b16e2ad6927d296817cdb1377f89c2a89cd4931a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4259788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb24e09a140854fa9043afb2033a750595fcb81b898360240304e7d6afed2d07`

```dockerfile
```

-	Layers:
	-	`sha256:8d809d4504044fad6c1847bb8b7e9ce0c2c38813213b74a13ff1dab78024ea29`  
		Last Modified: Mon, 09 Feb 2026 21:15:33 GMT  
		Size: 4.2 MB (4232039 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:18b92335a719c7e5326dcbd9e99116e666a488913641019cc927f03ea4999be5`  
		Last Modified: Mon, 09 Feb 2026 21:15:33 GMT  
...
```console
$ docker pull tomee@sha256:e04f4556c471516e91d6935b06139be175897d7c56adfd199419251091348abe
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180245222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95392794cb85aefb2effe9d7f405a106b47375f946d8dc8415d8d0687d94b3c4`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -eux;     unset OPENJ9_JAVA_OPTIONS;     SCC_SIZE="50m";     DOWNLOAD_PATH_TOMCAT=/tmp/tomcat;     INSTALL_PATH_TOMCAT=/opt/tomcat-home;     export CATALINA_PID=/opt/tomcat-home/tomcat.pid;     TOMCAT_CHECKSUM="fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d";     TOMCAT_VERSION="9.0.112";     TOMCAT_FILENAME="apache-tomcat-${TOMCAT_VERSION}.tar.gz";     SUCCESS=;         mkdir -p "${DOWNLOAD_PATH_TOMCAT}" "${INSTALL_PATH_TOMCAT}";     for baseUrl in         https://dlcdn.apache.org/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin         https://archive.apache.org/dist/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin     ; do         if curl -LfsSo "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz "${baseUrl}/${TOMCAT_FILENAME}" && [ -s "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz ]; then             SUCCESS=1;             break;         fi;     done;     [ -n "$SUCCESS" ];     echo "${TOMCAT_CHECKSUM}  ${DOWNLOAD_PATH_TOMCAT}/tomcat.tar.gz" | sha512sum -c -;     tar -xf "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz -C "${INSTALL_PATH_TOMCAT}" --strip-components=1;     rm -rf "${DOWNLOAD_PATH_TOMCAT}";         java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 20;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 15;     FULL=$( (java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     DST_CACHE=$(java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,destroy 2>&1 || true);     SCC_SIZE=$(echo $SCC_SIZE | sed 's/.$//');     SCC_SIZE=$(awk "BEGIN {print int($SCC_SIZE * $FULL / 100.0)}");     [ "${SCC_SIZE}" -eq 0 ] && SCC_SIZE=1;     SCC_SIZE="${SCC_SIZE}m";     java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     unset OPENJ9_JAVA_OPTIONS;         export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 20;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 5;     FULL=$( (java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     echo "SCC layer is $FULL% full.";     rm -rf "${INSTALL_PATH_TOMCAT}";     unset CATALINA_PID;     if [ -d "/opt/java/.scc" ]; then           chmod -R 0777 /opt/java/.scc;     fi;         echo "SCC generation phase completed"; # buildkit
# Mon, 09 Feb 2026 21:14:56 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Mon, 09 Feb 2026 21:14:56 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg # buildkit
# Mon, 09 Feb 2026 21:14:56 GMT
WORKDIR /usr/local/tomee
# Mon, 09 Feb 2026 21:15:05 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
...
-	Layers:
	...
	-	`sha256:cfb83fd2a24e3b44d36e1064f1786dbefed6c65e9608cef3fe13fc19dd3bce62`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:65d4845d4168db9455a1e0ab0437ae77ddd98aa9cfb8eb93e2e58b3e5c62eb41`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d65fdeb21a1211a0288fd302d15687fb17afd7d71597f66dc461bcc9fb7da53d`  
		Last Modified: Mon, 09 Feb 2026 21:15:28 GMT  
		Size: 2.3 MB (2347122 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:89a8f199f6a8654cb1661bf9563fcae84c12af63a6edb86756c931f76d4769a1`  
		Last Modified: Mon, 09 Feb 2026 21:15:28 GMT  
		Size: 75.7 KB (75651 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6509993376b4f624521ade24672ba41c0fee4bc1cd941be2fcdf4a11886c29f0`  
		Last Modified: Mon, 09 Feb 2026 21:15:30 GMT  
		Size: 75.0 MB (75016884 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10.1-jre21-Semeru-ubuntu-plus` - unknown; unknown

```console
$ docker pull tomee@sha256:930f34ab28d7acf6e985c1a7708c7870b7b06fb360a0e69f8ed230d2f394a959
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4257812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05882c796e67917e035dd9da82067daa9821ac4d803d4b05073bda34cd8a8ded`

```dockerfile
```

-	Layers:
	-	`sha256:d14a5f3e572273577182718c50113297c12feee8fc570d83f7f8d11994e1d2ec`  
		Last Modified: Mon, 09 Feb 2026 21:15:28 GMT  
		Size: 4.2 MB (4229866 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fcf72fb9f546e90a8eee04cc065934697bf4d0fca7af46068781ad8405350391`  
		Last Modified: Mon, 09 Feb 2026 21:15:28 GMT  
