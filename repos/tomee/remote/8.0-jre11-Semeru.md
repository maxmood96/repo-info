...
```console
$ docker pull tomee@sha256:1118eeb4fbfc1682500e551122133a4dc7f01df2f28cc4913f59fbe1be3d2c3a
```
...
```console
$ docker pull tomee@sha256:b304009f465a71a8b7c39a463463b5b5369d9236709dc79e1f269d9cbde1d421
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.8 MB (146849816 bytes)**  
...
-	Layers:
	...
	-	`sha256:246b18d6f936b53be037bc3067dc4d570a33c98708085180d1ee8322ae02e0a9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9c8ed691d7b514776a0922f328d3f8afa1413a0750c414227f19ebfbee9695c`  
		Last Modified: Tue, 07 Jun 2022 05:54:49 GMT  
		Size: 46.7 MB (46706917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre11-Semeru` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:dd61885094528abe8b64513255c94e97b6f7f6bbc0355f0e9fb5fbee873c1263
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143076260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35e934cb15bbe0ec77dea9a9a67e751ec44b61d7894ad7bf122a67fb41804703`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 07 Jun 2022 08:34:33 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 07 Jun 2022 08:34:39 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 07 Jun 2022 08:34:39 GMT
EXPOSE 8080
# Tue, 07 Jun 2022 08:34:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:8448e4957b6415f29dbab2153015edd8ef5b0f811191ac4caaf731e3260693ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5e15e3c18fcc634a67eaf8cee420d6748bcfe5825a195030b9870ebb8f5247d`  
		Last Modified: Tue, 07 Jun 2022 09:29:03 GMT  
		Size: 46.7 MB (46706498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
