...
### `tomee:10.0.0-jre21-Temurin-ubuntu-plus` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-ubuntu-plus` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-ubuntu-plus` - linux; arm64 variant v8
