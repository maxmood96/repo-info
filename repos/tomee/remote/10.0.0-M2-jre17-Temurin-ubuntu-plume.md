...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-plume` - linux; amd64
...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-plume` - unknown; unknown
...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-plume` - linux; arm64 variant v8
