...
```console
$ docker pull tomee@sha256:4348d2f534974db0e05089d1e101488c86cfc197ec66829553c3f3b3f33b5516
```
...
```console
$ docker pull tomee@sha256:93bb3d256fe0c8b5b89f6dbf5043f95bb1d3f03d1ac751cba52021b52e4aa214
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.8 MB (152844936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35fa49ece71c14678a023ecac331b8152bc12541829a953f99475287fffdd2ff`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:c27f2539656187cdd47a0bbbfde704e92a5b2d79992702878022ebf95a06b79f`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3e6b9ad09053ec1eb9128b0cd12af726893577a4a26767398c41384be75a752e`  
		Last Modified: Mon, 18 Nov 2024 21:30:58 GMT  
		Size: 58.7 MB (58745762 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10-Semeru-ubuntu-webprofile` - unknown; unknown

```console
$ docker pull tomee@sha256:ef1b5eea4175235296410510316eaea23a5506b4c156c3e5093d398c0491a29e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (3962763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a40c379be11af39652c4591bbc2a638f430881c855a4f670d4ada53ac617508d`

```dockerfile
```

-	Layers:
	-	`sha256:42e76db11663ae894307cff2d60551fe8cf6685939b8748087971844b84cdd54`  
		Last Modified: Mon, 18 Nov 2024 21:30:56 GMT  
		Size: 3.9 MB (3934361 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b3678f9ce8c90a5abda570c8f3d3b2d2255e0e5f1ebd2fc33b77e102e425599e`  
		Last Modified: Mon, 18 Nov 2024 21:30:55 GMT  
