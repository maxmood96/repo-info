...
### `tomee:10.0.1-jre17-Temurin-ubuntu` - linux; amd64
...
### `tomee:10.0.1-jre17-Temurin-ubuntu` - unknown; unknown
...
### `tomee:10.0.1-jre17-Temurin-ubuntu` - linux; arm64 variant v8
