...
### `tomee:10.1.1-Semeru-ubuntu` - linux; amd64
...
### `tomee:10.1.1-Semeru-ubuntu` - unknown; unknown
...
### `tomee:10.1.1-Semeru-ubuntu` - linux; arm64 variant v8
