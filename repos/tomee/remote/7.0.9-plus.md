...
```console
$ docker pull tomee@sha256:b97f6546c48b88aa407ecd73ce32ca042446595c941aa41d356949233934342c
```
...
```console
$ docker pull tomee@sha256:592bcbe66546377d99017b1b6c2ffa78bd96d5fc914804ea2b79bcb6957b1ab5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171689022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76da544c1b09ea83d948774b4584c83da27d70ecb2846921abeeaa866bb33b7f`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 24 Jun 2022 03:43:42 GMT
WORKDIR /usr/local/tomee
# Fri, 24 Jun 2022 03:43:43 GMT
ENV GPG_KEYS=223D3A74B068ECA354DC385CE126833F9CF64915     7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF     82D8419BA697F0E7FB85916EE91287822FDB81B1     9056B710F1E332780DE7AF34CBAEBE39A46C4CA1     A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1     B7574789F5018690043E6DD9C212662E12F3E1DD     B8B301E6105DF628076BD92C5483E55897ABD9B9     DBCCD103B8B24F86FFAAB025C8BB472CD297D428     F067B8140F5DD80E1D3B5D92318242FE9A0B1183     FAA603D58B1BA4EDF65896D0ED340E0E6D545F97     C92604B0DEC5C62CFF5801E73D4683C24EDC64D1     294A395FFDC9FCF25A7E2BFDCF6FC99C2CC77782
# Fri, 24 Jun 2022 03:51:20 GMT
RUN set -xe     && for key in $GPG_KEYS; do         gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||         gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||         gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;     done
# Fri, 24 Jun 2022 03:51:20 GMT
ENV TOMEE_VER=7.0.9
# Fri, 24 Jun 2022 03:51:39 GMT
ENV TOMEE_BUILD=plus
# Fri, 24 Jun 2022 03:51:47 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Fri, 24 Jun 2022 03:51:47 GMT
EXPOSE 8080
# Fri, 24 Jun 2022 03:51:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:4c1d63df8d6981a615a6043e1fe733d937fa239d1189fb34cae39e2fb0b9d1f0`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a5817782f9fcaba689dd5d6a4f1cf0c0585d347e521d481b142df6dbfa0feb4`  
		Last Modified: Fri, 24 Jun 2022 04:19:19 GMT  
		Size: 21.4 KB (21350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94ea31d22a977c90434789f22df11d939cc854987ab664b8ae64dca7194ef3c8`  
		Last Modified: Fri, 24 Jun 2022 04:19:41 GMT  
