...
```console
$ docker pull tomee@sha256:f1114739c3b8556f7ed277a937c921f80c80e516d225282cf135ca732ab1630b
```
...
```console
$ docker pull tomee@sha256:e0cd69eb7a81e9ecdb91a7b2a3a885ceca5b90ae68d1422b4eccb9481030a08e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.2 MB (174196597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65951117dff01786657d176ccd14dc288cedcb89264158c27b97af16f7042f26`
...
# Tue, 12 Jul 2022 19:45:27 GMT
ENV TOMEE_VER=7.0.9
# Tue, 12 Jul 2022 19:45:50 GMT
ENV TOMEE_BUILD=plus
# Tue, 12 Jul 2022 19:45:56 GMT
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e3d00ed5ade9abbdbbf7e773ca43e31e7d3cfad892d96232dc0cc6d9922bc51`  
		Last Modified: Tue, 12 Jul 2022 20:07:48 GMT  
...
```console
$ docker pull tomee@sha256:2148879f37ee3beb30fb2029db9b7e38765b5a74eb99d31192898a2d47e610cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.9 MB (171878953 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eeacb71533fa1f43747ab915fca08fc25d7d6888e58f7f48695b2758961e710c`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -xe     && for key in $GPG_KEYS; do         gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||         gpg --batch --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||         gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;     done
# Tue, 12 Jul 2022 20:09:33 GMT
ENV TOMEE_VER=7.0.9
# Tue, 12 Jul 2022 20:09:55 GMT
ENV TOMEE_BUILD=plus
# Tue, 12 Jul 2022 20:10:00 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:10:01 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:10:02 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc5ac35dbf617b914dd667b60104b5141691c26ccb336f1bfce4b0f848cd735d`  
		Last Modified: Tue, 12 Jul 2022 20:46:46 GMT  
		Size: 56.1 MB (56060024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
