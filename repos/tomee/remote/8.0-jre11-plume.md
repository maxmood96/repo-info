...
```console
$ docker pull tomee@sha256:97ada8794bd99e5b0c985963f00135838bbf110921f5fa097c2e03cb1cb4e569
```
...
```console
$ docker pull tomee@sha256:64a5caff230499e73318744686a98ea70e06235356dfb16373b0523f2126cef0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (173953470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09f20d9ddef72052830adca77665b7b36d4f587893905700ef0446938e14ae4b`
...
# Fri, 02 Feb 2024 14:08:31 GMT
ENV TOMEE_BUILD=plume
# Fri, 02 Feb 2024 14:08:39 GMT
...
-	Layers:
	...
	-	`sha256:00120ce143019864b89b5508c706f312ee46aea77bdd86883cdac9ac9eefe149`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b1b35a0661a22481521b7d9fafd47b7c0376e4cf2ffdc1f60270884d799557d`  
		Last Modified: Fri, 02 Feb 2024 14:31:27 GMT  
		Size: 79.1 MB (79110588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre11-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:6eef2c719f04d902350e977cea5a1a3b5636f6d78ad0238845d5e21ae348cc6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170750869 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e43f6d41dc00f6b2924ec83f8580cc3debda4fd412c9210d107f2afb60723295`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 06 Mar 2024 06:54:59 GMT
ENV TOMEE_VER=8.0.16
# Wed, 06 Mar 2024 06:55:17 GMT
ENV TOMEE_BUILD=plume
# Wed, 06 Mar 2024 06:55:25 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 06 Mar 2024 06:55:25 GMT
EXPOSE 8080
# Wed, 06 Mar 2024 06:55:25 GMT
...
-	Layers:
	...
	-	`sha256:4faac9a9e17d65143c346e37b325659469050c7176111a561cad03f8261ec64f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df6c09c8516a349ab5af49b4f937881aa939f703ded828599e94862800d36313`  
		Last Modified: Wed, 06 Mar 2024 07:13:57 GMT  
		Size: 79.1 MB (79110557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
