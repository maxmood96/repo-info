...
```console
$ docker pull tomee@sha256:bcb22821f3fb17d02a1564466ce7de6b66019a8f5712d2fa6cf6ddb145cd1959
```
...
```console
$ docker pull tomee@sha256:df6010a67143356d406fa1350a16f2bd7d1f0b8cbf843d0ca4e9d663210f1b22
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (173951985 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5cff8ea0ef31eae8394782a16b917b62a9422844d6e90a3fcf1f89ca2c282d87`
...
# Thu, 25 Jan 2024 01:31:04 GMT
ENV TOMEE_BUILD=plume
# Thu, 25 Jan 2024 01:31:13 GMT
...
-	Layers:
	...
	-	`sha256:40727c9393ed62921a4caa6d8e21a257f355ea2828f91a46a9073aa7bc0e5f7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a3c7c131a3ee87740419b10b7f681462f94df219931a581a0e517fe8d1f8e3a`  
		Last Modified: Thu, 25 Jan 2024 01:55:47 GMT  
...
```console
$ docker pull tomee@sha256:dadea371e0b8aca96f26ad16153ebc51226a0a9d4c618239ef6286d48dea54ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170742129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7166de355318ff304b9a7a1e419f27466f1d58fa7c1dee66ac2597c256ec3013`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 01:56:01 GMT
ENV TOMEE_VER=8.0.16
# Thu, 25 Jan 2024 01:56:20 GMT
ENV TOMEE_BUILD=plume
# Thu, 25 Jan 2024 01:56:28 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 01:56:28 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:56:28 GMT
...
-	Layers:
	...
	-	`sha256:6ad82d01a272d58c1f26c979b1eaabd41354743712a9ef76b5f88f8bb1e82afb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfcfa8df7d3e6442857df5e2fc540f59a894317139ecc6d1a1a4893b595ab720`  
		Last Modified: Thu, 25 Jan 2024 02:11:48 GMT  
		Size: 79.1 MB (79110547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
