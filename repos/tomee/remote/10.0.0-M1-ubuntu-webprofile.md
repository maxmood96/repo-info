...
### `tomee:10.0.0-M1-ubuntu-webprofile` - linux; amd64
...
### `tomee:10.0.0-M1-ubuntu-webprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-ubuntu-webprofile` - linux; arm64 variant v8
