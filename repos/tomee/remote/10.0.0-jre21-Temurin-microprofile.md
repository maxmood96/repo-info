...
### `tomee:10.0.0-jre21-Temurin-microprofile` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-microprofile` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-microprofile` - linux; arm64 variant v8
