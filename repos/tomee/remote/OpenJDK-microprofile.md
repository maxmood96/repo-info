## `tomee:OpenJDK-microprofile`

```console
$ docker pull tomee@sha256:42449522b24095503c17acc406f2a3dac80012670a21c2f152bc47a89678466c
```
...
### `tomee:OpenJDK-microprofile` - linux; amd64
...
### `tomee:OpenJDK-microprofile` - linux; arm64 variant v8
