...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M2-jre17-Temurin-ubuntu-microprofile` - linux; arm64 variant v8
