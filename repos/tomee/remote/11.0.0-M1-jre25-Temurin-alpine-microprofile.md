...
### `tomee:11.0.0-M1-jre25-Temurin-alpine-microprofile` - linux; amd64
...
### `tomee:11.0.0-M1-jre25-Temurin-alpine-microprofile` - unknown; unknown
...
### `tomee:11.0.0-M1-jre25-Temurin-alpine-microprofile` - linux; arm64 variant v8
