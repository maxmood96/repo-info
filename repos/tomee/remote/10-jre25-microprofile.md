...
### `tomee:10-jre25-microprofile` - linux; amd64
...
### `tomee:10-jre25-microprofile` - unknown; unknown
...
### `tomee:10-jre25-microprofile` - linux; arm64 variant v8
