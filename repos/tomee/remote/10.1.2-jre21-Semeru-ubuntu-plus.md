...
### `tomee:10.1.2-jre21-Semeru-ubuntu-plus` - linux; amd64
...
### `tomee:10.1.2-jre21-Semeru-ubuntu-plus` - unknown; unknown
...
### `tomee:10.1.2-jre21-Semeru-ubuntu-plus` - linux; arm64 variant v8
