## `tomee:10.0.0-M2-Temurin-alpine-microprofile`
...
### `tomee:10.0.0-M2-Temurin-alpine-microprofile` - linux; amd64
...
### `tomee:10.0.0-M2-Temurin-alpine-microprofile` - unknown; unknown
