...
```console
$ docker pull tomee@sha256:ed3599ed755cf29f58488168f405fa62f2a2402889c6a8ae102ea865ba7ea1ec
```
...
```console
$ docker pull tomee@sha256:b662247187aabef52dc1d9284ae4f6608593cfe20335edf9b6c960415aece8cd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.4 MB (158416053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4740585796bc0ed78379601975ac891d213dfe572133d09517850ab72d215986`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:09:02 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:09:08 GMT
...
-	Layers:
	...
	-	`sha256:865caa1b725d5037c6fcdaaedaf20f5d422c839a67aa9338073abd0f0213164c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8243ffd72475f6de660e265b0009dcec17b33212fe787798b6e9529d7524a291`  
		Last Modified: Wed, 17 Apr 2024 02:35:48 GMT  
		Size: 59.8 MB (59814089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:Semeru-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:b25a3d047d78e8eea7cfe48776bd13c4d371695884085fa9afd14d36410afe70
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155331982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dbe4b9fff67347d43794d698dd7a5a77e1439e6b6740664b6fae807e0b36991`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:20:00 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:20:07 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:20:07 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:20:07 GMT
...
-	Layers:
	...
	-	`sha256:5e299225fb1346fb4d387e0035ed922c8b2e555df753ffebfdd752c0dd325b3e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd8266c323d963095627e90f243898d2a725640a943f80c335116a782a5e53aa`  
		Last Modified: Wed, 17 Apr 2024 02:38:38 GMT  
		Size: 59.8 MB (59814105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
