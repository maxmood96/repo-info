...
### `tomee:10.0.0-M3-Semeru-microprofile` - linux; amd64
...
### `tomee:10.0.0-M3-Semeru-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M3-Semeru-microprofile` - linux; arm64 variant v8
