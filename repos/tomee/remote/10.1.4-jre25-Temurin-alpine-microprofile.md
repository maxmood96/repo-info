...
```console
$ docker pull tomee@sha256:2f8f3a3accee6e1cf59edfa940760d498378d818b13d457bb39da1eabbd64129
```
...
### `tomee:10.1.4-jre25-Temurin-alpine-microprofile` - linux; amd64
...
### `tomee:10.1.4-jre25-Temurin-alpine-microprofile` - unknown; unknown
...
### `tomee:10.1.4-jre25-Temurin-alpine-microprofile` - linux; arm64 variant v8
