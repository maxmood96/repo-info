...
### `tomee:10.1.3-Temurin-alpine-plume` - linux; amd64
...
### `tomee:10.1.3-Temurin-alpine-plume` - unknown; unknown
...
### `tomee:10.1.3-Temurin-alpine-plume` - linux; arm64 variant v8
