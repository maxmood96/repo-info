...
```console
$ docker pull tomee@sha256:5b93259097c053bdd1d46bb2d8f5630f687b8ccae6c820cac00eb075b04529da
```
...
```console
$ docker pull tomee@sha256:19739685e88527243bc5e043bda6f19ec1cc5e1535085eaf6d4862b677b2c597
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160992675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99470ab34b8c8c93ce66e4691b661087cb9478c23d3445d10f8a4bf3bc747724`
...
# Thu, 25 Jan 2024 01:30:54 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 01:31:01 GMT
...
-	Layers:
	...
	-	`sha256:40727c9393ed62921a4caa6d8e21a257f355ea2828f91a46a9073aa7bc0e5f7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d15033f31f297ede922bf0e4907d87f67edb69adde6982ee35c5ff6d3069122b`  
		Last Modified: Thu, 25 Jan 2024 01:55:07 GMT  
...
```console
$ docker pull tomee@sha256:bdfc5811a80eb475dd494c641498f5cdc4fa179a508b72aeb9dff8a233def1ae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157782828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebd7dba1d9335de2f71b69a4c08b7d8fec3e6a0d969e350a35428e0beeff72c3`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 01:56:01 GMT
ENV TOMEE_VER=8.0.16
# Thu, 25 Jan 2024 01:56:10 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 01:56:17 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 01:56:17 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:56:17 GMT
...
-	Layers:
	...
	-	`sha256:6ad82d01a272d58c1f26c979b1eaabd41354743712a9ef76b5f88f8bb1e82afb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c6d5127e32e8f8f4e3ebf4937d569c2177220f56f889c02d8891842e88d5adf`  
		Last Modified: Thu, 25 Jan 2024 02:11:09 GMT  
		Size: 66.2 MB (66151246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
