## `tomee:8-jre11-Temurin-ubuntu-microprofile`

```console
$ docker pull tomee@sha256:93092b804f09031cdc29c31c59437af6e06b1c5cddb8d7e26f6a78fa6b4d3e03
```
...
### `tomee:8-jre11-Temurin-ubuntu-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:3579157c42279b62529635b721aff00b627f9781f0ba5727bb62b8612316b620
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157077414 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:608cbe8a053be21b1c197393f42bc04bbbb6f0982c825400d767cbc9ee92a5b6`
...
# Thu, 28 Jul 2022 17:41:34 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 28 Jul 2022 17:41:41 GMT
...
-	Layers:
	...
	-	`sha256:3045458856b6031aa376ef8e1ad324e702c15d5ab7cbf26bdaca2efa2a9ce7d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:236d6a4270f73781ca0f1b65bc6f72d53a8144af51989bdbde5af91b9bcca242`  
		Last Modified: Thu, 28 Jul 2022 18:17:18 GMT  
		Size: 65.0 MB (65007157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Temurin-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:ea01a85a0291334ff8e07bfd97c114695a21779b15be3b5223e12b939b91f20c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.6 MB (153633172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:802f535a9abbbaaedf470e2e4e3ed1fd3a0e8b53974f1d4d6d7f00b355f6231a`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Thu, 28 Jul 2022 18:35:55 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 28 Jul 2022 18:36:04 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 28 Jul 2022 18:36:04 GMT
EXPOSE 8080
# Thu, 28 Jul 2022 18:36:05 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:827b5fbc46d7672ff95b86f7b249ab692c508f79cd9695af43b6dd2b3e6b6a78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1a0f470ee59508b51476085effded1941782f31ab08ee649da507022a64d3a0`  
		Last Modified: Thu, 28 Jul 2022 19:20:05 GMT  
		Size: 65.0 MB (65006866 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
