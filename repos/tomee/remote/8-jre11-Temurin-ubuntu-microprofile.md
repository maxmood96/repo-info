...
```console
$ docker pull tomee@sha256:03013b29a36773b6e501d49e8c6f72beffcebef27d2649a214af5aff198d2d5d
```
...
```console
$ docker pull tomee@sha256:b1af3958ced91d7d54139ea87773d328569a317a64004b6824381dd5f074f716
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.4 MB (158421996 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e599f04ae816b1b7bb371df02b8201e41bfa0c33fceb4d75ac55593d20df6d1`
...
# Thu, 31 Aug 2023 21:47:25 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 31 Aug 2023 21:47:32 GMT
...
-	Layers:
	...
	-	`sha256:fd61aaa263cec8b11c97b8c19b8086cc36c283596037716cc3047fb0908d7e1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3fdbab4645912e0f7f417b116c7ecb70685d851284340a17cd0d10e883580a6`  
		Last Modified: Thu, 31 Aug 2023 22:09:37 GMT  
...
```console
$ docker pull tomee@sha256:bbb3285687f1e0f12c15932b270ea6039e1ada866f2f2b78fff2d1150740335b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155215987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c9bfe9f1c8020779f591e0592ce105786c35456cd327027a4e5b1d877bfa06e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 20:33:00 GMT
ENV TOMEE_VER=8.0.15
# Mon, 14 Aug 2023 20:33:11 GMT
ENV TOMEE_BUILD=microprofile
# Mon, 14 Aug 2023 20:33:17 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Mon, 14 Aug 2023 20:33:18 GMT
EXPOSE 8080
# Mon, 14 Aug 2023 20:33:18 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2977e492e9f28ff9e305620cc9cb4cabada43d5c3092ed1da84975bc028c71c1`  
		...
		Size: 62.9 KB (62920 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:374473904d86022ab4db0796dca20164386f5e6dda85cacdf128f4e1fc1def8a`  
		Last Modified: Mon, 14 Aug 2023 20:50:51 GMT  
		Size: 63.8 MB (63798695 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
