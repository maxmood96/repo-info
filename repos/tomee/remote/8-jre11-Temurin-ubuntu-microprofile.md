...
```console
$ docker pull tomee@sha256:b7e2981ebf02bee9db1b5bf5efc9e3988878acc2eb549ae0c17c5f23bbacad64
```
...
```console
$ docker pull tomee@sha256:e8054f93af1daa38d32da0353a2b3dc1c6eada46a92f8a7c041297ed5677399a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159243117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cd907bd94893c3078a28b8785124d5fb0ca9e0796682914d6118388bbc7d3e8`
...
# Wed, 26 Apr 2023 22:03:13 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:03:19 GMT
...
-	Layers:
	...
	-	`sha256:a6af4d7b87fb5b4abb5d148ee1e55574714967f4806e3c3b3ed42a0a20acfb5e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b566ea3a568b60cdfaec2106f099d843a6b6cae37d154a050235da4f49bd95ce`  
		Last Modified: Wed, 26 Apr 2023 22:26:59 GMT  
		Size: 63.9 MB (63926337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Temurin-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:b5681792ecaa98713fb10f8ed02deb2eadb6de244c5c47ede1d94dbd9507c5a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156062410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1e35495cae03078611acc0c8abdabada8a86d0a7bdd9b5e0e6c8e6bd04b0329`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 26 Apr 2023 22:11:25 GMT
ENV TOMEE_VER=8.0.14
# Wed, 26 Apr 2023 22:11:34 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:11:41 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 26 Apr 2023 22:11:41 GMT
EXPOSE 8080
# Wed, 26 Apr 2023 22:11:41 GMT
...
-	Layers:
	...
	-	`sha256:2bd8afefccbe80160b0dc3b8b30443dc243ebe914bcdede85feb95ee6e50ddfa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49a2bb42c02edc6ef7afe95716273766197e789f37fd934c348eee17a9901dad`  
		Last Modified: Wed, 26 Apr 2023 22:25:03 GMT  
		Size: 63.9 MB (63926269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
