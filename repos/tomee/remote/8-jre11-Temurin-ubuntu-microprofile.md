...
```console
$ docker pull tomee@sha256:96c661e232698c16579c8b4f9ea8f40c89d5e7760762c9c7b02983b75f3e6324
```
...
```console
$ docker pull tomee@sha256:a814fd05c0211a0f7d15e4a504bb850e971a08cb6b3a9ebbd42884ac118303f6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160991208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56900028e32060f11181c165a3e6604d7bba870b58afc8449592b30067747e4a`
...
# Tue, 16 Apr 2024 09:32:43 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 16 Apr 2024 09:32:51 GMT
...
-	Layers:
	...
	-	`sha256:d5ff91a005873c1d0e65b7705b42f02e7289d896d755da394fe1c16442e3218b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65439e33fcf08370ac89f0df7ca325feee97e8f2b9b67add4d81d15ec7cad1b9`  
		Last Modified: Tue, 16 Apr 2024 09:52:06 GMT  
		Size: 66.2 MB (66151222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Temurin-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:b46a35dca650dfaa9690ce1aaf669f1e62caec634e6b07096a5d8c0ebff0f489
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157793058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a23113e9c140b9dafd2b45188ebc7a10c113d52b8f840a2aa406728cb61c39e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 16 Apr 2024 08:02:02 GMT
ENV TOMEE_VER=8.0.16
# Tue, 16 Apr 2024 08:02:11 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 16 Apr 2024 08:02:17 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 16 Apr 2024 08:02:18 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 08:02:18 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:7da4f0f9751de4e06563cd7445f6f281f0922206f3951dc6b3ce4758e73bc5e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4237e16d8e6710cfd3d09738ac1d2a3ec036152ac323a4c4c3523e01debbe8f0`  
		Last Modified: Tue, 16 Apr 2024 08:18:13 GMT  
		Size: 66.2 MB (66151196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
