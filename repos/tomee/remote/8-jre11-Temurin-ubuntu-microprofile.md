...
```console
$ docker pull tomee@sha256:a538ba78706b40d4a4a9ac97d312d0fcb3ff769ef154ece547f0921f600aa0f3
```
...
```console
$ docker pull tomee@sha256:1956d35053b5c96b7e3b2f365048680d43334f53210266d9266d21d2767c4530
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.8 MB (156847434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a7f72f3fa59f1d308e92969ae69ef63d3201bc79af15a0bc4844de4bf8daf49`
...
# Wed, 03 Aug 2022 06:13:14 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 06:13:21 GMT
...
-	Layers:
	...
	-	`sha256:d3649ab61597078403f6d45a967629b88645443fa247ec016252d23067490a90`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:232612e92529ca344f183af2951ee03bcd4fe824a68b0fe66cfeb789a86fea2c`  
		Last Modified: Wed, 03 Aug 2022 07:01:32 GMT  
		Size: 65.0 MB (65007108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-Temurin-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:a2d37e99b8217f84cd727df689565264c7acf80723d5e5b3ef43866d7eac2e02
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153396453 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f93cebe342ccd787becde72cb8191b3991c7b99eb93fbae5c79a2101e30e390`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:49:34 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 03:49:43 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:49:44 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:49:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0f6b9cb2272824263018a9ded4a3bd4aaf5fee22c4d4850278e68ca1b7d7e4c7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a44f86d51d52a9c3084cc36d1f99f7b319ef3415b54b72d2f57d0a68c72079bd`  
		Last Modified: Wed, 03 Aug 2022 04:59:45 GMT  
		Size: 65.0 MB (65006859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
