...
### `tomee:11.0-Semeru-webprofile` - linux; amd64
...
### `tomee:11.0-Semeru-webprofile` - unknown; unknown
...
### `tomee:11.0-Semeru-webprofile` - linux; arm64 variant v8
