...
```console
$ docker pull tomee@sha256:c1e8b4a62df72c425088b712fda9e446029ff52139a20c88a358cc642ab4ff66
```
...
### `tomee:jre11-Semeru-plume` - linux; amd64

```console
$ docker pull tomee@sha256:202e5f84cffacc598704b15f8fb98c2697faefd1507ccf90d5a1ff8a301c1b90
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.5 MB (178511658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9441efee9e43c3eaae62ebc9114a1f4bcd24141092a3e87994df50b1191a9fbb`
...
# Wed, 24 Aug 2022 01:28:36 GMT
ENV TOMEE_BUILD=plume
# Wed, 24 Aug 2022 01:28:44 GMT
...
-	Layers:
	...
	-	`sha256:386158b4f0dd0154655678f73e7701491cfe87c34f13c95e8b9b491cec0b6be0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:837216e1d321cd641e32c5dbeec6bf097efc3e2b60f4f3de1355332bb754e603`  
		Last Modified: Wed, 24 Aug 2022 01:55:56 GMT  
		Size: 77.9 MB (77947407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre11-Semeru-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:0eed9fb4af010015d92daca83b7bb4cf5c2b4bfde5e49c081e895ff08fa8750b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174706202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1135d835b18b274794c07650e49385c32e04db01900cf4cf7d128e79077fa97`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 10 Aug 2022 22:57:31 GMT
ENV TOMEE_BUILD=plume
# Wed, 10 Aug 2022 22:57:39 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 10 Aug 2022 22:57:39 GMT
EXPOSE 8080
# Wed, 10 Aug 2022 22:57:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3d46d034af4933bf0f92f2fc9724b29f4d69d77f08303f0228e2bda0a3d90130`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e6610876494ff1d4e2473f3bea2d490f538492c48da396cb580ee93d73a025f`  
		Last Modified: Wed, 10 Aug 2022 23:39:27 GMT  
		Size: 77.9 MB (77947080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
