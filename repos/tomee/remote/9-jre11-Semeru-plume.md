...
```console
$ docker pull tomee@sha256:9e666cfd4ba4aca25056bd009b8fc1f4255676878eb261ac3b8c09caccd17010
```
...
```console
$ docker pull tomee@sha256:20e3b3692b1c7c688558cd7afe8fab49c06f51146dfc94fa5c4c9998f2000aa5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180440296 bytes)**  
...
-	Layers:
	...
	-	`sha256:d4a3d7004571020f58ba52a5c50c5b39b6ff0668c98133dbd6b988e178ddac35`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c654c69ecda5bef6a87dc49702161e982d94814e31c1e1ad1e90732b9911b57`  
		Last Modified: Wed, 17 Jan 2024 13:49:03 GMT  
		Size: 81.8 MB (81839414 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Semeru-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:86d0b9407469c92f79ddb0820aa696f0c0df52eb819479fa7c79fb52cbcbda28
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.8 MB (176844275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f2e9ffbb6e5a6dd61ba5503ab1c8b9b6e6219a5a5c1cb4d26f9b3c87f76a902`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 12:29:10 GMT
ENV TOMEE_VER=9.1.2
# Wed, 17 Jan 2024 12:29:29 GMT
ENV TOMEE_BUILD=plume
# Wed, 17 Jan 2024 12:29:37 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Jan 2024 12:29:38 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 12:29:38 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:ca41e1f1987719ee420f6bf8b80ed356ba2d2b33cf9c0caea3c1a8f62080b9ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9474f329db8b7d9cdd6a35f20d1a0ca3e9c916e4646bcdea2eae40598745d186`  
		Last Modified: Wed, 17 Jan 2024 13:59:28 GMT  
