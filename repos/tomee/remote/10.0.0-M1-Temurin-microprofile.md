...
### `tomee:10.0.0-M1-Temurin-microprofile` - linux; amd64
...
### `tomee:10.0.0-M1-Temurin-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-Temurin-microprofile` - linux; arm64 variant v8
