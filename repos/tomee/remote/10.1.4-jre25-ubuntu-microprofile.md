...
### `tomee:10.1.4-jre25-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.1.4-jre25-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.1.4-jre25-ubuntu-microprofile` - linux; arm64 variant v8
