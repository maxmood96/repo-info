## `tomee:10.0-jre21-Temurin-ubuntu-microprofile`
...
### `tomee:10.0-jre21-Temurin-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0-jre21-Temurin-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0-jre21-Temurin-ubuntu-microprofile` - linux; arm64 variant v8
