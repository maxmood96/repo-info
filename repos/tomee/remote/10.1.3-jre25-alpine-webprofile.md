...
### `tomee:10.1.3-jre25-alpine-webprofile` - linux; amd64
...
### `tomee:10.1.3-jre25-alpine-webprofile` - unknown; unknown
...
### `tomee:10.1.3-jre25-alpine-webprofile` - linux; arm64 variant v8
