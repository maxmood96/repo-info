...
```console
$ docker pull tomee@sha256:804fc08e58d7b160d6152477a818a1e505579264ca208ac4695d9c09505857f6
```
...
```console
$ docker pull tomee@sha256:93d44802eba003787e5becb29e52a26e28c218359b7c8b7785138f32fc006ff0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180425476 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd03103ec49098d4736b81d3fc6bbf038140167a0869faeb35938270eaaf1c1d`
...
# Fri, 01 May 2026 00:15:58 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 01 May 2026 00:16:07 GMT
...
-	Layers:
	...
	-	`sha256:425fc26f151077aad725c56807aaf222568ec743a47140ceb514d2d7bd5c7584`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5c487df034a9d1b66cf7e051042e111b3baa44182df4da2966a7feb13f55d779`  
		Last Modified: Fri, 01 May 2026 00:16:19 GMT  
		Size: 172.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c46efc5747b76883ace1621fe22065d96fe769d139825578178c11f264f7ac2e`  
		Last Modified: Fri, 01 May 2026 00:16:19 GMT  
		Size: 2.4 MB (2357702 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f001f4c7ce9e6a2e34967ef74f21b6da2fa2e079bf85311262b7cde985d3ff72`  
		Last Modified: Fri, 01 May 2026 00:16:19 GMT  
		Size: 75.7 KB (75651 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:defc15481b68f30d9aef5e9f37c9bef3c3d12fb2b7d6268d3bc06fdfc3767a0d`  
		Last Modified: Fri, 01 May 2026 00:16:21 GMT  
...
```console
$ docker pull tomee@sha256:20b5a428b286f540b42ebd1543f146273ca06f25f162fe3337bc4c5514b64d40
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4254946 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f143ea9d4c2460b127cb92ece1bfea19434ef6e1d44eb4aa150a3a1768d14e0`

```dockerfile
```

-	Layers:
	-	`sha256:0450f54de294f9c47a69e6d6708ca8290af0d7b0e036cdfaa0c5e7a87148e59d`  
		Last Modified: Fri, 01 May 2026 00:16:19 GMT  
		Size: 4.2 MB (4227270 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3c63b4e1c8a017d66aa97e6ba8b9ca6289fa35a8d2e00ee1d796cdae60412b66`  
		Last Modified: Fri, 01 May 2026 00:16:19 GMT  
...
```console
$ docker pull tomee@sha256:e1024bb197f461466c85f4649e4068699fc33e158c890d1acb5c6583f36687cc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.9 MB (175939786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b306401f28ff6683f6c4c8551969b8b33ec20bd9b675cca1b28be57ffea04b7c`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -eux;     unset OPENJ9_JAVA_OPTIONS;     SCC_SIZE="50m";     DOWNLOAD_PATH_TOMCAT=/tmp/tomcat;     INSTALL_PATH_TOMCAT=/opt/tomcat-home;     export CATALINA_PID=/opt/tomcat-home/tomcat.pid;     TOMCAT_CHECKSUM="82b15278a7bfa2685c80e07963c43246df4fd742d574b608a68f5ce67c6ffde0eff3e224cc9809925cc6bf7002a190c3bf420f50c0e4052467d3e665efc84a54";     TOMCAT_VERSION="9.0.117";     TOMCAT_FILENAME="apache-tomcat-${TOMCAT_VERSION}.tar.gz";     SUCCESS=;         mkdir -p "${DOWNLOAD_PATH_TOMCAT}" "${INSTALL_PATH_TOMCAT}";     for baseUrl in         https://dlcdn.apache.org/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin         https://archive.apache.org/dist/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin     ; do         if curl -LfsSo "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz "${baseUrl}/${TOMCAT_FILENAME}" && [ -s "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz ]; then             SUCCESS=1;             break;         fi;     done;     [ -n "$SUCCESS" ];     echo "${TOMCAT_CHECKSUM}  ${DOWNLOAD_PATH_TOMCAT}/tomcat.tar.gz" | sha512sum -c -;     tar -xf "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz -C "${INSTALL_PATH_TOMCAT}" --strip-components=1;     rm -rf "${DOWNLOAD_PATH_TOMCAT}";         java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 20;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 15;     FULL=$( (java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     DST_CACHE=$(java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,destroy 2>&1 || true);     SCC_SIZE=$(echo $SCC_SIZE | sed 's/.$//');     SCC_SIZE=$(awk "BEGIN {print int($SCC_SIZE * $FULL / 100.0)}");     [ "${SCC_SIZE}" -eq 0 ] && SCC_SIZE=1;     SCC_SIZE="${SCC_SIZE}m";     java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     unset OPENJ9_JAVA_OPTIONS;         export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 20;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 5;     FULL=$( (java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     echo "SCC layer is $FULL% full.";     rm -rf "${INSTALL_PATH_TOMCAT}";     unset CATALINA_PID;     if [ -d "/opt/java/.scc" ]; then           chmod -R 0777 /opt/java/.scc;     fi;         echo "SCC generation phase completed"; # buildkit
# Fri, 01 May 2026 00:14:56 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 01 May 2026 00:14:56 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg # buildkit
# Fri, 01 May 2026 00:14:56 GMT
WORKDIR /usr/local/tomee
# Fri, 01 May 2026 00:15:07 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
...
-	Layers:
	...
	-	`sha256:bde61dcc5b783b95f8b1ab2c8ec66be9be5103e261e4a97e4053ace649a8a9c0`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a658b2d7b8064416f4b1820846ada99524764578644ed158edc891a91efb42bb`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0f4e34195c6ef9b2b57c51d057c4dbe5f53f10b9d1b788c87b684ba123d3fe2f`  
		Last Modified: Fri, 01 May 2026 00:15:29 GMT  
		Size: 2.3 MB (2347078 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2fa9f40449d6d8613fb7e90705fbb6f091341be2f8b43984bdc9686e163a672d`  
		Last Modified: Fri, 01 May 2026 00:15:29 GMT  
		Size: 75.6 KB (75626 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:921b28a226209723565166d57db01b5519a50f41589ba6ab5ab768bc836e2690`  
		Last Modified: Fri, 01 May 2026 00:15:31 GMT  
		Size: 75.0 MB (75016883 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10-jre17-Semeru-ubuntu-plus` - unknown; unknown

```console
$ docker pull tomee@sha256:caa550a63b5244052738123937fbb4653b2f65ac00253e6c20d92cf3a2f8264f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.3 MB (4252970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d0a3988fef7fb09a0808ab03eeab10abeeb93fda8e74db25d6cba2a841bcf38`

```dockerfile
```

-	Layers:
	-	`sha256:9266a307c055c5ddd052a5da93041362e8928892587fea475649d91ae4b6a33a`  
		Last Modified: Fri, 01 May 2026 00:15:29 GMT  
		Size: 4.2 MB (4225097 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:65ce9c2b33ac7136c79cbe8ff9cbb132f38e8abd7c4bf6e8c2f3ce898cc9c0a2`  
		Last Modified: Fri, 01 May 2026 00:15:28 GMT  
