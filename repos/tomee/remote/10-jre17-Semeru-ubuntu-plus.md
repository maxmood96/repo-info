...
```console
$ docker pull tomee@sha256:50a3c645098ab0d540d6714641f2902f3200137b250f497630449b6de53678c3
```
...
```console
$ docker pull tomee@sha256:49f36f0a5bdd68d5c36f764b70414e575197af2cca9982d00e0a323f20d76c48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.3 MB (175254337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb283d1f65e407fffd3d4fb4645011ae1679650e798156cd23a29fa079ee56ac`
...
# Wed, 17 Apr 2024 02:16:02 GMT
ENV TOMEE_BUILD=plus
# Wed, 17 Apr 2024 02:16:10 GMT
...
-	Layers:
	...
	-	`sha256:71edaa92fc7be91e0cd5be221752b7188dc465244656225acee06b394780b557`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4067fc034f16b26cb747bacdb5c0a3ad45a1b0e2d8e611bce14eec099286635d`  
		Last Modified: Wed, 17 Apr 2024 03:00:05 GMT  
...
```console
$ docker pull tomee@sha256:f39861ae2b5e8cd9c471ef7f8068275d5733836c93fdac60283348ac4703581f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.9 MB (168942575 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8dc2a663d8db7b19be29c25c382b47741e5311c43e8c544d35c6171b4a6dac6`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Wed, 17 Apr 2024 02:24:12 GMT
ENV TOMEE_BUILD=plus
# Wed, 17 Apr 2024 02:24:19 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:24:20 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:24:20 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:63f5d897cfee17c9d84490a1603270c5918f1dda60e57b871b846682d173ab0c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f6d0d67449f3953ba70d1f9445467bbc1ef99a409e4398873a7a64ed209a891`  
		Last Modified: Wed, 17 Apr 2024 02:56:12 GMT  
		Size: 73.5 MB (73467633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
