...
```console
$ docker pull tomee@sha256:ed15481b6a121e3f517ca56f94ccd9e0e35fe5d9c85f4939eb0d002ad8f7e3fb
```
...
```console
$ docker pull tomee@sha256:d41ebe8ddd5c16952e33aa7bb8364f2d51fd16c43b4cfbac29eb93da9bd3190f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162110530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:272116e5f065af8e75e6287196924a0ed0217981a2cdb77de685b9d713b139f2`
...
# Tue, 24 May 2022 17:35:05 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:35:12 GMT
...
-	Layers:
	...
	-	`sha256:57cf12f0c6c9cdb111966d3e0b921d377ea4b3dd8798705d348882a04c7af6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84fe188bcaad5677073f24de72c0ab84ebab80f073fd2f76660b1f2fc2bd57ba`  
		Last Modified: Tue, 24 May 2022 18:45:12 GMT  
		Size: 70.5 MB (70525937 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-jre11-Temurin-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:9cd69fb7b333a72477373edb7186af74e1a733fc15b0087de0bf565bb93a70d7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158658800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a58b2beedaf6887d23218bff41f08e4186b9370adff22047e32b8e61073838a8`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M7
# Tue, 24 May 2022 17:56:20 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:56:25 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:56:25 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:56:26 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:927c739c39c0432ac0180e57913a1ada40c70f17505265af6124faac0e29a1d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09bcae17a094b796496af2be3fd65dc2834d194b9204c905fd4da43fad8e31e3`  
		Last Modified: Tue, 24 May 2022 19:10:18 GMT  
		Size: 70.5 MB (70525243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
