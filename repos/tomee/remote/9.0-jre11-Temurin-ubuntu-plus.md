...
```console
$ docker pull tomee@sha256:dff23f845c63b1075fe755e9ba337c39ab1aa056fe6eedce47276876e9e67840
```
...
```console
$ docker pull tomee@sha256:6b3b973d0b359e94731dea976eb85726b7c4bbacfb5c39c678fd06405a093870
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175470442 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a300e3c2a13f8be9c2979026978e946f80006f177df6ae6c5900643534a6a5b`
...
ENV TOMEE_VER=9.0.0
# Tue, 24 Jan 2023 02:42:48 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 Jan 2023 02:42:56 GMT
...
-	Layers:
	...
	-	`sha256:44138c3c9c555142605fc2cc8fdda7ed889c726c471ce15721f93e2f0fc65b00`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:942e8808cdeba0be4a98a5f3386c5217c5db333aad18586f22007341b750fc8d`  
		Last Modified: Tue, 24 Jan 2023 03:37:43 GMT  
		Size: 82.3 MB (82317103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-jre11-Temurin-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:e176a49679622c5a6d8ec7fcc878df21ff4ec168676951dd155292838df436ad
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171686327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc23a6413150900da0e7db815a4931e9628f633c1d1fc3bb5cad06e4da3edef1`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 Jan 2023 02:14:00 GMT
ENV TOMEE_VER=9.0.0
# Tue, 24 Jan 2023 02:14:32 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 Jan 2023 02:14:40 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 Jan 2023 02:14:40 GMT
EXPOSE 8080
# Tue, 24 Jan 2023 02:14:40 GMT
...
-	Layers:
	...
	-	`sha256:de1b87446359c7d0c6cc004cdff3d993bd3f892db73758d5318f3d67a9a87611`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15ab5f8c719d69c258cca9c6236bbd956e6f958afacaa97642709f659b7fd6ce`  
		Last Modified: Tue, 24 Jan 2023 02:54:02 GMT  
		Size: 82.3 MB (82317051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
