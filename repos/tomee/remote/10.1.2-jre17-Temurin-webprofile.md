...
```console
$ docker pull tomee@sha256:6d64ae4ef9ae01170d2f94401d3ebf29fd2ee6355b7fa4cf5ea1b6d64bf46bdf
```
...
### `tomee:10.1.2-jre17-Temurin-webprofile` - linux; amd64
...
### `tomee:10.1.2-jre17-Temurin-webprofile` - unknown; unknown
...
### `tomee:10.1.2-jre17-Temurin-webprofile` - linux; arm64 variant v8
