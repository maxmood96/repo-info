...
### `tomee:11-jre17-ubuntu-plus` - linux; amd64
...
### `tomee:11-jre17-ubuntu-plus` - unknown; unknown
...
### `tomee:11-jre17-ubuntu-plus` - linux; arm64 variant v8
