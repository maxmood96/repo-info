## `tomee:9.0-jre17-Temurin-plume`

```console
$ docker pull tomee@sha256:03562751f6334102b79f4d0bd9b6bba05e29dc2791e4e2317eb292038ce3d3de
```
...
### `tomee:9.0-jre17-Temurin-plume` - linux; amd64

```console
$ docker pull tomee@sha256:d799f105ddc0dfacf669d42c31e8efd34f34ed4e22b0b716bac8b0bd9c9645c5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186879104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf5442f18be03310a4ce02e1fbdc19975c883e4dfec6fe31dd472e9bebf102ed`
...
-	Layers:
	...
	-	`sha256:3f883fc6a74559483c9bf08b1c5679f0167a4d7f4b2e4a8cfe7dbfc32c9ab785`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52ffb92244e603968c4536dc9f4f76ad98e7373acf224311655088e379167fd0`  
		Last Modified: Tue, 02 May 2023 19:36:35 GMT  
		Size: 89.8 MB (89805339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-jre17-Temurin-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:1d90b79faa0effa1e098a7606206a1d1e457f6dae4080eef20c09c2883ee10c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.8 MB (185803428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6853c8a90ee0eb321d0ec29654260010e25fbdc04767159b96249510c7b83d4`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 04 May 2023 11:32:03 GMT
ENV TOMEE_VER=9.0.0
# Thu, 04 May 2023 11:32:27 GMT
ENV TOMEE_BUILD=plume
# Thu, 04 May 2023 11:32:35 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 04 May 2023 11:32:36 GMT
EXPOSE 8080
# Thu, 04 May 2023 11:32:36 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dceec55fee0d677d011579a1e79f240a7c4c2a0d59fd425de77ead168ea83468`  
		...
		Size: 62.9 KB (62909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60995484b351e5f53eb753456375fad79239917fb6acaa03ed12ba0e056c84c9`  
		Last Modified: Thu, 04 May 2023 11:45:38 GMT  
		Size: 89.8 MB (89805348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
