...
### `tomee:10.1.3-Semeru-plume` - linux; amd64
...
### `tomee:10.1.3-Semeru-plume` - unknown; unknown
...
### `tomee:10.1.3-Semeru-plume` - linux; arm64 variant v8
