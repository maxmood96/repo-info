...
```console
$ docker pull tomee@sha256:293856f8638a1bc95f6f9f5ed993d1b2b95f6d0135eb90b578bafd5e0f5df426
```
...
```console
$ docker pull tomee@sha256:967a32eee0497195fbf4c039b7142831fb3e1a19dcd4ba1742e4a5ff75c8302c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.3 MB (165311406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f5f0bf30ce28425525b3c721e9ed7cd995537ac7c66063fbf4ae373c6377eb5`
...
-	Layers:
	...
	-	`sha256:26beba76333d379071cc0db0b2ec09b05d2e56a56732936fe7d0a0a7890369b5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d4ce8845bc1f32b0fdf1d181b6edfcd1887b28508d6436e10baebd5315cb95c`  
		Last Modified: Tue, 24 Jan 2023 03:13:44 GMT  
...
```console
$ docker pull tomee@sha256:6f5b594371a63ea523b122008fab3464422597d61cbceb37b5fc119a8163dc90
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162115554 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48f23aa0783fd8647f1012b05e947780ffc171914b61ab06e9d5b524cccb3796`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.14
# Tue, 24 Jan 2023 02:10:25 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 Jan 2023 02:10:32 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 Jan 2023 02:10:33 GMT
EXPOSE 8080
# Tue, 24 Jan 2023 02:10:33 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:cf74abe0da35aa1e0ae50abade2a902e853d846b020753ddb3449be2d64ea2b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917dbeda6a7ea20cdab691d2c40a3dc931567607ccc0d2a2571030a32cfffddc`  
		Last Modified: Tue, 24 Jan 2023 02:36:39 GMT  
		Size: 70.0 MB (70045336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
