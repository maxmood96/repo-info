...
```console
$ docker pull tomee@sha256:09564d9adfe46bf248dddc0250475eb3b61cb248f9337b1a2ba09f7fee71abf4
```
...
```console
$ docker pull tomee@sha256:3d72f9210ef0419dfabf60e39d36d84973924c94bcefa026400d59d499393320
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.0 MB (152991578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:884bbb508f7ace813981991220df3fd642d31542fbeb5169c822647c8b7553c6`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:09:50 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:09:56 GMT
...
-	Layers:
	...
	-	`sha256:10f3d0d6c900647017b16c6f0ea81d9fb3b176293030502f70060df6296d37a9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f916082f1a30af5d5aabcb623db84213607f16dc2a1494062e2dd71541c6308`  
		Last Modified: Wed, 17 Apr 2024 02:39:07 GMT  
		Size: 59.8 MB (59814074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre17-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:bfb9651e9bd16090e505fc38439406bc64b5305b3fb57d4e1b16330dafc2dd7d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.4 MB (150355150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c48adc511d3fef239ac268ca1e254e28cc967552ed214796c43ccdef1a81dfda`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.3
# Wed, 17 Apr 2024 02:20:45 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 17 Apr 2024 02:20:51 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:20:52 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:20:52 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e73dcb1e9e9c14c9e158be672ae1cbe9ae9868fc421dab669315624f6223ac1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88aae93a594bbafd16dce0bddc36fdf219fb7f8edf9fa42649c519022375a6e7`  
		Last Modified: Wed, 17 Apr 2024 02:42:03 GMT  
		Size: 59.8 MB (59814122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
