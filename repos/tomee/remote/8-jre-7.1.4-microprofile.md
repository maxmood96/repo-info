...
```console
$ docker pull tomee@sha256:6a114f00f9c02577d815a513362e3f87c8e9177917d93ef86ebc5c4b29449b27
```
...
```console
$ docker pull tomee@sha256:b039baefc26150c687d67cb4c4829c5de78ade5cbb0b0f7ba0bd59d924e84fca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159168028 bytes)**  
...
ENV TOMEE_VER=7.1.4
# Wed, 03 Aug 2022 06:08:21 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 06:08:26 GMT
...
-	Layers:
	...
	-	`sha256:653cc36a050019a86432d1d5ff22935a033a788b3a21103bb77dc81bd773ab89`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94dcbb0d339d1cd64447dc7c9a0a72ba3c207abeee5b2e08a3ebccdb74480fb5`  
		Last Modified: Wed, 03 Aug 2022 06:38:06 GMT  
...
```console
$ docker pull tomee@sha256:9622abe381a63e9164a49077fc36751c59b9b92d945c6eb6dbe6cdd88723185b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156865875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65afd5695155a2583ad5d9361d9d8d8691baf0a6bf53180681282842ade497b8`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.1.4
# Wed, 03 Aug 2022 03:41:39 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 03:41:43 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:41:44 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:41:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c714c0bc0e87d52ee29aea6f30d1be5991890569089f494372ce9ba2553886ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bcc4174637da82c232b8c888a2100d09e3666ae93c22fe07605c99a4786d8ce`  
		Last Modified: Wed, 03 Aug 2022 04:34:52 GMT  
		Size: 41.0 MB (41032056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
