...
```console
$ docker pull tomee@sha256:409e4899c4f8ba36a3b5770efe930a8547842d3bec55170d833f8dc70d2e6092
```
...
```console
$ docker pull tomee@sha256:e02da3312118ba5f1d7f39268cf99ff2b4295d37d0471bff3117237add14bfa2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.7 MB (156661051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac3238cc31dd344ae0aeb4a407b02a6ca486677730e0fc5ad098cd4768c0f205`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.1.4
# Fri, 24 Jun 2022 03:52:33 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 24 Jun 2022 03:52:39 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Fri, 24 Jun 2022 03:52:39 GMT
EXPOSE 8080
# Fri, 24 Jun 2022 03:52:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9a5817782f9fcaba689dd5d6a4f1cf0c0585d347e521d481b142df6dbfa0feb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2257dabd5c8d515d54541ae1574b1545757ad0db12c0c69ab9c6d675ec062d4`  
		Last Modified: Fri, 24 Jun 2022 04:20:44 GMT  
		Size: 41.0 MB (41032042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
