...
```console
$ docker pull tomee@sha256:e23993b4767cdbf2793a6254aed051d40ec52a191caa76dfc74ae93033340fda
```
...
```console
$ docker pull tomee@sha256:8cc55a250faa84b804086e836b097c1cfb747b95624b4bb69e90eb3e96e1a42d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159168565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a8db34346c35c96dd31834306cf9dfff81da5e3808ba0b28098ee2589cfb1ab`
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a909daaa228d35aaab8f0d0f135a775732d6ed4b9cb5ae22c11caf5fbad8bcd`  
		Last Modified: Tue, 12 Jul 2022 20:08:42 GMT  
...
```console
$ docker pull tomee@sha256:2d2ce377d6574ce735a360cc949fe20655d84e19ed9a6c11a9b82645c7b5ced2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156850980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffaf49f5fa7eead21581c156c538f63d4d8e9ac977f29c1a1191e0935cee4e89`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.1.4
# Tue, 12 Jul 2022 20:10:47 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 12 Jul 2022 20:10:53 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:10:53 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:10:54 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4aa9368159ecf0de5f71002310d52b531a0ca8cf8258d83dd983a86278c7b79`  
		Last Modified: Tue, 12 Jul 2022 20:47:48 GMT  
		Size: 41.0 MB (41032051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
