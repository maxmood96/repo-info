## `tomee:8.0.11-jre11-Semeru-ubuntu-plus`

```console
$ docker pull tomee@sha256:5c89a955ac62c78b723dedbada27b329bc955e95cd6ff7e230e583e8c3d1cb6f
```
...
### `tomee:8.0.11-jre11-Semeru-ubuntu-plus` - linux; amd64

```console
$ docker pull tomee@sha256:934901df74284e90c33126d3aa67fb6f9ea79264a815b29e4ba3417bcbb610d6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.1 MB (170138571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fa85804297224553b925e55773546a153b57848b5ab6afbbf3dbd53a65813b8`
...
# Tue, 24 May 2022 17:31:58 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:32:05 GMT
...
-	Layers:
	...
	-	`sha256:2d676fc584e8b40814470a0048d84bd24608b0d3a6ca8c4ad5d0f0b3a56089fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04b448a184cee788d941a95b916f311f80e98f0327fc2e23b5f459ccfc0a6902`  
		Last Modified: Tue, 24 May 2022 18:33:00 GMT  
		Size: 70.0 MB (69989535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre11-Semeru-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:0b31ab0da22d4220a797dd35a32f201cba7bbc9cd6c0f2cc7d429b3ae92b3dc0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166341239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1933a27c0fac0a07b455a846108c5abcb101de8b0940af08156edd97ec469d30`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:53:05 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:53:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:53:12 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:53:13 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d93f90e2cd98c9cb80ecb182f3948cb4315b8f4e35a5158640f95663c4a1b4a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f06626c1b4e881e54c459cf7f9039f03ad19c89d03d2a7eee4995bb4c6565abc`  
		Last Modified: Tue, 24 May 2022 18:59:24 GMT  
		Size: 70.0 MB (69989164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
