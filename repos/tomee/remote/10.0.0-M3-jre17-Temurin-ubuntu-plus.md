...
### `tomee:10.0.0-M3-jre17-Temurin-ubuntu-plus` - linux; amd64
...
### `tomee:10.0.0-M3-jre17-Temurin-ubuntu-plus` - unknown; unknown
...
### `tomee:10.0.0-M3-jre17-Temurin-ubuntu-plus` - linux; arm64 variant v8
