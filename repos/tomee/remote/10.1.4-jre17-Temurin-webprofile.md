...
### `tomee:10.1.4-jre17-Temurin-webprofile` - linux; amd64
...
### `tomee:10.1.4-jre17-Temurin-webprofile` - unknown; unknown
...
### `tomee:10.1.4-jre17-Temurin-webprofile` - linux; arm64 variant v8
