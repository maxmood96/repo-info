...
```console
$ docker pull tomee@sha256:a781701d3377b6925a2d4fe43d9ccfdaa877d4369dc32a28c816d2659c7e525c
```
...
```console
$ docker pull tomee@sha256:acf0916dd38317f2a4e3a4ead94efb1c752c39a0dede98f832302eab4b7ef945
```
...
-	Image ID: `sha256:710fc232830a77391733f28201b1e914c72921055d6fa9683bdbaf241194c75e`
...
-	Layers:
	...
	-	`sha256:d19b3724d7a9d7c4cc299c8fa160adce78dad570a8e4551103170ea07da2d6a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba3b0aab259df76fdf3112f76b670be5da034379dc479c807c6a6696c4f6e788`  
		Last Modified: Wed, 03 Aug 2022 07:09:42 GMT  
		Size: 46.8 MB (46800418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-Semeru-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:2d6568af184d375a32b68e55fe3dbe091f83e7614bac527abd21443e681db183
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143511790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cbc2c2b268544f95c8e0e4fa3d0758f7e614f6c854c81bad7f8b8ec09e0117e`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:52:56 GMT
ENV TOMEE_BUILD=webprofile
# Wed, 03 Aug 2022 03:53:03 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:53:03 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:53:04 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0557e9cee0e5f43359d39c868d2bac7ecbf9d096dbb93ed68b2f626daab80c76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fc49d5ce5bd80111eaf10a8c69403d6900896bba45d200d757643b1f21e4208`  
		Last Modified: Wed, 03 Aug 2022 05:11:08 GMT  
		Size: 46.8 MB (46799858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
