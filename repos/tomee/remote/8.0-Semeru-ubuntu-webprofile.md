...
```console
$ docker pull tomee@sha256:98e7ad9517e4b69a59554c8753a4bce1c782150df307cd1c310f33fc025a0854
```
...
```console
$ docker pull tomee@sha256:306ea802b075a8c08801db89e22e365136382011aaac37a9352dd6c6e5194fde
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.6 MB (147562924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ec23c6b5512998bf310532eab180f3ff6c74e2c31d45f0bc8c38a3437e8e213`
...
-	Layers:
	...
	-	`sha256:e883363c2b074b7d1875bf5c6ead198b4928b9110ac3dbe895de2a16068af77b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3673775b64ca492006dbb004454f82df2a7d571e0c904d3f95e882c1df5d462d`  
		Last Modified: Tue, 07 Jun 2022 05:50:41 GMT  
		Size: 46.7 MB (46706905 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-Semeru-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:bdf7e8a7bc22c0788770e3fe095a3def7b3b2369e4e3ea29446ef9f2b501193a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.3 MB (143327185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e23886e3622c853269f56dd1535f0dedcf0ba96cba32131725bf256fbd5482d`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 May 2022 17:50:17 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:50:18 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 24 May 2022 17:50:23 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:50:24 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:50:25 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0cab82a72f83edde43510a96fef2afd6c2d3bdfd6480860952a05da203d938c3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9da74f19231fda237604f2cd27bdf14edf57943a9f73da696b6bc0325e0aef80`  
		Last Modified: Tue, 24 May 2022 18:51:59 GMT  
		Size: 46.7 MB (46706501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
