...
```console
$ docker pull tomee@sha256:6134b45a03404b4e637691153a325d2ab342de37df36ee8b25b37733a567f0db
```
...
```console
$ docker pull tomee@sha256:aa7c5d735b4cb24946a33868b698f9e267e72dd211bc12f3788b0866dde7ec08
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.6 MB (149550841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5918357a6d9afc1b567b8a5655142647566762920752db2009a90e12c517f20`
...
-	Layers:
	...
	-	`sha256:bd5b02cb23325cd32c5891d2939bdcc789ca71ed84e0579bdf6f072752c0c6f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b7f24de214c7e06d9e20e0a45a1a07e1edd7f67c7ef497c76449c71de0c7f0e`  
		Last Modified: Sat, 02 Dec 2023 11:05:37 GMT  
...
```console
$ docker pull tomee@sha256:d169fe190ab718ad91bb7eb130333c596f2f03fcf560f9816be2c5a36b44a99a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146583089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:661555ea011c7621d7dc295201bdb04a5b35a09dd0a92e0a89a23ffbb183405d`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 02 Dec 2023 10:57:07 GMT
ENV TOMEE_BUILD=webprofile
# Sat, 02 Dec 2023 10:57:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 02 Dec 2023 10:57:13 GMT
EXPOSE 8080
# Sat, 02 Dec 2023 10:57:13 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:bcae03da1057d86ff44a3dd92a774ee96eba5120361327a6e4f333b303f1f9f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c392dd35a511f10415921aa4e8056eb59c27ae356be7a56f72d181e9ae545aa0`  
		Last Modified: Sat, 02 Dec 2023 11:19:46 GMT  
		Size: 49.0 MB (48986087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
