...
### `tomee:10.0.0-M3-Semeru-ubuntu-plus` - linux; amd64
...
### `tomee:10.0.0-M3-Semeru-ubuntu-plus` - unknown; unknown
...
### `tomee:10.0.0-M3-Semeru-ubuntu-plus` - linux; arm64 variant v8
