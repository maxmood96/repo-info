...
### `tomee:10.1.1-jre21-alpine` - linux; amd64
...
### `tomee:10.1.1-jre21-alpine` - unknown; unknown
...
### `tomee:10.1.1-jre21-alpine` - linux; arm64 variant v8
