...
### `tomee:10.1.4-jre25-Temurin-ubuntu` - linux; amd64
...
### `tomee:10.1.4-jre25-Temurin-ubuntu` - unknown; unknown
...
### `tomee:10.1.4-jre25-Temurin-ubuntu` - linux; arm64 variant v8
