...
```console
$ docker pull tomee@sha256:d0a2c7ba38c6bb014739dff89466e645583323ff710771faa37a9a1a3426f9da
```
...
```console
$ docker pull tomee@sha256:b1034f7bbc425a699ed0d9eed7ca98b90837bc5f29365adb6b98ac3ec1d098c9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.6 MB (180579720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd4aad3e40ce126df422774eed05cfe37bd84da5839134481d528d7f983a0e6a`
...
# Thu, 04 May 2023 15:45:05 GMT
ENV TOMEE_VER=9.0.0
# Thu, 04 May 2023 15:45:37 GMT
ENV TOMEE_BUILD=plus
# Thu, 04 May 2023 15:45:46 GMT
...
-	Layers:
	...
	-	`sha256:82c3df8c9cd853af476f60a9f9789331a681048ef19d3e4e5c574f4642ae5569`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcaf4013419ecb3ecfd8d5bdee503ad31f87d228b21d02ad96b36b95a165dc36`  
		Last Modified: Thu, 04 May 2023 16:07:45 GMT  
		Size: 82.3 MB (82317080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-Semeru-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:c5373441477236d9c9092df9ace0c441b24cced1aec167c26ddb8e43c8c39223
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176577248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b2204839df39ffffa98645043c6ec354313fb1120f0010e3ab5ee0cf198bfa8`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Jun 2023 02:16:53 GMT
ENV TOMEE_VER=9.0.0
# Fri, 02 Jun 2023 02:17:29 GMT
ENV TOMEE_BUILD=plus
# Fri, 02 Jun 2023 02:17:37 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 02 Jun 2023 02:17:37 GMT
EXPOSE 8080
# Fri, 02 Jun 2023 02:17:37 GMT
...
-	Layers:
	...
	-	`sha256:df5b4113661aac1bab87158b30cf977fe1248045a71501fd4c51277bacbf2513`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c69ce32ccea647f85e0135994350bd50f14b0416644a04d1eaa5a21bab04dd6`  
		Last Modified: Fri, 02 Jun 2023 02:32:15 GMT  
		Size: 82.3 MB (82317047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
