...
```console
$ docker pull tomee@sha256:548d3eb10d554d824f7b8119f995c77ea8f81d94515b676a482b222e86ec3ad9
```
...
```console
$ docker pull tomee@sha256:2d89cfe599c3ec3c21465d118fe35505aede6b3ec4433313397bb2cdc4d561da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.3 MB (171345616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:027286d17c76dc42be11c4c749e325c0cd1e2e27dd69695a0784462b42ca56c4`
...
# Tue, 24 May 2022 17:36:58 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:37:06 GMT
...
-	Layers:
	...
	-	`sha256:2b0544e87022f4984c4234d028c3e6109a773d8b4cc6eadeb51ca28f0843bb5c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ad851e9e8bad0baa02899f425274953b411968b53296e27262eb342073670cb`  
		Last Modified: Tue, 24 May 2022 18:50:23 GMT  
...
```console
$ docker pull tomee@sha256:abba68f84311d4c72589a47e62fb785f07e47278c1163610250ed83153c2ea97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167146031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:470597611ecb8fa25beb95d5f486bfe1e4e3f554c5102331aad4b89e87bc4237`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M7
# Tue, 24 May 2022 17:57:43 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:57:50 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:57:50 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:0cab82a72f83edde43510a96fef2afd6c2d3bdfd6480860952a05da203d938c3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:858e8f95be6c3ed68d33047f4b9db62229fa0a9843dcd9594f88663b4304e23f`  
		Last Modified: Tue, 24 May 2022 19:14:07 GMT  
		Size: 70.5 MB (70525347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
