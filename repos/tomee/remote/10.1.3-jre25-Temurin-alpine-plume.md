...
### `tomee:10.1.3-jre25-Temurin-alpine-plume` - linux; amd64
...
### `tomee:10.1.3-jre25-Temurin-alpine-plume` - unknown; unknown
...
### `tomee:10.1.3-jre25-Temurin-alpine-plume` - linux; arm64 variant v8
