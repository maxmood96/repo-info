...
```console
$ docker pull tomee@sha256:d75b0cde4fbfbef79ac76bb500c161ce2e742f021340a510d47f0a79c0c228d7
```
...
### `tomee:10.0.0-jre21-alpine-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:12e26b960edcb8da42b1f828314c1373523a5940eb504260913a2deac7ffa01d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.1 MB (147133231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3677aadc583b82a6af381cd18b790f0f6691fe4b0e0c198f6a9e06a1b4128ae6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:eb65cd74a8a4a732ece770009227e25e21d515da3d83c6d4b078331b843f7f1b`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f6fb6e27c24197df961b5e8dec397cfefbdb671f7dfd3517561cca3a6c57bc74`  
		Last Modified: Mon, 10 Mar 2025 17:36:21 GMT  
...
```console
$ docker pull tomee@sha256:c052fa1b1e5effd8649208a8c19cfb12f067376463976c50d8f1403c32049027
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.3 MB (1318495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bedd19c17fb585144bb4e5fc6542c215f854f1bbc0b4ea323ee68189fe16e527`

```dockerfile
```

-	Layers:
	-	`sha256:7b89c9a43f0a802d439655e53df3552d1eeca93229f7761fa709ba10051e0f69`  
		Last Modified: Mon, 10 Mar 2025 17:36:19 GMT  
		Size: 1.3 MB (1289182 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ae391888fa87b7a4e80665210a247fa092b51d5bcc0cd67c11dc1bb42b0fb8f1`  
		Last Modified: Mon, 10 Mar 2025 17:36:18 GMT  
