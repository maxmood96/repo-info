...
```console
$ docker pull tomee@sha256:7aa7f56e821893977e3a0ff63069483c9604e522c20486600a0bdcf063964c2e
```
...
```console
$ docker pull tomee@sha256:778dd3a47f585eceaf802b66220cb628b0f3d75f80d0584ec7a5a805c1219500
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.9 MB (174930944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:625d2111fde39aa5fabfff2f18e511d3111fe306a3abf896f5e03033ffa6c28c`
...
-	Layers:
	...
	-	`sha256:7c652889d8a2b148dba4c0d8b8a8674fbda0b9a5df1660bfb47ca6fca752dc1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87595d4ffde6c018c3c8accef1f25dfc606b2c81bfbb9f5ab615f04416d47cfe`  
		Last Modified: Thu, 25 Jan 2024 22:13:04 GMT  
...
```console
$ docker pull tomee@sha256:5c525423b8bc18449e430f69ac32053547805f5d1ee65bd962b5088dacf9a466
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.1 MB (171140321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d08e8e0413a6ca2d92d8e39d85fdb4c2f5ead75448d95a81cc5f05a140bcfd5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 23:45:55 GMT
ENV TOMEE_VER=9.1.2
# Thu, 25 Jan 2024 23:46:19 GMT
ENV TOMEE_BUILD=plume
# Thu, 25 Jan 2024 23:46:27 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 23:46:28 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 23:46:28 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d0ed31c12a4044c440b1740c94bc9dfd82359f31189f4a5cf69e6539e2db9573`  
		...
		Size: 69.3 KB (69322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be8cb915f4611a3de189bf5d0d0297aeeee6dc52fb538ae25fed1830ddfba9e7`  
		Last Modified: Fri, 26 Jan 2024 00:09:56 GMT  
