...
```console
$ docker pull tomee@sha256:c8eb03b672a684472528da5a17fba80dbc5c40ae48b60deba549c9eeddd472ea
```
...
```console
$ docker pull tomee@sha256:69d69068e891f8506a09a841804501e47f5c3da71273334f354e586fd1be235b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.9 MB (174931802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64c68cf70793756b29317ff0b22773deec1d2438605ca7cab2fbe2f64cc0c225`
...
# Fri, 02 Feb 2024 14:14:00 GMT
ENV TOMEE_VER=9.1.2
# Fri, 02 Feb 2024 14:14:24 GMT
ENV TOMEE_BUILD=plume
# Fri, 02 Feb 2024 14:14:32 GMT
...
-	Layers:
	...
	-	`sha256:deb0c6f63914965a08e99ed9b5f642b2f742f2af128cb41eca4edee6b108083f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82e93b1e471d1b4de5dd4ce2bb3982b2c292b71dc6c91b2ba660f302d939f737`  
		Last Modified: Fri, 02 Feb 2024 14:48:47 GMT  
...
```console
$ docker pull tomee@sha256:985fa6204df862d49f568a94f46601063a5eba199f29ad033eee0ec3ceff968a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.1 MB (171140281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dbb9d2e6daef9d6b8db5cd02ce9b27d37e4207d0985d09206a557f2ea5c97c7`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Feb 2024 05:50:04 GMT
ENV TOMEE_VER=9.1.2
# Fri, 02 Feb 2024 05:50:27 GMT
ENV TOMEE_BUILD=plume
# Fri, 02 Feb 2024 05:50:35 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 02 Feb 2024 05:50:35 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 05:50:35 GMT
...
-	Layers:
	...
	-	`sha256:2aeb9017e0606895360b4a08491dcaa5870233a47a2022a61f49bd4be1775ad8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:436182ee4162609688620058df87ef172be03daa3fa5ed21fc17e87f2d942e3b`  
		Last Modified: Fri, 02 Feb 2024 06:21:37 GMT  
		Size: 81.8 MB (81839400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
