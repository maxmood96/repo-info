...
```console
$ docker pull tomee@sha256:ae92bc7b75dc6352360c82f0da0222ec4c4cf96d984f4759b6bad7df8ac64397
```
...
### `tomee:8.0-jre11-debian-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:ec8de72dd8e0ab663d7542fc45ba921873d6c49ba37bfc8b5f95f5ee5b9c6497
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (188957818 bytes)**  
...
-	Layers:
	...
	-	`sha256:d62b3288337dc4a8315ef395fde38897c2f298a5cf3fa12e9b401dd21f9aa184`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee4d750ae21f66c8539f0c14530a24cadf381633620690448b04b8fc9d9f1dd7`  
		Last Modified: Tue, 12 Jul 2022 20:12:29 GMT  
		Size: 65.0 MB (65007200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre11-debian-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:65742fff50676b483a700819777391f4a416c90c4a83a51ad4bad055339d154e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.7 MB (186701354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb6e0e9667cb26643a8d1352b21380aa42ac09ea90ce49b1a20e55b3fc032ebd`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Tue, 12 Jul 2022 20:12:08 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 12 Jul 2022 20:12:16 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:12:16 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:12:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e3b39ff87b224496eb3f610c7295670f22cf090e45269eb03cb26bdb3df1c798`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb857dd14d1a8c94896d398184ea5841dc72c8f18237d846a429e8547898a2aa`  
		Last Modified: Tue, 12 Jul 2022 20:52:03 GMT  
