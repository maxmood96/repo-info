## `tomee:9.1.1-Temurin-ubuntu-microprofile`

```console
$ docker pull tomee@sha256:fbfeb55e51db5df73c3295f68a965651b04af99a33cc8eed2eb58170b69d05a8
```
...
### `tomee:9.1.1-Temurin-ubuntu-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:eb4a2c54685ef008d9de5ff0fe469a76a689ae0961c02fa749fb6449240eadfd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166331639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a1e159862dfbf41e3e61ec97b612745e641e6b18a4ee60e7636ac79f0695f1d`
...
-	Layers:
	...
	-	`sha256:3e9ba2c5e5b0640249599a2314ce7ace4edda28953253f726e6100e7d9ef7df3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:057a57eabe40577108f23178215b3317a2336784753254fbaff9798c9fc7df2c`  
		Last Modified: Tue, 31 Oct 2023 02:49:48 GMT  
		Size: 68.6 MB (68624197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1.1-Temurin-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:0f41ee6a5759babc35d0c0780dc93bb2e748c5361b36d4be4419cc4b24cfdaad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165150092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39b690a07d3f2db6f9dc9bcaa7b895295406e1fa1e85eaca7fa7edaec8d7b95b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.1
# Tue, 31 Oct 2023 03:30:18 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 31 Oct 2023 03:30:26 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 31 Oct 2023 03:30:26 GMT
EXPOSE 8080
# Tue, 31 Oct 2023 03:30:26 GMT
...
-	Layers:
	...
	-	`sha256:154b57109239eb1a086d677332ff414e89b18cf6e58918d43cf704a04440db87`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe9d77402d82bf16885f67e78e2334f9c595600554b4f095b029cff81e9733b0`  
		Last Modified: Tue, 31 Oct 2023 03:48:27 GMT  
		Size: 68.6 MB (68624218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
