...
### `tomee:10.1.4-Temurin-alpine-webprofile` - linux; amd64
...
### `tomee:10.1.4-Temurin-alpine-webprofile` - unknown; unknown
...
### `tomee:10.1.4-Temurin-alpine-webprofile` - linux; arm64 variant v8
