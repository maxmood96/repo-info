...
### `tomee:10.1.4-jre25-ubuntu-webprofile` - linux; amd64
...
### `tomee:10.1.4-jre25-ubuntu-webprofile` - unknown; unknown
...
### `tomee:10.1.4-jre25-ubuntu-webprofile` - linux; arm64 variant v8
