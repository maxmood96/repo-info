...
### `tomee:10.1.2-jre25-alpine-microprofile` - linux; amd64
...
### `tomee:10.1.2-jre25-alpine-microprofile` - unknown; unknown
...
### `tomee:10.1.2-jre25-alpine-microprofile` - linux; arm64 variant v8
