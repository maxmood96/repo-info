...
### `tomee:10.1.0-jre17-ubuntu` - linux; amd64
...
### `tomee:10.1.0-jre17-ubuntu` - unknown; unknown
...
### `tomee:10.1.0-jre17-ubuntu` - linux; arm64 variant v8
