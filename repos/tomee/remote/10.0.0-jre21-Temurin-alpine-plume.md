...
### `tomee:10.0.0-jre21-Temurin-alpine-plume` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-alpine-plume` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-alpine-plume` - linux; arm64 variant v8
