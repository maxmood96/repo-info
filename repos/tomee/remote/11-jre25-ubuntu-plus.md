...
### `tomee:11-jre25-ubuntu-plus` - linux; amd64
...
### `tomee:11-jre25-ubuntu-plus` - unknown; unknown
...
### `tomee:11-jre25-ubuntu-plus` - linux; arm64 variant v8
