## `tomee:10.1.0-jre17-Temurin-plume`

```console
$ docker pull tomee@sha256:9810ab7b8aaac4e584ee1635aa78b64c448f6e3a784fb89df03f83c94e6a079f
```
...
### `tomee:10.1.0-jre17-Temurin-plume` - linux; amd64
...
### `tomee:10.1.0-jre17-Temurin-plume` - unknown; unknown
...
### `tomee:10.1.0-jre17-Temurin-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:28a95339c2eb59ea6ed2cf5d5afede5f6730efffd943a4d3c15ba9d3a30407fe
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.3 MB (175280057 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0808388d65bded2d84e84ae9cceb82887860b6ed9b764e01be101d3ee1128c79`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:2a10a4047d9c15ebc05411ff024cfc03abe560964acf9cf0cfc698ff2fa32b1e`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8bc477a57a2c50857f98a258dc5a5fe5fa061982ee695e0a3ccb9e1d03f42b2a`  
		Last Modified: Wed, 02 Jul 2025 11:47:52 GMT  
		Size: 82.9 MB (82882610 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:10.1.0-jre17-Temurin-plume` - unknown; unknown

```console
$ docker pull tomee@sha256:dc98126752fb1ef1e18fce1acf0e27a1eb4d3eb08833fa6e3d708e2df7da725b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3731575 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60fa5d195edf0c265c3a69691ce75b068726aa6425f53d718a74ca9ed0c69c70`

```dockerfile
```

-	Layers:
	-	`sha256:b9d521895f1597545d5ba899a2c49034c3d6df9689f9267b5edb71caec9fb202`  
		Last Modified: Wed, 02 Jul 2025 13:12:56 GMT  
		Size: 3.7 MB (3700800 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c5d89c6544ab93cb0d98782d6845cdd9b631d9328e3dcf05c31773812e22d855`  
		Last Modified: Wed, 02 Jul 2025 13:12:56 GMT  
