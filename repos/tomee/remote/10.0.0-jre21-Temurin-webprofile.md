...
### `tomee:10.0.0-jre21-Temurin-webprofile` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-webprofile` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-webprofile` - linux; arm64 variant v8
