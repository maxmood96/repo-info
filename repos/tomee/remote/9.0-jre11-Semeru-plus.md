...
```console
$ docker pull tomee@sha256:b66b8ed217e33880c6ae45f6caff82f47ba100c46b61817218d7462ed95246ce
```
...
```console
$ docker pull tomee@sha256:00c20bb6811d8c5b89e06222ec0d1c06fc22e3a85172e3346c538e4577a2d35c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170674963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44cc861b8cee891e8d19c99d1a683e83ba7d8a1bfaada6fe9c554d83af04c494`
...
# Tue, 24 May 2022 17:39:39 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:39:46 GMT
...
-	Layers:
	...
	-	`sha256:2d676fc584e8b40814470a0048d84bd24608b0d3a6ca8c4ad5d0f0b3a56089fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3869cc67e014f0d866c51d51fb9ce996f9dbc73abc00f4c3e005c72b1e983da`  
		Last Modified: Tue, 24 May 2022 18:52:37 GMT  
		Size: 70.5 MB (70525927 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-jre11-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:e93c3f6986bdebf5c238f4bd7b5149b8381dfc87195335fc1716101c34a79edb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166877439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c99b6688bbcd7726e221d8bb7977a493ab05beb93945fc2d90478b549b6ef335`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M7
# Tue, 24 May 2022 17:58:54 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:59:01 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:59:01 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:59:02 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d93f90e2cd98c9cb80ecb182f3948cb4315b8f4e35a5158640f95663c4a1b4a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18d3888369c15bf4dbc52086f07d8678ffebc568fbc6e4cb40263510337f33a0`  
		Last Modified: Tue, 24 May 2022 19:16:44 GMT  
		Size: 70.5 MB (70525364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
