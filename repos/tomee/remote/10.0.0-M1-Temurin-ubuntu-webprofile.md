...
```console
$ docker pull tomee@sha256:e65aea228705053be07a0fa7e4adce05f482f6896b1118d12dcba395882358ec
```
...
```console
$ docker pull tomee@sha256:0669e6759ccc6bf35fb50cd580b0d421942728763b34da1ce1f58e60f64a6b99
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.8 MB (152790107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:312b3c934130b221f7d866b0bbe4dcf93526ef539d971ddd28bda7a8b07a54c7`
...
# Fri, 26 Apr 2024 04:12:23 GMT
ENV TOMEE_BUILD=webprofile
# Fri, 26 Apr 2024 04:12:30 GMT
...
-	Layers:
	...
	-	`sha256:8920132a75ddb6ccab67248f72f9c7938b18058c9c5a1a0234a7e98a19648410`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77497d1bb9ff0a3c97ac1dc0ab78dec3ffee8cb150a9e20fdabc315b8b1b5b46`  
		Last Modified: Fri, 26 Apr 2024 04:33:28 GMT  
		Size: 59.6 MB (59589882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:10.0.0-M1-Temurin-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:dd99db37e687c767ed652b739042b3d4a4d64b381ebe4d32371fb4b4a14b9e6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.0 MB (149047172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a7f455dd1dc496aab90cf54a2dad50eb31728774e989cf8e7602ce70e6aeeaa`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Fri, 26 Apr 2024 03:39:07 GMT
ENV TOMEE_BUILD=webprofile
# Fri, 26 Apr 2024 03:39:14 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 26 Apr 2024 03:39:14 GMT
EXPOSE 8080
# Fri, 26 Apr 2024 03:39:14 GMT
...
-	Layers:
	...
	-	`sha256:9120245afa546e46739ba24a3099335bb96ea859fc47f68b7fc37ff1082b04de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88627f528b75fa7177b47d4c184739b1f66e4e80274d3c4583d04d828baee222`  
		Last Modified: Fri, 26 Apr 2024 03:56:47 GMT  
		Size: 59.6 MB (59589907 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
