...
```console
$ docker pull tomee@sha256:7374519171e86222610ff599f383990ee8fbb61123d10106f82e4557d214e5ec
```
...
```console
$ docker pull tomee@sha256:c2cc729f2b75a6b750ec3757c304eca4889de7b078d7c882dccb15f02dbe86b8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158656523 bytes)**  
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25136db5ff5b9a5d29f4020e37fb40b45080d9a28826cc499d8ec0cc88a692fb`  
		Last Modified: Tue, 12 Jul 2022 20:08:55 GMT  
		Size: 40.5 MB (40520449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:7.1.4-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:a7d6b9e4197943d69bd5676693b767edfd4b1bdee1c25edfc1568653e2244867
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156338915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a20763dde56e57c2e41739cd441e7ea047db6f356f10f4be0176994c98ac74b7`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.1.4
# Tue, 12 Jul 2022 20:10:59 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 12 Jul 2022 20:11:04 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:11:04 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:11:05 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc32a7f040dd1d90ec6d4cdc07f1a4a90fb7d6cb8f44abc8ce1954fa219f5296`  
		Last Modified: Tue, 12 Jul 2022 20:48:03 GMT  
		Size: 40.5 MB (40519986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
