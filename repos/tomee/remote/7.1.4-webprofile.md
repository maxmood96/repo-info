...
```console
$ docker pull tomee@sha256:6cf24568fa1b21d4c36689bc2fdee96e3c829bac3b3860f5ae8614d0b20ae40d
```
...
```console
$ docker pull tomee@sha256:6fb7da6f48089189401c8c53bf42cfada30fc0fd562621e15b51cbffd239bd08
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156148950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbee5d3c120d799f1c40d679071659326e529f7c2f291bf11347b745c58e7d99`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_BUILD=webprofile
# Fri, 24 Jun 2022 03:52:50 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Fri, 24 Jun 2022 03:52:51 GMT
EXPOSE 8080
# Fri, 24 Jun 2022 03:52:52 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9a5817782f9fcaba689dd5d6a4f1cf0c0585d347e521d481b142df6dbfa0feb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c75ab5716b0495097b6be584852671ce71a252ac3546c3fc8f4e6ee95894a2a1`  
		Last Modified: Fri, 24 Jun 2022 04:20:59 GMT  
		Size: 40.5 MB (40519941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
