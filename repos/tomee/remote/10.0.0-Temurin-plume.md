...
### `tomee:10.0.0-Temurin-plume` - linux; amd64
...
### `tomee:10.0.0-Temurin-plume` - unknown; unknown
...
### `tomee:10.0.0-Temurin-plume` - linux; arm64 variant v8
