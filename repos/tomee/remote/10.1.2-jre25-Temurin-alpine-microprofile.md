...
### `tomee:10.1.2-jre25-Temurin-alpine-microprofile` - linux; amd64
...
### `tomee:10.1.2-jre25-Temurin-alpine-microprofile` - unknown; unknown
...
### `tomee:10.1.2-jre25-Temurin-alpine-microprofile` - linux; arm64 variant v8
