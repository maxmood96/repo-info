...
```console
$ docker pull tomee@sha256:5e3d70a2f688e8f20809481403a2aa876960286564bf9f87fec7921b27098c66
```
...
```console
$ docker pull tomee@sha256:f01a4497f99a414811d5ecf723c2ef0fb877b60c448af151042d56a2b8cd1586
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.1 MB (166118347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a854e8090bcfe0ba830e591ac20154b557f34b0977fa937ee905096e56b7f1e8`
...
# Fri, 02 Feb 2024 14:08:44 GMT
ENV TOMEE_BUILD=plus
# Fri, 02 Feb 2024 14:08:51 GMT
...
-	Layers:
	...
	-	`sha256:00120ce143019864b89b5508c706f312ee46aea77bdd86883cdac9ac9eefe149`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:620d85925af628090d3087420c9ec161d84a94821c9260017d1aae78e53d8c28`  
		Last Modified: Fri, 02 Feb 2024 14:32:09 GMT  
		Size: 71.3 MB (71275465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d2aa6f0a1a38a3bbe866b64cf09f3184a645e23e1272830c7143d3052a00c6b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162913688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6374427ef011a558fd2112e047b04e05992d8d8cb19adce877a04464dc22507`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.16
# Fri, 02 Feb 2024 05:45:46 GMT
ENV TOMEE_BUILD=plus
# Fri, 02 Feb 2024 05:45:53 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 02 Feb 2024 05:45:54 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 05:45:54 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:13968909546fcd253fef4bec3ffd01687b3fa2f815602aa304a6e59bcfdf6432`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04f7801c868a1719c99366edcba7329a2c482f709f4cf2abbd27c105355d0fc3`  
		Last Modified: Fri, 02 Feb 2024 06:06:07 GMT  
