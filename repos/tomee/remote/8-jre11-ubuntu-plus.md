...
```console
$ docker pull tomee@sha256:fa00a64f593bba41bc14c62231b509c09340c0d690a4b7bcc9a0d49ce2153e65
```
...
### `tomee:8-jre11-ubuntu-plus` - linux; amd64

```console
$ docker pull tomee@sha256:5598b23d0a60e90ee660af359dc5e96ef8b320455984173c3e00c4daa137fd61
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.6 MB (161574164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:776f6e11419f77ec15f2b32e33dcf684671c0ac07c4f7e1f35b0aeb2d9aa6b0e`
...
# Tue, 24 May 2022 17:26:25 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:26:32 GMT
...
-	Layers:
	...
	-	`sha256:57cf12f0c6c9cdb111966d3e0b921d377ea4b3dd8798705d348882a04c7af6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ad0d5eefb6c911dd175c980dcab7711e1ff4d4d2579d6a71ffc0a00edf9bf6c`  
		Last Modified: Tue, 24 May 2022 18:17:57 GMT  
		Size: 70.0 MB (69989571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre11-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d129dfb7c70db114842394c23baa5f40eb545307130e8f10921a7cd6063c60c0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158122732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:065e2f570100a564483f86f6dd845439b3fe6aaecd3b73072943bbf87a4e2b32`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 May 2022 17:46:54 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:47:59 GMT
ENV TOMEE_BUILD=plus
# Tue, 24 May 2022 17:48:05 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:48:05 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:48:06 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:927c739c39c0432ac0180e57913a1ada40c70f17505265af6124faac0e29a1d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dda14e7fe2b2ff4457e683a63bf1e66879c44ffa025e31fc8261c4b1bce586e6`  
		Last Modified: Tue, 24 May 2022 18:47:19 GMT  
		Size: 70.0 MB (69989175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
