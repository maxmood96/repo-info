...
```console
$ docker pull tomee@sha256:bb7d39269d9649080479be07c14568e57e1da98a0d0c07126b9e2318535420e5
```
...
```console
$ docker pull tomee@sha256:5a08178ddc325d808070af47922f5c3db3af619d6d782a07f034e9e6e27e51d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.2 MB (162196755 bytes)**  
...
# Thu, 28 Jul 2022 17:41:58 GMT
ENV TOMEE_BUILD=plus
# Thu, 28 Jul 2022 17:42:05 GMT
...
-	Layers:
	...
	-	`sha256:3045458856b6031aa376ef8e1ad324e702c15d5ab7cbf26bdaca2efa2a9ce7d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f820ac23d509b85008f07be7ffad91fe637cef5635b175d67cb5b763adb79ab`  
		Last Modified: Thu, 28 Jul 2022 18:18:44 GMT  
...
```console
$ docker pull tomee@sha256:64fc4697c5616a3863689295eca763778b45e6555ed9a988704806ed26b8b576
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158752549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cdc8ea9cc8eff39f42139ec333b0aaed5229114e814b322c3fe2a546bc6640b`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Thu, 28 Jul 2022 18:36:35 GMT
ENV TOMEE_BUILD=plus
# Thu, 28 Jul 2022 18:36:44 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 28 Jul 2022 18:36:44 GMT
EXPOSE 8080
# Thu, 28 Jul 2022 18:36:45 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:827b5fbc46d7672ff95b86f7b249ab692c508f79cd9695af43b6dd2b3e6b6a78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb55b9becb2b7da871cf618457d27158372e01f2504c224313dd09855ce324d3`  
		Last Modified: Thu, 28 Jul 2022 19:21:46 GMT  
