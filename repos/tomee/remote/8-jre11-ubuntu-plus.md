...
```console
$ docker pull tomee@sha256:724b22ecc92ffdcb2bd7e95cb998d2e23212190be5c176aa2f11bea88c064252
```
...
```console
$ docker pull tomee@sha256:67479a31ebb0514b077aaa4bff51cb2b47e3d1f7598294da77087a3fba42c6fc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.1 MB (166115430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c49a51919262ce15307227ad4c4aaf10cf4a3a16e605942477be56f8f1ee6e03`
...
# Tue, 16 Apr 2024 09:33:07 GMT
ENV TOMEE_BUILD=plus
# Tue, 16 Apr 2024 09:33:14 GMT
...
-	Layers:
	...
	-	`sha256:d5ff91a005873c1d0e65b7705b42f02e7289d896d755da394fe1c16442e3218b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15fd347fe3295252f7bd8cd6144b3ff50c78fa739cae545e8e80183cb2d74a75`  
		Last Modified: Tue, 16 Apr 2024 09:53:27 GMT  
...
```console
$ docker pull tomee@sha256:6e3e341bcee7c22a97475c5ca63da0fa433234375cb2511bda20e657805c51a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162917302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16423eefe78c74f7d82f66e66e6a487c91bb2ea87f30817411cd64a3e325f554`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 16 Apr 2024 08:02:02 GMT
ENV TOMEE_VER=8.0.16
# Tue, 16 Apr 2024 08:02:32 GMT
ENV TOMEE_BUILD=plus
# Tue, 16 Apr 2024 08:02:39 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 16 Apr 2024 08:02:39 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 08:02:39 GMT
...
-	Layers:
	...
	-	`sha256:7da4f0f9751de4e06563cd7445f6f281f0922206f3951dc6b3ce4758e73bc5e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f9e078df72fefb696e3dd0f6bf3edd4586574307056cd90587c9f429ca9f6fc`  
		Last Modified: Tue, 16 Apr 2024 08:19:32 GMT  
