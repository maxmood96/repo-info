...
### `tomee:10.1.4-jre25-Temurin-microprofile` - linux; amd64
...
### `tomee:10.1.4-jre25-Temurin-microprofile` - unknown; unknown
...
### `tomee:10.1.4-jre25-Temurin-microprofile` - linux; arm64 variant v8
