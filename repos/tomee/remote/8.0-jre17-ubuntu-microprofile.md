...
```console
$ docker pull tomee@sha256:ca01a7216fc06f0d6cbb6ae7041775d97f885d33cd4b654a56778caace824c7d
```
...
```console
$ docker pull tomee@sha256:b6f7b4b79028bf479fa3b0c816202bf4c78f17a00eb49c13a5517cee123c3461
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.8 MB (164832033 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee6c2396da6229e366d82c00835f6ef048abd05c8698cad85bc3f63434a58440`
...
# Thu, 25 Jan 2024 21:39:46 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 21:39:53 GMT
...
-	Layers:
	...
	-	`sha256:8bf1063a3a68781a7ac688959b0e9497ab6d8d93b530dec369fb8083da406bd1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2df298b736f458d15cf1ec9df64c8ad06fc16f5f9451e9bc318b55847204f8e1`  
		Last Modified: Thu, 25 Jan 2024 21:54:38 GMT  
...
```console
$ docker pull tomee@sha256:34152b4a6e6b5c3328e48697bd54fce8669f479c4a3e6a4adafd206548a3a770
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163636623 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd62ffd2ecc7d5e6779ee4333a781a65e5d903bb825a6a5e1171bdc7a2767603`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 23:41:50 GMT
ENV TOMEE_VER=8.0.16
# Thu, 25 Jan 2024 23:42:02 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 23:42:09 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 23:42:10 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 23:42:10 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b65906daf3da71731c90e0ad37a01aa28c471e6f78c3fb04326c2dd47a99b349`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c70038ec230754fbd010d0bde1d865a564bdc846ecf3989e4907fda324405713`  
		Last Modified: Thu, 25 Jan 2024 23:52:59 GMT  
