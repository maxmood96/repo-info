...
```console
$ docker pull tomee@sha256:da4ab4cd8da9188d96a1ecbd83ba88bbb21f285684536b4cfe68ce9ac0831920
```
...
```console
$ docker pull tomee@sha256:85ed18aba5464e6948fcfa2241e49a54a6adc223b41e06ede34dc6f1e453404c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.8 MB (163813084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7cf3777831e2be49a35669f69cbf3f1e15ddc33cd12d711964f5f8d0dfa5ef3`
...
# Tue, 24 May 2022 17:23:06 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:23:13 GMT
...
-	Layers:
	...
	-	`sha256:cfb3eda915bfdbfacde75c6fd801af643e3a6128f8b464b8990604234d5ad4f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83b4249a04ca1a0a2d64924df692ab365894b3d9af8ba38024820783017c2dce`  
		Last Modified: Tue, 24 May 2022 18:06:58 GMT  
		Size: 64.9 MB (64910767 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:1544648e21f364bf059357c7d2bde2c1e211418ec1a59b3a0702ccd42247446d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162313092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:062649c6d52d575f1d5c09c7290342e288a3f7861ae8b9960c42e9d5d6736863`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:45:15 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:45:22 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:45:22 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:f17c860bf52d044cbcecddd05b568b319f9d07329e5e44c5fb1653c1e9d4a100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b20a811625955e2971f157bc73b5d7883b535f10916103dd6c888ab2e70e91ed`  
		Last Modified: Tue, 24 May 2022 18:39:19 GMT  
		Size: 64.9 MB (64910361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
