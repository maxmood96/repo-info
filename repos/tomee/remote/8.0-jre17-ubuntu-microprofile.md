...
```console
$ docker pull tomee@sha256:3cb991b8b2b9660c8637e16d3ea68e8d4bbf8350cac7a93e706c5dfc55e4b557
```
...
```console
$ docker pull tomee@sha256:7f72b9db4afdef475a89b83371ca909169e55cfc963fea9c348bf7b09b441624
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161804135 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d08d4fd66ed9f8b9496003712b9f690d1d461c19cb7c7bb83e32b05794d7a48b`
...
# Fri, 16 Jun 2023 05:45:48 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 16 Jun 2023 05:45:55 GMT
...
-	Layers:
	...
	-	`sha256:b8e4225fbf858055cd0dc59fa41cf2fa146c13f12cb5b4ce3eb1c3a0f9400575`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e253e095793b344a670e3e3f0d896146d603c5ae38be5787f748965d197c2d88`  
		Last Modified: Fri, 16 Jun 2023 06:01:45 GMT  
...
```console
$ docker pull tomee@sha256:400bf6b82e3ff133af268209f0e8ec393e97875e97c1490407756bff04f65c64
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160617086 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd92ef896812a9b09fe9f90cff1a10c6b8d386bb025defcc8fdbd4719b7f19a7`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Jun 2023 06:24:15 GMT
ENV TOMEE_VER=8.0.15
# Fri, 16 Jun 2023 06:24:23 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 16 Jun 2023 06:24:29 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 16 Jun 2023 06:24:30 GMT
EXPOSE 8080
# Fri, 16 Jun 2023 06:24:30 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e8fc0ae28212f37895ad74cbecf463cce8d39de8a2bd02ddb9f3661856526da8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ef924ace6752c8ccea295d8906ee4be782909a8232aebcf161560ac0eb498b1`  
		Last Modified: Fri, 16 Jun 2023 06:35:31 GMT  
