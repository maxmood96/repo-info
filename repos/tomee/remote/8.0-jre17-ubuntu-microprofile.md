...
```console
$ docker pull tomee@sha256:7f4545f2c6fad1b8924d1bb9faa72e8db437d28c1bcd36ad2d1823c1f4bd4bce
```
...
```console
$ docker pull tomee@sha256:48e093591d58af49819dc9b3d8282c9dd90869d7efbb8122eb7900289c441191
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162451853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6034e4491ee1c28963f47a7993791aefe45334915f83b031a5a21b7d851b0ed`
...
# Tue, 31 Oct 2023 02:16:30 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 31 Oct 2023 02:16:37 GMT
...
-	Layers:
	...
	-	`sha256:48b3fd4deba260757db6bdd5c96ef400e5376f980009df226e4b2ab4c6952701`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:229bb2046797ebbb6ea8339688562cba01aa7268bd9a6d0d47f9d661a2511de7`  
		Last Modified: Tue, 31 Oct 2023 02:34:06 GMT  
...
```console
$ docker pull tomee@sha256:037782fa7105833295a94167f21fb551df57ecc191514250f9837da9c65f3a58
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161297689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f077482b6f78042ccf45abb6906b6742df362b852a1747bea9546173e412d54`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 08:55:19 GMT
ENV TOMEE_VER=8.0.15
# Fri, 13 Oct 2023 08:55:29 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 13 Oct 2023 08:55:35 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 08:55:36 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 08:55:36 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b17339e9b2811fdbc7ae9a3e8b15b81d627271bb218d9cb71e86da53e1589b72`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db76ac57a77aa7d2492bb90e6363ae3f8e543fe2bf1a5cfc9c3b7f6bd4302f8a`  
		Last Modified: Fri, 13 Oct 2023 09:10:56 GMT  
