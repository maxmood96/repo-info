...
```console
$ docker pull tomee@sha256:b88f4b6c10c255c25958d1a5ea9b65a3488d88676248613f99d1e661b81561dc
```
...
```console
$ docker pull tomee@sha256:3ac57f325ae7366151778af7747720ade07da170f1f123e67f896f36eeaace35
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.3 MB (163261619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7497f0e037ddea1182d52ef1cc60e880e0c91f32ca6e24e97e9f44c97472642`
...
# Thu, 02 Mar 2023 11:14:28 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 02 Mar 2023 11:14:36 GMT
...
-	Layers:
	...
	-	`sha256:c8f629800de852a4cdd18bece97561930a9b2e0c529b92ed50e9b616e278fd85`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e0522b85b05d23a6af267f4ad6ea36e86e41e9bb3a775bd82724ed73ab46766`  
		Last Modified: Thu, 02 Mar 2023 11:39:31 GMT  
		Size: 63.9 MB (63926342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:12d7a9cc9c16c34d47f115c26780e525701b9191e2fa3d58131f53824946a920
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162073823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a272a38bffdc6ebc83dc8b5c1e114e6b28b6b8a5ab108f148dd346020c0b80d6`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 16 Mar 2023 06:51:13 GMT
ENV TOMEE_VER=8.0.14
# Thu, 16 Mar 2023 06:51:25 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 16 Mar 2023 06:51:32 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 16 Mar 2023 06:51:32 GMT
EXPOSE 8080
# Thu, 16 Mar 2023 06:51:32 GMT
...
-	Layers:
	...
	-	`sha256:2796685b3083632b0aaf7ce689147c5ee6b350dc3fe27328a960593c5e05082e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03d2a6fa1119986a0147e6008e0380feb595cbb5fd7558df53260a8b1498dfb8`  
		Last Modified: Thu, 16 Mar 2023 07:11:20 GMT  
