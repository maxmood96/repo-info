...
```console
$ docker pull tomee@sha256:b55101496d50a2eb0e0f1cacf27d657af52d19f887be4f80db85438158189258
```
...
```console
$ docker pull tomee@sha256:bccbf104a1b2e50d87b87c5c0b876cab01c8d7eeb69e03dc53d07badf402a6ca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.9 MB (163885570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f39a0867c6d7c23a8e614758d6a6f36a906a5545e02c2b2d4656f9ab274cbc46`
...
-	Layers:
	...
	-	`sha256:aa4809a4963a60f8676dace9457e3f39fa147acdc65ba66a28d3263bc20a5e5b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e7457377ee272225f6bf5cdd52c9147468fda94989ede9831e23bc4f46f3bd3`  
		Last Modified: Wed, 03 Aug 2022 06:54:27 GMT  
		Size: 65.0 MB (65007145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:9451e7aec0d41caa88e23ee014f946e93c69fa793995d93d38489dd117a1e84b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.4 MB (162398143 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff5fa029bfa98b2617c02b8cf44f341c61bf51bd69093456cc6f853dac2ffda8`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_BUILD=microprofile
# Wed, 03 Aug 2022 03:47:30 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:47:30 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:47:31 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3b4830e25e2031926d0bc88069d7659b05fc5d65f6791a31aa5d2f8dbd87a973`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e26bc832bf73273d103c144bbaddb138b0cc242124092cc9ce9aec476e4d8f2`  
		Last Modified: Wed, 03 Aug 2022 04:52:56 GMT  
