...
```console
$ docker pull tomee@sha256:4da50fc1c683c815c65b6bf14e26a325aa0b9eb93cefbea589ab300dd4ff4b37
```
...
```console
$ docker pull tomee@sha256:78380de9f9584170fa7e33d3d022be469a8af96f07d42432471a8269eb91eda0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.3 MB (163338380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecd5f7bb23042e0ce8340f2b4fabdde170340118f83676d506fafd6a4134a98b`
...
# Wed, 26 Apr 2023 22:00:52 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:00:58 GMT
...
-	Layers:
	...
	-	`sha256:fb5d8d00ae9298c29285ba96e290346d1a5c5d36111b448945a73bfeef0bd954`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f370a2d603af65efa262d015522971f9a9abf494315372a3f1ce340aaab989f2`  
		Last Modified: Wed, 26 Apr 2023 22:19:19 GMT  
		Size: 63.9 MB (63926361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-ubuntu-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:59361402258d701903aeed491ee26c8131568e9bed8bde2d039bea6ab78b3476
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162143759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2282179b32652cdefaf6fe7e829e83df5ca241a7653d204c8d0eb21f2e79cd7`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 26 Apr 2023 22:10:32 GMT
ENV TOMEE_VER=8.0.14
# Wed, 26 Apr 2023 22:10:42 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 26 Apr 2023 22:10:49 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 26 Apr 2023 22:10:49 GMT
EXPOSE 8080
# Wed, 26 Apr 2023 22:10:49 GMT
...
-	Layers:
	...
	-	`sha256:3c521388f114167e9a5dfb46e691a8b080aa65985a33d40b787766bd76209a94`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2d88ca93cd17cc1a52d006304edeb21f50d0476713ece11a7900b3943a79ea4`  
		Last Modified: Wed, 26 Apr 2023 22:20:33 GMT  
		Size: 63.9 MB (63926315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
