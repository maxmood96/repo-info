...
### `tomee:10.1.0-jre21-Temurin-alpine-webprofile` - linux; amd64
...
### `tomee:10.1.0-jre21-Temurin-alpine-webprofile` - unknown; unknown
...
### `tomee:10.1.0-jre21-Temurin-alpine-webprofile` - linux; arm64 variant v8
