...
### `tomee:10.0.0-jre21-Temurin-alpine-plus` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-alpine-plus` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-alpine-plus` - linux; arm64 variant v8
