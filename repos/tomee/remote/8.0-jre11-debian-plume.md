...
```console
$ docker pull tomee@sha256:f723618379af8069c9498f3c88c4688db2da26dc482b6982602bde722eb18754
```
...
```console
$ docker pull tomee@sha256:943f17c30f65895befe01dc05a7113131ce7426f8b8cccb11125b7c9ca911146
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.5 MB (200470974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f587ac1a39167224e230e2093919aa6961ec2939a5ac8aeb25629fc405b2fc75`
...
# Wed, 03 Aug 2022 06:09:22 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 06:09:30 GMT
...
-	Layers:
	...
	-	`sha256:cec4c1e94b3db6080b329618b1e73e2f71642e97cd8d0068af7bf885a4c31961`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a241e45493b620f703bca3529db4a797c7ec54e2bd7ae47d773fa8ad04d96aef`  
		Last Modified: Wed, 03 Aug 2022 06:43:04 GMT  
		Size: 77.9 MB (77947386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre11-debian-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:46f7daca5f52edc8443c8651fcb6f654ec18b68625de1a5970b4c5b220b44b32
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.2 MB (198218225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:298cb7c517998db47f1eaf2c1bb2db974a0607cc696722a92e0d518a269fe1ff`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 03 Aug 2022 03:42:14 GMT
ENV TOMEE_VER=8.0.12
# Wed, 03 Aug 2022 03:43:29 GMT
ENV TOMEE_BUILD=plume
# Wed, 03 Aug 2022 03:43:36 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 03 Aug 2022 03:43:37 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 03:43:37 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:035cb71ea38a3cab37af3fed7faed9c7637f89af3fe177ae2706892abc5f816d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b1984d801bd5bc3016605af19a379c24df9e674560e53ddf65fd01194dc8e74`  
		Last Modified: Wed, 03 Aug 2022 04:40:59 GMT  
		Size: 77.9 MB (77947088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
