...
```console
$ docker pull tomee@sha256:95a80ee99d6f6dd20b37c3dc0c54dea438e5968d66ccfc4b6fc1c151310a9b8a
```
...
```console
$ docker pull tomee@sha256:3b3dd0d5073c97b6518474ea1c0a6a777d8ac638a7d84fd98ef32d89f7ca8f81
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.6 MB (138616173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eda071ccbcc8f5dc2df11dbeb3c85b8c165aae245a514c478af672c87be2e22e`
...
-	Layers:
	...
	-	`sha256:7314a3ac16a3253a98f16b689a630ab4db3a920ed41381bcfd6c3d32b58d211e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ed6759594dea6653459b48b4bd19cd547d2fe95d6b04a9767ff0e7b5a0d55df`  
		Last Modified: Sat, 02 Dec 2023 11:02:17 GMT  
		Size: 49.0 MB (48986086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre8-Temurin-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:74572d888d98876de7aae14a7380ebeb68513f51e212659510cc732a08b6132e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.1 MB (136063351 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4376dd8dd8f75d02ffbb0d437eb113fc6199936a4fe194ecec20b4048315b9a4`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 02 Dec 2023 10:56:06 GMT
ENV TOMEE_BUILD=webprofile
# Sat, 02 Dec 2023 10:56:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 02 Dec 2023 10:56:12 GMT
EXPOSE 8080
# Sat, 02 Dec 2023 10:56:13 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:ac2698f813215d9f5774848d58b8c6b0151b4dfdc3a5526e2c2d3367bf3f70db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0167ae1bf820827e565902595ee130f8de2d8aff37254907df97ba521a18344d`  
		Last Modified: Sat, 02 Dec 2023 11:16:44 GMT  
		Size: 49.0 MB (48986002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
