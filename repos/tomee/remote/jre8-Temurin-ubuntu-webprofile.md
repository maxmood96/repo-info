...
```console
$ docker pull tomee@sha256:72d92437295bd7467d4e49c913fe574ff0e02e4bb10dcfa28b5da1f4097b9b36
```
...
### `tomee:jre8-Temurin-ubuntu-webprofile` - linux; amd64

```console
$ docker pull tomee@sha256:344c3d3cdbfea7578e72e960db69138c85eee2ba8dcdcbb7db7e2d7a17636323
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.6 MB (138604692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b44fd4c17d16b4c90525c0f86b8007445a75be92902d5b0e850972e427bb5c2d`
...
-	Layers:
	...
	-	`sha256:e55ac737e36885c19c55aa0d4741fc3c24462c46b6b2931256e4e4f485cc264e`  
		...
		Size: 717.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0033d7d4d1102cfc47c2e43f75aa8e9ab6f4f2bbb107933cd1b8360c6efb1d5d`  
		Last Modified: Thu, 25 Jan 2024 01:58:58 GMT  
		Size: 218.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a36c05ba782745b82bd8f75ac12fa32f35da51fd1ca624f489aedcf8da5e0bf`  
		Last Modified: Thu, 25 Jan 2024 01:58:59 GMT  
		Size: 2.2 MB (2196410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6efd1c409208298dc04dc92ea7c7b932abd81ed8046ed5e58fc680ca5a0dfdf4`  
		Last Modified: Thu, 25 Jan 2024 01:58:58 GMT  
		Size: 69.3 KB (69302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31865bc3cd0f12f9b68c1541ff1d99a670bb5f4816f6401ee0c4192a622b85bb`  
		Last Modified: Thu, 25 Jan 2024 01:59:01 GMT  
		Size: 49.0 MB (48986092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:jre8-Temurin-ubuntu-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:c2c5868867981daa311b345cffae0b0123225c325b4b72f7dc9a2956fad202e1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.1 MB (136072718 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c0a9c1566671fec6aa1e93944b0e183160eb9fc4b8b359161baa69c64613e53`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 01:56:56 GMT
ENV TOMEE_BUILD=webprofile
# Thu, 25 Jan 2024 01:57:01 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 01:57:01 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:57:02 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3e098baf177f352ce1a7c35d9018d0f783e86ae4ce877c803d62e48b75c0f447`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d523c6c8b79be42581fc0d99d7dd43fc27263608a46ca42aedd8a697f7a1e185`  
		Last Modified: Thu, 25 Jan 2024 02:13:07 GMT  
