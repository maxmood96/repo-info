...
```console
$ docker pull tomee@sha256:f7aa12cbc1d0cfd90445ccfc7596b7e46b5b0b545afef4bfd052ad551fe8b6c7
```
...
### `tomee:9.0-jre11-Semeru` - linux; amd64

```console
$ docker pull tomee@sha256:4525ad847c8d1f8fd36d955ab1765d95001f147bbd0bebc78c939368d5fa9199
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154717282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a041209fddead1364740865c88922f44c25cc2adc8aed2e9a7fa3f025b2d7ed`
...
# Tue, 24 May 2022 17:37:10 GMT
ENV TOMEE_VER=9.0.0-M7
# Tue, 24 May 2022 17:37:10 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 24 May 2022 17:37:16 GMT
...
-	Layers:
	...
	-	`sha256:2d676fc584e8b40814470a0048d84bd24608b0d3a6ca8c4ad5d0f0b3a56089fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e697d29cead552f46ccdd4eb23a01c542c6f78db893bfc296bca72567074845a`  
		Last Modified: Tue, 24 May 2022 18:51:05 GMT  
		Size: 54.6 MB (54568246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.0-jre11-Semeru` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d274790c3736ecd6592dc8304fd935d58ae1a2a9497f8d4f468573043a9e21b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150920091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcbd1a6f3e2f56105abc46610f3dee377fa24a6c37534242cca842ceabbc550f`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.0.0-M7
# Tue, 24 May 2022 17:58:03 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 24 May 2022 17:58:08 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:58:09 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:58:10 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d93f90e2cd98c9cb80ecb182f3948cb4315b8f4e35a5158640f95663c4a1b4a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebc558b70b5e1d21172c4fa3e950ec64ef5eaedd3f8dcdf8bf8ad8a411cc1639`  
		Last Modified: Tue, 24 May 2022 19:14:57 GMT  
		Size: 54.6 MB (54568016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
