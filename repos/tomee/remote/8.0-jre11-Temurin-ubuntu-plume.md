...
```console
$ docker pull tomee@sha256:4dd5598e44a1668e81747d7be87ac732ac1fd43deccd67b6c70aa9a7fa736da5
```
...
### `tomee:8.0-jre11-Temurin-ubuntu-plume` - linux; amd64

```console
$ docker pull tomee@sha256:9aa5ea9ce6c7a8f921284dce7becaa90684a498b262215a6c5529d19a18f7225
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.4 MB (169390929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea51dd81f96653820df7fb4bdc56ef611dec19b00f695a8fc17a40cdfe3f7831`
...
# Tue, 24 May 2022 17:26:00 GMT
ENV TOMEE_BUILD=plume
# Tue, 24 May 2022 17:26:08 GMT
...
-	Layers:
	...
	-	`sha256:57cf12f0c6c9cdb111966d3e0b921d377ea4b3dd8798705d348882a04c7af6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26ebaf491968ed6ad2c887700ab81dd3c0a67e53d99d1eeb62c24ec3d8a99616`  
		Last Modified: Tue, 24 May 2022 18:17:16 GMT  
		Size: 77.8 MB (77806336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre11-Temurin-ubuntu-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:9eab830604753e10fe53664aae023e1427f6a163d82129858af5d8f5cad579a2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165939418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23a698f11d7abc70fc90eb41fe7744d7793b6156b73e23d94af6d04e77ad546f`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 May 2022 17:46:54 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:47:38 GMT
ENV TOMEE_BUILD=plume
# Tue, 24 May 2022 17:47:47 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:47:47 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:47:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:927c739c39c0432ac0180e57913a1ada40c70f17505265af6124faac0e29a1d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:866b3a992271ccae4378c10fe66ec8ce0739ec7ce49636ada69c523bb511b78b`  
		Last Modified: Tue, 24 May 2022 18:46:31 GMT  
		Size: 77.8 MB (77805861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
