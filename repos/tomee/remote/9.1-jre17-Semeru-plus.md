...
```console
$ docker pull tomee@sha256:2cf1f2d90c5b0ad7e5035089270c9ffaaa00c74188522e96d3483bb45e8ce14a
```
...
```console
$ docker pull tomee@sha256:ebabb0838c24c75acf5b57e5fcfeee2cee7f548918c6e9a7d0d2fe48c94e00f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.2 MB (173194818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9d6fff4978784c9a09f4e4b4b66a61fc608e3f6e19af34918d6591506397132`
...
# Sat, 02 Dec 2023 10:45:50 GMT
ENV TOMEE_VER=9.1.1
# Sat, 02 Dec 2023 10:46:26 GMT
ENV TOMEE_BUILD=plus
# Sat, 02 Dec 2023 10:46:34 GMT
...
-	Layers:
	...
	-	`sha256:b0eb6e750e1e82dcc3027a776a73bde2cedff41a1de0c730e25a5665563a4074`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7b71f2d0753581a01977c1aec0402ae473c947435f00841fa4ee9273726909e`  
		Last Modified: Sat, 02 Dec 2023 11:20:41 GMT  
...
```console
$ docker pull tomee@sha256:365fbc88d490e4779849b40d374e3be583df91109b781e367984c4d0576da1bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169608931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39654b750af652baefe87fc9505b0af06da4db18cfbf8d56783f159094fe3791`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 02 Dec 2023 11:01:08 GMT
ENV TOMEE_VER=9.1.1
# Sat, 02 Dec 2023 11:01:42 GMT
ENV TOMEE_BUILD=plus
# Sat, 02 Dec 2023 11:01:50 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 02 Dec 2023 11:01:50 GMT
EXPOSE 8080
# Sat, 02 Dec 2023 11:01:50 GMT
...
-	Layers:
	...
	-	`sha256:d8d7f9107d1a51021c93c0379b088e865a1e237313a3fd3684a99590edcbd0ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bcc95b0e197642276f9bd60299fc302aab7607290dfbcea3b50a9d4371617dc`  
		Last Modified: Sat, 02 Dec 2023 11:33:30 GMT  
		Size: 74.3 MB (74255008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
