...
```console
$ docker pull tomee@sha256:9912c8e61e2a249278a2bc9ba864a28f13b8c066eddd3befdca699b8f2b4013d
```
...
```console
$ docker pull tomee@sha256:25a1e061d5c5f54bb503634e4be18a9082bc72d470a000b4ff3fbcf402d845d3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.5 MB (176498895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a3bde616b6d1aa6834d7aadbfbe8b5932e9b0d10f6c4ec1ac17553235e67c54`
...
# Fri, 13 Oct 2023 11:40:03 GMT
ENV TOMEE_VER=9.1.0
# Fri, 13 Oct 2023 11:40:42 GMT
ENV TOMEE_BUILD=plus
# Fri, 13 Oct 2023 11:40:51 GMT
...
-	Layers:
	...
	-	`sha256:2333958078f233bfef19c54c6f93cec16b244290c8ec72f2598c577f8d2772b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5779ca006dbd4a4aae676d0d21e05e6a9fd429bbbc6a31765a063b5f156b16e`  
		Last Modified: Fri, 13 Oct 2023 12:18:54 GMT  
		Size: 220.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:738df433271bd12bcd4f0a6c55c56c9abe0b6a66ceaa6251517639f85a9d0a15`  
		Last Modified: Fri, 13 Oct 2023 12:18:54 GMT  
		Size: 2.6 MB (2594322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dad3789cafbed6df2cea73cc1181466b75e3e4cc255346994d99234f7547cea`  
		Last Modified: Fri, 13 Oct 2023 12:18:54 GMT  
		Size: 62.9 KB (62924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8486a33fe93a9dfa2a2e888aa9a2ea3c3dd8fe5bf7d98073103efc1c361435c9`  
		Last Modified: Fri, 13 Oct 2023 12:21:11 GMT  
		Size: 77.8 MB (77784366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1-jre17-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:ba96ba98eda745fd971ee3e47c14a2c21f621523131e62a361a2698f7c70ee3d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172287257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e29f94cf49fe952fab9e97231e005c5865ebcb477489454c0475e9b44808f95`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 09:01:58 GMT
ENV TOMEE_VER=9.1.0
# Fri, 13 Oct 2023 09:02:31 GMT
ENV TOMEE_BUILD=plus
# Fri, 13 Oct 2023 09:02:38 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 09:02:39 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 09:02:39 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6b8310db4bce54c27bebf8415fdd92db2389a73e21056da540830acb34c75967`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8aa5de96d96efd406e0ccb27cc9a8e4674284c03d637dbd808cbffb898e393db`  
		Last Modified: Fri, 13 Oct 2023 09:37:16 GMT  
		Size: 77.8 MB (77784350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
