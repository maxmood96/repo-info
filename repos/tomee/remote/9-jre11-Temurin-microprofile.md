...
```console
$ docker pull tomee@sha256:e65353bb218ac401659aa3c62382173e698b888851ee902e52365e823b82917e
```
...
```console
$ docker pull tomee@sha256:a2c59353e07d1785836613d4d87d7b248ad60b4831e276fa9b3224a3c62c3d23
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161798617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c01dcc09bf8f275ba8762772689963a9a4f46a7d1bef32e2a7c81645f5040297`
...
ENV TOMEE_VER=9.1.2
# Mon, 08 Jan 2024 22:25:19 GMT
ENV TOMEE_BUILD=microprofile
# Mon, 08 Jan 2024 22:25:27 GMT
...
-	Layers:
	...
	-	`sha256:4d22163b73293425ac2a73eacebe29e8c6b821521a560c125345c0fc24bea85f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:139803cce03357ec0518175c7980256079f9bab15234971996b9a897a6346167`  
		Last Modified: Mon, 08 Jan 2024 22:44:55 GMT  
		Size: 68.7 MB (68711145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:615535ba803c0535233459f53cfc23ff058e111897b1a62b629f5580963fb072
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158011648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bb666b3d2ab5a7c651d8ff27de960676c0ed1225b43ceacb6a99dab13f4a32e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.2
# Mon, 08 Jan 2024 21:52:29 GMT
ENV TOMEE_BUILD=microprofile
# Mon, 08 Jan 2024 21:52:36 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Mon, 08 Jan 2024 21:52:36 GMT
EXPOSE 8080
# Mon, 08 Jan 2024 21:52:36 GMT
...
-	Layers:
	...
	-	`sha256:70d35eb3c1619900790b64e3c2733e08e6edc4e4044f51cef38563d32ad7d3d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0cb6a48f1a36c795bd52f8286392be129e410672e7ee788706bd6613c155ced`  
		Last Modified: Mon, 08 Jan 2024 22:06:51 GMT  
		Size: 68.7 MB (68711188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
