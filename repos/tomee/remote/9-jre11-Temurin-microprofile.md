...
```console
$ docker pull tomee@sha256:fdbb034312b1b9bcd3d47efc351236228efc87fba03021acf4fd3dbeb95746c6
```
...
```console
$ docker pull tomee@sha256:99a9542cbb0d74faf100b4b3095fd896831a52dfbe797220a28bdaf93f60673e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.7 MB (164736315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c009568b1042a20e3d8662023fb448979ba31a809c8b98ec2f47c434315758d3`
...
-	Layers:
	...
	-	`sha256:49a77cae0303e5eb290e23d90958e8a163b92645521b2ad699b996e40567e578`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a1665c2c05b3372cbb7ee149bd4dfd5c3cd75a053a6ff0264567585f20c0fec`  
		Last Modified: Thu, 31 Aug 2023 22:22:57 GMT  
		Size: 71.9 MB (71869317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:4157a9e5993e5e0d2111bd6f2a87ff9838a73031d492d8cf00ebafd8b681d16a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.9 MB (160944407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd5baed55484268fc7e74f02ccab88c937e156a7029a732d95d01d7e960f1195`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 16 Aug 2023 17:39:29 GMT
ENV TOMEE_VER=9.1.0
# Wed, 16 Aug 2023 17:39:39 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 16 Aug 2023 17:39:46 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 16 Aug 2023 17:39:47 GMT
EXPOSE 8080
# Wed, 16 Aug 2023 17:39:47 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a683e0116564d6117cea106e8f4410cfe1eec6be5eb4519b438acd377ebddabd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1fac86d54063b3899ad3fd1aca537b774dff0152f71616be56f4c200d2b6ef1`  
		Last Modified: Wed, 16 Aug 2023 17:54:36 GMT  
		Size: 71.9 MB (71869302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
