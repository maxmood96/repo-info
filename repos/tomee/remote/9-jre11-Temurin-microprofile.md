...
```console
$ docker pull tomee@sha256:2fbb70c2f47e721d2b775475dd795c1910baac4bcd5df93c693e0498c93aaab8
```
...
```console
$ docker pull tomee@sha256:942f7b4428ddd69e3c0e6c60a7dd38501f634cc573611c4f07df4ffb332bf164
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161805714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35388d8076cd10c5f5d0d29874442187a1a504c16d28a064e88716f6b7a42f36`
...
# Fri, 16 Feb 2024 05:53:47 GMT
ENV TOMEE_VER=9.1.2
# Fri, 16 Feb 2024 05:54:00 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 16 Feb 2024 05:54:07 GMT
...
-	Layers:
	...
	-	`sha256:84d5e90afe4210097c219d8150b0698f66ae37a1a2f0786f82fdb8e57991eee3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4caea24ddb95466566c6ccb06f0e44c8351504eadd2391ec1e72afafd3352a0b`  
		Last Modified: Fri, 16 Feb 2024 06:12:15 GMT  
		Size: 68.7 MB (68711200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:fff7c6fb4b30066100a9cc3420a11c7a30b48b8521f36fc7ebbe82eebaf679de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158012150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90e4f56b281188eb24c9340567bdc310380faab9e9402938845eaca1b7514544`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 09:17:55 GMT
ENV TOMEE_VER=9.1.2
# Fri, 16 Feb 2024 09:18:08 GMT
ENV TOMEE_BUILD=microprofile
# Fri, 16 Feb 2024 09:18:15 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 16 Feb 2024 09:18:16 GMT
EXPOSE 8080
# Fri, 16 Feb 2024 09:18:16 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0aa03bb47bbceb1e9ec574d3c45ce78fc333340e01e6d66d10436ee09f91e4e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:770e73e8df958aee36e649320021cd59116776a0ffb531751321958acfeb05ad`  
		Last Modified: Fri, 16 Feb 2024 09:32:33 GMT  
