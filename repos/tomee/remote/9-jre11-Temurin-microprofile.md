## `tomee:9-jre11-Temurin-microprofile`

```console
$ docker pull tomee@sha256:3ea64518978ec6d3013975a3aee96474d404bfb86673cbe97fa4d00c0b5c992a
```
...
### `tomee:9-jre11-Temurin-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:eeb6e1ac9cc3e6c6427f67c633a69b82cfc491d8524972bacef751bb265c9354
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161802622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ed5b4806474bac51c18f186e4f68ec9cb2763532033cb91e0ea45b8f874621b`
...
# Thu, 25 Jan 2024 21:45:00 GMT
ENV TOMEE_VER=9.1.2
# Thu, 25 Jan 2024 21:45:13 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 21:45:20 GMT
...
-	Layers:
	...
	-	`sha256:7c652889d8a2b148dba4c0d8b8a8674fbda0b9a5df1660bfb47ca6fca752dc1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34d8fb80f1f3ae06366b3fe235d8bc582576252bdc8188f6a931fe992a649618`  
		Last Modified: Thu, 25 Jan 2024 22:12:30 GMT  
		Size: 68.7 MB (68711111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:a15dfbab59c8ba7283594d53089fdda8f175d59ab2d8211e28234768953867d3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158012051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1847b429f7dc0234752de7cf1b645dce2d1b18e48d911b38c05b8c917668963e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 25 Jan 2024 01:59:03 GMT
ENV TOMEE_VER=9.1.2
# Thu, 25 Jan 2024 01:59:16 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 25 Jan 2024 01:59:23 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 25 Jan 2024 01:59:23 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:59:24 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c80cb3c25a595fd927d0ea19745849c83bf286fb29bae7621a0af861f3dd4517`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d86c7dfff196cfc109850f8a1b05efdadedbf782e5aa253de23c3f5a4a17af4`  
		Last Modified: Thu, 25 Jan 2024 02:22:29 GMT  
		Size: 68.7 MB (68711207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
