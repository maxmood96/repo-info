...
```console
$ docker pull tomee@sha256:ca86228b1d54b6e55f01abdef68b4d7a80319c0506965ab03407317e564b0a81
```
...
```console
$ docker pull tomee@sha256:4ff9676c4bee19a8da8b096e9adc22f5463ac0db254445c79b5fc3ffc23b8a61
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161802912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d24c209944096f0135fb37d2d7e990a003dcec9921b212fbf92ad304e05c79b`
...
# Wed, 17 Jan 2024 11:43:18 GMT
ENV TOMEE_VER=9.1.2
# Wed, 17 Jan 2024 11:43:31 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 17 Jan 2024 11:43:39 GMT
...
-	Layers:
	...
	-	`sha256:8323496d26b7d36964b3f4c8b515d41f3de5ff4f0e1079cc5278506c876c0171`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a6b321b658d1200904a78fa26b4ef9247c3b5795bd45dce6b846f379ae21940`  
		Last Modified: Wed, 17 Jan 2024 13:35:47 GMT  
...
```console
$ docker pull tomee@sha256:9779850a7b4938b6d00d16787871cc3df18e685752bd27ceacf04921587c856e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158013262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6d1f452bcfa77272c62cb4fc112b02b3edf3eba51f062a99cbaf19c4ea3f03a`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 12:27:14 GMT
ENV TOMEE_VER=9.1.2
# Wed, 17 Jan 2024 12:27:24 GMT
ENV TOMEE_BUILD=microprofile
# Wed, 17 Jan 2024 12:27:31 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Jan 2024 12:27:31 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 12:27:31 GMT
...
-	Layers:
	...
	-	`sha256:35888ba9e9809975d58d78fb720dbe48edd9d62ae1ba5a0d5f286fc04154a2fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16f996f5da26637f4026c813aa443e1b30d9a374bf9cef4d31fac64a59ed2d75`  
		Last Modified: Wed, 17 Jan 2024 13:48:26 GMT  
		Size: 68.7 MB (68711178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
