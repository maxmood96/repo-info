## `tomee:10.0-jre11-Semeru-ubuntu-microprofile`
...
### `tomee:10.0-jre11-Semeru-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0-jre11-Semeru-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0-jre11-Semeru-ubuntu-microprofile` - linux; arm64 variant v8
