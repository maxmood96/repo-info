## `tomee:10.0.0-M2-Semeru-ubuntu-plus`
...
### `tomee:10.0.0-M2-Semeru-ubuntu-plus` - linux; amd64
...
### `tomee:10.0.0-M2-Semeru-ubuntu-plus` - unknown; unknown
...
### `tomee:10.0.0-M2-Semeru-ubuntu-plus` - linux; arm64 variant v8
