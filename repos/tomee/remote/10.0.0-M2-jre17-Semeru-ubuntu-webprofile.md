...
### `tomee:10.0.0-M2-jre17-Semeru-ubuntu-webprofile` - linux; amd64
...
### `tomee:10.0.0-M2-jre17-Semeru-ubuntu-webprofile` - unknown; unknown
...
### `tomee:10.0.0-M2-jre17-Semeru-ubuntu-webprofile` - linux; arm64 variant v8
