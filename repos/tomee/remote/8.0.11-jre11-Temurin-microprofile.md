...
```console
$ docker pull tomee@sha256:3a2e6176afc6f3a699773ac6fe81175145d8ba18f14a359e5fe5831753e42032
```
...
### `tomee:8.0.11-jre11-Temurin-microprofile` - linux; amd64

```console
$ docker pull tomee@sha256:a113084b42a857c36bbf42208af2889cbe8239f0caac7cf1edb52ff5277439d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156495373 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10de49c0dcdb6dbd834e7dcae0594998bc202472dd9d0257eb467cbc473892a2`
...
# Tue, 24 May 2022 17:25:48 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:25:55 GMT
...
-	Layers:
	...
	-	`sha256:57cf12f0c6c9cdb111966d3e0b921d377ea4b3dd8798705d348882a04c7af6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b10f9322a910af17e237463765d7eea027e4974095790568f0892fc0a6734433`  
		Last Modified: Tue, 24 May 2022 18:16:35 GMT  
		Size: 64.9 MB (64910780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:09f665c04ff3585c2bee3f06ca31a9e7f3f39d02c452cb249391560ba47a49f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.0 MB (153043960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3aa8a2e70351c3420598aea682a3e6d3bc14c5e405715aec4bff3691ac34907f`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 24 May 2022 17:46:54 GMT
ENV TOMEE_VER=8.0.11
# Tue, 24 May 2022 17:47:19 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 24 May 2022 17:47:26 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 24 May 2022 17:47:26 GMT
EXPOSE 8080
# Tue, 24 May 2022 17:47:27 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:927c739c39c0432ac0180e57913a1ada40c70f17505265af6124faac0e29a1d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd7e235f418564ca62101e5299dd493af968de6383b8b2b42df123cd1dbfe7b3`  
		Last Modified: Tue, 24 May 2022 18:45:43 GMT  
