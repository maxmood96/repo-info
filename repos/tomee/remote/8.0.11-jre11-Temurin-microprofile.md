...
```console
$ docker pull tomee@sha256:cbb5599473bb035d7a64b1db42de6ff927181e112e349fa8ac4f8a3c18501547
```
...
```console
$ docker pull tomee@sha256:7dea88a748ba56ffa98752aa67e5fe5bf41ef7cb3b33252735942ede8cca13c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156501642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d68c6f3ae2c71c372a5cbd309f668759c7fb247ece726373839e7335d66d1f9`
...
# Tue, 07 Jun 2022 05:12:25 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 07 Jun 2022 05:12:32 GMT
...
-	Layers:
	...
	-	`sha256:be9cb027ff67ec0dbf355c76f42cc546e01522cdd6a1c88bf2d5174d569da658`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cbdad046ea15c8a774a6d44b10d7b71afebb1d5599d26b2c0b6cb45f21a7f0b`  
		Last Modified: Tue, 07 Jun 2022 05:44:53 GMT  
		Size: 64.9 MB (64910845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.11-jre11-Temurin-microprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:beeb9549e6b2b05d00f9cf213556a41cfabd4f162ac009428dd569674ce73e4b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.1 MB (153067502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fb9dbfe31fa724a62bfa3068e2042fc409cb14d347754b540882f367598d0c1`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.11
# Tue, 07 Jun 2022 08:29:41 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 07 Jun 2022 08:29:46 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 07 Jun 2022 08:29:47 GMT
EXPOSE 8080
# Tue, 07 Jun 2022 08:29:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:fe0609cdb81eed6c3b052291fa12a4eb9e0885ed70bf5cf6bcb43688ff92e950`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aea5a28ec414487524785c1bdff7e08720df567b889d62a95ecffaed1a54d10a`  
		Last Modified: Tue, 07 Jun 2022 09:17:54 GMT  
		Size: 64.9 MB (64910404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
