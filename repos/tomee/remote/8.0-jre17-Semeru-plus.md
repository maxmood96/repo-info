...
```console
$ docker pull tomee@sha256:c9b325a4081a4d0fdd70578ef86878d23fa3d8a93fc6702ebbb3f9aa7af8b822
```
...
```console
$ docker pull tomee@sha256:b2efde5fdb15f4d802f0c08477f0c0fa803667ae718a7fd0e7447f5b409c78e0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171840202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:732141bffe34df723c5f0ed7bcb65c1a21b513ed95dce6776ce520ebaab62738`
...
# Sat, 02 Dec 2023 10:41:51 GMT
ENV TOMEE_BUILD=plus
# Sat, 02 Dec 2023 10:41:59 GMT
...
-	Layers:
	...
	-	`sha256:bd5b02cb23325cd32c5891d2939bdcc789ca71ed84e0579bdf6f072752c0c6f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8acdd06dc998a0cfc74e9271e26756f79a14de6d286a3d07de08f569f7e6b2e6`  
		Last Modified: Sat, 02 Dec 2023 11:08:10 GMT  
		Size: 71.3 MB (71275458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:c9bb522203e07a4a61a6113de422bdcbecd4eadc490c0274c50f84e8c6f10426
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.9 MB (168872477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19ff438cdae67da32a78447de283f1aaf523845d7ff9d7626dcfae6b11346630`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 02 Dec 2023 10:57:07 GMT
ENV TOMEE_VER=8.0.16
# Sat, 02 Dec 2023 10:57:38 GMT
ENV TOMEE_BUILD=plus
# Sat, 02 Dec 2023 10:57:45 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 02 Dec 2023 10:57:45 GMT
EXPOSE 8080
# Sat, 02 Dec 2023 10:57:45 GMT
...
-	Layers:
	...
	-	`sha256:bcae03da1057d86ff44a3dd92a774ee96eba5120361327a6e4f333b303f1f9f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f0d23f1bc386fc1c0d4a06a6035f02892e17b2722e80a6b6bcab0dd8a380e0f`  
		Last Modified: Sat, 02 Dec 2023 11:22:16 GMT  
		Size: 71.3 MB (71275475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
