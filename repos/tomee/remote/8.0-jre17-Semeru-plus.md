...
```console
$ docker pull tomee@sha256:bf61b2855ae2a4040cd0a809babf2ad07a692112f9d48ce7500b457c8e58f493
```
...
```console
$ docker pull tomee@sha256:c57aeff2e1349c4d88bac545a5f8717ade8d88cd07bb291d49f2b0b5b7841957
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.1 MB (170057348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19a1388f8b13e29858b09111e9694774930c6492390d85fad2b2b21427177c6a`
...
# Sat, 03 Jun 2023 15:27:17 GMT
ENV TOMEE_BUILD=plus
# Sat, 03 Jun 2023 15:27:24 GMT
...
-	Layers:
	...
	-	`sha256:dcd34bdef44e76290da41c67ec5880d364715fd0271c27c4ce4333833de888e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a376ab176dd76d89f98b971b1e2dfb8613131624db36bd79a94d9f3cf6dc4911`  
		Last Modified: Sun, 04 Jun 2023 15:42:19 GMT  
		Size: 69.9 MB (69921827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:a33f5e90a39f3c252680e13a58fc61dad3305d320c93c2b007d7c651bcb1c68a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166316923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7a7960d9ee72b423b61c670596b29e0d5d0a709113eae0983f74d45e4fe7fae`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 01 Jun 2023 00:33:32 GMT
ENV TOMEE_VER=8.0.15
# Thu, 01 Jun 2023 00:34:04 GMT
ENV TOMEE_BUILD=plus
# Thu, 01 Jun 2023 00:34:12 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 01 Jun 2023 00:34:12 GMT
EXPOSE 8080
# Thu, 01 Jun 2023 00:34:12 GMT
...
-	Layers:
	...
	-	`sha256:2e4c678741e0694829cd1b97d8c77376ae7dca74d5dc4216fc8154eb7b5d86ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75c94638d118e641c302e57c5a7f549e60a259b9647124083f2d3b870ede5a14`  
		Last Modified: Thu, 01 Jun 2023 00:44:29 GMT  
		Size: 69.9 MB (69921822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
