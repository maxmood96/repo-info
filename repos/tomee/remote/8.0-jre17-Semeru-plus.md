...
```console
$ docker pull tomee@sha256:585f25aad88474c9ac4eb1404558a14db56f8ccd3939478db9b7ebd09b3b6060
```
...
```console
$ docker pull tomee@sha256:5efb478529d72e970aa9c1db2c0e64f0458235704cd9f7e93b51fcf87aec3573
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.1 MB (170122926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e7bdd7c90d3c913479bb3f6ff4554673bd2301e7c5428805bdd76dfd7b59dd2`
...
# Fri, 16 Jun 2023 05:49:17 GMT
ENV TOMEE_BUILD=plus
# Fri, 16 Jun 2023 05:49:24 GMT
...
-	Layers:
	...
	-	`sha256:f93d239456028b1489c0443eebb80f99a29ead5133bb1ea105b92b2075052d08`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c8cfdbd2d76367915f0b1f47b246f3a0d0c5d3b129e020255e1c7dd05328b7d`  
		Last Modified: Fri, 16 Jun 2023 06:14:55 GMT  
		Size: 69.9 MB (69921799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:15628400e14d8a46ac60301caffebd1337ead3b4da9e3634c64f545a442dc140
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.4 MB (166421629 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:939cff97149c03997ebc742a7f097d6d36eef1cb98fecab7e5c8cf4691698e68`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 05:08:45 GMT
ENV TOMEE_VER=8.0.15
# Wed, 05 Jul 2023 05:09:15 GMT
ENV TOMEE_BUILD=plus
# Wed, 05 Jul 2023 05:09:22 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 05 Jul 2023 05:09:22 GMT
EXPOSE 8080
# Wed, 05 Jul 2023 05:09:22 GMT
...
-	Layers:
	...
	-	`sha256:a075cdd84c8d4852734727273eabe3723023d68f9e2bb02810415562a3855a9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01680e07749cd3b223a5925c2bb5fdea8155569fe1d1509c0ea85cbbee6f67de`  
		Last Modified: Wed, 05 Jul 2023 05:30:27 GMT  
		Size: 69.9 MB (69921819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
