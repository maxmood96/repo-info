...
```console
$ docker pull tomee@sha256:a17fabbd97d74536febc6705ae3ab191776ec99681136d1859c4016a7495ad9c
```
...
```console
$ docker pull tomee@sha256:449cfb3ce3d690b3ed8c3b8bae71a387290b8d268f787213803d533dfbe7e593
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.1 MB (171124694 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3efc99fad4455801b4e5e10d3ba4a61a4e7dce1319e294452d88483e789d8496`
...
# Wed, 24 Aug 2022 01:27:45 GMT
ENV TOMEE_BUILD=plus
# Wed, 24 Aug 2022 01:27:53 GMT
...
-	Layers:
	...
	-	`sha256:1463acfb225412559528f2c3212d2ea68a929b92b6bd46319615fe951a1ade05`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0aca73d8e01ba1754e0a23819c52e9927def9005f240e3019147d16cea50363`  
		Last Modified: Wed, 24 Aug 2022 01:53:45 GMT  
		Size: 70.1 MB (70126500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0-jre17-Semeru-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:5e92803ed4496552ce87d490310944077ac27e1d2f0569ba07a944828bbe48ca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167328782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb9fa3e21e68bc7469c842b7ffaccc4faa719ba2ef180d8fc2382e541a226d54`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=8.0.12
# Wed, 10 Aug 2022 22:56:11 GMT
ENV TOMEE_BUILD=plus
# Wed, 10 Aug 2022 22:56:20 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 10 Aug 2022 22:56:20 GMT
EXPOSE 8080
# Wed, 10 Aug 2022 22:56:21 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3fa3493acc49a70e03e4e988787d1c89a3a4923bb9067640d3505321e9da3f94`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8168a3e5dc6645ec45dc5d76742d6d387ccf773c28b44c5a59b10f7cb598244a`  
		Last Modified: Wed, 10 Aug 2022 23:36:52 GMT  
		Size: 70.1 MB (70126238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
