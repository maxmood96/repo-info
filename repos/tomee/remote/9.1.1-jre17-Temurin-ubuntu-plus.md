## `tomee:9.1.1-jre17-Temurin-ubuntu-plus`

```console
$ docker pull tomee@sha256:49e27e819cd605e5a0f687a43b878584be3448f041cdffeabf08b946db82929a
```
...
### `tomee:9.1.1-jre17-Temurin-ubuntu-plus` - linux; amd64

```console
$ docker pull tomee@sha256:91082ce3dac56227a334b7e51d32befa047297fa063c1fd312e6da9fb54b1e2c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (171962456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a098998c73a989a4c355b43518a8e6b1f34e6a142b1b55409838ecc004ea45c`
...
# Tue, 31 Oct 2023 02:21:25 GMT
ENV TOMEE_VER=9.1.1
# Tue, 31 Oct 2023 02:22:04 GMT
ENV TOMEE_BUILD=plus
# Tue, 31 Oct 2023 02:22:12 GMT
...
-	Layers:
	...
	-	`sha256:3e9ba2c5e5b0640249599a2314ce7ace4edda28953253f726e6100e7d9ef7df3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ae60931f509dd8433272ab5a264112bf99f372152c844e1b8b0cf7061cea10b`  
		Last Modified: Tue, 31 Oct 2023 02:51:45 GMT  
		Size: 74.3 MB (74255014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:9.1.1-jre17-Temurin-ubuntu-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:d3883f8614d0118f692dce818668934c7703ea50e3fca3326490092cf29f73d6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170780860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b11c7ebbc4a81de8ffce28c019e60c9cd989071f20b86fb0de46ec230bf3ca6f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=9.1.1
# Tue, 31 Oct 2023 03:30:41 GMT
ENV TOMEE_BUILD=plus
# Tue, 31 Oct 2023 03:30:49 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Tue, 31 Oct 2023 03:30:49 GMT
EXPOSE 8080
# Tue, 31 Oct 2023 03:30:49 GMT
...
-	Layers:
	...
	-	`sha256:154b57109239eb1a086d677332ff414e89b18cf6e58918d43cf704a04440db87`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a52c6982c36adc623dc6900b3229c604e701cd23bb74522b848e404104dfa7d6`  
		Last Modified: Tue, 31 Oct 2023 03:50:24 GMT  
		Size: 74.3 MB (74254986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
