...
```console
$ docker pull tomee@sha256:f6792440cb607c198a4db0e1d146f54226e53b36115956d9b776e056d28333b4
```
...
```console
$ docker pull tomee@sha256:24fdaea44a6568d7b7428c76fa04ecbcb1cfc04ea275d55c072f71464df6726c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.5 MB (176462811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e366b8dba194ac1de7a89e8e56705727560be77cd030c3ce7699e7b129965678`
...
# Thu, 31 Aug 2023 21:45:19 GMT
ENV TOMEE_BUILD=plume
# Thu, 31 Aug 2023 21:45:27 GMT
...
-	Layers:
	...
	-	`sha256:04229e403e5bb695bae2d6385f63875fa58b894e0077f502ffa27957f6abae6d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40f763495b6edce781615355df95a4a7148d729e6c451af27bb265aadf520b65`  
		Last Modified: Thu, 31 Aug 2023 22:02:40 GMT  
		Size: 77.7 MB (77746754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8.0.15-Temurin-ubuntu-plume` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:ef1bcbb74cd497c86a5ef879ebf19af49fe7c81f81e80e97c0d7be1d2180c95c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175245708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be04919177d2e3a42e916dd4d79e33bf4c22712da30c0ca3e6298100612132a6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 13 Oct 2023 08:55:19 GMT
ENV TOMEE_VER=8.0.15
# Fri, 13 Oct 2023 08:55:38 GMT
ENV TOMEE_BUILD=plume
# Fri, 13 Oct 2023 08:55:46 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 13 Oct 2023 08:55:46 GMT
EXPOSE 8080
# Fri, 13 Oct 2023 08:55:46 GMT
...
-	Layers:
	...
	-	`sha256:b17339e9b2811fdbc7ae9a3e8b15b81d627271bb218d9cb71e86da53e1589b72`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cf2cb08d245b4d8316a10b571e85e08bac38c73b15bced967b70a28a5bee8d4`  
		Last Modified: Fri, 13 Oct 2023 09:12:14 GMT  
