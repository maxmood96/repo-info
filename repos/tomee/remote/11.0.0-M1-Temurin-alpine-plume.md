...
### `tomee:11.0.0-M1-Temurin-alpine-plume` - linux; amd64
...
### `tomee:11.0.0-M1-Temurin-alpine-plume` - unknown; unknown
...
### `tomee:11.0.0-M1-Temurin-alpine-plume` - linux; arm64 variant v8
