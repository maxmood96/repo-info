...
### `tomee:10.0.0-M1-Semeru-ubuntu-plume` - linux; amd64
...
### `tomee:10.0.0-M1-Semeru-ubuntu-plume` - unknown; unknown
...
### `tomee:10.0.0-M1-Semeru-ubuntu-plume` - linux; arm64 variant v8
