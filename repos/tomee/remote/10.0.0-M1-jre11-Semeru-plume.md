...
### `tomee:10.0.0-M1-jre11-Semeru-plume` - linux; amd64
...
### `tomee:10.0.0-M1-jre11-Semeru-plume` - unknown; unknown
...
### `tomee:10.0.0-M1-jre11-Semeru-plume` - linux; arm64 variant v8
