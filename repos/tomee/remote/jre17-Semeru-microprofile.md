...
```console
$ docker pull tomee@sha256:497b4a2ffa2ef516aff6ee82d28b4e46b39a00f168026ea52b27e79feb844b63
```
...
```console
$ docker pull tomee@sha256:038409bb8b6a4508367ca09323b8e914f2991d9dc258761aad27183fcfda2df3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170711372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:699c8f2fd8c348510e9382ef531c452ed257899e0daab85052f3665ed67b3125`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 01 Dec 2025 22:16:18 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Mon, 01 Dec 2025 22:16:18 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg # buildkit
# Mon, 01 Dec 2025 22:16:18 GMT
WORKDIR /usr/local/tomee
# Mon, 01 Dec 2025 22:16:28 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
...
-	Layers:
	...
	-	`sha256:d720a9f5e9e53bbb044c8bfce9605aa4425eba8b50105e1bcbc04471d71b1c80`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:84b394332953d53e68c92a76a78b962fcef5adc41762a1419a240d386c6777cc`  
		Last Modified: Mon, 01 Dec 2025 22:17:01 GMT  
		Size: 174.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 10 Oct 2025 22:54:50 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:39673202df2def62b68ce044a6d8bc000698753958cc097fcc43587374a05d60`  
		Last Modified: Mon, 01 Dec 2025 22:17:02 GMT  
		Size: 2.3 MB (2341878 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ad72c60eeae56d4309829ba8a169d36140897df1814f986bc612125b1d44461a`  
		Last Modified: Mon, 01 Dec 2025 22:17:02 GMT  
		Size: 75.7 KB (75665 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3bed7b395e989a4c47c87a5489a0d968dc4e59c2fac1b4000770af01d07c31ac`  
		Last Modified: Mon, 01 Dec 2025 22:17:21 GMT  
		Size: 70.4 MB (70445232 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:jre17-Semeru-microprofile` - unknown; unknown

```console
$ docker pull tomee@sha256:250de588977e4e32d08f6c06d7d2c6bcdb4d39d015990072fcdde62e1ffbcbb4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.2 MB (4248465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f33436e0f6b69c42ab039dbc737b532a842248f691557d66099b9059bd703529`

```dockerfile
```

-	Layers:
	-	`sha256:09b68f2c6af1b7f7a4ef501420636d4c6be8ecfcb6abecd90ca70c0f6b0d9079`  
		Last Modified: Mon, 01 Dec 2025 23:12:06 GMT  
		Size: 4.2 MB (4217675 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ba254937417e3b56c6f91d160bab2a427079d61528111d63be46f119131ffc55`  
		Last Modified: Mon, 01 Dec 2025 23:12:07 GMT  
