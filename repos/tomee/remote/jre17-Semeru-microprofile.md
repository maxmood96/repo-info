...
```console
$ docker pull tomee@sha256:40626d7ca6ba269be862f42f1b0fdaec689a62d999be07ecad476e8eb05c1872
```
...
```console
$ docker pull tomee@sha256:68b7a75ee18332337e12aa65ea78aac08023394aa24acb7867c88b639aa3ab27
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174712527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2dfbce803fbc2027378da9a4e466e8a40472f603bfdd544355f1e79820b68170`
...
-	Layers:
	...
	-	`sha256:d519b9076ae98b6426f41422c82797c40eb767583f0b6fcbb33c8c344a197cbe`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0f0eb2e0cfbfb19d9223543139c720c6734edaf4fefb63f685f11361d839dc21`  
		Last Modified: Mon, 15 Dec 2025 19:02:46 GMT  
		Size: 173.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:345deba708921bf245966fc6e7492a608144bf041252757a9e2083e41c818c14`  
		Last Modified: Mon, 15 Dec 2025 19:02:36 GMT  
		Size: 2.4 MB (2357892 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3620531caaaccd23c5f8abb7a640841c82f3a18b15d0eaafe1409972df3c0fa1`  
		Last Modified: Mon, 15 Dec 2025 19:02:46 GMT  
		Size: 75.6 KB (75636 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ca34cee148534d72e5619eb21dd2bed701530d839aa4760308c6f410ca75b291`  
		Last Modified: Mon, 15 Dec 2025 19:03:13 GMT  
		Size: 70.3 MB (70281765 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:jre17-Semeru-microprofile` - unknown; unknown

```console
$ docker pull tomee@sha256:8b96e3a44fd60bd75d2af6ecc4ba077ba7c74a78305389be7cd1aea1db4a361e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.2 MB (4249626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dd9f1c600f45b60621343bdf1a39f500b8a3984aa4ae16d04757030f4266fa3`

```dockerfile
```

-	Layers:
	-	`sha256:fc7c388197b5b81e82e3e5cc450aa26e93b8c8a004f16251f205246e50ce108f`  
		Last Modified: Mon, 15 Dec 2025 20:13:48 GMT  
		Size: 4.2 MB (4219129 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a42b69d0a726524c8ba1d4035d0abfa0e991b005f42f4d72503d4f980d222de2`  
		Last Modified: Mon, 15 Dec 2025 20:13:49 GMT  
...
```console
$ docker pull tomee@sha256:53e67006094c9a8851d2e00005b6858d6fe7eb54049a25dedad8c47d03595ac8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.5 MB (170547915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77339ddcd90d130ce729076975a89769209bfceb0f63b025cb303b42eab46975`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -eux;     unset OPENJ9_JAVA_OPTIONS;     SCC_SIZE="50m";     DOWNLOAD_PATH_TOMCAT=/tmp/tomcat;     INSTALL_PATH_TOMCAT=/opt/tomcat-home;     TOMCAT_CHECKSUM="fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d";     TOMCAT_VERSION="9.0.112";     TOMCAT_FILENAME="apache-tomcat-${TOMCAT_VERSION}.tar.gz";     SUCCESS=;         mkdir -p "${DOWNLOAD_PATH_TOMCAT}" "${INSTALL_PATH_TOMCAT}";     for baseUrl in         https://dlcdn.apache.org/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin         https://archive.apache.org/dist/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin     ; do         if curl -LfsSo "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz "${baseUrl}/${TOMCAT_FILENAME}" && [ -s "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz ]; then             SUCCESS=1;             break;         fi;     done;     [ -n "$SUCCESS" ];     echo "${TOMCAT_CHECKSUM}  ${DOWNLOAD_PATH_TOMCAT}/tomcat.tar.gz" | sha512sum -c -;     tar -xf "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz -C "${INSTALL_PATH_TOMCAT}" --strip-components=1;     rm -rf "${DOWNLOAD_PATH_TOMCAT}";         java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 5;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 15;     FULL=$( (java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     DST_CACHE=$(java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,destroy 2>&1 || true);     SCC_SIZE=$(echo $SCC_SIZE | sed 's/.$//');     SCC_SIZE=$(awk "BEGIN {print int($SCC_SIZE * $FULL / 100.0)}");     [ "${SCC_SIZE}" -eq 0 ] && SCC_SIZE=1;     SCC_SIZE="${SCC_SIZE}m";     java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     unset OPENJ9_JAVA_OPTIONS;         export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 5;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 5;     FULL=$( (java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     echo "SCC layer is $FULL% full.";     rm -rf "${INSTALL_PATH_TOMCAT}";     if [ -d "/opt/java/.scc" ]; then           chmod -R 0777 /opt/java/.scc;     fi;         echo "SCC generation phase completed"; # buildkit
# Mon, 15 Dec 2025 19:01:36 GMT
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Mon, 15 Dec 2025 19:01:36 GMT
RUN mkdir -p /usr/local/tomee ~/.gnupg # buildkit
# Mon, 15 Dec 2025 19:01:36 GMT
WORKDIR /usr/local/tomee
# Mon, 15 Dec 2025 19:01:46 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 15 Dec 2025 19:01:56 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   871638A21A7F2C38066471420306A354336B4F0D   85FBBE98D6C37CDA8A7D8FF9F9FF83A48D339D37   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done # buildkit
# Mon, 15 Dec 2025 19:01:56 GMT
ENV TOMEE_VER=10.1.3
# Mon, 15 Dec 2025 19:01:56 GMT
ENV TOMEE_BUILD=microprofile
# Mon, 15 Dec 2025 19:01:58 GMT
RUN set -eux; 	ddist() { 		local f="$1"; shift; 		local distFile="$1"; shift; 		local success=; 		local distUrl=; 		for distUrl in 			https://dlcdn.apache.org/ 			https://archive.apache.org/dist/ 		; do 			if curl -fSL "$distUrl$distFile" -o "$f" && [ -s "$f" ]; then 				success=1; 				break; 			fi; 		done; 		[ -n "$success" ]; 	};   ddist tomee.tar.gz.asc tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc   && ddist tomee.tar.gz.sha512 tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512   && ddist apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz* # buildkit
# Mon, 15 Dec 2025 19:01:58 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 15 Dec 2025 19:01:58 GMT
...
-	Layers:
	...
	-	`sha256:d720a9f5e9e53bbb044c8bfce9605aa4425eba8b50105e1bcbc04471d71b1c80`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c44a8388fa8b344f915f14da23e749fe87bbb4154899c650eeb6dc82e6caee76`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5016c21a6ba9edb9e37575828c38315fb89857b38d9b9544cee8504360d2b15d`  
		Last Modified: Mon, 15 Dec 2025 19:02:22 GMT  
		Size: 2.3 MB (2341933 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:411cbc434b0e6b5d428bc8d289d0f3abb17a286fa3aa9f7b3cd95e0ebf58f6a3`  
		Last Modified: Mon, 15 Dec 2025 19:02:21 GMT  
		Size: 75.6 KB (75642 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:eda150305327b0c1a4ab96886e20cb1979e940ce6aa05e6807af571a953aeffb`  
		Last Modified: Mon, 15 Dec 2025 19:02:37 GMT  
		Size: 70.3 MB (70281744 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `tomee:jre17-Semeru-microprofile` - unknown; unknown

```console
$ docker pull tomee@sha256:8031b73b93d1cf42d875606643d2d428a4e82ccb93ab4a48385946bada53c3f1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.2 MB (4248464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc7f8cc48b7e6c6a75dff23454f771819e57d2aea9361b6e94d4cb23f7d74955`

```dockerfile
```

-	Layers:
	-	`sha256:4c1d8624804f4326897a28c79010813f2d300130d83c00c7087c1c68550a670d`  
		Last Modified: Mon, 15 Dec 2025 20:13:53 GMT  
		Size: 4.2 MB (4217675 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:eacb19e6fa23754ad2b5f24bf75fa0c94ce5736e8aa8b30eefa45f2451f62e55`  
		Last Modified: Mon, 15 Dec 2025 20:13:54 GMT  
