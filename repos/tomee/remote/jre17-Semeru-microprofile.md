...
```console
$ docker pull tomee@sha256:97d9bf7e0666f9958fc055dcf4dfd7741843768453a59514ea345ec053b08585
```
...
```console
$ docker pull tomee@sha256:ab620006f477c988bedc18344fecbb915dd4faeed7a8017918337e3c9724193c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166873316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d201a361453d5b0c9e21c395cca07238e4472cb2e68577bb153711b20ffc49f9`
...
# Tue, 16 Jan 2024 20:41:57 GMT
ENV TOMEE_BUILD=microprofile
# Tue, 16 Jan 2024 20:42:04 GMT
...
-	Layers:
	...
	-	`sha256:7e41107c388e8402d5bdf01c8d9c31caca17c0e6516f7708b74ccab386e27f7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8a825e7a55bbc0eb0d1c9e1515da08f713384bc7661f16e02e23083121127a8`  
		Last Modified: Tue, 16 Jan 2024 20:55:48 GMT  
...
```console
$ docker pull tomee@sha256:83cdc50bfd0807b150b4f81af64d90a5aeab14200beaf367389d666fc9ce71ba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.7 MB (163734284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f06eb1f729e0a93b7ba04aed03aed53a789e5500c38746e493d1b69dfe8eea92`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 16 Dec 2023 14:15:11 GMT
ENV TOMEE_VER=8.0.16
# Sat, 16 Dec 2023 14:15:20 GMT
ENV TOMEE_BUILD=microprofile
# Sat, 16 Dec 2023 14:15:26 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Sat, 16 Dec 2023 14:15:27 GMT
EXPOSE 8080
# Sat, 16 Dec 2023 14:15:27 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:fc7f09e8c6484333562cf2877854bd0ee739f3e8bbb8bde446d0e0a4d60d3e02`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:844feacc83d0f9e162e179248df537a8482c6c201da609e6aa6c91ba2d3a707d`  
		Last Modified: Sat, 16 Dec 2023 14:37:31 GMT  
		Size: 66.2 MB (66151258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
