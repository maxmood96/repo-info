...
```console
$ docker pull tomee@sha256:227ce80df69d56e509416ea4f8dddc3f3c977388fbb4cf4358e01a2f72134031
```
...
```console
$ docker pull tomee@sha256:1a45a7930aff7cac8885790a829c60e5ac8ddd8a82c0032e93975f1777d4b207
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.9 MB (163934246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:628104e0e93673b475e70334c0a8f8e1eaa0e07af76dcdb2197c2b86b409e0c9`
...
# Sat, 03 Jun 2023 15:26:55 GMT
ENV TOMEE_BUILD=microprofile
# Sat, 03 Jun 2023 15:27:01 GMT
...
-	Layers:
	...
	-	`sha256:02ba360d31077dc366844ca724e69747754db979b23fe07cbad095bb5b52f7fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:048c3e5ac1a81930a6725692865dce435d852f6b553cb490770443b61c70111a`  
		Last Modified: Sun, 04 Jun 2023 15:39:52 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0dd0cc36bacd0f979d6b87d273a62de54f1ea8efb25a9798587dd9ba54241dc`  
		Last Modified: Sun, 04 Jun 2023 15:39:53 GMT  
		Size: 2.2 MB (2192411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcd34bdef44e76290da41c67ec5880d364715fd0271c27c4ce4333833de888e7`  
		Last Modified: Sun, 04 Jun 2023 15:39:53 GMT  
		Size: 62.9 KB (62938 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1233f2ece9e85416cc4e9b15577d964d32235e42b765938e4a6f2d63b8eb67ac`  
		Last Modified: Sun, 04 Jun 2023 15:41:04 GMT  
...
```console
$ docker pull tomee@sha256:1fa444fd08608eabe6aad2bb859a8bbfb9afe0113984011b16b816a83ba23dd3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.2 MB (160193779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ffb9a89996f41291f9f4b1b0a200d1169e7d93db8988c2da98ca6f1b62bc431`
-	Default Command: `["catalina.sh","run"]`
...
ENV PATH=/usr/local/tomee/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 01 Jun 2023 00:33:11 GMT
RUN mkdir -p /usr/local/tomee
# Thu, 01 Jun 2023 00:33:11 GMT
WORKDIR /usr/local/tomee
# Thu, 01 Jun 2023 00:33:23 GMT
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/*
# Thu, 01 Jun 2023 00:33:32 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Thu, 01 Jun 2023 00:33:32 GMT
ENV TOMEE_VER=8.0.15
# Thu, 01 Jun 2023 00:33:43 GMT
ENV TOMEE_BUILD=microprofile
# Thu, 01 Jun 2023 00:33:50 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Thu, 01 Jun 2023 00:33:51 GMT
EXPOSE 8080
# Thu, 01 Jun 2023 00:33:51 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:99d37044247df246b2ab675012773ba859276c7c230507bd2186ddbd0d8916f9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df92f71a9ca4485b43736bfef000f7a34f2ad23425ac8094dcdae5caf8be5f31`  
		Last Modified: Thu, 01 Jun 2023 00:42:04 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e81680045ad9908f99f342f9e6c7bf0da140bc9b4ad5898afadd9a71b1dc7e8`  
		Last Modified: Thu, 01 Jun 2023 00:42:05 GMT  
		Size: 2.2 MB (2187325 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e4c678741e0694829cd1b97d8c77376ae7dca74d5dc4216fc8154eb7b5d86ff`  
		Last Modified: Thu, 01 Jun 2023 00:42:04 GMT  
		Size: 62.9 KB (62918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:120c3f56b0a1fc750363011940663f88abe9c8db860e649bfa04b3b61a47e739`  
		Last Modified: Thu, 01 Jun 2023 00:43:13 GMT  
		Size: 63.8 MB (63798678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
