...
```console
$ docker pull tomee@sha256:d633e1d33803a0f4ddfad3684bf95854ae26997bfe07223378f119576486d626
```
...
```console
$ docker pull tomee@sha256:1cf681fabcef223f5df050b37e1ef86d2fcdc8647de1f22c7a245cb140b6c0ef
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156542558 bytes)**  
...
ENV TOMEE_VER=7.0.9
# Tue, 12 Jul 2022 19:45:59 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 12 Jul 2022 19:46:03 GMT
...
-	Layers:
	...
	-	`sha256:df6eec81a746fa3f23969a0513becf9947eeb347c6617bde920efea6e3f3acbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cb6cbf9472181af65e4e21c52a76b0f36d36d0f4aaee5a865c532b955f6d751`  
		Last Modified: Tue, 12 Jul 2022 20:08:01 GMT  
		Size: 38.4 MB (38406484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:8-jre-7.0.9-webprofile` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:31fe913122d82317856eda8378714d318b7ec544b37baa01cd63f5663555f3ed
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154224767 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b00b3ec1698664032ab4e83e424d6eec556c85cd1bd533850cfb0fb50e275e0d`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=7.0.9
# Tue, 12 Jul 2022 20:10:08 GMT
ENV TOMEE_BUILD=webprofile
# Tue, 12 Jul 2022 20:10:12 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Tue, 12 Jul 2022 20:10:13 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 20:10:14 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1c5d583348600b533bae004a47cdbae9d2dec97aaa4139208151f4beab98725c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c9ad44680b33928e18328c5e23148968392e5402a2227fe35be53347656ff4f`  
		Last Modified: Tue, 12 Jul 2022 20:47:00 GMT  
