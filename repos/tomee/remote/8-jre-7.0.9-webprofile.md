...
```console
$ docker pull tomee@sha256:fdf9c02dfa8840643be5eb8f1cb27533f0b8fcb5549bc5b296dbee08d7f46017
```
...
```console
$ docker pull tomee@sha256:992921ced8449662c57e382fff4fe660ddf54a41b9b111c4c2b565453aa353ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.0 MB (154034843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f413cf04581c74b24ea0612a3ad874bacf299344a3facbf624f0792379357fc5`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 24 Jun 2022 03:51:20 GMT
ENV TOMEE_VER=7.0.9
# Fri, 24 Jun 2022 03:51:54 GMT
ENV TOMEE_BUILD=webprofile
# Fri, 24 Jun 2022 03:51:59 GMT
RUN set -x 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc 	&& curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o tomee.tar.gz 	&& gpg --batch --verify tomee.tar.gz.asc tomee.tar.gz 	&& tar -zxf tomee.tar.gz 	&& mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee 	&& rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER} 	&& rm bin/*.bat 	&& rm tomee.tar.gz*
# Fri, 24 Jun 2022 03:51:59 GMT
EXPOSE 8080
# Fri, 24 Jun 2022 03:52:00 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9a5817782f9fcaba689dd5d6a4f1cf0c0585d347e521d481b142df6dbfa0feb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:601a266c1c05c33d741f110ef15340185b7e9e2f1e4c235b8b2b7b510e79db54`  
		Last Modified: Fri, 24 Jun 2022 04:19:55 GMT  
