...
```console
$ docker pull tomee@sha256:e68a87a7ba76290b7646d4784e4562c323f6ec9b5dee5bb5e43223692ccc70ef
```
...
```console
$ docker pull tomee@sha256:78ba7025dbc9e48c4fadb52c3af938effc48617e99574eab07399d2dc3b72789
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.7 MB (166667930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3735587e622db6f66def5e582500ec5aae9edc2668b491c7603381fc7aee9d79`
...
# Wed, 24 Apr 2024 23:44:42 GMT
ENV TOMEE_BUILD=plus
# Wed, 24 Apr 2024 23:44:50 GMT
...
-	Layers:
	...
	-	`sha256:0415c35c66e44e2ee30ab3d8d405f45fa24c7d53a0807ab2ef7970083aca22bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c041f71a9995ae67ec8809d3219b81296970bcaa30ac1abe1c4cd698b79a2473`  
		Last Modified: Thu, 25 Apr 2024 00:11:08 GMT  
...
```console
$ docker pull tomee@sha256:7029113a172fd9708db311405d561e70a61c0636fcbe34d87803ae9f37fa2a41
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162924608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f198fb6c9e568fba3bd74e933b345cd71fda1236c8f9fe8a1824cba3b306cd5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Wed, 24 Apr 2024 21:25:46 GMT
ENV TOMEE_BUILD=plus
# Wed, 24 Apr 2024 21:25:54 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 24 Apr 2024 21:25:55 GMT
EXPOSE 8080
# Wed, 24 Apr 2024 21:25:55 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:772be4e25d0774bc05099fc55576bd47451e265fc6e0103c004574c4215b4f2b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59582063767d159a4b046a3d7693a5d78afecffd238625b69200200c43210eba`  
		Last Modified: Wed, 24 Apr 2024 21:42:55 GMT  
