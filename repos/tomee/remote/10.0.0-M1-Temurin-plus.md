...
```console
$ docker pull tomee@sha256:c089322a3dac768e38af98263ef961c1c4afe85e79064b2e0dc57d379bdca7bf
```
...
### `tomee:10.0.0-M1-Temurin-plus` - linux; amd64

```console
$ docker pull tomee@sha256:ae5b6620d14b821d13686fb2a0e4b659523438064762977c888a2e6d21970fad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.7 MB (166667857 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74f3708c1751dd95a63142cebf1646a64be6b0f1f61e02d5b80f4a74e54ab845`
...
# Fri, 26 Apr 2024 04:12:11 GMT
ENV TOMEE_BUILD=plus
# Fri, 26 Apr 2024 04:12:18 GMT
...
-	Layers:
	...
	-	`sha256:8920132a75ddb6ccab67248f72f9c7938b18058c9c5a1a0234a7e98a19648410`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0a255a3e69a8a59b65df2c8d088f1002b17d87603eeeed97ba9fef9ca4361e5`  
		Last Modified: Fri, 26 Apr 2024 04:32:33 GMT  
		Size: 73.5 MB (73467632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:10.0.0-M1-Temurin-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:55a1048dafc501388a050dfadc4beee4a46d76f4b1511a3b7ed21a332a00b05a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162924864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc84f0dd25f790fb4a66a16915edefb1ee9f58230bde104c86da784aea58e563`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Fri, 26 Apr 2024 03:38:56 GMT
ENV TOMEE_BUILD=plus
# Fri, 26 Apr 2024 03:39:03 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Fri, 26 Apr 2024 03:39:04 GMT
EXPOSE 8080
# Fri, 26 Apr 2024 03:39:04 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9120245afa546e46739ba24a3099335bb96ea859fc47f68b7fc37ff1082b04de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01c4f27d68b20494fe9d3c6c93f6b9f4f2658066af024817fd0338700c8cd9e4`  
		Last Modified: Fri, 26 Apr 2024 03:55:52 GMT  
		Size: 73.5 MB (73467599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
