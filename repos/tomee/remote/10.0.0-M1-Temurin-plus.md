...
```console
$ docker pull tomee@sha256:805a741e14294a02899153f6a1ae68ac7eddbc73ddbf1af7f02db7198d3fe355
```
...
```console
$ docker pull tomee@sha256:24ad3a6c4e28210a4a972e3881239b99a59183bc011c11037b8a50887e353be5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166551261 bytes)**  
...
# Wed, 17 Apr 2024 02:12:02 GMT
ENV TOMEE_BUILD=plus
# Wed, 17 Apr 2024 02:12:10 GMT
...
-	Layers:
	...
	-	`sha256:f7dd9f0331c9eee7cc49872f453033add17f946d305ea3d4b51696a3de07b583`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca0e4690ef4a1a7693f14058890e643b64c2579688987de9c7e8cfa34d0d6c26`  
		Last Modified: Wed, 17 Apr 2024 02:46:43 GMT  
		Size: 73.5 MB (73467635 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomee:10.0.0-M1-Temurin-plus` - linux; arm64 variant v8

```console
$ docker pull tomee@sha256:8fac709c2ae3f076723572684f593ce7494c5cf60f520e662bfdf92e9c1e5375
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.8 MB (162767787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd745f4a5db9f924ec1d8d1f33c4f377b54e03bc7097f38360265213931d8f79`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMEE_VER=10.0.0-M1
# Wed, 17 Apr 2024 02:22:02 GMT
ENV TOMEE_BUILD=plus
# Wed, 17 Apr 2024 02:22:10 GMT
RUN set -x   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc -o tomee.tar.gz.asc   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512 -o tomee.tar.gz.sha512   && curl -fSL https://dist.apache.org/repos/dist/release/tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz -o apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz*
# Wed, 17 Apr 2024 02:22:10 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 02:22:10 GMT
...
-	Layers:
	...
	-	`sha256:f64c8b56a536742c45f2207ee4608e7416985c2ecc62e3c23da61633a666019a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b1e74d579fff9dcea02047a3516bfad73d70d4e36294f57cdd460f876eb4894`  
		Last Modified: Wed, 17 Apr 2024 02:47:44 GMT  
		Size: 73.5 MB (73467624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
