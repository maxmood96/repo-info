...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-jre11-Temurin-ubuntu-microprofile` - linux; arm64 variant v8
