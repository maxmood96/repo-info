...
```console
$ docker pull tomee@sha256:d1db42aadcceb6857603357142840ee0d992004a5ea2ec82f3d58b6f51abd9a8
```
...
### `tomee:8-jre17-Semeru-ubuntu-plume` - linux; amd64
...
### `tomee:8-jre17-Semeru-ubuntu-plume` - linux; arm64 variant v8
