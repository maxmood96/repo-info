...
```console
$ docker pull tomee@sha256:94d6191655b93920a5c5ad94459ef765476b712f361e3bf4533b65ebcdd30fb6
```
...
```console
$ docker pull tomee@sha256:f246e708ac0a14fd91d9a8522f3f6e4145671a9a1f790dac1f30d3a1203b4ad9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.1 MB (164108884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94c6817fed738dded254e47739e7fdc2967a363d10fe4e4a63202148681a9ddb`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e572adeba5f0915af6fec39c1478ab4e2c9eba987bef73e8426b56e5c5523e24`  
		Last Modified: Mon, 15 Dec 2025 19:01:26 GMT  
		Size: 2.4 MB (2357853 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:30ebdf92d72ad645a8bfea164352501ac0c04d20ee7e1081e668777e27346a4c`  
		Last Modified: Mon, 15 Dec 2025 19:01:25 GMT  
		Size: 75.6 KB (75647 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2f7840931a19118ca98bd1bed4a88ffa3dacb3e2a7ec1b02579bab0215e3802e`  
		Last Modified: Mon, 15 Dec 2025 19:01:34 GMT  
...
```console
$ docker pull tomee@sha256:c6bf6c170e273d6dd16ffba3ef9fba627d32e41a1fba2c4cb153d572f360dca2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4127945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0af57f6e42803d986293aef67f077d4f8ebe918ce5c6eef1de227eb642bb0b6`

```dockerfile
```

-	Layers:
	-	`sha256:31f06bc0b8d115c0a03a27ce4c0b776991377c4f3b880131a0a5ed0366ab06e4`  
		Last Modified: Mon, 15 Dec 2025 20:14:25 GMT  
		Size: 4.1 MB (4100070 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:760ee01fc2a5f3ad115b8262d58b87d8d734e8c206cefbb0377e84d23cc956a0`  
		Last Modified: Mon, 15 Dec 2025 20:14:26 GMT  
...
```console
$ docker pull tomee@sha256:b6498d4bd944d748e5c6858984acbf0a7368c918c5833e7467b6be6f1c435ea4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159944299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffe8de981d61754b07dc9aaad19ac8b6bc30fbcb0088e523f56a0f4a1fffbf88`
-	Default Command: `["catalina.sh","run"]`
...
RUN apt-get update   && apt-get install -y --no-install-recommends gpg dirmngr gpg-agent   && rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 15 Dec 2025 19:01:53 GMT
RUN set -xe;   for key in   9056B710F1E332780DE7AF34CBAEBE39A46C4CA1   F067B8140F5DD80E1D3B5D92318242FE9A0B1183   223D3A74B068ECA354DC385CE126833F9CF64915   DBCCD103B8B24F86FFAAB025C8BB472CD297D428   7A2744A8A9AAF063C23EB7868EBE7DBE8D050EEF   B8B301E6105DF628076BD92C5483E55897ABD9B9   FAA603D58B1BA4EDF65896D0ED340E0E6D545F97   A57DAF81C1B69921F4BA8723A8DE0A4DB863A7C1   82D8419BA697F0E7FB85916EE91287822FDB81B1   B7574789F5018690043E6DD9C212662E12F3E1DD   C23A3F6F595EBD0F960270CC997C8F1A5BE6E4C1   678F2D98F1FD9643811639FB622B8F2D043F71D8   BDD0BBEB753192957EFC5F896A62FC8EF17D8FEF   D11DF12CC2CA4894BDE638B967C1227A2678363C   C92604B0DEC5C62CFF5801E73D4683C24EDC64D1   626C542EDA7C113814B77AF09C04914D63645D20   3948829384B269D333CC5B98358807C52B4B0E23   B83D15E72253ED1104EB4FBBDAB472F0E5B8A431   871638A21A7F2C38066471420306A354336B4F0D   85FBBE98D6C37CDA8A7D8FF9F9FF83A48D339D37   ; do     gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys "$key" ||     gpg --batch --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done # buildkit
# Mon, 15 Dec 2025 19:01:53 GMT
ENV TOMEE_VER=10.1.3
# Mon, 15 Dec 2025 19:01:53 GMT
ENV TOMEE_BUILD=webprofile
# Mon, 15 Dec 2025 19:01:55 GMT
RUN set -eux; 	ddist() { 		local f="$1"; shift; 		local distFile="$1"; shift; 		local success=; 		local distUrl=; 		for distUrl in 			https://dlcdn.apache.org/ 			https://archive.apache.org/dist/ 		; do 			if curl -fSL "$distUrl$distFile" -o "$f" && [ -s "$f" ]; then 				success=1; 				break; 			fi; 		done; 		[ -n "$success" ]; 	};   ddist tomee.tar.gz.asc tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.asc   && ddist tomee.tar.gz.sha512 tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz.sha512   && ddist apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz tomee/tomee-${TOMEE_VER}/apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && gpg --batch --verify tomee.tar.gz.asc apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && echo `cat tomee.tar.gz.sha512` | sha512sum -c -   && tar -zxf apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && mv apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}/* /usr/local/tomee   && rm apache-tomee-${TOMEE_VER}-${TOMEE_BUILD}.tar.gz   && rm -Rf apache-tomee-${TOMEE_BUILD}-${TOMEE_VER}   && rm bin/*.bat   && rm bin/*.exe   && rm bin/*.tar.gz*   && rm tomee.tar.gz.asc   && rm tomee.tar.gz* # buildkit
# Mon, 15 Dec 2025 19:01:55 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 15 Dec 2025 19:01:55 GMT
...
-	Layers:
	...
	-	`sha256:d720a9f5e9e53bbb044c8bfce9605aa4425eba8b50105e1bcbc04471d71b1c80`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4dd63c69f064d543c7102747238169eca96ac8df02e6e281789eeef44234fbde`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:454e742d3806ec22dda8b1347dbbdff527115e0aa1b6775d90adebb91a9e141d`  
		Last Modified: Mon, 15 Dec 2025 19:02:13 GMT  
		Size: 2.3 MB (2341930 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3386e30dbaecf908775b49397a8f00f69ed1a97df3ea1cc7567192497e5183c6`  
		Last Modified: Mon, 15 Dec 2025 19:02:13 GMT  
		Size: 75.6 KB (75630 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:abd8ad8bb9467be23dd9fc7b15fe97ea61e8dcbe39cb69d832ebe6cafc73e2e1`  
...
```console
$ docker pull tomee@sha256:006989c749eff3212003ceb83bd4c334b55e7b1c375ce910bc69e5a117d3199c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4126592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06fe0acc82178be3d2ee060d448baed4fcbd9fcc6d66a0dad0b05e8f1e5fd640`

```dockerfile
```

-	Layers:
	-	`sha256:37b396419417d23cb1456e88eadf130f96241637564501b6662ab327b75c917f`  
		Last Modified: Mon, 15 Dec 2025 20:14:31 GMT  
		Size: 4.1 MB (4098520 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:38d10e166bb335774b96e668f2b23d835bcaa1c6e5c794483734a2f3d8a2d4b9`  
		Last Modified: Mon, 15 Dec 2025 20:14:32 GMT  
