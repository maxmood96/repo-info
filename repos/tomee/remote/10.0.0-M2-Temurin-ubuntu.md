## `tomee:10.0.0-M2-Temurin-ubuntu`
...
### `tomee:10.0.0-M2-Temurin-ubuntu` - linux; amd64
...
### `tomee:10.0.0-M2-Temurin-ubuntu` - unknown; unknown
...
### `tomee:10.0.0-M2-Temurin-ubuntu` - linux; arm64 variant v8
