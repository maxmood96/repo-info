## `tomee:10.0.0-M2-Temurin-alpine-webprofile`
...
### `tomee:10.0.0-M2-Temurin-alpine-webprofile` - linux; amd64
...
### `tomee:10.0.0-M2-Temurin-alpine-webprofile` - unknown; unknown
