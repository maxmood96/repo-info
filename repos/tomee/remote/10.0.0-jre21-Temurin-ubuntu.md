...
### `tomee:10.0.0-jre21-Temurin-ubuntu` - linux; amd64
...
### `tomee:10.0.0-jre21-Temurin-ubuntu` - unknown; unknown
...
### `tomee:10.0.0-jre21-Temurin-ubuntu` - linux; arm64 variant v8
