...
### `tomee:10.0.0-M1-ubuntu-microprofile` - linux; amd64
...
### `tomee:10.0.0-M1-ubuntu-microprofile` - unknown; unknown
...
### `tomee:10.0.0-M1-ubuntu-microprofile` - linux; arm64 variant v8
