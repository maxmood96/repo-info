...
### `tomee:11.0.0-M1-jre25-Temurin-ubuntu-webprofile` - linux; amd64
...
### `tomee:11.0.0-M1-jre25-Temurin-ubuntu-webprofile` - unknown; unknown
...
### `tomee:11.0.0-M1-jre25-Temurin-ubuntu-webprofile` - linux; arm64 variant v8
