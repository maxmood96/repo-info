...
- Created: `2020-01-25T02:43:43.63534982Z`
- Virtual Size: ~ 747.95 Mb  
...
- `comerr-dev=2.1-1.42.12-2+deb8u1`
...
```console
$ apt-get source -qq --print-uris libgd2=2.1.0-5+deb8u13
'http://security.debian.org/debian-security/pool/updates/main/libg/libgd2/libgd2_2.1.0-5+deb8u13.dsc' libgd2_2.1.0-5+deb8u13.dsc 2355 SHA256:13e8b95fd91a2f94e4ead5d72bfab11af75a542ac5bac7ad8f28a7cfdf8bce9b
...
'http://security.debian.org/debian-security/pool/updates/main/libg/libgd2/libgd2_2.1.0-5+deb8u13.debian.tar.xz' libgd2_2.1.0-5+deb8u13.debian.tar.xz 43028 SHA256:943ab2fc94c1193a4d02bf40c4f34cc12da446315dff29bb95804a706b3c4101
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgd2/2.1.0-5+deb8u13/ (for browsing the source)
- https://sources.debian.net/src/libgd2/2.1.0-5+deb8u13/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgd2/2.1.0-5+deb8u13/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris tcl8.6=8.6.2+dfsg-2
'http://deb.debian.org/debian/pool/main/t/tcl8.6/tcl8.6_8.6.2+dfsg-2.dsc' tcl8.6_8.6.2+dfsg-2.dsc 2031 SHA256:38cc8c8d674b7782a1b15f32c4b4160d8de1278684f396eeb010c520c0f8e9d0
'http://deb.debian.org/debian/pool/main/t/tcl8.6/tcl8.6_8.6.2+dfsg.orig.tar.gz' tcl8.6_8.6.2+dfsg.orig.tar.gz 5812100 SHA256:bc539f27e423f05637575b324e60fed2c4bfc26b0dc3f25e4f94d83b473a43d9
'http://deb.debian.org/debian/pool/main/t/tcl8.6/tcl8.6_8.6.2+dfsg-2.debian.tar.xz' tcl8.6_8.6.2+dfsg-2.debian.tar.xz 14724 SHA256:24d249cf7d7d9405c5b2adfb868611235ebde78c41bc8701087e2a66bf1f5189
```

Other potentially useful URLs:

- https://sources.debian.net/src/tcl8.6/8.6.2+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/tcl8.6/8.6.2+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tcl8.6/8.6.2+dfsg-2/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris tcltk-defaults=8.6.0+8
'http://deb.debian.org/debian/pool/main/t/tcltk-defaults/tcltk-defaults_8.6.0+8.dsc' tcltk-defaults_8.6.0+8.dsc 1276 SHA256:7e9f3478b081cc6ddc1763562e86984a10c067edc54b68fa54bfe73694374272
'http://deb.debian.org/debian/pool/main/t/tcltk-defaults/tcltk-defaults_8.6.0+8.tar.xz' tcltk-defaults_8.6.0+8.tar.xz 13648 SHA256:beb10c8bebc11dc5bac04d8f69594ac52ddcf1f0f961d056919cea8903ec7987
```

Other potentially useful URLs:

- https://sources.debian.net/src/tcltk-defaults/8.6.0+8/ (for browsing the source)
- https://sources.debian.net/src/tcltk-defaults/8.6.0+8/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tcltk-defaults/8.6.0+8/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris tk8.6=8.6.2-1
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.2-1.dsc' tk8.6_8.6.2-1.dsc 1431 SHA256:00282766db224c1c2f2898e51adad8072c1ae52d6be938e78eee6379769468a6
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.2.orig.tar.gz' tk8.6_8.6.2.orig.tar.gz 4246617 SHA256:afb6639043ec38905afe22b61ca54820217f4d4e81e0ad49f839c16d2bf98579
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.2-1.debian.tar.xz' tk8.6_8.6.2-1.debian.tar.xz 10844 SHA256:b8327498ffa62d8be6b263560aa1da994ea1d626198076ae94bcae62cae5b6e1
```

Other potentially useful URLs:

- https://sources.debian.net/src/tk8.6/8.6.2-1/ (for browsing the source)
...
### `dpkg` source package: `unzip=6.0-16+deb8u5`
...
- http://snapshot.debian.org/package/unzip/6.0-16+deb8u5/
