...
```console
$ docker pull pypy@sha256:a722545c4c16bbbaa79f9f39920f39665245a6095fb6112c8129982f0434aed4
```
...
### `pypy:3.8-7-slim-bookworm` - linux; amd64
...
### `pypy:3.8-7-slim-bookworm` - linux; arm64 variant v8
