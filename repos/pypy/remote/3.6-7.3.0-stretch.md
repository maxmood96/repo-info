...
### `pypy:3.6-7.3.0-stretch` - linux; amd64
...
### `pypy:3.6-7.3.0-stretch` - linux; arm64 variant v8
...
### `pypy:3.6-7.3.0-stretch` - linux; 386
...
### `pypy:3.6-7.3.0-stretch` - linux; ppc64le
...
### `pypy:3.6-7.3.0-stretch` - linux; s390x
