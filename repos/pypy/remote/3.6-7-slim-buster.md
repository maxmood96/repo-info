...
```console
$ docker pull pypy@sha256:640e289a41d5324a7265a3f9c8fd2d5c2378e2b0e9d0f3d3727d80c52f57e21f
```
...
```console
$ docker pull pypy@sha256:b9c8cbcff015b5516cf2c11a5f8263da7c5c36935cdd419b553f31c9eb2215d1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.0 MB (68008760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d3d8a406998cfd41075a28ae0694e8f149b1f9391837823432022f569b83fcf`
...
```console
$ docker pull pypy@sha256:d9cadfb48e41cc552e44d0dbf6ea00288804b35712b31da4507eb3751fd8434d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.4 MB (60403930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6202879aa8c2b9d171cb64ac0b5cfb886134df6718140b5f79ed050834bcb4da`
-	Default Command: `["pypy3"]`
...
ENV PYTHON_PIP_VERSION=20.2.4
# Tue, 20 Oct 2020 17:51:18 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/8283828b8fd6f1783daf55a765384e6d8d2c5014/get-pip.py
# Tue, 20 Oct 2020 17:51:18 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 17:52:11 GMT
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		wget 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		pypy3 get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	apt-get purge -y --auto-remove wget; 	pip --version; 		find /opt/pypy -depth 		\( 			\( -type d -a \( -name test -o -name tests \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 17:52:13 GMT
CMD ["pypy3"]
```
...
-	Layers:
	...
	-	`sha256:e202e68dc254c6e8b107ab20a0c00d499dc205c0b972aa013ec6213203f98377`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e4db37d2e264e192683260e42b3c3f225ad0cfe6615440aadfe977cb69cb8c`  
		Last Modified: Tue, 20 Oct 2020 17:57:37 GMT  
		Size: 2.4 MB (2397146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `pypy:3.6-7-slim-buster` - linux; 386

```console
$ docker pull pypy@sha256:a821516d75286eb427f21927369912d4e97ab5b620b3afd5aa659ff012092eda
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.0 MB (70971487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:901934b6fb08e3a006a007f87a49aad358b46ae1ca010474020615886c055228`
-	Default Command: `["pypy3"]`
...
-	Layers:
	...
	-	`sha256:4efdd334df4432ad4df98638cad16becc2b78a2477f9775b4580058708419ac2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:241cb83caddf1932da01951386c5dbd361e0e2bfe856905debfdb17c882f7ed4`  
		Last Modified: Tue, 20 Oct 2020 18:03:14 GMT  
...
```console
$ docker pull pypy@sha256:c709c874e6abd90ebf395416ad9407443e080c07a8a21f894a3ed3e9eb21d155
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.3 MB (63264224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:774a0ed7a481555d1844bf7ed535f719b7fe252797720d4b95e55a36acce2dd2`
-	Default Command: `["pypy3"]`
...
# Tue, 20 Oct 2020 17:56:05 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 17:56:18 GMT
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		wget 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		pypy3 get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	apt-get purge -y --auto-remove wget; 	pip --version; 		find /opt/pypy -depth 		\( 			\( -type d -a \( -name test -o -name tests \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 17:56:19 GMT
CMD ["pypy3"]
```
...
-	Layers:
	...
	-	`sha256:b31d9f021c76d5215d759fbf06241c50be1e4dfc63039f36a59dae18a3323391`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:548e6dcefca8a121122becde7f5fca325ba87966cb39892e78f3a1ac09b6449d`  
		Last Modified: Tue, 20 Oct 2020 17:57:57 GMT  
		Size: 2.4 MB (2396413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
