...
### `pypy:3.11-7.3.21-trixie` - linux; amd64
...
### `pypy:3.11-7.3.21-trixie` - unknown; unknown
...
### `pypy:3.11-7.3.21-trixie` - linux; arm64 variant v8
...
### `pypy:3.11-7.3.21-trixie` - linux; 386
