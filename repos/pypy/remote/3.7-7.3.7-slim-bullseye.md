...
```console
$ docker pull pypy@sha256:21dc40b390b9d2c1e485b531d0c705633be7fe99fac0e4a8349663e67d6f5f09
```
...
### `pypy:3.7-7.3.7-slim-bullseye` - linux; amd64
...
### `pypy:3.7-7.3.7-slim-bullseye` - linux; arm64 variant v8
...
### `pypy:3.7-7.3.7-slim-bullseye` - linux; 386
