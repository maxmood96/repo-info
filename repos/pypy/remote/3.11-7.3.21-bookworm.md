...
### `pypy:3.11-7.3.21-bookworm` - linux; amd64
...
### `pypy:3.11-7.3.21-bookworm` - unknown; unknown
...
### `pypy:3.11-7.3.21-bookworm` - linux; arm64 variant v8
...
### `pypy:3.11-7.3.21-bookworm` - linux; 386
