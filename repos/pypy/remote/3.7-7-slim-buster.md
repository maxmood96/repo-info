...
```console
$ docker pull pypy@sha256:3247ca4bee38eb51a7a681b39db40ab99f09556bfd6542783621e6825845f64b
```
...
```console
$ docker pull pypy@sha256:0ea41b45832669a7eed35c9c475be6d4f60f79862c2d4da0c91e55cf226abc74
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **64.0 MB (64021021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1dfdbcd064eeb618274e22ca759a340c9e208516450e17501a0eb017514cf063`
-	Default Command: `["pypy3"]`
