...
```console
$ docker pull pypy@sha256:ee698ee810dbd4a37a11a07d723f8ea5c7eddaf7b6f148cb7f1f95917d204b69
```
...
```console
$ docker pull pypy@sha256:3e3f400bea14d7e837b4d879af3288301851e5dabfae22da08ba0df56987aa54
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349614267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bf1b1dde33656fc45d97cd7806c4dfe477bc4ab26384e4e8a3d2c1f6ca50041`
...
-	Layers:
	...
	-	`sha256:58cc00bc171eaf026543acc3e0afb6b92161516846a063d6052fabca7962146f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29655c8c31c2d9343691c35abd76f0d67f82e13c26de91c87299e88a9cdcc04a`  
		Last Modified: Tue, 20 Oct 2020 17:47:12 GMT  
...
```console
$ docker pull pypy@sha256:2628217e9c726cdd353a5433a325d725bae26dd054f89728dfbd27d954c08c8e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.1 MB (335119362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b53d936654f6659e34425909c7bc82655f16452faedb4653c7750e3a2e85a50b`
-	Default Command: `["pypy3"]`
...
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/8283828b8fd6f1783daf55a765384e6d8d2c5014/get-pip.py
# Tue, 20 Oct 2020 17:52:24 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 17:52:58 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		pypy3 get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /opt/pypy -depth 		\( 			\( -type d -a \( -name test -o -name tests \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 17:52:59 GMT
CMD ["pypy3"]
```
...
-	Layers:
	...
	-	`sha256:157e156530292bb031567304b73ce536b4ca4b62bcbfa6dfc831ef579d548216`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea06309d24b6bbaead6c7e42bad468a525dcb5433ab8c37e58fc90e74efe0fb7`  
		Last Modified: Tue, 20 Oct 2020 17:58:25 GMT  
...
```console
$ docker pull pypy@sha256:3bcfdd15c82479305223e4b6bc791cd4063392d45aff0718681661dc5592f2a0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.9 MB (356887298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99098cf9d67704e75a32f931f2fef7699258c7c61c2a7ca5aa9c12f5900368e5`
-	Default Command: `["pypy3"]`
...
-	Layers:
	...
	-	`sha256:776278022d2350f8e3c7f6aebd61d7023cf320b235d56a0210d1e5654bc0e284`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f2d3805dfa603c17b60410dcb8cb491401a00a49af92930c870013e2b82fdf`  
		Last Modified: Tue, 20 Oct 2020 18:04:10 GMT  
		Size: 2.3 MB (2272367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `pypy:3.7-7.3` - linux; s390x

```console
$ docker pull pypy@sha256:72cab8c10075c5d7411b37d2d9cc7daaa42f000c881109616568e9cb4fd10216
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.6 MB (329595676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be248eae82b7034f8c06f7b48ae87e57324a3c9a4b0b77125362bb5972313d7b`
-	Default Command: `["pypy3"]`
...
# Tue, 20 Oct 2020 17:56:26 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 17:56:35 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		pypy3 get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /opt/pypy -depth 		\( 			\( -type d -a \( -name test -o -name tests \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 17:56:36 GMT
CMD ["pypy3"]
```
...
-	Layers:
	...
	-	`sha256:b74915ff7ff0d0fbd659fc441bdb6cb455d992da60ed9d9b4d14f8a027bbabcd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f9fb6a593655319e6bff0b82bc662c8910aa81a78f5f03e5decd0719611421a`  
		Last Modified: Tue, 20 Oct 2020 17:58:25 GMT  
