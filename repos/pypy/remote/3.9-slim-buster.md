...
```console
$ docker pull pypy@sha256:faff0c549366197134c15aa9ffd6271a64c38656d7c7caace0b7c54c1476bb7c
```
...
```console
$ docker pull pypy@sha256:5e058aaedd4d87cc00cff048010e552659fb714dec503ac2088f6edaf4f5e1a7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.4 MB (72422144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86b4cdc15a4b80f954729049186872f1d7cf40224129013ac8f02bc682779162`
-	Default Command: `["pypy3"]`
