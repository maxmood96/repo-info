...
```console
$ docker pull pypy@sha256:bdf00df966e8298d50576cc02cca1746c528fead632dd5281e1a8627879fc650
```
...
### `pypy:3-7.3.4-buster` - linux; amd64
...
### `pypy:3-7.3.4-buster` - linux; arm64 variant v8
...
### `pypy:3-7.3.4-buster` - linux; s390x
