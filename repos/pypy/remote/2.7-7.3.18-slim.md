...
```console
$ docker pull pypy@sha256:db943535ac9fe99bc89e037d446b3df2968c7d12e764ca28e6fff538afe72c84
```
...
### `pypy:2.7-7.3.18-slim` - linux; amd64
...
### `pypy:2.7-7.3.18-slim` - unknown; unknown
...
### `pypy:2.7-7.3.18-slim` - linux; 386
