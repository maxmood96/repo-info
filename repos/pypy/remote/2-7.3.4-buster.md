...
```console
$ docker pull pypy@sha256:78764a1822e65c93c639758ed94468121d852cd852581c8a8c1e894fc88b5346
```
...
### `pypy:2-7.3.4-buster` - linux; amd64
...
### `pypy:2-7.3.4-buster` - linux; arm64 variant v8
