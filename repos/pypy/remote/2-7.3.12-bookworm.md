...
```console
$ docker pull pypy@sha256:9402b9b513be4ef7bbda33e8027e3fe872280aae9cc878a260abd5fc85224868
```
...
### `pypy:2-7.3.12-bookworm` - linux; amd64
...
### `pypy:2-7.3.12-bookworm` - linux; arm64 variant v8
...
### `pypy:2-7.3.12-bookworm` - linux; 386
