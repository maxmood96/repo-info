...
```console
$ docker pull lightstreamer@sha256:acc4938df3c404d152b19446c706109ccb3f49c8ee6c424848610a969a61ec1b
```
...
```console
$ docker pull lightstreamer@sha256:fcc90dc3b688635b8eff246dbe163d550a3d8c5a163ff491e68eaed6dca7bab4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.5 MB (242528970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c871c91de32b5fcf0fa600e57ff8f0a9e03e2d4529c21e184850916dd700484`
...
-	Layers:
	...
	-	`sha256:52f3c972a504f747415515092049c9748342476934976909755f9de6a832de39`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d878eeea1cb51df50f2380b4c145eb27c3e65046b4c05cbf916bb1a7089120e`  
		Last Modified: Wed, 05 Jun 2024 10:58:57 GMT  
		Size: 50.1 MB (50072526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:7.1.3` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:949272101ce0fb170b67fca90a6f601817f6f999ad2ede22e6d0ecbf66bbb681
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.2 MB (237211197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d0823f9977bcdb5ee35c5bdc101e746ddd9afb787b5c9a80fbc01387c1cd3de`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Wed, 05 Jun 2024 09:17:18 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.1.3/Lightstreamer_7_1_3.tar.gz
# Wed, 05 Jun 2024 09:17:20 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -- 's/\/usr\/jdk1.8.0/$JAVA_HOME/' bin/unix-like/LS.sh         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Wed, 05 Jun 2024 09:17:21 GMT
USER lightstreamer
# Wed, 05 Jun 2024 09:17:21 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 09:17:21 GMT
...
-	Layers:
	...
	-	`sha256:b2622fecfbb8875c798be2c538838e51cfb3fa2e909fd16c7e2b4688e7ede3cb`  
		...
		Size: 2.4 KB (2363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c2bfff798dd6e2fed6d7beabe53bbc21d8842a6cd4c2ee31ed69e63b4a7f61d`  
		Last Modified: Wed, 05 Jun 2024 09:20:36 GMT  
