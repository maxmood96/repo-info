...
```console
$ docker pull lightstreamer@sha256:0cd0c3eccd8adcdbb43ca92db888586dbcba375a873816edcbfbec88d604471b
```
...
```console
$ docker pull lightstreamer@sha256:18147606ab70bb755b482b26799651b0bf9071c35ef87404b5a1db3e9e4d4e04
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.1 MB (210060534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9758c1d0fa2df94436f49a51610212438fbcd197c7a5986427c19cb4cedd543`
...
-	Layers:
	...
	-	`sha256:5c7d1472ceff027cb366d891499457ff4f4049229a675da101306651b76ba507`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:298047597fe9cb8d3bd895df74e7b6fac8f57b8f3c95fe75ea13a9c1bfdee405`  
		Last Modified: Wed, 17 Jan 2024 15:22:20 GMT  
		Size: 59.5 MB (59507454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:7.4-jdk8` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:21f1869896bf93a41285e8f5f40acb6773bb33117041ac0af1fb4ed4fd1024bd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.0 MB (207036231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a2b1adb8173abde6a0af5a74b488fe8d39669304f618206f85865cf35d990b1`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Wed, 17 Jan 2024 10:10:00 GMT
ENV LIGHTSTREAMER_VERSION=7.4.1
# Wed, 17 Jan 2024 10:10:00 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.4.1/Lightstreamer-7.4.1.tar.gz
# Wed, 17 Jan 2024 10:10:07 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Wed, 17 Jan 2024 10:10:07 GMT
USER lightstreamer
# Wed, 17 Jan 2024 10:10:07 GMT
...
-	Layers:
	...
	-	`sha256:69d89bf9f7c44c453754df1367ce9f114e462b35226900f592f20fb1e70808e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77e8fb922bfa431e52ec8c386c5ae4bf2cab515852181abebae166ef4a1abe12`  
		Last Modified: Wed, 17 Jan 2024 10:21:54 GMT  
