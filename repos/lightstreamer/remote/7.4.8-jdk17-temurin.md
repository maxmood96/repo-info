...
### `lightstreamer:7.4.8-jdk17-temurin` - linux; amd64
...
### `lightstreamer:7.4.8-jdk17-temurin` - unknown; unknown
...
### `lightstreamer:7.4.8-jdk17-temurin` - linux; arm64 variant v8
