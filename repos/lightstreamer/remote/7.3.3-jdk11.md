...
```console
$ docker pull lightstreamer@sha256:473fb5065185a2221a1bff62a62d388c9d75dec4b29f0373a79f9f8c29167ab9
```
...
```console
$ docker pull lightstreamer@sha256:9f187d4be5b0d042ddb56275864530770c73abb56c33d3198c47db91366ac4ef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.3 MB (250302922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0469621a7a0d60c42b8c7b5b4d8888a8ad499f3b3326f07fa97bcfc5aecbc924`
...
-	Layers:
	...
	-	`sha256:6d05bdf7fe93db5633a5b6c5dbacd254f9e2e2b8b3236a7987bbb3dc1b2731e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef36450dab94a0970adf15fe90260bca4b5fd6acfbeb2fe0430fe84cc5995347`  
		Last Modified: Wed, 24 Apr 2024 22:24:19 GMT  
...
```console
$ docker pull lightstreamer@sha256:bad63b24d48a563fe4366ddff959c4a36197a5cdf95192e5428dea7e584ab3c5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.0 MB (244980463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36e4e42adb708b88f7c946045dfd5488ca5c753bbac675367433a002ea468217`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Wed, 24 Apr 2024 20:02:24 GMT
ENV LIGHTSTREAMER_VERSION=7.3.3
# Wed, 24 Apr 2024 20:02:24 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.3.3/Lightstreamer-7.3.3.tar.gz
# Wed, 24 Apr 2024 20:02:26 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Wed, 24 Apr 2024 20:02:27 GMT
USER lightstreamer
# Wed, 24 Apr 2024 20:02:27 GMT
EXPOSE 8080
# Wed, 24 Apr 2024 20:02:27 GMT
...
-	Layers:
	...
	-	`sha256:0191bcf8bc0836ca1046bb813a533c2223101c792f73aa12dca5aaec1b348790`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01d21330ed3ce114aaf72400e9af1a138feca43be90382825d501555faf74fbe`  
