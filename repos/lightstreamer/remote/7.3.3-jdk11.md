...
```console
$ docker pull lightstreamer@sha256:cfc8a141bfcc58962130f5982e7b89e179d7a95556ad6b9904486d437a71a0e6
```
...
```console
$ docker pull lightstreamer@sha256:87b3a1837fe3f4d43b419d3ac65f1e913f5b13ca21fdac96606cf148951565bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.1 MB (250092809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdf0f02263f6c1f263aab50c91e0ffa6a96ff1cb5fc784578dcf76ea764008f9`
...
-	Layers:
	...
	-	`sha256:912d0f923e72f97fa4e439990d1cbd520c677a4cc014acce1a88b158acb004af`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dfa17d323f79807d3bb177a08a6b2a8dbfb5f6242febd047f7909344d54253a`  
		Last Modified: Thu, 28 Mar 2024 05:10:07 GMT  
...
```console
$ docker pull lightstreamer@sha256:cedb644e01e3d46ad01535d2ca76d64e3f3bffbd183804abd76e5b17aff10a97
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.7 MB (244682725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93eb1337ab0afb01c139161bec5219a08a02e5c4eacf32c28cbad2c577744083`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Thu, 28 Mar 2024 02:16:56 GMT
ENV LIGHTSTREAMER_VERSION=7.3.3
# Thu, 28 Mar 2024 02:16:56 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.3.3/Lightstreamer-7.3.3.tar.gz
# Thu, 28 Mar 2024 02:16:59 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Thu, 28 Mar 2024 02:16:59 GMT
USER lightstreamer
# Thu, 28 Mar 2024 02:16:59 GMT
...
-	Layers:
	...
	-	`sha256:6b4255dd9a545da2e0e5a68a0b7b52c938577ba4659763bdef23f05e7d1838b4`  
		...
		Size: 2.4 KB (2400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2bfb0218cdd069dadcfa8daec02991f28d5562e7ef41777e30afa0250b214a3`  
		Last Modified: Thu, 28 Mar 2024 02:20:45 GMT  
