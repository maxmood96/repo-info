...
```console
$ docker pull lightstreamer@sha256:6cc9d6d385a12e7c21fab8a2e485dbd90222427592632fd3d9b3a7d049e5f134
```
...
```console
$ docker pull lightstreamer@sha256:2b5e508b1a9940229815c4273443a8721a19cc24362b96b02195c142ebc60bfc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.4 MB (200408501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccb33487e3a452718209b7505d789ec8740a0d80fffc3a9334c3d6cee0e43e45`
...
-	Layers:
	...
	-	`sha256:67d411853f1d939b305f83cc6fbaddd77a2b049710a7b47d9cee833a0861bc96`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:901f2abb2a18202f77f1db7663b6139bf753cc9c6482820922c945b979502466`  
		Last Modified: Fri, 02 Feb 2024 18:13:32 GMT  
...
```console
$ docker pull lightstreamer@sha256:1312c89db144f447f7d4975b30f4f6c621101f1562f35036f3f82630e2d1e0dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.4 MB (197380437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f40be7e81c4d3c0b594b9625716a9d0f32eee1db73126ae3da7be6e0ab01aa5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Fri, 02 Feb 2024 09:26:49 GMT
ENV LIGHTSTREAMER_VERSION=7.2.2
# Fri, 02 Feb 2024 09:26:49 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.2.2/Lightstreamer-7.2.2.tar.gz
# Fri, 02 Feb 2024 09:26:56 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Fri, 02 Feb 2024 09:26:56 GMT
USER lightstreamer
# Fri, 02 Feb 2024 09:26:56 GMT
...
-	Layers:
	...
	-	`sha256:e084f618697cac3fe48edf0fd60092fe257d8c4b0910ec0bfc4f947aa30054a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fdc82e446b0f1dc85f742e185ad7a8f411d9d003c0d6f37ce4c59b1608c07d2`  
		Last Modified: Fri, 02 Feb 2024 09:29:57 GMT  
