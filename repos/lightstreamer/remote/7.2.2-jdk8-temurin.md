...
```console
$ docker pull lightstreamer@sha256:01c1b54993418b2f441a568ae8cbe2b3647ba5caa7c7be3bc7506818fee4b3d2
```
...
```console
$ docker pull lightstreamer@sha256:3a511d97d3e90a961ad69246d69fa8dd013d275d845ea98a1c6efc9196ca539e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.4 MB (200407641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:970e9cf90f248b27f881a59bc591cdf40d0efe011ee52e7f71665e8dd48d2946`
...
-	Layers:
	...
	-	`sha256:bce5684c9f341c449169e0db540a8bdcdbd2bda6992f5893fb6c159a01c5ae6d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcf1668825e6326261a7c07d45dac17e5cfc987e61dac13c957200965cad63ca`  
		Last Modified: Thu, 25 Jan 2024 00:15:34 GMT  
...
```console
$ docker pull lightstreamer@sha256:08ba253d4cf3f33824ca45f510e19772ec6018068bac0f8f242250d18b7f7967
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.4 MB (197380226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04a4f4b8ef168b549188b2b9f7d6af026c2562c1dc061c2b6fdacb26e5c82c47`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Wed, 24 Jan 2024 23:53:32 GMT
ENV LIGHTSTREAMER_VERSION=7.2.2
# Wed, 24 Jan 2024 23:53:32 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.2.2/Lightstreamer-7.2.2.tar.gz
# Wed, 24 Jan 2024 23:53:39 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Wed, 24 Jan 2024 23:53:39 GMT
USER lightstreamer
# Wed, 24 Jan 2024 23:53:39 GMT
...
-	Layers:
	...
	-	`sha256:ccd094495dff7ec6a96cf7980cda9c14f1071079fe2033d40ccd26c49fe49d7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6ad9298a20d487edc859645cafc7111d80e0d6ba6eefdc6661441d08dbc3c40`  
		Last Modified: Wed, 24 Jan 2024 23:56:44 GMT  
