...
```console
$ docker pull lightstreamer@sha256:f1abe7a55bedc2715abca580212ea1c42d1c79258a20af8a983a851c7ae42c6f
```
...
```console
$ docker pull lightstreamer@sha256:0af4d541ba25a22e1553bcf80be6d7daf71ffff148351118024acce1a0fa42d9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188348587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1f2068df14d7997bd9df41cf308c9153cd09d154a6db8b198e41c7ae9c56dd0`
...
-	Layers:
	...
	-	`sha256:5c7d1472ceff027cb366d891499457ff4f4049229a675da101306651b76ba507`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b777b0b11bd5cafeb4080946863383e23e5771dca2b16d6d962ec9f0d9ea79e`  
		Last Modified: Wed, 17 Jan 2024 15:15:55 GMT  
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a7126180ed9000f4053665848b303d51061077502ef0cbe91b7d3081724fd9e`  
		Last Modified: Wed, 17 Jan 2024 15:15:59 GMT  
		Size: 37.8 MB (37795371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:6.0.3` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:e74a970fc5b928eb5ad94e012149d3da5b2947d37f536a9d9f41323d1089a882
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185324289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7427c92c003c898548b18d57300c66c54bde18ef48f8b6498cc4f09e58a065a8`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
# Wed, 17 Jan 2024 10:08:21 GMT
WORKDIR /lightstreamer
# Wed, 17 Jan 2024 10:08:28 GMT
RUN set -x         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc         && sed -i -- 's/\/usr\/jdk1.8.0/$JAVA_HOME/' bin/unix-like/LS.sh         && sed -i -e '123,$s/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<appender-ref ref="LSDailyRolling" \/>/ d' conf/lightstreamer_log_conf.xml
# Wed, 17 Jan 2024 10:08:29 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 10:08:29 GMT
WORKDIR /lightstreamer/bin/unix-like
# Wed, 17 Jan 2024 10:08:29 GMT
...
-	Layers:
	...
	-	`sha256:69d89bf9f7c44c453754df1367ce9f114e462b35226900f592f20fb1e70808e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bbfaf32c605553bec00e1cd15a2cd8d3e6d5b31c3434ca592c8a175b5a90eae`  
		Last Modified: Wed, 17 Jan 2024 10:15:42 GMT  
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a32ae96c8ab60004611b9bfcf568965f40c8b6c69d3c036c4c6bbe01d001901f`  
		Last Modified: Wed, 17 Jan 2024 10:15:45 GMT  
