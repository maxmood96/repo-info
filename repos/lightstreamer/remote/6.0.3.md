...
```console
$ docker pull lightstreamer@sha256:52b7bbf8cb8b498b0fa12986f8ed75ce313ddcacacf2eaf63aa8c0a6b9b173c4
```
...
```console
$ docker pull lightstreamer@sha256:0ec7694c945eae40311b8ad30b02b609290e5c4301535a3c91a38e6d7df2b57c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189391734 bytes)**  
...
-	Layers:
	...
	-	`sha256:60dc43b2ae5456834189eb8e50bb9e212108d281b02b42ff8681a66d6d00cf8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d141d637a3d314ed76b5dcfc6e51eb5550b2c6f268da143dcb6d80010510058f`  
		Last Modified: Thu, 25 Jul 2024 17:52:58 GMT  
		Size: 102.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:930627059242700e8a86a6e05a270800a2d037ccacfd0cbaacab7bff1c8a5651`  
		Last Modified: Thu, 25 Jul 2024 17:53:02 GMT  
...
```console
$ docker pull lightstreamer@sha256:35cd63ecc1576c13aff94fa6674a1f5253e72ef8cbebd0e53ac151916958064a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.9 MB (187873524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fabd3cef34a4b1c726de9e0cd968c9b5d7d929fd562d095c1061274bce8dab31`
-	Entrypoint: `["\/bin\/bash","\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
# Thu, 25 Jul 2024 18:05:27 GMT
WORKDIR /lightstreamer
# Thu, 25 Jul 2024 18:05:30 GMT
RUN set -x         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc         && sed -i -- 's/\/usr\/jdk1.8.0/$JAVA_HOME/' bin/unix-like/LS.sh         && sed -i -e '123,$s/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<appender-ref ref="LSDailyRolling" \/>/ d' conf/lightstreamer_log_conf.xml
# Thu, 25 Jul 2024 18:05:30 GMT
EXPOSE 8080
# Thu, 25 Jul 2024 18:05:30 GMT
WORKDIR /lightstreamer/bin/unix-like
# Thu, 25 Jul 2024 18:05:31 GMT
CMD ["./LS.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:554a93851595508d22de46c1ca2531c243c2be7f2b2960e6bcad40de5dae55e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e678570e5f3961b7fd53b56355f07bde8e3b21a8b1b52a7ae6157a0c0aa76a1`  
		Last Modified: Thu, 25 Jul 2024 18:07:29 GMT  
		Size: 102.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1efbccf7d7670169e40ef2ff1b7cc240e6c83fe115e2eee719d0b397d373a4e9`  
		Last Modified: Thu, 25 Jul 2024 18:07:32 GMT  
		Size: 37.8 MB (37795080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
