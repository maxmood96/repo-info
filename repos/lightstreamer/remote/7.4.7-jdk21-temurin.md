...
### `lightstreamer:7.4.7-jdk21-temurin` - linux; amd64
...
### `lightstreamer:7.4.7-jdk21-temurin` - unknown; unknown
...
### `lightstreamer:7.4.7-jdk21-temurin` - linux; arm64 variant v8
