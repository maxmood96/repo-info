...
```console
$ docker pull lightstreamer@sha256:48a757a5cca3ac5a146d718b9ee172cca9c30a672fcb25e08ebbe6a7f49b5ac4
```
...
```console
$ docker pull lightstreamer@sha256:0ba5dcab17b3a2c2752ae18f9031152057178b154fc128f3e51aa30bd7d9d4bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.6 MB (200631808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1858a9d75dca15bed0efab44f48b14b4148256235e7a165afc99010a73d72194`
...
-	Layers:
	...
	-	`sha256:d2e99e1eba47ab1646863f8b3b2828639f573e36536e12cc39da52a4ce233abb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80f7fd4f9092b24b899b7bf0d020b93d6ef1ad4e2956790afee56a55573d158c`  
		Last Modified: Thu, 28 Mar 2024 05:08:38 GMT  
...
```console
$ docker pull lightstreamer@sha256:eb851371fcfbe0b2a26c9b0679691b6efb90075de45208edce79c442779bda75
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197599590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5d65f552d08049b65df1d011b83315f121774e7543e8ae94952ea0a9fd020ed`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Thu, 28 Mar 2024 02:16:17 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.1.3/Lightstreamer_7_1_3.tar.gz
# Thu, 28 Mar 2024 02:16:24 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -- 's/\/usr\/jdk1.8.0/$JAVA_HOME/' bin/unix-like/LS.sh         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Thu, 28 Mar 2024 02:16:24 GMT
USER lightstreamer
# Thu, 28 Mar 2024 02:16:24 GMT
...
-	Layers:
	...
	-	`sha256:6ca7b751d64a5703881ebbb559e0290d88baf6d0c0864df0f2e91dedbff08917`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ef5294b03ed65d839ac7074a2ff9067f6404e070865bd541cecd9da20997239`  
		Last Modified: Thu, 28 Mar 2024 02:19:20 GMT  
