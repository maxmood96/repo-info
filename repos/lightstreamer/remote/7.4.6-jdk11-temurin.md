...
### `lightstreamer:7.4.6-jdk11-temurin` - linux; amd64
...
### `lightstreamer:7.4.6-jdk11-temurin` - unknown; unknown
...
### `lightstreamer:7.4.6-jdk11-temurin` - linux; arm64 variant v8
