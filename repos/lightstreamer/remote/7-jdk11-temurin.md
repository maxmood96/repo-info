...
```console
$ docker pull lightstreamer@sha256:4437a2cbf4695c846210415e443469737cbcbe49350952ee6fd5742769c5639b
```
...
```console
$ docker pull lightstreamer@sha256:f2507c3e0302c9848ee54f64fec6f5304b0ada983f77e9f2d782ac753ccad39c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.5 MB (253482220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4635e51ddad8b910def9521836fc38f98b496646511a03ba58aec645f609e1c3`
...
-	Layers:
	...
	-	`sha256:d3220d056800ed1f3ed4829d56b434c552b050003ffc14305869ce3a8cb79000`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b82966a05295f7944da153e32d4876d984168a6086fd3f6eed32c985be91fb61`  
		Last Modified: Sat, 17 Aug 2024 02:18:50 GMT  
...
```console
$ docker pull lightstreamer@sha256:fd281c408f39e87d83eb691c626c79248a7160ea45545e3a2bb332a3d36a92e7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.6 MB (249648532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d8b1c94592c1a19b56776b2a529b98d012c496c773a50220863b3a609fd6c4f`
-	Entrypoint: `["\/bin\/bash","\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Sat, 17 Aug 2024 01:58:27 GMT
ENV LIGHTSTREAMER_VERSION=7.4.4
# Sat, 17 Aug 2024 01:58:27 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.4.4/Lightstreamer-7.4.4.tar.gz
# Sat, 17 Aug 2024 01:58:30 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Sat, 17 Aug 2024 01:58:30 GMT
USER lightstreamer
# Sat, 17 Aug 2024 01:58:30 GMT
...
-	Layers:
	...
	-	`sha256:315d37cd88d8587a1da1ff4ea30ae78a7c2e8a2036164e288378840e108ab34d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8bbce311e22a4c194e241dcc9858ce349e69d2b77c142fc4354f6a9d6327c88`  
		Last Modified: Sat, 17 Aug 2024 02:02:24 GMT  
		Size: 59.9 MB (59938536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
