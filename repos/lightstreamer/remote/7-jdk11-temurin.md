...
```console
$ docker pull lightstreamer@sha256:4f83e7715b0c3d0acc40395c531396b9870d5262f1cc7578ba7d9761d6190cc6
```
...
```console
$ docker pull lightstreamer@sha256:0b41220cf48be08694d5362d9a4f4bc89012a73a8e7cd0cb0726eb5a08d05d35
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.8 MB (302758654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11537cbbd24552c1d5d7dd73d99aeac241e14ec6e84133b1f4d2bb229670a335`
...
-	Layers:
	...
	-	`sha256:8bd197c4c00919006ba509882d3befbd447c4bd3484c0c767b70554e5c66d749`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b8da4ec291794e1691fe0889e6c0d7e488bad1f900baaad93daae72b27bed7b`  
		Last Modified: Sat, 05 Nov 2022 00:58:22 GMT  
		Size: 57.8 MB (57830048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:7-jdk11-temurin` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:4b13ca423610cf64475e8e3b1d693de35bb73af628258776951a12165e6d0a06
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.4 MB (297395113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05a1831e2a6cac1326a8d3edee5834cac2298c09b37ed700d929f98343d5780b`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Sat, 05 Nov 2022 00:24:58 GMT
ENV LIGHTSTREAMER_VERSION=7.3.0
# Sat, 05 Nov 2022 00:24:58 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.3.0/Lightstreamer-7.3.0.tar.gz
# Sat, 05 Nov 2022 00:25:01 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Sat, 05 Nov 2022 00:25:01 GMT
USER lightstreamer
# Sat, 05 Nov 2022 00:25:01 GMT
...
-	Layers:
	...
	-	`sha256:8806fd5d5714d3f2c864bf73205b88584f1713e27ee48823ce4a56961ea9c108`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9cce28bd55d3ff2f5990a1e962ecc9a3cc1368d818ea0d360cedc00fae2a64f`  
		Last Modified: Sat, 05 Nov 2022 00:28:50 GMT  
		Size: 57.8 MB (57830039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
