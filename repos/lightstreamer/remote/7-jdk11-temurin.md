...
```console
$ docker pull lightstreamer@sha256:9f2a5bc05a39d6564dae9852ab7416b51f1f715e26495895241abc84c1fa4b88
```
...
```console
$ docker pull lightstreamer@sha256:500b6b6f71867858731590bb09f24807c41b9c0fd136b72749e9255bcf0195a3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.3 MB (252279925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53b237463c192a3a68582661159b72e5cea90d7c29dc2acf003ac7ec96f96583`
...
-	Layers:
	...
	-	`sha256:275ac68c6f442c857e404563c10a7fe3d4ed8a7b9cdc7b6d648ae7101ee8bba8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c89d31e4519f60a7cc6f184584ff185daf585d208142f8baaafd7e6ff56f8a93`  
		Last Modified: Fri, 26 Apr 2024 03:23:47 GMT  
		Size: 59.8 MB (59822418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:7-jdk11-temurin` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:b40fc369e36d020c535901211b623e47242da4d89eba8a5eb4cd4827eb0c0faf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.0 MB (246959460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a41cbfc9d88a250f6375bd06502365bd38ac289d99f2e6183d626c2f602227b8`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Fri, 26 Apr 2024 02:39:30 GMT
ENV LIGHTSTREAMER_VERSION=7.4.2
# Fri, 26 Apr 2024 02:39:30 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/7.4.2/Lightstreamer-7.4.2.tar.gz
# Fri, 26 Apr 2024 02:39:32 GMT
RUN set -ex;         mkdir /lightstreamer && cd /lightstreamer         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && sed -i -e 's/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<logger name="LightstreamerLogger.init/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerLogger.license/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   -e '/<logger name="LightstreamerProxyAdapters/,+2s/<appender-ref ref="LSConsole" \/>/<!-- <appender-ref ref="LSConsole" \/> -->/'                   conf/lightstreamer_log_conf.xml         && groupadd -r -g 10000 lightstreamer         && useradd --no-log-init -r -g lightstreamer -u 10000 lightstreamer         && chown -R lightstreamer:lightstreamer ../lightstreamer         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc
# Fri, 26 Apr 2024 02:39:33 GMT
USER lightstreamer
# Fri, 26 Apr 2024 02:39:33 GMT
EXPOSE 8080
# Fri, 26 Apr 2024 02:39:33 GMT
...
-	Layers:
	...
	-	`sha256:8e226c218dceb66f6c0b51fc986007778e657f898800f6d17169d8dfe279c3a6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b9f6d63307d515c55d16dc7df1762117c41e7d787fbed7733c74cd51ec37e7a`  
		Last Modified: Fri, 26 Apr 2024 02:43:50 GMT  
		Size: 59.8 MB (59822379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
