...
```console
$ docker pull lightstreamer@sha256:a9b18000706444b30a5e07037e2e054138ed1b6203c8aba0e6ed8c1fec93c499
```
...
```console
$ docker pull lightstreamer@sha256:1a5a9909d54a15cfc10f8b55358306bf6236163340419a590f0e5a6ac3eaa338
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187032235 bytes)**  
...
-	Layers:
	...
	-	`sha256:9c094c03fecbad04768c391689c6f770921541725ed2e2286cfd1d6c7cad8114`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e65c0821c2e04df3b87d016f4441ad1c392930d091ee0bec5f473a5bd957bf3`  
		Last Modified: Tue, 02 Jul 2024 08:57:24 GMT  
		Size: 102.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4db321ec2dd0f2b36499ab4e7ab5403c71a33781ac0f95ef36f0eff565f3d9a5`  
		Last Modified: Tue, 02 Jul 2024 08:57:28 GMT  
		Size: 36.5 MB (36516579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `lightstreamer:6.1` - linux; arm64 variant v8

```console
$ docker pull lightstreamer@sha256:c5b29f32b370cfad183d815e0c471c2a8e446bc9308bf104bab157ec16372f5a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.0 MB (184009578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec4edce0f4eb98d9805a10fb622f19ac11e3d62d6734df05f8d9908bf798aa7d`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `[".\/LS.sh","run"]`
...
RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com --recv-keys 9B90BFD14309C7DA5EF58D7D4A8C08966F29B4D2
# Tue, 02 Jul 2024 08:30:13 GMT
ENV LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distr/ls-server/6.1.0/Lightstreamer_Allegro-Presto-Vivace_6_1_0_20170123.tar.gz
# Tue, 02 Jul 2024 08:30:13 GMT
WORKDIR /lightstreamer
# Tue, 02 Jul 2024 08:30:19 GMT
RUN set -x         && curl -fSL -o Lightstreamer.tar.gz ${LIGHTSTREAMER_URL_DOWNLOAD}         && curl -fSL -o Lightstreamer.tar.gz.asc ${LIGHTSTREAMER_URL_DOWNLOAD}.asc         && gpg --batch --verify Lightstreamer.tar.gz.asc Lightstreamer.tar.gz         && tar -xvf Lightstreamer.tar.gz --strip-components=1         && rm Lightstreamer.tar.gz Lightstreamer.tar.gz.asc         && sed -i -- 's/\/usr\/jdk1.8.0/$JAVA_HOME/' bin/unix-like/LS.sh         && sed -i -e '123,$s/<appender-ref ref="LSDailyRolling" \/>/<appender-ref ref="LSConsole" \/>/'                   -e '/<appender-ref ref="LSDailyRolling" \/>/ d' conf/lightstreamer_log_conf.xml
# Tue, 02 Jul 2024 08:30:20 GMT
EXPOSE 8080
# Tue, 02 Jul 2024 08:30:20 GMT
WORKDIR /lightstreamer/bin/unix-like
# Tue, 02 Jul 2024 08:30:20 GMT
...
-	Layers:
	...
	-	`sha256:f5c78a236b9dde508f105bcada24f4e7308a1ba2731e17b905d7740b02c79db7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c771c54897d5126d2ee13d7ac8aa76bd4bc09f5370273e11006010970069cbf`  
		Last Modified: Tue, 02 Jul 2024 08:32:47 GMT  
		Size: 102.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f89a73e3aa76fcc3c370723bdb3b25e180525ae7c556bdbf73a5d81a54026ae5`  
		Last Modified: Tue, 02 Jul 2024 08:32:50 GMT  
		Size: 36.5 MB (36516566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
