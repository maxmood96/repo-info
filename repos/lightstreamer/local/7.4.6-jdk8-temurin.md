...
- Created: `2025-02-20T11:07:31Z`
- Virtual Size: ~ 342.38 Mb  
...
- Environment:
  ...
  - `LIGHTSTREAMER_VERSION=7.4.6`
  - `LIGHTSTREAMER_URL_DOWNLOAD=https://lightstreamer.com/distros/ls-server/7.4.6/Lightstreamer-7.4.6.tar.gz`
- Labels:
