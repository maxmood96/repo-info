...
```console
$ docker pull phpmyadmin@sha256:42c2849bdd93aa98a287bcf5f20ed5e38bc12d0b0e623bf0c9d4ef89ee59ec61
```
...
```console
$ docker pull phpmyadmin@sha256:faa294666475cd9b312ddb3f9ccebe4820d2661d91cb5f64eb84cd6c372dc6f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175794875 bytes)**  
...
-	Layers:
	...
	-	`sha256:8e96e70d882a74061f70e62b4a1e94868d9b314471dabaee7556cc9887601514`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8381204b9203d92958e3ac5d25a83f33f1dc0fc84f2e7261e65b58c3517db77e`  
		Last Modified: Fri, 05 Aug 2022 01:03:24 GMT  
		Size: 771.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:6aea4880bd205ef5b815edee6bc3eb87f7d7c9f3780d49b8b2d51232f78c73b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153433114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59cbdb598e06967468d00e06057c42a0075fb8ef946831a2813e0c02c5bcd47b`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:60a4f3fbc2dd92bd8cee5252d9e5489439d6d585c02b0233bbf6d6eb7a57a75c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea822b795bc9a5df49172d220d5f5506f36c5c88856a6fdbce2bcc6152487bf1`  
		Last Modified: Fri, 05 Aug 2022 00:58:29 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:7af32a30f0a220e9d7bf99574a806fc87556a92f7ddedef20819aa075419c795
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.8 MB (145758053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75da1701f078b5c9c315babe40bb32ad50e08e83874694755c5beb298dcd172d`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Aug 2022 20:10:35 GMT
CMD ["php-fpm"]
# Thu, 04 Aug 2022 12:50:17 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libbz2-dev         libfreetype6-dev         libjpeg-dev         libpng-dev         libwebp-dev         libxpm-dev         libzip-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp --with-xpm;     docker-php-ext-install -j "$(nproc)"         bz2         gd         mysqli         opcache         zip     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 04 Aug 2022 12:50:18 GMT
ENV MAX_EXECUTION_TIME=600
# Thu, 04 Aug 2022 12:50:18 GMT
ENV MEMORY_LIMIT=512M
# Thu, 04 Aug 2022 12:50:18 GMT
...
-	Layers:
	...
	-	`sha256:9e332ba61786eacf97ef59d4ad055ac7179efd0d2ff5a777b0a58e0e297c849c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5275b49e223f9662dab2e15cf8747c4d7e68457b199c384b25f0f64367ae89fe`  
		Last Modified: Thu, 04 Aug 2022 12:53:17 GMT  
		Size: 2.6 MB (2558378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:677f1f139ecc1f5ab48bbda91410902be71f67146f2a0b6f69178dafa3902f85`  
		Last Modified: Thu, 04 Aug 2022 12:53:16 GMT  
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96da3026f7b7349f3347bb6e18b61dc8ee9630fb563a9520f631033f56c9d1ab`  
		Last Modified: Thu, 04 Aug 2022 12:53:20 GMT  
		Size: 12.4 MB (12442100 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:112c084c9a6a74d3b94f6c0db3e6c770ada0cb598cc9c9b11839a3028e70add0`  
		Last Modified: Thu, 04 Aug 2022 12:53:17 GMT  
		Size: 1.5 KB (1528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:716742c249ba8b0cb6e187ac3156ff8f37b43babf81a7d37c38379a123ddc471`  
		Last Modified: Thu, 04 Aug 2022 12:53:17 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:b56cce45a88aa215773289d3e9fbc8846076a5277efcf2116bad30ade37d6d1a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.6 MB (177597631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fcf750e48701357ecb1cb4e2b72ef9f2a05acc81a9d185540557b9d7cb4eed0`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY file:74e988fef607090521e63cea57b4c61ab22b3a2a131bc55f0cf4a0d9c36ce65d in /etc/phpmyadmin/config.inc.php 
# Fri, 05 Aug 2022 02:04:18 GMT
COPY file:7a1864d35a5b72dc75fa085c7d09497f417e1ef1eacb8597037c366f1978b5fa in /docker-entrypoint.sh 
# Fri, 05 Aug 2022 02:04:18 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Fri, 05 Aug 2022 02:04:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c43c2714dd5feace6fb0872ed9b8d71dba5e63b4a741bcd2dcb9b2cb3040f633`  
		...
		Size: 1.5 KB (1500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68e1c89202744f1bfee4e53f180041dd7563519d821b9872195fcf4ba2a552d2`  
		Last Modified: Fri, 05 Aug 2022 02:07:14 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:2c8282cdfad7726875295992f28317bbd8672225525d2555bac113d3b751dd95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.4 MB (152378143 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6f74ada66d34b3b91b04213793e55fb6ad1c686d1e54f8424987313eee149fd`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY file:74e988fef607090521e63cea57b4c61ab22b3a2a131bc55f0cf4a0d9c36ce65d in /etc/phpmyadmin/config.inc.php 
# Fri, 05 Aug 2022 03:17:20 GMT
COPY file:7a1864d35a5b72dc75fa085c7d09497f417e1ef1eacb8597037c366f1978b5fa in /docker-entrypoint.sh 
# Fri, 05 Aug 2022 03:17:24 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Fri, 05 Aug 2022 03:17:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:671af7a6c91e0bdb0b24f15dd2c71e25200975ac0cbd25ffd73bf76c755a6523`  
		...
		Size: 1.5 KB (1500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:053c58e4e03045086e9f42b12fcd0c84864918100fe79a0839f4ebd0701462a6`  
		Last Modified: Fri, 05 Aug 2022 03:18:40 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
