...
```console
$ docker pull phpmyadmin@sha256:73726acbf8c609c9140825753c5b9845f29fcf3823c46986ba8bc1dd0a9044ff
```
...
```console
$ docker pull phpmyadmin@sha256:d07fded940f95bbceb6bd58edccb7e53811cdd3d3bead9922ed73d724312f045
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48724793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:758800c611e1b9e460abc5049b86de3b59d12323792219a0d4dbe85c3b00b376`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 20 Nov 2021 02:17:18 GMT
RUN apk add --no-cache     bash     tzdata
# Sat, 20 Nov 2021 02:17:57 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         bzip2-dev         freetype-dev         libjpeg-turbo-dev         libpng-dev         libwebp-dev         libxpm-dev         libzip-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp --with-xpm;     docker-php-ext-install -j "$(nproc)"         bz2         gd         mysqli         opcache         zip     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .phpmyadmin-phpexts-rundeps $runDeps;     apk del --no-network .build-deps
# Sat, 20 Nov 2021 02:17:58 GMT
ENV MAX_EXECUTION_TIME=600
# Sat, 20 Nov 2021 02:17:59 GMT
ENV MEMORY_LIMIT=512M
# Sat, 20 Nov 2021 02:18:00 GMT
ENV UPLOAD_LIMIT=2048K
# Sat, 20 Nov 2021 02:18:01 GMT
RUN set -ex;         {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=2';         echo 'opcache.fast_shutdown=1';     } > $PHP_INI_DIR/conf.d/opcache-recommended.ini;         {         echo 'session.cookie_httponly=1';         echo 'session.use_strict_mode=1';     } > $PHP_INI_DIR/conf.d/session-strict.ini;         {         echo 'allow_url_fopen=Off';         echo 'max_execution_time=${MAX_EXECUTION_TIME}';         echo 'max_input_vars=10000';         echo 'memory_limit=${MEMORY_LIMIT}';         echo 'post_max_size=${UPLOAD_LIMIT}';         echo 'upload_max_filesize=${UPLOAD_LIMIT}';     } > $PHP_INI_DIR/conf.d/phpmyadmin-misc.ini
# Sat, 20 Nov 2021 02:18:02 GMT
ENV VERSION=5.1.1
# Sat, 20 Nov 2021 02:18:03 GMT
ENV SHA256=1964d7190223c11e89fa1b7970c618e3a3bae2e859f5f60383f64c3848ef6921
# Sat, 20 Nov 2021 02:18:04 GMT
ENV URL=https://files.phpmyadmin.net/phpMyAdmin/5.1.1/phpMyAdmin-5.1.1-all-languages.tar.xz
# Sat, 20 Nov 2021 02:18:05 GMT
LABEL org.opencontainers.image.title=Official phpMyAdmin Docker image org.opencontainers.image.description=Run phpMyAdmin with Alpine, Apache and PHP FPM. org.opencontainers.image.authors=The phpMyAdmin Team <developers@phpmyadmin.net> org.opencontainers.image.vendor=phpMyAdmin org.opencontainers.image.documentation=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.licenses=GPL-2.0-only org.opencontainers.image.version=5.1.1 org.opencontainers.image.url=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.source=https://github.com/phpmyadmin/docker.git
# Sat, 20 Nov 2021 02:18:10 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         gnupg     ;         export GNUPGHOME="$(mktemp -d)";     export GPGKEY="3D06A59ECE730EB71B511C17CE752F178259BD92";     curl -fsSL -o phpMyAdmin.tar.xz $URL;     curl -fsSL -o phpMyAdmin.tar.xz.asc $URL.asc;     echo "$SHA256 *phpMyAdmin.tar.xz" | sha256sum -c -;     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver ipv4.pool.sks-keyservers.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver keys.gnupg.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver pgp.mit.edu --recv-keys "$GPGKEY"         || gpg --batch --keyserver keyserver.pgp.com --recv-keys "$GPGKEY";     gpg --batch --verify phpMyAdmin.tar.xz.asc phpMyAdmin.tar.xz;     tar -xf phpMyAdmin.tar.xz -C /var/www/html --strip-components=1;     mkdir -p /var/www/html/tmp;     chown www-data:www-data /var/www/html/tmp;     gpgconf --kill all;     rm -r "$GNUPGHOME" phpMyAdmin.tar.xz phpMyAdmin.tar.xz.asc;     rm -rf /var/www/html/setup/ /var/www/html/examples/ /var/www/html/test/ /var/www/html/po/ /var/www/html/composer.json /var/www/html/RELEASE-DATE-$VERSION;     sed -i "s@define('CONFIG_DIR'.*@define('CONFIG_DIR', '/etc/phpmyadmin/');@" /var/www/html/libraries/vendor_config.php;     apk del --no-network .fetch-deps
# Sat, 20 Nov 2021 02:18:11 GMT
COPY file:74e988fef607090521e63cea57b4c61ab22b3a2a131bc55f0cf4a0d9c36ce65d in /etc/phpmyadmin/config.inc.php 
# Sat, 20 Nov 2021 02:18:12 GMT
COPY file:7a1864d35a5b72dc75fa085c7d09497f417e1ef1eacb8597037c366f1978b5fa in /docker-entrypoint.sh 
# Sat, 20 Nov 2021 02:18:12 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Sat, 20 Nov 2021 02:18:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bee09c074e685d06c59d3db8fc9c241d78fc68e320fea7ab92c8638d4d44b59f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f95361c13a5212b14eadac1ddb2c1650033688b44b54bd9ff1ec4f47364ee262`  
		Last Modified: Sat, 20 Nov 2021 02:19:54 GMT  
		Size: 871.4 KB (871362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54d37aa3c576e9e7adab2bc32bdcde8351e4ac20307ddc1ccc8b1bc07bb486a3`  
		Last Modified: Sat, 20 Nov 2021 02:19:52 GMT  
		Size: 5.3 MB (5251037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac90183be735f0d1d64c5343bef9532006b55c5a7ac12d818c4fb89baf43f533`  
		Last Modified: Sat, 20 Nov 2021 02:19:51 GMT  
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0c42e1160ed8eb40d1107327b0f289ed1777799188b381e6a45809adf7ac1ae`  
		Last Modified: Sat, 20 Nov 2021 02:19:55 GMT  
		Size: 13.6 MB (13556649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18907b7567f71bb94761801f0e31ed49b36a99c6c51d075a51158389c1f09f04`  
		Last Modified: Sat, 20 Nov 2021 02:19:52 GMT  
		Size: 1.5 KB (1500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a37e0536f6136e2fa9617d460fe0a7574ed0f6375810319d82baf41263370b3`  
		Last Modified: Sat, 20 Nov 2021 02:19:51 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:451ad3ff1fd83babdd5eadd9c2b204666fba879c23eb78bfe035585877f4aed7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49736423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:295d878c78de23d88362deaf8881f2d79b77730b1b4490fcc9093cf1d66a133d`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Nov 2021 16:53:56 GMT
CMD ["php-fpm"]
# Sat, 20 Nov 2021 03:30:57 GMT
RUN apk add --no-cache     bash     tzdata
# Sat, 20 Nov 2021 03:31:41 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         bzip2-dev         freetype-dev         libjpeg-turbo-dev         libpng-dev         libwebp-dev         libxpm-dev         libzip-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp --with-xpm;     docker-php-ext-install -j "$(nproc)"         bz2         gd         mysqli         opcache         zip     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .phpmyadmin-phpexts-rundeps $runDeps;     apk del --no-network .build-deps
# Sat, 20 Nov 2021 03:31:41 GMT
ENV MAX_EXECUTION_TIME=600
# Sat, 20 Nov 2021 03:31:42 GMT
ENV MEMORY_LIMIT=512M
# Sat, 20 Nov 2021 03:31:42 GMT
ENV UPLOAD_LIMIT=2048K
# Sat, 20 Nov 2021 03:31:43 GMT
RUN set -ex;         {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=2';         echo 'opcache.fast_shutdown=1';     } > $PHP_INI_DIR/conf.d/opcache-recommended.ini;         {         echo 'session.cookie_httponly=1';         echo 'session.use_strict_mode=1';     } > $PHP_INI_DIR/conf.d/session-strict.ini;         {         echo 'allow_url_fopen=Off';         echo 'max_execution_time=${MAX_EXECUTION_TIME}';         echo 'max_input_vars=10000';         echo 'memory_limit=${MEMORY_LIMIT}';         echo 'post_max_size=${UPLOAD_LIMIT}';         echo 'upload_max_filesize=${UPLOAD_LIMIT}';     } > $PHP_INI_DIR/conf.d/phpmyadmin-misc.ini
# Sat, 20 Nov 2021 03:31:43 GMT
ENV VERSION=5.1.1
# Sat, 20 Nov 2021 03:31:43 GMT
...
# Sat, 20 Nov 2021 03:31:43 GMT
ENV URL=https://files.phpmyadmin.net/phpMyAdmin/5.1.1/phpMyAdmin-5.1.1-all-languages.tar.xz
# Sat, 20 Nov 2021 03:31:44 GMT
LABEL org.opencontainers.image.title=Official phpMyAdmin Docker image org.opencontainers.image.description=Run phpMyAdmin with Alpine, Apache and PHP FPM. org.opencontainers.image.authors=The phpMyAdmin Team <developers@phpmyadmin.net> org.opencontainers.image.vendor=phpMyAdmin org.opencontainers.image.documentation=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.licenses=GPL-2.0-only org.opencontainers.image.version=5.1.1 org.opencontainers.image.url=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.source=https://github.com/phpmyadmin/docker.git
# Sat, 20 Nov 2021 03:31:56 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         gnupg     ;         export GNUPGHOME="$(mktemp -d)";     export GPGKEY="3D06A59ECE730EB71B511C17CE752F178259BD92";     curl -fsSL -o phpMyAdmin.tar.xz $URL;     curl -fsSL -o phpMyAdmin.tar.xz.asc $URL.asc;     echo "$SHA256 *phpMyAdmin.tar.xz" | sha256sum -c -;     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver ipv4.pool.sks-keyservers.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver keys.gnupg.net --recv-keys "$GPGKEY"         || gpg --batch --keyserver pgp.mit.edu --recv-keys "$GPGKEY"         || gpg --batch --keyserver keyserver.pgp.com --recv-keys "$GPGKEY";     gpg --batch --verify phpMyAdmin.tar.xz.asc phpMyAdmin.tar.xz;     tar -xf phpMyAdmin.tar.xz -C /var/www/html --strip-components=1;     mkdir -p /var/www/html/tmp;     chown www-data:www-data /var/www/html/tmp;     gpgconf --kill all;     rm -r "$GNUPGHOME" phpMyAdmin.tar.xz phpMyAdmin.tar.xz.asc;     rm -rf /var/www/html/setup/ /var/www/html/examples/ /var/www/html/test/ /var/www/html/po/ /var/www/html/composer.json /var/www/html/RELEASE-DATE-$VERSION;     sed -i "s@define('CONFIG_DIR'.*@define('CONFIG_DIR', '/etc/phpmyadmin/');@" /var/www/html/libraries/vendor_config.php;     apk del --no-network .fetch-deps
# Sat, 20 Nov 2021 03:31:56 GMT
COPY file:74e988fef607090521e63cea57b4c61ab22b3a2a131bc55f0cf4a0d9c36ce65d in /etc/phpmyadmin/config.inc.php 
# Sat, 20 Nov 2021 03:31:56 GMT
COPY file:7a1864d35a5b72dc75fa085c7d09497f417e1ef1eacb8597037c366f1978b5fa in /docker-entrypoint.sh 
# Sat, 20 Nov 2021 03:31:57 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Sat, 20 Nov 2021 03:31:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f6f545379a5e98d3ea29f36cd127d7f7e95d2f119e73b1f51eb227c6a98185fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3404279f1e7e08b5b64aa16fed7fd84e22819b5fd57b81c6db06c7c6f1464606`  
		Last Modified: Sat, 20 Nov 2021 03:33:50 GMT  
		Size: 905.2 KB (905228 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7225cd9529371128f447069c8b7c5ff739e663760b6ad917146fafce95be570`  
		Last Modified: Sat, 20 Nov 2021 03:33:47 GMT  
		Size: 5.4 MB (5416565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20fa1c4a6dac21c9958f7221d4680237e5c4babbc6ddd629b317e87a4db90a94`  
		Last Modified: Sat, 20 Nov 2021 03:33:46 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfbab61302270d901e0491170642781cdb66b0abe6e2847564ecd89a2e325bf3`  
		Last Modified: Sat, 20 Nov 2021 03:33:50 GMT  
		Size: 13.6 MB (13557371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69434559ffa2aba74e40d116fe8b0221198351b2ddd60bdf5c39b9ba1d96f844`  
		Last Modified: Sat, 20 Nov 2021 03:33:46 GMT  
		Size: 1.5 KB (1529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8a784c9f85e11d84191feae3953c76ba4c87da16aaf0f2c73e5c3dd8c3005d3`  
		Last Modified: Sat, 20 Nov 2021 03:33:46 GMT  
		Size: 772.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
