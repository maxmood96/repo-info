...
```console
$ docker pull phpmyadmin@sha256:aa84975d0ae59c8c17172e044bc80a948cbedecc74aec499ae5b41553cd31870
```
...
```console
$ docker pull phpmyadmin@sha256:22075e1097496587db1e406d1cc6eb6c6097046b5fa0be2e611eaae807449acd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.6 MB (49551291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c644abbb3e9d074981b9182b1b7fa495013eb6957b0e32c452fa4f787565143a`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 01:16:23 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 03:33:43 GMT
RUN apk add --no-cache     bash     tzdata
# Tue, 23 Jul 2024 03:35:13 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         bzip2-dev         freetype-dev         libjpeg-turbo-dev         libpng-dev         libwebp-dev         libxpm-dev         libzip-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp --with-xpm;     docker-php-ext-install -j "$(nproc)"         bz2         gd         mysqli         opcache         zip         bcmath     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .phpmyadmin-phpexts-rundeps $runDeps;     apk del --no-network .build-deps
# Tue, 23 Jul 2024 03:35:13 GMT
ENV MAX_EXECUTION_TIME=600
# Tue, 23 Jul 2024 03:35:13 GMT
...
# Tue, 23 Jul 2024 03:35:14 GMT
LABEL org.opencontainers.image.title=Official phpMyAdmin Docker image org.opencontainers.image.description=Run phpMyAdmin with Alpine, Apache and PHP FPM. org.opencontainers.image.authors=The phpMyAdmin Team <developers@phpmyadmin.net> org.opencontainers.image.vendor=phpMyAdmin org.opencontainers.image.documentation=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.licenses=GPL-2.0-only org.opencontainers.image.version=5.2.1 org.opencontainers.image.url=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.source=https://github.com/phpmyadmin/docker.git
# Tue, 23 Jul 2024 03:35:18 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         gnupg     ;     mkdir $SESSION_SAVE_PATH;     chmod 1777 $SESSION_SAVE_PATH;     chown www-data:www-data $SESSION_SAVE_PATH;         export GNUPGHOME="$(mktemp -d)";     export GPGKEY="3D06A59ECE730EB71B511C17CE752F178259BD92";     curl -fsSL -o phpMyAdmin.tar.xz $URL;     curl -fsSL -o phpMyAdmin.tar.xz.asc $URL.asc;     echo "$SHA256 *phpMyAdmin.tar.xz" | sha256sum -c -;     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$GPGKEY"         || gpg --batch --keyserver pgp.mit.edu --recv-keys "$GPGKEY"         || gpg --batch --keyserver keyserver.pgp.com --recv-keys "$GPGKEY"         || gpg --batch --keyserver keys.openpgp.org --recv-keys "$GPGKEY";     gpg --batch --verify phpMyAdmin.tar.xz.asc phpMyAdmin.tar.xz;     tar -xf phpMyAdmin.tar.xz -C /var/www/html --strip-components=1;     mkdir -p /var/www/html/tmp;     chown www-data:www-data /var/www/html/tmp;     gpgconf --kill all;     rm -r "$GNUPGHOME" phpMyAdmin.tar.xz phpMyAdmin.tar.xz.asc;     rm -r -v /var/www/html/setup/ /var/www/html/examples/ /var/www/html/js/src/ /var/www/html/babel.config.json /var/www/html/doc/html/_sources/ /var/www/html/RELEASE-DATE-$VERSION /var/www/html/CONTRIBUTING.md;     grep -q -F "'configFile' => ROOT_PATH . 'config.inc.php'," /var/www/html/libraries/vendor_config.php;     sed -i "s@'configFile' => .*@'configFile' => '/etc/phpmyadmin/config.inc.php',@" /var/www/html/libraries/vendor_config.php;     grep -q -F "'configFile' => '/etc/phpmyadmin/config.inc.php'," /var/www/html/libraries/vendor_config.php;     php -l /var/www/html/libraries/vendor_config.php;     apk del --no-network .fetch-deps
# Tue, 23 Jul 2024 03:35:19 GMT
COPY file:f697d9b67ffcb023f485f153138036d27b209f81ffe35ce3b93a825c617138cd in /etc/phpmyadmin/config.inc.php 
# Tue, 23 Jul 2024 03:35:19 GMT
COPY file:d8c9f50886f5865fe589f64cb31544582913bb98f2cfa51a8828d71871363ce9 in /docker-entrypoint.sh 
# Tue, 23 Jul 2024 03:35:19 GMT
...
-	Layers:
	...
	-	`sha256:5876176c021392562624347f1d643b754e6bba176140d66e6dc6086582b878bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95e522b7ffeb23bdfbb4d7f483d951f966d3e0ba77a3955c6d97f3eedc1c86b5`  
		Last Modified: Tue, 23 Jul 2024 03:35:49 GMT  
		Size: 715.1 KB (715108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d250031a984ecb9ffae22587f05b815f4254801e6679017c84e776a003100f0`  
		Last Modified: Tue, 23 Jul 2024 03:35:47 GMT  
		Size: 3.6 MB (3612955 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a85a4c4ce75642f79fab39df0759e0f28d79bd5c743d36b1323a1442ad2cba52`  
		Last Modified: Tue, 23 Jul 2024 03:35:47 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e1d7d961381b2f6069fccbd50d9c60dbf470e17439f7cb4816878d3f17f3205`  
		Last Modified: Tue, 23 Jul 2024 03:35:49 GMT  
		Size: 12.7 MB (12717681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d289d7a835d0f682e752fa78c238db95cdb464f15a96fafc58e1d92b075e5bef`  
		Last Modified: Tue, 23 Jul 2024 03:35:46 GMT  
		Size: 1.6 KB (1588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70fcd6c172f30177f73d496ad21f5af3bfa2e00779d0bf2bfb2f7793e96f51ae`  
		Last Modified: Tue, 23 Jul 2024 03:35:46 GMT  
		Size: 783.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull phpmyadmin@sha256:fbad40f883ec0c3db0348571c4681dcc26d3a0243c50bbef1bc4ba5c3f74cc10
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48906397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b4be5b37fc18354c380a5ac7efe9229528824e4b5814d1ced87012d6ac0496e`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 01:03:19 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 03:34:29 GMT
RUN apk add --no-cache     bash     tzdata
# Tue, 23 Jul 2024 03:35:40 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         bzip2-dev         freetype-dev         libjpeg-turbo-dev         libpng-dev         libwebp-dev         libxpm-dev         libzip-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp --with-xpm;     docker-php-ext-install -j "$(nproc)"         bz2         gd         mysqli         opcache         zip         bcmath     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .phpmyadmin-phpexts-rundeps $runDeps;     apk del --no-network .build-deps
# Tue, 23 Jul 2024 03:35:40 GMT
ENV MAX_EXECUTION_TIME=600
# Tue, 23 Jul 2024 03:35:41 GMT
ENV MEMORY_LIMIT=512M
# Tue, 23 Jul 2024 03:35:41 GMT
ENV UPLOAD_LIMIT=2048K
# Tue, 23 Jul 2024 03:35:41 GMT
...
# Tue, 23 Jul 2024 03:35:42 GMT
LABEL org.opencontainers.image.title=Official phpMyAdmin Docker image org.opencontainers.image.description=Run phpMyAdmin with Alpine, Apache and PHP FPM. org.opencontainers.image.authors=The phpMyAdmin Team <developers@phpmyadmin.net> org.opencontainers.image.vendor=phpMyAdmin org.opencontainers.image.documentation=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.licenses=GPL-2.0-only org.opencontainers.image.version=5.2.1 org.opencontainers.image.url=https://github.com/phpmyadmin/docker#readme org.opencontainers.image.source=https://github.com/phpmyadmin/docker.git
# Tue, 23 Jul 2024 03:35:47 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         gnupg     ;     mkdir $SESSION_SAVE_PATH;     chmod 1777 $SESSION_SAVE_PATH;     chown www-data:www-data $SESSION_SAVE_PATH;         export GNUPGHOME="$(mktemp -d)";     export GPGKEY="3D06A59ECE730EB71B511C17CE752F178259BD92";     curl -fsSL -o phpMyAdmin.tar.xz $URL;     curl -fsSL -o phpMyAdmin.tar.xz.asc $URL.asc;     echo "$SHA256 *phpMyAdmin.tar.xz" | sha256sum -c -;     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$GPGKEY"         || gpg --batch --keyserver pgp.mit.edu --recv-keys "$GPGKEY"         || gpg --batch --keyserver keyserver.pgp.com --recv-keys "$GPGKEY"         || gpg --batch --keyserver keys.openpgp.org --recv-keys "$GPGKEY";     gpg --batch --verify phpMyAdmin.tar.xz.asc phpMyAdmin.tar.xz;     tar -xf phpMyAdmin.tar.xz -C /var/www/html --strip-components=1;     mkdir -p /var/www/html/tmp;     chown www-data:www-data /var/www/html/tmp;     gpgconf --kill all;     rm -r "$GNUPGHOME" phpMyAdmin.tar.xz phpMyAdmin.tar.xz.asc;     rm -r -v /var/www/html/setup/ /var/www/html/examples/ /var/www/html/js/src/ /var/www/html/babel.config.json /var/www/html/doc/html/_sources/ /var/www/html/RELEASE-DATE-$VERSION /var/www/html/CONTRIBUTING.md;     grep -q -F "'configFile' => ROOT_PATH . 'config.inc.php'," /var/www/html/libraries/vendor_config.php;     sed -i "s@'configFile' => .*@'configFile' => '/etc/phpmyadmin/config.inc.php',@" /var/www/html/libraries/vendor_config.php;     grep -q -F "'configFile' => '/etc/phpmyadmin/config.inc.php'," /var/www/html/libraries/vendor_config.php;     php -l /var/www/html/libraries/vendor_config.php;     apk del --no-network .fetch-deps
# Tue, 23 Jul 2024 03:35:48 GMT
COPY file:f697d9b67ffcb023f485f153138036d27b209f81ffe35ce3b93a825c617138cd in /etc/phpmyadmin/config.inc.php 
# Tue, 23 Jul 2024 03:35:48 GMT
COPY file:d8c9f50886f5865fe589f64cb31544582913bb98f2cfa51a8828d71871363ce9 in /docker-entrypoint.sh 
# Tue, 23 Jul 2024 03:35:48 GMT
...
-	Layers:
	...
	-	`sha256:b8f78bc73f2db98c5f356a48ae9ec2ac50578808e252494c754ea6454912cc7d`  
		...
		Size: 9.2 KB (9177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bfcd4be1f0bc56ba91060a5b2080b3f0917fcba3bec37151bbb6bdbf3df9fd4`  
		Last Modified: Tue, 23 Jul 2024 03:36:07 GMT  
		Size: 660.2 KB (660153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53901bcc9c57ca7d8ae4402106b540ca7e51dfa32fb4b0d21474a827dd3eb597`  
		Last Modified: Tue, 23 Jul 2024 03:36:05 GMT  
		Size: 3.4 MB (3358323 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2bdfcd6da11df976d6bc6af006428bd064ee123d2ba1ad8b30eee7df32db210`  
		Last Modified: Tue, 23 Jul 2024 03:36:04 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acdea44006d11fbf50266f4f465b101bc7bca8bef69edcdade15e1688dca871c`  
		Last Modified: Tue, 23 Jul 2024 03:36:08 GMT  
		Size: 12.7 MB (12717233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bc99633e895818f274b330b551dfac773cf03028b7cb614d19243855ef5fc1b`  
		Last Modified: Tue, 23 Jul 2024 03:36:04 GMT  
		Size: 1.6 KB (1586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac3ea83701343558354bf1ac143cda24f309aebf2409ddd9e9281f11508afd4e`  
		Last Modified: Tue, 23 Jul 2024 03:36:04 GMT  
		Size: 782.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
