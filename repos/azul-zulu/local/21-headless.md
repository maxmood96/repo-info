...
- Created: `2026-05-08T19:38:45.275161127Z`
...
### `dpkg` source package: `java-common=0.76`
...
```console
$ apt-get source -qq --print-uris java-common=0.76
'http://deb.debian.org/debian/pool/main/j/java-common/java-common_0.76.dsc' java-common_0.76.dsc 1990 SHA256:f5760144187b30940c9090934d4f0616e9e80a0cf1fa1ebdd3636d984c194a25
'http://deb.debian.org/debian/pool/main/j/java-common/java-common_0.76.tar.xz' java-common_0.76.tar.xz 13520 SHA256:36dc1a734f86793d8f5f26c48fd8eedee18131475c447cc8e4474cf87df39589
```

Other potentially useful URLs:

- https://sources.debian.net/src/java-common/0.76/ (for browsing the source)
- https://sources.debian.net/src/java-common/0.76/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/java-common/0.76/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/zulu21-ca-jdk-headless/copyright`, `/usr/share/doc/zulu21-ca-jre-headless/copyright`)
...
Licenses: (parsed from: `/usr/share/doc/zulu21-jdk-headless/copyright`, `/usr/share/doc/zulu21-jre-headless/copyright`)
