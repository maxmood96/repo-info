...
- Created: `2026-06-02T19:07:41.574509188Z`
- Virtual Size: ~ 383.39 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["/bin/bash"]`
- Environment:
  - `PATH=/usr/lib/jvm/zulu11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `LANG=C.UTF-8`
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/bash-5.2.26-6.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/bzip2-1.0.8-25.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/ca-certificates-2025.2.80_v9.0.305-102.el10_1.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/cyrus-sasl-2.1.28-29.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/dbus-1.14.10-5.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/dbus-broker-36-4.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/filesystem-3.18-17.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/findutils-4.10.0-5.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/gawk-5.3.0-6.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/gmp-6.2.1-12.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/gnutls-3.8.10-3.el10_1.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/grep-3.11-10.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/json-c-0.18-3.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/acl-2.3.2-4.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libarchive-3.7.7-8.el10_1.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libcap-ng-0.8.4-6.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libeconf-0.6.2-4.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libedit-3.1-52.20230828cvs.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/AppStream/Source/Packages/libestr-0.1.11-11.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libevent-2.1.12-16.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libffi-3.4.4-10.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libidn2-2.3.7-3.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libpsl-0.21.5-6.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libunistring-1.1-10.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libverto-0.3.2-10.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/libyaml-0.2.5-16.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/zstd-1.5.5-9.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/lua-5.4.6-7.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/lz4-1.9.4-8.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/python-dateutil-2.9.0.post0-1.el10_0.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/python-six-1.16.0-16.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/python-systemd-235-11.el10.src.rpm
```
...
http://vault.almalinux.org/10.2/BaseOS/Source/Packages/zlib-ng-2.2.3-3.el10_1.src.rpm
```
