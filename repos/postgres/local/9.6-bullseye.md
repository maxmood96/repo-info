...
- Created: `2021-11-17T21:59:51.313589502Z`
- Virtual Size: ~ 239.17 Mb  
...
### `dpkg` source package: `libjson-perl=4.03000-1`
...
```console
$ apt-get source -qq --print-uris libjson-perl=4.03000-1
'http://deb.debian.org/debian/pool/main/libj/libjson-perl/libjson-perl_4.03000-1.dsc' libjson-perl_4.03000-1.dsc 2375 SHA256:c29ce9e15160b6b2d679b287945cce9c4b5fe57bd0f2b7fa7db5bb43443e722f
'http://deb.debian.org/debian/pool/main/libj/libjson-perl/libjson-perl_4.03000.orig.tar.gz' libjson-perl_4.03000.orig.tar.gz 91373 SHA256:e41f8761a5e7b9b27af26fe5780d44550d7a6a66bf3078e337d676d07a699941
'http://deb.debian.org/debian/pool/main/libj/libjson-perl/libjson-perl_4.03000-1.debian.tar.xz' libjson-perl_4.03000-1.debian.tar.xz 5164 SHA256:545ae100de35fa36600588bec1f150bf1409bcdf9a64d49db1937600927be075
```

Other potentially useful URLs:

- https://sources.debian.net/src/libjson-perl/4.03000-1/ (for browsing the source)
- https://sources.debian.net/src/libjson-perl/4.03000-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libjson-perl/4.03000-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `nss-wrapper=1.1.11-1`

Binary Packages:

- `libnss-wrapper:amd64=1.1.11-1`
...
```console
$ apt-get source -qq --print-uris nss-wrapper=1.1.11-1
'http://deb.debian.org/debian/pool/main/n/nss-wrapper/nss-wrapper_1.1.11-1.dsc' nss-wrapper_1.1.11-1.dsc 2176 SHA256:55b69519d86636a74788ba1ef50800a860099db5299e792812593ab682c7e562
'http://deb.debian.org/debian/pool/main/n/nss-wrapper/nss-wrapper_1.1.11.orig.tar.gz' nss-wrapper_1.1.11.orig.tar.gz 93431 SHA256:fb45332e7fb4d85d3ea829ed18172366196c17cbd32ef690a7e1309f0c37b4e0
'http://deb.debian.org/debian/pool/main/n/nss-wrapper/nss-wrapper_1.1.11-1.debian.tar.gz' nss-wrapper_1.1.11-1.debian.tar.gz 5273 SHA256:e9340cee3e7b0740a18d2222afc2e103808ff0656c89bfe55cae52ba18f5baca
```

Other potentially useful URLs:

- https://sources.debian.net/src/nss-wrapper/1.1.11-1/ (for browsing the source)
- https://sources.debian.net/src/nss-wrapper/1.1.11-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nss-wrapper/1.1.11-1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris postgresql-14=14.1-1.pgdg110+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-14/postgresql-14_14.1-1.pgdg110+1.dsc' postgresql-14_14.1-1.pgdg110+1.dsc 2841 SHA256:1cfb39e20e146f3d12d884eb075d3099c77c8e07a8ae11c1128b151ae06f3886
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-14/postgresql-14_14.1.orig.tar.bz2' postgresql-14_14.1.orig.tar.bz2 21887101 SHA256:4d3c101ea7ae38982f06bdc73758b53727fb6402ecd9382006fa5ecc7c2ca41f
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-14/postgresql-14_14.1-1.pgdg110+1.debian.tar.xz' postgresql-14_14.1-1.pgdg110+1.debian.tar.xz 25956 SHA256:686417d1e16fd9e3cfcd9880b3011e2f2af3ce4aa99d82e08183466667ed9599
```

### `dpkg` source package: `postgresql-9.6=9.6.24-1.pgdg110+1`

Binary Packages:

- `postgresql-9.6=9.6.24-1.pgdg110+1`
- `postgresql-client-9.6=9.6.24-1.pgdg110+1`
...
```console
$ apt-get source -qq --print-uris postgresql-9.6=9.6.24-1.pgdg110+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.6/postgresql-9.6_9.6.24-1.pgdg110+1.dsc' postgresql-9.6_9.6.24-1.pgdg110+1.dsc 2746 SHA256:e4a72c1096acd0fc87458b3b9cd050a071601db1b03cf14550280f76b6d5b059
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.6/postgresql-9.6_9.6.24.orig.tar.bz2' postgresql-9.6_9.6.24.orig.tar.bz2 19047518 SHA256:aeb7a196be3ebed1a7476ef565f39722187c108dd47da7489be9c4fcae982ace
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.6/postgresql-9.6_9.6.24-1.pgdg110+1.debian.tar.xz' postgresql-9.6_9.6.24-1.pgdg110+1.debian.tar.xz 34332 SHA256:c9668984172ecb8fa9c5910e18bb1d740646cdd0f643189ebeca9dde70ee9187
```
...
- `postgresql-common=232.pgdg110+1`
...
```console
$ apt-get source -qq --print-uris postgresql-common=232.pgdg110+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_232.pgdg110+1.dsc' postgresql-common_232.pgdg110+1.dsc 1537 SHA256:05681477b432220dad8f6910cb2754989a87598e8d7575637e9778c49808823d
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_232.pgdg110+1.tar.xz' postgresql-common_232.pgdg110+1.tar.xz 199240 SHA256:4009a44ab199792e9906ce4bf7adf2f9d22c66fbfe0525a9381a0d78d8c3bdeb
```
...
### `dpkg` source package: `ssl-cert=1.1.0+nmu1`
...
```console
$ apt-get source -qq --print-uris ssl-cert=1.1.0+nmu1
'http://deb.debian.org/debian/pool/main/s/ssl-cert/ssl-cert_1.1.0+nmu1.dsc' ssl-cert_1.1.0+nmu1.dsc 1519 SHA256:e843db99ede88892768d1b340757724d47a525924afba76ceb772b6d87a66b51
'http://deb.debian.org/debian/pool/main/s/ssl-cert/ssl-cert_1.1.0+nmu1.tar.xz' ssl-cert_1.1.0+nmu1.tar.xz 31304 SHA256:b1e17d659d8fcc8d838ec5503500fc9e58a3109af70d8a5b2ec707a9dbdb5154
```

Other potentially useful URLs:

- https://sources.debian.net/src/ssl-cert/1.1.0+nmu1/ (for browsing the source)
- https://sources.debian.net/src/ssl-cert/1.1.0+nmu1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ssl-cert/1.1.0+nmu1/ (for access to the source package after it no longer exists in the archive)
