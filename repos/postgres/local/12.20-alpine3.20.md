...
- Environment:
  ...
  - `PG_MAJOR=12`
  - `PG_VERSION=12.20`
  - `PG_SHA256=2d543af3009fec7fd5af35f7a70c95085d3eef6b508e517aa9493e99b15e9ea9`
...
```console
zstd-1.5.6-r0 description:
Zstandard - Fast real-time compression algorithm

zstd-1.5.6-r0 webpage:
https://www.zstd.net/

zstd-1.5.6-r0 installed size:
288 KiB

zstd-1.5.6-r0 license:
