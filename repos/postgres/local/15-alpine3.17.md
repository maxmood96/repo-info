...
```console
icu-data-full-72.1-r1 description:
Full ICU data

icu-data-full-72.1-r1 webpage:
https://icu.unicode.org/

icu-data-full-72.1-r1 installed size:
29 MiB

icu-data-full-72.1-r1 license:
MIT ICU Unicode-TOU
...
```console
zstd-1.5.5-r0 description:
Zstandard - Fast real-time compression algorithm

zstd-1.5.5-r0 webpage:
https://www.zstd.net/

zstd-1.5.5-r0 installed size:
1256 KiB

zstd-1.5.5-r0 license:
