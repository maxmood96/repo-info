...
### `postgres:13.15-alpine3.18` - linux; amd64
...
### `postgres:13.15-alpine3.18` - linux; arm variant v7
...
### `postgres:13.15-alpine3.18` - linux; arm64 variant v8
...
### `postgres:13.15-alpine3.18` - linux; ppc64le
...
### `postgres:13.15-alpine3.18` - linux; s390x
