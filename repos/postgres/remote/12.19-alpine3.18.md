...
```console
$ docker pull postgres@sha256:7ac84dc862a81ab677daf7544610cf998ab9d1c5881ea78ed8fcf01089dc00de
```
...
### `postgres:12.19-alpine3.18` - linux; amd64
...
### `postgres:12.19-alpine3.18` - linux; arm64 variant v8
...
### `postgres:12.19-alpine3.18` - linux; ppc64le
...
### `postgres:12.19-alpine3.18` - linux; s390x
