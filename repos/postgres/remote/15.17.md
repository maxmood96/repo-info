...
```console
$ docker pull postgres@sha256:c635fa3e3b7421a659d34abdfd6d492f679cbe8149e261a501237b55c5a94212
```
...
### `postgres:15.17` - unknown; unknown
...
### `postgres:15.17` - linux; arm variant v5
...
### `postgres:15.17` - linux; arm variant v7
...
### `postgres:15.17` - linux; arm64 variant v8
...
### `postgres:15.17` - linux; ppc64le

```console
$ docker pull postgres@sha256:c6f93c774fe42e5f72a45879bc5ff984d785d8bde2399aa2116980ea51dbec20
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170281106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e373913b088efb11702a618037909ebe63f903c8c768ef38d25071cea5dbcd19`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
-	Layers:
	...
	-	`sha256:673613a255bf2076327dc4ae485f87213acd2fde047c19f914d2e74f8aff961d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6022f02f017bfd8cd3a1323a2ea2f6118b5e27b78f26c02521ad525be03d8bae`  
		Last Modified: Tue, 17 Mar 2026 01:34:51 GMT  
		Size: 118.8 MB (118777437 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a0413166a188656bea233f566980b3a821b095c7a1979db2765b146006bd2ee1`  
		Last Modified: Tue, 17 Mar 2026 01:34:48 GMT  
		Size: 9.9 KB (9878 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:397f30bcb7a15cf051a241e49912ca638f63a911bd72c43ebdbf55035c70b7b1`  
		Last Modified: Tue, 17 Mar 2026 01:34:48 GMT  
		Size: 127.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:dea1ab8c0efa153e211991655311d056a88484056e7c9eb5766d1b73315bc754`  
		Last Modified: Tue, 17 Mar 2026 01:34:48 GMT  
		Size: 168.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:03910efc08ca7fc39abc0520f7cb793679333fe6b871cbfe68d5464c1559d293`  
		Last Modified: Tue, 17 Mar 2026 01:34:49 GMT  
		Size: 5.8 KB (5838 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cc6cfcabc172ca507413a3b752fefb16bb16a060686e069d34e468fbb2fe522a`  
		Last Modified: Tue, 17 Mar 2026 01:34:49 GMT  
		Size: 186.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull postgres@sha256:4586f288c1cc4fa609c27eb938f3335be2d9653f376b794aab9531886beda6d5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.7 MB (5703097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:719116b6d2b6f5df49b0390d6f63965c2dea10142d57fb72c5381f3291960cea`

```dockerfile
```

-	Layers:
	-	`sha256:9b5144c065709d0ffd472798ef7bfebdea0c5753c63e40e63c6208723435934b`  
		Last Modified: Tue, 17 Mar 2026 01:34:48 GMT  
		Size: 5.6 MB (5649167 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b8aad6244ed5eefa6e4c05993c9fd84c8c2e2a4007ccee7b3db4a754ee3bee2c`  
		Last Modified: Tue, 17 Mar 2026 01:34:48 GMT  
		Size: 53.9 KB (53930 bytes)  
		MIME: application/vnd.in-toto+json

### `postgres:15.17` - linux; riscv64

```console
$ docker pull postgres@sha256:f3117d51eb7927151d307e4fcee18569140d585341e02b2f12b60a908d3880d7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.0 MB (89996242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40c68541c4adb6731235b96fabfee2acb965733aef2e29b65560084aca39c72b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
# Tue, 17 Mar 2026 17:56:19 GMT
ENV PG_VERSION=15.17-1.pgdg13+1
# Wed, 18 Mar 2026 02:14:59 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	aptRepo="[ signed-by=/usr/local/share/keyrings/postgres.gpg.asc ] http://apt.postgresql.org/pub/repos/apt trixie-pgdg main $PG_MAJOR"; 	case "$dpkgArch" in 		amd64 | arm64 | ppc64el) 			echo "deb $aptRepo" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src $aptRepo" > /etc/apt/sources.list.d/pgdg.list; 						savedAptMark="$(apt-mark showmanual)"; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						apt-get update; 			apt-get install -y --no-install-recommends dpkg-dev; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			_update_repo() { 				dpkg-scanpackages . > Packages; 				apt-get -o Acquire::GzipIndexes=false update; 			}; 			_update_repo; 						nproc="$(nproc)"; 			export DEB_BUILD_OPTIONS="nocheck parallel=$nproc"; 			apt-get build-dep -y postgresql-common-dev; 			apt-get source --compile postgresql-common-dev; 			_update_repo; 			apt-get build-dep -y "postgresql-$PG_MAJOR=$PG_VERSION"; 			apt-get source --compile "postgresql-$PG_MAJOR=$PG_VERSION"; 									apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			_update_repo; 			grep '^Package: ' Packages; 			cd /; 			;; 	esac; 		apt-get install -y --no-install-recommends postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y --no-install-recommends 		"postgresql-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +; 		postgres --version # buildkit
# Wed, 18 Mar 2026 02:14:59 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample # buildkit
# Wed, 18 Mar 2026 02:15:00 GMT
RUN install --verbose --directory --owner postgres --group postgres --mode 3777 /var/run/postgresql # buildkit
# Wed, 18 Mar 2026 02:15:00 GMT
ENV PGDATA=/var/lib/postgresql/data
# Wed, 18 Mar 2026 02:15:00 GMT
...
-	Layers:
	...
	-	`sha256:c7334e3a25422febd2c6fd13ca95b213e8189220da903bda179d2fefb3dd2bbf`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:320d7fa40abaa05d0f0dbcd3ba89e9a26a34836f526107ceff575308af98d664`  
		Last Modified: Wed, 18 Mar 2026 02:17:28 GMT  
		Size: 44.6 MB (44598634 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:30d05bd7109e78f79734759b4b0d92f8a964c5cbd87237c2e5afc505e68b3996`  
		Last Modified: Wed, 18 Mar 2026 02:17:21 GMT  
		Size: 9.9 KB (9887 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:509d00c1bff209eabe6d743b3b9265b6dd5c367096a6baaeeead16e5c7853556`  
		Last Modified: Wed, 18 Mar 2026 02:17:21 GMT  
		Size: 128.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6e89b0772d1641df3cfb9e8064961fc62682c9c9700dc5c1652cbb6fa65d0422`  
		Last Modified: Wed, 18 Mar 2026 02:17:21 GMT  
		Size: 167.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:30b1008081c3a6c0e0647eacf7afaafe12123843b1295c439e2bfcccabef3751`  
		Last Modified: Wed, 18 Mar 2026 02:17:23 GMT  
		Size: 5.8 KB (5841 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:777ca7680e75199577447a0a512f434796ae5da14cb4667c07e53d1a32a0ffcb`  
		Last Modified: Wed, 18 Mar 2026 02:17:23 GMT  
		Size: 184.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull postgres@sha256:2cffec3e3c158ab1bd34a3b791a0791b1e81b746f0fe6ce4a53558c27035ef73
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.1 MB (5074524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6db180371f2ea94279391a03261f571e474702739fa08f7b85f20d74524c7820`

```dockerfile
```

-	Layers:
	-	`sha256:f3aa806b8776c4f3c7f402c1e8b7a93ce7147627bb11bbe28531a49802564ede`  
		Last Modified: Wed, 18 Mar 2026 02:17:22 GMT  
		Size: 5.0 MB (5020600 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4b88c96fe47fa4568cd350f456bf4547a1b72c973706e06194c6546de6ec308d`  
		Last Modified: Wed, 18 Mar 2026 02:17:21 GMT  
		Size: 53.9 KB (53924 bytes)  
		MIME: application/vnd.in-toto+json

### `postgres:15.17` - linux; s390x
