...
```console
$ docker pull postgres@sha256:32e2dbbd222962cce3b5a95c25ce96e5027d8b075ede586a856c355767e203ce
```
...
### `postgres:16.2-alpine3.18` - linux; amd64
...
### `postgres:16.2-alpine3.18` - unknown; unknown
...
### `postgres:16.2-alpine3.18` - linux; arm variant v6
...
### `postgres:16.2-alpine3.18` - linux; arm variant v7
...
### `postgres:16.2-alpine3.18` - linux; arm64 variant v8
...
### `postgres:16.2-alpine3.18` - linux; 386
...
### `postgres:16.2-alpine3.18` - linux; ppc64le
