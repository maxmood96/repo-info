...
### `postgres:18.0-alpine` - linux; amd64
...
### `postgres:18.0-alpine` - unknown; unknown
...
### `postgres:18.0-alpine` - linux; arm variant v6
...
### `postgres:18.0-alpine` - linux; arm variant v7
...
### `postgres:18.0-alpine` - linux; arm64 variant v8
...
### `postgres:18.0-alpine` - linux; 386
...
### `postgres:18.0-alpine` - linux; ppc64le
...
### `postgres:18.0-alpine` - linux; riscv64
...
### `postgres:18.0-alpine` - linux; s390x
