...
```console
$ docker pull postgres@sha256:4f87fce212ca9d435cb3ee66c030fdda06648ed839e3e73a67b708e64508dd04
```
...
### `postgres:12.11-alpine3.15` - linux; arm variant v6
...
### `postgres:12.11-alpine3.15` - linux; 386
...
### `postgres:12.11-alpine3.15` - linux; ppc64le
...
### `postgres:12.11-alpine3.15` - linux; s390x
