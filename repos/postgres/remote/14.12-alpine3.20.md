...
```console
$ docker pull postgres@sha256:e53c3038b0a368f705f09fe263c3199dd6e2b12c201699d93dd593a70eb880fb
```
...
### `postgres:14.12-alpine3.20` - linux; amd64
...
### `postgres:14.12-alpine3.20` - unknown; unknown
...
### `postgres:14.12-alpine3.20` - linux; arm variant v6
...
### `postgres:14.12-alpine3.20` - linux; arm variant v7
...
### `postgres:14.12-alpine3.20` - linux; 386
...
### `postgres:14.12-alpine3.20` - linux; ppc64le
...
### `postgres:14.12-alpine3.20` - linux; riscv64
...
### `postgres:14.12-alpine3.20` - linux; s390x
