...
### `postgres:13.17-alpine3.20` - linux; amd64
...
### `postgres:13.17-alpine3.20` - unknown; unknown
...
### `postgres:13.17-alpine3.20` - linux; arm variant v6
...
### `postgres:13.17-alpine3.20` - linux; arm variant v7
...
### `postgres:13.17-alpine3.20` - linux; arm64 variant v8
...
### `postgres:13.17-alpine3.20` - linux; 386
...
### `postgres:13.17-alpine3.20` - linux; ppc64le
...
### `postgres:13.17-alpine3.20` - linux; riscv64
...
### `postgres:13.17-alpine3.20` - linux; s390x
