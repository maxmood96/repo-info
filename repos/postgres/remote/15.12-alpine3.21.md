...
### `postgres:15.12-alpine3.21` - linux; amd64
...
### `postgres:15.12-alpine3.21` - unknown; unknown
...
### `postgres:15.12-alpine3.21` - linux; arm variant v6
...
### `postgres:15.12-alpine3.21` - linux; arm variant v7
...
### `postgres:15.12-alpine3.21` - linux; arm64 variant v8
...
### `postgres:15.12-alpine3.21` - linux; 386
...
### `postgres:15.12-alpine3.21` - linux; ppc64le
...
### `postgres:15.12-alpine3.21` - linux; riscv64
...
### `postgres:15.12-alpine3.21` - linux; s390x
