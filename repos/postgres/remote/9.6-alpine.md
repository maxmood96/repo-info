...
```console
$ docker pull postgres@sha256:94c172a238678d01ce53722b2323985132b4d4c9b55f99edc896822bf8030ecf
```
...
```console
$ docker pull postgres@sha256:e27893551fe477c574de03b92b1e2d53d92b58ea9c467ce6db93a96860dc4277
```
...
-	Total Size: **13.1 MB (13109578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86e72a1d5bbcbd331a3ba15ead5ae5b1428a0da10e707f7c0f7bb474cbf0e5a8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 18 Sep 2020 03:08:06 GMT
EXPOSE 5432
# Fri, 18 Sep 2020 03:08:12 GMT
CMD ["postgres"]
```
...
```console
$ docker pull postgres@sha256:89262feee0fafb1432a819651f752f00e05c51f0163d696e5c66d6363e214d49
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **14.4 MB (14350612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5bcab06dfb63495beccf58379bb79ccf8353f977d167b603a6917136a7dffc1`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
VOLUME [/var/lib/postgresql/data]
# Fri, 18 Sep 2020 01:25:50 GMT
COPY file:be0996fe6c3fcec9976408f3f94ed203fdcb751cfa2cd940a2bfcbbbda925e9c in /usr/local/bin/ 
# Fri, 18 Sep 2020 01:26:05 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 18 Sep 2020 01:26:12 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 18 Sep 2020 01:26:18 GMT
EXPOSE 5432
# Fri, 18 Sep 2020 01:26:30 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:163f557f23dfc5d161c556e4c69a736d095386435bec2cdc077748d548c6d7a8`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b48df21f24c8357ce008a10ba2dd16d4ae6890e3cca03bdd5fcb137b79dbbb34`  
		Last Modified: Fri, 18 Sep 2020 01:30:15 GMT  
		Size: 4.3 KB (4268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc7a4ca6930aa4dd1d8dbfb22d6bbce05c7e7a65075ae01433a9dfc95dfb94c6`  
		Last Modified: Fri, 18 Sep 2020 01:30:15 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:ca3cdfce2d9dcc2fdcb6a72e07fecfc5c77f9d91fd2b3729b6167307c6073cbc
```
...
-	Total Size: **14.2 MB (14184910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb1962bfe69e53e63070d3d7ab5b76eed98a595a2df9cd086548fe7252fffa21`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
