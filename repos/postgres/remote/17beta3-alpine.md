...
### `postgres:17beta3-alpine` - linux; amd64
...
### `postgres:17beta3-alpine` - linux; arm variant v7
...
### `postgres:17beta3-alpine` - linux; arm64 variant v8
...
### `postgres:17beta3-alpine` - linux; 386
...
### `postgres:17beta3-alpine` - linux; ppc64le
...
### `postgres:17beta3-alpine` - linux; riscv64
...
### `postgres:17beta3-alpine` - linux; s390x
