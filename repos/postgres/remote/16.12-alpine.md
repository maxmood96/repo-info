...
```console
$ docker pull postgres@sha256:0684b845f742c60db58b31f4edf84ba7098b5ab26294949985b9633ba713e91c
```
...
### `postgres:16.12-alpine` - linux; amd64
...
### `postgres:16.12-alpine` - unknown; unknown
...
### `postgres:16.12-alpine` - linux; arm variant v6
...
### `postgres:16.12-alpine` - linux; arm variant v7
...
### `postgres:16.12-alpine` - linux; arm64 variant v8
...
### `postgres:16.12-alpine` - linux; 386
...
### `postgres:16.12-alpine` - linux; ppc64le
...
### `postgres:16.12-alpine` - linux; s390x
