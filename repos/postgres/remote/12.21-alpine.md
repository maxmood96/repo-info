...
### `postgres:12.21-alpine` - linux; amd64
...
### `postgres:12.21-alpine` - unknown; unknown
...
### `postgres:12.21-alpine` - linux; arm variant v6
...
### `postgres:12.21-alpine` - linux; arm variant v7
...
### `postgres:12.21-alpine` - linux; arm64 variant v8
...
### `postgres:12.21-alpine` - linux; 386
...
### `postgres:12.21-alpine` - linux; ppc64le
...
### `postgres:12.21-alpine` - linux; riscv64
...
### `postgres:12.21-alpine` - linux; s390x
