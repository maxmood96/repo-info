...
```console
$ docker pull postgres@sha256:94d07904c6e039dc02f90eea92db50d68ea260f80f8a9ec3b410baea5c1e20f4
```
...
### `postgres:17.8-alpine3.22` - linux; amd64
...
### `postgres:17.8-alpine3.22` - unknown; unknown
...
### `postgres:17.8-alpine3.22` - linux; arm variant v6
...
### `postgres:17.8-alpine3.22` - linux; arm variant v7
...
### `postgres:17.8-alpine3.22` - linux; arm64 variant v8
...
### `postgres:17.8-alpine3.22` - linux; 386
...
### `postgres:17.8-alpine3.22` - linux; ppc64le
...
### `postgres:17.8-alpine3.22` - linux; s390x
