...
```console
$ docker pull postgres@sha256:32d1e9990e6c1975329a8c0c33e2819087045f23f3cf1e352fae232c53b3b98e
```
...
### `postgres:18.3-alpine3.22` - linux; amd64
...
### `postgres:18.3-alpine3.22` - unknown; unknown
...
### `postgres:18.3-alpine3.22` - linux; arm variant v6
...
### `postgres:18.3-alpine3.22` - linux; arm variant v7
...
### `postgres:18.3-alpine3.22` - linux; arm64 variant v8
...
### `postgres:18.3-alpine3.22` - linux; 386
...
### `postgres:18.3-alpine3.22` - linux; ppc64le
...
### `postgres:18.3-alpine3.22` - linux; riscv64
...
### `postgres:18.3-alpine3.22` - linux; s390x
