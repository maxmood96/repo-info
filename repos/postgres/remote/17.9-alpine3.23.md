...
```console
$ docker pull postgres@sha256:7aac5bf8d96c5023eddac39a078eef81677776c482eab67149cd2478aac2914a
```
...
### `postgres:17.9-alpine3.23` - linux; amd64
...
### `postgres:17.9-alpine3.23` - unknown; unknown
...
### `postgres:17.9-alpine3.23` - linux; arm variant v6
...
### `postgres:17.9-alpine3.23` - linux; arm variant v7
...
### `postgres:17.9-alpine3.23` - linux; arm64 variant v8
...
### `postgres:17.9-alpine3.23` - linux; 386
...
### `postgres:17.9-alpine3.23` - linux; ppc64le
...
### `postgres:17.9-alpine3.23` - linux; riscv64
...
### `postgres:17.9-alpine3.23` - linux; s390x
