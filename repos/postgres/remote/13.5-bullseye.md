...
```console
$ docker pull postgres@sha256:5e1c13326d5444a8a178ae42c10ce912f6ce6426cf231a8ca2624b9d3ebe76aa
```
...
```console
$ docker pull postgres@sha256:c3d404edb75bdfa92d8a7a4e24e97c3af81870caf1fc55e95eeb60820f01269a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135760406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7975f8e74a95de26f34458220c944580b112d21d378a18c8c7dd286e7ea3a5e4`
...
-	Layers:
	...
	-	`sha256:d46bc4e17ddc1435cd51e55137ceeaf9dda763bfb65aee8779fae5fcee741c8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dff8437bf5d297ef3008b41656a29fda443e9279818b9d67ca5941b8dc6a3f1`  
		Last Modified: Wed, 17 Nov 2021 22:02:23 GMT  
		Size: 90.0 MB (90018804 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d87f4e351645f5aa9650a168c8fde10370e7afdaceede8d944517d71781980cc`  
		Last Modified: Wed, 17 Nov 2021 22:02:11 GMT  
		Size: 9.4 KB (9362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:484beacd6052f6266b01f1620ffca1c4e85d8c62012646d712265bd12d40c0c6`  
		Last Modified: Wed, 17 Nov 2021 22:02:10 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2094221757a30263b95f32c4431257b5f0a981306db4534db9bb9a059e38c4f4`  
		Last Modified: Wed, 17 Nov 2021 22:02:10 GMT  
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bec481c855df35b41ed9931fa16783f3752ded8e4693f84fa7458d2faf69fd03`  
		Last Modified: Wed, 17 Nov 2021 22:02:10 GMT  
...
```console
$ docker pull postgres@sha256:23298c32b34b16a08e96db0acd211dd5279fea1a4c15c0d285bfb09e0b66f756
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.9 MB (137855229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10b0b20c76b2a625cba5adf66a9f15769b683a1f5244ad81fd9a4613cc40aa53`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
RUN set -ex; 	key='B97B0AFCAA1A47F044F244A07FCC7D46ACCC4CF8'; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 	gpg --batch --export "$key" > /etc/apt/trusted.gpg.d/postgres.gpg; 	command -v gpgconf > /dev/null && gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 	apt-key list
# Wed, 17 Nov 2021 14:03:38 GMT
ENV PG_MAJOR=13
# Wed, 17 Nov 2021 14:03:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/13/bin
# Wed, 17 Nov 2021 14:03:38 GMT
ENV PG_VERSION=13.5-1.pgdg110+1
# Wed, 17 Nov 2021 14:22:18 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64 | arm64 | ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ bullseye-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ bullseye-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			DEBIAN_FRONTEND=noninteractive 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y --no-install-recommends postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y --no-install-recommends 		"postgresql-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +; 		postgres --version
# Wed, 17 Nov 2021 14:22:20 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Wed, 17 Nov 2021 14:22:22 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Wed, 17 Nov 2021 14:22:22 GMT
ENV PGDATA=/var/lib/postgresql/data
# Wed, 17 Nov 2021 14:22:23 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Wed, 17 Nov 2021 14:22:23 GMT
VOLUME [/var/lib/postgresql/data]
# Wed, 17 Nov 2021 14:22:24 GMT
COPY file:6e4de9271291e4bdd4a40b73fffe4d6d1aeff033460f5b14d74e948686daa095 in /usr/local/bin/ 
# Wed, 17 Nov 2021 14:22:24 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:2eec68e4ce0d353367d0b31385864533e9b3a6bb49023be8fd541ae0c5955c95`  
		...
		Size: 3.1 KB (3056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e28502cf04fd57beadec6ed794d368e94a36156eef4fade2ce7438a72ecb7bdc`  
		Last Modified: Wed, 17 Nov 2021 15:22:44 GMT  
		Size: 90.7 MB (90728043 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0dfe351a351ad5f1ebb476ede87e2c90edc2ae3101618df5686e2b6e2c399b4`  
		Last Modified: Wed, 17 Nov 2021 15:22:24 GMT  
		Size: 9.4 KB (9361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83fc016ee1875538cfbd8ab4577f6e72c747a4696d62e9361ffcd97dcdc1e4d1`  
		Last Modified: Wed, 17 Nov 2021 15:22:24 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa298d56c5a48ccd641d0cbb7c3a697773d4aab826e4f467153319e940f6bc4f`  
		Last Modified: Wed, 17 Nov 2021 15:22:24 GMT  
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3079c44a77181f1e28d53a5669417afac7e2f40db626bbb407d04cc7efb0516`  
		Last Modified: Wed, 17 Nov 2021 15:22:24 GMT  
...
```console
$ docker pull postgres@sha256:c0dd9fdab185b611bca6d392cf1c72b1bfe60a91f848c4e5913c1f1b1fc1daf7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.6 MB (144596701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0540012d1db58eaaec135666fd4e926113accc7d9019959aa01c1676e3a4f3b5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
RUN set -ex; 	key='B97B0AFCAA1A47F044F244A07FCC7D46ACCC4CF8'; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 	gpg --batch --export "$key" > /etc/apt/trusted.gpg.d/postgres.gpg; 	command -v gpgconf > /dev/null && gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 	apt-key list
# Wed, 17 Nov 2021 12:39:41 GMT
ENV PG_MAJOR=13
# Wed, 17 Nov 2021 12:39:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/13/bin
# Wed, 17 Nov 2021 12:39:54 GMT
ENV PG_VERSION=13.5-1.pgdg110+1
# Wed, 17 Nov 2021 12:41:26 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64 | arm64 | ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ bullseye-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ bullseye-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			DEBIAN_FRONTEND=noninteractive 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y --no-install-recommends postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y --no-install-recommends 		"postgresql-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +; 		postgres --version
# Wed, 17 Nov 2021 12:41:37 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Wed, 17 Nov 2021 12:41:45 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Wed, 17 Nov 2021 12:41:47 GMT
ENV PGDATA=/var/lib/postgresql/data
# Wed, 17 Nov 2021 12:41:53 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Wed, 17 Nov 2021 12:41:55 GMT
VOLUME [/var/lib/postgresql/data]
# Wed, 17 Nov 2021 12:41:56 GMT
COPY file:6e4de9271291e4bdd4a40b73fffe4d6d1aeff033460f5b14d74e948686daa095 in /usr/local/bin/ 
# Wed, 17 Nov 2021 12:41:59 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 17 Nov 2021 12:42:01 GMT
STOPSIGNAL SIGINT
# Wed, 17 Nov 2021 12:42:05 GMT
EXPOSE 5432
# Wed, 17 Nov 2021 12:42:07 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:b090914c5527de59020db6f6356f2a147ba8e8f0d258a2bf0d8fbe7e432d1828`  
		...
		Size: 3.1 KB (3056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18c5bf2cdf0caf6b2e355b5b9ed48f86fad0c4360321f786626142ffe50f2922`  
		Last Modified: Wed, 17 Nov 2021 12:55:52 GMT  
		Size: 94.2 MB (94216035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ada21074415dba9d1c95887c19387749524df78efa73b3bb0b323320b0129c8e`  
		Last Modified: Wed, 17 Nov 2021 12:55:36 GMT  
		Size: 9.4 KB (9362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df3ec4afa947f86c90e42652c716c2f0a8439b587806b46a29e719e42fc4498f`  
		Last Modified: Wed, 17 Nov 2021 12:55:35 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6c46fa46ee650cb6bdffd20e2cd3234803b31010411939d25c99f801a1518c2`  
		Last Modified: Wed, 17 Nov 2021 12:55:35 GMT  
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1459375f0b38233b5aa850a8e2623c99695057bd19ad0a2dd3461322120b76a`  
		Last Modified: Wed, 17 Nov 2021 12:55:35 GMT  
