...
```console
$ docker pull postgres@sha256:6855d8492846c6ce3d61566bd6020e60e2349a9ed1b42c45a888bae44e4fee9f
```
...
```console
$ docker pull postgres@sha256:60622c9841d2b71ec69468eb92aecb749af232a3de8e0a29da9843b706d2703f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.2 MB (117199415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d564e7420639a6941ca8cb5649f8c9ce2ea53d8793302cd63d42150d89bdfb91`
...
-	Layers:
	...
	-	`sha256:c042b5a6607d69d45e2e680be60e60139bce50474f0bf79a75f3fdd8a83e41d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f42c4574165ad5f966175784b4cc3723eaadbeba1524515babc9143cfdee85e3`  
		Last Modified: Thu, 22 Jul 2021 14:35:27 GMT  
		Size: 76.1 MB (76079174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68d31b3edc30969933acfb2fbc1f99b583cb81759138008c73ca0cf7789392b6`  
		Last Modified: Thu, 22 Jul 2021 14:35:16 GMT  
		Size: 9.5 KB (9549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6abba01615dfe257226453888fa7fa4f5ff481d7fab8f024593e280d095231d9`  
		Last Modified: Thu, 22 Jul 2021 14:35:16 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369c317794fd6f613c2131d021174b969960987342c7dd3dc9ebea3e46c2b95b`  
		Last Modified: Thu, 22 Jul 2021 14:35:16 GMT  
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81b69ff9c12d0ecfe699ce654fba6f970d4f3d3479f24bd9f7a1799ed34ee975`  
...
```console
$ docker pull postgres@sha256:34adda91d617893ccfb5da2f0108bf38eff54b07a6b4b77ad4f4bd6533086a43
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.4 MB (107399189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b02f73574c79be5e1e06f8ca72860ee7d9f5e766c5725eb741f2e3aa9500d9b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
# Thu, 22 Jul 2021 17:03:33 GMT
ENV PG_VERSION=14~beta2-1.pgdg100+1
# Thu, 22 Jul 2021 17:35:35 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64 | arm64 | i386 | ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ buster-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ buster-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y --no-install-recommends postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y --no-install-recommends 		"postgresql-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +; 		postgres --version
# Thu, 22 Jul 2021 17:35:37 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Thu, 22 Jul 2021 17:35:39 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Thu, 22 Jul 2021 17:35:40 GMT
ENV PGDATA=/var/lib/postgresql/data
# Thu, 22 Jul 2021 17:35:41 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Thu, 22 Jul 2021 17:35:42 GMT
VOLUME [/var/lib/postgresql/data]
# Thu, 22 Jul 2021 17:35:42 GMT
COPY file:e9c9c5e19c7b014c81f4ef8bcc5c1f247c4d9b165d34d35e9a28ca5adb5e0ab3 in /usr/local/bin/ 
# Thu, 22 Jul 2021 17:35:43 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 22 Jul 2021 17:35:43 GMT
STOPSIGNAL SIGINT
# Thu, 22 Jul 2021 17:35:43 GMT
EXPOSE 5432
# Thu, 22 Jul 2021 17:35:44 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:4ceea61b7b5c08921fa659f915c9995d7437d4422ca341c853acac7b13ae3504`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9db7bc2eed8b99098abd0ac47433c5967924016283cdb0c44b1adbf17d08a285`  
		Last Modified: Thu, 22 Jul 2021 21:06:53 GMT  
		Size: 71.4 MB (71431458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9b1025e65dbec79bed8503f8aa5c6b70eb70c63d82c03f8c5214c9703346eb1`  
		Last Modified: Thu, 22 Jul 2021 21:06:09 GMT  
		Size: 9.6 KB (9554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:356116ef71ebcccebd7f6b3e9641806517a1be7624ea39b6233177e59d132b31`  
		Last Modified: Thu, 22 Jul 2021 21:06:09 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b18d83c308640fba9a4c79e587a0c6adf79df869195b7b0a3a37b83c69a36c6`  
		Last Modified: Thu, 22 Jul 2021 21:06:09 GMT  
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3783a2cf3e5f8d912f0df44eb58081462bdfaf7bc5abacf6bb08016d49b2cec1`  
		Last Modified: Thu, 22 Jul 2021 21:06:09 GMT  
		Size: 4.4 KB (4400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:37f628e9b7bea42ed01e19b685b6e36e03b32f104d6269096a34995f9cadd9fc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.5 MB (124532757 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfb60d0e66c1bc1fab2b120be95ef9ca2fc759a9027ef33bea927356d66567f2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/14/bin
# Thu, 22 Jul 2021 16:31:10 GMT
ENV PG_VERSION=14~beta2-1.pgdg100+1
# Thu, 22 Jul 2021 16:33:16 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64 | arm64 | i386 | ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ buster-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ buster-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y --no-install-recommends postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y --no-install-recommends 		"postgresql-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +; 		postgres --version
# Thu, 22 Jul 2021 16:33:41 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Thu, 22 Jul 2021 16:33:59 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Thu, 22 Jul 2021 16:34:03 GMT
ENV PGDATA=/var/lib/postgresql/data
# Thu, 22 Jul 2021 16:34:18 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Thu, 22 Jul 2021 16:34:22 GMT
VOLUME [/var/lib/postgresql/data]
# Thu, 22 Jul 2021 16:34:26 GMT
COPY file:e9c9c5e19c7b014c81f4ef8bcc5c1f247c4d9b165d34d35e9a28ca5adb5e0ab3 in /usr/local/bin/ 
# Thu, 22 Jul 2021 16:34:36 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 22 Jul 2021 16:34:49 GMT
STOPSIGNAL SIGINT
# Thu, 22 Jul 2021 16:34:59 GMT
EXPOSE 5432
# Thu, 22 Jul 2021 16:35:06 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:0b8f31d0b1bd29f737016025f4a27dc4ac5fd325ad5e2ecda40d4c76674b42c4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fa5edff5b2ff66b55e17bb537776a2eeff6957dcacf4243f2ae0b09db340d1e`  
		Last Modified: Thu, 22 Jul 2021 17:39:02 GMT  
		Size: 79.3 MB (79291221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75f2f073d34b03e90c78dafdea95e6b22d35ef4499adc8392f25152807518de8`  
		Last Modified: Thu, 22 Jul 2021 17:38:48 GMT  
		Size: 9.6 KB (9553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acd6bf010ed7946b143842d32f1d3be594d6fa7cce03832eb64319b8fc33cfa0`  
		Last Modified: Thu, 22 Jul 2021 17:38:48 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d183983bc37f04375436efa261d0b8605f5adcd83a907391b2f41471de9e6e9`  
		Last Modified: Thu, 22 Jul 2021 17:38:48 GMT  
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9557265a8eda5fd63172d433bcfc8340e6fa164d35f59a48a744670289e39031`  
		Last Modified: Thu, 22 Jul 2021 17:38:48 GMT  
		Size: 4.4 KB (4399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
