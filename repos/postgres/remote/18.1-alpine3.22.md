...
### `postgres:18.1-alpine3.22` - linux; amd64
...
### `postgres:18.1-alpine3.22` - unknown; unknown
...
### `postgres:18.1-alpine3.22` - linux; arm variant v6
...
### `postgres:18.1-alpine3.22` - linux; arm variant v7
...
### `postgres:18.1-alpine3.22` - linux; arm64 variant v8
...
### `postgres:18.1-alpine3.22` - linux; 386
...
### `postgres:18.1-alpine3.22` - linux; ppc64le
...
### `postgres:18.1-alpine3.22` - linux; riscv64
...
### `postgres:18.1-alpine3.22` - linux; s390x
