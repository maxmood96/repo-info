...
```console
$ docker pull postgres@sha256:db6521331addbe88647d835946eae2d0719011cb6805a1b7711f747947b292d5
```
...
### `postgres:12.21-bookworm` - linux; amd64
...
### `postgres:12.21-bookworm` - unknown; unknown
...
### `postgres:12.21-bookworm` - linux; arm variant v5
...
### `postgres:12.21-bookworm` - linux; arm variant v7
...
### `postgres:12.21-bookworm` - linux; arm64 variant v8
...
### `postgres:12.21-bookworm` - linux; 386
...
### `postgres:12.21-bookworm` - linux; ppc64le
...
### `postgres:12.21-bookworm` - linux; s390x
