...
```console
$ docker pull postgres@sha256:7e20e0f486f63943d49305265745c62ceadeb09199495e60d25b3fc9161fac8b
```
...
### `postgres:18.4-alpine3.22` - linux; amd64
...
### `postgres:18.4-alpine3.22` - unknown; unknown
...
### `postgres:18.4-alpine3.22` - linux; arm variant v6
...
### `postgres:18.4-alpine3.22` - linux; arm variant v7
...
### `postgres:18.4-alpine3.22` - linux; arm64 variant v8
...
### `postgres:18.4-alpine3.22` - linux; 386
...
### `postgres:18.4-alpine3.22` - linux; ppc64le
...
### `postgres:18.4-alpine3.22` - linux; s390x
