...
```console
$ docker pull postgres@sha256:c1c94be066aa7e356da84731474a3bc7f121c8b774c431131c993ec5b6719f77
```
...
### `postgres:14.21-alpine3.22` - linux; amd64
...
### `postgres:14.21-alpine3.22` - unknown; unknown
...
### `postgres:14.21-alpine3.22` - linux; arm variant v6
...
### `postgres:14.21-alpine3.22` - linux; arm variant v7
...
### `postgres:14.21-alpine3.22` - linux; arm64 variant v8
...
### `postgres:14.21-alpine3.22` - linux; 386
...
### `postgres:14.21-alpine3.22` - linux; ppc64le
...
### `postgres:14.21-alpine3.22` - linux; s390x
