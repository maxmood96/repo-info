...
```console
$ docker pull postgres@sha256:beb96848244b4528c476d8896bbdea11855a3b85b6fd92077ac05813ec56c3a4
```
...
```console
$ docker pull postgres@sha256:e64f134c27b0bd74728ce511b0205fa10ea4d1e68aadd18bde123ac26982ef8e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.8 MB (75820669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f6c178b426d13c8e629aa6f611254daf06ed041746490811177816916bb4ec7`
...
-	Layers:
	...
	-	`sha256:2e9ccfc29d86510f6297bc5869ce92182e27c70e34c8415c54675acfba85e7e2`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af052b6da3dc80b9e0d7fb793df817695c5fb3a3bd77cfed74fb384977b918d0`  
...
```console
$ docker pull postgres@sha256:73ca4e0a2fa955d3d7d9bb6463de6cc2055f639c0ed817db0ea3452954a7d1e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.3 MB (74349864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:652db4e28da4262393771044e5a8987ec185804ab7aa1e348283b3a27ccd1a6d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
VOLUME [/var/lib/postgresql/data]
# Thu, 30 Sep 2021 23:48:45 GMT
COPY file:af11d0c631db05080f16c63e7915add96493742b5a9914b61af4925ce6046b60 in /usr/local/bin/ 
# Thu, 30 Sep 2021 23:48:45 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 30 Sep 2021 23:48:45 GMT
STOPSIGNAL SIGINT
# Thu, 30 Sep 2021 23:48:46 GMT
EXPOSE 5432
# Thu, 30 Sep 2021 23:48:46 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:1173e8b71a75edb15ae41018c5ad714445716252a8e49c86478a7392d4069845`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08c4486e5f5c8782bfd57b11d730bd439908a4d82940b989d1dcfac1efcb9333`  
		Last Modified: Thu, 30 Sep 2021 23:53:16 GMT  
...
```console
$ docker pull postgres@sha256:78a76b650a768dfb528654a697f5aa7a7566c8388832fc64add98c8744c84182
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.1 MB (70060056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26b4de4df203a0ea85ca14ca002f1b4ac914435b4d896fc512d23199c8f278a5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
-	Layers:
	...
	-	`sha256:6ae7c4cc9e8a76a3000d2bed6195da87517f0899347bb154e56bfae38fb28f97`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18978d757df1ebff9c014f5fd7479af7607f692d5b73f739cb253cea7008391a`  
		Last Modified: Fri, 01 Oct 2021 02:38:49 GMT  
...
```console
$ docker pull postgres@sha256:16b2727d4ec9b28eae5a2912461ca9bd776ecf3bccba101efe687d2ba4008b10
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.7 MB (74700812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77b9453fae93a4eb7a22fe0e64a18885219633e5b6bc39310f5307a4b1f74d79`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
RUN mkdir /docker-entrypoint-initdb.d
# Sat, 28 Aug 2021 00:49:10 GMT
ENV PG_MAJOR=13
# Sat, 28 Aug 2021 00:49:10 GMT
ENV PG_VERSION=13.4
# Sat, 28 Aug 2021 00:49:10 GMT
ENV PG_SHA256=ea93e10390245f1ce461a54eb5f99a48d8cabd3a08ce4d652ec2169a357bc0cd
# Sat, 28 Aug 2021 00:53:25 GMT
RUN set -eux; 		wget -O postgresql.tar.bz2 "https://ftp.postgresql.org/pub/source/v$PG_VERSION/postgresql-$PG_VERSION.tar.bz2"; 	echo "$PG_SHA256 *postgresql.tar.bz2" | sha256sum -c -; 	mkdir -p /usr/src/postgresql; 	tar 		--extract 		--file postgresql.tar.bz2 		--directory /usr/src/postgresql 		--strip-components 1 	; 	rm postgresql.tar.bz2; 		apk add --no-cache --virtual .build-deps 		bison 		coreutils 		dpkg-dev dpkg 		flex 		gcc 		libc-dev 		libedit-dev 		libxml2-dev 		libxslt-dev 		linux-headers 		llvm11-dev clang g++ 		make 		openssl-dev 		perl-utils 		perl-ipc-run 		util-linux-dev 		zlib-dev 		icu-dev 	; 		cd /usr/src/postgresql; 	awk '$1 == "#define" && $2 == "DEFAULT_PGSOCKET_DIR" && $3 == "\"/tmp\"" { $3 = "\"/var/run/postgresql\""; print; next } { print }' src/include/pg_config_manual.h > src/include/pg_config_manual.h.new; 	grep '/var/run/postgresql' src/include/pg_config_manual.h.new; 	mv src/include/pg_config_manual.h.new src/include/pg_config_manual.h; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	wget -O config/config.guess 'https://git.savannah.gnu.org/cgit/config.git/plain/config.guess?id=7d3d27baf8107b630586c962c057e22149653deb'; 	wget -O config/config.sub 'https://git.savannah.gnu.org/cgit/config.git/plain/config.sub?id=7d3d27baf8107b630586c962c057e22149653deb'; 	./configure 		--build="$gnuArch" 		--enable-integer-datetimes 		--enable-thread-safety 		--enable-tap-tests 		--disable-rpath 		--with-uuid=e2fs 		--with-gnu-ld 		--with-pgport=5432 		--with-system-tzdata=/usr/share/zoneinfo 		--prefix=/usr/local 		--with-includes=/usr/local/include 		--with-libraries=/usr/local/lib 				--with-openssl 		--with-libxml 		--with-libxslt 		--with-icu 		--with-llvm 	; 	make -j "$(nproc)" world; 	make install-world; 	make -C contrib install; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache --virtual .postgresql-rundeps 		$runDeps 		bash 		su-exec 		tzdata 	; 	apk del --no-network .build-deps; 	cd /; 	rm -rf 		/usr/src/postgresql 		/usr/local/share/doc 		/usr/local/share/man 	; 		postgres --version
# Sat, 28 Aug 2021 00:53:26 GMT
RUN set -eux; 	cp -v /usr/local/share/postgresql/postgresql.conf.sample /usr/local/share/postgresql/postgresql.conf.sample.orig; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/local/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/local/share/postgresql/postgresql.conf.sample
# Sat, 28 Aug 2021 00:53:27 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Sat, 28 Aug 2021 00:53:27 GMT
ENV PGDATA=/var/lib/postgresql/data
# Sat, 28 Aug 2021 00:53:28 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Sat, 28 Aug 2021 00:53:28 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 01 Oct 2021 00:23:54 GMT
COPY file:af11d0c631db05080f16c63e7915add96493742b5a9914b61af4925ce6046b60 in /usr/local/bin/ 
# Fri, 01 Oct 2021 00:23:54 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 01 Oct 2021 00:23:54 GMT
STOPSIGNAL SIGINT
# Fri, 01 Oct 2021 00:23:55 GMT
EXPOSE 5432
# Fri, 01 Oct 2021 00:23:55 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:1e16841d04e832ad38f955594481fd7205810db3379719d35e62c344f12dc0ff`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bb4d6f8fad8ebba71faba880b3d152251eda84af9cc4f9f19a76ae702854529`  
		Last Modified: Sat, 28 Aug 2021 01:11:40 GMT  
		Size: 72.0 MB (71973606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6f008f9b3af6cffa847e18efdadbe64323bfc76eb64d92de09312dd655a4999`  
		Last Modified: Sat, 28 Aug 2021 01:11:30 GMT  
		Size: 9.0 KB (9023 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84c0172d9e883fb1170a5d2703ad040ff312698837d9b6efc4ffc781bcda5369`  
		Last Modified: Sat, 28 Aug 2021 01:11:30 GMT  
		Size: 161.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5f0ebb20912a45b37e806282a43fe11c2baac7f93a7ccf067fa22c8f14bed29`  
		Last Modified: Sat, 28 Aug 2021 01:11:30 GMT  
		Size: 195.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:302b0992dbb6ecf1307f2949d4f39d33c19cddb1a49c74463fb8b1fd33ea1dab`  
		Last Modified: Fri, 01 Oct 2021 00:29:28 GMT  
...
```console
$ docker pull postgres@sha256:c9202d5c33f2402f8ae9d1341a7a113eb80c895e290527e94034ff08add7ae7e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.6 MB (80572007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c24446f19c5a40c305b8f53e8384b7895909daf7832145535b85a0874802d5c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
# Fri, 27 Aug 2021 22:13:01 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 01 Oct 2021 01:34:35 GMT
COPY file:af11d0c631db05080f16c63e7915add96493742b5a9914b61af4925ce6046b60 in /usr/local/bin/ 
# Fri, 01 Oct 2021 01:34:35 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 01 Oct 2021 01:34:36 GMT
STOPSIGNAL SIGINT
# Fri, 01 Oct 2021 01:34:36 GMT
EXPOSE 5432
# Fri, 01 Oct 2021 01:34:36 GMT
...
-	Layers:
	...
	-	`sha256:5d7c982a1820f41f0b875b2d15d7744226839c49d2b4a8f3dc5b625ee5f3e5fb`  
		...
		Size: 195.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9e9e4aff5b015707f71f98b664c4f3219693b90b6b4b2a03e06e98e543173bd`  
		Last Modified: Fri, 01 Oct 2021 01:40:56 GMT  
		Size: 4.6 KB (4565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:7cd7679719e0c2d8c7c48ca1fdf0151f677d437bc63dcb2d05b7df2c19e52d13
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.7 MB (80738247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be877af946545e38a700ad220ffff17bdc20239c360dd5c611206b62bc8533f2`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
VOLUME [/var/lib/postgresql/data]
# Tue, 05 Oct 2021 08:08:29 GMT
COPY file:af11d0c631db05080f16c63e7915add96493742b5a9914b61af4925ce6046b60 in /usr/local/bin/ 
# Tue, 05 Oct 2021 08:08:31 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 05 Oct 2021 08:08:34 GMT
STOPSIGNAL SIGINT
# Tue, 05 Oct 2021 08:08:40 GMT
EXPOSE 5432
# Tue, 05 Oct 2021 08:08:43 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:d7311d71c34803f2c6669e38f3e60f650da1e415451fef4801b312db30318d09`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7689fd1beebea5e3da4b0d056467788cbe82c066aa2d4887912b951cdcc24c5`  
		Last Modified: Tue, 05 Oct 2021 08:25:33 GMT  
...
```console
$ docker pull postgres@sha256:b1c73a1f2412167024008b6c390994cbb477ff88f3c5d24e26d4795352d76aa2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.0 MB (77043163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae601c80612edbffdca5282b407d83a015ab9c1d67c209e7dacab01b05a42651`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
-	Layers:
	...
	-	`sha256:5b5422fe64c303ed209900d3d3323ffb7013ae6163e6faa789f21e1859cd23bd`  
		...
		Size: 195.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f15bdb399b13e3bb1a3a23c030163135739602adb948efee67dafce2342cc5a0`  
		Last Modified: Fri, 01 Oct 2021 00:04:36 GMT  
		Size: 4.6 KB (4567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
