...
```console
$ docker pull postgres@sha256:deb643db8fcbf792ce79078f1a69429db547a34eeb3d504c363c1ec452088039
```
...
### `postgres:13.18-alpine3.19` - linux; amd64
...
### `postgres:13.18-alpine3.19` - unknown; unknown
...
### `postgres:13.18-alpine3.19` - linux; arm variant v6
...
### `postgres:13.18-alpine3.19` - linux; arm64 variant v8
...
### `postgres:13.18-alpine3.19` - linux; 386
...
### `postgres:13.18-alpine3.19` - linux; ppc64le
...
### `postgres:13.18-alpine3.19` - linux; s390x
