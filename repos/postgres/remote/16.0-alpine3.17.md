...
```console
$ docker pull postgres@sha256:b02ec03647373b5e8002a48fd5b34514e6727e55b740adf1ca1ac96a86a5f4ef
```
...
### `postgres:16.0-alpine3.17` - linux; amd64
...
### `postgres:16.0-alpine3.17` - unknown; unknown
...
### `postgres:16.0-alpine3.17` - linux; arm variant v6
...
### `postgres:16.0-alpine3.17` - linux; arm variant v7
...
### `postgres:16.0-alpine3.17` - linux; arm64 variant v8
...
### `postgres:16.0-alpine3.17` - linux; 386
...
### `postgres:16.0-alpine3.17` - linux; ppc64le
...
### `postgres:16.0-alpine3.17` - linux; s390x
