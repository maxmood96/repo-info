## `postgres:16.12-alpine3.22`

```console
$ docker pull postgres@sha256:9419a6df4140de2b56320712a715af6f3f408e6680cd42330b53097c6d3bb70f
```
...
### `postgres:16.12-alpine3.22` - linux; amd64
...
### `postgres:16.12-alpine3.22` - unknown; unknown
...
### `postgres:16.12-alpine3.22` - linux; arm variant v6
...
### `postgres:16.12-alpine3.22` - linux; arm variant v7
...
### `postgres:16.12-alpine3.22` - linux; arm64 variant v8
...
### `postgres:16.12-alpine3.22` - linux; 386
...
### `postgres:16.12-alpine3.22` - linux; ppc64le
...
### `postgres:16.12-alpine3.22` - linux; s390x
