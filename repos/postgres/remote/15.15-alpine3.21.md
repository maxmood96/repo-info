...
```console
$ docker pull postgres@sha256:418063a1e9dccbc9d8e9a5e1768e6f7452c1ccfb124c5700940e5caf40b39e7a
```
...
### `postgres:15.15-alpine3.21` - linux; amd64
...
### `postgres:15.15-alpine3.21` - unknown; unknown
...
### `postgres:15.15-alpine3.21` - linux; arm variant v6
...
### `postgres:15.15-alpine3.21` - linux; arm variant v7
...
### `postgres:15.15-alpine3.21` - linux; arm64 variant v8
...
### `postgres:15.15-alpine3.21` - linux; 386
...
### `postgres:15.15-alpine3.21` - linux; ppc64le
...
### `postgres:15.15-alpine3.21` - linux; s390x
