...
### `postgres:17.1-bullseye` - linux; amd64
...
### `postgres:17.1-bullseye` - unknown; unknown
...
### `postgres:17.1-bullseye` - linux; arm variant v7
...
### `postgres:17.1-bullseye` - linux; arm64 variant v8
...
### `postgres:17.1-bullseye` - linux; 386
