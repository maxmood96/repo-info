...
```console
$ docker pull postgres@sha256:dc17045ccfd343b49600570ea734b9c4991cf1c3f3302e67df51e3b402dd55c4
```
...
### `postgres:17.10-alpine3.24` - linux; amd64
...
### `postgres:17.10-alpine3.24` - unknown; unknown
...
### `postgres:17.10-alpine3.24` - linux; arm variant v6
...
### `postgres:17.10-alpine3.24` - linux; arm variant v7
...
### `postgres:17.10-alpine3.24` - linux; arm64 variant v8
...
### `postgres:17.10-alpine3.24` - linux; 386
...
### `postgres:17.10-alpine3.24` - linux; ppc64le
...
### `postgres:17.10-alpine3.24` - linux; riscv64
...
### `postgres:17.10-alpine3.24` - linux; s390x
