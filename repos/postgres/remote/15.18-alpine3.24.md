...
### `postgres:15.18-alpine3.24` - linux; amd64
...
### `postgres:15.18-alpine3.24` - unknown; unknown
...
### `postgres:15.18-alpine3.24` - linux; arm variant v6
...
### `postgres:15.18-alpine3.24` - linux; arm variant v7
...
### `postgres:15.18-alpine3.24` - linux; arm64 variant v8
...
### `postgres:15.18-alpine3.24` - linux; 386
...
### `postgres:15.18-alpine3.24` - linux; ppc64le
...
### `postgres:15.18-alpine3.24` - linux; riscv64
...
### `postgres:15.18-alpine3.24` - linux; s390x
