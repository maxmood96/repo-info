...
```console
$ docker pull postgres@sha256:38346350acb3e824c6948e6df7ff4759f48ba09d8ef4cb8d1b6e6db120f56872
```
...
### `postgres:18.4-alpine` - linux; amd64
...
### `postgres:18.4-alpine` - unknown; unknown
...
### `postgres:18.4-alpine` - linux; arm variant v6
...
### `postgres:18.4-alpine` - linux; arm variant v7
...
### `postgres:18.4-alpine` - linux; arm64 variant v8
...
### `postgres:18.4-alpine` - linux; 386
...
### `postgres:18.4-alpine` - linux; ppc64le
...
### `postgres:18.4-alpine` - linux; s390x
