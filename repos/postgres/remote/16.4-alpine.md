...
```console
$ docker pull postgres@sha256:08f5b7192320b3180ae3b7386d2b2caa776b0d0c7d0940d2739660c356b47984
```
...
### `postgres:16.4-alpine` - linux; amd64
...
### `postgres:16.4-alpine` - unknown; unknown
...
### `postgres:16.4-alpine` - linux; arm variant v6
...
### `postgres:16.4-alpine` - linux; arm variant v7
...
### `postgres:16.4-alpine` - linux; arm64 variant v8
...
### `postgres:16.4-alpine` - linux; 386
...
### `postgres:16.4-alpine` - linux; ppc64le
...
### `postgres:16.4-alpine` - linux; riscv64
...
### `postgres:16.4-alpine` - linux; s390x
