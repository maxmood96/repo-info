...
### `postgres:13.17-alpine` - linux; amd64
...
### `postgres:13.17-alpine` - unknown; unknown
...
### `postgres:13.17-alpine` - linux; arm variant v6
...
### `postgres:13.17-alpine` - linux; arm variant v7
...
### `postgres:13.17-alpine` - linux; arm64 variant v8
...
### `postgres:13.17-alpine` - linux; 386
...
### `postgres:13.17-alpine` - linux; ppc64le
...
### `postgres:13.17-alpine` - linux; riscv64
...
### `postgres:13.17-alpine` - linux; s390x
