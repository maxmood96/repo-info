...
```console
$ docker pull postgres@sha256:a808f40eeb13cabbe3e185bfdde5a01750808c0fac30bb060fd034068d964d97
```
...
### `postgres:13.21-alpine3.20` - linux; amd64
...
### `postgres:13.21-alpine3.20` - linux; arm variant v7
...
### `postgres:13.21-alpine3.20` - linux; arm64 variant v8
...
### `postgres:13.21-alpine3.20` - linux; 386
...
### `postgres:13.21-alpine3.20` - linux; s390x
