...
```console
$ docker pull postgres@sha256:fc4969b22882b7cf6b40564f2041859aa9fb61f582ef6925f1eeffad5af5440f
```
...
### `postgres:14.23-alpine3.24` - linux; amd64
...
### `postgres:14.23-alpine3.24` - unknown; unknown
...
### `postgres:14.23-alpine3.24` - linux; arm variant v6
...
### `postgres:14.23-alpine3.24` - linux; arm variant v7
...
### `postgres:14.23-alpine3.24` - linux; arm64 variant v8
...
### `postgres:14.23-alpine3.24` - linux; 386
...
### `postgres:14.23-alpine3.24` - linux; ppc64le
...
### `postgres:14.23-alpine3.24` - linux; s390x
