...
### `postgres:14.22-alpine` - linux; amd64
...
### `postgres:14.22-alpine` - unknown; unknown
...
### `postgres:14.22-alpine` - linux; arm variant v6
...
### `postgres:14.22-alpine` - linux; arm variant v7
...
### `postgres:14.22-alpine` - linux; arm64 variant v8
...
### `postgres:14.22-alpine` - linux; 386
...
### `postgres:14.22-alpine` - linux; ppc64le
...
### `postgres:14.22-alpine` - linux; riscv64
...
### `postgres:14.22-alpine` - linux; s390x
