...
```console
$ docker pull postgres@sha256:5b34d5d0fa5a17df0bee1b0193a984483b33eb126d0532420c99571683629d79
```
...
### `postgres:16.3-alpine3.18` - linux; amd64
...
### `postgres:16.3-alpine3.18` - unknown; unknown
...
### `postgres:16.3-alpine3.18` - linux; arm variant v6
...
### `postgres:16.3-alpine3.18` - linux; arm64 variant v8
...
### `postgres:16.3-alpine3.18` - linux; 386
...
### `postgres:16.3-alpine3.18` - linux; ppc64le
...
### `postgres:16.3-alpine3.18` - linux; s390x
