...
```console
$ docker pull postgres@sha256:e6394dec64173e9596db5ee682d8eeeca4fa5315000a7765adc612a36f8fc3ac
```
...
### `postgres:14.21-trixie` - linux; amd64
...
### `postgres:14.21-trixie` - unknown; unknown
...
### `postgres:14.21-trixie` - linux; arm variant v5
...
### `postgres:14.21-trixie` - linux; arm variant v7
...
### `postgres:14.21-trixie` - linux; arm64 variant v8
...
### `postgres:14.21-trixie` - linux; 386
...
### `postgres:14.21-trixie` - linux; ppc64le
...
### `postgres:14.21-trixie` - linux; s390x
