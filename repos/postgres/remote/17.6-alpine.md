...
```console
$ docker pull postgres@sha256:036d26b9001bfc0b6aa1d78c9fe8f43cd7211fbe2fb92b4e1908a8beb0b2eb8b
```
...
### `postgres:17.6-alpine` - linux; amd64
...
### `postgres:17.6-alpine` - unknown; unknown
...
### `postgres:17.6-alpine` - linux; arm variant v6
...
### `postgres:17.6-alpine` - linux; arm variant v7
...
### `postgres:17.6-alpine` - linux; arm64 variant v8
...
### `postgres:17.6-alpine` - linux; 386
...
### `postgres:17.6-alpine` - linux; ppc64le
...
### `postgres:17.6-alpine` - linux; riscv64
...
### `postgres:17.6-alpine` - linux; s390x
