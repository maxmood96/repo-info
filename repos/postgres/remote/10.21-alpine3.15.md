...
### `postgres:10.21-alpine3.15` - linux; arm variant v6
...
### `postgres:10.21-alpine3.15` - linux; arm64 variant v8
...
### `postgres:10.21-alpine3.15` - linux; 386
...
### `postgres:10.21-alpine3.15` - linux; ppc64le
...
### `postgres:10.21-alpine3.15` - linux; s390x
