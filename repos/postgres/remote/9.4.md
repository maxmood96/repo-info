...
```console
$ docker pull postgres@sha256:42a7a6a647a602efa9592edd1f56359800d079b93fa52c5d92244c58ac4a2ab9
```
...
```console
$ docker pull postgres@sha256:0de729a6fcda3becc1742aac92cf29f9b77c4a40283ae06abea3c5d7c5b2a126
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **85.0 MB (84974089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c204da0e8d4b5baaa54cf7b65540cb17590ec18eb593081c90339510b4646a7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_MAJOR=9.4
# Fri, 14 Feb 2020 19:40:28 GMT
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 19:58:16 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 19:58:20 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 19:58:21 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 19:58:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 19:58:23 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 19:58:24 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 19:58:25 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 19:58:25 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 19:58:27 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 19:58:28 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 19:58:28 GMT
EXPOSE 5432
# Fri, 14 Feb 2020 19:58:29 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:1c9bf11db5cc7dd3ff01824ff16d5642657294a22e3ec2086a5b3575ef803947`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66abe4615ceceaf3eef08fc41ddb1adee990f11b6614b28da6cafbe95fb11dbc`  
		Last Modified: Fri, 14 Feb 2020 20:01:45 GMT  
		Size: 51.7 MB (51725426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:434d3e7bea09af5da62294bab7ff07e3daffc52f6e9112a792f3cede53f2a26a`  
		Last Modified: Fri, 14 Feb 2020 20:01:25 GMT  
		Size: 7.4 KB (7353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb803562b3bf4cc161b42013d45c1d1539b87781df7cd41b08ff791292aac4ce`  
		Last Modified: Fri, 14 Feb 2020 20:01:25 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8be5f18ba60a27d3813897ea5da1d556b59e14531cc222cf5f9d2d43623cb2d2`  
		Last Modified: Fri, 14 Feb 2020 20:01:25 GMT  
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a70e3bf904b31921e0fee490bd670be79523dffec5a543ff4cf687a1745351d9`  
		Last Modified: Fri, 14 Feb 2020 20:01:25 GMT  
		Size: 4.2 KB (4194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eb8bfa33e06aef502958f14a7018788c1b51528809f1d472f015164259b4cb7`  
		Last Modified: Fri, 14 Feb 2020 20:01:25 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:281e97364cd86db68397525a5672989450d81e72aa4501726b51af135e3e90d1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.1 MB (81055096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e95eec40c3c12eaf91fe84c626fe22c6bfd02d3eb5a41efae6dcdff7216b4c4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_MAJOR=9.4
# Fri, 14 Feb 2020 18:51:12 GMT
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 19:08:05 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 19:08:11 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 19:08:13 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 19:08:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 19:08:15 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 19:08:17 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 19:08:18 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 19:08:19 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 19:08:21 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 19:08:22 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 19:08:23 GMT
EXPOSE 5432
# Fri, 14 Feb 2020 19:08:23 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:f1f8d5c6112a73a87453a9f3b2c2c298c0d2c275026fb63fb5ecdd81e6205461`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4db179f48ff052fe9c5fa06ecd28988df518e5aa816c9e98f48cb6324fe7d959`  
		Last Modified: Fri, 14 Feb 2020 19:15:55 GMT  
		Size: 50.1 MB (50070710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27e9a44dd03682e96b13c1605557d3658f87d64e02f6737784aed27ec658d0ea`  
		Last Modified: Fri, 14 Feb 2020 19:15:36 GMT  
		Size: 7.4 KB (7352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de87e754911da9f42ebca04bc62131d187e14ab33733e7d39827582090d6e8c0`  
		Last Modified: Fri, 14 Feb 2020 19:15:36 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56aed608fbd74bc888127fc5d99163780e020efbf084cffda4ba86bae8ec73b4`  
		Last Modified: Fri, 14 Feb 2020 19:15:37 GMT  
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0702d0e35b446274036e4607663c4ba2e02614cdde34bbd5a63610d04c2290a7`  
		Last Modified: Fri, 14 Feb 2020 19:15:36 GMT  
		Size: 4.2 KB (4195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:977b8fd431472542227948952b6892ad36da74f30e79c56032906ac729f281e3`  
		Last Modified: Fri, 14 Feb 2020 19:15:36 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:6f9666f304461f854a609bef6d4404be91fbbd5eda4efa4680582e3a9c9b5d10
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.9 MB (83918137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:897a27671908f1d905b22b3051874cb1d64b66e486f3d720c8b1c543074b1dcb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_MAJOR=9.4
# Fri, 14 Feb 2020 19:37:28 GMT
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 19:53:46 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 19:53:51 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 19:53:53 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 19:53:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 19:53:54 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 19:53:56 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 19:53:57 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 19:53:57 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 19:53:59 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 19:54:00 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 19:54:00 GMT
EXPOSE 5432
# Fri, 14 Feb 2020 19:54:01 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:f5ff0687a25d7e24b75be4e353f57d8821a81a4b8c51aff2a01f927bb70d1a76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dc143e33906e6a8c53f55816f6885ac0e2b605c68b5ef353e0eaa1eed9cb1fa`  
		Last Modified: Fri, 14 Feb 2020 20:01:26 GMT  
		Size: 51.7 MB (51671882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:582894ca74e1b5b0488c2f2bab2ccccc8f6f0df400fa32a026a3030d29310eee`  
		Last Modified: Fri, 14 Feb 2020 20:01:09 GMT  
		Size: 7.3 KB (7346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c116dd4b34b6493fbdb11144af9c6defd9dba1a5e08bf8327e86a60eb58d6b96`  
		Last Modified: Fri, 14 Feb 2020 20:01:08 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48d8ac22e10b742a92f491765a1d0e59f8aa49692e2ec25c13785280124062c5`  
		Last Modified: Fri, 14 Feb 2020 20:01:08 GMT  
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:baccad31540ee4a01ffa7ea75ac4a682af1592839921ecb2931792a46e7d8038`  
		Last Modified: Fri, 14 Feb 2020 20:01:08 GMT  
		Size: 4.2 KB (4192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdfd1c2f57c6cffea2178b3569850975af41495ec23d72ea0bcc8036193cdecd`  
		Last Modified: Fri, 14 Feb 2020 20:01:08 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:77e3191a4a46d73385ed9e1d696703718fdd7fa2bf523eededcd4bf1c87e6f71
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.0 MB (89952432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21919dd6f2e778aaafbb7556a97c9ef0f0b5e21f9b04a3275b58f7091abb7880`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_MAJOR=9.4
# Fri, 14 Feb 2020 18:12:01 GMT
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 18:12:28 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 18:12:29 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 18:12:29 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 18:12:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 18:12:30 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 18:12:31 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 18:12:31 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 18:12:31 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 18:12:32 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 18:12:32 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 18:12:32 GMT
...
-	Layers:
	...
	-	`sha256:66ff425a04fcdc853777162926c616c569257ea00e96154204e9e3f91e2f7527`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75ea0cb0875e2efe00c01d9a653845984bdd729c5a6d9449f3ea131c23840618`  
		Last Modified: Fri, 14 Feb 2020 18:19:31 GMT  
		Size: 54.2 MB (54176103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6548db61afa0a86be2f382a0cb619b91cefffac7327d5d7b5ae39be9f432eeed`  
		Last Modified: Fri, 14 Feb 2020 18:19:17 GMT  
		Size: 7.3 KB (7350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecc1e0363e2562e30a747a380d4d5992d9dfe9213160ba54c4600a0c5109192b`  
		Last Modified: Fri, 14 Feb 2020 18:19:16 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a10aeb4496ea9e5044856c4337ed890eca7ce8e5c89761f6865bf5d40bc3a6c`  
		Last Modified: Fri, 14 Feb 2020 18:19:16 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd314e998a121f5e591e17aff0a31cc439bb3b5abc1a2271e6c90882f611d764`  
		Last Modified: Fri, 14 Feb 2020 18:19:17 GMT  
		Size: 4.2 KB (4189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eda621ec079c160c8e7f2fb3dc3af1d39d0c30dd1024a62dc984cc1e52eb1f7f`  
		Last Modified: Fri, 14 Feb 2020 18:19:16 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:5a6ba39f350e06380226f792019053e6eecc9cc0f149dcb2a902913bca41168a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.2 MB (88209845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:692c0a453a33b195cc7392c11c65e9c54d71467f12ffece1f58e060b6f684104`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_MAJOR=9.4
# Fri, 14 Feb 2020 18:01:06 GMT
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 18:04:40 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 18:04:50 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 18:04:55 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 18:04:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 18:05:00 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 18:05:08 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 18:05:14 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 18:05:16 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 18:05:21 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 18:05:25 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 18:05:28 GMT
EXPOSE 5432
# Fri, 14 Feb 2020 18:05:31 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:3f2e5ca1d60f37146aeff96ecb4c62cbe26cf5ebc72cb162751de46927921192`  
		...
		Size: 4.8 KB (4790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfdfbe57a00a9a2a9cd84d985269ffd2fd6151a0a82b2b862cab9f09a39bbbb`  
		Last Modified: Fri, 14 Feb 2020 18:15:30 GMT  
		Size: 53.3 MB (53271184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:467d2692ee1b058bb9a3363b08b1d4e37e007e8be13a92e8c87893040b5e4b5f`  
		Last Modified: Fri, 14 Feb 2020 18:15:14 GMT  
		Size: 7.3 KB (7347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:074ff32da969ee4f8bd7c7091433833d8cae0cf6c590ff89c966a9f28728eb77`  
		Last Modified: Fri, 14 Feb 2020 18:15:13 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12db84ff500786e59b68f82d3051859d6de546dd05169b51e28e41b232f8e75a`  
		Last Modified: Fri, 14 Feb 2020 18:15:14 GMT  
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99432284ff1eff952921bfcd48ece1254043b8167408f5d29d73ae422a1b8f35`  
		Last Modified: Fri, 14 Feb 2020 18:15:14 GMT  
		Size: 4.2 KB (4191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4ba1171f34f54b877c085c5d42be9b07ea2dde6c9a65fe8cebcfd83d0a3bc45`  
		Last Modified: Fri, 14 Feb 2020 18:15:14 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull postgres@sha256:833b5b0e51ab5086187bf2711a38f9421cc7b9232260ce80c2e771f2b04939c5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.8 MB (88822310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e0e9fa18c7c6910e551e99775d5af233acfe7924b0ab59fadef4be29a35e592`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["postgres"]`
...
ENV PG_VERSION=9.4.26-1.pgdg90+1
# Fri, 14 Feb 2020 18:58:52 GMT
RUN set -ex; 		export PYTHONDONTWRITEBYTECODE=1; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64|i386|ppc64el) 			echo "deb http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 			apt-get update; 			;; 		*) 			echo "deb-src http://apt.postgresql.org/pub/repos/apt/ stretch-pgdg main $PG_MAJOR" > /etc/apt/sources.list.d/pgdg.list; 						case "$PG_MAJOR" in 				9.* | 10 ) ;; 				*) 					echo 'deb http://deb.debian.org/debian stretch-backports main' >> /etc/apt/sources.list.d/pgdg.list; 					;; 			esac; 						tempDir="$(mktemp -d)"; 			cd "$tempDir"; 						savedAptMark="$(apt-mark showmanual)"; 						apt-get update; 			apt-get build-dep -y 				postgresql-common pgdg-keyring 				"postgresql-$PG_MAJOR=$PG_VERSION" 			; 			DEB_BUILD_OPTIONS="nocheck parallel=$(nproc)" 				apt-get source --compile 					postgresql-common pgdg-keyring 					"postgresql-$PG_MAJOR=$PG_VERSION" 			; 						apt-mark showmanual | xargs apt-mark auto > /dev/null; 			apt-mark manual $savedAptMark; 						ls -lAFh; 			dpkg-scanpackages . > Packages; 			grep '^Package: ' Packages; 			echo "deb [ trusted=yes ] file://$tempDir ./" > /etc/apt/sources.list.d/temp.list; 			apt-get -o Acquire::GzipIndexes=false update; 			;; 	esac; 		apt-get install -y postgresql-common; 	sed -ri 's/#(create_main_cluster) .*$/\1 = false/' /etc/postgresql-common/createcluster.conf; 	apt-get install -y 		"postgresql-$PG_MAJOR=$PG_VERSION" 		"postgresql-contrib-$PG_MAJOR=$PG_VERSION" 	; 		rm -rf /var/lib/apt/lists/*; 		if [ -n "$tempDir" ]; then 		apt-get purge -y --auto-remove; 		rm -rf "$tempDir" /etc/apt/sources.list.d/temp.list; 	fi; 		find /usr -name '*.pyc' -type f -exec bash -c 'for pyc; do dpkg -S "$pyc" &> /dev/null || rm -vf "$pyc"; done' -- '{}' +
# Fri, 14 Feb 2020 18:59:02 GMT
RUN set -eux; 	dpkg-divert --add --rename --divert "/usr/share/postgresql/postgresql.conf.sample.dpkg" "/usr/share/postgresql/$PG_MAJOR/postgresql.conf.sample"; 	cp -v /usr/share/postgresql/postgresql.conf.sample.dpkg /usr/share/postgresql/postgresql.conf.sample; 	ln -sv ../postgresql.conf.sample "/usr/share/postgresql/$PG_MAJOR/"; 	sed -ri "s!^#?(listen_addresses)\s*=\s*\S+.*!\1 = '*'!" /usr/share/postgresql/postgresql.conf.sample; 	grep -F "listen_addresses = '*'" /usr/share/postgresql/postgresql.conf.sample
# Fri, 14 Feb 2020 18:59:04 GMT
RUN mkdir -p /var/run/postgresql && chown -R postgres:postgres /var/run/postgresql && chmod 2777 /var/run/postgresql
# Fri, 14 Feb 2020 18:59:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/postgresql/9.4/bin
# Fri, 14 Feb 2020 18:59:05 GMT
ENV PGDATA=/var/lib/postgresql/data
# Fri, 14 Feb 2020 18:59:07 GMT
RUN mkdir -p "$PGDATA" && chown -R postgres:postgres "$PGDATA" && chmod 777 "$PGDATA"
# Fri, 14 Feb 2020 18:59:08 GMT
VOLUME [/var/lib/postgresql/data]
# Fri, 14 Feb 2020 18:59:08 GMT
COPY file:48ec3c31f4d1f69699aa0f0d4223e3729e247909adfcf5f4ea33735737ebe574 in /usr/local/bin/ 
# Fri, 14 Feb 2020 18:59:10 GMT
RUN ln -s usr/local/bin/docker-entrypoint.sh / # backwards compat
# Fri, 14 Feb 2020 18:59:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 14 Feb 2020 18:59:12 GMT
EXPOSE 5432
# Fri, 14 Feb 2020 18:59:12 GMT
CMD ["postgres"]
```
...
-	Layers:
	...
	-	`sha256:4ffc1bb55d92f21306a95cb3259eec2a3f3659245aeebb728d6698b7be3381b8`  
		...
		Size: 4.8 KB (4790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c45a3c0fd68f104ea27d61d2b0f63c0bfc76e7341b202b3362f77bd1eaaaa872`  
		Last Modified: Fri, 14 Feb 2020 19:09:29 GMT  
		Size: 54.0 MB (54043626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffdbab38458795d788d49eb35b149afafbe6f85f96c063de27174444ccb9eff8`  
		Last Modified: Fri, 14 Feb 2020 19:09:19 GMT  
		Size: 7.3 KB (7350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:070d5b13d00b7cdb8a762d08a4012f646e8e217317af581599ee5482b43165d1`  
		Last Modified: Fri, 14 Feb 2020 19:09:34 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:958295d9ea46001d1feac8e2d73ba9b7642fa326a6fda21e605c9000128a99c3`  
		Last Modified: Fri, 14 Feb 2020 19:09:34 GMT  
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a7fadac3927d0017b470da29f70b02bca5ab5a14176a07782fc31eb657ff219`  
		Last Modified: Fri, 14 Feb 2020 19:09:34 GMT  
		Size: 4.2 KB (4193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7d0fb4fe6efff62c09ff976a100210840929dc5919ed4bbc19a744f6a3f8b9a`  
		Last Modified: Fri, 14 Feb 2020 19:09:19 GMT  
		Size: 121.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
