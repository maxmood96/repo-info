...
```console
$ docker pull postgres@sha256:4ec37d2a07a0067f176fdcc9d4bb633a5724d2cc4f892c7a2046d054bb6939e5
```
...
### `postgres:17.0-bookworm` - linux; arm variant v5
...
### `postgres:17.0-bookworm` - linux; arm variant v7
...
### `postgres:17.0-bookworm` - linux; arm64 variant v8
