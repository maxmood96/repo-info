...
```console
$ docker pull postgres@sha256:41e86430178ac92bfc7e5914b2dd1da39808866ca4b8bc3fc150d160531fff75
```
...
### `postgres:13.15` - unknown; unknown
...
### `postgres:13.15` - linux; arm variant v5
...
### `postgres:13.15` - linux; arm variant v7
...
### `postgres:13.15` - linux; arm64 variant v8
