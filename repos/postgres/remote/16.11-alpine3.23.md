...
```console
$ docker pull postgres@sha256:67541035eba109ceaf7719a6a334985aa23e0aa9368bd047818635cad1ca4678
```
...
### `postgres:16.11-alpine3.23` - linux; amd64
...
### `postgres:16.11-alpine3.23` - unknown; unknown
...
### `postgres:16.11-alpine3.23` - linux; arm variant v6
...
### `postgres:16.11-alpine3.23` - linux; arm variant v7
...
### `postgres:16.11-alpine3.23` - linux; arm64 variant v8
...
### `postgres:16.11-alpine3.23` - linux; 386
...
### `postgres:16.11-alpine3.23` - linux; ppc64le
...
### `postgres:16.11-alpine3.23` - linux; s390x
