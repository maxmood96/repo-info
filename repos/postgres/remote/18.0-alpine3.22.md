...
```console
$ docker pull postgres@sha256:c7e04f47c2e59dd0b64ac0d2cad90485d5cef0f8ebab1fa606067afa15b044fb
```
...
### `postgres:18.0-alpine3.22` - linux; amd64
...
### `postgres:18.0-alpine3.22` - unknown; unknown
...
### `postgres:18.0-alpine3.22` - linux; arm variant v6
...
### `postgres:18.0-alpine3.22` - linux; arm variant v7
...
### `postgres:18.0-alpine3.22` - linux; arm64 variant v8
...
### `postgres:18.0-alpine3.22` - linux; 386
...
### `postgres:18.0-alpine3.22` - linux; ppc64le
...
### `postgres:18.0-alpine3.22` - linux; riscv64
...
### `postgres:18.0-alpine3.22` - linux; s390x
