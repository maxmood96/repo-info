...
### `postgres:15.9-alpine3.19` - linux; amd64
...
### `postgres:15.9-alpine3.19` - unknown; unknown
...
### `postgres:15.9-alpine3.19` - linux; arm variant v6
...
### `postgres:15.9-alpine3.19` - linux; arm variant v7
...
### `postgres:15.9-alpine3.19` - linux; arm64 variant v8
...
### `postgres:15.9-alpine3.19` - linux; 386
...
### `postgres:15.9-alpine3.19` - linux; ppc64le
...
### `postgres:15.9-alpine3.19` - linux; s390x
