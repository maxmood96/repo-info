...
### `postgres:12.18-alpine` - linux; arm variant v7
...
### `postgres:12.18-alpine` - linux; arm64 variant v8
...
### `postgres:12.18-alpine` - linux; ppc64le
...
### `postgres:12.18-alpine` - linux; s390x
