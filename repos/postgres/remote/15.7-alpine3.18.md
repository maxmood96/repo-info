...
```console
$ docker pull postgres@sha256:88ea5693afbd45f17a717477db6b0c15235c828697237d9b1d36f76c76b255ec
```
...
### `postgres:15.7-alpine3.18` - linux; amd64
...
### `postgres:15.7-alpine3.18` - unknown; unknown
...
### `postgres:15.7-alpine3.18` - linux; arm variant v6
...
### `postgres:15.7-alpine3.18` - linux; arm64 variant v8
...
### `postgres:15.7-alpine3.18` - linux; 386
...
### `postgres:15.7-alpine3.18` - linux; ppc64le
...
### `postgres:15.7-alpine3.18` - linux; s390x
