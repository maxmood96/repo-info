...
### `postgres:15.17-alpine` - linux; amd64
...
### `postgres:15.17-alpine` - unknown; unknown
...
### `postgres:15.17-alpine` - linux; arm variant v6
...
### `postgres:15.17-alpine` - linux; arm variant v7
...
### `postgres:15.17-alpine` - linux; arm64 variant v8
...
### `postgres:15.17-alpine` - linux; 386
...
### `postgres:15.17-alpine` - linux; ppc64le
...
### `postgres:15.17-alpine` - linux; riscv64
...
### `postgres:15.17-alpine` - linux; s390x
