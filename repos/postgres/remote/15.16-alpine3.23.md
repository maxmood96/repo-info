...
```console
$ docker pull postgres@sha256:c06659f9d93e43c5a3f2685674b4159b10934d4081f0ee4617e8fb7c413f3fd3
```
...
### `postgres:15.16-alpine3.23` - linux; amd64
...
### `postgres:15.16-alpine3.23` - unknown; unknown
...
### `postgres:15.16-alpine3.23` - linux; arm variant v6
...
### `postgres:15.16-alpine3.23` - linux; arm variant v7
...
### `postgres:15.16-alpine3.23` - linux; arm64 variant v8
...
### `postgres:15.16-alpine3.23` - linux; 386
...
### `postgres:15.16-alpine3.23` - linux; ppc64le
...
### `postgres:15.16-alpine3.23` - linux; s390x
