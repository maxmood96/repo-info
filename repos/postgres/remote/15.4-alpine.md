...
```console
$ docker pull postgres@sha256:3e9aae393f97c48961b1541f5f39452bf29f033ac014b7736426263c0acb95be
```
...
### `postgres:15.4-alpine` - linux; amd64
...
### `postgres:15.4-alpine` - unknown; unknown
...
### `postgres:15.4-alpine` - linux; arm variant v6
...
### `postgres:15.4-alpine` - linux; arm variant v7
...
### `postgres:15.4-alpine` - linux; arm64 variant v8
...
### `postgres:15.4-alpine` - linux; 386
...
### `postgres:15.4-alpine` - linux; ppc64le
...
### `postgres:15.4-alpine` - linux; s390x
