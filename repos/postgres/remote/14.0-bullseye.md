...
### `postgres:14.0-bullseye` - linux; arm variant v5
...
### `postgres:14.0-bullseye` - linux; arm variant v7
...
### `postgres:14.0-bullseye` - linux; 386
...
### `postgres:14.0-bullseye` - linux; mips64le
...
### `postgres:14.0-bullseye` - linux; ppc64le
