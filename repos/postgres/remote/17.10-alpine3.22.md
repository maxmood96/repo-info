...
```console
$ docker pull postgres@sha256:7f0d4007abf66e515c347b7c992d8ac2ab99144ac5add6953317a6c222217636
```
...
### `postgres:17.10-alpine3.22` - linux; amd64
...
### `postgres:17.10-alpine3.22` - unknown; unknown
...
### `postgres:17.10-alpine3.22` - linux; arm variant v6
...
### `postgres:17.10-alpine3.22` - linux; arm variant v7
...
### `postgres:17.10-alpine3.22` - linux; arm64 variant v8
...
### `postgres:17.10-alpine3.22` - linux; 386
...
### `postgres:17.10-alpine3.22` - linux; ppc64le
...
### `postgres:17.10-alpine3.22` - linux; s390x
