...
### `postgres:17.3-bookworm` - linux; amd64
...
### `postgres:17.3-bookworm` - unknown; unknown
...
### `postgres:17.3-bookworm` - linux; arm variant v5
...
### `postgres:17.3-bookworm` - linux; arm variant v7
...
### `postgres:17.3-bookworm` - linux; arm64 variant v8
...
### `postgres:17.3-bookworm` - linux; 386
...
### `postgres:17.3-bookworm` - linux; mips64le
...
### `postgres:17.3-bookworm` - linux; ppc64le
...
### `postgres:17.3-bookworm` - linux; s390x
