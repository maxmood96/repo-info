...
### `postgres:14.3-alpine3.15` - linux; arm variant v6
...
### `postgres:14.3-alpine3.15` - linux; arm64 variant v8
...
### `postgres:14.3-alpine3.15` - linux; 386
...
### `postgres:14.3-alpine3.15` - linux; ppc64le
...
### `postgres:14.3-alpine3.15` - linux; s390x
