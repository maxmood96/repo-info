...
### `postgres:13.15-alpine` - linux; amd64
...
### `postgres:13.15-alpine` - linux; arm variant v7
...
### `postgres:13.15-alpine` - linux; arm64 variant v8
...
### `postgres:13.15-alpine` - linux; ppc64le
...
### `postgres:13.15-alpine` - linux; riscv64
