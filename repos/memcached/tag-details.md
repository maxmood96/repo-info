...
### `memcached:1.6.9-alpine3.13` - linux; amd64
...
### `memcached:1.6.9-alpine3.13` - linux; arm64 variant v8
...
### `memcached:1.6.9-alpine3.13` - linux; 386
...
### `memcached:1.6.9-alpine3.13` - linux; ppc64le
...
### `memcached:1.6.9-alpine3.13` - linux; s390x
