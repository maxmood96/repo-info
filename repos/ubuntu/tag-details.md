...
```console
$ docker pull ubuntu@sha256:b6ec12b8345cdc0714add139b17803301aec077509820faf970a1dab0a7fce78
```
...
```console
$ docker pull ubuntu@sha256:d7a74ae15f4eab49edfb65503f3bf94c5fa47cd94809c11cb36ffbb8eeb74028
```
