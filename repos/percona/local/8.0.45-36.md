...
- Created: `2026-04-22T18:15:46.961468141Z`
...
### `rpm` package: `libatomic-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libatomic-11.5.0-11.el9
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libssh-0.10.4-17.el9_7.src.rpm
```
...
### `rpm` package: `openssl-devel-3.5.1-7.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-3.5.1-7.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssl-3.5.1-7.el9_7.src.rpm
```
