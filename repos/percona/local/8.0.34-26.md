...
- Created: `2023-12-14T23:40:03.600184625Z`
...
- Environment:
  ...
  - `PS_VERSION=8.0.34-26.1`
  - `MYSQL_SHELL_VERSION=8.0.34-1`
  - `OS_VER=el9`
  - `FULL_PERCONA_VERSION=8.0.34-26.1.el9`
  - `FULL_MYSQL_SHELL_VERSION=8.0.34-1.el9`
  - `PS_REPO=release`
- Labels:
...
### `rpm` package: `chkconfig-1.24-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.24-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/chkconfig-1.24-1.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/chkconfig-1.24-1.0.1.el9.src.rpm
```
...
### `rpm` package: `curl-7.76.1-26.el9_3.2.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-26.el9_3.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-26.el9_3.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-26.el9_3.2.src.rpm
```
...
### `rpm` package: `dbus-libs-1.12.20-8.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.20-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dbus-1.12.20-8.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dbus-1.12.20-8.0.1.el9.src.rpm
```

### `rpm` package: `dhcp-client-4.4.2-19.b1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-client-4.4.2-19.b1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-19.b1.el9.src.rpm
```

### `rpm` package: `dhcp-common-4.4.2-19.b1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.4.2-19.b1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-19.b1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-8.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-8.0.1.el9.noarch
...
### `rpm` package: `dnf-plugins-core-4.3.0-11.0.1.el9_3.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-11.0.1.el9_3.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
```
...
### `rpm` package: `glibc-2.34-83.0.1.el9_3.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-83.0.1.el9_3.7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
```

### `rpm` package: `glibc-common-2.34-83.0.1.el9_3.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-83.0.1.el9_3.7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.34-83.0.1.el9_3.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-83.0.1.el9_3.7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-83.0.1.el9_3.7.src.rpm
```
...
```console
$ dnf --quiet download --source --url gnutls-3.7.6-23.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.7.6-23.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.7.6-23.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url iproute-6.2.0-5.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-6.2.0-5.el9.src.rpm
```

### `rpm` package: `iputils-20210202-9.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-9.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-9.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-9.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libbpf-1.2.0-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-1.2.0-1.el9.src.rpm
```
...
### `rpm` package: `libcurl-7.76.1-26.el9_3.2.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-26.el9_3.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-26.el9_3.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-26.el9_3.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libedit-3.1-38.20210216cvs.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libedit-3.1-38.20210216cvs.el9.src.rpm
```
...
### `rpm` package: `libfastjson-0.99.9-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libfastjson-0.99.9-5.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libfastjson-0.99.9-5.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libfdisk-2.37.4-15.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libfido2-1.13.0-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libfido2-1.13.0-1.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.4.1-2.1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.4.1-2.1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.4.1-2.1.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.4.1-2.1.0.1.el9.src.rpm
```
...
### `rpm` package: `libtirpc-1.3.3-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libtirpc-1.3.3-2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libtirpc-1.3.3-2.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libuser-0.63-13.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-13.el9.src.rpm
```
...
### `rpm` package: `numactl-libs-2.0.16-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url numactl-libs-2.0.16-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/numactl-2.0.16-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/numactl-2.0.16-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-34.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-34.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-34.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-34.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-34.el9.src.rpm
```

### `rpm` package: `openssl-3.0.7-24.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.0.7-24.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
```

### `rpm` package: `openssl-devel-3.0.7-24.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-3.0.7-24.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
```

### `rpm` package: `openssl-libs-3.0.7-24.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.0.7-24.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-24.0.1.el9.src.rpm
```
...
### `rpm` package: `oraclelinux-release-el9-1.0-12.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-12.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-12.el9.src.rpm
```
...
### `rpm` package: `percona-icu-data-files-8.0.34-26.1.el9.x86_64`
...
### `rpm` package: `percona-mysql-shell-8.0.34-1.el9.x86_64`
...
### `rpm` package: `percona-server-client-8.0.34-26.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-devel-8.0.34-26.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-rocksdb-8.0.34-26.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-server-8.0.34-26.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-shared-8.0.34-26.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-HTTP-Tiny-0.076-461.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-HTTP-Tiny-0.076-461.el9.src.rpm
```
...
### `rpm` package: `policycoreutils-3.5-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url policycoreutils-3.5-2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/policycoreutils-3.5-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/policycoreutils-3.5-2.el9.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.17-13.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.17-13.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.17-13.0.1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-3.9.18-1.el9_3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-1.el9_3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-1.el9_3.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-dateutil-2.8.1-7.el9.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-8.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-8.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-8.0.1.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-11.0.1.el9_3.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-11.0.1.el9_3.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-6.0.1.el9_3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-6.0.1.el9_3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-6.0.1.el9_3.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-6.0.1.el9_3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-6.0.1.el9_3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-6.0.1.el9_3.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.18-1.el9_3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-1.el9_3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-1.el9_3.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-pip-wheel-21.2.3-7.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-pip-21.2.3-7.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python-pip-21.2.3-7.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-25.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-4.16.1.3-25.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-25.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-libs-4.16.1.3-25.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-25.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-25.el9.src.rpm
```

### `rpm` package: `rsyslog-8.2102.0-117.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-117.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-117.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tpm2-tss-3.2.2-2.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url util-linux-2.37.4-15.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url util-linux-core-2.37.4-15.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-15.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/which-2.21-29.el9.src.rpm
```
...
### `rpm` package: `yum-4.14.0-8.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-8.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-8.0.1.el9.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-11.0.1.el9_3.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-11.0.1.el9_3.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-11.0.1.el9_3.src.rpm
```
