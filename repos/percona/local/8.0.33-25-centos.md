...
- Created: `2023-06-21T19:28:20.940715077Z`
...
- Environment:
  ...
  - `PS_VERSION=8.0.33-25.1`
  - `MYSQL_SHELL_VERSION=8.0.33-1`
  - `OS_VER=el9`
  - `FULL_PERCONA_VERSION=8.0.33-25.1.el9`
  - `FULL_MYSQL_SHELL_VERSION=8.0.33-1.el9`
  - `PS_REPO=testing`
- Labels:
...
### `rpm` package: `coreutils-8.32-34.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-34.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-34.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/crypto-policies-20221215-1.git9a18988.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-23.el9_2.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-23.el9_2.1.src.rpm
```
...
### `rpm` package: `dhcp-client-4.4.2-18.b1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-client-4.4.2-18.b1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-18.b1.el9.src.rpm
```

### `rpm` package: `dhcp-common-4.4.2-18.b1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.4.2-18.b1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dhcp-4.4.2-18.b1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-5.0.1.el9_2.src.rpm
```

### `rpm` package: `dnf-data-4.14.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.14.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-5.0.1.el9_2.src.rpm
```

### `rpm` package: `dnf-plugins-core-4.3.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.188-3.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-libelf-0.188-3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.188-3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.188-3.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/file-5.39-12.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/file-5.39-12.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url gflags-2.2.2-9.el9
https://yum.oracle.com/repo/OracleLinux/OL9/developer/EPEL/x86_64/getPackageSource/gflags-2.2.2-9.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-6.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-6.el9.src.rpm
```

### `rpm` package: `glibc-2.34-60.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-60.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
```

### `rpm` package: `glibc-common-2.34-60.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-60.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
```

### `rpm` package: `glibc-langpack-en-2.34-60.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-60.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-60.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.7.6-20.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.7.6-20.el9_2.src.rpm
```
...
### `rpm` package: `iproute-6.1.0-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-6.1.0-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-6.1.0-1.el9.src.rpm
```

### `rpm` package: `iputils-20210202-8.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-8.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-8.0.1.el9.src.rpm
```
...
### `rpm` package: `krb5-libs-1.20.1-8.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.20.1-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/krb5-1.20.1-8.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/krb5-1.20.1-8.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-11.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-11.el9_2.src.rpm
```

### `rpm` package: `libbpf-1.0.0-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libbpf-1.0.0-2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-1.0.0-2.el9.src.rpm
```
...
### `rpm` package: `libdnf-0.69.0-3.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-3.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-3.0.1.el9_2.src.rpm
```
...
### `rpm` package: `libgcc-11.3.1-4.3.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-11.3.1-4.3.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.3.1-4.3.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.3.1-4.3.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pkgconf-1.7.3-10.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pkgconf-1.7.3-10.el9.src.rpm
```
...
### `rpm` package: `libselinux-utils-3.5-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-utils-3.5-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libselinux-3.5-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libselinux-3.5-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsemanage-3.5-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsemanage-3.5-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsolv-0.7.22-4.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsolv-0.7.22-4.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libssh-0.10.4-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libssh-0.10.4-8.el9.src.rpm
```
...
### `rpm` package: `libstdc++-11.3.1-4.3.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-11.3.1-4.3.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.3.1-4.3.0.1.el9.src.rpm
```
...
### `rpm` package: `libtirpc-1.3.3-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libtirpc-1.3.3-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libtirpc-1.3.3-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libuser-0.63-12.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-12.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/lua-5.4.4-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/lua-5.4.4-3.el9.src.rpm
```
...
### `rpm` package: `numactl-libs-2.0.14-9.el9.x86_64`
...
```console
$ dnf --quiet download --source --url numactl-libs-2.0.14-9.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/numactl-2.0.14-9.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/numactl-2.0.14-9.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-29.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-29.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-29.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-29.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-29.el9_2.src.rpm
```

### `rpm` package: `openssl-3.0.7-6.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.0.7-6.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
```

### `rpm` package: `openssl-devel-3.0.7-6.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-3.0.7-6.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
```

### `rpm` package: `openssl-libs-3.0.7-6.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.0.7-6.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.0.7-6.0.1.el9_2.src.rpm
```
...
### `rpm` package: `oraclelinux-release-9.2-1.0.9.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.2-1.0.9.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.2-1.0.9.el9.src.rpm
```

### `rpm` package: `oraclelinux-release-el9-1.0-10.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-10.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-10.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-14.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-14.el9.src.rpm
```
...
### `rpm` package: `percona-icu-data-files-8.0.33-25.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-mysql-shell-8.0.33-1.el9.x86_64`
...
### `rpm` package: `percona-server-client-8.0.33-25.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-devel-8.0.33-25.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-rocksdb-8.0.33-25.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-server-8.0.33-25.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2023, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-shared-8.0.33-25.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-AutoLoader-5.74-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-B-1.80-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Class-Struct-0.66-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Errno-1.30-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Fcntl-1.13-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-File-Basename-2.85-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-File-stat-1.09-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-FileHandle-2.03-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Getopt-Std-1.12-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-IO-1.43-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-IPC-Open3-1.21-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-NDBM_File-1.15-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-POSIX-1.94-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-SelectSaver-1.02-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Symbol-1.08-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-base-2.27-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-if-0.60.800-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-interpreter-5.32.1-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-libs-5.32.1-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-mro-1.23-480.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-overload-1.31-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-overloading-0.02-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-subs-1.03-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-vars-1.05-480.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-5.32.1-480.el9.src.rpm
```
...
### `rpm` package: `policycoreutils-3.5-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url policycoreutils-3.5-1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/policycoreutils-3.5-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/policycoreutils-3.5-1.el9.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.17-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.17-11.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.17-11.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-3.9.16-1.el9_2.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.16-1.el9_2.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.16-1.el9_2.1.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-5.0.1.el9_2.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-3.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-3.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-3.0.1.el9_2.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-3.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-3.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-3.0.1.el9_2.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.16-1.el9_2.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.16-1.el9_2.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.16-1.el9_2.1.src.rpm
```
...
### `rpm` package: `python3-rpm-4.16.1.3-22.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-22.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-systemd-234-18.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-systemd-234-18.el9.src.rpm
```
...
### `rpm` package: `redhat-release-9.2-0.13.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url redhat-release-9.2-0.13.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/redhat-release-9.2-0.13.0.1.el9.src.rpm
```
...
### `rpm` package: `rpm-4.16.1.3-22.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.16.1.3-22.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
```

### `rpm` package: `rpm-build-libs-4.16.1.3-22.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-22.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
```

### `rpm` package: `rpm-libs-4.16.1.3-22.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.16.1.3-22.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
```

### `rpm` package: `rpm-sign-libs-4.16.1.3-22.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-22.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-22.0.1.el9.src.rpm
```

### `rpm` package: `rsyslog-8.2102.0-113.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-113.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-113.el9_2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/shadow-utils-4.9-6.el9.src.rpm
```
...
### `rpm` package: `systemd-252-13.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-13.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
```

### `rpm` package: `systemd-libs-252-13.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-13.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
```

### `rpm` package: `systemd-pam-252-13.0.1.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-13.0.1.el9_2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-13.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-13.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-13.0.1.el9_2.src.rpm
```
...
### `rpm` package: `yum-4.14.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-5.0.1.el9_2.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-5.0.1.el9_2.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-5.0.1.el9_2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-5.0.1.el9_2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-39.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/zlib-1.2.11-39.el9.src.rpm
```
