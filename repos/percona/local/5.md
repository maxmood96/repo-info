...
- Created: `2024-06-07T04:59:31.138876367Z`
- Virtual Size: ~ 973.84 Mb  
...
### `rpm` package: `Percona-Server-client-57-5.7.44-48.1.el8.x86_64`
...
### `rpm` package: `Percona-Server-devel-57-5.7.44-48.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-rocksdb-57-5.7.44-48.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-server-57-5.7.44-48.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-57-5.7.44-48.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-shared-compat-57-5.7.44-48.1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2015, Oracle and/or its affiliates. All rights reserved. Under the GNU General Public License (http://www.gnu.org/licenses/).

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `Percona-Server-tokudb-57-5.7.44-48.1.el8.x86_64`
...
### `rpm` package: `krb5-devel-1.18.2-27.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-devel-1.18.2-27.0.1.el8_10
...
### `rpm` package: `libkadm5-1.18.2-27.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libkadm5-1.18.2-27.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-27.0.1.el8_10.src.rpm
```
...
### `rpm` package: `openssl-devel-1.1.1k-12.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-1.1.1k-12.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-12.el8_9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-Digest-1.17-395.el8.src.rpm
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-Digest-MD5-2.55-396.el8.src.rpm
...
### `rpm` package: `perl-HTTP-Tiny-0.074-3.el8.noarch`
...
```console
$ dnf --quiet download --source --url perl-HTTP-Tiny-0.074-3.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-HTTP-Tiny-0.074-3.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-IO-Socket-IP-0.39-5.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-URI-1.73-3.el8.src.rpm
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-libnet-3.11-3.el8.src.rpm
```
...
### `rpm` package: `policycoreutils-python-utils-2.9-25.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url policycoreutils-python-utils-2.9-25.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/policycoreutils-2.9-25.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/policycoreutils-2.9-25.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-audit-3.1.2-1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-audit-3.1.2-1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.1.2-1.el8.src.rpm
```
...
### `rpm` package: `python3-policycoreutils-2.9-25.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-policycoreutils-2.9-25.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/policycoreutils-2.9-25.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/policycoreutils-2.9-25.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-setools-4.3.0-5.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-setools-4.3.0-5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/setools-4.3.0-5.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/setools-4.3.0-5.el8.src.rpm
```
...
### `rpm` package: `rpm-plugin-selinux-4.14.3-31.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-plugin-selinux-4.14.3-31.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
```
...
### `rpm` package: `selinux-policy-3.14.3-139.0.1.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-3.14.3-139.0.1.el8_10.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-139.0.1.el8_10.src.rpm
```

### `rpm` package: `selinux-policy-minimum-3.14.3-139.0.1.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-minimum-3.14.3-139.0.1.el8_10.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-139.0.1.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url which-2.21-20.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/which-2.21-20.el8.src.rpm
```
...
### `rpm` package: `zlib-devel-1.2.11-25.el8.x86_64`
...
```console
$ dnf --quiet download --source --url zlib-devel-1.2.11-25.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-25.el8.src.rpm
```
