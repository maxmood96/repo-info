...
- Image ID: `sha256:c71329f918c7bd142ef80ee0ddb78b04b119d4f6dda91f4b5afe0605e88cf25a`
- Created: `2025-08-01T11:26:55Z`
...
- Environment:
  ...
  - `container=oci`
  - `PSMDB_VERSION=7.0.22-12`
  - `OS_VER=el9`
  - `FULL_PERCONA_VERSION=7.0.22-12.el9`
...
### `rpm` package: `logrotate-3.18.0-9.el9.x86_64`
...
```console
$ dnf --quiet download --source --url logrotate-3.18.0-9.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/logrotate-3.18.0-9.el9.src.rpm
```
...
### `rpm` package: `percona-release-1.0-31.noarch`

Licenses (from `rpm --query`): GPL-3.0+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-mongos-7.0.22-12.el9.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-7.0.22-12.el9.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-tools-7.0.22-12.el9.x86_64`
