...
- Created: `2024-04-05T19:46:52.883911963Z`
- Virtual Size: ~ 957.80 Mb  
...
### `rpm` package: `krb5-devel-1.18.2-26.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-devel-1.18.2-26.0.1.el8_9
...
### `rpm` package: `libkadm5-1.18.2-26.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url libkadm5-1.18.2-26.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-26.0.1.el8_9.src.rpm
```
...
### `rpm` package: `perl-HTTP-Tiny-0.074-2.el8_9.1.noarch`
...
```console
$ dnf --quiet download --source --url perl-HTTP-Tiny-0.074-2.el8_9.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/perl-HTTP-Tiny-0.074-2.el8_9.1.src.rpm
```
...
### `rpm` package: `python3-audit-3.0.7-5.el8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-audit-3.0.7-5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.0.7-5.el8.src.rpm
```
...
### `rpm` package: `rpm-plugin-selinux-4.14.3-28.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-plugin-selinux-4.14.3-28.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
```
...
### `rpm` package: `selinux-policy-3.14.3-128.0.4.el8_9.1.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-3.14.3-128.0.4.el8_9.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-128.0.4.el8_9.1.src.rpm
```

### `rpm` package: `selinux-policy-minimum-3.14.3-128.0.4.el8_9.1.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-minimum-3.14.3-128.0.4.el8_9.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/selinux-policy-3.14.3-128.0.4.el8_9.1.src.rpm
```
