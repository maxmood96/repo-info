...
- Environment:
  ...
  - `PS_VERSION=8.0.39-30.1`
  - `MYSQL_SHELL_VERSION=8.0.38-1`
  - `OS_VER=el9`
  - `FULL_PERCONA_VERSION=8.0.39-30.1.el9`
  - `FULL_MYSQL_SHELL_VERSION=8.0.38-1.el9`
  - `PS_REPO=testing`
  - `PS_TELEMETRY_VERSION=8.0.39-30-1`
...
### `rpm` package: `chkconfig-1.24-1.0.2.el9_5.1.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.24-1.0.2.el9_5.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/chkconfig-1.24-1.0.2.el9_5.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/chkconfig-1.24-1.0.2.el9_5.1.src.rpm
```

### `rpm` package: `coreutils-8.32-36.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-36.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-36.0.1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-17.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-17.0.1.el9.noarch
...
### `rpm` package: `dnf-plugins-core-4.3.0-16.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-16.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-125.0.1.el9_5.1.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-125.0.1.el9_5.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-125.0.1.el9_5.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-125.0.1.el9_5.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ima-evm-utils-1.5-2.el9.src.rpm
```

### `rpm` package: `initscripts-10.11.7-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-10.11.7-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.7-1.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-rename-device-10.11.7-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-rename-device-10.11.7-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.7-1.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-service-10.11.7-1.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url initscripts-service-10.11.7-1.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.7-1.0.1.el9.src.rpm
```
...
### `rpm` package: `libatomic-11.5.0-2.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libatomic-11.5.0-2.0.1.el9
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-1.4.0-1.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-2.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-2.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-2.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-2.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-15.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/logrotate-3.18.0-8.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/net-tools-2.0-0.64.20160912git.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/numactl-2.0.18-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/numactl-2.0.18-2.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-43.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-43.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-43.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-43.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-43.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-43.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-43.0.1.el9.src.rpm
```
...
### `rpm` package: `openssl-devel-3.2.2-6.0.1.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-3.2.2-6.0.1.el9_5
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.2.2-6.0.1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.2.2-6.0.1.el9_5.src.rpm
```
...
### `rpm` package: `percona-icu-data-files-8.0.39-30.1.el9.x86_64`
...
### `rpm` package: `percona-mysql-shell-8.0.38-1.el9.x86_64`
...
### `rpm` package: `percona-server-client-8.0.39-30.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-devel-8.0.39-30.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-rocksdb-8.0.39-30.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-server-8.0.39-30.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-shared-8.0.39-30.1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. All rights reserved. Under GPLv2 license as shown in the Description field..

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-telemetry-agent-1.0.3-1.el9.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-IO-Socket-SSL-2.073-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-Net-SSLeay-1.94-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/perl-Scalar-List-Utils-1.56-462.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.21-1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.21-1.el9_5.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-17.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-17.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-17.0.1.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-16.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-16.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-12.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-12.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-12.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-12.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-12.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-12.0.1.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-21.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-21.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-21.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-21.0.1.el9.src.rpm
```
...
### `rpm` package: `yum-4.14.0-17.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-17.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-17.0.1.el9.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-16.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-16.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-16.0.1.el9.src.rpm
```
