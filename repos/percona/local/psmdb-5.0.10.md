...
- Created: `2022-10-12T21:49:23.875246926Z`
- Virtual Size: ~ 540.00 Mb  
...
### `rpm` package: `bind-export-libs-9.11.36-3.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.36-3.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/bind-9.11.36-3.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/bind-9.11.36-3.el8_6.1.src.rpm
```
...
### `rpm` package: `coreutils-8.30-12.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.30-12.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/coreutils-8.30-12.0.1.el8.src.rpm
```
...
### `rpm` package: `dbus-1.12.8-18.0.1.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-1.12.8-18.0.1.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
```

### `rpm` package: `dbus-common-1.12.8-18.0.1.el8_6.1.noarch`
...
```console
$ dnf --quiet download --source --url dbus-common-1.12.8-18.0.1.el8_6.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
```

### `rpm` package: `dbus-daemon-1.12.8-18.0.1.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-daemon-1.12.8-18.0.1.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
```
...
### `rpm` package: `dbus-libs-1.12.8-18.0.1.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.8-18.0.1.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
```

### `rpm` package: `dbus-tools-1.12.8-18.0.1.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-tools-1.12.8-18.0.1.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-18.0.1.el8_6.1.src.rpm
```

### `rpm` package: `device-mapper-1.02.181-3.el8_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-1.02.181-3.el8_6.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-3.el8_6.2.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.181-3.el8_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-libs-1.02.181-3.el8_6.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-3.el8_6.2.src.rpm
```

### `rpm` package: `dhcp-client-4.3.6-47.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-client-4.3.6-47.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dhcp-4.3.6-47.0.1.el8.src.rpm
```

### `rpm` package: `dhcp-common-4.3.6-47.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.3.6-47.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dhcp-4.3.6-47.0.1.el8.src.rpm
```

### `rpm` package: `dhcp-libs-4.3.6-47.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-libs-4.3.6-47.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dhcp-4.3.6-47.0.1.el8.src.rpm
```
...
### `rpm` package: `dnf-4.7.0-8.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.7.0-8.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-8.0.1.el8.src.rpm
```

### `rpm` package: `dnf-data-4.7.0-8.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.7.0-8.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-8.0.1.el8.src.rpm
```

### `rpm` package: `dnf-plugins-core-4.0.21-11.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.0.21-11.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.186-1.el8.noarch
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.186-1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/elfutils-0.186-1.el8.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.28-189.5.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.28-189.5.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-189.5.0.1.el8_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-189.5.0.1.el8_6.src.rpm
```
...
### `rpm` package: `initscripts-10.00.17-1.el8_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-10.00.17-1.el8_6.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/initscripts-10.00.17-1.el8_6.2.src.rpm
```
...
### `rpm` package: `iproute-5.15.0-4.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-5.15.0-4.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/iproute-5.15.0-4.el8_6.1.src.rpm
```
...
```console
$ dnf --quiet download --source --url iputils-20180629-9.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/iputils-20180629-9.el8.src.rpm
```
...
### `rpm` package: `kmod-libs-25-19.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url kmod-libs-25-19.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/kmod-25-19.0.1.el8.src.rpm
```
...
### `rpm` package: `libbpf-0.4.0-3.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libbpf-0.4.0-3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libbpf-0.4.0-3.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url libestr-0.1.10-1.el8
...
### `rpm` package: `libselinux-utils-2.9-5.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-utils-2.9-5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-5.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-5.el8.src.rpm
```
...
### `rpm` package: `openssh-server-8.0p1-13.el8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.0p1-13.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssh-8.0p1-13.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/openssh-8.0p1-13.el8.src.rpm
```
...
### `rpm` package: `platform-python-3.6.8-47.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url platform-python-3.6.8-47.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-47.0.1.el8_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-47.0.1.el8_6.src.rpm
```
...
### `rpm` package: `policycoreutils-2.9-19.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url policycoreutils-2.9-19.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/policycoreutils-2.9-19.0.2.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/policycoreutils-2.9-19.0.2.el8.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.15-6.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.15-6.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.15-6.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-dnf-4.7.0-8.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.7.0-8.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-8.0.1.el8.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.0.21-11.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.0.21-11.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.63.0-8.2.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.63.0-8.2.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-8.2.0.1.el8_6.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.63.0-8.2.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.63.0-8.2.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-8.2.0.1.el8_6.src.rpm
```

### `rpm` package: `python3-libs-3.6.8-47.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.6.8-47.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-47.0.1.el8_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-47.0.1.el8_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-rpm-4.14.3-23.el8
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.14.3-23.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-23.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-23.el8.src.rpm
```
...
### `rpm` package: `rsyslog-8.2102.0-7.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-7.el8_6.1
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-7.el8_6.1.src.rpm
```
...
### `rpm` package: `systemd-239-58.0.1.el8_6.7.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-58.0.1.el8_6.7
...
### `rpm` package: `systemd-pam-239-58.0.1.el8_6.7.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-58.0.1.el8_6.7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-58.0.1.el8_6.7.src.rpm
```
...
### `rpm` package: `tzdata-2022d-1.el8.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2022d-1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tzdata-2022d-1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/tzdata-2022d-1.el8.src.rpm
```
...
### `rpm` package: `yum-4.7.0-8.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.7.0-8.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-8.0.1.el8.src.rpm
```

### `rpm` package: `yum-utils-4.0.21-11.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.0.21-11.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-11.0.1.el8.src.rpm
```
