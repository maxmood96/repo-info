...
- Created: `2020-09-03T18:26:22.607117433Z`
- Virtual Size: ~ 452.55 Mb  
...
- Environment:
  ...
  - `PSMDB_VERSION=4.2.9-9`
  - `OS_VER=el7`
  - `FULL_PERCONA_VERSION=4.2.9-9.el7`
...
- Labels:
  ...
  - `org.label-schema.schema-version=4.2.9-9`
  ...
  - `org.opencontainers.image.version=4.2.9-9`
...
### `rpm` package: `percona-server-mongodb-mongos-4.2.9-9.el7.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-4.2.9-9.el7.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-4.2.9-9.el7.x86_64`
