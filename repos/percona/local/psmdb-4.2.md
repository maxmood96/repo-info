...
- Created: `2023-09-21T23:51:48.448531847Z`
- Virtual Size: ~ 583.96 Mb  
...
### `rpm` package: `libibverbs-44.0-2.el8.1.x86_64`
...
```console
$ dnf --quiet download --source --url libibverbs-44.0-2.el8.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rdma-core-44.0-2.el8.1.src.rpm
```
