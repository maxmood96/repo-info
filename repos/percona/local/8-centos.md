...
### `rpm` package: `libcom_err-devel-1.45.6-2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libcom_err-devel-1.45.6-2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/e2fsprogs-1.45.6-2.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/make-4.2.1-10.el8.src.rpm
```
...
### `rpm` package: `which-2.21-16.el8.x86_64`
...
```console
$ dnf --quiet download --source --url which-2.21-16.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/which-2.21-16.el8.src.rpm
```
