...
- Created: `2022-05-17T23:14:13.98425907Z`
...
```console
$ dnf --quiet download --source --url compat-openssl10-1.0.2o-3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/compat-openssl10-1.0.2o-3.el8.src.rpm
```
...
### `rpm` package: `rsyslog-8.2102.0-7.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-7.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-7.el8.src.rpm
```
