...
```console
$ docker pull cassandra@sha256:8b28e01d44d331cc2be24dde8734a10b7809375df1e5b46c7c6f88dbaf4e1c18
```
...
### `cassandra:5.0.0-jammy` - linux; amd64
...
### `cassandra:5.0.0-jammy` - unknown; unknown
...
### `cassandra:5.0.0-jammy` - linux; arm64 variant v8
...
### `cassandra:5.0.0-jammy` - linux; ppc64le
