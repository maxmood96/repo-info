...
```console
$ docker pull tomcat@sha256:1187cd4bd2bdb64d23d25e59deaa9f56ddc8b1041d9c3c7b4f74a066c2c10c7b
```
...
### `tomcat:9.0.85-jdk8-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.85-jdk8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.85-jdk8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.85-jdk8-temurin-jammy` - linux; ppc64le
