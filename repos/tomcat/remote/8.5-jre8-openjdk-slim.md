...
```console
$ docker pull tomcat@sha256:86408836230d3e8eab49b9abfe215352864d8944e3611e940380459956e4a1bc
```
...
```console
$ docker pull tomcat@sha256:5a0e6d163996ac111d94e676ba141130345a411931bc09ae56abc4ab20356375
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.2 MB (86215075 bytes)**  
...
# Tue, 12 Jul 2022 19:09:00 GMT
COPY dir:8df95790e753b441fe375193007a998e6a0de38f3e6ed8c0a5260f276f8786ab in /usr/local/tomcat 
# Tue, 12 Jul 2022 19:09:04 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 19:09:05 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 12 Jul 2022 19:09:05 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 19:09:06 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9ccb91d89c4f1d1c0f0f9b75f94db4fdfb541dfd72f32f1d90ebedf9d8f6d157`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d2717ffc3c4ce50b40202af8381a616a591032f64b784ff97b9dc1d276a9e90`  
		Last Modified: Tue, 12 Jul 2022 19:37:42 GMT  
		Size: 11.2 MB (11172038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bd81c2a10ff08276383ec6d7fab1a32fcc3edd014f6d80e4d14fac58099886b`  
		Last Modified: Tue, 12 Jul 2022 19:37:41 GMT  
		Size: 396.3 KB (396296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d476717c73b55dc1f115e1b04014d4f3bf97e023698aae9fee7bfdfe3ea45b5`  
		Last Modified: Tue, 12 Jul 2022 19:37:41 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
