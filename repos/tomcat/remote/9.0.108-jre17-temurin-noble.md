...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; amd64
...
### `tomcat:9.0.108-jre17-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; riscv64
...
### `tomcat:9.0.108-jre17-temurin-noble` - linux; s390x
