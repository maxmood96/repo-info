...
```console
$ docker pull tomcat@sha256:e758096dbfc301477a1a226ca776516c2701768b9eb1740c27843215af77e4e7
```
...
### `tomcat:9.0.78-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.78-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.78-jre17-temurin-jammy` - linux; s390x
