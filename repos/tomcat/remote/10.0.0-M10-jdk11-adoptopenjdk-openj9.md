...
```console
$ docker pull tomcat@sha256:e2e83c0968f758e2e9f510d1404240333cc0c4fc857aeaab5a5a37fc9f0d6ec6
```
...
### `tomcat:10.0.0-M10-jdk11-adoptopenjdk-openj9` - linux; amd64
...
### `tomcat:10.0.0-M10-jdk11-adoptopenjdk-openj9` - linux; arm64 variant v8
