...
```console
$ docker pull tomcat@sha256:28382eb17374fd2f521792275110fd954b5b30909291071eac4a414bd5428a3a
```
...
### `tomcat:11.0.21-jre25-temurin-noble` - linux; amd64
...
### `tomcat:11.0.21-jre25-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.21-jre25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.21-jre25-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.21-jre25-temurin-noble` - linux; s390x
