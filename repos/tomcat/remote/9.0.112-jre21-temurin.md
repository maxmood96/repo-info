...
```console
$ docker pull tomcat@sha256:2f9586f8fdbf1a01a16ec3508723543c474005f845599033dc573351513528e6
```
...
### `tomcat:9.0.112-jre21-temurin` - linux; amd64
...
### `tomcat:9.0.112-jre21-temurin` - unknown; unknown
...
### `tomcat:9.0.112-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.112-jre21-temurin` - linux; ppc64le
...
### `tomcat:9.0.112-jre21-temurin` - linux; s390x
