...
```console
$ docker pull tomcat@sha256:26710c982b1c4cffc11f2ada476dfa9bc5fd116e70e0786f6c2997586afd0b84
```
...
### `tomcat:9.0.86-jre8` - linux; amd64
...
### `tomcat:9.0.86-jre8` - linux; arm64 variant v8
...
### `tomcat:9.0.86-jre8` - linux; ppc64le
