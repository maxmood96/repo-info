## `tomcat:11.0.3-jdk21-temurin-jammy`

```console
$ docker pull tomcat@sha256:84ff0af80fdea49cbdf2679523fa4b7651b9df92c2b5881709660eb0fefb3ec1
```
...
### `tomcat:11.0.3-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.3-jdk21-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.3-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jdk21-temurin-jammy` - linux; s390x
