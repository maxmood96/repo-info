## `tomcat:10.0.11-jdk11-openjdk-slim-bullseye`
...
### `tomcat:10.0.11-jdk11-openjdk-slim-bullseye` - linux; amd64
...
### `tomcat:10.0.11-jdk11-openjdk-slim-bullseye` - linux; arm64 variant v8
