...
```console
$ docker pull tomcat@sha256:55b95b4e7c3b1153f2d3d53ece8cb6db96fe4e58b4566fd575600b41e5fa3041
```
...
### `tomcat:10.1.50-jdk25-temurin` - linux; amd64
...
### `tomcat:10.1.50-jdk25-temurin` - unknown; unknown
...
### `tomcat:10.1.50-jdk25-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.50-jdk25-temurin` - linux; ppc64le
...
### `tomcat:10.1.50-jdk25-temurin` - linux; s390x
