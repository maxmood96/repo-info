...
```console
$ docker pull tomcat@sha256:f649b49e30278edd31216ca48829e66347e78aec3c46a7a0b0ce8cda948c6017
```
...
### `tomcat:9.0.80-jre8` - linux; amd64
...
### `tomcat:9.0.80-jre8` - linux; arm variant v7
...
### `tomcat:9.0.80-jre8` - linux; arm64 variant v8
...
### `tomcat:9.0.80-jre8` - linux; ppc64le
