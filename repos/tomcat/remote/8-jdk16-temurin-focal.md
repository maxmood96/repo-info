...
```console
$ docker pull tomcat@sha256:10bb21d6559ebe824299c8eaf9ebd74b636d2fc561ba7cf00ea05771ce8dd7b0
```
...
```console
$ docker pull tomcat@sha256:e263777978808f8005ceb225334071999951e41f713e4532aac47e4a740d3f1a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.3 MB (275309133 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c4bbe8ad2786c150a2e84177eb4c46e31cab80a7f3d37059384277bd8fe5e61`
...
# Fri, 07 Jan 2022 08:07:03 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 07 Jan 2022 08:07:04 GMT
EXPOSE 8080
# Fri, 07 Jan 2022 08:07:04 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:282695de032d7b2f3f8f37b6c28fb4979503e0badec6847beaa567bf116714a6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22d581a87d967e6893f3bb6e264c8606801f3030f33c77912837268305abd569`  
		Last Modified: Fri, 07 Jan 2022 08:29:03 GMT  
		Size: 11.7 MB (11717155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:810e4625e9fcab2498646ce182b1191d7881194b55e2ac0584646758edd8104c`  
		Last Modified: Fri, 07 Jan 2022 08:29:01 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
