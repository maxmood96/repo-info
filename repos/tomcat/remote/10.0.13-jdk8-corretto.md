...
```console
$ docker pull tomcat@sha256:6e2af13d88b9f9602bc7dfebf7e4b391feb9f18d35b2c8361955e43a10cc2bc4
```
...
```console
$ docker pull tomcat@sha256:95758d1fdee8ebea82c29e5b013fe819483acb57cccda7edffc2e63836c8124a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154209984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b3cecadcc161285ae719ca2202dbaefd1e76f964dfcf2def93be8b132383280`
...
# Fri, 03 Dec 2021 23:04:56 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 03 Dec 2021 23:04:57 GMT
EXPOSE 8080
# Fri, 03 Dec 2021 23:04:57 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c0729bc4f98db4867b5de71498382c1d41d42604ce38fd3bb8d823f17d3e1c51`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac312b766fc6e5ee889ba91c08159a841d72edac00cc003fbfda7a081f80ae3d`  
		Last Modified: Fri, 03 Dec 2021 23:23:43 GMT  
		Size: 16.7 MB (16749704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4eb840f5ded62bfc066c81e422cb7ea421d0656a4332e3291546e28d3e9cba4`  
		Last Modified: Fri, 03 Dec 2021 23:23:41 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
