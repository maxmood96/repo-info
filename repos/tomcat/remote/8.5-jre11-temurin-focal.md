...
```console
$ docker pull tomcat@sha256:b02ab82fcacb98e32ee3d2d808839abab249ffd3db4e30308909d6680bf7447d
```
...
```console
$ docker pull tomcat@sha256:707ce7b90af787adb323bfdb66125b6162499dabc6da0a4b2b6fdb61c9ca8ef2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.0 MB (101023635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f39616c762bebd9c7af57e629f9f7b56d2e9147bc0f7276f4c1d141343c8d980`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 20:11:59 GMT
ENV TOMCAT_MAJOR=8
# Wed, 16 Aug 2023 00:43:48 GMT
ENV TOMCAT_VERSION=8.5.92
# Wed, 16 Aug 2023 00:43:48 GMT
ENV TOMCAT_SHA512=faab13a29531a800d38b2602ff76c0041277ffbfb25b938bbefb84ef6ad3ffa26d2c2645cd233eb0d819bcca9887aaeb44df6c044852160d000e5084b1addc2f
# Wed, 16 Aug 2023 00:43:48 GMT
COPY dir:06906990df36660b36940fe856fe816b6fcd49d247d8146c23e2fb2d1466f2bd in /usr/local/tomcat 
# Wed, 16 Aug 2023 00:43:51 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 16 Aug 2023 00:43:52 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 16 Aug 2023 00:43:52 GMT
EXPOSE 8080
# Wed, 16 Aug 2023 00:43:52 GMT
ENTRYPOINT []
# Wed, 16 Aug 2023 00:43:53 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9d0f370511f10bfcc59610b657ac616f0cfc0c0efee44bea8f7fd2d2c09cb92c`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19d7c38f9b626eb371c9a0a80574688e604034d0a507c0a4b4002d7320092dd0`  
		Last Modified: Wed, 16 Aug 2023 01:01:47 GMT  
		Size: 11.4 MB (11410533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31fc8dc37fe4eeac2faaf38449990defa0c83995d4c9891e977841828c68ac72`  
		Last Modified: Wed, 16 Aug 2023 01:01:46 GMT  
		Size: 450.4 KB (450404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02b47050adea89d77d01601dd1242fcaef819d40d0d366c42852bdb2f0a83804`  
		Last Modified: Wed, 16 Aug 2023 01:01:46 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
