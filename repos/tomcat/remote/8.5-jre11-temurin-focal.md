...
```console
$ docker pull tomcat@sha256:abe2c60a5b44063f6bc60d9cb851dc17b096f1749355a0e4064365a4e575af44
```
...
```console
$ docker pull tomcat@sha256:c9dea17a685f33e2e433c3eab655528c8a2613ff2bb6a9a0e27a8d15f6c808dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.5 MB (96467321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c895cecb84f2798c5dd771754f199b5684b74ae1d45d8e26ead274f66ab98b7b`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 05:42:00 GMT
ENV TOMCAT_MAJOR=8
# Tue, 11 Jul 2023 05:17:27 GMT
ENV TOMCAT_VERSION=8.5.91
# Tue, 11 Jul 2023 05:17:27 GMT
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Tue, 11 Jul 2023 05:17:27 GMT
COPY dir:612d07ce034c84bd4a2a09640cfebb4714690cb55abb5b0ac18016ff2b023dcf in /usr/local/tomcat 
# Tue, 11 Jul 2023 05:17:31 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 05:17:32 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Jul 2023 05:17:32 GMT
EXPOSE 8080
# Tue, 11 Jul 2023 05:17:32 GMT
...
-	Layers:
	...
	-	`sha256:870a5064b1e028be82d7ff47383985d01f753f2a637572f1c752ba24bf4aad4b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eea2a75c9dd4baff375ca7a2bcafe842744021eb6f2f6ee3b299b0b214343b2`  
		Last Modified: Tue, 11 Jul 2023 05:29:24 GMT  
		Size: 11.3 MB (11336836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46a3abbae0ecabeb98e7708566a7a2516ae0db16c2bd0ce4f2b606db8756e22f`  
		Last Modified: Tue, 11 Jul 2023 05:29:23 GMT  
		Size: 424.0 KB (424024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a48c5ec596c8e731aea732049df8aa6e14b0fc5695dbdeb5d2eab3493744ac7d`  
		Last Modified: Tue, 11 Jul 2023 05:29:23 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:2781b7537044154e33a1aeefdc86e00bdafb89ba8fcd91381d3f1880ef01bdd4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.5 MB (95508385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9909bdaf546a102c2b108a7236622fe8e0e21bfe4b948b04cb53c0975a0c6b24`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 11:11:52 GMT
ENV TOMCAT_MAJOR=8
# Tue, 11 Jul 2023 08:33:29 GMT
ENV TOMCAT_VERSION=8.5.91
# Tue, 11 Jul 2023 08:33:29 GMT
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Tue, 11 Jul 2023 08:33:30 GMT
COPY dir:0f01dbfa6fcb81aff0ee95d8b1151408856c142f6c27a68cfaa893f2df360e56 in /usr/local/tomcat 
# Tue, 11 Jul 2023 08:33:33 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 08:33:34 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Jul 2023 08:33:34 GMT
EXPOSE 8080
# Tue, 11 Jul 2023 08:33:34 GMT
...
-	Layers:
	...
	-	`sha256:2755e877755a156b956b29263e1f808db07f6ac4809c6010cd39dbdee378620b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe6a557eb2dc1f42a45ed21aa9d7cd22c95576464c727f0538573bd6d6ff7070`  
		Last Modified: Tue, 11 Jul 2023 08:39:36 GMT  
		Size: 11.4 MB (11399947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:619a7be53c143a49489a7a024ab25143c3ddb08fb7076231d714306b11d05036`  
		Last Modified: Tue, 11 Jul 2023 08:39:36 GMT  
		Size: 450.5 KB (450454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:093e45f92cd7c0cefe3673d70888c8340c97b7e4bced2b56c830a232ad125b58`  
		Last Modified: Tue, 11 Jul 2023 08:39:36 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
