...
### `tomcat:11.0.6-jre17-temurin` - linux; amd64
...
### `tomcat:11.0.6-jre17-temurin` - unknown; unknown
...
### `tomcat:11.0.6-jre17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.6-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.6-jre17-temurin` - linux; ppc64le
...
### `tomcat:11.0.6-jre17-temurin` - linux; riscv64
...
### `tomcat:11.0.6-jre17-temurin` - linux; s390x
