...
```console
$ docker pull tomcat@sha256:160313964fedb3a1e8976e77f87f3957d8ec36d6f9f927dd0428b43020537863
```
...
### `tomcat:9.0.112-jre8` - linux; amd64
...
### `tomcat:9.0.112-jre8` - unknown; unknown
...
### `tomcat:9.0.112-jre8` - linux; arm variant v7
...
### `tomcat:9.0.112-jre8` - linux; arm64 variant v8
