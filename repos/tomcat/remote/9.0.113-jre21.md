...
```console
$ docker pull tomcat@sha256:1f474c9eb938a6338dd13800dd9a385353ccec9cdb72df514c94f95432ba4d55
```
...
### `tomcat:9.0.113-jre21` - linux; amd64
...
### `tomcat:9.0.113-jre21` - unknown; unknown
...
### `tomcat:9.0.113-jre21` - linux; arm64 variant v8
...
### `tomcat:9.0.113-jre21` - linux; ppc64le
...
### `tomcat:9.0.113-jre21` - linux; s390x
