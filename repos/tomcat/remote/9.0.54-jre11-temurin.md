...
```console
$ docker pull tomcat@sha256:ea8ec360352a9f8cd9cc2e6e1fa2b47c025706f404620e2e169b1b9bcb6c5136
```
...
### `tomcat:9.0.54-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.54-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.54-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.54-jre11-temurin` - linux; ppc64le
