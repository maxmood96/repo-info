...
```console
$ docker pull tomcat@sha256:058fdbea973518d7f0f4752146cdcf2547ed4400e3b773bbabd491886293dfa0
```
...
### `tomcat:10.1.52-jre25-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.52-jre25-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.52-jre25-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.52-jre25-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.52-jre25-temurin-jammy` - linux; s390x
