## `tomcat:10.0.11-jdk11-openjdk-slim`

```console
$ docker pull tomcat@sha256:9d91271da91147c620fd8863c6a2e554d84b07b109cbfafb72153a7ce66ed993
```
...
### `tomcat:10.0.11-jdk11-openjdk-slim` - linux; amd64
