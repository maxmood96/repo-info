## `tomcat:10.0-jdk15-adoptopenjdk-hotspot`

```console
$ docker pull tomcat@sha256:01f0a1827ad5775bd9dfa96535e3c8b6387515ff5def572e63ca9aa18f5d7efa
```
...
### `tomcat:10.0-jdk15-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:10.0-jdk15-adoptopenjdk-hotspot` - linux; arm variant v7
...
### `tomcat:10.0-jdk15-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:10.0-jdk15-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:10.0-jdk15-adoptopenjdk-hotspot` - linux; s390x
