## `tomcat:11.0.0-M10-jdk21-openjdk-slim`

```console
$ docker pull tomcat@sha256:055dca9b14f46b1078ec0f40616fa94bcdc728c3c5aff1da6b4619232e5837a3
```
...
### `tomcat:11.0.0-M10-jdk21-openjdk-slim` - linux; amd64
