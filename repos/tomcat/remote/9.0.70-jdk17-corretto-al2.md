...
```console
$ docker pull tomcat@sha256:894095fcbe4724a80934c96f91df0ccbe7f4b12fba3df9c8ea8ef02b11081b3f
```
...
### `tomcat:9.0.70-jdk17-corretto-al2` - linux; amd64
...
### `tomcat:9.0.70-jdk17-corretto-al2` - linux; arm64 variant v8
