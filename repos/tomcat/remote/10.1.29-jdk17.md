...
```console
$ docker pull tomcat@sha256:810eeaf3f081267e4173a234dbd4c98f583e7d950a35e4aeadb59aaac0bf8db4
```
...
### `tomcat:10.1.29-jdk17` - linux; amd64
...
### `tomcat:10.1.29-jdk17` - unknown; unknown
...
### `tomcat:10.1.29-jdk17` - linux; arm variant v7
...
### `tomcat:10.1.29-jdk17` - linux; arm64 variant v8
...
### `tomcat:10.1.29-jdk17` - linux; ppc64le
...
### `tomcat:10.1.29-jdk17` - linux; s390x
