## `tomcat:8.5.72-jdk11-corretto`

```console
$ docker pull tomcat@sha256:93917323dca58d069f61749b05925cd2e06a8d431ee9a0a7b1c80516ab539391
```
...
### `tomcat:8.5.72-jdk11-corretto` - linux; amd64
...
### `tomcat:8.5.72-jdk11-corretto` - linux; arm64 variant v8
