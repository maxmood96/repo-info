...
```console
$ docker pull tomcat@sha256:a7418f29d3dd7ad20bcf052b3b6dc2777d118344286c6374bc447fb217a97c08
```
...
```console
$ docker pull tomcat@sha256:f5c03e68690424f24dd26907ce29fedea4aacdedbd9a9cf20cb5d3cc2766ea56
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.2 MB (251169994 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8b832100882e2a2282fd315921f4f27b395a1aaf98bc5124b1b6695e4f39b4a`
...
# Tue, 11 May 2021 02:00:05 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 May 2021 02:00:05 GMT
EXPOSE 8080
# Tue, 11 May 2021 02:00:06 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:7267948abfc47d400ccf2e9273d7a6ce5eeceea00dbb0d2c27d250e2200954da`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369c0bc4001d11e44c2034268a6544c21d0cbbf6e0776b26dbfb24a9443c63d1`  
		Last Modified: Tue, 11 May 2021 02:13:51 GMT  
		Size: 12.9 MB (12943837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa6d210f8b22d56accb2043920920c9e16018ece1adca42e26a6f303b7a41d03`  
		Last Modified: Tue, 11 May 2021 02:13:50 GMT  
		Size: 133.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
