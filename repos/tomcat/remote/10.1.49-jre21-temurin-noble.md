...
```console
$ docker pull tomcat@sha256:6a4b5014da519d7c9cb2b2153d5537cd465be1271e1fcc98bcae5e7ebe4bae13
```
...
### `tomcat:10.1.49-jre21-temurin-noble` - linux; amd64
...
### `tomcat:10.1.49-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.49-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.49-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.49-jre21-temurin-noble` - linux; s390x
