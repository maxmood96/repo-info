...
```console
$ docker pull tomcat@sha256:1aeec2721aa2289b3576b935309d9a433850f13da156836a3951ce9f57b6a646
```
...
### `tomcat:10.0.21-jdk11-temurin` - linux; amd64
...
### `tomcat:10.0.21-jdk11-temurin` - linux; arm variant v7
...
### `tomcat:10.0.21-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:10.0.21-jdk11-temurin` - linux; ppc64le
...
### `tomcat:10.0.21-jdk11-temurin` - linux; s390x
