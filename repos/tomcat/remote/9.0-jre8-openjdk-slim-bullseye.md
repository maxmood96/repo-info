...
```console
$ docker pull tomcat@sha256:a8eb5a9ac2afede7e4596e337d8ef6021937ae6c03fcbc842c2fde60ce529056
```
...
```console
$ docker pull tomcat@sha256:d4b0af7c899900b3370bb45bf7e5ec12277ba79f62b8ec016839f6ef960de3d9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.6 MB (84640659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53b5520374b8c1653c364eb465f3ae150bde67a92ec6ae89f501e16a3802d444`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Tue, 16 Nov 2021 00:08:25 GMT
ENV TOMCAT_VERSION=9.0.55
# Tue, 16 Nov 2021 00:08:26 GMT
ENV TOMCAT_SHA512=a0c480b8bba09069bda3b57f54e658450a59d799474ad587dead0ffbf5074c16ee3f9f9c13312d0ff3227c7034589dabf25941fbd672838e9baeee9661e024dc
# Tue, 16 Nov 2021 00:08:28 GMT
COPY dir:1c8296b45dd1568751a2ef166d409cb3c034787e9edcdef2f68f0012a3036c66 in /usr/local/tomcat 
# Tue, 16 Nov 2021 00:08:31 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 16 Nov 2021 00:08:33 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 16 Nov 2021 00:08:34 GMT
EXPOSE 8080
# Tue, 16 Nov 2021 00:08:35 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9e070527c90af7986d78e388a52ef6c79f19128fc13f43f6a68fefcf6b99ddff`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b02a44775c83ef734697dd36c325037566d1bb784ef1d6d1ec96a64650f55769`  
		Last Modified: Tue, 16 Nov 2021 00:42:59 GMT  
		Size: 12.2 MB (12167639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a80cbe517349f606a17313abada0912304a8026bd3703c4677c1052ae25f12ca`  
		Last Modified: Tue, 16 Nov 2021 00:42:57 GMT  
