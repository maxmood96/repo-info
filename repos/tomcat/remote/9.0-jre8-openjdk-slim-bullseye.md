...
```console
$ docker pull tomcat@sha256:0115ec574768b9758bd3537aef4f9b657eed0d7848ecbd35db81f17c97f1c875
```
...
```console
$ docker pull tomcat@sha256:dfc8b75a0904321acec2244a889ff533a85fa51bb58379da28b7b20629f015e5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.2 MB (87153398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ea87cf9911b52eab219fb71b3a507362d05ac9f7c4719427635e15be3751d29`
...
# Fri, 03 Dec 2021 14:33:17 GMT
COPY dir:a441bc1489373e7123a509fac341d676d359793aecc19b4be9097a92c43908ae in /usr/local/tomcat 
# Fri, 03 Dec 2021 14:33:21 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 03 Dec 2021 14:33:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 03 Dec 2021 14:33:23 GMT
EXPOSE 8080
# Fri, 03 Dec 2021 14:33:23 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0626e6bc46ce56c1c192e895abe5496651c92fa5574963aa59464cdbc3841ae9`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d974eaaa174cb68cb151d1cd5e6a51bd8544fa006fa9f671710a50aa98ce5d2`  
		Last Modified: Fri, 03 Dec 2021 15:13:02 GMT  
		Size: 12.2 MB (12158985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d921f49e1029d0f4e2d96f29db22e0a5896d5a8c14d20931013b8472d3ed0fe4`  
		Last Modified: Fri, 03 Dec 2021 15:13:01 GMT  
		Size: 396.2 KB (396220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:694eeddfe50b006e3f703ae7fee092699913d01e763eab3817e113b6c139ec99`  
		Last Modified: Fri, 03 Dec 2021 15:13:01 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
