...
```console
$ docker pull tomcat@sha256:8f69dd2c5dd1c524c6504ba2772813db91ff046ebd1880958c940a61f7f55e1e
```
...
```console
$ docker pull tomcat@sha256:5475328aebe218cfbdbddf3157b9c6f72eaffbc36899f37b6b13aba18d3b6b84
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.2 MB (87199407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:641298405a5d9c432cf167e8c25151421f15738158abeeb48cb47716a4342311`
...
# Tue, 12 Jul 2022 19:02:14 GMT
COPY dir:dc5703a379baba4a49af5da75170fc7633b8ef6c89efb7d400df78a93adcb4d4 in /usr/local/tomcat 
# Tue, 12 Jul 2022 19:02:18 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 19:02:19 GMT
...
-	Layers:
	...
	-	`sha256:9ccb91d89c4f1d1c0f0f9b75f94db4fdfb541dfd72f32f1d90ebedf9d8f6d157`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c244e6a5e952812cd5f2489b6a33972375abaf644d68433148ba4a269125a461`  
		Last Modified: Tue, 12 Jul 2022 19:32:21 GMT  
		Size: 12.2 MB (12156381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5151119182830d17642588f3f4ca60925219abf97a3dc6208ada5c9b189523c8`  
		Last Modified: Tue, 12 Jul 2022 19:32:20 GMT  
		Size: 396.3 KB (396286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84d85222d17e349e014c00e355f3f0baffdba3a368b6300f6e393257e0e0da7a`  
		Last Modified: Tue, 12 Jul 2022 19:32:20 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:4b93171d9a07efc426826e8dd499fd760c525360c91479385f1b40103748a409
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.7 MB (84688112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0491505d1d207114fa0904db8467a9ccddccebd6573e5990eec99ff15ac2cac4`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Tue, 12 Jul 2022 18:51:18 GMT
ENV TOMCAT_VERSION=9.0.64
# Tue, 12 Jul 2022 18:51:19 GMT
ENV TOMCAT_SHA512=38392b651fabe706fb0524c52849601299494178010bb8077af383232c20bbbda1aec4ab8898adb2cc37c07583ff0e9d3c7038ce55a22bc68c3641641b47fd1a
# Tue, 12 Jul 2022 18:51:21 GMT
COPY dir:2c4aaf70bebf6725d81c001380f39429c26c83b884f523e1747c54fdc91df2e9 in /usr/local/tomcat 
# Tue, 12 Jul 2022 18:51:24 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 18:51:25 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 12 Jul 2022 18:51:26 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:d2341952bac5e91c3473c28b5795a9153db89d424b5a3b865f2b7ea315cf5c5a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:397cfea3592af80bfca402e90f972ec79da2cb4e4c7176176bfe9dc533e32fa5`  
		Last Modified: Tue, 12 Jul 2022 19:36:42 GMT  
		Size: 12.2 MB (12166798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4754801a62166fed979f633ad0c0d5dda5a0d2480822bd2e17b72113f6eaef5a`  
		Last Modified: Tue, 12 Jul 2022 19:36:41 GMT  
