...
```console
$ docker pull tomcat@sha256:6b4ca43e545786368599972adf70b3702b03acdd18ab4ab7139494bb82ee7e72
```
...
```console
$ docker pull tomcat@sha256:0afa7db7d3ee3e6e5014f4fe1dd4ddcc90291d965592c75b3330075bb6f7c944
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.2 MB (87201556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79ba4d4936d2bba5954d787b7f640988754f63076a5f3f68be9dcd9ac238c0fc`
...
# Wed, 03 Aug 2022 05:06:26 GMT
COPY dir:9d223cf265c1446fb3a6bb8d2d534e1e85417a4b7f594f1fe0c18d1bd70ab068 in /usr/local/tomcat 
# Wed, 03 Aug 2022 05:06:29 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 05:06:30 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2022 05:06:31 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 05:06:31 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:93be3b3fd66eeea95b7422a32df6fa92d96c4d6e68b84ddfecaaff845dedce8c`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60e46bd36ada717656070bde468c26b280647b17b368974fbb1ca1d528c9041`  
		Last Modified: Wed, 03 Aug 2022 05:49:58 GMT  
		Size: 12.2 MB (12159568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1736f23e092a5200ee8a0362b4a267f661d59cea0c60cd535ac1d62d5e40a80`  
		Last Modified: Wed, 03 Aug 2022 05:49:57 GMT  
		Size: 396.3 KB (396266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1b8eb559724a17576f4984ed08e1f29bd8267b4351f142b92ca79a23219980d`  
		Last Modified: Wed, 03 Aug 2022 05:49:56 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:4f68ee08980fce39c95fb4aac144d810673976773782931710190c36264a1e2f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.7 MB (84701559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12e60eddeb233b1c3385ff2a58b969a4264aad063c0e9b9e8bd36b83c1ab6569`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Wed, 03 Aug 2022 02:19:47 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 03 Aug 2022 02:19:48 GMT
ENV TOMCAT_MAJOR=9
# Wed, 03 Aug 2022 02:19:49 GMT
ENV TOMCAT_VERSION=9.0.65
# Wed, 03 Aug 2022 02:19:50 GMT
ENV TOMCAT_SHA512=2ae846848b8436856be11cfa18d9c62caa06ca7d3134012b2e10cbf6078753c4af20cc5d37f7dc75f1779f5c59d7c033850b8626534c3ce7e389641a67963cf6
# Wed, 03 Aug 2022 02:19:52 GMT
COPY dir:df63d799bf9a9a2c3ca3e6ff15d122996f036259af110215d13cd3b0dcbf4a6a in /usr/local/tomcat 
# Wed, 03 Aug 2022 02:19:55 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 02:19:56 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2022 02:19:57 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:37315976878163c22f5f880c2fd3a959c2d52498a094aec357dd1d976c70bc15`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24b84bcc7b86a62f9a0d76383141a48db14055c81d588d35cf14c03bc9071cc8`  
		Last Modified: Wed, 03 Aug 2022 03:21:11 GMT  
		Size: 12.2 MB (12168573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a269df965d6ddc50ef07b465092a1eea5bd7dcd6683455a6fed414043879019e`  
		Last Modified: Wed, 03 Aug 2022 03:21:09 GMT  
