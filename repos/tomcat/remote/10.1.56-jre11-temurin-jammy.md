...
```console
$ docker pull tomcat@sha256:53511d3b858ce4fcf127e7def2478a8f0f4389df60ca317142f2a30331f8927a
```
...
### `tomcat:10.1.56-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.56-jre11-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.56-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.56-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.56-jre11-temurin-jammy` - linux; s390x
