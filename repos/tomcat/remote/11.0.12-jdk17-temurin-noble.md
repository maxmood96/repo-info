...
```console
$ docker pull tomcat@sha256:e5a8ad7fd4d8f9bcbfa3a3e6245fc18fba43a4421c8930d277aade58767c5ead
```
...
### `tomcat:11.0.12-jdk17-temurin-noble` - linux; amd64
...
### `tomcat:11.0.12-jdk17-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.12-jdk17-temurin-noble` - linux; arm variant v7
...
### `tomcat:11.0.12-jdk17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.12-jdk17-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.12-jdk17-temurin-noble` - linux; s390x
