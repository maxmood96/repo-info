...
```console
$ docker pull tomcat@sha256:339cb8aaf684682e0fa5062907cb19d73674987b65ebbc44e2481e0b24261bc3
```
...
### `tomcat:10.1.46-jdk21` - linux; amd64
...
### `tomcat:10.1.46-jdk21` - unknown; unknown
...
### `tomcat:10.1.46-jdk21` - linux; arm64 variant v8
...
### `tomcat:10.1.46-jdk21` - linux; ppc64le
...
### `tomcat:10.1.46-jdk21` - linux; s390x
