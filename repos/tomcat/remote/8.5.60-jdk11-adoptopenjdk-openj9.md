...
```console
$ docker pull tomcat@sha256:732117b5443d905e7e1e0f80ec884f3b2e8d3976e61c25071840cd2c6657e0bc
```
...
```console
$ docker pull tomcat@sha256:22795c678e6c56fb09b42ebbfd58c09d0e9ea62faf3b2b21aef05ec4587ec462
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.6 MB (258634185 bytes)**  
...
# Thu, 26 Nov 2020 04:29:54 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 26 Nov 2020 04:29:54 GMT
EXPOSE 8080
# Thu, 26 Nov 2020 04:29:55 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5a13fb8f93aec32b7535143992fe6d8dfdbd892e75af97e35255e2de5d50f70d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5070c86baa345199bc1ea23d8794e0c6d9cd489518168d1fd18c20f4b1ba31dd`  
		Last Modified: Thu, 26 Nov 2020 04:38:51 GMT  
		Size: 11.6 MB (11617711 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:331da28a061925f94b67d54d809292b98161d466902b2b8d81bc4282188b9853`  
		Last Modified: Thu, 26 Nov 2020 04:38:50 GMT  
		Size: 184.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
