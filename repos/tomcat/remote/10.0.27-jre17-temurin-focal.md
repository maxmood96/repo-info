...
```console
$ docker pull tomcat@sha256:a007b23976bac144d7127cad6a85db3c445db2d7642808c9b57c1f36c72aade6
```
...
```console
$ docker pull tomcat@sha256:02dabd46a08e9da7538bb3142c18e1163cf44090de87469f66e89bfab1bed6bf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.2 MB (115154215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4b16ed3e62078e252a852c17a9c28e3872db4f25d2aad81f5e56acd074e11a0`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 06 Oct 2022 01:57:20 GMT
ENV TOMCAT_MAJOR=10
# Tue, 11 Oct 2022 21:56:44 GMT
ENV TOMCAT_VERSION=10.0.27
# Tue, 11 Oct 2022 21:56:44 GMT
ENV TOMCAT_SHA512=33c51be9410eaa0ce1393f8ce80a42a9639b68c7b7af1e9e642045614c170a12f8841ce4142933d1f4d18ba7efc85c630f91c312e959dcdc64aae396c46bdd97
# Tue, 11 Oct 2022 21:56:45 GMT
COPY dir:75df988b453168f1135b4eb3fd1c13dedcccf847cd50bef1b7e1cfdaeee19582 in /usr/local/tomcat 
# Tue, 11 Oct 2022 21:56:54 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Oct 2022 21:56:57 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Oct 2022 21:56:57 GMT
EXPOSE 8080
# Tue, 11 Oct 2022 21:56:57 GMT
...
-	Layers:
	...
	-	`sha256:b336c7bfaa6411b5bcaf26a9445eb1b569499b968173b1c81fda38f1ad3528e7`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d4660cd5d93e5865ffc4e2bd99418429e320f20546457755fad31146faa6fed`  
		Last Modified: Tue, 11 Oct 2022 22:24:12 GMT  
		Size: 12.7 MB (12681464 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46834205661dc84ba053b1c0028e491dc2012f90ffaba74c051011a3921be6de`  
		Last Modified: Tue, 11 Oct 2022 22:24:11 GMT  
		Size: 476.7 KB (476736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:394130b502bb0d426255d555ef96b144ac8e85a2802e9561f8b4f9a65a3e20ab`  
		Last Modified: Tue, 11 Oct 2022 22:24:11 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
