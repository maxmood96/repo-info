...
```console
$ docker pull tomcat@sha256:9a0a3cc029378684f923fc7b75be2bb933ff318542a97f20a75f95632be25639
```
...
### `tomcat:9.0.67-jdk11-temurin` - linux; amd64
...
### `tomcat:9.0.67-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.67-jdk11-temurin` - linux; s390x
