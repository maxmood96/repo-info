...
```console
$ docker pull tomcat@sha256:fb5120086221a88532daa91eb1a5a94efc90842d71744783d0eff9ebbc33931e
```
...
### `tomcat:10.1.56-jre21-temurin-noble` - linux; amd64
...
### `tomcat:10.1.56-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.56-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.56-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.56-jre21-temurin-noble` - linux; s390x
