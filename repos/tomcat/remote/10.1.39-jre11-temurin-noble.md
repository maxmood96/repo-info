...
### `tomcat:10.1.39-jre11-temurin-noble` - linux; amd64
...
### `tomcat:10.1.39-jre11-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.39-jre11-temurin-noble` - linux; arm variant v7
...
### `tomcat:10.1.39-jre11-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.39-jre11-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.39-jre11-temurin-noble` - linux; s390x
