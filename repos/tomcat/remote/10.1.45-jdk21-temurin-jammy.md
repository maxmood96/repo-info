...
```console
$ docker pull tomcat@sha256:b6b4d83a5a75013bce7a7351f300acf66940fc6079d00b5e7a6d22b5043f601c
```
...
### `tomcat:10.1.45-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.45-jdk21-temurin-jammy` - linux; s390x
