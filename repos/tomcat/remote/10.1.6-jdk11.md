...
```console
$ docker pull tomcat@sha256:2334aa6140d518e8720589df596616dca6dacf282f7ba1b3fcad8b0ffb2a0be0
```
...
### `tomcat:10.1.6-jdk11` - linux; amd64
...
### `tomcat:10.1.6-jdk11` - linux; arm64 variant v8
...
### `tomcat:10.1.6-jdk11` - linux; ppc64le
...
### `tomcat:10.1.6-jdk11` - linux; s390x
