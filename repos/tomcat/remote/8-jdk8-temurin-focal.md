...
```console
$ docker pull tomcat@sha256:0183ae5cb39dd9e2ef5fa0d1c5124d35cf8afed58ea3a2b989c6d838a8ab499a
```
...
```console
$ docker pull tomcat@sha256:9b6fdd2d900eef2f7ab2badfc208ff6365d6a595edee060dd364cd2359c48fc8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.1 MB (161086120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a59bfee1533594a6bf8583f080802e7b05c00eff84b77ec2c8605b84e733d41`
...
# Fri, 02 Feb 2024 12:42:25 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Feb 2024 12:42:25 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 12:42:25 GMT
ENTRYPOINT []
# Fri, 02 Feb 2024 12:42:26 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:414fa602d2be2baf1a129575726c5d82b2c6b23900db8ab5a1a5e6dd00be2504`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:651d9794072e282a1b8c677d934e18cfa518cf12ee65b10100c0c5f87530d1ce`  
		Last Modified: Fri, 02 Feb 2024 13:00:39 GMT  
		Size: 12.0 MB (11973826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34789deec6fc3c816b39c5dbf09cbd6f29f4adcb7c943cc3758906bb6acfd556`  
		Last Modified: Fri, 02 Feb 2024 13:00:29 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
