...
### `tomcat:7.0.105-jdk8-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:7.0.105-jdk8-adoptopenjdk-hotspot` - linux; arm variant v7
...
### `tomcat:7.0.105-jdk8-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:7.0.105-jdk8-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:7.0.105-jdk8-adoptopenjdk-hotspot` - linux; s390x
