...
```console
$ docker pull tomcat@sha256:1a4a0e45a89b65925a73a0e48c68a0da04596775701f2562b5d9cd865c7e6097
```
...
### `tomcat:9.0.78-jdk8` - linux; arm variant v7
...
### `tomcat:9.0.78-jdk8` - linux; arm64 variant v8
