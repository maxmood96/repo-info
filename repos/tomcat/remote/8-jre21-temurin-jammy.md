...
```console
$ docker pull tomcat@sha256:398b13a89b29514840451662388301a6461fdc336e75cac2f0ea57d4db880edc
```
...
```console
$ docker pull tomcat@sha256:335b182c7be8f0227984425ad70c7ec089349fdcff549f24a88a76a4dde34ee4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.3 MB (113315284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fa9c8ee8de52c88df1ba819b297af10890c22a345ca4fb21aeb36bcfe179c6e`
...
# Tue, 09 Jan 2024 22:43:53 GMT
COPY dir:4522e945dac03d984c4d64e8e5c727d5cb62ba66522de645dba952f4ed060d07 in /usr/local/tomcat 
# Tue, 09 Jan 2024 22:43:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Jan 2024 22:43:59 GMT
...
-	Layers:
	...
	-	`sha256:f04b5b59f5079bec6f10e68105d75d15a34b3913a08fcc47150a3788c6837916`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39e67971ed62a2d00b591cbb5362cf082554d6186addaee27ab5c1d28edd2165`  
		Last Modified: Tue, 09 Jan 2024 23:06:18 GMT  
		Size: 11.4 MB (11449777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fd775369f65c85145cfc3bbe0f0ea5c8840746ce676a863a5e0d0fe4b32d1cd`  
		Last Modified: Tue, 09 Jan 2024 23:06:16 GMT  
		Size: 458.5 KB (458475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bb555ccb11105cf76f28750baf5bd35bdbb945ab86efae5b5254ddd70e22e2d`  
		Last Modified: Tue, 09 Jan 2024 23:06:16 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:f918b157f32b64c5d09825de027479a9b3a13c53ff23df91e934dfc3e0c6e743
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.8 MB (111847898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee9ff1b400be750612795f20327ccb3e993cf540c7362c047e414048f785570b`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 16 Dec 2023 15:04:29 GMT
ENV TOMCAT_MAJOR=8
# Tue, 09 Jan 2024 23:09:09 GMT
ENV TOMCAT_VERSION=8.5.98
# Tue, 09 Jan 2024 23:09:09 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Tue, 09 Jan 2024 23:09:10 GMT
COPY dir:160f3f7f39e71bf6e0471e2227e67d6f74d2a5aef2998cce331493a69aa1de4f in /usr/local/tomcat 
# Tue, 09 Jan 2024 23:09:13 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Jan 2024 23:09:14 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 09 Jan 2024 23:09:14 GMT
EXPOSE 8080
# Tue, 09 Jan 2024 23:09:14 GMT
...
-	Layers:
	...
	-	`sha256:92e3e6fdd5006ca29911b0245daca5b297ed1b8f9cda706f8731331202bfee74`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5bf629315df343172aeb3941551621b6a878c571f860bafefce33ff363e88bd`  
		Last Modified: Tue, 09 Jan 2024 23:29:18 GMT  
		Size: 11.5 MB (11457256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aee8a6b9f5295a42e73ea783707a33357d3fc2e129b61ab64396ffd7e95309b6`  
		Last Modified: Tue, 09 Jan 2024 23:29:17 GMT  
		Size: 458.5 KB (458468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4756266fefa6d2f866105e8e56ae4ffb91ca424fc7ee2d5231f3b3bbb117b6b8`  
		Last Modified: Tue, 09 Jan 2024 23:29:17 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:592c58b2d30844ba774f0750f001a0726339354c0c2df4b1eaaa548747f8c913
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.6 MB (119613274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4edb64eab847d52fae8b9484717024cadecff6b7a145ab8d43fc1678c924fe6a`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_VERSION=8.5.98
# Tue, 09 Jan 2024 23:00:04 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Tue, 09 Jan 2024 23:00:04 GMT
COPY dir:ec85dd8340a9e673d1a3cd28512b092d66a66ee4e87fbea031945041cb7cd04b in /usr/local/tomcat 
# Tue, 09 Jan 2024 23:00:12 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:2d4d793cbb0ed08e74c28e3bbca4c466d6c26dc4a8d1450a95b4de41006edf49`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31e878471eb360ff485b05ca41549bb8dd5c10e19ac6eef25ce0c45a1a012ff7`  
		Last Modified: Tue, 09 Jan 2024 23:26:36 GMT  
		Size: 11.5 MB (11478698 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c423eb05f263d87aaced380ccd6e376d3e1ffd749d24597bcf9b1a8933890c31`  
		Last Modified: Tue, 09 Jan 2024 23:26:35 GMT  
		Size: 489.6 KB (489564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc5bcb889077d414e3136ccc26beb3d07ea707dd1d49d712fcd6b0b8fb592616`  
		Last Modified: Tue, 09 Jan 2024 23:26:35 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
