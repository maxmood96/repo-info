...
```console
$ docker pull tomcat@sha256:5d1e38a9b9e28f5e622b11f1b01d3de1a4e3865a32ca31221c67c4e8489a35e9
```
...
### `tomcat:10.1.42-jdk21-temurin-noble` - linux; amd64
...
### `tomcat:10.1.42-jdk21-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.42-jdk21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.42-jdk21-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.42-jdk21-temurin-noble` - linux; riscv64
...
### `tomcat:10.1.42-jdk21-temurin-noble` - linux; s390x
