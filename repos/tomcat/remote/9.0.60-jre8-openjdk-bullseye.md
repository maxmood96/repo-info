## `tomcat:9.0.60-jre8-openjdk-bullseye`

```console
$ docker pull tomcat@sha256:93a94e8dd313964132ab2b6a881c0df3e93f79320fc82e877e0336f9dc4c3802
```
...
### `tomcat:9.0.60-jre8-openjdk-bullseye` - linux; amd64

```console
$ docker pull tomcat@sha256:4766a011a8d42b5f1b0cb6235cd6beba0d59c965a2813310aa0da95d179d7923
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.6 MB (130577029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05bd98830e072680b2845ab106b45e4baa5877c26304bb8a9dd19beba1cf695c`
...
# Sun, 20 Mar 2022 11:39:35 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Sun, 20 Mar 2022 11:39:35 GMT
ENV TOMCAT_MAJOR=9
# Sun, 20 Mar 2022 11:39:36 GMT
...
# Sun, 20 Mar 2022 11:39:36 GMT
COPY dir:8fc375e17bdbf259a5a157261e12baf41d0e2844e4cffd7fca5571903c8c83db in /usr/local/tomcat 
# Sun, 20 Mar 2022 11:39:39 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 11:39:40 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sun, 20 Mar 2022 11:39:41 GMT
EXPOSE 8080
# Sun, 20 Mar 2022 11:39:41 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c64d0b8e6c95cbb78d122d89716470b0e497575435336d83f4c9226a769b084b`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:781e17253e42388ff2e576d333f2740de8ce3c3593a0a741cd4002f6464ad910`  
		Last Modified: Sun, 20 Mar 2022 12:24:27 GMT  
		Size: 12.1 MB (12124056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b6efe33c1df3d71a492c1890e70e820d8308d1ce5a52627a7539eccb79cb204`  
		Last Modified: Sun, 20 Mar 2022 12:24:26 GMT  
		Size: 459.6 KB (459624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:289035b238627cd1b57a1339dd39ad7484fd1fa46a5e8c14ab9c604391a2c999`  
		Last Modified: Sun, 20 Mar 2022 12:24:26 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:9.0.60-jre8-openjdk-bullseye` - linux; arm64 variant v8
