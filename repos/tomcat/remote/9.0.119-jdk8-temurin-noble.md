...
```console
$ docker pull tomcat@sha256:f871d8942f41bc4e23fd270a4f21756eaebcf479b68c9b7047c6ee52e47991e7
```
...
### `tomcat:9.0.119-jdk8-temurin-noble` - linux; amd64
...
### `tomcat:9.0.119-jdk8-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.119-jdk8-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.119-jdk8-temurin-noble` - linux; arm64 variant v8
