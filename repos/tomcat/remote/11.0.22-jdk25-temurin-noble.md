...
### `tomcat:11.0.22-jdk25-temurin-noble` - linux; amd64
...
### `tomcat:11.0.22-jdk25-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.22-jdk25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.22-jdk25-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.22-jdk25-temurin-noble` - linux; riscv64
...
### `tomcat:11.0.22-jdk25-temurin-noble` - linux; s390x
