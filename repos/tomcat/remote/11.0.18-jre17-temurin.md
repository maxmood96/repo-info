...
```console
$ docker pull tomcat@sha256:717a9ea4b643adb125a990396d4a00550845e3edc49e7d527aded4515cd7ec06
```
...
### `tomcat:11.0.18-jre17-temurin` - linux; amd64
...
### `tomcat:11.0.18-jre17-temurin` - unknown; unknown
...
### `tomcat:11.0.18-jre17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.18-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.18-jre17-temurin` - linux; ppc64le
...
### `tomcat:11.0.18-jre17-temurin` - linux; s390x
