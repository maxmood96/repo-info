...
```console
$ docker pull tomcat@sha256:61c992a51f546649306c4f57d0b91d542c09109504aca39b84caceaaae9e68b3
```
...
### `tomcat:8.5.69-jdk8-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:8.5.69-jdk8-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:8.5.69-jdk8-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:8.5.69-jdk8-adoptopenjdk-hotspot` - linux; s390x
