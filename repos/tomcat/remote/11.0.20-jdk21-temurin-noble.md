...
```console
$ docker pull tomcat@sha256:3591a665c5b0b519e7400217d80cc2371d935ba6575e3b2790fd982aa41c332f
```
...
### `tomcat:11.0.20-jdk21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.20-jdk21-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.20-jdk21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.20-jdk21-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.20-jdk21-temurin-noble` - linux; s390x
