...
```console
$ docker pull tomcat@sha256:fa1e7dda698f6dd0cd988f5bab8805241a6fc138690a371ec8ef6c2d94f6ab08
```
...
### `tomcat:8.5.75-jre11-temurin` - linux; amd64
...
### `tomcat:8.5.75-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:8.5.75-jre11-temurin` - linux; ppc64le
...
### `tomcat:8.5.75-jre11-temurin` - linux; s390x
