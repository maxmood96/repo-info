...
```console
$ docker pull tomcat@sha256:2a1b4a72737c8041fb91da8e12348feaf484da01140d9fe8827b3c1595017cdd
```
...
```console
$ docker pull tomcat@sha256:f39fbbe432dfde39691e4207c47a09d054dc059d2a96734c0c8dce73fbb17171
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.1 MB (340051177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5603b427a517d81cc7877f2813d3696ecf9405c5cadcfedee63568a463b6b6f2`
...
# Tue, 01 Mar 2022 03:55:43 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 01 Mar 2022 03:55:44 GMT
EXPOSE 8080
# Tue, 01 Mar 2022 03:55:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:ed899f9e9475baed806c0c8e3159f66dfefec35444e1d8fc8b106dcc8093be1c`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7ef6912417fab311bdfb955722cc3d87d66e1955aa55fe20808ff700b0bdfaa`  
		Last Modified: Tue, 01 Mar 2022 05:00:42 GMT  
		Size: 12.8 MB (12841403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83c942fb7e25f3c8922b533a350652af7c229b9a374f8e4a79c6af3d396d4acd`  
		Last Modified: Tue, 01 Mar 2022 05:00:41 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
