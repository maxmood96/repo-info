...
```console
$ docker pull tomcat@sha256:287bb6a08c9e53700d8333135a374e8952a90f2103f13c1b50dbdfba989bf53e
```
...
```console
$ docker pull tomcat@sha256:dfac7e7ccf6657aaf6b3b34db78cba3aca16771a7423150545a7cb2b0b8214f3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.7 MB (339704689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:baae848e54cee52741b05c658e7c70fd116b175af1766ec75722c149c283b327`
...
# Wed, 22 Dec 2021 17:04:47 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 22 Dec 2021 17:04:48 GMT
EXPOSE 8080
# Wed, 22 Dec 2021 17:04:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:ee6b1639316f92cd4a06baa3f3d5d75e78db386795b9723df2171eccf1e73fcd`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46cde0a69971bbc037124b97a8c2ad08af2f6cf8ca0c938ee074c6863d0c8284`  
		Last Modified: Wed, 22 Dec 2021 17:46:06 GMT  
		Size: 12.8 MB (12843704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96624f008fec111c2246bcc8ac051ec2aa7e30f2f3d43ec428c6f9eee8388b14`  
		Last Modified: Wed, 22 Dec 2021 17:46:05 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:130a99fd6b5cc82f2bbf0b0725f8dcac19e8c14f16eb329be422a4abb87bbe08
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.3 MB (338294705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52dd4232365bdcb37325a97a0d3a5048b25a9739f21c23862a3a5d00e5c54995`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 21 Dec 2021 20:37:10 GMT
EXPOSE 8080
# Tue, 21 Dec 2021 20:37:11 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b64777e1e2acd132d5ff3e858c221d1a45ef7c0d9212d30d015da5ac0b884642`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:509eb4c2630081984f6dbfc541bf05ff4e534c0e9326a6a32323b51ed434a02b`  
		Last Modified: Tue, 21 Dec 2021 21:34:13 GMT  
		Size: 12.6 MB (12613221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
