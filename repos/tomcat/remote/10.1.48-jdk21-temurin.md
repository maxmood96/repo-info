...
```console
$ docker pull tomcat@sha256:0b2e3d8c26a4e7e3b006fd387fb9cc09c26c3a7e71d594c4926569bbc214325a
```
...
### `tomcat:10.1.48-jdk21-temurin` - linux; amd64
...
### `tomcat:10.1.48-jdk21-temurin` - unknown; unknown
...
### `tomcat:10.1.48-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.48-jdk21-temurin` - linux; ppc64le
...
### `tomcat:10.1.48-jdk21-temurin` - linux; s390x
