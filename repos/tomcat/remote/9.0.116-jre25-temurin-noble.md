...
```console
$ docker pull tomcat@sha256:f03eb35f75633804f5994ce0399770188b30807a3bc2fa93596f621971e11a36
```
...
### `tomcat:9.0.116-jre25-temurin-noble` - linux; amd64
...
### `tomcat:9.0.116-jre25-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.116-jre25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.116-jre25-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.116-jre25-temurin-noble` - linux; s390x
