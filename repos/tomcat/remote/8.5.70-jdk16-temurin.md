...
```console
$ docker pull tomcat@sha256:6604d335a3b909c33cc5285d0ee6a878988d089770478948005f68a246efbc56
```
...
### `tomcat:8.5.70-jdk16-temurin` - linux; amd64
...
### `tomcat:8.5.70-jdk16-temurin` - linux; ppc64le
...
### `tomcat:8.5.70-jdk16-temurin` - linux; s390x
