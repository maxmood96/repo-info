...
```console
$ docker pull tomcat@sha256:684511a9e9bf37f8756c7c0c7669234c2a5cc06a826a48c3b333421b67bc6c43
```
...
### `tomcat:9.0.71-jre8` - linux; amd64
...
### `tomcat:9.0.71-jre8` - linux; arm64 variant v8
...
### `tomcat:9.0.71-jre8` - linux; ppc64le
