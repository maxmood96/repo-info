## `tomcat:11.0.0-M11-jdk21-openjdk-slim-bookworm`
...
### `tomcat:11.0.0-M11-jdk21-openjdk-slim-bookworm` - linux; amd64
...
### `tomcat:11.0.0-M11-jdk21-openjdk-slim-bookworm` - linux; arm64 variant v8
