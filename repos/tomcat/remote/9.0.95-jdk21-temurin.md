## `tomcat:9.0.95-jdk21-temurin`

```console
$ docker pull tomcat@sha256:3aba1e27e9f589d59913160edf61e6f16e3d44f5a25737597b3f8952149241ac
```
...
### `tomcat:9.0.95-jdk21-temurin` - linux; amd64
...
### `tomcat:9.0.95-jdk21-temurin` - unknown; unknown
...
### `tomcat:9.0.95-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.95-jdk21-temurin` - linux; ppc64le
...
### `tomcat:9.0.95-jdk21-temurin` - linux; s390x
