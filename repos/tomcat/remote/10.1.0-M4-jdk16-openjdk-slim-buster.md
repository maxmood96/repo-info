## `tomcat:10.1.0-M4-jdk16-openjdk-slim-buster`
...
### `tomcat:10.1.0-M4-jdk16-openjdk-slim-buster` - linux; amd64
...
### `tomcat:10.1.0-M4-jdk16-openjdk-slim-buster` - linux; arm64 variant v8
