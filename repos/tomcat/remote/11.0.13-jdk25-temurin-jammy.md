## `tomcat:11.0.13-jdk25-temurin-jammy`
...
### `tomcat:11.0.13-jdk25-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.13-jdk25-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.13-jdk25-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.13-jdk25-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.13-jdk25-temurin-jammy` - linux; s390x
