## `tomcat:10.0.17-jre8-openjdk-buster`

```console
$ docker pull tomcat@sha256:714b51eaf0ddf79be6364943b5a9356ee29d63a65983d6eae8136ba4e5f57f4b
```
...
### `tomcat:10.0.17-jre8-openjdk-buster` - linux; amd64
