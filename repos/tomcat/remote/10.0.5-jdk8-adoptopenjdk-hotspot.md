## `tomcat:10.0.5-jdk8-adoptopenjdk-hotspot`

```console
$ docker pull tomcat@sha256:c951c563459c3aa32f89663b75a50b3d9e92cd705bbc11f0d6fa122fda910575
```
...
### `tomcat:10.0.5-jdk8-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:10.0.5-jdk8-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:10.0.5-jdk8-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:10.0.5-jdk8-adoptopenjdk-hotspot` - linux; s390x
