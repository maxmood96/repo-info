...
```console
$ docker pull tomcat@sha256:94df8b80b99597e5ac4ee91f8fd0b6f195c1bbaa2d41921da643ea3cfd6bae26
```
...
```console
$ docker pull tomcat@sha256:82e5beeb6d9697e0f5abc7021c91279f9f2c9a0852795492dd0bc32f824089f6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.2 MB (102182578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:900e549890a0c7fb90d8cf89269dbcc4d35636c3e228ddb02d61b92fe7185025`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 08 Nov 2025 20:57:43 GMT
ENV TOMCAT_SHA512=fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d
# Mon, 10 Nov 2025 23:30:56 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 23:31:01 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 23:31:03 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 23:31:03 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 23:31:03 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:354500c15b0ea35f04caff699285f049d681ec84cbec398e9e3fbc3ca2dc13f0`  
		Last Modified: Mon, 10 Nov 2025 23:31:31 GMT  
		Size: 13.8 MB (13765292 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:808bfe6de5a529b6cccb95c6ed7b074f4effb79679e2ad361065bdaa094f09c9`  
		Last Modified: Mon, 10 Nov 2025 23:31:30 GMT  
...
```console
$ docker pull tomcat@sha256:0363e877e2254337f7317a2d532035786d030bf0a6943aa8f52de724c6af84d5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (3960071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6109f0fe49be8717d8416da605983acd1ba734338d1e5d11b07f613b2080adc`

```dockerfile
```

-	Layers:
	-	`sha256:6bedf9879ed10663a60490c48532547e7ec9b2b114a0c93a41b7bf7c427a858c`  
		Last Modified: Tue, 11 Nov 2025 00:35:42 GMT  
		Size: 3.9 MB (3938856 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7f3e6457b11eed5ab6afce450365bc50281c852318ac8e7d74aa60576ff389f5`  
		Last Modified: Tue, 11 Nov 2025 00:35:44 GMT  
