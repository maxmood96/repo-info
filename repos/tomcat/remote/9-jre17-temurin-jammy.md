...
```console
$ docker pull tomcat@sha256:08349ec49baf8d96a4e0e4f155f318a6d5b9426099ccd9240fc6cf67504cffb3
```
...
```console
$ docker pull tomcat@sha256:bbd2230c52591d1b60bf3c1dae15b35e5a18d8d1764f463a918b9c8d7eec2648
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.0 MB (113011925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84b7106dd660a04ee3aa7dfa2ddb3f9dfd518794e2aa33b41b891a286a3f6c08`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 08 Nov 2025 22:14:06 GMT
ENV TOMCAT_SHA512=fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d
# Mon, 10 Nov 2025 21:23:13 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 21:23:19 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 21:23:20 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 21:23:20 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 21:23:20 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f83855b829718bb4bf8ecc86fb87c821820f308b5998220db84efbf0385f0dd8`  
		Last Modified: Mon, 10 Nov 2025 21:23:44 GMT  
		Size: 13.8 MB (13798526 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b954f0defcde19de165d4d34ee31ac7c756edc52f1744aaeb55ec280c4378405`  
		Last Modified: Mon, 10 Nov 2025 21:23:42 GMT  
...
```console
$ docker pull tomcat@sha256:036855cccd66b27ee1effcd8dc5a588b1108e5602faa32459e017218ddc085f8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (3962621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e3d1632cf212c557190140db052e28f53ae2b54c9d3e0afeecd98c20471488c`

```dockerfile
```

-	Layers:
	-	`sha256:80950da291c28fb0e84bc21d37f65641d4096cd3c81b2f939b67361d8af0cd97`  
		Last Modified: Tue, 11 Nov 2025 00:35:38 GMT  
		Size: 3.9 MB (3941353 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3cf52536cb91a1c5bf96ef5f9acbce369cd9c5f0e92ab8d537b55200aaab47d8`  
		Last Modified: Tue, 11 Nov 2025 00:35:38 GMT  
