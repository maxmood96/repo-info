...
```console
$ docker pull tomcat@sha256:02ed4642a65fd3899c21d3148d8e95d1694d2510d429723622c919bb751bdacc
```
...
### `tomcat:9.0.83-jdk11-corretto` - linux; amd64
...
### `tomcat:9.0.83-jdk11-corretto` - linux; arm64 variant v8
