...
```console
$ docker pull tomcat@sha256:7beb06060408b42cfa4985b9df34bacde18c33180bc03671632b064a9c0defbd
```
...
### `tomcat:10.0.22-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:10.0.22-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.0.22-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.0.22-jre11-temurin-jammy` - linux; s390x
