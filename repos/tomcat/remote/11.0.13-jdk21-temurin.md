...
```console
$ docker pull tomcat@sha256:0718ef4b6ab6ae2951fd1519560e54cb891069aeb8057582d4bb941554067e58
```
...
### `tomcat:11.0.13-jdk21-temurin` - linux; amd64
...
### `tomcat:11.0.13-jdk21-temurin` - unknown; unknown
...
### `tomcat:11.0.13-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.13-jdk21-temurin` - linux; ppc64le
...
### `tomcat:11.0.13-jdk21-temurin` - linux; s390x
