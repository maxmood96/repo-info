...
```console
$ docker pull tomcat@sha256:8529457d3386a0f339df917224b054d5d278b9b28e2dcad4e890f94aa48197b1
```
...
### `tomcat:11.0.15-jre25-temurin` - linux; amd64
...
### `tomcat:11.0.15-jre25-temurin` - unknown; unknown
...
### `tomcat:11.0.15-jre25-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.15-jre25-temurin` - linux; ppc64le
...
### `tomcat:11.0.15-jre25-temurin` - linux; s390x
