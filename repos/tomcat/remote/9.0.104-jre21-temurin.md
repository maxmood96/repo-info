...
```console
$ docker pull tomcat@sha256:5bf7c2dfe9f1f2b1f584b5294137b69fe70f5fcc6034e1bd3e2d7bd311104630
```
...
### `tomcat:9.0.104-jre21-temurin` - linux; amd64
...
### `tomcat:9.0.104-jre21-temurin` - unknown; unknown
...
### `tomcat:9.0.104-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.104-jre21-temurin` - linux; ppc64le
...
### `tomcat:9.0.104-jre21-temurin` - linux; s390x
