...
```console
$ docker pull tomcat@sha256:0d18cc482f50dfa28821d406b4495a5c622fe6e877a304f2a38751b640a7bd85
```
...
```console
$ docker pull tomcat@sha256:b6d28da70bf2cc5dabaf10378112b94682ee68c6b982b0ef74e6002673cf1ee4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.5 MB (99475518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acd46ee82cac993eb1f43c185f989f1366d9819b197a3b51ab773492d4dda839`
...
# Thu, 16 Mar 2023 08:11:49 GMT
COPY dir:e0d9aeacc49d97330b0ca8bda28014edb1d2a3fb9dc79ea4d782b0b6290afcc9 in /usr/local/tomcat 
# Thu, 16 Mar 2023 08:11:53 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Mar 2023 08:11:55 GMT
...
-	Layers:
	...
	-	`sha256:a8c77d4a8a1be6548a0d422ce60d06f30177d706f1b0a1f9a2d8182a9704520a`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd610bc4befbff2b6e7c3b6d2c3f9b3b5d36ef4ea6602f7672194b89d3f3a687`  
		Last Modified: Thu, 16 Mar 2023 08:27:22 GMT  
		Size: 12.3 MB (12283103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c219b0d49602b5cf5665f411090d4d1bc156ea186a42daf009229ef00a6b78b7`  
		Last Modified: Thu, 16 Mar 2023 08:27:21 GMT  
		Size: 448.2 KB (448184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88ad214fb5211af8072839cc2f5a3016ce6262f307ad59f7b5ada0f67c7a5115`  
		Last Modified: Thu, 16 Mar 2023 08:27:21 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:44e59f7ad1ecd261bb93aedf8256e13cded6529c6a1c11dfc873aa38a4a29546
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104891206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0d037a4fbf9c8762138e6397d07121117cb5d240cd254ca3808bac6ede62c91`
-	Default Command: `["catalina.sh","run"]`
...
COPY dir:7078176dd148080153b0001f020b81af3d8869385feb0eb2f7434784067e1848 in /usr/local/tomcat 
# Thu, 16 Mar 2023 09:37:10 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Mar 2023 09:37:15 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 16 Mar 2023 09:37:15 GMT
EXPOSE 8080
# Thu, 16 Mar 2023 09:37:15 GMT
...
-	Layers:
	...
	-	`sha256:915d095fa95ef0abf947215ad79e26813b1758c24acf01a798810d4aaf0da2c2`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:162c9d524fd62cbc60a7463d726b546a0a2669cfc1d93a44edc3d25d57a7c5e7`  
		Last Modified: Thu, 16 Mar 2023 10:06:33 GMT  
		Size: 12.3 MB (12323620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:512e2744683d1c2eb6eddb1af1e07a4759e85d34a196dd81af0728627f27380e`  
		Last Modified: Thu, 16 Mar 2023 10:06:32 GMT  
		Size: 474.0 KB (473971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bb2c58d099aa80cbf1a3731db81369604e43020a092c539be6d080d1628f41b`  
		Last Modified: Thu, 16 Mar 2023 10:06:31 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
