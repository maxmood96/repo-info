...
### `tomcat:9.0.113-jre25-temurin-noble` - linux; amd64
...
### `tomcat:9.0.113-jre25-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.113-jre25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.113-jre25-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.113-jre25-temurin-noble` - linux; riscv64
...
### `tomcat:9.0.113-jre25-temurin-noble` - linux; s390x
