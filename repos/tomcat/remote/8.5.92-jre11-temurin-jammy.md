...
```console
$ docker pull tomcat@sha256:b6b109b48d022acb050ef41dcdeab727fcf61a2179dfc420a213b8365fe4177f
```
...
### `tomcat:8.5.92-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.92-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.92-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:8.5.92-jre11-temurin-jammy` - linux; s390x
