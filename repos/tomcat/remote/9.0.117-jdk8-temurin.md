...
### `tomcat:9.0.117-jdk8-temurin` - linux; amd64
...
### `tomcat:9.0.117-jdk8-temurin` - unknown; unknown
...
### `tomcat:9.0.117-jdk8-temurin` - linux; arm variant v7
...
### `tomcat:9.0.117-jdk8-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.117-jdk8-temurin` - linux; ppc64le
