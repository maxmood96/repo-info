...
```console
$ docker pull tomcat@sha256:6e45e020704c7f215c8f703318771462fb867211f9e0660db185927cdde14858
```
...
### `tomcat:8.5.85-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.85-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.85-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.85-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:8.5.85-jre17-temurin-jammy` - linux; s390x
