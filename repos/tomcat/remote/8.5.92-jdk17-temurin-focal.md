...
```console
$ docker pull tomcat@sha256:8a2da24c312e4edb8a860d73166f459dd33dfa0cb7b7c1849d6c4ad5cd872745
```
...
### `tomcat:8.5.92-jdk17-temurin-focal` - linux; amd64
...
### `tomcat:8.5.92-jdk17-temurin-focal` - linux; arm variant v7
...
### `tomcat:8.5.92-jdk17-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.92-jdk17-temurin-focal` - linux; s390x
