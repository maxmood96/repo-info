## `tomcat:10.1.12-jdk11`

```console
$ docker pull tomcat@sha256:1a5607797f1c1c23667ae40b1c56eb749b50f821062b8c2c47fe66c38c51d423
```
...
### `tomcat:10.1.12-jdk11` - linux; amd64
...
### `tomcat:10.1.12-jdk11` - linux; arm variant v7
...
### `tomcat:10.1.12-jdk11` - linux; ppc64le
...
### `tomcat:10.1.12-jdk11` - linux; s390x
