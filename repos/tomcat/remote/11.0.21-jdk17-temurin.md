...
```console
$ docker pull tomcat@sha256:c2e348c12e8106efd951192b747885a0de12dc8d2a15e37e532e9eeffa2bba61
```
...
### `tomcat:11.0.21-jdk17-temurin` - linux; amd64
...
### `tomcat:11.0.21-jdk17-temurin` - unknown; unknown
...
### `tomcat:11.0.21-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.21-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.21-jdk17-temurin` - linux; ppc64le
...
### `tomcat:11.0.21-jdk17-temurin` - linux; s390x
