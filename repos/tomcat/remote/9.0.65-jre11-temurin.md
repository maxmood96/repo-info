...
```console
$ docker pull tomcat@sha256:bba4274633993d41f1e7d0cd95394fa4ff200ccc97e330fd4a2e97e885e9c5e8
```
...
### `tomcat:9.0.65-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.65-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.65-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.65-jre11-temurin` - linux; ppc64le
