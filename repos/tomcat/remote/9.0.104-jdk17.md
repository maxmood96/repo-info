...
```console
$ docker pull tomcat@sha256:a3a789d987c4471560412c82fd7b751e5ec98cadc7a3760320e15e245f70c2b0
```
...
### `tomcat:9.0.104-jdk17` - linux; amd64
...
### `tomcat:9.0.104-jdk17` - unknown; unknown
...
### `tomcat:9.0.104-jdk17` - linux; arm variant v7
...
### `tomcat:9.0.104-jdk17` - linux; ppc64le
...
### `tomcat:9.0.104-jdk17` - linux; s390x
