...
```console
$ docker pull tomcat@sha256:0fbca4f020832ea56e690b8f00dce4d30e215afa67d7afa3977718a938b9c2b9
```
...
### `tomcat:9.0.86-jre8-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.86-jre8-temurin-focal` - linux; ppc64le
