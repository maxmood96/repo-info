...
```console
$ docker pull tomcat@sha256:e0e1eab2e9f25b19f4d16010628f58b70ba346a0ba2713bf888ebeccae93b96c
```
...
### `tomcat:10.1.28-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.28-jdk21-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.28-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.28-jdk21-temurin-jammy` - linux; ppc64le
