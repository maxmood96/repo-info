...
```console
$ docker pull tomcat@sha256:265ca2bc0f7516afcd52998e28d8c7705f3fa2a5608396b016f90d08347fcec8
```
...
```console
$ docker pull tomcat@sha256:e6070ac0ca59fe9285074cb817cb1524e7b840a96959024c69503c3a3599d5d3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.5 MB (243533779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8206074e1443e8dc032245dc230a86c3d24870ca2a397b4e64159508db9c660`
...
# Thu, 21 Jan 2021 05:17:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 21 Jan 2021 05:17:16 GMT
EXPOSE 8080
# Thu, 21 Jan 2021 05:17:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6e211c68874d4eb021ca5f6b2d770726144c655fea9d2a34ad3d279ff57fbe32`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d002c235b9c6535f7d0c94e3d97e32d8b84a55ed787a1f10bc88bedcaf01ef86`  
		Last Modified: Thu, 21 Jan 2021 05:32:39 GMT  
		Size: 12.3 MB (12299782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9431e5add0825f8bb90e30a1bdbf7979c424e67fa0be017708815eb960ed0880`  
		Last Modified: Thu, 21 Jan 2021 05:32:37 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
