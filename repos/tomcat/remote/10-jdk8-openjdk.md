...
```console
$ docker pull tomcat@sha256:e6f290df91aa7372cab28be1f2e3bf60b39e3b1844f52b3c8a2fcc90d8d4b0f4
```
...
```console
$ docker pull tomcat@sha256:e6ceef38abfb65d8bb7d55da61949c7059c21915bdc44c71bf3ed2adbd9d320f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.3 MB (242272758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5a0aefcf3bbe8b9373da4a07b71f1e33153d5977986997cc88e92fa28db468c`
...
# Wed, 05 Aug 2020 19:20:09 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Aug 2020 19:20:09 GMT
EXPOSE 8080
# Wed, 05 Aug 2020 19:20:10 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:4aa5acb4765bc36031495e43b94457709bb151f5bbf94957dd7892434ff93c9a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7973809c8cc148b62814f3b5db58cd14f5365ab92058462bc2fd158dfd3fba6`  
		Last Modified: Wed, 05 Aug 2020 19:33:41 GMT  
		Size: 12.1 MB (12112122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf83c5665178ed2a46d517340742701df20de535d031165a41f04167fa4d0ca5`  
		Last Modified: Wed, 05 Aug 2020 19:33:40 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
