...
### `tomcat:11.0.9-jre21-temurin` - linux; amd64
...
### `tomcat:11.0.9-jre21-temurin` - unknown; unknown
...
### `tomcat:11.0.9-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.9-jre21-temurin` - linux; ppc64le
...
### `tomcat:11.0.9-jre21-temurin` - linux; riscv64
...
### `tomcat:11.0.9-jre21-temurin` - linux; s390x
