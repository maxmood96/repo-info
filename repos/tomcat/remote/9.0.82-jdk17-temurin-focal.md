...
```console
$ docker pull tomcat@sha256:eec99640f0c5283fd72d0c8350fba2a3b4494b8ed729886e7f205e7090cbf8e3
```
...
### `tomcat:9.0.82-jdk17-temurin-focal` - linux; amd64
...
### `tomcat:9.0.82-jdk17-temurin-focal` - linux; arm variant v7
...
### `tomcat:9.0.82-jdk17-temurin-focal` - linux; ppc64le
...
### `tomcat:9.0.82-jdk17-temurin-focal` - linux; s390x
