## `tomcat:9.0.45-jdk15-adoptopenjdk-hotspot`

```console
$ docker pull tomcat@sha256:55880cab9df044a6fcfebe515d65daf43b6e7018c9b3715d575361d2bf2d9391
```
...
### `tomcat:9.0.45-jdk15-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:9.0.45-jdk15-adoptopenjdk-hotspot` - linux; arm variant v7
...
### `tomcat:9.0.45-jdk15-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:9.0.45-jdk15-adoptopenjdk-hotspot` - linux; s390x
