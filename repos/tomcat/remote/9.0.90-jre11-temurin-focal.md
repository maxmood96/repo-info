...
### `tomcat:9.0.90-jre11-temurin-focal` - linux; amd64
...
### `tomcat:9.0.90-jre11-temurin-focal` - unknown; unknown
...
### `tomcat:9.0.90-jre11-temurin-focal` - linux; arm variant v7
...
### `tomcat:9.0.90-jre11-temurin-focal` - linux; s390x
