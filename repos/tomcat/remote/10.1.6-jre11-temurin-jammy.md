...
```console
$ docker pull tomcat@sha256:a69fa16034bd3ca8c34682c6aa73bef5b534e76ec111d5c6d047262af0c05e62
```
...
### `tomcat:10.1.6-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.6-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.6-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.6-jre11-temurin-jammy` - linux; s390x
