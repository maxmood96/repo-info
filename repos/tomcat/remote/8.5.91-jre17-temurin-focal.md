...
```console
$ docker pull tomcat@sha256:891d8e709047873908887b8515cf2ccf8142ad42d235a794a7f0660b227c6ce3
```
...
```console
$ docker pull tomcat@sha256:b2ba05288e606da24b7d811e9eadc91229c1b5f8b186b0a6d62f9b35357f6be7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.3 MB (102326919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88b557801d1fc5ccf687b528ecd4d66b749f954558f16d61675b5fc0878d91ea`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 03 Aug 2023 07:39:34 GMT
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Thu, 03 Aug 2023 07:39:35 GMT
COPY dir:83f995b7817ae9d40eeb712ae2cebc21b19ec1db4ff7c3984515e3b8f4836be1 in /usr/local/tomcat 
# Thu, 03 Aug 2023 07:39:41 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Aug 2023 07:39:43 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 03 Aug 2023 07:39:43 GMT
EXPOSE 8080
# Thu, 03 Aug 2023 07:39:43 GMT
...
-	Layers:
	...
	-	`sha256:3f4e04e4b338727b77514ca629f52799a4471290c6fca2cb4e4acdf06ee57414`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0eb2f3a87e5020a3e29bddce453e177177baef7e564fcd92bb5bb7a9fee279c`  
		Last Modified: Thu, 03 Aug 2023 07:44:01 GMT  
		Size: 11.4 MB (11399740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98fa0dd5bfe59aba1815460be3eb304ec8d9163f90a2b21e76b40ea21ed2a035`  
		Last Modified: Thu, 03 Aug 2023 07:44:00 GMT  
		Size: 453.5 KB (453460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78fbf488e2e795f73325dd8419ac39d3f06b15e068352e282381b19c0638913c`  
		Last Modified: Thu, 03 Aug 2023 07:44:00 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
