...
```console
$ docker pull tomcat@sha256:5a3c0fb7846d492ddbe2d53d22cab1b5c84266ff450d70a0b1b78ec864034cc1
```
...
```console
$ docker pull tomcat@sha256:39fe9f33a83985abd3c93e1f872a787761fe0c86ce4406ded724350b3e9e59c4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.6 MB (100611158 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4984aacb0b28a999f165a9ac31766e06b578f744820b5c428af6b9828f966e65`
-	Default Command: `["catalina.sh","run"]`
...
RUN echo Verifying install ...     && fileEncoding="$(echo 'System.out.println(System.getProperty("file.encoding"))' | jshell -s -)"; [ "$fileEncoding" = 'UTF-8' ]; rm -rf ~/.java     && echo java --version && java --version     && echo Complete.
# Tue, 25 Jul 2023 23:19:38 GMT
ENV CATALINA_HOME=/usr/local/tomcat
# Tue, 25 Jul 2023 23:19:38 GMT
ENV PATH=/usr/local/tomcat/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 25 Jul 2023 23:19:39 GMT
RUN mkdir -p "$CATALINA_HOME"
# Tue, 25 Jul 2023 23:19:39 GMT
WORKDIR /usr/local/tomcat
# Tue, 25 Jul 2023 23:19:39 GMT
...
# Tue, 25 Jul 2023 23:21:21 GMT
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Tue, 25 Jul 2023 23:21:22 GMT
COPY dir:8f5443385de1465de90cde547981d426de264a7f4f931fe54fef065a6d47f33a in /usr/local/tomcat 
# Tue, 25 Jul 2023 23:21:25 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 25 Jul 2023 23:21:27 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 25 Jul 2023 23:21:27 GMT
EXPOSE 8080
# Tue, 25 Jul 2023 23:21:27 GMT
...
-	Layers:
	...
	-	`sha256:20c8a317bb7cf4e8db05d340c296ca86087d40d75edd55d5387be07d4a365ec8`  
		...
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:638267d71f69a118147d401a767e7ce4eaa55010267761b99f513093480d5e42`  
		Last Modified: Tue, 25 Jul 2023 23:25:31 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bbde8c1e925e01a9826f64bcb2291c67ba09be670a6c882800d0645ec18c1fe`  
		Last Modified: Tue, 25 Jul 2023 23:27:09 GMT  
		Size: 11.3 MB (11336901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:112f35d4af8c57f04b09abf8162d8b23057f68d229e10c8b9cb12c56faea9039`  
		Last Modified: Tue, 25 Jul 2023 23:27:08 GMT  
		Size: 427.0 KB (427021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1df80e009f375e1f6c58e198a0e243adc0acadae7df97aa79119819909967864`  
		Last Modified: Tue, 25 Jul 2023 23:27:08 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
