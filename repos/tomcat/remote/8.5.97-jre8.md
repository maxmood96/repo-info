...
```console
$ docker pull tomcat@sha256:0ccd8afbcad2d62f6a85381cb94100675d96848d124c7b021febd59adc422aaa
```
...
### `tomcat:8.5.97-jre8` - linux; amd64
...
### `tomcat:8.5.97-jre8` - linux; arm variant v7
...
### `tomcat:8.5.97-jre8` - linux; arm64 variant v8
...
### `tomcat:8.5.97-jre8` - linux; ppc64le
