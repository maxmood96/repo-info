...
```console
$ docker pull tomcat@sha256:2d7c0be5c0171913f4a7b939af8b8efcda29f30b98f2f0673614c5a1a4acc724
```
...
```console
$ docker pull tomcat@sha256:679c05f9b19a32eb3293f991dc46e17ae38f1ea7e2c61fc9a87429deda1a9244
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.3 MB (333259611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a09f81c727b6510749b6f89d17f14a044242aa29f2216bed4b61f0b6329b5a8f`
...
# Thu, 20 Jan 2022 01:08:57 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 20 Jan 2022 01:08:57 GMT
EXPOSE 8080
# Thu, 20 Jan 2022 01:08:58 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5578c019a7a2c31e6849efba4ca08b84d1a3256734fa3edbcf921ac222e6832a`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:614d7afe78d605c90baeedcb906c46cbba7fafec38e874a57a055ea2cc451e3d`  
		Last Modified: Thu, 20 Jan 2022 01:38:03 GMT  
		Size: 11.6 MB (11596516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae0fb6e6d8a74a0db8ea7cf4a276e38061be0de76453b7a90835c8ec01285697`  
		Last Modified: Thu, 20 Jan 2022 01:38:01 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
