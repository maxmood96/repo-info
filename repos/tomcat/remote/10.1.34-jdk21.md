...
```console
$ docker pull tomcat@sha256:b432d25e27bc37b073bb121e0d404535d50f5dfb767bc15d6107b849b8687377
```
...
### `tomcat:10.1.34-jdk21` - linux; amd64
...
### `tomcat:10.1.34-jdk21` - unknown; unknown
...
### `tomcat:10.1.34-jdk21` - linux; arm64 variant v8
...
### `tomcat:10.1.34-jdk21` - linux; ppc64le
...
### `tomcat:10.1.34-jdk21` - linux; s390x
