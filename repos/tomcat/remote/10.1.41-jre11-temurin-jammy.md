...
### `tomcat:10.1.41-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.41-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.41-jre11-temurin-jammy` - linux; s390x
