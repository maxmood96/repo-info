...
```console
$ docker pull tomcat@sha256:46d9a889466ec43629c0474759b510f56dbf41955a7b6f3c0dfbc35f972fc867
```
...
### `tomcat:10.1.10-jdk17-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.10-jdk17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.10-jdk17-temurin-jammy` - linux; ppc64le
