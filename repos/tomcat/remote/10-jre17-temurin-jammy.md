...
```console
$ docker pull tomcat@sha256:da888adf9a137f5c63c6753e74e4de48ca9c4a278f57cbf283417f144d5f0e69
```
...
```console
$ docker pull tomcat@sha256:d599c325f22d41d376d02edeb0024fa196f8bb52706ae81b3fbdd3e767a63103
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102527564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fd36f27a5a29955a7f6bde0dad7eec0b184922620abd61ada08dd76de8fd2dc`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 08 Nov 2025 20:57:43 GMT
ENV TOMCAT_SHA512=a46c8e37d4767b56a16dbdd8e81b80f25ad2edd5fba68b5099b9165cfffbe32bc923a601db8bb5cba50e8b1047a7906eb8c30ca176e1c0b8dfd85fbb9c54c6c2
# Mon, 10 Nov 2025 23:25:06 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 23:25:11 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 23:25:12 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 23:25:12 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 23:25:12 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d5e0ba91b293ae6c7aab7ceaf45bd7014d4f07720d4762f094b5521b03ee13b6`  
		Last Modified: Mon, 10 Nov 2025 23:25:36 GMT  
		Size: 14.1 MB (14110281 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:92275ba038fefdd6874b0a029d2345d95a4d97fcf902ba775f8fde81f84b81b9`  
		Last Modified: Mon, 10 Nov 2025 23:25:32 GMT  
...
```console
$ docker pull tomcat@sha256:39c1d530f17fcd0d5e6c5db63295a893977aa6e25be47dd6ac6d517d457d8df4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (3964262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3754f21a08a61d1f7591037bf44312267ca1b942ebcdc9a3a30b0cb98a9f6167`

```dockerfile
```

-	Layers:
	-	`sha256:9c10c506b73ff5186a0c1cf6cf27f686c23c2911665df06a5852c37b4dd79cda`  
		Last Modified: Tue, 11 Nov 2025 00:29:15 GMT  
		Size: 3.9 MB (3943040 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:83f395196142b3a719233bbdbb8466b881f326da9944d373be8df3b08f7bfc73`  
		Last Modified: Tue, 11 Nov 2025 00:29:17 GMT  
