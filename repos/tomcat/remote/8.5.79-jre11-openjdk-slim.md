...
```console
$ docker pull tomcat@sha256:d063cdd7779a8febbc153f07c3b122b6ba40ab04fc2e84ffe9ee5192d7cd72d6
```
...
```console
$ docker pull tomcat@sha256:4cb5187aca9053e13e7709f9a01c1c16b4b4bc14df1e0ebfcc6cc5576f258682
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.3 MB (91321061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24575b098765e3692730a67cfc9f2116d9e471621bdc7e44d7fa3960fe2e72d7`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=8
# Tue, 24 May 2022 20:39:48 GMT
ENV TOMCAT_VERSION=8.5.79
# Tue, 24 May 2022 20:39:48 GMT
ENV TOMCAT_SHA512=ae059a595ba11386bf3c0a80e961c5f8bb057b2bab987c3863337311e95d4fa22f1185a44b2c8856dd33f7cfe76d4de4e2fe1bc8b89c6abfbfc008656c49b8c0
# Tue, 24 May 2022 20:39:50 GMT
COPY dir:152acf13ad7b84aed2112d7e6defdc7af8e7e25d8a080fc02a3572c965f47a8e in /usr/local/tomcat 
# Tue, 24 May 2022 20:39:54 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 24 May 2022 20:39:56 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 24 May 2022 20:39:57 GMT
EXPOSE 8080
# Tue, 24 May 2022 20:39:58 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b36888dabaf6a00bd7afdf75350c9f2240a02ac17ec7f24a44e6703d59a3e186`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7b982a356eb80afda58c9993c5726810ce3754c258bcf3338e924b27d410a4a`  
		Last Modified: Tue, 24 May 2022 21:12:21 GMT  
		Size: 11.2 MB (11176034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:989684bd95ba9e5696cbd25b9874dac20bf04ee3aaae7b150aeadfba9e10b4b2`  
		Last Modified: Tue, 24 May 2022 21:12:20 GMT  
		Size: 2.2 MB (2161543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
