...
```console
$ docker pull tomcat@sha256:abc950d0c3985aad7298ffffb991f73cf669f0d9375ed822d56c3da838fb453f
```
...
### `tomcat:10.1.49-jre25-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.49-jre25-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.49-jre25-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.49-jre25-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.49-jre25-temurin-jammy` - linux; s390x

```console
$ docker pull tomcat@sha256:6829bed5a67ef1729c49a33318ee1178ddc4c78a9c2b1dcd0a4b1f6cd5f27848
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.1 MB (114139200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dddf5bc7ebdded51fad9a17f737185a90ded3e3b760d0a1a1f2b9e79d5c1ddb2`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 08 Nov 2025 21:27:31 GMT
ENV TOMCAT_SHA512=a46c8e37d4767b56a16dbdd8e81b80f25ad2edd5fba68b5099b9165cfffbe32bc923a601db8bb5cba50e8b1047a7906eb8c30ca176e1c0b8dfd85fbb9c54c6c2
# Mon, 10 Nov 2025 23:22:45 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 23:22:48 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 23:22:48 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 23:22:48 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4fa5b85b3ac9a6c4b484975ffaf1921e2bef0f29535d0b9c5691383ee9ed1846`  
		Last Modified: Mon, 10 Nov 2025 23:23:31 GMT  
		Size: 14.1 MB (14110953 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d0ba8daa9c0fa6cdc3a0a381b0c6c79ca78713336153fd8648f4343eb70385d8`  
		Last Modified: Mon, 10 Nov 2025 23:23:07 GMT  
		Size: 214.6 KB (214610 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 10 Oct 2025 22:54:50 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:063cd047f7f5489cfc16b317d19879706eab2157abc2e597e719b70d189e4d52
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3731361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fc3e07d3fbfc3f80ccecdee05836d827981c1cffedf15f588e36d9efe7cd0be`

```dockerfile
```

-	Layers:
	-	`sha256:13530fd239d2cc19b3748e78c921d032ca94372a44ecd1ead64d89fed5c906aa`  
		Last Modified: Tue, 11 Nov 2025 00:29:49 GMT  
		Size: 3.7 MB (3710152 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c477c3d034f26b5eb50e9fdc159e2222343900c1eace6303815a0f7a3b2234e6`  
		Last Modified: Tue, 11 Nov 2025 00:29:50 GMT  
