...
```console
$ docker pull tomcat@sha256:22a891621e902bff59a20b88232c9edbc439f9f2698b77e529d2910732bf11d8
```
...
```console
$ docker pull tomcat@sha256:5beac0d60b92b19f515e8284bad6f5415be515b84ace339187c4e86946071487
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.4 MB (136424122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:933eb2a8b1bb56f51b2f5632afd4b45094056ec7b0c282dd6480ca81ac24f2d8`
...
# Sun, 20 Mar 2022 11:09:43 GMT
COPY dir:8f6025aef09289827ad2c6725738658ca0bae92dfab54c52b86cdcee50a62bad in /usr/local/tomcat 
# Sun, 20 Mar 2022 11:09:47 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 11:09:48 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sun, 20 Mar 2022 11:09:48 GMT
EXPOSE 8080
# Sun, 20 Mar 2022 11:09:49 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:43cf10162fa0b1934276c143d800ae522ba3e6cfe30611688c8aa62424f73879`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c066ff39c5518792032c99e85e6bd8f626085fe9fe868ae75b0fe54e89c74c9c`  
		Last Modified: Sun, 20 Mar 2022 12:07:57 GMT  
		Size: 12.5 MB (12479321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1ce35912b189e92a0d6989d8d9ebd177280a707e60531920f7d4ef6a73b4e15`  
		Last Modified: Sun, 20 Mar 2022 12:07:56 GMT  
		Size: 459.6 KB (459640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6d5197548faa48c2fc8a268aa11854edc5d4dd5d252921ad8beddf99b2ee503`  
		Last Modified: Sun, 20 Mar 2022 12:07:55 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
