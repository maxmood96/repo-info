...
```console
$ docker pull tomcat@sha256:9aea0de1053ad1dd34375ef76611cb3fa09d61b5befc501f40d36db62649ba67
```
...
```console
$ docker pull tomcat@sha256:cd9051af9f09b2549bf67b7b9e3da7b891a4d2f0ad5832999bcff08c47b9ed05
```
...
-	Image ID: `sha256:871694056930195ac5a667f69e0d37d9bfc0c9ef00a033f656feb61add559693`
...
```console
$ docker pull tomcat@sha256:5fd55051d5ffea3773ade01f40776e4c5b22593c9cfb33a6925ecdede2c4d5c6
```
...
-	Total Size: **104.5 MB (104504424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d3d3d288f433be1172c9fda57c50758e79fd68c7e15178509ccbbebb1fdd42b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
