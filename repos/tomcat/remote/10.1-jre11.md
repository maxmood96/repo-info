...
```console
$ docker pull tomcat@sha256:8356f46f226d96b96e579139c077b1da7c43a30ff2acec2107d5929c68f9cce1
```
...
```console
$ docker pull tomcat@sha256:eeb2eac4af765981c323aa2bf783297bf4d2f9bd84a308e19dcc26a1f1a37331
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.8 MB (109781106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf29b1d90ca56ff78a93d2955dfc7176e689dac11720d3632de86ad40d300263`
-	Default Command: `["catalina.sh","run"]`
...
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Fri, 14 Nov 2025 08:29:17 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 14 Nov 2025 08:29:19 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Fri, 14 Nov 2025 08:29:19 GMT
EXPOSE map[8080/tcp:{}]
# Fri, 14 Nov 2025 08:29:19 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:799da4fd9536427515956ce7035622415e614cb2c28e971f9253d85e1c9e9704`  
		Last Modified: Fri, 14 Nov 2025 08:29:48 GMT  
		Size: 14.1 MB (14111948 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0eb72d820714eeb609bd40ef352f8e99d71d1be86df4305aec3cd5e8b24b8c19`  
		Last Modified: Fri, 14 Nov 2025 08:29:47 GMT  
...
```console
$ docker pull tomcat@sha256:8efcb4537177fef221b500938ec7b36d0f0efca5d673e5137b2857f49372fa11
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3389100 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bb6ba6f9906bc2903612b1dffeefdfd02baf7c62402ca675758e4dc119721c4`

```dockerfile
```

-	Layers:
	-	`sha256:e79ea0801c1eb825ebfddc178f9cbb962cdcbc27822e761e202f4037de722f8c`  
		Last Modified: Fri, 14 Nov 2025 09:28:44 GMT  
		Size: 3.4 MB (3365903 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8cfa53dabd09be4bf762c6df6164eeb8370302b582afb99c61647f2ac229882b`  
		Last Modified: Fri, 14 Nov 2025 09:28:45 GMT  
