...
```console
$ docker pull tomcat@sha256:0059c73712cda660debbf3b8ead53b91b417fc83cd2ee78ee0e5c12b1abed43b
```
...
```console
$ docker pull tomcat@sha256:bc9b2a445a74854e6ff0409116582c3980331236b34752dace5f146113612dcb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.7 MB (95730015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1c9e9ab9a89f2cc62c9de4f692f4e9003847e64d8728a9dea3f5f50baf73359`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 02 May 2024 03:20:10 GMT
ENV TOMCAT_MAJOR=10
# Mon, 13 May 2024 21:46:46 GMT
ENV TOMCAT_VERSION=10.1.24
# Mon, 13 May 2024 21:46:47 GMT
ENV TOMCAT_SHA512=793802f5cbbc0c4f722d3c63b52323df7ca37846445c254edcaaa7702fd71cf72aa9506b2b2c59322b9635e25f69913aa1b223098d9b4f1426f5f5447dd78ff3
# Mon, 13 May 2024 21:46:47 GMT
COPY dir:2640987dd00c80527d16eccae8c5393c40452fd54b9ee9df286dc117dbe540bb in /usr/local/tomcat 
# Mon, 13 May 2024 21:46:50 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 13 May 2024 21:46:52 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 13 May 2024 21:46:52 GMT
EXPOSE 8080
# Mon, 13 May 2024 21:46:52 GMT
...
-	Layers:
	...
	-	`sha256:002d62854c60c0f55c77f3a22389a82b88395f89fb76252d412ec8624010b669`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3eeceb0e7230fa722e0bd8f5a61b04b504d7c3ff5ad4c4b59824c11af1cab3b7`  
		Last Modified: Mon, 13 May 2024 21:52:08 GMT  
		Size: 12.8 MB (12846879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f445bd4942214187fb0e467d58334500b41262eb2d2657419cd4a5da3c35f2c`  
		Last Modified: Mon, 13 May 2024 21:52:07 GMT  
		Size: 457.9 KB (457901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78fa8542a62904693f5203a75265593c69be2d677a711a45ad130db4ff42dbbc`  
		Last Modified: Mon, 13 May 2024 21:52:07 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
