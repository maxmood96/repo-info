...
```console
$ docker pull tomcat@sha256:07e72a25e54a17ca3cc283ea72486cb2577fff0dbe378db3330c2b1763a5c53b
```
...
```console
$ docker pull tomcat@sha256:7db870c7a0c500e1a218c5e06aa79755fda3681a84e63b69754d6be357826efa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.6 MB (133636951 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a384ca77f6bf945e252c6f04b82fdf4c7be944d099badeeeea645daabdf342d5`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Mon, 15 Nov 2021 21:23:43 GMT
ENV TOMCAT_VERSION=10.1.0-M7
# Mon, 15 Nov 2021 21:23:44 GMT
ENV TOMCAT_SHA512=2dd4d2779021a00b684d9e59785656a2473cac37ec24a7b04b72b92c60793209ac17753d4ad7153e486856f751758446451766d078594feb020a0197b79cf039
# Mon, 15 Nov 2021 21:23:46 GMT
COPY dir:16cc9dc4a42159a4f2a1afda3ee6d6d86acdf8f58bfadeaaceab3999788c0ea3 in /usr/local/tomcat 
# Mon, 15 Nov 2021 21:23:49 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 15 Nov 2021 21:23:52 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 15 Nov 2021 21:23:52 GMT
EXPOSE 8080
# Mon, 15 Nov 2021 21:23:53 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d2d4a06b5d4439b89dbd20dbe4f51f73718dd744f6bd6c6209aed7c70d53f893`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc113789987e5608e6aafb360431c75c7c856b2e0138fa84d8318d8d7ac934ff`  
		Last Modified: Mon, 15 Nov 2021 22:10:09 GMT  
		Size: 12.5 MB (12452569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52ee14e7f26edec3f672a60e23701581aa1135bb4c28716da82444e94d93e723`  
		Last Modified: Mon, 15 Nov 2021 22:10:08 GMT  
		Size: 217.0 KB (217017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
