...
```console
$ docker pull tomcat@sha256:101a95cd182f473dc024d8cf585fc1f84c0018e48efe4bb7705ca5f00d164775
```
...
```console
$ docker pull tomcat@sha256:3e2dbc3a4eb6d7ca97490e4ff4e07947e8095aaf060c484a84f2b3998890a5d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.8 MB (97795630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1e8270dabc29b88b5f78028a320600dece353602e9b19fb16816d06abef6dcc`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Fri, 14 Oct 2022 01:49:03 GMT
ENV TOMCAT_VERSION=10.1.1
# Fri, 14 Oct 2022 01:49:04 GMT
ENV TOMCAT_SHA512=5718b877eb2d3fb05ec0c11d0af8a2bb34766e14b915ecda8d61e92670a7a911ff08c3cb03dafe8f28f10df19172ca0681ade953ccda5363fc5b57468a47476c
# Fri, 14 Oct 2022 01:49:06 GMT
COPY dir:41cf0c86ebadf41282817ddb2f89a3c88b8ba6a5d072587728f4b8d67bf4000c in /usr/local/tomcat 
# Fri, 14 Oct 2022 01:49:12 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Oct 2022 01:49:14 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 14 Oct 2022 01:49:15 GMT
EXPOSE 8080
# Fri, 14 Oct 2022 01:49:16 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6a35f750fc20e703152b852090896888ff46a0f8426adf60a0368838db583d9a`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19e94384284dc474dcbe782accd7f6130b5aecafcc6ade640e173e146dcf3877`  
		Last Modified: Fri, 14 Oct 2022 02:04:31 GMT  
		Size: 12.0 MB (11976739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1122fe155133a6848d3d0946451fa31703731bdc10a66a2b3f3a9118c993659`  
		Last Modified: Fri, 14 Oct 2022 02:04:30 GMT  
		Size: 214.3 KB (214345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:10.1-jre11` - linux; ppc64le

```console
$ docker pull tomcat@sha256:a4f5ca835b2cb02a5b2719d0e16eff27c2a9a12c36e2f31e1e1e0cac75333ccb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.3 MB (103336362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f5b9ce19050d26a9895467a06712013a0c0a970f9031106f3c1dcc360ffeb0a`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Fri, 14 Oct 2022 02:19:35 GMT
ENV TOMCAT_VERSION=10.1.1
# Fri, 14 Oct 2022 02:19:35 GMT
ENV TOMCAT_SHA512=5718b877eb2d3fb05ec0c11d0af8a2bb34766e14b915ecda8d61e92670a7a911ff08c3cb03dafe8f28f10df19172ca0681ade953ccda5363fc5b57468a47476c
# Fri, 14 Oct 2022 02:19:36 GMT
COPY dir:1c93389fb45ac40eac16ec55782a193d64daad6e3a7d375479f1ea9aad621c3e in /usr/local/tomcat 
# Fri, 14 Oct 2022 02:19:44 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Oct 2022 02:19:47 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 14 Oct 2022 02:19:47 GMT
EXPOSE 8080
# Fri, 14 Oct 2022 02:19:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:356e59bd8eaf37b45e35042c4109b26a797858b66a5bf50b0b6aeafc855f025c`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8374494cb7c3e5b3b0f0778533660eea7c98097befd9b5e127116548d03e889`  
		Last Modified: Fri, 14 Oct 2022 02:34:45 GMT  
		Size: 12.0 MB (11991572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17e2ff07a1ab4d27cd97ce44068ff597b589fe7a66a6db0eccde5e1aa05f6429`  
		Last Modified: Fri, 14 Oct 2022 02:34:43 GMT  
		Size: 484.0 KB (483961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f8cd801ad644d6e5b4fdadb4768f6de7fb357fdf40ed97260713c6212e25e3d`  
		Last Modified: Fri, 14 Oct 2022 02:34:43 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
