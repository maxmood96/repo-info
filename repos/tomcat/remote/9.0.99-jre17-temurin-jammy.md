...
```console
$ docker pull tomcat@sha256:ccdfac77f225a25987e0e220a7012ef19a05878ea25588083dd17d82de077e2c
```
...
### `tomcat:9.0.99-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.99-jre17-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.99-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.99-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.99-jre17-temurin-jammy` - linux; s390x
