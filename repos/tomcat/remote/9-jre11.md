...
```console
$ docker pull tomcat@sha256:cda1f6a75f6b02bf59c81de82c1403f7c3b7259d2bf5af857a057fb61a353bd7
```
...
```console
$ docker pull tomcat@sha256:def7b4341005657983fdf9171803bef1bb32cf542a6899cc1261d9ca90fb790a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.4 MB (103423974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:253abe32e1b789ca9b2c643018c6f8d18e1048d5e845906a66f399571cf06e29`
...
# Wed, 05 Jun 2024 08:15:10 GMT
COPY dir:4cd82c81effe423da1583f234387cf5c3da354187eaebe7923776012b78ad997 in /usr/local/tomcat 
# Wed, 05 Jun 2024 08:15:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jun 2024 08:15:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jun 2024 08:15:16 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 08:15:16 GMT
ENTRYPOINT []
# Wed, 05 Jun 2024 08:15:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d55d461b56bd1dd525b7c0c00fa10ce2aa0ee79e652347df5b1c5529cf20e495`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fc3fdcaf2ae546e94436f64c28194988e86664655efc990b3694ae5f4cfb6f5`  
		Last Modified: Wed, 05 Jun 2024 08:28:11 GMT  
		Size: 12.4 MB (12436384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:456cc5be3558a5ec78a568cb5dcbd874e54d261e2fcbf2490dab3f12b10019a6`  
		Last Modified: Wed, 05 Jun 2024 08:28:10 GMT  
		Size: 456.3 KB (456315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8eaa12db52fb7245f2616287a489a90331da89db47fb2c797f1499075843c8a`  
		Last Modified: Wed, 05 Jun 2024 08:28:10 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:46a61c19ba1ba3ed8ccef045daf7a6110e4b9128261923ed85f7a8378de3eb62
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.1 MB (98125683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d658cbfcf23c3ca34ebb78855fea34c626ea46c14f25206edcc165a4c3211c9c`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 05:41:26 GMT
ENV TOMCAT_VERSION=9.0.89
# Wed, 05 Jun 2024 05:41:27 GMT
ENV TOMCAT_SHA512=aaa2851bdc7a2476b6793e95174965c1c861531f161d8a138e87f8532b1af4d4b3d92dd1ae890614a692e5f13fb2e6946a1ada888f21e9d7db1964616b4181f0
# Wed, 05 Jun 2024 05:41:27 GMT
COPY dir:64db78bea6d5d2330d57e0baace6c7e7132586fbffd54bffc566bb34750810bc in /usr/local/tomcat 
# Wed, 05 Jun 2024 05:41:32 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jun 2024 05:41:33 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jun 2024 05:41:33 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 05:41:33 GMT
...
-	Layers:
	...
	-	`sha256:a139b7ef22ba6e162dbdfe31604051afe9ef4bfa2344270e49caeff7d90a2d1d`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c99fb73fd8f43e86f209249abe21110a99d299a184a0a745efe60ff51baf4b2`  
		Last Modified: Wed, 05 Jun 2024 05:48:00 GMT  
		Size: 12.4 MB (12370322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bae38966a6b0b7eb5927c3f841149ab853c2bc3e7765a05eb5a7ca8be483f54`  
		Last Modified: Wed, 05 Jun 2024 05:47:58 GMT  
		Size: 430.0 KB (430038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a824d9e207980c814a085bbe8f8fe63593808e366fd04c12901b3084e288f43d`  
		Last Modified: Wed, 05 Jun 2024 05:47:58 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:2c43a96719ef3e8dc2b676057138774327da3d00afbb1777f1ec250261c97a09
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.7 MB (99707378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29002c5b261b03d4a995ecde073270718848a491cf3e9aedb3d6685e42dc2a26`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 07:27:03 GMT
ENV TOMCAT_SHA512=aaa2851bdc7a2476b6793e95174965c1c861531f161d8a138e87f8532b1af4d4b3d92dd1ae890614a692e5f13fb2e6946a1ada888f21e9d7db1964616b4181f0
# Wed, 05 Jun 2024 07:27:04 GMT
COPY dir:b47c7b46d9ca2c8919422871b159d995b8c0b4d787aadc33d4baf74ce24c3b4c in /usr/local/tomcat 
# Wed, 05 Jun 2024 07:27:09 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jun 2024 07:27:10 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jun 2024 07:27:11 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 07:27:11 GMT
ENTRYPOINT []
# Wed, 05 Jun 2024 07:27:11 GMT
...
-	Layers:
	...
	-	`sha256:583615aaa8a2fdc5f9a5d416adf9f6b51245a5c37670833b5f4c163da1e20de1`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f75030cb72603fadeebc0a6c1742b06d96f46d309d3e4f4ffb9a562be17d41cc`  
		Last Modified: Wed, 05 Jun 2024 07:38:37 GMT  
		Size: 12.4 MB (12444350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1793729b6c6bde20d2fdf50ef4bbc5edb426b1b7d2783d1b2d0c522e0a4f9d44`  
		Last Modified: Wed, 05 Jun 2024 07:38:37 GMT  
		Size: 456.8 KB (456823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b1307acf1d103e9cffd7372adb1fd3d169a15d8b3cae38f3294884c885c5406`  
		Last Modified: Wed, 05 Jun 2024 07:38:36 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:cfe89b523ddcb38591381b3c2b0bb757e2b19afae80a77fe0c073a3af66533f4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104949025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74b46bfba50fccf946ec819baab5c6644dbf3aab61cf43f18320b41518b53af5`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 07:50:23 GMT
ENV TOMCAT_MAJOR=9
# Wed, 05 Jun 2024 07:50:24 GMT
ENV TOMCAT_VERSION=9.0.89
# Wed, 05 Jun 2024 07:50:24 GMT
ENV TOMCAT_SHA512=aaa2851bdc7a2476b6793e95174965c1c861531f161d8a138e87f8532b1af4d4b3d92dd1ae890614a692e5f13fb2e6946a1ada888f21e9d7db1964616b4181f0
# Wed, 05 Jun 2024 07:50:25 GMT
COPY dir:bbec366c237f2a62f512167e8780f7e5586c3a43ca696c503da4937b303b6b4d in /usr/local/tomcat 
# Wed, 05 Jun 2024 07:50:31 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jun 2024 07:50:32 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jun 2024 07:50:33 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 07:50:33 GMT
ENTRYPOINT []
# Wed, 05 Jun 2024 07:50:34 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9e6dcd04035cbcf426ae0c6ddeb6e7a17cfdbc46815b499bd2f390702ea93c6a`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab09896f785500d4db130431388f427db50637b8d2fd6a0283d983898258b352`  
		Last Modified: Wed, 05 Jun 2024 08:02:01 GMT  
		Size: 12.5 MB (12465070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7363a28492e6e3ab073bcf333007ac8b990ff84d5e3889259bc1e94d06ecc10`  
		Last Modified: Wed, 05 Jun 2024 08:02:00 GMT  
		Size: 487.5 KB (487529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5cddc4d46ec702b4284d61f3057cb7a6c063b1384b07f1ac1e799763220c528`  
		Last Modified: Wed, 05 Jun 2024 08:02:00 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:1044537ccaf62587254f943fe28b51abbd7d3f6d1549d660f84eef440237a7a0
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.3 MB (95314455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bacf5bd5201f3e0b044d550ad5e35b641aefa337bb8b16e600f398755b792b1`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 04:22:35 GMT
ENV TOMCAT_VERSION=9.0.89
# Wed, 05 Jun 2024 04:22:36 GMT
ENV TOMCAT_SHA512=aaa2851bdc7a2476b6793e95174965c1c861531f161d8a138e87f8532b1af4d4b3d92dd1ae890614a692e5f13fb2e6946a1ada888f21e9d7db1964616b4181f0
# Wed, 05 Jun 2024 04:22:36 GMT
COPY dir:78e6c02754461680232c317c039025588e90d35b548780218983e4b4b5cfb7a4 in /usr/local/tomcat 
# Wed, 05 Jun 2024 04:22:40 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jun 2024 04:22:41 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jun 2024 04:22:41 GMT
EXPOSE 8080
# Wed, 05 Jun 2024 04:22:41 GMT
...
-	Layers:
	...
	-	`sha256:282bdc7ae5c9dab0fdeba77dc0981451a6dcd491ddb72bdab689c3dd57450e98`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72c94fe64d9f67cae12c3bc9b59ebc57a3b07ba02bcfe7f91dde562e22ec3b3b`  
		Last Modified: Wed, 05 Jun 2024 04:31:00 GMT  
		Size: 12.4 MB (12432763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07f8dcc52ac0be32535259128401a34a59773918696cf89d2aa6e7d5d3c39630`  
		Last Modified: Wed, 05 Jun 2024 04:31:00 GMT  
		Size: 457.9 KB (457854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2de7435b0e0de6996cd244a97c3789cd3a7206ad176c9e276b6a42d87aeb85b9`  
		Last Modified: Wed, 05 Jun 2024 04:31:00 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
