...
```console
$ docker pull tomcat@sha256:f19ac2d7590aab23573e88b6f85f35278196ab7821273b87e1b15ebb8775c7d5
```
...
### `tomcat:9.0.86-jdk17-temurin` - linux; amd64
...
### `tomcat:9.0.86-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.86-jdk17-temurin` - linux; ppc64le
