...
```console
$ docker pull tomcat@sha256:1ef1e1c9262069b94401c360325aff7d5572e9ce2d664429e1119059558d9d29
```
...
### `tomcat:9.0.118-jdk25-temurin-noble` - linux; amd64
...
### `tomcat:9.0.118-jdk25-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.118-jdk25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.118-jdk25-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.118-jdk25-temurin-noble` - linux; s390x
