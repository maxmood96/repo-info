...
```console
$ docker pull tomcat@sha256:1f443bc7a67e4246aed2f440468c89083d54183d5f534378c88fb28c74fe243a
```
...
### `tomcat:8.5.79-jre8-openjdk-bullseye` - linux; amd64
...
### `tomcat:8.5.79-jre8-openjdk-bullseye` - linux; arm64 variant v8

```console
$ docker pull tomcat@sha256:b2b1ae4b371b0f8c8c3019227e982c2d1a7b444901c22c13fb6220e7c95d5ba8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **129.0 MB (128997805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2898da9b4e25f626327460ce4f49b70b540abcf17406a77e16bea656cdbc0085`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 12 May 2022 03:34:26 GMT
ENV TOMCAT_MAJOR=8
# Tue, 24 May 2022 20:44:09 GMT
ENV TOMCAT_VERSION=8.5.79
# Tue, 24 May 2022 20:44:10 GMT
ENV TOMCAT_SHA512=ae059a595ba11386bf3c0a80e961c5f8bb057b2bab987c3863337311e95d4fa22f1185a44b2c8856dd33f7cfe76d4de4e2fe1bc8b89c6abfbfc008656c49b8c0
# Tue, 24 May 2022 20:44:12 GMT
COPY dir:446c8eafb5027c5b0186b13bd9b2ddf439302c93263bf7ecd0a424d81d56844c in /usr/local/tomcat 
# Tue, 24 May 2022 20:44:16 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 24 May 2022 20:44:18 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 24 May 2022 20:44:19 GMT
EXPOSE 8080
# Tue, 24 May 2022 20:44:20 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dece3e2de066f8bfb1161fe54980ed67db86009555c70a3b9937aea81702d6d7`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19c1065731fa1b1865e4023b453b517ce6909d9e2569677304e51b09d5fc299f`  
		Last Modified: Tue, 24 May 2022 21:15:01 GMT  
		Size: 11.2 MB (11175136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc3f56ee513260b61f20dc6d55c1d8db27ca83a2468a06fab57681e5ee108f60`  
		Last Modified: Tue, 24 May 2022 21:15:00 GMT  
