...
```console
$ docker pull tomcat@sha256:dd6f14e2b94db8d473166f6f373eab45c72c1821a02482656ad38da87737cca7
```
...
### `tomcat:9.0.91-jdk8` - linux; amd64
...
### `tomcat:9.0.91-jdk8` - unknown; unknown
...
### `tomcat:9.0.91-jdk8` - linux; arm variant v7
...
### `tomcat:9.0.91-jdk8` - linux; arm64 variant v8
