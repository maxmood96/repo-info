...
```console
$ docker pull tomcat@sha256:3fed797803fd65da97b3c5833b47e9c0edb5535a00c9933a55721360f490ef8b
```
...
### `tomcat:9.0.64-jre17` - linux; amd64
...
### `tomcat:9.0.64-jre17` - linux; arm variant v7
...
### `tomcat:9.0.64-jre17` - linux; arm64 variant v8
...
### `tomcat:9.0.64-jre17` - linux; ppc64le
...
### `tomcat:9.0.64-jre17` - linux; s390x
