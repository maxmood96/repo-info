...
```console
$ docker pull tomcat@sha256:4a86b7cb4e1e48d3e05662c30e7745339f95d913d5c59c4fcd25fb6d47e25c59
```
...
```console
$ docker pull tomcat@sha256:1be6dee92a40ff67db848bc3171f0659367ed097fcb5a3c838844c9c85a01ea3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.0 MB (90966346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc5e2b9b50b4f85a70fadbbba9bf4b7d642a98e0428efb776e8ce7d2ff94d2fa`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 07 Oct 2022 06:36:03 GMT
ENV TOMCAT_MAJOR=8
# Wed, 12 Oct 2022 00:49:51 GMT
ENV TOMCAT_VERSION=8.5.83
# Wed, 12 Oct 2022 00:49:51 GMT
ENV TOMCAT_SHA512=57cbe9608a9c4e88135e5f5480812e8d57690d5f3f6c43a7c05fe647bddb7c3b684bf0fc0efebad399d05e80c6d20c43d5ecdf38ec58f123e6653e443f9054e3
# Wed, 12 Oct 2022 00:49:52 GMT
COPY dir:4b325e10f6f05e7d0532f2badc85609e9ed280db27d5f6b2ff62df71cbe0a98c in /usr/local/tomcat 
# Wed, 12 Oct 2022 00:49:59 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Oct 2022 00:49:59 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 12 Oct 2022 00:50:00 GMT
EXPOSE 8080
# Wed, 12 Oct 2022 00:50:00 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e9c7b8571191805d4884cc1a72ee95e1f0f792a149ef03ad96f423362c01186e`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41769f55f0a712324b641be4be034bcc3abce9bbd1e7554aea217831814b648d`  
		Last Modified: Wed, 12 Oct 2022 01:10:27 GMT  
		Size: 11.2 MB (11230813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cf1df198fc511c5150c9585f3bfcb867ddd9c27ad9060a24e2ec219feae650d`  
		Last Modified: Wed, 12 Oct 2022 01:10:25 GMT  
		Size: 424.9 KB (424918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b8ce1db311eb6d4bfdbdaeae09410a4cd7e5f96442877aa36d33ddf898a8b81`  
		Last Modified: Wed, 12 Oct 2022 01:10:25 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:8dfbe79ccf97620319f96c565fe0115b9225f83e7d9b55c53dc90b7d7c599e51
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.9 MB (103877445 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:269bdf80e30a8e6dffdaf285e34b8cbc9415d3bd11894a28106b5bed22afa259`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=8
# Tue, 11 Oct 2022 22:13:52 GMT
ENV TOMCAT_VERSION=8.5.83
# Tue, 11 Oct 2022 22:13:52 GMT
ENV TOMCAT_SHA512=57cbe9608a9c4e88135e5f5480812e8d57690d5f3f6c43a7c05fe647bddb7c3b684bf0fc0efebad399d05e80c6d20c43d5ecdf38ec58f123e6653e443f9054e3
# Tue, 11 Oct 2022 22:13:54 GMT
COPY dir:b3e2bf98dc704d072a62447733ea29701a94f834c3d1809a309e993220b9e948 in /usr/local/tomcat 
# Tue, 11 Oct 2022 22:14:02 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Oct 2022 22:14:05 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Oct 2022 22:14:05 GMT
EXPOSE 8080
# Tue, 11 Oct 2022 22:14:06 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:bbb65bb5fd02f2dba1707c65529ff93a0175d13a72c76fd802b0458b09d892c6`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:985a4f49df8fde8a95807d17f45b3ca68185bd02a03566abeaffeef434ac71b7`  
		Last Modified: Tue, 11 Oct 2022 22:33:52 GMT  
		Size: 11.3 MB (11320471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a0b80c4b51e489407b6fb1ac18dbd48c62a4d580092b2de90269cd0181ac3de`  
		Last Modified: Tue, 11 Oct 2022 22:33:50 GMT  
		Size: 473.9 KB (473896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d57a95d553eeb373b82238f6ab9ff2dba94d695bbb643da70d9c7e0d75e45954`  
		Last Modified: Tue, 11 Oct 2022 22:33:50 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
