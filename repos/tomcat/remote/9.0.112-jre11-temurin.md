...
```console
$ docker pull tomcat@sha256:bfdbaeeb7bda0ed1f644f9d2dd4d7f72224bbd1943c26d3a353b9fed734ff858
```
...
### `tomcat:9.0.112-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.112-jre11-temurin` - unknown; unknown
...
### `tomcat:9.0.112-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.112-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.112-jre11-temurin` - linux; ppc64le
...
### `tomcat:9.0.112-jre11-temurin` - linux; s390x

```console
$ docker pull tomcat@sha256:4cab224df066095bbc9d61a0c4c44701981dcd041f6d4fc47104032ae7caf23b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.3 MB (102341467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31e868928703a9a68d37b07d9b15949b8f8f7994ee1a791239b71de63ae7d7f3`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 10 Nov 2025 23:25:45 GMT
ENV TOMCAT_SHA512=fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d
# Mon, 10 Nov 2025 23:31:49 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 23:31:53 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 23:31:55 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 23:31:55 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 23:31:55 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:61798e5f80367e3ba158140efface4d9ceb2be71154b10b27639489118a01586`  
		Last Modified: Mon, 10 Nov 2025 23:32:22 GMT  
		Size: 13.7 MB (13738318 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9f33d0fe80519c7d48653bcf024f112403921b25dd9d2bd466ce5d70e606173f`  
		Last Modified: Mon, 10 Nov 2025 23:32:20 GMT  
		Size: 232.8 KB (232754 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 10 Oct 2025 22:54:50 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:f153a0e54b79ff9825668995d92f665773548885d4dbc229e855f6b10b731404
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3382896 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b17eb69c27dc894dcec9343fc9439b68ec53d61fb3755cd0f8a5ac3f9862488b`

```dockerfile
```

-	Layers:
	-	`sha256:92950a2208347e55845aaeab6b43a1b645f020102209f4789217643e343dc7fd`  
		Last Modified: Tue, 11 Nov 2025 00:35:04 GMT  
		Size: 3.4 MB (3359803 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d354e6cdb980db5d6d3cd5991700306e9523fb5ac0c2adc1401e47611dda20a1`  
		Last Modified: Tue, 11 Nov 2025 00:35:05 GMT  
		Size: 23.1 KB (23093 bytes)  
		MIME: application/vnd.in-toto+json
