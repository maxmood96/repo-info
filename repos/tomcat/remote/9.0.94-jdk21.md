...
```console
$ docker pull tomcat@sha256:6f76bc31a76d13f7b8240d89c73331625b4774655ef54e85ef9130aa5e7bdba4
```
...
### `tomcat:9.0.94-jdk21` - linux; amd64
...
### `tomcat:9.0.94-jdk21` - unknown; unknown
...
### `tomcat:9.0.94-jdk21` - linux; arm64 variant v8
...
### `tomcat:9.0.94-jdk21` - linux; ppc64le
...
### `tomcat:9.0.94-jdk21` - linux; s390x
