...
```console
$ docker pull tomcat@sha256:9ac592d4da516db26797a8dd7816b0fa250a1a3a473a16a4ad11bed226fb0070
```
...
### `tomcat:9.0.76-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.76-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.76-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.76-jre17-temurin-jammy` - linux; ppc64le
