...
```console
$ docker pull tomcat@sha256:c6075791e64185796c5d7b68e761ec24802276eb0c3961c48e6141e69446c081
```
...
### `tomcat:9.0.105-jdk17` - linux; amd64
...
### `tomcat:9.0.105-jdk17` - unknown; unknown
...
### `tomcat:9.0.105-jdk17` - linux; arm variant v7
...
### `tomcat:9.0.105-jdk17` - linux; arm64 variant v8
...
### `tomcat:9.0.105-jdk17` - linux; s390x
