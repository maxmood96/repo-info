...
```console
$ docker pull tomcat@sha256:7fc0571c590d0af7548752a11ded9ef18dd69e87b516872903121f8f2a945944
```
...
### `tomcat:11.0.4-jdk21` - linux; amd64
...
### `tomcat:11.0.4-jdk21` - unknown; unknown
...
### `tomcat:11.0.4-jdk21` - linux; arm64 variant v8
...
### `tomcat:11.0.4-jdk21` - linux; ppc64le
...
### `tomcat:11.0.4-jdk21` - linux; s390x
