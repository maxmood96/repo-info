...
```console
$ docker pull tomcat@sha256:9bb1a188c474944a1a85ffffff0f9a4c9ee3995e37033b08501bbe32ca546715
```
...
### `tomcat:11.0.12-jdk21-temurin` - linux; amd64
...
### `tomcat:11.0.12-jdk21-temurin` - unknown; unknown
...
### `tomcat:11.0.12-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.12-jdk21-temurin` - linux; ppc64le
...
### `tomcat:11.0.12-jdk21-temurin` - linux; s390x
