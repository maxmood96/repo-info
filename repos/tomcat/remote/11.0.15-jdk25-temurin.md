...
### `tomcat:11.0.15-jdk25-temurin` - linux; amd64
...
### `tomcat:11.0.15-jdk25-temurin` - unknown; unknown
...
### `tomcat:11.0.15-jdk25-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.15-jdk25-temurin` - linux; ppc64le
...
### `tomcat:11.0.15-jdk25-temurin` - linux; riscv64
...
### `tomcat:11.0.15-jdk25-temurin` - linux; s390x
