...
```console
$ docker pull tomcat@sha256:3bd01506b3bcabaabb383224fbeddad9aac3da7c5623d0fd856149c93ce7f991
```
...
```console
$ docker pull tomcat@sha256:f6116f9a63e4656d4343a3d8d6daff86f4cd373b0dc245f62c99d5510df1c4a4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.8 MB (90846905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:053c5f5b8195e768b22e1b8963a117b1b3373aaa1b2ce28c571dcf9b82fdbf50`
...
# Sat, 28 May 2022 21:48:04 GMT
COPY dir:81cdd8e96bdab041c52e9a1c1392eaf53d97283bab80a91bf70490a870c45342 in /usr/local/tomcat 
# Sat, 28 May 2022 21:48:08 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 May 2022 21:48:09 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 28 May 2022 21:48:10 GMT
EXPOSE 8080
# Sat, 28 May 2022 21:48:10 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6f92a20ed3db0ed4fd15b98ffd50dc6a3fc7474aca150c7df5b9d9ba4d23bffa`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07da1626848e048edebaa9e3511619d35ba14d74ed0fd8d79446ff3ed0e782f5`  
		Last Modified: Sat, 28 May 2022 22:16:08 GMT  
		Size: 12.6 MB (12563201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03928b24ab1b859bb2153fcddd300d4eb644b9524328d01c6be4a6be0d3276b4`  
		Last Modified: Sat, 28 May 2022 22:16:07 GMT  
		Size: 387.7 KB (387689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3653f9e17c6822669a36115d11da7fb1aa02cee56e3a17d9b50b7a4da6fb0711`  
		Last Modified: Sat, 28 May 2022 22:16:07 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
