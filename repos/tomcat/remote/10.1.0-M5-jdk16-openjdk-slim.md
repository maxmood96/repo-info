## `tomcat:10.1.0-M5-jdk16-openjdk-slim`

```console
$ docker pull tomcat@sha256:6c07f9991cad7701868c66128cdb8ba73732dd970a6da05bbb6c80a92dbd50a5
```
...
### `tomcat:10.1.0-M5-jdk16-openjdk-slim` - linux; amd64
