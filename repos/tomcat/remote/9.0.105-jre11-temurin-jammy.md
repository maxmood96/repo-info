...
### `tomcat:9.0.105-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.105-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:9.0.105-jre11-temurin-jammy` - linux; s390x
