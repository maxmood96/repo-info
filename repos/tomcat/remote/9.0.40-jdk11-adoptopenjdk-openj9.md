...
```console
$ docker pull tomcat@sha256:aed91a16f3b24bedc51fab17b193350a9ebcc64e9702f48a3121522712e34df0
```
...
### `tomcat:9.0.40-jdk11-adoptopenjdk-openj9` - linux; amd64

```console
$ docker pull tomcat@sha256:2a83b203c773fa3a64f372e787bb2c5566b93e7bd7d8b582faec6f25555f57b0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.6 MB (259577457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f07e005a81fed6cef95bfa34d0a91d20d894d7a2a1152d0629834cd0f48da98`
...
# Thu, 26 Nov 2020 04:26:38 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 26 Nov 2020 04:26:39 GMT
EXPOSE 8080
# Thu, 26 Nov 2020 04:26:39 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5a13fb8f93aec32b7535143992fe6d8dfdbd892e75af97e35255e2de5d50f70d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ac8cf3b71722bb4f4388521eaa240b70039a3d1d62b2a780f315ed34b08e154`  
		Last Modified: Thu, 26 Nov 2020 04:37:38 GMT  
		Size: 12.6 MB (12560984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e35381a185736af1155b12a9a94665b4baf2eacad628d8a4994c216cf99b19ce`  
		Last Modified: Thu, 26 Nov 2020 04:37:38 GMT  
		Size: 183.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:9.0.40-jdk11-adoptopenjdk-openj9` - linux; ppc64le
...
### `tomcat:9.0.40-jdk11-adoptopenjdk-openj9` - linux; s390x
