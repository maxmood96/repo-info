## `tomcat:10.1.35-jdk17`

```console
$ docker pull tomcat@sha256:4d8afafda935acd01b8024a7e309acb6fbc2c4ee321342163a61b3785c2e9368
```
...
### `tomcat:10.1.35-jdk17` - linux; amd64
...
### `tomcat:10.1.35-jdk17` - unknown; unknown
...
### `tomcat:10.1.35-jdk17` - linux; arm variant v7
...
### `tomcat:10.1.35-jdk17` - linux; arm64 variant v8
...
### `tomcat:10.1.35-jdk17` - linux; riscv64
...
### `tomcat:10.1.35-jdk17` - linux; s390x
