...
```console
$ docker pull tomcat@sha256:bba10b98b123e9e5c910f18389086b020c3b83db7f2fec80016df79b86fd85c4
```
...
### `tomcat:9.0.82-jre17-temurin` - linux; amd64
...
### `tomcat:9.0.82-jre17-temurin` - linux; arm variant v7
...
### `tomcat:9.0.82-jre17-temurin` - linux; ppc64le
...
### `tomcat:9.0.82-jre17-temurin` - linux; s390x
