...
```console
$ docker pull tomcat@sha256:d38f5295b565428d0a10d00bbaa9fd85793886c557c05c6d5fa11d43fce70219
```
...
### `tomcat:11.0.7-jdk17` - linux; amd64
...
### `tomcat:11.0.7-jdk17` - unknown; unknown
...
### `tomcat:11.0.7-jdk17` - linux; arm variant v7
...
### `tomcat:11.0.7-jdk17` - linux; arm64 variant v8
...
### `tomcat:11.0.7-jdk17` - linux; ppc64le
...
### `tomcat:11.0.7-jdk17` - linux; s390x
