...
```console
$ docker pull tomcat@sha256:bf7001e818e8d3d17b77836a120e67149511e5a0cda37cf7cf0637849cc7b2f6
```
...
```console
$ docker pull tomcat@sha256:ec6da40244e1c5caf58cdc7d12deb6af83ace1c26f73dec6667cbe0c749fbbaf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **371.0 MB (371042261 bytes)**  
...
# Wed, 21 Jun 2023 01:40:00 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Jun 2023 01:40:00 GMT
EXPOSE 8080
# Wed, 21 Jun 2023 01:40:01 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1009f27a77633c7b9d4519642467204c35921a41bd21626349491e7582a92a7b`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e9d7e5765677a8687cd26e968613986df241a1eaeb1f0eaecd4928f54e6c6de`  
		Last Modified: Wed, 21 Jun 2023 01:49:33 GMT  
		Size: 12.5 MB (12456171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28244be4bc69e827a19e0eb71e5dba8266d3abea9ca2c7c09e02a3053a98a72b`  
		Last Modified: Wed, 21 Jun 2023 01:49:32 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
