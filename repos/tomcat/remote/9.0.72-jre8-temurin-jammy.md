...
```console
$ docker pull tomcat@sha256:4b11f95daadecd94e7a740e9107281064f6e4183e152377f4fe97caacb87e5f6
```
...
### `tomcat:9.0.72-jre8-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.72-jre8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.72-jre8-temurin-jammy` - linux; ppc64le
