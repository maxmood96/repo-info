...
```console
$ docker pull tomcat@sha256:e6cb3993221c54e396482c7e5b65d4449ceed076092d2dcfb79163c2702a1bb3
```
...
```console
$ docker pull tomcat@sha256:5fb80e2fa1ae2d355e5d71b47a856e129faa584702670cead20ca6d8890c94b6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.3 MB (102307668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8497b519ae99a77ec73dcaa4a5f5d6ef535d19d27b8bf703c98353fe5cc924c5`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=06e239d15ff7b72017c1d0752ddb1be4651374f7c1391631ec5619f4981cb2911267bc6b044d6c71a2a74738f70d433b96418951439848121f1d874862ddd3de
# Thu, 25 Jan 2024 01:20:48 GMT
COPY dir:f5dcee4dda258a328a843b95298af8cf2c3805430b3931d663ea36012143002f in /usr/local/tomcat 
# Thu, 25 Jan 2024 01:20:52 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 25 Jan 2024 01:20:53 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 25 Jan 2024 01:20:53 GMT
EXPOSE 8080
# Thu, 25 Jan 2024 01:20:53 GMT
...
-	Layers:
	...
	-	`sha256:b17ae447b5705d3dd39e1dfd4365ff33a8d24b44391efa293633c896e4b943ba`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f59570f6f0894bfbe6f2dfce4f90fe06c50e95c1c30f3c2fb868fe7595e6ed5`  
		Last Modified: Thu, 25 Jan 2024 01:36:16 GMT  
		Size: 12.5 MB (12486637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:240ed1483203d816dc7d5dcf4f4c6a5d4086ef0089ac7dade7f24af26530ae4f`  
		Last Modified: Thu, 25 Jan 2024 01:36:15 GMT  
		Size: 449.2 KB (449227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00ff94ad49bd38344ac133f479974cae7d34464d559074e6b30c7d19c71e8cf4`  
		Last Modified: Thu, 25 Jan 2024 01:36:15 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
