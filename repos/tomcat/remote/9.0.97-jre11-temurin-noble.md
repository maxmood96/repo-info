...
```console
$ docker pull tomcat@sha256:fdeac15e1397d6cf2b7a627adae2520a5fc11c64cda0f4687ecdaa1fb5a0ccf3
```
...
### `tomcat:9.0.97-jre11-temurin-noble` - linux; amd64
...
### `tomcat:9.0.97-jre11-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.97-jre11-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.97-jre11-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.97-jre11-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.97-jre11-temurin-noble` - linux; s390x
