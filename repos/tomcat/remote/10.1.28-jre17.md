...
```console
$ docker pull tomcat@sha256:2f7d930ef7e9f470918a1d7bedeb1c4b60a3e1a29c7806cbfa74ef0effcb98ec
```
...
### `tomcat:10.1.28-jre17` - linux; amd64
...
### `tomcat:10.1.28-jre17` - linux; arm64 variant v8
...
### `tomcat:10.1.28-jre17` - linux; s390x
