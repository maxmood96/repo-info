...
### `tomcat:10.1.29-jdk17-temurin-noble` - linux; amd64
...
### `tomcat:10.1.29-jdk17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.29-jdk17-temurin-noble` - linux; ppc64le
