...
```console
$ docker pull tomcat@sha256:0f750b251788980afdb220d05d6630e5761726e44ef15ffd5087f962c6f7878a
```
...
### `tomcat:11.0.23-jdk17-temurin` - linux; amd64
...
### `tomcat:11.0.23-jdk17-temurin` - unknown; unknown
...
### `tomcat:11.0.23-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.23-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.23-jdk17-temurin` - linux; ppc64le
...
### `tomcat:11.0.23-jdk17-temurin` - linux; s390x
