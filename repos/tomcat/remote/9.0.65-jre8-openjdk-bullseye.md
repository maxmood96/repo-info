...
```console
$ docker pull tomcat@sha256:b7a91f9b4493cfb3452360468ea5a3180ed1a4d4619394f997660a5e025bd341
```
...
```console
$ docker pull tomcat@sha256:1668ba23c66767fffbf8f57746f08e46094a462d16dc6181848cb569763b5006
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.7 MB (130733355 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:633c58210dec1555e92d9415b3fd0facc2c2f4987535d24efacd27512c5ccda3`
...
# Wed, 03 Aug 2022 05:04:58 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 03 Aug 2022 05:04:58 GMT
ENV TOMCAT_MAJOR=9
# Wed, 03 Aug 2022 05:04:59 GMT
...
# Wed, 03 Aug 2022 05:04:59 GMT
COPY dir:df36113042144a9fa251b56454946f268534287601abe103e55295290dcd8844 in /usr/local/tomcat 
# Wed, 03 Aug 2022 05:05:03 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 05:05:04 GMT
...
-	Layers:
	...
	-	`sha256:a25be23b96412121e9e10fbdcadb75f26f550828dc6a1e57c9d731b1408ab18b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8384d8fd000d4071bfb04fd8efcebeda5269fba91e4feaee38aa4e9428e69159`  
		Last Modified: Wed, 03 Aug 2022 05:48:48 GMT  
		Size: 12.2 MB (12159388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f5b26e3be084d4a30b753796ea45958bd5ce71ab1c96d8ad7d64002633ef257`  
		Last Modified: Wed, 03 Aug 2022 05:48:47 GMT  
		Size: 459.7 KB (459704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a1e7bfc4f87b019f5a687e116e13b51d31922c302f9e5a9e7c1e4fa6057bd6e`  
		Last Modified: Wed, 03 Aug 2022 05:48:47 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:aed041d9d87f1a9dd1bc8c3595f74b5794e1f2c47382ef5c292f34fedd94e851
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.2 MB (128198196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6deb7edbb2d3b49c1a442edc56a7172879bda8ba6eba3b674cffb953a6ccbd4`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Wed, 03 Aug 2022 02:17:47 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 03 Aug 2022 02:17:48 GMT
ENV TOMCAT_MAJOR=9
# Wed, 03 Aug 2022 02:17:49 GMT
ENV TOMCAT_VERSION=9.0.65
# Wed, 03 Aug 2022 02:17:50 GMT
ENV TOMCAT_SHA512=2ae846848b8436856be11cfa18d9c62caa06ca7d3134012b2e10cbf6078753c4af20cc5d37f7dc75f1779f5c59d7c033850b8626534c3ce7e389641a67963cf6
# Wed, 03 Aug 2022 02:17:52 GMT
COPY dir:87f5b35642748f03b5187adba5374980856c7d027398a5f97d5d474a7a059552 in /usr/local/tomcat 
# Wed, 03 Aug 2022 02:17:55 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 02:17:57 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2022 02:17:58 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 02:17:59 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:386d3e25cae34a0b03590874dc8025cd8a07479a31c69fcae413200e70f7212c`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37a913ac5ba5cec09d7304d916f5c589816ba33d7c08a8c1fee896d1118708c3`  
		Last Modified: Wed, 03 Aug 2022 03:19:46 GMT  
		Size: 12.2 MB (12168556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83276e809bbd36a13762116ca91146311ca4e51cef70db0bf941aeeef3547a3e`  
		Last Modified: Wed, 03 Aug 2022 03:19:45 GMT  
