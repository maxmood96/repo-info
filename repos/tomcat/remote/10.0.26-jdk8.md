...
```console
$ docker pull tomcat@sha256:afd1231bf25629d57bc11a34af71ed05394929b3ec54c175305a5b9a89805a53
```
...
### `tomcat:10.0.26-jdk8` - linux; amd64
...
### `tomcat:10.0.26-jdk8` - linux; arm64 variant v8
...
### `tomcat:10.0.26-jdk8` - linux; ppc64le
