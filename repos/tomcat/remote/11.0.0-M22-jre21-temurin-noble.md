...
### `tomcat:11.0.0-M22-jre21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.0-M22-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.0-M22-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.0-M22-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.0-M22-jre21-temurin-noble` - linux; s390x
