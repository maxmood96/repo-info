...
```console
$ docker pull tomcat@sha256:3c165ce371fd4858492651442ff47da8cf4559ef357afb6266f8ef88bd4ed9a6
```
...
### `tomcat:8.5.58-jdk11-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:8.5.58-jdk11-adoptopenjdk-hotspot` - linux; arm variant v7
...
### `tomcat:8.5.58-jdk11-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:8.5.58-jdk11-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:8.5.58-jdk11-adoptopenjdk-hotspot` - linux; s390x
