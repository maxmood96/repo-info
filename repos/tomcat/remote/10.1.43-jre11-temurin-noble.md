...
### `tomcat:10.1.43-jre11-temurin-noble` - linux; arm variant v7
...
### `tomcat:10.1.43-jre11-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.43-jre11-temurin-noble` - linux; s390x
