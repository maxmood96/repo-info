...
```console
$ docker pull tomcat@sha256:9f5fc279065f9725b23ab07b2d69a27f3746c3200561dc271635c0c62d67633b
```
...
### `tomcat:10.1.53-jre21-temurin-noble` - linux; amd64
...
### `tomcat:10.1.53-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.53-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.53-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.53-jre21-temurin-noble` - linux; s390x
