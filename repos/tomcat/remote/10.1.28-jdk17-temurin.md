## `tomcat:10.1.28-jdk17-temurin`

```console
$ docker pull tomcat@sha256:26965bcf705a333d7fd7ad2493a6cc46131a7fdefcff2908b53cc28c36d3d6d6
```
...
### `tomcat:10.1.28-jdk17-temurin` - linux; amd64
...
### `tomcat:10.1.28-jdk17-temurin` - unknown; unknown
...
### `tomcat:10.1.28-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:10.1.28-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.28-jdk17-temurin` - linux; ppc64le
