...
```console
$ docker pull tomcat@sha256:9ceb27f9601e359cd847c8a5136b0a24c9c894eb8363db4a7815d71c2d053059
```
...
```console
$ docker pull tomcat@sha256:f993834f98a5125f929dcfc63e47c88a0e38067b79578286efda7150e3e38a2b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.7 MB (101721407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53989236d4a06d31d83208e8051b2e4425517bbee8e0faac73fa0f036724518d`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 12:01:27 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Tue, 23 Jan 2024 00:34:44 GMT
COPY dir:c8785035e90595b70571b8068b2a075611cdb71ea266ebe8518b4665ecc57b7b in /usr/local/tomcat 
# Tue, 23 Jan 2024 00:34:50 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jan 2024 00:34:53 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 23 Jan 2024 00:34:54 GMT
EXPOSE 8080
# Tue, 23 Jan 2024 00:34:54 GMT
ENTRYPOINT []
# Tue, 23 Jan 2024 00:34:54 GMT
...
-	Layers:
	...
	-	`sha256:0165baa580eb9a74f03918bfa8c6e87cbb7423bddf68741d8c20cdaa1c87f775`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:219ec33c70f1b010e0025091728d1cbb4e32577aa74844a099cd5120e6fdd8f6`  
		Last Modified: Tue, 23 Jan 2024 00:51:04 GMT  
		Size: 11.4 MB (11383089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e78f79ba3868a5efcbb279f779c7e1a0cc4b4479f1eaa9b6c2069e073d006a`  
		Last Modified: Tue, 23 Jan 2024 00:51:03 GMT  
		Size: 432.3 KB (432314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efd1428449f696725bf9ccadad64169c0b1a46075a9dc6b2890a939543867164`  
		Last Modified: Tue, 23 Jan 2024 00:51:02 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:91e3d164a2ddbef2338eb3c28afc9b00d225fa82939e8aa872bc60596595b190
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.3 MB (113349940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d37f13c6849675e7c4714c8f09a5dccec19783ae6d1619428fd54e5a1ccad9e4`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 09:13:58 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Tue, 23 Jan 2024 00:02:13 GMT
COPY dir:8a3a8588eec7960c5fbbcf627f64b3691bfb1d3a780c9e18323ce66a47adb024 in /usr/local/tomcat 
# Tue, 23 Jan 2024 00:02:20 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jan 2024 00:02:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 23 Jan 2024 00:02:23 GMT
EXPOSE 8080
# Tue, 23 Jan 2024 00:02:23 GMT
ENTRYPOINT []
# Tue, 23 Jan 2024 00:02:23 GMT
...
-	Layers:
	...
	-	`sha256:b058c5afc20bc21438b55f2179b471ef52bcf7a7db1b238db0de129a1e0d92d2`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e0e8c541d9ff17e9186560747885d10f4c2a002ca94f5d79f74e0b70b7e731d`  
		Last Modified: Tue, 23 Jan 2024 00:22:24 GMT  
		Size: 11.5 MB (11476519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf2b3938cd44ce3696b71981ff35f2d9feb83090bf33300cf83bcfb2a186b46d`  
		Last Modified: Tue, 23 Jan 2024 00:22:23 GMT  
		Size: 489.7 KB (489692 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:633ff89988782acb3736897f21dcfc4cfa77cc3af6f20f5a1be4f8f6626233b0`  
		Last Modified: Tue, 23 Jan 2024 00:22:23 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
