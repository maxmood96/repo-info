...
```console
$ docker pull tomcat@sha256:358aa6c910e3a7f0ab914aeefa91ff69a3777cf194786a11f282d93d975c00b7
```
...
```console
$ docker pull tomcat@sha256:a662e1159b1a3c63e20838c8db6b5b749fc87225775f83e4f340cb0e059566ac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.3 MB (113346269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51c30ff63cff595c41bc594b35b9795398ef00520bfb00ebc15215fa384cb5f1`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 09 Jan 2024 23:02:00 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Tue, 09 Jan 2024 23:02:01 GMT
COPY dir:f31e9b06a63ec2977a19eb1c8942dce1d6613c9d88e47e3de29887a61d0fc335 in /usr/local/tomcat 
# Tue, 09 Jan 2024 23:02:10 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Jan 2024 23:02:13 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 09 Jan 2024 23:02:14 GMT
EXPOSE 8080
# Tue, 09 Jan 2024 23:02:15 GMT
ENTRYPOINT []
# Tue, 09 Jan 2024 23:02:16 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:bed6f2dae136c551e0701cec2cc9606163ea53bc879fcc47ab3eece51e92e0cd`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:073b22cfae5f4ce40d8f292782318e676152d17537e2d7f6fceab4f574bc549d`  
		Last Modified: Tue, 09 Jan 2024 23:27:33 GMT  
		Size: 11.5 MB (11476468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fc6e3d9cc214972f20f544150f8d129a93a29bcd660a370d3b467231bec4e47`  
		Last Modified: Tue, 09 Jan 2024 23:27:32 GMT  
		Size: 489.6 KB (489617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1bbb4f880653826253956d331b8ca0aa30ff1cd85b2162a9569b99280537e3b`  
		Last Modified: Tue, 09 Jan 2024 23:27:32 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
