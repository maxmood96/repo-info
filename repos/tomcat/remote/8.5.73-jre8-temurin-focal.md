...
```console
$ docker pull tomcat@sha256:87300053847b5eaeb1968850db7b53b25d6f6ef2522acfe564130b9c5eac8b4c
```
...
### `tomcat:8.5.73-jre8-temurin-focal` - linux; amd64
...
### `tomcat:8.5.73-jre8-temurin-focal` - linux; ppc64le
