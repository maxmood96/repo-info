...
```console
$ docker pull tomcat@sha256:ce0c3a0b3ab1f7b2a51f64a78297ed5467e8d5685a13c39d7d68357259e9c7eb
```
...
### `tomcat:11.0.13-jdk25-temurin-noble` - linux; amd64
...
### `tomcat:11.0.13-jdk25-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.13-jdk25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.13-jdk25-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.13-jdk25-temurin-noble` - linux; s390x
