...
```console
$ docker pull tomcat@sha256:c0e4248b7b08e5eb3460c8224f3293df9b4abcda897649a96b7f03416c3dabd7
```
...
```console
$ docker pull tomcat@sha256:2ab0f5e692793ec696446b325bda94634f9b576bafe1d53c8227227cf1c15727
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.4 MB (245413482 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b27017cd6b2939b6bd451fef8ac45720aa6198a1eed56b524d0a5fae34b25a8e`
...
# Fri, 23 Jul 2021 09:55:51 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 23 Jul 2021 09:55:51 GMT
EXPOSE 8080
# Fri, 23 Jul 2021 09:55:52 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:01f091106403719786f1b5caee4455903944e0165f6b03c69dda4af2f8b8ad21`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5202f39b20ec9245b0f39b66e0bcc6f49c433d606c02c4bf9167455a7c4cbcc`  
		Last Modified: Fri, 23 Jul 2021 10:09:17 GMT  
		Size: 11.6 MB (11603076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5507355b3c22f7652d7020a2632f3af5c3f4d2da3d2c3d0d4b68943bd99c88ce`  
		Last Modified: Fri, 23 Jul 2021 10:09:15 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
