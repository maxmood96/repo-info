...
```console
$ docker pull tomcat@sha256:7fda410a7e4405f8fc40cc65fc8f712b93a3f35a8fa5cac5f0d411e7683137b8
```
...
```console
$ docker pull tomcat@sha256:d087d90b1813651ca03b6a8a67c42592a1c3489dee34411db777aa03de30af43
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.4 MB (341390389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29f04ec872beedaf6fca998fe6c93b5d045f22e74b1a5dc4e7bc04d871dd5b30`
...
# Wed, 22 Dec 2021 17:02:08 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 22 Dec 2021 17:02:08 GMT
EXPOSE 8080
# Wed, 22 Dec 2021 17:02:09 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:fdc9dc26463c45ecb4cbe26ed7baa6ab15ec66f951148941c076f5d3e0cbe595`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:496cd592b15e184295d5ef68f68966a7a60e6612174ac93f17f97191d28c44d0`  
		Last Modified: Wed, 22 Dec 2021 17:44:11 GMT  
		Size: 12.9 MB (12864165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e03291b88711c23c6b8b359ea0a3973502d3a87d13f341a8357993b9d3686f`  
		Last Modified: Wed, 22 Dec 2021 17:44:09 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:10.1.0-M8-jdk11-openjdk-buster` - linux; arm64 variant v8
