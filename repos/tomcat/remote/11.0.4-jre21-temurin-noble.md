...
```console
$ docker pull tomcat@sha256:80b92f6c9603df7ddbbd7f390d529ee9eed8930633986e18d5fb634b41f13b23
```
...
### `tomcat:11.0.4-jre21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.4-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.4-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.4-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.4-jre21-temurin-noble` - linux; s390x
