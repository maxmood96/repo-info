...
```console
$ docker pull tomcat@sha256:586898341000672b64caa6dd3c4bfe89cb1a234cd76b6c83bfe8a76bfb20975a
```
...
### `tomcat:8.5.70-jre11-openjdk-bullseye` - linux; amd64
...
### `tomcat:8.5.70-jre11-openjdk-bullseye` - linux; arm64 variant v8
