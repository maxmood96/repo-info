## `tomcat:9.0.75-jre11-temurin`

```console
$ docker pull tomcat@sha256:cf0636d2659a28adf4cb1affc54de99627835fe867ca1fbdcf07bd7051ce12fe
```
...
### `tomcat:9.0.75-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.75-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.75-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.75-jre11-temurin` - linux; ppc64le
...
### `tomcat:9.0.75-jre11-temurin` - linux; s390x
