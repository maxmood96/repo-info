...
```console
$ docker pull tomcat@sha256:a996b01c77b89c9dd75a69a6288365f5a2d1fa9161ddf39acebcbf8adb2a7959
```
...
### `tomcat:10.1.36-jre17-temurin-noble` - linux; amd64
...
### `tomcat:10.1.36-jre17-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.36-jre17-temurin-noble` - linux; arm variant v7
...
### `tomcat:10.1.36-jre17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.36-jre17-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.36-jre17-temurin-noble` - linux; s390x
