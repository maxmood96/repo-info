## `tomcat:8.5.87-jre17-temurin`

```console
$ docker pull tomcat@sha256:2d45474b6ba3a9a2cb05ce0952b9342da959cb1a2bce8d79c27935d4a209033c
```
...
### `tomcat:8.5.87-jre17-temurin` - linux; amd64

```console
$ docker pull tomcat@sha256:b86f2fa7b06ef69a3e275572f93fcd24f2d14b2ad3ed5d5739105381eed93a5d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.0 MB (106038075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dea4de03f898ab833c58dba7adcdd0d1acdfab1d37cc803f997042e3594ef23b`
...
# Tue, 28 Mar 2023 01:25:15 GMT
COPY dir:59fd23d3ba005c9d9d15491b67d684b9bb28cd88e002c94c1cdc0588ed25deb5 in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:25:19 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:25:20 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Mar 2023 01:25:20 GMT
EXPOSE 8080
# Tue, 28 Mar 2023 01:25:21 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dd8fdd28e694b8be96f0ab2f7c9dcff51ded32313db281e697f0f47340b81555`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc044f8ea967197ef6ae4d93c68192052333fc0dafbfeee26e4d52a3bf84cc73`  
		Last Modified: Tue, 28 Mar 2023 01:40:59 GMT  
		Size: 11.2 MB (11239811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:025903fd22166f4069d9cb739ff7857bbf901911dec83f737d4511419c9a97fa`  
		Last Modified: Tue, 28 Mar 2023 01:40:58 GMT  
		Size: 457.0 KB (456969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:233399b8501a7ce923ccfb732e160c301d37670821f043c38ce0cc9ee0710a3a`  
		Last Modified: Tue, 28 Mar 2023 01:40:57 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.87-jre17-temurin` - linux; arm variant v7
...
### `tomcat:8.5.87-jre17-temurin` - linux; arm64 variant v8

```console
$ docker pull tomcat@sha256:11c51764d80b5933a0aa1af17ca04b189fd62f1c2d8f739f02ca6f7669460c8c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104912078 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f76eb41877c3cc8e3c5180a6f4639b2fdd60ee76e07e4b0aef1ca834bffe2ded`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 16 Mar 2023 06:32:21 GMT
ENV TOMCAT_SHA512=e303b45adaccef4c6c93546bd445e40caa690e0a80c850e2176178afd94dfa4402137820ffa40dc9005d625ec96c3c3b41124a6c4a1c90621a24b34932ae3b5e
# Tue, 28 Mar 2023 01:38:10 GMT
COPY dir:4798acd60c50fca1b5d1719d18f0310de826d8bb77c1b57279c58e1b0ed64cec in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:38:13 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:38:14 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Mar 2023 01:38:14 GMT
EXPOSE 8080
# Tue, 28 Mar 2023 01:38:14 GMT
...
-	Layers:
	...
	-	`sha256:22574da6a8f30964c321cccc4b118c72ce4409bbe3ed89ecaeb57dde841e1b86`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75ecfda5fd9768044f44e0363c52159b4fa69870210e43b9faac037b3d7ba574`  
		Last Modified: Tue, 28 Mar 2023 01:52:18 GMT  
		Size: 11.2 MB (11246204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81941448ba09a2225577ea54ad268372173d6ebff8bbbead70918c16bc67b07b`  
		Last Modified: Tue, 28 Mar 2023 01:52:17 GMT  
		Size: 455.7 KB (455710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b68c891facb80b8ac28d8ce7b8fc83de0e84a51545e8afd38d8fa864a85fbdc`  
		Last Modified: Tue, 28 Mar 2023 01:52:17 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.87-jre17-temurin` - linux; ppc64le

```console
$ docker pull tomcat@sha256:d7cd091f8249949b638be90cbaf67253740bd35ed499303d78937bf70272a1bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **112.5 MB (112506492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a37b289f77a95748afa87681b2a9409120fb3ed820915ae4d7d7bae6758cc6b3`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=e303b45adaccef4c6c93546bd445e40caa690e0a80c850e2176178afd94dfa4402137820ffa40dc9005d625ec96c3c3b41124a6c4a1c90621a24b34932ae3b5e
# Tue, 28 Mar 2023 01:12:19 GMT
COPY dir:1b1310b51c947798f0a5c84d94e6a8a3eea6aff8b8c3e0747b09e8babd76695d in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:12:29 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:12:31 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Mar 2023 01:12:31 GMT
EXPOSE 8080
# Tue, 28 Mar 2023 01:12:31 GMT
...
-	Layers:
	...
	-	`sha256:80dd64ca3704213605a362b3004556fa8b98a2aa849d188bda38b898c3499782`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8573943b1e822a60abd5e007708734bb30a316c76892b30591b90ca734d81a6`  
		Last Modified: Tue, 28 Mar 2023 01:29:25 GMT  
		Size: 11.3 MB (11267562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26f1dcf804fa58fff7e21fd4396ad0eea83aeb60ebdb290297dd39996bd6451e`  
		Last Modified: Tue, 28 Mar 2023 01:29:24 GMT  
		Size: 488.1 KB (488128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b10357373b1cdccb27c8fdd4fda4a6558f197d5061613563c57f93b3e80426d`  
		Last Modified: Tue, 28 Mar 2023 01:29:23 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.87-jre17-temurin` - linux; s390x
