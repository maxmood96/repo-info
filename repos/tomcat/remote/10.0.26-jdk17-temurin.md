...
```console
$ docker pull tomcat@sha256:e3041046f7dc911a69e1592dd0ef89ddf430949f75e34af1e0441f34401ee9f1
```
...
### `tomcat:10.0.26-jdk17-temurin` - linux; amd64
...
### `tomcat:10.0.26-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:10.0.26-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:10.0.26-jdk17-temurin` - linux; ppc64le
