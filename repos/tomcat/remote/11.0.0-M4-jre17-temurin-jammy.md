## `tomcat:11.0.0-M4-jre17-temurin-jammy`

```console
$ docker pull tomcat@sha256:0fac573accfb79bab2dcd4c18c6a21ea9b2876341aeafd580ab8fd0a9e4c7d57
```
...
### `tomcat:11.0.0-M4-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.0-M4-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.0-M4-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.0-M4-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.0-M4-jre17-temurin-jammy` - linux; s390x

```console
$ docker pull tomcat@sha256:1ba324a2382200c24b7f3b4a4bd9c6942bc24132943310af1219b501a2c3e5e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.7 MB (101733766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78ae87d2597b3061cfd2f4a2f2cdea2f0950becbc3134e8ea790639d0ef2b927`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 16 Mar 2023 18:46:43 GMT
ENV TOMCAT_SHA512=a3de7a907ff97e25ffed4d0677080b718051dbc9d8c2aea4b2afd97a4bb69482bff8e4caa3378238829a1705f81759fad9460ac45dc553db0f63a10685c694c4
# Thu, 16 Mar 2023 18:46:44 GMT
COPY dir:0e9c82a184e7f9be9350f1a71c54ca256336f0a96e3f51a6df664536b5a36158 in /usr/local/tomcat 
# Thu, 16 Mar 2023 18:46:47 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Mar 2023 18:46:48 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 16 Mar 2023 18:46:49 GMT
EXPOSE 8080
# Thu, 16 Mar 2023 18:46:49 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:09924691b21cfea2dfbb85f29471e0f6a0cacfa5393872f1497102d22add106d`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecafd33ff8bc64de882b681757e8cf80a8eb4efcac602a5c9b4e7ba9c81bfb22`  
		Last Modified: Thu, 16 Mar 2023 18:59:45 GMT  
		Size: 12.1 MB (12135162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a209551ca4e13a91b7f92e4463d077ccde8362d79dc892e639d1b05dac51618e`  
		Last Modified: Thu, 16 Mar 2023 18:59:44 GMT  
		Size: 458.4 KB (458410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fed87746b163c7f224e8e014682e9e7f093c21ecc015f638a2b1414e7bb5d413`  
		Last Modified: Thu, 16 Mar 2023 18:59:44 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
