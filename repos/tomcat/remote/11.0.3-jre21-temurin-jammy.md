## `tomcat:11.0.3-jre21-temurin-jammy`
...
### `tomcat:11.0.3-jre21-temurin-jammy` - linux; amd64
...
-	Layers:
	...
	-	`sha256:4366b15344693300422b144788173ce7b7551c12c1ea13d284c2790d7b5cff84`  
		Last Modified: Tue, 11 Feb 2025 12:14:18 GMT  
		Size: 139.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
### `tomcat:11.0.3-jre21-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.3-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jre21-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.3-jre21-temurin-jammy` - linux; s390x
