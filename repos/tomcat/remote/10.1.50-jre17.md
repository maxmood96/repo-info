...
```console
$ docker pull tomcat@sha256:364408613f7133c95ff9f88e12081b7a640c95b86ca281bce561af60046614ab
```
...
### `tomcat:10.1.50-jre17` - linux; amd64
...
### `tomcat:10.1.50-jre17` - unknown; unknown
...
### `tomcat:10.1.50-jre17` - linux; arm variant v7
...
### `tomcat:10.1.50-jre17` - linux; arm64 variant v8
...
### `tomcat:10.1.50-jre17` - linux; ppc64le
...
### `tomcat:10.1.50-jre17` - linux; s390x
