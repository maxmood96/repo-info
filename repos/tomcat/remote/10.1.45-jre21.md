...
```console
$ docker pull tomcat@sha256:21de34c9ec33ad72612e537341e456815b1cdd92fb90dd67a450067811c83c14
```
...
### `tomcat:10.1.45-jre21` - linux; amd64
...
### `tomcat:10.1.45-jre21` - unknown; unknown
...
### `tomcat:10.1.45-jre21` - linux; arm64 variant v8
...
### `tomcat:10.1.45-jre21` - linux; ppc64le
...
### `tomcat:10.1.45-jre21` - linux; s390x
