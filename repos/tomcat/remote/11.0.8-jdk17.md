...
```console
$ docker pull tomcat@sha256:c1fddd97a196c582672509c4a51086467b59da65da8087dc543e0ca87368bf79
```
...
### `tomcat:11.0.8-jdk17` - linux; amd64
...
### `tomcat:11.0.8-jdk17` - unknown; unknown
...
### `tomcat:11.0.8-jdk17` - linux; arm variant v7
...
### `tomcat:11.0.8-jdk17` - linux; arm64 variant v8
...
### `tomcat:11.0.8-jdk17` - linux; ppc64le
...
### `tomcat:11.0.8-jdk17` - linux; s390x
