...
```console
$ docker pull tomcat@sha256:314422490da661e13a63c53fc53021aed6cf2a054db62739ad23da4b2f37e4cc
```
...
### `tomcat:9.0.78-jdk17-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.78-jdk17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.78-jdk17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.78-jdk17-temurin-jammy` - linux; s390x
