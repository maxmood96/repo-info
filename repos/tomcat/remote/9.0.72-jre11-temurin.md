...
```console
$ docker pull tomcat@sha256:554cae5bf1e7f937494c83998867e64bc481ca3c61edd483f77b49ae2a6d1862
```
...
### `tomcat:9.0.72-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.72-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.72-jre11-temurin` - linux; ppc64le
...
### `tomcat:9.0.72-jre11-temurin` - linux; s390x
