...
```console
$ docker pull tomcat@sha256:1cd429da85a70fb8d507675e07db106044a56b7d88bffd114765dd91a8436b43
```
...
### `tomcat:8.5.99-jre17` - linux; amd64
...
### `tomcat:8.5.99-jre17` - linux; arm variant v7

```console
$ docker pull tomcat@sha256:8d3d12d766c15914be212935f6327a22a0890e160eddf468ab880b6dc861e331
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.8 MB (101762360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52a6b9b228f9e887c20ebb921bd66fc8be4271a0f884c8621089aeda436b791e`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 09:56:29 GMT
ENV TOMCAT_MAJOR=8
# Wed, 21 Feb 2024 04:11:09 GMT
ENV TOMCAT_VERSION=8.5.99
# Wed, 21 Feb 2024 04:11:09 GMT
ENV TOMCAT_SHA512=38f636039d00c66ff8f7347dfedcc1eef85b7ce25cf98dcc9192df07f85d4f6aec447922e0f934c1ab7d099ec484b2060aad4de496d5ca14637ac435cb55b7c0
# Wed, 21 Feb 2024 04:11:10 GMT
COPY dir:275de45653e6d18c66e1e084d4f1a19fb7d6ce858625f29e834cda99a2dc555b in /usr/local/tomcat 
# Wed, 21 Feb 2024 04:11:14 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 04:11:15 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 04:11:15 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 04:11:15 GMT
...
-	Layers:
	...
	-	`sha256:c0ce0364bd4edca128bfd0a83a84713b5576a90a4d2eed28c79ae17605780bbc`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e0c310cfc4c6945626b6ec7891520d30f55678cd8f21ae4996b554d8c4a7c88`  
		Last Modified: Wed, 21 Feb 2024 04:24:22 GMT  
		Size: 11.4 MB (11403385 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83cf970e41ff7c5e3f623c1460e8e9b8f18935edc3c9cf69a9a8712bcfd9209b`  
		Last Modified: Wed, 21 Feb 2024 04:24:21 GMT  
		Size: 433.5 KB (433528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:413dc164d567a7827e7aed463dfdffd204fbe05d44868134fc256fa6c36a4e32`  
		Last Modified: Wed, 21 Feb 2024 04:24:20 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.99-jre17` - linux; arm64 variant v8

```console
$ docker pull tomcat@sha256:a5d707e16bd0307bd969fafad3f1e5d93e36eea75ac002d51608a4e025182dfb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.8 MB (105834046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96dc770a34705b75208fa8a3cefee18dda64e9ab3ebfea3591d064081f3590bc`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 07:34:56 GMT
ENV TOMCAT_MAJOR=8
# Wed, 21 Feb 2024 02:28:58 GMT
ENV TOMCAT_VERSION=8.5.99
# Wed, 21 Feb 2024 02:28:58 GMT
ENV TOMCAT_SHA512=38f636039d00c66ff8f7347dfedcc1eef85b7ce25cf98dcc9192df07f85d4f6aec447922e0f934c1ab7d099ec484b2060aad4de496d5ca14637ac435cb55b7c0
# Wed, 21 Feb 2024 02:28:58 GMT
COPY dir:7697927754f632aabbc2503e9ab7aae575e6facdd2139384560f810bde892613 in /usr/local/tomcat 
# Wed, 21 Feb 2024 02:29:02 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 02:29:03 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 02:29:03 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 02:29:03 GMT
...
-	Layers:
	...
	-	`sha256:834bcd95e101783ee58afe3b6ea7c1050d27b18b749f6b70e0bcbce490b2298e`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3d3d9251aae460de7e77031a86b1ea73f396c93e99e39384c5fe19a7f9dca99`  
		Last Modified: Wed, 21 Feb 2024 02:49:28 GMT  
		Size: 11.5 MB (11475477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55e4fe8b436e01e5cf6ec84d0bf3cc4d84614cf81e9cebff431abc02120486e3`  
		Last Modified: Wed, 21 Feb 2024 02:49:27 GMT  
		Size: 457.1 KB (457136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c03e460ab9725a7cb8c74262204e33e5e82ad7d92d85971b2e38616d0032e64b`  
		Last Modified: Wed, 21 Feb 2024 02:49:27 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.99-jre17` - linux; ppc64le

```console
$ docker pull tomcat@sha256:5bbc80fbd0001953c3a6431aba1efe4ef30ae2ef86b185728c8d7d60c53e094d
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.4 MB (113355060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4b6f8c7e51a43186aba88a2ab62897ba8731c55736ccfc411d9502ce7db039d`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 05:10:52 GMT
ENV TOMCAT_MAJOR=8
# Wed, 21 Feb 2024 03:04:42 GMT
ENV TOMCAT_VERSION=8.5.99
# Wed, 21 Feb 2024 03:04:43 GMT
ENV TOMCAT_SHA512=38f636039d00c66ff8f7347dfedcc1eef85b7ce25cf98dcc9192df07f85d4f6aec447922e0f934c1ab7d099ec484b2060aad4de496d5ca14637ac435cb55b7c0
# Wed, 21 Feb 2024 03:04:43 GMT
COPY dir:fb9ac75aff373757d0fbca25c247f806e509e8fce8f7f37fb0db9d8649d68d22 in /usr/local/tomcat 
# Wed, 21 Feb 2024 03:04:49 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 03:04:52 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 03:04:52 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 03:04:52 GMT
ENTRYPOINT []
# Wed, 21 Feb 2024 03:04:53 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a515b8f2ec4e0019840dbf53bb6403e487fe611bd65a8ad1a6cab8513ac76088`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f9a972723e9940a8e3c4f0d933d9477c26cc3dbe99423b86541da17b8ad4773`  
		Last Modified: Wed, 21 Feb 2024 03:30:57 GMT  
		Size: 11.5 MB (11496631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb93b25b6da135ab2876cdc14fdc468580a845e3a969aef846ef5aa683ff0ade`  
		Last Modified: Wed, 21 Feb 2024 03:30:56 GMT  
		Size: 489.7 KB (489733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6598e6b5ba9bccef60596a5a7fb00de65d29f694caa46741217b5fa0d53fffb`  
		Last Modified: Wed, 21 Feb 2024 03:30:56 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.99-jre17` - linux; s390x

```console
$ docker pull tomcat@sha256:5a357308b169459814dede7f40598cb1498f24b7c1d176d2df2e60ed7ed31373
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.6 MB (101592986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90d4474d941ba83f8fb4691e03b83ce0790e085aa0a8defea875cbabb786f1bc`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 14:00:29 GMT
ENV TOMCAT_MAJOR=8
# Wed, 21 Feb 2024 04:23:11 GMT
ENV TOMCAT_VERSION=8.5.99
# Wed, 21 Feb 2024 04:23:11 GMT
ENV TOMCAT_SHA512=38f636039d00c66ff8f7347dfedcc1eef85b7ce25cf98dcc9192df07f85d4f6aec447922e0f934c1ab7d099ec484b2060aad4de496d5ca14637ac435cb55b7c0
# Wed, 21 Feb 2024 04:23:12 GMT
COPY dir:f8d2e460f2d4181ccd1f95ca3fd16e6cbc54dc1282c751f8ff1358e414142819 in /usr/local/tomcat 
# Wed, 21 Feb 2024 04:23:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 04:23:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 04:23:16 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 04:23:16 GMT
...
-	Layers:
	...
	-	`sha256:e0ef76cb7bac71df7b3cb7f311f8518f152108ffbb778e0bd486905727750d38`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d67759e4bbc7bf6891e23dca5ca6ac43f254405f54941b2a32fbf2398a67ed4e`  
		Last Modified: Wed, 21 Feb 2024 04:39:52 GMT  
		Size: 11.5 MB (11465642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d705e8d2d0d5f957505475f72b5391df0f75608489a26f2fc90dec4858e3b69e`  
		Last Modified: Wed, 21 Feb 2024 04:39:51 GMT  
		Size: 459.9 KB (459921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:270d08b2f7fff653cd4cf2994899e83c1a3846c2e949fc505626dd4ea508fe73`  
		Last Modified: Wed, 21 Feb 2024 04:39:51 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
