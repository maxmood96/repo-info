...
```console
$ docker pull tomcat@sha256:9db3d2e8c4aad57d1bb529cf7427ff24a3325c2a4cf599117d9af264cc0170c9
```
...
```console
$ docker pull tomcat@sha256:985d655cfa6ce78f72c29d679871db61fe08e6b637574418d3a0a87855b309bd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.1 MB (134065015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d32e80bdf826c40fcd9c91964737f4659ec9d08e9d42c41f23d34b53c07af87`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 04 Sep 2021 03:25:32 GMT
ENV TOMCAT_MAJOR=10
# Tue, 14 Sep 2021 17:50:38 GMT
ENV TOMCAT_VERSION=10.1.0-M5
# Tue, 14 Sep 2021 17:50:38 GMT
ENV TOMCAT_SHA512=fbc0721794f7d604b9036f67b995f31d541aee0eddc4d911274f0af2a13b264b2435450946192628efdef035eef50adcd929752fae8ca50dbb07b53e36e1bd48
# Tue, 14 Sep 2021 17:50:38 GMT
COPY dir:56846cbdd2a95cbfa4485f692cd2026fe25942c38c1db7af1225e52abf994d8b in /usr/local/tomcat 
# Tue, 14 Sep 2021 17:50:42 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 Sep 2021 17:50:44 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 14 Sep 2021 17:50:44 GMT
EXPOSE 8080
# Tue, 14 Sep 2021 17:50:44 GMT
...
-	Layers:
	...
	-	`sha256:8006d8a9e3d247fb6e2116243c87c00f309c91ca8a230eda24ecd14eafbd2e44`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df1e03a8232785e366431ad586f9c42c6cb560154c47d482b84092d7676aa03`  
		Last Modified: Tue, 14 Sep 2021 19:01:04 GMT  
		Size: 12.4 MB (12406130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd2d23dfc37e8ead68a94c0cc231b44de8d4c23eb93e81b3ed977fa62b674974`  
		Last Modified: Tue, 14 Sep 2021 19:01:03 GMT  
		Size: 457.3 KB (457310 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:037bf2f41aab7942e9fb6587cba94f8229a855ac12b278211fc94b90fa4921fc`  
		Last Modified: Tue, 14 Sep 2021 19:01:03 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
