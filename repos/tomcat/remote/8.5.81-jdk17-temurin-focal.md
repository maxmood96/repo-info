...
```console
$ docker pull tomcat@sha256:61bdc0896d21966408a3d3a6a3b1371397dff5cae685b75b7a6f6a38880e1cf0
```
...
### `tomcat:8.5.81-jdk17-temurin-focal` - linux; amd64
...
### `tomcat:8.5.81-jdk17-temurin-focal` - linux; arm variant v7
...
### `tomcat:8.5.81-jdk17-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:8.5.81-jdk17-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.81-jdk17-temurin-focal` - linux; s390x
