...
```console
$ docker pull tomcat@sha256:1f2ed25e9a1875df6a9b1721a88399ad0c77a5b6a1cb6eb45332ba4daf6a3a17
```
...
```console
$ docker pull tomcat@sha256:56af1d89cb4f3896af16ee908e9142e298b7b8e66b7744b4a23fba42dd81f4b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.1 MB (134058246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da013e8e5dc6b3c8e4a7ec76dd653c3ad7888a97164b0b70b3f750b882712eb1`
...
# Sat, 28 May 2022 21:46:28 GMT
COPY dir:82cc34fba5ceb98615885155ceac94dc44f7e30b8dd06f72b8d7e1fb414a1602 in /usr/local/tomcat 
# Sat, 28 May 2022 21:46:32 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 May 2022 21:46:33 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 28 May 2022 21:46:34 GMT
EXPOSE 8080
# Sat, 28 May 2022 21:46:34 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:22221c04a0c770d62731aca9d77c4e7c4abbb4ffa43b1d7c003f1b019cc829d5`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:513c62b18b534fc4d04eaad05aa6b83ea1ffe8d203dcfc886995297a20a8d749`  
		Last Modified: Sat, 28 May 2022 22:14:57 GMT  
		Size: 12.6 MB (12563160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1ed5ea395f7672183189ed996db59818a61591653c2b8765f4da9852208c3e8`  
		Last Modified: Sat, 28 May 2022 22:14:56 GMT  
		Size: 461.0 KB (460975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49081fd59dd649d784ca8d92130eb5760bb56b7170bec578ec4ef56076a9075a`  
		Last Modified: Sat, 28 May 2022 22:14:56 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
