...
```console
$ docker pull tomcat@sha256:cd6a9466981df2b4d68924fb1cbf19e5ca9d17101d6a713fc837544b8a07943c
```
...
```console
$ docker pull tomcat@sha256:5ccef78ac404318c924f055b99e95de3fe1a2933d68f63539a214a1e9645024d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153249094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:427b495037fbdeea1077c3537141b6184b5c80b2979b7c6ea6c84d85d69e04f1`
...
# Wed, 21 Jul 2021 00:54:46 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Jul 2021 00:54:47 GMT
EXPOSE 8080
# Wed, 21 Jul 2021 00:54:47 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:364d4feb5485a94267497c112a63a08d21d7cd69679eff7b74a300add8779d7c`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43672c4a16e18acffb665875720bc66f9d89d88c7c8ac8049b0ab06ea3086835`  
		Last Modified: Wed, 21 Jul 2021 01:03:28 GMT  
		Size: 15.9 MB (15949798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ada48789608b9b9a0fa4d9bc70d097e9e6e9eaf7558b73306ec3b2a1532f652`  
		Last Modified: Wed, 21 Jul 2021 01:03:25 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
