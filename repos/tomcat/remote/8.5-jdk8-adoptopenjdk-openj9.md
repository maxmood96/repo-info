...
```console
$ docker pull tomcat@sha256:980fc10ae122e6002820d12cd0e60eda230ac20acf5b504624891d4e8db8fb19
```
...
```console
$ docker pull tomcat@sha256:2ddc421f8769a6ea7f9b21c27160000aac3163163158b50620cdfcdad200b5b2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176582905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81cb52b527a28fe2090d86e47e785489dcdee9a24e297945caa271f467a2cd13`
...
# Thu, 26 Nov 2020 04:31:39 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 26 Nov 2020 04:31:40 GMT
EXPOSE 8080
# Thu, 26 Nov 2020 04:31:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:cd1bfe7629bf54fcb0c36c6dd708c82c6fa27bb94c18c8c53403f79486c3138c`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:518d42bbc2e05eded063c2f1e8073577033e07970e9498ac0e4df4dd74967cd1`  
		Last Modified: Thu, 26 Nov 2020 04:39:22 GMT  
		Size: 11.6 MB (11617431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0483e5403f57fcdec8cf9eb1cd3b0d1add57fa21bff5d6d57fe84647a22c6679`  
		Last Modified: Thu, 26 Nov 2020 04:39:21 GMT  
		Size: 184.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
