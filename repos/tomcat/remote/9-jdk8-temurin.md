...
```console
$ docker pull tomcat@sha256:cf411aa101902e1aefc00998cbaf7992d98e9ec518d251bb8d5dc36519ed60a9
```
...
```console
$ docker pull tomcat@sha256:7ec07ad04537fba3c526bfea3ef80d8cefc30e1b0da618e01e55510c8c5ee7e9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.4 MB (115399593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efcf05c1a6b56b89e422470728131012df5ef90c1afe3fc846a47c0ec3624d75`
...
```console
$ docker pull tomcat@sha256:982d4838965d1d0f32d374ff857d1471614bbdaf262776638e548aac0f99794f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3582384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6f476bb57723b321f14a0fcb25ef880fa959cdc253d58382f1a1e85c03016ad`

```dockerfile
```

-	Layers:
	-	`sha256:8931394bf116954daa844d2f8fc03fcd9ec34b66cbfde5028cb8fae65347450a`  
		Last Modified: Sat, 08 Nov 2025 18:33:18 GMT  
		Size: 3.6 MB (3550229 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d6e01bfe1b12f20d5c586da26b688ce609fe891db33c00b79fd5c45e467077f3`  
		Last Modified: Sat, 08 Nov 2025 18:33:18 GMT  
...
```console
$ docker pull tomcat@sha256:492b07470158c25e9dc171c82e4da07f1638788efcc7c638edb1ab0297132c95
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107173353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4ac6048d113504ed8d41ce10c31312d817f23493c750d347411dc125762dd50`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:a758b18e4bd34f9aa7cf549145b89ed0de030231fd0b7b164dc5d9d3493a889b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3586555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78ff3585258390bc7f7ddf7a8c98b3a780056d1294ff4e3655b7c1a44d6c4445`

```dockerfile
```

-	Layers:
	-	`sha256:ceb862581c128871c8cbef97290ff1f44b63d354c92e21c34de829bfeb85952a`  
		Last Modified: Sat, 08 Nov 2025 18:33:22 GMT  
		Size: 3.6 MB (3554254 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4064b59305ddb867fb795b2ef379a8f79566178041f0e8dffa6fe42e00b11649`  
		Last Modified: Sat, 08 Nov 2025 18:33:23 GMT  
...
```console
$ docker pull tomcat@sha256:8882e305a03bdcca486f8dadd391cf6ad244309b28eb824ce83187272ea573c3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.6 MB (113644965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdf2efa84bd2a0e4fd2af5d47f16be1be65c6ff34b39d28bf175638fee7d0aa0`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:dd5b4c4d3fe8c97d185986d6e45e3b3eba63fa87f725149e92f8a071978b26d6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3583806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06cc2c86c98f209eeda0b3574792ffab3319d19dbf893af3b8ea648b0ee8f919`

```dockerfile
```

-	Layers:
	-	`sha256:9ee0c9ea9330ea796a9b6beca5c7d81f42d313392f78f3746923bf5e1b3b31f1`  
		Last Modified: Sat, 08 Nov 2025 18:33:27 GMT  
		Size: 3.6 MB (3551459 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0574e71d60e8bca434d46bafe0aa941b091cbd792a1ab8ac14e99cefc1b7cb51`  
		Last Modified: Sat, 08 Nov 2025 18:33:28 GMT  
...
```console
$ docker pull tomcat@sha256:091e904c3cc49e419e0ed607d0a3b3c70f5cd8499177ebd5cd65ac207862e76d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.3 MB (119328645 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6485a07153acbd89cae06f4bdf907ddd29b484a3dd929d2df541889835db34f`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:a0d0b1bf5e08fafe43caa06eab6c486eabcf9a9a78e6f9805edda8252aeaaa8c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3585243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4883b16d93bd4268061fe95151ea2bd2598a5e9b6223c78649aaf56f40685651`

```dockerfile
```

-	Layers:
	-	`sha256:0144f7d647df07dc3216b1ce6fd8622ac4f2d638be20c4e7aac4be9950afc323`  
		Last Modified: Sat, 08 Nov 2025 21:44:45 GMT  
		Size: 3.6 MB (3553010 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e39578a08939fea1bf3a7e7470f159b98ee32c1203a745f0c77bed4d3d2333bb`  
		Last Modified: Sat, 08 Nov 2025 21:44:46 GMT  
