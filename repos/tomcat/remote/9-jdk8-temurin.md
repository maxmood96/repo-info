...
```console
$ docker pull tomcat@sha256:217f1165bc1adf5b6cefafb9e086eea977580696527c9d7bfef3734bbbbfb89f
```
...
```console
$ docker pull tomcat@sha256:1c2a098a14af9082baac7db745a057c40ae2085c028609c8fdb5978b2c3c5800
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.3 MB (119334002 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51fe8918b76738a499e7d5add7d7b62ecbd6b6b4031459532756867c8fcec65e`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:f371e0395db11194025eca8a84a74f4ef8150ae2b3396612d2ee7bdd74fa691f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3585243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ae538879090244fd5007aa0fe52a384ee409f10ed40611874ac8cf5b7c0dded`

```dockerfile
```

-	Layers:
	-	`sha256:1d38833e9c96d5e8edcddaae39ce085bce30444006cc11024751de3a253dda95`  
		Last Modified: Fri, 14 Nov 2025 06:36:31 GMT  
		Size: 3.6 MB (3553010 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d3f777717b52ec837c0730575b5013ae4d6b1c2024a8bf5354f409eda75cf496`  
		Last Modified: Fri, 14 Nov 2025 06:36:31 GMT  
