...
```console
$ docker pull tomcat@sha256:9dc81247a6deec87ce4a83cde799773ae0fe4e29d55ae4648a7c03911dc72613
```
...
```console
$ docker pull tomcat@sha256:a4cb49985c7089391ae39a38d1dbff61309a30441f72e98265f367fb4081f784
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159587699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee21762fbb8b259d368a771c2dbb6252dd5201cc0eff74dcbf6621562a43a5a2`
...
```console
$ docker pull tomcat@sha256:94c4ddb14b683fd87848d29d9d5f4bf45bf6b8ba38a8ef61edc0e8fc91b06a86
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3551126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c14323482e260b12951cb50bee6ccff754f292e651313b984df06e39c556b6c`

```dockerfile
```

-	Layers:
	-	`sha256:813db4e7c996a14c28959690bc85b9f8403c3a25c7d9c9ab418b7263d1156363`  
		Last Modified: Mon, 08 Jul 2024 22:57:12 GMT  
		Size: 3.5 MB (3520172 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fe6fcfd5fc174283ac477a040c130a6b109d18c970354532c945bb1e198e4807`  
		Last Modified: Mon, 08 Jul 2024 22:57:12 GMT  
...
```console
$ docker pull tomcat@sha256:79e66865ea3441714f9dbdbb6dd4144eff0ee2f298c54c4ec511a8d75362d546
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.8 MB (151806074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12b925b39931bb8750849e3cb4871ea84c8335abcfe7274cd8f92c3f0dac619d`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:8125a0385f57345896d32638c5e410f881c4fd35274e58d6520ed9d2837bfd0b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3554170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:231d1d1a2c2c3b0578a377500ff718546a046f5f53f397aae45399c7721fff91`

```dockerfile
```

-	Layers:
	-	`sha256:f9ae35c1ee51d172d5a6f609f5769746fe43ea2db0ecb2cb5edcbd6ae485bce5`  
		Last Modified: Mon, 08 Jul 2024 23:13:22 GMT  
		Size: 3.5 MB (3523085 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0870d94df3c31b6df0754013f663a28dafd701c6f2224769d0ea67bea45321b5`  
		Last Modified: Mon, 08 Jul 2024 23:13:22 GMT  
...
```console
$ docker pull tomcat@sha256:cc2240a8fd8e1fe89037200f0c1456a6b51db8f280fdf8f4edb2e1dc07c81f4e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.6 MB (156599243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f73652dc427e7dd4c5011b05d9f6f7dddab41dbaf33dcc9097f36639986d7eb5`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:64b732cf9fe446f44efd3810342b0a78513601f92835ba4193b37080220745f7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3551854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcd0a1003e088a7a6d5811b5f8e912c2c8244149ae63bbabf1e5cf3446647b47`

```dockerfile
```

-	Layers:
	-	`sha256:58cf3ad96bf5cd8daf036e85c0cf65436ee55c0bff35276d0508e59ae6a4ec8f`  
		Last Modified: Mon, 08 Jul 2024 23:14:30 GMT  
		Size: 3.5 MB (3520524 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:23462b766b2c44c1debe96079b97451402555d3de27796439467c9edb7c78789`  
		Last Modified: Mon, 08 Jul 2024 23:14:29 GMT  
...
```console
$ docker pull tomcat@sha256:a4679f7bee588cd5dc9032b19552c165b463509647edd570c11efed6a9c5a0e4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.1 MB (163108863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cfb43927a1942623239110d7ad0ae183dc465bac0d4b768cdfc150cd87356c0`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:2a3185680db2bbf849c78c55e22e399a9c1f97a4ac820844d08bb0273fef6d02
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3554784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9debcaad9f74f5ab0cf49203b32257e7691e6fc721b9ec9ab1fbe92571443516`

```dockerfile
```

-	Layers:
	-	`sha256:b6baf8eaf0bf74e52e95e8a4f6e0fe78ef085635a25806fad1613740580699d3`  
		Last Modified: Tue, 09 Jul 2024 03:16:22 GMT  
		Size: 3.5 MB (3523758 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:18e6e97117dd5539c6cf48a54688d5d5696087b49dc0d2c531ba1b761b07a440`  
		Last Modified: Tue, 09 Jul 2024 03:16:22 GMT  
