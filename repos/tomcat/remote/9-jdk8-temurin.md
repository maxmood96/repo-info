...
```console
$ docker pull tomcat@sha256:465b00ac7f68786e622d3705626cda3ed48515e2214ded0891785fdd03b97abe
```
...
```console
$ docker pull tomcat@sha256:497f1b73f5845fd544bec13eb99323fe02370140295be870aa4a162088dbbea4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (118954556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa1fd243fac13c454ff52d7b09f6d6a7fa13f69ae3cdd9be7605525f8dd3fc42`
...
```console
$ docker pull tomcat@sha256:042c2bc40dedfd055705ec5ddc9cba8697545704ee5c16a23d99f4629afbd2d0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3582399 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b2bfc32a44633d175f5eee4a2231aa4f487306404ba5bc9188c58f33975e686`

```dockerfile
```

-	Layers:
	-	`sha256:816f1b00374e52fd03482d5dbcfad2fad301dfa6e9b405e7cb34b8280d312b33`  
		Last Modified: Mon, 07 Jul 2025 21:13:03 GMT  
		Size: 3.6 MB (3550203 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bd53f0bfbdcd8437750034b54ddc6757f453265311c4a841d3deb1cebb85b753`  
		Last Modified: Mon, 07 Jul 2025 21:13:04 GMT  
...
```console
$ docker pull tomcat@sha256:f3d1413540be0430fac639218dedac8457e4c728c2deceef4b615ddf22971d74
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.8 MB (111801021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbf18e6f3f238249bb06b930fff2394be0207991625f5759c617467c0418b4b0`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:fe2ca5ff779f1896503aaa8ba44655a4d99b4c6d91471ed4f69366a2cb1848f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3586568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:092866785e50319231b89392a7c93e7bb4a5ceaf1bde9a8e09d10458a99a3231`

```dockerfile
```

-	Layers:
	-	`sha256:a44882533249b0698d60067f128e0991c936ae52c37c275f9d8598216b3d6fb4`  
		Last Modified: Tue, 08 Jul 2025 05:34:56 GMT  
		Size: 3.6 MB (3554228 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:9fd72c9bcc65684db6fb7daa4bc0aecdc228b4331bc0ce2095a2f726fc68f0d7`  
		Last Modified: Tue, 08 Jul 2025 05:34:57 GMT  
...
```console
$ docker pull tomcat@sha256:3ba0a9c1959519e0bae967dd8afafba6474eb36ded2b524f85a0745f7a3019f3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.3 MB (117287692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1eb1cf234470cdd3ec23a92b5ba83530b53f8b28ee7b3bfcd4fabf54e379ec2`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:82339f248e7e7ec6a31fa055b89c420697d0181b4da6a9e8e5fe07d112ab55d6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3583825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abf17676fe2b7a7b317909db2f5f25ee9138a02c5f72ab313d68485398d94384`

```dockerfile
```

-	Layers:
	-	`sha256:5c50842af1bc13dd3f43660b7bfe0388f6f0eb29e51e1175a173109771975f85`  
		Last Modified: Tue, 08 Jul 2025 05:35:01 GMT  
		Size: 3.6 MB (3551433 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2a5472c56111d9d3d2a023e7548fd5ee65b80d3596ddfa1b3648839161617847`  
		Last Modified: Tue, 08 Jul 2025 05:35:01 GMT  
...
```console
$ docker pull tomcat@sha256:4801efea027bd4d57e3febf1bc8a8de493ac2e9e6e42c9cf737c079557ff1981
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **123.8 MB (123767569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5885dd39938f7b393b2ea7f7eb33f8544d30e5d6e94fd6fa47b81ed239142e0`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:f5832dfa4f32068b1eb6c2ab570d625b8b3780244870143d3b582389fbf89b33
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3585260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c75545c188eee7397c1973f2ebef6aea4860275b5cf605523a004eb95969ca81`

```dockerfile
```

-	Layers:
	-	`sha256:234808efff0851e109a454357fcc1a2262d02e0725a715263c773be028613865`  
		Last Modified: Mon, 07 Jul 2025 23:35:23 GMT  
		Size: 3.6 MB (3552984 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:141af25e111a9edf28fab6fbc7b6f2c7ffdc3719f47ca1ad91e469d2d0bd1b35`  
