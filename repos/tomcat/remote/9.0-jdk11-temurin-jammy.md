...
```console
$ docker pull tomcat@sha256:be1703d597c33d8fa7fa90cd9abc8491e8000c7997fd918a2a31e7c70f7c2d54
```
...
```console
$ docker pull tomcat@sha256:125bd87254660d11795814a4964dd6679abe2e8a7e98cb0eff6aac0ba73d089f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.5 MB (201517973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75cacbe32d1ca9cf18a6f026eae87b24f70e7111bd9ab0002a41d74e1748cce8`
...
# Fri, 02 Feb 2024 12:29:45 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Feb 2024 12:29:45 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 12:29:46 GMT
ENTRYPOINT []
# Fri, 02 Feb 2024 12:29:46 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f6a8a9cbaf7de0759a2dced317f35f98cb5ba72622390a7241fa675637a5f085`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e43efb77655eb342d3c7efd53de38fa54d40561de05d6640b0a87ab8bb8de9d8`  
		Last Modified: Fri, 02 Feb 2024 12:52:27 GMT  
		Size: 12.9 MB (12873906 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb06d51e7b804f4b02b1640d7e558d10f28851ecbc02867271ad8dfe0c849913`  
		Last Modified: Fri, 02 Feb 2024 12:52:26 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
