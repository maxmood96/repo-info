...
### `tomcat:11.0.14-jre17` - linux; amd64
...
### `tomcat:11.0.14-jre17` - unknown; unknown
...
### `tomcat:11.0.14-jre17` - linux; arm variant v7
...
### `tomcat:11.0.14-jre17` - linux; arm64 variant v8
...
### `tomcat:11.0.14-jre17` - linux; ppc64le
...
### `tomcat:11.0.14-jre17` - linux; riscv64
...
### `tomcat:11.0.14-jre17` - linux; s390x
