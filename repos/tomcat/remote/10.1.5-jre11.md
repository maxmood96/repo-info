...
```console
$ docker pull tomcat@sha256:9454259db837c08ef89713da60a14fe1e644c3534caf2199718a74282b2d7aa4
```
...
### `tomcat:10.1.5-jre11` - linux; amd64
...
### `tomcat:10.1.5-jre11` - linux; arm variant v7
...
### `tomcat:10.1.5-jre11` - linux; arm64 variant v8
...
### `tomcat:10.1.5-jre11` - linux; ppc64le
...
### `tomcat:10.1.5-jre11` - linux; s390x
