...
```console
$ docker pull tomcat@sha256:de87414797b780dbf800b17b2cecb9c6ee5c8dfae3f4cf8545d4bc401cb346e5
```
...
### `tomcat:9.0.118-jre8-temurin-noble` - linux; amd64
...
### `tomcat:9.0.118-jre8-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.118-jre8-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.118-jre8-temurin-noble` - linux; arm64 variant v8
