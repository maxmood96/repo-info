## `tomcat:8.5.66-jdk16-openjdk-slim-buster`
...
### `tomcat:8.5.66-jdk16-openjdk-slim-buster` - linux; amd64
...
### `tomcat:8.5.66-jdk16-openjdk-slim-buster` - linux; arm64 variant v8
