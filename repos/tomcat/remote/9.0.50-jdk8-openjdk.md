...
```console
$ docker pull tomcat@sha256:cecaf8e1f344b54ab33e68bf3c1e31ad648e170775115890366b8d6da45d880b
```
...
### `tomcat:9.0.50-jdk8-openjdk` - linux; amd64

```console
$ docker pull tomcat@sha256:8e43dd14d5f6fc8a87efc3edceb6fae7fc9484d0f30452776aaba2b1cc0bcd1e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.9 MB (243900208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe84fc5aeced2bc49c0018ef6d9849b331c29fe09fcf34ac737ab29fc000fed5`
...
# Fri, 23 Jul 2021 09:49:00 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 23 Jul 2021 09:49:00 GMT
EXPOSE 8080
# Fri, 23 Jul 2021 09:49:01 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d24d42fda4321ad80db3a3b1d284d7093fcd38c3eb8479d441076956e563b2ba`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d11b7d3d68cf44e931e988db483429a2876d9d20945df7301ec1987ca0b7a0fe`  
		Last Modified: Fri, 23 Jul 2021 10:06:39 GMT  
		Size: 12.5 MB (12513169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd987d152244ade1eb2d5f7effc1126ea7eff8035acd437f1dbdbd3b224baddd`  
		Last Modified: Fri, 23 Jul 2021 10:06:37 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:9.0.50-jdk8-openjdk` - linux; arm64 variant v8
