...
```console
$ docker pull tomcat@sha256:71923d9aece231743eedea9c78754f31907230961abbd7f12392dfbc425833b3
```
...
### `tomcat:10.1.19-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.19-jre21-temurin-jammy` - linux; ppc64le
