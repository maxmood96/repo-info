## `tomcat:10.1.12-jre11-temurin`

```console
$ docker pull tomcat@sha256:c6d510e096812b2f564fb5383ad1bd062ec4be2b1496017b87c316b1f3927e3d
```
...
### `tomcat:10.1.12-jre11-temurin` - linux; amd64
...
### `tomcat:10.1.12-jre11-temurin` - linux; arm variant v7
...
### `tomcat:10.1.12-jre11-temurin` - linux; ppc64le
...
### `tomcat:10.1.12-jre11-temurin` - linux; s390x
