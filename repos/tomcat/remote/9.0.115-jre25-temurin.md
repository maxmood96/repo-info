...
### `tomcat:9.0.115-jre25-temurin` - linux; amd64
...
### `tomcat:9.0.115-jre25-temurin` - unknown; unknown
...
### `tomcat:9.0.115-jre25-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.115-jre25-temurin` - linux; ppc64le
...
### `tomcat:9.0.115-jre25-temurin` - linux; riscv64
...
### `tomcat:9.0.115-jre25-temurin` - linux; s390x
