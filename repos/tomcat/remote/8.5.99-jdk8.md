...
```console
$ docker pull tomcat@sha256:814be407cf8288069fad5a14df6141253b371cf78cb3b99bb38753d9e9d22010
```
...
### `tomcat:8.5.99-jdk8` - linux; amd64
...
### `tomcat:8.5.99-jdk8` - linux; arm64 variant v8
...
### `tomcat:8.5.99-jdk8` - linux; ppc64le
