...
```console
$ docker pull tomcat@sha256:954d464f5c1c35bcccb756b2c20d793b57f25ae5e36eb38785eed02262bf4dde
```
...
```console
$ docker pull tomcat@sha256:d25eea34fd45927762a8cc6a09e51fc7f20c12e1c7efbf98279786d30bae486b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.9 MB (127871832 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cb45d784b9c264986a27ebbeb858d7da91ff9d6ab1126d0e7c4d3cd18182983`
...
# Fri, 04 Feb 2022 01:53:25 GMT
COPY dir:0744676e1d73c00ee18129f49277c4286914c667be5ddf87e04524076c5592a3 in /usr/local/tomcat 
# Fri, 04 Feb 2022 01:53:30 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 01:53:32 GMT
...
-	Layers:
	...
	-	`sha256:dcaf928fa8f068e2481ffb0905ac05a5e3cf5fb4d337a78e27c39365a220cabc`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d2bd1dd4e3de138501773a75aee96da2516f096569d7a34e0668095433b0ae`  
		Last Modified: Fri, 04 Feb 2022 04:12:08 GMT  
		Size: 12.2 MB (12216011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9f28936d0ec676ccf1ab1eeae1eb9a84f7fff01cda6b3c2af64270f542d7ff0`  
		Last Modified: Fri, 04 Feb 2022 04:12:07 GMT  
		Size: 460.9 KB (460926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a4e91536fc42ac76d1efa94c738e7bb812eedb08f8b123879d64762b6597bf`  
		Last Modified: Fri, 04 Feb 2022 04:12:07 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:60468e918912c4b71fb4c18a299057cde91d67628bb1f4e82ecc8d269361b03d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.3 MB (125299461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e65f879d10a9a9b959c8a3309d7444e63f064b6f552e275e35a703c8f0d97ea`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 04 Feb 2022 01:12:05 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Fri, 04 Feb 2022 01:12:06 GMT
ENV TOMCAT_MAJOR=9
# Fri, 04 Feb 2022 01:12:07 GMT
ENV TOMCAT_VERSION=9.0.58
# Fri, 04 Feb 2022 01:12:08 GMT
ENV TOMCAT_SHA512=33c030a312a0a087deeb06fff921d13a23789e152d30620f33a368e7a2244c762fcf9acd55f3b90f08560704ba45bc2be820bccf2058b0cf5801a7b124f9056d
# Fri, 04 Feb 2022 01:12:10 GMT
COPY dir:c2c19ca75b0ae657a4277c61a83a3dbd12daa356d322b65aa6a715178239482c in /usr/local/tomcat 
# Fri, 04 Feb 2022 01:12:13 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 01:12:15 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 04 Feb 2022 01:12:16 GMT
EXPOSE 8080
# Fri, 04 Feb 2022 01:12:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3c69389b562a93be0c7b03e7346b20d7d914b891b12f764db72e19220cfe5416`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:618b3ad7b699bb19cd96c56502490b2764c74623930aa78e8f75fefc5d945cca`  
		Last Modified: Fri, 04 Feb 2022 02:03:52 GMT  
		Size: 12.2 MB (12230223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:550471df12b89ceebed8c59649786c9730dee698de72e6b28c89f8bc1b3a9f23`  
		Last Modified: Fri, 04 Feb 2022 02:03:51 GMT  
