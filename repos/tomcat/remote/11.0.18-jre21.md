...
### `tomcat:11.0.18-jre21` - linux; amd64
...
### `tomcat:11.0.18-jre21` - unknown; unknown
...
### `tomcat:11.0.18-jre21` - linux; arm64 variant v8
...
### `tomcat:11.0.18-jre21` - linux; ppc64le
...
### `tomcat:11.0.18-jre21` - linux; riscv64
...
### `tomcat:11.0.18-jre21` - linux; s390x
