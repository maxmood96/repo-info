...
```console
$ docker pull tomcat@sha256:f0adc5a6e744903510f80be7e885891fe6f0546666f66504d2421867a9b0e04d
```
...
### `tomcat:8.5.82-jdk11-temurin-focal` - linux; amd64
...
### `tomcat:8.5.82-jdk11-temurin-focal` - linux; arm variant v7
...
### `tomcat:8.5.82-jdk11-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:8.5.82-jdk11-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.82-jdk11-temurin-focal` - linux; s390x
