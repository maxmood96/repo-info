...
```console
$ docker pull tomcat@sha256:8d1c0be179c92da0edfbbb542aecf91626134fce9c6c661938d297a78de856de
```
...
### `tomcat:10.1.49-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.49-jre17-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.49-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.49-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.49-jre17-temurin-jammy` - linux; ppc64le
