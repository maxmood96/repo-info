...
```console
$ docker pull tomcat@sha256:b2b9ed0d1126418d87e33ee056c90c3418a8368d287af9bf884e89578416b79f
```
...
### `tomcat:9.0.71-jre17-temurin` - linux; amd64
...
### `tomcat:9.0.71-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.71-jre17-temurin` - linux; ppc64le
...
### `tomcat:9.0.71-jre17-temurin` - linux; s390x
