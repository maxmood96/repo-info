...
```console
$ docker pull tomcat@sha256:1d5e653c5c630e258a9da81c4d3e43e6eb3920d7de3e9fd2d0555bb372258c32
```
...
### `tomcat:11.0.13-jre21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.13-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.13-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.13-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.13-jre21-temurin-noble` - linux; s390x
