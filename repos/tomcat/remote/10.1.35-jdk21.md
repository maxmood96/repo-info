...
### `tomcat:10.1.35-jdk21` - linux; amd64
...
### `tomcat:10.1.35-jdk21` - unknown; unknown
...
### `tomcat:10.1.35-jdk21` - linux; arm64 variant v8
...
### `tomcat:10.1.35-jdk21` - linux; ppc64le
...
### `tomcat:10.1.35-jdk21` - linux; riscv64
...
### `tomcat:10.1.35-jdk21` - linux; s390x
