...
```console
$ docker pull tomcat@sha256:81db23627ddc8824096ace67c0b01fc4fd27a4104c517dc2ffc812a592e12de9
```
...
```console
$ docker pull tomcat@sha256:cf9379543e7cf03e9d5d98217ad2d027ebd18f9b914b4da2bfde257b8459968f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.1 MB (108078742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e0cbcc8e55ae9c900a68b01e2c98ee3991c08bde4aa8e792425a6d672f48a57`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Tue, 28 Jun 2022 01:15:35 GMT
ENV TOMCAT_VERSION=10.1.0-M16
# Tue, 28 Jun 2022 01:15:36 GMT
ENV TOMCAT_SHA512=ad25f3393324ce42619d6aeeb685186322776b5ba4583453c5e16957fa71cd64fa9f30e379985d57a701be43e9475991312893ee87979e69dd2b51de06510060
# Tue, 28 Jun 2022 01:15:38 GMT
COPY dir:3ba55d98a75af59d0c5a1ef0b80b092ecc4240f7bebe12c54140a0df56b1be7c in /usr/local/tomcat 
# Tue, 28 Jun 2022 01:15:45 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Jun 2022 01:15:48 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Jun 2022 01:15:48 GMT
EXPOSE 8080
# Tue, 28 Jun 2022 01:15:49 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1228d232a5b33bbc8e1fcc7dc0bbab418cd81115638dd1f1117d77c6d45c072d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45c15370f53963bd6aab26c90067604e9ebb12f44e97cff917a9d0d9c6a2b46e`  
		Last Modified: Tue, 28 Jun 2022 01:59:28 GMT  
		Size: 12.5 MB (12537489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:637bd0a655e9e146b9e0012498355e7f6567c5cc64f93f45db2150d4fdeafaec`  
		Last Modified: Tue, 28 Jun 2022 01:59:27 GMT  
