...
```console
$ docker pull tomcat@sha256:cff8284f093345dabc581dc66e7488ce8376c55747aa395495b60d03192ff0e2
```
...
```console
$ docker pull tomcat@sha256:d3ae89e40bd824df80c80e6349d28d09c63db31bdc04c0b820a0fb95040a4946
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.6 MB (109564517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a491868eddcf2c5c5b1507061957d2b37dac16dd21e309ea07d00e9dd488d7f`
-	Default Command: `["catalina.sh","run"]`
...
# Sun, 19 Apr 2026 16:07:50 GMT
ENV TOMCAT_SHA512=8694b94324cf6f62ab032fa2438d7334518dcfcbf7878361b147246c46eb1e558c327f32c05fb4b7705c01fcca92fde392ce320934410f1169ff4ab36a1c7139
# Sun, 19 Apr 2026 16:17:44 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Sun, 19 Apr 2026 16:18:26 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Sun, 19 Apr 2026 16:18:33 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Sun, 19 Apr 2026 16:18:33 GMT
EXPOSE map[8080/tcp:{}]
# Sun, 19 Apr 2026 16:18:33 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c7609f3e31cae3553d57dfffb1510b8b3682f4f6f3e7ee9834606703def5b024`  
		Last Modified: Sun, 19 Apr 2026 16:20:14 GMT  
		Size: 14.5 MB (14488588 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:684deca31131737def92ed91a4a73bd9435b7af4b88e1e46b5f1785f3861978a`  
		Last Modified: Sun, 19 Apr 2026 16:20:12 GMT  
		Size: 227.9 KB (227933 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:2d39f74589ddce49fc48f561a81fa61f613b64550bb2828e356704a5a285d934
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3363770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11e6cc57b9816489b06b95b00d5012000211688de5206ece57ee35da318fe354`

```dockerfile
```

-	Layers:
	-	`sha256:eb31804aae98e0da715dc8b36960fa55016c4bc055e5f063f29706a7679878ec`  
		Last Modified: Sun, 19 Apr 2026 16:20:12 GMT  
		Size: 3.3 MB (3340573 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:483a2fa0741afb31e9a53f18d9c5f08c73f90212d0b33cf16aa05610c5a27a0f`  
		Last Modified: Sun, 19 Apr 2026 16:20:11 GMT  
		Size: 23.2 KB (23197 bytes)  
		MIME: application/vnd.in-toto+json
