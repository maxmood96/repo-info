...
```console
$ docker pull tomcat@sha256:1ee5dd376b295587a29d58a1a5c645dcf08b7bd8021bdbf6ee23e259d0aa937f
```
...
```console
$ docker pull tomcat@sha256:4bb2e563580eb2fc4ddc5cfa7af034a8c4974c02c44376b8c762af3300c8ff05
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.9 MB (108949676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a335004ef72e92ffabd3ff93adc457a5c5e53698345e73dac759185af5df3bbf`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 15 Nov 2025 23:49:04 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Sat, 15 Nov 2025 23:49:43 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Sat, 15 Nov 2025 23:49:51 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Sat, 15 Nov 2025 23:49:51 GMT
EXPOSE map[8080/tcp:{}]
# Sat, 15 Nov 2025 23:49:51 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:148fce1ce46c527c1e2e3cb11ac75264c43999168bfbf01cb28b5af0df08b0d1`  
		Last Modified: Sat, 15 Nov 2025 23:51:41 GMT  
		Size: 14.3 MB (14282117 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5467aa9fa71b08effe370940a7899a995d1157265400fe0860a83f24d50fc2ee`  
		Last Modified: Sat, 15 Nov 2025 23:51:40 GMT  
		Size: 228.2 KB (228180 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 10 Oct 2025 22:54:50 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:09f287e5ef8af577a5fcaf85d04a0cd0ed2a888e2e42f49e3d70dc746fe56d71
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3363987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:981089dceaa10ec24dfa8952f1aa9da50f66f6444279af79a61ff3cbb7a91d04`

```dockerfile
```

-	Layers:
	-	`sha256:4d39d92d94ae26e65ff9d9a2975f0d65e40e04fa17817d331e99ac21099551ca`  
		Last Modified: Sun, 16 Nov 2025 00:28:55 GMT  
		Size: 3.3 MB (3340787 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b90c64c8a8cbdd78098878bd1065d2d8f5cf5f8ee1728d00dc679b6c0bb164cf`  
		Last Modified: Sun, 16 Nov 2025 00:28:56 GMT  
		Size: 23.2 KB (23200 bytes)  
		MIME: application/vnd.in-toto+json
