...
```console
$ docker pull tomcat@sha256:6e075fdf9dca09d5dd6b8ac8c7e20593fd3bba19ced0362046df45978412f51a
```
...
### `tomcat:11.0.15-jre21` - linux; amd64
...
### `tomcat:11.0.15-jre21` - unknown; unknown
...
### `tomcat:11.0.15-jre21` - linux; arm64 variant v8
...
### `tomcat:11.0.15-jre21` - linux; ppc64le
...
### `tomcat:11.0.15-jre21` - linux; s390x
