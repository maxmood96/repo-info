...
### `tomcat:11.0.9-jdk17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.9-jdk17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.9-jdk17-temurin-jammy` - linux; s390x
