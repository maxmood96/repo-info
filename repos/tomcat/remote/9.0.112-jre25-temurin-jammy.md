...
```console
$ docker pull tomcat@sha256:a222a0ab3ad7b8a235fa2e6c393bf951072c8ea57ecca4b4f3a3576f6b0cda73
```
...
### `tomcat:9.0.112-jre25-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.112-jre25-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.112-jre25-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.112-jre25-temurin-jammy` - linux; ppc64le
