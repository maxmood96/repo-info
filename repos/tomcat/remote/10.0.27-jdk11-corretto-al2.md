...
```console
$ docker pull tomcat@sha256:5b137fb00dbcb88111f204c5d2e76457f516e0c7d058ff0b7c7a433f520dbfef
```
...
### `tomcat:10.0.27-jdk11-corretto-al2` - linux; amd64
...
### `tomcat:10.0.27-jdk11-corretto-al2` - linux; arm64 variant v8
