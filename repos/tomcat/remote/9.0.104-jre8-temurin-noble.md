...
```console
$ docker pull tomcat@sha256:23663d61870f61476e64093d19a16a6d2a27ec879db64aca224489f5dad1d6aa
```
...
### `tomcat:9.0.104-jre8-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.104-jre8-temurin-noble` - linux; ppc64le
