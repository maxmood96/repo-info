...
```console
$ docker pull tomcat@sha256:d3bf7050d73e12fc81dac58a426e33353d25ff62315f916846d088f5e56bf9f3
```
...
```console
$ docker pull tomcat@sha256:886de11afdbab3155cd9e01bea16ac9e8a1e1fd6c16ceb80924f5f5edc6011de
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.4 MB (242385088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c62c727845ffe974e266a9f5127f5f3633d175ad3261e96f0d9d79ae0c480e2e`
...
# Wed, 05 Aug 2020 19:24:29 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Aug 2020 19:24:29 GMT
EXPOSE 8080
# Wed, 05 Aug 2020 19:24:30 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:4aa5acb4765bc36031495e43b94457709bb151f5bbf94957dd7892434ff93c9a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47587f59e7e3fbdc22a6c923f5b41c8f12027e0059b222c990774c5a52406d67`  
		Last Modified: Wed, 05 Aug 2020 19:34:53 GMT  
		Size: 12.2 MB (12224454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4a165766960d01e4fdd3065e49eac585c19ca7213c7cdc4d3bd1e19bc57fc65`  
		Last Modified: Wed, 05 Aug 2020 19:34:51 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
