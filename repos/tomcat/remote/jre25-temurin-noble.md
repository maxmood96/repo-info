...
```console
$ docker pull tomcat@sha256:6d7ca3b2e4bff0e79c45b919734af889a2d5709bd532c85da519bf421c624b56
```
...
-	Layers:
	...
	-	`sha256:d54eb3c6afba8367fbb7f89e0e87ee779eb047c3518213bb5802e21f3a5882a1`  
		Last Modified: Fri, 16 Jan 2026 04:52:58 GMT  
...
```console
$ docker pull tomcat@sha256:455d4e0bfdee33b1d1ee175fa48a4c01a796a897b441e51a537f1a626a8c6ae1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.6 MB (118648163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7a415487a4e4e9e9061ceb8459f89de60d8bc11e56e171b498580a71fdfc0d7`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 22 Jan 2026 12:28:00 GMT
ENV TOMCAT_SHA512=876beac5138cf8277f30fe8f6b519fcdd0bfe3d8ca3d20f734cab0f83e9b2e83de9395ee71052c2604f29f700d9646eddaeec72da5807a2d7edea3936096c742
# Thu, 22 Jan 2026 12:28:03 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Thu, 22 Jan 2026 12:28:41 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 22 Jan 2026 12:28:49 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Thu, 22 Jan 2026 12:28:49 GMT
EXPOSE map[8080/tcp:{}]
# Thu, 22 Jan 2026 12:28:49 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:32fb227f0c703f0d24e156cac664c74d44097736113229ec865bb28bea6ce54f`  
		Last Modified: Thu, 22 Jan 2026 12:30:34 GMT  
		Size: 14.5 MB (14468311 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7936f11b068d6e2d9fbce17754de41ebc4061bbb28bcc464612c32862a5f922e`  
		Last Modified: Thu, 22 Jan 2026 12:30:31 GMT  
		Size: 210.1 KB (210061 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:dd224f2dd7ff5e84a105db20cff9e410f03c34a9d41927461572e198d9d91c4b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.1 MB (3144771 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83c0d7594e814f36d934c2775599da81a77ea518b950c25351b5029113d54f02`

```dockerfile
```

-	Layers:
	-	`sha256:5ee04ba7cf673e51b37712839a7a63ea3c9deac21e75dfeef94ac8e96aed098b`  
		Last Modified: Thu, 22 Jan 2026 12:30:32 GMT  
		Size: 3.1 MB (3120635 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f57679d2e85ef99660db248569f8f3983d127fd3b067d1bdbef6dcd01d7d659a`  
		Last Modified: Thu, 22 Jan 2026 12:30:31 GMT  
