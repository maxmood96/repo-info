...
```console
$ docker pull tomcat@sha256:44a4f767027bae62364a894c31b0e8e86f08ecdca3be498f14c58b01df459a03
```
...
### `tomcat:8.5.81-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.81-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.81-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.81-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:8.5.81-jre17-temurin-jammy` - linux; s390x
