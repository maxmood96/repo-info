...
```console
$ docker pull tomcat@sha256:03a087b9e139c7c6ebd07e95e5ebadfae1004af62d95ee967e3b73e37f46d8a5
```
...
```console
$ docker pull tomcat@sha256:f1d9e3a3f7ecf124efaa3a349cef169a279ca9a3a2568874d77842e034cf6b7c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.0 MB (228047127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:573c2b002c3c3611c05e2380509b39642b8ebce7c9815c9daf3b5f5ca31434a3`
...
# Sat, 27 Mar 2021 12:08:35 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 27 Mar 2021 12:08:35 GMT
EXPOSE 8080
# Sat, 27 Mar 2021 12:08:36 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2ba19b3fb6f9d438c9e10f25d2ec6bd1ba84a400a826c6d2d99f11b281ea7895`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2641013c308577e1b8435516a13901423ff6921ee8f4c37a83ece69189e8e5b`  
		Last Modified: Sat, 27 Mar 2021 12:23:39 GMT  
		Size: 12.5 MB (12523823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cd6ec2028fe6802cb1cdad7bb156829fa4ab00b55d7b2f669f4ba0289612913`  
		Last Modified: Sat, 27 Mar 2021 12:23:36 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
