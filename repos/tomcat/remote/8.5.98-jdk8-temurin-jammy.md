...
### `tomcat:8.5.98-jdk8-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.98-jdk8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.98-jdk8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.98-jdk8-temurin-jammy` - linux; ppc64le
