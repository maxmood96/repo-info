...
### `tomcat:9.0.72-jdk11-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.72-jdk11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.72-jdk11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.72-jdk11-temurin-jammy` - linux; ppc64le
...
### `tomcat:9.0.72-jdk11-temurin-jammy` - linux; s390x
