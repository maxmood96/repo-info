...
```console
$ docker pull tomcat@sha256:1f5d96e05a7a377d0a59c90633c8fda2f19446cc5b7f28f87c71c708e38ff21e
```
...
### `tomcat:10.1.45-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.45-jre21-temurin-jammy` - linux; s390x
