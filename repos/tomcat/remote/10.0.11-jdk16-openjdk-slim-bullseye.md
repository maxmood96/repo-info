## `tomcat:10.0.11-jdk16-openjdk-slim-bullseye`

```console
$ docker pull tomcat@sha256:97471de45792378dba5caad54b3728178207843d338042f79a082c09216e5b99
```
...
### `tomcat:10.0.11-jdk16-openjdk-slim-bullseye` - linux; amd64
