...
```console
$ docker pull tomcat@sha256:311f3cce87c45bcf35b120861fe955807ee66630db5bcb6d7af5b43e0feb751a
```
...
### `tomcat:11.0.2-jre21-temurin` - linux; amd64
...
### `tomcat:11.0.2-jre21-temurin` - unknown; unknown
...
### `tomcat:11.0.2-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.2-jre21-temurin` - linux; ppc64le
...
### `tomcat:11.0.2-jre21-temurin` - linux; s390x
