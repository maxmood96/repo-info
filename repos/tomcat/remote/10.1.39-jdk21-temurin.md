...
### `tomcat:10.1.39-jdk21-temurin` - linux; amd64
...
### `tomcat:10.1.39-jdk21-temurin` - unknown; unknown
...
### `tomcat:10.1.39-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.39-jdk21-temurin` - linux; ppc64le
...
### `tomcat:10.1.39-jdk21-temurin` - linux; riscv64
...
### `tomcat:10.1.39-jdk21-temurin` - linux; s390x
