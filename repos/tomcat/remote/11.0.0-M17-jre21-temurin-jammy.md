...
```console
$ docker pull tomcat@sha256:7847e019e6e53c1536989b74b32b97d553956b9f0d1f1e94d902c9e28e652853
```
...
### `tomcat:11.0.0-M17-jre21-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.0-M17-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.0-M17-jre21-temurin-jammy` - linux; ppc64le
