...
```console
$ docker pull tomcat@sha256:278f7e668847285411867ab0845ea1da796e8024e0e33d4b2f0513c11eb5317c
```
...
```console
$ docker pull tomcat@sha256:dd9bcc441f67eb65a3f5df8514d22b6fa108c7eafd84bfd8a65c0a943b603a70
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.4 MB (337373240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:624087f4961efe1a3abf90f207dbda5d0ed808b01faa1244503ef3d4d9003e02`
...
# Wed, 29 Sep 2021 11:10:52 GMT
ENV TOMCAT_MAJOR=10
# Wed, 29 Sep 2021 11:20:54 GMT
ENV TOMCAT_VERSION=10.0.11
# Wed, 29 Sep 2021 11:20:55 GMT
...
# Wed, 29 Sep 2021 11:21:21 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 29 Sep 2021 11:21:21 GMT
EXPOSE 8080
# Wed, 29 Sep 2021 11:21:22 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0a6482d1c5176226ccb17f9de967e12bea0106e421aa1f305309d82f0075a352`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:729b13a92e34e398d9288fa58c0b5efcb5ba9852a6e325dcd30253ab1a45501b`  
		Last Modified: Wed, 29 Sep 2021 12:27:21 GMT  
		Size: 12.9 MB (12864374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a75dbae08d69871c307de42b340b2efae2a86a0df401e9b210fb52427ae73b2`  
		Last Modified: Wed, 29 Sep 2021 12:27:20 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
