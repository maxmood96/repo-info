...
```console
$ docker pull tomcat@sha256:9c18602175a22a4258458a830b942eb416182215cb2e8b8de21254930684acfc
```
...
### `tomcat:10.1.54-jre25` - linux; amd64
...
### `tomcat:10.1.54-jre25` - unknown; unknown
...
### `tomcat:10.1.54-jre25` - linux; arm64 variant v8
...
### `tomcat:10.1.54-jre25` - linux; ppc64le
...
### `tomcat:10.1.54-jre25` - linux; s390x
