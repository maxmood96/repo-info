...
```console
$ docker pull tomcat@sha256:8ac941521a6fae6552c3628b6550dd4b3fd1c19d04c3619700369427eb72a613
```
...
### `tomcat:9.0.58-jdk16-temurin` - linux; amd64
...
### `tomcat:9.0.58-jdk16-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.58-jdk16-temurin` - linux; ppc64le
...
### `tomcat:9.0.58-jdk16-temurin` - linux; s390x
