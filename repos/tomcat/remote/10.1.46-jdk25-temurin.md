...
### `tomcat:10.1.46-jdk25-temurin` - linux; amd64
...
### `tomcat:10.1.46-jdk25-temurin` - unknown; unknown
...
### `tomcat:10.1.46-jdk25-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.46-jdk25-temurin` - linux; ppc64le
...
### `tomcat:10.1.46-jdk25-temurin` - linux; riscv64
...
### `tomcat:10.1.46-jdk25-temurin` - linux; s390x
