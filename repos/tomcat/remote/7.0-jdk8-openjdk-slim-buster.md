...
```console
$ docker pull tomcat@sha256:db8ce7dce230b0b8ed52339335bb3f8eb90844cc73802cb461abfe5d592113ad
```
...
```console
$ docker pull tomcat@sha256:d25a499ea0a66ce3c0c39485b0b5a5bfb5b7a605f325e33c56f932cdac2ac0c5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147174599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3853d331d82ba9f46a7dc603a05aa2ef5eb7e7deaef57f7c5709ee8120a10c7`
...
# Tue, 03 Nov 2020 02:58:33 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 03 Nov 2020 02:58:34 GMT
EXPOSE 8080
# Tue, 03 Nov 2020 02:58:34 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0e7aabf33e6ebb195d22536cc9e3c4e7b455a1ecb4a1c1e014fe20ae8cbb2feb`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:698ceb4a0e227e055b2629d309c15d0d59dd1a5d95ea73734d8cea891588a422`  
		Last Modified: Tue, 03 Nov 2020 03:15:17 GMT  
		Size: 10.7 MB (10678896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d1006c56e7c14cce9155bf058e94ab9c0ecd3ef5b9c9c84f96efe38e7863f16`  
		Last Modified: Tue, 03 Nov 2020 03:15:16 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
