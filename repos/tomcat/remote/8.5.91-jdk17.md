...
```console
$ docker pull tomcat@sha256:6341511f9e6eb7e79a4adfee3c324094a4ac0e4e00c0c9bdab114a2725845259
```
...
### `tomcat:8.5.91-jdk17` - linux; amd64
...
### `tomcat:8.5.91-jdk17` - linux; arm variant v7
...
### `tomcat:8.5.91-jdk17` - linux; arm64 variant v8
...
### `tomcat:8.5.91-jdk17` - linux; s390x
