...
```console
$ docker pull tomcat@sha256:680d0b5ffa3951ed948604afaa4dfef437f9f2287197605129450b68fbbdb143
```
...
### `tomcat:8.5.98-jdk17-temurin-focal` - linux; amd64
...
### `tomcat:8.5.98-jdk17-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:8.5.98-jdk17-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.98-jdk17-temurin-focal` - linux; s390x
