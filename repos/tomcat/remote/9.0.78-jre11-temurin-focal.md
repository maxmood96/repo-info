...
```console
$ docker pull tomcat@sha256:ff1ae6966197315279410507936a14166bda98265e9f1f122145eb883c068c1b
```
...
```console
$ docker pull tomcat@sha256:94f4fcbda90645fc8766708a8be70bfa5837fb257a01ffbf9142cd0dc7a02fbe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.4 MB (97423282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b19f0428fc1c2dcb03ce630f2422b4fc1480c7cf2b6c4aaebcbfebc12a8cb00`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 05:37:22 GMT
ENV TOMCAT_MAJOR=9
# Tue, 11 Jul 2023 05:12:53 GMT
ENV TOMCAT_VERSION=9.0.78
# Tue, 11 Jul 2023 05:12:53 GMT
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Tue, 11 Jul 2023 05:12:54 GMT
COPY dir:6caf8735d68025d6a08683a07c7ccaa307105d7201c3ab6c72be9c5ee75707cf in /usr/local/tomcat 
# Tue, 11 Jul 2023 05:12:58 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 05:13:00 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Jul 2023 05:13:00 GMT
EXPOSE 8080
# Tue, 11 Jul 2023 05:13:00 GMT
...
-	Layers:
	...
	-	`sha256:870a5064b1e028be82d7ff47383985d01f753f2a637572f1c752ba24bf4aad4b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f81d06f8193d57948dd7f8456c4baa09272cd5e925acd80cbbc5ccf48d37f21e`  
		Last Modified: Tue, 11 Jul 2023 05:25:31 GMT  
		Size: 12.3 MB (12292797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40d28b2a0e60ee4734a00e0e371a32dc93952562fef420e6f394f2ba744c8e49`  
		Last Modified: Tue, 11 Jul 2023 05:25:30 GMT  
		Size: 424.0 KB (424024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66906abe5eadb9822c8dd4f212215a59b8ee4b75a998d7f1c9145a9db6ec9ce2`  
		Last Modified: Tue, 11 Jul 2023 05:25:30 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:42efe820b3e93c72488eb1a31934e78b73b38e56d43cd1b9157f0578aeb08369
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.5 MB (96461995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5efdc11f0ec537fe34e1a12041a48875c65bf2ac0404709f04a23df01329befa`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 11:08:47 GMT
ENV TOMCAT_MAJOR=9
# Tue, 11 Jul 2023 08:30:15 GMT
ENV TOMCAT_VERSION=9.0.78
# Tue, 11 Jul 2023 08:30:15 GMT
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Tue, 11 Jul 2023 08:30:15 GMT
COPY dir:8a111f375c7bcf041b01da69c8eeae1a70044801eb614488072d4e5bc0e45cd9 in /usr/local/tomcat 
# Tue, 11 Jul 2023 08:30:20 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 08:30:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Jul 2023 08:30:22 GMT
EXPOSE 8080
# Tue, 11 Jul 2023 08:30:22 GMT
...
-	Layers:
	...
	-	`sha256:2755e877755a156b956b29263e1f808db07f6ac4809c6010cd39dbdee378620b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b20f70735f2e31fb677e02b5c21b561e58cf21e9d58b49bbf36cb750dcf8e8e5`  
		Last Modified: Tue, 11 Jul 2023 08:37:59 GMT  
		Size: 12.4 MB (12353559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c03d54727468869d370ef7277d6db07c3d757bdead087557f67e6d4aa924a696`  
		Last Modified: Tue, 11 Jul 2023 08:37:58 GMT  
		Size: 450.5 KB (450452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80c33270dddd62b6cecd293762db7657c21244de4158560f5975dbb0b99ee77f`  
		Last Modified: Tue, 11 Jul 2023 08:37:58 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
