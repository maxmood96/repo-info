...
```console
$ docker pull tomcat@sha256:b229204159ce542b89367f68e64a3aa1916a5629fd0073944184054454f1c921
```
...
### `tomcat:11.0.0-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.0-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.0-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.0-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.0-jre11-temurin-jammy` - linux; s390x
