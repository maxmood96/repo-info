...
```console
$ docker pull tomcat@sha256:92c2e2005c5b4b945c6617e695cd03e36364cf9c40b6f6ebed7ffa41553586a8
```
...
```console
$ docker pull tomcat@sha256:7a82d5fa1b1d8e98915dae4034fadf13c8f75a5072d59392eab687b9e5c77e32
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.4 MB (121361726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc7ddc207dc3f53cdb6c62ac1c0c87944b04c0d0cf20a2cc25536e41040b4f5f`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=11
# Wed, 21 Feb 2024 02:46:55 GMT
ENV TOMCAT_VERSION=11.0.0-M17
# Wed, 21 Feb 2024 02:46:56 GMT
ENV TOMCAT_SHA512=22e6bef88f3591ca1ef79a0f7a1a22ad327084be6dc887b21d35adeed71755c60b810a3d92584b1d254029c80acc1aa5d63c02fa0c7db76986479f7f08e466c5
# Wed, 21 Feb 2024 02:46:56 GMT
COPY dir:4386b1c4f5c4ba3cf09d9f0a5b709154bb8b1cd1ef2f9251870d020d188f0942 in /usr/local/tomcat 
# Wed, 21 Feb 2024 02:47:03 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 02:47:06 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 02:47:06 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 02:47:06 GMT
ENTRYPOINT []
# Wed, 21 Feb 2024 02:47:07 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a862fd03d7be4030d03e715277cb4eb74dc06586c207a4c383b9e47981f47867`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e105099beb6806c4cd0593c04a31e18ddbe0a3bcc2a22752e939b000fa5b28c`  
		Last Modified: Wed, 21 Feb 2024 03:18:58 GMT  
		Size: 12.7 MB (12715345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e8bcc5b15de3bcbbfe32529f56379479e49a2891f08802b94dfbe5ede995bb8`  
		Last Modified: Wed, 21 Feb 2024 03:18:58 GMT  
		Size: 489.8 KB (489752 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b7cd2ebabc41d66d1c180f169facc546d4cb43837a70d738e108afff039275c`  
...
```console
$ docker pull tomcat@sha256:a2ae5fec590815ea272557ae0bcffe1decb2a8cb0642a3d5388e912f60b682d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.9 MB (108909398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:447d88c497c8f5bc1d1324fd2a4cafb9d4848ec3654a7a31b689ff539423d471`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 16 Feb 2024 13:32:27 GMT
ENV TOMCAT_MAJOR=11
# Wed, 21 Feb 2024 03:54:11 GMT
ENV TOMCAT_VERSION=11.0.0-M17
# Wed, 21 Feb 2024 03:54:11 GMT
ENV TOMCAT_SHA512=22e6bef88f3591ca1ef79a0f7a1a22ad327084be6dc887b21d35adeed71755c60b810a3d92584b1d254029c80acc1aa5d63c02fa0c7db76986479f7f08e466c5
# Wed, 21 Feb 2024 03:54:11 GMT
COPY dir:7108c32b6b6c9339b1c58425d2a180046b8551e69d059bae1f40dfd1ea2795d8 in /usr/local/tomcat 
# Wed, 21 Feb 2024 03:54:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 03:54:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 03:54:17 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 03:54:17 GMT
ENTRYPOINT []
# Wed, 21 Feb 2024 03:54:17 GMT
...
-	Layers:
	...
	-	`sha256:00bdcef3ab9f61e1a562a485a6d5ba58b0f877e014c54e06ec03d3c29438e75a`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7248ef8e2e0aa5edc67b30cf709487d73cdde268136fbf7e3b1ff481d35e07cc`  
		Last Modified: Wed, 21 Feb 2024 04:34:57 GMT  
		Size: 12.7 MB (12703599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0b8b5892f459fdadd852136da7af6cd2e19c060702a2cb6114e1737fb0e7dad`  
		Last Modified: Wed, 21 Feb 2024 04:34:56 GMT  
		Size: 460.0 KB (459973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:013bdd1ca2f7197c40f51f2ba013bbe83538c5232e47defd9ac905e0c3288200`  
		Last Modified: Wed, 21 Feb 2024 04:34:56 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
