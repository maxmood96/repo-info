...
```console
$ docker pull tomcat@sha256:f0caac57ad4b39d8fcb28f18d624bf6c7ad474496eb12887facdf19178703664
```
...
```console
$ docker pull tomcat@sha256:4426234dc304054c2a1ad104648351f3d8d747c8affb4e46c03db75b6cf61fc5
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.2 MB (116231721 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2c1b5dfaaa42d43be31139a594eb7257a50ff3adbc3d0f27ca6512dbab2a992`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 07:38:54 GMT
ENV TOMCAT_MAJOR=11
# Tue, 18 Jun 2024 22:21:13 GMT
ENV TOMCAT_VERSION=11.0.0-M21
# Tue, 18 Jun 2024 22:21:13 GMT
ENV TOMCAT_SHA512=034444deb0c238847b2161c5b05648ca7d1a7a79bf4848a59aeb40b87a1c28eb848b1a659db8684914bf79db706d73b69f42ce59c379ba6cde3e466a533abb0e
# Tue, 18 Jun 2024 22:21:14 GMT
COPY dir:3222fbfa6bac5a5fdabbce4601626592f9703425cb6a40543b3b59ccae4e2bc6 in /usr/local/tomcat 
# Tue, 18 Jun 2024 22:21:20 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 18 Jun 2024 22:21:23 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 18 Jun 2024 22:21:23 GMT
EXPOSE 8080
# Tue, 18 Jun 2024 22:21:23 GMT
ENTRYPOINT []
# Tue, 18 Jun 2024 22:21:24 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:23a4254d4f52ed527bf3056d00504ee9f5a3fe28a78e49e6d4dab9641ed0d92c`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d526b4fdef2b1f673e27011ef007c6239420fd25a7f656ff0575b0cb0ece5c39`  
		Last Modified: Tue, 18 Jun 2024 22:23:55 GMT  
		Size: 12.8 MB (12849606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5adb847384b9a0ac2f574fbd1e98606282a20e751f268ecf0d1f1553aed0d139`  
		Last Modified: Tue, 18 Jun 2024 22:23:54 GMT  
		Size: 487.5 KB (487534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ec10c2f34182b9a56d43d6f5c60f74497f241696c65bef126f86425b1bffca0`  
		Last Modified: Tue, 18 Jun 2024 22:23:54 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:cadecfd04af88e2cd797d313e41a34a503f53bc6a769bcdea5f52db9d12525b9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.6 MB (104550443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d980609fbbc6688ee7578898f162fc44841bafed0e747e4ede498dce2be062a`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jun 2024 04:14:36 GMT
ENV TOMCAT_MAJOR=11
# Tue, 18 Jun 2024 23:11:37 GMT
ENV TOMCAT_VERSION=11.0.0-M21
# Tue, 18 Jun 2024 23:11:37 GMT
ENV TOMCAT_SHA512=034444deb0c238847b2161c5b05648ca7d1a7a79bf4848a59aeb40b87a1c28eb848b1a659db8684914bf79db706d73b69f42ce59c379ba6cde3e466a533abb0e
# Tue, 18 Jun 2024 23:11:38 GMT
COPY dir:693d6d6bbfa5dce08ad5f6d344f1cfb0c5e855d630c8ca66183083790e083810 in /usr/local/tomcat 
# Tue, 18 Jun 2024 23:11:41 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 18 Jun 2024 23:11:42 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 18 Jun 2024 23:11:42 GMT
EXPOSE 8080
# Tue, 18 Jun 2024 23:11:42 GMT
ENTRYPOINT []
# Tue, 18 Jun 2024 23:11:43 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:197c111438ccfb4164b4349621815f87c92ed2c759ac0b93b37464cc9488a6c7`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a7d53f1a3bfaee890b0cb32fde270b6422aec27de739008d5d68843294387c7`  
		Last Modified: Tue, 18 Jun 2024 23:15:29 GMT  
		Size: 12.8 MB (12837396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f932c957a90719b45f6c6b3b80ee572abdefaad9acd610509b3fb05c13b53c0`  
		Last Modified: Tue, 18 Jun 2024 23:15:28 GMT  
		Size: 457.9 KB (457855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da85a623c9c1f4be54ea4628b2788345d6252b928d8b1c78a2584bd597b87490`  
		Last Modified: Tue, 18 Jun 2024 23:15:28 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
