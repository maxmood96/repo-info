...
```console
$ docker pull tomcat@sha256:40dc7f7c4c820a29e9fb20732fca5c6e224b4520564628fc66d0ca010ed9f932
```
...
### `tomcat:9.0.64-jre8-temurin` - linux; amd64
...
### `tomcat:9.0.64-jre8-temurin` - linux; arm variant v7
...
### `tomcat:9.0.64-jre8-temurin` - linux; arm64 variant v8
