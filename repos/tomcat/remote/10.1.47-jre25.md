...
```console
$ docker pull tomcat@sha256:66debe7104e8568eaddae48354947aeaf4c54b16f6549d1860fee185baf39e96
```
...
### `tomcat:10.1.47-jre25` - linux; amd64
...
### `tomcat:10.1.47-jre25` - unknown; unknown
...
### `tomcat:10.1.47-jre25` - linux; arm64 variant v8
...
### `tomcat:10.1.47-jre25` - linux; ppc64le
...
### `tomcat:10.1.47-jre25` - linux; s390x
