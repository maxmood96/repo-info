...
```console
$ docker pull tomcat@sha256:431113729c946ebee31b73a98cff80bf91aa84656111a33a2f8b41ac1e8c6077
```
...
### `tomcat:10.1.35-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.35-jdk21-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.35-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.35-jdk21-temurin-jammy` - linux; s390x
