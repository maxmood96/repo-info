...
```console
$ docker pull tomcat@sha256:261652ca77f759c75dd6c805cec103acbf431e688de5737447b449798788e919
```
...
### `tomcat:9.0.59-jdk17-temurin` - linux; amd64
...
### `tomcat:9.0.59-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:9.0.59-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.59-jdk17-temurin` - linux; ppc64le
...
### `tomcat:9.0.59-jdk17-temurin` - linux; s390x
