...
```console
$ docker pull tomcat@sha256:6e1122a4a42d6086a9923a1accf4f2fb4c93ad2e3bf63f080cc6ec004e43aaac
```
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; amd64
...
### `tomcat:10.1.54-jdk17-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; arm variant v7
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; riscv64
...
### `tomcat:10.1.54-jdk17-temurin-noble` - linux; s390x
