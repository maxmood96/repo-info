...
```console
$ docker pull tomcat@sha256:2e6b7b2ac034d10ccc4ff0affd04cca9bc5fa2e4ad26ede20e6de02834714e27
```
...
```console
$ docker pull tomcat@sha256:722ac3e90f1c3638378ddc0c4b992906593b43120d4b51167f111c569f4f00b7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100511608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ad10211eee2571d5e5f3b79d438f147b09052ca7e6b35c39573581bfaf66d63`
...
# Fri, 01 Oct 2021 09:07:38 GMT
COPY dir:f59a0a97ab266f3989417cd6450cbb545dded5586c2465c4e5082a38b761960f in /usr/local/tomcat 
# Fri, 01 Oct 2021 09:07:42 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 01 Oct 2021 09:07:44 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 01 Oct 2021 09:07:44 GMT
EXPOSE 8080
# Fri, 01 Oct 2021 09:07:45 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:bb12bcafdda20caf72322b09868c6a276f692d8ec9e182e04ddf34868f2f5fe1`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5264ee89fe411726a655d55aaa012e5cb2c873fdf26c1050f508d7e2466675b`  
		Last Modified: Fri, 01 Oct 2021 09:33:08 GMT  
		Size: 12.2 MB (12243500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08fc84ce38845229630f98a57398d34b605a6cdbbdf257d0d67356c98e699c6c`  
		Last Modified: Fri, 01 Oct 2021 09:33:07 GMT  
		Size: 445.7 KB (445677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aefc8cdb2c4c9677c9f62dd0923dfed87c4c1ce135b698e5bc03d162edba174`  
		Last Modified: Fri, 01 Oct 2021 09:33:07 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:c96c30d6ac7ab95d87545d70224fa062c6d477428b56d5640b56e5a3b1d18994
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.4 MB (93411576 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c32932acf30dc2decd0136c7df0e6f811986e6601a6d83764d583f683667a1d1`
-	Default Command: `["catalina.sh","run"]`
...
# Sun, 03 Oct 2021 03:38:40 GMT
ENV TOMCAT_MAJOR=9
# Sun, 03 Oct 2021 03:38:41 GMT
ENV TOMCAT_VERSION=9.0.53
# Sun, 03 Oct 2021 03:38:41 GMT
ENV TOMCAT_SHA512=ee731b2d0c3ab7e14fa924dcb8d598707cedf714c9ce1f2c2d907a1fd51e26f7eec1343c3dc39e240ff64dac2e0213f154d23e5f94a430f429165b5df51f786f
# Sun, 03 Oct 2021 03:38:44 GMT
COPY dir:74fd896765aeec2de0830affac85adafc3208f0a7ef2284e89a6b16d7bca98c5 in /usr/local/tomcat 
# Sun, 03 Oct 2021 03:38:53 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sun, 03 Oct 2021 03:38:57 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sun, 03 Oct 2021 03:38:57 GMT
EXPOSE 8080
# Sun, 03 Oct 2021 03:38:58 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1d2e3c5bbfe03c4b8f4b0fb938dfa563187e0d8755684ff6dc14e4ba383482c7`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:967381b8666a2fab20cb851b1de515461a942a5c880a58c80aa4fb1cc2649427`  
		Last Modified: Sun, 03 Oct 2021 03:53:42 GMT  
		Size: 12.2 MB (12192250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fa6d636a6254cd789898146e31138b763796e003c70332e8bc6158140897594`  
		Last Modified: Sun, 03 Oct 2021 03:53:37 GMT  
		Size: 422.3 KB (422265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c602074f73f1bf06626362a1117c069edd5ef0d1b308dfb9471630b11f1703b1`  
		Last Modified: Sun, 03 Oct 2021 03:53:37 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:e7f6b2cd063d93b0e501be0e91b2644fca0b1db4aac04472630ad2e84e3b5309
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.9 MB (101875222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8f3ad1a0a4dc9d3377c9cec10e3e145efc3794d8010d2c63a0e1fd455d88095`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Wed, 06 Oct 2021 15:56:21 GMT
ENV TOMCAT_VERSION=9.0.53
# Wed, 06 Oct 2021 15:56:28 GMT
ENV TOMCAT_SHA512=ee731b2d0c3ab7e14fa924dcb8d598707cedf714c9ce1f2c2d907a1fd51e26f7eec1343c3dc39e240ff64dac2e0213f154d23e5f94a430f429165b5df51f786f
# Wed, 06 Oct 2021 15:56:36 GMT
COPY dir:7778e77c552eb481a8955570b9aa2cca5fa42b84582939f71d3a6f2f30559b57 in /usr/local/tomcat 
# Wed, 06 Oct 2021 15:57:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 06 Oct 2021 15:57:32 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 06 Oct 2021 15:57:37 GMT
EXPOSE 8080
# Wed, 06 Oct 2021 15:57:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:65fa2bf0038fcb16cc68d2041f78f80bbb6ec8ad308e553f0eaf0b304a2ac713`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c00192522176d747233293a5d3d85a4dbf706b111da3522cb7932ce9e7dfff5`  
		Last Modified: Wed, 06 Oct 2021 16:54:26 GMT  
		Size: 12.3 MB (12281184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:573b87409eeea3e9b856b5241aef69a38b779a6edb45bc6060eae96dced7b2e5`  
		Last Modified: Wed, 06 Oct 2021 16:54:25 GMT  
		Size: 471.5 KB (471490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dce387cc49f776d0f4b6d40f83222ff1eb4cfcfc14ec4758b782655895e3409`  
		Last Modified: Wed, 06 Oct 2021 16:54:24 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
