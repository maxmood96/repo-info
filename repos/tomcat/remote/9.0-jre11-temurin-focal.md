...
```console
$ docker pull tomcat@sha256:18a1b5718e0f14fd340b9e3b5cd8da74d82e460377917cc724b6937694efc527
```
...
```console
$ docker pull tomcat@sha256:9d65e8c8338115b3c6c52dc3ebb1a724a81c4eea25da772f0b602b48fecabebd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.4 MB (97427825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:902ca6d0951ec1f92240eed9ec3c81c4580a45ab0a9b6fbef53f6bb327de86ed`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 02 May 2024 03:25:22 GMT
ENV TOMCAT_MAJOR=9
# Tue, 07 May 2024 23:08:14 GMT
ENV TOMCAT_VERSION=9.0.89
# Tue, 07 May 2024 23:08:14 GMT
ENV TOMCAT_SHA512=aaa2851bdc7a2476b6793e95174965c1c861531f161d8a138e87f8532b1af4d4b3d92dd1ae890614a692e5f13fb2e6946a1ada888f21e9d7db1964616b4181f0
# Tue, 07 May 2024 23:08:15 GMT
COPY dir:438f27eb8e9f71b32f0e9ba2c9ae382b7876d879c0967099020c7b3921a9ff45 in /usr/local/tomcat 
# Tue, 07 May 2024 23:08:19 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 07 May 2024 23:08:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 07 May 2024 23:08:22 GMT
EXPOSE 8080
# Tue, 07 May 2024 23:08:22 GMT
ENTRYPOINT []
# Tue, 07 May 2024 23:08:23 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:6ba46ba9fe1b381c7a887a7d8d604e60cc7b51c627bc6d60dbc0174f08dd4606`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:185eee1e48d90639a7137321367c84dfde39688ec4b3b4c35824fbdc463b4417`  
		Last Modified: Tue, 07 May 2024 23:13:36 GMT  
		Size: 12.5 MB (12514947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02a5edd59f84252d0ab7ad8f4f81f6797bf77c0143ecc5d9025969bb04b73b7a`  
		Last Modified: Tue, 07 May 2024 23:13:35 GMT  
		Size: 451.6 KB (451621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63d97034b4fee2a6769bd1dfce79992331ab4a2d0a5f8f6477f3dc78dd7b4aea`  
		Last Modified: Tue, 07 May 2024 23:13:35 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
