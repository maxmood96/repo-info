...
```console
$ docker pull tomcat@sha256:0e1216ff44c49aaee9076e93c226e8a9beb81c82673b6e0e338e443b0ec3a066
```
...
```console
$ docker pull tomcat@sha256:bd038391a435b7f5778f38237312a5948437040e1247aef9e61bae73032275b3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.7 MB (100731278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b549a960c901e860da0744b5adab640f252f116d6cbed2d42c9def79165c9c80`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 12 Aug 2022 21:32:46 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Fri, 12 Aug 2022 21:32:47 GMT
ENV TOMCAT_MAJOR=9
# Fri, 12 Aug 2022 21:32:48 GMT
ENV TOMCAT_VERSION=9.0.65
# Fri, 12 Aug 2022 21:32:49 GMT
ENV TOMCAT_SHA512=2ae846848b8436856be11cfa18d9c62caa06ca7d3134012b2e10cbf6078753c4af20cc5d37f7dc75f1779f5c59d7c033850b8626534c3ce7e389641a67963cf6
# Fri, 12 Aug 2022 21:32:51 GMT
COPY dir:e2449a183117d3f0c0be7a3371d1d7160471054a8ee912160f9828d4d83f3abf in /usr/local/tomcat 
# Fri, 12 Aug 2022 21:32:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Aug 2022 21:32:59 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 12 Aug 2022 21:33:00 GMT
EXPOSE 8080
# Fri, 12 Aug 2022 21:33:01 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:75b28eadd6940b2a7bbf488bd577ef8cc4aa4309a6c4d9048c11da4f4f45b46e`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3905fc350776bd8904c1e08d6168f5142dafc5dc6bfa582f97f036607a2697b5`  
		Last Modified: Fri, 12 Aug 2022 22:16:45 GMT  
		Size: 12.3 MB (12266597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc7dd6617e719325f9315bfe6cff424ee70c1b1a2e32b624b6573d885d358674`  
		Last Modified: Fri, 12 Aug 2022 22:16:43 GMT  
		Size: 211.6 KB (211606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:ae04f6c715756f299ade095a5b83eecb2005ae428c80489baefb644ab29bb320
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.3 MB (96311658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eab9fa94d0901b821e0e2ba76daf55f5c8dda87165a49a79079d095dfe0213ed`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 24 Aug 2022 20:58:38 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Wed, 24 Aug 2022 21:02:33 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 24 Aug 2022 21:02:34 GMT
ENV TOMCAT_MAJOR=9
# Wed, 24 Aug 2022 21:02:34 GMT
ENV TOMCAT_VERSION=9.0.65
# Wed, 24 Aug 2022 21:02:34 GMT
ENV TOMCAT_SHA512=2ae846848b8436856be11cfa18d9c62caa06ca7d3134012b2e10cbf6078753c4af20cc5d37f7dc75f1779f5c59d7c033850b8626534c3ce7e389641a67963cf6
# Wed, 24 Aug 2022 21:02:35 GMT
COPY dir:fd1b4385c1ed75e27852e61808e8feca613f1142cc6a5e19a6c62d5d6416e50a in /usr/local/tomcat 
# Wed, 24 Aug 2022 21:02:40 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 21:02:41 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 24 Aug 2022 21:02:41 GMT
EXPOSE 8080
# Wed, 24 Aug 2022 21:02:42 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0fb6246811e74ecba1024f7cac1f52107a758d79b860eed793279d63a9008755`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fa8dfe71c53b17a9ffa8daeee7cff097a1af40bb6c8153a8fbbcda800394391`  
		Last Modified: Wed, 24 Aug 2022 21:32:18 GMT  
		Size: 12.3 MB (12263517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fff05030b44eb6b6385a8d1c6474ad7ae6937bb438ce2ea4cf705e2c21f2d6c`  
		Last Modified: Wed, 24 Aug 2022 21:32:17 GMT  
		Size: 450.2 KB (450167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05a654c2d8dcd652f77ca31a727c352f2191c7cd0c04e021a6f6f92525787977`  
		Last Modified: Wed, 24 Aug 2022 21:32:17 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
