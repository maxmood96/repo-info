...
```console
$ docker pull tomcat@sha256:04de4a9246740c8fb63fcc0f6c3966ce9666ac021f64d8a2568441624d173503
```
...
```console
$ docker pull tomcat@sha256:d4c9d0cd960c0c09065963c7e25f7744bdc42fe5930c6c4c33ec870befd77ae1
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.0 MB (107040484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4225dfd54c613c6517cdf3223e8768b283387b84122efe5c1ce3e3a0e92e5eb8`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 16 Apr 2024 05:30:47 GMT
ENV TOMCAT_MAJOR=9
# Tue, 16 Apr 2024 05:30:48 GMT
ENV TOMCAT_VERSION=9.0.87
# Tue, 16 Apr 2024 05:30:49 GMT
ENV TOMCAT_SHA512=71a64fe805aab89ef4798571d860a3c9a4f751f808921559a9249305abb205836de33ab89bb33b625a77f799f193d6bffbe94aadf293866df756d708f5bfb933
# Tue, 16 Apr 2024 05:30:49 GMT
COPY dir:d52891ccabe312bd3628337c2d6f10fec54ee5b88e62bf7d1287229fecddb540 in /usr/local/tomcat 
# Tue, 16 Apr 2024 05:30:59 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 16 Apr 2024 05:31:03 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 16 Apr 2024 05:31:05 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 05:31:05 GMT
ENTRYPOINT []
# Tue, 16 Apr 2024 05:31:06 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:614f2f12200cbb738003dd93cb2af21f9a331ee4f5e68cb09d5db0584a6b04e4`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595598438b8b7d8de92d0b960d77728654fe7fb7f65e68e1ac7e369c530a3123`  
		Last Modified: Tue, 16 Apr 2024 05:46:59 GMT  
		Size: 12.5 MB (12530254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cd48346be778857c8f43f7c514fdf76fdc411fcd0707be1a6bd7e78d1c92732`  
		Last Modified: Tue, 16 Apr 2024 05:46:58 GMT  
		Size: 475.4 KB (475425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcd58ff709b5294c82dd7023c2926d3e4cb2a95b3f0f4cf25df49ed6c3c0630f`  
		Last Modified: Tue, 16 Apr 2024 05:46:57 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:f0050f1e6c130eee0a900a870c5f237967080f2c54c990412f24b2241038738f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.4 MB (97379708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6a44fe4f23e73e8794152eeaa9ae320673c6ac5313890ab53c7cc7c66db7a96`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=71a64fe805aab89ef4798571d860a3c9a4f751f808921559a9249305abb205836de33ab89bb33b625a77f799f193d6bffbe94aadf293866df756d708f5bfb933
# Tue, 16 Apr 2024 04:50:11 GMT
COPY dir:255c709de4168d95d981200615bc209542cca880689722008e0164df6996ca46 in /usr/local/tomcat 
# Tue, 16 Apr 2024 04:50:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 16 Apr 2024 04:50:17 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 16 Apr 2024 04:50:17 GMT
EXPOSE 8080
# Tue, 16 Apr 2024 04:50:17 GMT
...
-	Layers:
	...
	-	`sha256:928c1c0fae522780b74c6cfe9e15b349ac6198db23dc7acfdbd0c5953a453f60`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:608d5cc836dfd2b353f8054ee274a1dc2b612584465cc246f5ba2f6b57de9e0c`  
		Last Modified: Tue, 16 Apr 2024 04:57:26 GMT  
		Size: 12.5 MB (12502803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d5fe6ee25226d9e78f3721ea0aadab747c9ed5492d35faa73dcbe058aff8d2`  
		Last Modified: Tue, 16 Apr 2024 04:57:25 GMT  
		Size: 451.5 KB (451521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b912a8b32bebd6a605eb8f6bb0fdb11aafec896347c8092171e034259064113a`  
		Last Modified: Tue, 16 Apr 2024 04:57:25 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
