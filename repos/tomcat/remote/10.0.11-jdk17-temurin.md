...
```console
$ docker pull tomcat@sha256:dac9a9c8eadd5676f2de9a998b7d655516147287493bfa062862f7f6100d2ed8
```
...
### `tomcat:10.0.11-jdk17-temurin` - linux; amd64
...
### `tomcat:10.0.11-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:10.0.11-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:10.0.11-jdk17-temurin` - linux; ppc64le
...
### `tomcat:10.0.11-jdk17-temurin` - linux; s390x
