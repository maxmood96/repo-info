## `tomcat:11.0.3-jre17-temurin-jammy`

```console
$ docker pull tomcat@sha256:0f30ab885d5540079588f113040423f031c522fc1a6f3eb18ce3f82524037ea0
```
...
### `tomcat:11.0.3-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.3-jre17-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.3-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.3-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jre17-temurin-jammy` - linux; s390x
