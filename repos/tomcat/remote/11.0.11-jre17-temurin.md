...
```console
$ docker pull tomcat@sha256:7c9430147b6e1e172207c7feaad63f2876c4648d57d0c04a8c55351cc4bd168d
```
...
### `tomcat:11.0.11-jre17-temurin` - linux; amd64
...
### `tomcat:11.0.11-jre17-temurin` - unknown; unknown
...
### `tomcat:11.0.11-jre17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.11-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.11-jre17-temurin` - linux; ppc64le
...
### `tomcat:11.0.11-jre17-temurin` - linux; s390x
