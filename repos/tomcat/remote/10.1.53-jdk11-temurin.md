...
### `tomcat:10.1.53-jdk11-temurin` - linux; amd64
...
### `tomcat:10.1.53-jdk11-temurin` - unknown; unknown
...
### `tomcat:10.1.53-jdk11-temurin` - linux; arm variant v7
...
### `tomcat:10.1.53-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.53-jdk11-temurin` - linux; ppc64le
...
### `tomcat:10.1.53-jdk11-temurin` - linux; s390x
