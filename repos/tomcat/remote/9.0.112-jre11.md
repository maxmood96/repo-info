...
### `tomcat:9.0.112-jre11` - linux; amd64
...
### `tomcat:9.0.112-jre11` - unknown; unknown
...
### `tomcat:9.0.112-jre11` - linux; arm variant v7
...
### `tomcat:9.0.112-jre11` - linux; arm64 variant v8
...
### `tomcat:9.0.112-jre11` - linux; ppc64le
...
### `tomcat:9.0.112-jre11` - linux; s390x
