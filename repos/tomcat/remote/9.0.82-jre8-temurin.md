...
```console
$ docker pull tomcat@sha256:c2a9369afdc7788c05eb3cbd7b8d5de6f84f8ab9825473407ae4b8883ebaaa37
```
...
### `tomcat:9.0.82-jre8-temurin` - linux; amd64
...
### `tomcat:9.0.82-jre8-temurin` - linux; arm variant v7
...
### `tomcat:9.0.82-jre8-temurin` - linux; ppc64le
