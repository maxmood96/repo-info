...
### `tomcat:jre8-temurin-jammy` - linux; amd64
...
### `tomcat:jre8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:jre8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:jre8-temurin-jammy` - linux; ppc64le
