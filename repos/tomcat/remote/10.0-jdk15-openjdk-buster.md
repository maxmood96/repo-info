...
```console
$ docker pull tomcat@sha256:592a2bd00d7a3cce7bfde2ff862141499baa07ab44199e4aa174638f7cba429a
```
...
```console
$ docker pull tomcat@sha256:a98a4cc847cc2a22e3e9b2e6bf174b90408bda14069c268816532b9b023716f9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.2 MB (342154451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b69c9bacfdc8164a77ee08e4aab9da3e0b704149c8507704f0418b4e4fb46bf`
...
# Wed, 13 Jan 2021 08:18:45 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 13 Jan 2021 08:18:46 GMT
EXPOSE 8080
# Wed, 13 Jan 2021 08:18:46 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:7a55f05de5b7050369836bc19ff25b879b055d4eceb69f934b6398d77bd2957a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7483a707907b7270148a9a2b37929ebaf0f3e1ff95248fde5c6070d4d278200f`  
		Last Modified: Wed, 13 Jan 2021 08:39:09 GMT  
		Size: 12.3 MB (12303339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df11d260d0147a7d2f466d9f64c04f7750cdef51996bac09cb3e66a29332c09b`  
		Last Modified: Wed, 13 Jan 2021 08:39:09 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
