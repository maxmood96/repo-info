...
```console
$ docker pull tomcat@sha256:ee50a15b14428f4239fadf67c24511e084cfc89d2e9b72a74b86f77d36b07854
```
...
### `tomcat:8.5.73-jdk8-temurin-focal` - linux; amd64
...
### `tomcat:8.5.73-jdk8-temurin-focal` - linux; ppc64le
