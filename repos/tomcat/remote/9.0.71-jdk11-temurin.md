## `tomcat:9.0.71-jdk11-temurin`

```console
$ docker pull tomcat@sha256:439441f0c11075f7c0a3c14c97cb85f6de8bc69b048b498ef1478631006e6822
```
...
### `tomcat:9.0.71-jdk11-temurin` - linux; amd64
...
### `tomcat:9.0.71-jdk11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.71-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.71-jdk11-temurin` - linux; ppc64le
...
### `tomcat:9.0.71-jdk11-temurin` - linux; s390x
