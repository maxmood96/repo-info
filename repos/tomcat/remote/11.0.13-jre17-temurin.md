## `tomcat:11.0.13-jre17-temurin`

```console
$ docker pull tomcat@sha256:8e19296f6a426214922a083bb4e6d4a8c2d38914dac34e3d4b56df45e9a1fd25
```
...
### `tomcat:11.0.13-jre17-temurin` - linux; amd64
...
### `tomcat:11.0.13-jre17-temurin` - unknown; unknown
...
### `tomcat:11.0.13-jre17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.13-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.13-jre17-temurin` - linux; ppc64le
...
### `tomcat:11.0.13-jre17-temurin` - linux; riscv64
...
### `tomcat:11.0.13-jre17-temurin` - linux; s390x
