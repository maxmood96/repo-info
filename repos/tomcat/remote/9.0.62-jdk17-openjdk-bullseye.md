...
```console
$ docker pull tomcat@sha256:7bf0d6c0e433ee8135a4216df9ae9e510d6250e1ff21a471a0f3f4eee7f9d496
```
...
### `tomcat:9.0.62-jdk17-openjdk-bullseye` - linux; amd64
...
### `tomcat:9.0.62-jdk17-openjdk-bullseye` - linux; arm64 variant v8
