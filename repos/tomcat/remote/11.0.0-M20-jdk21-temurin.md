...
### `tomcat:11.0.0-M20-jdk21-temurin` - linux; amd64
...
### `tomcat:11.0.0-M20-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.0-M20-jdk21-temurin` - linux; ppc64le
...
### `tomcat:11.0.0-M20-jdk21-temurin` - linux; s390x
