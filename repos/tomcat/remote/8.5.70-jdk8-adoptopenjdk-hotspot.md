...
```console
$ docker pull tomcat@sha256:1b282f5ea3aa7f61a6bb6ab47d83e5c553fe148a95a264308e2054335acf331b
```
...
### `tomcat:8.5.70-jdk8-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:8.5.70-jdk8-adoptopenjdk-hotspot` - linux; ppc64le
