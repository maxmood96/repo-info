...
```console
$ docker pull tomcat@sha256:d478d1b89d5b6254c91d1dc444e8bd9aeca8ce828aefd89839c228743167893a
```
...
```console
$ docker pull tomcat@sha256:48c2a2ba79fbe0cb2371bda82df210710aa5e5609da5aa85633b0b49613cf629
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.9 MB (245852897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:217e716b9690e4d46ffefb57194d4d65fcf4dcf07982c73edb1da2d4a1cc5554`
-	Default Command: `["catalina.sh","run"]`
