...
```console
$ docker pull tomcat@sha256:ca6c0d0acaee7be12f91749a5259d12d90424f0504b53c0278511d0f0882fe61
```
...
### `tomcat:9.0.112-jre25` - linux; amd64
...
### `tomcat:9.0.112-jre25` - unknown; unknown
...
### `tomcat:9.0.112-jre25` - linux; arm64 variant v8
...
### `tomcat:9.0.112-jre25` - linux; ppc64le
...
### `tomcat:9.0.112-jre25` - linux; riscv64
...
### `tomcat:9.0.112-jre25` - linux; s390x
