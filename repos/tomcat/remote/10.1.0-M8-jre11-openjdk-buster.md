...
```console
$ docker pull tomcat@sha256:a39af9cd6cdfacea55bf9a0db6d598a1a5c7c445f53313fed9419f2d044ba39b
```
...
```console
$ docker pull tomcat@sha256:438ef6452acb907e423d1ed48db08a1a5e259aecf23874b343d4ee566b62a79c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.6 MB (133594742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0dc97197fc40174e410ffb29a447a0d045d73ad3188395500898daa345b22609`
...
# Wed, 22 Dec 2021 17:02:18 GMT
COPY dir:0d9543d2467ce5a24067a4807b1dabd7dc143a1a4b677503dbf9a166f7c4e764 in /usr/local/tomcat 
# Wed, 22 Dec 2021 17:02:22 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 22 Dec 2021 17:02:24 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 22 Dec 2021 17:02:25 GMT
EXPOSE 8080
# Wed, 22 Dec 2021 17:02:25 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9dfb800f91fde218e41a99486412f2103f5482ce916fc3b90d8f4de3501e3ca8`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b3993550fbf9226b15b710f151c659a7a9ae37781d87a1da22e960891820e2e`  
		Last Modified: Wed, 22 Dec 2021 17:44:25 GMT  
		Size: 12.5 MB (12492820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:998b98dcb627e0f8531293c2634b4a279fb3ae2f6df32c03117df7e63e766464`  
		Last Modified: Wed, 22 Dec 2021 17:44:24 GMT  
		Size: 461.0 KB (460951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1db7bb2cd437ec66143ba80f9fa3525e95d8e5dcc20a5db2754914e4090c681f`  
		Last Modified: Wed, 22 Dec 2021 17:44:24 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
