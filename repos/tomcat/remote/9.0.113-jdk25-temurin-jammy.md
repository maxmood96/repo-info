...
### `tomcat:9.0.113-jdk25-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.113-jdk25-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.113-jdk25-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.113-jdk25-temurin-jammy` - linux; ppc64le
...
### `tomcat:9.0.113-jdk25-temurin-jammy` - linux; s390x
