...
```console
$ docker pull tomcat@sha256:af2e18d9d67c7c6a6f9f800c8db0b0a0b810a010b0377afb25d4eb7a8b791bb9
```
...
### `tomcat:10.1.29-jdk11-temurin` - linux; amd64
...
### `tomcat:10.1.29-jdk11-temurin` - unknown; unknown
...
### `tomcat:10.1.29-jdk11-temurin` - linux; arm variant v7
...
### `tomcat:10.1.29-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.29-jdk11-temurin` - linux; ppc64le
...
### `tomcat:10.1.29-jdk11-temurin` - linux; s390x
