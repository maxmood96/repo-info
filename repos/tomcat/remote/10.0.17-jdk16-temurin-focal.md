...
```console
$ docker pull tomcat@sha256:c5b3528d3db661ba85e02a630d7eb86305dace2f4213facf96f3b5392a730e8e
```
...
### `tomcat:10.0.17-jdk16-temurin-focal` - linux; amd64
...
### `tomcat:10.0.17-jdk16-temurin-focal` - linux; arm variant v7
...
### `tomcat:10.0.17-jdk16-temurin-focal` - linux; ppc64le
...
### `tomcat:10.0.17-jdk16-temurin-focal` - linux; s390x
