...
```console
$ docker pull tomcat@sha256:6f4d5537d80443d1f921f89aedc97c5a32b53f8f6e3875f83a0e778a9ec84f67
```
...
### `tomcat:8.5.86-jre8-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.86-jre8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.86-jre8-temurin-jammy` - linux; ppc64le
