## `tomcat:10.1.19-jdk21`

```console
$ docker pull tomcat@sha256:bd5e83d4d8fecb81f4a8e869b350951e1dcaefb74df97711c53af44ed22b5678
```
...
### `tomcat:10.1.19-jdk21` - linux; amd64
...
### `tomcat:10.1.19-jdk21` - linux; arm64 variant v8
...
### `tomcat:10.1.19-jdk21` - linux; ppc64le
...
### `tomcat:10.1.19-jdk21` - linux; s390x
