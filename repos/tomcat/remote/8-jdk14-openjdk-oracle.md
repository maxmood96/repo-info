...
```console
$ docker pull tomcat@sha256:6203041211d9d443b481ee84765c268351ea497ec38192fee9f6ebfa749fd170
```
...
```console
$ docker pull tomcat@sha256:5fa9321adadc03187ee321fc13d7f8ec34b38fdb0dbd201e89acbf5e56271654
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.4 MB (279416569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed1125f0cdde085c828442c164cd0578c7a21daec6a00a7efb00019d259af901`
...
# Fri, 17 Jul 2020 03:40:36 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 17 Jul 2020 03:40:37 GMT
EXPOSE 8080
# Fri, 17 Jul 2020 03:40:37 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d7ef20ee1e6409e04d38a7f064d8a08a2f2ac7819d834e499a19f3c3d04549ea`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:863320ccefc4dadf1db76a790ab617d731d12a38990cbffc527119e6396bff16`  
		Last Modified: Fri, 17 Jul 2020 03:43:42 GMT  
		Size: 16.1 MB (16121289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:675ca8f4517d305daea6bcd8f41c2844837034cc8c1d8be0163bce8efdf826c9`  
		Last Modified: Fri, 17 Jul 2020 03:43:40 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
