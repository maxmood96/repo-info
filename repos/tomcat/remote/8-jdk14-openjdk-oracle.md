...
```console
$ docker pull tomcat@sha256:1011e522ef394dda5db6299194a3fca1e299d2ce2d0136faf8353c10aaecd199
```
...
```console
$ docker pull tomcat@sha256:436be83dc52ee1228b0b277894270d29fb4c70cf011385c07ae887407255c6d8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.8 MB (279784535 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1558b4cc2bc59fcf1b399812235d0769b14d25a1a6bd60ea06054e7a2c5592de`
...
# Wed, 14 Oct 2020 07:48:23 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 14 Oct 2020 07:48:24 GMT
EXPOSE 8080
# Wed, 14 Oct 2020 07:48:24 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d11a0727ff14298c7f042b5e7a5b994952166b55e8808b7b5992aabbcbd43e6b`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:210784ffdef4d7c46bcc01db5efee3aee54d229c8103f06f843ccee04dfe0a9d`  
		Last Modified: Wed, 14 Oct 2020 08:14:08 GMT  
		Size: 16.2 MB (16217007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb931355e40c9c03359f745b31191a2c8c337db7f26383ae3bf3eba26332b6c2`  
		Last Modified: Wed, 14 Oct 2020 08:14:06 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
