...
```console
$ docker pull tomcat@sha256:f6796550c03dd8d1dcbaf34005285df28f983499fd2b70f7250d94c7f7323317
```
...
### `tomcat:10.1.42-jre11` - linux; amd64
...
### `tomcat:10.1.42-jre11` - unknown; unknown
...
### `tomcat:10.1.42-jre11` - linux; arm variant v7
...
### `tomcat:10.1.42-jre11` - linux; arm64 variant v8
...
### `tomcat:10.1.42-jre11` - linux; ppc64le
...
### `tomcat:10.1.42-jre11` - linux; s390x
