...
```console
$ docker pull tomcat@sha256:d498c7a51d9386646b28a0deafd3626400630a688ac1b767e39646d352ef0035
```
...
### `tomcat:10.1.55-jre25-temurin` - linux; amd64
...
### `tomcat:10.1.55-jre25-temurin` - unknown; unknown
...
### `tomcat:10.1.55-jre25-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.55-jre25-temurin` - linux; ppc64le
...
### `tomcat:10.1.55-jre25-temurin` - linux; riscv64
...
### `tomcat:10.1.55-jre25-temurin` - linux; s390x
