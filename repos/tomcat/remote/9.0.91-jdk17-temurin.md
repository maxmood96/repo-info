...
```console
$ docker pull tomcat@sha256:1ceaa8f4f945adae67f278d00eff0d2748418a1b7db8b9724639ed2996b5ebe1
```
...
### `tomcat:9.0.91-jdk17-temurin` - linux; amd64
...
### `tomcat:9.0.91-jdk17-temurin` - unknown; unknown
...
### `tomcat:9.0.91-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:9.0.91-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.91-jdk17-temurin` - linux; ppc64le
...
### `tomcat:9.0.91-jdk17-temurin` - linux; s390x
