...
```console
$ docker pull tomcat@sha256:10bd5f0047120b1c9b9663a1b6efb0f588ac64fb17ff33d9ab2b4fc2afaa4df0
```
...
### `tomcat:9.0.64-jdk11-temurin-focal` - linux; amd64
...
### `tomcat:9.0.64-jdk11-temurin-focal` - linux; arm variant v7
...
### `tomcat:9.0.64-jdk11-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.64-jdk11-temurin-focal` - linux; s390x
