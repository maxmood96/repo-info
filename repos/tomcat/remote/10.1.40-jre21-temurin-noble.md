...
```console
$ docker pull tomcat@sha256:2a0977474a41293cbb397c19c120da5409ab09385fa1145a5586f7cb9390a510
```
...
### `tomcat:10.1.40-jre21-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.40-jre21-temurin-noble` - linux; riscv64
