...
```console
$ docker pull tomcat@sha256:8710507b2b6cc124d508597712783b3d00a6acc9bee2af5242a90402270e8822
```
...
### `tomcat:9.0.99-jre8-temurin` - linux; amd64
...
### `tomcat:9.0.99-jre8-temurin` - unknown; unknown
...
### `tomcat:9.0.99-jre8-temurin` - linux; arm variant v7
...
### `tomcat:9.0.99-jre8-temurin` - linux; arm64 variant v8
