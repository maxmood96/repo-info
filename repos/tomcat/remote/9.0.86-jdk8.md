...
```console
$ docker pull tomcat@sha256:c896daf57821fe21132f126115c1f8ab0ae879dc330f7ed6dc721ae46e17d0a5
```
...
### `tomcat:9.0.86-jdk8` - linux; amd64
...
### `tomcat:9.0.86-jdk8` - linux; arm64 variant v8
...
### `tomcat:9.0.86-jdk8` - linux; ppc64le
