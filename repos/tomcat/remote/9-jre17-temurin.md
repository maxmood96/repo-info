...
```console
$ docker pull tomcat@sha256:2e7c68d2eff15ec80f9fac9e66294ed4c7186709c57117a15190be0b8e3b18ca
```
...
```console
$ docker pull tomcat@sha256:7dcafe86fb418122bcb143398897dd3c8338fee229f821f13795ece6ceb52ba8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.8 MB (100774326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3fc748c59d72be910cb50a5e9309732d082f9bf74c3763659002e200f13d6d4`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 16 Apr 2024 08:33:17 GMT
ENV TOMCAT_MAJOR=9
# Wed, 17 Apr 2024 00:53:00 GMT
ENV TOMCAT_VERSION=9.0.88
# Wed, 17 Apr 2024 00:53:00 GMT
ENV TOMCAT_SHA512=b2668f50339afdd266dbdf3ff20a98632a5552910179eda272b65ea0b18be4bef8fa9988e3cfc77e4eae4b74ae1e7abe2483b0e427a07628ed50fed3a13eefb9
# Wed, 17 Apr 2024 00:53:01 GMT
COPY dir:ba3e33ed23284380cd070ee082efc56bd4e069281d5d61e5fd722562420f4b69 in /usr/local/tomcat 
# Wed, 17 Apr 2024 00:53:04 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Apr 2024 00:53:06 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 17 Apr 2024 00:53:06 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 00:53:06 GMT
...
```console
$ docker pull tomcat@sha256:b82257aa64bfd7c2a7f50b7bde0db768251cabf49045b2d1802bc14a763ee1ac
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.3 MB (109306077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a88b414a96109b0465fc49ed62d1b0354ee925f8b98c4a27eff7ea9a84d93adf`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Wed, 17 Apr 2024 00:22:05 GMT
ENV TOMCAT_VERSION=9.0.88
# Wed, 17 Apr 2024 00:22:05 GMT
ENV TOMCAT_SHA512=b2668f50339afdd266dbdf3ff20a98632a5552910179eda272b65ea0b18be4bef8fa9988e3cfc77e4eae4b74ae1e7abe2483b0e427a07628ed50fed3a13eefb9
# Wed, 17 Apr 2024 00:22:06 GMT
COPY dir:d16c389454b08a8c5b9211cdc8f41f878332aea0e5f2d67fdeec2d1381e3d626 in /usr/local/tomcat 
# Wed, 17 Apr 2024 00:22:12 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Apr 2024 00:22:15 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 17 Apr 2024 00:22:15 GMT
EXPOSE 8080
# Wed, 17 Apr 2024 00:22:15 GMT
...
-	Layers:
	...
	-	`sha256:dbe0e2289dc582220266b8d6db78088bdc58ce45a043e35c196e5a2044f10c70`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:768067c928eecb317bf1893ec1443c80b4a9b3790b75dd25f8c65e04cefe4411`  
		Last Modified: Wed, 17 Apr 2024 00:34:55 GMT  
		Size: 12.5 MB (12450735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a4bdc8b6ee44692092ffcc751adfd5f7f09ae85108b14f943a57ffd56c77faa`  
		Last Modified: Wed, 17 Apr 2024 00:34:54 GMT  
		Size: 487.6 KB (487598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:991bbb049187ff79493881ca53af1e01b834f34bcbb2b48c493e806a9cce234d`  
		Last Modified: Wed, 17 Apr 2024 00:34:54 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
