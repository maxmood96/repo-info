...
```console
$ docker pull tomcat@sha256:aeab27c7dfb6bd070e4c98f043f5f140d11f9a8af5d63b4330c9c9181194fe15
```
...
```console
$ docker pull tomcat@sha256:cecfcefc5389d660f05677d6ab881390c6d305fd78001e1583c6069b1fcbc10c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.7 MB (102709118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e910609fa4568fd227c6c12c802153c6f637868b26c36d83366f23d8ead16af1`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 06 Mar 2024 04:56:21 GMT
ENV TOMCAT_MAJOR=9
# Fri, 15 Mar 2024 01:08:56 GMT
ENV TOMCAT_VERSION=9.0.87
# Fri, 15 Mar 2024 01:08:57 GMT
ENV TOMCAT_SHA512=71a64fe805aab89ef4798571d860a3c9a4f751f808921559a9249305abb205836de33ab89bb33b625a77f799f193d6bffbe94aadf293866df756d708f5bfb933
# Fri, 15 Mar 2024 01:08:58 GMT
COPY dir:7bdf2860dce8710a051719246aacaeec76c8822891c1d589de31c0daf42aae12 in /usr/local/tomcat 
# Fri, 15 Mar 2024 01:09:05 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 15 Mar 2024 01:09:09 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 15 Mar 2024 01:09:10 GMT
EXPOSE 8080
# Fri, 15 Mar 2024 01:09:10 GMT
ENTRYPOINT []
# Fri, 15 Mar 2024 01:09:10 GMT
...
-	Layers:
	...
	-	`sha256:db1eb5a680c6bca8f7d02267fc64ce883b40fa4d0bcf00a37ab0343d93d07052`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b861f1d78309e876e134a403a604d06fe47e3b85c066fb6ebb52e9a6b0c8cd3b`  
		Last Modified: Fri, 15 Mar 2024 01:20:37 GMT  
		Size: 12.4 MB (12355200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7611ecf535561ca436b111583f7722720b1422e79c0a25f9432b28a8d05b2cf2`  
		Last Modified: Fri, 15 Mar 2024 01:20:35 GMT  
		Size: 431.4 KB (431352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42c286a006267192bc650eae0af53839ca00717c8bdfbd2215f969846c1b36ac`  
		Last Modified: Fri, 15 Mar 2024 01:20:34 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:600ae3cf9fc8a0a610b90dbc8a75b3104733f5fb163544601537d5b5633f9bd5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102539578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e62b16c1ddc580c7be10609029b916e25041d2a64cb744ec2a15207af5960318`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 06 Mar 2024 07:14:45 GMT
ENV TOMCAT_MAJOR=9
# Sat, 16 Mar 2024 14:44:46 GMT
ENV TOMCAT_VERSION=9.0.87
# Sat, 16 Mar 2024 14:44:46 GMT
ENV TOMCAT_SHA512=71a64fe805aab89ef4798571d860a3c9a4f751f808921559a9249305abb205836de33ab89bb33b625a77f799f193d6bffbe94aadf293866df756d708f5bfb933
# Sat, 16 Mar 2024 14:44:47 GMT
COPY dir:cc89a66d294e9153988ca09302b64c374bd6255a16f51ca30ec495213035ad22 in /usr/local/tomcat 
# Sat, 16 Mar 2024 14:44:50 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Mar 2024 14:44:51 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 16 Mar 2024 14:44:51 GMT
EXPOSE 8080
# Sat, 16 Mar 2024 14:44:51 GMT
ENTRYPOINT []
# Sat, 16 Mar 2024 14:44:52 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:8b8657c110577384c1d229be37f39c7fa6461581157416a901c5742e6901b16a`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:811ca21d52bcfe34931e7470a45b14da96858709f20ccbd4f9247903b94dcde8`  
		Last Modified: Sat, 16 Mar 2024 15:11:09 GMT  
		Size: 12.4 MB (12417153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4c7e968c206c6bb2ec0058cff4ef57b156dc68dc21556be1066c130da25ebdd`  
		Last Modified: Sat, 16 Mar 2024 15:11:08 GMT  
		Size: 460.1 KB (460090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60f82da0273dfc69ba3f63e2a353f1107d9859b801b2cc671f07700978847006`  
		Last Modified: Sat, 16 Mar 2024 15:11:08 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
