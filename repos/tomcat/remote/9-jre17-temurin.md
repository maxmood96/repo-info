...
```console
$ docker pull tomcat@sha256:77ea7ee438e74cf99237921f3d4c47b27942c2f0d974093ff5f014a5fae22300
```
...
```console
$ docker pull tomcat@sha256:b07fe4e56b447166973451447ad89519dab7cc309261e9daeb8cdccbdbe3ad6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.3 MB (114298326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9aa5f354f579f81ac362330b52b78184e25ac41f884aef811f8ca70f75e20d60`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 17 Aug 2023 12:44:07 GMT
ENV TOMCAT_MAJOR=9
# Sat, 26 Aug 2023 07:34:40 GMT
ENV TOMCAT_VERSION=9.0.80
# Sat, 26 Aug 2023 07:34:41 GMT
ENV TOMCAT_SHA512=24014441b0ccdd2dda238efa56e1a039476488943e6cf04f8a372a340a49dd21ce174ed68e2f5fcc43401e85fae6d00c5eac3d357653e91601737b6fa94476de
# Sat, 26 Aug 2023 07:34:42 GMT
COPY dir:a63b3dd04dced23674daddd07c715cc673832d0eb24391e7a6bf25dbaff9dccc in /usr/local/tomcat 
# Sat, 26 Aug 2023 07:34:55 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 26 Aug 2023 07:34:59 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 26 Aug 2023 07:34:59 GMT
EXPOSE 8080
# Sat, 26 Aug 2023 07:35:00 GMT
ENTRYPOINT []
# Sat, 26 Aug 2023 07:35:01 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:656c13689aa7acf407f5ecfc634370c05594ef95c505760eba96e44b8a6409cd`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb9e660e882c52339494e879b829293d10bdd9b0b1c38d77f0a662b966241be3`  
		Last Modified: Sat, 26 Aug 2023 08:09:43 GMT  
		Size: 12.3 MB (12312233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7e5916ab7f5c59c5d5a4dbc01d4f301455c1f50e9d61e99b6aaeca3682b6990`  
		Last Modified: Sat, 26 Aug 2023 08:09:42 GMT  
		Size: 489.5 KB (489497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00286989aea2ff113388e474da8c56228b44996ae13555171f54a97eece96e9`  
		Last Modified: Sat, 26 Aug 2023 08:09:41 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
