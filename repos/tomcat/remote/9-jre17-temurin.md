...
```console
$ docker pull tomcat@sha256:9a25714588d871a6c9438b0a04d45b09d1c9d78141ed798cf37681b91994d768
```
...
```console
$ docker pull tomcat@sha256:f07d85b345138b507f8e86519be26657c08452f10681a424c4f29df50dc0ee7b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.9 MB (108901366 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15a86da8f1734e5a35f55566ef6de1c3178411a7b71b667537c602a044f8d69c`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 10 Nov 2025 05:20:02 GMT
ENV TOMCAT_SHA512=2a955d97c6ed7d01fbf0392f3e2920129bcd541b259e894f441e411bac3bbe65576bcb3a314f06d624c9d70040828d26aa8a2c4f39d225d73f6a3db7523aa3ba
# Mon, 10 Nov 2025 05:38:13 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 05:38:51 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 05:38:58 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 05:38:58 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 05:38:58 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:88c7dfc9bf922eaad1c623578919b330b775b034281bf6706f5f7cbc0f7f7a1c`  
		Last Modified: Mon, 10 Nov 2025 05:40:46 GMT  
		Size: 14.2 MB (14233491 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c9df455874c5972e2161992f03597c997d024506bc2cf5b9b133572ca726efeb`  
		Last Modified: Mon, 10 Nov 2025 05:40:45 GMT  
...
```console
$ docker pull tomcat@sha256:b3d98591272fe6cc0f6bea84340c3e93dd81ef2040df40cd3ffe8f843fc258a1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3359779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8561274cacb0f54b040b436a3914a2302daa5ee19ace766b29994d805e2ba300`

```dockerfile
```

-	Layers:
	-	`sha256:d002c9285a1af5596b041486ce32a587c2269dc2492a1739ca202735359b1114`  
		Last Modified: Mon, 10 Nov 2025 06:33:36 GMT  
		Size: 3.3 MB (3336595 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:68a1b0758b06a07cd3c9689703cf97df61dc96715f0091f1d50a861b9a53e2bc`  
		Last Modified: Mon, 10 Nov 2025 06:33:38 GMT  
