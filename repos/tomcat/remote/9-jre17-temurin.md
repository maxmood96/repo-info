...
```console
$ docker pull tomcat@sha256:3821b8b555113694405377c275cd6d7f32fe9471ef56226f5e6d9cbbb5e7ed3a
```
...
```console
$ docker pull tomcat@sha256:21ad5af08c08de00be70453b0fec1ffdc07623185cee9adca45ec5a0a3f7cbc3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.7 MB (109714807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ae07299b2f3186d1dfa46a52c6fce8fa63744edcba6b432e0709296eda91d98`
...
# Sat, 10 Jun 2023 00:34:38 GMT
COPY dir:d9b0f8ef69aefc6cf560d824f5ecd2d105006fbc409f250a988602034b3bd602 in /usr/local/tomcat 
# Sat, 10 Jun 2023 00:34:42 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Jun 2023 00:34:43 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 10 Jun 2023 00:34:43 GMT
EXPOSE 8080
# Sat, 10 Jun 2023 00:34:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d83dfa938a5577195515e69d6d30625b1dcabf769779081319e40133354ff6fd`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:222c0f70737715a907c68a539de56de766a1703bea0643273f4c5e093eafddc8`  
		Last Modified: Sat, 10 Jun 2023 00:44:22 GMT  
		Size: 12.3 MB (12269620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:094920407a66c058d7cd433a908c1e0f0c2d8c8e163a4696bcc19b14b6dc983e`  
		Last Modified: Sat, 10 Jun 2023 00:44:21 GMT  
		Size: 3.0 MB (2969466 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5cf970ca70d1d7bae76cad6446965fa7bfc759366b0fba9bda26ef564411437`  
		Last Modified: Sat, 10 Jun 2023 00:44:21 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:963f8d172da64eff5b1897fc45d72a267cff680bec2b47de6f4cea6ed034a6fe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.4 MB (103427401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e92d48c61c3809413fa4357a13ac38d937648477843524b00bb05f6fc6d472af`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Jun 2023 00:46:33 GMT
ENV TOMCAT_MAJOR=9
# Sat, 10 Jun 2023 01:20:30 GMT
ENV TOMCAT_VERSION=9.0.76
# Sat, 10 Jun 2023 01:20:30 GMT
ENV TOMCAT_SHA512=028163cbe15367f0ab60e086b0ebc8d774e62d126d82ae9152f863d4680e280b11c9503e3b51ee7089ca9bea1bfa5b535b244a727a3021e5fa72dd7e9569af9a
# Sat, 10 Jun 2023 01:20:31 GMT
COPY dir:a57fa31fe74bfc33cf35f7007a722181090bd70e982cac5e808ced1c9de189c2 in /usr/local/tomcat 
# Sat, 10 Jun 2023 01:20:35 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Jun 2023 01:20:37 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 10 Jun 2023 01:20:37 GMT
EXPOSE 8080
# Sat, 10 Jun 2023 01:20:37 GMT
...
-	Layers:
	...
	-	`sha256:ccc8f0e6691601b583b55a059b778115c6e96712d328e807f3cab63b95c4c7c5`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1127204d1fde11095ede7b2ba79d8750f6b4a7fa080fd159738f308ac891470d`  
		Last Modified: Sat, 10 Jun 2023 01:27:41 GMT  
		Size: 12.2 MB (12199985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eba9fc06879592ab9b9c70afaae01d677082b9d19b5f203cd0fce0890d7986af`  
		Last Modified: Sat, 10 Jun 2023 01:27:41 GMT  
		Size: 2.5 MB (2451239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d15aa881b154b00b0c2a8cb5b9134ce6f399480493dd9f3cb84c66d8a7c00ed1`  
		Last Modified: Sat, 10 Jun 2023 01:27:40 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
