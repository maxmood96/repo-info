...
```console
$ docker pull tomcat@sha256:dc539d7608755abc169c38670f666f6274433a4345591c60cf0f529ef7f89f67
```
...
```console
$ docker pull tomcat@sha256:e93e1f14426bd800e10bc42dd9f200ec3e1e0a5c87387f46e2bf2ae8acd854b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.8 MB (107840917 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28e596d8deb06c61e8e1fd7ed44d453ca032aa3792ec1bed673b6eb436aab1c9`
...
# Mon, 14 Aug 2023 21:53:00 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Mon, 14 Aug 2023 21:53:00 GMT
ENV TOMCAT_MAJOR=9
# Tue, 15 Aug 2023 23:50:33 GMT
...
# Tue, 15 Aug 2023 23:50:33 GMT
COPY dir:6888b91490d52d175a2693fc3c85994ed448316903641877c8caed3a5102991c in /usr/local/tomcat 
# Tue, 15 Aug 2023 23:50:38 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 15 Aug 2023 23:50:39 GMT
...
-	Layers:
	...
	-	`sha256:7b6ff46d953c79a5b313559a36f62fbdff140fd4c93262567294c5f023c58ba6`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:531cf3cb817b2db9dd4c688577f42214aa4c62e461ceaf805ead31cd3d6664f6`  
		Last Modified: Wed, 16 Aug 2023 00:15:35 GMT  
		Size: 12.3 MB (12284423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37e96b955aaffb696db3e43e77446d7436d2088e895a548913744ddcfb743310`  
		Last Modified: Wed, 16 Aug 2023 00:15:34 GMT  
		Size: 458.4 KB (458379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67e9f695d4bec9ba5f4be16b1f1c5d92409159e1a7843bd71e9112255835646e`  
		Last Modified: Wed, 16 Aug 2023 00:15:34 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:08ca3ad63d0b5f4dca7a408ddb63da61dd9f82d6102d6790786707885b284312
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.7 MB (106660951 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bf21d32732c2481ca395dea2e240ecb929dc57a54c4c6256592136da226ea7c`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 20:05:17 GMT
ENV TOMCAT_MAJOR=9
# Wed, 16 Aug 2023 00:33:07 GMT
ENV TOMCAT_VERSION=9.0.79
# Wed, 16 Aug 2023 00:33:07 GMT
ENV TOMCAT_SHA512=7a0d99b5fc37c9e9ac26b554fab9147ce0a2ba59fad41e2565b15e9f6e137bf0105f5c9cd6b7b508837ff24feb7b95b2aba49e0abc7b1480a30a11606e79802a
# Wed, 16 Aug 2023 00:33:07 GMT
COPY dir:8d0447ee7d61d5cdb635a4a9b4748ce5538261537014e8ee7cd43850258f3866 in /usr/local/tomcat 
# Wed, 16 Aug 2023 00:33:11 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 16 Aug 2023 00:33:12 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 16 Aug 2023 00:33:12 GMT
EXPOSE 8080
# Wed, 16 Aug 2023 00:33:12 GMT
...
-	Layers:
	...
	-	`sha256:a4a415ed118dd1e239876257ba77d50b29e9a5818cc9952a547588df12624af0`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04ab3a65bd5cd028350bcb8e96554fdd9931a8ef173b54d304929ea94784670b`  
		Last Modified: Wed, 16 Aug 2023 00:54:01 GMT  
		Size: 12.3 MB (12290962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14564780abce32662d2c57dd4a1c9894fdb9e26df5788f8ba9a23174994a3be5`  
		Last Modified: Wed, 16 Aug 2023 00:54:00 GMT  
		Size: 458.4 KB (458367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4a9f20a23e9e907b23ae419c74659a8cb9034111024c23f4c70e62888de0863`  
		Last Modified: Wed, 16 Aug 2023 00:54:00 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:ec2c7821d4d80148067c5d0838f539670f5884583f499ab935bc0a0fc60ef1ef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102500017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:915cf0f8837960eeb655084600f43f70ac2bb7bb3866126a4a7eeef3900e9d16`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 18:48:25 GMT
ENV TOMCAT_MAJOR=9
# Wed, 16 Aug 2023 00:02:41 GMT
ENV TOMCAT_VERSION=9.0.79
# Wed, 16 Aug 2023 00:02:41 GMT
ENV TOMCAT_SHA512=7a0d99b5fc37c9e9ac26b554fab9147ce0a2ba59fad41e2565b15e9f6e137bf0105f5c9cd6b7b508837ff24feb7b95b2aba49e0abc7b1480a30a11606e79802a
# Wed, 16 Aug 2023 00:02:42 GMT
COPY dir:f3eb2acd127c3b75bb5ec4613576e47e687046977e078b3fd8720d8f986b407e in /usr/local/tomcat 
# Wed, 16 Aug 2023 00:02:46 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 16 Aug 2023 00:02:47 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 16 Aug 2023 00:02:47 GMT
EXPOSE 8080
# Wed, 16 Aug 2023 00:02:47 GMT
...
-	Layers:
	...
	-	`sha256:d92d5fe74136aa1497cce4d11d4c3cd13a47b86ca0ba6e7597c521caae970b4c`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbcbda65e4852581a40e1ab04e8270b34c4009d62e42ede42f8944b7932d7bff`  
		Last Modified: Wed, 16 Aug 2023 00:12:32 GMT  
		Size: 12.3 MB (12277823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:815baa7e5961d5191f08eb6dbfdbb923684466ea603a61cd330caf3693904c68`  
		Last Modified: Wed, 16 Aug 2023 00:12:31 GMT  
		Size: 459.8 KB (459849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffdaefea684215f2cb87f62e9497c2eb408ba5a7917aaa3c1613a3a37e2ab125`  
		Last Modified: Wed, 16 Aug 2023 00:12:31 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
