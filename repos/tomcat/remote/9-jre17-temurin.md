...
```console
$ docker pull tomcat@sha256:fae9391a9e44f11e81263cd63e6956f392faa73e6ef4e79bdbb4312218ee9c3c
```
...
```console
$ docker pull tomcat@sha256:b38b8fad7f1c6159718b51a57341df045f77b0ec3f3df8cb03ede565f26660ef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107206126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae857ecc27e1337755ad3827867c46c12fe58b2c91f2991480f0b85ce557a657`
...
# Wed, 05 Jul 2023 08:23:15 GMT
COPY dir:248e07570dc4064ad6e9de7e2999c1c9e6047f90fd042a20e3d9cd4553ae857a in /usr/local/tomcat 
# Wed, 05 Jul 2023 08:23:19 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jul 2023 08:23:20 GMT
...
-	Layers:
	...
	-	`sha256:9ba1432db677a99205528d9c3fea1f90f343bba513750e0691d4ac8c75f3a708`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2f508e99b9250b8c69ee58cba6e88c341897ed83efd1de291a864d80f710e96`  
		Last Modified: Wed, 05 Jul 2023 08:38:20 GMT  
		Size: 12.3 MB (12269620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c42cbfa0cb68168e4193072cf4e49143272597157e4e569d2cf0c39e624b9c`  
		Last Modified: Wed, 05 Jul 2023 08:38:19 GMT  
		Size: 457.5 KB (457544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3abe55bc37f2279afcfda88a03f03a8c9cc575eb04155782b6473899148b4b0`  
		Last Modified: Wed, 05 Jul 2023 08:38:18 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:ef7e7cce00393b50f28f25e9a9f9d0664847d0e71755e753f4136c2486c292de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.4 MB (101406757 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:766afeb8068d8f573172c47f0691697857023e47f00a9a46e2aeafca3e96fddf`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 05:34:43 GMT
ENV TOMCAT_SHA512=028163cbe15367f0ab60e086b0ebc8d774e62d126d82ae9152f863d4680e280b11c9503e3b51ee7089ca9bea1bfa5b535b244a727a3021e5fa72dd7e9569af9a
# Wed, 05 Jul 2023 05:34:44 GMT
COPY dir:ffc8d925f79b5cbbf8e4a9f35db7a1232b2a935d2f7b3676f3f791729f7078cf in /usr/local/tomcat 
# Wed, 05 Jul 2023 05:34:48 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jul 2023 05:34:49 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jul 2023 05:34:49 GMT
EXPOSE 8080
# Wed, 05 Jul 2023 05:34:49 GMT
...
-	Layers:
	...
	-	`sha256:51e44d3df44d54ce9ff98c598301e844025b3f53217c48bd7bbcf7206d869990`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e46bb1f7993453a00baae6549cc17fdfb8afe01adb4325046481244d6e2ccc1`  
		Last Modified: Wed, 05 Jul 2023 05:47:52 GMT  
		Size: 12.2 MB (12200008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f20428bac0bb6ddfcbdf76efa7c83c17406e226e9a0ef140b291eb984113d1d2`  
		Last Modified: Wed, 05 Jul 2023 05:47:51 GMT  
		Size: 430.4 KB (430386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fb12d2fdaef2971b62f89e79c3f97a48842f76e0db02febb13307e0ce2d679d`  
		Last Modified: Wed, 05 Jul 2023 05:47:51 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
