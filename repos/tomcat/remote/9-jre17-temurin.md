...
```console
$ docker pull tomcat@sha256:d7b6bb82205b4f2bddd9e10e61fb05556ee521a2f064ce7c64c868c9cb29569a
```
...
```console
$ docker pull tomcat@sha256:9bb0cd5cb10b7ca0d86dfc9d42efc79e44c5e0614471b3bb93e5fe034cd08c1b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.4 MB (101418383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49853f385ba0fccd540766d2a719267d71e33d6e499632b7fec25f4d35afee1f`
-	Default Command: `["catalina.sh","run"]`
...
COPY dir:a3163cf295917825035254e6e724f73256a0027c24af86b5b9891955991b10a7 in /usr/local/tomcat 
# Tue, 11 Jul 2023 05:10:11 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:51e44d3df44d54ce9ff98c598301e844025b3f53217c48bd7bbcf7206d869990`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05a89fe3abb87f065c976a0d8a50be41a836d894b8253fedfcad3770173e8471`  
		Last Modified: Tue, 11 Jul 2023 05:23:38 GMT  
		Size: 12.2 MB (12211632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a44421480b1fa1e9034224b307bae222382fddc7953617664e5d29ab59ce4940`  
		Last Modified: Tue, 11 Jul 2023 05:23:37 GMT  
		Size: 430.4 KB (430389 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a9f811c93ec6fc91c8a400aea0007c48afff3529bd25dcab75c09c8402a997e`  
		Last Modified: Tue, 11 Jul 2023 05:23:37 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:da99076b1c9215690d4afc931b9cb36b5db9304d70f0bb19ed849975b1a10a27
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.7 MB (113693614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cc3175a754ff1328b738b8474a8f05a01fabc434539b2f8c3e110637561c7d3`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 05 Jul 2023 17:51:45 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Wed, 05 Jul 2023 17:57:43 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 05 Jul 2023 17:57:44 GMT
ENV TOMCAT_MAJOR=9
# Wed, 05 Jul 2023 17:57:44 GMT
ENV TOMCAT_VERSION=9.0.76
# Wed, 05 Jul 2023 17:57:45 GMT
...
# Wed, 05 Jul 2023 17:57:46 GMT
COPY dir:5d60f3f1482540c7c0971fd81a20aafa989a58ea8c79b6b168c2a72333ca6a4d in /usr/local/tomcat 
# Wed, 05 Jul 2023 17:57:56 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Jul 2023 17:58:00 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Jul 2023 17:58:00 GMT
EXPOSE 8080
# Wed, 05 Jul 2023 17:58:00 GMT
...
-	Layers:
	...
	-	`sha256:49abca5e97b497313c6e45283c12659db41a4a49dfdc6aea1b66e4392df9ba9a`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:790fccd5316caef23f15791b2687c0a5edd5b74f9ae65b729c6cf6c20f4c9549`  
		Last Modified: Wed, 05 Jul 2023 18:32:24 GMT  
		Size: 12.3 MB (12297163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6faf50dbecc2e0812cb56716bec83dd4ce6e9ec3c4a69c5242ba9d9e76ccc8b`  
		Last Modified: Wed, 05 Jul 2023 18:32:23 GMT  
		Size: 488.6 KB (488621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e9c3e0735d8cb8822c7009fa30b9e36dd0ea5c17a20cc1be8b97d9343c2d935`  
		Last Modified: Wed, 05 Jul 2023 18:32:22 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:b2af95c7b2633f7581007046f092b872d6113ea3d0f2cf2b317f404b0b44f0ac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.0 MB (101972399 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fadb88846edff624c9d60811f62734d7a3dfa32baf753ba7c60fff8896e8048`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Wed, 05 Jul 2023 11:06:14 GMT
ENV GPG_KEYS=48F8E69F6390C9F25CFEDCD268248959359E722B A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243
# Wed, 05 Jul 2023 11:06:14 GMT
ENV TOMCAT_MAJOR=9
# Tue, 11 Jul 2023 08:27:37 GMT
ENV TOMCAT_VERSION=9.0.78
# Tue, 11 Jul 2023 08:27:37 GMT
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Tue, 11 Jul 2023 08:27:38 GMT
COPY dir:479187b4cdaa21a0208342d0e85b829f71d5aa6d7b78f65e022509036211ee0d in /usr/local/tomcat 
# Tue, 11 Jul 2023 08:27:42 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 08:27:43 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Jul 2023 08:27:43 GMT
EXPOSE 8080
# Tue, 11 Jul 2023 08:27:43 GMT
...
-	Layers:
	...
	-	`sha256:40f309d7c2c2b39da228e8dff6f91abda879f0f142513d4a2701af3deeb6b114`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:861dfef3f02dfbad73445b624d42513613360df8e60449fcee9da9e17ef25e1f`  
		Last Modified: Tue, 11 Jul 2023 08:36:49 GMT  
		Size: 12.3 MB (12274200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85a8626c75bbd5f31eb46a39b0ce31db6b788b6b76cf66324155ef31938fde66`  
		Last Modified: Tue, 11 Jul 2023 08:36:48 GMT  
		Size: 459.0 KB (458952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e69dfba941cf1abb5d4f161103601426cf7025a584d2d5982524a8f7b1a1fb3`  
		Last Modified: Tue, 11 Jul 2023 08:36:48 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
