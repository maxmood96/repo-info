...
```console
$ docker pull tomcat@sha256:2a0bbc8401fb1bc56b92d4cf7bb6f839d4736049621ff65fd9521848f73bb816
```
...
```console
$ docker pull tomcat@sha256:0969661b0e7fec6b9a70261ea08d35cf73fbc1d24a57b8ead5e4934077d6575c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.9 MB (107918955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43cec111f7d6b046808ba092f7a5bbb0f9b0b9dd195f90d696a8e2d72ff39499`
...
```console
$ docker pull tomcat@sha256:afe1feeeda4a6ae67e453e8b127c69108627cc181580d6423be716ff07903d2d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.7 MB (102675888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:144606daf0f13a14b58387def2980fd14bba1783f3b593b4be5e8be6e229cdcb`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 11:57:19 GMT
ENV TOMCAT_SHA512=06e239d15ff7b72017c1d0752ddb1be4651374f7c1391631ec5619f4981cb2911267bc6b044d6c71a2a74738f70d433b96418951439848121f1d874862ddd3de
# Wed, 17 Jan 2024 11:57:21 GMT
COPY dir:47b4f81c5960f2a0b74d5e47fbd3c60471aaaadd73c263637198786984a121a7 in /usr/local/tomcat 
# Wed, 17 Jan 2024 11:57:26 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:0165baa580eb9a74f03918bfa8c6e87cbb7423bddf68741d8c20cdaa1c87f775`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2b86e5603c79c6fcc4f51fc695f45de0a3e69a87163a3deaceb0e65b24386a3`  
		Last Modified: Wed, 17 Jan 2024 12:24:16 GMT  
		Size: 12.3 MB (12337571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d39b768d0a5fb93145c2c153b361ffecf07f5be9761b8158c2d0134c9b8d853c`  
		Last Modified: Wed, 17 Jan 2024 12:24:14 GMT  
		Size: 432.3 KB (432313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1d192be1c204551bad03c510e243f5d32d4c0fde3d50b5bca01c5fd7167a706`  
		Last Modified: Wed, 17 Jan 2024 12:24:14 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:86976842c0be1e8358cf35116f4e3291cd018bfc723808a006c2d495ea55198d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.8 MB (106754802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:445883e6b258a9cbd2b283fe76d6805334e8a78a944d4c442ddbfd4c782cfc99`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 14:05:22 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Jan 2024 14:05:23 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 17 Jan 2024 14:05:23 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 14:05:23 GMT
...
```console
$ docker pull tomcat@sha256:e76002a60ff82c2f8627db441f06b824969fa6d4dcdba5f91bf367bf4be6348f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.3 MB (114305808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63ddbf5c0e773638ac8f3de0886affed4e1309ef66df91cf197c913b826f5b39`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 17 Jan 2024 09:07:59 GMT
ENV TOMCAT_SHA512=06e239d15ff7b72017c1d0752ddb1be4651374f7c1391631ec5619f4981cb2911267bc6b044d6c71a2a74738f70d433b96418951439848121f1d874862ddd3de
# Wed, 17 Jan 2024 09:08:00 GMT
COPY dir:f8cce39036420e5ea2d26e772202825cb9c1c51f7ce0db4223430dcf1e4c1787 in /usr/local/tomcat 
# Wed, 17 Jan 2024 09:08:08 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Jan 2024 09:08:10 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 17 Jan 2024 09:08:10 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 09:08:11 GMT
ENTRYPOINT []
# Wed, 17 Jan 2024 09:08:11 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b058c5afc20bc21438b55f2179b471ef52bcf7a7db1b238db0de129a1e0d92d2`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a45a2e4e3100de79c2239cca54a1c5136416d307a1a0e322951a9aefe10554c6`  
		Last Modified: Wed, 17 Jan 2024 09:24:45 GMT  
		Size: 12.4 MB (12432390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8965bc6a85d90bd80372ae94ebf35b4b50a9fd06792421a7757893497f56d4f`  
		Last Modified: Wed, 17 Jan 2024 09:24:44 GMT  
		Size: 489.7 KB (489687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cac90e57ac1c6b8cd6738b057cbfcd432807cd26b7f6cd5e7842c55f84e34049`  
		Last Modified: Wed, 17 Jan 2024 09:24:44 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:00318d45662982cfc1ac8729671ff456946441c16fbe9ea6a181d23bb290263d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102530081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11400eea8870f3cd1cf25d161c458268352fae7f517eaa2d9f2e633ce2613512`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=06e239d15ff7b72017c1d0752ddb1be4651374f7c1391631ec5619f4981cb2911267bc6b044d6c71a2a74738f70d433b96418951439848121f1d874862ddd3de
# Wed, 17 Jan 2024 15:43:28 GMT
COPY dir:89219ae75a9724927925c7dd3aadebd2b0d05720627af8389072e34c9e964219 in /usr/local/tomcat 
# Wed, 17 Jan 2024 15:43:36 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Jan 2024 15:43:39 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 17 Jan 2024 15:43:39 GMT
EXPOSE 8080
# Wed, 17 Jan 2024 15:43:39 GMT
ENTRYPOINT []
# Wed, 17 Jan 2024 15:43:40 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:5ac2e3605788c449d00b97f09aea1607d05b52b2ac47a10a38bcaa030bab192d`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8db8ed5c08b146e9f0643295ddaabe462f1585df2c355791ef475c2c033851f0`  
		Last Modified: Wed, 17 Jan 2024 16:23:45 GMT  
		Size: 12.4 MB (12398981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:794373a5262023945a4b8b67c026cedf212c81ab2c1c8d622e06a6f5580fd4c0`  
		Last Modified: Wed, 17 Jan 2024 16:23:44 GMT  
		Size: 459.9 KB (459946 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8858dc04ebf122d8a0f8b24e9d8b57e20114222007830c78e54197e0bf286224`  
		Last Modified: Wed, 17 Jan 2024 16:23:44 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
