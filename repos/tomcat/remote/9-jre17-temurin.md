...
```console
$ docker pull tomcat@sha256:78ff6663ca062c5f937afb065ec5cc8a9d9ef98575509365a5428e2476eacf8c
```
...
```console
$ docker pull tomcat@sha256:952794d50707e5d0a628ce7ed8a96570ea77413797ec05e39203d6114c8333f5
```
...
-	Image ID: `sha256:5bee5ffc8dca3db5dee401b798bccc4d56d4519fe57de70497320b074b4e615b`
...
COPY dir:09ff72c31511f9c5f9b70cf85b208565c8b3b5c19b7230c1f53378d54aec74b9 in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:18:09 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:18:10 GMT
...
-	Layers:
	...
	-	`sha256:dd8fdd28e694b8be96f0ab2f7c9dcff51ded32313db281e697f0f47340b81555`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ca184838ee13afee16f911049d3304bf95c1f78295a0e7251fddf70ebeeb257`  
		Last Modified: Tue, 28 Mar 2023 01:36:46 GMT  
		Size: 12.2 MB (12218378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e2fb001c3992d1a48f9d240c2bbd91785cbdc6c9e086738df9e4eacc4ac96bd`  
		Last Modified: Tue, 28 Mar 2023 01:36:45 GMT  
		Size: 457.0 KB (456972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73b403337b5ebd82dbb51c3eebbc5993375b14e4c76781facd40e74d5df8de21`  
		Last Modified: Tue, 28 Mar 2023 01:36:45 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:9897971b43819ca4f388b9352b0671cf8c2d5ba0272c55e1b21e9cf10088a1ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.9 MB (105891188 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e819cd8f2aad13a55ef5d140502d9a50b3ff62edd05f30e1a7d2b3d9214dbd21`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 16 Mar 2023 06:28:08 GMT
ENV TOMCAT_SHA512=d43fbd6c5ae00bc0ffc2559743f91abd3547c827426cb0acdc8428e060e8659b6bb41b3877deb061ab6202980de39b9558525a4256725b647d5bff93e47a5664
# Tue, 28 Mar 2023 01:31:54 GMT
COPY dir:a0a07e75f2b7cb40ace682c4ae62c9bc579282e91976c4b0308463e1752ac142 in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:31:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:31:58 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Mar 2023 01:31:58 GMT
EXPOSE 8080
# Tue, 28 Mar 2023 01:31:58 GMT
...
-	Layers:
	...
	-	`sha256:22574da6a8f30964c321cccc4b118c72ce4409bbe3ed89ecaeb57dde841e1b86`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a35396d182d39c5ea24367b50b4086a36b394046bef02afa296137ed7a447645`  
		Last Modified: Tue, 28 Mar 2023 01:48:10 GMT  
		Size: 12.2 MB (12225316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75cdb8bae047d5f9590fe9324d9b246d58d1c15e839009e5596d8fd0b55bd72e`  
		Last Modified: Tue, 28 Mar 2023 01:48:09 GMT  
		Size: 455.7 KB (455708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a96c420690974219280c4ec95ca9996adf5a31c773531cdcfc41cc98d265ad4c`  
		Last Modified: Tue, 28 Mar 2023 01:48:09 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:e0bf3fb22d07f5a76c242fabac3b7da2fa851faeafccf8fe224db84681480fb5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.5 MB (113485742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83928d56645921e876f3f20fafb9b08338412a5f8ed1660efd9b349f295b64cc`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 16 Mar 2023 09:26:28 GMT
ENV TOMCAT_SHA512=d43fbd6c5ae00bc0ffc2559743f91abd3547c827426cb0acdc8428e060e8659b6bb41b3877deb061ab6202980de39b9558525a4256725b647d5bff93e47a5664
# Tue, 28 Mar 2023 01:02:57 GMT
COPY dir:d02cd198a1c63cb67d4ba4d8e0d3a7b855c395d42ff72e9f7e21d07cbf0bd108 in /usr/local/tomcat 
# Tue, 28 Mar 2023 01:03:05 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 01:03:07 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 28 Mar 2023 01:03:07 GMT
EXPOSE 8080
# Tue, 28 Mar 2023 01:03:07 GMT
...
-	Layers:
	...
	-	`sha256:80dd64ca3704213605a362b3004556fa8b98a2aa849d188bda38b898c3499782`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bf3a3de1c75ff3c3be143275146526e5b224280706737111cf32461213ff5a1`  
		Last Modified: Tue, 28 Mar 2023 01:25:24 GMT  
		Size: 12.2 MB (12246804 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2b8ee6413807232e86415cb4f9cd80564f0a2ae1aefe3a4e5dba45d92eeb318`  
		Last Modified: Tue, 28 Mar 2023 01:25:23 GMT  
		Size: 488.1 KB (488137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:209aac47ce91df45d31a4f01288ee4900174736423f724ae1d97a30116d202cd`  
		Last Modified: Tue, 28 Mar 2023 01:25:22 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
