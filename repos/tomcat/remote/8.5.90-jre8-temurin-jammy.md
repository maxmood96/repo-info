...
```console
$ docker pull tomcat@sha256:019d8d59db86ab988236391f123cfda11257830cd63eee0fd00e98cf211c1056
```
...
### `tomcat:8.5.90-jre8-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.90-jre8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.90-jre8-temurin-jammy` - linux; arm64 variant v8
