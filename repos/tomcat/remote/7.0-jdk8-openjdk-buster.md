...
```console
$ docker pull tomcat@sha256:31f5244e3447e111eab08c69a00cb06dd0cf14d83773a92217b5a09fbf116f8f
```
...
```console
$ docker pull tomcat@sha256:5279062acf76c6f0ff0c9be102cff71c9fca18b0613b1b137241e45925138654
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **241.9 MB (241865678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50fcd208bfcebfc6f8e29da282a3c051b0da6531447bd5d89bdfbb79e4940b50`
...
# Wed, 13 Jan 2021 08:34:19 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 13 Jan 2021 08:34:20 GMT
EXPOSE 8080
# Wed, 13 Jan 2021 08:34:20 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f4d903639a1376ee17cab865e8eda643fafc2e7274da7893946add823e04f715`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b455174347c8dacc57f90fb8454458bee31a8cd2f02373328459a6a48ca68a8b`  
		Last Modified: Wed, 13 Jan 2021 08:45:48 GMT  
		Size: 10.7 MB (10658996 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1e3cfad93d15834a5e358fcbf384e7b466e203b6d92661c9dac080844bbe82d`  
		Last Modified: Wed, 13 Jan 2021 08:45:46 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
