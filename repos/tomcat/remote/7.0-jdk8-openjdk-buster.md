...
```console
$ docker pull tomcat@sha256:52010c2b3ca6a79c4e831ff32d5e0261e331a92a250c25fbe2cc9145387ecfae
```
...
```console
$ docker pull tomcat@sha256:19f478789f6c95ba8bed21321f3dd6b628604bcc88aa67d475b8e09a84dc34b8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.8 MB (240821270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8cee8b799d7a483347f3af868787204d97de5b75cd35208e20929fd6c1c260f`
...
# Fri, 11 Sep 2020 04:30:48 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 11 Sep 2020 04:30:48 GMT
EXPOSE 8080
# Fri, 11 Sep 2020 04:30:49 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:184fa67b56e04ebe43d5e74bf81820b741b215bbebab9aa1fb0db2c164ef40d8`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1adfeacffa9d7d02faa0b0b824cd51199adf4f2303623a1576fdc5dc1355873f`  
		Last Modified: Fri, 11 Sep 2020 04:37:35 GMT  
		Size: 10.7 MB (10660966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcfa43c1b58bc32f262066081311d085d23bcf7287ab2de66efa945e4901c699`  
		Last Modified: Fri, 11 Sep 2020 04:37:34 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
