## `tomcat:8-jdk15-adoptopenjdk-openj9`

```console
$ docker pull tomcat@sha256:917a8015c3b5738dae9e37c9235c67feea94aab586453756b430342c8f3b5119
```
...
### `tomcat:8-jdk15-adoptopenjdk-openj9` - linux; amd64
...
### `tomcat:8-jdk15-adoptopenjdk-openj9` - linux; arm64 variant v8
...
### `tomcat:8-jdk15-adoptopenjdk-openj9` - linux; ppc64le
...
### `tomcat:8-jdk15-adoptopenjdk-openj9` - linux; s390x
