...
```console
$ docker pull tomcat@sha256:00629c5c7685c967fc66cbfc77431551579fcc437970d20514196d991616d2f8
```
...
### `tomcat:9.0.63-jre8-temurin-focal` - linux; amd64
...
### `tomcat:9.0.63-jre8-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.63-jre8-temurin-focal` - linux; ppc64le
