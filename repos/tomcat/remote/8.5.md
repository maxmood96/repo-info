...
```console
$ docker pull tomcat@sha256:c7e2724f796963e690db00643a3809a882fab027fc61220541e50cd67338f237
```
...
```console
$ docker pull tomcat@sha256:69ce6dc9633ceb5a074cb1d699fe588fe10eac78b3965c521bc668052dc2b6f3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **241.6 MB (241554410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34aaa18518993d3db759971ee595d6c152adf0eccf316cc9107bd53261cef66d`
