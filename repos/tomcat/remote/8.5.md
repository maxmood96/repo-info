...
```console
$ docker pull tomcat@sha256:cc0466b0009605b8059684afd04eecd008dd911bbb65e5b06a2423791856c4d8
```
...
```console
$ docker pull tomcat@sha256:2b1f950e214a089b01c857f1d54c35bcacd8026a7b734213c035195a75bf4e7c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.9 MB (240926233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:990949f5169a6951acf13b6a5ba23145f090d346305c70127a627706ae6e9698`
-	Default Command: `["catalina.sh","run"]`
