...
```console
$ docker pull tomcat@sha256:04f3da569afc6bf4af7cbd9a801011ccd5f83bf38b71669bc1cbe94b5d73ffc2
```
...
```console
$ docker pull tomcat@sha256:a7f349176281ef4f33ee362b8e22873a7698a24071f765cb1c8eb65fb0d48b0c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.9 MB (240938734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07fae8960d10b33ca75c7297e9f3f1d73c8f6369d25832267de8706618e084a0`
-	Default Command: `["catalina.sh","run"]`
