...
```console
$ docker pull tomcat@sha256:11f0f67a2d8851465b7ab45cbd4d55f943f3e654b7f08671f5fcf505c3b36404
```
...
```console
$ docker pull tomcat@sha256:f4616015f3bde8011e428cacb16b5319d4995e0ce0becf478969b49a0551e310
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.0 MB (106957776 bytes)**  
...
# Sat, 16 Dec 2023 16:15:53 GMT
COPY dir:c4b7aa8e6a6bf576b76bc9db5275d6fed081e7e7168632136d0128ec6a5eb212 in /usr/local/tomcat 
# Sat, 16 Dec 2023 16:15:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 16:15:58 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 16 Dec 2023 16:15:58 GMT
EXPOSE 8080
# Sat, 16 Dec 2023 16:15:58 GMT
ENTRYPOINT []
# Sat, 16 Dec 2023 16:15:59 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dc81f1b04d3d203216bfcc90d5a6429b5c33ec66e790e3ebf566431088f5212c`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4313d7ffa7fcb5ab80941e2e10ed4fe43a553f12e2db061a8f58b0a0bf638bcb`  
		Last Modified: Sat, 16 Dec 2023 16:32:25 GMT  
		Size: 11.4 MB (11446108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbc8841badaafd46641d6999f99c9df5725a94f5d53206664556e35a5a99080c`  
		Last Modified: Sat, 16 Dec 2023 16:32:24 GMT  
		Size: 458.4 KB (458440 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddeb3773806b93f8798ada15ba2a324cfb533c24e24730882774155e986e9c46`  
		Last Modified: Sat, 16 Dec 2023 16:32:24 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
