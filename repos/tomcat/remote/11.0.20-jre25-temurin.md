...
```console
$ docker pull tomcat@sha256:c6967a770426ce211410c6d3e18c7aba28db10697f88f896379d7ea2239b4fad
```
...
### `tomcat:11.0.20-jre25-temurin` - linux; amd64
...
### `tomcat:11.0.20-jre25-temurin` - unknown; unknown
...
### `tomcat:11.0.20-jre25-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.20-jre25-temurin` - linux; ppc64le
...
### `tomcat:11.0.20-jre25-temurin` - linux; s390x
