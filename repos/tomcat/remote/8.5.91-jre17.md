...
```console
$ docker pull tomcat@sha256:fad9513160b951bd9d845f33acac510d0c4f25da55d1ed41bf3bfd15378075b0
```
...
```console
$ docker pull tomcat@sha256:a86819902ff3e54e74e882deef580f4d8333d9d2a52309221a830145b38549e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.6 MB (100600307 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:323633dfa4a62ead1ce3fbcc66b595defcf27d97866992765eaad838b2bbf285`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Tue, 25 Jul 2023 23:20:40 GMT
COPY dir:a5f58ec1d2187119202390f222569c309df09466e3bda5bda1f49478209ca498 in /usr/local/tomcat 
# Tue, 25 Jul 2023 23:20:44 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 25 Jul 2023 23:20:45 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 25 Jul 2023 23:20:45 GMT
EXPOSE 8080
# Tue, 25 Jul 2023 23:20:45 GMT
...
-	Layers:
	...
	-	`sha256:8481306d21d946773ff081b169ac0a58d5ace755f35d4fcd9f8dcffd6a80982f`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f136007b20dfeb8ad8afd8d600a21b9e53a4fb055cebb7ac59742ba6a884ef6`  
		Last Modified: Tue, 25 Jul 2023 23:26:34 GMT  
		Size: 11.3 MB (11254798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0af17585c6efe728db2fe7aafc33b4b339cf0964e95f256aabaf711806471b9a`  
		Last Modified: Tue, 25 Jul 2023 23:26:33 GMT  
		Size: 430.4 KB (430391 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26fff51725175bbea85650f11d31801e8f6d00dccdd96bb0ca12fbfadec16ae8`  
		Last Modified: Tue, 25 Jul 2023 23:26:32 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:8157ec3db14fcd77f8662ba0338b85e42423ac07f09b9a9b1351ea48fdf790b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.1 MB (101101089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8dc83e56eab9b1b9f001d9a04920dabebf79956108cf92767fd5f401623af457`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 25 Jul 2023 22:26:08 GMT
ENV TOMCAT_SHA512=9e6770e9c9c3b630011c0f0e320b31bb0ea3700d52247a12d544ea25f9ee4d93613ad6ccb7939f97fb05e1760978a7547eccb16352d73fa28886134ba58f3f8c
# Tue, 25 Jul 2023 22:26:09 GMT
COPY dir:7652cc956561ff57e9a87964d887b21e3f5652cedfa3197b5a4c2421dafac47c in /usr/local/tomcat 
# Tue, 25 Jul 2023 22:26:13 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 25 Jul 2023 22:26:13 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
...
-	Layers:
	...
	-	`sha256:39521595c90c1e8a7a0a9d6148cab2e4833b91acce26d569550b2ba1f606009f`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2850136e726621773e30439157befe608e9d89e5e5eb2cda2ee246d1aa5926d7`  
		Last Modified: Tue, 25 Jul 2023 22:31:23 GMT  
		Size: 11.3 MB (11317642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7ad7a8d417456d927c97c895d2dd5f6aae4b28ee2ab4a924dd5d26b7330c683`  
		Last Modified: Tue, 25 Jul 2023 22:31:22 GMT  
		Size: 458.9 KB (458942 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78e7908ac3737ee415f84295bcb725e51aedb08222abfceb204c999eed469a97`  
		Last Modified: Tue, 25 Jul 2023 22:31:22 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
