...
```console
$ docker pull tomcat@sha256:17743e7a93101cabc3881cb565884a3f9fee6a418281ce5f6bee82e9f30fc3e2
```
...
### `tomcat:9.0.52-jdk8-openjdk-bullseye` - linux; amd64
...
### `tomcat:9.0.52-jdk8-openjdk-bullseye` - linux; arm64 variant v8
