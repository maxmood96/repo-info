...
```console
$ docker pull tomcat@sha256:784a2711b34f5caeb98e22fd0b90cf7eb29eb8e119cfff34e7fdec6f929e5a6d
```
...
### `tomcat:8.5.88-jre17-temurin` - linux; amd64
...
### `tomcat:8.5.88-jre17-temurin` - linux; arm variant v7
...
### `tomcat:8.5.88-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:8.5.88-jre17-temurin` - linux; ppc64le
...
### `tomcat:8.5.88-jre17-temurin` - linux; s390x
