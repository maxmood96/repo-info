...
```console
$ docker pull tomcat@sha256:08a96cb9978ec5c5a5a6cff497e07415148cdc0d6b7949fef138836bd7fa93ba
```
...
```console
$ docker pull tomcat@sha256:e377834ae61b8ffeb11cad0006aae6bdfe10abdbef7b4434cc1af7c3da8bd8e1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.4 MB (108384305 bytes)**  
...
# Fri, 02 Feb 2024 12:37:28 GMT
COPY dir:924912c1551a7976e077b5d096da7055d7c79f4e2f6e98de9d36c78f9776ccb7 in /usr/local/tomcat 
# Fri, 02 Feb 2024 12:37:33 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Feb 2024 12:37:34 GMT
...
-	Layers:
	...
	-	`sha256:2eabae6d9c8d965f9a9fe99c26e1c88a217124d865a50a5e9f3eb45a0d44b88b`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0fe69fea5b507a2a19a32b2c3558707c4cae950a8cc9f8735303af3d0ff9e77`  
		Last Modified: Fri, 02 Feb 2024 12:57:39 GMT  
		Size: 11.5 MB (11512638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1d0eb81f1ed8cba8e29cd2d11bfe4c950a43959ef9c84fb2ebc1f206fbb7b61`  
		Last Modified: Fri, 02 Feb 2024 12:57:35 GMT  
		Size: 452.9 KB (452876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f474c33116e64bb8d17a586f9220f713b318b00df860042a9423cf3a3006be1`  
		Last Modified: Fri, 02 Feb 2024 12:57:35 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:edb7dc285e929480df22b7b61a3fd1fe65d6b6c4a81b40602cfe7ccbbfc3f7dc
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.1 MB (115079583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4daf11dd40c623a109dc80af3f63933dea648eae34e3f0277d60972df70ab5c6`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Feb 2024 07:54:47 GMT
ENV TOMCAT_MAJOR=8
# Fri, 02 Feb 2024 07:54:48 GMT
ENV TOMCAT_VERSION=8.5.98
# Fri, 02 Feb 2024 07:54:49 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Fri, 02 Feb 2024 07:54:50 GMT
COPY dir:3a973929e335eb444dbdac630a9ec5647efc8aa3094ba1805d283dc08cb7ad86 in /usr/local/tomcat 
# Fri, 02 Feb 2024 07:54:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Feb 2024 07:55:00 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Feb 2024 07:55:01 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 07:55:02 GMT
ENTRYPOINT []
# Fri, 02 Feb 2024 07:55:02 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b2dd8e96073741fa7bdd84ef2c28e8e7e288a32ad8be640a2dabcc58816e5b3b`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7070a1f92a2e59362b05137438700b376f6d3229bc5988679d417982ab965e5`  
		Last Modified: Fri, 02 Feb 2024 08:20:09 GMT  
		Size: 11.6 MB (11557412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79bfb83a580d8d4e16f2f0f71522fde2fd5d7c279d8af19473ccc9a9adde658b`  
		Last Modified: Fri, 02 Feb 2024 08:20:08 GMT  
		Size: 477.9 KB (477923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85e6c8c33a99f7ccd0782f3f75aa4d7b35670af4d4e4452cedb8071cd48ce7d`  
		Last Modified: Fri, 02 Feb 2024 08:20:07 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:aaa857943f424ba5bb8b648e95a842255ceee360903d64b4004e9ae12a2d95dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.9 MB (102914799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:187ca0d26f7e7974b77aaaf1fe5bc1feda2dd46079b0ead1cbdcc7e72d76f01b`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Feb 2024 08:46:16 GMT
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Fri, 02 Feb 2024 08:46:17 GMT
COPY dir:a37b8eec384bc28453334241e48d9cc68995b8b57f4fb4be035e282a1c810aad in /usr/local/tomcat 
# Fri, 02 Feb 2024 08:46:21 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Feb 2024 08:46:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Feb 2024 08:46:22 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 08:46:22 GMT
...
-	Layers:
	...
	-	`sha256:f17887458634448624a71960f8b65759cec10f15b29df1d2b6db26fff2207b45`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c0605f5de1ba2ec7f14d526f6a9536330ab2dbc05e489ba784a3d5074601ee3`  
		Last Modified: Fri, 02 Feb 2024 09:01:35 GMT  
		Size: 11.5 MB (11527849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7ec5c3f1420b37619ce6b5efed97bcac295ad27ea370d71b6d64ee97109c3ce`  
		Last Modified: Fri, 02 Feb 2024 09:01:35 GMT  
		Size: 454.5 KB (454526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f38cca7248d1b0ae01003deef19e771eac75d274c496e79991f9d6dbdb36d27`  
		Last Modified: Fri, 02 Feb 2024 09:01:34 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
