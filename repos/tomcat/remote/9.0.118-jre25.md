...
### `tomcat:9.0.118-jre25` - linux; amd64
...
### `tomcat:9.0.118-jre25` - unknown; unknown
...
### `tomcat:9.0.118-jre25` - linux; arm64 variant v8
...
### `tomcat:9.0.118-jre25` - linux; ppc64le
...
### `tomcat:9.0.118-jre25` - linux; riscv64
...
### `tomcat:9.0.118-jre25` - linux; s390x
