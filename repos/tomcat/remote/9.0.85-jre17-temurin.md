...
```console
$ docker pull tomcat@sha256:441616973e3a695fc3a43b45d54161de542769fbf3fd735f36da0fbb4d2761f0
```
...
### `tomcat:9.0.85-jre17-temurin` - linux; amd64
...
### `tomcat:9.0.85-jre17-temurin` - linux; arm variant v7
...
### `tomcat:9.0.85-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.85-jre17-temurin` - linux; ppc64le
...
### `tomcat:9.0.85-jre17-temurin` - linux; s390x
