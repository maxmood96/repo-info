## `tomcat:10.1.48-jdk11-temurin-jammy`

```console
$ docker pull tomcat@sha256:ce87e8f6864e517308c8814b9e5ed254436926a393c347c7719fd9c529a880d7
```
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.48-jdk11-temurin-jammy` - linux; s390x
