...
```console
$ docker pull tomcat@sha256:aed652010cd559962f88ce084524e29af54c7a7282467972779f9833a2e0932f
```
...
```console
$ docker pull tomcat@sha256:d4c03ee5cdfe20d25ecb7978ffb5ebc028b546e268b539477cd2cf2498ab6472
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.3 MB (274300008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dfbee6757a540f948080fc5c09fe384d3a1a05403e09ca6da2d4e28f69b3547`
...
# Mon, 22 Jun 2020 21:15:26 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 22 Jun 2020 21:15:27 GMT
EXPOSE 8080
# Mon, 22 Jun 2020 21:15:27 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1b6512a263723d6c5c7ff549d3758ce6026fb62b47c78bb2ec1d9233ecf15003`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54a9fceee506d43535e2da665f068fa7c1d1424a91c9ca176dc1b0cf8f1a9452`  
		Last Modified: Mon, 22 Jun 2020 21:19:32 GMT  
		Size: 16.9 MB (16928758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07ce22de532fdc5ef7b7708d2d825d650539234d8540bddf84fe0f73ed395a99`  
		Last Modified: Mon, 22 Jun 2020 21:19:30 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
