...
```console
$ docker pull tomcat@sha256:c38bdef02914ef2ef832ea230b0b2221d4ae2f92eb1052f05c1ac54a2542c068
```
...
### `tomcat:jdk16-openjdk-buster` - linux; amd64

```console
$ docker pull tomcat@sha256:dd2c9ab5b2eb6e7590da8727995f314849bc601f70e2173748d0664ade544dbc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.9 MB (331882610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1b1c4658e4057f6abc5dacfa6d18c7489f43b174c512f1a017252b56b1e0b46`
...
# Wed, 29 Sep 2021 11:21:55 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 29 Sep 2021 11:21:56 GMT
EXPOSE 8080
# Wed, 29 Sep 2021 11:21:56 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3cc7bed7b0d5383f601c7fa40658a44761dda6c0bbb2e6498b11b690892f68db`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ab35d209de94923ac0b0c54bfeda5306541c416210e0f4e2617255b866b68d`  
		Last Modified: Wed, 29 Sep 2021 12:28:00 GMT  
		Size: 12.9 MB (12931205 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8188625a02111562a5051b1304dd57e4ed315b3f7681bd00aa1c54dc99157e3`  
		Last Modified: Wed, 29 Sep 2021 12:27:59 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:jdk16-openjdk-buster` - linux; arm64 variant v8
