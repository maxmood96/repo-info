...
```console
$ docker pull tomcat@sha256:68d1e501d727f328376aa040eb8e7d59e32b6d93560b45cb1b7125a2a40d3460
```
...
### `tomcat:10.1.50-jdk21` - linux; amd64
...
### `tomcat:10.1.50-jdk21` - unknown; unknown
...
### `tomcat:10.1.50-jdk21` - linux; arm64 variant v8
...
### `tomcat:10.1.50-jdk21` - linux; ppc64le
...
### `tomcat:10.1.50-jdk21` - linux; s390x
