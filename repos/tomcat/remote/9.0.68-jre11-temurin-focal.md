...
```console
$ docker pull tomcat@sha256:438077deba848890f9e897150eaba0d7ff649a9a27e465d8ad4f771ca0f7faa2
```
...
```console
$ docker pull tomcat@sha256:1ef46bbd6eac659d86781a17af65fb551e3580965aa19ee97d817552218e3e5c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.1 MB (97073558 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f126c9ab54d95f632de38b265487f59405eda53a9b66f9e11bcaaf7c8eb014be`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 02 Nov 2022 20:56:44 GMT
ENV TOMCAT_SHA512=840b21c5cd2bfea7bbfed99741c166608fa1515bb00475ebd4eccfd4f3ed2a1be6bfffd590b2a6600003205b62f271b6ba0937e557fc65a536df61cb4f7b7c8f
# Wed, 02 Nov 2022 20:56:45 GMT
COPY dir:5dfa24913838347f6a00e0a94a7e82bde7572af00a4b6046c9a8bcd2182dee8f in /usr/local/tomcat 
# Wed, 02 Nov 2022 20:56:49 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Nov 2022 20:56:51 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 02 Nov 2022 20:56:51 GMT
EXPOSE 8080
# Wed, 02 Nov 2022 20:56:51 GMT
...
-	Layers:
	...
	-	`sha256:a337ec8f82084bc3cb92f77e288dee7b3cebf77788e83810e9a1979c517fdeea`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4a8c54b0bd20e4df5e97224f1fe0c857928466f876b6f54d77f1d6f4a735d1c`  
		Last Modified: Wed, 02 Nov 2022 21:27:16 GMT  
		Size: 12.2 MB (12206431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7ef065614e000ddd3f4114f9452f034aff68bb8b3e40de4f2ea810c4cdd85d9`  
		Last Modified: Wed, 02 Nov 2022 21:27:14 GMT  
		Size: 425.1 KB (425132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b811a9e3f4d5add10b972805591e8257555e77ade45eca2e30e86e43b2e11ff`  
		Last Modified: Wed, 02 Nov 2022 21:27:14 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
