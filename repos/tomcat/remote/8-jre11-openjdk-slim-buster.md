...
```console
$ docker pull tomcat@sha256:ace9e0363039d3d822f2c67a3d33888a8658d898af9a11f489e4ce4eff4131a9
```
...
```console
$ docker pull tomcat@sha256:bc8d957bda03908ceccfde593b260df3d4a70ba132cef7e48015efe524d940a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.2 MB (89183388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65112e8258d07e8a219432d8edb33d01ea7c8a4c0233888bbf3b799419b009c0`
...
# Thu, 21 Apr 2022 04:48:22 GMT
COPY dir:4d2ab1a2623bc645343398213b6f56aec62818755226f951e2bda76d8e88d3ac in /usr/local/tomcat 
# Thu, 21 Apr 2022 04:48:25 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 04:48:27 GMT
...
-	Layers:
	...
	-	`sha256:ab9522f3e50e4ee592b7ac3f689c801f02d55d3ec396137e61703fa139edfdfb`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0194ea2a3409c7c826f5cb62a235939eb12fd72ac1e6e1e917e6c325143b9ccc`  
		Last Modified: Thu, 21 Apr 2022 07:04:40 GMT  
		Size: 11.2 MB (11216128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93a496eccb62365ae131535d6ff1fed526cb8e59eb5a6d50cadcdfbecd537ae5`  
		Last Modified: Thu, 21 Apr 2022 07:04:39 GMT  
		Size: 387.7 KB (387724 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f85db2dacbf45b75ceb9587df7453f24118493da11f25265e79a9e9121048580`  
		Last Modified: Thu, 21 Apr 2022 07:04:38 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:21441216c9f5bfbaad2d6b543ea7aa7a970123553dc820e1bc644fe1091ac730
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.5 MB (86488354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df73623fc6a03d77f0ed794c73ca8ed0cc2e74a464067c536f5a058325029004`
-	Default Command: `["catalina.sh","run"]`
...
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Thu, 21 Apr 2022 06:34:36 GMT
ENV GPG_KEYS=05AB33110949707C93A279E3D3EFE6B686867BA6 07E48665A34DCAFAE522E5E6266191C37C037D42 47309207D818FFD8DCD3F83F1931D684307A10A5 541FBE7D8F78B25E055DDEE13C370389288584E7 5C3C5F3E314C866292F359A8F3AD5C94A67F707E 765908099ACF92702C7D949BFA0C35EA8AA299F1 79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 9BA44C2621385CB966EBA586F72C284D731FABEE A27677289986DB50844682F8ACB77FC2E86E29AC A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23
# Thu, 21 Apr 2022 06:34:37 GMT
ENV TOMCAT_MAJOR=8
# Thu, 21 Apr 2022 06:34:38 GMT
ENV TOMCAT_VERSION=8.5.78
# Thu, 21 Apr 2022 06:34:39 GMT
ENV TOMCAT_SHA512=b50213e64cc1fd3da2847deda1ca13bee4c26663093c11d53c5ecfe4cdec8856e743b4a1d8488e0c0cbe9bf149e755df40a4140f3b155e2195e3bc6335de3512
# Thu, 21 Apr 2022 06:34:41 GMT
COPY dir:a19a33751d8dd36706ce692dd386a482d45a71df0bfeb306f3d2f2088e86382c in /usr/local/tomcat 
# Thu, 21 Apr 2022 06:34:44 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 06:34:46 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 21 Apr 2022 06:34:47 GMT
EXPOSE 8080
# Thu, 21 Apr 2022 06:34:48 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c41248aebfce6697f749da265a7c2e9e7a1c1af3eaabfce02a90c1d09c804ef4`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccc95b4cd030445276114467d59248e250ad1dad6f39072c19887dd730d82c78`  
		Last Modified: Thu, 21 Apr 2022 09:06:03 GMT  
		Size: 11.2 MB (11230510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfb32e42f0fee3f75862946a1e9a407c0eb51cf29714cd7daeb6503ddd64a133`  
		Last Modified: Thu, 21 Apr 2022 09:06:02 GMT  
