## `tomcat:11.0.5-jre21-temurin-jammy`

```console
$ docker pull tomcat@sha256:e5da4a17414210753db964cf5b9a2981257ff15f582c3199605b0f31a9454906
```
...
### `tomcat:11.0.5-jre21-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.5-jre21-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.5-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.5-jre21-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.5-jre21-temurin-jammy` - linux; s390x
