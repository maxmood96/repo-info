...
```console
$ docker pull tomcat@sha256:02fd2a36942adb16d0e7b1c22d71b183d4ae306b07215892520b1dc788d24d41
```
...
### `tomcat:11.0.21-jre17-temurin-noble` - linux; amd64
...
### `tomcat:11.0.21-jre17-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.21-jre17-temurin-noble` - linux; arm variant v7
...
### `tomcat:11.0.21-jre17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.21-jre17-temurin-noble` - linux; ppc64le
...
### `tomcat:11.0.21-jre17-temurin-noble` - linux; s390x
