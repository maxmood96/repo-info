...
```console
$ docker pull tomcat@sha256:3f700c34b484a4d280186428d2b038e33ef2d47adae77501551258caf53b7317
```
...
### `tomcat:8.5.86-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.86-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.86-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.86-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:8.5.86-jre17-temurin-jammy` - linux; s390x
