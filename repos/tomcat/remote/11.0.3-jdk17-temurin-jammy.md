...
```console
$ docker pull tomcat@sha256:2c738f2ab93b3cb440841794d06f925aadb2f2e92e64b33f2a94e70fe08ddfd4
```
...
### `tomcat:11.0.3-jdk17-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.3-jdk17-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.3-jdk17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.3-jdk17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jdk17-temurin-jammy` - linux; s390x
