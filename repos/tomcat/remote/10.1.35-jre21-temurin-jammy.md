...
```console
$ docker pull tomcat@sha256:447072e15926e29406c9b822e4328f5aa60d869b81a5fcf0eb7e1bd9261aa8cd
```
...
### `tomcat:10.1.35-jre21-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.35-jre21-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.35-jre21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.35-jre21-temurin-jammy` - linux; s390x
