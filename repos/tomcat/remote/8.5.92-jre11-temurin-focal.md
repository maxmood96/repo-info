...
```console
$ docker pull tomcat@sha256:61f187c70c5f35eb2e16b5d5d89256f6c8f4e24ae5c1894892e8f6b4d9cfbb6a
```
...
### `tomcat:8.5.92-jre11-temurin-focal` - linux; amd64
...
### `tomcat:8.5.92-jre11-temurin-focal` - linux; arm variant v7
...
### `tomcat:8.5.92-jre11-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.92-jre11-temurin-focal` - linux; s390x
