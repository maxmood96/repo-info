...
```console
$ docker pull tomcat@sha256:7757bfbd0e3f03665b504a509e03a209e861455a7769ec4aed776ea9b65ef02d
```
...
### `tomcat:9.0.109-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.109-jre17-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.109-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.109-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.109-jre17-temurin-jammy` - linux; ppc64le
