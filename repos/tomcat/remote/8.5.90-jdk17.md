...
```console
$ docker pull tomcat@sha256:50cffd265001569fa1672724b8d3611f5017999e1c550e7b69337900aeabf772
```
...
### `tomcat:8.5.90-jdk17` - linux; amd64
...
### `tomcat:8.5.90-jdk17` - linux; arm variant v7
...
### `tomcat:8.5.90-jdk17` - linux; arm64 variant v8
...
### `tomcat:8.5.90-jdk17` - linux; ppc64le
