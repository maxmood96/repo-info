## `tomcat:10.1.0-jdk16-openjdk-bullseye`

```console
$ docker pull tomcat@sha256:c0b49d978134f991c71a7c45d4c2907aa418c0aa5f10593ac664430b93f772e3
```
...
### `tomcat:10.1.0-jdk16-openjdk-bullseye` - linux; amd64
...
### `tomcat:10.1.0-jdk16-openjdk-bullseye` - linux; arm64 variant v8
