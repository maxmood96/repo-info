...
```console
$ docker pull tomcat@sha256:c2cf3cd67eb3c89633867384f72aaf8684f9a39e86aa2ff2b6ceaf4544d483d2
```
...
```console
$ docker pull tomcat@sha256:606eef4bc8d439050511f02676dc842042580fe851c99adfa64b2f6b21c11b15
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.1 MB (242060881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13d4c16fff38e078f820832aca29b74e8fba0605474889fadfa1b0c6ab4dfd27`
...
# Thu, 23 Jul 2020 08:24:32 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 23 Jul 2020 08:24:32 GMT
EXPOSE 8080
# Thu, 23 Jul 2020 08:24:33 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2c9eee0d6f84f80ef9bb069c15f334e630491cae84c691a098a5efe2102e8d06`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:000087ab4cacdb0a5aa6f05ee6eb208afbca55f0ad16d7db91d4bbec7b196e36`  
		Last Modified: Thu, 23 Jul 2020 08:35:55 GMT  
		Size: 12.2 MB (12247077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87fc1d8dcd76b88b92fc951ffe9713c1e4527d60aa3d4d06a6e03b7583121182`  
		Last Modified: Thu, 23 Jul 2020 08:35:54 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
