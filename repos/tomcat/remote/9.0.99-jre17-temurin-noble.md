...
```console
$ docker pull tomcat@sha256:747fcc5033758231d976fcf51a695226f7451c9e0c7d58c3ae7e3d0d5204b093
```
...
### `tomcat:9.0.99-jre17-temurin-noble` - linux; amd64
...
### `tomcat:9.0.99-jre17-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.99-jre17-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.99-jre17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.99-jre17-temurin-noble` - linux; riscv64
...
### `tomcat:9.0.99-jre17-temurin-noble` - linux; s390x
