...
```console
$ docker pull tomcat@sha256:1ae5be0607bc3529f3d9b4ede15fd3eeda693335a255942be7d33927157c48c1
```
...
### `tomcat:9.0.110-jdk17-temurin-noble` - linux; amd64
...
### `tomcat:9.0.110-jdk17-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.110-jdk17-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.110-jdk17-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.110-jdk17-temurin-noble` - linux; ppc64le
...
### `tomcat:9.0.110-jdk17-temurin-noble` - linux; s390x
