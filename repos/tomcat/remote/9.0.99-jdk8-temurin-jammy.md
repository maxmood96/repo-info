...
```console
$ docker pull tomcat@sha256:65e7a5b9b0f45521aee21779154e00fc3b500cbc2b358b3de533141e4acf7101
```
...
### `tomcat:9.0.99-jdk8-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.99-jdk8-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.99-jdk8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.99-jdk8-temurin-jammy` - linux; arm64 variant v8
