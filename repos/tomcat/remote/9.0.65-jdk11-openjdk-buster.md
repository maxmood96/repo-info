...
```console
$ docker pull tomcat@sha256:ce5a77cdacc11e57611d7b4926354293b041b15026cf87df630777e8abbc3f8f
```
...
```console
$ docker pull tomcat@sha256:ad40143d9a4c2be0157440100327e7d5c78dc44392a72baf1c21ea2e00a5fdf7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.1 MB (340090428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:125595d3483dc3bf24ef451569a26db13619dc1d18511b0263129a5826591bec`
...
# Wed, 03 Aug 2022 05:01:11 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2022 05:01:11 GMT
EXPOSE 8080
# Wed, 03 Aug 2022 05:01:12 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b0cc2eeebb98eaacf15d2d7b456bc6e83051b964460a377cbe704c12a2182b3b`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b04b4b9489a7864c655772d1989c296b30d8dc7e8db7898974e08660bac8dd1`  
		Last Modified: Wed, 03 Aug 2022 05:45:22 GMT  
		Size: 12.6 MB (12591962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f7abf28d32689006349d94c7d27bd2dbdfa7596103b627f36dde377e6e45bc4`  
		Last Modified: Wed, 03 Aug 2022 05:45:20 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
