...
```console
$ docker pull tomcat@sha256:98fa09054e4dc4c6d31e735c43d85cd295aef341cd1068335c416fb58e769ee5
```
...
```console
$ docker pull tomcat@sha256:0da7b129c96a5ae90209d6e86a866e81c6575213410863272ef3eaa2a5de1603
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.6 MB (334578328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c049e4271c1a2c96bb3ac46d35edd1ddd20245441d3f5642879a9d5c868099d2`
...
# Sun, 20 Mar 2022 11:16:13 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sun, 20 Mar 2022 11:16:13 GMT
EXPOSE 8080
# Sun, 20 Mar 2022 11:16:14 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1fb87b01eadaff04347b377f8c6e852cd6c17b9b4ef3dd145e434cd82c6974a4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e14da6eb50b0918efa4f268e456d26637f7d86528446c3c16507181ab73fd21`  
		Last Modified: Sun, 20 Mar 2022 12:10:35 GMT  
		Size: 12.9 MB (12912434 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14145c689f6f91977c74b95baf1199e5dcc18e7609a81bc4face3a39212f2566`  
		Last Modified: Sun, 20 Mar 2022 12:10:34 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
