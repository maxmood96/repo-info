...
```console
$ docker pull tomcat@sha256:06462f12f1fe6fea1db74115e488d462e3f98595519440ba6e408753ac20daff
```
...
### `tomcat:9.0.91-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.91-jdk21-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.91-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.91-jdk21-temurin-jammy` - linux; s390x
