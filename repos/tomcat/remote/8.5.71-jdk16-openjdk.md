## `tomcat:8.5.71-jdk16-openjdk`

```console
$ docker pull tomcat@sha256:ea412f41b9944b9d99c06be0571b08453957576a416236db73e4edd8bdcc1ec8
```
...
### `tomcat:8.5.71-jdk16-openjdk` - linux; amd64

```console
$ docker pull tomcat@sha256:3d5e814b41bde7802be8825e3e87365c704da73897f94f9439f8ed0e24c4b716
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.0 MB (336031817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2200c71c12426aba4ae5423d093b8b133d765df46a1befd950e6a1e6f9e84448`
...
# Wed, 29 Sep 2021 11:53:28 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 29 Sep 2021 11:53:29 GMT
EXPOSE 8080
# Wed, 29 Sep 2021 11:53:29 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0a6482d1c5176226ccb17f9de967e12bea0106e421aa1f305309d82f0075a352`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3d0158bc1419afb98b2eda4007cb91cc21d08b402d895515bc85384e4dc6cbc`  
		Last Modified: Wed, 29 Sep 2021 12:45:50 GMT  
		Size: 11.5 MB (11522952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a6c99e5e2b8cbfec3ba9f80fa237b6877cc57169a5117409eae054ca334a92e`  
		Last Modified: Wed, 29 Sep 2021 12:45:49 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.71-jdk16-openjdk` - linux; arm64 variant v8
