...
```console
$ docker pull tomcat@sha256:b27fed986405ee5264c9536bf4ab620cb2d5bd3523c9ac8191ea0a5e1bd71468
```
...
### `tomcat:9.0.116-jre21-temurin` - linux; amd64
...
### `tomcat:9.0.116-jre21-temurin` - unknown; unknown
...
### `tomcat:9.0.116-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.116-jre21-temurin` - linux; ppc64le
...
### `tomcat:9.0.116-jre21-temurin` - linux; s390x
