...
### `tomcat:9.0.89-jre8-temurin-focal` - linux; arm variant v7
...
### `tomcat:9.0.89-jre8-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.89-jre8-temurin-focal` - linux; ppc64le
