...
### `tomcat:jdk8-temurin-jammy` - linux; amd64
...
### `tomcat:jdk8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:jdk8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:jdk8-temurin-jammy` - linux; ppc64le
