## `tomcat:11.0.3-jre21-temurin-noble`

```console
$ docker pull tomcat@sha256:34f220aa4f43e5812c41da885b07d7f61526e3585d63a62d7c1d5246c16f3b1b
```
...
### `tomcat:11.0.3-jre21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.3-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:11.0.3-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jre21-temurin-noble` - linux; riscv64
...
### `tomcat:11.0.3-jre21-temurin-noble` - linux; s390x
