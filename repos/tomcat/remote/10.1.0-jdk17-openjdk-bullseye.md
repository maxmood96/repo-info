...
```console
$ docker pull tomcat@sha256:e64a82f04a96ee36728cdac80ccf875829979f22365e81231178775b24121f42
```
...
```console
$ docker pull tomcat@sha256:f49ffad3fa3f10639c27f5b567e4086a419dbada756756d381bc121bd772d325
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.0 MB (340006536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1776f012e591053b9b503a40319e1b52d5f10f33525ba11fd28617e91547dad0`
...
# Thu, 20 Jan 2022 00:51:11 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 20 Jan 2022 00:51:11 GMT
EXPOSE 8080
# Thu, 20 Jan 2022 00:51:12 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:aaeb79502525353a03599166316a6e50dab715b1a73943662e61843607b0351c`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15e2ff9e65f39efa4c45ee47bfe4991ddeee2cd209bf8242c01f0d80e098ee44`  
		Last Modified: Thu, 20 Jan 2022 01:24:52 GMT  
		Size: 12.8 MB (12796051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdadd2357c229b5520b2286bd1837a39515e4559b10ab1bc7f78da059ef7e420`  
		Last Modified: Thu, 20 Jan 2022 01:24:51 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
