## `tomcat:jdk15-adoptopenjdk-hotspot`
...
### `tomcat:jdk15-adoptopenjdk-hotspot` - linux; amd64
...
### `tomcat:jdk15-adoptopenjdk-hotspot` - linux; arm variant v7
...
### `tomcat:jdk15-adoptopenjdk-hotspot` - linux; arm64 variant v8
...
### `tomcat:jdk15-adoptopenjdk-hotspot` - linux; ppc64le
...
### `tomcat:jdk15-adoptopenjdk-hotspot` - linux; s390x
