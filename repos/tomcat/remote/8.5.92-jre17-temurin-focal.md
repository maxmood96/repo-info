...
```console
$ docker pull tomcat@sha256:fde5b0c3dac46745f34d41affea18575fcd0e86654d9c5ce51be2efec78a46a2
```
...
### `tomcat:8.5.92-jre17-temurin-focal` - linux; amd64
...
### `tomcat:8.5.92-jre17-temurin-focal` - linux; arm variant v7
...
### `tomcat:8.5.92-jre17-temurin-focal` - linux; ppc64le
...
### `tomcat:8.5.92-jre17-temurin-focal` - linux; s390x
