...
### `tomcat:10.1.17-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.17-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.17-jre11-temurin-jammy` - linux; ppc64le
