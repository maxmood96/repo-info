...
```console
$ docker pull tomcat@sha256:de7f55bdaf5642b259cadf6131ae64808f45c2de9d5e3d345130521869626b7a
```
...
```console
$ docker pull tomcat@sha256:922a725f7fba10bb6c9f79a36467f96d1b1ebbea964d2ca577ff589779610e25
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.8 MB (148838409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddbd1f870c76c51f5b300ddae6b97fe925ecd809e401f8a2a3d9ad1ffc3437df`
...
# Wed, 13 Jan 2021 08:23:21 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 13 Jan 2021 08:23:22 GMT
EXPOSE 8080
# Wed, 13 Jan 2021 08:23:22 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f85eac235911f6b34bd5501db5953350828366119128fc5b12ed11c9a0795787`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87e59ff755dc3cee89b7c4e311aab8f3880552be691b3fb9917143a091a92a10`  
		Last Modified: Wed, 13 Jan 2021 08:40:48 GMT  
		Size: 12.3 MB (12323554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2230d51bd3a98c63395d3d6cfdd2e84f62e5b5efeca182b0a0e2e89485c25efc`  
		Last Modified: Wed, 13 Jan 2021 08:40:47 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
