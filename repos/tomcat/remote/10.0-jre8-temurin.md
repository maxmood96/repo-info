...
```console
$ docker pull tomcat@sha256:cdb50643559fd55ce30e2ca94a3cad1e51a0cc7d38efb935e3946f4a77476573
```
...
```console
$ docker pull tomcat@sha256:42fd9b50938f98ce79c7ab78af03bd1b2046859ea37896595389736a3cc029cd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.3 MB (103258958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71a64d3f4b663bacb403414e331b8f45a90a69f7035cdd6a59a133b2800584dc`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Tue, 11 Oct 2022 22:01:20 GMT
ENV TOMCAT_VERSION=10.0.27
# Tue, 11 Oct 2022 22:01:21 GMT
ENV TOMCAT_SHA512=33c51be9410eaa0ce1393f8ce80a42a9639b68c7b7af1e9e642045614c170a12f8841ce4142933d1f4d18ba7efc85c630f91c312e959dcdc64aae396c46bdd97
# Tue, 11 Oct 2022 22:01:22 GMT
COPY dir:34d71c9c3056483fdfacbbf2e4a446a3fc1adc57be3d6c74d360401b0550e44d in /usr/local/tomcat 
# Tue, 11 Oct 2022 22:01:30 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Oct 2022 22:01:32 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Oct 2022 22:01:33 GMT
EXPOSE 8080
# Tue, 11 Oct 2022 22:01:33 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0279ccd976c8f17ccca0fd8ebc47abd6f8e8eab6739c272aadfa9c2a61455fc0`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c9e6312f32c297b4ea8fbbf561048011a274359e7764603034f2db51bfd414e`  
		Last Modified: Tue, 11 Oct 2022 22:26:25 GMT  
		Size: 12.6 MB (12604164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcdd31bae5f62684511a4045440dc117a3fd05152cc8e0a318ccc5741fdc1ef6`  
		Last Modified: Tue, 11 Oct 2022 22:26:23 GMT  
		Size: 484.0 KB (483983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05bda4d78760e644f79fcb5b9f1f054f857d94cc43071438b14a0761230e2c0b`  
		Last Modified: Tue, 11 Oct 2022 22:26:23 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
