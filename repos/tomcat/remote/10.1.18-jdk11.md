...
```console
$ docker pull tomcat@sha256:eb1479ad10d7ac8a86f2292b0e1bfdc4060d469989ee9751c7bb395e32b40b69
```
...
### `tomcat:10.1.18-jdk11` - linux; amd64
...
### `tomcat:10.1.18-jdk11` - linux; arm64 variant v8
...
### `tomcat:10.1.18-jdk11` - linux; ppc64le
...
### `tomcat:10.1.18-jdk11` - linux; s390x
