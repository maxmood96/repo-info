...
```console
$ docker pull tomcat@sha256:f9726d0501c6d63dde743c054c1562be28ff686536d75c4f9ef0711875f7b012
```
...
### `tomcat:10.1.41-jdk21-temurin` - linux; amd64
...
### `tomcat:10.1.41-jdk21-temurin` - unknown; unknown
...
### `tomcat:10.1.41-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.41-jdk21-temurin` - linux; ppc64le
...
### `tomcat:10.1.41-jdk21-temurin` - linux; s390x
