...
```console
$ docker pull tomcat@sha256:b22d9281fcdc4548668886253afab369a0b35e68c4d760168e71c647f16e86bb
```
...
### `tomcat:10.0.21-jre11-temurin` - linux; amd64
...
### `tomcat:10.0.21-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:10.0.21-jre11-temurin` - linux; ppc64le
...
### `tomcat:10.0.21-jre11-temurin` - linux; s390x
