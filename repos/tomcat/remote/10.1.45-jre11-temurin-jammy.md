...
```console
$ docker pull tomcat@sha256:c4adb539e1f7ec7f21bd1252d6d1c04949fbb6095d99662b86b267300a8605b6
```
...
### `tomcat:10.1.45-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.45-jre11-temurin-jammy` - linux; s390x
