...
```console
$ docker pull tomcat@sha256:791f88fcfcdc5be5acde7598dbffa84fc87618600e69e98c3ef2a9b231186ae1
```
...
```console
$ docker pull tomcat@sha256:504e304712e777a8f3102f55165758521d123eec2f8d23cd1ffd0be6fe30ccc8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157814647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d1508620bfb63eced481cd6be6ee0f9561985b504ff6261f02e61119da43442`
...
-	Layers:
	...
	-	`sha256:aa11bb64d87ceeb48ffd6bf69340b8dc53f989a04a6ab0d338fa9fac12c4435a`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b90b7db79a7edf25299c9c98e5b2bcf94dd643f9e16709658ce5b0f16a8b3ac4`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:175e70d6b295a044d73ae16670234d3ff7986c50b802fd9d40b1c2f057383072`  
...
```console
$ docker pull tomcat@sha256:21489eb2d9af680efac18851bcd0a480fc9c69968aa2364a0b0d28ec350e9d40
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3925387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53c142b6129378b19f347e0d2c93e0a47efc1383e5eef2cdb2f581016bf4f627`

```dockerfile
```

-	Layers:
	-	`sha256:a3cfd5367f322ea27a5135391358fadbf15341573f46aeadc2dc53d13f78076a`  
		Last Modified: Mon, 26 Jan 2026 22:14:21 GMT  
		Size: 3.9 MB (3894987 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4a37257f33b3f009942afac96aaf06bf1c2884491850c26879d8387a3f7934ff`  
		Last Modified: Mon, 26 Jan 2026 22:14:20 GMT  
...
```console
$ docker pull tomcat@sha256:8245cfb4ce854de9f6e8d666ab85ffe584941ba34ec145f56a8c016c92e488ae
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155032015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c040b538ec08a6f1d491425e1a69a34f3c83c4b1b9baf0317df2156a93b15cc`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:7438f0e4b22abef2d0602d2dff2207c52201911ab3dea1a78bf093597362c1a0`  
		...
		Size: 2.3 KB (2282 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cae001fc8ddc7a2235cf946773e366987221915289a0fc5589c8f6a4bff41b5a`  
		Last Modified: Mon, 26 Jan 2026 22:13:41 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0295756c6575232ce0e010b1aa160034cf9454ea01289814519bf524b9e1b981`  
		Last Modified: Mon, 26 Jan 2026 22:13:42 GMT  
		Size: 19.1 MB (19111177 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:8820a4139857f18eac9c2eb9d49137b54ba11cc29f452339ebfeb587f0c29c87
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4020986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ef824d80fc674137c174df8606d3af8ffa4ca4fc3a1041af4bc346fc034e6dd`

```dockerfile
```

-	Layers:
	-	`sha256:03706a7fd7759be3993a1787c22bcbe5e26afcc7729fd2a1484d9966ff313061`  
		Last Modified: Mon, 26 Jan 2026 22:13:41 GMT  
		Size: 4.0 MB (3990452 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3be75b8855a1e7f03d291af11cb7f16ea651c76ada1d0a83e071ae2b5100672a`  
		Last Modified: Mon, 26 Jan 2026 22:13:41 GMT  
...
```console
$ docker pull tomcat@sha256:254db9383b339081f4065f149960d96189a43dac45f5004417ffdac746bef9e4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164025245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77cc6ec1cc6b80c522499a9d301fb391ee57e858a17d58e541f3cc6266de0bfd`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 23 Jan 2026 22:39:53 GMT
ENV TOMCAT_SHA512=e428203454e57962296e6e95705e46a1406d15569f67ea0cbd417f38fcad85e81de6fa1be62cfa660ec746312aefb87c39127eef7348e6f78cb57e9afb862ed4
# Mon, 26 Jan 2026 22:48:19 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		ca-certificates 		curl 		gnupg 	; 		ddist() { 		local f="$1"; shift; 		local distFile="$1"; shift; 		local mvnFile="${1:-}"; 		local success=; 		local distUrl=; 		for distUrl in 			"https://dlcdn.apache.org/$distFile" 			"https://archive.apache.org/dist/$distFile" 			${mvnFile:+"https://repo1.maven.org/maven2/org/apache/tomcat/tomcat/$mvnFile"} 		; do 			if curl -fL -o "$f" "$distUrl" && [ -s "$f" ]; then 				success=1; 				break; 			fi; 		done; 		[ -n "$success" ]; 	}; 		ddist 'tomcat.tar.gz' "tomcat/tomcat-$TOMCAT_MAJOR/v$TOMCAT_VERSION/bin/apache-tomcat-$TOMCAT_VERSION.tar.gz" "$TOMCAT_VERSION/tomcat-$TOMCAT_VERSION.tar.gz"; 	echo "$TOMCAT_SHA512 *tomcat.tar.gz" | sha512sum --strict --check -; 	ddist 'tomcat.tar.gz.asc' "tomcat/tomcat-$TOMCAT_MAJOR/v$TOMCAT_VERSION/bin/apache-tomcat-$TOMCAT_VERSION.tar.gz.asc" "$TOMCAT_VERSION/tomcat-$TOMCAT_VERSION.tar.gz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	curl -fL -o upstream-KEYS 'https://www.apache.org/dist/tomcat/tomcat-11/KEYS'; 	gpg --batch --import upstream-KEYS; 	printf '' > filtered-KEYS; 	for key in 		'A9C5DF4D22E99998D9875A5110C01C5A2F6059E7' 		'48F8E69F6390C9F25CFEDCD268248959359E722B' 	; do 		gpg --batch --fingerprint "$key"; 		gpg --batch --export --armor "$key" >> filtered-KEYS; 	done; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --import filtered-KEYS; 	gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz; 	tar -xf tomcat.tar.gz --strip-components=1; 	rm bin/*.bat; 	rm tomcat.tar.gz*; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mv webapps webapps.dist; 	mkdir webapps; 		nativeBuildDir="$(mktemp -d)"; 	tar -xf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1; 	apt-get install -y --no-install-recommends 		dpkg-dev 		gcc 		libapr1-dev 		libssl-dev 		make 	; 	( 		export CATALINA_HOME="$PWD"; 		cd "$nativeBuildDir/native"; 		gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 		aprConfig="$(command -v apr-1-config)"; 		./configure 			--build="$gnuArch" 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$aprConfig" 			--with-java-home="$JAVA_HOME" 		; 		nproc="$(nproc)"; 		make -j "$nproc"; 		make install; 	); 	rm -rf "$nativeBuildDir"; 	rm bin/tomcat-native.tar.gz; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	find "$TOMCAT_NATIVE_LIBDIR" -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| xargs -rt readlink -e 		| sort -u 		| xargs -rt dpkg-query --search 		| cut -d: -f1 		| sort -u 		| tee "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt" 		| xargs -r apt-mark manual 	; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		find ./bin/ -name '*.sh' -exec sed -ri 's|^#!/bin/sh$|#!/usr/bin/env bash|' '{}' +; 		chmod -R +rX .; 	chmod 1777 logs temp work; 		catalina.sh version # buildkit
# Mon, 26 Jan 2026 22:48:21 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 26 Jan 2026 22:48:21 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 26 Jan 2026 22:48:21 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6d6223d3dabd43262ce7afbd5118a632a9871448884c32e2b8affc32ab54f52c`  
		Last Modified: Mon, 26 Jan 2026 22:48:56 GMT  
		Size: 21.0 MB (21008529 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:8f21792e22addd43f78ee72b84f80ddeb73e26fcbd48c91ecdadd58205b31861
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (3954171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87cf3decaf99f43a5c69a5c61b1d23720102503efcd620fe03bd186661279560`

```dockerfile
```

-	Layers:
	-	`sha256:ddebffa8378d2154f353f5634d837eddb93d24e60dbe25e08372930733762427`  
		Last Modified: Mon, 26 Jan 2026 22:48:55 GMT  
		Size: 3.9 MB (3923723 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:cf2e2b0b780c44282400dda9d91a064f055b7bed678ceead4acceccc6e1d4559`  
		Last Modified: Mon, 26 Jan 2026 22:48:55 GMT  
...
```console
$ docker pull tomcat@sha256:a0b5b78f0456a41ee9b30ce1abcbe013f36816e256e4e29e3602ed83fccf8cc4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.3 MB (151259764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a81809db32c86e5c8a070f00c0231bc6488b1911e5bc63f798c5ef1d3b8fd23`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:499832fabac1f961b07f1906e4904f68c5e93af9fc3f82e79c26a3a18dab97ae`  
		Last Modified: Mon, 26 Jan 2026 22:15:42 GMT  
		Size: 19.2 MB (19172215 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:a1added89da6bdfe7104267d4d100a1dbef862d7aa71f4fe8bfd0de7621574f5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3852945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a7f24ec4c4b8d22d430d9afe9bd323a90290bd8215a6d31c87ee4e2762587a6`

```dockerfile
```

-	Layers:
	-	`sha256:7f0b38b1049d48c027e0141c0746cb7e00f76c097c968725825cd15842030030`  
		Last Modified: Mon, 26 Jan 2026 22:15:41 GMT  
		Size: 3.8 MB (3822545 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:78f95c8f735a0f8f5964c9d1cd81361e625f0b4871929aea54ac63d24bbf60d5`  
		Last Modified: Mon, 26 Jan 2026 22:15:41 GMT  
		Size: 30.4 KB (30400 bytes)  
		MIME: application/vnd.in-toto+json
