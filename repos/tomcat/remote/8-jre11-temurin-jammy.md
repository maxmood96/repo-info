...
```console
$ docker pull tomcat@sha256:239d16bc25997c661b4d418be03e8b6abe5c3cbf109ef944f8e83314441834e5
```
...
```console
$ docker pull tomcat@sha256:60435129aa42f6401125c980ca2e04d2c53e7d90f7d644c9fc5a1677200b9380
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.6 MB (102588983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53bd25837bfb56022ecdc1c7efa58b5440c710c8992bdaa74c7758e8851ce395`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 06 Oct 2022 02:18:23 GMT
ENV TOMCAT_MAJOR=8
# Tue, 11 Oct 2022 22:09:05 GMT
ENV TOMCAT_VERSION=8.5.83
# Tue, 11 Oct 2022 22:09:06 GMT
ENV TOMCAT_SHA512=57cbe9608a9c4e88135e5f5480812e8d57690d5f3f6c43a7c05fe647bddb7c3b684bf0fc0efebad399d05e80c6d20c43d5ecdf38ec58f123e6653e443f9054e3
# Tue, 11 Oct 2022 22:09:07 GMT
COPY dir:bf3c1970e57d540fea3dfa4229438c1b232ff3b4dd63afa4ee01961f92cfdf99 in /usr/local/tomcat 
# Tue, 11 Oct 2022 22:09:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Oct 2022 22:09:17 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 11 Oct 2022 22:09:17 GMT
EXPOSE 8080
# Tue, 11 Oct 2022 22:09:18 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:356e59bd8eaf37b45e35042c4109b26a797858b66a5bf50b0b6aeafc855f025c`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb149ee4691fe6a8fa213dddcb843c811ac0e49738b75937d8530f548574bc2f`  
		Last Modified: Tue, 11 Oct 2022 22:31:01 GMT  
		Size: 11.2 MB (11244171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef9a2e7125e30fd0db8fc3301395f606c733c6bfa7f15d0f83ca7a86da1a4862`  
		Last Modified: Tue, 11 Oct 2022 22:31:00 GMT  
		Size: 484.0 KB (483984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20530a9402842f0c0fff79b7c1ea5e2f5e13e00f60bfe26fcdc480623431dfd2`  
		Last Modified: Tue, 11 Oct 2022 22:30:59 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
