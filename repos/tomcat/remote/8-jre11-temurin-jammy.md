...
```console
$ docker pull tomcat@sha256:40b45b36fe0cdd9024f215d95248325fabb74c288ce05103619dc9050f28f660
```
...
```console
$ docker pull tomcat@sha256:23a79b772a2568be9d83e6c938915917395af84415ca31fdb33042e5b1f72e6f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.3 MB (94296237 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d57ced5a4efae646ab26fcda7c352290eb5ad40f6b854a6bc691de026fa3cfd0`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=12f58114fe608fdc5f06e99a4ba01852396169f89d08e1ecf96ace36dd685c439519433e7750bfa7523f12c14788a3b5cb9ee3835dd1cce37e2cee121d69625e
# Fri, 16 Feb 2024 14:05:57 GMT
COPY dir:17db131d6f2d90220220052b537c591b840910e908d85b7b9fc6d0ea3e70e276 in /usr/local/tomcat 
# Fri, 16 Feb 2024 14:06:01 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 16 Feb 2024 14:06:02 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 16 Feb 2024 14:06:02 GMT
EXPOSE 8080
# Fri, 16 Feb 2024 14:06:02 GMT
ENTRYPOINT []
# Fri, 16 Feb 2024 14:06:03 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1b4fb2e814505bbe723c7f68bdbeb4cf59a978823d599af8649ead86afb25bd7`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbe38942579387f0e873a92e6a07f4a4425db7e7897c2c727f1b9d8eb23d1eb7`  
		Last Modified: Fri, 16 Feb 2024 14:16:43 GMT  
		Size: 11.4 MB (11445553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c456c720015f626984c4d9b7ad97c01f066fac12343ce8e75a716cedfd14e5`  
		Last Modified: Fri, 16 Feb 2024 14:16:43 GMT  
		Size: 457.4 KB (457395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e48f2b89adee39491d46f6439399a688cb45dfa9ac6da71be3dc79cd37abaed`  
		Last Modified: Fri, 16 Feb 2024 14:16:43 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
