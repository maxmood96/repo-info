...
```console
$ docker pull tomcat@sha256:59ba6ecce4db9b0815d1dfec80c19c62866f18d1dd98e031907c84baa3247ca0
```
...
```console
$ docker pull tomcat@sha256:6db8b24b37726ebf0e425f782c37685637d332b39f0c57188803dabbde5b8b50
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.6 MB (95647598 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83b3a1338d6506173a68887b8a3875bed3f95c4dc8c8d4061f297ddc20882609`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Jun 2023 15:47:29 GMT
ENV TOMCAT_MAJOR=8
# Fri, 02 Jun 2023 15:47:30 GMT
ENV TOMCAT_VERSION=8.5.89
# Fri, 02 Jun 2023 15:47:30 GMT
ENV TOMCAT_SHA512=328c6f5e9515baa1dc8c4d81db51194688be36a6dbc9fc0f6444d1a8f692ca0efb8b90555aed23cb28fe2a69ab1fd6b9b71c047212c7bbf6445bba193debbc09
# Fri, 02 Jun 2023 15:47:30 GMT
COPY dir:a2e5f48ec1883a4beca4c50b7f52fbaccc0995b84c40b945ffa1ae7a5dab8725 in /usr/local/tomcat 
# Fri, 02 Jun 2023 15:47:33 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Jun 2023 15:47:34 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Jun 2023 15:47:34 GMT
EXPOSE 8080
# Fri, 02 Jun 2023 15:47:34 GMT
...
-	Layers:
	...
	-	`sha256:580192213cba6d6e6e7eb5089f0d628b7a0d07784c9aeebea40ca0c67da44d2b`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0334ca0312319eaaa31f7074c5a588fbab2824d01416f7ed318931829a7f4f7b`  
		Last Modified: Fri, 02 Jun 2023 15:52:26 GMT  
		Size: 11.3 MB (11262371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8acec966d7218d81e34154671923b33ca86464c15e32f527b0159d00c011ccbb`  
		Last Modified: Fri, 02 Jun 2023 15:52:26 GMT  
		Size: 2.6 MB (2649628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ed505538fd634096d4c1ed27af081ea0d90e989cf1d5b1520480d39b242ce32`  
		Last Modified: Fri, 02 Jun 2023 15:52:25 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
