...
```console
$ docker pull tomcat@sha256:a781992cb53f9dff1945bd97de1c7c54bb26dee066b454cbc8b45eeebbc793cf
```
...
```console
$ docker pull tomcat@sha256:0f6961672b4d8c76a832e557be4998ae922a257c70fbf4baa1004719585d04db
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.6 MB (103623852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:511130a460321e2423f9c7f3983a33877e484e4b3d06b5945a6cbb8a30fee1d9`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=8
# Sat, 26 Aug 2023 07:54:21 GMT
ENV TOMCAT_VERSION=8.5.93
# Sat, 26 Aug 2023 07:54:22 GMT
ENV TOMCAT_SHA512=fdd9bd768c2c8b7f57c75f1a4863bd2bde55e8ea7c8b9cb81427ea8be652540bdcb1ff1cd625b9fb0dd48eb750ebef0f0244d12ac574998d5df3a0d339699bcc
# Sat, 26 Aug 2023 07:54:23 GMT
COPY dir:c54d61ef55817ccdedc584782d9ab205c1e401590ebf99ddb3e22c5ccecab421 in /usr/local/tomcat 
# Sat, 26 Aug 2023 07:54:35 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 26 Aug 2023 07:54:42 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 26 Aug 2023 07:54:42 GMT
EXPOSE 8080
# Sat, 26 Aug 2023 07:54:43 GMT
ENTRYPOINT []
# Sat, 26 Aug 2023 07:54:44 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b34607f5e7c115c259db1be16e2be4a06e676081489ae890b2db23b15a9dc7e6`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3cf68676d33d4750bbc12a45345b4f6ca64944fb99d58420725a9c9b5cf5f16`  
		Last Modified: Sat, 26 Aug 2023 08:17:19 GMT  
		Size: 11.4 MB (11357207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e28004994df3032bade80544326013b60d55058bde8be1819c195029c5abef35`  
		Last Modified: Sat, 26 Aug 2023 08:17:18 GMT  
		Size: 486.9 KB (486930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c6757ddfca10d2e71d4a08261fe35580d33292ef78db035068770b9a8cc2c6b`  
		Last Modified: Sat, 26 Aug 2023 08:17:17 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
