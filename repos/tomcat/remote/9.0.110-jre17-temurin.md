...
```console
$ docker pull tomcat@sha256:ade88a2db5c1d3075e0cda3c3b580ec8d6bdec2efed84e3ad76d9dd6933e1047
```
...
### `tomcat:9.0.110-jre17-temurin` - linux; amd64
...
### `tomcat:9.0.110-jre17-temurin` - unknown; unknown
...
### `tomcat:9.0.110-jre17-temurin` - linux; arm variant v7
...
### `tomcat:9.0.110-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.110-jre17-temurin` - linux; ppc64le
...
### `tomcat:9.0.110-jre17-temurin` - linux; s390x
