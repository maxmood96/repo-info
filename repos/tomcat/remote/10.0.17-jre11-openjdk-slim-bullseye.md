## `tomcat:10.0.17-jre11-openjdk-slim-bullseye`

```console
$ docker pull tomcat@sha256:377922a0a5468dbf806f9d9e2e4a151e4cd57379ae400ba1798ebb8fc7d35c11
```
...
### `tomcat:10.0.17-jre11-openjdk-slim-bullseye` - linux; amd64
