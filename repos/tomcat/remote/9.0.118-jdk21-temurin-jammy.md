...
```console
$ docker pull tomcat@sha256:7a359b4a627ca9346f5d3d1791243093359aa9e349e7c418e77df54a4dce8e70
```
...
### `tomcat:9.0.118-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.118-jdk21-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.118-jdk21-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.118-jdk21-temurin-jammy` - linux; ppc64le
...
### `tomcat:9.0.118-jdk21-temurin-jammy` - linux; s390x
