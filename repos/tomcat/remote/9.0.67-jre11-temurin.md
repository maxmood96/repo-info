...
```console
$ docker pull tomcat@sha256:7481d717bcd2345f1433659157fea76d2d1c51b2e4ceb268c118d7fa77b95729
```
...
### `tomcat:9.0.67-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.67-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.67-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.67-jre11-temurin` - linux; ppc64le
...
### `tomcat:9.0.67-jre11-temurin` - linux; s390x
