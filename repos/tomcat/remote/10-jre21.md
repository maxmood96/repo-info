...
```console
$ docker pull tomcat@sha256:cce4ff1b1a1233cc23303ba88e4f7aadc05d3a67d9fb3b705f36b6afaae42d35
```
...
```console
$ docker pull tomcat@sha256:0219736c2f97136f6b2e9c38d51062d1a5ddb632fc0abdded1cb5e9e7ec97793
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.2 MB (121213264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a87784659adcf50be6ae85f4a69bfcda3853363ac61139878e3bceb51ac54f2`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Wed, 21 Feb 2024 02:48:21 GMT
ENV TOMCAT_VERSION=10.1.19
# Wed, 21 Feb 2024 02:48:21 GMT
ENV TOMCAT_SHA512=7264da6196a510b0bba74469d215d61a464331302239256477f78b6bec067f7f4d90f671b96a440061ae0e20d16b1be8ca1dbd547dab9927383366dbc677f590
# Wed, 21 Feb 2024 02:48:22 GMT
COPY dir:63d75407cb8294c1c0e644075a4cf1538dee90ce91c956f9766c891a5aa95641 in /usr/local/tomcat 
# Wed, 21 Feb 2024 02:48:28 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 02:48:30 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 02:48:30 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 02:48:30 GMT
...
-	Layers:
	...
	-	`sha256:a862fd03d7be4030d03e715277cb4eb74dc06586c207a4c383b9e47981f47867`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46be453f95bd61af87964ac7680b7db1dc37a55cbcd47796bf9639e4549d4bd2`  
		Last Modified: Wed, 21 Feb 2024 03:20:16 GMT  
		Size: 12.6 MB (12566895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b3b15c9b5de3ae09ba738a8c2cab77b4a4813071f02473bfb591609933250e7`  
		Last Modified: Wed, 21 Feb 2024 03:20:15 GMT  
		Size: 489.7 KB (489741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4da6b00b94ff088a57f9dd10fd1e40e65a1425ccb65f845f8b62883d4cbba2f1`  
		Last Modified: Wed, 21 Feb 2024 03:20:15 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
