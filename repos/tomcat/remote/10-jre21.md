...
```console
$ docker pull tomcat@sha256:31aa64f37424eef10f37c960931015819728fd5a8c80803a629ab20c0690709f
```
...
```console
$ docker pull tomcat@sha256:b27abca7d13f3248d1f4dd9105d6011ad6fcb6a74ce51f26fb223f9be60900d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.9 MB (114902815 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e9a7dd7ac80ac20aa0d5f87636f42a2fa255a75f1639fd241f62ab04f2107f5`
...
# Wed, 06 Mar 2024 14:43:12 GMT
COPY dir:d53f0ab61ced3faeb9b81b0f49f32766d7a10f5b9b63d8a36ac13b3ac1f92f88 in /usr/local/tomcat 
# Wed, 06 Mar 2024 14:43:17 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 06 Mar 2024 14:43:18 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 06 Mar 2024 14:43:18 GMT
EXPOSE 8080
# Wed, 06 Mar 2024 14:43:19 GMT
ENTRYPOINT []
# Wed, 06 Mar 2024 14:43:19 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:092bc382e8b087e4b247e2d4f740513cbe6605a01096b5c04645df76137fddf0`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0ff3c9bf97d019533119f4f6fcca8894e550f80f14f0c4c0c5359ebdc680251`  
		Last Modified: Wed, 06 Mar 2024 15:01:51 GMT  
		Size: 12.6 MB (12551707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fce49ff47e63886d08d2110cb95a1c1e069936d88b6c42e32fd25b2322955d77`  
		Last Modified: Wed, 06 Mar 2024 15:01:50 GMT  
		Size: 458.6 KB (458599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3c70f5e011436509502a5244290cc69c7fb1b5b5aa96b2a305b712ae83a51c3`  
		Last Modified: Wed, 06 Mar 2024 15:01:50 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
