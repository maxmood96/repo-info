...
```console
$ docker pull tomcat@sha256:041551142670ba07748d4a041f1c1cfac37d9252ead0cbc43b07aecb84152580
```
...
```console
$ docker pull tomcat@sha256:75eb4da8b28077391c3619413264a978d4add4cfbb9d0e24c877e2eceedd2d43
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.3 MB (111349989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2eea9d8b8d83bb7342e2ae6f5a580e8dc24544b73c89e195abc2f434a35b9dd5`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 08 Nov 2025 21:28:22 GMT
ENV TOMCAT_SHA512=a46c8e37d4767b56a16dbdd8e81b80f25ad2edd5fba68b5099b9165cfffbe32bc923a601db8bb5cba50e8b1047a7906eb8c30ca176e1c0b8dfd85fbb9c54c6c2
# Mon, 10 Nov 2025 23:23:19 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Mon, 10 Nov 2025 23:23:23 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Mon, 10 Nov 2025 23:23:24 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Mon, 10 Nov 2025 23:23:24 GMT
EXPOSE map[8080/tcp:{}]
# Mon, 10 Nov 2025 23:23:24 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:605d9b8e90a3a833c417fd9030694841ba82c6cc7b59bd0407f3a6ec2c5e5e4d`  
		Last Modified: Mon, 10 Nov 2025 23:23:44 GMT  
		Size: 14.1 MB (14105583 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2e398a94217b2d4c5c392208ee409f14efcda53da03b30660d7f1324fcfa9387`  
		Last Modified: Mon, 10 Nov 2025 23:23:43 GMT  
		Size: 232.8 KB (232778 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 10 Oct 2025 22:54:50 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:c2e10503890b782dbc98453b2f91408a82c88e5935579109d764ee16ee18a8a7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3376484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86515d082f7b54510b78f8811ffb4abfd9c439aa4f0e370829768d8153f4f1da`

```dockerfile
```

-	Layers:
	-	`sha256:4a3d271476b4e3c874b13a9d9b78bd889770d50413a107a0612b0d4d897688bd`  
		Last Modified: Tue, 11 Nov 2025 00:29:23 GMT  
		Size: 3.4 MB (3353375 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:95b9e2b6a28a43559534238e36912a1c935c92e3a105ed8b78adf6968ddb73d8`  
		Last Modified: Tue, 11 Nov 2025 00:29:24 GMT  
		Size: 23.1 KB (23109 bytes)  
		MIME: application/vnd.in-toto+json
