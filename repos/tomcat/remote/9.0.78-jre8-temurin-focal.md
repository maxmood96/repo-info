...
```console
$ docker pull tomcat@sha256:b5a90b4e1f78abe6f0250e9447c890934fdca3a1f9bafd10e1ce3c524e940302
```
...
```console
$ docker pull tomcat@sha256:2f07196becd75746a0d21480c35e9c4f3f9961cc81562a5eb0a679a8be041e02
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.1 MB (100143539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0eb9c9dff814a16c0584aad15edf19ce6f8a85b0e40974654d89de819c338d1b`
...
# Mon, 14 Aug 2023 21:57:02 GMT
COPY dir:5ffae546761b65a3f6349ef3653be79c031f551b7c03f9fb0213d2ae77edee71 in /usr/local/tomcat 
# Mon, 14 Aug 2023 21:57:06 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 14 Aug 2023 21:57:08 GMT
...
-	Layers:
	...
	-	`sha256:7ede39422df70fb2ba93a440255d430249cbf4e37b4961f7779423a176f13141`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d6aab68535cde231649d888f607036d11b4c12b5ad91172bfb2200c8f6fabcd`  
		Last Modified: Mon, 14 Aug 2023 22:11:03 GMT  
		Size: 12.3 MB (12339053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffbfc854181b92718d796564f37db0081e2b3d11736be8283b819de684ec67fa`  
		Last Modified: Mon, 14 Aug 2023 22:11:02 GMT  
		Size: 449.5 KB (449477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d2f0ec9f2bf877a7c6fbb2aa168d75ac8cc599b4cca9627e132dff7f1434cf0`  
		Last Modified: Mon, 14 Aug 2023 22:11:01 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:9.0.78-jre8-temurin-focal` - linux; arm variant v7

```console
$ docker pull tomcat@sha256:3db42aef8afa44a9378f178d30c2f22b054a52aa0be476b9761227d0c9500d8f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.5 MB (92534651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18acd60798515b3e0d0bb8e65eb6a3e8faa76d8d51fbdac32191d6ba1bcfbc05`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 18:57:25 GMT
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Mon, 14 Aug 2023 18:57:26 GMT
COPY dir:913df7c2cf46b901017c93f179c26b62dfce60ec6e349ae1bf7b43dfb47b6eb0 in /usr/local/tomcat 
# Mon, 14 Aug 2023 18:57:30 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 14 Aug 2023 18:57:31 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
...
-	Layers:
	...
	-	`sha256:f82051fc31dc8217061400b98b3fa7e989fedc26a823c5866c823aa910bc026f`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:561573aee1e5c5e254d2f2ee5b27a785dd0e526b5b74d49de4c4bbbf937e82fa`  
		Last Modified: Mon, 14 Aug 2023 19:09:46 GMT  
		Size: 12.3 MB (12289644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4203f116bf9e7eeec50b827415774368390908bca6bea39a22c03ae2ac05000`  
		Last Modified: Mon, 14 Aug 2023 19:09:45 GMT  
		Size: 427.2 KB (427191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e141879882a1313e1501e7b6e8fbcd1de04c6dc66afb6000bdf1b8ba17f60f2`  
		Last Modified: Mon, 14 Aug 2023 19:09:45 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:f2dc7de45083430397c9fa56fae47e97a180c6e86cf4ba3d31367b276513e764
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.6 MB (97625796 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70cd8e0abec36c61c44b6ffb5923e8c33f36203c4ff4dcea407015cdd477db75`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Mon, 14 Aug 2023 20:09:03 GMT
COPY dir:018a75a2b854e07b94341811ee3c96b9823ac2a2b6b3427d117c6b411d1c26a2 in /usr/local/tomcat 
# Mon, 14 Aug 2023 20:09:07 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 14 Aug 2023 20:09:08 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 14 Aug 2023 20:09:08 GMT
EXPOSE 8080
# Mon, 14 Aug 2023 20:09:08 GMT
...
-	Layers:
	...
	-	`sha256:4c1e65b5462697390cc9704a0c4a8e8050340f6fd38b5acd50dbb3bd6868f78e`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9acc67f39a3591fadffb32d64783e206ce1034fda86891d5094a7b82767ebcd0`  
		Last Modified: Mon, 14 Aug 2023 20:21:47 GMT  
		Size: 12.4 MB (12357713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:972e7ae70bebd5966c7366b3ceec3cc9860b085490069041590d9bcc97f46951`  
		Last Modified: Mon, 14 Aug 2023 20:21:46 GMT  
		Size: 450.3 KB (450349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5c3432b8fea2ea02177b230f86b974621ec35af228619441889e16e850be61b`  
		Last Modified: Mon, 14 Aug 2023 20:21:45 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:9.0.78-jre8-temurin-focal` - linux; ppc64le

```console
$ docker pull tomcat@sha256:324ada050adb87fec27c6b3ae536f366eef7d9b1499883fdbeaf9cc2b4c8bd27
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.6 MB (105609563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a387ef6318d93bee7d257ab692a950ad2ff4740ae5003cb4f62bf51acc8785de`
-	Default Command: `["catalina.sh","run"]`
...
# Mon, 14 Aug 2023 19:55:05 GMT
ENV TOMCAT_VERSION=9.0.78
# Mon, 14 Aug 2023 19:55:06 GMT
ENV TOMCAT_SHA512=c9f2e60489d07f25b53f715918f4b082c5bb69dbc497e0a9d3d5e3a0d351ff2e0ec8dfc5657de840ee5b3dea6174b27630033b38e36fa4c06b08664e70dec8df
# Mon, 14 Aug 2023 19:55:06 GMT
COPY dir:4b5a58366b8497e478f7dc7539eec34193075d7b76c80dcc918ef972da98a292 in /usr/local/tomcat 
# Mon, 14 Aug 2023 19:55:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 14 Aug 2023 19:55:19 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 14 Aug 2023 19:55:20 GMT
EXPOSE 8080
# Mon, 14 Aug 2023 19:55:20 GMT
ENTRYPOINT []
# Mon, 14 Aug 2023 19:55:21 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:f64e6629e99bbc0cb2c1d222e38ca8db9b6e0106ba8c663cf9dbf372646beaf7`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3d98375cc7b6a73ec249dd617071d755f2ed42620f35c1383b9775a39b80e46`  
		Last Modified: Mon, 14 Aug 2023 20:20:21 GMT  
		Size: 12.4 MB (12380462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d049d338112df8935085c094903fcb07a77a9ee0477a9f8f4e883f289cc6b37`  
		Last Modified: Mon, 14 Aug 2023 20:20:19 GMT  
		Size: 475.2 KB (475209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d5791c64bf5b027aaa61fec41b814967d625aff3588f57a6f1ed0ecf87ea362`  
		Last Modified: Mon, 14 Aug 2023 20:20:19 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
