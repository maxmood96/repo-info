...
```console
$ docker pull tomcat@sha256:4df26c0066bd2e655a8010866a26e5642e0f893ebd0c306d9e7b45fc2bf86863
```
...
### `tomcat:8.5.92-jdk8-temurin` - linux; amd64
...
### `tomcat:8.5.92-jdk8-temurin` - linux; arm variant v7
...
### `tomcat:8.5.92-jdk8-temurin` - linux; arm64 variant v8
...
### `tomcat:8.5.92-jdk8-temurin` - linux; ppc64le
