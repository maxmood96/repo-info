...
```console
$ docker pull tomcat@sha256:03002b275695d245f6062a2705c95f591cda410160ab214034e1f4626c11eb0b
```
...
```console
$ docker pull tomcat@sha256:ec6bccaf1d1bddb7d4e85c4995633e5fbbeafcdf10d785ead50b138e17604c5f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.4 MB (230355460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f3cd47abeed626f19d20e4095c0e75d4cad9372084170c41175f1df297852cb`
...
# Tue, 17 Aug 2021 21:27:22 GMT
ENV TOMCAT_MAJOR=10
# Tue, 31 Aug 2021 20:20:39 GMT
...
# Tue, 31 Aug 2021 20:21:31 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 31 Aug 2021 20:21:31 GMT
EXPOSE 8080
# Tue, 31 Aug 2021 20:21:32 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:4ee7b55a9808d82a1a308c849918a7f83c1ae8c5ac89cf0bd570a105fec888a0`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e0d21f2eb7ee12be2f73db3c650c098370f1cda7850ebaab2f32ce4336ed912`  
		Last Modified: Tue, 31 Aug 2021 21:29:37 GMT  
		Size: 14.8 MB (14750803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d48ce74d62c3792e4c4e80f0ef0008b106b5d53d198634258c78c1eb697c94a`  
		Last Modified: Tue, 31 Aug 2021 21:29:36 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
