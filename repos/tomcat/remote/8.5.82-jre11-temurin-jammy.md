...
```console
$ docker pull tomcat@sha256:a2744d459cc7e4a7650d1536c6be38f64eaaab43e3cd1943a0d5359a03f96338
```
...
### `tomcat:8.5.82-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:8.5.82-jre11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:8.5.82-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:8.5.82-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:8.5.82-jre11-temurin-jammy` - linux; s390x
