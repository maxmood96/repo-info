...
```console
$ docker pull tomcat@sha256:d3228a3bcd21cb292cf47d42fe0864642c5f532234f8a76b393e8d4356664b28
```
...
### `tomcat:9.0.91-jre8-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.91-jre8-temurin-jammy` - unknown; unknown
...
### `tomcat:9.0.91-jre8-temurin-jammy` - linux; arm variant v7
...
### `tomcat:9.0.91-jre8-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.91-jre8-temurin-jammy` - linux; ppc64le
