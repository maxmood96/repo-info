...
```console
$ docker pull tomcat@sha256:b8d9889858f04969b4915f4f651f34181e45944a6a2ad82f36800eac7d8351c3
```
...
```console
$ docker pull tomcat@sha256:ea06f1b5cd25ff1f7e1ecbb34f552ae18387a7f606af60c2a02bce50fb698300
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.7 MB (83735788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83d6c1cb6d1682079746243abbae5e7b50178667ce177a524fe5e6315e247d21`
...
# Tue, 12 Jul 2022 19:09:50 GMT
COPY dir:308a1232604fa1f71b33a8c255c9fc934effa21fdc86f290ec8d6c53a857525b in /usr/local/tomcat 
# Tue, 12 Jul 2022 19:09:54 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 19:09:55 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 12 Jul 2022 19:09:56 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 19:09:56 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:18293c31b074e2b20fdf3df568aab5917843b9b0e7de388420729f951100c7df`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e11a8ed2ebc8cf23b41eb67489d78ce67d0491870b245ec96fa3256976fa0b63`  
		Last Modified: Tue, 12 Jul 2022 19:38:18 GMT  
		Size: 11.2 MB (11230303 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f18bc2f5409be3242708c7c8ae1b7658f27eb50e4b814fb39bb0576b2cece51`  
		Last Modified: Tue, 12 Jul 2022 19:38:17 GMT  
		Size: 387.7 KB (387698 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b28fb18eea90730684524b8c5b73117dd2848033053bf0d3bbb51f7cd0ab7b2e`  
		Last Modified: Tue, 12 Jul 2022 19:38:17 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:1aa7173cfc3146ca013c7039789458e9498b8768e30d00600d8ad92eec0b1b81
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.2 MB (81191610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fb997eac5f6c836cec75817019419dc971ebdcac98d256da87f3a9863ba40f4`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=729387275cce4a0900289722f6c70ebcf7aee924af671b110b8ea8577fd6d045d47f17d526c8db5fd41c8590102e7f5100e95e89f7fd511b941565812ecbed35
# Tue, 12 Jul 2022 19:02:12 GMT
COPY dir:7a2d5b2f6b426b392b08297d3917e48f0bfb69ec521ce87e69cf4cb51135acf3 in /usr/local/tomcat 
# Tue, 12 Jul 2022 19:02:15 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 19:02:17 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
...
-	Layers:
	...
	-	`sha256:06c78f88573d20d5823850fd22e38725ffe08d106f6132b9e2d7ffabe0aa62d9`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dbc11ca57f031b116008a9789f680ec10eeae24ffdf192efddffc517cefa8f3`  
		Last Modified: Tue, 12 Jul 2022 19:43:48 GMT  
		Size: 11.2 MB (11246174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f370e576b8939dae863a773d141283c08024d2710c5dc10c691b678646125571`  
		Last Modified: Tue, 12 Jul 2022 19:43:46 GMT  
