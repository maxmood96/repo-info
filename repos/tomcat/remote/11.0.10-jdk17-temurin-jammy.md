...
### `tomcat:11.0.10-jdk17-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.10-jdk17-temurin-jammy` - unknown; unknown
...
### `tomcat:11.0.10-jdk17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.10-jdk17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.10-jdk17-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.10-jdk17-temurin-jammy` - linux; s390x
