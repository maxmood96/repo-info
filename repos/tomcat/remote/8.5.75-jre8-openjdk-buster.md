...
```console
$ docker pull tomcat@sha256:0974ab273eb2b9637fd366844a4ce115b65a66a787453b0eab4eea111fa338a3
```
...
### `tomcat:8.5.75-jre8-openjdk-buster` - linux; amd64

```console
$ docker pull tomcat@sha256:15c9da008de452777ca42bcec8b924d556fd4e441e4b6c89225319b5f211bcea
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.9 MB (126887641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f662691209e6cc0bd6221be8926c34bcc0ccbdc9a198410be0b4641eebabbb3d`
...
# Fri, 04 Feb 2022 02:04:17 GMT
COPY dir:069a9c295451c064257ed74e2a6ea9c9cce2c5f5ad637bc364c22a241f83976f in /usr/local/tomcat 
# Fri, 04 Feb 2022 02:04:21 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 02:04:24 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 04 Feb 2022 02:04:24 GMT
EXPOSE 8080
# Fri, 04 Feb 2022 02:04:25 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:dcaf928fa8f068e2481ffb0905ac05a5e3cf5fb4d337a78e27c39365a220cabc`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40a1eea7c895f797456af47cc645ad95c6e88bb74af4179008c14a4e537765f9`  
		Last Modified: Fri, 04 Feb 2022 04:17:59 GMT  
		Size: 11.2 MB (11231834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3119bb3ba6f8f58fbc6b9051ac8348202fd9c325c076a301f6c7eb150e73ab6d`  
		Last Modified: Fri, 04 Feb 2022 04:17:58 GMT  
		Size: 460.9 KB (460912 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:723153e03b5a3a1c5b4a9b75a51e9ed0b2c17b2e2ea7803f10eac6475f6dd070`  
		Last Modified: Fri, 04 Feb 2022 04:17:58 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.75-jre8-openjdk-buster` - linux; arm64 variant v8

```console
$ docker pull tomcat@sha256:6a428fa62069aba32d877bb6d6c1d4606b2846c5aa0abf950cdc4f1f2c2c5323
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.3 MB (124315463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a74626e2d5972ff7cc0e2bf5f897e41fb96a5ec5db6b8341dd44187c7b0c614`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=8
# Fri, 04 Feb 2022 01:23:46 GMT
ENV TOMCAT_VERSION=8.5.75
# Fri, 04 Feb 2022 01:23:47 GMT
ENV TOMCAT_SHA512=b86d191506f8a647e3f4505bb7cc095068abb26bb4283562924913606514ce15930a467bd5d20c09b11d785827bf1914ed869b48dfb1c95e9f826e4c8b4e8aaa
# Fri, 04 Feb 2022 01:23:49 GMT
COPY dir:5b1ef413dcabb678e94809c22ada1834aa3a8750d1b831ac55d9525b896552ed in /usr/local/tomcat 
# Fri, 04 Feb 2022 01:23:52 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 01:23:54 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 04 Feb 2022 01:23:55 GMT
EXPOSE 8080
# Fri, 04 Feb 2022 01:23:56 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3c69389b562a93be0c7b03e7346b20d7d914b891b12f764db72e19220cfe5416`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1042a20de9870492d615b52656d00b30f64b3133b911777a36d024a2d5cd8fdc`  
		Last Modified: Fri, 04 Feb 2022 02:11:50 GMT  
		Size: 11.2 MB (11246226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4197c8ad520c275f185a5f4f0d26a35957fa1c5b18131de0e2a8528d93aace0`  
		Last Modified: Fri, 04 Feb 2022 02:11:50 GMT  
