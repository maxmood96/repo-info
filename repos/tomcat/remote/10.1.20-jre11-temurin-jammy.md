...
```console
$ docker pull tomcat@sha256:baa8fa147db483d3f441f9cbafea56568b94e1916dcbd93dcc7eab7c2e2619cd
```
...
### `tomcat:10.1.20-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.20-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.20-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.20-jre11-temurin-jammy` - linux; s390x
