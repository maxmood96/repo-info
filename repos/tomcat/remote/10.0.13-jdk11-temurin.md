...
### `tomcat:10.0.13-jdk11-temurin` - linux; arm variant v7
...
### `tomcat:10.0.13-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:10.0.13-jdk11-temurin` - linux; ppc64le
...
### `tomcat:10.0.13-jdk11-temurin` - linux; s390x
