...
```console
$ docker pull tomcat@sha256:21aff057da72bca1c03e692ce8f767b53512bd91dec4d5d52fb33f0884e61b74
```
...
```console
$ docker pull tomcat@sha256:ad67f118181f1477584fcdda54caf2aa5fee1437d3e5b867a5e759b1fe9bb108
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.1 MB (242053535 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:768d0a274c19ebf3adf4578f65859fe8500f8a806fdc479921c6410a143fc24d`
...
# Fri, 11 Sep 2020 04:23:16 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 11 Sep 2020 04:23:16 GMT
EXPOSE 8080
# Fri, 11 Sep 2020 04:23:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2dcc388f7238ba15dfe2b311935aa8d071f12bb34c77aca619fff36b65444d31`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c8e54d73cf7bba39d90313c5181fd5210f38d96411a2f1a9387e866c7977e2`  
		Last Modified: Fri, 11 Sep 2020 04:34:44 GMT  
		Size: 12.2 MB (12247336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2baf3d921e6057bdd0ee4c85d8ce2397d740c15da056815cee20a7d222e8d0f9`  
		Last Modified: Fri, 11 Sep 2020 04:34:43 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
