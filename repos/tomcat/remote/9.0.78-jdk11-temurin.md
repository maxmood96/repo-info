...
```console
$ docker pull tomcat@sha256:42191825047e40dc0e0bc61aae582de1cd9b371f8b816766bc6e0b4f610b183b
```
...
```console
$ docker pull tomcat@sha256:1f771632f0a01844ac7d789bea72f6383cedbfb369c857fb71be1cf1c7663a92
```
...
-	Image ID: `sha256:540c3ff6bbc925c832e345e2ba4d7fecb0956b1147f3cb83b6875a7e3203b1ca`
...
```console
$ docker pull tomcat@sha256:0376bee0cd82d959dc95cdc3ac5665684addfe523a3503047adf026719908f11
```
...
-	Total Size: **195.4 MB (195369401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b4ef3006d1be3962e8e155185826bcb93eb4a2edc50ee8c80fda9bcd432bcf8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
