...
```console
$ docker pull tomcat@sha256:b4aa82a9ec0bd33c5016aed0f450055e67999eec5ab70990ee3757328259671a
```
...
### `tomcat:9.0.71-jre11-temurin-jammy` - linux; amd64
...
### `tomcat:9.0.71-jre11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:9.0.71-jre11-temurin-jammy` - linux; ppc64le
...
### `tomcat:9.0.71-jre11-temurin-jammy` - linux; s390x
