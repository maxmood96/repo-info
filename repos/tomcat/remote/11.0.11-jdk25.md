...
### `tomcat:11.0.11-jdk25` - linux; amd64
...
### `tomcat:11.0.11-jdk25` - unknown; unknown
...
### `tomcat:11.0.11-jdk25` - linux; arm64 variant v8
...
### `tomcat:11.0.11-jdk25` - linux; ppc64le
...
### `tomcat:11.0.11-jdk25` - linux; riscv64
...
### `tomcat:11.0.11-jdk25` - linux; s390x
