...
```console
$ docker pull tomcat@sha256:74a1bd94f82c664f916d38a8ef0d83c34a4e76e2d8005a64bbcfe292522ae13d
```
...
### `tomcat:9.0.107-jre8` - linux; amd64
...
### `tomcat:9.0.107-jre8` - unknown; unknown
...
### `tomcat:9.0.107-jre8` - linux; arm variant v7
...
### `tomcat:9.0.107-jre8` - linux; ppc64le
