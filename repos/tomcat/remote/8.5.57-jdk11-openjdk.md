...
```console
$ docker pull tomcat@sha256:d73676b797a33bd3e925d8473cdd63c0bf68c49cff582fde79b4ef9c781c3d0d
```
...
```console
$ docker pull tomcat@sha256:1bb8c8558ef715ad5fadaafd864b3431c320e2c077eaec11367e23e3cf81073d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.0 MB (332964236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d21146b8d441c67997f3ef747599f2bdae34c2106114cca2024cca2e97b2412`
...
# Wed, 05 Aug 2020 19:27:12 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Aug 2020 19:27:12 GMT
EXPOSE 8080
# Wed, 05 Aug 2020 19:27:13 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:586534165c2f0913973ee10cd595efeff5a5b4bc8367a2114ee4c3183a38a558`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb93f1c334c591e25fa4d34aa221eb5f82cc3338d6502a8f4d5044658b5cd538`  
		Last Modified: Wed, 05 Aug 2020 19:35:44 GMT  
		Size: 11.4 MB (11396481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ce3963f00e0c4d65c705fe7a81bc5f8d288bc1cc493f2f94dc16ae3c8fec219`  
		Last Modified: Wed, 05 Aug 2020 19:35:43 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
