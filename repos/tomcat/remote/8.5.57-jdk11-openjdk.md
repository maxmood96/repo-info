...
```console
$ docker pull tomcat@sha256:7454df538a6ae7d972d20ee148d89e23d89ff5d8b6f44d6a6bd3e72d432eb95e
```
...
```console
$ docker pull tomcat@sha256:e67f09fec9d398c334fe58d7d3117612019cd2dfbf1e6070260ebd235d8d7ec0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.0 MB (332964152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13d7395eb0a950a037aaa9dae59070c4b57c9855908ffc7ac67b19a04431dfe1`
...
# Fri, 11 Sep 2020 04:27:56 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 11 Sep 2020 04:27:57 GMT
EXPOSE 8080
# Fri, 11 Sep 2020 04:27:57 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:48ee8bc64dbc95eb00ed65280f8930c335f486bd464dc49399ba6701da40207b`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0748d5262965cebea9d4e1fb60a44865809d78624d88b167adebc56160466cb3`  
		Last Modified: Fri, 11 Sep 2020 04:36:40 GMT  
		Size: 11.4 MB (11396709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4def6db04ff0d879f3b7869a7357fc6d43077114e94f9865db1d3c0fb17909fe`  
		Last Modified: Fri, 11 Sep 2020 04:36:37 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
