...
```console
$ docker pull tomcat@sha256:944ae78b11842a81aad8c2a31200159e6e438e10bfc08ed9d4e5552b563a55bd
```
...
### `tomcat:10.1.5-jdk17-temurin` - linux; amd64
...
### `tomcat:10.1.5-jdk17-temurin` - linux; arm variant v7
...
### `tomcat:10.1.5-jdk17-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.5-jdk17-temurin` - linux; ppc64le
...
### `tomcat:10.1.5-jdk17-temurin` - linux; s390x
