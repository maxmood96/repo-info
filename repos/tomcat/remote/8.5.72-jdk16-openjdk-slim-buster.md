...
```console
$ docker pull tomcat@sha256:8d8db43799060797b5a8411fec96997861596410ace38b8f76c3446288029f9c
```
...
### `tomcat:8.5.72-jdk16-openjdk-slim-buster` - linux; amd64
...
### `tomcat:8.5.72-jdk16-openjdk-slim-buster` - linux; arm64 variant v8
