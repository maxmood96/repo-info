...
```console
$ docker pull tomcat@sha256:868a53fb9a1940f9e719367faa7ac48a79a5a972c3af2aba0055945933c7bf14
```
...
```console
$ docker pull tomcat@sha256:273cb87794be8f20420bcbc3008aa8b6f055f03412f65694e7c91a02392d174a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.4 MB (103411968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c7a548eb63ddb8393d355172ae233b8616ab0500a7ab7031137b91ac99b081d`
...
# Thu, 02 May 2024 06:59:43 GMT
COPY dir:d195723e23c73cd52ac122d5a50e336c8607982fd35d5250f9e34e17a991388e in /usr/local/tomcat 
# Thu, 02 May 2024 06:59:47 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 02 May 2024 06:59:48 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 02 May 2024 06:59:49 GMT
EXPOSE 8080
# Thu, 02 May 2024 06:59:49 GMT
ENTRYPOINT []
# Thu, 02 May 2024 06:59:49 GMT
...
-	Layers:
	...
	-	`sha256:55614dadd1ab5a5496f658762e14010c4ca88c3d0718ece860633735d79e3966`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd68e94795b0f721a55a04fbd82f34f8055218ac78a2fe7712c4e64e3c55eeb4`  
		Last Modified: Thu, 02 May 2024 07:10:52 GMT  
		Size: 12.4 MB (12423113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c3156f9eda56af3c1d21e0b998a685d7a29f64d8a1ba2976e373a5503c12a0f`  
		Last Modified: Thu, 02 May 2024 07:10:51 GMT  
		Size: 456.3 KB (456286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9469f757a5147da9058ecdcb70ef6c673afb04d8694908bb899977100f08e61b`  
		Last Modified: Thu, 02 May 2024 07:10:50 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
