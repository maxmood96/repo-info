...
```console
$ docker pull tomcat@sha256:5e90f7e787b74e8abc1c248519c6490cedb7a1e3412cc6648cc7151085d5bfaf
```
...
### `tomcat:9.0.55-jdk16-temurin-focal` - linux; amd64
...
### `tomcat:9.0.55-jdk16-temurin-focal` - linux; arm variant v7
...
### `tomcat:9.0.55-jdk16-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.55-jdk16-temurin-focal` - linux; s390x
