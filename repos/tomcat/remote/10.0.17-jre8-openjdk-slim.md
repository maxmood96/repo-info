## `tomcat:10.0.17-jre8-openjdk-slim`

```console
$ docker pull tomcat@sha256:c56219625941024ec6aee595302e3f1560f10dcfff8ba9eafc3d7977b9932c38
```
...
### `tomcat:10.0.17-jre8-openjdk-slim` - linux; amd64
