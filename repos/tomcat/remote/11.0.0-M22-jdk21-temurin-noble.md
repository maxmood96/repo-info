...
### `tomcat:11.0.0-M22-jdk21-temurin-noble` - linux; amd64
...
### `tomcat:11.0.0-M22-jdk21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:11.0.0-M22-jdk21-temurin-noble` - linux; s390x
