...
```console
$ docker pull tomcat@sha256:e9e1d0c18ca5640153f4df5939fc92d749113219e4addcf12411ecc9fc7b783f
```
...
```console
$ docker pull tomcat@sha256:ebea97e8fde87d8ed2456bdbde7b519e1c487437689a14e5f73baeda57bcfeb8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.4 MB (345384467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a5392ea5abfefea70391ca8de23899d1ec28368a9840b099327ec59759ba899`
...
# Wed, 05 Aug 2020 19:21:35 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 05 Aug 2020 19:21:35 GMT
EXPOSE 8080
# Wed, 05 Aug 2020 19:21:36 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0a7e05df4cb79eea80a82dc48ca339f92505441a2bdae2fa663759c027ba1b1e`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c46a059758e6b8f1d664f79a3198aacadf9430e6b4816b3fde81ed1fa7ca9b18`  
		Last Modified: Wed, 05 Aug 2020 19:34:03 GMT  
		Size: 12.2 MB (12226845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36f2f2ae4673778b9eb4b0a9e066e07f4d60087724834b0a2db48ab0a90b321f`  
		Last Modified: Wed, 05 Aug 2020 19:34:02 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
