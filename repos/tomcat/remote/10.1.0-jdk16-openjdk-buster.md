...
```console
$ docker pull tomcat@sha256:e797ca1c2bf242ef61c58d9ccf239ff5721b4dbce783149c6df10a42e854a522
```
...
```console
$ docker pull tomcat@sha256:fb7138740ffe8363a112c8e3daece1a9686e4079f0c3351d2e7ae0562768aa03
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.8 MB (331781875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05123bd138e7a31e0307a4be7e0fd9fde3c7ec908186add967ba3799cee1fd68`
...
# Wed, 29 Sep 2021 11:11:56 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 29 Sep 2021 11:11:56 GMT
EXPOSE 8080
# Wed, 29 Sep 2021 11:11:57 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3cc7bed7b0d5383f601c7fa40658a44761dda6c0bbb2e6498b11b690892f68db`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6244b44076605a2fcbefc011ba107b3699d2d7a531844fe2913a2eb4bf31b992`  
		Last Modified: Wed, 29 Sep 2021 12:21:49 GMT  
		Size: 12.8 MB (12830472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:915556cd739cc346165f5e39b8b8302160cd868d033fffc1522dae310f2f76e8`  
		Last Modified: Wed, 29 Sep 2021 12:21:47 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
