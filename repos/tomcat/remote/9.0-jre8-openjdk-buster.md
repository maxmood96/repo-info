...
```console
$ docker pull tomcat@sha256:dac7d20b66d1359e8bd572dd7c3291030a4436113ae1f08c669270a9d5325d91
```
...
```console
$ docker pull tomcat@sha256:149a613f08a38a1005d7a0b2d5bca4699eecd3f9a078ce1631537b2200a5254d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.9 MB (127938077 bytes)**  
...
# Tue, 12 Jul 2022 19:01:24 GMT
COPY dir:ed8560cb052bbbda639660aa78e6b010f6dd6e2b8aacf23f7df57cd3b3ea271b in /usr/local/tomcat 
# Tue, 12 Jul 2022 19:01:28 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 19:01:30 GMT
...
-	Layers:
	...
	-	`sha256:c48407caa7543c4ded54ec9edbbdf0b78564f4f281af794892c232b185ece517`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04cadde09750329c2ab8b72bdb34c12476bedbc3e90f7a2f1ab589cde113af9e`  
		Last Modified: Tue, 12 Jul 2022 19:31:45 GMT  
		Size: 12.2 MB (12216274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a85572e7259644aafa37b86236bcce006074adf47560dd41c4bce053312da059`  
		Last Modified: Tue, 12 Jul 2022 19:31:45 GMT  
		Size: 460.9 KB (460932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca49ea660c7be1044768d05cc445e472c40112f35db8c9678f9fe5577d37750b`  
		Last Modified: Tue, 12 Jul 2022 19:31:44 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:da2f08826fdfa36b242a77b2c587def9e65ad836a8475f8b1ff8908ff541b2db
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.3 MB (125345438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa7cdc04856569ad92609a5e1a0be0299f6ccba24f1dce349782e23cd528da2e`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=38392b651fabe706fb0524c52849601299494178010bb8077af383232c20bbbda1aec4ab8898adb2cc37c07583ff0e9d3c7038ce55a22bc68c3641641b47fd1a
# Tue, 12 Jul 2022 18:50:17 GMT
COPY dir:bb2ea43843bf23fa77b11570d5dabd334fd3e7ca0be0d1f68c278d1a78471e11 in /usr/local/tomcat 
# Tue, 12 Jul 2022 18:50:20 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 18:50:22 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 12 Jul 2022 18:50:23 GMT
EXPOSE 8080
# Tue, 12 Jul 2022 18:50:24 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:69c84b262e5ff488c2a7371ecdc676f3d1de32dd7c598b453032a1db1a4f10b1`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10a77b63b1ecf83f06532443e0b31c4ce92afe928eab0d0777528cf534565713`  
		Last Modified: Tue, 12 Jul 2022 19:36:01 GMT  
		Size: 12.2 MB (12230193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f719fd0212c181f5edb5ed77d1e25ac017bdae3fdab31bea8683e93cbceab36`  
		Last Modified: Tue, 12 Jul 2022 19:36:00 GMT  
