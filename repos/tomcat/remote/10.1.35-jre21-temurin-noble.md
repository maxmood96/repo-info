## `tomcat:10.1.35-jre21-temurin-noble`

```console
$ docker pull tomcat@sha256:d5b48da3867357925f8022b867a4e8a4a3927bdc1e75a317153da14f4b84a3fa
```
...
### `tomcat:10.1.35-jre21-temurin-noble` - linux; amd64
...
### `tomcat:10.1.35-jre21-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.35-jre21-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.35-jre21-temurin-noble` - linux; riscv64
...
### `tomcat:10.1.35-jre21-temurin-noble` - linux; s390x
