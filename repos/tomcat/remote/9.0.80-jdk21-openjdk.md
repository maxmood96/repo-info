## `tomcat:9.0.80-jdk21-openjdk`

```console
$ docker pull tomcat@sha256:59874308973c4824661571b48eafe94b53ad3518bb7b95cdd4e5902714c50b43
```
...
### `tomcat:9.0.80-jdk21-openjdk` - linux; amd64
...
### `tomcat:9.0.80-jdk21-openjdk` - linux; arm64 variant v8
