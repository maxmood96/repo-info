...
### `tomcat:9.0.102-jdk8-temurin-noble` - linux; amd64
...
### `tomcat:9.0.102-jdk8-temurin-noble` - unknown; unknown
...
### `tomcat:9.0.102-jdk8-temurin-noble` - linux; arm variant v7
...
### `tomcat:9.0.102-jdk8-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:9.0.102-jdk8-temurin-noble` - linux; ppc64le
