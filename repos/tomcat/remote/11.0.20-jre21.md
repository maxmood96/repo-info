...
```console
$ docker pull tomcat@sha256:a800773f357da9f6be2bd0ddcfd58c8fa53bb04db15a3e317c782bc5118b49bd
```
...
### `tomcat:11.0.20-jre21` - linux; amd64
...
### `tomcat:11.0.20-jre21` - unknown; unknown
...
### `tomcat:11.0.20-jre21` - linux; arm64 variant v8
...
### `tomcat:11.0.20-jre21` - linux; ppc64le
...
### `tomcat:11.0.20-jre21` - linux; s390x
