...
```console
$ docker pull tomcat@sha256:051e72a2a2856efdc41065f478ad198aefc4c4d308a7b06be70be9e43c771ef2
```
...
```console
$ docker pull tomcat@sha256:a70209806555b36ff122952a23b0b4ac94497a8c65f566bedfbf3b3913c49c5d
```
...
-	Image ID: `sha256:d151df10e1ebe96d24be1b5ec32e85c85d7d68de6932d2b81a796a59d7323472`
...
```console
$ docker pull tomcat@sha256:aaa1914d5fd88898380b91b1ad0ec97595808b6c958770b2ac96f9795c80a373
```
...
-	Total Size: **189.4 MB (189432566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:daee0656c2e79c258a0e13d38d5a9523bba68c3c753f9a2d0f29fc0a3d1ed3c8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:42833951cd7f2d3cd6fe7eaf20347576cc73345fc46a5539ed6baed9c887b8c1
```
...
-	Total Size: **195.4 MB (195442010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2da538c070f09305143870c42f2587c419b2c7790b1e85e23814663d8ddca2f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
```console
$ docker pull tomcat@sha256:5129e192a35f3349059b9250384c6919d86196222de073e27356e7bc77242370
```
...
-	Total Size: **180.7 MB (180657475 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92047a3f98d643aabeb0fad5475e1b19da572a93e2ffd8ed00c2d2e59e3c6c3e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
