...
```console
$ docker pull tomcat@sha256:e447ec536371b9815bb439d1ce41a85639cb732145891f674a3f6713edb011fd
```
...
### `tomcat:9.0.63-jdk11-temurin` - linux; amd64
...
### `tomcat:9.0.63-jdk11-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.63-jdk11-temurin` - linux; ppc64le
...
### `tomcat:9.0.63-jdk11-temurin` - linux; s390x
