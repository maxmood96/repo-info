...
```console
$ docker pull tomcat@sha256:89ed282be89defad466382bf2add60d14791c62a88c10d920c85aa852adb9b16
```
...
### `tomcat:9.0.58-jdk11-temurin-focal` - linux; amd64
...
### `tomcat:9.0.58-jdk11-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:9.0.58-jdk11-temurin-focal` - linux; ppc64le
...
### `tomcat:9.0.58-jdk11-temurin-focal` - linux; s390x
