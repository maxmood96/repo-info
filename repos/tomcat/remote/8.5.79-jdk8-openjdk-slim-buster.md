...
```console
$ docker pull tomcat@sha256:8be0bc0b938566781368dec164af24be7efb310e95fe8702047ba67056b38fcb
```
...
### `tomcat:8.5.79-jdk8-openjdk-slim-buster` - linux; amd64

```console
$ docker pull tomcat@sha256:786319572347658bbceb205bf3f9c0634bf839fc1f78e5b5c54b232c899b181d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.3 MB (148266431 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca8dec37521fcafad560b89f71506a78e2b0fccf48ef702e97a2f6be6646a09c`
...
# Sat, 28 May 2022 22:06:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 28 May 2022 22:06:17 GMT
EXPOSE 8080
# Sat, 28 May 2022 22:06:17 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:7df23f14a7b2aaf3f7359041356d2c3976f2bddab6cbc8c61db6b77d7e9e8cd1`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7a841da43364e3b3b295bb92cf62a6d0064bc5ef093c4a970fe2913e292d7d1`  
		Last Modified: Sat, 28 May 2022 22:34:55 GMT  
		Size: 11.6 MB (11623769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f82598b8d676e606576f82a81b55f59d2b82313131a6cdb7ee843196e061a434`  
		Last Modified: Sat, 28 May 2022 22:34:54 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:8.5.79-jdk8-openjdk-slim-buster` - linux; arm64 variant v8
