...
```console
$ docker pull tomcat@sha256:722ced65591cbf1e7a83557079c8c59620ab1e1468e7c0ee02e1b1cde3f2309b
```
...
```console
$ docker pull tomcat@sha256:0a5af562ffdf8a2dfb918eeebc552fbf761b0384293410828ae0d0451ab7d67e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.8 MB (100828570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cfa0e38debebdba0eed086117bc772747818dfa2ad36a8b691cc159ec2e8a9c`
...
-	Layers:
	...
	-	`sha256:aace950ad619b2b4827052362b07ef2c57ba11dc68dd27225785522f1158c860`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae76a2fd3be93682add21fe163b80476215f016824da423ebad67a1f7df7a2b1`  
		Last Modified: Wed, 27 Oct 2021 01:29:56 GMT  
		Size: 12.6 MB (12559434 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa39b5aaccc8d3aae3a1c9cd6407116f3c700d09fca34f275b6407f8285a1f67`  
		Last Modified: Wed, 27 Oct 2021 01:29:54 GMT  
		Size: 445.6 KB (445639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e97aec080b9dbfaa516dd5819ed946cc2a0204341a2a98984109a366dedac68d`  
		Last Modified: Wed, 27 Oct 2021 01:29:54 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:5180e37f20cade8d51a1a89f01f9dc2e4818952421e89826449e7013277f2ce4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.7 MB (93730196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25d0652b080ea2e628d287819b71f152100f52411175a615dcfe5e9e2464dcbe`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=e084fc0cc243c0a9ac7de85ffd4b96d00b40b5493ed7ef276d91373fe8036bc953406cd3c48db6b5ae116f2af162fd1bfb13ecdddf5d64523fdd69a9463de8a3
# Sat, 16 Oct 2021 04:14:36 GMT
COPY dir:094b9e6f35858e7090f2d5a0801f333898da33d0a512cc2fb8f644b86793e093 in /usr/local/tomcat 
# Sat, 16 Oct 2021 04:14:45 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:35da13bec386fd4cda866c8ecca298229ca2cbd25ced17fa6d4b3233de51b423`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1175640992faf1cda49de450dbbbb758d25d624c6cd2b387c4211bb0267dfc1`  
		Last Modified: Sat, 16 Oct 2021 04:36:41 GMT  
		Size: 12.5 MB (12508969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:646ba7ea83750a02e7a1a6fc26856d9cd9f9339554dc291b94c776900df53ffe`  
		Last Modified: Sat, 16 Oct 2021 04:36:36 GMT  
		Size: 422.4 KB (422393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:741ea4af0e40b769f60a611fe640a989fd2d2db46c4c0aeb40840b748c902fe0`  
		Last Modified: Sat, 16 Oct 2021 04:36:36 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:db984bb0a7f583517e4c661cad50400f6ba03c012f4bbb9a7192df69eaf6f810
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.4 MB (97370028 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fdb74d517fc4f045b1e92777d6c29e4375ec35b7a729bd8f08ccb52489d3273`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Sat, 16 Oct 2021 12:23:35 GMT
ENV TOMCAT_VERSION=10.0.12
# Sat, 16 Oct 2021 12:23:36 GMT
ENV TOMCAT_SHA512=e084fc0cc243c0a9ac7de85ffd4b96d00b40b5493ed7ef276d91373fe8036bc953406cd3c48db6b5ae116f2af162fd1bfb13ecdddf5d64523fdd69a9463de8a3
# Sat, 16 Oct 2021 12:23:38 GMT
COPY dir:e40423e49fda8e340f3048d4ecabddcc022b622ade08fb0321b1b4954befc64b in /usr/local/tomcat 
# Sat, 16 Oct 2021 12:23:43 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Oct 2021 12:23:45 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 16 Oct 2021 12:23:46 GMT
EXPOSE 8080
# Sat, 16 Oct 2021 12:23:47 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:75b37d3234f5f380ee776df02ff38ee03d55e693bf68125101cf402d5f21b518`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f926560065cccbe816ffd1e3ed5f7186add160fd2b64fa9ace2f35fa8ba25746`  
		Last Modified: Sat, 16 Oct 2021 13:26:45 GMT  
		Size: 12.6 MB (12575818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57c025c1cfa45b9b6796ec546be1781f0247ce4bc18c52393734205d0625f464`  
		Last Modified: Sat, 16 Oct 2021 13:26:43 GMT  
...
```console
$ docker pull tomcat@sha256:e7f0a24e93085966c8705602940e36a9d7de920a449c6268b580f9b935189497
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.2 MB (102192296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad5885dd52bbabdc891cd01e059a9aa01c945d0581788cf2b4a4c61c3aa00dd5`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=e084fc0cc243c0a9ac7de85ffd4b96d00b40b5493ed7ef276d91373fe8036bc953406cd3c48db6b5ae116f2af162fd1bfb13ecdddf5d64523fdd69a9463de8a3
# Sat, 16 Oct 2021 03:56:17 GMT
COPY dir:922cc88bc6b7a182e187067b745947fdc5c9a26eecc8eeff2efcc78cb1c9e122 in /usr/local/tomcat 
# Sat, 16 Oct 2021 03:56:39 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Oct 2021 03:56:52 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
...
-	Layers:
	...
	-	`sha256:33058999b653d35d5dd1ba6ae60b23bcf33e7e4700c7d0ea03b5952c243605d9`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f649bbdd65e86cd0edea28a25bc9303dac3ed49c86ba871adf6f7d797f89dc51`  
		Last Modified: Sat, 16 Oct 2021 05:06:07 GMT  
		Size: 12.6 MB (12598870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39b7df36bfd9d00e5c2cd305a93ca04b88a38d11627e3b541293ca9b32c73e34`  
		Last Modified: Sat, 16 Oct 2021 05:06:06 GMT  
		Size: 471.4 KB (471383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cbf1a6cab5b6c2b888120be515bb7abc0c853649ea7d3c4f858cc876772f079`  
		Last Modified: Sat, 16 Oct 2021 05:06:06 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:389e6582a36dc9b7b1a75314e5ec08360d88b284b491657992c45c1ac687b3f6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.4 MB (93446033 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24a20c1b97639dd0439db82e78d79f2085d0c7dee1612eb553764f3ab075eb70`
-	Default Command: `["catalina.sh","run"]`
...
# Sat, 16 Oct 2021 01:35:57 GMT
ENV TOMCAT_SHA512=e084fc0cc243c0a9ac7de85ffd4b96d00b40b5493ed7ef276d91373fe8036bc953406cd3c48db6b5ae116f2af162fd1bfb13ecdddf5d64523fdd69a9463de8a3
# Wed, 27 Oct 2021 01:18:33 GMT
COPY dir:1c027cfcab78fb2dde2a6029ebcb5b59cc955dc617eb17968e904f5de369f695 in /usr/local/tomcat 
# Wed, 27 Oct 2021 01:18:36 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 27 Oct 2021 01:18:37 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 27 Oct 2021 01:18:38 GMT
EXPOSE 8080
# Wed, 27 Oct 2021 01:18:38 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:971ce99f351b1c125f6ab87dd8e0879116d05ca11e309a0d478c2db4452bbd2d`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:254d1319774dd321daf8e9f9058aec84f80d30c66f5c2cd9b1c2f711234ad5e0`  
		Last Modified: Wed, 27 Oct 2021 01:25:00 GMT  
		Size: 12.6 MB (12571341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917255022ffd6291e5d3b7861b8af81fcf7209efed946c9e63a9120fc14cb2bf`  
		Last Modified: Wed, 27 Oct 2021 01:24:59 GMT  
		Size: 446.8 KB (446772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aba0e4d714ed02678f58a70c7509948c7d3ec35f47c160859bee3e14eb7c02f3`  
		Last Modified: Wed, 27 Oct 2021 01:24:59 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
