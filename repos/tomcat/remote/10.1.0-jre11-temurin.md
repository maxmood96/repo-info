...
```console
$ docker pull tomcat@sha256:c911d41d3bb4e217cc68835c056e2978f62140944f4ff7dbfaf060e50031d5da
```
...
```console
$ docker pull tomcat@sha256:a63559b503ae39642089b89f32b00da1e487bf3e18be31b550581fa4aaaf347f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.6 MB (97569858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:660fa4071fbf7f58cf7842d091f3b78c16da6dedc31b1340b94d62ad4a3c0cb4`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 01 Oct 2021 06:30:28 GMT
ENV TOMCAT_MAJOR=10
# Wed, 06 Oct 2021 18:51:08 GMT
ENV TOMCAT_VERSION=10.1.0-M6
# Wed, 06 Oct 2021 18:51:08 GMT
ENV TOMCAT_SHA512=3a8219dd39dcc4ab22489244d60ccf123c2a4fed89a7813474b2dad095416b5e2a22c806618c235d004e16ce429496f13461c876d3bce1ce6bb642a99193af31
# Wed, 06 Oct 2021 18:51:09 GMT
COPY dir:e521d80a410d4d1865e6c775dfe2363051ec601b6c8c119c9e84b135f3b10ac6 in /usr/local/tomcat 
# Wed, 06 Oct 2021 18:51:14 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 06 Oct 2021 18:51:16 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 06 Oct 2021 18:51:16 GMT
EXPOSE 8080
...
-	Layers:
	...
	-	`sha256:8327b77f45d819d7c2beb6b1cd3664b11e0637de552f507d3831c6a8ae2769f0`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51d81192cac8fa2a5b13fa8a151c1afd5c6d1667394e652a35084606da03cbb5`  
		Last Modified: Wed, 06 Oct 2021 20:01:53 GMT  
		Size: 12.5 MB (12537168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52a5864b1672a2c32954220c907926ec9bcd76d58fbf3e223dc50bb3d8c02278`  
		Last Modified: Wed, 06 Oct 2021 20:01:52 GMT  
		Size: 446.2 KB (446233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3121ee2ac51475eeed440e628f9b1c14efd017518fc01897d9faed8802a4494`  
		Last Modified: Wed, 06 Oct 2021 20:01:52 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
