...
```console
$ docker pull tomcat@sha256:296bbd72c8d5497ec59cbdbdfd5af8288ca51e93a1ed2bf045e801ff07a05564
```
...
```console
$ docker pull tomcat@sha256:5bf7e7a38ddc6b5104f15a70320c10982edee0e1e0f7d24c0f4b6a9d9796240d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.5 MB (97538968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72fbad7dd78e41ca8c62e72b9bad044c2b2e8a18e97edfa4707e5dc4ad25961b`
-	Default Command: `["catalina.sh","run"]`
...
# Wed, 22 Sep 2021 20:10:47 GMT
ENV TOMCAT_VERSION=10.1.0-M5
# Wed, 22 Sep 2021 20:10:48 GMT
ENV TOMCAT_SHA512=fbc0721794f7d604b9036f67b995f31d541aee0eddc4d911274f0af2a13b264b2435450946192628efdef035eef50adcd929752fae8ca50dbb07b53e36e1bd48
# Wed, 22 Sep 2021 20:10:48 GMT
COPY dir:26659616e7fba8fbd02e46c871deb68ba74b248bb5a3b3625d77bc8b50e66fda in /usr/local/tomcat 
# Wed, 22 Sep 2021 20:10:54 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 22 Sep 2021 20:10:55 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 22 Sep 2021 20:10:56 GMT
EXPOSE 8080
# Wed, 22 Sep 2021 20:10:56 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:2afec31c5638c3c70f8d30f5aa37551bbbd6cdf2c67296ff102be8562d763e64`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ddf312a98ea711ade9bfd9b96ba8a4f5cbd5e34a934c279ef1c7576b14a0972`  
		Last Modified: Wed, 22 Sep 2021 20:46:34 GMT  
		Size: 12.5 MB (12503278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eb6817d68b442c5f778ece57ff62b69b469218182dfca59153999ea5d7d0b7a`  
		Last Modified: Wed, 22 Sep 2021 20:46:32 GMT  
		Size: 446.2 KB (446159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73566b7b996a96c21fadc7e806400d5555c651a6de3ae6698c26da5780c915ee`  
		Last Modified: Wed, 22 Sep 2021 20:46:32 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
