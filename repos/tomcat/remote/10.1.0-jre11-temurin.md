...
```console
$ docker pull tomcat@sha256:c3c7f555ce9d02b6c5f304735bf42205d2768fd42b7bc2f728ebaabd178613dc
```
...
```console
$ docker pull tomcat@sha256:e23c285c2684c13febb8d893824326dde4185e7e4f778dadf8d06a4a30796407
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.9 MB (101933995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1733251411e9585a98070c434ccad64bfcbd12935d44437c8bb815e8b0c943c3`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 10 Feb 2022 21:48:14 GMT
ENV TOMCAT_VERSION=10.1.0-M10
# Thu, 10 Feb 2022 21:48:15 GMT
ENV TOMCAT_SHA512=ec744e2151a4c9d50728efc0f97a4132e9cbcbf0a643621d7676115d4d59d174bde313512346d52cd53ac1f96ed31e0503e7c430dd61ada35a4c2e70d26e0532
# Thu, 10 Feb 2022 21:48:15 GMT
COPY dir:a36788376c7ff9d4c19506c1874c9b789f0fb5e4ff0a6c0b5b436a8371d758c2 in /usr/local/tomcat 
# Thu, 10 Feb 2022 21:48:20 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Thu, 10 Feb 2022 21:48:21 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 10 Feb 2022 21:48:21 GMT
EXPOSE 8080
# Thu, 10 Feb 2022 21:48:21 GMT
...
-	Layers:
	...
	-	`sha256:9174613d257bf1658b17cec1d9a8858e6043efb873d7b0425f754d9374c7ea60`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42b424afccc5ef8b863c9bef20334035b0fb646cc712661d7459f8a2732f20d2`  
		Last Modified: Thu, 10 Feb 2022 22:05:26 GMT  
		Size: 12.6 MB (12585629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c313709ee92cf16bddf16697220bfcd2bf4b0429643a9426966da096023f62c`  
		Last Modified: Thu, 10 Feb 2022 22:05:26 GMT  
		Size: 453.7 KB (453707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d66c924a671861970b5281083f0fdc5c1ac17c5f9820d02fd523838ca6c6789e`  
		Last Modified: Thu, 10 Feb 2022 22:05:26 GMT  
		Size: 128.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
