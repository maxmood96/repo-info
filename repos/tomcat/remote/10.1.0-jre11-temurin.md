...
```console
$ docker pull tomcat@sha256:103706c0b461bd038adab65b553a4688def9632a327bf447ac33498382c6cacd
```
...
```console
$ docker pull tomcat@sha256:18990de16943a6b4dae9ee7694541b97fcb17909d736eead3bc983b0b11e9598
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.3 MB (99349137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cea654ecff8f8eebfa3500c50fcc46c0573f561f7413d4f5b31289682010ddd`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Mon, 15 Nov 2021 21:28:19 GMT
ENV TOMCAT_VERSION=10.1.0-M7
# Mon, 15 Nov 2021 21:28:20 GMT
ENV TOMCAT_SHA512=2dd4d2779021a00b684d9e59785656a2473cac37ec24a7b04b72b92c60793209ac17753d4ad7153e486856f751758446451766d078594feb020a0197b79cf039
# Mon, 15 Nov 2021 21:28:22 GMT
COPY dir:b0461d76cc1da6d7de44d07a07238ad1424fa3451723103c142e0dafa3e70461 in /usr/local/tomcat 
# Mon, 15 Nov 2021 21:28:30 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Mon, 15 Nov 2021 21:28:32 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Mon, 15 Nov 2021 21:28:33 GMT
EXPOSE 8080
# Mon, 15 Nov 2021 21:28:34 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:792e9d0b7a27f69a09381edae9b3e4da52e018a04a9b7a52a089365e30b54327`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cd4d186e9355b73eed86118948215d0f50c34dc44ff1537044f564fb1bd6214`  
		Last Modified: Mon, 15 Nov 2021 22:13:15 GMT  
		Size: 12.5 MB (12547047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66836a3d06c0498f90d16bf0b2f7d6c33f06e5b289a0bb2d5a11651b86a696b0`  
		Last Modified: Mon, 15 Nov 2021 22:13:14 GMT  
		Size: 2.2 MB (2215827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
