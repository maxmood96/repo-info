...
```console
$ docker pull tomcat@sha256:75e6e1b6eeeead9b6e07b29a621774a4e7c38353933b1bc42f2681c0a724ddad
```
...
```console
$ docker pull tomcat@sha256:5ab435ecb21e55892361bc571bb1869f0a4b25f5b513f24c1b82acbef8ac7395
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.6 MB (111630307 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b929287a6add3213891cb1b9964cef72785da56c5b57f97132156c4a349ff941`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=10
# Fri, 21 Jan 2022 03:44:49 GMT
ENV TOMCAT_VERSION=10.1.0-M10
# Fri, 21 Jan 2022 03:44:52 GMT
ENV TOMCAT_SHA512=ec744e2151a4c9d50728efc0f97a4132e9cbcbf0a643621d7676115d4d59d174bde313512346d52cd53ac1f96ed31e0503e7c430dd61ada35a4c2e70d26e0532
# Fri, 21 Jan 2022 03:44:54 GMT
COPY dir:3292f82ddd335268dbaedbad262579570526b7a130147b9780b7f5ad47da178a in /usr/local/tomcat 
# Fri, 21 Jan 2022 03:45:13 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 03:45:28 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 21 Jan 2022 03:45:33 GMT
EXPOSE 8080
# Fri, 21 Jan 2022 03:45:37 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:9f344abcb45a4c064a36daf9f1f4275e2406879d29cffb99d237a6fba540b998`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb9330b63deabaf18b1b56a79d2aafa7d5439f3f7df90157d7da4ab8279b358f`  
		Last Modified: Fri, 21 Jan 2022 04:44:24 GMT  
		Size: 12.6 MB (12612305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:900d9c2126c148eef704cab05e12ca192f7a9f3f5e833a6bc4843bebd9d465ff`  
		Last Modified: Fri, 21 Jan 2022 04:44:22 GMT  
		Size: 477.5 KB (477540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bf68a178516dee65266c8d31821e31740a4214634101b5efeccd1bfe73d3b82`  
		Last Modified: Fri, 21 Jan 2022 04:44:22 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
