## `tomcat:8.5.71-jdk11-openjdk-bullseye`

```console
$ docker pull tomcat@sha256:3df819512a2116a2cce01581645a2c52ffc7da37e4d39c2b71a1c2412a5825d1
```
...
### `tomcat:8.5.71-jdk11-openjdk-bullseye` - linux; amd64
