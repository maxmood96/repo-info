## `tomcat:10.0.17-jdk8-openjdk-slim`

```console
$ docker pull tomcat@sha256:8e38ed0978948ddf012d3b0b79a55b332b23e1efa0b65c744bfd08768156b0e7
```
...
### `tomcat:10.0.17-jdk8-openjdk-slim` - linux; amd64
