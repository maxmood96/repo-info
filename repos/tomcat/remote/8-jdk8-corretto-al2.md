...
```console
$ docker pull tomcat@sha256:e8eaaee94d5ad95aa185bef03f62e0c18ee1c396282f8381e06b54cff87cdaa2
```
...
```console
$ docker pull tomcat@sha256:a2c7b4f10f96470b997355af8abf9338e6aac7e8eba79835b4acbc100c7f8a1f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153897369 bytes)**  
...
# Tue, 20 Jun 2023 23:47:59 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 20 Jun 2023 23:48:00 GMT
EXPOSE 8080
# Tue, 20 Jun 2023 23:48:00 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:822c85dd1a2c3150ce3cc7b5735d1e9862c2d83c4d957de1fa11ca50a4f5a2fb`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf9d0f65afa6f48d9748250935d10ef6f6cddfeef916a2a0b1016b8ebf3757ea`  
		Last Modified: Tue, 20 Jun 2023 23:52:54 GMT  
		Size: 15.9 MB (15857982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e04647075bc4a40512a94b550a07de85e9696d5a21201ac1e4286f4ab62fa11`  
		Last Modified: Tue, 20 Jun 2023 23:52:52 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
