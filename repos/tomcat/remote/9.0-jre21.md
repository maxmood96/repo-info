...
```console
$ docker pull tomcat@sha256:55ebebed994b9d8e2dc2314897cddc7d7767fe23586f24af0a6fd68b5ea7a4aa
```
...
-	Layers:
	...
	-	`sha256:dabdc079e878deab9f6a06c5400140ab25499aef8f33f3198c3fab4a0e42612d`  
		Last Modified: Fri, 16 Jan 2026 04:53:52 GMT  
		Size: 139.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
...
```console
$ docker pull tomcat@sha256:bfb81e7afbfd51f1a130732a7067f3ccf7b21baeb050a64d5b273792a0094d37
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.8 MB (115814428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be9f41145aa22bc2a2019fab2ece3941cb9f039f5bf40e61edf9a650b159f329`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 22 Jan 2026 12:31:03 GMT
ENV TOMCAT_SHA512=1b8d9ba5c5e2ed2b4134a3fe6f206b3bb1184391e5c112ca7ea6a49ecadca63a7fc565c83caa610f0a8341988777870302a8162a84f0880af751531cdd4a2ee5
# Thu, 22 Jan 2026 12:48:58 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Thu, 22 Jan 2026 12:49:35 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 22 Jan 2026 12:49:43 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Thu, 22 Jan 2026 12:49:43 GMT
EXPOSE map[8080/tcp:{}]
# Thu, 22 Jan 2026 12:49:43 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d72d220e07883bb3d153fd51d5335adab334068528b55341fe257f09a34f7351`  
		Last Modified: Thu, 22 Jan 2026 12:51:27 GMT  
		Size: 14.2 MB (14242633 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9696f99997004d52e80df05cc66d498bccf1f81fb474ef804016a01977c1e5ae`  
		Last Modified: Thu, 22 Jan 2026 12:51:25 GMT  
		Size: 228.1 KB (228079 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:ed7037fa4cf54560af09af703c095626197e10e4917b78587d9cdcbfc7e85d30
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.4 MB (3362286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48c4b4ad2289c4367fa1a15bc51ea6f463e73f1fe905990e65638f5c3656620d`

```dockerfile
```

-	Layers:
	-	`sha256:123f3327e9fbe78d63ddd9c3b1bac547ea69974b2c0c0c5554de9312364f3373`  
		Last Modified: Thu, 22 Jan 2026 12:51:26 GMT  
		Size: 3.3 MB (3339105 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:03c4de035542edf02027f3ce14c2deb82fd49165ecba03e85347cb528eec7752`  
		Last Modified: Thu, 22 Jan 2026 12:51:25 GMT  
		Size: 23.2 KB (23181 bytes)  
		MIME: application/vnd.in-toto+json
