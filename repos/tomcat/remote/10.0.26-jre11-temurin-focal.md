...
```console
$ docker pull tomcat@sha256:e0ccff92f3ca901db70ad509fbf5349f41242519323e0ca3a0d315403f5a438c
```
...
```console
$ docker pull tomcat@sha256:d9bd2cd1e27dc3120ad42728701acf3ddb5e5b161244674ce899d8579001a9a2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.1 MB (101102284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:374a6dc1cb2abddac317fa0f404d0b1d81bb48348ef95f802ca195924e8a80c7`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_VERSION=10.0.26
# Wed, 28 Sep 2022 01:51:56 GMT
ENV TOMCAT_SHA512=dad742b2962f73a23ebbe7aecd674246e25d83cde04bd20126f10e9a9abbac6fd025cd9ffd829c8e3152b6cbe07ff839f48383b64f81a5b0ac020f8d8c7f054f
# Wed, 28 Sep 2022 01:51:58 GMT
COPY dir:cada4f37be73456a53c28dc406d94354e86afe1fba19718e17acc41321dcfd98 in /usr/local/tomcat 
# Wed, 28 Sep 2022 01:52:04 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 28 Sep 2022 01:52:06 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 28 Sep 2022 01:52:07 GMT
EXPOSE 8080
# Wed, 28 Sep 2022 01:52:08 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c161cf060414c6a6a052fdc0681d0765b62d2e5455829990d0338d56ec4c68d2`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0289eda68780b2a3b56645c6c4f5b6d6d820de6f5af17075365c488f4b9b6ca`  
		Last Modified: Wed, 28 Sep 2022 02:10:28 GMT  
		Size: 12.7 MB (12654689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba7ebb2ec0a7bf0ac401416afdf51327df7541eceba6e0a032e040398a631a96`  
		Last Modified: Wed, 28 Sep 2022 02:10:28 GMT  
		Size: 211.6 KB (211618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:10.0.26-jre11-temurin-focal` - linux; ppc64le

```console
$ docker pull tomcat@sha256:ef351cc0c17187ca4f4e21b86dc501ea73c56c80c492e20532dfb6d434ff8e82
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.9 MB (105927229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c718338977c08ca3295abd21de6f9768218ccd6909f021987e83bc046a3dea71`
-	Default Command: `["catalina.sh","run"]`
...
COPY dir:19eb8d441936c8403cbbaf99b48a0aeb02c0ad8ffd75f0b53a0ff2e049e40820 in /usr/local/tomcat 
# Wed, 28 Sep 2022 02:07:47 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 28 Sep 2022 02:07:50 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 28 Sep 2022 02:07:51 GMT
EXPOSE 8080
# Wed, 28 Sep 2022 02:07:51 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:13102ab242c4ceab6b8edcdf3d483868a01140617a3046f3bd60c285eaf9e263`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3db7d70127876d7ec92ba26d62f3d0ac0cf21b603614a9978b85cd3b7fdc2bc`  
		Last Modified: Wed, 28 Sep 2022 02:25:33 GMT  
		Size: 12.7 MB (12680206 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2119db005f3d3e20a589a31ca0b679bbafcb2fd6e3adbf46a5732fff47aee35c`  
		Last Modified: Wed, 28 Sep 2022 02:25:32 GMT  
		Size: 474.0 KB (473981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8917693d49fa4c8e73a3cc0712f3f164af554a38ec763a668fb8398f90d320e2`  
		Last Modified: Wed, 28 Sep 2022 02:25:31 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
