...
```console
$ docker pull tomcat@sha256:37bb1031a6275f5db353789912963eacf909d897dacd7f5422ec7d2d76a5950a
```
...
```console
$ docker pull tomcat@sha256:d093b3035a0097b5bcec4839d0f3f8c4bb791d03b6a1acffd7f3f5eedf25acd9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.0 MB (238040186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8fd92a3a5f46747fa194f2daab054b0be5ac6d75a23f9d166e39d23d6461f0d`
...
# Wed, 13 Jan 2021 08:30:27 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 13 Jan 2021 08:30:28 GMT
EXPOSE 8080
# Wed, 13 Jan 2021 08:30:28 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a96ab010372931e8f4a359ada50fd58645132b23d64b5db1a6856900ca3ffdf7`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fdccb50e8a0953c9999c3c0a7879acc096002d7ea9759732fad4d543a281f9e`  
		Last Modified: Wed, 13 Jan 2021 08:44:16 GMT  
		Size: 11.5 MB (11530634 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f19a3e6222ece46bec2d36561c1eb825e23191ea5a16371a034dafa41345ccff`  
		Last Modified: Wed, 13 Jan 2021 08:44:14 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
