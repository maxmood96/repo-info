...
```console
$ docker pull tomcat@sha256:62537dd529702b0d4b434250d1c7a0ffee74f65f11b77144850cc5f8f7b3d176
```
...
### `tomcat:9.0.87-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.87-jre11-temurin` - linux; arm64 variant v8
