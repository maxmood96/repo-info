...
```console
$ docker pull tomcat@sha256:89752ec7f22c08bf5c0cd0158ab71381c09d676472c987622be71b076a3bb47b
```
...
```console
$ docker pull tomcat@sha256:68ba8340d0d08f1964be0263d76c271c766ad9069d27e486393f9db3ea2f8959
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.4 MB (122424751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3a4d7299e70d59ec00f3ed16ad6314697e2d947b345befcb78e32bf05e373d7`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_VERSION=10.1.0-M10
# Fri, 21 Jan 2022 03:37:07 GMT
ENV TOMCAT_SHA512=ec744e2151a4c9d50728efc0f97a4132e9cbcbf0a643621d7676115d4d59d174bde313512346d52cd53ac1f96ed31e0503e7c430dd61ada35a4c2e70d26e0532
# Fri, 21 Jan 2022 03:37:09 GMT
COPY dir:696aa3a4e23ff62b655d6a399ec60760fbcaa2b1145802d58a0b5a415265dbcf in /usr/local/tomcat 
# Fri, 21 Jan 2022 03:37:26 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 03:37:38 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 21 Jan 2022 03:37:41 GMT
EXPOSE 8080
# Fri, 21 Jan 2022 03:37:45 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:1735bdf6d68b9a8eb3cfe4d426ee2cc342c573fefe25b517c207c66292385fd0`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c00df3a98fd0baba7756b2c5598678e21df7a4e0fca4123116e3cf99a4b9b32a`  
		Last Modified: Fri, 21 Jan 2022 04:42:58 GMT  
		Size: 12.6 MB (12612223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ce1699964dcca0998a9d6fff52cf967e42a8ea96c7850f1f6412230354233ef`  
		Last Modified: Fri, 21 Jan 2022 04:42:57 GMT  
		Size: 479.9 KB (479897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f1938ec04e46ff8bcf8a3b3968278f4b73c1742bf86d5ea7397175c976c1918`  
		Last Modified: Fri, 21 Jan 2022 04:42:56 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
