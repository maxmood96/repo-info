...
```console
$ docker pull tomcat@sha256:eb1dd68d7a21f4eec5c31ab03c28859de3e95c6de4f550b516bc9270dc83b010
```
...
```console
$ docker pull tomcat@sha256:3f103f37bcbb69984e150f271a4b1eeddeb7525f6a71672de6609f39e4ebfa60
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.9 MB (103884389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3983c22dcd150bf57b7ffa9a6f338f60a60aa894105d5640c9c27699d1a99dd3`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_SHA512=71a64fe805aab89ef4798571d860a3c9a4f751f808921559a9249305abb205836de33ab89bb33b625a77f799f193d6bffbe94aadf293866df756d708f5bfb933
# Sat, 16 Mar 2024 14:47:53 GMT
COPY dir:b05cbfd83dda002d0e3181d11099c953d58b84c45ed1af40615005e4b0b60753 in /usr/local/tomcat 
# Sat, 16 Mar 2024 14:47:57 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Sat, 16 Mar 2024 14:47:58 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Sat, 16 Mar 2024 14:47:58 GMT
EXPOSE 8080
# Sat, 16 Mar 2024 14:47:58 GMT
...
-	Layers:
	...
	-	`sha256:319848d37f438bfc171bc6ca51b9bdc87c09e4e5c21ec6daa1dfcba76d001495`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56fc94ab698be6b8926e926c7a26796f9ff60659a3fb07441b39fdf0a9dc426b`  
		Last Modified: Sat, 16 Mar 2024 15:11:42 GMT  
		Size: 12.5 MB (12502620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:924e8bd69960f58a3ac7159f7dcc339aec4ab7a07d528dbe09282f6c771a027d`  
		Last Modified: Sat, 16 Mar 2024 15:11:41 GMT  
		Size: 455.1 KB (455058 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12963ef83566dcd07bacd08b7647398009128ab42a4402fa73a3f7e7972e95b5`  
		Last Modified: Sat, 16 Mar 2024 15:11:41 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
