...
```console
$ docker pull tomcat@sha256:5f6286a2ab1292c14844915a39da4dbea5adcbdfc6d63a8d3a5ac6ce5a02aa39
```
...
```console
$ docker pull tomcat@sha256:339d839ee8008747ca7a3b62d64765be7152c356e1ebd00e39976a9eb08d3513
```
...
-	Image ID: `sha256:87b5281ba4dae5aecb185e5e21a3703a41746175e71a4fe3a77cf2ffade8d155`
...
```console
$ docker pull tomcat@sha256:0986674e8c86a25093af630ec4a890acee8c899064f9f893763e33c88bb4646a
```
...
-	Total Size: **115.9 MB (115930285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:738afe834dbe39d321019ce27cc5a6e2b1cb80a4c76673062468c0416a9cec9e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
