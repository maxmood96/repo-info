...
```console
$ docker pull tomcat@sha256:a91381cd07bf67ad2946cd6574f034f72b1cda36e5e8d6b699c89271c65bbaf4
```
...
```console
$ docker pull tomcat@sha256:9c327c3f41e75307b2c509e6993448b2ba250f8d2b7fd31cb156a5c1aa788ea1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.3 MB (109340502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38c673c858f3d443dd477eac62db946323f64f9164806a226bc9ae15f2b39598`
...
# Fri, 02 Feb 2024 12:28:17 GMT
COPY dir:247e8985232f92fbef237a1d76540b54f4cd21fc8766926bbfcf430e82c35b23 in /usr/local/tomcat 
# Fri, 02 Feb 2024 12:28:22 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Feb 2024 12:28:23 GMT
...
-	Layers:
	...
	-	`sha256:2eabae6d9c8d965f9a9fe99c26e1c88a217124d865a50a5e9f3eb45a0d44b88b`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360d8bd97ca1df4fd484009c96db5ff751f2ea7a7fdd76b2d34b43ad54c3a53d`  
		Last Modified: Fri, 02 Feb 2024 12:51:59 GMT  
		Size: 12.5 MB (12468846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18a9e1bf916cbb898685b10cd943e083e65ff3aa0f6bea5b651191e646e9ce76`  
		Last Modified: Fri, 02 Feb 2024 12:51:58 GMT  
		Size: 452.9 KB (452865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fc80550af8cdfff8b869a28237a4226690a3a636ab73efd7b7a0649cac2f269`  
		Last Modified: Fri, 02 Feb 2024 12:51:57 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:0d51fc485c7923e82ce1d95163f9771a031b2132833d5fb6f03b975d0152b671
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.0 MB (116031716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d0241d4bbfab27e7117d2619d6b7df7fd5ce50446171af9cacae200ad2bb8ea`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Fri, 02 Feb 2024 07:32:53 GMT
ENV TOMCAT_VERSION=9.0.85
# Fri, 02 Feb 2024 07:32:55 GMT
ENV TOMCAT_SHA512=06e239d15ff7b72017c1d0752ddb1be4651374f7c1391631ec5619f4981cb2911267bc6b044d6c71a2a74738f70d433b96418951439848121f1d874862ddd3de
# Fri, 02 Feb 2024 07:32:56 GMT
COPY dir:f1b665ec9f9c11694f8ca96bfc0208fd89ddf234e2e870d5f40d4df8e1d2e334 in /usr/local/tomcat 
# Fri, 02 Feb 2024 07:33:05 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Fri, 02 Feb 2024 07:33:10 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 02 Feb 2024 07:33:11 GMT
EXPOSE 8080
# Fri, 02 Feb 2024 07:33:14 GMT
ENTRYPOINT []
# Fri, 02 Feb 2024 07:33:16 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b2dd8e96073741fa7bdd84ef2c28e8e7e288a32ad8be640a2dabcc58816e5b3b`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3ea6f1e79f9e8010212150c98475448d6a7d673e34ec0c982c780dfab1ac6d1`  
		Last Modified: Fri, 02 Feb 2024 08:14:42 GMT  
		Size: 12.5 MB (12509543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:610f359fe95cb1ca288352aadb41d70ea652cd7ae027a17490e8e5270a3227d5`  
		Last Modified: Fri, 02 Feb 2024 08:14:42 GMT  
		Size: 477.9 KB (477924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:813f39bbfeffaed46e33aaa5f8789ceb7ff43ae19ff42373cf89406934382202`  
		Last Modified: Fri, 02 Feb 2024 08:14:41 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
