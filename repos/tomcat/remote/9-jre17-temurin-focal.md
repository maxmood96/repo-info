...
```console
$ docker pull tomcat@sha256:e2e7e2797392dcac52e63d4df11b32cdcb1f149bc1923da16fc01169c8ce626f
```
...
```console
$ docker pull tomcat@sha256:85bc573e1f4aa3490be1ff6b8722ce0e68c97cdf09bbbe4a96867fecdce8d4f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **103.8 MB (103770268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ac195319cf265cc9d2bf9ae58dfb728c04660ef4f359e0380c4ff475668238d`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 02 Feb 2024 01:32:52 GMT
ENV TOMCAT_MAJOR=9
# Wed, 21 Feb 2024 04:07:13 GMT
ENV TOMCAT_VERSION=9.0.86
# Wed, 21 Feb 2024 04:07:14 GMT
ENV TOMCAT_SHA512=e8a8000dbeba5ee266ec4bf77217574364ffd114c8b913816f2e7a5e4eab4d01d0be3f05c8fccefcb5c5d770308efe1983be80279b6ef6d122d6183288a8ee9c
# Wed, 21 Feb 2024 04:07:14 GMT
COPY dir:00d7e4520079a8d60582d80aed17762c4ed0ed9ebaba17344f26355b24324a08 in /usr/local/tomcat 
# Wed, 21 Feb 2024 04:07:19 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 04:07:20 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 21 Feb 2024 04:07:20 GMT
EXPOSE 8080
# Wed, 21 Feb 2024 04:07:20 GMT
...
-	Layers:
	...
	-	`sha256:18483c78819a0bed54f49243a0a6a1eef2f7098ec49df8ebb2598d789278c2a8`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf4a0418e6d5d13e862ab8ae4f12ea6d02d694637e00192991d07a45be4f5cb0`  
		Last Modified: Wed, 21 Feb 2024 04:20:56 GMT  
		Size: 12.4 MB (12429339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b21d054b603079e9c21c50665dee4fe8e92e20db1d98d79891c525c2562355ca`  
		Last Modified: Wed, 21 Feb 2024 04:20:55 GMT  
		Size: 2.0 MB (1976242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f965291c245bdd6cbfc6c3fba7cca847e080eb2af6e3b56dc8a4b10d07a6c597`  
		Last Modified: Wed, 21 Feb 2024 04:20:54 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
