...
```console
$ docker pull tomcat@sha256:97424aa425b7fb929f6b24c23c67c58695a31a270ccbce277c66a553cc06a8d9
```
...
### `tomcat:9.0.119-jre11-temurin` - linux; amd64
...
### `tomcat:9.0.119-jre11-temurin` - unknown; unknown
...
### `tomcat:9.0.119-jre11-temurin` - linux; arm variant v7
...
### `tomcat:9.0.119-jre11-temurin` - linux; arm64 variant v8
