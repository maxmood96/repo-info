...
```console
$ docker pull tomcat@sha256:ad3a673edca7c435f9ecdcca5c7a5a9273f0071213254de6bc072aa534281dc5
```
...
### `tomcat:10.1.55-jdk25-temurin-noble` - linux; amd64
...
### `tomcat:10.1.55-jdk25-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.55-jdk25-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.55-jdk25-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.55-jdk25-temurin-noble` - linux; s390x
