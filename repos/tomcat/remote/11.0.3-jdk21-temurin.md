## `tomcat:11.0.3-jdk21-temurin`

```console
$ docker pull tomcat@sha256:4801fc58536f9bec1c5c97d9618cc67d95c23d8f49171c23113c9477d581605a
```
...
### `tomcat:11.0.3-jdk21-temurin` - linux; amd64
...
### `tomcat:11.0.3-jdk21-temurin` - unknown; unknown
...
### `tomcat:11.0.3-jdk21-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.3-jdk21-temurin` - linux; riscv64
...
### `tomcat:11.0.3-jdk21-temurin` - linux; s390x
