...
```console
$ docker pull tomcat@sha256:a31a0df1914a5a381364f151f39a310d881a46663aa1d13d1c739ccfae774ee2
```
...
### `tomcat:10.0.16-jre8-temurin-focal` - linux; amd64
...
### `tomcat:10.0.16-jre8-temurin-focal` - linux; arm64 variant v8
...
### `tomcat:10.0.16-jre8-temurin-focal` - linux; ppc64le
