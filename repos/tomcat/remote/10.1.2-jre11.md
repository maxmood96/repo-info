...
```console
$ docker pull tomcat@sha256:3d832626102807c30d624a538d1283065df2803e118c65071644c77cc8d6e983
```
...
### `tomcat:10.1.2-jre11` - linux; amd64
...
### `tomcat:10.1.2-jre11` - linux; arm variant v7
...
### `tomcat:10.1.2-jre11` - linux; arm64 variant v8

```console
$ docker pull tomcat@sha256:605a3bab05d13e3c2827a57f2ab326119f4f73a18f9d83207bcc722d349c79c3
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.4 MB (98384572 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9634cad6d533d6057db981152ae72e341729ae5604d43bb55c31f5b3986b81e5`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 04 Nov 2022 23:48:39 GMT
ENV TOMCAT_MAJOR=10
# Tue, 15 Nov 2022 04:53:28 GMT
ENV TOMCAT_VERSION=10.1.2
# Tue, 15 Nov 2022 04:53:28 GMT
ENV TOMCAT_SHA512=50e933934cbf2915603264dfd245db0137491555d71d4fe8a535a7a8b6bc36bb4984e8bb2f38c968fbfc84a87aeeaa773ce1c6ee5f2eaa87780d1869251da51e
# Tue, 15 Nov 2022 04:53:28 GMT
COPY dir:5edfafe61d426261d571c06183a31fa8b4df237ac8364a9e0fa3fbb0197c8f73 in /usr/local/tomcat 
# Tue, 15 Nov 2022 04:53:31 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 04:53:33 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 15 Nov 2022 04:53:33 GMT
EXPOSE 8080
# Tue, 15 Nov 2022 04:53:33 GMT
...
-	Layers:
	...
	-	`sha256:5fb623f082f74b2fa9fc2c4e3f3a4802875cb9753cfa26ed940201ce72bb56cb`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:168424180f6046f2bf1a7a12a60f25c30fe5cd76a53944fa7806ffb7f94bfb8d`  
		Last Modified: Tue, 15 Nov 2022 05:07:24 GMT  
		Size: 12.2 MB (12195125 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4a7063ef0fc930bd17e8c2dcb6efe71680578a07a1fb0d507a50b79b4450565`  
		Last Modified: Tue, 15 Nov 2022 05:07:23 GMT  
		Size: 452.0 KB (452031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:606bb75fa6620ab8137b327d7c6c249c918e714966d3f7cdabef15bd57acadda`  
		Last Modified: Tue, 15 Nov 2022 05:07:23 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `tomcat:10.1.2-jre11` - linux; ppc64le
...
### `tomcat:10.1.2-jre11` - linux; s390x

```console
$ docker pull tomcat@sha256:bdc464da29ebeb39db3c50d953157de502ac44b40e2a1df4ceef6aada084bc54
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.3 MB (94327030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3217d93d2b5b92daeec9d45adb131549a6ffe63ac3988b372ee87ccba9999eb`
-	Default Command: `["catalina.sh","run"]`
...
COPY dir:bc2f33af57cf803e377888dfbcc8d7b9b7f647869ba46eb67111205e04d82cf5 in /usr/local/tomcat 
# Tue, 15 Nov 2022 04:58:52 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 04:58:55 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 15 Nov 2022 04:58:55 GMT
EXPOSE 8080
# Tue, 15 Nov 2022 04:58:55 GMT
...
-	Layers:
	...
	-	`sha256:bb3a23c53fe7bb0b55a31d1df80d02dda799bf33850391ebbe6be143283914c4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcd4a09b0b5007015e4d0c45491d63b33a3dd24f48a33db96d2e4ff8eaa0015c`  
		Last Modified: Tue, 15 Nov 2022 05:13:41 GMT  
		Size: 12.2 MB (12199051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e3126275261fd028412e195fc438e58f33d7795f281410ea9612b07531c7769`  
		Last Modified: Tue, 15 Nov 2022 05:13:40 GMT  
		Size: 454.3 KB (454278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45506513f8bcf052b7733d061a148824cf2158c21e235371a40192b4bd071437`  
		Last Modified: Tue, 15 Nov 2022 05:13:40 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
