## `tomcat:9.0.86-jre21-temurin`

```console
$ docker pull tomcat@sha256:60023fdfc74d4b56c63dabd108e2a6d7cea61750c07f753f355e1461b3e6a988
```
...
### `tomcat:9.0.86-jre21-temurin` - linux; amd64
...
### `tomcat:9.0.86-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:9.0.86-jre21-temurin` - linux; ppc64le
