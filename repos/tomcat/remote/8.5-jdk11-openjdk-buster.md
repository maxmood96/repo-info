...
```console
$ docker pull tomcat@sha256:fe401e7e3122ed3321fc4ea35620dd398179f27873358a2002489c6622aebdf8
```
...
```console
$ docker pull tomcat@sha256:1fb3c7647e1c1fb0c3f93c2245f494f2fca1401906920c1af3cf81c9e2cfc843
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.2 MB (342244042 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94956ef3d616779b9a5da6e785032de2a8b4873d4172cb847578540ce9a5f1a7`
...
# Tue, 31 Aug 2021 21:10:50 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 31 Aug 2021 21:10:51 GMT
EXPOSE 8080
# Tue, 31 Aug 2021 21:10:51 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:c36aa3d16702850a7d9588241836db68a404f7fec3812a99fa4700fec0b03ac4`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06335ecdb5635fa446be7283c2148bc2c02364b63a28a77c5fd7ae5751e064fc`  
		Last Modified: Tue, 31 Aug 2021 21:57:37 GMT  
		Size: 13.7 MB (13719937 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16d6fa1c44db888aa6be3294abb282a3f275dc425171cf008b1bfb35ab7e8027`  
		Last Modified: Tue, 31 Aug 2021 21:57:35 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
