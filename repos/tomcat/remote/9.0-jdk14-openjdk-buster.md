...
```console
$ docker pull tomcat@sha256:6ea6deb5603c97269eb79c7dfccc355b68bf6eb8ffd3b32a9941cd274a91cebc
```
...
```console
$ docker pull tomcat@sha256:c3df3021daa2d1286a41c2591d449b17eff44fdab7f9c3c86bdd1fd3c4086445
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.4 MB (345376519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:235bb1246cc85917d1bf901de8dfc6839ce688c2651e8438bd6e83311f64fd3b`
...
# Thu, 23 Jul 2020 08:23:52 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 23 Jul 2020 08:23:52 GMT
EXPOSE 8080
# Thu, 23 Jul 2020 08:23:53 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:0b4981ad19f6f52632f0af2d7692b5fda753d9558244a259f8bf8b195719b062`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9beb5a012fc6e2d50eeedfd7ef3a37538fd0e5d62e34902fc19319cda27073d6`  
		Last Modified: Thu, 23 Jul 2020 08:35:04 GMT  
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6933816eaa09f8a94ff9ced1bd54afacd9af99f02f1b1bd0848407ff3d3bad0`  
		Last Modified: Thu, 23 Jul 2020 08:35:49 GMT  
		Size: 12.2 MB (12226901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b82f85d40b318b29a8009df7c25411d186edcc549342bb58f392d2a59594916`  
		Last Modified: Thu, 23 Jul 2020 08:35:48 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
