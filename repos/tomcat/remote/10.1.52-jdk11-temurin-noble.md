...
```console
$ docker pull tomcat@sha256:a3a738dedaaf904741adfbd26dbef0be9d3dc39d41f848ace95d2ea97d06d149
```
...
### `tomcat:10.1.52-jdk11-temurin-noble` - linux; amd64
...
### `tomcat:10.1.52-jdk11-temurin-noble` - unknown; unknown
...
### `tomcat:10.1.52-jdk11-temurin-noble` - linux; arm variant v7
...
### `tomcat:10.1.52-jdk11-temurin-noble` - linux; arm64 variant v8
...
### `tomcat:10.1.52-jdk11-temurin-noble` - linux; ppc64le
...
### `tomcat:10.1.52-jdk11-temurin-noble` - linux; s390x
