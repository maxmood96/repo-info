...
```console
$ docker pull tomcat@sha256:8939e5e1419e9d95a8726b5a17946f9761be60fc96b9511ab8e1ace425f87cd0
```
...
### `tomcat:9.0.39-jdk8-adoptopenjdk-hotspot` - linux; arm variant v7
