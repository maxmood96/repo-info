...
```console
$ docker pull tomcat@sha256:c79416399d9a3a46ac8015f1561e15aaaa72a79239827e41ccc6192499d17456
```
...
```console
$ docker pull tomcat@sha256:dd08d19684e5282a82923ae9137eddcb38ce40d7dceea58d813995d73215e550
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.4 MB (148369411 bytes)**  
...
# Wed, 02 Mar 2022 11:37:49 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 02 Mar 2022 11:37:49 GMT
EXPOSE 8080
# Wed, 02 Mar 2022 11:37:50 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:26986f268275753701fd87cf1d85b5b3ed6299f7da5af4aa4c2cf588cae33d74`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a909a4bf35f66ad07ffc3ca7f7a1a5176a14d53e6a6bff8a775c7e352ef8476`  
		Last Modified: Wed, 02 Mar 2022 12:17:02 GMT  
		Size: 11.6 MB (11594181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5b00f13cd44a268b20cb74e44c3283796fd8f77596fa42316f0c495b1f0b753`  
		Last Modified: Wed, 02 Mar 2022 12:17:01 GMT  
		Size: 129.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
