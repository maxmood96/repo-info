...
```console
$ docker pull tomcat@sha256:f8944746fe22e81494b32ee05abc0cf4ff74f0c11068e9fb017029c594cb7b3e
```
...
```console
$ docker pull tomcat@sha256:9aea8f6ae762fca10e8c87c81a423cf3f83d4cf91bd026ddd78364b99f709498
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **123.1 MB (123079887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c76de284ce20054ccaddf78d92da7221b37bbc0eb70ba76b6dc0fb25e270549`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 07 Apr 2026 18:37:55 GMT
ENV TOMCAT_SHA512=8694b94324cf6f62ab032fa2438d7334518dcfcbf7878361b147246c46eb1e558c327f32c05fb4b7705c01fcca92fde392ce320934410f1169ff4ab36a1c7139
# Tue, 07 Apr 2026 18:39:23 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Tue, 07 Apr 2026 18:39:33 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 07 Apr 2026 18:39:35 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Tue, 07 Apr 2026 18:39:35 GMT
EXPOSE map[8080/tcp:{}]
# Tue, 07 Apr 2026 18:39:35 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:61668d8439980d52e93007661765a4e2fc259c84161fda9a55f38c5d254c1c17`  
		Last Modified: Tue, 07 Apr 2026 18:39:53 GMT  
		Size: 14.3 MB (14319438 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0ad568dc7c87d7e2b0c4dfe9b486ac90d916e11fcc73ea36f372ef09b9cd4c4a`  
		Last Modified: Tue, 07 Apr 2026 18:39:53 GMT  
		Size: 238.7 KB (238657 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
...
```console
$ docker pull tomcat@sha256:6ff06f06463a4810bd17a2b81445e72c0eec59548c9003c15501046860d37c8d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.2 MB (3154212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba060556def5ce2b2cbf7cec44cbadde576d5600192811623760826686840223`

```dockerfile
```

-	Layers:
	-	`sha256:ec54f89c1e1bc34a064a22fa253c542ea80934c8d2aeedf3950a31091d9129ab`  
		Last Modified: Tue, 07 Apr 2026 18:39:53 GMT  
		Size: 3.1 MB (3131023 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:75df00e88bc2d1a7193a01ea0cc0ffe3fb65f1104cf02f2de3b80cca6f378454`  
		Last Modified: Tue, 07 Apr 2026 18:39:53 GMT  
...
```console
$ docker pull tomcat@sha256:6beca9f26ec4c3b192288b39968a0689c7856cff3cf1616a535e073f4c39a713
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.8 MB (120797443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d180c487b7b02d90c1c01bc25b6c403aa2f1e77ea60e26e5cf501ee2737d785b`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 14 Apr 2026 07:20:25 GMT
ENV TOMCAT_SHA512=8694b94324cf6f62ab032fa2438d7334518dcfcbf7878361b147246c46eb1e558c327f32c05fb4b7705c01fcca92fde392ce320934410f1169ff4ab36a1c7139
# Tue, 14 Apr 2026 07:23:44 GMT
COPY /usr/local/tomcat /usr/local/tomcat # buildkit
# Tue, 14 Apr 2026 07:24:30 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 14 Apr 2026 07:24:37 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi # buildkit
# Tue, 14 Apr 2026 07:24:37 GMT
EXPOSE map[8080/tcp:{}]
# Tue, 14 Apr 2026 07:24:37 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4b2691da53293771b6100227ecebdcfa05a0c3182fd672fc7fe9c631bd104529`  
		Last Modified: Tue, 14 Apr 2026 07:26:22 GMT  
		Size: 14.5 MB (14489509 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3ac015a3e51697266434af9a6d2620082bbdef68020c9561d5fe5a5d6aef622b`  
		Last Modified: Tue, 14 Apr 2026 07:26:19 GMT  
...
```console
$ docker pull tomcat@sha256:4d83bb7ea81dd33014daa5aebc7562a74493d4cd593deb22f42c66d2e76e23e5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.1 MB (3142908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74b1d78306e32f2d7846ccb26b92fcd23df4712151a5449fc386d75e8467f3ed`

```dockerfile
```

-	Layers:
	-	`sha256:9e0e81c9e5d24f0ca273be4f7048a5b09e36bf3aa845203fd8d2d218cf2a1910`  
		Last Modified: Tue, 14 Apr 2026 07:26:20 GMT  
		Size: 3.1 MB (3119719 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:24b0dded62fc05ed2cc0b42a1de969b820420605328c25eb7dae43ae3bd28b74`  
		Last Modified: Tue, 14 Apr 2026 07:26:19 GMT  
		Size: 23.2 KB (23189 bytes)  
		MIME: application/vnd.in-toto+json
