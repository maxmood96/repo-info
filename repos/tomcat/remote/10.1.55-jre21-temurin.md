...
```console
$ docker pull tomcat@sha256:2b1f6b181a9ed5affc7febb788c7a7ddc570cd9003d5d617a710c7c4b99a4740
```
...
### `tomcat:10.1.55-jre21-temurin` - linux; amd64
...
### `tomcat:10.1.55-jre21-temurin` - unknown; unknown
...
### `tomcat:10.1.55-jre21-temurin` - linux; arm64 variant v8
...
### `tomcat:10.1.55-jre21-temurin` - linux; ppc64le
...
### `tomcat:10.1.55-jre21-temurin` - linux; s390x
