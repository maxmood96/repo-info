...
```console
$ docker pull tomcat@sha256:bf19cb6a6890ce54bafed94681fed95a5a8641501ddd9ec6732bf0d5ffded5a8
```
...
### `tomcat:10.0.0-M7-jdk11-openjdk` - linux; amd64
...
### `tomcat:10.0.0-M7-jdk11-openjdk` - linux; arm64 variant v8
