...
```console
$ docker pull tomcat@sha256:48ff586b356a87eb547cafc885100bbb0710ed3f0b014095d2e5dd94adc2fbad
```
...
### `tomcat:10.1.6-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.6-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.6-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.6-jre17-temurin-jammy` - linux; s390x
