...
```console
$ docker pull tomcat@sha256:a0710a1897aebdfd61a04395b25c817d3b96ed3f4fb5052d5d19e6a65c66dfe0
```
...
```console
$ docker pull tomcat@sha256:7af197893831e2385d1db8f76cdc9f5e606ff71c21522098b5910ecbefda4f4b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.4 MB (133353248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6a3cb90ace13ef41e0f3cbbc507ee5d8f769b20de54c51657c2c3b39c26722f`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=9
# Tue, 16 Nov 2021 00:00:33 GMT
ENV TOMCAT_VERSION=9.0.55
# Tue, 16 Nov 2021 00:00:34 GMT
ENV TOMCAT_SHA512=a0c480b8bba09069bda3b57f54e658450a59d799474ad587dead0ffbf5074c16ee3f9f9c13312d0ff3227c7034589dabf25941fbd672838e9baeee9661e024dc
# Tue, 16 Nov 2021 00:00:36 GMT
COPY dir:ac6840ceb17d58a606333a08189c12be42d3f3bf4601e26e4b45489610760452 in /usr/local/tomcat 
# Tue, 16 Nov 2021 00:00:39 GMT
RUN set -eux; 	apt-get update; 	xargs -rt apt-get install -y --no-install-recommends < "$TOMCAT_NATIVE_LIBDIR/.dependencies.txt"; 	rm -rf /var/lib/apt/lists/*
# Tue, 16 Nov 2021 00:00:42 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 16 Nov 2021 00:00:42 GMT
EXPOSE 8080
# Tue, 16 Nov 2021 00:00:43 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:d2d4a06b5d4439b89dbd20dbe4f51f73718dd744f6bd6c6209aed7c70d53f893`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0f6dc7808408683880934edabf3ecbc6a638bb4edc11e989ee8b22e6dd9441f`  
		Last Modified: Tue, 16 Nov 2021 00:37:17 GMT  
		Size: 12.2 MB (12168876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0c8a2c7ecda49e7e5571f24a901173e36d191d0fc675aa5af2ba6f0659a6a18`  
		Last Modified: Tue, 16 Nov 2021 00:37:16 GMT  
