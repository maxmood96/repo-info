...
```console
$ docker pull tomcat@sha256:9572352369a4515e2ca4351e3f804355a45c0304347591046590aa238663717f
```
...
```console
$ docker pull tomcat@sha256:91d4628bce09e1e6f50c9708beefbec84a057f17a601b9fad70364b71e504947
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.4 MB (341358270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c13777fbd565ba442216fd0b2718adb90d3994a92d2ff547a39905e8e7c006e`
...
# Wed, 13 Jan 2021 08:29:50 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 13 Jan 2021 08:29:50 GMT
EXPOSE 8080
# Wed, 13 Jan 2021 08:29:51 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:7a55f05de5b7050369836bc19ff25b879b055d4eceb69f934b6398d77bd2957a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ebeda3c93904a6285f159f19e7256a84f1d5560ba9ec860f06a5455f08de7f4`  
		Last Modified: Wed, 13 Jan 2021 08:43:58 GMT  
		Size: 11.5 MB (11507158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8982e9d5a12e29d1c1f9dcfbf696a9c1d161465c84c7ebbc2a9b4e50c3c9c90f`  
		Last Modified: Wed, 13 Jan 2021 08:43:58 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
