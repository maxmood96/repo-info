...
```console
$ docker pull tomcat@sha256:f4d7546e47ff32e931822779b083796d6958898f54f2a68c063334ae52c6568d
```
...
### `tomcat:11.0.14-jre17-temurin` - linux; amd64
...
### `tomcat:11.0.14-jre17-temurin` - unknown; unknown
...
### `tomcat:11.0.14-jre17-temurin` - linux; arm variant v7
...
### `tomcat:11.0.14-jre17-temurin` - linux; arm64 variant v8
...
### `tomcat:11.0.14-jre17-temurin` - linux; ppc64le
...
### `tomcat:11.0.14-jre17-temurin` - linux; s390x
