...
```console
$ docker pull tomcat@sha256:ae6d781d529963427f3bfc7a5d648be78df3d428a67a12dadea1a64e6800d3e9
```
...
### `tomcat:11.0.0-M13-jdk21-temurin-jammy` - linux; amd64
...
### `tomcat:11.0.0-M13-jdk21-temurin-jammy` - linux; arm64 variant v8
