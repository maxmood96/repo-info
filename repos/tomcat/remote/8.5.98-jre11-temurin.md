...
```console
$ docker pull tomcat@sha256:d0b3edd2cd328a74f6ac998fbf447875f835b391258c7eeed63a1c1c6adee6b6
```
...
### `tomcat:8.5.98-jre11-temurin` - linux; amd64
...
### `tomcat:8.5.98-jre11-temurin` - linux; arm64 variant v8
...
### `tomcat:8.5.98-jre11-temurin` - linux; ppc64le
...
### `tomcat:8.5.98-jre11-temurin` - linux; s390x
