...
```console
$ docker pull tomcat@sha256:44c3eaa077f06d13813bb709c180a9dc7fe9584dced7a219d14f74afd0245388
```
...
### `tomcat:10.1.24-jre17-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.24-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.24-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:10.1.24-jre17-temurin-jammy` - linux; s390x
