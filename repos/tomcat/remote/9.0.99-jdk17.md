...
### `tomcat:9.0.99-jdk17` - linux; amd64
...
### `tomcat:9.0.99-jdk17` - unknown; unknown
...
### `tomcat:9.0.99-jdk17` - linux; arm variant v7
...
### `tomcat:9.0.99-jdk17` - linux; arm64 variant v8
...
### `tomcat:9.0.99-jdk17` - linux; ppc64le
...
### `tomcat:9.0.99-jdk17` - linux; riscv64
...
### `tomcat:9.0.99-jdk17` - linux; s390x
