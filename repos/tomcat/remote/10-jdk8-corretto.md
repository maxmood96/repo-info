...
```console
$ docker pull tomcat@sha256:0a17bb2fc1e224608b5ce01ef7406b5d6f71e704e762f2b9b16c464635078ca1
```
...
```console
$ docker pull tomcat@sha256:f4e90487920ef926f134a898d171eda404ba20f8ffe0035f6eab4b47f8cca11e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154540746 bytes)**  
...
# Thu, 09 Sep 2021 01:35:41 GMT
RUN set -eux; 	nativeLines="$(catalina.sh configtest 2>&1)"; 	nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')"; 	nativeLines="$(echo "$nativeLines" | sort -u)"; 	if ! echo "$nativeLines" | grep -E 'INFO: Loaded( APR based)? Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 09 Sep 2021 01:35:42 GMT
EXPOSE 8080
# Thu, 09 Sep 2021 01:35:42 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:86fce1c557a2ba9ecae2e93e421db19d862efd9652d88b2f66dfd6bb5cf47858`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa8ec680a4b9f72d2ff51810e88c11994954cbea562ec14815cfdca2266b42fb`  
		Last Modified: Thu, 09 Sep 2021 01:54:14 GMT  
		Size: 17.2 MB (17226886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d660207535e05fd317040891cb7b8d0c367b1c70844905023f45a3e4d7212b28`  
		Last Modified: Thu, 09 Sep 2021 01:54:07 GMT  
		Size: 133.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull tomcat@sha256:fe9a988dc9d09cc0b53df5ec0bbc81f78d0ef1f213c0d4d1f45c7bb414edeeac
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140082010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62c5dfe479e6e73d8536ec42d66664857121cefa9bf6029cc2e47a2617b38c0e`
-	Default Command: `["catalina.sh","run"]`
...
-	Layers:
	...
	-	`sha256:619e47ff854a46489d8017c1d37c4e3c99c008bb95523b4f68c6da232dbaaf16`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bf3d10e76d18e3d3a65cc7e0e776ec6fe142625b92fa85aa081bfbfe73c8cec`  
		Last Modified: Thu, 09 Sep 2021 01:58:41 GMT  
		Size: 17.2 MB (17246959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f43e91be4a6d021558c9e3df516b38ea0fe9e583564ccd3622d8ef31ce251841`  
		Last Modified: Thu, 09 Sep 2021 01:58:39 GMT  
		Size: 133.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
