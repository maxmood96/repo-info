...
```console
$ docker pull tomcat@sha256:0aa208411345c900f7f12a82fcf31e8a81b33bf0c66bd0e0971ad3d9474bf811
```
...
### `tomcat:10.1.28-jdk11-temurin-jammy` - linux; amd64
...
### `tomcat:10.1.28-jdk11-temurin-jammy` - unknown; unknown
...
### `tomcat:10.1.28-jdk11-temurin-jammy` - linux; arm variant v7
...
### `tomcat:10.1.28-jdk11-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:10.1.28-jdk11-temurin-jammy` - linux; ppc64le
