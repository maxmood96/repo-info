...
### `tomcat:11.0.8-jre17-temurin-jammy` - linux; arm variant v7
...
### `tomcat:11.0.8-jre17-temurin-jammy` - linux; arm64 variant v8
...
### `tomcat:11.0.8-jre17-temurin-jammy` - linux; ppc64le
...
### `tomcat:11.0.8-jre17-temurin-jammy` - linux; s390x
