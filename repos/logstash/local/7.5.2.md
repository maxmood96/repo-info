...
- Created: `2020-01-15T13:45:36.771637155Z`
- Virtual Size: ~ 804.75 Mb  
...
- Labels:
  ...
  - `org.label-schema.version=7.5.2`
...
### `rpm` package: `alsa-lib-1.1.8-1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls alsa-lib-1.1.8-1.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/alsa-lib-1.1.8-1.el7.src.rpm
```
...
### `rpm` package: `bind-license-9.11.4-9.P2.el7.noarch`
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/binutils-2.27-41.base.el7_7.1.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/ca-certificates-2019.2.32-76.el7_7.src.rpm
```

### `rpm` package: `centos-release-7-7.1908.0.el7.centos.x86_64`
...
### `rpm` package: `cryptsetup-libs-2.0.3-5.el7.x86_64`
...
### `rpm` package: `cups-libs-1.6.3-40.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls cups-libs-1.6.3-40.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/cups-1.6.3-40.el7.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/lvm2-2.02.185-2.el7_7.2.src.rpm
```
...
### `rpm` package: `dracut-033-564.el7.x86_64`
...
### `rpm` package: `elfutils-libs-0.176-2.el7.x86_64`
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/freetype-2.8-14.el7.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/hostname-3.13-3.el7_7.1.src.rpm
```
...
### `rpm` package: `java-11-openjdk-11.0.5.10-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-11.0.5.10-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.5.10-0.el7_7.src.rpm
```

### `rpm` package: `java-11-openjdk-devel-11.0.5.10-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-devel-11.0.5.10-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.5.10-0.el7_7.src.rpm
...
### `rpm` package: `java-11-openjdk-headless-11.0.5.10-0.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-headless-11.0.5.10-0.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.5.10-0.el7_7.src.rpm
...
### `rpm` package: `javapackages-tools-3.4.1-11.el7.noarch`
...
### `rpm` package: `kmod-libs-20-25.el7.x86_64`
...
### `rpm` package: `kpartx-0.4.9-127.el7.x86_64`
...
### `rpm` package: `libX11-1.6.7-2.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libX11-1.6.7-2.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/libX11-1.6.7-2.el7.src.rpm
```

### `rpm` package: `libX11-common-1.6.7-2.el7.noarch`
...
```console
$ yumdownloader --quiet --source --urls libX11-common-1.6.7-2.el7.noarch
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/libX11-1.6.7-2.el7.src.rpm
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/util-linux-2.23.2-61.el7_7.1.src.rpm
```
...
### `rpm` package: `libjpeg-turbo-1.2.90-8.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libjpeg-turbo-1.2.90-8.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/libjpeg-turbo-1.2.90-8.el7.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/nss-3.44.0-7.el7_7.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/nss-softokn-3.44.0-8.el7_7.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/nss-util-3.44.0-4.el7_7.src.rpm
```
...
### `rpm` package: `passwd-0.79-5.el7.x86_64`
...
### `rpm` package: `python-2.7.5-86.el7.x86_64`
...
### `rpm` package: `python-libs-2.7.5-86.el7.x86_64`
...
### `rpm` package: `rpm-4.11.3-40.el7.x86_64`
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/systemd-219-67.el7_7.2.src.rpm
```
...
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/tzdata-2019c-1.el7.src.rpm
```

### `rpm` package: `tzdata-java-2019c-1.el7.noarch`
...
```console
$ yumdownloader --quiet --source --urls tzdata-java-2019c-1.el7.noarch
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/tzdata-2019c-1.el7.src.rpm
...
### `rpm` package: `xorg-x11-font-utils-7.5-21.el7.x86_64`
...
### `rpm` package: `yum-3.4.3-163.el7.centos.noarch`
...
### `rpm` package: `yum-plugin-fastestmirror-1.1.31-52.el7.noarch`
...
### `rpm` package: `yum-plugin-ovl-1.1.31-52.el7.noarch`
