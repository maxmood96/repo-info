...
- Created: `2020-05-04T18:38:56.674239941Z`
...
### `rpm` package: `java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8.src.rpm
```

### `rpm` package: `java-1.8.0-openjdk-devel-1.8.0.252.b09-2.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-devel-1.8.0.252.b09-2.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8.src.rpm
...
### `rpm` package: `java-1.8.0-openjdk-headless-1.8.0.252.b09-2.el7_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-headless-1.8.0.252.b09-2.el7_8
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.252.b09-2.el7_8.src.rpm
...
### `rpm` package: `mesa-libEGL-18.3.4-7.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libEGL-18.3.4-7.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/mesa-18.3.4-7.el7.src.rpm
```

### `rpm` package: `mesa-libGL-18.3.4-7.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libGL-18.3.4-7.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/mesa-18.3.4-7.el7.src.rpm
...
### `rpm` package: `mesa-libgbm-18.3.4-7.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libgbm-18.3.4-7.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/mesa-18.3.4-7.el7.src.rpm
...
### `rpm` package: `mesa-libglapi-18.3.4-7.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls mesa-libglapi-18.3.4-7.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/mesa-18.3.4-7.el7.src.rpm
