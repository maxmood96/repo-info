...
```console
$ docker pull geonetwork@sha256:09a071bee4e4dd27e1383f6fe3ab9eebc7e9547b7884a8ac8839dea3541b081f
```
...
```console
$ docker pull geonetwork@sha256:23de5136ecf6ee16a4f86d6bd4c1d86e47bea96a05e259bc27711bd05b2e66f0
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.5 MB (412457005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0d1a2c36bdb56e9c80784cc123bde4962122eaa0a885d07ca4175b6e10b41ed`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
CMD ["catalina.sh" "run"]
# Mon, 15 Apr 2024 20:31:32 GMT
ENV GN_FILE=geonetwork.war
# Mon, 15 Apr 2024 20:31:32 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Mon, 15 Apr 2024 20:31:33 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Mon, 15 Apr 2024 20:31:33 GMT
ENV GN_VERSION=3.12.11
# Mon, 15 Apr 2024 20:31:34 GMT
ENV GN_DOWNLOAD_MD5=2ece7076f05068e7a5270af03e32d632
# Mon, 15 Apr 2024 20:31:34 GMT
WORKDIR /usr/local/tomcat/webapps
# Mon, 15 Apr 2024 20:31:58 GMT
RUN apt-get update &&      apt-get install -y --no-install-recommends           unzip           curl &&     rm -rf /var/lib/apt/lists/* &&      curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/${GN_FILE}/download &&      echo "${GN_DOWNLOAD_MD5} *${GN_FILE}" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Mon, 15 Apr 2024 20:32:02 GMT
COPY file:0804862fd42c05f06dfa65cb1e5dad9a956d8ac6a3ddd4d962847ba159f5cfe6 in /entrypoint.sh 
# Mon, 15 Apr 2024 20:32:03 GMT
WORKDIR /usr/local/tomcat
# Mon, 15 Apr 2024 20:32:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 15 Apr 2024 20:32:04 GMT
CMD ["catalina.sh" "run"]
# Mon, 15 Apr 2024 20:32:22 GMT
RUN apt-get update && apt-get install -y --no-install-recommends postgresql-client &&     rm -rf /var/lib/apt/lists/*
# Mon, 15 Apr 2024 20:32:26 GMT
RUN sed -i -e 's#<import resource="../config-db/${geonetwork.db.type:h2}.xml"/>#<!--<import resource="../config-db/${geonetwork.db.type:h2}.xml"/-->#g' "${CATALINA_HOME}/webapps/geonetwork/WEB-INF/config-node/srv.xml" && sed -i -e 's#<!--<import resource="../config-db/postgres.xml"/>-->#<import resource="../config-db/postgres.xml"/>#g' "${CATALINA_HOME}/webapps/geonetwork/WEB-INF/config-node/srv.xml"
# Mon, 15 Apr 2024 20:32:26 GMT
COPY file:83f69d2041e5fb378033b0db57e096c81ba0725102ab4da4f089685e748fcce3 in /usr/local/tomcat/webapps/geonetwork/WEB-INF/config-db/jdbc.properties 
# Mon, 15 Apr 2024 20:32:27 GMT
COPY file:c88411abba7ad9b7bb75019f08755dbfa163d2fc7fdd80676bf9350c4c56a19c in /entrypoint.sh 
# Mon, 15 Apr 2024 20:32:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 15 Apr 2024 20:32:28 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a67aeb0fd48423cee898e4c12c63739dbdf65023cb5495a6a4fac20dc7e705a1`  
		...
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23a219ff732beab1965ac85c3cd2e75b6c6b014339dd118b046b0d5d97f5e5cd`  
		Last Modified: Mon, 15 Apr 2024 20:32:54 GMT  
		Size: 234.8 MB (234817165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb10a770b9639db50c3c037ee9681e7062e3c082a51bd1f5e74cfbbd14375035`  
		Last Modified: Mon, 15 Apr 2024 20:32:39 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dab414d6b02103e8a7f1136f1b8afdb5fab1509b3febdf2c7bcb73d32a86284`  
		Last Modified: Mon, 15 Apr 2024 20:33:15 GMT  
		Size: 14.2 MB (14196856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2ce36f57c6403e0f78904aa7a40e2fc70b2cace55d608554efbdfe610e34a59`  
		Last Modified: Mon, 15 Apr 2024 20:33:12 GMT  
		Size: 1.3 KB (1268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8951d3fc2dbfeacb9a184c65ad600f2040f15b7434af03b16c67f9e8a9cdb6a9`  
		Last Modified: Mon, 15 Apr 2024 20:33:12 GMT  
		Size: 1.1 KB (1127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:976af0bb77b251599cb44aad97575b4f3d0aff9a57167c2bc244d5ebe33833b8`  
		Last Modified: Mon, 15 Apr 2024 20:33:12 GMT  
		Size: 971.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
