...
```console
$ docker pull geonetwork@sha256:32646e7bee4230267bc21169ecf04c3fccde0b3efc1c2581c167740c5d277322
```
...
```console
$ docker pull geonetwork@sha256:898a324d0c9818ca982725f4b7aeb22350edbb81478ad05625d1bf974cc748d9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **386.8 MB (386824550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea69a4f08ab5e675ffe273d71f5aa1d791929cb11ed351a1a69226e5a0f74f37`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
