...
```console
$ docker pull geonetwork@sha256:7b9c806f66f711ba6473b23ca85509d1a1dca2c7452345ee131711fa0e483aff
```
...
```console
$ docker pull geonetwork@sha256:71dd11107895f28c09e112e16ca3b95b29d51754a8ea93a4bda8178f2ddf0f17
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **545.0 MB (544975467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de382093791e4ff57f1ebe86fc4ee1264e4f967582f26950b0751adccc4f231a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
