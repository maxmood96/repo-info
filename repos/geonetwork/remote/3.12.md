...
```console
$ docker pull geonetwork@sha256:a440aefe74ab4a0b00fecb19afd6efa47a95c205b82ffa6b255920a0b97f698e
```
...
```console
$ docker pull geonetwork@sha256:a7eb514599ca4c36aeaf624b82f008932263d7c2efdb01a572447083f2fe304f
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **398.3 MB (398257058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07bd9bb94949093e45289ae3ea092b34aa2bddf218192c073472560a8ad5af7a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
