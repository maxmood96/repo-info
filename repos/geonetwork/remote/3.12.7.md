...
```console
$ docker pull geonetwork@sha256:ac37238365bc6d02de4d84e56f51e596bae637b85b4f50e599cc3fa1b6287d5a
```
...
```console
$ docker pull geonetwork@sha256:cc25e0c0661996616ef6dc1cfcdf191830f5ef3b9d6ae0e6903118f27b2f216a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **473.8 MB (473805533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2baf1c241996b76932bf55c352e3f123c097ccfefd8582198b6d7cd0282f5c8b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
