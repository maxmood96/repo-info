...
```console
$ docker pull geonetwork@sha256:6ba0d108d0838826103372f67badf239f2f7a1c11f7b9bb7406cbdcde4ede5a1
```
...
```console
$ docker pull geonetwork@sha256:61025906054c6d3888b0e2522ed3add0cb581afc28fd5f1252f2087cd137a74e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **517.2 MB (517206389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ce91c9bb4ba93dbfd93dcff736109a73ff06e49b3d3bc376c1835a39245bc1b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 27 May 2021 21:54:15 GMT
ENV GN_VERSION=3.10.6
# Thu, 27 May 2021 21:54:16 GMT
ENV GN_DOWNLOAD_MD5=6f6980788a4df8477b20aa114bae2ef9
# Thu, 27 May 2021 21:54:16 GMT
WORKDIR /usr/local/tomcat/webapps
# Thu, 27 May 2021 21:54:31 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/${GN_FILE}/download &&      echo "$GN_DOWNLOAD_MD5 *${GN_FILE}" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Thu, 27 May 2021 21:54:32 GMT
COPY file:0804862fd42c05f06dfa65cb1e5dad9a956d8ac6a3ddd4d962847ba159f5cfe6 in /entrypoint.sh 
# Thu, 27 May 2021 21:54:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 May 2021 21:54:32 GMT
...
-	Layers:
	...
	-	`sha256:2228df1ba28718e882a78dba794ce4c12d562a57a68c71eb8ab7906a4896b08c`  
		...
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:064ad70ae60a5832997525db5b04b5e76af6c4d537d096eb418bb914e4d7db30`  
		Last Modified: Thu, 27 May 2021 21:56:23 GMT  
		Size: 276.3 MB (276302219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3250c8a21ed78a1eca23b6817711197c6b640c1ab6b3ecc185a079bd6dd75f70`  
		Last Modified: Thu, 27 May 2021 21:56:02 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
