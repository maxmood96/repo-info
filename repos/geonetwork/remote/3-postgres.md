...
```console
$ docker pull geonetwork@sha256:632b14ba441fa4ae316918ad13cd1fea8ece0359030c1c39c2bf10355c731659
```
...
```console
$ docker pull geonetwork@sha256:a8cce833285394f44cf26823399bb266aa0f3384e9bed62c0b624d3642df7bd3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **479.3 MB (479296476 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:798beb1747b755fe261ab110c6af6584288be6fd33a103e28e29c0c58a0ac86e`
...
# Tue, 22 Mar 2022 04:53:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 22 Mar 2022 04:53:38 GMT
CMD ["catalina.sh" "run"]
# Tue, 22 Mar 2022 04:53:48 GMT
RUN apt-get update && apt-get install -y --no-install-recommends postgresql-client &&     rm -rf /var/lib/apt/lists/*
# Tue, 22 Mar 2022 04:53:49 GMT
...
-	Layers:
	...
	-	`sha256:d22974530dde378d68cb72f4df94d44cb2dfb9d76aae8d7158913f9b127c0da9`  
		...
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0ff1b582bb9f6a7642b424f86d959b95ac89a657a2c84fd008652053228fff1`  
		Last Modified: Tue, 22 Mar 2022 04:54:20 GMT  
		Size: 227.3 MB (227271894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:148650cd6c6294c9171bf8f1486c73018efbde8b92fa32cd6d358c0044d10242`  
		Last Modified: Tue, 22 Mar 2022 04:54:06 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9427a661574451cf0618013ae7c7fb7f93a520ce213e6d1edb4be7e500255f8`  
		Last Modified: Tue, 22 Mar 2022 04:54:34 GMT  
		Size: 3.5 MB (3503967 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43767dc7b535f2c94f7da07f9f6f0485a2815e4569666d3d360c29aec3377b32`  
		Last Modified: Tue, 22 Mar 2022 04:54:33 GMT  
		Size: 1.3 KB (1269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:743014165467ef11fd1ae0a9324e2abebcd4ac2f6075609c70c011b5216a01c6`  
		Last Modified: Tue, 22 Mar 2022 04:54:33 GMT  
		Size: 1.1 KB (1128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:637b37248627168e9c1a6ef1d743ef17df702cc2e7ff23e8ee646a682eb3bd10`  
		Last Modified: Tue, 22 Mar 2022 04:54:34 GMT  
		Size: 973.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull geonetwork@sha256:2dca628a47216695be7159bbf5e4323a454d88f99cd96689d626998f582ee176
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **476.2 MB (476193101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8ef42f30c11b17183470360360d7ed7f07c2ed667fed9cf7a0b5f33833bf5f1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 22 Mar 2022 10:45:03 GMT
CMD ["catalina.sh" "run"]
# Tue, 22 Mar 2022 12:55:38 GMT
ENV GN_FILE=geonetwork.war
# Tue, 22 Mar 2022 12:55:38 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Tue, 22 Mar 2022 12:55:39 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Tue, 22 Mar 2022 12:57:30 GMT
ENV GN_VERSION=3.12.3
# Tue, 22 Mar 2022 12:57:31 GMT
ENV GN_DOWNLOAD_MD5=ecbbff832c8a6edf22e06aa1870dddab
# Tue, 22 Mar 2022 12:57:32 GMT
WORKDIR /usr/local/tomcat/webapps
# Tue, 22 Mar 2022 12:57:54 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/${GN_FILE}/download &&      echo "${GN_DOWNLOAD_MD5} *${GN_FILE}" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Tue, 22 Mar 2022 12:57:55 GMT
COPY file:0804862fd42c05f06dfa65cb1e5dad9a956d8ac6a3ddd4d962847ba159f5cfe6 in /entrypoint.sh 
# Tue, 22 Mar 2022 12:57:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 22 Mar 2022 12:57:57 GMT
CMD ["catalina.sh" "run"]
# Tue, 22 Mar 2022 12:58:07 GMT
RUN apt-get update && apt-get install -y --no-install-recommends postgresql-client &&     rm -rf /var/lib/apt/lists/*
# Tue, 22 Mar 2022 12:58:09 GMT
RUN sed -i -e 's#<import resource="../config-db/${geonetwork.db.type:h2}.xml"/>#<!--<import resource="../config-db/${geonetwork.db.type:h2}.xml"/-->#g' "${CATALINA_HOME}/webapps/geonetwork/WEB-INF/config-node/srv.xml" && sed -i -e 's#<!--<import resource="../config-db/postgres.xml"/>-->#<import resource="../config-db/postgres.xml"/>#g' "${CATALINA_HOME}/webapps/geonetwork/WEB-INF/config-node/srv.xml"
# Tue, 22 Mar 2022 12:58:10 GMT
COPY file:83f69d2041e5fb378033b0db57e096c81ba0725102ab4da4f089685e748fcce3 in /usr/local/tomcat/webapps/geonetwork/WEB-INF/config-db/jdbc.properties 
# Tue, 22 Mar 2022 12:58:11 GMT
COPY file:c88411abba7ad9b7bb75019f08755dbfa163d2fc7fdd80676bf9350c4c56a19c in /entrypoint.sh 
# Tue, 22 Mar 2022 12:58:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 22 Mar 2022 12:58:12 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:b55a04949530c425e60697d03c6e2a9f4c27717744909398557a4994f8a8024d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fa8961538a268d794b3b783941f08f99b17e5f6a51ac81630f9fa046cb6ccf0`  
		Last Modified: Tue, 22 Mar 2022 12:59:03 GMT  
		Size: 227.3 MB (227270834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76f5179ddad286fab68ce74b230e4839608b21296abf84a2f9f0d1144d51cba6`  
		Last Modified: Tue, 22 Mar 2022 12:58:46 GMT  
		Size: 251.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91deeb9dd1f6e8e9d32afd08a4bacfb3b37406f52c7a63da3866e6ae5ccdb11e`  
		Last Modified: Tue, 22 Mar 2022 12:59:19 GMT  
		Size: 3.3 MB (3261089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19c85348de61f300ee929a451d931f64da8bdd9f6c4425e47e0ad4a38da99808`  
		Last Modified: Tue, 22 Mar 2022 12:59:19 GMT  
		Size: 1.3 KB (1269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d606994ed9fd7490e6c9712ae9df553843503cfbe17cfbd70f6d54e835699b2e`  
		Last Modified: Tue, 22 Mar 2022 12:59:19 GMT  
		Size: 1.1 KB (1127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f12052a0e89cd386a6e3f609f00a14961435c44ac7aa59034a164393281ed5e3`  
		Last Modified: Tue, 22 Mar 2022 12:59:19 GMT  
		Size: 974.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
