...
- Created: `2021-04-08T19:23:14.855796341Z`
- Virtual Size: ~ 316.71 Mb  
...
### `rpm` package: `basesystem-minimal-8-0.4.mga8.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/bzip2-1.0.8-2.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/coreutils-8.32-2.mga8.src.rpm
```
...
### `rpm` package: `cracklib-dicts-2.9.7-4.mga9.x86_64`
...
### `rpm` package: `curl-7.76.0-1.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/dbus-1.13.18-3.mga8.src.rpm
```
...
### `rpm` package: `dnf-4.6.0-2.mga9.noarch`

Licenses (from `rpm --query`): GPLv2+ and GPLv2 and GPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `dnf-data-4.6.0-2.mga9.noarch`

Licenses (from `rpm --query`): GPLv2+ and GPLv2 and GPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `e2fsprogs-1.46.2-2.mga9.x86_64`
...
### `rpm` package: `file-5.40-3.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/filesystem-2.1.9-34.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/findutils-4.8.0-1.mga8.src.rpm
```
...
### `rpm` package: `glibc-2.33-7.mga9.x86_64`

Licenses (from `rpm --query`): LGPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gnupg2-2.2.27-3.mga9.x86_64`

Licenses (from `rpm --query`): GPLv3+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gobject-introspection-1.68.0-1.mga9.x86_64`
...
### `rpm` package: `grep-3.6-2.mga8.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/grep-3.6-2.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/hostname-3.23-2.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/ifmetric-0.3-19.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/ifplugd-0.28-23.mga8.src.rpm
```
...
### `rpm` package: `iputils-20210202-1.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/kbd-2.4.0-1.mga8.src.rpm
```
...
### `rpm` package: `krb5-1.19.1-1.mga9.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `less-575-1.mga9.x86_64`
...
### `rpm` package: `lib64audit1-3.0.1-2.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64blkid1-2.36.2-2.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64brotlicommon1-1.0.9-3.mga9.x86_64`
...
### `rpm` package: `lib64com_err2-1.46.2-2.mga9.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64comps0-0.1.15-3.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64crack2-2.9.7-4.mga9.x86_64`
...
### `rpm` package: `lib64curl4-7.76.0-1.mga9.x86_64`
...
### `rpm` package: `lib64elfutils1-0.183-1.mga9.x86_64`
...
### `rpm` package: `lib64ext2fs2-1.46.2-2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64fdisk1-2.36.2-2.mga9.x86_64`
...
### `rpm` package: `lib64gio2.0_0-2.68.0-1.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64girepository1.0_1-1.68.0-1.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64glib-gir2.0-1.68.0-1.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64glib2.0_0-2.68.0-1.mga9.x86_64`
...
### `rpm` package: `lib64gpgme11-1.15.1-2.mga9.x86_64`
...
### `rpm` package: `lib64krb53-1.19.1-1.mga9.x86_64`
...
### `rpm` package: `lib64ldap2.4_2-2.4.58-1.mga9.x86_64`

Licenses (from `rpm --query`): OpenLDAP

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64lua5.4-5.4.3-4.mga9.x86_64`
...
### `rpm` package: `lib64modulemd2-2.12.0-2.mga9.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64mount1-2.36.2-2.mga9.x86_64`
...
### `rpm` package: `lib64nghttp2_14-1.43.0-1.mga9.x86_64`
...
### `rpm` package: `lib64python3.9-stdlib-3.9.4-1.mga9.x86_64`
...
### `rpm` package: `lib64rpm9-4.16.1.3-2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+ with exceptions

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64rpmbuild9-4.16.1.3-2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+ with exceptions

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64rpmsign9-4.16.1.3-2.mga9.x86_64`
...
### `rpm` package: `lib64selinux1-3.2-0.rc1.5.mga9.x86_64`
...
### `rpm` package: `lib64sqlite3_0-3.35.4-1.mga9.x86_64`

Licenses (from `rpm --query`): Public Domain

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `lib64ss2-1.46.2-2.mga9.x86_64`
...
### `rpm` package: `lib64systemd0-248-2.mga9.x86_64`
...
### `rpm` package: `lib64udev1-248-2.mga9.x86_64`
...
### `rpm` package: `lib64verto1-0.3.2-1.mga9.x86_64`
...
### `rpm` package: `lib64xml2_2-2.9.10-8.mga9.x86_64`
...
### `rpm` package: `lib64zstd1-1.4.9-1.mga9.x86_64`

Licenses (from `rpm --query`): BSD and GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libgcc1-10.3.0-0.RC.2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv3+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libgomp1-10.3.0-0.RC.2.mga9.x86_64`
...
### `rpm` package: `libselinux-3.2-0.rc1.5.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/libselinux-3.2-0.rc1.5.mga9.src.rpm
```
...
### `rpm` package: `libuser-0.63-1.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/libuser-0.63-1.mga9.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/libutempter-1.2.1-1.mga8.src.rpm
```
...
### `rpm` package: `locales-en-2.33-1.mga9.x86_64`
...
### `rpm` package: `lsb-release-3.1-3.mga9.noarch`
...
### `rpm` package: `mageia-release-common-9-0.4.mga9.x86_64`

Licenses (from `rpm --query`): GPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `mageia-repos-9-0.0.1.mga8.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/mageia-repos-9-0.0.1.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/net-tools-2.0-0.20150915git.6.mga8.src.rpm
```
...
### `rpm` package: `openldap-2.4.58-1.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/passwd-0.80-2.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/procps-ng-3.3.17-1.mga9.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/psmisc-23.4-1.mga9.src.rpm
```
...
### `rpm` package: `python-pip-wheel-20.3.3-5.mga9.noarch`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python-rpm-macros-3.9-7.mga9.noarch`
...
### `rpm` package: `python-srpm-macros-3.9-7.mga9.noarch`
...
### `rpm` package: `python3-dnf-4.6.0-2.mga9.noarch`

Licenses (from `rpm --query`): GPLv2+ and GPLv2 and GPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-gobject-base-3.40.1-1.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-gpg-1.15.1-2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-hawkey-0.58.0-2.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-libcomps-0.1.15-3.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-libdnf-0.58.0-2.mga9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-libmodulemd-2.12.0-2.mga9.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-rpm-4.16.1.3-2.mga9.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-rpm-macros-3.9-7.mga9.noarch`
...
### `rpm` package: `rootcerts-20210223.00-1.mga9.noarch`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/run-parts-4.8.4-3.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/sash-3.8-9.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/sed-4.8-3.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/shared-mime-info-2.1-2.mga8.src.rpm
```
...
### `rpm` package: `tar-1.34-1.mga9.x86_64`
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/tar-1.34-1.mga9.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/time-1.9-4.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/traceroute-2.1.0-3.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/which-2.21-6.mga8.src.rpm
```
...
https://mirror2.tuxinator.org/mageia/distrib/cauldron/SRPMS/core/release/xz-5.2.5-2.mga8.src.rpm
```
