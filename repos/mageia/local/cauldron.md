...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/bzip2-1.0.8-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/coreutils-8.32-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/dbus-1.13.18-3.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/filesystem-2.1.9-34.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/findutils-4.8.0-1.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/grep-3.6-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/hostname-3.23-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/ifmetric-0.3-19.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/ifplugd-0.28-23.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/kbd-2.4.0-1.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/pam_userpass-1.0.2-15.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/libselinux-3.2-0.rc1.5.mga9.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/libuser-0.63-1.mga9.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/libutempter-1.2.1-1.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/mageia-repos-9-0.0.1.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/net-tools-2.0-0.20150915git.6.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/passwd-0.80-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/procps-ng-3.3.17-1.mga9.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/psmisc-23.4-1.mga9.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/run-parts-4.8.4-3.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/sash-3.8-9.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/sed-4.8-3.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/shared-mime-info-2.1-2.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/tar-1.34-1.mga9.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/time-1.9-4.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/traceroute-2.1.0-3.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/which-2.21-6.mga8.src.rpm
```
...
http://ftp.fau.de/mageia/distrib/cauldron/SRPMS/core/release/xz-5.2.5-2.mga8.src.rpm
```
