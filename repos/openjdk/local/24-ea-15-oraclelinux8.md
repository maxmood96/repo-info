# `openjdk:24-ea-15-jdk-oraclelinux8`

## Docker Metadata

- Image ID: `sha256:efbd5059dd0e1598353ecc23a3140a6983c9cfa97a1071600051947deffd70b8`
- Created: `2024-09-14T06:48:15Z`
- Virtual Size: ~ 519.27 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.1.2-1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/bash-4.4.20-5.el8.src.rpm
```

### `rpm` package: `binutils-2.30-123.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.30-123.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/binutils-2.30-123.0.2.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/binutils-2.30-123.0.2.el8.src.rpm
```
...
### `rpm` package: `ca-certificates-2024.2.69_v8.0.303-80.0.el8_10.noarch`
...
```console
$ dnf --quiet download --source --url ca-certificates-2024.2.69_v8.0.303-80.0.el8_10.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/ca-certificates-2024.2.69_v8.0.303-80.0.el8_10.src.rpm
```

### `rpm` package: `chkconfig-1.19.2-1.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.19.2-1.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/chkconfig-1.19.2-1.0.2.el8.src.rpm
```

### `rpm` package: `coreutils-single-8.30-15.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.30-15.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/coreutils-8.30-15.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/crypto-policies-20230731-1.git3177e06.el8.src.rpm
```

### `rpm` package: `curl-7.61.1-34.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.61.1-34.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8_10.2.src.rpm
```
...
### `rpm` package: `dejavu-fonts-common-2.35-7.el8.noarch`
...
```console
$ dnf --quiet download --source --url dejavu-fonts-common-2.35-7.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dejavu-fonts-2.35-7.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dejavu-fonts-2.35-7.el8.src.rpm
```

### `rpm` package: `dejavu-sans-fonts-2.35-7.el8.noarch`
...
```console
$ dnf --quiet download --source --url dejavu-sans-fonts-2.35-7.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dejavu-fonts-2.35-7.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dejavu-fonts-2.35-7.el8.src.rpm
```
...
### `rpm` package: `expat-2.2.5-13.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url expat-2.2.5-13.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/expat-2.2.5-13.0.1.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url file-libs-5.33-26.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/file-5.33-26.el8.src.rpm
```
...
### `rpm` package: `glib2-2.56.4-162.el8.x86_64`
...
```console
$ dnf --quiet download --source --url glib2-2.56.4-162.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glib2-2.56.4-162.el8.src.rpm
```

### `rpm` package: `glibc-2.28-251.0.2.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-251.0.2.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
```

### `rpm` package: `glibc-common-2.28-251.0.2.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-251.0.2.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-251.0.2.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-251.0.2.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.2.src.rpm
```
...
```console
$ dnf --quiet download --source --url gmp-6.1.2-11.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gmp-6.1.2-11.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gnutls-3.6.16-8.el8_9.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gnutls-3.6.16-8.el8_9.3.src.rpm
```
...
### `rpm` package: `gpgme-1.13.1-12.el8.x86_64`
...
```console
$ dnf --quiet download --source --url gpgme-1.13.1-12.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gpgme-1.13.1-12.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gpgme-1.13.1-12.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url keyutils-libs-1.5.10-9.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/keyutils-1.5.10-9.0.1.el8.src.rpm
```

### `rpm` package: `krb5-libs-1.18.2-29.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-29.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-29.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/acl-2.2.53-3.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libarchive-3.3.3-5.el8.src.rpm
```
...
### `rpm` package: `libblkid-2.32.1-46.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libblkid-2.32.1-46.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcap-2.48-6.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libcap-2.48-6.el8_9.src.rpm
```
...
### `rpm` package: `libcurl-7.61.1-34.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.61.1-34.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8_10.2.src.rpm
```

### `rpm` package: `libdb-5.3.28-42.0.1.el8_4.x86_64`
...
```console
$ dnf --quiet download --source --url libdb-5.3.28-42.0.1.el8_4
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libdb-5.3.28-42.0.1.el8_4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdb-5.3.28-42.0.1.el8_4.src.rpm
```

### `rpm` package: `libdb-utils-5.3.28-42.0.1.el8_4.x86_64`
...
```console
$ dnf --quiet download --source --url libdb-utils-5.3.28-42.0.1.el8_4
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libdb-5.3.28-42.0.1.el8_4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdb-5.3.28-42.0.1.el8_4.src.rpm
```

### `rpm` package: `libdnf-0.63.0-20.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-20.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-20.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libffi-3.1-24.el8.src.rpm
```

### `rpm` package: `libgcc-8.5.0-22.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-8.5.0-22.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-22.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-22.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libmount-2.32.1-46.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libmount-2.32.1-46.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/nghttp2-1.33.0-6.el8_10.1.src.rpm
```
...
### `rpm` package: `librepo-1.14.2-5.el8.x86_64`
...
```console
$ dnf --quiet download --source --url librepo-1.14.2-5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/librepo-1.14.2-5.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-8.el8.src.rpm
```
...
### `rpm` package: `libsmartcols-2.32.1-46.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libsmartcols-2.32.1-46.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsolv-0.7.20-6.el8.src.rpm
```

### `rpm` package: `libssh-0.9.6-14.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libssh-0.9.6-14.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libssh-0.9.6-14.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libssh-0.9.6-14.el8.src.rpm
```

### `rpm` package: `libssh-config-0.9.6-14.el8.noarch`
...
```console
$ dnf --quiet download --source --url libssh-config-0.9.6-14.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libssh-0.9.6-14.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libssh-0.9.6-14.el8.src.rpm
```

### `rpm` package: `libstdc++-8.5.0-22.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-8.5.0-22.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-22.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-22.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libuuid-2.32.1-46.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libuuid-2.32.1-46.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-46.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libxml2-2.9.7-18.el8_10.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libxml2-2.9.7-18.el8_10.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/ncurses-6.1-10.20180224.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openldap-2.4.46-19.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-libs-1.1.1k-12.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-12.el8_9.src.rpm
```

### `rpm` package: `oraclelinux-release-8.10-1.0.7.el8.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-8.10-1.0.7.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/oraclelinux-release-8.10-1.0.7.el8.src.rpm
```

### `rpm` package: `oraclelinux-release-el8-1.0-38.el8.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el8-1.0-38.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el8-1.0-38.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url p11-kit-0.23.22-2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/p11-kit-0.23.22-2.el8.src.rpm
```

### `rpm` package: `p11-kit-trust-0.23.22-2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url p11-kit-trust-0.23.22-2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/p11-kit-0.23.22-2.el8.src.rpm
```
...
### `rpm` package: `redhat-release-8.10-0.2.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url redhat-release-8.10-0.2.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/redhat-release-8.10-0.2.0.1.el8.src.rpm
```

### `rpm` package: `rpm-4.14.3-31.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.14.3-31.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
```

### `rpm` package: `rpm-libs-4.14.3-31.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.14.3-31.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-31.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url setup-2.12.2-9.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/setup-2.12.2-9.el8.src.rpm
```

### `rpm` package: `shadow-utils-4.6-22.el8.x86_64`
...
```console
$ dnf --quiet download --source --url shadow-utils-4.6-22.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/shadow-utils-4.6-22.el8.src.rpm
```

### `rpm` package: `sqlite-libs-3.26.0-19.0.1.el8_9.x86_64`
...
### `rpm` package: `systemd-libs-239-82.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.2.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tar-1.30-9.el8.src.rpm
```

### `rpm` package: `tzdata-2024a-1.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2024a-1.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/tzdata-2024a-1.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tzdata-2024a-1.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url zlib-1.2.11-25.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-25.el8.src.rpm
```
