...
### `rpm` package: `binutils-2.35.2-54.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-54.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-54.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-54.0.1.el9.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-54.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-54.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-54.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-54.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.191-4.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.191-4.el9.src.rpm
```
...
### `rpm` package: `kmod-libs-28-10.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url kmod-libs-28-10.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/kmod-28-10.0.1.el9.src.rpm
```
...
### `rpm` package: `libdb-5.3.28-54.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libdb-5.3.28-54.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdb-5.3.28-54.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libdb-5.3.28-54.0.1.el9.src.rpm
```
...
### `rpm` package: `libfdisk-2.37.4-20.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libfdisk-2.37.4-20.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
```
...
### `rpm` package: `pam-1.5.1-22.0.1.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url pam-1.5.1-22.0.1.el9_5
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-22.0.1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-22.0.1.el9_5.src.rpm
```
...
### `rpm` package: `selinux-policy-38.1.45-3.0.1.el9_5.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-38.1.45-3.0.1.el9_5.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/selinux-policy-38.1.45-3.0.1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/selinux-policy-38.1.45-3.0.1.el9_5.src.rpm
```

### `rpm` package: `selinux-policy-targeted-38.1.45-3.0.1.el9_5.noarch`
...
```console
$ dnf --quiet download --source --url selinux-policy-targeted-38.1.45-3.0.1.el9_5.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/selinux-policy-38.1.45-3.0.1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/selinux-policy-38.1.45-3.0.1.el9_5.src.rpm
```
...
### `rpm` package: `systemd-252-46.0.3.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-46.0.3.el9_5.2
...
### `rpm` package: `systemd-pam-252-46.0.3.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-46.0.3.el9_5.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-46.0.3.el9_5.2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-46.0.3.el9_5.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
```
...
### `rpm` package: `util-linux-2.37.4-20.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-2.37.4-20.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
```

### `rpm` package: `util-linux-core-2.37.4-20.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-core-2.37.4-20.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-20.0.1.el9.src.rpm
```
