...
### `rpm` package: `audit-libs-3.1.2-1.0.1.el8_10.1.x86_64`
...
```console
$ dnf --quiet download --source --url audit-libs-3.1.2-1.0.1.el8_10.1
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.1.2-1.0.1.el8_10.1.src.rpm
```
...
### `rpm` package: `binutils-2.30-125.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.30-125.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/binutils-2.30-125.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/binutils-2.30-125.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/bzip2-1.0.6-28.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8_10.3.src.rpm
```
...
### `rpm` package: `freetype-2.9.1-10.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url freetype-2.9.1-10.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/freetype-2.9.1-10.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glib2-2.56.4-166.el8_10.src.rpm
```

### `rpm` package: `glibc-2.28-251.0.3.el8_10.25.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-251.0.3.el8_10.25
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
```

### `rpm` package: `glibc-common-2.28-251.0.3.el8_10.25.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-251.0.3.el8_10.25
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-251.0.3.el8_10.25.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-251.0.3.el8_10.25
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.3.el8_10.25.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gnutls-3.6.16-8.el8_10.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gnutls-3.6.16-8.el8_10.3.src.rpm
```
...
### `rpm` package: `krb5-libs-1.18.2-32.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-32.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-32.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libarchive-3.3.3-6.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/e2fsprogs-1.45.6-6.el8_10.src.rpm
```
...
### `rpm` package: `libdnf-0.63.0-21.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-21.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-21.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libgcc-8.5.0-26.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-8.5.0-26.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-26.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-26.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-10.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-10.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libsemanage-2.9-12.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsemanage-2.9-12.el8_10.src.rpm
```
...
### `rpm` package: `libstdc++-8.5.0-26.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-8.5.0-26.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-26.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-26.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libtasn1-4.13-5.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libtasn1-4.13-5.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libxml2-2.9.7-21.el8_10.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libxml2-2.9.7-21.el8_10.3.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lz4-1.8.3-5.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openldap-2.4.46-21.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-14.el8_6.src.rpm
```
...
### `rpm` package: `rpm-4.14.3-32.0.1.el8_10.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/sqlite-3.26.0-20.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/sqlite-3.26.0-20.el8_10.src.rpm
```

### `rpm` package: `systemd-libs-239-82.0.5.el8_10.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.5.el8_10.5
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.5.el8_10.5.src.rpm
```

### `rpm` package: `tar-1.30-10.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url tar-1.30-10.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tar-1.30-10.el8_10.src.rpm
```

### `rpm` package: `tzdata-2025b-1.0.1.el8.noarch`
