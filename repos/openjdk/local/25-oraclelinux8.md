...
- Created: `2025-02-21T01:48:17Z`
- Virtual Size: ~ 519.65 Mb  
...
### `rpm` package: `glibc-2.28-251.0.2.el8_10.11.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-251.0.2.el8_10.11
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
```

### `rpm` package: `glibc-common-2.28-251.0.2.el8_10.11.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-251.0.2.el8_10.11
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-251.0.2.el8_10.11.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-251.0.2.el8_10.11
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-251.0.2.el8_10.11.src.rpm
```
...
### `rpm` package: `krb5-libs-1.18.2-30.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-30.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-30.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libgcc-8.5.0-23.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-8.5.0-23.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-23.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-23.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libselinux-2.9-9.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libselinux-2.9-9.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libselinux-2.9-9.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libselinux-2.9-9.el8_10.src.rpm
```

### `rpm` package: `libsemanage-2.9-10.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libsemanage-2.9-10.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsemanage-2.9-10.el8_10.src.rpm
```
...
### `rpm` package: `libstdc++-8.5.0-23.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-8.5.0-23.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-23.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-23.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libxml2-2.9.7-18.el8_10.2.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-2.9.7-18.el8_10.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libxml2-2.9.7-18.el8_10.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libxml2-2.9.7-18.el8_10.2.src.rpm
```
...
### `rpm` package: `openldap-2.4.46-20.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url openldap-2.4.46-20.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openldap-2.4.46-20.el8_10.src.rpm
```
...
### `rpm` package: `systemd-libs-239-82.0.3.el8_10.3.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.3.el8_10.3
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.3.el8_10.3.src.rpm
```
...
### `rpm` package: `tzdata-2025a-1.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-2025a-1.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tzdata-2025a-1.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/tzdata-2025a-1.0.1.el8.src.rpm
```
