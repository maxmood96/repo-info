...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/ca-certificates-2023.2.60_v7.0.306-80.0.el8_8.src.rpm
```

### `rpm` package: `chkconfig-1.19.2-1.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.19.2-1.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/chkconfig-1.19.2-1.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url curl-7.61.1-34.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8.src.rpm
```
...
### `rpm` package: `krb5-libs-1.18.2-27.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-27.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-27.0.1.el8_10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcurl-7.61.1-34.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-34.el8.src.rpm
```
...
### `rpm` package: `libdnf-0.63.0-19.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-19.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-19.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/nghttp2-1.33.0-5.el8_9.src.rpm
```
...
### `rpm` package: `systemd-libs-239-82.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.1.el8.src.rpm
```
