# `openjdk:28-ea-4-jdk-oraclelinux10`

## Docker Metadata

- Image ID: `sha256:f458263639edf737252edc99385ef41c86854a940fc46e10a17c86267dd43e76`
- Created: `2026-06-26T17:49:44.593237126Z`
- Virtual Size: ~ 597.91 Mb  
...
```console
$ dnf --quiet download --source --url alternatives-1.30-2.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/chkconfig-1.30-2.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/chkconfig-1.30-2.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/attr-2.5.2-5.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/attr-2.5.2-5.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url audit-libs-4.0.3-4.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/audit-4.0.3-4.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/audit-4.0.3-4.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/authselect-1.5.0-8.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url basesystem-11-22.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/basesystem-11-22.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/bash-5.2.26-6.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/bzip2-1.0.8-25.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/bzip2-1.0.8-25.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/ca-certificates-2025.2.80_v9.0.305-102.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url chkconfig-1.30-2.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/chkconfig-1.30-2.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/chkconfig-1.30-2.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url coreutils-9.5-6.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/coreutils-9.5-6.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url coreutils-common-9.5-6.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/coreutils-9.5-6.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/cracklib-2.9.11-8.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url curl-8.12.1-2.el10_1.2
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/curl-8.12.1-2.el10_1.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/curl-8.12.1-2.el10_1.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dbus-1.14.10-5.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dbus-1.14.10-5.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dbus-broker-36-4.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/diffutils-3.10-8.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url dnf-4.20.0-18.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url dnf-data-4.20.0-18.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.7.0-9.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/file-5.45-8.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/file-5.45-8.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/filesystem-3.18-17.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/findutils-4.10.0-5.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/gdbm-1.23-12.el10_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/gmp-6.2.1-12.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/gmp-6.2.1-12.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url gnutls-3.8.10-3.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/gnutls-3.8.10-3.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/gnutls-3.8.10-3.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/grep-3.11-10.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/gzip-1.13-3.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/ima-evm-utils-1.6.2-3.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url initscripts-10.26-2.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/initscripts-10.26-2.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url initscripts-rename-device-10.26-2.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/initscripts-10.26-2.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url initscripts-service-10.26-2.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/initscripts-10.26-2.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/json-c-0.18-3.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/json-c-0.18-3.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/keyutils-1.6.3-5.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/keyutils-1.6.3-5.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/acl-2.3.2-4.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/acl-2.3.2-4.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libarchive-3.7.7-8.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libarchive-3.7.7-8.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url libblkid-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/brotli-1.1.0-7.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/brotli-1.1.0-7.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libcbor-0.11.0-3.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/e2fsprogs-1.47.1-4.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/e2fsprogs-1.47.1-4.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libcomps-0.1.21-3.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcurl-8.12.1-2.el10_1.2
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/curl-8.12.1-2.el10_1.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/curl-8.12.1-2.el10_1.2.src.rpm
```
...
```console
$ dnf --quiet download --source --url libdnf-0.73.1-12.0.1.el10_1.1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libdnf-0.73.1-12.0.1.el10_1.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libeconf-0.6.2-4.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libestr-0.1.11-11.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libevent-2.1.12-16.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libevent-2.1.12-16.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libfastjson-1.2304.0-6.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libfdisk-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libffi-3.4.4-10.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libffi-3.4.4-10.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libidn2-2.3.7-3.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libidn2-2.3.7-3.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libmodulemd-2.15.0-12.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libmodulemd-2.15.0-12.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libmount-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url librepo-1.18.0-6.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/librepo-1.18.0-6.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libsemanage-3.9-1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libsemanage-3.9-1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libsepol-3.9-1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libsepol-3.9-1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libsmartcols-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libtasn1-4.20.0-1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libtasn1-4.20.0-1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libunistring-1.1-10.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libutempter-1.2.1-15.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libuuid-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libverto-0.3.2-10.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libverto-0.3.2-10.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url libxml2-2.12.5-9.el10_0
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libxml2-2.12.5-9.el10_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/libxml2-2.12.5-9.el10_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libyaml-0.2.5-16.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/zstd-1.5.5-9.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/zstd-1.5.5-9.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/lz4-1.9.4-8.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/lz4-1.9.4-8.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/mpdecimal-2.5.1-12.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/mpfr-4.2.1-5.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/mpfr-4.2.1-5.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/ncurses-6.4-15.20240127.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/ncurses-6.4-15.20240127.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/openldap-2.6.9-1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openldap-2.6.9-1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-9.9p1-14.0.1.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-clients-9.9p1-14.0.1.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssh-server-9.9p1-14.0.1.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssh-9.9p1-14.0.1.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-3.0.7-8.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssl-fips-provider-3.0.7-8.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-so-3.0.7-8.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssl-fips-provider-3.0.7-8.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.1-7.0.1.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url oraclelinux-release-10.1-1.0.6.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/oraclelinux-release-10.1-1.0.6.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el10-1.0-17.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el10-1.0-17.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/pam-1.6.1-8.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/pam-1.6.1-8.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url pcre2-10.44-1.0.1.el10.3
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/pcre2-10.44-1.0.1.el10.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/pcre2-10.44-1.0.1.el10.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url pcre2-syntax-10.44-1.0.1.el10.3.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/pcre2-10.44-1.0.1.el10.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/pcre2-10.44-1.0.1.el10.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url policycoreutils-3.9-1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/policycoreutils-3.9-1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/policycoreutils-3.9-1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/popt-1.19-8.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/popt-1.19-8.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/procps-ng-4.0.4-8.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/publicsuffix-list-20240107-5.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/publicsuffix-list-20240107-5.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/python-dateutil-2.9.0.post0-1.el10_0.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dbus-python-1.3.2-8.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-dnf-4.20.0-18.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.7.0-9.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.73.1-12.0.1.el10_1.1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libdnf-0.73.1-12.0.1.el10_1.1.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.73.1-12.0.1.el10_1.1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/libdnf-0.73.1-12.0.1.el10_1.1.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-rpm-4.19.1.1-20.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/python-six-1.16.0-16.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/python-systemd-235-11.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url redhat-release-10.1-16.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/redhat-release-10.1-16.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rootfiles-8.1-54.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-4.19.1.1-20.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.19.1.1-20.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-libs-4.19.1.1-20.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-sequoia-1.9.0.3-1.0.1.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rust-rpm-sequoia-1.9.0.3-1.0.1.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.19.1.1-20.0.1.el10
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rpm-4.19.1.1-20.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/rsyslog-8.2506.0-2.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/sed-4.9-3.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/setup-2.14.5-7.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url shadow-utils-4.15.0-10.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/shadow-utils-4.15.0-10.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/sqlite-3.46.1-5.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/sqlite-3.46.1-5.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url systemd-257-13.0.1.el10_1.3
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url systemd-libs-257-13.0.1.el10_1.3
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url systemd-pam-257-13.0.1.el10_1.3
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/systemd-257-13.0.1.el10_1.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url tar-1.35-9.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/tar-1.35-9.el10_1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/tpm2-tss-4.1.3-5.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url util-linux-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url util-linux-core-2.40.2-16.el10_1
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/util-linux-2.40.2-16.el10_1.src.rpm
```
...
```console
$ dnf --quiet download --source --url vim-data-9.1.083-6.0.1.el10_1.4.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/vim-9.1.083-6.0.1.el10_1.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/vim-9.1.083-6.0.1.el10_1.4.src.rpm
```
...
```console
$ dnf --quiet download --source --url vim-minimal-9.1.083-6.0.1.el10_1.4
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/vim-9.1.083-6.0.1.el10_1.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/vim-9.1.083-6.0.1.el10_1.4.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/xz-5.6.2-4.el10_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/xz-5.6.2-4.el10_0.src.rpm
```
...
```console
$ dnf --quiet download --source --url yum-4.20.0-18.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-4.20.0-18.0.1.el10.src.rpm
```
...
```console
$ dnf --quiet download --source --url yum-utils-4.7.0-9.0.1.el10.noarch
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.7.0-9.0.1.el10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/x86_64/getPackageSource/zlib-ng-2.2.3-3.el10_1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL10/appstream/x86_64/getPackageSource/zlib-ng-2.2.3-3.el10_1.src.rpm
```
