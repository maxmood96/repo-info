...
### `rpm` package: `alternatives-1.24-2.0.1.el9.x86_64`
...
### `rpm` package: `audit-libs-3.1.5-7.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url audit-libs-3.1.5-7.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/audit-3.1.5-7.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/audit-3.1.5-7.0.1.el9.src.rpm
```
...
### `rpm` package: `binutils-2.35.2-67.0.1.el9_7.1.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-67.0.1.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-67.0.1.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-67.0.1.el9_7.1.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-67.0.1.el9_7.1.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-67.0.1.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-67.0.1.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-67.0.1.el9_7.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/bzip2-1.0.8-10.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/bzip2-1.0.8-10.el9_5.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ca-certificates-2025.2.80_v9.0.305-91.el9.src.rpm
```

### `rpm` package: `coreutils-single-8.32-39.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.32-39.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-39.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/crypto-policies-20250905-1.git377cc42.el9_7.src.rpm
```

### `rpm` package: `curl-7.76.1-35.el9_7.3.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-35.el9_7.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-35.el9_7.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-35.el9_7.3.src.rpm
```
...
### `rpm` package: `dnf-data-4.14.0-31.0.1.el9.noarch`
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.193-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.193-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.5.0-5.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.5.0-5.el9_7.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/filesystem-3.16-5.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/findutils-4.8.0-7.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gdbm-1.23-1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-18.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-18.el9_7.1.src.rpm
```

### `rpm` package: `glibc-2.34-231.0.1.el9_7.2.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnupg2-2.3.3-5.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnupg2-2.3.3-5.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.8.3-9.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.8.3-9.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url kmod-libs-28-11.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/kmod-28-11.0.1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url krb5-libs-1.21.1-8.0.1.el9_6
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/krb5-1.21.1-8.0.1.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/krb5-1.21.1-8.0.1.el9_6.src.rpm
```
...
### `rpm` package: `libblkid-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libblkid-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/brotli-1.0.9-9.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/brotli-1.0.9-9.el9_7.src.rpm
```
...
### `rpm` package: `libcurl-7.76.1-35.el9_7.3.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-35.el9_7.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-35.el9_7.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-35.el9_7.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-16.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-16.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libeconf-0.4.1-4.el9.src.rpm
```
...
### `rpm` package: `libfdisk-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libfdisk-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
...
### `rpm` package: `libgcc-11.5.0-11.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-11.5.0-11.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libgcrypt-1.10.0-11.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libgcrypt-1.10.0-11.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libksba-1.5.1-7.el9.src.rpm
```
...
### `rpm` package: `libmount-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libmount-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/nghttp2-1.43.0-6.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libpng-1.6.37-12.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libpng-1.6.37-12.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libpng-1.6.37-12.el9_7.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/librepo-1.14.5-3.el9.src.rpm
```
...
### `rpm` package: `libsmartcols-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libsmartcols-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libsolv-0.7.24-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libsolv-0.7.24-3.el9.src.rpm
```

### `rpm` package: `libssh-0.10.4-17.el9_7.x86_64`
...
### `rpm` package: `libstdc++-11.5.0-11.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-11.5.0-11.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
```
...
### `rpm` package: `libuuid-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libuuid-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-14.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-14.el9_7.src.rpm
```
...
### `rpm` package: `openssl-3.5.1-7.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-3.5.1-7.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el9_7.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-3.0.7-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-fips-provider-3.0.7-8.0.1.el9.src.rpm
```

### `rpm` package: `openssl-fips-provider-so-3.0.7-8.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-so-3.0.7-8.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-fips-provider-3.0.7-8.0.1.el9.src.rpm
```

### `rpm` package: `openssl-libs-3.5.1-7.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.1-7.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el9_7.src.rpm
```
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.7-1.0.6.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.7-1.0.6.el9.src.rpm
```

### `rpm` package: `oraclelinux-release-el9-1.0-26.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el9-1.0-26.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el9-1.0-26.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/p11-kit-0.25.3-3.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/p11-kit-0.25.3-3.el9_5.src.rpm
```
...
### `rpm` package: `pam-1.5.1-26.0.1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url pam-1.5.1-26.0.1.el9_6
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/pam-1.5.1-26.0.1.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/pam-1.5.1-26.0.1.el9_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url redhat-release-9.7-0.6.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/redhat-release-9.7-0.6.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/shadow-utils-4.9-15.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tar-1.34-9.el9_7.src.rpm
```
...
### `rpm` package: `util-linux-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```

### `rpm` package: `util-linux-core-2.37.4-21.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-core-2.37.4-21.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9_7.src.rpm
```
