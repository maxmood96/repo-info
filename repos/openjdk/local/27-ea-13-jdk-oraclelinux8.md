# `openjdk:27-ea-13-jdk-oraclelinux8`

## Docker Metadata

- Image ID: `sha256:0045baf1e655b6ff502a3068f9a5b49d452de9915793e1b28cb5a8d92533a347`
- Created: `2026-03-16T17:03:11.045018618Z`
- Virtual Size: ~ 567.38 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glib2-2.56.4-168.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gnupg2-2.2.20-4.el8_10.src.rpm
```
...
### `rpm` package: `libblkid-2.32.1-48.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libblkid-2.32.1-48.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libmount-2.32.1-48.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libmount-2.32.1-48.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libpng-1.6.34-9.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libpng-1.6.34-9.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libpng-1.6.34-9.el8_10.src.rpm
```
...
### `rpm` package: `libsmartcols-2.32.1-48.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libsmartcols-2.32.1-48.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
```
...
### `rpm` package: `libuuid-2.32.1-48.0.1.el8_10.x86_64`
...
```console
$ dnf --quiet download --source --url libuuid-2.32.1-48.0.1.el8_10
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-48.0.1.el8_10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-15.el8_6.src.rpm
```
...
### `rpm` package: `systemd-libs-239-82.0.8.el8_10.13.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-82.0.8.el8_10.13
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-82.0.8.el8_10.13.src.rpm
```
