# `openjdk:20-ea-9-jdk-oraclelinux8`

## Docker Metadata

- Image ID: `sha256:201fb337745338ee4afdffed1c2400711cb4a7c47668f34ef822612b961f19e3`
- Created: `2022-08-08T22:51:29.097979898Z`
- Virtual Size: ~ 480.39 Mb  
...
### `rpm` package: `binutils-2.30-113.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.30-113.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/binutils-2.30-113.0.2.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/binutils-2.30-113.0.2.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-22.el8_6.3.src.rpm
```
...
### `rpm` package: `expat-2.2.5-8.0.1.el8_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url expat-2.2.5-8.0.1.el8_6.2
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/expat-2.2.5-8.0.1.el8_6.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glib2-2.56.4-158.el8.src.rpm
```
...
### `rpm` package: `libdnf-0.63.0-8.1.0.1.el8_6.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-8.1.0.1.el8_6
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-8.1.0.1.el8_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url libsemanage-2.9-8.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libsemanage-2.9-8.el8.src.rpm
```
...
### `rpm` package: `oraclelinux-release-8.6-1.0.5.el8.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-8.6-1.0.5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/oraclelinux-release-8.6-1.0.5.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-23.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-23.el8.src.rpm
```
...
### `rpm` package: `systemd-libs-239-58.0.1.el8_6.3.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-58.0.1.el8_6.3
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-58.0.1.el8_6.3.src.rpm
```
