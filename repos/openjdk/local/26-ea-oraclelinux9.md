# `openjdk:26-ea-19-jdk-oraclelinux9`

## Docker Metadata

- Image ID: `sha256:936ed279b76256479bc4ac2a1bc764020603cca02469f6ddc42d5d9449015c57`
- Created: `2025-10-11T00:48:11Z`
- Virtual Size: ~ 614.76 Mb  
...
### `rpm` package: `binutils-2.35.2-63.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-63.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-63.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-63.0.1.el9.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-63.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-63.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/binutils-2.35.2-63.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/binutils-2.35.2-63.0.1.el9.src.rpm
```
...
### `rpm` package: `curl-7.76.1-31.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url curl-7.76.1-31.el9_6.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-31.el9_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-31.el9_6.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/elfutils-0.192-6.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/elfutils-0.192-6.el9_6.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/expat-2.5.0-5.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/expat-2.5.0-5.el9_6.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-16.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-16.el9_6.2.src.rpm
```

### `rpm` package: `glibc-2.34-168.0.1.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-168.0.1.el9_6.23
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
```

### `rpm` package: `glibc-common-2.34-168.0.1.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-168.0.1.el9_6.23
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-168.0.1.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-168.0.1.el9_6.23
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.8.3-6.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.8.3-6.el9_6.2.src.rpm
```
...
### `rpm` package: `kmod-libs-28-10.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url kmod-libs-28-10.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/kmod-28-10.0.2.el9.src.rpm
```
...
### `rpm` package: `libcurl-7.76.1-31.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-7.76.1-31.el9_6.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/curl-7.76.1-31.el9_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/curl-7.76.1-31.el9_6.1.src.rpm
```
...
### `rpm` package: `libfdisk-2.37.4-21.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libfdisk-2.37.4-21.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-12.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-12.el9_6.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ncurses-6.2-10.20210508.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/ncurses-6.2-10.20210508.el9_6.2.src.rpm
```
...
### `rpm` package: `oraclelinux-release-9.6-1.0.9.el9.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-9.6-1.0.9.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/oraclelinux-release-9.6-1.0.9.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/sqlite-3.34.1-8.el9_6.src.rpm
```

### `rpm` package: `systemd-252-51.0.4.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-51.0.4.el9_6.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
```

### `rpm` package: `systemd-libs-252-51.0.4.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-51.0.4.el9_6.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
```

### `rpm` package: `systemd-pam-252-51.0.4.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-51.0.4.el9_6.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-51.0.4.el9_6.2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-51.0.4.el9_6.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-51.0.4.el9_6.2.src.rpm
```
...
### `rpm` package: `util-linux-2.37.4-21.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-2.37.4-21.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
```

### `rpm` package: `util-linux-core-2.37.4-21.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-core-2.37.4-21.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/util-linux-2.37.4-21.0.1.el9.src.rpm
```
