...
- Created: `2024-12-09T05:52:24Z`
- Virtual Size: ~ 597.19 Mb  
...
### `rpm` package: `systemd-252-46.0.1.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-46.0.1.el9_5.2
...
### `rpm` package: `systemd-pam-252-46.0.1.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-46.0.1.el9_5.2
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-46.0.1.el9_5.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-46.0.1.el9_5.2.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-46.0.1.el9_5.2.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-46.0.1.el9_5.2.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-46.0.1.el9_5.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-46.0.1.el9_5.2.src.rpm
```
