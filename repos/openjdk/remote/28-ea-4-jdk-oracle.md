...
### `openjdk:28-ea-4-jdk-oracle` - linux; amd64
...
### `openjdk:28-ea-4-jdk-oracle` - unknown; unknown
...
### `openjdk:28-ea-4-jdk-oracle` - linux; arm64 variant v8
