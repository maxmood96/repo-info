...
```console
$ docker pull openjdk@sha256:495d2ed1d77fb3db957e3cd2e01e1ecec2b82ba1749d75f5812ed52c7e27dcc9
```
...
### `openjdk:11.0.9.1-jre-buster` - linux; amd64
...
### `openjdk:11.0.9.1-jre-buster` - linux; arm64 variant v8
