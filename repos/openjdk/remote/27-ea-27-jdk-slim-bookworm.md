...
### `openjdk:27-ea-27-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:27-ea-27-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:27-ea-27-jdk-slim-bookworm` - linux; arm64 variant v8
