...
### `openjdk:24-ea-16-bullseye` - linux; amd64
...
### `openjdk:24-ea-16-bullseye` - unknown; unknown
...
### `openjdk:24-ea-16-bullseye` - linux; arm64 variant v8
