...
### `openjdk:22-ea-34-jdk-bookworm` - linux; amd64
...
### `openjdk:22-ea-34-jdk-bookworm` - unknown; unknown
...
### `openjdk:22-ea-34-jdk-bookworm` - linux; arm64 variant v8
