...
```console
$ docker pull openjdk@sha256:1fea69960ae54a0581fd705c5a1478c9e8b7f3fe1a22fc49b5be92d4fe996cbc
```
...
### `openjdk:23-ea-24-jdk-bookworm` - linux; amd64
...
### `openjdk:23-ea-24-jdk-bookworm` - unknown; unknown
