...
### `openjdk:23-ea-27-jdk-slim` - linux; amd64
...
### `openjdk:23-ea-27-jdk-slim` - unknown; unknown
...
### `openjdk:23-ea-27-jdk-slim` - linux; arm64 variant v8
