## `openjdk:8u342-jre-slim-buster`

```console
$ docker pull openjdk@sha256:5e7ff39f491117755d3f1961f093bb4599512c5618f374a03d0acf492744cdcd
```
...
### `openjdk:8u342-jre-slim-buster` - linux; amd64
...
### `openjdk:8u342-jre-slim-buster` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:198cf663b7bce4d3e752d86c20b4aba455913510ee6daf6440a7dd291e5d1f69
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.8 MB (69780130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84dc0bdc889d8562cb5cdcaab654467a899617a2b3751d97cca670af4d58b9e1`
-	Default Command: `["bash"]`
