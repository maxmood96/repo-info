...
### `openjdk:24-ea-11-jdk-bullseye` - linux; amd64
...
### `openjdk:24-ea-11-jdk-bullseye` - unknown; unknown
...
### `openjdk:24-ea-11-jdk-bullseye` - linux; arm64 variant v8
