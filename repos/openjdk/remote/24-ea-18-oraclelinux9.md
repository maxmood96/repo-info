...
```console
$ docker pull openjdk@sha256:38b6767acc304c1cafabe6abee4372697517db2ed838e627c7f7f1d43f561d55
```
...
### `openjdk:24-ea-18-oraclelinux9` - linux; amd64
...
### `openjdk:24-ea-18-oraclelinux9` - unknown; unknown
