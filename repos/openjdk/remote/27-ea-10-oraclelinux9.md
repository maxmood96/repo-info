...
### `openjdk:27-ea-10-oraclelinux9` - linux; amd64
...
### `openjdk:27-ea-10-oraclelinux9` - unknown; unknown
...
### `openjdk:27-ea-10-oraclelinux9` - linux; arm64 variant v8
