## `openjdk:21-ea-22-jdk-slim`

```console
$ docker pull openjdk@sha256:9fb7a8a56dabef0bbdb8f31b8d6f60dbc9f55671d8480b3871a4d31992e33d6b
```
...
### `openjdk:21-ea-22-jdk-slim` - linux; amd64
