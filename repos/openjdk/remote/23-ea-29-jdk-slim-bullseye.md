...
```console
$ docker pull openjdk@sha256:06656296697575388b42bc4a5b38f58a3750bec68d439120682ab024523f272a
```
...
### `openjdk:23-ea-29-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:23-ea-29-jdk-slim-bullseye` - unknown; unknown
