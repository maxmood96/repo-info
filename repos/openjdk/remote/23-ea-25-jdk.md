## `openjdk:23-ea-25-jdk`

```console
$ docker pull openjdk@sha256:822cf2d9ee157eececb44c4962153a143fa552b8da0dde6aa1562563273075f8
```
...
### `openjdk:23-ea-25-jdk` - linux; amd64
...
### `openjdk:23-ea-25-jdk` - unknown; unknown
...
### `openjdk:23-ea-25-jdk` - windows version 10.0.20348.2461; amd64
...
### `openjdk:23-ea-25-jdk` - windows version 10.0.17763.5820; amd64
