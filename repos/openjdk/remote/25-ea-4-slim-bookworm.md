...
### `openjdk:25-ea-4-slim-bookworm` - linux; amd64
...
### `openjdk:25-ea-4-slim-bookworm` - unknown; unknown
...
### `openjdk:25-ea-4-slim-bookworm` - linux; arm64 variant v8
