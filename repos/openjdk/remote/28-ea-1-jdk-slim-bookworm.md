...
### `openjdk:28-ea-1-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:28-ea-1-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:28-ea-1-jdk-slim-bookworm` - linux; arm64 variant v8
