...
### `openjdk:26-ea-23-oraclelinux8` - linux; amd64
...
### `openjdk:26-ea-23-oraclelinux8` - unknown; unknown
...
### `openjdk:26-ea-23-oraclelinux8` - linux; arm64 variant v8
