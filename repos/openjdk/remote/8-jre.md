...
```console
$ docker pull openjdk@sha256:25e561352df9454c4b5f8f98005292929577f98301cf9496a7b0fcda1006cd28
```
...
### `openjdk:8-jre` - windows version 10.0.20348.825; amd64
...
### `openjdk:8-jre` - windows version 10.0.17763.3165; amd64
