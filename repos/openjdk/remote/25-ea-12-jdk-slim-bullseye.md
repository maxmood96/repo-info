...
### `openjdk:25-ea-12-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:25-ea-12-jdk-slim-bullseye` - unknown; unknown
...
### `openjdk:25-ea-12-jdk-slim-bullseye` - linux; arm64 variant v8
