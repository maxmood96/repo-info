...
### `openjdk:24-ea-25-bullseye` - linux; amd64
...
### `openjdk:24-ea-25-bullseye` - unknown; unknown
...
### `openjdk:24-ea-25-bullseye` - linux; arm64 variant v8
