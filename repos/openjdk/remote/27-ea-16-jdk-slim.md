...
### `openjdk:27-ea-16-jdk-slim` - linux; amd64
...
### `openjdk:27-ea-16-jdk-slim` - unknown; unknown
...
### `openjdk:27-ea-16-jdk-slim` - linux; arm64 variant v8
