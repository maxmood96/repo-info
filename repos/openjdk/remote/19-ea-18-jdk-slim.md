## `openjdk:19-ea-18-jdk-slim`

```console
$ docker pull openjdk@sha256:0b3403582e3d9acc298682affc301adfe7f49a4630137a2278b68709a67e78c4
```
...
### `openjdk:19-ea-18-jdk-slim` - linux; amd64
