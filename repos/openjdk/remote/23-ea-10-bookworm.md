...
### `openjdk:23-ea-10-bookworm` - linux; amd64
...
### `openjdk:23-ea-10-bookworm` - unknown; unknown
...
### `openjdk:23-ea-10-bookworm` - linux; arm64 variant v8
