...
### `openjdk:24-ea-25-oraclelinux8` - linux; amd64
...
### `openjdk:24-ea-25-oraclelinux8` - unknown; unknown
...
### `openjdk:24-ea-25-oraclelinux8` - linux; arm64 variant v8
