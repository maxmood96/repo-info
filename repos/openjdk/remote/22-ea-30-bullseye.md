...
### `openjdk:22-ea-30-bullseye` - linux; amd64
...
### `openjdk:22-ea-30-bullseye` - unknown; unknown
...
### `openjdk:22-ea-30-bullseye` - linux; arm64 variant v8
