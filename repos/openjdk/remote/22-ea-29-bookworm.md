...
### `openjdk:22-ea-29-bookworm` - linux; amd64
...
### `openjdk:22-ea-29-bookworm` - unknown; unknown
...
### `openjdk:22-ea-29-bookworm` - linux; arm64 variant v8
