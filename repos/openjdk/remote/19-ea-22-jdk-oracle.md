## `openjdk:19-ea-22-jdk-oracle`

```console
$ docker pull openjdk@sha256:e1ebeecb64510f50a78632f64ee65cd13e44955d2762d7f42adc5db4d52bf691
```
...
### `openjdk:19-ea-22-jdk-oracle` - linux; arm64 variant v8
