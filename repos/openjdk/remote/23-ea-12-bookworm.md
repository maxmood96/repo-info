## `openjdk:23-ea-12-bookworm`

```console
$ docker pull openjdk@sha256:91143c5519a863f43f76cd770cfe82654af81232c771d9d0d8ffe08a48c269e4
```
...
### `openjdk:23-ea-12-bookworm` - linux; amd64
...
### `openjdk:23-ea-12-bookworm` - unknown; unknown
