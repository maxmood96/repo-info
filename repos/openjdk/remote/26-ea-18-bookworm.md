...
### `openjdk:26-ea-18-bookworm` - linux; amd64
...
### `openjdk:26-ea-18-bookworm` - unknown; unknown
...
### `openjdk:26-ea-18-bookworm` - linux; arm64 variant v8
