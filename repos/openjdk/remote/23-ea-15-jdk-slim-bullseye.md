...
### `openjdk:23-ea-15-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:23-ea-15-jdk-slim-bullseye` - unknown; unknown
...
### `openjdk:23-ea-15-jdk-slim-bullseye` - linux; arm64 variant v8
