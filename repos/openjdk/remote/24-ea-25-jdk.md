...
### `openjdk:24-ea-25-jdk` - linux; amd64
...
### `openjdk:24-ea-25-jdk` - unknown; unknown
...
### `openjdk:24-ea-25-jdk` - linux; arm64 variant v8
...
### `openjdk:24-ea-25-jdk` - windows version 10.0.20348.2849; amd64
...
### `openjdk:24-ea-25-jdk` - windows version 10.0.17763.6532; amd64
