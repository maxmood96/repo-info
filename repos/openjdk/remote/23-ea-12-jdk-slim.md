## `openjdk:23-ea-12-jdk-slim`

```console
$ docker pull openjdk@sha256:149c9f26a6cecda2b275399dbb6fbe3681d5d5c1ceecf96c26aa56bc18a2234b
```
...
### `openjdk:23-ea-12-jdk-slim` - linux; amd64
...
### `openjdk:23-ea-12-jdk-slim` - unknown; unknown
