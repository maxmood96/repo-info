...
### `openjdk:26-ea-18-slim-trixie` - linux; amd64
...
### `openjdk:26-ea-18-slim-trixie` - unknown; unknown
...
### `openjdk:26-ea-18-slim-trixie` - linux; arm64 variant v8
