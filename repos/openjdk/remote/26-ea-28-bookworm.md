...
### `openjdk:26-ea-28-bookworm` - linux; amd64
...
### `openjdk:26-ea-28-bookworm` - unknown; unknown
...
### `openjdk:26-ea-28-bookworm` - linux; arm64 variant v8
