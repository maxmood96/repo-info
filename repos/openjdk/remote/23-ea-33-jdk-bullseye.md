...
### `openjdk:23-ea-33-jdk-bullseye` - linux; amd64
...
### `openjdk:23-ea-33-jdk-bullseye` - unknown; unknown
...
### `openjdk:23-ea-33-jdk-bullseye` - linux; arm64 variant v8
