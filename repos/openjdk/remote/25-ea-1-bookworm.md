...
```console
$ docker pull openjdk@sha256:6f7da67216a4c6c920b3f33b5aa73202e54403708bd2d0f758a9d50485653751
```
...
### `openjdk:25-ea-1-bookworm` - linux; amd64
...
### `openjdk:25-ea-1-bookworm` - unknown; unknown
