## `openjdk:18-ea-19-jdk-slim-bullseye`

```console
$ docker pull openjdk@sha256:2a4c9b0e04db3b3884008ba11dd5be40a77b56a4e4d8e3a515764fda4da98915
```
...
### `openjdk:18-ea-19-jdk-slim-bullseye` - linux; arm64 variant v8
