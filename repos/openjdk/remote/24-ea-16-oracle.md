## `openjdk:24-ea-16-oracle`

```console
$ docker pull openjdk@sha256:c4700a8ba2dc10afee0be22aed087456409c3371686bdb8f0926b068540f1ede
```
...
### `openjdk:24-ea-16-oracle` - linux; arm64 variant v8
...
### `openjdk:24-ea-16-oracle` - unknown; unknown
