...
```console
$ docker pull openjdk@sha256:597725c988f03c81e75d2b24c3519a6bd837bd8ef9fc898ed9e05978079ccbe4
```
...
### `openjdk:16-ea-jdk-windowsservercore-ltsc2016` - windows version 10.0.14393.4104; amd64
