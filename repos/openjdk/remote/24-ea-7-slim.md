## `openjdk:24-ea-7-slim`

```console
$ docker pull openjdk@sha256:72abec2af73986caa8b394127cec8115500da7aea3296addfdf57941c2ef0a78
```
...
### `openjdk:24-ea-7-slim` - linux; amd64
...
### `openjdk:24-ea-7-slim` - unknown; unknown
