...
### `openjdk:24-ea-32-bullseye` - linux; amd64
...
### `openjdk:24-ea-32-bullseye` - unknown; unknown
...
### `openjdk:24-ea-32-bullseye` - linux; arm64 variant v8
