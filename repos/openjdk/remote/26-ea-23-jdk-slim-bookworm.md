...
### `openjdk:26-ea-23-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:26-ea-23-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:26-ea-23-jdk-slim-bookworm` - linux; arm64 variant v8
