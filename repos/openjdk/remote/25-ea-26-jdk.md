...
### `openjdk:25-ea-26-jdk` - linux; amd64
...
### `openjdk:25-ea-26-jdk` - unknown; unknown
...
### `openjdk:25-ea-26-jdk` - linux; arm64 variant v8
...
### `openjdk:25-ea-26-jdk` - windows version 10.0.26100.4061; amd64
...
### `openjdk:25-ea-26-jdk` - windows version 10.0.20348.3692; amd64
