...
### `openjdk:28-ea-2-jdk-bookworm` - linux; amd64
...
### `openjdk:28-ea-2-jdk-bookworm` - unknown; unknown
...
### `openjdk:28-ea-2-jdk-bookworm` - linux; arm64 variant v8
