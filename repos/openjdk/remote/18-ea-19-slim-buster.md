## `openjdk:18-ea-19-slim-buster`

```console
$ docker pull openjdk@sha256:d9f05820a89667c2277e6d390f968716c931e01a24e8d7e0d9b74acfd6616a9e
```
...
### `openjdk:18-ea-19-slim-buster` - linux; arm64 variant v8
