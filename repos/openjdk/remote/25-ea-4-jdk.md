...
### `openjdk:25-ea-4-jdk` - linux; amd64
...
### `openjdk:25-ea-4-jdk` - unknown; unknown
...
### `openjdk:25-ea-4-jdk` - linux; arm64 variant v8
...
### `openjdk:25-ea-4-jdk` - windows version 10.0.20348.2966; amd64
...
### `openjdk:25-ea-4-jdk` - windows version 10.0.17763.6659; amd64
