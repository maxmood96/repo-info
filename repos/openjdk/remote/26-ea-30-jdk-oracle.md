...
### `openjdk:26-ea-30-jdk-oracle` - linux; amd64
...
### `openjdk:26-ea-30-jdk-oracle` - unknown; unknown
...
### `openjdk:26-ea-30-jdk-oracle` - linux; arm64 variant v8
