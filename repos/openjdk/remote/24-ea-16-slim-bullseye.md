## `openjdk:24-ea-16-slim-bullseye`

```console
$ docker pull openjdk@sha256:8cd6f895a3f5a5f01cde40b2baf782f39180993249b547be2d8fa6bec6efd0f1
```
...
### `openjdk:24-ea-16-slim-bullseye` - linux; amd64
...
### `openjdk:24-ea-16-slim-bullseye` - unknown; unknown
...
### `openjdk:24-ea-16-slim-bullseye` - linux; arm64 variant v8
