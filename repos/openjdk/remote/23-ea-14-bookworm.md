...
### `openjdk:23-ea-14-bookworm` - linux; amd64
...
### `openjdk:23-ea-14-bookworm` - unknown; unknown
...
### `openjdk:23-ea-14-bookworm` - linux; arm64 variant v8
