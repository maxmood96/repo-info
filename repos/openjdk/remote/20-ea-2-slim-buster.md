## `openjdk:20-ea-2-slim-buster`

```console
$ docker pull openjdk@sha256:e0e4beda29ef889a57a67a4e9345d5134b4d8af1ae1413a57dfb25c9a15330b0
```
...
### `openjdk:20-ea-2-slim-buster` - linux; amd64
