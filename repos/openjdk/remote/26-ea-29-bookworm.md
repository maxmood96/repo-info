...
### `openjdk:26-ea-29-bookworm` - linux; amd64
...
### `openjdk:26-ea-29-bookworm` - unknown; unknown
...
### `openjdk:26-ea-29-bookworm` - linux; arm64 variant v8
