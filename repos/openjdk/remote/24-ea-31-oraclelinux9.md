...
### `openjdk:24-ea-31-oraclelinux9` - linux; amd64
...
### `openjdk:24-ea-31-oraclelinux9` - unknown; unknown
...
### `openjdk:24-ea-31-oraclelinux9` - linux; arm64 variant v8
