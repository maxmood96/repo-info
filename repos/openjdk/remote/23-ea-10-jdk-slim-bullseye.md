...
```console
$ docker pull openjdk@sha256:7a181e0a9e6bbc37a18073ff2dae14f467631d4d48a032326dc88c14552a2149
```
...
### `openjdk:23-ea-10-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:23-ea-10-jdk-slim-bullseye` - unknown; unknown
