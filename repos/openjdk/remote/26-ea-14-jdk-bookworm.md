...
### `openjdk:26-ea-14-jdk-bookworm` - linux; amd64
...
### `openjdk:26-ea-14-jdk-bookworm` - unknown; unknown
...
### `openjdk:26-ea-14-jdk-bookworm` - linux; arm64 variant v8
