...
### `openjdk:23-ea-5-slim-bookworm` - linux; amd64
...
### `openjdk:23-ea-5-slim-bookworm` - unknown; unknown
...
### `openjdk:23-ea-5-slim-bookworm` - linux; arm64 variant v8
