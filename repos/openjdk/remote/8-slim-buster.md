...
```console
$ docker pull openjdk@sha256:ca50cd63d08268f2775af636dd055862ff75b9cae3cfc201ab18448c9d26b0b9
```
...
```console
$ docker pull openjdk@sha256:9e808ebc883769543d60bc04515b66daf0cbd554333a15812cd3c91ef1f237a4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.0 MB (134024770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4145a1bdc163ff10bbe9e79f2e6208e2acf314aeb6fca05cd9ff32c3e477ced`
-	Default Command: `["bash"]`
