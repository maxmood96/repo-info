## `openjdk:24-ea-22-jdk-bookworm`

```console
$ docker pull openjdk@sha256:6843f5872bd7b4105725c0fcb5a1120236a64b783d6fa94d0246ef164a192815
```
...
### `openjdk:24-ea-22-jdk-bookworm` - linux; amd64
...
### `openjdk:24-ea-22-jdk-bookworm` - unknown; unknown
...
### `openjdk:24-ea-22-jdk-bookworm` - linux; arm64 variant v8
