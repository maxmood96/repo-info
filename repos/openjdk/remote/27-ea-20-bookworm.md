...
### `openjdk:27-ea-20-bookworm` - linux; amd64
...
### `openjdk:27-ea-20-bookworm` - unknown; unknown
...
### `openjdk:27-ea-20-bookworm` - linux; arm64 variant v8
