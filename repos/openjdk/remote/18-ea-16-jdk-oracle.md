...
```console
$ docker pull openjdk@sha256:60f62fdac4ffa0fd833c3a7617d349f5e60c66946f63b058ad32ac6f4a71bb84
```
...
### `openjdk:18-ea-16-jdk-oracle` - linux; amd64
...
### `openjdk:18-ea-16-jdk-oracle` - linux; arm64 variant v8
