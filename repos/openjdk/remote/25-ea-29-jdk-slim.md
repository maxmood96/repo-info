...
### `openjdk:25-ea-29-jdk-slim` - linux; amd64
...
### `openjdk:25-ea-29-jdk-slim` - unknown; unknown
...
### `openjdk:25-ea-29-jdk-slim` - linux; arm64 variant v8
