...
```console
$ docker pull openjdk@sha256:edb7b2a66e1fba1555f87fd21796bd74de00ebb53c27ec65f95f3d44b4bb0d7e
```
...
### `openjdk:25-ea-10-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:25-ea-10-jdk-slim-bullseye` - unknown; unknown
