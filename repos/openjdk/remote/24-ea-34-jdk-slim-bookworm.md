...
### `openjdk:24-ea-34-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:24-ea-34-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:24-ea-34-jdk-slim-bookworm` - linux; arm64 variant v8
