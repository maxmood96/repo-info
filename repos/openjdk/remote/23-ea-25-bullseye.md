## `openjdk:23-ea-25-bullseye`

```console
$ docker pull openjdk@sha256:fc291adb143048696a8b09ea242ea158304ef8bedebf306095b133381c89c068
```
...
### `openjdk:23-ea-25-bullseye` - linux; amd64
...
### `openjdk:23-ea-25-bullseye` - unknown; unknown
