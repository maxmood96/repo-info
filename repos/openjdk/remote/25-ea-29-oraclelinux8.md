...
### `openjdk:25-ea-29-oraclelinux8` - linux; amd64
...
### `openjdk:25-ea-29-oraclelinux8` - unknown; unknown
...
### `openjdk:25-ea-29-oraclelinux8` - linux; arm64 variant v8
