## `openjdk:8u332-bullseye`

```console
$ docker pull openjdk@sha256:e2d79a584a2ef6e56f744e7d1ad3517fd614de954fc39f47de2c65a812f2389e
```
...
### `openjdk:8u332-bullseye` - linux; amd64
...
### `openjdk:8u332-bullseye` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:986246507155a520064cb223b985f035157b8c654c499118cb99d89fcc617448
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.3 MB (234306682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:920ea47a05c52c34c8647964f50dec4c83303420789e6968c8f627f338b1b2b6`
-	Default Command: `["bash"]`
