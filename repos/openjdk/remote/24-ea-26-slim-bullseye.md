...
```console
$ docker pull openjdk@sha256:452225b86d8a2a57315627338d3bbd2aa10827aa4a56b3d3df891cd2642d7bba
```
...
### `openjdk:24-ea-26-slim-bullseye` - linux; amd64
...
### `openjdk:24-ea-26-slim-bullseye` - unknown; unknown
