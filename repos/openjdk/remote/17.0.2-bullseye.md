...
```console
$ docker pull openjdk@sha256:b2c07314117356e3be6d6b8950247d8e6acf84ceeaed78e9ebcae377241cb8fe
```
...
```console
$ docker pull openjdk@sha256:21acea319817c2fbdfcbd6f3a09fa55b3d0fe12d04b1bb15b345ec2b4a2fd148
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.9 MB (325878622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e2bcf94ddb14cb70d6ba6d0a9737d2e4f60dee92f4c2b68a65f33f72ecbe458`
-	Default Command: `["jshell"]`
