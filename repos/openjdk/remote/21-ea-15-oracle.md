## `openjdk:21-ea-15-oracle`

```console
$ docker pull openjdk@sha256:7d06933b64e17efba902037fb1e8a17ac0d89bf0a9e1214c6ae369097711905f
```
...
### `openjdk:21-ea-15-oracle` - linux; amd64
...
### `openjdk:21-ea-15-oracle` - linux; arm64 variant v8
