...
### `openjdk:27-ea-21-bookworm` - linux; amd64
...
### `openjdk:27-ea-21-bookworm` - unknown; unknown
...
### `openjdk:27-ea-21-bookworm` - linux; arm64 variant v8
