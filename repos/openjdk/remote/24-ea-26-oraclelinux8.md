...
```console
$ docker pull openjdk@sha256:59af62e689f8470a00cff40b6eafbf44288d06adceaea7c5c6db82051c9bf752
```
...
### `openjdk:24-ea-26-oraclelinux8` - linux; amd64
...
### `openjdk:24-ea-26-oraclelinux8` - unknown; unknown
