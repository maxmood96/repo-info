...
### `openjdk:26-ea-15-jdk-trixie` - linux; amd64
...
### `openjdk:26-ea-15-jdk-trixie` - unknown; unknown
...
### `openjdk:26-ea-15-jdk-trixie` - linux; arm64 variant v8
