...
### `openjdk:23-ea-10-jdk-slim` - linux; amd64
...
### `openjdk:23-ea-10-jdk-slim` - unknown; unknown
...
### `openjdk:23-ea-10-jdk-slim` - linux; arm64 variant v8
