...
### `openjdk:27-ea-16-slim-trixie` - linux; amd64
...
### `openjdk:27-ea-16-slim-trixie` - unknown; unknown
...
### `openjdk:27-ea-16-slim-trixie` - linux; arm64 variant v8
