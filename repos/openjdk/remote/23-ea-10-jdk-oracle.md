...
### `openjdk:23-ea-10-jdk-oracle` - linux; amd64
...
### `openjdk:23-ea-10-jdk-oracle` - unknown; unknown
...
### `openjdk:23-ea-10-jdk-oracle` - linux; arm64 variant v8
