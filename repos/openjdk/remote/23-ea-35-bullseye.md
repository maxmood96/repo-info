...
### `openjdk:23-ea-35-bullseye` - linux; amd64
...
### `openjdk:23-ea-35-bullseye` - unknown; unknown
...
### `openjdk:23-ea-35-bullseye` - linux; arm64 variant v8
