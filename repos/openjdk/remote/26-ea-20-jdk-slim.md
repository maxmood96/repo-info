...
### `openjdk:26-ea-20-jdk-slim` - linux; amd64
...
### `openjdk:26-ea-20-jdk-slim` - unknown; unknown
...
### `openjdk:26-ea-20-jdk-slim` - linux; arm64 variant v8
