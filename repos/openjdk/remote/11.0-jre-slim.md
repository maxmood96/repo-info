...
```console
$ docker pull openjdk@sha256:2dc2fe284c751c4578225c14afcadeba0be10e7fa627920272089afb83f2f6de
```
...
```console
$ docker pull openjdk@sha256:c24e557d6cb84410abfae6570ea9ec5aa6fe2525ec0e536bdd14a66a0e4ab44e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **75.2 MB (75175958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7a6ad3db418b1b5eb754986757d5cb5594a4546691793ee02ed6aed38483528`
-	Default Command: `["bash"]`
