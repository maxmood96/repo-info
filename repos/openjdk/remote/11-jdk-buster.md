...
```console
$ docker pull openjdk@sha256:be96ebdcdf7682d618e7835c33f86813addbcda222dce10dd81f809a6d91b9f2
```
...
```console
$ docker pull openjdk@sha256:e2aee10341360f31d4dc4878dbbca94a6cfc03fa88b8b0abe00001faa6b2831d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.2 MB (326167495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79e9e47a442d01d3d42d55bb5ce5c19920d1997357d831c05357fcdb4f848ad9`
-	Default Command: `["jshell"]`
