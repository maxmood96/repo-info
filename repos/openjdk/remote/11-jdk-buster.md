...
```console
$ docker pull openjdk@sha256:36793995052f38decc52b54f1354bac8760b9344279e45c29b157bfa8ff7fc0c
```
...
```console
$ docker pull openjdk@sha256:005f30baa7a7e2e08994adf25224a0509cfbae7eb8c44bfd404142e45964f04a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.1 MB (325053172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94f3b3bbbd3d4d12020d4f1952ab4638f8bed0d3e91c24b899a90f226bd0a12a`
-	Default Command: `["jshell"]`
