...
### `openjdk:24-ea-15-jdk-slim` - linux; amd64
...
### `openjdk:24-ea-15-jdk-slim` - unknown; unknown
...
### `openjdk:24-ea-15-jdk-slim` - linux; arm64 variant v8
