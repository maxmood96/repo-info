...
```console
$ docker pull openjdk@sha256:3432e5c27a4c5b56b717b06669414458ea5142cda2fb80e5fe8049e1cbe8b582
```
...
```console
$ docker pull openjdk@sha256:24eb619261278d501d748d0446f2c87a0dcc80efaceb09f3e16208c58cfb50c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.4 MB (331378466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1666bc23b57ddaa6c12a692b543eaa16ccd0ad7a3850aeab581a56eae721da25`
-	Default Command: `["jshell"]`
...
### `openjdk:11.0.15` - windows version 10.0.20348.768; amd64
...
### `openjdk:11.0.15` - windows version 10.0.17763.3046; amd64
