## `openjdk:16-ea-15-oracle`

```console
$ docker pull openjdk@sha256:1112133faa1edf3b5df97e607300d8d03681e24c75e31a7650771555f81a3434
```
...
### `openjdk:16-ea-15-oracle` - linux; amd64
...
### `openjdk:16-ea-15-oracle` - linux; arm64 variant v8
