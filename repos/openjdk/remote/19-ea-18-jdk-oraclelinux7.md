## `openjdk:19-ea-18-jdk-oraclelinux7`

```console
$ docker pull openjdk@sha256:9758cbcb194c798a2d232fa88f6ed6cd348e04e477f7b42ec62fbe4048c62822
```
...
### `openjdk:19-ea-18-jdk-oraclelinux7` - linux; amd64
