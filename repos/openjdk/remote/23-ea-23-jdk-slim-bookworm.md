...
### `openjdk:23-ea-23-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:23-ea-23-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:23-ea-23-jdk-slim-bookworm` - linux; arm64 variant v8
