...
### `openjdk:23-ea-21-oraclelinux8` - linux; amd64
...
### `openjdk:23-ea-21-oraclelinux8` - unknown; unknown
...
### `openjdk:23-ea-21-oraclelinux8` - linux; arm64 variant v8
