## `openjdk:16-ea-27-jdk-buster`

```console
$ docker pull openjdk@sha256:c326492336aef0f82d46ba46a716272cd782e5c1114cedf04db6af2847d32907
```
...
### `openjdk:16-ea-27-jdk-buster` - linux; amd64
