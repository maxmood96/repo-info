...
### `openjdk:24-ea-33-bookworm` - linux; amd64
...
### `openjdk:24-ea-33-bookworm` - unknown; unknown
...
### `openjdk:24-ea-33-bookworm` - linux; arm64 variant v8
