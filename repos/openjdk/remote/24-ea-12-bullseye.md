...
### `openjdk:24-ea-12-bullseye` - linux; amd64
...
### `openjdk:24-ea-12-bullseye` - unknown; unknown
...
### `openjdk:24-ea-12-bullseye` - linux; arm64 variant v8
