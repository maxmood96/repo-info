## `openjdk:24-ea-22-bullseye`

```console
$ docker pull openjdk@sha256:64be37b2360f99217330589299c7e5fa37a4c59539df9452ed1e59ba9e63cccb
```
...
### `openjdk:24-ea-22-bullseye` - linux; amd64
...
### `openjdk:24-ea-22-bullseye` - unknown; unknown
