...
### `openjdk:25-ea-22-bookworm` - linux; amd64
...
### `openjdk:25-ea-22-bookworm` - unknown; unknown
...
### `openjdk:25-ea-22-bookworm` - linux; arm64 variant v8
