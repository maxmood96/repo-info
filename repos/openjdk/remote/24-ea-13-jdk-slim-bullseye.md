...
### `openjdk:24-ea-13-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:24-ea-13-jdk-slim-bullseye` - unknown; unknown
...
### `openjdk:24-ea-13-jdk-slim-bullseye` - linux; arm64 variant v8
