## `openjdk:24-ea-16-bookworm`

```console
$ docker pull openjdk@sha256:4a983cc3d4198ad69b16dcd03452ceb9bb8a21546fc6d18a84da6f3acee88de5
```
...
### `openjdk:24-ea-16-bookworm` - linux; amd64
...
### `openjdk:24-ea-16-bookworm` - unknown; unknown
