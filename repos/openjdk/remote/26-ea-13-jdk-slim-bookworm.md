...
```console
$ docker pull openjdk@sha256:108800784dd813c4643dd0b7f7f7ea4aa0a06c451713692c95a1e237a44ac501
```
...
### `openjdk:26-ea-13-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:26-ea-13-jdk-slim-bookworm` - unknown; unknown
