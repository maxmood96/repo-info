...
```console
$ docker pull openjdk@sha256:18750f4cd0cff064f4abeedf17003c8cbc1f61d24f447c4e49fafefe975cd5cf
```
...
### `openjdk:14.0.2-jdk-windowsservercore` - windows version 10.0.17763.1339; amd64
...
### `openjdk:14.0.2-jdk-windowsservercore` - windows version 10.0.14393.3808; amd64
