## `openjdk:24-ea-16-jdk`

```console
$ docker pull openjdk@sha256:57f6544183329bf782fa080caba9cdf9a8a38de9f4cd3de35279c314ab24125e
```
...
### `openjdk:24-ea-16-jdk` - linux; arm64 variant v8
...
### `openjdk:24-ea-16-jdk` - unknown; unknown
...
### `openjdk:24-ea-16-jdk` - windows version 10.0.20348.2700; amd64
...
### `openjdk:24-ea-16-jdk` - windows version 10.0.17763.6293; amd64
