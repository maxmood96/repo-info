...
```console
$ docker pull openjdk@sha256:f7b867528231424ee873115511ea334b1829446c6fb0218e9583185550f36344
```
...
### `openjdk:23-ea-33-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:23-ea-33-jdk-slim-bullseye` - unknown; unknown
