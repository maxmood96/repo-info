...
### `openjdk:27-ea-15-jdk-oracle` - linux; amd64
...
### `openjdk:27-ea-15-jdk-oracle` - unknown; unknown
...
### `openjdk:27-ea-15-jdk-oracle` - linux; arm64 variant v8
