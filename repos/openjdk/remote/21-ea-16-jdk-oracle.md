## `openjdk:21-ea-16-jdk-oracle`

```console
$ docker pull openjdk@sha256:3719231094a6a527e4e3773883b76d6f6dd6a2bea91e38924006f45e19677d1b
```
...
### `openjdk:21-ea-16-jdk-oracle` - linux; arm64 variant v8
