...
### `openjdk:27-ea-6-slim-bookworm` - linux; amd64
...
### `openjdk:27-ea-6-slim-bookworm` - unknown; unknown
...
### `openjdk:27-ea-6-slim-bookworm` - linux; arm64 variant v8
