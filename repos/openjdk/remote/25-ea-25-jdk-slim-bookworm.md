...
### `openjdk:25-ea-25-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:25-ea-25-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:25-ea-25-jdk-slim-bookworm` - linux; arm64 variant v8
