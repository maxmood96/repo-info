...
### `openjdk:24-ea-30-jdk-bookworm` - linux; amd64
...
### `openjdk:24-ea-30-jdk-bookworm` - unknown; unknown
...
### `openjdk:24-ea-30-jdk-bookworm` - linux; arm64 variant v8
