...
```console
$ docker pull openjdk@sha256:37c7bf60374d6f35d6d43a88f2945b572b14651210f65eff64cdecfc8ca67c97
```
...
### `openjdk:24-ea-17-jdk-bullseye` - linux; amd64
...
### `openjdk:24-ea-17-jdk-bullseye` - unknown; unknown
