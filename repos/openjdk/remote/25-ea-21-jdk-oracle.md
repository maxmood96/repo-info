...
### `openjdk:25-ea-21-jdk-oracle` - linux; amd64
...
### `openjdk:25-ea-21-jdk-oracle` - unknown; unknown
...
### `openjdk:25-ea-21-jdk-oracle` - linux; arm64 variant v8
