...
### `openjdk:25-ea-28-jdk-slim` - linux; amd64
...
### `openjdk:25-ea-28-jdk-slim` - unknown; unknown
...
### `openjdk:25-ea-28-jdk-slim` - linux; arm64 variant v8
