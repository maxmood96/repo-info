## `openjdk:8u342-bullseye`

```console
$ docker pull openjdk@sha256:bceb8fd0a0b9d5a6f17c4c5aaa492d6b2df063d79721ede60631f809e1d49f9b
```
...
### `openjdk:8u342-bullseye` - linux; amd64
...
### `openjdk:8u342-bullseye` - linux; arm64 variant v8
