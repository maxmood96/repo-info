## `openjdk:18-ea-16-bullseye`

```console
$ docker pull openjdk@sha256:eaa53b9ca5b4a8a7db9029cdf84a8ec58c153ec38719336b885901fc2ddcc61e
```
...
### `openjdk:18-ea-16-bullseye` - linux; amd64

```console
$ docker pull openjdk@sha256:6ccf8e52d13aff6ba5cd48a22812e73cc9a1213cd965fecac5369f64052860cd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.6 MB (327602516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:134ca015f3f1b79cdea6e9d551df70e2768939de71b16394ae5cdbc02beedb32`
...
### `openjdk:18-ea-16-bullseye` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:17f2f3e54fc9ca4570d9c44f71e5b4e4d9d56dbe99c18b22360bfd9bb22d75b0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.6 MB (326569091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b024a4f9a996d92a707cffdc195c3ba7704b30f9486c6c48110a55fa4c43eee1`
-	Default Command: `["jshell"]`
