...
### `openjdk:25-ea-29-oraclelinux9` - linux; amd64
...
### `openjdk:25-ea-29-oraclelinux9` - unknown; unknown
...
### `openjdk:25-ea-29-oraclelinux9` - linux; arm64 variant v8
