...
### `openjdk:22-ea-32-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:22-ea-32-jdk-slim-bookworm` - unknown; unknown
...
### `openjdk:22-ea-32-jdk-slim-bookworm` - linux; arm64 variant v8
