## `openjdk:26-ea-10-trixie`

```console
$ docker pull openjdk@sha256:72e3279738549701c0df35fee26ad9fdff6163d7bbac644b7866757b7ae23c06
```
...
### `openjdk:26-ea-10-trixie` - linux; amd64

```console
$ docker pull openjdk@sha256:24470a660b941968a59469033485c6fa9b3591f97514002de4205fe9509ca39e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **381.9 MB (381887124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4b05d51cabf7951fe350ed032282bf813e3e495a926f67aba17a5257c3a5953`
...
-	Layers:
	...
	-	`sha256:8ea45766c6449310ca2fc621a7e00bedb4b9b803a7fbfe2607efce6d2e07e435`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bd215b1a5a38a6b0876980b94310ebe2679eaf9fbd5cbfc40d255f05a4a19b12`  
		Last Modified: Tue, 12 Aug 2025 23:39:42 GMT  
		Size: 16.1 MB (16061144 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1ca26ae47cc602e467dc1a190e18c85fbbee29cb5c7aceeec9b7ecf2dbb482eb`  
		Last Modified: Wed, 13 Aug 2025 00:38:46 GMT  
		Size: 223.2 MB (223157444 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `openjdk:26-ea-10-trixie` - unknown; unknown

```console
$ docker pull openjdk@sha256:36f9c499e42781bf7c9745f9642a6d347eba95cb87787d71803ce1bc0e7dcbfe
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.5 MB (8526932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b624b2def38127e3952de24c2e8692fc390c63239d3958af668783c5bd8a23ab`

```dockerfile
```

-	Layers:
	-	`sha256:317867831a26a83961bd64b8d1297ec72c9ddcc3fcbb20b1b5007886479b6080`  
		Last Modified: Wed, 13 Aug 2025 00:24:53 GMT  
		Size: 8.5 MB (8508348 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:803c91a06c5761a27c3abb0fe3b3b65105762ab281c288cda42734fcb8ea2cb9`  
		Last Modified: Wed, 13 Aug 2025 00:24:54 GMT  
		Size: 18.6 KB (18584 bytes)  
		MIME: application/vnd.in-toto+json

### `openjdk:26-ea-10-trixie` - linux; arm64 variant v8
