...
### `openjdk:24-ea-21-jdk` - linux; amd64
...
### `openjdk:24-ea-21-jdk` - unknown; unknown
...
### `openjdk:24-ea-21-jdk` - linux; arm64 variant v8
...
### `openjdk:24-ea-21-jdk` - windows version 10.0.20348.2762; amd64
...
### `openjdk:24-ea-21-jdk` - windows version 10.0.17763.6414; amd64
