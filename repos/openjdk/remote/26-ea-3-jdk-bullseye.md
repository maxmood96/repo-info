...
### `openjdk:26-ea-3-jdk-bullseye` - linux; amd64
...
### `openjdk:26-ea-3-jdk-bullseye` - unknown; unknown
...
### `openjdk:26-ea-3-jdk-bullseye` - linux; arm64 variant v8
