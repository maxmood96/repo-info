## `openjdk:27-ea-17-oracle`

```console
$ docker pull openjdk@sha256:191913ea746cdcea1dd887a379705a47ab1c171d8c1e5acebc3f0dc37e3debfd
```
...
### `openjdk:27-ea-17-oracle` - linux; amd64
...
### `openjdk:27-ea-17-oracle` - unknown; unknown
...
### `openjdk:27-ea-17-oracle` - linux; arm64 variant v8
