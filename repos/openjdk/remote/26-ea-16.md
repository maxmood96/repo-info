...
```console
$ docker pull openjdk@sha256:81a9ff2987143937790e39fb1b53e12fe7985694b5a74514640b1afe7c1271d1
```
...
### `openjdk:26-ea-16` - linux; arm64 variant v8
...
### `openjdk:26-ea-16` - unknown; unknown
...
### `openjdk:26-ea-16` - windows version 10.0.26100.6584; amd64
...
### `openjdk:26-ea-16` - windows version 10.0.20348.4171; amd64
