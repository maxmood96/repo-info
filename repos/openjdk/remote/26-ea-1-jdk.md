...
```console
$ docker pull openjdk@sha256:126c09d4b7ce2adf5dfa173e3000afea7417c72d3fcf2e51f853f082e1c75a74
```
...
### `openjdk:26-ea-1-jdk` - linux; amd64
...
### `openjdk:26-ea-1-jdk` - unknown; unknown
...
### `openjdk:26-ea-1-jdk` - linux; arm64 variant v8
...
### `openjdk:26-ea-1-jdk` - windows version 10.0.26100.4349; amd64
...
### `openjdk:26-ea-1-jdk` - windows version 10.0.20348.3807; amd64
