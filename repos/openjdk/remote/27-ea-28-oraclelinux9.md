...
### `openjdk:27-ea-28-oraclelinux9` - linux; amd64
...
### `openjdk:27-ea-28-oraclelinux9` - unknown; unknown
...
### `openjdk:27-ea-28-oraclelinux9` - linux; arm64 variant v8
