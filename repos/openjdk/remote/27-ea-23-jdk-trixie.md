...
### `openjdk:27-ea-23-jdk-trixie` - linux; amd64
...
### `openjdk:27-ea-23-jdk-trixie` - unknown; unknown
...
### `openjdk:27-ea-23-jdk-trixie` - linux; arm64 variant v8
