...
### `openjdk:27-ea-10-oraclelinux8` - linux; amd64
...
### `openjdk:27-ea-10-oraclelinux8` - unknown; unknown
...
### `openjdk:27-ea-10-oraclelinux8` - linux; arm64 variant v8
