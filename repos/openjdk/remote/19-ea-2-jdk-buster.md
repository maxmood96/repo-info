## `openjdk:19-ea-2-jdk-buster`

```console
$ docker pull openjdk@sha256:d3e09ed57534e82c97c49315d096af594a6ca921b96e30d4aa691658963bd013
```
...
### `openjdk:19-ea-2-jdk-buster` - linux; amd64
...
### `openjdk:19-ea-2-jdk-buster` - linux; arm64 variant v8
