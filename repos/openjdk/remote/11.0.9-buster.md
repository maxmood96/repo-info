...
```console
$ docker pull openjdk@sha256:067c689c758ccc50caf9a860bbc17329cf20b76f47a82277cc5366de5a1496af
```
...
### `openjdk:11.0.9-buster` - linux; amd64
...
### `openjdk:11.0.9-buster` - linux; arm64 variant v8
