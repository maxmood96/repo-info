...
```console
$ docker pull openjdk@sha256:3e18ba703630d12a5781f8710fec8a0b68186a2d5fad6e7b08b97619c2332a06
```
...
```console
$ docker pull openjdk@sha256:34911c8db24ea54e7a9e08b070ca6f9357ddf1981f9d18b8328c1b936d3e910b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.9 MB (217938070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89425ed3d6e7ce0d99b86b349fa36c7f4a3e5ce664743f4e72185588c445d672`
...
```console
$ docker pull openjdk@sha256:b09cb8297601fc34f57c4a2566ede7cb0fd92be97c034f021264c7850f84725c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.4 MB (215359325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:410981e7e2b48896d0d868f419caaa809dc119f2d5521a9e1cadf7a856dadf1c`
-	Default Command: `["jshell"]`
