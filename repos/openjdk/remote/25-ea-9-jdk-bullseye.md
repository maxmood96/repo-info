...
### `openjdk:25-ea-9-jdk-bullseye` - linux; amd64
...
### `openjdk:25-ea-9-jdk-bullseye` - unknown; unknown
...
### `openjdk:25-ea-9-jdk-bullseye` - linux; arm64 variant v8
