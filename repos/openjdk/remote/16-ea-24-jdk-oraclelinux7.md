## `openjdk:16-ea-24-jdk-oraclelinux7`

```console
$ docker pull openjdk@sha256:230d295f7f5b457509da5f19f9a219f44d78fce189fe4a873fde210948c410fd
```
...
### `openjdk:16-ea-24-jdk-oraclelinux7` - linux; amd64
