## `openjdk:17-ea-12-jdk-slim`

```console
$ docker pull openjdk@sha256:c7952f51dfd8a9afc457671d858e91766912bcbe8a4466238be5f1c9c65ea8dc
```
...
### `openjdk:17-ea-12-jdk-slim` - linux; amd64
