...
### `openjdk:24-ea-2-slim-bookworm` - linux; amd64
...
### `openjdk:24-ea-2-slim-bookworm` - unknown; unknown
...
### `openjdk:24-ea-2-slim-bookworm` - linux; arm64 variant v8
