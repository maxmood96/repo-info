...
### `openjdk:24-ea-8-jdk-oracle` - linux; amd64
...
### `openjdk:24-ea-8-jdk-oracle` - unknown; unknown
...
### `openjdk:24-ea-8-jdk-oracle` - linux; arm64 variant v8
