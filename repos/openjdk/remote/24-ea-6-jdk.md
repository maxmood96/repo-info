...
### `openjdk:24-ea-6-jdk` - linux; amd64
...
### `openjdk:24-ea-6-jdk` - unknown; unknown
...
### `openjdk:24-ea-6-jdk` - linux; arm64 variant v8
...
### `openjdk:24-ea-6-jdk` - windows version 10.0.20348.2582; amd64
...
### `openjdk:24-ea-6-jdk` - windows version 10.0.17763.6054; amd64
