...
### `openjdk:23-ea-5-jdk` - linux; amd64
...
### `openjdk:23-ea-5-jdk` - unknown; unknown
...
### `openjdk:23-ea-5-jdk` - linux; arm64 variant v8
...
### `openjdk:23-ea-5-jdk` - windows version 10.0.20348.2227; amd64
...
### `openjdk:23-ea-5-jdk` - windows version 10.0.17763.5329; amd64
