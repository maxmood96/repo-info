...
### `openjdk:25-ea-18-jdk-bookworm` - linux; amd64
...
### `openjdk:25-ea-18-jdk-bookworm` - unknown; unknown
...
### `openjdk:25-ea-18-jdk-bookworm` - linux; arm64 variant v8
