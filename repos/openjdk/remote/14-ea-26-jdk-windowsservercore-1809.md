...
```console
$ docker pull openjdk@sha256:147bee21ae3d53755c8e04befa29be8490fdf6e4884d9ec152524775d4f4be0a
```
...
### `openjdk:14-ea-26-jdk-windowsservercore-1809` - windows version 10.0.17763.914; amd64
