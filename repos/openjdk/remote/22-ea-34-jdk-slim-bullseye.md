...
### `openjdk:22-ea-34-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:22-ea-34-jdk-slim-bullseye` - unknown; unknown
...
### `openjdk:22-ea-34-jdk-slim-bullseye` - linux; arm64 variant v8
