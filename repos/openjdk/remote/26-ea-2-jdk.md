...
### `openjdk:26-ea-2-jdk` - linux; amd64
...
### `openjdk:26-ea-2-jdk` - unknown; unknown
...
### `openjdk:26-ea-2-jdk` - linux; arm64 variant v8
...
### `openjdk:26-ea-2-jdk` - windows version 10.0.26100.4349; amd64
...
### `openjdk:26-ea-2-jdk` - windows version 10.0.20348.3807; amd64
