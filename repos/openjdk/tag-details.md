...
### `openjdk:22-ea-27-jdk-slim` - linux; amd64
...
### `openjdk:22-ea-27-jdk-slim-bookworm` - linux; amd64
...
### `openjdk:22-ea-27-oraclelinux8` - linux; amd64
...
### `openjdk:22-ea-27-slim` - linux; amd64
