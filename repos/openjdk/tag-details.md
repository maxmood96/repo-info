...
### `openjdk:22-ea-20-bookworm` - linux; amd64
...
### `openjdk:22-ea-20-jdk-slim-bullseye` - linux; amd64
...
### `openjdk:22-ea-20-oraclelinux8` - linux; amd64
...
### `openjdk:22-ea-20-slim-bullseye` - linux; amd64
