...
```console
$ docker pull flink@sha256:8a338b2b70f1ad7787d4b333bd3fbc7c9bd8bde4a802d42981b61cd389de1bf3
```
...
### `flink:1.20.5-java17` - linux; amd64

```console
$ docker pull flink@sha256:3a1efb08dca55954786ac33a9932b4c0e152974b0e00dfff71a24ceab04f175f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **585.1 MB (585143244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed90782430408fa64e1f76d2b6301f6e52faec2540ac0d61e9edbc7d019d2e45`
...
-	Layers:
	...
	-	`sha256:c93b6475daa329a3740bb43abc8e5f9a930e634998d68f8c32f092667b8ccfb9`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5eb7e1bc52a1715c0ff4193faf718c604c3461703e20e1fd6d4399342ef3f4dd`  
		Last Modified: Tue, 23 Jun 2026 23:28:53 GMT  
		Size: 1.2 MB (1169764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9def5c457e89aece7a17148be86ea02e8bd149b94e2c487cdac332e821ecd943`  
		Last Modified: Tue, 23 Jun 2026 23:28:53 GMT  
		Size: 900.5 KB (900493 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:032c5aeeffa98573cf9744afcd5e4845a9d70e4b5e9640b6ff6db7496f84b346`  
		Last Modified: Tue, 23 Jun 2026 23:28:52 GMT  
	...
	-	`sha256:1a6b7cdc3a7174723c3036e55ffd9f3fdf64256fd46e3bc761d822b523fa88cf`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9b278e38dba2d0e5f85ed3c77ab62633332f508f183e66523832b10d2914c2e3`  
		Last Modified: Tue, 23 Jun 2026 23:29:03 GMT  
		Size: 489.6 MB (489609300 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
### `flink:1.20.5-java17` - unknown; unknown

```console
$ docker pull flink@sha256:27429af17c9a28a51c3d6de06084bf3fd9dfc28075325ee7262f97c1c67cc566
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4027659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4620e8e23f76c29d2cf13980ed4fe1f430ce857d876e81a8aac914fb8cd148ba`

```dockerfile
```

-	Layers:
	-	`sha256:3b4cdb7174a3b8c82d60c13b21cf7086177a627d3930805ecae5adc908c68186`  
		Last Modified: Tue, 23 Jun 2026 23:28:53 GMT  
		Size: 4.0 MB (3997738 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8906ded4de3be08cef7c38cbff58dcaae570600377b55cb3844555df443c29c3`  
		Last Modified: Tue, 23 Jun 2026 23:28:53 GMT  
		Size: 29.9 KB (29921 bytes)  
		MIME: application/vnd.in-toto+json

### `flink:1.20.5-java17` - linux; arm64 variant v8

```console
$ docker pull flink@sha256:694df3c2c3fb61a17f3be53aa70aba46f358ac75d5b8614e848d0b5db0db3ac1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **582.2 MB (582229179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0cdcfd9346892d7ed7b1931a4a8c63f8e34ccca1c5bc78ffaa6482653d55d93`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["help"]`
...
# Fri, 15 May 2026 21:11:08 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Tue, 23 Jun 2026 23:28:23 GMT
RUN set -ex;   apt-get update;   apt-get -y install gpg libsnappy1v5 gettext-base libjemalloc-dev;   rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 23 Jun 2026 23:28:25 GMT
ENV GOSU_VERSION=1.11
# Tue, 23 Jun 2026 23:28:25 GMT
RUN set -ex;   wget -nv -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$(dpkg --print-architecture)";   wget -nv -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$(dpkg --print-architecture).asc";   export GNUPGHOME="$(mktemp -d)";   for server in hkps://keys.openpgp.org $(shuf -e                           keyserver.ubuntu.com                           hkp://keyserver.ubuntu.com:80                           pgp.mit.edu) ; do       gpg --batch --keyserver "$server" --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4 && break || : ;   done &&   gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu;   gpgconf --kill all;   rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc;   chmod +x /usr/local/bin/gosu;   gosu nobody true # buildkit
# Tue, 23 Jun 2026 23:28:25 GMT
...
-	Layers:
	...
	-	`sha256:4dfa4fa8392b71a4e9a65d8308287940ce342639c44f4a3b6996e0ee2c79228a`  
		...
		Size: 2.3 KB (2281 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b1f5061ad80f50a82302b959159e1fdf4eb206469de3e4c8612d39715bb0bae3`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
		Size: 1.0 MB (1041905 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:719ea7c494c3ef12214a7a6162c4374b8ef2e638254183ab272596233189c319`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
		Size: 835.4 KB (835385 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:29419f10fed54a37b50e8b5d72fc297c291631e9bba024f2178f8d90f5b136b4`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
		Size: 4.6 KB (4635 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d4ae901acb43a71e73d028a54c7216a197219cba3d499a18e8bdb74e1a63d90a`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9c2d48c794956e6aedfc5a7cf821212c55aa18a5d0ef855918f2a41fe653bde0`  
		Last Modified: Tue, 23 Jun 2026 23:29:25 GMT  
		Size: 489.6 MB (489609264 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b4e9b9c12a3f5cca5c991d4f2fb714f88918598253f576f1beca32e76c4a15bf`  
		Last Modified: Tue, 23 Jun 2026 23:29:08 GMT  
...
```console
$ docker pull flink@sha256:1c9986dae61e2ebde9cc3a428ab4b83345584d9d2d17d8235fc7281d321dbdc4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4027492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66f7ce89ce3056af5ba1b6abf8f6fb31fe1de6c582ec37c0d0d356f342c7fbf7`

```dockerfile
```

-	Layers:
	-	`sha256:250ddd6e5c8f33f4b1a583773b9984e8fdae5a35b17aa24bf843637467bc234a`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
		Size: 4.0 MB (3997423 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3b917598c22f06ffeb336986e64709d81174d5328504ce9acdfe3ceefb757d11`  
		Last Modified: Tue, 23 Jun 2026 23:29:07 GMT  
