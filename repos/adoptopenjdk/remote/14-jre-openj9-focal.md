...
```console
$ docker pull adoptopenjdk@sha256:59304eb1943ba3d46e2a21a5ca4518bd399735f6955dc183d8b97a954d7e292d
```
...
### `adoptopenjdk:14-jre-openj9-focal` - linux; amd64
...
### `adoptopenjdk:14-jre-openj9-focal` - linux; ppc64le
...
### `adoptopenjdk:14-jre-openj9-focal` - linux; s390x
