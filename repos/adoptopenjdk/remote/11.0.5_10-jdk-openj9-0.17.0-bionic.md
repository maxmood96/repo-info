...
### `adoptopenjdk:11.0.5_10-jdk-openj9-0.17.0-bionic` - linux; amd64
...
### `adoptopenjdk:11.0.5_10-jdk-openj9-0.17.0-bionic` - linux; ppc64le
...
### `adoptopenjdk:11.0.5_10-jdk-openj9-0.17.0-bionic` - linux; s390x
