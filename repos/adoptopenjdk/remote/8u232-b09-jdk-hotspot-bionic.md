...
```console
$ docker pull adoptopenjdk@sha256:cc804eb01272050cec306612cca666558db686583a770c501978766533d90cb0
```
...
### `adoptopenjdk:8u232-b09-jdk-hotspot-bionic` - linux; arm64 variant v8
