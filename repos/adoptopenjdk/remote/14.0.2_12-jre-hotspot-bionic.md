...
```console
$ docker pull adoptopenjdk@sha256:37e9281566bffa72e5dcf99d54a47218f3ae103e884e1e4e29780bc111d0d1d7
```
...
### `adoptopenjdk:14.0.2_12-jre-hotspot-bionic` - linux; amd64
...
### `adoptopenjdk:14.0.2_12-jre-hotspot-bionic` - linux; arm variant v7
...
### `adoptopenjdk:14.0.2_12-jre-hotspot-bionic` - linux; arm64 variant v8
...
### `adoptopenjdk:14.0.2_12-jre-hotspot-bionic` - linux; ppc64le
...
### `adoptopenjdk:14.0.2_12-jre-hotspot-bionic` - linux; s390x
