...
### `adoptopenjdk:8u272-b10-jdk-hotspot-focal` - linux; amd64
...
### `adoptopenjdk:8u272-b10-jdk-hotspot-focal` - linux; arm64 variant v8
...
### `adoptopenjdk:8u272-b10-jdk-hotspot-focal` - linux; ppc64le
...
### `adoptopenjdk:8u272-b10-jdk-hotspot-focal` - linux; s390x
