...
### `adoptopenjdk:11.0.9_11-jdk-hotspot-focal` - linux; amd64
...
### `adoptopenjdk:11.0.9_11-jdk-hotspot-focal` - linux; arm variant v7
...
### `adoptopenjdk:11.0.9_11-jdk-hotspot-focal` - linux; arm64 variant v8
...
### `adoptopenjdk:11.0.9_11-jdk-hotspot-focal` - linux; ppc64le
...
### `adoptopenjdk:11.0.9_11-jdk-hotspot-focal` - linux; s390x
