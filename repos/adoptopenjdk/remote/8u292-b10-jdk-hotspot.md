...
```console
$ docker pull adoptopenjdk@sha256:03a68f9d63f853675ad0aa66520094127a5599c5d62c57c0f6cc279a1997a5f4
```
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - linux; amd64

```console
$ docker pull adoptopenjdk@sha256:1f423aab000068791a3cf180acadc5d1d21f7808562f1ad844d2df0b32389cab
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.2 MB (148150802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c8aa53204a5b43b2f83dbe0cb2a03bbae977f50720525881020f51c2e69c11b`
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - linux; arm variant v7

```console
$ docker pull adoptopenjdk@sha256:2d4f72aea840bc09105e205ad7b191132e4084b5cf6f8aeb0d6f24999513c129
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.9 MB (137890580 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3163a56a536c5e58d90478f0ee8bf70435b44b239f8fefc49b2e3ce0f33d4ff6`
-	Default Command: `["bash"]`
...
ENV JAVA_VERSION=jdk8u292-b10
# Wed, 14 Jul 2021 01:29:18 GMT
RUN set -eux;     ARCH="$(dpkg --print-architecture)";     case "${ARCH}" in        aarch64|arm64)          ESUM='a29edaf66221f7a51353d3f28e1ecf4221268848260417bc562d797e514082a8';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_aarch64_linux_hotspot_8u292b10.tar.gz';          ;;        armhf|armv7l)          ESUM='0de107b7df38314c1daab78571383b8b39fdc506790aaef5d870b3e70048881b';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_arm_linux_hotspot_8u292b10.tar.gz';          ;;        ppc64el|ppc64le)          ESUM='7ecf00e57033296fd23201477a64dc13a1356b16a635907e104d079ddb544e4b';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_ppc64le_linux_hotspot_8u292b10.tar.gz';          ;;        s390x)          ESUM='276a431c79b7e94bc1b1b4fd88523383ae2d635ea67114dfc8a6174267f8fb2c';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_s390x_linux_hotspot_8u292b10.tar.gz';          LIBFFI_SUM='05e456a2e8ad9f20db846ccb96c483235c3243e27025c3e8e8e358411fd48be9';          LIBFFI_URL='http://launchpadlibrarian.net/354371408/libffi6_3.2.1-8_s390x.deb';          curl -LfsSo /tmp/libffi6.deb ${LIBFFI_URL};          echo "${LIBFFI_SUM} /tmp/libffi6.deb" | sha256sum -c -;          apt-get install -y --no-install-recommends /tmp/libffi6.deb;          rm -rf /tmp/libffi6.deb;          ;;        amd64|x86_64)          ESUM='0949505fcf42a1765558048451bb2a22e84b3635b1a31dd6191780eeccaa4ada';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_x64_linux_hotspot_8u292b10.tar.gz';          ;;        *)          echo "Unsupported arch: ${ARCH}";          exit 1;          ;;     esac;     curl -LfsSo /tmp/openjdk.tar.gz ${BINARY_URL};     echo "${ESUM} */tmp/openjdk.tar.gz" | sha256sum -c -;     mkdir -p /opt/java/openjdk;     cd /opt/java/openjdk;     tar -xf /tmp/openjdk.tar.gz --strip-components=1;     rm -rf /tmp/openjdk.tar.gz;
# Wed, 14 Jul 2021 01:29:19 GMT
ENV JAVA_HOME=/opt/java/openjdk PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
```
...
-	Layers:
	...
	-	`sha256:3374ff0390670de6a897592ab5ae9d7b16efe9170df99397d09cef4f6c91dab4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acd1a997470191262154cbfb557ecbf0e6c19f98725aae6ca708b56b168d12bf`  
		Last Modified: Wed, 14 Jul 2021 01:37:17 GMT  
		Size: 98.9 MB (98929504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `adoptopenjdk:8u292-b10-jdk-hotspot` - linux; arm64 variant v8

```console
$ docker pull adoptopenjdk@sha256:d8fcd96ca2d9f1395cf407d159221a9217c05f4e98a2b3c7a1d5305e2489e502
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (146019125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c87ae61d32f81ea244bc25b074de96d321a53a969d312b11923fe6358cd4d877`
-	Default Command: `["bash"]`
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - linux; ppc64le

```console
$ docker pull adoptopenjdk@sha256:d70fbb807c03906f3f104737aa9175b82936e2b2528047983bfe7297526f8a1f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.5 MB (151544284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dfece914eeb6a56def9555b544da6453d3196674db25cd3a8e675a797f390b3`
-	Default Command: `["bash"]`
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - linux; s390x

```console
$ docker pull adoptopenjdk@sha256:16c92a1ebdb1f77311e5dbfa0ead52cc4382e32010f7ff043d476d71fb97d029
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.5 MB (141531864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a0881ef34c57a0657588acf174f057e6d28fd1ad0fcd90aea40fd50bf9eca53`
-	Default Command: `["bash"]`
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - windows version 10.0.17763.2061; amd64
...
### `adoptopenjdk:8u292-b10-jdk-hotspot` - windows version 10.0.14393.4530; amd64

```console
$ docker pull adoptopenjdk@sha256:543577754002324116d0dbd24aeb4ac1aebbe2ac28cede00044ae69ef31e7aa5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.5 GB (6462778573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe0c40cff8909eaa899cdc09ac7d58bb56197e095bc906ab96076a6ed5cffb05`
-	Default Command: `["c:\\windows\\system32\\cmd.exe"]`
-	`SHELL`: `["powershell","-Command","$ErrorActionPreference = 'Stop'; $ProgressPreference = 'SilentlyContinue';"]`
...
-	Layers:
	...
	-	`sha256:aac0de4a2433923fda3f62862fc6e75acc7b69f6acf6714da22f1149cbfcf580`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41fd1f4ce0c9811ad3c5d07504ec29a5ecc37bd456f81a7bebad79380f6eb6e6`  
		Last Modified: Wed, 14 Jul 2021 16:42:00 GMT  
		Size: 193.1 MB (193143788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
