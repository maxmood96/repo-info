...
```console
$ docker pull adoptopenjdk@sha256:8b521823125921011852328590984901bbb0915609faed4011406ebbc73decbb
```
...
### `adoptopenjdk:11-jdk-hotspot-windowsservercore-1809` - windows version 10.0.17763.1697; amd64
