...
### `adoptopenjdk:16-jdk` - linux; amd64
...
### `adoptopenjdk:16-jdk` - linux; arm variant v7
...
### `adoptopenjdk:16-jdk` - linux; arm64 variant v8
...
### `adoptopenjdk:16-jdk` - linux; ppc64le
...
### `adoptopenjdk:16-jdk` - linux; s390x
...
### `adoptopenjdk:16-jdk` - windows version 10.0.17763.1817; amd64
...
### `adoptopenjdk:16-jdk` - windows version 10.0.14393.4283; amd64
