...
```console
$ docker pull adoptopenjdk@sha256:ae500b69afb946a668a6a8edbcb3ae6688fdbc167bcd27c6b9a2206cff56e663
```
...
```console
$ docker pull adoptopenjdk@sha256:de09da5b2edb594eb258b9b2705a2ecf8cbc671cc4149cec0685e886cfea3add
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.3 MB (86308421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59ff393ca9b787430b1fa0b0e8e1bb218fa61d8702808e93a4088f527602ebb7`
...
```console
$ docker pull adoptopenjdk@sha256:44ad54a71e7e592ea8d90c78781f3e6d4f6a3d050a3081b5806cb3bee8cb619c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **78.1 MB (78115788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7510051cdf1f33c205332e3a738d9c4a37f8ceadb170c3c41e28e377788f8e63`
-	Default Command: `["bash"]`
...
RUN apt-get update     && apt-get install -y --no-install-recommends tzdata curl ca-certificates fontconfig locales     && echo "en_US.UTF-8 UTF-8" >> /etc/locale.gen     && locale-gen en_US.UTF-8     && rm -rf /var/lib/apt/lists/*
# Wed, 14 Jul 2021 01:29:03 GMT
ENV JAVA_VERSION=jdk8u292-b10
# Wed, 14 Jul 2021 01:29:44 GMT
RUN set -eux;     ARCH="$(dpkg --print-architecture)";     case "${ARCH}" in        aarch64|arm64)          ESUM='b062ec775e6c2961532d9afeae4027fe3ac2cf4344cbc912a401be5bfb6ca221';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_aarch64_linux_hotspot_8u292b10.tar.gz';          ;;        armhf|armv7l)          ESUM='7f7707a7a3998737d2221080ea65d50ea96f5dde5226961ebcebd3ec99a82a32';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_arm_linux_hotspot_8u292b10.tar.gz';          ;;        ppc64el|ppc64le)          ESUM='245ecd0dfde7e763c0b65028aa0440489466926be2ba018977ac9047dc328a8e';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_ppc64le_linux_hotspot_8u292b10.tar.gz';          ;;        s390x)          ESUM='170c12f2017c212b23c1ba47728dcf9f5f2c9f2e29abf503136a8e55f513e048';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_s390x_linux_hotspot_8u292b10.tar.gz';          LIBFFI_SUM='05e456a2e8ad9f20db846ccb96c483235c3243e27025c3e8e8e358411fd48be9';          LIBFFI_URL='http://launchpadlibrarian.net/354371408/libffi6_3.2.1-8_s390x.deb';          curl -LfsSo /tmp/libffi6.deb ${LIBFFI_URL};          echo "${LIBFFI_SUM} /tmp/libffi6.deb" | sha256sum -c -;          apt-get install -y --no-install-recommends /tmp/libffi6.deb;          rm -rf /tmp/libffi6.deb;          ;;        amd64|x86_64)          ESUM='cad66f48f90167ed19030c71f8f0580702c43cce5ce5a0d76833f7a5ae7c402a';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_x64_linux_hotspot_8u292b10.tar.gz';          ;;        *)          echo "Unsupported arch: ${ARCH}";          exit 1;          ;;     esac;     curl -LfsSo /tmp/openjdk.tar.gz ${BINARY_URL};     echo "${ESUM} */tmp/openjdk.tar.gz" | sha256sum -c -;     mkdir -p /opt/java/openjdk;     cd /opt/java/openjdk;     tar -xf /tmp/openjdk.tar.gz --strip-components=1;     rm -rf /tmp/openjdk.tar.gz;
# Wed, 14 Jul 2021 01:29:45 GMT
ENV JAVA_HOME=/opt/java/openjdk PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
```
...
-	Layers:
	...
	-	`sha256:3374ff0390670de6a897592ab5ae9d7b16efe9170df99397d09cef4f6c91dab4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b01502e5d611f607363b5cb99b99c0dd36903d8ee8f1ee4c4ef62c479a67479d`  
		Last Modified: Wed, 14 Jul 2021 01:37:57 GMT  
		Size: 39.2 MB (39154712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `adoptopenjdk:8-jre` - linux; arm64 variant v8

```console
$ docker pull adoptopenjdk@sha256:6c5c19f53201e8fb6a51fad0ea51effe0da5affcbe38a979fc87132b5f7de414
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **84.1 MB (84091613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43158f67ece98368ba97361227eb7a226f13f60f22bd01f8a9f58fba793685ca`
-	Default Command: `["bash"]`
...
```console
$ docker pull adoptopenjdk@sha256:e03df7b330de78eca7bc319ec3924593ef774c41fea19342e96d8998c517f729
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.6 MB (91599242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4e906b8689d1d6b43368c25f4f0cd45891e866e63ad98b6e79ce85e235b13bd`
-	Default Command: `["bash"]`
...
```console
$ docker pull adoptopenjdk@sha256:54cb9d99eb8ab152782ce4f6d04d13129d30dd404924dcca029f9ac9f2280f21
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **81.7 MB (81730522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d65b091364eb931d2f77a6d14875b982b4bdc3ff3c9e6d292dce842a796bd4b7`
-	Default Command: `["bash"]`
...
ENV JAVA_VERSION=jdk8u292-b10
# Tue, 13 Jul 2021 23:19:27 GMT
RUN set -eux;     ARCH="$(dpkg --print-architecture)";     case "${ARCH}" in        aarch64|arm64)          ESUM='b062ec775e6c2961532d9afeae4027fe3ac2cf4344cbc912a401be5bfb6ca221';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_aarch64_linux_hotspot_8u292b10.tar.gz';          ;;        armhf|armv7l)          ESUM='7f7707a7a3998737d2221080ea65d50ea96f5dde5226961ebcebd3ec99a82a32';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_arm_linux_hotspot_8u292b10.tar.gz';          ;;        ppc64el|ppc64le)          ESUM='245ecd0dfde7e763c0b65028aa0440489466926be2ba018977ac9047dc328a8e';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_ppc64le_linux_hotspot_8u292b10.tar.gz';          ;;        s390x)          ESUM='170c12f2017c212b23c1ba47728dcf9f5f2c9f2e29abf503136a8e55f513e048';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_s390x_linux_hotspot_8u292b10.tar.gz';          LIBFFI_SUM='05e456a2e8ad9f20db846ccb96c483235c3243e27025c3e8e8e358411fd48be9';          LIBFFI_URL='http://launchpadlibrarian.net/354371408/libffi6_3.2.1-8_s390x.deb';          curl -LfsSo /tmp/libffi6.deb ${LIBFFI_URL};          echo "${LIBFFI_SUM} /tmp/libffi6.deb" | sha256sum -c -;          apt-get install -y --no-install-recommends /tmp/libffi6.deb;          rm -rf /tmp/libffi6.deb;          ;;        amd64|x86_64)          ESUM='cad66f48f90167ed19030c71f8f0580702c43cce5ce5a0d76833f7a5ae7c402a';          BINARY_URL='https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jre_x64_linux_hotspot_8u292b10.tar.gz';          ;;        *)          echo "Unsupported arch: ${ARCH}";          exit 1;          ;;     esac;     curl -LfsSo /tmp/openjdk.tar.gz ${BINARY_URL};     echo "${ESUM} */tmp/openjdk.tar.gz" | sha256sum -c -;     mkdir -p /opt/java/openjdk;     cd /opt/java/openjdk;     tar -xf /tmp/openjdk.tar.gz --strip-components=1;     rm -rf /tmp/openjdk.tar.gz;
# Tue, 13 Jul 2021 23:19:28 GMT
ENV JAVA_HOME=/opt/java/openjdk PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
```
...
-	Layers:
	...
	-	`sha256:0237838e148d45cea54b0d86c053131b4152f4928836cbb3a0c83ba79b538728`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85e090a293921fcf1fcb3a76c4c146c47a8eb4c7da8f1365a13c3a6b1a2d3c91`  
		Last Modified: Tue, 13 Jul 2021 23:32:42 GMT  
		Size: 38.8 MB (38839509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `adoptopenjdk:8-jre` - windows version 10.0.17763.2061; amd64

```console
$ docker pull adoptopenjdk@sha256:e4cea736768c4f687e7549a732325549eb425fae9efb20e2ca27ac8dc2ea79de
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.8 GB (2760178247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f243d74653f674c7370b79af5854eeaaa375bbc688d10411e808e7f0fd9a742`
...
-	Layers:
	...
	-	`sha256:fa9fd60d95dfab7c8e8aff71c9567b573b9ca71ce16bdaf3282be85dca3ce71a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:534fa2c4c5e284314ff96f641c4e3055ecf0f6994cdf25d550ecdd26338959c4`  
		Last Modified: Wed, 14 Jul 2021 16:43:35 GMT  
		Size: 74.7 MB (74728621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `adoptopenjdk:8-jre` - windows version 10.0.14393.4530; amd64

```console
$ docker pull adoptopenjdk@sha256:7436cb5e26eb6813f1dc753b61c1957363c8349c200ffdc39cdb3c6f80549e82
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.3 GB (6344286704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82b10e341695c61f692d11ec8fa1a0eb8597aa9e7acc0b5c1c9f9c9e3b09fb3f`
-	Default Command: `["c:\\windows\\system32\\cmd.exe"]`
-	`SHELL`: `["powershell","-Command","$ErrorActionPreference = 'Stop'; $ProgressPreference = 'SilentlyContinue';"]`
...
SHELL [powershell -Command $ErrorActionPreference = 'Stop'; $ProgressPreference = 'SilentlyContinue';]
# Wed, 14 Jul 2021 15:27:40 GMT
ENV JAVA_VERSION=jdk8u292-b10
# Wed, 14 Jul 2021 15:33:03 GMT
...
-	Layers:
	...
	-	`sha256:624cc64d28951435759fcbbc930532718666f3285fc939c97e36c2cda79f80f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aac0de4a2433923fda3f62862fc6e75acc7b69f6acf6714da22f1149cbfcf580`  
		Last Modified: Wed, 14 Jul 2021 16:38:19 GMT  
		Size: 1.4 KB (1426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9495ebfb67d9d73004af77035c3a51efcae2be623a12c2b393398926a0893be9`  
		Last Modified: Wed, 14 Jul 2021 16:43:59 GMT  
		Size: 74.7 MB (74651919 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
