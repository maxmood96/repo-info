...
```console
$ docker pull adoptopenjdk@sha256:f20df8e98a28a75b69f770be59b8431c2f878c29156fc8453fa0c5978857f3aa
```
...
### `adoptopenjdk:11.0.9_11-jre-hotspot-focal` - linux; amd64
...
### `adoptopenjdk:11.0.9_11-jre-hotspot-focal` - linux; arm variant v7
...
### `adoptopenjdk:11.0.9_11-jre-hotspot-focal` - linux; arm64 variant v8
...
### `adoptopenjdk:11.0.9_11-jre-hotspot-focal` - linux; ppc64le
...
### `adoptopenjdk:11.0.9_11-jre-hotspot-focal` - linux; s390x
