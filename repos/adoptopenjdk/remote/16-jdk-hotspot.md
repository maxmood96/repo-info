...
```console
$ docker pull adoptopenjdk@sha256:abdd7f5aeb5f32608b5a4d701872845759bca334a12f9e3e89676afe770522af
```
...
### `adoptopenjdk:16-jdk-hotspot` - windows version 10.0.17763.2061; amd64
...
### `adoptopenjdk:16-jdk-hotspot` - windows version 10.0.14393.4530; amd64
