...
```console
$ docker pull adoptopenjdk@sha256:bfbc45c03317bf739be5ca8ff61648a672d1aa18aea8053d2ff2d3e3e4f519fb
```
...
### `adoptopenjdk:16-jdk-hotspot` - windows version 10.0.17763.1999; amd64
...
### `adoptopenjdk:16-jdk-hotspot` - windows version 10.0.14393.4467; amd64
