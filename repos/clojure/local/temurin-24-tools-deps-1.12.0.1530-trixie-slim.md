...
### `dpkg` source package: `apt=3.0.1`

Binary Packages:

- `apt=3.0.1`
- `libapt-pkg7.0:amd64=3.0.1`
...
### `dpkg` source package: `bash-completion=1:2.16.0-7`
...
```console
$ apt-get source -qq --print-uris bash-completion=1:2.16.0-7
'http://deb.debian.org/debian/pool/main/b/bash-completion/bash-completion_2.16.0-7.dsc' bash-completion_2.16.0-7.dsc 2080 SHA256:6cb8252a09c86b0b06d14dc74c01d8c9289623d140ed99fd7eef2655d932d4b2
'http://deb.debian.org/debian/pool/main/b/bash-completion/bash-completion_2.16.0.orig.tar.gz' bash-completion_2.16.0.orig.tar.gz 503843 SHA256:c4d7edf0b035d8f6ed33294380326bde1fb8a4a8e24699566d545b4276141cc2
'http://deb.debian.org/debian/pool/main/b/bash-completion/bash-completion_2.16.0-7.debian.tar.xz' bash-completion_2.16.0-7.debian.tar.xz 20444 SHA256:b4d0472be217badd907634516f8f5da73090bdad2275834f5875b7dc85749c55
```

Other potentially useful URLs:

- https://sources.debian.net/src/bash-completion/1:2.16.0-7/ (for browsing the source)
- https://sources.debian.net/src/bash-completion/1:2.16.0-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bash-completion/1:2.16.0-7/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/c/cdebconf/cdebconf_0.278.dsc' cdebconf_0.278.dsc 2707 SHA256:57ed5abc75180c6e400b0c5e2d2fc5a179478d2460231fe7232ffbd6c65d9415
'http://deb.debian.org/debian/pool/main/c/cdebconf/cdebconf_0.278.tar.xz' cdebconf_0.278.tar.xz 285660 SHA256:d66b6500dcc041c39553b62ff2f50b1d0f2ba29435cf1b79f66512a0a3b8156a
```

Other potentially useful URLs:

- https://sources.debian.net/src/cdebconf/0.278/ (for browsing the source)
- https://sources.debian.net/src/cdebconf/0.278/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cdebconf/0.278/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `coreutils=9.7-2`
...
- `libcurl3t64-gnutls:amd64=8.13.0-5`
...
```console
$ apt-get source -qq --print-uris curl=8.13.0-5
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.13.0-5.dsc' curl_8.13.0-5.dsc 3231 SHA256:d0ee2f6a21f248054f098a445cc396bdca6bac5825340601ead87ffda588cc84
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.13.0.orig.tar.gz' curl_8.13.0.orig.tar.gz 4188717 SHA256:c261a4db579b289a7501565497658bbd52d3138fdbaccf1490fa918129ab45bc
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.13.0.orig.tar.gz.asc' curl_8.13.0.orig.tar.gz.asc 488 SHA256:a13900f07f7c54cb5fa3bb288b12e13532475ed6ef482fbe9a59f6d440759aa5
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.13.0-5.debian.tar.xz' curl_8.13.0-5.debian.tar.xz 54832 SHA256:f906118f346eb39e50e6bd22c3be433474475870cf71f23a9b6de55c4762040d
```

Other potentially useful URLs:

- https://sources.debian.net/src/curl/8.13.0-5/ (for browsing the source)
- https://sources.debian.net/src/curl/8.13.0-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/curl/8.13.0-5/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/d/dpkg/dpkg_1.22.18.dsc' dpkg_1.22.18.dsc 3406 SHA256:570965593ff88a6be0ccc4bef8eff566922c6758f86989d376cb03702374d1d4
'http://deb.debian.org/debian/pool/main/d/dpkg/dpkg_1.22.18.tar.xz' dpkg_1.22.18.tar.xz 5753376 SHA256:7135eb7960e38b2c77810d5aab8cabf5f690fed7475b7b0f2654fd91efbba0f6
```

Other potentially useful URLs:

- https://sources.debian.net/src/dpkg/1.22.18/ (for browsing the source)
- https://sources.debian.net/src/dpkg/1.22.18/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/dpkg/1.22.18/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/e/expat/expat_2.7.1-1.dsc' expat_2.7.1-1.dsc 1964 SHA256:4ffb7f7a8adf961deaaec47654866eb965bafeda54bbf006fbad56d33c2d1290
...
'http://deb.debian.org/debian/pool/main/e/expat/expat_2.7.1-1.debian.tar.xz' expat_2.7.1-1.debian.tar.xz 13204 SHA256:1c604a215810ed6598dcf49d87462a3b79c9d780aaf997ee1814b7afc1f25022
```

Other potentially useful URLs:

- https://sources.debian.net/src/expat/2.7.1-1/ (for browsing the source)
- https://sources.debian.net/src/expat/2.7.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/expat/2.7.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `git=1:2.47.2-0.1`

Binary Packages:

- `git=1:2.47.2-0.1`
- `git-man=1:2.47.2-0.1`
...
```console
$ apt-get source -qq --print-uris git=1:2.47.2-0.1
'http://deb.debian.org/debian/pool/main/g/git/git_2.47.2-0.1.dsc' git_2.47.2-0.1.dsc 2832 SHA256:0ff8e1ffeb1471f012ee2b93bcf21ceb2776abd88b1e9a171771f94d13eecde6
'http://deb.debian.org/debian/pool/main/g/git/git_2.47.2.orig.tar.xz' git_2.47.2.orig.tar.xz 7655652 SHA256:b19268be6b6f1556b47a9dd834272e167d3a75740cdcd283cf3812edffe3930f
'http://deb.debian.org/debian/pool/main/g/git/git_2.47.2-0.1.debian.tar.xz' git_2.47.2-0.1.debian.tar.xz 792848 SHA256:a183a1a1edd7190b6c6836f62a98662d1d2228a8b16ddd8163c29101b4342482
```

Other potentially useful URLs:

- https://sources.debian.net/src/git/1:2.47.2-0.1/ (for browsing the source)
- https://sources.debian.net/src/git/1:2.47.2-0.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/git/1:2.47.2-0.1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris glibc=2.41-7
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.41-7.dsc' glibc_2.41-7.dsc 7540 SHA256:0df18743da45048bf397878624f5dc1ea452fd59051b70b923162a756be174ca
...
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.41-7.debian.tar.xz' glibc_2.41-7.debian.tar.xz 416420 SHA256:51b15c3e56c23d7937e33fe13c1ced2f52d59fcee06321d71ece8e0d794ff519
```

Other potentially useful URLs:

- https://sources.debian.net/src/glibc/2.41-7/ (for browsing the source)
- https://sources.debian.net/src/glibc/2.41-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glibc/2.41-7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gpm=1.20.7-11`
...
```console
$ apt-get source -qq --print-uris gpm=1.20.7-11
'http://deb.debian.org/debian/pool/main/g/gpm/gpm_1.20.7-11.dsc' gpm_1.20.7-11.dsc 1995 SHA256:bf525d4e3aacaa375b29f2a1888c7d23c912e9133f6b0b016ea1a98cedb0ae71
...
'http://deb.debian.org/debian/pool/main/g/gpm/gpm_1.20.7-11.debian.tar.xz' gpm_1.20.7-11.debian.tar.xz 85096 SHA256:3624196c3c84a01bae2a245c81f7c28c37ca4693430637dc17ace329e826a807
```

Other potentially useful URLs:

- https://sources.debian.net/src/gpm/1.20.7-11/ (for browsing the source)
- https://sources.debian.net/src/gpm/1.20.7-11/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gpm/1.20.7-11/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/l/less/less_668-1.dsc' less_668-1.dsc 1889 SHA256:84c63a051999d30deab36131d98345d4277105dadfd5d7c63ffea6a631f498f1
'http://deb.debian.org/debian/pool/main/l/less/less_668.orig.tar.gz' less_668.orig.tar.gz 649770 SHA256:2819f55564d86d542abbecafd82ff61e819a3eec967faa36cd3e68f1596a44b8
'http://deb.debian.org/debian/pool/main/l/less/less_668.orig.tar.gz.asc' less_668.orig.tar.gz.asc 195 SHA256:5b24942fb8e4352fc22ddff6ccaa61eb978d590fb3eecd26591f5cca8965ab03
'http://deb.debian.org/debian/pool/main/l/less/less_668-1.debian.tar.xz' less_668-1.debian.tar.xz 22332 SHA256:83e659f43c11ee8591685744cd71e6b99e8cb430224649ac98557068d881e4ce
```

Other potentially useful URLs:

- https://sources.debian.net/src/less/668-1/ (for browsing the source)
- https://sources.debian.net/src/less/668-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/less/668-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libcap2=1:2.75-7`

Binary Packages:

- `libcap2:amd64=1:2.75-7`
...
```console
$ apt-get source -qq --print-uris libcap2=1:2.75-7
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.75-7.dsc' libcap2_2.75-7.dsc 2699 SHA256:9e039642853668796dd9b34f4e4cfd5d07fb416d5f90143b4f03104e7f4cb96b
...
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.75-7.debian.tar.xz' libcap2_2.75-7.debian.tar.xz 22504 SHA256:a284ed4c215f409f0894e494275b4e6e4140fa74f62a8bea3c414c12c4a9b636
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcap2/1:2.75-7/ (for browsing the source)
- https://sources.debian.net/src/libcap2/1:2.75-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcap2/1:2.75-7/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris patch=2.8-1
'http://deb.debian.org/debian/pool/main/p/patch/patch_2.8-1.dsc' patch_2.8-1.dsc 1689 SHA256:96c6d2eb32df1d5be002b9fabeb29446be8c90728bb842dd45d2ef06b1febd2f
...
'http://deb.debian.org/debian/pool/main/p/patch/patch_2.8-1.debian.tar.xz' patch_2.8-1.debian.tar.xz 8840 SHA256:7a85e5fe9fef087864ef836d392ef622b358868e85dbbadb896c0ae79000fe04
```

Other potentially useful URLs:

- https://sources.debian.net/src/patch/2.8-1/ (for browsing the source)
- https://sources.debian.net/src/patch/2.8-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/patch/2.8-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/pcre2/pcre2_10.45-1.dsc' pcre2_10.45-1.dsc 2337 SHA256:9b9d6aa2c970a416cb6808ac894d18fe37dd6df0497e2d75c13bb86429fa7b35
'http://deb.debian.org/debian/pool/main/p/pcre2/pcre2_10.45.orig.tar.gz' pcre2_10.45.orig.tar.gz 2715958 SHA256:0e138387df7835d7403b8351e2226c1377da804e0737db0e071b48f07c9d12ee
'http://deb.debian.org/debian/pool/main/p/pcre2/pcre2_10.45-1.diff.gz' pcre2_10.45-1.diff.gz 8659 SHA256:02ef5e4fbdf274f344c7be0efb3d1bdff538bd621e6988cc0a3d2c43da40b351
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcre2/10.45-1/ (for browsing the source)
...
'http://deb.debian.org/debian/pool/main/p/perl/perl_5.40.1-3.dsc' perl_5.40.1-3.dsc 2372 SHA256:97f69bf3cf3a4318a2a2a54cff072e3e870ed5426e7c578831791b63221f40b8
...
'http://deb.debian.org/debian/pool/main/p/perl/perl_5.40.1-3.debian.tar.xz' perl_5.40.1-3.debian.tar.xz 167844 SHA256:6144b016c000ebdf5643b41b2fb579a5845e17461d187983f82e7d26b637f146
```

Other potentially useful URLs:

- https://sources.debian.net/src/perl/5.40.1-3/ (for browsing the source)
- https://sources.debian.net/src/perl/5.40.1-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/perl/5.40.1-3/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris publicsuffix=20250328.1952-0.1
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20250328.1952-0.1.dsc' publicsuffix_20250328.1952-0.1.dsc 2025 SHA256:98a55e1962af969d2aa8584a620e766c98c8cd571e89ba217f58ca2ed873e33b
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20250328.1952.orig.tar.gz' publicsuffix_20250328.1952.orig.tar.gz 297725 SHA256:98a1c1966565e309fe72adf74495e5bd015a026163191bb39ea7291b0160bad6
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20250328.1952-0.1.debian.tar.xz' publicsuffix_20250328.1952-0.1.debian.tar.xz 152616 SHA256:e24023e0a96f01c01f247fa60d10cb61639006fb3662abd945979072f0317fbb
```

Other potentially useful URLs:

- https://sources.debian.net/src/publicsuffix/20250328.1952-0.1/ (for browsing the source)
- https://sources.debian.net/src/publicsuffix/20250328.1952-0.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/publicsuffix/20250328.1952-0.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python3.13=3.13.3-2`

Binary Packages:

- `libpython3.13-minimal:amd64=3.13.3-2`
- `libpython3.13-stdlib:amd64=3.13.3-2`
- `python3.13=3.13.3-2`
...
```console
$ apt-get source -qq --print-uris python3.13=3.13.3-2
'http://deb.debian.org/debian/pool/main/p/python3.13/python3.13_3.13.3-2.dsc' python3.13_3.13.3-2.dsc 3659 SHA256:febb40566dfe5ad4db2698ad5e5e2580b6d044d4e1aaf9ac48bc97504f373718
...
'http://deb.debian.org/debian/pool/main/p/python3.13/python3.13_3.13.3-2.debian.tar.xz' python3.13_3.13.3-2.debian.tar.xz 263172 SHA256:76b79bf1587114156f52cb37c5bd2bd4baccba41f6d1cf5ef6192913a8b5ab9d
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.13/3.13.3-2/ (for browsing the source)
- https://sources.debian.net/src/python3.13/3.13.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.13/3.13.3-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `rlwrap=0.46.1-1`
...
```console
$ apt-get source -qq --print-uris rlwrap=0.46.1-1
'http://deb.debian.org/debian/pool/main/r/rlwrap/rlwrap_0.46.1-1.dsc' rlwrap_0.46.1-1.dsc 1713 SHA256:2598aad1019da08d4dda32e948bc8dcc08e35abae3f6d8869c1d51873e437121
'http://deb.debian.org/debian/pool/main/r/rlwrap/rlwrap_0.46.1.orig.tar.gz' rlwrap_0.46.1.orig.tar.gz 185088 SHA256:c537e8a53df36f1f996601d776203478ad56fab1d67b3c1a63057badb0851cec
'http://deb.debian.org/debian/pool/main/r/rlwrap/rlwrap_0.46.1-1.debian.tar.xz' rlwrap_0.46.1-1.debian.tar.xz 5136 SHA256:738ab1cb5002322a4ca8413a9b425ec2aa489b85de91a3868573862a6f82563c
```

Other potentially useful URLs:

- https://sources.debian.net/src/rlwrap/0.46.1-1/ (for browsing the source)
- https://sources.debian.net/src/rlwrap/0.46.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rlwrap/0.46.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `rust-sequoia-sqv=1.3.0-2`
...
- `libsystemd0:amd64=257.5-2`
- `libudev1:amd64=257.5-2`
...
### `dpkg` source package: `util-linux=2.41-4`

Binary Packages:

- `bsdutils=1:2.41-4`
- `libblkid1:amd64=2.41-4`
- `liblastlog2-2:amd64=2.41-4`
- `libmount1:amd64=2.41-4`
- `libsmartcols1:amd64=2.41-4`
- `libuuid1:amd64=2.41-4`
- `login=1:4.16.0-2+really2.41-4`
- `mount=2.41-4`
- `util-linux=2.41-4`
...
'http://deb.debian.org/debian/pool/main/x/xauth/xauth_1.1.2-1.1.dsc' xauth_1.1.2-1.1.dsc 1828 SHA256:042ec790bd830c17bf1fe195d292f4eed29f0e095db1fb4e5156008ddda2ddd1
...
'http://deb.debian.org/debian/pool/main/x/xauth/xauth_1.1.2-1.1.diff.gz' xauth_1.1.2-1.1.diff.gz 18218 SHA256:763c20707faf0ba512294c83dcb2df4541e37eeb53eb596af608b0188de5243e
```

Other potentially useful URLs:

- https://sources.debian.net/src/xauth/1:1.1.2-1.1/ (for browsing the source)
- https://sources.debian.net/src/xauth/1:1.1.2-1.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xauth/1:1.1.2-1.1/ (for access to the source package after it no longer exists in the archive)
