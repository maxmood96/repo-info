...
- Image ID: `sha256:a573abeee2628384fab3fe54bdc59c61ac854f36f24eb08613448db8311e8412`
- Created: `2022-10-26T21:46:06.869764382Z`
- Virtual Size: ~ 658.83 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["entrypoint"]`
- Command: `["-M","--repl"]`
- Environment:
  - `PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/:/usr/local/bin/`
