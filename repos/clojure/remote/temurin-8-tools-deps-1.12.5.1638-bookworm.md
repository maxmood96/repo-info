...
### `clojure:temurin-8-tools-deps-1.12.5.1638-bookworm` - linux; amd64
...
### `clojure:temurin-8-tools-deps-1.12.5.1638-bookworm` - unknown; unknown
...
### `clojure:temurin-8-tools-deps-1.12.5.1638-bookworm` - linux; arm64 variant v8
...
### `clojure:temurin-8-tools-deps-1.12.5.1638-bookworm` - linux; ppc64le
