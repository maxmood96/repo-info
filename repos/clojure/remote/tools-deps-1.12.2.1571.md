...
### `clojure:tools-deps-1.12.2.1571` - linux; amd64
...
### `clojure:tools-deps-1.12.2.1571` - unknown; unknown
...
### `clojure:tools-deps-1.12.2.1571` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.2.1571` - linux; ppc64le
...
### `clojure:tools-deps-1.12.2.1571` - linux; s390x
