...
### `clojure:tools-deps-1.12.5.1638` - linux; amd64
...
### `clojure:tools-deps-1.12.5.1638` - unknown; unknown
...
### `clojure:tools-deps-1.12.5.1638` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.5.1638` - linux; ppc64le
...
### `clojure:tools-deps-1.12.5.1638` - linux; s390x
