...
### `clojure:tools-deps-1.12.1.1561` - linux; amd64
...
### `clojure:tools-deps-1.12.1.1561` - unknown; unknown
...
### `clojure:tools-deps-1.12.1.1561` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.1.1561` - linux; ppc64le
...
### `clojure:tools-deps-1.12.1.1561` - linux; s390x
