...
```console
$ docker pull clojure@sha256:143af5e4a5866249ff395f325015c0ed0e926812190cd9a0f5acdeb9bfae1999
```
...
-	Layers:
	...
	-	`sha256:c244b198380bbf608de1ecbda1e0e3609810b9fcf17b18827896242bfb9f0aae`  
		Last Modified: Tue, 04 Nov 2025 00:54:35 GMT  
...
```console
$ docker pull clojure@sha256:8544ad6a9e2e6e8620a672b6c242836f057b793a4ea7392efcdb3929b279cbdd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.8 MB (215831331 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e10e0fd3e88bbffa8a23aab737e600bbc7515c956b2cfb438d4da93c5b699d8`
-	Default Command: `["lein","repl"]`

```dockerfile
# Mon, 03 Nov 2025 20:44:10 GMT
RUN # debian.sh --arch 'arm64' out/ 'bullseye' '@1762202650'
# Tue, 04 Nov 2025 00:54:58 GMT
ENV JAVA_HOME=/opt/java/openjdk
# Tue, 04 Nov 2025 00:54:58 GMT
COPY /opt/java/openjdk /opt/java/openjdk # buildkit
# Tue, 04 Nov 2025 00:54:58 GMT
...
# Tue, 04 Nov 2025 00:54:58 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Tue, 04 Nov 2025 00:54:59 GMT
WORKDIR /tmp
# Tue, 04 Nov 2025 00:55:12 GMT
RUN set -eux; apt-get update && apt-get install -y make gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://codeberg.org/leiningen/leiningen/raw/tag/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "12a9c5e3a2471619ca3d64a7462f920fdf713ae8959eb4fcd6257c23332b5aa4 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 9D13D9426A0814B3373CF5E3D8A8243577A7859F && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mkdir -p /root/.lein && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget # buildkit
# Tue, 04 Nov 2025 00:55:12 GMT
ENV PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Tue, 04 Nov 2025 00:55:12 GMT
ENV LEIN_ROOT=1
# Tue, 04 Nov 2025 00:55:14 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.12.1"]])' > project.clj   && lein deps && rm project.clj # buildkit
# Tue, 04 Nov 2025 00:55:14 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0b2bebd3c1d760d1729d4fc07eaf8daa761cbd28c168e68cdc69c4fa51f97014`  
		Last Modified: Tue, 04 Nov 2025 00:55:41 GMT  
		Size: 16.6 MB (16594979 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7f2b45da051d23bcf36a798be3f3529d28e7a6865e0058808e193d4e10bcd533`  
...
```console
$ docker pull clojure@sha256:40cb36b7ec9f1b2ed271c627353bdce719ebfecc816b0ea80b49db147ed134df
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.5 MB (4512424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d6d31deb44752e069345750a9df0ab6c97c8b06f92602d09d606ecbbb6614f9`

```dockerfile
```

-	Layers:
	-	`sha256:35ee8f2fccd3030b7fb5066bf5f2f4e43f326e7e71c5b60f67a144eed3c12b94`  
		Last Modified: Tue, 04 Nov 2025 10:37:13 GMT  
		Size: 4.5 MB (4495921 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2e2fad2032701cb1e02c85e826ce73c8513565f2f736a60f4e3b192a7d587075`  
		Last Modified: Tue, 04 Nov 2025 10:37:14 GMT  
