...
```console
$ docker pull clojure@sha256:91762c1d33653077a553450706abd4743962b607fabda20798de4b55bdf9f445
```
...
### `clojure:tools-deps-1.12.4.1607-trixie-slim` - linux; amd64
...
### `clojure:tools-deps-1.12.4.1607-trixie-slim` - unknown; unknown
...
### `clojure:tools-deps-1.12.4.1607-trixie-slim` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.4.1607-trixie-slim` - linux; ppc64le
...
### `clojure:tools-deps-1.12.4.1607-trixie-slim` - linux; s390x
