...
```console
$ docker pull clojure@sha256:9de1b238c0193f2d316f786d276b27f40215e103b77b264a5a149aa450bc7605
```
...
```console
$ docker pull clojure@sha256:3639f411bd89345b26a4dc90a1b4591ecb0e2d5d0c541e1ff75900037dcf576c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.1 MB (290131557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1e29ec5bd883939ff46669f2642a682a72cf9c987630548ab2ac9371ee1e715`
...
# Thu, 01 Apr 2021 01:38:41 GMT
ENV BOOT_VERSION=2.8.3
# Thu, 01 Apr 2021 01:38:41 GMT
ENV BOOT_INSTALL=/usr/local/bin/
# Thu, 01 Apr 2021 01:38:42 GMT
WORKDIR /tmp
# Thu, 01 Apr 2021 01:38:44 GMT
RUN mkdir -p $BOOT_INSTALL && wget -q https://github.com/boot-clj/boot-bin/releases/download/latest/boot.sh && echo "Comparing installer checksum..." && sha256sum boot.sh && echo "0ccd697f2027e7e1cd3be3d62721057cbc841585740d0aaa9fbb485d7b1f17c3 *boot.sh" | sha256sum -c - && mv boot.sh $BOOT_INSTALL/boot && chmod 0755 $BOOT_INSTALL/boot
# Thu, 01 Apr 2021 01:38:44 GMT
ENV PATH=/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 01 Apr 2021 01:38:44 GMT
ENV BOOT_AS_ROOT=yes
# Thu, 01 Apr 2021 01:39:09 GMT
RUN boot
# Thu, 01 Apr 2021 01:39:10 GMT
CMD ["boot" "repl"]
```
...
-	Layers:
	...
	-	`sha256:914dd506c7501e988b3a395e2de51eac03bf5a4cbb7857663fd0ee0573f4dbc4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aaa073c86de0839d4740284eb09a117506196e9ed9d1b44dfd0dc3b67009fc9`  
		Last Modified: Thu, 01 Apr 2021 01:58:21 GMT  
		Size: 6.9 KB (6926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4998cb43d02d2e5ee0577d3e56136ecf0598d4319cb2c24071ada3da83a1b70c`  
		Last Modified: Thu, 01 Apr 2021 01:58:26 GMT  
