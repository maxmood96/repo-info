...
```console
$ docker pull clojure@sha256:538cda93776f7158647a8b868a36c181e65baad3765d92eaadd95d023ff03cd5
```
...
```console
$ docker pull clojure@sha256:2b25a25ae0014018155de3d61fcb32a7faeaa4138ee52c1548fd9583cfe459b3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.8 MB (350846806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58eeaac1bbbf8e5207f7ae284abdee6352c6a27e22b64e643bb161c8cfe6470d`
...
CMD ["jshell"]
# Thu, 27 Jan 2022 17:11:02 GMT
ENV LEIN_VERSION=2.9.8
# Thu, 27 Jan 2022 17:11:02 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 27 Jan 2022 17:11:02 GMT
WORKDIR /tmp
# Thu, 27 Jan 2022 17:11:16 GMT
...
-	Layers:
	...
	-	`sha256:4512bdd2598cabd6c3bd8ee70ad79fceb4082b9bc297ff1b46a4e769ed684062`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c68e9069d0772c0ca4103edaeec7c9c2aca1eebd563482323700b54f960babe8`  
		Last Modified: Thu, 27 Jan 2022 17:32:38 GMT  
		Size: 12.6 MB (12591573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac6e2185a365e41bf6f1e422fe6a77789f16d11c1c9b88597b99afa3a275edb1`  
		Last Modified: Thu, 27 Jan 2022 17:32:37 GMT  
...
```console
$ docker pull clojure@sha256:d6859f8f50671a8d6f30db2f60dd43d08eca3208d1c6b2fc988d469ba0c3d386
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.8 MB (346767924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a705e5733f49ec0ab48430ec040d3758a099c5210ebb410a8a8413099a699bf5`
-	Default Command: `["lein","repl"]`
...
CMD ["jshell"]
# Wed, 26 Jan 2022 21:28:55 GMT
ENV LEIN_VERSION=2.9.8
# Wed, 26 Jan 2022 21:28:56 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Wed, 26 Jan 2022 21:28:57 GMT
WORKDIR /tmp
# Wed, 26 Jan 2022 21:29:04 GMT
RUN set -eux; apt-get update && apt-get install -y make gnupg && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "9952cba539cc6454c3b7385ebce57577087bf2b9001c3ab5c55d668d0aeff6e9 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && if printf '%s\n%s\n' "2.9.7" "$LEIN_VERSION" | sort -cV; then               gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys 6A2D483DB59437EBB97D09B1040193357D0606ED;             else               gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 20242BACBBE95ADA22D0AFD7808A33D379C806C3;               FILENAME_EXT=zip;             fi && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg
# Wed, 26 Jan 2022 21:29:05 GMT
ENV PATH=/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Wed, 26 Jan 2022 21:29:05 GMT
ENV LEIN_ROOT=1
# Wed, 26 Jan 2022 21:29:09 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.3"]])' > project.clj   && lein deps && rm project.clj
# Wed, 26 Jan 2022 21:29:10 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:d46cad4095d077981b03d8fc3768a011689e84da8c906b28c8d762521c7d3d1a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b9d5d4307300513f6ca284ddcc5b9e116712b7f3032a1946dd2c00a2587c0e6`  
		Last Modified: Wed, 26 Jan 2022 21:51:04 GMT  
		Size: 12.4 MB (12350603 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af62a67ea4a8d998a61b4db1db1a9a93892241d5fb8e8b7f59b7d7eea0e34b41`  
		Last Modified: Wed, 26 Jan 2022 21:51:03 GMT  
