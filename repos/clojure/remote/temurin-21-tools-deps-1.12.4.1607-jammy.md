...
### `clojure:temurin-21-tools-deps-1.12.4.1607-jammy` - linux; amd64
...
### `clojure:temurin-21-tools-deps-1.12.4.1607-jammy` - unknown; unknown
...
### `clojure:temurin-21-tools-deps-1.12.4.1607-jammy` - linux; arm64 variant v8
...
### `clojure:temurin-21-tools-deps-1.12.4.1607-jammy` - linux; ppc64le
...
### `clojure:temurin-21-tools-deps-1.12.4.1607-jammy` - linux; s390x
