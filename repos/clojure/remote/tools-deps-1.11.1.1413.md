## `clojure:tools-deps-1.11.1.1413`

```console
$ docker pull clojure@sha256:e0becd11c4ca38a90a0779aafe4d042d46e150104d69060523c06bbf7dfa1ef6
```
...
### `clojure:tools-deps-1.11.1.1413` - linux; amd64

```console
$ docker pull clojure@sha256:42c75a92f73852e9b09c8ad212df10b0fbb13bb31239a6c3a9ceaa529e86a606
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.2 MB (247223932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:923ca454a8a5e35d4eb25650aa755ee9a2f14f80bdb9a7cd535e6ffc8434208b`
...
-	Layers:
	...
	-	`sha256:ebe3e1fbfc694c2c5f51c235a1e39256452b356bac11c8bf84cfc7c4d80f57c4`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bc48b19bd146b1ce281963126bac276443540360ab78e8c6af79ac5b6d6e9c7`  
		Last Modified: Sat, 02 Sep 2023 04:20:05 GMT  
		Size: 54.5 MB (54548400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4a546d73ebfca0fbc4e8c1091aa03f47509c2ae5a210248bf67f7a59409c526`  
		Last Modified: Sat, 02 Sep 2023 04:19:58 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bcf7b44d4ff1f3d07f80147dceecf5e72ddbffaad4262ad76f491ead2468429`  
		Last Modified: Sat, 02 Sep 2023 04:19:58 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `clojure:tools-deps-1.11.1.1413` - linux; arm64 variant v8

```console
$ docker pull clojure@sha256:5f4db787dee3479cb06ff531887e9d60cce299e09bd116e22e3bff4789d174b1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.3 MB (245328742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:535942310b6433bc475fbf9819920bfff34ca87faeb57f3df76686691f24d525`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
# Fri, 01 Sep 2023 23:30:26 GMT
CMD ["jshell"]
# Sat, 02 Sep 2023 01:50:15 GMT
ENV CLOJURE_VERSION=1.11.1.1413
# Sat, 02 Sep 2023 01:50:15 GMT
WORKDIR /tmp
# Sat, 02 Sep 2023 01:50:28 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "ad9aa1e99c59a4f7eb66450914fbec543337d9fada60dd9d34eec7fe18ae4965 *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Sat, 02 Sep 2023 01:50:29 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Sat, 02 Sep 2023 01:50:29 GMT
COPY file:137b40904568e30898cd031ef34f77e7f132846ba4eec91d04ae4b93dddfbb8d in /usr/local/bin/entrypoint 
# Sat, 02 Sep 2023 01:50:29 GMT
...
-	Layers:
	...
	-	`sha256:3979f02ed44e49a402b31eb35a56f3d8f92fe0d2dffe6ae62216fd91f57ace46`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89ac25cf93a7710d09ba59b9d72919cd3bb95b6b7dfdf961e837d6ef0b4c082d`  
		Last Modified: Sat, 02 Sep 2023 01:57:35 GMT  
		Size: 54.5 MB (54520404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be41139f06f2333010a3083a71df05f7c49a7f9cb7dbbc59694996c597d08018`  
		Last Modified: Sat, 02 Sep 2023 01:57:30 GMT  
		Size: 618.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:530a543b7b25b0c9fa197ff02f8ce73ab6667405a5b5293556dc7042dcc10bc9`  
		Last Modified: Sat, 02 Sep 2023 01:57:30 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
