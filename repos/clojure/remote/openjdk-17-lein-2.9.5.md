...
```console
$ docker pull clojure@sha256:064a0d23d204b557e24a61424ae6c3679691be8ebdf792751261abc376c72d96
```
...
```console
$ docker pull clojure@sha256:b900d18138f58d85026670ebb459fc23811e19107ceea6b66f96c8706cbceeb2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.0 MB (227043027 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc4a9769508d0ecb3fd8b771760a9299d017b899a4882cccac2342f7c070628d`
-	Default Command: `["lein","repl"]`
...
CMD ["jshell"]
# Thu, 11 Mar 2021 23:29:26 GMT
ENV LEIN_VERSION=2.9.5
# Thu, 11 Mar 2021 23:29:27 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 11 Mar 2021 23:29:28 GMT
WORKDIR /tmp
# Thu, 11 Mar 2021 23:29:47 GMT
RUN apt-get update && apt-get install -y gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "3601d55c4b5ac5c654e4ebd0d75abf7ad683f48cba8a7af1a8730b6590187b8a *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver keys.openpgp.org --recv-key 20242BACBBE95ADA22D0AFD7808A33D379C806C3 && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.zip.asc leiningen-$LEIN_VERSION-standalone.zip && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Thu, 11 Mar 2021 23:29:47 GMT
ENV PATH=/usr/local/openjdk-17/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 11 Mar 2021 23:29:48 GMT
ENV LEIN_ROOT=1
# Thu, 11 Mar 2021 23:29:55 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.2"]])' > project.clj   && lein deps && rm project.clj
# Thu, 11 Mar 2021 23:29:55 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:a15c5e4d83049a2a6c32a6589bbb0f37432b728a6d23954ef6136e5eaeaf6961`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99145b32679342b2fb7c46dd419c520a2f21ce0850d04a7274a76c65a9c1af19`  
		Last Modified: Thu, 11 Mar 2021 23:35:37 GMT  
		Size: 11.8 MB (11798299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c64a0a1cecf7b164aad3c7d7e8058af17b03fc77229618ce08d2a46d782400c5`  
		Last Modified: Thu, 11 Mar 2021 23:35:36 GMT  
		Size: 4.2 MB (4205108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
