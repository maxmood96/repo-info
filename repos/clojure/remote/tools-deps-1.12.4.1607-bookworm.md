...
### `clojure:tools-deps-1.12.4.1607-bookworm` - linux; amd64
...
### `clojure:tools-deps-1.12.4.1607-bookworm` - unknown; unknown
...
### `clojure:tools-deps-1.12.4.1607-bookworm` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.4.1607-bookworm` - linux; ppc64le
...
### `clojure:tools-deps-1.12.4.1607-bookworm` - linux; s390x
