...
### `clojure:tools-deps-1.12.1.1543-trixie-slim` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.1.1543-trixie-slim` - linux; ppc64le
...
### `clojure:tools-deps-1.12.1.1543-trixie-slim` - linux; riscv64
...
### `clojure:tools-deps-1.12.1.1543-trixie-slim` - linux; s390x
