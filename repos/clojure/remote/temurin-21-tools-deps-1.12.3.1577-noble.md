...
```console
$ docker pull clojure@sha256:686dea1e58c6a492e155ffb4a6f67fccac3f0125ea094465619a4f5386576682
```
...
```console
$ docker pull clojure@sha256:42373dd94b7ec190a11fb1675588c29ca8258dfac17038690198de7a62112e1d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **276.1 MB (276115326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc23c092780160f351301510ea912f7586971a2327a6c19e10694df95b810ae0`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
# Fri, 14 Nov 2025 07:21:52 GMT
WORKDIR /tmp
# Fri, 14 Nov 2025 07:31:12 GMT
RUN apt-get update && apt-get install -y curl make git rlwrap && rm -rf /var/lib/apt/lists/* && curl -fsSLO https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "a55106244ca93ef7b61309e9dca4b248257685870824a8abe2efa706ede8241f *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" # buildkit
# Fri, 14 Nov 2025 07:31:13 GMT
COPY rlwrap.retry /usr/local/bin/rlwrap # buildkit
# Fri, 14 Nov 2025 07:31:13 GMT
COPY entrypoint /usr/local/bin/entrypoint # buildkit
# Fri, 14 Nov 2025 07:31:13 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0177a535d5e750ff8c19fcbdb78847d43a389d7c3c75df8fc4b8e0e025cc783a`  
		Last Modified: Fri, 14 Nov 2025 07:32:03 GMT  
		Size: 59.8 MB (59754868 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:82c6dd8ac9ac1b832d7bb3b0065d122e683013e638d1851ab5f7fec43ca9c90c`  
		Last Modified: Fri, 14 Nov 2025 07:31:58 GMT  
		Size: 617.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fc8b3bd1770a2407d88761fdbdcb5cdfbcf08ab412163654d217ed89de25ded9`  
		Last Modified: Fri, 14 Nov 2025 07:31:58 GMT  
		Size: 399.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull clojure@sha256:d63316042b788bcd1776a55bd8acb455f8f17a946b95152bf3f6804f2b9bb148
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.0 MB (5973758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fca81dc387491f20c2882845079dc35ccac22d7d6b71f8823bfc398b0158232`

```dockerfile
```

-	Layers:
	-	`sha256:64996a566ec84b1ab0daed9e931d23a9eecaf6002f6225d210f80e9ba6ef3091`  
		Last Modified: Fri, 14 Nov 2025 10:38:34 GMT  
		Size: 6.0 MB (5958176 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b860dbf5ba71772363f6f75f9b64bd52a6a19cd2445c78c8e5bc762b4a504030`  
		Last Modified: Fri, 14 Nov 2025 10:38:35 GMT  
...
```console
$ docker pull clojure@sha256:740d7ba147394043a2ee759b667a1564457f5c37910b497dc1dd97d04ee19999
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **271.8 MB (271785606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff61092154039a8b2b9a77395b888a2984713e4ea920d600ad80e78e3b0ffb27`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
# Sat, 15 Nov 2025 21:34:33 GMT
WORKDIR /tmp
# Sat, 15 Nov 2025 21:54:32 GMT
RUN apt-get update && apt-get install -y curl make git rlwrap && rm -rf /var/lib/apt/lists/* && curl -fsSLO https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "a55106244ca93ef7b61309e9dca4b248257685870824a8abe2efa706ede8241f *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" # buildkit
# Sat, 15 Nov 2025 21:54:33 GMT
COPY rlwrap.retry /usr/local/bin/rlwrap # buildkit
# Sat, 15 Nov 2025 21:54:33 GMT
COPY entrypoint /usr/local/bin/entrypoint # buildkit
# Sat, 15 Nov 2025 21:54:33 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:573aaa960b5046ec862b572f8acf2e9e51cfc1fb9eed1506873d340ee07700dd`  
		Last Modified: Sat, 15 Nov 2025 21:58:45 GMT  
		Size: 63.5 MB (63479636 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9890c20cf4826340917ce03bca7460f13bc9e533e5340f5f3a113108a2ea97de`  
		Last Modified: Sat, 15 Nov 2025 21:58:41 GMT  
		Size: 614.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:67ecd41d927b30181993de8eb9f42083313d4ea50eaf0689e30889dd4dc963a4`  
		Last Modified: Sat, 15 Nov 2025 21:58:41 GMT  
		Size: 398.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull clojure@sha256:560f491cd20d08fc966daefe32fb82d4438aa56186b70cd23f73925fc3818c8f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.0 MB (6026611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38cfad1b1cf890f26270fb959d214a318001f48739f937967c0d92e316aa2332`

```dockerfile
```

-	Layers:
	-	`sha256:7847b166f0a18b5bbb749cd47b96e6a8ba162f5fc45ae4485e8889cc8789f3fb`  
		Last Modified: Sat, 15 Nov 2025 22:37:17 GMT  
		Size: 6.0 MB (6011029 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6710ee129670b70e46a5540e681dffad5eccb1a304177544b240c64c27ab702d`  
		Last Modified: Sat, 15 Nov 2025 22:37:17 GMT  
		Size: 15.6 KB (15582 bytes)  
		MIME: application/vnd.in-toto+json
