...
```console
$ docker pull clojure@sha256:d795bae72b0ae3b8f3b5307cf71fbe7902190655f28bbb8e0582ea4b37de2ab8
```
...
```console
$ docker pull clojure@sha256:cbf5730819eec53416d80c223f63eab28e8df46be83bd4f3c520005b6fd4b0e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198619813 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5abe2596c940b3fa9eb14b477452aa72842434384663829addf0bdf0f4076b1`
...
# Wed, 17 Jan 2024 07:15:03 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Wed, 17 Jan 2024 14:11:33 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Wed, 17 Jan 2024 14:11:33 GMT
WORKDIR /tmp
# Wed, 17 Jan 2024 14:11:56 GMT
...
-	Layers:
	...
	-	`sha256:8df04bc9ca3f63493e4e3a5d1df9f8c98ef892c1a7054cf5110c6bac471ed2a9`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b4e108c53bac88e0a644d4878cfe6cd96eca6a80a608ea4fef4d64c6b4263da`  
		Last Modified: Wed, 17 Jan 2024 14:47:54 GMT  
		Size: 51.7 MB (51667075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edd0fc43bb0ac08a9c0876586ab929260b96eada4d967ed87f7bb00167171cc9`  
		Last Modified: Wed, 17 Jan 2024 14:47:48 GMT  
		Size: 618.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:94ffe5b2c37ea2f0762700ebdeea35c5e467bd54268fec4de3adc7069ef3fbfa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.6 MB (195605953 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8de304291a9bf59b73483e6569cfce4270b6855e4f3cddee33e51842d2a8e393`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["clj"]`
...
# Wed, 17 Jan 2024 06:58:00 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Wed, 17 Jan 2024 09:21:57 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Wed, 17 Jan 2024 09:21:57 GMT
WORKDIR /tmp
# Wed, 17 Jan 2024 09:22:13 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "7edee5b12197a2dbe6338e672b109b18164cde84bea1f049ceceed41fc4dd10a *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Wed, 17 Jan 2024 09:22:13 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Wed, 17 Jan 2024 09:22:13 GMT
...
-	Layers:
	...
	-	`sha256:32df1e7fc05d2cd82e7bf05b9de0a091504af7f2eaeba40e6154958f1c0d9b84`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7b15f7febfcad7860c33845ed59e6c3b018402e55d26bc04883f304720fed39`  
		Last Modified: Wed, 17 Jan 2024 09:36:38 GMT  
		Size: 51.6 MB (51649869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4614e32efdf9f32f4bda8a7ca87831fed40c63036547b6542f2b57e316aad66f`  
		Last Modified: Wed, 17 Jan 2024 09:36:33 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
