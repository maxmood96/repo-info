...
```console
$ docker pull clojure@sha256:12d406828b07d7d602cc652fe03ba142a92bf3ad371d8a3ae3e129aec0fba3ae
```
...
```console
$ docker pull clojure@sha256:d903eea0be6a6503bf9dcbb62a0a3ac3928d4d7a5277693cee037160ca33244f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198625576 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b7e100e4eea51a06ba2e33addfda83a32f8f909e55f3a0cf0b40e3686381317`
...
-	Layers:
	...
	-	`sha256:401c25db2ebafaaede733d2b3e5cd7dc70e004edd4e8b8fbe8768a80106825ec`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8983285beebd97f70cfa0db366b1dd05b2daf5b7f496097c10e4b63aa529c45f`  
		Last Modified: Thu, 28 Mar 2024 03:18:46 GMT  
		Size: 51.7 MB (51666748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34c7cd53f5549ac0d837c81b37aa4dd7c0a03d4c7daed53ff60cd99665230374`  
...
```console
$ docker pull clojure@sha256:e5b1b55b9bbc7e44e35c9601204363cd2dee704ed02f3a3096407740d7b78178
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.6 MB (195603364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd65085778fa3533f9abfe99920fb04db5b2dc793ad524577ae8c361c67559f1`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["clj"]`
...
# Thu, 28 Mar 2024 02:31:47 GMT
WORKDIR /tmp
# Thu, 28 Mar 2024 02:32:07 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "7edee5b12197a2dbe6338e672b109b18164cde84bea1f049ceceed41fc4dd10a *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Thu, 28 Mar 2024 02:32:08 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Thu, 28 Mar 2024 02:32:08 GMT
CMD ["clj"]
```
...
-	Layers:
	...
	-	`sha256:c6328c808abc1335b4efa10cdd4cb1d0c9b06b944f4aca3b409376141a42768b`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89a52f3b010e9d9ea15a708c4d69ce910e1e3b0d6c9076f03fcb7ce8fb51bd07`  
		Last Modified: Thu, 28 Mar 2024 02:49:03 GMT  
		Size: 51.6 MB (51649032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a64ffd77ad5ae0df3078fc8ec1c01428e277b07147a4f7819991dc05e4a5372`  
		Last Modified: Thu, 28 Mar 2024 02:48:58 GMT  
		Size: 620.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
