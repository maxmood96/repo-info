...
```console
$ docker pull clojure@sha256:d13392abb6041e32a87c6eca42df3ecacfafe55a6d9b0c75785686c18412767a
```
...
```console
$ docker pull clojure@sha256:50d663e57af0f7c1239931affc20ec58005819723326f098d639e419c329c275
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198618106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5ba0e86b74635b2db2b9ac74bff1047cd31b73a8e05ca4d5a94a1a77571c779`
...
# Tue, 23 Apr 2024 20:51:38 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Tue, 28 May 2024 21:26:18 GMT
ENV CLOJURE_VERSION=1.11.3.1456
# Tue, 28 May 2024 21:26:18 GMT
WORKDIR /tmp
# Tue, 28 May 2024 21:26:46 GMT
...
-	Layers:
	...
	-	`sha256:95775e4b4d5153b3651e53c635338b8c37d6cd12fb3dff3f6df1534464e41628`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce5c8493b193484cd8dcd35636df524588e390cafcf7e82af64ec314c741b2af`  
		Last Modified: Tue, 28 May 2024 21:52:24 GMT  
		Size: 51.7 MB (51669055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2151af1abd28c90c537488edee959c1246f73fa6239a6a52cda04830411a00fe`  
		Last Modified: Tue, 28 May 2024 21:52:18 GMT  
		Size: 621.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:f6c860b4f92f565186ddfdce9949e4558757b59b3bed74c065d9abeef5c1cebb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.6 MB (195605589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1edc52793e2a322bc7c6e502e9d79398644946698dfb0490d8b1c41e1e24b205`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["clj"]`
...
# Tue, 23 Apr 2024 20:51:38 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Tue, 28 May 2024 19:49:31 GMT
ENV CLOJURE_VERSION=1.11.3.1456
# Tue, 28 May 2024 19:49:31 GMT
WORKDIR /tmp
# Tue, 28 May 2024 19:50:16 GMT
RUN apt-get update && apt-get install -y curl make git rlwrap && rm -rf /var/lib/apt/lists/* && curl -fsSLO https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "2f5edc801133c72a49e990816b0e245beb8b4e35a85524b4dd0b3fa03a4a5365 *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)"
# Tue, 28 May 2024 19:50:17 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Tue, 28 May 2024 19:50:17 GMT
CMD ["clj"]
```
...
-	Layers:
	...
	-	`sha256:a22bcaede3cb82201c2804d7a050cbf18f994bd6f0b34f3ec133a47cc3c24ca9`  
		...
		Size: 731.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01e1776f88f5a41c3c88ff8e8c0ffef4853b9d71f8b56b8d177921ede2997a9f`  
		Last Modified: Tue, 28 May 2024 20:10:47 GMT  
		Size: 51.7 MB (51651704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b765df7b74782d126480bb6c11167a9ff0286b936b2ed503e1eeaa70ab83b9fa`  
		Last Modified: Tue, 28 May 2024 20:10:41 GMT  
		Size: 618.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
