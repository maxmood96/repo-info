...
```console
$ docker pull clojure@sha256:c51c1ef3cce34d3ffd48c215811fd20f67a96574afd8c3a3da6fd775b89e4a68
```
...
```console
$ docker pull clojure@sha256:9874da8d6ea3db4df52a7f96fcdfec73599395fa233fd16560e66d22294fb8ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198625784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f20ec913b24f8fe43c07d8bfec5d2f8df3d6a65a67b4883f355a1b88555b965`
...
# Wed, 06 Mar 2024 06:02:39 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Wed, 06 Mar 2024 14:00:53 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Wed, 06 Mar 2024 14:00:54 GMT
WORKDIR /tmp
# Wed, 06 Mar 2024 14:01:16 GMT
...
-	Layers:
	...
	-	`sha256:2d8727e407d8afb0bc127215ae7755d265a18fae32a798b36e72e1aa732ade25`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b318bd91630ebd3cfe652dfd77266ada06119b4a3c9f233ff3b2dcb06dbfc8e`  
		Last Modified: Wed, 06 Mar 2024 14:22:24 GMT  
		Size: 51.7 MB (51667131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a714638d9e94c58c2f69e80fccb8a480ddaba7fa44218a4ce4afe5a99798f28c`  
		Last Modified: Wed, 06 Mar 2024 14:22:18 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:8b175676d20ee6c0cfe1d6a5b9b6d4eb463f71209c70db2e6d25b70f49cfdcb8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.6 MB (195604081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e10b7fa4da4f4cf7a4bf952bd25b66aeb2121397608933cedccacefb45197f5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["clj"]`
...
# Wed, 06 Mar 2024 04:01:55 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Wed, 06 Mar 2024 13:15:10 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Wed, 06 Mar 2024 13:15:10 GMT
WORKDIR /tmp
# Wed, 06 Mar 2024 13:15:32 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "7edee5b12197a2dbe6338e672b109b18164cde84bea1f049ceceed41fc4dd10a *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Wed, 06 Mar 2024 13:15:33 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Wed, 06 Mar 2024 13:15:33 GMT
CMD ["clj"]
```
...
-	Layers:
	...
	-	`sha256:3b4ca9405ba8d165ed87c13f38e95b6b519f9d8b4d4c97040cb9ac6c5ade21e3`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9091162a8eea68b4afeed5633aad45e533add47c0f70704ef771de3d1fe8b4e1`  
		Last Modified: Wed, 06 Mar 2024 13:33:12 GMT  
		Size: 51.6 MB (51649797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d26c36e4acb523d6a201382b64f3bc976bb6687a8296fe1855c7f37a0608d714`  
		Last Modified: Wed, 06 Mar 2024 13:33:07 GMT  
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
