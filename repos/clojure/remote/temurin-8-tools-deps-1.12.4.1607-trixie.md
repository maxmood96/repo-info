...
### `clojure:temurin-8-tools-deps-1.12.4.1607-trixie` - linux; amd64
...
### `clojure:temurin-8-tools-deps-1.12.4.1607-trixie` - unknown; unknown
...
### `clojure:temurin-8-tools-deps-1.12.4.1607-trixie` - linux; arm64 variant v8
...
### `clojure:temurin-8-tools-deps-1.12.4.1607-trixie` - linux; ppc64le
