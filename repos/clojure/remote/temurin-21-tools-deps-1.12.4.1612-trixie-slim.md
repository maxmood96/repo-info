...
```console
$ docker pull clojure@sha256:2f6f39895f0b77cd3763493ae569e6a06df11e657639750cb31d8899b35bcded
```
...
### `clojure:temurin-21-tools-deps-1.12.4.1612-trixie-slim` - linux; amd64
...
### `clojure:temurin-21-tools-deps-1.12.4.1612-trixie-slim` - unknown; unknown
...
### `clojure:temurin-21-tools-deps-1.12.4.1612-trixie-slim` - linux; arm64 variant v8
...
### `clojure:temurin-21-tools-deps-1.12.4.1612-trixie-slim` - linux; ppc64le
...
### `clojure:temurin-21-tools-deps-1.12.4.1612-trixie-slim` - linux; s390x
