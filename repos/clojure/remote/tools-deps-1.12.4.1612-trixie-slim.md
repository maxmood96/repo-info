...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - linux; amd64
...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - unknown; unknown
...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - linux; ppc64le
...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - linux; riscv64
...
### `clojure:tools-deps-1.12.4.1612-trixie-slim` - linux; s390x
