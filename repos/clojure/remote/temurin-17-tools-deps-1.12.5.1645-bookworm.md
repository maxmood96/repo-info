## `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm`

```console
$ docker pull clojure@sha256:43acc866164d9f19fe439c59a3a2e856100a0ec80b496720938ed719dcad39c9
```
...
### `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm` - linux; amd64
...
### `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm` - unknown; unknown
...
### `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm` - linux; arm64 variant v8
...
### `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm` - linux; ppc64le
...
### `clojure:temurin-17-tools-deps-1.12.5.1645-bookworm` - linux; s390x
