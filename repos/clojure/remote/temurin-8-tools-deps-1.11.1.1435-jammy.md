...
```console
$ docker pull clojure@sha256:a4e83d6866f7257c74586d1d3376279bf386353a58a317755b6a6564b62a1ead
```
...
```console
$ docker pull clojure@sha256:6b4adf73f7cdda3b7eace21cab8168b7d3821b4fde82dd816139145616eff610
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198626523 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:913a67819bfe1bbdcd62014231d7d8c4bffab18e815f56751a3f957ecf3e7194`
...
# Fri, 16 Feb 2024 01:38:55 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Fri, 16 Feb 2024 05:13:36 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Fri, 16 Feb 2024 05:13:37 GMT
WORKDIR /tmp
# Fri, 16 Feb 2024 05:13:55 GMT
...
-	Layers:
	...
	-	`sha256:a3a45aa4c4e140beade15c463ee14bd7d915806eeaef64b1f07b379223c561d8`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b009ed7cfc671b8383e46e6aa6e70a0a99bebea50af2c10fcd239c630550d7b`  
		Last Modified: Fri, 16 Feb 2024 05:31:47 GMT  
		Size: 51.7 MB (51667184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3169f387038c55f551dcee6eca27f4b4e7881dc0ba6694e30d7a01614d2c2cb7`  
		Last Modified: Fri, 16 Feb 2024 05:31:40 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:170f04dae68f28540acad67a999146d413b09508d482451d502fb9508cc805c8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.6 MB (195606430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9001cb82e37f0dfdcf369799415c5ad073071598c01c19af57d250f99f99e21c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["clj"]`
...
# Fri, 02 Feb 2024 02:10:18 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Fri, 02 Feb 2024 08:19:08 GMT
ENV CLOJURE_VERSION=1.11.1.1435
# Fri, 02 Feb 2024 08:19:08 GMT
WORKDIR /tmp
# Fri, 02 Feb 2024 08:19:31 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "7edee5b12197a2dbe6338e672b109b18164cde84bea1f049ceceed41fc4dd10a *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Fri, 02 Feb 2024 08:19:32 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Fri, 02 Feb 2024 08:19:32 GMT
CMD ["clj"]
```
...
-	Layers:
	...
	-	`sha256:ce0b92b348457895515e6390ad70809750c9a696861ac0f5fc499392d661e3ae`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2b1faedb25d50d60caedbc211460a858d78481ff9592ea9adddbdc556528296`  
		Last Modified: Fri, 02 Feb 2024 08:37:44 GMT  
		Size: 51.6 MB (51649777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8076dacaeecb8500161d6a96912eb8491b4c9b2a1ffa627e8431fa05222a23bd`  
		Last Modified: Fri, 02 Feb 2024 08:37:39 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
