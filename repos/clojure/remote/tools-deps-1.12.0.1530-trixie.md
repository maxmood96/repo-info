...
### `clojure:tools-deps-1.12.0.1530-trixie` - linux; amd64
...
### `clojure:tools-deps-1.12.0.1530-trixie` - unknown; unknown
...
### `clojure:tools-deps-1.12.0.1530-trixie` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.0.1530-trixie` - linux; ppc64le
...
### `clojure:tools-deps-1.12.0.1530-trixie` - linux; riscv64
...
### `clojure:tools-deps-1.12.0.1530-trixie` - linux; s390x
