...
```console
$ docker pull clojure@sha256:a80820b8b1b9b071dbebe4a936d6ab62862185a3e3450220f6eeb8b8c88531f5
```
...
```console
$ docker pull clojure@sha256:30ccc2e1a3c6f397ccb38e2435d42c812459ecbab5fbf679e7b4a6c669504ee3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.5 MB (207501489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bccfa28b86b372f8f2c28ef1fd39a6848e6c600bf27cb6fe62aadd97a3cd2259`
...
# Thu, 25 Jan 2024 19:32:13 GMT
CMD ["jshell"]
# Mon, 29 Jan 2024 19:42:28 GMT
ENV LEIN_VERSION=2.11.1
# Mon, 29 Jan 2024 19:42:28 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Mon, 29 Jan 2024 19:42:28 GMT
WORKDIR /tmp
# Mon, 29 Jan 2024 19:42:40 GMT
...
# Mon, 29 Jan 2024 19:42:41 GMT
ENV LEIN_ROOT=1
# Mon, 29 Jan 2024 19:42:43 GMT
...
-	Layers:
	...
	-	`sha256:bb0c36fa009100f1a06827c7626dd35c4a6648a73bf9802fe2a18a1b18c19512`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:589b7176df8a48605b952c989236beadf3dd59203ffd0628e4c57c3dba8098cc`  
		Last Modified: Mon, 29 Jan 2024 19:52:55 GMT  
		Size: 14.5 MB (14459435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:456d82e246e99f07ecf357d09034c092c28d40c08bf8e29349436fd2288e38df`  
		Last Modified: Mon, 29 Jan 2024 19:52:54 GMT  
		Size: 4.4 MB (4399141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `clojure:temurin-11-lein` - linux; arm64 variant v8

```console
$ docker pull clojure@sha256:559928779bf6f39f452f56325c97e3372dd3170ee8ab17f6050fc45b33bc8af2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.1 MB (202123264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b88005750ebc0df6d4e31679d5193fd031e50276b39ac0e4f5d5df0de50a23f9`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["lein","repl"]`
...
# Fri, 02 Feb 2024 02:11:02 GMT
CMD ["jshell"]
# Fri, 02 Feb 2024 08:24:40 GMT
ENV LEIN_VERSION=2.11.1
# Fri, 02 Feb 2024 08:24:40 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Fri, 02 Feb 2024 08:24:40 GMT
WORKDIR /tmp
# Fri, 02 Feb 2024 08:24:52 GMT
RUN set -eux; apt-get update && apt-get install -y make gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://codeberg.org/leiningen/leiningen/raw/tag/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "03b3fbf7e6fac262f88f843a87b712a2b37f39cffc4f4f384436a30d8b01d6e4 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 9D13D9426A0814B3373CF5E3D8A8243577A7859F && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Fri, 02 Feb 2024 08:24:52 GMT
ENV PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Fri, 02 Feb 2024 08:24:52 GMT
ENV LEIN_ROOT=1
# Fri, 02 Feb 2024 08:24:54 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.11.1"]])' > project.clj   && lein deps && rm project.clj
# Fri, 02 Feb 2024 08:24:54 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:d8c52a928a1c521eed89178fa2f6673baa8f5399a4965aab4f75b5c1af3fea6c`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1faaaa4c3d2f37ab1c5d0de81ed30bf6620c39ec05b2b4c57f4ddf517c6d2554`  
		Last Modified: Fri, 02 Feb 2024 08:40:25 GMT  
		Size: 14.5 MB (14459178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da3157e55b45010e0d1b07aa2bafb93e21fc249c7adfc6376ad1bc208c02e25`  
		Last Modified: Fri, 02 Feb 2024 08:40:24 GMT  
		Size: 4.4 MB (4399137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
