...
```console
$ docker pull clojure@sha256:2f729abb073ba26df6e2e910eda3a4cd4e63f303a980a5e5ad1dbb6db8e8ee04
```
...
### `clojure:tools-deps-1.11.1.1323` - linux; amd64
...
### `clojure:tools-deps-1.11.1.1323` - linux; arm64 variant v8
