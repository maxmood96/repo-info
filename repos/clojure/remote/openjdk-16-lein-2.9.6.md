...
```console
$ docker pull clojure@sha256:36d3c6e26630ffdc2e8d660cc492f4a81f049e93d4090937b97a6d35354992fb
```
...
```console
$ docker pull clojure@sha256:d9ae70023461f82c4b3c94ac6d1ee3a2187d6342f981faec99a749d058d8eb77
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.6 MB (231610730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f9ccdbc76637c37ce494748128b23d583126f47cf961a65a01bd0b6fee6492a`
...
CMD ["jshell"]
# Fri, 23 Jul 2021 07:13:12 GMT
ENV LEIN_VERSION=2.9.6
# Fri, 23 Jul 2021 07:13:13 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Fri, 23 Jul 2021 07:13:13 GMT
WORKDIR /tmp
# Fri, 23 Jul 2021 07:13:22 GMT
...
# Fri, 23 Jul 2021 07:13:22 GMT
ENV LEIN_ROOT=1
# Fri, 23 Jul 2021 07:13:25 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.3"]])' > project.clj   && lein deps && rm project.clj
# Fri, 23 Jul 2021 07:13:26 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:832966127d0da9170ec8437f178aa3ef092c50755f743b7c3e39fbdb05ba3e73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e7cc16f50f82f679bde910b23ec66d3ba53861c62f2ac66b010d1e05cdc0965`  
		Last Modified: Fri, 23 Jul 2021 07:23:36 GMT  
		Size: 11.8 MB (11803012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:102e8bb15c3076645892c795307de0cbb61997546f0f691f93c01079444d82d6`  
		Last Modified: Fri, 23 Jul 2021 07:23:36 GMT  
...
```console
$ docker pull clojure@sha256:d0212ab9673c886ec44bd8176c22313d1159088991fe4af77913b79a58e69b13
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.6 MB (224605019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b9fe561f2b07ffc9e3baba1cf110826ed7ed1aee77792f7c9e8a7a3849fb752`
-	Default Command: `["lein","repl"]`
...
CMD ["jshell"]
# Thu, 22 Jul 2021 20:30:12 GMT
ENV LEIN_VERSION=2.9.6
# Thu, 22 Jul 2021 20:30:12 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 22 Jul 2021 20:30:12 GMT
WORKDIR /tmp
# Thu, 22 Jul 2021 20:30:32 GMT
RUN apt-get update && apt-get install -y gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "094b58e2b13b42156aaf7d443ed5f6665aee27529d9512f8d7282baa3cc01429 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver keys.openpgp.org --recv-key 20242BACBBE95ADA22D0AFD7808A33D379C806C3 && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.zip.asc leiningen-$LEIN_VERSION-standalone.zip && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Thu, 22 Jul 2021 20:30:32 GMT
ENV PATH=/usr/local/openjdk-16/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 22 Jul 2021 20:30:32 GMT
ENV LEIN_ROOT=1
# Thu, 22 Jul 2021 20:30:35 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.3"]])' > project.clj   && lein deps && rm project.clj
# Thu, 22 Jul 2021 20:30:36 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:04e0b0137dea4fd55d596ad6fe274c16e03c68361d25d0a0f9c3c1a4d711914f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b2ee319e6d6a9cca9f330fceb1613d1868b889a6c68a9615d30ee60450a41c8`  
		Last Modified: Thu, 22 Jul 2021 20:41:26 GMT  
		Size: 11.8 MB (11802883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44ac4191a13cd0db4fdaa419aabd68e3ce3b87c9a199a4defe5c2b7fd62d2b79`  
		Last Modified: Thu, 22 Jul 2021 20:41:25 GMT  
