...
```console
$ docker pull clojure@sha256:bdff8d12c334e9724a0eba8f2049977d2d4a1b5f79e03e7072402ca940a5a43e
```
...
```console
$ docker pull clojure@sha256:74f54929d8013bf6b6cb676671b40eb6f59a61b10fa1504605c7ebb55c23250c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.6 MB (199621575 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de127a71793190627c35b4c0641ec644766813f24cd0f60148767f1f6f92ffe9`
-	Default Command: `["clj"]`
...
# Tue, 12 Jul 2022 16:08:48 GMT
ENV CLOJURE_VERSION=1.11.1.1149
# Tue, 12 Jul 2022 16:08:48 GMT
WORKDIR /tmp
# Tue, 12 Jul 2022 16:09:05 GMT
...
-	Layers:
	...
	-	`sha256:e5bb6d406ee56d2ec0f242c91a97c204cfb6307fd3e547798c13ebeeebf197e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6465b8487c9b3bf57d1a016a4c5cad1fddf54fa96acc4dc5350b7b8054b75dda`  
		Last Modified: Tue, 12 Jul 2022 16:17:54 GMT  
		Size: 60.5 MB (60456476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:841a0fac804de7b8452e32a195d10590eb0124810d3ef94319bef2ff92439541`  
		Last Modified: Tue, 12 Jul 2022 16:17:46 GMT  
		Size: 624.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:29a4aaa6005f06ce0e5bbbea31ae264e42216de6692ecc83ed85430682b2ff6f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.0 MB (196979098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99fe8d0638d25f56738acef8ad357c858827dea63d3e8be7bd552a8a3a15835a`
-	Default Command: `["clj"]`
...
RUN set -eux; 		arch="$(dpkg --print-architecture)"; 	case "$arch" in 		'amd64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u332-b09/OpenJDK8U-jdk_x64_linux_8u332b09.tar.gz'; 			;; 		'arm64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u332-b09/OpenJDK8U-jdk_aarch64_linux_8u332b09.tar.gz'; 			;; 		*) echo >&2 "error: unsupported architecture: '$arch'"; exit 1 ;; 	esac; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		dirmngr 		gnupg 		wget 	; 	rm -rf /var/lib/apt/lists/*; 		wget --progress=dot:giga -O openjdk.tgz "$downloadUrl"; 	wget --progress=dot:giga -O openjdk.tgz.asc "$downloadUrl.sign"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --keyserver keyserver.ubuntu.com --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$JAVA_HOME/jre/lib/security/cacerts"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		javac -version; 	java -version
# Tue, 12 Jul 2022 17:14:34 GMT
ENV CLOJURE_VERSION=1.11.1.1149
# Tue, 12 Jul 2022 17:14:35 GMT
WORKDIR /tmp
...
-	Layers:
	...
	-	`sha256:abae956d26f0f6c37b3cca2515f7de0e6002cab03197a495c1c44a4ef4ca6ebc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67322d2e3b04dd92d960ab162a9765dc0b586fe0f259f8ff35c588a25fd74044`  
		Last Modified: Tue, 12 Jul 2022 17:26:28 GMT  
		Size: 60.4 MB (60380810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15ae820a68ed119868651ac0d0668e3738b394662df0f5f657aa5be63d147001`  
		Last Modified: Tue, 12 Jul 2022 17:26:19 GMT  
		Size: 626.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
