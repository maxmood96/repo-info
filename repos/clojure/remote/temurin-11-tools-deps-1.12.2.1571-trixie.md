...
### `clojure:temurin-11-tools-deps-1.12.2.1571-trixie` - linux; amd64
...
### `clojure:temurin-11-tools-deps-1.12.2.1571-trixie` - unknown; unknown
...
### `clojure:temurin-11-tools-deps-1.12.2.1571-trixie` - linux; arm64 variant v8
...
### `clojure:temurin-11-tools-deps-1.12.2.1571-trixie` - linux; ppc64le
...
### `clojure:temurin-11-tools-deps-1.12.2.1571-trixie` - linux; s390x
