...
### `clojure:temurin-11-tools-deps-1.12.5.1645-jammy` - linux; amd64
...
### `clojure:temurin-11-tools-deps-1.12.5.1645-jammy` - unknown; unknown
...
### `clojure:temurin-11-tools-deps-1.12.5.1645-jammy` - linux; arm64 variant v8
...
### `clojure:temurin-11-tools-deps-1.12.5.1645-jammy` - linux; ppc64le
...
### `clojure:temurin-11-tools-deps-1.12.5.1645-jammy` - linux; s390x
