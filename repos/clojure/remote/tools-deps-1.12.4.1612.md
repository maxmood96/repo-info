...
### `clojure:tools-deps-1.12.4.1612` - linux; amd64
...
### `clojure:tools-deps-1.12.4.1612` - unknown; unknown
...
### `clojure:tools-deps-1.12.4.1612` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.4.1612` - linux; ppc64le
...
### `clojure:tools-deps-1.12.4.1612` - linux; s390x
