...
```console
$ docker pull clojure@sha256:8197a8445cb0eb1c984afa318498969edeb0d1312c81e3e8cf0eaa985e116529
```
...
```console
$ docker pull clojure@sha256:a38f85177f45d6c7a255ec1a9d43dcce10eb23e1df7e19b6b6c79d96c33a752b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.5 MB (235536110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fb20f4c4ccd30e9326de8a70d01bfc5dede9952fabab001b51a145490176b75`
...
CMD ["jshell"]
# Thu, 21 Apr 2022 00:30:41 GMT
ENV LEIN_VERSION=2.9.8
# Thu, 21 Apr 2022 00:30:42 GMT
...
-	Layers:
	...
	-	`sha256:67bdf31b68717524e362a27632620f1fb7c20f98df8266069471050c943348c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06f2761376598c9f31d669b9971fe3081f7ce89d0879331cae2df0412b00d688`  
		Last Modified: Thu, 21 Apr 2022 00:52:58 GMT  
		Size: 11.9 MB (11863418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:316c7428eddaa877030cbf69351b5bbbf5516e19af1665956d0fcf00c64daae1`  
		Last Modified: Thu, 21 Apr 2022 00:52:57 GMT  
		Size: 4.2 MB (4207222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83fe5d620dd8d5f64063eb22d6fb7640ca6707f3fdc70005e65cadd63a31c7d2`  
		Last Modified: Thu, 21 Apr 2022 00:52:57 GMT  
		Size: 406.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:e2e4de7f0f549697908d66fd6f47198e5714f8a69c5a4df4cd1c65f8ba74c4b4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.7 MB (232665432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7184f06044aa3f3e660f777611fee83d19983194b28fc193bccea2ada15f36d3`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["repl"]`
...
CMD ["jshell"]
# Wed, 30 Mar 2022 09:48:34 GMT
ENV LEIN_VERSION=2.9.8
# Wed, 30 Mar 2022 09:48:35 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Wed, 30 Mar 2022 09:48:36 GMT
WORKDIR /tmp
# Wed, 30 Mar 2022 09:48:51 GMT
RUN set -eux; apt-get update && apt-get install -y gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "9952cba539cc6454c3b7385ebce57577087bf2b9001c3ab5c55d668d0aeff6e9 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && if printf '%s\n%s\n' "2.9.7" "$LEIN_VERSION" | sort -cV; then               gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys 6A2D483DB59437EBB97D09B1040193357D0606ED;             else               gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 20242BACBBE95ADA22D0AFD7808A33D379C806C3;               FILENAME_EXT=zip;             fi && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Wed, 30 Mar 2022 09:48:52 GMT
ENV PATH=/usr/local/openjdk-18/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Wed, 30 Mar 2022 09:48:53 GMT
ENV LEIN_ROOT=1
# Wed, 30 Mar 2022 09:48:58 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.3"]])' > project.clj   && lein deps && rm project.clj
# Wed, 30 Mar 2022 09:49:00 GMT
COPY file:cf90f595e38d932dff3bdcd4221efe7c65fb3432787490053b55b6917f06e4cd in /usr/local/bin/entrypoint 
# Wed, 30 Mar 2022 09:49:00 GMT
ENTRYPOINT ["entrypoint"]
# Wed, 30 Mar 2022 09:49:01 GMT
CMD ["repl"]
```
...
-	Layers:
	...
	-	`sha256:48f9851eea0f63f4e1441e8632210304b963bef313a55ca238b7ba1975c61ea7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf988de3645d90046ee00ad4745ff0b03c10b9d2f4facc16c8ab583823999ac4`  
		Last Modified: Wed, 30 Mar 2022 10:18:07 GMT  
		Size: 11.7 MB (11650236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5c9b60684af499c4bf0cf88da8a013b677027fe87e7f926430a2201860e1a74`  
		Last Modified: Wed, 30 Mar 2022 10:18:07 GMT  
		Size: 4.2 MB (4207064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5862a885783f40aea9a8c5112cdbba82a2e2235c0b790c799c5e8f48c5e7fa3f`  
		Last Modified: Wed, 30 Mar 2022 10:18:06 GMT  
		Size: 407.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
