...
### `clojure:temurin-11-tools-deps-1.12.1.1561-trixie` - linux; amd64
...
### `clojure:temurin-11-tools-deps-1.12.1.1561-trixie` - unknown; unknown
...
### `clojure:temurin-11-tools-deps-1.12.1.1561-trixie` - linux; arm64 variant v8
...
### `clojure:temurin-11-tools-deps-1.12.1.1561-trixie` - linux; ppc64le
...
### `clojure:temurin-11-tools-deps-1.12.1.1561-trixie` - linux; s390x
