...
### `clojure:temurin-8-tools-deps-1.12.1.1561-bookworm` - linux; amd64
...
### `clojure:temurin-8-tools-deps-1.12.1.1561-bookworm` - unknown; unknown
...
### `clojure:temurin-8-tools-deps-1.12.1.1561-bookworm` - linux; arm64 variant v8
...
### `clojure:temurin-8-tools-deps-1.12.1.1561-bookworm` - linux; ppc64le
