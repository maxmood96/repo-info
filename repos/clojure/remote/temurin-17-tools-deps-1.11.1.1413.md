...
```console
$ docker pull clojure@sha256:1182b2433253ccdaeae5de5cb26d68547ffc19e106786543c9249c57b6635214
```
...
```console
$ docker pull clojure@sha256:49743674e012e86d6986813b1bcfd5db372b3b21f3d9f8ce2caed726f8a8f799
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.3 MB (247323540 bytes)**  
...
-	Layers:
	...
	-	`sha256:7dde3ab12c0f85f2f9a988da397a4a64afc2b1e4b5ec4ca72a3e5a620a77d263`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59b17f4a690cbbc8f7f3e14f35fabe46dbb25f268d429e088530d664f2e1a4a4`  
		Last Modified: Sat, 02 Dec 2023 10:22:31 GMT  
		Size: 54.5 MB (54539699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e8f280a078b206ed85c6650650b23420828ffedea51c19a6ef9db6120ee459f`  
		Last Modified: Sat, 02 Dec 2023 10:22:24 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f408ee44aed32d60b4b1688f7ea7f4f2f469c2f6642705300ad049d3974d27b`  
		Last Modified: Sat, 02 Dec 2023 10:22:24 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:297b9714b11e71c2a83583d3d435756c977924fb6cbb0834f53687596e670f9d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.5 MB (245466963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64dee5ce9ebd3220379791681ceb0ced6d7eb9e13925f1a67e0847a729900ae8`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
# Sat, 02 Dec 2023 05:33:08 GMT
CMD ["jshell"]
# Sat, 02 Dec 2023 08:59:24 GMT
ENV CLOJURE_VERSION=1.11.1.1413
# Sat, 02 Dec 2023 08:59:24 GMT
WORKDIR /tmp
# Sat, 02 Dec 2023 08:59:37 GMT
RUN apt-get update && apt-get install -y make git rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && sha256sum linux-install-$CLOJURE_VERSION.sh && echo "ad9aa1e99c59a4f7eb66450914fbec543337d9fada60dd9d34eec7fe18ae4965 *linux-install-$CLOJURE_VERSION.sh" | sha256sum -c - && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && rm linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get purge -y --auto-remove wget
# Sat, 02 Dec 2023 08:59:37 GMT
COPY file:b0aef3ea203de7b5c2ea645debf58c8231445a2e3070b72749b54614f4a89b82 in /usr/local/bin/rlwrap 
# Sat, 02 Dec 2023 08:59:37 GMT
...
-	Layers:
	...
	-	`sha256:9d09be65578f663048ff0b94845bd4e097b253f967bd3498e0ec5b412527436c`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:816aec9455dc6651d03de81884ef48c470723f51d4675fd01d7478a3b59e6a16`  
		Last Modified: Sat, 02 Dec 2023 09:12:01 GMT  
		Size: 54.5 MB (54516399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03b0c0286ce5f8c30568994e83c80e31d70db8b634cd92dedbc4effe06f75c19`  
		Last Modified: Sat, 02 Dec 2023 09:11:55 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89610e882acedc8c462cf30c76e0fec45e87f94489830bd85be50582550714ef`  
		Last Modified: Sat, 02 Dec 2023 09:11:55 GMT  
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
