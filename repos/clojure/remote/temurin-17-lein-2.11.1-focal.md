...
```console
$ docker pull clojure@sha256:1fb9e12a10910b1f0d7af11c971a34be9624dba9eca0b1e2585233f2af895db8
```
...
```console
$ docker pull clojure@sha256:5b0cdc180b041bebf4768b0eedd01fc7e1b6e3546ba59e54cb958dd574849aa7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.0 MB (213009582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:877c07b1602fccc5cb0f2fe82ef8a0377e50b325a5035a2c39321e172f8888ba`
...
# Fri, 02 Feb 2024 07:44:42 GMT
CMD ["jshell"]
# Fri, 02 Feb 2024 17:22:56 GMT
ENV LEIN_VERSION=2.11.1
# Fri, 02 Feb 2024 17:22:56 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Fri, 02 Feb 2024 17:22:56 GMT
WORKDIR /tmp
# Fri, 02 Feb 2024 17:23:10 GMT
...
# Fri, 02 Feb 2024 17:23:11 GMT
ENV LEIN_ROOT=1
# Fri, 02 Feb 2024 17:23:13 GMT
...
-	Layers:
	...
	-	`sha256:055140fc60fd644c5db5a50dcdd7ab44b3b88e055fe860794d4708cc22d4e533`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaecdb9fad68099c66d2b5eff0ddcefda7129880503c9b8786ef82e621cd91af`  
		Last Modified: Fri, 02 Feb 2024 17:38:24 GMT  
		Size: 14.5 MB (14454512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b06c6b13da62d7c85f0fa92ac3c00f64827c5a8a8d8f7525f8f5c93695465745`  
		Last Modified: Fri, 02 Feb 2024 17:38:24 GMT  
		Size: 4.4 MB (4399145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af66d009f02a227fd41c556f64ea70ba2d5cc0caf5ddbd5eab0ff975137f0959`  
		Last Modified: Fri, 02 Feb 2024 17:38:23 GMT  
		Size: 409.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:7ef17b01505a5f306e37102de961d32c382c8409e87c5e95af51be636e12cb82
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.2 MB (211164294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1db525f041f2681abbf5ae63f578be2820d27f02c6554fbbc5757707ba35394`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["repl"]`
...
# Fri, 02 Feb 2024 02:11:50 GMT
CMD ["jshell"]
# Fri, 02 Feb 2024 08:31:28 GMT
ENV LEIN_VERSION=2.11.1
# Fri, 02 Feb 2024 08:31:28 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Fri, 02 Feb 2024 08:31:28 GMT
WORKDIR /tmp
# Fri, 02 Feb 2024 08:31:40 GMT
RUN set -eux; apt-get update && apt-get install -y make gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://codeberg.org/leiningen/leiningen/raw/tag/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "03b3fbf7e6fac262f88f843a87b712a2b37f39cffc4f4f384436a30d8b01d6e4 *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 9D13D9426A0814B3373CF5E3D8A8243577A7859F && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Fri, 02 Feb 2024 08:31:40 GMT
ENV PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Fri, 02 Feb 2024 08:31:40 GMT
ENV LEIN_ROOT=1
# Fri, 02 Feb 2024 08:31:42 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.11.1"]])' > project.clj   && lein deps && rm project.clj
# Fri, 02 Feb 2024 08:31:42 GMT
COPY file:cf90f595e38d932dff3bdcd4221efe7c65fb3432787490053b55b6917f06e4cd in /usr/local/bin/entrypoint 
# Fri, 02 Feb 2024 08:31:42 GMT
...
-	Layers:
	...
	-	`sha256:47ca80af753b61d7d80de7bbfe06a31a6b4661fc10be78349d199a2457146952`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90132c3c6c4fa79968067181c49fbce901d9ac88e33f7451261bd2153de6b248`  
		Last Modified: Fri, 02 Feb 2024 08:45:49 GMT  
		Size: 14.5 MB (14453851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ccd9081e75967b73e807575b3151ea6100b2ff86c9792ad0180181ebc38bf6f`  
		Last Modified: Fri, 02 Feb 2024 08:45:48 GMT  
		Size: 4.4 MB (4399206 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24370e6297029f5b4a016be698abd9bb39baf9126b3ddceae47bcf8c2ad7b65b`  
		Last Modified: Fri, 02 Feb 2024 08:45:48 GMT  
		Size: 407.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
