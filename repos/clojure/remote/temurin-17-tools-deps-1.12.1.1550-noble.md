...
```console
$ docker pull clojure@sha256:5e7892ef11761f9f5736a57c214db95f2db6d41cdba8bb532784f00f951f21bc
```
...
### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - linux; amd64
...
### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - unknown; unknown
...
### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - linux; arm64 variant v8

```console
$ docker pull clojure@sha256:f735b8fccf09952ae9bf9c94dd5625119e1127eba21410132508d06815ec97dd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.5 MB (251466589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc19d4aa45d1f91f958ba0b7df01601b1128ffd9862674d64311fb8767a32ea0`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:995b2923ba412e1702f2d1d41eab3c776162d21f1a9e25289682f8d8d9673635`  
		Last Modified: Wed, 02 Jul 2025 12:39:40 GMT  
		Size: 54.9 MB (54930366 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:41f807d221c37088a1f2855a5c042ad6650326241ce868bec9363727aa45352a`  
		Last Modified: Wed, 02 Jul 2025 12:39:35 GMT  
		Size: 615.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:85a1f0748076fe693fe8d0768e2d7eab4d7957a1a373586f6391251b99bc6cb2`  
		Last Modified: Wed, 02 Jul 2025 12:39:35 GMT  
		Size: 399.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull clojure@sha256:0565adbf2ee1db32fb6aab4af50f180cba722bf6db962e26568b6d3475201321
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.1 MB (6058852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7e49b0e6617e603f1b12d40c3e05ea953d146aa82277249e246e3658865a708`

```dockerfile
```

-	Layers:
	-	`sha256:488c45ff02d2164a4cbad53643e785190ba72f7ab612715c3129557896553c01`  
		Last Modified: Wed, 02 Jul 2025 15:38:41 GMT  
		Size: 6.0 MB (6042465 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:56437b55240a5439300d134a852790d2dbeb4baa5b01099b733e7c7a37e73a8f`  
		Last Modified: Wed, 02 Jul 2025 15:38:42 GMT  
		Size: 16.4 KB (16387 bytes)  
		MIME: application/vnd.in-toto+json

### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - linux; ppc64le

```console
$ docker pull clojure@sha256:371647abf54487d3b63ffe7d34e089a0e75c0d7934402b91c7b1586e869934bd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.3 MB (262317244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce45edcf6e63cc480a3eabdc52217d6c92b5a6b1d7ce31982ca18692617e3f0d`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:341af1a1847f30bf342718bedcc7409375d0ea8e88c8504b6e9b0e25fc0ad4a7`  
		Last Modified: Wed, 02 Jul 2025 10:40:12 GMT  
		Size: 59.6 MB (59599646 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b70a60979ffba9df43a99a7f4ac5d8ceecc259f9fbd2fab9011bab427b3bcb3c`  
		Last Modified: Wed, 02 Jul 2025 10:40:02 GMT  
		Size: 616.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:020c047d50d8e5b311dc94ee85537cc83d3368b3a3b83a0d24493730f47be8c9`  
		Last Modified: Wed, 02 Jul 2025 10:40:02 GMT  
		Size: 399.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull clojure@sha256:ab27eeb7a3beddac684c8a5ca0156e44fbe8a8045ed736894d07b61ea6f5c3b6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.0 MB (5972018 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01eace7888cd34e3fe20d23699a3129d9cb01036fb60fab99d14c1f1d24fbdb3`

```dockerfile
```

-	Layers:
	-	`sha256:3cf1c6289cf5878a268df690c598f1520c71d18a044a749cb1166bce3d42924b`  
		Last Modified: Wed, 02 Jul 2025 12:38:07 GMT  
		Size: 6.0 MB (5955697 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:67604703bc625ec5aa8f1e0fa6231c6ff8aef1715ca839984392faca4d28a07b`  
		Last Modified: Wed, 02 Jul 2025 12:38:08 GMT  
		Size: 16.3 KB (16321 bytes)  
		MIME: application/vnd.in-toto+json

### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - linux; riscv64
...
### `clojure:temurin-17-tools-deps-1.12.1.1550-noble` - linux; s390x
