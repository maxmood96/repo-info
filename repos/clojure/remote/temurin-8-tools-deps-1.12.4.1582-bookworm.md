...
### `clojure:temurin-8-tools-deps-1.12.4.1582-bookworm` - linux; amd64
...
### `clojure:temurin-8-tools-deps-1.12.4.1582-bookworm` - unknown; unknown
...
### `clojure:temurin-8-tools-deps-1.12.4.1582-bookworm` - linux; arm64 variant v8
...
### `clojure:temurin-8-tools-deps-1.12.4.1582-bookworm` - linux; ppc64le
