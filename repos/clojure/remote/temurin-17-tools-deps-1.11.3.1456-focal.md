...
```console
$ docker pull clojure@sha256:342b757cba54a95be2b41fd7be857ade2d0c640b66892dea6b965d36801e2838
```
...
### `clojure:temurin-17-tools-deps-1.11.3.1456-focal` - unknown; unknown
...
```console
$ docker pull clojure@sha256:0b4a23afb507d8de0a137e2ec254348a2e07c808def4424de453866cd163427e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.8 MB (252780159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b162a45bcbec3ea798ce41b6763e064deef47daa549a7bea3c83d5c5ed34b806`
-	Entrypoint: `["entrypoint"]`
-	Default Command: `["-M","--repl"]`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:778ba8dc431698c7dc7aedd19ca199d107710ca9001e2020779f72e38ae40a8d`  
		Last Modified: Tue, 23 Jul 2024 12:40:36 GMT  
		Size: 60.2 MB (60229658 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c20913c05ee7ce0f0c4d4706baa6cb651fd93743dc1f32116e7e9acffa1113e8`  
		Last Modified: Tue, 23 Jul 2024 12:40:34 GMT  
		Size: 625.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1de89e690479338d9b040a93b8ebd504de48c70a699068cc1a2c0f600eb95b13`  
		Last Modified: Tue, 23 Jul 2024 12:40:34 GMT  
		Size: 405.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull clojure@sha256:2d176e07da1685acc5b4cc34ab97d4317b2c2e8a37c9ca4862a8f4c451fff91e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.0 MB (6004599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf89bf64dfb7f91a0fb0a87bc56e12f9594088d963527f0c8c90f9ceaa176d3f`

```dockerfile
```

-	Layers:
	-	`sha256:cb41c07f8c225eeeec6a8a2250fc32fad848d968304e469ece601306f0298763`  
		Last Modified: Tue, 23 Jul 2024 12:40:35 GMT  
		Size: 6.0 MB (5988763 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d7da0ce2904538f7efa08fdb3b6c40be65e2dcbaa5c7ccb278798194ff5c7b03`  
		Last Modified: Tue, 23 Jul 2024 12:40:34 GMT  
