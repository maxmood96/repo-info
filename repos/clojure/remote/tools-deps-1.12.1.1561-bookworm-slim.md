...
### `clojure:tools-deps-1.12.1.1561-bookworm-slim` - linux; amd64
...
### `clojure:tools-deps-1.12.1.1561-bookworm-slim` - unknown; unknown
...
### `clojure:tools-deps-1.12.1.1561-bookworm-slim` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.1.1561-bookworm-slim` - linux; ppc64le
...
### `clojure:tools-deps-1.12.1.1561-bookworm-slim` - linux; s390x
