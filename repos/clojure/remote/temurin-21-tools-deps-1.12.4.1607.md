...
### `clojure:temurin-21-tools-deps-1.12.4.1607` - linux; amd64
...
### `clojure:temurin-21-tools-deps-1.12.4.1607` - unknown; unknown
...
### `clojure:temurin-21-tools-deps-1.12.4.1607` - linux; arm64 variant v8
...
### `clojure:temurin-21-tools-deps-1.12.4.1607` - linux; ppc64le
...
### `clojure:temurin-21-tools-deps-1.12.4.1607` - linux; s390x
