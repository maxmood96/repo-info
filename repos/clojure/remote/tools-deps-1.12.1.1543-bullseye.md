...
```console
$ docker pull clojure@sha256:4d97d7de8a8600fa19cd74a5c18f92229db18195b653ca76f46dbb9b125bfd5a
```
...
### `clojure:tools-deps-1.12.1.1543-bullseye` - linux; amd64
...
### `clojure:tools-deps-1.12.1.1543-bullseye` - unknown; unknown
