...
### `clojure:tools-deps-1.12.5.1638-trixie-slim` - linux; amd64
...
### `clojure:tools-deps-1.12.5.1638-trixie-slim` - unknown; unknown
...
### `clojure:tools-deps-1.12.5.1638-trixie-slim` - linux; arm64 variant v8
...
### `clojure:tools-deps-1.12.5.1638-trixie-slim` - linux; ppc64le
...
### `clojure:tools-deps-1.12.5.1638-trixie-slim` - linux; s390x
