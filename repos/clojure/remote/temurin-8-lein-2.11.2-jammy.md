...
```console
$ docker pull clojure@sha256:b21c052346af1e58b50270a82dcf245b00dfd9eb0b0e7f3b5467e752e045a9e7
```
...
```console
$ docker pull clojure@sha256:c508e304caca53969c5c802d2992a67d5e03c3d31d3b6c8f6e098b936460dbe8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165815273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e871e710c8f6f27396f447364eef1df7354e5ec9d3fd674237727d774550f13e`
...
# Fri, 02 Feb 2024 07:42:43 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Thu, 15 Feb 2024 02:55:39 GMT
ENV LEIN_VERSION=2.11.2
# Thu, 15 Feb 2024 02:55:39 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 15 Feb 2024 02:55:39 GMT
WORKDIR /tmp
# Thu, 15 Feb 2024 02:56:01 GMT
...
-	Layers:
	...
	-	`sha256:c77c5b1038cba6c10d34b66fbe72283aae2bc733387e95b98ea685ba9643ab1c`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b33bef34c134656647dbf28683330474641578e7475807f506c516591c2c60e`  
		Last Modified: Thu, 15 Feb 2024 03:08:02 GMT  
		Size: 14.5 MB (14459701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:043e50b5e147f2b7aebea0e782dd977e4d91c4f98a98e0ba3908e265e7d189ab`  
		Last Modified: Thu, 15 Feb 2024 03:08:02 GMT  
...
```console
$ docker pull clojure@sha256:8ee1739b30d0faca5257a57c2d3418ee87e7ebea1e6d0a55f3129a88f5c2d213
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.8 MB (162815134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b2ba0a87ac07dd444790ef9254fb19d301adde08e5efe30835d9d19e5a9a1be`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["lein","repl"]`
...
# Fri, 02 Feb 2024 02:10:18 GMT
ENTRYPOINT ["/__cacert_entrypoint.sh"]
# Thu, 15 Feb 2024 01:43:49 GMT
ENV LEIN_VERSION=2.11.2
# Thu, 15 Feb 2024 01:43:49 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 15 Feb 2024 01:43:49 GMT
WORKDIR /tmp
# Thu, 15 Feb 2024 01:44:14 GMT
RUN set -eux; apt-get update && apt-get install -y make gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://codeberg.org/leiningen/leiningen/raw/tag/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha256sum lein-pkg && echo "28a1a62668c5f427b413a8677e376affaa995f023b1fcd06e2d4c98ac1df5f3e *lein-pkg" | sha256sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && export GNUPGHOME="$(mktemp -d)" && export FILENAME_EXT=jar && gpg --batch --keyserver hkps://keyserver.ubuntu.com --recv-keys 9D13D9426A0814B3373CF5E3D8A8243577A7859F && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && wget -q https://codeberg.org/leiningen/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && echo "Verifying file PGP signature..." && gpg --batch --verify leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT && gpgconf --kill all && rm -rf "$GNUPGHOME" leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.$FILENAME_EXT /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get purge -y --auto-remove gnupg wget
# Thu, 15 Feb 2024 01:44:14 GMT
ENV PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 15 Feb 2024 01:44:14 GMT
ENV LEIN_ROOT=1
# Thu, 15 Feb 2024 01:44:17 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.11.1"]])' > project.clj   && lein deps && rm project.clj
# Thu, 15 Feb 2024 01:44:17 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:ce0b92b348457895515e6390ad70809750c9a696861ac0f5fc499392d661e3ae`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83b9ddd18df72d164db4c114cc3536ee387f50f98fbcf6bbb3b2b3bac28dbacd`  
		Last Modified: Thu, 15 Feb 2024 01:53:18 GMT  
		Size: 14.5 MB (14459956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63e2073a920c7c3e7cd1c262b45d076dcf3e445f922e495765f9013cd191bcd2`  
		Last Modified: Thu, 15 Feb 2024 01:53:17 GMT  
