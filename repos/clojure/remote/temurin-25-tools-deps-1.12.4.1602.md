...
### `clojure:temurin-25-tools-deps-1.12.4.1602` - linux; amd64
...
### `clojure:temurin-25-tools-deps-1.12.4.1602` - unknown; unknown
...
### `clojure:temurin-25-tools-deps-1.12.4.1602` - linux; arm64 variant v8
...
### `clojure:temurin-25-tools-deps-1.12.4.1602` - linux; ppc64le
...
### `clojure:temurin-25-tools-deps-1.12.4.1602` - linux; s390x
