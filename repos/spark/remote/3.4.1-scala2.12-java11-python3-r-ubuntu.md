...
```console
$ docker pull spark@sha256:79b77f102b33c4db7bc90c7a7b724c3b2c4f6883aa471373cff8602575059f06
```
...
```console
$ docker pull spark@sha256:aadc8422defd379f0693b30cc3b7b9f18abf529669e7e5a32d7cd9e72a9bbb92
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **666.1 MB (666081204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b36af5dd88bcf2238349e82d89400dfa4810669ec56bf9182d553664b1a9bc2`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
...
USER root
# Tue, 16 Apr 2024 06:05:25 GMT
RUN set -ex;     apt-get update;     apt-get install -y python3 python3-pip;     apt-get install -y r-base r-base-dev;     rm -rf /var/lib/apt/lists/*
# Tue, 16 Apr 2024 06:05:30 GMT
ENV R_HOME=/usr/lib/R
# Tue, 16 Apr 2024 06:05:30 GMT
USER spark
```
...
-	Layers:
	...
	-	`sha256:301eda2180652233ad54d971fa2d4b7756e8518d00f8b3a6215d6fc7862fc6ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22d1619d062c6d8ba90e4dfa907bc13c161083031391a0415e6600a609a0ad2f`  
		Last Modified: Tue, 16 Apr 2024 06:16:24 GMT  
		Size: 235.1 MB (235145546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
