...
```console
$ docker pull spark@sha256:d5ff2d0eea35276b9f4abdf060ffe2ba1944c29de8d184c93e45f2a7b5a06b19
```
...
```console
$ docker pull spark@sha256:3819711224cf52cd1dbc751f415b2a3d9e0d02c2782105464b0b10c1a0633a10
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **672.5 MB (672528826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da20b8f3dd6cb072870e5a3c33da3b6b8be69ad7ef1d850592150cc03f7f924f`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
...
USER root
# Thu, 28 Mar 2024 04:11:17 GMT
RUN set -ex;     apt-get update;     apt-get install -y python3 python3-pip;     apt-get install -y r-base r-base-dev;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Mar 2024 04:11:22 GMT
ENV R_HOME=/usr/lib/R
# Thu, 28 Mar 2024 04:11:22 GMT
USER spark
```
...
-	Layers:
	...
	-	`sha256:4793164fd6ca45f611b48fdbb1cfac8298af12bb145be67d7a16576b190cab2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d8f157912299f4632fe33cfe17d8f45d09b1b5b64f4f0c60fafbde518263719`  
		Last Modified: Thu, 28 Mar 2024 04:26:03 GMT  
		Size: 235.1 MB (235147951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
