...
```console
$ docker pull spark@sha256:35b89c2d8e9f7ddc958890fb09c2bd5a50565bcd6de4b56d89a7f2acd6f6039a
```
...
```console
$ docker pull spark@sha256:46fe5b8217cb46aa1760899320d415808fd1dbae84f11365894710aa73c98970
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **437.5 MB (437466559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:caa0b43293c5ac16b0d9d56600efbfcabd1da0d29865599de6b2181f95a7c008`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
