...
```console
$ docker pull spark@sha256:aff8443846fb224509d4d2393379585a9b39a935cfad257d2fa06b839d7e6b2e
```
...
```console
$ docker pull spark@sha256:5e573469a3ef6a72c848c2110fcf5e9dd4aac216b3d5e857b1a71186d3829cd5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **746.0 MB (746036868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a678e1c990fb209c3c62bfe08b7e90ea5d4c04868517722c737e4fa6e542177`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
...
USER root
# Thu, 28 Mar 2024 04:18:48 GMT
RUN set -ex;     apt-get update;     apt-get install -y r-base r-base-dev;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Mar 2024 04:18:54 GMT
ENV R_HOME=/usr/lib/R
# Thu, 28 Mar 2024 04:18:54 GMT
USER spark
```
...
-	Layers:
	...
	-	`sha256:c0e9685ca5c451f5cc3da39d936d503e8cdf8d050ee326f1d8501cf74d662dc8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:097bc3dc2eee53f4f7a8af64ea1f4451f69158c86c50f11e82769a11d034dfe3`  
		Last Modified: Thu, 28 Mar 2024 04:30:14 GMT  
		Size: 308.5 MB (308513781 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
