...
### `spark:4.1.1-scala2.13-java21-python3-ubuntu` - linux; amd64
...
### `spark:4.1.1-scala2.13-java21-python3-ubuntu` - unknown; unknown
...
### `spark:4.1.1-scala2.13-java21-python3-ubuntu` - linux; arm64 variant v8
