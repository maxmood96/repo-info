...
```console
$ docker pull spark@sha256:22a8087956db711dd5c9a280fa0839bf0851a0496ce906bd1b5d903d15f8c34e
```
...
```console
$ docker pull spark@sha256:887e57943cc711330e5c9c6ab2c3b4e511a14c15b33c8b0f44fa76bb458f1eae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **760.6 MB (760583869 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3ec4aed91e7a409808a65a00f2fcb23c34750adb8e0ec7685d8fc077ecb1be3`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
...
USER root
# Thu, 28 Mar 2024 04:06:19 GMT
RUN set -ex;     apt-get update;     apt-get install -y python3 python3-pip;     apt-get install -y r-base r-base-dev;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Mar 2024 04:06:26 GMT
ENV R_HOME=/usr/lib/R
# Thu, 28 Mar 2024 04:06:26 GMT
USER spark
```
...
-	Layers:
	...
	-	`sha256:c0e9685ca5c451f5cc3da39d936d503e8cdf8d050ee326f1d8501cf74d662dc8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ed0cb575048fc7148ef2bc2ba7726364ef8760a9bd1ddd6341529b9aff4b00e`  
		Last Modified: Thu, 28 Mar 2024 04:25:07 GMT  
		Size: 323.1 MB (323060782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
