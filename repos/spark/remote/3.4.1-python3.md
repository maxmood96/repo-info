...
```console
$ docker pull spark@sha256:7409e1ff5f0483dd7206cbc2860e8d45080042d3c129d1e1435dc39852dfd25b
```
...
```console
$ docker pull spark@sha256:309008986cc5b32329d572493d63ba3d31d827e6abfb9e21c2ad56dc8fe302b3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **518.0 MB (518038411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:078e1995be250ef69533a83201f93c7c61b7a739f8a6c242fd5d9bfb0a95f145`
-	Entrypoint: `["\/opt\/entrypoint.sh"]`
...
# Mon, 14 Aug 2023 21:11:27 GMT
ENTRYPOINT ["/opt/entrypoint.sh"]
# Mon, 14 Aug 2023 21:11:42 GMT
USER root
# Mon, 14 Aug 2023 21:15:05 GMT
RUN set -ex;     apt-get update;     apt-get install -y python3 python3-pip;     rm -rf /var/lib/apt/lists/*
# Mon, 14 Aug 2023 21:15:07 GMT
USER spark
```
...
-	Layers:
	...
	-	`sha256:7edba5bc3590cbd76d589aed888196397e298e35906ef91bdaf11ac3d237ce6b`  
		...
		Size: 2.1 KB (2084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6adf58b8ebbd97c0d2a3e25176298ea1771a06b2509fc23f1906d072d4aaaa4`  
		Last Modified: Mon, 14 Aug 2023 21:17:09 GMT  
		Size: 87.5 MB (87531057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
