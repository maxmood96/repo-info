...
### `spark:4.1.2-java21-python3` - linux; amd64
...
### `spark:4.1.2-java21-python3` - unknown; unknown
...
### `spark:4.1.2-java21-python3` - linux; arm64 variant v8
