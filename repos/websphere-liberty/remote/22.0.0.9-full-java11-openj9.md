...
```console
$ docker pull websphere-liberty@sha256:2423a6484033ab66fc2353956581d0b23482be55c55e3e3d82c1aa89a77b266b
```
...
```console
$ docker pull websphere-liberty@sha256:aeed8f015a7d3fdeb41d2b6f93833f5555d05f0349837bf50d94abd17e598dea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **409.8 MB (409814439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d278bc045015874d8649c0165c1795f56db52b1573b0b2873356a000d25975b`
...
# Wed, 01 Feb 2023 01:05:24 GMT
ARG VERBOSE=false
# Wed, 01 Feb 2023 01:05:24 GMT
ARG REPOSITORIES_PROPERTIES=
# Wed, 01 Feb 2023 01:13:13 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN if [ ! -z $REPOSITORIES_PROPERTIES ]; then mkdir /opt/ibm/wlp/etc/   && echo $REPOSITORIES_PROPERTIES > /opt/ibm/wlp/etc/repositories.properties; fi   && installUtility install --acceptLicense baseBundle   && if [ ! -z $REPOSITORIES_PROPERTIES ]; then rm /opt/ibm/wlp/etc/repositories.properties; fi   && rm -rf /output/workarea /output/logs   && find /opt/ibm/wlp ! -perm -g=rw -print0 | xargs -r -0 chmod g+rw
# Wed, 01 Feb 2023 01:13:14 GMT
COPY --chown=1001:0file:f212cc38605f508baa0f75a07632700533ad28792dd9761a792209e709b00f23 in /config/ 
# Wed, 01 Feb 2023 01:13:42 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
...
-	Layers:
	...
	-	`sha256:e72daa200a5a1cc15500982ef147aa9996433fa84ee12ddc405fec5b9d593150`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a05a2ff6bfc208b9aadadb3facb5cfeb6ddaf6f19b55ff63a20471eb35040d2`  
		Last Modified: Wed, 01 Feb 2023 01:25:19 GMT  
		Size: 281.6 MB (281622763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4446808c0b4d0de0f41aba1eddcc0389faf585ddfd2a04a3604361aa140481f`  
		Last Modified: Wed, 01 Feb 2023 01:25:05 GMT  
		Size: 944.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfe0fdd822fb34f92c58d22d83a8ec72e0015d485af206c915faf428e71415b9`  
		Last Modified: Wed, 01 Feb 2023 01:25:07 GMT  
		Size: 14.3 MB (14328675 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull websphere-liberty@sha256:c178926c6f9fc13d5333e4d3e0b7682cf360f2caa3ac882f7c6dafa4f5c79b97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **407.6 MB (407591716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acc393f9e87330423dc3737eea496f640353a1a1ec3a8c5d5f4c92cc7b62f147`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
...
# Wed, 01 Feb 2023 20:29:03 GMT
CMD ["/opt/ibm/wlp/bin/server" "run" "defaultServer"]
# Wed, 01 Feb 2023 20:29:41 GMT
ARG VERBOSE=false
# Wed, 01 Feb 2023 20:29:41 GMT
ARG REPOSITORIES_PROPERTIES=
# Wed, 01 Feb 2023 20:36:55 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN if [ ! -z $REPOSITORIES_PROPERTIES ]; then mkdir /opt/ibm/wlp/etc/   && echo $REPOSITORIES_PROPERTIES > /opt/ibm/wlp/etc/repositories.properties; fi   && installUtility install --acceptLicense baseBundle   && if [ ! -z $REPOSITORIES_PROPERTIES ]; then rm /opt/ibm/wlp/etc/repositories.properties; fi   && rm -rf /output/workarea /output/logs   && find /opt/ibm/wlp ! -perm -g=rw -print0 | xargs -r -0 chmod g+rw
# Wed, 01 Feb 2023 20:37:06 GMT
COPY --chown=1001:0file:f212cc38605f508baa0f75a07632700533ad28792dd9761a792209e709b00f23 in /config/ 
# Wed, 01 Feb 2023 20:37:31 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN if [ "$OPENJ9_SCC" = "true" ]; then populate_scc.sh; fi     && rm -rf /output/messaging /output/resources/security /logs/* $WLP_OUTPUT_DIR/.classCache     && find /opt/ibm/wlp/output ! -perm -g=rwx -print0 | xargs -0 -r chmod g+rwx
```
...
-	Layers:
	...
	-	`sha256:14a0e71047cf66d96f86fb7a45ced76ea62fe2dce0b5bc600d6e46ac556519aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e65b17c9b55eae535e24ad27fb6c441e060ea4ba70fa7877716011e84c9e0ba`  
		Last Modified: Wed, 01 Feb 2023 20:47:31 GMT  
		Size: 281.6 MB (281621463 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c49fe2dbd9022f778bf62e609a751d59cacdea5a86668b656dd9ff63cde7f65`  
		Last Modified: Wed, 01 Feb 2023 20:47:19 GMT  
		Size: 942.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5b5aec98d9d933555cc17771cfa9e94dccdc7772817a49674cb563f32d93f5a`  
		Last Modified: Wed, 01 Feb 2023 20:47:21 GMT  
		Size: 14.4 MB (14377862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
