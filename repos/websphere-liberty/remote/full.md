...
```console
$ docker pull websphere-liberty@sha256:2bd385ae2e0af6a0ef7386be1b9e7bb6450a88fd9741ecfe35f9921fb9fd6aaa
```
...
```console
$ docker pull websphere-liberty@sha256:67ae94cdcf77173a299cbc05bcdd66817ab1d5102b85df1ef2848126406c0953
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **555.7 MB (555706510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2082b989bfd4ccb799827badeb6d5d738f019c9a85ac124a5b3dc54dd3da1529`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
...
# Wed, 13 Dec 2023 18:35:36 GMT
CMD ["/opt/ibm/wlp/bin/server" "run" "defaultServer"]
# Wed, 13 Dec 2023 18:37:02 GMT
ARG VERBOSE=false
# Wed, 13 Dec 2023 18:37:03 GMT
ARG REPOSITORIES_PROPERTIES=
# Wed, 13 Dec 2023 18:46:53 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN set -eux;   if [ ! -z "$REPOSITORIES_PROPERTIES" ]; then     mkdir /opt/ibm/wlp/etc/;     echo "$REPOSITORIES_PROPERTIES" > /opt/ibm/wlp/etc/repositories.properties;   fi;   installUtility install --acceptLicense baseBundle;   if [ ! -z "$REPOSITORIES_PROPERTIES" ]; then     rm /opt/ibm/wlp/etc/repositories.properties;   fi;   rm -rf /output/workarea /output/logs;   find /opt/ibm/wlp ! -perm -g=rw -print0 | xargs -r -0 chmod g+rw;
# Wed, 13 Dec 2023 18:46:59 GMT
COPY --chown=1001:0file:f212cc38605f508baa0f75a07632700533ad28792dd9761a792209e709b00f23 in /config/ 
# Wed, 13 Dec 2023 18:47:41 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN if [ "$OPENJ9_SCC" = "true" ]; then populate_scc.sh; fi     && rm -rf /output/messaging /output/resources/security /logs/* $WLP_OUTPUT_DIR/.classCache     && find /opt/ibm/wlp/output ! -path "*.classCache*" ! -perm -g=rwx -print0 | xargs -0 -r chmod g+rwx
```
...
-	Layers:
	...
	-	`sha256:65fa8e8651bd005f0a271e373a4e5a71bbb6510f6a700f43ebe4f4bf4ba3410f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80e402484353262c02fd720e0213fa22a1178139b57b815812bc5c4ebfb8b219`  
		Last Modified: Wed, 13 Dec 2023 19:12:59 GMT  
		Size: 348.5 MB (348542958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fe15dbab9fb1d2a2dbd66230dd85d57b3e4a782641d4c5cf2099c2a493e00d5`  
		Last Modified: Wed, 13 Dec 2023 19:12:41 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:213e6466ea309d795d33d4e42f7f1df4929a933078ff780adf130f1b02a80cdb`  
		Last Modified: Wed, 13 Dec 2023 19:12:43 GMT  
		Size: 13.1 MB (13144151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `websphere-liberty:full` - linux; s390x

```console
$ docker pull websphere-liberty@sha256:57fb8bfaeacfe400c93f2f09d55de5752a67458ee7c39c52dcdcab95e1afcbab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **548.1 MB (548121193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a33f6ab4fb9044529681854819a2bd85d1240697c3af71102aec38bbe4561364`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
...
# Wed, 13 Dec 2023 18:56:53 GMT
CMD ["/opt/ibm/wlp/bin/server" "run" "defaultServer"]
# Wed, 13 Dec 2023 18:57:48 GMT
ARG VERBOSE=false
# Wed, 13 Dec 2023 18:57:48 GMT
ARG REPOSITORIES_PROPERTIES=
# Wed, 13 Dec 2023 19:05:43 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN set -eux;   if [ ! -z "$REPOSITORIES_PROPERTIES" ]; then     mkdir /opt/ibm/wlp/etc/;     echo "$REPOSITORIES_PROPERTIES" > /opt/ibm/wlp/etc/repositories.properties;   fi;   installUtility install --acceptLicense baseBundle;   if [ ! -z "$REPOSITORIES_PROPERTIES" ]; then     rm /opt/ibm/wlp/etc/repositories.properties;   fi;   rm -rf /output/workarea /output/logs;   find /opt/ibm/wlp ! -perm -g=rw -print0 | xargs -r -0 chmod g+rw;
# Wed, 13 Dec 2023 19:05:51 GMT
COPY --chown=1001:0file:f212cc38605f508baa0f75a07632700533ad28792dd9761a792209e709b00f23 in /config/ 
# Wed, 13 Dec 2023 19:06:19 GMT
# ARGS: REPOSITORIES_PROPERTIES= VERBOSE=false
RUN if [ "$OPENJ9_SCC" = "true" ]; then populate_scc.sh; fi     && rm -rf /output/messaging /output/resources/security /logs/* $WLP_OUTPUT_DIR/.classCache     && find /opt/ibm/wlp/output ! -path "*.classCache*" ! -perm -g=rwx -print0 | xargs -0 -r chmod g+rwx
```
...
-	Layers:
	...
	-	`sha256:d38265653f0afbe3d85564d5638bb8e20ebfdde10f96cbb4cbb482c80dcdc4fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d12b11aabb58fab85d6a81f4936a371c962549a339aa9a319e896e768c1f49b`  
		Last Modified: Wed, 13 Dec 2023 19:26:40 GMT  
		Size: 348.5 MB (348542635 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c6b41b55f018176cd5def872d708218ed77dd39d96b16ce18ea3590965c299e`  
		Last Modified: Wed, 13 Dec 2023 19:26:25 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a51f39c5334556f78b3c70fd817839ba816ee70b20c46f2294226b9d08526b3`  
		Last Modified: Wed, 13 Dec 2023 19:26:27 GMT  
		Size: 15.6 MB (15554035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
