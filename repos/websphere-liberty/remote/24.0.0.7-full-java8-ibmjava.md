...
```console
$ docker pull websphere-liberty@sha256:d99d033aa74e0a4390f3ee69691c7669b44e0ab078760c59cf34ae226e5aff22
```
...
### `websphere-liberty:24.0.0.7-full-java8-ibmjava` - linux; ppc64le

```console
$ docker pull websphere-liberty@sha256:3d0803f36de3f1e742f87495938d1991722d6d679d5901fd7d6dda746c607ff5
```
...
```console
$ docker pull websphere-liberty@sha256:7950ea0287422f138fe5f75a9bfe9a9a150ec48db9ce058ab7b8a6248419c15c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4094006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd603a401ed01960234593a6c405cd3b7cade9c4f32a848212c8b112a31179b4`

```dockerfile
```

-	Layers:
	-	`sha256:725596145c37002daff94897b23c603f357ad68df7814a25bb0e75705e725f81`  
		Last Modified: Thu, 18 Jul 2024 23:19:03 GMT  
		Size: 4.1 MB (4075531 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8705bd9afdd4f1a65f0ab5067db710fd299924cf743952a6e01338a9f31e4665`  
		Last Modified: Thu, 18 Jul 2024 23:19:02 GMT  
