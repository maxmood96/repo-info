...
```console
$ docker pull websphere-liberty@sha256:ea13f13b3912f58f6aa34803611a019c0350fa165d11d626cc330ac0ad375e9c
```
...
### `websphere-liberty:23.0.0.4-kernel-java8-ibmjava` - linux; ppc64le
