...
```console
$ docker pull websphere-liberty@sha256:5da94076aef938f008f8642f3184245bbcc81736ef23f13ea808c9f11508f65a
```
...
### `websphere-liberty:23.0.0.4-full-java17-openj9` - linux; ppc64le
