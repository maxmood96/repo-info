...
### `websphere-liberty:24.0.0.10-kernel-java8-ibmjava` - linux; amd64
...
### `websphere-liberty:24.0.0.10-kernel-java8-ibmjava` - unknown; unknown
...
### `websphere-liberty:24.0.0.10-kernel-java8-ibmjava` - linux; ppc64le
...
### `websphere-liberty:24.0.0.10-kernel-java8-ibmjava` - linux; s390x
