...
```console
$ docker pull websphere-liberty@sha256:4e84e79af72b6ad8a2d1144563ffe6708a4e1831c4f3b5e6e4014be2d0dd7bda
```
...
### `websphere-liberty:23.0.0.8-kernel-java11-openj9` - linux; arm64 variant v8
