...
```console
alsa-lib-1.2.10-r0 description:
Advanced Linux Sound Architecture (ALSA) library

alsa-lib-1.2.10-r0 webpage:
https://alsa-project.org/

alsa-lib-1.2.10-r0 installed size:
1440 KiB

alsa-lib-1.2.10-r0 license:
LGPL-2.1-or-later
