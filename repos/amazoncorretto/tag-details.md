...
```console
$ docker pull amazoncorretto@sha256:f7e3bb114dbab3095c3a1aa435b315535172b3395d27359ed281cfe49ccaf739
```
...
### `amazoncorretto:17.0.1-alpine` - linux; amd64
...
### `amazoncorretto:17.0.1-alpine3.13` - linux; amd64
...
### `amazoncorretto:17.0.1-alpine3.14` - linux; amd64
...
### `amazoncorretto:17.0.1-alpine3.15` - linux; amd64
...
### `amazoncorretto:8u312-alpine3.15` - linux; amd64
...
### `amazoncorretto:8u312-alpine3.15-jre` - linux; amd64
