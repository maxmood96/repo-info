## `amazoncorretto:11-alpine3.24-full`
...
### `amazoncorretto:11-alpine3.24-full` - linux; amd64
...
### `amazoncorretto:11-alpine3.24-full` - unknown; unknown
...
### `amazoncorretto:11-alpine3.24-full` - linux; arm64 variant v8
