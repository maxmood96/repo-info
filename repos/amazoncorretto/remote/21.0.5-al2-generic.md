...
### `amazoncorretto:21.0.5-al2-generic` - linux; amd64
...
### `amazoncorretto:21.0.5-al2-generic` - unknown; unknown
...
### `amazoncorretto:21.0.5-al2-generic` - linux; arm64 variant v8
