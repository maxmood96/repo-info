...
### `amazoncorretto:21.0.8-al2` - linux; amd64
...
### `amazoncorretto:21.0.8-al2` - unknown; unknown
...
### `amazoncorretto:21.0.8-al2` - linux; arm64 variant v8
