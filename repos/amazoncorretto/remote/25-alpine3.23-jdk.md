## `amazoncorretto:25-alpine3.23-jdk`
...
### `amazoncorretto:25-alpine3.23-jdk` - linux; amd64
...
### `amazoncorretto:25-alpine3.23-jdk` - unknown; unknown
...
### `amazoncorretto:25-alpine3.23-jdk` - linux; arm64 variant v8
