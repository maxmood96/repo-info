## `amazoncorretto:11.0.28-al2-generic`
...
### `amazoncorretto:11.0.28-al2-generic` - linux; amd64
...
### `amazoncorretto:11.0.28-al2-generic` - unknown; unknown
...
### `amazoncorretto:11.0.28-al2-generic` - linux; arm64 variant v8
