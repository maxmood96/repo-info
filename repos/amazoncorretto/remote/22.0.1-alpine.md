...
### `amazoncorretto:22.0.1-alpine` - linux; amd64
...
### `amazoncorretto:22.0.1-alpine` - unknown; unknown
...
### `amazoncorretto:22.0.1-alpine` - linux; arm64 variant v8
