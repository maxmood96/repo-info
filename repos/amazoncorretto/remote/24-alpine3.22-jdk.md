## `amazoncorretto:24-alpine3.22-jdk`
...
### `amazoncorretto:24-alpine3.22-jdk` - linux; amd64
...
### `amazoncorretto:24-alpine3.22-jdk` - unknown; unknown
...
### `amazoncorretto:24-alpine3.22-jdk` - linux; arm64 variant v8
