...
### `amazoncorretto:25.0.3-alpine` - linux; amd64
...
### `amazoncorretto:25.0.3-alpine` - unknown; unknown
...
### `amazoncorretto:25.0.3-alpine` - linux; arm64 variant v8
