...
### `amazoncorretto:17.0.19-alpine3.21` - linux; amd64
...
### `amazoncorretto:17.0.19-alpine3.21` - unknown; unknown
...
### `amazoncorretto:17.0.19-alpine3.21` - linux; arm64 variant v8
