...
### `amazoncorretto:17.0.19-alpine3.24` - linux; amd64
...
### `amazoncorretto:17.0.19-alpine3.24` - unknown; unknown
...
### `amazoncorretto:17.0.19-alpine3.24` - linux; arm64 variant v8
