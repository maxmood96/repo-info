...
### `amazoncorretto:25.0.0-alpine` - linux; amd64
...
### `amazoncorretto:25.0.0-alpine` - unknown; unknown
...
### `amazoncorretto:25.0.0-alpine` - linux; arm64 variant v8
