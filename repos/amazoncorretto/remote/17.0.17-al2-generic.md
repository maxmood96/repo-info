## `amazoncorretto:17.0.17-al2-generic`
...
### `amazoncorretto:17.0.17-al2-generic` - linux; amd64
...
### `amazoncorretto:17.0.17-al2-generic` - unknown; unknown
...
### `amazoncorretto:17.0.17-al2-generic` - linux; arm64 variant v8
