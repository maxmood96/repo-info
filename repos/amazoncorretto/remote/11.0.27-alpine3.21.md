...
### `amazoncorretto:11.0.27-alpine3.21` - linux; amd64
...
### `amazoncorretto:11.0.27-alpine3.21` - unknown; unknown
...
### `amazoncorretto:11.0.27-alpine3.21` - linux; arm64 variant v8
