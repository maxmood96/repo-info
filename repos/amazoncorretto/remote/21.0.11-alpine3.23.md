...
### `amazoncorretto:21.0.11-alpine3.23` - linux; amd64
...
### `amazoncorretto:21.0.11-alpine3.23` - unknown; unknown
...
### `amazoncorretto:21.0.11-alpine3.23` - linux; arm64 variant v8
