...
### `amazoncorretto:11.0.23-alpine3.16` - linux; amd64
...
### `amazoncorretto:11.0.23-alpine3.16` - unknown; unknown
...
### `amazoncorretto:11.0.23-alpine3.16` - linux; arm64 variant v8
