...
### `amazoncorretto:11.0.27-alpine3.18` - linux; amd64
...
### `amazoncorretto:11.0.27-alpine3.18` - unknown; unknown
...
### `amazoncorretto:11.0.27-alpine3.18` - linux; arm64 variant v8
