## `amazoncorretto:24-alpine3.22-full`
...
### `amazoncorretto:24-alpine3.22-full` - linux; amd64
...
### `amazoncorretto:24-alpine3.22-full` - unknown; unknown
...
### `amazoncorretto:24-alpine3.22-full` - linux; arm64 variant v8
