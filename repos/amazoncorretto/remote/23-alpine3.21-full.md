## `amazoncorretto:23-alpine3.21-full`
...
### `amazoncorretto:23-alpine3.21-full` - linux; amd64
...
### `amazoncorretto:23-alpine3.21-full` - unknown; unknown
...
### `amazoncorretto:23-alpine3.21-full` - linux; arm64 variant v8
