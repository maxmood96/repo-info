...
### `amazoncorretto:21.0.11-alpine3.24` - linux; amd64
...
### `amazoncorretto:21.0.11-alpine3.24` - unknown; unknown
...
### `amazoncorretto:21.0.11-alpine3.24` - linux; arm64 variant v8
