...
### `amazoncorretto:24.0.2-alpine` - linux; amd64
...
### `amazoncorretto:24.0.2-alpine` - unknown; unknown
...
### `amazoncorretto:24.0.2-alpine` - linux; arm64 variant v8
