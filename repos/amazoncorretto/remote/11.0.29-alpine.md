...
### `amazoncorretto:11.0.29-alpine` - linux; amd64
...
### `amazoncorretto:11.0.29-alpine` - unknown; unknown
...
### `amazoncorretto:11.0.29-alpine` - linux; arm64 variant v8
