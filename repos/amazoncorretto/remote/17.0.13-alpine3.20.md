...
### `amazoncorretto:17.0.13-alpine3.20` - linux; amd64
...
### `amazoncorretto:17.0.13-alpine3.20` - unknown; unknown
...
### `amazoncorretto:17.0.13-alpine3.20` - linux; arm64 variant v8
