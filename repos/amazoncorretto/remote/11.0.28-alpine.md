...
### `amazoncorretto:11.0.28-alpine` - linux; amd64
...
### `amazoncorretto:11.0.28-alpine` - unknown; unknown
...
### `amazoncorretto:11.0.28-alpine` - linux; arm64 variant v8
