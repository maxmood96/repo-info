...
### `amazoncorretto:26.0.1-alpine` - linux; amd64
...
### `amazoncorretto:26.0.1-alpine` - unknown; unknown
...
### `amazoncorretto:26.0.1-alpine` - linux; arm64 variant v8
