...
### `amazoncorretto:21.0.11-alpine3.20` - linux; amd64
...
### `amazoncorretto:21.0.11-alpine3.20` - unknown; unknown
...
### `amazoncorretto:21.0.11-alpine3.20` - linux; arm64 variant v8
