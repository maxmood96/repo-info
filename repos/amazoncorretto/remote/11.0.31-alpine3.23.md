...
### `amazoncorretto:11.0.31-alpine3.23` - linux; amd64
...
### `amazoncorretto:11.0.31-alpine3.23` - unknown; unknown
...
### `amazoncorretto:11.0.31-alpine3.23` - linux; arm64 variant v8
