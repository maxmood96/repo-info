...
### `amazoncorretto:25.0.1-alpine` - linux; amd64
...
### `amazoncorretto:25.0.1-alpine` - unknown; unknown
...
### `amazoncorretto:25.0.1-alpine` - linux; arm64 variant v8
