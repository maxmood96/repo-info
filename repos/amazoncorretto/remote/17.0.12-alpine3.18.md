...
### `amazoncorretto:17.0.12-alpine3.18` - linux; amd64
...
### `amazoncorretto:17.0.12-alpine3.18` - unknown; unknown
...
### `amazoncorretto:17.0.12-alpine3.18` - linux; arm64 variant v8
