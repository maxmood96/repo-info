## `amazoncorretto:26-alpine3.24-jdk`
...
### `amazoncorretto:26-alpine3.24-jdk` - linux; amd64
...
### `amazoncorretto:26-alpine3.24-jdk` - unknown; unknown
...
### `amazoncorretto:26-alpine3.24-jdk` - linux; arm64 variant v8
