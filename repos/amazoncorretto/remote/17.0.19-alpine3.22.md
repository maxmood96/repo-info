...
### `amazoncorretto:17.0.19-alpine3.22` - linux; amd64
...
### `amazoncorretto:17.0.19-alpine3.22` - unknown; unknown
...
### `amazoncorretto:17.0.19-alpine3.22` - linux; arm64 variant v8
