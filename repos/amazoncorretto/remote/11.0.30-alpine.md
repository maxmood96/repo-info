...
### `amazoncorretto:11.0.30-alpine` - linux; amd64
...
### `amazoncorretto:11.0.30-alpine` - unknown; unknown
...
### `amazoncorretto:11.0.30-alpine` - linux; arm64 variant v8
