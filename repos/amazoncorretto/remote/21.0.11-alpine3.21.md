...
### `amazoncorretto:21.0.11-alpine3.21` - linux; amd64
...
### `amazoncorretto:21.0.11-alpine3.21` - unknown; unknown
...
### `amazoncorretto:21.0.11-alpine3.21` - linux; arm64 variant v8
