## `amazoncorretto:17-alpine3.24-jdk`
...
### `amazoncorretto:17-alpine3.24-jdk` - linux; amd64
...
### `amazoncorretto:17-alpine3.24-jdk` - unknown; unknown
...
### `amazoncorretto:17-alpine3.24-jdk` - linux; arm64 variant v8
