...
### `amazoncorretto:17.0.12-alpine3.19` - linux; amd64
...
### `amazoncorretto:17.0.12-alpine3.19` - unknown; unknown
...
### `amazoncorretto:17.0.12-alpine3.19` - linux; arm64 variant v8
