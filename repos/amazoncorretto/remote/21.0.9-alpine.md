...
### `amazoncorretto:21.0.9-alpine` - linux; amd64
...
### `amazoncorretto:21.0.9-alpine` - unknown; unknown
...
### `amazoncorretto:21.0.9-alpine` - linux; arm64 variant v8
