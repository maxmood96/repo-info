...
### `amazoncorretto:22-alpine3.20-full` - linux; amd64
...
### `amazoncorretto:22-alpine3.20-full` - unknown; unknown
...
### `amazoncorretto:22-alpine3.20-full` - linux; arm64 variant v8
