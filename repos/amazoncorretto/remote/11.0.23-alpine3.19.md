...
### `amazoncorretto:11.0.23-alpine3.19` - linux; amd64
...
### `amazoncorretto:11.0.23-alpine3.19` - unknown; unknown
...
### `amazoncorretto:11.0.23-alpine3.19` - linux; arm64 variant v8
