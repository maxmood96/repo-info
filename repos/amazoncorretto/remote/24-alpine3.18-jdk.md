## `amazoncorretto:24-alpine3.18-jdk`
...
### `amazoncorretto:24-alpine3.18-jdk` - linux; amd64
...
### `amazoncorretto:24-alpine3.18-jdk` - unknown; unknown
...
### `amazoncorretto:24-alpine3.18-jdk` - linux; arm64 variant v8
