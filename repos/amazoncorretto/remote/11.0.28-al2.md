...
### `amazoncorretto:11.0.28-al2` - linux; amd64
...
### `amazoncorretto:11.0.28-al2` - unknown; unknown
...
### `amazoncorretto:11.0.28-al2` - linux; arm64 variant v8
