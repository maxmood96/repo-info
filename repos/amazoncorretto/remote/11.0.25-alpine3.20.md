...
### `amazoncorretto:11.0.25-alpine3.20` - linux; amd64
...
### `amazoncorretto:11.0.25-alpine3.20` - unknown; unknown
...
### `amazoncorretto:11.0.25-alpine3.20` - linux; arm64 variant v8
