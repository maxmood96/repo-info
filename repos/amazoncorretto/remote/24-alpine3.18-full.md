## `amazoncorretto:24-alpine3.18-full`
...
### `amazoncorretto:24-alpine3.18-full` - linux; amd64
...
### `amazoncorretto:24-alpine3.18-full` - unknown; unknown
...
### `amazoncorretto:24-alpine3.18-full` - linux; arm64 variant v8
