...
### `amazoncorretto:11.0.31-alpine3.24` - linux; amd64
...
### `amazoncorretto:11.0.31-alpine3.24` - unknown; unknown
...
### `amazoncorretto:11.0.31-alpine3.24` - linux; arm64 variant v8
