...
```console
$ docker pull amazoncorretto@sha256:cd12e7097010b708ee57b8adc53a1a33eb76857fc1568f26abdc8a5ed2898a28
```
...
### `amazoncorretto:22-alpine3.19` - linux; amd64
...
### `amazoncorretto:22-alpine3.19` - linux; arm64 variant v8
