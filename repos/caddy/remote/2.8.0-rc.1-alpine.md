...
### `caddy:2.8.0-rc.1-alpine` - linux; amd64
...
### `caddy:2.8.0-rc.1-alpine` - unknown; unknown
...
### `caddy:2.8.0-rc.1-alpine` - linux; arm variant v6
...
### `caddy:2.8.0-rc.1-alpine` - linux; arm variant v7
...
### `caddy:2.8.0-rc.1-alpine` - linux; arm64 variant v8
...
### `caddy:2.8.0-rc.1-alpine` - linux; ppc64le
...
### `caddy:2.8.0-rc.1-alpine` - linux; s390x
