...
```console
$ docker pull caddy@sha256:9aa1eca4d3f9e28df8cdf3d8c010abd2e4a30f6670ebf727eb0bc62261175fde
```
...
### `caddy:2.10.0-alpine` - linux; amd64
...
### `caddy:2.10.0-alpine` - unknown; unknown
...
### `caddy:2.10.0-alpine` - linux; arm variant v6
...
### `caddy:2.10.0-alpine` - linux; arm variant v7
...
### `caddy:2.10.0-alpine` - linux; arm64 variant v8
...
### `caddy:2.10.0-alpine` - linux; ppc64le
...
### `caddy:2.10.0-alpine` - linux; s390x
