...
```console
$ docker pull caddy@sha256:8822ed5bff4b9f6028b25796aeced1d2d7ac111ce2530ed005e9bb0e7e026648
```
...
```console
$ docker pull caddy@sha256:5b444a7c76693996aec9f858ef01ac9b91a689512914040a6e0f907640dfaba6
```
