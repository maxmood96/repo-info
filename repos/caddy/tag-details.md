...
```console
$ docker pull caddy@sha256:98fc88c521e3978f891916dc5afad36ee4373ee5065d341d8828f3a83d4f0fc3
```
...
```console
$ docker pull caddy@sha256:944ea3baf3c4795a0fcc5e5f519ede2663b5a4bc352646cd9717f7dcb92417a0
```
