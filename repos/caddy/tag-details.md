...
```console
$ docker pull caddy@sha256:0cedb91c72064092e6d2980e07918dffd64898f7a957417e7a42abcbd16e4f39
```
...
```console
$ docker pull caddy@sha256:fdf7889917e44cfe6c85d8cc438aa2b3bcae9a3274705a3399530e6ff573367e
```
