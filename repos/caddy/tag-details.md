...
```console
$ docker pull caddy@sha256:cb12b47abd949c1c43472714d89132b2a600c4435a46ff7bc4cb6b2171a472d5
```
...
```console
$ docker pull caddy@sha256:2e9ef4f41431b64a4cd17775687ed74272c130a21085492a80fe0ffc9395dac6
```
