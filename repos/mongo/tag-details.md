...
### `mongo:4.2.7-windowsservercore-1809` - windows version 10.0.17763.1282; amd64
...
```console
$ docker pull mongo@sha256:c88cc59301a04015c4bde177f4d2ccb2fc14e8109cdfdc34f8eba7fa2d75f63f
```
...
```console
$ docker pull mongo@sha256:825de7a56617caf3b442a41607a745a62008bc6fa87988dd560df55fc59441c6
```
