...
```console
$ docker pull mongo@sha256:01afdff6a910c45be4926ebdc29df5dc75a358832ebb878c00f1dcd01efd4c94
```
...
```console
$ docker pull mongo@sha256:69608eb37b8a875d08dea3e8530ea01de3c95faf25a138f7bc020521d8e3cc92
```
