...
- Created: `2026-06-10T20:12:08.524361226Z`
- Virtual Size: ~ 956.16 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.24`

Binary Packages:

- `mongodb-org=8.0.24`
- `mongodb-org-database=8.0.24`
- `mongodb-org-database-tools-extra=8.0.24`
- `mongodb-org-mongos=8.0.24`
- `mongodb-org-server=8.0.24`
- `mongodb-org-shell=8.0.24`
- `mongodb-org-tools=8.0.24`
