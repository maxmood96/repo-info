...
- Created: `2026-06-02T08:19:43.936470485Z`
- Virtual Size: ~ 949.23 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.23`

Binary Packages:

- `mongodb-org=8.0.23`
- `mongodb-org-database=8.0.23`
- `mongodb-org-database-tools-extra=8.0.23`
- `mongodb-org-mongos=8.0.23`
- `mongodb-org-server=8.0.23`
- `mongodb-org-shell=8.0.23`
