...
- Created: `2024-03-09T17:01:37Z`
- Virtual Size: ~ 756.71 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.7~rc2`

Binary Packages:

- `mongodb-org=7.0.7~rc2`
- `mongodb-org-database=7.0.7~rc2`
- `mongodb-org-database-tools-extra=7.0.7~rc2`
- `mongodb-org-mongos=7.0.7~rc2`
- `mongodb-org-server=7.0.7~rc2`
- `mongodb-org-shell=7.0.7~rc2`
- `mongodb-org-tools=7.0.7~rc2`
