...
- Created: `2026-02-21T00:08:52.146223134Z`
- Virtual Size: ~ 942.43 Mb  
...
### `dpkg` source package: `mongodb-org=8.2.6~rc0`

Binary Packages:

- `mongodb-org=8.2.6~rc0`
- `mongodb-org-database=8.2.6~rc0`
- `mongodb-org-database-tools-extra=8.2.6~rc0`
- `mongodb-org-mongos=8.2.6~rc0`
- `mongodb-org-server=8.2.6~rc0`
- `mongodb-org-shell=8.2.6~rc0`
- `mongodb-org-tools=8.2.6~rc0`
