...
- Created: `2025-10-28T19:05:48.809261595Z`
...
### `dpkg` source package: `mongodb-org=8.2.2~rc0`

Binary Packages:

- `mongodb-org=8.2.2~rc0`
- `mongodb-org-database=8.2.2~rc0`
- `mongodb-org-database-tools-extra=8.2.2~rc0`
- `mongodb-org-mongos=8.2.2~rc0`
- `mongodb-org-server=8.2.2~rc0`
- `mongodb-org-shell=8.2.2~rc0`
- `mongodb-org-tools=8.2.2~rc0`
