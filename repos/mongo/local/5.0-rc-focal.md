...
- Created: `2024-05-29T16:01:17Z`
- Virtual Size: ~ 738.08 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.27~rc0`

Binary Packages:

- `mongodb-org=5.0.27~rc0`
- `mongodb-org-mongos=5.0.27~rc0`
- `mongodb-org-server=5.0.27~rc0`
- `mongodb-org-shell=5.0.27~rc0`
- `mongodb-org-tools=5.0.27~rc0`
...
### `dpkg` source package: `mongodb-org=8.0.0~rc5`

Binary Packages:

- `mongodb-org-database=8.0.0~rc5`
- `mongodb-org-database-tools-extra=8.0.0~rc5`
