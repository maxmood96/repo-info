...
- Created: `2024-03-13T22:01:27Z`
- Virtual Size: ~ 697.83 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.26~rc0`

Binary Packages:

- `mongodb-org=5.0.26~rc0`
- `mongodb-org-mongos=5.0.26~rc0`
- `mongodb-org-server=5.0.26~rc0`
- `mongodb-org-shell=5.0.26~rc0`
- `mongodb-org-tools=5.0.26~rc0`
