...
- Created: `2024-08-21T04:01:18Z`
- Virtual Size: ~ 723.61 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.29~rc0`

Binary Packages:

- `mongodb-org=5.0.29~rc0`
- `mongodb-org-mongos=5.0.29~rc0`
- `mongodb-org-server=5.0.29~rc0`
- `mongodb-org-shell=5.0.29~rc0`
- `mongodb-org-tools=5.0.29~rc0`
...
### `dpkg` source package: `mongodb-org=8.0.0~rc18`

Binary Packages:

- `mongodb-org-database=8.0.0~rc18`
- `mongodb-org-database-tools-extra=8.0.0~rc18`
