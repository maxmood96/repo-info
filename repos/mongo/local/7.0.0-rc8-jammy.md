...
### `dpkg` source package: `mongodb-database-tools=100.7.3`

Binary Packages:

- `mongodb-database-tools=100.7.3`
...
### `dpkg` source package: `mongodb-mongosh=1.10.1`

Binary Packages:

- `mongodb-mongosh=1.10.1`
...
### `dpkg` source package: `mongodb-org=7.0.0~rc8`

Binary Packages:

- `mongodb-org=7.0.0~rc8`
- `mongodb-org-database=7.0.0~rc8`
- `mongodb-org-database-tools-extra=7.0.0~rc8`
- `mongodb-org-mongos=7.0.0~rc8`
- `mongodb-org-server=7.0.0~rc8`
- `mongodb-org-shell=7.0.0~rc8`
- `mongodb-org-tools=7.0.0~rc8`
