...
- Created: `2026-05-05T23:10:54.412236095Z`
- Virtual Size: ~ 838.94 Mb  
...
### `dpkg` source package: `mongodb-org=8.3.1`

Binary Packages:

- `mongodb-org=8.3.1`
- `mongodb-org-database=8.3.1`
- `mongodb-org-database-tools-extra=8.3.1`
- `mongodb-org-mongos=8.3.1`
- `mongodb-org-server=8.3.1`
- `mongodb-org-shell=8.3.1`
- `mongodb-org-tools=8.3.1`
