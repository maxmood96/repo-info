...
- Created: `2025-05-22T22:07:05Z`
- Virtual Size: ~ 817.78 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.21~rc0`

Binary Packages:

- `mongodb-org=7.0.21~rc0`
- `mongodb-org-database=7.0.21~rc0`
- `mongodb-org-database-tools-extra=7.0.21~rc0`
- `mongodb-org-mongos=7.0.21~rc0`
- `mongodb-org-server=7.0.21~rc0`
- `mongodb-org-shell=7.0.21~rc0`
- `mongodb-org-tools=7.0.21~rc0`
