...
- Created: `2020-07-06T22:04:28.83192344Z`
...
### `dpkg` source package: `mongodb-org=4.4.0~rc12`

Binary Packages:

- `mongodb-org=4.4.0~rc12`
- `mongodb-org-database-tools-extra=4.4.0~rc12`
- `mongodb-org-mongos=4.4.0~rc12`
- `mongodb-org-server=4.4.0~rc12`
- `mongodb-org-shell=4.4.0~rc12`
- `mongodb-org-tools=4.4.0~rc12`
