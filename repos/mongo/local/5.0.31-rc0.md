...
- Created: `2024-12-20T05:01:19Z`
- Virtual Size: ~ 722.38 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.31~rc0`

Binary Packages:

- `mongodb-org=5.0.31~rc0`
- `mongodb-org-mongos=5.0.31~rc0`
- `mongodb-org-server=5.0.31~rc0`
- `mongodb-org-shell=5.0.31~rc0`
- `mongodb-org-tools=5.0.31~rc0`
...
### `dpkg` source package: `mongodb-org=8.0.4~rc0`

Binary Packages:

- `mongodb-org-database=8.0.4~rc0`
- `mongodb-org-database-tools-extra=8.0.4~rc0`
