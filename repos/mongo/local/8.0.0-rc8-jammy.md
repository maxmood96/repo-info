...
### `dpkg` source package: `mongodb-database-tools=100.9.4-40-g323a0b0b`

Binary Packages:

- `mongodb-database-tools=100.9.4-40-g323a0b0b`
...
### `dpkg` source package: `mongodb-org=8.0.0~rc8`

Binary Packages:

- `mongodb-org=8.0.0~rc8`
- `mongodb-org-database=8.0.0~rc8`
- `mongodb-org-database-tools-extra=8.0.0~rc8`
- `mongodb-org-mongos=8.0.0~rc8`
- `mongodb-org-server=8.0.0~rc8`
- `mongodb-org-shell=8.0.0~rc8`
- `mongodb-org-tools=8.0.0~rc8`
