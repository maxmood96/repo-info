...
- Created: `2024-07-02T22:01:16Z`
- Virtual Size: ~ 737.53 Mb  
...
### `dpkg` source package: `mongodb-org=5.0.28~rc0`

Binary Packages:

- `mongodb-org=5.0.28~rc0`
- `mongodb-org-mongos=5.0.28~rc0`
- `mongodb-org-server=5.0.28~rc0`
- `mongodb-org-shell=5.0.28~rc0`
- `mongodb-org-tools=5.0.28~rc0`
...
### `dpkg` source package: `mongodb-org=8.0.0~rc10`

Binary Packages:

- `mongodb-org-database=8.0.0~rc10`
- `mongodb-org-database-tools-extra=8.0.0~rc10`
