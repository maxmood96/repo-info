...
- Created: `2022-04-30T01:27:31.408398383Z`
- Virtual Size: ~ 437.94 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.14~rc0`

Binary Packages:

- `mongodb-org=4.4.14~rc0`
- `mongodb-org-mongos=4.4.14~rc0`
- `mongodb-org-server=4.4.14~rc0`
- `mongodb-org-shell=4.4.14~rc0`
- `mongodb-org-tools=4.4.14~rc0`
...
### `dpkg` source package: `mongodb-org=6.0.0~rc3`

Binary Packages:

- `mongodb-org-database-tools-extra=6.0.0~rc3`
