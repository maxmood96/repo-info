...
- Created: `2024-05-23T10:01:46Z`
- Virtual Size: ~ 866.29 Mb  
...
- `mongodb-org=8.0.0~rc5`
- `mongodb-org-database=8.0.0~rc5`
- `mongodb-org-database-tools-extra=8.0.0~rc5`
- `mongodb-org-mongos=8.0.0~rc5`
- `mongodb-org-server=8.0.0~rc5`
- `mongodb-org-shell=8.0.0~rc5`
- `mongodb-org-tools=8.0.0~rc5`
