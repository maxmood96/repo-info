...
- Created: `2021-12-27T18:49:51.664741326Z`
- Virtual Size: ~ 437.44 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.11~rc1`

Binary Packages:

- `mongodb-org=4.4.11~rc1`
- `mongodb-org-mongos=4.4.11~rc1`
- `mongodb-org-server=4.4.11~rc1`
- `mongodb-org-shell=4.4.11~rc1`
- `mongodb-org-tools=4.4.11~rc1`
