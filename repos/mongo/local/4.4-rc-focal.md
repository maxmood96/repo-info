...
- Created: `2021-06-24T08:51:47.148711613Z`
...
### `dpkg` source package: `mongodb-org=4.4.7~rc0`

Binary Packages:

- `mongodb-org=4.4.7~rc0`
- `mongodb-org-mongos=4.4.7~rc0`
- `mongodb-org-server=4.4.7~rc0`
- `mongodb-org-shell=4.4.7~rc0`
- `mongodb-org-tools=4.4.7~rc0`
...
### `dpkg` source package: `mongodb-org=5.0.0~rc3`

Binary Packages:

- `mongodb-org-database-tools-extra=5.0.0~rc3`
