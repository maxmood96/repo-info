...
- Created: `2024-07-15T16:06:25Z`
- Virtual Size: ~ 866.91 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.0~rc13`

Binary Packages:

- `mongodb-org=8.0.0~rc13`
- `mongodb-org-database=8.0.0~rc13`
- `mongodb-org-database-tools-extra=8.0.0~rc13`
- `mongodb-org-mongos=8.0.0~rc13`
- `mongodb-org-server=8.0.0~rc13`
- `mongodb-org-shell=8.0.0~rc13`
- `mongodb-org-tools=8.0.0~rc13`
