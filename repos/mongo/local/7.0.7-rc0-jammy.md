...
- Created: `2024-02-29T23:36:29Z`
- Virtual Size: ~ 756.49 Mb  
...
### `dpkg` source package: `mongodb-mongosh=2.1.5`
...
### `dpkg` source package: `mongodb-org=7.0.7~rc0`

Binary Packages:

- `mongodb-org=7.0.7~rc0`
- `mongodb-org-database=7.0.7~rc0`
- `mongodb-org-database-tools-extra=7.0.7~rc0`
- `mongodb-org-mongos=7.0.7~rc0`
- `mongodb-org-server=7.0.7~rc0`
- `mongodb-org-shell=7.0.7~rc0`
- `mongodb-org-tools=7.0.7~rc0`
