...
### `dpkg` source package: `mongodb-mongosh=2.3.5`

Binary Packages:

- `mongodb-mongosh=2.3.5`
...
### `dpkg` source package: `mongodb-org=6.0.20~rc3`

Binary Packages:

- `mongodb-org=6.0.20~rc3`
- `mongodb-org-database=6.0.20~rc3`
- `mongodb-org-database-tools-extra=6.0.20~rc3`
- `mongodb-org-mongos=6.0.20~rc3`
- `mongodb-org-server=6.0.20~rc3`
- `mongodb-org-shell=6.0.20~rc3`
- `mongodb-org-tools=6.0.20~rc3`
