...
### `dpkg` source package: `mongodb-org=6.0.21~rc1`

Binary Packages:

- `mongodb-org=6.0.21~rc1`
- `mongodb-org-database=6.0.21~rc1`
- `mongodb-org-database-tools-extra=6.0.21~rc1`
- `mongodb-org-mongos=6.0.21~rc1`
- `mongodb-org-server=6.0.21~rc1`
- `mongodb-org-shell=6.0.21~rc1`
- `mongodb-org-tools=6.0.21~rc1`
