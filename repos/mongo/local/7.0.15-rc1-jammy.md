...
- Created: `2024-10-09T04:01:29Z`
- Virtual Size: ~ 782.57 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.15~rc1`

Binary Packages:

- `mongodb-org=7.0.15~rc1`
- `mongodb-org-database=7.0.15~rc1`
- `mongodb-org-database-tools-extra=7.0.15~rc1`
- `mongodb-org-mongos=7.0.15~rc1`
- `mongodb-org-server=7.0.15~rc1`
- `mongodb-org-shell=7.0.15~rc1`
- `mongodb-org-tools=7.0.15~rc1`
