...
- Created: `2022-09-02T03:54:15.857973781Z`
...
### `dpkg` source package: `mongodb-org=4.4.17~rc0`

Binary Packages:

- `mongodb-org=4.4.17~rc0`
- `mongodb-org-mongos=4.4.17~rc0`
- `mongodb-org-server=4.4.17~rc0`
- `mongodb-org-shell=4.4.17~rc0`
- `mongodb-org-tools=4.4.17~rc0`
...
### `dpkg` source package: `mongodb-org=6.0.2~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=6.0.2~rc0`
