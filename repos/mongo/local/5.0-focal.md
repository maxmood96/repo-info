...
- Created: `2021-10-01T05:28:01.368876748Z`
...
### `dpkg` source package: `mongodb-database-tools=100.5.0`
...
### `dpkg` source package: `mongodb-mongosh=1.0.7`
...
### `dpkg` source package: `mongodb-org=5.0.3`

Binary Packages:

- `mongodb-org=5.0.3`
- `mongodb-org-database=5.0.3`
- `mongodb-org-database-tools-extra=5.0.3`
