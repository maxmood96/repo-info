...
- Created: `2026-03-23T18:14:45.484829821Z`
...
### `dpkg` source package: `mongodb-org=8.0.21~rc0`

Binary Packages:

- `mongodb-org=8.0.21~rc0`
- `mongodb-org-database=8.0.21~rc0`
- `mongodb-org-database-tools-extra=8.0.21~rc0`
- `mongodb-org-mongos=8.0.21~rc0`
- `mongodb-org-server=8.0.21~rc0`
- `mongodb-org-shell=8.0.21~rc0`
- `mongodb-org-tools=8.0.21~rc0`
