...
- Created: `2022-01-08T00:27:03.38122286Z`
- Virtual Size: ~ 437.92 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.12~rc1`

Binary Packages:

- `mongodb-org=4.4.12~rc1`
- `mongodb-org-mongos=4.4.12~rc1`
- `mongodb-org-server=4.4.12~rc1`
- `mongodb-org-shell=4.4.12~rc1`
- `mongodb-org-tools=4.4.12~rc1`
...
### `dpkg` source package: `mongodb-org=5.0.6~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=5.0.6~rc0`
