...
- Created: `2024-08-06T10:01:39Z`
- Virtual Size: ~ 778.74 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.13~rc0`

Binary Packages:

- `mongodb-org=7.0.13~rc0`
- `mongodb-org-database=7.0.13~rc0`
- `mongodb-org-database-tools-extra=7.0.13~rc0`
- `mongodb-org-mongos=7.0.13~rc0`
- `mongodb-org-server=7.0.13~rc0`
- `mongodb-org-shell=7.0.13~rc0`
- `mongodb-org-tools=7.0.13~rc0`
