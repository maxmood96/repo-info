...
### `dpkg` source package: `mongodb-org=8.0.0~rc4`

Binary Packages:

- `mongodb-org=8.0.0~rc4`
- `mongodb-org-database=8.0.0~rc4`
- `mongodb-org-database-tools-extra=8.0.0~rc4`
- `mongodb-org-mongos=8.0.0~rc4`
- `mongodb-org-server=8.0.0~rc4`
- `mongodb-org-shell=8.0.0~rc4`
- `mongodb-org-tools=8.0.0~rc4`
