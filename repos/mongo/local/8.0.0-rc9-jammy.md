...
- Created: `2024-06-21T10:01:41Z`
- Virtual Size: ~ 866.60 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.0~rc9`

Binary Packages:

- `mongodb-org=8.0.0~rc9`
- `mongodb-org-database=8.0.0~rc9`
- `mongodb-org-database-tools-extra=8.0.0~rc9`
- `mongodb-org-mongos=8.0.0~rc9`
- `mongodb-org-server=8.0.0~rc9`
- `mongodb-org-shell=8.0.0~rc9`
- `mongodb-org-tools=8.0.0~rc9`
