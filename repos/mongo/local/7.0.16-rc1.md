...
- Created: `2024-12-04T23:01:31Z`
- Virtual Size: ~ 781.33 Mb  
...
### `dpkg` source package: `mongodb-mongosh=2.3.4`

Binary Packages:

- `mongodb-mongosh=2.3.4`
...
### `dpkg` source package: `mongodb-org=7.0.16~rc1`

Binary Packages:

- `mongodb-org=7.0.16~rc1`
- `mongodb-org-database=7.0.16~rc1`
- `mongodb-org-database-tools-extra=7.0.16~rc1`
- `mongodb-org-mongos=7.0.16~rc1`
- `mongodb-org-server=7.0.16~rc1`
- `mongodb-org-shell=7.0.16~rc1`
- `mongodb-org-tools=7.0.16~rc1`
