...
- Created: `2023-01-27T23:34:08.437511978Z`
- Virtual Size: ~ 438.40 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.19~rc0`

Binary Packages:

- `mongodb-org=4.4.19~rc0`
- `mongodb-org-mongos=4.4.19~rc0`
- `mongodb-org-server=4.4.19~rc0`
- `mongodb-org-shell=4.4.19~rc0`
- `mongodb-org-tools=4.4.19~rc0`
...
### `dpkg` source package: `mongodb-org=6.0.4~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=6.0.4~rc0`
