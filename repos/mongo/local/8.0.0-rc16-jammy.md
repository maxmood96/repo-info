...
- Created: `2024-08-05T22:01:35Z`
- Virtual Size: ~ 849.83 Mb  
...
### `dpkg` source package: `mongodb-mongosh=2.2.15`
...
### `dpkg` source package: `mongodb-org=8.0.0~rc16`

Binary Packages:

- `mongodb-org=8.0.0~rc16`
- `mongodb-org-database=8.0.0~rc16`
- `mongodb-org-database-tools-extra=8.0.0~rc16`
- `mongodb-org-mongos=8.0.0~rc16`
- `mongodb-org-server=8.0.0~rc16`
- `mongodb-org-shell=8.0.0~rc16`
- `mongodb-org-tools=8.0.0~rc16`
