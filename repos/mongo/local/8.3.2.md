...
- Created: `2026-05-13T18:11:28.045328105Z`
- Virtual Size: ~ 838.95 Mb  
...
### `dpkg` source package: `mongodb-org=8.3.2`

Binary Packages:

- `mongodb-org=8.3.2`
- `mongodb-org-database=8.3.2`
- `mongodb-org-database-tools-extra=8.3.2`
- `mongodb-org-mongos=8.3.2`
- `mongodb-org-server=8.3.2`
- `mongodb-org-shell=8.3.2`
- `mongodb-org-tools=8.3.2`
