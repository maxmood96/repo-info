...
- Created: `2026-05-13T18:11:47.837563254Z`
- Virtual Size: ~ 943.44 Mb  
...
### `dpkg` source package: `mongodb-org=8.2.9`

Binary Packages:

- `mongodb-org=8.2.9`
- `mongodb-org-database=8.2.9`
- `mongodb-org-database-tools-extra=8.2.9`
- `mongodb-org-mongos=8.2.9`
- `mongodb-org-server=8.2.9`
- `mongodb-org-shell=8.2.9`
- `mongodb-org-tools=8.2.9`
