...
- Created: `2024-08-01T17:56:56Z`
- Virtual Size: ~ 849.88 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.0~rc15`

Binary Packages:

- `mongodb-org=8.0.0~rc15`
- `mongodb-org-database=8.0.0~rc15`
- `mongodb-org-database-tools-extra=8.0.0~rc15`
- `mongodb-org-mongos=8.0.0~rc15`
- `mongodb-org-server=8.0.0~rc15`
- `mongodb-org-shell=8.0.0~rc15`
- `mongodb-org-tools=8.0.0~rc15`
