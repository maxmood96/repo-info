...
- Created: `2024-07-05T22:01:36Z`
- Virtual Size: ~ 866.87 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.0~rc11`

Binary Packages:

- `mongodb-org=8.0.0~rc11`
- `mongodb-org-database=8.0.0~rc11`
- `mongodb-org-database-tools-extra=8.0.0~rc11`
- `mongodb-org-mongos=8.0.0~rc11`
- `mongodb-org-server=8.0.0~rc11`
- `mongodb-org-shell=8.0.0~rc11`
- `mongodb-org-tools=8.0.0~rc11`
