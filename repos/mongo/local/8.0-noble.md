...
- Created: `2025-11-19T23:52:45.713575377Z`
- Virtual Size: ~ 909.92 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.16`

Binary Packages:

- `mongodb-org=8.0.16`
- `mongodb-org-database=8.0.16`
- `mongodb-org-database-tools-extra=8.0.16`
- `mongodb-org-mongos=8.0.16`
- `mongodb-org-server=8.0.16`
- `mongodb-org-shell=8.0.16`
- `mongodb-org-tools=8.0.16`
