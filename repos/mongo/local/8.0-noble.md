...
- Created: `2026-05-01T05:32:30.919561587Z`
- Virtual Size: ~ 955.94 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.21`

Binary Packages:

- `mongodb-org=8.0.21`
- `mongodb-org-database=8.0.21`
- `mongodb-org-database-tools-extra=8.0.21`
- `mongodb-org-mongos=8.0.21`
- `mongodb-org-server=8.0.21`
- `mongodb-org-shell=8.0.21`
- `mongodb-org-tools=8.0.21`
