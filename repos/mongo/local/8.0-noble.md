...
- Created: `2026-01-28T18:58:16.713795549Z`
- Virtual Size: ~ 926.88 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.18`

Binary Packages:

- `mongodb-org=8.0.18`
- `mongodb-org-database=8.0.18`
- `mongodb-org-database-tools-extra=8.0.18`
- `mongodb-org-mongos=8.0.18`
- `mongodb-org-server=8.0.18`
- `mongodb-org-shell=8.0.18`
