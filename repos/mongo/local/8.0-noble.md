...
- Created: `2026-02-17T20:29:06.192652177Z`
- Virtual Size: ~ 945.24 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.19`

Binary Packages:

- `mongodb-org=8.0.19`
- `mongodb-org-database=8.0.19`
- `mongodb-org-database-tools-extra=8.0.19`
- `mongodb-org-mongos=8.0.19`
- `mongodb-org-server=8.0.19`
- `mongodb-org-shell=8.0.19`
- `mongodb-org-tools=8.0.19`
