...
- Created: `2026-01-15T22:33:54.444823339Z`
- Virtual Size: ~ 919.96 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.17`

Binary Packages:

- `mongodb-org=8.0.17`
- `mongodb-org-database=8.0.17`
- `mongodb-org-database-tools-extra=8.0.17`
- `mongodb-org-mongos=8.0.17`
- `mongodb-org-server=8.0.17`
- `mongodb-org-shell=8.0.17`
