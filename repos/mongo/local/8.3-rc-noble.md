# `mongo:8.3.0-rc5-noble`

## Docker Metadata

- Image ID: `sha256:cab9b073893855103f755201301c39444b4df2d10db06a2c1d3ffd7badbd1d4e`
- Created: `2026-04-15T20:45:20.362088571Z`
- Virtual Size: ~ 845.62 Mb  
...
### `dpkg` source package: `mongodb-org=8.3.0~rc5`

Binary Packages:

- `mongodb-org=8.3.0~rc5`
- `mongodb-org-database=8.3.0~rc5`
- `mongodb-org-database-tools-extra=8.3.0~rc5`
- `mongodb-org-mongos=8.3.0~rc5`
- `mongodb-org-server=8.3.0~rc5`
- `mongodb-org-shell=8.3.0~rc5`
- `mongodb-org-tools=8.3.0~rc5`
