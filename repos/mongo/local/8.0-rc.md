...
- Created: `2025-05-22T22:13:18Z`
- Virtual Size: ~ 892.05 Mb  
...
### `dpkg` source package: `mongodb-database-tools=100.12.1`
...
### `dpkg` source package: `mongodb-mongosh=2.5.1`
...
### `dpkg` source package: `mongodb-org=8.0.10~rc0`

Binary Packages:

- `mongodb-org=8.0.10~rc0`
- `mongodb-org-database=8.0.10~rc0`
- `mongodb-org-database-tools-extra=8.0.10~rc0`
- `mongodb-org-mongos=8.0.10~rc0`
- `mongodb-org-server=8.0.10~rc0`
- `mongodb-org-shell=8.0.10~rc0`
- `mongodb-org-tools=8.0.10~rc0`
