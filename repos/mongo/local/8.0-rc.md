...
- Created: `2026-02-21T00:10:01.079586493Z`
- Virtual Size: ~ 945.86 Mb  
...
### `dpkg` source package: `mongodb-mongosh=2.7.0`

Binary Packages:

- `mongodb-mongosh=2.7.0`
...
### `dpkg` source package: `mongodb-org=8.0.20~rc0`

Binary Packages:

- `mongodb-org=8.0.20~rc0`
- `mongodb-org-database=8.0.20~rc0`
- `mongodb-org-database-tools-extra=8.0.20~rc0`
- `mongodb-org-mongos=8.0.20~rc0`
- `mongodb-org-server=8.0.20~rc0`
- `mongodb-org-shell=8.0.20~rc0`
- `mongodb-org-tools=8.0.20~rc0`
