...
### `dpkg` source package: `mongodb-org=8.0.13~rc2`

Binary Packages:

- `mongodb-org=8.0.13~rc2`
- `mongodb-org-database=8.0.13~rc2`
- `mongodb-org-database-tools-extra=8.0.13~rc2`
- `mongodb-org-mongos=8.0.13~rc2`
- `mongodb-org-server=8.0.13~rc2`
- `mongodb-org-shell=8.0.13~rc2`
- `mongodb-org-tools=8.0.13~rc2`
