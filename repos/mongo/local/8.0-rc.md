...
### `dpkg` source package: `mongodb-org=8.0.6~rc1`

Binary Packages:

- `mongodb-org=8.0.6~rc1`
- `mongodb-org-database=8.0.6~rc1`
- `mongodb-org-database-tools-extra=8.0.6~rc1`
- `mongodb-org-mongos=8.0.6~rc1`
- `mongodb-org-server=8.0.6~rc1`
- `mongodb-org-shell=8.0.6~rc1`
- `mongodb-org-tools=8.0.6~rc1`
