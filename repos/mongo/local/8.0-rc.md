...
- Created: `2025-09-03T10:01:56Z`
- Virtual Size: ~ 909.88 Mb  
...
### `dpkg` source package: `mongodb-org=8.0.14~rc0`

Binary Packages:

- `mongodb-org=8.0.14~rc0`
- `mongodb-org-database=8.0.14~rc0`
- `mongodb-org-database-tools-extra=8.0.14~rc0`
- `mongodb-org-mongos=8.0.14~rc0`
- `mongodb-org-server=8.0.14~rc0`
- `mongodb-org-shell=8.0.14~rc0`
- `mongodb-org-tools=8.0.14~rc0`
...
- http://snapshot.debian.org/package/publicsuffix/20231001.0357-0.1/
