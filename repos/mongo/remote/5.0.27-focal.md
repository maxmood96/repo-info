...
```console
$ docker pull mongo@sha256:955784ea302a4e1e3c1cf16ba01a33d12d1705ea64688ea5a0626b00494efc12
```
...
### `mongo:5.0.27-focal` - linux; amd64
...
### `mongo:5.0.27-focal` - unknown; unknown
...
### `mongo:5.0.27-focal` - linux; arm64 variant v8
