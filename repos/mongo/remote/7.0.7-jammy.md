...
```console
$ docker pull mongo@sha256:eebb4353f8406f75c7f08c37e51738e94484582ffe191c0ca92f57019bfb865a
```
...
### `mongo:7.0.7-jammy` - unknown; unknown
