...
- Created: `2026-05-19T23:01:58.035909408Z`
- Virtual Size: ~ 3.51 Gb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["ghci"]`
- Environment:
  - `PATH=/root/.cabal/bin:/root/.local/bin:/opt/ghc/9.10.3/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `LANG=C.UTF-8`
...
- `libtinfo-dev:amd64=6.2+20201114-2+deb11u2`
