...
```console
iproute2-minimal-6.9.0-r0 description:
IP Routing Utilities (/sbin/ip only)

iproute2-minimal-6.9.0-r0 webpage:
https://wiki.linuxfoundation.org/networking/iproute2

iproute2-minimal-6.9.0-r0 installed size:
652 KiB

iproute2-minimal-6.9.0-r0 license:
GPL-2.0-or-later
...
```console
iproute2-ss-6.9.0-r0 description:
IP Routing Utilities (socket statistics tool)

iproute2-ss-6.9.0-r0 webpage:
https://wiki.linuxfoundation.org/networking/iproute2

iproute2-ss-6.9.0-r0 installed size:
108 KiB

iproute2-ss-6.9.0-r0 license:
GPL-2.0-or-later
...
```console
iproute2-tc-6.9.0-r0 description:
IP Routing Utilities (traffic control and XDP support)

iproute2-tc-6.9.0-r0 webpage:
https://wiki.linuxfoundation.org/networking/iproute2

iproute2-tc-6.9.0-r0 installed size:
596 KiB

iproute2-tc-6.9.0-r0 license:
GPL-2.0-or-later
...
```console
zfs-2.2.4-r0 description:
Advanced filesystem and volume manager

zfs-2.2.4-r0 webpage:
https://openzfs.org

zfs-2.2.4-r0 installed size:
1376 KiB

zfs-2.2.4-r0 license:
CDDL-1.0
...
```console
zfs-libs-2.2.4-r0 description:
Advanced filesystem and volume manager (libraries)

zfs-libs-2.2.4-r0 webpage:
https://openzfs.org

zfs-libs-2.2.4-r0 installed size:
4116 KiB

zfs-libs-2.2.4-r0 license:
CDDL-1.0
