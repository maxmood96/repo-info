...
- Created: `2022-11-16T20:19:39.79198063Z`
...
```console
libc6-compat-1.2.3-r2 description:
compatibility libraries for glibc

libc6-compat-1.2.3-r2 webpage:
https://musl.libc.org/

libc6-compat-1.2.3-r2 installed size:
12 KiB

libc6-compat-1.2.3-r2 license:
MIT
