...
```console
$ docker pull docker@sha256:877751de383bdde8540adf9c12710a187aad77b8902a3bf3a790d8844eb05ef9
```
...
```console
$ docker pull docker@sha256:357b400d40abb24d7f58b57910bdc9ecf1cb958d84b199dacf386e6f96e41247
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.1 MB (118115031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b74133e36c202bad94dd44c3f114a34a4c1736b022a3831df3a61a269843d5d0`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
...
-	Layers:
	...
	-	`sha256:82e1904f27ce6d8f1e4721863c0a2134d1761fb0a7c59072c2bf1c1884b91e9b`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a3599c7b0798f0c6b38252d21e1f8754a6f6053f5d019d577898cb265337cae8`  
		Last Modified: Tue, 14 Nov 2023 07:24:36 GMT  
		Size: 4.5 MB (4492367 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `docker:rc-git` - unknown; unknown

```console
$ docker pull docker@sha256:037ad368b8803f17d22e9a002c914cf330a61fcf205e7da8b739c2f82edce86b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **735.7 KB (735716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee80b0ef7a90f63771fb0657854af00e861229b8ce5ad3b58826b3ed9fe3f287`

```dockerfile
```

-	Layers:
	-	`sha256:5cfdee8aa86a8b4f2e64b7abcc2dd180acb790c19b235a19de65f4cff04aec11`  
		Last Modified: Tue, 14 Nov 2023 07:24:35 GMT  
		Size: 723.0 KB (722967 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f3130b4e9ae85c46a54de793126f6d17d4345dfd57677da092ccee49fe2536c0`  
		Last Modified: Tue, 14 Nov 2023 07:24:35 GMT  
