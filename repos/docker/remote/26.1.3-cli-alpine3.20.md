...
```console
$ docker pull docker@sha256:1f2f5de5478b01961a2d77962d2694cf7d3f594a310affa142417184dc6f3969
```
...
### `docker:26.1.3-cli-alpine3.20` - linux; amd64
...
### `docker:26.1.3-cli-alpine3.20` - unknown; unknown
...
### `docker:26.1.3-cli-alpine3.20` - linux; arm variant v6
...
### `docker:26.1.3-cli-alpine3.20` - linux; arm variant v7
