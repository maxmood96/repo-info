...
```console
$ docker pull docker@sha256:3c6c66c7b2a56087af3a068692d5f3c965082606824ab941bb90cc98208eb6a2
```
...
### `docker:27.2.0-rc.1-cli-alpine3.20` - linux; amd64
...
### `docker:27.2.0-rc.1-cli-alpine3.20` - unknown; unknown
...
### `docker:27.2.0-rc.1-cli-alpine3.20` - linux; arm variant v6
...
### `docker:27.2.0-rc.1-cli-alpine3.20` - linux; arm64 variant v8
