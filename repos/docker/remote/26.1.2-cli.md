...
### `docker:26.1.2-cli` - unknown; unknown
...
### `docker:26.1.2-cli` - linux; arm variant v6
...
### `docker:26.1.2-cli` - linux; arm variant v7
...
### `docker:26.1.2-cli` - linux; arm64 variant v8
