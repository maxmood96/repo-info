...
```console
$ docker pull docker@sha256:81ba7af473a161a68e10bd2076a73ff48e13d5e47ff512764d1a129f29d76d70
```
...
### `docker:24.0.2-dind-alpine3.18` - linux; amd64
...
### `docker:24.0.2-dind-alpine3.18` - linux; arm64 variant v8
