...
### `docker:27.0.2-cli` - unknown; unknown
...
### `docker:27.0.2-cli` - linux; arm variant v6
...
### `docker:27.0.2-cli` - linux; arm variant v7
...
### `docker:27.0.2-cli` - linux; arm64 variant v8
