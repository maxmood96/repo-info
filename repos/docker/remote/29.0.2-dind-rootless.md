...
```console
$ docker pull docker@sha256:ed8e33f1b5291d8b18a7b5f93dc1e135d989d973feb04b9b47d48c2593d71c4f
```
...
### `docker:29.0.2-dind-rootless` - linux; arm64 variant v8
...
### `docker:29.0.2-dind-rootless` - unknown; unknown
