...
```console
$ docker pull docker@sha256:815f0a256832c31d439ee46fdaf2e57a5ad612a349e556c8dc8d3aae22da120f
```
...
### `docker:25.0.0-rc.3-dind-rootless` - linux; amd64
...
### `docker:25.0.0-rc.3-dind-rootless` - unknown; unknown
