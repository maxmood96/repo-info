...
### `docker:24.0.8-dind` - linux; amd64
...
### `docker:24.0.8-dind` - unknown; unknown
...
### `docker:24.0.8-dind` - linux; arm variant v6
...
### `docker:24.0.8-dind` - linux; arm variant v7
...
### `docker:24.0.8-dind` - linux; arm64 variant v8
