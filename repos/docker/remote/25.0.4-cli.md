...
```console
$ docker pull docker@sha256:2cd3d953dd17ba8c2c14943be27a2a3782e2f74d736ba86f568278c37a89ef45
```
...
### `docker:25.0.4-cli` - linux; arm variant v7
...
### `docker:25.0.4-cli` - linux; arm64 variant v8
