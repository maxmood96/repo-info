...
```console
$ docker pull docker@sha256:7760d249550f538f27693334998a75b1721ed46095aba03a2e1c77437fd0e20f
```
...
```console
$ docker pull docker@sha256:f640c99836e2e01707f36ced0ee1d14947bbcf2605a38b43e9cd9bbedb30ef2e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53682688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17ca7824b19db957351762b95eacdf8961c4da9ca4b3dd32b46420bb039aa6b9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
```console
$ docker pull docker@sha256:82acaca7f77ac824a87a1fb002fc08d619c159b6099f60bc1e82dced6c2cdb63
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.5 KB (37518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:534d0911dbc07b6e97d22e2932386879a4dac3b05ba7ca30615bab74c912aad3`

```dockerfile
```

-	Layers:
	-	`sha256:9b61ff9248b6acd3e6498d1df57e5d4e4444e94d4e9b9e13f5b3ee928701a434`  
		Last Modified: Tue, 23 Jan 2024 14:02:31 GMT  
...
```console
$ docker pull docker@sha256:48a80264a33d90a307a0a4fafa0976aba7f9a2ebebf212764d9148d59668dc72
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53187746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25b881038294c9752ba7a232746401eb73ee3f7cfedbeb7c3775b3ac9db3eec7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
```console
$ docker pull docker@sha256:ddecdaada8b9d6f6dc78fd09786ee866fd72099b9fed0f29be3bffd8ad8ddc00
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **393.5 KB (393508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67c60133bda883c085f35b02426e70069ab94b659f077153fc6e3422732e40f9`

```dockerfile
```

-	Layers:
	-	`sha256:2f2eb128c5f1de9858bfae707576747cdd5ead16ecefbef0378dbd22f753ab2d`  
		Last Modified: Tue, 23 Jan 2024 04:37:31 GMT  
		Size: 355.8 KB (355775 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:40d875b663c8b5636e965c96ba3b636b8142b5cd909c39897e0c7349504d51ae`  
		Last Modified: Tue, 23 Jan 2024 04:37:30 GMT  
