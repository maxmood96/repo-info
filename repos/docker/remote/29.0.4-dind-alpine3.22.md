...
### `docker:29.0.4-dind-alpine3.22` - linux; amd64
...
### `docker:29.0.4-dind-alpine3.22` - unknown; unknown
...
### `docker:29.0.4-dind-alpine3.22` - linux; arm variant v6
...
### `docker:29.0.4-dind-alpine3.22` - linux; arm variant v7
...
### `docker:29.0.4-dind-alpine3.22` - linux; arm64 variant v8
