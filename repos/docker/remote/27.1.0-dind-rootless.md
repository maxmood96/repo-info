...
```console
$ docker pull docker@sha256:49343ff484e157eb3ee67be7ee6bc989fefd7fc1875d7e62008572bb6ac026d9
```
...
### `docker:27.1.0-dind-rootless` - linux; amd64
...
### `docker:27.1.0-dind-rootless` - unknown; unknown
