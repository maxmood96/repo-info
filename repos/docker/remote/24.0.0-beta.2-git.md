...
```console
$ docker pull docker@sha256:2080f80ca66b7b3605671dd101ee0361c4ba4e53bbe8436130d24ec1cc50a60e
```
...
```console
$ docker pull docker@sha256:97f697afdb2e2f43007ccc4e42b544d9b11edb6d545ad9af588d3c430a10dfb0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54186931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6397148dadcd90f7bbf5d6ff73b07962b2bab2477947516fda9e464bbb4435ec`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
-	Layers:
	...
	-	`sha256:7b67a8cc1f85dc1ced7f28a30869cd725cd185587721781495e460db8ce4df4d`  
		...
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9bc06bea05aa5fda7e76ae03be645f613987e969099588049a064f67f19f419`  
		Last Modified: Thu, 20 Apr 2023 22:34:47 GMT  
		Size: 4.2 MB (4195466 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
