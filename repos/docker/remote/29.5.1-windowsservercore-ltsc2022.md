...
```console
$ docker pull docker@sha256:44db15c5730577b5a9a69587ba75450c1c8e2a71a05022295e7b41cf61d3b7aa
```
...
### `docker:29.5.1-windowsservercore-ltsc2022` - windows version 10.0.20348.5139; amd64
