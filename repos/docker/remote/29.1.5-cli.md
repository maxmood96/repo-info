...
### `docker:29.1.5-cli` - unknown; unknown
...
### `docker:29.1.5-cli` - linux; arm variant v6
...
### `docker:29.1.5-cli` - linux; arm variant v7
...
### `docker:29.1.5-cli` - linux; arm64 variant v8
