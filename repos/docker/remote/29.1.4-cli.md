...
### `docker:29.1.4-cli` - unknown; unknown
...
### `docker:29.1.4-cli` - linux; arm variant v6
...
### `docker:29.1.4-cli` - linux; arm variant v7
...
### `docker:29.1.4-cli` - linux; arm64 variant v8
