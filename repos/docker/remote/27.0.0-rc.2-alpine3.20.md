...
```console
$ docker pull docker@sha256:3c676a4247abe38774b3c19c1bb3f42d4337f63fad86e533886c393c1c7e9c49
```
...
### `docker:27.0.0-rc.2-alpine3.20` - linux; amd64
...
### `docker:27.0.0-rc.2-alpine3.20` - unknown; unknown
...
### `docker:27.0.0-rc.2-alpine3.20` - linux; arm variant v6
...
### `docker:27.0.0-rc.2-alpine3.20` - linux; arm variant v7
...
### `docker:27.0.0-rc.2-alpine3.20` - linux; arm64 variant v8

```console
$ docker pull docker@sha256:555bfaa43b81b4eaf663cca1619ac09d27de287c79dfd90950b5b91491b01121
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.3 MB (122267570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c2dd762fb26304abcbe34d89c344cae06bc455228cd83ff2e122630fe78c8d9`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
...
```console
$ docker pull docker@sha256:60d1fcb9fbce6ef53d0aa372b64ac4f1b308400537133e84b77d26cf7094270a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.5 KB (34522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e33f0bf21c92ce5ce9f0a668d27ee5d03ac8a4ea8dbec08d0fa05d5941c10d25`

```dockerfile
```

-	Layers:
	-	`sha256:cfbf4843ed8e6635b03f234e79fd3924b36bbddfe06e9c34fc94b6222d2d513f`  
		Last Modified: Fri, 21 Jun 2024 15:52:21 GMT  
