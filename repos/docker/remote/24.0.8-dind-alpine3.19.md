...
```console
$ docker pull docker@sha256:6f26eb2c1336cd7c59722c0348ab2b79076d1f35623e4c78008c475223670f77
```
...
### `docker:24.0.8-dind-alpine3.19` - linux; arm variant v6
...
### `docker:24.0.8-dind-alpine3.19` - linux; arm variant v7
