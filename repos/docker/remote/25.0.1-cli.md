...
### `docker:25.0.1-cli` - unknown; unknown
...
### `docker:25.0.1-cli` - linux; arm variant v6
...
### `docker:25.0.1-cli` - linux; arm variant v7
...
### `docker:25.0.1-cli` - linux; arm64 variant v8
