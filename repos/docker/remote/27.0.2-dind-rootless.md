...
```console
$ docker pull docker@sha256:dffbe8e73779044f766e02d93cac5cbb1b78be9b15452c0cb4cf3da131db8ee8
```
...
### `docker:27.0.2-dind-rootless` - linux; amd64
...
### `docker:27.0.2-dind-rootless` - unknown; unknown
