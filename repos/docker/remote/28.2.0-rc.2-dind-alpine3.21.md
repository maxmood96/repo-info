...
### `docker:28.2.0-rc.2-dind-alpine3.21` - linux; amd64
...
### `docker:28.2.0-rc.2-dind-alpine3.21` - unknown; unknown
...
### `docker:28.2.0-rc.2-dind-alpine3.21` - linux; arm variant v6
...
### `docker:28.2.0-rc.2-dind-alpine3.21` - linux; arm variant v7
...
### `docker:28.2.0-rc.2-dind-alpine3.21` - linux; arm64 variant v8
