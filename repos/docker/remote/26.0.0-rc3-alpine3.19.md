...
### `docker:26.0.0-rc3-alpine3.19` - linux; amd64
...
### `docker:26.0.0-rc3-alpine3.19` - unknown; unknown
...
### `docker:26.0.0-rc3-alpine3.19` - linux; arm variant v6
...
### `docker:26.0.0-rc3-alpine3.19` - linux; arm variant v7
...
### `docker:26.0.0-rc3-alpine3.19` - linux; arm64 variant v8
