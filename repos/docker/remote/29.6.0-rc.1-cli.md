...
### `docker:29.6.0-rc.1-cli` - linux; amd64
...
### `docker:29.6.0-rc.1-cli` - unknown; unknown
...
### `docker:29.6.0-rc.1-cli` - linux; arm variant v6
...
### `docker:29.6.0-rc.1-cli` - linux; arm variant v7
...
### `docker:29.6.0-rc.1-cli` - linux; arm64 variant v8
