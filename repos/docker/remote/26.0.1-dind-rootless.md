...
```console
$ docker pull docker@sha256:b7bdd4ae6388843f545dd56b0f1b1de0425cedaa8e5deb312635fb59f4209515
```
...
### `docker:26.0.1-dind-rootless` - linux; amd64
...
### `docker:26.0.1-dind-rootless` - unknown; unknown
