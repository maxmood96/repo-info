...
### `docker:26.0.0-rc3-cli` - linux; amd64
...
### `docker:26.0.0-rc3-cli` - unknown; unknown
...
### `docker:26.0.0-rc3-cli` - linux; arm variant v6
...
### `docker:26.0.0-rc3-cli` - linux; arm variant v7
...
### `docker:26.0.0-rc3-cli` - linux; arm64 variant v8
