...
### `docker:26.0-dind` - unknown; unknown
...
### `docker:26.0-dind` - linux; arm variant v6
...
### `docker:26.0-dind` - linux; arm variant v7
...
### `docker:26.0-dind` - linux; arm64 variant v8
