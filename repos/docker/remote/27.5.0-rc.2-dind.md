...
### `docker:27.5.0-rc.2-dind` - linux; amd64
...
### `docker:27.5.0-rc.2-dind` - unknown; unknown
...
### `docker:27.5.0-rc.2-dind` - linux; arm variant v6
...
### `docker:27.5.0-rc.2-dind` - linux; arm variant v7
...
### `docker:27.5.0-rc.2-dind` - linux; arm64 variant v8
