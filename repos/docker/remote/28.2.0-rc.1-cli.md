...
### `docker:28.2.0-rc.1-cli` - linux; amd64
...
### `docker:28.2.0-rc.1-cli` - unknown; unknown
...
### `docker:28.2.0-rc.1-cli` - linux; arm variant v6
...
### `docker:28.2.0-rc.1-cli` - linux; arm variant v7
...
### `docker:28.2.0-rc.1-cli` - linux; arm64 variant v8
