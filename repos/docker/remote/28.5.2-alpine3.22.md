...
### `docker:28.5.2-alpine3.22` - linux; amd64
...
### `docker:28.5.2-alpine3.22` - unknown; unknown
...
### `docker:28.5.2-alpine3.22` - linux; arm variant v6
...
### `docker:28.5.2-alpine3.22` - linux; arm variant v7
...
### `docker:28.5.2-alpine3.22` - linux; arm64 variant v8
