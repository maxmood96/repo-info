...
### `docker:19.03.6-rc1-dind` - linux; amd64
...
### `docker:19.03.6-rc1-dind` - linux; arm variant v6
...
### `docker:19.03.6-rc1-dind` - linux; arm variant v7
...
### `docker:19.03.6-rc1-dind` - linux; arm64 variant v8
