...
### `docker:27.0.1-dind` - linux; amd64
...
### `docker:27.0.1-dind` - unknown; unknown
...
### `docker:27.0.1-dind` - linux; arm variant v6
...
### `docker:27.0.1-dind` - linux; arm variant v7
...
### `docker:27.0.1-dind` - linux; arm64 variant v8
