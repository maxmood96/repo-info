...
### `docker:27.5.0-rc.2-alpine3.21` - linux; amd64
...
### `docker:27.5.0-rc.2-alpine3.21` - unknown; unknown
...
### `docker:27.5.0-rc.2-alpine3.21` - linux; arm variant v6
...
### `docker:27.5.0-rc.2-alpine3.21` - linux; arm variant v7
...
### `docker:27.5.0-rc.2-alpine3.21` - linux; arm64 variant v8
