...
### `docker:27.1.0-cli` - unknown; unknown
...
### `docker:27.1.0-cli` - linux; arm variant v6
...
### `docker:27.1.0-cli` - linux; arm variant v7
...
### `docker:27.1.0-cli` - linux; arm64 variant v8
