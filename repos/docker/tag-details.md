...
### `docker:29.5.1-cli` - linux; arm variant v7
...
### `docker:29.5.1-cli` - linux; arm64 variant v8
...
### `docker:29.5.1-windowsservercore` - windows version 10.0.26100.32860; amd64
...
### `docker:29.5.1-windowsservercore` - windows version 10.0.20348.5139; amd64
