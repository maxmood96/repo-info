...
```console
$ docker pull convertigo@sha256:18d4eb76c51959b1aa3eb06b4f2d1e7923a4ecc722ad5075af9d66387d7438c2
```
...
```console
$ docker pull convertigo@sha256:a7640b81c2d0cb88934b3ff6a7d0a4247d8a573842a762172026dad8a9811300
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300290593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81fb24b223ae5c2e013e357f2d6af95111a3fc460124e498514947932166da35`
-	Entrypoint: `["tini","--","\/docker-entrypoint.sh"]`
-	Default Command: `["convertigo"]`
...
# Wed, 21 Feb 2024 04:07:11 GMT
CMD ["catalina.sh" "run"]
# Wed, 21 Feb 2024 05:09:05 GMT
MAINTAINER Nicolas Albert nicolasa@convertigo.com
# Wed, 21 Feb 2024 05:09:06 GMT
ENV SWT_GTK3=0
# Wed, 21 Feb 2024 05:09:06 GMT
ENV CATALINA_HOME=/usr/local/tomcat
# Wed, 21 Feb 2024 05:09:08 GMT
RUN mkdir -p "$CATALINA_HOME"
# Wed, 21 Feb 2024 05:09:09 GMT
WORKDIR /usr/local/tomcat
# Wed, 21 Feb 2024 05:09:34 GMT
RUN apt-get update -y   && apt-get install -y --no-install-recommends     ca-certificates     curl     dirmngr     gnupg     gosu     sudo     tini     unzip   && apt-get remove -y --purge wget libfreetype6   && apt-get autoremove -y   && rm -rf /var/lib/apt/lists/*
# Wed, 21 Feb 2024 05:09:37 GMT
RUN useradd -s /bin/false -m convertigo     && mkdir -p /workspace     && chown -R convertigo:convertigo /workspace     && chmod -R 777 /workspace     && echo "convertigo ALL=(ALL) NOPASSWD: ALL" > /etc/sudoers.d/convertigo     && chmod 0440 /etc/sudoers.d/convertigo
# Wed, 21 Feb 2024 05:09:39 GMT
RUN sed -i.bak         -e '/protocol="AJP/d'         -e '/JasperListener/d'         -e 's/port="8080"/port="28080" maxThreads="64000" relaxedQueryChars="{}[]|"/'         -e 's,</Host>,  <Valve className="org.apache.catalina.valves.RemoteIpValve" />\n        <Valve className="org.apache.catalina.valves.ErrorReportValve"  errorCode.404="webapps/convertigo/404.html" errorCode.0="webapps/convertigo/error.html" showReport="false" showServerInfo="false" />\n      </Host>,'         -e 's,</Service>,<!--SSL<Connector port="28443" protocol="org.apache.coyote.http11.Http11AprProtocol" SSLEnabled="true" maxThreads="64000" relaxedQueryChars="{}[]|">\n      <UpgradeProtocol className="org.apache.coyote.http2.Http2Protocol" />\n      <SSLHostConfig>\n        <Certificate certificateKeyFile="/certs/key.pem"\n                     certificateFile="/certs/cert.pem"\n                     certificateChainFile="/certs/chain.pem"\n                     type="RSA" />\n      </SSLHostConfig>\n    </Connector>SSL-->\n  </Service>,'         conf/server.xml     && sed -i.bak         -e 's,<Context>,<Context sessionCookiePath="/">,'         -e 's,</Context>,<Manager pathname="" /><CookieProcessor sameSiteCookies="unset" /></Context>,'         conf/context.xml     && rm -rf webapps/* bin/*.bat conf/server.xml.bak /tmp/*     && mkdir webapps/ROOT     && chown -R convertigo:convertigo conf temp work logs     && chmod -w conf/*     && chmod 777 conf/context.xml conf/server.xml
# Wed, 21 Feb 2024 05:09:40 GMT
ENV CONVERTIGO_VERSION=8.2.6
# Wed, 21 Feb 2024 05:09:40 GMT
ENV CONVERTIGO_WAR_URL=https://github.com/convertigo/convertigo/releases/download/8.2.6/convertigo-8.2.6.war
# Wed, 21 Feb 2024 05:09:41 GMT
ENV CONVERTIGO_GPG_KEYS=6A7779BB78FE368DF74B708FD4DA8FBEB64BF75F
# Wed, 21 Feb 2024 05:09:51 GMT
RUN export GNUPGHOME="$(mktemp -d)"     && ( gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$CONVERTIGO_GPG_KEYS"     || gpg --batch --keyserver keyserver.pgp.com --recv-keys "$CONVERTIGO_GPG_KEYS" )     && curl -fSL -o /tmp/convertigo.war $CONVERTIGO_WAR_URL     && curl -fSL -o /tmp/convertigo.war.asc $CONVERTIGO_WAR_URL.asc     && gpg --batch --verify /tmp/convertigo.war.asc /tmp/convertigo.war     && mkdir -p webapps/ROOT webapps/convertigo     && mkdir /certs && chmod 777 /certs     && (cd webapps/convertigo         && unzip -q /tmp/convertigo.war         && (chmod -f a+x WEB-INF/xvnc/* || true)         && (test "$(dpkg --print-architecture)" != "i386" && rm -rf WEB-INF/xulrunner WEB-INF/xvnc WEB-INF/lib/swt_* || true)         && chmod 777 WEB-INF/web.xml WEB-INF/lib WEB-INF/classes         && rm -rf /tmp/*)
# Wed, 21 Feb 2024 05:09:52 GMT
COPY file:a8c73db31af1c6589d48a2342d8673de69087696e5f19812fc67f887368ccae8 in webapps/ROOT/index.html 
# Wed, 21 Feb 2024 05:09:52 GMT
COPY file:63fbfc6fa825ca14dacaadfe1477ad30f6a2b93014ebcb85d2016902fdaf17b9 in / 
# Wed, 21 Feb 2024 05:09:53 GMT
WORKDIR /workspace
# Wed, 21 Feb 2024 05:09:53 GMT
VOLUME [/workspace]
# Wed, 21 Feb 2024 05:09:54 GMT
EXPOSE 28080
# Wed, 21 Feb 2024 05:09:54 GMT
ENTRYPOINT ["tini" "--" "/docker-entrypoint.sh"]
# Wed, 21 Feb 2024 05:09:54 GMT
...
-	Layers:
	...
	-	`sha256:437a018c80ae86b7605884dc4264bf7e4940ebc2e9cb6cfbfec3864d48a88ec5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e642cd5879109b0354ddc56d1eee116669cada979be7fffbb5e60da9dd7f810`  
		Last Modified: Wed, 21 Feb 2024 04:20:43 GMT  
		Size: 14.4 MB (14415419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ab2bae26be05f619b165ecff218e35b7f87bc325157153031b202ec66e65c83`  
		Last Modified: Wed, 21 Feb 2024 04:20:41 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72cf1218e603b9fc7ba388efae51a63492a1f92661b7fa0227864c67eed9beec`  
		Last Modified: Wed, 21 Feb 2024 05:10:15 GMT  
		Size: 4.7 MB (4669424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c488260c03523dafea52219a8846b0eb245ba6defb4c10946a12767019fdc3d`  
		Last Modified: Wed, 21 Feb 2024 05:10:12 GMT  
		Size: 4.5 KB (4540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b965d7032565391a248feeac88b44495853a81d0f258fd49498ad312d2d680bf`  
		Last Modified: Wed, 21 Feb 2024 05:10:12 GMT  
		Size: 28.0 KB (27965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72cc600784a52d99f5c0896613b33e8647f9beaade8707378093caae2de8dd12`  
		Last Modified: Wed, 21 Feb 2024 05:10:22 GMT  
		Size: 94.3 MB (94266256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b1dd3e4dbd63fc629713c109ebd0ff7492b9f96b26ab8db8b944de62478e9f`  
		Last Modified: Wed, 21 Feb 2024 05:10:12 GMT  
		Size: 453.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e3b632ff35660d01285905934661cb611ea0797b33ebfabaf62f657350d2275`  
		Last Modified: Wed, 21 Feb 2024 05:10:12 GMT  
