...
### `ibm-semeru-runtimes:open-23_37-jre` - linux; amd64
...
### `ibm-semeru-runtimes:open-23_37-jre` - unknown; unknown
...
### `ibm-semeru-runtimes:open-23_37-jre` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-23_37-jre` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-23_37-jre` - linux; s390x
