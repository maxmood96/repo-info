...
### `ibm-semeru-runtimes:open-8u482-b08-jdk` - linux; amd64
...
### `ibm-semeru-runtimes:open-8u482-b08-jdk` - unknown; unknown
...
### `ibm-semeru-runtimes:open-8u482-b08-jdk` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-8u482-b08-jdk` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-8u482-b08-jdk` - linux; s390x
