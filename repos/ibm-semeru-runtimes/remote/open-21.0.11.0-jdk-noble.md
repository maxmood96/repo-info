...
```console
$ docker pull ibm-semeru-runtimes@sha256:e8518a7fc1192eefafad24b8a818eede54e671472554f7c639e4bbf0c641f2a6
```
...
### `ibm-semeru-runtimes:open-21.0.11.0-jdk-noble` - linux; amd64
...
### `ibm-semeru-runtimes:open-21.0.11.0-jdk-noble` - unknown; unknown
...
### `ibm-semeru-runtimes:open-21.0.11.0-jdk-noble` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-21.0.11.0-jdk-noble` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-21.0.11.0-jdk-noble` - linux; s390x
