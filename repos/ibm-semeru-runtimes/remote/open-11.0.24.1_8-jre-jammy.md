...
```console
$ docker pull ibm-semeru-runtimes@sha256:2c87e9988f633c498e5f10bce07761125ecc4373ec2113a0847d1665e1169c57
```
...
```console
$ docker pull ibm-semeru-runtimes@sha256:d619e31d5a84b1389c9901d2be0f9b0b133b9046a3e0b5fae2a4f673f7967cc6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.1 MB (98149403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e55c28e77526c21ecb10ef07dcc65bcff7fbffcd389a347648624b246849a223`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:90cae808ebe5d302b3c6bafe8c58c1d498de3e6fb185cb1f19ecc8ae1708d659
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3622605 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37b4e2ffbcdcb37303a225a2035f556595e958530d9da07c5bd11d3b7fbaf747`

```dockerfile
```

-	Layers:
	-	`sha256:3a57579f371982f4f76f2e81d036d90830304546e7bb6678f9089d914a3e67ec`  
		Last Modified: Mon, 04 Nov 2024 22:04:46 GMT  
		Size: 3.6 MB (3597911 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:60d92c2213b1606139a1aa979a8ca51173e4abef80b0baaf28daaf78d67ddf75`  
		Last Modified: Mon, 04 Nov 2024 22:04:46 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:c3ea0859c269e0d2fcc3eecc9ffdddf7706079a948925dfd89b12212a052740e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.1 MB (92084159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:377bbc05530b2f4d79812336fc62f36bfc63abe00b20b37e572793d3e568fcb8`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:455c5e3bb16bb12c8049c6ff4009ec83737cc5a24b67b3b3a70dd86ad15ccbea
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3616095 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fbd8b07b44d7e48e0bd65d41da08fd5ed04118b4416becd35f0e6fc70e9a57dd`

```dockerfile
```

-	Layers:
	-	`sha256:b65c16d7546fd2084166269adf48e64d1ada69f6bb39e47464ae912c9cef96fe`  
		Last Modified: Mon, 04 Nov 2024 22:15:30 GMT  
		Size: 3.6 MB (3591269 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:78cc88d03d73ba501a9193f48cd328386c84b4b535b1b80dfb9ab3123108263d`  
		Last Modified: Mon, 04 Nov 2024 22:15:29 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:94f3b69251058fc22b109d7c59b1fc7198f1e966ba8c9b7c54b4d9623219b24d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.4 MB (104382418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5d24f3de723e10ac6215b158d3111976ab94108a4300166835c68f23b734769`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:b77a9fb0d35fe6f77ea194bf1b5aa14dd9d6b17ddeeae859d0d602ab6d80865f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3621263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7b14dff40dc866f3d76a07a2df010f33c2c5208a7f65b4a427afbf36e5500e7`

```dockerfile
```

-	Layers:
	-	`sha256:5285a44a92f2bde3f7bb12682b951b8ed4378a000bd679c739bfc8f9d413b90c`  
		Last Modified: Mon, 04 Nov 2024 22:17:46 GMT  
		Size: 3.6 MB (3596521 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e2cdbfe3554f8d9548b8ab99599f08654855d6f4ace450552881858d5bfa516e`  
		Last Modified: Mon, 04 Nov 2024 22:17:45 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:0fcd128ecda26bbb53cd508e4fcbb12f78fa255480036415fc6ecc3d399322e8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.7 MB (95681501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1c153aa2f06a3fc743ef433de6f888fd5251c7fc59d3a657e23ff2b0ce8ba6a`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:cd2304ded1afeed1c2a10a595b2b1defd8a2e996b979d58f54eb21dd0ae4c612
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.6 MB (3618936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d9aadb1797a42cde0e7b932a4d63e96b26f65da519b0cb270ee3b50b9b6554d`

```dockerfile
```

-	Layers:
	-	`sha256:aa951ba9d9c872a5147d08b1369dca90fc6229d8018ee1d49b4042373d57db26`  
		Last Modified: Mon, 04 Nov 2024 22:18:37 GMT  
		Size: 3.6 MB (3594243 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6660b1e08a6ab72f37fb61006946b8bf362bf19b87e321b5bb00afcf22bf6de3`  
		Last Modified: Mon, 04 Nov 2024 22:18:36 GMT  
