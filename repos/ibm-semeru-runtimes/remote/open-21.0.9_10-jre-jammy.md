...
```console
$ docker pull ibm-semeru-runtimes@sha256:d336049391a9cc2be3aacb78ecdef71d5268da269e27b988d5ff6c2a6afef84a
```
...
```console
$ docker pull ibm-semeru-runtimes@sha256:780c05a5d725df7e665e221720b88861140bedc97cb1b0df09cbff484faef025
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.9 MB (106891404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6395120e601a749e57d90d58a30cffa43003d0cfd84afa36fe5e8246c93fe770`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:afc7669af461c0297fc19cb67a330aa98c90ccb88d12d2019ee9278e44625774
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3757488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb620d9484ef3775a42ebb0f4d18a2649781fced89fbac1ea41161791609dbf8`

```dockerfile
```

-	Layers:
	-	`sha256:6964a84591470484e18f0a94a03daaf776f05eb064e076fca8915679f1afd1a0`  
		Last Modified: Mon, 01 Dec 2025 23:47:30 GMT  
		Size: 3.7 MB (3732238 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5b514befe8810a463b1ef1e97c47ef2462351a24e4dd6cf4663abd554e5b7691`  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:281675f173361c5e4a60bc1c73e80a8b8f69d1eb6c6521effd10cb186b6336c4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.6 MB (102597616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c46ccb7e7c88de1fd33bd13e4a0258d960a8f0edb32ae97a268b3582792a08d`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:5fd5db2372e68d6eb2126dcca8dcc7e45f75ed04501ff1e0ea2875fb39499666
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3755970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f206cab71ac493281f1285f78aa13341c9197145422df94520c27c4a31543a51`

```dockerfile
```

-	Layers:
	-	`sha256:63f9623fbcd2e3c5f1329bb233db5e713bf979f3d9df57792635695e0fbca351`  
		Last Modified: Mon, 01 Dec 2025 23:13:32 GMT  
		Size: 3.7 MB (3730610 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7668ca7ddd1ad7d8f53b3ff803451e0f8571fb3e425b9208ca385c39220dca34`  
		Last Modified: Mon, 01 Dec 2025 23:13:33 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:f52b1146e284e2cdd93ecb3d52d7d421546d46b202c0b419c3d6d3efcbdcd40f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.0 MB (113039112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c31e4bd8a35b6b9e669604cf39f8dea03aa8379a0201ae310c36885c8965692`
-	Default Command: `["\/bin\/bash"]`
...
-	Layers:
	...
	-	`sha256:1eae94ecd0286c7cea2aea440a0163fd4edff3a7b0d0fa86fbec9e096e140e07`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f87534996a6ae1e3eb5f2581de8988b0734e9ea74b34e786bfffda9dc2ce3173`  
		Last Modified: Mon, 01 Dec 2025 22:08:50 GMT  
		Size: 4.0 MB (3986951 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `ibm-semeru-runtimes:open-21.0.9_10-jre-jammy` - unknown; unknown

```console
$ docker pull ibm-semeru-runtimes@sha256:83f528a9fe013f70aaba6b47b8770be44c420f91bc0c5f9cd728a10d0de66ffb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3762151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ee1092cfaf7be22ea738d86b3ef204b663dfd2eb5cdf254484bb47f30e724cb`

```dockerfile
```

-	Layers:
	-	`sha256:4b5dc361df487dbca7addca0ba0499d4ce2d19223941d168634c5596e6ee6f4e`  
		Last Modified: Mon, 01 Dec 2025 23:47:38 GMT  
		Size: 3.7 MB (3736865 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5cefb5115b6de96b1c7a28a94f11debc48310cd517879b7b235a2f5ea8980699`  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:d7418214c632b705f0f0ffe48001bf20a166dcfa61f9a0bc9105d07d84f5d56f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.5 MB (104543273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae41c10439452dcd557e22bf679006d43f671564b91400ffc1dfb0cc03397723`
-	Default Command: `["\/bin\/bash"]`
...
# Mon, 01 Dec 2025 21:53:32 GMT
ENV JAVA_VERSION=jdk-21.0.9+10_openj9-0.56.0
# Mon, 01 Dec 2025 21:59:09 GMT
RUN set -eux;     ARCH="$(dpkg --print-architecture)";     case "${ARCH}" in        aarch64|arm64)          ESUM='ac8c6c5aa3c345e14e82966972040b479d672c12e5cd0eaa52d8b38e6bdea40c';          BINARY_URL='https://github.com/ibmruntimes/semeru21-binaries/releases/download/jdk-21.0.9%2B10_openj9-0.56.0/ibm-semeru-open-jre_aarch64_linux_21.0.9_10_openj9-0.56.0.tar.gz';          ;;        amd64|x86_64)          ESUM='6b3022f3d286b2fde9a964028da637a5ad9a93b1028741dcb72aa3bca49c83d2';          BINARY_URL='https://github.com/ibmruntimes/semeru21-binaries/releases/download/jdk-21.0.9%2B10_openj9-0.56.0/ibm-semeru-open-jre_x64_linux_21.0.9_10_openj9-0.56.0.tar.gz';          ;;        ppc64el|ppc64le)          ESUM='876af8243616745796762539816cdb37c194e4b5942398277d6ccd35e96e3dcc';          BINARY_URL='https://github.com/ibmruntimes/semeru21-binaries/releases/download/jdk-21.0.9%2B10_openj9-0.56.0/ibm-semeru-open-jre_ppc64le_linux_21.0.9_10_openj9-0.56.0.tar.gz';          ;;        s390x)          ESUM='e7828369bf76eb25426b807c039974f067888e1f67e9e461274407675946738e';          BINARY_URL='https://github.com/ibmruntimes/semeru21-binaries/releases/download/jdk-21.0.9%2B10_openj9-0.56.0/ibm-semeru-open-jre_s390x_linux_21.0.9_10_openj9-0.56.0.tar.gz';          ;;        *)          echo "Unsupported arch: ${ARCH}";          exit 1;          ;;     esac;     curl -LfsSo /tmp/openjdk.tar.gz ${BINARY_URL};     echo "${ESUM} */tmp/openjdk.tar.gz" | sha256sum -c -;     mkdir -p /opt/java/openjdk;     cd /opt/java/openjdk;     tar -xf /tmp/openjdk.tar.gz --strip-components=1;     rm -rf /tmp/openjdk.tar.gz; # buildkit
# Mon, 01 Dec 2025 21:59:09 GMT
ENV JAVA_HOME=/opt/java/openjdk PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Mon, 01 Dec 2025 21:59:09 GMT
ENV JAVA_TOOL_OPTIONS=-XX:+IgnoreUnrecognizedVMOptions -XX:+PortableSharedCache -XX:+IdleTuningGcOnIdle -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,readonly,nonFatal
# Mon, 01 Dec 2025 21:59:42 GMT
RUN set -eux;     unset OPENJ9_JAVA_OPTIONS;     SCC_SIZE="50m";     DOWNLOAD_PATH_TOMCAT=/tmp/tomcat;     INSTALL_PATH_TOMCAT=/opt/tomcat-home;     TOMCAT_CHECKSUM="fc55589f28bf6659928167461c741649b6005b64285dd81df05bb5ee40f4c6de59b8ee3af84ff756ae1513fc47f5f73070e29313b555e27f096f25881c69841d";     TOMCAT_VERSION="9.0.112";     TOMCAT_FILENAME="apache-tomcat-${TOMCAT_VERSION}.tar.gz";     SUCCESS=;         mkdir -p "${DOWNLOAD_PATH_TOMCAT}" "${INSTALL_PATH_TOMCAT}";     for baseUrl in         https://dlcdn.apache.org/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin         https://archive.apache.org/dist/tomcat/tomcat-9/v${TOMCAT_VERSION}/bin     ; do         if curl -LfsSo "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz "${baseUrl}/${TOMCAT_FILENAME}" && [ -s "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz ]; then             SUCCESS=1;             break;         fi;     done;     [ -n "$SUCCESS" ];     echo "${TOMCAT_CHECKSUM}  ${DOWNLOAD_PATH_TOMCAT}/tomcat.tar.gz" | sha512sum -c -;     tar -xf "${DOWNLOAD_PATH_TOMCAT}"/tomcat.tar.gz -C "${INSTALL_PATH_TOMCAT}" --strip-components=1;     rm -rf "${DOWNLOAD_PATH_TOMCAT}";         java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 5;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 15;     FULL=$( (java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     DST_CACHE=$(java -Xshareclasses:name=dry_run_scc,cacheDir=/opt/java/.scc,destroy 2>&1 || true);     SCC_SIZE=$(echo $SCC_SIZE | sed 's/.$//');     SCC_SIZE=$(awk "BEGIN {print int($SCC_SIZE * $FULL / 100.0)}");     [ "${SCC_SIZE}" -eq 0 ] && SCC_SIZE=1;     SCC_SIZE="${SCC_SIZE}m";     java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal,createLayer -Xscmx$SCC_SIZE -version;     unset OPENJ9_JAVA_OPTIONS;         export OPENJ9_JAVA_OPTIONS="-XX:+IProfileDuringStartupPhase -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,bootClassesOnly,nonFatal";     "${INSTALL_PATH_TOMCAT}"/bin/startup.sh;     sleep 5;     "${INSTALL_PATH_TOMCAT}"/bin/shutdown.sh -force;     sleep 5;     FULL=$( (java -Xshareclasses:name=openj9_system_scc,cacheDir=/opt/java/.scc,printallStats 2>&1 || true) | awk '/^Cache is [0-9.]*% .*full/ {print substr($3, 1, length($3)-1)}');     echo "SCC layer is $FULL% full.";     rm -rf "${INSTALL_PATH_TOMCAT}";     if [ -d "/opt/java/.scc" ]; then           chmod -R 0777 /opt/java/.scc;     fi;         echo "SCC generation phase completed"; # buildkit
```
...
-	Layers:
	...
	-	`sha256:b729344b6db60e029cbcc5ef912d5e5debcd7c143dafbbe8c4f8b0b91566586f`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3cf60c1f011be93166f320546b7d6de38597b9c51b9e75990b8c68195e503ee5`  
		Last Modified: Mon, 01 Dec 2025 22:00:36 GMT  
		Size: 58.9 MB (58867948 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:893d7e70417d9b4588ffbe0a5110d5c25301d0d797c47d4f9aa26377e46846f3`  
		Last Modified: Mon, 01 Dec 2025 22:00:26 GMT  
		Size: 5.5 MB (5452143 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `ibm-semeru-runtimes:open-21.0.9_10-jre-jammy` - unknown; unknown

```console
$ docker pull ibm-semeru-runtimes@sha256:54688b1bfb04abb12c4562db1359975ab9c327c19698bf901d159536da465e61
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3759706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86379428d4eb24a8bc769f0b1917eeef2e0b53b1e235f6dc8c54e01f41ae5da3`

```dockerfile
```

-	Layers:
	-	`sha256:f29055aa2eb2c352488097121a1fd3954d016aa3cbe02a6bd8a93798d00ff34f`  
		Last Modified: Mon, 01 Dec 2025 23:47:43 GMT  
		Size: 3.7 MB (3734456 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4fc4f38559883b1b7b7401e68fa7c2b9d79ae30051ea8236ef99f078b3449647`  
		Last Modified: Mon, 01 Dec 2025 23:47:44 GMT  
		Size: 25.2 KB (25250 bytes)  
		MIME: application/vnd.in-toto+json
