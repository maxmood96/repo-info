...
### `ibm-semeru-runtimes:open-11.0.30_7-jdk` - linux; amd64
...
### `ibm-semeru-runtimes:open-11.0.30_7-jdk` - unknown; unknown
...
### `ibm-semeru-runtimes:open-11.0.30_7-jdk` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-11.0.30_7-jdk` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-11.0.30_7-jdk` - linux; s390x
