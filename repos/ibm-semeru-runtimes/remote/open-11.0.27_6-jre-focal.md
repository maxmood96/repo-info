...
### `ibm-semeru-runtimes:open-11.0.27_6-jre-focal` - linux; amd64
...
### `ibm-semeru-runtimes:open-11.0.27_6-jre-focal` - unknown; unknown
...
### `ibm-semeru-runtimes:open-11.0.27_6-jre-focal` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-11.0.27_6-jre-focal` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-11.0.27_6-jre-focal` - linux; s390x
