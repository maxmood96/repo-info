...
### `ibm-semeru-runtimes:open-17.0.11_9-jre-jammy` - linux; amd64
...
### `ibm-semeru-runtimes:open-17.0.11_9-jre-jammy` - unknown; unknown
...
### `ibm-semeru-runtimes:open-17.0.11_9-jre-jammy` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-17.0.11_9-jre-jammy` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-17.0.11_9-jre-jammy` - linux; s390x
