...
### `ibm-semeru-runtimes:open-11.0.13_8-jre-focal` - linux; amd64
...
### `ibm-semeru-runtimes:open-11.0.13_8-jre-focal` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-11.0.13_8-jre-focal` - linux; s390x
