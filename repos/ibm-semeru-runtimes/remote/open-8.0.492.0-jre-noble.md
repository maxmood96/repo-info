## `ibm-semeru-runtimes:open-8.0.492.0-jre-noble`
...
### `ibm-semeru-runtimes:open-8.0.492.0-jre-noble` - linux; amd64
...
### `ibm-semeru-runtimes:open-8.0.492.0-jre-noble` - unknown; unknown
...
### `ibm-semeru-runtimes:open-8.0.492.0-jre-noble` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-8.0.492.0-jre-noble` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-8.0.492.0-jre-noble` - linux; s390x
