...
### `ibm-semeru-runtimes:open-8u432-b06-jdk-focal` - linux; amd64
...
### `ibm-semeru-runtimes:open-8u432-b06-jdk-focal` - unknown; unknown
...
### `ibm-semeru-runtimes:open-8u432-b06-jdk-focal` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-8u432-b06-jdk-focal` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-8u432-b06-jdk-focal` - linux; s390x
