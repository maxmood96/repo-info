...
```console
$ docker pull ibm-semeru-runtimes@sha256:eb1e3c803a8788ee8c1d0cfb46534d9d94760af207db7e7ec682027b03590171
```
...
```console
$ docker pull ibm-semeru-runtimes@sha256:6a3eb3d1ccd592c7a1849f3135bd7092a01a0a049825bf2796371ef7dd454b42
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.2 MB (262241481 bytes)**  
...
### `ibm-semeru-runtimes:open-11.0.23_9-jdk-focal` - unknown; unknown

```console
$ docker pull ibm-semeru-runtimes@sha256:b7b06bbf2cd71eada528d4326a8febb73761777f803adddb5be9c084581440a7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3462023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b559046caaa0dcd182f358f2eacb36ee500de37502ab056cbd20b06a60bb649`

```dockerfile
```

-	Layers:
	-	`sha256:8d83bf5e8ca2da89d66cafdfdd10caf224718ec645e400d9d41f6c1b8a060879`  
		Last Modified: Tue, 25 Jun 2024 22:57:58 GMT  
		Size: 3.4 MB (3438251 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c240adfedefa06b3c1f9f8e4986ed604b179bd7573a38ec06986345aa46ee37f`  
		Last Modified: Tue, 25 Jun 2024 22:57:58 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:6337a5d97a7990940dd42130457e2f2bdf6f35f079c2f997ae9fabbd8ae6c6e6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.1 MB (252147472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3a0625f8be526f6615677490d1033e28657910e71939c16190858acf768fd6a`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:de91fc8645e1967918353de8e6975d4fa2c57fb66eab36975a07b0c844a92c8d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3462546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:362b7e7f8abcad6a27cb51fef9e34f96b268e6abb200958f4bce15a3dbed122e`

```dockerfile
```

-	Layers:
	-	`sha256:f757d0a84f078b58ce2395304667ca6359409c6c24987e9cde60afa55c149a9e`  
		Last Modified: Tue, 25 Jun 2024 23:09:16 GMT  
		Size: 3.4 MB (3438497 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:9ae2065c965387ff900cdca97c20267f697239d0a683d44ee13bb154da0aa962`  
		Last Modified: Tue, 25 Jun 2024 23:09:15 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:67d0eecdb9bada1fedecb360d105b118044ef1ae2fca6223cd619900cd75cf41
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.6 MB (269590819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b01782fd478f874b0066d7ce618a67764d78d6b4d53c76074589c084dcd3469`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:a7176ffcc14461338d6ca240bae7c7107db7f7fe70337902dc4e5a1e08ec248f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3466488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7f5cc97aad1010bcc073001a44fea3e95bf40f39a72dbcba846933d20176235`

```dockerfile
```

-	Layers:
	-	`sha256:3faaa47208e8a15e86b0f40a014d3ab0f038932bfbb9823e244d21a4e0094bbd`  
		Last Modified: Tue, 25 Jun 2024 23:12:32 GMT  
		Size: 3.4 MB (3442686 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:739fc17f2cb9a4d3ea986b129a8914da1910891a695103557d381f5fceddee17`  
		Last Modified: Tue, 25 Jun 2024 23:12:32 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:a68e3d1fe87dfa348bf08a6464e631d57a412c04ee44209b15a853476d628a48
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.1 MB (258118396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abca4d07f6344cbe8ed7d135ecdcc8d901f7a6f37fe8ce28d4c468333ac583ee`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:295249d3ece5c049d7d58211e3df3c08008ea675f4ad8849c42a533fffb2eeff
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3462490 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:322809de66013da645748af3d62806adebcf6910c9eef9cb15d6c8c7098b2709`

```dockerfile
```

-	Layers:
	-	`sha256:3bf4adc3e0569d7890e9368f3e9603863a31492aa7680b5b576959b78be8e941`  
		Last Modified: Tue, 25 Jun 2024 23:06:30 GMT  
		Size: 3.4 MB (3438718 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c77c11cde0d9273e4342a2608c5edbb0b41a2bb86b765cb0dc949da190b73b84`  
		Last Modified: Tue, 25 Jun 2024 23:06:30 GMT  
		Size: 23.8 KB (23772 bytes)  
		MIME: application/vnd.in-toto+json
