...
### `ibm-semeru-runtimes:open-8u482-b08-jre-noble` - linux; amd64
...
### `ibm-semeru-runtimes:open-8u482-b08-jre-noble` - unknown; unknown
...
### `ibm-semeru-runtimes:open-8u482-b08-jre-noble` - linux; arm64 variant v8
...
### `ibm-semeru-runtimes:open-8u482-b08-jre-noble` - linux; ppc64le
...
### `ibm-semeru-runtimes:open-8u482-b08-jre-noble` - linux; s390x
