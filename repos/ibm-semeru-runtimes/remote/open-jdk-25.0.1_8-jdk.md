...
```console
$ docker pull ibm-semeru-runtimes@sha256:b597266e56bd857c5a7fa9952419bb434e6d18d90733ef992556751f171e7f28
```
...
```console
$ docker pull ibm-semeru-runtimes@sha256:8650a9cfc13dc9742cf2f532ff2b874122b912c6b49ebb74c82df6095ae01708
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.6 MB (296586919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5ac04f89d21ab152651a4fd0b0e3fbecae2ffed6622960d5f8b20d13d31b4fa`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:b313674dfe7a451c3e0dc9e983d3440549722d6f772d32c08a61878bfd6eda06
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.3 MB (3275816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91e53cfcce077e01ad80ba13cb95c0f20593005ea0b2acd9c983273c469b410f`

```dockerfile
```

-	Layers:
	-	`sha256:f44cfd6668b080501049ca528176fdc70a2d4263d6dc65d27e67a8a201c30802`  
		Last Modified: Mon, 01 Dec 2025 23:48:00 GMT  
		Size: 3.2 MB (3249865 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:07cfcd60bd7a0cdb7be4e38bba8e0792b58db5b7f960692601d2c50789202fd3`  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:d7f4f5b70d542c52cdb2da7e534bbe9ed0293d4c4cac491080570277ebb100e2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.7 MB (291652534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14359cf3b1bd0166ea10061f471a281f6ccbf887b1c9bf8896a88a7b7fd6977b`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:907bd2a07d7a2b88652223c614de17c4083790490b1f9c983cd64d659bad1bc3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.3 MB (3275139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ec5b77a4a1bfaf7cf736b52b86f37b8cc612b56c7febacf6105c129b92bc8dd`

```dockerfile
```

-	Layers:
	-	`sha256:4cce339ea4fa950ba462e4414b32636f29619f04a118872ce40542138295ec45`  
		Last Modified: Mon, 01 Dec 2025 23:48:06 GMT  
		Size: 3.2 MB (3249054 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:22766c42a7c04d3069882acf15f8991e75bb00061849c7c1557eecd02e1b9b4b`  
		Last Modified: Mon, 01 Dec 2025 23:48:06 GMT  
		Size: 26.1 KB (26085 bytes)  
		MIME: application/vnd.in-toto+json

### `ibm-semeru-runtimes:open-jdk-25.0.1_8-jdk` - linux; ppc64le

```console
$ docker pull ibm-semeru-runtimes@sha256:ee3b4da300e4cb141bb08e175963421143115a7856897b26ff0fe94ed10d29e6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.7 MB (304652935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42ed910fc7312e4130bd3faaa82ca4a4d81c748817ffa57337ac4b7b11da7514`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:b901e643575b75848c7a527eac76e4a0311e365b7d68e9e04696886ddb8afa82
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.3 MB (3280504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0dad9a34767336a77984ce0206cd2b342c3b42065b8547b27a081a053b4ed53a`

```dockerfile
```

-	Layers:
	-	`sha256:22e995c17c5ededb2ef7d73db5749d513610c3a1cabb0f0839560ef7a5959074`  
		Last Modified: Mon, 01 Dec 2025 23:48:11 GMT  
		Size: 3.3 MB (3254505 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:22019c608dfe98eab09208994d5905429014b40fca3b20bb81c6da1a873d4e57`  
		Last Modified: Mon, 01 Dec 2025 23:48:12 GMT  
		Size: 26.0 KB (25999 bytes)  
		MIME: application/vnd.in-toto+json

### `ibm-semeru-runtimes:open-jdk-25.0.1_8-jdk` - linux; s390x

```console
$ docker pull ibm-semeru-runtimes@sha256:1e69726eca19f818c90a47523381c6cab8e641240fe989d5b930bc3ec6cda160
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **294.9 MB (294942193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14e5945c1349716685c9145425351ed81eaf6b413d0b37b9cc350fe67f3a1f76`
-	Default Command: `["jshell"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:9e282562037b1734dd72f44c1fdbd9ed1b678ac4cf7e98d0207104c1aff126e0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.3 MB (3278640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fe824efbb50ee573f5df9ffe72da34f65301fb270c3224f03d9edb3be3f5d74`

```dockerfile
```

-	Layers:
	-	`sha256:ed79c6e9d57e687afb17d2c328b9bd0e5968890b1dd1712181c341797960aa6b`  
		Last Modified: Mon, 01 Dec 2025 23:48:17 GMT  
		Size: 3.3 MB (3252689 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d3ff91d013e21da54605047258d21d51a7c44b6cc5d87144a02c0616013ab50c`  
		Last Modified: Mon, 01 Dec 2025 23:48:17 GMT  
		Size: 26.0 KB (25951 bytes)  
		MIME: application/vnd.in-toto+json
