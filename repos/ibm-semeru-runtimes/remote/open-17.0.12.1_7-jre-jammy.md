...
```console
$ docker pull ibm-semeru-runtimes@sha256:8c8165127df61e2464827b226438e0f9ff988a74f0bab6605d4e7d69dde56b1c
```
...
```console
$ docker pull ibm-semeru-runtimes@sha256:676b4ea9243fe0799e2bfeb443c8f5362bd82098b7bc7ac2b8b606a4f4d5fd5f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.1 MB (98124326 bytes)**  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:3181fc24737bf816e505a85622bdeeb8a650ec4ec75f3bb795c7e442dc1fe979
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.9 KB (26879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad648558d9d79bb04fa39e61f1d193c5d8d361210e3ea5fdac98edbd288bd07a`

```dockerfile
```

-	Layers:
	-	`sha256:d32747e1847d537a37d7c667e17076950b42d7e5e8aabeebd6a2d0d49774c612`  
		Last Modified: Thu, 19 Sep 2024 20:01:39 GMT  
		Size: 2.4 KB (2439 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:529197267f292c33af42beb236472a660ac647cc8efdab3ef831e2f40546bae3`  
		Last Modified: Thu, 19 Sep 2024 20:01:39 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:bf31349228adbef0f195dde064ca438647e825cc7c7cc31e36acd8c67d4e2ca9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.1 MB (92052562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99257d524403f6ea9463382a9c2444ae18fbcf3cd878a61319b4397b90e91b19`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:2a58fb9eeb726d41dbbeee0ca1ec16084161c3d07f5dd120f553b5306ceb8e3f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3484567 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1972599f93ba9617be818e2b366621f7d6f4ecb143dc34838f45d4c03dc3b498`

```dockerfile
```

-	Layers:
	-	`sha256:a55f3b739c656d17810a3cd44dcb7a25861446b168390142adf1bc4b1c093473`  
		Last Modified: Thu, 19 Sep 2024 20:11:28 GMT  
		Size: 3.5 MB (3459827 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0713f923d6621476134b7020e41d2e2ba79fcd4b082ab7775383fa4cf5d107cd`  
		Last Modified: Thu, 19 Sep 2024 20:11:27 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:19d8be288b089b0c427b7b62adac9b2beb6cefb8d4ede2eeea0d350e649cd154
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.2 MB (104235047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95fda07ca34b964507dcabf04344bd06a465309067fe1eadbd9620ceb792a2d4`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:efe23620b97cf578538121fe6f2a76bf12100213976c1e5d182645768003769d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3488520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:236c116ed049c7903892f82fec398a32d8202cf1eebfde4e70f21bda06a4784c`

```dockerfile
```

-	Layers:
	-	`sha256:36af2f3fc207d3950deb26744a4cf45fba6e682ea53ad192ab2cece42cefee46`  
		Last Modified: Thu, 19 Sep 2024 20:15:51 GMT  
		Size: 3.5 MB (3464038 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e3506d956b4aa22cd07295f8b94c44bd1797895068347fb42ba00df4538084fd`  
		Last Modified: Thu, 19 Sep 2024 20:15:50 GMT  
...
```console
$ docker pull ibm-semeru-runtimes@sha256:80472f7e5566d84b6f945fff2183d532c07f4de88994db4057a8787579e229df
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **95.7 MB (95709325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f076703035afc15fe8080430acaee9d65bc54ac16641a90a4f699098374d3a5`
-	Default Command: `["\/bin\/bash"]`
...
```console
$ docker pull ibm-semeru-runtimes@sha256:78740fe337098d26aeedcac7b4fd4c1a3820fbdbe901094190d3593ba1efdfd3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3485103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2a22fd0d471c75780e27eb2dace5c89f97633c05888ecbdc8e7c0a63dcb431a`

```dockerfile
```

-	Layers:
	-	`sha256:90a1a56ef32fa586593f76824d8bb779995b836021d173971612113d81cb85b9`  
		Last Modified: Thu, 19 Sep 2024 20:15:44 GMT  
		Size: 3.5 MB (3460663 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:dfc4b4b1a7b2ed035236376b2c043e840df4595d72fa67d0fb3134460311aba5`  
		Last Modified: Thu, 19 Sep 2024 20:15:44 GMT  
		Size: 24.4 KB (24440 bytes)  
		MIME: application/vnd.in-toto+json
