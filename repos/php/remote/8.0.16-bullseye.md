...
```console
$ docker pull php@sha256:63f77bc6c06cd36e73bdee5cc875913f9093c002347bfae4ba1fdbf98dade68a
```
...
### `php:8.0.16-bullseye` - linux; amd64
...
### `php:8.0.16-bullseye` - linux; arm variant v5
...
### `php:8.0.16-bullseye` - linux; arm variant v7
...
### `php:8.0.16-bullseye` - linux; arm64 variant v8
...
### `php:8.0.16-bullseye` - linux; mips64le
...
### `php:8.0.16-bullseye` - linux; ppc64le
...
### `php:8.0.16-bullseye` - linux; s390x
