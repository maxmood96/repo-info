...
```console
$ docker pull php@sha256:b5e599794f8fe243e9615b25744fd370434fccfa3db3fa548c1719cc354fb076
```
...
### `php:8.0.2-fpm` - linux; arm variant v5
...
### `php:8.0.2-fpm` - linux; arm variant v7
...
### `php:8.0.2-fpm` - linux; arm64 variant v8
