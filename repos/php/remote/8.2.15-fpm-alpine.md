...
```console
$ docker pull php@sha256:9f358983faaf1b5902ef9e6303ebc863b9be793a13e66094e366732c20fe3e7e
```
...
```console
$ docker pull php@sha256:b0c1d3cdbce2a0d336b195b23f42514b0786534a2d6ef5b07f327b0036049d9a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.9 MB (30909433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9636e7989622950fb2447a95a531b06e87947d4f8bbea2d2c656e7f1853ae20`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
