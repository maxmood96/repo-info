...
```console
$ docker pull php@sha256:c7ebac8254c65db28148ecb535277b7cfb8fe6fb002744996524b5934b913574
```
...
### `php:8.3.6-apache-bullseye` - linux; arm variant v7
...
### `php:8.3.6-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.6-apache-bullseye` - linux; 386
