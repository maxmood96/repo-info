...
```console
$ docker pull php@sha256:798c12c8e065a857ac21f0b921718f85a9d365057d9fde0acb43e6dc2be4db21
```
...
### `php:8.3.12-zts-alpine` - linux; amd64
...
### `php:8.3.12-zts-alpine` - linux; arm variant v6
...
### `php:8.3.12-zts-alpine` - linux; arm variant v7
...
### `php:8.3.12-zts-alpine` - linux; arm64 variant v8
...
### `php:8.3.12-zts-alpine` - linux; 386
...
### `php:8.3.12-zts-alpine` - linux; ppc64le
...
### `php:8.3.12-zts-alpine` - linux; s390x
