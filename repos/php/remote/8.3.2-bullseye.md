...
```console
$ docker pull php@sha256:4555e95d0eb3cb2ade6411a1a4f0f660edfe6123b4af480aa050f5df5c38c6cd
```
...
### `php:8.3.2-bullseye` - linux; amd64
...
### `php:8.3.2-bullseye` - linux; arm variant v5
...
### `php:8.3.2-bullseye` - linux; arm variant v7
...
### `php:8.3.2-bullseye` - linux; arm64 variant v8
...
### `php:8.3.2-bullseye` - linux; ppc64le
...
### `php:8.3.2-bullseye` - linux; s390x
