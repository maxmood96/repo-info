...
### `php:8.0.9-bullseye` - linux; arm variant v7
...
### `php:8.0.9-bullseye` - linux; mips64le
...
### `php:8.0.9-bullseye` - linux; ppc64le
...
### `php:8.0.9-bullseye` - linux; s390x
