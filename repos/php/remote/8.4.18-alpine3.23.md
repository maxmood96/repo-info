...
```console
$ docker pull php@sha256:e7a697a15a5421332526bcaef45b52fffebf3bc1a52974c85d879bf80638e48e
```
...
### `php:8.4.18-alpine3.23` - linux; amd64
...
### `php:8.4.18-alpine3.23` - unknown; unknown
...
### `php:8.4.18-alpine3.23` - linux; arm variant v6
...
### `php:8.4.18-alpine3.23` - linux; arm variant v7
...
### `php:8.4.18-alpine3.23` - linux; arm64 variant v8
...
### `php:8.4.18-alpine3.23` - linux; 386
...
### `php:8.4.18-alpine3.23` - linux; ppc64le
...
### `php:8.4.18-alpine3.23` - linux; s390x
