...
```console
$ docker pull php@sha256:a99eb73fc250fae341399a14960aa4b4ca6b2c0c141890b85de161488be3e424
```
...
### `php:8.4.15-fpm` - unknown; unknown
...
### `php:8.4.15-fpm` - linux; arm variant v5
...
### `php:8.4.15-fpm` - linux; arm variant v7
...
### `php:8.4.15-fpm` - linux; arm64 variant v8
