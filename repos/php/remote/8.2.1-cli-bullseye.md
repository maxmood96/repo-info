...
```console
$ docker pull php@sha256:fe08ec9931abbfce0d22da856b87db58b80699869435c741ff2bf0ebc6ebc55f
```
...
### `php:8.2.1-cli-bullseye` - linux; amd64
...
### `php:8.2.1-cli-bullseye` - linux; arm variant v5
...
### `php:8.2.1-cli-bullseye` - linux; arm variant v7
...
### `php:8.2.1-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.2.1-cli-bullseye` - linux; 386
...
### `php:8.2.1-cli-bullseye` - linux; mips64le
...
### `php:8.2.1-cli-bullseye` - linux; ppc64le
...
### `php:8.2.1-cli-bullseye` - linux; s390x
