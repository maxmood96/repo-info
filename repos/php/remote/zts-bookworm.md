...
```console
$ docker pull php@sha256:3324a6a447acfb5fed14f31f1a2ffde3c4f797eadcefa54805a877cf1518031e
```
...
```console
$ docker pull php@sha256:5d4430bb9fb20d911e97b4c142eb33af5b6af214a67e78bf2848a428e7dd3f6b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162313377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c596b2fe1aaa36208eee8a9a13a628f114ada16ea6941f66426632d584382736`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:8f2575063a413fc9043ba89004ab7840e5037b402dca2a7cbc1b93318c66ee56`  
		...
		Size: 488.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:adb287f6d1c91ba6602bff2eeb4e777484bfb74f215341b203ae5afe8411940a`  
		Last Modified: Tue, 18 Mar 2025 13:51:26 GMT  
		Size: 39.4 MB (39437817 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f34998ce7c722843b983c3d19f66013ed62ad28b291b8dcb6d6a345293975df2`  
		Last Modified: Tue, 18 Mar 2025 13:51:22 GMT  
		Size: 2.5 KB (2450 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:28a749e1c9782900091c53a4db3740e17e7ef907f400353483901a1ebbb5ccc8`  
		Last Modified: Tue, 18 Mar 2025 13:51:23 GMT  
		Size: 249.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull php@sha256:91d8bac1362301e865330af64c8680b0e66251f0df244a6eff0e14a143e6ade8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.6 KB (40650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f560d322f2eaf6c69c942f55284f8affca7af1bb5670799d6f383b667a009843`

```dockerfile
```

-	Layers:
	-	`sha256:3933919efeaa2c66a9ecb5e911a9b843bcc4dd2fc49c000be5c2399620456755`  
		Last Modified: Tue, 18 Mar 2025 13:51:21 GMT  
