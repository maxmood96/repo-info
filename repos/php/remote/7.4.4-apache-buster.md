...
```console
$ docker pull php@sha256:eed050a241c5d24a912e1a5a6b37fec3eac8ede28c005d9471f2cfe4facd93fb
```
...
### `php:7.4.4-apache-buster` - linux; amd64

```console
$ docker pull php@sha256:7b2edc7f08e1908d0e3721f8e677e8c31f1b5f163537684c540e46f3f2c6a64c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.8 MB (146834113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9ac5626debedc99890a36741393c20983cd05626505398a0df2c26801e8f2c7`
...
```console
$ docker pull php@sha256:7be39bb2e62ca77b7b0d575af5e6287aaea6019aa39166c0bd964bad67025843
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.2 MB (125155977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:065dd949521d7e0c48eb168073a267fca9705117703f1d9761581d640a4a8f41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.4-apache-buster` - linux; arm variant v7

```console
$ docker pull php@sha256:e904061ea12de510ff010607a5e7fa4814ad63c5d3de40eefab9d73ec8f95db5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.5 MB (122489302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:294b9a2335001e3cb7f262da7a24361b351ed1dd951750f292276c703e145224`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull php@sha256:fbcbb4060ce9196cbf90116e08a47895771a62d1643f087cca752b1b37f349b0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.0 MB (138951239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79020ae14eae0a517ff91b4dd3b296f287d772068acf177db76d78661e2e960f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.4-apache-buster` - linux; 386

```console
$ docker pull php@sha256:225a4b5e56fcbe19cc42691127e7d099ea598491e9bc5308fe5df552d99ea298
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.8 MB (152809713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:160bff266267d461231f0a4a5f1cb7ef9506aad88ea730f3ba39308c6026b262`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.4-apache-buster` - linux; ppc64le

```console
$ docker pull php@sha256:efe3ae7248a5f31d1a6fac907d06c199f8e437cbeed73034ad6704381d7876f7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158047026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7d83d9f81a530c0aa807720ef9b63d62123ecc56c792eaed1182b165cb5c16a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
