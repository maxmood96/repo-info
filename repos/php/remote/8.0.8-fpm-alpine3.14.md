...
```console
$ docker pull php@sha256:bb8bcd0f85602aff78f7716a368df3232ffadc323a9d9dc29ef1059258f8b761
```
...
### `php:8.0.8-fpm-alpine3.14` - linux; amd64
...
### `php:8.0.8-fpm-alpine3.14` - linux; arm variant v6
...
### `php:8.0.8-fpm-alpine3.14` - linux; arm variant v7
...
### `php:8.0.8-fpm-alpine3.14` - linux; arm64 variant v8
...
### `php:8.0.8-fpm-alpine3.14` - linux; 386
...
### `php:8.0.8-fpm-alpine3.14` - linux; ppc64le
