...
```console
$ docker pull php@sha256:0e82e85d8c5d5111f173477a3747651850a3c0342408feb2aa0740e0ea44ffc1
```
...
### `php:7.4.18-alpine` - linux; arm variant v6
...
### `php:7.4.18-alpine` - linux; arm variant v7
...
### `php:7.4.18-alpine` - linux; arm64 variant v8
