...
### `php:8.5.0-alpine` - unknown; unknown
...
### `php:8.5.0-alpine` - linux; arm variant v6
...
### `php:8.5.0-alpine` - linux; arm variant v7
...
### `php:8.5.0-alpine` - linux; arm64 variant v8
...
### `php:8.5.0-alpine` - linux; ppc64le
...
### `php:8.5.0-alpine` - linux; riscv64
