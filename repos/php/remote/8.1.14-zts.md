...
```console
$ docker pull php@sha256:8299519e2123f08c2feb7b24fd6d92adaa20a676c530852f27e0106a7f11c5f3
```
...
### `php:8.1.14-zts` - linux; arm variant v5
...
### `php:8.1.14-zts` - linux; arm variant v7
...
### `php:8.1.14-zts` - linux; arm64 variant v8
