...
```console
$ docker pull php@sha256:6f32ad195b256e8533ba24f776e33400d8e6f52f73b43d413188877b03bff84a
```
...
```console
$ docker pull php@sha256:d2b854d8e8fb361f5281ff5c3244148fa7bc42316d23066984587aae4acee89c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.4 MB (29428386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75612169ea9451753f56ce032897d2d1f4a98e52b2d2e43d90ebfd8e87ae7395`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:c59568ca18cf7789cd668bbdc676736c0229a976da28533dc4ebdfeb45a170aa
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.3 MB (28289313 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03e61941111fc3a6750d6b286ae509a9e988c73f5393601d7fb1a4519b215e1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:6b30621a4d4aacee4f9104883d3630ec9b124bb7c7e14bff1abcf999f0c67a8f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30313104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee6ee1d762b491afed69be5e9c009d6f3479b71abf6521f1eed16871d4ebff87`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:b71baba1db6c926c24942e55278dd828086b927f5c4a96f8c3dd2138bc3d7a68
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.1 MB (31128496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:774c40a0f7550c7e39d9a4a7341442ff45d07985a7e65f782a2468c6ba0e336c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:785a7b30c6cf1f74703951336a5b97638c5ed67dbb141d9cc4071dc355a575a8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29839969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:493994d34047a80c3a85363663a9bcdbb0e3f9538be7d930097909da7039d129`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
