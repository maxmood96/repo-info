...
```console
$ docker pull php@sha256:4e19643665d21aaf93b5e07c9d787b27a05ce406b1546edad95599835acc7314
```
...
```console
$ docker pull php@sha256:0b2d8a23ae196a6a214b4138e3f3376a7a7131dd5797dff50ef2ecb5ea77a84e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31520590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4440027a4d4d1e83f95adeb4f61ca560c338db74c8d39574ac565100f4b4196`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
