...
```console
$ docker pull php@sha256:0d77085dbf121cfbd8da7ef09e818d5325b3551d2c2bd6dccd096403137f64ee
```
...
### `php:8.3.3-fpm-bookworm` - linux; amd64
...
### `php:8.3.3-fpm-bookworm` - linux; 386
...
### `php:8.3.3-fpm-bookworm` - linux; s390x
