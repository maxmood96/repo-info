...
```console
$ docker pull php@sha256:144cf0691392cb77f7c21d80484f8582483d367841afba034991599001b1278c
```
...
### `php:8.3.6-zts-alpine3.19` - linux; arm variant v6
...
### `php:8.3.6-zts-alpine3.19` - linux; arm variant v7
...
### `php:8.3.6-zts-alpine3.19` - linux; 386
