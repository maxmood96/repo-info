...
```console
$ docker pull php@sha256:c1e9ccde1e98c1ed498cde7e3b6e5a30ace88bee015cecc3395c2ac5058c4f1b
```
...
### `php:8.1.24RC1-apache` - linux; amd64
...
### `php:8.1.24RC1-apache` - linux; arm variant v5
...
### `php:8.1.24RC1-apache` - linux; arm variant v7
...
### `php:8.1.24RC1-apache` - linux; arm64 variant v8
...
### `php:8.1.24RC1-apache` - linux; 386
...
### `php:8.1.24RC1-apache` - linux; mips64le
...
### `php:8.1.24RC1-apache` - linux; ppc64le
...
### `php:8.1.24RC1-apache` - linux; s390x
