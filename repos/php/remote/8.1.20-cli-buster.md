...
```console
$ docker pull php@sha256:29e502883ff243a065ccb36186ba2f12ff5940267128a1b38fd5c4df06e1ea4a
```
...
### `php:8.1.20-cli-buster` - linux; amd64
...
### `php:8.1.20-cli-buster` - linux; arm variant v7
...
### `php:8.1.20-cli-buster` - linux; arm64 variant v8
...
### `php:8.1.20-cli-buster` - linux; 386
