...
### `php:8.2.23-bookworm` - linux; amd64
...
### `php:8.2.23-bookworm` - linux; arm variant v7
...
### `php:8.2.23-bookworm` - linux; mips64le
...
### `php:8.2.23-bookworm` - linux; ppc64le
