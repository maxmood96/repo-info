...
```console
$ docker pull php@sha256:465e699dd7634d28aabb0fdb8dae1a8e227b8a5a55e992292a1636c8275316b8
```
...
### `php:8.1.11RC1-apache-buster` - linux; amd64
...
### `php:8.1.11RC1-apache-buster` - linux; arm64 variant v8
...
### `php:8.1.11RC1-apache-buster` - linux; 386
