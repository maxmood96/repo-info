...
```console
$ docker pull php@sha256:ab4ded8d05e10ea3c5758b6641312fcac228f9a4b50a2279556ec27db83493e6
```
...
### `php:7.4.15-zts-alpine3.12` - linux; amd64

```console
$ docker pull php@sha256:44039eae297a96a17637c29bc11a4f3a50abcba6076875625c972d4504c3867c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.3 MB (25261002 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf49a1c2b4c4b6b873f48713d728256eb1ce04d9bf9cc05dbd3faccd95c1ddfb`
...
# Thu, 04 Feb 2021 18:29:50 GMT
ENV PHP_VERSION=7.4.15
# Thu, 04 Feb 2021 18:29:51 GMT
...
-	Layers:
	...
	-	`sha256:4612e05a72cfb0fde0de7565baa2660900747122288141d8dba25482f4983fe0`  
		...
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fd7778401db24017b182722cf6d9160df79e3294d268238c3c35894aceb191d`  
		Last Modified: Thu, 04 Feb 2021 20:49:07 GMT  
		Size: 10.4 MB (10351197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:811eadc4ec3f73fa0d764efc9f8df91dbb0a62c4fdc0af71617256d0f3802e2b`  
		Last Modified: Thu, 04 Feb 2021 20:49:07 GMT  
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:774007970590d003e93e15fe08fb577da33fc4e4bff348eebe1877e383b8f0f0`  
		Last Modified: Thu, 04 Feb 2021 20:49:10 GMT  
		Size: 10.7 MB (10748729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:069959b0ffc90b37457a3588a3f246ddd352bbc56934d0d0ab29edb584075ee5`  
		Last Modified: Thu, 04 Feb 2021 20:49:06 GMT  
		Size: 2.3 KB (2267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6e69e37c8b07a0bc3156551dd5b9725944d072bcf391c42623084f977bcd2d2`  
		Last Modified: Thu, 04 Feb 2021 20:49:06 GMT  
...
### `php:7.4.15-zts-alpine3.12` - linux; 386

```console
$ docker pull php@sha256:5030f8b080cc7ff066977e149021050a46e879b692422bc6586e4d123c210dd5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.6 MB (25631582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca054cd828873c2d143639f3c953fd8de4468567813276fe6465f725ce82969f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 17 Dec 2020 03:58:41 GMT
ENV GPG_KEYS=42670A7FE4D0441C8E4632349E4FDC074A4EF02D 5A52880781F755608BF815FC910DEB46F53EA312
# Thu, 04 Feb 2021 19:07:23 GMT
ENV PHP_VERSION=7.4.15
# Thu, 04 Feb 2021 19:07:23 GMT
ENV PHP_URL=https://www.php.net/distributions/php-7.4.15.tar.xz PHP_ASC_URL=https://www.php.net/distributions/php-7.4.15.tar.xz.asc
# Thu, 04 Feb 2021 19:07:24 GMT
ENV PHP_SHA256=9b859c65f0cf7b3eff9d4a28cfab719fb3d36a1db3c20d874a79b5ec44d43cb8
# Thu, 04 Feb 2021 19:07:29 GMT
RUN set -eux; 		apk add --no-cache --virtual .fetch-deps gnupg; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apk del --no-network .fetch-deps
# Thu, 04 Feb 2021 19:07:29 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 04 Feb 2021 19:16:03 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 04 Feb 2021 19:16:04 GMT
COPY multi:efd917b98407edb5d558edb0edbd8e63c9318f701892aaa449794d019a092f37 in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:f25357089a74d7e4f4ee1bc77cd180c431537e393399785f113a7f2fe4ac7614`  
		...
		Size: 221.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:219ac200cdf2235630431050c296be62edbde9c0cd99a6458ae3cc1f70edc768`  
		Last Modified: Thu, 04 Feb 2021 21:20:01 GMT  
		Size: 10.4 MB (10351190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee862f9b0ac33b83f02d98951cbdad651e1097503fe743005849359161eb87fe`  
		Last Modified: Thu, 04 Feb 2021 21:20:00 GMT  
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9fe4680cb13125a609fc8e11abb2fb2c753001989f0751815230d4f3a0bcc2b`  
		Last Modified: Thu, 04 Feb 2021 21:20:06 GMT  
		Size: 11.0 MB (11025366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f14e99a51eebac2b6613d574f66ce7322d608fa00fcc2952f861d428d9f4cc6`  
		Last Modified: Thu, 04 Feb 2021 21:20:00 GMT  
		Size: 2.3 KB (2264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f36b8952ff2741128ca10d0cabba7a03df773df311bac06bcda454baa429cea`  
		Last Modified: Thu, 04 Feb 2021 21:20:00 GMT  
...
### `php:7.4.15-zts-alpine3.12` - linux; s390x
