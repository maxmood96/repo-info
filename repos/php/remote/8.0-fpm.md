...
```console
$ docker pull php@sha256:5e975111cb4900648667ec826d5ed0f9352e14f2164adf10ee1e8913efd067e6
```
...
```console
$ docker pull php@sha256:3cd0954c1f7188970673a0ab74ba8d6d9bdf343e84113d43d3753f2fd01ca821
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.7 MB (162674377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bd0d5ea75fcea21c77aa3822eeb73e9b6c7307a27df10e071fdb58a67eae609`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
