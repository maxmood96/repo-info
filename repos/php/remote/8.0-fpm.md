...
```console
$ docker pull php@sha256:a79847dc396dbf87b2fe54eec5c41d6883a8910ad9dcbd6d5619d5cd93d53445
```
...
```console
$ docker pull php@sha256:925af8e1ba2cabc456a1149cd9d04fb81f041c14db4b1e3ea4fbbf1d1cbdd24a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.3 MB (137327117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c6621d6d80caad2cfb2a9c08a7abeee9b064aaf6d019c6c58717bacf0f7a53f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
