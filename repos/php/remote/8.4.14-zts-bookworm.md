...
```console
$ docker pull php@sha256:bf23b8cdde2dff7d2ce2ff210b517533d1e66976c9401034f68610415b943052
```
...
### `php:8.4.14-zts-bookworm` - linux; amd64
...
### `php:8.4.14-zts-bookworm` - linux; arm variant v7
...
### `php:8.4.14-zts-bookworm` - linux; arm64 variant v8
...
### `php:8.4.14-zts-bookworm` - linux; ppc64le
...
### `php:8.4.14-zts-bookworm` - linux; s390x
