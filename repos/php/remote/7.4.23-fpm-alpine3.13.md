...
```console
$ docker pull php@sha256:231640f7b3034b2e685d7bd42cb6b82e1c14d3371fc12ea1a6746dc264a3a6be
```
...
```console
$ docker pull php@sha256:ed95ae4af6b3fee5b9ef5d34aae8b058aaf43cc0a485f9914877536ee65da4e9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.6 MB (28573664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a076d90f1c0ae25cb197526fc927ee4bccca59d374d16342a54034d5f9936756`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
