...
```console
$ docker pull php@sha256:019338ef51b98d5cb34e195c289c5e6242dfde4c45775af60172235a77742e45
```
...
### `php:8.0.30-zts-alpine3.16` - linux; amd64
...
### `php:8.0.30-zts-alpine3.16` - linux; arm variant v6
...
### `php:8.0.30-zts-alpine3.16` - linux; 386
...
### `php:8.0.30-zts-alpine3.16` - linux; ppc64le
...
### `php:8.0.30-zts-alpine3.16` - linux; s390x
