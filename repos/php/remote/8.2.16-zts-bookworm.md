...
```console
$ docker pull php@sha256:161cf962fa6e5524fd9b11cd465423a5ed625aa823ad883a5fadeaca4ec7fd9e
```
...
### `php:8.2.16-zts-bookworm` - linux; amd64
...
### `php:8.2.16-zts-bookworm` - linux; arm64 variant v8
...
### `php:8.2.16-zts-bookworm` - linux; 386
...
### `php:8.2.16-zts-bookworm` - linux; mips64le
...
### `php:8.2.16-zts-bookworm` - linux; s390x
