...
```console
$ docker pull php@sha256:302a95a470fcd202a4a08e4036f41f61ab53b4a652d99d3ae466310718e4a0d1
```
...
### `php:8.5.2-apache-trixie` - linux; amd64
...
### `php:8.5.2-apache-trixie` - unknown; unknown
...
### `php:8.5.2-apache-trixie` - linux; arm variant v5
...
### `php:8.5.2-apache-trixie` - linux; arm variant v7
...
### `php:8.5.2-apache-trixie` - linux; arm64 variant v8
...
### `php:8.5.2-apache-trixie` - linux; 386
...
### `php:8.5.2-apache-trixie` - linux; ppc64le
...
### `php:8.5.2-apache-trixie` - linux; s390x
