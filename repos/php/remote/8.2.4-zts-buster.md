...
```console
$ docker pull php@sha256:18b4144be7f585f7454db590f261c652999bac18d8aa1293b3a28739b0147787
```
...
### `php:8.2.4-zts-buster` - linux; arm variant v7
...
### `php:8.2.4-zts-buster` - linux; 386
