...
```console
$ docker pull php@sha256:eb3b17b0bfaa8fe2b8a2494c2e576aec0ba35e3fef1c0e6f8ef59c1a63dee6d9
```
...
### `php:7.2.32-fpm-alpine` - linux; amd64
...
### `php:7.2.32-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.2.32-fpm-alpine` - linux; ppc64le
