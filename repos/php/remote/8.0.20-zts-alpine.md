...
```console
$ docker pull php@sha256:dff826f77398bac3bf5eeebb133949b0cd1c8dc173ea0f94742e81f1e3bc1866
```
...
### `php:8.0.20-zts-alpine` - linux; arm variant v7
...
### `php:8.0.20-zts-alpine` - linux; arm64 variant v8
...
### `php:8.0.20-zts-alpine` - linux; ppc64le
...
### `php:8.0.20-zts-alpine` - linux; s390x
