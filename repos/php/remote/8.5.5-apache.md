...
```console
$ docker pull php@sha256:268b406b28dda0db7697bdc54569da0a640cece08c6efb58fa8139b28ae66157
```
...
### `php:8.5.5-apache` - unknown; unknown
...
### `php:8.5.5-apache` - linux; arm variant v5
...
### `php:8.5.5-apache` - linux; arm variant v7
...
### `php:8.5.5-apache` - linux; arm64 variant v8
...
### `php:8.5.5-apache` - linux; ppc64le
