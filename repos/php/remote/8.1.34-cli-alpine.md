...
```console
$ docker pull php@sha256:c5f34bd576afa3c8f3e5fca79efc2bbf34120783367f867ccf6539bcf70bec60
```
...
### `php:8.1.34-cli-alpine` - linux; amd64
...
### `php:8.1.34-cli-alpine` - unknown; unknown
...
### `php:8.1.34-cli-alpine` - linux; arm variant v6
...
### `php:8.1.34-cli-alpine` - linux; arm variant v7
...
### `php:8.1.34-cli-alpine` - linux; arm64 variant v8
...
### `php:8.1.34-cli-alpine` - linux; 386
...
### `php:8.1.34-cli-alpine` - linux; ppc64le
...
### `php:8.1.34-cli-alpine` - linux; s390x
