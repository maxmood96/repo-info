...
```console
$ docker pull php@sha256:6b2533aeafc38f754d7213114b8941d0e6974f0926e47746fe8ee3c9e26241f6
```
...
### `php:8-zts-alpine3.24` - linux; amd64
...
### `php:8-zts-alpine3.24` - unknown; unknown
...
### `php:8-zts-alpine3.24` - linux; arm variant v6
...
### `php:8-zts-alpine3.24` - linux; arm variant v7
...
### `php:8-zts-alpine3.24` - linux; arm64 variant v8
...
### `php:8-zts-alpine3.24` - linux; 386
...
### `php:8-zts-alpine3.24` - linux; ppc64le
...
### `php:8-zts-alpine3.24` - linux; s390x
