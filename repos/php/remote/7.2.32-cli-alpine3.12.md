## `php:7.2.32-cli-alpine3.12`

```console
$ docker pull php@sha256:c998f38ef150d66722de74910372633a03d30f9f27521618329421eff0836b03
```
...
### `php:7.2.32-cli-alpine3.12` - linux; amd64
...
### `php:7.2.32-cli-alpine3.12` - linux; arm variant v6
...
### `php:7.2.32-cli-alpine3.12` - linux; arm variant v7
...
### `php:7.2.32-cli-alpine3.12` - linux; arm64 variant v8
...
### `php:7.2.32-cli-alpine3.12` - linux; 386
...
### `php:7.2.32-cli-alpine3.12` - linux; ppc64le

```console
$ docker pull php@sha256:58b9f0db8fc34db2170daad513a06bb56f65462a6e91809bd576c1e848d6a855
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (32009633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd4a4334127df485231576dc936719c950ed92f79f9088b74f7d0a35f3aa232e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.2.32-cli-alpine3.12` - linux; s390x
