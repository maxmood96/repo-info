...
```console
$ docker pull php@sha256:fcd0999f164521b9d9f686cce4bbd4021c315d8856281a8aecef5d6668a033b4
```
...
### `php:8.3.1-zts-bullseye` - linux; arm variant v7
...
### `php:8.3.1-zts-bullseye` - linux; 386
