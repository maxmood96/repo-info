...
```console
$ docker pull php@sha256:9fcb0f5a47540f39f8a0755908498bd9950d818bdceea05669ed9a2060be3790
```
...
### `php:8.0.1-fpm-alpine` - linux; amd64
...
### `php:8.0.1-fpm-alpine` - linux; arm variant v6
...
### `php:8.0.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull php@sha256:b9e686061fdddf336933d7fd7ec547070724bfbe453429365bd51434dbe11ab5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.1 MB (27076736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fad75e95d59d5ad50d78d502942074d03b361e2a99fcd04a53c2a9c01b1f81ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull php@sha256:5786a1f58dd0c5b88944d17b72955b47f73e74c8fed51774d813c691f9f0a073
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.2 MB (29165193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b4d4480a16b72bc20bfc57e5e37989f924585975177fd1bbfb3b5e3751fc73f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.1-fpm-alpine` - linux; 386
...
### `php:8.0.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:9c4015f37f2571fee29686298f6cf8e422cae87d3baaea0a89c5092c53379bcd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30511891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:accdec1b92bd19abbc5fa24aeedef388c4c5086c43dd0a9ec7fc7ee289e1f3fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.1-fpm-alpine` - linux; s390x
