...
### `php:8.3.14-fpm-bullseye` - linux; amd64
...
### `php:8.3.14-fpm-bullseye` - unknown; unknown
...
### `php:8.3.14-fpm-bullseye` - linux; arm variant v7
...
### `php:8.3.14-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.3.14-fpm-bullseye` - linux; 386
