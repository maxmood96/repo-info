...
### `php:7.4.24-alpine3.14` - linux; amd64
...
### `php:7.4.24-alpine3.14` - linux; arm variant v7
...
### `php:7.4.24-alpine3.14` - linux; arm64 variant v8
...
### `php:7.4.24-alpine3.14` - linux; 386
...
### `php:7.4.24-alpine3.14` - linux; ppc64le
