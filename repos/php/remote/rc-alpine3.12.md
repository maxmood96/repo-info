...
```console
$ docker pull php@sha256:7688e27bdc624765b6329cd4aab32559daceefea4db8d05a2e56af7bbd517123
```
...
```console
$ docker pull php@sha256:fb8a7c962b3f879c84435ed48b45d3482e40dcb32dd3d272eeee1d6430ac360e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.4 MB (29417550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e4920aa7c3dc9c9f53115b8da57a3e057fccc9824f158db82ff780e7728edca`
...
# Thu, 22 Oct 2020 06:37:06 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 06:37:07 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 06:37:07 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:230439f765abca51d19362602aedfe7217300d5196074adde93ca0eb2345b2ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdc76a66634edefacba19159613f734ee34d8856a697c2bf566d5cfba9cc4775`  
		Last Modified: Thu, 22 Oct 2020 07:36:54 GMT  
		Size: 2.3 KB (2275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c61b292053ac1258930ac1bc2fcb7931325fc993be6d33ff7becfe870d5e55`  
		Last Modified: Thu, 22 Oct 2020 07:36:54 GMT  
...
```console
$ docker pull php@sha256:226484505ab2bf7a414309248aff4c4fa80997972b097cb1fbf1ac438910552d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.9 MB (27867997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:110a10561d394dede2cd9be016b8c7c106a0f3dfe6aa4a216a9a455e68b0f7cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Thu, 22 Oct 2020 06:45:55 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Thu, 22 Oct 2020 06:45:58 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 06:45:59 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 06:46:00 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:d99fdfcba7ac4d6760d197330f79c0cfc3bbb37449cc7e32315a9714325c12ba`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e74ed685c0784920ec5020ed987b70b79e88789dfb42268cc1f49737da353ff`  
		Last Modified: Thu, 22 Oct 2020 07:35:56 GMT  
		Size: 2.3 KB (2275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72552c23b1e4a7a3511db81eb2b57127a8fb7b1b25b6ca0a0f64872f7d98ba1a`  
		Last Modified: Thu, 22 Oct 2020 07:35:56 GMT  
...
```console
$ docker pull php@sha256:73bc66005b3d2eb75d05bacc3cb0b9201117a69ca5eb5e6baf463509e2ac5efc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.7 MB (26720082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7e0757f1db3eb1e9a9f6c203541306f4b15426a6a34e5823e80ca3d39ad7db8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Thu, 22 Oct 2020 06:51:02 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Thu, 22 Oct 2020 06:51:10 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 06:51:11 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 06:51:13 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:72b8eabdab00ba3ec55844d76936143667e973abbe22a3fd924a85016485df6c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82c39e3e2aae0e6a36100cb5070780fe80a1b0d526ee62983deebbb63cd41e40`  
		Last Modified: Thu, 22 Oct 2020 07:35:53 GMT  
		Size: 2.3 KB (2273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c22f1431289942ec42c9976bb679dc6eca5f177c48adc0c565e568b7cb45aac`  
		Last Modified: Thu, 22 Oct 2020 07:35:53 GMT  
...
```console
$ docker pull php@sha256:7015b5e7b74cf38bb33286bb6d7b2c95a401f2ffa6e8ccbce235d386a2266385
```
...
-	Total Size: **28.8 MB (28775512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88cf3d594455df9b2968380d63dc30ba66f06da226d2bdb8efd1e8022b812e4b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Thu, 22 Oct 2020 07:22:54 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Thu, 22 Oct 2020 07:22:57 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 07:22:57 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 07:22:58 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:2721e3f907624a1cccdd6366afcb079b50e9558721a008b4c674585ef3c1cb4c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a1c60ff583b3ccb259e350ebcd6c94ec51d9db69c9c101f4a28de06886f2006`  
		Last Modified: Thu, 22 Oct 2020 08:06:18 GMT  
		Size: 2.3 KB (2274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c4e0f168c6beccae98c10d8378a14136303f92b7227e9dec6a619e83dfd3fbd`  
		Last Modified: Thu, 22 Oct 2020 08:06:18 GMT  
...
```console
$ docker pull php@sha256:d1913e146eb32ce5837ce85e914e774afb49fa26a9624702fac8e74fced47b7b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29548706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a17cd996e048ad52a41cd7d0582cff44d13412ce3dac0e661409c2c930f0a71a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Thu, 22 Oct 2020 03:45:11 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Thu, 22 Oct 2020 03:45:12 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 03:45:12 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 03:45:12 GMT
...
-	Layers:
	...
	-	`sha256:eeda34d2162155a22afb9560f781b9fb2b00e28a453e6e2d007bbd0796f99f11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f85e671e13225e6780ebdc3bd6a92b2cdec355d26871d35028e4491b7c89041f`  
		Last Modified: Thu, 22 Oct 2020 05:10:20 GMT  
		Size: 2.3 KB (2276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9f39cd3346d07c2cce5c8b21ec75b37440b44d4c6984ac4d32cc52f425e909b`  
		Last Modified: Thu, 22 Oct 2020 05:10:20 GMT  
...
```console
$ docker pull php@sha256:3d132966fce5212ecc8c0fca470d4eb1520c1fbd2fd906f6ccdb4f367c73c838
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.1 MB (30132159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34e2be995df42eab3a0a8f0a75ee6e98264b0481bb793adb727416ad8e5d27ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Fri, 23 Oct 2020 00:26:59 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Fri, 23 Oct 2020 00:27:10 GMT
RUN docker-php-ext-enable sodium
# Fri, 23 Oct 2020 00:27:17 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 23 Oct 2020 00:27:29 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:f6bb4659ba439a26a978e5cbb4119d40fdb909eff1ea134b6559bc541b50fcdc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45b758aec4a543a56d9b2d45dbebc584a37e15987d5d512d6d88cb950a8b5324`  
		Last Modified: Fri, 23 Oct 2020 01:34:03 GMT  
		Size: 2.3 KB (2276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:191e7954786239a71a62ba4b8d4d8692532ed9ae5b150bad00f137a2063664da`  
		Last Modified: Fri, 23 Oct 2020 01:34:03 GMT  
...
```console
$ docker pull php@sha256:716077050eb01e49943f5ab754fbb658321cddc38b613600541445c41e4bee90
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.2 MB (28188515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab9000c2f572558a5539b60f8b791c65db5310c2c1c7371fb6443c50ff44a2d0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libedit-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		sqlite-dev 	; 		export CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		php --version
# Thu, 22 Oct 2020 04:39:03 GMT
COPY multi:cfe027e655535d9b3eb4b44f84eafb2e1d257620ca628247fe5c1c4fb008a78a in /usr/local/bin/ 
# Thu, 22 Oct 2020 04:39:04 GMT
RUN docker-php-ext-enable sodium
# Thu, 22 Oct 2020 04:39:05 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 22 Oct 2020 04:39:05 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:5d199f2ced01c9d31e37e93eb20c92357ddbdbc2359833b0cb33ab75e9ea8d8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cd1a1969150a6d5de4607cb245475a02fd2eb70b87d79773e5a0fb83ca0c90d`  
		Last Modified: Thu, 22 Oct 2020 05:29:07 GMT  
		Size: 2.3 KB (2273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36fef48fb2c8e72ad9f68e18a4ffcca6b870f7fa872b5a7d76320d8f21a1783b`  
		Last Modified: Thu, 22 Oct 2020 05:29:07 GMT  
		Size: 16.9 KB (16883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
