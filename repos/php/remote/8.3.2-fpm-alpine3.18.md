...
```console
$ docker pull php@sha256:8ecbbe9318252681e8aefb9030e2cba5cf521c4c1e55741bf315074dce31eda2
```
...
### `php:8.3.2-fpm-alpine3.18` - linux; amd64
...
### `php:8.3.2-fpm-alpine3.18` - linux; arm variant v6
...
### `php:8.3.2-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.3.2-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.3.2-fpm-alpine3.18` - linux; ppc64le
