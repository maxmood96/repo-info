...
```console
$ docker pull php@sha256:4ccde46815cb092657f3ac5d0f52a607e5f477a24be6969beef7eab6c3fb1159
```
...
### `php:8.2.11RC1-apache-bullseye` - linux; amd64
...
### `php:8.2.11RC1-apache-bullseye` - linux; arm variant v7
...
### `php:8.2.11RC1-apache-bullseye` - linux; 386
...
### `php:8.2.11RC1-apache-bullseye` - linux; mips64le
...
### `php:8.2.11RC1-apache-bullseye` - linux; ppc64le
