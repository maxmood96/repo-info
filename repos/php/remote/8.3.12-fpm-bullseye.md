...
```console
$ docker pull php@sha256:defe9951d08f988d2b2737769568c585997560650889aca868c29a543d3a0fad
```
...
### `php:8.3.12-fpm-bullseye` - linux; amd64
...
### `php:8.3.12-fpm-bullseye` - linux; arm variant v7
...
### `php:8.3.12-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.3.12-fpm-bullseye` - linux; ppc64le
...
### `php:8.3.12-fpm-bullseye` - linux; s390x
