...
```console
$ docker pull php@sha256:2e6d5cdb9280db79d7b481b492259a04b9edbf4d0f67f1111092e5b956757699
```
...
### `php:8.0.20-fpm-bullseye` - linux; mips64le
...
### `php:8.0.20-fpm-bullseye` - linux; ppc64le

```console
$ docker pull php@sha256:d21131eed36e79e15720e0486239a81ddf36b9ca062bde236bf486ae80ab3dc6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160083811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ca0237c3991dd0ce4977e0149c527af0a623ea2d17f95bddb49769454f72e9e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
