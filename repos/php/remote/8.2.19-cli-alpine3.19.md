...
```console
$ docker pull php@sha256:197c0d7e9ebc93c23c3558fd02ec171e538e188362e4003e1306cd7f77a0af79
```
...
### `php:8.2.19-cli-alpine3.19` - linux; amd64
...
### `php:8.2.19-cli-alpine3.19` - linux; arm variant v7
...
### `php:8.2.19-cli-alpine3.19` - linux; arm64 variant v8
...
### `php:8.2.19-cli-alpine3.19` - linux; ppc64le
...
### `php:8.2.19-cli-alpine3.19` - linux; s390x
