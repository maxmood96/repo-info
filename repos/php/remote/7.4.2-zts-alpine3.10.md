...
```console
$ docker pull php@sha256:5813a88732b45e08cefe73db7f63589f49b1514ce296d8582cd720b49cd58415
```
...
### `php:7.4.2-zts-alpine3.10` - linux; amd64
...
### `php:7.4.2-zts-alpine3.10` - linux; arm64 variant v8
...
### `php:7.4.2-zts-alpine3.10` - linux; 386
...
### `php:7.4.2-zts-alpine3.10` - linux; ppc64le
