...
```console
$ docker pull php@sha256:d0059b27ca040544317f66562844fc85d0f924302ec807c7e2cf6521841f34c3
```
...
### `php:8.0.16-fpm-alpine3.14` - linux; amd64
...
```console
$ docker pull php@sha256:18ffff3cd3dbf4a2616eceed29b33cbfb470086c89591b3874703821cc95e18b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.2 MB (26219786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e086b767b704542c05c17ae4e8a5b56b5630d02c6a9e53ffb84c2a606f0e5d86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.16-fpm-alpine3.14` - linux; arm variant v7
...
### `php:8.0.16-fpm-alpine3.14` - linux; arm64 variant v8
...
### `php:8.0.16-fpm-alpine3.14` - linux; 386
...
### `php:8.0.16-fpm-alpine3.14` - linux; ppc64le
...
### `php:8.0.16-fpm-alpine3.14` - linux; s390x
