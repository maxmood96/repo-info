...
```console
$ docker pull php@sha256:88e7cacda289c46415d3dd88c37cdaa8d0eb303f3bd870290860d7379ac030f5
```
...
### `php:8.3.1-zts` - linux; arm variant v5
...
### `php:8.3.1-zts` - linux; arm variant v7
...
### `php:8.3.1-zts` - linux; arm64 variant v8
