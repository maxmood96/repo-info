...
```console
$ docker pull php@sha256:90c6ae7bb43b106d8a616cbb0e6334662fb3a5a6bb4a8ce0aa214fa2008fe6dc
```
...
### `php:8.0.13-alpine3.14` - linux; amd64
...
### `php:8.0.13-alpine3.14` - linux; arm variant v7
...
### `php:8.0.13-alpine3.14` - linux; arm64 variant v8
...
### `php:8.0.13-alpine3.14` - linux; ppc64le
...
### `php:8.0.13-alpine3.14` - linux; s390x
