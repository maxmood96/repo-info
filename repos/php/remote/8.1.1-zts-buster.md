...
```console
$ docker pull php@sha256:acb0780208072efa3663343b0cc3398dc122c51c2fdfd62d6e3f9cc64f10892d
```
...
### `php:8.1.1-zts-buster` - linux; amd64
...
### `php:8.1.1-zts-buster` - linux; arm variant v5
...
### `php:8.1.1-zts-buster` - linux; arm variant v7
...
### `php:8.1.1-zts-buster` - linux; arm64 variant v8
...
### `php:8.1.1-zts-buster` - linux; mips64le
...
### `php:8.1.1-zts-buster` - linux; ppc64le
...
### `php:8.1.1-zts-buster` - linux; s390x
