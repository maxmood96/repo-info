...
```console
$ docker pull php@sha256:1d059ccb31fa548baca43d55c2f79d9a7320a0cc68c75430facf84c2683636b2
```
...
### `php:8.5.7-zts-alpine3.22` - linux; amd64
...
### `php:8.5.7-zts-alpine3.22` - unknown; unknown
...
### `php:8.5.7-zts-alpine3.22` - linux; arm variant v6
...
### `php:8.5.7-zts-alpine3.22` - linux; arm variant v7
...
### `php:8.5.7-zts-alpine3.22` - linux; arm64 variant v8
...
### `php:8.5.7-zts-alpine3.22` - linux; 386
...
### `php:8.5.7-zts-alpine3.22` - linux; ppc64le
...
### `php:8.5.7-zts-alpine3.22` - linux; s390x
