...
```console
$ docker pull php@sha256:2f2e299298604904d53da21926b34a142c65bc3af35537a13b1b2e65476098e4
```
...
### `php:8.3.0-alpine3.18` - linux; amd64
...
### `php:8.3.0-alpine3.18` - linux; arm variant v6
...
### `php:8.3.0-alpine3.18` - linux; arm variant v7
...
### `php:8.3.0-alpine3.18` - linux; arm64 variant v8
...
### `php:8.3.0-alpine3.18` - linux; 386
...
### `php:8.3.0-alpine3.18` - linux; ppc64le
...
### `php:8.3.0-alpine3.18` - linux; s390x
