...
### `php:8.3.8RC1-apache-bullseye` - linux; arm variant v7
...
### `php:8.3.8RC1-apache-bullseye` - linux; 386
...
### `php:8.3.8RC1-apache-bullseye` - linux; mips64le
...
### `php:8.3.8RC1-apache-bullseye` - linux; ppc64le
