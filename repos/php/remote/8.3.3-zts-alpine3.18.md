...
```console
$ docker pull php@sha256:fc16a77e865c9061ba3b8260bb5a87342869ea2bc1d1fcdb7540606adccbe3f2
```
...
### `php:8.3.3-zts-alpine3.18` - linux; amd64
...
### `php:8.3.3-zts-alpine3.18` - linux; arm variant v7
...
### `php:8.3.3-zts-alpine3.18` - linux; 386
...
### `php:8.3.3-zts-alpine3.18` - linux; ppc64le
...
### `php:8.3.3-zts-alpine3.18` - linux; s390x
