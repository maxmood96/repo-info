...
```console
$ docker pull php@sha256:491f74ebd67c4a496752bfd4ccb89d2d2c4815c37822e59a8c44584a433b9d7b
```
...
### `php:8.3.7-fpm-alpine3.18` - linux; amd64
...
### `php:8.3.7-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.3.7-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.3.7-fpm-alpine3.18` - linux; ppc64le
...
### `php:8.3.7-fpm-alpine3.18` - linux; s390x
