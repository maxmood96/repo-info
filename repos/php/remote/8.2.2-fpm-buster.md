...
```console
$ docker pull php@sha256:e25783400277e8f4326c0629f8f8adc5d6883fd2ea3b11369dfa0624376c68db
```
...
### `php:8.2.2-fpm-buster` - linux; arm variant v7
...
### `php:8.2.2-fpm-buster` - linux; arm64 variant v8
...
### `php:8.2.2-fpm-buster` - linux; 386
