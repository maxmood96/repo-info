...
```console
$ docker pull php@sha256:8329eebea70706fb3bc1a5dcb8b610dcd10e5ac6b77dc4333ed44c09b686b613
```
...
### `php:7.4.32-alpine3.15` - linux; amd64
...
### `php:7.4.32-alpine3.15` - linux; arm64 variant v8
...
### `php:7.4.32-alpine3.15` - linux; 386
...
### `php:7.4.32-alpine3.15` - linux; ppc64le
...
### `php:7.4.32-alpine3.15` - linux; s390x
