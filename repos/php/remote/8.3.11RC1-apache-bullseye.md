...
```console
$ docker pull php@sha256:847cb4380f5716989e6c3845f52e032cfba3c3e4656119c5c5033668e026ac53
```
...
### `php:8.3.11RC1-apache-bullseye` - linux; amd64
...
### `php:8.3.11RC1-apache-bullseye` - linux; arm variant v7
...
### `php:8.3.11RC1-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.11RC1-apache-bullseye` - linux; s390x
