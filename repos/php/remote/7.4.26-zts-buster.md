...
```console
$ docker pull php@sha256:b84cc7e477839ae9dbf0234456126e9ca6f480d53d3f13be011f0a6eeecbdafb
```
...
### `php:7.4.26-zts-buster` - linux; amd64
...
### `php:7.4.26-zts-buster` - linux; arm variant v7
...
### `php:7.4.26-zts-buster` - linux; 386
...
### `php:7.4.26-zts-buster` - linux; mips64le
...
### `php:7.4.26-zts-buster` - linux; ppc64le
