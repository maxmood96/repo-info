...
```console
$ docker pull php@sha256:0fc564c16271cdf079bc68626a9c530261870640dc490ee616402d6d55be6fcb
```
...
### `php:7.4.7-alpine` - linux; arm variant v6

```console
$ docker pull php@sha256:833f5046a62c353a3c3c3370db06a4ea5ecf447daedd264d807b5766895512f4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.4 MB (27435368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3667a57de70b0c9898fc6869f822b2b7db5008b229e8079900bfe60a20ab28b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.4.7-alpine` - linux; arm variant v7

```console
$ docker pull php@sha256:6c53abc3605cac13dfaae8ec2465891c0f27f3ea5a2e3aa8de1376439fa73935
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.3 MB (26298462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360b23b42b91da9e9bc1c62aafe0616b1e4c691936cc67db2a4d46761921458a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.4.7-alpine` - linux; arm64 variant v8

```console
$ docker pull php@sha256:6b91a2e304e927f0ddd2b15c07c75104580251ac355f5d0bbb2e3e0ca4acd3a4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.4 MB (28358809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfc451274b94d34088853cdb4eee2f37944d93e79bb621db1b4461f226bfadf1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.4.7-alpine` - linux; ppc64le
...
### `php:7.4.7-alpine` - linux; s390x

```console
$ docker pull php@sha256:d515e128a93132bca0cfc8bca26b76d2ffce56155d7f6a2f5a564b893db4c63e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27753437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7aaf0b146e381f1b3f08e2d1723b330b08a114bfa73f8e3903bf9207e62390cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
