...
```console
$ docker pull php@sha256:9fee2121467820ceaf1ce6bcdc59f3989ae15580aa220902cdd47433f6dd16db
```
...
### `php:8.3.6-fpm-alpine3.18` - linux; arm variant v6
...
### `php:8.3.6-fpm-alpine3.18` - linux; arm variant v7
