...
```console
$ docker pull php@sha256:5c61c1ad0add320f2dd092348b84963ef77e31c666c3643dd56c33b88611dbe2
```
...
### `php:8.1.10-fpm-alpine3.15` - linux; amd64
...
### `php:8.1.10-fpm-alpine3.15` - linux; 386
...
### `php:8.1.10-fpm-alpine3.15` - linux; ppc64le
...
### `php:8.1.10-fpm-alpine3.15` - linux; s390x
