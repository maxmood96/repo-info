...
```console
$ docker pull php@sha256:d2e6daed5199acd290a5ec5ddd7b47064925ffc60f5d8ec2b3bd90982fcc5de5
```
...
### `php:8.0.2-fpm-alpine3.13` - linux; arm variant v7
...
### `php:8.0.2-fpm-alpine3.13` - linux; arm64 variant v8
...
### `php:8.0.2-fpm-alpine3.13` - linux; 386
