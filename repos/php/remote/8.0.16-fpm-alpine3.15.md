...
```console
$ docker pull php@sha256:15115ec3396bfd512b01812808bb9ad2cd32a6ba7a770960b51172a74a9edd69
```
...
### `php:8.0.16-fpm-alpine3.15` - linux; amd64
...
### `php:8.0.16-fpm-alpine3.15` - linux; arm variant v7
...
### `php:8.0.16-fpm-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.16-fpm-alpine3.15` - linux; 386
...
### `php:8.0.16-fpm-alpine3.15` - linux; ppc64le
...
### `php:8.0.16-fpm-alpine3.15` - linux; s390x
