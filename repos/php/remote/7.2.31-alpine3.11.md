...
```console
$ docker pull php@sha256:4159577609fbd4ee727b591a326ae32e68a45fa5b8208b00710b89566d625719
```
...
### `php:7.2.31-alpine3.11` - linux; arm variant v6
...
### `php:7.2.31-alpine3.11` - linux; arm variant v7
...
### `php:7.2.31-alpine3.11` - linux; arm64 variant v8
...
### `php:7.2.31-alpine3.11` - linux; s390x
