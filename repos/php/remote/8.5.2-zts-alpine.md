...
```console
$ docker pull php@sha256:37807c811f4b079890c5387988aad28cd19e62a41b08d7c80671b58c53348d6b
```
...
### `php:8.5.2-zts-alpine` - linux; amd64
...
### `php:8.5.2-zts-alpine` - unknown; unknown
...
### `php:8.5.2-zts-alpine` - linux; arm variant v6
...
### `php:8.5.2-zts-alpine` - linux; arm variant v7
...
### `php:8.5.2-zts-alpine` - linux; arm64 variant v8
...
### `php:8.5.2-zts-alpine` - linux; 386
...
### `php:8.5.2-zts-alpine` - linux; ppc64le
...
### `php:8.5.2-zts-alpine` - linux; s390x
