...
```console
$ docker pull php@sha256:1dc653d9c74d7e27575488f9f3e9aa06bbd711887cd19f566a70b1f37fdfbf12
```
...
### `php:7.3.19-cli-alpine3.12` - linux; amd64
...
### `php:7.3.19-cli-alpine3.12` - linux; 386
