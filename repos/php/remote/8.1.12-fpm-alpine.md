...
```console
$ docker pull php@sha256:2b6686f7aca27a75892172145175a20853518e8a2f92232d3b3f53dbade6028d
```
...
### `php:8.1.12-fpm-alpine` - linux; amd64
...
### `php:8.1.12-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.12-fpm-alpine` - linux; arm variant v7
...
### `php:8.1.12-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.12-fpm-alpine` - linux; 386
...
### `php:8.1.12-fpm-alpine` - linux; ppc64le
...
### `php:8.1.12-fpm-alpine` - linux; s390x
