...
```console
$ docker pull php@sha256:a56900f13289531c2d7b58d7348096aec3323704eddfd47891fcf942d1b14dfa
```
...
### `php:8.3.2-fpm-alpine` - linux; amd64
...
### `php:8.3.2-fpm-alpine` - linux; arm variant v6
...
### `php:8.3.2-fpm-alpine` - linux; arm variant v7
...
### `php:8.3.2-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.3.2-fpm-alpine` - linux; ppc64le
