...
```console
$ docker pull php@sha256:120e2e6bbd50233fd1a84963e0ed194c71a6c7cbbf69d5e35ad6d06b1d604daf
```
...
```console
$ docker pull php@sha256:bbeabae4c44c4a6ae78886d0551eb2170d342a29826596032a66a8e8625b63d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.3 MB (151263787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98b89cf7cdf10484fc5bf5e1d72040978222171f62c1a2d8f0aaff161de647cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
