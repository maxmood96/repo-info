...
```console
$ docker pull php@sha256:1390c3858991e8c3773feb67e840b1ef4e2840bc81c3f4275cfdeacfb1800efb
```
...
### `php:8.2.17-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.2.17-fpm-alpine3.18` - linux; ppc64le

```console
$ docker pull php@sha256:bbee2d81c922efb08adcab6e525c7b1736c00d314e07cef75fa54bd632a35fdb
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.3 MB (31342679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ae22c5be6ea6115a282fbe7a9d7433197813ea0a93bdb10186e60af1bfe9c64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.2.17-fpm-alpine3.18` - linux; s390x
