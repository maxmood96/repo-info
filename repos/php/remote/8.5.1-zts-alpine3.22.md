...
```console
$ docker pull php@sha256:60b4220646ad9b4d34aacc9b3dea21bbd5afda92a413136e1a376d5f0c095806
```
...
### `php:8.5.1-zts-alpine3.22` - linux; amd64
...
### `php:8.5.1-zts-alpine3.22` - unknown; unknown
...
### `php:8.5.1-zts-alpine3.22` - linux; arm variant v6
...
### `php:8.5.1-zts-alpine3.22` - linux; arm variant v7
...
### `php:8.5.1-zts-alpine3.22` - linux; arm64 variant v8
...
### `php:8.5.1-zts-alpine3.22` - linux; 386
...
### `php:8.5.1-zts-alpine3.22` - linux; ppc64le
...
### `php:8.5.1-zts-alpine3.22` - linux; s390x
