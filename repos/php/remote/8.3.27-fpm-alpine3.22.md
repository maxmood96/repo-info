...
```console
$ docker pull php@sha256:10606543be572a487616476311cd4fbf407c203cf8ae75f3e2d96d2168d9a0a2
```
...
### `php:8.3.27-fpm-alpine3.22` - linux; amd64
...
### `php:8.3.27-fpm-alpine3.22` - unknown; unknown
...
### `php:8.3.27-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.3.27-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.3.27-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.3.27-fpm-alpine3.22` - linux; 386
...
### `php:8.3.27-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.3.27-fpm-alpine3.22` - linux; s390x
