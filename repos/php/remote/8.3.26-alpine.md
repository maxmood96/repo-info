...
```console
$ docker pull php@sha256:45d52e11984f5b559fc05822d7bd5404df179f304bb1c0e8f92ec7728650dbcd
```
...
### `php:8.3.26-alpine` - unknown; unknown
...
### `php:8.3.26-alpine` - linux; arm variant v6
...
### `php:8.3.26-alpine` - linux; arm variant v7
...
### `php:8.3.26-alpine` - linux; arm64 variant v8
...
### `php:8.3.26-alpine` - linux; ppc64le
