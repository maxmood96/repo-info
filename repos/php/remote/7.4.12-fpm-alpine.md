## `php:7.4.12-fpm-alpine`

```console
$ docker pull php@sha256:62c51d62aa582c8daaad37dee323c8b3811936473825f3bae30fa78925b81f06
```
...
### `php:7.4.12-fpm-alpine` - linux; amd64
...
### `php:7.4.12-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.12-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.12-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.12-fpm-alpine` - linux; 386
...
### `php:7.4.12-fpm-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:6bcbc72487e7d39d8e70486506b480a3fa5fe922988ca886878b6e4d233c95a1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29787571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4a9d6ed3fec91e9815d823214792c69c9944f77724cb2add926ab114ec2828f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.4.12-fpm-alpine` - linux; s390x
