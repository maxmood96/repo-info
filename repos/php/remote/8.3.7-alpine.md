...
```console
$ docker pull php@sha256:cdf7a10e01e30ac3678dbc93761d28a9e0942854faf4d9185e59fa77e6cc0e16
```
...
### `php:8.3.7-alpine` - linux; arm variant v6
...
### `php:8.3.7-alpine` - linux; arm variant v7
...
### `php:8.3.7-alpine` - linux; arm64 variant v8
...
### `php:8.3.7-alpine` - linux; ppc64le
