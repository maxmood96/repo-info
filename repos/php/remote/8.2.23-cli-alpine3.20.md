...
### `php:8.2.23-cli-alpine3.20` - linux; amd64
...
### `php:8.2.23-cli-alpine3.20` - linux; arm variant v7
...
### `php:8.2.23-cli-alpine3.20` - linux; 386
...
### `php:8.2.23-cli-alpine3.20` - linux; ppc64le
...
### `php:8.2.23-cli-alpine3.20` - linux; riscv64
