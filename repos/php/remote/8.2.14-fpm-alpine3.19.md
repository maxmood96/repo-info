...
```console
$ docker pull php@sha256:27d888ffb761d4ceb967067bb23859347a0b644e1bad589c73a2a8a5b184a73d
```
...
### `php:8.2.14-fpm-alpine3.19` - linux; amd64
...
### `php:8.2.14-fpm-alpine3.19` - linux; arm variant v6

```console
$ docker pull php@sha256:5a3c25530156237722aba594b52e364509c224a4c743b73ace0e3d31662b6990
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29783404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a36cfc16989cacaca015c78cd1354a8e268b1bca38f590b1bc049803424f6dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.2.14-fpm-alpine3.19` - linux; arm variant v7
...
### `php:8.2.14-fpm-alpine3.19` - linux; arm64 variant v8
...
### `php:8.2.14-fpm-alpine3.19` - linux; 386
...
### `php:8.2.14-fpm-alpine3.19` - linux; ppc64le
...
### `php:8.2.14-fpm-alpine3.19` - linux; s390x
