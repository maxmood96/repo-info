...
### `php:8.1.3-zts-buster` - linux; amd64
...
### `php:8.1.3-zts-buster` - linux; arm variant v5
...
### `php:8.1.3-zts-buster` - linux; arm variant v7
...
### `php:8.1.3-zts-buster` - linux; arm64 variant v8
...
### `php:8.1.3-zts-buster` - linux; 386
...
### `php:8.1.3-zts-buster` - linux; mips64le
...
### `php:8.1.3-zts-buster` - linux; ppc64le
...
### `php:8.1.3-zts-buster` - linux; s390x
