## `php:7.3.13-apache-buster`

```console
$ docker pull php@sha256:c77c0f3beddb1d73b5f4064041391dd767519706b7d8ac5f67820668255801f0
```
...
### `php:7.3.13-apache-buster` - linux; amd64
...
### `php:7.3.13-apache-buster` - linux; arm variant v5
...
### `php:7.3.13-apache-buster` - linux; arm variant v7
...
### `php:7.3.13-apache-buster` - linux; arm64 variant v8
...
### `php:7.3.13-apache-buster` - linux; ppc64le
