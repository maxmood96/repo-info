...
```console
$ docker pull php@sha256:36c0143e903ea7db2025f2775c9df80a0e373b88a1f3f1dc65062b35b2cb3f1d
```
...
### `php:7.3.32-fpm-bullseye` - linux; arm variant v7
...
### `php:7.3.32-fpm-bullseye` - linux; 386
...
### `php:7.3.32-fpm-bullseye` - linux; ppc64le
