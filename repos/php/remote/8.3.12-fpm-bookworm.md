...
```console
$ docker pull php@sha256:a59141697c2e6d93fbdd6f5ef8772f5d53074be65f9e644d5069903fd4c93424
```
...
### `php:8.3.12-fpm-bookworm` - linux; amd64
...
### `php:8.3.12-fpm-bookworm` - linux; arm variant v5
...
### `php:8.3.12-fpm-bookworm` - linux; arm variant v7
...
### `php:8.3.12-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.3.12-fpm-bookworm` - linux; mips64le
...
### `php:8.3.12-fpm-bookworm` - linux; ppc64le
...
### `php:8.3.12-fpm-bookworm` - linux; s390x
