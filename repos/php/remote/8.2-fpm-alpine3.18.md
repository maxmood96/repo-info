...
```console
$ docker pull php@sha256:37fd6363d4b36a0b90df510d7e47314deea7e7ed0f494c550dcae9d568fb4a30
```
...
```console
$ docker pull php@sha256:8ce6e0a3d9384894f674389cd99c56c10855882be75aab98e2a10e9cc6c680ca
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30456045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:763eb34c97b8b5c6148eb9886d2a05f049d1977dd14e86cc221112af3b24222c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
