...
```console
$ docker pull php@sha256:4e205df4a8cdc181f22dded05fb6bf75642782172c66865579eb2a41b1bc8500
```
...
### `php:8.3.10-fpm-alpine` - linux; amd64
...
### `php:8.3.10-fpm-alpine` - linux; arm variant v6
...
### `php:8.3.10-fpm-alpine` - linux; arm variant v7
...
### `php:8.3.10-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.3.10-fpm-alpine` - linux; 386
...
### `php:8.3.10-fpm-alpine` - linux; ppc64le
...
### `php:8.3.10-fpm-alpine` - linux; riscv64
