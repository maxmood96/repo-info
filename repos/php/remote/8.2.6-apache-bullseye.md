...
```console
$ docker pull php@sha256:40be48a8075683b66605146c92c7e90e7e9afb9e5949140d7b94d89ab2755e28
```
...
### `php:8.2.6-apache-bullseye` - linux; arm variant v7
...
### `php:8.2.6-apache-bullseye` - linux; 386
...
### `php:8.2.6-apache-bullseye` - linux; ppc64le
