...
```console
$ docker pull php@sha256:24c1d102ca09d0926760bf3000b3ddccfa53dc2f0939deed303df674019134b2
```
...
### `php:8.2.16-cli` - linux; arm variant v5
...
### `php:8.2.16-cli` - linux; arm variant v7
...
### `php:8.2.16-cli` - linux; arm64 variant v8
...
### `php:8.2.16-cli` - linux; mips64le

```console
$ docker pull php@sha256:7f2965af0de070c27c72b268fd0cbc288ca40ed1fd1fc903fac9104174c92fe0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156260503 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fb19bb416b8cdf9487e40ba605f6ef8bd54ed3eeae2f019a7440e4ba291d6c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Tue, 12 Mar 2024 13:33:10 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--enable-embed 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Tue, 12 Mar 2024 13:33:14 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Tue, 12 Mar 2024 13:33:19 GMT
RUN docker-php-ext-enable sodium
# Tue, 12 Mar 2024 13:33:23 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 12 Mar 2024 13:33:26 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:9c5319c6f32d0ded5e138fd0dcf8f019e6a53884cfcaedb64108caf360435626`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1127e3164c8579a3a105969b2bafcf8f11b6e0d72d109d88981c13246769e7f7`  
		Last Modified: Tue, 12 Mar 2024 17:38:44 GMT  
		Size: 34.3 MB (34278244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0139303a749f0570881fc86efbeeea55fa21e587380228aa61b26c027344aeb`  
		Last Modified: Tue, 12 Mar 2024 17:38:21 GMT  
		Size: 2.5 KB (2451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f1631fdf81fd1ea50326350541572f720198915e10cb69b7c6bedcbbc935ca9`  
		Last Modified: Tue, 12 Mar 2024 17:38:26 GMT  
		Size: 246.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.2.16-cli` - linux; ppc64le
...
### `php:8.2.16-cli` - linux; s390x

```console
$ docker pull php@sha256:6936614f27fa5c71448f13bcc3f79381c894dc5709d2aaac81b1925962bb609b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154904349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1deb659028945b37a11dc56ee42d560d4e96ca19dd08511bab4e97ea4ad4a232`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:1fd99106be73ba6198e9c3f24fd4e01b368220d0576483d8fd3d7426a189f149`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8bb59f357a84d117f7272b349f48a1b0ccb9bbc010b33444134f0c6ecb0b9ad`  
		Last Modified: Tue, 12 Mar 2024 11:22:01 GMT  
		Size: 34.2 MB (34205693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08fb88f095d6e56b407001937f4d8d406204055464d67f6efd878c3ac8f3894c`  
		Last Modified: Tue, 12 Mar 2024 11:21:56 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7125c6da2f41ec47eb629cdaf7d58c3ffc3de3607dceac25e3756554639ced7a`  
		Last Modified: Tue, 12 Mar 2024 11:21:56 GMT  
		Size: 247.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
