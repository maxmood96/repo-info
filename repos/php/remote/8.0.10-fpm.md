...
```console
$ docker pull php@sha256:a1cb0e73c4ecb1a462d77794d48ef41b20856f7357bf8bf8d80b8821f6022c4a
```
...
### `php:8.0.10-fpm` - linux; arm variant v7
...
### `php:8.0.10-fpm` - linux; arm64 variant v8
...
### `php:8.0.10-fpm` - linux; 386

```console
$ docker pull php@sha256:2dd3e17016b45a09fb54606b7add9a0dbc4870e5bc3f9bfa60708e5e7435314f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.2 MB (169162735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a314e6bbf1990ae4ce6b09820130b3cb69e5647671d1a69efdba693e37a52fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
