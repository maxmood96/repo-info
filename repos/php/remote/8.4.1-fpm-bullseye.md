...
### `php:8.4.1-fpm-bullseye` - linux; amd64
...
### `php:8.4.1-fpm-bullseye` - unknown; unknown
...
### `php:8.4.1-fpm-bullseye` - linux; arm variant v7
...
### `php:8.4.1-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.4.1-fpm-bullseye` - linux; 386
