...
```console
$ docker pull php@sha256:4a7cf5404819b40f742a75ac2dbacd7fafef17fe06c95150c2b80a6dac7cba9a
```
...
### `php:8.1.9-fpm-alpine` - linux; amd64
...
### `php:8.1.9-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.9-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.9-fpm-alpine` - linux; 386
...
### `php:8.1.9-fpm-alpine` - linux; ppc64le
...
### `php:8.1.9-fpm-alpine` - linux; s390x
