...
```console
$ docker pull php@sha256:89f9e975faccb94ffeffc81c7ea4e74de6fdf0a86c9ced6bf4964027c526afbc
```
...
### `php:8.2.25-fpm` - linux; arm variant v7
...
### `php:8.2.25-fpm` - linux; arm64 variant v8
