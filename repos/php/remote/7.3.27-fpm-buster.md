...
```console
$ docker pull php@sha256:d600f473c59d4ca35c0c4e5bf4dfe1da4b6125f62e19360a46d63b82cac5cd8f
```
...
```console
$ docker pull php@sha256:189c5b873314d00ede746db10654df4b0a737e41715422be2a55073a120c79b5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.8 MB (150772717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:846f1cadb5a0ebab652cbf1d5ed8edeec36b3bc54513f7b7681bf781de1226cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
