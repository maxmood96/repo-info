...
```console
$ docker pull php@sha256:d0e7f17d0e3562ff8554ae6518cc5f95f337fc2285139b89c0951dd7c6f446a9
```
...
```console
$ docker pull php@sha256:9c2d4a79865974e5ad7ee9511154a62dbda2ea809b13b6cbff34c4a39c3c835e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.4 MB (30359512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f646d335234f4216826cfa350bb83fe4a3890ae35af29d48152460ced0c38776`
...
-	Layers:
	...
	-	`sha256:3da2f9afa1ef0a2f2910745b04b4659c7f2926f6b9d66111cd9a983483d167ec`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e178f2a7a884d13a14f26c7a5043fb743e71e4a6fcbc47fc6d9d4d34e5d32f88`  
		Last Modified: Thu, 16 Mar 2023 23:08:58 GMT  
		Size: 13.1 MB (13079566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d8b24bd6e8128562191e6646047fdb35a080689cf179b2a7bf04bb6d26f5e8c`  
		Last Modified: Thu, 16 Mar 2023 23:08:56 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d980ec2b6e63e95518c8bc6670a578a9cc8ca75e1da5886c2ceecfb766df10c`  
		Last Modified: Thu, 16 Mar 2023 23:08:56 GMT  
...
```console
$ docker pull php@sha256:a666bcef5bef571cf34c22b737cd2717d371a994885f08d25e0da3404767d9a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.6 MB (27577644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0164fee0ddd667acb91929a264c9d5858fdf212069b83243b9a7ab2b9fa9c52e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 16 Mar 2023 23:08:33 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 16 Mar 2023 23:17:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-embed 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 16 Mar 2023 23:17:01 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 16 Mar 2023 23:17:02 GMT
RUN docker-php-ext-enable sodium
# Thu, 16 Mar 2023 23:17:02 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 16 Mar 2023 23:17:02 GMT
...
-	Layers:
	...
	-	`sha256:c7dbaa575aac70098c5c2a23aec2646c1d0261a80b073a421b1d86a316e060eb`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdcbf76780a2dc21f5b57d0cde50c69e56c85b280ce6d6428fe49dcc4eedcb27`  
		Last Modified: Fri, 17 Mar 2023 00:14:48 GMT  
		Size: 11.0 MB (10957552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e3da7f2721465a1d1087907666abe89c60d6c54d45b439d0c06ddb49ec75c13`  
		Last Modified: Fri, 17 Mar 2023 00:14:45 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd101ab4688f76b638a1de37b3e62d0c0baeb4d9e4a3df6bb9cb1c8252080660`  
		Last Modified: Fri, 17 Mar 2023 00:14:45 GMT  
...
```console
$ docker pull php@sha256:e789fd88a22b7d9218b115d2a0b8bf2ef095c0b8fa2042026ce4f7946b638631
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.2 MB (30248420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fa3b8d24f1171cee4f672d4d1852688a6bbd88544c24cf62c40457ec010aeb2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:a18ad46cc84736bba0e2e38b27cbefd11136f5338d49c741e3c3789c1a5c527d`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d8020987169ad208facf637235a7e569ce1136f1336ccdbb159b3e03860221a`  
		Last Modified: Thu, 16 Mar 2023 23:18:58 GMT  
		Size: 13.1 MB (13088098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a3819e9e21436d349072d5a68820529c8563b14cf64d9dd09cbb863d5c55193`  
		Last Modified: Thu, 16 Mar 2023 23:18:56 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96d570fd2d4272f4b8068b1658057db318fae39bb7470bfed6c0b003aaf9e18a`  
		Last Modified: Thu, 16 Mar 2023 23:18:56 GMT  
...
```console
$ docker pull php@sha256:e7de8eed90500c21ab4c3921e44a6c5baab04f46487db8534cf54ddecd89485b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30500561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca319ab522f3034fabe6910de9415eb253529e1339e5c96eb6079af7f49ebab1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 16 Mar 2023 22:24:14 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 16 Mar 2023 22:42:59 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-embed 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 16 Mar 2023 22:42:59 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 16 Mar 2023 22:43:00 GMT
RUN docker-php-ext-enable sodium
# Thu, 16 Mar 2023 22:43:00 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 16 Mar 2023 22:43:00 GMT
...
-	Layers:
	...
	-	`sha256:6282b32a6a31cc75e05f9314b6ad115b6f7674b6784c17fe6cc73eef79626072`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:014e25c497389a92473f996bc32616aa353a03d8b24a7c377bc5b43a5859a400`  
		Last Modified: Fri, 17 Mar 2023 00:43:05 GMT  
		Size: 13.1 MB (13060521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:673e98d836cc5d161e2305f65c0726b075791e9284939f3317863f8f4c881170`  
		Last Modified: Fri, 17 Mar 2023 00:43:01 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3efc0b6bd4a8beae1a30cca7dda67d56ac1df35117b7cdbffbb422995eac9174`  
		Last Modified: Fri, 17 Mar 2023 00:43:01 GMT  
...
```console
$ docker pull php@sha256:618a7e764fe112e81571ba8db34b42031b84362028ff49d9c58c6a9ce6577c65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.3 MB (31315902 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df48f3d5c063c2cb0432ec8a41228f033c50ace2a47b039be6650048c1b12547`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Mon, 27 Mar 2023 22:56:08 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Mon, 27 Mar 2023 23:04:56 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-embed 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Mon, 27 Mar 2023 23:04:57 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Mon, 27 Mar 2023 23:04:58 GMT
RUN docker-php-ext-enable sodium
# Mon, 27 Mar 2023 23:04:58 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Mon, 27 Mar 2023 23:04:58 GMT
...
-	Layers:
	...
	-	`sha256:7c0d0dbff232746bdb02d44209bf5b9541d7b94e356ea3e5f092d0bbe60ba749`  
		...
		Size: 487.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0742c2db0c254ea9bdf8b8d0a164c457601f53fabf195b193544471cdc144b31`  
		Last Modified: Tue, 28 Mar 2023 00:03:54 GMT  
		Size: 14.2 MB (14187908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57223633bebae4f29cae11b6f0063c172c697ee71514596b2e840d23d5adc645`  
		Last Modified: Tue, 28 Mar 2023 00:03:51 GMT  
		Size: 2.4 KB (2445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cbc638a399c10bec65831f559b9c9dfa5b5bd217cea178fae13b9c0ea5849ff`  
		Last Modified: Tue, 28 Mar 2023 00:03:52 GMT  
