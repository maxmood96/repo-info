...
```console
$ docker pull php@sha256:70fa3d07224ee8941404379f01a49d35a293fac78ad521cbf94d8291c235ca4d
```
...
```console
$ docker pull php@sha256:d6e1170df31587bc9ef8ed0db762490f00649987f54f8bab0ef2dd5048aeaad4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.6 MB (147627374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1eba67c2471e2ef4a1135b74bfa561d1bb0f549640bce18b9b321651ce263a15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
