...
```console
$ docker pull php@sha256:f1a18c40d0a4d2df455c9918e3344ac9f4a9a515d11710176c558af896c46f2a
```
...
```console
$ docker pull php@sha256:cb4800a95cdb9ca95dbd8dde2fa9f7d6d3d2940456429ea6b267edf339cd846b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.7 MB (148689428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5efa5ce0481e7648efedcc6e08b96bc9db8490f9b509c11fa84d3b5cae4d30e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
