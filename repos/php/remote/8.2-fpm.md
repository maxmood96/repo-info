...
```console
$ docker pull php@sha256:bb3965026f2e2ae2e59f9c80848d3d1343b12c5c71120876a2ef04ebbff31deb
```
...
```console
$ docker pull php@sha256:1ca7916ba0419eb8bf24756858ef208d8ee5b4fb384b2a852877a1e80915ecb4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.4 MB (147427398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cddf13f807cf0ed24bea11f44a9f15fad4fbe5cc7c870a25642235048307e8a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
