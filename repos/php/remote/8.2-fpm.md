...
```console
$ docker pull php@sha256:9e63bd10d2956f78d996815c34a75ee0960bb84904d2413b6511baaf7fc7bce1
```
...
```console
$ docker pull php@sha256:d86db082990e8050f7ed39586149a8f02f9d2818e38e2450bfefec97f64fc301
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172406680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5da65a573c126fda7b2afb349918e710efd4feb0649a42cced6e93ecde02155b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
