...
```console
$ docker pull php@sha256:0256a6f840ee5e7144afffa883c0f539a9ba03c7481e29033195bb3e969a56ba
```
...
### `php:7.4.25-apache-buster` - linux; arm variant v7
...
### `php:7.4.25-apache-buster` - linux; 386
...
### `php:7.4.25-apache-buster` - linux; mips64le
...
### `php:7.4.25-apache-buster` - linux; ppc64le
