...
```console
$ docker pull php@sha256:77d729a0c8a014ba97e6ec8020191dacfc3df517b6c36e0932a7854f802b2c6a
```
...
### `php:7.4.8-fpm-buster` - linux; amd64
...
### `php:7.4.8-fpm-buster` - linux; arm variant v5
...
### `php:7.4.8-fpm-buster` - linux; arm variant v7
...
### `php:7.4.8-fpm-buster` - linux; arm64 variant v8
...
### `php:7.4.8-fpm-buster` - linux; mips64le
...
### `php:7.4.8-fpm-buster` - linux; ppc64le
...
### `php:7.4.8-fpm-buster` - linux; s390x
