...
```console
$ docker pull php@sha256:50307a227fd53f499dec7969978eeb1be3a6cf339d4f09e0ae10c915c8a76262
```
...
### `php:rc-apache-buster` - linux; mips64le
...
### `php:rc-apache-buster` - linux; s390x
