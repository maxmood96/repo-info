...
```console
$ docker pull php@sha256:91efa8d7331189437a0dc9817fbc046690511c12f52fa59a24dedd5f0e4056db
```
...
### `php:7.4.6-fpm-alpine3.11` - linux; arm variant v7
...
### `php:7.4.6-fpm-alpine3.11` - linux; arm64 variant v8
