...
```console
$ docker pull php@sha256:628c120b50812694bddecd9f1a566bac56b2c4d12abe98a5f1b37db0c18ff35f
```
...
### `php:8.1.0RC6-apache-bullseye` - linux; amd64
...
### `php:8.1.0RC6-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.0RC6-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.0RC6-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.0RC6-apache-bullseye` - linux; 386
...
### `php:8.1.0RC6-apache-bullseye` - linux; mips64le
...
### `php:8.1.0RC6-apache-bullseye` - linux; ppc64le
...
### `php:8.1.0RC6-apache-bullseye` - linux; s390x
