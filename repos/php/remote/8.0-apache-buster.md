...
```console
$ docker pull php@sha256:11c76ae80f8fc5f4748a4bd2e6d861919cb66993c900860a08c675c9dca733dd
```
...
```console
$ docker pull php@sha256:af7d6af8fff1ab5eac537e3e407ebe85fa83fb6ac97416030447388f55aa183f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.4 MB (144443700 bytes)**  
...
```console
$ docker pull php@sha256:5816623098ecc0eb62a295c4b7d2667b510b1e695433be1ee8948d591365ee38
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.2 MB (120207068 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50d0f0dec9e8b55f2f8d96012f4c922edeb85bdb6ce565e4403c7679932d128b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:5b888ee895ed86bc1a8ed157c5f0d80f42d036675c34760e7cbf40ced4328f9b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.5 MB (126493452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a605d8700c30e2d559bd9d954044dac510f4b9a27d827efbb0b8dec6eeee168f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 05 Mar 2022 04:03:32 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 05 Mar 2022 04:03:35 GMT
COPY multi:ee8b9bb4e448c5d38508b40a8ace77d14cf000229390e687b6d467283c9826e6 in /usr/local/bin/ 
# Sat, 05 Mar 2022 04:03:42 GMT
RUN docker-php-ext-enable sodium
# Sat, 05 Mar 2022 04:03:46 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 05 Mar 2022 04:03:49 GMT
STOPSIGNAL SIGWINCH
# Sat, 05 Mar 2022 04:03:52 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Sat, 05 Mar 2022 04:03:55 GMT
WORKDIR /var/www/html
# Sat, 05 Mar 2022 04:03:59 GMT
EXPOSE 80
# Sat, 05 Mar 2022 04:04:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0edd8178f879307a035fc831f3c89298751ed4d752dc00e331e060bdd0b153b8`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d024abd300bc5c4652bb1c06c06b4e5cf06e15c74371ebecfa7e58c95ebafb0`  
		Last Modified: Sat, 05 Mar 2022 07:42:57 GMT  
		Size: 9.9 MB (9874484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67dbb23cd45319fa865aab0525422acebc8286748de728e8ff168f7d7c8a2f5b`  
		Last Modified: Sat, 05 Mar 2022 07:42:48 GMT  
		Size: 2.3 KB (2314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b61eaf67d5d0867c8265b2b9bacce3de8e6447d30b25c39927e498be39777600`  
		Last Modified: Sat, 05 Mar 2022 07:42:49 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56be01babc4c55696376080d553e53167a01ebaa0bb0acabadbf37e741e7f041`  
		Last Modified: Sat, 05 Mar 2022 07:42:48 GMT  
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
