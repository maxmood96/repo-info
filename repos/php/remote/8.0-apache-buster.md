...
```console
$ docker pull php@sha256:ab5f89235c38384c4f27fbd27bfa1dd4dcb4fdb511c14ededa1d8eb0d3ccbae3
```
...
```console
$ docker pull php@sha256:e3b36f5703a25f1cabc20ab8908deca92d8eea1c9a306ea71082731ae6063fe7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.3 MB (136295525 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d7042db641a32f3853728dbc4efd8ed7932ce3206b2b4062df78f493ece136d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
