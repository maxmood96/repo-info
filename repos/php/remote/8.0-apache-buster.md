...
```console
$ docker pull php@sha256:60d6df35a987d38ff570a441177c185d7904b1cf46022d3392eba74498564b96
```
...
```console
$ docker pull php@sha256:e40e67b8954c2e4ed49bc12ddbef0f5005c064783af9566de152330f06d1ea9b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.3 MB (150307735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7f544b1887ad405733298e7b821c98ceb10ac1d7c18b0727940832c4b6aa89c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
