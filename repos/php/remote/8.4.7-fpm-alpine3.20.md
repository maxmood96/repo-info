...
```console
$ docker pull php@sha256:1e8da9f6bf2f96188e2a976c924de2df154735f7709c75bb5eec4e621feae526
```
...
### `php:8.4.7-fpm-alpine3.20` - linux; arm variant v7
...
### `php:8.4.7-fpm-alpine3.20` - linux; arm64 variant v8
...
### `php:8.4.7-fpm-alpine3.20` - linux; ppc64le
...
### `php:8.4.7-fpm-alpine3.20` - linux; s390x
