...
```console
$ docker pull php@sha256:28498e15eb124f71526b2a9dd4775204b713037b0d6fbcbaec873200c7fbab8e
```
...
### `php:8.4.8-cli` - linux; arm variant v5
...
### `php:8.4.8-cli` - linux; arm variant v7
...
### `php:8.4.8-cli` - linux; arm64 variant v8
