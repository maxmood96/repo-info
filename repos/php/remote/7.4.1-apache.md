...
```console
$ docker pull php@sha256:94ecf4767d0f3dbbc8dd09dde2a0bf49aa1633ede9566bca7b6ba051177f4ce5
```
...
### `php:7.4.1-apache` - linux; arm variant v5
...
### `php:7.4.1-apache` - linux; arm variant v7
...
### `php:7.4.1-apache` - linux; arm64 variant v8
...
### `php:7.4.1-apache` - linux; ppc64le
