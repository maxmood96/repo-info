...
```console
$ docker pull php@sha256:e1c76c4e783996590b9d0cc385565a04eb1e2f18fd513563ac6ffda515bf2a77
```
...
```console
$ docker pull php@sha256:c6dcff2242d718bacdc798a7fa1f99ca730d9839234a568ba65aedbffab6651c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.3 MB (145342679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9acedf01468faf854479c43658d6e7ac2f5cf51fa95ca711037387e4f8ffca14`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
