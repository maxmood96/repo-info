...
```console
$ docker pull php@sha256:bb5ddc5be2ac9e402395968b6fa135fb1449288c75650976c20936b36aaa9472
```
...
### `php:8.0.20-alpine` - linux; arm variant v6
...
### `php:8.0.20-alpine` - linux; arm64 variant v8
