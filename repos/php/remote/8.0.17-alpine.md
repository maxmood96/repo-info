...
```console
$ docker pull php@sha256:867e091da77c2f76e5cfc734730b1a9507bb4f9efb5e423ae9955c2b15a2d58a
```
...
### `php:8.0.17-alpine` - linux; arm variant v7
...
### `php:8.0.17-alpine` - linux; arm64 variant v8
...
### `php:8.0.17-alpine` - linux; ppc64le
