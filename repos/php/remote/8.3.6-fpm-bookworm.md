...
```console
$ docker pull php@sha256:134cef1fe4d38fd4631ed98dbed420437c66e2a10931b31c37ec962805e2b760
```
...
### `php:8.3.6-fpm-bookworm` - linux; arm variant v7
...
### `php:8.3.6-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.3.6-fpm-bookworm` - linux; 386
