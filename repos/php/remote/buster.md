...
```console
$ docker pull php@sha256:8540145d03843588cf0d47d259d56f66ecad609c20ec79f3b181d8cc80da985e
```
...
```console
$ docker pull php@sha256:8db7d199728e5882fc753d226a9a805653935771c9600cd9c105a6a9e533bd42
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.1 MB (150146600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:974d0c94170204b2eb2207b028b34ad55e0394b8193da75fb7eab775deaa8fa2`
...
-	Layers:
	...
	-	`sha256:4f0adb6d11b8ca9670733b9e272423c7ffbd703282e46c302876daefa054db4a`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b0a924d311e9114a6e08b50f0dd0b452beb11b2c1fb0b8905c94197f5a21d9b`  
		Last Modified: Thu, 23 Mar 2023 10:53:43 GMT  
		Size: 34.0 MB (33995183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89d065e8bae4ad74fb23715b817f9182d43441ee8e73bc300c0cb221cf04bbe4`  
		Last Modified: Thu, 23 Mar 2023 10:53:38 GMT  
		Size: 2.5 KB (2451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0acfeaefebe208989e410173e9101f84cedbe7da64895a151f18f24a97786c95`  
		Last Modified: Thu, 23 Mar 2023 10:53:38 GMT  
		Size: 245.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:bce15e0a1e11dbd865d045645432dd359f5b896e178a2e75332696c533d7fb9c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.2 MB (125200358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7aa801a8d5350b2ed37247bbe1049015dd73df16193de30cdec57b2cc825eebb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 23 Mar 2023 10:02:38 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 23 Mar 2023 10:04:46 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--enable-embed 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 23 Mar 2023 10:04:47 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 23 Mar 2023 10:04:47 GMT
RUN docker-php-ext-enable sodium
# Thu, 23 Mar 2023 10:04:47 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 23 Mar 2023 10:04:48 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:791d9a20a797191f6cf57fb72e39a5d820ed762069a62dd07da66dd330192239`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cf642001f986c5454b3627b66cf3f062d45d98f840df9d2d5e3fd583b2a2e1f`  
		Last Modified: Thu, 23 Mar 2023 10:52:15 GMT  
		Size: 30.6 MB (30591886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecd40d9b74822f07e52081662221bc6db3e5f59c8f62cb3545543f6a568eded0`  
		Last Modified: Thu, 23 Mar 2023 10:52:10 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea8f3ab5c22690231e6c6fd123d723a06245f53dc49a9e665d57a953962dbb34`  
		Last Modified: Thu, 23 Mar 2023 10:52:10 GMT  
		Size: 244.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:f9f6c77c5be8f24498e8ea42a5fa0ed82140b3401f93a003acacc488d1e833c2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (156003865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ed32b590e1d87ea795588fe2d50044de0ffa1cda3f127e254e8ce6ad4a48356`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:9f52ead465d8360c18ceec010c9fc61e5b7a3cefd7252d7f22233f9bad0d2847`  
		...
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7244516b73ab597a859b7aa0a4b5c56873474e3fb21c69ac2d39280dccfd196`  
		Last Modified: Thu, 23 Mar 2023 10:52:41 GMT  
		Size: 34.6 MB (34649608 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7074806254f8eb52e76f9a61c604a9170c4231c3cb7cd37c81d8a35cc09646cd`  
		Last Modified: Thu, 23 Mar 2023 10:52:31 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da0f2c553f51d4edbb971d9b653d822ca09b3268e9db056347e8690e7b190767`  
		Last Modified: Thu, 23 Mar 2023 10:52:31 GMT  
		Size: 245.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
