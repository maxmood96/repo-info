...
```console
$ docker pull php@sha256:3c1087350751847307d6ba3b98902d7e5ecba991ca9cecbe74c89f71c1932333
```
...
### `php:8.3.3-apache` - linux; arm variant v7
...
### `php:8.3.3-apache` - linux; ppc64le
