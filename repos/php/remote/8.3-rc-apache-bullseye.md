...
```console
$ docker pull php@sha256:a7ae176389b17094df8077e892c26c0c883873465f7c4d4f0b0b0fc17637d9b3
```
...
```console
$ docker pull php@sha256:a800c8cfd13a047ef2312b918f6249d861b0db4a9369eef4757303d71dd20ff2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143471360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:675eece9e03b62d2f94ae9f0b91eac99ff26a7c9ec422b6be32ecfed8cb9ee55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Wed, 05 Jul 2023 03:28:11 GMT
ENV PHP_VERSION=8.3.0alpha2
# Wed, 05 Jul 2023 03:28:14 GMT
ENV PHP_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz PHP_ASC_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz.asc
# Wed, 05 Jul 2023 03:28:18 GMT
ENV PHP_SHA256=60b0b18220dcb018ac3a602875fd21f07c9a08887ee22d50ed0670fe1e0a4792
# Wed, 05 Jul 2023 03:29:07 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Wed, 05 Jul 2023 03:29:10 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 05 Jul 2023 03:43:24 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 05 Jul 2023 03:43:28 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Wed, 05 Jul 2023 03:43:34 GMT
RUN docker-php-ext-enable sodium
# Wed, 05 Jul 2023 03:43:37 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 05 Jul 2023 03:43:41 GMT
STOPSIGNAL SIGWINCH
# Wed, 05 Jul 2023 03:43:44 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Wed, 05 Jul 2023 03:43:48 GMT
WORKDIR /var/www/html
# Wed, 05 Jul 2023 03:43:51 GMT
EXPOSE 80
# Wed, 05 Jul 2023 03:43:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:96cc631b607414e0dfaa50055e2c62e3a00fa041f9cd35481130acb2175630a1`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92b8196a1b4c2861cc1892804153c4ea806b0c13d89f8326e90fb2c9b85aa4bc`  
		Last Modified: Wed, 05 Jul 2023 13:27:22 GMT  
		Size: 12.4 MB (12415672 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dc97771e213a4107547cb8e707939a4a009985146317f2166626e39df8f60d3`  
		Last Modified: Wed, 05 Jul 2023 13:27:15 GMT  
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b1512cf0b23a61fc1d417216ca05f928346706144a3822ae5bb42d42de8f1cc`  
		Last Modified: Wed, 05 Jul 2023 13:27:26 GMT  
		Size: 10.7 MB (10653719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:227ed4b55b3b4763483775632b7746778407f2a886a16e9d9abedfef94a4b7e5`  
		Last Modified: Wed, 05 Jul 2023 13:27:15 GMT  
		Size: 2.5 KB (2459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15a840cd5f859da4761c53ccc9761eaa2c7616565863531a15a804c56a35314f`  
		Last Modified: Wed, 05 Jul 2023 13:27:15 GMT  
		Size: 247.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6af0bc79374e943da554523ed85d1b6fdd282f3869ad1720640cbbcad92fa7ba`  
		Last Modified: Wed, 05 Jul 2023 13:27:15 GMT  
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
