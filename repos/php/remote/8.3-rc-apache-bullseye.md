...
```console
$ docker pull php@sha256:93404d9537ed74438f2fa644293d6b314b9ec8c76ccce7cd85c8c735394062ea
```
...
```console
$ docker pull php@sha256:3d5b9a75ffcc5171ebb5dc29d592249fdc50f11be984adb557b4720b7f784151
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.5 MB (169515979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d31b0f29a01f8ef7f73a22d167640a02de83a4fea006b9c3c76d2443fe3cc470`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Fri, 16 Aug 2024 23:46:03 GMT
ENV PHP_VERSION=8.3.11RC1
# Fri, 16 Aug 2024 23:46:03 GMT
ENV PHP_URL=https://downloads.php.net/~jakub/php-8.3.11RC1.tar.xz PHP_ASC_URL=https://downloads.php.net/~jakub/php-8.3.11RC1.tar.xz.asc
# Fri, 16 Aug 2024 23:46:03 GMT
ENV PHP_SHA256=03e2982f21578c2ffe962cb0465ef970ff43109b23a4879557ccc7e89ce03867
# Fri, 16 Aug 2024 23:46:15 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Fri, 16 Aug 2024 23:46:15 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:dde62e9fc2596d45fa90e31a4a77fc8c1f723cc13d81fe3bb7401ccc91f9eb05`  
		...
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad1219e2f97241f8bcdb072bedcd462b5cf8351cbe9a82bd763991c76ff27494`  
		Last Modified: Sat, 17 Aug 2024 02:29:12 GMT  
		Size: 12.8 MB (12816971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ba12421ef8c2895f8354d773e83352d166740fba4b42e189051580afa67e888`  
		Last Modified: Sat, 17 Aug 2024 02:29:09 GMT  
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de96db7bf7f8da1a83c2280b23aa00cad7e4278abe31add34e2da675041bff53`  
		Last Modified: Sat, 17 Aug 2024 02:29:12 GMT  
		Size: 11.8 MB (11791365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:772b7478dca0f63e5340cd73a2c9810e62a3b972c38d24772e07eb853ba643c8`  
		Last Modified: Sat, 17 Aug 2024 02:29:08 GMT  
		Size: 2.5 KB (2455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65f1614619203ff2d1fc685fee57fe684ed0de096fd7e634329b5a1fce197fd5`  
		Last Modified: Sat, 17 Aug 2024 02:29:09 GMT  
		Size: 244.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7af7a4f71f7d3ecf1a843395cdeb120618c442b2733a32ea7d397fbfed6f0df`  
		Last Modified: Sat, 17 Aug 2024 02:29:09 GMT  
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:74e09f63be9409d8b15a5cc757670aa317f001211866de57e6c1aaf86fe95ff6
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143933478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:765e377a1465135350e2c8a4f411f973c11ccd08b58a90a2729872f23ff825df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Sat, 17 Aug 2024 00:40:22 GMT
ENV PHP_VERSION=8.3.11RC1
# Sat, 17 Aug 2024 00:40:26 GMT
ENV PHP_URL=https://downloads.php.net/~jakub/php-8.3.11RC1.tar.xz PHP_ASC_URL=https://downloads.php.net/~jakub/php-8.3.11RC1.tar.xz.asc
# Sat, 17 Aug 2024 00:40:30 GMT
ENV PHP_SHA256=03e2982f21578c2ffe962cb0465ef970ff43109b23a4879557ccc7e89ce03867
# Sat, 17 Aug 2024 00:41:18 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Sat, 17 Aug 2024 00:41:21 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 17 Aug 2024 00:55:36 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 17 Aug 2024 00:55:40 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Sat, 17 Aug 2024 00:55:47 GMT
RUN docker-php-ext-enable sodium
# Sat, 17 Aug 2024 00:55:51 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 17 Aug 2024 00:55:55 GMT
STOPSIGNAL SIGWINCH
# Sat, 17 Aug 2024 00:55:59 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Sat, 17 Aug 2024 00:56:02 GMT
WORKDIR /var/www/html
# Sat, 17 Aug 2024 00:56:06 GMT
EXPOSE 80
...
-	Layers:
	...
	-	`sha256:eb53b5696a16897f02b43df74c2e3e9531a9b4eb272fa60fccd9ab4c60704472`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c1198aac675c578c28b810f769f5a9b228f314b0621c38b6c7d639fa69469c`  
		Last Modified: Sat, 17 Aug 2024 03:38:15 GMT  
		Size: 12.6 MB (12599552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3ad44b88d8163e51b7d1a2b396f74f20d0acb36f83427133e2cb2d049fb0a35`  
		Last Modified: Sat, 17 Aug 2024 03:38:09 GMT  
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d749e382d7218f9d2fd8cdd8d5181edc42c05f26e87ecf0576cced85d41a3ae`  
		Last Modified: Sat, 17 Aug 2024 03:38:23 GMT  
		Size: 10.7 MB (10691594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:494348ad121015974be71a474c42c02d7fc374fa37875582bd0326efaf7d4c2c`  
		Last Modified: Sat, 17 Aug 2024 03:38:09 GMT  
		Size: 2.5 KB (2457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22b95c2b27de250000e5633c849e930388d51b6283309daf005901c017ce8864`  
		Last Modified: Sat, 17 Aug 2024 03:38:09 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfafa85f40b6f2200d2a389167e5582177b6aa2f6a02cc16acf7c458e43b9c26`  
		Last Modified: Sat, 17 Aug 2024 03:38:09 GMT  
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
