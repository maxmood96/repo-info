...
```console
$ docker pull php@sha256:2621a757b860b8c39b1b7e2e3bd1a77ec0b7cda6680b1223b279b9b2bab5fecb
```
...
### `php:8.3.28-fpm-trixie` - linux; amd64
...
### `php:8.3.28-fpm-trixie` - unknown; unknown
...
### `php:8.3.28-fpm-trixie` - linux; arm variant v5
...
### `php:8.3.28-fpm-trixie` - linux; arm variant v7
...
### `php:8.3.28-fpm-trixie` - linux; arm64 variant v8
...
### `php:8.3.28-fpm-trixie` - linux; 386
...
### `php:8.3.28-fpm-trixie` - linux; ppc64le
...
### `php:8.3.28-fpm-trixie` - linux; s390x
