...
```console
$ docker pull php@sha256:f21f5e9d398a1b26b4dfa60ab3627374d7d00910ad41ac275eb2314d5f854556
```
...
### `php:8.2.17-zts-alpine` - linux; arm variant v7
...
### `php:8.2.17-zts-alpine` - linux; s390x
