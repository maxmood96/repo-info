...
```console
$ docker pull php@sha256:863e9bc06d1a23fa9f262ecc6ae2f19c1b9419c023269793d7b99d7b811e56aa
```
...
```console
$ docker pull php@sha256:fe56b13d8e7c2b8be1179b7e9ca37b24e721a9a37e7f1ef89169e17352951a91
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.3 MB (29251534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db6805c4ff1dfe929940ce955a496e97666e54b8196beba502e1778447967a86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
