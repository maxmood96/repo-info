...
```console
$ docker pull php@sha256:93c461b987e242223fb31184af91e1a870729aa172198b916be4049ea873ebe5
```
...
### `php:8.0.15-alpine` - linux; arm variant v6
...
### `php:8.0.15-alpine` - linux; arm variant v7
...
### `php:8.0.15-alpine` - linux; arm64 variant v8
...
### `php:8.0.15-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:dc85d2917f303b5856e4bd5a40d14d3fad3f433e91cfc8ae5e342d05d16a2a6a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32524451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:229dd1f27508fd3d871fa8a1777456cd7207d331d5fad768d305a62867e88063`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
