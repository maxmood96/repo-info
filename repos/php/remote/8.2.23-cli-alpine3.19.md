...
```console
$ docker pull php@sha256:33405eca26b699812887ba2aa459653907d6f0e21906aaa64adec331ec3ac77e
```
...
### `php:8.2.23-cli-alpine3.19` - linux; amd64
...
### `php:8.2.23-cli-alpine3.19` - linux; arm variant v7
...
### `php:8.2.23-cli-alpine3.19` - linux; ppc64le
