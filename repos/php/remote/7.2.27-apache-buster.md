...
```console
$ docker pull php@sha256:af8d8f62565fa3458d996c7e3804c6ade3fa8cfa451ade4bab137e931977416b
```
...
### `php:7.2.27-apache-buster` - linux; arm64 variant v8
...
### `php:7.2.27-apache-buster` - linux; 386
...
### `php:7.2.27-apache-buster` - linux; ppc64le
