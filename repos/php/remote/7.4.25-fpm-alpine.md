...
```console
$ docker pull php@sha256:365ec731569b5f5dd6a004d4a6fe18495975bdebda1061807f25c8c98cfa7f04
```
...
### `php:7.4.25-fpm-alpine` - linux; amd64
...
### `php:7.4.25-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.25-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.25-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.25-fpm-alpine` - linux; 386
...
### `php:7.4.25-fpm-alpine` - linux; ppc64le
...
### `php:7.4.25-fpm-alpine` - linux; s390x
