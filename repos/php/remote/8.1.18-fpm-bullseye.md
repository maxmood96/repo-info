...
```console
$ docker pull php@sha256:2030d0b71def280fc5a8b2fcd4a5501be5dbd2663df570b8457f849fbd9dc492
```
...
```console
$ docker pull php@sha256:db4e87317093905436e51d0fb6fc958a060ee6da1efa1dfeea372ef1b37f5b1e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.7 MB (138690574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f182f1d66749c7acf865ae213cadbb5d0f3d8978c70988205b49e4822fa994a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
