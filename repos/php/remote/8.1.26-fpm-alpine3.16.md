...
```console
$ docker pull php@sha256:78977334ace3f246a067a29281ee6d9adea8741ed8ca9d9d291ece296f280a12
```
...
### `php:8.1.26-fpm-alpine3.16` - linux; 386

```console
$ docker pull php@sha256:459ddafdc28fd37f258ad146877274118d74c9959162f68adf853023527c0f03
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.7 MB (32741812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e0a706751055d180fcd0ac1948354a4c119408898ee0fd6861c7b7b794d73c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
