...
```console
$ docker pull php@sha256:6dcba5bd8972ae7dc61cd8a644eb70059f815b782a74ec2d02722c32dbfcc2fd
```
...
### `php:8.1.7-apache-buster` - linux; amd64
...
### `php:8.1.7-apache-buster` - linux; arm variant v5
...
### `php:8.1.7-apache-buster` - linux; arm variant v7
...
### `php:8.1.7-apache-buster` - linux; arm64 variant v8
...
### `php:8.1.7-apache-buster` - linux; 386
...
### `php:8.1.7-apache-buster` - linux; mips64le
...
### `php:8.1.7-apache-buster` - linux; ppc64le
...
### `php:8.1.7-apache-buster` - linux; s390x
