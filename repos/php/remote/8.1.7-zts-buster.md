...
```console
$ docker pull php@sha256:92156c4ab5cb3f5d99bfb5867eae722de49d9f8f0209097a7864b53a2f859c3c
```
...
### `php:8.1.7-zts-buster` - linux; amd64
...
### `php:8.1.7-zts-buster` - linux; arm variant v5
...
### `php:8.1.7-zts-buster` - linux; arm variant v7
...
### `php:8.1.7-zts-buster` - linux; arm64 variant v8
...
### `php:8.1.7-zts-buster` - linux; 386
...
### `php:8.1.7-zts-buster` - linux; ppc64le
...
### `php:8.1.7-zts-buster` - linux; s390x
