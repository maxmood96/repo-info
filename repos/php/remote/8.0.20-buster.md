...
### `php:8.0.20-buster` - linux; arm variant v7
...
### `php:8.0.20-buster` - linux; arm64 variant v8
...
### `php:8.0.20-buster` - linux; mips64le
...
### `php:8.0.20-buster` - linux; ppc64le
