...
```console
$ docker pull php@sha256:e0c3754d5fcbd89748ef61eb6c9ff745f479b684e5111ae2c0310a6376e1b7b3
```
...
### `php:8.1.21-fpm-bookworm` - linux; amd64
...
### `php:8.1.21-fpm-bookworm` - linux; arm variant v5
...
### `php:8.1.21-fpm-bookworm` - linux; arm variant v7
...
### `php:8.1.21-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.1.21-fpm-bookworm` - linux; 386
...
### `php:8.1.21-fpm-bookworm` - linux; mips64le
...
### `php:8.1.21-fpm-bookworm` - linux; ppc64le
...
### `php:8.1.21-fpm-bookworm` - linux; s390x
