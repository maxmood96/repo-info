...
```console
$ docker pull php@sha256:bac0135eead5976bbdb49dbdd89b927a6808c7a4b2f0af172118901971876364
```
...
### `php:8.0.14-alpine3.15` - linux; amd64
...
### `php:8.0.14-alpine3.15` - linux; arm variant v6
...
### `php:8.0.14-alpine3.15` - linux; arm variant v7
...
### `php:8.0.14-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.14-alpine3.15` - linux; ppc64le
...
### `php:8.0.14-alpine3.15` - linux; s390x
