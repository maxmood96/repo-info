...
```console
$ docker pull php@sha256:c038a097cc02cde78c0fe75c6d64401821de6b56280dfc3d21f790c0e5dad40b
```
...
### `php:8.4.20-fpm-trixie` - linux; amd64
...
### `php:8.4.20-fpm-trixie` - unknown; unknown
...
### `php:8.4.20-fpm-trixie` - linux; arm variant v5
...
### `php:8.4.20-fpm-trixie` - linux; arm variant v7
...
### `php:8.4.20-fpm-trixie` - linux; arm64 variant v8
...
### `php:8.4.20-fpm-trixie` - linux; 386
...
### `php:8.4.20-fpm-trixie` - linux; ppc64le
...
### `php:8.4.20-fpm-trixie` - linux; riscv64
...
### `php:8.4.20-fpm-trixie` - linux; s390x
