...
```console
$ docker pull php@sha256:b9fcdc8be8c501c9bf274d7f8fee119c2895baf6f363a5197dd58c1cb8325738
```
...
### `php:7.3.20-apache` - linux; arm variant v7
...
### `php:7.3.20-apache` - linux; arm64 variant v8
...
### `php:7.3.20-apache` - linux; mips64le
...
### `php:7.3.20-apache` - linux; ppc64le
