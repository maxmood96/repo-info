...
```console
$ docker pull php@sha256:8c7e287a66004e94ec15a54a528a7ac7df556a8c81f17d8be910e8809685d741
```
...
```console
$ docker pull php@sha256:38be25aa2ca341a557450e258c49e2460fd965b0749645b9a8e6353998a3b0bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.0 MB (28980779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03bd7ec076514eacdce79422e00dcc93a3d18fe9fab1d0db18043413c4aeffb3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
