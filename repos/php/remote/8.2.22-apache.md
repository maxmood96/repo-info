...
```console
$ docker pull php@sha256:f6d5cbb787f36e3e474851741f340f7ade8a62359fcde1728f423ca2303e4e27
```
...
### `php:8.2.22-apache` - linux; arm variant v5
...
### `php:8.2.22-apache` - linux; arm variant v7
...
### `php:8.2.22-apache` - linux; arm64 variant v8
...
### `php:8.2.22-apache` - linux; mips64le
