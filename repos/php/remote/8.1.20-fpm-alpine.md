...
```console
$ docker pull php@sha256:67e1e970cddf9303c91ff418c8324f342d5e5ee3c15f953270ccaccc9a3431ac
```
...
```console
$ docker pull php@sha256:edfeb4ecb23cca6d20d91cd6732c280663d5a4db3baa2540315e283fe17c7dda
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27822865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47bf3615ca51032b07b2c132d87b9f22b6eb05471e0cce8c176d64246dfab1d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
