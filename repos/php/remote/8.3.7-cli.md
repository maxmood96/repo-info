...
```console
$ docker pull php@sha256:54417dc84522bd7bd7ec1f417ea00cc7bfe6a710cb090a897034cab87bbf9049
```
...
### `php:8.3.7-cli` - linux; arm variant v5
...
### `php:8.3.7-cli` - linux; arm variant v7
...
### `php:8.3.7-cli` - linux; arm64 variant v8
