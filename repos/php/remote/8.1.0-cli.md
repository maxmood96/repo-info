...
```console
$ docker pull php@sha256:ee11a414c619b650612e06de74c9d3d40cca2da4ef5509fb8ededd01585f7fc5
```
...
### `php:8.1.0-cli` - linux; arm variant v5
...
### `php:8.1.0-cli` - linux; arm variant v7
...
### `php:8.1.0-cli` - linux; arm64 variant v8
