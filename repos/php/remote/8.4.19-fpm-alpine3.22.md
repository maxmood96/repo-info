...
```console
$ docker pull php@sha256:d7eed3b4e534584b68ca80756d8b023203503c6b07656352d8902fd45474cf04
```
...
### `php:8.4.19-fpm-alpine3.22` - linux; amd64
...
### `php:8.4.19-fpm-alpine3.22` - unknown; unknown
...
### `php:8.4.19-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.4.19-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.4.19-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.4.19-fpm-alpine3.22` - linux; 386
...
### `php:8.4.19-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.4.19-fpm-alpine3.22` - linux; s390x
