...
```console
$ docker pull php@sha256:8d7fd9b3d99899b9703368c3cd8bd3ead3be512ba28f7b1ce4d6ad9732529d24
```
...
```console
$ docker pull php@sha256:1ce81a7636d59351d279c08ac324cac1cde3ed7f51de0bc234dae354be90f3c3
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29510102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b44f0e18398bdd159e0c6d7c75178881d1edafedd9d0f00f916eba8d206ff7b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
