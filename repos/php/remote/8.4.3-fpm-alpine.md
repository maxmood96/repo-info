...
```console
$ docker pull php@sha256:9038d02625acbf22d5cbe03eac4ef2114b1c494c54c969aa42c39e79a2fbaecd
```
...
### `php:8.4.3-fpm-alpine` - linux; amd64
...
### `php:8.4.3-fpm-alpine` - unknown; unknown
...
### `php:8.4.3-fpm-alpine` - linux; arm variant v6
...
### `php:8.4.3-fpm-alpine` - linux; arm variant v7
...
### `php:8.4.3-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.4.3-fpm-alpine` - linux; 386
...
### `php:8.4.3-fpm-alpine` - linux; ppc64le
...
### `php:8.4.3-fpm-alpine` - linux; s390x
