...
### `php:8.3.29-apache-trixie` - linux; amd64
...
### `php:8.3.29-apache-trixie` - unknown; unknown
...
### `php:8.3.29-apache-trixie` - linux; arm variant v5
...
### `php:8.3.29-apache-trixie` - linux; arm variant v7
...
### `php:8.3.29-apache-trixie` - linux; arm64 variant v8
...
### `php:8.3.29-apache-trixie` - linux; 386
...
### `php:8.3.29-apache-trixie` - linux; ppc64le
...
### `php:8.3.29-apache-trixie` - linux; riscv64
...
### `php:8.3.29-apache-trixie` - linux; s390x
