...
```console
$ docker pull php@sha256:e3a031cf5093235018c5d3859acf35a0a1225ae5e52c1bd131cf24fee0a4de53
```
...
### `php:8.4.12-fpm-alpine3.21` - linux; amd64
...
### `php:8.4.12-fpm-alpine3.21` - unknown; unknown
...
### `php:8.4.12-fpm-alpine3.21` - linux; arm variant v6
...
### `php:8.4.12-fpm-alpine3.21` - linux; arm variant v7
...
### `php:8.4.12-fpm-alpine3.21` - linux; arm64 variant v8
...
### `php:8.4.12-fpm-alpine3.21` - linux; 386
...
### `php:8.4.12-fpm-alpine3.21` - linux; ppc64le
...
### `php:8.4.12-fpm-alpine3.21` - linux; s390x
