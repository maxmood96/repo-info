...
```console
$ docker pull php@sha256:a870347468562bd254a24cf38706d64abfdc079301f600ec9e52a37cc8e29082
```
...
### `php:8.2.24-fpm-alpine3.20` - linux; amd64
...
### `php:8.2.24-fpm-alpine3.20` - linux; arm variant v7
...
### `php:8.2.24-fpm-alpine3.20` - linux; arm64 variant v8
...
### `php:8.2.24-fpm-alpine3.20` - linux; 386
...
### `php:8.2.24-fpm-alpine3.20` - linux; ppc64le
...
### `php:8.2.24-fpm-alpine3.20` - linux; s390x
