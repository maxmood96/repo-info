...
```console
$ docker pull php@sha256:3baaabdab9185a40248778f00ad7230654f78fba99115bc0e336d77114d504f8
```
...
### `php:8.2.23-fpm-bullseye` - linux; amd64
...
### `php:8.2.23-fpm-bullseye` - linux; arm variant v7
...
### `php:8.2.23-fpm-bullseye` - linux; 386
...
### `php:8.2.23-fpm-bullseye` - linux; ppc64le
