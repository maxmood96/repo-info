...
```console
$ docker pull php@sha256:8dba4e1d572631820d19e2f33723a195b859705a48ec3a047aad102938b2d27e
```
...
### `php:8.0.16-alpine3.15` - linux; amd64
...
### `php:8.0.16-alpine3.15` - linux; arm variant v7
...
### `php:8.0.16-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.16-alpine3.15` - linux; 386
...
### `php:8.0.16-alpine3.15` - linux; ppc64le
...
### `php:8.0.16-alpine3.15` - linux; s390x
