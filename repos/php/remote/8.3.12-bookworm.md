...
```console
$ docker pull php@sha256:d760a867d613c1da339687ef623e9420bc330a610fc8fa881f3fe046ee45bbac
```
...
### `php:8.3.12-bookworm` - linux; amd64
...
### `php:8.3.12-bookworm` - linux; arm variant v5
...
### `php:8.3.12-bookworm` - linux; arm variant v7
...
### `php:8.3.12-bookworm` - linux; arm64 variant v8
...
### `php:8.3.12-bookworm` - linux; mips64le
...
### `php:8.3.12-bookworm` - linux; ppc64le
...
### `php:8.3.12-bookworm` - linux; s390x
