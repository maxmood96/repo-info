...
```console
$ docker pull php@sha256:929efc7c64008095cd5e385849b8ed5bd10c2b5109f70fdb4721fa972a68aa94
```
...
### `php:8.4.21-apache-trixie` - linux; amd64
...
### `php:8.4.21-apache-trixie` - unknown; unknown
...
### `php:8.4.21-apache-trixie` - linux; arm variant v5
...
### `php:8.4.21-apache-trixie` - linux; arm variant v7
...
### `php:8.4.21-apache-trixie` - linux; arm64 variant v8
...
### `php:8.4.21-apache-trixie` - linux; 386
...
### `php:8.4.21-apache-trixie` - linux; ppc64le
...
### `php:8.4.21-apache-trixie` - linux; s390x
