...
```console
$ docker pull php@sha256:a8a00817451439693313c37f7b22e5226d5e66e826872fb8aae61315bf255bd0
```
...
### `php:8.4.12-alpine3.21` - linux; amd64
...
### `php:8.4.12-alpine3.21` - unknown; unknown
...
### `php:8.4.12-alpine3.21` - linux; arm variant v6
...
### `php:8.4.12-alpine3.21` - linux; arm variant v7
...
### `php:8.4.12-alpine3.21` - linux; arm64 variant v8
...
### `php:8.4.12-alpine3.21` - linux; 386
...
### `php:8.4.12-alpine3.21` - linux; ppc64le
...
### `php:8.4.12-alpine3.21` - linux; s390x
