...
```console
$ docker pull php@sha256:40ed6c89f22a7d2fa16dfae82b6e85ad3d39cbddad3da034bd8c69384df09471
```
...
### `php:8.3-fpm-alpine3.24` - linux; amd64
...
### `php:8.3-fpm-alpine3.24` - unknown; unknown
...
### `php:8.3-fpm-alpine3.24` - linux; arm variant v6
...
### `php:8.3-fpm-alpine3.24` - linux; arm variant v7
...
### `php:8.3-fpm-alpine3.24` - linux; arm64 variant v8
...
### `php:8.3-fpm-alpine3.24` - linux; 386
...
### `php:8.3-fpm-alpine3.24` - linux; ppc64le
...
### `php:8.3-fpm-alpine3.24` - linux; s390x
