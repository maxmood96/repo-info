...
```console
$ docker pull php@sha256:9f083be997d29af8d59e44d99d9435f948c1e835b7e2ae5ba060c8992b47724c
```
...
### `php:8.0.22-zts-alpine` - linux; arm variant v6
...
### `php:8.0.22-zts-alpine` - linux; arm variant v7
...
### `php:8.0.22-zts-alpine` - linux; arm64 variant v8
