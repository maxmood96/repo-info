...
```console
$ docker pull php@sha256:0ae705cc4e7c8e65a2330f0e36ed71379bb6c2ed0840e4efa21b5cfe7aaecec9
```
...
### `php:8.1.26-cli-bullseye` - linux; amd64
...
### `php:8.1.26-cli-bullseye` - linux; arm variant v5
...
### `php:8.1.26-cli-bullseye` - linux; arm variant v7
...
### `php:8.1.26-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.1.26-cli-bullseye` - linux; 386
...
### `php:8.1.26-cli-bullseye` - linux; mips64le
...
### `php:8.1.26-cli-bullseye` - linux; ppc64le
...
### `php:8.1.26-cli-bullseye` - linux; s390x
