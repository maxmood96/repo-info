...
```console
$ docker pull php@sha256:aa2f73830548ca95fb570696915b8a835077a9eda1244be62572d988b1435c45
```
...
### `php:7.4.27-fpm-alpine` - linux; amd64
...
### `php:7.4.27-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.27-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.27-fpm-alpine` - linux; ppc64le
...
### `php:7.4.27-fpm-alpine` - linux; s390x
