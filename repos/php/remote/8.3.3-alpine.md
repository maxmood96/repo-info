...
```console
$ docker pull php@sha256:30f472e379731fe16a74449b585e16d5e91a2c93c827299febb9c0c5e3facac9
```
...
### `php:8.3.3-alpine` - linux; arm variant v6
...
### `php:8.3.3-alpine` - linux; arm variant v7
...
### `php:8.3.3-alpine` - linux; ppc64le
