...
```console
$ docker pull php@sha256:5aea6054239390596b62f38ff2742ac83d8ccd2e774b4bf3bcec5917634b0edd
```
...
### `php:8.0.9-fpm` - linux; arm variant v5
...
### `php:8.0.9-fpm` - linux; arm variant v7
...
### `php:8.0.9-fpm` - linux; arm64 variant v8
