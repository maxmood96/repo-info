...
### `php:8.1.10-apache-bullseye` - linux; amd64
...
### `php:8.1.10-apache-bullseye` - linux; 386
...
### `php:8.1.10-apache-bullseye` - linux; mips64le
...
### `php:8.1.10-apache-bullseye` - linux; ppc64le
...
### `php:8.1.10-apache-bullseye` - linux; s390x
