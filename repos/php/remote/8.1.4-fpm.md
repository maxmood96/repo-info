...
```console
$ docker pull php@sha256:eca32af4341bc7813b0232a56a34a7caf366a90b3a12134b37e79d74dbc78707
```
...
### `php:8.1.4-fpm` - linux; arm variant v5
...
### `php:8.1.4-fpm` - linux; arm variant v7
...
### `php:8.1.4-fpm` - linux; arm64 variant v8
