...
```console
$ docker pull php@sha256:5fa504a4475f1fc59fe0d126762cd01cd6ea22b550359ed523161a5c9351349e
```
...
```console
$ docker pull php@sha256:4c85f59f3be16891647d3ceff89a4e14b418d388790e82011081f361553a26c9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.9 MB (29905251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed17a3abac155d5a0d81be4a84f082d26d51fe114c7d9fd8c5e5d4902843a4c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
