...
```console
$ docker pull php@sha256:d94359be904b969fcc6b1865e113f94599e69b599ae9670a658168b7c27f225a
```
...
### `php:8.0.25-fpm-alpine3.16` - linux; amd64
...
### `php:8.0.25-fpm-alpine3.16` - linux; arm variant v6
...
### `php:8.0.25-fpm-alpine3.16` - linux; arm variant v7
...
### `php:8.0.25-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.25-fpm-alpine3.16` - linux; 386
...
### `php:8.0.25-fpm-alpine3.16` - linux; ppc64le
...
### `php:8.0.25-fpm-alpine3.16` - linux; s390x
