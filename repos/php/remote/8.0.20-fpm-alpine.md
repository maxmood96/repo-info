## `php:8.0.20-fpm-alpine`

```console
$ docker pull php@sha256:7f6bf11b7c8b38516fc10fa551c5c746894c6ac93437cebfcb94529d250dfd35
```
...
### `php:8.0.20-fpm-alpine` - linux; amd64
...
### `php:8.0.20-fpm-alpine` - linux; arm variant v6
...
### `php:8.0.20-fpm-alpine` - linux; arm variant v7
...
### `php:8.0.20-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.0.20-fpm-alpine` - linux; 386
...
### `php:8.0.20-fpm-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:547caeb70b9e6412bd2bc6dafde00f54790afdcc76109d2b7bdc4deeb2c37701
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.0 MB (28006905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41ebe79478282edc1a542f36227344dfc98dcc0fd40315ea6cfd5e07df7d310b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.20-fpm-alpine` - linux; s390x
