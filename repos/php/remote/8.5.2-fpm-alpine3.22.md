...
```console
$ docker pull php@sha256:9c9d51b4445498caaab40525721349579a6ada996533626d6161f5f7891f5216
```
...
### `php:8.5.2-fpm-alpine3.22` - linux; amd64
...
### `php:8.5.2-fpm-alpine3.22` - unknown; unknown
...
### `php:8.5.2-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.5.2-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.5.2-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.5.2-fpm-alpine3.22` - linux; 386
...
### `php:8.5.2-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.5.2-fpm-alpine3.22` - linux; s390x
