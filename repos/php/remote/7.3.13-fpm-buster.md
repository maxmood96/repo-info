...
```console
$ docker pull php@sha256:9b28856c04cf86b5c3e844020c713562bb64719db5396346f71ea0f00220367c
```
...
### `php:7.3.13-fpm-buster` - linux; amd64
...
### `php:7.3.13-fpm-buster` - linux; 386
