...
```console
$ docker pull php@sha256:3d61f7cbc2720b97e5e28a3e9f24573bd563a1aa8bd8eff2b641767c6b0c1b9a
```
...
```console
$ docker pull php@sha256:57cc25783be38a57532f565e9b61421c4aa31c450d17e7e041622ae83f1c6347
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140944116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54feedda99fe4994ca7370215fdba1f61ff61b02392d8b502f50b86d6e3b48a9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
