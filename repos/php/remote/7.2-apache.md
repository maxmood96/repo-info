...
```console
$ docker pull php@sha256:69dcff731fe13f46b0116754757bf5c302787f25a7d32f06305fa1ef8db46d89
```
...
```console
$ docker pull php@sha256:b22151c4b76045fafdc83e6ba4ecc87bd44e4b01764be83443b79bf16aa12b33
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154855855 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78da4f13b5e4975ab09a6a3e916ef60020734234def4d19ef675099958fde5ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
