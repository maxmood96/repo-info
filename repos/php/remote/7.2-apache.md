...
```console
$ docker pull php@sha256:a482a74cdbeefd5401bf1df21be06eeb804ff1b91439d4b54c82149f2630ee93
```
...
```console
$ docker pull php@sha256:87fd92cf727a057fc7ee29e067b923aac64421f132cb288a9bfcbffc0f9aaae9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.8 MB (154835612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3a46877f2370071730e0a67a4db6a94efb3c1d046a2b1de2ab27079ac8c48b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
