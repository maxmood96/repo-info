...
```console
$ docker pull php@sha256:486d42cb69b9e31480ca9470574fa8c27a0d66859a179152b53822fe71be865e
```
...
```console
$ docker pull php@sha256:cbfa89da7d8422976832862b0bf8c5924088da4137fbfaa8ebf702cc4b8a0570
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145590153 bytes)**  
...
```console
$ docker pull php@sha256:29e1d1725e13fb69e1564fac37c1655e7be1922928dfc29cd5cd0b28efb21f16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.3 MB (121322854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dcfe1c55fb4b37d0aa86a624c18dfc83a3efd693236afcce11184c4272d89d0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:446a36dab1ede6d7b1caeff64fda7ed38cdf476d5aae86a8d14437581ee07a52
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.6 MB (127640600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dfe3f3c8d02864317610c28b4a80f1bafae2502290093a11306a304e6bc225e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 05 Mar 2022 00:22:50 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 05 Mar 2022 00:22:54 GMT
COPY multi:ee8b9bb4e448c5d38508b40a8ace77d14cf000229390e687b6d467283c9826e6 in /usr/local/bin/ 
# Sat, 05 Mar 2022 00:23:01 GMT
RUN docker-php-ext-enable sodium
# Sat, 05 Mar 2022 00:23:04 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 05 Mar 2022 00:23:07 GMT
STOPSIGNAL SIGWINCH
# Sat, 05 Mar 2022 00:23:10 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Sat, 05 Mar 2022 00:23:13 GMT
WORKDIR /var/www/html
# Sat, 05 Mar 2022 00:23:17 GMT
EXPOSE 80
# Sat, 05 Mar 2022 00:23:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a06a2178214461966ecf80d564793feccb46a8db8d06d11bb60055443c0b1756`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bba0b21233cef841c032e2f122475aae475e1ebc6b18c1b74496ee153269e5b6`  
		Last Modified: Sat, 05 Mar 2022 07:34:23 GMT  
		Size: 10.1 MB (10133772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13e5ef9493e68c8acd48ac4910adebcb42bbb510f363f0a9b2c805cd0e36a107`  
		Last Modified: Sat, 05 Mar 2022 07:34:14 GMT  
		Size: 2.3 KB (2315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05fb3e2d4439bb49d78111f1843f1a28ab4f01af896fdec5b8cecc4739ca0b6c`  
		Last Modified: Sat, 05 Mar 2022 07:34:14 GMT  
		Size: 250.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd31527a422549f8c768ba33fb445b8a96c5081e9f9e42b7d62a1efa413703ce`  
		Last Modified: Sat, 05 Mar 2022 07:34:14 GMT  
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:a3bd8d0a7161e8042301877c8a03176bc2884d18f404e5fbb2552750de309658
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156132790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc8e5e4428c70722c8445e1c39b6cf532f3170bc5e5dd27ea29e5d091b20b62d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
