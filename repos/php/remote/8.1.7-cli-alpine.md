...
```console
$ docker pull php@sha256:550d7aae4d5d48e27ada0e2987b0eb0829e80c0e8287744c23c7c9789b0337d3
```
...
### `php:8.1.7-cli-alpine` - linux; amd64
...
### `php:8.1.7-cli-alpine` - linux; arm variant v6
...
### `php:8.1.7-cli-alpine` - linux; arm64 variant v8
...
### `php:8.1.7-cli-alpine` - linux; 386
...
### `php:8.1.7-cli-alpine` - linux; s390x
