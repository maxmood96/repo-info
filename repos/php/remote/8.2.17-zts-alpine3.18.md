...
```console
$ docker pull php@sha256:ec22ee56e5b80d9e6154fed41121f9b3528283aa851c571adb6232ae24603a29
```
...
### `php:8.2.17-zts-alpine3.18` - linux; arm variant v7
...
### `php:8.2.17-zts-alpine3.18` - linux; ppc64le

```console
$ docker pull php@sha256:46f564b3e10f616c7403a18b04efe85b5969655261a7be37e95a359909b4e99f
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.3 MB (40328298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8097d155a94adaf59266c1a51b1d41565518f9178a6effb117cd9219d0b68655`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 16 Mar 2024 06:32:44 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--enable-embed 				--enable-zts 		--disable-zend-signals 		--enable-zend-max-execution-timers 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 16 Mar 2024 06:32:45 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Sat, 16 Mar 2024 06:32:47 GMT
RUN docker-php-ext-enable sodium
# Sat, 16 Mar 2024 06:32:47 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 16 Mar 2024 06:32:48 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:931fac3fdabf5f4ef567198e75c2359fbbe48936aac8637bb44a2ede2cfaebf5`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe162256cfc9aa64ff8ea34679815f6e42aab0fbc7f4f21447fa096c65af9d0e`  
		Last Modified: Sat, 16 Mar 2024 07:02:37 GMT  
		Size: 22.1 MB (22075296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98d5b12ab2dc1b7363e3aa1ea73ebaaffc93ca043c4b14b5e1fd60564403863a`  
		Last Modified: Sat, 16 Mar 2024 07:02:33 GMT  
		Size: 2.4 KB (2444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3c95883cef207932beccae12c367fe79ebcb48fde8048029f2b2b55b9df920e`  
		Last Modified: Sat, 16 Mar 2024 07:02:33 GMT  
		Size: 18.7 KB (18735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.2.17-zts-alpine3.18` - linux; s390x
