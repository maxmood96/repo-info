...
```console
$ docker pull php@sha256:76d7ee39f685c11a287fe50708c0e83a2eb8dbd3a1fc6371944dad5ce1ac6ea9
```
...
```console
$ docker pull php@sha256:11ea3f53e8b4acea17dcada0475d39e27043fd7f231eceaa3e6bd205cd71174f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.2 MB (28162335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10206f23e60087d7c450ec08343344c35fb434e2b05efc77796f1923f6d60245`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
