...
```console
$ docker pull php@sha256:f6272bbe5cfde3a6eb931ed9cc1a6aa1f875712c70f7e0e46adc357570daa103
```
...
```console
$ docker pull php@sha256:34fb6a1cb27aaed11e22f25d1227d8170480db2902c8336af787cabe4607b8d3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.4 MB (29404293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e299afe02b273f52ce0e51d79757cd9a59605633e1639b24acbe263818e9f3e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
