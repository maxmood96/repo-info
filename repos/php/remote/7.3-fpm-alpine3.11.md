...
```console
$ docker pull php@sha256:a935a55b3dd7d52aa5bc6baba427b14de9b77ae50ab18d64ea917dec5d78115f
```
...
```console
$ docker pull php@sha256:d1614de26d71297917ee90893766ef3b2cd2bc27dccbebc4e6fe8745aade730e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.4 MB (28357779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce14874f97006e286b7aad10e336438fa3ca7af98a4f270b56645abc380b4b53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:5988054133b4828fc9904891c7b30cfbfe16d2930b321b5d4964d4a6ed719192
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.4 MB (30429328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d68820f5e5a1afca49b67d3e64faa72427035c0f013e163a319c0b1476a6fef7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
