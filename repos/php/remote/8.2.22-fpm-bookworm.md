...
```console
$ docker pull php@sha256:754a90c04904c86011197b38f88e3f32117813560574c465f1de83e825ff673c
```
...
### `php:8.2.22-fpm-bookworm` - linux; amd64
...
### `php:8.2.22-fpm-bookworm` - linux; arm variant v5
...
### `php:8.2.22-fpm-bookworm` - linux; arm variant v7
...
### `php:8.2.22-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.2.22-fpm-bookworm` - linux; 386
...
### `php:8.2.22-fpm-bookworm` - linux; mips64le
...
### `php:8.2.22-fpm-bookworm` - linux; ppc64le
