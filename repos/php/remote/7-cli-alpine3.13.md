...
```console
$ docker pull php@sha256:84e0b6630b276d99ccd8f120e3b215fdcebcb9dc2a7ee2c956b24bef659ef226
```
...
```console
$ docker pull php@sha256:bf0ffdee85ac24f2d3763fee0e0dc855047022cae89216322c6eb2192ee29db0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.3 MB (28258273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea495c34896c11cc5f6b8d2694ad3acff3082ff45b0131e64b2a090cbc673f88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 14 Oct 2021 21:02:40 GMT
COPY multi:a00980ff863125d6071b93844e0a51dc89719405d95217aba6860be950a05740 in /usr/local/bin/ 
# Thu, 14 Oct 2021 21:02:43 GMT
RUN docker-php-ext-enable sodium
# Thu, 14 Oct 2021 21:02:43 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 14 Oct 2021 21:02:44 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:e665d80d6f40a0aaba132178b4e75d00180f01f5f5f2d8cf3bbc3f589d3ca265`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ed54efa5d7970997061f940363b88930faee2ee2a8d61edb0c6b741107ebbcd`  
		Last Modified: Thu, 14 Oct 2021 22:00:37 GMT  
		Size: 13.5 MB (13523958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a17db90123c1ec1cd21c94a1919ace943543dd134e4f635b9387fbb409b5265`  
		Last Modified: Thu, 14 Oct 2021 22:00:28 GMT  
		Size: 2.3 KB (2302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5396964bd017646caf9161108bc610086fd728735854d6c8cf48d8429571f13`  
		Last Modified: Thu, 14 Oct 2021 22:00:28 GMT  
...
```console
$ docker pull php@sha256:d0a578cbfcddb00ea988058b5e211056474653d5d21c33ac005f82f604b6998f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (30001070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d441fefcf226a9b20a319a84e2d41d5950c1ec730cbcf960d14c76faf9c16d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Fri, 24 Sep 2021 02:03:54 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-openssl 		--with-readline 		--with-zlib 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Fri, 24 Sep 2021 02:03:55 GMT
COPY multi:efd917b98407edb5d558edb0edbd8e63c9318f701892aaa449794d019a092f37 in /usr/local/bin/ 
# Fri, 24 Sep 2021 02:03:56 GMT
RUN docker-php-ext-enable sodium
# Fri, 24 Sep 2021 02:03:56 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 24 Sep 2021 02:03:57 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:a909fa4a4fe9ff0db253b2032e0a0120ddaa1ac67e2d6f66f705852cf50bafe6`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:427eafc5678ef2e0700143ab864624b5f3ba5239f671453707e8cd0bb636905f`  
		Last Modified: Fri, 24 Sep 2021 02:38:04 GMT  
		Size: 15.0 MB (14960963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efbeab6be03d5d61ac7d660d3e01898a254801aa2fa74d6bb7ec44417759b180`  
		Last Modified: Fri, 24 Sep 2021 02:37:59 GMT  
		Size: 2.3 KB (2270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0555ffb7f7ed90508b5a6838df2b0a4efead5925fcbd59397ae2617a8a56ee62`  
		Last Modified: Fri, 24 Sep 2021 02:37:59 GMT  
...
```console
$ docker pull php@sha256:93f1140947b44d326dda4f17e56570fbf5cac79e09a92492fe51c2ee1d361b7a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.6 MB (30571839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b04b57a48c3bbbbb4c8b7a3550ed99cbf6ae5d68593b529b7acae251643cfdc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Fri, 24 Sep 2021 02:16:54 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-openssl 		--with-readline 		--with-zlib 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -perm +0111 -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Fri, 24 Sep 2021 02:17:04 GMT
COPY multi:efd917b98407edb5d558edb0edbd8e63c9318f701892aaa449794d019a092f37 in /usr/local/bin/ 
# Fri, 24 Sep 2021 02:17:43 GMT
RUN docker-php-ext-enable sodium
# Fri, 24 Sep 2021 02:17:58 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 24 Sep 2021 02:18:04 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:6bd39bbcf93dd5fe8fa5e309af8ee1e4333b837d52efef1c5bd35be63b61bec9`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c172d1abe583d41b4fa51a3e860ff10727df72510e347ff8b504278b600fe3a6`  
		Last Modified: Fri, 24 Sep 2021 05:16:36 GMT  
		Size: 15.6 MB (15589602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a9c1678ef26dc29c9e6606765070acdf777451824d419caba95838cb8be9ac0`  
		Last Modified: Fri, 24 Sep 2021 05:16:33 GMT  
		Size: 2.3 KB (2265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27e0a1f144b3f0aca9ec761286eabf7712aa86a37235834a26bce62ca6dd744e`  
		Last Modified: Fri, 24 Sep 2021 05:16:33 GMT  
...
```console
$ docker pull php@sha256:9df7a0d145ca974be36d9dc692a68ec800de45777acc07f33cd99565de8ae780
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.7 MB (28699329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff8e112e7a3bfeacc40a8b56edf8b287dbbfab2a4307164aa6687dd28c6e133d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 23 Sep 2021 21:06:05 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 14 Oct 2021 21:19:12 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-openssl 		--with-readline 		--with-zlib 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 14 Oct 2021 21:19:13 GMT
COPY multi:a00980ff863125d6071b93844e0a51dc89719405d95217aba6860be950a05740 in /usr/local/bin/ 
# Thu, 14 Oct 2021 21:19:13 GMT
RUN docker-php-ext-enable sodium
# Thu, 14 Oct 2021 21:19:13 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 14 Oct 2021 21:19:14 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:a8758b59a8bc9c0a14ff345e08de3e093d200639926ce5e85dbc2d610d998a18`  
		...
		Size: 497.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:170c95b8e1f89a51f3b62f83a9a5adb48f2b35c9faa6f69ccd5f8c46b52ddb05`  
		Last Modified: Thu, 14 Oct 2021 22:18:09 GMT  
		Size: 13.9 MB (13913184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dc31652f17609313a1b2efb37e0810f7d18be971b0f61b036fe19bf39ac0812`  
		Last Modified: Thu, 14 Oct 2021 22:18:07 GMT  
		Size: 2.3 KB (2302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6123c7516c6b0dd14ddad0120c0b13653f4e29c411cd542b6c1c59d5f77e656d`  
		Last Modified: Thu, 14 Oct 2021 22:18:07 GMT  
