...
```console
$ docker pull php@sha256:38330e49f60e6b198acd06464e6e288d53beb27d8f005e3809f0b0ea404c0f0e
```
...
### `php:8.4.7-fpm-alpine` - linux; arm variant v7
...
### `php:8.4.7-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.4.7-fpm-alpine` - linux; ppc64le
...
### `php:8.4.7-fpm-alpine` - linux; s390x
