...
```console
$ docker pull php@sha256:6ec71a0f07d26c506572bb42a544d67e3e0cd6cd99cac9118eeb71836b710a12
```
...
### `php:8.1.15-cli-alpine` - linux; amd64
...
### `php:8.1.15-cli-alpine` - linux; arm variant v6
...
### `php:8.1.15-cli-alpine` - linux; arm variant v7
...
### `php:8.1.15-cli-alpine` - linux; arm64 variant v8
...
### `php:8.1.15-cli-alpine` - linux; 386
...
### `php:8.1.15-cli-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:75a378f4ff6e3b25b263781fca37b3211fc1b8a35edf34667a57ba6cf8d6a9e9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.6 MB (34570679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1acf642e59b1cf8591fee242b7ca03d2fcb1df706d1b43f3bd2835c3dba7990`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:8.1.15-cli-alpine` - linux; s390x
