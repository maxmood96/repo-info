...
```console
$ docker pull php@sha256:381edc1130d881aeb35226c675bb63e5e07278c6e0adce2ca7b067b8c617a914
```
...
### `php:8.2.19-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.19-fpm-alpine3.18` - linux; s390x
