...
```console
$ docker pull php@sha256:797c2e4eac722e46a3f0a8ec7561b27c694e279606c521d42083993c16fdc2eb
```
...
### `php:8.2.16-fpm-alpine` - linux; amd64
...
### `php:8.2.16-fpm-alpine` - linux; arm variant v6
...
### `php:8.2.16-fpm-alpine` - linux; arm variant v7
...
### `php:8.2.16-fpm-alpine` - linux; 386
...
### `php:8.2.16-fpm-alpine` - linux; ppc64le
...
### `php:8.2.16-fpm-alpine` - linux; s390x
