...
```console
$ docker pull php@sha256:5d568324dcdbea372698c750b9311764daebfa83f82c6107ba984a7b07b5571c
```
...
### `php:8.1.16-cli` - linux; arm variant v7
