...
```console
$ docker pull php@sha256:2b2e25af295d02772fa8fc0602ac3e8084aa7ce22d79d44aae065df3bfa29a62
```
...
### `php:8.1.24-fpm` - linux; arm variant v7
...
### `php:8.1.24-fpm` - linux; arm64 variant v8
...
### `php:8.1.24-fpm` - linux; ppc64le

```console
$ docker pull php@sha256:c9d7d18ddeb0489cf4070b027aa3108051924fc14c98740d380e5d54d6144dde
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.1 MB (177085897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:223b203dd9e08d6fef58d9832d6c96380373d94d768aec107ee1245643a8afea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
