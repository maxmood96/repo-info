...
```console
$ docker pull php@sha256:8aa562d57b5e3a710fca9aeae601531109ae6e9435028fb1c2262d17415dc72d
```
...
```console
$ docker pull php@sha256:2297a168cb2b42b8464282e4a80e64887bbf4df4599471533d32428c2a1a21de
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.1 MB (29116738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a8d09802a0fc37b96b3ab4e12bb1a00fef211eb7666d437371fe5c661352a64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
