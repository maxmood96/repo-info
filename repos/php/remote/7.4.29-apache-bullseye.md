...
```console
$ docker pull php@sha256:e1bad655c75f310a769bd1bda9ea10f134cdacf103db178f91699a7d9cfddefd
```
...
```console
$ docker pull php@sha256:ea9a3197494fd21c5f295a14d72d2e7282823f46eb49ab5a08b2dcaca46aee87
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.6 MB (140624814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50ef8d6a89f9bfb505a581529ab6423a26ca2a57665cf28bf02e0776ff56b645`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
