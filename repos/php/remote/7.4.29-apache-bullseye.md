...
```console
$ docker pull php@sha256:da319570bd8432802b844c08f3b852810bae11a827a5150921604d57fe50ca84
```
...
### `php:7.4.29-apache-bullseye` - linux; amd64
...
### `php:7.4.29-apache-bullseye` - linux; arm variant v5

```console
$ docker pull php@sha256:ea2990573a282a1515bf55b1c514ffd1fb5c3d0d9e8ab7cf719c03ec36355cf6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.5 MB (141486566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57f09aa2c24c7037da26be9922f96a9e73d908cadff5cea7b3a113f1a3b95cff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.29-apache-bullseye` - linux; arm variant v7

```console
$ docker pull php@sha256:6343fcda50b88ea9ff74a0b7307ef1432220ab173c40d679478808903dc4c163
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.7 MB (133736425 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0564ab6244b44e3600cc6df63e178eede1844e142cecf2d55c7c33695d5e7b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.29-apache-bullseye` - linux; arm64 variant v8
...
### `php:7.4.29-apache-bullseye` - linux; 386
...
### `php:7.4.29-apache-bullseye` - linux; mips64le
...
### `php:7.4.29-apache-bullseye` - linux; ppc64le

```console
$ docker pull php@sha256:a3c0a7ae9a56c95cfc42f89796fc96a2557e5a4f8617ecc20de4297699bb4cb1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164022611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35c044b5b5f286dab9632549e9c1099947d530083e8bf054684b377bc4241fc2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.4.29-apache-bullseye` - linux; s390x
