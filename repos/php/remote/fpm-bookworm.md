...
```console
$ docker pull php@sha256:6fd142d85bbdafa639ff9db23f89eed05461d1aff916a8df75766b4785703fd3
```
...
```console
$ docker pull php@sha256:e1c94a0bcf73d91f4a0d7ef109be8dddab1c8e77f869609584e0fdff1dd705f8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152135157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:030f0f74acc493564a32f94d6fbad9d034cffead4d91034ae405bf81fe313cc0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:29c585c047e7879d9d48f15044cff6d43f9d5b657e2f7a4575d69b128d5785a6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 KB (50998 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2b2d19c29f4604931de0d0704d5164df6f8a809280663cae0763cae974c8c84`

```dockerfile
```

-	Layers:
	-	`sha256:6cdba394a6b98d14e4ab61f3a966745a7af6c455ff61f8064c87d66cebe86f1e`  
		Last Modified: Wed, 11 Jun 2025 04:55:20 GMT  
...
```console
$ docker pull php@sha256:d02627d4d1fd00799ca79d7d045aa2b12280e4d0d64b3bf4901d56ee39311e20
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.5 MB (180486866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0d5d36784e77c44c80c559c1ec6ca95a3dad42b9164035e484e82e87d9d1d28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:abf5b378841a66df183bd9b053211e39dc53eb78a259848dcf38ec4d965aa9ad
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.4 MB (6430509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9926f572cd260bd941ac4dd69e4117992be53800f8749fefe7556cd20cd7d1b`

```dockerfile
```

-	Layers:
	-	`sha256:4d85211838d23b31534a5de6d40c6ddc348e0803c5d35f46366f2caa62862144`  
		Last Modified: Wed, 11 Jun 2025 04:55:24 GMT  
		Size: 6.4 MB (6379326 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1589f8a667163849af27dd88a383d8ae8733aaaffdce10901cfbfd3b7ae1c328`  
		Last Modified: Wed, 11 Jun 2025 04:55:25 GMT  
