...
```console
$ docker pull php@sha256:a1b547addc4e531aa50229c3723378009ee2209b31d86a4ba7f597346a5ac3bc
```
...
```console
$ docker pull php@sha256:82a2a3dff87848e4b804b8ae9a10dfd56940973f47f76e035d664407871675cf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152113314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e9323f7dc8c2c08cc33bd92a2b8c28081d945c759a90bab7967b321fc0aea3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:3356f49ab2170c56f038c1721840fa29bb8f1fac8c248f404762e2f19c026ae6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 KB (50998 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:952bd4860e70d2cecf1b3a586ebccb78298592a82be47b7e8cb7e9e0c3b9a946`

```dockerfile
```

-	Layers:
	-	`sha256:aa787882328aa23914cfad402341bb81eb5742ea95b8773d61a202cd1ce4656c`  
		Last Modified: Tue, 08 Apr 2025 05:25:19 GMT  
