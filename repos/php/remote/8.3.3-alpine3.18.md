...
```console
$ docker pull php@sha256:58659ce19e3472ce5e8a40dd5183530f69af7457c9d5e58d98377913ef2655ff
```
...
### `php:8.3.3-alpine3.18` - linux; amd64
...
### `php:8.3.3-alpine3.18` - linux; 386
...
### `php:8.3.3-alpine3.18` - linux; s390x
