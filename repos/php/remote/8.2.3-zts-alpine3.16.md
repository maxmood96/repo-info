...
```console
$ docker pull php@sha256:946135fc660d8ccbb4a85402fb6bb3d8a22cfffa80f76d4f15f90f0db2bc22e1
```
...
### `php:8.2.3-zts-alpine3.16` - linux; amd64
...
### `php:8.2.3-zts-alpine3.16` - linux; arm64 variant v8
...
### `php:8.2.3-zts-alpine3.16` - linux; 386
...
### `php:8.2.3-zts-alpine3.16` - linux; ppc64le
...
### `php:8.2.3-zts-alpine3.16` - linux; s390x
