...
```console
$ docker pull php@sha256:7d6bf9a1b291eef3f9615d71801da64dc5fa776dc818256c7a4d82ff6c265219
```
...
### `php:8.4.6-alpine3.20` - linux; amd64
...
### `php:8.4.6-alpine3.20` - unknown; unknown
...
### `php:8.4.6-alpine3.20` - linux; arm variant v6
...
### `php:8.4.6-alpine3.20` - linux; arm variant v7
...
### `php:8.4.6-alpine3.20` - linux; arm64 variant v8
...
### `php:8.4.6-alpine3.20` - linux; 386
...
### `php:8.4.6-alpine3.20` - linux; ppc64le
...
### `php:8.4.6-alpine3.20` - linux; s390x
