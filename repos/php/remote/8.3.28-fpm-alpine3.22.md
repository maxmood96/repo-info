...
### `php:8.3.28-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.3.28-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.3.28-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.3.28-fpm-alpine3.22` - linux; riscv64
...
### `php:8.3.28-fpm-alpine3.22` - linux; s390x
