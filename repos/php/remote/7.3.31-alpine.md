...
```console
$ docker pull php@sha256:46c4b9b68059735f336c9721b75172834d8d19782cf402c8abd528b40c117526
```
...
### `php:7.3.31-alpine` - linux; arm variant v6
...
### `php:7.3.31-alpine` - linux; arm variant v7
...
### `php:7.3.31-alpine` - linux; arm64 variant v8
