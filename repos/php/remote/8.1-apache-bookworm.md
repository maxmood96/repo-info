...
```console
$ docker pull php@sha256:cc15a46074bfa5c47149935e3eee5f24bfe7e1188e1db9918d309598c29f66b3
```
...
```console
$ docker pull php@sha256:348b9e083a8ff4152999f05c635bd4e3ad09f88c7a06226f40971257697bb59d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.5 MB (151514266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13214545d8fa27b1c0bf10c2a12678dd81b354bd8743e8ab1c6f16b0bea89bd3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:021f16c1326f6a54c6f17d8b32537ccedd4380a5431dac6b7aed3d73c98f390b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.2 KB (59160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f5f9898a88f29fe79f39f940105a3060e2daf4f6fe0e3ce15020e1a4320436b`

```dockerfile
```

-	Layers:
	-	`sha256:cb75325e573ade2368872ef01f09316ca1fa43e464c3a0dc4e7d8eb7936b4a72`  
