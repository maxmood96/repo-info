...
```console
$ docker pull php@sha256:03a685890541699750b27316f6d906db04f97ca68d1e46b04390a214af7b67e7
```
...
```console
$ docker pull php@sha256:68b69241e66381b62eabaffd011e362120c55c6c68d0c4400e02d4514b0d3bac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (151972511 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d396b09d1c2784c48729c91a52859087017a8e1589ae08a774efaa6e261e7615`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
