...
```console
$ docker pull php@sha256:2612ba30efaab9532c82571090b69e8ea376946610b5c79ea5cd538bfcb8fe34
```
...
```console
$ docker pull php@sha256:57c7cf8122562711fe3baf31411024507a8af41b8499bdcb128143f20bc1bed5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152115472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70fd268465875e2eaf9071dc18dfeca3b73a4e9e1e8af1fc7f583daa2ee661b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
