...
```console
$ docker pull php@sha256:76dedc7635c40f6efe26b6a052c9fdcbd5b0450062c69f4a0f66c18ce9c0cd47
```
...
```console
$ docker pull php@sha256:8e651197047f3c8d7fa1db22dff3aa57398e2a14f56793eedaf30c2bdbefd35e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176119804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcdfabf73a3de1050c0726cf72c6db1964bed75c4ff6d4647ee31e5bbe4b811f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
