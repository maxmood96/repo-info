...
```console
$ docker pull php@sha256:a6c3178a1b84033d778f33b6a2f6f7e226d9b963506554f14965c2def05d2a88
```
...
### `php:8.4.12-fpm-trixie` - linux; amd64
...
### `php:8.4.12-fpm-trixie` - unknown; unknown
...
### `php:8.4.12-fpm-trixie` - linux; arm variant v5
...
### `php:8.4.12-fpm-trixie` - linux; arm variant v7
...
### `php:8.4.12-fpm-trixie` - linux; arm64 variant v8
...
### `php:8.4.12-fpm-trixie` - linux; 386
...
### `php:8.4.12-fpm-trixie` - linux; ppc64le
...
### `php:8.4.12-fpm-trixie` - linux; s390x
