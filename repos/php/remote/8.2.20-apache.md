...
```console
$ docker pull php@sha256:23269f94479d7f679ab09e9221ed58ef0fae0173f9e7300082b3de7cb7b20abf
```
...
### `php:8.2.20-apache` - linux; arm variant v5
...
### `php:8.2.20-apache` - linux; arm variant v7
...
### `php:8.2.20-apache` - linux; arm64 variant v8
...
### `php:8.2.20-apache` - linux; ppc64le
