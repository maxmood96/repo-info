...
```console
$ docker pull php@sha256:92e9d2a4c6888a712f6002659bdf93d16609734f0720f618e214083b220d5b3a
```
...
```console
$ docker pull php@sha256:8b61ca4d00ed1bd7ea4e181d679ae521ada0f6988f44790b3e4339cce1206164
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.8 MB (26843776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fe3c8dcf4775a4e10b3a061c01cfdce8f1a90eaf0af0e65aace8b4e78eec879`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
