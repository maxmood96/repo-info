...
```console
$ docker pull php@sha256:bc6a127217877045e6fe1f3c99546f26c3c31b51b2f6f2692736e37ccd741651
```
...
```console
$ docker pull php@sha256:500628a28ce0eb9b094485de23c05d8ce429ab18a1285807457429643ece4fe6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.5 MB (25485993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d6610b9006ff1a2e2cc3e39abfe77a34a27e6d219ea3dde285470a9ac7b0efc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
