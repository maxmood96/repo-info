...
```console
$ docker pull php@sha256:353848f9b3fb64a5c45657b34e665eff3cb9800552862e284d264d8b2fbc8263
```
...
### `php:8.4.13-apache` - unknown; unknown
...
### `php:8.4.13-apache` - linux; arm variant v5
...
### `php:8.4.13-apache` - linux; arm variant v7
...
### `php:8.4.13-apache` - linux; arm64 variant v8
...
### `php:8.4.13-apache` - linux; ppc64le
