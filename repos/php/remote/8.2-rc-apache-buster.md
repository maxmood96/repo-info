...
```console
$ docker pull php@sha256:05f7ad58514388ff47f7efedb36b4ba54b4e133087ac44563a1cf67431f63273
```
...
```console
$ docker pull php@sha256:54ea81744da6962a723c6739c422fdbaf1d004aed67ec89af43837b998526b95
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.2 MB (146179262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e192ee53351deadc0cbe523f3d1b05e0db7a2cd6aa724099ff7a907788cac70`
...
-	Layers:
	...
	-	`sha256:56a2658f0454892c01b65e280148f40371cfe61e873bd89c6b4d7be81d1ee27b`  
		...
		Size: 513.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fd43dc66a3c07095b7fe33e51321398de080c08d47626a22a9752c62aec4214`  
		Last Modified: Sat, 27 May 2023 03:08:21 GMT  
		Size: 12.4 MB (12355955 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5de768bea28b20c7254f5ad09182751e737bbe64b265eec8112bd21d42f47dfc`  
		Last Modified: Sat, 27 May 2023 03:08:18 GMT  
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09a7778014162f405744c44be37c21a34321e7c01a6afb421ff6ed8eb87289f1`  
		Last Modified: Sat, 27 May 2023 03:08:20 GMT  
		Size: 11.3 MB (11294877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d943615148eb257b7f83c9cac3293a11f7c13811ac420073561292c2c0dba09a`  
		Last Modified: Sat, 27 May 2023 03:08:18 GMT  
		Size: 2.5 KB (2460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f375d615df2358c6df028928fe77f8f797c2e471a4a36a3c0f06696b0f2f9dd2`  
		Last Modified: Sat, 27 May 2023 03:08:18 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d2e378146cf8293c51066e89b27d7c09bdda54528a9b3c22b70a8075837f06f`  
		Last Modified: Sat, 27 May 2023 03:08:18 GMT  
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:b21e224307a05e9a66dc9e5baa835d2790b1f2d8fb6d0ae6851e5dc4cc3f70ae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.9 MB (121904388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c217c94d32bae4e61a94c2e043eeff6ce7a118a79e407abfc8cae206a0928938`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 May 2023 07:11:46 GMT
ENV GPG_KEYS=39B641343D8C104B2B146DC3F9C39DC0B9698544 E60913E4DF209907D8E30D96659A97C9CF2A795A 1198C0117593497A5EC5C199286AF1F9897469DC
# Sat, 27 May 2023 01:43:23 GMT
ENV PHP_VERSION=8.2.7RC1
# Sat, 27 May 2023 01:43:23 GMT
ENV PHP_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz PHP_ASC_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz.asc
# Sat, 27 May 2023 01:43:23 GMT
ENV PHP_SHA256=af19cc4c5b50034e59186c369fd152c47f86b8eb921b41d67b61e64b42217ce9
# Sat, 27 May 2023 01:43:38 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Sat, 27 May 2023 01:43:38 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 27 May 2023 01:45:51 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 27 May 2023 01:45:52 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Sat, 27 May 2023 01:45:52 GMT
RUN docker-php-ext-enable sodium
# Sat, 27 May 2023 01:45:52 GMT
...
-	Layers:
	...
	-	`sha256:2b6934476b06beca7ea9b9b23a6f10911ebaafbf25050c6592ebc54916ba1c5b`  
		...
		Size: 516.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76ff287f35b92a097af5e91c324f877b6bb13b59a1714bf22d232324501142a4`  
		Last Modified: Sat, 27 May 2023 02:47:50 GMT  
		Size: 12.4 MB (12353870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d487d06e978f79f00b60f4923fe146c85297df973daa4b9559da051cd2788ab2`  
		Last Modified: Sat, 27 May 2023 02:47:47 GMT  
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24314281e8674885f9f215854ea86493ecfca3a3b9d1da05605fdba796032c51`  
		Last Modified: Sat, 27 May 2023 02:47:49 GMT  
		Size: 9.8 MB (9771586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1c55a7fac36c49053c78ac718f683ed7232c94e9cba2a584fe96b48c2407baf`  
		Last Modified: Sat, 27 May 2023 02:47:47 GMT  
		Size: 2.5 KB (2456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b358900a6c90467f6ee6832295767413f3c51b6e02fbedb6936ec3012a6821af`  
		Last Modified: Sat, 27 May 2023 02:47:47 GMT  
		Size: 245.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14e65997e301f548bbcb374bf34cf27311485d88611b9b5bca0fb29303856759`  
		Last Modified: Sat, 27 May 2023 02:47:47 GMT  
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:ab31ab24e0f08527617090d488ffe2dab61d9a29a379df4a2517866ae7437010
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.6 MB (138609178 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7295f237328f437f10df308474f2f7a4662a6f3ff07f299ecd54931de61865e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 May 2023 04:27:36 GMT
ENV GPG_KEYS=39B641343D8C104B2B146DC3F9C39DC0B9698544 E60913E4DF209907D8E30D96659A97C9CF2A795A 1198C0117593497A5EC5C199286AF1F9897469DC
# Sat, 27 May 2023 01:04:04 GMT
ENV PHP_VERSION=8.2.7RC1
# Sat, 27 May 2023 01:04:04 GMT
ENV PHP_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz PHP_ASC_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz.asc
# Sat, 27 May 2023 01:04:04 GMT
ENV PHP_SHA256=af19cc4c5b50034e59186c369fd152c47f86b8eb921b41d67b61e64b42217ce9
# Sat, 27 May 2023 01:04:13 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Sat, 27 May 2023 01:04:13 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 27 May 2023 01:07:12 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 27 May 2023 01:07:12 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Sat, 27 May 2023 01:07:13 GMT
RUN docker-php-ext-enable sodium
# Sat, 27 May 2023 01:07:13 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 27 May 2023 01:07:13 GMT
...
-	Layers:
	...
	-	`sha256:b3cb02374b91e069a07701f09049791d56f83ce345a0e351bcec67ccb5308e60`  
		...
		Size: 514.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:879b3085e2a09ce3935903b85d38e8987142cfd793a0de9eb9b04194ff34bfcc`  
		Last Modified: Sat, 27 May 2023 02:29:15 GMT  
		Size: 12.4 MB (12354702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46640460c29ca6171a52782f3b713e74cb419f6647f4aaf684ea1693306b7683`  
		Last Modified: Sat, 27 May 2023 02:29:12 GMT  
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee427c710cfaa0e010a426f4148e078bc2cbc45ceca5a8007407a30dbac74c9d`  
		Last Modified: Sat, 27 May 2023 02:29:14 GMT  
		Size: 11.4 MB (11373513 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23c5e7c2512deddea4741ae04dbcea6b5d8cf2f45317841fd6961bd55e403bba`  
		Last Modified: Sat, 27 May 2023 02:29:12 GMT  
		Size: 2.5 KB (2457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2b9ca96bec57be704cd1b239f83da0d82b91f330a7a7e22c6f40ad000a19c6f`  
		Last Modified: Sat, 27 May 2023 02:29:12 GMT  
		Size: 247.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:578195a1ea061a4a4b48efede344532c976ce0f8360aec63bf7846cbd3f1bffe`  
		Last Modified: Sat, 27 May 2023 02:29:12 GMT  
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:75202931ad12b461c29d147b7e3c55b94d7797c3f4c32d3177767de6d150ca2a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152047607 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3992d58f63b975cde1677c00db0d1306a069082e4f0b5854233596552a79e194`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 May 2023 13:06:05 GMT
ENV GPG_KEYS=39B641343D8C104B2B146DC3F9C39DC0B9698544 E60913E4DF209907D8E30D96659A97C9CF2A795A 1198C0117593497A5EC5C199286AF1F9897469DC
# Sat, 27 May 2023 01:04:59 GMT
ENV PHP_VERSION=8.2.7RC1
# Sat, 27 May 2023 01:04:59 GMT
ENV PHP_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz PHP_ASC_URL=https://downloads.php.net/~pierrick/php-8.2.7RC1.tar.xz.asc
# Sat, 27 May 2023 01:04:59 GMT
ENV PHP_SHA256=af19cc4c5b50034e59186c369fd152c47f86b8eb921b41d67b61e64b42217ce9
# Sat, 27 May 2023 01:05:10 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Sat, 27 May 2023 01:05:10 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 27 May 2023 01:09:57 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 27 May 2023 01:09:58 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Sat, 27 May 2023 01:09:58 GMT
RUN docker-php-ext-enable sodium
# Sat, 27 May 2023 01:09:58 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 27 May 2023 01:09:59 GMT
STOPSIGNAL SIGWINCH
# Sat, 27 May 2023 01:09:59 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Sat, 27 May 2023 01:09:59 GMT
...
-	Layers:
	...
	-	`sha256:fa5cc15d0327b6b0bd19cb07e50d8a9581949b526b796aae521f0cebcc129d75`  
		...
		Size: 517.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a80e88dad8b292eb11a176ecbf4cabf01ccd4c3c43d097eeb0b03395d1109ea`  
		Last Modified: Sat, 27 May 2023 03:18:43 GMT  
		Size: 12.4 MB (12355255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f04b143b1e6feed0445f40a1391096a592f672f3eb8e96ce764a011eee7be1d`  
		Last Modified: Sat, 27 May 2023 03:18:40 GMT  
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff67ac8c68b9a23803b4ffd6a5b427cdd0e7e4115c83e56047857e3748249234`  
		Last Modified: Sat, 27 May 2023 03:18:43 GMT  
		Size: 11.5 MB (11532565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4e7edbb032686c1bf3825a8b16030169be74eb136f0df62f8b2ef3b68f2e2c0`  
		Last Modified: Sat, 27 May 2023 03:18:40 GMT  
		Size: 2.5 KB (2460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c149404a598a7e20645b96a3c741f8ef33e23984a4c3baf2ae787c3e756d5e3f`  
		Last Modified: Sat, 27 May 2023 03:18:40 GMT  
		Size: 245.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e4823f9848dcd9028286faad8eea61b846958a9f050f258631ed967beebc855`  
		Last Modified: Sat, 27 May 2023 03:18:40 GMT  
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
