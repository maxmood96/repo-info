...
```console
$ docker pull php@sha256:d33826ffba901d894ae08001ad00db62a42171b5b870aaa49128eefd0aa05ca3
```
...
### `php:8.5.7-fpm-alpine3.23` - linux; amd64
...
### `php:8.5.7-fpm-alpine3.23` - unknown; unknown
...
### `php:8.5.7-fpm-alpine3.23` - linux; arm variant v6
...
### `php:8.5.7-fpm-alpine3.23` - linux; arm variant v7
...
### `php:8.5.7-fpm-alpine3.23` - linux; arm64 variant v8
...
### `php:8.5.7-fpm-alpine3.23` - linux; 386
...
### `php:8.5.7-fpm-alpine3.23` - linux; ppc64le
...
### `php:8.5.7-fpm-alpine3.23` - linux; riscv64

```console
$ docker pull php@sha256:647809844b9aadd98843075e61a4f0e3a72caf88a1edf1389e01e501022fa74f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.1 MB (38101287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:281788bde2fc5a2c504e479bf099f9709813662748aeedf31f1a23c866121efc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull php@sha256:08d1bfcf3b258413f52a280de226265bd7633ecd51d1d024e8ce8588903985e7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.1 KB (324063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:925bd4a6dd73151b042e016aea5da1e9cd1f99cccebb4225fad3a2eafebdd6d5`

```dockerfile
```

-	Layers:
	-	`sha256:9be937eccdb6ac32fd8bb267c07575d9770c5c69a20ce24d3ad30b3595ef1daf`  
		Last Modified: Fri, 05 Jun 2026 06:38:25 GMT  
		Size: 275.0 KB (274982 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:128510d895889ce47b6eb4aea378facb2d20b6d4d5884c4e9fe0fb618b98a368`  
		Last Modified: Fri, 05 Jun 2026 06:38:24 GMT  
		Size: 49.1 KB (49081 bytes)  
		MIME: application/vnd.in-toto+json

### `php:8.5.7-fpm-alpine3.23` - linux; s390x
