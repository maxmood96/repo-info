## `php:8.0.23-zts-buster`

```console
$ docker pull php@sha256:872f1c8368d6d07dcbfd36eea833b8a6bcce37ef36ed39fe0a2a2f6b5bab1b49
```
...
### `php:8.0.23-zts-buster` - linux; amd64

```console
$ docker pull php@sha256:151bc46e8dd637e53dd0e0edca51bf03b69ca105b05068b4d9b741054b79c6f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140915024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:671587579e6f76fcb6ae33137a7f7d39755ed4953024bcaef294e9abe5318689`
...
-	Layers:
	...
	-	`sha256:e3fe5f2647b13cf7e197bbc7ec9e82d9827501afa7792f0f9dd7e6c68777c207`  
		...
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a297f388ada10f5772a0721f182f2dbec6516476bc8933e18ea690bf24f302b`  
		Last Modified: Thu, 01 Sep 2022 23:07:36 GMT  
		Size: 25.9 MB (25906947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7547735da96b10cc9c73c2d7e25e6bed1d96c8ce2cb62441be759f5841abca6`  
		Last Modified: Thu, 01 Sep 2022 23:07:32 GMT  
		Size: 2.5 KB (2450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb0342e8400b6465933496c283643fa10311cb7eda3ba0d86af0846a1a3e1878`  
		Last Modified: Thu, 01 Sep 2022 23:07:32 GMT  
		Size: 243.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.0.23-zts-buster` - linux; 386

```console
$ docker pull php@sha256:8f2177f99f05177f0f6a7d1bfb93f473de5bdbdcaf98a11005af1409d41c4183
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.2 MB (146193200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a2d7175ad7f9a4febb96f7e0cc3ff0c84218a9af84c44f95a4f795ad587c01d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 01 Sep 2022 22:40:55 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--enable-embed 				--enable-zts 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 01 Sep 2022 22:40:56 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 01 Sep 2022 22:40:56 GMT
RUN docker-php-ext-enable sodium
# Thu, 01 Sep 2022 22:40:57 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 01 Sep 2022 22:40:58 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:f19618507218af9e78b6afbdee928d9913c580c363b27bec1d4ac913c175bc96`  
		...
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f3299fe3358192602507cd3102e993cd1e1ce83c9dffe7d41bceb412b407824`  
		Last Modified: Thu, 01 Sep 2022 23:29:24 GMT  
		Size: 26.2 MB (26192983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca5ecd2d27d8c4aab3a61872fbb4fd3a03c8456745456d36280611c632c6fbac`  
		Last Modified: Thu, 01 Sep 2022 23:29:20 GMT  
		Size: 2.5 KB (2451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfa394190a3868b3b9478353e9b05300e4de83849640be8d58349d4e3b3efceb`  
		Last Modified: Thu, 01 Sep 2022 23:29:20 GMT  
		Size: 246.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
