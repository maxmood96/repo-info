...
### `php:8.4.2-alpine` - unknown; unknown
...
### `php:8.4.2-alpine` - linux; arm variant v6
...
### `php:8.4.2-alpine` - linux; arm variant v7
...
### `php:8.4.2-alpine` - linux; arm64 variant v8
...
### `php:8.4.2-alpine` - linux; ppc64le
...
### `php:8.4.2-alpine` - linux; riscv64
