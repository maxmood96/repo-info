...
```console
$ docker pull php@sha256:de22e4b7710a47117ad5f27bf93e6d10974617934fff311bedbcb57bab3acc0b
```
...
### `php:8.3.11-apache-bullseye` - linux; amd64
...
### `php:8.3.11-apache-bullseye` - linux; arm variant v5
...
### `php:8.3.11-apache-bullseye` - linux; arm variant v7
...
### `php:8.3.11-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.11-apache-bullseye` - linux; 386
...
### `php:8.3.11-apache-bullseye` - linux; ppc64le
...
### `php:8.3.11-apache-bullseye` - linux; s390x
