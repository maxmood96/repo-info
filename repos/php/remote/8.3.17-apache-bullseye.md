...
```console
$ docker pull php@sha256:c81aa6bc332ca87e9d04e2491c44615ce3649e465fee8e920b4acc7e293622b8
```
...
### `php:8.3.17-apache-bullseye` - linux; amd64
...
### `php:8.3.17-apache-bullseye` - unknown; unknown
...
### `php:8.3.17-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.17-apache-bullseye` - linux; 386
