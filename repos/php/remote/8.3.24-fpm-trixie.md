...
### `php:8.3.24-fpm-trixie` - linux; amd64
...
### `php:8.3.24-fpm-trixie` - unknown; unknown
...
### `php:8.3.24-fpm-trixie` - linux; arm variant v5
...
### `php:8.3.24-fpm-trixie` - linux; arm variant v7
...
### `php:8.3.24-fpm-trixie` - linux; arm64 variant v8
...
### `php:8.3.24-fpm-trixie` - linux; 386
...
### `php:8.3.24-fpm-trixie` - linux; ppc64le
...
### `php:8.3.24-fpm-trixie` - linux; riscv64
...
### `php:8.3.24-fpm-trixie` - linux; s390x
