...
```console
$ docker pull php@sha256:4112094939cfb744d8054477ca84109181a63fefc9f77336b277aec63c87564d
```
...
### `php:8.3.9-fpm-alpine3.20` - linux; amd64
...
### `php:8.3.9-fpm-alpine3.20` - linux; arm variant v6
...
### `php:8.3.9-fpm-alpine3.20` - linux; arm variant v7
...
### `php:8.3.9-fpm-alpine3.20` - linux; arm64 variant v8
...
### `php:8.3.9-fpm-alpine3.20` - linux; 386
...
### `php:8.3.9-fpm-alpine3.20` - linux; ppc64le
...
### `php:8.3.9-fpm-alpine3.20` - linux; s390x
