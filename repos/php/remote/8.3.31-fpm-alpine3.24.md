...
### `php:8.3.31-fpm-alpine3.24` - linux; 386
...
### `php:8.3.31-fpm-alpine3.24` - linux; ppc64le
...
### `php:8.3.31-fpm-alpine3.24` - linux; riscv64
...
### `php:8.3.31-fpm-alpine3.24` - linux; s390x
