...
```console
$ docker pull php@sha256:5144fcc8cea663d0a2cb815248644987f8f7540ba55537023f9ce7b18db0a072
```
...
### `php:7-alpine3.15` - linux; amd64

```console
$ docker pull php@sha256:6e2757709a952c37b449f4b836dffc73f2c94f5ad4aebc1f118e68a4f362fef3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (30044567 bytes)**  
...
-	Layers:
	...
	-	`sha256:b7a3a837776d3a802b486e499a207f4fce753fdf189d758dbeda592b7d212e00`  
		...
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cb2ce63b2f4704a38d83afdf5b669815a2bad894a595c9220de8f2b69aff7c6`  
		Last Modified: Tue, 09 Aug 2022 23:09:35 GMT  
		Size: 15.0 MB (15044421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:797954581941528f169e84ed7d6f3bf0ef661b753be817b73436e1e24ee95b39`  
		Last Modified: Tue, 09 Aug 2022 23:09:33 GMT  
		Size: 2.4 KB (2446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:627ce393bcd8db196d61688e179f52f28ab691a02aaa8cad2d784d2d4ca381d9`  
		Last Modified: Tue, 09 Aug 2022 23:09:33 GMT  
		Size: 18.7 KB (18668 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:7-alpine3.15` - linux; arm variant v6

```console
$ docker pull php@sha256:6af3d62f1c44ac7c3e144b5352a2d536d621fc54422ad6f3b5db93115ca6c5d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.8 MB (28823113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8fed28a2617f07fd2949f7d167b5f1a3b76281cc7e343a26d832ca02814d49a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Wed, 10 Aug 2022 15:41:52 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 10 Aug 2022 15:52:49 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 	ln -sv /usr/include/gnu-libiconv/*.h /usr/include/; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 10 Aug 2022 15:52:49 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 10 Aug 2022 15:52:50 GMT
RUN docker-php-ext-enable sodium
# Wed, 10 Aug 2022 15:52:51 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 10 Aug 2022 15:52:51 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:fe86a9b198378b093212068687b6ce43c08a78dfb9a5608df048fce437b952d6`  
		...
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a86ef6dd72181213ed619eddd7133ed98e44c1074059413734d44ab01b6cbd6b`  
		Last Modified: Wed, 10 Aug 2022 16:31:33 GMT  
		Size: 14.0 MB (14025855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbbb5a8c23202124829dcabca9809312526426abc6171d633fe8d77316f5d01d`  
		Last Modified: Wed, 10 Aug 2022 16:31:29 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c79b8ed98ae9de71f98cc22d83c6af6eb90218b3945e64f798f132fc9ac73c4`  
		Last Modified: Wed, 10 Aug 2022 16:31:29 GMT  
		Size: 18.7 KB (18656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:7-alpine3.15` - linux; arm variant v7

```console
$ docker pull php@sha256:76ae5a4ee3dc22f47e505c6087f14ee0b98289a6f24a38ba6fd04e508e217966
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.6 MB (27636403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6f0195965c090ad5005f57b55ebba830d79ec80aa19f5a0d3bfd302e80dcae3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:b6e53a7e1cce78ef6e82d27daf5db707b3a532b4e200a4c0083916fd1ccbef21`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e0cff8850a2934e936365c9d5d660b46ac9fcae8047ce6fa6ab33d8307dbb6c`  
		Last Modified: Wed, 10 Aug 2022 19:29:54 GMT  
		Size: 13.2 MB (13167303 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df7c01cbfa69179ef0ae0bae13bcdd3f7598abe0593e5108a4d5f85ec41a50e2`  
		Last Modified: Wed, 10 Aug 2022 19:29:50 GMT  
		Size: 2.4 KB (2446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fec736f3be3189c711feccdfaac2ad970b618e1a727b71ec3ee8476849e1ecf`  
		Last Modified: Wed, 10 Aug 2022 19:29:50 GMT  
		Size: 18.6 KB (18647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:7-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull php@sha256:be560f80c1cf5aa15924ab11913effc4901716b94531ce67341f8086e78e38d8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.7 MB (29711446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e5384515290c1efd4aacd93b8361ee49cef252a36b8cc9e179babffb1362634`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 10 Aug 2022 01:57:56 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 	ln -sv /usr/include/gnu-libiconv/*.h /usr/include/; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 10 Aug 2022 01:57:57 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 10 Aug 2022 01:57:58 GMT
RUN docker-php-ext-enable sodium
# Wed, 10 Aug 2022 01:57:58 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 10 Aug 2022 01:57:59 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:90020a9dfe6dfcc02866351c4d9c43eb847b6d389b5e38935cc71e016728905f`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eca42fef8f189401812f9ca71f1296bc670c1600e8f6704140f4647ffdace2e9`  
		Last Modified: Wed, 10 Aug 2022 02:25:15 GMT  
		Size: 14.8 MB (14816252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7413bc8b2ed3422994c5354393554f197f07eaad976271b9493fb901258de442`  
		Last Modified: Wed, 10 Aug 2022 02:25:13 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e57a6126c4bf1ebe5765cf732d323384c13046de6f5144ef2f745275e8d3b03`  
		Last Modified: Wed, 10 Aug 2022 02:25:13 GMT  
		Size: 18.6 KB (18569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:7-alpine3.15` - linux; 386
...
### `php:7-alpine3.15` - linux; ppc64le
...
### `php:7-alpine3.15` - linux; s390x

```console
$ docker pull php@sha256:2d003f6196e12700c833f25dab11859460c47971391f91fa8b633e03ff38d532
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.2 MB (29247268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c432d7446be2f7d19808b85ed49fe3420e3958968a96e9a33399e5f56d2b381`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 10 Aug 2022 00:55:40 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 	ln -sv /usr/include/gnu-libiconv/*.h /usr/include/; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 10 Aug 2022 00:55:42 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 10 Aug 2022 00:55:43 GMT
RUN docker-php-ext-enable sodium
# Wed, 10 Aug 2022 00:55:43 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 10 Aug 2022 00:55:44 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:2c28c3f09f2b41aad12319a9ef194faab7eb5ee7373924158340ac1c832414a3`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e3981d736e33228ddf61d67d8761fbf698b5fae29b2e9b93306f42624fdc3c4`  
		Last Modified: Wed, 10 Aug 2022 02:29:58 GMT  
		Size: 14.4 MB (14403911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8df2a50fc5b8f01fd640ed22d38eed3b2a252f0851b1fc545e6dcf9c0df19a4`  
		Last Modified: Wed, 10 Aug 2022 02:29:58 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12d9c652a570eab4015e9e19553587562546c5fb28784446a96d5c7fcce39b77`  
		Last Modified: Wed, 10 Aug 2022 02:29:58 GMT  
