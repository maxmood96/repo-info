...
```console
$ docker pull php@sha256:d1430a71e647c244f82b12d938e00d667260bb284a5627a3d7a2f3dd9e3d51cd
```
...
```console
$ docker pull php@sha256:8fde7609a8be7b76590313b5d1f475c013f1fe8fccf88b7d382b1c6ecb8dbe9e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30298789 bytes)**  
...
-	Layers:
	...
	-	`sha256:24518bca5a39956d9e458a5b559b187d214b38db20e6ece3bb838992f8ca7498`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50d282504be0a5d8e6f4121f8ff813907e726651993d0ea4c73a56c9fc4c3d6d`  
		Last Modified: Thu, 29 Sep 2022 15:17:05 GMT  
		Size: 15.3 MB (15298597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad2782a497f05257a1a82e908ee031bd110750441abadfcad254657f00062bca`  
		Last Modified: Thu, 29 Sep 2022 15:17:02 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efaf21142d826b8a6551daac5acd57fbf017c86e040e633e508117ffbd7bc8fc`  
		Last Modified: Thu, 29 Sep 2022 15:17:02 GMT  
...
```console
$ docker pull php@sha256:b4a45a6e51a4bf2948dc140dd69aa54260bd3dc995eb6de4e81c627b274c7ec6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.8 MB (30808881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d0d961795548f6cfafcb6d91c0e823ab206a95e1f419e78ddc7c932e8d811ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 29 Sep 2022 15:18:47 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 	ln -sv /usr/include/gnu-libiconv/*.h /usr/include/; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 29 Sep 2022 15:18:48 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 29 Sep 2022 15:18:48 GMT
RUN docker-php-ext-enable sodium
# Thu, 29 Sep 2022 15:18:49 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 29 Sep 2022 15:18:50 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:418c5b9ba7b61bdab05e05d66be981127c4e18d4dc37c9775b8b368d35485857`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cf53f1170c5bbec1e984c8ea4f1b5b5ccb80b553c0a2c382595348a32c04ca2`  
		Last Modified: Thu, 29 Sep 2022 15:47:17 GMT  
		Size: 15.7 MB (15703617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e62c198e5b052bb0d651f351c77892eefe499f597d3bb3eff2dc628555a98dad`  
		Last Modified: Thu, 29 Sep 2022 15:47:14 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bee34f0072885b533bd4022664b85224ae6c4042203084c1129ffead25bfe2ce`  
		Last Modified: Thu, 29 Sep 2022 15:47:14 GMT  
...
```console
$ docker pull php@sha256:55b9edd9f43e953a7bcb6976319482dc36988d0910e0c6c4049fac92ac481a86
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.4 MB (31369088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ef953a1e1351807d45eb3a0337ba389497d442a6c4558e60f6adaed1cd4a404`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 29 Sep 2022 14:55:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 	ln -sv /usr/include/gnu-libiconv/*.h /usr/include/; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 29 Sep 2022 14:55:24 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 29 Sep 2022 14:55:26 GMT
RUN docker-php-ext-enable sodium
# Thu, 29 Sep 2022 14:55:26 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 29 Sep 2022 14:55:27 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:a874dcfb38f0f1304944a742ede072cb21ef0448b0dc519054656757bfb1d350`  
		...
		Size: 500.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd8791f20b44204c9df27c6b1d0ab6d8dcebd08da97387602c09756920121b05`  
		Last Modified: Thu, 29 Sep 2022 15:24:05 GMT  
		Size: 16.3 MB (16331493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a33f89de958bb69fbeb5e76e1ad92577a5ab54da6e00431a78b83d1c388025c`  
		Last Modified: Thu, 29 Sep 2022 15:24:00 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:138a008b549fcf7e0e54782a3727bafc48ced8b1415d69118975fec610b8bdaf`  
		Last Modified: Thu, 29 Sep 2022 15:24:00 GMT  
