...
```console
$ docker pull php@sha256:32b7823afbac634b2e0115ca53a5d270fad0df3c7c021c54714d811237fde8cc
```
...
### `php:8.1.28-fpm` - linux; s390x

```console
$ docker pull php@sha256:5736d589408afd42eadb5a02f8e7e2b8b5fb6cf8fdf2d2c6ef111be62a92820f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.0 MB (146953850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4c1f753cdf7212b7ddef791f915b487c592e4f458c181604b16551641b282aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
