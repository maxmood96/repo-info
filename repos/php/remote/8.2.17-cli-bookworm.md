...
```console
$ docker pull php@sha256:097530d95a3aaa70ecb0d54e40e5530140514ee2b51c9f02739a41c8ae9538c5
```
...
### `php:8.2.17-cli-bookworm` - linux; amd64
...
### `php:8.2.17-cli-bookworm` - linux; arm variant v5
...
### `php:8.2.17-cli-bookworm` - linux; arm variant v7
...
### `php:8.2.17-cli-bookworm` - linux; arm64 variant v8
...
### `php:8.2.17-cli-bookworm` - linux; 386
...
### `php:8.2.17-cli-bookworm` - linux; mips64le
...
### `php:8.2.17-cli-bookworm` - linux; ppc64le
...
### `php:8.2.17-cli-bookworm` - linux; s390x
