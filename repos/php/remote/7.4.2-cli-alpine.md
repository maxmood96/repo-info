...
```console
$ docker pull php@sha256:3d0229841a0684b8c7ed16b1321fc7e02c0e66101dec47efa3ed050614a5a98e
```
...
### `php:7.4.2-cli-alpine` - linux; arm64 variant v8
...
### `php:7.4.2-cli-alpine` - linux; 386
...
### `php:7.4.2-cli-alpine` - linux; ppc64le
