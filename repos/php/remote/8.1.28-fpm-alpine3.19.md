...
```console
$ docker pull php@sha256:5b3c248eb95e9a0993f188c82bcb67adab24fcc31ecc9e0b19d222a9b3f369d3
```
...
### `php:8.1.28-fpm-alpine3.19` - linux; 386
...
### `php:8.1.28-fpm-alpine3.19` - linux; s390x

```console
$ docker pull php@sha256:29ae8e8e8a73e51ed7ca343b60586802e0f27beaf63dd84f76e2f9e624df26cd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.8 MB (32784121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3f728a248005b2461864cb791cb48230b88df4798ef6eabac278956b6af4d60`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
