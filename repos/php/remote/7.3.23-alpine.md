...
```console
$ docker pull php@sha256:8e37176c3cc99b57a82f0cedaa0a8845867385f5d2fe9cf2f6e1b36b163015d0
```
...
```console
$ docker pull php@sha256:dc0a735f9c37c3dde8a639721f9e478548a9b46f3367f3be1cb0cd10aca1486e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.8 MB (31761163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a51957b7d03c41ab1f0b096c95f81d2303783c6d2b47e7f8177b4f3fd986e516`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
