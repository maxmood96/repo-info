...
```console
$ docker pull php@sha256:0eb875b14839c484381cbddc30de1f22f04932c1f7f95567ca57ef8eed7ceac8
```
...
### `php:8.3.7-apache-bullseye` - linux; amd64
...
### `php:8.3.7-apache-bullseye` - linux; arm variant v7
...
### `php:8.3.7-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.3.7-apache-bullseye` - linux; 386
...
### `php:8.3.7-apache-bullseye` - linux; ppc64le
...
### `php:8.3.7-apache-bullseye` - linux; s390x
