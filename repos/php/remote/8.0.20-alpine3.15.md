## `php:8.0.20-alpine3.15`

```console
$ docker pull php@sha256:9f35667f2a0fcd7969a0c923749071eb932d5d2accc54ec8cf7fd3703b8a5d32
```
...
### `php:8.0.20-alpine3.15` - linux; amd64
...
### `php:8.0.20-alpine3.15` - linux; arm variant v6
...
### `php:8.0.20-alpine3.15` - linux; arm64 variant v8
...
### `php:8.0.20-alpine3.15` - linux; 386
...
### `php:8.0.20-alpine3.15` - linux; s390x
