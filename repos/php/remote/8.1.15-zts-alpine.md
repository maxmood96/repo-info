...
```console
$ docker pull php@sha256:8ee1c83693eaa6b3582abdb38d3bde87b9e70bcebe64f30968655eb0b1086843
```
...
### `php:8.1.15-zts-alpine` - linux; amd64

```console
$ docker pull php@sha256:4d0164ecef2656bb696729732b6dacb18e43e5767d5e084cea2ce66e16469e17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29624677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c70701bde1eec1e75e9ef1d359de93f8ea4342c20aafd715cd99a731af43745`
...
# Sat, 11 Feb 2023 10:52:17 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Sat, 11 Feb 2023 10:52:18 GMT
...
-	Layers:
	...
	-	`sha256:f8c0b65e82a49556eb43274e17025f408de7889a54b762d15fd299764242157c`  
		...
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec7936b005b1c070d35d2f80d71261177ecf7ba62f61ac31822ef2a0407a2f8c`  
		Last Modified: Sat, 11 Feb 2023 11:23:22 GMT  
		Size: 12.5 MB (12522515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76503131def6cd4a360700dd82ef0ad3277262ebc89de86a4c2c8592320ec5e`  
		Last Modified: Sat, 11 Feb 2023 11:23:20 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e331bb935414adc833c40c5c83648c9a9f2910122a5edfa67ad5f48f66af4ea2`  
		Last Modified: Sat, 11 Feb 2023 11:23:20 GMT  
		Size: 18.9 KB (18946 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.1.15-zts-alpine` - linux; arm variant v6
...
### `php:8.1.15-zts-alpine` - linux; arm variant v7

```console
$ docker pull php@sha256:2396c63abf5216544e0a70703f7e30c7e5b059ea58cf354ab705a7d76ba74068
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.1 MB (27112626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c4aee10f877b4c66e1fceb645f015b5e1c296f8b950f79a3f895fc64666ac55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Sat, 11 Feb 2023 07:19:09 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Sat, 11 Feb 2023 07:28:52 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-embed 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Sat, 11 Feb 2023 07:28:53 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Sat, 11 Feb 2023 07:28:54 GMT
RUN docker-php-ext-enable sodium
# Sat, 11 Feb 2023 07:28:54 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 11 Feb 2023 07:28:54 GMT
...
-	Layers:
	...
	-	`sha256:7c1a50377a04aa0c0fba981c05aabdb3ff9efd33729f6a17f16399a180b8798f`  
		...
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:270a0e70dbd9fa31c322fe014be02bab88f6864382708af88f9333f53964d9e4`  
		Last Modified: Sat, 11 Feb 2023 08:05:55 GMT  
		Size: 10.7 MB (10679729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05c271975b6f1d7ae75fcd01f4ac6e04013f7c80508cb1582e2058d450386c75`  
		Last Modified: Sat, 11 Feb 2023 08:05:53 GMT  
		Size: 2.4 KB (2443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2900e45029cc91a148bc7c0454b24a645c23a6ae2016b19f787bbb3c6d473c07`  
		Last Modified: Sat, 11 Feb 2023 08:05:53 GMT  
		Size: 18.7 KB (18734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.1.15-zts-alpine` - linux; arm64 variant v8
...
### `php:8.1.15-zts-alpine` - linux; 386
...
### `php:8.1.15-zts-alpine` - linux; ppc64le
...
### `php:8.1.15-zts-alpine` - linux; s390x
