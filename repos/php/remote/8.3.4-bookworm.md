...
```console
$ docker pull php@sha256:823fd6113a717ed31be368f0745723dcfc4b66b3b12f018facbc8f2921ffb250
```
...
### `php:8.3.4-bookworm` - linux; amd64
...
### `php:8.3.4-bookworm` - linux; arm variant v5
...
### `php:8.3.4-bookworm` - linux; arm variant v7
...
### `php:8.3.4-bookworm` - linux; arm64 variant v8
...
### `php:8.3.4-bookworm` - linux; mips64le
...
### `php:8.3.4-bookworm` - linux; ppc64le
