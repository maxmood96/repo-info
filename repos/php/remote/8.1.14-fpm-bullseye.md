...
```console
$ docker pull php@sha256:1debfabf5afe2b53874d5f8a3a8c67c952092e2b438a037c58f4188f5fb8012e
```
...
### `php:8.1.14-fpm-bullseye` - linux; amd64
...
### `php:8.1.14-fpm-bullseye` - linux; arm variant v5
...
### `php:8.1.14-fpm-bullseye` - linux; arm variant v7
...
### `php:8.1.14-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.1.14-fpm-bullseye` - linux; 386
...
### `php:8.1.14-fpm-bullseye` - linux; mips64le
...
### `php:8.1.14-fpm-bullseye` - linux; ppc64le
...
### `php:8.1.14-fpm-bullseye` - linux; s390x
