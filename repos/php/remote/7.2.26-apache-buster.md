...
```console
$ docker pull php@sha256:4a73d70944fa851a3e28957c35773386c2af7b4ab90e83eeeba72ec352d03a5a
```
...
### `php:7.2.26-apache-buster` - linux; amd64
...
### `php:7.2.26-apache-buster` - linux; arm64 variant v8
...
### `php:7.2.26-apache-buster` - linux; ppc64le
