...
```console
$ docker pull php@sha256:0f45a5c142002461e45d7a529eefdedee15fe23a8bd8cd78f5dce305a9b2e27d
```
...
### `php:8.0.9-cli-bullseye` - linux; arm variant v7
...
### `php:8.0.9-cli-bullseye` - linux; 386
...
### `php:8.0.9-cli-bullseye` - linux; mips64le
...
### `php:8.0.9-cli-bullseye` - linux; ppc64le
...
### `php:8.0.9-cli-bullseye` - linux; s390x
