...
```console
$ docker pull php@sha256:a60b861e4ca047b48ce93b0cee1ce40e696464dce7fa8edee3203d1d5c02cbbd
```
...
### `php:8.4.22-fpm-alpine3.22` - linux; amd64
...
### `php:8.4.22-fpm-alpine3.22` - unknown; unknown
...
### `php:8.4.22-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.4.22-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.4.22-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.4.22-fpm-alpine3.22` - linux; 386
...
### `php:8.4.22-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.4.22-fpm-alpine3.22` - linux; s390x
