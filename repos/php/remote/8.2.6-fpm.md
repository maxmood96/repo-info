...
```console
$ docker pull php@sha256:36e07ae4a2df8063c73a2dd8208b01475dc29c8198f377af6d3ffe4390c681b8
```
...
### `php:8.2.6-fpm` - linux; arm variant v5
...
### `php:8.2.6-fpm` - linux; arm variant v7
...
### `php:8.2.6-fpm` - linux; arm64 variant v8
