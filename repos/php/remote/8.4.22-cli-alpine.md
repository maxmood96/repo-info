...
```console
$ docker pull php@sha256:b87a4d394f5cdfb7551628837bb90fc97e213b16294d7a2e61efbbd5823ea35c
```
...
### `php:8.4.22-cli-alpine` - linux; amd64
...
### `php:8.4.22-cli-alpine` - unknown; unknown
...
### `php:8.4.22-cli-alpine` - linux; arm variant v6
...
### `php:8.4.22-cli-alpine` - linux; arm variant v7
...
### `php:8.4.22-cli-alpine` - linux; arm64 variant v8
...
### `php:8.4.22-cli-alpine` - linux; 386

```console
$ docker pull php@sha256:821effeedaf6d74a0c701d5a0db259e996161d3ae8947b7feabcb8fa2ada1a36
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.1 MB (44143843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0317fe22cda47c938ac777ad8c4570bbf4394aec886dc6fc64fc2a57881602a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:3db32797e70980c2f1ff4999ffaf2a350f932adfd3008bfbfc78d0c4ea2f048d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.4 KB (319404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec083b9e1d5ac297c381762ba9adb8296adb04a44e4ae557abdcaa454b940478`

```dockerfile
```

-	Layers:
	-	`sha256:26b9abd92b4ff5c7fa76c2922dbe3f88993784966e5a90aeed26dcced569e44f`  
		Last Modified: Wed, 10 Jun 2026 21:37:06 GMT  
		Size: 278.5 KB (278520 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ea2f3dcee7c493987caa569bfa79f2e3d3569e177b1654db10622f8e397f100d`  
		Last Modified: Wed, 10 Jun 2026 21:37:06 GMT  
		Size: 40.9 KB (40884 bytes)  
		MIME: application/vnd.in-toto+json

### `php:8.4.22-cli-alpine` - linux; ppc64le
...
### `php:8.4.22-cli-alpine` - linux; riscv64

```console
$ docker pull php@sha256:e64d293289418cba1d1e96da5547d82280cd1b4708001b16f8551c30a0f0bae9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.8 MB (42802519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a22ad1f4e8adcfddd85e2c67070fb7162945a00857ce4ffd95c1295166ca3c37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
```console
$ docker pull php@sha256:ff438a82adf02fa9775d8abd0eff1dbecf48bd877edeac18d43740d9b08f9077
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.0 KB (316005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9106e69509c6bf57ad14ff9e4645aed4a90fb5fc2e668c743ec156d46e6d8dfc`

```dockerfile
```

-	Layers:
	-	`sha256:8edcab64e76024752a9d1a2c33a1b4bf218e007b7454bf7cd9fe270008c1ac99`  
		Last Modified: Thu, 11 Jun 2026 07:44:08 GMT  
		Size: 275.0 KB (274978 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0a36bedff770f67d20e9863876cf554f60fc27a8e75e2995205bfb41ffced71c`  
		Last Modified: Thu, 11 Jun 2026 07:44:07 GMT  
		Size: 41.0 KB (41027 bytes)  
		MIME: application/vnd.in-toto+json

### `php:8.4.22-cli-alpine` - linux; s390x
