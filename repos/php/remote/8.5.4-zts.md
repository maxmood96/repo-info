...
```console
$ docker pull php@sha256:845d9987bf26337619f50c764433f64c035fbe8463b42ed0db4a51f553c7e971
```
...
### `php:8.5.4-zts` - linux; arm variant v5
...
### `php:8.5.4-zts` - linux; arm variant v7
...
### `php:8.5.4-zts` - linux; arm64 variant v8
