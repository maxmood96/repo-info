...
```console
$ docker pull php@sha256:ecd399528ba8c885a93ec9a005035724ba5d0f5051a1c4652de6bf7c517c5d1b
```
...
### `php:8.3.7-fpm-bookworm` - linux; amd64
...
### `php:8.3.7-fpm-bookworm` - linux; arm variant v7
...
### `php:8.3.7-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.3.7-fpm-bookworm` - linux; 386
...
### `php:8.3.7-fpm-bookworm` - linux; ppc64le
...
### `php:8.3.7-fpm-bookworm` - linux; s390x
