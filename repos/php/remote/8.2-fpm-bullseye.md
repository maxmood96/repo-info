...
```console
$ docker pull php@sha256:b9ac5f4363e35218b5f086a99e7758af65d363d5f1e53db11aebf29b514c53fe
```
...
```console
$ docker pull php@sha256:fd008ddfce010e9d8dd2141d5f525edd75b04a1aea27ef65874f71cab937bf78
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.6 MB (132568437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a425032a379916b0fa7bed24dd4249894f6d118fceaa5aefc6a3a04b9b9fcc75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
