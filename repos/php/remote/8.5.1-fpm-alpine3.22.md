...
```console
$ docker pull php@sha256:3e661a78d0dacc5575b1d39e584aba5c85237676b64beb8a18e0b51c8e139e54
```
...
### `php:8.5.1-fpm-alpine3.22` - linux; amd64
...
### `php:8.5.1-fpm-alpine3.22` - unknown; unknown
...
### `php:8.5.1-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.5.1-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.5.1-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.5.1-fpm-alpine3.22` - linux; 386
...
### `php:8.5.1-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.5.1-fpm-alpine3.22` - linux; s390x
