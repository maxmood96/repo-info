...
```console
$ docker pull php@sha256:c29f82da7be63a991ec0026a450967447f4cc4c1a1fcdb9cf9557b6fe10f0918
```
...
### `php:7.4.18-apache` - linux; arm variant v5
...
### `php:7.4.18-apache` - linux; arm variant v7
...
### `php:7.4.18-apache` - linux; arm64 variant v8
...
### `php:7.4.18-apache` - linux; mips64le
