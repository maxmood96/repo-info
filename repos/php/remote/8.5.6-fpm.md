...
```console
$ docker pull php@sha256:e0aa9ff408fcc19e5bac972eb57ac91b818fa6b9fa0bffa3d73660b1ccf14da9
```
...
### `php:8.5.6-fpm` - linux; arm variant v5
...
### `php:8.5.6-fpm` - linux; arm variant v7
...
### `php:8.5.6-fpm` - linux; arm64 variant v8
