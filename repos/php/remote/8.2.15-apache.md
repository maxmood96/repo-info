...
```console
$ docker pull php@sha256:30228388bdf48bb0998262d0614a754b7b1d657c79c476792ac45ecba538b811
```
...
### `php:8.2.15-apache` - linux; arm variant v5
...
### `php:8.2.15-apache` - linux; arm variant v7
...
### `php:8.2.15-apache` - linux; arm64 variant v8
...
### `php:8.2.15-apache` - linux; mips64le

```console
$ docker pull php@sha256:c3f0e34f16b8deec5a6cfb98503b265d2c36ec49774f34bfa5b81728d525edf9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.5 MB (152533688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca19f56d9ee4d6429c24d6f8f463a5da08e65143d973aab38650774019b6eece`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:8.2.15-apache` - linux; ppc64le
...
### `php:8.2.15-apache` - linux; s390x

```console
$ docker pull php@sha256:de358cf0e8f8fd9f771528a5ba24e7f1abf6302a6cdb552cc385d1f90e03b436
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.2 MB (151249907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f6541fa12e384a3d842449e2a2cdd436f6f6ee7da930714eaa10541af287e95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
