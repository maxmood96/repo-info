...
```console
$ docker pull php@sha256:dfccd374152a55f1980e39d5f824c687b692c784b9348ff1ea5b4c1e2d0000d1
```
...
```console
$ docker pull php@sha256:c2cdface5abb4522fe0645791d3857246968a234da7e829f8ded6e4993e8a3a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176584472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7865b257b6e981b327d8806d769829acc9fb9b518bafe8032b6cd0d4ba501f18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
