...
```console
$ docker pull php@sha256:c1da5babf406555289c41948c66ac8d3ad82f6785c1f7e719d31becea0a4e949
```
...
### `php:8.2.20-zts-alpine3.20` - linux; amd64
...
### `php:8.2.20-zts-alpine3.20` - linux; arm variant v6
...
### `php:8.2.20-zts-alpine3.20` - linux; arm variant v7
...
### `php:8.2.20-zts-alpine3.20` - linux; arm64 variant v8
...
### `php:8.2.20-zts-alpine3.20` - linux; 386
...
### `php:8.2.20-zts-alpine3.20` - linux; ppc64le
...
### `php:8.2.20-zts-alpine3.20` - linux; riscv64
...
### `php:8.2.20-zts-alpine3.20` - linux; s390x
