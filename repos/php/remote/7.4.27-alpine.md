...
```console
$ docker pull php@sha256:7783140338952506bc92a1e907784f6a39605de1143accf676e3340062be56fb
```
...
### `php:7.4.27-alpine` - linux; arm variant v7
...
### `php:7.4.27-alpine` - linux; arm64 variant v8
...
### `php:7.4.27-alpine` - linux; ppc64le
