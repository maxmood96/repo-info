...
### `php:8.3.11-alpine3.20` - linux; amd64
...
### `php:8.3.11-alpine3.20` - linux; arm variant v7
...
### `php:8.3.11-alpine3.20` - linux; arm64 variant v8
...
### `php:8.3.11-alpine3.20` - linux; 386
...
### `php:8.3.11-alpine3.20` - linux; ppc64le
...
### `php:8.3.11-alpine3.20` - linux; riscv64
...
### `php:8.3.11-alpine3.20` - linux; s390x
