...
```console
$ docker pull php@sha256:4085659c424e3c132cdc3a15fba5786237bfc9d91c8bd8d5a17d98a595f23fdb
```
...
### `php:8.3.20-fpm-alpine` - linux; amd64
...
### `php:8.3.20-fpm-alpine` - unknown; unknown
...
### `php:8.3.20-fpm-alpine` - linux; arm variant v6
...
### `php:8.3.20-fpm-alpine` - linux; arm variant v7
...
### `php:8.3.20-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.3.20-fpm-alpine` - linux; 386
...
### `php:8.3.20-fpm-alpine` - linux; ppc64le
...
### `php:8.3.20-fpm-alpine` - linux; s390x
