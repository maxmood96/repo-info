...
```console
$ docker pull php@sha256:39cd39ad7672920e6f8875bc750cca654281e6f9d76d5a88b096c7d79dcc50e3
```
...
### `php:8.5.6-fpm-bookworm` - linux; amd64
...
### `php:8.5.6-fpm-bookworm` - unknown; unknown
...
### `php:8.5.6-fpm-bookworm` - linux; arm variant v5
...
### `php:8.5.6-fpm-bookworm` - linux; arm variant v7
...
### `php:8.5.6-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.5.6-fpm-bookworm` - linux; 386
...
### `php:8.5.6-fpm-bookworm` - linux; mips64le
...
### `php:8.5.6-fpm-bookworm` - linux; s390x
