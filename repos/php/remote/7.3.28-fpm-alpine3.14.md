...
```console
$ docker pull php@sha256:7cc623edc5751cda70ce83419d12f03cecfd5d69c1be1887604b7e7bd9eb7607
```
...
### `php:7.3.28-fpm-alpine3.14` - linux; arm variant v6

```console
$ docker pull php@sha256:adba543090e154d4e5d1ef90c5548a0d0c925b8205273d43d16bd8ae34e3fd2d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (29966144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebb4cf1d89d8a9f783d5db0f5dacb7d41d33b13c02a75b432d5ab27aa676e6b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
