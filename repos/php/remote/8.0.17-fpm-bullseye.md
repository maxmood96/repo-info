...
```console
$ docker pull php@sha256:db90b354953ccd3ece24a9879c9fee6036c02022c11108f63f7dd1230610837a
```
...
### `php:8.0.17-fpm-bullseye` - linux; arm variant v5
...
### `php:8.0.17-fpm-bullseye` - linux; arm variant v7
...
### `php:8.0.17-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.0.17-fpm-bullseye` - linux; mips64le
...
### `php:8.0.17-fpm-bullseye` - linux; ppc64le
...
### `php:8.0.17-fpm-bullseye` - linux; s390x
