...
```console
$ docker pull php@sha256:d85ada7590f43960a46b699395747a35c560a44d990c98fdd72ad6e8ca8b5fba
```
...
### `php:8.4.14-cli-trixie` - linux; amd64
...
### `php:8.4.14-cli-trixie` - unknown; unknown
...
### `php:8.4.14-cli-trixie` - linux; arm variant v5
...
### `php:8.4.14-cli-trixie` - linux; arm variant v7
...
### `php:8.4.14-cli-trixie` - linux; arm64 variant v8
...
### `php:8.4.14-cli-trixie` - linux; 386
...
### `php:8.4.14-cli-trixie` - linux; ppc64le
...
### `php:8.4.14-cli-trixie` - linux; s390x
