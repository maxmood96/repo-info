...
```console
$ docker pull php@sha256:57dade01edfbb17d90248f2be19dfa2d115195b7f2e7ae1ff07aee6f4b6f031b
```
...
```console
$ docker pull php@sha256:16f170a2a7a2019b05685707766c8f4033f87543b181037cab097f42aa46c8bd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.8 MB (28770681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fe6a0eec3217acdc74a2fbc4f28fac820550f356046cb18e864c7c30cb72973`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
