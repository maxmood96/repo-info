...
```console
$ docker pull php@sha256:609d7dd8f67a9a1deb58fa8159832ac103eebc5dcffb9d6eb7924ae933479f0c
```
...
### `php:7.2.31-alpine3.12` - linux; amd64
...
### `php:7.2.31-alpine3.12` - linux; 386
