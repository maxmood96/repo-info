...
```console
$ docker pull php@sha256:6fa62f5afc229ad273bc4b1edee3e0ec1937525905b4f0b5137a52f25ddf8652
```
...
### `php:8.3.1-alpine3.18` - linux; amd64
...
### `php:8.3.1-alpine3.18` - linux; arm variant v7
...
### `php:8.3.1-alpine3.18` - linux; arm64 variant v8
...
### `php:8.3.1-alpine3.18` - linux; 386
...
### `php:8.3.1-alpine3.18` - linux; ppc64le
