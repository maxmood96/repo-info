...
```console
$ docker pull php@sha256:9a395cd3ebba9d26f915f1e0860828390e057cb7343f01aa19d6408ca8fe38b5
```
...
### `php:8.2.8-cli-alpine3.18` - linux; amd64
...
### `php:8.2.8-cli-alpine3.18` - linux; arm variant v6
...
### `php:8.2.8-cli-alpine3.18` - linux; arm variant v7
...
### `php:8.2.8-cli-alpine3.18` - linux; arm64 variant v8

```console
$ docker pull php@sha256:d0e7d7eb50a10f4bd027a93a5f3afcadbb19c6c6d22dec0a721297dc3b3adab4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34846968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a905fcda88ded29803b1b4adaa98d558fb65a50a713c5f5709f6366b23c55fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:8.2.8-cli-alpine3.18` - linux; 386
...
### `php:8.2.8-cli-alpine3.18` - linux; ppc64le
...
### `php:8.2.8-cli-alpine3.18` - linux; s390x
