...
### `php:7.2.31-cli-alpine` - linux; amd64
...
### `php:7.2.31-cli-alpine` - linux; arm variant v7
...
### `php:7.2.31-cli-alpine` - linux; arm64 variant v8
...
### `php:7.2.31-cli-alpine` - linux; 386
...
### `php:7.2.31-cli-alpine` - linux; ppc64le
