...
```console
$ docker pull php@sha256:3e618e817cad69f12ed2952cb96beb8b9e8fc52eb78e9ae90b7c849073445a8f
```
...
### `php:8.4.21-fpm-alpine3.22` - linux; amd64
...
### `php:8.4.21-fpm-alpine3.22` - unknown; unknown
...
### `php:8.4.21-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.4.21-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.4.21-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.4.21-fpm-alpine3.22` - linux; 386
...
### `php:8.4.21-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.4.21-fpm-alpine3.22` - linux; s390x
