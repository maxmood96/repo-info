...
```console
$ docker pull php@sha256:bce6dde650adba5d0807b84a5b1052cc314007dd5915cfabbd1d8644cded327a
```
...
```console
$ docker pull php@sha256:2042b5bd9cf07b47bd59167f73452328f992a363c4462259bfe02d181f73b18a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.6 MB (138642777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccd90dcbe4448bc4d251c2b4067a8696c0274d25be9547fcb48a4f66f13f776d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
