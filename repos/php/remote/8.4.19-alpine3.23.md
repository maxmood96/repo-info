...
```console
$ docker pull php@sha256:c0932b730de07fd826d6021e617890ecaa9419230429db3ddc5a7d523454ebf5
```
...
### `php:8.4.19-alpine3.23` - linux; amd64
...
### `php:8.4.19-alpine3.23` - unknown; unknown
...
### `php:8.4.19-alpine3.23` - linux; arm variant v6
...
### `php:8.4.19-alpine3.23` - linux; arm variant v7
...
### `php:8.4.19-alpine3.23` - linux; arm64 variant v8
...
### `php:8.4.19-alpine3.23` - linux; 386
...
### `php:8.4.19-alpine3.23` - linux; ppc64le
...
### `php:8.4.19-alpine3.23` - linux; s390x
