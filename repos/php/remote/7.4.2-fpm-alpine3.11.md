...
```console
$ docker pull php@sha256:e93211034f2a2d68ce6efd0136af7ee260fd1203c2196c2612f05d4209e527fa
```
...
### `php:7.4.2-fpm-alpine3.11` - linux; arm64 variant v8
...
### `php:7.4.2-fpm-alpine3.11` - linux; 386
...
### `php:7.4.2-fpm-alpine3.11` - linux; ppc64le
