...
```console
$ docker pull php@sha256:9e5498067d6c893436fda1e4a014ed57cea0661bb08c7bb65b239f772b522384
```
...
### `php:8.3.6-zts-bullseye` - linux; arm variant v7
...
### `php:8.3.6-zts-bullseye` - linux; 386
