...
```console
$ docker pull php@sha256:797978f6894ba27ff07d85acefc8d4bbc5f6377ac65edddc0d5190963d1c12c2
```
...
### `php:7.4.9-apache` - linux; arm variant v5
...
### `php:7.4.9-apache` - linux; arm variant v7
...
### `php:7.4.9-apache` - linux; arm64 variant v8
...
### `php:7.4.9-apache` - linux; mips64le
...
### `php:7.4.9-apache` - linux; ppc64le
