...
```console
$ docker pull php@sha256:612501135b57152245376ad9dd7cde440ccf65752db7869237d47beb2fd07719
```
...
### `php:8.1.7-apache-bullseye` - linux; amd64
...
### `php:8.1.7-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.7-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.7-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.7-apache-bullseye` - linux; 386
...
### `php:8.1.7-apache-bullseye` - linux; mips64le
...
### `php:8.1.7-apache-bullseye` - linux; ppc64le
...
### `php:8.1.7-apache-bullseye` - linux; s390x
