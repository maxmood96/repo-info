...
### `php:7.4.18-cli-alpine` - linux; arm variant v6
...
### `php:7.4.18-cli-alpine` - linux; arm variant v7
...
### `php:7.4.18-cli-alpine` - linux; arm64 variant v8
...
### `php:7.4.18-cli-alpine` - linux; 386
...
### `php:7.4.18-cli-alpine` - linux; s390x
