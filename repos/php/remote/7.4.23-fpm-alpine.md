...
```console
$ docker pull php@sha256:714fdd014d854fe25e4f2daf2a067720f2c1517ca92a53768cecea87229c04a7
```
...
### `php:7.4.23-fpm-alpine` - linux; amd64
...
### `php:7.4.23-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.23-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.23-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.23-fpm-alpine` - linux; 386
...
### `php:7.4.23-fpm-alpine` - linux; s390x
