## `php:8.1.1-cli-buster`

```console
$ docker pull php@sha256:5d5f742e1d29dfe3fc01a0c241670ab7d164a5ef124799176bcbc448d81dd896
```
...
### `php:8.1.1-cli-buster` - linux; amd64
...
### `php:8.1.1-cli-buster` - linux; arm variant v5
...
### `php:8.1.1-cli-buster` - linux; arm variant v7
...
### `php:8.1.1-cli-buster` - linux; arm64 variant v8
...
### `php:8.1.1-cli-buster` - linux; 386
...
### `php:8.1.1-cli-buster` - linux; mips64le
...
### `php:8.1.1-cli-buster` - linux; ppc64le
...
### `php:8.1.1-cli-buster` - linux; s390x
