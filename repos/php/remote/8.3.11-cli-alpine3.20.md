...
```console
$ docker pull php@sha256:bd309766733dd5e1d421258ee070618df686e802cdf81361a00389e838e342a8
```
...
### `php:8.3.11-cli-alpine3.20` - linux; amd64
...
### `php:8.3.11-cli-alpine3.20` - linux; arm variant v6
...
### `php:8.3.11-cli-alpine3.20` - linux; arm variant v7
...
### `php:8.3.11-cli-alpine3.20` - linux; arm64 variant v8
...
### `php:8.3.11-cli-alpine3.20` - linux; 386
...
### `php:8.3.11-cli-alpine3.20` - linux; ppc64le
...
### `php:8.3.11-cli-alpine3.20` - linux; riscv64

```console
$ docker pull php@sha256:23d46eb76e6e0f7f460fc9ddf0b45b7ce670ec73905dc900dbe5a1793eb9ddcf
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.1 MB (36089703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:021a0ba26665cd5d51aa69a821a75f58102fcd2c80add12bee4cd791b4c5aa38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Sat, 07 Sep 2024 03:11:36 GMT
RUN docker-php-ext-enable sodium
# Sat, 07 Sep 2024 03:11:36 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 07 Sep 2024 03:11:37 GMT
CMD ["php" "-a"]
```
...
### `php:8.3.11-cli-alpine3.20` - linux; s390x
