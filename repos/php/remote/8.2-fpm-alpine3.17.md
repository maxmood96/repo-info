...
```console
$ docker pull php@sha256:da02a3d195a3b34e66a34272f89f997c13faff18eda8052cbaf2fa9de4fb0065
```
...
```console
$ docker pull php@sha256:6e7c6748daa558fee83f38f2bdee0b442387f93221767fa6ba4c5605e61391ec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.7 MB (30660814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10db81dbc7e2ae7d8fb6b2d13dc92f4416f93adbd55191ec65a86bb916f868e7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
