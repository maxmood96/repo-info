...
```console
$ docker pull php@sha256:a453b28cda65a38534740c8c1142220c1d035c3d076f2659fe5369bc61bb2be5
```
...
### `php:8.3.24-fpm` - unknown; unknown
...
### `php:8.3.24-fpm` - linux; arm variant v5
...
### `php:8.3.24-fpm` - linux; arm variant v7
...
### `php:8.3.24-fpm` - linux; arm64 variant v8
