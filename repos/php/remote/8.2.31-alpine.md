...
```console
$ docker pull php@sha256:869a6a3015e1b08abbf4264144a6f1c24fe9302c89840046cad3e0947e9e348f
```
...
### `php:8.2.31-alpine` - unknown; unknown
...
### `php:8.2.31-alpine` - linux; arm variant v6
...
### `php:8.2.31-alpine` - linux; arm variant v7
...
### `php:8.2.31-alpine` - linux; arm64 variant v8
...
### `php:8.2.31-alpine` - linux; ppc64le
