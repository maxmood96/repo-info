...
```console
$ docker pull php@sha256:cd895fb4208f1b705e00c274dfc02f9e93fa6495d6412ebfb17d7eab0fb808f1
```
...
```console
$ docker pull php@sha256:e07a81dce0e0900f8bd630b9b2744efcbe13e1045bb3d71f219963d591babb96
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.6 MB (27643432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74c38d2ae46566fdbcd3b78c160ffabbfac474c7efb338d81a332ac9a9723ffb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
