...
```console
$ docker pull php@sha256:f7c2986bd8ad619d1ce17d7f60dc24335fd038a7e42339a4cf544d746971721a
```
...
```console
$ docker pull php@sha256:752c60056d9aaceef8a22fbf127044a74eb26f912e50f0abfad321b7f6afccde
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **131.6 MB (131625555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d73cd803145a9b950a02c40dade2948b411fc5bb0a152701737ef7c08b1670fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 17 Aug 2021 22:12:05 GMT
ENV PHP_URL=https://downloads.php.net/~ramsey/php-8.1.0beta2.tar.xz PHP_ASC_URL=https://downloads.php.net/~ramsey/php-8.1.0beta2.tar.xz.asc
# Tue, 17 Aug 2021 22:12:06 GMT
ENV PHP_SHA256=c0b8d45639f171fcbbaaf6b239a4759126130cf14628eaf74c4916408cb16ce0
# Tue, 17 Aug 2021 22:12:26 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg dirmngr; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 17 Aug 2021 22:12:27 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Tue, 17 Aug 2021 22:24:49 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libedit-dev 		libonig-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 		${PHP_EXTRA_BUILD_DEPS:-} 	; 	rm -rf /var/lib/apt/lists/*; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -executable -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Tue, 17 Aug 2021 22:24:50 GMT
COPY multi:e4407f0002276f00cc93b01e48696c1f677a5f7d3d194b3a84bec1cc5e733bcb in /usr/local/bin/ 
# Tue, 17 Aug 2021 22:24:52 GMT
RUN docker-php-ext-enable sodium
# Tue, 17 Aug 2021 22:24:52 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 17 Aug 2021 22:24:53 GMT
STOPSIGNAL SIGWINCH
# Tue, 17 Aug 2021 22:24:53 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Tue, 17 Aug 2021 22:24:53 GMT
WORKDIR /var/www/html
# Tue, 17 Aug 2021 22:24:54 GMT
EXPOSE 80
# Tue, 17 Aug 2021 22:24:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2df8276220a585617d744a3c44013be8471c39c57dda9624bb03856f87d2a03e`  
		...
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44af4e89f8415ccdeb9c07e20bb41c61c4a162aaf85e302dff8bbf3b2c9e3d2d`  
		Last Modified: Wed, 18 Aug 2021 03:36:46 GMT  
		Size: 11.9 MB (11934886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20f53a0374fd077f8e0c0808aae5b4397fa725093668993ab4df897e8fe16618`  
		Last Modified: Wed, 18 Aug 2021 03:36:39 GMT  
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df960e8d7d93debd2417259cd17eb1dba668dda7f83f0df24412fbb848748c61`  
		Last Modified: Wed, 18 Aug 2021 03:36:53 GMT  
		Size: 13.9 MB (13856295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7407a8de2a89881dac7f96fa177b00f1b86c3402dabd6c5e269db26f331335a`  
		Last Modified: Wed, 18 Aug 2021 03:36:39 GMT  
		Size: 2.3 KB (2277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7573ea1abf20dd4c06fc85e7a87d9614ca5ce2e027f8ca438c99160f93aafb78`  
		Last Modified: Wed, 18 Aug 2021 03:36:39 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53ca689cacf52c12660140c646ecb882364612996f9cde4dbf240c8ace26e066`  
		Last Modified: Wed, 18 Aug 2021 03:36:39 GMT  
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
