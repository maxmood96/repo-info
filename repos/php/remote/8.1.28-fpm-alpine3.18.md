...
```console
$ docker pull php@sha256:45b790800d1c8dbd9fd2a47d0a72ee9e1dd0d9f9393cf94ce72c7dc440321daf
```
...
### `php:8.1.28-fpm-alpine3.18` - linux; amd64
...
### `php:8.1.28-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.1.28-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.1.28-fpm-alpine3.18` - linux; ppc64le
