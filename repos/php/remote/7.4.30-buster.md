...
```console
$ docker pull php@sha256:6a4a6a826d3c9002623460757a9704d4fe5f13ff919d7384e8dab4e1e5ffb403
```
...
### `php:7.4.30-buster` - linux; arm variant v5
...
### `php:7.4.30-buster` - linux; mips64le
...
### `php:7.4.30-buster` - linux; ppc64le
