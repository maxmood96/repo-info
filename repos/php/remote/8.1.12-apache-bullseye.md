...
```console
$ docker pull php@sha256:c9c619ce3b91d13444456b4ea536c4bd5fa63ce8164069103202a3169311df19
```
...
### `php:8.1.12-apache-bullseye` - linux; amd64
...
### `php:8.1.12-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.12-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.12-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.12-apache-bullseye` - linux; 386
...
### `php:8.1.12-apache-bullseye` - linux; mips64le
...
### `php:8.1.12-apache-bullseye` - linux; ppc64le
...
### `php:8.1.12-apache-bullseye` - linux; s390x
