...
```console
$ docker pull php@sha256:eb04a9395048e218e4e229657fee0825329283b668fb729836410ec1c6148afe
```
...
### `php:7.4.24-cli-alpine` - linux; amd64
...
### `php:7.4.24-cli-alpine` - linux; arm variant v6
...
### `php:7.4.24-cli-alpine` - linux; arm variant v7
...
### `php:7.4.24-cli-alpine` - linux; arm64 variant v8
...
### `php:7.4.24-cli-alpine` - linux; 386
...
### `php:7.4.24-cli-alpine` - linux; s390x
