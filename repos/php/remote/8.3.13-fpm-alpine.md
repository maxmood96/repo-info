...
```console
$ docker pull php@sha256:59c776becf9978f307240020a463bb846b2344141edcc1cdb3daa12b3bab23a4
```
...
### `php:8.3.13-fpm-alpine` - linux; amd64
...
### `php:8.3.13-fpm-alpine` - linux; arm variant v6
...
### `php:8.3.13-fpm-alpine` - linux; arm variant v7
...
### `php:8.3.13-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.3.13-fpm-alpine` - linux; 386
...
### `php:8.3.13-fpm-alpine` - linux; ppc64le
...
### `php:8.3.13-fpm-alpine` - linux; s390x
