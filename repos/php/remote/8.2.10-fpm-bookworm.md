...
```console
$ docker pull php@sha256:d22d0c44b717337490881dc61f5f04fa60ae3cafa4df93ed3fb0f7144a2ce9e2
```
...
### `php:8.2.10-fpm-bookworm` - linux; amd64
...
### `php:8.2.10-fpm-bookworm` - linux; arm variant v5
...
### `php:8.2.10-fpm-bookworm` - linux; arm variant v7
...
### `php:8.2.10-fpm-bookworm` - linux; arm64 variant v8

```console
$ docker pull php@sha256:a33e2140e33b7f5c0272d4d79c98ab62e776ad48714b8f9ecccbd1ae18d3980f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167393264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:365cad5dea7e96784da5533dbe29b931845a09746deb7c8f5dd5e58fe8a483ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.2.10-fpm-bookworm` - linux; 386
...
### `php:8.2.10-fpm-bookworm` - linux; mips64le
...
### `php:8.2.10-fpm-bookworm` - linux; ppc64le
...
### `php:8.2.10-fpm-bookworm` - linux; s390x

```console
$ docker pull php@sha256:e23c06bab913d2a581d518b97226255a62f9170ce082839eccc9fb92163f9083
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.4 MB (147391397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f100176ff2503f601d4c6fec7d5bbd8bede042154a84380b78f434d96ee3c9a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
