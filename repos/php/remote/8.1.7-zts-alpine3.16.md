...
```console
$ docker pull php@sha256:6ae0a3f2cd259f9ae68cc145b0bc2ae41b36c3d4506f865a8224ee088e09d8df
```
...
### `php:8.1.7-zts-alpine3.16` - linux; amd64
...
### `php:8.1.7-zts-alpine3.16` - linux; arm variant v6
...
### `php:8.1.7-zts-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.7-zts-alpine3.16` - linux; 386
...
### `php:8.1.7-zts-alpine3.16` - linux; s390x
