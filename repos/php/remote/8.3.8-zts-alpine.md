...
```console
$ docker pull php@sha256:878d304eb0920d6c3151c8b45b8f4fde42d4b47b9083ec26621487c8254bbe06
```
...
### `php:8.3.8-zts-alpine` - linux; amd64
...
### `php:8.3.8-zts-alpine` - linux; arm variant v6
...
### `php:8.3.8-zts-alpine` - linux; arm variant v7
...
### `php:8.3.8-zts-alpine` - linux; arm64 variant v8
...
### `php:8.3.8-zts-alpine` - linux; 386
...
### `php:8.3.8-zts-alpine` - linux; ppc64le
...
### `php:8.3.8-zts-alpine` - linux; s390x
