...
```console
$ docker pull php@sha256:df0136b0ba25efa2608aae8979907097746a8b7d98aa86147617d862d1f95db4
```
...
### `php:8.5.7-fpm` - linux; arm variant v5
...
### `php:8.5.7-fpm` - linux; arm variant v7
...
### `php:8.5.7-fpm` - linux; arm64 variant v8
