...
### `php:8.3.6-bullseye` - linux; arm variant v7
...
### `php:8.3.6-bullseye` - linux; arm64 variant v8
...
### `php:8.3.6-bullseye` - linux; mips64le
...
### `php:8.3.6-bullseye` - linux; s390x
