...
```console
$ docker pull php@sha256:f44ec1da8ff95544326c7a1ec6f2cf0b4bd24b643b71082d01f12f4105bdd9dd
```
...
```console
$ docker pull php@sha256:53e32a9bdd60ae18e79282249661b6f442b614e3dc48438030b3c9823ad726e5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30311609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc10ea08f6303b0a54d8296e9ef2d3d3a3b963721a4f1c2cddd00e8beb9a624b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.2.29-cli-alpine` - linux; s390x
