...
```console
$ docker pull php@sha256:56aaba52dde08d9e42800bca392e7c90ed3c4a7773c39a1aaaf11b3d9ffe70bc
```
...
### `php:8.3.3-fpm-bullseye` - linux; amd64
...
### `php:8.3.3-fpm-bullseye` - linux; 386
...
### `php:8.3.3-fpm-bullseye` - linux; s390x
