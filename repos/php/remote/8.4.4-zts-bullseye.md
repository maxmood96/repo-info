...
### `php:8.4.4-zts-bullseye` - linux; amd64
...
### `php:8.4.4-zts-bullseye` - unknown; unknown
...
### `php:8.4.4-zts-bullseye` - linux; arm variant v7
...
### `php:8.4.4-zts-bullseye` - linux; arm64 variant v8
...
### `php:8.4.4-zts-bullseye` - linux; 386
