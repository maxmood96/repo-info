...
```console
$ docker pull php@sha256:817c48266ca7c9debda88e8afe5de2bf2a0ebc38fe8405724cb7d2fa8d0327c4
```
...
### `php:8.2.19RC1-apache-bullseye` - linux; amd64
...
### `php:8.2.19RC1-apache-bullseye` - linux; arm variant v5
...
### `php:8.2.19RC1-apache-bullseye` - linux; arm variant v7
...
### `php:8.2.19RC1-apache-bullseye` - linux; 386
...
### `php:8.2.19RC1-apache-bullseye` - linux; mips64le
...
### `php:8.2.19RC1-apache-bullseye` - linux; ppc64le
...
### `php:8.2.19RC1-apache-bullseye` - linux; s390x
