...
### `php:8.3.20-apache` - unknown; unknown
...
### `php:8.3.20-apache` - linux; arm variant v5
...
### `php:8.3.20-apache` - linux; arm variant v7
...
### `php:8.3.20-apache` - linux; arm64 variant v8
...
### `php:8.3.20-apache` - linux; mips64le
...
### `php:8.3.20-apache` - linux; ppc64le
