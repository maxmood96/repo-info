...
```console
$ docker pull php@sha256:bb781419ef15e6f5d0769aea943b749b7abf4c4882841d8eac90e4751ba494ab
```
...
### `php:7.3.16-fpm-alpine3.11` - linux; s390x

```console
$ docker pull php@sha256:e8108e3d9b15692b65fa54d486cfc4aec63dbb53bc3761afe990325c05253814
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.9 MB (29935971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41b3d69f32496fc58d90cf7e30bab2b04fad76d7c08ed413b3e5f53d9057ff83`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
