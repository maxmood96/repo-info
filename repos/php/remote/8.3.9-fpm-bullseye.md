...
```console
$ docker pull php@sha256:94430c25a04afbf7c6340f81497a668237e5ac540f30da19cea2242e6267be37
```
...
### `php:8.3.9-fpm-bullseye` - linux; amd64
...
### `php:8.3.9-fpm-bullseye` - linux; arm variant v5
...
### `php:8.3.9-fpm-bullseye` - linux; arm variant v7
...
### `php:8.3.9-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.3.9-fpm-bullseye` - linux; 386
...
### `php:8.3.9-fpm-bullseye` - linux; mips64le
...
### `php:8.3.9-fpm-bullseye` - linux; ppc64le
...
### `php:8.3.9-fpm-bullseye` - linux; s390x
