...
### `php:8.4.7-bookworm` - linux; amd64
...
### `php:8.4.7-bookworm` - unknown; unknown
...
### `php:8.4.7-bookworm` - linux; arm variant v5
...
### `php:8.4.7-bookworm` - linux; arm variant v7
...
### `php:8.4.7-bookworm` - linux; arm64 variant v8
...
### `php:8.4.7-bookworm` - linux; mips64le
...
### `php:8.4.7-bookworm` - linux; ppc64le
...
### `php:8.4.7-bookworm` - linux; s390x
