...
```console
$ docker pull php@sha256:8d5fa38d80c324a68747e79c7cb24e9901027f3df730f7cd85464f1f9c05b366
```
...
```console
$ docker pull php@sha256:1fc680a7cf7a7ac967a71af5434cf09d01a370573d2f030f3f8166ee32db30e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160075097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c861f72681578f6731f5be8dbd31b62a29e2499100c86f4e6cabe1636a48da8`
...
-	Layers:
	...
	-	`sha256:af7aea80a677ddc286db6d287dc709169386c48e701448100938599062ffaab7`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e95375d2dc56577b99c661b5c480a3ebc67087e879e7934a2bff46bd4833c45a`  
		Last Modified: Thu, 12 May 2022 20:54:40 GMT  
		Size: 26.0 MB (25992976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ccc943023ff14b1d897a97ec9067c924dfb78dc666b3b62f981fbc8ad3fd3fc`  
		Last Modified: Thu, 12 May 2022 20:54:36 GMT  
		Size: 2.4 KB (2449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba96aaf48cc9fd28f037dbb941792487523d769ef0109ddd79ac5d8c1b8019d1`  
		Last Modified: Thu, 12 May 2022 20:54:36 GMT  
		Size: 246.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:41bab689d01e5e2141025a8b2f6c1ec45d54798171096ab9338567342008a0f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152906282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1a2b0b42b2c837a7a9f9db5d4d184e95117ed7a8e17d350866dc3183e68bb9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Thu, 12 May 2022 20:46:58 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--enable-embed 				--enable-zts 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Thu, 12 May 2022 20:46:59 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Thu, 12 May 2022 20:47:00 GMT
RUN docker-php-ext-enable sodium
# Thu, 12 May 2022 20:47:00 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 12 May 2022 20:47:01 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:0e08e6459b7997ba8e9a7753a08d045ae4bea2ffd4a77ab245c2b1028a9a19a8`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4feed9d528e407293621143e6812e5b20649b5dbd5af797ba231d51eebd9d5ac`  
		Last Modified: Thu, 12 May 2022 21:58:24 GMT  
		Size: 25.2 MB (25239215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca6bf7fa6910a75e79034adb7fe07d66ac442ef113f409ad127a7f16f1bf832e`  
		Last Modified: Thu, 12 May 2022 21:58:20 GMT  
		Size: 2.5 KB (2452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:870335ba3f3beabb7672f8a5935699deadfa2bbb8b71756dad959e87939a3352`  
		Last Modified: Thu, 12 May 2022 21:58:20 GMT  
		Size: 246.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
