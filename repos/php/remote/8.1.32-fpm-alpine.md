...
### `php:8.1.32-fpm-alpine` - linux; amd64
...
### `php:8.1.32-fpm-alpine` - unknown; unknown
...
-	Layers:
	-	`sha256:b4e6091f737cbc7d311789594a580866f08dc4b54282a2a68a1b1894cd7203cd`  
		Last Modified: Fri, 16 May 2025 13:08:18 GMT  
		Size: 50.8 KB (50828 bytes)  
		MIME: application/vnd.in-toto+json

### `php:8.1.32-fpm-alpine` - linux; arm variant v7
...
### `php:8.1.32-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.32-fpm-alpine` - linux; 386
...
### `php:8.1.32-fpm-alpine` - linux; riscv64
...
### `php:8.1.32-fpm-alpine` - linux; s390x
