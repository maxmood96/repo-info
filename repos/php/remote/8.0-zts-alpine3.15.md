...
```console
$ docker pull php@sha256:a911c546ed7810c87a8ce6ba67e69c13ce081ea83372ce507991f921e34d4006
```
...
```console
$ docker pull php@sha256:bc6898cb60a87a7f9f59d426c168f93cf663443180e8d03e2a7988e4954313d6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.5 MB (25474120 bytes)**  
...
-	Layers:
	...
	-	`sha256:1c4e8b23fea234d92db5ca8f09fea3db09d1bdff6304b6f5f3b91121629334f1`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:353e142a0fe5f1a2416dab4fa15adcbb9a7bfa20c8962a28610b6c08f1f835e4`  
		Last Modified: Wed, 02 Nov 2022 00:34:09 GMT  
		Size: 10.1 MB (10089976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:102f020edbe963b3d7b81dd727c4047c538bfcf4cef254fccb7537a7cfc2ff98`  
		Last Modified: Wed, 02 Nov 2022 00:34:07 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a96e51f8353f6b176e290b50603497c8f20ca21c9456c392d9fb27b3223c8087`  
		Last Modified: Wed, 02 Nov 2022 00:34:07 GMT  
...
```console
$ docker pull php@sha256:f7d1c5a6e574caa9aa0eaa280b4b66f938e5e61af558344234b9cf5bd6e81d21
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.0 MB (24035545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16849cf9b017942de72522f4c1cd0a0cc1bbb761d33646ef6b044e0051aa9495`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:37:55 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 00:37:55 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:37:56 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 00:37:56 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 00:37:56 GMT
...
-	Layers:
	...
	-	`sha256:d8fe244949a50b1113e2d3a667de7a1c325f7912f7dcb2c81d72ff525791b02e`  
		...
		Size: 497.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f85493da70f6bd24fd36d5e4e5e177b9b443aa99e5be46319036ab49b8aa23b5`  
		Last Modified: Wed, 02 Nov 2022 00:57:06 GMT  
		Size: 8.9 MB (8854461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcc5187870faefea757016aa59d12d2004a33552a11179a4fef83222b0b91a3f`  
		Last Modified: Wed, 02 Nov 2022 00:57:04 GMT  
		Size: 2.4 KB (2443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035eca89bc4ca4ac33e7641818ac55eefcd2f68363924ae0f60b2a126b271a27`  
		Last Modified: Wed, 02 Nov 2022 00:57:04 GMT  
...
```console
$ docker pull php@sha256:e0c1560d3522d9e29e7ceef9ecff00c0b8222b9d7c91ee0d87c5370db1ec94b4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.4 MB (23402583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f81b5eee348b1c77b97aa7c96a03b9ebdcf13f91efca0a2a32b1cc46ea121c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 01:16:53 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 01:16:55 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 01:16:57 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 01:16:57 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 01:16:58 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:e965dda37698f04e5c509432d5941a09f87379810004accfc9e7981f85e6bdf4`  
		...
		Size: 498.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45488a9c9a0fd14122c5211fd71560bb31082f869970c0bb7e8afa449fee6be9`  
		Last Modified: Wed, 02 Nov 2022 01:58:27 GMT  
		Size: 8.5 MB (8549660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e43fe95ee998b55a5526cf46ccdc8f02166a7b0cbf63cb5df2bcb5ee9f223559`  
		Last Modified: Wed, 02 Nov 2022 01:58:25 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fb88c580be70b0ea9b5dbbbf824b165ac81df7a7ac3fb44aedfb2de2a684b1d`  
		Last Modified: Wed, 02 Nov 2022 01:58:25 GMT  
...
```console
$ docker pull php@sha256:8248d1233dec2c09ce749f22153135a4d969e05ad80d845f356f3a834049c6f5
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.8 MB (24818434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5cb484907b9a112c43911a261ea8fd1edf40efc6efd9a99ef1ef23f0b7450fc6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Fri, 28 Oct 2022 19:53:45 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:33:54 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 00:33:54 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:33:55 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 00:33:55 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 00:33:55 GMT
...
-	Layers:
	...
	-	`sha256:5d0f544f481ff36f041f3a18a913c7fb9d551a4c6fbb5f05bb414f627771f4dd`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b6cb5151598a0093b9047f61c75c9e4efda3c40367c2633e2103bbb4b885f42`  
		Last Modified: Wed, 02 Nov 2022 00:52:00 GMT  
		Size: 9.5 MB (9538541 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91cd64d9e04a860f9e8732a4a24a8939ede967462f45116f3b1517a236570bf6`  
		Last Modified: Wed, 02 Nov 2022 00:51:59 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8085fc5e1dfe692f001d54b213b7ec87a40cc2f660097c1f771dcd10129ace2`  
		Last Modified: Wed, 02 Nov 2022 00:51:59 GMT  
...
```console
$ docker pull php@sha256:185df223bbcf154dc78387109c15e2fbe750a56cb35ff5acf8015d727178b876
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.8 MB (25773074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8722238b489ebba5b6803c905f04ca990497135f2a0d09246f629ce6c738acbb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:27:19 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 00:27:21 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:27:21 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 00:27:22 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 00:27:23 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:8193a331eb5019783fe8a58fe5bffb1a37b9913e484ba6cfdf7b1fa31070403e`  
		...
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c2fbb1dd58761fa2b34d459c95ba6b746d4b9f5ff4b21025a1c0857d8cc4d09`  
		Last Modified: Wed, 02 Nov 2022 00:54:41 GMT  
		Size: 10.3 MB (10283713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49c0270fbf46e7e10c59d171530e477756f0985cc099748115e2075e20353605`  
		Last Modified: Wed, 02 Nov 2022 00:54:40 GMT  
		Size: 2.4 KB (2444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74877cc3fd45e4a046a189ae8f2c1bcfe82ca52499671240f40cd0351ca5b3eb`  
		Last Modified: Wed, 02 Nov 2022 00:54:40 GMT  
...
```console
$ docker pull php@sha256:001bec2bc254a51b934d65ec53dc310418a65024b865748c68070c4ab1b6dfd8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.5 MB (25524742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c5803a1112d0b0119c08d9146bf636f08d7688e187f06aa2e960a340027946b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Fri, 28 Oct 2022 19:55:45 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 01:19:12 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 01:19:13 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 01:19:15 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 01:19:15 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 01:19:16 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:8e5e1b2529be529f91d8c5cbf8bf67f09594d9d16a56ba55f7675bab2693e02e`  
		...
		Size: 497.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b4da76ea80ba8ea20b17a50e7a69318ca6b4a08eba2bf33192f424b044aac9d`  
		Last Modified: Wed, 02 Nov 2022 01:46:02 GMT  
		Size: 10.1 MB (10103131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eefd2283daa860ff073566df416f51104dc91c551e6d53d18921b61a9f667822`  
		Last Modified: Wed, 02 Nov 2022 01:45:59 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f4245cce1a4ccd7b2846b1acaaf9477e4a5ec015c31609dc8d67c680b38210a`  
		Last Modified: Wed, 02 Nov 2022 01:45:59 GMT  
...
```console
$ docker pull php@sha256:9455f1770644a6c36c5302a9f89fe798bc8ac46f4ff4e9c2945bff9a8686fe9b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.6 MB (24588191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c427ed3fe604d8a2984e84397a59f59871c3a14e13b6d91d0f7a0c0f69676978`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Fri, 28 Oct 2022 19:30:31 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:52:11 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-zts 		--disable-zend-signals 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 02 Nov 2022 00:52:14 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 02 Nov 2022 00:52:16 GMT
RUN docker-php-ext-enable sodium
# Wed, 02 Nov 2022 00:52:17 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 02 Nov 2022 00:52:17 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:3009c3b796720fa72151ce48c717572b447f69c5e9c92713c81adb35ed4e2629`  
		...
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38c856aa3f9b3899fc68c07d6cc7afcb4f529880f940dcc4d79eeb2e42fe0036`  
		Last Modified: Wed, 02 Nov 2022 01:26:25 GMT  
		Size: 9.4 MB (9360828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9dddd42ae5309a9b26905c76109c38262465e86eaa80eb9de13cbfe794290a2`  
		Last Modified: Wed, 02 Nov 2022 01:26:24 GMT  
		Size: 2.4 KB (2447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:979f5e0eeaf56055081ecff2c689bc10178d6715f7e1d5b2c6627f2d676a63b8`  
		Last Modified: Wed, 02 Nov 2022 01:26:24 GMT  
