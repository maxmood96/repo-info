...
```console
$ docker pull php@sha256:afd8ff2458d1f8a285506e0fe9c0f62585e724ff939829a40edeadb47c84fd8c
```
...
```console
$ docker pull php@sha256:df8424cb44d64d43046378627b22ed83d0ff50890faf5a327d5ffc6e0830f71d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.9 MB (29890726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:510a8fd65f3c5b1bff1088f77ab5469de257663574798629a3c128a19b2425cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
