...
```console
$ docker pull php@sha256:2baff4b94a366d1a858aec4e5bcd90e43b6997f5ca088401d3a274d9b9a7826b
```
...
```console
$ docker pull php@sha256:9c780aa6fdcac8bada55ad268d46b8978892d433f3afaea8468ba5e0e7910a03
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.8 MB (30773905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:842edcf5ac0e1620785f8e39491fcae9b78776197af9c09dc5d0b34ec35bba11`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
