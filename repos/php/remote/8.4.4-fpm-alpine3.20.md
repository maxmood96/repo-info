...
```console
$ docker pull php@sha256:4121bb502141d5d91d9e5b50c6edc05a8849592cb2bb9c8074a191b2a9857c7c
```
...
### `php:8.4.4-fpm-alpine3.20` - linux; amd64
...
### `php:8.4.4-fpm-alpine3.20` - unknown; unknown
...
### `php:8.4.4-fpm-alpine3.20` - linux; arm variant v6
...
### `php:8.4.4-fpm-alpine3.20` - linux; arm variant v7
...
### `php:8.4.4-fpm-alpine3.20` - linux; arm64 variant v8
...
### `php:8.4.4-fpm-alpine3.20` - linux; 386
...
### `php:8.4.4-fpm-alpine3.20` - linux; ppc64le
...
### `php:8.4.4-fpm-alpine3.20` - linux; s390x
