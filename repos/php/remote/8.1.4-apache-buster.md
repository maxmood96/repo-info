...
```console
$ docker pull php@sha256:996d3dd42225f06c44152ea020a8021ad4e38b027260607411be1c2277fde6b4
```
...
### `php:8.1.4-apache-buster` - linux; arm variant v5
...
### `php:8.1.4-apache-buster` - linux; arm variant v7
...
### `php:8.1.4-apache-buster` - linux; arm64 variant v8
...
### `php:8.1.4-apache-buster` - linux; mips64le
...
### `php:8.1.4-apache-buster` - linux; ppc64le
