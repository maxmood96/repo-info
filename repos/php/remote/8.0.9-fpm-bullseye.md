...
```console
$ docker pull php@sha256:00ee5201b5119135a3773ce159e27b7deed2e3f72ca0f9cd19f8ea24f5693179
```
...
### `php:8.0.9-fpm-bullseye` - linux; arm variant v7
...
### `php:8.0.9-fpm-bullseye` - linux; 386
...
### `php:8.0.9-fpm-bullseye` - linux; mips64le
...
### `php:8.0.9-fpm-bullseye` - linux; ppc64le
...
### `php:8.0.9-fpm-bullseye` - linux; s390x
