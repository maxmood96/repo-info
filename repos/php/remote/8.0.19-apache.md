...
```console
$ docker pull php@sha256:d18ab6f32c335382e19e9ac929f28a51d831637d3aeaa023ab25aea68d092bed
```
...
### `php:8.0.19-apache` - linux; arm variant v7
...
### `php:8.0.19-apache` - linux; arm64 variant v8
...
### `php:8.0.19-apache` - linux; mips64le
...
### `php:8.0.19-apache` - linux; ppc64le
