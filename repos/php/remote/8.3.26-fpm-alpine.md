...
```console
$ docker pull php@sha256:5b5bdb63a09adcc249fbeb427393ff4e50e7d5ee6ff318efaf0e7fa861b0d6b1
```
...
### `php:8.3.26-fpm-alpine` - linux; amd64
...
### `php:8.3.26-fpm-alpine` - unknown; unknown
...
### `php:8.3.26-fpm-alpine` - linux; arm variant v6
...
### `php:8.3.26-fpm-alpine` - linux; arm variant v7
...
### `php:8.3.26-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.3.26-fpm-alpine` - linux; 386
...
### `php:8.3.26-fpm-alpine` - linux; ppc64le
...
### `php:8.3.26-fpm-alpine` - linux; s390x
