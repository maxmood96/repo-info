...
```console
$ docker pull php@sha256:bdc84a424482fbecee87f1587eba876218f1242fcddced795f1e748b0d23ccf3
```
...
```console
$ docker pull php@sha256:2adfcaf11344b954413ded6eefad783342b88546b2221095d5558525cf947005
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.4 MB (30382935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5e5aa71bf31cb08abe89ea3b5f1c5c0ef7e701d70d364bdf334fa2659b51bb9`
...
-	Layers:
	...
	-	`sha256:ef146910517c834a4e34f28fc3df23a9ca51de2bb5ce851bf5027b155adb01af`  
		...
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edbd57782ebeb43e97814abb097c2e98f378381ab19d4325a3243d10da506158`  
		Last Modified: Wed, 09 Aug 2023 07:16:22 GMT  
		Size: 12.5 MB (12467332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:814328011cc32e9b997631b3f7e9ae0d1fca4ae68e2a221fff48bea98e251eec`  
		Last Modified: Wed, 09 Aug 2023 07:16:20 GMT  
		Size: 2.4 KB (2448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3857de83132193f89ec603c123e7d361264eb67e8ed4ea32201e00114da7953e`  
		Last Modified: Wed, 09 Aug 2023 07:16:20 GMT  
...
```console
$ docker pull php@sha256:299279a602afc71b9f261a185a7a878c1d4085661fd132012e4ea8617902a069
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.4 MB (30428439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:632eae7d856acda3a9be7500e8aca01e4698c3ecb553ae3766e36556508a8b68`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 09 Aug 2023 06:26:33 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-musl' && echo '--without-pcre-jit') 				--disable-cgi 				--enable-embed 				--enable-zts 		--disable-zend-signals 		--enable-zend-max-execution-timers 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 09 Aug 2023 06:26:33 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 09 Aug 2023 06:26:34 GMT
RUN docker-php-ext-enable sodium
# Wed, 09 Aug 2023 06:26:34 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 09 Aug 2023 06:26:35 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:f3fd3638ed97e1ab790fba3dc7f27e14fe7377ede9509492c64b2e0435fcd66c`  
		...
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:954cb6a461acbadc43d1308b8434d97ab99855a0517c1ef83dabfd1ccc063891`  
		Last Modified: Wed, 09 Aug 2023 07:25:08 GMT  
		Size: 12.5 MB (12545964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:552049774baa8279a4734694e09e68938bef215651283a0884a0b662174cad5d`  
		Last Modified: Wed, 09 Aug 2023 07:25:06 GMT  
		Size: 2.4 KB (2446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c40b21205e000e06efb9a9f3f5ed3b2e0b444c73e302abd28baef3665b0757a`  
		Last Modified: Wed, 09 Aug 2023 07:25:06 GMT  
...
```console
$ docker pull php@sha256:4fd52c9ed41cc3cf0d6437c807be336259da859ba51598bb50adc08b59e76e0e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29533913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:263bc542af16ddf7ad21da85862fc28367a4423b6a5a0edf47089c1686676ca5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
-	Layers:
	...
	-	`sha256:25a010c31ac739baed0fc94ea2545eb34238758daee953281dd19c2c71279271`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70329a1120a137346e80af33704be696190e46042ebfd15d37fc8f78c8ac87e4`  
		Last Modified: Wed, 09 Aug 2023 06:32:39 GMT  
		Size: 11.7 MB (11695001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79ddb4fc08b0aaab808ae464205aab8fdef4422a9aac0d328d6eed136467901e`  
		Last Modified: Wed, 09 Aug 2023 06:32:37 GMT  
		Size: 2.4 KB (2446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edc8443effd81fd170a9e3cbcbdd70c7bdcb88325092dea6919846f9faffeabd`  
		Last Modified: Wed, 09 Aug 2023 06:32:37 GMT  
