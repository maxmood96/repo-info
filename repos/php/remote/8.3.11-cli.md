...
```console
$ docker pull php@sha256:ac3136f866084cd18aa4a573b002a1dd7b7e1242bedc7f8d1632bf157a2ed2b2
```
...
### `php:8.3.11-cli` - linux; arm variant v5
...
### `php:8.3.11-cli` - linux; arm variant v7
...
### `php:8.3.11-cli` - linux; arm64 variant v8
