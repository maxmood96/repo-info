...
```console
$ docker pull php@sha256:30be234ee241fe61c4daa6ac55c5159bd0baf0b8a0147833becf094ff796b3ad
```
...
### `php:8.3.28-alpine3.23` - linux; amd64
...
### `php:8.3.28-alpine3.23` - unknown; unknown
...
### `php:8.3.28-alpine3.23` - linux; arm variant v6
...
### `php:8.3.28-alpine3.23` - linux; arm variant v7
...
### `php:8.3.28-alpine3.23` - linux; arm64 variant v8
...
### `php:8.3.28-alpine3.23` - linux; 386
...
### `php:8.3.28-alpine3.23` - linux; ppc64le
...
### `php:8.3.28-alpine3.23` - linux; s390x
