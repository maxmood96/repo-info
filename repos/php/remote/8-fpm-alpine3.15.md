...
```console
$ docker pull php@sha256:a7924365635959ca5441ae0f9eab27453c734cb5c5acd08e8d4b6a4796399e46
```
...
```console
$ docker pull php@sha256:5e632817778550049baf11fecd2a279b0e9477aed45af7cfb2e2acf314f6144a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.7 MB (27666996 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db72d70ea39428101567eb1ba11e0c4cd936a38117850b57622ae86c4d4ab40b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
