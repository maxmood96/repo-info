...
```console
$ docker pull php@sha256:68c9a24e989fc4d7520fbbe7156c9f12c9c90bac39297016d1d5b066f2955772
```
...
### `php:8.2.26-fpm-bullseye` - linux; amd64
...
### `php:8.2.26-fpm-bullseye` - unknown; unknown
...
### `php:8.2.26-fpm-bullseye` - linux; arm variant v7
...
### `php:8.2.26-fpm-bullseye` - linux; 386
