...
### `php:8.4.4-apache-bullseye` - linux; amd64
...
### `php:8.4.4-apache-bullseye` - unknown; unknown
...
### `php:8.4.4-apache-bullseye` - linux; arm variant v7
...
### `php:8.4.4-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.4.4-apache-bullseye` - linux; 386
