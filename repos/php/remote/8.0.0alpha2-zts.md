...
```console
$ docker pull php@sha256:0c97273d0bd2fb64b4cf35014342ad6dbefce672254ce0f3240ac92f07878904
```
...
### `php:8.0.0alpha2-zts` - linux; amd64
...
### `php:8.0.0alpha2-zts` - linux; ppc64le
