...
```console
$ docker pull php@sha256:af5e2f002b621164f3fc8162c0d5a66109a040c9668502b3593f736121c1679a
```
...
### `php:8.2.7-alpine3.18` - linux; amd64
...
### `php:8.2.7-alpine3.18` - linux; arm variant v6
...
### `php:8.2.7-alpine3.18` - linux; arm variant v7
...
### `php:8.2.7-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.7-alpine3.18` - linux; ppc64le
...
### `php:8.2.7-alpine3.18` - linux; s390x
