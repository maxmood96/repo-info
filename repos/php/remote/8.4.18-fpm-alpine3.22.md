...
```console
$ docker pull php@sha256:c064b36e92cbff508153f33430bcd058e266cb5e7c8bbd021de078a2ded3f75f
```
...
### `php:8.4.18-fpm-alpine3.22` - linux; amd64
...
### `php:8.4.18-fpm-alpine3.22` - unknown; unknown
...
### `php:8.4.18-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.4.18-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.4.18-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.4.18-fpm-alpine3.22` - linux; 386
...
### `php:8.4.18-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.4.18-fpm-alpine3.22` - linux; s390x
