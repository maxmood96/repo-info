...
```console
$ docker pull php@sha256:598b79480021ed40777540406c131213a3d46b4e1018bff0adf4bbd0e0e677b8
```
...
### `php:8.1.30-cli-bookworm` - linux; amd64
...
### `php:8.1.30-cli-bookworm` - linux; arm variant v7
...
### `php:8.1.30-cli-bookworm` - linux; arm64 variant v8
...
### `php:8.1.30-cli-bookworm` - linux; mips64le
...
### `php:8.1.30-cli-bookworm` - linux; ppc64le
