...
```console
$ docker pull php@sha256:9f5df90efc335d1556cab4bace43f61b3433ba01455b886246c76f8661104c47
```
...
### `php:8.2.15-fpm` - linux; arm variant v5
...
### `php:8.2.15-fpm` - linux; arm variant v7
...
### `php:8.2.15-fpm` - linux; arm64 variant v8
