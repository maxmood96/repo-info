...
```console
$ docker pull php@sha256:1f5365b5281f236ada47c94a24a99e1bce7e00f0db73f691f1442c553ed9f925
```
...
### `php:8.3.16-fpm-alpine3.20` - linux; amd64
...
### `php:8.3.16-fpm-alpine3.20` - unknown; unknown
...
### `php:8.3.16-fpm-alpine3.20` - linux; arm variant v6
...
### `php:8.3.16-fpm-alpine3.20` - linux; arm variant v7
...
### `php:8.3.16-fpm-alpine3.20` - linux; arm64 variant v8
...
### `php:8.3.16-fpm-alpine3.20` - linux; 386
...
### `php:8.3.16-fpm-alpine3.20` - linux; ppc64le
...
### `php:8.3.16-fpm-alpine3.20` - linux; s390x
