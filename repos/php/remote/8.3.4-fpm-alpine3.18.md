...
```console
$ docker pull php@sha256:c2ebfc04a7c9ea46cb85e867ce7661f9b251064286e5f252081c1c7f54fd456d
```
...
### `php:8.3.4-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.3.4-fpm-alpine3.18` - linux; 386
...
### `php:8.3.4-fpm-alpine3.18` - linux; ppc64le
