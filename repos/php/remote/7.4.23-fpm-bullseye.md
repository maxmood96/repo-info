...
```console
$ docker pull php@sha256:fd92c51f48a061828376fa24c9bbb6590d5cf700cd4e59ce6eb8851d5b0433d4
```
...
### `php:7.4.23-fpm-bullseye` - linux; amd64
...
### `php:7.4.23-fpm-bullseye` - linux; arm variant v5
...
### `php:7.4.23-fpm-bullseye` - linux; arm variant v7
...
### `php:7.4.23-fpm-bullseye` - linux; arm64 variant v8
...
### `php:7.4.23-fpm-bullseye` - linux; 386

```console
$ docker pull php@sha256:2d433cb99dfb97b62c60a19f05f3d5728eee20cdb4e0459b15b42d2d05c5e245
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.2 MB (168214499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f53a96e45e2891f1bb26afdc9f8ed7a69ce04503f92898c3ed829fcf04f4c2a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.4.23-fpm-bullseye` - linux; mips64le
...
### `php:7.4.23-fpm-bullseye` - linux; s390x
