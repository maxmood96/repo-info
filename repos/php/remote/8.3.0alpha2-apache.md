...
```console
$ docker pull php@sha256:7f2286e20e0dbe016cea14078b78c22402e61400b1781c2e7ea8715c624d6372
```
...
### `php:8.3.0alpha2-apache` - linux; amd64
...
### `php:8.3.0alpha2-apache` - linux; arm variant v7
...
### `php:8.3.0alpha2-apache` - linux; arm64 variant v8
...
### `php:8.3.0alpha2-apache` - linux; 386

```console
$ docker pull php@sha256:21e4caf3e4306675f702f6f53d7c9f1ff71da50b8b4eaaee9b9a814918577b5c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.9 MB (176937540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57bab90e3ce1cdfc69bd6480f8b9928ade4230123d928188368730470dc19034`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 04 Jul 2023 14:36:20 GMT
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Tue, 04 Jul 2023 14:36:21 GMT
ENV PHP_VERSION=8.3.0alpha2
# Tue, 04 Jul 2023 14:36:21 GMT
ENV PHP_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz PHP_ASC_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz.asc
# Tue, 04 Jul 2023 14:36:21 GMT
ENV PHP_SHA256=60b0b18220dcb018ac3a602875fd21f07c9a08887ee22d50ed0670fe1e0a4792
# Tue, 04 Jul 2023 14:36:32 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 04 Jul 2023 14:36:32 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:d01ad8615e14468938f690515ed22516090c7f9b35b8dc55eee4d925775e9e05`  
		...
		Size: 515.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb429bd6e2698c599ae90f30b144708590f1fe8506081c11ee56e332643ca97f`  
		Last Modified: Tue, 04 Jul 2023 19:05:10 GMT  
		Size: 12.6 MB (12623008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6983c3b3c7ce911dca389b0a83191fe8cad6fdaa942cf2ab2cdd9974eab6d090`  
		Last Modified: Tue, 04 Jul 2023 19:05:07 GMT  
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04900019a20af02fe1834eae178a6a6f9ad15534191ac60683ad77f90e2db711`  
		Last Modified: Tue, 04 Jul 2023 19:05:10 GMT  
		Size: 11.8 MB (11836834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b31485f53d1cb9078fd678e571ed93d125891083f97cae5628628e683ed54dd`  
		Last Modified: Tue, 04 Jul 2023 19:05:07 GMT  
		Size: 2.5 KB (2457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6924ae648493f585833976f1a9e19d316b0aee1b4c73f398c56eafae7306f1e3`  
		Last Modified: Tue, 04 Jul 2023 19:05:07 GMT  
		Size: 245.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56722a08ff8d2d0b9f48534a2a149ed9b85c1e83104c7bee1e79d20369c53381`  
		Last Modified: Tue, 04 Jul 2023 19:05:07 GMT  
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.3.0alpha2-apache` - linux; mips64le

```console
$ docker pull php@sha256:d0a915905c6bdd587ec88f913b3c8640e5f8680e3367c796e7d9e3be8048ed08
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152934924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02dc1af27834afbf2e7a0b81b6c48b3a92bddcfb308b775358b77003807125b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Wed, 05 Jul 2023 02:19:39 GMT
ENV PHP_VERSION=8.3.0alpha2
# Wed, 05 Jul 2023 02:19:42 GMT
ENV PHP_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz PHP_ASC_URL=https://downloads.php.net/~eric/php-8.3.0alpha2.tar.xz.asc
# Wed, 05 Jul 2023 02:19:46 GMT
ENV PHP_SHA256=60b0b18220dcb018ac3a602875fd21f07c9a08887ee22d50ed0670fe1e0a4792
# Wed, 05 Jul 2023 02:20:34 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Wed, 05 Jul 2023 02:20:37 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 05 Jul 2023 02:36:47 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 05 Jul 2023 02:36:51 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Wed, 05 Jul 2023 02:36:57 GMT
RUN docker-php-ext-enable sodium
# Wed, 05 Jul 2023 02:37:00 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 05 Jul 2023 02:37:04 GMT
STOPSIGNAL SIGWINCH
# Wed, 05 Jul 2023 02:37:07 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Wed, 05 Jul 2023 02:37:10 GMT
WORKDIR /var/www/html
# Wed, 05 Jul 2023 02:37:14 GMT
EXPOSE 80
# Wed, 05 Jul 2023 02:37:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:db35cda58797839e80a072f0634e7bcc331cdec61b951176ed98f2385e109fb2`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae76528e935907ac69d3950bc5ae854f76a34d88d7ebe2a8d66680f2a6d6d773`  
		Last Modified: Wed, 05 Jul 2023 13:24:35 GMT  
		Size: 12.4 MB (12417890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3de1120d5e9ad7896f77670dc60b2428c1ad369dce206bc1834e2fea8f1cb3d`  
		Last Modified: Wed, 05 Jul 2023 13:24:29 GMT  
		Size: 491.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a6ab8834760e398ff4f78c71be7e65d8f8204b2f9e28e1a34482c9e9b2af79b`  
		Last Modified: Wed, 05 Jul 2023 13:24:39 GMT  
		Size: 10.7 MB (10669666 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:021915ef6bae4162a229289b21331f693ea9b25471c8da55c6b21bd060a5b864`  
		Last Modified: Wed, 05 Jul 2023 13:24:28 GMT  
		Size: 2.5 KB (2458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f40ba9d441e32b74124a5c0e741e1e863849d3b26aacf888dfc9ddef0554bc7`  
		Last Modified: Wed, 05 Jul 2023 13:24:29 GMT  
		Size: 247.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61ca2ccaa81de6f6873490fa04ca4b166e7e3c9fd431255b8923ae9ce0141a4c`  
		Last Modified: Wed, 05 Jul 2023 13:24:29 GMT  
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:8.3.0alpha2-apache` - linux; ppc64le
