...
```console
$ docker pull php@sha256:051b44f7f608156e60534b27b844dda99cd713389a0c0ef8f1417bfe78379c6a
```
...
### `php:8.0.19-fpm-alpine3.15` - linux; amd64
...
### `php:8.0.19-fpm-alpine3.15` - linux; arm variant v6
...
### `php:8.0.19-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull php@sha256:6247b44338a33ff7d0ca8261bd433b3adf7c2fd880266991b232bd4451b8a94f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.6 MB (26610518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b837f96c330c7e7b9bdd88cb8de2344b2be1930e8bfc48120002ecb4a27555c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.19-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull php@sha256:b21429e17563792ed81a447df7964ca4ce2fa32c326f8465fc65dfc469853169
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.5 MB (28504700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:076188a0eb67dcabec16f0181028909783bef5b01ea949f6887f4b6a6550f3cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.19-fpm-alpine3.15` - linux; 386

```console
$ docker pull php@sha256:447c0500eff214a4179972196576f658a91b58cfde7871cba5c3ade50fdcb8eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29637715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3984056c8e7a26b631920df1da201b547a8b0c18f9dc162d8aa345afa4d5f3a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.19-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull php@sha256:8cc80ff534a46948d58710af28c8b797b7f898a0119af6f388bbbe0e344e1af4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29645138 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:501b3bc947db83fd06d747066e0d980cc6fe0c0d149ad2f6e7bfd2a8fda29856`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.19-fpm-alpine3.15` - linux; s390x
