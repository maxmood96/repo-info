...
```console
$ docker pull php@sha256:a96ad112be3e562bc473db27858a2ee3747ebfa5c248cb8001bded377413ee65
```
...
### `php:8.2.12RC1-apache-bookworm` - linux; amd64
...
### `php:8.2.12RC1-apache-bookworm` - linux; arm variant v5
...
### `php:8.2.12RC1-apache-bookworm` - linux; arm variant v7
...
### `php:8.2.12RC1-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.2.12RC1-apache-bookworm` - linux; 386
...
### `php:8.2.12RC1-apache-bookworm` - linux; mips64le
...
### `php:8.2.12RC1-apache-bookworm` - linux; ppc64le
...
### `php:8.2.12RC1-apache-bookworm` - linux; s390x
