...
```console
$ docker pull php@sha256:b4c1570d0fb51a4994e876b15315234931a545c866de84fdd8e450d3d1ac88c7
```
...
### `php:8.1.6-zts-bullseye` - linux; amd64
...
### `php:8.1.6-zts-bullseye` - linux; arm variant v5
...
### `php:8.1.6-zts-bullseye` - linux; arm variant v7
...
### `php:8.1.6-zts-bullseye` - linux; arm64 variant v8
...
### `php:8.1.6-zts-bullseye` - linux; 386
...
### `php:8.1.6-zts-bullseye` - linux; mips64le
...
### `php:8.1.6-zts-bullseye` - linux; ppc64le
...
### `php:8.1.6-zts-bullseye` - linux; s390x
