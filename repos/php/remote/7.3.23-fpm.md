...
```console
$ docker pull php@sha256:9a98957fe9afd32dc125b0aa7c6bf6541180f5f74eead94cf67ad0b7b0f755c0
```
...
### `php:7.3.23-fpm` - linux; arm variant v5
...
### `php:7.3.23-fpm` - linux; arm variant v7
...
### `php:7.3.23-fpm` - linux; arm64 variant v8
