...
```console
$ docker pull php@sha256:38e05ea239508b4f01ac7361436abd44844d46d652ad3d43023efcb6a35dfda0
```
...
```console
$ docker pull php@sha256:3635cee59490c02c9aac1bbd265d14a3d5b58b5f2e325ede46d6222e102db3f7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.6 MB (27587714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f64a507622f0be304660dec9a2f2943be3863082ce203600e0087516873b6a01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
