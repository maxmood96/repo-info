...
```console
$ docker pull php@sha256:189b4794bda08a4ea1c19ff54751a1a91c5c06c34e1d90305cec2523a7d10241
```
...
### `php:8.2.19-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.2.19-apache-bullseye` - linux; 386
...
### `php:8.2.19-apache-bullseye` - linux; s390x
