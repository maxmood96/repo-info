...
```console
$ docker pull php@sha256:d2ac35773989033fb48072fdb2fef8bfd6181b2103fc12f1feb55eb6a7ef9f45
```
...
```console
$ docker pull php@sha256:1b2a1239753c8272a9b523e9d154e606205517103b8ce80f702249cb8145f4c1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29792069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc38f9c5b0ad02c364660f7f94e13f04f415fd7a948d80d97858604d7feac374`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
