...
```console
$ docker pull php@sha256:087bb56253a480f4719213ff226fc8a2b965da123cf329af121847d0883080e7
```
...
### `php:8.0.9-fpm-alpine3.13` - linux; amd64
...
```console
$ docker pull php@sha256:62e63322ca91fbd9c769d8a33d1fea34955ca323ce738f9f1c3e9cf535dbdfe3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.1 MB (29106079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:288b509a8ea89ade30a7313ca7ba5d9d66bf01596efcb4aff3205bf281d7944d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.9-fpm-alpine3.13` - linux; arm variant v7
...
### `php:8.0.9-fpm-alpine3.13` - linux; arm64 variant v8
...
### `php:8.0.9-fpm-alpine3.13` - linux; 386
...
### `php:8.0.9-fpm-alpine3.13` - linux; ppc64le
...
### `php:8.0.9-fpm-alpine3.13` - linux; s390x
