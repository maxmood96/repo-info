...
```console
$ docker pull php@sha256:967855746377c3bae2e20ac558742276596809fa1a44ec4e71e2b1bb195baed9
```
...
### `php:8.3.1-fpm-alpine3.19` - linux; arm variant v7
...
### `php:8.3.1-fpm-alpine3.19` - linux; 386
