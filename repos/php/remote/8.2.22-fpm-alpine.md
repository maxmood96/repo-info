...
```console
$ docker pull php@sha256:710a00ee3f32a23df30d7c99ae6fa307bf5977c6e485704a1e15527fc6857657
```
...
### `php:8.2.22-fpm-alpine` - linux; amd64
...
### `php:8.2.22-fpm-alpine` - linux; arm variant v6
...
### `php:8.2.22-fpm-alpine` - linux; arm variant v7
...
### `php:8.2.22-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.2.22-fpm-alpine` - linux; 386
...
### `php:8.2.22-fpm-alpine` - linux; ppc64le
...
### `php:8.2.22-fpm-alpine` - linux; riscv64
...
### `php:8.2.22-fpm-alpine` - linux; s390x

```console
$ docker pull php@sha256:aca8f36049f1dc4d5e7f3e79daf5e76b4f7b46b72816113a0b9df596f0a10914
```
...
-	Total Size: **32.4 MB (32405985 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0af42a9661c4d12e6f4e21c9acd20c53a54ebb08694f90e59ee918db09dc3f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
