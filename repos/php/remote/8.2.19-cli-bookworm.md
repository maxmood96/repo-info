...
### `php:8.2.19-cli-bookworm` - linux; arm64 variant v8
...
### `php:8.2.19-cli-bookworm` - linux; 386
...
### `php:8.2.19-cli-bookworm` - linux; mips64le
...
### `php:8.2.19-cli-bookworm` - linux; s390x
