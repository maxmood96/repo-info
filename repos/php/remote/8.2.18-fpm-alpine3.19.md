...
```console
$ docker pull php@sha256:99e566decc96b55ae5b3fc2bf9c4522298159d118e5fddcec0d694570f8e4cd5
```
...
### `php:8.2.18-fpm-alpine3.19` - linux; arm variant v6
...
### `php:8.2.18-fpm-alpine3.19` - linux; arm variant v7
...
### `php:8.2.18-fpm-alpine3.19` - linux; 386
