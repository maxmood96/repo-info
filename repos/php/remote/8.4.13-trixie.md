...
### `php:8.4.13-trixie` - unknown; unknown
...
### `php:8.4.13-trixie` - linux; arm variant v5
...
### `php:8.4.13-trixie` - linux; arm variant v7
...
### `php:8.4.13-trixie` - linux; arm64 variant v8
...
### `php:8.4.13-trixie` - linux; ppc64le
...
### `php:8.4.13-trixie` - linux; riscv64
