...
```console
$ docker pull php@sha256:e9fa36295464c658d2743c4af8e59f01511588c87a706701b333963b17c9af33
```
...
### `php:8.5.5-fpm-alpine3.22` - linux; amd64
...
### `php:8.5.5-fpm-alpine3.22` - unknown; unknown
...
### `php:8.5.5-fpm-alpine3.22` - linux; arm variant v6
...
### `php:8.5.5-fpm-alpine3.22` - linux; arm variant v7
...
### `php:8.5.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `php:8.5.5-fpm-alpine3.22` - linux; 386
...
### `php:8.5.5-fpm-alpine3.22` - linux; ppc64le
...
### `php:8.5.5-fpm-alpine3.22` - linux; s390x
