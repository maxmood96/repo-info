...
### `php:8.2.12-alpine3.17` - linux; amd64
...
### `php:8.2.12-alpine3.17` - linux; arm variant v7
...
### `php:8.2.12-alpine3.17` - linux; arm64 variant v8
...
### `php:8.2.12-alpine3.17` - linux; 386
...
### `php:8.2.12-alpine3.17` - linux; ppc64le
...
### `php:8.2.12-alpine3.17` - linux; s390x
