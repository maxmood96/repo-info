...
```console
$ docker pull php@sha256:5757f199e58798e7471205542651a90241726aafe31a91b23f43e02baa1218f7
```
...
### `php:8.1.4-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.4-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.4-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.4-apache-bullseye` - linux; mips64le
...
### `php:8.1.4-apache-bullseye` - linux; ppc64le
