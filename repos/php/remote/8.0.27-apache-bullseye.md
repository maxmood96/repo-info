...
```console
$ docker pull php@sha256:8c8cb8a21286707307eb7872d45a098605f6383962b75c2346378222f5eaceb4
```
...
```console
$ docker pull php@sha256:4d3d3f39d3286b77b660646ddf10a4da20f6952d56d27ebba1cd1be09c454cc9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164201163 bytes)**  
