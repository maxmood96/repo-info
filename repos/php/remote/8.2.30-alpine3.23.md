...
```console
$ docker pull php@sha256:261b6914bc61baffaa884cf9125e9ecdd68462220c20038683387670f8aaa9d1
```
...
### `php:8.2.30-alpine3.23` - linux; amd64
...
### `php:8.2.30-alpine3.23` - unknown; unknown
...
### `php:8.2.30-alpine3.23` - linux; arm variant v6
...
### `php:8.2.30-alpine3.23` - linux; arm variant v7
...
### `php:8.2.30-alpine3.23` - linux; arm64 variant v8
...
### `php:8.2.30-alpine3.23` - linux; 386
...
### `php:8.2.30-alpine3.23` - linux; ppc64le
...
### `php:8.2.30-alpine3.23` - linux; s390x
