...
```console
$ docker pull php@sha256:9ec222542966505fdbc81011787e8865b35cef1c24198e107bcbefeef61af956
```
...
### `php:7.4.2-fpm-alpine3.10` - linux; arm64 variant v8
...
### `php:7.4.2-fpm-alpine3.10` - linux; 386
...
### `php:7.4.2-fpm-alpine3.10` - linux; ppc64le
