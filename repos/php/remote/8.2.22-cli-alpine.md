...
### `php:8.2.22-cli-alpine` - linux; arm variant v7
...
### `php:8.2.22-cli-alpine` - linux; arm64 variant v8
...
### `php:8.2.22-cli-alpine` - linux; 386
...
### `php:8.2.22-cli-alpine` - linux; riscv64
...
### `php:8.2.22-cli-alpine` - linux; s390x
