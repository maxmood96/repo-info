...
```console
$ docker pull php@sha256:3b210cb8f9cd7ff07512a555e6e91320acb111425d42bee4330047049fb404ce
```
...
### `php:8.3.13-fpm-alpine3.19` - linux; amd64
...
### `php:8.3.13-fpm-alpine3.19` - linux; arm variant v7
...
### `php:8.3.13-fpm-alpine3.19` - linux; arm64 variant v8
...
### `php:8.3.13-fpm-alpine3.19` - linux; s390x
