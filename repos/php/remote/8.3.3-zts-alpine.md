...
```console
$ docker pull php@sha256:01a91f33bdd57b9abebc4c173a582966f0aeb68c4187cd66f65aa18a3e8330c7
```
...
### `php:8.3.3-zts-alpine` - linux; amd64
...
### `php:8.3.3-zts-alpine` - linux; 386
...
### `php:8.3.3-zts-alpine` - linux; s390x
