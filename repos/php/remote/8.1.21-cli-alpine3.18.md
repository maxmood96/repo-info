...
```console
$ docker pull php@sha256:6a9106c10125e262f6c0ce9fab2a50eb73424df7bd927bb10911b54f41e88953
```
...
### `php:8.1.21-cli-alpine3.18` - linux; amd64
...
### `php:8.1.21-cli-alpine3.18` - linux; arm variant v6
...
### `php:8.1.21-cli-alpine3.18` - linux; arm variant v7
...
### `php:8.1.21-cli-alpine3.18` - linux; arm64 variant v8
...
### `php:8.1.21-cli-alpine3.18` - linux; 386
...
### `php:8.1.21-cli-alpine3.18` - linux; ppc64le
...
### `php:8.1.21-cli-alpine3.18` - linux; s390x

```console
$ docker pull php@sha256:879f25058b5608217cad1a48722062afd5b0712aeee407e965abf893230c83f1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.1 MB (33134972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52740fcbd0df86b6c9fcad7e8b26bade82e1e1507a1d75bf2817590db669e9fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
