...
```console
$ docker pull php@sha256:298b1e9af07854d6c531eb062075a1dba6a588f6af6a04b10e93e91816bdc1a2
```
...
### `php:8.2.29-alpine3.22` - linux; amd64
...
### `php:8.2.29-alpine3.22` - unknown; unknown
...
### `php:8.2.29-alpine3.22` - linux; arm variant v6
...
### `php:8.2.29-alpine3.22` - linux; arm variant v7
...
### `php:8.2.29-alpine3.22` - linux; arm64 variant v8
...
### `php:8.2.29-alpine3.22` - linux; 386
...
### `php:8.2.29-alpine3.22` - linux; ppc64le
...
### `php:8.2.29-alpine3.22` - linux; s390x
