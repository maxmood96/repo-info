...
```console
$ docker pull php@sha256:7c4527ff93ee64a5a851df88555490981b3cb1c00d473f274974b776459f1a72
```
...
### `php:8.4.14-fpm-alpine` - linux; amd64
...
### `php:8.4.14-fpm-alpine` - unknown; unknown
...
### `php:8.4.14-fpm-alpine` - linux; arm variant v6
...
### `php:8.4.14-fpm-alpine` - linux; arm variant v7
...
### `php:8.4.14-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.4.14-fpm-alpine` - linux; 386
...
### `php:8.4.14-fpm-alpine` - linux; ppc64le
...
### `php:8.4.14-fpm-alpine` - linux; s390x
