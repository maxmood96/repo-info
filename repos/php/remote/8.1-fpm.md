...
```console
$ docker pull php@sha256:10d3b1b92a860006de47e5e2f2813a8aa32f4c78bd024075a05d6e86cbffe6f7
```
...
```console
$ docker pull php@sha256:7b6da5bd48759619924be7a2c0df9e87ffa173edcc0a356c162e1904edf41e1d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.1 MB (139096620 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5369721c942ae2787d3d5fad690db1088afb225ba82eb0d909e23364c3a4ec23`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
