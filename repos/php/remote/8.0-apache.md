...
```console
$ docker pull php@sha256:b8e8ccb337fc7c9a08de7e0f5d19b46e5eaf393bdaf79dfa87da92bc95d10a7c
```
...
```console
$ docker pull php@sha256:fbbfeacbfc868df3004835366df33b93ca0d4f8ed3328a4979cb714c56d6c128
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.4 MB (134398888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7d962e1e4f66dfcd86087ad0ea36c5eca9e5e6e31480db44b4be0f5a08cac6a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
