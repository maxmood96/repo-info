...
```console
$ docker pull php@sha256:a511a622454b221789cda18dea58b6cc33a4ef88de23bc24e4a72a33006b4efb
```
...
### `php:8.3.19-fpm-alpine3.20` - linux; amd64
...
### `php:8.3.19-fpm-alpine3.20` - linux; arm variant v7
