...
```console
$ docker pull php@sha256:dd3052f5a467b308a66db35e8cb92a65d03381fb308d84c292910a97dfd193e2
```
...
### `php:7.4.1-alpine` - linux; arm64 variant v8
...
### `php:7.4.1-alpine` - linux; ppc64le
