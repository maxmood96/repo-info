...
### `php:8.4.11-apache` - unknown; unknown
...
### `php:8.4.11-apache` - linux; arm variant v5
...
### `php:8.4.11-apache` - linux; arm variant v7
...
### `php:8.4.11-apache` - linux; arm64 variant v8
...
### `php:8.4.11-apache` - linux; ppc64le
...
### `php:8.4.11-apache` - linux; riscv64
