...
```console
$ docker pull php@sha256:2264e223f5f03ab2769173d147a8a8b54c138e9275c1246236a74edca060d313
```
...
### `php:8.3.6-zts-alpine3.18` - linux; arm variant v6
...
### `php:8.3.6-zts-alpine3.18` - linux; arm variant v7
