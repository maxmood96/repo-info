...
```console
$ docker pull php@sha256:5940cf4953e3b85b1df7dd9f88a28afd5c2df2bc4207a4b6bfb090c450887f17
```
...
### `php:8.1.10-zts-alpine3.15` - linux; amd64
...
### `php:8.1.10-zts-alpine3.15` - linux; 386
...
### `php:8.1.10-zts-alpine3.15` - linux; ppc64le
...
### `php:8.1.10-zts-alpine3.15` - linux; s390x
