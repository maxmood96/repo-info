...
```console
$ docker pull php@sha256:42bb63ae3d87ac5656633639e9cf16306d02fba7a0902cb12f1a847dd0f21607
```
...
### `php:8.2.8-apache` - linux; arm variant v5
...
### `php:8.2.8-apache` - linux; arm variant v7
...
### `php:8.2.8-apache` - linux; arm64 variant v8
...
### `php:8.2.8-apache` - linux; mips64le
...
### `php:8.2.8-apache` - linux; ppc64le
