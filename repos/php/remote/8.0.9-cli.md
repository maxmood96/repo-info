...
```console
$ docker pull php@sha256:39b392af1c60e412e4ea62785e5ec9b81ba461d629eca2e9be70d77d03dc0fe2
```
...
### `php:8.0.9-cli` - linux; arm variant v5
...
### `php:8.0.9-cli` - linux; arm variant v7
...
### `php:8.0.9-cli` - linux; arm64 variant v8
