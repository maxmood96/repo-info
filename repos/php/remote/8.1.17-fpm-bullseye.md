...
### `php:8.1.17-fpm-bullseye` - linux; amd64
...
### `php:8.1.17-fpm-bullseye` - linux; arm variant v7
...
### `php:8.1.17-fpm-bullseye` - linux; arm64 variant v8
...
### `php:8.1.17-fpm-bullseye` - linux; 386
...
### `php:8.1.17-fpm-bullseye` - linux; mips64le
...
### `php:8.1.17-fpm-bullseye` - linux; s390x
