...
```console
$ docker pull php@sha256:b2b24fe1fe697e5cc27606663baf62b64fb06cb363221d299c488d2218d6e08b
```
...
```console
$ docker pull php@sha256:24137003cd07ff4e0c03e8725bf4a1d715046d3a56c71d46425bb797facffbea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.0 MB (181950047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e875c595d38d2bcd701f260245d4aff92903e6adfc9834f52ee92ad775fcea3`
...
-	Layers:
	...
	-	`sha256:88e24511c7bbf65fbbb3a037dd325b11e7ec99a2f5ff3c30a31cb8081384e354`  
		...
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3d69f527900b2ab2bf6924788cdadc1ed6456e9bfa0688fda799eec86a37d66`  
		Last Modified: Wed, 24 Apr 2024 10:17:48 GMT  
		Size: 36.0 MB (36033636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa05b4af715d0538e2acd28def83b91b1e9eccb4a1e2ad50f87fd03a2c27f597`  
		Last Modified: Wed, 24 Apr 2024 10:17:43 GMT  
		Size: 2.5 KB (2455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77adbe2b906dad3b4cdfb87a080b48877780cd1d90e9b531a4203828bee3675`  
		Last Modified: Wed, 24 Apr 2024 10:17:43 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:06c8d09368d817d3ffaed52c740f2b33bec9483862d2474f2012f57c30eaa3df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156312753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b73816998af205d081cb677be4dad2fe3bb45a1e10d2b18ad1029bdac70245ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Wed, 24 Apr 2024 14:04:54 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--enable-embed 				--enable-zts 		--disable-zend-signals 		--enable-zend-max-execution-timers 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Wed, 24 Apr 2024 14:04:58 GMT
COPY multi:6edd033b037aa2d7697fc3b9f82c2f162146c1920a0c6d25a165dc56783204db in /usr/local/bin/ 
# Wed, 24 Apr 2024 14:05:05 GMT
RUN docker-php-ext-enable sodium
# Wed, 24 Apr 2024 14:05:08 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Wed, 24 Apr 2024 14:05:12 GMT
CMD ["php" "-a"]
```
...
-	Layers:
	...
	-	`sha256:45a535cf25cd05169700ef062fabe7bc5cb3bd32b27a23fa0203fc35dbe582b2`  
		...
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02575ab13926efe33e4192ba3ceb9a40f5cd602de0c85880391a6e6f1c3c52c3`  
		Last Modified: Wed, 24 Apr 2024 17:17:08 GMT  
		Size: 34.5 MB (34493437 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0011577a52c46f9dda57dcf9ad91e3b62b912ca6ba8687142ac67a54b4ddfbb2`  
		Last Modified: Wed, 24 Apr 2024 17:16:47 GMT  
		Size: 2.5 KB (2454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58ef6ab8180c820c1f3db1d2ab86d0e0fa751e48384ed6f61c4250c605c6fbde`  
		Last Modified: Wed, 24 Apr 2024 17:16:47 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
