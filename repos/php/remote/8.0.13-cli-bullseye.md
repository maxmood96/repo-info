...
```console
$ docker pull php@sha256:3c9d23999c3331d7c22ab5fb7d05d60cedf0340629577a535616edb30d37831f
```
...
### `php:8.0.13-cli-bullseye` - linux; amd64
...
### `php:8.0.13-cli-bullseye` - linux; arm variant v5
...
### `php:8.0.13-cli-bullseye` - linux; arm variant v7
...
### `php:8.0.13-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.0.13-cli-bullseye` - linux; 386
...
### `php:8.0.13-cli-bullseye` - linux; mips64le
...
### `php:8.0.13-cli-bullseye` - linux; ppc64le
...
### `php:8.0.13-cli-bullseye` - linux; s390x
