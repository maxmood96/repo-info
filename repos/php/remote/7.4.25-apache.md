...
```console
$ docker pull php@sha256:fd3cadaa78a01bc8a7d3cf97ab2bd74e0d203ac162eef5a953f4819f9bae2277
```
...
### `php:7.4.25-apache` - linux; arm variant v5
...
### `php:7.4.25-apache` - linux; arm variant v7
...
### `php:7.4.25-apache` - linux; arm64 variant v8
...
### `php:7.4.25-apache` - linux; mips64le
...
### `php:7.4.25-apache` - linux; ppc64le
