...
```console
$ docker pull php@sha256:eb8b648de86e61f066642c6650b78d5f6dfddb63f113ff61abacbbc6aa22c98c
```
...
### `php:8.0.20-apache` - linux; arm variant v7
...
### `php:8.0.20-apache` - linux; arm64 variant v8
...
### `php:8.0.20-apache` - linux; mips64le
...
### `php:8.0.20-apache` - linux; ppc64le
