...
```console
$ docker pull php@sha256:00d4db54279c42ffb97fff24c114cf562ae336d09843aa7207cf1264fa632f24
```
...
### `php:8.2.7-zts` - linux; arm variant v5
...
### `php:8.2.7-zts` - linux; arm variant v7
...
### `php:8.2.7-zts` - linux; arm64 variant v8
