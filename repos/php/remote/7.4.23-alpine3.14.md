...
```console
$ docker pull php@sha256:2054d6a957b21d2668462570144ad33eaebeecd7fd9c30ef9f35280413983914
```
...
### `php:7.4.23-alpine3.14` - linux; amd64
...
### `php:7.4.23-alpine3.14` - linux; 386
