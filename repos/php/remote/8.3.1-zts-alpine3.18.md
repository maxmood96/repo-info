...
```console
$ docker pull php@sha256:4ac4200b0624b06a65addcfaabbbf6718fc90ad0d5b330b5f45165eb583508b2
```
...
### `php:8.3.1-zts-alpine3.18` - linux; amd64
...
### `php:8.3.1-zts-alpine3.18` - linux; arm variant v7
...
### `php:8.3.1-zts-alpine3.18` - linux; arm64 variant v8
...
### `php:8.3.1-zts-alpine3.18` - linux; 386
...
### `php:8.3.1-zts-alpine3.18` - linux; ppc64le
