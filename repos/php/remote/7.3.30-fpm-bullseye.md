...
### `php:7.3.30-fpm-bullseye` - linux; amd64
...
### `php:7.3.30-fpm-bullseye` - linux; arm variant v7
...
### `php:7.3.30-fpm-bullseye` - linux; arm64 variant v8
...
### `php:7.3.30-fpm-bullseye` - linux; 386
...
### `php:7.3.30-fpm-bullseye` - linux; mips64le
...
### `php:7.3.30-fpm-bullseye` - linux; s390x
