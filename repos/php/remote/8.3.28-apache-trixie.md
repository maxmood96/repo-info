...
### `php:8.3.28-apache-trixie` - linux; arm variant v7
...
### `php:8.3.28-apache-trixie` - linux; ppc64le
...
### `php:8.3.28-apache-trixie` - linux; riscv64
...
### `php:8.3.28-apache-trixie` - linux; s390x
