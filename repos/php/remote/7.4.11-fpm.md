...
```console
$ docker pull php@sha256:0927e3b75e35c885b835a10f539c86f53d25b50fb68ba4c373f8e6b561068600
```
...
### `php:7.4.11-fpm` - linux; arm variant v5
...
### `php:7.4.11-fpm` - linux; arm variant v7
...
### `php:7.4.11-fpm` - linux; arm64 variant v8
