...
```console
$ docker pull php@sha256:b995834a4f9defca5ad341fa3b04ea1f3519a1c795ffbe397e039dd131fb683d
```
...
```console
$ docker pull php@sha256:2956c235c9f152ca1de69bdf37fa499aefcd113c4cc105b38c37ce3cd9e7d693
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.2 MB (178221262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ecebee892882b976f2c1f697a222f4ecc1dac586caf22638a00a58aeb920078`
...
```console
$ docker pull php@sha256:acc245826f122cc9d5b2f05a1783d2e6ecb4fbb2739e4e97b661cc8f26283135
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.9 MB (151897076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63ae9bcf42fbfb8830c370e2603dbc732304a33ec210f762aa6f53c9d077d878`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:8add3a476099a989f6c9460ac93fa7aae6a231b17aeb3bc36c3c5dcd704a75b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142762317 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ee0f97cee18e04e4fd14bde098ae5dfefd3255a45d947906348a8a41d6fd8b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:826c64e23baa10b8f891daa763934230d891e9be81b502f91e3c3dd258e0c486
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172018749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f411dcc0bcc85b3a17ad09f47cfd96b62dd810319fce8d7173688d0feb83169`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:1fce8d240c4655ca98ef65d8e7bec181b9b46adfbfe5f658d28599a431ff50af
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.1 MB (177146381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82ccb3d103754fddff321a2c876380c7f72d7eb16d4d0ef28f1048ec1f5a8268`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:e7b8a3d124321273dc00614f49b2be1e0dd0f8dc6be7a9cfd98be2d0eeeeaa9d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.1 MB (153143933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:849d046032670a59f0ed5f51611659e1a0e6ac29fe82060ed6277d465e715a57`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV GPG_KEYS=1198C0117593497A5EC5C199286AF1F9897469DC C28D937575603EB4ABB725861C0779DC5C0A9DE4 AFD8691FDAEDF03BDF6E460563F15A9B715376CA
# Fri, 16 Feb 2024 20:30:08 GMT
ENV PHP_VERSION=8.3.3
# Fri, 16 Feb 2024 20:30:11 GMT
ENV PHP_URL=https://www.php.net/distributions/php-8.3.3.tar.xz PHP_ASC_URL=https://www.php.net/distributions/php-8.3.3.tar.xz.asc
# Fri, 16 Feb 2024 20:30:15 GMT
ENV PHP_SHA256=b0a996276fe21fe9ca8f993314c8bc02750f464c7b0343f056fb0894a8dfa9d1
# Fri, 16 Feb 2024 20:31:05 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Fri, 16 Feb 2024 20:31:08 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Fri, 16 Feb 2024 20:46:41 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Fri, 16 Feb 2024 20:46:45 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Fri, 16 Feb 2024 20:46:52 GMT
RUN docker-php-ext-enable sodium
# Fri, 16 Feb 2024 20:46:56 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 16 Feb 2024 20:46:59 GMT
STOPSIGNAL SIGWINCH
# Fri, 16 Feb 2024 20:47:03 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Fri, 16 Feb 2024 20:47:06 GMT
WORKDIR /var/www/html
# Fri, 16 Feb 2024 20:47:10 GMT
EXPOSE 80
# Fri, 16 Feb 2024 20:47:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:89512f4c62da1973731a52f8a2a3bb04472e18b986b3ac253c808b4cb2f69f4a`  
		...
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7093324b2e7ea60e6473611adb53d7331ba4ec9d3c3e1551d55bc80ab62aaae7`  
		Last Modified: Sat, 17 Feb 2024 00:25:34 GMT  
		Size: 12.6 MB (12590199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bf8a9c2b9e2e0368943683ea39c14e8166ca28c27b0717066d8691f4fa4ed93`  
		Last Modified: Sat, 17 Feb 2024 00:25:28 GMT  
		Size: 493.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f3ca07677d6d59e0e7d2a76ece9761e03c727e75113004c88b34dc0ed5944fe`  
		Last Modified: Sat, 17 Feb 2024 00:25:37 GMT  
		Size: 10.7 MB (10707908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf7fe588f536aa95443397695bab2bba575fae7a8ccd5dd90c3aeeb7d036cae0`  
		Last Modified: Sat, 17 Feb 2024 00:25:28 GMT  
		Size: 2.5 KB (2459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c225a06534d03d26d7e9b57309a48f941dcea6401b391db4af882e7b260a317d`  
		Last Modified: Sat, 17 Feb 2024 00:25:28 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b40b1b4a536b18869924dadd85cec6d73752a30b16b5ae02560212e0b2bf9d6`  
		Last Modified: Sat, 17 Feb 2024 00:25:28 GMT  
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull php@sha256:a7099f0c3127096774ecd9a366c5a618cdd78de07c768d6301f40381dfbf27b5
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.8 MB (182776910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53aeaf01f0eed7581d077475d39abe9437e779c200f8ba0667318d7994204301`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:e113f31fd1cd4da214b7fc9ed5b4f1de510bca55eb92867265d576e6261f987c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.8 MB (151845968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d5a189449cf00ca513014afc54102771dca65de50f18832ed8478e40628c98f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
