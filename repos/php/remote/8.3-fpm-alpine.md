...
```console
$ docker pull php@sha256:35864ef41ce1d1e316ac2b9ebf7ea2e3ce988965285fe3b5f14b987a162752f8
```
...
```console
$ docker pull php@sha256:ce9e78ca8003a1042043d97bc766c77289f2950e2acf86805a85948d66b4ba82
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32510334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd6c4c312ac3b72dd7db501e97d2935efcf525685d4a13d9c6a3c904cd3cc5b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
