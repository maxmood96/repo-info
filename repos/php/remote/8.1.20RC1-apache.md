...
### `php:8.1.20RC1-apache` - linux; amd64
...
### `php:8.1.20RC1-apache` - linux; arm variant v7
...
### `php:8.1.20RC1-apache` - linux; arm64 variant v8
...
### `php:8.1.20RC1-apache` - linux; 386
...
### `php:8.1.20RC1-apache` - linux; mips64le
...
### `php:8.1.20RC1-apache` - linux; ppc64le
