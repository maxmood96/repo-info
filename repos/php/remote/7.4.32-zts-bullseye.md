...
```console
$ docker pull php@sha256:01d996a886241eecb222d438645e94a01823406c7a1ee630aa4983576853537d
```
...
### `php:7.4.32-zts-bullseye` - linux; amd64
...
### `php:7.4.32-zts-bullseye` - linux; arm variant v5
...
### `php:7.4.32-zts-bullseye` - linux; arm64 variant v8
...
### `php:7.4.32-zts-bullseye` - linux; 386
...
### `php:7.4.32-zts-bullseye` - linux; mips64le
...
### `php:7.4.32-zts-bullseye` - linux; ppc64le
...
### `php:7.4.32-zts-bullseye` - linux; s390x
