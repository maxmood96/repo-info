...
```console
$ docker pull php@sha256:de0cd7867c9b992f66237b786d938c3db895cfce09ebd8bbbadae5f0fdf9405b
```
...
```console
$ docker pull php@sha256:acd7e584b67d18777188b8efd5fc8e463e2c69e73b2aab7082337170174e36f4
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.4 MB (133383130 bytes)**  
