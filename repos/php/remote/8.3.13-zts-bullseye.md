...
```console
$ docker pull php@sha256:5ff71e08406ba5d27a31e9b19a75c1688d4604f0963d747317a551bda9014c7b
```
...
### `php:8.3.13-zts-bullseye` - linux; amd64
...
### `php:8.3.13-zts-bullseye` - linux; arm variant v7
...
### `php:8.3.13-zts-bullseye` - linux; arm64 variant v8
