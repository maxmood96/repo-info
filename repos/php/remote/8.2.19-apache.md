...
```console
$ docker pull php@sha256:b66ca17e7b4fe819cc1ea65a87dfe6c2590dbcd667383be3110455a6a4c51c56
```
...
### `php:8.2.19-apache` - linux; arm variant v5
...
### `php:8.2.19-apache` - linux; arm variant v7
...
### `php:8.2.19-apache` - linux; arm64 variant v8
...
### `php:8.2.19-apache` - linux; 386

```console
$ docker pull php@sha256:a402e892535f92789765c10b66d454085a65bc7f603218b20f2f1d96cddefdad
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176602451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91e414da9060d99ecc0abe6ec5edc4c4447962841ba983b7ff55ab6163cf3c9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:8.2.19-apache` - linux; mips64le

```console
$ docker pull php@sha256:3be52a52a31d1ebee4bef27b8e0af294b324ab3acbebba576a875c72b710aa0d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.4 MB (152395726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b554d650ce635ec8e08653054ddebc3b8e4c1530f250d44c52429f3e1806be20`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:8.2.19-apache` - linux; ppc64le
