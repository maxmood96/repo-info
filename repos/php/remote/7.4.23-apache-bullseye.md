...
### `php:7.4.23-apache-bullseye` - linux; amd64
...
### `php:7.4.23-apache-bullseye` - linux; arm variant v7
...
### `php:7.4.23-apache-bullseye` - linux; arm64 variant v8
...
### `php:7.4.23-apache-bullseye` - linux; 386
...
### `php:7.4.23-apache-bullseye` - linux; mips64le
