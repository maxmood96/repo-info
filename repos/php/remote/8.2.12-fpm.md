...
```console
$ docker pull php@sha256:f72c8b1f0ecd629bc89d0c2e99f4423b43c0ecf2f89e528c3029138f9df71e5d
```
...
```console
$ docker pull php@sha256:b069b123758ded7e51e9641df20669e2a8b7a41955a92f92632232bd48f0dfe3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.4 MB (147445845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d2b4c653d1cd463257431bb6db6427574267a58ceab28424dc7dcd99ad8ccba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
