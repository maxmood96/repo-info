...
### `php:8.2.23-apache` - linux; arm variant v7
...
### `php:8.2.23-apache` - linux; arm64 variant v8
...
### `php:8.2.23-apache` - linux; mips64le
...
### `php:8.2.23-apache` - linux; ppc64le
