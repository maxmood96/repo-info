...
```console
$ docker pull php@sha256:0a02df246cc3aae241c8832b67e88c24bc139e83eb15c9e8effd68b69ecd15d7
```
...
### `php:8.1.23-alpine3.16` - linux; arm variant v6
...
### `php:8.1.23-alpine3.16` - linux; arm variant v7
...
### `php:8.1.23-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.23-alpine3.16` - linux; 386
...
### `php:8.1.23-alpine3.16` - linux; s390x
