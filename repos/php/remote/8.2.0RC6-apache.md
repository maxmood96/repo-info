...
```console
$ docker pull php@sha256:ed05357a2f1b66916f6390ff00a40274d728dce853c3f7b021011d78517b1b6e
```
...
### `php:8.2.0RC6-apache` - linux; arm variant v7
...
### `php:8.2.0RC6-apache` - linux; arm64 variant v8
