...
```console
$ docker pull php@sha256:19a9eb316c6a0aba6509cd1018682922156a51e3535b698aae1c7679d35cd5fe
```
...
### `php:8.0.24RC1-apache` - linux; amd64
...
### `php:8.0.24RC1-apache` - linux; arm variant v5
...
### `php:8.0.24RC1-apache` - linux; arm64 variant v8
...
### `php:8.0.24RC1-apache` - linux; 386
...
### `php:8.0.24RC1-apache` - linux; mips64le
...
### `php:8.0.24RC1-apache` - linux; ppc64le
...
### `php:8.0.24RC1-apache` - linux; s390x
