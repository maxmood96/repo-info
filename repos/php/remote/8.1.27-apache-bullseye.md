...
```console
$ docker pull php@sha256:18bbd44476c1ed9b7deb4f677dec139b9f30eb88ea3b67b2093c4dc9d26633c8
```
...
```console
$ docker pull php@sha256:a562fe90a5040f5da1fcff930c9bd94030848af859204243a73a58e3db1d03ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.9 MB (142909677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3ac1397953da203dfeb7928551e3b537deccdb6a14de35def617a491c59b8fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
