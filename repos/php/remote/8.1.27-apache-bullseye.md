...
```console
$ docker pull php@sha256:536d6d9f12b07692cb04b0db8cb83374bdd9709fe775dd5e3e1f1c6b0d6851bc
```
...
```console
$ docker pull php@sha256:9ad26dfb2207e924bb7fd0e2d54acc1da5f2eaaa38bde17e3745f780412a7542
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.9 MB (142888261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac6e4d8e1c1d99041ae3f8adecbdcb238e62152acc9fc39429cf2a1d2ce52883`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
