...
```console
$ docker pull php@sha256:2f6ea5e8d0e394223fa8589bd2bb2acf7543764a7288503080a12b84e342fbf8
```
...
### `php:8.5.3-zts-alpine` - linux; amd64
...
### `php:8.5.3-zts-alpine` - unknown; unknown
...
### `php:8.5.3-zts-alpine` - linux; arm variant v6
...
### `php:8.5.3-zts-alpine` - linux; arm variant v7
...
### `php:8.5.3-zts-alpine` - linux; arm64 variant v8
...
### `php:8.5.3-zts-alpine` - linux; 386
...
### `php:8.5.3-zts-alpine` - linux; ppc64le
...
### `php:8.5.3-zts-alpine` - linux; s390x
