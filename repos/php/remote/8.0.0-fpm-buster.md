...
```console
$ docker pull php@sha256:224e7b574d27e74baf3229170e285d4ce40b1adfc9789ac1b8b94fbf127b1545
```
...
### `php:8.0.0-fpm-buster` - linux; arm variant v5
...
### `php:8.0.0-fpm-buster` - linux; arm variant v7
...
### `php:8.0.0-fpm-buster` - linux; arm64 variant v8
...
### `php:8.0.0-fpm-buster` - linux; mips64le
...
### `php:8.0.0-fpm-buster` - linux; ppc64le
...
### `php:8.0.0-fpm-buster` - linux; s390x
