...
```console
$ docker pull php@sha256:00d436ff7f55e0f8395e7af179e48394b4b1cbeb2538e8753ee0b1307f8e5a3b
```
...
```console
$ docker pull php@sha256:ff79f673699149db8861a8df27a97df66dd035dd999f817615bc663d7a902fe4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32228676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15cd33b2e96cc36ebd1345b8da10fdb28a33e478a8af8cec2c56239bb0872241`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
