...
```console
$ docker pull php@sha256:e4e9730af9f31f49e489a9d095dd1859eb7272ac7146ec20ffc88abebc620089
```
...
```console
$ docker pull php@sha256:70b74abdc8ac38dafda57ff2c1e1a37c8e92ea9a8fefb684a3282eb9bc0e4de4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.7 MB (32661295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d2f5b34cc522914a88747f8c693c78ded1fc27698081d938e8b253eefadd445`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
