...
```console
$ docker pull php@sha256:571d4afed16c522e7a7f2c91c6b5e01cfc6e90d6bc2addfc648199a5dcc13a6a
```
...
### `php:8.4.21-fpm-alpine3.23` - linux; amd64
...
### `php:8.4.21-fpm-alpine3.23` - unknown; unknown
...
### `php:8.4.21-fpm-alpine3.23` - linux; arm variant v6
...
### `php:8.4.21-fpm-alpine3.23` - linux; arm variant v7
...
### `php:8.4.21-fpm-alpine3.23` - linux; arm64 variant v8
...
### `php:8.4.21-fpm-alpine3.23` - linux; 386
...
### `php:8.4.21-fpm-alpine3.23` - linux; ppc64le
...
### `php:8.4.21-fpm-alpine3.23` - linux; s390x
