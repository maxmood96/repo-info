...
```console
$ docker pull php@sha256:bd6992addb7c75784b91ef8c41c52c2dda75046f8066d339b1b9e5b83aaedad5
```
...
### `php:8.4-zts-alpine3.20` - linux; amd64
...
### `php:8.4-zts-alpine3.20` - unknown; unknown
...
### `php:8.4-zts-alpine3.20` - linux; arm variant v6
...
### `php:8.4-zts-alpine3.20` - linux; arm variant v7
...
### `php:8.4-zts-alpine3.20` - linux; arm64 variant v8
...
### `php:8.4-zts-alpine3.20` - linux; 386
...
### `php:8.4-zts-alpine3.20` - linux; ppc64le
...
### `php:8.4-zts-alpine3.20` - linux; riscv64
...
### `php:8.4-zts-alpine3.20` - linux; s390x
