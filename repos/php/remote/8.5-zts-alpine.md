...
```console
$ docker pull php@sha256:07395fe2f34069f305f09b16af91f40c523bf2e7866937fa41b37090c918814b
```
...
### `php:8.5-zts-alpine` - linux; amd64
...
### `php:8.5-zts-alpine` - unknown; unknown
...
### `php:8.5-zts-alpine` - linux; arm variant v6
...
### `php:8.5-zts-alpine` - linux; arm variant v7
...
### `php:8.5-zts-alpine` - linux; arm64 variant v8
...
### `php:8.5-zts-alpine` - linux; ppc64le
...
### `php:8.5-zts-alpine` - linux; riscv64
...
### `php:8.5-zts-alpine` - linux; s390x
