...
```console
$ docker pull php@sha256:4bd5a5c692f462bbd146b2d8eab0f02bab941b83eb1d3ed0538d9ce379513304
```
...
### `php:8.2.16-zts-alpine3.18` - linux; amd64
...
### `php:8.2.16-zts-alpine3.18` - linux; 386
...
### `php:8.2.16-zts-alpine3.18` - linux; s390x
