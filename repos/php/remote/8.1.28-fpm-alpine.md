...
```console
$ docker pull php@sha256:2716072cf859935767e625927b0e951aae014523f11a3daad679a63c4f9120dc
```
...
### `php:8.1.28-fpm-alpine` - linux; amd64
...
### `php:8.1.28-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.28-fpm-alpine` - linux; arm variant v7
...
### `php:8.1.28-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.28-fpm-alpine` - linux; 386
...
### `php:8.1.28-fpm-alpine` - linux; ppc64le
...
### `php:8.1.28-fpm-alpine` - linux; s390x
