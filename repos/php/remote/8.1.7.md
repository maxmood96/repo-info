...
```console
$ docker pull php@sha256:5b21e503b3d8f2887318ca553fdbfd9e6bf7b49dc4ee76db4b964ca917339d1e
```
...
### `php:8.1.7` - linux; arm variant v5
...
### `php:8.1.7` - linux; arm variant v7
...
### `php:8.1.7` - linux; arm64 variant v8
