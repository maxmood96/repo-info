...
```console
$ docker pull php@sha256:7590e92090cb2f93f9c4bae66be8b46a16207d7e457520a891af055c2356db38
```
...
```console
$ docker pull php@sha256:4f8c4e7aeeb8649e2feb31b03327b48d77754a1b99ffa35c6a4d3a465cf610a0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.6 MB (125559170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79f4cf82988282fd1291b46ad2ba684515f38cc90ec2a4b5f80d4277fa5e0512`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
```console
$ docker pull php@sha256:27bd827e68103b07e99484e502f1554d2680396ea524b012e8758565487a68e6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.0 MB (133001469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3131224d70b7ebba4fcb3e4ce6de506a5f86f9343fdb82829af8d76d2e566de2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
