...
```console
$ docker pull php@sha256:74b376fac1f779e9536595660985315201c2db37376c5fe2e209ae787ea3f1a8
```
...
### `php:8.3.11-zts-alpine` - linux; amd64
...
### `php:8.3.11-zts-alpine` - linux; arm variant v6
...
### `php:8.3.11-zts-alpine` - linux; arm variant v7
...
### `php:8.3.11-zts-alpine` - linux; arm64 variant v8
...
### `php:8.3.11-zts-alpine` - linux; 386
...
### `php:8.3.11-zts-alpine` - linux; ppc64le
...
### `php:8.3.11-zts-alpine` - linux; s390x
