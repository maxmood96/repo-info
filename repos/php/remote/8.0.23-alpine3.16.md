## `php:8.0.23-alpine3.16`

```console
$ docker pull php@sha256:b72a36736841ef114df11bf80d4b59556ec7ad3088c8bd5b76416b501391811c
```
...
### `php:8.0.23-alpine3.16` - linux; amd64
...
### `php:8.0.23-alpine3.16` - linux; 386

```console
$ docker pull php@sha256:e32b1e2c93ffd8717a5efafdce66cdb2b8658241a18011ed9bd726e830a4d012
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (31956032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4446da207a7ea1431fe928bef2405ed6bff88bf66d5c5a627adb7588911b9d57`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:8.0.23-alpine3.16` - linux; ppc64le
...
### `php:8.0.23-alpine3.16` - linux; s390x

```console
$ docker pull php@sha256:c88fbbd4215adc75f463da661d493f5ed0526b4f4f903f5ba112e20a46632757
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30341523 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e4b9087d6a9598852390103a7927b78e58f14b23fea9f0d23bd8ecda0921a1c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
