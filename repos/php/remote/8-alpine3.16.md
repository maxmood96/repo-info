...
```console
$ docker pull php@sha256:f6bf13787c96a2e87d5af2475f0a6efc83e77190d9f66ded4d0f3c3366f7d093
```
...
```console
$ docker pull php@sha256:629d4d6fc8ea32af24aa71a28d51676ed6ca09e33a89bc67701adf9d386d7ea9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.9 MB (29944466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29f6fcff1c0ca130c67f92bf7dcfa583ce0e1b8112951d8a7784ebc9123ce5a7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
