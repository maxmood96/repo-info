...
```console
$ docker pull php@sha256:f0989269fde2cf77be4a51f0f7f469baa28305a865ecbd1b6489a51724859453
```
...
### `php:8.4.10-alpine3.21` - linux; amd64
...
### `php:8.4.10-alpine3.21` - unknown; unknown
...
### `php:8.4.10-alpine3.21` - linux; arm variant v6
...
### `php:8.4.10-alpine3.21` - linux; arm variant v7
...
### `php:8.4.10-alpine3.21` - linux; arm64 variant v8
...
### `php:8.4.10-alpine3.21` - linux; 386
...
### `php:8.4.10-alpine3.21` - linux; ppc64le
...
### `php:8.4.10-alpine3.21` - linux; s390x
