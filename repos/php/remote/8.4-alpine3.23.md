...
```console
$ docker pull php@sha256:2034638fbaf586f8772b5b228615195618f8c1ac22b78697774ded4de55ce17d
```
...
```console
$ docker pull php@sha256:1067a7364666f0a1a8fce4b11e096bf0f450266c5b7eef797f93fb5f288165b3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.4 MB (40439854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:930033014b4f4284f142d3b0f86959715e47476fd7684beae616658143a4db47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
# Thu, 18 Dec 2025 16:27:43 GMT
COPY docker-php-source /usr/local/bin/ # buildkit
# Thu, 18 Dec 2025 17:25:55 GMT
RUN set -eux; 	apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		argon2-dev 		coreutils 		curl-dev 		gnu-libiconv-dev 		libsodium-dev 		libxml2-dev 		linux-headers 		oniguruma-dev 		openssl-dev 		readline-dev 		sqlite-dev 	; 		rm -vf /usr/include/iconv.h; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv=/usr 		--with-openssl 		--with-readline 		--with-zlib 				--enable-phpdbg 		--enable-phpdbg-readline 				--with-pear 			; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-cache $runDeps; 		apk del --no-network .build-deps; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version # buildkit
# Thu, 18 Dec 2025 17:25:55 GMT
COPY docker-php-ext-* docker-php-entrypoint /usr/local/bin/ # buildkit
# Thu, 18 Dec 2025 17:26:00 GMT
RUN docker-php-ext-enable opcache # buildkit
# Thu, 18 Dec 2025 17:26:05 GMT
RUN docker-php-ext-enable sodium # buildkit
# Thu, 18 Dec 2025 17:26:05 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Thu, 18 Dec 2025 17:26:05 GMT
...
-	Layers:
	...
	-	`sha256:a7cae23b57c5f5e5d61b59604e60f51a20a0e219e30bf87f7438e8f2837ddacb`  
		...
		Size: 493.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2ed5cd978b182755b8aace806256573bddcd36cdb4b241e49c9e4a7f10e1a2e0`  
		Last Modified: Thu, 18 Dec 2025 17:27:20 GMT  
		Size: 19.4 MB (19388574 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ef5d88e6ff0b70fe455af5371b700daadbbb6ca273533dc7a7ab16ffe6d221d3`  
		Last Modified: Thu, 18 Dec 2025 17:27:18 GMT  
		Size: 2.5 KB (2452 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:65f9a8582ac9084035bc861f508ad217046546ccd344618eac4ce070a06d346b`  
		Last Modified: Thu, 18 Dec 2025 17:27:18 GMT  
		Size: 23.3 KB (23322 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9ea5adf49261ae4983d8902e9f56887ce12f92578fa74f2a038c4a51708bb45f`  
		Last Modified: Thu, 18 Dec 2025 17:27:18 GMT  
...
```console
$ docker pull php@sha256:ce753ee1a416017375a93f23aa31bfa1740867508d5cd378308fe64cf16cfdc6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.3 KB (319321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:528bf4283ae37d1e8f22639f6d16aae418f2867950ba6cabed2718200b5292aa`

```dockerfile
```

-	Layers:
	-	`sha256:ff9147eb0886f30329b9fb3927f02bb23afdbd3eacda368a686452b188e1a76a`  
		Last Modified: Thu, 18 Dec 2025 21:00:25 GMT  
		Size: 278.6 KB (278588 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:af57b5154ed6c33fb723473760928c8cb32fb6e026eed4ea5a35e7cfc105fc1a`  
		Last Modified: Thu, 18 Dec 2025 21:00:26 GMT  
