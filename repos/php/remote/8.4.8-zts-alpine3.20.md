...
```console
$ docker pull php@sha256:d7737695dadf7fcdf9a22c108e869c22d17e3b4d393bdadeecbeb56f7c2f9c3c
```
...
### `php:8.4.8-zts-alpine3.20` - linux; amd64
...
### `php:8.4.8-zts-alpine3.20` - unknown; unknown
...
### `php:8.4.8-zts-alpine3.20` - linux; arm variant v6
...
### `php:8.4.8-zts-alpine3.20` - linux; arm variant v7
...
### `php:8.4.8-zts-alpine3.20` - linux; arm64 variant v8
...
### `php:8.4.8-zts-alpine3.20` - linux; 386
...
### `php:8.4.8-zts-alpine3.20` - linux; ppc64le
...
### `php:8.4.8-zts-alpine3.20` - linux; s390x
