...
```console
$ docker pull php@sha256:9a1027acb1135635a9034ed5ae9b71655898584b461d47a1bfe33a1b6cce5a06
```
...
### `php:8.1.8-fpm-alpine3.16` - linux; amd64
...
### `php:8.1.8-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.8-fpm-alpine3.16` - linux; 386
