...
```console
$ docker pull php@sha256:9846e1f7287b408b6c42dd7189d26417e94cd494ed02bf57d62c5b48f97fbc05
```
...
### `php:8.2.12RC1-apache-bullseye` - linux; amd64
...
### `php:8.2.12RC1-apache-bullseye` - linux; arm variant v7
...
### `php:8.2.12RC1-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.2.12RC1-apache-bullseye` - linux; 386
...
### `php:8.2.12RC1-apache-bullseye` - linux; mips64le
...
### `php:8.2.12RC1-apache-bullseye` - linux; ppc64le
...
### `php:8.2.12RC1-apache-bullseye` - linux; s390x
