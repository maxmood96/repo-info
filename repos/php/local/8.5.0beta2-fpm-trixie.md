...
- Environment:
  ...
  - `PHP_VERSION=8.5.0beta2`
  - `PHP_URL=https://downloads.php.net/~daniels/php-8.5.0beta2.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~daniels/php-8.5.0beta2.tar.xz.asc`
  - `PHP_SHA256=02d0e9cbe8a1a022c2756c73c693f57b9c47b24545b1e82b72c7f7ffc3079193`
