...
- Created: `2024-11-08T01:31:53Z`
- Virtual Size: ~ 118.96 Mb  
...
- Environment:
  ...
  - `PHP_URL=https://downloads.php.net/~calvinb/php-8.4.0RC4.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~calvinb/php-8.4.0RC4.tar.xz.asc`
  - `PHP_SHA256=b3f8a19d845f4aa565015ff86196407eb533284eb4365ac5953f5e74ae61dcb0`
...
```console
curl-8.11.0-r1 description:
URL retrival utility and library

curl-8.11.0-r1 webpage:
https://curl.se/

curl-8.11.0-r1 installed size:
256 KiB

curl-8.11.0-r1 license:
curl
