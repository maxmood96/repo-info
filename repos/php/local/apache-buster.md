...
- Created: `2023-05-23T09:56:54.88946846Z`
- Virtual Size: ~ 404.64 Mb  
...
### `dpkg` source package: `apache2=2.4.38-3+deb10u10`

Binary Packages:

- `apache2=2.4.38-3+deb10u10`
- `apache2-bin=2.4.38-3+deb10u10`
- `apache2-data=2.4.38-3+deb10u10`
- `apache2-utils=2.4.38-3+deb10u10`
...
```console
$ apt-get source -qq --print-uris apache2=2.4.38-3+deb10u10
'http://deb.debian.org/debian-security/pool/updates/main/a/apache2/apache2_2.4.38-3%2bdeb10u10.dsc' apache2_2.4.38-3+deb10u10.dsc 3363 SHA256:c6ae667395293ef81a94bf83a4cdb08781af467959740e40aa266cf609f111ad
...
'http://deb.debian.org/debian-security/pool/updates/main/a/apache2/apache2_2.4.38-3%2bdeb10u10.debian.tar.xz' apache2_2.4.38-3+deb10u10.debian.tar.xz 1104408 SHA256:3ee2646e17bcb20b7dd7932b13b839dcc2a7c4e14472c502004d8acbf95f7798
```

Other potentially useful URLs:

- https://sources.debian.net/src/apache2/2.4.38-3+deb10u10/ (for browsing the source)
- https://sources.debian.net/src/apache2/2.4.38-3+deb10u10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/apache2/2.4.38-3+deb10u10/ (for access to the source package after it no longer exists in the archive)
...
- `libaprutil1-dbd-sqlite3:amd64=1.6.1-4+deb10u1`
- `libaprutil1-ldap:amd64=1.6.1-4+deb10u1`
