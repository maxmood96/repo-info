...
- Environment:
  ...
  - `PHP_VERSION=8.4.14RC1`
  - `PHP_URL=https://downloads.php.net/~saki/php-8.4.14RC1.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~saki/php-8.4.14RC1.tar.xz.asc`
  - `PHP_SHA256=afa5d25db94f1f34baeddcb8682dfea212f56e3a142651c27a11ca96c1fe5484`
