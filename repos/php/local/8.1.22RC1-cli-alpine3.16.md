...
- Created: `2023-07-24T23:59:24.43732043Z`
...
```console
libcrypto1.1-1.1.1u-r2 description:
Crypto library from openssl

libcrypto1.1-1.1.1u-r2 webpage:
https://www.openssl.org/

libcrypto1.1-1.1.1u-r2 installed size:
2708 KiB

libcrypto1.1-1.1.1u-r2 license:
OpenSSL
...
```console
libssl1.1-1.1.1u-r2 description:
SSL shared libraries

libssl1.1-1.1.1u-r2 webpage:
https://www.openssl.org/

libssl1.1-1.1.1u-r2 installed size:
528 KiB

libssl1.1-1.1.1u-r2 license:
OpenSSL
...
```console
openssl-1.1.1u-r2 description:
toolkit for transport layer security (TLS) - version 1.1

openssl-1.1.1u-r2 webpage:
https://www.openssl.org/

openssl-1.1.1u-r2 installed size:
660 KiB

openssl-1.1.1u-r2 license:
OpenSSL
