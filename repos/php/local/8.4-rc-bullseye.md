...
- Environment:
  ...
  - `PHP_VERSION=8.4.8RC1`
  - `PHP_URL=https://downloads.php.net/~calvinb/php-8.4.8RC1.tar.xz`
  - `PHP_ASC_URL=https://downloads.php.net/~calvinb/php-8.4.8RC1.tar.xz.asc`
  - `PHP_SHA256=c8a8b11d8239c6d748197badacb81881973e79401a652756083c18ab04343602`
