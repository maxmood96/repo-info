...
### `jetty:12.1.7-jdk25-amazoncorretto` - linux; amd64
...
### `jetty:12.1.7-jdk25-amazoncorretto` - unknown; unknown
...
### `jetty:12.1.7-jdk25-amazoncorretto` - linux; arm64 variant v8
