...
```console
$ docker pull jetty@sha256:29487f7f6add41e3d5971241ce80961af37021a17e8eb58a77219494f247aace
```
...
```console
$ docker pull jetty@sha256:17cacc8cde549239aed4fd682e7176a8d0e7a7e1a217351c833ada2cf887464b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.0 MB (209001023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bd01f8970d2a56e4aa22d95e028c127f20e36af28f383188f8acec278a20e0c`
...
# Mon, 30 Oct 2023 23:27:21 GMT
CMD ["jshell"]
# Tue, 31 Oct 2023 01:42:56 GMT
ENV JETTY_VERSION=11.0.17
# Tue, 31 Oct 2023 01:42:57 GMT
...
-	Layers:
	...
	-	`sha256:3d8fee9502d1f30de11b84ef3b10d6754c83fea9aeb59bc8e694fdaefdf819e7`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8da531d88386f8eb5e5bf912f716ba0187b748408fe58d9feaa19fc134961ac4`  
		Last Modified: Tue, 31 Oct 2023 01:55:01 GMT  
		Size: 14.9 MB (14876188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e9d756de6b898611edd423f3135d792792d1c0113d695c0e2c21471b9368e45`  
		Last Modified: Tue, 31 Oct 2023 01:55:00 GMT  
...
```console
$ docker pull jetty@sha256:329c5669729b26462472d6aed58d96c087f35b1613c5d74d54d0269a31abae7c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.1 MB (207148735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08be7f97d1ab7403c539eb6fdc8030b26a4219879f5ebf67d99462ae031ffd93`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
# Mon, 30 Oct 2023 23:43:46 GMT
CMD ["jshell"]
# Tue, 31 Oct 2023 01:56:36 GMT
ENV JETTY_VERSION=11.0.17
# Tue, 31 Oct 2023 01:56:36 GMT
ENV JETTY_HOME=/usr/local/jetty
# Tue, 31 Oct 2023 01:56:37 GMT
ENV JETTY_BASE=/var/lib/jetty
# Tue, 31 Oct 2023 01:56:37 GMT
ENV TMPDIR=/tmp/jetty
# Tue, 31 Oct 2023 01:56:37 GMT
...
# Tue, 31 Oct 2023 01:56:37 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	F254B35617DC255D9344BCFA873A8E86B4372146 	E22488CC94F63E3FC928536C4241C08270D999C3
# Tue, 31 Oct 2023 01:56:53 GMT
RUN set -xe ; 	export savedAptMark="$(apt-mark showmanual)" ; 	mkdir -p $TMPDIR ; 	apt-get update ; 	apt-get install -y --no-install-recommends 		ca-certificates 		p11-kit 		gnupg 		curl 		; 	export GNUPGHOME=/jetty-keys ; 	mkdir -p "$GNUPGHOME" ; 	for key in $JETTY_GPG_KEYS; do 		gpg --batch --keyserver "hkps://keyserver.ubuntu.com" --recv-keys "$key"; 	done ; 	mkdir -p "$JETTY_HOME" ; 	cd $JETTY_HOME ; 	curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz ; 	curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc ; 	gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz ; 	tar -xvf jetty.tar.gz --strip-components=1 ; 	sed -i '/jetty-logging/d' etc/jetty.conf ; 	mkdir -p "$JETTY_BASE" ; 	cd $JETTY_BASE ; 	case "$JETTY_VERSION" in 		"12."*) START_MODULES="server,http,ext,resources" ;; 		*) START_MODULES="server,http,deploy,ext,resources,jsp,jstl,websocket" ;; 	esac ; 	java -jar "$JETTY_HOME/start.jar" --create-startd 		--add-to-start="$START_MODULES" ; 	groupadd -r jetty && useradd -r -g jetty jetty ; 	chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" ; 	usermod -d $JETTY_BASE jetty ; 	apt-mark auto '.*' > /dev/null ; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null ; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false ; 	rm -rf /var/lib/apt/lists/* ; 	rm -rf /tmp/hsperfdata_root ; 	rm -fr $JETTY_HOME/jetty.tar.gz* ; 	rm -fr /jetty-keys $GNUPGHOME ; 	rm -rf /tmp/hsperfdata_root ; 	java -jar "$JETTY_HOME/start.jar" --list-config ;
# Tue, 31 Oct 2023 01:56:53 GMT
WORKDIR /var/lib/jetty
# Tue, 31 Oct 2023 01:56:53 GMT
COPY multi:6bf6ffc2c0ff756d51254f4ec987e84575c16c895c328c42a63bde92f8d5278a in / 
# Tue, 31 Oct 2023 01:56:54 GMT
USER jetty
# Tue, 31 Oct 2023 01:56:54 GMT
EXPOSE 8080
# Tue, 31 Oct 2023 01:56:54 GMT
...
-	Layers:
	...
	-	`sha256:06bd917118368b7a5b4cf5a84521e0fbf7a95755a495330edd4cd040b2065397`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aea5ae447d22c2de7b1ba4865e67da16f167dd9f2e11f9a441f71cbfc090a2ee`  
		Last Modified: Tue, 31 Oct 2023 02:03:53 GMT  
		Size: 14.9 MB (14876597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3542205cbd74aa83d0be3523f32d75259a60d63caea1d8d732666882d0bfaf73`  
		Last Modified: Tue, 31 Oct 2023 02:03:52 GMT  
		Size: 1.6 KB (1633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
