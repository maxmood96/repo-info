...
### `jetty:12.1.6-jdk25-amazoncorretto` - linux; amd64
...
### `jetty:12.1.6-jdk25-amazoncorretto` - unknown; unknown
...
### `jetty:12.1.6-jdk25-amazoncorretto` - linux; arm64 variant v8
