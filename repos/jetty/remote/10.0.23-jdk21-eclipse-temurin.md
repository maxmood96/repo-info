...
### `jetty:10.0.23-jdk21-eclipse-temurin` - linux; amd64
...
### `jetty:10.0.23-jdk21-eclipse-temurin` - unknown; unknown
...
### `jetty:10.0.23-jdk21-eclipse-temurin` - linux; arm64 variant v8
