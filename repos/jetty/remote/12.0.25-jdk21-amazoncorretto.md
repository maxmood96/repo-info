...
```console
$ docker pull jetty@sha256:53a66556a154bafd1c21aba4f79e7f33d785fc306a71661c8186164444a00425
```
...
### `jetty:12.0.25-jdk21-amazoncorretto` - linux; amd64
...
### `jetty:12.0.25-jdk21-amazoncorretto` - unknown; unknown
