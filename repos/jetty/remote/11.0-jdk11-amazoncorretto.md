...
```console
$ docker pull jetty@sha256:358d86ee4c81ebfbc5aabd019cc836dec3c3ae68d11f0c750a9bc72da54a7ad2
```
...
```console
$ docker pull jetty@sha256:b22666c6bf5b9d7e3ff9426f1195d22a06ef6f0b2ae213b1444f491f6421a80a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.1 MB (231102327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23fbc16f8e532b94b1fd9273a3c4073ff0fc5adb78ecf77b6d2f033695592476`
...
-	Layers:
	...
	-	`sha256:14bae2abfeeb4e1770f837d3ef3a42f0a787fa207ee9e48fa96311ca4c28ec2d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aec6efe91ab32697b4a3e972babd28e0c65b9fca941a40ea0b54920c09ab5da`  
		Last Modified: Fri, 28 Jun 2024 01:57:53 GMT  
		Size: 20.3 MB (20348704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89d3537362e8fbc4758e6ccfc1939b454619d289e42208682e947dc4dc01bd9a`  
		Last Modified: Fri, 28 Jun 2024 01:57:52 GMT  
...
```console
$ docker pull jetty@sha256:2c152fe0b29601155816c1789d9c65041f41f4c0a9c373c965d395b478f822e7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.3 MB (230261478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f04a484bba9fe9a7b0cc62c9fe9161ac49691d30bd438409305d6d9f626fcb02`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
# Fri, 28 Jun 2024 01:52:51 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	F254B35617DC255D9344BCFA873A8E86B4372146 	E22488CC94F63E3FC928536C4241C08270D999C3
# Fri, 28 Jun 2024 01:53:06 GMT
RUN set -xe ; 	mkdir -p $TMPDIR ;     yum install -y shadow-utils tar xz gzip which && yum clean all ; 	export GNUPGHOME=/jetty-keys ; 	mkdir -p "$GNUPGHOME" ; 	for key in $JETTY_GPG_KEYS; do 		gpg --batch --keyserver "hkps://keyserver.ubuntu.com" --recv-keys "$key"; 	done ; 	mkdir -p "$JETTY_HOME" ; 	cd $JETTY_HOME ; 	curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz ; 	curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc ; 	gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz ; 	tar -xvf jetty.tar.gz --strip-components=1 ; 	sed -i '/jetty-logging/d' etc/jetty.conf ; 	mkdir -p "$JETTY_BASE" ; 	cd $JETTY_BASE ; 	case "$JETTY_VERSION" in 		"12."*) START_MODULES="server,http,ext,resources" ;; 		*) START_MODULES="server,http,deploy,ext,resources,jsp,jstl,websocket" ;; 	esac ; 	java -jar "$JETTY_HOME/start.jar" --create-startd 		--add-to-start="$START_MODULES" ; 	groupadd -r jetty && useradd -r -g jetty jetty ; 	chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" ; 	usermod -d $JETTY_BASE jetty ; 	rm -rf /tmp/hsperfdata_root ; 	rm -fr $JETTY_HOME/jetty.tar.gz* ; 	rm -fr /jetty-keys $GNUPGHOME ; 	rm -rf /tmp/hsperfdata_root ; 	java -jar "$JETTY_HOME/start.jar" --list-config ;
# Fri, 28 Jun 2024 01:53:07 GMT
WORKDIR /var/lib/jetty
# Fri, 28 Jun 2024 01:53:07 GMT
COPY multi:6bf6ffc2c0ff756d51254f4ec987e84575c16c895c328c42a63bde92f8d5278a in / 
# Fri, 28 Jun 2024 01:53:07 GMT
...
-	Layers:
	...
	-	`sha256:54f05d4584bd775d90dfcdf0d33cbd2aa81836d3c79c27528081d4023dcef9e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70e5a2f2aab7d39bd2813ec748b08a815b93591dfcca8d176ae0bc4f335a0328`  
		Last Modified: Fri, 28 Jun 2024 01:57:58 GMT  
		Size: 20.5 MB (20465857 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93480084ea47d6d1a24dc61d22309c2ed5dfd478b7d7774b7185920fa6125f53`  
		Last Modified: Fri, 28 Jun 2024 01:57:57 GMT  
		Size: 1.6 KB (1634 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
