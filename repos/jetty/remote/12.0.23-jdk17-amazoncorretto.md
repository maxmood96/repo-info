...
### `jetty:12.0.23-jdk17-amazoncorretto` - linux; amd64
...
### `jetty:12.0.23-jdk17-amazoncorretto` - unknown; unknown
...
### `jetty:12.0.23-jdk17-amazoncorretto` - linux; arm64 variant v8
