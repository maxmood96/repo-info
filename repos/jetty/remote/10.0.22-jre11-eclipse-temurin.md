...
```console
$ docker pull jetty@sha256:597c4bef251c61015a2591d5130458c126aafe6d5b5013cb97659f651933e432
```
...
### `jetty:10.0.22-jre11-eclipse-temurin` - linux; amd64
...
### `jetty:10.0.22-jre11-eclipse-temurin` - unknown; unknown
...
### `jetty:10.0.22-jre11-eclipse-temurin` - linux; arm64 variant v8
