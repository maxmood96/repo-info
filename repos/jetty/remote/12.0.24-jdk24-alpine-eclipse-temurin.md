## `jetty:12.0.24-jdk24-alpine-eclipse-temurin`
...
### `jetty:12.0.24-jdk24-alpine-eclipse-temurin` - linux; amd64
...
### `jetty:12.0.24-jdk24-alpine-eclipse-temurin` - unknown; unknown
