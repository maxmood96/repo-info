...
### `jetty:12.0.20-jdk17-al2023-amazoncorretto` - linux; amd64
...
### `jetty:12.0.20-jdk17-al2023-amazoncorretto` - unknown; unknown
...
### `jetty:12.0.20-jdk17-al2023-amazoncorretto` - linux; arm64 variant v8
