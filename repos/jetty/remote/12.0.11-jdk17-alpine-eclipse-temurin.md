## `jetty:12.0.11-jdk17-alpine-eclipse-temurin`
...
### `jetty:12.0.11-jdk17-alpine-eclipse-temurin` - linux; amd64
...
### `jetty:12.0.11-jdk17-alpine-eclipse-temurin` - unknown; unknown
