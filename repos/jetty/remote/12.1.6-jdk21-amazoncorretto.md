...
### `jetty:12.1.6-jdk21-amazoncorretto` - linux; amd64
...
### `jetty:12.1.6-jdk21-amazoncorretto` - unknown; unknown
...
### `jetty:12.1.6-jdk21-amazoncorretto` - linux; arm64 variant v8
