## `jetty:10.0.26-jre11-alpine-eclipse-temurin`
...
### `jetty:10.0.26-jre11-alpine-eclipse-temurin` - linux; amd64
...
### `jetty:10.0.26-jre11-alpine-eclipse-temurin` - unknown; unknown
