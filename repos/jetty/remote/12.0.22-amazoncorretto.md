...
```console
$ docker pull jetty@sha256:a2ef826751f4ae2258a34d60df7e8cf8d34b4fbb9881d739ced4e630f69a079c
```
...
### `jetty:12.0.22-amazoncorretto` - linux; amd64
...
### `jetty:12.0.22-amazoncorretto` - unknown; unknown
