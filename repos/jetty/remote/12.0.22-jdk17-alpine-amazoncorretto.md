...
```console
$ docker pull jetty@sha256:61e03ac51b0727ad8a38937a2a3cbc13a9fafe9c19cd81450ce4c3a103b20ef9
```
...
### `jetty:12.0.22-jdk17-alpine-amazoncorretto` - linux; amd64
...
### `jetty:12.0.22-jdk17-alpine-amazoncorretto` - unknown; unknown
