...
```console
$ docker pull jetty@sha256:4354a516e79c43aca6af3210b52610cca6d064ae1eb8d52c96de88241922c210
```
...
```console
$ docker pull jetty@sha256:3e1ab0aebabcbf2671c953b7ae0de00fb07e0a3420b95de775b58a8e9c70ac5f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **344.3 MB (344289088 bytes)**  
...
CMD ["jshell"]
# Fri, 04 Feb 2022 00:31:27 GMT
ENV JETTY_VERSION=10.0.7
# Fri, 04 Feb 2022 00:31:28 GMT
...
-	Layers:
	...
	-	`sha256:fda090e7df3523dc9db18e06c2619b52e4dd2772c2800105e421552c27e599ed`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c105b35b39d363c063f0de66268b01513dcdd6de025319a86dcb90f65b04964`  
		Last Modified: Fri, 04 Feb 2022 00:38:49 GMT  
		Size: 10.1 MB (10085722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:052300bbec9d3a23ed0e6f32bce40f3b49e5b16f68a96be6e7868f9ad8b9aca0`  
		Last Modified: Fri, 04 Feb 2022 00:38:48 GMT  
...
```console
$ docker pull jetty@sha256:d0ad34cd80f0c7208aa4a2aec80778eb9954c99a684f6fbc2927d60a1933e55a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.5 MB (340469819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c41a537d5936876d56261c28e0c65f91c95ee81bf3b379f189c7f1be98c6384`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
CMD ["jshell"]
# Thu, 03 Feb 2022 22:18:21 GMT
ENV JETTY_VERSION=10.0.7
# Thu, 03 Feb 2022 22:18:22 GMT
ENV JETTY_HOME=/usr/local/jetty
# Thu, 03 Feb 2022 22:18:23 GMT
ENV JETTY_BASE=/var/lib/jetty
# Thu, 03 Feb 2022 22:18:24 GMT
ENV TMPDIR=/tmp/jetty
# Thu, 03 Feb 2022 22:18:25 GMT
ENV PATH=/usr/local/jetty/bin:/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 03 Feb 2022 22:18:26 GMT
ENV JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/10.0.7/jetty-home-10.0.7.tar.gz
# Thu, 03 Feb 2022 22:18:27 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	FBA2B18D238AB852DF95745C76157BDF03D0DCD6 	5C9579B3DB2E506429319AAEF33B071B29559E1E 	F254B35617DC255D9344BCFA873A8E86B4372146
# Thu, 03 Feb 2022 22:18:37 GMT
RUN set -xe ; 	export GNUPGHOME=/jetty-keys ; 	mkdir -p "$GNUPGHOME" ; 	for key in $JETTY_GPG_KEYS; do 		for server in 			ha.pool.sks-keyservers.net 			pgp.mit.edu 			hkp://p80.pool.sks-keyservers.net:80 			hkp://keyserver.ubuntu.com:80 			keyserver.pgp.com 			ipv4.pool.sks-keyservers.net ; 		do 			if gpg --batch --keyserver "$server" --recv-keys "$key"; then 				break; 			fi; 		done; 	done ; 	mkdir -p "$JETTY_HOME" ; 	cd $JETTY_HOME ; 	curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz ; 	curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc ; 	gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz ; 	tar -xvf jetty.tar.gz --strip-components=1 ; 	sed -i '/jetty-logging/d' etc/jetty.conf ; 	mkdir -p "$JETTY_BASE" ; 	cd $JETTY_BASE ; 	java -jar "$JETTY_HOME/start.jar" --create-startd 		--add-to-start="server,http,deploy,jsp,jstl,ext,resources,websocket" ; 	mkdir -p "$TMPDIR" ; 	groupadd -r jetty && useradd -r -g jetty jetty ; 	chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" ; 	usermod -d $JETTY_BASE jetty ; 	rm -rf /tmp/hsperfdata_root ; 	rm -fr $JETTY_HOME/jetty.tar.gz* ; 	rm -fr /jetty-keys $GNUPGHOME ; 	rm -rf /tmp/hsperfdata_root ; 	java -jar "$JETTY_HOME/start.jar" --list-config ;
# Thu, 03 Feb 2022 22:18:38 GMT
WORKDIR /var/lib/jetty
# Thu, 03 Feb 2022 22:18:40 GMT
COPY multi:a6bf79f83e3ff0c7dc5946cd61ca0413cd3191ce9671725a647923d97a115fae in / 
# Thu, 03 Feb 2022 22:18:40 GMT
USER jetty
# Thu, 03 Feb 2022 22:18:41 GMT
EXPOSE 8080
# Thu, 03 Feb 2022 22:18:42 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Thu, 03 Feb 2022 22:18:43 GMT
CMD ["java" "-jar" "/usr/local/jetty/start.jar"]
```
...
-	Layers:
	...
	-	`sha256:094aec66c6a7d824fad2b23976909d7a80fb1306908ad7fdfa38bded6f5d2f8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f5b83bea560feb352dab082b83c5c33d1b3cad6e41a6dd36d3ddf94cf1d6d08`  
		Last Modified: Fri, 04 Feb 2022 00:11:36 GMT  
		Size: 10.1 MB (10085526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41e9fc5666698775d5b8bb3c51f956e1e9da998317ee6afd0ec975eee87107d`  
		Last Modified: Fri, 04 Feb 2022 00:11:35 GMT  
