...
```console
$ docker pull jetty@sha256:b5a033ba4af387b92b28ad7355382a93e7925a8e3ea3e3c7b188731919984f48
```
...
```console
$ docker pull jetty@sha256:3981194dfe1ec2780b31f0605739afb2e2d5108ec6dae9a3f10eb10ee2d38430
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **131.8 MB (131832322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fb47a1ed2e95bb46ae3f70a2a36422f57cba0249de9be8a68f8d1151e8bd1de`
...
-	Layers:
	...
	-	`sha256:3f055c83789475c280e5740808b198f0679973b74a2c26d8781ca84c07047f5d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20894e588ebc7f3d00e7a4dadad140dba640c35ba2491508476246bcab7ca659`  
		Last Modified: Fri, 04 Feb 2022 00:41:06 GMT  
		Size: 13.8 MB (13847611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1adde4f5a79cd1c1f3adbacdcee330ab4370def6ee0b0e792ac4e85f8ddec5b`  
		Last Modified: Fri, 04 Feb 2022 00:41:04 GMT  
...
```console
$ docker pull jetty@sha256:de1a69e6f9becb1c1e26cdbd11a207a2a2238e413044cb3c8b9f6088b21ffde3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **129.6 MB (129556239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3605e4687291f57dc4ddf59494702ed6ec04a1545b4a6cab1de325def8cea45`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
RUN set -eux; 		arch="$(dpkg --print-architecture)"; 	case "$arch" in 		'amd64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u322-b06/OpenJDK8U-jre_x64_linux_8u322b06.tar.gz'; 			;; 		'arm64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u322-b06/OpenJDK8U-jre_aarch64_linux_8u322b06.tar.gz'; 			;; 		*) echo >&2 "error: unsupported architecture: '$arch'"; exit 1 ;; 	esac; 		wget --progress=dot:giga -O openjdk.tgz "$downloadUrl"; 	wget --progress=dot:giga -O openjdk.tgz.asc "$downloadUrl.sign"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --keyserver keyserver.ubuntu.com --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 		{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$JAVA_HOME/lib/security/cacerts"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		java -version
# Thu, 03 Feb 2022 22:25:58 GMT
ENV JETTY_VERSION=9.2.30.v20200428
# Thu, 03 Feb 2022 22:25:59 GMT
ENV JETTY_HOME=/usr/local/jetty
# Thu, 03 Feb 2022 22:26:00 GMT
ENV JETTY_BASE=/var/lib/jetty
# Thu, 03 Feb 2022 22:26:01 GMT
ENV TMPDIR=/tmp/jetty
# Thu, 03 Feb 2022 22:26:02 GMT
ENV PATH=/usr/local/jetty/bin:/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 03 Feb 2022 22:26:03 GMT
ENV JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/9.2.30.v20200428/jetty-distribution-9.2.30.v20200428.tar.gz
# Thu, 03 Feb 2022 22:26:04 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	FBA2B18D238AB852DF95745C76157BDF03D0DCD6 	5C9579B3DB2E506429319AAEF33B071B29559E1E
# Thu, 03 Feb 2022 22:26:19 GMT
RUN set -xe 	&& mkdir /jetty-keys         && export GNUPGHOME=/jetty-keys;         for key in $JETTY_GPG_KEYS; do                 for server in                         ha.pool.sks-keyservers.net                         p80.pool.sks-keyservers.net:80                         ipv4.pool.sks-keyservers.net                         pgp.mit.edu ;                 do                         if gpg --batch --keyserver "$server" --recv-keys "$key"; then                                 break;                         fi;                 done;         done 	&& mkdir -p "$JETTY_HOME" 	&& cd $JETTY_HOME 	&& curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz 	&& curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc 	&& gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz 	&& tar -xvf jetty.tar.gz --strip-components=1 	&& sed -i '/jetty-logging/d' etc/jetty.conf 	&& rm -fr jetty.tar.gz* 	&& mkdir -p "$JETTY_BASE" 	&& cd $JETTY_BASE 	&& modules="$(grep -- ^--module= "$JETTY_HOME/start.ini" | cut -d= -f2 | paste -d, -s)" 	&& java -jar "$JETTY_HOME/start.jar" --add-to-startd="$modules" 	&& mkdir -p "$TMPDIR" 	&& groupadd -r jetty && useradd -r -g jetty jetty 	&& chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" 	&& rm -rf /tmp/hsperfdata_root
# Thu, 03 Feb 2022 22:26:19 GMT
WORKDIR /var/lib/jetty
# Thu, 03 Feb 2022 22:26:21 GMT
COPY multi:b8b1838b39ef7d9df547fe9a734d87e1a3923c8022961091b24ee37feff4d404 in / 
# Thu, 03 Feb 2022 22:26:21 GMT
USER jetty
# Thu, 03 Feb 2022 22:26:22 GMT
EXPOSE 8080
# Thu, 03 Feb 2022 22:26:23 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Thu, 03 Feb 2022 22:26:24 GMT
CMD ["java" "-jar" "/usr/local/jetty/start.jar"]
```
...
-	Layers:
	...
	-	`sha256:aef8653beb32e4708864f4beab9f0223e48d7fee98dc1ed370f92eaa9102aacb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:895e7df212875ccb4589e5473d0e293c9b852baadec53ceeb99c93cbaa157003`  
		Last Modified: Fri, 04 Feb 2022 00:14:18 GMT  
		Size: 13.8 MB (13847403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4af4f59f0a038386f714cd3af98a4b4d208a95bd3421a40461e554433d15d22f`  
		Last Modified: Fri, 04 Feb 2022 00:14:17 GMT  
