...
### `jetty:11.0.23-jre17-eclipse-temurin` - linux; amd64
...
### `jetty:11.0.23-jre17-eclipse-temurin` - unknown; unknown
...
### `jetty:11.0.23-jre17-eclipse-temurin` - linux; arm64 variant v8
