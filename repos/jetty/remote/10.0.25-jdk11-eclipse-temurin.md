...
### `jetty:10.0.25-jdk11-eclipse-temurin` - linux; amd64
...
### `jetty:10.0.25-jdk11-eclipse-temurin` - unknown; unknown
...
### `jetty:10.0.25-jdk11-eclipse-temurin` - linux; arm64 variant v8
