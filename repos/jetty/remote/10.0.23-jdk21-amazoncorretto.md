...
```console
$ docker pull jetty@sha256:3733c72625e8baff7c678e49366db81255c9060f26e778b594b243ad6f575a39
```
...
### `jetty:10.0.23-jdk21-amazoncorretto` - linux; amd64
...
### `jetty:10.0.23-jdk21-amazoncorretto` - unknown; unknown
