...
### `jetty:12.1.5-jdk17-eclipse-temurin` - linux; amd64
...
### `jetty:12.1.5-jdk17-eclipse-temurin` - unknown; unknown
...
### `jetty:12.1.5-jdk17-eclipse-temurin` - linux; arm64 variant v8
