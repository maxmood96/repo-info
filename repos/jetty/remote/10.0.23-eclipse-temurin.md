...
```console
$ docker pull jetty@sha256:1819cbbc70720357e7d335ce4b1a7753941e263e5ff935528408ecec5ca17ddf
```
...
### `jetty:10.0.23-eclipse-temurin` - linux; amd64
...
### `jetty:10.0.23-eclipse-temurin` - unknown; unknown
