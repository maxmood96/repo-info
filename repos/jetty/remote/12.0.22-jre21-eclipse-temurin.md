...
### `jetty:12.0.22-jre21-eclipse-temurin` - linux; amd64
...
### `jetty:12.0.22-jre21-eclipse-temurin` - unknown; unknown
...
### `jetty:12.0.22-jre21-eclipse-temurin` - linux; arm64 variant v8
