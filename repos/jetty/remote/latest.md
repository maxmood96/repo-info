...
```console
$ docker pull jetty@sha256:df8145965cee68fd797e8c6ffd5a749e37c4fa124cb063053159d82ee71137a1
```
...
```console
$ docker pull jetty@sha256:afc2ed80e2fb21d53de5907aca241fe398bd9b1e99663bdec0ea7b558fc1eabc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.8 MB (243846468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4441cd54b74b80cfdeb83d0c01ccf6c52f7ffaf8dddd00ca262976bc36a33fa9`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
-	Layers:
	...
	-	`sha256:ba26bf8b117fb371b47bc0e1c92c8bbf4937ba2e3fe7ce5b58222c2dc1a72586`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:07e070b3f673c5031a7fd58d5d17ef4feaa0de4970e2ffe331545eeb5b8cf9d6`  
		Last Modified: Tue, 10 Sep 2024 03:09:53 GMT  
		Size: 36.2 MB (36213009 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:406a8b6fd6036afbbe27fc0a5bbdc7f38b217f3f44bbf3377b1a89f24c2e6cb0`  
		Last Modified: Tue, 10 Sep 2024 03:09:52 GMT  
		Size: 1.6 KB (1634 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull jetty@sha256:137883bdd95892879e9d10e949fcc211922cbe80004e10c7853a02955a5b96ce
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3453670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ff8287472e6430202f8cc73b3e3e6bccf110cf6690118e8c825edddde1865a0`

```dockerfile
```

-	Layers:
	-	`sha256:e076fda405b134b9a1b5a0a12b7267081fa6e7081c96430f614b7682a77ce0cc`  
		Last Modified: Tue, 10 Sep 2024 03:09:52 GMT  
		Size: 3.4 MB (3429375 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:db6815061f96d4ba3f3e69c119431741fe9d33ab7f0cafaa9e554554a5bb5c31`  
		Last Modified: Tue, 10 Sep 2024 03:09:51 GMT  
