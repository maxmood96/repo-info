...
```console
$ docker pull jetty@sha256:a3164dfee3c02ead981d24b36cb79606fb8d513d0445109e4451259f45ac00e0
```
...
```console
$ docker pull jetty@sha256:5def48a4812f493657a018c47f25ba2eabe44f0ab5af64fb5d46148f07811809
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.2 MB (255158812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:116187ddbe5d1bccd2dccd448bb4fe6dc2e22d70b2856fe8298035fc06f9d013`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
-	Layers:
	...
	-	`sha256:09baae02538fc7f6795ae085c56cf991b27600bd53e4b9caf13dd43ad69bba16`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c0f41f60129dcfda6064a9e64247853db41b3cff48f4c2ebddff10ab7b0df597`  
		Last Modified: Tue, 02 Sep 2025 04:25:47 GMT  
		Size: 46.0 MB (46039760 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Fri, 13 Dec 2024 15:01:47 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0a1326cc23a06c6f31a7263d0934aa35f48a34e10f3a8e5493f614a2bbfad58e`  
		Last Modified: Tue, 02 Sep 2025 04:25:43 GMT  
		Size: 1.8 KB (1844 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull jetty@sha256:ed68cde7dc1e608f51780bd402bd21ac0242a1f41c40f3da484aabc4141023f5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4012891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27c5b6e45075ac0980638860e7dd54a554542f6f89e6cf96fdd2b9b899e314e5`

```dockerfile
```

-	Layers:
	-	`sha256:2c465c771b43974d8782a20f8d124e6b392be9cc19962c4be0aaac752be200de`  
		Last Modified: Tue, 02 Sep 2025 05:17:32 GMT  
		Size: 4.0 MB (3988710 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:9cf20eaf57cb6a5cd2a221d9de576ed090158411ae0362e74a4c635b3350ae8d`  
		Last Modified: Tue, 02 Sep 2025 05:17:33 GMT  
