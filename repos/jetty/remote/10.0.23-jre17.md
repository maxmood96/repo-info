...
```console
$ docker pull jetty@sha256:b522cb1bbcf606871828046765913360036c7d035cdf0f47780d3e4d78bc8a87
```
...
### `jetty:10.0.23-jre17` - linux; amd64
...
### `jetty:10.0.23-jre17` - unknown; unknown
