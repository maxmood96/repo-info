...
### `jetty:12.0.18-jdk23-eclipse-temurin` - linux; amd64
...
### `jetty:12.0.18-jdk23-eclipse-temurin` - unknown; unknown
...
### `jetty:12.0.18-jdk23-eclipse-temurin` - linux; arm64 variant v8
