...
```console
$ docker pull jetty@sha256:e029a4ca7d663c75d58d8c7e64b25fc48fdb24376fc22760905da5d25f940aec
```
...
```console
$ docker pull jetty@sha256:939ee8b6fbdb10ac20c4735cdb1fcbac10fc4e1b47ff22a3d38d1397b3c437b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100506173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3e2030e8ec67a5180119a56e6fbeed1642e06ff3229929d65db7ee76938c231`
...
-	Layers:
	...
	-	`sha256:dd008fd673e62dbc2983fea0bbb3c1537c7bd0a29c81811bd4b5d7e88ba5c8de`  
		...
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca7c85caed05f2375bb15b44726e79380493d465f13247a19ca7ee9118c5ee59`  
		Last Modified: Wed, 26 Jul 2023 01:27:17 GMT  
		Size: 10.7 MB (10712748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b0a8ef9eb427765a5c8e18e863c92fff2ec335122275ffc7a4b111d6ceb11b4`  
		Last Modified: Wed, 26 Jul 2023 01:27:16 GMT  
...
```console
$ docker pull jetty@sha256:9458d0773a55f650c218d657a9cef70762d722698ef5a3404218042f3dddeb0a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.7 MB (96745043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aef17f2f9ac4a7347f3bd3234802f344be617bd32d2bcbfbbb46f5a5823b1bae`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
# Wed, 26 Jul 2023 01:18:01 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	F254B35617DC255D9344BCFA873A8E86B4372146 	E22488CC94F63E3FC928536C4241C08270D999C3
# Wed, 26 Jul 2023 01:18:18 GMT
RUN set -xe ; 	export savedAptMark="$(apt-mark showmanual)" ; 	mkdir -p $TMPDIR ; 	apt-get update ; 	apt-get install -y --no-install-recommends 		ca-certificates 		p11-kit 		gnupg 		curl 		; 	export GNUPGHOME=/jetty-keys ; 	mkdir -p "$GNUPGHOME" ; 	for key in $JETTY_GPG_KEYS; do 		gpg --batch --keyserver "hkps://keyserver.ubuntu.com" --recv-keys "$key"; 	done ; 	mkdir -p "$JETTY_HOME" ; 	cd $JETTY_HOME ; 	curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz ; 	curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc ; 	gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz ; 	tar -xvf jetty.tar.gz --strip-components=1 ; 	sed -i '/jetty-logging/d' etc/jetty.conf ; 	mkdir -p "$JETTY_BASE" ; 	cd $JETTY_BASE ; 	java -jar "$JETTY_HOME/start.jar" --create-startd 		--add-to-start="server,http,deploy,jsp,jstl,ext,resources,websocket" ; 	groupadd -r jetty && useradd -r -g jetty jetty ; 	chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" ; 	usermod -d $JETTY_BASE jetty ; 	apt-mark auto '.*' > /dev/null ; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null ; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false ; 	rm -rf /var/lib/apt/lists/* ; 	rm -rf /tmp/hsperfdata_root ; 	rm -fr $JETTY_HOME/jetty.tar.gz* ; 	rm -fr /jetty-keys $GNUPGHOME ; 	rm -rf /tmp/hsperfdata_root ; 	java -jar "$JETTY_HOME/start.jar" --list-config ;
# Wed, 26 Jul 2023 01:18:18 GMT
WORKDIR /var/lib/jetty
# Wed, 26 Jul 2023 01:18:18 GMT
COPY multi:88ca540b9901ef22d614e919524f1d550a54166ea9880b0aa9695f8e0470c8f7 in / 
# Wed, 26 Jul 2023 01:18:19 GMT
USER jetty
# Wed, 26 Jul 2023 01:18:19 GMT
EXPOSE 8080
# Wed, 26 Jul 2023 01:18:19 GMT
...
-	Layers:
	...
	-	`sha256:2602ad591dae4ca1dacabf276ed61bbaf302eae24766c153943036ff85dd8173`  
		...
		Size: 159.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56dd89e829982425e94781f2ca050a966456eea002f44064ce0d5d5ba26a36f0`  
		Last Modified: Wed, 26 Jul 2023 01:21:37 GMT  
		Size: 10.7 MB (10706469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a8f91db46c4139e676e59399c8912256f801fea0ff5b814d6aa130e7256b842`  
		Last Modified: Wed, 26 Jul 2023 01:21:37 GMT  
		Size: 1.6 KB (1612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
