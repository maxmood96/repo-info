...
```console
$ docker pull jetty@sha256:2ebf0c963485674f665ca530fafcc12f395ca2210343fbce5239e0a540801ed3
```
...
```console
$ docker pull jetty@sha256:8ae6f6ad6e79e194f4db37a1e7943daab568dd3cd7daaf40bbb5c25a768b3c5a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.0 MB (201047041 bytes)**  
