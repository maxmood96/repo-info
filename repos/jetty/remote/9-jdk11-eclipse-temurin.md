...
```console
$ docker pull jetty@sha256:25d1215321bda1f2e2a3ca691227771144961cfd932ed129ff55eef81903ebdc
```
...
```console
$ docker pull jetty@sha256:4818e05e377743b37eb7f87a21d18f147b409ca9c5917e5c7e8174c72909cafb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.6 MB (196554691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83c8f4e9ea301963f952acdc553972da78a3295c4c4a5b009537bf71dec8f765`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
