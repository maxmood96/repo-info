...
```console
$ docker pull jetty@sha256:688a0b55f1920158af76d92f967dfb4282cfe6f57ff5308cebad097c4a124734
```
...
```console
$ docker pull jetty@sha256:b7671d360009d675436077d05be608ea44089ce90dda31d2e15d39e24d020746
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.8 MB (198758804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86a5258faf52236caf7cc3bc99e2cce5084fd3bb09e354466d7dd22395ba7ca4`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
```console
$ docker pull jetty@sha256:189c0e44cd51ee21068b5e9781fd514527ed7a539beea8db7e92db97af6a1084
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3926426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2af39c5584ecc873ae352fbd3831dd9f233811ba371c873c965c6f5f9573b78`

```dockerfile
```

-	Layers:
	-	`sha256:85ff2078c71bc2f0ffeca4c58ccf84f35392ef6ffd3be82d258286959dda5194`  
		Last Modified: Thu, 23 Jan 2025 00:22:55 GMT  
		Size: 3.9 MB (3904733 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:03c4e41f217ace452834c4cfdae835a03df04eced6f5862d9614e1c7905cabef`  
		Last Modified: Thu, 23 Jan 2025 00:22:55 GMT  
