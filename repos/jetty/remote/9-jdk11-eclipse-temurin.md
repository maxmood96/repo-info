...
```console
$ docker pull jetty@sha256:5c5b7078475c150f0c1e6d4998073a4b46fc8c0226d13f9b2b79b4fd4eb81a9d
```
...
```console
$ docker pull jetty@sha256:ec68da6da95de156f7d8241b4dd7ea1282d5895c16f6b896c4cee3beb14602a0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.3 MB (196259131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd98ee8c22256f5d47b8416af183a002124c185f7bba593564387fe554697edc`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
