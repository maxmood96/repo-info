...
```console
$ docker pull jetty@sha256:15dfef54c5717df7e59dd6102697d20ff0d1a07b8dea2690d59677071a173fad
```
...
```console
$ docker pull jetty@sha256:61b7f8f55fa47203372b717465c11b1558333511fe2df87987493b8e2be4b5d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.3 MB (253291680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1033a32a747de6e574ef5bcdb7bbb5734effd657302896a3c4667e0fc73a351`
...
-	Layers:
	...
	-	`sha256:550d2faf78e22583f22e6f1c9f76aa4e6dfb6d8bc3b98ecc014694f04f824495`  
		...
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:108dbb85c8f88bc93cfc6f3991e6d5b501bed85e861ae2b11c5828d84834d71c`  
		Last Modified: Thu, 06 Oct 2022 05:03:56 GMT  
		Size: 10.2 MB (10233477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4eb6f3ab63d2dd57615f00cea144741c305dfd40a1bdd40e1e43913f86ad870`  
		Last Modified: Thu, 06 Oct 2022 05:03:55 GMT  
...
```console
$ docker pull jetty@sha256:2f90e55fa1dc00b799bf966f07ada7fc4dcf2d5b7148ba2dc41800794cea1f31
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.3 MB (248282287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acdd72de993c024bb48523c4cc029fba81b5838f07d48c61e7acf38343a7c89b`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
CMD ["jshell"]
# Thu, 06 Oct 2022 03:28:13 GMT
ENV JETTY_VERSION=9.4.49.v20220914
# Thu, 06 Oct 2022 03:28:14 GMT
ENV JETTY_HOME=/usr/local/jetty
# Thu, 06 Oct 2022 03:28:15 GMT
ENV JETTY_BASE=/var/lib/jetty
# Thu, 06 Oct 2022 03:28:16 GMT
ENV TMPDIR=/tmp/jetty
# Thu, 06 Oct 2022 03:28:17 GMT
ENV PATH=/usr/local/jetty/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 06 Oct 2022 03:28:18 GMT
ENV JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/9.4.49.v20220914/jetty-home-9.4.49.v20220914.tar.gz
# Thu, 06 Oct 2022 03:28:19 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	FBA2B18D238AB852DF95745C76157BDF03D0DCD6 	5C9579B3DB2E506429319AAEF33B071B29559E1E 	F254B35617DC255D9344BCFA873A8E86B4372146
# Thu, 06 Oct 2022 03:28:42 GMT
RUN set -xe ; 	export savedAptMark="$(apt-mark showmanual)" ; 	mkdir -p $TMPDIR ; 	apt-get update ; 	apt-get install -y --no-install-recommends 		ca-certificates 		p11-kit 		gnupg 		curl 		; 	export GNUPGHOME=/jetty-keys ; 	mkdir -p "$GNUPGHOME" ; 	for key in $JETTY_GPG_KEYS; do 		gpg --batch --keyserver "hkps://keyserver.ubuntu.com" --recv-keys "$key"; 	done ; 	mkdir -p "$JETTY_HOME" ; 	cd $JETTY_HOME ; 	curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz ; 	curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc ; 	gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz ; 	tar -xvf jetty.tar.gz --strip-components=1 ; 	sed -i '/jetty-logging/d' etc/jetty.conf ; 	mkdir -p "$JETTY_BASE" ; 	cd $JETTY_BASE ; 	java -jar "$JETTY_HOME/start.jar" --create-startd 		--add-to-start="server,http,deploy,jsp,jstl,ext,resources,websocket" ; 	groupadd -r jetty && useradd -r -g jetty jetty ; 	chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" ; 	usermod -d $JETTY_BASE jetty ; 	apt-mark auto '.*' > /dev/null ; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null ; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false ; 	rm -rf /var/lib/apt/lists/* ; 	rm -rf /tmp/hsperfdata_root ; 	rm -fr $JETTY_HOME/jetty.tar.gz* ; 	rm -fr /jetty-keys $GNUPGHOME ; 	rm -rf /tmp/hsperfdata_root ; 	java -jar "$JETTY_HOME/start.jar" --list-config ;
# Thu, 06 Oct 2022 03:28:43 GMT
WORKDIR /var/lib/jetty
# Thu, 06 Oct 2022 03:28:45 GMT
COPY multi:a6bf79f83e3ff0c7dc5946cd61ca0413cd3191ce9671725a647923d97a115fae in / 
# Thu, 06 Oct 2022 03:28:45 GMT
USER jetty
# Thu, 06 Oct 2022 03:28:46 GMT
EXPOSE 8080
# Thu, 06 Oct 2022 03:28:47 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Thu, 06 Oct 2022 03:28:48 GMT
CMD ["java" "-jar" "/usr/local/jetty/start.jar"]
```
...
-	Layers:
	...
	-	`sha256:0b84406949b0d586cbce73f9d6f9a9bd5c857798af62c2903f03887e67bb64ca`  
		...
		Size: 160.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b76aaa5585708fac5bb503062dfd8012a476e6cd630a4c140f5777d5dff74a9`  
		Last Modified: Thu, 06 Oct 2022 03:41:45 GMT  
		Size: 10.0 MB (9996529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68e43b7a78934822f0eb0a41befca32d610a4477680b7408cafc0307f14b2479`  
		Last Modified: Thu, 06 Oct 2022 03:41:44 GMT  
