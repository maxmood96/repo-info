...
```console
$ docker pull jetty@sha256:81bff4dd4ecc6159bba93209c5b42d0308efc92ef604cbe26b159fbbce38a2b7
```
...
```console
$ docker pull jetty@sha256:d2d0b0ced091bd0e1d9e477c5a8718e54bb5d4732696b4ce0ca2d28daf1733cc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156943690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15df8f812578cd22a828497832611565ddad75ce308d1429bdf6108223f19b6a`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
