...
```console
$ docker pull jetty@sha256:7b151655bd209206ac19721fcda585ae7e68f69edd9a9e325718b164a850594a
```
...
```console
$ docker pull jetty@sha256:492aa7ee237794a1aeb9ea20e270b3127b74b49727c9aa6b128796896b918bb4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156944537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce387ea08ba8e6703737e16a86048c8703ff474aa05e10af34edfd4e20f128ff`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
