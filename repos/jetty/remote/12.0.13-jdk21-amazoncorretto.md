...
### `jetty:12.0.13-jdk21-amazoncorretto` - linux; amd64
...
### `jetty:12.0.13-jdk21-amazoncorretto` - unknown; unknown
...
### `jetty:12.0.13-jdk21-amazoncorretto` - linux; arm64 variant v8
