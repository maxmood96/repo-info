## `jetty:11.0.22-jre11-alpine-eclipse-temurin`
...
### `jetty:11.0.22-jre11-alpine-eclipse-temurin` - linux; amd64
...
### `jetty:11.0.22-jre11-alpine-eclipse-temurin` - unknown; unknown
