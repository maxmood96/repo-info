...
### `jetty:12.0.20-jdk17-alpine-amazoncorretto` - linux; amd64
...
### `jetty:12.0.20-jdk17-alpine-amazoncorretto` - unknown; unknown
...
### `jetty:12.0.20-jdk17-alpine-amazoncorretto` - linux; arm64 variant v8
