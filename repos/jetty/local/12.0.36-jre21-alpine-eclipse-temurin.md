...
- Created: `2026-06-22T20:21:27.607874748Z`
- Virtual Size: ~ 249.04 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=12.0.36`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/12.0.36/jetty-home-12.0.36.tar.gz`
