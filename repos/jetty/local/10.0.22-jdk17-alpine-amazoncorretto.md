...
- Environment:
  ...
  - `JETTY_VERSION=10.0.22`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/10.0.22/jetty-home-10.0.22.tar.gz`
...
```console
amazon-corretto-17-17.0.12.7.1-r0 description:
Corretto17

amazon-corretto-17-17.0.12.7.1-r0 webpage:
https://github.com/corretto/corretto-jdk

amazon-corretto-17-17.0.12.7.1-r0 installed size:
319 MiB

amazon-corretto-17-17.0.12.7.1-r0 license:
