...
- Environment:
  ...
  - `JETTY_VERSION=12.0.26`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/12.0.26/jetty-home-12.0.26.tar.gz`
