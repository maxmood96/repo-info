...
- Created: `2023-03-15T22:49:24.892221478Z`
- Virtual Size: ~ 365.39 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=11.0.14`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.14/jetty-home-11.0.14.tar.gz`
...
```console
amazon-corretto-11-11.0.18.10.1-r0 description:
Corretto11

amazon-corretto-11-11.0.18.10.1-r0 webpage:
https://github.com/corretto/corretto-11

amazon-corretto-11-11.0.18.10.1-r0 installed size:
311 MiB

amazon-corretto-11-11.0.18.10.1-r0 license:
