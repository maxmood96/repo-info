...
- Image ID: `sha256:676603817e2551bc500de50a2798b384d5b1e1f1d5b4a0ff6e1d96d9013c4a5a`
- Created: `2023-04-26T21:04:11.619665324Z`
- Virtual Size: ~ 185.13 Mb  
...
```console
encodings-1.0.6-r0 description:
X.org font encoding files

encodings-1.0.6-r0 webpage:
http://xorg.freedesktop.org/

encodings-1.0.6-r0 installed size:
788 KiB

encodings-1.0.6-r0 license:
custom
...
```console
font-dejavu-2.37-r3 description:
Font family based on the Bitstream Vera Fonts with a wider range of characters

font-dejavu-2.37-r3 webpage:
https://dejavu-fonts.github.io/

font-dejavu-2.37-r3 installed size:
17 MiB

font-dejavu-2.37-r3 license:
custom
...
```console
gnupg-2.2.40-r0 description:
GNU Privacy Guard 2 - meta package for full GnuPG suite

gnupg-2.2.40-r0 webpage:
https://www.gnupg.org/

gnupg-2.2.40-r0 installed size:
4096 B

gnupg-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gnupg-dirmngr-2.2.40-r0 description:
GNU Privacy Guard 2 - network certificate management service

gnupg-dirmngr-2.2.40-r0 webpage:
https://www.gnupg.org/

gnupg-dirmngr-2.2.40-r0 installed size:
668 KiB

gnupg-dirmngr-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gnupg-gpgconf-2.2.40-r0 description:
GNU Privacy Guard 2 - core configuration utilities

gnupg-gpgconf-2.2.40-r0 webpage:
https://www.gnupg.org/

gnupg-gpgconf-2.2.40-r0 installed size:
300 KiB

gnupg-gpgconf-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gnupg-utils-2.2.40-r0 description:
GNU Privacy Guard 2 - utility programs

gnupg-utils-2.2.40-r0 webpage:
https://www.gnupg.org/

gnupg-utils-2.2.40-r0 installed size:
400 KiB

gnupg-utils-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gnupg-wks-client-2.2.40-r0 description:
GNU Privacy Guard 2 - Web Key Service client

gnupg-wks-client-2.2.40-r0 webpage:
https://www.gnupg.org/

gnupg-wks-client-2.2.40-r0 installed size:
196 KiB

gnupg-wks-client-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gpg-2.2.40-r0 description:
GNU Privacy Guard 2 - public key operations only

gpg-2.2.40-r0 webpage:
https://www.gnupg.org/

gpg-2.2.40-r0 installed size:
900 KiB

gpg-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gpg-agent-2.2.40-r0 description:
GNU Privacy Guard 2 - cryptographic agent

gpg-agent-2.2.40-r0 webpage:
https://www.gnupg.org/

gpg-agent-2.2.40-r0 installed size:
744 KiB

gpg-agent-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gpg-wks-server-2.2.40-r0 description:
GNU Privacy Guard 2 - Web Key Service server

gpg-wks-server-2.2.40-r0 webpage:
https://www.gnupg.org/

gpg-wks-server-2.2.40-r0 installed size:
180 KiB

gpg-wks-server-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gpgsm-2.2.40-r0 description:
GNU Privacy Guard 2 - S/MIME version

gpgsm-2.2.40-r0 webpage:
https://www.gnupg.org/

gpgsm-2.2.40-r0 installed size:
448 KiB

gpgsm-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
gpgv-2.2.40-r0 description:
GNU Privacy Guard 2 - signature verification only

gpgv-2.2.40-r0 webpage:
https://www.gnupg.org/

gpgv-2.2.40-r0 installed size:
388 KiB

gpgv-2.2.40-r0 license:
GPL-3.0-or-later
...
```console
libfontenc-1.1.6-r0 description:
X11 font encoding library

libfontenc-1.1.6-r0 webpage:
http://xorg.freedesktop.org/

libfontenc-1.1.6-r0 installed size:
48 KiB

libfontenc-1.1.6-r0 license:
MIT
...
```console
libgpg-error-1.46-r1 description:
Support library for libgcrypt

libgpg-error-1.46-r1 webpage:
https://www.gnupg.org/

libgpg-error-1.46-r1 installed size:
180 KiB

libgpg-error-1.46-r1 license:
...
```console
libretls-3.5.2-r1 description:
port of libtls from libressl to openssl

libretls-3.5.2-r1 webpage:
https://git.causal.agency/libretls/

libretls-3.5.2-r1 installed size:
88 KiB

libretls-3.5.2-r1 license:
...
```console
mkfontscale-1.2.2-r1 description:
Scalable font index generator for X

mkfontscale-1.2.2-r1 webpage:
http://xorg.freedesktop.org

mkfontscale-1.2.2-r1 installed size:
56 KiB

mkfontscale-1.2.2-r1 license:
MIT
