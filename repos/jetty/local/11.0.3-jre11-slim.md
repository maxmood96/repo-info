...
- Created: `2021-05-25T01:20:11.221428674Z`
- Virtual Size: ~ 237.26 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=11.0.3`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.3/jetty-home-11.0.3.tar.gz`
