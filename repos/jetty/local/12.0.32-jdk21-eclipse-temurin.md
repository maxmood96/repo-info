...
- Created: `2026-02-17T21:21:34.424305451Z`
- Virtual Size: ~ 488.78 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=12.0.32`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/12.0.32/jetty-home-12.0.32.tar.gz`
