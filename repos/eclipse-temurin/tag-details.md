...
```console
$ docker pull eclipse-temurin@sha256:efd736d645928db4018b8b8ad104c25764d768fd064ca5a477b7dbde9b160ffe
```
...
### `eclipse-temurin:11-jdk` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:11-jdk` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:11-jdk-nanoserver` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:11-jdk-nanoserver-1809` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:11-jdk-windowsservercore` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:11-jdk-windowsservercore` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:11-nanoserver-1809` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:11-windowsservercore-ltsc2016` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:16-jdk-windowsservercore` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:16-jdk-windowsservercore` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:16-windowsservercore-1809` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:16.0.2_7-jdk-nanoserver-1809` - windows version 10.0.17763.2114; amd64
...
```console
$ docker pull eclipse-temurin@sha256:23a5496f0ccaa07f07b177a9b972421324ca41bd04fd5db18dfddd4ba7057d81
```
...
```console
$ docker pull eclipse-temurin@sha256:7061e7e9663eaf8921b402f69046038c76fe6cc2d9d0875845397978727c56b1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.3 MB (223343320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40a339f14bf674d80b78b74bf105f906fc4f18e7bfa786cfc6b667a3248d2714`
-	Default Command: `["\/bin\/bash"]`
...
# Fri, 13 Aug 2021 21:32:06 GMT
RUN yum install -y tzdata openssl curl binutils ca-certificates fontconfig gzip tar     && yum clean all
# Fri, 13 Aug 2021 21:32:07 GMT
ENV JAVA_VERSION=jdk8u302-b08
# Fri, 13 Aug 2021 21:32:15 GMT
RUN set -eux;     ARCH="$(uname -m)";     case "${ARCH}" in        aarch64|arm64)          ESUM='f287cdc2a688c2df247ea0d8bfe2863645b73848e4e5c35b02a8a3d2d6b69551';          BINARY_URL='https://github.com/adoptium/temurin8-binaries/releases/download/jdk8u302-b08/OpenJDK8U-jdk_aarch64_linux_hotspot_8u302b08.tar.gz';          ;;        ppc64el|ppc64le)          ESUM='c2940f3772d4467a818a0221e80c2c720b6d427a886aaed37262e451ddbb0a56';          BINARY_URL='https://github.com/adoptium/temurin8-binaries/releases/download/jdk8u302-b08/OpenJDK8U-jdk_ppc64le_linux_hotspot_8u302b08.tar.gz';          ;;        amd64|x86_64)          ESUM='cc13f274becf9dd5517b6be583632819dfd4dd81e524b5c1b4f406bdaf0e063a';          BINARY_URL='https://github.com/adoptium/temurin8-binaries/releases/download/jdk8u302-b08/OpenJDK8U-jdk_x64_linux_hotspot_8u302b08.tar.gz';          ;;        *)          echo "Unsupported arch: ${ARCH}";          exit 1;          ;;     esac;     curl -LfsSo /tmp/openjdk.tar.gz ${BINARY_URL};     echo "${ESUM} */tmp/openjdk.tar.gz" | sha256sum -c -;     mkdir -p /opt/java/openjdk;     cd /opt/java/openjdk;     tar -xf /tmp/openjdk.tar.gz --strip-components=1;     rm -rf /tmp/openjdk.tar.gz;
# Fri, 13 Aug 2021 21:32:15 GMT
ENV JAVA_HOME=/opt/java/openjdk PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 13 Aug 2021 21:32:16 GMT
RUN echo Verifying install ...     && echo   javac -version && javac -version     && echo   java -version && java -version     && echo Complete.
```
...
-	Layers:
	...
	-	`sha256:a1f30f64b2dba124507bf31c8ca19668559c7863dd22ef9c7e0269feadc0e379`  
		...
		Size: 12.3 MB (12262266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:419fde6d6e34dfddd21dd98278118661b3675b2a59d98342cb5e0bd6c58bb1f7`  
		Last Modified: Fri, 13 Aug 2021 21:35:34 GMT  
		Size: 102.7 MB (102705949 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6772143da3f9f6c9fcb50db045e2b9aae52a792b04c7de823cbaef044310e31`  
		Last Modified: Fri, 13 Aug 2021 21:35:24 GMT  
		Size: 160.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull eclipse-temurin@sha256:ecec1f2d8244552dff4e3c58de119a03813c4551b3858642c9161b42d14145cb
```
...
```console
$ docker pull eclipse-temurin@sha256:dc6a48229f0871fa920e4884ba219d3c7e77c7b22c1143e32405fc50f5b96211
```
...
```console
$ docker pull eclipse-temurin@sha256:437271fa336e34459ecac1026cb0b99a96b8671194df5081aa23267ae27c961f
```

-	Docker Version: 20.10.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.1 MB (203055963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48af78e1e04c0ed04e0d310cb38e68c6f6149f3d792af7479096d36f1bdff8d8`
-	Default Command: `["c:\\windows\\system32\\cmd.exe"]`
-	`SHELL`: `["cmd","\/s","\/c"]`
...
-	Layers:
	...
	-	`sha256:7d5932d5d4ce162aa5027cf5459c722437263db5c63f0a3141aa17a36dc19968`  
		...
		Size: 100.2 MB (100158395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55a829acefa927c063fcb438b169abb34ef862b18674f0b9c566518b1f375a42`  
		Last Modified: Wed, 25 Aug 2021 23:24:51 GMT  
		Size: 81.4 KB (81351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `eclipse-temurin:8-jre-windowsservercore` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:8-jre-windowsservercore` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:8-jre-windowsservercore-ltsc2016` - windows version 10.0.14393.4583; amd64
...
### `eclipse-temurin:8-nanoserver` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:8-nanoserver-1809` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:8u302-b08-jre-nanoserver` - windows version 10.0.17763.2114; amd64
...
### `eclipse-temurin:8u302-b08-jre-nanoserver-1809` - windows version 10.0.17763.2114; amd64
