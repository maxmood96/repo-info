...
- Created: `2022-11-07T20:21:39.304081919Z`
- Virtual Size: ~ 587.95 Mb  
...
```console
$ dnf --quiet download --source --url dejavu-fonts-common-2.33-6.el7.noarch
...
```console
$ dnf --quiet download --source --url dejavu-sans-fonts-2.33-6.el7.noarch
http://vault.centos.org/centos/7/os/Source/SPackages/dejavu-fonts-2.33-6.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url fontconfig-2.13.0-4.3.el7
...
```console
$ dnf --quiet download --source --url fontpackages-filesystem-1.44-8.el7.noarch
...
```console
$ dnf --quiet download --source --url freetype-2.8-14.el7_9.1
http://vault.centos.org/centos/7/updates/Source/SPackages/freetype-2.8-14.el7_9.1.src.rpm
```
...
```console
$ dnf --quiet download --source --url libpng-1.5.13-8.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libpng-1.5.13-8.el7.src.rpm
```
