...
```console
$ docker pull eclipse-temurin@sha256:24dd0ef75eadf6107a0620471ce106d5df9716a2d4d54f2ac0f7cc16b144d823
```
...
### `eclipse-temurin:8u452-b09-jdk-focal` - linux; amd64

```console
$ docker pull eclipse-temurin@sha256:c135cf05131eeb3cd22aa2dd5e02d4f937a0ebf8059b8493fb147a702964814e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.5 MB (102495124 bytes)**  
...
### `eclipse-temurin:8u452-b09-jdk-focal` - unknown; unknown

```console
$ docker pull eclipse-temurin@sha256:cb07803ff823c84f040595ed205f74778ab481cb1db3850f12c222797ebb5188
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3936621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:682597a2f41476e61b9aaeaba6df9d55952bcb6e694d45dea10efc42cc679182`

```dockerfile
```

-	Layers:
	-	`sha256:320829edb2ba11c34746d9f7c8ab9a7555d942c8fc38307bef7ac73423a1285b`  
		Last Modified: Fri, 06 Jun 2025 01:44:14 GMT  
		Size: 3.9 MB (3914149 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:dd8355201016dee9de7525bf44e2444dad57e9cfada8b59cba80d3a3fb1d2915`  
		Last Modified: Fri, 06 Jun 2025 01:44:16 GMT  
		Size: 22.5 KB (22472 bytes)  
		MIME: application/vnd.in-toto+json

### `eclipse-temurin:8u452-b09-jdk-focal` - linux; arm variant v7

```console
$ docker pull eclipse-temurin@sha256:8a50d37c01d28d68d46499169f05a5cbc5055c8aac9d091f6134a39b604da554
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.2 MB (92230076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b2f1e090f7be58e36a86841bb7296bf1445488bf644ba32b8925eb61f99513d`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:67b3ce1bf33ec590ca03c1ec0c8981c52d8acfa85774d1594bfceb89a91ff26f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3940370 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d4bfbe1764bb4f12b3ba26e7e4682523522c064986fbef012fa2e911e739de`

```dockerfile
```

-	Layers:
	-	`sha256:c0008606554168adbe309e8757fce34ac2520e4cf423b636501c5fd81b6df135`  
		Last Modified: Mon, 28 Apr 2025 20:07:35 GMT  
		Size: 3.9 MB (3917802 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:68414b0d32f7ff243a41856d5d8035650e7f90e64315ab25a59cd70dbfec82a6`  
		Last Modified: Mon, 28 Apr 2025 20:07:34 GMT  
		Size: 22.6 KB (22568 bytes)  
		MIME: application/vnd.in-toto+json

### `eclipse-temurin:8u452-b09-jdk-focal` - linux; arm64 variant v8

```console
$ docker pull eclipse-temurin@sha256:bd50bbb5e08bc62cd095a312ee76ca68be0e5a41bf255459029ac65c0bb760cb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.9 MB (99907763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:386b108abf612a0367d9b243d9197d67487e4919d800475e478bf65f6f377976`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:5d4fb3ec265c8f010d4eaa1d70322ab16cc1bdf760ada4129249ec13bf3f386b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3937091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ac011459ab2c2f9bdaa1ecf85c08d15d2e40242be2b28f494a6da7f21493bef`

```dockerfile
```

-	Layers:
	-	`sha256:3601374ec95bde740eeef46e2ea63090467d333745137d96d63c157e7691656a`  
		Last Modified: Mon, 28 Apr 2025 20:07:12 GMT  
		Size: 3.9 MB (3914495 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:85d7df2c01b952627da7d407fcae0b7c4fc7f753c5ac1841a7d74289751d7fe6`  
		Last Modified: Mon, 28 Apr 2025 20:07:11 GMT  
		Size: 22.6 KB (22596 bytes)  
		MIME: application/vnd.in-toto+json

### `eclipse-temurin:8u452-b09-jdk-focal` - linux; ppc64le

```console
$ docker pull eclipse-temurin@sha256:9662792c044341a7b823e0ac9d6e7e4a62d24dccb9509c38255b3ff5a08b2968
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.7 MB (106672671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cccddcf7f2872ead844e514c05289aacfce40645c73c72d1e4cea24d01834305`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
-	Layers:
	...
	-	`sha256:8741079b5f79fd6329e63d54b05157175d23c60526801255e4d311b3d4a0442c`  
		Last Modified: Wed, 04 Jun 2025 11:29:33 GMT  
		Size: 126.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c0ac0617f4761bfff5a6bd3badeb391144d791076226cdbe054bdd5925a220fe`  
		Last Modified: Wed, 04 Jun 2025 11:29:37 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:36764ace76fd07b07d80a1533e7fbbd5430920c0fcf513dbadaf62635f9bafee
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3939207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:132501f7e8f1f65ad6c92328a2314e541fd274634d7fe7579c606fc0a1e59690`

```dockerfile
```

-	Layers:
	-	`sha256:592aed252a1bfe124eb5e2785cd0f51c317ed0867919f11a499be0bcf6b97203`  
		Last Modified: Mon, 28 Apr 2025 20:07:55 GMT  
		Size: 3.9 MB (3916692 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:33128518e58fab26385f2bdbbf45b3bf3132e8e25b57f9f3f3015b99404e5697`  
