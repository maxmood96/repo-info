...
```console
$ docker pull eclipse-temurin@sha256:039f727ed86402f37524b5d01a129947e2f061d5856901d07d73a454e689bb13
```
...
```console
$ docker pull eclipse-temurin@sha256:3f30352a87719a81c03c9fad62073e8ec8c44fc736d2f2b887d9e0d7503d9fbb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.8 MB (156784082 bytes)**  
