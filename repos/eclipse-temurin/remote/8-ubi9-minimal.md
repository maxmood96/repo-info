...
```console
$ docker pull eclipse-temurin@sha256:78ba5509f99d72c92dc8c0aa0821104620d31b60982c777609b01fcc0b0eba9d
```
...
```console
$ docker pull eclipse-temurin@sha256:41c28e7fb31e26aa87fe431372430cddcb155e4628d8e994a603fb9377124e68
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.5 MB (125536751 bytes)**  
...
```console
$ docker pull eclipse-temurin@sha256:4e85edc48570137e76622b7cef60b048b44655a197e7c6eb692ae689189c45d1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.6 MB (2641060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cc3ba06d5ceedfc565ce072dba58bd318f30d5fa641af9c6b26b1dc6c66eae6`

```dockerfile
```

-	Layers:
	-	`sha256:413a63770651be07a0f4bc96a43a82f99f567187fd0f9eddbe7db6480050f6b6`  
		Last Modified: Fri, 08 May 2026 16:20:41 GMT  
		Size: 2.6 MB (2621187 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5c29973d4d54a2c6360c4411178cf7f3862b6ee63a244feec159652f1143dd84`  
		Last Modified: Fri, 08 May 2026 16:20:41 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:7919aaaa4d01a47027495bd679caba3d94aae9a4b3eb67dd45a952d75df3478b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **123.2 MB (123249583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a84990cc05d110d65aa48e127463922642533ba1b544512f778bc39141b0352d`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:19150ec9a19992a4700df5d34c8cb7416560333c26c2823e59ca9bfc02a88c57
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.6 MB (2641246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90d24e056ab2d3c90845cf680ee29c6f7c2adca50da5cb6d8898b6f23cff36e9`

```dockerfile
```

-	Layers:
	-	`sha256:aca153638ababb69af6779ff1b1ed43b2dda9b42c60bdc4b9b9a5cd82f94552f`  
		Last Modified: Fri, 08 May 2026 16:20:21 GMT  
		Size: 2.6 MB (2621257 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:790864d42cf13f20582ecb8b796254116a7090ecfc06617c89e72bc6362d03a2`  
...
```console
$ docker pull eclipse-temurin@sha256:d19746709c7181e9ef04c0a0b1bcc36b2a7ca685d00c5118150da97dcea92288
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.0 MB (129954139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b3c4116510e56be45faa7f6c53d068f1f8dae08fc76ec3ae9f0e90e15333a1f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:5afa9353f322d1937635eb111012001a3b109e7c7b8e4e068613b289a6175595
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.6 MB (2639783 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3647b372c846fe9567ca89ec02115be982862bb7782bd31e0c01281ff18ada82`

```dockerfile
```

-	Layers:
	-	`sha256:832e62a0d239f6ad059a360be230b343797b70155e17668e6b8e5de591032c49`  
		Last Modified: Fri, 08 May 2026 16:19:17 GMT  
		Size: 2.6 MB (2619874 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3ce2160b43ede55cd3ad38e5847e61430562b997978251cb438259e49183d97f`  
		Last Modified: Fri, 08 May 2026 16:19:17 GMT  
