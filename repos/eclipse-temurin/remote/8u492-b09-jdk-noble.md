...
```console
$ docker pull eclipse-temurin@sha256:7b3baf173053e7cef85b9650ba0e865879e91050431fa688fcb7438374aa7dd9
```
...
```console
$ docker pull eclipse-temurin@sha256:4bb9f867637e93165304f1d76e78a59e85bae4e42d34b7105252319bcbf93439
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.9 MB (101920125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b01b1e8f655a410eb39a1cca384e3cdd43ee5f7c29e2fee718d6aa3186922e81`
...
```console
$ docker pull eclipse-temurin@sha256:838327a42a920eeff3874a196bac4b2ab867d096e4832cdd7691f499e766bca1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3513903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0420988c9b3ad32c3ec5dafb23da859a18dbf24bbe5adb9cefec0ea53372b6d5`

```dockerfile
```

-	Layers:
	-	`sha256:d5d493394b89d926d93e61144aba1116e1129961e89c005a7fc11dc38e0fab0f`  
		Last Modified: Tue, 02 Jun 2026 08:14:14 GMT  
		Size: 3.5 MB (3491473 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bf90b23170ba65598642208d513b3f2d164802d30b36a42e678dd76788c9e5fe`  
		Last Modified: Tue, 02 Jun 2026 08:14:14 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:f595c2fe97016bc7835aa3086a13b96dd4adb0e46b01bfa0217ae933f1bc1f79
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.7 MB (93714119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:473740e3303243315e689a9cd6124b85566ff5ac94cb13b72130b4e089f839c6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:6d8c7d80d4440416355ab29c0dd9695a96d1ad60cf5424e99a43d000f0d3d759
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3517982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0aace7ceca729af29ce3436861896114a0732ded4ca5ded1fcf502778f92c78`

```dockerfile
```

-	Layers:
	-	`sha256:a05563bac0718a2ecb71ee51b898b6ce43c8e8d97d56098ce0fa1f89093c827c`  
		Last Modified: Tue, 02 Jun 2026 08:10:46 GMT  
		Size: 3.5 MB (3495453 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:48fe8ab36c7517eeb4ce5fedcff420d260be52e3aec9287b9816a11f77bd9177`  
		Last Modified: Tue, 02 Jun 2026 08:10:45 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:aafcc3b880c050ea76d4e5293a07fa930358ba32747affa86a3176e7dcb297e9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.2 MB (100154049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e849b4ab6cfb7d70688331f71e7401195b98cb1da758de86c338ebdc1fde2a28`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:28134dbf5dc29e4bab88a5d719d288392eab66172667c55c82e16772c432a665
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3515185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7385113e420bf93026288d51b7a4d6067c16fa2173bcee19219f48832cff484b`

```dockerfile
```

-	Layers:
	-	`sha256:671e94848431ac7ae29fae50a6507f61968d1fa1ed03734b6c214dc07a938638`  
		Last Modified: Tue, 02 Jun 2026 08:15:39 GMT  
		Size: 3.5 MB (3492632 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b00b64c6df6b999e139a2fc4c57a58d4d3a762a351786d4f82f4ed5077e4d852`  
		Last Modified: Tue, 02 Jun 2026 08:15:39 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:324acd33dbb4a268729ee31e94c083fa5a69721378194f4d07177e4f549358db
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.8 MB (105800544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0d82c8e1cd963bd41a8d9797b3ba7b825f72c890b328ca8d2e73776e910e0f6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:5a624c720fedf0e56d0f95caf0dff71ed0ef02f7c3b5f01a5c3fc06f5e57719a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.5 MB (3516684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c82c43df8a05c4ffc27b2074f4ffd6f0806d1f49e08096c25b7531a02e35ed64`

```dockerfile
```

-	Layers:
	-	`sha256:2869c2bb04a67a960536d2691fab215a93582069b161504e05561f92bb943bf2`  
		Last Modified: Tue, 02 Jun 2026 08:10:41 GMT  
		Size: 3.5 MB (3494211 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:97914feaebdb57c243d72bc1ed58306253032013c12dbeb6f8b7928d0df6b982`  
		Last Modified: Tue, 02 Jun 2026 08:10:41 GMT  
