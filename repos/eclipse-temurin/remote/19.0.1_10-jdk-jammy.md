...
### `eclipse-temurin:19.0.1_10-jdk-jammy` - linux; amd64
...
### `eclipse-temurin:19.0.1_10-jdk-jammy` - linux; arm variant v7
...
### `eclipse-temurin:19.0.1_10-jdk-jammy` - linux; arm64 variant v8
...
### `eclipse-temurin:19.0.1_10-jdk-jammy` - linux; ppc64le
...
### `eclipse-temurin:19.0.1_10-jdk-jammy` - linux; s390x
