...
```console
$ docker pull eclipse-temurin@sha256:3217c89fb6a1a46be2fb72ea56b6e1197675a705e018822af3094c1c5a2fd3a4
```
...
```console
$ docker pull eclipse-temurin@sha256:f17810605ffc1a9e71837b3bbbcf89899d9e9d69fe769261a2144d8c4d662287
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191324529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5730cb34a540cf27c6b890e744d40eb090062a62b0fdcde55d5b5579b88a4a53`
...
```console
$ docker pull eclipse-temurin@sha256:1394c6cbbbd87661998fdecdd9cb3fbfec653682e7044b05720204ae23f6a6eb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3836081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:874c1dccdf03cc630cae7b02a173c3f713be4b81facff22ac6093ec15ead108d`
...
```console
$ docker pull eclipse-temurin@sha256:afa775ddeb14b7825e7931e386eb53cd97a447a91ba1dd4a458579e25d57da4f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180650532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b3245cff379f2a2bc0cf79bc2a46d83cf15ae92b7ae238544f5070fb0f0d18f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:b198a39fb4d9cad1c5b8a32fd6485d29770ab8d1e8d9956e46cca2ea0a9c6ed6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3837231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:001ae60488354bd9592181bcfdbdc5ab7491263d319a14b9344eaa73f01b5f86`
...
```console
$ docker pull eclipse-temurin@sha256:a63adb2e3a88d2f0f1b8e70d7412964f0e0bd25abd0b1632a1522b5f7a265e5c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.8 MB (185847942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:137096165f3c58f8fd2e31151018f7be606bdf6b06ae4848983f6f79accc73b6`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:8c7be6d0109346202ab1c23c9dae6ef80cafc0bd97e45fc777c869ff6e543a49
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3836490 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4d692e8b0c317c8461b8882b4569fc67f1c8e4969ea702441c876b53713d252`
...
```console
$ docker pull eclipse-temurin@sha256:79d41bb66cd370badaccf09ad67603eac5e64960cd2b404f240f035b40df556e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184889641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e3f38fbdfb8e6e04449e77026765ea0ca0f735079b5d7ab8192f6fccf851f5b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:b27c60ad8ee33cf6f67adfe5866565816d70ee0bd1939535c5797a9feb911db9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3837519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9da3fe5e5974785ab155ab48ecf706ce2943d8717a3f3dce864d01597475005e`
...
```console
$ docker pull eclipse-temurin@sha256:4e66bb1c9db26843f3823736711d05a7fc84d987449e344b403a03d96a00881f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.7 MB (169743213 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eb1085dec8d35971a1e7c4176d8e92457f0f79c3c34a7a0be79a75eb0f7b91e`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:b5cd37145573d55284dcb3ac18df8da295179b03dbfcdf4a9ac566cd38bce2fc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3833278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ac1f3785b89ab305095654edfb08ceec86171314d150b52f67fa9aa13b588d0`
