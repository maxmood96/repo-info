...
```console
$ docker pull eclipse-temurin@sha256:64fdcd70083385fccfc6dc417bf47356a827d73b5501994160541f6e7e20655a
```
...
### `eclipse-temurin:11.0.17_8-jdk-focal` - linux; amd64
...
### `eclipse-temurin:11.0.17_8-jdk-focal` - linux; arm variant v7

```console
$ docker pull eclipse-temurin@sha256:5a40db789f95d7039aae7eeee08a1d594888c444d2e33d2881dc39391343bbf9
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.7 MB (225656288 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13145ba4a6fd443e723c83e1a3964900d4835370fcb35cd9e3804589e9688dd1`
-	Default Command: `["jshell"]`
...
### `eclipse-temurin:11.0.17_8-jdk-focal` - linux; arm64 variant v8

```console
$ docker pull eclipse-temurin@sha256:9ef7c1ce50192e5f886dcb0cecc5d9b152ca33fdbe65af8aa4e0834a0d2c321b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.6 MB (238613513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97d7c1cb90835a10927219010e19db82361c08793319410f4d5609282b4183c4`
-	Default Command: `["jshell"]`
...
### `eclipse-temurin:11.0.17_8-jdk-focal` - linux; ppc64le

```console
$ docker pull eclipse-temurin@sha256:57f9c9ff141c8ff85b47a5dc50215d87385935dc8c1f47d37befc4bca3189557
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.3 MB (231285740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:092a8c4862e15cdcaea6500bebb7907863fb2b12a04af748e2407280a4261cc6`
-	Default Command: `["jshell"]`
...
### `eclipse-temurin:11.0.17_8-jdk-focal` - linux; s390x

```console
$ docker pull eclipse-temurin@sha256:f6cbd1319a17b1c0f3c141a78bd33f2d4bcd456d5a6d38194af6fe7968da86fe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.0 MB (214982238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f33b7a639b25379b1262f39cd90bcf1db53d319023dd5c5c77b1cb308a8df55`
-	Default Command: `["jshell"]`
