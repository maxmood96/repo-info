...
```console
$ docker pull eclipse-temurin@sha256:cb618fade2f53fe7b67e11a62fdcd88c6b228a211d1320f693d0939c1f740d9e
```
...
```console
$ docker pull eclipse-temurin@sha256:32aaa40e28a7cee08fcf4613dab3d3702ffa30c7c6311d02462283a5f3c33bc2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.3 MB (209302840 bytes)**  
...
```console
$ docker pull eclipse-temurin@sha256:4bfcbd1f7ec70994ba0298f0f20e92d828920f5d60c8e1d0485d5b2e70570c88
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2515589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a18a3c86802b1f70085a7b7e37649bde63aa8ef33d5eb830e381689958f0b7b`

```dockerfile
```

-	Layers:
	-	`sha256:f0a66147934dd9e402ee25d3dc566df65a5e45b2ab2670b21e82d4ca84ca8734`  
		Last Modified: Fri, 19 Sep 2025 23:18:18 GMT  
		Size: 2.5 MB (2494432 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:aecdde98470052d6ee82cec522f4ade4c6094c30001d6e3232f2283b75c54367`  
		Last Modified: Fri, 19 Sep 2025 23:18:19 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:1218de8c97e773f73a72c5eca7622a9cac1297827ab74e4765223f832b1d0398
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.8 MB (204803412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e498c3cc87aa15b9e7d67f4421c04bd096d78f17245d853b1c715bdf5c317c97`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:757a1afd32996abe8ba7effd8dffa42d0c73cc70811998b36c3e407319d9539a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2515695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c6fe8b83513256eea36f715ae5bff9e82725339c5109104dca28b3341c4c20b`

```dockerfile
```

-	Layers:
	-	`sha256:f370e54136287e5f98b8fd828547715f38bdfe970ddcbfd5d00cca8d541df8ff`  
		Last Modified: Fri, 19 Sep 2025 23:18:15 GMT  
		Size: 2.5 MB (2494422 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4a2c8c6ef08ed09e3f4bf14c09bd5bac0a71eed545d568d738629652076d5921`  
		Last Modified: Fri, 19 Sep 2025 23:18:16 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:fa8c23d92db09379fa29dd784bb5990236cfbadb037c8ec706c6497a37b6387f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203371427 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4d5c4d4c6437ca068a61f1571edf33995a1a68075bd03704ce32c937e1918ad`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:fcddf9c7cfbc3370486907c57499fdf0fee718b58bf554695215911bf624bae5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2513104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae8143b9f3414dae93626b7ac6b0dafe000f92a7ddf4db8c62e56c7bdf3d5fc6`

```dockerfile
```

-	Layers:
	-	`sha256:e46460b2dc52b6b409dd2b3b0be914c89d66732c52971e28ebfcfa43471c60a8`  
		Last Modified: Sat, 20 Sep 2025 02:18:08 GMT  
		Size: 2.5 MB (2491911 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:441d3b789c82c7f478cb7f202f88bdc749202e30288800ca9d5ae0dc35ffca00`  
		Last Modified: Sat, 20 Sep 2025 02:18:09 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:c3837407d4d33d3aa9b4f867be627e20eda13a27181dfc7dc5bd487aa263d307
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.4 MB (187380897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a456f3f4dfb70d7785077af554a3f3adb3af522a5270e63065241b47976fcc0`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:7178bd3136964a5ac232fd51c15325cd3af99b4d6c01ea0247d6301439d56932
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2502987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bfd98c468f6bafc3d4e85d150b1e3ce66f348d467a92292136376de24af2a4f`

```dockerfile
```

-	Layers:
	-	`sha256:57147c53f31af4dd45675c3b16ddc67bcf5ed304878b32b7c71eb1fb1d4e5328`  
		Last Modified: Sat, 20 Sep 2025 00:12:51 GMT  
		Size: 2.5 MB (2481830 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0b91578b8199705f86d684af1b2fc010d84935a62dbed738e86893d45b568d43`  
		Last Modified: Sat, 20 Sep 2025 00:12:52 GMT  
		Size: 21.2 KB (21157 bytes)  
		MIME: application/vnd.in-toto+json
