...
```console
$ docker pull eclipse-temurin@sha256:94b63d82f9fd6ec2a2beba56be8b85941e0d4d600e429545c7a4a01170a65364
```
...
```console
$ docker pull eclipse-temurin@sha256:378da5564ca9d5e4709823fabc2d34845d097f256e2ed2bf589811f144306898
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.0 MB (224992929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff5809f46b82acf5a8365c471b92e622dc18dadf706b48cc7c138cd7e3917ac3`
...
```console
$ docker pull eclipse-temurin@sha256:968fdb311224a341142ba72cdc802c48a19673c3c8553815d821ba4f9151675c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2499149 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fec62647631d1f381c3d89f9ead347cd2898bcc655445cacd9880d0d123a9c5`

```dockerfile
```

-	Layers:
	-	`sha256:d8393aea2ce84d01f3d541ba54190d797ea60a257f6c9b8ee95222120a2c0142`  
		Last Modified: Fri, 19 Sep 2025 23:22:32 GMT  
		Size: 2.5 MB (2478016 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:47d3ea01f99787958045f6522fbed6f020e6a9234cf81a2ade9524801de9fa1d`  
		Last Modified: Fri, 19 Sep 2025 23:22:33 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:2b116ddc5ec0ca111a372f37b203c603b4cfcfbd32538b24bac2298197da68e8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.0 MB (221964619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:330701c855a189960066353d0d6687a28f29d5fa181ae42683d657d41cce556b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:81a3bafecf28e1f65cb2e3d6d530f53cdb1f3c9a7d5e8ca4c914f2014ca6df8f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2498637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a66cc7fc598447cd5068856a0babc88e1d1abae10f57366034912921e7a52547`

```dockerfile
```

-	Layers:
	-	`sha256:9041ac9f0ff075d27321846ed3df0a66d66bc6e04018c0c862c6a2fd10770ea8`  
		Last Modified: Fri, 19 Sep 2025 23:22:38 GMT  
		Size: 2.5 MB (2477388 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:dc48abe11c25d4d08d13e0281b940650fb41ae647f765c4fbf56ba7a7302892d`  
...
```console
$ docker pull eclipse-temurin@sha256:fb8816788746a9355f0c2928106f0eb2987477c66d07d56c799c20b079eb530e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.0 MB (231980265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7de733ed520d7865bff69f070d5bce9e5b0ed4b0d5a6ab7845733155b4e2def`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:826d4f39cbc86ec7e7940f9785f219e688377c8df1b59ffa2cc67be3a8f010bf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2497279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcb15450bc00e67a8e5998f47c4b0d86b1ea144e1ad42bb36953179319645e55`

```dockerfile
```

-	Layers:
	-	`sha256:8ffad260497fa5729720947631dc489f9d3892646946752fd5fa9d06c0b5c5db`  
		Last Modified: Sat, 20 Sep 2025 02:21:27 GMT  
		Size: 2.5 MB (2476110 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4d04b5c10b66fb9659c3ba8f74f856e368e1fc140139ed246a0fcb029a8063bb`  
		Last Modified: Sat, 20 Sep 2025 02:21:28 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:94bc3a8b48ccd15f69080458c661fe3f01f2387c6d23ca54df85f001159bbda5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.4 MB (212376472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a93d11f29d6a4f4342f5791965521fb17568825222f139155637d6438f4ea7be`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:8a94e1ad3ed3e4542cac1ccec81f350bd636952039f824fdc7cb4830f3c953eb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.5 MB (2486543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29a55dd048beb542faae2807720a471263866c824925a7a02a9292913593e113`

```dockerfile
```

-	Layers:
	-	`sha256:315c6ff253327fafce6a63f34b3a10a5ed357d6d2f1ae076a7f43457a3f22cf2`  
		Last Modified: Fri, 19 Sep 2025 23:22:32 GMT  
		Size: 2.5 MB (2465410 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f8afb80802c069e0d964b038b98a548cb5bcc3b38210a0daa55251c95373400a`  
		Last Modified: Fri, 19 Sep 2025 23:22:33 GMT  
		Size: 21.1 KB (21133 bytes)  
		MIME: application/vnd.in-toto+json
