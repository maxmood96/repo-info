...
### `eclipse-temurin:22-jdk-noble` - linux; amd64
...
### `eclipse-temurin:22-jdk-noble` - linux; arm64 variant v8
...
### `eclipse-temurin:22-jdk-noble` - linux; ppc64le
...
### `eclipse-temurin:22-jdk-noble` - linux; s390x
