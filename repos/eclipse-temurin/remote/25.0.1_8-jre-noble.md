...
```console
$ docker pull eclipse-temurin@sha256:0e3a8bcb838ce09b18a6176b675133f918f80863c9d463f9c581492cdfac86d9
```
...
### `eclipse-temurin:25.0.1_8-jre-noble` - linux; amd64
...
### `eclipse-temurin:25.0.1_8-jre-noble` - unknown; unknown
...
### `eclipse-temurin:25.0.1_8-jre-noble` - linux; arm64 variant v8
...
### `eclipse-temurin:25.0.1_8-jre-noble` - linux; ppc64le
...
### `eclipse-temurin:25.0.1_8-jre-noble` - linux; s390x
