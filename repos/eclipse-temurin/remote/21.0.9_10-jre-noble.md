...
```console
$ docker pull eclipse-temurin@sha256:d3eb69add1874bc785382d6282db53a67841f602a1139dee6c4a1221d8c56568
```
...
### `eclipse-temurin:21.0.9_10-jre-noble` - linux; amd64
...
### `eclipse-temurin:21.0.9_10-jre-noble` - unknown; unknown
...
### `eclipse-temurin:21.0.9_10-jre-noble` - linux; arm64 variant v8
...
### `eclipse-temurin:21.0.9_10-jre-noble` - linux; ppc64le
...
### `eclipse-temurin:21.0.9_10-jre-noble` - linux; riscv64
...
### `eclipse-temurin:21.0.9_10-jre-noble` - linux; s390x
