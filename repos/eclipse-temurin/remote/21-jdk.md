...
```console
$ docker pull eclipse-temurin@sha256:1f64d3e6c88850f2d88982c561954683803e1dec8894e85cda1d1df89de93454
```
...
```console
$ docker pull eclipse-temurin@sha256:8b27700a44813a93808f0543660321a15a47fdd85f0699f1efca096c317e4648
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.3 MB (193318798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d26f9a80e6463c79c504ca0f6898ad5e9ee05f3b057eb978e718bc9a8bb47193`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
### `eclipse-temurin:21-jdk` - windows version 10.0.20348.2340; amd64
...
### `eclipse-temurin:21-jdk` - windows version 10.0.17763.5576; amd64
