...
```console
$ docker pull eclipse-temurin@sha256:f71b4cab6bfd7e6a9885ff38a58ea20ecd1300bea3955a3af465ebafa020a5b3
```
...
```console
$ docker pull eclipse-temurin@sha256:d0861e686aa44dcca542877aaedf7d276762cc5c85a072dfdf2391b7defc4f08
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **101.1 MB (101092589 bytes)**  
...
```console
$ docker pull eclipse-temurin@sha256:73412ed91b4346910fe1a9bb085e2b72a44571aebf0a7c4ac5078312636d354d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4108515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37fcc850e6b05b19c8c324a2f4274fbb325e2a8e4ffa35d858e949f3a835590e`

```dockerfile
```

-	Layers:
	-	`sha256:3623365950eb82db8381a1d0bda1f74d30d071acab30494b486c78463f622384`  
		Last Modified: Fri, 15 May 2026 21:15:31 GMT  
		Size: 4.1 MB (4086084 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ec66754c42d3de9c8ad59edb792777936a91de34670e34a4bbe4b1b762a8bbc7`  
		Last Modified: Fri, 15 May 2026 21:15:31 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:ab451dfe63c4619f066e9e70762f88cdc83414a8bc23b86f7428f2755682d73b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.3 MB (93285500 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6237caf1b131dcbd9dca33a391a5720cb2dfbd64ffe54e6f99f2988658875d8f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:7992ef08a51fc737d9e2f21aae0a68a0154c1f9e7ab48f4308a0bdc5e52fe693
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4112612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a8180a466cf478abab5cd0bbc5902a6733a332535897ea6a2bf5650616ae95c`

```dockerfile
```

-	Layers:
	-	`sha256:6f0000b471eb4eff9ebd399abe2ffbd8edd45dc018c6c808b3ff9697719e72cf`  
		Last Modified: Fri, 15 May 2026 21:11:52 GMT  
		Size: 4.1 MB (4090083 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3a52ab4a8153c738b0533fa5ba6b3ebf386087a43b6a815a52e923abcd45d5ce`  
		Last Modified: Fri, 15 May 2026 21:11:52 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:4fafd08ae76dd19018977ef5305645bb1890c37960c3960918808edc39639d68
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.0 MB (97962887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb711b2241b8dd9c92825c7e838c796ba6db442049733e3f80f33e0ef98b87bd`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:e8adb6a2ac7a9d5d474c50ca031493008a64e93c2107b8fd1e763cb5c174097c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4109005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85548215c5bcda4cc01093d2d2b16c734da76d3388186d5ea0897b327e689544`

```dockerfile
```

-	Layers:
	-	`sha256:524d17045060dff701844be4a623d9abe4115a23dcf56b887217969fd0c217df`  
		Last Modified: Fri, 15 May 2026 21:15:49 GMT  
		Size: 4.1 MB (4086452 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:36717b0820dd08993051ede6ad75f85901b0a7a5c87dff14f0bb87bbe1a956f9`  
		Last Modified: Fri, 15 May 2026 21:15:49 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:b1623aad1d72989db1c31145d11101ecee13d6b176b5c5ced4dc8bbc9d0b0d72
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.9 MB (104945546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dad46756d1ff91dfb48c643c601d53083d48283b5d728ec54561068d8ba2c55c`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
...
```console
$ docker pull eclipse-temurin@sha256:9a4b936a7533d915da113e51d27c33c4feefe0052dc401eee5217bf77b38c0ed
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.1 MB (4111312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c940d5b18dd32b8cc0f18b987e1871f66c85dc7b1345ef52e655766298be55a`

```dockerfile
```

-	Layers:
	-	`sha256:8588b3348b4c0ecc19307af9f1ec661d5107b370d1f9800af84a49cbcd5e3432`  
		Last Modified: Fri, 15 May 2026 21:10:50 GMT  
		Size: 4.1 MB (4088839 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1c42e7d658d9ea27e871d888076a235ea3788e20cd0dbdfeb7dd8fe212a81647`  
		Last Modified: Fri, 15 May 2026 21:10:50 GMT  
