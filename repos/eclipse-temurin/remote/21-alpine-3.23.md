...
```console
$ docker pull eclipse-temurin@sha256:c98f0d2e171c898bf896dc4166815d28a56d428e218190a1f35cdc7d82efd61f
```
...
```console
$ docker pull eclipse-temurin@sha256:fd10ef3691adde33aa57cd1070eedd4ecbe7eff025e0bc82503fdd15e0e70f47
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183298158 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b060c8487c875dd2375caab8423cb7eefee56a1e328181ce90272aaf9390c29`
...
```console
$ docker pull eclipse-temurin@sha256:a2c200d2a024cb73b57c1392a694bb72c559f716dc4275f13f2cfd2afe0682ae
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.1 MB (1130859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d860781568dfa46f023e101358a939864fdb4be7adf85b8f0bb34439bf3ac681`

```dockerfile
```

-	Layers:
	-	`sha256:7e4b602ee7e19524601974f2d855cd3ecca699a11c0a2fcabbe6384988f1c1f1`  
		Last Modified: Thu, 05 Feb 2026 22:19:35 GMT  
		Size: 1.1 MB (1109441 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:110e35c739667d01a5d1fd5250e1338b6adc88e0852823ff4d6c3b1519c18cf6`  
		Last Modified: Thu, 05 Feb 2026 22:19:35 GMT  
...
```console
$ docker pull eclipse-temurin@sha256:0e1c1bd03c6fadd9ae7c5e7d7b6b363a41287350a665341d461023da8c4de86d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181641908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06c90b4d2755ec9c8492544bd2c87b035ee7177976a686d0b019681660ddef53`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["jshell"]`
...
```console
$ docker pull eclipse-temurin@sha256:49d937bf8879c90e6cefc91ee66ac10ae1317eed00e47c7737d47fe438a5fcb6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **1.3 MB (1280405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2be2b05ae678baf6b6b26353592968dd8190a997e922e4f859baa82e681fd84c`

```dockerfile
```

-	Layers:
	-	`sha256:793547d3c8f4057cc7e8e726b154fcb674044a4454c8f281b1effca269fd377b`  
		Last Modified: Thu, 05 Feb 2026 22:18:34 GMT  
		Size: 1.3 MB (1258829 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3967e698e1d49954e898988106d6127b37e5844ee0a6b2b6f3af48e5a70116f1`  
		Last Modified: Thu, 05 Feb 2026 22:18:34 GMT  
