...
### `httpd:2.4.63-alpine3.22` - linux; amd64
...
### `httpd:2.4.63-alpine3.22` - unknown; unknown
...
### `httpd:2.4.63-alpine3.22` - linux; arm variant v6
...
### `httpd:2.4.63-alpine3.22` - linux; arm variant v7
...
### `httpd:2.4.63-alpine3.22` - linux; arm64 variant v8
...
### `httpd:2.4.63-alpine3.22` - linux; 386
...
### `httpd:2.4.63-alpine3.22` - linux; ppc64le
...
### `httpd:2.4.63-alpine3.22` - linux; riscv64
...
### `httpd:2.4.63-alpine3.22` - linux; s390x
