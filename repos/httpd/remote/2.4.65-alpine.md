...
### `httpd:2.4.65-alpine` - linux; amd64
...
### `httpd:2.4.65-alpine` - unknown; unknown
...
### `httpd:2.4.65-alpine` - linux; arm variant v6
...
### `httpd:2.4.65-alpine` - linux; arm variant v7
...
### `httpd:2.4.65-alpine` - linux; arm64 variant v8
...
### `httpd:2.4.65-alpine` - linux; ppc64le
...
### `httpd:2.4.65-alpine` - linux; riscv64
...
### `httpd:2.4.65-alpine` - linux; s390x
