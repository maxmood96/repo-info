...
### `dpkg` source package: `ca-certificates-java=20230710~deb12u1`
...
```console
$ apt-get source -qq --print-uris ca-certificates-java=20230710~deb12u1
'http://deb.debian.org/debian/pool/main/c/ca-certificates-java/ca-certificates-java_20230710%7edeb12u1.dsc' ca-certificates-java_20230710~deb12u1.dsc 1930 SHA256:57a9912fef237a20f73f86abc348f368a056a334178ac835f7c29d8088c26f14
'http://deb.debian.org/debian/pool/main/c/ca-certificates-java/ca-certificates-java_20230710%7edeb12u1.tar.xz' ca-certificates-java_20230710~deb12u1.tar.xz 18464 SHA256:cb899d38b6518a0240fb744d6ac69f891c00307a86837dc3992d2e184ca1699a
```

Other potentially useful URLs:

- https://sources.debian.net/src/ca-certificates-java/20230710~deb12u1/ (for browsing the source)
- https://sources.debian.net/src/ca-certificates-java/20230710~deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ca-certificates-java/20230710~deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `nspr=2:4.35-1`
...
```console
$ apt-get source -qq --print-uris nspr=2:4.35-1
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.35-1.dsc' nspr_4.35-1.dsc 2000 SHA256:29dd6c0844a50ae4ea86d14345cfceaafd3696d453eb3ef366d5705b581cef97
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.35.orig.tar.gz' nspr_4.35.orig.tar.gz 1096974 SHA256:7ea3297ea5969b5d25a5dd8d47f2443cda88e9ee746301f6e1e1426f8a6abc8f
'http://deb.debian.org/debian/pool/main/n/nspr/nspr_4.35-1.debian.tar.xz' nspr_4.35-1.debian.tar.xz 11220 SHA256:e84ddbe388d60d135f753a6a5593f46acfda16bdc9c92af18470014c067f0f5a
```

Other potentially useful URLs:

- https://sources.debian.net/src/nspr/2:4.35-1/ (for browsing the source)
- https://sources.debian.net/src/nspr/2:4.35-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nspr/2:4.35-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `nss=2:3.87.1-1+deb12u1`
...
```console
$ apt-get source -qq --print-uris nss=2:3.87.1-1+deb12u1
'http://deb.debian.org/debian/pool/main/n/nss/nss_3.87.1-1%2bdeb12u1.dsc' nss_3.87.1-1+deb12u1.dsc 2202 SHA256:0d616e6f1b1315f9a9db5a1eb78d7abba03f32b742d818311c014a72d7934a2a
'http://deb.debian.org/debian/pool/main/n/nss/nss_3.87.1.orig.tar.gz' nss_3.87.1.orig.tar.gz 71430196 SHA256:f30fb0de6986e59420ce3bfea340e801222be1da144b420bcbfec1d977dab4d5
'http://deb.debian.org/debian/pool/main/n/nss/nss_3.87.1-1%2bdeb12u1.debian.tar.xz' nss_3.87.1-1+deb12u1.debian.tar.xz 20440 SHA256:20247aea994ee740c40f58ed0c4b758c843d3c9ed7cb4559051f1c00bdb83fdd
```

Other potentially useful URLs:

- https://sources.debian.net/src/nss/2:3.87.1-1+deb12u1/ (for browsing the source)
...
### `dpkg` source package: `openjdk-17=17.0.16+8-1~deb12u1`
...
```console
$ apt-get source -qq --print-uris openjdk-17=17.0.16+8-1~deb12u1
'http://deb.debian.org/debian-security/pool/updates/main/o/openjdk-17/openjdk-17_17.0.16%2b8-1%7edeb12u1.dsc' openjdk-17_17.0.16+8-1~deb12u1.dsc 4900 SHA256:e1198e597b0dcfc88303589b5f91f825301299bebeee0b02713e04a9eb608bc1
'http://deb.debian.org/debian-security/pool/updates/main/o/openjdk-17/openjdk-17_17.0.16%2b8.orig-googletest.tar.xz' openjdk-17_17.0.16+8.orig-googletest.tar.xz 616652 SHA256:c2013181c6fbd98d7aa2b868ee6dec7ca24f0ebee05f6b074a420b0910866f38
'http://deb.debian.org/debian-security/pool/updates/main/o/openjdk-17/openjdk-17_17.0.16%2b8.orig.tar.xz' openjdk-17_17.0.16+8.orig.tar.xz 63602644 SHA256:d65e6d5c78bc89cefe7d726c076359578399d21f4fd44b5d2186b2f5e427dfc1
'http://deb.debian.org/debian-security/pool/updates/main/o/openjdk-17/openjdk-17_17.0.16%2b8-1%7edeb12u1.debian.tar.xz' openjdk-17_17.0.16+8-1~deb12u1.debian.tar.xz 204900 SHA256:166e4e43474be93fcdce31d80c992595437d2737eede5c62f2f2449ca50b5de8
```

Other potentially useful URLs:

- https://sources.debian.net/src/openjdk-17/17.0.16+8-1~deb12u1/ (for browsing the source)
- https://sources.debian.net/src/openjdk-17/17.0.16+8-1~deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openjdk-17/17.0.16+8-1~deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pcsc-lite=1.9.9-2`
...
```console
$ apt-get source -qq --print-uris pcsc-lite=1.9.9-2
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_1.9.9-2.dsc' pcsc-lite_1.9.9-2.dsc 2333 SHA256:7f41763f994336ce4371b5a67fefda900c7f3e61b52e3acb77b3a70632869cba
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_1.9.9.orig.tar.bz2' pcsc-lite_1.9.9.orig.tar.bz2 789914 SHA256:cbcc3b34c61f53291cecc0d831423c94d437b188eb2b97b7febc08de1c914e8a
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_1.9.9.orig.tar.bz2.asc' pcsc-lite_1.9.9.orig.tar.bz2.asc 833 SHA256:387dfea1c79ecae42ec82f5ce401117700b578f4fd25f73af38df438e44f66f7
'http://deb.debian.org/debian/pool/main/p/pcsc-lite/pcsc-lite_1.9.9-2.debian.tar.xz' pcsc-lite_1.9.9-2.debian.tar.xz 19408 SHA256:c2655a7e6caf14f7f29345ccc98b61db30f2eb4e6cdea9349f649673a0825eb3
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcsc-lite/1.9.9-2/ (for browsing the source)
- https://sources.debian.net/src/pcsc-lite/1.9.9-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pcsc-lite/1.9.9-2/ (for access to the source package after it no longer exists in the archive)
