...
### `dpkg` source package: `linux-base=4.12.1`

Binary Packages:

- `linux-sysctl-defaults=4.12.1`

Licenses: (parsed from: `/usr/share/doc/linux-sysctl-defaults/copyright`)
...
```console
$ apt-get source -qq --print-uris linux-base=4.12.1
'http://deb.debian.org/debian/pool/main/l/linux-base/linux-base_4.12.1.dsc' linux-base_4.12.1.dsc 1754 SHA256:4940b5cc720d791c6a8d23c7d060c4a80941707140913924c29974753baccc8b
'http://deb.debian.org/debian/pool/main/l/linux-base/linux-base_4.12.1.tar.xz' linux-base_4.12.1.tar.xz 29524 SHA256:453e136acc4568f02319795d0280ee32e792fb46a1e79b361b720cb70abe9c58
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux-base/4.12.1/ (for browsing the source)
- https://sources.debian.net/src/linux-base/4.12.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux-base/4.12.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mozjs128=128.14.0-1~deb13u1`

Binary Packages:

- `libmozjs-128-0:amd64=128.14.0-1~deb13u1`

Licenses: (parsed from: `/usr/share/doc/libmozjs-128-0/copyright`)
...
```console
$ apt-get source -qq --print-uris mozjs128=128.14.0-1~deb13u1
'http://deb.debian.org/debian/pool/main/m/mozjs128/mozjs128_128.14.0-1%7edeb13u1.dsc' mozjs128_128.14.0-1~deb13u1.dsc 2448 SHA256:0bb78fc07665cafb45b0659644cc7b812ef306cae470b6a0c89b9dc7e0d34d8b
'http://deb.debian.org/debian/pool/main/m/mozjs128/mozjs128_128.14.0.orig.tar.xz' mozjs128_128.14.0.orig.tar.xz 157263392 SHA256:41cca35149710ce45fbabc5fefcf86a01fdf833fdb783941964fca3a55fb72dd
'http://deb.debian.org/debian/pool/main/m/mozjs128/mozjs128_128.14.0-1%7edeb13u1.debian.tar.xz' mozjs128_128.14.0-1~deb13u1.debian.tar.xz 53764 SHA256:39bd9cb8abb66e2dc5b2b2a8fe7df1f55307e48a0155a9c2a3d698bac0b25b3b
```

Other potentially useful URLs:

- https://sources.debian.net/src/mozjs128/128.14.0-1~deb13u1/ (for browsing the source)
- https://sources.debian.net/src/mozjs128/128.14.0-1~deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mozjs128/128.14.0-1~deb13u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `psmisc=23.7-2`
...
```console
$ apt-get source -qq --print-uris psmisc=23.7-2
'http://deb.debian.org/debian/pool/main/p/psmisc/psmisc_23.7-2.dsc' psmisc_23.7-2.dsc 1892 SHA256:1b17a803e533be2e0244f62fe73da1174e4e1fbdc5709c908c022fcb6be1d42a
'http://deb.debian.org/debian/pool/main/p/psmisc/psmisc_23.7.orig.tar.xz' psmisc_23.7.orig.tar.xz 432208 SHA256:58c55d9c1402474065adae669511c191de374b0871eec781239ab400b907c327
'http://deb.debian.org/debian/pool/main/p/psmisc/psmisc_23.7-2.debian.tar.xz' psmisc_23.7-2.debian.tar.xz 8620 SHA256:7d9c737c6eb6aefbe04f65a3ff4425ffee75c43068ba4bd1d928664121bd3e72
```

Other potentially useful URLs:

- https://sources.debian.net/src/psmisc/23.7-2/ (for browsing the source)
- https://sources.debian.net/src/psmisc/23.7-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/psmisc/23.7-2/ (for access to the source package after it no longer exists in the archive)
