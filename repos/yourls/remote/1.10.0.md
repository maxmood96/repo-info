...
```console
$ docker pull yourls@sha256:a4f26dc3714f008d2fc2b38bdfe2859db5cb4ab8ddee5138769f7c8e4250ad44
```
...
### `yourls:1.10.0` - linux; arm variant v5
...
### `yourls:1.10.0` - linux; arm variant v7
...
### `yourls:1.10.0` - linux; arm64 variant v8
