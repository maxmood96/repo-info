...
```console
$ docker pull yourls@sha256:082e8184bad9c046b054d7d448e58a87e5c49ff2e00013a35c7cb16b72cf23b7
```
...
```console
$ docker pull yourls@sha256:a5273d4174edf5fae3c79c76df3d96437bd828423be80cd29fa899e1671d9ed5
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.6 MB (177573587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1f36398b46205268e7f930fac665f9c7f28cdcd4da95beba34a2346d2c4d075`
-	Entrypoint: `["container-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Jul 2024 02:49:18 GMT
CMD ["php-fpm"]
# Tue, 02 Jul 2024 07:35:20 GMT
RUN set -eux;     docker-php-ext-install -j "$(nproc)" bcmath opcache pdo_mysql mysqli
# Tue, 02 Jul 2024 07:35:21 GMT
RUN {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=2';         echo 'opcache.fast_shutdown=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 02 Jul 2024 07:35:21 GMT
ARG YOURLS_VERSION=1.9.2
# Tue, 02 Jul 2024 07:35:21 GMT
...
# Tue, 02 Jul 2024 07:35:21 GMT
ENV YOURLS_SHA256=62a95ba766d62f3305d75944cbfe12d5a90c08c88fbf2f6e67150d36412b916f
# Tue, 02 Jul 2024 07:35:23 GMT
RUN set -eux;     curl -o yourls.tar.gz -fsSL "https://github.com/YOURLS/YOURLS/archive/${YOURLS_VERSION}.tar.gz";     echo "$YOURLS_SHA256 *yourls.tar.gz" | sha256sum -c -;     tar -xf yourls.tar.gz -C /usr/src/;     mv "/usr/src/YOURLS-${YOURLS_VERSION}" /usr/src/yourls;     rm yourls.tar.gz;     chown -R www-data:www-data /usr/src/yourls
# Tue, 02 Jul 2024 07:35:23 GMT
COPY --chown=www-data:www-datafile:407fa98e3948ea07c2ff8bc30ad1b3b7b28a1c2b9b5d8e5ab87f9b317a2bac85 in /usr/src/yourls/user/ 
# Tue, 02 Jul 2024 07:35:23 GMT
COPY file:50b4d483341578e719ad63fd7aaea99a0d6d7cebfb7b43d6098a656a975ee0e3 in /usr/local/bin/ 
# Tue, 02 Jul 2024 07:35:24 GMT
ENTRYPOINT ["container-entrypoint.sh"]
# Tue, 02 Jul 2024 07:35:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a7a7671bedb15cca1f007e96869afc191d7e9460e58ac5887f2481bc0a141d8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32b32868111f1cd2668392d91548f29d8b051df72da92a1fc0ad3c8ed5d69d23`  
		Last Modified: Tue, 02 Jul 2024 07:36:15 GMT  
		Size: 506.3 KB (506348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dc678f9a7da80563189f68f98f167356ad7ce8d99e5868ea5a296b38896f710`  
		Last Modified: Tue, 02 Jul 2024 07:36:14 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f996f856253c076fd0aab4b69bf68e22af0c826a3295a83c5b08f6d228dab271`  
		Last Modified: Tue, 02 Jul 2024 07:36:15 GMT  
		Size: 4.1 MB (4073447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31c5f324a916fb898b9f3e1627e852b7b8fa618a44d56e5bc24387f409650fd3`  
		Last Modified: Tue, 02 Jul 2024 07:36:14 GMT  
		Size: 2.0 KB (2047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c39c3ad6e5124dec6775851705147ea9b25f7292e20114e579cb0429f7ba4f02`  
		Last Modified: Tue, 02 Jul 2024 07:36:14 GMT  
