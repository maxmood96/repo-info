...
```console
$ docker pull yourls@sha256:40078ccb77cb4eedc40a57a125f6518ae1d30f40cf8a939ce61a4ad25feb71e4
```
...
```console
$ docker pull yourls@sha256:0f684a5f99ec3a29b6d23aeb47dcde725297fc55bb3ad01b0dee569539344c4e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.8 MB (183752174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1dcf765f087dd3d6525ce66334eb561d5d2cf15e741f84b1f51a441ebff7660e`
-	Entrypoint: `["container-entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 17 Mar 2026 00:15:57 GMT
CMD ["apache2-foreground"]
# Tue, 17 Mar 2026 06:02:11 GMT
RUN set -eux;     docker-php-ext-install -j "$(nproc)"     bcmath     pdo_mysql     mysqli # buildkit
# Tue, 17 Mar 2026 06:02:11 GMT
RUN {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=2';         echo 'opcache.fast_shutdown=1';     } > "$PHP_INI_DIR/conf.d/opcache-recommended.ini" # buildkit
# Tue, 17 Mar 2026 06:02:12 GMT
RUN a2enmod rewrite expires # buildkit
# Tue, 17 Mar 2026 06:02:17 GMT
ARG YOURLS_VERSION=1.10.3
# Tue, 17 Mar 2026 06:02:17 GMT
ARG YOURLS_SHA256=71749ae9b3950d6a7c043b1240aba8645e912c3c22eac5abfb6ae3cc576ff740
# Tue, 17 Mar 2026 06:02:17 GMT
...
# ARGS: YOURLS_VERSION=1.10.3 YOURLS_SHA256=71749ae9b3950d6a7c043b1240aba8645e912c3c22eac5abfb6ae3cc576ff740
RUN set -eux;     curl -o yourls.tar.gz -fsSL "https://github.com/YOURLS/YOURLS/archive/${YOURLS_VERSION}.tar.gz";     echo "$YOURLS_SHA256 *yourls.tar.gz" | sha256sum -c -;     tar -xf yourls.tar.gz -C /usr/src/;     mv "/usr/src/YOURLS-${YOURLS_VERSION}" /usr/src/yourls;     rm yourls.tar.gz;     chown -R www-data:www-data /usr/src/yourls # buildkit
# Tue, 17 Mar 2026 06:02:18 GMT
COPY --chown=www-data:www-data config-container.php /usr/src/yourls/user/ # buildkit
# Tue, 17 Mar 2026 06:02:20 GMT
COPY container-entrypoint.sh /usr/local/bin/ # buildkit
# Tue, 17 Mar 2026 06:02:21 GMT
COPY files/vhost.conf /etc/apache2/sites-available/000-default.conf # buildkit
# Tue, 17 Mar 2026 06:02:22 GMT
COPY files/vhost-https.conf /etc/apache2/sites-available/default-ssl.conf # buildkit
# Tue, 17 Mar 2026 06:02:23 GMT
COPY files/ports.conf /etc/apache2/ports.conf # buildkit
# Tue, 17 Mar 2026 06:02:23 GMT
EXPOSE map[8080/tcp:{}]
# Tue, 17 Mar 2026 06:02:23 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:024cdb7c0c1d257234c3d19577f2cac2b99612217418a64b8dd4266714bcbec5`  
		Last Modified: Tue, 17 Mar 2026 06:02:32 GMT  
		Size: 117.3 KB (117320 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:baa65732ea943cef453f6a3fb83930009ff330e326de6a524f0449feaca6dd46`  
		Last Modified: Tue, 17 Mar 2026 06:02:31 GMT  
		Size: 326.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2082c361b9f29dd49eacf3596ce473ef85b64ba92246986eae457ab475b126db`  
		Last Modified: Tue, 17 Mar 2026 06:02:31 GMT  
		Size: 346.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d76a38f7979ace7e2aeec99f1d483d4d4e49e94a65ee4313e8425971d8c6926c`  
		Last Modified: Tue, 17 Mar 2026 06:02:32 GMT  
		Size: 6.0 MB (6048924 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e9b5cc0da36cb34acaa69cffbc6122940c45e82bfa65cbe144e808b3a04c963b`  
		Last Modified: Tue, 17 Mar 2026 06:02:33 GMT  
		Size: 2.1 KB (2094 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:97f2f8bf1355b1af8de9284d51f09223fc754ed03b55528b7f85450ad43423fd`  
		Last Modified: Tue, 17 Mar 2026 06:02:33 GMT  
		Size: 1.7 KB (1691 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:80a5bd4e51ebdf8b109b0db24209f32db680682abef4a8bf868ab4171a180d3d`  
		Last Modified: Tue, 17 Mar 2026 06:02:33 GMT  
		Size: 500.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7ad60b68b020989b4d2656d5efd487930423e156f53c6c857457fca3f7a7c13c`  
		Last Modified: Tue, 17 Mar 2026 06:02:33 GMT  
		Size: 546.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a1c19d7efdff592bc3e5300fa52bc7d175d6c83ef1af230d5045eb342fe54851`  
		Last Modified: Tue, 17 Mar 2026 06:02:34 GMT  
		Size: 327.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull yourls@sha256:c287eaa57d3e16ee12c95fa218e1dae9aa71280fa375229ac8c870f4e5dc24eb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.7 KB (47662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39c5f866dbf2e8022ddc21df7a6ce297c9a85e50e681e5ea5ea1a679f27101fa`

```dockerfile
```

-	Layers:
	-	`sha256:c8a65cb9a77209a9235eb4ca54453ae3f9c0f944f7654c88b193a2ff5015b7ac`  
		Last Modified: Tue, 17 Mar 2026 06:02:31 GMT  
