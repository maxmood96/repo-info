...
```console
$ docker pull yourls@sha256:bf667cfe0b31e9d1a8fd397a8ba141cd8b839740434563e875ee7f9717a6be4b
```
...
```console
$ docker pull yourls@sha256:4065204ba90e877782c7de1c8ce390c5be4a3d5ae91bf757d48c1df9dc5eba38
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32464336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84421f06dd6c6fd545d6c31b9bbf9ba17a3131cdd183224df74fbf55a945c4f9`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 30 Jul 2021 00:54:55 GMT
RUN set -eux;     docker-php-ext-install -j "$(nproc)" bcmath opcache pdo_mysql mysqli
# Fri, 30 Jul 2021 00:54:57 GMT
RUN {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=60';         echo 'opcache.fast_shutdown=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 00:54:59 GMT
RUN apk add --no-cache bash
# Fri, 30 Jul 2021 00:55:00 GMT
ENV YOURLS_VERSION=1.8.1
# Fri, 30 Jul 2021 00:55:00 GMT
ENV YOURLS_SHA256=92b0666af3e3ad4a783e78cba93687e9a24acf216606a6d457819c5d36d2cfe4
...
-	Layers:
	...
	-	`sha256:9dc4292852576ae0f03aefbd2770552de2709914f74a937911f4b60ef9ccb26d`  
		...
		Size: 8.6 KB (8570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:740121694bcc9d5e219c7ed98cd7095291626ee2790ce0e891c89accbb80776f`  
		Last Modified: Fri, 30 Jul 2021 00:55:39 GMT  
		Size: 359.8 KB (359835 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8670cd1f5dcca84d74371828c2a282b197d9b9ba5ff96bc7744d21e1a64ca631`  
		Last Modified: Fri, 30 Jul 2021 00:55:37 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88fb0ad597a9d5a9192a4eefb5a738ab8a55bc7f3f36f45b982a441ecaf3072f`  
		Last Modified: Fri, 30 Jul 2021 00:55:38 GMT  
		Size: 570.8 KB (570787 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a5302cec285cd95be68ff1e2ecfcbdfaeaf3ed111378cf4f24077ceb4cede3`  
		Last Modified: Fri, 30 Jul 2021 00:55:40 GMT  
		Size: 2.6 MB (2572166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1aa8382f28c196223c512090bfa193a7341bc6bcb0bc360209e23b09b8df1ea`  
		Last Modified: Fri, 30 Jul 2021 00:55:38 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:213f9c35e85f3daf8026e8e7c73a3e838136112fa326a209d5130e97a469e75e`  
		Last Modified: Fri, 30 Jul 2021 00:55:37 GMT  
...
```console
$ docker pull yourls@sha256:1fc70053f812b7372f0320eeb77fd492081e425eaac8c0260be377c3e26e7ae0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.2 MB (31167904 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f713af59cff872814225607f9324080f696b4c9a5dbd5f1e47a31290a3479dc0`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 00:25:56 GMT
CMD ["php-fpm"]
# Fri, 30 Jul 2021 07:54:01 GMT
RUN set -eux;     docker-php-ext-install -j "$(nproc)" bcmath opcache pdo_mysql mysqli
# Fri, 30 Jul 2021 07:54:03 GMT
RUN {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=60';         echo 'opcache.fast_shutdown=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 07:54:05 GMT
RUN apk add --no-cache bash
# Fri, 30 Jul 2021 07:54:06 GMT
ENV YOURLS_VERSION=1.8.1
# Fri, 30 Jul 2021 07:54:06 GMT
ENV YOURLS_SHA256=92b0666af3e3ad4a783e78cba93687e9a24acf216606a6d457819c5d36d2cfe4
# Fri, 30 Jul 2021 07:54:09 GMT
RUN set -eux;     curl -o yourls.tar.gz -fsSL "https://github.com/YOURLS/YOURLS/archive/${YOURLS_VERSION}.tar.gz";     echo "$YOURLS_SHA256 *yourls.tar.gz" | sha256sum -c -;     tar -xf yourls.tar.gz -C /usr/src/;     mv "/usr/src/YOURLS-${YOURLS_VERSION}" /usr/src/yourls;     rm yourls.tar.gz;     chown -R www-data:www-data /usr/src/yourls
# Fri, 30 Jul 2021 07:54:10 GMT
COPY file:7bfc5a435dd9f76b0c1d23545b13f25bad15f4271d687c1a76bb5d10a41af1eb in /usr/local/bin/ 
# Fri, 30 Jul 2021 07:54:10 GMT
COPY file:0bcfdfe0566007e7477c55552a1341b82b958e95879a5314f411d2188da2429e in /usr/src/yourls/user/ 
# Fri, 30 Jul 2021 07:54:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Jul 2021 07:54:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4bcdfcb9f756ff9b07ed102e0d712c9dc3a6c1f9d291c4423176793ec382520d`  
		...
		Size: 8.6 KB (8570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b248b4a56179061c4fb5bdf851a14ca9914542434013fc47b0bfd61fcff83a77`  
		Last Modified: Fri, 30 Jul 2021 07:56:43 GMT  
		Size: 333.7 KB (333685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7798f34463490019048929c96c3575ce30d06eb99d9fa47607ae570c416e019b`  
		Last Modified: Fri, 30 Jul 2021 07:56:41 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:449db46e714ee629c6c83a64d2b9e92826bacb4cec2a9b2e4ecb01a13fd64617`  
		Last Modified: Fri, 30 Jul 2021 07:56:42 GMT  
		Size: 520.0 KB (519985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad44a36d78c1701aa9fed99eda761107637f594b4240eea57c6de4be0337de3e`  
		Last Modified: Fri, 30 Jul 2021 07:56:44 GMT  
		Size: 2.6 MB (2572160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf46de0e7be7954c63d3173368134fc2ec46bef841043d7fb2db35b9d224d58f`  
		Last Modified: Fri, 30 Jul 2021 07:56:41 GMT  
		Size: 1.2 KB (1184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d916a4effb7dd9fb438469fd302950eeff62985b06a0aa2d53b0a28c94ad7422`  
		Last Modified: Fri, 30 Jul 2021 07:56:41 GMT  
...
```console
$ docker pull yourls@sha256:1dec25e15c5725a3e638a2471252a6683f8e7d3f228a540f0e7cef23662d4e68
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.0 MB (34975595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79a58d9b6e73faf5e5e9fe70563bd2e9d345b6b13904ca72e13439134322ee6d`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 30 Jul 2021 09:45:07 GMT
RUN set -eux;     docker-php-ext-install -j "$(nproc)" bcmath opcache pdo_mysql mysqli
# Fri, 30 Jul 2021 09:45:27 GMT
RUN {         echo 'opcache.memory_consumption=128';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=4000';         echo 'opcache.revalidate_freq=60';         echo 'opcache.fast_shutdown=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 09:45:50 GMT
RUN apk add --no-cache bash
# Fri, 30 Jul 2021 09:45:57 GMT
ENV YOURLS_VERSION=1.8.1
# Fri, 30 Jul 2021 09:45:59 GMT
ENV YOURLS_SHA256=92b0666af3e3ad4a783e78cba93687e9a24acf216606a6d457819c5d36d2cfe4
# Fri, 30 Jul 2021 09:46:11 GMT
RUN set -eux;     curl -o yourls.tar.gz -fsSL "https://github.com/YOURLS/YOURLS/archive/${YOURLS_VERSION}.tar.gz";     echo "$YOURLS_SHA256 *yourls.tar.gz" | sha256sum -c -;     tar -xf yourls.tar.gz -C /usr/src/;     mv "/usr/src/YOURLS-${YOURLS_VERSION}" /usr/src/yourls;     rm yourls.tar.gz;     chown -R www-data:www-data /usr/src/yourls
# Fri, 30 Jul 2021 09:46:14 GMT
COPY file:7bfc5a435dd9f76b0c1d23545b13f25bad15f4271d687c1a76bb5d10a41af1eb in /usr/local/bin/ 
# Fri, 30 Jul 2021 09:46:16 GMT
COPY file:0bcfdfe0566007e7477c55552a1341b82b958e95879a5314f411d2188da2429e in /usr/src/yourls/user/ 
# Fri, 30 Jul 2021 09:46:19 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 30 Jul 2021 09:46:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c105b2a8d289fbf4a95e88c3eb457362808ceb152087233c452ded8fef7cbf81`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b620915a15bc489c99900ff5cacad190aaed181f70be2890758fc7cbcf625752`  
		Last Modified: Fri, 30 Jul 2021 09:48:35 GMT  
		Size: 422.7 KB (422696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14e460159456ac590cbf0f2500a826d769326fdb616aabf686f42dcdaf396ed0`  
		Last Modified: Fri, 30 Jul 2021 09:48:29 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:433525df7ff7d6ecc120f08a42031c8e639c5a80d2a792085a889b2078030b85`  
		Last Modified: Fri, 30 Jul 2021 09:48:30 GMT  
		Size: 663.1 KB (663055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8463e2ca62ed07db77c2ed93d5ed54c1b66fe8ac69f0974067916ec074e2777d`  
		Last Modified: Fri, 30 Jul 2021 09:48:30 GMT  
		Size: 2.6 MB (2572160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c5539b815099ff6ab96439e74b3ad0c5e1915e760f9e84cc3f1930a7c8a1074`  
		Last Modified: Fri, 30 Jul 2021 09:48:29 GMT  
		Size: 1.2 KB (1188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d369472054001a13fd2f88b7b39d124f912213120b092a9630fcfa0aed1e8613`  
		Last Modified: Fri, 30 Jul 2021 09:48:29 GMT  
