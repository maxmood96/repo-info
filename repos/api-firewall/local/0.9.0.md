...
```console
wget-1.25.0-r0 description:
Network utility to retrieve files from the Web

wget-1.25.0-r0 webpage:
https://www.gnu.org/software/wget/wget.html

wget-1.25.0-r0 installed size:
407 KiB

wget-1.25.0-r0 license:
