...
### `rust:1.94.1-alpine3.23` - linux; amd64
...
### `rust:1.94.1-alpine3.23` - unknown; unknown
...
### `rust:1.94.1-alpine3.23` - linux; arm64 variant v8
...
### `rust:1.94.1-alpine3.23` - linux; ppc64le
