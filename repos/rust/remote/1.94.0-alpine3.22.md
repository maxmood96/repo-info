...
### `rust:1.94.0-alpine3.22` - linux; amd64
...
### `rust:1.94.0-alpine3.22` - unknown; unknown
...
### `rust:1.94.0-alpine3.22` - linux; arm64 variant v8
...
### `rust:1.94.0-alpine3.22` - linux; ppc64le
