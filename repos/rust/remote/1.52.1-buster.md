...
```console
$ docker pull rust@sha256:889e774aa591ac92e43b6219a4292b98c8da1b298bc905eb1e2635adb5e4d56b
```
...
### `rust:1.52.1-buster` - linux; amd64
...
### `rust:1.52.1-buster` - linux; arm variant v7
...
### `rust:1.52.1-buster` - linux; arm64 variant v8
