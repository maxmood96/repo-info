...
### `rust:1.94.0-trixie` - linux; amd64
...
### `rust:1.94.0-trixie` - unknown; unknown
...
### `rust:1.94.0-trixie` - linux; arm variant v7
...
### `rust:1.94.0-trixie` - linux; arm64 variant v8
...
### `rust:1.94.0-trixie` - linux; ppc64le
...
### `rust:1.94.0-trixie` - linux; riscv64
...
### `rust:1.94.0-trixie` - linux; s390x
