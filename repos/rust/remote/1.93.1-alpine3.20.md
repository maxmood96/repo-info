...
### `rust:1.93.1-alpine3.20` - linux; amd64
...
### `rust:1.93.1-alpine3.20` - unknown; unknown
...
### `rust:1.93.1-alpine3.20` - linux; arm64 variant v8
...
### `rust:1.93.1-alpine3.20` - linux; ppc64le
