...
### `rust:1.96.1-alpine3.24` - linux; amd64
...
### `rust:1.96.1-alpine3.24` - unknown; unknown
...
### `rust:1.96.1-alpine3.24` - linux; arm64 variant v8
...
### `rust:1.96.1-alpine3.24` - linux; ppc64le
