...
```console
$ docker pull rust@sha256:1153c6fe815a704c0fb7ddfbc73774aa3fead24db88b4c3f6079b5b7a5bc1bdd
```
...
### `rust:1.56.0` - linux; arm64 variant v8
