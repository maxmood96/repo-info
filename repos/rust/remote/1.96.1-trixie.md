...
### `rust:1.96.1-trixie` - linux; amd64
...
### `rust:1.96.1-trixie` - unknown; unknown
...
### `rust:1.96.1-trixie` - linux; arm variant v7
...
### `rust:1.96.1-trixie` - linux; arm64 variant v8
...
### `rust:1.96.1-trixie` - linux; ppc64le
...
### `rust:1.96.1-trixie` - linux; riscv64
...
### `rust:1.96.1-trixie` - linux; s390x
