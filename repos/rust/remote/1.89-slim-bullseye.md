...
### `rust:1.89-slim-bullseye` - linux; amd64
...
### `rust:1.89-slim-bullseye` - unknown; unknown
...
### `rust:1.89-slim-bullseye` - linux; arm variant v7
...
### `rust:1.89-slim-bullseye` - linux; arm64 variant v8
...
### `rust:1.89-slim-bullseye` - linux; 386
