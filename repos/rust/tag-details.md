...
### `rust:1.68.0-alpine` - linux; amd64
...
### `rust:1.68.0-alpine3.17` - linux; amd64
...
### `rust:1.68.0-slim-bookworm` - linux; amd64
...
### `rust:1.68.0-slim-bullseye` - linux; amd64
