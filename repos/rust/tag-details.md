...
```console
$ docker pull rust@sha256:9992f015849e9fa5e586578b949461c0ef9541e0d48b9327a70312ea1a97d2c7
```
...
### `rust:1.77.1-bullseye` - linux; 386
...
### `rust:1.77.1-slim-bookworm` - linux; 386
...
### `rust:1.77.1-slim-bullseye` - linux; 386
