...
- Created: `2024-01-11T12:04:55.139365501Z`
...
### `dpkg` source package: `curl=7.64.0-4+deb10u8`

Binary Packages:

- `curl=7.64.0-4+deb10u8`
- `libcurl3-gnutls:amd64=7.64.0-4+deb10u8`
- `libcurl4:amd64=7.64.0-4+deb10u8`
- `libcurl4-openssl-dev:amd64=7.64.0-4+deb10u8`
...
- `libgnutls-dane0:amd64=3.6.7-4+deb10u11`
- `libgnutls-openssl27:amd64=3.6.7-4+deb10u11`
- `libgnutls28-dev:amd64=3.6.7-4+deb10u11`
- `libgnutls30:amd64=3.6.7-4+deb10u11`
- `libgnutlsxx28:amd64=3.6.7-4+deb10u11`
...
- `krb5-multidev:amd64=1.17-3+deb10u6`
- `libgssapi-krb5-2:amd64=1.17-3+deb10u6`
- `libgssrpc4:amd64=1.17-3+deb10u6`
- `libk5crypto3:amd64=1.17-3+deb10u6`
- `libkadm5clnt-mit11:amd64=1.17-3+deb10u6`
- `libkadm5srv-mit11:amd64=1.17-3+deb10u6`
- `libkdb5-9:amd64=1.17-3+deb10u6`
- `libkrb5-3:amd64=1.17-3+deb10u6`
- `libkrb5-dev:amd64=1.17-3+deb10u6`
...
### `dpkg` source package: `libde265=1.0.11-0+deb10u6`

Binary Packages:

- `libde265-0:amd64=1.0.11-0+deb10u6`
...
```console
$ apt-get source -qq --print-uris libde265=1.0.11-0+deb10u6
'http://deb.debian.org/debian-security/pool/updates/main/libd/libde265/libde265_1.0.11-0%2bdeb10u6.dsc' libde265_1.0.11-0+deb10u6.dsc 2411 SHA256:e4bbaec93431a78c89c23497de621633820cbd3481d4ab80200a98ecc0ec1f11
...
'http://deb.debian.org/debian-security/pool/updates/main/libd/libde265/libde265_1.0.11-0%2bdeb10u6.debian.tar.xz' libde265_1.0.11-0+deb10u6.debian.tar.xz 16144 SHA256:c85455c7851c0d79ecf35778d2bf57a18ad6f21abab9949a3211f99812aef0e7
```

Other potentially useful URLs:

- https://sources.debian.net/src/libde265/1.0.11-0+deb10u6/ (for browsing the source)
- https://sources.debian.net/src/libde265/1.0.11-0+deb10u6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libde265/1.0.11-0+deb10u6/ (for access to the source package after it no longer exists in the archive)
...
- `libwebp-dev:amd64=0.6.1-2+deb10u3`
- `libwebp6:amd64=0.6.1-2+deb10u3`
- `libwebpdemux2:amd64=0.6.1-2+deb10u3`
- `libwebpmux3:amd64=0.6.1-2+deb10u3`
...
- `libncurses-dev:amd64=6.1+20181013-2+deb10u5`
- `libncurses5-dev:amd64=6.1+20181013-2+deb10u5`
- `libncurses6:amd64=6.1+20181013-2+deb10u5`
- `libncursesw5-dev:amd64=6.1+20181013-2+deb10u5`
...
### `dpkg` source package: `openssh=1:7.9p1-10+deb10u4`
...
```console
$ apt-get source -qq --print-uris openssh=1:7.9p1-10+deb10u4
'http://deb.debian.org/debian-security/pool/updates/main/o/openssh/openssh_7.9p1-10%2bdeb10u4.dsc' openssh_7.9p1-10+deb10u4.dsc 2592 SHA256:a57adf80b4f434f2e8aaf736e642761f30ab2c2bd1432b3e1e6bc824ae826962
...
'http://deb.debian.org/debian-security/pool/updates/main/o/openssh/openssh_7.9p1-10%2bdeb10u4.debian.tar.xz' openssh_7.9p1-10+deb10u4.debian.tar.xz 181408 SHA256:3c9246796095b8cb8785b14ab4157f0cc0ab754e929327ff60cfba4e93213a67
```

Other potentially useful URLs:

- https://sources.debian.net/src/openssh/1:7.9p1-10+deb10u4/ (for browsing the source)
- https://sources.debian.net/src/openssh/1:7.9p1-10+deb10u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssh/1:7.9p1-10+deb10u4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python3.7=3.7.3-2+deb10u6`
...
- `libtiff-dev:amd64=4.1.0+git191117-2~deb10u8`
- `libtiff5:amd64=4.1.0+git191117-2~deb10u8`
- `libtiffxx5:amd64=4.1.0+git191117-2~deb10u8`
