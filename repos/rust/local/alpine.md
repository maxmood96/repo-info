...
- Created: `2022-11-12T08:14:02.429015915Z`
- Virtual Size: ~ 778.15 Mb  
...
```console
gcc-11.2.1_git20220219-r2 description:
The GNU Compiler Collection

gcc-11.2.1_git20220219-r2 webpage:
https://gcc.gnu.org

gcc-11.2.1_git20220219-r2 installed size:
86 MiB

gcc-11.2.1_git20220219-r2 license:
...
```console
libatomic-11.2.1_git20220219-r2 description:
GCC Atomic library

libatomic-11.2.1_git20220219-r2 webpage:
https://gcc.gnu.org

libatomic-11.2.1_git20220219-r2 installed size:
44 KiB

libatomic-11.2.1_git20220219-r2 license:
GPL-2.0-or-later LGPL-2.1-or-later
