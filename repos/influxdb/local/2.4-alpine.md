...
- Created: `2023-03-16T00:57:23.202383493Z`
...
```console
run-parts-4.11.2-r1 description:
run-parts from the debianutils package

run-parts-4.11.2-r1 webpage:
https://packages.qa.debian.org/d/debianutils.html

run-parts-4.11.2-r1 installed size:
36 KiB

run-parts-4.11.2-r1 license:
GPL-2.0-or-later
