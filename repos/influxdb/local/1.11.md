...
- Created: `2025-11-04T04:17:01.893366523Z`
- Virtual Size: ~ 291.74 Mb  
...
### `dpkg` source package: `bsd-mailx=8.1.2-0.20220412cvs-1`

Binary Packages:

- `bsd-mailx=8.1.2-0.20220412cvs-1`

Licenses: (parsed from: `/usr/share/doc/bsd-mailx/copyright`)
...
```console
$ apt-get source -qq --print-uris bsd-mailx=8.1.2-0.20220412cvs-1
'http://deb.debian.org/debian/pool/main/b/bsd-mailx/bsd-mailx_8.1.2-0.20220412cvs-1.dsc' bsd-mailx_8.1.2-0.20220412cvs-1.dsc 1923 SHA256:88d22947694b3b0c874a26e5590ed52c806a37d11e7b20550b6cfe7f4e99c132
'http://deb.debian.org/debian/pool/main/b/bsd-mailx/bsd-mailx_8.1.2-0.20220412cvs.orig.tar.xz' bsd-mailx_8.1.2-0.20220412cvs.orig.tar.xz 79616 SHA256:9ef5ba71c8bf82c528389ca46e11296fb110e4b30eaf33f5888a22b957c5d640
'http://deb.debian.org/debian/pool/main/b/bsd-mailx/bsd-mailx_8.1.2-0.20220412cvs-1.debian.tar.xz' bsd-mailx_8.1.2-0.20220412cvs-1.debian.tar.xz 49564 SHA256:25dbf9f37a0757965e05d771db7045421256c8396c2596ff5d2a07b227e83d18
```

Other potentially useful URLs:

- https://sources.debian.net/src/bsd-mailx/8.1.2-0.20220412cvs-1/ (for browsing the source)
- https://sources.debian.net/src/bsd-mailx/8.1.2-0.20220412cvs-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bsd-mailx/8.1.2-0.20220412cvs-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `cron=3.0pl1-162`
...
Licenses: (parsed from: `/usr/share/doc/cron/copyright`, `/usr/share/doc/cron-daemon-common/copyright`)
...
```console
$ apt-get source -qq --print-uris cron=3.0pl1-162
'http://deb.debian.org/debian/pool/main/c/cron/cron_3.0pl1-162.dsc' cron_3.0pl1-162.dsc 2129 SHA256:5258f1e5e13bc330b66019a631092dc517904214881bbb4a39bef252781a22cd
...
'http://deb.debian.org/debian/pool/main/c/cron/cron_3.0pl1-162.debian.tar.xz' cron_3.0pl1-162.debian.tar.xz 115032 SHA256:72790571714030f0ba9acd98a14ad1cef835d3cc7056f013f67182adf1a83d3a
```

Other potentially useful URLs:

- https://sources.debian.net/src/cron/3.0pl1-162/ (for browsing the source)
- https://sources.debian.net/src/cron/3.0pl1-162/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cron/3.0pl1-162/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `exim4=4.96-15+deb12u7`

Binary Packages:

- `exim4-base=4.96-15+deb12u7`
- `exim4-config=4.96-15+deb12u7`
- `exim4-daemon-light=4.96-15+deb12u7`
...
```console
$ apt-get source -qq --print-uris exim4=4.96-15+deb12u7
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.96-15%2bdeb12u7.dsc' exim4_4.96-15+deb12u7.dsc 2924 SHA256:6b180be4d373c220953ef4ddc18e49a202bf779acdbb72d85b377eda5776d9d4
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.96.orig.tar.xz' exim4_4.96.orig.tar.xz 1879152 SHA256:299a56927b2eb3477daafd3c5bda02bc67e5c4e5898a7aeaf2740875278cf1a3
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.96.orig.tar.xz.asc' exim4_4.96.orig.tar.xz.asc 508 SHA256:9d868dbe6ef823dd563371dc0aadbe58475cd6e42ac8998bfb2b922db3f0fdd0
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.96-15%2bdeb12u7.debian.tar.xz' exim4_4.96-15+deb12u7.debian.tar.xz 512508 SHA256:fbf7dc1f9081780f2574c3ddae705304645a4c9f2ecd00fa53352c12568a8b1f
```

Other potentially useful URLs:

- https://sources.debian.net/src/exim4/4.96-15+deb12u7/ (for browsing the source)
- https://sources.debian.net/src/exim4/4.96-15+deb12u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/exim4/4.96-15+deb12u7/ (for access to the source package after it no longer exists in the archive)
...
- `libgnutls-dane0:amd64=3.7.9-2+deb12u5`
...
### `dpkg` source package: `influxdb=1.11.8-2`

Binary Packages:

- `influxdb=1.11.8-2`

Licenses: (parsed from: `/usr/share/doc/influxdb/copyright`)
...
### `dpkg` source package: `liblockfile=1.17-1`
...
```console
$ apt-get source -qq --print-uris liblockfile=1.17-1
'http://deb.debian.org/debian/pool/main/libl/liblockfile/liblockfile_1.17-1.dsc' liblockfile_1.17-1.dsc 2067 SHA256:2365773d1d1f36086738c63667c2af1a7cb86f51600b61b76ac1c022d1c41e8c
'http://deb.debian.org/debian/pool/main/libl/liblockfile/liblockfile_1.17.orig.tar.gz' liblockfile_1.17.orig.tar.gz 69232 SHA256:6e937f3650afab4aac198f348b89b1ca42edceb17fb6bb0918f642143ccfd15e
'http://deb.debian.org/debian/pool/main/libl/liblockfile/liblockfile_1.17-1.debian.tar.bz2' liblockfile_1.17-1.debian.tar.bz2 6773 SHA256:e3657c0e3facfeccb58900c0b48d56cd68ad5f9f24d1b4c6eaa69c26490fb673
```

Other potentially useful URLs:

- https://sources.debian.net/src/liblockfile/1.17-1/ (for browsing the source)
- https://sources.debian.net/src/liblockfile/1.17-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/liblockfile/1.17-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `logrotate=3.21.0-1`
...
```console
$ apt-get source -qq --print-uris logrotate=3.21.0-1
'http://deb.debian.org/debian/pool/main/l/logrotate/logrotate_3.21.0-1.dsc' logrotate_3.21.0-1.dsc 2230 SHA256:ffacbf8281bd9bd85be49cda2a6a14c4b094c693819f3ca268e1c9dc908ca824
'http://deb.debian.org/debian/pool/main/l/logrotate/logrotate_3.21.0.orig.tar.gz' logrotate_3.21.0.orig.tar.gz 231500 SHA256:1680947a9431de1aaa629fedde358696ff49a808ae903feecf996682949e3cff
'http://deb.debian.org/debian/pool/main/l/logrotate/logrotate_3.21.0.orig.tar.gz.asc' logrotate_3.21.0.orig.tar.gz.asc 833 SHA256:72867e293093e86448238e6be1a1c967d308a3cfa6e775ecce0ccd29b2a17eee
'http://deb.debian.org/debian/pool/main/l/logrotate/logrotate_3.21.0-1.debian.tar.xz' logrotate_3.21.0-1.debian.tar.xz 19676 SHA256:0b3d414f1e133596f8a71c555977a7d54083371a84d76da7cd2e99055006839e
```

Other potentially useful URLs:

- https://sources.debian.net/src/logrotate/3.21.0-1/ (for browsing the source)
- https://sources.debian.net/src/logrotate/3.21.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/logrotate/3.21.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `unbound=1.17.1-2+deb12u3`

Binary Packages:

- `libunbound8:amd64=1.17.1-2+deb12u3`
...
```console
$ apt-get source -qq --print-uris unbound=1.17.1-2+deb12u3
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2%2bdeb12u3.dsc' unbound_1.17.1-2+deb12u3.dsc 2953 SHA256:df7ea09f8be3e6c991f76045cbc1065079b722cc647b1f8b9097906f2e6b6c8e
...
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2%2bdeb12u3.debian.tar.xz' unbound_1.17.1-2+deb12u3.debian.tar.xz 60392 SHA256:ef8cbfe14f143d0c2364b97773a075e0d2b2a960940852e925ea81be87c4de41
```

Other potentially useful URLs:

- https://sources.debian.net/src/unbound/1.17.1-2+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/unbound/1.17.1-2+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unbound/1.17.1-2+deb12u3/ (for access to the source package after it no longer exists in the archive)
