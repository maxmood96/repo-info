...
- Created: `2026-06-24T01:44:07.992121875Z`
...
### `dpkg` source package: `jq=1.6-2.1+deb11u2`

Binary Packages:

- `jq=1.6-2.1+deb11u2`
- `libjq1:amd64=1.6-2.1+deb11u2`
...
```console
$ apt-get source -qq --print-uris jq=1.6-2.1+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/j/jq/jq_1.6-2.1%2bdeb11u2.dsc' jq_1.6-2.1+deb11u2.dsc 1973 SHA256:7a2883c42db8bc732199fe850bde4e9b849e9521eb1d716ae4b0b7c98d3b3786
...
'http://deb.debian.org/debian-security/pool/updates/main/j/jq/jq_1.6-2.1%2bdeb11u2.debian.tar.xz' jq_1.6-2.1+deb11u2.debian.tar.xz 22580 SHA256:9a31cca0035b7321b476e4f0158fe10a85ee524b0b36ecd21e6092f82e869ae2
```

Other potentially useful URLs:

- https://sources.debian.net/src/jq/1.6-2.1+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/jq/1.6-2.1+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jq/1.6-2.1+deb11u2/ (for access to the source package after it no longer exists in the archive)
