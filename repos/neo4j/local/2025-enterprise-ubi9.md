# `neo4j:2025.09.0-enterprise-ubi9`

## Docker Metadata

- Image ID: `sha256:87c6aa59cf660a289d261d9d6a6b9d315d7f63e2270cdda43abf4889906b55a1`
- Created: `2025-09-30T13:19:30Z`
- Virtual Size: ~ 856.94 Mb  
...
- Environment:
  ...
  - `container=oci`
  - `NEO4J_SHA256=0b81f4601987925d0a7a844b4206fc75fefb8cd989bc95b00f1ecbf38afc3e4f`
  - `NEO4J_TARBALL=neo4j-enterprise-2025.09.0-unix.tar.gz`
...
### `rpm` package: `avahi-libs-0.8-22.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url avahi-libs-0.8-22.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/a/avahi-0.8-22.el9_6.1.src.rpm
```
...
### `rpm` package: `cups-libs-2.3.3op2-33.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url cups-libs-2.3.3op2-33.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/cups-2.3.3op2-33.el9_6.1.src.rpm
```
...
### `rpm` package: `java-21-openjdk-headless-21.0.8.0.9-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url java-21-openjdk-headless-21.0.8.0.9-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/java-21-openjdk-21.0.8.0.9-1.el9.src.rpm
```
...
### `rpm` package: `jq-1.6-17.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url jq-1.6-17.el9_6.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/j/jq-1.6-17.el9_6.2.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.49.1.el9_6.x86_64`
...
### `rpm` package: `python-unversioned-command-3.9.21-2.el9_6.2.noarch`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.21-2.el9_6.2.noarch
