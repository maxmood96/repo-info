...
- Created: `2025-06-19T13:23:43Z`
- Virtual Size: ~ 845.50 Mb  
...
- Environment:
  ...
  - `container=oci`
  - `NEO4J_SHA256=836097f43a9d33f986620f5ff6d7862f83623f6a74d7d828dbe2d694c39f98cd`
  - `NEO4J_TARBALL=neo4j-enterprise-2025.05.1-unix.tar.gz`
  - `NEO4J_EDITION=enterprise`
  - `NEO4J_HOME=/var/lib/neo4j`
  - `LANG=C.UTF-8`
- Labels:
  - `architecture=x86_64`
  - `build-date=2025-06-24T16:31:57`
  ...
  - `vcs-ref=69e50e2a07c936e700297091886db408257a857c`
  - `vcs-type=git`
  - `vendor=Red Hat, Inc.`
  - `version=9.6`
...
### `rpm` package: `alsa-lib-1.2.13-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url alsa-lib-1.2.13-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/a/alsa-lib-1.2.13-2.el9.src.rpm
```
...
### `rpm` package: `avahi-libs-0.8-22.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url avahi-libs-0.8-22.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/a/avahi-0.8-22.el9_6.src.rpm
```
...
### `rpm` package: `copy-jdk-configs-4.0-3.el9.noarch`
...
```console
$ dnf --quiet download --source --url copy-jdk-configs-4.0-3.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/c/copy-jdk-configs-4.0-3.el9.src.rpm
```
...
### `rpm` package: `cups-libs-2.3.3op2-33.el9.x86_64`
...
```console
$ dnf --quiet download --source --url cups-libs-2.3.3op2-33.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/cups-2.3.3op2-33.el9.src.rpm
```
...
### `rpm` package: `java-21-openjdk-headless-21.0.7.0.6-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url java-21-openjdk-headless-21.0.7.0.6-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/java-21-openjdk-21.0.7.0.6-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url javapackages-filesystem-6.4.0-1.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/javapackages-tools-6.4.0-1.el9.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.23.1.el9_6.x86_64`
...
### `rpm` package: `lksctp-tools-1.0.19-3.el9_4.x86_64`
...
```console
$ dnf --quiet download --source --url lksctp-tools-1.0.19-3.el9_4
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/lksctp-tools-1.0.19-3.el9_4.src.rpm
```

### `rpm` package: `lua-5.4.4-4.el9.x86_64`
...
```console
$ dnf --quiet download --source --url lua-5.4.4-4.el9
...
### `rpm` package: `lua-posix-35.0-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url lua-posix-35.0-8.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/l/lua-posix-35.0-8.el9.src.rpm
```
...
### `rpm` package: `nspr-4.35.0-17.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nspr-4.35.0-17.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```

### `rpm` package: `nss-3.101.0-10.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nss-3.101.0-10.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```

### `rpm` package: `nss-softokn-3.101.0-10.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nss-softokn-3.101.0-10.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```

### `rpm` package: `nss-softokn-freebl-3.101.0-10.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nss-softokn-freebl-3.101.0-10.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```

### `rpm` package: `nss-sysinit-3.101.0-10.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nss-sysinit-3.101.0-10.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```

### `rpm` package: `nss-util-3.101.0-10.el9_2.x86_64`
...
```console
$ dnf --quiet download --source --url nss-util-3.101.0-10.el9_2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/n/nss-3.101.0-10.el9_2.src.rpm
```
...
### `rpm` package: `python-unversioned-command-3.9.21-2.el9.noarch`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.21-2.el9.noarch
...
### `rpm` package: `tzdata-java-2025b-1.el9.noarch`
...
```console
$ dnf --quiet download --source --url tzdata-java-2025b-1.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/t/tzdata-2025b-1.el9.src.rpm
```
