...
- Created: `2025-02-27T14:20:06Z`
- Virtual Size: ~ 963.53 Mb  
...
- Environment:
  ...
  - `container=oci`
  - `NEO4J_SHA256=d4323822935d7677ae5a12dd5638a1ed7012c190b6dd93913640ac2fda30501f`
  - `NEO4J_TARBALL=neo4j-enterprise-2025.02.0-unix.tar.gz`
...
### `rpm` package: `alsa-lib-1.2.12-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url alsa-lib-1.2.12-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/a/alsa-lib-1.2.12-1.el9.src.rpm
```
...
### `rpm` package: `avahi-libs-0.8-21.el9.x86_64`
...
```console
$ dnf --quiet download --source --url avahi-libs-0.8-21.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/a/avahi-0.8-21.el9.src.rpm
```
...
### `rpm` package: `cups-libs-2.3.3op2-31.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url cups-libs-2.3.3op2-31.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/cups-2.3.3op2-31.el9_5.src.rpm
```
...
### `rpm` package: `java-21-openjdk-headless-21.0.6.0.7-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url java-21-openjdk-headless-21.0.6.0.7-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/java-21-openjdk-21.0.6.0.7-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url javapackages-filesystem-6.0.0-7.el9_5.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/javapackages-tools-6.0.0-7.el9_5.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-503.29.1.el9_5.x86_64`
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/policycoreutils-3.6-2.1.el9.src.rpm
```
...
### `rpm` package: `python-unversioned-command-3.9.21-1.el9_5.noarch`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.21-1.el9_5.noarch
