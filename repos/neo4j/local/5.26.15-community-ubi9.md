...
- Created: `2025-10-30T20:50:30.442838847Z`
- Virtual Size: ~ 605.24 Mb  
...
- Environment:
  ...
  - `container=oci`
  - `NEO4J_SHA256=4ae618c5d781fa73560aaf001da49b502989ebd00c593ba80d3331d0b0c8aad3`
  - `NEO4J_TARBALL=neo4j-community-5.26.15-unix.tar.gz`
...
```console
$ dnf --quiet download --source --url java-17-openjdk-headless-17.0.17.0.10-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/j/java-17-openjdk-17.0.17.0.10-1.el9.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.58.1.el9_6.x86_64`
