...
- Created: `2026-04-07T02:58:43.726530221Z`
- Virtual Size: ~ 961.59 Mb  
...
### `dpkg` source package: `jq=1.7.1-6+deb13u1`

Binary Packages:

- `jq=1.7.1-6+deb13u1`
- `libjq1:amd64=1.7.1-6+deb13u1`
...
```console
$ apt-get source -qq --print-uris jq=1.7.1-6+deb13u1
'http://deb.debian.org/debian/pool/main/j/jq/jq_1.7.1-6%2bdeb13u1.dsc' jq_1.7.1-6+deb13u1.dsc 2032 SHA256:cce780e46a9af23bb424643411db0a5ebb1c3038095e2f6e3a418fe6628afa63
...
'http://deb.debian.org/debian/pool/main/j/jq/jq_1.7.1-6%2bdeb13u1.debian.tar.xz' jq_1.7.1-6+deb13u1.debian.tar.xz 16436 SHA256:9d2a2534be2dee0484f6d384b6680630b556985c58a0e5b794ac0b3d240e4512
```

Other potentially useful URLs:

- https://sources.debian.net/src/jq/1.7.1-6+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/jq/1.7.1-6+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jq/1.7.1-6+deb13u1/ (for access to the source package after it no longer exists in the archive)
