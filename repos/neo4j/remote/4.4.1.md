...
```console
$ docker pull neo4j@sha256:6e4bf3a0e36322cfb71843970cbba4a20835339fe7d0852878feac8ae2ddb3ec
```
...
```console
$ docker pull neo4j@sha256:09c4c9839ebda08ecfabbbfcffb8643bbb15ad800b7dc1dc434645b64f150e7b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.7 MB (368739644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8dc8e1c9e4b93e05058c9c4b4ee8dc048ab61d41e8f254a4e579ec0a1b05c9e`
...
-	Layers:
	...
	-	`sha256:313fb0b5de5ee7f8a750da20f5629882554fb425ee07ed611b8a934cb2506da5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63f1df1bf99b755c1407ee0e0e26e265aaa7ae23660803403649c528a72b77cf`  
		Last Modified: Wed, 30 Mar 2022 03:27:42 GMT  
		Size: 3.9 KB (3865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d86672743a13a8ad955819a6c98c78a0ef6162ecd0e32c2694fd378410ea6ee7`  
		Last Modified: Wed, 30 Mar 2022 03:27:42 GMT  
		Size: 604.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b230427ddcc1fc309114413f322d629f35d1dd9ac2497ab3983eade968bc67f6`  
		Last Modified: Wed, 30 Mar 2022 03:27:49 GMT  
		Size: 132.2 MB (132243566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15b712587f0ddb04458e11fdd1f40f2ff88e9b7982ba63eca0906b43ef4e6a4f`  
		Last Modified: Wed, 30 Mar 2022 03:27:42 GMT  
...
```console
$ docker pull neo4j@sha256:c2a1bef41339bc9ed2d156fbb1ab7085bbc7499e2834ca3e4d4e3fb51fd5c388
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.3 MB (364315110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f6c3327397b5c752e74e7e2a665f9a72664a1b6711a27a1c2b5db0f6a142f28`
-	Entrypoint: `["\/sbin\/tini","-g","--","\/docker-entrypoint.sh"]`
-	Default Command: `["neo4j"]`
...
# Tue, 29 Mar 2022 01:23:46 GMT
CMD ["jshell"]
# Wed, 30 Mar 2022 11:00:40 GMT
ENV NEO4J_SHA256=280e15336640e7fdde0dcebca5dcf2a0739dfaab7fa97752a1f98f8ea707fb84 NEO4J_TARBALL=neo4j-community-4.4.1-unix.tar.gz NEO4J_EDITION=community NEO4J_HOME=/var/lib/neo4j
# Wed, 30 Mar 2022 11:00:41 GMT
ARG NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.1-unix.tar.gz
# Wed, 30 Mar 2022 11:00:42 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.1-unix.tar.gz
RUN addgroup --gid 7474 --system neo4j && adduser --uid 7474 --system --no-create-home --home "${NEO4J_HOME}" --ingroup neo4j neo4j
# Wed, 30 Mar 2022 11:00:44 GMT
COPY multi:220c2663e29181f5cd4d1cc8ff4ea55bca5bd66e60ecec0890d11b2c206bdb54 in /tmp/ 
# Wed, 30 Mar 2022 11:01:00 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.1-unix.tar.gz
RUN apt update     && apt install -y curl wget gosu jq     && curl --fail --silent --show-error --location --remote-name ${NEO4J_URI}     && echo "${NEO4J_SHA256}  ${NEO4J_TARBALL}" | sha256sum -c --strict --quiet     && tar --extract --file ${NEO4J_TARBALL} --directory /var/lib     && mv /var/lib/neo4j-* "${NEO4J_HOME}"     && rm ${NEO4J_TARBALL}     && mv "${NEO4J_HOME}"/data /data     && mv "${NEO4J_HOME}"/logs /logs     && chown -R neo4j:neo4j /data     && chmod -R 777 /data     && chown -R neo4j:neo4j /logs     && chmod -R 777 /logs     && chown -R neo4j:neo4j "${NEO4J_HOME}"     && chmod -R 777 "${NEO4J_HOME}"     && ln -s /data "${NEO4J_HOME}"/data     && ln -s /logs "${NEO4J_HOME}"/logs     && mv /tmp/neo4jlabs-plugins.json /neo4jlabs-plugins.json     && set -eux; 	dpkgArch="$(dpkg --print-architecture)"; 	case "${dpkgArch##*-}" in 		'amd64')             tinisha="12d20136605531b09a2c2dac02ccee85e1b874eb322ef6baf7561cd93f93c855";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini"; 			;; 		'arm64')             tinisha="7c5463f55393985ee22357d976758aaaecd08defb3c5294d353732018169b019";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini-arm64"; 			;; 		*) echo >&2 "Neo4j does not currently have a docker image for architecture $dpkgArch"; exit 1 ;; 	esac     && curl -L --fail --silent --show-error ${tiniurl} > /sbin/tini     && echo "${tinisha}  /sbin/tini" | sha256sum -c --strict --quiet     && chmod +x /sbin/tini     && apt-get -y purge --auto-remove curl     && rm -rf /tmp/*     && rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 11:01:01 GMT
ENV PATH=/var/lib/neo4j/bin:/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 30 Mar 2022 11:01:02 GMT
WORKDIR /var/lib/neo4j
# Wed, 30 Mar 2022 11:01:03 GMT
VOLUME [/data /logs]
# Wed, 30 Mar 2022 11:01:05 GMT
COPY file:ab7ae7f90c4a2b48d55ce46bb4b2dcdc336a04742bc26d5311b62b6d1e2ce171 in /docker-entrypoint.sh 
# Wed, 30 Mar 2022 11:01:05 GMT
EXPOSE 7473 7474 7687
# Wed, 30 Mar 2022 11:01:06 GMT
ENTRYPOINT ["/sbin/tini" "-g" "--" "/docker-entrypoint.sh"]
# Wed, 30 Mar 2022 11:01:07 GMT
CMD ["neo4j"]
```
...
-	Layers:
	...
	-	`sha256:ec8f189a638f733fdf08e8ac8d579e196d88e34855d5121a93aa2247f5aa0223`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cbda880cebc0f4c820bdc10fb3d8cd49e5d54cb30ec54098a5b510058aefb34`  
		Last Modified: Wed, 30 Mar 2022 11:06:55 GMT  
		Size: 3.8 KB (3840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd67d43385aa3d0c5f6c5fa0bdd9d7e4b7dfdfd9580e75e81a2fa3d835f292f0`  
		Last Modified: Wed, 30 Mar 2022 11:06:55 GMT  
		Size: 604.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05bf644eb56cf176d020ef046d3bddcf2107342090632dfe06712cac81eab573`  
		Last Modified: Wed, 30 Mar 2022 11:07:04 GMT  
		Size: 131.9 MB (131939067 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe3a9837a6fc1d7fa876202278b00e063d58cae3927e70f80b65f8921c39b56f`  
		Last Modified: Wed, 30 Mar 2022 11:06:55 GMT  
