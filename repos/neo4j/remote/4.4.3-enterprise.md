...
```console
$ docker pull neo4j@sha256:8080a24ea924330aee27ed699030e9b8952731133c2e93647defe5db5c5c0924
```
...
```console
$ docker pull neo4j@sha256:82e056cc7ae8ffe8fbd312f47e132fe3db2b9487d6f83a2263750425934fe061
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **444.9 MB (444949091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72714c1acd327fe3b2441f094c33f2b5c1e36a3969e7c323f43fbf28fa93c0b0`
...
-	Layers:
	...
	-	`sha256:313fb0b5de5ee7f8a750da20f5629882554fb425ee07ed611b8a934cb2506da5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6d0862cf1c5a9b0ea3fe616404002f04285e347a16f472347c99afa2f313906`  
		Last Modified: Wed, 30 Mar 2022 03:26:51 GMT  
		Size: 3.9 KB (3868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba1941e4a5dc3630352765b8b2682e3188a7fadc40e96f92e0060c7c45ab6cda`  
		Last Modified: Wed, 30 Mar 2022 03:26:51 GMT  
		Size: 604.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27db324afaf023833e639fa3769604673128b0df1bee04aae27dfe6b0b2b3946`  
		Last Modified: Wed, 30 Mar 2022 03:27:01 GMT  
		Size: 208.5 MB (208453013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48ffd51346834534c5f58053fb45cea5c221ac4b35583cad4f39bb7f83cf11e6`  
		Last Modified: Wed, 30 Mar 2022 03:26:51 GMT  
...
```console
$ docker pull neo4j@sha256:e9fa8041adfce0024c3cf9ab8f252ab7f935ac7bd1bc0779cc38fa87b2cce00a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **440.5 MB (440526137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:004c8c25e36e37f4c0e0e742ba4cc37bdb2f5c56ecd9273bbd68136c61f9bd49`
-	Entrypoint: `["\/sbin\/tini","-g","--","\/docker-entrypoint.sh"]`
-	Default Command: `["neo4j"]`
...
# Tue, 29 Mar 2022 01:23:46 GMT
CMD ["jshell"]
# Wed, 30 Mar 2022 10:59:11 GMT
ENV NEO4J_SHA256=8f059040b2c88c9045b7d03f83f3cee0c0c0a65fa96f87546765a9267adccec4 NEO4J_TARBALL=neo4j-enterprise-4.4.3-unix.tar.gz NEO4J_EDITION=enterprise NEO4J_HOME=/var/lib/neo4j
# Wed, 30 Mar 2022 10:59:11 GMT
ARG NEO4J_URI=https://dist.neo4j.org/neo4j-enterprise-4.4.3-unix.tar.gz
# Wed, 30 Mar 2022 10:59:12 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-enterprise-4.4.3-unix.tar.gz
RUN addgroup --gid 7474 --system neo4j && adduser --uid 7474 --system --no-create-home --home "${NEO4J_HOME}" --ingroup neo4j neo4j
# Wed, 30 Mar 2022 10:59:14 GMT
COPY multi:220c2663e29181f5cd4d1cc8ff4ea55bca5bd66e60ecec0890d11b2c206bdb54 in /tmp/ 
# Wed, 30 Mar 2022 10:59:26 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-enterprise-4.4.3-unix.tar.gz
RUN apt update     && apt install -y curl wget gosu jq     && curl --fail --silent --show-error --location --remote-name ${NEO4J_URI}     && echo "${NEO4J_SHA256}  ${NEO4J_TARBALL}" | sha256sum -c --strict --quiet     && tar --extract --file ${NEO4J_TARBALL} --directory /var/lib     && mv /var/lib/neo4j-* "${NEO4J_HOME}"     && rm ${NEO4J_TARBALL}     && mv "${NEO4J_HOME}"/data /data     && mv "${NEO4J_HOME}"/logs /logs     && chown -R neo4j:neo4j /data     && chmod -R 777 /data     && chown -R neo4j:neo4j /logs     && chmod -R 777 /logs     && chown -R neo4j:neo4j "${NEO4J_HOME}"     && chmod -R 777 "${NEO4J_HOME}"     && ln -s /data "${NEO4J_HOME}"/data     && ln -s /logs "${NEO4J_HOME}"/logs     && mv /tmp/neo4jlabs-plugins.json /neo4jlabs-plugins.json     && set -eux; 	dpkgArch="$(dpkg --print-architecture)"; 	case "${dpkgArch##*-}" in 		'amd64')             tinisha="12d20136605531b09a2c2dac02ccee85e1b874eb322ef6baf7561cd93f93c855";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini"; 			;; 		'arm64')             tinisha="7c5463f55393985ee22357d976758aaaecd08defb3c5294d353732018169b019";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini-arm64"; 			;; 		*) echo >&2 "Neo4j does not currently have a docker image for architecture $dpkgArch"; exit 1 ;; 	esac     && curl -L --fail --silent --show-error ${tiniurl} > /sbin/tini     && echo "${tinisha}  /sbin/tini" | sha256sum -c --strict --quiet     && chmod +x /sbin/tini     && apt-get -y purge --auto-remove curl     && rm -rf /tmp/*     && rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 10:59:27 GMT
ENV PATH=/var/lib/neo4j/bin:/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 30 Mar 2022 10:59:27 GMT
WORKDIR /var/lib/neo4j
# Wed, 30 Mar 2022 10:59:28 GMT
VOLUME [/data /logs]
# Wed, 30 Mar 2022 10:59:30 GMT
COPY file:ab7ae7f90c4a2b48d55ce46bb4b2dcdc336a04742bc26d5311b62b6d1e2ce171 in /docker-entrypoint.sh 
# Wed, 30 Mar 2022 10:59:30 GMT
EXPOSE 7473 7474 7687
# Wed, 30 Mar 2022 10:59:31 GMT
ENTRYPOINT ["/sbin/tini" "-g" "--" "/docker-entrypoint.sh"]
# Wed, 30 Mar 2022 10:59:32 GMT
CMD ["neo4j"]
```
...
-	Layers:
	...
	-	`sha256:ec8f189a638f733fdf08e8ac8d579e196d88e34855d5121a93aa2247f5aa0223`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78295fc3aced8a6b419cd6f70cefb7b527f519245c026112cf4b8485035151a0`  
		Last Modified: Wed, 30 Mar 2022 11:05:53 GMT  
		Size: 3.8 KB (3838 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26a38fda56c8d5ccc2e65ccd37d44ae8d89483a549307363f8228a6429b614c5`  
		Last Modified: Wed, 30 Mar 2022 11:05:53 GMT  
		Size: 605.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be70a62343496a9fc7f1ce8f1841b2ec99d6ef66d4b0c91e1cb4384c2a74ae45`  
		Last Modified: Wed, 30 Mar 2022 11:06:06 GMT  
		Size: 208.2 MB (208150093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf560736e4a40e6a10fbe955f1d90bb756add610c67dda616449424c88bf1e05`  
		Last Modified: Wed, 30 Mar 2022 11:05:53 GMT  
