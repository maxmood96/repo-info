...
```console
$ docker pull neo4j@sha256:6e3f4fae8899ba1453fb2b9d0972098c49f84fe8f88315fe85dafb6483257452
```
...
```console
$ docker pull neo4j@sha256:045d7903c9a4ad37b351685432cc0b5d45bb4febacbfee7a1fc42fe2d1ab60e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.7 MB (368749426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a469366562b1942092bb640c29ae549a784f9307dd5ca81cdcc51bff65329bb8`
...
-	Layers:
	...
	-	`sha256:313fb0b5de5ee7f8a750da20f5629882554fb425ee07ed611b8a934cb2506da5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0221afd099108bdd33b7178c44bb4fa2268133f0d86499e630ccebd2642675cb`  
		Last Modified: Wed, 30 Mar 2022 03:26:34 GMT  
		Size: 3.9 KB (3863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:224871e5a9d4b6fc8bacb9d836ec0ce8499d1f5f51d9bc2262aea6e07e916bb7`  
		Last Modified: Wed, 30 Mar 2022 03:26:34 GMT  
		Size: 602.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77b222b58f8da512a7c52c662b5d83e310f31efd40f2c8322388a8dc83c48741`  
		Last Modified: Wed, 30 Mar 2022 03:26:41 GMT  
		Size: 132.3 MB (132253349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f805c3513c80e8cba08779ba9f8e806485f5342f9f3683f0beb14af134ce8f4d`  
		Last Modified: Wed, 30 Mar 2022 03:26:34 GMT  
...
```console
$ docker pull neo4j@sha256:6ddd9c06e93eca8b4bc371ccc43e2125721f9e8295bbd82d25ca652ce9a4218f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.3 MB (364326644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:687deec84059d640c7365790c91bfa7b48788a829f69b4cbe523801f00ac2d3e`
-	Entrypoint: `["\/sbin\/tini","-g","--","\/docker-entrypoint.sh"]`
-	Default Command: `["neo4j"]`
...
ENV NEO4J_SHA256=87a01906c178977c082579def934afde0f806695e593fd119f237bff01cfa738 NEO4J_TARBALL=neo4j-community-4.4.3-unix.tar.gz NEO4J_EDITION=community NEO4J_HOME=/var/lib/neo4j
# Wed, 30 Mar 2022 10:58:40 GMT
ARG NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.3-unix.tar.gz
# Wed, 30 Mar 2022 10:58:41 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.3-unix.tar.gz
RUN addgroup --gid 7474 --system neo4j && adduser --uid 7474 --system --no-create-home --home "${NEO4J_HOME}" --ingroup neo4j neo4j
# Wed, 30 Mar 2022 10:58:43 GMT
COPY multi:220c2663e29181f5cd4d1cc8ff4ea55bca5bd66e60ecec0890d11b2c206bdb54 in /tmp/ 
# Wed, 30 Mar 2022 10:58:59 GMT
# ARGS: NEO4J_URI=https://dist.neo4j.org/neo4j-community-4.4.3-unix.tar.gz
RUN apt update     && apt install -y curl wget gosu jq     && curl --fail --silent --show-error --location --remote-name ${NEO4J_URI}     && echo "${NEO4J_SHA256}  ${NEO4J_TARBALL}" | sha256sum -c --strict --quiet     && tar --extract --file ${NEO4J_TARBALL} --directory /var/lib     && mv /var/lib/neo4j-* "${NEO4J_HOME}"     && rm ${NEO4J_TARBALL}     && mv "${NEO4J_HOME}"/data /data     && mv "${NEO4J_HOME}"/logs /logs     && chown -R neo4j:neo4j /data     && chmod -R 777 /data     && chown -R neo4j:neo4j /logs     && chmod -R 777 /logs     && chown -R neo4j:neo4j "${NEO4J_HOME}"     && chmod -R 777 "${NEO4J_HOME}"     && ln -s /data "${NEO4J_HOME}"/data     && ln -s /logs "${NEO4J_HOME}"/logs     && mv /tmp/neo4jlabs-plugins.json /neo4jlabs-plugins.json     && set -eux; 	dpkgArch="$(dpkg --print-architecture)"; 	case "${dpkgArch##*-}" in 		'amd64')             tinisha="12d20136605531b09a2c2dac02ccee85e1b874eb322ef6baf7561cd93f93c855";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini"; 			;; 		'arm64')             tinisha="7c5463f55393985ee22357d976758aaaecd08defb3c5294d353732018169b019";             tiniurl="https://github.com/krallin/tini/releases/download/v0.18.0/tini-arm64"; 			;; 		*) echo >&2 "Neo4j does not currently have a docker image for architecture $dpkgArch"; exit 1 ;; 	esac     && curl -L --fail --silent --show-error ${tiniurl} > /sbin/tini     && echo "${tinisha}  /sbin/tini" | sha256sum -c --strict --quiet     && chmod +x /sbin/tini     && apt-get -y purge --auto-remove curl     && rm -rf /tmp/*     && rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 10:58:59 GMT
ENV PATH=/var/lib/neo4j/bin:/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 30 Mar 2022 10:59:00 GMT
WORKDIR /var/lib/neo4j
# Wed, 30 Mar 2022 10:59:01 GMT
VOLUME [/data /logs]
# Wed, 30 Mar 2022 10:59:03 GMT
COPY file:ab7ae7f90c4a2b48d55ce46bb4b2dcdc336a04742bc26d5311b62b6d1e2ce171 in /docker-entrypoint.sh 
# Wed, 30 Mar 2022 10:59:03 GMT
EXPOSE 7473 7474 7687
# Wed, 30 Mar 2022 10:59:04 GMT
ENTRYPOINT ["/sbin/tini" "-g" "--" "/docker-entrypoint.sh"]
# Wed, 30 Mar 2022 10:59:05 GMT
CMD ["neo4j"]
```
...
-	Layers:
	...
	-	`sha256:ec8f189a638f733fdf08e8ac8d579e196d88e34855d5121a93aa2247f5aa0223`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d758e78aed8dd9044036bafa6de326b76c04d097102a97363763ebe8e75e0a30`  
		Last Modified: Wed, 30 Mar 2022 11:05:33 GMT  
		Size: 3.8 KB (3843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:812ebbd627004119be1146519cfa57131d0f2664f11c11ef8a49fb6581d51769`  
		Last Modified: Wed, 30 Mar 2022 11:05:33 GMT  
		Size: 605.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dca02a61d3ae31705288d96be809fa28926a95650f11592c1ebc740e00785d70`  
		Last Modified: Wed, 30 Mar 2022 11:05:42 GMT  
		Size: 132.0 MB (131950597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04e6dab043a91fdd4c1040b8c8cf922fe5ab2ce5f592db6bfaf5fcd34b37f3ed`  
		Last Modified: Wed, 30 Mar 2022 11:05:33 GMT  
