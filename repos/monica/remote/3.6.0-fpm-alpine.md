...
### `monica:3.6.0-fpm-alpine` - linux; arm variant v7
...
### `monica:3.6.0-fpm-alpine` - linux; arm64 variant v8
...
### `monica:3.6.0-fpm-alpine` - linux; ppc64le
...
### `monica:3.6.0-fpm-alpine` - linux; s390x
