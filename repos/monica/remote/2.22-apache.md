...
### `monica:2.22-apache` - linux; arm variant v5
...
### `monica:2.22-apache` - linux; arm variant v7
...
### `monica:2.22-apache` - linux; arm64 variant v8
...
### `monica:2.22-apache` - linux; mips64le
