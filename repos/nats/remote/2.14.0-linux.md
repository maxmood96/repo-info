...
### `nats:2.14.0-linux` - unknown; unknown
...
### `nats:2.14.0-linux` - linux; arm variant v6
...
### `nats:2.14.0-linux` - linux; arm variant v7
...
### `nats:2.14.0-linux` - linux; arm64 variant v8
...
### `nats:2.14.0-linux` - linux; ppc64le
