...
```console
$ docker pull nats@sha256:dcd43231c810057b97996727f96c80a3c8df621e48d37283d46f73d1e8f96b70
```
...
### `nats:2.12.5-alpine3.22` - linux; amd64
...
### `nats:2.12.5-alpine3.22` - unknown; unknown
...
### `nats:2.12.5-alpine3.22` - linux; arm variant v6
...
### `nats:2.12.5-alpine3.22` - linux; arm variant v7
...
### `nats:2.12.5-alpine3.22` - linux; arm64 variant v8
...
### `nats:2.12.5-alpine3.22` - linux; s390x
