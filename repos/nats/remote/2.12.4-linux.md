...
### `nats:2.12.4-linux` - unknown; unknown
...
### `nats:2.12.4-linux` - linux; arm variant v6
...
### `nats:2.12.4-linux` - linux; arm variant v7
...
### `nats:2.12.4-linux` - linux; arm64 variant v8
...
### `nats:2.12.4-linux` - linux; ppc64le
