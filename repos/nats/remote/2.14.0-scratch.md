...
```console
$ docker pull nats@sha256:7e24e2e44106be39463c8f25f80b3e72e3a950985931b133b53a5f211673a754
```
...
### `nats:2.14.0-scratch` - linux; amd64
...
### `nats:2.14.0-scratch` - unknown; unknown
...
### `nats:2.14.0-scratch` - linux; arm variant v6
...
### `nats:2.14.0-scratch` - linux; arm variant v7
...
### `nats:2.14.0-scratch` - linux; arm64 variant v8
...
### `nats:2.14.0-scratch` - linux; s390x
