...
```console
$ docker pull nats@sha256:4cba39588914318f0a128e07655d6dd8ae42ad8d89e7c410800e6db6f891689a
```
...
### `nats:2.12.0` - linux; arm variant v6
...
### `nats:2.12.0` - linux; arm variant v7
...
### `nats:2.12.0` - linux; arm64 variant v8
...
### `nats:2.12.0` - windows version 10.0.20348.4171; amd64
