...
- Created: `2020-09-11T06:00:47.690634115Z`
...
### `dpkg` source package: `exiv2=0.25-4+deb10u1`

Binary Packages:

- `libexiv2-14:amd64=0.25-4+deb10u1`
...
```console
$ apt-get source -qq --print-uris exiv2=0.25-4+deb10u1
'http://deb.debian.org/debian/pool/main/e/exiv2/exiv2_0.25-4+deb10u1.dsc' exiv2_0.25-4+deb10u1.dsc 2269 SHA256:905e3daa3b0de7b738b6df35df7a734d8f91c680293195249016e3593c11ffc1
...
'http://deb.debian.org/debian/pool/main/e/exiv2/exiv2_0.25-4+deb10u1.debian.tar.xz' exiv2_0.25-4+deb10u1.debian.tar.xz 28380 SHA256:ecace695d346625c1bfce21859409008afedcef3021b7fe4f94edfc13def2454
```

Other potentially useful URLs:

- https://sources.debian.net/src/exiv2/0.25-4+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/exiv2/0.25-4+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/exiv2/0.25-4+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libreoffice=1:6.1.5-3+deb10u6`
...
- `libreoffice-base-drivers=1:6.1.5-3+deb10u6`
...
```console
$ apt-get source -qq --print-uris libreoffice=1:6.1.5-3+deb10u6
'http://deb.debian.org/debian/pool/main/libr/libreoffice/libreoffice_6.1.5-3+deb10u6.dsc' libreoffice_6.1.5-3+deb10u6.dsc 27751 SHA256:56aedb65240f7143b3f41cb609c118f8128f7b9937c406f4e9f3fd408610aa2f
...
'http://deb.debian.org/debian/pool/main/libr/libreoffice/libreoffice_6.1.5-3+deb10u6.debian.tar.xz' libreoffice_6.1.5-3+deb10u6.debian.tar.xz 9978848 SHA256:490fe07635b5a52fa2d2c3de83bbaf19616d9900ac485e1d063786aae7a996e7
```

Other potentially useful URLs:

- https://sources.debian.net/src/libreoffice/1:6.1.5-3+deb10u6/ (for browsing the source)
- https://sources.debian.net/src/libreoffice/1:6.1.5-3+deb10u6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libreoffice/1:6.1.5-3+deb10u6/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `zeromq3=4.3.1-4+deb10u2`

Binary Packages:

- `libzmq5:amd64=4.3.1-4+deb10u2`
...
```console
$ apt-get source -qq --print-uris zeromq3=4.3.1-4+deb10u2
'http://security.debian.org/debian-security/pool/updates/main/z/zeromq3/zeromq3_4.3.1-4+deb10u2.dsc' zeromq3_4.3.1-4+deb10u2.dsc 2042 SHA256:9275130b35deb80875046d018f1a9bbe47f6faa672e672b58fa4211002995a9a
'http://security.debian.org/debian-security/pool/updates/main/z/zeromq3/zeromq3_4.3.1.orig.tar.gz' zeromq3_4.3.1.orig.tar.gz 788963 SHA256:e1dec061725b55d791e0c6952b8c220846c8cd901c09d1283a6e902898205b9d
'http://security.debian.org/debian-security/pool/updates/main/z/zeromq3/zeromq3_4.3.1-4+deb10u2.debian.tar.xz' zeromq3_4.3.1-4+deb10u2.debian.tar.xz 18100 SHA256:62e5ceadb9d346825e14311b2ac6e5b4c0c97c24577177046fdd8db4328fdba7
```

Other potentially useful URLs:

- https://sources.debian.net/src/zeromq3/4.3.1-4+deb10u2/ (for browsing the source)
- https://sources.debian.net/src/zeromq3/4.3.1-4+deb10u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/zeromq3/4.3.1-4+deb10u2/ (for access to the source package after it no longer exists in the archive)
