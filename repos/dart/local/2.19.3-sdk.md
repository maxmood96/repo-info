...
- Created: `2023-03-02T02:53:19.456860726Z`
- Virtual Size: ~ 882.53 Mb  
...
### `dpkg` source package: `bind9=1:9.16.37-1~deb11u1`

Binary Packages:

- `bind9-dnsutils=1:9.16.37-1~deb11u1`
- `bind9-host=1:9.16.37-1~deb11u1`
- `bind9-libs:amd64=1:9.16.37-1~deb11u1`
...
```console
$ apt-get source -qq --print-uris bind9=1:9.16.37-1~deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.16.37-1%7edeb11u1.dsc' bind9_9.16.37-1~deb11u1.dsc 3266 SHA256:bfd43568de7509289938f07a4bd2a162ded1292353b522fa1b2a63d71de08aa9
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.16.37.orig.tar.xz' bind9_9.16.37.orig.tar.xz 5109440 SHA256:0e4661d522a2fe1f111c1f0685e7d6993d657f81dae24e7a75dbd8db3ef2e2ab
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.16.37.orig.tar.xz.asc' bind9_9.16.37.orig.tar.xz.asc 833 SHA256:983358adca456af4c07378ce955063da8ed31f1d98062902ac24598ff90edc5f
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.16.37-1%7edeb11u1.debian.tar.xz' bind9_9.16.37-1~deb11u1.debian.tar.xz 78716 SHA256:850ff72527d0437fb648911199a52b33148d4a5d812e4c1f4af92ba01356972a
```

Other potentially useful URLs:

- https://sources.debian.net/src/bind9/1:9.16.37-1~deb11u1/ (for browsing the source)
- https://sources.debian.net/src/bind9/1:9.16.37-1~deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bind9/1:9.16.37-1~deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `fstrm=0.6.0-1`

Binary Packages:

- `libfstrm0:amd64=0.6.0-1+b1`

Licenses: (parsed from: `/usr/share/doc/libfstrm0/copyright`)
...
```console
$ apt-get source -qq --print-uris fstrm=0.6.0-1
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.0-1.dsc' fstrm_0.6.0-1.dsc 1932 SHA256:b1301ec500a2c8ef3535d6f6f99616a284270f0eb2693300310b2daf466d5f3e
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.0.orig.tar.gz' fstrm_0.6.0.orig.tar.gz 135214 SHA256:82851b2424ae3e94b4fba310b60629b33d6757fbeb15662566b1857cd5c31517
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.0-1.debian.tar.xz' fstrm_0.6.0-1.debian.tar.xz 3520 SHA256:6636a96bb4d45555a749da05f39afd8e155c2d753a9fa9a2b43ef8d1937abde0
```

Other potentially useful URLs:

- https://sources.debian.net/src/fstrm/0.6.0-1/ (for browsing the source)
- https://sources.debian.net/src/fstrm/0.6.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/fstrm/0.6.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `git=1:2.30.2-1+deb11u2`
...
```console
$ apt-get source -qq --print-uris git=1:2.30.2-1+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/g/git/git_2.30.2-1%2bdeb11u2.dsc' git_2.30.2-1+deb11u2.dsc 2525 SHA256:81c919ef1a321ae7c6eb9ecbb29d1c0fc052ffe96d4c8540c04d64cdcc5ed5c6
...
'http://deb.debian.org/debian-security/pool/updates/main/g/git/git_2.30.2-1%2bdeb11u2.debian.tar.xz' git_2.30.2-1+deb11u2.debian.tar.xz 698392 SHA256:ca456459c18359a34008db6f68cd0f7bf470e3e4eb7093a982b67c51277a0f58
```

Other potentially useful URLs:

- https://sources.debian.net/src/git/1:2.30.2-1+deb11u2/ (for browsing the source)
...
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.24-1.dsc' lmdb_0.9.24-1.dsc 2119 SHA256:f90d1cc2b69cae56f1b465636c810f4e3667d43a2567cf3bfb48b62cb710da6e
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.24.orig.tar.gz' lmdb_0.9.24.orig.tar.gz 143901 SHA256:8e7200fdc9bb09b0cfad1d4eee8b20d539e43fe05c7ef9406247d64659c4a480
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.24-1.debian.tar.xz' lmdb_0.9.24-1.debian.tar.xz 6080 SHA256:522abd2cf9777afe3af0acf26886bd0789a30da09bba91d01d0e1562982b1fc5
```

Other potentially useful URLs:

- https://sources.debian.net/src/lmdb/0.9.24-1/ (for browsing the source)
- https://sources.debian.net/src/lmdb/0.9.24-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lmdb/0.9.24-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `protobuf-c=1.3.3-1`

Binary Packages:

- `libprotobuf-c1:amd64=1.3.3-1+b2`

Licenses: (parsed from: `/usr/share/doc/libprotobuf-c1/copyright`)
...
```console
$ apt-get source -qq --print-uris protobuf-c=1.3.3-1
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.3-1.dsc' protobuf-c_1.3.3-1.dsc 2099 SHA256:bd97f715a6d4905420393370f8d4b7a0bbfb41339bca92b8e1a3d51ae9a45123
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.3.orig.tar.gz' protobuf-c_1.3.3.orig.tar.gz 500505 SHA256:22956606ef50c60de1fabc13a78fbc50830a0447d780467d3c519f84ad527e78
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.3.3-1.debian.tar.xz' protobuf-c_1.3.3-1.debian.tar.xz 4400 SHA256:67c41d68f57fc035ce9b9eba97c8d7f3463ac3c4cb4bb39c4d22b5c58ee24381
```

Other potentially useful URLs:

- https://sources.debian.net/src/protobuf-c/1.3.3-1/ (for browsing the source)
- https://sources.debian.net/src/protobuf-c/1.3.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/protobuf-c/1.3.3-1/ (for access to the source package after it no longer exists in the archive)
