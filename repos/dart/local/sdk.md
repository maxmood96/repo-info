...
- Created: `2025-11-04T04:14:48.298869906Z`
...
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.20.15-1%7edeb13u1.dsc' bind9_9.20.15-1~deb13u1.dsc 3197 SHA256:a327e32c45d6b72613a20a2a36edf6650f234735d1c9d1dc33f55544aa263a60
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.20.15.orig.tar.xz' bind9_9.20.15.orig.tar.xz 5765964 SHA256:d62b38fae48ba83fca6181112d0c71018d8b0f2ce285dc79dc6a0367722ccabb
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.20.15.orig.tar.xz.asc' bind9_9.20.15.orig.tar.xz.asc 833 SHA256:2e9215f01c68734fd03b207dc1dd62fe32af79d02fe8182002529faaca6c9361
'http://deb.debian.org/debian-security/pool/updates/main/b/bind9/bind9_9.20.15-1%7edeb13u1.debian.tar.xz' bind9_9.20.15-1~deb13u1.debian.tar.xz 61900 SHA256:ab95e35c4eb58cedf6fb3dece49ba2e4323a0cfd0ed6fc7ac03e1dfe5deec781
```
...
### `dpkg` source package: `fstrm=0.6.1-1`

Binary Packages:

- `libfstrm0:amd64=0.6.1-1+b3`
...
```console
$ apt-get source -qq --print-uris fstrm=0.6.1-1
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.1-1.dsc' fstrm_0.6.1-1.dsc 1937 SHA256:f42ca88ddc54acb39fcaa6a2f7cda3d70a9f256b83e6044ea56cd8bb5f90d37d
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.1.orig.tar.gz' fstrm_0.6.1.orig.tar.gz 135425 SHA256:4f0f7ad2b760119c441aba58271e84de683b3cc138530d02710896641866e2d2
'http://deb.debian.org/debian/pool/main/f/fstrm/fstrm_0.6.1-1.debian.tar.xz' fstrm_0.6.1-1.debian.tar.xz 3632 SHA256:bdeb41cf8d70ed9e804990d7026861334027766d09201635d808eefbff3aa457
```

Other potentially useful URLs:

- https://sources.debian.net/src/fstrm/0.6.1-1/ (for browsing the source)
- https://sources.debian.net/src/fstrm/0.6.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/fstrm/0.6.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `jemalloc=5.3.0-3`

Binary Packages:

- `libjemalloc2:amd64=5.3.0-3`
...
```console
$ apt-get source -qq --print-uris jemalloc=5.3.0-3
'http://deb.debian.org/debian/pool/main/j/jemalloc/jemalloc_5.3.0-3.dsc' jemalloc_5.3.0-3.dsc 2030 SHA256:e83aab73c22240f9600c1265fd3120649f2da95fc8196c8f5c254355aafad183
'http://deb.debian.org/debian/pool/main/j/jemalloc/jemalloc_5.3.0.orig.tar.bz2' jemalloc_5.3.0.orig.tar.bz2 736023 SHA256:2db82d1e7119df3e71b7640219b6dfe84789bc0537983c3b7ac4f7189aecfeaa
'http://deb.debian.org/debian/pool/main/j/jemalloc/jemalloc_5.3.0-3.debian.tar.xz' jemalloc_5.3.0-3.debian.tar.xz 16064 SHA256:9c71e65b798052e412478b2dce84226c95414f87bd15ed229d7f50cb531f1095
```

Other potentially useful URLs:

- https://sources.debian.net/src/jemalloc/5.3.0-3/ (for browsing the source)
...
### `dpkg` source package: `json-c=0.18+ds-1`

Binary Packages:

- `libjson-c5:amd64=0.18+ds-1`
...
```console
$ apt-get source -qq --print-uris json-c=0.18+ds-1
'http://deb.debian.org/debian/pool/main/j/json-c/json-c_0.18%2bds-1.dsc' json-c_0.18+ds-1.dsc 2102 SHA256:30f35cab8f920a6481e5fb8e58e789c59dd92945b82a2bcb9cf640a6e6e88594
'http://deb.debian.org/debian/pool/main/j/json-c/json-c_0.18%2bds.orig.tar.xz' json-c_0.18+ds.orig.tar.xz 159264 SHA256:f6439962c9622c1f9f4746d5b3daf5e0800c335281b048fab00159f2a29d7daa
'http://deb.debian.org/debian/pool/main/j/json-c/json-c_0.18%2bds-1.debian.tar.xz' json-c_0.18+ds-1.debian.tar.xz 8984 SHA256:01c6b44a9c3cbf33f8eba7f83bc78dd8f4c84a8e1f3e41314d1d2357d0316100
```

Other potentially useful URLs:

- https://sources.debian.net/src/json-c/0.18+ds-1/ (for browsing the source)
- https://sources.debian.net/src/json-c/0.18+ds-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/json-c/0.18+ds-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `liburcu=0.15.2-2`

Binary Packages:

- `liburcu8t64:amd64=0.15.2-2`

Licenses: (parsed from: `/usr/share/doc/liburcu8t64/copyright`)
...
```console
$ apt-get source -qq --print-uris liburcu=0.15.2-2
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.15.2-2.dsc' liburcu_0.15.2-2.dsc 2294 SHA256:0b96c347fe81db8e8bd0da890d6b1633b864b23a403de065cc813008e42b6ae4
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.15.2.orig.tar.bz2' liburcu_0.15.2.orig.tar.bz2 684018 SHA256:59f36f2b8bda1b7620a7eced2634f26c549444818a8313025a3bb09c0766a61d
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.15.2.orig.tar.bz2.asc' liburcu_0.15.2.orig.tar.bz2.asc 488 SHA256:ed81e1f48d6a29df65ed136631e5da369c61aa376accf32ccefce95282b94268
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.15.2-2.debian.tar.xz' liburcu_0.15.2-2.debian.tar.xz 18816 SHA256:be7dbd5e0ce9c18bc7a3073acf265a890b24e6741fa2b749d0025dec9abda277
```

Other potentially useful URLs:

- https://sources.debian.net/src/liburcu/0.15.2-2/ (for browsing the source)
- https://sources.debian.net/src/liburcu/0.15.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/liburcu/0.15.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `lmdb=0.9.31-1`

Binary Packages:

- `liblmdb0:amd64=0.9.31-1+b2`
...
```console
$ apt-get source -qq --print-uris lmdb=0.9.31-1
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.31-1.dsc' lmdb_0.9.31-1.dsc 2030 SHA256:76262c17115458e3ab423cc7eeb7d16cee46d5ca76a660a8f2bdbab93473457b
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.31.orig.tar.gz' lmdb_0.9.31.orig.tar.gz 145086 SHA256:d35d4f6f46313d62fd342c9dcbf574432919ce5e802d2b6cbe2ebd549821e5c4
'http://deb.debian.org/debian/pool/main/l/lmdb/lmdb_0.9.31-1.debian.tar.xz' lmdb_0.9.31-1.debian.tar.xz 6460 SHA256:926309e655186f7107c70b7b2d5020215aefd08b0902b1c8282e123c9584080a
```

Other potentially useful URLs:

- https://sources.debian.net/src/lmdb/0.9.31-1/ (for browsing the source)
- https://sources.debian.net/src/lmdb/0.9.31-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lmdb/0.9.31-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `protobuf-c=1.5.1-1`

Binary Packages:

- `libprotobuf-c1:amd64=1.5.1-1`
...
```console
$ apt-get source -qq --print-uris protobuf-c=1.5.1-1
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.5.1-1.dsc' protobuf-c_1.5.1-1.dsc 2060 SHA256:3909be2fc4586eb21d3249dc35320f7794cf070d6196d116c59ef4676553f6ed
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.5.1.orig.tar.gz' protobuf-c_1.5.1.orig.tar.gz 531693 SHA256:20d1dc257da96f8ddff8be4dd9779215bbd0a6069ed53bbe9de38fa7629be06b
'http://deb.debian.org/debian/pool/main/p/protobuf-c/protobuf-c_1.5.1-1.debian.tar.xz' protobuf-c_1.5.1-1.debian.tar.xz 4576 SHA256:1da0623adb42dd51a87b94c1a0f0e652d57d865c59c15cf43e034c4aa1690663
```

Other potentially useful URLs:

- https://sources.debian.net/src/protobuf-c/1.5.1-1/ (for browsing the source)
- https://sources.debian.net/src/protobuf-c/1.5.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/protobuf-c/1.5.1-1/ (for access to the source package after it no longer exists in the archive)
