...
```console
$ docker pull unit@sha256:ae9a0084ca7fa5723373963a14442ed6f619257fefc687e81d717c488c0e673e
```
...
```console
$ docker pull unit@sha256:4c4d6add6da539a2a5ed316de9c159595c897bf71180a621d17d49342271a89c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.3 MB (68259580 bytes)**  
...
-	Layers:
	...
	-	`sha256:997762e48473faa6008cfee212554a22ee33e0932889ab6cec14dcffff01fdc0`  
		...
		Size: 249.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a7d21df0613370ead4b1cb4f095d7b2dc0418c20a9a974a809fb706abd0a398`  
		Last Modified: Fri, 16 May 2025 13:28:46 GMT  
		Size: 23.9 MB (23923998 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:319f1df2f3b921b65585eca450fc45d29a4b03cb88792c220273dd81c0a5d45f`  
		Last Modified: Thu, 15 May 2025 19:34:29 GMT  
		Size: 1.3 KB (1262 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cb61fc455375f47f1e506b0c0e8ac2dd1614934665e65ce8a20cc44f6b093c4b`  
		Last Modified: Thu, 15 May 2025 19:34:29 GMT  
...
```console
$ docker pull unit@sha256:84b6e8c6b63ff7ffb404b4ae3ebef9e5a72bd16cbba2f3258a0d1eb717219086
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.7 KB (26719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4213e402859cb2b173756c0a3a298928dc1c7ca827bdc3fbce5539c5e7b88377`

```dockerfile
```

-	Layers:
	-	`sha256:8eed0456464d78512502e56df9a1d722c406a0c8809037861759737459bb27f3`  
		Last Modified: Sat, 10 May 2025 00:11:54 GMT  
...
```console
$ docker pull unit@sha256:1abe89a91c4283f6ac903c8092642f1a7802900c37a5316cc2e48250f0c19003
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **67.2 MB (67182643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fe169fb2d9f22941dbd40165967f9251cc01ea8739b3f916dab373042ddbae1`
-	Entrypoint: `["\/usr\/local\/bin\/docker-entrypoint.sh"]`
-	Default Command: `["unitd","--no-daemon","--control","unix:\/var\/run\/control.unit.sock"]`
...
-	Layers:
	...
	-	`sha256:867244661c52679fd8388356e5b3180e2d68e96045109d2d9e8223c907d4aba7`  
		...
		Size: 250.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1a19719688a033588a0e6952f75e053fdfbbb02d99d68f5f7c52c69bec65670f`  
		Last Modified: Mon, 19 May 2025 13:35:22 GMT  
		Size: 23.3 MB (23295423 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5766432e76c5b8b238617b396cff7d7723c9cda37cd9e0193cd910db94a8f817`  
		Last Modified: Mon, 19 May 2025 13:35:21 GMT  
		Size: 1.3 KB (1262 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4d72ab4f6aedd3ec3449c5fca6c3c2b59119f5b0bb0430ff9fc601d0f4152462`  
		Last Modified: Mon, 19 May 2025 13:35:22 GMT  
...
```console
$ docker pull unit@sha256:409f4f61dd00cc809994a601eafb91b6acb714f6a1825d6ed80bff94ad6f9d59
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.8 KB (26822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04ab11d112a2a9f1b794e4d3147861043dde34b4cf6d9081711d5c8682516ec9`

```dockerfile
```

-	Layers:
	-	`sha256:06514a821b5e0970fab87c8815d3aa3a070785dbf5788769b0feb0f3ff1ad5ab`  
		Last Modified: Sat, 10 May 2025 04:39:00 GMT  
