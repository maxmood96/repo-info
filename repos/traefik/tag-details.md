...
```console
$ docker pull traefik@sha256:15fb6274da4d04e02fb6af08af897d1cd3ac5dcac39a089c457a5edb57fb28f9
```
...
```console
$ docker pull traefik@sha256:0e1c3e6d5a53a3b0315833587143df0deee479aa168128efb67f8d97ae30528d
```
