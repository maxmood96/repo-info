...
-	[`traefik:2.3.4`](#traefik234)
-	[`traefik:2.3.4-windowsservercore-1809`](#traefik234-windowsservercore-1809)
...
-	[`traefik:v2.3.4`](#traefikv234)
-	[`traefik:v2.3.4-windowsservercore-1809`](#traefikv234-windowsservercore-1809)
...
```console
$ docker pull traefik@sha256:98a2ca34f2ef8f539fb198a052284e114c1cd00948fb3094a9a6336f4a7c4f94
```
...
### `traefik:2.3.4` - linux; arm64 variant v8
...
### `traefik:2.3.4-windowsservercore-1809` - windows version 10.0.17763.1637; amd64
...
### `traefik:v2.3.4` - linux; arm variant v6
...
### `traefik:v2.3.4` - linux; arm64 variant v8
