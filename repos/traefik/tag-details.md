...
```console
$ docker pull traefik@sha256:d791d42b850678998f416d3b02261f9ce3207b472acbe5a3e0721d1bccce0e7c
```
...
### `traefik:2.9.9` - linux; arm64 variant v8
...
### `traefik:v2.9.9` - linux; arm64 variant v8
