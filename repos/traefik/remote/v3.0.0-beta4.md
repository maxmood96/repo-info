...
```console
$ docker pull traefik@sha256:a25aa319fe3cc8095e4b1dcd8394430103a2e324e1af321312b45c266ba3e129
```
...
```console
$ docker pull traefik@sha256:0a22457e7d5eb1a6559371ad4bd1986778015413c2c857dc68f78d5bf56e7e93
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.9 MB (42933391 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:caf88578072d8109d6f8ae3c139bcfc66999e685a9a00c3be448b3e045d93b8b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["traefik"]`
...
RUN apk --no-cache add ca-certificates tzdata
# Fri, 13 Oct 2023 08:53:36 GMT
RUN set -ex; 	apkArch="$(apk --print-arch)"; 	case "$apkArch" in 		armhf) arch='armv6' ;; 		aarch64) arch='arm64' ;; 		x86_64) arch='amd64' ;; 		s390x) arch='s390x' ;; 		*) echo >&2 "error: unsupported architecture: $apkArch"; exit 1 ;; 	esac; 	wget --quiet -O /tmp/traefik.tar.gz "https://github.com/traefik/traefik/releases/download/v3.0.0-beta4/traefik_v3.0.0-beta4_linux_$arch.tar.gz"; 	tar xzvf /tmp/traefik.tar.gz -C /usr/local/bin traefik; 	rm -f /tmp/traefik.tar.gz; 	chmod +x /usr/local/bin/traefik
# Fri, 13 Oct 2023 08:53:38 GMT
COPY file:59a219a1fb7a9dc894a7a9a4718fa97fd24adb0a4a6455240ec2ab0183da796e in / 
# Fri, 13 Oct 2023 08:53:38 GMT
EXPOSE 80
# Fri, 13 Oct 2023 08:53:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Oct 2023 08:53:39 GMT
CMD ["traefik"]
# Fri, 13 Oct 2023 08:53:39 GMT
...
-	Layers:
	...
	-	`sha256:37af407ac96c8e70e35ccb675ba932c1f6a441da5da4bff25fdfee4b8037205c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7694da4b01ddf4a51c516fd603ba70ab63671510e9bacec985a4ed274fe0bb3`  
		Last Modified: Fri, 13 Oct 2023 08:54:07 GMT  
		Size: 39.1 MB (39095082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be41d4d9b711afe5a835f541f9b1abd19b8c978c8a2ccbc94fb164ce1ea15ac1`  
