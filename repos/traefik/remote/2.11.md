...
```console
$ docker pull traefik@sha256:2972c4f1b6218af6c112bc73a0104e46e8f41c53c86803119a9577973270718f
```
...
```console
$ docker pull traefik@sha256:889658483ea6724818af76a72ce327de78ed5e44aaac610944566ad471d1b58a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.1 MB (41061434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ced061c9cd1db9fece848822854bdae585a2e1b2164715a11d9db3f26dd8ac83`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["traefik"]`
...
RUN apk --no-cache add ca-certificates tzdata
# Wed, 03 Jan 2024 23:53:07 GMT
RUN set -ex; 	apkArch="$(apk --print-arch)"; 	case "$apkArch" in 		armhf) arch='armv6' ;; 		aarch64) arch='arm64' ;; 		x86_64) arch='amd64' ;; 		s390x) arch='s390x' ;; 		*) echo >&2 "error: unsupported architecture: $apkArch"; exit 1 ;; 	esac; 	wget --quiet -O /tmp/traefik.tar.gz "https://github.com/traefik/traefik/releases/download/v2.11.0-rc1/traefik_v2.11.0-rc1_linux_$arch.tar.gz"; 	tar xzvf /tmp/traefik.tar.gz -C /usr/local/bin traefik; 	rm -f /tmp/traefik.tar.gz; 	chmod +x /usr/local/bin/traefik
# Wed, 03 Jan 2024 23:53:08 GMT
COPY file:59a219a1fb7a9dc894a7a9a4718fa97fd24adb0a4a6455240ec2ab0183da796e in / 
# Wed, 03 Jan 2024 23:53:08 GMT
EXPOSE 80
# Wed, 03 Jan 2024 23:53:08 GMT
...
-	Layers:
	...
	-	`sha256:d6542b96876e4556908503f37970c866762377a00fca7a15fd9dfc6ef2a43a8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b34fe78f54f1e44bd808678173f6bd6e99be02fb6dcae4089f29bcccab3bcbae`  
		Last Modified: Wed, 03 Jan 2024 23:53:47 GMT  
		Size: 37.3 MB (37272563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c20037572ef0c2f444fea4b2d3399a21c19477de5d758d029fa4d71cf83bf3`  
		Last Modified: Wed, 03 Jan 2024 23:53:40 GMT  
		Size: 368.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
