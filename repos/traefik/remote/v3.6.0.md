...
```console
$ docker pull traefik@sha256:e4153c8abbeaf88bfae33796b1860c584fb937ce31c53d0137012e9bfc3af99b
```
...
### `traefik:v3.6.0` - unknown; unknown
...
### `traefik:v3.6.0` - linux; arm variant v6
...
### `traefik:v3.6.0` - linux; arm64 variant v8
