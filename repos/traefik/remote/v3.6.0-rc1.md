...
```console
$ docker pull traefik@sha256:e3d70a1f07d6084980e894d115441eac1be30dc5602f5af8681682f069ce140c
```
...
### `traefik:v3.6.0-rc1` - linux; amd64
...
### `traefik:v3.6.0-rc1` - unknown; unknown
...
### `traefik:v3.6.0-rc1` - linux; arm variant v6
...
### `traefik:v3.6.0-rc1` - linux; arm64 variant v8
...
### `traefik:v3.6.0-rc1` - linux; ppc64le
...
### `traefik:v3.6.0-rc1` - linux; s390x
