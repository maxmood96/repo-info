...
```console
$ docker pull groovy@sha256:4fa4a531d464c12dfda5824899534f8a7bcbe5a77600556d8a15f348f96595ee
```
...
### `groovy:4.0.0-alpha-3-jdk` - linux; ppc64le
...
### `groovy:4.0.0-alpha-3-jdk` - linux; s390x
