...
```console
$ docker pull groovy@sha256:208eec93229380d275ad5cd3ad2fc752c5ed35e69bab582ef10772b488744dec
```
...
### `groovy:5.0.3-jammy` - linux; amd64
...
### `groovy:5.0.3-jammy` - unknown; unknown
...
### `groovy:5.0.3-jammy` - linux; arm variant v7
...
### `groovy:5.0.3-jammy` - linux; arm64 variant v8
...
### `groovy:5.0.3-jammy` - linux; ppc64le
...
### `groovy:5.0.3-jammy` - linux; s390x
