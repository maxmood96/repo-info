...
```console
$ docker pull groovy@sha256:c64b1dcde741db31f39d937ec71f3ead4431580bcf2c44fed7d14d794e400c86
```
...
```console
$ docker pull groovy@sha256:6b41fcc1db293039be0d97d619ff85f721945b70a4afb980ab8af01b9b992dbb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.4 MB (134386238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98bbd227837afd84a209c4c712acabf47605c9b072937be25182a044e5d2d605`
...
# Tue, 31 Aug 2021 07:30:34 GMT
USER groovy
# Tue, 31 Aug 2021 07:30:35 GMT
...
-	Layers:
	...
	-	`sha256:791a68b985eb5e5e7fe894a91028f5dbb277af2611718e618c00d22e42d7e975`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a2ccc47f694a0033e9d01e37ed6689bf2480ef5765343a6ad75606844cc7556`  
		Last Modified: Tue, 31 Aug 2021 07:35:11 GMT  
		Size: 43.9 MB (43917154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62d2717cafcadea3f794ddf856e5b44d7fbdedf0c265a37e51190ed28c091df2`  
		Last Modified: Tue, 31 Aug 2021 07:35:08 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:6af3d77e45073d2774e8fd6f234ab98b5cb52518518df18feee729207beb84e3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.1 MB (132142860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5f97c9f24c226802d1974017142119bbb2d1935453f8399c5d5f614b934ccfc`
-	Default Command: `["groovysh"]`
...
# Tue, 31 Aug 2021 03:35:24 GMT
ENV GROOVY_VERSION=3.0.8
# Tue, 31 Aug 2021 03:35:35 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver ha.pool.sks-keyservers.net --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy
# Tue, 31 Aug 2021 03:35:36 GMT
USER groovy
# Tue, 31 Aug 2021 03:35:37 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:edc70c79784d739b8937c8c5587ef105be95c0d4c872b38565fd8add67a4ff20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0cf2fd5bcab4637b896f794ade9a1a52be68807dbb4489b08a3bf546777cd53`  
		Last Modified: Tue, 31 Aug 2021 03:41:22 GMT  
		Size: 43.9 MB (43917147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f52db58b7397cba5bb9d665b74444619d494eed7348289a409a541bf4d5cb912`  
		Last Modified: Tue, 31 Aug 2021 03:41:18 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:4ce0cb7dc21eba24cc4e7a156e8a838fad6382df62ba8d3433e1ce855142bc2c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.6 MB (140593672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc04e00f13ea2248b840116f06d532a2edd3a4e5bfbc845f7e32ae9d4b6ea97e`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         fontconfig         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Tue, 31 Aug 2021 07:02:56 GMT
ENV GROOVY_VERSION=3.0.8
# Tue, 31 Aug 2021 07:03:20 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver ha.pool.sks-keyservers.net --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy
# Tue, 31 Aug 2021 07:03:24 GMT
USER groovy
# Tue, 31 Aug 2021 07:03:50 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:7fc9eb799cef2d50fd75c78d7a7183630549a2c6f623ed92a47bbce4831c67a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:975ced86167aaa05b5f0bcf7b14aa867f0161c88016432024b0e2478cabd85f0`  
		Last Modified: Tue, 31 Aug 2021 07:21:04 GMT  
		Size: 43.9 MB (43917160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba2d40cc19e0a65881be35695eba5059546733392cff130d8e8cd81d04cfd3ef`  
		Last Modified: Tue, 31 Aug 2021 07:20:59 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:f8b665d279a017c953539f158fa6a27fd43e7c8f5d05496c6d6487ee1449f611
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **129.7 MB (129690632 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74684499da6947d250543fa39b9bfb0b318df01c3372c9ae72dd92de5cb08c40`
-	Default Command: `["groovysh"]`
...
# Tue, 31 Aug 2021 04:15:30 GMT
ENV GROOVY_VERSION=3.0.8
# Tue, 31 Aug 2021 04:15:45 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver ha.pool.sks-keyservers.net --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy
# Tue, 31 Aug 2021 04:15:47 GMT
USER groovy
# Tue, 31 Aug 2021 04:15:49 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:8af6a632eb87cfbb732b8a305faac70b0d345421f6823a7090157fced65c4bbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:055f8c2e30d4449801176ca800c6cb43805b7835eb721b60a3a008516bcc67b2`  
		Last Modified: Tue, 31 Aug 2021 04:23:57 GMT  
		Size: 43.9 MB (43917145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f21e58f5b8d72bfdb3779e42d5dfa6cf167d93c6a75f386482b2f3dea2bb9910`  
		Last Modified: Tue, 31 Aug 2021 04:23:54 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
