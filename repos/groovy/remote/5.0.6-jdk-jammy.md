...
### `groovy:5.0.6-jdk-jammy` - linux; amd64
...
### `groovy:5.0.6-jdk-jammy` - unknown; unknown
...
### `groovy:5.0.6-jdk-jammy` - linux; arm variant v7
...
### `groovy:5.0.6-jdk-jammy` - linux; arm64 variant v8
...
### `groovy:5.0.6-jdk-jammy` - linux; ppc64le
...
### `groovy:5.0.6-jdk-jammy` - linux; s390x
