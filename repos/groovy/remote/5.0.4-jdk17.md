...
```console
$ docker pull groovy@sha256:c35c39c7dec799126af5faa78a1878886ddb7ae30689b49983ce2ff3b0f4cde1
```
...
### `groovy:5.0.4-jdk17` - linux; amd64
...
### `groovy:5.0.4-jdk17` - unknown; unknown
...
### `groovy:5.0.4-jdk17` - linux; arm variant v7
...
### `groovy:5.0.4-jdk17` - linux; arm64 variant v8
...
### `groovy:5.0.4-jdk17` - linux; ppc64le

```console
$ docker pull groovy@sha256:7c19db90f7dae7363055b6bb37af5b86aefe2c6bf44e2e49067c766cfe8e11f1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.6 MB (238629992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25784b7363318c407c07129f14ac599cbf1a289468acef8aac3539ae63f074e2`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
# Tue, 17 Mar 2026 13:29:53 GMT
ENV GROOVY_VERSION=5.0.4
# Tue, 17 Mar 2026 13:30:09 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && rm --force "${GROOVY_HOME}/lib/groovy-raw-${GROOVY_VERSION}-raw.jar"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy" # buildkit
# Tue, 17 Mar 2026 13:30:09 GMT
USER 1000:1000
# Tue, 17 Mar 2026 13:30:11 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version # buildkit
```
...
-	Layers:
	...
	-	`sha256:789499852ab2ab1dc3729907d1ade0a6ededbc5950fbdfc0af8f73b2af667bf9`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:58dfa12a48e6ead1b3aecd20ba956dce1edfb2404d16ce8e67a0ac2b2ad85158`  
		Last Modified: Tue, 17 Mar 2026 13:30:35 GMT  
		Size: 34.5 MB (34509352 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f628dcb9c7c2bca9633783f6e174780854e9ed3bb5da6caf743b37202ba5318b`  
		Last Modified: Tue, 17 Mar 2026 13:30:34 GMT  
		Size: 140.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull groovy@sha256:3c1478b862c5b8e9d2884587f93f0c3dfccc51f2b57b38fa93e50eb8ffcf8b1b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3708350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eee5d9f77ac467371a5984f4e19bb8013c08ae9191067370aa1eae053755192`

```dockerfile
```

-	Layers:
	-	`sha256:dbd2826427373b4fd2efce38f16d3edca3d5759e782584bb11abf13b4417f4dc`  
		Last Modified: Tue, 17 Mar 2026 13:30:34 GMT  
		Size: 3.7 MB (3681851 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:19186d3e05ac35bbc154890a3c6c2fdcfc796159c297f288be464141925293f0`  
		Last Modified: Tue, 17 Mar 2026 13:30:34 GMT  
		Size: 26.5 KB (26499 bytes)  
		MIME: application/vnd.in-toto+json

### `groovy:5.0.4-jdk17` - linux; riscv64

```console
$ docker pull groovy@sha256:90fba6b0ec43606d9307e806ab5495e07d45572538e526763220112d91454b78
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.6 MB (228553508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39b4a82e9d1714d85aeb85e1ae91fb1314946bb0bbcd27402c055e41ab080bff`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
# Sat, 21 Mar 2026 17:09:07 GMT
ENV GROOVY_VERSION=5.0.4
# Sat, 21 Mar 2026 17:09:20 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && rm --force "${GROOVY_HOME}/lib/groovy-raw-${GROOVY_VERSION}-raw.jar"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy" # buildkit
# Sat, 21 Mar 2026 17:09:20 GMT
USER 1000:1000
# Sat, 21 Mar 2026 17:09:27 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version # buildkit
```
...
-	Layers:
	...
	-	`sha256:ffd01d46d939e8d0e07e20162494f072105a7f5511a3f8027f02c424a7f544e4`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2e06e3e444aad07201244275e6ff95038c32cd3a5e48e1063cbf11f331557df6`  
		Last Modified: Sat, 21 Mar 2026 17:11:57 GMT  
		Size: 34.5 MB (34509360 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:491ce2b54175c45dd3fc6525e76f404d5fb1bafa43a7db165af79053dbcb15fb`  
		Last Modified: Sat, 21 Mar 2026 17:11:51 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull groovy@sha256:0ccccf2aecdc90d4cb6101b67ebf3596f0862c3f67b514107b78ce269a8c49f7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3765920 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63cb369d91866c703614d1a85e701115612aaae2d42877837ed29925122c91de`

```dockerfile
```

-	Layers:
	-	`sha256:7d804ea07d6fd32b220358e39171c00b575c9be1a32ab4a3c90eaa91a9f66615`  
		Last Modified: Sat, 21 Mar 2026 17:11:52 GMT  
		Size: 3.7 MB (3739421 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b57d1a24d9b47da28ee5086d1c9f9798be1865cd5558220eeae5d1ab3fda174f`  
		Last Modified: Sat, 21 Mar 2026 17:11:51 GMT  
		Size: 26.5 KB (26499 bytes)  
		MIME: application/vnd.in-toto+json

### `groovy:5.0.4-jdk17` - linux; s390x
