...
### `groovy:5.0.3-jdk11-jammy` - linux; amd64
...
### `groovy:5.0.3-jdk11-jammy` - unknown; unknown
...
### `groovy:5.0.3-jdk11-jammy` - linux; arm variant v7
...
### `groovy:5.0.3-jdk11-jammy` - linux; arm64 variant v8
...
### `groovy:5.0.3-jdk11-jammy` - linux; ppc64le
...
### `groovy:5.0.3-jdk11-jammy` - linux; s390x
