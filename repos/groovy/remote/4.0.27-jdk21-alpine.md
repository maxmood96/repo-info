...
```console
$ docker pull groovy@sha256:5c94eebdab8c683007c696e669f3d5870b78a6c5873d9126742ed6470fa4ec95
```
...
### `groovy:4.0.27-jdk21-alpine` - linux; amd64
...
### `groovy:4.0.27-jdk21-alpine` - unknown; unknown
