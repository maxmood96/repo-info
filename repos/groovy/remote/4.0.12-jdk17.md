...
```console
$ docker pull groovy@sha256:e3a44d2ecd3749073d56785f6da3b9e0c6b58d5d5b0b5b4308399b1113f99418
```
...
### `groovy:4.0.12-jdk17` - linux; amd64
...
### `groovy:4.0.12-jdk17` - linux; arm variant v7
...
### `groovy:4.0.12-jdk17` - linux; arm64 variant v8
...
### `groovy:4.0.12-jdk17` - linux; ppc64le
...
### `groovy:4.0.12-jdk17` - linux; s390x
