...
### `groovy:5.0.3-jdk25-noble` - linux; amd64
...
### `groovy:5.0.3-jdk25-noble` - unknown; unknown
...
### `groovy:5.0.3-jdk25-noble` - linux; arm64 variant v8
...
### `groovy:5.0.3-jdk25-noble` - linux; ppc64le
...
### `groovy:5.0.3-jdk25-noble` - linux; riscv64
...
### `groovy:5.0.3-jdk25-noble` - linux; s390x
