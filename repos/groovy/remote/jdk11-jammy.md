...
```console
$ docker pull groovy@sha256:d24f56db18585a57e6034661974046ef3a05ddf84210b268dadc95d91c8770f2
```
...
```console
$ docker pull groovy@sha256:2cded81767265d9e8d825daf970b0b2017deba8102875f0ddbdeceb3de4fbbba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.6 MB (274600399 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e56adde20bb0c7a89f51db995e7946cd5742dd5ae4d19cd9bf7745f919cae52`
...
# Wed, 15 Mar 2023 22:28:14 GMT
ENV GROOVY_VERSION=4.0.10
# Wed, 15 Mar 2023 22:28:24 GMT
...
-	Layers:
	...
	-	`sha256:89cda25bf9c812e048c27bda40f0f5f3d17f4d9feea574010acbc4e91429907c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33364573890dd37d13caf374aaadb65b6d5ab2c0bb55f894d587de719a7153ee`  
		Last Modified: Wed, 15 Mar 2023 22:30:16 GMT  
		Size: 29.5 MB (29507768 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad0a68562bf3f0c2404e10a89a71da92218fa0c434f9ef14c42220e56474b629`  
		Last Modified: Wed, 15 Mar 2023 22:30:14 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:4393436866beabcf8e303ec218e7ab24aae4f685033db185680d9234708c4f52
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.4 MB (258358292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54c56db4e1df2944ff825da019d763fbb4ce88ca52db1cce5dd4d34faee1f038`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Wed, 15 Mar 2023 21:57:50 GMT
ENV GROOVY_VERSION=4.0.10
# Wed, 15 Mar 2023 21:58:08 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy"
# Wed, 15 Mar 2023 21:58:08 GMT
USER 1000:1000
# Wed, 15 Mar 2023 21:58:10 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:551dff511f9163821c3b4d3712ce22a1a92cb315fe7454b7a2421224b577d56f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bf92265b5e21bc3fc95a57e93fa3c4e8dcf0b32ca31044057a98b39581161e1`  
		Last Modified: Wed, 15 Mar 2023 22:00:27 GMT  
		Size: 29.5 MB (29507776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f25309081523231cad3e49a31b633ca9bac201f01c78379c29904b081b9cbc72`  
		Last Modified: Wed, 15 Mar 2023 22:00:25 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:ea3e1b784a83dccbdc807c4d3fa8afe19fd59fb0c03b7936bdd695f93c2e08a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.2 MB (269246554 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8de2b3cccb23869237e56b74781fc55981cd9a79143cde9491d84d3d8fc7e586`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Wed, 15 Mar 2023 21:42:47 GMT
ENV GROOVY_VERSION=4.0.10
# Wed, 15 Mar 2023 21:42:59 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy"
# Wed, 15 Mar 2023 21:42:59 GMT
USER 1000:1000
# Wed, 15 Mar 2023 21:43:00 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:f6c9c8aab52336d7978501e47dbc731c4205cb3c98f465bf1908c08bc1d01992`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0622bf5e8337e78c4b23c296fcf569b067e4bfd1d166e85c9b24cb18482fc670`  
		Last Modified: Wed, 15 Mar 2023 21:44:26 GMT  
		Size: 29.5 MB (29507758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e9a8d7860016543a7f289e86cd4c8a16a1cf9c41c839292f2b726f57071fd8`  
		Last Modified: Wed, 15 Mar 2023 21:44:24 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
