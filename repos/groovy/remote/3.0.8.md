...
```console
$ docker pull groovy@sha256:a6398f0f0df1d9eadeb916b64ff3e39daa5e0c98220007d6009090716b36f27f
```
...
### `groovy:3.0.8` - linux; arm64 variant v8
