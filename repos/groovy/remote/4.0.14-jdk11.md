...
```console
$ docker pull groovy@sha256:eaa01374816ffd979b4ab1ced0d07c8a7d939761e6271b902314a45b7f5b6af6
```
...
```console
$ docker pull groovy@sha256:dff21b83db0710b34e53d3f04df1888d5734130a444bdc3eb5207cd1ec19477f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.6 MB (221593821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20722db2158dca1e479af4feb59201ec760585e901f539e9876190e43cae5000`
...
# Tue, 22 Aug 2023 20:21:53 GMT
ENV GROOVY_VERSION=4.0.14
# Tue, 22 Aug 2023 20:22:02 GMT
...
-	Layers:
	...
	-	`sha256:ad32d6d9413cb60612d89a340d8697024804e4b9f31d8e375356237cf44ebb85`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a05a8124c98fa12078f3c80d0b5fd8346fe14696f2dce08c7598a6e2c2d857f6`  
		Last Modified: Tue, 22 Aug 2023 20:24:20 GMT  
		Size: 29.7 MB (29669266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e89c3ab7dbafad0135f943f87593d0c8a0e3b8f5dce562e02df133d89488a71`  
		Last Modified: Tue, 22 Aug 2023 20:24:17 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:cd04c29f4aeca20339999fb82a203b484944422e57b118a95304edb866fd4a23
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.5 MB (210478835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69623d5e48282bce753759f3c70310b79b87813574686ddd4e4de267d997fa1b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Tue, 22 Aug 2023 19:57:37 GMT
ENV GROOVY_VERSION=4.0.14
# Tue, 22 Aug 2023 19:57:46 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy"
# Tue, 22 Aug 2023 19:57:47 GMT
USER 1000:1000
# Tue, 22 Aug 2023 19:57:48 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:7c04810cfc3e42e5f29529da9657bd614c921fdcf88dfba9d69f3a07e3bdd789`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be9cc4162d8c63b6b6bc2ab34f032c531391146572ad488dede3bf261ab194f5`  
		Last Modified: Tue, 22 Aug 2023 19:58:51 GMT  
		Size: 29.7 MB (29669283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57f27f44e5068606b50fecc01ecde0a3b350a8a581523dd602d8b6502d85bf31`  
		Last Modified: Tue, 22 Aug 2023 19:58:48 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:c09f957d5a6fffdac701c283b1e208acf80f6fb87ffdb65d36bc8a00bedcb13c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.2 MB (216191182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8824a37206f77d9e8c7fb2043ba18ba857f4ae04c55891238c996dddc7ef8f5`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Tue, 22 Aug 2023 19:42:40 GMT
ENV GROOVY_VERSION=4.0.14
# Tue, 22 Aug 2023 19:42:51 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy"
# Tue, 22 Aug 2023 19:42:51 GMT
USER 1000:1000
# Tue, 22 Aug 2023 19:42:52 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:5bbbc2b7a062465a8a6ec76a60cb31852960a0a27455192d097b8d359ecb1d9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74a90877efe202bded584ae7688e983a5020b06e8e42fa37124d1d818def71dc`  
		Last Modified: Tue, 22 Aug 2023 19:43:58 GMT  
		Size: 29.7 MB (29669282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc110f365cbe05c570001ad002f94b5696d6af5440e91aeae8ec68855748392`  
		Last Modified: Tue, 22 Aug 2023 19:43:57 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:175a04fb80520b1b12c2a10b5bc08bdd7162aed83edf6b6ae860d81aaa5010ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.6 MB (215607178 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa0b48e626589352d8f2969682e9bd3ce51ef1ed3b616eea11b975c6c9c5502b`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
-	Layers:
	...
	-	`sha256:fc78c3f2e97c4593ccc306e4068b44b2aaed1f9bd7ca7a0f90b974e892f1f362`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1792c9c4f2af681eb50bff905996866176e2e3d3c6963e01e5d7e5a3678e915a`  
		Last Modified: Tue, 22 Aug 2023 20:23:39 GMT  
		Size: 29.7 MB (29669278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4c6baaa9a87f83d22738c23f604d32082982bf4acf7b89661cc86e74d474d3b`  
		Last Modified: Tue, 22 Aug 2023 20:23:28 GMT  
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:b4dcd5fd89c92273608b966323bceb2137598b6fc7f615bc9d857ea39e2aa127
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.1 MB (200083655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d83c613dd47193d428b1e57408b0361894fbf7c7be6e87ef6b5e4c84f983790f`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
RUN apt-get update     && echo "Installing build dependencies"     && apt-get install --yes --no-install-recommends         dirmngr         gnupg         unzip         wget     && rm --recursive --force /var/lib/apt/lists/*
# Tue, 22 Aug 2023 19:43:18 GMT
ENV GROOVY_VERSION=4.0.14
# Tue, 22 Aug 2023 19:43:29 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy"
# Tue, 22 Aug 2023 19:43:30 GMT
USER 1000:1000
# Tue, 22 Aug 2023 19:43:31 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version
```
...
-	Layers:
	...
	-	`sha256:067be3a73561424cbba21d58b876c7d03e81b42e3bad7d6d9fc253a27e50621d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47a467efc11aa66461cd2580c966656c39f5cf1d1bb818dd83b269f72ca1f326`  
		Last Modified: Tue, 22 Aug 2023 19:44:17 GMT  
		Size: 29.7 MB (29669258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d0f36cea652a250c676c54a0a546734581699d2aff7c42c5aecab0ccccd6ece`  
		Last Modified: Tue, 22 Aug 2023 19:44:14 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
