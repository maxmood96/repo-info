...
```console
$ docker pull groovy@sha256:896afb15ea7fa83e6c90dbb9c80a349b750971bf097d3ed6780099d728fd4121
```
...
### `groovy:4.0.30-jdk-jammy` - linux; amd64
...
### `groovy:4.0.30-jdk-jammy` - unknown; unknown
...
### `groovy:4.0.30-jdk-jammy` - linux; arm variant v7
...
### `groovy:4.0.30-jdk-jammy` - linux; arm64 variant v8
...
### `groovy:4.0.30-jdk-jammy` - linux; ppc64le
...
### `groovy:4.0.30-jdk-jammy` - linux; s390x
