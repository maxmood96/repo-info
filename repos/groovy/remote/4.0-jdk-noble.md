...
```console
$ docker pull groovy@sha256:3ac0c2055c4fdbaa1faa8fca19e3127053e101d61efd341cbf221fbfbd6ee2f1
```
...
```console
$ docker pull groovy@sha256:0ab220457baf863da78f0f68adc3adb724df5777139f88ca404cf3369d9ac40d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.7 MB (239746379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:492279c848cc0cead92a8fe998c91e20b037a2276b19beaf4fa2be7f8eb81904`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
-	Layers:
	...
	-	`sha256:eb16d5821ee33f1281926d03a505976d51f051dd7a4b837f6f0f40b194cd6331`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f2d2c64d037e5b154cf6a2c4e794498e33833ca794933928a35c2350f7d1b44`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8283f4900a891cc0b185592e6a30a7f86b69b5b490fbea6e8198595edf8f7f4e`  
		Last Modified: Tue, 17 Feb 2026 21:20:43 GMT  
		Size: 241.6 KB (241619 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d3a5cf8ad2a40f3cbe1e9964812dc6402d44e03375629f94af27ceec1ef7d123`  
		Last Modified: Tue, 17 Feb 2026 21:20:44 GMT  
		Size: 30.3 MB (30328595 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:92fde07061f24a08512c5a991771f608c06ae92d2af29373239e65aeb4c6a8db`  
		Last Modified: Tue, 17 Feb 2026 21:20:43 GMT  
		Size: 139.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull groovy@sha256:bdc042a817eaabf74f809dac96998a93f26b69c8ace121fb5436bfd5f5e9f7f6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3784827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:198f582701fe3e3ef0bb12deb297f073a1a62be11f0ccee360e1a9252988d4a4`

```dockerfile
```

-	Layers:
	-	`sha256:517e533d3479c1802b88230525c6dff6270c426734414586ad3a92bfb1e2155e`  
		Last Modified: Tue, 17 Feb 2026 21:20:43 GMT  
		Size: 3.8 MB (3755051 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5fc6a2f6b7b22f7d0bde9e379021d971d6fc5546e629bffca44fc6ad74b7943b`  
		Last Modified: Tue, 17 Feb 2026 21:20:43 GMT  
...
```console
$ docker pull groovy@sha256:70833882944bd4ec1f949db93ce21de79ce1a73f36a9b2ebce85898ba89fe3de
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.9 MB (238909639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db9fdb5bd021e9f5316ffd65828a552158e920957c089a3079a0b788eb6360d7`
-	Entrypoint: `["\/__cacert_entrypoint.sh"]`
-	Default Command: `["groovysh"]`
...
# Sun, 08 Feb 2026 06:04:34 GMT
ENV GROOVY_VERSION=4.0.30
# Sun, 08 Feb 2026 06:12:31 GMT
RUN set -o errexit -o nounset     && echo "Downloading Groovy"     && wget --no-verbose --output-document=groovy.zip "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip"         && echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server"     && export GNUPGHOME="$(mktemp -d)"     && gpg --batch --no-tty --keyserver keyserver.ubuntu.com --recv-keys         7FAA0F2206DE228F0DB01AD741321490758AAD6F         331224E1D7BE883D16E8A685825C06C827AF6B66         34441E504A937F43EB0DAEF96A65176A0FB1CD0B         9A810E3B766E089FFB27C70F11B595CEDC4AEBB5         81CABC23EECA0790E8989B361FF96E10F0E13706         && echo "Checking download signature"     && wget --no-verbose --output-document=groovy.zip.asc "https://archive.apache.org/dist/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc"     && gpg --batch --no-tty --verify groovy.zip.asc groovy.zip     && rm --recursive --force "${GNUPGHOME}"     && rm groovy.zip.asc         && echo "Installing Groovy"     && unzip groovy.zip     && rm groovy.zip     && mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/"     && rm --force "${GROOVY_HOME}/lib/groovy-raw-${GROOVY_VERSION}-raw.jar"     && ln --symbolic "${GROOVY_HOME}/bin/grape" /usr/bin/grape     && ln --symbolic "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy     && ln --symbolic "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc     && ln --symbolic "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole     && ln --symbolic "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc     && ln --symbolic "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh     && ln --symbolic "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy         && echo "Editing startGroovy to include java.xml.bind module"     && sed --in-place 's|startGroovy ( ) {|startGroovy ( ) {\n    JAVA_OPTS="$JAVA_OPTS --add-modules=ALL-SYSTEM"|' "${GROOVY_HOME}/bin/startGroovy" # buildkit
# Sun, 08 Feb 2026 06:12:31 GMT
USER 1000:1000
# Sun, 08 Feb 2026 06:12:37 GMT
RUN set -o errexit -o nounset     && echo "Testing Groovy installation"     && groovy --version # buildkit
```
...
-	Layers:
	...
	-	`sha256:79491aa3832b56fc9373c3d8688c61976c7a792ccbff3aa77b38630d64ae40c9`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b0a9edd49ce85cd8ea28fa8b5473552d4ec072ff4733769aaa8afa82e3907bfb`  
		Last Modified: Sun, 08 Feb 2026 06:15:10 GMT  
		Size: 30.3 MB (30328591 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a51d4f5da705145b011d6f1ce9ce9b26517ed0d4969ea496ed15bf99ff6062bc`  
		Last Modified: Sun, 08 Feb 2026 06:15:05 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull groovy@sha256:198ea9b09dc9a5f927c63112ae3da53a099959e5e53054da7e694b081f542416
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3760280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4d6576321209b797835992f0f16ae84722026ecb8cfcd0cf663781374fb9244`

```dockerfile
```

-	Layers:
	-	`sha256:be293a92b6324519bb416b8aa577ce1ac2dacd82441bf051341a66cef1e7b460`  
		Last Modified: Sun, 08 Feb 2026 06:15:06 GMT  
		Size: 3.7 MB (3730687 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:969279d925cf143ae2830743f2dfc203d21c489de62a053466c75503392ee852`  
		Last Modified: Sun, 08 Feb 2026 06:15:05 GMT  
		Size: 29.6 KB (29593 bytes)  
		MIME: application/vnd.in-toto+json
