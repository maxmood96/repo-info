...
### `dpkg` source package: `distro-info-data=0.43ubuntu1.14`
...
```console
$ apt-get source -qq --print-uris distro-info-data=0.43ubuntu1.14
'http://archive.ubuntu.com/ubuntu/pool/main/d/distro-info-data/distro-info-data_0.43ubuntu1.14.dsc' distro-info-data_0.43ubuntu1.14.dsc 1742 SHA512:89993f027148f75e31de95c901ee95e2ca4e9348d9f5ccd0b4d0478d0b31e15f8084ec2a088228da4e21b0bae2319df70f03919c585a62fe7934a07ca6f9601a
'http://archive.ubuntu.com/ubuntu/pool/main/d/distro-info-data/distro-info-data_0.43ubuntu1.14.tar.xz' distro-info-data_0.43ubuntu1.14.tar.xz 8216 SHA512:148191445c1f9539b3657804bdb11e844c0ec7b7f573682fab9752ea9a35259553a852781f158311798fc6f549c858093eaee2ff976bdae8b4ad3eefd88585b0
```
...
'http://archive.ubuntu.com/ubuntu/pool/universe/f/freeimage/freeimage_3.18.0%2bds2-1ubuntu3.dsc' freeimage_3.18.0+ds2-1ubuntu3.dsc 2667 SHA256:870a30dce6ce7e2b3437280beae2e694b23ae8326be17b5d6fa83006379c147c
'http://archive.ubuntu.com/ubuntu/pool/universe/f/freeimage/freeimage_3.18.0%2bds2.orig.tar.xz' freeimage_3.18.0+ds2.orig.tar.xz 1281524 SHA256:4425d04d4691084260848d67eb79949ea7c129d85c73a72066ba609fd3f3aa39
...
### `dpkg` source package: `gazebo11=11.14.0-1~focal`

Binary Packages:

- `gazebo11=11.14.0-1~focal`
- `gazebo11-common=11.14.0-1~focal`
- `gazebo11-plugin-base=11.14.0-1~focal`
- `libgazebo11:amd64=11.14.0-1~focal`
- `libgazebo11-dev:amd64=11.14.0-1~focal`
...
```console
$ apt-get source -qq --print-uris gazebo11=11.14.0-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/g/gazebo11/gazebo11_11.14.0-1%7efocal.dsc' gazebo11_11.14.0-1~focal.dsc 2682 SHA256:4387fa0dedb4d61dacc5a6243014f1205fb528dd34097bc2f10791490e7f6370
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/g/gazebo11/gazebo11_11.14.0.orig.tar.bz2' gazebo11_11.14.0.orig.tar.bz2 56640328 SHA256:7e9842c046c9e0755355b274c240a8abbf4e962be7ce7b7f59194e5f4b584f45
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/g/gazebo11/gazebo11_11.14.0-1%7efocal.debian.tar.xz' gazebo11_11.14.0-1~focal.debian.tar.xz 6984 SHA256:7ac2b36f30a0eafeec42915ad1eae3ef06016e221eeafcca1d72d931297d5990
```
...
### `dpkg` source package: `ignition-cmake2=2.17.1-1~focal`

Binary Packages:

- `libignition-cmake2-dev:amd64=2.17.1-1~focal`
...
```console
$ apt-get source -qq --print-uris ignition-cmake2=2.17.1-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-cmake2/ignition-cmake2_2.17.1-1%7efocal.dsc' ignition-cmake2_2.17.1-1~focal.dsc 1128 SHA256:da238e94947164a23b24f162366909fa86d66a9d3918a7c99dc7998c2b2cb41b
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-cmake2/ignition-cmake2_2.17.1.orig.tar.bz2' ignition-cmake2_2.17.1.orig.tar.bz2 205001 SHA256:3b678f90d2db79912cfbe4c93f3eed695b8a391847fe9e6454f1c6366370650c
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-cmake2/ignition-cmake2_2.17.1-1%7efocal.debian.tar.xz' ignition-cmake2_2.17.1-1~focal.debian.tar.xz 1948 SHA256:534aa8df154fca191a828896ff00e173953bdae17212f0ebc2849e386f8296c3
```

### `dpkg` source package: `ignition-common3=3.16.0-1~focal`

Binary Packages:

- `libignition-common3:amd64=3.16.0-1~focal`
- `libignition-common3-av:amd64=3.16.0-1~focal`
- `libignition-common3-av-dev:amd64=3.16.0-1~focal`
- `libignition-common3-core-dev:amd64=3.16.0-1~focal`
- `libignition-common3-dev:amd64=3.16.0-1~focal`
- `libignition-common3-events:amd64=3.16.0-1~focal`
- `libignition-common3-events-dev:amd64=3.16.0-1~focal`
- `libignition-common3-graphics:amd64=3.16.0-1~focal`
- `libignition-common3-graphics-dev:amd64=3.16.0-1~focal`
- `libignition-common3-profiler:amd64=3.16.0-1~focal`
- `libignition-common3-profiler-dev:amd64=3.16.0-1~focal`
...
```console
$ apt-get source -qq --print-uris ignition-common3=3.16.0-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-common3/ignition-common3_3.16.0-1%7efocal.dsc' ignition-common3_3.16.0-1~focal.dsc 2691 SHA256:b8b04e500c8bf4430e9d14dd6a9d0dfe376e93ccbe3be9a3bf60da01e85b0f98
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-common3/ignition-common3_3.16.0-1%7efocal.tar.xz' ignition-common3_3.16.0-1~focal.tar.xz 7372524 SHA256:5a25960868e577e65b549af17954056cedb4106d57c43c608ec02d5f85f1aaff
```
...
- `libignition-fuel-tools4-dev:amd64=4.9.0-1~focal`
...
### `dpkg` source package: `ignition-math6=6.15.0-1~focal`

Binary Packages:

- `libignition-math6:amd64=6.15.0-1~focal`
- `libignition-math6-dev:amd64=6.15.0-1~focal`
...
```console
$ apt-get source -qq --print-uris ignition-math6=6.15.0-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-math6/ignition-math6_6.15.0-1%7efocal.dsc' ignition-math6_6.15.0-1~focal.dsc 2016 SHA256:4708c85993e39477ce19229217a00c5d65cf5a34cc100bd36a14f9d9ee9ad3f6
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-math6/ignition-math6_6.15.0.orig.tar.bz2' ignition-math6_6.15.0.orig.tar.bz2 514582 SHA256:f89ff9d592a73365fbfed49a96c66535953b66bd0178a29963b6de7c6dc346db
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-math6/ignition-math6_6.15.0-1%7efocal.debian.tar.xz' ignition-math6_6.15.0-1~focal.debian.tar.xz 4920 SHA256:fdbb4a78ca20cabcac1c837a1773730ca7a990378eedb58df6830cddbb898e0d
```
...
```console
$ apt-get source -qq --print-uris ignition-msgs5=5.11.0-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-msgs5/ignition-msgs5_5.11.0-1%7efocal.dsc' ignition-msgs5_5.11.0-1~focal.dsc 1390 SHA256:6906e3293e7fddc560300e572bbd8e30680b74a81ae492f3a4bf5c525f6e3f51
...
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-msgs5/ignition-msgs5_5.11.0-1%7efocal.debian.tar.xz' ignition-msgs5_5.11.0-1~focal.debian.tar.xz 2244 SHA256:71cfaa6c15b54eed3e968892b2d2aa01063f9dfc6eb73ff2331a989f5a5331d2
```
...
### `dpkg` source package: `ignition-transport8=8.4.0-3~focal`

Binary Packages:

- `libignition-transport8:amd64=8.4.0-3~focal`
- `libignition-transport8-core-dev:amd64=8.4.0-3~focal`
- `libignition-transport8-dev:amd64=8.4.0-3~focal`
- `libignition-transport8-log:amd64=8.4.0-3~focal`
- `libignition-transport8-log-dev:amd64=8.4.0-3~focal`
...
```console
$ apt-get source -qq --print-uris ignition-transport8=8.4.0-3~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-transport8/ignition-transport8_8.4.0-3%7efocal.dsc' ignition-transport8_8.4.0-3~focal.dsc 2263 SHA256:72662ac3c6aab7c8d63ce05b6a0f8e8600353c31564e47d1672df05666b25e9a
...
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/i/ignition-transport8/ignition-transport8_8.4.0-3%7efocal.debian.tar.xz' ignition-transport8_8.4.0-3~focal.debian.tar.xz 3844 SHA256:69485512748bbcd8ac32fb4f9e39b9b0311b58b8ed475a70e6daa3965727b262
```
...
- `krb5-multidev:amd64=1.17-6ubuntu4.4`
...
- `libkrb5-dev:amd64=1.17-6ubuntu4.4`
...
- `libmysqlclient-dev=8.0.35-0ubuntu0.20.04.1`
...
- `libssl-dev:amd64=1.1.1f-1ubuntu2.20`
...
### `dpkg` source package: `ruby2.7=2.7.0-5ubuntu1.12`
...
```console
$ apt-get source -qq --print-uris ruby2.7=2.7.0-5ubuntu1.12
'http://archive.ubuntu.com/ubuntu/pool/main/r/ruby2.7/ruby2.7_2.7.0-5ubuntu1.12.dsc' ruby2.7_2.7.0-5ubuntu1.12.dsc 2582 SHA512:736647e5c2f21364090ad54f6b22287a53a1a9444861e9a4c4e10fbf1a6d858438249794b750125cfbc8917a95c7a2da4c34d78fcfb59dc300bf496db3dfb403
...
'http://archive.ubuntu.com/ubuntu/pool/main/r/ruby2.7/ruby2.7_2.7.0-5ubuntu1.12.debian.tar.xz' ruby2.7_2.7.0-5ubuntu1.12.debian.tar.xz 133036 SHA512:0e8c0aca57f1cc9a2c7846599af5c6c24783385c690568e786225467c11544c5b762ac77b33822b20905cfb01ef65b40242c6380601744b7e83c412ee9320224
```
...
### `dpkg` source package: `sdformat9=9.10.0-1~focal`

Binary Packages:

- `libsdformat9:amd64=9.10.0-1~focal`
- `libsdformat9-dev:amd64=9.10.0-1~focal`
- `sdformat9-sdf=9.10.0-1~focal`
...
```console
$ apt-get source -qq --print-uris sdformat9=9.10.0-1~focal
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/s/sdformat9/sdformat9_9.10.0-1%7efocal.dsc' sdformat9_9.10.0-1~focal.dsc 1383 SHA256:146ba5a8b8f1753af2b1fb0f8a17404ef7981c4b8c6eaf1994d786142e43a587
...
'http://packages.osrfoundation.org/gazebo/ubuntu-stable/pool/main/s/sdformat9/sdformat9_9.10.0-1%7efocal.debian.tar.xz' sdformat9_9.10.0-1~focal.debian.tar.xz 3608 SHA256:f706648251082d55e145822addde43124e37ee79840227026f4bf927059436b8
```
...
- `libtiff-dev:amd64=4.1.0+git191117-2ubuntu0.20.04.11`
- `libtiff5:amd64=4.1.0+git191117-2ubuntu0.20.04.11`
- `libtiffxx5:amd64=4.1.0+git191117-2ubuntu0.20.04.11`
...
- `libblkid-dev:amd64=2.34-0.1ubuntu9.4`
- `libblkid1:amd64=2.34-0.1ubuntu9.4`
- `libfdisk1:amd64=2.34-0.1ubuntu9.4`
- `libmount-dev:amd64=2.34-0.1ubuntu9.4`
...
'http://archive.ubuntu.com/ubuntu/pool/universe/x/xerces-c/xerces-c_3.2.2%2bdebian-1build3.dsc' xerces-c_3.2.2+debian-1build3.dsc 2306 SHA256:a5c3214a8105b08c8797a8677396b2e32129277b280601ac28e3062294271081
'http://archive.ubuntu.com/ubuntu/pool/universe/x/xerces-c/xerces-c_3.2.2%2bdebian.orig.tar.gz' xerces-c_3.2.2+debian.orig.tar.gz 2513427 SHA256:98f9ece846b7858aad8243b066d3bf726abd72ccb93735b858a1b927fc7cdaca
'http://archive.ubuntu.com/ubuntu/pool/universe/x/xerces-c/xerces-c_3.2.2%2bdebian-1build3.debian.tar.xz' xerces-c_3.2.2+debian-1build3.debian.tar.xz 21948 SHA256:b00032454b5e5f3769215e2dc9fba80a39feb4f74ff5f135a1c01266de5156b4
```
