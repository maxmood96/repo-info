...
- Created: `2022-01-20T00:20:56.549009541Z`
- Virtual Size: ~ 724.61 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["irb"]`
- Environment:
  - `PATH=/usr/local/bundle/bin:/opt/jruby/bin:/usr/local/openjdk-17/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `JAVA_HOME=/usr/local/openjdk-17`
  - `LANG=C.UTF-8`
  - `JAVA_VERSION=17.0.2`
  - `JRUBY_VERSION=9.3.3.0`
  - `JRUBY_SHA256=3da828cbe287d5468507f1c2c42bef6cf34bc5361bcd6a5d99c207b21b9fdc5c`
