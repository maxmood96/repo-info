...
```console
$ docker pull ros@sha256:37f169c9aa6f7c24a9e30e7fd27f7727285e83d6418af9254f36e85b65725cdc
```
...
```console
$ docker pull ros@sha256:932447241913f64c1af30d096ad803ae33dcf31c542304a0488346fc3fc74a40
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **492.1 MB (492064972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1022226a8d54539c6d5dd4ce8101135cd7daf9ae44e2d168312d8797802f756e`
...
# Sat, 09 Dec 2023 02:41:48 GMT
CMD ["bash"]
# Sat, 09 Dec 2023 02:42:45 GMT
RUN apt-get update && apt-get install -y     ros-lunar-ros-base=1.3.2-0*     && rm -rf /var/lib/apt/lists/*
# Sat, 09 Dec 2023 02:43:45 GMT
...
-	Layers:
	...
	-	`sha256:aef8d941936706e76f42503c124245262cb1b272db9d9f91217c3b772d34b6d8`  
		...
		Size: 195.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e099aedbdc0387b156b4ddf5d6e012427145dcd1a5e0b18434d168b0e281058`  
		Last Modified: Sat, 09 Dec 2023 04:32:12 GMT  
		Size: 85.5 MB (85467264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8400546cbcfc2bc42b65edff7c628c7c70499d3f7e1fc37366bd181c4ef7d323`  
		Last Modified: Sat, 09 Dec 2023 04:32:42 GMT  
		Size: 103.7 MB (103723878 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `ros:lunar-robot` - linux; arm variant v7

```console
$ docker pull ros@sha256:aebaa1731b217ad34b62254969e84a75564f1c80cfed24a15858b702f6a497a7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **428.7 MB (428741849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:862996605db8efc241fb2329fc13b1d25489eba4e449ed1a995c3e4b565e8477`
-	Entrypoint: `["\/ros_entrypoint.sh"]`
-	Default Command: `["bash"]`
...
# Sat, 09 Dec 2023 02:52:05 GMT
CMD ["bash"]
# Sat, 09 Dec 2023 02:53:10 GMT
RUN apt-get update && apt-get install -y     ros-lunar-ros-base=1.3.2-0*     && rm -rf /var/lib/apt/lists/*
# Sat, 09 Dec 2023 02:54:20 GMT
RUN apt-get update && apt-get install -y     ros-lunar-robot=1.3.2-0*     && rm -rf /var/lib/apt/lists/*
```
...
-	Layers:
	...
	-	`sha256:5ff9288e4dc53084dd34a30a91c07bcc72bf91d6aa5f296597445fc3467daedc`  
		...
		Size: 195.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f014ae9a361cf00cf41a4366760c0b6de940fb9ea4bc1700964d7c83dc38912f`  
		Last Modified: Sat, 09 Dec 2023 03:37:19 GMT  
		Size: 76.3 MB (76254146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5488d8418436a125b57a7a4f3de329bce194fce29bf955437798648295f490b8`  
		Last Modified: Sat, 09 Dec 2023 03:37:49 GMT  
		Size: 90.1 MB (90103250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `ros:lunar-robot` - linux; arm64 variant v8

```console
$ docker pull ros@sha256:aa222d19f069a87bd319736b27e2124b85528c7523501254214b9056848969a7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **446.3 MB (446306371 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1fa4b86274ef70b3ca1252bfc9c0cfb92358d6eee1ef95dda91e86df40dd300`
-	Entrypoint: `["\/ros_entrypoint.sh"]`
-	Default Command: `["bash"]`
...
# Sat, 09 Dec 2023 02:19:12 GMT
CMD ["bash"]
# Sat, 09 Dec 2023 02:20:21 GMT
RUN apt-get update && apt-get install -y     ros-lunar-ros-base=1.3.2-0*     && rm -rf /var/lib/apt/lists/*
# Sat, 09 Dec 2023 02:21:23 GMT
RUN apt-get update && apt-get install -y     ros-lunar-robot=1.3.2-0*     && rm -rf /var/lib/apt/lists/*
```
...
-	Layers:
	...
	-	`sha256:3e3a1dee3a06cbbabef948d1b7df41e7db7394bc5caa7676dfaee141930f7e59`  
		...
		Size: 194.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f80a1a456e3c4d83eaf9d826ae8faa7c9fc535b0cc5f5f1169a38f28b2487951`  
		Last Modified: Sat, 09 Dec 2023 03:52:09 GMT  
		Size: 77.7 MB (77728657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9538ba085f90838ea0f92f2a01f45a7033f835192f304014504c2c62e8ad876d`  
		Last Modified: Sat, 09 Dec 2023 03:52:37 GMT  
		Size: 94.0 MB (93994454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
