...
```console
$ docker pull ros@sha256:97d006aae6947c50200f84656b3442eec7e04c54dd1881999c6c98ca0e7dcf55
```
...
```console
$ docker pull ros@sha256:44f126fcbe3631e8706589e15ae2305ebb3d68434653d3c88a88a572e870f363
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.2 MB (332168674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec5f4dfbf9922970fcb56a719dfef73199172396f7b004ba6f7885a3d23ceec0`
...
# Mon, 11 Sep 2017 19:26:55 GMT
RUN apt-get update && apt-get install -y     ros-jade-robot=1.2.1-0*     && rm -rf /var/lib/apt/lists/* # buildkit
```
...
### `ros:jade-robot` - unknown; unknown

```console
$ docker pull ros@sha256:31ade33dbfff12bfe3c1033a5d70c7db253df6e30179308e427f467c13edca62
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (31971353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3182f97ecc43a7c4c97f97ff416e4f20c2dbf6c7c48521a1d9372080aa484807`

```dockerfile
```

-	Layers:
	-	`sha256:6571e668fe7e6281e199600e504e1020e82e81f0849720473f1a0ef7d2413faa`  
		Last Modified: Sat, 07 Jun 2025 01:21:21 GMT  
		Size: 32.0 MB (31961788 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7085ac5041f6e344c3b843724c89ad64ec13e34faeb7e66ba39e680abc64ece9`  
		Last Modified: Sat, 07 Jun 2025 01:21:21 GMT  
...
```console
$ docker pull ros@sha256:b4c3bf71e97e19b0915f530fb1f97728467e2e5ef3ab2488ea2fc59bc5e85a8a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.8 MB (301821176 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34113794343f2575676ce7d82df7469a9be3e2f892a70cdf2a56c00c6c61e625`
-	Entrypoint: `["\/ros_entrypoint.sh"]`
-	Default Command: `["bash"]`
...
```console
$ docker pull ros@sha256:f06ea5fdf50a433a36ef4f541fc4a425e7db1462f57c3ca144438e22b6c41e6c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31852254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1aee8c66ae2e55e8dea63ad8766bd6ef95621a59571282d45eeea782f6d5a6e`

```dockerfile
```

-	Layers:
	-	`sha256:a43a6f0c2174cec2460e1605aec50707d0e92be31aa09acfed8a0a10e4a3e216`  
		Last Modified: Sat, 07 Jun 2025 01:21:47 GMT  
		Size: 31.8 MB (31842593 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:88f15d16d3226e17393e97136a7d63eacdd305b1592c738383187e95177e6a42`  
		Last Modified: Sat, 07 Jun 2025 01:21:48 GMT  
