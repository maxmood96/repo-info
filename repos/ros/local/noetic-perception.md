...
- `libcurl4-gnutls-dev:amd64=7.68.0-1ubuntu2.25`
...
- `libturbojpeg:amd64=2.0.3-0ubuntu1.20.04.3`
- `libturbojpeg0-dev:amd64=2.0.3-0ubuntu1.20.04.3`
...
### `dpkg` source package: `libpcap=1.9.1-3ubuntu1.20.04.1`

Binary Packages:

- `libpcap0.8:amd64=1.9.1-3ubuntu1.20.04.1`
...
```console
$ apt-get source -qq --print-uris libpcap=1.9.1-3ubuntu1.20.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpcap/libpcap_1.9.1-3ubuntu1.20.04.1.dsc' libpcap_1.9.1-3ubuntu1.20.04.1.dsc 2520 SHA512:df22a2450856781a4ea0655074eb731737397ed83db2412f47d04b3c7d1c3a6341c2380295be86b1980e27ebff34e7a655a5fba5dacbb6ce1c13cc3173d71608
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpcap/libpcap_1.9.1.orig.tar.gz' libpcap_1.9.1.orig.tar.gz 861228 SHA512:ae0d6b0ad8253e7e059336c0f4ed3850d20d7d2f4dc1d942c2951f99a5443a690f0cc42c6f8fdc4a0ccb19e9e985192ba6f399c4bde2c7076e420f547fddfb08
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpcap/libpcap_1.9.1.orig.tar.gz.asc' libpcap_1.9.1.orig.tar.gz.asc 442 SHA512:c99af6afc48e2797a4cd47600498822273dda60f7a2a30d7ad9f48946d307b44b82bf6a80acc21f383c6ea42adbdf926945aab50f67d091892e2990f78bb240a
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpcap/libpcap_1.9.1-3ubuntu1.20.04.1.debian.tar.xz' libpcap_1.9.1-3ubuntu1.20.04.1.debian.tar.xz 20240 SHA512:a95eb03caa7013488e966e073ccae3d3d9826c0f79fd35b33d5e529a962974bb68613a9c425992458907501b6177b66ef31a288298f92fba44b4ff4929c44d38
```
...
### `dpkg` source package: `libsoup2.4=2.70.0-1ubuntu0.1`

Binary Packages:

- `libsoup-gnome2.4-1:amd64=2.70.0-1ubuntu0.1`
- `libsoup2.4-1:amd64=2.70.0-1ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris libsoup2.4=2.70.0-1ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/libs/libsoup2.4/libsoup2.4_2.70.0-1ubuntu0.1.dsc' libsoup2.4_2.70.0-1ubuntu0.1.dsc 3117 SHA512:9f008366a611c2862c5c2314100da0c67f969c105df35f74d6f7d7fef840735e20a64b2feea9a3fcda1596863e78e420258bb6c8cc7d1ca920173627379a6f42
...
'http://archive.ubuntu.com/ubuntu/pool/main/libs/libsoup2.4/libsoup2.4_2.70.0-1ubuntu0.1.debian.tar.xz' libsoup2.4_2.70.0-1ubuntu0.1.debian.tar.xz 27824 SHA512:fa2c35fa592d6bc4adebbaade072f916528bcd74908f05804004e0bc32601b1881a8689ec2e3990058ba7d1759b80ab6255a32f7537c00460d5c7345f49fc5f6
```
...
### `dpkg` source package: `poppler=0.86.1-0ubuntu1.5`

Binary Packages:

- `libpoppler-dev:amd64=0.86.1-0ubuntu1.5`
- `libpoppler-private-dev:amd64=0.86.1-0ubuntu1.5`
- `libpoppler97:amd64=0.86.1-0ubuntu1.5`
...
```console
$ apt-get source -qq --print-uris poppler=0.86.1-0ubuntu1.5
'http://archive.ubuntu.com/ubuntu/pool/main/p/poppler/poppler_0.86.1-0ubuntu1.5.dsc' poppler_0.86.1-0ubuntu1.5.dsc 3365 SHA512:1c5a59df16aa000799c0202ab8fb2dc393dc15682bb239e5661ef005cfbe9e5017a6b9de14877187069eda3f3126241e893b322dd147b0e9adf22a9cbfe89bf7
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/poppler/poppler_0.86.1-0ubuntu1.5.debian.tar.xz' poppler_0.86.1-0ubuntu1.5.debian.tar.xz 41316 SHA512:50b64f08fbb4604af0a8bc8c6c0ed3fe9ebdae522ea46c21632003dec86a8562eff1925d594b216cab4e4db7ffa877972ebdea608355954b54a6a3b581b07d43
```
...
### `dpkg` source package: `python-idna=2.8-1ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris python-idna=2.8-1ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-idna/python-idna_2.8-1ubuntu0.1.dsc' python-idna_2.8-1ubuntu0.1.dsc 2339 SHA512:308f84b7225d844d8b5b1df7895ce9db4657b862dab9d1ed32c41c2bb4e3672c1443d10f138dc0ca5a9c7274e3f2aa047903cc869e3f2f9cc4616faaa6f07e69
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-idna/python-idna_2.8.orig.tar.gz' python-idna_2.8.orig.tar.gz 174481 SHA512:8ca5cfe6350c51250bafdac7c6e4ddd54c4a5d6bf7acbcef896760a759868c8e9df1fdf550121d8512fa3eb316dcf031ec6058e03b4f66eadee21b63e2187d33
'http://archive.ubuntu.com/ubuntu/pool/main/p/python-idna/python-idna_2.8-1ubuntu0.1.debian.tar.xz' python-idna_2.8-1ubuntu0.1.debian.tar.xz 7908 SHA512:af1aca629822c738c89623cbe4c44f6608fa241b7d18191bc715a375dd22058e97319d1cbba5fe30cbe5aa4301d4c6723968d3cbb5b4a9ccd1e1d969716810dc
```
...
### `dpkg` source package: `ros-noetic-camera-calibration-parsers=1.12.0-1focal.20240913.192710`

Binary Packages:

- `ros-noetic-camera-calibration-parsers=1.12.0-1focal.20240913.192710`
...
### `dpkg` source package: `ros-noetic-camera-calibration=1.17.0-1focal.20240913.193338`

Binary Packages:

- `ros-noetic-camera-calibration=1.17.0-1focal.20240913.193338`
...
### `dpkg` source package: `ros-noetic-camera-info-manager=1.12.0-1focal.20240913.193232`

Binary Packages:

- `ros-noetic-camera-info-manager=1.12.0-1focal.20240913.193232`
...
### `dpkg` source package: `ros-noetic-compressed-depth-image-transport=1.15.0-1focal.20240913.194300`

Binary Packages:

- `ros-noetic-compressed-depth-image-transport=1.15.0-1focal.20240913.194300`
...
### `dpkg` source package: `ros-noetic-compressed-image-transport=1.15.0-1focal.20240913.194147`

Binary Packages:

- `ros-noetic-compressed-image-transport=1.15.0-1focal.20240913.194147`
...
### `dpkg` source package: `ros-noetic-cv-bridge=1.16.2-1focal.20240913.193012`

Binary Packages:

- `ros-noetic-cv-bridge=1.16.2-1focal.20240913.193012`
...
### `dpkg` source package: `ros-noetic-depth-image-proc=1.17.0-1focal.20241118.193427`

Binary Packages:

- `ros-noetic-depth-image-proc=1.17.0-1focal.20241118.193427`
...
### `dpkg` source package: `ros-noetic-filters=1.9.2-1focal.20240913.191417`

Binary Packages:

- `ros-noetic-filters=1.9.2-1focal.20240913.191417`
...
### `dpkg` source package: `ros-noetic-image-common=1.12.0-1focal.20240913.194300`

Binary Packages:

- `ros-noetic-image-common=1.12.0-1focal.20240913.194300`
...
### `dpkg` source package: `ros-noetic-image-geometry=1.16.2-1focal.20240913.192946`

Binary Packages:

- `ros-noetic-image-geometry=1.16.2-1focal.20240913.192946`
...
### `dpkg` source package: `ros-noetic-image-pipeline=1.17.0-1focal.20241118.200010`

Binary Packages:

- `ros-noetic-image-pipeline=1.17.0-1focal.20241118.200010`
...
### `dpkg` source package: `ros-noetic-image-proc=1.17.0-1focal.20241118.194642`

Binary Packages:

- `ros-noetic-image-proc=1.17.0-1focal.20241118.194642`
...
### `dpkg` source package: `ros-noetic-image-publisher=1.17.0-1focal.20241118.194051`

Binary Packages:

- `ros-noetic-image-publisher=1.17.0-1focal.20241118.194051`
...
### `dpkg` source package: `ros-noetic-image-rotate=1.17.0-1focal.20241118.193421`

Binary Packages:

- `ros-noetic-image-rotate=1.17.0-1focal.20241118.193421`
...
### `dpkg` source package: `ros-noetic-image-transport-plugins=1.15.0-1focal.20240913.195107`

Binary Packages:

- `ros-noetic-image-transport-plugins=1.15.0-1focal.20240913.195107`
...
### `dpkg` source package: `ros-noetic-image-transport=1.12.0-1focal.20240913.192955`

Binary Packages:

- `ros-noetic-image-transport=1.12.0-1focal.20240913.192955`
...
### `dpkg` source package: `ros-noetic-image-view=1.17.0-1focal.20241118.194317`

Binary Packages:

- `ros-noetic-image-view=1.17.0-1focal.20241118.194317`
...
### `dpkg` source package: `ros-noetic-laser-assembler=1.7.8-1focal.20240913.201230`

Binary Packages:

- `ros-noetic-laser-assembler=1.7.8-1focal.20240913.201230`
...
### `dpkg` source package: `ros-noetic-laser-filters=1.9.1-2focal.20241118.193355`

Binary Packages:

- `ros-noetic-laser-filters=1.9.1-2focal.20241118.193355`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-laser-filters/copyright`)
...
### `dpkg` source package: `ros-noetic-laser-geometry=1.6.7-1focal.20240913.200750`

Binary Packages:

- `ros-noetic-laser-geometry=1.6.7-1focal.20240913.200750`
...
### `dpkg` source package: `ros-noetic-laser-pipeline=1.6.4-1focal.20241118.195238`

Binary Packages:

- `ros-noetic-laser-pipeline=1.6.4-1focal.20241118.195238`
...
### `dpkg` source package: `ros-noetic-pcl-conversions=1.7.4-1focal.20240913.193412`

Binary Packages:

- `ros-noetic-pcl-conversions=1.7.4-1focal.20240913.193412`
...
### `dpkg` source package: `ros-noetic-pcl-msgs=0.3.0-1focal.20240913.193206`

Binary Packages:

- `ros-noetic-pcl-msgs=0.3.0-1focal.20240913.193206`
...
### `dpkg` source package: `ros-noetic-pcl-ros=1.7.4-1focal.20241118.194620`

Binary Packages:

- `ros-noetic-pcl-ros=1.7.4-1focal.20241118.194620`
...
### `dpkg` source package: `ros-noetic-perception-pcl=1.7.4-1focal.20241118.201457`

Binary Packages:

- `ros-noetic-perception-pcl=1.7.4-1focal.20241118.201457`
...
### `dpkg` source package: `ros-noetic-perception=1.5.0-1focal.20241118.202311`

Binary Packages:

- `ros-noetic-perception=1.5.0-1focal.20241118.202311`
...
### `dpkg` source package: `ros-noetic-polled-camera=1.12.0-1focal.20240913.193607`

Binary Packages:

- `ros-noetic-polled-camera=1.12.0-1focal.20240913.193607`
...
### `dpkg` source package: `ros-noetic-stereo-image-proc=1.17.0-1focal.20241118.195338`

Binary Packages:

- `ros-noetic-stereo-image-proc=1.17.0-1focal.20241118.195338`
...
### `dpkg` source package: `ros-noetic-tf2-eigen=0.7.7-1focal.20231013.185259`

Binary Packages:

- `ros-noetic-tf2-eigen=0.7.7-1focal.20231013.185259`
...
### `dpkg` source package: `ros-noetic-tf2-geometry-msgs=0.7.7-1focal.20240913.195606`

Binary Packages:

- `ros-noetic-tf2-geometry-msgs=0.7.7-1focal.20240913.195606`
...
### `dpkg` source package: `ros-noetic-tf2-msgs=0.7.7-1focal.20231013.184042`

Binary Packages:

- `ros-noetic-tf2-msgs=0.7.7-1focal.20231013.184042`
...
### `dpkg` source package: `ros-noetic-tf2-py=0.7.7-1focal.20240913.190527`

Binary Packages:

- `ros-noetic-tf2-py=0.7.7-1focal.20240913.190527`
...
### `dpkg` source package: `ros-noetic-tf2-ros=0.7.7-1focal.20240913.195020`

Binary Packages:

- `ros-noetic-tf2-ros=0.7.7-1focal.20240913.195020`
...
### `dpkg` source package: `ros-noetic-tf2=0.7.7-1focal.20231013.184703`

Binary Packages:

- `ros-noetic-tf2=0.7.7-1focal.20231013.184703`
...
### `dpkg` source package: `ros-noetic-tf=1.13.2-1focal.20240913.200215`

Binary Packages:

- `ros-noetic-tf=1.13.2-1focal.20240913.200215`
...
### `dpkg` source package: `ros-noetic-theora-image-transport=1.15.0-1focal.20240913.194159`

Binary Packages:

- `ros-noetic-theora-image-transport=1.15.0-1focal.20240913.194159`
...
### `dpkg` source package: `ros-noetic-vision-opencv=1.16.2-1focal.20240913.193700`

Binary Packages:

- `ros-noetic-vision-opencv=1.16.2-1focal.20240913.193700`
...
### `dpkg` source package: `twisted=18.9.0-11ubuntu0.20.04.5`

Binary Packages:

- `python3-twisted=18.9.0-11ubuntu0.20.04.5`
- `python3-twisted-bin:amd64=18.9.0-11ubuntu0.20.04.5`
...
```console
$ apt-get source -qq --print-uris twisted=18.9.0-11ubuntu0.20.04.5
'http://archive.ubuntu.com/ubuntu/pool/main/t/twisted/twisted_18.9.0-11ubuntu0.20.04.5.dsc' twisted_18.9.0-11ubuntu0.20.04.5.dsc 2717 SHA512:5300c96173fe26d3868d4c981f33e61efda9125c114f7a7b693fb86d1a29e37422f4902f1fc83651c624ef872ea9af00d0d204ea88c79e67229a6d1266fc10f2
...
'http://archive.ubuntu.com/ubuntu/pool/main/t/twisted/twisted_18.9.0-11ubuntu0.20.04.5.debian.tar.xz' twisted_18.9.0-11ubuntu0.20.04.5.debian.tar.xz 54004 SHA512:79d8ca0b0c138216cec4892ba687bb545f065a61e3ab440eeb42b22a889f4c6107241edf020d4cda4e72d86fc457c2257b3b95b757afb30ffd49cb22b6c2a288
```
