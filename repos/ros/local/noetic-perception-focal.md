...
### `dpkg` source package: `cryptsetup=2:2.2.2-3ubuntu2.5`

Binary Packages:

- `libcryptsetup12:amd64=2:2.2.2-3ubuntu2.5`
...
```console
$ apt-get source -qq --print-uris cryptsetup=2:2.2.2-3ubuntu2.5
'http://archive.ubuntu.com/ubuntu/pool/main/c/cryptsetup/cryptsetup_2.2.2-3ubuntu2.5.dsc' cryptsetup_2.2.2-3ubuntu2.5.dsc 2968 SHA512:3f3d18657bd75b502089fdb2bccf126db0444a78c12be687d7f1bcb96627837714e0d0bceb8c4b6cbbcfb2f3e61221f472798326066e2c9089a1b9e27ebfe3bf
...
'http://archive.ubuntu.com/ubuntu/pool/main/c/cryptsetup/cryptsetup_2.2.2-3ubuntu2.5.debian.tar.xz' cryptsetup_2.2.2-3ubuntu2.5.debian.tar.xz 129016 SHA512:51cbbe3568cb5a7f1d7948919d9f16e761602a7f3875df81cff5fada7b728f3c63c491cced7140bf30865f90a4e51e088f3c2215284e81416ef87020cfbe0fa3
```
...
### `dpkg` source package: `libsoup2.4=2.70.0-1ubuntu0.5`

Binary Packages:

- `libsoup-gnome2.4-1:amd64=2.70.0-1ubuntu0.5`
- `libsoup2.4-1:amd64=2.70.0-1ubuntu0.5`
...
```console
$ apt-get source -qq --print-uris libsoup2.4=2.70.0-1ubuntu0.5
'http://archive.ubuntu.com/ubuntu/pool/main/libs/libsoup2.4/libsoup2.4_2.70.0-1ubuntu0.5.dsc' libsoup2.4_2.70.0-1ubuntu0.5.dsc 3336 SHA512:9e463c8dcc96932b633baeb473badbea9711cbc795f5725d21652bd460ac122b1c2c6cdbe48b963d1415ac60d1c8ad9fa28e40e8d48fd327d34d9d8cbaf811de
...
'http://archive.ubuntu.com/ubuntu/pool/main/libs/libsoup2.4/libsoup2.4_2.70.0-1ubuntu0.5.debian.tar.xz' libsoup2.4_2.70.0-1ubuntu0.5.debian.tar.xz 36644 SHA512:205e72542faef5fbcf960e7e20f8289d2a16c54ad552bca4fa5707698a028abeb74d4e500b716bb944e6cff704df02f6035fed9b02db3ff082be73ca98a6e56f
```
...
### `dpkg` source package: `libvpx=1.8.2-1ubuntu0.4`
...
```console
$ apt-get source -qq --print-uris libvpx=1.8.2-1ubuntu0.4
'http://archive.ubuntu.com/ubuntu/pool/main/libv/libvpx/libvpx_1.8.2-1ubuntu0.4.dsc' libvpx_1.8.2-1ubuntu0.4.dsc 2403 SHA512:4f8455a3e06701411e42eb7797b93ad25a82c20ae0a8afde81a55582450ee6416a5448779b0128bef1cde73965d899030dfba32849a0d9bc61a821ef12ac02c5
...
'http://archive.ubuntu.com/ubuntu/pool/main/libv/libvpx/libvpx_1.8.2-1ubuntu0.4.debian.tar.xz' libvpx_1.8.2-1ubuntu0.4.debian.tar.xz 18036 SHA512:264869d26c7f0c340bf893f0c6163d3463cdebbedf6914a4db0a2aac5cbac79e75810fa5abc9528a57e6c0429c26431390db3b9ff8dffc9ca1e2651ec1bbda67
```
...
### `dpkg` source package: `poppler=0.86.1-0ubuntu1.7`

Binary Packages:

- `libpoppler-dev:amd64=0.86.1-0ubuntu1.7`
- `libpoppler-private-dev:amd64=0.86.1-0ubuntu1.7`
- `libpoppler97:amd64=0.86.1-0ubuntu1.7`
...
```console
$ apt-get source -qq --print-uris poppler=0.86.1-0ubuntu1.7
'http://archive.ubuntu.com/ubuntu/pool/main/p/poppler/poppler_0.86.1-0ubuntu1.7.dsc' poppler_0.86.1-0ubuntu1.7.dsc 3361 SHA512:1f44ebf89de00d07858fd8609ad6b25c03a93fa0c850f27b9cf6172a4262d022cf548b5f1eb26349c189952bbd23805647ea19eb6c317bb0f1901c3e13b31aeb
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/poppler/poppler_0.86.1-0ubuntu1.7.debian.tar.xz' poppler_0.86.1-0ubuntu1.7.debian.tar.xz 42488 SHA512:ee9693365e1c6ad320bfb420021bcd01b10bc374d93ba9a407a3fd5f7f7193d65847f7702d31268d822fae449d15c03ba8616da5f3b043a624ec94dfc751fad0
```

### `dpkg` source package: `postgresql-12=12.22-0ubuntu0.20.04.4`

Binary Packages:

- `libpq-dev=12.22-0ubuntu0.20.04.4`
- `libpq5:amd64=12.22-0ubuntu0.20.04.4`
...
```console
$ apt-get source -qq --print-uris postgresql-12=12.22-0ubuntu0.20.04.4
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-12/postgresql-12_12.22-0ubuntu0.20.04.4.dsc' postgresql-12_12.22-0ubuntu0.20.04.4.dsc 3764 SHA512:c0415752735da615867812cd0c5b25af896fbad755f0d19f87d7688ce52fe75a5052a4c515477fc06cbc66e9320351725d3f5f723316664d7c31bfa56e76c793
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-12/postgresql-12_12.22-0ubuntu0.20.04.4.debian.tar.xz' postgresql-12_12.22-0ubuntu0.20.04.4.debian.tar.xz 53928 SHA512:d1624a57fa67e53a626df9ffb1a212bbac5be8bf6cc08de6fca63226e976efeb1a0deafdbdff62b9d8a94c4c4c20f17e9bed38bef76ce91e5a2517021a54c01b
```
...
### `dpkg` source package: `ros-noetic-camera-calibration-parsers=1.12.1-1focal.20250519.235403`

Binary Packages:

- `ros-noetic-camera-calibration-parsers=1.12.1-1focal.20250519.235403`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-camera-calibration-parsers/copyright`)
...
### `dpkg` source package: `ros-noetic-camera-calibration=1.17.0-1focal.20250520.005809`

Binary Packages:

- `ros-noetic-camera-calibration=1.17.0-1focal.20250520.005809`
...
### `dpkg` source package: `ros-noetic-camera-info-manager=1.12.1-1focal.20250520.000220`

Binary Packages:

- `ros-noetic-camera-info-manager=1.12.1-1focal.20250520.000220`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-camera-info-manager/copyright`)
...
### `dpkg` source package: `ros-noetic-compressed-depth-image-transport=1.15.0-1focal.20250521.004155`

Binary Packages:

- `ros-noetic-compressed-depth-image-transport=1.15.0-1focal.20250521.004155`
...
### `dpkg` source package: `ros-noetic-compressed-image-transport=1.15.0-1focal.20250521.004234`

Binary Packages:

- `ros-noetic-compressed-image-transport=1.15.0-1focal.20250521.004234`
...
### `dpkg` source package: `ros-noetic-cv-bridge=1.16.2-1focal.20250519.235655`

Binary Packages:

- `ros-noetic-cv-bridge=1.16.2-1focal.20250519.235655`
...
### `dpkg` source package: `ros-noetic-depth-image-proc=1.17.0-1focal.20250520.012250`

Binary Packages:

- `ros-noetic-depth-image-proc=1.17.0-1focal.20250520.012250`
...
### `dpkg` source package: `ros-noetic-image-common=1.12.1-1focal.20250520.015250`

Binary Packages:

- `ros-noetic-image-common=1.12.1-1focal.20250520.015250`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-image-common/copyright`)
...
### `dpkg` source package: `ros-noetic-image-geometry=1.16.2-1focal.20250520.005312`

Binary Packages:

- `ros-noetic-image-geometry=1.16.2-1focal.20250520.005312`
...
### `dpkg` source package: `ros-noetic-image-pipeline=1.17.0-1focal.20250521.010122`

Binary Packages:

- `ros-noetic-image-pipeline=1.17.0-1focal.20250521.010122`
...
### `dpkg` source package: `ros-noetic-image-proc=1.17.0-1focal.20250521.004322`

Binary Packages:

- `ros-noetic-image-proc=1.17.0-1focal.20250521.004322`
...
### `dpkg` source package: `ros-noetic-image-publisher=1.17.0-1focal.20250521.003823`

Binary Packages:

- `ros-noetic-image-publisher=1.17.0-1focal.20250521.003823`
...
### `dpkg` source package: `ros-noetic-image-rotate=1.17.0-1focal.20250521.003149`

Binary Packages:

- `ros-noetic-image-rotate=1.17.0-1focal.20250521.003149`
...
### `dpkg` source package: `ros-noetic-image-transport-plugins=1.15.0-1focal.20250521.012022`

Binary Packages:

- `ros-noetic-image-transport-plugins=1.15.0-1focal.20250521.012022`
...
### `dpkg` source package: `ros-noetic-image-transport=1.12.1-1focal.20250519.235437`

Binary Packages:

- `ros-noetic-image-transport=1.12.1-1focal.20250519.235437`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-image-transport/copyright`)
...
### `dpkg` source package: `ros-noetic-image-view=1.17.0-1focal.20250521.003902`

Binary Packages:

- `ros-noetic-image-view=1.17.0-1focal.20250521.003902`
...
### `dpkg` source package: `ros-noetic-laser-assembler=1.7.8-1focal.20250520.003141`

Binary Packages:

- `ros-noetic-laser-assembler=1.7.8-1focal.20250520.003141`
...
### `dpkg` source package: `ros-noetic-laser-filters=1.9.1-2focal.20250521.004125`

Binary Packages:

- `ros-noetic-laser-filters=1.9.1-2focal.20250521.004125`
...
### `dpkg` source package: `ros-noetic-laser-geometry=1.6.8-1focal.20250520.002454`

Binary Packages:

- `ros-noetic-laser-geometry=1.6.8-1focal.20250520.002454`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-laser-geometry/copyright`)
...
### `dpkg` source package: `ros-noetic-laser-pipeline=1.6.4-1focal.20250521.012210`

Binary Packages:

- `ros-noetic-laser-pipeline=1.6.4-1focal.20250521.012210`
...
### `dpkg` source package: `ros-noetic-pcl-conversions=1.7.4-1focal.20250520.005606`

Binary Packages:

- `ros-noetic-pcl-conversions=1.7.4-1focal.20250520.005606`
...
### `dpkg` source package: `ros-noetic-pcl-msgs=0.3.0-1focal.20250520.005335`

Binary Packages:

- `ros-noetic-pcl-msgs=0.3.0-1focal.20250520.005335`
...
### `dpkg` source package: `ros-noetic-pcl-ros=1.7.4-1focal.20250521.004323`

Binary Packages:

- `ros-noetic-pcl-ros=1.7.4-1focal.20250521.004323`
...
### `dpkg` source package: `ros-noetic-perception-pcl=1.7.4-1focal.20250521.013426`

Binary Packages:

- `ros-noetic-perception-pcl=1.7.4-1focal.20250521.013426`
...
### `dpkg` source package: `ros-noetic-perception=1.5.0-1focal.20250521.013504`

Binary Packages:

- `ros-noetic-perception=1.5.0-1focal.20250521.013504`
...
### `dpkg` source package: `ros-noetic-polled-camera=1.12.1-1focal.20250520.000507`

Binary Packages:

- `ros-noetic-polled-camera=1.12.1-1focal.20250520.000507`

Licenses: (parsed from: `/usr/share/doc/ros-noetic-polled-camera/copyright`)
...
### `dpkg` source package: `ros-noetic-stereo-image-proc=1.17.0-1focal.20250521.005052`

Binary Packages:

- `ros-noetic-stereo-image-proc=1.17.0-1focal.20250521.005052`
...
### `dpkg` source package: `ros-noetic-tf2-eigen=0.7.10-1focal.20250502.232642`

Binary Packages:

- `ros-noetic-tf2-eigen=0.7.10-1focal.20250502.232642`
...
### `dpkg` source package: `ros-noetic-tf2-geometry-msgs=0.7.10-1focal.20250520.001448`

Binary Packages:

- `ros-noetic-tf2-geometry-msgs=0.7.10-1focal.20250520.001448`
...
### `dpkg` source package: `ros-noetic-theora-image-transport=1.15.0-1focal.20250521.004408`

Binary Packages:

- `ros-noetic-theora-image-transport=1.15.0-1focal.20250521.004408`
...
### `dpkg` source package: `ros-noetic-vision-opencv=1.16.2-1focal.20250520.015345`

Binary Packages:

- `ros-noetic-vision-opencv=1.16.2-1focal.20250520.015345`
