...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `REDIS_VERSION=7.2.9`
  - `REDIS_DOWNLOAD_URL=http://download.redis.io/releases/redis-7.2.9.tar.gz`
  - `REDIS_DOWNLOAD_SHA=2343cc49db3beb9d2925a44e13032805a608821a58f25bd874c84881115a20b7`
