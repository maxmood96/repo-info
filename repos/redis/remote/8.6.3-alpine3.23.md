...
```console
$ docker pull redis@sha256:d146f83b1e0f02fc27c26a50cee39338c736674c5959db84363e6ae3cd9e02d2
```
...
### `redis:8.6.3-alpine3.23` - linux; amd64
...
### `redis:8.6.3-alpine3.23` - unknown; unknown
...
### `redis:8.6.3-alpine3.23` - linux; arm variant v6
...
### `redis:8.6.3-alpine3.23` - linux; arm variant v7
...
### `redis:8.6.3-alpine3.23` - linux; arm64 variant v8
...
### `redis:8.6.3-alpine3.23` - linux; 386
...
### `redis:8.6.3-alpine3.23` - linux; ppc64le
...
### `redis:8.6.3-alpine3.23` - linux; riscv64
...
### `redis:8.6.3-alpine3.23` - linux; s390x
