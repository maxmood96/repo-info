...
### `redis:7.0.6-alpine3.17` - linux; amd64
...
### `redis:7.0.6-alpine3.17` - linux; arm variant v6
...
### `redis:7.0.6-alpine3.17` - linux; arm variant v7
...
### `redis:7.0.6-alpine3.17` - linux; arm64 variant v8
...
### `redis:7.0.6-alpine3.17` - linux; 386
...
### `redis:7.0.6-alpine3.17` - linux; ppc64le
...
### `redis:7.0.6-alpine3.17` - linux; s390x
