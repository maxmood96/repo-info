...
```console
$ docker pull redis@sha256:202ca6965ec0adc57666fe78ff44892811f3e6becb52d33f8e5093bc1093bcde
```
...
### `redis:6.0.7-alpine` - linux; amd64
...
### `redis:6.0.7-alpine` - linux; arm variant v6
...
### `redis:6.0.7-alpine` - linux; arm64 variant v8
