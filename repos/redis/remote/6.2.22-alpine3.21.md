...
### `redis:6.2.22-alpine3.21` - linux; amd64
...
### `redis:6.2.22-alpine3.21` - unknown; unknown
...
### `redis:6.2.22-alpine3.21` - linux; arm variant v6
...
### `redis:6.2.22-alpine3.21` - linux; arm variant v7
...
### `redis:6.2.22-alpine3.21` - linux; arm64 variant v8
...
### `redis:6.2.22-alpine3.21` - linux; 386
...
### `redis:6.2.22-alpine3.21` - linux; ppc64le
...
### `redis:6.2.22-alpine3.21` - linux; riscv64
...
### `redis:6.2.22-alpine3.21` - linux; s390x
