...
```console
$ docker pull redis@sha256:24b938803224357af09d03fb2b8d01c49089c09d75c2503f9ae2bd193bbb4f06
```
...
### `redis:7.0.11-bookworm` - linux; amd64
...
### `redis:7.0.11-bookworm` - linux; arm variant v5
...
### `redis:7.0.11-bookworm` - linux; arm variant v7
...
### `redis:7.0.11-bookworm` - linux; arm64 variant v8
...
### `redis:7.0.11-bookworm` - linux; 386
...
### `redis:7.0.11-bookworm` - linux; mips64le
...
### `redis:7.0.11-bookworm` - linux; ppc64le
...
### `redis:7.0.11-bookworm` - linux; s390x
