...
```console
$ docker pull redis@sha256:2da4679295e9402100d6ddafe65705f0fefc4173ff7bd0968c1c09f14e940779
```
...
```console
$ docker pull redis@sha256:34c88936cdc698952fbbca62188fa5d127e540cad03ce6a16ec162062f01825f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **11.9 MB (11879435 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72608438f968a1594bfeeda2ade63c947a799186494874f3c0c7dd635ba3d0e8`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["redis-server"]`
...
# Sun, 19 Apr 2026 03:01:55 GMT
ENV REDIS_DOWNLOAD_SHA=6383b32ba8d246f41bbbb83663381f5a5f4c4713235433cec22fc4a47e9b6d5f
# Sun, 19 Apr 2026 03:42:24 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		dpkg-dev dpkg 		gcc 		linux-headers 		make 		musl-dev 		openssl-dev 		wget 	; 		wget -O redis.tar.gz "$REDIS_DOWNLOAD_URL"; 	echo "$REDIS_DOWNLOAD_SHA *redis.tar.gz" | sha256sum -c -; 	mkdir -p /usr/src/redis; 	tar -xzf redis.tar.gz -C /usr/src/redis --strip-components=1; 	rm redis.tar.gz; 		grep -E '^ *createBoolConfig[(]"protected-mode",.*, *1 *,.*[)],$' /usr/src/redis/src/config.c; 	sed -ri 's!^( *createBoolConfig[(]"protected-mode",.*, *)1( *,.*[)],)$!\10\2!' /usr/src/redis/src/config.c; 	grep -E '^ *createBoolConfig[(]"protected-mode",.*, *0 *,.*[)],$' /usr/src/redis/src/config.c; 		gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	extraJemallocConfigureFlags="--build=$gnuArch"; 	dpkgArch="$(dpkg --print-architecture)"; 	case "${dpkgArch##*-}" in 		amd64 | i386 | x32) extraJemallocConfigureFlags="$extraJemallocConfigureFlags --with-lg-page=12" ;; 		*) extraJemallocConfigureFlags="$extraJemallocConfigureFlags --with-lg-page=16" ;; 	esac; 	extraJemallocConfigureFlags="$extraJemallocConfigureFlags --with-lg-hugepage=21"; 	grep -F 'cd jemalloc && ./configure ' /usr/src/redis/deps/Makefile; 	sed -ri 's!cd jemalloc && ./configure !&'"$extraJemallocConfigureFlags"' !' /usr/src/redis/deps/Makefile; 	grep -F "cd jemalloc && ./configure $extraJemallocConfigureFlags " /usr/src/redis/deps/Makefile; 		export BUILD_TLS=yes; 	make -C /usr/src/redis -j "$(nproc)" all; 	make -C /usr/src/redis install; 		serverMd5="$(md5sum /usr/local/bin/redis-server | cut -d' ' -f1)"; export serverMd5; 	find /usr/local/bin/redis* -maxdepth 0 		-type f -not -name redis-server 		-exec sh -eux -c ' 			md5="$(md5sum "$1" | cut -d" " -f1)"; 			test "$md5" = "$serverMd5"; 		' -- '{}' ';' 		-exec ln -svfT 'redis-server' '{}' ';' 	; 		rm -r /usr/src/redis; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .redis-rundeps $runDeps; 	apk del --no-network .build-deps; 		redis-cli --version; 	redis-server --version # buildkit
# Sun, 19 Apr 2026 03:42:25 GMT
RUN mkdir /data && chown redis:redis /data # buildkit
# Sun, 19 Apr 2026 03:42:25 GMT
VOLUME [/data]
# Sun, 19 Apr 2026 03:42:25 GMT
...
-	Layers:
	...
	-	`sha256:ad9546c3d2ff0935058f369faaffdaba348b108126d85a268fa3bcebd68e4680`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9d1bc52db1f0efd361f79d407587f8bf37bcdde76936551b144eea0777d2459b`  
		Last Modified: Sun, 19 Apr 2026 03:43:02 GMT  
		Size: 7.4 MB (7374914 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f6a37f0d015874f3268464571ff99bbcf6510cb84479efd29ee722859821e10c`  
		Last Modified: Sun, 19 Apr 2026 03:43:01 GMT  
		Size: 99.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5f93e92000d69fbcf9bde3450892610decbdcbc72cb155019608e65039058729`  
		Last Modified: Sun, 19 Apr 2026 03:43:01 GMT  
		Size: 575.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull redis@sha256:5aaa38a5e1250ff9678c773a88434d6585e657be60fc97f5d8f74f94d35615ee
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **492.8 KB (492753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1beb714e6bbda84f173b905e0ae23cf153e25410c55ae641b504f63cfb770c4b`

```dockerfile
```

-	Layers:
	-	`sha256:b0949b48d06b741d86a42b154ab8df7c045ec676cb34ffb6df5887d07a4504d7`  
		Last Modified: Sun, 19 Apr 2026 03:43:01 GMT  
		Size: 458.9 KB (458916 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:6e4c80cf229922d3cfa7efd3d3e4fe7840f00ed0e23462b3e88d2efb02c659b0`  
		Last Modified: Sun, 19 Apr 2026 03:43:01 GMT  
