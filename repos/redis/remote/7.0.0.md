...
```console
$ docker pull redis@sha256:69fa365a017ea2660c8cedd02afba2e52a476ebee81e3b0454e265166c028147
```
...
### `redis:7.0.0` - linux; arm variant v5
...
### `redis:7.0.0` - linux; arm variant v7
...
### `redis:7.0.0` - linux; arm64 variant v8
