...
```console
$ docker pull redis@sha256:cfda0458239615720cc16d6edf6bae7905c31265f218d2033c43cdb40cd59792
```
...
### `redis:7.0.2` - linux; arm variant v5
...
### `redis:7.0.2` - linux; arm variant v7
...
### `redis:7.0.2` - linux; arm64 variant v8
