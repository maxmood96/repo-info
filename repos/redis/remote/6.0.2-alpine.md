...
```console
$ docker pull redis@sha256:d2b43e0cf75a82439e92d9481b2d9aeaa720951f912255f2ab0ef66037d2d497
```
...
### `redis:6.0.2-alpine` - linux; amd64
...
### `redis:6.0.2-alpine` - linux; arm variant v7
...
### `redis:6.0.2-alpine` - linux; arm64 variant v8
