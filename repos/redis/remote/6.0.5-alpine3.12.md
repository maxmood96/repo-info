...
```console
$ docker pull redis@sha256:5e7a3b51df905481b4d9e1b63f4541a46983d504711465e84c433c95e84f6605
```
...
### `redis:6.0.5-alpine3.12` - linux; arm variant v7
...
### `redis:6.0.5-alpine3.12` - linux; arm64 variant v8
