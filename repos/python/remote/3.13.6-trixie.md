...
```console
$ docker pull python@sha256:70a0c7decdf358d4b3aa5d68447d92a9cc05021afe5caa16a7525b03a5a0805b
```
...
### `python:3.13.6-trixie` - linux; amd64
...
### `python:3.13.6-trixie` - unknown; unknown
...
### `python:3.13.6-trixie` - linux; arm variant v5
...
### `python:3.13.6-trixie` - linux; arm variant v7
...
### `python:3.13.6-trixie` - linux; arm64 variant v8
...
### `python:3.13.6-trixie` - linux; 386
...
### `python:3.13.6-trixie` - linux; ppc64le
...
### `python:3.13.6-trixie` - linux; s390x
