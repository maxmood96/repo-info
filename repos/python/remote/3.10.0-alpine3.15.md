...
### `python:3.10.0-alpine3.15` - linux; amd64
...
### `python:3.10.0-alpine3.15` - linux; arm variant v7
...
### `python:3.10.0-alpine3.15` - linux; ppc64le
...
### `python:3.10.0-alpine3.15` - linux; s390x
