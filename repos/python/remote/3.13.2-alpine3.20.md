...
```console
$ docker pull python@sha256:e885b40c1ed9f3134030e99a27bd61e98e376bf6d6709cccfb3c0aa6e856f56a
```
...
### `python:3.13.2-alpine3.20` - linux; amd64
...
### `python:3.13.2-alpine3.20` - unknown; unknown
...
### `python:3.13.2-alpine3.20` - linux; arm variant v6

```console
$ docker pull python@sha256:0f32ebea2b6151a77d91e7ea53b33469d2ce6c990a8998af7856118b037993b9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.9 MB (15922145 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1077338f6360070cf2107954a0113b5d17d8aba8ecf9e5516a15411bbb220cef`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:4b84388302016da44652456393b1080afb8a1bdb49c0ddf489234bcae7634ee1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.5 KB (22521 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:012a92acd3f68205f81d4bf808c1887200b3d9cda78dc37d32ee68ffc6befc86`

```dockerfile
```

-	Layers:
	-	`sha256:98a07f02cceccbd35bdac25eba0466613fb549522b572c1b2e3b81897d7df2ee`  
		Last Modified: Sat, 15 Feb 2025 10:06:30 GMT  
		Size: 22.5 KB (22521 bytes)  
		MIME: application/vnd.in-toto+json

### `python:3.13.2-alpine3.20` - linux; arm variant v7

```console
$ docker pull python@sha256:ffae15a3aada8111360b742a7ecdaa1d34fc4710e0b3fa9cc3b9492e2fd1ebc1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.3 MB (15307243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3aa13307aaa926ba21da786b612bd6301763a84f693f1382c1bf2d62d23bedf6`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:18f4cb7388b9d708161c95185c4d1982d9199b1f910e96a98d5cfa484f590ca0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **640.8 KB (640753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20e57dfda8c8ef7d2a47287e170b9780b9be41b888e1f70b614eddeb3cb2851f`

```dockerfile
```

-	Layers:
	-	`sha256:ad1cfd1daad8983cdcfd5437a898f17716b46c2c30878d3c024e7d114a67007c`  
		Last Modified: Sat, 15 Feb 2025 10:06:32 GMT  
		Size: 618.0 KB (618016 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7206c189c0cae7b0cd629e93a3b90ded93efbe67fd1996f8ddfcb0d5bdece8bc`  
		Last Modified: Sat, 15 Feb 2025 10:06:32 GMT  
		Size: 22.7 KB (22737 bytes)  
		MIME: application/vnd.in-toto+json

### `python:3.13.2-alpine3.20` - linux; arm64 variant v8
...
### `python:3.13.2-alpine3.20` - linux; 386
...
### `python:3.13.2-alpine3.20` - linux; ppc64le
...
### `python:3.13.2-alpine3.20` - linux; s390x
