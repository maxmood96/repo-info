...
```console
$ docker pull python@sha256:f74e244c26cf94c81a2a6ec8e4e5e55e59bae979063c83382cafb87f03fc1f56
```
...
### `python:3.14.2-alpine` - linux; amd64
...
### `python:3.14.2-alpine` - unknown; unknown
...
### `python:3.14.2-alpine` - linux; arm variant v6
...
### `python:3.14.2-alpine` - linux; arm variant v7
...
### `python:3.14.2-alpine` - linux; arm64 variant v8
...
### `python:3.14.2-alpine` - linux; 386
...
### `python:3.14.2-alpine` - linux; ppc64le
...
### `python:3.14.2-alpine` - linux; s390x
