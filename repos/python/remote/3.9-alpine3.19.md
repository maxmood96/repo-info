...
```console
$ docker pull python@sha256:ed4ba8b56018a1d217ada4d5e8ed6c9820f9a15a0b9da9159095675eaf8fb47c
```
...
```console
$ docker pull python@sha256:0ad78a099ce19b7cd021bb256df6f14bd9f6f27da7f51d4d5a2d0eff48637ceb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.6 MB (18556187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47b7fae9df6e2fe2837768adb2092832c6573a9f3b1aba0f478c12e05642d79e`
-	Default Command: `["python3"]`
