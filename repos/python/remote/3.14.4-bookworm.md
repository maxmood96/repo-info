...
```console
$ docker pull python@sha256:786d12398a4b61918e68bc30d93d0bd679a95136bbbd1dbe4d96f116636516bc
```
...
### `python:3.14.4-bookworm` - linux; amd64
...
### `python:3.14.4-bookworm` - unknown; unknown
...
### `python:3.14.4-bookworm` - linux; arm variant v5
...
### `python:3.14.4-bookworm` - linux; arm variant v7
...
### `python:3.14.4-bookworm` - linux; arm64 variant v8
...
### `python:3.14.4-bookworm` - linux; ppc64le
...
### `python:3.14.4-bookworm` - linux; s390x
