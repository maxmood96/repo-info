...
```console
$ docker pull python@sha256:e81619bf7e1e8d2085380444ca7c0a3263f37aa1a9f70170bd8cbed8c04821ea
```
...
### `python:3.12.4-bookworm` - linux; amd64
...
### `python:3.12.4-bookworm` - unknown; unknown
...
### `python:3.12.4-bookworm` - linux; arm variant v5
...
### `python:3.12.4-bookworm` - linux; arm variant v7
...
### `python:3.12.4-bookworm` - linux; arm64 variant v8
...
### `python:3.12.4-bookworm` - linux; 386
...
### `python:3.12.4-bookworm` - linux; ppc64le
...
### `python:3.12.4-bookworm` - linux; s390x
