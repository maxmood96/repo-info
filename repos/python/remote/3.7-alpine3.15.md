...
```console
$ docker pull python@sha256:454691ba84a74b255b0177ae65657f892a391159e04f08a66fdbbf5467d32375
```
...
```console
$ docker pull python@sha256:69ad6e7416c770485509e89bcdd256d9c4b99e75b466144e0975871fef9c6dc6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **16.4 MB (16352241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5516450e8f058c2100512207342c4fa40618d1246357aedcf93954f26ab9b2f`
-	Default Command: `["python3"]`
