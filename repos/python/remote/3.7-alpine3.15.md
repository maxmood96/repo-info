...
```console
$ docker pull python@sha256:d64e0124674d64e78cc9d7378a1130499ced66a7a00db0521d0120a2e88ac9e4
```
...
```console
$ docker pull python@sha256:9a14a9ce422a61e4a56cb730873ab5e9f816212bbc145d2cb6b67c470e1484ee
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.8 MB (15801226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:819d8e7ef74c6fe897cf9f0ccc6dae38afcc74485c1e49a21cfc662d538c79ec`
-	Default Command: `["python3"]`
