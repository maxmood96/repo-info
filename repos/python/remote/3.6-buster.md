...
```console
$ docker pull python@sha256:70fd6e9637290b356501cc3ec01c8db21358d39d0f454551cb82bcb8e65f357e
```
...
```console
$ docker pull python@sha256:60c01b46a175d4867a6523cded8e88bc4ee82b87a736b16bd178fbf9d2cb6944
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.9 MB (320926792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50dda16ba3400061f7f5ae364deb989c577d649fc2f4604198850b3cc7417ca3`
-	Default Command: `["python3"]`
...
# Sat, 04 Sep 2021 04:52:30 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Sat, 04 Sep 2021 04:52:51 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 04 Sep 2021 04:52:52 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c62fd8d9150ad7644ed090e3cfcd58ca73938182368faf4044718806ed94bc50`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b50996e033b0d26f6c30ada6325faf2493d7b0ad5042e01ea9a890c016321960`  
		Last Modified: Sat, 04 Sep 2021 05:32:20 GMT  
		Size: 15.2 MB (15155674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7de17420a94efd35b6f33c7b92a380c6a5566391b5d03a5f936374ad7d6b91d`  
		Last Modified: Sat, 04 Sep 2021 05:32:08 GMT  
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e06dd9ce0633e4be7abc37bc4a8800a794d1957025f9a96088335968496387be`  
		Last Modified: Sat, 04 Sep 2021 05:32:10 GMT  
		Size: 2.2 MB (2208303 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
