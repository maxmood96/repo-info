...
```console
$ docker pull python@sha256:ccfff0e1c234978f7082b68833651d69526f74ccd05085353ae63a722a426c61
```
...
### `python:3.13.2-alpine` - linux; amd64
...
### `python:3.13.2-alpine` - unknown; unknown
...
### `python:3.13.2-alpine` - linux; arm variant v6
...
### `python:3.13.2-alpine` - linux; 386
...
### `python:3.13.2-alpine` - linux; ppc64le
...
### `python:3.13.2-alpine` - linux; s390x
