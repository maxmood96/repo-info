...
```console
$ docker pull python@sha256:b7ac51991e2d3a399d1ca11d5b6df575b43e6c5022bab1583fe3e9e9ab5174d3
```
...
```console
$ docker pull python@sha256:1ee68d76dbc6e3cbbe33ae7f434100e4858260ab20f38c16746b1655d82e8d6c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **361.2 MB (361174870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45aa5353fc1023c9ee7af8e90deacb647eaa3a21a69c37e3537b164f48a8139e`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 11 Aug 2020 21:52:51 GMT
ENV PYTHON_PIP_VERSION=20.2.2
# Tue, 11 Aug 2020 21:52:53 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 11 Aug 2020 21:52:59 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 11 Aug 2020 21:53:25 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 11 Aug 2020 21:53:30 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:056e9dcdb4b34db62bfd4b6ef3c685672357b87a81c57d4c6ea30911f181c1a7`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24807c4d7b7a874f7e22a031c480d9cfa3a90ef6eba6cfbfa3e5440bbef58c40`  
		Last Modified: Tue, 11 Aug 2020 22:16:06 GMT  
		Size: 2.1 MB (2119818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; s390x

```console
$ docker pull python@sha256:3db66d83de5d927cd2ca87effd108c8e477af9fa1476707b1e48ef492cfdfcfd
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.2 MB (320236658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca68a4a684c2ec6de2d7bb7d6e2bf21e18e02d3506fcc16357d300523aa2d437`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 11 Aug 2020 20:42:27 GMT
ENV PYTHON_PIP_VERSION=20.2.2
# Tue, 11 Aug 2020 20:42:28 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 11 Aug 2020 20:42:28 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 11 Aug 2020 20:42:33 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 11 Aug 2020 20:42:33 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cf574bd8438a5aead2443189252cbbf8e871e0ae58841eb175357e75b407db4b`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2289e0145aba1bbc935c8b7979695e69153e44aadc44722a046d40eaa79cbd56`  
		Last Modified: Tue, 11 Aug 2020 20:46:51 GMT  
		Size: 2.1 MB (2119629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
