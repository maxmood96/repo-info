...
```console
$ docker pull python@sha256:5f865f9aec3bb1d280cae5fd45d7e54a71841bed0e5a5d7c04c6dcde37588da6
```
...
```console
$ docker pull python@sha256:f4a80485550dcb86a4f82e68842b91f0a17c8b54703e20a59dbee154769a71d5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.2 MB (340201830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59433749a9e33baff917df20844700d2c9e340c0d574c2f1157b09487cdaf3ab`
...
-	Layers:
	...
	-	`sha256:abbaf10bd160ffc7dd605ff95789a35730f1ee6d3e249b53f0ca07d6d0556195`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17cd945c5d4dac4ff8abfb763fb5171630bafb0e9a4f2dba6aab1c5d2baf90d9`  
		Last Modified: Fri, 06 Aug 2021 22:01:24 GMT  
		Size: 2.4 MB (2355407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; arm variant v5

```console
$ docker pull python@sha256:a878782a3a5d7f0e8cd5be9eacf46ffd05b774c2a573d7ef47a4ef249a943c00
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.6 MB (312619849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66b71666dbd7b692b607732a223d089dc3d7358b71cac51393dfd8b649fd2481`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:41:16 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:41:17 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:41:18 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:41:36 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:41:37 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:e0d4674dd0583c6a258d2ce150381f4a8b2de9fe7aa8092775539b8178f227ad`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bef395a884dcf62de1d318443cd9a404c0e4b28546ea6b0b8c06ad0e885f5d2`  
		Last Modified: Fri, 06 Aug 2021 19:55:07 GMT  
		Size: 2.4 MB (2355412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; arm variant v7

```console
$ docker pull python@sha256:0e5a18fae7869b73c2c4ce8df4115e86906fa94522ac4be811f3eccd884bc800
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.3 MB (304272737 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08fd19854492a2f9e70ceb69416260b82b7039520dc2f75fb00174541a7d6400`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:11:25 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:11:26 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:11:26 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:11:41 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:11:42 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9dc0a5c8c1da6b79c42598fa514d78b3722f9b430c1b66d00455ae519f73c7f2`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76024eaca6cbabdb3c36df9299c1b8a065afa442c3e5ef28a195c532bb1edc3a`  
		Last Modified: Mon, 02 Aug 2021 19:30:46 GMT  
		Size: 2.4 MB (2356103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; arm64 variant v8

```console
$ docker pull python@sha256:8b4024e72d7245a58010f10214a44596ea86eb76c68f59ecc6a5f817a803b7e2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.3 MB (330334636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c63f5231fa7a9ba41c1149b5dfa1d12bc77dd4d0f1dac0a25b855b82d53fab86`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:1354066e326c01c7f44839a2d7499ce10c62c0036dc4641e388dabdbe4f03ec3`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eea5fef8384b259ed8841931a3efe33a8a9a5eddd844db6aa639c1ac0ec69c9`  
		Last Modified: Mon, 02 Aug 2021 19:57:41 GMT  
		Size: 2.4 MB (2355934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; 386

```console
$ docker pull python@sha256:bf0b690c0445a8d973e3933d6937a4941f309c863377cdc385c72bf359d4d22b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.3 MB (349267723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a2df09e2ce074ef75ae9a8d0a5a5916f58940e4eb73367aedb2ac5415d4e942`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:46:06 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:46:07 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:46:07 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:46:14 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:46:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:2f127239ffd174908e914af67ed3208d88bb972462aa376978967c41d691c404`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57bbab226edcb82967890f2a92876b98d073c967359c7468792d0792dabb466c`  
		Last Modified: Mon, 02 Aug 2021 19:56:50 GMT  
		Size: 2.4 MB (2355896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; mips64le

```console
$ docker pull python@sha256:ee9e9a45dc74fcbabb41afe1f8329d20abc261884c028e07d9200d32c4f7aa11
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.7 MB (324738777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cada1bb42cbdad2686cc69975ae1e16687f82d3cbf1e00db0c187e36b052ef4`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:10:29 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:10:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:10:29 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:10:53 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:10:54 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:075436562824ce288d05c30ddf890f2cf38b7f32112555d69e2740b6b0a16096`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08a4e1c6c4e7e3fa81c88e6e84602786c1cd8a92de9117f411d6b18caa7b9ae9`  
		Last Modified: Fri, 06 Aug 2021 19:16:57 GMT  
		Size: 2.4 MB (2355294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; ppc64le

```console
$ docker pull python@sha256:27a59e0df96ba1ad245acd1918588f467788dd1a40d71202b5e62e8a6c637d65
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.9 MB (362879879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d950eb7fa3db31a0b75f58453f358122814c044f85e0f35c6265e740695e2b6`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 18:47:30 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 18:47:36 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 18:47:44 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 18:48:22 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 18:48:32 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:7d7cb218ce981d398133ad3280d4fb4a8174bd07ae818706a6ba74d16e733265`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba4511e095ef60abfe3a18ef48c18b3d6ed89833320c1037fa5841c14cdb4b28`  
...
```console
$ docker pull python@sha256:df3ad0d607a25bb17f3d9842888be9b9f380db57d50776362b2cb14a164fe56d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.8 MB (321839928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:546add2e8b969dce56d95d9a1def24d5aed298cfb3d5e8e90fd43bbea4bb6c69`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:52:23 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:52:23 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:52:24 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:52:31 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:52:31 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d9353139a74896eda282c3fe99e7fba41e705ae6a6c088ef27afb54e6227fb17`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb470596a1b7b8a7e242d7e32bf7515270bfcf09a491a0661cdaf08c1b569f68`  
		Last Modified: Mon, 02 Aug 2021 20:12:50 GMT  
		Size: 2.4 MB (2355962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
