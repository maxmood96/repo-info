...
```console
$ docker pull python@sha256:0e7635f347c34c95ed6e2e8cd5c4ecdc2a52035cc834fcdb21931e0b826b620a
```
...
```console
$ docker pull python@sha256:8c90c57a8a239efd988b4b1438854e66e2cd838083937f650da7acef95abb27a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.7 MB (335661405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a236ea392a8cec4f1b7d437caa01758cebbce11fb0a6c35172e87bdb1cd71673`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:f6359af587013428ad954cdba30cb59be048d8b41d83085dc0447423aab01bce`  
		...
		Size: 230.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c11283b0738e99939deae125e472de29e0afc7b1b23c36dfb2df033e9ae6ea06`  
		Last Modified: Tue, 15 Nov 2022 10:56:25 GMT  
...
```console
$ docker pull python@sha256:12d4697debf3c948dee17849c959aa6804d303453327e1ed82d4234f1a6e71f4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.3 MB (354306536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15529922b57952ca9d82314f26be5d61fe8732c0abeec259a1f930e81ec0f61f`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=65.5.0
# Tue, 15 Nov 2022 14:53:08 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 14:53:09 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 14:53:17 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 14:53:18 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:efb0d4aa2eedb883cfa79e4dcec7582cfd9c8e38718a16916459f51f223635e1`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:171d6a27f3bc2b7ce14fde43c5b137d597100bdcddd88417e7eda7c679d08001`  
		Last Modified: Tue, 15 Nov 2022 17:39:29 GMT  
		Size: 3.1 MB (3054589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
