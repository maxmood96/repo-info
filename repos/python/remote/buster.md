...
```console
$ docker pull python@sha256:d4c50342d181abc47bcad850d47595c51dd2ceba7372b37858e57a8bba6bd09f
```
...
```console
$ docker pull python@sha256:a803f8b89ffcddc938836e65e24e0a213a7044163d2687ff87dbf4434ba7fbcc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.3 MB (304261180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ceaae987e01e7b33d92d47426d748af8ffc7b881a00a4b0f5ee3584299270259`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 24 Jun 2021 02:19:19 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Thu, 24 Jun 2021 02:19:19 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Thu, 24 Jun 2021 02:19:19 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Thu, 24 Jun 2021 02:19:35 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 24 Jun 2021 02:19:35 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:e2d10e78fa3edd837c33fedae785b221e5206726992a8ad52f5469a6a1544d1c`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:691dd993a4379bedbaf3d46baecc47da5fb080737007af69f8eaedda00b7633c`  
		Last Modified: Thu, 24 Jun 2021 06:58:31 GMT  
...
```console
$ docker pull python@sha256:1571e5237c523ee43093925fff705720e310308ceff84d73bac4cff5dbb272ca
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.9 MB (362866846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b22be24bf3a5ced2d9a960cff91660355d4527842cc742e17142f0f8271159e1`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sun, 27 Jun 2021 05:39:13 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sun, 27 Jun 2021 05:39:17 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sun, 27 Jun 2021 05:39:20 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sun, 27 Jun 2021 05:39:42 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sun, 27 Jun 2021 05:39:46 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:afa89e9703cd1d6162a96d523c5148ab70140bea85c5165aa09e917c30f2b02a`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cc9e97b5d4867ab1b902fa99fd2908701f633c44e861669fb57539a6441c7f2`  
		Last Modified: Sun, 27 Jun 2021 09:02:24 GMT  
...
```console
$ docker pull python@sha256:bdf5e30d29eb7b6a44ffc5327e15c94a20711f5ad98743e5b071323eb2fcd485
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.8 MB (321825187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4af5619d991da31ed00c30330fd153e9b603b2b8aeebdf1e67ea036cbcd4d278`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 26 Jun 2021 22:13:15 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sat, 26 Jun 2021 22:13:15 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sat, 26 Jun 2021 22:13:15 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sat, 26 Jun 2021 22:13:22 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 26 Jun 2021 22:13:22 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:84f867559c9164a7a8e02702e9918c8c1bf9ed782ca0a7b7dbfa67bead23159c`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d24b08de5403cd2006951ec5242ab402531d00fd8e1a4364bf627975fff23547`  
		Last Modified: Sun, 27 Jun 2021 11:32:50 GMT  
