...
```console
$ docker pull python@sha256:ebda34d86d2246f7c649db0275b0efe16449d5b5125ee4aeea4d14134236b07c
```
...
```console
$ docker pull python@sha256:6e34cd2c16e096a4bd28d78deb5476ef5f73d5c48c302649a931733180ec460a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.6 MB (324589254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c4e740e043421fa4cba15236bfb9ac0af2ef15a3e46e731c91732912e748722`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 17:52:36 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 17:52:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 17:52:37 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 17:53:01 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 17:53:01 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:16cbe0251a796b79177a2d7c16d5e8712f47ebf9217c3f076a0b242764df3265`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928d7377f9055de92330b65d08c797c35c329c807e6022ed6cbf147b67e1a55c`  
		Last Modified: Wed, 28 Apr 2021 18:00:11 GMT  
		Size: 2.3 MB (2311517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:buster` - linux; ppc64le

```console
$ docker pull python@sha256:b773cb3ae681ab78c0556bee9f7ce70691f82621dfbcc06d0db6d9ed7ed38e41
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.7 MB (362711347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f5e88279b28f6a65e1ae31537b9614faef3724e06fcf062ecc2b5270ad4a8b7`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 01:03:44 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 01:03:50 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 01:03:56 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 01:04:40 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 01:04:52 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9050c8c66e6cf7acc5127c6075004e58ecf62e14459290d0df47c0950ae4a260`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f568e398f75350adb5adaacf983c86f98ac9608eed7c749fa2cd0ad4a10a368`  
		Last Modified: Wed, 28 Apr 2021 01:31:57 GMT  
		Size: 2.3 MB (2311700 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
