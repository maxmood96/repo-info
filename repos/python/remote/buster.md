...
```console
$ docker pull python@sha256:bec7e84088052ae28a2c268926d11133bfd7c14a6f809e4c849ec283a2627d21
```
...
```console
$ docker pull python@sha256:9ac930795d9333af266a5b3ac61fb4c1107aa401eacf8f406e52c1619354362f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.8 MB (314827350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a89749231ea4507af628ae695b56bef0560968bbad52fc0feb817695661d1e8b`
-	Default Command: `["python3"]`
...
# Wed, 27 Jul 2022 01:13:28 GMT
ENV GPG_KEY=A035C8C19219BA821ECEA86B64E628F8D684696D
# Wed, 27 Jul 2022 03:48:55 GMT
ENV PYTHON_VERSION=3.10.5
# Wed, 27 Jul 2022 04:21:54 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-lto 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 04:21:55 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 04:21:55 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 04:21:55 GMT
...
-	Layers:
	...
	-	`sha256:807b5461b9f694693b616506330e973f2021b9143f16f8da7aa55820caa40ff8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40d89c26f1628b8eccabf04028202fc17412cf26cfaa86f21595c7980455dd42`  
		Last Modified: Wed, 27 Jul 2022 07:36:31 GMT  
		Size: 19.8 MB (19825895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35967ced7a279f68dfc79d2e9de859cb955be2d52e59f27b9f1b4694b6428c6f`  
		Last Modified: Wed, 27 Jul 2022 07:36:25 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab5bcad5dce2346aa792d00cad3891cac883386d18288f3ad44e33742dbbee39`  
		Last Modified: Wed, 27 Jul 2022 07:36:26 GMT  
...
```console
$ docker pull python@sha256:3902164080bf2176ca719db089a2e6468ccd0aa90a44b04f4f1e04382f706484
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.4 MB (306438039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64f6f2c837ec09b2108b25f48795ee1da69cba903be37b57fd552ac74533ccf3`
-	Default Command: `["python3"]`
...
# Wed, 27 Jul 2022 02:27:16 GMT
ENV GPG_KEY=A035C8C19219BA821ECEA86B64E628F8D684696D
# Wed, 27 Jul 2022 06:23:58 GMT
ENV PYTHON_VERSION=3.10.5
# Wed, 27 Jul 2022 06:45:34 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-lto 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 06:45:35 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 06:45:35 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 06:45:35 GMT
...
-	Layers:
	...
	-	`sha256:1b4849f783e6329af6d978ade7eba59fa80adbd00f743b0e25711d120917d829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9adf2ba0c8c64620d286f68120d7402bc824f4aaede73de6c6194abad387c07`  
		Last Modified: Wed, 27 Jul 2022 10:56:17 GMT  
		Size: 19.6 MB (19551176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c7c5ca97e0234b0ed3fb4c233c54e5247f1503813472756ab204f549004650f`  
		Last Modified: Wed, 27 Jul 2022 10:56:13 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76d59efd70d4cb0aa606bba072fc5549e5312a8c84ae90d969f746e0e323ac63`  
		Last Modified: Wed, 27 Jul 2022 10:56:14 GMT  
...
```console
$ docker pull python@sha256:583588b0ec7e32d0a4315030978bc8d874ff99cf9c06f10067507eaadbf8d720
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.9 MB (323867844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47f1e5391146341d25245d945b710c6a4e52f954fcb116e6aad8af941b5d29f2`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:84060af27676a7a1e800e38dc8d874139fbbcb996d1deb9215ba1bab741ddf20`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e3c8755aba6b9a1a4e1d5bd0740af78d988491d8a8de30286186125ab268bd4`  
		Last Modified: Wed, 27 Jul 2022 01:23:10 GMT  
