...
```console
$ docker pull python@sha256:3b844d1ff63a69d5b634e389b207270c84f6f7a014ec09ae00364b2c03069e20
```
...
### `python:3.11.5-alpine3.17` - linux; arm variant v7
...
### `python:3.11.5-alpine3.17` - linux; 386
...
### `python:3.11.5-alpine3.17` - linux; ppc64le
