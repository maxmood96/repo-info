...
```console
$ docker pull python@sha256:e0ecde581c1539fd67ad156d2f1155a76c055dbcddacf757cda745478ac0e7fe
```
...
### `python:3.11.8-slim-bookworm` - linux; arm variant v7
...
### `python:3.11.8-slim-bookworm` - linux; ppc64le
...
### `python:3.11.8-slim-bookworm` - linux; s390x
