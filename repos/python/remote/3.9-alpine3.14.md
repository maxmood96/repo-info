...
```console
$ docker pull python@sha256:163dcb9efe7ae9e3a074d6a2e0e2efff4580ae873692bb3db77c4aad0fcd4521
```
...
```console
$ docker pull python@sha256:82d5e2be13a6c6ead86daf9fcfff7b33dfd92fb56908a7adcbd3406e10106637
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.6 MB (18639891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c32e3512a7427b2dfc752908f580b9e1f80f70e514f238bcfc90507954a66b59`
-	Default Command: `["python3"]`
