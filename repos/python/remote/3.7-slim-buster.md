...
```console
$ docker pull python@sha256:5f64348e9e1edc33836953dc6d1d1b355c600357402381f279e66c2f2f1637de
```
...
```console
$ docker pull python@sha256:fad39181d29bc5e515554ac65052e2aa3125918797d4109fd1fcc182eb976455
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.8 MB (40793950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d9bcd56561026b8e83beec87c3712f111c06b498b92f6401eba156cc40c9094`
-	Default Command: `["python3"]`
