...
```console
$ docker pull python@sha256:5476b9122ec71cfdabc0da5ab4a379fe610c2a9a5b4eba7f93ef5fb1d407b9fa
```
...
```console
$ docker pull python@sha256:39fba5e8e8101f26fff7f0273430afa32fa05a48a35c9ad5c04959a32d45703a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.1 MB (41073628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed04d2bf06703a1e720f131f31fc47b4e47509a16f769c2c4560dcf0da43dd81`
-	Default Command: `["python3"]`
