...
### `python:3.13.0-bullseye` - linux; amd64
...
### `python:3.13.0-bullseye` - unknown; unknown
...
### `python:3.13.0-bullseye` - linux; arm variant v7
...
### `python:3.13.0-bullseye` - linux; arm64 variant v8
...
### `python:3.13.0-bullseye` - linux; 386
