...
```console
$ docker pull python@sha256:5c5787c0e1f5f9279c05742368d0b271ae717c1c770279919d05150038f44912
```
...
```console
$ docker pull python@sha256:afd709e72f5862f7a9bc4314cc09f523da10bcf709a027b5459d7e25c91c0186
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.5 MB (44481028 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2dbce078c271ca7721c07ae3c57959204fd3a6e7a0b834f49e023de7c3324185`
-	Default Command: `["python3"]`
