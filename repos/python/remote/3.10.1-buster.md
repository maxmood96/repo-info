...
```console
$ docker pull python@sha256:495865ee17cf10f775e8199ae3641782463f5ce93791db530f86bfd56468e65f
```
...
### `python:3.10.1-buster` - linux; arm variant v7
...
### `python:3.10.1-buster` - linux; ppc64le
