...
```console
$ docker pull python@sha256:5d56baebbacccfe05b7ab00ec79c836c63ad489718383f41f634d511176cc12c
```
...
```console
$ docker pull python@sha256:b4e71f9ad518cd0ed7e3331b16ef6c6e1b3d95d1d696df0ef299b0334535c2db
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.1 MB (348123879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f82b6ca31aab8c31e0775d5269a2a126c8fcb5b04e09b333ffedf7a13dc95a1`
...
-	Layers:
	...
	-	`sha256:ad2e23ed164a08186d5c369a0277c41f4dc18c524d1473da4df131df930e840e`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80d261bf3cb8eb1bcc0de1ab05a3090b3fcf9d6a6a653d515e4f7b27b716e6b9`  
		Last Modified: Tue, 20 Oct 2020 17:56:52 GMT  
		Size: 2.1 MB (2121123 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.9-stretch` - linux; arm variant v5

```console
$ docker pull python@sha256:7391db9616992fbac0036b8b071774bc6381333e022d42fee4df9c38c6d64393
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.4 MB (330420848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9223762d2332239214c5d909702c55f3b0af644d76c62eeaf0825cef33534b09`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 20 Oct 2020 18:04:48 GMT
ENV PYTHON_PIP_VERSION=20.2.4
# Tue, 20 Oct 2020 18:04:49 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/8283828b8fd6f1783daf55a765384e6d8d2c5014/get-pip.py
# Tue, 20 Oct 2020 18:04:50 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 18:05:12 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 18:05:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:1ed5c5bc67b9bb42d4c47020e325369cdf0d888cee067237a3d94a58529eb22d`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6998d04e7634fab5182f5c184d967333d6331ac89420441bd782028c06862734`  
		Last Modified: Tue, 20 Oct 2020 18:12:41 GMT  
		Size: 2.1 MB (2121503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.9-stretch` - linux; arm variant v7

```console
$ docker pull python@sha256:6296cfc5fe47d7a92730d481bcacc93d742e46534b7dda8e45dd35d42f672448
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318626319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:380afc3e94e2b18e146c6e7c0f11e13136319a4f77483f036cc4161b8bb8a4ae`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.2.4
# Tue, 20 Oct 2020 18:10:01 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/8283828b8fd6f1783daf55a765384e6d8d2c5014/get-pip.py
# Tue, 20 Oct 2020 18:10:05 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 18:10:45 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 18:10:50 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:b6043397e5bfc9a8f9552f8843d74e158f9284c9e41084ecd03cc6e0c5e75c42`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c9093262063888c9937eb4e138fe7c2c20449617145b9e69a3d0367be9c7ef`  
		Last Modified: Tue, 20 Oct 2020 18:22:04 GMT  
		Size: 2.1 MB (2121375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.9-stretch` - linux; arm64 variant v8

```console
$ docker pull python@sha256:9b754fc25bb1771b3854f900ac8e5726d09dbda71745eca6e2672edb349bc6be
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.1 MB (329149524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8800bab869008b1c8f2347d9ddaae6a93f631541e50c1c65d42f5e9d461f1747`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.2.4
# Tue, 20 Oct 2020 18:08:44 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/8283828b8fd6f1783daf55a765384e6d8d2c5014/get-pip.py
# Tue, 20 Oct 2020 18:08:46 GMT
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 18:09:02 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 18:09:04 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:15a8e35169a45778fdf88ee20f1662d54e03bab8340e8fe4b5b10f01187f1776`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aee6b456484ec4610e549e2038e96044ccee2718f166369c77ce79b423849746`  
		Last Modified: Tue, 20 Oct 2020 18:19:21 GMT  
		Size: 2.1 MB (2121435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.9-stretch` - linux; 386

```console
$ docker pull python@sha256:31751f2854708b4b2778e340e727e8d84afbdc29aa33647f36f9ecef3a6ee02a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.4 MB (355375484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e68a33c919a9767617162e0eb1770c743d4caa204891170d99299cafdf64d7a4`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:f5ebce21649376cb2d399e7bde62a68e0fc7100f6c50e2168691e1312de74baf`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62beea9f15fb8a55a6f40731d6fca0be7dc86041199954a2e595075cb42fd70d`  
		Last Modified: Tue, 20 Oct 2020 17:56:26 GMT  
		Size: 2.1 MB (2121123 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
