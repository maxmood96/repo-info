...
```console
$ docker pull python@sha256:dff974cfb598fef89610a2853fc2c4e80e7ad335859f7e43f42fc0adb9d46c77
```
...
```console
$ docker pull python@sha256:8dec34c74d62769eefd33cf0ea0ba73892ce857d21b6244e34756d55f3e84d04
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.2 MB (348238396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f072e5917967cb138e89c48720d83f33293c21f768cdd2815e8b8f9fd48ed7b`
...
-	Layers:
	...
	-	`sha256:0dfee554fe488f93ae4e660f538000673a1172b83a688b9481ede5e854b5b219`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc67a1c0ed380f9ae815487bfa6c8702e125a77b12fc48513d166bf07b73305e`  
		Last Modified: Tue, 02 Feb 2021 00:26:00 GMT  
...
```console
$ docker pull python@sha256:8f952b1a251f251363603eef194881cf89e1e67c6840730769a3a97fce9b8b68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.7 MB (330719370 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32a93523bb3bb15885a205f7e085fc92805abd6024bf39778b683140c1c74de2`
-	Default Command: `["python3"]`
...
ENV LANG=C.UTF-8
# Fri, 05 Feb 2021 23:16:29 GMT
RUN apt-get update && apt-get install -y --no-install-recommends 		libbluetooth-dev 		tk-dev 		uuid-dev 	&& rm -rf /var/lib/apt/lists/*
# Fri, 05 Feb 2021 23:16:30 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Fri, 05 Feb 2021 23:16:31 GMT
ENV PYTHON_VERSION=3.7.9
# Fri, 05 Feb 2021 23:26:04 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 		&& ldconfig 		&& python3 --version
# Fri, 05 Feb 2021 23:26:11 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 05 Feb 2021 23:26:11 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Fri, 05 Feb 2021 23:26:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/4be3fe44ad9dedc028629ed1497052d65d281b8e/get-pip.py
# Fri, 05 Feb 2021 23:26:13 GMT
ENV PYTHON_GET_PIP_SHA256=8006625804f55e1bd99ad4214fd07082fee27a1c35945648a58f9087a714e9d4
# Fri, 05 Feb 2021 23:26:32 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 05 Feb 2021 23:26:33 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:94daff07ac6737556a4f695683056b7f28694398f90589835eeb77667d1ebbfb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c5938c813dd5df100b2838dec095d50a59c5a5823422384353a01a11933a8f`  
		Last Modified: Fri, 05 Feb 2021 23:34:31 GMT  
		Size: 6.0 MB (5956544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbc1ed91a39c52665a4acac3b661ba9c7f2c9d1bfbfa7aff605df694413d9488`  
		Last Modified: Fri, 05 Feb 2021 23:34:34 GMT  
		Size: 13.5 MB (13544850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56547eff42e71ccb8758e97739a86cd1a4eea07553451669e38579c2257f228c`  
		Last Modified: Fri, 05 Feb 2021 23:34:29 GMT  
		Size: 242.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20d8778a8f73eb387c507dbe5ba41b65ef4dfcfbd5495a001c4b4a09489ac765`  
		Last Modified: Fri, 05 Feb 2021 23:34:31 GMT  
		Size: 2.2 MB (2164487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.9-stretch` - linux; arm variant v7

```console
$ docker pull python@sha256:b74a4ab416a219481a5372ad1007e3c0d8f20b819caddbb9a7bba38a8a9a0f10
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.8 MB (318768440 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ced98c178fcd40c0810171a3f217bbf0450339a46a1301dccacc38cd48640676`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 01 Feb 2021 22:10:08 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Mon, 01 Feb 2021 22:10:09 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/4be3fe44ad9dedc028629ed1497052d65d281b8e/get-pip.py
# Mon, 01 Feb 2021 22:10:09 GMT
ENV PYTHON_GET_PIP_SHA256=8006625804f55e1bd99ad4214fd07082fee27a1c35945648a58f9087a714e9d4
# Mon, 01 Feb 2021 22:10:46 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 01 Feb 2021 22:11:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:68f05a742b8a4a046173c1d446e1d86ed5dbd936210a712c365078194f2a1ce9`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d94eccf715cea0f6bc8abaab5c49f3fdd0a7a91aae05a313538f2e8c79f8972`  
		Last Modified: Mon, 01 Feb 2021 22:19:35 GMT  
...
```console
$ docker pull python@sha256:e81e3a4ff219420e8daa26ff3f18b9b286ff31583cf65eb579a0a3d9a4419b63
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.3 MB (329269775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac3a077ed57ac83a56908a7d133de6614cf4c8f1410d6dbf7f52c57d967d5de1`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 01 Feb 2021 23:22:36 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Mon, 01 Feb 2021 23:22:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/4be3fe44ad9dedc028629ed1497052d65d281b8e/get-pip.py
# Mon, 01 Feb 2021 23:22:37 GMT
ENV PYTHON_GET_PIP_SHA256=8006625804f55e1bd99ad4214fd07082fee27a1c35945648a58f9087a714e9d4
# Mon, 01 Feb 2021 23:22:52 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 01 Feb 2021 23:22:53 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:218510bf246db037b16655895f976639b049f050da913f4e55ebeab5d95cc810`  
		...
		Size: 243.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23dbd582dea94aeaedf1ba9c161756ea37574ade9643c9076fa2f6842e5f1115`  
		Last Modified: Mon, 01 Feb 2021 23:31:07 GMT  
...
```console
$ docker pull python@sha256:0d25fc9807358693054813067e66c14183bfa30df532234db32eaa8bbf832f59
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.5 MB (355488755 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f67d9b2629b125cbd41093f47affc45b63dff9497879189db452f0955506c5f3`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:51c304654959f2e0f4f905bea600ddc49718d39d8262902c8ded03f1bd6d2054`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1234c1478a07450d1d985c8bb98afa36cb2bd861e5d3fb8216ebd8acb33c373a`  
		Last Modified: Mon, 01 Feb 2021 21:51:23 GMT  
		Size: 2.2 MB (2164418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
