...
```console
$ docker pull python@sha256:812f74121b715c48bdd9a021e30e6bb4fa6c341321fef3b6c8492169f9a8d437
```
...
### `python:3.7.17-buster` - linux; arm variant v7
...
### `python:3.7.17-buster` - linux; arm64 variant v8
...
### `python:3.7.17-buster` - linux; 386
