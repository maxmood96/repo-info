...
```console
$ docker pull python@sha256:c4ef1e5398feb60190e3396ac57cade150145bf74502264702f8ff3906591754
```
...
### `python:3.9.11-slim-bullseye` - linux; amd64
...
### `python:3.9.11-slim-bullseye` - linux; arm variant v5
...
### `python:3.9.11-slim-bullseye` - linux; arm variant v7
...
### `python:3.9.11-slim-bullseye` - linux; arm64 variant v8
...
### `python:3.9.11-slim-bullseye` - linux; 386
...
### `python:3.9.11-slim-bullseye` - linux; mips64le
...
### `python:3.9.11-slim-bullseye` - linux; s390x
