...
```console
$ docker pull python@sha256:24680ddf8422899b24756d62b31eb5de782fbb42e9c2bb1c70f1f55fcf891721
```
...
### `python:3.12.3-alpine3.18` - linux; arm variant v7
...
### `python:3.12.3-alpine3.18` - linux; 386

```console
$ docker pull python@sha256:12fbecacf7792a0bbae7ab5af8e251df0c66b17dd24aa49b0c544d932b905789
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.3 MB (20262121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cd5a20b800349988de18f6d82fa86ed36db9bf83657825d7c379edd50fe85fd`
-	Default Command: `["python3"]`
...
### `python:3.12.3-alpine3.18` - linux; ppc64le
...
### `python:3.12.3-alpine3.18` - linux; s390x
