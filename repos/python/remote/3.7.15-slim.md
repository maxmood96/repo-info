...
```console
$ docker pull python@sha256:1c087bd077dafec71fa40c7cb1f9ddbc107a4a77308cc7e86263f4a5d2776783
```
...
```console
$ docker pull python@sha256:399a71715d499fc9275ad1faf72d817cecbd851213fa39969e1684ebc38e45e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50642507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5098d64ff7ce6dba07abd4acb6a057d0adc09199d696bb658acca7add2a63641`
-	Default Command: `["python3"]`
