...
```console
$ docker pull python@sha256:98453933ad9f0c4aa257244e6ac2a070e21ee8df314e87b19dc6fb620e0f2914
```
...
```console
$ docker pull python@sha256:acff4feac3181e6ba89b1039eb445b3aac0477281a573d25e7a616bea5d96a19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.7 MB (321653831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84739733ca099a3af755d5b208c73aaad6f6e8677c0e9534df6a114ed319b9de`
-	Default Command: `["python3"]`
...
# Sat, 28 May 2022 14:50:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a312303dbd516f6a692f2fee59852701bd828dd8/public/get-pip.py
# Sat, 28 May 2022 14:50:25 GMT
ENV PYTHON_GET_PIP_SHA256=8dd03e99645c19f49bbb629ce65c46b665ee92a1d94d246418bad6afade89f8d
# Sat, 28 May 2022 14:50:41 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sat, 28 May 2022 14:50:42 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:8c0caf62280ac9056fa67628061737745525a3c47c1614c2d0f678887da63cdf`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:029658d34e0dc6609aa4a8ec8c30cb672df4c0541deec200bf60fc87219cd4a8`  
		Last Modified: Sat, 28 May 2022 18:01:35 GMT  
...
```console
$ docker pull python@sha256:e227b5b2e40df421b22148977a6a2257dbe6f4b2659aa82470fa2a8bd042e11e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.6 MB (340563518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73e96a93fc0be6578f2fc46c8caf6ea291a612d7b4cd9833c7f4f722c0cd39db`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Sun, 29 May 2022 04:49:04 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a312303dbd516f6a692f2fee59852701bd828dd8/public/get-pip.py
# Sun, 29 May 2022 04:49:05 GMT
ENV PYTHON_GET_PIP_SHA256=8dd03e99645c19f49bbb629ce65c46b665ee92a1d94d246418bad6afade89f8d
# Sun, 29 May 2022 04:49:13 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sun, 29 May 2022 04:49:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:83b7afc87dadbec730e3af55ca8a4a156d3885ce06a154008cc12a2ba9d74427`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dc19aeaf9f4dafc1639ae10d9a8020fb4c6718071cad1d7e967dde831b8bb2d`  
		Last Modified: Sun, 29 May 2022 05:33:31 GMT  
...
```console
$ docker pull python@sha256:194b08c8e2e8330584891ed6e87aee3d4337e8aa1038a3769275892bddac8026
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.2 MB (359162043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8460773e3262b5da06d6ef82f745e448b52d518dba8c8207174ded3eac27320`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Sat, 28 May 2022 15:38:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a312303dbd516f6a692f2fee59852701bd828dd8/public/get-pip.py
# Sat, 28 May 2022 15:38:31 GMT
ENV PYTHON_GET_PIP_SHA256=8dd03e99645c19f49bbb629ce65c46b665ee92a1d94d246418bad6afade89f8d
# Sat, 28 May 2022 15:38:52 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sat, 28 May 2022 15:38:55 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c7c2dc62d4935f5089878eb958ffe01e019cced7ff78f8a54102fe15b8929c96`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b776c9d16a71d87d25373a0d1443de6b7e3d9bf6c56a4b577154389513d9aef`  
		Last Modified: Sat, 28 May 2022 18:10:01 GMT  
