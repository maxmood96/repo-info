...
```console
$ docker pull python@sha256:e3f17ae48c935eca126ed3075fbd2a07a2de4d6e55688a96017d823ea1697d53
```
...
```console
$ docker pull python@sha256:255e39b77be1648e6eb601a07485d89bad4e8988effbcf7911f9e787041bf712
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.6 MB (328613132 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9e91ce7b988996cd068e8c36defc7a529398e95d0f8331141a84dd6d75a0e44`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:3469bd31b5cbe32e1dd5c3f1c2e6d37d37ccef9a7f3d5978d2a3cc18b33ec19f`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c74e2ca106e79ef71e8895cc81035e4bedb2bd21cac21ff4565cfda828d2add`  
		Last Modified: Tue, 02 Aug 2022 23:48:05 GMT  
...
```console
$ docker pull python@sha256:9cb9b7cd812f802f7d42cae98487074973e24304be804409fa5c83c6f24340e4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.2 MB (359209701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a73cd126dbcc2f280371dcb9a72ecc2808b4f3193931e60f56c1979a2cae58a`
-	Default Command: `["python3"]`
...
# Tue, 02 Aug 2022 20:35:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/49ca29908cfd49683da12f2d5a4fa5689539f9d9/public/get-pip.py
# Tue, 02 Aug 2022 20:35:30 GMT
ENV PYTHON_GET_PIP_SHA256=d077d469ce4c0beaf9cc97b73f8164ad20e68e0519f14dd886ce35d053721501
# Tue, 02 Aug 2022 20:35:43 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 02 Aug 2022 20:35:44 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:17e1f0f9a64d3f6b2cb0882328fac40c8e495b468c474bded4fb759917c31088`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:658cb4d8cc9ffbc1335ada1f3bd323413b69408e831a031482d70bf36beade04`  
		Last Modified: Wed, 03 Aug 2022 00:17:35 GMT  
		Size: 2.9 MB (2882451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
