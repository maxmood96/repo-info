...
```console
$ docker pull python@sha256:4502196b7a347fc4e8c66c6e30be481b0287aa275a49d6d9fc3b2bbc3f81f65f
```
...
```console
$ docker pull python@sha256:20150e2039a9c35e98b5a0eea7379efec85fc832586949825cd163a5fa004b92
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.4 MB (321411127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a13e7cd0050909a203e1f372fec317cfc15279af874a72cedd03e69fc5b1f4af`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:68f0ea3606791edad731f216aa49260961e1fbaa56898b542310c192fe989dc9`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76b37612c6bce528af39f6c4f87cbb5db5112033450af5c8864d0a7908eeefa2`  
		Last Modified: Wed, 18 May 2022 07:02:04 GMT  
		Size: 2.9 MB (2872362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:0b22d091811da40f15c8c07a07395e034609724f8d6335ce1c069137591765c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.1 MB (328112229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb65aae4c210eb784770995723787b1f2e9eaa731778b4082c013bfdb18e5a18`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Wed, 18 May 2022 07:26:50 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2d26a16e351a22108b46fa11507aa57a732d4074/public/get-pip.py
# Wed, 18 May 2022 07:26:56 GMT
ENV PYTHON_GET_PIP_SHA256=530e7077f9e31f0378b5ee7cc90c8d99b7aef832f3d4ea96b42c2072e322734e
# Wed, 18 May 2022 07:27:31 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 18 May 2022 07:27:37 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:88c7b3fc83358e63328e8d01dc4e52914113409f4f765fe1b84b24001d8bafa6`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b02b9478e0f0db49676f700548c1f685cd166b87464e39cccdc0fe1f4c60925`  
		Last Modified: Wed, 18 May 2022 10:15:01 GMT  
		Size: 2.9 MB (2871849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
