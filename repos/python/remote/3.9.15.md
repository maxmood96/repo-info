...
```console
$ docker pull python@sha256:825121a2d3216005529ccdd5c5dfa8d9ebe80b651c024adb84abac78fd8ddc19
```
...
```console
$ docker pull python@sha256:7e6943f5030af39f82a6bc9d767a2f9bc7116f8d3eb6396b6a6898064fb4605a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.4 MB (354444595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e35bb52f56eb68edb15d08d5df70f3eaeee73efbfe231cb5086a1155a45098f`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 16:12:28 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Tue, 15 Nov 2022 16:12:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 16:12:30 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 16:12:39 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 16:12:40 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:eb943aa802eb0780f132aa3a2df0e414e74143d5c570a3086048776e4e6232ee`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3d60ea8d663be94f47a940f1d066203a097d7be7a758fb2f63033ea210c9a88`  
		Last Modified: Tue, 15 Nov 2022 17:41:23 GMT  
		Size: 2.9 MB (2883321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:de13eec59ab94e3768f6fc568129321e45a39ff2687f64724830bf4e963ac49a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.3 MB (359312594 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95c8c27c97307b7a45537fe6286e0ca6c0c1e04791b74a66bee25f7ad4a3f8e3`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 16:52:59 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 16:53:12 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 16:53:13 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:b285185777190a9edc1fc155eeb802391596c1994e6cf0e13cf2f72c44a23ac3`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37d4ea64614b78108e68886cf7c9ac22e4426094b3c4acfaca14ae0c6c39d340`  
		Last Modified: Tue, 15 Nov 2022 18:00:13 GMT  
