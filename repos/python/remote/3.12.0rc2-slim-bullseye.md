...
```console
$ docker pull python@sha256:a4f5ccab89cba8e34e3131ffa5e1fd95bdf697efd27ccda9a52e3922cd5012da
```
...
### `python:3.12.0rc2-slim-bullseye` - linux; 386
...
### `python:3.12.0rc2-slim-bullseye` - linux; ppc64le
