...
### `python:3.9.16-alpine3.18` - linux; arm variant v7
...
### `python:3.9.16-alpine3.18` - linux; 386
...
### `python:3.9.16-alpine3.18` - linux; ppc64le
...
### `python:3.9.16-alpine3.18` - linux; s390x
