...
```console
$ docker pull python@sha256:555dcc94587b4101de48664b45b19f17e099a3ab236dec629791f366e2f2e83c
```
...
```console
$ docker pull python@sha256:c4f6e78edddb9704eebd4639ca38a30d3903072278436811c9e2c3bd7dcf71e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.5 MB (46500070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:429f25e221f8d578ba3a36b7e1269a1b0e2da7fdb9eadfb2f52af732a287667a`
-	Default Command: `["python3"]`
