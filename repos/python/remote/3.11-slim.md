...
```console
$ docker pull python@sha256:254f5d6323421b9b777d5de4100be34aed66a2a96a751eec3e9470dcae6542c0
```
...
```console
$ docker pull python@sha256:2c97c8aed4f290009ef36f85a0b6576d8e0f7b87c7b25eb9805e465794f09f1c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50122655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8e8cd833cf0509c1b5b2f6824164f44e383ce8e271aa519af31ef27473a1c41`
-	Default Command: `["python3"]`
