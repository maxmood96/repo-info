...
```console
$ docker pull python@sha256:1c113b4ca05ce0ffcbe41cb24fab4d4ca1ddb1a2b87c6284e38fafc4c769ad22
```
...
### `python:3.10.3-alpine` - linux; amd64
...
### `python:3.10.3-alpine` - linux; arm variant v6
...
### `python:3.10.3-alpine` - linux; arm variant v7
...
### `python:3.10.3-alpine` - linux; arm64 variant v8
...
### `python:3.10.3-alpine` - linux; 386
...
### `python:3.10.3-alpine` - linux; s390x
