...
```console
$ docker pull python@sha256:be06cd1d91e5af26fc111d7b0f9e8cc6b27836c16d6900d16441457458b20da5
```
...
```console
$ docker pull python@sha256:60db58bedcaff080563c0dbe77b1aeefac397a7980c96afae32ecedc4efc19b6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.1 MB (43149529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:798291d2645fc51bf5b6bf518a7b3b70701d41e95c878a9fddd73d9a080999d6`
-	Default Command: `["python3"]`
