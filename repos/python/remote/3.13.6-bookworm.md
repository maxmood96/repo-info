...
### `python:3.13.6-bookworm` - linux; amd64
...
### `python:3.13.6-bookworm` - unknown; unknown
...
### `python:3.13.6-bookworm` - linux; arm variant v5
...
### `python:3.13.6-bookworm` - linux; arm variant v7
...
### `python:3.13.6-bookworm` - linux; arm64 variant v8
...
### `python:3.13.6-bookworm` - linux; 386
...
### `python:3.13.6-bookworm` - linux; ppc64le
...
### `python:3.13.6-bookworm` - linux; s390x
