...
```console
$ docker pull python@sha256:cc9c1e817f2252a92714d35bc5d07a15ad6cabb5a90586e36a282dd4b73b1ed0
```
...
```console
$ docker pull python@sha256:8fc223b091f0a61336b170cb4570189a1cacd7d03b2efe8d0d7e864c67eb55c5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.6 MB (325623910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9261bcd88ae8058dad83b99664b3cdbe3a1fe08626230b0ad59aef5b43bde379`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 17:24:20 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 17:24:21 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 17:24:21 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 17:24:37 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 17:24:39 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:a494acf266b46a9bbfd25e5510ce081d0935d78c6a0196e4ab82860b54b6009f`  
		...
		Size: 242.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70dba5a9fac8aacf4a678c5f22fda5369e3f4d497183ed26f76a7f9da731e200`  
		Last Modified: Wed, 29 Apr 2020 17:32:36 GMT  
		Size: 1.9 MB (1931529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6-stretch` - linux; arm64 variant v8

```console
$ docker pull python@sha256:51111aaf86b03eb466fd503e31baacc1a4ac4966aaf0550114dbe6f65b7c7992
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.0 MB (336963816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e3af28058e1b5325a7fcd602f04981639e3d9874d12ed37a3e9b6d09f6afa6c`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:07:44 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:07:45 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:07:46 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:08:13 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
...
-	Layers:
	...
	-	`sha256:8a3399314cf8dfbee8bd246fefdd2d05cc946dc23b6438bdba031d4691d145a7`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:587904a6d41bbcc47becc216eefc3a4d8e59ff3a19d6ded582fa138f429cfa89`  
		Last Modified: Wed, 29 Apr 2020 18:17:03 GMT  
		Size: 1.9 MB (1931551 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
