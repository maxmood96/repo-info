...
```console
$ docker pull python@sha256:dc9788ea26562a5cde452e8fb752d9f418942b7d7d1fd5ab7fd0aec803cdfd0f
```
...
```console
$ docker pull python@sha256:a4a09122e53865836eea338d5126d2faa6f5544de6afe281602d1ab38769ea8c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.7 MB (337663833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2865f3ae74f7ec9c3073677abd8256a6c60fbf5ccaabe80ec032462f8e73575`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:07:28 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:07:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:07:30 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:07:57 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:07:58 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:659b92d8f9d2ffbb0bbe557ac66222798c813937b1e0d49346b238052c67c355`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:912b96856b761f88d4c28d17e0188e5b9f7cda80b0e32e1fdc2654365d040890`  
		Last Modified: Wed, 29 Apr 2020 18:13:53 GMT  
		Size: 1.9 MB (1931509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:527e9bc756d031ee1d736a9e818094ddc929f92ee9a032646cb5b6378514642b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.2 MB (349222035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ca9775d257c136de199adf54f16165d0faedd9ba527c31117e9e92f8db39b07`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:02:27 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:02:36 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
...
-	Layers:
	...
	-	`sha256:4d5ab52a545c1fa6fd378c64684c8c484c930a3f8bc47d787cea85712108f7a9`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93a34d83af9887808eea436a3478ca5335dd06fb3f514063bddd2d6e17302247`  
		Last Modified: Wed, 29 Apr 2020 18:08:32 GMT  
		Size: 1.9 MB (1931532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
