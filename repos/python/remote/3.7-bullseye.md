...
```console
$ docker pull python@sha256:bf5ae24e891fb8a59f735b4ed76629738c1aa4e82aacf3089c03ea9887153b80
```
...
```console
$ docker pull python@sha256:5eee401abae2da2e84d1cc13c404692a3666eb0efc3714364beaab86fc4e8b98
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.9 MB (325865188 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9875e213ee2d83f902f59bec9622896cf9a4c3618afc75ffa41e14307498b8f9`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 04 Aug 2022 08:09:33 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/aeca83c7ba7f9cdfd681103c4dcbf0214f6d742e/public/get-pip.py
# Thu, 04 Aug 2022 08:09:39 GMT
ENV PYTHON_GET_PIP_SHA256=d0b5909f3ab32dae9d115aa68a4b763529823ad5589c56af15cf816fca2773d6
# Thu, 04 Aug 2022 08:10:08 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 04 Aug 2022 08:10:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ab3942b59c485fba73a228086e85d01fbcf5570b61e51bd3286a1a6f736873dd`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37367613512e0f8727ebca1a75decc03b34ae12b2b504625efe840a7de6f9912`  
		Last Modified: Thu, 04 Aug 2022 08:17:59 GMT  
