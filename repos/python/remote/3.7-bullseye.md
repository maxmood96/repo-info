...
```console
$ docker pull python@sha256:0079d66a2332899bfb400475f1856313133295737943b354572edcc485eb6f2c
```
...
```console
$ docker pull python@sha256:89fa33204c57634b0ab25ffbfaa8f607603ec735d503068f4e3600416d177df6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.9 MB (351897488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ca660b054bf9c20cca050addd7083c4377825506eeda759d11da0dda1d61d49`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 17:09:44 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 17:09:45 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 17:09:53 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 17:09:54 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:96c151b23454805a0be586ac5aa317872a7c72ae8a5a9cbd39113eba8df94918`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a52aacd7630c9d3e23b93e5901e19b02b74d2b9bc48486acb01dfe028ac440e`  
		Last Modified: Tue, 15 Nov 2022 17:43:21 GMT  
...
```console
$ docker pull python@sha256:2de02cf46029f91db2274e8b26be54fc1f433bda14760d3dab5c16de5367cf9b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.5 MB (356471778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee96e936d98ba398c3f9b6f27f307fa150925f2d466c5c29d79db26cf2d440f2`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 17:53:30 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Tue, 15 Nov 2022 17:53:31 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 17:53:31 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 17:53:43 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 17:53:43 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:24b4558522588800a2d9143c12ee1884e636df01b9605db45e601131f6ba3696`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3d085d1cf7203047f215c20fbd12c0fe69e9ed10aa72c56af4c15a7398f0ba`  
		Last Modified: Tue, 15 Nov 2022 18:01:19 GMT  
