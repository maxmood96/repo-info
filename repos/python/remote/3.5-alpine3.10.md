...
```console
$ docker pull python@sha256:d27ea48f0e4d3a1010272f263499ab2eb3f7f3e438eb237a1cc3cf98b2162550
```
...
```console
$ docker pull python@sha256:cac71efbf813207ce03fa2ad0f349f8108a9b46945b2df49a762ed1fc96ff4cc
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.2 MB (29198634 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d2d95e77a450310ca55258c93316529be5c3f64919241dcbeff4f9086cd477d`
-	Default Command: `["python3"]`
