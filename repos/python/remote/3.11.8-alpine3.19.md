...
### `python:3.11.8-alpine3.19` - linux; amd64
...
### `python:3.11.8-alpine3.19` - linux; arm variant v6
...
### `python:3.11.8-alpine3.19` - linux; arm variant v7
...
### `python:3.11.8-alpine3.19` - linux; 386
...
### `python:3.11.8-alpine3.19` - linux; ppc64le
...
### `python:3.11.8-alpine3.19` - linux; s390x
