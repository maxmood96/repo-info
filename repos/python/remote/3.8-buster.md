...
```console
$ docker pull python@sha256:200a711fcfa48ecf5d31994962466470df75e867270a3d6a68f42c82393dcbf5
```
...
```console
$ docker pull python@sha256:1def6083af1e4602737bf360a2503ab9e40a6b4272a5ac43287159d820b8f448
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.0 MB (313001251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61eb1398be5c4d8a972f2fa207e1d954bd3af8351c05f8f1891f9f6ccb4d3d00`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Wed, 27 Jul 2022 06:22:30 GMT
ENV PYTHON_VERSION=3.8.13
# Wed, 27 Jul 2022 06:33:56 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 06:33:57 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 06:33:57 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 06:33:57 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 27 Jul 2022 06:33:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/49ca29908cfd49683da12f2d5a4fa5689539f9d9/public/get-pip.py
# Wed, 27 Jul 2022 06:33:58 GMT
ENV PYTHON_GET_PIP_SHA256=d077d469ce4c0beaf9cc97b73f8164ad20e68e0519f14dd886ce35d053721501
# Wed, 27 Jul 2022 06:34:05 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 27 Jul 2022 06:34:05 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:807b5461b9f694693b616506330e973f2021b9143f16f8da7aa55820caa40ff8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f83838de885718ea3090382c00549fe5ea39e15ac78ea904ce473d30769c7c8e`  
		Last Modified: Wed, 27 Jul 2022 07:39:08 GMT  
		Size: 18.0 MB (17997161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da3ef542307aa0202ada32a194d3fabb2e0f456c28dbde0a57aa47169a4637e2`  
		Last Modified: Wed, 27 Jul 2022 07:39:02 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea696c90836f2459e3a59bb0e9f0497c12b826f6d968e3a43b5167071930fcb7`  
		Last Modified: Wed, 27 Jul 2022 07:39:04 GMT  
...
```console
$ docker pull python@sha256:64c54a437eada3ea53efd3265b9cbb536c6c7134b93bacacdb0fe7e2e6863dbf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.6 MB (304633465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1461808c4076151e69f4acace8948d7d4af7ed813d0789b11e457e87cf36a0b4`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Wed, 27 Jul 2022 09:17:28 GMT
ENV PYTHON_VERSION=3.8.13
# Wed, 27 Jul 2022 09:25:48 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 09:25:49 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 09:25:49 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 09:25:49 GMT
...
-	Layers:
	...
	-	`sha256:1b4849f783e6329af6d978ade7eba59fa80adbd00f743b0e25711d120917d829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c10fd5fd8cdad4d591601ecd588bc9a861c356088e0e5c5205585fbcfc56d57`  
		Last Modified: Wed, 27 Jul 2022 10:59:57 GMT  
		Size: 17.7 MB (17743934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60dc9a6398e56d4d386aba232b4490166ceab4efe7bc0e608b2aa199b0fe5a4c`  
		Last Modified: Wed, 27 Jul 2022 10:59:54 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f961de70c3a9d27f02ec436d98f4d34e372c259f4e6f56b84fb08021e01a9eb`  
		Last Modified: Wed, 27 Jul 2022 10:59:55 GMT  
		Size: 2.9 MB (2885092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:72bfd9d1ef9ef339c7db92636ca34e064e79623f4b5eb654fd80ab3d71d7fe4f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.2 MB (322172005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ad0f6a918feb8e9e44a83f6f21bfc8f7d2ef7d470d965beeafb38043606322d`
-	Default Command: `["python3"]`
...
# Tue, 12 Jul 2022 15:07:10 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 27 Jul 2022 01:15:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/49ca29908cfd49683da12f2d5a4fa5689539f9d9/public/get-pip.py
# Wed, 27 Jul 2022 01:15:58 GMT
ENV PYTHON_GET_PIP_SHA256=d077d469ce4c0beaf9cc97b73f8164ad20e68e0519f14dd886ce35d053721501
# Wed, 27 Jul 2022 01:16:08 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 27 Jul 2022 01:16:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:b0fee65b057343cae416ba2dcc71b556d81d92a60c7eb14af9426c06bf076175`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24e2d3bea29b737c2848e9997f4eaa74fe348330ed7a867ac268e91392772ad8`  
		Last Modified: Wed, 27 Jul 2022 01:25:13 GMT  
		Size: 2.9 MB (2885059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
