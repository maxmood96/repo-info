...
```console
$ docker pull python@sha256:58e0148884889f0216202857880d8d011ae24967dbe51389367d675d5be0e34c
```
...
```console
$ docker pull python@sha256:692ba7ea47610f686782fdee7b848e10c8212e09f926314662585768cb24a383
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.7 MB (311729704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:998bf1505779b31cd3a82bf9097ce5bbf1049805552bce11b63b30026ec96831`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 08 Sep 2021 02:10:40 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 08 Sep 2021 02:10:41 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Wed, 08 Sep 2021 02:10:41 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Wed, 08 Sep 2021 02:10:55 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 08 Sep 2021 02:10:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:8dd523d42e5dac34b1ffc6b571b5516a0a021f7fe84b20edfd7e9012182aebb6`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:357dfadd32de506fcbf2e210595ab25cb71afe1cd6eada5fc322356bcbabd7e1`  
		Last Modified: Wed, 08 Sep 2021 04:22:00 GMT  
