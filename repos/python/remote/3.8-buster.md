...
```console
$ docker pull python@sha256:ca36af3b2245d9d76ea1aa36a247f6c16e86ceba8dd81ea3afa68fa1e9288b4f
```
...
```console
$ docker pull python@sha256:5ad65e0d0e6b74c9ed9ee8ede84051305f7ef01600575c24a14011ffbaed6947
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.9 MB (323873803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b8cf3fbde4e4e0c48949ffb5ab1ec8e19c2a6a7630c84cf0e5b79b6c6be79c0`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 06 Oct 2021 13:16:39 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Wed, 06 Oct 2021 13:16:39 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Wed, 06 Oct 2021 13:16:59 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 06 Oct 2021 13:17:00 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:46e153b1835af3563d0eaeb723cf12b1165d080e852dedf04ffdc0b579a10093`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed8c97eb81c89b9f76f40c07d377ea0cee825d7a81fc2f3cf60820e22251f087`  
		Last Modified: Wed, 06 Oct 2021 16:33:37 GMT  
		Size: 2.3 MB (2349108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
