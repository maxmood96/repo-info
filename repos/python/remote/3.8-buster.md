...
```console
$ docker pull python@sha256:b41569c486f9a167acec2ebdba4400ba17852e5c824708dd2b816f79fe6dafd8
```
...
```console
$ docker pull python@sha256:25b30d95907fa5f9718a9044531560c01b16346eadf29beb1496d8789ca735c3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.4 MB (303405406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a46ff53d643631bb2a001e7e51d767f18c62bc1451ac5d522d3920a69dc4e26f`
-	Default Command: `["python3"]`
...
# Thu, 14 Oct 2021 07:31:28 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 14 Oct 2021 07:31:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Thu, 14 Oct 2021 07:31:29 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Thu, 14 Oct 2021 07:31:43 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 14 Oct 2021 07:31:44 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:fbe78cf9b6329cdd8e755bbbdbc5c990dfdf8e337bf7d9a4bd752eb4468c978b`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b81c63b7963bd46ecb27073d3d5be2c140bb1c8691e94a4d8888ad4aa3b159d`  
		Last Modified: Thu, 14 Oct 2021 08:59:10 GMT  
...
```console
$ docker pull python@sha256:255702b88aae1e0ec083eb602edb7378bea118bf121baf165db776c405663041
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.0 MB (329048762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95bd1e9a90d2f69d5bd40b6e2cbdc469ad5d744d5e4bbe2e34e851081dae47cb`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sat, 16 Oct 2021 10:32:10 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Sat, 16 Oct 2021 10:32:11 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Sat, 16 Oct 2021 10:32:17 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 16 Oct 2021 10:32:18 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d9c9378fb42680dd914fafcaec7379b84201725ce4cde5394dd9423537ff9b52`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcdf34a6d4e6b8c9fa08e0d71c8a9d10cf8f6890c203035e02afcf1ed783d1db`  
		Last Modified: Sat, 16 Oct 2021 11:01:49 GMT  
		Size: 2.4 MB (2350872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
