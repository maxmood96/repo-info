...
```console
$ docker pull python@sha256:d101d14c3f922ee3be970c225c6c129d23a887bf98585da6a342c0e38e6086a5
```
...
```console
$ docker pull python@sha256:b5cb6c538dc2217fdf185ed40687ae5e2b139054836ba6d3d0658dbfebab3087
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.4 MB (339367123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bce0dcd37cda4b3c1ac4c491bd8b96877bf64b7de0cda48a65cb5d8c017b6564`
...
-	Layers:
	...
	-	`sha256:b0b7966b632e1dfa6adc17603b477eef263cd36b36c2adc374ef0b6f80cf9b5c`  
		...
		Size: 236.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45f7edddbb7868a46c32aa26425c309fe6741f04ce893dc81622152b7756da62`  
		Last Modified: Wed, 02 Mar 2022 06:02:55 GMT  
...
```console
$ docker pull python@sha256:9896be73312e1b991bfebcb9a71c546297edc2d20464d5b068b11c819dd7d41c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.8 MB (311771480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59487dcb57a41d7f965c2b3e7a070a8004777d9b7974a2d1def4929850a246b3`
-	Default Command: `["python3"]`
...
# Tue, 01 Mar 2022 22:35:11 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Tue, 01 Mar 2022 22:35:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 22:35:12 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 22:35:26 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 01 Mar 2022 22:35:26 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:5e1b7c028222d5df39c6fb4b1c9f1e965f893cee7ea43c8bad6829922de054fd`  
		...
		Size: 236.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f258b41427af3c4e3351a1fda8ba9369ba6a3d3992612c611420dc2250d0e0c7`  
		Last Modified: Wed, 02 Mar 2022 00:18:18 GMT  
...
```console
$ docker pull python@sha256:fe0a7084903dab18b5403db84c9c0ee70184475f15879e6265ac7bcf226d6f37
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.4 MB (303435348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27ca39a5efbefdce111e7f3511911680f51dd8c4b1d743a5078accf0995c4c82`
-	Default Command: `["python3"]`
...
# Wed, 02 Mar 2022 10:56:14 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 10:56:15 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 10:56:28 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 10:56:29 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:a607aa73442aedef0f3698ae8a1331c0a521142b978086087c3941ee883e8e47`  
		...
		Size: 236.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b1655bc26d3975f92ee0728a8f3bd07029b5b6eba0c83372f38e484cfeddced`  
		Last Modified: Wed, 02 Mar 2022 13:02:33 GMT  
...
```console
$ docker pull python@sha256:5156e6ec6acea7fc15b2f8eada39a95473292f108023150de4ae7a9cdac00f14
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.1 MB (329106334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76dea8de1ef628049223ecd45f1b43977144303d8b8b52e10f8907bb4adbd4e4`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Tue, 01 Mar 2022 21:19:06 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 21:19:07 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 21:19:13 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 01 Mar 2022 21:19:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ad27121c90305ec6c249b90d563cf576a26d84b1e8fa45c69cb90630eb091178`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0b07bffbeeb03eab07725a7c8c4a619fd2568d0678d4f18c68558a74fdb9763`  
		Last Modified: Tue, 01 Mar 2022 22:01:00 GMT  
...
```console
$ docker pull python@sha256:e3437b8d52d3b571dc56d4eacc5242e53aa276991642c00c9786df24c274b7e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348446434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10311e390dd48274bb49d7b3e506e0b031476f97bd466704cb4033140d31c44e`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:b3190d5ac4144d3bdd4ff0dc9962cc7d369283fa1118364f0d924c40e9ebac56`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8acf7edcc34190e9c512a234121b075f792bdbc1cc9ce508f5a67d6d31030191`  
		Last Modified: Wed, 02 Mar 2022 02:42:52 GMT  
		Size: 2.3 MB (2346357 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8-buster` - linux; mips64le

```console
$ docker pull python@sha256:7aaa4f7e24da2745c8ce761658851b050b8fd59662f449e3c118834c3879b11f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.9 MB (323900534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08e069ef5bcc6cbfd0d8fddba2aff3123250cc521fcc5da71b38ef71b0bb31f4`
-	Default Command: `["python3"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		libbluetooth-dev 		tk-dev 		uuid-dev 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 10:04:06 GMT
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Wed, 02 Mar 2022 12:58:44 GMT
ENV PYTHON_VERSION=3.8.12
# Wed, 02 Mar 2022 13:37:50 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 02 Mar 2022 13:37:52 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "/usr/local/bin/$src" "/usr/local/bin/$dst"; 	done
# Wed, 02 Mar 2022 13:37:52 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 02 Mar 2022 13:37:52 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 02 Mar 2022 13:37:53 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 13:37:53 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 13:38:13 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 13:38:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:95023adec9887430f4ead25cbf62a0028e56a27659badd303990d73d3a9dc8f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b77707684dc9ecedb8c6ec91da506b878dca2346dab3592e299eb34fb6649bc6`  
		Last Modified: Wed, 02 Mar 2022 17:13:07 GMT  
		Size: 18.0 MB (17955717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cae82c303e0a729d93d9fc2d017c70f2dd8fc31eaffa3d2aed55f561d4953bf0`  
		Last Modified: Wed, 02 Mar 2022 17:12:55 GMT  
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:907c1f3b9bca05a66a0e5f8545403a6fa5881c26fe11febfccc8d90dcf5a8c6f`  
		Last Modified: Wed, 02 Mar 2022 17:12:57 GMT  
...
```console
$ docker pull python@sha256:47009ee9d60931ddaa49f1f374699069ccd92098a7b0a4fed59ba1dd63552975
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.1 MB (362057499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e890bd01a0f0f2a3d887be77bf44de4bfe9dc0a835487fcfc7651a932c883938`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Tue, 01 Mar 2022 22:25:28 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 22:25:34 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 22:25:57 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
...
-	Layers:
	...
	-	`sha256:cf4f85efa6ef5c2c17b000273e4dae13cf6f4f2fcfb7b8cf26dfd323829f1f49`  
		...
		Size: 238.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9dc2d385498f35d19a3273f913f2380458a74ef91a10906dcd2d7eeadd63201`  
		Last Modified: Wed, 02 Mar 2022 00:01:30 GMT  
...
```console
$ docker pull python@sha256:3c9228e63dc376a5c37e01e90277d989acf7d2394d94b7944280b9440c16f903
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.0 MB (320950773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:beb6f80346cfd49081bb55089ea549920f187a25d8e86bb19f7ff5899042e4da`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:0a486d61ece596ac26d68ab537de316dda3b2022175f1d4f39ce39af30ab83e6`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928e3e7f83954eb6a431550ac7d528f93c1e6de3510ddd9fe3b4d0a676a22361`  
		Last Modified: Tue, 01 Mar 2022 12:43:24 GMT  
