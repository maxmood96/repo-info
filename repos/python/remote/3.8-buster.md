...
```console
$ docker pull python@sha256:f71ea6cc6e2d5c29da35306a59fa9ca98b9ad353fb47ec4ff799d11b293185e5
```
...
```console
$ docker pull python@sha256:40d163a036286dda2f470b3311799485271b44c071b2b74aa09bf79a37f7327f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.7 MB (323670574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fddd3c593ba87fa3c37b4260c704f3cc2b6a74a16d0d032d9919ed178d4706ff`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sun, 06 Mar 2022 07:52:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Sun, 06 Mar 2022 07:52:42 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Sun, 06 Mar 2022 07:53:11 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sun, 06 Mar 2022 07:53:18 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0165e7a2fc3d4aa3cfc59791fe3ad8b5808f743cb2e58709e86ae487a7129418`  
		...
		Size: 237.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8e0a3471c8ac01da868832fc741583a45c78595b45bce15a99c38124a0b6c20`  
		Last Modified: Sun, 06 Mar 2022 11:46:13 GMT  
