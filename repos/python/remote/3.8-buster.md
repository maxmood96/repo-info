...
```console
$ docker pull python@sha256:cf4fa7651746524721531601a68f6aac6917c6e76b3fe42a5f326dac4c0be6e2
```
...
```console
$ docker pull python@sha256:b2e8879f01e8f4995d539625795d87bf7cf545350638ac096ad6b8a12fd45253
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348385202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71d961dadecdf2c183f6ab11dcb83323c9e6b9f23726138d08cf9c7f8b77e667`
-	Default Command: `["python3"]`
...
# Tue, 28 Sep 2021 22:35:41 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Tue, 28 Sep 2021 22:35:42 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Tue, 28 Sep 2021 22:35:42 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Tue, 28 Sep 2021 22:35:49 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 28 Sep 2021 22:35:50 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:5603c84ac5d96a55d954a72d4b646ad7e9b0566ff96db9094308d910628a529a`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53ad4736f00dcb2babbb41ff3693acc1eec90e805251938544afd2834c298f54`  
		Last Modified: Wed, 29 Sep 2021 00:50:03 GMT  
