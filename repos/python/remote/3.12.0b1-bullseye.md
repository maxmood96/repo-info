...
```console
$ docker pull python@sha256:8788d450b054effb29b28c16c097ddca15923685694500dc982e4bc841a8953f
```
...
### `python:3.12.0b1-bullseye` - linux; amd64
...
### `python:3.12.0b1-bullseye` - linux; arm variant v7
...
### `python:3.12.0b1-bullseye` - linux; 386
...
### `python:3.12.0b1-bullseye` - linux; ppc64le
