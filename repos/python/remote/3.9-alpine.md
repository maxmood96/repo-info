...
```console
$ docker pull python@sha256:6600646604b7213df3e1c432137b7f3aef83ffef8cacd215fa8da62d1df1ddb3
```
...
```console
$ docker pull python@sha256:595ca5eddc5070b5651e3815b922e0b0441a4cfa9be5ba0c953acd74514422e2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.7 MB (17743782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15f794ebdc79a72568d35c6158cfae36a64d5648090b939bbcdbb4d2e8858964`
-	Default Command: `["python3"]`
