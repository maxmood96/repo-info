...
```console
$ docker pull python@sha256:3edfa765f8f77f333c50222b14552d0d0fa9f46659c1ead5f4fd10bf96178d3e
```
...
### `python:3.9.3-slim` - linux; arm variant v5
...
### `python:3.9.3-slim` - linux; arm variant v7
...
### `python:3.9.3-slim` - linux; arm64 variant v8
...
### `python:3.9.3-slim` - linux; mips64le
...
### `python:3.9.3-slim` - linux; ppc64le
