...
```console
$ docker pull python@sha256:355522f4e6b640e9255e6b6830ef52f32ece54df43db93f61101f48c5d4c6658
```
...
### `python:3.14.4-alpine3.22` - linux; amd64
...
### `python:3.14.4-alpine3.22` - unknown; unknown
...
### `python:3.14.4-alpine3.22` - linux; arm variant v6
...
### `python:3.14.4-alpine3.22` - linux; arm variant v7
...
### `python:3.14.4-alpine3.22` - linux; arm64 variant v8
...
### `python:3.14.4-alpine3.22` - linux; 386

```console
$ docker pull python@sha256:3902c07c7d555f177ae45fd0766fe682a4577d0261034f4755abddd21878cfbc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.7 MB (17693744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ea1f6ae286965c4a0aa62d1ec3f52a5e05def98b540fced660123635a775cac`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:5d688de4a1e81e87ef6a48c7e2fa0ae41ab82024f08ff5d2bc96ca4b0fca9838
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **637.4 KB (637412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6110a54d34386d6bcc6ddc3bd0a3d0c0b7d562ccae456e0bc35a84619887321`

```dockerfile
```

-	Layers:
	-	`sha256:e5eba981d22e918da3dc7ef823d01161f6ffe3cc2a564e8315b38ea3c8592307`  
		Last Modified: Fri, 17 Apr 2026 05:58:30 GMT  
		Size: 616.0 KB (616043 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:11c1dad92f558a01c1be7e94a8bca32c4be214f0283fcde91ae9f75a34effcde`  
		Last Modified: Fri, 17 Apr 2026 05:58:30 GMT  
		Size: 21.4 KB (21369 bytes)  
		MIME: application/vnd.in-toto+json

### `python:3.14.4-alpine3.22` - linux; ppc64le
...
### `python:3.14.4-alpine3.22` - linux; riscv64

```console
$ docker pull python@sha256:4b3ea01db0d3a3a0b5cd9645209c97dafb45024f64f5c0dec17dc0f8095fc4a2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17475191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ad2c8327060338ce38a3576429e377d9aec0ac8ef2309910ca68ff063283b92`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:08b124bd5d271a65cac0b5a24b4b88a9ff3885b8a958fc887e3d9497c32b68b5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **635.6 KB (635600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2611efca92659a4260c1471a2891bb00cf5e1c9678bf920b540d08806433f13`

```dockerfile
```

-	Layers:
	-	`sha256:f6ddc4793d8168c4b558a93fdb2267ee9e2ed13fe0f697228b431b74ca2554f7`  
		Last Modified: Sun, 19 Apr 2026 08:29:12 GMT  
		Size: 614.1 KB (614147 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2847410f332c57208da0c7d0a2ea2c17ac85dbd77802a79fe6c9c2d70271e26d`  
		Last Modified: Sun, 19 Apr 2026 08:29:12 GMT  
		Size: 21.5 KB (21453 bytes)  
		MIME: application/vnd.in-toto+json

### `python:3.14.4-alpine3.22` - linux; s390x
