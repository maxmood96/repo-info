...
```console
$ docker pull python@sha256:88926d7e877e7fcb23fbe88ca0a5f46b21d6271b7a068e10e5a67cb2ead4f1fd
```
...
### `python:3.12.1-slim` - linux; arm variant v7
...
### `python:3.12.1-slim` - linux; ppc64le
