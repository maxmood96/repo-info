...
```console
$ docker pull python@sha256:9f1ac0688143f26ea8078bbec61cd24547d665f9e5137c92d5f8a44fd1b7bf38
```
...
### `python:3.6-alpine3.15` - linux; arm variant v7
...
### `python:3.6-alpine3.15` - linux; ppc64le
