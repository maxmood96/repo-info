...
```console
$ docker pull python@sha256:bf7ee509a3fda88d7afc8b82ce3eeedd80d1cbeadea0b24e35f0215b9fc41537
```
...
```console
$ docker pull python@sha256:8262c6864ba356262f11d3088986867a3e3a5bb4714a6a0db882d6b16db9fd23
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.0 MB (17048334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d934033fcabce0d83cc48d7306995e2906e7b5e839292a6a14c8a58247e0ccc`
-	Default Command: `["python3"]`
