...
```console
$ docker pull python@sha256:d34a1e368b536de5e7b8dc5066bdeb53dc303ab9502b5e527a5628727d0fc665
```
...
### `python:3.7.11-slim-bullseye` - linux; arm variant v5
...
### `python:3.7.11-slim-bullseye` - linux; arm variant v7
...
### `python:3.7.11-slim-bullseye` - linux; 386
...
### `python:3.7.11-slim-bullseye` - linux; mips64le
...
### `python:3.7.11-slim-bullseye` - linux; ppc64le
