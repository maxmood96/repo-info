...
```console
$ docker pull python@sha256:b93adf0086ecce7dfb27c0686077570d4ef0e1ac317370e850e68085b6ae7fb3
```
...
```console
$ docker pull python@sha256:c3baeba9d6a3beaaf4376dfc2156a6e4439b4b38733f0954df1a4277069a3ad6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.2 MB (18199833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3a43e2a459e897deb8fa8c373b6bd3409ae1242aebd88db77ca09fc77551b45`
-	Default Command: `["python3"]`
