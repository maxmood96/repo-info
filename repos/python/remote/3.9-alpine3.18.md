...
```console
$ docker pull python@sha256:e9c0cb95a8a229705d318b511b41a0a5aed6ae94acfa9c894710bfa90a671c71
```
...
```console
$ docker pull python@sha256:24dc8778f58470839a1760f1f8b43d6038d704d070bad1d842feb11c12f6e300
```
...
```console
$ docker pull python@sha256:2e9575fe2ac71f8ffd2ca6f6052a85683406bf6180db67de35b3c933486dfaa0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.0 MB (17047583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04c2afe8fe55f81d5eb2e068989247ec38f0625b026fcedc4eb9a17f8dc633a9`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:1a14265c1d6b0988cf306d3b260b0992bec57c4be661fff41b91af334f596077
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.3 MB (18304948 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a7ed30f3e572a0e8e5c4a036d4f2563095556cdb4cdfa37750185a0ad13f049`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:9fbaf4e7221adee2b9d488ea96ed6b56fe5de75d3a460fe72ab7479845e51519
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.3 MB (18283986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44b088c49e84e0f1baa30049b19813961024ee667664320488a132335ef03adf`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:dcc2516a6706a7700055d0a1a194988be9f06bee5bbe120dc3bb62de0fe787c0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.6 MB (18622786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56f3d23f74eeb3a99da5a6f34f85f76a626b51ed354f63cdda39a3522ce2c441`
-	Default Command: `["python3"]`
