...
```console
$ docker pull python@sha256:8fb2f758c3f752d4c301937afb9150821e28a3923634d099185b7de6404d6a77
```
...
```console
$ docker pull python@sha256:b18526652c294f785a21dcc3e3f2f4b9b92d4a4ca40cd0e1354014d35951fe92
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.4 MB (328442784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:292edfca1ed1e8ab6b4c9da5855630299798a7ff033c62f1fc045a9d0ea61947`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sun, 29 May 2022 05:28:06 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a312303dbd516f6a692f2fee59852701bd828dd8/public/get-pip.py
# Sun, 29 May 2022 05:28:08 GMT
ENV PYTHON_GET_PIP_SHA256=8dd03e99645c19f49bbb629ce65c46b665ee92a1d94d246418bad6afade89f8d
# Sun, 29 May 2022 05:28:14 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sun, 29 May 2022 05:28:15 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:371f8a8fbf8b0182b84566242c124314cfb092021ca7e24d27162e093d8b5d21`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d90eb8901642bea61bac4304f5e86930e5d045da4278053934fb7b2fd623a0`  
		Last Modified: Sun, 29 May 2022 05:35:13 GMT  
		Size: 2.9 MB (2874216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
