...
```console
$ docker pull python@sha256:c0683a2e5ae43163f0441f02d78789c892c118e0c023890f1b8edf5e3b7b1963
```
...
```console
$ docker pull python@sha256:0082a661d50613d028a8753ced80e66756376c4af0be8af6ef3140ccfabd4f68
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.8 MB (322818456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2584b995828316a47175f2f915e405a742eaeadd6cae143e68cad42cf01f88d2`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 04 Aug 2022 08:11:39 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/aeca83c7ba7f9cdfd681103c4dcbf0214f6d742e/public/get-pip.py
# Thu, 04 Aug 2022 08:11:45 GMT
ENV PYTHON_GET_PIP_SHA256=d0b5909f3ab32dae9d115aa68a4b763529823ad5589c56af15cf816fca2773d6
# Thu, 04 Aug 2022 08:12:14 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 04 Aug 2022 08:12:20 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9ab353619e93319cc17c4dbb88d6c6926e5a8f3817b4eca0411bdbb93e2a9712`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db87c58f433083f1cd2b5a671d6c1005257ff015c78e3c7f7df3d43be19db4e4`  
		Last Modified: Thu, 04 Aug 2022 08:18:28 GMT  
		Size: 2.9 MB (2886000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
