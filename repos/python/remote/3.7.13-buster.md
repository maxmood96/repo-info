...
```console
$ docker pull python@sha256:be3beef068d7e682ee2cc7f065d0f43c4a8a5837fd450d0baec8d9e2a3a23ef7
```
...
```console
$ docker pull python@sha256:9fd9ba0750f7cd1a386a24cd3d292b175e7728242946fa74e038f8e6adca856b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.6 MB (338640101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f0e59bbc9aad2f8d43f1ba597c0096200402bfa4656c624d06301f5dad94d88`
...
-	Layers:
	...
	-	`sha256:00715acb3b3c18fab2c618d483bd927d4c9c3b84c9db3fdae0e980f0908114dd`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1060b8f9310d243a619c45a1d3799635de450565854bfd8962fa7e8678ac4cd`  
		Last Modified: Wed, 27 Jul 2022 01:23:29 GMT  
		Size: 2.9 MB (2885551 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.13-buster` - linux; arm variant v5

```console
$ docker pull python@sha256:326959866226cf0c5e9be1f3ab5d687c6fcda497abaaf3bbc531f154cd6a0098
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.2 MB (311200009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d20f9e47347443e4e19f37dbe2941934825c0f4f0f5d3d292ff98fb77b6b3fb9`
-	Default Command: `["python3"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		libbluetooth-dev 		tk-dev 		uuid-dev 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 27 Jul 2022 07:08:39 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Wed, 27 Jul 2022 07:08:40 GMT
ENV PYTHON_VERSION=3.7.13
# Wed, 27 Jul 2022 07:19:16 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 07:19:16 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 07:19:17 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 07:19:17 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 27 Jul 2022 07:19:17 GMT
...
-	Layers:
	...
	-	`sha256:807b5461b9f694693b616506330e973f2021b9143f16f8da7aa55820caa40ff8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a63194119a0b9530184b1caa6a8b24d20f98da726ed6669bde0adab0ee7f13af`  
		Last Modified: Wed, 27 Jul 2022 07:40:14 GMT  
		Size: 16.2 MB (16195409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4282895c9afe4ea22704200cb1fa8541f18eb747c48373c3c04838fcacb7159`  
		Last Modified: Wed, 27 Jul 2022 07:40:10 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7be6afe7d3e573249431e7a50f5495676a81b0428a3160366b4dd1ca5aea4f51`  
		Last Modified: Wed, 27 Jul 2022 07:40:11 GMT  
...
```console
$ docker pull python@sha256:81abaff27e1a925512fe56f6194b6dd0b99f8a9fa00109f58e5ef35fce74a5e8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.9 MB (302851221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f5ef96ad7c7106f8b6c2b7555cc4ff26441c2b0cf0780e941bffd2d01269479`
-	Default Command: `["python3"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		libbluetooth-dev 		tk-dev 		uuid-dev 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 27 Jul 2022 10:10:55 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Wed, 27 Jul 2022 10:10:55 GMT
ENV PYTHON_VERSION=3.7.13
# Wed, 27 Jul 2022 10:19:30 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 27 Jul 2022 10:19:31 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Wed, 27 Jul 2022 10:19:31 GMT
ENV PYTHON_PIP_VERSION=22.0.4
# Wed, 27 Jul 2022 10:19:31 GMT
...
-	Layers:
	...
	-	`sha256:1b4849f783e6329af6d978ade7eba59fa80adbd00f743b0e25711d120917d829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14c78f612e6270da9ba785bfdb416fd04fb16ca32ffa576c4a1c34085256f60c`  
		Last Modified: Wed, 27 Jul 2022 11:01:31 GMT  
		Size: 16.0 MB (15961192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:265a7ec96b6662361e0eb242e0de9165bfb078e75795c384ed2fc7bd6545c440`  
		Last Modified: Wed, 27 Jul 2022 11:01:29 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c547df2468d7f1b9107840d66dd67e3aa95f5a045b0b27ac0d3b9263a73dd9c`  
		Last Modified: Wed, 27 Jul 2022 11:01:29 GMT  
		Size: 2.9 MB (2885590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:765973e4f4b14aaacb7f4557ff4884ba031ce90ddc8412beb817eba274ed7e1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.4 MB (320374585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:779d2ae8160436787a93b6a806a149d20954715ae6e34e8b2ff99d3e65e0fbbd`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 27 Jul 2022 01:17:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/49ca29908cfd49683da12f2d5a4fa5689539f9d9/public/get-pip.py
# Wed, 27 Jul 2022 01:17:24 GMT
ENV PYTHON_GET_PIP_SHA256=d077d469ce4c0beaf9cc97b73f8164ad20e68e0519f14dd886ce35d053721501
# Wed, 27 Jul 2022 01:17:29 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 27 Jul 2022 01:17:29 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:78ce1c4efcc366bf7e41083ce4d24eeece88caba705bd233c9ca8de5791774d7`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79ba4f55daaefb40529be902ab6409ce0f3c2c84e09ff286fd1cddb4d661b86b`  
		Last Modified: Wed, 27 Jul 2022 01:26:03 GMT  
		Size: 2.9 MB (2885604 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
