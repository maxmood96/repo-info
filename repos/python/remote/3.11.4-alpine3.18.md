...
```console
$ docker pull python@sha256:4352dc7ee495075659df0738d21b27b74b7b61fa2351dafcdbd4cbba39d19af3
```
...
### `python:3.11.4-alpine3.18` - linux; amd64
...
### `python:3.11.4-alpine3.18` - linux; arm variant v6
...
### `python:3.11.4-alpine3.18` - linux; arm variant v7
...
### `python:3.11.4-alpine3.18` - linux; arm64 variant v8
...
### `python:3.11.4-alpine3.18` - linux; 386
...
### `python:3.11.4-alpine3.18` - linux; ppc64le
...
### `python:3.11.4-alpine3.18` - linux; s390x
