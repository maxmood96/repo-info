...
```console
$ docker pull python@sha256:745fac134e7ea2947934f4baba06db821e63db3607938692017f766c4834cbc0
```
...
```console
$ docker pull python@sha256:d24c90379c162310c73fbfecf744039a4cb7cd9ee011def41a1b329617602324
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.3 MB (35313730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e341f3f377419cfc8a8a4a919c492f7ca29c27cee4fcff7155bca7981fed5ce`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:85d79ea7f22dd6eefb1101753129b5f681af7622c92f1e74f5cd58c18fb5dabd
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34236680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9206422dc6cd598b87df74d5c9423e4102430b2bd1dc7ec39e0badd046fbc05a`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:20f82c3af5450132e0600f51049aace117671307ee6edb5d51c85914224006db
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.1 MB (37096584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cb8248f917a45dfc89dd0670a7440b1c43f377fa99ab55631591f5bb54f8999`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:da1c3cf22d89c995f13c5052ed1f09d39449ff7514937f9b22f0e0745b50cda3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (36039955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c69b80f715214f88b531cad546c653980d4758b7e8b1536cc5ac91e97b16653`
-	Default Command: `["python3"]`
