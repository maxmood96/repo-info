...
```console
$ docker pull python@sha256:69d9502e1098c7e3b06f368d27e8bd6e060e01e4911c184dab2fb0f90c4a6446
```
...
```console
$ docker pull python@sha256:06dd19c1ef5e1f87d1a9d5c56d570bffefd5371c4df2322c0dd783072a4a9a8c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.5 MB (18479465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a7bf5e28575e4835ce6ef1abbad87c453b5bec1c01142dd08714119e2382dcb`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:7e681f6b006ece61d790ad949fa0068d1cf8ba7de6ba6e7ba7a536291a9f9a7d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.4 MB (20358045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4945b4619589a07263ed4f9704add646cd5de85ee126e841a58a46c70842ab1a`
-	Default Command: `["python3"]`
