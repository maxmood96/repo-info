...
```console
$ docker pull python@sha256:78000ce757647480ab68239bbd2114a5e6affea46b2b6853a084f486c82109d3
```
...
```console
$ docker pull python@sha256:ac0f7e0cbe573878435b9269e8bfcfa334fde948dc484a5a98ea358faba5d0e1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.4 MB (44414561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a30372344ee25eeea26e75a32c68099399530a75a6ef4191b984673e1b178b0`
-	Default Command: `["python3"]`
