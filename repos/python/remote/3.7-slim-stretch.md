...
```console
$ docker pull python@sha256:bd72c818be270807fac6e801f7b41b2f27402d56eec8bb58dfb46519dc511442
```
...
```console
$ docker pull python@sha256:516140b2892ce7b337561a528002263de51a49b737a52f3a64898a34c7bdd1dc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53789037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17a0196834c69791d31f72bee16818ec0a2fb34f61bd9da5d7e085521ce528eb`
-	Default Command: `["python3"]`
