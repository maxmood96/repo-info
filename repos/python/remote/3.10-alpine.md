...
```console
$ docker pull python@sha256:4db3888ac3e79e4ec0772a628486f6ebfa6b02c7e4566b0c0d60f4046ae5d0c9
```
...
```console
$ docker pull python@sha256:b1d366346c3bc2ab2373a2bd822ca570d6dcb8ca4472133b8665f2b1fc4ca77a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.7 MB (18737565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a821395e57fc4bee2973557ecbbad053aa3e7d9f81e5d01e6aba41b8e45944b`
-	Default Command: `["python3"]`
