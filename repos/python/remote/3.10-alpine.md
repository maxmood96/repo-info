...
```console
$ docker pull python@sha256:def82962a6ee048e54b5bec2fcdfd4aada4a907277ba6b0300f18c836d27f095
```
...
```console
$ docker pull python@sha256:699440a8fd169a914acab40bd64cc9ad55fbd9304edd1d81268b4b6235a48f35
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **19.0 MB (19019208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4403e31f7609477d8cdeab395d4e4d8a4e4985b95f6b73cfdf93e3d7d462b57`
-	Default Command: `["python3"]`
