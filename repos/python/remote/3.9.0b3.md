...
```console
$ docker pull python@sha256:d8bf1ccbe2d98085fd8c037cef14954862577146febf737c2651973b800db554
```
...
### `python:3.9.0b3` - linux; arm variant v7
...
### `python:3.9.0b3` - linux; arm64 variant v8
