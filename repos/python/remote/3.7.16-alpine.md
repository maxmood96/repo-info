...
```console
$ docker pull python@sha256:f48c5f6a8a22a73558ea93eb26d2c7928d23f2acb2bb9270be9a08adc2bfa63d
```
...
```console
$ docker pull python@sha256:010c89db6ef4006ccdc2685abde1dcb3054719efa4440452d63e29883187d741
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.8 MB (17771250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09ec7b18eaf922451fc6507a65e3b23d9a3f53af50816539f47eb2a5cd32a6f3`
-	Default Command: `["python3"]`
