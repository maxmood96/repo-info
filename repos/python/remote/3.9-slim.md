...
```console
$ docker pull python@sha256:65b0977764b96764924b1ca1908f6f9369f39b51a367d6c932e82f5465b64387
```
...
```console
$ docker pull python@sha256:0b7848db06b1271cac085939710a3bd7b356b3d6d0ddcce17ab0d811ec88864e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.2 MB (44217282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fe22a2ab8d555da74d98e64f73916344449d4a4cf24b91fb4f20aab8e44170d`
-	Default Command: `["python3"]`
