...
```console
$ docker pull python@sha256:7eadeefa20629571d3e63211329b2025cdc43694c25c12291e674abf2e5e1130
```
...
```console
$ docker pull python@sha256:8fe69ec8468c436f18f331efd9f0984c9a536f7135a8b7caf74612cd1b96fde9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.3 MB (44251397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d1f903e8ec177cdc717d54a5e971a1eed9a9b0a28877fb2d0fc0844191bd133`
-	Default Command: `["python3"]`
...
# Wed, 03 Aug 2022 00:24:29 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Fri, 12 Aug 2022 04:03:21 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 04:03:21 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 04:03:41 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 04:03:41 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d7f069182502ed5d7a9f90fb838418b14dbab1eb7bd306eb73859003dea01cad`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51d86021838b6ade5d42a00ef25825219f009bf5e0a3986aaecc63bec29ebb94`  
		Last Modified: Fri, 12 Aug 2022 04:12:49 GMT  
		Size: 3.2 MB (3174882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
