...
```console
$ docker pull python@sha256:edd758565e6f38800f62b5d8028ef43a0385aa36caaa053866af7cb33fca1954
```
...
```console
$ docker pull python@sha256:85fd0e463dfdffd4724c74a54a4b305dc417a2d89efeddbb30f1a5d5193b86fb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.0 MB (44014099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acdfe532c4636cc8f213727782f87df106e53216a3995137fd5cb9a7216132af`
-	Default Command: `["python3"]`
