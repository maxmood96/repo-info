...
```console
$ docker pull python@sha256:afbbc7a984433377e5a4264d5b57b6e5206b2d53ed55a0b529d1b0daff571120
```
...
```console
$ docker pull python@sha256:a504cf8dff2164e7c73a9a23cbbcd5e3ecceec6bfa072af1133a6697c649e942
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.6 MB (40586804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b831c9cc873b836271ce6cb267a2ae2c30bf4268f757c02ff05d6f6e3aec1ba9`
-	Default Command: `["python3"]`
