...
### `python:3.14.6-alpine3.24` - linux; amd64
...
### `python:3.14.6-alpine3.24` - unknown; unknown
...
### `python:3.14.6-alpine3.24` - linux; arm variant v6
...
### `python:3.14.6-alpine3.24` - linux; arm variant v7
...
### `python:3.14.6-alpine3.24` - linux; arm64 variant v8
...
### `python:3.14.6-alpine3.24` - linux; 386
...
### `python:3.14.6-alpine3.24` - linux; ppc64le
...
### `python:3.14.6-alpine3.24` - linux; riscv64
...
### `python:3.14.6-alpine3.24` - linux; s390x
