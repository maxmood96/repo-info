...
```console
$ docker pull python@sha256:ee914e0b13f8b900ec6c3fc1d351469b1a069ad4c1c48106cba7b496e8b6c3c9
```
...
### `python:3.10.3-buster` - linux; amd64
...
### `python:3.10.3-buster` - linux; arm variant v5
...
### `python:3.10.3-buster` - linux; arm variant v7
...
### `python:3.10.3-buster` - linux; arm64 variant v8
...
### `python:3.10.3-buster` - linux; 386
...
### `python:3.10.3-buster` - linux; s390x
