...
```console
$ docker pull python@sha256:f67facc70967f80bd81c3310106865a8dae20cc1bdbd18f01680709648f69d9f
```
...
```console
$ docker pull python@sha256:8d3eb1851a33ea1db73917399c68304fc43a3d26e87a86851cf4bfb5af24b022
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.2 MB (45244187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:956d1be658bd4284ff1debbcfef9cdd2ea18d8a8b72c83a36288fadff67c3c1a`
-	Default Command: `["python3"]`
