...
```console
$ docker pull python@sha256:57db8f66ca538638d47263cfc5d571a8cf4800cf469c518d18193e7f3db5f70f
```
...
```console
$ docker pull python@sha256:4d001c0755573a6b86571bc5248609d8e2209dab74c047bc11e8fa42d8407f7a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.7 MB (17696293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dd962dde574a2356246af0c333fee88473f8479e8cb1e8e0a1128bc97a2bf36`
-	Default Command: `["python3"]`
