...
```console
$ docker pull python@sha256:1c29f2cedd0448c33654d57988e537fc821ad3d9dac90fe69f6900e770014d1f
```
...
```console
$ docker pull python@sha256:684d8a63b40d20c1e5da7c525e66c4e209cd23043d09c517f1fb03f3097c768c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.2 MB (331222104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b601e08a51de01f5ea26b890d3057e4a67086aa066b745707e2e6b3ef3debd19`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Sun, 29 May 2022 05:01:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a312303dbd516f6a692f2fee59852701bd828dd8/public/get-pip.py
# Sun, 29 May 2022 05:01:25 GMT
ENV PYTHON_GET_PIP_SHA256=8dd03e99645c19f49bbb629ce65c46b665ee92a1d94d246418bad6afade89f8d
# Sun, 29 May 2022 05:01:33 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sun, 29 May 2022 05:01:34 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cc8c12e0c7f17abdf578235fa80b3b61bac9cb4a8277f61a3595c91596b97158`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e978dd2690070b055ca91060a4965693b0475fa1ef1d40ef95d902fd1dfb095f`  
		Last Modified: Sun, 29 May 2022 05:34:02 GMT  
