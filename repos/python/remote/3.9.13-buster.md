...
```console
$ docker pull python@sha256:341554a2a78ef1427b8a57392c950202ece182ca99fa890a2dbdd5533af91539
```
...
```console
$ docker pull python@sha256:09685d80928fae220d6525b5b46dbc5ed0de84c26922424393bba8141862b9a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.0 MB (313995193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5cf051edc1f47d57e8038ff6aba948796c6a5447a31b97ca5ebd3303e8ae7ee9`
-	Default Command: `["python3"]`
...
# Wed, 03 Aug 2022 00:39:54 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Fri, 12 Aug 2022 04:03:48 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 04:03:48 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 04:03:56 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 04:03:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:7737217094a794daf9697ac87a55dbf7f729d72af2df4c44d84876c618bea563`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f3db277342c684156954b6d3a8907508bc180ba46954560ce36c9d715a5bae6`  
		Last Modified: Fri, 12 Aug 2022 04:13:08 GMT  
		Size: 2.9 MB (2882499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:105993afd6d1da9d67778abeb92d2e814d03e44bcc378b5928f032c425e05612
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.1 MB (350137220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a38c7548d5375acc03e8d949dc39b8422a182ac40d9379a4b3e7c054c9f1f7d8`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Fri, 12 Aug 2022 03:35:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 03:35:13 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 03:35:21 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 03:35:22 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9bed00ae3bea9f04fe8ca3510d54efce28fbc895ef66c3b786d470c54ff695d7`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39404034524eada57391749cd53a9120d1070085c292dfe985f9a2ddac366450`  
		Last Modified: Fri, 12 Aug 2022 03:47:34 GMT  
...
```console
$ docker pull python@sha256:a7d0bd5843f9e95a102ea23f12b7b542e71d31275b33f7b7d59e4bfdcfe46b69
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.3 MB (364280681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4eebf29165829856176f38afa759830ebb0ac2161eac41fb82c68ad4bcbb802`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Fri, 12 Aug 2022 04:20:48 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 04:20:48 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 04:21:01 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 04:21:02 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:55fb323882c4892cf8ae8ec91ca6abb8d5fbefb6286d44289c8c6e439c406779`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12a15074f51b838aa8bea2b4d6fdf03f9d6e5edfe8df262f69090c278efc32a4`  
		Last Modified: Fri, 12 Aug 2022 04:37:03 GMT  
		Size: 2.9 MB (2882462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
