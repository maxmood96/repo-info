...
```console
$ docker pull python@sha256:389227a6879219401c9ea51185d9e6862adc1d43ff18a81e4d8398d016d5be55
```
...
### `python:3.9.0a5` - linux; arm variant v5
...
### `python:3.9.0a5` - linux; arm variant v7
...
### `python:3.9.0a5` - linux; arm64 variant v8
...
### `python:3.9.0a5` - windows version 10.0.14393.3630; amd64
...
### `python:3.9.0a5` - windows version 10.0.17763.1158; amd64
