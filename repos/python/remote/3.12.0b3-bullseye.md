...
```console
$ docker pull python@sha256:e91a743757ccd90e9acccf4237a52d9ab1860da96744077b625fc6a80e189c99
```
...
### `python:3.12.0b3-bullseye` - linux; arm variant v7
...
### `python:3.12.0b3-bullseye` - linux; arm64 variant v8
...
### `python:3.12.0b3-bullseye` - linux; 386
...
### `python:3.12.0b3-bullseye` - linux; ppc64le
...
### `python:3.12.0b3-bullseye` - linux; s390x
