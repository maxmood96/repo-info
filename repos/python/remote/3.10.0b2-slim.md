...
### `python:3.10.0b2-slim` - linux; amd64
...
### `python:3.10.0b2-slim` - linux; arm variant v5
...
### `python:3.10.0b2-slim` - linux; arm variant v7
...
### `python:3.10.0b2-slim` - linux; arm64 variant v8
...
### `python:3.10.0b2-slim` - linux; 386
...
### `python:3.10.0b2-slim` - linux; mips64le
...
### `python:3.10.0b2-slim` - linux; ppc64le
...
### `python:3.10.0b2-slim` - linux; s390x
