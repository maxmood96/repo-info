...
```console
$ docker pull python@sha256:24390198e4365a6aed5f63024f4b8f94d1c80d2aff630de528730573f6f50348
```
...
```console
$ docker pull python@sha256:bb5f6463eb7b42b6684428581811225ec67c641125d216a1c544db9f4c43a6c9
```
...
```console
$ docker pull python@sha256:272fa3a75ee2f5ae0cae4591f4c61339ad0e7bd127a4baf81d3a164f7fa16163
```
