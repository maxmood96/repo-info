...
```console
$ docker pull python@sha256:49f98d464234f1bac52de86598ee55aeb13b6e4d0cbc09f919d0868fc6a47148
```
...
```console
$ docker pull python@sha256:c90e57e63e27e300b09c8b93f24e65acfe8fdef1f8d02b2014567674e9b9f96f
```
...
```console
$ docker pull python@sha256:43fd59aa0ca41e865ebb5794ded1cff8eabb6a13dc0e4c271c4e7ec9a89e6c44
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.4 MB (324437879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b08524775c2e3f816fb4d37ffff9efb6df619f58bc9ddc696fb65854e7e7346`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:abbd916bfd16192e5e61286000ac780a9c2acbab5c33fcad300ff298389ce47c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.3 MB (311332432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2eb4dbc693e60974374b64e8a3926c2287b452a4c9985f889ba9ec54145cf37`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:a2c6057c5b2f41c85acb2dd433b9e9bf8c03c133cb29c0e503498a44cdcfff0e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **343.6 MB (343599727 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c12732b81e3032e9d08ec1a92991fbf0038a30cdc9fc186a7f223e6dc1e06cff`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:e0de83a84a91c47f026396adfa87c26049f38b28381dc41764045e63ec178903
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **357.5 MB (357512327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efb83600f6e1420607758b2fc519a1fa56013677be20d85c12a00e0306e9629d`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:2bea26318c500fd993997036d813d7d218cc07bb068de4acd0434f2c3e460251
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **361.3 MB (361318656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e996bf73aee66b3e68c69a5baf1ed59060570b6c1be26516677dc92797d48a9`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:42efd7fcadcb8a12c6bac1a6aef9ad1454a13e70b62991b46d3badc7f0b442de
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.6 MB (325622417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d77fb8406838fe210254156f0b0d1fb752e9e676a15fda5566775d434f8caeca`
-	Default Command: `["python3"]`
