...
```console
$ docker pull python@sha256:bb8ba2a303395fde9dd637f8d060165a0e380b1228a602d25639f75a5b3ba175
```
...
### `python:3.9.10-windowsservercore` - windows version 10.0.20348.473; amd64
...
### `python:3.9.10-windowsservercore` - windows version 10.0.17763.2458; amd64
