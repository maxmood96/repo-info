...
```console
$ docker pull python@sha256:f04a62c5f08dffec45b3d33a41c61112394669f17aca2b2dc260f7a993fa373b
```
...
### `python:3.10.4-alpine3.16` - linux; amd64
...
### `python:3.10.4-alpine3.16` - linux; arm variant v7
...
### `python:3.10.4-alpine3.16` - linux; arm64 variant v8
...
### `python:3.10.4-alpine3.16` - linux; 386
...
### `python:3.10.4-alpine3.16` - linux; ppc64le
...
### `python:3.10.4-alpine3.16` - linux; s390x
