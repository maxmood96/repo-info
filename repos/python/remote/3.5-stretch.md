...
```console
$ docker pull python@sha256:537075ebc70f2024fcf1f6efafa39d39b138230447e79673e5bb5702a8322230
```
...
```console
$ docker pull python@sha256:adfc47f666745a4fc8d102c811676842bcc9648e2f89a2ed8932f8b0c5335f33
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.5 MB (337465573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:107b0a48988d21d263010720bae0796642aa4ee2032a7f6c22576028f5af84ce`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:10:32 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:10:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:10:36 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:10:56 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:10:58 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:33f968d2a9d5a4c383344e6b93a41ee239c8faa3cea82192c115968e4cc591b6`  
		...
		Size: 242.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87d1077653fa92a973e6c11969862bb3d87244876d7ee2b55dfe77356cac33c7`  
		Last Modified: Wed, 29 Apr 2020 18:14:25 GMT  
		Size: 1.9 MB (1931626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.5-stretch` - linux; arm variant v7

```console
$ docker pull python@sha256:7b2cf72168d62bae8ed4c35b2d02745be8af210e2647312e781caddecb920805
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.7 MB (324699031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b457c5c92cd94cf0431b8fe667185fa9d03d4e193d9717c951311faab60ae25b`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 17:27:12 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 17:27:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 17:27:13 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 17:27:27 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 17:27:28 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:16f71dd70733d74a4d026ae8dba4adfeed6e84c4d925c09271e711a0bd231bf5`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:949d5f9bca1cee02dd348835eb830ef302acf4a187b70e3f5667f88ac8f9c35f`  
		Last Modified: Wed, 29 Apr 2020 17:33:22 GMT  
		Size: 1.9 MB (1931595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.5-stretch` - linux; arm64 variant v8

```console
$ docker pull python@sha256:13327872c35d23ff2b039428a40d91fbedef95fc7892f7f0ff479cba89dcdb11
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.0 MB (335995593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4d7d0ab17c463e62d8f4bbd1781bd9dcf7ac727bfd6193a74ade6fe85dade37`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:11:27 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:11:28 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:11:50 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:11:51 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:a574690125e1106afecd432669cec21230ab1f3f783167f25b2576fdc54f990e`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6874c466eae8f086e72f19b84c314111aeb84ee2516808ee42e7feac845bff4`  
		Last Modified: Wed, 29 Apr 2020 18:17:43 GMT  
...
```console
$ docker pull python@sha256:7dd34118efcd2bbcc2431a398a48c91be9c819b77b103102784ae7293494679d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.3 MB (348290433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a212f567afdc7e67c7ddaa2e61dbfcdd881ea8f006c5cf74626244beb882f9e9`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:5cc933bdf7b626bf920cfeadcbefe67220469b7c27c4703cca3be75d50e18a9a`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21a413232a10030716cf03ce3c8760b8edec26acf1ae5de014f8ead4aeacba76`  
		Last Modified: Wed, 29 Apr 2020 18:09:13 GMT  
		Size: 1.9 MB (1931557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
