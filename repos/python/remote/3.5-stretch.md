...
```console
$ docker pull python@sha256:785d6d1e4a4fd586b743aba353bc65301918ab1ef7ea8e348c321f84fa5b4063
```
...
```console
$ docker pull python@sha256:848d93ab40b50386ed49597323419bc1251f64bfa6931c5578f4eefea0f0f982
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.4 MB (354438666 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e318abfd03235182621bb1b9880dfe341533b3752aa626b78271a13bba1ca5e6`
-	Default Command: `["python3"]`
...
# Tue, 04 Aug 2020 03:09:55 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 04 Aug 2020 03:09:56 GMT
ENV PYTHON_PIP_VERSION=20.2
# Tue, 04 Aug 2020 03:09:56 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/cb5b85a8e0c3d13ced611b97816d7490d2f1497e/get-pip.py
# Tue, 04 Aug 2020 03:09:56 GMT
ENV PYTHON_GET_PIP_SHA256=a30ff8a3446c592c6d70403a82483716e7b759e8eecba2c8d3f6ecfb34a8d6d7
# Tue, 04 Aug 2020 03:10:03 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 04 Aug 2020 03:10:03 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:786352773f2d8d6bfe1965c1f854ab61a6baf9cade0b6bee48eb423b882548bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0400d9751d9fad7020289cf84724c317fb60c4a9e01755c299ecf8c23b6fb712`  
		Last Modified: Tue, 04 Aug 2020 03:35:36 GMT  
		Size: 12.9 MB (12865157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b44b18826291d1359fdc6876358183e52be97b8a85f35efafdd820c528bb1aea`  
		Last Modified: Tue, 04 Aug 2020 03:35:33 GMT  
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19a10bc1d380cb72174f0db00e2a260e5b3c8da76cfeb2e33d3344b90185b475`  
		Last Modified: Tue, 04 Aug 2020 03:35:34 GMT  
