...
```console
$ docker pull python@sha256:9d352e0a01f09dceb099bcb7ec6c40d2030edfd5fc0cca5a1871e8ab901375aa
```
...
```console
$ docker pull python@sha256:05a2f24556f5d58bb97ea82ee0e1ac1501afeb8e1259701cd6b8cbbe7e4b1cc0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.8 MB (42812028 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:770b1115b70b2d2710c94ad251bb1c7b53038e81bbf6f4371219b4a53ed7253b`
-	Default Command: `["python3"]`
