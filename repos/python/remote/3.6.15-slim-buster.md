...
```console
$ docker pull python@sha256:4ffe6337211db0e54ed72f977ba1be1a5c09bcde346fee1d9fa0e1f8f4c8baf8
```
...
```console
$ docker pull python@sha256:5b497eaf986c8ceaea4362f8f969a9910cceb0a575b6cc70120c7d47aef08260
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.9 MB (42872470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebe207ec6404093dc801a8d6863ee040d68656392ba3454c22b1fdf7f30134c0`
-	Default Command: `["python3"]`
