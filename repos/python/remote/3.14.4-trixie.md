...
```console
$ docker pull python@sha256:aa07dba3315dea8a79a2a853df759909081e276174801c75260de145361a018e
```
...
### `python:3.14.4-trixie` - linux; amd64
...
### `python:3.14.4-trixie` - unknown; unknown
...
### `python:3.14.4-trixie` - linux; arm variant v5
...
### `python:3.14.4-trixie` - linux; arm variant v7
...
### `python:3.14.4-trixie` - linux; arm64 variant v8
...
### `python:3.14.4-trixie` - linux; ppc64le
...
### `python:3.14.4-trixie` - linux; riscv64
...
### `python:3.14.4-trixie` - linux; s390x
