...
```console
$ docker pull python@sha256:187ace559f49638af61737e81ed42652c0ac012057f0df818ea8e3836f0db9a0
```
...
### `python:3.12-windowsservercore-1809` - windows version 10.0.17763.6532; amd64
