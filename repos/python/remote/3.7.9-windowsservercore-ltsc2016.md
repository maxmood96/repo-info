...
```console
$ docker pull python@sha256:52991d00df4d1d2ba5d2a8798609cd490fda1a0d8fdcb049075236746c0668d5
```
...
### `python:3.7.9-windowsservercore-ltsc2016` - windows version 10.0.14393.4104; amd64
