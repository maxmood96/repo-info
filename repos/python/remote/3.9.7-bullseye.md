...
```console
$ docker pull python@sha256:6408b13f3992183ea0f744e8f79c18a7de31ab864a66c64e17344b1af2e40662
```
...
```console
$ docker pull python@sha256:cefb146117260eda7442fea324c82060027cb01ec30ae20a01717d522f7493ba
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.1 MB (307057639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bd2f3e64065f49bbe7080f2868e1c62b2446f0e160fee54c3a1c7f835012254`
-	Default Command: `["python3"]`
...
# Thu, 14 Oct 2021 06:32:52 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Thu, 14 Oct 2021 06:32:53 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Thu, 14 Oct 2021 06:33:08 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 14 Oct 2021 06:33:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:dc35847dcb8a68a488b5b97727561a363fa8a42e8c678d2d9fa5f56147252768`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf771366ebcbaadf1eaa6cc7ed7e99b35ca7e6fefd4e15ca83d63866d673eb65`  
		Last Modified: Thu, 14 Oct 2021 08:57:39 GMT  
...
```console
$ docker pull python@sha256:494af288273b13ee05a8f2a101f3611cd6781de78b64f261e20c6a48978da98c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.3 MB (339277995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77b8ebd34f4bd6fed2cedb9c256d90bb18776d77f800eaba6fc0d6f8baf4c377`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sat, 16 Oct 2021 10:16:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Sat, 16 Oct 2021 10:16:36 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Sat, 16 Oct 2021 10:16:43 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 16 Oct 2021 10:16:44 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d7da4191aa2ba74b0ccbaff45b413b7acfd961b260563f00ba527be7f5675a67`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ab546d3a61e8b682a38f3bc1199261fd17fb8edbda7d7ef721274daf8e11a85`  
		Last Modified: Sat, 16 Oct 2021 11:00:58 GMT  
		Size: 2.4 MB (2350793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
