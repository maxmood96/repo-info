...
```console
$ docker pull python@sha256:79004d0712b02644fecf06df361df880c6c72826a169d787080cad96563b1a69
```
...
```console
$ docker pull python@sha256:f37e8d4fba6ae8bb9536948d4bb9e7f66e8d4dd92cf6e260e48f14136b31b74b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.8 MB (338813384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ffeebdad73a1fa93e9fdf7aa4b520182cfedf28b83f917c18940df404417b1b`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:a66061eefcd9c945d7d7b6b08beaad40e431d805881144e256ec2f6c41dd68a0`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11bdecb50e6fadcb3ac7d66348a68da4c3e39648bc046d8aa0498e7fa12151f9`  
		Last Modified: Wed, 29 Apr 2020 18:13:25 GMT  
		Size: 1.9 MB (1931517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.7-stretch` - linux; arm variant v7

```console
$ docker pull python@sha256:c5a9497e48fa97bcd65e54295caea46ff9b26752ad07cbece9b137a3e7da8938
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327111264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca898e30ae7ac516fd910392a0cd5ca402394699b530a955ea3abd5dd437af5f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 17:21:02 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 17:21:03 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 17:21:03 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
...
-	Layers:
	...
	-	`sha256:664fa7443516070e35feac8b90caa7c1e1402b39acd0ba1501e7cafa1131b177`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaa45261d3f406330cc5ba7bb191e7ab7584cc880dbf9f4b0cc9c248bb766571`  
		Last Modified: Wed, 29 Apr 2020 17:31:54 GMT  
		Size: 1.9 MB (1931523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.7-stretch` - linux; arm64 variant v8

```console
$ docker pull python@sha256:72be217946dcb4cdb88ae1245dbf8a00c2cb961e2f33de39788243cb5fbc1d8d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.5 MB (338492870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ae2410a07ea07947179931fe02aa49e90087341428719d76e8fad534a42f7fb`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:e89e79240e40134d2bf56eae9dc67fe30422786c3f3f24da2f9af4103c079966`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5dd8c3db68386db1b1d82a975ff69d48cce461bce59cf5ea533c960447ccf58`  
		Last Modified: Wed, 29 Apr 2020 18:16:19 GMT  
		Size: 1.9 MB (1931531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:7d97c5983b762d32781193def3beb95dcaf1f9a251ae4b5d01dfd50a66725166
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.1 MB (351106952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cdf4a8b520df7bb1a0fd3ea0af0446d8210f393b0b7e3a647297d9f81080128`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:00:26 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:00:26 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:00:26 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:00:34 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:00:35 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:fccaa75dbb5489f06592be60f368d10eb1b5f2745bfee48f3825eb18bf5259fa`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85a6f04a13004c0a367efb55f2d47a3aec0a187ad928494b899962341b815fc`  
		Last Modified: Wed, 29 Apr 2020 18:07:48 GMT  
		Size: 1.9 MB (1931488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
