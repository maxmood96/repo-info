...
```console
$ docker pull python@sha256:b4cd985b85f002c32d08ce5b66618a3cebb64173a4094a0191eeede5df8bf856
```
...
### `python:3.9-windowsservercore-ltsc2022` - windows version 10.0.20348.350; amd64
