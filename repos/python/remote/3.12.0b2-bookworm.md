...
```console
$ docker pull python@sha256:52f602da2a64427e38aadfd49c58f03f9d51ca2ad2174548087acbd15f9622d0
```
...
### `python:3.12.0b2-bookworm` - linux; amd64
...
### `python:3.12.0b2-bookworm` - linux; arm variant v5
...
### `python:3.12.0b2-bookworm` - linux; arm variant v7
...
### `python:3.12.0b2-bookworm` - linux; arm64 variant v8
