...
```console
$ docker pull python@sha256:558cf1925593b2d6366905f11f6e6870916ee328124d7114c7a88080012dbabc
```
...
```console
$ docker pull python@sha256:e3fe0bb46a785c71a62d7a2e2b50551d0009a8ba0777e2dc335a7ff3a58209c1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.3 MB (336324016 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f98e1be91a46868ad48ba88ae0d51c39502dfca60d06a3721454c6871610d1b`
...
# Sat, 10 Apr 2021 16:31:24 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Sat, 10 Apr 2021 16:31:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/29f37dbe6b3842ccd52d61816a3044173962ebeb/public/get-pip.py
# Sat, 10 Apr 2021 16:31:24 GMT
ENV PYTHON_GET_PIP_SHA256=e03eb8a33d3b441ff484c56a436ff10680479d4bd14e59268e67977ed40904de
# Sat, 10 Apr 2021 16:31:31 GMT
...
-	Layers:
	...
	-	`sha256:d620e4e1748464607440df777f17a4281a3ed50cf26a18e0d2372a6b6ed7fd6b`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6beeb6ce99334d4329b6269e3e822159ca1a28a2131a8c47301ceb4b75793078`  
		Last Modified: Sat, 10 Apr 2021 16:57:29 GMT  
...
```console
$ docker pull python@sha256:b2125f84b91b6ceda56303abada1fad9b86cd6f63eb9b403ad1ffcf058b4e45e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.4 MB (326449599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0779b876cded074e27af5a61b046f837fb3e7621c18c9aa160b2e7003d14ebd`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 10 Apr 2021 14:39:24 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Sat, 10 Apr 2021 14:39:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/29f37dbe6b3842ccd52d61816a3044173962ebeb/public/get-pip.py
# Sat, 10 Apr 2021 14:39:26 GMT
ENV PYTHON_GET_PIP_SHA256=e03eb8a33d3b441ff484c56a436ff10680479d4bd14e59268e67977ed40904de
# Sat, 10 Apr 2021 14:39:41 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 10 Apr 2021 14:39:42 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:54e58315f823f689c2c6c00e89a80041cbb9231698271987f3de9befcd228c2d`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3298b6b5015bcdede42cf47b7e303c9d491b500efdcd9c6d72abdb1583867c84`  
		Last Modified: Sat, 10 Apr 2021 15:11:01 GMT  
