...
```console
$ docker pull python@sha256:c6947aed04e48da5d6b1ef293193d19760a59d36f627c0cd45630534c2589e8d
```
...
```console
$ docker pull python@sha256:fb06f9df94807b2649b57f80a20abd9e2f570a2afe860b12790e0dd3cfba709e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.3 MB (345298745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:357e0a6896c21f73650cf771cede3bbaf0ab6eb17d5922b7f9ae32d4ea40a80d`
-	Default Command: `["python3"]`
...
# Sat, 10 Apr 2021 17:42:18 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Sat, 10 Apr 2021 17:42:19 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/29f37dbe6b3842ccd52d61816a3044173962ebeb/public/get-pip.py
# Sat, 10 Apr 2021 17:42:19 GMT
ENV PYTHON_GET_PIP_SHA256=e03eb8a33d3b441ff484c56a436ff10680479d4bd14e59268e67977ed40904de
# Sat, 10 Apr 2021 17:42:26 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 10 Apr 2021 17:42:26 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ae65bea7e21b6257638f4018e22ad51b844190c870b453cb314c0f8baa6e2001`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bafcdd59732c3dd265cc3f089fa2159c5787ca6f08b06769359afd87b0655f4`  
		Last Modified: Sat, 10 Apr 2021 17:55:59 GMT  
