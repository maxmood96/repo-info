...
```console
$ docker pull python@sha256:20abfcfc324009a50c550e53c2853377b9baf54fdff42652bf7007e7f7e50c68
```
...
```console
$ docker pull python@sha256:0449f58dddfecc58deb79e30427354c6580a5312f0e957e930c8962fd51e8d42
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.8 MB (320808423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa37c52f533189003d57a3989255524db7d9240e5d738552baed55f5c39cb62e`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:a22ba5fb1e8ed92a79171aea4f51617d2ccd461646d2c1613a1e63ae86cc1bf6`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bce7c346f00a89d552f3a85f06c7d9502243f2fc8df14633b97d433606926dab`  
		Last Modified: Wed, 28 Apr 2021 18:02:31 GMT  
		Size: 2.2 MB (2168084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6.13` - linux; ppc64le

```console
$ docker pull python@sha256:cb98fb9af697170e711744869f71f1a546e66447275e6bb772dd4f5d153f38c0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.8 MB (358800136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5791128c6c91ec5ab4f5cb8eca1a8b0429180035120b361cae84a001b96349d5`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 01:23:09 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 01:23:15 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 01:23:21 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 01:23:57 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 01:24:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:12a2671fb7f3dac0afd43f7ad99f3eea8ec16a314b2e40c161ca705709de9bd6`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed5a08b11a01208c33036e03e2d784788dc44d21e338fe4a2401623772f21051`  
		Last Modified: Wed, 28 Apr 2021 01:35:24 GMT  
		Size: 2.2 MB (2168304 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
