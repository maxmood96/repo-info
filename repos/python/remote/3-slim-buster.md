...
```console
$ docker pull python@sha256:835fe38a8ef87b0c9e7107f58306fe9df5ac90fabdf0a2e16496787f31ffd954
```
...
```console
$ docker pull python@sha256:df30bbc409eb3ad2fb463ed6e78fbb0b8e0ef41e3c1066871fb0d2927ed56190
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.6 MB (41593533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66d48cda18b82735625f6f9fb992ae55e434173ae9fa206f136cb692f887e331`
-	Default Command: `["python3"]`
