...
```console
$ docker pull python@sha256:1cfca20b384f82fc1eacd2c01f5fe761b23617087c51503fc0ff54fbdb9fe048
```
...
### `python:3.8.11-slim` - linux; amd64
...
### `python:3.8.11-slim` - linux; arm variant v5
...
### `python:3.8.11-slim` - linux; arm variant v7
...
### `python:3.8.11-slim` - linux; arm64 variant v8
...
### `python:3.8.11-slim` - linux; mips64le
...
### `python:3.8.11-slim` - linux; ppc64le
...
### `python:3.8.11-slim` - linux; s390x
