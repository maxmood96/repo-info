...
```console
$ docker pull python@sha256:b6bd7d58b4e0f38cd151de9b96fffc9edf647bc6ba490ffe772d5d5eab11acda
```
...
```console
$ docker pull python@sha256:596b30602eb4e710e47a113316b1b1b99880b92f29db0cf26d3b2d4b2cbebcb4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.0 MB (19973309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e89f21796e9f93c97994c6dc8a77698eeb2c99196bb743bae7211ced07a8c30`
-	Default Command: `["python3"]`
