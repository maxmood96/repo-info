...
```console
$ docker pull python@sha256:0ab344fd043963d5c1d6827143ccee923d0e826f5059a507ac095061ce09bcae
```
...
```console
$ docker pull python@sha256:17e6c33b5d775943fc4b8a7fae3e4ec2c701ba66a0074d699c42e02dcffd5f3b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.5 MB (44482197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28c73be45b4eb1e7b5f6ea166186c56a5ab63a82aa03428daa831030be2a6fbf`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:328e6d6b871cd2dc41a846ba86d8834cf1dafe34cb299ee7ac3847dd1e3d31fa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.4 KB (25356 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b441d2e172b4172bd7852fe4326ec45ee43b30eebc9943e4db5a79d838c049f9`

```dockerfile
```

-	Layers:
	-	`sha256:b3ce222713fc0da3717c9cd9f7818db23127761120dcec210fd1936e71ab3246`  
		Last Modified: Wed, 14 Aug 2024 17:29:06 GMT  
