...
```console
$ docker pull python@sha256:7f8e99522226c0813486f22952204df889a8d90a74a6f7ad78def0f1130d9a0e
```
...
```console
$ docker pull python@sha256:ecb48def4af68dfeccc05013ba2068cdf26cbb0efe2e842fec5814952f228b23
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50939159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b07a437ace4fb412d645536dd42b1a40be418540257f06c3798fe30bc0f07b12`
-	Default Command: `["python3"]`
