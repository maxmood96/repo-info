...
```console
$ docker pull python@sha256:d68a35edd5d14be545d672ee5bc0fa44b223c4eb857ceaca41c134c578c7e143
```
...
```console
$ docker pull python@sha256:ceab83d244a6a9b5156066afba399ceb8d5e355632de51b16eb1cba56ebba954
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.1 MB (331146700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16050eff3295c0dbe2275e02b882aabf81a696eea486f1780a88979ff1b11190`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:0a1d3ebd79c6d852731e28e00feb6b66a298bd31ae9de5938d10b832552c8165`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3406dfc9dd68b9fa0fd061ffa7fb17814f84da3bdecc0edb3d2530f23becbc00`  
		Last Modified: Tue, 15 Nov 2022 10:58:18 GMT  
		Size: 2.9 MB (2883685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.15-buster` - linux; 386

```console
$ docker pull python@sha256:a2b31e03ad27e529bc0ef7cbd2a528628b82094cde3413ca7f1210f48aee3e40
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349559327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:500c212b45a55e4502ee8ffa0772a1cbc6886993ba7ef3a8ffe48998354db2c4`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Tue, 15 Nov 2022 16:27:08 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 16:27:09 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 16:27:17 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 16:27:18 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d8589337e525028c3a3e94f67c814116fc0a11754d27bf9695f48f76b2bde534`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09163d36cf2890a65ca9e309178485fb398fef6e16fb0e783be7a74e8e1a3891`  
		Last Modified: Tue, 15 Nov 2022 17:41:53 GMT  
		Size: 2.9 MB (2883375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
