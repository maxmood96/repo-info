...
```console
$ docker pull python@sha256:5392b60aac9056c7d3a558ec6d1793c0b8e9f5a213c24352a9db616fd389df86
```
...
```console
$ docker pull python@sha256:cc680df3f9636a9318b435360ab3cbd1d02ea55f63864bf0e723a55810195ee5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.2 MB (45249310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:daa7dd3493536ad5c28d28db803c79daf6a18c8b3f51add7947a00825eaf1587`
-	Default Command: `["python3"]`
