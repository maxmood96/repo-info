...
```console
$ docker pull python@sha256:234da35e659c02a785a1e9d2002e386bea80f293572f90ad0cf668e8f9084078
```
...
```console
$ docker pull python@sha256:87d59fe8e9f7d874ebe7701992136fdfec4ae70eccc14122736542c73c9fed58
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.3 MB (42277467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e5bd6929c00c3e2c31141acb49d633c2249b86180ed112549be15074fd86831`
-	Default Command: `["python3"]`
