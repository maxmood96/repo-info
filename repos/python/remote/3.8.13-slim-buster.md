...
```console
$ docker pull python@sha256:1484fa1fe074e03ed3e21a378c8ba7a21a8ecda95fc1492a49e570a653d17ecc
```
...
```console
$ docker pull python@sha256:49dcd38f85b84916773d53d6e4cd7ce261ceee9cd5a0c64eca925c5abe58448c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.5 MB (42535040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b4fa43b0be549b0ff6402027dca5ef6bf43e3e5d3c081eb3c836e1d4d24e08c`
-	Default Command: `["python3"]`
