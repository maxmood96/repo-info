...
```console
$ docker pull python@sha256:b97f39fe158c68dfedbc058fac0aef4f4a0e20de9aa82ee7e27ee55542220a70
```
...
```console
$ docker pull python@sha256:3a3882b6e5155a656270fff01dee3bca0b16bc4ffb1e44dbc06ad2eb0327d3b0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.8 MB (30753922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b23f930faa719009244330a396da81cd6942bfc2475200eaf5708f23bb16c48f`
-	Default Command: `["python3"]`
