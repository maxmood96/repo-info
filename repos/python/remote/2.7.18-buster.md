...
```console
$ docker pull python@sha256:4ebedfabc03c4218e3551820d6783dd942426120ce3f0bdbee8271447b910a34
```
...
### `python:2.7.18-buster` - linux; amd64
...
### `python:2.7.18-buster` - linux; arm variant v5
...
### `python:2.7.18-buster` - linux; arm variant v7
...
### `python:2.7.18-buster` - linux; arm64 variant v8
...
### `python:2.7.18-buster` - linux; 386
...
### `python:2.7.18-buster` - linux; ppc64le
...
### `python:2.7.18-buster` - linux; s390x
