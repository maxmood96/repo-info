...
```console
$ docker pull python@sha256:eeb8aa012e2fd2df7862a1704a23776aaf7273a8115c2806c9a7055098b5734a
```
...
```console
$ docker pull python@sha256:9a324ca68d24e63b989afd3cc9c3f7ab08e24d524534c432fbbb0ad22dd34183
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.0 MB (350982652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21a89967a5c41610b568530dc563795d70a5cac6fc208ec3d6eaf624071ecc70`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=63.2.0
# Tue, 15 Nov 2022 15:51:46 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 15:51:47 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 15:51:54 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 15:51:55 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:3228a4d2f4c135b30afedf550e4541b851482075c03276cf5c7c2b91c1836b37`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f5e93a788d063be8efce710f00a1393fffd5cc1799b6db8f90b7dc9a7932633`  
		Last Modified: Tue, 15 Nov 2022 17:40:52 GMT  
		Size: 3.0 MB (3044862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
