...
```console
$ docker pull python@sha256:6ed03f165f015f1441f24f63751349845cdfc87fa2d85d9d6c3950dd42f27fe4
```
...
### `python:3.12.2-slim-bookworm` - linux; arm variant v5
...
### `python:3.12.2-slim-bookworm` - linux; arm variant v7
...
### `python:3.12.2-slim-bookworm` - linux; arm64 variant v8
...
### `python:3.12.2-slim-bookworm` - linux; ppc64le
...
### `python:3.12.2-slim-bookworm` - linux; s390x
