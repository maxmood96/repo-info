## `python:3.9.4-windowsservercore`

```console
$ docker pull python@sha256:41755647d86eb9f9ba96c33e159c0db04bb74f32febf3731f6aa05db4f79b1be
```
...
### `python:3.9.4-windowsservercore` - windows version 10.0.17763.1879; amd64
...
### `python:3.9.4-windowsservercore` - windows version 10.0.14393.4350; amd64
