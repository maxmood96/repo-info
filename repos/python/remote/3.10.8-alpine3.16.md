...
```console
$ docker pull python@sha256:00be2731a1c650d3573aebd84a46c06f3a3251377323f6f43ff1386e70ea2992
```
...
```console
$ docker pull python@sha256:e473564a6a601ac89527c22153aab1dae5e9c04121ab30051dc48262eb9bd029
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.7 MB (17676733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da7117f22bf84219ba91d04833594f6c4b529745fdc34743b3dbe32e2a51e8fa`
-	Default Command: `["python3"]`
