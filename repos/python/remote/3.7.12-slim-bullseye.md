...
```console
$ docker pull python@sha256:05302042d4a1b18852055ba4686dd8f1e5df4a0670ace67b8c6f9abcb014b9da
```
...
```console
$ docker pull python@sha256:b36398d2bc81ed20d832c317d0b4c8ae124f5d79830b6c3ef65a4625fa66b883
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.2 MB (45186506 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a96a80108dcadbbf368ecc55583a6a78c17e9701d97b634951860267f788514`
...
```console
$ docker pull python@sha256:fc8d76f808aab37beaea0d0b6352689cc5008edeefc2f690d62b483c958a0ad8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.3 MB (42308474 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65f2930c51a9c4c6af959d19a631fcf6eeed93af5c20a990e7d4c2de932cd9d8`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:a947410f2fe3a842ff9116e08ce9f5da28d48d8070a7238bbad36cb593263519
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.5 MB (39541233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abd215c2072f2c3c33fcc2cec6dee97b704d61e4907296fbb7b3b8628c36b691`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:a5aeea4a28bed84af9a4fb69c96f85d8b892426cf8c6ae0e8bab7797a6ca3d0f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.7 MB (43682986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8560944b25877bb5dbe986ee731c92596bd999bd3ba3889f6e7b9a4afff901aa`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:7da01244dabc004a49ab7847a1d29c215566124fc897a0c37ca0982bb687c8ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.3 MB (46312999 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b1a2d229eda354cbc4462ce0a79d881d6eba70ee77e708531575fb21174d9cc`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:c36bda7c4f83f1429d553564d24a6082909e0abb785d0d598451bef4602d7173
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.3 MB (43349244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2dc32f0b0fda462cfbf7a8096f6a5802b610e29ed9ca6b3f3b1a353fdcf7d433`
-	Default Command: `["python3"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ca-certificates 		netbase 		tzdata 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 15:01:38 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Wed, 02 Mar 2022 15:01:38 GMT
ENV PYTHON_VERSION=3.7.12
# Wed, 02 Mar 2022 15:44:02 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 		LDFLAGS="-Wl,--strip-all" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	; 	make install; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python3 --version
# Wed, 02 Mar 2022 15:44:03 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "/usr/local/bin/$src" "/usr/local/bin/$dst"; 	done
# Wed, 02 Mar 2022 15:44:04 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 02 Mar 2022 15:44:04 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 02 Mar 2022 15:44:04 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 15:44:05 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 15:44:46 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 15:44:46 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:00108a70b805461e0187e3c07fcfaf8ca39ab74f33064adaf9c5c381c368fad0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e88aecfca57fa93445bd201c2025b8eb9641318c4cd94fb995985330e6c40d41`  
		Last Modified: Wed, 02 Mar 2022 17:14:00 GMT  
		Size: 10.0 MB (10027565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6aa2386523c98690c0a7b659e720fa0933212acacda3000df6037055bb7d7c3a`  
		Last Modified: Wed, 02 Mar 2022 17:13:53 GMT  
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:602bcaff18b66858c7f0c44b2a34194973e4a2deba8ace4e6db8cffa64ad8bf0`  
		Last Modified: Wed, 02 Mar 2022 17:13:56 GMT  
		Size: 2.6 MB (2639174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7.12-slim-bullseye` - linux; ppc64le

```console
$ docker pull python@sha256:ea39ca2a6dd3ca78e70bb71bea9612f63a2d01e58e9273f4ddf95a2a26001ead
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49470921 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:198aed52658fd7afb59dba137d6a62e7a19822114ff861bb318512968853fda1`
-	Default Command: `["python3"]`
