...
```console
$ docker pull python@sha256:28ceb5d93db1067b677a0f177169be3d28c7c5a6d6237988bf15882105c65543
```
...
```console
$ docker pull python@sha256:f63e3d19da46b0e5e3c7cb03cc3aaaa58013eb5d334dcd4486bcfd8db64a5deb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.1 MB (43138017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54a64b6efe59ca8a1d7bc16828ddcccfa52168791a9f84d32e77ade93d9cc815`
-	Default Command: `["python3"]`
