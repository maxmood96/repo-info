...
```console
$ docker pull python@sha256:7847a79a67a40f0fa6654e3b4a7eec197ed7fd782f007dc0efc6c0a57cd6da8f
```
...
```console
$ docker pull python@sha256:9cd9116cb6098e13c9c3b601a99f7ed2d5b8e4190cbb7b01e01c9bfc34f375e2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.9 MB (22906358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c48e5295fef6fb4100ed1f2eaf69152a09bb265996e238bb76adac7058b22b2a`
-	Default Command: `["python2"]`
...
-	Layers:
	...
	-	`sha256:b94df0ee546fc6e571193703e856f01ef196ae6fc1f17993310758e876cda98d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f898ba560f29a4e2fce5b3ca71c1cf1b518cf0188cc76200084998fcb35d15b9`  
		Last Modified: Thu, 06 Feb 2020 02:36:13 GMT  
		Size: 1.9 MB (1888089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:2-alpine3.10` - linux; arm64 variant v8

```console
$ docker pull python@sha256:8fccb11903120985082f8ac6dab4cdca972d13f6c2a2a954995d602e04b58e34
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.7 MB (24723562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adfacd491b715a6cb5716be93c568e2e4388a5b7e99e99cc3f9431797ccbd617`
-	Default Command: `["python2"]`
...
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 02:08:05 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 02:08:06 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 02:08:31 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 02:08:32 GMT
CMD ["python2"]
```
...
-	Layers:
	...
	-	`sha256:58527918589164c54232196a2c9b1a4dcdf510ffe98b28e5f2825aa71b1ed687`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cfab37a861e45b9aea7f73a9b0134d141f3429fa112b678fc8d2dfb102dfb6e`  
		Last Modified: Thu, 06 Feb 2020 02:14:07 GMT  
...
```console
$ docker pull python@sha256:fbe853483d7b9e431b802080d985d84310a3039b4db42523086371f00f3a438b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.7 MB (25727599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df90abd4d242bab0d4555b82e9a0cb9d214d39972a9e92240db7874280c3d1c9`
-	Default Command: `["python2"]`
...
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 01:48:03 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 01:48:08 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 01:48:31 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 01:48:33 GMT
CMD ["python2"]
```
...
-	Layers:
	...
	-	`sha256:ca69543c610bd6bb9111de00aebd803a2b3968358ffe0fca79233acb2e6069b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5950b628d9031b70b57b8a02a45cde35cfe93641df799547a7ca777c4c9adb43`  
		Last Modified: Thu, 06 Feb 2020 01:57:18 GMT  
