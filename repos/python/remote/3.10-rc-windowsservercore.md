...
```console
$ docker pull python@sha256:7231feacc759f00dcd226b87cce692df572b83ff149eea768a395b32ab17ffbf
```
...
### `python:3.10-rc-windowsservercore` - windows version 10.0.17763.1817; amd64
...
### `python:3.10-rc-windowsservercore` - windows version 10.0.14393.4283; amd64
