...
### `python:3.12.3-alpine3.20` - linux; amd64
...
### `python:3.12.3-alpine3.20` - linux; arm variant v6
...
### `python:3.12.3-alpine3.20` - linux; arm variant v7
...
### `python:3.12.3-alpine3.20` - linux; arm64 variant v8
...
### `python:3.12.3-alpine3.20` - linux; 386
...
### `python:3.12.3-alpine3.20` - linux; ppc64le
...
### `python:3.12.3-alpine3.20` - linux; s390x
