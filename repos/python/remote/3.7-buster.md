...
```console
$ docker pull python@sha256:56d185483b374e072794e759bdb09b95b84e7db4aa38c54ef48c228c0e280bed
```
...
```console
$ docker pull python@sha256:6988d58a3e5acca6a18a29028c34d295001f7ba5be5a74233019152b84715e6a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.4 MB (328380183 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9338f5a12fbbef6bd2d352eb3bb4160e73f55e005e7ae53199c84598e1e55bdd`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:fe900a2738a4c64e8b6b18c208f9336a5e4af226fb7b22cf2afd1f4bf81099fc`  
		...
		Size: 236.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:741f00e0ab3e11d53d18a9f2dc3b76bff7282a14e5e66afd7b8ab935c115ebe1`  
		Last Modified: Tue, 15 Nov 2022 11:00:00 GMT  
...
```console
$ docker pull python@sha256:98a807a94d08c003ca66fa46ff5e1153c81ee53bc71d65f2a5b0e71513484b73
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.7 MB (346705874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4abc36d395732b9d03577f886e652a331e049247ff0adbf6a393623b5a6bb94b`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 17:25:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 17:25:30 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 17:25:38 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 17:25:39 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:1b176f8cecba107454a56ddfe0a7e76593011f0878f870bf604894114bd6894b`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e78689839a28229e3e0c22c5d979ac8782df4a67ad153b62e381aa593459257`  
		Last Modified: Tue, 15 Nov 2022 17:43:53 GMT  
