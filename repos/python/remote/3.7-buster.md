...
```console
$ docker pull python@sha256:2cacef1f71c84f7f8c6bdeaed9f74fc3f1c69e72bcd998e5e8d81a7df153046f
```
...
```console
$ docker pull python@sha256:f4326b8d2d3ee600062a626f8255a3b09d88704f61c55a55e6106c2f4df3e7d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.8 MB (321765043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:871001fa64877ebc2bbb9e5445570312e377d99cf8483d12baaab5ef3e8de847`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sun, 06 Mar 2022 10:55:05 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Sun, 06 Mar 2022 10:55:12 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Sun, 06 Mar 2022 10:55:41 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Sun, 06 Mar 2022 10:55:47 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9fabb3e995c96ffc75609143118996c7cff12d710e03fcea0e88f2096abe0536`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37996c252a2951535f61aa5d5b48d4d9a7c745a9e8a29d1a85e88387da153558`  
		Last Modified: Sun, 06 Mar 2022 11:47:32 GMT  
