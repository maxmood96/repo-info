...
```console
$ docker pull python@sha256:f072f97fb9c3a8157e834685cc58d316223d58c441bd7448f444aa97a65e8f43
```
...
```console
$ docker pull python@sha256:0958e32bef4d70555cd53bfc6100532d84a1a2b57f8547c102844b2e10246b3c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.9 MB (321862276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d657393349f50dd06aea15b3eb04be0de342118dbfc48c595d0460311d263f67`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 17:55:15 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 17:55:15 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 17:55:16 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 17:55:35 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 17:55:36 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9abc4cd6d50e6b22d030b734bea447e34364c44781fe5702705fc2ef2bf23057`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7a2557a14d755e431f32f1aaca6939ba1af74343f74d2d411283c4cdba71a8c`  
		Last Modified: Wed, 28 Apr 2021 18:01:54 GMT  
		Size: 2.3 MB (2311818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-buster` - linux; ppc64le

```console
$ docker pull python@sha256:dcf23adfac70f419616dd83d2de487901474413a5f68c26514b5ae2d150981ec
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.9 MB (359900489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fed9a1a885800db7fa4f3a4b9d4395adc4e94909bb502e8d4f3a9fc441be93ab`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 01:16:51 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 01:16:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 01:17:07 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 01:17:59 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 01:18:11 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cb134f33308d3d8fffcd42df7f9b4c27ce05b18796e59dfba80e19571bfbbf8a`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a80578536d07dfcaea86af6e86b61fc06a9e2eec0d3a5c2bd6f91b63214c012d`  
		Last Modified: Wed, 28 Apr 2021 01:34:28 GMT  
		Size: 2.3 MB (2312047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
