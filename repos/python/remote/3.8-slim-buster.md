...
```console
$ docker pull python@sha256:269c3acfc900bbe8deea8dd646af354c0950839298b9e84f553c9d0d74a7c5e8
```
...
```console
$ docker pull python@sha256:30f9baec6cceb06a4be4814639320236918d0ab7f6b04a2b984fe71a9a3ac734
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.2 MB (41191696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d28147f798d7796ed91fb48bbb1c589360324c685c7dc05d6594a6a83cbaccf8`
-	Default Command: `["python3"]`
