...
```console
$ docker pull python@sha256:511bc84b3a227a6cf194c5923ba169f710e35c5c3e0359dccc221fb2ee4f067a
```
...
```console
$ docker pull python@sha256:6ef9260af95104471336074df2a0c9b36cf8db2b999055b972a381cc0a769cbb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.9 MB (18863061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3b817313885160aa771f76a8dd74fe83a268986822a746636d248c62544a107`
-	Default Command: `["python3"]`
