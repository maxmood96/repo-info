...
### `python:3.13.2-alpine3.21` - linux; amd64
...
### `python:3.13.2-alpine3.21` - unknown; unknown
...
### `python:3.13.2-alpine3.21` - linux; arm variant v6
...
### `python:3.13.2-alpine3.21` - linux; arm variant v7
...
### `python:3.13.2-alpine3.21` - linux; arm64 variant v8
...
### `python:3.13.2-alpine3.21` - linux; 386
...
### `python:3.13.2-alpine3.21` - linux; ppc64le
...
### `python:3.13.2-alpine3.21` - linux; s390x
