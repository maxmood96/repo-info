...
```console
$ docker pull python@sha256:ff2d0720243a476aae42e4594527661b3647c98cbf5c1735e2bb0311374521f4
```
...
```console
$ docker pull python@sha256:0c0792b65d9183866d195e535935f7709506f64bc4f991d02dccedda2112195e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.1 MB (303127080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66c8bc2936a3a899337e68b80976a5f2e35d3aaf0eb212193566f7b17b044db7`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 10 Apr 2021 23:09:09 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Sat, 10 Apr 2021 23:09:10 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/29f37dbe6b3842ccd52d61816a3044173962ebeb/public/get-pip.py
# Sat, 10 Apr 2021 23:09:10 GMT
ENV PYTHON_GET_PIP_SHA256=e03eb8a33d3b441ff484c56a436ff10680479d4bd14e59268e67977ed40904de
# Sat, 10 Apr 2021 23:09:23 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 10 Apr 2021 23:09:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:b98be1b57e236710ed9cdd9883acdcb01786df7cdcd30896f7e6ff712d0bfbef`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c3578e92c4eed72e9e63c1c2ca6cfb6d8c3f440b1885bc588adedded2144159`  
		Last Modified: Sat, 10 Apr 2021 23:57:33 GMT  
		Size: 2.2 MB (2164822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:c49eee82b82194683fd57c1a1bc7c6d52cc07243d55f47315d92f092237a4a56
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.1 MB (348113155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d61b4847bba6a44c8b763c728490d86319db6ffc286b659a9a1b8cf41e88ede`
-	Default Command: `["python3"]`
...
# Sat, 10 Apr 2021 17:13:35 GMT
ENV PYTHON_GET_PIP_SHA256=e03eb8a33d3b441ff484c56a436ff10680479d4bd14e59268e67977ed40904de
# Sat, 10 Apr 2021 17:13:43 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 10 Apr 2021 17:13:44 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0b8e52ab5f14435751382fd118e0ea8962a8a70487b80c37b615773762eedd96`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac3a5f52f63df04f7a37ccda4fafe983fa819825d0d2a400ecf9c182246258f0`  
		Last Modified: Sat, 10 Apr 2021 17:54:46 GMT  
