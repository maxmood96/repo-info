...
```console
$ docker pull python@sha256:a4967094041a26d36af5459f140baa9a936c0527af8d5c4b059a0bbd89b00003
```
...
```console
$ docker pull python@sha256:a19ee40587df8355bc04a9ecb75e19355e987497d79a4de0190a27e9599fc6d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.4 MB (303385907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49b36ae866ab726f99a5dfad7e484bdd073fb0a241f51041c9c0c406bd42b755`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 24 Jun 2021 03:16:54 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Thu, 24 Jun 2021 03:16:54 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Thu, 24 Jun 2021 03:16:55 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Thu, 24 Jun 2021 03:17:09 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 24 Jun 2021 03:17:09 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9d5190bc867fb95497710e470273754c1e4d318e197cc4e4c536c59757b67e93`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:524e81312328ab338843f458fe22e8c350aba95be6d1cb259af435373757f757`  
		Last Modified: Thu, 24 Jun 2021 07:01:01 GMT  
...
```console
$ docker pull python@sha256:6056ea4530f3b8d93d8f31abb14a827cd5808cc1594ce2aa5337e77b57a43125
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.0 MB (362008287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6412f9739d37ff3e842c5fb071a5ba69e3b30b5ee81284cc9acfeffcf8ffd404`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sun, 27 Jun 2021 06:25:56 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sun, 27 Jun 2021 06:26:04 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sun, 27 Jun 2021 06:26:08 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sun, 27 Jun 2021 06:26:42 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sun, 27 Jun 2021 06:26:50 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:3fd04e8f6d3baec2239ff777dd3dfd9e20a45bc5c69252fd74eb4a027d022af0`  
		...
		Size: 238.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d799c13569b98f462f07e92c9272618a3910a37fc4b6882619ce2fee0898ca7`  
		Last Modified: Sun, 27 Jun 2021 09:04:18 GMT  
...
```console
$ docker pull python@sha256:0c0d200d354d6b48dd050aaa30b1a273e656167c162f2b1721ff5d6c0de516f2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.9 MB (320911106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f5df7439418ba2da5fdbe0119ed63bf31cf577ad04f0466d58cf7921573ddf7`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sun, 27 Jun 2021 04:26:35 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sun, 27 Jun 2021 04:26:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sun, 27 Jun 2021 04:26:35 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sun, 27 Jun 2021 04:26:42 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sun, 27 Jun 2021 04:26:43 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:682232dff8ef61aa0402f49a6fb7394ab8634d8909937ec5f00ee84418a56fba`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e7493056e5d9fc9dea3899fe3bea7da4f9678477fdd9c9ebb36142849eb094f`  
		Last Modified: Sun, 27 Jun 2021 11:33:19 GMT  
