...
```console
$ docker pull python@sha256:879f5549865557ed9f8c2dbf227b317a4de89059534ce475a7a32a7b0c09d188
```
...
```console
$ docker pull python@sha256:9cf8b6aaf447ebc8ecf60c574e371923cd6a0dba9d76995e0e00d4cd24f4877f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.0 MB (363998014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:989bd91d6de5a485af5910598fe704272319ee1e7986926c2196b729811d8391`
-	Default Command: `["python3"]`
