...
```console
$ docker pull python@sha256:22987319cc80714d914b0b0525e6bef77957a749ad6884bd7a8b2348418fc40a
```
...
```console
$ docker pull python@sha256:05b159167a0951570a7431c72ecd616cd0c3111a50ebee3191c36bafc20d2f80
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.3 MB (339323438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d136c1ca7e1990e7757141f063eeb6e302ed2f15cbfd72592ac588a39fe19b1`
...
-	Layers:
	...
	-	`sha256:4f3b94c24f544e7cd5be7e7f1344a2c5521a675192443029039ba58afeab0bd0`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a54c27036fa5a2fd07d433ac8f83b2e5e1e78533c99431bc7bf98d0dc4c156b8`  
		Last Modified: Fri, 06 Aug 2021 22:02:54 GMT  
...
```console
$ docker pull python@sha256:21ceebe3ea56af64c6549da1ffe77b11bf1f04982c5f61e0d01b9f57fce6ec24
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.7 MB (311733548 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dec0012c65423d831fcb26ffa895d205ed01a297dd5123b0ca8c967dc4d8659`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:42:47 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:42:48 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:42:48 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:43:03 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:43:04 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:e793181d00f6741bdff377a94154d9bc9fba51ca7df2278006d26891eae0867b`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:057a7118e65adff84ca9ccec1619126353402a6a1a12cb5c1c7a595dee0e853a`  
		Last Modified: Fri, 06 Aug 2021 19:56:13 GMT  
		Size: 2.4 MB (2355433 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; arm variant v7

```console
$ docker pull python@sha256:6fc430876a3b45bc6512224478e982c3ef126f470fd7aeba442622f44bac0d7d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.4 MB (303390898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f602946972dbc67c60fe8788118de22f455cb8ed72541413ad9f3ae74fa33329`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:13:53 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:13:54 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:13:54 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:14:08 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:14:09 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:4dd392623b8be228f24807554b536918392e76887300827c49235d58bd2a976b`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc138ca26d791de18603e238699c4e5246aac8500ca491fe709b856eb4b03d00`  
		Last Modified: Mon, 02 Aug 2021 19:32:49 GMT  
		Size: 2.4 MB (2355961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; arm64 variant v8

```console
$ docker pull python@sha256:1f269ef45e0559a123a6cc3ac583373dcaeda167cca1c76decfc3d13ac15cdc9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.5 MB (329490957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f903d5c3417ba653840eedc5a9a32addb1c46a8bf814e27d6e1ab0cac349e83`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:48:59 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:49:00 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:49:00 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:49:11 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:49:11 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:8a4c660701a3ac4622a6004ef34643886be898682ebe5f421df748bbd4f4d977`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4562215e2c0f2e88358caa9fe7a0c07e2bd07d62736c219cc841cfc8faebf40`  
		Last Modified: Mon, 02 Aug 2021 19:59:16 GMT  
		Size: 2.4 MB (2355904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; 386

```console
$ docker pull python@sha256:1ebdcf6ae7e381502a444add86309cb03f16d305f84f3f624ffc63c9d7732b2c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348391955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d869f96868cf666d923da0e998dfb5e3970a316493bc6a1c488dd1b8fd6cef7d`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:47:18 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:47:18 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:47:18 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:47:25 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:47:26 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:6232a322a4407c272a2cf978cc21bd6ecf29207f08b491e23cbc4add15904974`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b660fbc19eb1f0f5a4c07cdbe537dd7e17001af848eeee566ad7d2e605d6f090`  
		Last Modified: Mon, 02 Aug 2021 19:58:32 GMT  
		Size: 2.4 MB (2356045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; mips64le

```console
$ docker pull python@sha256:b2ae77c87c5c40141695bcb48db2ab2a04b9e28b8900850535cbe86c14732257
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.9 MB (323856201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2f46ba20ead264201dfbb36061854b0248e2dba91fc1f15575b8b879365ac12`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:11808dafc7e0a3bc1c03310804f08be8b8cd57d5b4e6a2af1024aa7fb6cbe026`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76912a43ad0526a2e0ee89f527618aa2a84e04280bc8c93da98de18a4ec5e9bd`  
		Last Modified: Fri, 06 Aug 2021 19:17:42 GMT  
...
```console
$ docker pull python@sha256:d90a675c0c5392c9a92ca8bd6edb782589e6bf1f45f22771a77bffb13747658f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.0 MB (361992674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9aa5100fd9c99f3be381606d149a7e0a085b84b2f4a2cd6e90e3541dfadf7077`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:02:53 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:03:13 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:03:17 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:03:56 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:04:03 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:a07a8ee42b413c4bd4ccf193dafb4c2cbe8b2e5276086b9a140525bdb55fccc2`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:468fa93c274fdc7f8d00624398e4cd6f80f189ab9d0732261db356773e8f68da`  
		Last Modified: Fri, 06 Aug 2021 19:53:18 GMT  
		Size: 2.4 MB (2355397 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; s390x

```console
$ docker pull python@sha256:107a5fd8a7a99a9446d9649bfb80ce7ff5cb8895e85ab9b4be4ac7b4dd0bfe64
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.9 MB (320923169 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f802fe7409e154c3f8a4ea3e8bbf12f785e0c7fc515a6944e7443128878110f4`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:54:50 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:54:50 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:54:51 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:54:58 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:54:59 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:fcda8d8dfabc1bfe40a391d395534b57d8e04c46791056f059595eb6924a0501`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ae1f3fc902994d04f63675c1c7b4ff8c43d124f002c294c1b53578539968af9`  
		Last Modified: Mon, 02 Aug 2021 20:13:38 GMT  
		Size: 2.4 MB (2355889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
