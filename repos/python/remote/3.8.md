...
```console
$ docker pull python@sha256:c3bdfae4d2077b697a844cd9dc1469e2fb631bf8f12dd34870a4fd75a95b0166
```
...
```console
$ docker pull python@sha256:735f6a32b9874babf39a55ad207d0e132a52af763f59e76461bcff70842a30cf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.4 MB (311377942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34dfb4e06f79eaab3f30d5699f35666b3890c65bffd7691c0bae8fde546c5d47`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 01 Feb 2021 21:53:48 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Mon, 01 Feb 2021 21:53:49 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/4be3fe44ad9dedc028629ed1497052d65d281b8e/get-pip.py
# Mon, 01 Feb 2021 21:53:49 GMT
ENV PYTHON_GET_PIP_SHA256=8006625804f55e1bd99ad4214fd07082fee27a1c35945648a58f9087a714e9d4
# Mon, 01 Feb 2021 21:54:03 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 01 Feb 2021 21:54:04 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:865c7ef1d1ce3424ac9a8f47f8884c74a9695cdfbe3d4c950b264bd761b20c21`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7dc6a34b97b0557c3f7b319b52ac40e0a13ec3c6d4bb164d8d1d9c51378348b`  
		Last Modified: Mon, 01 Feb 2021 22:02:27 GMT  
		Size: 2.2 MB (2164308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:d81059bc8d4ea87c06ca354734e31670448fe31a38dec838f9f9e4a59476aeb1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.6 MB (320592544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7fa1ade5ba88eac50a2f7f2208c7afc536d14eed0a537b90601e6e97e802248`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 01 Feb 2021 21:48:34 GMT
ENV PYTHON_PIP_VERSION=21.0.1
# Mon, 01 Feb 2021 21:48:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/4be3fe44ad9dedc028629ed1497052d65d281b8e/get-pip.py
# Mon, 01 Feb 2021 21:48:35 GMT
ENV PYTHON_GET_PIP_SHA256=8006625804f55e1bd99ad4214fd07082fee27a1c35945648a58f9087a714e9d4
# Mon, 01 Feb 2021 21:48:44 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
...
-	Layers:
	...
	-	`sha256:7de1a9e70fc55a3924c98ec1c4e06638708871cb5eaf448926dcfa3e9610eea4`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d23b1971c5a975b8ff0b820469b54a918e59ea56b84cdd98a910efe7d2a26383`  
		Last Modified: Mon, 01 Feb 2021 21:54:34 GMT  
		Size: 2.2 MB (2164147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
