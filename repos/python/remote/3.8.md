...
```console
$ docker pull python@sha256:11a1bb9a6b8c09904418a602372bb28e71c8007ca4e244e58791596a03449124
```
...
```console
$ docker pull python@sha256:da54263b4336ebc3229ac3e98c8639a1ddf041cbc1f5786f0e4f7db505b03fad
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.7 MB (323703463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cbf86aec867b82b69eedb9a929b6f27bf614ffaee80689c2098c964072117f7`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 17:53:58 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 17:53:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 17:53:59 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 17:54:19 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 17:54:19 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:338b8051e81408ce715d408b7f2f7a82d3a9f82dd6d5b0d67fcd13a6e67837cb`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5b863dc73a9676bc01744dcc31d6f95ea6a12badbbf5004167da22a014ce34b`  
		Last Modified: Wed, 28 Apr 2021 18:01:14 GMT  
		Size: 2.3 MB (2311490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.8` - linux; ppc64le

```console
$ docker pull python@sha256:1da2441b3d977def3d173e77a711829394292ec06b64b84568f3c31d7e2c9988
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **361.8 MB (361818456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fe231136b9c997125ba4ca800461da42525ea12088f374eddeb782c73623d45`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 28 Apr 2021 01:10:25 GMT
ENV PYTHON_PIP_VERSION=21.1
# Wed, 28 Apr 2021 01:10:33 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ab9dde151f662745c13461f00c453dcf32a51ea9/public/get-pip.py
# Wed, 28 Apr 2021 01:10:40 GMT
ENV PYTHON_GET_PIP_SHA256=0ed17e859b835ad5bf00851f4dc8bbc3520c13dfff6c131d410cdb3a92ff0af9
# Wed, 28 Apr 2021 01:11:31 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 28 Apr 2021 01:11:40 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:96acce30aad884b9a48a7462c2fafdc9da7b38ab32f1a6110e82a2fad7e36c90`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6da7423941670f1e2701c3a151b4bfd9322fc9c334dcb51bc1a328a2df7ef762`  
		Last Modified: Wed, 28 Apr 2021 01:33:32 GMT  
		Size: 2.3 MB (2311769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `python:3.8` - windows version 10.0.17763.1879; amd64
...
### `python:3.8` - windows version 10.0.14393.4350; amd64
