...
```console
$ docker pull python@sha256:79bbe7f83fab34f89ecf138270cf7828c09724392d2d72933f620ba3119953a0
```
...
```console
$ docker pull python@sha256:8b760f54a6d0c0bfca689fb3c4c5d9fdd8b9b4a502b4ff78b63c4daa738f9deb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.0 MB (315005403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37158685c5e74045333858f477ef809b07c59b0f94777a27047090ce2f32fefd`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:c690c3f154ffec8adffd35d6dc6f36cb0a0b70da5f65d35967bc915105c188d5`  
		...
		Size: 238.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54d52d9578ee20a280e11669bca7c964cad1d87c03f052bad4cd2bcc9a605f50`  
		Last Modified: Wed, 23 Feb 2022 23:11:31 GMT  
		Size: 2.3 MB (2344315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:c1aa1614078e70c37726c6bd855c0be18ed07241ca31140aaff28c35ff222ab8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327112203 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:685cff58e70dccc1ed4b9e1b3cc71702584f2019eab8d23ef9df2951cd209f77`
-	Default Command: `["python3"]`
...
# Tue, 08 Feb 2022 04:57:03 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 23 Feb 2022 22:10:04 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 23 Feb 2022 22:10:05 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9d6a43190380d685607b07b0ebad6935a3ff709b1cc7af88de4aaf6d2ed0bc8e`  
		...
		Size: 239.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d58d0dc0181baf6f10a4644a95a0694e7ff1879528f358754de3953e9f3c798`  
		Last Modified: Wed, 23 Feb 2022 22:20:20 GMT  
		Size: 2.3 MB (2344044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
