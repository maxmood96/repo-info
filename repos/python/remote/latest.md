...
```console
$ docker pull python@sha256:66dfc04a1efccda84e4386b905921a83dabe51cc01a0ad28b20db6ef5205a916
```
...
```console
$ docker pull python@sha256:13e0a04b1a2abaf4b3785fee4d23fccd85c8c54bf98c83344efbec66f24a3ee0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.6 MB (312620588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48ceb01aa9320fa6182c15a58a0829a2b846c4ef23966f62c4fcdb6fbe918750`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 20:41:40 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 20:41:40 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 20:41:41 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 20:41:56 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 20:41:57 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:e0d4674dd0583c6a258d2ce150381f4a8b2de9fe7aa8092775539b8178f227ad`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fdc854a1d8c32be43a8e902ed67358716e873db34a15cccac2fb07b8d975619`  
		Last Modified: Mon, 02 Aug 2021 20:54:19 GMT  
		Size: 2.4 MB (2356151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:c1e7222a360f9331c4da8725c8c60f9b4e041e9bed0edcdbcffea2d3b35e3c38
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.7 MB (324739340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f5bf12ce495ec0f8dff8db215c8463863f8fb05b40c970ee30a99719c304f7a`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:14:02 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:14:02 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:14:02 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:14:26 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:14:26 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:075436562824ce288d05c30ddf890f2cf38b7f32112555d69e2740b6b0a16096`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2130181f1248846c90d9b00303b91274557c77237d77dde24ec6c4e2cfc7e51`  
		Last Modified: Mon, 02 Aug 2021 19:20:30 GMT  
...
```console
$ docker pull python@sha256:d1761f0be784b20dbc29cde6ed6252f83334b016ed3b5af621e142fbe3802439
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.9 MB (362880475 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3b4806d1de336b9c2e58630ef8a1ba1828809eef874d57dd0a6bbe8b9958f2c`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:33:40 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:33:49 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:33:54 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:34:28 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:34:34 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:7d7cb218ce981d398133ad3280d4fb4a8174bd07ae818706a6ba74d16e733265`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cd417b1feb946026c6af8c047b9ebc7a6136f0e903047a7c77bbdf37ac983af`  
		Last Modified: Mon, 02 Aug 2021 19:56:26 GMT  
		Size: 2.4 MB (2356001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `python:latest` - windows version 10.0.17763.2061; amd64
...
### `python:latest` - windows version 10.0.14393.4530; amd64
