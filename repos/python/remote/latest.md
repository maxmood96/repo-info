...
```console
$ docker pull python@sha256:d11211d39533127a435013ba42f5e3246e379b79b2d85090342e461592108a75
```
...
```console
$ docker pull python@sha256:7f2fa3897549ad7a3b64353c5f7bf61021d22ec4073137804660d1aa3b3143ac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.9 MB (322917922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc246e3caeaeff7e8a8cdb615a766e13c4e7f16a4cd6ef0e6fb6ad96af4404e4`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Wed, 18 May 2022 04:59:17 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2d26a16e351a22108b46fa11507aa57a732d4074/public/get-pip.py
# Wed, 18 May 2022 04:59:17 GMT
ENV PYTHON_GET_PIP_SHA256=530e7077f9e31f0378b5ee7cc90c8d99b7aef832f3d4ea96b42c2072e322734e
# Wed, 18 May 2022 04:59:31 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 18 May 2022 04:59:32 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:20af8fb996c3f44c8441227aa5ea7669d13b930e685e9df6dafec951e980aefa`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63c00279f564eebe61dd03e894d86019c61fa950ca2d312e4696de7a01cabb28`  
		Last Modified: Wed, 18 May 2022 07:00:14 GMT  
		Size: 2.9 MB (2872437 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:latest` - linux; arm variant v7

```console
$ docker pull python@sha256:cdbd9cec9ce8b3f938fb3f44172003764d8a767e34ee8bceee78e5d1f9bc2be2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.8 MB (309775087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fe3ebe16439e6186e725e338f8b0378816d8039109f0e5b4949503803b63333`
-	Default Command: `["python3"]`
...
# Thu, 12 May 2022 01:51:09 GMT
ENV PYTHON_GET_PIP_SHA256=e235c437e5c7d7524fbce3880ca39b917a73dc565e0c813465b7a7a329bb279a
# Thu, 12 May 2022 01:51:23 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 12 May 2022 01:51:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c2bee87a24739da9cc62725886259658dd8d40a14b948ba3c4b7f3d351dd9b59`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60722ca9193addb191b17fc7a3ba186ff1be616f095b03fdba35671f2846e16c`  
		Last Modified: Thu, 12 May 2022 07:43:11 GMT  
		Size: 2.9 MB (2872290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:78c4a13b079a7fb057e8cbcef9fbe412c02179ba848363db856d97bb16b26236
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.7 MB (329717011 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48d3fa7cded51952f47ef466f5bf46dbbb1eaa94bc548178498b45938368244e`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 12 May 2022 09:30:05 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/38e54e5de07c66e875c11a1ebbdb938854625dd8/public/get-pip.py
# Thu, 12 May 2022 09:30:11 GMT
ENV PYTHON_GET_PIP_SHA256=e235c437e5c7d7524fbce3880ca39b917a73dc565e0c813465b7a7a329bb279a
# Thu, 12 May 2022 09:30:42 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 12 May 2022 09:30:49 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0666f8f2e700c37204867ca590bded182d403be26e252db492aaae2e5f088f36`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52a16971bcefa0469d507e9f85d9f6e902d2ed0b21c45ae94c2353dc82325126`  
		Last Modified: Thu, 12 May 2022 22:46:49 GMT  
