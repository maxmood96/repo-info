...
```console
$ docker pull python@sha256:f7fc670dc175c88887d0bf0c1178fb25aefc68f7e2e43bbdb2cedcd40a16b2cc
```
...
### `python:latest` - windows version 10.0.20348.405; amd64
...
### `python:latest` - windows version 10.0.17763.2366; amd64
...
### `python:latest` - windows version 10.0.14393.4825; amd64
