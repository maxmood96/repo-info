...
```console
$ docker pull python@sha256:d8c03730973cf1891f1815ea16903a9c8fefb3e0af1ba5bb89f7a67d2c5a97c3
```
...
```console
$ docker pull python@sha256:fa54307b0f774169a835e0c2d55ad02e56c0919bbda3d07bf96e053f7b413cb2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348362772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1846708830e3e1c8ebfd06c14dc72c62b8f1b88db54aa4797f34901ff433593`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:5cfbc37adcf408b6ea8be876d43ca4ac080debe5d69e206227356568728c5615`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ea93c75ce9edad5526f83f943007c832802ef8050f23788e699515b6bf2d82d8`  
		Last Modified: Sat, 19 Oct 2024 09:52:58 GMT  
		Size: 25.9 MB (25878527 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:10149b4e7e30cb5d060d4c8c8092fcff499915edbd7e91c5e2ea870258139a5b`  
		Last Modified: Sat, 19 Oct 2024 09:52:56 GMT  
		Size: 249.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull python@sha256:9b0993490add0e9eac81bf82b6be1ff0bfcc445d408fbe2bce45d961b873f99c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.8 MB (15814893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f97d751515e32a0c7b56266cb5a747edf85e34dd67dbda7e6c792c59f8f9630a`

```dockerfile
```

-	Layers:
	-	`sha256:be04a6650fd3f3b916c72fc14f5584cba40465cbc95e4070005c859024be1b01`  
		Last Modified: Sat, 19 Oct 2024 09:52:57 GMT  
		Size: 15.8 MB (15793388 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:40f1280912d67bd95c7bb4c6f3c7e9403f5bdc28a8f7673f4e72a2121f295500`  
		Last Modified: Sat, 19 Oct 2024 09:52:56 GMT  
...
### `python:latest` - windows version 10.0.20348.2762; amd64
...
### `python:latest` - windows version 10.0.17763.6414; amd64
