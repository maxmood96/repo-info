...
```console
$ docker pull python@sha256:cddebe04ec7846e28870cf8624b46313a22e6407b51ced3776588784caa12d27
```
...
```console
$ docker pull python@sha256:669af593d65207f8546f5df7ebe7a6d89452c25f8efa86a4a9ec0ab334339280
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.2 MB (323154703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c5d3598a467f3451faf2f4282c3d76c9f1b506c620642e19fdef24480f37e00`
-	Default Command: `["python3"]`
...
# Sat, 28 May 2022 13:05:42 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 02 Jun 2022 21:02:42 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6ce3639da143c5d79b44f94b04080abf2531fd6e/public/get-pip.py
# Thu, 02 Jun 2022 21:02:42 GMT
ENV PYTHON_GET_PIP_SHA256=ba3ab8267d91fd41c58dbce08f76db99f747f716d85ce1865813842bb035524d
# Thu, 02 Jun 2022 21:02:57 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 02 Jun 2022 21:02:57 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:970e829145232d1d921549e8beccf981291655a9c2e15dc364a4eec7f94411a1`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f47145b81fe8f98bd76242c07d4411081a0171877d13dc2b32b6e0dab38dfa77`  
		Last Modified: Thu, 02 Jun 2022 21:19:18 GMT  
...
```console
$ docker pull python@sha256:f66e10e31338a92941ac0828546ad0c267fbc14d03a60897c0198060ed4f4c4c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.0 MB (310014134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89184a268507cd8c736992b2dae7f28f73a69f77f6fe62a844ac894c7636006a`
-	Default Command: `["python3"]`
...
# Sat, 28 May 2022 21:59:40 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 02 Jun 2022 23:52:39 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6ce3639da143c5d79b44f94b04080abf2531fd6e/public/get-pip.py
# Thu, 02 Jun 2022 23:52:40 GMT
ENV PYTHON_GET_PIP_SHA256=ba3ab8267d91fd41c58dbce08f76db99f747f716d85ce1865813842bb035524d
# Thu, 02 Jun 2022 23:52:54 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 02 Jun 2022 23:52:55 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:f8a8029c5f07e59fc790865b5fcbc3264428138731abe23839ca61a898d3d4f8`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:359cb7c582f368c416b030c38acbd226b1083a2891d2264283df2a54a30c0396`  
		Last Modified: Fri, 03 Jun 2022 00:15:46 GMT  
		Size: 2.9 MB (2872420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:a04e728b8f12155506b371ad4a27898a2ece701e5a0b19a4e2b6c48b494e0928
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.0 MB (329977302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9c71848c23906b8fab856f2577b0f607fa208e3ebaa8715935712c709fdd4f6`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 02 Jun 2022 23:07:13 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6ce3639da143c5d79b44f94b04080abf2531fd6e/public/get-pip.py
# Thu, 02 Jun 2022 23:07:18 GMT
ENV PYTHON_GET_PIP_SHA256=ba3ab8267d91fd41c58dbce08f76db99f747f716d85ce1865813842bb035524d
# Thu, 02 Jun 2022 23:07:50 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 02 Jun 2022 23:07:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:56c57f46ed7cf87145bab84631540607895d39337dfab4f8ca90729c993a652b`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7546120fb5355a6084303d90eeab8cd4fdef4ba5631fa7820a7f9b28ea5231f4`  
		Last Modified: Thu, 02 Jun 2022 23:25:53 GMT  
...
```console
$ docker pull python@sha256:c624793c3c40d149789eed63caa96118cf31c6731003933f1ede378ac8f1b698
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **360.5 MB (360526847 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f543d64150bcaab39b8e12b5b3126178ee560fa9bc92ea290fe40a3918f2c89`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 02 Jun 2022 22:04:20 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6ce3639da143c5d79b44f94b04080abf2531fd6e/public/get-pip.py
# Thu, 02 Jun 2022 22:04:21 GMT
ENV PYTHON_GET_PIP_SHA256=ba3ab8267d91fd41c58dbce08f76db99f747f716d85ce1865813842bb035524d
# Thu, 02 Jun 2022 22:04:44 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 02 Jun 2022 22:04:47 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:35bb9c818081a74fcd30df759283315c18fb47bc6516eb0c6b2cb7c469205c75`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53765f2a3f9ca4c782883ad08967dafff729d38e429daafb490dee818e0d52ef`  
		Last Modified: Thu, 02 Jun 2022 22:28:41 GMT  
		Size: 2.9 MB (2872417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:latest` - linux; s390x

```console
$ docker pull python@sha256:3de7d33a05e286244988dc2171fa9639b90143b428ffc74f7456d7834b35f667
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.5 MB (324538875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32e6b464d8baab03d44df65b77ba14d20bbd1cb865175907c5be5ecf2311c502`
-	Default Command: `["python3"]`
...
# Sat, 28 May 2022 11:58:26 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 02 Jun 2022 20:30:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6ce3639da143c5d79b44f94b04080abf2531fd6e/public/get-pip.py
# Thu, 02 Jun 2022 20:30:29 GMT
ENV PYTHON_GET_PIP_SHA256=ba3ab8267d91fd41c58dbce08f76db99f747f716d85ce1865813842bb035524d
# Thu, 02 Jun 2022 20:30:39 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 02 Jun 2022 20:30:40 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:68993e3d76b50ccd3853027052d1dd041b3f74980e4e6f5c9b12ad631b1e395b`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea89611d154bdbba02c70685663a64d4914aa13cd93a0662d182f5d7fcda2074`  
		Last Modified: Thu, 02 Jun 2022 20:44:27 GMT  
