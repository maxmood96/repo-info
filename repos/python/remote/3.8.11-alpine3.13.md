...
```console
$ docker pull python@sha256:e05357b416967063ed46f7870a09db634d502ab3056a3a436da973d727ba33c2
```
...
```console
$ docker pull python@sha256:ea469d72f0dd2c994ff5873e17d491109521999b186e7190a2194571ac448cfa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.4 MB (17372821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af139dbc4c69d7dc145cf50683e6106e8624f8376ea971dcf5af766c0ca1dc6b`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:15:33 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:15:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:15:40 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:16:07 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:16:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:b44a5c7891523e877169d59a926bdff85ca5a870ad5b2d3cd7aee0ef086f2f3e`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b59a3b87c846f953a5b1e8dd84448f44d555e572266b654634f52b8d691a5baf`  
		Last Modified: Fri, 06 Aug 2021 19:54:09 GMT  
...
```console
$ docker pull python@sha256:483141c0745ab744e9b90d9e8ceb8b5e741f816f06c44c1979a67dab8b768d17
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **16.8 MB (16849962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ec7d8cdf1686d70dce2391415e06a375a6187d22e2a09f71500df020467ec0f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 23:24:55 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 23:24:56 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 23:24:57 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 23:25:07 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 23:25:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0405f00d2a23ad395c59533db540e968e444e48e7d2786982e4ee6c5df0a46bb`  
		...
		Size: 229.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06f4e4209630520ac999bc15c90e74ca5396f4402e9db91c623d3dd6618534c2`  
		Last Modified: Fri, 06 Aug 2021 23:37:59 GMT  
		Size: 2.4 MB (2355144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
