...
```console
$ docker pull python@sha256:10b5aad82ea9260cb26a081e18d086e3d9b68118b5aa036b2b6eddb27f29cf22
```
...
### `python:3.10.6-bullseye` - linux; mips64le
...
### `python:3.10.6-bullseye` - linux; ppc64le
