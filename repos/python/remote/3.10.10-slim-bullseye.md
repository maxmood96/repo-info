...
```console
$ docker pull python@sha256:856c38edd35530904fdf975894bd06cc340f3ef57babae31c2741308bd6999cb
```
...
```console
$ docker pull python@sha256:90c5c9960140aea84eeb8ef3b602a520f190676935e2b1b1a5f4c5217f1af6d5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48716914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a288fdd25ec887766aca2e260b2b16fd212cd6fb8be3873724eb33daf1b23ff`
-	Default Command: `["python3"]`
