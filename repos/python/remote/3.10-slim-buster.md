...
```console
$ docker pull python@sha256:099b0794a9839f981cbcace640be2989690fc7420a30f0da4347a89ee0c6f6a5
```
...
```console
$ docker pull python@sha256:f2ce58fcb56e79d5e946136c1eb55018196fc5221450d9c16ac31005527c7fbb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.0 MB (38009182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c9802cb1d0e6d2adc2de17c82145bc524818d1aba1c4337a7ccbfd8159fb6fe`
-	Default Command: `["python3"]`
