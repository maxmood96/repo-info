...
```console
$ docker pull python@sha256:b59fd1a008ab77d90dca9dffeab9fdcc55475ee78ffa5de3a0097d33936583da
```
...
```console
$ docker pull python@sha256:8af39096d3be7544f81470cb98174d11e709fb670ed3870276c2430f23c6e637
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.1 MB (39135767 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fa9008ab3ab2f3e3ea74cb35a04634fc77f3e5f8d132a11cabc2f08f45d6934`
-	Default Command: `["python3"]`
