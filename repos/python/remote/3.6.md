...
```console
$ docker pull python@sha256:28b9e7ce5d8ad3e9105eedb241dbd619e4ccfe8343ac8605ac47782e33466d63
```
...
```console
$ docker pull python@sha256:86bdc4ebcdacc760db91abe842607c5ce891e6e837b08054a502886457891c6c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **344.8 MB (344798503 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0317a0512841882e084f9327f472717b39c2e9ec056f52e4c6cdd5f92e5a005a`
...
# Sat, 21 Dec 2019 02:29:58 GMT
ENV PYTHON_VERSION=3.6.10
# Sat, 21 Dec 2019 02:38:37 GMT
...
# Sat, 21 Dec 2019 02:38:38 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 21 Dec 2019 02:38:38 GMT
ENV PYTHON_PIP_VERSION=19.3.1
# Sat, 21 Dec 2019 02:38:39 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Sat, 21 Dec 2019 02:38:39 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Sat, 21 Dec 2019 02:38:45 GMT
...
-	Layers:
	...
	-	`sha256:49a8841b38a3d271396f6ee3b117c3857dbbbc55105285a6e80a105afc2aedbd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4280fae8cb4d2fc11036a448f7b2c2b1297e550725d08ee137a9e92327bdb465`  
		Last Modified: Sat, 21 Dec 2019 07:33:19 GMT  
		Size: 25.1 MB (25116433 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e74d16bb3da555db32c7bc290fedfee889e189673d7c9125eb3f64030f3c00fc`  
		Last Modified: Sat, 21 Dec 2019 07:33:15 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29d55d3d8def184c33b56cea8faa7f3c5903e98b9c03a2fc0bfe4226287becfc`  
		Last Modified: Sat, 21 Dec 2019 07:33:15 GMT  
		Size: 1.9 MB (1870523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:736af24237f0009baaa87abaac3c8872978bf68b6e5a4fc027f651925674f555
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.5 MB (367505270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c073816faabb8d1006041fd7dbef46f98486ff5bdf656df67e8b7479ea22d6a2`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Sat, 21 Dec 2019 00:54:05 GMT
ENV PYTHON_VERSION=3.6.10
# Sat, 21 Dec 2019 01:02:25 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	&& make install 	&& ldconfig 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' + 	&& rm -rf /usr/src/python 		&& python3 --version
# Sat, 21 Dec 2019 01:02:34 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 21 Dec 2019 01:02:36 GMT
ENV PYTHON_PIP_VERSION=19.3.1
# Sat, 21 Dec 2019 01:02:39 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Sat, 21 Dec 2019 01:02:44 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Sat, 21 Dec 2019 01:02:59 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 21 Dec 2019 01:03:14 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:6ece2ef0e37c8be1afd1a5efe6da4b825abd557284525f931ab7aacf613ba913`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0498619b0995067f51cb9bc89d3843320060f829b7cc995c5a73853cd5dd1b2a`  
		Last Modified: Sat, 21 Dec 2019 04:02:46 GMT  
		Size: 25.7 MB (25749355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41f9c92db2a3a8d336c038a9f8a344f942a40067f104bf2fad38e7466f539341`  
		Last Modified: Sat, 21 Dec 2019 04:02:34 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c22bd58ba3225c6fd490ce6cc0ffbe512fc5863bbbc908da0eefba263d2b312`  
		Last Modified: Sat, 21 Dec 2019 04:02:37 GMT  
