...
```console
$ docker pull python@sha256:6764f8b6c2ff721353de23cbd999206bb1afcb88735c16cb20c97ca92ed075f4
```
...
```console
$ docker pull python@sha256:5f789f3e8ab7886869910a07630a910f4dc98228522f127d79b2b146e90cdab2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.6 MB (316633428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa0b3c6e313c336019e678289b959e18d1aaecb7c5c59d1894c28a91dd52a510`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:06:01 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:06:02 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:06:21 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:06:23 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:a4f7b9c61eab13c6ccabd11abd2b6fcb7bd32406599758a9d21a83863ec4f67e`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb085532050c1a34795c77de055786e44f1ac74c54d1f55f7d1a705e28688b4d`  
		Last Modified: Wed, 29 Apr 2020 18:13:38 GMT  
...
```console
$ docker pull python@sha256:1ad0a50add14f71dfa036a8235664f2e77e2ebb885fce9f4d2ea14de4b95ccad
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.1 MB (335140274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:797bf2ead7d535a30e7f6e96688cd7e71a5081e83f88823b88eed3caaacd0d8d`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:06:34 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:06:35 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:06:36 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:06:52 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
...
-	Layers:
	...
	-	`sha256:da4810832d33cf77e9c8983b88b70af3d788fae9839154cc4fcfbd8d4eaa2777`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16e46347b0f476d882966cb8923cc00d72af812f271316f720f9a0752f8e3836`  
		Last Modified: Wed, 29 Apr 2020 18:16:46 GMT  
		Size: 1.9 MB (1931323 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:d44b6071cad10e5404ef2046c9936db9f90d0924e9a1b4bf5ec5a735bfe1b126
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327084173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ae574b76c06f76164a6eaef3490c859125a4d76e185e8dddab3d01f873d786f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:01:36 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:01:36 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:01:37 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
...
-	Layers:
	...
	-	`sha256:4624ef97ab53d1a975201775215771d05d99ed5ee1a6ab68fdd52231a238aee8`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fc9966a7cf5bc66b865221898642742dd2c97084bd1bf3ab0be3bba8e56a7db`  
