...
```console
$ docker pull python@sha256:a91aa1e212ae2f1ec3a63c2f948ef90f37d1fa4aebbfec3e124b8a1f0011b1fa
```
...
```console
$ docker pull python@sha256:a6589c500bb23ad71771aad83e476707483f8d3ba9ec679db6e94c1ccc60c0a3
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.2 MB (345192257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f27d17206bbda9eac33ce048661dce0505593320e90ad8ff00fb493a073aac39`
...
-	Layers:
	...
	-	`sha256:a2d410a0f39cff43a6ad7c800424f6c9dad59813cbde66b65f229e04d6655775`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11f9d8faa61d775aff37d7d1e25e6b3d996a6eb177741339fa08d9ab573b2db5`  
		Last Modified: Fri, 24 Jan 2020 05:55:54 GMT  
		Size: 1.9 MB (1946640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; arm variant v5

```console
$ docker pull python@sha256:c4e9034020b5244a04b4a1e63774d7a4d7b374f24e59450582b199a0f0feafef
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.5 MB (316483069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f95da041cb432ab3c4f79ae77e492be557cda2285fd131468383f28f2db02a0`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 01:09:15 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 01:09:16 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 01:09:17 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 01:09:37 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 01:09:38 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:bd3e31ca7a74848ee69b35bd9a0cea6c08cf9edd5c2923cc6c19ce456142ac18`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5bd7b8ed84f8071f334e78a09fa1c0fc7ffa3494390ec070c5026f6f87f74c9`  
		Last Modified: Fri, 24 Jan 2020 01:19:19 GMT  
		Size: 1.9 MB (1946799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; arm variant v7

```console
$ docker pull python@sha256:1e1d737c65cade150b769b4d50ea0b8c413f28615705d8976bba4538d1ae23b5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.0 MB (308020934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d06a27003e693961b021cdc0af1dfac81a49086fdfa36a7b7f04cb3bc9695c37`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 03:19:00 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 03:19:01 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 03:19:01 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 03:19:14 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 03:19:15 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9d590f26b2979dae2a90648467e3b5829a51b41b7a6407f5e12ec71fca44495b`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a444974162361fd949a7e24013e8a0724f6ef5f2c97728cd4d9e4ce7f1640d0b`  
		Last Modified: Fri, 24 Jan 2020 03:33:38 GMT  
		Size: 1.9 MB (1946858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; arm64 variant v8

```console
$ docker pull python@sha256:9c541436da584e9b30c9897db143b7b5dba9282c727064cd3b66ff41ea030747
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.9 MB (334945365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53877f6e0b11ddfe109ff221d4fde454d4fa86ad92114b1f8627212f1e13be2b`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 09:14:45 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 09:14:45 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 09:14:46 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 09:15:00 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 09:15:01 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0847dc7849b07c953d5bf71d0530de57a61e390afb4b002a7bea1f590e629ee9`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:019cc1bd329f69ec7c2550912a98f08312d365f871c57b3656cb2d7b8107932b`  
		Last Modified: Fri, 24 Jan 2020 09:28:38 GMT  
		Size: 1.9 MB (1946830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; 386

```console
$ docker pull python@sha256:8d79b40190c764627d99f9d83d9871824af6856c73c1d8958be53e670abbb4e1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.3 MB (353260233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa25a2f1e8ab1ab0f202ecfe80b048837b489a985b51cf044805c78d7a3e1f3e`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 03:16:19 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 03:16:19 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 03:16:19 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 03:16:25 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 03:16:25 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0a8016ecbee90c79de7b90225aa4b6b657601abe54baa51f4c3470383f1afe5f`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10434b4b3dc561ca10b9d49196b473ef9b7a91605a338989bb9a4640c5bb6fca`  
		Last Modified: Fri, 24 Jan 2020 03:42:50 GMT  
		Size: 1.9 MB (1946592 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; ppc64le

```console
$ docker pull python@sha256:34addb68ac83cd53693dab79356e4698979bb2693f085ad09360c6975195adeb
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.9 MB (367891241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0657b65e289bfcb9d227974886e5c93f55e1d9431cd3418d66e16afe1698bbe0`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 05:16:55 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 05:16:57 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 05:16:59 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 05:17:19 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 05:17:22 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:298dc3b151102d2e9329e28a4419af4b793b3ce669b2310778642d4e04070cae`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01a09610a2034084f030d0c67bbcfd41653ac0345f06f18c8f31956fbd29b08a`  
		Last Modified: Fri, 24 Jan 2020 05:33:50 GMT  
		Size: 1.9 MB (1946836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
