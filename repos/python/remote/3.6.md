...
```console
$ docker pull python@sha256:18e16199b6a18e3d485e966baa1a16f8a7b1e4a0369f93c7b1b8a2b36f9884d6
```
...
```console
$ docker pull python@sha256:321569bae6f23c7e304cff1f5a66d62e7cddc1a5e9109cb64039b2a5788e6ef3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.2 MB (308196120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad2ec283666dcb8b03181f5dbb1949d936949cb63ea3ff512774fdd257b0f239`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 17:22:56 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 17:22:57 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 17:22:58 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 17:23:27 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 17:23:28 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:576ed5f725f2ee23de46535027b09e44b5d4449e2b2f6fed7d1fca9dd00c2e09`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac72c555073fcab526a84440580d13d08c7ac4450dfe2422258bb32de976514`  
		Last Modified: Wed, 29 Apr 2020 17:32:20 GMT  
...
```console
$ docker pull python@sha256:99b968202f1cf9ea42bd36a5f9fdd4ceb077a766c36b75ac77f96440fe56b6af
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.1 MB (335100841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb914e6d9f8458ab547c7f4068a04f1fec45f146c124715d3accf4bc7b5d34e1`
-	Default Command: `["python3"]`
...
RUN apt-get update && apt-get install -y --no-install-recommends 		libbluetooth-dev 		tk-dev 	&& rm -rf /var/lib/apt/lists/*
# Thu, 23 Apr 2020 14:05:59 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Thu, 23 Apr 2020 14:06:00 GMT
ENV PYTHON_VERSION=3.6.10
# Thu, 23 Apr 2020 14:13:53 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	&& make install 	&& ldconfig 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' + 	&& rm -rf /usr/src/python 		&& python3 --version
# Thu, 23 Apr 2020 14:13:59 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 23 Apr 2020 14:14:01 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 23 Apr 2020 14:14:02 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 23 Apr 2020 14:14:02 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 23 Apr 2020 22:23:22 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 23 Apr 2020 22:23:34 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:e032a2f53aad64733f5182094373bf2215e67cf66bfb941a303ea247af67093e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f55b310d1e6addb8e7da4788f980fffb611dd9bc143d0adaa3e6537afc7df27`  
		Last Modified: Thu, 23 Apr 2020 22:27:44 GMT  
		Size: 24.2 MB (24246923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da4810832d33cf77e9c8983b88b70af3d788fae9839154cc4fcfbd8d4eaa2777`  
		Last Modified: Thu, 23 Apr 2020 22:27:31 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eea9a91ab759ec56b51d8b8d31175d421d1d90c63e61b04d3fd6fa0fb3ee639a`  
		Last Modified: Thu, 23 Apr 2020 22:27:31 GMT  
		Size: 1.9 MB (1891890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; 386

```console
$ docker pull python@sha256:2c2487cf8b7a37b8a0e4df61f71d05b558a9a67800077e678ecee608754fa888
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.4 MB (353410013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:109c2e0dbe6f27ee352b42188643038e1525735ed1a4dc79d250de53a2ac5e4e`
-	Default Command: `["python3"]`
...
# Thu, 23 Apr 2020 17:02:36 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 23 Apr 2020 17:02:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 23 Apr 2020 17:02:37 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 23 Apr 2020 17:02:48 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 23 Apr 2020 17:02:48 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ae8b7786edf382ad64b561cea32ff207311082e3a8e0c6a9335cde8043245542`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cb10f4d9726847d9f73813155ec9cddffe78519a3233aaff109f45237abdfa9`  
		Last Modified: Thu, 23 Apr 2020 18:27:27 GMT  
		Size: 1.9 MB (1891542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; mips64le

```console
$ docker pull python@sha256:275e3575b081545e51810cb16d1c51609cafcfd6b7ea7a7675ee02e5a68b4a16
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.9 MB (329859473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:823e39cde03e89a560ec0324d730e9899ee8879dea6b145355597c71a6dea448`
-	Default Command: `["python3"]`
...
# Thu, 23 Apr 2020 14:36:31 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 23 Apr 2020 14:36:32 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 23 Apr 2020 14:36:32 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 23 Apr 2020 14:36:52 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 23 Apr 2020 14:36:52 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ed3dbce2bff0667a0765da5864a3e4aae99217f4977fd638ea6d0f062dc8dfac`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12f774694367104a37bef496c5b0aa37808d9e3e8427a57a0a075ff1a14e7c03`  
		Last Modified: Thu, 23 Apr 2020 17:34:23 GMT  
		Size: 1.9 MB (1891590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6` - linux; ppc64le

```console
$ docker pull python@sha256:79facd2213b44acf46d5060bb448514ad4edfc11b6e11819121ccbd81d989e6e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.1 MB (368101937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e554cd70d764a14c33fde7fb7259ec74b73959e881957fb1e94defcce470422`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 23 Apr 2020 13:30:02 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 23 Apr 2020 13:30:04 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 23 Apr 2020 13:30:07 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 23 Apr 2020 19:51:13 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 23 Apr 2020 19:51:16 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:86dcfab4272c9c568541e111076bdb626634718333091987d5255e452297180c`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79e72dcd784aa271a80276a56552a5b7b3eaa6aac5c63890629f8b8769953107`  
		Last Modified: Thu, 23 Apr 2020 19:57:18 GMT  
