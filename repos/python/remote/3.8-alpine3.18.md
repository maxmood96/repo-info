...
```console
$ docker pull python@sha256:6bbe2d42d8bbbf7444f62516f827dba8119efc2569c86513bd1b2a9273ed8a39
```
...
```console
$ docker pull python@sha256:ec74a235bfdeaf73b8e6dc91fa5eaacabe4210f4aea6bc466f7a4d2494a8faf4
```
