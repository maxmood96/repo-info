...
```console
$ docker pull python@sha256:5d3d3945196f318e004944018e8c69ccbe94a4902d7dfa15db08da5dd392be63
```
...
```console
$ docker pull python@sha256:6690afd91b946d279f0692752693c4e2edf49ddcfd3b04f31413869c5a8779d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.4 MB (340357411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b81e853046fd196c0d477ecbc78db026e3a7ce201e4156de8ae6ec29a3c9f504`
...
-	Layers:
	...
	-	`sha256:442ac3aa4e3d38932eff7371592f5ae14a257073cf248b2e7106c39c44d21b0a`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b3b2f54e33b079afff8045efb0086a89824661dedb1b8654dc9bd3975a6598f`  
		Last Modified: Wed, 02 Mar 2022 06:01:59 GMT  
		Size: 2.3 MB (2344229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-buster` - linux; arm variant v5

```console
$ docker pull python@sha256:e4c40a1b2b0d61eafe34eefc914f5c84c62e0b3662735823c99439dd2a26b7d4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.8 MB (312794787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:307bb36583c2bc94beb751de124bac8b6216be37b0f29a85dd3a7e1786318724`
-	Default Command: `["python3"]`
...
# Tue, 01 Mar 2022 21:35:57 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 21:35:58 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 21:36:12 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 01 Mar 2022 21:36:13 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:5ba69686c97efc7b420597802a56f26b6ef6d7ccfc746a12eea77599bffcca30`  
		...
		Size: 237.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b587dd0f4f3c4cc11ac3b8eeada004b8e0de387d60a2bf1d012adc91756297e2`  
		Last Modified: Wed, 02 Mar 2022 00:16:49 GMT  
		Size: 2.3 MB (2344226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-buster` - linux; arm variant v7

```console
$ docker pull python@sha256:9797909697bc349187eccaa1e84786afa46966ec125fcad176e7f6e42bd86626
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.5 MB (304452058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b9e6f6921dc979acff722074c976e9207718b759f332e7c3e64351ff37c246d`
-	Default Command: `["python3"]`
...
# Wed, 02 Mar 2022 09:35:40 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 09:35:41 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 09:35:56 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 09:35:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:4e4149bf6cce1ac05ac3906a41ca7d8a9d59dcbc9c71dcbbf32b9e5eccb4fa7f`  
		...
		Size: 238.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c33d9717032ea17550f5cb2ee2ecac04ea132ca94fcd1ccbcf0c0c687730c5ce`  
		Last Modified: Wed, 02 Mar 2022 13:00:55 GMT  
		Size: 2.3 MB (2344309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-buster` - linux; arm64 variant v8

```console
$ docker pull python@sha256:dd71a05183c928b11e568f1ca6bfb5a3c17d92dccf4e67eb1dca3edc5755117a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.1 MB (330063005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:437398bd9423951f76dcb88c40c47f9e56905e88ff2c71c49efd4c0edaea481f`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Tue, 01 Mar 2022 20:57:47 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 20:57:48 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 20:57:55 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 01 Mar 2022 20:57:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cbf00fb8d1db5b92a136adb3d4bd60741f2b4e45e48e9f213d1d98627962dcba`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184e179617ad8e74104169b44fefe17e72262f209e52812a5ab43d30253e0b35`  
		Last Modified: Tue, 01 Mar 2022 21:59:58 GMT  
		Size: 2.3 MB (2346515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-buster` - linux; 386

```console
$ docker pull python@sha256:1729e64e3f97bbc62587b00cafc163e5feec94cb16b2f5bfe81afc335a108165
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.4 MB (349444699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e29973fdf880e719a27d4fbddb4b7ad9dbbe5c3b8bed871957ee3c68eca7571e`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:2e5de43e983035b25b9daab16d56bff2997adef8cf03bc07002379a845a8204d`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:343c88cf1b3efe902480527c2f09e2dfe5f05637497398710d455edcfcb3ebcf`  
		Last Modified: Wed, 02 Mar 2022 02:42:03 GMT  
...
```console
$ docker pull python@sha256:2758fc2f7c8183be7fd7dc92733d32787177f9a412c30e67680c2a94dc629a45
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.9 MB (324895470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79a74c3faa78afcae0f0fe162cb66c321af7b5cab8e9abe0312499baea36f15b`
-	Default Command: `["python3"]`
...
# Wed, 02 Mar 2022 10:04:06 GMT
ENV PYTHON_VERSION=3.9.10
# Wed, 02 Mar 2022 10:45:39 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Wed, 02 Mar 2022 10:45:41 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "/usr/local/bin/$src" "/usr/local/bin/$dst"; 	done
# Wed, 02 Mar 2022 10:45:41 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 02 Mar 2022 10:45:41 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Wed, 02 Mar 2022 10:45:42 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 10:45:42 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 10:46:06 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 10:46:07 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:95023adec9887430f4ead25cbf62a0028e56a27659badd303990d73d3a9dc8f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a5c2f7adc85aa2b9291788fe56b9d9afab721a9a4896744e58da00cbdca8fc4`  
		Last Modified: Wed, 02 Mar 2022 17:11:43 GMT  
		Size: 19.0 MB (18952526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e9b0d2f2a1f1a6bff56adcb024c92230ddb2fdec392f54c2bddcec3674d2e5`  
		Last Modified: Wed, 02 Mar 2022 17:11:30 GMT  
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1ad711bdb4e4f0fdff7334b9b7dad615e02701bd3194d1082a5328c04088ccc`  
		Last Modified: Wed, 02 Mar 2022 17:11:32 GMT  
		Size: 2.3 MB (2344064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-buster` - linux; ppc64le

```console
$ docker pull python@sha256:0b703e203d652e0fbf274d8741a796e81f01aa1b64e54d463b1e71a53e6cfe2d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **363.1 MB (363094203 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a34e35e24389dce594bb05cc3da62058daa5a8804f9f465b2661521f41547270`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Tue, 01 Mar 2022 21:47:00 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Tue, 01 Mar 2022 21:47:01 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Tue, 01 Mar 2022 21:47:19 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 01 Mar 2022 21:47:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:8d9c10ceda481500ad2134e43c4ed780d48946ac3c7c6658fe135c583f2f7d44`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aefb7bf69db49d9365ff2eed52274222825a86773dffcf200e3f106b3704f39`  
		Last Modified: Wed, 02 Mar 2022 00:00:38 GMT  
