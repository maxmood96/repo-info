...
```console
$ docker pull python@sha256:6642297ab405f5f8067b613b6d438b0ea1fa0a19785464e8f4759e9862d25131
```
...
```console
$ docker pull python@sha256:30549c3706a88f3bf2a7782f8de353c9718c26872b415894d2f1b0731340b98b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.6 MB (336601227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9203006e1419279f1f19366b35ee2f136e8460fa44215f8ddb5442f81f79368f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 09:10:59 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 09:11:00 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 09:11:01 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 09:11:15 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 09:11:17 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c1f76b5df95a382ac3322037cdcd5e86287b5234c3e10d174f56c549e26039ec`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e859bde0971c34287f0e0911e78e5220a0713f59938efa4d29f7ca2bfc30df51`  
		Last Modified: Fri, 24 Jan 2020 09:27:41 GMT  
