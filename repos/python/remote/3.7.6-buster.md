...
```console
$ docker pull python@sha256:366002b9b22cac2e138ffb8710eadfb14d94b95ceeb95670cbe8ce1f18be8018
```
...
```console
$ docker pull python@sha256:0c171cf2cd00e028aface87e62c5682e4060b68ccdff7fa0f08a1ced9b8b7788
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.6 MB (328569224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c3faec03385341f77e489352b1d9ac4f411bc60683a86f0dc94f466e4561cc2`
-	Default Command: `["python3"]`
...
# Fri, 03 Jan 2020 22:25:28 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 03 Jan 2020 22:25:29 GMT
ENV PYTHON_PIP_VERSION=19.3.1
# Fri, 03 Jan 2020 22:25:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 03 Jan 2020 22:25:29 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 03 Jan 2020 22:25:38 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 03 Jan 2020 22:25:38 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:88d1f66b3a3b1ab47563185a1434606b9000322faf8a6221a9065d76f2cef08b`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a796ed64561559f7ae98e4a1e646953e36d8e5ad2999a05635f5cad232f6eb0`  
		Last Modified: Sat, 04 Jan 2020 02:44:48 GMT  
