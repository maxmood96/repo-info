...
```console
$ docker pull python@sha256:815c5c6df7736eb9e1212f04f0d0239d9c0d0e46e9b7f8e69964f6e62d450fa3
```
...
### `python:3.13.1-bookworm` - linux; amd64
...
### `python:3.13.1-bookworm` - unknown; unknown
...
### `python:3.13.1-bookworm` - linux; arm variant v7
...
### `python:3.13.1-bookworm` - linux; arm64 variant v8
...
### `python:3.13.1-bookworm` - linux; 386
...
### `python:3.13.1-bookworm` - linux; ppc64le
...
### `python:3.13.1-bookworm` - linux; s390x
