...
```console
$ docker pull python@sha256:59f74a59a83cabbb15dd5a4a3dc38f921b664cc2d3a9ff0ca916de7395d39237
```
...
```console
$ docker pull python@sha256:e118eb6f92d211b3b0924bf2cbc9e546b1af410dcf7708206e4b140a7b52beff
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.9 MB (42872060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f741bb0bdf474e80e7f6c6af6eb1ed8dc2814607cb457a13a0858c9ef1e9ec5`
...
# Tue, 04 Aug 2020 16:04:55 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 05 Aug 2020 08:14:29 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Wed, 05 Aug 2020 08:14:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Wed, 05 Aug 2020 08:14:30 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Wed, 05 Aug 2020 08:14:43 GMT
...
-	Layers:
	...
	-	`sha256:385bb58d08e62a5f1ce007200cd30794be92530c300519417607392423a316df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcace2657aed039dc267271c3a917452db6e4276c51e2b9df02bb29f1ebd27b9`  
		Last Modified: Tue, 04 Aug 2020 20:37:12 GMT  
		Size: 10.6 MB (10623132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79dbc697723b6442635da8d662777044e149a44a89e98cfab4dae04c755a54a0`  
		Last Modified: Tue, 04 Aug 2020 20:37:09 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd94e0d05891f9bdc78cdb72aaa0e7c8c74fbf7c4b352c8d4f3a577085827485`  
		Last Modified: Wed, 05 Aug 2020 09:14:14 GMT  
...
```console
$ docker pull python@sha256:a2dea528dea415401519f29a894480bf1ce5afef837dc762f00694e0049d3b7e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.0 MB (39994593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8ab673efff09df5f9bce5da19465d6a20e0dea64af801fa295b6087e5e75602`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.2.1
# Tue, 04 Aug 2020 22:45:59 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 04 Aug 2020 22:46:00 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 04 Aug 2020 22:46:41 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 04 Aug 2020 22:46:41 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ba5592a6558b476cb3ea8a78bbc21ccb97e4ec93b672f8029b2c8377e123c066`  
		...
		Size: 230.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cdef1f172b21d409a22bb5baa0689fc63ac6f114126f95a2ce30a5de8e5305c`  
		Last Modified: Tue, 04 Aug 2020 23:04:05 GMT  
		Size: 2.4 MB (2406475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:rc-slim-buster` - linux; arm variant v7

```console
$ docker pull python@sha256:a97eb2fba28ba1faf929a33d83e275a564569864eee7cacea299c284138ced72
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.3 MB (37290027 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b614d99ac7bfcf46e82f588a4826c249533a5efc2a0d1b273712051bb90fd17b`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 04 Aug 2020 23:33:06 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Tue, 04 Aug 2020 23:33:07 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 04 Aug 2020 23:33:07 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 04 Aug 2020 23:33:47 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 04 Aug 2020 23:33:48 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0db4992a8b4f54ed4b4f93df7c9aae2501032cc9f038d090e8697ee6919e1e66`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f0cb321e4f32c25f01e749c57998060d17a0ce4325e0e835a00645403362cbc`  
		Last Modified: Wed, 05 Aug 2020 01:05:13 GMT  
		Size: 2.4 MB (2406440 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:rc-slim-buster` - linux; arm64 variant v8

```console
$ docker pull python@sha256:7aa9b683dd565167bbf71743ce7c92c86b7fb4917603a01f2b9cacfa2d79a528
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.5 MB (41512531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e88e2c19f1c67458dd3010ed04dfd0e5c605ea93e1ce998eeb778e4f2b5ec2f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 05 Aug 2020 01:27:06 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Wed, 05 Aug 2020 01:27:07 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Wed, 05 Aug 2020 01:27:07 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Wed, 05 Aug 2020 01:27:34 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 05 Aug 2020 01:27:34 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:53d15a7ae3a6ab7a279c7aa05f4021918cc14c7705a97b1cb734d0aace8835e3`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6821f78fcb7ab00f8d4ae4a96b14ad6774220bfdd95036b5dba2064c84b1f189`  
		Last Modified: Wed, 05 Aug 2020 02:48:32 GMT  
		Size: 2.4 MB (2406817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:rc-slim-buster` - linux; 386

```console
$ docker pull python@sha256:176e74359234206fafefaa74ef927530d87eb18204ac3e3e698d6a0a8b063239
```
...
-	Total Size: **43.7 MB (43678955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b692fbf5e8a7cfbac532fe6b8d978c7ebedc5d707239438f8999d14b42596e54`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:3ca41e040aae13e475bef3fab308178c386f3d3247d8cb88b63d6cdd60ad76a3`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f296dd36a8141b18fa66c067be9f31adba017c3c49c690b56d427a8ca8c9de80`  
...
```console
$ docker pull python@sha256:57bde970d26b4d577e0df5195c3a3a3178a11682af1a3874e647d989fc98b425
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.0 MB (41002929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92aeabc66003c8193ea3d020ffc64270ca1ebf36253fc242ea50e848dccd676d`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 04 Aug 2020 23:56:51 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Tue, 04 Aug 2020 23:56:51 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 04 Aug 2020 23:56:51 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 04 Aug 2020 23:57:33 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 04 Aug 2020 23:57:33 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:3322a2bfa7fbef3a067c9266e0a90683cd52d53e2f8116ba8fea0d80a140ff6f`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72d2d44ddc3690d1f70280721df06e039628e6470978b96fa13d38ceb93f16e8`  
		Last Modified: Wed, 05 Aug 2020 00:04:08 GMT  
		Size: 2.4 MB (2406296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:rc-slim-buster` - linux; ppc64le

```console
$ docker pull python@sha256:641dee6727ea819d0491556f2577ae6b38d35b443bbe961ef990bda8c8748031
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.3 MB (47259233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ccb91255168c224be8ead43f45a224e51b07f32f779d9cfca40a758a076c906`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 05 Aug 2020 05:07:33 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Wed, 05 Aug 2020 05:07:34 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Wed, 05 Aug 2020 05:07:36 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Wed, 05 Aug 2020 05:08:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 05 Aug 2020 05:08:21 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d7a2f033f4a1d94e857db7fd8370c8790aa51b657fa662c4908272afc8f5a00e`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:902e91ea1341cfa30832d00d47e4c21f1c25a4c462b59a200a1844345c4ca3c9`  
		Last Modified: Wed, 05 Aug 2020 05:23:53 GMT  
		Size: 2.4 MB (2407885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:rc-slim-buster` - linux; s390x

```console
$ docker pull python@sha256:6147388616192c325ef17ca5723cb1371f6c1794ac5c70b90221b7d2ae91c070
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.0 MB (41047447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c85f247ccede56c4740b1cd27f05f41923fcce466e39f3019d6b0807070d179f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 04 Aug 2020 22:50:13 GMT
ENV PYTHON_PIP_VERSION=20.2.1
# Tue, 04 Aug 2020 22:50:13 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5578af97f8b2b466f4cdbebe18a3ba2d48ad1434/get-pip.py
# Tue, 04 Aug 2020 22:50:14 GMT
ENV PYTHON_GET_PIP_SHA256=d4d62a0850fe0c2e6325b2cc20d818c580563de5a2038f917e3cb0e25280b4d1
# Tue, 04 Aug 2020 22:50:29 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 04 Aug 2020 22:50:30 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:5b78ea7eb66452c30857ceac08e6ca22c5dc5317dd31f4c5cf4360dd89fc0a83`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:227d60bf850baa09f067b4c7cec1863cf6022294dfad83b2f5456654eda1c664`  
		Last Modified: Tue, 04 Aug 2020 22:54:39 GMT  
		Size: 2.4 MB (2406224 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
