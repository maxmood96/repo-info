...
```console
$ docker pull python@sha256:41f6e62b4c7024e216c919950bd369a22d0561e8b6e669407f8577923e8ab336
```
...
```console
$ docker pull python@sha256:6b92f48c230dd2066e449ff3c7a97edb82475ab7025eef95580d60cf1fd59b61
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.0 MB (46988498 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a65d62b94cbc02f5c9a418bd9e99fceba9ba9e9e6b8e1ea87d11a52af19471b`
-	Default Command: `["python3"]`
