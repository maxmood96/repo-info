...
```console
$ docker pull python@sha256:464ab573d23ffe70daa26e75526b31f6308c38d188833b20adda43eed0246f82
```
...
```console
$ docker pull python@sha256:2908ae31f385a4c15e9226e1030b63ea2fa91994428abadbfe3e7e373ac03067
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.1 MB (355136128 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9886e761095725d1a1a17007b037cf3a7df594140c54e3580a66608dfd77060`
...
-	Layers:
	...
	-	`sha256:aa86ac293d0fa66515f0a670445969ba98dd8d6a114a7f6aea934aaad44084d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32d1faaefc303d530833ba7b47226a58beaea6ac5ba6164bc98d6156b7adb0c3`  
		Last Modified: Tue, 06 Dec 2022 16:15:46 GMT  
		Size: 23.2 MB (23247646 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ccd92605074ba3b14ec8143b014397a9a66a4aeb134a91cdd37f6bed89ded21`  
		Last Modified: Tue, 06 Dec 2022 16:15:43 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a35eb2be5d427970e1e5eda31ebc0c4d825f76db8c21db79a018924f6f4fdc7`  
		Last Modified: Tue, 06 Dec 2022 16:15:43 GMT  
...
```console
$ docker pull python@sha256:cac0061a2abdf7761e2184ddf17b8cc5ede196b4066f326b6a3d212713e6a547
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.4 MB (364413368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb8182b8018295960905cfcd0aecf1ba99fc840830b3821d273ca8e16aec6c00`
-	Default Command: `["python3"]`
...
# Tue, 06 Dec 2022 15:12:57 GMT
ENV PYTHON_VERSION=3.11.0
# Tue, 06 Dec 2022 15:58:56 GMT
RUN set -eux; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-lto 		--with-system-expat 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 	; 	make install; 		bin="$(readlink -ve /usr/local/bin/python3)"; 	dir="$(dirname "$bin")"; 	mkdir -p "/usr/share/gdb/auto-load/$dir"; 	cp -vL Tools/gdb/libpython.py "/usr/share/gdb/auto-load/$bin-gdb.py"; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name 'libpython*.a' \) \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		python3 --version
# Tue, 06 Dec 2022 15:58:58 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "$src" "/usr/local/bin/$dst"; 	done
# Tue, 06 Dec 2022 15:58:58 GMT
ENV PYTHON_PIP_VERSION=22.3
# Tue, 06 Dec 2022 15:58:58 GMT
...
# Tue, 06 Dec 2022 15:58:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/66030fa03382b4914d4c4d0896961a0bdeeeb274/public/get-pip.py
# Tue, 06 Dec 2022 15:58:59 GMT
ENV PYTHON_GET_PIP_SHA256=1e501cf004eac1b7eb1f97266d28f995ae835d30250bec7f8850562703067dc6
# Tue, 06 Dec 2022 15:59:09 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 06 Dec 2022 15:59:09 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c61459104b38a3a591ed4a1e143d51f2265c32cceabdcb9968cd5d0102058fd3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0d8f670b730cfe06fd6409f34b40e6608c1b43db43a420af3073ca1cea50c7a`  
		Last Modified: Tue, 06 Dec 2022 18:19:35 GMT  
		Size: 23.3 MB (23288694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ec0168fe1aeda570dbfe53c7863dcf4b4b3bad7a343b3774abb0e693d2f9cf1`  
		Last Modified: Tue, 06 Dec 2022 18:19:29 GMT  
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:996ef883b7dda4784ecdcf74094f21d8f4698b572c3749f51d33804f5c1057e6`  
		Last Modified: Tue, 06 Dec 2022 18:19:30 GMT  
