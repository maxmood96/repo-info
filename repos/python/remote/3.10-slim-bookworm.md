...
```console
$ docker pull python@sha256:e53bad75661571d23d9fd632d10f192b09228f31b14af1fc0be3d0142b426657
```
...
```console
$ docker pull python@sha256:5e8f0a3d6833d23bf7f6fd876b09bf186047892bb8b6d1cebc53b6303a6e5aa8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53191771 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ad09b31ed0e17c8b8e691902202c015bd2e9b8b933fd39eaaee9533a1fb3461`
-	Default Command: `["python3"]`
