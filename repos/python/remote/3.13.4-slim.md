...
### `python:3.13.4-slim` - linux; amd64
...
### `python:3.13.4-slim` - unknown; unknown
...
### `python:3.13.4-slim` - linux; arm variant v5
...
### `python:3.13.4-slim` - linux; arm variant v7
...
### `python:3.13.4-slim` - linux; arm64 variant v8
...
### `python:3.13.4-slim` - linux; ppc64le
...
### `python:3.13.4-slim` - linux; s390x
