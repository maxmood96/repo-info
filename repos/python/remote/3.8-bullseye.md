...
```console
$ docker pull python@sha256:5b1abe2430872bc0ac3f067d6fdf9b011fa7958e2072970cdb20568874180dfc
```
...
```console
$ docker pull python@sha256:d88c726e32f163b92adc88a930e79b73b3d9132eaaec8fd6d10398140f04fc5f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.7 MB (320708146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf81c4e4f260453518281f868f6b5e77ff1edc9de45d3db2fa6d8457c45496eb`
-	Default Command: `["python3"]`
...
# Fri, 03 Sep 2021 07:23:48 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 08 Sep 2021 01:31:34 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 08 Sep 2021 01:31:34 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Wed, 08 Sep 2021 01:31:35 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Wed, 08 Sep 2021 01:31:42 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 08 Sep 2021 01:31:43 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:77cdfe32d3bf59da53506f5b7f8faec363c0f1d4750b1c2fe1ef369d2967265f`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3588e97b4c0cc2c766d8b9ccbe52ae376d58f1b9d2cd2454f9aef126620b17a2`  
		Last Modified: Wed, 08 Sep 2021 03:07:34 GMT  
