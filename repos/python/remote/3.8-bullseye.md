...
```console
$ docker pull python@sha256:5b8626f6b9ff6e141a9c62e69bdb41987d09d618aec5b6d640b7090588c41f4b
```
...
```console
$ docker pull python@sha256:836c3846d2a42c20be56fdec31dc88af491e5586a4b4b95311976ad1933731c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.3 MB (358307065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:434ac06680030f4f27aae42b06b6ef195609a3c47de0787e44e70b2de1df1aac`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 03 Aug 2022 20:32:46 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/aeca83c7ba7f9cdfd681103c4dcbf0214f6d742e/public/get-pip.py
# Wed, 03 Aug 2022 20:32:46 GMT
ENV PYTHON_GET_PIP_SHA256=d0b5909f3ab32dae9d115aa68a4b763529823ad5589c56af15cf816fca2773d6
# Wed, 03 Aug 2022 20:32:59 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 03 Aug 2022 20:33:00 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0632d5170c0af29a551388fde678827aba6926482ae4b16d56c984a289cf1173`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2577cb8f5aa7141eb4660db2ea65f7ad0e30a2fadd63086d2549f55d679f1ec2`  
		Last Modified: Wed, 03 Aug 2022 20:46:41 GMT  
