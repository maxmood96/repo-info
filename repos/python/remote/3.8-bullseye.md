...
```console
$ docker pull python@sha256:8dd8fc16f1ee219a1db8fd852112da08acd204ac7899abcebbe441edcab992da
```
...
```console
$ docker pull python@sha256:2f2cbfddf854ffee49c407a6a7a1b8ab3545acc698340947b8baf29e2b83d470
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **353.6 MB (353626246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5720203670161a88a79ff1e1fa6c468dd05df08bb00378418c061cf52fa6d1c6`
-	Default Command: `["python3"]`
...
# Tue, 15 Nov 2022 16:41:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/6d265be7a6b5bc4e9c5c07646aee0bf0394be03d/public/get-pip.py
# Tue, 15 Nov 2022 16:41:30 GMT
ENV PYTHON_GET_PIP_SHA256=36c6f6214694ef64cc70f4127ac0ccec668408a93825359d998fb31d24968d67
# Tue, 15 Nov 2022 16:41:38 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Tue, 15 Nov 2022 16:41:39 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:4b54f2fb0d9bac6250709b9882adc8b3071f3fdeb208f7ffb881066d67913458`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d8b6f9f1832a9edfc0d841955ec2aba9d732c965e6fec7054a928478c5069e1`  
		Last Modified: Tue, 15 Nov 2022 17:42:22 GMT  
...
```console
$ docker pull python@sha256:59b0faf948f3f37de7eaa4b2fbee69793fc352acde104b9e49cd8ef62eef5cf0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.4 MB (358401253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c009af68af0c6b94c67db52e8e85e161f7417dfeb49491d387bdfd3d723112a`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:d0b481c50c68bf945a08e1eace5ce34ba5489e1a250fa73cb082bd60b638e13b`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e393068750894daf8966d83a37a2c3995227436be8bf80cfbd230e3a5a3fff7f`  
		Last Modified: Tue, 15 Nov 2022 18:00:34 GMT  
		Size: 2.9 MB (2886094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
