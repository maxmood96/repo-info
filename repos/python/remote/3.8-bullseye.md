...
```console
$ docker pull python@sha256:1f873ee288fd84221586299fe319c6fcce04c76161ac628d96ef06e27a8348af
```
...
```console
$ docker pull python@sha256:6b49c1263290d42afbfafb83417da2d400da751c1a9e47aad4220ebbefbc53c1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.4 MB (319411282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5518ce985c2e9dc50c433c66195327f8e8b7ab827cc51e3451775a4ebec4bad`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Thu, 27 Jan 2022 00:09:10 GMT
ENV PYTHON_VERSION=3.8.12
# Thu, 27 Jan 2022 00:21:57 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 		&& ldconfig 		&& python3 --version
# Thu, 27 Jan 2022 00:21:59 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 27 Jan 2022 00:21:59 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Thu, 27 Jan 2022 00:22:00 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 27 Jan 2022 00:22:00 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/3cb8888cc2869620f57d5d2da64da38f516078c7/public/get-pip.py
# Thu, 27 Jan 2022 00:22:01 GMT
ENV PYTHON_GET_PIP_SHA256=c518250e91a70d7b20cceb15272209a4ded2a0c263ae5776f129e0d9b5674309
# Thu, 27 Jan 2022 00:22:14 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 27 Jan 2022 00:22:15 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:6c7eb608fe1af643639b5b49747825806d6bedd1d7f9bacf19f51f9be3917c41`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c825b3e40fdac7eae7f9f23db40e66fc5aa7d121db22794debbab8b1f05ea7ec`  
		Last Modified: Thu, 27 Jan 2022 02:31:18 GMT  
		Size: 15.9 MB (15898561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e69fc6fac57e344a073c68c743710cb37dcd80164d1dba53bbd828fb6188aee`  
		Last Modified: Thu, 27 Jan 2022 02:31:07 GMT  
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29ee83697c0d92209c3f6de954d8a2360460f93e4cf11294f126e445e175ba92`  
		Last Modified: Thu, 27 Jan 2022 02:31:09 GMT  
...
```console
$ docker pull python@sha256:6734d26d7904b82f4c49f0c02d44d572e07946ea07c779c05bd89a6fd77cd767
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.3 MB (306274196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55af28f5333956e546a11f72409817f585f8d81b4edd356f0a588f5bb48c820d`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_SHA256=c518250e91a70d7b20cceb15272209a4ded2a0c263ae5776f129e0d9b5674309
# Wed, 26 Jan 2022 22:55:55 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 26 Jan 2022 22:55:56 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:7a60afaea5c320ff902f2f228c6405e55bc4e09a9a0ae542befe89526311a918`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e673a1dffd0fea11fa78d9b11b4f4d4841dc33c0ad3e56a27b4b087ed710d98`  
		Last Modified: Thu, 27 Jan 2022 01:38:30 GMT  
		Size: 15.7 MB (15661720 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf0b3d4776ecf1500e09f56b3272c50f5d0693b30bd8092f50590246575dfeb8`  
		Last Modified: Thu, 27 Jan 2022 01:38:20 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f070ae74a0e36d19a50689f13d8ef0edf913ad0dfeebc1967f35879557e1a4f8`  
		Last Modified: Thu, 27 Jan 2022 01:38:22 GMT  
...
```console
$ docker pull python@sha256:154f0f559b7a80a2bacbca9bed607eb67563474df3f825088d22e9f4d85fbd57
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **352.8 MB (352822044 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95ce25a9133e64125f200b4bdc41cdd7f2e06b1caa40c9613eedac14313866f4`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Thu, 27 Jan 2022 00:47:18 GMT
ENV PYTHON_VERSION=3.8.12
# Thu, 27 Jan 2022 00:57:35 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 		&& ldconfig 		&& python3 --version
# Thu, 27 Jan 2022 00:57:36 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 27 Jan 2022 00:57:36 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Thu, 27 Jan 2022 00:57:36 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 27 Jan 2022 00:57:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/3cb8888cc2869620f57d5d2da64da38f516078c7/public/get-pip.py
# Thu, 27 Jan 2022 00:57:37 GMT
ENV PYTHON_GET_PIP_SHA256=c518250e91a70d7b20cceb15272209a4ded2a0c263ae5776f129e0d9b5674309
# Thu, 27 Jan 2022 00:57:44 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 27 Jan 2022 00:57:44 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:1769ac075432f55477cb2f69ec6d70f003f4ec82cf2a9c14a07b94ca118ebdc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0f02e1ccb71ce9ac3f29cb5f8d6bd4e65f7388ce1aa198acf1d1c10dfbb24ef`  
		Last Modified: Thu, 27 Jan 2022 02:23:38 GMT  
		Size: 16.0 MB (15950600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1e6081761758aa94358119149a28bcd34ec5da7bc6afc32cb4c4e49604e464b`  
		Last Modified: Thu, 27 Jan 2022 02:23:35 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b52bcd6e2e5bf1d93e8a63a7a6e6131424af43b524a83862bb5c8b6eacdae5c`  
		Last Modified: Thu, 27 Jan 2022 02:23:35 GMT  
...
```console
$ docker pull python@sha256:842f19986645efab023c9ebe37972fec507e2020b38f71f3cf2f2d70bfbb74d7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.7 MB (326677800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f71c275af9399d38e990f411a901651d1c167ed28a91b11661d4d99f17c980d`
-	Default Command: `["python3"]`
...
ENV GPG_KEY=E3FF2839C048B25C084DEBE9B26995E310250568
# Thu, 27 Jan 2022 05:46:45 GMT
ENV PYTHON_VERSION=3.8.12
# Thu, 27 Jan 2022 06:30:00 GMT
RUN set -ex 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 		&& ldconfig 		&& python3 --version
# Thu, 27 Jan 2022 06:30:02 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Thu, 27 Jan 2022 06:30:02 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Thu, 27 Jan 2022 06:30:03 GMT
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 27 Jan 2022 06:30:03 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/3cb8888cc2869620f57d5d2da64da38f516078c7/public/get-pip.py
# Thu, 27 Jan 2022 06:30:03 GMT
ENV PYTHON_GET_PIP_SHA256=c518250e91a70d7b20cceb15272209a4ded2a0c263ae5776f129e0d9b5674309
# Thu, 27 Jan 2022 06:30:24 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 27 Jan 2022 06:30:25 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:fe4ca0a2dc2d677affcdfca702ac3124044bfd05ea1ec6fc419d37f38f8990f0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32dffa3d83f172c6287d902251e0b4820534073662602e95b8ce5aae2fd1b19c`  
		Last Modified: Thu, 27 Jan 2022 11:24:31 GMT  
		Size: 16.6 MB (16595219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ba9bca41e94f1e801e48c4474f14d5381013a88278c506f04520b2ab23ab47a`  
		Last Modified: Thu, 27 Jan 2022 11:24:19 GMT  
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bb91970cf6d8b2bb811b7c24b55ff4536956365f7375b2c2ba9ac75b6e7f4c1`  
		Last Modified: Thu, 27 Jan 2022 11:24:21 GMT  
