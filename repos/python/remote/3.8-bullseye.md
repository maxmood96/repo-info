...
```console
$ docker pull python@sha256:fad52be679f6efb6c93c81d00c114552ef9b77f042451cd9e69173bb5f7281c4
```
...
```console
$ docker pull python@sha256:fd063b00df4c38e90987cf8c5bed0094b3a84b846cb8ad305422596fbde790fc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.4 MB (319409352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43712d666d866bb1209c383679d63ad6176b4de5c6f61767f90713556a29700e`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:32f88203172f2ff4ace616ec3a4762b6342c2bb45e4ccb521de965bcadd34469`  
		...
		Size: 238.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4239bb7d8165aa4bf8f7e0fee288b82c578d8b2dab1e7e31d3ca2d2268429c`  
		Last Modified: Wed, 23 Feb 2022 23:14:46 GMT  
...
```console
$ docker pull python@sha256:690ccc8f3e48abcd21ebbd278435ddce823ee15769bc8019b08f65c69b838bd2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.7 MB (326665797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1792b299402f32fdd79fc2a730fe80acd17a55837631943abd835c16215e8618`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 23 Feb 2022 22:14:06 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 23 Feb 2022 22:14:07 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:aa8dd68b70c91611304a2a19fcaaf4920baed59130cc84bba749254c3e2a227e`  
		...
		Size: 239.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba2f95310b8243c6ecdda2da0975f570294e236c2cee8eba8455e35652cbad49`  
		Last Modified: Wed, 23 Feb 2022 22:21:40 GMT  
		Size: 2.3 MB (2346162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
