...
```console
$ docker pull python@sha256:a82aa07b94d62f03f682aa6498779beda52a670da614336c1ad2921bccb930c3
```
...
```console
$ docker pull python@sha256:14858474c61e390272ebf4f6a5d04cbe4533616be193613901921dba0f205fff
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.1 MB (326102903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360e5c976c204a52a6cabd87014a0a0d106d21a972fd2d0bb97ee1430a42778a`
-	Default Command: `["python3"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Sat, 16 Oct 2021 10:56:00 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d781367b97acf0ece7e9e304bf281e99b618bf10/public/get-pip.py
# Sat, 16 Oct 2021 10:56:01 GMT
ENV PYTHON_GET_PIP_SHA256=01249aa3e58ffb3e1686b7141b4e9aac4d398ef4ac3012ed9dff8dd9f685ffe0
# Sat, 16 Oct 2021 10:56:07 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 16 Oct 2021 10:56:08 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:148470ecb1fc0fc79495cc922b9cbdc07d29074c7b42e571f61fffab3929a8b3`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8918fc04a6e88e122d019cc31491ac1aa7b6d1d3074c4093fcb418407130bd68`  
		Last Modified: Sat, 16 Oct 2021 11:02:56 GMT  
		Size: 2.2 MB (2209694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
