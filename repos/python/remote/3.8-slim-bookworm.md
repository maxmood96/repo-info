...
```console
$ docker pull python@sha256:a92a4fd9129160a074f537482b2db341c8e9d6e04a07bfb0867228ae981b4165
```
...
```console
$ docker pull python@sha256:5bf8c38b1f2426a345f1078dfcdb1d306488faed852df25f1b31690b20f520fb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.5 MB (47453062 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5cf00b276c7b7e539becffe461d4bd9e19e52d1327e495a2ee01df6a2fc11cd3`
-	Default Command: `["python3"]`
