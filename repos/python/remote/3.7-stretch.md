...
```console
$ docker pull python@sha256:d13667c03ee5b85802da46132f0c05793410c6f3e09310378a817b6d39faadcd
```
...
```console
$ docker pull python@sha256:1caf5c98b8ecf37f6bc80c46ff38485fd0d429bf18f2d7b9906a9c6fc5616116
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.7 MB (348733209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42b11f5c9360df8626ce33ab34d82c48f52157ffeeeef768e7ad38c6485a428e`
...
-	Layers:
	...
	-	`sha256:38c43fb9424dbb772d8c06014302d842c54990d6e1942621e61ca8c010da9822`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:141501851f940e15e4f085531f42de9acdc465d830f3cc4ac05af8d157f4e986`  
		Last Modified: Fri, 06 Aug 2021 22:04:18 GMT  
		Size: 2.4 MB (2355618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-stretch` - linux; arm variant v5

```console
$ docker pull python@sha256:73932dd9c1306a7abf776a4ea069e53110c80e7d7796333458601b2406fb7af2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.0 MB (330994730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edad86a6c0cd65eeef98a776ee99586ecc35b8fc33eccb941d0f1a3cb29cd884`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 06 Aug 2021 19:45:18 GMT
ENV PYTHON_PIP_VERSION=21.2.3
# Fri, 06 Aug 2021 19:45:19 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/c20b0cfd643cd4a19246ccf204e2997af70f6b21/public/get-pip.py
# Fri, 06 Aug 2021 19:45:19 GMT
ENV PYTHON_GET_PIP_SHA256=fa6f3fb93cce234cd4e8dd2beb54a51ab9c247653b52855a48dd44e6b21ff28b
# Fri, 06 Aug 2021 19:45:33 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 06 Aug 2021 19:45:34 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cb46c997e4ed082b895f43a8ecc9459096d261357a6d73c325d6c1b5c404e717`  
		...
		Size: 237.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d8e329b134b21192535d700ad15c206133e9ddbfc8cedec6f1996f48b24af82`  
		Last Modified: Fri, 06 Aug 2021 19:57:32 GMT  
		Size: 2.4 MB (2355652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-stretch` - linux; arm variant v7

```console
$ docker pull python@sha256:98efd8df38f4af7888132fc00c30eab30df9a30dca357ce5d27e059dff4fdbf7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.2 MB (319248965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32df63e014344a110fb7e97e677edff91d2849575b3ee363a6d0d3502e261ebc`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:17:09 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:17:10 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:17:10 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:17:23 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:17:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ba41941bda6af8036dec34d826f46b3e05f3f7764ef2963559d6af0a0d522779`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b96ec5a2bc7376f77c510697453399f348ccc96fbfef4695f253af8bbea3b34`  
		Last Modified: Mon, 02 Aug 2021 19:34:40 GMT  
...
```console
$ docker pull python@sha256:a7f12a3a115cbba7873e125863b6fce3bad346363e55d02dbc1025610d85906b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.7 MB (329719919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b390a36ee94fbe8909abdcca30a463fbf29b930039128d0c11cdf8b17c74aba9`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:50:34 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:50:34 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:50:34 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:50:40 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
...
-	Layers:
	...
	-	`sha256:0f756d273d3a7ebf851fc846ceea8365b829a0efead380ba06ed22525a78bf24`  
		...
		Size: 242.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c11dde0f3358e9ff029bded5101af39b7041ed36bb1eb66eb4d985ad44e95ba4`  
		Last Modified: Mon, 02 Aug 2021 20:00:45 GMT  
		Size: 2.4 MB (2356215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-stretch` - linux; 386

```console
$ docker pull python@sha256:3c3efbba42095845983403d0737b0c40b11a3cee16436746e6b882548830eb9b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.0 MB (356001982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b70ee992dcacf8f1bb045e09f3db16b078c95966ee3baa9d825a806d2cfc94d5`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:e3b7744fc7a1290c8852f6bcb1bf04e9e221d685c1efc0d3eb06e17f6169399c`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1bc08d1d8a3bc5a3dadcbac4eaf99085f4072c1b9468999f4c9c393fbd2d6ee`  
		Last Modified: Mon, 02 Aug 2021 20:00:06 GMT  
