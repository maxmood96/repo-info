...
```console
$ docker pull python@sha256:3f432962c96f67110cb8001b995994ec11598dcb9c56a125745a43b374d968a2
```
...
```console
$ docker pull python@sha256:862bab743d8e3faf9e2f70d9755e359cab14a9e6b1d65116b996ef4ae4ee3b1a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.7 MB (348734168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2fd40df1158fbfe41f7e5205c400567f0ccf4babf8001271d9415ff6aec9452`
...
# Tue, 29 Jun 2021 01:47:22 GMT
ENV PYTHON_PIP_VERSION=21.1.3
# Tue, 29 Jun 2021 01:47:22 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Tue, 29 Jun 2021 01:47:22 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Tue, 29 Jun 2021 01:47:29 GMT
...
-	Layers:
	...
	-	`sha256:e406effc43512e96546475404a2a879849e7a54bd1b533fffc27ad88eccd0cf8`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48bd5edcd625d2edc3b86b173e96bb90d5e0fca1f4a91a2d7ba1ab86ecfce520`  
...
```console
$ docker pull python@sha256:a03a991ef1752fda3918cd65cd9c2d2fe8f8b0e7d9d74ed48f7193911e2b772c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.2 MB (319213337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e97b6b8db4c6407036827a5e7f21b6492dc05476360062779fb0588baff0d75d`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 29 Jun 2021 01:26:24 GMT
ENV PYTHON_PIP_VERSION=21.1.3
# Tue, 29 Jun 2021 01:26:24 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Tue, 29 Jun 2021 01:26:25 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
...
-	Layers:
	...
	-	`sha256:1526a9fd64439a18b34ea8a5970c186fab17893798f7458752eb6bfd68b22f73`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e20f215384fb9e7b26801ba230e9db28200aeca93318d42ac9380d708998c310`  
		Last Modified: Tue, 29 Jun 2021 02:12:11 GMT  
		Size: 2.3 MB (2348942 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-stretch` - linux; arm64 variant v8

```console
$ docker pull python@sha256:a2048b6eed5e1649d2ce50ff1e5370cbb3c88de246d9523f388fe79c1a95d7e6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.7 MB (329695036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1ada9a851e7d33146f2e8b25c725816c5e2b8ef71c51c452602e2980afbe7ac`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 28 Jun 2021 23:56:19 GMT
ENV PYTHON_PIP_VERSION=21.1.3
# Mon, 28 Jun 2021 23:56:19 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 28 Jun 2021 23:56:19 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 28 Jun 2021 23:56:25 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 28 Jun 2021 23:56:25 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:db7c611e30690167e49f2a000253af90f739da579b4880142f862f4ddce9ad6b`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4442bd1313a58dbeee04966e06f71a85bae069791ff76b1bee04dfb34e24b7`  
		Last Modified: Tue, 29 Jun 2021 00:22:35 GMT  
		Size: 2.3 MB (2348821 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.7-stretch` - linux; 386

```console
$ docker pull python@sha256:64fd931be97a192ee60a6defada19a862b347949c41b9cadff085432aec7f23a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.0 MB (355975225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a97c0a2b090d62afa1d4ae755240cbfb07d0be85f35f280e13383baa38384da6`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:4ac229f9aeea59e6f87270d09f984428fe801882bab2a3ac74e0e183690cf482`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f138f5e0b22a8eae9488d35581d286ea63139b30d2439b65faa4dd0785f66dd`  
		Last Modified: Tue, 29 Jun 2021 03:15:37 GMT  
		Size: 2.3 MB (2348842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
