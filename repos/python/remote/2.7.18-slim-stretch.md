...
```console
$ docker pull python@sha256:0dca6ceb44a978b1411ba11bf277c3185e3d60455d8eade4ffbbef314b444944
```
...
### `python:2.7.18-slim-stretch` - linux; ppc64le

```console
$ docker pull python@sha256:416633db40e158f504f5584bea8df9fbcf0e7c351489155ace6a35fdee94d737
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.4 MB (45410085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d99819fe099201e776dae07fbe5059961abe8341da9a72a66c1f61dbba4a40d`
-	Default Command: `["python2"]`
