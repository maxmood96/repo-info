...
```console
$ docker pull python@sha256:1a67359fdf62bbd31029a302f5fb305b4f1d4eb394f1cd561eb00b7498f056e9
```
...
```console
$ docker pull python@sha256:73de5282c0602da151163dea9cd0884534ea9734982675b41bd258ee97295f0d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.6 MB (315583216 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:598b1b4bad943a348532918ac3111a418e60670389ac381cb4bf2ec438a1e5b2`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:09:11 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:09:28 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:09:29 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d0dba981d13be407f6021fa929e27f56c015965a78c89ddef4d6a71691c0c144`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5048e81aadeac9ee8a2abe1bf683fc292cca601ac4a8e4ff822658c4c42b078`  
		Last Modified: Wed, 29 Apr 2020 18:14:11 GMT  
...
```console
$ docker pull python@sha256:883eda28b6209bea6bd35745fa7e8e3ebbf4f20cf8d7c949a1c83c58b31565a0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.2 MB (307163517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9550739b2ae3a74c66b081032bd00d38c5bd0213c8b54297f659c8043545f63`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 17:26:14 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 17:26:28 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 17:26:30 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:3d40d7d6f9d1cb836c12b7d77b6d34a0b21ea7cd739bf345844a3ad45fa79e5c`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7c743f8b5fca826ca7ac8b36489b1df78ea4213d2785413595fc836760bfc98`  
		Last Modified: Wed, 29 Apr 2020 17:33:04 GMT  
...
```console
$ docker pull python@sha256:7167af510ffffeb68f7afecede7cf02bbfd23ccc89795895ba683463aae69dfc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.0 MB (334040259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3e7ede8d57f2cd0db2ccbc5120802217525e47ea9afb6ee1e7b079a50fa1dfc`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Wed, 29 Apr 2020 18:10:13 GMT
ENV PYTHON_PIP_VERSION=20.1
# Wed, 29 Apr 2020 18:10:14 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/1fe530e9e3d800be94e04f6428460fc4fb94f5a9/get-pip.py
# Wed, 29 Apr 2020 18:10:15 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:10:34 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:10:36 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:0f8e5e081f473512be0be0b321a06922511c111325c7d5d36a699064e7af4c76`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a84358989a7c584a13353d74b26868c5bdd89b55d161ff1dba3b117b680ccef9`  
		Last Modified: Wed, 29 Apr 2020 18:17:29 GMT  
		Size: 1.9 MB (1931422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:73cccfc40155112d49d5f615ffd9efab8fcf5c31bd335bf7be7bd78ebf9c94fb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.1 MB (326110463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e4ec1ed48d1b4fcf687dcdd70e67df3322234f8cc3871ef5738cf97250bf5df`
-	Default Command: `["python3"]`
...
# Wed, 29 Apr 2020 18:03:41 GMT
ENV PYTHON_GET_PIP_SHA256=ce486cddac44e99496a702aa5c06c5028414ef48fdfd5242cd2fe559b13d4348
# Wed, 29 Apr 2020 18:03:49 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Wed, 29 Apr 2020 18:03:50 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:4737b58fa3952ed5328d3896b9b1f892b233212a2d39737c988b1ebf49b40f67`  
		...
		Size: 234.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d79dffbded3c9e6571a9a1bfa5a08a9579820e043e718a5e272d5a4cf00bc84`  
		Last Modified: Wed, 29 Apr 2020 18:08:59 GMT  
		Size: 1.9 MB (1931204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
