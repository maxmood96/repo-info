...
```console
$ docker pull python@sha256:812a654ecdddf3ea96c58e314eec4ea01cab00571009effbf739abc084c68b42
```
...
```console
$ docker pull python@sha256:ef0025a7a9a69237e35398206f3fe8a6c0337436b805856868623422eabe965d
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.8 MB (328771571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f8a4ccb99a55670b2dbc74cf02aa996ddf938f5dbcc90219fd78542c9aa5d6f`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 19 May 2020 20:02:58 GMT
ENV PYTHON_PIP_VERSION=20.1.1
# Tue, 19 May 2020 20:02:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/eff16c878c7fd6b688b9b4c4267695cf1a0bf01b/get-pip.py
# Tue, 19 May 2020 20:02:58 GMT
ENV PYTHON_GET_PIP_SHA256=b3153ec0cf7b7bbf9556932aa37e4981c35dc2a2c501d70d91d2795aa532be79
# Tue, 19 May 2020 20:03:18 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 19 May 2020 20:03:18 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:c8da683d253b255e3f8af7391ff7eb969fcf48d2fa7d104965bbda47d3d8722d`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e06eeb5cc0bec8d14363a4754785d241ed45444529e49b781d3924f662cc463b`  
		Last Modified: Tue, 19 May 2020 20:09:13 GMT  
