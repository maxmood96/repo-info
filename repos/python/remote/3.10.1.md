...
```console
$ docker pull python@sha256:cbf8af0a607089690cbbdcd60da425f2a78ed58a0c267bd5e249fba1d9080121
```
...
### `python:3.10.1` - linux; arm variant v5
...
### `python:3.10.1` - linux; arm variant v7
