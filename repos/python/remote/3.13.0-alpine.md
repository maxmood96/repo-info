...
```console
$ docker pull python@sha256:d4daf858ce04f8e6f9a3f73d036f7a8dbb3b9541dccdb87e93993589449c5b9e
```
...
### `python:3.13.0-alpine` - linux; amd64
...
### `python:3.13.0-alpine` - unknown; unknown
...
### `python:3.13.0-alpine` - linux; arm variant v6
...
### `python:3.13.0-alpine` - linux; arm variant v7
...
### `python:3.13.0-alpine` - linux; arm64 variant v8
...
### `python:3.13.0-alpine` - linux; 386
...
### `python:3.13.0-alpine` - linux; ppc64le
...
### `python:3.13.0-alpine` - linux; s390x
