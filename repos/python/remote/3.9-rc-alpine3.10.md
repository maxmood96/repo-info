...
```console
$ docker pull python@sha256:0e44e589370dee1499d8a5f88a74b385b8c72cd331e1982237637f58684fc830
```
...
```console
$ docker pull python@sha256:cdf0b5fb1ee29d63423cbf92bafeb0f06944b7d4eb3cce2177848ad2903e5a99
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.7 MB (35687507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6c827f156e1bd496eedd21b34a0e08dbff77ff608fa0c00cb011ae0aedc51ae`
...
# Thu, 06 Feb 2020 01:36:18 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 01:36:18 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 01:36:24 GMT
...
-	Layers:
	...
	-	`sha256:ead16a540d050d1244f068476a8aadb5e03428c3cb6d376b23f1345a524b4198`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7b1d3a9614f6056d6334e4dd8dc936e7d5e367a34516e405726868697b2ce09`  
		Last Modified: Thu, 06 Feb 2020 01:43:21 GMT  
		Size: 1.9 MB (1892133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; arm variant v6

```console
$ docker pull python@sha256:13f832fc92bcb64d46eee75c6c6f9b655ee3e9be8c7d37f13c22b3e594a9e4e3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.1 MB (33052822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13251f15ab9ab9ec4755ca41a69665f50f870af17e95d926cae04ee0896a92bd`
-	Default Command: `["python3"]`
...
# Tue, 28 Jan 2020 01:27:30 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 01:37:40 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 01:37:41 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 01:38:07 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 01:38:09 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:9c9c9a9394a896ac88485b9c5fc12f488c81a910600f70acbd6f6e516c6b1871`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8cdef38e2cc9d06bf36338c95bf5cbb1ed213b0325addda6070351c240af53d`  
		Last Modified: Thu, 06 Feb 2020 01:43:53 GMT  
		Size: 1.9 MB (1892479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; arm variant v7

```console
$ docker pull python@sha256:c2de77ecad0d460cf8247d5b5f735eb82cfc0c06836d45bcbc5caa697917034b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32293969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dc99d394cfbd0be3cb255add0b23e11ea471cc83bf364425729f30c78852842`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 02:14:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 02:14:13 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 02:14:27 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 02:14:29 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:d50619550316bab8eadb70d7f2f68145579b00343d0c9cb6884129f718c7a851`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf884a1d8cf8f3cb0d55295172424735443bf86c09b440643b8e2d69129590ad`  
		Last Modified: Thu, 06 Feb 2020 02:31:33 GMT  
		Size: 1.9 MB (1892451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; arm64 variant v8

```console
$ docker pull python@sha256:96cf443862419d9b5de885a007f1c2be50fb7a27e0282d7c4df1db9b8b08eec3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34789814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75214a7f489d0eb8528e74d8c12887cd778dbf4ab0971c79960603eada4c2ae6`
-	Default Command: `["python3"]`
...
# Tue, 28 Jan 2020 01:32:39 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 01:50:08 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 01:50:09 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 01:50:23 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 01:50:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:f749fdcc34639b7a92a6029d84953ac4d0021505e2711c30620c3b04e89ae814`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aabfdbe0514df68cbb2013402404da362ca06e6f678bf77673be8a279cc40e9c`  
		Last Modified: Thu, 06 Feb 2020 02:09:46 GMT  
		Size: 1.9 MB (1892467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; 386

```console
$ docker pull python@sha256:a63000d4650275ac9e3ee571bd655f0c94340f0457e0f83459bfe7828f5a3498
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 MB (34082764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c87462956d7b79386e427ecff618e7eb217826c88803802b1dc3641675521a5c`
-	Default Command: `["python3"]`
...
# Tue, 28 Jan 2020 01:19:04 GMT
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 00:46:46 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 00:46:46 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 00:46:53 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 00:46:53 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:2a55483957885b6ab79c15726d9d55e0f873d6d9b9224c91a959c3628af26c76`  
		...
		Size: 230.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e27535017ee6faf15295daa6f9fb565ca5ebf1d62e7ae76fd16e15d94047150`  
		Last Modified: Thu, 06 Feb 2020 00:55:31 GMT  
		Size: 1.9 MB (1892232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; ppc64le

```console
$ docker pull python@sha256:620ebfd18d0d38b2184e051356287edb36ba683a5d6aebbda29bc14d687e0746
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.7 MB (36672600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f6addd2fb603356a655ca837869895b4714fe6acbca24fc21480723024b0906`
-	Default Command: `["python3"]`
...
ENV PYTHON_PIP_VERSION=20.0.2
# Thu, 06 Feb 2020 01:24:23 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/d59197a3c169cef378a22428a3fa99d33e080a5d/get-pip.py
# Thu, 06 Feb 2020 01:24:26 GMT
ENV PYTHON_GET_PIP_SHA256=421ac1d44c0cf9730a088e337867d974b91bdce4ea2636099275071878cc189e
# Thu, 06 Feb 2020 01:24:48 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Thu, 06 Feb 2020 01:24:52 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:cf0c06af0f04ce6b42bf870fb958cd47e33a75752555a8e236659e85bf6841ce`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aea7b06102dffdfb001fa2a4fe34eaf2e547261a0fc26a82ed67e06c437adcb1`  
		Last Modified: Thu, 06 Feb 2020 01:49:56 GMT  
		Size: 1.9 MB (1892412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9-rc-alpine3.10` - linux; s390x

```console
$ docker pull python@sha256:86443f56f76e8059d38773d835861a7ee9693fb60a764fad001e221d66560e6f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.5 MB (35510284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07592275732cf71a54b1646e24fd7f6e4f280d9fb28140672a3b2a9d8bad1d3c`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:232e16fa7f3d0bf26b073fed356bd23a62f5fdd025847d4f8da5d1ba198eb7c2`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c7a8d009a78f2478307d01589e1940933af1566f2d1bc4f415dbed6a9d261a7`  
		Last Modified: Thu, 06 Feb 2020 00:54:06 GMT  
