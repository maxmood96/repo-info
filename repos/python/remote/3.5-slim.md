...
```console
$ docker pull python@sha256:40e7239f857ac84b2a6e93df37cf4f35a8d839f4851803008ea0161cbe14f43c
```
...
```console
$ docker pull python@sha256:9ca41e7a8d0b20e057df6fca5ca4229bd2359a9cc8c63b8a292c96886ff867da
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.3 MB (55284333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:572b161c5820db2c9c3012b6f3ab582bd768e0bd85e9b1b32a574f7fce1055f8`
-	Default Command: `["python3"]`
