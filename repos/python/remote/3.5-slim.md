...
```console
$ docker pull python@sha256:be6105828a8e3d17dc7982fdeee01ba05930af5ed3b62b09ae2dd3989a889ae4
```
...
```console
$ docker pull python@sha256:c6566885d3161b9f0bfd0660d12717221a5c5707ab92591c9e52199636c794b4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.8 MB (61822741 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63d3f910f6d7e62235825e08ca1eaac1d704b9328fce6debc10c943985a5b579`
-	Default Command: `["python3"]`
