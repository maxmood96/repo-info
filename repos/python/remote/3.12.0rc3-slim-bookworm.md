...
### `python:3.12.0rc3-slim-bookworm` - linux; arm variant v7
...
### `python:3.12.0rc3-slim-bookworm` - linux; arm64 variant v8
...
### `python:3.12.0rc3-slim-bookworm` - linux; 386
...
### `python:3.12.0rc3-slim-bookworm` - linux; s390x
