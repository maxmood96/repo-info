...
```console
$ docker pull python@sha256:8b3bf4207cbea183c8fcc71148365e687583379de64ec52a0460f14cd3dece4d
```
...
```console
$ docker pull python@sha256:1d4381ee94e74c25784957d7ba8d5f4b285f502417f4c75b5645694f77a549b0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **15.7 MB (15711885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:987c5687140d1f13f42c168c7c903d5a52f866f08405fd87e344a022a034ece8`
-	Default Command: `["python3"]`
