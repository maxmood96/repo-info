...
```console
$ docker pull python@sha256:ec39662a5d14a895d1e60670186a85f83e7e28992288bd8be0e11b2ca14c1308
```
...
```console
$ docker pull python@sha256:ccdf3d309f3e1f5611138a388f50282face379981408c1638c09d52530e1333b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **14.9 MB (14870300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e2f9d77c127c01bb43cc355797e901997aa0154ddee0c1813fc22ab4b7ba565`
-	Default Command: `["python3"]`
