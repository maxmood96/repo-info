...
```console
$ docker pull python@sha256:06596a93e12c05ea61c816bf5cce8221c441346f9273ec08a3ef5de50aa75c4a
```
...
```console
$ docker pull python@sha256:19f73152663f54758df56dda36e5462543dbfa7ebdd180d55f5571edc75f7965
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.2 MB (37153841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:586db39823918cc380b2c7eec7c3e13615317b9263753afcabfea152714e65be`
...
```console
$ docker pull python@sha256:ce080cc141811293a9f06c5ab64f35d4af69ee53be0d5571b54a12387cb9341a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.9 MB (32895929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84a3107b74939782c9c9dd9034e8098728a0dc8fad20ea4884d8134ce67a2be3`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:a143604c636b9d7fcfc52e3f9b9058e13bb813b70709d0a4e297f3972e0d248b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.4 MB (34446377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0aa3b69fda6d886cc9a47a8e96695111226b26a1ef455566857523d598c62f1`
-	Default Command: `["python3"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 29 Jun 2021 00:07:37 GMT
ENV PYTHON_PIP_VERSION=21.1.3
# Tue, 29 Jun 2021 00:07:37 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Tue, 29 Jun 2021 00:07:38 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Tue, 29 Jun 2021 00:07:51 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 29 Jun 2021 00:07:51 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:ef0a1fda9aa6c0ed7257b2d62fe7c1f26c2c67512a3b0ae6cc02bf6c7634b0db`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6460300b5ca2758a42853e24dfc396d7fd9f127c8d067125494f618677eaf37`  
		Last Modified: Tue, 29 Jun 2021 00:24:15 GMT  
		Size: 2.5 MB (2486568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.6-slim-stretch` - linux; 386

```console
$ docker pull python@sha256:6e1ca7928286802e265855ce7dcc245a1e51f1dde39fa0cfa8d659c003b4985a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.9 MB (37865999 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39300968563ec6edbb1bd68a021228c362ef247e050c27353001ad23508182da`
-	Default Command: `["python3"]`
