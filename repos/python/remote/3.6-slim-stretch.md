...
```console
$ docker pull python@sha256:b697bc735a06a6b027f9d1707de44e8e85a96f35923c1a28a968996998c62a88
```
...
```console
$ docker pull python@sha256:fbde88484c53b1df705044992e71c8de2002bdfbc4de45beccf64112c4251e59
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.0 MB (35005141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6b84e153270e46bc1dbede2b683758ef72a9ddc850c6548ebcc750c42ac8c40`
-	Default Command: `["python3"]`
...
ENV PYTHON_GET_PIP_SHA256=2250ab0a7e70f6fd22b955493f7f5cf1ea53e70b584a84a32573644a045b4bfb
# Tue, 20 Oct 2020 18:09:23 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 20 Oct 2020 18:09:24 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:283f757db68ce096764c2a27b6aa9dfdc05a82c44837f1e347a785e09cc2488e`  
		...
		Size: 241.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa00c4acd715a861a4c5f53f88380257baa77bf8fbc5837ddd186eef06f1f991`  
		Last Modified: Tue, 20 Oct 2020 18:13:50 GMT  
		Size: 2.4 MB (2403916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull python@sha256:7a2158790bcf59c6dfd336fc1d6b5e284120adaf5bad0728ee655b9805418af1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.8 MB (37755799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c53ed4805bda9f61157b17e9c26507fd9d7798ef48645a8ad6d587a3b7e207b4`
-	Default Command: `["python3"]`
...
-	Layers:
	...
	-	`sha256:77cdcb2b7f61dce0296a020b06789f7c41d05f7900e904dec810d726913427a5`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17298469804e65399754d302418e2cc9e1137e49dae6a3b78f99cf0ede0ef545`  
		Last Modified: Tue, 20 Oct 2020 17:57:19 GMT  
