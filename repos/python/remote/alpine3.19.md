...
```console
$ docker pull python@sha256:1bf8e10904181a535546cb14980ca635fec33d944a097ce786f9fc34d6cff20c
```
...
```console
$ docker pull python@sha256:d0f288ace8e3912faaa9eb5451af6ff74d87a2758a1a7c5f957038a9ef8f99d5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.5 MB (18502049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1eed4f5616ad60f33d1ac48bfc45cd7202fc8166fe205c785329387a9e93a061`
-	Default Command: `["python3"]`
