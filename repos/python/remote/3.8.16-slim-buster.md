...
```console
$ docker pull python@sha256:b6625da729591bb6a922bcefc903668dd977d353492e53fbe9d399b9f41be32b
```
...
```console
$ docker pull python@sha256:1727f749166a28ffe4eabb875258c2209053f1a23178ae1cb246eb62fc432d5b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.7 MB (44713324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02cf77301ce9d42900abb381118f2a5d9a9b8eadcf4d91c4ba72d7ad95134b19`
-	Default Command: `["python3"]`
