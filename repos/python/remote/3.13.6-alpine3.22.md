...
### `python:3.13.6-alpine3.22` - linux; amd64
...
### `python:3.13.6-alpine3.22` - unknown; unknown
...
### `python:3.13.6-alpine3.22` - linux; arm variant v6
...
### `python:3.13.6-alpine3.22` - linux; arm variant v7
...
### `python:3.13.6-alpine3.22` - linux; arm64 variant v8
...
### `python:3.13.6-alpine3.22` - linux; 386
...
### `python:3.13.6-alpine3.22` - linux; ppc64le
...
### `python:3.13.6-alpine3.22` - linux; riscv64
...
### `python:3.13.6-alpine3.22` - linux; s390x
