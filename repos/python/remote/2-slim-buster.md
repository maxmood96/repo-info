...
```console
$ docker pull python@sha256:05e4ce6c44bcfc6e6797ef132a0bc3f650758c2fb98c4482cccc876762bfe967
```
...
```console
$ docker pull python@sha256:695cf766eb0dae4000c2e4bbb1ecd2aa0afe5fde42eddf732de5e56c6ef09d72
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (50032665 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df921c85682194e99cdb71466336b544b73a7b4ad2b75eb2890d7d8ecf0e0d62`
-	Default Command: `["python2"]`
