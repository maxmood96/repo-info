...
### `python:3.13.7-slim-bookworm` - linux; arm variant v5
...
### `python:3.13.7-slim-bookworm` - linux; arm variant v7
...
### `python:3.13.7-slim-bookworm` - linux; ppc64le
...
### `python:3.13.7-slim-bookworm` - linux; s390x
