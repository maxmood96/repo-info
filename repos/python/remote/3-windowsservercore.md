...
```console
$ docker pull python@sha256:eacddf39600cae507bc456264712b6459ad72bfbde069df368c5d186a2132384
```
...
### `python:3-windowsservercore` - windows version 10.0.20348.2113; amd64
...
### `python:3-windowsservercore` - windows version 10.0.17763.5122; amd64
