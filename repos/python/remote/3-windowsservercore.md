...
```console
$ docker pull python@sha256:2aa03cf57d6cd668ddcf197975061c0588b32930479356692e6522ada9e9f316
```
...
### `python:3-windowsservercore` - windows version 10.0.26100.4946; amd64
...
### `python:3-windowsservercore` - windows version 10.0.20348.4052; amd64
