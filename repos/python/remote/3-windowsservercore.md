...
```console
$ docker pull python@sha256:b5184ab0fc6ab4370b17c01adfb7cd98a7874e5d3ce71d8f98ebaf47d0b9d9ee
```
...
### `python:3-windowsservercore` - windows version 10.0.26100.3194; amd64
