...
```console
$ docker pull python@sha256:0b1874422f63a886b3ac574a6be69251d78c0ed9892d76ed31c868b2046fb129
```
...
### `python:3-windowsservercore` - windows version 10.0.26100.32690; amd64
...
### `python:3-windowsservercore` - windows version 10.0.20348.5020; amd64
