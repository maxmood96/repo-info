...
```console
$ docker pull python@sha256:d9e8d6f3fe5ec4eb8a5cab779f3fffc2672cd0729925389c741712e944326589
```
...
### `python:3-windowsservercore` - windows version 10.0.20348.2849; amd64
...
### `python:3-windowsservercore` - windows version 10.0.17763.6532; amd64
