...
### `python:3.11.7-alpine3.18` - linux; amd64
...
### `python:3.11.7-alpine3.18` - linux; arm variant v6
...
### `python:3.11.7-alpine3.18` - linux; arm variant v7
...
### `python:3.11.7-alpine3.18` - linux; arm64 variant v8
...
### `python:3.11.7-alpine3.18` - linux; 386
...
### `python:3.11.7-alpine3.18` - linux; ppc64le
...
### `python:3.11.7-alpine3.18` - linux; s390x
