...
```console
$ docker pull python@sha256:0ddccce8820c89f39cde6c482b3ba8bcad9e6652a060c329b7b963112df0b8e7
```
...
```console
$ docker pull python@sha256:1724b17cbf37548616325811484dd5a60351ab06bca4c5367b5c297c5e193e01
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **16.0 MB (15993532 bytes)**  
