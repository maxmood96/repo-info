...
```console
$ docker pull python@sha256:f815fb70eb02e51e341e3697b8fb974bf69bb7c9c6c933c7dffae6f32f37a5e9
```
...
### `python:3.12.6-bookworm` - linux; amd64
...
### `python:3.12.6-bookworm` - unknown; unknown
...
### `python:3.12.6-bookworm` - linux; arm variant v5
...
### `python:3.12.6-bookworm` - linux; arm variant v7
...
### `python:3.12.6-bookworm` - linux; arm64 variant v8
...
### `python:3.12.6-bookworm` - linux; 386
...
### `python:3.12.6-bookworm` - linux; ppc64le
...
### `python:3.12.6-bookworm` - linux; s390x
