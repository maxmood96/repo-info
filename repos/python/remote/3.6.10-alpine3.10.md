...
```console
$ docker pull python@sha256:816dc2c62f1bd458061ab8e0d127631603913c1a278e69f5ee25a026a1393499
```
...
```console
$ docker pull python@sha256:cb01acdfb724f5a3ae3f5f0f61958f025b765dd6df3300d933f24da1de6eef48
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.6 MB (31594686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ace9e8c2e7e4e2597d2d8354764e60652afc7d8157b42f25f65a89bb929840a8`
-	Default Command: `["python3"]`
