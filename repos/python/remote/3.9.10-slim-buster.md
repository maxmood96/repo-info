...
```console
$ docker pull python@sha256:d90ad6665b82b308eafc0ac599ba388e3a07c70ce159bfe7eb8f0283ac8d1dfe
```
...
```console
$ docker pull python@sha256:8aa59c672fa30f9e1dbbe8b3b7b8e2cd3275c4c0900307461b2115ace26f1a3a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.5 MB (41471920 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a55f270f8f92d3c845804bb3326e92cf7e7595c2320c19d956cb9d7bfe35711c`
-	Default Command: `["python3"]`
