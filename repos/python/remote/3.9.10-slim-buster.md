...
```console
$ docker pull python@sha256:7d0884a75438f45b87fd0c0be832399471bc7319ebeaa2820a69da0e9e7db54d
```
...
```console
$ docker pull python@sha256:e50fd4ded9de59ef4e4e63a12996d0bae461ce1ae1f64728ec3d1076546d331c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.6 MB (43574140 bytes)**  
...
```console
$ docker pull python@sha256:ff08e45a875add33dc8efd4f7b3f662faa69fedc19f15d1dc9cefd2f6898471c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.7 MB (40668316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6719e6a63fda636ac33b22da745dbda1510785e22003f02d6ba15f38d9bfba29`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:9a83ebd161255ea489e5775cf0490e132c371e1e23eb1e70fecf53a697f0357e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.0 MB (37963159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2661f930def25d6e7550812a6ae609220ab0e4a836b80055000a903d2df5e487`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:c9a21a5d59b3a3d36d314691208a28e7695eb518d7353a65f3ba936c82bd7606
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.0 MB (41994911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a7af33593f9b559328ca1859392188047b0086192898dff17bcbce6c0cba985`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:a0e4f1318f49c0629d0009911aa5caf7b5d4876e7be7d415107727f59e9ca592
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.4 MB (44368219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f097e82b1cc5fc5166a0ea74590db2715293f13dec6f342417421d866258fe7d`
-	Default Command: `["python3"]`
...
```console
$ docker pull python@sha256:3be67472cd25d3bd60123832eb88bc188b55863616a31b6d81a00ff11dd5c8e3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.7 MB (41680634 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49782634783c5f7faca8b8ac2f87c95421605792ca785bb12b1ef8de6f347188`
-	Default Command: `["python3"]`
...
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 		wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz"; 	wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc"; 	GNUPGHOME="$(mktemp -d)"; export GNUPGHOME; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY"; 	gpg --batch --verify python.tar.xz.asc python.tar.xz; 	command -v gpgconf > /dev/null && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" python.tar.xz.asc; 	mkdir -p /usr/src/python; 	tar --extract --directory /usr/src/python --strip-components=1 --file python.tar.xz; 	rm python.tar.xz; 		cd /usr/src/python; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	; 	nproc="$(nproc)"; 	make -j "$nproc" 		LDFLAGS="-Wl,--strip-all" 	; 	make install; 		cd /; 	rm -rf /usr/src/python; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 		\) -exec rm -rf '{}' + 	; 		ldconfig; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python3 --version
# Wed, 02 Mar 2022 11:28:53 GMT
RUN set -eux; 	for src in idle3 pydoc3 python3 python3-config; do 		dst="$(echo "$src" | tr -d 3)"; 		[ -s "/usr/local/bin/$src" ]; 		[ ! -e "/usr/local/bin/$dst" ]; 		ln -svT "/usr/local/bin/$src" "/usr/local/bin/$dst"; 	done
# Wed, 02 Mar 2022 11:28:54 GMT
ENV PYTHON_PIP_VERSION=21.2.4
# Wed, 02 Mar 2022 11:28:54 GMT
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Wed, 02 Mar 2022 11:28:54 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2caf84b14febcda8077e59e9b8a6ef9a680aa392/public/get-pip.py
# Wed, 02 Mar 2022 11:28:55 GMT
ENV PYTHON_GET_PIP_SHA256=7c5239cea323cadae36083079a5ee6b2b3d56f25762a0c060d2867b89e5e06c5
# Wed, 02 Mar 2022 11:29:39 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 02 Mar 2022 11:29:40 GMT
CMD ["python3"]
```
...
-	Layers:
	...
	-	`sha256:490725008c9002983bdf754bcbe4d31879dc968428bf218b08c9776ac2029d78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1392e52ffe3e98c261a682bfd42a89057e4b2575ac43b33032b33f6ea473a274`  
		Last Modified: Wed, 02 Mar 2022 17:12:02 GMT  
		Size: 10.9 MB (10905882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34b5310bd430092faf3e60ce492792792d124043173a19c5f3759f603402bd34`  
		Last Modified: Wed, 02 Mar 2022 17:11:55 GMT  
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaf4d62691f6300bf264a83e903f20f7444c826ccb0bf2174bad34763f0a9305`  
		Last Modified: Wed, 02 Mar 2022 17:11:57 GMT  
		Size: 2.6 MB (2632897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `python:3.9.10-slim-buster` - linux; ppc64le

```console
$ docker pull python@sha256:86844f4d5f0565ce32485e223f377776278e622c5ba0d2235d167d4eaf2f8b76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47932867 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:118b5ea91ce61bde1ae478d619eb988a42fcbecf2ad40abe71f97a24ecca54b3`
-	Default Command: `["python3"]`
