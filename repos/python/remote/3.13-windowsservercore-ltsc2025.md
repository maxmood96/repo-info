...
```console
$ docker pull python@sha256:5eb12cb3f73ffe4ee1a3e5be2db3a52c251fe05705713570c92a9f4bf1580c6a
```
...
### `python:3.13-windowsservercore-ltsc2025` - windows version 10.0.26100.32230; amd64
