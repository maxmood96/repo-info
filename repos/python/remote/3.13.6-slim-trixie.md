...
### `python:3.13.6-slim-trixie` - linux; amd64
...
### `python:3.13.6-slim-trixie` - unknown; unknown
...
### `python:3.13.6-slim-trixie` - linux; arm variant v5
...
### `python:3.13.6-slim-trixie` - linux; arm variant v7
...
### `python:3.13.6-slim-trixie` - linux; arm64 variant v8
...
### `python:3.13.6-slim-trixie` - linux; 386
...
### `python:3.13.6-slim-trixie` - linux; ppc64le
...
### `python:3.13.6-slim-trixie` - linux; riscv64
...
### `python:3.13.6-slim-trixie` - linux; s390x
