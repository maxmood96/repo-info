...
```console
$ docker pull python@sha256:778f33381939533ae9bc5a29c7b7cdfddab247a695724fc6a1ab8b42d44fd82c
```
...
```console
$ docker pull python@sha256:4fdebae3ff0ad8932763313c2d8a5956456cac0c0e4505b00557085b66264fc0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.5 MB (17488224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5d4dad373626015ba0d0327128d0940832efa040c27636753bd023f2b3405d7`
-	Default Command: `["python3"]`
