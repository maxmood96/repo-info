...
```console
$ docker pull python@sha256:496fca1d018bccb0ba594399873949d4de93f5fe989278f59028065894783454
```
...
```console
$ docker pull python@sha256:268e289a27f48091f0bd98550917051b9978e0d9128f2ba2140c31298c127d39
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.7 MB (17659913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9709710f1171d419a2be4fbada385dacedb271edf9ac7a1f66e17a9bf57c049a`
-	Default Command: `["python3"]`
