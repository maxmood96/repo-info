...
```console
$ docker pull python@sha256:700f4b48c6e679fa7dcbea8ccbebb69451a6f537526e06d514549277c9f5bac0
```
...
### `python:3.10.11-alpine3.18` - linux; amd64
...
### `python:3.10.11-alpine3.18` - linux; arm variant v6
...
### `python:3.10.11-alpine3.18` - linux; arm variant v7
...
### `python:3.10.11-alpine3.18` - linux; arm64 variant v8
...
### `python:3.10.11-alpine3.18` - linux; 386
...
### `python:3.10.11-alpine3.18` - linux; ppc64le
