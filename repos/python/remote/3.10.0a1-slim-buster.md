...
```console
$ docker pull python@sha256:85820bf4110e1f6f43c36ec3942de7b6ffa268d50a2adae9b2f8d683d35375bb
```
...
### `python:3.10.0a1-slim-buster` - linux; amd64
...
### `python:3.10.0a1-slim-buster` - linux; arm variant v5
...
### `python:3.10.0a1-slim-buster` - linux; arm variant v7
...
### `python:3.10.0a1-slim-buster` - linux; arm64 variant v8
...
### `python:3.10.0a1-slim-buster` - linux; 386
...
### `python:3.10.0a1-slim-buster` - linux; mips64le
...
### `python:3.10.0a1-slim-buster` - linux; ppc64le
...
### `python:3.10.0a1-slim-buster` - linux; s390x
