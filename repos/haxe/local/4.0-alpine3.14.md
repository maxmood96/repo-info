...
- Created: `2023-03-29T21:52:58.113860431Z`
...
```console
cups-libs-2.3.3-r3 description:
CUPS libraries

cups-libs-2.3.3-r3 webpage:
https://www.cups.org/

cups-libs-2.3.3-r3 installed size:
564 KiB

cups-libs-2.3.3-r3 license:
GPL-2.0-only
...
```console
gdk-pixbuf-2.42.6-r1 description:
GTK+ image loading library

gdk-pixbuf-2.42.6-r1 webpage:
https://wiki.gnome.org/Projects/GdkPixbuf

gdk-pixbuf-2.42.6-r1 installed size:
528 KiB

gdk-pixbuf-2.42.6-r1 license:
LGPL-2.0-or-later
...
```console
libtasn1-4.17.0-r1 description:
The ASN.1 library used in GNUTLS

libtasn1-4.17.0-r1 webpage:
https://www.gnu.org/software/gnutls/

libtasn1-4.17.0-r1 installed size:
88 KiB

libtasn1-4.17.0-r1 license:
LGPL-2.1-or-later
...
```console
pkgconf-1.7.4-r1 description:
development framework configuration tools

pkgconf-1.7.4-r1 webpage:
https://git.sr.ht/~kaniini/pkgconf

pkgconf-1.7.4-r1 installed size:
140 KiB

pkgconf-1.7.4-r1 license:
ISC
