...
- Created: `2023-08-09T00:54:21.451079056Z`
- Virtual Size: ~ 94.08 Mb  
...
```console
cups-libs-2.4.2-r3 description:
CUPS libraries

cups-libs-2.4.2-r3 webpage:
https://github.com/OpenPrinting/cups/

cups-libs-2.4.2-r3 installed size:
572 KiB

cups-libs-2.4.2-r3 license:
GPL-2.0-only
...
```console
mbedtls-2.28.4-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.4-r0 webpage:
https://tls.mbed.org/

mbedtls-2.28.4-r0 installed size:
736 KiB

mbedtls-2.28.4-r0 license:
Apache-2.0
