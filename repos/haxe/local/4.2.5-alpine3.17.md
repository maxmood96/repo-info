...
- Created: `2024-07-25T21:23:41.883614274Z`
- Virtual Size: ~ 103.62 Mb  
...
```console
at-spi2-core-2.46.0-r0 description:
Protocol definitions and daemon for D-Bus at-spi

at-spi2-core-2.46.0-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-2.46.0-r0 installed size:
456 KiB

at-spi2-core-2.46.0-r0 license:
LGPL-2.0-or-later
...
```console
glib-2.74.7-r0 description:
Common C routines used by Gtk+ and other libs

glib-2.74.7-r0 webpage:
https://developer.gnome.org/glib/

glib-2.74.7-r0 installed size:
3396 KiB

glib-2.74.7-r0 license:
LGPL-2.1-or-later
...
```console
gtk+3.0-3.24.41-r0 description:
The GTK+ Toolkit (v3)

gtk+3.0-3.24.41-r0 webpage:
https://www.gtk.org/

gtk+3.0-3.24.41-r0 installed size:
9 MiB

gtk+3.0-3.24.41-r0 license:
LGPL-2.1-or-later
...
```console
libatk-bridge-2.0-2.46.0-r0 description:
GTK+2.0 module that bridges ATK to D-Bus at-spi

libatk-bridge-2.0-2.46.0-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-bridge-2.0-2.46.0-r0 installed size:
272 KiB

libatk-bridge-2.0-2.46.0-r0 license:
LGPL-2.0-or-later
...
```console
libepoxy-1.5.10-r0 description:
Direct Rendering Manager runtime library

libepoxy-1.5.10-r0 webpage:
https://github.com/anholt/libepoxy

libepoxy-1.5.10-r0 installed size:
1100 KiB

libepoxy-1.5.10-r0 license:
MIT
...
```console
libwebp-1.2.4-r3 description:
Libraries for working with WebP images

libwebp-1.2.4-r3 webpage:
https://developers.google.com/speed/webp

libwebp-1.2.4-r3 installed size:
584 KiB

libwebp-1.2.4-r3 license:
BSD-3-Clause
...
```console
libxinerama-1.1.5-r0 description:
X11 Xinerama extension library

libxinerama-1.1.5-r0 webpage:
http://xorg.freedesktop.org/

libxinerama-1.1.5-r0 installed size:
28 KiB

libxinerama-1.1.5-r0 license:
MIT
...
```console
libxkbcommon-1.4.1-r0 description:
keyboard handling library

libxkbcommon-1.4.1-r0 webpage:
https://www.xkbcommon.org/

libxkbcommon-1.4.1-r0 installed size:
296 KiB

libxkbcommon-1.4.1-r0 license:
MIT
...
```console
libxtst-1.2.4-r0 description:
X11 Testing -- Resource extension library

libxtst-1.2.4-r0 webpage:
https://wiki.freedesktop.org/xorg/

libxtst-1.2.4-r0 installed size:
40 KiB

libxtst-1.2.4-r0 license:
custom
...
```console
mbedtls-2.28.8-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.8-r0 webpage:
https://tls.mbed.org/

mbedtls-2.28.8-r0 installed size:
744 KiB

mbedtls-2.28.8-r0 license:
Apache-2.0
...
```console
wayland-libs-client-1.21.0-r1 description:
A computer display server protocol (client library)

wayland-libs-client-1.21.0-r1 webpage:
https://wayland.freedesktop.org

wayland-libs-client-1.21.0-r1 installed size:
68 KiB

wayland-libs-client-1.21.0-r1 license:
MIT
...
```console
wayland-libs-cursor-1.21.0-r1 description:
A computer display server protocol (cursor library)

wayland-libs-cursor-1.21.0-r1 webpage:
https://wayland.freedesktop.org

wayland-libs-cursor-1.21.0-r1 installed size:
44 KiB

wayland-libs-cursor-1.21.0-r1 license:
MIT
...
```console
wayland-libs-egl-1.21.0-r1 description:
A computer display server protocol (egl library)

wayland-libs-egl-1.21.0-r1 webpage:
https://wayland.freedesktop.org

wayland-libs-egl-1.21.0-r1 installed size:
28 KiB

wayland-libs-egl-1.21.0-r1 license:
MIT
...
```console
xkeyboard-config-2.37-r0 description:
X keyboard configuration files

xkeyboard-config-2.37-r0 webpage:
https://github.com/freedesktop/xkeyboard-config

xkeyboard-config-2.37-r0 installed size:
4048 KiB

xkeyboard-config-2.37-r0 license:
MIT
