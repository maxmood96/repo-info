...
### `dpkg` source package: `libgc=1:8.2.2-3`

Binary Packages:

- `libgc1:amd64=1:8.2.2-3`
...
```console
$ apt-get source -qq --print-uris libgc=1:8.2.2-3
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_8.2.2-3.dsc' libgc_8.2.2-3.dsc 1910 SHA256:99eebbbf9f5a8fe659504f8cf7c26bc3a43fbe766d2c3b5ad3dfe8997a9a62ff
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_8.2.2.orig.tar.gz' libgc_8.2.2.orig.tar.gz 1200115 SHA256:f30107bcb062e0920a790ffffa56d9512348546859364c23a14be264b38836a0
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_8.2.2-3.debian.tar.xz' libgc_8.2.2-3.debian.tar.xz 11480 SHA256:cbd0266c8c355d122d6754a8640e54f42ce2dbe3912fc226980823e9bd0ae3b4
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgc/1:8.2.2-3/ (for browsing the source)
- https://sources.debian.net/src/libgc/1:8.2.2-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgc/1:8.2.2-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mbedtls=2.28.3-1`

Binary Packages:

- `libmbedcrypto7:amd64=2.28.3-1`
- `libmbedtls14:amd64=2.28.3-1`
- `libmbedx509-1:amd64=2.28.3-1`

Licenses: (parsed from: `/usr/share/doc/libmbedcrypto7/copyright`, `/usr/share/doc/libmbedtls14/copyright`, `/usr/share/doc/libmbedx509-1/copyright`)
...
```console
$ apt-get source -qq --print-uris mbedtls=2.28.3-1
'http://deb.debian.org/debian/pool/main/m/mbedtls/mbedtls_2.28.3-1.dsc' mbedtls_2.28.3-1.dsc 1684 SHA256:a8bf91b5ffb40654efb0ebe0c962ac1e87b8eed5e104880982eaa70dd4bb33e3
'http://deb.debian.org/debian/pool/main/m/mbedtls/mbedtls_2.28.3.orig.tar.gz' mbedtls_2.28.3.orig.tar.gz 3952799 SHA256:3b4953aa55a681e084d31892d9904cc5328d6b4958ea57b90ae4b4f94ae69a8d
'http://deb.debian.org/debian/pool/main/m/mbedtls/mbedtls_2.28.3-1.debian.tar.xz' mbedtls_2.28.3-1.debian.tar.xz 15360 SHA256:3e03c61f63c7bbcd0bf695b53e6663ab448cc2e15429cd67d0e4f32e699645a9
```

Other potentially useful URLs:

- https://sources.debian.net/src/mbedtls/2.28.3-1/ (for browsing the source)
- https://sources.debian.net/src/mbedtls/2.28.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mbedtls/2.28.3-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ocaml=4.13.1-4`

Binary Packages:

- `ocaml=4.13.1-4`
- `ocaml-base=4.13.1-4`
- `ocaml-compiler-libs=4.13.1-4`
- `ocaml-interp=4.13.1-4`

Licenses: (parsed from: `/usr/share/doc/ocaml/copyright`, `/usr/share/doc/ocaml-base/copyright`, `/usr/share/doc/ocaml-compiler-libs/copyright`, `/usr/share/doc/ocaml-interp/copyright`)
...
```console
$ apt-get source -qq --print-uris ocaml=4.13.1-4
'http://deb.debian.org/debian/pool/main/o/ocaml/ocaml_4.13.1-4.dsc' ocaml_4.13.1-4.dsc 2245 SHA256:5f41728483f9d233ed146af2f2f44066e01900ca791554d0b176c904d173ea02
'http://deb.debian.org/debian/pool/main/o/ocaml/ocaml_4.13.1.orig.tar.gz' ocaml_4.13.1.orig.tar.gz 5327797 SHA256:66a5353c5e7b33a8981446e857657aad45a3b82080ea5c67d4baa434eacfcf5f
'http://deb.debian.org/debian/pool/main/o/ocaml/ocaml_4.13.1-4.debian.tar.xz' ocaml_4.13.1-4.debian.tar.xz 39716 SHA256:e35c2b49d5e9a72b904fc2a28179a8c18f50b5297d65a7571d83dd78e33ad985
```

Other potentially useful URLs:

- https://sources.debian.net/src/ocaml/4.13.1-4/ (for browsing the source)
- https://sources.debian.net/src/ocaml/4.13.1-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ocaml/4.13.1-4/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/bsdextrautils/copyright`, `/usr/share/doc/bsdutils/copyright`, `/usr/share/doc/libblkid1/copyright`, `/usr/share/doc/libmount1/copyright`, `/usr/share/doc/libsmartcols1/copyright`, `/usr/share/doc/libuuid1/copyright`, `/usr/share/doc/mount/copyright`, `/usr/share/doc/util-linux/copyright`, `/usr/share/doc/util-linux-extra/copyright`)
