...
- Created: `2021-05-20T18:39:30.611310878Z`
- Virtual Size: ~ 82.85 Mb  
...
```console
gdk-pixbuf-2.40.0-r3 description:
GTK+ image loading library

gdk-pixbuf-2.40.0-r3 webpage:
https://wiki.gnome.org/Projects/GdkPixbuf

gdk-pixbuf-2.40.0-r3 installed size:
624 KiB

gdk-pixbuf-2.40.0-r3 license:
LGPL-2.0-or-later
