...
- Created: `2024-07-25T20:46:47.43778629Z`
- Virtual Size: ~ 102.94 Mb  
...
```console
at-spi2-core-2.48.4-r0 description:
Protocol definitions and daemon for D-Bus at-spi

at-spi2-core-2.48.4-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-2.48.4-r0 installed size:
444 KiB

at-spi2-core-2.48.4-r0 license:
LGPL-2.1-or-later
...
```console
libatk-1.0-2.48.4-r0 description:
ATK library accessibility interfaces (1.0)

libatk-1.0-2.48.4-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-1.0-2.48.4-r0 installed size:
228 KiB

libatk-1.0-2.48.4-r0 license:
LGPL-2.1-or-later
...
```console
libatk-bridge-2.0-2.48.4-r0 description:
GTK+2.0 module that bridges ATK to D-Bus at-spi

libatk-bridge-2.0-2.48.4-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-bridge-2.0-2.48.4-r0 installed size:
264 KiB

libatk-bridge-2.0-2.48.4-r0 license:
LGPL-2.1-or-later
...
```console
libxinerama-1.1.5-r2 description:
X11 Xinerama extension library

libxinerama-1.1.5-r2 webpage:
https://xorg.freedesktop.org/

libxinerama-1.1.5-r2 installed size:
28 KiB

libxinerama-1.1.5-r2 license:
MIT
...
```console
libxkbcommon-1.5.0-r2 description:
keyboard handling library

libxkbcommon-1.5.0-r2 webpage:
https://www.xkbcommon.org/

libxkbcommon-1.5.0-r2 installed size:
288 KiB

libxkbcommon-1.5.0-r2 license:
MIT
...
```console
libxtst-1.2.4-r2 description:
X11 Testing -- Resource extension library

libxtst-1.2.4-r2 webpage:
https://wiki.freedesktop.org/xorg/

libxtst-1.2.4-r2 installed size:
40 KiB

libxtst-1.2.4-r2 license:
MIT
...
```console
wayland-libs-client-1.22.0-r2 description:
A computer display server protocol (client library)

wayland-libs-client-1.22.0-r2 webpage:
https://wayland.freedesktop.org

wayland-libs-client-1.22.0-r2 installed size:
60 KiB

wayland-libs-client-1.22.0-r2 license:
MIT
...
```console
wayland-libs-cursor-1.22.0-r2 description:
A computer display server protocol (cursor library)

wayland-libs-cursor-1.22.0-r2 webpage:
https://wayland.freedesktop.org

wayland-libs-cursor-1.22.0-r2 installed size:
44 KiB

wayland-libs-cursor-1.22.0-r2 license:
MIT
...
```console
wayland-libs-egl-1.22.0-r2 description:
A computer display server protocol (egl library)

wayland-libs-egl-1.22.0-r2 webpage:
https://wayland.freedesktop.org

wayland-libs-egl-1.22.0-r2 installed size:
28 KiB

wayland-libs-egl-1.22.0-r2 license:
MIT
...
```console
xkeyboard-config-2.38-r0 description:
X keyboard configuration files

xkeyboard-config-2.38-r0 webpage:
https://github.com/freedesktop/xkeyboard-config

xkeyboard-config-2.38-r0 installed size:
4056 KiB

xkeyboard-config-2.38-r0 license:
MIT
