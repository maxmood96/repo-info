...
- Created: `2024-09-06T23:07:56.251643678Z`
- Virtual Size: ~ 105.12 Mb  
...
```console
gdk-pixbuf-2.42.10-r6 description:
GTK+ image loading library

gdk-pixbuf-2.42.10-r6 webpage:
https://wiki.gnome.org/Projects/GdkPixbuf

gdk-pixbuf-2.42.10-r6 installed size:
516 KiB

gdk-pixbuf-2.42.10-r6 license:
LGPL-2.1-or-later
...
```console
mbedtls-2.28.9-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.9-r0 webpage:
https://www.trustedfirmware.org/projects/mbed-tls/

mbedtls-2.28.9-r0 installed size:
712 KiB

mbedtls-2.28.9-r0 license:
