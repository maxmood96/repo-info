...
- Created: `2024-03-05T23:39:02.496832209Z`
- Virtual Size: ~ 95.49 Mb  
...
```console
glib-2.78.4-r0 description:
Common C routines used by Gtk+ and other libs

glib-2.78.4-r0 webpage:
https://developer.gnome.org/glib/

glib-2.78.4-r0 installed size:
3864 KiB

glib-2.78.4-r0 license:
LGPL-2.1-or-later
...
```console
gtk-update-icon-cache-3.24.41-r0 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.41-r0 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.41-r0 installed size:
48 KiB

gtk-update-icon-cache-3.24.41-r0 license:
LGPL-2.1-or-later
...
```console
mbedtls-2.28.7-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.7-r0 webpage:
https://www.trustedfirmware.org/projects/mbed-tls/

mbedtls-2.28.7-r0 installed size:
704 KiB

mbedtls-2.28.7-r0 license:
