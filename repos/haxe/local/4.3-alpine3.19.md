...
- Created: `2024-01-27T01:44:10.813965739Z`
- Virtual Size: ~ 95.47 Mb  
...
```console
gtk-update-icon-cache-3.24.38-r5 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.38-r5 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.38-r5 installed size:
48 KiB

gtk-update-icon-cache-3.24.38-r5 license:
LGPL-2.1-or-later
...
```console
mbedtls-2.28.6-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.6-r0 webpage:
https://www.trustedfirmware.org/projects/mbed-tls/

mbedtls-2.28.6-r0 installed size:
704 KiB

mbedtls-2.28.6-r0 license:
