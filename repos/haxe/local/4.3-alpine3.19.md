...
```console
at-spi2-core-2.50.1-r0 description:
Protocol definitions and daemon for D-Bus at-spi

at-spi2-core-2.50.1-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-2.50.1-r0 installed size:
436 KiB

at-spi2-core-2.50.1-r0 license:
LGPL-2.1-or-later
...
```console
busybox-1.36.1-r20 description:
Size optimized toolbox of many common UNIX utilities

busybox-1.36.1-r20 webpage:
https://busybox.net/

busybox-1.36.1-r20 installed size:
924 KiB

busybox-1.36.1-r20 license:
GPL-2.0-only
...
```console
busybox-binsh-1.36.1-r20 description:
busybox ash /bin/sh

busybox-binsh-1.36.1-r20 webpage:
https://busybox.net/

busybox-binsh-1.36.1-r20 installed size:
8192 B

busybox-binsh-1.36.1-r20 license:
GPL-2.0-only
...
```console
gc-8.2.4-r1 description:
garbage collector for C and C++

gc-8.2.4-r1 webpage:
https://hboehm.info/gc/

gc-8.2.4-r1 installed size:
232 KiB
...
```console
glib-2.78.6-r0 description:
Common C routines used by Gtk+ and other libs

glib-2.78.6-r0 webpage:
https://developer.gnome.org/glib/

glib-2.78.6-r0 installed size:
3868 KiB

glib-2.78.6-r0 license:
LGPL-2.1-or-later
...
```console
gtk+3.0-3.24.43-r0 description:
The GTK+ Toolkit (v3)

gtk+3.0-3.24.43-r0 webpage:
https://www.gtk.org/

gtk+3.0-3.24.43-r0 installed size:
10 MiB

gtk+3.0-3.24.43-r0 license:
LGPL-2.1-or-later
...
```console
gtk-update-icon-cache-3.24.43-r0 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.43-r0 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.43-r0 installed size:
48 KiB

gtk-update-icon-cache-3.24.43-r0 license:
LGPL-2.1-or-later
...
```console
harfbuzz-8.3.0-r0 description:
Text shaping library

harfbuzz-8.3.0-r0 webpage:
https://harfbuzz.github.io/

harfbuzz-8.3.0-r0 installed size:
1236 KiB

harfbuzz-8.3.0-r0 license:
MIT
...
```console
libatk-1.0-2.50.1-r0 description:
ATK library accessibility interfaces (1.0)

libatk-1.0-2.50.1-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-1.0-2.50.1-r0 installed size:
228 KiB

libatk-1.0-2.50.1-r0 license:
LGPL-2.1-or-later
...
```console
libatk-bridge-2.0-2.50.1-r0 description:
GTK+2.0 module that bridges ATK to D-Bus at-spi

libatk-bridge-2.0-2.50.1-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-bridge-2.0-2.50.1-r0 installed size:
260 KiB

libatk-bridge-2.0-2.50.1-r0 license:
LGPL-2.1-or-later
...
```console
libblkid-2.39.3-r0 description:
Block device identification library from util-linux

libblkid-2.39.3-r0 webpage:
https://git.kernel.org/cgit/utils/util-linux/util-linux.git

libblkid-2.39.3-r0 installed size:
196 KiB

libblkid-2.39.3-r0 license:
LGPL-2.1-or-later
...
```console
libcrypto3-3.1.8-r1 description:
Crypto library from openssl

libcrypto3-3.1.8-r1 webpage:
https://www.openssl.org/

libcrypto3-3.1.8-r1 installed size:
4516 KiB

libcrypto3-3.1.8-r1 license:
Apache-2.0
...
```console
libmount-2.39.3-r0 description:
Block device identification library from util-linux

libmount-2.39.3-r0 webpage:
https://git.kernel.org/cgit/utils/util-linux/util-linux.git

libmount-2.39.3-r0 installed size:
268 KiB

libmount-2.39.3-r0 license:
LGPL-2.1-or-later
...
```console
libssl3-3.1.8-r1 description:
SSL shared libraries

libssl3-3.1.8-r1 webpage:
https://www.openssl.org/

libssl3-3.1.8-r1 installed size:
548 KiB

libssl3-3.1.8-r1 license:
Apache-2.0
...
```console
libxcomposite-0.4.6-r4 description:
X11 Composite extension library

libxcomposite-0.4.6-r4 webpage:
https://xorg.freedesktop.org/

libxcomposite-0.4.6-r4 installed size:
28 KiB

libxcomposite-0.4.6-r4 license:
MIT
...
```console
libxcursor-1.2.1-r3 description:
X cursor management library

libxcursor-1.2.1-r3 webpage:
https://xorg.freedesktop.org/

libxcursor-1.2.1-r3 installed size:
52 KiB

libxcursor-1.2.1-r3 license:
MIT
...
```console
libxdamage-1.1.6-r4 description:
X11 damaged region extension library

libxdamage-1.1.6-r4 webpage:
https://xorg.freedesktop.org/

libxdamage-1.1.6-r4 installed size:
28 KiB

libxdamage-1.1.6-r4 license:
MIT
...
```console
libxfixes-6.0.1-r3 description:
X11 miscellaneous 'fixes' extension library

libxfixes-6.0.1-r3 webpage:
https://xorg.freedesktop.org/

libxfixes-6.0.1-r3 installed size:
40 KiB

libxfixes-6.0.1-r3 license:
MIT
...
```console
libxft-2.3.8-r2 description:
FreeType-based font drawing library for X

libxft-2.3.8-r2 webpage:
https://xorg.freedesktop.org/

libxft-2.3.8-r2 installed size:
96 KiB

libxft-2.3.8-r2 license:
MIT
...
```console
libxi-1.8.1-r2 description:
X11 Input extension library

libxi-1.8.1-r2 webpage:
https://www.x.org

libxi-1.8.1-r2 installed size:
76 KiB

libxi-1.8.1-r2 license:
MIT AND X11
...
```console
libxinerama-1.1.5-r3 description:
X11 Xinerama extension library

libxinerama-1.1.5-r3 webpage:
https://xorg.freedesktop.org/

libxinerama-1.1.5-r3 installed size:
28 KiB

libxinerama-1.1.5-r3 license:
MIT
...
```console
libxkbcommon-1.6.0-r0 description:
keyboard handling library

libxkbcommon-1.6.0-r0 webpage:
https://www.xkbcommon.org/

libxkbcommon-1.6.0-r0 installed size:
292 KiB

libxkbcommon-1.6.0-r0 license:
MIT
...
```console
libxml2-2.11.8-r3 description:
XML parsing library, version 2

libxml2-2.11.8-r3 webpage:
https://gitlab.gnome.org/GNOME/libxml2

libxml2-2.11.8-r3 installed size:
1092 KiB

libxml2-2.11.8-r3 license:
MIT
...
```console
libxrandr-1.5.4-r0 description:
X11 RandR extension library

libxrandr-1.5.4-r0 webpage:
https://xorg.freedesktop.org/

libxrandr-1.5.4-r0 installed size:
56 KiB

libxrandr-1.5.4-r0 license:
MIT
...
```console
libxrender-0.9.11-r4 description:
X Rendering Extension client library

libxrender-0.9.11-r4 webpage:
https://xorg.freedesktop.org/

libxrender-0.9.11-r4 installed size:
56 KiB

libxrender-0.9.11-r4 license:
MIT
...
```console
libxtst-1.2.4-r4 description:
X11 Testing -- Resource extension library

libxtst-1.2.4-r4 webpage:
https://wiki.freedesktop.org/xorg/

libxtst-1.2.4-r4 installed size:
40 KiB

libxtst-1.2.4-r4 license:
MIT
...
```console
mariadb-connector-c-3.3.8-r0 description:
The MariaDB Native Client library (C driver)

mariadb-connector-c-3.3.8-r0 webpage:
https://mariadb.org/

mariadb-connector-c-3.3.8-r0 installed size:
416 KiB

mariadb-connector-c-3.3.8-r0 license:
LGPL-2.1-or-later
...
```console
mbedtls-2.28.10-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.28.10-r0 webpage:
https://www.trustedfirmware.org/projects/mbed-tls/

mbedtls-2.28.10-r0 installed size:
712 KiB

mbedtls-2.28.10-r0 license:
...
```console
pango-1.51.0-r0 description:
library for layout and rendering of text

pango-1.51.0-r0 webpage:
https://www.pango.org/

pango-1.51.0-r0 installed size:
632 KiB

pango-1.51.0-r0 license:
LGPL-2.1-or-later
...
```console
pixman-0.42.2-r2 description:
Low-level pixel manipulation library

pixman-0.42.2-r2 webpage:
https://gitlab.freedesktop.org/pixman

pixman-0.42.2-r2 installed size:
584 KiB

pixman-0.42.2-r2 license:
MIT
...
```console
pkgconf-2.1.0-r0 description:
development framework configuration tools

pkgconf-2.1.0-r0 webpage:
https://gitea.treehouse.systems/ariadne/pkgconf

pkgconf-2.1.0-r0 installed size:
160 KiB

pkgconf-2.1.0-r0 license:
ISC
...
```console
sqlite-libs-3.44.2-r1 description:
C library that implements an SQL database engine (libraries)

sqlite-libs-3.44.2-r1 webpage:
https://www.sqlite.org/

sqlite-libs-3.44.2-r1 installed size:
1412 KiB

sqlite-libs-3.44.2-r1 license:
blessing
...
```console
ssl_client-1.36.1-r20 description:
EXternal ssl_client for busybox wget

ssl_client-1.36.1-r20 webpage:
https://busybox.net/

ssl_client-1.36.1-r20 installed size:
28 KiB

ssl_client-1.36.1-r20 license:
GPL-2.0-only
...
```console
wayland-libs-client-1.22.0-r4 description:
A computer display server protocol (client library)

wayland-libs-client-1.22.0-r4 webpage:
https://wayland.freedesktop.org

wayland-libs-client-1.22.0-r4 installed size:
60 KiB

wayland-libs-client-1.22.0-r4 license:
MIT
...
```console
wayland-libs-cursor-1.22.0-r4 description:
A computer display server protocol (cursor library)

wayland-libs-cursor-1.22.0-r4 webpage:
https://wayland.freedesktop.org

wayland-libs-cursor-1.22.0-r4 installed size:
44 KiB

wayland-libs-cursor-1.22.0-r4 license:
MIT
...
```console
wayland-libs-egl-1.22.0-r4 description:
A computer display server protocol (egl library)

wayland-libs-egl-1.22.0-r4 webpage:
https://wayland.freedesktop.org

wayland-libs-egl-1.22.0-r4 installed size:
28 KiB

wayland-libs-egl-1.22.0-r4 license:
MIT
...
```console
xkeyboard-config-2.40-r0 description:
X keyboard configuration files

xkeyboard-config-2.40-r0 webpage:
https://gitlab.freedesktop.org/xkeyboard-config/xkeyboard-config

xkeyboard-config-2.40-r0 installed size:
4044 KiB

xkeyboard-config-2.40-r0 license:
MIT
...
```console
xz-libs-5.4.5-r1 description:
Library and CLI tools for XZ and LZMA compressed files (libraries)

xz-libs-5.4.5-r1 webpage:
https://tukaani.org/xz

xz-libs-5.4.5-r1 installed size:
232 KiB

xz-libs-5.4.5-r1 license:
