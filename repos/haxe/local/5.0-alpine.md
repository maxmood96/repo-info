...
```console
at-spi2-core-2.56.3-r0 description:
Protocol definitions and daemon for D-Bus at-spi

at-spi2-core-2.56.3-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-2.56.3-r0 installed size:
161 KiB

at-spi2-core-2.56.3-r0 license:
LGPL-2.1-or-later
...
```console
at-spi2-core-libs-2.56.3-r0 description:
Protocol definitions and daemon for D-Bus at-spi (libraries)

at-spi2-core-libs-2.56.3-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-libs-2.56.3-r0 installed size:
206 KiB

at-spi2-core-libs-2.56.3-r0 license:
LGPL-2.1-or-later
...
```console
gtk+3.0-3.24.49-r1 description:
The GTK+ Toolkit (v3)

gtk+3.0-3.24.49-r1 webpage:
https://www.gtk.org/

gtk+3.0-3.24.49-r1 installed size:
10 MiB

gtk+3.0-3.24.49-r1 license:
LGPL-2.1-or-later
...
```console
gtk-update-icon-cache-3.24.49-r1 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.49-r1 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.49-r1 installed size:
34 KiB

gtk-update-icon-cache-3.24.49-r1 license:
LGPL-2.1-or-later
...
```console
libatk-1.0-2.56.3-r0 description:
ATK library accessibility interfaces (1.0)

libatk-1.0-2.56.3-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-1.0-2.56.3-r0 installed size:
207 KiB

libatk-1.0-2.56.3-r0 license:
LGPL-2.1-or-later
...
```console
libatk-bridge-2.0-2.56.3-r0 description:
GTK+2.0 module that bridges ATK to D-Bus at-spi

libatk-bridge-2.0-2.56.3-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-bridge-2.0-2.56.3-r0 installed size:
231 KiB

libatk-bridge-2.0-2.56.3-r0 license:
LGPL-2.1-or-later
