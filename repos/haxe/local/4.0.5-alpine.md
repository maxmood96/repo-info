...
- Created: `2022-12-01T19:37:16.944579365Z`
...
```console
gtk-update-icon-cache-3.24.34-r7 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.34-r7 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.34-r7 installed size:
48 KiB

gtk-update-icon-cache-3.24.34-r7 license:
LGPL-2.1-or-later
