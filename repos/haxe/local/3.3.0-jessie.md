...
- Image ID: `sha256:4bbb4780658da85e07cdebc70f7f342a5c02fedc904ac1cbbc058a624c80ec7a`
- Created: `2019-12-29T07:13:03.95105256Z`
- Virtual Size: ~ 321.38 Mb  
...
### `dpkg` source package: `bsdmainutils=9.0.6`
...
```console
$ apt-get source -qq --print-uris bsdmainutils=9.0.6
'http://deb.debian.org/debian/pool/main/b/bsdmainutils/bsdmainutils_9.0.6.dsc' bsdmainutils_9.0.6.dsc 1699 SHA256:751d8620245f0a8d8bdf791f9eded0d654b3890eb548aa120fd5e64ebc8ab3e9
'http://deb.debian.org/debian/pool/main/b/bsdmainutils/bsdmainutils_9.0.6.tar.gz' bsdmainutils_9.0.6.tar.gz 280770 SHA256:48868ac99c8dd92a69bb430e6bdf865602522ad3a2f5a0dd9cae77b46fc93b57
```

Other potentially useful URLs:

- https://sources.debian.net/src/bsdmainutils/9.0.6/ (for browsing the source)
- https://sources.debian.net/src/bsdmainutils/9.0.6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bsdmainutils/9.0.6/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libgc=1:7.2d-6.4`

Binary Packages:

- `libgc1c2:amd64=1:7.2d-6.4`
...
```console
$ apt-get source -qq --print-uris libgc=1:7.2d-6.4
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_7.2d-6.4.dsc' libgc_7.2d-6.4.dsc 1617 SHA256:78ad4d1013b1c9512940d1562e2e4f2e77603a62dc88bd06ec3ca1ca52765769
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_7.2d.orig.tar.gz' libgc_7.2d.orig.tar.gz 1263064 SHA256:d9fe0ae8650d43746a48bfb394cab01a319f3809cee19f8ebd16aa985b511c5e
'http://deb.debian.org/debian/pool/main/libg/libgc/libgc_7.2d-6.4.debian.tar.xz' libgc_7.2d-6.4.debian.tar.xz 16696 SHA256:c8bda6878e6f2e170d03281c57b5ae715b03ee61296f633a5bf752b3f24a7ec2
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgc/1:7.2d-6.4/ (for browsing the source)
- https://sources.debian.net/src/libgc/1:7.2d-6.4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgc/1:7.2d-6.4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mariadb-client-lgpl=2.0.0-1`

Binary Packages:

- `libmariadb2:amd64=2.0.0-1`

Licenses: (parsed from: `/usr/share/doc/libmariadb2/copyright`)
...
```console
$ apt-get source -qq --print-uris mariadb-client-lgpl=2.0.0-1
'http://deb.debian.org/debian/pool/main/m/mariadb-client-lgpl/mariadb-client-lgpl_2.0.0-1.dsc' mariadb-client-lgpl_2.0.0-1.dsc 1433 SHA256:5b9c25351ea6f8f42044a0e85959b7938995a3d1de8031963079ec16b661fc41
'http://deb.debian.org/debian/pool/main/m/mariadb-client-lgpl/mariadb-client-lgpl_2.0.0.orig.tar.gz' mariadb-client-lgpl_2.0.0.orig.tar.gz 1923436 SHA256:fd2f751dea049c1907735eb236aeace1d811d6a8218118b00bbaa9b84dc5cd60
'http://deb.debian.org/debian/pool/main/m/mariadb-client-lgpl/mariadb-client-lgpl_2.0.0-1.debian.tar.xz' mariadb-client-lgpl_2.0.0-1.debian.tar.xz 5252 SHA256:025548e0a2506eef1ed1b2b16c090bd3c6577f0995ffe8fed70e269863675cb6
```

Other potentially useful URLs:

- https://sources.debian.net/src/mariadb-client-lgpl/2.0.0-1/ (for browsing the source)
- https://sources.debian.net/src/mariadb-client-lgpl/2.0.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mariadb-client-lgpl/2.0.0-1/ (for access to the source package after it no longer exists in the archive)
