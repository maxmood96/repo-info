...
- Created: `2022-10-06T21:52:24.121649328Z`
- Virtual Size: ~ 83.62 Mb  
...
```console
cairo-1.16.0-r4 description:
A vector graphics library

cairo-1.16.0-r4 webpage:
https://cairographics.org/

cairo-1.16.0-r4 installed size:
1132 KiB

cairo-1.16.0-r4 license:
...
```console
expat-2.2.10-r7 description:
XML Parser library written in C

expat-2.2.10-r7 webpage:
http://www.libexpat.org/

expat-2.2.10-r7 installed size:
188 KiB

expat-2.2.10-r7 license:
MIT
...
```console
gdk-pixbuf-2.42.4-r1 description:
GTK+ image loading library

gdk-pixbuf-2.42.4-r1 webpage:
https://wiki.gnome.org/Projects/GdkPixbuf

gdk-pixbuf-2.42.4-r1 installed size:
560 KiB

gdk-pixbuf-2.42.4-r1 license:
LGPL-2.0-or-later
