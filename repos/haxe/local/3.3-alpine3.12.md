...
- Created: `2021-09-01T02:36:48.558688392Z`
...
```console
gdk-pixbuf-2.40.0-r4 description:
GTK+ image loading library

gdk-pixbuf-2.40.0-r4 webpage:
https://wiki.gnome.org/Projects/GdkPixbuf

gdk-pixbuf-2.40.0-r4 installed size:
624 KiB

gdk-pixbuf-2.40.0-r4 license:
LGPL-2.0-or-later
