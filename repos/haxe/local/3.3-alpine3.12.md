...
- Created: `2020-10-22T04:14:49.344273676Z`
- Virtual Size: ~ 69.50 Mb  
...
```console
glib-2.64.6-r0 description:
Common C routines used by Gtk+ and other libs

glib-2.64.6-r0 webpage:
https://developer.gnome.org/glib/

glib-2.64.6-r0 installed size:
3366912

glib-2.64.6-r0 license:
LGPL-2.1-or-later
...
```console
mbedtls-2.16.8-r0 description:
Light-weight cryptographic and SSL/TLS library

mbedtls-2.16.8-r0 webpage:
https://tls.mbed.org

mbedtls-2.16.8-r0 installed size:
659456

mbedtls-2.16.8-r0 license:
Apache-2.0
