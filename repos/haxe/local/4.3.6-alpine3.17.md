...
```console
libcrypto3-3.0.15-r1 description:
Crypto library from openssl

libcrypto3-3.0.15-r1 webpage:
https://www.openssl.org/

libcrypto3-3.0.15-r1 installed size:
4128 KiB

libcrypto3-3.0.15-r1 license:
Apache-2.0
...
```console
libssl3-3.0.15-r1 description:
SSL shared libraries

libssl3-3.0.15-r1 webpage:
https://www.openssl.org/

libssl3-3.0.15-r1 installed size:
608 KiB

libssl3-3.0.15-r1 license:
Apache-2.0
