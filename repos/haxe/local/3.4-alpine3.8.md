...
- Created: `2020-05-22T20:12:25.838365386Z`
...
```console
libxml2-2.9.8-r2 description:
XML parsing library, version 2

libxml2-2.9.8-r2 webpage:
http://www.xmlsoft.org/

libxml2-2.9.8-r2 installed size:
1224704

libxml2-2.9.8-r2 license:
MIT
...
```console
sqlite-libs-3.25.3-r4 description:
Sqlite3 library

sqlite-libs-3.25.3-r4 webpage:
http://www.sqlite.org

sqlite-libs-3.25.3-r4 installed size:
913408

sqlite-libs-3.25.3-r4 license:
Public-Domain
