...
- Created: `2022-05-11T20:08:33.828556535Z`
- Virtual Size: ~ 308.81 Mb  
...
### `dpkg` source package: `bsdmainutils=9.0.12+nmu1`
...
```console
$ apt-get source -qq --print-uris bsdmainutils=9.0.12+nmu1
'http://deb.debian.org/debian/pool/main/b/bsdmainutils/bsdmainutils_9.0.12%2bnmu1.dsc' bsdmainutils_9.0.12+nmu1.dsc 1798 SHA256:0420e165b50a6b37ea66deeb919c1a6455e1c395219c3aa316b4eda09dd54e98
'http://deb.debian.org/debian/pool/main/b/bsdmainutils/bsdmainutils_9.0.12%2bnmu1.tar.gz' bsdmainutils_9.0.12+nmu1.tar.gz 281769 SHA256:46ae19dcd28b2879379d70d149ea4fbe79b29d6c48e9ba4b576c5b38252043e8
```

Other potentially useful URLs:

- https://sources.debian.net/src/bsdmainutils/9.0.12+nmu1/ (for browsing the source)
- https://sources.debian.net/src/bsdmainutils/9.0.12+nmu1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bsdmainutils/9.0.12+nmu1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libgc=1:7.4.2-8+deb9u1`

Binary Packages:

- `libgc1c2:amd64=1:7.4.2-8+deb9u1`
...
```console
$ apt-get source -qq --print-uris libgc=1:7.4.2-8+deb9u1
'http://security.debian.org/debian-security/pool/updates/main/libg/libgc/libgc_7.4.2-8%2bdeb9u1.dsc' libgc_7.4.2-8+deb9u1.dsc 2187 SHA256:acced98f4c75d6577116dd92e4d297f9e0c5156b6bf8cef052c3281be3d97645
'http://security.debian.org/debian-security/pool/updates/main/libg/libgc/libgc_7.4.2.orig.tar.gz' libgc_7.4.2.orig.tar.gz 730375 SHA256:09f21d38dd42bced14d6875f55804cb1b5e6bc486da7980187ecd2e768739c62
'http://security.debian.org/debian-security/pool/updates/main/libg/libgc/libgc_7.4.2-8%2bdeb9u1.debian.tar.xz' libgc_7.4.2-8+deb9u1.debian.tar.xz 23060 SHA256:560d4b21acbea88c0e533e402a3df14e1a15576af4787e2ddaee4141bf60cc91
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgc/1:7.4.2-8+deb9u1/ (for browsing the source)
- https://sources.debian.net/src/libgc/1:7.4.2-8+deb9u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgc/1:7.4.2-8+deb9u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mariadb-connector-c=2.3.2-2`

Binary Packages:

- `libmariadb-dev=2.3.2-2`
- `libmariadb-dev-compat:amd64=2.3.2-2`
- `libmariadb2:amd64=2.3.2-2`

Licenses: (parsed from: `/usr/share/doc/libmariadb-dev/copyright`, `/usr/share/doc/libmariadb-dev-compat/copyright`, `/usr/share/doc/libmariadb2/copyright`)
...
```console
$ apt-get source -qq --print-uris mariadb-connector-c=2.3.2-2
'http://deb.debian.org/debian/pool/main/m/mariadb-connector-c/mariadb-connector-c_2.3.2-2.dsc' mariadb-connector-c_2.3.2-2.dsc 2231 SHA256:4fda8feb529fa92933b423432a949641b247f553a53f62fa536dac1fc60b066a
'http://deb.debian.org/debian/pool/main/m/mariadb-connector-c/mariadb-connector-c_2.3.2.orig.tar.gz' mariadb-connector-c_2.3.2.orig.tar.gz 538172 SHA256:4063c8655dc37608d4eade981e25b76f67f5d36e8426dc7f20d59e48ebba628a
'http://deb.debian.org/debian/pool/main/m/mariadb-connector-c/mariadb-connector-c_2.3.2-2.debian.tar.xz' mariadb-connector-c_2.3.2-2.debian.tar.xz 24868 SHA256:bd88c3829d47625c12ea28ff7f806e849db22d68e0af97a28dc9defdc631af8e
```

Other potentially useful URLs:

- https://sources.debian.net/src/mariadb-connector-c/2.3.2-2/ (for browsing the source)
- https://sources.debian.net/src/mariadb-connector-c/2.3.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mariadb-connector-c/2.3.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mbedtls=2.4.2-1+deb9u4`

Binary Packages:

- `libmbedcrypto0:amd64=2.4.2-1+deb9u4`
- `libmbedtls10:amd64=2.4.2-1+deb9u4`
- `libmbedx509-0:amd64=2.4.2-1+deb9u4`

Licenses: (parsed from: `/usr/share/doc/libmbedcrypto0/copyright`, `/usr/share/doc/libmbedtls10/copyright`, `/usr/share/doc/libmbedx509-0/copyright`)
...
```console
$ apt-get source -qq --print-uris mbedtls=2.4.2-1+deb9u4
'http://security.debian.org/debian-security/pool/updates/main/m/mbedtls/mbedtls_2.4.2-1%2bdeb9u4.dsc' mbedtls_2.4.2-1+deb9u4.dsc 2219 SHA256:360d3d6d2590cb5583949fbe9a521d3af099871d1aeb092e66e2ce39930e9a51
'http://security.debian.org/debian-security/pool/updates/main/m/mbedtls/mbedtls_2.4.2.orig.tar.gz' mbedtls_2.4.2.orig.tar.gz 1925368 SHA256:17dd98af7478aadacc480c7e4159e447353b5b2037c1b6d48ed4fd157fb1b018
'http://security.debian.org/debian-security/pool/updates/main/m/mbedtls/mbedtls_2.4.2-1%2bdeb9u4.debian.tar.xz' mbedtls_2.4.2-1+deb9u4.debian.tar.xz 30572 SHA256:00c69e29252afef6de99898b28a281c7402e8ab36cd71d800ca48773b176d040
```

Other potentially useful URLs:

- https://sources.debian.net/src/mbedtls/2.4.2-1+deb9u4/ (for browsing the source)
- https://sources.debian.net/src/mbedtls/2.4.2-1+deb9u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mbedtls/2.4.2-1+deb9u4/ (for access to the source package after it no longer exists in the archive)
