...
- Created: `2024-07-22T23:33:00.548209967Z`
...
```console
gtk+2.0-2.24.33-r11 description:
The GTK+ Toolkit (v2)

gtk+2.0-2.24.33-r11 webpage:
https://www.gtk.org/

gtk+2.0-2.24.33-r11 installed size:
6152 KiB

gtk+2.0-2.24.33-r11 license:
LGPL-2.0-or-later
