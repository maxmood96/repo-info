...
- Image ID: `sha256:a669c95c1a2589b07fcb963af6eed714b1a8ad5ce4933c5b70c7ad67234c3647`
- Created: `2024-07-25T21:32:27.252397624Z`
...
```console
at-spi2-core-2.52.0-r0 description:
Protocol definitions and daemon for D-Bus at-spi

at-spi2-core-2.52.0-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

at-spi2-core-2.52.0-r0 installed size:
436 KiB

at-spi2-core-2.52.0-r0 license:
LGPL-2.1-or-later
...
```console
gc-8.2.6-r0 description:
garbage collector for C and C++

gc-8.2.6-r0 webpage:
https://hboehm.info/gc/

gc-8.2.6-r0 installed size:
232 KiB
...
```console
gtk+3.0-3.24.42-r0 description:
The GTK+ Toolkit (v3)

gtk+3.0-3.24.42-r0 webpage:
https://www.gtk.org/

gtk+3.0-3.24.42-r0 installed size:
10 MiB

gtk+3.0-3.24.42-r0 license:
LGPL-2.1-or-later
...
```console
gtk-update-icon-cache-3.24.42-r0 description:
The GTK+ Toolkit (v3)

gtk-update-icon-cache-3.24.42-r0 webpage:
https://www.gtk.org/

gtk-update-icon-cache-3.24.42-r0 installed size:
48 KiB

gtk-update-icon-cache-3.24.42-r0 license:
LGPL-2.1-or-later
...
```console
libatk-1.0-2.52.0-r0 description:
ATK library accessibility interfaces (1.0)

libatk-1.0-2.52.0-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-1.0-2.52.0-r0 installed size:
228 KiB

libatk-1.0-2.52.0-r0 license:
LGPL-2.1-or-later
...
```console
libatk-bridge-2.0-2.52.0-r0 description:
GTK+2.0 module that bridges ATK to D-Bus at-spi

libatk-bridge-2.0-2.52.0-r0 webpage:
https://www.freedesktop.org/wiki/Accessibility/AT-SPI2/

libatk-bridge-2.0-2.52.0-r0 installed size:
268 KiB

libatk-bridge-2.0-2.52.0-r0 license:
LGPL-2.1-or-later
...
```console
libxcursor-1.2.2-r1 description:
X cursor management library

libxcursor-1.2.2-r1 webpage:
https://xorg.freedesktop.org/

libxcursor-1.2.2-r1 installed size:
52 KiB

libxcursor-1.2.2-r1 license:
MIT
...
```console
libxkbcommon-1.7.0-r0 description:
keyboard handling library

libxkbcommon-1.7.0-r0 webpage:
https://www.xkbcommon.org/

libxkbcommon-1.7.0-r0 installed size:
296 KiB

libxkbcommon-1.7.0-r0 license:
MIT
...
```console
mbedtls2-2.28.8-r1 description:
Light-weight cryptographic and SSL/TLS library

mbedtls2-2.28.8-r1 webpage:
https://www.trustedfirmware.org/projects/mbed-tls/

mbedtls2-2.28.8-r1 installed size:
712 KiB

mbedtls2-2.28.8-r1 license:
...
```console
xkeyboard-config-2.41-r0 description:
X keyboard configuration files

xkeyboard-config-2.41-r0 webpage:
https://gitlab.freedesktop.org/xkeyboard-config/xkeyboard-config

xkeyboard-config-2.41-r0 installed size:
4036 KiB

xkeyboard-config-2.41-r0 license:
MIT
