...
- Created: `2021-02-24T22:59:42.041265432Z`
- Virtual Size: ~ 79.86 Mb  
...
```console
dbus-libs-1.12.16-r1 description:
D-BUS access libraries

dbus-libs-1.12.16-r1 webpage:
https://www.freedesktop.org/Software/dbus

dbus-libs-1.12.16-r1 installed size:
303104

dbus-libs-1.12.16-r1 license:
...
```console
freetype-2.10.0-r1 description:
TrueType font rendering library

freetype-2.10.0-r1 webpage:
https://www.freetype.org/

freetype-2.10.0-r1 installed size:
737280

freetype-2.10.0-r1 license:
...
```console
libbsd-0.9.1-r1 description:
commonly-used BSD functions not implemented by all libcs

libbsd-0.9.1-r1 webpage:
https://libbsd.freedesktop.org/

libbsd-0.9.1-r1 installed size:
94208

libbsd-0.9.1-r1 license:
BSD
...
```console
libxml2-2.9.9-r4 description:
XML parsing library, version 2

libxml2-2.9.9-r4 webpage:
http://www.xmlsoft.org/

libxml2-2.9.9-r4 installed size:
1216512

libxml2-2.9.9-r4 license:
MIT
...
```console
mariadb-connector-c-3.0.10-r1 description:
The MariaDB Native Client library (C driver)

mariadb-connector-c-3.0.10-r1 webpage:
https://mariadb.org/

mariadb-connector-c-3.0.10-r1 installed size:
442368

mariadb-connector-c-3.0.10-r1 license:
LGPL-2.1-or-later
...
```console
p11-kit-0.23.16.1-r1 description:
Library for loading and sharing PKCS#11 modules

p11-kit-0.23.16.1-r1 webpage:
https://p11-glue.freedesktop.org/

p11-kit-0.23.16.1-r1 installed size:
1232896

p11-kit-0.23.16.1-r1 license:
BSD
