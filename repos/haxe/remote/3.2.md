...
```console
$ docker pull haxe@sha256:22576fff2b652d036ea1dc8ee66e8a3022d6d260c47708e50eb3b2fa8cc07964
```
...
```console
$ docker pull haxe@sha256:0fed0eb824d25023b3f8e3a7cf278e4a8dde28e546c08515cc1fd982d16942c9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.7 MB (128720060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a726237ae58eba99d49715e81b51954d69b10b065a297c6750903af151d1a90a`
...
-	Layers:
	...
	-	`sha256:934893658aad470bab66c9b4907945593957fe3893f1d4663d2b1e91a876b4b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c14f1f032c106d60cc300bba95f00518f752f24267ee56253023f9b01fc61f7`  
		Last Modified: Thu, 18 Nov 2021 09:40:21 GMT  
		Size: 5.0 MB (4988293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `haxe:3.2` - linux; arm variant v7

```console
$ docker pull haxe@sha256:6f272d388ce32fd10cf374a6009443fb29922b6ca45b7716b4733771899bb980
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.0 MB (118037034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7959643286f2ccb6b8bca30c30039d88294cde96bd72035a62fdbbb900529f7`
-	Default Command: `["haxe"]`
...
RUN set -ex 	&& buildDeps=' 		gcc 		make 		cmake 		libgc-dev 		libssl-dev 		libpcre3-dev 		zlib1g-dev 		apache2-dev 		libmariadb-client-lgpl-dev-compat 		libsqlite3-dev 		libmbedtls-dev 		libgtk2.0-dev 	' 	&& apt-get update && apt-get install -y $buildDeps --no-install-recommends && rm -rf /var/lib/apt/lists/* 		&& wget -O neko.tar.gz "https://github.com/HaxeFoundation/neko/archive/v2-3-0/neko-2.3.0.tar.gz" 	&& echo "850e7e317bdaf24ed652efeff89c1cb21380ca19f20e68a296c84f6bad4ee995 *neko.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/src/neko 	&& tar -xC /usr/src/neko --strip-components=1 -f neko.tar.gz 	&& rm neko.tar.gz 	&& cd /usr/src/neko 	&& cmake -DRELOCATABLE=OFF . 	&& make 	&& make install 		&& apt-get purge -y --auto-remove $buildDeps 	&& rm -rf /usr/src/neko ~/.cache
# Thu, 18 Nov 2021 16:31:49 GMT
ENV HAXE_VERSION=3.2.1
# Thu, 18 Nov 2021 16:31:49 GMT
ENV HAXE_STD_PATH=/usr/local/share/haxe/std
# Thu, 18 Nov 2021 16:38:36 GMT
RUN set -ex 	&& buildDeps=' 		make 		ocaml-nox 		ocaml-native-compilers 		camlp4 		ocaml-findlib 		zlib1g-dev 		libpcre3-dev 		libmbedtls-dev 		libxml-light-ocaml-dev 			' 	&& git clone --recursive --depth 1 --branch 3.2.1 "https://github.com/HaxeFoundation/haxe.git" /usr/src/haxe 	&& cd /usr/src/haxe 	&& mkdir -p $HAXE_STD_PATH 	&& cp -r std/* $HAXE_STD_PATH 	&& apt-get update && apt-get install -y $buildDeps --no-install-recommends 			&& make all tools 	&& mkdir -p /usr/local/bin 	&& cp haxe haxelib /usr/local/bin 	&& mkdir -p /haxelib 	&& cd / && haxelib setup /haxelib 			&& rm -rf /var/lib/apt/lists/* 	&& apt-get purge -y --auto-remove $buildDeps 	&& rm -rf /usr/src/haxe ~/.cache
# Thu, 18 Nov 2021 16:38:37 GMT
CMD ["haxe"]
```
...
-	Layers:
	...
	-	`sha256:69ee7c04819ff00af0af0376060f0690616b0c5a138dd5edd6f6d63f35239361`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2efd103387ce16c71c0c94884a4e3bd5821219ccc5e6ea9fbb7287c24d9ca588`  
		Last Modified: Thu, 18 Nov 2021 16:49:21 GMT  
		Size: 4.8 MB (4805694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `haxe:3.2` - linux; arm64 variant v8

```console
$ docker pull haxe@sha256:29171f91616f8982ab5ebea046a6073390626e85a12f44d77d028f05e14d7f99
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.7 MB (127682131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8fc580370b12c96531b49c6e4b9470efe1a4cd58a609d8d5491fc28f6a325c0`
-	Default Command: `["haxe"]`
...
RUN set -ex 	&& buildDeps=' 		gcc 		make 		cmake 		libgc-dev 		libssl-dev 		libpcre3-dev 		zlib1g-dev 		apache2-dev 		libmariadb-client-lgpl-dev-compat 		libsqlite3-dev 		libmbedtls-dev 		libgtk2.0-dev 	' 	&& apt-get update && apt-get install -y $buildDeps --no-install-recommends && rm -rf /var/lib/apt/lists/* 		&& wget -O neko.tar.gz "https://github.com/HaxeFoundation/neko/archive/v2-3-0/neko-2.3.0.tar.gz" 	&& echo "850e7e317bdaf24ed652efeff89c1cb21380ca19f20e68a296c84f6bad4ee995 *neko.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/src/neko 	&& tar -xC /usr/src/neko --strip-components=1 -f neko.tar.gz 	&& rm neko.tar.gz 	&& cd /usr/src/neko 	&& cmake -DRELOCATABLE=OFF . 	&& make 	&& make install 		&& apt-get purge -y --auto-remove $buildDeps 	&& rm -rf /usr/src/neko ~/.cache
# Fri, 03 Dec 2021 04:33:58 GMT
ENV HAXE_VERSION=3.2.1
# Fri, 03 Dec 2021 04:33:59 GMT
ENV HAXE_STD_PATH=/usr/local/share/haxe/std
# Fri, 03 Dec 2021 04:34:37 GMT
RUN set -ex 	&& buildDeps=' 		make 		ocaml-nox 		ocaml-native-compilers 		camlp4 		ocaml-findlib 		zlib1g-dev 		libpcre3-dev 		libmbedtls-dev 		libxml-light-ocaml-dev 			' 	&& git clone --recursive --depth 1 --branch 3.2.1 "https://github.com/HaxeFoundation/haxe.git" /usr/src/haxe 	&& cd /usr/src/haxe 	&& mkdir -p $HAXE_STD_PATH 	&& cp -r std/* $HAXE_STD_PATH 	&& apt-get update && apt-get install -y $buildDeps --no-install-recommends 			&& make all tools 	&& mkdir -p /usr/local/bin 	&& cp haxe haxelib /usr/local/bin 	&& mkdir -p /haxelib 	&& cd / && haxelib setup /haxelib 			&& rm -rf /var/lib/apt/lists/* 	&& apt-get purge -y --auto-remove $buildDeps 	&& rm -rf /usr/src/haxe ~/.cache
# Fri, 03 Dec 2021 04:34:38 GMT
CMD ["haxe"]
```
...
-	Layers:
	...
	-	`sha256:675a999532c84fb1a88be68509df1d712904eb8da4241ff1b6fd1882c3fb0c98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dde84e6bb9e511e94d2058adc0e0c801dced15f1ca7d0cc1907aac3dcc8ffb2`  
		Last Modified: Fri, 03 Dec 2021 04:46:03 GMT  
		Size: 5.5 MB (5464839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `haxe:3.2` - windows version 10.0.17763.2300; amd64
...
### `haxe:3.2` - windows version 10.0.14393.4770; amd64
