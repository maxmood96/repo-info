...
```console
$ docker pull hylang@sha256:a050f3dba926989ca818d642d28ac8efb83c5e1cc9af0f3ea74adc319f37f7f1
```
...
```console
$ docker pull hylang@sha256:d1cc28a6b4a7ef3053522dcdb530f9be1965d968169f4e03b0c228e3fd4b24d4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.3 MB (46294356 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cb095987a47b4cc45e21eaf16ecfe4524623c29ee3f23cd756eb508c7ff18dc`
-	Default Command: `["hy"]`
...
# Tue, 02 Aug 2022 10:18:15 GMT
CMD ["python3"]
# Tue, 02 Aug 2022 21:49:47 GMT
ENV HY_VERSION=0.24.0
# Tue, 02 Aug 2022 21:49:47 GMT
ENV HYRULE_VERSION=0.2
# Tue, 02 Aug 2022 21:49:59 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Tue, 02 Aug 2022 21:49:59 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:a6a8e6dbdb14a6ef23963bcbb796d4726512ed8c5ee222fbc5c80c701350c05f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b3eeb5d71a92aae3e630206238043b8824b7803d751b6b6fb665a4ad78cdb92`  
		Last Modified: Tue, 02 Aug 2022 21:57:25 GMT  
		Size: 3.7 MB (3749243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
