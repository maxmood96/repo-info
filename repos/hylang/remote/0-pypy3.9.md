...
```console
$ docker pull hylang@sha256:8d88ec8972fb019e36f7c0c921b6487061c8538150d99ea378e76dbc64b54a3c
```
...
```console
$ docker pull hylang@sha256:c05515c20306e6f6c5fd163b89ddcd9ff6275486fda13e6e5cc6dd363ac1ee02
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **73.4 MB (73375127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01dac852569cd061ea2bf29262cd6f5ae2672894208bf78d4d15652a426be258`
-	Default Command: `["hy"]`
...
# Wed, 16 Aug 2023 10:24:51 GMT
CMD ["pypy3"]
# Wed, 16 Aug 2023 18:55:19 GMT
ENV HY_VERSION=0.27.0
# Wed, 16 Aug 2023 18:55:19 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 16 Aug 2023 18:55:46 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 16 Aug 2023 18:55:46 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:5e0ea17f8991a680bfcddda9aac6e6b17cacdec57eb0792fa7202ead96700ae8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71ed7caffcc3c70cb3bf6b0d00c13e73fdab50797e1c17c5bf6918ac62010762`  
		Last Modified: Wed, 16 Aug 2023 19:01:25 GMT  
		Size: 3.9 MB (3915751 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
