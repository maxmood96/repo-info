...
```console
$ docker pull hylang@sha256:52eeb809dda4d88c9731ecef8b3c75170ddbdc6e180b68f45565bd6fcbad6144
```
...
```console
$ docker pull hylang@sha256:35af401198136f1fd2bcb94d51072da08229929e8ef69cae41ebc34ea439757b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52301207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90da20881a5215fc31c631d2c5c88b16adeffc590010fd01fa8e40889aaf7db1`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:d79d23b1189efee5d9b9b568dbe1a78c420e11bd71f0cce938251018629828f6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1e6885120dfb520e0e034e3142ae00bcda64e5dbf66b9054cafd63cfd04c8b37`  
		Last Modified: Thu, 04 Apr 2024 10:09:29 GMT  
		Size: 6.1 MB (6135326 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `hylang:python3.11-bullseye` - unknown; unknown

```console
$ docker pull hylang@sha256:946d2199daadfb2c87bb00784ad766cfbb8092134d21f4c46e3ba1f5dcf59de5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **2.7 MB (2693646 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49ce5a49ddcbcbec229497491f47044157de7ffedfa651ddaeca7e7d08c132fe`

```dockerfile
```

-	Layers:
	-	`sha256:4c6a45401c091e9ff71ea856c80674a5993d61926a60934e7903dd6621a6f7de`  
		Last Modified: Thu, 04 Apr 2024 10:09:28 GMT  
		Size: 2.7 MB (2684519 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2512bd221fdeb79da67525bdfff157b75263ac9ae376fc414701b4145bac1939`  
		Last Modified: Thu, 04 Apr 2024 10:09:28 GMT  
