...
```console
$ docker pull hylang@sha256:2c1ee5c35978828a3d58c77dcf102986b14cffd47a192f2da680bd518aef40f5
```
...
```console
$ docker pull hylang@sha256:2b2a4a45d27d698201ae471a3207a4c2ada64ce78262d9d96af480a7608d337a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47779563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b869e3b550923d9b3f8f6749e53f240b54e4b34875137d93314a68994864889`
-	Default Command: `["hy"]`
...
# Fri, 14 Oct 2022 01:37:57 GMT
CMD ["python3"]
# Fri, 14 Oct 2022 02:41:32 GMT
ENV HY_VERSION=0.24.0
# Fri, 14 Oct 2022 02:41:32 GMT
ENV HYRULE_VERSION=0.2
# Fri, 14 Oct 2022 02:41:55 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 14 Oct 2022 02:41:55 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:7838bfe7f1014e3ba7e993e308b8bac2cb9d641141beb4e282dd7c178a34695b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6609608c291970bd6a309971e3d970883dd41602839ac9adbd30c773f4972652`  
		Last Modified: Fri, 14 Oct 2022 02:45:12 GMT  
		Size: 3.7 MB (3749543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:1b1164653b1960336a11f97d4889bf3a6d3153c4107b8aeac5860c8e05f9f6fb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (48969129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:758768f43367d94fb00fa138e295b907d9a159d918524fd52069180261fe91b1`
-	Default Command: `["hy"]`
...
# Fri, 14 Oct 2022 01:08:47 GMT
CMD ["python3"]
# Fri, 14 Oct 2022 03:58:00 GMT
ENV HY_VERSION=0.24.0
# Fri, 14 Oct 2022 03:58:01 GMT
ENV HYRULE_VERSION=0.2
# Fri, 14 Oct 2022 03:58:16 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 14 Oct 2022 03:58:17 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:1f6524094f2429d85f6f9e050ddbf0f4756c4dc142bb11c0afe1bf3f7cc53da8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70503d370e6e6054eed3ab7452245a85ae343b4d1a7b0f5496c0658182e9ae7c`  
		Last Modified: Fri, 14 Oct 2022 04:07:32 GMT  
		Size: 3.7 MB (3746418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.8` - linux; 386

```console
$ docker pull hylang@sha256:8c35db4fd0968701fd1cc79da6850895881cee9c927a5cca2efbe8b41415a574
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51403177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16b00b3e083802c20f8bf516cb35094157419bd672093f8d44fd542c9ae423a1`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Fri, 14 Oct 2022 03:06:34 GMT
ENV HY_VERSION=0.24.0
# Fri, 14 Oct 2022 03:06:34 GMT
ENV HYRULE_VERSION=0.2
# Fri, 14 Oct 2022 03:06:54 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 14 Oct 2022 03:06:54 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:13388055c0b79ea80e98f0ad8d7404823f68c3a5a916901a9a5f93153445662f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:569d3716c4ef184b3c1be95409cae1ced6860f7e07600c539d74362f80e9aad3`  
		Last Modified: Fri, 14 Oct 2022 03:16:32 GMT  
		Size: 3.7 MB (3746479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:06e50b458bf3868053acaf0bf507b5466a1c02cc56b0822f1761cadbf988b8e3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.0 MB (55010748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4281a9a9e417e1012311fa4e8e0ee47ad8d2ad687bfc5a4de39c63b72e014c8`
-	Default Command: `["hy"]`
...
# Fri, 14 Oct 2022 04:10:24 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 14 Oct 2022 04:10:46 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 14 Oct 2022 04:10:47 GMT
CMD ["python3"]
# Fri, 14 Oct 2022 04:20:20 GMT
ENV HY_VERSION=0.24.0
# Fri, 14 Oct 2022 04:20:21 GMT
ENV HYRULE_VERSION=0.2
# Fri, 14 Oct 2022 04:20:56 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 14 Oct 2022 04:20:57 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:8eced59dcf3b5578847841485e1ad843b84d53878af320b277f0b155e5741533`  
		...
		Size: 235.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5c96ae560d6301670adaafc7d30ca1a0a7197323a3440baf9402523d048996f`  
		Last Modified: Fri, 14 Oct 2022 04:14:39 GMT  
		Size: 3.2 MB (3178284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab619a5922bfff0ac1523fa8c92062b6ef990c7b9e3327872b2fe8b5428d9a6b`  
		Last Modified: Fri, 14 Oct 2022 04:27:14 GMT  
		Size: 3.7 MB (3749592 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
