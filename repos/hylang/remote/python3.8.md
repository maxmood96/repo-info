...
```console
$ docker pull hylang@sha256:dc359f0ba3f4937d7e9e951deb2db7532f8cac9fdde146df50ba06b111c7d85c
```
...
```console
$ docker pull hylang@sha256:0b2ac233031b7450f350da2552c4e4844c45670b850bb117fd3b36439168107f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47782050 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5443b1fd59c2ba5a1e9b266a22d29324e414a795dcd1934fcc62337b64dc4e6`
-	Default Command: `["hy"]`
...
# Fri, 12 Aug 2022 04:32:36 GMT
ENV HYRULE_VERSION=0.2
# Fri, 12 Aug 2022 04:32:51 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 12 Aug 2022 04:32:52 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:f250b4089fc296873f87c777c3f050b2dce41dae053b80c6e1a4af436a47554b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9ee3b8b0a73aa2269305a6c894eb86d4e187758707507dfd7178e729aabf2cc`  
		Last Modified: Fri, 12 Aug 2022 04:38:01 GMT  
		Size: 3.7 MB (3749405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.8` - linux; arm variant v7

```console
$ docker pull hylang@sha256:db75ba80b210635bca914a18f3dad0884ad5efe301ec34fcaa8c5e58e6b63a1e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.0 MB (44993238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7401a6661c6df8046aa6169aea8b9fa0a374e58d0b28bd835d722898ebe35491`
-	Default Command: `["hy"]`
...
# Wed, 03 Aug 2022 09:59:50 GMT
CMD ["python3"]
# Thu, 04 Aug 2022 13:35:13 GMT
ENV HY_VERSION=0.24.0
# Thu, 04 Aug 2022 13:35:13 GMT
ENV HYRULE_VERSION=0.2
# Thu, 04 Aug 2022 13:35:28 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 04 Aug 2022 13:35:28 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:9b2bbb8868b13903dbb9c434937e9c75cb237e9d6bcfebaa5108d55d1924a9d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34b6bad0b841cf2f69087c67dc701c766e6c42431f7b1689639442df509aec7e`  
		Last Modified: Thu, 04 Aug 2022 13:44:31 GMT  
		Size: 3.7 MB (3749274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:710658b7ae0b3cbbb5234f13e60f948e1297c40ae712e05cf136e534141fd712
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51605455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1866d9e974653d2b5668de4d0a97111b8bb6ec520dbecd82056b85aefdc235c2`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:af8aedcaa5544b26b62c29d1c418a33b71660934dd7b382a3c9bc40852594834`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41ac3464430bb0f6b1d07e5cc8e3fb47b91e70227cf13383e02bbe7cd2bc92d6`  
		Last Modified: Fri, 12 Aug 2022 04:28:58 GMT  
		Size: 3.7 MB (3746621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.8` - linux; mips64le

```console
$ docker pull hylang@sha256:501fb38121c08a2c5954f5367fe7373f91944b9bc9337e217362c37de73bc7c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48589400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:051486f4fec8c8bc25f3a707c44acb9b3af32d9168347453e1789b3b247cc015`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Thu, 04 Aug 2022 08:06:09 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/aeca83c7ba7f9cdfd681103c4dcbf0214f6d742e/public/get-pip.py
# Thu, 04 Aug 2022 08:06:11 GMT
ENV PYTHON_GET_PIP_SHA256=d0b5909f3ab32dae9d115aa68a4b763529823ad5589c56af15cf816fca2773d6
# Thu, 04 Aug 2022 08:07:03 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 04 Aug 2022 08:07:06 GMT
CMD ["python3"]
# Thu, 04 Aug 2022 08:24:21 GMT
ENV HY_VERSION=0.24.0
# Thu, 04 Aug 2022 08:24:23 GMT
ENV HYRULE_VERSION=0.2
# Thu, 04 Aug 2022 08:25:30 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 04 Aug 2022 08:25:33 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:6f36f68aa959ef072ff2e7db89fe3d2951e37bdbdca7c4c95c1e2bcf099ee5b6`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e3e4e87746de417fe89895ba625f7523287f9056f2a5a7d3dc5aecb1bbe2201`  
		Last Modified: Thu, 04 Aug 2022 08:17:16 GMT  
		Size: 3.0 MB (2962150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d4fd6fe83ce82d4e3c8955a9ad33a3199ebecef905b0d1c7387f7cb09c2f0f2`  
		Last Modified: Thu, 04 Aug 2022 08:32:31 GMT  
		Size: 3.7 MB (3747275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
