...
### `hylang:1.1-alpine` - unknown; unknown
...
### `hylang:1.1-alpine` - linux; arm variant v6
...
### `hylang:1.1-alpine` - linux; arm variant v7
...
### `hylang:1.1-alpine` - linux; arm64 variant v8
...
### `hylang:1.1-alpine` - linux; ppc64le
...
### `hylang:1.1-alpine` - linux; riscv64
