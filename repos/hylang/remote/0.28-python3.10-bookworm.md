...
### `hylang:0.28-python3.10-bookworm` - linux; amd64
...
### `hylang:0.28-python3.10-bookworm` - unknown; unknown
...
### `hylang:0.28-python3.10-bookworm` - linux; arm variant v5
...
### `hylang:0.28-python3.10-bookworm` - linux; arm variant v7
...
### `hylang:0.28-python3.10-bookworm` - linux; arm64 variant v8
...
### `hylang:0.28-python3.10-bookworm` - linux; 386
...
### `hylang:0.28-python3.10-bookworm` - linux; ppc64le
...
### `hylang:0.28-python3.10-bookworm` - linux; s390x
