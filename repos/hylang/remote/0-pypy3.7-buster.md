...
```console
$ docker pull hylang@sha256:088f2df5bd613bad41c7e7754d91fd140cfc5e974e2805acc3ea92a069edb54a
```
...
```console
$ docker pull hylang@sha256:946944f16d0517fcda54f6a7d91013893b88fca6428f7234c94ad45a57598390
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.0 MB (70007659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c13da2e892087af44d3d7d6fed509feb6dd90c687047463d642bebcd92449b3`
-	Default Command: `["hy"]`
...
ENV HY_VERSION=0.24.0
# Wed, 13 Jul 2022 08:18:22 GMT
ENV HYRULE_VERSION=0.2
# Wed, 13 Jul 2022 08:19:09 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Jul 2022 08:19:11 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:81e24910aa1636c4e02c3e062695fb17965be0c1309b42b4af152e7671ad6360`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e03178026b0e7e8ed0b29b72cf4b48c0d390afd71118862d4d6a8cb72a155ba0`  
		Last Modified: Wed, 13 Jul 2022 08:27:24 GMT  
		Size: 4.0 MB (3975850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
