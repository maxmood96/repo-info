...
```console
$ docker pull hylang@sha256:de573e6c63388719f48cb23dca5d92fdd0fc870a89d7d591d4e2ed7c046b741c
```
...
```console
$ docker pull hylang@sha256:3cc44459c84a88f73910952c4d2fd4ef6cd54c75f5b8bd26aea343a926042040
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.5 MB (76500398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:873de1f79497801db5f99899341143b50fcb1ed24a1d569ae8041679a566803c`
-	Default Command: `["hy"]`
...
# Fri, 11 Dec 2020 22:23:26 GMT
ENV PYTHON_PIP_VERSION=20.3.1
# Fri, 11 Dec 2020 22:23:27 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/91630a4867b1f93ba0a12aa81d0ec4ecc1e7eeb9/get-pip.py
# Fri, 11 Dec 2020 22:23:27 GMT
ENV PYTHON_GET_PIP_SHA256=d48ae68f297cac54db17e4107b800faae0e5210131f9f386c30c0166bf8d81b7
# Fri, 11 Dec 2020 22:23:45 GMT
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		wget 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		pypy3 get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	apt-get purge -y --auto-remove wget; 	pip --version; 		find /opt/pypy -depth 		\( 			\( -type d -a \( -name test -o -name tests \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 11 Dec 2020 22:23:45 GMT
CMD ["pypy3"]
# Sat, 12 Dec 2020 07:40:33 GMT
ENV HY_VERSION=0.19.0
# Sat, 12 Dec 2020 07:40:44 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sat, 12 Dec 2020 07:40:44 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:ca50cd1e9ae97c73203c8992d37da329ae8617326d3fc8b5691a14858ac1efcf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cfdf29eaffacd2bbeb6156343bc86e785a1258c17771eb43059a07354f94a08`  
		Last Modified: Fri, 11 Dec 2020 22:27:47 GMT  
		Size: 2.6 MB (2562122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67107b828e01d37946efeb0256978b1ccf96ecd4c45ae91f8dbb5e44bb86e7ca`  
		Last Modified: Sat, 12 Dec 2020 07:44:06 GMT  
		Size: 3.1 MB (3074142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
