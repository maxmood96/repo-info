## `hylang:0-python3.7-alpine3.18`

```console
$ docker pull hylang@sha256:3e827c1c7bb6d8e87143001d610f86466aeb30748e7ab09d2b9877bc466d7d60
```
...
### `hylang:0-python3.7-alpine3.18` - linux; amd64
...
### `hylang:0-python3.7-alpine3.18` - linux; arm variant v6
...
### `hylang:0-python3.7-alpine3.18` - linux; arm variant v7

```console
$ docker pull hylang@sha256:0a2835c3fecb3bc85e51767f00604fd2290a92f984d52082bd23becdf08ae2bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.2 MB (20182651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e02a669ed700755dff473967547d8ad53f2a84b31ead1d5fc7f357a0c4e63ddd`
-	Default Command: `["hy"]`
...
# Tue, 06 Jun 2023 23:32:36 GMT
CMD ["python3"]
# Thu, 15 Jun 2023 10:55:48 GMT
ENV HY_VERSION=0.26.0
# Thu, 15 Jun 2023 10:55:48 GMT
ENV HYRULE_VERSION=0.3.0
# Thu, 15 Jun 2023 10:56:05 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 15 Jun 2023 10:56:05 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:01dc09e22b665918beaf385fd844af1a3c130ca13441d5cd234d5fc58b78f86a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:859d8cca511daa26073b17450bd4b0a069d2e47852f0299fdd33431058819393`  
		Last Modified: Thu, 15 Jun 2023 11:00:45 GMT  
		Size: 3.7 MB (3692547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.7-alpine3.18` - linux; arm64 variant v8
...
### `hylang:0-python3.7-alpine3.18` - linux; 386
...
### `hylang:0-python3.7-alpine3.18` - linux; ppc64le

```console
$ docker pull hylang@sha256:1876420b364c604b1fb2743a93e298d2b70d587af7933aca5617817e9df4fb36
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **21.8 MB (21833511 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1570c269b58b40ff4ac769e40d347ec9b7973d59db84daeb7404eecea610fffd`
-	Default Command: `["hy"]`
...
# Tue, 06 Jun 2023 23:32:36 GMT
CMD ["python3"]
# Thu, 15 Jun 2023 15:00:59 GMT
ENV HY_VERSION=0.26.0
# Thu, 15 Jun 2023 15:01:00 GMT
ENV HYRULE_VERSION=0.3.0
# Thu, 15 Jun 2023 15:01:43 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 15 Jun 2023 15:01:44 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:bf28a960fbed9eea54ba8e89574bde83c4ae33f4c1499fece28b1963af39e0d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b12613d8cca004a529dfa08d0a26ae599508d6d27a5e6ffd207ada54839eb9cb`  
		Last Modified: Thu, 15 Jun 2023 15:07:40 GMT  
		Size: 3.7 MB (3692927 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.7-alpine3.18` - linux; s390x
