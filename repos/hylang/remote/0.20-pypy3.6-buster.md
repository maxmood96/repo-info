...
### `hylang:0.20-pypy3.6-buster` - linux; amd64
...
### `hylang:0.20-pypy3.6-buster` - linux; arm64 variant v8
...
### `hylang:0.20-pypy3.6-buster` - linux; 386
...
### `hylang:0.20-pypy3.6-buster` - linux; s390x
