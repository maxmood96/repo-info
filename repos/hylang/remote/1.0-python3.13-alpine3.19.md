...
### `hylang:1.0-python3.13-alpine3.19` - linux; amd64
...
### `hylang:1.0-python3.13-alpine3.19` - unknown; unknown
...
### `hylang:1.0-python3.13-alpine3.19` - linux; arm variant v6
...
### `hylang:1.0-python3.13-alpine3.19` - linux; arm variant v7
...
### `hylang:1.0-python3.13-alpine3.19` - linux; arm64 variant v8
...
### `hylang:1.0-python3.13-alpine3.19` - linux; 386
...
### `hylang:1.0-python3.13-alpine3.19` - linux; ppc64le
...
### `hylang:1.0-python3.13-alpine3.19` - linux; s390x
