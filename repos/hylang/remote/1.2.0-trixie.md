...
### `hylang:1.2.0-trixie` - linux; amd64
...
### `hylang:1.2.0-trixie` - unknown; unknown
...
### `hylang:1.2.0-trixie` - linux; arm variant v5
...
### `hylang:1.2.0-trixie` - linux; arm variant v7
...
### `hylang:1.2.0-trixie` - linux; arm64 variant v8
...
### `hylang:1.2.0-trixie` - linux; ppc64le
...
### `hylang:1.2.0-trixie` - linux; riscv64
...
### `hylang:1.2.0-trixie` - linux; s390x
