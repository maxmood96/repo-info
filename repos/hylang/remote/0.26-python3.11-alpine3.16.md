...
### `hylang:0.26-python3.11-alpine3.16` - linux; amd64
...
### `hylang:0.26-python3.11-alpine3.16` - linux; arm variant v6
...
### `hylang:0.26-python3.11-alpine3.16` - linux; arm variant v7
...
### `hylang:0.26-python3.11-alpine3.16` - linux; arm64 variant v8
...
### `hylang:0.26-python3.11-alpine3.16` - linux; 386
...
### `hylang:0.26-python3.11-alpine3.16` - linux; ppc64le
...
### `hylang:0.26-python3.11-alpine3.16` - linux; s390x
