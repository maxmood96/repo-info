...
```console
$ docker pull hylang@sha256:fac3ae2a638533755d0659b91b7796975a53f631d6971931634e1ce88ef1ae1a
```
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; amd64
...
### `hylang:0.29.0-python3.8-alpine3.18` - unknown; unknown
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; arm variant v6
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; arm variant v7
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; 386
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; ppc64le
...
### `hylang:0.29.0-python3.8-alpine3.18` - linux; s390x
