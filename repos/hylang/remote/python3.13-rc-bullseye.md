...
```console
$ docker pull hylang@sha256:c13bed03c76fd3a7ee71cc5b28503f5145a71ebc4ac447c03e332f138a200f48
```
...
### `hylang:python3.13-rc-bullseye` - linux; arm variant v5
...
### `hylang:python3.13-rc-bullseye` - linux; ppc64le
...
### `hylang:python3.13-rc-bullseye` - linux; s390x
