...
```console
$ docker pull hylang@sha256:30899128d35517af82ac92d245a0270d8ec4eda286b45b2e272ef7253b11f05d
```
...
```console
$ docker pull hylang@sha256:c13aa4b30a347f9bc9166d7b347a6e799f2979c7edab150115c64aeb05fd77c3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.7 MB (42698753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a056337123409cf6a3b1759fa084976a84df872cda902a017fc317420ba6125`
-	Default Command: `["hy"]`
...
# Wed, 03 Aug 2022 09:33:48 GMT
CMD ["python3"]
# Thu, 04 Aug 2022 13:34:30 GMT
ENV HY_VERSION=0.24.0
# Thu, 04 Aug 2022 13:34:30 GMT
ENV HYRULE_VERSION=0.2
# Thu, 04 Aug 2022 13:34:44 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 04 Aug 2022 13:34:44 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:15edfc7d407e7ece4373ccf1c0c637f1703b51a9bafa24e23852f85f3d965008`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9211698facf22213ca4459fc39986d027c570eb31daa107d685446af6132cd2`  
		Last Modified: Thu, 04 Aug 2022 13:43:38 GMT  
		Size: 3.6 MB (3645367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:034237a23e063289b6276b1e4b49196cf58d82f28a4f6c6e0f4013f5dc157c9c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.2 MB (46201245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ec6868a3c96f3edc5b9aa366cfe181c015d607c15e43601f78bdbe7ff229e2b`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=58.1.0
# Thu, 04 Aug 2022 08:04:02 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/aeca83c7ba7f9cdfd681103c4dcbf0214f6d742e/public/get-pip.py
# Thu, 04 Aug 2022 08:04:05 GMT
ENV PYTHON_GET_PIP_SHA256=d0b5909f3ab32dae9d115aa68a4b763529823ad5589c56af15cf816fca2773d6
# Thu, 04 Aug 2022 08:05:00 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Thu, 04 Aug 2022 08:05:03 GMT
CMD ["python3"]
# Thu, 04 Aug 2022 08:23:07 GMT
ENV HY_VERSION=0.24.0
# Thu, 04 Aug 2022 08:23:10 GMT
ENV HYRULE_VERSION=0.2
# Thu, 04 Aug 2022 08:24:11 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 04 Aug 2022 08:24:13 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:950cdb79959f5b477c942edc2ff01653d51135f46a5827c478a58b7f4a8ade75`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be02c75a68902d83ec4785db64005f9836a28614f108afc554f1184ee247fd61`  
		Last Modified: Thu, 04 Aug 2022 08:16:52 GMT  
		Size: 3.0 MB (2959511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f69e6b498329a50efa3f608d4e11eeb9c1fabfb49e9bbef8ec6349552a0452f`  
		Last Modified: Thu, 04 Aug 2022 08:32:13 GMT  
		Size: 3.6 MB (3643109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.24.0-python3.9-buster` - linux; ppc64le

```console
$ docker pull hylang@sha256:7928dbf0cd2be3bd62865b97bfcc02c6b6f88b9a3596d22a9f8475e0ce9493c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52679581 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2e35fe7d66120f2e7a454ccb5f879fa844267edee80b7f477a7bdae8fd9846e`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Wed, 03 Aug 2022 20:53:01 GMT
ENV HY_VERSION=0.24.0
# Wed, 03 Aug 2022 20:53:01 GMT
ENV HYRULE_VERSION=0.2
# Wed, 03 Aug 2022 20:53:32 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 03 Aug 2022 20:53:33 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:91432a56564abbd82faa67d7247315f0c4e3e489bfa86f99ce00f9b711dcca2e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70c24105a3eafcf0a9f3c4069460fcf7724c45cb6ba98327d0d5afc0c4094d73`  
		Last Modified: Wed, 03 Aug 2022 21:04:49 GMT  
		Size: 3.6 MB (3645560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
