...
```console
$ docker pull hylang@sha256:02e079577832f37907dbdf1886711da8de6edb127a0167bab8352060014f0cb6
```
...
```console
$ docker pull hylang@sha256:2c76d4a6a2d137977fdf3add34aa6cd34deb1de38bd73649b65c0df267708e1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48888970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32ce4208c2df91ee28326ccf9282279763b3272f89d06358f2bf70e401d38e49`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Tue, 02 Aug 2022 20:20:15 GMT
ENV HY_VERSION=0.24.0
# Tue, 02 Aug 2022 20:20:15 GMT
ENV HYRULE_VERSION=0.2
# Tue, 02 Aug 2022 20:20:33 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Tue, 02 Aug 2022 20:20:34 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:5414a334fb0ba387a8dedb22498f7762acdc8ce721a8888e68ebfe624293c444`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48739c347811097399d1515e5e620bff891952edc40a99d9ca0f64a420b188ce`  
		Last Modified: Tue, 02 Aug 2022 20:33:26 GMT  
		Size: 3.6 MB (3642558 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
