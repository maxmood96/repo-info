...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; amd64
...
### `hylang:1.1.0-python3.14-alpine3.22` - unknown; unknown
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; arm variant v6
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; arm variant v7
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; arm64 variant v8
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; 386
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; ppc64le
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; riscv64
...
### `hylang:1.1.0-python3.14-alpine3.22` - linux; s390x
