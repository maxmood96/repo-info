...
```console
$ docker pull hylang@sha256:ccaa5c1590fb0496447869cb4ff42135626d96bc828a4f3bff2c4e2fe8aa7463
```
...
### `hylang:0.29-python3.10-alpine3.18` - linux; arm variant v6
...
### `hylang:0.29-python3.10-alpine3.18` - linux; arm variant v7
...
### `hylang:0.29-python3.10-alpine3.18` - linux; s390x
