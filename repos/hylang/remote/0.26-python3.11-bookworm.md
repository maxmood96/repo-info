...
```console
$ docker pull hylang@sha256:3662aa08f42d038b850bd9ee1a26f2656f0d40a9ba14774d697f847813cafbc5
```
...
### `hylang:0.26-python3.11-bookworm` - linux; amd64
...
### `hylang:0.26-python3.11-bookworm` - linux; arm variant v5

```console
$ docker pull hylang@sha256:e10fd47605c5006a51d0b4de6115b4d401024d96b541da47261ac4d025ec4387
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 MB (55662552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7949a8bccb946a4dc475d81f78fabf7119fd102043fe87c30e560bf3237e5d5e`
-	Default Command: `["hy"]`
...
ENV HY_VERSION=0.26.0
# Wed, 21 Jun 2023 00:48:16 GMT
ENV HYRULE_VERSION=0.3.0
# Wed, 21 Jun 2023 00:48:29 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 21 Jun 2023 00:48:29 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:b6e247c2074dc943e5454620776a5771c5c7cd89de6aa462eb7507dadcd865f3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50a61593f7ca204e03ddd00cde493032b958019f7575087335dcfcbeed783e3e`  
		Last Modified: Wed, 21 Jun 2023 00:50:36 GMT  
		Size: 6.1 MB (6134407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.26-python3.11-bookworm` - linux; arm variant v7

```console
$ docker pull hylang@sha256:d1a0ac480f87f16b690dec98f752e07d2dfa4d69364526ba663c6186a1bed31c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52726150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c50c9f9887bce187b5249c20a6b55cf61957fbaa63bef1ab3104135ebc51c9f9`
-	Default Command: `["hy"]`
...
# Tue, 13 Jun 2023 17:45:16 GMT
CMD ["python3"]
# Wed, 21 Jun 2023 01:09:54 GMT
ENV HY_VERSION=0.26.0
# Wed, 21 Jun 2023 01:09:54 GMT
ENV HYRULE_VERSION=0.3.0
# Wed, 21 Jun 2023 01:10:07 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 21 Jun 2023 01:10:07 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:aac7aed21b572a2cbc28255f8939b4eb60aa3818742f8770f7c9f7e3011b8c7e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b444045aa5731900258489f1e225b0f0d4f4dd394ed06ae794f8a33b03ff9bc`  
		Last Modified: Wed, 21 Jun 2023 01:12:52 GMT  
		Size: 6.1 MB (6134516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.26-python3.11-bookworm` - linux; arm64 variant v8
...
### `hylang:0.26-python3.11-bookworm` - linux; 386
...
### `hylang:0.26-python3.11-bookworm` - linux; ppc64le
...
### `hylang:0.26-python3.11-bookworm` - linux; s390x
