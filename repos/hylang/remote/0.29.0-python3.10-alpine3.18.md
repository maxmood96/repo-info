...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; amd64
...
### `hylang:0.29.0-python3.10-alpine3.18` - unknown; unknown
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; arm variant v6
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; arm variant v7
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; arm64 variant v8
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; 386
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; ppc64le
...
### `hylang:0.29.0-python3.10-alpine3.18` - linux; s390x
