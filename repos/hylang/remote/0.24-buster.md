...
```console
$ docker pull hylang@sha256:f8e696eb3549b427febbca20f88d056c916ad8203de14fcaddb7de8b225aacb5
```
...
```console
$ docker pull hylang@sha256:60da218f4693fe0edfb1f0d1f6ccca24caf163cd4ff689276f63925137d68f48
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49249893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d22e341f271c7a5ad90a86ee4a8bbf4bb893fc7de29f77efe55344398e16c76`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:ee29c3416e00e08572d78201b72c6c2eb31e1c250462630d3cbf409444f1238d`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0faa113035047714119c72d0449ee7c1b5f61c582bcc5642789395947f8c8c92`  
		Last Modified: Fri, 12 Aug 2022 02:54:21 GMT  
		Size: 3.3 MB (3332751 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f098ba7be56262211ae15e4ac9ae1ddac8189171eb9af552c44447e33fd0d24`  
		Last Modified: Fri, 12 Aug 2022 03:43:53 GMT  
		Size: 4.0 MB (3995019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:f16f2e55abfbad986a924e4608b2124cb50e6d77176ce026a6d5cea69216645a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.6 MB (43631979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:662a32be02bdd21ee9ec3105bac2831a6ff242b73b725627b2d6dcc483f1e3b7`
-	Default Command: `["hy"]`
...
# Wed, 03 Aug 2022 07:37:52 GMT
CMD ["python3"]
# Thu, 04 Aug 2022 13:33:22 GMT
ENV HY_VERSION=0.24.0
# Thu, 04 Aug 2022 13:33:22 GMT
ENV HYRULE_VERSION=0.2
# Thu, 04 Aug 2022 13:33:34 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Thu, 04 Aug 2022 13:33:34 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:63553e45b8c229126124c67b83c3ad7c01219457edb92af541e0fe443215684a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:103990570417cde1a28dd81fdac9e7cd5407b799828e09594584c5e7d912b902`  
		Last Modified: Thu, 04 Aug 2022 13:41:43 GMT  
		Size: 4.0 MB (3994897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.24-buster` - linux; arm64 variant v8

```console
$ docker pull hylang@sha256:74ff5c405a9d76b92094bf801209b56c899aaa8e9410f3e4d5e3c6d40fa1babc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.7 MB (47671771 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04b1bf0e2022203c856f8de1012d69e324c92209c48e67a7ab4b6c808d3e7167`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=63.2.0
# Fri, 12 Aug 2022 03:07:17 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 03:07:18 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 03:07:30 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 03:07:30 GMT
CMD ["python3"]
# Fri, 12 Aug 2022 03:50:54 GMT
ENV HY_VERSION=0.24.0
# Fri, 12 Aug 2022 03:50:55 GMT
ENV HYRULE_VERSION=0.2
# Fri, 12 Aug 2022 03:51:07 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 12 Aug 2022 03:51:08 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:a436d95a54a63029dcf7f77e408912c5885a473a345bce18d23f621a59c63c48`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49c4b03676b78f44076a7356cca9ef824432519ebe7db3bd3aadee57418f97b9`  
		Last Modified: Fri, 12 Aug 2022 03:18:39 GMT  
		Size: 3.1 MB (3119540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:447931b956a402378eb0f26be3fe64abc770ae88a684a0ad15888048b514dea7`  
		Last Modified: Fri, 12 Aug 2022 04:00:19 GMT  
...
```console
$ docker pull hylang@sha256:207084cbdb12b474906c0a8133b9b3591b025a5b31ede1c42cd6daa95445e3c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49837245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a19c1733dd2e1eb77a4b7b44cd32313df758748fb6b6f4daad83dfe36ba39229`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=63.2.0
# Fri, 12 Aug 2022 03:33:40 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/5eaac1050023df1f5c98b173b248c260023f2278/public/get-pip.py
# Fri, 12 Aug 2022 03:33:41 GMT
ENV PYTHON_GET_PIP_SHA256=5aefe6ade911d997af080b315ebcb7f882212d070465df544e1175ac2be519b4
# Fri, 12 Aug 2022 03:33:54 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 12 Aug 2022 03:33:54 GMT
CMD ["python3"]
# Fri, 12 Aug 2022 04:15:14 GMT
ENV HY_VERSION=0.24.0
# Fri, 12 Aug 2022 04:15:15 GMT
ENV HYRULE_VERSION=0.2
# Fri, 12 Aug 2022 04:15:30 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Fri, 12 Aug 2022 04:15:31 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:9bda146616dfdbd9142020abe0474fd95f7b23d75a6b1ad61564e656e9907ec5`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba683c48a649a8ccf01d8af1f9a5d16dd5300ff38350f356668ec6f68b4f92a3`  
		Last Modified: Fri, 12 Aug 2022 03:46:01 GMT  
		Size: 3.1 MB (3119501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4aa7068bcb81d58735074e74aec13005aa7641364fb4f05b554c36a031a0e07`  
		Last Modified: Fri, 12 Aug 2022 04:25:48 GMT  
		Size: 4.0 MB (3992826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
