...
```console
$ docker pull hylang@sha256:3d05cf57b152d3c04eed6677ac391990e33aa667c09afd8fcadd99d335ba5cde
```
...
```console
$ docker pull hylang@sha256:7f80ef94f5491d6458937231d023def6ea994cff65426a40e110cd40704d5b8f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.3 MB (20291992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9296f81fefd735038d317e11ff584c94001fb47d755ee294add5fd616b8bc5e`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:cf9b895594a7a5a8a4d85c2b59aefffd57efee47bb673a7a96925f229951f14f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:898efc43ba748028a172cdaa180a664c773b4e6a980dbee19a735fcf9077c542`  
		Last Modified: Tue, 29 Jun 2021 02:53:11 GMT  
		Size: 3.3 MB (3301037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:6917f34a4afce67f7c12d05f4f910d9529d2a3ce506ff831d42bb7e1fac6449a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **21.7 MB (21676240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b80b10c04b84431c5c99bd4f06dadd9e50c4f922d06562b2f6a2936bf57b6b5`
-	Default Command: `["hy"]`
...
RUN set -eux; 	apk add --no-cache 		ca-certificates 		tzdata 	;
# Sun, 27 Jun 2021 05:19:16 GMT
ENV GPG_KEY=A035C8C19219BA821ECEA86B64E628F8D684696D
# Sun, 27 Jun 2021 05:19:25 GMT
ENV PYTHON_VERSION=3.10.0b2
# Sun, 27 Jun 2021 05:28:26 GMT
RUN set -ex 	&& apk add --no-cache --virtual .fetch-deps 		gnupg 		tar 		xz 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& apk add --no-cache --virtual .build-deps  		bluez-dev 		bzip2-dev 		coreutils 		dpkg-dev dpkg 		expat-dev 		findutils 		gcc 		gdbm-dev 		libc-dev 		libffi-dev 		libnsl-dev 		libtirpc-dev 		linux-headers 		make 		ncurses-dev 		openssl-dev 		pax-utils 		readline-dev 		sqlite-dev 		tcl-dev 		tk 		tk-dev 		util-linux-dev 		xz-dev 		zlib-dev 	&& apk del --no-network .fetch-deps 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		EXTRA_CFLAGS="-DTHREAD_STACK_SIZE=0x100000" 		LDFLAGS="-Wl,--strip-all" 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 		\) -exec rm -rf '{}' + 		&& find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec scanelf --needed --nobanner --format '%n#p' '{}' ';' 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		| xargs -rt apk add --no-cache --virtual .python-rundeps 	&& apk del --no-network .build-deps 		&& python3 --version
# Sun, 27 Jun 2021 05:28:37 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sun, 27 Jun 2021 05:28:42 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sun, 27 Jun 2021 05:28:46 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sun, 27 Jun 2021 05:28:50 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sun, 27 Jun 2021 05:29:14 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sun, 27 Jun 2021 05:29:19 GMT
CMD ["python3"]
# Sun, 27 Jun 2021 21:24:48 GMT
ENV HY_VERSION=1.0a1
# Sun, 27 Jun 2021 21:25:37 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sun, 27 Jun 2021 21:25:41 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:8d58a48984c26a906960cfbc07253f6a58e206be146726542ad8eab6d0070d16`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a57382444f3d30440e033cd12da5a2778cfe0ce1c6e714c3a901e2118440437`  
		Last Modified: Sun, 27 Jun 2021 09:02:08 GMT  
		Size: 12.6 MB (12554653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3372b6b41651e32128be5f8633a318a9d86e509ed9e63f7edd21e79694285521`  
		Last Modified: Sun, 27 Jun 2021 09:02:05 GMT  
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b81103ae1c4286bbbc381750239101c4dc8ff0bfe8f9bd3af4b2f70e5cbfbf59`  
		Last Modified: Sun, 27 Jun 2021 09:02:06 GMT  
		Size: 2.3 MB (2348489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9668d695d13bf59fb9aec309e349503c0dc49b32f7111a8f766547ea0ee77084`  
		Last Modified: Sun, 27 Jun 2021 21:32:36 GMT  
		Size: 3.3 MB (3301501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.10-rc-alpine3.12` - linux; s390x

```console
$ docker pull hylang@sha256:0e229f596ce718df7cb66d24acc32dec9f750eea5017a5db17682db95aca83bf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.6 MB (20617324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbf7b1a9a90125007b7faf42b274be232536e82dd138c8c5817a60455040ca1f`
-	Default Command: `["hy"]`
...
RUN set -eux; 	apk add --no-cache 		ca-certificates 		tzdata 	;
# Sat, 26 Jun 2021 22:01:52 GMT
ENV GPG_KEY=A035C8C19219BA821ECEA86B64E628F8D684696D
# Sat, 26 Jun 2021 22:01:52 GMT
ENV PYTHON_VERSION=3.10.0b2
# Sat, 26 Jun 2021 22:07:28 GMT
RUN set -ex 	&& apk add --no-cache --virtual .fetch-deps 		gnupg 		tar 		xz 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& apk add --no-cache --virtual .build-deps  		bluez-dev 		bzip2-dev 		coreutils 		dpkg-dev dpkg 		expat-dev 		findutils 		gcc 		gdbm-dev 		libc-dev 		libffi-dev 		libnsl-dev 		libtirpc-dev 		linux-headers 		make 		ncurses-dev 		openssl-dev 		pax-utils 		readline-dev 		sqlite-dev 		tcl-dev 		tk 		tk-dev 		util-linux-dev 		xz-dev 		zlib-dev 	&& apk del --no-network .fetch-deps 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		EXTRA_CFLAGS="-DTHREAD_STACK_SIZE=0x100000" 		LDFLAGS="-Wl,--strip-all" 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 		\) -exec rm -rf '{}' + 		&& find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec scanelf --needed --nobanner --format '%n#p' '{}' ';' 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		| xargs -rt apk add --no-cache --virtual .python-rundeps 	&& apk del --no-network .build-deps 		&& python3 --version
# Sat, 26 Jun 2021 22:07:29 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sat, 26 Jun 2021 22:07:29 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sat, 26 Jun 2021 22:07:29 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sat, 26 Jun 2021 22:07:30 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sat, 26 Jun 2021 22:07:36 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sat, 26 Jun 2021 22:07:37 GMT
CMD ["python3"]
# Sun, 27 Jun 2021 15:43:49 GMT
ENV HY_VERSION=1.0a1
# Sun, 27 Jun 2021 15:43:58 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sun, 27 Jun 2021 15:44:00 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:a12ade977e13736445796e30fc24cb689f54809963e67ee9bff9308573a3b4bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29c4b064df4265d11f9ecf2e15766225bfb7b4a0754a0c126d7ad943d60656c3`  
		Last Modified: Sun, 27 Jun 2021 11:32:40 GMT  
		Size: 11.7 MB (11738749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b9672d850a04f85fc57af2d990193757e18a31659e1f1624b92d4514ed1b402`  
		Last Modified: Sun, 27 Jun 2021 11:32:33 GMT  
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be1ecf49475fc4a889755513e5d9de233e2365c493c4ab242fe2bb6ba11e5b13`  
		Last Modified: Sun, 27 Jun 2021 11:32:34 GMT  
		Size: 2.3 MB (2348399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75283715ca7e06562aa69c0f1a0b7a97e645440bebc129a89e65a262c3dca7a5`  
		Last Modified: Sun, 27 Jun 2021 15:49:52 GMT  
		Size: 3.3 MB (3300987 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
