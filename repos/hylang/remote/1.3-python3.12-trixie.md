...
### `hylang:1.3-python3.12-trixie` - linux; amd64
...
### `hylang:1.3-python3.12-trixie` - unknown; unknown
...
### `hylang:1.3-python3.12-trixie` - linux; arm variant v5
...
### `hylang:1.3-python3.12-trixie` - linux; arm variant v7
...
### `hylang:1.3-python3.12-trixie` - linux; arm64 variant v8
...
### `hylang:1.3-python3.12-trixie` - linux; 386
...
### `hylang:1.3-python3.12-trixie` - linux; ppc64le
...
### `hylang:1.3-python3.12-trixie` - linux; riscv64
...
### `hylang:1.3-python3.12-trixie` - linux; s390x
