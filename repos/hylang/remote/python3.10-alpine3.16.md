...
```console
$ docker pull hylang@sha256:2cf627d2f18ecede656781fa9bd048d9a2bdb6c3619f629a36ebcd11e9a9bb0c
```
...
```console
$ docker pull hylang@sha256:cb0a04137f4fcb7fba51703f03c89e80a60739bdf4b501371ee6491fe9bf5e3b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.3 MB (23304430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7eb9a86a32b14ec6c0afa5eb58cba1729838d8a175b54706bcd311d666eaff1`
-	Default Command: `["hy"]`
...
# Thu, 08 Dec 2022 00:42:56 GMT
ENV PYTHON_PIP_VERSION=22.3.1
# Fri, 06 Jan 2023 23:44:44 GMT
ENV PYTHON_SETUPTOOLS_VERSION=65.5.1
# Fri, 06 Jan 2023 23:44:45 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/66030fa03382b4914d4c4d0896961a0bdeeeb274/public/get-pip.py
# Fri, 06 Jan 2023 23:44:46 GMT
ENV PYTHON_GET_PIP_SHA256=1e501cf004eac1b7eb1f97266d28f995ae835d30250bec7f8850562703067dc6
# Fri, 06 Jan 2023 23:44:56 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Fri, 06 Jan 2023 23:44:58 GMT
CMD ["python3"]
# Sat, 07 Jan 2023 00:10:30 GMT
ENV HY_VERSION=0.25.0
# Sat, 07 Jan 2023 00:10:31 GMT
ENV HYRULE_VERSION=0.2.1
# Sat, 07 Jan 2023 00:10:44 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Sat, 07 Jan 2023 00:10:46 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:8b1625ad8e1f11da7e3038898d98ed04b1feba92f588a1d23ad3c03c4c701ea7`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bd8a3c7f3f22f0fcb98cd58ffd9a6fc121f6a561fddecb71e27789a14135b28`  
		Last Modified: Fri, 06 Jan 2023 23:51:53 GMT  
		Size: 3.1 MB (3056436 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40bbd1e18d926bc760c40af887a03873c23cded4e5fcdaecb220b289672f2bda`  
		Last Modified: Sat, 07 Jan 2023 00:17:48 GMT  
		Size: 4.1 MB (4133670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
