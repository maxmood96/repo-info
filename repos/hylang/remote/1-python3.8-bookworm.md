...
### `hylang:1-python3.8-bookworm` - linux; amd64
...
### `hylang:1-python3.8-bookworm` - unknown; unknown
...
### `hylang:1-python3.8-bookworm` - linux; arm variant v5
...
### `hylang:1-python3.8-bookworm` - linux; arm variant v7
...
### `hylang:1-python3.8-bookworm` - linux; arm64 variant v8
...
### `hylang:1-python3.8-bookworm` - linux; 386
...
### `hylang:1-python3.8-bookworm` - linux; mips64le
...
### `hylang:1-python3.8-bookworm` - linux; ppc64le
...
### `hylang:1-python3.8-bookworm` - linux; s390x
