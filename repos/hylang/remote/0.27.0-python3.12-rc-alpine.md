...
```console
$ docker pull hylang@sha256:b910013c9a2b9ee174777b1bb62644956695706d832fc0f81e6b1135edc061b6
```
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; amd64
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; arm variant v6
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; arm variant v7
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; arm64 variant v8
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; 386
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; ppc64le
...
### `hylang:0.27.0-python3.12-rc-alpine` - linux; s390x
