...
### `hylang:1.0-python3.13-rc-bookworm` - linux; amd64
...
### `hylang:1.0-python3.13-rc-bookworm` - unknown; unknown
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; arm variant v5
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; arm variant v7
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; arm64 variant v8
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; 386
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; ppc64le
...
### `hylang:1.0-python3.13-rc-bookworm` - linux; s390x
