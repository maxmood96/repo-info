...
### `hylang:1-python3.8-alpine` - linux; amd64
...
### `hylang:1-python3.8-alpine` - unknown; unknown
...
### `hylang:1-python3.8-alpine` - linux; arm variant v6
...
### `hylang:1-python3.8-alpine` - linux; arm variant v7
...
### `hylang:1-python3.8-alpine` - linux; arm64 variant v8
...
### `hylang:1-python3.8-alpine` - linux; 386
...
### `hylang:1-python3.8-alpine` - linux; ppc64le
...
### `hylang:1-python3.8-alpine` - linux; riscv64
...
### `hylang:1-python3.8-alpine` - linux; s390x
