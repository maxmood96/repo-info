...
```console
$ docker pull hylang@sha256:8f75edc43578aaca9f0df3271e7e54be69a10546985ea3b1aa6ce2c4d47ee626
```
...
```console
$ docker pull hylang@sha256:41532c363acb14bda39f7a0841b3a0fca8fed6930cdb5691516ea3b6020ab331
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.9 MB (45934436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ac37eec6ff21967dcbda097cc5443b802cfdd311c39643f6b6c5b3dc42c4268`
-	Default Command: `["hy"]`
...
# Fri, 11 Dec 2020 14:04:03 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/91630a4867b1f93ba0a12aa81d0ec4ecc1e7eeb9/get-pip.py
# Fri, 11 Dec 2020 14:04:04 GMT
ENV PYTHON_GET_PIP_SHA256=d48ae68f297cac54db17e4107b800faae0e5210131f9f386c30c0166bf8d81b7
# Fri, 11 Dec 2020 14:04:19 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 11 Dec 2020 14:04:20 GMT
CMD ["python3"]
# Sat, 12 Dec 2020 07:39:27 GMT
ENV HY_VERSION=0.19.0
# Sat, 12 Dec 2020 07:39:37 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sat, 12 Dec 2020 07:39:37 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:4df932ffe13779e6bc7bd20fd5c3c53d94170fd2646d0d89cc143619c26014ff`  
		...
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:213ddeac24e08dbc6f442f3d59e174fb5df950c7157c54cd0c6a96e0eb321849`  
		Last Modified: Fri, 11 Dec 2020 20:44:49 GMT  
		Size: 2.4 MB (2424317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2db8d4b1238038e73b70ab19a67f651691f81039de03b902ca17d9560a787856`  
		Last Modified: Sat, 12 Dec 2020 07:43:13 GMT  
		Size: 2.8 MB (2822493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
