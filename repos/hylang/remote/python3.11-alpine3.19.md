...
```console
$ docker pull hylang@sha256:c70b379f9273463e39ffdab38bf248142466af14695192fa548eed791902e497
```
...
```console
$ docker pull hylang@sha256:d6633dfc43d61ea8be813ecb3446d6a2f737b287731d948453826c55ec5ef147
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.3 MB (26335956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c283f8d9326b3095503ddbea1738a8b4cb2a759240d213c367d8fea301bd921`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:567fea9b804fe895b56707d265b639da861ccad0b08d0224c3ad7a69ff16aba3`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4df265d70daec80f7af700bbf0ec38a1fda8f9599148cccf507bb04fbff2407a`  
		Last Modified: Tue, 30 Jan 2024 04:05:22 GMT  
		Size: 6.1 MB (6111388 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `hylang:python3.11-alpine3.19` - unknown; unknown

```console
$ docker pull hylang@sha256:a83cde9e302209eeaef904cd728b25304da08ba8fd0a05403d689cab0c1641fe
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **871.2 KB (871191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69e5014ff67e685b19c234b78948a6f04381af06544352b8159bfe874107f453`

```dockerfile
```

-	Layers:
	-	`sha256:cb6801414cf434da1261d1dfe0a0940e1e6193dbba609ce786c1e051db620a25`  
		Last Modified: Tue, 30 Jan 2024 04:05:22 GMT  
		Size: 860.7 KB (860675 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:33ceaf923dead504a551d9ad904e62e216cc66dd4f8a833bd9c580faa8bd6ea7`  
		Last Modified: Tue, 30 Jan 2024 04:05:21 GMT  
