...
```console
$ docker pull hylang@sha256:b7614625df04a802a2a0ea2e622a5578314652845fadebbfbcdbbec60b1de74a
```
...
```console
$ docker pull hylang@sha256:ef0226861b0ef1fa73542dcb43f5dee48fe94800cb6d034aeec5c2d471d5bf1b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **21.2 MB (21216555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0dcf5ffff796abbfcfe23cc1507326f415e30c27bc11a8a9ffac8907a48f45c`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Wed, 09 Nov 2022 00:57:30 GMT
ENV HY_VERSION=0.25.0
# Wed, 09 Nov 2022 00:57:30 GMT
ENV HYRULE_VERSION=0.2.1
# Wed, 09 Nov 2022 00:57:44 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 09 Nov 2022 00:57:44 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:c752ca6c9d0b5baf019814ed39fd8b710b266a0f344d5f3e75902af055bfcb99`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdb90e61156c2ca54611f5beafb5bb4f74f13e78472ea94f12c81b383f3c602f`  
		Last Modified: Wed, 09 Nov 2022 01:10:55 GMT  
