...
```console
$ docker pull hylang@sha256:1700a55de1720bc352b9ef758b6b889a40850ee17315d9920a7664b76395edf5
```
...
```console
$ docker pull hylang@sha256:049e6fee2f929184a0f4000dcbd4e7c68c95597bfe93eba7905bf1e4c9583865
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51604937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78a57ea5b9a99cc20e0b4f8c659e7c1f76cdfd6e63784868f447c3f7200bcf3a`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 27 Jul 2022 01:48:03 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/49ca29908cfd49683da12f2d5a4fa5689539f9d9/public/get-pip.py
# Wed, 27 Jul 2022 01:48:04 GMT
ENV PYTHON_GET_PIP_SHA256=d077d469ce4c0beaf9cc97b73f8164ad20e68e0519f14dd886ce35d053721501
# Wed, 27 Jul 2022 01:48:17 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 27 Jul 2022 01:48:18 GMT
CMD ["python3"]
# Wed, 27 Jul 2022 02:29:52 GMT
ENV HY_VERSION=0.24.0
# Wed, 27 Jul 2022 02:29:53 GMT
ENV HYRULE_VERSION=0.2
# Wed, 27 Jul 2022 02:30:13 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 27 Jul 2022 02:30:13 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:487e8d7816941c7ceca514357532eb63913bf262a841c436d8e63a48514872e7`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a96205ebfd7ec4002421411ab4f22e69a3c8ced3611cc13332ac1bfa4a12c26b`  
		Last Modified: Wed, 27 Jul 2022 01:59:51 GMT  
		Size: 3.0 MB (2961057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f964163046f1bec21fdb3192ce91490a1aace0e4c9864389df1e922ff8633df`  
		Last Modified: Wed, 27 Jul 2022 02:40:52 GMT  
		Size: 3.7 MB (3746581 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
