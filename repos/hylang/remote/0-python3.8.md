...
```console
$ docker pull hylang@sha256:2fd883fdc9da82f5f7ba6be94db029f3031754068bc5db83efafc72309d2001f
```
...
```console
$ docker pull hylang@sha256:8d0ef6b3ff11d750eafe0c6347d19314f2d212642b850dc660d46f181ebbcfbd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50125875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cdaaf88e1a22286178b6660637f4dccbd46edc72c19eb60699045b925cbbe21`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Wed, 16 Dec 2020 01:07:58 GMT
ENV HY_VERSION=0.19.0
# Wed, 16 Dec 2020 01:08:50 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Wed, 16 Dec 2020 01:09:01 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:4856be3333a033d42b2b4f9d5c2a8ab3679c9f1c9960fa222b472347a6550caa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0a2c55b531aadf25963a58abbc124d012e44639de55c3089e77ad5cc52f418b`  
		Last Modified: Wed, 16 Dec 2020 01:20:23 GMT  
		Size: 2.9 MB (2875123 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `hylang:0-python3.8` - windows version 10.0.17763.1637; amd64
...
### `hylang:0-python3.8` - windows version 10.0.14393.4104; amd64
