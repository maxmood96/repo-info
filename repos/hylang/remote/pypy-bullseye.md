...
```console
$ docker pull hylang@sha256:f0eb657b8cabe20870fe00ed5c988814246c5bd2b9971cdd806b34606482ebf6
```
...
```console
$ docker pull hylang@sha256:95358fbab2d4acbd66c21e7cbc7721a4133dcf6b13dc5bfc8bc32ada3fbb2f8d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.6 MB (72634234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e61568d66567dac4a3e359a59d99cb1aa5993c7476fd91c560692840f3c0cec`
-	Default Command: `["hy"]`
...
# Tue, 06 Dec 2022 06:45:00 GMT
CMD ["pypy3"]
# Tue, 06 Dec 2022 17:46:58 GMT
ENV HY_VERSION=0.25.0
# Tue, 06 Dec 2022 17:46:58 GMT
ENV HYRULE_VERSION=0.2.1
# Tue, 06 Dec 2022 17:47:32 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Tue, 06 Dec 2022 17:47:32 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:56034302e69f83d8d5f7ed42cbb83dfd4f97b8ebc3418c4e6a6a0834c16d9484`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b93e55cde18eb5b7040571c312666d2dd09f3d4a4664f61d5991425acb10d28`  
		Last Modified: Tue, 06 Dec 2022 17:55:53 GMT  
		Size: 4.0 MB (4031609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:pypy-bullseye` - linux; 386

```console
$ docker pull hylang@sha256:2e99a81cf7a1641075c8b4f83c9a5fb2a9d3abf2e355c6b228fccf3ed7d76a95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.1 MB (76131696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aac3524d99cb0a5f8ccf2400f0629357d264cdceb7e33ed6d457f41962b7d350`
-	Default Command: `["hy"]`
...
CMD ["pypy3"]
# Tue, 06 Dec 2022 19:55:15 GMT
ENV HY_VERSION=0.25.0
# Tue, 06 Dec 2022 19:55:15 GMT
ENV HYRULE_VERSION=0.2.1
# Tue, 06 Dec 2022 19:55:55 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Tue, 06 Dec 2022 19:55:56 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:d04447bafe18c12019613976a3161e9387c8df3734b6116006dd745df90db561`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5c53c2d3ef03b67b1b5566d6eab24d9f41470791a2a80d613adfcf3f7aefc13`  
		Last Modified: Tue, 06 Dec 2022 20:08:40 GMT  
		Size: 4.0 MB (4031738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
