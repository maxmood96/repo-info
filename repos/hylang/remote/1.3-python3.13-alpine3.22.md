...
```console
$ docker pull hylang@sha256:8a3810eefe719b103a92111fbf804322367a694266a879da02cd7b4dc6699ffe
```
...
### `hylang:1.3-python3.13-alpine3.22` - linux; amd64
...
### `hylang:1.3-python3.13-alpine3.22` - unknown; unknown
...
### `hylang:1.3-python3.13-alpine3.22` - linux; arm variant v6
...
### `hylang:1.3-python3.13-alpine3.22` - linux; arm variant v7
...
### `hylang:1.3-python3.13-alpine3.22` - linux; arm64 variant v8
...
### `hylang:1.3-python3.13-alpine3.22` - linux; 386
...
### `hylang:1.3-python3.13-alpine3.22` - linux; ppc64le
...
### `hylang:1.3-python3.13-alpine3.22` - linux; s390x
