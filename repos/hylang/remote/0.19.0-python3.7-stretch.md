...
```console
$ docker pull hylang@sha256:434603ac547c13e79a1980a9b4828a6163664ccfa61cfa81b5eac9d27b308f04
```
...
### `hylang:0.19.0-python3.7-stretch` - linux; mips64le
...
### `hylang:0.19.0-python3.7-stretch` - linux; ppc64le
...
### `hylang:0.19.0-python3.7-stretch` - linux; s390x
