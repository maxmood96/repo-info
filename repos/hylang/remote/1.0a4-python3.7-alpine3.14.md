...
```console
$ docker pull hylang@sha256:8f18a32c945f78d0c0aeb76b849541a6615746123b05774c18b1bef87f1761a5
```
...
```console
$ docker pull hylang@sha256:5ef7e52714b27099019ec09152b2432f9ba6831efdbe14b3f4c1822491470d13
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **19.2 MB (19243783 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a7c1e03747875f28f457bfcb2db1cdb68490e4c663763d4eb8fcfd67d5c36d9`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 18 May 2022 07:51:46 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2d26a16e351a22108b46fa11507aa57a732d4074/public/get-pip.py
# Wed, 18 May 2022 07:51:46 GMT
ENV PYTHON_GET_PIP_SHA256=530e7077f9e31f0378b5ee7cc90c8d99b7aef832f3d4ea96b42c2072e322734e
# Wed, 18 May 2022 07:52:01 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 18 May 2022 07:52:02 GMT
CMD ["python3"]
# Wed, 18 May 2022 09:48:30 GMT
ENV HY_VERSION=1.0a4
# Wed, 18 May 2022 09:48:30 GMT
ENV HYRULE_VERSION=0.1
# Wed, 18 May 2022 09:48:38 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 18 May 2022 09:48:38 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:b1c2730256b29e2f9745f0b39e6818b86dfc540f9fde7da507ca58886709710e`  
		...
		Size: 230.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a23296fc54abac81e72695a9c314746fcd2272835bccc8299b453233c08a547`  
		Last Modified: Wed, 18 May 2022 08:08:59 GMT  
		Size: 2.9 MB (2873997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16abe0fa8899aab253e0ad65466d43d7091ea61bb85b5ce9fe9f9438ccaaf8b7`  
		Last Modified: Wed, 18 May 2022 09:57:28 GMT  
		Size: 2.9 MB (2896052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:1b64a8f496ef7ee76ba33fc0944115854a59f339e6901a3cf1d01750b7e69713
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.8 MB (20772091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4727cc1b46ea80a6da175b0ad180e1e5952814db6cea8b9b7513760ccf6030f`
-	Default Command: `["hy"]`
...
ENV PYTHON_SETUPTOOLS_VERSION=57.5.0
# Wed, 18 May 2022 05:58:20 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/2d26a16e351a22108b46fa11507aa57a732d4074/public/get-pip.py
# Wed, 18 May 2022 05:58:22 GMT
ENV PYTHON_GET_PIP_SHA256=530e7077f9e31f0378b5ee7cc90c8d99b7aef832f3d4ea96b42c2072e322734e
# Wed, 18 May 2022 05:58:45 GMT
RUN set -eux; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		export PYTHONDONTWRITEBYTECODE=1; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		--no-compile 		"pip==$PYTHON_PIP_VERSION" 		"setuptools==$PYTHON_SETUPTOOLS_VERSION" 	; 	rm -f get-pip.py; 		pip --version
# Wed, 18 May 2022 05:58:47 GMT
CMD ["python3"]
# Wed, 18 May 2022 07:53:04 GMT
ENV HY_VERSION=1.0a4
# Wed, 18 May 2022 07:53:08 GMT
ENV HYRULE_VERSION=0.1
# Wed, 18 May 2022 07:53:38 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 18 May 2022 07:53:44 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:9830c8e846350109e985392f5ee9707c924a0cb4ffb929584984280abd4e2a7a`  
		...
		Size: 230.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a54f7f84d1bf1624d8336330d1f157186fb5eba4b6a4a3bd76ade94791620ad4`  
		Last Modified: Wed, 18 May 2022 06:12:05 GMT  
		Size: 2.9 MB (2873997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:054528fa20f5f17dfde1933785dc2e7a2680ecef8c7b3d2546b417c1a535d793`  
		Last Modified: Wed, 18 May 2022 08:01:10 GMT  
		Size: 2.9 MB (2896420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
