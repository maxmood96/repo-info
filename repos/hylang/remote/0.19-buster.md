...
```console
$ docker pull hylang@sha256:243c6c877240b3894052a73fc3af07591e8d7ee1abe203beaae3697b18750db9
```
...
```console
$ docker pull hylang@sha256:62e1dfe5f6e2868e33b8700f6c8509ce6f3b88df977552b40857de392bac1be2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.0 MB (44001561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebde58fb2c166543225fdd606ff81a82d5d98f586eed4ec7e1f5977517c1f3e1`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Tue, 22 Dec 2020 19:34:49 GMT
ENV HY_VERSION=0.19.0
# Tue, 22 Dec 2020 19:34:58 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Tue, 22 Dec 2020 19:35:00 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:fbf8c1c0481c22493101f52af3ce7efcf340deb57084bf4646bb99d89f66599a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:291cacba2c561e54bf7ed4ee9637a4c55ccc50f89a2e610353167a4fec09e674`  
		Last Modified: Tue, 22 Dec 2020 19:36:10 GMT  
