...
```console
$ docker pull hylang@sha256:d0c5dc4813c561e4d120b35c2b1030a1bd9484c8a81c7543490b87df182983a0
```
...
```console
$ docker pull hylang@sha256:5381aa78324e72a821a4077c9632a36b7643ca53388a869821de314af3bbee65
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50873238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b267ac4cbe9d51c620ea97e377abd52593f8247b80a682cf61bfbae1b89dc4d9`
-	Default Command: `["hy"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Fri, 24 Jan 2020 09:16:27 GMT
ENV PYTHON_PIP_VERSION=20.0.1
# Fri, 24 Jan 2020 09:16:27 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/ffe826207a010164265d9cc807978e3604d18ca0/get-pip.py
# Fri, 24 Jan 2020 09:16:28 GMT
ENV PYTHON_GET_PIP_SHA256=b86f36cc4345ae87bfd4f10ef6b2dbfa7a872fbff70608a1e43944d283fd0eee
# Fri, 24 Jan 2020 09:16:56 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Fri, 24 Jan 2020 09:16:56 GMT
CMD ["python3"]
# Fri, 24 Jan 2020 10:07:53 GMT
ENV HY_VERSION=0.17.0
# Fri, 24 Jan 2020 10:08:04 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Fri, 24 Jan 2020 10:08:05 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:d24ac3478399c87a56bfb95df2db4133089df38815925df084ec0b97597e2411`  
		...
		Size: 240.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abd8fc4a89ba5ff26d404c46523d17709102162263176e316001eed6aedcc2e0`  
		Last Modified: Fri, 24 Jan 2020 09:29:04 GMT  
		Size: 2.2 MB (2230479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51365117b36bd58f8e06eb293e5c0ddeee0bdb34cdcb822476afc56e79d1c3cc`  
		Last Modified: Fri, 24 Jan 2020 10:12:24 GMT  
		Size: 2.8 MB (2795461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.17.0-python3.6-stretch` - linux; 386

```console
$ docker pull hylang@sha256:544318a1b2e073d874dbeab6e25722ee46756a796f23b765f1f390a2fe64ab31
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53532202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f197d4d25582ef7e1a69a1c012045c81d6e92dddf33b417d48b049ef59e03554`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Fri, 24 Jan 2020 10:30:38 GMT
ENV HY_VERSION=0.17.0
# Fri, 24 Jan 2020 10:30:45 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Fri, 24 Jan 2020 10:30:46 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:9c88d2e93c49bfbf10f8c5bcbc17d59e1609a2cb2e66090d90c4b2da852ef842`  
		...
		Size: 239.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:132286de8de2618b3b0a998305acb472a8d81b056a93aca2699f30e0e18ce3a2`  
		Last Modified: Fri, 24 Jan 2020 03:43:08 GMT  
		Size: 2.2 MB (2230235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:975ba968695d75a6eeac50f7af5f38a991a6650e9bc68fd6083712f3370cf0c4`  
		Last Modified: Fri, 24 Jan 2020 10:35:06 GMT  
		Size: 2.8 MB (2795320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
