...
```console
$ docker pull hylang@sha256:ff15b969ada15cedc882c9e8c42b686b9d6048e72784f25e4d26340de86f4502
```
...
### `hylang:1.3-python3.11-bookworm` - linux; arm variant v5
...
### `hylang:1.3-python3.11-bookworm` - linux; s390x
