...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; amd64
...
### `hylang:1.0.0-python3.13-rc-bullseye` - unknown; unknown
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; arm variant v5
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; arm variant v7
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; arm64 variant v8
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; 386
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; ppc64le
...
### `hylang:1.0.0-python3.13-rc-bullseye` - linux; s390x
