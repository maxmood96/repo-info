...
### `hylang:1.1-python3.9-trixie` - linux; amd64
...
### `hylang:1.1-python3.9-trixie` - unknown; unknown
...
### `hylang:1.1-python3.9-trixie` - linux; arm variant v5
...
### `hylang:1.1-python3.9-trixie` - linux; arm variant v7
...
### `hylang:1.1-python3.9-trixie` - linux; arm64 variant v8
...
### `hylang:1.1-python3.9-trixie` - linux; 386
...
### `hylang:1.1-python3.9-trixie` - linux; ppc64le
...
### `hylang:1.1-python3.9-trixie` - linux; riscv64
...
### `hylang:1.1-python3.9-trixie` - linux; s390x
