...
```console
$ docker pull hylang@sha256:833968e94e1ced49377a441d737848278494260b589dd02d40ea13e14ed448be
```
...
### `hylang:1.0.0-python3.8-alpine` - linux; amd64
...
### `hylang:1.0.0-python3.8-alpine` - unknown; unknown
...
### `hylang:1.0.0-python3.8-alpine` - linux; arm variant v6
...
### `hylang:1.0.0-python3.8-alpine` - linux; arm variant v7
...
### `hylang:1.0.0-python3.8-alpine` - linux; arm64 variant v8
...
### `hylang:1.0.0-python3.8-alpine` - linux; 386
...
### `hylang:1.0.0-python3.8-alpine` - linux; ppc64le
...
### `hylang:1.0.0-python3.8-alpine` - linux; riscv64
...
### `hylang:1.0.0-python3.8-alpine` - linux; s390x
