...
```console
$ docker pull hylang@sha256:2911049602cc3d0b0fefa6c553fa5fd94fe80872123c5d4e4bfc771a1b9de035
```
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; amd64
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; arm variant v6
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; arm variant v7
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; arm64 variant v8
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; 386
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; ppc64le
...
### `hylang:0.26.0-python3.10-alpine3.16` - linux; s390x
