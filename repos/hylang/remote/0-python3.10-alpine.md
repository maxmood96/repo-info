...
```console
$ docker pull hylang@sha256:41b481b56f037d0edb926c9954485cec9e05c5ef594c08856c5021dea5bef62f
```
...
```console
$ docker pull hylang@sha256:ba221c57cc7a38fabc59489736b7aff869cb4d28a886ba74c9cc7f6b4bfb8189
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.4 MB (23443912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:925c89746d35592e7b8c2943922ef538cdd98052376e9d3de151552d7b55eb58`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:40:52 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:40:52 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:41:06 GMT
...
-	Layers:
	...
	-	`sha256:8c653295a5ef963995a580080525696a67e2671956a9c4c55e8b699d447cf790`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e74d472f9499a1c2932497b2aeb6bbe5dba6dbd28ce4f25e8c2247293d5c2725`  
		Last Modified: Wed, 13 Dec 2023 20:45:32 GMT  
		Size: 4.1 MB (4119021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.10-alpine` - linux; arm variant v6

```console
$ docker pull hylang@sha256:3a0fa9dc2e09e7b9530d42ef4533db221e7cbd00ad86daefeb40ff902dd8f874
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.9 MB (22853263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:511b3bb57b06c029e43d6968a6ba245898a78d30dc5ed619af55f06c67333fdf`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:50:08 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:50:09 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:50:28 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:50:28 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:6a59bbdee93d8e05d07b44017459ca41f8666fbf1281bee35bd63e06147c4269`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c10e84b9b5afa609617a3860d9583388480b9f48a761b0cfc31d3c3fe526e0c9`  
		Last Modified: Wed, 13 Dec 2023 20:53:38 GMT  
...
```console
$ docker pull hylang@sha256:69e6da9b1d1a97efb9145e6789837e18a5f99d6c1794210ed2b11a87492bc07f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.2 MB (22187280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5eede51363a817bc47dd40dc836b49e3e869fcc75ec97d8ee8822cbfaa748098`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:19:16 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:19:16 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:19:30 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:19:30 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:d1b2bb1be3c39838b7c128776cc9a08f1d34fceb28bff262112778032c7ad1db`  
		...
		Size: 3.1 MB (3080732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11c0e7b11e927f952bbc5afc11e4ce97b113215a66ea710820334cc45b547a65`  
		Last Modified: Wed, 13 Dec 2023 20:24:10 GMT  
		Size: 4.1 MB (4119052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.10-alpine` - linux; arm64 variant v8

```console
$ docker pull hylang@sha256:dbfa1a96434728682ef938d327edd3a22f1bc57cc4ccbdf10084c8bd71d0705c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.5 MB (23459445 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbd3ee3f104ad18eb0e3879b3ae0ece4b8571986258438f24c62b96db82bb9c6`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:49:13 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:49:13 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:49:25 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:49:25 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:ad274ec315323040018b08f6054c66a02ead755999e2e8e9ac6304f25b7ee5f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79dffb8f80646f231b27d4ce51796ad503fb0e195ca1ff2e29b25bfc0dcc5984`  
		Last Modified: Wed, 13 Dec 2023 20:54:53 GMT  
		Size: 4.1 MB (4118998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.10-alpine` - linux; 386

```console
$ docker pull hylang@sha256:2a2dd481e3ce0516cddc2f29558a8ec18059c6e2c96927b954bd876950f473bd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.5 MB (23501363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:907faf2542d8bbf7824627b3176b053b0e06e606e039e8fb006c15091873b66c`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:40:32 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:40:32 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:40:49 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:40:49 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:99a2d26888f8d7815f194082f9f90da0c977243758b561596cc7a715be00e3e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0e3bc284e71169f12a041c0d1ad513a58b4b42fcb84a3490120c30a2f97c4d5`  
		Last Modified: Wed, 13 Dec 2023 20:46:50 GMT  
		Size: 4.1 MB (4119074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.10-alpine` - linux; ppc64le

```console
$ docker pull hylang@sha256:30655e640829ccfb588016be38ff7150d2bc75c4cdc44572be9db9e1b818b13f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.9 MB (23904647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2576275605a3de84d964ba5ebf2e2fe1d4f266f9e8f8b8bb1abc0696ed59d5ba`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:28:12 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:28:17 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:28:40 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:28:41 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:a59dc481cf502a1be080e5356709b81403a9e6d93b92617700a89a9628e24f91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14f67cbdf2e5d83f00187db815f7e3dc9a8c43695d450cc5f61e7b2399ebea9d`  
		Last Modified: Wed, 13 Dec 2023 20:33:10 GMT  
		Size: 4.1 MB (4119301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0-python3.10-alpine` - linux; s390x

```console
$ docker pull hylang@sha256:8c5d39c33bc04b6f46beb34c6fc8efcfc8a30fd7aafef7f217bb271bb6bea035
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.6 MB (23553792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e47d17bc77a93a70cde9f0a6387def3a38fbd769a942b720b1984fa69eb3572`
-	Default Command: `["hy"]`
...
# Fri, 08 Dec 2023 09:55:38 GMT
CMD ["python3"]
# Wed, 13 Dec 2023 20:44:05 GMT
ENV HY_VERSION=0.27.0
# Wed, 13 Dec 2023 20:44:05 GMT
ENV HYRULE_VERSION=0.4.0
# Wed, 13 Dec 2023 20:44:15 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION" "hyrule == $HYRULE_VERSION"
# Wed, 13 Dec 2023 20:44:15 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:0ecbec11c6f4504879314c1e9787ea41de87df4a228048acc9427f6fe79a167e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ecf972d299699e4830f15504f969b0d715ac48185c3db98fb8536da900ff233`  
		Last Modified: Wed, 13 Dec 2023 20:47:56 GMT  
		Size: 4.1 MB (4119034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
