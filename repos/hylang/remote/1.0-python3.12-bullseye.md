...
```console
$ docker pull hylang@sha256:0c5772dd1cbb10d8702b4c667a60603fe420cb8d0a83cc4ac3a03a7e178e30a2
```
...
### `hylang:1.0-python3.12-bullseye` - linux; arm variant v5
...
### `hylang:1.0-python3.12-bullseye` - linux; ppc64le
...
### `hylang:1.0-python3.12-bullseye` - linux; s390x
