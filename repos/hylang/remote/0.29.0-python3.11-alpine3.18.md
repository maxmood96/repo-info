...
```console
$ docker pull hylang@sha256:1f6515710e59ab4124aebdf2216e04f6c967b1971d46497ce6a1f6f489c3d8ba
```
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; amd64
...
### `hylang:0.29.0-python3.11-alpine3.18` - unknown; unknown
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; arm variant v6
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; arm variant v7
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; 386
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; ppc64le
...
### `hylang:0.29.0-python3.11-alpine3.18` - linux; s390x
