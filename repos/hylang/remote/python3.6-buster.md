...
```console
$ docker pull hylang@sha256:5838c13a93386b217b7e58ca7f34a962d0b143062cf78da0ec9e5e6f3b51b054
```
...
```console
$ docker pull hylang@sha256:40b2106681596fcbbb8d809580e2cbe139abfab6b4df000ad0fb961808f90dda
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.2 MB (45205695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d388ed20070a10d7190ab8169ec8187715eacd7ce919bb833ed796c9d7f4cfff`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Mon, 02 Aug 2021 20:38:54 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 20:38:58 GMT
...
-	Layers:
	...
	-	`sha256:8732a1c742b640c078a4eeeea5301dbfb68fd64b603765cf5fae744b692f4d12`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:914be838dfbb16909549b7af70fc60ffa2d388af6e2a1729ed9f30d711dcb6de`  
		Last Modified: Mon, 02 Aug 2021 20:43:43 GMT  
		Size: 3.1 MB (3101522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; arm variant v5

```console
$ docker pull hylang@sha256:a5e6d47ef4d39c84b98933a4047dcac55c564d35200d439afe92c72029b1c73c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.3 MB (42320004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e75784b62b0b986fc0fbb368a2b30078472a1dcdcaecfa793c6a7260b99e37b5`
-	Default Command: `["hy"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 20:47:20 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 20:47:20 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 20:47:21 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 20:47:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 20:47:54 GMT
CMD ["python3"]
# Mon, 02 Aug 2021 22:11:33 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 22:11:45 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 02 Aug 2021 22:11:45 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:70e00f25388e997793fb4311bed3372f2aafc6712adc95c280b515bd9cd8a981`  
		...
		Size: 233.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:865f8ff48a16c8486b6ba6b5c697d3b243e0762d084ac7f602d2f5ec94c4e517`  
		Last Modified: Mon, 02 Aug 2021 20:57:18 GMT  
		Size: 2.5 MB (2502790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f31dfd9b3f801f708de736bf16e2d96e2d7a62a71da0ee1e89cf15e6a7183fe0`  
		Last Modified: Mon, 02 Aug 2021 22:15:42 GMT  
		Size: 3.1 MB (3101899 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; arm variant v7

```console
$ docker pull hylang@sha256:acdc46c80f073012fbf20067f161dbcc55aedf0bffa2d981ec40569bea041454
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.7 MB (39667137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6321356ba3d11aa64bbb9828af6848146805d69ba56715de18f2f00a9d9884cf`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Mon, 02 Aug 2021 20:27:45 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 20:27:55 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 02 Aug 2021 20:27:56 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:d1bfdf2eecc5827bf65836d10eefef52676c86231a5aabb5010a97aaa2a9fd7b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e3af64bb95b27c88623e7757ab67c5b53b00ccf8b5e0af0f5b94bbd5fff6365`  
		Last Modified: Mon, 02 Aug 2021 20:38:16 GMT  
		Size: 3.1 MB (3101689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; arm64 variant v8

```console
$ docker pull hylang@sha256:762336ab3aee66e726b5c2839520cb34fe9f058e0929683aa294bc686bd6c2b1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.9 MB (43873738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d8996e95376720b86076d477f36d5a11e300970aeba6cfee4ec97c2dba71a02`
-	Default Command: `["hy"]`
...
-	Layers:
	...
	-	`sha256:3967714f7189827619a57be7013c53b0dc69faf104c1e5f0439fa46f3ba93bd5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76cdbd3f8b0fc15eb6584ffbe7cbaa1bcad6d4128bc14205fe59293e8a8e541f`  
		Last Modified: Mon, 02 Aug 2021 20:27:27 GMT  
		Size: 3.1 MB (3101349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; 386

```console
$ docker pull hylang@sha256:c610be02339bf322785e51c45cbff177b12ebc1b9fbbf0e841b751b3ec950d6a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (45962287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:905ac044e9075fe4d60638254cfa6e216bbef89770fee00d692b770b4d700111`
-	Default Command: `["hy"]`
...
# Mon, 02 Aug 2021 19:50:35 GMT
CMD ["python3"]
# Mon, 02 Aug 2021 20:20:20 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 20:20:26 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 02 Aug 2021 20:20:26 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:80245da98922e9be34880f25d4c56641def28f4d56b0b2e19d32ec831c990f0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc737bab7e00be9be9d48b0bd069f6b5408b851798d40f8a685c955aae4a0a43`  
		Last Modified: Mon, 02 Aug 2021 20:27:18 GMT  
		Size: 3.1 MB (3101457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; mips64le

```console
$ docker pull hylang@sha256:a22445674c16158d102e6a7376bdced73a82be2696a7cb586b01f5ea143fd1aa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.4 MB (43381684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ca483395eda5284b17ee8cc0306f8949de71285ddf069adf926f04e0e0559aa`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Fri, 06 Aug 2021 19:36:03 GMT
ENV HY_VERSION=1.0a3
# Fri, 06 Aug 2021 19:36:19 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Fri, 06 Aug 2021 19:36:19 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:fefc4e40fea9527d759405b886d6d1ca6f75335d9ca3351e34fde1df0e73e044`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0daf2802f9d46dd068ca5290fa8af1f9277d053db5ecdc8423d5f200fef08e78`  
		Last Modified: Fri, 06 Aug 2021 19:37:54 GMT  
		Size: 3.1 MB (3102495 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; ppc64le

```console
$ docker pull hylang@sha256:079bcbdc656b74425ce048b93c8c74879aa5d302356d3f211aafb1944056dc05
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49504156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b0bb3505677570fb912beb324e9631df74eb5be8458f9ded7c22cc1540b9895`
-	Default Command: `["hy"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Mon, 02 Aug 2021 19:49:12 GMT
ENV PYTHON_PIP_VERSION=21.2.2
# Mon, 02 Aug 2021 19:49:15 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/a1675ab6c2bd898ed82b1f58c486097f763c74a9/public/get-pip.py
# Mon, 02 Aug 2021 19:49:18 GMT
ENV PYTHON_GET_PIP_SHA256=6665659241292b2147b58922b9ffe11dda66b39d52d8a6f3aa310bc1d60ea6f7
# Mon, 02 Aug 2021 19:50:07 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends wget; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum --check --strict -; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Mon, 02 Aug 2021 19:50:11 GMT
CMD ["python3"]
# Mon, 02 Aug 2021 20:22:57 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 20:23:16 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 02 Aug 2021 20:23:19 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:e05632dc891a8e770fcedd5e69e86fd0cc1e8768cad998a40136253e683169e1`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15bcb2693bea1570a9ba965358a86d6167d88ddb8f8d856b53d6c1b7ecc20ccf`  
		Last Modified: Mon, 02 Aug 2021 20:00:13 GMT  
		Size: 2.5 MB (2504715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ceadfa72fb2cfb3360484ed10c7a8ed0448cfb451e91c1ae0a107f0d7984859`  
		Last Modified: Mon, 02 Aug 2021 20:32:12 GMT  
		Size: 3.1 MB (3101716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:python3.6-buster` - linux; s390x

```console
$ docker pull hylang@sha256:bcc216b9bfd06b63ffdda05d08d0e9ce56e21a821442152f50d43b267369d0d7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.4 MB (43388789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc09f272fbe47ab8b2d65096b1f365123461d7dc0a042c653253b133f684ce8b`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Mon, 02 Aug 2021 20:32:51 GMT
ENV HY_VERSION=1.0a3
# Mon, 02 Aug 2021 20:32:56 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 02 Aug 2021 20:32:57 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:84be973b32dbae9c53d3204064816cb6b6cb6b6b2e71ca4671ba4b05f5797f37`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:773d7457ae0661c38dfa72ded9e06edc21968da9e06465dbfd4063e26c5b44dc`  
		Last Modified: Mon, 02 Aug 2021 20:36:32 GMT  
		Size: 3.1 MB (3101402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
