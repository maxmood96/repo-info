...
```console
$ docker pull hylang@sha256:47de92ebfaa23ca81eaf25e14930d5716a6fbf220f3a0b65cd567cb0341dc5bd
```
...
### `hylang:0.18-python3.8-alpine3.10` - linux; amd64
...
```console
$ docker pull hylang@sha256:20405891001be6e82b7f408c286dff15304911b1c25b1c15b39320932a6d92c9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.5 MB (36463855 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13a57867705a212f27e6869e759138d2c126442d90dddcf3394c05167e35d8cd`
-	Default Command: `["hy"]`
...
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Tue, 19 May 2020 19:00:55 GMT
ENV PYTHON_PIP_VERSION=20.1.1
# Tue, 19 May 2020 19:00:58 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/eff16c878c7fd6b688b9b4c4267695cf1a0bf01b/get-pip.py
# Tue, 19 May 2020 19:01:01 GMT
ENV PYTHON_GET_PIP_SHA256=b3153ec0cf7b7bbf9556932aa37e4981c35dc2a2c501d70d91d2795aa532be79
# Tue, 19 May 2020 19:01:46 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Tue, 19 May 2020 19:01:47 GMT
CMD ["python3"]
# Tue, 19 May 2020 19:44:42 GMT
ENV HY_VERSION=0.18.0
# Tue, 19 May 2020 19:44:51 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Tue, 19 May 2020 19:44:52 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:0fa2111811bd1623f911d7ed7f4311124f46f5161070c7aad23e7febf349d284`  
		...
		Size: 232.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dbbb8a1743242c4b5262b5ebf112b36b6f694e53aaf4fdce5caa7e0ecc4c1a4`  
		Last Modified: Tue, 19 May 2020 19:06:24 GMT  
		Size: 1.9 MB (1932084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ed2a69c8a8fb88caaf651ca5e1a4f8c2921f5d0ed21c0a3cfcb25b97c69c6d7`  
		Last Modified: Tue, 19 May 2020 19:47:54 GMT  
		Size: 2.8 MB (2820561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:0.18-python3.8-alpine3.10` - linux; arm variant v7

```console
$ docker pull hylang@sha256:37bb45ba69836247aa7c56e7f22fdc7250e3d15215829148d4dfb358a60adbef
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.7 MB (35734063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cea2db4fb3bbcdf3565417d584ec40a8f71fc7994ba2ebd292eced266e724820`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Tue, 19 May 2020 19:51:10 GMT
ENV HY_VERSION=0.18.0
# Tue, 19 May 2020 19:51:21 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Tue, 19 May 2020 19:51:23 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:acfbb00d9911a7416ac54e4471dfa6a0eb036095510839943ee8f1f7f2e7c502`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d759fabb1fe9638d9d39ab872f0a4452c697c90581ab503e626c526e7a470893`  
		Last Modified: Tue, 19 May 2020 19:56:34 GMT  
		Size: 2.8 MB (2820557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `hylang:0.18-python3.8-alpine3.10` - linux; ppc64le

```console
$ docker pull hylang@sha256:dd9693ef9eaee7af0fea41ad8e4fd53cdbc04270470d7b078724bd87449758ad
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.3 MB (40257800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b9b3aa15385b7bd62f739771b045756cea86d5891232ea5b2ce70ecabd85502`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Mon, 18 May 2020 16:42:51 GMT
ENV HY_VERSION=0.18.0
# Mon, 18 May 2020 16:43:15 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Mon, 18 May 2020 16:43:19 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:afc062785ed1aeb4c22b2e60ae7e14c80f420e42a1d6348d4f1b889376988176`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f417992e3a685da7eb8ded14ffe256f603b5bb24a6e8c7887e14b1b7bb9c8515`  
		Last Modified: Mon, 18 May 2020 16:51:03 GMT  
		Size: 2.8 MB (2811543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
