...
```console
$ docker pull hylang@sha256:0a0e965d0ff26423e4c2a5dcbf8c8c0b2bd18c3992a3515c2ac77302a7633187
```
...
### `hylang:1.2.0-python3.14-bookworm` - linux; amd64
...
### `hylang:1.2.0-python3.14-bookworm` - unknown; unknown
...
### `hylang:1.2.0-python3.14-bookworm` - linux; arm variant v5
...
### `hylang:1.2.0-python3.14-bookworm` - linux; arm variant v7
...
### `hylang:1.2.0-python3.14-bookworm` - linux; arm64 variant v8
...
### `hylang:1.2.0-python3.14-bookworm` - linux; 386
...
### `hylang:1.2.0-python3.14-bookworm` - linux; ppc64le
...
### `hylang:1.2.0-python3.14-bookworm` - linux; s390x
