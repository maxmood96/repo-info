...
```console
$ docker pull hylang@sha256:34734ea12a62b6729f17231823f60c2d6592606774eded9edaba7e64c9edc1a2
```
...
```console
$ docker pull hylang@sha256:04eaa0ebfa5c3417a3b53825bf61e4cb91f5eae26beed9ebd65d8bceda789a85
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.2 MB (18176960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b19235a0841f50639b1c8f48a2fed012db0dd2d1d0dff6fb74806bf9ce84f36`
-	Default Command: `["hy"]`
...
# Wed, 16 Jun 2021 16:29:38 GMT
CMD ["python3"]
# Tue, 29 Jun 2021 02:46:01 GMT
ENV HY_VERSION=1.0a1
# Tue, 29 Jun 2021 02:46:12 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Tue, 29 Jun 2021 02:46:13 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:4b421c1fc5449f2e67eff7fd91c17b7eeea4728dcdb5842f45fbe3a4b3070a18`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c87a838f09334f2d0d3ee9a2eb9a0fcc228800861198f0a2022baa8f97848c`  
		Last Modified: Tue, 29 Jun 2021 02:52:33 GMT  
		Size: 3.1 MB (3087725 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull hylang@sha256:0d2f46be6ff162675825ba3396aa3c5ec2f9572eb2932befcc3a59cbaef5c7ad
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **19.4 MB (19429390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e943da7859417546f3048b2944d325d7132bbb89c969be89caf693e0d65b8ec`
-	Default Command: `["hy"]`
...
RUN set -eux; 	apk add --no-cache 		ca-certificates 	;
# Sun, 27 Jun 2021 07:56:43 GMT
ENV GPG_KEY=0D96DF4D4110E5C43FBFB17F2D347EA6AA65421D
# Sun, 27 Jun 2021 08:49:14 GMT
ENV PYTHON_VERSION=3.6.13
# Sun, 27 Jun 2021 08:56:55 GMT
RUN set -ex 	&& apk add --no-cache --virtual .fetch-deps 		gnupg 		tar 		xz 		&& wget -O python.tar.xz "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz" 	&& wget -O python.tar.xz.asc "https://www.python.org/ftp/python/${PYTHON_VERSION%%[a-z]*}/Python-$PYTHON_VERSION.tar.xz.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys "$GPG_KEY" 	&& gpg --batch --verify python.tar.xz.asc python.tar.xz 	&& { command -v gpgconf > /dev/null && gpgconf --kill all || :; } 	&& rm -rf "$GNUPGHOME" python.tar.xz.asc 	&& mkdir -p /usr/src/python 	&& tar -xJC /usr/src/python --strip-components=1 -f python.tar.xz 	&& rm python.tar.xz 		&& apk add --no-cache --virtual .build-deps  		bluez-dev 		bzip2-dev 		coreutils 		dpkg-dev dpkg 		expat-dev 		findutils 		gcc 		gdbm-dev 		libc-dev 		libffi-dev 		libnsl-dev 		libtirpc-dev 		linux-headers 		make 		ncurses-dev 		openssl-dev 		pax-utils 		readline-dev 		sqlite-dev 		tcl-dev 		tk 		tk-dev 		xz-dev 		zlib-dev 	&& apk del --no-network .fetch-deps 		&& cd /usr/src/python 	&& gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)" 	&& ./configure 		--build="$gnuArch" 		--enable-loadable-sqlite-extensions 		--enable-optimizations 		--enable-option-checking=fatal 		--enable-shared 		--with-system-expat 		--with-system-ffi 		--without-ensurepip 	&& make -j "$(nproc)" 		EXTRA_CFLAGS="-DTHREAD_STACK_SIZE=0x100000" 		LDFLAGS="-Wl,--strip-all" 		PROFILE_TASK='-m test.regrtest --pgo 			test_array 			test_base64 			test_binascii 			test_binhex 			test_binop 			test_bytes 			test_c_locale_coercion 			test_class 			test_cmath 			test_codecs 			test_compile 			test_complex 			test_csv 			test_decimal 			test_dict 			test_float 			test_fstring 			test_hashlib 			test_io 			test_iter 			test_json 			test_long 			test_math 			test_memoryview 			test_pickle 			test_re 			test_set 			test_slice 			test_struct 			test_threading 			test_time 			test_traceback 			test_unicode 		' 	&& make install 	&& rm -rf /usr/src/python 		&& find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o \( -type f -a \( -name '*.pyc' -o -name '*.pyo' -o -name '*.a' \) \) 			-o \( -type f -a -name 'wininst-*.exe' \) 		\) -exec rm -rf '{}' + 		&& find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec scanelf --needed --nobanner --format '%n#p' '{}' ';' 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		| xargs -rt apk add --no-cache --virtual .python-rundeps 	&& apk del --no-network .build-deps 		&& python3 --version
# Sun, 27 Jun 2021 08:57:04 GMT
RUN cd /usr/local/bin 	&& ln -s idle3 idle 	&& ln -s pydoc3 pydoc 	&& ln -s python3 python 	&& ln -s python3-config python-config
# Sun, 27 Jun 2021 08:57:08 GMT
ENV PYTHON_PIP_VERSION=21.1.2
# Sun, 27 Jun 2021 08:57:12 GMT
ENV PYTHON_GET_PIP_URL=https://github.com/pypa/get-pip/raw/936e08ce004d0b2fae8952c50f7ccce1bc578ce5/public/get-pip.py
# Sun, 27 Jun 2021 08:57:16 GMT
ENV PYTHON_GET_PIP_SHA256=8890955d56a8262348470a76dc432825f61a84a54e2985a86cd520f656a6e220
# Sun, 27 Jun 2021 08:57:35 GMT
RUN set -ex; 		wget -O get-pip.py "$PYTHON_GET_PIP_URL"; 	echo "$PYTHON_GET_PIP_SHA256 *get-pip.py" | sha256sum -c -; 		python get-pip.py 		--disable-pip-version-check 		--no-cache-dir 		"pip==$PYTHON_PIP_VERSION" 	; 	pip --version; 		find /usr/local -depth 		\( 			\( -type d -a \( -name test -o -name tests -o -name idle_test \) \) 			-o 			\( -type f -a \( -name '*.pyc' -o -name '*.pyo' \) \) 		\) -exec rm -rf '{}' +; 	rm -f get-pip.py
# Sun, 27 Jun 2021 08:57:38 GMT
CMD ["python3"]
# Sun, 27 Jun 2021 21:21:18 GMT
ENV HY_VERSION=1.0a1
# Sun, 27 Jun 2021 21:21:59 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sun, 27 Jun 2021 21:22:06 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:f735b6b6227670b274000cc76198dd36eec5bd6f842d5ef1a1fd57f4836fec90`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbf457a6e08a75af67fc6828c0e55502129eaad196853651e4f7d7aae21dd4f9`  
		Last Modified: Sun, 27 Jun 2021 09:07:48 GMT  
		Size: 11.0 MB (11046711 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c158f2bac95092b5f1a1624efe26a15ae4ebeb3371b9fc7ab379fb1ac542084`  
		Last Modified: Sun, 27 Jun 2021 09:07:46 GMT  
		Size: 231.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b185ad1b9244e59a8ca52bfc83f2aa5bc1ac7c412e9f93299e1067568d1939a`  
		Last Modified: Sun, 27 Jun 2021 09:07:46 GMT  
		Size: 2.2 MB (2204247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:312a94702fb4498e7d4c53785296bef94a216063b1c727200f69b792fab1f96c`  
		Last Modified: Sun, 27 Jun 2021 21:31:44 GMT  
		Size: 3.1 MB (3088240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `hylang:1.0a1-python3.6-alpine3.12` - linux; s390x

```console
$ docker pull hylang@sha256:c990c9a91486c44f6f24b8894245c85df4c3c5d787cc02490bde8194d09f56c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.5 MB (18493243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d020648c14db0e0f624c8c3ef50a64916883432b0da6a67e5ef2a4fc71ffde2`
-	Default Command: `["hy"]`
...
CMD ["python3"]
# Sun, 27 Jun 2021 15:42:57 GMT
ENV HY_VERSION=1.0a1
# Sun, 27 Jun 2021 15:43:03 GMT
RUN pip install --no-cache-dir "hy == $HY_VERSION"
# Sun, 27 Jun 2021 15:43:05 GMT
CMD ["hy"]
```
...
-	Layers:
	...
	-	`sha256:1b9ab3aae24d16c97c173ab755a9b14fd233ef723d750a2e4527b6c547c82c7c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e34645952ca572ccbd9eb86894ba3386b3f602c01c2b032f5528b0deb8b40885`  
		Last Modified: Sun, 27 Jun 2021 15:49:23 GMT  
		Size: 3.1 MB (3087416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
