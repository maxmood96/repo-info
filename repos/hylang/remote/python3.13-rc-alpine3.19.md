...
### `hylang:python3.13-rc-alpine3.19` - linux; amd64
...
### `hylang:python3.13-rc-alpine3.19` - unknown; unknown
...
### `hylang:python3.13-rc-alpine3.19` - linux; arm variant v6
...
### `hylang:python3.13-rc-alpine3.19` - linux; arm variant v7
...
### `hylang:python3.13-rc-alpine3.19` - linux; arm64 variant v8
...
### `hylang:python3.13-rc-alpine3.19` - linux; 386
...
### `hylang:python3.13-rc-alpine3.19` - linux; ppc64le
...
### `hylang:python3.13-rc-alpine3.19` - linux; s390x
