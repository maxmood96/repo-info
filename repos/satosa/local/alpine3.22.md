...
- Created: `2026-02-04T21:11:44.427592888Z`
- Virtual Size: ~ 138.67 Mb  
...
```console
libxml2-utils-2.13.9-r0 description:
XML utilities

libxml2-utils-2.13.9-r0 webpage:
https://gitlab.gnome.org/GNOME/libxml2

libxml2-utils-2.13.9-r0 installed size:
80 KiB

libxml2-utils-2.13.9-r0 license:
MIT
