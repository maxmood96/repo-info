...
- Environment:
  ...
  - `PYTHON_SHA256=b9910730526b298299b46b35595ced9055722df60c06ad6301f6a4e2c728a252`
...
### `dpkg` source package: `jq=1.6-2.1+deb12u1`

Binary Packages:

- `jq=1.6-2.1+deb12u1`
- `libjq1:amd64=1.6-2.1+deb12u1`
...
```console
$ apt-get source -qq --print-uris jq=1.6-2.1+deb12u1
'http://deb.debian.org/debian/pool/main/j/jq/jq_1.6-2.1%2bdeb12u1.dsc' jq_1.6-2.1+deb12u1.dsc 1973 SHA256:9ffdf70a4593f367f89b7896e7263997563c595ce2b9d203692b3d0d83492d71
...
'http://deb.debian.org/debian/pool/main/j/jq/jq_1.6-2.1%2bdeb12u1.debian.tar.xz' jq_1.6-2.1+deb12u1.debian.tar.xz 14344 SHA256:62a4adfa825addc21258cefc89413ec0d8734fb4da0f1721626dd3df74f05ddf
```

Other potentially useful URLs:

- https://sources.debian.net/src/jq/1.6-2.1+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/jq/1.6-2.1+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jq/1.6-2.1+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `xmlsec1=1.2.37-2`
...
```console
$ apt-get source -qq --print-uris xmlsec1=1.2.37-2
'http://deb.debian.org/debian/pool/main/x/xmlsec1/xmlsec1_1.2.37-2.dsc' xmlsec1_1.2.37-2.dsc 2634 SHA256:f3f22ab92762d66f605bf8567c0ea813cd8b0355c7dbc1dffcfb0e29167fb5ca
'http://deb.debian.org/debian/pool/main/x/xmlsec1/xmlsec1_1.2.37.orig.tar.gz' xmlsec1_1.2.37.orig.tar.gz 2039332 SHA256:a75ba7aa698ebb6e1a7ed914896de27888c4f5cdf549cc0856e31585b4110c3c
'http://deb.debian.org/debian/pool/main/x/xmlsec1/xmlsec1_1.2.37-2.debian.tar.xz' xmlsec1_1.2.37-2.debian.tar.xz 14348 SHA256:00f3452ddfb7a24763e6cf7323457a9f5fc757258e6dd1e13e9904c462e6b04e
```

Other potentially useful URLs:

- https://sources.debian.net/src/xmlsec1/1.2.37-2/ (for browsing the source)
- https://sources.debian.net/src/xmlsec1/1.2.37-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xmlsec1/1.2.37-2/ (for access to the source package after it no longer exists in the archive)
