...
```console
$ docker pull satosa@sha256:3e2d20e72b3b64b413d2f01d6a943b36b92910c61934c3d4fc32b28502f539bf
```
...
```console
$ docker pull satosa@sha256:db02241bb620507b106897fe292711ade77bf20f969f077a61f8372643b52348
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.3 MB (213270070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e434874fe3d535b0e5575c272ec31e0e42eaf52e40840386a71e87b3024f90e4`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["gunicorn","-b0.0.0.0:8080","satosa.wsgi:app"]`
...
# Fri, 12 Aug 2022 06:53:50 GMT
CMD ["python3"]
# Fri, 12 Aug 2022 11:03:42 GMT
RUN set -eux; 	groupadd -g 1000 satosa; 	useradd -g 1000 -u 1000 satosa; 	apt-get update; 	apt-get install -y --no-install-recommends 		jq 		libxml2-utils 		xmlsec1 	; 	rm -rf /var/lib/apt/lists/*; 	pip install --no-cache-dir 		yq 	;
# Fri, 12 Aug 2022 11:03:43 GMT
ENV SATOSA_VERSION=8.1.1
# Fri, 12 Aug 2022 11:08:06 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		cargo 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		python3-dev 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 	pip install --no-cache-dir 		satosa==${SATOSA_VERSION} 	; 	apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 	mkdir /etc/satosa; 	chown -R satosa:satosa /etc/satosa
# Fri, 12 Aug 2022 11:08:08 GMT
RUN set -eux; 	python -c 'import urllib.request; urllib.request.urlretrieve("https://github.com/IdentityPython/SATOSA/archive/refs/tags/v'${SATOSA_VERSION%%[a-z]*}'.tar.gz","/tmp/satosa.tgz")'; 	mkdir /usr/share/satosa; 	tar --extract --directory /usr/share/satosa --strip-components=1 --file /tmp/satosa.tgz SATOSA-${SATOSA_VERSION%%[a-z]*}/example/; 	rm /tmp/satosa.tgz
# Fri, 12 Aug 2022 11:08:08 GMT
WORKDIR /etc/satosa
# Fri, 12 Aug 2022 11:08:08 GMT
...
-	Layers:
	...
	-	`sha256:1a7acd435bd10e965ae7e968ebc8339b1d63e058b5e65274c78dcbdc8550944b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7dfb8762b7c5dd8e540fa0627e53d190882f78c194a2790f222adecf33654b3`  
		Last Modified: Fri, 12 Aug 2022 11:13:01 GMT  
		Size: 21.0 MB (20964878 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2398f5b660ea3cd71ac18c9e9b31fc12df08ef3d5abafe8cff2117024e6db2c`  
		Last Modified: Fri, 12 Aug 2022 11:13:11 GMT  
		Size: 150.2 MB (150150113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7f0b89d1bf6d605889478c5763557562578fa8d6169e8be97908cb3b6efad20`  
		Last Modified: Fri, 12 Aug 2022 11:12:58 GMT  
		Size: 9.4 KB (9443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a5938012bf6d398dbc0bb20d7572c7696a966ef8d65fb60271638a84baebe57`  
		Last Modified: Fri, 12 Aug 2022 11:12:57 GMT  
...
```console
$ docker pull satosa@sha256:dbb4dce5f969fbee8dc6f0b9b1a1ff77ce24c0188003bb32e38e3f9f00bc42b0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.4 MB (217359327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a3953d09f9ad626fb9b96f28ec432fbe77ce45eee455409f6c42dbb730503a7`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["gunicorn","-b0.0.0.0:8080","satosa.wsgi:app"]`
...
CMD ["python3"]
# Fri, 12 Aug 2022 06:22:30 GMT
RUN set -eux; 	groupadd -g 1000 satosa; 	useradd -g 1000 -u 1000 satosa; 	apt-get update; 	apt-get install -y --no-install-recommends 		jq 		libxml2-utils 		xmlsec1 	; 	rm -rf /var/lib/apt/lists/*; 	pip install --no-cache-dir 		yq 	;
# Fri, 12 Aug 2022 06:22:33 GMT
ENV SATOSA_VERSION=8.1.1
# Fri, 12 Aug 2022 06:39:25 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		cargo 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		python3-dev 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 	pip install --no-cache-dir 		satosa==${SATOSA_VERSION} 	; 	apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 	mkdir /etc/satosa; 	chown -R satosa:satosa /etc/satosa
# Fri, 12 Aug 2022 06:39:35 GMT
RUN set -eux; 	python -c 'import urllib.request; urllib.request.urlretrieve("https://github.com/IdentityPython/SATOSA/archive/refs/tags/v'${SATOSA_VERSION%%[a-z]*}'.tar.gz","/tmp/satosa.tgz")'; 	mkdir /usr/share/satosa; 	tar --extract --directory /usr/share/satosa --strip-components=1 --file /tmp/satosa.tgz SATOSA-${SATOSA_VERSION%%[a-z]*}/example/; 	rm /tmp/satosa.tgz
# Fri, 12 Aug 2022 06:39:39 GMT
WORKDIR /etc/satosa
# Fri, 12 Aug 2022 06:39:43 GMT
COPY file:052229d57447119afa18a76253b740426943fcd4cf1c553c23df3445a5ed9f32 in /usr/local/bin/ 
# Fri, 12 Aug 2022 06:39:48 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Fri, 12 Aug 2022 06:39:53 GMT
EXPOSE 8080
# Fri, 12 Aug 2022 06:39:57 GMT
USER satosa:satosa
# Fri, 12 Aug 2022 06:40:02 GMT
CMD ["gunicorn" "-b0.0.0.0:8080" "satosa.wsgi:app"]
```
...
-	Layers:
	...
	-	`sha256:087c5713c0d4bc6e2eb0f5252d1d9e56f03d00828245f414046cb4004c686ffd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5901f00d1792f91f549fb04ccdb2810207a2f817a164bd4612af1d2e9def891c`  
		Last Modified: Fri, 12 Aug 2022 06:40:35 GMT  
		Size: 21.3 MB (21310294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa6d4c6379bef4364cd3b2449f39d78836e0e305ca808f4f818be79c59050a52`  
		Last Modified: Fri, 12 Aug 2022 06:41:18 GMT  
		Size: 150.1 MB (150113489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbf492be8dbd59e4cc8de7f656c0182c139cdc033ebef020c5a0ff9d8adccfbb`  
		Last Modified: Fri, 12 Aug 2022 06:40:22 GMT  
		Size: 9.4 KB (9395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:323b8efb272f7541af9f6030c29e6514a5f39905206edc76c4b495554496de68`  
		Last Modified: Fri, 12 Aug 2022 06:40:22 GMT  
