...
```console
$ docker pull satosa@sha256:a97ba2bef36b31d74586400cb75020d04f874bb78955d5e082c591238b45e172
```
...
```console
$ docker pull satosa@sha256:7b49758393751f74e1098a1fb723237519a828d3b4a8103acc6414cd711f68fb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.8 MB (90817678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f62e4307d453b7f8b849066206c7a05aad17812d90b212f57b1cd2fecf1173c3`
...
-	Layers:
	...
	-	`sha256:0bc82fabe4303550cf32878b15a660f9113b11fb4a051988b028a2bf438b9518`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb7e212eb1c3ec0175e7520326c3c0c3db4d9e75cc79a2ab893de594dcc554a3`  
		Last Modified: Tue, 19 Dec 2023 18:22:44 GMT  
		Size: 21.2 MB (21195499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90563bcc28de15f8b40d7c547411dd328584c7c1b4f790c32742004982404486`  
		Last Modified: Tue, 19 Dec 2023 18:22:44 GMT  
		Size: 21.7 MB (21713081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dca9c093514c285f16ff8c0a19b240f5f017b87ba3b62f887a7bdb9fcf847174`  
		Last Modified: Tue, 19 Dec 2023 18:22:41 GMT  
		Size: 9.5 KB (9489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f915902f2318b758e2faf01d373d4c1ce18ae28c5abb4edaec1546a21a1fb2eb`  
		Last Modified: Tue, 19 Dec 2023 18:22:41 GMT  
...
```console
$ docker pull satosa@sha256:f8205b55aeb1e15a80f7b7a22bf68075491d1777bf324dccc0c6ee332332e715
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.0 MB (88956562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f47e70ec975ab14b7deee3084801d4c3973d700b48c86a3de94a0e092530354`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["gunicorn","-b0.0.0.0:8080","satosa.wsgi:app"]`
...
# Mon, 04 Dec 2023 22:49:21 GMT
CMD ["python3"]
# Tue, 19 Dec 2023 13:51:10 GMT
RUN set -eux; 	groupadd -g 1000 satosa; 	useradd -m -g 1000 -u 1000 satosa; 	apt-get update; 	apt-get install -y --no-install-recommends 		jq 		libxml2-utils 		xmlsec1 	; 	rm -rf /var/lib/apt/lists/*; 	pip install --no-cache-dir 		yq 	;
# Tue, 19 Dec 2023 13:51:10 GMT
ENV SATOSA_VERSION=8.2.0
# Tue, 19 Dec 2023 13:52:08 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		cargo 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		python3-dev 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 	pip install --no-cache-dir 		satosa==${SATOSA_VERSION} 	; 	apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 	mkdir /etc/satosa; 	chown -R satosa:satosa /etc/satosa
# Tue, 19 Dec 2023 13:52:09 GMT
RUN set -eux; 	python -c 'import urllib.request; urllib.request.urlretrieve("https://github.com/IdentityPython/SATOSA/archive/refs/tags/v'${SATOSA_VERSION%%[a-z]*}'.tar.gz","/tmp/satosa.tgz")'; 	mkdir /usr/share/satosa; 	tar --extract --directory /usr/share/satosa --strip-components=1 --file /tmp/satosa.tgz SATOSA-${SATOSA_VERSION%%[a-z]*}/example/; 	rm /tmp/satosa.tgz
# Tue, 19 Dec 2023 13:52:09 GMT
WORKDIR /etc/satosa
# Tue, 19 Dec 2023 13:52:09 GMT
...
-	Layers:
	...
	-	`sha256:3d97a142f1ef2f8601b57105ce339dcb086cb58ddf81f19a4be9c296234a3a4c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fadc9b7413b12d30dc029805344be60a67912f6d872b046331bf69612bf2729f`  
		Last Modified: Tue, 19 Dec 2023 13:52:26 GMT  
		Size: 21.1 MB (21076130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44674fb0995d672001588610cc71bfc7375cbf1b51370c9aee0580cdb35ee5a1`  
		Last Modified: Tue, 19 Dec 2023 13:52:26 GMT  
		Size: 21.3 MB (21272798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e75a813a80a5fa7c4a81d4382de41794e962c396c365fdc26eafb01177445765`  
		Last Modified: Tue, 19 Dec 2023 13:52:23 GMT  
		Size: 9.5 KB (9491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da53c0d830fb94a9bc9bebcbe28e62629eeaaef9f473f3849a94e2989ff00c48`  
		Last Modified: Tue, 19 Dec 2023 13:52:23 GMT  
