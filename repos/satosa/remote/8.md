...
```console
$ docker pull satosa@sha256:14575b228c549a2be5240cc65ca5f7ae266d2f40f31c26927c9526b9e9596a3d
```
...
```console
$ docker pull satosa@sha256:508b7529ddbfb515fa32c819e2073fd32f0550d8afdc2765fa7f0acb27f9aad5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.6 MB (90551177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12eba3132f91cff738014895df2e8cb1360e4719db26829599b382ea5f4900fb`
...
# Wed, 09 Aug 2023 13:02:11 GMT
ENV SATOSA_VERSION=8.2.0
# Wed, 09 Aug 2023 13:03:07 GMT
...
-	Layers:
	...
	-	`sha256:6cf63801d0e6e61f9987b58fd8646d2865a2d1f3ae2eee200429be4db8b972e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f0007a86346aa896ca5bb89257fd78cd3c887b2bf2ce7fb8540d99e682d2ff`  
		Last Modified: Wed, 09 Aug 2023 13:03:30 GMT  
		Size: 21.2 MB (21174090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28d2d50e4f7c7bbd4a2fd72d031986577cb478d560ab1f9721140bf8d0e22588`  
		Last Modified: Wed, 09 Aug 2023 13:03:30 GMT  
		Size: 21.5 MB (21526523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:732536440c772de2855c267aac4f20973960e95ffbfa7ef3fc19f5fa46a280ad`  
		Last Modified: Wed, 09 Aug 2023 13:03:27 GMT  
		Size: 9.5 KB (9487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c1d8612aebda3589d7da4d2f83839069f89c8bb11397ac6f57bfe9fa1b5f25c`  
		Last Modified: Wed, 09 Aug 2023 13:03:27 GMT  
...
```console
$ docker pull satosa@sha256:049adbcd0e8bfe40a6ec3ba6214acd4f67f37a164303031997a412c0914e7239
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.7 MB (88720573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:760ffa3f824d2d9667dc33d5568333a862166d11462b8f93d0d99a7027a79be5`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["gunicorn","-b0.0.0.0:8080","satosa.wsgi:app"]`
...
# Sat, 22 Jul 2023 09:54:20 GMT
CMD ["python3"]
# Wed, 09 Aug 2023 13:28:48 GMT
RUN set -eux; 	groupadd -g 1000 satosa; 	useradd -m -g 1000 -u 1000 satosa; 	apt-get update; 	apt-get install -y --no-install-recommends 		jq 		libxml2-utils 		xmlsec1 	; 	rm -rf /var/lib/apt/lists/*; 	pip install --no-cache-dir 		yq 	;
# Wed, 09 Aug 2023 13:28:49 GMT
ENV SATOSA_VERSION=8.2.0
# Wed, 09 Aug 2023 13:29:42 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		cargo 		dpkg-dev 		gcc 		gnupg dirmngr 		libbluetooth-dev 		libbz2-dev 		libc6-dev 		libexpat1-dev 		libffi-dev 		libgdbm-dev 		liblzma-dev 		libncursesw5-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		make 		python3-dev 		tk-dev 		uuid-dev 		wget 		xz-utils 		zlib1g-dev 	; 	pip install --no-cache-dir 		satosa==${SATOSA_VERSION} 	; 	apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 	mkdir /etc/satosa; 	chown -R satosa:satosa /etc/satosa
# Wed, 09 Aug 2023 13:29:44 GMT
RUN set -eux; 	python -c 'import urllib.request; urllib.request.urlretrieve("https://github.com/IdentityPython/SATOSA/archive/refs/tags/v'${SATOSA_VERSION%%[a-z]*}'.tar.gz","/tmp/satosa.tgz")'; 	mkdir /usr/share/satosa; 	tar --extract --directory /usr/share/satosa --strip-components=1 --file /tmp/satosa.tgz SATOSA-${SATOSA_VERSION%%[a-z]*}/example/; 	rm /tmp/satosa.tgz
# Wed, 09 Aug 2023 13:29:44 GMT
WORKDIR /etc/satosa
# Wed, 09 Aug 2023 13:29:44 GMT
...
-	Layers:
	...
	-	`sha256:efdc701eacf3112f7e56658627705a7f687213917eb60d324f50dc2f86d53c13`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6a80353531db2f5910eee5d4b88ac99219908edec93dfaf9909dc0370f9ee28`  
		Last Modified: Wed, 09 Aug 2023 13:30:09 GMT  
		Size: 21.1 MB (21053977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccfeb3def93f791ba26a443090aecac5e8b79d31afbc3ce817dcbd682dc49fa9`  
		Last Modified: Wed, 09 Aug 2023 13:30:08 GMT  
		Size: 21.1 MB (21116018 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aa5456e727bdfe512aa5629c23864c36da3bc7308a0748a7bdc2a7a3fa9a292`  
		Last Modified: Wed, 09 Aug 2023 13:30:06 GMT  
		Size: 9.5 KB (9488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62a0e453af202e4fe3ac3d52816f16c69535e05da1218ca940556a2553ae9106`  
		Last Modified: Wed, 09 Aug 2023 13:30:05 GMT  
		Size: 2.1 KB (2142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
