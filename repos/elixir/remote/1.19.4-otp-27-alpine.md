...
```console
$ docker pull elixir@sha256:7306ad788a304c8803b9032109e41539488c296d11000de9248f5f6019a992c8
```
...
### `elixir:1.19.4-otp-27-alpine` - linux; amd64
...
### `elixir:1.19.4-otp-27-alpine` - unknown; unknown
...
### `elixir:1.19.4-otp-27-alpine` - linux; arm variant v7
...
### `elixir:1.19.4-otp-27-alpine` - linux; arm64 variant v8
...
### `elixir:1.19.4-otp-27-alpine` - linux; 386
...
### `elixir:1.19.4-otp-27-alpine` - linux; s390x
