...
```console
$ docker pull elixir@sha256:0260bfe5130b1844e7a15c01f88bc7eefca39aa70e9173343f6cf88baebe941c
```
...
### `elixir:1.19.1-otp-28-alpine` - linux; amd64
...
### `elixir:1.19.1-otp-28-alpine` - unknown; unknown
...
### `elixir:1.19.1-otp-28-alpine` - linux; arm variant v7
...
### `elixir:1.19.1-otp-28-alpine` - linux; arm64 variant v8
...
### `elixir:1.19.1-otp-28-alpine` - linux; 386
...
### `elixir:1.19.1-otp-28-alpine` - linux; ppc64le
