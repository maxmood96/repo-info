...
### `elixir:1.19.2-slim` - linux; amd64
...
### `elixir:1.19.2-slim` - unknown; unknown
...
### `elixir:1.19.2-slim` - linux; arm variant v7
...
### `elixir:1.19.2-slim` - linux; arm64 variant v8
...
### `elixir:1.19.2-slim` - linux; ppc64le
...
### `elixir:1.19.2-slim` - linux; s390x
