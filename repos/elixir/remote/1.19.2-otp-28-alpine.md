...
```console
$ docker pull elixir@sha256:25592951e9bd4ec206af568bcc2f7393d77efe68c5f314a99c4f2be56facc887
```
...
### `elixir:1.19.2-otp-28-alpine` - linux; amd64
...
### `elixir:1.19.2-otp-28-alpine` - unknown; unknown
...
### `elixir:1.19.2-otp-28-alpine` - linux; arm variant v7
...
### `elixir:1.19.2-otp-28-alpine` - linux; arm64 variant v8
...
### `elixir:1.19.2-otp-28-alpine` - linux; 386
