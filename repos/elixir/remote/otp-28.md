...
```console
$ docker pull elixir@sha256:eb03af20582e5f5d3f3daf3d8d6b49ee4e62c263615406363124db7f4f4a62b0
```
...
```console
$ docker pull elixir@sha256:294a0403511423f2fbc1030be4ad392e2a4a4203c73a297d9dc2cb276c6121d9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **638.9 MB (638924157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d42334a12b170e24ab3d639364390b4982e6574988c51ee321635203053a0b2`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:f1d0c2be260fd6694dac813e222a21e605e3d0b81e243d665bdb2f5025c3b250`  
		...
		Size: 817.8 KB (817783 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e83e49d8b71c0c29d78ef237ace7a91c55d3b238e5f9aedec16db2155d6be2dc`  
...
```console
$ docker pull elixir@sha256:cc4deaa1a43fa78e812f2d3a1b5a5c08fc914baf4a167aaf7770c6b94ba86592
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.7 MB (23742776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af8c68044271f612df99c44fa90b33a2a3a607a0ab69f183f4e30429aca7ca0a`

```dockerfile
```

-	Layers:
	-	`sha256:c4212ff1f2ae4fbbb9fe2ea0180638f76c53baece641fc918a4db5efec86b69d`  
		Last Modified: Wed, 19 Nov 2025 04:47:13 GMT  
		Size: 23.7 MB (23731472 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f45d9aa03280115b715668db6cbffbad93c76bfa1d1ab3f87c6039637bd64190`  
		Last Modified: Wed, 19 Nov 2025 04:47:14 GMT  
