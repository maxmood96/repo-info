...
### `elixir:1.20.0-otp-28-alpine` - linux; amd64
...
### `elixir:1.20.0-otp-28-alpine` - unknown; unknown
...
### `elixir:1.20.0-otp-28-alpine` - linux; arm variant v7
...
### `elixir:1.20.0-otp-28-alpine` - linux; arm64 variant v8
...
### `elixir:1.20.0-otp-28-alpine` - linux; 386
...
### `elixir:1.20.0-otp-28-alpine` - linux; ppc64le
...
### `elixir:1.20.0-otp-28-alpine` - linux; s390x
