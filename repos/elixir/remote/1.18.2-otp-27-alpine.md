...
### `elixir:1.18.2-otp-27-alpine` - linux; amd64
...
### `elixir:1.18.2-otp-27-alpine` - unknown; unknown
...
### `elixir:1.18.2-otp-27-alpine` - linux; arm variant v7
...
### `elixir:1.18.2-otp-27-alpine` - linux; arm64 variant v8
...
### `elixir:1.18.2-otp-27-alpine` - linux; 386
...
### `elixir:1.18.2-otp-27-alpine` - linux; ppc64le
...
### `elixir:1.18.2-otp-27-alpine` - linux; s390x
