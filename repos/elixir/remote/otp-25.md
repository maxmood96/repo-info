...
```console
$ docker pull elixir@sha256:a724d48450187d337543676b4eac5b9fb0b530e7a32441cc35ca04dce100fc5a
```
...
```console
$ docker pull elixir@sha256:fd209b803a5cc3f02fa6dc19bc759c2a376dcf7624cd96f0a9af636aad7b5e5d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **580.4 MB (580442716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90ea6bc8b56382f80fbe3060b6cf57f95bd09a5aea7e13c13a74f086e2d70edb`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:d7001b737d7a4bd109820d774507a56bfbf45579128c5fbe4c3f44a3ec2eddd4`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:50054154bd19abdbd5a680755f6d38555363d869525b99e4f25452637f42d8b9`  
		Last Modified: Fri, 27 Sep 2024 07:04:20 GMT  
		Size: 7.0 MB (6973753 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:otp-25` - unknown; unknown

```console
$ docker pull elixir@sha256:3500cf3f1767278274ed1462a084c8a906a63bd9e19186e40a473521ef6ef37c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.8 MB (22820202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffb60f9e5df6ddb9815df2626f4195f934e57f54b6b7953b44742a972d57c9d5`

```dockerfile
```

-	Layers:
	-	`sha256:815e3180e9d8d8585cab581ecae6cb1da5c958e60e0c63da1e54383483ad5c47`  
		Last Modified: Fri, 27 Sep 2024 07:04:20 GMT  
		Size: 22.8 MB (22809816 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e54b46acd828005b041ea58085492dce7df5b69e4fdd799eeb6bd9dc88373c11`  
		Last Modified: Fri, 27 Sep 2024 07:04:20 GMT  
...
```console
$ docker pull elixir@sha256:04fe8cb25b1952f35bbda942912ec85aec57ab264f831eced00dd08c5eeea15f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **515.8 MB (515796541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79d63e151be395665a88550282006048c89165248a5b867971e7b8935b0594e8`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:150ee8e04acf720a036ffb725fab4e6cdc8fc660cc2604eabb062fc85c282ea7`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e42e0ef6e0af430583a7319551b4926c66af1bf7a3ff6f094a2c16fe5eaff9b5`  
		Last Modified: Sat, 28 Sep 2024 05:39:05 GMT  
		Size: 7.0 MB (6973784 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:otp-25` - unknown; unknown

```console
$ docker pull elixir@sha256:454429714d4aa3a331e10cfb7ec7cd1c08587dfe3ee4357fa03ccbb3d75ea07c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.6 MB (22629225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc11ee4787e39ea8bfc0235e1c0a307c1c41c94a40f3c02b8c7f81d77e567035`

```dockerfile
```

-	Layers:
	-	`sha256:690e03046095d4e47151b27c9d9fb3e4376c6146b6f644319f8c8c9fda14bfa0`  
		Last Modified: Sat, 28 Sep 2024 05:39:05 GMT  
		Size: 22.6 MB (22618722 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:419c1cdd6f56e90df951a19886dc0f55f81d18abfff0f587c3561314508dfc55`  
		Last Modified: Sat, 28 Sep 2024 05:39:04 GMT  
...
```console
$ docker pull elixir@sha256:4a0baf1dd2c9096a516714b53acb6f4aad91f61cd390b95c286477fd76dbc193
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **566.4 MB (566417542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9987c3ee155722389842eb14a104dfe48ad92cdce84b5a927d558c1f4ad67ce`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:861c526146a3d29aea83d4767929b0da663269d6701f8388f88df5c73b05950a`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:501a3f5275f6e3adfcd9aa015294789262f77c7b8b5107d1e4d2408ba48da6b3`  
		Last Modified: Sat, 28 Sep 2024 01:24:44 GMT  
		Size: 7.0 MB (6973716 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:otp-25` - unknown; unknown

```console
$ docker pull elixir@sha256:8cccaa3c77044fdcf761eb9fec32b1439a71b994a59db7583b614481cf411d29
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.8 MB (22830658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c25ad36dccbfe0b9a62b410e01fdac063c665a0d240a762bdfd66870a6703fcc`

```dockerfile
```

-	Layers:
	-	`sha256:3b3fc69ffdfcccc78feb707320e86e13285aed7b875ef7372aa43981de60fb29`  
		Last Modified: Sat, 28 Sep 2024 01:24:44 GMT  
		Size: 22.8 MB (22819851 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f8ef09b7a6c73666ba91ee75ef2c6114bcb8fe4734e77bc59bff4b8c7f396798`  
		Last Modified: Sat, 28 Sep 2024 01:24:43 GMT  
...
```console
$ docker pull elixir@sha256:52e213c79723d87d503c0f379f8c9a72c7917d6256576ac6d3c32de825661fa4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **581.9 MB (581875594 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d3881be6ddbdd02074b94294ce700146f2e7d6d17fab32ef2516d520f8db7db`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:2852ad11bd551ac2b935b53211cef717bfdc2013b647cbffe9545ac7a99a4af8`  
		...
		Size: 803.9 KB (803869 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:11b723f048dc8ff36876ef6887f5d1d02f9d97b78022e7c09696c4d0350ab4b5`  
		Last Modified: Fri, 27 Sep 2024 10:02:33 GMT  
		Size: 7.0 MB (6973754 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:otp-25` - unknown; unknown

```console
$ docker pull elixir@sha256:2b34fa4e057c3d97fa84e12114c808dbfd7fd7378221ba9fea6548f3b9027619
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.8 MB (22807980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:122e0119ddd54d54c4906639cfae008aaf9bd82ca7b79c1fb139ad45a05d1c10`

```dockerfile
```

-	Layers:
	-	`sha256:f21cf72fa6d424b2be75d926c91c5ad104952113afb950be3244e0c5fa24031f`  
		Last Modified: Fri, 27 Sep 2024 10:02:33 GMT  
		Size: 22.8 MB (22797620 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ab561df65f43f7ccad58100760390406db39b30a08c947c4717ac516412fba1c`  
