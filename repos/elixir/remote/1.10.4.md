...
```console
$ docker pull elixir@sha256:ba981350b63eb016427d12d90dad643eea8e2bfed37e0f2e4f2bce5aa5303eae
```
...
```console
$ docker pull elixir@sha256:250aac9806fba3b935371382739bb92bf79374446d7dd04b5d9eaf1a1c4b7b09
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **478.6 MB (478566444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f90136f8bdc3636785364f4f4c645a5572f18f28eab69b02539774d0d716834`
-	Default Command: `["iex"]`
...
# Mon, 05 Oct 2020 22:52:30 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Mon, 05 Oct 2020 22:53:54 GMT
...
-	Layers:
	...
	-	`sha256:e4487bf4ed3825c6b6dfd1537086cde24a303faab0612838b4c94aecdeb0edb8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e86f6444f68d6f5ed7329b7019692698f4c0b4691df24d43298130fb12cccc90`  
		Last Modified: Mon, 05 Oct 2020 23:22:44 GMT  
		Size: 6.8 MB (6750036 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.10.4` - linux; arm variant v7

```console
$ docker pull elixir@sha256:59fd9ba8bdf043b5cde8275f1703b50a9bc1efa1a60cec78cffc1022f621f1a1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.5 MB (431524516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14649c1589ca9b20dd17fcb30167966cbe2e653d063a68e200175c17c678c7b`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="b01275b6cbdb354dcf9ed686fce2b5f9dfdd58972ded9e970e31b9215a8521f2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 06 Oct 2020 00:11:28 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Tue, 06 Oct 2020 00:13:32 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 06 Oct 2020 00:13:33 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:6dc337d7a0d7780a91519fa19b3dbdd4653b69d31e5286c8faa76c23b3b57bde`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e97e3adc064baeccb55fcb981d85e8e3573699895c2d707534c6897a36ce57`  
		Last Modified: Tue, 06 Oct 2020 00:43:01 GMT  
		Size: 6.7 MB (6749945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.10.4` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:4def4ff9cb59ba6906643b15cf54c1413f3874a463d90609d20bb1a1ae65d5e6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **461.7 MB (461729300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f88e3775cb17c81e70961c45ea92e4dcafbee51fde62788ba582edb212112a4b`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="b01275b6cbdb354dcf9ed686fce2b5f9dfdd58972ded9e970e31b9215a8521f2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Mon, 05 Oct 2020 22:54:06 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Mon, 05 Oct 2020 22:57:00 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Mon, 05 Oct 2020 22:57:05 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:d00c0f12fd1cecf6e624b5e7bf4c988fdea371498267173d29a6402e2ba8449f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66b6b72363de0f8abae5cd09b12e448b7829b43130c4c046d05037c116faacaa`  
		Last Modified: Mon, 05 Oct 2020 23:31:28 GMT  
		Size: 6.7 MB (6749944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.10.4` - linux; 386

```console
$ docker pull elixir@sha256:fa39e889f414a6ebf5cc306be5c193cc22880236d1b9a3992ff7db9ddc467e18
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **488.9 MB (488928056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc39cadf1e740a94207576d0100d53eb41924156cab31e1ea2077ce0110fd828`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="b01275b6cbdb354dcf9ed686fce2b5f9dfdd58972ded9e970e31b9215a8521f2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 06 Oct 2020 00:02:17 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Tue, 06 Oct 2020 00:03:36 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 06 Oct 2020 00:03:36 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:87617267350dbfe98d48562f66f5d3c42cac5c8c04bc3a400ed9cf478223fe66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a0ec5c56902ed4a8d089be614a09006cbd19c1e70f93c8bbc70392d6aa5a3f8`  
		Last Modified: Tue, 06 Oct 2020 00:23:40 GMT  
		Size: 6.7 MB (6749994 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull elixir@sha256:c693e5a5f8e400146ed8d4e2a3f65df5788e23c9ff47cfb9d249f26d0e48837f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **454.6 MB (454561151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33cc3692d981d71492f373aa0f2edf4ad83e50743fbf3d0673b993069bc57394`
-	Default Command: `["iex"]`
...
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Mon, 05 Oct 2020 22:39:43 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Mon, 05 Oct 2020 22:39:44 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:9dc22cbc87416515365071e2a2bd9c08e59d891188dc411770d361b465b00e42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dee095b875402382ee4415a640d376d8527154dbe5b76bf7bd60478d6b62b183`  
		Last Modified: Mon, 05 Oct 2020 22:47:59 GMT  
		Size: 6.8 MB (6750048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
