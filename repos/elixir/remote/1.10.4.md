...
```console
$ docker pull elixir@sha256:ad81a0a27156911b7ba585a079c36e9df32fa32dd69af4bfb1c5c511318664be
```
...
```console
$ docker pull elixir@sha256:4f45c14657d3658d5efae20eaa0dad51fb5cc3f95e2d46a80b640cdfb8bbd6a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **478.1 MB (478052130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2b5a4e2c61aba230c06c46a56bdad3dc5bfb45737a4f0c998906e4c894e8d4d`
-	Default Command: `["iex"]`
...
# Thu, 04 May 2023 17:43:37 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Thu, 04 May 2023 17:44:39 GMT
...
-	Layers:
	...
	-	`sha256:7cdac8cf5f5f49e2bbeaf95d9a8f474899da95edef75d01ca6f046e2f40b0c01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0daa7ed6ea2b51177d9528451e22fd0a7385b970a2cb9352a5998ae61cedb009`  
		Last Modified: Thu, 04 May 2023 17:50:18 GMT  
...
```console
$ docker pull elixir@sha256:25440abb23d16f8269d887d23b9e4fd721f42e62da0ce41d5a92d90264f0fd27
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **461.2 MB (461214936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a04c998f7cd0a6dc76a152300a9bca332d5e20c61611b781831ade82bb60182c`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 04 May 2023 12:14:35 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Thu, 04 May 2023 12:15:17 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Thu, 04 May 2023 12:15:17 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:f298424b555a2885fa254fa7ad6594b471c7db2b2c12215b92c61ce2252d2149`  
		...
		Size: 780.0 KB (780049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:197053ef2be4e6c9477e2cf9b402cbec23b578030510579db5305df64322c331`  
		Last Modified: Thu, 04 May 2023 12:19:46 GMT  
