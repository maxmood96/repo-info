...
```console
$ docker pull elixir@sha256:6e22de6de175321871fe4861d8083b6f8ac9a2b64daeabf39f4f7d99d4e2dc5a
```
...
```console
$ docker pull elixir@sha256:60612e11105e617eb97d22ce63cdf039c66bbd422f8831e36025abf7bc5bd581
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **479.0 MB (479039641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2320c1c6d80bf036458e64b670dfc35acc6232f6c474d3e0361273c354f92d3`
-	Default Command: `["iex"]`
...
# Tue, 23 Aug 2022 20:33:16 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Tue, 23 Aug 2022 20:34:16 GMT
...
-	Layers:
	...
	-	`sha256:ef0fd41d42574166ae46f51333ea3294349a8dba9a3c146058e38d3eacaefe59`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04df88ee4a3d3622167b20fb80f179975fbf65ff302bceeb6038ac4042648df2`  
		Last Modified: Tue, 23 Aug 2022 20:45:59 GMT  
...
```console
$ docker pull elixir@sha256:ba3345fd2fd662fbb839d8c052e683e91935b4b24149feec538c7f89f4fe18da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.9 MB (431923933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69821cebe01d400670452214019c47677dcfd632863bb4d668f9814dc767a8a0`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 04 Aug 2022 08:30:04 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Thu, 04 Aug 2022 08:31:21 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Thu, 04 Aug 2022 08:31:21 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:df84ebc5d66406b6f6518c6dab76267612846273afabafd385aff91b6005c4d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4efe8eaeea2b6fc2c901b11dc0066f7fdd45fbd4c50f32a6c5bbc76c5a0d3ef`  
		Last Modified: Thu, 04 Aug 2022 08:45:28 GMT  
...
```console
$ docker pull elixir@sha256:d1f1fc50c1f15554577e93e825662cb9dd3cdafa897c5b1146bb8792b4a2b124
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **462.0 MB (461992128 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f57eb2c3911ad84545fb092f26e524a178a023fc7dab225c50c10bccf262b3bf`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 23 Aug 2022 21:50:28 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Tue, 23 Aug 2022 21:51:24 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 23 Aug 2022 21:51:25 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:96af06a30f020f26ef4d061a57e9c920960c788cbc1223104be74ccc740eb7a6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4122f6a7045563ea75196d265317ceded09e4dffaae361696562fb16340d397c`  
		Last Modified: Tue, 23 Aug 2022 22:07:07 GMT  
...
```console
$ docker pull elixir@sha256:38d301b807f29f84cf1868aa20a4ca876e88416372b79c3a0b69a03c31124bff
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **489.1 MB (489130747 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c85db12deebcc0317f993518d5faedec4861b9ce9ddb7aa85730ff3eac302a50`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 23 Aug 2022 17:09:02 GMT
ENV ELIXIR_VERSION=v1.10.4 LANG=C.UTF-8
# Tue, 23 Aug 2022 17:10:01 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="8518c78f43fe36315dbe0d623823c2c1b7a025c114f3f4adbb48e04ef63f1d9f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 23 Aug 2022 17:10:02 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:61ac6f1fa6c756de6112ecdfc02de29501ae480c8936c9cb01f6e8a955300d22`  
		...
		Size: 929.9 KB (929884 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d92f746e50f66e5a197fa123d12d596f3a7512d1d0a3d492c2d7891349f7febc`  
		Last Modified: Tue, 23 Aug 2022 17:23:22 GMT  
		Size: 6.8 MB (6750795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
