...
```console
$ docker pull elixir@sha256:6c920d4dce3f19a8976e577491b251d11206e4efe872a79854ba3659546cd581
```
...
```console
$ docker pull elixir@sha256:3f9731b1b6261a53df136e0692fbb9a3253ba7b3437e152b0c88b847344eabae
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52217496 bytes)**  
...
# Thu, 30 Jul 2020 21:13:37 GMT
CMD ["erl"]
# Thu, 30 Jul 2020 22:09:15 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 22:11:06 GMT
...
-	Layers:
	...
	-	`sha256:1c9831484ba2aa999a4d6baea38fcb5e722a203193b21b692873bcf51aafa1a6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef72820e6e4766b5a00df0a958a24557208516980704e2481ae2c7e2d2f3046f`  
		Last Modified: Thu, 30 Jul 2020 22:15:37 GMT  
		Size: 6.3 MB (6275501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7-alpine` - linux; arm variant v7

```console
$ docker pull elixir@sha256:4e9f2fe170a0fda4cfc3964ea25eb236be902670ba3f4b98be7fe271f2249b62
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48298817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8ea76ff7e8aaf1d2f60ce8d9e0829515ee98fd169e0cfe5206850af53b97b24`
-	Default Command: `["iex"]`
...
CMD ["erl"]
# Thu, 30 Jul 2020 20:58:24 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 21:00:00 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& buildDeps=' 		ca-certificates 		curl 		make 	' 	&& apk add --no-cache --virtual .build-deps $buildDeps 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& apk del .build-deps
# Thu, 30 Jul 2020 21:00:01 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:f8f0d959c6bd8613c0293596089b411d72c335b15571a7be188308483a55ddca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49f89994ad1f6d744a2f9d681e27ebbfff5e531a5780f0e8b5b79903e4930f3c`  
		Last Modified: Thu, 30 Jul 2020 21:07:06 GMT  
		Size: 6.3 MB (6270831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7-alpine` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:bf85b7c99bce526695e3b207545cfcb75e580f622fc0294c5109aa809418b457
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49356157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:085746c6da1fa5dfc0de17bf2373596a9ea97997ac42ff82722f82906951a2bc`
-	Default Command: `["iex"]`
...
CMD ["erl"]
# Thu, 30 Jul 2020 21:44:25 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 21:45:52 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& buildDeps=' 		ca-certificates 		curl 		make 	' 	&& apk add --no-cache --virtual .build-deps $buildDeps 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& apk del .build-deps
# Thu, 30 Jul 2020 21:45:53 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:c5a3ab5754aa8a8caebea0298aeb0c94bc9afad1a969e6737b264e1408fe71f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a38bd612b61f81de853addbcc0192f1895cfbc4929ef070395017d2ff74c2161`  
		Last Modified: Thu, 30 Jul 2020 21:50:46 GMT  
		Size: 6.3 MB (6273762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7-alpine` - linux; 386

```console
$ docker pull elixir@sha256:c49ce378055995baf5e71737fa3823aa201319fa8ef16e5b2330eab39689c836
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52146944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70ee0374b0ed9572d52a14c299448a1a245cddc2f97c8a212582796e707b4667`
-	Default Command: `["iex"]`
...
# Thu, 30 Jul 2020 21:44:33 GMT
CMD ["erl"]
# Thu, 30 Jul 2020 22:57:50 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 22:59:07 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& buildDeps=' 		ca-certificates 		curl 		make 	' 	&& apk add --no-cache --virtual .build-deps $buildDeps 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& apk del .build-deps
# Thu, 30 Jul 2020 22:59:07 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:a4a2c9f834771a58180c0e6f5aecdc2b004f814590c80e711133c3a253869e0c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5882122d51534c99551d8369b85d86ff7588cfd94d950475beb738982c49cf3c`  
		Last Modified: Thu, 30 Jul 2020 23:02:39 GMT  
		Size: 6.3 MB (6269667 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
