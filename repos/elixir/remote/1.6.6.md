...
```console
$ docker pull elixir@sha256:2b340c6c18dc1fa931922246f781fadccdf04c71a03a3d756d740372e0ea7819
```
...
```console
$ docker pull elixir@sha256:8bf5382156be1f47da1635738389c0b412d089a74c88e18d980e041febe9fca9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **469.4 MB (469431288 bytes)**  
...
# Wed, 10 Feb 2021 11:03:30 GMT
ENV ELIXIR_VERSION=v1.6.6 LANG=C.UTF-8
# Wed, 10 Feb 2021 11:04:31 GMT
...
-	Layers:
	...
	-	`sha256:88d76258db67d9604156523fc7ee4376243cfae49331c0c77cb9d7688bedf34c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cdfc589e717828a112ab20ee2f23b8a6899085201e7c5be635ac80b67035ff2`  
		Last Modified: Wed, 10 Feb 2021 11:07:17 GMT  
		Size: 6.0 MB (6020235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull elixir@sha256:a8339451ef5fdd4eeaf739e2e7d358d34720ff65041e2a9bfd4612a9d7ec591f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **447.4 MB (447404685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a83872c7c198de6de84fdddbe38516e6da0ded1c89ef409573f511a3c1bd726`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="69024b30f17b52c61e5e0568cbf9a2db325eb646ae230c48858401507394f5c0" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 10 Feb 2021 08:50:38 GMT
ENV ELIXIR_VERSION=v1.6.6 LANG=C.UTF-8
# Wed, 10 Feb 2021 08:52:07 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="74507b0646bf485ee3af0e7727e3fdab7123f1c5ecf2187a52a928ad60f93831" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Wed, 10 Feb 2021 08:52:07 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:4a1d5027b7dd8f68aa133bf46ebbb3d348266b46bc337908e6ea6f9fdc1b38ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a6dc4ddb61a7dc076a6fc260f8ca6ff30ec3e13dbae0558b59e720966cc6956`  
		Last Modified: Wed, 10 Feb 2021 08:55:55 GMT  
		Size: 6.0 MB (6020563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
