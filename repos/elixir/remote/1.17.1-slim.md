...
```console
$ docker pull elixir@sha256:8f78b75c555eb4741df9ca899759584eb75178e1d7a0134ebcc6ea3d29f2d8d5
```
...
### `elixir:1.17.1-slim` - linux; amd64
...
### `elixir:1.17.1-slim` - unknown; unknown
...
### `elixir:1.17.1-slim` - linux; arm variant v7
...
### `elixir:1.17.1-slim` - linux; arm64 variant v8
...
### `elixir:1.17.1-slim` - linux; ppc64le
