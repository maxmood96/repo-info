...
```console
$ docker pull elixir@sha256:b235c1fa795fc6de01a3d8cef435975a48f76c3d182cbc578d3ebfa4459b47d4
```
...
```console
$ docker pull elixir@sha256:e82384d3f2ecf00b4a65f4cf47c4a65f91a45670f155574641d8845659d388be
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **469.3 MB (469278433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:478f9bea5f98f2004222375eaf0a7e1f99c099952d612ac744d054c6fd798f6f`
-	Default Command: `["iex"]`
...
# Tue, 01 Sep 2020 23:29:24 GMT
ENV ELIXIR_VERSION=v1.5.3 LANG=C.UTF-8
# Tue, 01 Sep 2020 23:30:21 GMT
...
-	Layers:
	...
	-	`sha256:cd18b8f0af69924fae74a43629b68f38f83560036a3f447ca9611ddf11a909d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f59fb31283b456bdd8dc51417a0e57b0474d20fac1f418fcb87d3463ff40bc39`  
...
```console
$ docker pull elixir@sha256:0746622e4371ed8169f8abbc8075f3f8570de79ab7fae61ed35734e810579b9b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **434.0 MB (433954076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11d736794033823877b549c1f1d4ee9316db7900c61b58632cf8d3f96ad118cd`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="706cc0770062bde2674abc01964c68553398fe4d8023605b305cfe326b92520f" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 02 Sep 2020 06:47:45 GMT
ENV ELIXIR_VERSION=v1.5.3 LANG=C.UTF-8
# Wed, 02 Sep 2020 06:49:08 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="0fc6024b6027d87af9609b416448fd65d8927e0d05fc02410b35f4b9b9eb9629" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Wed, 02 Sep 2020 06:49:09 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:1fbb010574770b5269257d7b5a7da7495a0d66e9e1147a740f1469b3e98a5c42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a899c51fbf71f8a050b6f40dd62257c4946ebe79080633e798cc4eb9bdff40ca`  
		Last Modified: Wed, 02 Sep 2020 06:51:39 GMT  
		Size: 5.6 MB (5601052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.5` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:edb9922e9781a6447c461dff918f1f000648db04ab55e899b7fdbb28aadec2da
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **447.2 MB (447231454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04985e0c4473ca0fd2b0ccec42fd84c0ebe973fd7c9049cf4346a6dd99fb3ef8`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="706cc0770062bde2674abc01964c68553398fe4d8023605b305cfe326b92520f" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 01 Sep 2020 21:34:34 GMT
ENV ELIXIR_VERSION=v1.5.3 LANG=C.UTF-8
# Tue, 01 Sep 2020 21:36:41 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="0fc6024b6027d87af9609b416448fd65d8927e0d05fc02410b35f4b9b9eb9629" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 01 Sep 2020 21:36:50 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:fa7a122aa15ea3ed7e7dfcd2e21cd9809242f7cde1a0d925a82c269b43f146ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9f54d9675b512fc3664341dfbda58fc0e3c1bcbd69dac053444108323fa6124`  
		Last Modified: Tue, 01 Sep 2020 21:41:08 GMT  
		Size: 5.6 MB (5603525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.5` - linux; 386

```console
$ docker pull elixir@sha256:3b1f26a352cf64b0f45e774d40d1f71220f5c130992cddfa9e4289ac36870221
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **473.7 MB (473684294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3424aacaff275030aa7351cdcf2c59f85d7bf610a3f9eb3fe919d749b96d0675`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="706cc0770062bde2674abc01964c68553398fe4d8023605b305cfe326b92520f" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 01 Sep 2020 17:26:37 GMT
ENV ELIXIR_VERSION=v1.5.3 LANG=C.UTF-8
# Tue, 01 Sep 2020 17:28:07 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="0fc6024b6027d87af9609b416448fd65d8927e0d05fc02410b35f4b9b9eb9629" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Tue, 01 Sep 2020 17:28:07 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:294255c084d13098d09fa69eceb62a6c1f4de54b9a788aec4d866e5938723abf`  
		...
		Size: 836.7 KB (836663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a7871cc2c00f77481a4b1abf8a4917499c79d4eb34dac83e79e55425ca4980d`  
		Last Modified: Tue, 01 Sep 2020 17:30:33 GMT  
		Size: 5.6 MB (5600734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
