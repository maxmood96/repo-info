...
```console
$ docker pull elixir@sha256:9dc1477da3566c38ac82145e14e74f805b4ded1848c8ef70f97e335a794774b4
```
...
### `elixir:1.19.2-otp-26-slim` - linux; amd64
...
### `elixir:1.19.2-otp-26-slim` - unknown; unknown
...
### `elixir:1.19.2-otp-26-slim` - linux; arm variant v7
...
### `elixir:1.19.2-otp-26-slim` - linux; arm64 variant v8
...
### `elixir:1.19.2-otp-26-slim` - linux; 386
