...
```console
$ docker pull elixir@sha256:7ff4ebbbc061e0ba0d08781c6a92a011bf21027ac97b31a1727da4e2b49e00c5
```
...
```console
$ docker pull elixir@sha256:f5818332683e52308665fe5ac5400ca1f44a967fcbdf72f58a5a16c883b522b8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.9 MB (127867301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76d51397d66a3d1affae79799f3a169ccae2aecbce1b28d96a3dda4b0d19617f`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:d68e5a0f49c31f817feb6c3a3adda5b7d71d5ef3d4d5b2a048da9a746dbbcd79`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5fdafd4ab7a5c59e6202ed3d7f7e4eff8762351c7e193a648537d7396017a0ad`  
		Last Modified: Wed, 22 Apr 2026 11:44:38 GMT  
		Size: 8.2 MB (8240753 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:otp-27-slim` - unknown; unknown

```console
$ docker pull elixir@sha256:df4483e7e71d28c8b149ed4f4eaf3a7db52c63e393452274b5efb2a3840ceaf3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.8 MB (3846043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a26b002484b414b095afd40017a292b2a4493f2ce5bd6a82e7c6ef5458597de1`

```dockerfile
```

-	Layers:
	-	`sha256:93f2f6d7b2d8d5dc03593a12590e2a58fb0b55ff235ecfdcb454a38a414ad02b`  
		Last Modified: Wed, 22 Apr 2026 11:44:38 GMT  
		Size: 3.8 MB (3836259 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:230775b92309a59f6011c3dcb34e0053aafa1c95fe881e416a729eeaaac78819`  
