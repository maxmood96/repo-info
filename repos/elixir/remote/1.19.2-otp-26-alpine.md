...
```console
$ docker pull elixir@sha256:14be6f7ad252757fe19f5136a68ad2f714716aac57146cbcf474a1703b44c47c
```
...
### `elixir:1.19.2-otp-26-alpine` - linux; amd64
...
### `elixir:1.19.2-otp-26-alpine` - unknown; unknown
...
### `elixir:1.19.2-otp-26-alpine` - linux; arm variant v7
...
### `elixir:1.19.2-otp-26-alpine` - linux; arm64 variant v8
...
### `elixir:1.19.2-otp-26-alpine` - linux; 386
