...
```console
$ docker pull elixir@sha256:820e69fb068b2a6983d2a4f2122e6ace07aa0f91ed5ad25b197cbc3425fa736a
```
...
```console
$ docker pull elixir@sha256:baa66b9348a290851075936a7707107d3524a6f3f7b02f7e8558f69d14f1d22b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53672330 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dab8b92d5225ede57cfbef1ef5def8f038599a497fa25f2c94a3594a97a1517b`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:9583d678ae0d4fcfec7c13ba52a0bec724a218550b5d6d91b02b64b128a64535`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d669aa24dd47a050efde95c2cd6cb6134647fa8ab420d4ceb2ede2d2f84c6836`  
		Last Modified: Tue, 12 Mar 2024 00:51:58 GMT  
		Size: 6.8 MB (6841167 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:1.16-otp-25-alpine` - unknown; unknown

```console
$ docker pull elixir@sha256:2155264393a35bfffa712211b91d93cf9261a1b39f4cd6edaeedfb3446829704
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.5 KB (268481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50219992ceae4fb85f4ff327c259cb4e8ad6f0ead02cea240300111dedc45417`

```dockerfile
```

-	Layers:
	-	`sha256:947cbf320d99ac8f6037fd2ee3780eb605fbbb95521c54445ac7240db955adb9`  
		Last Modified: Tue, 12 Mar 2024 00:51:57 GMT  
		Size: 258.9 KB (258917 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7d794bb12bfaf9bc60356545735a5845c815701c4ab26c820351cdb0a3e740ad`  
		Last Modified: Tue, 12 Mar 2024 00:51:57 GMT  
...
```console
$ docker pull elixir@sha256:b139bbf9a5a38974ec1049955b49d8df9da23d5af796d85000c613d96da2b610
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.9 MB (53886221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6766956186a23c02e0ed3e1619fa5abd5969e48cead0e0a4532704311434aad9`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:adf3a195926267f5ab33ee165a528460666f44a31d6a4bbc2c3d28b2c4824e47`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6ff629db4a369ad1272ceeb1b63dba23e4f9f8f48328046de34eb73b516c7f74`  
		Last Modified: Tue, 12 Mar 2024 00:11:22 GMT  
		Size: 6.8 MB (6841000 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `elixir:1.16-otp-25-alpine` - unknown; unknown

```console
$ docker pull elixir@sha256:8c79cb1519e2333019b2c88dcf2d8a6573aa4c2b3d2a11ec4e1e06b98e46510e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.6 KB (266631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1526095421010ab1e9e25d44a90621c9be277ba3ee837ec75fea13f2822a4aad`

```dockerfile
```

-	Layers:
	-	`sha256:b7490d0e9fdd631e9393757c0c438555e63fc2c8ed6d21911649bfceb40f5f22`  
		Last Modified: Tue, 12 Mar 2024 00:11:22 GMT  
		Size: 257.0 KB (257011 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:771994625434e1be57781fbb61ab52527e673e597de164526486b67073282338`  
		Last Modified: Tue, 12 Mar 2024 00:11:22 GMT  
