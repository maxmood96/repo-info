...
### `elixir:1.18.0-slim` - linux; amd64
...
### `elixir:1.18.0-slim` - unknown; unknown
...
### `elixir:1.18.0-slim` - linux; arm variant v7
...
### `elixir:1.18.0-slim` - linux; arm64 variant v8
...
### `elixir:1.18.0-slim` - linux; ppc64le
...
### `elixir:1.18.0-slim` - linux; s390x
