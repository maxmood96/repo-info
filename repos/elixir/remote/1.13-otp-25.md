...
```console
$ docker pull elixir@sha256:d779df37492f09486b2ecd37747df4a7a22ab26f2a448387a4b0967c0a674547
```
...
```console
$ docker pull elixir@sha256:4995fbde86d38aad27ce728e75c0113d390d161e6d799fdad6e86cb5eb09ef1e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **577.6 MB (577597133 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19891e868525f2fc2a9b861262248e0fe1d00e4b040f9d3f5641a0c5f7388fcc`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:1f4347a62025ed9059369f5aabf2d2a38b72d8291ca2a46d9a0305eb4651f56b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91865b04b72f34971dc1bbf6067b8164d20fd362b9c5949132c693c79a2dd5a5`  
		Last Modified: Wed, 01 Nov 2023 19:08:22 GMT  
...
```console
$ docker pull elixir@sha256:f098ea3be7d1294faa3242eca7ff670bfbff6b8e2375969dc01eb68595dfeaf3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **512.8 MB (512826708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0291418dd9e7dbec975aa3baaf7c1def3f6ef564c2c2cba869a1e7a93c0407c2`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 01 Nov 2023 20:59:08 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Wed, 01 Nov 2023 21:00:32 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Wed, 01 Nov 2023 21:00:32 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:cfd3dfbf9efbb1ec1e880e087742cdee19971417a4952e1ccf8e4bed64042546`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2ffe7eea84820d12a509d0cacea1310a6c546be072e88b624a795ada0d486a5`  
		Last Modified: Wed, 01 Nov 2023 21:14:15 GMT  
		Size: 6.0 MB (5964356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.13-otp-25` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:7e4d84a7c45033a6cc18c116269e6fc023dcfa06da4ec181af970c5a62c7ebac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **563.3 MB (563339193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1214fe4ce3a6430fbb6aff0d6304a1cf29953df741bac2078b7e628203a605cc`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:bb2e3fe2199184021e129db5f89df506fb81686d97e009f799200e672de22843`  
		...
		Size: 781.9 KB (781897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82331c3aec1b7b0673b12080e555b07302b5737abb3e4d952063a5fb9b9be11f`  
		Last Modified: Wed, 01 Nov 2023 16:23:32 GMT  
...
```console
$ docker pull elixir@sha256:83ba1fb2569e9ebd93810aa154bb2743e1eca532a780ee5dc4540983a1ea78f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **579.0 MB (578993234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20c3722da80a7b8123c78af66836a682d56cfd65b984dd20e0e4c0013b2835c0`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 02 Nov 2023 03:44:15 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Thu, 02 Nov 2023 03:45:26 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Thu, 02 Nov 2023 03:45:26 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:32ab5d9b3a7539d9cd72bb579e40ad8cb80ff55e0fc355ec570a92ffe1a9f784`  
		...
		Size: 781.9 KB (781897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deab8f0d7daac84fc5e99a4957480c3879bb067651c8c3ac6a1c76aa2981afa2`  
		Last Modified: Thu, 02 Nov 2023 03:57:49 GMT  
