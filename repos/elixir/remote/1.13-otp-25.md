...
```console
$ docker pull elixir@sha256:3952ebedae79c246d7c96a7b2320899b64fa9663ef14e00a53dd32570e3d25e5
```
...
```console
$ docker pull elixir@sha256:4633c07d7ced1a7830c65d6198b41efd8a7f9c41e660790f681a779365aa88c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **572.9 MB (572865901 bytes)**  
...
# Wed, 05 Oct 2022 23:30:00 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Wed, 05 Oct 2022 23:30:42 GMT
...
-	Layers:
	...
	-	`sha256:f44b6b37d873be0785374a913e3ef283f3061e747d2d67426df477302543bcd2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:505415342efa782a2d0dc2e5c932577a84bb7ecf6f8d409fdf9d5aa0a40b81e4`  
		Last Modified: Wed, 05 Oct 2022 23:49:49 GMT  
...
```console
$ docker pull elixir@sha256:8da0e4e7f5860b12d9bea578d28ed63d38cf9aec533e86a81370fd18c625a23d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **549.9 MB (549892157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8f6a0bdd458f44fe8ef0cb376b2ed9af31f7cd7264243c93755132111c526a1`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="ff9ef42c737480477ebdf0dd9d95ece534a14c96f05edafbf32e9af973280bc3" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 05 Oct 2022 21:27:56 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Wed, 05 Oct 2022 21:28:37 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Wed, 05 Oct 2022 21:28:38 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:ba69be0abbca3ee915308b2924ddcd91e10dd4e937a857d30d63523119a5f7e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b690d2822babfce1663e70528fc5bcb0958822749bbd20cf3a96a9a45568ef7d`  
		Last Modified: Wed, 05 Oct 2022 21:49:25 GMT  
		Size: 6.0 MB (5965071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.13-otp-25` - linux; 386

```console
$ docker pull elixir@sha256:7cdb37a8533fec309074eff1bb4606c5dd2fd97efbfe84edad44f70cfeaa69b3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **573.7 MB (573745640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36c9100d412229cb250045e71d46c0388f4395490763f4530bd5bd70166c777b`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:252d9b5303ca95326aa9849217f5827699b14617c65c36c7d97c5c2522f2f756`  
		...
		Size: 988.2 KB (988204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36fb8dd7e8f1c2cf55ed25ba0fadcedec6ec325d2077c7ebca1685e6c6af2629`  
		Last Modified: Wed, 05 Oct 2022 15:01:21 GMT  
		Size: 6.0 MB (5965028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
