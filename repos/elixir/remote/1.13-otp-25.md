...
```console
$ docker pull elixir@sha256:2e65f64ebd17c9c9a32af8f7d86bd90838768730bcda56a721f21f08374a09c1
```
...
```console
$ docker pull elixir@sha256:903fe0fe8e496e37728af470470c5b319ae6ba84d2d0fb31ed1612ba6262f76b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **576.0 MB (575996910 bytes)**  
...
# Fri, 08 Sep 2023 04:52:23 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Fri, 08 Sep 2023 04:53:06 GMT
...
-	Layers:
	...
	-	`sha256:a1ca0221350f2d3316811d2e7c43f61ce9156afe7f635c5deb02343fd0862e72`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5dd1f1f79a2efd6457044ac65fcac56c9281ef857f37691f8bc5dd8d5a2e80d`  
		Last Modified: Fri, 08 Sep 2023 05:03:30 GMT  
...
```console
$ docker pull elixir@sha256:b4a159b609051d73962eeb37bf60b5535792480d40959a0fd343a3a831ee2ce3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **561.7 MB (561731592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a26e01963b5a1db32bd79963625cc127797f25257442d3e0d05c9de34d577457`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 07 Sep 2023 23:04:25 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Thu, 07 Sep 2023 23:04:57 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Thu, 07 Sep 2023 23:04:57 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:22aab7ca7ebee2587a392cf11317bbd9a2ef4de7cdd26316edf145d6e02cb3ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff71e91d6c84422ef0582f472a9abd99984d78bbd4fa62436acfacc44ced746c`  
		Last Modified: Thu, 07 Sep 2023 23:12:58 GMT  
...
```console
$ docker pull elixir@sha256:53c9be0308e265e38733208818d6c6f8f6ca5119a33db8803d6e4fe5ae300467
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **577.5 MB (577476943 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:001a3e6e99593b9067470e36ee8f1257740ac138607ab131367ff95b727b61b8`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 16 Aug 2023 20:07:28 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Wed, 16 Aug 2023 20:08:37 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Wed, 16 Aug 2023 20:08:37 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:518191c8410ab15bbf949aa371e19e0bcf43e77d7b385bce3d3c6058a1773d41`  
		...
		Size: 781.9 KB (781897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:421ad4fe5943db416308f844b5b951a5666a00a5a2f2f32a2f811373265eba42`  
		Last Modified: Wed, 16 Aug 2023 20:30:34 GMT  
...
```console
$ docker pull elixir@sha256:d7294135380ab17e272502ab00142d75bb91799625df702eaa68ae712df7f391
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **582.3 MB (582337006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dc32b5e0747343b88f95f492a35f61d931f674d4bd5c6b84cad98fb1cff00c9`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 17 Aug 2023 00:49:33 GMT
ENV ELIXIR_VERSION=v1.13.4 LANG=C.UTF-8
# Thu, 17 Aug 2023 00:51:24 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="95daf2dd3052e6ca7d4d849457eaaba09de52d65ca38d6933c65bc1cdf6b8579" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Thu, 17 Aug 2023 00:51:25 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:bac7188dbe53c73e6cd2c4f4ec22aafeeebba1d90784a7d0dbed3ef432b72375`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8893384fcbc79102d7415fc6005c998a3d3a701dcdef10429ba190f3adb354ae`  
		Last Modified: Thu, 17 Aug 2023 01:03:56 GMT  
		Size: 6.0 MB (5964347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull elixir@sha256:5aa66051919c11fe6e76f7bdabba7b1e6505fc4ac01fdd3a3076aeb79cef827a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **537.3 MB (537337255 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b36c2dc3f9fe3b85b33b4a00bded070caecd52a7a656999b626fd92095340fda`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:db0dfaadaf8e6c6f403cf04b2cd9afc0f9bd2661aa81ae90d38950d7745883cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ae4ea68136b899c4a539bc469f319abcae206d94dab9ad0305dc3cbd81fafe`  
		Last Modified: Thu, 07 Sep 2023 17:23:34 GMT  
		Size: 6.0 MB (5964358 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
