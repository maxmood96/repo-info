...
```console
$ docker pull elixir@sha256:1c5cfc6e4b571fec796e5e565d35b74bdcb267e4f9a82a530860809b470c5186
```
...
```console
$ docker pull elixir@sha256:58fd4bdb40e7f9cc94e6a8b2b016dcf54a089be27d19b41a24da90c7a21e7381
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **580.5 MB (580479759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94a92ff7452e2f34aad21551043902ceb290897149ee8a3d84e52187163e6140`
-	Default Command: `["iex"]`
...
# Tue, 26 Dec 2023 20:30:54 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:31:42 GMT
...
-	Layers:
	...
	-	`sha256:4c34cc1670dcdaba786e0bb1d23b6a480ec5d0e5d3ea4276789d3bcad45a67d1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26f21875cc73ad5eee2491420696a61111de8a913b67439e248113bdf5f15b3c`  
		Last Modified: Tue, 26 Dec 2023 20:42:07 GMT  
		Size: 6.7 MB (6736258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.16` - linux; arm variant v7

```console
$ docker pull elixir@sha256:cd12f5fa84c2a4caeb0bd669109a2c18b73c2f46343706b933bb577d623f6177
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **514.4 MB (514433019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c315369b8298b5a2382c3c8ea7c584ac48a66526087c4af384eadb707dced9d`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 26 Dec 2023 20:13:36 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:15:00 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="d7fe641e3c85c9774232618d22c880c86c2f31e3508c344ce75d134cd40aea18" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 26 Dec 2023 20:15:01 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:4b30d242a806d3b5be62a782a25ccad5cb03768526d8cebf92795b9a31ad72e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e68637e77606985639a73a73fee25aad109d1fd9c6464d4df5aa9d1d542109d2`  
		Last Modified: Tue, 26 Dec 2023 20:32:03 GMT  
		Size: 6.7 MB (6736274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.16` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:0501e89402602cda1ffb1fa73e43c6d0ca6dd7e83edb2c479f75741977803638
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **565.7 MB (565688668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff423e9553f098fd666d09ecf3177fc4dc6fd6c8ce15df836c040827ce6c5c28`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 26 Dec 2023 20:32:32 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:33:03 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="d7fe641e3c85c9774232618d22c880c86c2f31e3508c344ce75d134cd40aea18" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 26 Dec 2023 20:33:04 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:b68e358a64d407ba1061956e0a80418f2233418ffb732a815bef5bcf419f8df6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7554f962460c1cef29f5e5782a5f0e1b69aa92a2a8d47537e4ab6db37354d3e9`  
		Last Modified: Tue, 26 Dec 2023 20:40:21 GMT  
		Size: 6.7 MB (6736246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.16` - linux; 386

```console
$ docker pull elixir@sha256:c3d3691c08020dbf43674e67376f9b00895b5ab893f61bba20c9cf02ed929160
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **580.6 MB (580584952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21385e72af6047985ae983b8bb7b915b3f9ba2334fc00e764a11d435bd77e35c`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 26 Dec 2023 20:50:23 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:51:45 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="d7fe641e3c85c9774232618d22c880c86c2f31e3508c344ce75d134cd40aea18" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 26 Dec 2023 20:51:46 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:2a9dc5af62a47d1adf1e24692b41e9c95f6d3eb7ca7b38fc34e72080ba0b9648`  
		...
		Size: 781.8 KB (781813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bc52cd5886429bacd94eea7919e8a8c36157d0c30b5d5f749d198a764d87a03`  
		Last Modified: Tue, 26 Dec 2023 21:06:44 GMT  
		Size: 6.7 MB (6736271 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.16` - linux; ppc64le

```console
$ docker pull elixir@sha256:56fbb49200d4010ced3a28f96cce4be7286ac43e17c5ed8a04c62341f4b9d874
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **585.1 MB (585133530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:679055279184ed04d18f9f5b71a9989dd322ae95f052e6ed1605c6b5aa4af918`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 26 Dec 2023 20:32:39 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:33:52 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="d7fe641e3c85c9774232618d22c880c86c2f31e3508c344ce75d134cd40aea18" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 26 Dec 2023 20:33:53 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:2dbbf345cee1732c7f9b74f7d1e368b06121323991020e04a40f840e925587ee`  
		...
		Size: 781.8 KB (781815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a59f60b7f65fbd4e32973bbbba3e5481fa992f2870d79cee6d01ec63dc41a80b`  
		Last Modified: Tue, 26 Dec 2023 20:48:39 GMT  
		Size: 6.7 MB (6736266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.16` - linux; s390x

```console
$ docker pull elixir@sha256:344effa837841a937ba0c1bffda49cd54520fa4672bafcd2710bb32d7063f9a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **539.9 MB (539915129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe9875f079f8935db5bc7033e4b30508a16276dcdc7bea37c515be3122cf4203`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="53ed7f294a8b8fb4d7d75988c69194943831c104d39832a1fa30307b1a8593de" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 26 Dec 2023 20:25:08 GMT
ENV ELIXIR_VERSION=v1.16.0 LANG=C.UTF-8
# Tue, 26 Dec 2023 20:25:56 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="d7fe641e3c85c9774232618d22c880c86c2f31e3508c344ce75d134cd40aea18" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 26 Dec 2023 20:25:56 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:7190ccc83ad459709adfb8d3d076a94910770560e476cb69b465518df4320e76`  
		...
		Size: 781.8 KB (781814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6d879dfba6eee82ac8e79c3f4290feb2d279e2aa00fde6584a313395c753924`  
		Last Modified: Tue, 26 Dec 2023 20:37:54 GMT  
		Size: 6.7 MB (6736245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
