...
```console
$ docker pull elixir@sha256:eaa69362a93106137e06983031b0e117ab8eacfdfbcea694b61ca2d87b845021
```
...
### `elixir:1.16.1-alpine` - linux; amd64
...
### `elixir:1.16.1-alpine` - linux; arm variant v7
