...
```console
$ docker pull elixir@sha256:523c57dd294645248bc5a482d77f7610643f94f84c3b12e2224f3c07417ef160
```
...
```console
$ docker pull elixir@sha256:a1f97efa443ebf3346fe78e39cfa2c4575511c6ca88f8512e2ecf674034d5117
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **466.8 MB (466829662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d44b5b530df1c48cf96de1943892a17af83c1f2b1676fa16ea08a5499bf6d41d`
-	Default Command: `["iex"]`
...
# Thu, 23 Jul 2020 07:05:51 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 23 Jul 2020 07:06:44 GMT
...
-	Layers:
	...
	-	`sha256:fe178a28f55c4e7a79976a7dbfd79909f70377260ffb4da8cbbdec275ed0424d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3702da54a1795e7b6d614c5561b0c12bcc0abd3b00cfb92684a1b95a87e8f3f9`  
		Last Modified: Thu, 23 Jul 2020 07:13:34 GMT  
		Size: 6.2 MB (6203412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; arm variant v7

```console
$ docker pull elixir@sha256:dc3a06328029bd1bbcdd60a15fda4edba514715dbb64e309ef1ad9e35b862293
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.5 MB (431514269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70f5e428cf1a000394ccda1e48335a0353e036a83901a866948bc65192749d42`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 30 Jul 2020 20:54:05 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 20:56:04 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Thu, 30 Jul 2020 20:56:06 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:6bec51261cae76e2d6eee49888661cf211b95be7299c711511e93e1445d7d373`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2a9122b4da608aa29e0e827c6d593cf2dace86f9da7fd941173ee3c3b8427bd`  
		Last Modified: Thu, 30 Jul 2020 21:06:48 GMT  
		Size: 6.2 MB (6201048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:237e26d405728253e6d8a7c4662c50c93a02d1a595d9f572261ddd46b3730d3d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **444.8 MB (444763045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7ef0152637c9f79f99e788005eb9a76d249dbb88bff81838f6bd80c31ca103f`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 30 Jul 2020 21:40:48 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 30 Jul 2020 21:42:15 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Thu, 30 Jul 2020 21:42:16 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:ee74b349ddb8de11ea915fa7597338009d2b3210497eb151081b6bfa33ed0ede`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d50ff9fd62c30fdd7a80149402bdf13e32b9218c6ff533cb1a0cda9ca473ad1`  
		Last Modified: Thu, 30 Jul 2020 21:50:28 GMT  
		Size: 6.2 MB (6203595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
