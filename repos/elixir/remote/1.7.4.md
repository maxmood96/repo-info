...
```console
$ docker pull elixir@sha256:b934e3cc70a291381f41e7a775de0152177bc51257f9ad33c1273fb77f14cc4e
```
...
```console
$ docker pull elixir@sha256:72c918b68959aa62055f81e147f0ad55c26915667deb98d029d50528265f9435
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **466.7 MB (466725299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17b02d0c976df4a0eec169a53bd27808db66b13d61bcd10f2cda5f5fa89aa299`
-	Default Command: `["iex"]`
...
# Fri, 03 Dec 2021 12:25:21 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Fri, 03 Dec 2021 12:26:20 GMT
...
-	Layers:
	...
	-	`sha256:928ad1189b522dd68b613933adb1cb1b6f4dca9dee29e468f5eb1814ab563371`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:080e9b503a98def1d51e78b10e414a4aeb08899f948f4ca3e7bc24d02e08994e`  
		Last Modified: Fri, 03 Dec 2021 12:34:32 GMT  
		Size: 6.2 MB (6202987 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; arm variant v7

```console
$ docker pull elixir@sha256:e7f98dad0acee75eed356f5f48c340209c50556e7f84e5096a174905b2cde024
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.3 MB (431320171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f02e7f0fdb21b3c8d0ab8934548aa7963840e0392ea596ecdfa7d89495dcfbb`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="11b6bead835421a276e287562588580b63ac1c8dcb0e3c51f674887e4ab395cd" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Sat, 04 Dec 2021 04:11:46 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Sat, 04 Dec 2021 04:13:20 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Sat, 04 Dec 2021 04:13:20 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:9b85aecde7e92dca91fb5330915159392ef9588154aea07fc7322a53a34af075`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54cd5bf177a9e5890b66d0b97a80fd84011c84adc184bd0be3f737aeb38607b0`  
		Last Modified: Sat, 04 Dec 2021 04:29:24 GMT  
		Size: 6.2 MB (6201156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:6a80ea72f9c171c9b5ac3e8fdb76699063d0a32db23a851851185d952df8653a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **444.1 MB (444092378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a87c6110769e152c7aac053274d276a36702e826ea2dd765c30170fc3e1e7bb`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="11b6bead835421a276e287562588580b63ac1c8dcb0e3c51f674887e4ab395cd" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Fri, 03 Dec 2021 15:57:19 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Fri, 03 Dec 2021 15:58:03 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
...
-	Layers:
	...
	-	`sha256:9d14a85040644454deb6226c36ae4032b59fdf028a36b6da6384b68550e463ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dfd323b054c192885c5d53f233e3a3d171a5c2bab98f5fd1aa0003809d8f539`  
		Last Modified: Fri, 03 Dec 2021 16:12:18 GMT  
		Size: 6.2 MB (6205002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; 386

```console
$ docker pull elixir@sha256:09b37275c9c698ee1f365c1b7149e9e384ceeb4933e5c2870b8d35928ca02961
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **471.0 MB (470982693 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c606de778d2c0404516737e31b1adb746660bedb245897e144c6dc4896e57a40`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="11b6bead835421a276e287562588580b63ac1c8dcb0e3c51f674887e4ab395cd" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Fri, 03 Dec 2021 05:40:37 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Fri, 03 Dec 2021 05:41:45 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Fri, 03 Dec 2021 05:41:45 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:b60a421f2044b2fd84fb48b7f9bfe4c7b5ff446da303163176a2ef2281024dc5`  
		...
		Size: 950.2 KB (950171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cef03f99b816e08fc3ca086a978f084010ec9e0072f1ff32ebeb90a1ab454e81`  
		Last Modified: Fri, 03 Dec 2021 05:55:34 GMT  
