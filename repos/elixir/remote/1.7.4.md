...
```console
$ docker pull elixir@sha256:1256423388d7f11fae0e257d549cceff53996d997cd19cf1a0e7439cd982bee8
```
...
```console
$ docker pull elixir@sha256:2ca324b4eb63dae525e13dcff3a298ad0b6dc73a45d70e464a0e18575536e13a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **466.2 MB (466182926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdbe30c344bd6d9ab0295eaeda8ad5e7da2f4c9839bf6bef12efab6b53dfa9e4`
-	Default Command: `["iex"]`
...
# Fri, 11 Sep 2020 03:35:36 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Fri, 11 Sep 2020 03:36:29 GMT
...
-	Layers:
	...
	-	`sha256:715805fa5d6001a3c39989ad54f60e1278a7b76037757e1d6b8fb1cfe172b71d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fab597cb3787d5140908b9a90bb13b22b8d012f3b88542b944a7a6f3d273296`  
		Last Modified: Fri, 11 Sep 2020 03:43:26 GMT  
...
```console
$ docker pull elixir@sha256:8fc3833d091b2225db8ea15f3247fbc3619f018f66564a341788677bad45c1a4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.4 MB (431381526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e322227282fec6128c891c7a23636c07fa323400dcc26f17040a7afb86fb8f24`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 02 Sep 2020 06:42:13 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Wed, 02 Sep 2020 06:43:35 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Wed, 02 Sep 2020 06:43:36 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:7429cc51a139e51c9db3aca45d52363e5378731c72e8e00b8821f37d2cde970d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b6357342d246240772c4716c9124500833e9c13f51f90cc28cf1aa528364dc3`  
		Last Modified: Wed, 02 Sep 2020 06:51:13 GMT  
		Size: 6.2 MB (6200911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; arm64 variant v8

```console
$ docker pull elixir@sha256:7269d7d05ed0fe97140c5b95fe99f8eb745a6df0771a448f2419d038468ccedc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **444.1 MB (444082821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7be6895722e54fb014ec922232e3a0870a38fabf72425bc281b0d0fbaa18340`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Fri, 11 Sep 2020 00:12:48 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Fri, 11 Sep 2020 00:14:18 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Fri, 11 Sep 2020 00:14:19 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:9801e061959348cfd13d290564b5eb6b3f42b5911470dcfb74b873e02815af08`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18e8e5132dd46243741faa3354f1b72d00f1a0d34166fcc640509877bef07ed7`  
		Last Modified: Fri, 11 Sep 2020 00:27:40 GMT  
		Size: 6.2 MB (6203980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.7.4` - linux; 386

```console
$ docker pull elixir@sha256:245b18082e4a22639ff101e29432955ef7584c1effe9500500d93aba23ed94fb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **470.5 MB (470456113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee74bbb0957fa669dbe0bc67f1ba49970ceeb21cfd92242f69a37ef0ac4e1f5a`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Thu, 10 Sep 2020 21:53:34 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Thu, 10 Sep 2020 21:55:19 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Thu, 10 Sep 2020 21:55:19 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:144a3531e6696da8de20c61caae6f38acee01a025276e8c2b4819f842c9f0af0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c7c8b6f9c9cc3ffb3606832f62a69fcc3034ed53c3c7ef41316fedfcaa6ec31`  
		Last Modified: Thu, 10 Sep 2020 22:04:21 GMT  
		Size: 6.2 MB (6200831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
