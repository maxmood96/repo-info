...
```console
$ docker pull elixir@sha256:1fd3e4f40890ee5fba7e207909bf4af0b46fbfeeea35d168855ac18d0bce0654
```
...
```console
$ docker pull elixir@sha256:e169e7304f07e7728091d29b0cfb871b8e48c6a353e212add38e90bf0bd13243
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.5 MB (431518831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e724ef6af533902c28e6401bddce1447c5b4644463f04f999d138348a5ef582a`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="e14cdc1f5b7d363a238a9f555f89e878bc4fc836c970571b41b90ee947f91505" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Wed, 20 May 2020 22:05:29 GMT
ENV ELIXIR_VERSION=v1.7.4 LANG=C.UTF-8
# Wed, 20 May 2020 22:06:52 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="c7c87983e03a1dcf20078141a22355e88dadb26b53d3f3f98b9a9268687f9e20" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean
# Wed, 20 May 2020 22:06:53 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:c30bd2f0734e727b23db6d2fb574dfba901a149218593de6b3b5b2be9ae5d48a`  
		...
		Size: 833.3 KB (833282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:877933791967cd91dae43d08ce52a326296620afdb2cd3887436722b8f2eb0cd`  
		Last Modified: Wed, 20 May 2020 22:15:14 GMT  
		Size: 6.2 MB (6200846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull elixir@sha256:3c6589a0b1cd3613b78cb115d755cbfa6fc354d23d3f2e3dc7322264cf13a08f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **471.1 MB (471137250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864334d0adedd51ed44f865bd59a4e6cecf345c0d672bc1b197c19de11e9c8b2`
-	Default Command: `["iex"]`
...
-	Layers:
	...
	-	`sha256:a91d98d85a4f08cfd5bd0ac0556be32d07e22070058b083f76925efb0557388a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:882644950551cd0c8265362503c167e3af3d3863bd6b6e7c6d33d785c37cba5a`  
		Last Modified: Thu, 21 May 2020 00:25:58 GMT  
