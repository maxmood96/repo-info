...
```console
$ docker pull elixir@sha256:f1072d1c7b00b73a42b616983fb2594eab166f0ce41c31ca4eb08e5d289ae42a
```
...
```console
$ docker pull elixir@sha256:f517492686592a8de5393b1110a7be69c811c9a36545f1105b389ce8e1a31df4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **569.2 MB (569227918 bytes)**  
...
# Tue, 23 Aug 2022 20:22:28 GMT
ENV ELIXIR_VERSION=v1.14.0-rc.0 LANG=C.UTF-8
# Tue, 23 Aug 2022 20:23:08 GMT
...
-	Layers:
	...
	-	`sha256:021e521f6a3d0b9132013475441af4e0ec810e377b09b5b3fc116330413529e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5888499358a902bb94dbeb7db6f84791685b934881c5c9b161bd54a7d8a1e95f`  
		Last Modified: Tue, 23 Aug 2022 20:43:51 GMT  
		Size: 6.2 MB (6184997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull elixir@sha256:9d9499ff40bed313ea68a8d02c27319bb769631cda9a455c320454b690f1ad25
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **546.4 MB (546387187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ad37899cbc7a4ce5c81f347e162c5f93088c8ab33255678affe52946913f29c`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 23 Aug 2022 21:38:09 GMT
ENV ELIXIR_VERSION=v1.14.0-rc.0 LANG=C.UTF-8
# Tue, 23 Aug 2022 21:38:51 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="b3f7de60df9889bc511c515f22774b4ca51ec6d54f6528374c0762bad5b9a64f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 23 Aug 2022 21:38:52 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:672e47a782f1154b72994f329829f79cbf626ea788efba2a8fcd8732d1287a06`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7b02b97fdd0e0f3d547b2a283b1bfe60180e1beb19aa124d6e550f82f25d5f2`  
		Last Modified: Tue, 23 Aug 2022 22:02:15 GMT  
...
```console
$ docker pull elixir@sha256:b82ed8c7b531cbe852acce8ea2541f21afda22ec68b801593e7d29fd8e997915
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **567.8 MB (567794465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d365e44fd48b2ce614cece9b75c225d537709c824700de97861ee74d5740cac6`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 23 Aug 2022 20:16:37 GMT
ENV ELIXIR_VERSION=v1.14.0-rc.0 LANG=C.UTF-8
# Tue, 23 Aug 2022 20:18:18 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="b3f7de60df9889bc511c515f22774b4ca51ec6d54f6528374c0762bad5b9a64f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 23 Aug 2022 20:18:18 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:82bf1d560da4f8ebe94bfc1ca179a26112b8617c1c33de8e3960564646139ba7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e2648059ccbfd2906f43bb96bbf3788c6865b6e287ce20ee9054ed82661b02a`  
		Last Modified: Tue, 23 Aug 2022 20:37:08 GMT  
		Size: 6.2 MB (6185001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `elixir:1.14` - linux; s390x

```console
$ docker pull elixir@sha256:0a1e866f9862ff3a9bd992fde0a81a5e1ea9752d2d15b13343870a5933b90526
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **531.1 MB (531100940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d39ec70d962d07c77096b2dca19acabea74a365a4a37e3608e2486c6d66b9b1b`
-	Default Command: `["iex"]`
...
RUN set -xe 	&& REBAR3_DOWNLOAD_URL="https://github.com/erlang/rebar3/archive/${REBAR3_VERSION}.tar.gz" 	&& REBAR3_DOWNLOAD_SHA256="cce1925d33240d81d0e4d2de2eef3616d4c17b0532ed004274f875e6607d25d2" 	&& mkdir -p /usr/src/rebar3-src 	&& curl -fSL -o rebar3-src.tar.gz "$REBAR3_DOWNLOAD_URL" 	&& echo "$REBAR3_DOWNLOAD_SHA256 rebar3-src.tar.gz" | sha256sum -c - 	&& tar -xzf rebar3-src.tar.gz -C /usr/src/rebar3-src --strip-components=1 	&& rm rebar3-src.tar.gz 	&& cd /usr/src/rebar3-src 	&& HOME=$PWD ./bootstrap 	&& install -v ./rebar3 /usr/local/bin/ 	&& rm -rf /usr/src/rebar3-src
# Tue, 23 Aug 2022 22:25:08 GMT
ENV ELIXIR_VERSION=v1.14.0-rc.0 LANG=C.UTF-8
# Tue, 23 Aug 2022 22:25:59 GMT
RUN set -xe 	&& ELIXIR_DOWNLOAD_URL="https://github.com/elixir-lang/elixir/archive/${ELIXIR_VERSION}.tar.gz" 	&& ELIXIR_DOWNLOAD_SHA256="b3f7de60df9889bc511c515f22774b4ca51ec6d54f6528374c0762bad5b9a64f" 	&& curl -fSL -o elixir-src.tar.gz $ELIXIR_DOWNLOAD_URL 	&& echo "$ELIXIR_DOWNLOAD_SHA256  elixir-src.tar.gz" | sha256sum -c - 	&& mkdir -p /usr/local/src/elixir 	&& tar -xzC /usr/local/src/elixir --strip-components=1 -f elixir-src.tar.gz 	&& rm elixir-src.tar.gz 	&& cd /usr/local/src/elixir 	&& make install clean 	&& find /usr/local/src/elixir/ -type f -not -regex "/usr/local/src/elixir/lib/[^\/]*/lib.*" -exec rm -rf {} + 	&& find /usr/local/src/elixir/ -type d -depth -empty -delete
# Tue, 23 Aug 2022 22:25:59 GMT
CMD ["iex"]
```
...
-	Layers:
	...
	-	`sha256:02f6f059ee828aaf4f152a2799e2f8d9d5b54ada4ee945fb3f5b1238d56a3442`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e4d4873c4ffe0a512f556469c23e63cb7bb4831062e2d89b8ba3291626dad7b`  
		Last Modified: Tue, 23 Aug 2022 22:38:43 GMT  
		Size: 6.2 MB (6184915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
