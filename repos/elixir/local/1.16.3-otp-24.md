...
### `dpkg` source package: `cups=2.3.3op2-3+deb11u8`

Binary Packages:

- `libcups2:amd64=2.3.3op2-3+deb11u8`
...
```console
$ apt-get source -qq --print-uris cups=2.3.3op2-3+deb11u8
'http://deb.debian.org/debian/pool/main/c/cups/cups_2.3.3op2-3%2bdeb11u8.dsc' cups_2.3.3op2-3+deb11u8.dsc 3412 SHA256:5e5e35d6a8f21dfb12d960fa79ec4b1b7cd3c3fd403b675b8276d282bd74ceea
...
'http://deb.debian.org/debian/pool/main/c/cups/cups_2.3.3op2-3%2bdeb11u8.debian.tar.xz' cups_2.3.3op2-3+deb11u8.debian.tar.xz 350468 SHA256:4bcfb6ac208ddbabcec8f63993ba0c430f6fad8df4262830657a4e9f674fa232
```

Other potentially useful URLs:

- https://sources.debian.net/src/cups/2.3.3op2-3+deb11u8/ (for browsing the source)
- https://sources.debian.net/src/cups/2.3.3op2-3+deb11u8/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cups/2.3.3op2-3+deb11u8/ (for access to the source package after it no longer exists in the archive)
