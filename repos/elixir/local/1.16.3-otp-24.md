...
- Created: `2026-05-20T03:25:31.975013405Z`
...
### `dpkg` source package: `alsa-lib=1.2.4-1.1+deb11u1`
...
```console
$ apt-get source -qq --print-uris alsa-lib=1.2.4-1.1+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/a/alsa-lib/alsa-lib_1.2.4-1.1%2bdeb11u1.dsc' alsa-lib_1.2.4-1.1+deb11u1.dsc 2320 SHA256:042971430be9582b4cae5777b39774915bc4b3be732a29e948cdceb6d57fe868
'http://deb.debian.org/debian-security/pool/updates/main/a/alsa-lib/alsa-lib_1.2.4.orig.tar.bz2' alsa-lib_1.2.4.orig.tar.bz2 1044405 SHA256:f7554be1a56cdff468b58fc1c29b95b64864c590038dd309c7a978c7116908f7
'http://deb.debian.org/debian-security/pool/updates/main/a/alsa-lib/alsa-lib_1.2.4-1.1%2bdeb11u1.debian.tar.xz' alsa-lib_1.2.4-1.1+deb11u1.debian.tar.xz 31260 SHA256:6f8dedc591762f00ffe4d5b78f9a6fd4073a4e60cfec804d4d6dadf5594d9185
```

Other potentially useful URLs:

- https://sources.debian.net/src/alsa-lib/1.2.4-1.1+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/alsa-lib/1.2.4-1.1+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/alsa-lib/1.2.4-1.1+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `avahi=0.8-5+deb11u3`
...
```console
$ apt-get source -qq --print-uris avahi=0.8-5+deb11u3
'http://deb.debian.org/debian-security/pool/updates/main/a/avahi/avahi_0.8-5%2bdeb11u3.dsc' avahi_0.8-5+deb11u3.dsc 3981 SHA256:493b35b13f41a4df5584d97ce52b28c5d0992450c9c52c8bead35a621455f6ef
'http://deb.debian.org/debian-security/pool/updates/main/a/avahi/avahi_0.8.orig.tar.gz' avahi_0.8.orig.tar.gz 1591458 SHA256:060309d7a333d38d951bc27598c677af1796934dbd98e1024e7ad8de798fedda
'http://deb.debian.org/debian-security/pool/updates/main/a/avahi/avahi_0.8-5%2bdeb11u3.debian.tar.xz' avahi_0.8-5+deb11u3.debian.tar.xz 40524 SHA256:afbf89f3491be2a33a6a3cd305eebf0d4944e39d10c94e6eae9f0e4be786896e
```

Other potentially useful URLs:

- https://sources.debian.net/src/avahi/0.8-5+deb11u3/ (for browsing the source)
- https://sources.debian.net/src/avahi/0.8-5+deb11u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/avahi/0.8-5+deb11u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `bubblewrap=0.4.1-3+deb11u1`

Binary Packages:

- `bubblewrap=0.4.1-3+deb11u1`
...
```console
$ apt-get source -qq --print-uris bubblewrap=0.4.1-3+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/b/bubblewrap/bubblewrap_0.4.1-3%2bdeb11u1.dsc' bubblewrap_0.4.1-3+deb11u1.dsc 2195 SHA256:36e23966cc764b7686edd18a6b8192dddad98cf6f4867f560f2324b5d6c4f749
'http://deb.debian.org/debian-security/pool/updates/main/b/bubblewrap/bubblewrap_0.4.1.orig.tar.xz' bubblewrap_0.4.1.orig.tar.xz 214496 SHA256:b9c69b9b1c61a608f34325c8e1a495229bacf6e4a07cbb0c80cf7a814d7ccc03
'http://deb.debian.org/debian-security/pool/updates/main/b/bubblewrap/bubblewrap_0.4.1-3%2bdeb11u1.debian.tar.xz' bubblewrap_0.4.1-3+deb11u1.debian.tar.xz 15712 SHA256:2634224cdf69ea172cb32c07f3c214bdd64605286e20fca94f3bcfbc9a463845
```

Other potentially useful URLs:

- https://sources.debian.net/src/bubblewrap/0.4.1-3+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/bubblewrap/0.4.1-3+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bubblewrap/0.4.1-3+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `cups=2.3.3op2-3+deb11u10`
...
```console
$ apt-get source -qq --print-uris cups=2.3.3op2-3+deb11u10
'http://deb.debian.org/debian-security/pool/updates/main/c/cups/cups_2.3.3op2-3%2bdeb11u10.dsc' cups_2.3.3op2-3+deb11u10.dsc 3416 SHA256:db26d3d3e9d0843137762fad01dab09637c7fab773fd834ecc4183b38fd0a103
...
'http://deb.debian.org/debian-security/pool/updates/main/c/cups/cups_2.3.3op2-3%2bdeb11u10.debian.tar.xz' cups_2.3.3op2-3+deb11u10.debian.tar.xz 354664 SHA256:1b19470dfd7ecfd4bdf32a8989d3ad8fdd77622a4714b3ac0b382a9a3d2387c8
```

Other potentially useful URLs:

- https://sources.debian.net/src/cups/2.3.3op2-3+deb11u10/ (for browsing the source)
- https://sources.debian.net/src/cups/2.3.3op2-3+deb11u10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cups/2.3.3op2-3+deb11u10/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `flite=2.2-2`
...
```console
$ apt-get source -qq --print-uris flite=2.2-2
'http://deb.debian.org/debian/pool/main/f/flite/flite_2.2-2.dsc' flite_2.2-2.dsc 2178 SHA256:5b041a8046efe1076f199394661d3d5475b0caf3493b549d070908fe94b92e1e
...
'http://deb.debian.org/debian/pool/main/f/flite/flite_2.2-2.debian.tar.xz' flite_2.2-2.debian.tar.xz 48156 SHA256:818eefa2ef4e638984003f47ec25405285287f157b4ea4ab4f5740201c3ccc6a
```

Other potentially useful URLs:

- https://sources.debian.net/src/flite/2.2-2/ (for browsing the source)
- https://sources.debian.net/src/flite/2.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/flite/2.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gst-plugins-base1.0=1.18.4-2+deb11u5`

Binary Packages:

- `gstreamer1.0-plugins-base:amd64=1.18.4-2+deb11u5`
- `libgstreamer-gl1.0-0:amd64=1.18.4-2+deb11u5`
- `libgstreamer-plugins-base1.0-0:amd64=1.18.4-2+deb11u5`
...
```console
$ apt-get source -qq --print-uris gst-plugins-base1.0=1.18.4-2+deb11u5
'http://deb.debian.org/debian-security/pool/updates/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.18.4-2%2bdeb11u5.dsc' gst-plugins-base1.0_1.18.4-2+deb11u5.dsc 3742 SHA256:0c3ecccf95aaee32f10c0b101234fead00ecad9a535cb924efa98222f0480eea
'http://deb.debian.org/debian-security/pool/updates/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.18.4.orig.tar.xz' gst-plugins-base1.0_1.18.4.orig.tar.xz 3169512 SHA256:29e53229a84d01d722f6f6db13087231cdf6113dd85c25746b9b58c3d68e8323
'http://deb.debian.org/debian-security/pool/updates/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.18.4-2%2bdeb11u5.debian.tar.xz' gst-plugins-base1.0_1.18.4-2+deb11u5.debian.tar.xz 56064 SHA256:2247ee3c95f7bcacba6d40dc0dcc9aa1b8f83fe707d5aae3cf804e03db618262
```

Other potentially useful URLs:

- https://sources.debian.net/src/gst-plugins-base1.0/1.18.4-2+deb11u5/ (for browsing the source)
- https://sources.debian.net/src/gst-plugins-base1.0/1.18.4-2+deb11u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gst-plugins-base1.0/1.18.4-2+deb11u5/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `gst-plugins-good1.0=1.18.4-2+deb11u4`

Binary Packages:

- `gstreamer1.0-plugins-good:amd64=1.18.4-2+deb11u4`
...
```console
$ apt-get source -qq --print-uris gst-plugins-good1.0=1.18.4-2+deb11u4
'http://deb.debian.org/debian-security/pool/updates/main/g/gst-plugins-good1.0/gst-plugins-good1.0_1.18.4-2%2bdeb11u4.dsc' gst-plugins-good1.0_1.18.4-2+deb11u4.dsc 3613 SHA256:b389bc411e52a3b7ed1fdd13db8b9dbe6b7e3a649a449647a2be5105890847f5
...
'http://deb.debian.org/debian-security/pool/updates/main/g/gst-plugins-good1.0/gst-plugins-good1.0_1.18.4-2%2bdeb11u4.debian.tar.xz' gst-plugins-good1.0_1.18.4-2+deb11u4.debian.tar.xz 53496 SHA256:91747bfba15d7b718d3a30114a4dfbd0de72a37cbd28127d2c4a72d24eadc5df
```

Other potentially useful URLs:

- https://sources.debian.net/src/gst-plugins-good1.0/1.18.4-2+deb11u4/ (for browsing the source)
- https://sources.debian.net/src/gst-plugins-good1.0/1.18.4-2+deb11u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gst-plugins-good1.0/1.18.4-2+deb11u4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `gstreamer1.0=1.18.4-2.1+deb11u1`
...
```console
$ apt-get source -qq --print-uris gstreamer1.0=1.18.4-2.1+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/g/gstreamer1.0/gstreamer1.0_1.18.4-2.1%2bdeb11u1.dsc' gstreamer1.0_1.18.4-2.1+deb11u1.dsc 2918 SHA256:a3f96ff75866d1fb4020cca3840b8237c3b9c465a4e342be2b138b463228dffa
'http://deb.debian.org/debian-security/pool/updates/main/g/gstreamer1.0/gstreamer1.0_1.18.4.orig.tar.xz' gstreamer1.0_1.18.4.orig.tar.xz 2703948 SHA256:9aeec99b38e310817012aa2d1d76573b787af47f8a725a65b833880a094dfbc5
'http://deb.debian.org/debian-security/pool/updates/main/g/gstreamer1.0/gstreamer1.0_1.18.4-2.1%2bdeb11u1.debian.tar.xz' gstreamer1.0_1.18.4-2.1+deb11u1.debian.tar.xz 45104 SHA256:96278e726ad970a2af087789216a3f1163e722bb31e15461a9a30b7d8ecd3c32
```

Other potentially useful URLs:

- https://sources.debian.net/src/gstreamer1.0/1.18.4-2.1+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/gstreamer1.0/1.18.4-2.1+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gstreamer1.0/1.18.4-2.1+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libcaca=0.99.beta19-2.2+deb11u1`

Binary Packages:

- `libcaca0:amd64=0.99.beta19-2.2+deb11u1`
...
```console
$ apt-get source -qq --print-uris libcaca=0.99.beta19-2.2+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcaca/libcaca_0.99.beta19-2.2%2bdeb11u1.dsc' libcaca_0.99.beta19-2.2+deb11u1.dsc 2415 SHA256:33cf2f8f1ead7889a4c7040bb6305795a0ac29c43ad6c8bf0c62ff571a2b25b7
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcaca/libcaca_0.99.beta19.orig.tar.gz' libcaca_0.99.beta19.orig.tar.gz 1203495 SHA256:128b467c4ed03264c187405172a4e83049342cc8cc2f655f53a2d0ee9d3772f4
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcaca/libcaca_0.99.beta19-2.2%2bdeb11u1.debian.tar.xz' libcaca_0.99.beta19-2.2+deb11u1.debian.tar.xz 16084 SHA256:311a536dcc0b5b86ea0c4a7b7cb9bf65dce9a9f79699ab087c08743f9d075251
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcaca/0.99.beta19-2.2+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/libcaca/0.99.beta19-2.2+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcaca/0.99.beta19-2.2+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libcap2=1:2.44-1+deb11u1`
...
```console
$ apt-get source -qq --print-uris libcap2=1:2.44-1+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcap2/libcap2_2.44-1%2bdeb11u1.dsc' libcap2_2.44-1+deb11u1.dsc 2212 SHA256:eae49d474583738ed24f1c837d3a86f7f2ffe590ac211403c1cd581b0b4e488b
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcap2/libcap2_2.44.orig.tar.xz' libcap2_2.44.orig.tar.xz 125568 SHA256:92188359cd5be86e8e5bd3f6483ac6ce582264f912398937ef763def2205c8e1
'http://deb.debian.org/debian-security/pool/updates/main/libc/libcap2/libcap2_2.44-1%2bdeb11u1.debian.tar.xz' libcap2_2.44-1+deb11u1.debian.tar.xz 23004 SHA256:1cb81c73eeb97a051e98ff5cc28e811d45ae356d6b3c9954be68a7878776bec3
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcap2/1:2.44-1+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/libcap2/1:2.44-1+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcap2/1:2.44-1+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libsndfile=1.0.31-2+deb11u2`

Binary Packages:

- `libsndfile1:amd64=1.0.31-2+deb11u2`
...
```console
$ apt-get source -qq --print-uris libsndfile=1.0.31-2+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/libs/libsndfile/libsndfile_1.0.31-2%2bdeb11u2.dsc' libsndfile_1.0.31-2+deb11u2.dsc 2328 SHA256:5012394d730083c2e48ee8f4118f674e4d9e3326b1d969aa4a14096981f73835
...
'http://deb.debian.org/debian-security/pool/updates/main/libs/libsndfile/libsndfile_1.0.31-2%2bdeb11u2.debian.tar.xz' libsndfile_1.0.31-2+deb11u2.debian.tar.xz 17884 SHA256:e8cac1fb3cb461cc1ef9c7f85faf8a865fd81c8c1e574964e28c3ff7f3815f80
```

Other potentially useful URLs:

- https://sources.debian.net/src/libsndfile/1.0.31-2+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/libsndfile/1.0.31-2+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libsndfile/1.0.31-2+deb11u2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libsoup2.4=2.72.0-2+deb11u3`
...
```console
$ apt-get source -qq --print-uris libsoup2.4=2.72.0-2+deb11u3
'http://deb.debian.org/debian-security/pool/updates/main/libs/libsoup2.4/libsoup2.4_2.72.0-2%2bdeb11u3.dsc' libsoup2.4_2.72.0-2+deb11u3.dsc 3208 SHA256:ef45a1060217b726e4829c999a14d93ebd9bc2b0c76ce79c37be804c1aec33fa
'http://deb.debian.org/debian-security/pool/updates/main/libs/libsoup2.4/libsoup2.4_2.72.0.orig.tar.xz' libsoup2.4_2.72.0.orig.tar.xz 1477940 SHA256:170c3f8446b0f65f8e4b93603349172b1085fb8917c181d10962f02bb85f5387
'http://deb.debian.org/debian-security/pool/updates/main/libs/libsoup2.4/libsoup2.4_2.72.0-2%2bdeb11u3.debian.tar.xz' libsoup2.4_2.72.0-2+deb11u3.debian.tar.xz 47312 SHA256:94e879007c7d71fe9524377544b90d971051d18e9563f4a318f7a847869a8850
```

Other potentially useful URLs:

- https://sources.debian.net/src/libsoup2.4/2.72.0-2+deb11u3/ (for browsing the source)
- https://sources.debian.net/src/libsoup2.4/2.72.0-2+deb11u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libsoup2.4/2.72.0-2+deb11u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libvpx=1.9.0-1+deb11u5`

Binary Packages:

- `libvpx6:amd64=1.9.0-1+deb11u5`
...
```console
$ apt-get source -qq --print-uris libvpx=1.9.0-1+deb11u5
'http://deb.debian.org/debian-security/pool/updates/main/libv/libvpx/libvpx_1.9.0-1%2bdeb11u5.dsc' libvpx_1.9.0-1+deb11u5.dsc 2438 SHA256:dca95e3948e2078fdb93650e8dcc59b245889cc9b0dab8f5cba67c0aef48dc7a
...
'http://deb.debian.org/debian-security/pool/updates/main/libv/libvpx/libvpx_1.9.0-1%2bdeb11u5.debian.tar.xz' libvpx_1.9.0-1+deb11u5.debian.tar.xz 19160 SHA256:659f3ff381bcc860becc206306d2e036f6f99c1ec6223b89d25b64ce9040fd2e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libvpx/1.9.0-1+deb11u5/ (for browsing the source)
- https://sources.debian.net/src/libvpx/1.9.0-1+deb11u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libvpx/1.9.0-1+deb11u5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `llvm-toolchain-16=1:16.0.6-15~deb11u2`

Binary Packages:

- `libc++1-16:amd64=1:16.0.6-15~deb11u2`
- `libc++abi1-16:amd64=1:16.0.6-15~deb11u2`
- `libunwind-16:amd64=1:16.0.6-15~deb11u2`

Licenses: (parsed from: `/usr/share/doc/libc++1-16/copyright`, `/usr/share/doc/libc++abi1-16/copyright`, `/usr/share/doc/libunwind-16/copyright`)
...
```console
$ apt-get source -qq --print-uris llvm-toolchain-16=1:16.0.6-15~deb11u2
'http://deb.debian.org/debian/pool/main/l/llvm-toolchain-16/llvm-toolchain-16_16.0.6-15%7edeb11u2.dsc' llvm-toolchain-16_16.0.6-15~deb11u2.dsc 8076 SHA256:771ffaed9431dfbca4b0dc910803c3485b60fc85950318e5a18d0df0aa03463c
'http://deb.debian.org/debian/pool/main/l/llvm-toolchain-16/llvm-toolchain-16_16.0.6.orig.tar.xz' llvm-toolchain-16_16.0.6.orig.tar.xz 136421172 SHA256:5ab98480d3bc9f1896de1a1afafb46c318a9baa02bf21a4f6830c644d06c1cc0
'http://deb.debian.org/debian/pool/main/l/llvm-toolchain-16/llvm-toolchain-16_16.0.6-15%7edeb11u2.debian.tar.xz' llvm-toolchain-16_16.0.6-15~deb11u2.debian.tar.xz 171296 SHA256:052d2d2bb6a40dba756e8962a4d7d5b06364a0512a5d9a3d762b35e6cc940050
```

Other potentially useful URLs:

- https://sources.debian.net/src/llvm-toolchain-16/1:16.0.6-15~deb11u2/ (for browsing the source)
- https://sources.debian.net/src/llvm-toolchain-16/1:16.0.6-15~deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/llvm-toolchain-16/1:16.0.6-15~deb11u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mpg123=1.26.4-1+deb11u1`

Binary Packages:

- `libmpg123-0:amd64=1.26.4-1+deb11u1`
...
```console
$ apt-get source -qq --print-uris mpg123=1.26.4-1+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/m/mpg123/mpg123_1.26.4-1%2bdeb11u1.dsc' mpg123_1.26.4-1+deb11u1.dsc 2616 SHA256:1b69d835888641bea440e90c5967db2f9edcb1c5ac58c07d6cc02c8985c61025
'http://deb.debian.org/debian-security/pool/updates/main/m/mpg123/mpg123_1.26.4.orig.tar.bz2' mpg123_1.26.4.orig.tar.bz2 1050563 SHA256:081991540df7a666b29049ad870f293cfa28863b36488ab4d58ceaa7b5846454
'http://deb.debian.org/debian-security/pool/updates/main/m/mpg123/mpg123_1.26.4.orig.tar.bz2.asc' mpg123_1.26.4.orig.tar.bz2.asc 833 SHA256:e4d0bef9aa45533294ab69028a823c25423e491e124ac8086e592e3fec765e6b
'http://deb.debian.org/debian-security/pool/updates/main/m/mpg123/mpg123_1.26.4-1%2bdeb11u1.debian.tar.xz' mpg123_1.26.4-1+deb11u1.debian.tar.xz 35128 SHA256:bf1706f8047e99d1b5e8663e9d2ad9af99b133210c2f4c4f752b14368d1ab236
```

Other potentially useful URLs:

- https://sources.debian.net/src/mpg123/1.26.4-1+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/mpg123/1.26.4-1+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mpg123/1.26.4-1+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `taglib=1.11.1+dfsg.1-3+deb11u1`

Binary Packages:

- `libtag1v5:amd64=1.11.1+dfsg.1-3+deb11u1`
- `libtag1v5-vanilla:amd64=1.11.1+dfsg.1-3+deb11u1`
...
```console
$ apt-get source -qq --print-uris taglib=1.11.1+dfsg.1-3+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/t/taglib/taglib_1.11.1%2bdfsg.1-3%2bdeb11u1.dsc' taglib_1.11.1+dfsg.1-3+deb11u1.dsc 2545 SHA256:a759b66991995cdd6df66862d6a5585e4af104eb0a279022ca68178c53b1d828
'http://deb.debian.org/debian-security/pool/updates/main/t/taglib/taglib_1.11.1%2bdfsg.1.orig.tar.xz' taglib_1.11.1+dfsg.1.orig.tar.xz 868744 SHA256:5bceb7940edf5a0674f0892e5788b119f278c5c246f3f2cf979b27faa70063c8
'http://deb.debian.org/debian-security/pool/updates/main/t/taglib/taglib_1.11.1%2bdfsg.1-3%2bdeb11u1.debian.tar.xz' taglib_1.11.1+dfsg.1-3+deb11u1.debian.tar.xz 36288 SHA256:e5d8c10f5166db99d76d2d77560e7c538d61bacd5466868d54bf36b7c6201784
```

Other potentially useful URLs:

- https://sources.debian.net/src/taglib/1.11.1+dfsg.1-3+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/taglib/1.11.1+dfsg.1-3+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/taglib/1.11.1+dfsg.1-3+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `webkit2gtk=2.50.6-1~deb11u1`

Binary Packages:

- `libjavascriptcoregtk-4.0-18:amd64=2.50.6-1~deb11u1`
- `libwebkit2gtk-4.0-37:amd64=2.50.6-1~deb11u1`
...
```console
$ apt-get source -qq --print-uris webkit2gtk=2.50.6-1~deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/w/webkit2gtk/webkit2gtk_2.50.6-1%7edeb11u1.dsc' webkit2gtk_2.50.6-1~deb11u1.dsc 3998 SHA256:3a0764b83ea6ffa0e8bbd5a63321d5b452899231d9345944bdc90183c2e3cddf
...
'http://deb.debian.org/debian-security/pool/updates/main/w/webkit2gtk/webkit2gtk_2.50.6-1%7edeb11u1.debian.tar.xz' webkit2gtk_2.50.6-1~deb11u1.debian.tar.xz 106732 SHA256:f06f81e7d21956d65df3305e07e0bd8f8db16d10fa438253ab75a03c373ef881
```

Other potentially useful URLs:

- https://sources.debian.net/src/webkit2gtk/2.50.6-1~deb11u1/ (for browsing the source)
- https://sources.debian.net/src/webkit2gtk/2.50.6-1~deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/webkit2gtk/2.50.6-1~deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `xdg-dbus-proxy=0.1.2-2+deb11u1`

Binary Packages:

- `xdg-dbus-proxy=0.1.2-2+deb11u1`
...
```console
$ apt-get source -qq --print-uris xdg-dbus-proxy=0.1.2-2+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/x/xdg-dbus-proxy/xdg-dbus-proxy_0.1.2-2%2bdeb11u1.dsc' xdg-dbus-proxy_0.1.2-2+deb11u1.dsc 2236 SHA256:a955174c129a78e74eb9ffd30db0b6e971a09640519b762dabc88e3862aa70d6
'http://deb.debian.org/debian-security/pool/updates/main/x/xdg-dbus-proxy/xdg-dbus-proxy_0.1.2.orig.tar.xz' xdg-dbus-proxy_0.1.2.orig.tar.xz 119264 SHA256:1749d6f9f46dcc9edc87725641cf56cf91dcad1b01707891ea0850c1000c520f
'http://deb.debian.org/debian-security/pool/updates/main/x/xdg-dbus-proxy/xdg-dbus-proxy_0.1.2-2%2bdeb11u1.debian.tar.xz' xdg-dbus-proxy_0.1.2-2+deb11u1.debian.tar.xz 5728 SHA256:993490ab8760c237c881f860c93e8c050141391290be98a3bcb1c831f78b6810
```

Other potentially useful URLs:

- https://sources.debian.net/src/xdg-dbus-proxy/0.1.2-2+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/xdg-dbus-proxy/0.1.2-2+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xdg-dbus-proxy/0.1.2-2+deb11u1/ (for access to the source package after it no longer exists in the archive)
