...
- Created: `2026-02-03T06:18:46.152688388Z`
...
### `dpkg` source package: `libvpx=1.9.0-1+deb11u4`

Binary Packages:

- `libvpx6:amd64=1.9.0-1+deb11u4`
...
```console
$ apt-get source -qq --print-uris libvpx=1.9.0-1+deb11u4
'http://deb.debian.org/debian-security/pool/updates/main/libv/libvpx/libvpx_1.9.0-1%2bdeb11u4.dsc' libvpx_1.9.0-1+deb11u4.dsc 2279 SHA256:6dfd90f9a182c57dd8b2bc8a4f107df7d306bf747bdc2db24f817b1d6938f54a
...
'http://deb.debian.org/debian-security/pool/updates/main/libv/libvpx/libvpx_1.9.0-1%2bdeb11u4.debian.tar.xz' libvpx_1.9.0-1+deb11u4.debian.tar.xz 18148 SHA256:d689175beddb06541e77fc915202005554e5c53f0b78613d2be9089340c8db8e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libvpx/1.9.0-1+deb11u4/ (for browsing the source)
- https://sources.debian.net/src/libvpx/1.9.0-1+deb11u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libvpx/1.9.0-1+deb11u4/ (for access to the source package after it no longer exists in the archive)
