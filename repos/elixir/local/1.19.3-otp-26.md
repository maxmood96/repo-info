...
- Created: `2025-11-27T01:13:07.234699687Z`
...
### `dpkg` source package: `gdk-pixbuf=2.42.10+dfsg-1+deb12u2`

Binary Packages:

- `gir1.2-gdkpixbuf-2.0:amd64=2.42.10+dfsg-1+deb12u2`
- `libgdk-pixbuf-2.0-0:amd64=2.42.10+dfsg-1+deb12u2`
- `libgdk-pixbuf-2.0-dev:amd64=2.42.10+dfsg-1+deb12u2`
...
```console
$ apt-get source -qq --print-uris gdk-pixbuf=2.42.10+dfsg-1+deb12u2
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.10%2bdfsg-1%2bdeb12u2.dsc' gdk-pixbuf_2.42.10+dfsg-1+deb12u2.dsc 3173 SHA256:117f2f12e10c1a81b402f316edc37a1f02377e3475601360a2d50583a3432fca
...
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.10%2bdfsg-1%2bdeb12u2.debian.tar.xz' gdk-pixbuf_2.42.10+dfsg-1+deb12u2.debian.tar.xz 22604 SHA256:0a00c1c52b64abbe5fab1f08cc6c4b1032680c95ca9fdaf148f115011755de4b
```

Other potentially useful URLs:

- https://sources.debian.net/src/gdk-pixbuf/2.42.10+dfsg-1+deb12u2/ (for browsing the source)
- https://sources.debian.net/src/gdk-pixbuf/2.42.10+dfsg-1+deb12u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gdk-pixbuf/2.42.10+dfsg-1+deb12u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `glib2.0=2.74.6-2+deb12u7`
...
```console
$ apt-get source -qq --print-uris glibc=2.36-9+deb12u13
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.36-9%2bdeb12u13.dsc' glibc_2.36-9+deb12u13.dsc 9765 SHA256:c034e180a28197c8a9d2b378bcf621d87766a49b3d1bb2d82cc25068ba398cac
...
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.36-9%2bdeb12u13.debian.tar.xz' glibc_2.36-9+deb12u13.debian.tar.xz 908524 SHA256:728086077548b13c37a348a99f74b9c7a437d6a8aed4aab5e2ed86b3a5ff6df6
```

Other potentially useful URLs:

- https://sources.debian.net/src/glibc/2.36-9+deb12u13/ (for browsing the source)
- https://sources.debian.net/src/glibc/2.36-9+deb12u13/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glibc/2.36-9+deb12u13/ (for access to the source package after it no longer exists in the archive)
...
- `gstreamer1.0-plugins-base:amd64=1.22.0-3+deb12u5`
- `libgstreamer-gl1.0-0:amd64=1.22.0-3+deb12u5`
...
```console
$ apt-get source -qq --print-uris gst-plugins-base1.0=1.22.0-3+deb12u5
'http://deb.debian.org/debian/pool/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.22.0-3%2bdeb12u5.dsc' gst-plugins-base1.0_1.22.0-3+deb12u5.dsc 3733 SHA256:b792f551a66e3a1086bfeae6a59715f4e7c666280030630f17e05cc0cadd6d07
...
'http://deb.debian.org/debian/pool/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.22.0-3%2bdeb12u5.debian.tar.xz' gst-plugins-base1.0_1.22.0-3+deb12u5.debian.tar.xz 61472 SHA256:d47b99c8809635e802e841980637b1bf78b1e569461e9a552a8aff10780a90ae
```

Other potentially useful URLs:

- https://sources.debian.net/src/gst-plugins-base1.0/1.22.0-3+deb12u5/ (for browsing the source)
- https://sources.debian.net/src/gst-plugins-base1.0/1.22.0-3+deb12u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gst-plugins-base1.0/1.22.0-3+deb12u5/ (for access to the source package after it no longer exists in the archive)
...
- `krb5-multidev:amd64=1.20.1-2+deb12u4`
- `libgssapi-krb5-2:amd64=1.20.1-2+deb12u4`
- `libgssrpc4:amd64=1.20.1-2+deb12u4`
- `libk5crypto3:amd64=1.20.1-2+deb12u4`
- `libkadm5clnt-mit12:amd64=1.20.1-2+deb12u4`
- `libkadm5srv-mit12:amd64=1.20.1-2+deb12u4`
- `libkdb5-10:amd64=1.20.1-2+deb12u4`
- `libkrb5-3:amd64=1.20.1-2+deb12u4`
- `libkrb5-dev:amd64=1.20.1-2+deb12u4`
...
### `dpkg` source package: `libcaca=0.99.beta20-3`

Binary Packages:

- `libcaca0:amd64=0.99.beta20-3`
...
```console
$ apt-get source -qq --print-uris libcaca=0.99.beta20-3
'http://deb.debian.org/debian/pool/main/libc/libcaca/libcaca_0.99.beta20-3.dsc' libcaca_0.99.beta20-3.dsc 2266 SHA256:7e127704c2bcffbcc2ac5a3804416ad81ad1aaca06de64ae42691750f5ee0ab4
...
'http://deb.debian.org/debian/pool/main/libc/libcaca/libcaca_0.99.beta20-3.debian.tar.xz' libcaca_0.99.beta20-3.debian.tar.xz 10076 SHA256:ee7ef2959556a0e9216ed3b585a5940078b2ab438c9d502d64cf445cfb22daef
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcaca/0.99.beta20-3/ (for browsing the source)
- https://sources.debian.net/src/libcaca/0.99.beta20-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcaca/0.99.beta20-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libcap2=1:2.66-4+deb12u2`
...
```console
$ apt-get source -qq --print-uris libcap2=1:2.66-4+deb12u2
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.66-4%2bdeb12u2.dsc' libcap2_2.66-4+deb12u2.dsc 2236 SHA256:c7dbaba2c03fc9a22265abc376e658f2c7ee3e641374255ab65275ac4e658b4e
...
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.66-4%2bdeb12u2.debian.tar.xz' libcap2_2.66-4+deb12u2.debian.tar.xz 22304 SHA256:b60f0b25112d6ec9fcbd410b05dd56ba93db636969bda57362e57113fc338984
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcap2/1:2.66-4+deb12u2/ (for browsing the source)
- https://sources.debian.net/src/libcap2/1:2.66-4+deb12u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcap2/1:2.66-4+deb12u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libvpx=1.12.0-1+deb12u4`

Binary Packages:

- `libvpx7:amd64=1.12.0-1+deb12u4`
...
```console
$ apt-get source -qq --print-uris libvpx=1.12.0-1+deb12u4
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.12.0-1%2bdeb12u4.dsc' libvpx_1.12.0-1+deb12u4.dsc 2432 SHA256:bc1abf37bd85c2ef316537bb85c27fd11e7c4cb115259b22d2ca5371392165bf
...
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.12.0-1%2bdeb12u4.debian.tar.xz' libvpx_1.12.0-1+deb12u4.debian.tar.xz 19752 SHA256:f6266cb01ac5fc2af437858cd3f6aa85cc6fdedb5ea5ccedfa1b38cea335d619
```

Other potentially useful URLs:

- https://sources.debian.net/src/libvpx/1.12.0-1+deb12u4/ (for browsing the source)
- https://sources.debian.net/src/libvpx/1.12.0-1+deb12u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libvpx/1.12.0-1+deb12u4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mesa=22.3.6-1+deb12u1`
...
```console
$ apt-get source -qq --print-uris mesa=22.3.6-1+deb12u1
'http://deb.debian.org/debian/pool/main/m/mesa/mesa_22.3.6-1%2bdeb12u1.dsc' mesa_22.3.6-1+deb12u1.dsc 5859 SHA256:bbcdcd01885e820a697c0226a148f28cfdb2262f1fdb48d32293aaf38bfbf27e
...
'http://deb.debian.org/debian/pool/main/m/mesa/mesa_22.3.6-1%2bdeb12u1.diff.gz' mesa_22.3.6-1+deb12u1.diff.gz 114035 SHA256:23dd70fe39d81d66399c2a76ab7208a4364580f7b4aa749f7d7aba8bffb8696c
```

Other potentially useful URLs:

- https://sources.debian.net/src/mesa/22.3.6-1+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/mesa/22.3.6-1+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mesa/22.3.6-1+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `openjpeg2=2.5.0-2+deb12u2`
...
```console
$ apt-get source -qq --print-uris openjpeg2=2.5.0-2+deb12u2
'http://deb.debian.org/debian/pool/main/o/openjpeg2/openjpeg2_2.5.0-2%2bdeb12u2.dsc' openjpeg2_2.5.0-2+deb12u2.dsc 2705 SHA256:7408bf3e437b96ef2ee2e401a02b3c40f3b45b0216f3d35dd034ce5579df0215
...
'http://deb.debian.org/debian/pool/main/o/openjpeg2/openjpeg2_2.5.0-2%2bdeb12u2.debian.tar.xz' openjpeg2_2.5.0-2+deb12u2.debian.tar.xz 20072 SHA256:54c6d8c7e39bc7ac5fcd3de9bf7779bc905ba29e54a505e4530eb057d5df33da
```

Other potentially useful URLs:

- https://sources.debian.net/src/openjpeg2/2.5.0-2+deb12u2/ (for browsing the source)
- https://sources.debian.net/src/openjpeg2/2.5.0-2+deb12u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openjpeg2/2.5.0-2+deb12u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-15=15.14-0+deb12u1`
...
```console
$ apt-get source -qq --print-uris postgresql-15=15.14-0+deb12u1
'http://deb.debian.org/debian/pool/main/p/postgresql-15/postgresql-15_15.14-0%2bdeb12u1.dsc' postgresql-15_15.14-0+deb12u1.dsc 3926 SHA256:dfadb4a24df17970d152f845db33e589617938f04142a4f6708088adce0ace1a
'http://deb.debian.org/debian/pool/main/p/postgresql-15/postgresql-15_15.14.orig.tar.bz2' postgresql-15_15.14.orig.tar.bz2 23229854 SHA256:06dd75d305cd3870ee62b3932e661c624543eaf9ae2ba37cdec0a4f8edd051d2
'http://deb.debian.org/debian/pool/main/p/postgresql-15/postgresql-15_15.14-0%2bdeb12u1.debian.tar.xz' postgresql-15_15.14-0+deb12u1.debian.tar.xz 29292 SHA256:1d66919ab0816c8962f3966455b2bee7a8359d118d4d0c54277efb2c4dedac67
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-15/15.14-0+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-15/15.14-0+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-15/15.14-0+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
- `libpam-systemd:amd64=252.39-1~deb12u1`
- `libsystemd-shared:amd64=252.39-1~deb12u1`
- `libsystemd0:amd64=252.39-1~deb12u1`
...
```console
$ apt-get source -qq --print-uris systemd=252.39-1~deb12u1
'http://deb.debian.org/debian/pool/main/s/systemd/systemd_252.39-1%7edeb12u1.dsc' systemd_252.39-1~deb12u1.dsc 6618 SHA256:015c62f9c4a668553ee657156e2bd0436fd3cda296f4d4c91943e23a0888dfab
...
'http://deb.debian.org/debian/pool/main/s/systemd/systemd_252.39-1%7edeb12u1.debian.tar.xz' systemd_252.39-1~deb12u1.debian.tar.xz 171464 SHA256:051881cd4cae832fd65b6f55d04bc84c398839c2c9128b5a5835740001ead7da
```

Other potentially useful URLs:

- https://sources.debian.net/src/systemd/252.39-1~deb12u1/ (for browsing the source)
- https://sources.debian.net/src/systemd/252.39-1~deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/systemd/252.39-1~deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `taglib=1.13-2`

Binary Packages:

- `libtag1v5:amd64=1.13-2`
- `libtag1v5-vanilla:amd64=1.13-2`
...
```console
$ apt-get source -qq --print-uris taglib=1.13-2
'http://deb.debian.org/debian/pool/main/t/taglib/taglib_1.13-2.dsc' taglib_1.13-2.dsc 2336 SHA256:d4032865e0a7e9ea07fa057d0c924f89ae57e44797d0462a1368438935371ebf
...
'http://deb.debian.org/debian/pool/main/t/taglib/taglib_1.13-2.debian.tar.xz' taglib_1.13-2.debian.tar.xz 33860 SHA256:5d8b0c9b0302313a780b445967b49c681edd6a1d006bd313fd78eae42c9d7675
```

Other potentially useful URLs:

- https://sources.debian.net/src/taglib/1.13-2/ (for browsing the source)
- https://sources.debian.net/src/taglib/1.13-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/taglib/1.13-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tiff=4.5.0-6+deb12u3`
...
```console
$ apt-get source -qq --print-uris tiff=4.5.0-6+deb12u3
'http://deb.debian.org/debian-security/pool/updates/main/t/tiff/tiff_4.5.0-6%2bdeb12u3.dsc' tiff_4.5.0-6+deb12u3.dsc 2287 SHA256:078ea18a8b7683291a4586566281e8cbd4926c72340bc2691dd20fcff59e40a7
...
'http://deb.debian.org/debian-security/pool/updates/main/t/tiff/tiff_4.5.0-6%2bdeb12u3.debian.tar.xz' tiff_4.5.0-6+deb12u3.debian.tar.xz 31356 SHA256:75c8500b9063edc916030e29bbdfc390a9d850d6806d3ec3ef08670d21467c96
```

Other potentially useful URLs:

- https://sources.debian.net/src/tiff/4.5.0-6+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/tiff/4.5.0-6+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tiff/4.5.0-6+deb12u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tzdata=2025b-0+deb12u2`
...
```console
$ apt-get source -qq --print-uris tzdata=2025b-0+deb12u2
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2025b-0%2bdeb12u2.dsc' tzdata_2025b-0+deb12u2.dsc 2396 SHA256:5deb74393ecf6d15faa919af249d7d22bdcc3c6d8c54c8054b8b5993f56c4a32
...
'http://deb.debian.org/debian/pool/main/t/tzdata/tzdata_2025b-0%2bdeb12u2.debian.tar.xz' tzdata_2025b-0+deb12u2.debian.tar.xz 122524 SHA256:d4580ecbdae515744d61b1a309d62446749d4cd73909808def5e074bc5132244
```

Other potentially useful URLs:

- https://sources.debian.net/src/tzdata/2025b-0+deb12u2/ (for browsing the source)
- https://sources.debian.net/src/tzdata/2025b-0+deb12u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tzdata/2025b-0+deb12u2/ (for access to the source package after it no longer exists in the archive)
