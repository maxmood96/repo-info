...
- Environment:
  ...
  - `LANG=C.UTF-8`
- Labels:
  - `org.opencontainers.image.version=26.2.3`
...
```console
liblksctp-1.0.19-r4 description:
User-space access to Linux Kernel SCTP (libraries)

liblksctp-1.0.19-r4 webpage:
https://lksctp.sourceforge.net/

liblksctp-1.0.19-r4 installed size:
52 KiB

liblksctp-1.0.19-r4 license:
GPL-2.0-or-later AND LGPL-2.1-or-later
...
```console
lksctp-tools-1.0.19-r4 description:
User-space access to Linux Kernel SCTP

lksctp-tools-1.0.19-r4 webpage:
https://lksctp.sourceforge.net/

lksctp-tools-1.0.19-r4 installed size:
136 KiB

lksctp-tools-1.0.19-r4 license:
GPL-2.0-or-later AND LGPL-2.1-or-later
