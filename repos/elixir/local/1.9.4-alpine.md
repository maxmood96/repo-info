...
- Created: `2023-12-01T09:10:08.255360045Z`
- Virtual Size: ~ 83.70 Mb  
...
- Environment:
  ...
  - `LANG=C.UTF-8`
- Labels:
  - `org.opencontainers.image.version=22.3.4.26`
...
```console
libcrypto1.1-1.1.1w-r1 description:
Crypto library from openssl

libcrypto1.1-1.1.1w-r1 webpage:
https://www.openssl.org/

libcrypto1.1-1.1.1w-r1 installed size:
2708 KiB

libcrypto1.1-1.1.1w-r1 license:
OpenSSL
...
```console
liblksctp-1.0.19-r0 description:
User-space access to Linux Kernel SCTP (libraries)

liblksctp-1.0.19-r0 webpage:
http://lksctp.sourceforge.net

liblksctp-1.0.19-r0 installed size:
52 KiB

liblksctp-1.0.19-r0 license:
...
```console
libssl1.1-1.1.1w-r1 description:
SSL shared libraries

libssl1.1-1.1.1w-r1 webpage:
https://www.openssl.org/

libssl1.1-1.1.1w-r1 installed size:
528 KiB

libssl1.1-1.1.1w-r1 license:
OpenSSL
...
```console
lksctp-tools-1.0.19-r0 description:
User-space access to Linux Kernel SCTP

lksctp-tools-1.0.19-r0 webpage:
http://lksctp.sourceforge.net

lksctp-tools-1.0.19-r0 installed size:
140 KiB

lksctp-tools-1.0.19-r0 license:
GPL-2.0-only AND LGPL-2.1-or-later
...
```console
unixodbc-2.3.11-r0 description:
ODBC is an open specification to access Data Sources

unixodbc-2.3.11-r0 webpage:
http://www.unixodbc.org/

unixodbc-2.3.11-r0 installed size:
700 KiB

unixodbc-2.3.11-r0 license:
LGPL-2.0-or-later
