...
### `clickhouse:25.8.22-jammy` - linux; amd64
...
### `clickhouse:25.8.22-jammy` - unknown; unknown
...
### `clickhouse:25.8.22-jammy` - linux; arm64 variant v8
...
### `clickhouse:25.8.22.28` - linux; amd64
...
### `clickhouse:25.8.22.28` - unknown; unknown
...
### `clickhouse:25.8.22.28` - linux; arm64 variant v8
