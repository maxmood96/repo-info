...
- Image ID: `sha256:1397784c79f37cb5abb7234aa5f6c221887623ee866620a07544b18bb592ec7a`
- Created: `2021-10-13T13:44:03.62247685Z`
- Virtual Size: ~ 667.28 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/docker-entrypoint.sh"]`
- Environment:
  - `PATH=/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/apache-storm-2.2.0/bin`
...
'http://deb.debian.org/debian/pool/main/p/python-defaults/python-defaults_2.7.18-3.dsc' python-defaults_2.7.18-3.dsc 2446 SHA256:0f499e87d8f68a87b52d6c4b897b91c95c3686066367aaeb822840b54c608105
'http://deb.debian.org/debian/pool/main/p/python-defaults/python-defaults_2.7.18-3.tar.gz' python-defaults_2.7.18-3.tar.gz 44668 SHA256:d8d1a800097c5bf2e57139ff006e0a4d340e45f1c1e535967c0e0b886e0082bf
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-defaults/2.7.18-3/ (for browsing the source)
- https://sources.debian.net/src/python-defaults/2.7.18-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-defaults/2.7.18-3/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `python2.7=2.7.18-8`
...
```console
$ apt-get source -qq --print-uris python2.7=2.7.18-8
'http://deb.debian.org/debian/pool/main/p/python2.7/python2.7_2.7.18-8.dsc' python2.7_2.7.18-8.dsc 3313 SHA256:838477c7e5f2b4da4ea1ce936724250cc5ef8dab98460910f0a383d7bb6f6ee0
...
'http://deb.debian.org/debian/pool/main/p/python2.7/python2.7_2.7.18-8.diff.gz' python2.7_2.7.18-8.diff.gz 290602 SHA256:3ad1ae1ea8a14ef701d9b3a9fd7f5ec346711846cec5b6c0884f6d78dfe2cdae
```

Other potentially useful URLs:

- https://sources.debian.net/src/python2.7/2.7.18-8/ (for browsing the source)
- https://sources.debian.net/src/python2.7/2.7.18-8/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python2.7/2.7.18-8/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `what-is-python=9`
...
```console
$ apt-get source -qq --print-uris what-is-python=9
'http://deb.debian.org/debian/pool/main/w/what-is-python/what-is-python_9.dsc' what-is-python_9.dsc 1716 SHA256:80892be8aca6789cee06e86f35444b9ef7d59c0e50a319db551e307442ff6bdf
'http://deb.debian.org/debian/pool/main/w/what-is-python/what-is-python_9.tar.xz' what-is-python_9.tar.xz 2668 SHA256:24c7aa1c4d04e14d7b98d01001d5cedd40883c7a889a0c78263cc167be030a15
```

Other potentially useful URLs:

- https://sources.debian.net/src/what-is-python/9/ (for browsing the source)
- https://sources.debian.net/src/what-is-python/9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/what-is-python/9/ (for access to the source package after it no longer exists in the archive)
