...
```console
$ docker pull mono@sha256:de96124a4d3da6b196db67446ef815ca444036235a4e23f11ab8a34a0ea77a80
```
...
```console
$ docker pull mono@sha256:50ed9e9f06766cf9a8dedb1de23480790bc79f01f0afd99a0a0ccb2ebffe3e9d
```
