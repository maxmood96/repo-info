...
```console
$ docker pull ruby@sha256:0c09d8f16c63a82b97d83d19da1d5b5ef4616d46f887d68a1fd772c1c5357357
```
...
```console
$ docker pull ruby@sha256:f3f5bad8ee12f98182fb4f38a270da60478c86ca71b15a769a08ca7889768e66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.3 MB (326345881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98a832037ee179644fec69d873be981aaa823922cf2b7281e8c04acdd900abc5`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:26fd99871bb930bdf411ea4e9a757b5c6c976838fd6f6bf0218acc15e7721128`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee0c2c7ee39ff0b9fa065b4a525dc6f96a521b80c736d9e462e656b27689320f`  
		Last Modified: Thu, 04 May 2023 13:43:47 GMT  
		Size: 14.6 MB (14565735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b067f557a91e53a7efe8b2d10a5b4f5be85c7fa59679762d3a6b4f296be70ba`  
		Last Modified: Thu, 04 May 2023 13:43:45 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:2bc3cd287b5e4e80874be2382a2a42e7a57fd2f7b579fc176fbcafef744ffc08
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.5 MB (291452976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16b459906e5416f2f3ab314476a43f1c2412796cf2c699578ea772260f82a7d0`
-	Default Command: `["irb"]`
...
# Thu, 04 May 2023 08:11:00 GMT
ENV RUBY_DOWNLOAD_SHA256=f22f662da504d49ce2080e446e4bea7008cee11d5ec4858fc69000d0e5b1d7fb
# Thu, 04 May 2023 08:12:17 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 04 May 2023 08:12:18 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 04 May 2023 08:12:18 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 04 May 2023 08:12:18 GMT
...
-	Layers:
	...
	-	`sha256:fb4c2eb10904ae38f86431121b3e9ee75a53ab4cd57ed8332836ffe21f710b3f`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:147475592800ba0d9f23e499013d01a9be7c0be80b8fb6ac28ecdd48448d237f`  
		Last Modified: Thu, 04 May 2023 08:14:57 GMT  
		Size: 13.9 MB (13850444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fccc15f7c36cbfd871fc6791d5c5a97b18502ae99765e22ca03d3276b4afe46`  
		Last Modified: Thu, 04 May 2023 08:14:55 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:809fb09f8597b92378185a23a443bfd2802a74a2a613cf5ac8bde5de89b384be
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.8 MB (316755900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eb1aa68cd76bccbec6bfa6f3993b8ea46a1bd559ca750cca4315eaa11216505`
-	Default Command: `["irb"]`
...
# Thu, 04 May 2023 08:06:45 GMT
ENV RUBY_DOWNLOAD_SHA256=f22f662da504d49ce2080e446e4bea7008cee11d5ec4858fc69000d0e5b1d7fb
# Thu, 04 May 2023 08:07:50 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 04 May 2023 08:07:51 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 04 May 2023 08:07:51 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 04 May 2023 08:07:51 GMT
...
-	Layers:
	...
	-	`sha256:a8e04616831333259b1b103cf08279339b0d51f8157deb3c5e7048ec7c19f607`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cc5554861f2d07127552a49703e91c95d0a74e4ae26055030182143631bcc3c`  
		Last Modified: Thu, 04 May 2023 08:10:23 GMT  
		Size: 14.4 MB (14421596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a4dc77a0554c11858efc17e537f1334e2b3270f477eca81a75655d42b0bfbae`  
		Last Modified: Thu, 04 May 2023 08:10:21 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:6c5993d237f3ad3331196b04d989ec9d5d407ca9e7dd01da63567cdc864cf2e4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.2 MB (335233938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ec21d544e9b9a92623ff737f2240d4143a8dafc6184a2f64ee283efd357bd1b`
-	Default Command: `["irb"]`
...
# Thu, 04 May 2023 06:00:01 GMT
ENV LANG=C.UTF-8
# Thu, 04 May 2023 06:19:12 GMT
ENV RUBY_MAJOR=2.7
# Thu, 04 May 2023 06:19:12 GMT
ENV RUBY_VERSION=2.7.8
# Thu, 04 May 2023 06:19:12 GMT
ENV RUBY_DOWNLOAD_SHA256=f22f662da504d49ce2080e446e4bea7008cee11d5ec4858fc69000d0e5b1d7fb
# Thu, 04 May 2023 06:21:32 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 04 May 2023 06:21:32 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 04 May 2023 06:21:32 GMT
...
-	Layers:
	...
	-	`sha256:077e01f091042f3bb7faf39e3a86abf31def7162e7a3a098b36d5ac625b4405c`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:341a3e8d1f6cf067657ac8282354875b251dc0d94e74b00fbb39bf7ffb7aa9c0`  
		Last Modified: Thu, 04 May 2023 06:24:21 GMT  
		Size: 14.0 MB (14029838 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:998a8a15465f9cd2ffa7b29bde8123ff5fac2f9b6a64b19de52ff4ebd014afc4`  
		Last Modified: Thu, 04 May 2023 06:24:19 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
