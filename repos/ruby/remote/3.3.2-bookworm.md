...
### `ruby:3.3.2-bookworm` - linux; amd64
...
### `ruby:3.3.2-bookworm` - unknown; unknown
...
### `ruby:3.3.2-bookworm` - linux; arm variant v5
...
### `ruby:3.3.2-bookworm` - linux; arm variant v7
...
### `ruby:3.3.2-bookworm` - linux; arm64 variant v8
...
### `ruby:3.3.2-bookworm` - linux; mips64le
...
### `ruby:3.3.2-bookworm` - linux; ppc64le
...
### `ruby:3.3.2-bookworm` - linux; s390x
