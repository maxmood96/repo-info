...
```console
$ docker pull ruby@sha256:753d9029d0ac87a818acc4e4591c3d74a15520eb724aeeaf9b7a6ddd01c99f4e
```
...
### `ruby:4.0.1-slim` - unknown; unknown
...
### `ruby:4.0.1-slim` - linux; arm variant v5
...
### `ruby:4.0.1-slim` - linux; arm variant v7
...
### `ruby:4.0.1-slim` - linux; arm64 variant v8
