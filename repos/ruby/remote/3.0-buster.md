...
```console
$ docker pull ruby@sha256:123c9b5ec373ae97a7b87de2f8e0180f3ce2f757605569e0ba0ecf55c9c24628
```
...
```console
$ docker pull ruby@sha256:18114e8bd9c958c12b85d6bb7c46cf9ebe3b6647deb52cd55727dd3166bad1c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.4 MB (341376217 bytes)**  
...
-	Layers:
	...
	-	`sha256:34b452db5b3150c246f280cfdf5f3b90b2489a2d051549a821e093990480f55f`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd97cdb11a3b02bbba01e2679886128f4412daeb041495ff8f6a0451ff405e02`  
		Last Modified: Tue, 12 Apr 2022 19:16:45 GMT  
		Size: 28.8 MB (28753392 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13373e6d2b7e273afce7397a4fa0c066309b2c8865f6f67b6c3b7289a54e8a05`  
		Last Modified: Tue, 12 Apr 2022 19:16:43 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:1440c41237bf15d840d15e6826a2140d7a1160c9958b6d398938686411ce9298
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.2 MB (331200579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecfc52256da257c057a2d75b72bd0b980eb134975bcd136a883ac970014a0a16`
-	Default Command: `["irb"]`
...
ENV RUBY_MAJOR=3.0
# Tue, 12 Apr 2022 19:00:09 GMT
ENV RUBY_VERSION=3.0.4
# Tue, 12 Apr 2022 19:00:10 GMT
ENV RUBY_DOWNLOAD_SHA256=8e22fc7304520435522253210ed0aa9a50545f8f13c959fe01a05aea06bef2f0
# Tue, 12 Apr 2022 19:01:54 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 12 Apr 2022 19:01:55 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 12 Apr 2022 19:01:56 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 12 Apr 2022 19:01:57 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 12 Apr 2022 19:01:58 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 12 Apr 2022 19:01:59 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:ce9b8af7baea2c05d1bbd787592370eef0cc57ffa85a1f246a3eae2041295376`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c24172cf3c0e3e5f489371d5116642b95a76d356a0889738023db7c826d5800b`  
		Last Modified: Tue, 12 Apr 2022 19:40:54 GMT  
		Size: 28.3 MB (28253439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d84a3738c82e6bb3d49506f544cf768abb5941da5bcb609c70f975ac37626302`  
		Last Modified: Tue, 12 Apr 2022 19:40:52 GMT  
		Size: 143.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
