...
### `ruby:3.4.5-trixie` - unknown; unknown
...
### `ruby:3.4.5-trixie` - linux; arm variant v5
...
### `ruby:3.4.5-trixie` - linux; arm variant v7
...
### `ruby:3.4.5-trixie` - linux; arm64 variant v8
...
### `ruby:3.4.5-trixie` - linux; ppc64le
...
### `ruby:3.4.5-trixie` - linux; riscv64
