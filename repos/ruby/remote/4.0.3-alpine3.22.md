...
```console
$ docker pull ruby@sha256:1da544951dd5a505eb5a440edc2b0fe455520676988560bfeaa4e4417e13187b
```
...
### `ruby:4.0.3-alpine3.22` - linux; amd64
...
### `ruby:4.0.3-alpine3.22` - unknown; unknown
...
### `ruby:4.0.3-alpine3.22` - linux; arm variant v6
...
### `ruby:4.0.3-alpine3.22` - linux; arm variant v7
...
### `ruby:4.0.3-alpine3.22` - linux; arm64 variant v8
...
### `ruby:4.0.3-alpine3.22` - linux; 386
...
### `ruby:4.0.3-alpine3.22` - linux; ppc64le
...
### `ruby:4.0.3-alpine3.22` - linux; s390x
