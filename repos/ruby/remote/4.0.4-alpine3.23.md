...
```console
$ docker pull ruby@sha256:ac9c68cd41d6a49a9138fca74aa344968e8ddb5e20d8a3b1f455b97c7148f8da
```
...
### `ruby:4.0.4-alpine3.23` - linux; amd64
...
### `ruby:4.0.4-alpine3.23` - unknown; unknown
...
### `ruby:4.0.4-alpine3.23` - linux; arm variant v6
...
### `ruby:4.0.4-alpine3.23` - linux; arm variant v7
...
### `ruby:4.0.4-alpine3.23` - linux; arm64 variant v8
...
### `ruby:4.0.4-alpine3.23` - linux; 386
...
### `ruby:4.0.4-alpine3.23` - linux; ppc64le
...
### `ruby:4.0.4-alpine3.23` - linux; s390x
