...
```console
$ docker pull ruby@sha256:3105190fe49f9c655903638578c3a1838f3d6613663df67eabb440c547ce19c5
```
...
### `ruby:3.4.7-slim-trixie` - linux; amd64
...
### `ruby:3.4.7-slim-trixie` - unknown; unknown
...
### `ruby:3.4.7-slim-trixie` - linux; arm variant v5
...
### `ruby:3.4.7-slim-trixie` - linux; arm variant v7
...
### `ruby:3.4.7-slim-trixie` - linux; arm64 variant v8
...
### `ruby:3.4.7-slim-trixie` - linux; 386
...
### `ruby:3.4.7-slim-trixie` - linux; ppc64le
...
### `ruby:3.4.7-slim-trixie` - linux; riscv64
...
### `ruby:3.4.7-slim-trixie` - linux; s390x
