...
```console
$ docker pull ruby@sha256:ae5bff22b8112b1d67d89523de928f68225a0868cc09a889419a4e28a06441c8
```
...
```console
$ docker pull ruby@sha256:a19eafd6439595ec0bad86231ca3ade78f6bad546bdf5ffd769c55875bb8e2a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.2 MB (334152809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:faca91bd5e604b164e2cc9489be560fd639fffbbbbd43d1cb5b62c159ff1c578`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:34b452db5b3150c246f280cfdf5f3b90b2489a2d051549a821e093990480f55f`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd7424e8d15948002b7f2410071230427d7280c58d073c2c660fe38ec379e70`  
		Last Modified: Tue, 12 Apr 2022 19:20:24 GMT  
		Size: 21.5 MB (21529983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:115e1f2093c340b48e127f77591495196cbad7a71121a2f975303c65954898b5`  
		Last Modified: Tue, 12 Apr 2022 19:20:21 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:a3517d6ac4e96e7dd82f3a5e117c104efffe33fbd83fe0dbf1e156afec919ee8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.1 MB (324081688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41e4118315f32b1e4434cb33f354712511dc9be9b6d9d645cbda0574263b1dda`
-	Default Command: `["irb"]`
...
ENV RUBY_VERSION=2.6.10
# Tue, 12 Apr 2022 19:25:13 GMT
ENV RUBY_DOWNLOAD_SHA256=5fd8ded51321b88fdc9c1b4b0eb1b951d2eddbc293865da0151612c2e814c1f2
# Tue, 12 Apr 2022 19:26:43 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 12 Apr 2022 19:26:45 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 12 Apr 2022 19:26:46 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 12 Apr 2022 19:26:47 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 12 Apr 2022 19:26:48 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
...
-	Layers:
	...
	-	`sha256:ce9b8af7baea2c05d1bbd787592370eef0cc57ffa85a1f246a3eae2041295376`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:301dcd7264126ebea4db4c2d823bded4c1cd1ff7835413b1bac770d1ae52b851`  
		Last Modified: Tue, 12 Apr 2022 19:45:21 GMT  
		Size: 21.1 MB (21134546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0820adbefdd3f56b2f70ed364fa1f785b0658f128e323c23e437030522450a44`  
		Last Modified: Tue, 12 Apr 2022 19:45:15 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
