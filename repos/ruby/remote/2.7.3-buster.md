...
### `ruby:2.7.3-buster` - linux; arm variant v5
...
### `ruby:2.7.3-buster` - linux; arm variant v7
...
### `ruby:2.7.3-buster` - linux; arm64 variant v8
...
### `ruby:2.7.3-buster` - linux; mips64le
...
### `ruby:2.7.3-buster` - linux; ppc64le
