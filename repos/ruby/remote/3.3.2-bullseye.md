...
```console
$ docker pull ruby@sha256:b1847d0ea27385e682ca0ae0dbcf5c3ffb8613e92616784d71006dc60bf8f59a
```
...
### `ruby:3.3.2-bullseye` - linux; amd64
...
### `ruby:3.3.2-bullseye` - unknown; unknown
...
### `ruby:3.3.2-bullseye` - linux; arm variant v5
...
### `ruby:3.3.2-bullseye` - linux; arm variant v7
...
### `ruby:3.3.2-bullseye` - linux; mips64le
...
### `ruby:3.3.2-bullseye` - linux; ppc64le
...
### `ruby:3.3.2-bullseye` - linux; s390x
