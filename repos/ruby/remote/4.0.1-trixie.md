...
```console
$ docker pull ruby@sha256:21425a9d28f04c3021e69cf315778311063578c00c7791d265cdb15cbe2f1da2
```
...
### `ruby:4.0.1-trixie` - unknown; unknown
...
### `ruby:4.0.1-trixie` - linux; arm variant v5
...
### `ruby:4.0.1-trixie` - linux; arm variant v7
...
### `ruby:4.0.1-trixie` - linux; arm64 variant v8
...
### `ruby:4.0.1-trixie` - linux; ppc64le
