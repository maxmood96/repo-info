...
### `ruby:4.0.0-trixie` - unknown; unknown
...
### `ruby:4.0.0-trixie` - linux; arm variant v5
...
### `ruby:4.0.0-trixie` - linux; arm variant v7
...
### `ruby:4.0.0-trixie` - linux; arm64 variant v8
...
### `ruby:4.0.0-trixie` - linux; ppc64le
...
### `ruby:4.0.0-trixie` - linux; riscv64
