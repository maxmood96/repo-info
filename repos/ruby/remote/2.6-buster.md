...
```console
$ docker pull ruby@sha256:69af063564a9c84bc9f457f7e45eae137c031938edbcfafb0ed39930aeaa9c44
```
...
```console
$ docker pull ruby@sha256:cacd7a6e626d55c3dac078d3dceb2e6badfb1f857163a3aa24f49e7d8e2b6c0f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.9 MB (306875438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3be931f3fefd35be94e63636770b0db9fcf56f6c9d832a1931a192694c3600e7`
-	Default Command: `["irb"]`
...
# Fri, 28 May 2021 07:26:37 GMT
ENV LANG=C.UTF-8
# Fri, 28 May 2021 07:42:23 GMT
ENV RUBY_MAJOR=2.6
# Fri, 28 May 2021 07:42:24 GMT
ENV RUBY_VERSION=2.6.7
# Fri, 28 May 2021 07:42:24 GMT
ENV RUBY_DOWNLOAD_SHA256=f43ead5626202d5432d2050eeab606e547f0554299cc1e5cf573d45670e59611
# Fri, 28 May 2021 07:45:41 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 28 May 2021 07:45:41 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 28 May 2021 07:45:42 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 28 May 2021 07:45:42 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 28 May 2021 07:45:43 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 28 May 2021 07:45:43 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:121f5cda8498efdaa2a9b6eac9e42fd85e7d39b95f63f6f50efe3190b2a19b69`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:172a83fc8522d02277a4bb2e8d8a263ab07f15e3f2d9b56f1ef76c95d7e9b379`  
		Last Modified: Fri, 28 May 2021 08:17:43 GMT  
		Size: 20.8 MB (20781703 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7481987e7a8891aa1adef340a2fcf38b3ec35b8d3091ef19a75ff83acd5a39d0`  
		Last Modified: Fri, 28 May 2021 08:17:39 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:2c2c89441a2f432f662601343921b256f457a47bb1f725baeed4954793e53fd5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **299.0 MB (299015737 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fad15a13135799663270201367ae8330fe95db30e3e5eca1579d880c581432b4`
-	Default Command: `["irb"]`
...
# Fri, 28 May 2021 14:16:20 GMT
ENV LANG=C.UTF-8
# Fri, 28 May 2021 14:44:07 GMT
ENV RUBY_MAJOR=2.6
# Fri, 28 May 2021 14:44:07 GMT
ENV RUBY_VERSION=2.6.7
# Fri, 28 May 2021 14:44:08 GMT
ENV RUBY_DOWNLOAD_SHA256=f43ead5626202d5432d2050eeab606e547f0554299cc1e5cf573d45670e59611
# Fri, 28 May 2021 14:46:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 28 May 2021 14:46:11 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 28 May 2021 14:46:11 GMT
...
-	Layers:
	...
	-	`sha256:89946661eeefeeb59ccf6bac95ae3f82d97077486a321082dc53be2b1b37e42a`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73cb2275b902afdeabdccec7ee862f1a0226b4209b7f75ecb31b39a5563c2978`  
		Last Modified: Fri, 28 May 2021 15:26:34 GMT  
		Size: 20.7 MB (20705837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cd7f37af1dfe0714fcdf2b89b491555a43f0c9cf1e248f3b56359db323a6108`  
		Last Modified: Fri, 28 May 2021 15:26:30 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:7160f4bf35eb14be3084fbb8211adf87d271c46d09da647ec65a7d13e90a6a60
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.3 MB (324325492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52f68c0452fcefce2824d79a7302ee67cf31aec1adafa25253d1458230026103`
-	Default Command: `["irb"]`
...
# Fri, 28 May 2021 11:26:39 GMT
ENV LANG=C.UTF-8
# Fri, 28 May 2021 11:48:37 GMT
ENV RUBY_MAJOR=2.6
# Fri, 28 May 2021 11:48:37 GMT
ENV RUBY_VERSION=2.6.7
# Fri, 28 May 2021 11:48:37 GMT
ENV RUBY_DOWNLOAD_SHA256=f43ead5626202d5432d2050eeab606e547f0554299cc1e5cf573d45670e59611
# Fri, 28 May 2021 11:50:32 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 28 May 2021 11:50:32 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 28 May 2021 11:50:32 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 28 May 2021 11:50:33 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 28 May 2021 11:50:33 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 28 May 2021 11:50:34 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:9a79dd4ab4364b5a5c44fcf3b500901fe58adad2d95a258874a2ee72accd3bde`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a39d77bb06c66702373dacaa93390a73a0c56e01714c94713fcdbc06a5c94dc`  
		Last Modified: Fri, 28 May 2021 12:24:10 GMT  
		Size: 21.4 MB (21353843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3311babe13070f7f97c17bc80c4675342bdd73f2c43d59580bb5d1d438c67295`  
		Last Modified: Fri, 28 May 2021 12:24:07 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
