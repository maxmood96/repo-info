...
```console
$ docker pull ruby@sha256:3b42ff1d7ed639c539f0548e76715f6ee7400d3d0a52a22ece049a5b22372bc3
```
...
### `ruby:4.0.5-alpine3.23` - linux; amd64
...
### `ruby:4.0.5-alpine3.23` - unknown; unknown
...
### `ruby:4.0.5-alpine3.23` - linux; arm variant v6
...
### `ruby:4.0.5-alpine3.23` - linux; arm variant v7
...
### `ruby:4.0.5-alpine3.23` - linux; arm64 variant v8
...
### `ruby:4.0.5-alpine3.23` - linux; 386
...
### `ruby:4.0.5-alpine3.23` - linux; ppc64le
...
### `ruby:4.0.5-alpine3.23` - linux; s390x
