...
```console
$ docker pull ruby@sha256:93508c60c23c644c58c03578f53450ac6d0aac566e4fb1534275faf0231eec81
```
...
### `ruby:4.0.3-slim-bookworm` - linux; amd64
...
### `ruby:4.0.3-slim-bookworm` - unknown; unknown
...
### `ruby:4.0.3-slim-bookworm` - linux; arm variant v5
...
### `ruby:4.0.3-slim-bookworm` - linux; arm variant v7
...
### `ruby:4.0.3-slim-bookworm` - linux; arm64 variant v8
...
### `ruby:4.0.3-slim-bookworm` - linux; mips64le
...
### `ruby:4.0.3-slim-bookworm` - linux; ppc64le
...
### `ruby:4.0.3-slim-bookworm` - linux; s390x
