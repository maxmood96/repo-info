...
```console
$ docker pull ruby@sha256:0eb70fcabda8f4bf802db3f4e458eb077a707037594518ef81e84e328b0a1d17
```
...
```console
$ docker pull ruby@sha256:51ffdb09a2769cf3635fdf3838a501d737c42612ae8930ab7739c109f011cf59
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.7 MB (333719899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c28758bbe65bb6a89687a9a82fde3472c80eedbdd2df9a3c46cceb126a2a5b73`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 21:36:45 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 21:36:46 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 21:36:46 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 21:40:16 GMT
...
-	Layers:
	...
	-	`sha256:7bab57a324dc48828e9a9dc460047ce8cb950ffcb647364e00fde236e4a71256`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:956d839e3bc0307ff23fbc06fed5462c723bf782fc7cf283d0b88758f71fa1b8`  
		Last Modified: Fri, 26 Jun 2020 22:31:55 GMT  
		Size: 21.5 MB (21480371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c737d14f48a826f570931e841a9f7319af8ec966f0563323aec3905477120ac0`  
		Last Modified: Fri, 26 Jun 2020 22:31:51 GMT  
		Size: 142.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:0c34f815aeac0cc0d758650a0ce63af2a4655335715eb8f86794226721fbbc06
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.7 MB (306654408 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f575d48bf072b31a96c11fadd5b4a6742467c9de566c4d488ff74b15afe380a`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 20:24:25 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 20:24:27 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 20:24:28 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
...
-	Layers:
	...
	-	`sha256:aaa77d5f3405458c8a4ddbb275bc11843550ed5b028275999aa4d2521b33df86`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df2e4ca77c391fbe509c0fd50b846d42c1fe8663d908adec82e7a567f8cd9b1a`  
		Last Modified: Fri, 26 Jun 2020 21:03:35 GMT  
		Size: 20.8 MB (20760383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:b830da6787eefd7c6a8f06618e85e5a74e631f123f843ce5e1dfb5b749f150e9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.8 MB (298769350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4a6249700fc83665fb24b504a61f1760563e28512a20e289f9e85e182b94e5c`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 20:48:59 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 20:49:01 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 20:49:03 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 20:51:47 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 26 Jun 2020 20:51:50 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 26 Jun 2020 20:51:51 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 26 Jun 2020 20:51:52 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 26 Jun 2020 20:51:56 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 26 Jun 2020 20:52:06 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:cc3dbfa79d3337137287222c197f3fb39741066caf7dd7d605b530f055e6270d`  
		...
		Size: 196.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d00e10516f078127a010b0fb8093f9fda4cbd2d203f8ef7fc2fd8d024ec22587`  
		Last Modified: Fri, 26 Jun 2020 21:33:28 GMT  
		Size: 20.7 MB (20681755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2a85aeebacef352760c70032da3d490a9d9ee5d2b56ea74554bb768ad615e51`  
		Last Modified: Fri, 26 Jun 2020 21:33:25 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:c6578ee8cc18a809125a2c579202070cd6f910e99d482e8203fbf9fce978a50e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.1 MB (324066657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08b3e428420fa731ce21d32f61e64e4667667ce3871f18bf81d7369f53e3178f`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 21:22:19 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 21:22:21 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 21:22:22 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 21:25:09 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 26 Jun 2020 21:25:11 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 26 Jun 2020 21:25:11 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 26 Jun 2020 21:25:12 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 26 Jun 2020 21:25:14 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 26 Jun 2020 21:25:16 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:a7531b268ff1689cde1ff61a26022ff43e55c0063053766efc41283f171bd568`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f60a8ea3b1ef722b249d6fee65da5c57a79d2fb0371d58da4a0b5c6f0aac6a74`  
		Last Modified: Fri, 26 Jun 2020 22:10:11 GMT  
		Size: 21.3 MB (21332682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7144e6ad163bdb489cd648f9e94bb7f85187f51363241aa051dab31e40f836aa`  
		Last Modified: Fri, 26 Jun 2020 22:10:08 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:adb85080fd1774d3713af148015e4ef1b5da6149d7645759a82125227bc6a708
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.6 MB (342561043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d579424a384c0d8ca7f6a9ed0839c1e72982a2a657fa7c6b18733b7998b1c798`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 21:04:40 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 21:04:41 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 21:04:41 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 21:09:27 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
...
-	Layers:
	...
	-	`sha256:6c14cbcfb494ecf2d8d8d76c7481ce41b6211822b01208a7844e2b937ad40115`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc460a56049c0d442b63261196110fd530ad29e9211b31298df60c8aa5e35371`  
		Last Modified: Fri, 26 Jun 2020 22:04:24 GMT  
		Size: 20.9 MB (20900210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fca1248669f87741a381bd70b108374f6f979c2fc3ae278428ffa41635efe702`  
		Last Modified: Fri, 26 Jun 2020 22:04:17 GMT  
		Size: 143.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:4bd40469090ef7628f85af2eca11584ea32ea0185f815158da4bbbf60391f653
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.5 MB (318537454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23f1ac237d1ae750eaeefa3e625846f152f0b420f57a7ccf035e89bbf09a68e4`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 21:37:12 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 21:37:12 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 21:37:13 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 21:47:01 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 26 Jun 2020 21:47:01 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 26 Jun 2020 21:47:01 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 26 Jun 2020 21:47:02 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
-	Layers:
	...
	-	`sha256:ffb904951588ba6015d5240b2237699d1018a5fee8db5f9910c98e18530edbc0`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b1263b378413d1709da412d820b3341ee769c2106033701ed3fc8ee61f7a92d`  
		Last Modified: Fri, 26 Jun 2020 22:59:20 GMT  
		Size: 21.7 MB (21681688 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a4a85950f9ce683d9d7072b573059333c4a9e8220a32a1522ec866d4c52a86e`  
		Last Modified: Fri, 26 Jun 2020 22:59:09 GMT  
		Size: 143.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:c823081c03128e7c578fa9f874ecd1e04c88fb4c80b4a9847571621e80623959
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.6 MB (355593195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23e4d9f0a84892061ae3a9d1d94e94ac6c0c0479f21f7b721666a163e02a608f`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 21:09:56 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 21:10:00 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 21:10:03 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 21:13:14 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 26 Jun 2020 21:13:17 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 26 Jun 2020 21:13:22 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 26 Jun 2020 21:13:24 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 26 Jun 2020 21:13:30 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 26 Jun 2020 21:13:34 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:43280da50a773abc3a2d45d5506dcc72a78feb2f1d05b6d9c487c1399c1a9f4f`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:140c380ae6591c7de022fe1d424cda89dd0a93f26fa0958f524e82b9cb45915c`  
		Last Modified: Fri, 26 Jun 2020 22:16:13 GMT  
		Size: 22.0 MB (21990767 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:815c1910d3895addb7afd0fce02a59f814f16bb049f687f7e30815a6dd2e7aa4`  
		Last Modified: Fri, 26 Jun 2020 22:16:08 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:a9e71b084c2c58931c6751f059691f950128da93441938a72f2b18922735e401
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.0 MB (315991368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7367b4835c9a9a63a767b9afe78df07e94fcb1a41406adb2bac090cb3c69f544`
-	Default Command: `["irb"]`
...
RUN set -eux; 	mkdir -p /usr/local/etc; 	{ 		echo 'install: --no-document'; 		echo 'update: --no-document'; 	} >> /usr/local/etc/gemrc
# Fri, 26 Jun 2020 20:33:38 GMT
ENV LANG=C.UTF-8
# Fri, 26 Jun 2020 20:48:56 GMT
ENV RUBY_MAJOR=2.6
# Fri, 26 Jun 2020 20:48:56 GMT
ENV RUBY_VERSION=2.6.6
# Fri, 26 Jun 2020 20:48:57 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Fri, 26 Jun 2020 20:50:47 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 26 Jun 2020 20:50:48 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 26 Jun 2020 20:50:48 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 26 Jun 2020 20:50:48 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 26 Jun 2020 20:50:49 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 26 Jun 2020 20:50:50 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:034175ade312f62a5156aa0ece94fbe0946a8de06227298d059dcd51960826ec`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfc9b0ba63bb4d1c68fe0fcd9df9768868980d7b5d3ff9e1c4ab115a519edbb4`  
		Last Modified: Fri, 26 Jun 2020 21:11:30 GMT  
		Size: 21.6 MB (21627094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f50e2786fb3b1c78b4f7fbcb3675d5474ac7418578efb011a5a149cacc568ebb`  
		Last Modified: Fri, 26 Jun 2020 21:11:28 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
