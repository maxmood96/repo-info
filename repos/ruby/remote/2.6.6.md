...
```console
$ docker pull ruby@sha256:09dbcb95cf2323f027136cb8f91cac4f4dedbf22ce43e335b4e9994ad24401cc
```
...
```console
$ docker pull ruby@sha256:ee981bbeb10c2ba88c9472641368c855e02938c5373cc3493f1e73e4e0e3b98d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.7 MB (306660097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93fbf2c211666c737c54b59bdf497880db2385f3125a2aca98b7f50d6a90ab7a`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Wed, 22 Jul 2020 11:09:42 GMT
ENV RUBY_MAJOR=2.6
# Wed, 22 Jul 2020 11:09:47 GMT
ENV RUBY_VERSION=2.6.6
# Wed, 22 Jul 2020 11:09:50 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Wed, 22 Jul 2020 11:12:58 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Wed, 22 Jul 2020 11:13:04 GMT
ENV GEM_HOME=/usr/local/bundle
# Wed, 22 Jul 2020 11:13:10 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Wed, 22 Jul 2020 11:13:13 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 22 Jul 2020 11:13:42 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
...
-	Layers:
	...
	-	`sha256:93ae9f2876f3a060df815d23735736522ccc9f5772973a186235c01fdaf251ea`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d8893540fd754f322d283764559aba965e4d2fabc6ad97079e73187d6b92d73`  
		Last Modified: Wed, 22 Jul 2020 11:52:34 GMT  
		Size: 20.8 MB (20760281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00782ef928697c6bb040f1ffba61399332189638656a593fe834d2c0e5a7ce53`  
		Last Modified: Wed, 22 Jul 2020 11:52:30 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:1c5a4a0bc47b320112d4c848e26c005d0fafa547fc236e0b5805d61554e3d1cc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.0 MB (316004103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45e6959ec45816901cf9e7a47b04fe665877447344a76d849ca3e516ff8f1050`
-	Default Command: `["irb"]`
...
# Wed, 22 Jul 2020 05:38:23 GMT
ENV LANG=C.UTF-8
# Wed, 22 Jul 2020 05:48:46 GMT
ENV RUBY_MAJOR=2.6
# Wed, 22 Jul 2020 05:48:46 GMT
ENV RUBY_VERSION=2.6.6
# Wed, 22 Jul 2020 05:48:46 GMT
ENV RUBY_DOWNLOAD_SHA256=5db187882b7ac34016cd48d7032e197f07e4968f406b0690e20193b9b424841f
# Wed, 22 Jul 2020 05:50:09 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Wed, 22 Jul 2020 05:50:10 GMT
ENV GEM_HOME=/usr/local/bundle
# Wed, 22 Jul 2020 05:50:10 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Wed, 22 Jul 2020 05:50:10 GMT
...
-	Layers:
	...
	-	`sha256:7c63b2763e1a3645845ab4f1630c204601d3aa3a72923e9fae374728bfe5cf49`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a079de607d1ced1a2fe346ac8464f40686dc7d9979ce0346b1e6ba493ad95925`  
		Last Modified: Wed, 22 Jul 2020 05:56:53 GMT  
		Size: 21.6 MB (21627252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:419dc0abfa1d4fcb30877680e90c4f124215093df63bbac62ff800aae68f1ab9`  
		Last Modified: Wed, 22 Jul 2020 05:56:56 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
