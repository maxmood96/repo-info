...
### `ruby:3.3.4-bullseye` - linux; amd64
...
### `ruby:3.3.4-bullseye` - unknown; unknown
...
### `ruby:3.3.4-bullseye` - linux; arm variant v5
...
### `ruby:3.3.4-bullseye` - linux; arm variant v7
...
### `ruby:3.3.4-bullseye` - linux; arm64 variant v8
...
### `ruby:3.3.4-bullseye` - linux; mips64le
...
### `ruby:3.3.4-bullseye` - linux; ppc64le
...
### `ruby:3.3.4-bullseye` - linux; s390x
