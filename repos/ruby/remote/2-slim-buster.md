...
```console
$ docker pull ruby@sha256:ee8001de379a3d098bc00f43a50fd6d649f5d7b580a9730e95dbd2502e162683
```
...
```console
$ docker pull ruby@sha256:cfb2801f999c3b9770881077fadf0019b7b182d8558047900b705eac3b0ec12d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.3 MB (54281335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:591695405c881df2e1ba16de402a60acee2e4949663bee6670138816095d1a23`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:e5812fdc56bb069b5ee346cc2335a2233b171cbec31ff56d4c2fb7fd7727b4d9`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d48d44433f2e46c204c1875697ce3592dae13a405b66a0580f1ef8b940d2e308`  
		Last Modified: Tue, 12 Apr 2022 19:19:03 GMT  
		Size: 14.5 MB (14547715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d9844155e5030ea9dbb6aec3be6e47e0a48031e2671f04b54d05fcfeb5f5b94`  
		Last Modified: Tue, 12 Apr 2022 19:19:01 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:6cf200b549e9ddcf3329e3150c0d004718ab91f1b2ade8522a12c7df3fbafde5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51374238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ababbed96750257a377c7ceebbedb236a1c88b46df806a553750e6dd33fbea6c`
-	Default Command: `["irb"]`
...
ENV RUBY_MAJOR=2.7
# Tue, 12 Apr 2022 19:14:52 GMT
ENV RUBY_VERSION=2.7.6
# Tue, 12 Apr 2022 19:14:52 GMT
ENV RUBY_DOWNLOAD_SHA256=54dcd3044726c4ab75a9d4604720501442b229a3aed6a55fe909567da8807f24
# Tue, 12 Apr 2022 19:16:33 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 		autoconf 		g++ 		gcc 		libbz2-dev 		libgdbm-compat-dev 		libglib2.0-dev 		libncurses-dev 		libreadline-dev 		libxml2-dev 		libxslt-dev 		make 		wget 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 12 Apr 2022 19:16:34 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 12 Apr 2022 19:16:35 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 12 Apr 2022 19:16:36 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 12 Apr 2022 19:16:37 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 12 Apr 2022 19:16:38 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:fba948d1a3c98e143c52c978123573078325be9c0af31e4058612687efebfdfb`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecac03e1cdeb8c92e08ce400c15b16603f346c305b2ef7179c58d7fd26859534`  
		Last Modified: Tue, 12 Apr 2022 19:43:26 GMT  
		Size: 14.2 MB (14173736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b01560d766a58401da36e7d997b1fc8de2309004b2adbd921215313fb302fd`  
		Last Modified: Tue, 12 Apr 2022 19:43:24 GMT  
		Size: 142.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
