...
```console
$ docker pull ruby@sha256:e2fd553b93a63617f1af195e97d70fddeb210fdd2aab4d15ab158b818f21af71
```
...
```console
$ docker pull ruby@sha256:e009982928bcd9f558ede43c90e79b0d98704f190011de876cce6c733f4e1770
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49149385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78f651b44ca1faba73dd1d916137f677c9b2fd3b00046eb77e36a6963bc6239e`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:1450afd5aacf92a110971673753e165edbf402159dbf7bebd6fbedc83d1f3475`  
		...
		Size: 197.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95257c1775f0921de4c9dc6c97bb2a519f6985186244a383fdf532c646f3526b`  
		Last Modified: Sat, 28 May 2022 19:52:54 GMT  
		Size: 13.9 MB (13902901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab4b15da6997c081325939f906d22d9d26a23b833c6f39941ed96daa445d7d67`  
		Last Modified: Sat, 28 May 2022 19:52:47 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:c950358795aded2c534ac48d3002b1fd5888744eb02195fab7cef76292ed5b97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.3 MB (58314049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d596a74690683c7e583bfaf7e64240e2a559a9a69cf3868d6288aaf8cf33801c`
-	Default Command: `["irb"]`
...
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 		autoconf 		g++ 		gcc 		libbz2-dev 		libgdbm-compat-dev 		libglib2.0-dev 		libncurses-dev 		libreadline-dev 		libxml2-dev 		libxslt-dev 		make 		wget 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Sat, 28 May 2022 20:35:44 GMT
ENV GEM_HOME=/usr/local/bundle
# Sat, 28 May 2022 20:35:47 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Sat, 28 May 2022 20:35:53 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Sat, 28 May 2022 20:36:09 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Sat, 28 May 2022 20:36:16 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:763b0484ed29728662b757b6eb4082b4edb9ab5a6100afb4a473ed1b2a769aad`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79dde7ed67fac80a521e20c26865a945116cb0c0e54578a062b04737b66762bd`  
		Last Modified: Sat, 28 May 2022 20:46:45 GMT  
		Size: 15.0 MB (15031245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:315412b19652820f8891b8dda77ddc69b58127ca92954d6c2746aa03622168b8`  
		Last Modified: Sat, 28 May 2022 20:46:43 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
