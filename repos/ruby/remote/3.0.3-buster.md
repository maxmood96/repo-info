...
```console
$ docker pull ruby@sha256:73271712d33818aa324b0766b2913b3661c01c6964dd5b629ef656fae076125a
```
...
```console
$ docker pull ruby@sha256:8241f011ad570af22bd9a82a988cd842d9de20a03ffd715f0cac94e5e065c6da
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.1 MB (306110034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d9aa188573d196f8264bf432e303a37fb8224a32eabb8bcfdede139a6951b47`
-	Default Command: `["irb"]`
...
# Thu, 27 Jan 2022 23:48:01 GMT
ENV LANG=C.UTF-8
# Thu, 27 Jan 2022 23:57:43 GMT
ENV RUBY_MAJOR=3.0
# Thu, 27 Jan 2022 23:57:43 GMT
ENV RUBY_VERSION=3.0.3
# Thu, 27 Jan 2022 23:57:44 GMT
ENV RUBY_DOWNLOAD_SHA256=88cc7f0f021f15c4cd62b1f922e3a401697f7943551fe45b1fdf4f2417a17a9c
# Fri, 28 Jan 2022 00:01:50 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 28 Jan 2022 00:01:50 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 28 Jan 2022 00:01:51 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 28 Jan 2022 00:01:51 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 28 Jan 2022 00:01:53 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 28 Jan 2022 00:01:53 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:b1cdf251c9014c3af40ac63a34f07ef077d46ae13f46be46836b23c5073512c7`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c890392044b8bd1567c70073ec006e51330f66aa357e368c4bb2a00047f90cb`  
		Last Modified: Fri, 28 Jan 2022 00:29:28 GMT  
		Size: 27.7 MB (27737175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e68d31ae87407232f69b4e43a1b57791d9e56bc1c0410ae22b5724911c7e5ab`  
		Last Modified: Fri, 28 Jan 2022 00:29:16 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:89e7bc8be7a8f7d6ee71bf0c1255f9389a2c346a30d569e923dcfdd1bbe47106
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.0 MB (349961562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af671dfbbac1f7363e1f73207fcc7fcadb3b05873e76d9aff0a3ea8fbb945780`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Thu, 27 Jan 2022 02:54:09 GMT
ENV RUBY_MAJOR=3.0
# Thu, 27 Jan 2022 02:54:09 GMT
ENV RUBY_VERSION=3.0.3
# Thu, 27 Jan 2022 02:54:09 GMT
ENV RUBY_DOWNLOAD_SHA256=88cc7f0f021f15c4cd62b1f922e3a401697f7943551fe45b1fdf4f2417a17a9c
# Thu, 27 Jan 2022 02:57:46 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 27 Jan 2022 02:57:47 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 27 Jan 2022 02:57:47 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 27 Jan 2022 02:57:47 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 27 Jan 2022 02:57:48 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Thu, 27 Jan 2022 02:57:49 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:4820e35b7386d376b2ccd273a23baf2ad4a9838653c4a65856a93b662e6bcc2e`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b339a56008c63c0de18c4fe6b9e2735c649a720cbc280006519b8052820e8a2`  
		Last Modified: Thu, 27 Jan 2022 03:40:32 GMT  
		Size: 28.0 MB (27998229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f37f3f86fa394df7c945b7810777a76a982b4b091aa4c9142b7350a73194770`  
		Last Modified: Thu, 27 Jan 2022 03:40:25 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
