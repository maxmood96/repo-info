...
```console
$ docker pull ruby@sha256:49088e8d4022d6abd6ddf5228e9456ca3d4be786338d081cebefa274367a4a95
```
...
### `ruby:3.3.3-slim-bullseye` - linux; amd64
...
### `ruby:3.3.3-slim-bullseye` - unknown; unknown
...
### `ruby:3.3.3-slim-bullseye` - linux; arm variant v5
...
### `ruby:3.3.3-slim-bullseye` - linux; arm variant v7
...
### `ruby:3.3.3-slim-bullseye` - linux; arm64 variant v8
...
### `ruby:3.3.3-slim-bullseye` - linux; 386
...
### `ruby:3.3.3-slim-bullseye` - linux; mips64le
...
### `ruby:3.3.3-slim-bullseye` - linux; ppc64le
...
### `ruby:3.3.3-slim-bullseye` - linux; s390x
