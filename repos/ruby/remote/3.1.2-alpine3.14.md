...
### `ruby:3.1.2-alpine3.14` - linux; amd64
...
### `ruby:3.1.2-alpine3.14` - linux; arm variant v6
...
### `ruby:3.1.2-alpine3.14` - linux; arm variant v7
...
### `ruby:3.1.2-alpine3.14` - linux; arm64 variant v8
...
### `ruby:3.1.2-alpine3.14` - linux; 386
...
### `ruby:3.1.2-alpine3.14` - linux; ppc64le
...
### `ruby:3.1.2-alpine3.14` - linux; s390x
