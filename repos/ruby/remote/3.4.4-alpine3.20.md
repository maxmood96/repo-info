...
```console
$ docker pull ruby@sha256:a6a0069a1236b8aa27be0074d6752c0f27cf0a35913f2a4a24e8d118216c4dcd
```
...
### `ruby:3.4.4-alpine3.20` - linux; amd64
...
### `ruby:3.4.4-alpine3.20` - unknown; unknown
...
### `ruby:3.4.4-alpine3.20` - linux; arm variant v6
...
### `ruby:3.4.4-alpine3.20` - linux; arm variant v7
...
### `ruby:3.4.4-alpine3.20` - linux; arm64 variant v8
...
### `ruby:3.4.4-alpine3.20` - linux; 386
...
### `ruby:3.4.4-alpine3.20` - linux; ppc64le
...
### `ruby:3.4.4-alpine3.20` - linux; riscv64
