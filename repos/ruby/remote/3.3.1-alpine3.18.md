...
### `ruby:3.3.1-alpine3.18` - linux; amd64
...
### `ruby:3.3.1-alpine3.18` - linux; arm variant v7
...
### `ruby:3.3.1-alpine3.18` - linux; arm64 variant v8
...
### `ruby:3.3.1-alpine3.18` - linux; 386
...
### `ruby:3.3.1-alpine3.18` - linux; ppc64le
...
### `ruby:3.3.1-alpine3.18` - linux; s390x
