...
```console
$ docker pull ruby@sha256:806e86226a360a538e675a2aaac6412d607e85dec7b30bd7e5fce101b64a3946
```
...
### `ruby:3.3.2-slim-bullseye` - linux; mips64le
...
### `ruby:3.3.2-slim-bullseye` - linux; ppc64le
