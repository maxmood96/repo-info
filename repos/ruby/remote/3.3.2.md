...
```console
$ docker pull ruby@sha256:2e65a8296383aee6ebce075fe3e0915d556d73794efdc985fc38193608801002
```
...
### `ruby:3.3.2` - linux; arm variant v5
...
### `ruby:3.3.2` - linux; arm variant v7
