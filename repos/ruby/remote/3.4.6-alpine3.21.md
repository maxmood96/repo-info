...
```console
$ docker pull ruby@sha256:8b16f10c7c9fd361a593f5a66865d99fea130d6e5b7a5ba2f53c43b1e08a0032
```
...
### `ruby:3.4.6-alpine3.21` - linux; amd64
...
### `ruby:3.4.6-alpine3.21` - unknown; unknown
...
### `ruby:3.4.6-alpine3.21` - linux; arm variant v6
...
### `ruby:3.4.6-alpine3.21` - linux; arm variant v7
...
### `ruby:3.4.6-alpine3.21` - linux; arm64 variant v8
...
### `ruby:3.4.6-alpine3.21` - linux; 386
...
### `ruby:3.4.6-alpine3.21` - linux; ppc64le
...
### `ruby:3.4.6-alpine3.21` - linux; s390x
