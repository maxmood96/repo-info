...
```console
$ docker pull ruby@sha256:514c207e77c10337e929381ea1835074d6de491c8fc1db208cde2972b6047ae7
```
...
### `ruby:4.0.5-bookworm` - linux; amd64
...
### `ruby:4.0.5-bookworm` - unknown; unknown
...
### `ruby:4.0.5-bookworm` - linux; arm variant v5
...
### `ruby:4.0.5-bookworm` - linux; arm variant v7
...
### `ruby:4.0.5-bookworm` - linux; arm64 variant v8
...
### `ruby:4.0.5-bookworm` - linux; mips64le
...
### `ruby:4.0.5-bookworm` - linux; ppc64le
...
### `ruby:4.0.5-bookworm` - linux; s390x
