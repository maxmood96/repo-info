...
```console
$ docker pull ruby@sha256:f1c8d62ce9063e4351f0823be7d76053530c8439c19fb7a8c8f86c9b814ced9e
```
...
```console
$ docker pull ruby@sha256:dd024f33ecff62dac093fb1c3e4060698fb764acb783e09e89d93afcafba2856
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.7 MB (355652000 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:198141eaa2db07e74e05d76b06eaa0a1b5e99e347d10334b3bef9d9b677c8029`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:26e7ceebb0b46999ab07630803680603213e4d63c622a1c2ff6efaf4cf86cbc6`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:435ee10c6e7e5505742f94a5cbbb113c8d1300b5f0e1100042b420afa044f39a`  
		Last Modified: Tue, 05 Apr 2022 03:45:32 GMT  
		Size: 33.6 MB (33557152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08571a6221997b9b44e24827727f03d020282ea5f5d97f47e59cd47d49fdc45e`  
		Last Modified: Tue, 05 Apr 2022 03:45:28 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:19ed85e1f25b04978f561369df58ac8ee67cdc034cbf8fb4c8154a3e38b7f393
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.1 MB (346071666 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c765c31792680af8c964dc35e128d3d1a534f0413de4e4c4c0b82a6253dcc3c1`
-	Default Command: `["irb"]`
...
ENV RUBY_VERSION=3.2.0-preview1
# Tue, 05 Apr 2022 02:02:20 GMT
ENV RUBY_DOWNLOAD_SHA256=6d28477f7fa626b63bf139afd37bcfeb28fce6847b203fa10f37cb3615d0c35d
# Tue, 05 Apr 2022 02:04:14 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 05 Apr 2022 02:04:15 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 05 Apr 2022 02:04:16 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 05 Apr 2022 02:04:17 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 05 Apr 2022 02:04:19 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 05 Apr 2022 02:04:20 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:346f04d025b152a76c5adae79911f03f9567e74c7c57a68663a16850d4729c31`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:705d47ee1a6ae7629641e5ea2c49b67288fefe2a89b3807cc89ecaf34f03b9df`  
		Last Modified: Tue, 05 Apr 2022 02:40:44 GMT  
		Size: 32.7 MB (32712114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec46b9a559531531ad5ba7cb21ecd8e78fefcd8e518d20fd82aff493ee6e9455`  
