...
```console
$ docker pull ruby@sha256:56ec62a637795d21f2c42a47e607e0b3dd8d7338296facee59a9e2d05a7960f6
```
...
### `ruby:3.3.2-slim-bookworm` - linux; amd64
...
### `ruby:3.3.2-slim-bookworm` - unknown; unknown
...
### `ruby:3.3.2-slim-bookworm` - linux; arm variant v5
...
### `ruby:3.3.2-slim-bookworm` - linux; arm variant v7
...
### `ruby:3.3.2-slim-bookworm` - linux; 386
...
### `ruby:3.3.2-slim-bookworm` - linux; mips64le
...
### `ruby:3.3.2-slim-bookworm` - linux; ppc64le
...
### `ruby:3.3.2-slim-bookworm` - linux; s390x
