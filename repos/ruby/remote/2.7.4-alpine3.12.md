...
```console
$ docker pull ruby@sha256:89d332f29a5214c830432fe1d1e5a4f3b66039708567d57f4055aaf62c21abba
```
...
### `ruby:2.7.4-alpine3.12` - linux; amd64
...
### `ruby:2.7.4-alpine3.12` - linux; 386
