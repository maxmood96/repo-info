...
### `ruby:4.0.4-slim-bookworm` - linux; amd64
...
### `ruby:4.0.4-slim-bookworm` - unknown; unknown
...
### `ruby:4.0.4-slim-bookworm` - linux; arm variant v5
...
### `ruby:4.0.4-slim-bookworm` - linux; arm variant v7
...
### `ruby:4.0.4-slim-bookworm` - linux; arm64 variant v8
...
### `ruby:4.0.4-slim-bookworm` - linux; 386
...
### `ruby:4.0.4-slim-bookworm` - linux; mips64le
...
### `ruby:4.0.4-slim-bookworm` - linux; ppc64le
...
### `ruby:4.0.4-slim-bookworm` - linux; s390x
