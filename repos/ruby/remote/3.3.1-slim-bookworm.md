...
### `ruby:3.3.1-slim-bookworm` - linux; amd64
...
### `ruby:3.3.1-slim-bookworm` - linux; arm variant v7
...
### `ruby:3.3.1-slim-bookworm` - linux; arm64 variant v8
...
### `ruby:3.3.1-slim-bookworm` - linux; ppc64le
...
### `ruby:3.3.1-slim-bookworm` - linux; s390x
