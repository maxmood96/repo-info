...
```console
$ docker pull ruby@sha256:fd75a485fe3d64cff94d078932955ca2f9cc72cad0a06eb667bec2a44a94b433
```
...
```console
$ docker pull ruby@sha256:ba90dbc14a04073f6aa75951ce9c6bcf7715372d7b2e1d69e48593496951fd14
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.2 MB (335201283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd155aa807dfbad1908b464403478ab618a8a2a12d8d01179fe082f4a8e5012d`
-	Default Command: `["irb"]`
...
# Wed, 18 Nov 2020 15:30:21 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Wed, 18 Nov 2020 15:30:21 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 18 Nov 2020 15:30:23 GMT
...
-	Layers:
	...
	-	`sha256:49d50a24de5f0c486106c4629b593d8ce9a5e766a04d84901f6bed1b5b7d1afa`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1b8cc7a10d3a0391f24edd4a7e9da0c17f56bbf0d3f5cd15db2a58ba27ef677`  
		Last Modified: Wed, 18 Nov 2020 16:04:35 GMT  
		Size: 22.9 MB (22885106 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eae309b30d92a905f1f2103feffc869d221d7366fd872cea64e50d14fbd02e8d`  
		Last Modified: Wed, 18 Nov 2020 16:04:32 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:28973eb5a83a3f21628476ce099bdde9450ae8bb788b4b7396c4123b522fad55
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.1 MB (320057392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e6adf7d1a43f2bce781082ae3361c9caa90464fbf8dfb0ac644d1ee73e05cdc`
-	Default Command: `["irb"]`
...
# Fri, 11 Dec 2020 15:41:14 GMT
ENV LANG=C.UTF-8
# Fri, 11 Dec 2020 16:01:11 GMT
ENV RUBY_MAJOR=2.7
# Fri, 11 Dec 2020 16:01:11 GMT
ENV RUBY_VERSION=2.7.2
# Fri, 11 Dec 2020 16:01:12 GMT
ENV RUBY_DOWNLOAD_SHA256=1b95ab193cc8f5b5e59d2686cb3d5dcf1ddf2a86cb6950e0b4bdaae5040ec0d6
# Fri, 11 Dec 2020 16:09:40 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 11 Dec 2020 16:09:41 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 11 Dec 2020 16:09:41 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 11 Dec 2020 16:09:42 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 11 Dec 2020 16:09:43 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 11 Dec 2020 16:09:44 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:919ed1fefca70c98e3cd87c00351131b83c5875315d3ad04c855fd8838d873de`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1eaa180bc6e18ff7ceb2be08696308c32869aab0dd6ba3c4c4cedfcf4ec8581`  
		Last Modified: Fri, 11 Dec 2020 16:54:37 GMT  
		Size: 23.1 MB (23119891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd88935176ea6c8b3587df75602f00e01ad2eeabc01b847b102350c5a8605940`  
		Last Modified: Fri, 11 Dec 2020 16:54:25 GMT  
		Size: 142.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
