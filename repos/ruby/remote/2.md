...
```console
$ docker pull ruby@sha256:da589a8f39c8b64651d16c34fdffd16faa3e9ea53cd95152376e6b7b4e643a5f
```
...
```console
$ docker pull ruby@sha256:c3eeab14ea19b4175546f7839efc81e6db7200a8c0e6e1356b6eb6d0403f688e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.4 MB (296355101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ba6abf37d7867d7f499984964e269da530ccb6025896de23e4b2e87b533b1cb`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Fri, 28 Jan 2022 00:02:35 GMT
ENV RUBY_MAJOR=2.7
# Fri, 28 Jan 2022 00:02:35 GMT
ENV RUBY_VERSION=2.7.5
# Fri, 28 Jan 2022 00:02:36 GMT
ENV RUBY_DOWNLOAD_SHA256=d216d95190eaacf3bf165303747b02ff13f10b6cfab67a9031b502a49512b516
# Fri, 28 Jan 2022 00:06:00 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 28 Jan 2022 00:06:01 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 28 Jan 2022 00:06:01 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 28 Jan 2022 00:06:02 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 28 Jan 2022 00:06:03 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 28 Jan 2022 00:06:04 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:00deba4f4ba0b7ca8fb55b4892a21eb3ef19ac3b7513c11107e3a8396bc4b01e`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf47ee565c09e3a196c52bacda72807fb2e8119ed6b3ab965e33bbaa10d39098`  
		Last Modified: Fri, 28 Jan 2022 00:29:59 GMT  
		Size: 13.8 MB (13794008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9779bde6af43c9c124211f1b7b4edf0dd48233f0d494522d56d2f5b4ce911e05`  
		Last Modified: Fri, 28 Jan 2022 00:29:52 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:0ebf7465ae34be37e2f3b23d563868e967dbf75fef5c4daecd9d547253533abb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.7 MB (341688116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1a6fd92bd6f83e446f01e70b37d03284ac179de59a63b771b38ccf33d7ea410`
-	Default Command: `["irb"]`
...
# Thu, 27 Jan 2022 02:27:18 GMT
ENV LANG=C.UTF-8
# Thu, 27 Jan 2022 03:03:07 GMT
ENV RUBY_MAJOR=2.7
# Thu, 27 Jan 2022 03:03:07 GMT
ENV RUBY_VERSION=2.7.5
# Thu, 27 Jan 2022 03:03:08 GMT
ENV RUBY_DOWNLOAD_SHA256=d216d95190eaacf3bf165303747b02ff13f10b6cfab67a9031b502a49512b516
# Thu, 27 Jan 2022 03:05:59 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 27 Jan 2022 03:05:59 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 27 Jan 2022 03:06:00 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 27 Jan 2022 03:06:00 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 27 Jan 2022 03:06:01 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Thu, 27 Jan 2022 03:06:01 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:823ab819ef22ebed75f22813498282bd322bedf9c842e1fbb7323311183ef970`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad099e35db4a18979392fc8633a78e631a17533e7eeebcf01af919862249dcd2`  
		Last Modified: Thu, 27 Jan 2022 03:41:21 GMT  
		Size: 13.8 MB (13846071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05d37cdb34f38e8f6034b2c7891686aeb6eaea6ec5c0c84ae7a6aceca0a28b04`  
		Last Modified: Thu, 27 Jan 2022 03:41:17 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
