...
```console
$ docker pull ruby@sha256:4aefbce26e37bd4e700d72861cad351aac61f8fdad39a0f34a789df03bf84649
```
...
```console
$ docker pull ruby@sha256:ff26835d333b185c03b89bb6958bcf681c796cc8c99be82e480469ce3dda2100
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.1 MB (308094330 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b92afa01943c4bbe343187312d17ddee2df3361b34e9ff50fef7365bf523fe2`
-	Default Command: `["irb"]`
...
# Tue, 01 Sep 2020 08:52:59 GMT
ENV RUBY_MAJOR=2.7
# Tue, 01 Sep 2020 08:53:00 GMT
ENV RUBY_VERSION=2.7.1
# Tue, 01 Sep 2020 08:53:01 GMT
ENV RUBY_DOWNLOAD_SHA256=b224f9844646cc92765df8288a46838511c1cec5b550d8874bd4686a904fcee7
# Tue, 01 Sep 2020 08:55:58 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 01 Sep 2020 08:56:00 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 01 Sep 2020 08:56:00 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 01 Sep 2020 08:56:01 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 01 Sep 2020 08:56:04 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 01 Sep 2020 08:56:05 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:4bf539a0f17981859985c31ce964801e475eb61c7afe5cb59807b6f4ddf1ffa2`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a42526ad1536f990c6359aa454e6a4ace726a3016dce629465e01d8f3e7a0550`  
		Last Modified: Tue, 01 Sep 2020 09:10:12 GMT  
		Size: 22.1 MB (22147203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77f39c85734c58a3706029a8ea1af3b466c209c957be6eb1e8c78bd8efb57aa8`  
		Last Modified: Tue, 01 Sep 2020 09:10:08 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:61906b1319f81080261186a2eb994c4f1aa86afe632539fd18a3ee89bfd82d81
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **357.0 MB (357048069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:655aa7cae1e2ffeb81328bce4bc97a6fd0bcf8b9336869b0f92b0a3042f47615`
-	Default Command: `["irb"]`
...
ENV LANG=C.UTF-8
# Tue, 01 Sep 2020 15:05:19 GMT
ENV RUBY_MAJOR=2.7
# Tue, 01 Sep 2020 15:05:22 GMT
ENV RUBY_VERSION=2.7.1
# Tue, 01 Sep 2020 15:05:28 GMT
ENV RUBY_DOWNLOAD_SHA256=b224f9844646cc92765df8288a46838511c1cec5b550d8874bd4686a904fcee7
# Tue, 01 Sep 2020 15:08:49 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 01 Sep 2020 15:08:55 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 01 Sep 2020 15:09:03 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 01 Sep 2020 15:09:06 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 01 Sep 2020 15:09:22 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 01 Sep 2020 15:09:28 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:cd4d343c6838b1d4b7b955da0e6bec50c9a28a736e4be23c57150bbaa15bbe66`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0d6875a0804eefd2b3d7568c62065743c096d39e6fca6833bdb9058601a2f5f`  
		Last Modified: Tue, 01 Sep 2020 15:23:05 GMT  
		Size: 23.4 MB (23393443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b365d6288689d6720679a3c233a141a41f9e7aa732fb1559054dd9586a214165`  
		Last Modified: Tue, 01 Sep 2020 15:23:02 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
