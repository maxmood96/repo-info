...
```console
$ docker pull ruby@sha256:66cfe6384573830f61c10306c34deb0141645c03ed435b77135b6a69203e0337
```
...
```console
$ docker pull ruby@sha256:aea5836846e6a86a95e7738351157ec49ecebeed54f29f96824ab9d50c2bcc2c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.8 MB (296814647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:148da904cc7ec7e2f2928a708634c392d3d93d78b21ccd73d78398833ae2885d`
-	Default Command: `["irb"]`
...
# Wed, 12 Apr 2023 21:01:06 GMT
ENV LANG=C.UTF-8
# Wed, 12 Apr 2023 21:12:02 GMT
ENV RUBY_MAJOR=2.7
# Wed, 12 Apr 2023 21:12:02 GMT
ENV RUBY_VERSION=2.7.8
# Wed, 12 Apr 2023 21:12:02 GMT
ENV RUBY_DOWNLOAD_SHA256=f22f662da504d49ce2080e446e4bea7008cee11d5ec4858fc69000d0e5b1d7fb
# Wed, 12 Apr 2023 21:13:19 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Wed, 12 Apr 2023 21:13:19 GMT
ENV GEM_HOME=/usr/local/bundle
# Wed, 12 Apr 2023 21:13:19 GMT
...
-	Layers:
	...
	-	`sha256:0068fe200f7bc1f8bd9636580b9243f5f2a40c618ec362dcc54bc97ca5d4f622`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5261b10c165f5e5f895804c6483b2f3b4fdd37e45c35b6099b8199471d37cdfd`  
		Last Modified: Wed, 12 Apr 2023 21:17:09 GMT  
		Size: 13.8 MB (13800856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e381cd25b695919162bf0b6c9caedff56ff4e9e7a779b09b06ca9fe52586896`  
		Last Modified: Wed, 12 Apr 2023 21:17:07 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:1f3ae1c54fc5e7ee9f69786e3577dfbf9f73cc2f5df2f25a18cc0078ee2b0deb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.1 MB (342075895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c257e66c1850f4c12eff701c82ed66c655d47fe54595aa961c2ee3468be07cb`
-	Default Command: `["irb"]`
...
# Wed, 12 Apr 2023 21:00:47 GMT
ENV LANG=C.UTF-8
# Wed, 12 Apr 2023 21:42:53 GMT
ENV RUBY_MAJOR=2.7
# Wed, 12 Apr 2023 21:42:54 GMT
ENV RUBY_VERSION=2.7.8
# Wed, 12 Apr 2023 21:42:54 GMT
ENV RUBY_DOWNLOAD_SHA256=f22f662da504d49ce2080e446e4bea7008cee11d5ec4858fc69000d0e5b1d7fb
# Wed, 12 Apr 2023 21:45:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Wed, 12 Apr 2023 21:45:11 GMT
ENV GEM_HOME=/usr/local/bundle
# Wed, 12 Apr 2023 21:45:11 GMT
...
-	Layers:
	...
	-	`sha256:da7b7fa36a56205ea7c78d8a55c7d3089de4370e9624a16908d81f69989c80c9`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2189516f9bbb62ab9516457e73a0da9028c591c33bfaa9b1b84766c86f3c8ff`  
		Last Modified: Wed, 12 Apr 2023 21:57:01 GMT  
		Size: 13.9 MB (13852140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5425ec36df92cc9d605447b0c3ebfcf9f2d0c1800ce799d3a121aebffd78f3b7`  
		Last Modified: Wed, 12 Apr 2023 21:56:59 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
