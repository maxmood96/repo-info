...
```console
$ docker pull ruby@sha256:989f872da8dda2bbae2a195c42d81f0c30b99d8f7a088d64f3ccd77f757f264a
```
...
```console
$ docker pull ruby@sha256:ee5560abdbe752a3ee5a4b5676a2f62bb4ce401c5305a4d743378ce56ad41924
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.6 MB (313615799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7401f1935c5aef56db0fa77454c619861b789288a0374381dc4b5d7a67491355`
-	Default Command: `["irb"]`
...
ENV RUBY_MAJOR=3.0
# Mon, 05 Apr 2021 18:42:08 GMT
ENV RUBY_VERSION=3.0.1
# Mon, 05 Apr 2021 18:42:08 GMT
ENV RUBY_DOWNLOAD_SHA256=d06bccd382d03724b69f674bc46cd6957ba08ed07522694ce44b9e8ffc9c48e2
# Mon, 05 Apr 2021 18:45:23 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	! dpkg -l | grep -i ruby; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Mon, 05 Apr 2021 18:45:24 GMT
ENV GEM_HOME=/usr/local/bundle
# Mon, 05 Apr 2021 18:45:25 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Mon, 05 Apr 2021 18:45:26 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
-	Layers:
	...
	-	`sha256:07471f9a8bf3b32d1b868e26bf15ab2ab59f452f869423cdfb1b8a9781e77993`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e277029c423c0cd2ef2092b2a2ce6a1ddf0ac94946238871411fb59a39ffc135`  
		Last Modified: Mon, 05 Apr 2021 19:29:26 GMT  
		Size: 27.5 MB (27533249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0338446621b03c2b5c24bd5e76efab4cf0b23cf4e4d2e9014fbb54180f5d11c`  
		Last Modified: Mon, 05 Apr 2021 19:29:20 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:33c25481dcb5b9645d3d92a6efa1c1bb158dff599dffec25872c72d80fd4d671
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.2 MB (323155539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bf2abe49aa1ca6894ae45046db6845be9161a659e80d2607a4a04d70ce174b3`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:9c68f7c939dda8809a9e19615b35b40aec9786195afa1a7c1d14487c73f5b09a`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f014fa4052ea5fc384ea329e2cb5a31218a70d2c0fc154a23d1572f6c6e54ce`  
		Last Modified: Mon, 05 Apr 2021 18:32:18 GMT  
		Size: 28.6 MB (28623359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a38c5c0f46a2b23e0a494f202503de6fd8caf5127b23ea11a5f60a91be4d0e89`  
		Last Modified: Mon, 05 Apr 2021 18:32:16 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
