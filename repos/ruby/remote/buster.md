...
```console
$ docker pull ruby@sha256:7e081c49cab8c3b437684d7ed75269eeb27c2057851f9c89b0e909233e18f65e
```
...
```console
$ docker pull ruby@sha256:c7407aec698797bb0433fee1ab00cf089cb10b8987af7338519fd414f14e8273
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.7 MB (313663407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a24867772c799aa6c93302627ce15006d2542157076d66e1ec21e2ae641492a`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:c6c760778486d834d884cf06df4c4e1fab5751f8b487cbb8a50bbaff2ad677e5`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e84057ee6870c79e7def7fedc68bf26779cd1cb8aae06ddbacfd4ce7125e436a`  
		Last Modified: Thu, 08 Jul 2021 20:41:27 GMT  
		Size: 27.5 MB (27542901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09f11224a228c8844894b30548589a42e05c8e889889a0c7c915043a37622745`  
		Last Modified: Thu, 08 Jul 2021 20:41:15 GMT  
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:c8d6e3704d67a633636262b1e8ebcae9651ed1ce1f57c7a3c6bbc083d7eefb2e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **331.2 MB (331234908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f48641cd719005a4a5374aa13c0fca4b8348a13453c86fdd1322ca91c15c430`
-	Default Command: `["irb"]`
...
# Wed, 07 Jul 2021 23:31:57 GMT
ENV RUBY_DOWNLOAD_SHA256=570e7773100f625599575f363831166d91d49a1ab97d3ab6495af44774155c40
# Thu, 08 Jul 2021 20:32:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 08 Jul 2021 20:32:12 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 08 Jul 2021 20:32:12 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 08 Jul 2021 20:32:12 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 08 Jul 2021 20:32:13 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Thu, 08 Jul 2021 20:32:13 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:0a2a528124d496eac690ecea4b73d72dd78179551e75e187cfa0ac7c770ac001`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1ef976e29199d0106554a34d18be8c079b4b6f5c46a50e3d77e1f7c4b13ea3c`  
		Last Modified: Thu, 08 Jul 2021 21:07:14 GMT  
		Size: 28.2 MB (28193779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5c96f42ef11e947fcebbc787b3b938f6364cd76cccf986be9c17969343f6639`  
		Last Modified: Thu, 08 Jul 2021 21:07:11 GMT  
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:e04c0e7b073c3094a9553331136d18365c8b8603f63a6dda8b2ed34a3d3f6e68
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.6 MB (349633235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6027e3f017300aa5e129f43b52cdba561223272a684e38c582b20acdb159020c`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:1c66981eeebac00534878964fa14df44f9a6fd486578f1ab0fbe3a24dd974a07`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0d3610e4b8b3374793057c3f5fc1e7b0c207c0a986a1229c3fb1dc9f3706d9e`  
		Last Modified: Thu, 08 Jul 2021 20:31:00 GMT  
		Size: 27.7 MB (27717480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:192abb06e1f8c7645da589be24795e625e66ed20fefa470479e54628dc1864fe`  
		Last Modified: Thu, 08 Jul 2021 20:30:53 GMT  
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:df48f2bd4453e8e4886a4e6e0a06bd02f7df05e4d8bdf5d87e3f13970e636280
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **362.8 MB (362796949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb7d4800eee33db5dcbf1e55b050db3743aa2cb214c390a92e6e5bac7cd0a4ae`
-	Default Command: `["irb"]`
...
ENV RUBY_MAJOR=3.0
# Thu, 08 Jul 2021 20:08:44 GMT
ENV RUBY_VERSION=3.0.2
# Thu, 08 Jul 2021 20:08:56 GMT
ENV RUBY_DOWNLOAD_SHA256=570e7773100f625599575f363831166d91d49a1ab97d3ab6495af44774155c40
# Thu, 08 Jul 2021 20:14:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 08 Jul 2021 20:14:15 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 08 Jul 2021 20:14:21 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 08 Jul 2021 20:14:25 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 08 Jul 2021 20:14:43 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Thu, 08 Jul 2021 20:14:57 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:231ea1fe157e3de9c484871aa11d7bef2a8461abd812858834f075948b2df983`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cb0b84614c9ba7771d082e0cab6683b524c48efca4652f4999c81098b002892`  
		Last Modified: Thu, 08 Jul 2021 21:13:37 GMT  
		Size: 28.9 MB (28873634 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e625354dae8ec5d2394f541b8771d1618ee882b8e89cdd3092882ac0771a9058`  
		Last Modified: Thu, 08 Jul 2021 21:13:33 GMT  
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:d4bd69f9be8be6e4c9c57968f5408b80dbaa9f5572afb12c3c00c0c2fe65b8a6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.2 MB (323189092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb566adb5d3d20f3ae31ea0e9520cb4c500f53b583537d8f52d69a4c89db83f2`
-	Default Command: `["irb"]`
...
# Fri, 09 Jul 2021 03:54:03 GMT
ENV LANG=C.UTF-8
# Fri, 09 Jul 2021 03:54:04 GMT
ENV RUBY_MAJOR=3.0
# Fri, 09 Jul 2021 03:54:04 GMT
ENV RUBY_VERSION=3.0.2
# Fri, 09 Jul 2021 03:54:04 GMT
ENV RUBY_DOWNLOAD_SHA256=570e7773100f625599575f363831166d91d49a1ab97d3ab6495af44774155c40
# Fri, 09 Jul 2021 03:56:13 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Fri, 09 Jul 2021 03:56:15 GMT
ENV GEM_HOME=/usr/local/bundle
# Fri, 09 Jul 2021 03:56:15 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Fri, 09 Jul 2021 03:56:15 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 09 Jul 2021 03:56:16 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Fri, 09 Jul 2021 03:56:17 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:1e325f89363e05070305804f4d43884ea545f8a0161ffe16b5d0549f3f74e397`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4999c9221b92ea1d5d8a500af905c31e48c04daad3fdf4dc01e7f82221127a86`  
		Last Modified: Fri, 09 Jul 2021 04:33:14 GMT  
		Size: 28.6 MB (28641665 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a8685b424834e33c19df84c46db19341124f63c0681d17561a4db7afb4affbb`  
		Last Modified: Fri, 09 Jul 2021 04:33:11 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
