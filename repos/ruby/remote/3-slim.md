...
```console
$ docker pull ruby@sha256:e0be7ab1fa6b43159fff18191e365061b2dd180c81db2a4b080527e43d6e2528
```
...
```console
$ docker pull ruby@sha256:a4eb58d768b119e283351453dec3e21fd899ca6f8e62e50c66e60771980a0687
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.0 MB (75994172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9f8bf7d7eeb9c3826d745df948fa3cf99d72dd0558a0f09ffcf6928d93678bc`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:5692b4eac6394ca445b3714bd43a44c026b16fd3322fce3ec89e70e219446657`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45abf1074ed49b8b94e45c7cb7c4fe240accee4496ea662f6ed4a81673ca01bb`  
		Last Modified: Tue, 28 Mar 2023 01:10:47 GMT  
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:528f1887cd24dcc39da3d895b2d833eee892e6c061ed3131970252103403558e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **68.0 MB (68037487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a107a17c6ae8c954dc26d797c10b0f221982ce6cdc5de2039fb99449ff22743`
-	Default Command: `["irb"]`
...
# Thu, 23 Mar 2023 06:42:50 GMT
ENV RUBY_DOWNLOAD_SHA256=746c8661ae25449cbdc5297d1092702e93e66f365a75fecb740d4f292ced630c
# Thu, 23 Mar 2023 06:45:03 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 		autoconf 		g++ 		gcc 		libbz2-dev 		libgdbm-compat-dev 		libglib2.0-dev 		libncurses-dev 		libreadline-dev 		libxml2-dev 		libxslt-dev 		make 		wget 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		rustArch=; 	dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		'amd64') rustArch='x86_64-unknown-linux-gnu'; rustupUrl='https://static.rust-lang.org/rustup/archive/1.25.1/x86_64-unknown-linux-gnu/rustup-init'; rustupSha256='5cc9ffd1026e82e7fb2eec2121ad71f4b0f044e88bca39207b3f6b769aaa799c' ;; 		'arm64') rustArch='aarch64-unknown-linux-gnu'; rustupUrl='https://static.rust-lang.org/rustup/archive/1.25.1/aarch64-unknown-linux-gnu/rustup-init'; rustupSha256='e189948e396d47254103a49c987e7fb0e5dd8e34b200aa4481ecc4b8e41fb929' ;; 	esac; 		if [ -n "$rustArch" ]; then 		mkdir -p /tmp/rust; 				wget -O /tmp/rust/rustup-init "$rustupUrl"; 		echo "$rustupSha256 */tmp/rust/rustup-init" | sha256sum --check --strict; 		chmod +x /tmp/rust/rustup-init; 				export RUSTUP_HOME='/tmp/rust/rustup' CARGO_HOME='/tmp/rust/cargo'; 		export PATH="$CARGO_HOME/bin:$PATH"; 		/tmp/rust/rustup-init -y --no-modify-path --profile minimal --default-toolchain '1.66.0' --default-host "$rustArch"; 				rustc --version; 		cargo --version; 	fi; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 		${rustArch:+--enable-yjit} 	; 	make -j "$(nproc)"; 	make install; 		rm -rf /tmp/rust; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 23 Mar 2023 06:45:04 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 23 Mar 2023 06:45:04 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 23 Mar 2023 06:45:04 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 28 Mar 2023 00:23:51 GMT
RUN mkdir -p "$GEM_HOME" && chmod 1777 "$GEM_HOME"
# Tue, 28 Mar 2023 00:23:51 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:d2dbe6acaf6962399719d4c660823c56b892af485f4e2596b748c9cd0724b9c1`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:777fcddd877cbee7dcc16a02243d44d1f455551391a7a4f44fc38f564394c1e3`  
		Last Modified: Fri, 24 Mar 2023 23:27:16 GMT  
		Size: 30.5 MB (30485361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ae47422034f2b2b6827c5aa06bcc2792ea392b962468cecd7cc53f7ff123feb`  
...
```console
$ docker pull ruby@sha256:881c9a3f04cc4ae3a08ff1decaea55cb84ba9f605af0704c677c6e3ebe554f5d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **65.1 MB (65099247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a19342981034f95b9c9fbc76923c83d3c98867f5529e0307ca49bbd77868b365`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:8164b85b385f1e4ba864685c9e28778d19ebd30a4d2cb1f3efcde46fd4f13655`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dce30ddd0a35440af9943b1863d53ae637a80da2d09a26516387229e82546c53`  
		Last Modified: Tue, 28 Mar 2023 02:26:57 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:72638fcd99a1ff43a81bd42819ca3b2906a87b58d940fdba24115a1f7df672de
```
...
-	Total Size: **73.7 MB (73736425 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dd263ed2ee6b47739e628fa0c47658113f7d9b9b4b5f48c4b5286c4fa02229a`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:410f54ce97cb9d67b4e025ee1b33ec5c997d0e4ddaa907449eac25107000255d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f70d31f638d2300db9dc5bf019de0d543c6f179ba815a5de403228de8828e024`  
		Last Modified: Tue, 28 Mar 2023 01:24:36 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:b2af9d26a888bc7d1c8e1c138a4cccb545e9fbb38bad9cd3e694f9465c9b264d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **74.8 MB (74846084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ec84711a4d8614c484eadf55562d2f80c1f51ef89f2e52064fbeda69da7e2da`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:b71f1e847ad5979318ce0c7d87e0899270ffb40d5dfb0b567f77c7d15dcf7177`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30dd9f9573528c46301499aea923c60b47743e98f604deb43d133c647c569d23`  
		Last Modified: Thu, 23 Mar 2023 20:45:01 GMT  
		Size: 30.5 MB (30451184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59c86569ae5a9d621bddc4b994f60dd1790b85c47c74cc06a44c640164972ca8`  
		Last Modified: Tue, 28 Mar 2023 02:42:27 GMT  
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull ruby@sha256:a3e4e57bced723843f3a0483f971dfe0341677f8b3ca776d056ce648d7960023
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.7 MB (70683099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b00df38fcfde6e1778678354a1a875418d38b7e5cef8f44029614d99b4980c1`
-	Default Command: `["irb"]`
...
ENV RUBY_MAJOR=3.2
# Thu, 23 Mar 2023 22:35:09 GMT
ENV RUBY_VERSION=3.2.1
# Thu, 23 Mar 2023 22:35:12 GMT
ENV RUBY_DOWNLOAD_SHA256=746c8661ae25449cbdc5297d1092702e93e66f365a75fecb740d4f292ced630c
# Thu, 23 Mar 2023 22:48:06 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 		autoconf 		g++ 		gcc 		libbz2-dev 		libgdbm-compat-dev 		libglib2.0-dev 		libncurses-dev 		libreadline-dev 		libxml2-dev 		libxslt-dev 		make 		wget 		xz-utils 	; 	rm -rf /var/lib/apt/lists/*; 		rustArch=; 	dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		'amd64') rustArch='x86_64-unknown-linux-gnu'; rustupUrl='https://static.rust-lang.org/rustup/archive/1.25.1/x86_64-unknown-linux-gnu/rustup-init'; rustupSha256='5cc9ffd1026e82e7fb2eec2121ad71f4b0f044e88bca39207b3f6b769aaa799c' ;; 		'arm64') rustArch='aarch64-unknown-linux-gnu'; rustupUrl='https://static.rust-lang.org/rustup/archive/1.25.1/aarch64-unknown-linux-gnu/rustup-init'; rustupSha256='e189948e396d47254103a49c987e7fb0e5dd8e34b200aa4481ecc4b8e41fb929' ;; 	esac; 		if [ -n "$rustArch" ]; then 		mkdir -p /tmp/rust; 				wget -O /tmp/rust/rustup-init "$rustupUrl"; 		echo "$rustupSha256 */tmp/rust/rustup-init" | sha256sum --check --strict; 		chmod +x /tmp/rust/rustup-init; 				export RUSTUP_HOME='/tmp/rust/rustup' CARGO_HOME='/tmp/rust/cargo'; 		export PATH="$CARGO_HOME/bin:$PATH"; 		/tmp/rust/rustup-init -y --no-modify-path --profile minimal --default-toolchain '1.66.0' --default-host "$rustArch"; 				rustc --version; 		cargo --version; 	fi; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 		${rustArch:+--enable-yjit} 	; 	make -j "$(nproc)"; 	make install; 		rm -rf /tmp/rust; 	apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Thu, 23 Mar 2023 22:48:09 GMT
ENV GEM_HOME=/usr/local/bundle
# Thu, 23 Mar 2023 22:48:13 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Thu, 23 Mar 2023 22:48:16 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 28 Mar 2023 01:14:18 GMT
RUN mkdir -p "$GEM_HOME" && chmod 1777 "$GEM_HOME"
# Tue, 28 Mar 2023 01:14:21 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:eda1813a36d980925be65f23f2cdc2f031cdaaf264620583d19f3ab6d5dee84d`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70ce8f1d0fe673d1a111ef691826d80bf980e042a46b70f928244dc4bfb792b2`  
		Last Modified: Thu, 23 Mar 2023 23:57:42 GMT  
		Size: 31.4 MB (31414408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9a25a7390b23868d1e160f8fd3a14ffd5f03838587267a7fd0ab27d4e27e1ff`  
...
```console
$ docker pull ruby@sha256:50902312db51f136c0e56ee82453d14df129376b4fd66c5b3c8c5bde459c7945
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.8 MB (77805517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f826be9bc7740a9dadfa6d76480ce96766b34934a7e6a01b78160f015e78010`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:f575dcbb9059206eab82408b8dd572269cec704c059ab6a7e1e65ec0098039e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a00f135928f764b92723215354dd98cc6384df04407b935dfd4db89e86c833b`  
...
```console
$ docker pull ruby@sha256:8a28ea531dd13031b6acb25321f939d8661ec043e511d73efffd747a6dc1dece
```
...
-	Total Size: **70.2 MB (70156599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c5eb5f5c003167a14f8c51cbef7a3a2de5aa2a91fa4d6e88272b5bf4c7f00ee`
-	Default Command: `["irb"]`
...
# Thu, 23 Mar 2023 11:06:29 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 28 Mar 2023 00:11:54 GMT
RUN mkdir -p "$GEM_HOME" && chmod 1777 "$GEM_HOME"
# Tue, 28 Mar 2023 00:11:55 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:a8daab9471649ac5ff7c878dd64d228f80e2e6ff7fa429d36e6fcc135b3769c7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5b9b84c36131bf15430f8a1854c199779714b89173b7fa8c8dde94172a2f213`  
		Last Modified: Tue, 28 Mar 2023 00:13:45 GMT  
		Size: 175.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
