...
```console
$ docker pull ruby@sha256:288b0fc2a8f23b28979f84ed49d9e20d67ece670b6a42aa01fc7146daad6c95e
```
...
### `ruby:4.0.2-alpine3.22` - linux; amd64
...
### `ruby:4.0.2-alpine3.22` - unknown; unknown
...
### `ruby:4.0.2-alpine3.22` - linux; arm variant v6
...
### `ruby:4.0.2-alpine3.22` - linux; arm variant v7
...
### `ruby:4.0.2-alpine3.22` - linux; arm64 variant v8
...
### `ruby:4.0.2-alpine3.22` - linux; 386
...
### `ruby:4.0.2-alpine3.22` - linux; ppc64le
...
### `ruby:4.0.2-alpine3.22` - linux; s390x
