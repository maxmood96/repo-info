...
```console
$ docker pull ruby@sha256:e120176b1106d97072e206a8690ac1f200303020e5acbefd637f6a00a7666c06
```
...
### `ruby:3.4.7-alpine3.21` - linux; amd64
...
### `ruby:3.4.7-alpine3.21` - unknown; unknown
...
### `ruby:3.4.7-alpine3.21` - linux; arm variant v6
...
### `ruby:3.4.7-alpine3.21` - linux; arm variant v7
...
### `ruby:3.4.7-alpine3.21` - linux; arm64 variant v8
...
### `ruby:3.4.7-alpine3.21` - linux; 386
...
### `ruby:3.4.7-alpine3.21` - linux; ppc64le
...
### `ruby:3.4.7-alpine3.21` - linux; s390x
