...
### `ruby:4.0.2-alpine` - unknown; unknown
...
### `ruby:4.0.2-alpine` - linux; arm variant v6
...
### `ruby:4.0.2-alpine` - linux; arm variant v7
...
### `ruby:4.0.2-alpine` - linux; arm64 variant v8
...
### `ruby:4.0.2-alpine` - linux; ppc64le
...
### `ruby:4.0.2-alpine` - linux; riscv64
