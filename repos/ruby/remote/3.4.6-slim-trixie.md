...
```console
$ docker pull ruby@sha256:51be4b1ec238f92cec36157f45fae693a1dd968d1cf14fd4cb78531bc6a01ebb
```
...
### `ruby:3.4.6-slim-trixie` - linux; amd64
...
### `ruby:3.4.6-slim-trixie` - unknown; unknown
...
### `ruby:3.4.6-slim-trixie` - linux; arm variant v5
...
### `ruby:3.4.6-slim-trixie` - linux; arm variant v7
...
### `ruby:3.4.6-slim-trixie` - linux; arm64 variant v8
...
### `ruby:3.4.6-slim-trixie` - linux; 386
...
### `ruby:3.4.6-slim-trixie` - linux; ppc64le
...
### `ruby:3.4.6-slim-trixie` - linux; s390x
