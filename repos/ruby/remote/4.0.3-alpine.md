...
```console
$ docker pull ruby@sha256:695ec456058d0ab792694aa3c815441bd83a279c78a2978a1f069e7a3324a5d0
```
...
### `ruby:4.0.3-alpine` - unknown; unknown
...
### `ruby:4.0.3-alpine` - linux; arm variant v6
...
### `ruby:4.0.3-alpine` - linux; arm variant v7
...
### `ruby:4.0.3-alpine` - linux; arm64 variant v8
...
### `ruby:4.0.3-alpine` - linux; ppc64le
