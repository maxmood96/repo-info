...
```console
$ docker pull ruby@sha256:26856d692f62c767368244008b9b85797d39a08051885de40963f5e87698dd6c
```
...
```console
$ docker pull ruby@sha256:7daf308a6243b4ae46575f99cca88f02b985bf10cc8e1104b2b9af701992939c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.9 MB (345905856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff1370aba6d77b3484215c034fd5f7e39c9431a3dfa1ab75b608902ed304a57a`
-	Default Command: `["irb"]`
...
-	Layers:
	...
	-	`sha256:34b452db5b3150c246f280cfdf5f3b90b2489a2d051549a821e093990480f55f`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5aaaaadcd16f092e90ac1db029fe58868ddbe2fdf91c185782383d36666416c1`  
		Last Modified: Tue, 05 Apr 2022 03:46:19 GMT  
		Size: 33.3 MB (33283030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac204c35ca145cac70fcf8341d3cf6652bba52616d1edb8e8eed0ffedc5b0c0c`  
...
```console
$ docker pull ruby@sha256:9276506b95c01f12336d4a445753f342e96eb813ef469d688dc2cd07e9c2b591
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.5 MB (335500720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e777b000e34849f4134d7b5760eeec95b5d5536de6ca4ca112a55ee80fbff735`
-	Default Command: `["irb"]`
...
ENV RUBY_DOWNLOAD_SHA256=6d28477f7fa626b63bf139afd37bcfeb28fce6847b203fa10f37cb3615d0c35d
# Tue, 05 Apr 2022 02:08:52 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		bison 		dpkg-dev 		libgdbm-dev 		ruby 	; 	rm -rf /var/lib/apt/lists/*; 		wget -O ruby.tar.xz "https://cache.ruby-lang.org/pub/ruby/${RUBY_MAJOR%-rc}/ruby-$RUBY_VERSION.tar.xz"; 	echo "$RUBY_DOWNLOAD_SHA256 *ruby.tar.xz" | sha256sum --check --strict; 		mkdir -p /usr/src/ruby; 	tar -xJf ruby.tar.xz -C /usr/src/ruby --strip-components=1; 	rm ruby.tar.xz; 		cd /usr/src/ruby; 		{ 		echo '#define ENABLE_PATH_CHECK 0'; 		echo; 		cat file.c; 	} > file.c.new; 	mv file.c.new file.c; 		autoconf; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--disable-install-doc 		--enable-shared 	; 	make -j "$(nproc)"; 	make install; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	find /usr/local -type f -executable -not \( -name '*tkinter*' \) -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| grep -vE '^/usr/local/lib/' 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		cd /; 	rm -r /usr/src/ruby; 	if dpkg -l | grep -i ruby; then exit 1; fi; 	[ "$(command -v ruby)" = '/usr/local/bin/ruby' ]; 	ruby --version; 	gem --version; 	bundle --version
# Tue, 05 Apr 2022 02:08:53 GMT
ENV GEM_HOME=/usr/local/bundle
# Tue, 05 Apr 2022 02:08:54 GMT
ENV BUNDLE_SILENCE_ROOT_WARNING=1 BUNDLE_APP_CONFIG=/usr/local/bundle
# Tue, 05 Apr 2022 02:08:55 GMT
ENV PATH=/usr/local/bundle/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Tue, 05 Apr 2022 02:08:56 GMT
RUN mkdir -p "$GEM_HOME" && chmod 777 "$GEM_HOME"
# Tue, 05 Apr 2022 02:08:58 GMT
CMD ["irb"]
```
...
-	Layers:
	...
	-	`sha256:ce9b8af7baea2c05d1bbd787592370eef0cc57ffa85a1f246a3eae2041295376`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89399d52e86154665ae0991ac79701351bdd6e421af8db281edbfd6d9173970c`  
		Last Modified: Tue, 05 Apr 2022 02:41:26 GMT  
		Size: 32.6 MB (32553580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2703ddf76f23966f75a742b787da7c576e5ca6766caab1f566940196aca75a14`  
		Last Modified: Tue, 05 Apr 2022 02:41:22 GMT  
		Size: 143.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
