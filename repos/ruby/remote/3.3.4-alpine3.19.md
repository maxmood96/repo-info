...
```console
$ docker pull ruby@sha256:28456928cecd2cd8ad048dcc0619f31bcd510cf898935fc29822bd9f8164f56b
```
...
### `ruby:3.3.4-alpine3.19` - linux; amd64
...
### `ruby:3.3.4-alpine3.19` - linux; arm variant v6
...
### `ruby:3.3.4-alpine3.19` - linux; arm64 variant v8
...
### `ruby:3.3.4-alpine3.19` - linux; s390x
