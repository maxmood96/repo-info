...
### `ruby:3.3.2-alpine` - unknown; unknown
...
### `ruby:3.3.2-alpine` - linux; arm variant v6
...
### `ruby:3.3.2-alpine` - linux; arm variant v7
...
### `ruby:3.3.2-alpine` - linux; arm64 variant v8
...
### `ruby:3.3.2-alpine` - linux; ppc64le
...
### `ruby:3.3.2-alpine` - linux; riscv64
