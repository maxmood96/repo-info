...
```console
alpine-release-3.22.0_alpha20250108-r0 description:
Alpine release data

alpine-release-3.22.0_alpha20250108-r0 webpage:
https://alpinelinux.org

alpine-release-3.22.0_alpha20250108-r0 installed size:
394 B

alpine-release-3.22.0_alpha20250108-r0 license:
MIT
...
```console
apk-tools-2.14.7-r0 description:
Alpine Package Keeper - package manager for alpine

apk-tools-2.14.7-r0 webpage:
https://gitlab.alpinelinux.org/alpine/apk-tools

apk-tools-2.14.7-r0 installed size:
247 KiB

apk-tools-2.14.7-r0 license:
GPL-2.0-only
...
```console
busybox-1.37.0-r10 description:
Size optimized toolbox of many common UNIX utilities

busybox-1.37.0-r10 webpage:
https://busybox.net/

busybox-1.37.0-r10 installed size:
798 KiB

busybox-1.37.0-r10 license:
GPL-2.0-only
...
```console
busybox-binsh-1.37.0-r10 description:
busybox ash /bin/sh

busybox-binsh-1.37.0-r10 webpage:
https://busybox.net/

busybox-binsh-1.37.0-r10 installed size:
1 B

busybox-binsh-1.37.0-r10 license:
GPL-2.0-only
...
```console
ssl_client-1.37.0-r10 description:
External ssl_client for busybox wget

ssl_client-1.37.0-r10 webpage:
https://busybox.net/

ssl_client-1.37.0-r10 installed size:
14 KiB

ssl_client-1.37.0-r10 license:
GPL-2.0-only
