...
- Created: `2021-11-19T01:40:37.132408725Z`
...
```console
busybox-1.34.1-r2 description:
Size optimized toolbox of many common UNIX utilities

busybox-1.34.1-r2 webpage:
https://busybox.net/

busybox-1.34.1-r2 installed size:
924 KiB

busybox-1.34.1-r2 license:
GPL-2.0-only
...
```console
libcrypto1.1-1.1.1l-r5 description:
Crypto library from openssl

libcrypto1.1-1.1.1l-r5 webpage:
https://www.openssl.org/

libcrypto1.1-1.1.1l-r5 installed size:
2676 KiB

libcrypto1.1-1.1.1l-r5 license:
OpenSSL
...
```console
libssl1.1-1.1.1l-r5 description:
SSL shared libraries

libssl1.1-1.1.1l-r5 webpage:
https://www.openssl.org/

libssl1.1-1.1.1l-r5 installed size:
528 KiB

libssl1.1-1.1.1l-r5 license:
OpenSSL
...
```console
ssl_client-1.34.1-r2 description:
EXternal ssl_client for busybox wget

ssl_client-1.34.1-r2 webpage:
https://busybox.net/

ssl_client-1.34.1-r2 installed size:
28 KiB

ssl_client-1.34.1-r2 license:
GPL-2.0-only
