...
- Image ID: `sha256:664252b141391b3b1d48d26b1a3762b294f830ea59bc9ca4947c5ee510399d03`
- Created: `2025-07-08T13:49:16Z`
- Virtual Size: ~ 519.14 Mb  
...
### `dpkg` source package: `iputils=3:20221126-1+deb12u1`
...
```console
$ apt-get source -qq --print-uris iputils=3:20221126-1+deb12u1
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20221126-1%2bdeb12u1.dsc' iputils_20221126-1+deb12u1.dsc 2211 SHA256:570f4053315d3c5dcaed6d0902dc9302581c29023eea805dc92bc34199192f07
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20221126.orig.tar.xz' iputils_20221126.orig.tar.xz 431024 SHA256:250f361352dcd6ae0cb21fc4589381c6202084ddceee4691a899cae4360253d1
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20221126-1%2bdeb12u1.debian.tar.xz' iputils_20221126-1+deb12u1.debian.tar.xz 11876 SHA256:028568563e037c0a5631c63dfe04e5a2649bbbb867b36bd772aa0290b3e1cab8
```

Other potentially useful URLs:

- https://sources.debian.net/src/iputils/3:20221126-1+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/iputils/3:20221126-1+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/iputils/3:20221126-1+deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `net-snmp=5.9.3+dfsg-2`

Binary Packages:

- `libsnmp-base=5.9.3+dfsg-2`
- `libsnmp40:amd64=5.9.3+dfsg-2`
- `snmp=5.9.3+dfsg-2`

Licenses: (parsed from: `/usr/share/doc/libsnmp-base/copyright`, `/usr/share/doc/libsnmp40/copyright`, `/usr/share/doc/snmp/copyright`)
...
```console
$ apt-get source -qq --print-uris net-snmp=5.9.3+dfsg-2
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9.3%2bdfsg-2.dsc' net-snmp_5.9.3+dfsg-2.dsc 2599 SHA256:5bd7c146c906af3a337a233601f3f65dcb2bf63430c00ea9571e5b3f661f2823
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9.3%2bdfsg.orig.tar.xz' net-snmp_5.9.3+dfsg.orig.tar.xz 3545096 SHA256:b78f93276a80d40726d94956aa7d06fd8752b5c0624af5bbf155cbc33fd521d1
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9.3%2bdfsg-2.debian.tar.xz' net-snmp_5.9.3+dfsg-2.debian.tar.xz 70072 SHA256:8ae27b57cebe5688df9c802865cd6fcf349cde9ac758a621b3d0ba9fe446521b
```

Other potentially useful URLs:

- https://sources.debian.net/src/net-snmp/5.9.3+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/net-snmp/5.9.3+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/net-snmp/5.9.3+dfsg-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pci.ids=0.0~2023.04.11-1`
...
```console
$ apt-get source -qq --print-uris pci.ids=0.0~2023.04.11-1
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2023.04.11-1.dsc' pci.ids_0.0~2023.04.11-1.dsc 1908 SHA256:18c23efcbcd6643adcdb7be7ef31719f0f8071619e821e9af4366f65aaaa72c4
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2023.04.11.orig.tar.xz' pci.ids_0.0~2023.04.11.orig.tar.xz 238928 SHA256:7fbd22074007079d24500c9b79901ec6303203edbe5657eb727f16c1065d85e8
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2023.04.11-1.debian.tar.xz' pci.ids_0.0~2023.04.11-1.debian.tar.xz 4712 SHA256:193762c09f6de9952639aa9c95ee490b7f52ffd433be580b9d020cc56c323106
```

Other potentially useful URLs:

- https://sources.debian.net/src/pci.ids/0.0~2023.04.11-1/ (for browsing the source)
- https://sources.debian.net/src/pci.ids/0.0~2023.04.11-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pci.ids/0.0~2023.04.11-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `pciutils=1:3.9.0-4`

Binary Packages:

- `libpci3:amd64=1:3.9.0-4`

Licenses: (parsed from: `/usr/share/doc/libpci3/copyright`)
...
```console
$ apt-get source -qq --print-uris pciutils=1:3.9.0-4
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.9.0-4.dsc' pciutils_3.9.0-4.dsc 2589 SHA256:b605cd0cfb3e56ebfbc60af4a72aec3d6d60ce514ae2ebd9a8e2e84e61c2aeda
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.9.0.orig.tar.gz' pciutils_3.9.0.orig.tar.gz 908219 SHA256:8953a785b2e3af414434b8fdcbfb75c90758819631001e60dd3afb89b22b2331
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.9.0.orig.tar.gz.asc' pciutils_3.9.0.orig.tar.gz.asc 228 SHA256:e1f32991072cc621d99a2437a923af09951cf1ad95e578a359b4e486cf641d58
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.9.0-4.debian.tar.xz' pciutils_3.9.0-4.debian.tar.xz 19704 SHA256:8fa19682a52543b1d4f613099ead5bdf0eee42b84003626625801bb05ed564a5
```

Other potentially useful URLs:

- https://sources.debian.net/src/pciutils/1:3.9.0-4/ (for browsing the source)
- https://sources.debian.net/src/pciutils/1:3.9.0-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pciutils/1:3.9.0-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tcp-wrappers=7.6.q-32`
...
```console
$ apt-get source -qq --print-uris tcp-wrappers=7.6.q-32
'http://deb.debian.org/debian/pool/main/t/tcp-wrappers/tcp-wrappers_7.6.q-32.dsc' tcp-wrappers_7.6.q-32.dsc 1390 SHA256:c9620a45e897c786b99890b54c6ea916df2380b6f3260e1e6442a1f8b5066997
...
'http://deb.debian.org/debian/pool/main/t/tcp-wrappers/tcp-wrappers_7.6.q-32.debian.tar.xz' tcp-wrappers_7.6.q-32.debian.tar.xz 38040 SHA256:deec7966808407ddcb11581380c7253c348bd8780da6c9ee17fa9e7a729539fe
```

Other potentially useful URLs:

- https://sources.debian.net/src/tcp-wrappers/7.6.q-32/ (for browsing the source)
...
### `dpkg` source package: `telegraf=1.33.3-1`
