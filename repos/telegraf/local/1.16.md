...
- Created: `2021-02-10T05:12:34.811293598Z`
- Virtual Size: ~ 278.87 Mb  
...
### `dpkg` source package: `net-snmp=5.7.3+dfsg-5+deb10u2`

Binary Packages:

- `libsnmp-base=5.7.3+dfsg-5+deb10u2`
- `libsnmp30:amd64=5.7.3+dfsg-5+deb10u2`
...
```console
$ apt-get source -qq --print-uris net-snmp=5.7.3+dfsg-5+deb10u2
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.7.3+dfsg-5+deb10u2.dsc' net-snmp_5.7.3+dfsg-5+deb10u2.dsc 3000 SHA256:7ac3606171332d2a3f0725d1862494d317588eeee9cd96c6b0a9c7852c075968
...
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.7.3+dfsg-5+deb10u2.debian.tar.xz' net-snmp_5.7.3+dfsg-5+deb10u2.debian.tar.xz 83716 SHA256:a176612ac83e2b80e64a17a605c74b259b0eca3eaeb77ab6b17dd04d23e1b7be
```

Other potentially useful URLs:

- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-5+deb10u2/ (for browsing the source)
- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-5+deb10u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/net-snmp/5.7.3+dfsg-5+deb10u2/ (for access to the source package after it no longer exists in the archive)
