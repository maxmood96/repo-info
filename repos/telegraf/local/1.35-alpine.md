...
```console
iputils-20240905-r0 description:
IP Configuration Utilities

iputils-20240905-r0 webpage:
https://github.com/iputils/iputils/

iputils-20240905-r0 installed size:
0 B

iputils-20240905-r0 license:
...
```console
iputils-arping-20240905-r0 description:
IP Configuration Utilities (arping utility)

iputils-arping-20240905-r0 webpage:
https://github.com/iputils/iputils/

iputils-arping-20240905-r0 installed size:
25 KiB

iputils-arping-20240905-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-clockdiff-20240905-r0 description:
IP Configuration Utilities (clockdiff utility)

iputils-clockdiff-20240905-r0 webpage:
https://github.com/iputils/iputils/

iputils-clockdiff-20240905-r0 installed size:
21 KiB

iputils-clockdiff-20240905-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-ping-20240905-r0 description:
IP Configuration Utilities (ping utility)

iputils-ping-20240905-r0 webpage:
https://github.com/iputils/iputils/

iputils-ping-20240905-r0 installed size:
139 KiB

iputils-ping-20240905-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-tracepath-20240905-r0 description:
IP Configuration Utilities (tracepath utility)

iputils-tracepath-20240905-r0 webpage:
https://github.com/iputils/iputils/

iputils-tracepath-20240905-r0 installed size:
17 KiB

iputils-tracepath-20240905-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
net-snmp-agent-libs-5.9.4-r1 description:
The NET-SNMP runtime agent libraries

net-snmp-agent-libs-5.9.4-r1 webpage:
http://www.net-snmp.org/

net-snmp-agent-libs-5.9.4-r1 installed size:
1668 KiB

net-snmp-agent-libs-5.9.4-r1 license:
Net-SNMP
...
```console
net-snmp-libs-5.9.4-r1 description:
The NET-SNMP runtime client libraries

net-snmp-libs-5.9.4-r1 webpage:
http://www.net-snmp.org/

net-snmp-libs-5.9.4-r1 installed size:
2322 KiB

net-snmp-libs-5.9.4-r1 license:
Net-SNMP
...
```console
net-snmp-tools-5.9.4-r1 description:
Network management utilities using SNMP

net-snmp-tools-5.9.4-r1 webpage:
http://www.net-snmp.org/

net-snmp-tools-5.9.4-r1 installed size:
459 KiB

net-snmp-tools-5.9.4-r1 license:
Net-SNMP
