...
- Created: `2021-01-15T03:39:46.028563493Z`
...
```console
net-snmp-agent-libs-5.9-r1 description:
The NET-SNMP runtime agent libraries

net-snmp-agent-libs-5.9-r1 webpage:
http://www.net-snmp.org/

net-snmp-agent-libs-5.9-r1 installed size:
1724416

net-snmp-agent-libs-5.9-r1 license:
GPL
...
```console
net-snmp-libs-5.9-r1 description:
The NET-SNMP runtime client libraries

net-snmp-libs-5.9-r1 webpage:
http://www.net-snmp.org/

net-snmp-libs-5.9-r1 installed size:
2564096

net-snmp-libs-5.9-r1 license:
GPL
...
```console
net-snmp-tools-5.9-r1 description:
Network management utilities using SNMP

net-snmp-tools-5.9-r1 webpage:
http://www.net-snmp.org/

net-snmp-tools-5.9-r1 installed size:
532480

net-snmp-tools-5.9-r1 license:
GPL
