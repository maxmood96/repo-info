...
```console
iputils-20240117-r0 description:
IP Configuration Utilities

iputils-20240117-r0 webpage:
https://github.com/iputils/iputils/

iputils-20240117-r0 installed size:
4096 B

iputils-20240117-r0 license:
...
```console
iputils-arping-20240117-r0 description:
IP Configuration Utilities (arping utility)

iputils-arping-20240117-r0 webpage:
https://github.com/iputils/iputils/

iputils-arping-20240117-r0 installed size:
40 KiB

iputils-arping-20240117-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-clockdiff-20240117-r0 description:
IP Configuration Utilities (clockdiff utility)

iputils-clockdiff-20240117-r0 webpage:
https://github.com/iputils/iputils/

iputils-clockdiff-20240117-r0 installed size:
36 KiB

iputils-clockdiff-20240117-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-ping-20240117-r0 description:
IP Configuration Utilities (ping utility)

iputils-ping-20240117-r0 webpage:
https://github.com/iputils/iputils/

iputils-ping-20240117-r0 installed size:
84 KiB

iputils-ping-20240117-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-tracepath-20240117-r0 description:
IP Configuration Utilities (tracepath utility)

iputils-tracepath-20240117-r0 webpage:
https://github.com/iputils/iputils/

iputils-tracepath-20240117-r0 installed size:
32 KiB

iputils-tracepath-20240117-r0 license:
BSD-3-Clause AND GPL-2.0-or-later
