...
- Created: `2024-02-21T01:01:45.45890268Z`
- Virtual Size: ~ 243.59 Mb  
...
```console
iputils-20221126-r2 description:
IP Configuration Utilities

iputils-20221126-r2 webpage:
https://github.com/iputils/iputils/

iputils-20221126-r2 installed size:
4096 B

iputils-20221126-r2 license:
...
```console
iputils-arping-20221126-r2 description:
IP Configuration Utilities (arping utility)

iputils-arping-20221126-r2 webpage:
https://github.com/iputils/iputils/

iputils-arping-20221126-r2 installed size:
40 KiB

iputils-arping-20221126-r2 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-clockdiff-20221126-r2 description:
IP Configuration Utilities (clockdiff utility)

iputils-clockdiff-20221126-r2 webpage:
https://github.com/iputils/iputils/

iputils-clockdiff-20221126-r2 installed size:
36 KiB

iputils-clockdiff-20221126-r2 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-ping-20221126-r2 description:
IP Configuration Utilities (ping utility)

iputils-ping-20221126-r2 webpage:
https://github.com/iputils/iputils/

iputils-ping-20221126-r2 installed size:
80 KiB

iputils-ping-20221126-r2 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
iputils-tracepath-20221126-r2 description:
IP Configuration Utilities (tracepath utility)

iputils-tracepath-20221126-r2 webpage:
https://github.com/iputils/iputils/

iputils-tracepath-20221126-r2 installed size:
32 KiB

iputils-tracepath-20221126-r2 license:
BSD-3-Clause AND GPL-2.0-or-later
...
```console
libcap-2.69-r1 description:
POSIX 1003.1e capabilities

libcap-2.69-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-2.69-r1 installed size:
12 KiB

libcap-2.69-r1 license:
...
```console
libcap-getcap-2.69-r1 description:
POSIX 1003.1e capabilities (getcap utility)

libcap-getcap-2.69-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-getcap-2.69-r1 installed size:
28 KiB

libcap-getcap-2.69-r1 license:
BSD-3-Clause OR GPL-2.0-only
...
```console
libcap-setcap-2.69-r1 description:
POSIX 1003.1e capabilities (setcap utility)

libcap-setcap-2.69-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-setcap-2.69-r1 installed size:
28 KiB

libcap-setcap-2.69-r1 license:
BSD-3-Clause OR GPL-2.0-only
...
```console
libcap-utils-2.69-r1 description:
POSIX 1003.1e capabilities (extra utils)

libcap-utils-2.69-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-utils-2.69-r1 installed size:
76 KiB

libcap-utils-2.69-r1 license:
BSD-3-Clause OR GPL-2.0-only
...
```console
net-snmp-agent-libs-5.9.4-r0 description:
The NET-SNMP runtime agent libraries

net-snmp-agent-libs-5.9.4-r0 webpage:
http://www.net-snmp.org/

net-snmp-agent-libs-5.9.4-r0 installed size:
1692 KiB

net-snmp-agent-libs-5.9.4-r0 license:
Net-SNMP
...
```console
net-snmp-libs-5.9.4-r0 description:
The NET-SNMP runtime client libraries

net-snmp-libs-5.9.4-r0 webpage:
http://www.net-snmp.org/

net-snmp-libs-5.9.4-r0 installed size:
2504 KiB

net-snmp-libs-5.9.4-r0 license:
Net-SNMP
...
```console
net-snmp-tools-5.9.4-r0 description:
Network management utilities using SNMP

net-snmp-tools-5.9.4-r0 webpage:
http://www.net-snmp.org/

net-snmp-tools-5.9.4-r0 installed size:
520 KiB

net-snmp-tools-5.9.4-r0 license:
Net-SNMP
