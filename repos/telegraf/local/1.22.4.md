...
- Created: `2022-10-05T23:03:06.128794791Z`
...
### `dpkg` source package: `iputils=3:20210202-1`
...
```console
$ apt-get source -qq --print-uris iputils=3:20210202-1
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20210202-1.dsc' iputils_20210202-1.dsc 2169 SHA256:ab8b0a4bb6872f48dbc22c60b26018d86d431222c3f04cb35b08319f505d364c
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20210202.orig.tar.xz' iputils_20210202.orig.tar.xz 441832 SHA256:685e2b20bd1088d03f12c1aa8e400bf488600f158dd56ec046dc68aed251fc9a
'http://deb.debian.org/debian/pool/main/i/iputils/iputils_20210202-1.debian.tar.xz' iputils_20210202-1.debian.tar.xz 10404 SHA256:b19c9a31c4b4562e983d6d6a84daddf7f8fd89f07e44dc9e729d91af024e788c
```

Other potentially useful URLs:

- https://sources.debian.net/src/iputils/3:20210202-1/ (for browsing the source)
- https://sources.debian.net/src/iputils/3:20210202-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/iputils/3:20210202-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `net-snmp=5.9+dfsg-4+deb11u1`
...
```console
$ apt-get source -qq --print-uris net-snmp=5.9+dfsg-4+deb11u1
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9%2bdfsg-4%2bdeb11u1.dsc' net-snmp_5.9+dfsg-4+deb11u1.dsc 2851 SHA256:88e406faab0274693e443e064208f2e12e8fe99d8ead45170aec3572aff2e64b
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9%2bdfsg.orig.tar.xz' net-snmp_5.9+dfsg.orig.tar.xz 3513780 SHA256:a153d0e867ded287285335e5055e67e0177959315f02ae6995401ddf9b10c8e8
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.9%2bdfsg-4%2bdeb11u1.debian.tar.xz' net-snmp_5.9+dfsg-4+deb11u1.debian.tar.xz 69952 SHA256:3f2e8d4ac4c6ae7550c101923c169d6bddc9e1e01053ed6bc7ad86b807426dff
```

Other potentially useful URLs:

- https://sources.debian.net/src/net-snmp/5.9+dfsg-4+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/net-snmp/5.9+dfsg-4+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/net-snmp/5.9+dfsg-4+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pci.ids=0.0~2021.02.08-1`
...
```console
$ apt-get source -qq --print-uris pci.ids=0.0~2021.02.08-1
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2021.02.08-1.dsc' pci.ids_0.0~2021.02.08-1.dsc 1908 SHA256:1ac97e1afcd25e5221d731d6239c10b9d2cf383f978733b605ecbe92dcdce232
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2021.02.08.orig.tar.xz' pci.ids_0.0~2021.02.08.orig.tar.xz 221268 SHA256:dd0784ad3adea87e07b863e4d980c33d586c430ec5238bd9822949cdf8ccba44
'http://deb.debian.org/debian/pool/main/p/pci.ids/pci.ids_0.0%7e2021.02.08-1.debian.tar.xz' pci.ids_0.0~2021.02.08-1.debian.tar.xz 3904 SHA256:daf9579bb65b47fef92eb0d2106ebe54e914180c064ce4b28d6f7e6985e44327
```

Other potentially useful URLs:

- https://sources.debian.net/src/pci.ids/0.0~2021.02.08-1/ (for browsing the source)
- https://sources.debian.net/src/pci.ids/0.0~2021.02.08-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pci.ids/0.0~2021.02.08-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `pciutils=1:3.7.0-5`
...
```console
$ apt-get source -qq --print-uris pciutils=1:3.7.0-5
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.7.0-5.dsc' pciutils_3.7.0-5.dsc 2515 SHA256:4c0cfe792e843e1387acc093ef60bf4151f641866479dfe26757528341893207
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.7.0.orig.tar.gz' pciutils_3.7.0.orig.tar.gz 516418 SHA256:08c27e01030d1fcc700d02bc2ea66c638f58a3d150e45e58852aa82ad4160d84
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.7.0.orig.tar.gz.asc' pciutils_3.7.0.orig.tar.gz.asc 833 SHA256:f1c3ef27541bba787c1a12d96580cf4df0c169783b12eea5ca36717970eeba6b
'http://deb.debian.org/debian/pool/main/p/pciutils/pciutils_3.7.0-5.debian.tar.xz' pciutils_3.7.0-5.debian.tar.xz 21428 SHA256:910b5955d54e42ee4073534f60716c4f5ca2ac4470b99b2be02a98ccfb18239e
```

Other potentially useful URLs:

- https://sources.debian.net/src/pciutils/1:3.7.0-5/ (for browsing the source)
- https://sources.debian.net/src/pciutils/1:3.7.0-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pciutils/1:3.7.0-5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `telegraf=1.22.4-1`
