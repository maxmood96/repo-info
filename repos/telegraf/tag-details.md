...
```console
$ docker pull telegraf@sha256:db27f6c463fdb2dd169ca7360b6d1df7565df77e0df913bdba37a36185a549da
```
...
```console
$ docker pull telegraf@sha256:7a9c108053b38d6f083cf5b139a3d99fbe415ea48c4862ec2425fcc26da0f1fe
```
