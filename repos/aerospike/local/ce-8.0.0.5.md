...
- Created: `2025-02-25T21:03:12Z`
- Virtual Size: ~ 209.31 Mb  
...
- Labels:
  ...
  - `org.opencontainers.image.version=8.0.0.5`
...
### `dpkg` source package: `aerospike-server-community=8.0.0.5-1`

Binary Packages:

- `aerospike-server-community=8.0.0.5-1`
