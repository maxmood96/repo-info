...
- Created: `2021-12-02T03:37:53.852902652Z`
...
### `dpkg` source package: `gettext=0.19.8.1-9`
...
```console
$ apt-get source -qq --print-uris gettext=0.19.8.1-9
'http://deb.debian.org/debian/pool/main/g/gettext/gettext_0.19.8.1-9.dsc' gettext_0.19.8.1-9.dsc 2011 SHA256:1854346197e167b6ac7eaa3cc0630cbfcad4b47c21980f045ee5c82fe37f9593
...
'http://deb.debian.org/debian/pool/main/g/gettext/gettext_0.19.8.1-9.debian.tar.xz' gettext_0.19.8.1-9.debian.tar.xz 32792 SHA256:646bee2ac7de6d6c8e64a612a03abaf9dab116671ec258199671894e90faf73e
```

Other potentially useful URLs:

- https://sources.debian.net/src/gettext/0.19.8.1-9/ (for browsing the source)
- https://sources.debian.net/src/gettext/0.19.8.1-9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gettext/0.19.8.1-9/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `linux-atm=1:2.5.1-2`
...
```console
$ apt-get source -qq --print-uris linux-atm=1:2.5.1-2
'http://deb.debian.org/debian/pool/main/l/linux-atm/linux-atm_2.5.1-2.dsc' linux-atm_2.5.1-2.dsc 1935 SHA256:f703e5f6b48b17e9d0f20df9495d997e920c432a61f26d24310066ed9f781120
...
'http://deb.debian.org/debian/pool/main/l/linux-atm/linux-atm_2.5.1-2.debian.tar.xz' linux-atm_2.5.1-2.debian.tar.xz 10516 SHA256:8f06851b9093f5896cbe6916b89e8891adf9caa3856e6684587627e78a33248a
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux-atm/1:2.5.1-2/ (for browsing the source)
- https://sources.debian.net/src/linux-atm/1:2.5.1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux-atm/1:2.5.1-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `psmisc=23.2-1+deb10u1`
...
```console
$ apt-get source -qq --print-uris psmisc=23.2-1+deb10u1
'http://deb.debian.org/debian/pool/main/p/psmisc/psmisc_23.2-1+deb10u1.dsc' psmisc_23.2-1+deb10u1.dsc 1412 SHA256:39024e645e6afcefc5c37db8e0b4e9b70f103eaf380dbba4fac5df1d1096990a
...
'http://deb.debian.org/debian/pool/main/p/psmisc/psmisc_23.2-1+deb10u1.debian.tar.xz' psmisc_23.2-1+deb10u1.debian.tar.xz 8120 SHA256:5b1b34899292a56ebac3ce26393187ebc2cca19f810db754f0c0a396e1f496b0
```

Other potentially useful URLs:

- https://sources.debian.net/src/psmisc/23.2-1+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/psmisc/23.2-1+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/psmisc/23.2-1+deb10u1/ (for access to the source package after it no longer exists in the archive)
