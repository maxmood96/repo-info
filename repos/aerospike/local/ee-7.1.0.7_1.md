...
- Labels:
  ...
  - `org.opencontainers.image.version=7.1.0.7`
...
### `dpkg` source package: `aerospike-server-enterprise=7.1.0.7-1`

Binary Packages:

- `aerospike-server-enterprise=7.1.0.7-1`
