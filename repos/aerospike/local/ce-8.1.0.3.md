...
- Created: `2026-01-15T22:08:13.803108951Z`
- Virtual Size: ~ 203.60 Mb  
...
- Labels:
  ...
  - `org.opencontainers.image.version=8.1.0.3`
...
### `dpkg` source package: `aerospike-server-community=8.1.0.3-1`

Binary Packages:

- `aerospike-server-community=8.1.0.3-1`
