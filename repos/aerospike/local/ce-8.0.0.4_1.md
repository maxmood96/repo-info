...
- Labels:
  ...
  - `org.opencontainers.image.version=8.0.0.4`
...
### `dpkg` source package: `aerospike-server-community=8.0.0.4-1`

Binary Packages:

- `aerospike-server-community=8.0.0.4-1`
