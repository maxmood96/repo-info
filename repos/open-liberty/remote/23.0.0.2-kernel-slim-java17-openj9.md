...
### `open-liberty:23.0.0.2-kernel-slim-java17-openj9` - linux; amd64
...
### `open-liberty:23.0.0.2-kernel-slim-java17-openj9` - linux; ppc64le
...
### `open-liberty:23.0.0.2-kernel-slim-java17-openj9` - linux; s390x
