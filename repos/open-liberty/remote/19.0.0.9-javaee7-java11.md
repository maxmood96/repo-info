...
```console
$ docker pull open-liberty@sha256:6268b3394a19f192bdea0ee6537b9d4dedf81a9a94156a67bc53561a866cb12c
```
...
```console
$ docker pull open-liberty@sha256:10649331224c02a150ab07777465fe5a9ebf4bad2c171e013da44648024538a5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.2 MB (234175020 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:308742bc5b6f52c7c80dd2768933787ecb019cd52def4a312873be14b9c0cbd7`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:8e29e2ce687c67618334d9369c765b222eadd52a256a74f1f1d014bb1c520a49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdfe0537ce5c90c839ce5dffa0a5c87fd7f14aae92cd06f136e7e7ec649c02ad`  
		Last Modified: Thu, 19 Dec 2019 12:28:46 GMT  
		Size: 902.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
