...
```console
$ docker pull open-liberty@sha256:9720f5b080943cd0885b34b95162fbc045bd1f3e8d2203e2df1d0fffd374d38c
```
...
```console
$ docker pull open-liberty@sha256:3d7e32fe2fa25ac6df3cd8fd306887381c20102f038165c06684abfadffdfee0
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.2 MB (234174658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e85eaba7141bb74453e6dc688fb9e01fb6d2629d4dea57ef5b73ca8e5909826`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:8e29e2ce687c67618334d9369c765b222eadd52a256a74f1f1d014bb1c520a49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc721d90fa17d46c6979cb2413a22d3d78a24fb990433b9b6b1cdc98faade939`  
		Last Modified: Thu, 19 Dec 2019 12:29:16 GMT  
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
