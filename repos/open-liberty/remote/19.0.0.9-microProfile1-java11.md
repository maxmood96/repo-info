...
```console
$ docker pull open-liberty@sha256:02a3e0102fab0888a8863311fd6f2cf8ca7083d6906b237671397f84ad896e53
```
...
```console
$ docker pull open-liberty@sha256:dfe3e52341db40cdd5713df7cc1292603c1b5c6a01b8bbeef643f2eca22e7ec8
```
...
-	Layers:
	...
	-	`sha256:28e39266d50b6e5df3bc9e2e57ba247beca6487f9872d74244a8a994977d15b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b0af3980316628d8141bd2e9b4dd598068597dcc2e7c7894671eb4bf8620091`  
		Last Modified: Thu, 19 Dec 2019 10:17:12 GMT  
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull open-liberty@sha256:4e1ce18ce61442338c6fc4bab0d7e6bdbbd3681254446b15cdc067bf995eee98
```
...
-	Total Size: **234.2 MB (234174667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6db7deeafc7546858b671eddbdefa1fa0e0d380254ae9ec435112353f4bc1ad`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:8e29e2ce687c67618334d9369c765b222eadd52a256a74f1f1d014bb1c520a49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9bbcb92c6462aada83d11cd67184f7f7b335123db2f6ec6cac32b33be6474a0`  
		Last Modified: Thu, 19 Dec 2019 12:26:29 GMT  
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
