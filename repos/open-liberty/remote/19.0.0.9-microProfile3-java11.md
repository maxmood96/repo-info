...
```console
$ docker pull open-liberty@sha256:1ef8dc31140d93ffc3e8608abb98295cc876de7129cc3143546b1bb9acc03f53
```
...
```console
$ docker pull open-liberty@sha256:a72f84b8c320dfa5467be21f12dc7d7d25c1174544fb374d55e85fa8eb005666
```
...
-	Layers:
	...
	-	`sha256:28e39266d50b6e5df3bc9e2e57ba247beca6487f9872d74244a8a994977d15b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b32e08029fab6ee739999448876e41dfcf4309881f8c1f2e28fcf3e34f310584`  
...
```console
$ docker pull open-liberty@sha256:0edb2ce93cf5fa58cacf4350d937f99b33396906ffa0e0f76928266df6f2ad9e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.2 MB (234174668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:519ccf45de3a2faa20f788c62959ac080d09e10bba3a4daa2db57e8f7b058de3`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:8e29e2ce687c67618334d9369c765b222eadd52a256a74f1f1d014bb1c520a49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cc918db44c086a893877ab54b975fb9b1fd9707ac584e4276470dc7740e7f3b`  
		Last Modified: Thu, 19 Dec 2019 12:27:27 GMT  
		Size: 550.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
