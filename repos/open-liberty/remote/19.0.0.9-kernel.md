...
```console
$ docker pull open-liberty@sha256:cc6819961e04b13da1e6d126fdbb19b646f2bd9e74a1ef57819fd4a2ade8f54f
```
...
```console
$ docker pull open-liberty@sha256:f7df378f81c10bfc6fc6ddcb4161dd7e46a5d57d3538ddf92d1ad9cee4a18e03
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.4 MB (295408551 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:646477f1623579f3f4176b4ed5adcb6ec4c916b2bb6e2bbdd20c01b8af55284c`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
```console
$ docker pull open-liberty@sha256:a9a129acde21e219bcc579c3bd18a313e0cf83703eea4a809b408d07937d37b7
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.2 MB (323232362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29b73145943a270feaf166f5cf2c9143e23100aece8357fe875fd0d91ef37669`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
