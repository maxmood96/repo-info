...
### `open-liberty:22.0.0.1-kernel-slim-java17-openj9` - linux; amd64
...
### `open-liberty:22.0.0.1-kernel-slim-java17-openj9` - linux; ppc64le
...
### `open-liberty:22.0.0.1-kernel-slim-java17-openj9` - linux; s390x
