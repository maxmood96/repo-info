...
### `open-liberty:22.0.0.11-kernel-slim-java11-openj9` - linux; amd64
...
### `open-liberty:22.0.0.11-kernel-slim-java11-openj9` - linux; ppc64le
...
### `open-liberty:22.0.0.11-kernel-slim-java11-openj9` - linux; s390x
