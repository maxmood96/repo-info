...
- Created: `2026-01-27T20:57:09.432458084Z`
- Virtual Size: ~ 330.48 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/opt/ol/helpers/runtime/docker-server.sh"]`
- Command: `["/opt/ol/wlp/bin/server","run","defaultServer"]`
- Environment:
  - `PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/ol/wlp/bin:/opt/ol/helpers/build:/opt/ol/helpers/runtime`
  - `LANG=en_US.UTF-8`
  - `LANGUAGE=en_US:en`
  - `LC_ALL=en_US.UTF-8`
  - `JAVA_VERSION=jdk-11.0.29+7_openj9-0.56.0`
...
- Labels:
  - `io.openliberty.version=26.0.0.1`
  ...
  - `org.opencontainers.image.revision=cl260120260112-1902`
  - `org.opencontainers.image.source=https://github.com/OpenLiberty/ci.docker`
  - `org.opencontainers.image.title=Open Liberty`
  - `org.opencontainers.image.url=https://openliberty.io/`
  - `org.opencontainers.image.vendor=Open Liberty`
  - `org.opencontainers.image.version=26.0.0.1`
