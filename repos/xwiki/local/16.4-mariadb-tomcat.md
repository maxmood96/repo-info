...
- Environment:
  ...
  - `MARIADB_JDBC_VERSION=3.5.2`
  - `MARIADB_JDBC_SHA256=f2f3c3c1a3bdaca69dd1d4e1cd8aed075242fc72ae41463ddb82e367b388f6ad`
  - `MARIADB_JDBC_PREFIX=https://repo1.maven.org/maven2/org/mariadb/jdbc/mariadb-java-client/3.5.2`
  - `MARIADB_JDBC_ARTIFACT=mariadb-java-client-3.5.2.jar`
  - `MARIADB_JDBC_TARGET=/usr/local/tomcat/webapps/ROOT/WEB-INF/lib/mariadb-java-client-3.5.2.jar`
- Labels:
