...
```console
$ docker pull xwiki@sha256:4412b177ecf0bc1af5b68f7575a242b2d4905d82fe8bc180649ac034d8396834
```
...
### `xwiki:18.5-mariadb-tomcat` - linux; arm64 variant v8
...
### `xwiki:18.5-mariadb-tomcat` - unknown; unknown
