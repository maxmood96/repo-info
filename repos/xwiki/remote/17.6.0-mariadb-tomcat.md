...
### `xwiki:17.6.0-mariadb-tomcat` - linux; amd64
...
### `xwiki:17.6.0-mariadb-tomcat` - unknown; unknown
...
### `xwiki:17.6.0-mariadb-tomcat` - linux; arm64 variant v8
