...
### `xwiki:16.3.1-postgres-tomcat` - linux; amd64
...
### `xwiki:16.3.1-postgres-tomcat` - unknown; unknown
...
### `xwiki:16.3.1-postgres-tomcat` - linux; arm64 variant v8
