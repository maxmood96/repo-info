...
### `xwiki:18.1-postgres-tomcat` - linux; amd64
...
### `xwiki:18.1-postgres-tomcat` - unknown; unknown
...
### `xwiki:18.1-postgres-tomcat` - linux; arm64 variant v8
