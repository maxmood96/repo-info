...
### `xwiki:15.10.9-mariadb-tomcat` - linux; amd64
...
### `xwiki:15.10.9-mariadb-tomcat` - unknown; unknown
...
### `xwiki:15.10.9-mariadb-tomcat` - linux; arm64 variant v8
