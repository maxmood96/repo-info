...
### `xwiki:16.3.1-mysql-tomcat` - linux; amd64
...
### `xwiki:16.3.1-mysql-tomcat` - unknown; unknown
...
### `xwiki:16.3.1-mysql-tomcat` - linux; arm64 variant v8
