...
### `xwiki:16.10.10-mysql-tomcat` - linux; amd64
...
### `xwiki:16.10.10-mysql-tomcat` - unknown; unknown
...
### `xwiki:16.10.10-mysql-tomcat` - linux; arm64 variant v8
