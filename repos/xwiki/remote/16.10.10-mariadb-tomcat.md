...
### `xwiki:16.10.10-mariadb-tomcat` - linux; amd64
...
### `xwiki:16.10.10-mariadb-tomcat` - unknown; unknown
...
### `xwiki:16.10.10-mariadb-tomcat` - linux; arm64 variant v8
