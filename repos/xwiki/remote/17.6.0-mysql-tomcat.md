...
### `xwiki:17.6.0-mysql-tomcat` - linux; amd64
...
### `xwiki:17.6.0-mysql-tomcat` - unknown; unknown
...
### `xwiki:17.6.0-mysql-tomcat` - linux; arm64 variant v8
