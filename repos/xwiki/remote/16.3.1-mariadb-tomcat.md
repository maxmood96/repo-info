...
### `xwiki:16.3.1-mariadb-tomcat` - linux; amd64
...
### `xwiki:16.3.1-mariadb-tomcat` - unknown; unknown
...
### `xwiki:16.3.1-mariadb-tomcat` - linux; arm64 variant v8
