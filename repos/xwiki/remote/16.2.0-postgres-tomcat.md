...
```console
$ docker pull xwiki@sha256:8ff43f7aa1cb6f84342e1cca78b1939002d831261285aa444f91d0240b94ebcf
```
...
### `xwiki:16.2.0-postgres-tomcat` - linux; amd64
...
### `xwiki:16.2.0-postgres-tomcat` - unknown; unknown
