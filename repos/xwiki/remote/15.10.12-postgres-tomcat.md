...
```console
$ docker pull xwiki@sha256:7ea1e5a1a62cf9cbcd7a6a7450adc9b19a505d11977b7611d7fd7f59e5729b11
```
...
### `xwiki:15.10.12-postgres-tomcat` - linux; arm64 variant v8
...
### `xwiki:15.10.12-postgres-tomcat` - unknown; unknown
