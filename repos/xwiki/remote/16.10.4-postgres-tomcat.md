...
```console
$ docker pull xwiki@sha256:8890dbbfe9f49f9398c8ff4b9d9b5d9eb86956160cc99f73df1b31cce6b01065
```
...
### `xwiki:16.10.4-postgres-tomcat` - linux; arm64 variant v8
...
### `xwiki:16.10.4-postgres-tomcat` - unknown; unknown
