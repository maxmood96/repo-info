...
### `xwiki:17.10.3-postgres-tomcat` - linux; amd64
...
### `xwiki:17.10.3-postgres-tomcat` - unknown; unknown
...
### `xwiki:17.10.3-postgres-tomcat` - linux; arm64 variant v8
