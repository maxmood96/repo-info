...
```console
$ docker pull xwiki@sha256:a13ea3b31c555355006f21629d9983117d2107ebad9362a62a9fca78b99df7a4
```
...
### `xwiki:16.6-mysql-tomcat` - linux; amd64
...
### `xwiki:16.6-mysql-tomcat` - unknown; unknown
