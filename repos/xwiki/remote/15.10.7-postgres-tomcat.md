...
### `xwiki:15.10.7-postgres-tomcat` - linux; amd64
...
### `xwiki:15.10.7-postgres-tomcat` - unknown; unknown
...
### `xwiki:15.10.7-postgres-tomcat` - linux; arm64 variant v8
