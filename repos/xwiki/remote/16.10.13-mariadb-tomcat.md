...
### `xwiki:16.10.13-mariadb-tomcat` - linux; amd64
...
### `xwiki:16.10.13-mariadb-tomcat` - unknown; unknown
...
### `xwiki:16.10.13-mariadb-tomcat` - linux; arm64 variant v8
