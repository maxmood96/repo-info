...
```console
$ docker pull xwiki@sha256:5073eb0410ab5697f0926d9e5bd33fb20a9d90f10caab3bbda49da085f5df0c9
```
...
### `xwiki:18.5-postgres-tomcat` - linux; arm64 variant v8
...
### `xwiki:18.5-postgres-tomcat` - unknown; unknown
