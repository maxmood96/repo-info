...
### `xwiki:17.6-postgres-tomcat` - linux; amd64
...
### `xwiki:17.6-postgres-tomcat` - unknown; unknown
...
### `xwiki:17.6-postgres-tomcat` - linux; arm64 variant v8
