...
### `xwiki:15.10.13-mysql-tomcat` - linux; amd64
...
### `xwiki:15.10.13-mysql-tomcat` - unknown; unknown
...
### `xwiki:15.10.13-mysql-tomcat` - linux; arm64 variant v8
