...
### `xwiki:15.10.9-postgres-tomcat` - linux; amd64
...
### `xwiki:15.10.9-postgres-tomcat` - unknown; unknown
...
### `xwiki:15.10.9-postgres-tomcat` - linux; arm64 variant v8
