...
```console
$ docker pull xwiki@sha256:2ba3ee4bfd168f2f5cb169fb37a40c6b9afe2d20b5f2164a28b48f9dffd8754b
```
...
```console
$ docker pull xwiki@sha256:2fe24062aefed36c9e7df277f21b307eb91975192b1e312cdf6d8e988b691112
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **592.2 MB (592187700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d10e8d4cbe0c247bc8faf96e73e66b82a6aad37c6c5de4d503e078cb24ada0d`
...
-	Layers:
	...
	-	`sha256:8243ab0f5c5ff2e1e4219296ff13e241ac0ba132cb2aa86e0c20d9d52435b6fa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83310fa4850a914ae2a502b07a4cc6b9cc0256425ff1f1fab62c7660d425aa14`  
		Last Modified: Mon, 25 Sep 2023 22:34:42 GMT  
		Size: 308.5 MB (308522700 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7bfe4c136918566f500b6fb5a4fbb8a55cb9899cd65d4f26d19176d95124705`  
		Last Modified: Mon, 25 Sep 2023 22:34:20 GMT  
		Size: 2.3 MB (2347556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce99ce2ee05f593b21d56926ed029ad4cec9c3df72f7d4c5aac2ab573fd4c24d`  
		Last Modified: Mon, 25 Sep 2023 22:34:20 GMT  
		Size: 1.3 KB (1345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81201592fc879821b58ade3756617498e4f2713dee06d42e0079108fab76f7fa`  
		Last Modified: Mon, 25 Sep 2023 22:34:20 GMT  
		Size: 2.3 KB (2311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9472c69acb9f43581b158d38b87af5da730c1411bdcf9ff4c83ebcbfc474983`  
		Last Modified: Mon, 25 Sep 2023 22:34:20 GMT  
		Size: 6.3 KB (6322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bb1de75a2a6d3f45eb5cf08379e7a7e55e56d876f70fbb79b4c4d62e0b45678`  
		Last Modified: Mon, 25 Sep 2023 22:34:20 GMT  
...
```console
$ docker pull xwiki@sha256:b8c56ffd09d283528ec3f5d16395a9c8749383f2d8def4c71c6ce067f4d14a89
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **583.5 MB (583457112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:043d70670aa611bfa9f38036717bf92eaf9e2043499a1135ca8216e02537fa98`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["xwiki"]`
...
RUN apt-get update &&   apt-get --no-install-recommends -y install     curl     libreoffice     unzip     procps &&   rm -rf /var/lib/apt/lists/*
# Mon, 25 Sep 2023 22:53:50 GMT
ENV XWIKI_VERSION=15.8
# Mon, 25 Sep 2023 22:53:50 GMT
ENV XWIKI_URL_PREFIX=https://maven.xwiki.org/releases/org/xwiki/platform/xwiki-platform-distribution-war/15.8
# Mon, 25 Sep 2023 22:53:51 GMT
ENV XWIKI_DOWNLOAD_SHA256=359e44485615722ab533559ec3e3334197a10935e4dfa6fc872b93d1447475fc
# Mon, 25 Sep 2023 22:54:31 GMT
RUN rm -rf /usr/local/tomcat/webapps/* &&   mkdir -p /usr/local/tomcat/temp &&   mkdir -p /usr/local/xwiki/data &&   curl -fSL "${XWIKI_URL_PREFIX}/xwiki-platform-distribution-war-${XWIKI_VERSION}.war" -o xwiki.war &&   echo "$XWIKI_DOWNLOAD_SHA256 xwiki.war" | sha256sum -c - &&   unzip -d /usr/local/tomcat/webapps/ROOT xwiki.war &&   rm -f xwiki.war
# Mon, 25 Sep 2023 22:54:33 GMT
ENV MYSQL_JDBC_VERSION=8.1.0
# Mon, 25 Sep 2023 22:54:33 GMT
ENV MYSQL_JDBC_SHA256=e2e657e9c5ebe06a73485c9739ebd8a18e7bebb852a58d0da287da850beca1c7
# Mon, 25 Sep 2023 22:54:33 GMT
...
# Mon, 25 Sep 2023 22:54:33 GMT
ENV MYSQL_JDBC_TARGET=/usr/local/tomcat/webapps/ROOT/WEB-INF/lib/mysql-connector-j-8.1.0.jar
# Mon, 25 Sep 2023 22:54:34 GMT
RUN curl -fSL "${MYSQL_JDBC_PREFIX}/${MYSQL_JDBC_ARTIFACT}" -o $MYSQL_JDBC_TARGET &&   echo "$MYSQL_JDBC_SHA256 $MYSQL_JDBC_TARGET" | sha256sum -c -
# Mon, 25 Sep 2023 22:54:34 GMT
COPY file:0a1be11e2eb610a1dbcd415404e3a592641110b93090030cb831e3a19a163017 in /usr/local/tomcat/bin/ 
# Mon, 25 Sep 2023 22:54:34 GMT
COPY file:1b8409986f3e4eb79a7a0b18472cb2692a61d504fb5ef34292bc997b79fd760d in /usr/local/tomcat/webapps/ROOT/WEB-INF/hibernate.cfg.xml 
# Mon, 25 Sep 2023 22:54:35 GMT
RUN sed -i 's/<id>org.xwiki.platform:xwiki-platform-distribution-war/<id>org.xwiki.platform:xwiki-platform-distribution-docker/'   /usr/local/tomcat/webapps/ROOT/META-INF/extension.xed
# Mon, 25 Sep 2023 22:54:35 GMT
COPY file:a47c4dcd87c9dad97aff38c49188357e6193bcad50757e516cfb08a60d4de611 in /usr/local/bin/docker-entrypoint.sh 
# Mon, 25 Sep 2023 22:54:35 GMT
...
-	Layers:
	...
	-	`sha256:7a0f291c51328d7044de62c9f8de2c8863b150fbecb842a556f8a94757ec2adc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df0adbcaeda0a3d9a2e2a332bbd40cbec33e6d38be41d97734222bdfadf22616`  
		Last Modified: Mon, 25 Sep 2023 22:56:31 GMT  
		Size: 308.5 MB (308522694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e33001419144a0bacdb753984371df5970485455e3d413f3e5a0ab2f1e18b9da`  
		Last Modified: Mon, 25 Sep 2023 22:56:06 GMT  
		Size: 2.3 MB (2347558 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6470f2ff5ff17e2a65901020e48263237fba8bb1c43bc892400102f7c7d96d4b`  
		Last Modified: Mon, 25 Sep 2023 22:56:06 GMT  
		Size: 1.3 KB (1344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe5cdb76b93c96f46b10e8c06fddb9ab6f9d868615a8b00136283de490d8004`  
		Last Modified: Mon, 25 Sep 2023 22:56:06 GMT  
		Size: 2.3 KB (2311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e4de2514b97d22d07ac494a7edea5e01637c593e2657077e57e387b44995da5`  
		Last Modified: Mon, 25 Sep 2023 22:56:05 GMT  
		Size: 6.3 KB (6320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:036121d805be79f2dcea894966c3f7690d69dd0276bbf77dd39c1ef1a93ba393`  
		Last Modified: Mon, 25 Sep 2023 22:56:06 GMT  
