...
```console
$ docker pull xwiki@sha256:42c849f5ea1549b508bdec7effaa74f23af50607fa224f2acf18aba61fdc16ab
```
...
### `xwiki:17.5-mariadb-tomcat` - linux; amd64
...
### `xwiki:17.5-mariadb-tomcat` - unknown; unknown
