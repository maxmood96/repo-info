...
- Created: `2022-03-31T02:12:06.38513585Z`
- Virtual Size: ~ 435.15 Mb  
...
- Environment:
  ...
  - `GOSU_VERSION=1.14`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.28-1.el8`
  - `MYSQL_SHELL_VERSION=8.0.28-1.el8`
...
### `rpm` package: `mysql-community-server-minimal-8.0.28-1.el8.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2021, Oracle and/or its affiliates. Under GPLv2 license as shown in the Description field.

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `mysql-shell-8.0.28-1.el8.x86_64`
...
### `rpm` package: `python39-libs-3.9.6-2.module+el8.5.0+20364+c7fe1181.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python39-pip-wheel-20.2.4-6.module+el8.5.0+20364+c7fe1181.noarch`
...
```console
$ dnf --quiet download --source --url python39-pip-wheel-20.2.4-6.module+el8.5.0+20364+c7fe1181.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-pip-20.2.4-6.module+el8.5.0+20364+c7fe1181.src.rpm
```
