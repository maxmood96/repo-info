...
```console
$ apt-get source -qq --print-uris libaio=0.3.112-3
'http://deb.debian.org/debian/pool/main/liba/libaio/libaio_0.3.112-3.dsc' libaio_0.3.112-3.dsc 1990 SHA256:d253b61d3edebc60b91575db13b66f03b7450cf676f4a7ce1d54e66b03f67a5c
...
'http://deb.debian.org/debian/pool/main/liba/libaio/libaio_0.3.112-3.debian.tar.xz' libaio_0.3.112-3.debian.tar.xz 25880 SHA256:c11858bac134b8c8b5a0f8605f129172beee1c58010c1b56b1f76a55ee4a322e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libaio/0.3.112-3/ (for browsing the source)
- https://sources.debian.net/src/libaio/0.3.112-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libaio/0.3.112-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mecab-ipadic=2.7.0-20070801+main-2.1`
...
```console
$ apt-get source -qq --print-uris mecab-ipadic=2.7.0-20070801+main-2.1
'http://deb.debian.org/debian/pool/main/m/mecab-ipadic/mecab-ipadic_2.7.0-20070801+main-2.1.dsc' mecab-ipadic_2.7.0-20070801+main-2.1.dsc 2198 SHA256:3fd80b3a52e27789e2a50e328b238ad71c705d7ff8fe06c59debe19e0201b8ea
...
'http://deb.debian.org/debian/pool/main/m/mecab-ipadic/mecab-ipadic_2.7.0-20070801+main-2.1.debian.tar.xz' mecab-ipadic_2.7.0-20070801+main-2.1.debian.tar.xz 5764 SHA256:0f367751b5cb1fe1a46f493ea0c766d8bcd52f0919f79b3a12f7f6535ddf17cf
```

Other potentially useful URLs:

- https://sources.debian.net/src/mecab-ipadic/2.7.0-20070801+main-2.1/ (for browsing the source)
- https://sources.debian.net/src/mecab-ipadic/2.7.0-20070801+main-2.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mecab-ipadic/2.7.0-20070801+main-2.1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `mecab=0.996-6`

Binary Packages:

- `libmecab2:amd64=0.996-6`
- `mecab-utils=0.996-6`
...
```console
$ apt-get source -qq --print-uris mecab=0.996-6
'http://deb.debian.org/debian/pool/main/m/mecab/mecab_0.996-6.dsc' mecab_0.996-6.dsc 2144 SHA256:d95ce12ac7aab7a9f16e637bb25be406f6845231b028e19247079b201900ae12
...
'http://deb.debian.org/debian/pool/main/m/mecab/mecab_0.996-6.debian.tar.xz' mecab_0.996-6.debian.tar.xz 8184 SHA256:b3aa7032502ef687d8838cbc604a683cdb22c684d3cd536ab36f9aba19a7982c
```

Other potentially useful URLs:

- https://sources.debian.net/src/mecab/0.996-6/ (for browsing the source)
...
### `dpkg` source package: `mysql-community=8.0.21-1debian10`

Binary Packages:

- `mysql-common=8.0.21-1debian10`
- `mysql-community-client=8.0.21-1debian10`
- `mysql-community-client-core=8.0.21-1debian10`
- `mysql-community-server-core=8.0.21-1debian10`
...
```console
$ apt-get source -qq --print-uris mysql-community=8.0.21-1debian10
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.21-1debian10.dsc' mysql-community_8.0.21-1debian10.dsc 2500 SHA256:bd8424ff5b47e94c735896d10632227706078215d3bba57fc32822170be5fcae
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.21.orig.tar.gz' mysql-community_8.0.21.orig.tar.gz 281674750 SHA256:ad56535eee03943adeef5f188e1df7a39729a7557d8b2179b1affd994b990034
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.21-1debian10.debian.tar.xz' mysql-community_8.0.21-1debian10.debian.tar.xz 21172 SHA256:3eb6fc1e374e2fb2a39aafd7f72bc8c5c93542b37a2a4cd43ca5d9bc34a7ebc6
```
