...
### `rpm` package: `mysql-community-server-minimal-9.4.0-1.el9.x86_64`
...
### `rpm` package: `mysql-shell-9.4.0-1.el9.x86_64`
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.21-2.el9_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.21-2.el9_6.1.src.rpm
```
