...
### `rpm` package: `bzip2-1.0.8-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url bzip2-1.0.8-8.el9
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/findutils-4.8.0-6.el9.src.rpm
```
...
### `rpm` package: `glibc-2.34-100.0.1.el9_4.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-100.0.1.el9_4.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
```

### `rpm` package: `glibc-common-2.34-100.0.1.el9_4.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-100.0.1.el9_4.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-100.0.1.el9_4.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-100.0.1.el9_4.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/nghttp2-1.43.0-5.el9_4.3.src.rpm
```
...
### `rpm` package: `libtirpc-1.3.3-8.el9_4.x86_64`
...
```console
$ dnf --quiet download --source --url libtirpc-1.3.3-8.el9_4
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libtirpc-1.3.3-8.el9_4.src.rpm
```
...
### `rpm` package: `mysql-community-server-minimal-8.4.2-1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2024, Oracle and/or its affiliates. Under GPLv2 license as shown in the Description field.

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `mysql-shell-8.4.1-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.18-3.el9_4.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python-pip-21.2.3-8.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-pip-21.2.3-8.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-setuptools-wheel-53.0.0-12.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python-setuptools-53.0.0-12.el9.src.rpm
```
...
### `rpm` package: `zstd-1.5.1-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url zstd-1.5.1-2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/zstd-1.5.1-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/zstd-1.5.1-2.el9.src.rpm
```
