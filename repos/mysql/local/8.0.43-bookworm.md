...
- Created: `2025-07-22T22:15:12Z`
- Virtual Size: ~ 610.71 Mb  
...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.43-1debian12`
...
### `dpkg` source package: `libaio=0.3.113-4`
...
```console
$ apt-get source -qq --print-uris libaio=0.3.113-4
'http://deb.debian.org/debian/pool/main/liba/libaio/libaio_0.3.113-4.dsc' libaio_0.3.113-4.dsc 2071 SHA256:b04bfaab63ecb85f16513957a40c3ed045597fa0af17c16dacbff75dab78af6e
'http://deb.debian.org/debian/pool/main/liba/libaio/libaio_0.3.113.orig.tar.gz' libaio_0.3.113.orig.tar.gz 49980 SHA256:2c44d1c5fd0d43752287c9ae1eb9c023f04ef848ea8d4aafa46e9aedb678200b
'http://deb.debian.org/debian/pool/main/liba/libaio/libaio_0.3.113-4.debian.tar.xz' libaio_0.3.113-4.debian.tar.xz 17528 SHA256:0080eb530b80a5520cd7835bfac7532dfd5997f29c0c4ca567c257563ad784b9
```

Other potentially useful URLs:

- https://sources.debian.net/src/libaio/0.3.113-4/ (for browsing the source)
- https://sources.debian.net/src/libaio/0.3.113-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libaio/0.3.113-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mecab-ipadic=2.7.0-20070801+main-3`
...
```console
$ apt-get source -qq --print-uris mecab-ipadic=2.7.0-20070801+main-3
'http://deb.debian.org/debian/pool/main/m/mecab-ipadic/mecab-ipadic_2.7.0-20070801%2bmain-3.dsc' mecab-ipadic_2.7.0-20070801+main-3.dsc 2168 SHA256:d50ca713d5afa2c9bcc690007e50cc044669d9be9636545533ef06726135dbc2
'http://deb.debian.org/debian/pool/main/m/mecab-ipadic/mecab-ipadic_2.7.0-20070801%2bmain.orig.tar.gz' mecab-ipadic_2.7.0-20070801+main.orig.tar.gz 12208105 SHA256:b62f527d881c504576baed9c6ef6561554658b175ce6ae0096a60307e49e3523
'http://deb.debian.org/debian/pool/main/m/mecab-ipadic/mecab-ipadic_2.7.0-20070801%2bmain-3.debian.tar.xz' mecab-ipadic_2.7.0-20070801+main-3.debian.tar.xz 5832 SHA256:2796c8e31f52d11c1393c53cd664756f83d609597123c50f658938449499993b
```

Other potentially useful URLs:

- https://sources.debian.net/src/mecab-ipadic/2.7.0-20070801+main-3/ (for browsing the source)
- https://sources.debian.net/src/mecab-ipadic/2.7.0-20070801+main-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mecab-ipadic/2.7.0-20070801+main-3/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `mecab=0.996-14`

Binary Packages:

- `libmecab2:amd64=0.996-14+b14`
- `mecab-utils=0.996-14+b14`
...
```console
$ apt-get source -qq --print-uris mecab=0.996-14
'http://deb.debian.org/debian/pool/main/m/mecab/mecab_0.996-14.dsc' mecab_0.996-14.dsc 2599 SHA256:79236b4d3890988697a98d3e68961c7f917ebae612b956f40bf602ce7e5e0b1d
'http://deb.debian.org/debian/pool/main/m/mecab/mecab_0.996.orig.tar.gz' mecab_0.996.orig.tar.gz 1398663 SHA256:e073325783135b72e666145c781bb48fada583d5224fb2490fb6c1403ba69c59
'http://deb.debian.org/debian/pool/main/m/mecab/mecab_0.996-14.debian.tar.xz' mecab_0.996-14.debian.tar.xz 12644 SHA256:09f60737f72680b76c28263bb7acfae70639350f0e8408670b317d0c90fbf250
```

Other potentially useful URLs:

- https://sources.debian.net/src/mecab/0.996-14/ (for browsing the source)
- https://sources.debian.net/src/mecab/0.996-14/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mecab/0.996-14/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `mysql-community=8.0.43-1debian12`

Binary Packages:

- `mysql-common=8.0.43-1debian12`
- `mysql-community-client=8.0.43-1debian12`
- `mysql-community-client-core=8.0.43-1debian12`
- `mysql-community-client-plugins=8.0.43-1debian12`
- `mysql-community-server-core=8.0.43-1debian12`
...
```console
$ apt-get source -qq --print-uris mysql-community=8.0.43-1debian12
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.43-1debian12.dsc' mysql-community_8.0.43-1debian12.dsc 3233 SHA256:7d32d3d20d4d914cf114bc0a50b490fecc374cec1e678b5e502eb4adf3aa9037
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.43.orig.tar.gz' mysql-community_8.0.43.orig.tar.gz 485017765 SHA256:76250a81015c878f62521cfaf30dff0ea9b250978d2b1dff007408a398d5db93
'http://repo.mysql.com/apt/debian/pool/mysql-8.0/m/mysql-community/mysql-community_8.0.43-1debian12.debian.tar.xz' mysql-community_8.0.43-1debian12.debian.tar.xz 22276 SHA256:3d3edd10f97840ad4e69e30c1f0389d1e5a800a22539daa0f7b8a4d5c302fa14
```
