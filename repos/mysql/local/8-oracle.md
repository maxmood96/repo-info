...
- Created: `2024-04-30T12:45:29Z`
- Virtual Size: ~ 623.11 Mb  
...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `MYSQL_MAJOR=8.4`
  - `MYSQL_VERSION=8.4.0-1.el8`
  - `MYSQL_SHELL_VERSION=8.4.0-1.el8`
...
### `rpm` package: `mysql-community-server-minimal-8.4.0-1.el8.x86_64`
...
### `rpm` package: `mysql-shell-8.4.0-1.el8.x86_64`
