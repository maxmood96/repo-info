...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/audit-3.0.7-5.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-33.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/elfutils-0.189-3.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/file-5.33-25.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url findutils-4.6.0-21.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/findutils-4.6.0-21.el8.src.rpm
```
...
### `rpm` package: `glibc-2.28-236.0.1.el8.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.28-236.0.1.el8.7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
```

### `rpm` package: `glibc-common-2.28-236.0.1.el8.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.28-236.0.1.el8.7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.28-236.0.1.el8.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-236.0.1.el8.7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
```
...
```console
$ dnf --quiet download --source --url gnutls-3.6.16-8.el8_9.1
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gnutls-3.6.16-8.el8_9.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gnutls-3.6.16-8.el8_9.1.src.rpm
```
...
### `rpm` package: `krb5-libs-1.18.2-26.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.18.2-26.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-26.0.1.el8_9.src.rpm
```
...
### `rpm` package: `libblkid-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libblkid-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcurl-7.61.1-33.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/curl-7.61.1-33.el8.src.rpm
```
...
### `rpm` package: `libdnf-0.63.0-17.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.63.0-17.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-17.0.1.el8_9.src.rpm
```
...
### `rpm` package: `libgcc-8.5.0-20.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libgcc-8.5.0-20.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-20.0.2.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-20.0.2.el8.src.rpm
```
...
### `rpm` package: `libmount-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libmount-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
### `rpm` package: `libsmartcols-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libsmartcols-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url libssh-0.9.6-13.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libssh-0.9.6-13.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libssh-0.9.6-13.el8_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libssh-config-0.9.6-13.el8_9.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libssh-0.9.6-13.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libssh-0.9.6-13.el8_9.src.rpm
```

### `rpm` package: `libstdc++-8.5.0-20.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-8.5.0-20.0.2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gcc-8.5.0-20.0.2.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gcc-8.5.0-20.0.2.el8.src.rpm
```
...
### `rpm` package: `libuuid-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libuuid-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libxml2-2.9.7-18.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libxml2-2.9.7-18.el8_9.src.rpm
```
...
### `rpm` package: `mysql-community-server-minimal-8.0.36-1.el8.x86_64`
...
### `rpm` package: `mysql-shell-8.0.36-1.el8.x86_64`
...
### `rpm` package: `openssl-1.1.1k-12.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-1.1.1k-12.el8_9
...
### `rpm` package: `oraclelinux-release-8.9-1.0.8.el8.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-8.9-1.0.8.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/oraclelinux-release-8.9-1.0.8.el8.src.rpm
```

### `rpm` package: `oraclelinux-release-el8-1.0-35.el8.x86_64`
...
```console
$ dnf --quiet download --source --url oraclelinux-release-el8-1.0-35.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/oraclelinux-release-el8-1.0-35.el8.src.rpm
```
...
### `rpm` package: `python39-3.9.18-1.module+el8.9.0+90071+8dc52a4f.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python39-libs-3.9.18-1.module+el8.9.0+90071+8dc52a4f.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python39-pip-20.2.4-8.module+el8.9.0+90016+9c2d6573.noarch`
...
```console
$ dnf --quiet download --source --url python39-pip-20.2.4-8.module+el8.9.0+90016+9c2d6573.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-pip-20.2.4-8.module+el8.9.0+90016+9c2d6573.src.rpm
```

### `rpm` package: `python39-pip-wheel-20.2.4-8.module+el8.9.0+90016+9c2d6573.noarch`
...
```console
$ dnf --quiet download --source --url python39-pip-wheel-20.2.4-8.module+el8.9.0+90016+9c2d6573.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-pip-20.2.4-8.module+el8.9.0+90016+9c2d6573.src.rpm
```

### `rpm` package: `python39-setuptools-50.3.2-4.module+el8.9.0+90016+9c2d6573.noarch`
...
```console
$ dnf --quiet download --source --url python39-setuptools-50.3.2-4.module+el8.9.0+90016+9c2d6573.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-setuptools-50.3.2-4.module+el8.9.0+90016+9c2d6573.src.rpm
```

### `rpm` package: `python39-setuptools-wheel-50.3.2-4.module+el8.9.0+90016+9c2d6573.noarch`
...
```console
$ dnf --quiet download --source --url python39-setuptools-wheel-50.3.2-4.module+el8.9.0+90016+9c2d6573.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-setuptools-50.3.2-4.module+el8.9.0+90016+9c2d6573.src.rpm
```
...
### `rpm` package: `redhat-release-8.9-0.1.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url redhat-release-8.9-0.1.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/redhat-release-8.9-0.1.0.1.el8.src.rpm
```

### `rpm` package: `rpm-4.14.3-28.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.14.3-28.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
```

### `rpm` package: `rpm-libs-4.14.3-28.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.14.3-28.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rpm-4.14.3-28.0.2.el8_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url shadow-utils-4.6-19.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/shadow-utils-4.6-19.el8.src.rpm
```
...
### `rpm` package: `systemd-libs-239-78.0.3.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-78.0.3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-78.0.3.el8.src.rpm
```
