...
- Created: `2025-01-21T17:21:51Z`
- Virtual Size: ~ 769.17 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libxml2-2.9.13-6.el9_5.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libxml2-2.9.13-6.el9_5.1.src.rpm
```
...
### `rpm` package: `mysql-community-server-minimal-8.4.4-1.el9.x86_64`
...
### `rpm` package: `mysql-shell-8.4.4-1.el9.x86_64`
...
### `rpm` package: `systemd-libs-252-46.0.3.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-46.0.3.el9_5.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-46.0.3.el9_5.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2025a-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2025a-1.el9.src.rpm
```
