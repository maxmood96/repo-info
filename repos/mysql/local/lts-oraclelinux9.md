...
- Created: `2026-04-23T01:01:09.752745212Z`
- Virtual Size: ~ 949.90 Mb  
...
### `rpm` package: `glibc-2.34-231.0.1.el9_7.10.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-2.34-231.0.1.el9_7.10
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
```

### `rpm` package: `glibc-common-2.34-231.0.1.el9_7.10.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-common-2.34-231.0.1.el9_7.10
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
```

### `rpm` package: `glibc-minimal-langpack-2.34-231.0.1.el9_7.10.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-231.0.1.el9_7.10
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gnutls-3.8.3-10.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gnutls-3.8.3-10.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libarchive-3.5.3-9.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/libarchive-3.5.3-9.el9_7.src.rpm
```
...
### `rpm` package: `libdnf-0.69.0-17.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-17.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-17.0.1.el9_7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/nghttp2-1.43.0-6.el9_7.1.src.rpm
```
...
### `rpm` package: `mysql-community-server-minimal-9.7.0-1.el9.x86_64`

Licenses (from `rpm --query`): Copyright (c) 2000, 2026, Oracle and/or its affiliates. Under GPLv2 license as shown in the Description field.

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `mysql-shell-9.7.0-1.el9.x86_64`
...
### `rpm` package: `systemd-libs-252-55.0.3.el9_7.8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-55.0.3.el9_7.8
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-55.0.3.el9_7.8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-55.0.3.el9_7.8.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/tzdata-2026a-1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/tzdata-2026a-1.el9.src.rpm
```
