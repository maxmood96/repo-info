...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.39-1.el9`
  - `MYSQL_SHELL_VERSION=8.0.38-1.el9`
...
### `rpm` package: `mysql-community-server-minimal-8.0.39-1.el9.x86_64`
...
### `rpm` package: `mysql-shell-8.0.38-1.el9.x86_64`
...
### `rpm` package: `python-unversioned-command-3.9.18-3.el9_4.3.noarch`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.18-3.el9_4.3.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-3.9.18-3.el9_4.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.18-3.el9_4.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-3.el9_4.3.src.rpm
```
