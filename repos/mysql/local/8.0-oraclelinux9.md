...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.37-1.el9`
  - `MYSQL_SHELL_VERSION=8.0.37-1.el9`
...
### `rpm` package: `mysql-community-server-minimal-8.0.37-1.el9.x86_64`
...
### `rpm` package: `mysql-shell-8.0.37-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python-unversioned-command-3.9.18-3.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.18-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.18-3.el9.src.rpm
```
