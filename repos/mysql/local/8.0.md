...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `MYSQL_MAJOR=8.0`
  - `MYSQL_VERSION=8.0.37-1.el8`
  - `MYSQL_SHELL_VERSION=8.0.37-1.el8`
...
### `rpm` package: `glibc-minimal-langpack-2.28-236.0.1.el8_9.12.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-236.0.1.el8_9.12
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-236.0.1.el8_9.12.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-236.0.1.el8_9.12.src.rpm
```
...
### `rpm` package: `mysql-community-server-minimal-8.0.37-1.el8.x86_64`
...
### `rpm` package: `mysql-shell-8.0.37-1.el8.x86_64`
...
### `rpm` package: `python39-pip-20.2.4-8.module+el8.9.0+90284+c66f938a.1.noarch`
...
```console
$ dnf --quiet download --source --url python39-pip-20.2.4-8.module+el8.9.0+90284+c66f938a.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-pip-20.2.4-8.module+el8.9.0+90284+c66f938a.1.src.rpm
```

### `rpm` package: `python39-pip-wheel-20.2.4-8.module+el8.9.0+90284+c66f938a.1.noarch`
...
```console
$ dnf --quiet download --source --url python39-pip-wheel-20.2.4-8.module+el8.9.0+90284+c66f938a.1.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3x-pip-20.2.4-8.module+el8.9.0+90284+c66f938a.1.src.rpm
```
