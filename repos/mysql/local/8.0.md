...
- Created: `2023-02-24T00:38:19.232437888Z`
- Virtual Size: ~ 530.47 Mb  
...
### `rpm` package: `mysql-community-server-minimal-8.0.32-1.el8.x86_64`
...
### `rpm` package: `mysql-shell-8.0.32-1.el8.x86_64`
...
### `rpm` package: `python39-3.9.13-2.module+el8.7.0+20879+a85b87b0.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python39-libs-3.9.13-2.module+el8.7.0+20879+a85b87b0.x86_64`
