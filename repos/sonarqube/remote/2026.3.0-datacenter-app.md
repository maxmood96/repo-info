...
### `sonarqube:2026.3.0-datacenter-app` - linux; amd64
...
### `sonarqube:2026.3.0-datacenter-app` - unknown; unknown
...
### `sonarqube:2026.3.0-datacenter-app` - linux; arm64 variant v8
