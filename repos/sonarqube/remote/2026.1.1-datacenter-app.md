...
### `sonarqube:2026.1.1-datacenter-app` - linux; amd64
...
### `sonarqube:2026.1.1-datacenter-app` - unknown; unknown
...
### `sonarqube:2026.1.1-datacenter-app` - linux; arm64 variant v8
