...
```console
$ docker pull sonarqube@sha256:fe3cd25a1e55a33c4b2d3531c38c33ae9ae75de475715eff3a2d6f7af90213a1
```
...
```console
$ docker pull sonarqube@sha256:b474855140e2f68c23dce2feccb93053bedc59a54d740dbea881dd3181f0691e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **528.1 MB (528116191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9225eef67a0d4368b45757a827e10faf482dbf787321f361ee49a35e7a716bc`
-	Entrypoint: `["\/opt\/sonarqube\/docker\/run.sh"]`
-	Default Command: `["\/opt\/sonarqube\/docker\/sonar.sh"]`
...
-	Layers:
	...
	-	`sha256:6f320f164b70019d3de719bb4a4b380f596330be1d584f5d935f80a4344b5b48`  
		...
		Size: 734.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:54570a51d033d713e63ab6aa9bae8a2580601ac6dd72fc2287c735f43e259808`  
		Last Modified: Fri, 26 Apr 2024 09:54:05 GMT  
		Size: 440.2 MB (440150416 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:140f14872ee5fdf4c7f18723da221d38e82e8074cc04dc399b9c1618b77c3d2b`  
		Last Modified: Fri, 26 Apr 2024 09:53:56 GMT  
		Size: 824.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		Last Modified: Tue, 07 Mar 2017 15:01:14 GMT  
...
```console
$ docker pull sonarqube@sha256:c34ecb41eded25f6606a0b387d10011a6def94da77820813a3a93db2bca34f3a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.2 MB (4227240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5679f2cc6af85c583996bd9917b3e53edcecd6a4600bda179c3a2d736355d6a2`

```dockerfile
```

-	Layers:
	-	`sha256:66ece6bef20989e0a0938c41599f3b2e09ef47d5fb36d87bb6458cdb1e9c6b71`  
		Last Modified: Fri, 26 Apr 2024 09:53:56 GMT  
		Size: 4.2 MB (4208793 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:38c5afde9c4f1e8792ed63641b80c3083fbbf10a43b41124e15408e3e1063b05`  
		Last Modified: Fri, 26 Apr 2024 09:53:56 GMT  
