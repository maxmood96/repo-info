...
- Created: `2026-02-18T19:21:06.33135099Z`
- Virtual Size: ~ 520.39 Mb  
...
### `rpm` package: `MariaDB-backup-11.8.6-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-11.8.6-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-compat-11.8.6-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-common-11.8.6-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-11.8.6-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-compat-11.8.6-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-shared-11.8.6-1.el9.x86_64`
...
### `rpm` package: `epel-release-9-10.el9.noarch`
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/e/epel-release-9-10.el9.src.rpm
```
...
### `rpm` package: `gperftools-libs-2.9.1-3.el9.x86_64`
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/g/gperftools-2.9.1-3.el9.src.rpm
```
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/j/jemalloc-5.2.1-2.el9.src.rpm
```
...
### `rpm` package: `libunwind-1.6.2-1.el9.x86_64`
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/l/libunwind-1.6.2-1.el9.src.rpm
```
...
### `rpm` package: `perl-File-Copy-2.34-481.1.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url perl-File-Copy-2.34-481.1.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.1.el9_6.src.rpm
```
...
### `rpm` package: `perl-Math-Complex-1.59-481.1.el9_6.noarch`
...
### `rpm` package: `perl-Sys-Hostname-1.23-481.1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url perl-Sys-Hostname-1.23-481.1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.1.el9_6.src.rpm
```
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/p/pv-1.6.20-1.el9.src.rpm
```
...
https://epel.mirror.shastacoe.net/epel/9/Everything/source/tree/Packages/p/pwgen-2.08-8.el9.src.rpm
```
...
### `rpm` package: `socat-1.7.4.1-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url socat-1.7.4.1-8.el9
...
### `rpm` package: `zstd-1.5.5-1.el9.x86_64`
