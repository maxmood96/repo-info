...
- Created: `2026-05-20T18:35:08.039358737Z`
...
- Labels:
  ...
  - `org.opencontainers.image.version=11.8.7`
...
### `rpm` package: `MariaDB-backup-11.8.7-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-11.8.7-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-compat-11.8.7-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-common-11.8.7-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-11.8.7-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-compat-11.8.7-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-shared-11.8.7-1.el9.x86_64`
...
### `rpm` package: `galera-4-26.4.26-1.el9.x86_64`
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-266.el9_8.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-266.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-266.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-266.el9_8.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gnutls-3.8.10-3.el9.src.rpm
```
...
https://mirrors.iu13.net/epel/9/Everything/source/tree/Packages/g/gperftools-2.9.1-3.el9.src.rpm
```
...
https://mirrors.iu13.net/epel/9/Everything/source/tree/Packages/l/libunwind-1.6.2-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url liburing-2.12-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/l/liburing-2.12-1.el9.src.rpm
```
