...
```console
$ dnf --quiet download --source --url boost-program-options-1.75.0-12.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/b/boost-1.75.0-12.el9.src.rpm
```
