...
### `rpm` package: `boost-program-options-1.75.0-8.el9.x86_64`
...
```console
$ dnf --quiet download --source --url boost-program-options-1.75.0-8.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/b/boost-1.75.0-8.el9.src.rpm
```
...
http://mirror.math.princeton.edu/pub/epel/9/Everything/source/tree/Packages/e/epel-release-9-8.el9.src.rpm
```
...
### `rpm` package: `gpg-pubkey-c74cd1d8-56fc10ab`
...
http://mirror.math.princeton.edu/pub/epel/9/Everything/source/tree/Packages/j/jemalloc-5.2.1-2.el9.src.rpm
```
...
Licenses (from `rpm --query`): (GPLv2 with exceptions and LGPLv2+) or MIT

Source:

```console
$ dnf --quiet download --source --url liburing-2.5-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/l/liburing-2.5-1.el9.src.rpm
```
...
### `rpm` package: `lsof-4.94.0-3.el9.x86_64`

Licenses (from `rpm --query`): zlib and Sendmail and LGPLv2+

Source:

```console
$ dnf --quiet download --source --url lsof-4.94.0-3.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/lsof-4.94.0-3.el9.src.rpm
```
...
### `rpm` package: `perl-DBI-1.643-9.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-DBI-1.643-9.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-DBI-1.643-9.el9.src.rpm
```
...
### `rpm` package: `perl-File-Copy-2.34-481.el9.noarch`
...
```console
$ dnf --quiet download --source --url perl-File-Copy-2.34-481.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `perl-Math-BigInt-1.9998.18-460.el9.noarch`
...
```console
$ dnf --quiet download --source --url perl-Math-BigInt-1.9998.18-460.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-Math-BigInt-1.9998.18-460.el9.src.rpm
```

### `rpm` package: `perl-Math-Complex-1.59-481.el9.noarch`
...
```console
$ dnf --quiet download --source --url perl-Math-Complex-1.59-481.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `perl-Sys-Hostname-1.23-481.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-Sys-Hostname-1.23-481.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `pv-1.6.20-1.el9.x86_64`
...
http://mirror.math.princeton.edu/pub/epel/9/Everything/source/tree/Packages/p/pv-1.6.20-1.el9.src.rpm
```
...
http://mirror.math.princeton.edu/pub/epel/9/Everything/source/tree/Packages/p/pwgen-2.08-8.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url socat-1.7.4.1-6.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/s/socat-1.7.4.1-6.el9.src.rpm
```
