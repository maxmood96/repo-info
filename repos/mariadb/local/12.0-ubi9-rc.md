...
### `rpm` package: `MariaDB-backup-12.0.1-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-12.0.1-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-compat-12.0.1-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-common-12.0.1-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-12.0.1-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-compat-12.0.1-1.el9.noarch`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-shared-12.0.1-1.el9.x86_64`
...
### `rpm` package: `boost-program-options-1.75.0-10.el9.x86_64`
...
```console
$ dnf --quiet download --source --url boost-program-options-1.75.0-10.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/b/boost-1.75.0-10.el9.src.rpm
```
...
https://download-cc-rdu01.fedoraproject.org/pub/epel/9/Everything/source/tree/Packages/e/epel-release-9-10.el9.src.rpm
```
...
### `rpm` package: `galera-4-26.4.22-1.el9.x86_64`
...
https://download-cc-rdu01.fedoraproject.org/pub/epel/9/Everything/source/tree/Packages/j/jemalloc-5.2.1-2.el9.src.rpm
```
...
https://download-cc-rdu01.fedoraproject.org/pub/epel/9/Everything/source/tree/Packages/p/pv-1.6.20-1.el9.src.rpm
```
...
https://download-cc-rdu01.fedoraproject.org/pub/epel/9/Everything/source/tree/Packages/p/pwgen-2.08-8.el9.src.rpm
```
