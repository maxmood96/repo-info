...
- Environment:
  ...
  - `LANG=C.UTF-8`
  - `MARIADB_MAJOR=10.4`
  - `MARIADB_VERSION=1:10.4.33+maria~ubu2004`
- Labels:
...
### `dpkg` source package: `mariadb-10.4=1:10.4.33+maria~ubu2004`

Binary Packages:

- `libmariadb3:amd64=1:10.4.33+maria~ubu2004`
- `mariadb-backup=1:10.4.33+maria~ubu2004`
- `mariadb-client-10.4=1:10.4.33+maria~ubu2004`
- `mariadb-client-core-10.4=1:10.4.33+maria~ubu2004`
- `mariadb-common=1:10.4.33+maria~ubu2004`
- `mariadb-server=1:10.4.33+maria~ubu2004`
- `mariadb-server-10.4=1:10.4.33+maria~ubu2004`
- `mariadb-server-core-10.4=1:10.4.33+maria~ubu2004`
- `mysql-common=1:10.4.33+maria~ubu2004`
...
```console
$ apt-get source -qq --print-uris mariadb-10.4=1:10.4.33+maria~ubu2004
'http://archive.mariadb.org/mariadb-10.4.33/repo/ubuntu/pool/main/m/mariadb-10.4/mariadb-10.4_10.4.33%2bmaria%7eubu2004.dsc' mariadb-10.4_10.4.33+maria~ubu2004.dsc 3426 SHA256:2173d28becb536a2c6f467beb6cfe9ba372651a52151b9e4b79d990a22683ebf
'http://archive.mariadb.org/mariadb-10.4.33/repo/ubuntu/pool/main/m/mariadb-10.4/mariadb-10.4_10.4.33%2bmaria%7eubu2004.tar.xz' mariadb-10.4_10.4.33+maria~ubu2004.tar.xz 62753208 SHA256:9c58ba242e5498ffcb27926419327f84ca5fd4603619ba2ff14837cd67968fed
```
