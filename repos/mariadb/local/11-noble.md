...
### `dpkg` source package: `mariadb=1:11.7.2+maria~ubu2404`

Binary Packages:

- `libmariadb3:amd64=1:11.7.2+maria~ubu2404`
- `mariadb-backup=1:11.7.2+maria~ubu2404`
- `mariadb-client=1:11.7.2+maria~ubu2404`
- `mariadb-client-core=1:11.7.2+maria~ubu2404`
- `mariadb-common=1:11.7.2+maria~ubu2404`
- `mariadb-server=1:11.7.2+maria~ubu2404`
- `mariadb-server-core=1:11.7.2+maria~ubu2404`
- `mysql-common=1:11.7.2+maria~ubu2404`
...
```console
$ apt-get source -qq --print-uris mariadb=1:11.7.2+maria~ubu2404
'http://archive.mariadb.org/mariadb-11.7.2/repo/ubuntu/pool/main/m/mariadb/mariadb_11.7.2%2bmaria%7eubu2404.dsc' mariadb_11.7.2+maria~ubu2404.dsc 4574 SHA256:f3f5c837208edb9a10ea62ed89083a4fc2fe70d6c5b98d469d597bd7423e0e93
'http://archive.mariadb.org/mariadb-11.7.2/repo/ubuntu/pool/main/m/mariadb/mariadb_11.7.2%2bmaria%7eubu2404.tar.xz' mariadb_11.7.2+maria~ubu2404.tar.xz 63206836 SHA256:b6e9ce63f8517e3c6d20d7b620d0d8d5c86230cf48d799dc09f33f01b3d7e108
```
