...
- Created: `2025-12-04T19:48:52.688251759Z`
...
### `rpm` package: `MariaDB-backup-10.6.24-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-client-10.6.24-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-common-10.6.24-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-server-10.6.24-1.el9.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `MariaDB-shared-10.6.24-1.el9.x86_64`
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/e/epel-release-9-10.el9.src.rpm
```
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/g/gperftools-2.9.1-3.el9.src.rpm
```
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/j/jemalloc-5.2.1-2.el9.src.rpm
```
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/l/libunwind-1.6.2-1.el9.src.rpm
```
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/p/pv-1.6.20-1.el9.src.rpm
```
...
https://iad.mirror.rackspace.com/epel/9/Everything/source/tree/Packages/p/pwgen-2.08-8.el9.src.rpm
```
