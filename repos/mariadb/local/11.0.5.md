...
- Environment:
  ...
  - `GOSU_VERSION=1.17`
  - `LANG=C.UTF-8`
  - `MARIADB_VERSION=1:11.0.5+maria~ubu2204`
- Labels:
...
### `dpkg` source package: `galera-4=26.4.16-ubu2204`

Binary Packages:

- `galera-4=26.4.16-ubu2204`
...
### `dpkg` source package: `gawk=1:5.1.0-1ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris gawk=1:5.1.0-1ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/g/gawk/gawk_5.1.0-1ubuntu0.1.dsc' gawk_5.1.0-1ubuntu0.1.dsc 1927 SHA512:876842d18635c2fe6595bae95df11d8c39716d9706cbb87e9ecf706c7d3ca44dfebf2c86081fd4644da887ce9821415e2399a5e7e36d61b3821a7d859176d79b
...
```console
$ apt-get source -qq --print-uris libconfig-inifiles-perl=3.000003-1
'http://archive.ubuntu.com/ubuntu/pool/main/libc/libconfig-inifiles-perl/libconfig-inifiles-perl_3.000003-1.dsc' libconfig-inifiles-perl_3.000003-1.dsc 2262 SHA512:551014c818a9f54494e030ffdd04e836a6cb9e70d38151174a8610defa3a8e0424a32f0e54211edca9f27e56554f6fe26b09c6a700707d348e704132981ed24a
...
'http://archive.ubuntu.com/ubuntu/pool/main/libc/libconfig-inifiles-perl/libconfig-inifiles-perl_3.000003-1.debian.tar.xz' libconfig-inifiles-perl_3.000003-1.debian.tar.xz 9744 SHA512:c14adb3965fea8c7973e3baa90630857afc404a4f4a4788aabe2feec90e86e462352e36e62a26042431eea1da837a372fca82bdc52c3f323c285963dd3cf7d59
```

### `dpkg` source package: `libdbi-perl=1.643-3build3`

Binary Packages:

- `libdbi-perl:amd64=1.643-3build3`
...
```console
$ apt-get source -qq --print-uris libdbi-perl=1.643-3build3
'http://archive.ubuntu.com/ubuntu/pool/main/libd/libdbi-perl/libdbi-perl_1.643-3build3.dsc' libdbi-perl_1.643-3build3.dsc 2270 SHA512:bb00b4a404c410ee7fb71061407aba144b6b12dca8224c629789369955a11e5770b77f2c651a054251ab44e4dd89b3d464b04f79ed50d8f69410fea8fac0d1aa
...
'http://archive.ubuntu.com/ubuntu/pool/main/libd/libdbi-perl/libdbi-perl_1.643-3build3.debian.tar.xz' libdbi-perl_1.643-3build3.debian.tar.xz 14700 SHA512:4bc175ebc8f4418d6c403fa3d88bdbd55abe120e59802ecb8b6c581ec92b68f015234b47af659fd362c7613c7a07ddc6c2a44233c48438c27f80fc3119a32248
```
...
### `dpkg` source package: `mariadb=1:11.0.5+maria~ubu2204`

Binary Packages:

- `libmariadb3:amd64=1:11.0.5+maria~ubu2204`
- `mariadb-backup=1:11.0.5+maria~ubu2204`
- `mariadb-client=1:11.0.5+maria~ubu2204`
- `mariadb-client-core=1:11.0.5+maria~ubu2204`
- `mariadb-common=1:11.0.5+maria~ubu2204`
- `mariadb-server=1:11.0.5+maria~ubu2204`
- `mariadb-server-core=1:11.0.5+maria~ubu2204`
- `mysql-common=1:11.0.5+maria~ubu2204`
...
```console
$ apt-get source -qq --print-uris mariadb=1:11.0.5+maria~ubu2204
'http://archive.mariadb.org/mariadb-11.0.5/repo/ubuntu/pool/main/m/mariadb/mariadb_11.0.5%2bmaria%7eubu2204.dsc' mariadb_11.0.5+maria~ubu2204.dsc 4483 SHA256:c22cd862db62eabe8cb84cf6d9ba8281a7241800f3e53120c3682b28630ba4b8
'http://archive.mariadb.org/mariadb-11.0.5/repo/ubuntu/pool/main/m/mariadb/mariadb_11.0.5%2bmaria%7eubu2204.tar.xz' mariadb_11.0.5+maria~ubu2204.tar.xz 62292432 SHA256:038433d971717559229b8689cc1440359e384f9b2c415bd756587e431505f88e
```
...
### `dpkg` source package: `ndctl=72.1-1`

Binary Packages:

- `libdaxctl1:amd64=72.1-1`
- `libndctl6:amd64=72.1-1`

Licenses: (parsed from: `/usr/share/doc/libdaxctl1/copyright`, `/usr/share/doc/libndctl6/copyright`)
...
```console
$ apt-get source -qq --print-uris ndctl=72.1-1
'http://archive.ubuntu.com/ubuntu/pool/main/n/ndctl/ndctl_72.1-1.dsc' ndctl_72.1-1.dsc 2356 SHA512:dc164daf8b9ba48fa62287a0537ca6fec85612f100727c3033423fbea08fddb09283cdd7f133343873a379e5f1a16d07ee9bf470d7c7e06c04308eaf8aacc7d5
'http://archive.ubuntu.com/ubuntu/pool/main/n/ndctl/ndctl_72.1.orig.tar.gz' ndctl_72.1.orig.tar.gz 365324 SHA512:7304e23121c99457fa6e22a399fb636f6a66d6d07b090463ec41e424687b06e7e8a1a18623ab9dd5783aaccfa09ff964e3477b63aaa4614ac60f6e6050452f12
'http://archive.ubuntu.com/ubuntu/pool/main/n/ndctl/ndctl_72.1-1.debian.tar.xz' ndctl_72.1-1.debian.tar.xz 9744 SHA512:aad6e0f085cb19cb4391df14606f807586f4b792955005bbce3e4342d034e54b5345e56838f657101fd2a1ca8d6a3e1ab2ca64ceeb1a9b472847e97bcc7c6588
```
...
### `dpkg` source package: `pmdk=1.11.1-3build1`

Binary Packages:

- `libpmem1:amd64=1.11.1-3build1`

Licenses: (parsed from: `/usr/share/doc/libpmem1/copyright`)
...
```console
$ apt-get source -qq --print-uris pmdk=1.11.1-3build1
'http://archive.ubuntu.com/ubuntu/pool/main/p/pmdk/pmdk_1.11.1-3build1.dsc' pmdk_1.11.1-3build1.dsc 4192 SHA512:91d81bc524284e0a1c7aaae9f90b7928436f3b9d5ab8b10d1cb3b37e3a02fada33d3dd70146a639473c1e044240ea0b3bd2994379d7a3da8a1efa65cbd4fcbe5
'http://archive.ubuntu.com/ubuntu/pool/main/p/pmdk/pmdk_1.11.1.orig.tar.gz' pmdk_1.11.1.orig.tar.gz 2432431 SHA512:100c7fd223675bf10649620a75d01c3fd0dbdd1a7b00d17878175559a5e5a0219180b08227688f715b0bc2002464c9146877c954aad33aff596e3cad0b2b67cb
'http://archive.ubuntu.com/ubuntu/pool/main/p/pmdk/pmdk_1.11.1.orig.tar.gz.asc' pmdk_1.11.1.orig.tar.gz.asc 833 SHA512:9929583c881159110a3b1152ad9f6207092a7c8f9f608dc5804bcbd48a4519b471b07035a3fd061c11080e3547865478c99b780e2e1671c23525fee206be70b1
'http://archive.ubuntu.com/ubuntu/pool/main/p/pmdk/pmdk_1.11.1-3build1.debian.tar.xz' pmdk_1.11.1-3build1.debian.tar.xz 20856 SHA512:74848177f390ddfb4c2dde7c6f7f8925ad7686eb40e8ddf75ac57bc66225fe7175033be36110614d3b7b9f8d6dce8bea8f0ab51e6c5bd3282662264fc81064a6
```
