...
### `mariadb:10.11.10-jammy` - linux; amd64
...
### `mariadb:10.11.10-jammy` - unknown; unknown
...
### `mariadb:10.11.10-jammy` - linux; arm64 variant v8
...
### `mariadb:10.11.10-jammy` - linux; ppc64le
...
### `mariadb:10.11.10-jammy` - linux; s390x
