...
### `mariadb:11.4.2-noble` - linux; amd64
...
### `mariadb:11.4.2-noble` - unknown; unknown
...
### `mariadb:11.4.2-noble` - linux; arm64 variant v8
...
### `mariadb:11.4.2-noble` - linux; ppc64le
...
### `mariadb:11.4.2-noble` - linux; s390x
