...
### `mariadb:11.4.11-ubi` - linux; amd64
...
### `mariadb:11.4.11-ubi` - unknown; unknown
...
### `mariadb:11.4.11-ubi` - linux; arm64 variant v8
...
### `mariadb:11.4.11-ubi` - linux; ppc64le
...
### `mariadb:11.4.11-ubi` - linux; s390x
