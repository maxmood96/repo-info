...
### `mariadb:11.8.7-noble` - linux; amd64
...
### `mariadb:11.8.7-noble` - unknown; unknown
...
### `mariadb:11.8.7-noble` - linux; arm64 variant v8
...
### `mariadb:11.8.7-noble` - linux; ppc64le
...
### `mariadb:11.8.7-noble` - linux; s390x
