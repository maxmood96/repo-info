...
### `mariadb:10.11.17-jammy` - linux; amd64
...
### `mariadb:10.11.17-jammy` - unknown; unknown
...
### `mariadb:10.11.17-jammy` - linux; arm64 variant v8
...
### `mariadb:10.11.17-jammy` - linux; ppc64le
...
### `mariadb:10.11.17-jammy` - linux; s390x
