...
### `mariadb:11.3.2-jammy` - linux; amd64
...
### `mariadb:11.3.2-jammy` - unknown; unknown
...
### `mariadb:11.3.2-jammy` - linux; arm64 variant v8
...
### `mariadb:11.3.2-jammy` - linux; ppc64le
...
### `mariadb:11.3.2-jammy` - linux; s390x
