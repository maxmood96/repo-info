...
### `mariadb:10.11.14-ubi` - linux; amd64
...
### `mariadb:10.11.14-ubi` - unknown; unknown
...
### `mariadb:10.11.14-ubi` - linux; arm64 variant v8
...
### `mariadb:10.11.14-ubi` - linux; ppc64le
...
### `mariadb:10.11.14-ubi` - linux; s390x
