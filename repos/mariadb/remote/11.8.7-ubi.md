...
### `mariadb:11.8.7-ubi` - linux; amd64
...
### `mariadb:11.8.7-ubi` - unknown; unknown
...
### `mariadb:11.8.7-ubi` - linux; arm64 variant v8
...
### `mariadb:11.8.7-ubi` - linux; ppc64le
...
### `mariadb:11.8.7-ubi` - linux; s390x
