...
### `mariadb:10.6.26-ubi` - linux; amd64
...
### `mariadb:10.6.26-ubi` - unknown; unknown
...
### `mariadb:10.6.26-ubi` - linux; arm64 variant v8
...
### `mariadb:10.6.26-ubi` - linux; ppc64le
...
### `mariadb:10.6.26-ubi` - linux; s390x
