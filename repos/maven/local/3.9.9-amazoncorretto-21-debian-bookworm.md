...
- Created: `2025-01-25T20:08:38Z`
- Virtual Size: ~ 468.54 Mb  
...
### `dpkg` source package: `java-21-amazon-corretto-jdk=1:21.0.6.7-1`

Binary Packages:

- `java-21-amazon-corretto-jdk:amd64=1:21.0.6.7-1`
...
### `dpkg` source package: `java-common=0.74`
...
```console
$ apt-get source -qq --print-uris java-common=0.74
'http://deb.debian.org/debian/pool/main/j/java-common/java-common_0.74.dsc' java-common_0.74.dsc 1966 SHA256:a061c2ebcc56271a169531e7c2e72007ecb3162f733c316a1ce5c52e768988d9
'http://deb.debian.org/debian/pool/main/j/java-common/java-common_0.74.tar.xz' java-common_0.74.tar.xz 13252 SHA256:1cdf4b75bd121d89de57398c200f7a036b97fd74a0b1aa17eff145ce1e5c2e5b
```

Other potentially useful URLs:

- https://sources.debian.net/src/java-common/0.74/ (for browsing the source)
- https://sources.debian.net/src/java-common/0.74/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/java-common/0.74/ (for access to the source package after it no longer exists in the archive)
