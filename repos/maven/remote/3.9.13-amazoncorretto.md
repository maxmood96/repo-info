...
### `maven:3.9.13-amazoncorretto` - linux; amd64
...
### `maven:3.9.13-amazoncorretto` - unknown; unknown
...
### `maven:3.9.13-amazoncorretto` - linux; arm64 variant v8
