...
```console
$ docker pull maven@sha256:ae194b9e6d5555e9e740d3f09f3d5c99957713c95a462151d5fba1395015a2fd
```
...
### `maven:3.9.16-eclipse-temurin-25-noble` - linux; amd64
...
### `maven:3.9.16-eclipse-temurin-25-noble` - unknown; unknown
...
### `maven:3.9.16-eclipse-temurin-25-noble` - linux; arm64 variant v8
...
### `maven:3.9.16-eclipse-temurin-25-noble` - linux; ppc64le
...
### `maven:3.9.16-eclipse-temurin-25-noble` - linux; riscv64
...
### `maven:3.9.16-eclipse-temurin-25-noble` - linux; s390x
