...
### `maven:3.9.15-amazoncorretto-21-alpine` - linux; amd64
...
### `maven:3.9.15-amazoncorretto-21-alpine` - unknown; unknown
...
### `maven:3.9.15-amazoncorretto-21-alpine` - linux; arm64 variant v8
