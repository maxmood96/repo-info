...
```console
$ docker pull maven@sha256:95baca01f93f5ffd60d6f10e1ddc621c2aae6a9389af146a6b3297590ea57ce7
```
...
```console
$ docker pull maven@sha256:3393baec62997ad124993e96eb56b94175708f2ef3fcdd7a3ad8bba7eea29df8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.5 MB (148486939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6f84603558e5b87d9ee67fcb82d13d3de577a1fa2eab82f57a0047ad7ed5bc6`
-	Entrypoint: `["\/usr\/local\/bin\/mvn-entrypoint.sh"]`
-	Default Command: `["mvn"]`
...
-	Layers:
	-	`sha256:e363695fcb930d5f18449254c0052117582c3de4263c91575b0a9040c986e412`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a88ec1b5c9b2051ab276e562cfcb36bbb82d934c7ba498ebdfcae30abb93c733`  
		Last Modified: Tue, 30 Sep 2025 00:57:29 GMT  
		Size: 109.1 MB (109102485 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bcb26a0feab522d1297857185572de44d991a403a426dcf896f0260a4d3fb9a3`  
		Last Modified: Tue, 30 Sep 2025 00:57:17 GMT  
		Size: 9.2 MB (9242578 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:334c6a156500610502590a95995b8e408561cfbeb72483c15b20df3879421e1a`  
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1c530d8e9a6e9bf25943b0ce03cc5360238d27feea14a7e300c49709d2188f02`  
		Last Modified: Tue, 30 Sep 2025 00:57:14 GMT  
		Size: 154.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull maven@sha256:0a024557669e1dd068a97361104a6b3f882d5cbe3c1167099c1b8e494358a20f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.0 MB (2982244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa24e23d55e2ac37dbfa322acc72e124566457cb4cebc5d8ced45d640b733ca5`

```dockerfile
```

-	Layers:
	-	`sha256:675887f9d1d68c5689c368979a058ab2316a93bf7fd859297791a39435783d85`  
		Last Modified: Wed, 01 Oct 2025 20:29:13 GMT  
		Size: 3.0 MB (2962820 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b9cfd2286fc20bb56263b73afd5cc41f65fd9cdb33ab6613c0cbdf4dd8d6dcc6`  
