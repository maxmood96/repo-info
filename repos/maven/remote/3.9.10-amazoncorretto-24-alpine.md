...
### `maven:3.9.10-amazoncorretto-24-alpine` - linux; amd64
...
### `maven:3.9.10-amazoncorretto-24-alpine` - unknown; unknown
...
### `maven:3.9.10-amazoncorretto-24-alpine` - linux; arm64 variant v8
