...
### `maven:3.9.10-amazoncorretto-11-alpine` - linux; amd64
...
### `maven:3.9.10-amazoncorretto-11-alpine` - unknown; unknown
...
### `maven:3.9.10-amazoncorretto-11-alpine` - linux; arm64 variant v8
