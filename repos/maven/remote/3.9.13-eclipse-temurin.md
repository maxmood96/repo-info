...
### `maven:3.9.13-eclipse-temurin` - linux; amd64
...
### `maven:3.9.13-eclipse-temurin` - unknown; unknown
...
### `maven:3.9.13-eclipse-temurin` - linux; arm64 variant v8
...
### `maven:3.9.13-eclipse-temurin` - linux; ppc64le
...
### `maven:3.9.13-eclipse-temurin` - linux; riscv64
...
### `maven:3.9.13-eclipse-temurin` - linux; s390x
