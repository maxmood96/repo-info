...
### `maven:3.9.15-sapmachine` - linux; amd64
...
### `maven:3.9.15-sapmachine` - unknown; unknown
...
### `maven:3.9.15-sapmachine` - linux; arm64 variant v8
...
### `maven:3.9.15-sapmachine` - linux; ppc64le
