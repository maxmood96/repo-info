...
```console
$ docker pull maven@sha256:ea66a4415b46b21752798952e879dda59851eacd2826eca42eda2ed793e7413f
```
...
### `maven:3.9.11-eclipse-temurin-25` - linux; amd64
...
### `maven:3.9.11-eclipse-temurin-25` - unknown; unknown
...
### `maven:3.9.11-eclipse-temurin-25` - linux; arm64 variant v8
...
### `maven:3.9.11-eclipse-temurin-25` - linux; ppc64le
...
### `maven:3.9.11-eclipse-temurin-25` - linux; s390x
