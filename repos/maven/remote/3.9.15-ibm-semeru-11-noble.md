...
### `maven:3.9.15-ibm-semeru-11-noble` - linux; amd64
...
### `maven:3.9.15-ibm-semeru-11-noble` - unknown; unknown
...
### `maven:3.9.15-ibm-semeru-11-noble` - linux; arm64 variant v8
...
### `maven:3.9.15-ibm-semeru-11-noble` - linux; ppc64le
...
### `maven:3.9.15-ibm-semeru-11-noble` - linux; s390x
