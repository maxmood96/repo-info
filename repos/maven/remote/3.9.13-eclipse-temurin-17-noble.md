...
```console
$ docker pull maven@sha256:c9647cca51e626d8fbe07ea3ef9340b5da5e4056cc60db537e037225a46c5b3a
```
...
### `maven:3.9.13-eclipse-temurin-17-noble` - linux; amd64
...
### `maven:3.9.13-eclipse-temurin-17-noble` - unknown; unknown
...
### `maven:3.9.13-eclipse-temurin-17-noble` - linux; arm variant v7
...
### `maven:3.9.13-eclipse-temurin-17-noble` - linux; arm64 variant v8
...
### `maven:3.9.13-eclipse-temurin-17-noble` - linux; ppc64le
...
### `maven:3.9.13-eclipse-temurin-17-noble` - linux; s390x
