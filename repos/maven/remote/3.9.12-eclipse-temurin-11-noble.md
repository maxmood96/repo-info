...
### `maven:3.9.12-eclipse-temurin-11-noble` - linux; amd64
...
### `maven:3.9.12-eclipse-temurin-11-noble` - unknown; unknown
...
### `maven:3.9.12-eclipse-temurin-11-noble` - linux; arm variant v7
...
### `maven:3.9.12-eclipse-temurin-11-noble` - linux; arm64 variant v8
...
### `maven:3.9.12-eclipse-temurin-11-noble` - linux; ppc64le
...
### `maven:3.9.12-eclipse-temurin-11-noble` - linux; s390x
