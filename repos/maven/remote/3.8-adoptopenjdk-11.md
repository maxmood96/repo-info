...
```console
$ docker pull maven@sha256:2d4ffb038a19c5f9ab3c90c8ffd0844ba96442fdbfbbddb9647b2a155c33d37c
```
...
```console
$ docker pull maven@sha256:3b0d2b1e4c35e527e6e832ccdd4345a551f7a7468c7d61a74f5a0c251c001f7a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.5 MB (273519935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e517f0274e8387e3934a4a02243b155d9a50099f65001710b0f4509698ea04b`
-	Entrypoint: `["\/usr\/local\/bin\/mvn-entrypoint.sh"]`
-	Default Command: `["mvn"]`
...
# Fri, 01 Oct 2021 03:02:59 GMT
CMD ["jshell"]
# Wed, 13 Oct 2021 08:07:45 GMT
ARG MAVEN_VERSION=3.8.3
# Wed, 13 Oct 2021 08:07:46 GMT
ARG USER_HOME_DIR=/root
# Wed, 13 Oct 2021 08:07:47 GMT
ARG SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa
# Wed, 13 Oct 2021 08:07:48 GMT
ARG BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries
# Wed, 13 Oct 2021 08:07:58 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN apt-get update     && apt-get install -y git     && rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 08:08:18 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN mkdir -p /usr/share/maven /usr/share/maven/ref   && curl -fsSL -o /tmp/apache-maven.tar.gz ${BASE_URL}/apache-maven-${MAVEN_VERSION}-bin.tar.gz   && echo "${SHA}  /tmp/apache-maven.tar.gz" | sha512sum -c -   && tar -xzf /tmp/apache-maven.tar.gz -C /usr/share/maven --strip-components=1   && rm -f /tmp/apache-maven.tar.gz   && ln -s /usr/share/maven/bin/mvn /usr/bin/mvn
# Wed, 13 Oct 2021 08:08:19 GMT
ENV MAVEN_HOME=/usr/share/maven
# Wed, 13 Oct 2021 08:08:20 GMT
ENV MAVEN_CONFIG=/root/.m2
# Wed, 13 Oct 2021 08:08:22 GMT
COPY file:1b3da5c58894f705e7387946301c0c52edb6271761ea3cd80b86a848847a64cd in /usr/local/bin/mvn-entrypoint.sh 
# Wed, 13 Oct 2021 08:08:23 GMT
COPY file:2bbb488dd73c55d658b91943cfdf9c26975a320ceafc45dda94c95b03e518ad3 in /usr/share/maven/ref/ 
# Wed, 13 Oct 2021 08:08:23 GMT
ENTRYPOINT ["/usr/local/bin/mvn-entrypoint.sh"]
# Wed, 13 Oct 2021 08:08:24 GMT
CMD ["mvn"]
```
...
-	Layers:
	...
	-	`sha256:efa7d2173ed66673d4fca4a1b653952ec74486215c16ba0f32f47a92e34098ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae8f29b6c504fb5026999c848910ac3b5732b77583d1f9bc9c927b6bfa226804`  
		Last Modified: Wed, 13 Oct 2021 08:21:52 GMT  
		Size: 31.0 MB (30965548 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f98e8207b9ad861ee96fa581a0c1fb06c5824a137f4c8e89cfe57c8afc8253a3`  
		Last Modified: Wed, 13 Oct 2021 08:21:48 GMT  
		Size: 9.1 MB (9105588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5316432ac1e3ae43ed181f0bf7b116fd3e6728992d194942967679a1bcdfee03`  
		Last Modified: Wed, 13 Oct 2021 08:21:47 GMT  
		Size: 851.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f90e403184cf8a9f776d78b75de0b74afefe5229695da7bf0851755e0ebb2c1e`  
		Last Modified: Wed, 13 Oct 2021 08:21:47 GMT  
		Size: 360.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull maven@sha256:1def86a0854cf1da93c365cb06207e2329ae39975cc821e7e55a732786a33d4b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.5 MB (273527337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0197892821ecf1e90400e9eb2c129c21affddb1d22c31f51f72748031e8e33b`
-	Entrypoint: `["\/usr\/local\/bin\/mvn-entrypoint.sh"]`
-	Default Command: `["mvn"]`
...
CMD ["jshell"]
# Thu, 07 Oct 2021 06:35:22 GMT
ARG MAVEN_VERSION=3.8.3
# Thu, 07 Oct 2021 06:35:28 GMT
ARG USER_HOME_DIR=/root
# Thu, 07 Oct 2021 06:35:33 GMT
ARG SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa
# Thu, 07 Oct 2021 06:35:36 GMT
ARG BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries
# Thu, 07 Oct 2021 06:36:29 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN apt-get update     && apt-get install -y git     && rm -rf /var/lib/apt/lists/*
# Thu, 07 Oct 2021 06:36:42 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN mkdir -p /usr/share/maven /usr/share/maven/ref   && curl -fsSL -o /tmp/apache-maven.tar.gz ${BASE_URL}/apache-maven-${MAVEN_VERSION}-bin.tar.gz   && echo "${SHA}  /tmp/apache-maven.tar.gz" | sha512sum -c -   && tar -xzf /tmp/apache-maven.tar.gz -C /usr/share/maven --strip-components=1   && rm -f /tmp/apache-maven.tar.gz   && ln -s /usr/share/maven/bin/mvn /usr/bin/mvn
# Thu, 07 Oct 2021 06:36:46 GMT
ENV MAVEN_HOME=/usr/share/maven
# Thu, 07 Oct 2021 06:36:49 GMT
ENV MAVEN_CONFIG=/root/.m2
# Thu, 07 Oct 2021 06:36:50 GMT
COPY file:1b3da5c58894f705e7387946301c0c52edb6271761ea3cd80b86a848847a64cd in /usr/local/bin/mvn-entrypoint.sh 
# Thu, 07 Oct 2021 06:36:51 GMT
COPY file:2bbb488dd73c55d658b91943cfdf9c26975a320ceafc45dda94c95b03e518ad3 in /usr/share/maven/ref/ 
# Thu, 07 Oct 2021 06:36:54 GMT
ENTRYPOINT ["/usr/local/bin/mvn-entrypoint.sh"]
# Thu, 07 Oct 2021 06:36:56 GMT
CMD ["mvn"]
```
...
-	Layers:
	...
	-	`sha256:0e00120f5c731e2ed3e87d5d18b14835db8a25c925f131bce4db4f3919fb51f9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62033d2f561bc2469b8ea967dcbaf4c3220f59a50892480e9499335d4e9763b2`  
		Last Modified: Thu, 07 Oct 2021 06:57:31 GMT  
		Size: 38.4 MB (38369066 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7e2007def4c71cc121982feb82c42837469a75659b0f65541fcf8e7371cf62f`  
		Last Modified: Thu, 07 Oct 2021 06:57:24 GMT  
		Size: 9.1 MB (9105600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:264a2d0ed58543a650363c3b8d730e16d3383a14a90dbfa09b012be6c874cc71`  
		Last Modified: Thu, 07 Oct 2021 06:57:23 GMT  
		Size: 852.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba8f6559e44868febbea2fff491c443a468341f5a37f2bdc435db5c389a08824`  
		Last Modified: Thu, 07 Oct 2021 06:57:23 GMT  
		Size: 361.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
