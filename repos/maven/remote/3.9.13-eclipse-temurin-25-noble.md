...
### `maven:3.9.13-eclipse-temurin-25-noble` - linux; amd64
...
### `maven:3.9.13-eclipse-temurin-25-noble` - unknown; unknown
...
### `maven:3.9.13-eclipse-temurin-25-noble` - linux; arm64 variant v8
...
### `maven:3.9.13-eclipse-temurin-25-noble` - linux; ppc64le
...
### `maven:3.9.13-eclipse-temurin-25-noble` - linux; riscv64
...
### `maven:3.9.13-eclipse-temurin-25-noble` - linux; s390x
