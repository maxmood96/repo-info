...
```console
$ docker pull maven@sha256:d733a2e7ef73d351208d744540e81803b6921a82d634cc053284bb4a74b9690c
```
...
### `maven:3.8.3-adoptopenjdk-15` - linux; amd64
...
### `maven:3.8.3-adoptopenjdk-15` - linux; arm variant v7
...
### `maven:3.8.3-adoptopenjdk-15` - linux; arm64 variant v8

```console
$ docker pull maven@sha256:fe74ba6970bf796fe64f9bf579a4b9dd817262d5222e24d4019a7d6d6efc69af
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.8 MB (287838291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ad1bd94be0ec97c510b3ea26e6818c9ef96d0a49225b0576ad5b1ea3502f103`
-	Entrypoint: `["\/usr\/local\/bin\/mvn-entrypoint.sh"]`
-	Default Command: `["mvn"]`
...
# Wed, 13 Oct 2021 08:08:30 GMT
ARG USER_HOME_DIR=/root
# Wed, 13 Oct 2021 08:08:31 GMT
ARG SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa
# Wed, 13 Oct 2021 08:08:32 GMT
ARG BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries
# Wed, 13 Oct 2021 08:08:42 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN apt-get update     && apt-get install -y git     && rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 08:08:56 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN mkdir -p /usr/share/maven /usr/share/maven/ref   && curl -fsSL -o /tmp/apache-maven.tar.gz ${BASE_URL}/apache-maven-${MAVEN_VERSION}-bin.tar.gz   && echo "${SHA}  /tmp/apache-maven.tar.gz" | sha512sum -c -   && tar -xzf /tmp/apache-maven.tar.gz -C /usr/share/maven --strip-components=1   && rm -f /tmp/apache-maven.tar.gz   && ln -s /usr/share/maven/bin/mvn /usr/bin/mvn
# Wed, 13 Oct 2021 08:08:57 GMT
ENV MAVEN_HOME=/usr/share/maven
# Wed, 13 Oct 2021 08:08:58 GMT
ENV MAVEN_CONFIG=/root/.m2
# Wed, 13 Oct 2021 08:09:00 GMT
COPY file:1b3da5c58894f705e7387946301c0c52edb6271761ea3cd80b86a848847a64cd in /usr/local/bin/mvn-entrypoint.sh 
# Wed, 13 Oct 2021 08:09:01 GMT
COPY file:2bbb488dd73c55d658b91943cfdf9c26975a320ceafc45dda94c95b03e518ad3 in /usr/share/maven/ref/ 
# Wed, 13 Oct 2021 08:09:01 GMT
ENTRYPOINT ["/usr/local/bin/mvn-entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:dcadcd5d68d6f16ec932ded95599e1a968644631caf7ba0d63941b0b1b5e51cb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52232277417cda862bd4400e4b1bccf17083eca462cf2735f30bde5c5f561b5e`  
		Last Modified: Wed, 13 Oct 2021 08:22:12 GMT  
		Size: 31.0 MB (30965483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6742f5f25f1290c3be15fadca4759646a7346ba7d0e3ba430a7034dbd4ea170`  
		Last Modified: Wed, 13 Oct 2021 08:22:08 GMT  
		Size: 9.1 MB (9105569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdcb717025ccb074925bdfbdb592546f9bba07d611a03fd02869e64a89740435`  
		Last Modified: Wed, 13 Oct 2021 08:22:06 GMT  
		Size: 852.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49918702ec986986738fb40cff6eb1c6de8c4162833aaa3be5d94e9641a2820f`  
		Last Modified: Wed, 13 Oct 2021 08:22:06 GMT  
		Size: 361.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `maven:3.8.3-adoptopenjdk-15` - linux; ppc64le

```console
$ docker pull maven@sha256:9e377e8c084e23bfc4addbceea6464e73d82dd4d88eab4993734cf54b2226568
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.1 MB (287063307 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df14ee1c3832afce37f20e3b7a3ecde09bab93db74919da45dd514df5afc333e`
-	Entrypoint: `["\/usr\/local\/bin\/mvn-entrypoint.sh"]`
-	Default Command: `["mvn"]`
...
CMD ["jshell"]
# Thu, 07 Oct 2021 06:37:03 GMT
ARG MAVEN_VERSION=3.8.3
# Thu, 07 Oct 2021 06:37:05 GMT
ARG USER_HOME_DIR=/root
# Thu, 07 Oct 2021 06:37:07 GMT
ARG SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa
# Thu, 07 Oct 2021 06:37:09 GMT
ARG BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries
# Thu, 07 Oct 2021 06:38:19 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN apt-get update     && apt-get install -y git     && rm -rf /var/lib/apt/lists/*
# Thu, 07 Oct 2021 06:38:29 GMT
# ARGS: BASE_URL=https://apache.osuosl.org/maven/maven-3/3.8.3/binaries MAVEN_VERSION=3.8.3 SHA=1c12a5df43421795054874fd54bb8b37d242949133b5bf6052a063a13a93f13a20e6e9dae2b3d85b9c7034ec977bbc2b6e7f66832182b9c863711d78bfe60faa USER_HOME_DIR=/root
RUN mkdir -p /usr/share/maven /usr/share/maven/ref   && curl -fsSL -o /tmp/apache-maven.tar.gz ${BASE_URL}/apache-maven-${MAVEN_VERSION}-bin.tar.gz   && echo "${SHA}  /tmp/apache-maven.tar.gz" | sha512sum -c -   && tar -xzf /tmp/apache-maven.tar.gz -C /usr/share/maven --strip-components=1   && rm -f /tmp/apache-maven.tar.gz   && ln -s /usr/share/maven/bin/mvn /usr/bin/mvn
# Thu, 07 Oct 2021 06:38:31 GMT
ENV MAVEN_HOME=/usr/share/maven
# Thu, 07 Oct 2021 06:38:33 GMT
ENV MAVEN_CONFIG=/root/.m2
# Thu, 07 Oct 2021 06:38:34 GMT
COPY file:1b3da5c58894f705e7387946301c0c52edb6271761ea3cd80b86a848847a64cd in /usr/local/bin/mvn-entrypoint.sh 
# Thu, 07 Oct 2021 06:38:35 GMT
COPY file:2bbb488dd73c55d658b91943cfdf9c26975a320ceafc45dda94c95b03e518ad3 in /usr/share/maven/ref/ 
# Thu, 07 Oct 2021 06:38:38 GMT
ENTRYPOINT ["/usr/local/bin/mvn-entrypoint.sh"]
# Thu, 07 Oct 2021 06:38:39 GMT
CMD ["mvn"]
```
...
-	Layers:
	...
	-	`sha256:0bf4624228657e959443ed9db9a8f22201309ea293e3387c8cc7911de2b7ae6e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ca4f5e3aaf9cf0aec0826ac9df2439176da7c4203c67a876bc2e4e05acd34ed`  
		Last Modified: Thu, 07 Oct 2021 06:57:53 GMT  
		Size: 38.4 MB (38369253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c6f0835bfc7c940a39a416e15829362ec6769f4b909e4f2162ead699ef6035c`  
		Last Modified: Thu, 07 Oct 2021 06:57:47 GMT  
		Size: 9.1 MB (9105599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63a55ac7f65219658c18f52ee0525b00d1f4d816751fbef4b7a9c8daefd3f2ff`  
		Last Modified: Thu, 07 Oct 2021 06:57:46 GMT  
		Size: 851.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaaa7baddb538ac069ee34fd3dbb9f7ca04cd012508989e98ebf12396fb47491`  
		Last Modified: Thu, 07 Oct 2021 06:57:46 GMT  
		Size: 360.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
