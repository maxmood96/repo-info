...
```console
$ docker pull maven@sha256:984a4646e37d084eda156442ffe6e6c688f5152133dcecb1008de0d1728651d6
```
...
### `maven:3.9.7-sapmachine` - linux; amd64
...
### `maven:3.9.7-sapmachine` - linux; ppc64le
