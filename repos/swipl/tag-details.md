...
```console
$ docker pull swipl@sha256:eff20dda2f0ab90ddcbbd71fa4557a0751dfcf4e8125b76d5d0497c13eb8008b
```
...
```console
$ docker pull swipl@sha256:c36a3b4ca4ad1cb01f9e6b4dc5207d580959c5895c7841c7897f1821454ed20c
```
...
```console
$ docker pull swipl@sha256:ee5ce1164be156eb267f3c3decb1163b4a20cab860101b5c36c96f746fc72931
```
...
```console
$ docker pull swipl@sha256:daf776866fccb5602073cdd9b810d2637d3ccaf0bfaee668c46716f9caeae795
```
