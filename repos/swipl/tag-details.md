...
```console
$ docker pull swipl@sha256:0144726879f6102e7f02dd619d479951a7d2bf89bcf16203febe9ac55c9c296b
```
...
```console
$ docker pull swipl@sha256:fd082caeffe19456514154d2d4e3c5a6aaaeae3558b5f2a83f24889a8bf3fed5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **78.8 MB (78825812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48cbac5dba7e140409318e6602ea404bcd7f1bc58fa6700c2e2ff1c42e66a21a`
-	Default Command: `["swipl"]`
...
-	Layers:
	...
	-	`sha256:cafd250e20f29aa70358e932e31c9900cb6f955512bad54498b6503e95bc50dd`  
		...
		Size: 30.0 MB (30002536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bf572fe66a91fa402f1b9e88b0d44a9ed9224bf272299f784c499ebcbfbc194`  
		Last Modified: Thu, 23 Mar 2023 14:51:32 GMT  
		Size: 17.4 MB (17411871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull swipl@sha256:22edcc0fa673276b53df04edc3f988e1188c88c36c0f1a8a7386a6a990de4b33
```
...
```console
$ docker pull swipl@sha256:220aec71fa20fc5d0c907f23a3790f2fe99825944f712c3b248c1554a7d10fed
```
