...
```console
$ docker pull swipl@sha256:baa5c0c8e6634515030a9b97287d0c70bf3deb9cb2348062d768fec39db0f3a5
```
...
```console
$ docker pull swipl@sha256:b3e35a36347b9de3435a271a23c768f70751bb97a3011d2e75158add47afb624
```
...
```console
$ docker pull swipl@sha256:f38adcad572f7f74dcd6d33f7adefdfc13c399488a9e5837d78d7230360e3f8c
```
...
```console
$ docker pull swipl@sha256:e52578d22fdc0ac214686f056a738a33f3f08033e9f7a52a419e7c298aa32801
```
