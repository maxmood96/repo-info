...
- Environment:
  ...
  - `LANG=C.UTF-8`
- Labels:
  - `maintainer=Dave Curylo <dave@curylo.org>, Michael Hendricks <michael@ndrix.org>`
...
### `dpkg` source package: `freetds=0.91-6.1`

Binary Packages:

- `freetds-common=0.91-6.1`
- `tdsodbc:amd64=0.91-6.1+b4`

Licenses: (parsed from: `/usr/share/doc/freetds-common/copyright`, `/usr/share/doc/tdsodbc/copyright`)
...
```console
$ apt-get source -qq --print-uris freetds=0.91-6.1
'http://deb.debian.org/debian/pool/main/f/freetds/freetds_0.91-6.1.dsc' freetds_0.91-6.1.dsc 2247 SHA256:b5e5571fad0a62afb0a2ee0ae29238a8b2c723fbbd1b023aa5e0c10f5a3b8daa
'http://deb.debian.org/debian/pool/main/f/freetds/freetds_0.91.orig.tar.gz' freetds_0.91.orig.tar.gz 2136329 SHA256:6a8148bd803aebceac6862b0dead1c5d9659f7e1038993abfe0ce8febb322465
'http://deb.debian.org/debian/pool/main/f/freetds/freetds_0.91-6.1.diff.gz' freetds_0.91-6.1.diff.gz 23021 SHA256:77cbb83c4596a791ebc81e4bd6c577f21a9da78c09d4823b8d8cca9510cb0db2
```

Other potentially useful URLs:

- https://sources.debian.net/src/freetds/0.91-6.1/ (for browsing the source)
- https://sources.debian.net/src/freetds/0.91-6.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/freetds/0.91-6.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `geos=3.5.1-3`

Binary Packages:

- `libgeos-3.5.1=3.5.1-3`
- `libgeos-c1v5=3.5.1-3`

Licenses: (parsed from: `/usr/share/doc/libgeos-3.5.1/copyright`, `/usr/share/doc/libgeos-c1v5/copyright`)
...
```console
$ apt-get source -qq --print-uris geos=3.5.1-3
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.5.1-3.dsc' geos_3.5.1-3.dsc 2311 SHA256:f0539dd472d1d063487ef2bb375e3a370e3f5c87b11dd0990da4b1c1357acd5f
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.5.1.orig.tar.bz2' geos_3.5.1.orig.tar.bz2 1930928 SHA256:e6bb0a7ba0e142b1e952fae9d946b2b532fa05a5c384e458f7cb8990e1fcac32
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.5.1-3.debian.tar.xz' geos_3.5.1-3.debian.tar.xz 44580 SHA256:a56d0d07f733d653fb10d77ea467cd38204253c085b85d78f19d6974db1252c6
```

Other potentially useful URLs:

- https://sources.debian.net/src/geos/3.5.1-3/ (for browsing the source)
...
'http://security.debian.org/debian-security/pool/updates/main/i/icu/icu_57.1-6+deb9u4.dsc' icu_57.1-6+deb9u4.dsc 2133 SHA256:80b9e9f411f713e7ba475959f083ba600cead528ab2c097448564f3ad9c0ffb5
...
'http://security.debian.org/debian-security/pool/updates/main/i/icu/icu_57.1-6+deb9u4.debian.tar.xz' icu_57.1-6+deb9u4.debian.tar.xz 36404 SHA256:37674a98793c0048ad8f7f8dc21d9ab14fd01b182c5ea764da3bae111f8afd63
```
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.2.2-2+deb9u2.dsc' libarchive_3.2.2-2+deb9u2.dsc 2644 SHA256:188d14846701eba7e6caaba30bbccc178b2fbce8690964bb2356018c7a0d438e
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.2.2-2+deb9u2.debian.tar.xz' libarchive_3.2.2-2+deb9u2.debian.tar.xz 20628 SHA256:0374969f2be08877324a97cf21a3e6ac73c1cde07c30d2b15b005a7da8429334
```
...
- `libossp-uuid16:amd64=1.6.2-1.5+b4`
...
```console
$ apt-get source -qq --print-uris ossp-uuid=1.6.2-1.5
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.2-1.5.dsc' ossp-uuid_1.6.2-1.5.dsc 1437 SHA256:93bb29568fe8610a455e03aec96622f6aefac43b7abe67532a8ea3c69ce633cb
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.2.orig.tar.gz' ossp-uuid_1.6.2.orig.tar.gz 397048 SHA256:11a615225baa5f8bb686824423f50e4427acd3f70d394765bdff32801f0fd5b0
'http://deb.debian.org/debian/pool/main/o/ossp-uuid/ossp-uuid_1.6.2-1.5.debian.tar.xz' ossp-uuid_1.6.2-1.5.debian.tar.xz 12504 SHA256:97d7f4a7e6bb6cc38653eecd6729a69b9f8953b6e97099ea5b0da914d9a0e768
```

Other potentially useful URLs:

- https://sources.debian.net/src/ossp-uuid/1.6.2-1.5/ (for browsing the source)
- https://sources.debian.net/src/ossp-uuid/1.6.2-1.5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ossp-uuid/1.6.2-1.5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-9.6=9.6.17-0+deb9u1`

Binary Packages:

- `libpq5:amd64=9.6.17-0+deb9u1`
...
```console
$ apt-get source -qq --print-uris postgresql-9.6=9.6.17-0+deb9u1
'http://security.debian.org/debian-security/pool/updates/main/p/postgresql-9.6/postgresql-9.6_9.6.17-0+deb9u1.dsc' postgresql-9.6_9.6.17-0+deb9u1.dsc 3698 SHA256:d7bd776c56f514fcdae757d0bc88b5d3311799eb436e1e389a6c0138c48cb40d
'http://security.debian.org/debian-security/pool/updates/main/p/postgresql-9.6/postgresql-9.6_9.6.17.orig.tar.bz2' postgresql-9.6_9.6.17.orig.tar.bz2 18812282 SHA256:f6e1e32d32545f97c066f3c19f4d58dfab1205c01252cf85c5c92294ace1a0c2
'http://security.debian.org/debian-security/pool/updates/main/p/postgresql-9.6/postgresql-9.6_9.6.17-0+deb9u1.debian.tar.xz' postgresql-9.6_9.6.17-0+deb9u1.debian.tar.xz 29964 SHA256:daae30d27d42300b52aeddd7280e03872bab9fd2baa0f939d6a2674e7172933b
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-9.6/9.6.17-0+deb9u1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-9.6/9.6.17-0+deb9u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-9.6/9.6.17-0+deb9u1/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/odbc-postgresql/copyright`)
...
```console
$ apt-get source -qq --print-uris psqlodbc=1:09.05.0400-2
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_09.05.0400-2.dsc' psqlodbc_09.05.0400-2.dsc 2230 SHA256:00d69f84dfd5abc80d6c7c2b4841a28cfd7ad25ac6de9b515b34527f06c6951a
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_09.05.0400.orig.tar.gz' psqlodbc_09.05.0400.orig.tar.gz 812613 SHA256:c9fde1c104065e81813d79eb29bb7e715d64697bdda031ff01e40e3ad59e3ad3
'http://deb.debian.org/debian/pool/main/p/psqlodbc/psqlodbc_09.05.0400-2.debian.tar.xz' psqlodbc_09.05.0400-2.debian.tar.xz 8852 SHA256:7074bcda03b8e671bbe509b5fecca13d680a1f9fcc37932d7628ab1dca52083a
```

Other potentially useful URLs:

- https://sources.debian.net/src/psqlodbc/1:09.05.0400-2/ (for browsing the source)
- https://sources.debian.net/src/psqlodbc/1:09.05.0400-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/psqlodbc/1:09.05.0400-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `serd=0.26.0~dfsg0-1`

Binary Packages:

- `libserd-0-0:amd64=0.26.0~dfsg0-1`
...
```console
$ apt-get source -qq --print-uris serd=0.26.0~dfsg0-1
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.26.0~dfsg0-1.dsc' serd_0.26.0~dfsg0-1.dsc 2247 SHA256:abddb53279dd1a31ae9ba327acb1dd4534fd7228640a7b90d94966d55d07fed3
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.26.0~dfsg0.orig.tar.xz' serd_0.26.0~dfsg0.orig.tar.xz 261004 SHA256:ca1009e5f10330c0e6bdad8daf60c45272eb958d9ecd37d7b30003072df45313
'http://deb.debian.org/debian/pool/main/s/serd/serd_0.26.0~dfsg0-1.debian.tar.xz' serd_0.26.0~dfsg0-1.debian.tar.xz 6352 SHA256:91676657b6892c219be9ddd7393868bb97c72b03eb8dee9275e8a2aa37c625d0
```

Other potentially useful URLs:

- https://sources.debian.net/src/serd/0.26.0~dfsg0-1/ (for browsing the source)
- https://sources.debian.net/src/serd/0.26.0~dfsg0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/serd/0.26.0~dfsg0-1/ (for access to the source package after it no longer exists in the archive)
...
- `libspatialindex4v5:amd64=1.8.5-4`

Licenses: (parsed from: `/usr/share/doc/libspatialindex4v5/copyright`)
...
```console
$ apt-get source -qq --print-uris spatialindex=1.8.5-4
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_1.8.5-4.dsc' spatialindex_1.8.5-4.dsc 2269 SHA256:98178564188cb47d47454daea3cf7b76b8d0df7a2108040cc80903853aefe3e7
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_1.8.5.orig.tar.bz2' spatialindex_1.8.5.orig.tar.bz2 407871 SHA256:31ec0a9305c3bd6b4ad60a5261cba5402366dd7d1969a8846099717778e9a50a
'http://deb.debian.org/debian/pool/main/s/spatialindex/spatialindex_1.8.5-4.debian.tar.xz' spatialindex_1.8.5-4.debian.tar.xz 18168 SHA256:7476516c3caf44a03663b08bce655fa1d5bcd4c5e68d693d277f97afad2c1d3e
```

Other potentially useful URLs:

- https://sources.debian.net/src/spatialindex/1.8.5-4/ (for browsing the source)
- https://sources.debian.net/src/spatialindex/1.8.5-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/spatialindex/1.8.5-4/ (for access to the source package after it no longer exists in the archive)
...
- `odbcinst=2.3.4-1`
- `odbcinst1debian2:amd64=2.3.4-1`
- `unixodbc=2.3.4-1`
