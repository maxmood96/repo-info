...
- Created: `2026-02-03T02:47:33.91397309Z`
...
### `dpkg` source package: `libarchive=3.6.2-1+deb12u3`

Binary Packages:

- `libarchive13:amd64=3.6.2-1+deb12u3`
...
```console
$ apt-get source -qq --print-uris libarchive=3.6.2-1+deb12u3
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.6.2-1%2bdeb12u3.dsc' libarchive_3.6.2-1+deb12u3.dsc 2561 SHA256:046ac1af7b20d70071e5171badc5df406ac3f2450828a568194a5b5e92814f24
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.6.2-1%2bdeb12u3.debian.tar.xz' libarchive_3.6.2-1+deb12u3.debian.tar.xz 31416 SHA256:2774090be2ba8e08f79b098284e7f72ec73583946d1abae199188af56013b4f2
```

Other potentially useful URLs:

- https://sources.debian.net/src/libarchive/3.6.2-1+deb12u3/ (for browsing the source)
- https://sources.debian.net/src/libarchive/3.6.2-1+deb12u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libarchive/3.6.2-1+deb12u3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `raptor2=2.0.15-4+deb12u1`
...
```console
$ apt-get source -qq --print-uris raptor2=2.0.15-4+deb12u1
'http://deb.debian.org/debian/pool/main/r/raptor2/raptor2_2.0.15-4%2bdeb12u1.dsc' raptor2_2.0.15-4+deb12u1.dsc 2208 SHA256:a89d88c60f06b2ad987bf0e7d2405f203bbe6a0e9960dd0ef36b1d13b86bdbef
...
'http://deb.debian.org/debian/pool/main/r/raptor2/raptor2_2.0.15-4%2bdeb12u1.debian.tar.xz' raptor2_2.0.15-4+deb12u1.debian.tar.xz 15308 SHA256:97cd215fcd4ab843e1a67b9e14443e7b7d70fc4c66fd05064ed6485614e6823b
```

Other potentially useful URLs:

- https://sources.debian.net/src/raptor2/2.0.15-4+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/raptor2/2.0.15-4+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/raptor2/2.0.15-4+deb12u1/ (for access to the source package after it no longer exists in the archive)
