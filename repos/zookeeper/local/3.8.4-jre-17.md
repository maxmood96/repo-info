...
- Image ID: `sha256:236ec809c3302980ca739a79609d7c4cf8bab21306872841dee0fe1ef4e9b5ff`
- Created: `2024-03-14T05:00:02Z`
- Virtual Size: ~ 306.05 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/docker-entrypoint.sh"]`
- Command: `["zkServer.sh","start-foreground"]`
- Environment:
  - `PATH=/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/apache-zookeeper-3.8.4-bin/bin`
