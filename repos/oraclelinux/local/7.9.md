...
- Created: `2020-10-08T16:36:45.587235597Z`
- Virtual Size: ~ 255.19 Mb  
...
### `rpm` package: `rsyslog-8.24.0-55.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-55.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-55.el7.src.rpm
```
