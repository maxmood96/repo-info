...
- Created: `2024-06-12T00:29:51.455440483Z`
...
### `rpm` package: `bind-export-libs-9.11.4-26.P2.el7_9.16.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.4-26.P2.el7_9.16
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.P2.el7_9.16.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.13.el7_9.9.x86_64`
...
```console
$ dnf --quiet download --source --url libgudev1-219-78.0.13.el7_9.9
