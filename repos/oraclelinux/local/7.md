...
- Created: `2019-12-20T01:46:11.099082225Z`
...
### `rpm` package: `bind-export-libs-9.11.4-9.P2.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls bind-export-libs-9.11.4-9.P2.el7
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/cryptsetup-2.0.3-5.el7.src.rpm
```
...
### `rpm` package: `device-mapper-1.02.158-2.0.1.el7_7.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-1.02.158-2.0.1.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.185-2.0.1.el7_7.2.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.158-2.0.1.el7_7.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-libs-1.02.158-2.0.1.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.185-2.0.1.el7_7.2.src.rpm
```

### `rpm` package: `dhclient-4.2.5-77.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhclient-4.2.5-77.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-77.0.1.el7.src.rpm
```

### `rpm` package: `dhcp-common-4.2.5-77.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhcp-common-4.2.5-77.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-77.0.1.el7.src.rpm
```

### `rpm` package: `dhcp-libs-4.2.5-77.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhcp-libs-4.2.5-77.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-77.0.1.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/hwdata-0.252-9.3.el7.src.rpm
```
...
### `rpm` package: `initscripts-9.49.47-1.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls initscripts-9.49.47-1.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/initscripts-9.49.47-1.0.1.el7.src.rpm
```
...
### `rpm` package: `kmod-20-25.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kmod-20-25.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/kmod-20-25.0.1.el7.src.rpm
```

### `rpm` package: `kmod-libs-20-25.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kmod-libs-20-25.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/kmod-20-25.0.1.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/device-mapper-multipath-0.4.9-127.el7.src.rpm
```
...
### `rpm` package: `libgudev1-219-67.0.5.el7_7.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-67.0.5.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-21.el7.src.rpm
```
...
### `rpm` package: `openssh-server-7.4p1-21.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-server-7.4p1-21.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-21.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/passwd-0.79-5.el7.src.rpm
```
...
### `rpm` package: `policycoreutils-2.5-33.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls policycoreutils-2.5-33.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/policycoreutils-2.5-33.0.1.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/procps-ng-3.3.10-26.el7_7.1.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-41.el7_7.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-41.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-41.el7_7.2.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls systemd-219-67.0.5.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.2.src.rpm
```

### `rpm` package: `systemd-libs-219-67.0.5.el7_7.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-67.0.5.el7_7.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/vim-7.4.629-6.el7.src.rpm
```
