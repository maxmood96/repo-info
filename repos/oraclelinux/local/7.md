...
- Created: `2021-05-06T00:10:23.494358897Z`
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.11.4-26.P2.el7_9.5.src.rpm
```
...
### `rpm` package: `device-mapper-1.02.170-6.0.3.el7_9.5.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-1.02.170-6.0.3.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.187-6.0.3.el7_9.5.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.170-6.0.3.el7_9.5.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-libs-1.02.170-6.0.3.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.187-6.0.3.el7_9.5.src.rpm
```
...
### `rpm` package: `kpartx-0.4.9-134.0.3.el7_9.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kpartx-0.4.9-134.0.3.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/device-mapper-multipath-0.4.9-134.0.3.el7_9.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.3.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-78.0.3.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.3.el7_9.3.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-57.0.1.el7_9.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-57.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-57.0.1.el7_9.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.3.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-78.0.3.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.3.el7_9.3.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.3.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-78.0.3.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.3.el7_9.3.src.rpm
```
