...
- Created: `2021-06-01T15:21:32.50913913Z`
...
### `rpm` package: `libgudev1-219-78.0.5.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-78.0.5.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.5.el7_9.3.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.5.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-78.0.5.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.5.el7_9.3.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.5.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-78.0.5.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.5.el7_9.3.src.rpm
```
