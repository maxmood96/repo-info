...
### `rpm` package: `bind-export-libs-9.11.4-26.0.1.P2.el7_9.16.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.4-26.0.1.P2.el7_9.16
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.0.1.P2.el7_9.16.src.rpm
```
...
### `rpm` package: `dhclient-4.2.5-83.0.3.el7_9.2.x86_64`
...
```console
$ dnf --quiet download --source --url dhclient-4.2.5-83.0.3.el7_9.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.2.src.rpm
```

### `rpm` package: `dhcp-common-4.2.5-83.0.3.el7_9.2.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.2.5-83.0.3.el7_9.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.2.src.rpm
```

### `rpm` package: `dhcp-libs-4.2.5-83.0.3.el7_9.2.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-libs-4.2.5-83.0.3.el7_9.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.2.src.rpm
```
...
### `rpm` package: `initscripts-9.49.53-1.0.5.el7_9.1.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-9.49.53-1.0.5.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/initscripts-9.49.53-1.0.5.el7_9.1.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.17.el7_9.9.x86_64`
...
```console
$ dnf --quiet download --source --url libgudev1-219-78.0.17.el7_9.9
...
### `rpm` package: `openssh-7.4p1-23.0.3.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-7.4p1-23.0.3.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.3.el7_9.src.rpm
```

### `rpm` package: `openssh-clients-7.4p1-23.0.3.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-7.4p1-23.0.3.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.3.el7_9.src.rpm
```

### `rpm` package: `openssh-server-7.4p1-23.0.3.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-7.4p1-23.0.3.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.3.el7_9.src.rpm
```
