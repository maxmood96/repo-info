...
- Created: `2021-11-24T22:08:48.648136367Z`
...
```console
$ yumdownloader --quiet --source --urls bind-export-libs-9.11.4-26.P2.el7_9.8
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.11.4-26.P2.el7_9.8.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls device-mapper-1.02.170-6.0.5.el7_9.5
...
```console
$ yumdownloader --quiet --source --urls device-mapper-libs-1.02.170-6.0.5.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.187-6.0.5.el7_9.5.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls dhclient-4.2.5-83.0.1.el7_9.1
...
```console
$ yumdownloader --quiet --source --urls dhcp-common-4.2.5-83.0.1.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-83.0.1.el7_9.1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls dhcp-libs-4.2.5-83.0.1.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-83.0.1.el7_9.1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls hwdata-0.252-9.7.0.1.el7
...
```console
$ yumdownloader --quiet --source --urls kpartx-0.4.9-135.0.1.el7_9
...
### `rpm` package: `libgudev1-219-78.0.7.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-78.0.7.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.7.el7_9.3.src.rpm
```
...
### `rpm` package: `libsmartcols-2.23.2-65.0.1.el7_9.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libsmartcols-2.23.2-65.0.1.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/util-linux-2.23.2-65.0.1.el7_9.1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls openssh-7.4p1-22.0.1.el7_9
...
```console
$ yumdownloader --quiet --source --urls openssh-clients-7.4p1-22.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-22.0.1.el7_9.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls openssh-server-7.4p1-22.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-22.0.1.el7_9.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-57.0.1.el7_9.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-57.0.1.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-57.0.1.el7_9.1.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.7.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-78.0.7.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.7.el7_9.3.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.7.el7_9.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-78.0.7.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.7.el7_9.3.src.rpm
```
...
### `rpm` package: `util-linux-2.23.2-65.0.1.el7_9.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls util-linux-2.23.2-65.0.1.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/util-linux-2.23.2-65.0.1.el7_9.1.src.rpm
```
