...
- Created: `2020-10-22T02:16:33.858027007Z`
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.11.4-26.P2.el7.src.rpm
```
...
### `rpm` package: `device-mapper-1.02.170-6.0.3.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-1.02.170-6.0.3.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.187-6.0.3.el7.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.170-6.0.3.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-libs-1.02.170-6.0.3.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.187-6.0.3.el7.src.rpm
```
...
### `rpm` package: `dracut-033-572.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dracut-033-572.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dracut-033-572.0.1.el7.src.rpm
```
...
### `rpm` package: `initscripts-9.49.53-1.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls initscripts-9.49.53-1.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/initscripts-9.49.53-1.0.1.el7.src.rpm
```
...
### `rpm` package: `kpartx-0.4.9-133.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kpartx-0.4.9-133.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/device-mapper-multipath-0.4.9-133.0.1.el7.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-78.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-78.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-78.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-78.0.1.el7.src.rpm
```
...
### `rpm` package: `vim-minimal-7.4.629-7.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls vim-minimal-7.4.629-7.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/vim-7.4.629-7.0.1.el7.src.rpm
```
