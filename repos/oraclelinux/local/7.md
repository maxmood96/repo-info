...
- Created: `2023-10-12T21:28:56.715452395Z`
...
### `rpm` package: `bind-export-libs-9.11.4-26.P2.el7_9.14.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.4-26.P2.el7_9.14
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.P2.el7_9.14.src.rpm
```
