...
- Created: `2026-05-06T19:39:27.077041653Z`
...
### `rpm` package: `openssh-8.7p1-49.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-49.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-49.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-49.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-49.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-49.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-49.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-3.9.25-3.0.1.el9_7.3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-3.0.1.el9_7.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.3.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-3.0.1.el9_7.3.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-3.0.1.el9_7.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.3.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-23.0.1.el9_7.3.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.0.1.el9_7.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.3.src.rpm
```
