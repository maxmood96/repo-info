...
- Created: `2024-07-08T23:20:15.887516252Z`
- Virtual Size: ~ 236.48 Mb  
...
### `rpm` package: `openssh-8.7p1-38.0.2.el9_4.1.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-38.0.2.el9_4.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-38.0.2.el9_4.1.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-38.0.2.el9_4.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-38.0.2.el9_4.1.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-38.0.2.el9_4.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.1.src.rpm
```
