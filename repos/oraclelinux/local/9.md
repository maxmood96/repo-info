...
### `rpm` package: `dnf-4.14.0-25.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-25.0.1.el9.noarch
...
### `rpm` package: `dnf-plugins-core-4.3.0-20.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-20.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-168.0.1.el9_6.19.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-168.0.1.el9_6.19
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.19.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.19.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/ima-evm-utils-1.5-3.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-6.11.0-1.el9.src.rpm
```

### `rpm` package: `iputils-20210202-11.0.1.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-11.0.1.el9_6.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-11.0.1.el9_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-11.0.1.el9_6.1.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-5.0.1.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-5.0.1.el9_5
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-5.0.1.el9_5.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-5.0.1.el9_5.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libuser-0.63-16.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-45.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-45.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-45.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-45.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-45.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-45.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-45.0.2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.21-2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.21-2.el9.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-25.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-25.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-25.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-25.0.1.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-20.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-20.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-13.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-13.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-13.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-13.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-13.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-13.0.1.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rootfiles-8.1-34.el9.src.rpm
```
...
### `rpm` package: `rsyslog-8.2412.0-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2412.0-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2412.0-1.0.1.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-22.0.1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-22.0.1.el9_6
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-22.0.1.el9_6.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-22.0.1.el9_6.src.rpm
```
...
### `rpm` package: `yum-4.14.0-25.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-25.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-25.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-25.0.1.el9.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-20.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-20.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-20.0.1.el9.src.rpm
```
