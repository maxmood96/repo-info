...
- Created: `2026-05-04T22:03:19.618647487Z`
...
### `rpm` package: `openssh-8.7p1-48.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-48.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-48.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-48.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-48.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-48.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-48.0.1.el9_7.src.rpm
```
