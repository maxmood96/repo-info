...
### `rpm` package: `glibc-langpack-en-2.34-168.0.1.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-168.0.1.el9_6.23
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-168.0.1.el9_6.23.src.rpm
```
...
### `rpm` package: `iputils-20210202-11.0.1.el9_6.3.x86_64`
...
```console
$ dnf --quiet download --source --url iputils-20210202-11.0.1.el9_6.3
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/iputils-20210202-11.0.1.el9_6.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iputils-20210202-11.0.1.el9_6.3.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-22.0.1.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-22.0.1.el9_6.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-22.0.1.el9_6.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-22.0.1.el9_6.1.src.rpm
```
