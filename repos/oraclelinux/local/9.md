...
- Created: `2026-04-17T23:38:58.752150362Z`
...
### `rpm` package: `python3-3.9.25-3.0.1.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-3.0.1.el9_7.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.2.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-3.0.1.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-3.0.1.el9_7.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.2.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-23.0.1.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.0.1.el9_7.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.2.src.rpm
```
