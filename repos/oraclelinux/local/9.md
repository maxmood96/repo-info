...
- Created: `2025-12-01T23:45:38.754495936Z`
...
### `rpm` package: `coreutils-8.32-39.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-common-8.32-39.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/coreutils-8.32-39.0.1.el9.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-31.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-31.0.1.el9.noarch
...
### `rpm` package: `dnf-plugins-core-4.3.0-23.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-23.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-231.0.1.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-231.0.1.el9_7.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/iproute-6.14.0-2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libbpf-1.5.0-1.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-11.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-11.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-11.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-11.0.1.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-46.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-46.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-46.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-46.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-46.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-46.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-46.0.2.el9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/policycoreutils-3.6-3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/policycoreutils-3.6-3.el9.src.rpm
```
...
### `rpm` package: `python3-dnf-4.14.0-31.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-31.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-31.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-31.0.1.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-23.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-23.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-16.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-16.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-16.0.1.el9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-16.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-16.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-16.0.1.el9.src.rpm
```
...
### `rpm` package: `rsyslog-8.2506.0-2.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2506.0-2.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rsyslog-8.2506.0-2.0.1.el9.src.rpm
```
...
### `rpm` package: `systemd-252-55.0.3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-55.0.3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
```

### `rpm` package: `systemd-libs-252-55.0.3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-55.0.3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
```

### `rpm` package: `systemd-pam-252-55.0.3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-55.0.3.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-55.0.3.el9.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-55.0.3.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/systemd-252-55.0.3.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-23.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.src.rpm
```
...
### `rpm` package: `yum-4.14.0-31.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-31.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-4.14.0-31.0.1.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-4.14.0-31.0.1.el9.src.rpm
```

### `rpm` package: `yum-utils-4.3.0-23.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-23.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-23.0.1.el9_7.src.rpm
```
