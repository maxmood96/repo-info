...
- Created: `2026-01-30T23:39:03.148581516Z`
...
### `rpm` package: `python3-3.9.25-3.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-3.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-3.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-3.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.src.rpm
```
