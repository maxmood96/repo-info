...
### `rpm` package: `chkconfig-1.24-1.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url chkconfig-1.24-1.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/chkconfig-1.24-1.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/chkconfig-1.24-1.0.2.el9.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-100.0.1.el9_4.4.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-100.0.1.el9_4.4
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-100.0.1.el9_4.4.src.rpm
```
...
### `rpm` package: `initscripts-10.11.6-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-10.11.6-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.6-1.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-rename-device-10.11.6-1.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url initscripts-rename-device-10.11.6-1.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.6-1.0.1.el9.src.rpm
```

### `rpm` package: `initscripts-service-10.11.6-1.0.1.el9.noarch`
...
```console
$ dnf --quiet download --source --url initscripts-service-10.11.6-1.0.1.el9.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/initscripts-10.11.6-1.0.1.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-38.0.2.el9_4.4.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-38.0.2.el9_4.4
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-38.0.2.el9_4.4.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-38.0.2.el9_4.4
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-38.0.2.el9_4.4.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-38.0.2.el9_4.4
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-38.0.2.el9_4.4.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-8.0.1.el9_4.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-8.0.1.el9_4.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-8.0.1.el9_4.1.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-8.0.1.el9_4.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-8.0.1.el9_4.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-8.0.1.el9_4.1.src.rpm
```
