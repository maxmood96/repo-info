...
- Created: `2026-03-25T18:51:09.226380237Z`
- Virtual Size: ~ 237.89 Mb  
...
### `rpm` package: `dnf-plugins-core-4.3.0-24.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.3.0-24.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.34-231.0.1.el9_7.10.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.34-231.0.1.el9_7.10
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-231.0.1.el9_7.10.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-11.0.2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-11.0.2.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/gcc-11.5.0-11.0.2.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-47.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-47.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-47.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-47.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
```

### `rpm` package: `openssh-server-8.7p1-47.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.7p1-47.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/openssh-8.7p1-47.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-3.9.25-3.0.1.el9_7.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-3.0.1.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.1.src.rpm
```
...
### `rpm` package: `python3-dnf-plugins-core-4.3.0-24.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-24.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-17.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-17.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-17.0.1.el9_7.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-17.0.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-17.0.1.el9_7
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/libdnf-0.69.0-17.0.1.el9_7.src.rpm
```

### `rpm` package: `python3-libs-3.9.25-3.0.1.el9_7.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-3.0.1.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.25-3.0.1.el9_7.1.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-23.0.1.el9_7.1.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.0.1.el9_7.1
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/vim-8.2.2637-23.0.1.el9_7.1.src.rpm
```
...
### `rpm` package: `yum-utils-4.3.0-24.0.1.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.3.0-24.0.1.el9_7.noarch
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.3.0-24.0.1.el9_7.src.rpm
```
