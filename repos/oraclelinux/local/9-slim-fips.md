...
- Image ID: `sha256:8bcfa01cc34253f3fbc53b209ed581059d04c6656023814c25a7906814ec7ddb`
- Created: `2026-03-20T00:15:25.858009528Z`
...
### `rpm` package: `gnutls-3.8.3-10.el9_7_fips.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.8.3-10.el9_7_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/gnutls-3.8.3-10.el9_7_fips.src.rpm
```
...
### `rpm` package: `openssl-libs-3.5.1-7.0.1.el9_7_fips.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.1-7.0.1.el9_7_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/openssl-3.5.1-7.0.1.el9_7_fips.src.rpm
```
