...
- Image ID: `sha256:5457dc8af9b3178d83279b308dc2ca3acf1c5f52403d0ba7837a5cdea56c6166`
- Created: `2025-07-16T17:17:10Z`
- Virtual Size: ~ 113.84 Mb  
...
### `rpm` package: `gnutls-3.8.3-6.el9_fips.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.8.3-6.el9_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/gnutls-3.8.3-6.el9_fips.src.rpm
```
...
### `rpm` package: `openssl-libs-3.2.2-6.0.1.el9_5.1_fips.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.2.2-6.0.1.el9_5.1_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/openssl-3.2.2-6.0.1.el9_5.1_fips.src.rpm
```
