...
- Image ID: `sha256:530b4b73cf74b42f7ab67267d5bfd615afbe815523a96f671f0bc5bf5e35f83d`
- Created: `2025-12-01T23:44:59.173968034Z`
...
### `rpm` package: `fips-provider-next-1.2.0-5.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url fips-provider-next-1.2.0-5.0.1.el9
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/fips-provider-next-1.2.0-5.0.1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url glib2-2.68.4-16.el9_6.3
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glib2-2.68.4-16.el9_6.3.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glib2-2.68.4-16.el9_6.3.src.rpm
```
...
### `rpm` package: `gnutls-3.8.3-9.el9_fips.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.8.3-9.el9_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/gnutls-3.8.3-9.el9_fips.src.rpm
```
...
### `rpm` package: `libgcrypt-1.10.0-11.el9_fips.x86_64`
...
```console
$ dnf --quiet download --source --url libgcrypt-1.10.0-11.el9_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/libgcrypt-1.10.0-11.el9_fips.src.rpm
```
...
### `rpm` package: `openssl-libs-3.5.1-4.0.2.el9_7_fips.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.1-4.0.2.el9_7_fips
https://yum.oracle.com/repo/OracleLinux/OL9/3/security/validation/x86_64/getPackageSource/openssl-3.5.1-4.0.2.el9_7_fips.src.rpm
```
