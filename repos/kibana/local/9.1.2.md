...
- Image ID: `sha256:2003e6c42e1ee031328ed454c8433639cf4e05877a12e2cf432e7a014433ce12`
- Created: `2025-08-12T11:49:08Z`
...
- Labels:
  ...
  - `name=Kibana`
  - `org.label-schema.build-date=2025-08-11T16:35:56.587Z`
...
### `rpm` package: `liberation-fonts-common-2.1.3-5.el9.noarch`
...
```console
$ dnf --quiet download --source --url liberation-fonts-common-2.1.3-5.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/l/liberation-fonts-2.1.3-5.el9.src.rpm
```
