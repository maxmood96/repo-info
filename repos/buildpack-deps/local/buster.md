...
- Created: `2024-06-13T03:44:20.38175588Z`
- Virtual Size: ~ 803.13 Mb  
...
### `dpkg` source package: `curl=7.64.0-4+deb10u9`

Binary Packages:

- `curl=7.64.0-4+deb10u9`
- `libcurl3-gnutls:amd64=7.64.0-4+deb10u9`
- `libcurl4:amd64=7.64.0-4+deb10u9`
- `libcurl4-openssl-dev:amd64=7.64.0-4+deb10u9`
...
```console
$ apt-get source -qq --print-uris curl=7.64.0-4+deb10u9
'http://deb.debian.org/debian-security/pool/updates/main/c/curl/curl_7.64.0-4%2bdeb10u9.dsc' curl_7.64.0-4+deb10u9.dsc 2719 SHA256:4aa1619bb94edf34dc8c66fce4665089a9d2daa78ddaf0af7c9d63180b5bd306
...
'http://deb.debian.org/debian-security/pool/updates/main/c/curl/curl_7.64.0-4%2bdeb10u9.debian.tar.xz' curl_7.64.0-4+deb10u9.debian.tar.xz 72416 SHA256:ca0718f3388879cc2c7b6db8d5d784c88ac599721812888c45d84b63c454ef58
```

Other potentially useful URLs:

- https://sources.debian.net/src/curl/7.64.0-4+deb10u9/ (for browsing the source)
- https://sources.debian.net/src/curl/7.64.0-4+deb10u9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/curl/7.64.0-4+deb10u9/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `expat=2.2.6-2+deb10u7`

Binary Packages:

- `libexpat1:amd64=2.2.6-2+deb10u7`
- `libexpat1-dev:amd64=2.2.6-2+deb10u7`
...
```console
$ apt-get source -qq --print-uris expat=2.2.6-2+deb10u7
'http://deb.debian.org/debian-security/pool/updates/main/e/expat/expat_2.2.6-2%2bdeb10u7.dsc' expat_2.2.6-2+deb10u7.dsc 1981 SHA256:d2544ddde86b80328d975ea7747f61670769e516c0ace034995a151ea3ad6659
...
'http://deb.debian.org/debian-security/pool/updates/main/e/expat/expat_2.2.6-2%2bdeb10u7.debian.tar.xz' expat_2.2.6-2+deb10u7.debian.tar.xz 78596 SHA256:92659584405905570ca3b5295e4a1106eff4eeae70795004276c801bbbed2490
```

Other potentially useful URLs:

- https://sources.debian.net/src/expat/2.2.6-2+deb10u7/ (for browsing the source)
- https://sources.debian.net/src/expat/2.2.6-2+deb10u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/expat/2.2.6-2+deb10u7/ (for access to the source package after it no longer exists in the archive)
...
- http://snapshot.debian.org/package/git/1:2.20.1-2+deb10u8/
...
- `libgnutls-dane0:amd64=3.6.7-4+deb10u12`
- `libgnutls-openssl27:amd64=3.6.7-4+deb10u12`
- `libgnutls28-dev:amd64=3.6.7-4+deb10u12`
- `libgnutls30:amd64=3.6.7-4+deb10u12`
- `libgnutlsxx28:amd64=3.6.7-4+deb10u12`
...
### `dpkg` source package: `imagemagick=8:6.9.10.23+dfsg-2.1+deb10u7`

Binary Packages:

- `imagemagick=8:6.9.10.23+dfsg-2.1+deb10u7`
- `imagemagick-6-common=8:6.9.10.23+dfsg-2.1+deb10u7`
- `imagemagick-6.q16=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-6-arch-config:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-6-headers=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-6.q16-6:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-6.q16-6-extra:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-6.q16-dev:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickcore-dev=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickwand-6-headers=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickwand-6.q16-6:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
- `libmagickwand-6.q16-dev:amd64=8:6.9.10.23+dfsg-2.1+deb10u7`
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.9.10.23+dfsg-2.1+deb10u7
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.10.23%2bdfsg-2.1%2bdeb10u7.dsc' imagemagick_6.9.10.23+dfsg-2.1+deb10u7.dsc 5239 SHA256:47484df76dc887fa59823061d63a69564e654940013f4940159549d67a01ff6b
...
'http://deb.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.9.10.23%2bdfsg-2.1%2bdeb10u7.debian.tar.xz' imagemagick_6.9.10.23+dfsg-2.1+deb10u7.debian.tar.xz 267020 SHA256:249b3fb7f114074af2126215f9ae3cb4d02fbc7dfa54240d7b2249cfd40d624a
```

Other potentially useful URLs:

- https://sources.debian.net/src/imagemagick/8:6.9.10.23+dfsg-2.1+deb10u7/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.9.10.23+dfsg-2.1+deb10u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.9.10.23+dfsg-2.1+deb10u7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-11=11.22-0+deb10u2`

Binary Packages:

- `libpq-dev=11.22-0+deb10u2`
- `libpq5:amd64=11.22-0+deb10u2`
...
```console
$ apt-get source -qq --print-uris postgresql-11=11.22-0+deb10u2
'http://deb.debian.org/debian-security/pool/updates/main/p/postgresql-11/postgresql-11_11.22-0%2bdeb10u2.dsc' postgresql-11_11.22-0+deb10u2.dsc 3745 SHA256:69cdceb7d5dff9b822b5c84c08454e93b1528c5086c250eaa6a5c28a6e34cee5
...
'http://deb.debian.org/debian-security/pool/updates/main/p/postgresql-11/postgresql-11_11.22-0%2bdeb10u2.debian.tar.xz' postgresql-11_11.22-0+deb10u2.debian.tar.xz 31264 SHA256:addff5d61239c7f376b0378cc5ba99d164f5e08c30a71958bcab9711f6f804e5
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-11/11.22-0+deb10u2/ (for browsing the source)
- https://sources.debian.net/src/postgresql-11/11.22-0+deb10u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-11/11.22-0+deb10u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python2.7=2.7.16-2+deb10u4`

Binary Packages:

- `libpython2.7-minimal:amd64=2.7.16-2+deb10u4`
- `libpython2.7-stdlib:amd64=2.7.16-2+deb10u4`
- `python2.7=2.7.16-2+deb10u4`
- `python2.7-minimal=2.7.16-2+deb10u4`
...
```console
$ apt-get source -qq --print-uris python2.7=2.7.16-2+deb10u4
'http://deb.debian.org/debian-security/pool/updates/main/p/python2.7/python2.7_2.7.16-2%2bdeb10u4.dsc' python2.7_2.7.16-2+deb10u4.dsc 3362 SHA256:2368bdba0dd8c10066ebb5eb092a6191d381dc3ce1c65ee811b0aca7c928a9e0
...
'http://deb.debian.org/debian-security/pool/updates/main/p/python2.7/python2.7_2.7.16-2%2bdeb10u4.diff.gz' python2.7_2.7.16-2+deb10u4.diff.gz 331877 SHA256:9cb6366a7a6959e449f68876c1c9f7db7e70df380e59a79901cbb57ed5eda18e
```

Other potentially useful URLs:

- https://sources.debian.net/src/python2.7/2.7.16-2+deb10u4/ (for browsing the source)
- https://sources.debian.net/src/python2.7/2.7.16-2+deb10u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python2.7/2.7.16-2+deb10u4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python3.7=3.7.3-2+deb10u7`

Binary Packages:

- `libpython3.7-minimal:amd64=3.7.3-2+deb10u7`
- `libpython3.7-stdlib:amd64=3.7.3-2+deb10u7`
- `python3.7=3.7.3-2+deb10u7`
...
```console
$ apt-get source -qq --print-uris python3.7=3.7.3-2+deb10u7
'http://deb.debian.org/debian-security/pool/updates/main/p/python3.7/python3.7_3.7.3-2%2bdeb10u7.dsc' python3.7_3.7.3-2+deb10u7.dsc 3404 SHA256:587d3af05bda31fcec4aca7157b73168f28ac5552d87eff0d2579b928ffddce3
...
'http://deb.debian.org/debian-security/pool/updates/main/p/python3.7/python3.7_3.7.3-2%2bdeb10u7.debian.tar.xz' python3.7_3.7.3-2+deb10u7.debian.tar.xz 253612 SHA256:b01fd29bf12e7e51f0210bce89fc99345e8887e1ba35318dfa0be1f07a29d0ab
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.7/3.7.3-2+deb10u7/ (for browsing the source)
- https://sources.debian.net/src/python3.7/3.7.3-2+deb10u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.7/3.7.3-2+deb10u7/ (for access to the source package after it no longer exists in the archive)
...
- `libtiff-dev:amd64=4.1.0+git191117-2~deb10u9`
- `libtiff5:amd64=4.1.0+git191117-2~deb10u9`
- `libtiffxx5:amd64=4.1.0+git191117-2~deb10u9`
...
### `dpkg` source package: `unbound=1.9.0-2+deb10u4`

Binary Packages:

- `libunbound8:amd64=1.9.0-2+deb10u4`
...
```console
$ apt-get source -qq --print-uris unbound=1.9.0-2+deb10u4
'http://deb.debian.org/debian-security/pool/updates/main/u/unbound/unbound_1.9.0-2%2bdeb10u4.dsc' unbound_1.9.0-2+deb10u4.dsc 3209 SHA256:eb3725142a45ff8211d8b2f8ab0506a58cb5503a6c7527cafb5fe072c4912fa1
...
'http://deb.debian.org/debian-security/pool/updates/main/u/unbound/unbound_1.9.0-2%2bdeb10u4.debian.tar.xz' unbound_1.9.0-2+deb10u4.debian.tar.xz 50628 SHA256:37e6fa5153d01ce11240287feb874978c7d3ab76b7f1203050a9a1a7bd2be5be
```

Other potentially useful URLs:

- https://sources.debian.net/src/unbound/1.9.0-2+deb10u4/ (for browsing the source)
- https://sources.debian.net/src/unbound/1.9.0-2+deb10u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unbound/1.9.0-2+deb10u4/ (for access to the source package after it no longer exists in the archive)
...
- `libblkid-dev:amd64=2.33.1-0.1+deb10u1`
- `libblkid1:amd64=2.33.1-0.1+deb10u1`
- `libfdisk1:amd64=2.33.1-0.1+deb10u1`
- `libmount-dev:amd64=2.33.1-0.1+deb10u1`
...
- `uuid-dev:amd64=2.33.1-0.1+deb10u1`
