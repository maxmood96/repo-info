...
### `dpkg` source package: `adduser=3.145`
...
```console
$ apt-get source -qq --print-uris adduser=3.145
'http://deb.debian.org/debian/pool/main/a/adduser/adduser_3.145.dsc' adduser_3.145.dsc 1678 SHA256:3f059f21fdba3eb6b82b81e434f8f188f7d1c1818226429ecd61c17872ce21e0
'http://deb.debian.org/debian/pool/main/a/adduser/adduser_3.145.tar.xz' adduser_3.145.tar.xz 322616 SHA256:a8f909e00760da0dc43c9db7841f31d4a6f60b32390ffd6bf9a85abf1adfe8ce
```

Other potentially useful URLs:

- https://sources.debian.net/src/adduser/3.145/ (for browsing the source)
- https://sources.debian.net/src/adduser/3.145/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/adduser/3.145/ (for access to the source package after it no longer exists in the archive)
...
- `curl=8.12.1-3`
- `libcurl3t64-gnutls:amd64=8.12.1-3`
- `libcurl4-openssl-dev:amd64=8.12.1-3`
...
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.12.1-3.dsc' curl_8.12.1-3.dsc 3252 SHA256:3c3918ce2f3863f801b95071f71eed9bf95bcfe8fb0fd1b5e48ab3157c24fc4c
...
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.12.1-3.debian.tar.xz' curl_8.12.1-3.debian.tar.xz 53716 SHA256:550dcaf7cc74556a2f1f45d068aaa694e4d89a6dc651c302745f358073fcaf08
```

Other potentially useful URLs:

- https://sources.debian.net/src/curl/8.12.1-3/ (for browsing the source)
- https://sources.debian.net/src/curl/8.12.1-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/curl/8.12.1-3/ (for access to the source package after it no longer exists in the archive)
...
- `libfontconfig-dev:amd64=2.15.0-2.1`
...
- `gir1.2-glib-2.0:amd64=2.84.0-2`
- `gir1.2-glib-2.0-dev:amd64=2.84.0-2`
- `girepository-tools:amd64=2.84.0-2`
- `libgio-2.0-dev:amd64=2.84.0-2`
- `libgio-2.0-dev-bin=2.84.0-2`
- `libgirepository-2.0-0:amd64=2.84.0-2`
- `libglib2.0-0t64:amd64=2.84.0-2`
- `libglib2.0-bin=2.84.0-2`
- `libglib2.0-data=2.84.0-2`
- `libglib2.0-dev:amd64=2.84.0-2`
...
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.84.0-2.dsc' glib2.0_2.84.0-2.dsc 4812 SHA256:745444c7b330cb3618319945af5d83a70f5ae16324d31c1da492607bc25b2a9e
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.84.0.orig-unicode-data.tar.xz' glib2.0_2.84.0.orig-unicode-data.tar.xz 660708 SHA256:c1742461e8c0e9673a3453a3127671169de9cb0138493e5c916f1b989530efcd
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.84.0.orig.tar.xz' glib2.0_2.84.0.orig.tar.xz 5613328 SHA256:f8823600cb85425e2815cfad82ea20fdaa538482ab74e7293d58b3f64a5aff6a
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.84.0-2.debian.tar.xz' glib2.0_2.84.0-2.debian.tar.xz 172092 SHA256:f9b953ac71670bf0bf2e4fe4751b3770a992e6d7d9e8baccd51f311213c89c10
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.84.0-2/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.84.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.84.0-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gobject-introspection=1.83.4-1`

Binary Packages:

- `gir1.2-freedesktop:amd64=1.83.4-1`
- `gir1.2-freedesktop-dev:amd64=1.83.4-1`
...
```console
$ apt-get source -qq --print-uris gobject-introspection=1.83.4-1
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.83.4-1.dsc' gobject-introspection_1.83.4-1.dsc 4073 SHA256:83b54dd01f78dfa279974b23707cdbb26b28fd43d5e9a757c9b017d556b11611
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.83.4.orig-glib.tar.xz' gobject-introspection_1.83.4.orig-glib.tar.xz 5475296 SHA256:b3764dd6e29b664085921dd4dd6ba2430fc19760ab6857ecfa3ebd4e8c1d114c
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.83.4.orig.tar.xz' gobject-introspection_1.83.4.orig.tar.xz 1080376 SHA256:86f02e689ff4df362b2d0f0a9acc262ace5dc3e71c9078bdba69246748213855
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.83.4-1.debian.tar.xz' gobject-introspection_1.83.4-1.debian.tar.xz 58716 SHA256:912e6f340dfa410beddbdd30b3ea13323a041dcdcc7e41e627859f9e2841ff4c
```

Other potentially useful URLs:

- https://sources.debian.net/src/gobject-introspection/1.83.4-1/ (for browsing the source)
- https://sources.debian.net/src/gobject-introspection/1.83.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gobject-introspection/1.83.4-1/ (for access to the source package after it no longer exists in the archive)
...
- `libheif-plugin-dav1d:amd64=1.19.7-1`
- `libheif-plugin-libde265:amd64=1.19.7-1`
- `libheif1:amd64=1.19.7-1`
...
```console
$ apt-get source -qq --print-uris libidn2=2.3.8-1
'http://deb.debian.org/debian/pool/main/libi/libidn2/libidn2_2.3.8-1.dsc' libidn2_2.3.8-1.dsc 2961 SHA256:c32644a80d68ffae53b2063eeecc00d11910fa50d80b2311c9199b28311c690c
...
'http://deb.debian.org/debian/pool/main/libi/libidn2/libidn2_2.3.8-1.debian.tar.xz' libidn2_2.3.8-1.debian.tar.xz 17220 SHA256:dc77c0136bb917301d3ca8b2922f17e74760bfb5fe258a5a5f5d42dcdc8636c5
```

Other potentially useful URLs:

- https://sources.debian.net/src/libidn2/2.3.8-1/ (for browsing the source)
- https://sources.debian.net/src/libidn2/2.3.8-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libidn2/2.3.8-1/ (for access to the source package after it no longer exists in the archive)
...
- `libxml2:amd64=2.12.7+dfsg+really2.9.14-0.2+b2`
- `libxml2-dev:amd64=2.12.7+dfsg+really2.9.14-0.2+b2`
...
### `dpkg` source package: `linux=6.12.17-1`

Binary Packages:

- `linux-libc-dev=6.12.17-1`
...
```console
$ apt-get source -qq --print-uris linux=6.12.17-1
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.12.17-1.dsc' linux_6.12.17-1.dsc 206708 SHA256:5286349102d546dc77f4928f66464bbabd8d3d09afb47539bb39605c7b4107ee
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.12.17.orig.tar.xz' linux_6.12.17.orig.tar.xz 150943664 SHA256:4cf73e404bc6b9b32b942c5c163adb6e2cac15e4ba40d8e8afe8d4e48080d707
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.12.17-1.debian.tar.xz' linux_6.12.17-1.debian.tar.xz 1597364 SHA256:f9f8a54d3bfe88e34c5ed24eec51659495c41b995209707e29734032d3e94f25
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/6.12.17-1/ (for browsing the source)
- https://sources.debian.net/src/linux/6.12.17-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/6.12.17-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `m4=1.4.19-7`
...
```console
$ apt-get source -qq --print-uris m4=1.4.19-7
'http://deb.debian.org/debian/pool/main/m/m4/m4_1.4.19-7.dsc' m4_1.4.19-7.dsc 1755 SHA256:c23e935c0aec078d12d34e29982307c903ced3baa03ea236486d72aabd124ba7
...
'http://deb.debian.org/debian/pool/main/m/m4/m4_1.4.19-7.debian.tar.xz' m4_1.4.19-7.debian.tar.xz 18024 SHA256:3c4a5fc77db322c370523d2a68e7f9f6e3c00916bd57e5536399de295b83441b
```

Other potentially useful URLs:

- https://sources.debian.net/src/m4/1.4.19-7/ (for browsing the source)
- https://sources.debian.net/src/m4/1.4.19-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/m4/1.4.19-7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mercurial=6.9.2-1`

Binary Packages:

- `mercurial=6.9.2-1`
- `mercurial-common=6.9.2-1`
...
- http://snapshot.debian.org/package/mercurial/6.9.2-1/
...
- `libldap-dev:amd64=2.6.9+dfsg-2`
...
### `dpkg` source package: `postgresql-17=17.4-1`

Binary Packages:

- `libpq-dev=17.4-1+b1`
- `libpq5:amd64=17.4-1+b1`
...
```console
$ apt-get source -qq --print-uris postgresql-17=17.4-1
'http://deb.debian.org/debian/pool/main/p/postgresql-17/postgresql-17_17.4-1.dsc' postgresql-17_17.4-1.dsc 4245 SHA256:0dcc2ad1fbbc28312d47c5e5454859c99074b0ed4eb34519e6419b09656e70ce
...
'http://deb.debian.org/debian/pool/main/p/postgresql-17/postgresql-17_17.4-1.debian.tar.xz' postgresql-17_17.4-1.debian.tar.xz 27248 SHA256:b648e84ce8dea0e4403797a8f8ba6477426ba6c2840fdc84e3578bad3b010f80
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-17/17.4-1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-17/17.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-17/17.4-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/python3-defaults/python3-defaults_3.13.2-2.dsc' python3-defaults_3.13.2-2.dsc 2948 SHA256:5c9680f0f0ebc39ba8037b0d10bef81b46272ee1d3db8ec49ec4aea029ad2447
'http://deb.debian.org/debian/pool/main/p/python3-defaults/python3-defaults_3.13.2-2.tar.gz' python3-defaults_3.13.2-2.tar.gz 388662 SHA256:153c628880eff39da3124dd8561fbf3fe9d1b84527cab50e2f193f12fcb289a3
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3-defaults/3.13.2-2/ (for browsing the source)
- https://sources.debian.net/src/python3-defaults/3.13.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3-defaults/3.13.2-2/ (for access to the source package after it no longer exists in the archive)
...
- `libsvn1:amd64=1.14.5-2+b3`
- `subversion=1.14.5-2+b3`
...
- `bsdutils=1:2.40.4-5`
- `libblkid-dev:amd64=2.40.4-5`
- `libblkid1:amd64=2.40.4-5`
- `libmount-dev:amd64=2.40.4-5`
