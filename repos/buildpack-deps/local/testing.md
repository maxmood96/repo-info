...
- Created: `2024-04-10T05:33:28.073454695Z`
...
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.42-4.dsc' binutils_2.42-4.dsc 12563 SHA256:d0b6efec32aa2829ee9de7ea3f9f5401f96a4ec89e570396b2b37bfbbb3ccd5b
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.42.orig.tar.xz' binutils_2.42.orig.tar.xz 27791308 SHA256:b2ca95ea1f2527aa225c3ed8b80de9dc366515c7a1219092d7111d870ec6f8a2
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.42-4.debian.tar.xz' binutils_2.42-4.debian.tar.xz 140800 SHA256:77a0a7de89772a8218ae1f37b06a5cfaab051e5b661b20ea19af4bdf16f92650
```

Other potentially useful URLs:

- https://sources.debian.net/src/binutils/2.42-4/ (for browsing the source)
- https://sources.debian.net/src/binutils/2.42-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/binutils/2.42-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `boost1.83=1.83.0-2`

Binary Packages:

- `libboost-python1.83.0=1.83.0-2+b2`
...
```console
$ apt-get source -qq --print-uris boost1.83=1.83.0-2
'http://deb.debian.org/debian/pool/main/b/boost1.83/boost1.83_1.83.0-2.dsc' boost1.83_1.83.0-2.dsc 8756 SHA256:ec4d18d5291e7a834136013a02a495fa6e61dbf15508a2f2021ccb8c23bde028
...
'http://deb.debian.org/debian/pool/main/b/boost1.83/boost1.83_1.83.0-2.debian.tar.xz' boost1.83_1.83.0-2.debian.tar.xz 378528 SHA256:735f1194ee7a27ebc394da42e84f8afd8596d8a6902df40b57f507d1f371901b
```

Other potentially useful URLs:

- https://sources.debian.net/src/boost1.83/1.83.0-2/ (for browsing the source)
- https://sources.debian.net/src/boost1.83/1.83.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/boost1.83/1.83.0-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `brotli=1.1.0-2`

Binary Packages:

- `libbrotli-dev:amd64=1.1.0-2+b3`
...
- `libcairo-gobject2:amd64=1.18.0-1+b1`
- `libcairo-script-interpreter2:amd64=1.18.0-1+b1`
- `libcairo2:amd64=1.18.0-1+b1`
- `libcairo2-dev:amd64=1.18.0-1+b1`
...
- `curl=8.5.0-2`
- `libcurl3-gnutls:amd64=8.5.0-2`
- `libcurl4:amd64=8.5.0-2`
- `libcurl4-openssl-dev:amd64=8.5.0-2`
...
### `dpkg` source package: `dav1d=1.4.1-1`

Binary Packages:

- `libdav1d7:amd64=1.4.1-1`
...
- `libdb5.3-dev=5.3.28+dfsg2-4+b1`
...
- `libexpat1-dev:amd64=2.5.0-2+b2`
...
- `libfftw3-double3:amd64=3.3.10-1+b1`
...
- `libfreetype-dev:amd64=2.13.2+dfsg-1+b1`
...
'http://deb.debian.org/debian/pool/main/g/gcc-13/gcc-13_13.2.0-13.dsc' gcc-13_13.2.0-13.dsc 39059 SHA256:1364ce788f123bb41b633c0a50b604d7ebb7823f81153ffe077f6a87bd114f7e
...
'http://deb.debian.org/debian/pool/main/g/gcc-13/gcc-13_13.2.0-13.debian.tar.xz' gcc-13_13.2.0-13.debian.tar.xz 1789428 SHA256:97e85b24c9ac130d9aec1ca26ac6b948338277929125aa956cbff009280a9648
```

Other potentially useful URLs:

- https://sources.debian.net/src/gcc-13/13.2.0-13/ (for browsing the source)
- https://sources.debian.net/src/gcc-13/13.2.0-13/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gcc-13/13.2.0-13/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/g/gcc-defaults/gcc-defaults_1.214.dsc' gcc-defaults_1.214.dsc 36725 SHA256:000e5785b15c3858843df98d8d35c84b6fad33fa62f85f1db3666af9c5cf2e1b
'http://deb.debian.org/debian/pool/main/g/gcc-defaults/gcc-defaults_1.214.tar.xz' gcc-defaults_1.214.tar.xz 64612 SHA256:2719b26b8321c2ac33620cf857956ef1d10f4432ce7690df7270a77fce996e56
```

Other potentially useful URLs:

- https://sources.debian.net/src/gcc-defaults/1.214/ (for browsing the source)
- https://sources.debian.net/src/gcc-defaults/1.214/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gcc-defaults/1.214/ (for access to the source package after it no longer exists in the archive)
...
- `gir1.2-gdkpixbuf-2.0:amd64=2.42.10+dfsg-3+b1`
- `libgdk-pixbuf-2.0-0:amd64=2.42.10+dfsg-3+b1`
- `libgdk-pixbuf-2.0-dev:amd64=2.42.10+dfsg-3+b1`
- `libgdk-pixbuf2.0-bin=2.42.10+dfsg-3+b1`
...
### `dpkg` source package: `glib2.0=2.78.4-1`

Binary Packages:

- `libglib2.0-0:amd64=2.78.4-1`
- `libglib2.0-bin=2.78.4-1`
- `libglib2.0-data=2.78.4-1`
- `libglib2.0-dev:amd64=2.78.4-1`
- `libglib2.0-dev-bin=2.78.4-1`
...
```console
$ apt-get source -qq --print-uris glib2.0=2.78.4-1
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.4-1.dsc' glib2.0_2.78.4-1.dsc 3672 SHA256:eff560ff1466d250c4215d06d9f6f37ceed6586b704cab8c171d95e85f916044
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.4.orig-unicode-data.tar.xz' glib2.0_2.78.4.orig-unicode-data.tar.xz 266184 SHA256:7c3e36ec1356ac025a92169b74c4c3e6858345f59ed4ea4cf0db300dec4fa21a
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.4.orig.tar.xz' glib2.0_2.78.4.orig.tar.xz 5331892 SHA256:24b8e0672dca120cc32d394bccb85844e732e04fe75d18bb0573b2dbc7548f63
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.4-1.debian.tar.xz' glib2.0_2.78.4-1.debian.tar.xz 120476 SHA256:66c725367247a65b722418a12a536db87eb18242a898e6f211249cb3329dc32d
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.78.4-1/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.78.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.78.4-1/ (for access to the source package after it no longer exists in the archive)
...
- `dirmngr=2.2.40-1.1+b1`
- `gnupg=2.2.40-1.1`
- `gnupg-l10n=2.2.40-1.1`
- `gnupg-utils=2.2.40-1.1+b1`
- `gpg=2.2.40-1.1+b1`
- `gpg-agent=2.2.40-1.1+b1`
- `gpg-wks-client=2.2.40-1.1+b1`
- `gpg-wks-server=2.2.40-1.1+b1`
- `gpgconf=2.2.40-1.1+b1`
- `gpgsm=2.2.40-1.1+b1`
- `gpgv=2.2.40-1.1+b1`
...
### `dpkg` source package: `gobject-introspection=1.78.1-15`

Binary Packages:

- `gir1.2-freedesktop:amd64=1.78.1-15`
- `gir1.2-glib-2.0:amd64=1.78.1-15`
- `gir1.2-glib-2.0-dev:amd64=1.78.1-15`

Licenses: (parsed from: `/usr/share/doc/gir1.2-freedesktop/copyright`, `/usr/share/doc/gir1.2-glib-2.0/copyright`, `/usr/share/doc/gir1.2-glib-2.0-dev/copyright`)
...
- `imagemagick=8:6.9.12.98+dfsg1-5+b1`
- `imagemagick-6-common=8:6.9.12.98+dfsg1-5`
- `imagemagick-6.q16=8:6.9.12.98+dfsg1-5+b1`
- `libmagickcore-6-arch-config:amd64=8:6.9.12.98+dfsg1-5+b1`
- `libmagickcore-6-headers=8:6.9.12.98+dfsg1-5`
- `libmagickcore-6.q16-7:amd64=8:6.9.12.98+dfsg1-5+b1`
- `libmagickcore-6.q16-7-extra:amd64=8:6.9.12.98+dfsg1-5+b1`
- `libmagickcore-6.q16-dev:amd64=8:6.9.12.98+dfsg1-5+b1`
- `libmagickcore-dev=8:6.9.12.98+dfsg1-5`
- `libmagickwand-6-headers=8:6.9.12.98+dfsg1-5`
- `libmagickwand-6.q16-7:amd64=8:6.9.12.98+dfsg1-5+b1`
- `libmagickwand-6.q16-dev:amd64=8:6.9.12.98+dfsg1-5+b1`
...
- https://sources.debian.net/src/imagemagick/8:6.9.12.98+dfsg1-5/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.9.12.98+dfsg1-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.9.12.98+dfsg1-5/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `imath=3.1.9-3`

Binary Packages:

- `libimath-3-1-29:amd64=3.1.9-3+b2`
- `libimath-dev:amd64=3.1.9-3+b2`
- `python3-imath:amd64=3.1.9-3+b2`
...
- `krb5-multidev:amd64=1.20.1-5+b1`
- `libgssapi-krb5-2:amd64=1.20.1-5+b1`
- `libgssrpc4:amd64=1.20.1-5+b1`
- `libk5crypto3:amd64=1.20.1-5+b1`
- `libkadm5clnt-mit12:amd64=1.20.1-5+b1`
- `libkadm5srv-mit12:amd64=1.20.1-5+b1`
- `libkdb5-10:amd64=1.20.1-5+b1`
- `libkrb5-3:amd64=1.20.1-5+b1`
- `libkrb5-dev:amd64=1.20.1-5+b1`
...
### `dpkg` source package: `libheif=1.17.6-1`

Binary Packages:

- `libheif-plugin-dav1d:amd64=1.17.6-1`
- `libheif-plugin-libde265:amd64=1.17.6-1`
- `libheif1:amd64=1.17.6-1`
...
```console
$ apt-get source -qq --print-uris libheif=1.17.6-1
'http://deb.debian.org/debian/pool/main/libh/libheif/libheif_1.17.6-1.dsc' libheif_1.17.6-1.dsc 3071 SHA256:ace5f7eabe936084ab07f6051c47c07dd817e22e51e87307de0cb935edd5d7c3
...
'http://deb.debian.org/debian/pool/main/libh/libheif/libheif_1.17.6-1.debian.tar.xz' libheif_1.17.6-1.debian.tar.xz 9420 SHA256:de9c9f0ab4c4290d99e9af74c6d29c0c78396c7a65ccfed99822e6f35c6d5a02
```

Other potentially useful URLs:

- https://sources.debian.net/src/libheif/1.17.6-1/ (for browsing the source)
- https://sources.debian.net/src/libheif/1.17.6-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libheif/1.17.6-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libpng1.6=1.6.43-1`

Binary Packages:

- `libpng-dev:amd64=1.6.43-1`
- `libpng16-16:amd64=1.6.43-1`
...
'http://deb.debian.org/debian/pool/main/libr/libraw/libraw_0.21.2-2.dsc' libraw_0.21.2-2.dsc 2184 SHA256:1773b38c620bab56678b504b78a28752ff129b5091a16632919901d07550de41
...
'http://deb.debian.org/debian/pool/main/libr/libraw/libraw_0.21.2-2.debian.tar.xz' libraw_0.21.2-2.debian.tar.xz 24520 SHA256:7df59e74f256d23ff47ec8657ab26face74bc8611f954c2d1237da1f9f1ede4b
```

Other potentially useful URLs:

- https://sources.debian.net/src/libraw/0.21.2-2/ (for browsing the source)
- https://sources.debian.net/src/libraw/0.21.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libraw/0.21.2-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libs/libssh2/libssh2_1.11.0-4.dsc' libssh2_1.11.0-4.dsc 2289 SHA256:4e470d039d3fe584247ba6fe55d6df1f61b7d5ca1f6a20e935f3429fc2260bee
...
'http://deb.debian.org/debian/pool/main/libs/libssh2/libssh2_1.11.0-4.debian.tar.xz' libssh2_1.11.0-4.debian.tar.xz 13892 SHA256:490185b99efe121a516dd36867ced264babbe638568ddaf8cf6a6b5ed1afc01a
```

Other potentially useful URLs:

- https://sources.debian.net/src/libssh2/1.11.0-4/ (for browsing the source)
- https://sources.debian.net/src/libssh2/1.11.0-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libssh2/1.11.0-4/ (for access to the source package after it no longer exists in the archive)
...
- `libsharpyuv-dev:amd64=1.3.2-0.4`
- `libsharpyuv0:amd64=1.3.2-0.4`
- `libwebp-dev:amd64=1.3.2-0.4`
- `libwebp7:amd64=1.3.2-0.4`
- `libwebpdecoder3:amd64=1.3.2-0.4`
- `libwebpdemux2:amd64=1.3.2-0.4`
- `libwebpmux3:amd64=1.3.2-0.4`
...
- `libxml2:amd64=2.9.14+dfsg-1.3+b2`
- `libxml2-dev:amd64=2.9.14+dfsg-1.3+b2`
...
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.6.15-2.dsc' linux_6.6.15-2.dsc 231670 SHA256:7b93a7b309585fff8380cc0ff8a8f85cfea948db1a33eece1225c6b158363f84
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.6.15.orig.tar.xz' linux_6.6.15.orig.tar.xz 142681236 SHA256:95376a6c0bd78aae882013478ad90e147e12b433fe61ae579882e34adac7ec9c
'http://deb.debian.org/debian/pool/main/l/linux/linux_6.6.15-2.debian.tar.xz' linux_6.6.15-2.debian.tar.xz 1580640 SHA256:3378e2d56ea472bc29e922d2c00a2c8e6ee307e3bdd973a1e39cb5d9f6942b2e
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/6.6.15-2/ (for browsing the source)
- https://sources.debian.net/src/linux/6.6.15-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/6.6.15-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mariadb=1:10.11.6-2`

Binary Packages:

- `libmariadb-dev=1:10.11.6-2`
- `libmariadb-dev-compat=1:10.11.6-2`
- `libmariadb3:amd64=1:10.11.6-2`
- `mariadb-common=1:10.11.6-2`
...
```console
$ apt-get source -qq --print-uris mariadb=1:10.11.6-2
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_10.11.6-2.dsc' mariadb_10.11.6-2.dsc 5044 SHA256:70878b6b4619def9d2363ccea5f01f919c1d76bd0ec8dcd5bbcf7950105f9234
...
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_10.11.6-2.debian.tar.xz' mariadb_10.11.6-2.debian.tar.xz 278764 SHA256:0ee6da6eb9304f4b4b1e80f0e5f17ad8bd9f253181f90ae45fc9c219d039cca9
```

Other potentially useful URLs:

- https://sources.debian.net/src/mariadb/1:10.11.6-2/ (for browsing the source)
- https://sources.debian.net/src/mariadb/1:10.11.6-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mariadb/1:10.11.6-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mercurial=6.7.2-1`

Binary Packages:

- `mercurial=6.7.2-1`
- `mercurial-common=6.7.2-1`
...
- `default-libmysqlclient-dev:amd64=1.1.0+b1`
...
'http://deb.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.59.0-1.dsc' nghttp2_1.59.0-1.dsc 2534 SHA256:c7709f9df579a18e3612040b886a41ee91248d91f959d1d87a50fdd847ba614f
'http://deb.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.59.0.orig.tar.gz' nghttp2_1.59.0.orig.tar.gz 1055492 SHA256:0dd5c980f1262ff5f03676fd99f46f250b66c842f7d864fa1ca9f8453e5f8868
'http://deb.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.59.0-1.debian.tar.xz' nghttp2_1.59.0-1.debian.tar.xz 11772 SHA256:8672ac178e36e1449e1217a53d670fd162d482e9e96a215dac4df166dcc27072
```

Other potentially useful URLs:

- https://sources.debian.net/src/nghttp2/1.59.0-1/ (for browsing the source)
- https://sources.debian.net/src/nghttp2/1.59.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nghttp2/1.59.0-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `npth=1.6-3`

Binary Packages:

- `libnpth0:amd64=1.6-3+b1`
...
- `libopenexr-3-1-30:amd64=3.1.5-5.1+b1`
- `libopenexr-dev=3.1.5-5.1+b1`
...
- `libopenjp2-7:amd64=2.5.0-2+b2`
- `libopenjp2-7-dev:amd64=2.5.0-2+b2`
...
### `dpkg` source package: `openssh=1:9.6p1-4`
...
```console
$ apt-get source -qq --print-uris openssh=1:9.6p1-4
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.6p1-4.dsc' openssh_9.6p1-4.dsc 3341 SHA256:f23587e5b398ff440b3463b31954e64bc60fc1b4080b79c8b2c6ce6e84389b58
...
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.6p1-4.debian.tar.xz' openssh_9.6p1-4.debian.tar.xz 188640 SHA256:09fe6da6333c9fe8d1d7f3a29dfb30937888b3d392a87910136d2e503662b020
```

Other potentially useful URLs:

- https://sources.debian.net/src/openssh/1:9.6p1-4/ (for browsing the source)
- https://sources.debian.net/src/openssh/1:9.6p1-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssh/1:9.6p1-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `openssl=3.1.5-1`

Binary Packages:

- `libssl-dev:amd64=3.1.5-1`
...
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.52.0%2bds-1.dsc' pango1.0_1.52.0+ds-1.dsc 3536 SHA256:f820d7ce0b6d2f90e1d0fd6fe878f1c038c43089d301f50ef119a2c2afac9189
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.52.0%2bds.orig.tar.xz' pango1.0_1.52.0+ds.orig.tar.xz 1738092 SHA256:f229f815756dc18cd0c219facf1b382aa4165af1dd07d5c1f7d988e5e2f0da33
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.52.0%2bds-1.debian.tar.xz' pango1.0_1.52.0+ds-1.debian.tar.xz 41628 SHA256:d63cc0745b3dc03135651bfc4e636bdae9f924d510c26434ccd191f4c8fbb160
```

Other potentially useful URLs:

- https://sources.debian.net/src/pango1.0/1.52.0+ds-1/ (for browsing the source)
- https://sources.debian.net/src/pango1.0/1.52.0+ds-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pango1.0/1.52.0+ds-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-16=16.2-1`
...
```console
$ apt-get source -qq --print-uris postgresql-16=16.2-1
'http://deb.debian.org/debian/pool/main/p/postgresql-16/postgresql-16_16.2-1.dsc' postgresql-16_16.2-1.dsc 4187 SHA256:2700b610a315b627632e3d6cc11103707e78048c59272fa6ef2aeeab1f0541f5
...
'http://deb.debian.org/debian/pool/main/p/postgresql-16/postgresql-16_16.2-1.debian.tar.xz' postgresql-16_16.2-1.debian.tar.xz 31264 SHA256:6eaa133ec2240213b1bab0e59c800353d2ec18af2d48c1c1f60fbbb7f1096fa0
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-16/16.2-1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-16/16.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-16/16.2-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `procps=2:4.0.4-4`

Binary Packages:

- `libproc2-0:amd64=2:4.0.4-4`
- `procps=2:4.0.4-4`
...
- `libpython3-stdlib:amd64=3.11.6-1`
- `python3=3.11.6-1`
...
```console
$ apt-get source -qq --print-uris python3-defaults=3.11.6-1
'http://deb.debian.org/debian/pool/main/p/python3-defaults/python3-defaults_3.11.6-1.dsc' python3-defaults_3.11.6-1.dsc 3026 SHA256:6aceccd55713879f64ed2f7b9f5b360c3b2e12d19bb5b08194cd5b9ac14edc76
'http://deb.debian.org/debian/pool/main/p/python3-defaults/python3-defaults_3.11.6-1.tar.gz' python3-defaults_3.11.6-1.tar.gz 146677 SHA256:d079b2d831a1f6e9972489d4e940e5d68e31e590e50271033179acd5b70f826c
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3-defaults/3.11.6-1/ (for browsing the source)
- https://sources.debian.net/src/python3-defaults/3.11.6-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3-defaults/3.11.6-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/python3.11/python3.11_3.11.8-1.dsc' python3.11_3.11.8-1.dsc 3806 SHA256:6550704fce45af1cabf48a8a291da2c630eacb3c6b1a4b2ba576b5c89e6a0466
'http://deb.debian.org/debian/pool/main/p/python3.11/python3.11_3.11.8.orig.tar.xz' python3.11_3.11.8.orig.tar.xz 20041256 SHA256:9e06008c8901924395bc1da303eac567a729ae012baa182ab39269f650383bb3
'http://deb.debian.org/debian/pool/main/p/python3.11/python3.11_3.11.8-1.debian.tar.xz' python3.11_3.11.8-1.debian.tar.xz 213780 SHA256:497302fa7cce33f3581ec63259960db2df7b99cee548c6c50fc7ad1c530039cf
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.11/3.11.8-1/ (for browsing the source)
- https://sources.debian.net/src/python3.11/3.11.8-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.11/3.11.8-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/python3.12/python3.12_3.12.2-1.dsc' python3.12_3.12.2-1.dsc 3837 SHA256:7b6a2342144cd2e68a7b7d0b13741347b76d783b4264b425bb9a13303aef6519
'http://deb.debian.org/debian/pool/main/p/python3.12/python3.12_3.12.2.orig.tar.xz' python3.12_3.12.2.orig.tar.xz 20591308 SHA256:be28112dac813d2053545c14bf13a16401a21877f1a69eb6ea5d84c4a0f3d870
'http://deb.debian.org/debian/pool/main/p/python3.12/python3.12_3.12.2-1.debian.tar.xz' python3.12_3.12.2-1.debian.tar.xz 211832 SHA256:f8f8ff1a2f7f875abacc05132aecb0e7959e1a4b40b289daaa0ac656006abf4a
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.12/3.12.2-1/ (for browsing the source)
- https://sources.debian.net/src/python3.12/3.12.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.12/3.12.2-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.45.1-1.dsc' sqlite3_3.45.1-1.dsc 2486 SHA256:96986334d196e53c5a0db99dc9091f73af693f42017f5a9b6c21112862f62249
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.45.1.orig-www.tar.xz' sqlite3_3.45.1.orig-www.tar.xz 5693812 SHA256:79b60798195a024d447e661e5bbc1eb40af50387ebf840e6f581190cc02064b6
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.45.1.orig.tar.xz' sqlite3_3.45.1.orig.tar.xz 8257884 SHA256:e32e817f7b4166a301f60b14a711871bfab7d35c1d7e29b585dfc479ae150aa4
'http://deb.debian.org/debian/pool/main/s/sqlite3/sqlite3_3.45.1-1.debian.tar.xz' sqlite3_3.45.1-1.debian.tar.xz 30292 SHA256:f598716379954464c7e00d412823703d4d0105c79a7e30a41b4c3a11299e9f9c
```

Other potentially useful URLs:

- https://sources.debian.net/src/sqlite3/3.45.1-1/ (for browsing the source)
- https://sources.debian.net/src/sqlite3/3.45.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/sqlite3/3.45.1-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `subversion=1.14.3-1`

Binary Packages:

- `libsvn1:amd64=1.14.3-1+b1`
- `subversion=1.14.3-1+b1`
...
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.3-1.dsc' subversion_1.14.3-1.dsc 4046 SHA256:42218e3bcfb7c48203cb40cbac5a9d0a562244cf75c113673fdf004130c33b24
...
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.3-1.debian.tar.xz' subversion_1.14.3-1.debian.tar.xz 336856 SHA256:f161a8d73795c547af63a0de56f6efc5b544e375b7722585b5efb7ba5c14bd4a
```

Other potentially useful URLs:

- https://sources.debian.net/src/subversion/1.14.3-1/ (for browsing the source)
- https://sources.debian.net/src/subversion/1.14.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/subversion/1.14.3-1/ (for access to the source package after it no longer exists in the archive)
