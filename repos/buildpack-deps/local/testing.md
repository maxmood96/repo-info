...
### `dpkg` source package: `binutils=2.43.1-5`

Binary Packages:

- `binutils=2.43.1-5`
- `binutils-common:amd64=2.43.1-5`
- `binutils-x86-64-linux-gnu=2.43.1-5`
- `libbinutils:amd64=2.43.1-5`
- `libctf-nobfd0:amd64=2.43.1-5`
- `libctf0:amd64=2.43.1-5`
- `libgprofng0:amd64=2.43.1-5`
- `libsframe1:amd64=2.43.1-5`
...
```console
$ apt-get source -qq --print-uris binutils=2.43.1-5
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.1-5.dsc' binutils_2.43.1-5.dsc 12245 SHA256:d07d6cecf44bf867e263ce8461f63fb92be671bf52da86da5999ca692bc6d8c0
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.1.orig.tar.xz' binutils_2.43.1.orig.tar.xz 28362952 SHA256:a215b366d075f43ba7ae43585fa66e3a00c604964dc272cf57b2916f4c57796e
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.1-5.debian.tar.xz' binutils_2.43.1-5.debian.tar.xz 122528 SHA256:3464a3346899dd2b0a5c0643456a896252120f943300c47953aa5a4511b1f5ba
```

Other potentially useful URLs:

- https://sources.debian.net/src/binutils/2.43.1-5/ (for browsing the source)
- https://sources.debian.net/src/binutils/2.43.1-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/binutils/2.43.1-5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `curl=8.11.0-1`

Binary Packages:

- `curl=8.11.0-1`
- `libcurl3t64-gnutls:amd64=8.11.0-1`
- `libcurl4-openssl-dev:amd64=8.11.0-1`
- `libcurl4t64:amd64=8.11.0-1`
...
- `comerr-dev:amd64=2.1-1.47.1-1+b1`
...
- `libfftw3-bin=3.3.10-1+b3`
- `libfftw3-dev:amd64=3.3.10-1+b3`
- `libfftw3-double3:amd64=3.3.10-1+b3`
- `libfftw3-long3:amd64=3.3.10-1+b3`
- `libfftw3-quad3:amd64=3.3.10-1+b3`
- `libfftw3-single3:amd64=3.3.10-1+b3`
...
'http://deb.debian.org/debian/pool/main/f/fribidi/fribidi_1.0.15-1.dsc' fribidi_1.0.15-1.dsc 2004 SHA256:fe428965937cf253b71efb5de0b214c8bbb2a024a13d09635938ff9fa0052283
'http://deb.debian.org/debian/pool/main/f/fribidi/fribidi_1.0.15.orig.tar.xz' fribidi_1.0.15.orig.tar.xz 1166860 SHA256:0bbc7ff633bfa208ae32d7e369cf5a7d20d5d2557a0b067c9aa98bcbf9967587
'http://deb.debian.org/debian/pool/main/f/fribidi/fribidi_1.0.15-1.debian.tar.xz' fribidi_1.0.15-1.debian.tar.xz 8888 SHA256:e0ec140d8bcabaaf5edcfe10e6bb268d8150a76d657bbfe9e3415569d4b67440
```

Other potentially useful URLs:

- https://sources.debian.net/src/fribidi/1.0.15-1/ (for browsing the source)
- https://sources.debian.net/src/fribidi/1.0.15-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/fribidi/1.0.15-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `glib2.0=2.82.2-3`

Binary Packages:

- `gir1.2-glib-2.0:amd64=2.82.2-3`
- `gir1.2-glib-2.0-dev:amd64=2.82.2-3`
- `girepository-tools:amd64=2.82.2-3`
- `libgio-2.0-dev:amd64=2.82.2-3`
- `libgio-2.0-dev-bin=2.82.2-3`
- `libgirepository-2.0-0:amd64=2.82.2-3`
- `libglib2.0-0t64:amd64=2.82.2-3`
- `libglib2.0-bin=2.82.2-3`
- `libglib2.0-data=2.82.2-3`
- `libglib2.0-dev:amd64=2.82.2-3`
...
- `libgmp-dev:amd64=2:6.3.0+dfsg-2+b2`
- `libgmp10:amd64=2:6.3.0+dfsg-2+b2`
- `libgmpxx4ldbl:amd64=2:6.3.0+dfsg-2+b2`
...
### `dpkg` source package: `gobject-introspection=1.82.0-2`

Binary Packages:

- `gir1.2-freedesktop:amd64=1.82.0-2`
- `gir1.2-freedesktop-dev:amd64=1.82.0-2`
...
- `gir1.2-harfbuzz-0.0:amd64=10.0.1-1`
- `libharfbuzz-cairo0:amd64=10.0.1-1`
- `libharfbuzz-dev:amd64=10.0.1-1`
- `libharfbuzz-gobject0:amd64=10.0.1-1`
- `libharfbuzz-icu0:amd64=10.0.1-1`
- `libharfbuzz-subset0:amd64=10.0.1-1`
- `libharfbuzz0b:amd64=10.0.1-1`
...
### `dpkg` source package: `libpng1.6=1.6.44-2`

Binary Packages:

- `libpng-dev:amd64=1.6.44-2`
- `libpng16-16t64:amd64=1.6.44-2`
...
- `libxrender-dev:amd64=1:0.9.10-1.1+b2`
- `libxrender1:amd64=1:0.9.10-1.1+b2`
...
- `libyaml-0-2:amd64=0.2.5-1+b2`
- `libyaml-dev:amd64=0.2.5-1+b2`
...
### `dpkg` source package: `linux=6.11.10-1`

Binary Packages:

- `linux-libc-dev=6.11.10-1`
...
### `dpkg` source package: `pango1.0=1.54.0+ds-3`

Binary Packages:

- `gir1.2-pango-1.0:amd64=1.54.0+ds-3`
- `libpango-1.0-0:amd64=1.54.0+ds-3`
...
```console
$ apt-get source -qq --print-uris pango1.0=1.54.0+ds-3
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.54.0%2bds-3.dsc' pango1.0_1.54.0+ds-3.dsc 3638 SHA256:eccf7bfc77aae3c07424d1782cc2027844ab616c26155b846cbb92af5e01e588
...
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.54.0%2bds-3.debian.tar.xz' pango1.0_1.54.0+ds-3.debian.tar.xz 43816 SHA256:2942e4ce3dab7a602cf1e31e044bc52597fa389a50da96379b48703853da86c1
```

Other potentially useful URLs:

- https://sources.debian.net/src/pango1.0/1.54.0+ds-3/ (for browsing the source)
- https://sources.debian.net/src/pango1.0/1.54.0+ds-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pango1.0/1.54.0+ds-3/ (for access to the source package after it no longer exists in the archive)
...
- `libpcre2-16-0:amd64=10.44-4`
- `libpcre2-32-0:amd64=10.44-4`
- `libpcre2-8-0:amd64=10.44-4`
- `libpcre2-dev:amd64=10.44-4`
- `libpcre2-posix3:amd64=10.44-4`
...
- `libpython3-stdlib:amd64=3.12.6-1`
- `python3=3.12.6-1`
...
- `libpython3.12-minimal:amd64=3.12.7-3`
- `libpython3.12-stdlib:amd64=3.12.7-3`
- `python3.12=3.12.7-3`
...
```console
$ apt-get source -qq --print-uris python3.12=3.12.7-3
'http://deb.debian.org/debian/pool/main/p/python3.12/python3.12_3.12.7-3.dsc' python3.12_3.12.7-3.dsc 3651 SHA256:3a6f5439039e1bce662246cde65ebbacb8c7467116af0f0069dade5dbbb7ab4e
...
'http://deb.debian.org/debian/pool/main/p/python3.12/python3.12_3.12.7-3.debian.tar.xz' python3.12_3.12.7-3.debian.tar.xz 322488 SHA256:79bcd9f370fc00be235b3367836af27c632e26819abbed63d72b18a5830d641d
```

Other potentially useful URLs:

- https://sources.debian.net/src/python3.12/3.12.7-3/ (for browsing the source)
- https://sources.debian.net/src/python3.12/3.12.7-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python3.12/3.12.7-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `rust-sequoia-sq=0.38.0-3`
...
```console
$ apt-get source -qq --print-uris rust-sequoia-sq=0.38.0-3
'http://deb.debian.org/debian/pool/main/r/rust-sequoia-sq/rust-sequoia-sq_0.38.0-3.dsc' rust-sequoia-sq_0.38.0-3.dsc 3882 SHA256:afa5c9ee050c38f2fb036095a9d96581983b4d2ffad816fdcf52bf155b150d99
...
'http://deb.debian.org/debian/pool/main/r/rust-sequoia-sq/rust-sequoia-sq_0.38.0-3.debian.tar.xz' rust-sequoia-sq_0.38.0-3.debian.tar.xz 5440 SHA256:4ab77eec5d2449eaa45614c02f9e1cf1f54c528b4db24e3fa86e0c9c8210ab29
```

Other potentially useful URLs:

- https://sources.debian.net/src/rust-sequoia-sq/0.38.0-3/ (for browsing the source)
- https://sources.debian.net/src/rust-sequoia-sq/0.38.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rust-sequoia-sq/0.38.0-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `subversion=1.14.4-2`

Binary Packages:

- `libsvn1:amd64=1.14.4-2+b1`
- `subversion=1.14.4-2+b1`
...
```console
$ apt-get source -qq --print-uris subversion=1.14.4-2
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.4-2.dsc' subversion_1.14.4-2.dsc 3991 SHA256:feae3d08161113556f570b55c61288ffb64a9408274ac5aaf9a7da9b3918cb37
...
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.4-2.debian.tar.xz' subversion_1.14.4-2.debian.tar.xz 297404 SHA256:6e9145b15158187a42c704416d6ca1212d8e2e8862d3dba1c188197a38d96c44
```

Other potentially useful URLs:

- https://sources.debian.net/src/subversion/1.14.4-2/ (for browsing the source)
- https://sources.debian.net/src/subversion/1.14.4-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/subversion/1.14.4-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `sysprof=47.1-1`

Binary Packages:

- `libsysprof-capture-4-dev:amd64=47.1-1`
...
```console
$ apt-get source -qq --print-uris sysprof=47.1-1
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.1-1.dsc' sysprof_47.1-1.dsc 3059 SHA256:2e27fec403d93e4a59a853989cb09366b855e3dd7a8450d159b341b28487c21e
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.1.orig.tar.xz' sysprof_47.1.orig.tar.xz 1191908 SHA256:d3baba814be0cdaef28704c8004ff3110e99525422060f2a993a22a47b9334eb
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.1-1.debian.tar.xz' sysprof_47.1-1.debian.tar.xz 16676 SHA256:5f04283fefa914d02fede79cfaa12e631fa1f011b32cfa7a701cbab6a77ce2a9
```

Other potentially useful URLs:

- https://sources.debian.net/src/sysprof/47.1-1/ (for browsing the source)
- https://sources.debian.net/src/sysprof/47.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/sysprof/47.1-1/ (for access to the source package after it no longer exists in the archive)
...
- `libblkid-dev:amd64=2.40.2-11`
- `libblkid1:amd64=2.40.2-11`
- `libmount-dev:amd64=2.40.2-11`
...
- `libxft-dev:amd64=2.3.6-1+b2`
- `libxft2:amd64=2.3.6-1+b2`
