...
- Created: `2023-10-12T03:27:21.017235569Z`
- Virtual Size: ~ 997.93 Mb  
...
### `dpkg` source package: `binutils=2.41-5`

Binary Packages:

- `binutils=2.41-5`
- `binutils-common:amd64=2.41-5`
- `binutils-x86-64-linux-gnu=2.41-5`
- `libbinutils:amd64=2.41-5`
- `libctf-nobfd0:amd64=2.41-5`
- `libctf0:amd64=2.41-5`
- `libgprofng0:amd64=2.41-5`
- `libsframe1:amd64=2.41-5`
...
- `libcurl4-openssl-dev:amd64=8.3.0-2`
...
- `libasan8:amd64=13.2.0-4`
- `libatomic1:amd64=13.2.0-4`
- `libcc1-0:amd64=13.2.0-4`
- `libgcc-13-dev:amd64=13.2.0-4`
- `libgcc-s1:amd64=13.2.0-4`
- `libgfortran5:amd64=13.2.0-4`
- `libgomp1:amd64=13.2.0-4`
- `libhwasan0:amd64=13.2.0-4`
- `libitm1:amd64=13.2.0-4`
- `liblsan0:amd64=13.2.0-4`
- `libquadmath0:amd64=13.2.0-4`
- `libstdc++-13-dev:amd64=13.2.0-4`
- `libstdc++6:amd64=13.2.0-4`
- `libtsan2:amd64=13.2.0-4`
- `libubsan1:amd64=13.2.0-4`
...
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.0-2.dsc' glib2.0_2.78.0-2.dsc 3684 SHA256:2a6306b5af09d6ee8b098c9ce2432655361f168fb7cfcd2661b356936d12cde8
...
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.78.0-2.debian.tar.xz' glib2.0_2.78.0-2.debian.tar.xz 202588 SHA256:715d8b2eca2d82eff197193b9be39624b2fb97788ba6ce5ef39de48e57d7bd29
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.78.0-2/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.78.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.78.0-2/ (for access to the source package after it no longer exists in the archive)
...
- `krb5-multidev:amd64=1.20.1-4`
- `libgssapi-krb5-2:amd64=1.20.1-4`
- `libgssrpc4:amd64=1.20.1-4`
- `libk5crypto3:amd64=1.20.1-4`
- `libkadm5clnt-mit12:amd64=1.20.1-4`
- `libkadm5srv-mit12:amd64=1.20.1-4`
- `libkdb5-10:amd64=1.20.1-4`
- `libkrb5-3:amd64=1.20.1-4`
- `libkrb5-dev:amd64=1.20.1-4`
...
### `dpkg` source package: `libheif=1.16.2-3`

Binary Packages:

- `libheif-plugin-dav1d:amd64=1.16.2-3`
- `libheif-plugin-libde265:amd64=1.16.2-3`
- `libheif1:amd64=1.16.2-3`
...
- http://snapshot.debian.org/package/libheif/1.16.2-3/
...
### `dpkg` source package: `linux=6.5.3-1`

Binary Packages:

- `linux-libc-dev:amd64=6.5.3-1`
...
### `dpkg` source package: `postgresql-16=16.0-2`
...
```console
$ apt-get source -qq --print-uris postgresql-16=16.0-2
'http://deb.debian.org/debian/pool/main/p/postgresql-16/postgresql-16_16.0-2.dsc' postgresql-16_16.0-2.dsc 4193 SHA256:3b51eb618a751cede1cea3fc67c2820b4cccbeac48077345d8a4f735f327cfce
'http://deb.debian.org/debian/pool/main/p/postgresql-16/postgresql-16_16.0.orig.tar.bz2' postgresql-16_16.0.orig.tar.bz2 24528207 SHA256:df9e823eb22330444e1d48e52cc65135a652a6fdb3ce325e3f08549339f51b99
'http://deb.debian.org/debian/pool/main/p/postgresql-16/postgresql-16_16.0-2.debian.tar.xz' postgresql-16_16.0-2.debian.tar.xz 29472 SHA256:e76294c480dff105d6a7ccec80014e8e8c4255c7aa45a706dd141cfdcb895291
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-16/16.0-2/ (for browsing the source)
- https://sources.debian.net/src/postgresql-16/16.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-16/16.0-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `setuptools=68.1.2-1`
