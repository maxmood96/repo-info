...
### `dpkg` source package: `binutils-gold=2.43.90.20250127-1`

Binary Packages:

- `binutils-gold=2.43.90.20250127-1`
- `binutils-gold-x86-64-linux-gnu=2.43.90.20250127-1`

Licenses: (parsed from: `/usr/share/doc/binutils-gold/copyright`, `/usr/share/doc/binutils-gold-x86-64-linux-gnu/copyright`)
...
```console
$ apt-get source -qq --print-uris binutils-gold=2.43.90.20250127-1
'http://deb.debian.org/debian/pool/main/b/binutils-gold/binutils-gold_2.43.90.20250127-1.dsc' binutils-gold_2.43.90.20250127-1.dsc 6079 SHA256:2c22d63863b0016060f0206520b43497d7cbc6e62ef0fbe8f6f245b1948ec47a
'http://deb.debian.org/debian/pool/main/b/binutils-gold/binutils-gold_2.43.90.20250127.orig.tar.xz' binutils-gold_2.43.90.20250127.orig.tar.xz 24242604 SHA256:f9fd21b997205875b41abb06b1326e7b522e481a120fc7dcbc0324667ea61829
'http://deb.debian.org/debian/pool/main/b/binutils-gold/binutils-gold_2.43.90.20250127-1.debian.tar.xz' binutils-gold_2.43.90.20250127-1.debian.tar.xz 123592 SHA256:2fcbdfba85d9af3dd4a0f3051c312851a763955cb9b571c4232f33734519222d
```

Other potentially useful URLs:

- https://sources.debian.net/src/binutils-gold/2.43.90.20250127-1/ (for browsing the source)
- https://sources.debian.net/src/binutils-gold/2.43.90.20250127-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/binutils-gold/2.43.90.20250127-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `binutils=2.43.90.20250127-1`

Binary Packages:

- `binutils=2.43.90.20250127-1`
- `binutils-common:amd64=2.43.90.20250127-1`
- `binutils-x86-64-linux-gnu=2.43.90.20250127-1`
- `libbinutils:amd64=2.43.90.20250127-1`
- `libctf-nobfd0:amd64=2.43.90.20250127-1`
- `libctf0:amd64=2.43.90.20250127-1`
- `libgprofng0:amd64=2.43.90.20250127-1`
- `libsframe1:amd64=2.43.90.20250127-1`
...
```console
$ apt-get source -qq --print-uris binutils=2.43.90.20250127-1
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.90.20250127-1.dsc' binutils_2.43.90.20250127-1.dsc 11589 SHA256:3c1214c9120ba3dc4eab0d801ede0ca4a5b17284008989a116cb46981756b334
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.90.20250127.orig.tar.xz' binutils_2.43.90.20250127.orig.tar.xz 24150868 SHA256:bc5f28a5741b498c1f905c9ee4a726223375fa2d749bada3b7437fae62d63104
'http://deb.debian.org/debian/pool/main/b/binutils/binutils_2.43.90.20250127-1.debian.tar.xz' binutils_2.43.90.20250127-1.debian.tar.xz 126420 SHA256:010479ab4db61ef5dbee7cffc5f9338036d7d3b890a1bfb6166939816a58a20f
```

Other potentially useful URLs:

- https://sources.debian.net/src/binutils/2.43.90.20250127-1/ (for browsing the source)
- https://sources.debian.net/src/binutils/2.43.90.20250127-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/binutils/2.43.90.20250127-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `brotli=1.1.0-2`

Binary Packages:

- `libbrotli-dev:amd64=1.1.0-2+b6`
...
'http://deb.debian.org/debian/pool/main/c/cairo/cairo_1.18.2-2.dsc' cairo_1.18.2-2.dsc 2763 SHA256:31a79f10ecd571d7c1f6fdc57940a92a3f87912aa727d095b8b80b94e8c66d6f
'http://deb.debian.org/debian/pool/main/c/cairo/cairo_1.18.2.orig.tar.xz' cairo_1.18.2.orig.tar.xz 32574256 SHA256:a62b9bb42425e844cc3d6ddde043ff39dbabedd1542eba57a2eb79f85889d45a
'http://deb.debian.org/debian/pool/main/c/cairo/cairo_1.18.2-2.debian.tar.xz' cairo_1.18.2-2.debian.tar.xz 30396 SHA256:0ee2cd7c17803cbe8da585493e68a59019c001176e4ce02d14b1af197398b098
```

Other potentially useful URLs:

- https://sources.debian.net/src/cairo/1.18.2-2/ (for browsing the source)
- https://sources.debian.net/src/cairo/1.18.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cairo/1.18.2-2/ (for access to the source package after it no longer exists in the archive)
...
- `curl=8.11.1-1+b1`
- `libcurl3t64-gnutls:amd64=8.11.1-1+b1`
- `libcurl4-openssl-dev:amd64=8.11.1-1+b1`
- `libcurl4t64:amd64=8.11.1-1+b1`
...
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.11.1-1.dsc' curl_8.11.1-1.dsc 3252 SHA256:6611dcd0c91d6dc8b4363b8a4472812a3044a04cba2304c64a0d1c6d06d91069
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.11.1.orig.tar.gz' curl_8.11.1.orig.tar.gz 4169067 SHA256:a889ac9dbba3644271bd9d1302b5c22a088893719b72be3487bc3d401e5c4e80
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.11.1.orig.tar.gz.asc' curl_8.11.1.orig.tar.gz.asc 484 SHA256:d6c44df0a8e6958ef8d38fceda44f219db666b8215da6b33dc7dda81fcfc696b
'http://deb.debian.org/debian/pool/main/c/curl/curl_8.11.1-1.debian.tar.xz' curl_8.11.1-1.debian.tar.xz 53972 SHA256:511130b8192911c22e03832a005531dd8990d9f5821640b6bac12a750d54bf33
```

Other potentially useful URLs:

- https://sources.debian.net/src/curl/8.11.1-1/ (for browsing the source)
- https://sources.debian.net/src/curl/8.11.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/curl/8.11.1-1/ (for access to the source package after it no longer exists in the archive)
...
- `libdjvulibre-dev:amd64=3.5.28-2+b2`
- `libdjvulibre-text=3.5.28-2`
- `libdjvulibre21:amd64=3.5.28-2+b2`
...
'http://deb.debian.org/debian/pool/main/e/expat/expat_2.6.4-1.dsc' expat_2.6.4-1.dsc 1964 SHA256:efcb13c3ce2a9426bca993176431353622712018b47c2e677f3db568745c9ded
'http://deb.debian.org/debian/pool/main/e/expat/expat_2.6.4.orig.tar.gz' expat_2.6.4.orig.tar.gz 8419100 SHA256:372b18f6527d162fa9658f1c74d22a37429b82d822f5a1e1fc7e00f6045a06a2
'http://deb.debian.org/debian/pool/main/e/expat/expat_2.6.4-1.debian.tar.xz' expat_2.6.4-1.debian.tar.xz 13124 SHA256:d58fe77a081ebd753c91d71f428c5081e5ec0d918bfaf6dfd19f7e0134b8dc95
```

Other potentially useful URLs:

- https://sources.debian.net/src/expat/2.6.4-1/ (for browsing the source)
- https://sources.debian.net/src/expat/2.6.4-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/expat/2.6.4-1/ (for access to the source package after it no longer exists in the archive)
...
- `libmagic1t64:amd64=1:5.45-3+b1`
...
- `libfontconfig-dev:amd64=2.15.0-2`
...
- `libasan8:amd64=14.2.0-12`
- `libatomic1:amd64=14.2.0-12`
- `libcc1-0:amd64=14.2.0-12`
- `libgcc-14-dev:amd64=14.2.0-12`
- `libgcc-s1:amd64=14.2.0-12`
- `libgomp1:amd64=14.2.0-12`
- `libhwasan0:amd64=14.2.0-12`
- `libitm1:amd64=14.2.0-12`
- `liblsan0:amd64=14.2.0-12`
- `libquadmath0:amd64=14.2.0-12`
- `libstdc++-14-dev:amd64=14.2.0-12`
- `libstdc++6:amd64=14.2.0-12`
- `libtsan2:amd64=14.2.0-12`
- `libubsan1:amd64=14.2.0-12`
...
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.12%2bdfsg-2.dsc' gdk-pixbuf_2.42.12+dfsg-2.dsc 3091 SHA256:7d93dab8a4d7c0c0ea69c68e0bdda113fadf7458994e93fcd34226d626bf0706
...
'http://deb.debian.org/debian/pool/main/g/gdk-pixbuf/gdk-pixbuf_2.42.12%2bdfsg-2.debian.tar.xz' gdk-pixbuf_2.42.12+dfsg-2.debian.tar.xz 21832 SHA256:f95cc3b01eac0b6c8bb045187d265445d54b342259ad6755330697f8de272ba2
```

Other potentially useful URLs:

- https://sources.debian.net/src/gdk-pixbuf/2.42.12+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/gdk-pixbuf/2.42.12+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gdk-pixbuf/2.42.12+dfsg-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `glib2.0=2.82.4-2`

Binary Packages:

- `gir1.2-glib-2.0:amd64=2.82.4-2`
- `gir1.2-glib-2.0-dev:amd64=2.82.4-2`
- `girepository-tools:amd64=2.82.4-2`
- `libgio-2.0-dev:amd64=2.82.4-2`
- `libgio-2.0-dev-bin=2.82.4-2`
- `libgirepository-2.0-0:amd64=2.82.4-2`
- `libglib2.0-0t64:amd64=2.82.4-2`
- `libglib2.0-bin=2.82.4-2`
- `libglib2.0-data=2.82.4-2`
- `libglib2.0-dev:amd64=2.82.4-2`
- `libglib2.0-dev-bin=2.82.4-2`
...
### `dpkg` source package: `gnupg2=2.2.46-1`
...
```console
$ apt-get source -qq --print-uris gnupg2=2.2.46-1
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.46-1.dsc' gnupg2_2.2.46-1.dsc 3366 SHA256:e3b33bad045e508a8c7df2ae112c9f8cdb1db1445f848afd701079d0c564444d
...
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.46-1.debian.tar.xz' gnupg2_2.2.46-1.debian.tar.xz 143552 SHA256:5ca01b5b562c4840155290e3b49d5a1373f3fd4799ce3e15c158ccf47ba33729
```

Other potentially useful URLs:

- https://sources.debian.net/src/gnupg2/2.2.46-1/ (for browsing the source)
- https://sources.debian.net/src/gnupg2/2.2.46-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gnupg2/2.2.46-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `gnutls28=3.8.8-2`

Binary Packages:

- `libgnutls-dane0t64:amd64=3.8.8-2`
- `libgnutls-openssl27t64:amd64=3.8.8-2`
- `libgnutls28-dev:amd64=3.8.8-2`
...
```console
$ apt-get source -qq --print-uris gobject-introspection=1.82.0-4
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.82.0-4.dsc' gobject-introspection_1.82.0-4.dsc 4074 SHA256:603dbaf5bc9a91bed51a185205bf714ab8a38f23f2ada901bf3f9578e2e6bf4d
...
'http://deb.debian.org/debian/pool/main/g/gobject-introspection/gobject-introspection_1.82.0-4.debian.tar.xz' gobject-introspection_1.82.0-4.debian.tar.xz 58496 SHA256:89269bfa43d1bfc2fb70e53f1a04941126d795cb24efb7bee8a3e9032f0a86c9
```

Other potentially useful URLs:

- https://sources.debian.net/src/gobject-introspection/1.82.0-4/ (for browsing the source)
- https://sources.debian.net/src/gobject-introspection/1.82.0-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gobject-introspection/1.82.0-4/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/i/icu/icu_72.1-6.dsc' icu_72.1-6.dsc 2239 SHA256:d9e89e723d0c50e7a051796b9a22ac21ebf68f0972ec978d1490f53d171a81a9
...
'http://deb.debian.org/debian/pool/main/i/icu/icu_72.1-6.debian.tar.xz' icu_72.1-6.debian.tar.xz 62864 SHA256:f5dd7b585d25be53b4e1da6a3e81924887d022052e0d007b3ca94495883ba32e
```

Other potentially useful URLs:

- https://sources.debian.net/src/icu/72.1-6/ (for browsing the source)
- https://sources.debian.net/src/icu/72.1-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/icu/72.1-6/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/k/keyutils/keyutils_1.6.3-4.dsc' keyutils_1.6.3-4.dsc 2193 SHA256:1943ee7376e7abedfebce2285c04a5c1d3062f63fce14ab2bcfbf65c52073b89
...
'http://deb.debian.org/debian/pool/main/k/keyutils/keyutils_1.6.3-4.debian.tar.xz' keyutils_1.6.3-4.debian.tar.xz 13872 SHA256:d64f58058ba3f3776e068fdd4cddf9a7a81b19006563a1e8d10894d949923806
```

Other potentially useful URLs:

- https://sources.debian.net/src/keyutils/1.6.3-4/ (for browsing the source)
- https://sources.debian.net/src/keyutils/1.6.3-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/keyutils/1.6.3-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `krb5=1.21.3-4`

Binary Packages:

- `krb5-multidev:amd64=1.21.3-4`
- `libgssapi-krb5-2:amd64=1.21.3-4`
- `libgssrpc4t64:amd64=1.21.3-4`
- `libk5crypto3:amd64=1.21.3-4`
- `libkadm5clnt-mit12:amd64=1.21.3-4`
- `libkadm5srv-mit12:amd64=1.21.3-4`
- `libkdb5-10t64:amd64=1.21.3-4`
- `libkrb5-3:amd64=1.21.3-4`
- `libkrb5-dev:amd64=1.21.3-4`
...
'http://deb.debian.org/debian/pool/main/k/krb5/krb5_1.21.3-4.dsc' krb5_1.21.3-4.dsc 3377 SHA256:bd43c30b5b99caa717dd6938521d635f9a4eee25fd69cc75bc928d14d0b040f5
...
'http://deb.debian.org/debian/pool/main/k/krb5/krb5_1.21.3-4.debian.tar.xz' krb5_1.21.3-4.debian.tar.xz 103508 SHA256:80516e0decadae2a2c5aa4f9ac641fd124e76857f2bf6aa1504bb4a1bcc3463c
```

Other potentially useful URLs:

- https://sources.debian.net/src/krb5/1.21.3-4/ (for browsing the source)
- https://sources.debian.net/src/krb5/1.21.3-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/krb5/1.21.3-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libexif=0.6.24-2`

Binary Packages:

- `libexif-dev:amd64=0.6.24-2`
- `libexif12:amd64=0.6.24-2`
...
### `dpkg` source package: `libheif=1.19.5-1`

Binary Packages:

- `libheif-plugin-dav1d:amd64=1.19.5-1+b1`
- `libheif-plugin-libde265:amd64=1.19.5-1+b1`
- `libheif1:amd64=1.19.5-1+b1`
...
```console
$ apt-get source -qq --print-uris libheif=1.19.5-1
'http://deb.debian.org/debian/pool/main/libh/libheif/libheif_1.19.5-1.dsc' libheif_1.19.5-1.dsc 3631 SHA256:9426d08ce7ea5ee976265b333e0865a75a6eb2c2a6791ce0fbb9183543507b41
'http://deb.debian.org/debian/pool/main/libh/libheif/libheif_1.19.5.orig.tar.gz' libheif_1.19.5.orig.tar.gz 1716856 SHA256:d3cf0a76076115a070f9bc87cf5259b333a1f05806500045338798486d0afbaf
'http://deb.debian.org/debian/pool/main/libh/libheif/libheif_1.19.5-1.debian.tar.xz' libheif_1.19.5-1.debian.tar.xz 12464 SHA256:856afc41f84b3585dd86b078a33f794f96906c04fc90582f077750376fe94274
```

Other potentially useful URLs:

- https://sources.debian.net/src/libheif/1.19.5-1/ (for browsing the source)
- https://sources.debian.net/src/libheif/1.19.5-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libheif/1.19.5-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libp/libpng1.6/libpng1.6_1.6.44-3.dsc' libpng1.6_1.6.44-3.dsc 2254 SHA256:a28e586623a116c1392d0144929ea10e02466b1e7e437fa95a948215316078b4
...
'http://deb.debian.org/debian/pool/main/libp/libpng1.6/libpng1.6_1.6.44-3.debian.tar.xz' libpng1.6_1.6.44-3.debian.tar.xz 31652 SHA256:c3c58c5cea3b4c8459ccf1bdfbaf35baa8d865a8b3b2fc322ccd6dc3697610c1
```

Other potentially useful URLs:

- https://sources.debian.net/src/libpng1.6/1.6.44-3/ (for browsing the source)
- https://sources.debian.net/src/libpng1.6/1.6.44-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libpng1.6/1.6.44-3/ (for access to the source package after it no longer exists in the archive)
...
- `libtasn1-6-dev:amd64=4.19.0-3+b3`
...
### `dpkg` source package: `libtool=2.5.4-2`

Binary Packages:

- `libltdl-dev:amd64=2.5.4-2`
- `libltdl7:amd64=2.5.4-2`
- `libtool=2.5.4-2`
...
```console
$ apt-get source -qq --print-uris libtool=2.5.4-2
'http://deb.debian.org/debian/pool/main/libt/libtool/libtool_2.5.4-2.dsc' libtool_2.5.4-2.dsc 2255 SHA256:e329e6b85decee3b5dcad3501600524259b67facb7385dc684a3a59d0c3fd2d4
...
'http://deb.debian.org/debian/pool/main/libt/libtool/libtool_2.5.4-2.debian.tar.xz' libtool_2.5.4-2.debian.tar.xz 37368 SHA256:73574a3ed3f5d2a2242f148372636dd8bf1cd3b346ee0ef89d54432a7ac8e117
```

Other potentially useful URLs:

- https://sources.debian.net/src/libtool/2.5.4-2/ (for browsing the source)
- https://sources.debian.net/src/libtool/2.5.4-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libtool/2.5.4-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.8.10-2.dsc' libx11_1.8.10-2.dsc 2519 SHA256:3c251eb0a8ac14ddaeac6ca1720d993e1164086b42c5f979df428ada4f029479
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.8.10.orig.tar.gz' libx11_1.8.10.orig.tar.gz 3192536 SHA256:b7a1a90d881bb7b94df5cf31509e6b03f15c0972d3ac25ab0441f5fbc789650f
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.8.10.orig.tar.gz.asc' libx11_1.8.10.orig.tar.gz.asc 833 SHA256:783f7cee17473f10248d2bbfbd446735ef47d8c7da24736c7b5c15caf7576dda
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.8.10-2.diff.gz' libx11_1.8.10-2.diff.gz 74852 SHA256:6c5853a7ab0c012a20821396122509da105dcf432d33d52da98898cc0b0d391e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libx11/2:1.8.10-2/ (for browsing the source)
- https://sources.debian.net/src/libx11/2:1.8.10-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libx11/2:1.8.10-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libxml2=2.12.7+dfsg+really2.9.14-0.2`

Binary Packages:

- `libxml2:amd64=2.12.7+dfsg+really2.9.14-0.2+b1`
- `libxml2-dev:amd64=2.12.7+dfsg+really2.9.14-0.2+b1`
...
```console
$ apt-get source -qq --print-uris libxml2=2.12.7+dfsg+really2.9.14-0.2
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.12.7%2bdfsg%2breally2.9.14-0.2.dsc' libxml2_2.12.7+dfsg+really2.9.14-0.2.dsc 2437 SHA256:7637f6cf2dbbc341f944b92602a776583f1f10fde10f93756e46f1fa6a5f7bdf
...
'http://deb.debian.org/debian/pool/main/libx/libxml2/libxml2_2.12.7%2bdfsg%2breally2.9.14-0.2.debian.tar.xz' libxml2_2.12.7+dfsg+really2.9.14-0.2.debian.tar.xz 36144 SHA256:36dc635e3ce0d15f98ecf4555ff265ce00ba33743e76ab827701333b9def5c3d
```

Other potentially useful URLs:

- https://sources.debian.net/src/libxml2/2.12.7+dfsg+really2.9.14-0.2/ (for browsing the source)
- https://sources.debian.net/src/libxml2/2.12.7+dfsg+really2.9.14-0.2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libxml2/2.12.7+dfsg+really2.9.14-0.2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libxrender=1:0.9.10-1.1`

Binary Packages:

- `libxrender-dev:amd64=1:0.9.10-1.1+b4`
...
- `libxslt1-dev:amd64=1.1.35-1.1+b1`
- `libxslt1.1:amd64=1.1.35-1.1+b1`
...
### `dpkg` source package: `linux=6.12.11-1`

Binary Packages:

- `linux-libc-dev=6.12.11-1`
...
'http://deb.debian.org/debian/pool/main/m/m4/m4_1.4.19-5.dsc' m4_1.4.19-5.dsc 1659 SHA256:c35451301bfc9de58590cc2b1383a1b00e5c5fb30343ad677bb902ec73493c9a
...
'http://deb.debian.org/debian/pool/main/m/m4/m4_1.4.19-5.debian.tar.xz' m4_1.4.19-5.debian.tar.xz 17648 SHA256:b9b8bd7eb52ac6dc5d8e7ba2fd7ed2925765e03ef3092b29bbd45aa0eb34a74a
```

Other potentially useful URLs:

- https://sources.debian.net/src/m4/1.4.19-5/ (for browsing the source)
- https://sources.debian.net/src/m4/1.4.19-5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/m4/1.4.19-5/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/m/make-dfsg/make-dfsg_4.4.1-1.dsc' make-dfsg_4.4.1-1.dsc 1976 SHA256:4207e14d2dfceadcfabd1bc5b392b37b004afe2670e76cff27d607c8a8f1e3ef
...
'http://deb.debian.org/debian/pool/main/m/make-dfsg/make-dfsg_4.4.1-1.debian.tar.xz' make-dfsg_4.4.1-1.debian.tar.xz 44572 SHA256:5fa0b82841979963c0512ef2147698fc24adb5f8d783172d7a3c6d68e3464f7e
```

Other potentially useful URLs:

- https://sources.debian.net/src/make-dfsg/4.4.1-1/ (for browsing the source)
- https://sources.debian.net/src/make-dfsg/4.4.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/make-dfsg/4.4.1-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `mariadb=1:11.4.4-3`

Binary Packages:

- `libmariadb-dev=1:11.4.4-3`
- `libmariadb-dev-compat=1:11.4.4-3`
- `libmariadb3:amd64=1:11.4.4-3`
- `mariadb-common=1:11.4.4-3`
...
```console
$ apt-get source -qq --print-uris mariadb=1:11.4.4-3
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_11.4.4-3.dsc' mariadb_11.4.4-3.dsc 5595 SHA256:db01fca348c5ff127a9f3f607e063f18e34f5a132aba185dfe015cd4e399880a
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_11.4.4.orig.tar.gz' mariadb_11.4.4.orig.tar.gz 111017581 SHA256:96fbd2e6e93fb7e8b373eea75d85b6fea57c0e111a02090cbbefed52599dc77b
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_11.4.4.orig.tar.gz.asc' mariadb_11.4.4.orig.tar.gz.asc 833 SHA256:908905072978bbd445dda3c2f2888dd024b150d89539bfe2121dce66625e4acf
'http://deb.debian.org/debian/pool/main/m/mariadb/mariadb_11.4.4-3.debian.tar.xz' mariadb_11.4.4-3.debian.tar.xz 290088 SHA256:4171be05b88447dfce49aa76289e6a035b6add3480e03afdeaf126d8aa275669
```

Other potentially useful URLs:

- https://sources.debian.net/src/mariadb/1:11.4.4-3/ (for browsing the source)
- https://sources.debian.net/src/mariadb/1:11.4.4-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mariadb/1:11.4.4-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `mercurial=6.9-1`

Binary Packages:

- `mercurial=6.9-1`
- `mercurial-common=6.9-1`
...
```console
$ apt-get source -qq --print-uris mercurial=6.9-1
'http://deb.debian.org/debian/pool/main/m/mercurial/mercurial_6.9-1.dsc' mercurial_6.9-1.dsc 2786 SHA256:be1d60099ef6d774cf348b2f1223b6b028f30f0dd25768cdaaacda39c6ea2bb0
'http://deb.debian.org/debian/pool/main/m/mercurial/mercurial_6.9.orig.tar.gz' mercurial_6.9.orig.tar.gz 8662295 SHA256:629604293df2be8171ec856bf4f8b4faa8e4305af13607dce0f89f74132836d6
'http://deb.debian.org/debian/pool/main/m/mercurial/mercurial_6.9.orig.tar.gz.asc' mercurial_6.9.orig.tar.gz.asc 659 SHA256:e6f85d8a0a5a5868ad38691005ad33aafd5f8603a135bfad4facbedea3563940
'http://deb.debian.org/debian/pool/main/m/mercurial/mercurial_6.9-1.debian.tar.xz' mercurial_6.9-1.debian.tar.xz 55388 SHA256:ba3521087cc02d767dfd533101fa1d095496ceac6d7c3558443edd6c64c3ff39
```

Other potentially useful URLs:

- https://sources.debian.net/src/mercurial/6.9-1/ (for browsing the source)
- https://sources.debian.net/src/mercurial/6.9-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mercurial/6.9-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.64.0-1.dsc' nghttp2_1.64.0-1.dsc 2531 SHA256:2707e30147f7f5c5562245f1760876476798cf0cac10a9784f8e66a4d14d42a3
...
'http://deb.debian.org/debian/pool/main/n/nghttp2/nghttp2_1.64.0-1.debian.tar.xz' nghttp2_1.64.0-1.debian.tar.xz 38888 SHA256:3085083399b3f02bfc00e9b4f9c286ddd33c9624b622713a55ebbd8c398625eb
```

Other potentially useful URLs:

- https://sources.debian.net/src/nghttp2/1.64.0-1/ (for browsing the source)
- https://sources.debian.net/src/nghttp2/1.64.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nghttp2/1.64.0-1/ (for access to the source package after it no longer exists in the archive)
...
- `libngtcp2-16:amd64=1.9.1-1`
- `libngtcp2-crypto-gnutls8:amd64=1.9.1-1`
...
- `libopenexr-3-1-30:amd64=3.1.5-5.1+b4`
- `libopenexr-dev=3.1.5-5.1+b4`
...
- `libopenjp2-7:amd64=2.5.0-2+b4`
- `libopenjp2-7-dev:amd64=2.5.0-2+b4`
...
- `libldap-dev:amd64=2.6.9+dfsg-1`
...
'http://deb.debian.org/debian/pool/main/o/openldap/openldap_2.6.9%2bdfsg-1.dsc' openldap_2.6.9+dfsg-1.dsc 3146 SHA256:73ecdf22c5c1a2eb46c8724f418881426585dc7a0719911d1dae6c735795d7aa
...
'http://deb.debian.org/debian/pool/main/o/openldap/openldap_2.6.9%2bdfsg-1.debian.tar.xz' openldap_2.6.9+dfsg-1.debian.tar.xz 171288 SHA256:f12a08b62e8fa13d68e935611b248ce30bf4575e58e874b4906066250821747e
```

Other potentially useful URLs:

- https://sources.debian.net/src/openldap/2.6.9+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/openldap/2.6.9+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openldap/2.6.9+dfsg-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `openssh=1:9.9p1-3`
...
```console
$ apt-get source -qq --print-uris openssh=1:9.9p1-3
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.9p1-3.dsc' openssh_9.9p1-3.dsc 3465 SHA256:a490245e3481601eddd5445e1f7e099c3a7020de8dfeb089f00003c23164721e
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.9p1.orig.tar.gz' openssh_9.9p1.orig.tar.gz 1964864 SHA256:b343fbcdbff87f15b1986e6e15d6d4fc9a7d36066be6b7fb507087ba8f966c02
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.9p1.orig.tar.gz.asc' openssh_9.9p1.orig.tar.gz.asc 833 SHA256:0a3c462e9cb862bf0bb3a56c7251091f1c88a47724d10cede3ea018f97cf1c94
'http://deb.debian.org/debian/pool/main/o/openssh/openssh_9.9p1-3.debian.tar.xz' openssh_9.9p1-3.debian.tar.xz 196860 SHA256:956984cca4c6b92875ea5923920042c40ce7db71ad92d55b51ecf94f9ef565b3
```

Other potentially useful URLs:

- https://sources.debian.net/src/openssh/1:9.9p1-3/ (for browsing the source)
- https://sources.debian.net/src/openssh/1:9.9p1-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssh/1:9.9p1-3/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.56.1-1.dsc' pango1.0_1.56.1-1.dsc 3690 SHA256:92df1c3706f369ced3116c601c61850bf9417132be24639dbd4d3e9c8ee653ca
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.56.1.orig.tar.xz' pango1.0_1.56.1.orig.tar.xz 1882616 SHA256:426be66460c98b8378573e7f6b0b2ab450f6bb6d2ec7cecc33ae81178f246480
'http://deb.debian.org/debian/pool/main/p/pango1.0/pango1.0_1.56.1-1.debian.tar.xz' pango1.0_1.56.1-1.debian.tar.xz 43776 SHA256:e7aa37d87b2d7e92ceba963c63a7f1b721556ec672535176b25e17a31fa9b255
```

Other potentially useful URLs:

- https://sources.debian.net/src/pango1.0/1.56.1-1/ (for browsing the source)
- https://sources.debian.net/src/pango1.0/1.56.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pango1.0/1.56.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-17=17.2-1`

Binary Packages:

- `libpq-dev=17.2-1+b2`
- `libpq5:amd64=17.2-1+b2`
...
```console
$ apt-get source -qq --print-uris postgresql-17=17.2-1
'http://deb.debian.org/debian/pool/main/p/postgresql-17/postgresql-17_17.2-1.dsc' postgresql-17_17.2-1.dsc 4242 SHA256:c09ed708c558cf28be0e09542f6a2fb728032b0c24c54338d65eee482ad72cd8
'http://deb.debian.org/debian/pool/main/p/postgresql-17/postgresql-17_17.2.orig.tar.bz2' postgresql-17_17.2.orig.tar.bz2 21408880 SHA256:82ef27c0af3751695d7f64e2d963583005fbb6a0c3df63d0e4b42211d7021164
'http://deb.debian.org/debian/pool/main/p/postgresql-17/postgresql-17_17.2-1.debian.tar.xz' postgresql-17_17.2-1.debian.tar.xz 25904 SHA256:059c2db558f667c039f7422fc97f764709f2c7f1ad50956a50afbf679fb379df
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-17/17.2-1/ (for browsing the source)
- https://sources.debian.net/src/postgresql-17/17.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-17/17.2-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python3-defaults=3.13.1-2`

Binary Packages:

- `libpython3-stdlib:amd64=3.13.1-2`
- `python3=3.13.1-2`
- `python3-minimal=3.13.1-2`
...
### `dpkg` source package: `python3.13=3.13.1-3`

Binary Packages:

- `libpython3.13-minimal:amd64=3.13.1-3+b1`
- `libpython3.13-stdlib:amd64=3.13.1-3+b1`
- `python3.13=3.13.1-3+b1`
- `python3.13-minimal=3.13.1-3+b1`
...
### `dpkg` source package: `rust-sequoia-sq=0.40.0-2`
...
```console
$ apt-get source -qq --print-uris rust-sequoia-sq=0.40.0-2
'http://deb.debian.org/debian/pool/main/r/rust-sequoia-sq/rust-sequoia-sq_0.40.0-2.dsc' rust-sequoia-sq_0.40.0-2.dsc 4171 SHA256:7caf806ba7176096534a2617a3211b422b57a3476ee4e889930a054943876614
'http://deb.debian.org/debian/pool/main/r/rust-sequoia-sq/rust-sequoia-sq_0.40.0.orig.tar.gz' rust-sequoia-sq_0.40.0.orig.tar.gz 666335 SHA256:412971915f99bf37510c016713e5905f2c1e26c4a12596c732ac7237aa0a6912
'http://deb.debian.org/debian/pool/main/r/rust-sequoia-sq/rust-sequoia-sq_0.40.0-2.debian.tar.xz' rust-sequoia-sq_0.40.0-2.debian.tar.xz 5264 SHA256:ef312e2e6cfde1402700d68327daf62ff301d25723db376e0b078cbbd9e18040
```

Other potentially useful URLs:

- https://sources.debian.net/src/rust-sequoia-sq/0.40.0-2/ (for browsing the source)
- https://sources.debian.net/src/rust-sequoia-sq/0.40.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rust-sequoia-sq/0.40.0-2/ (for access to the source package after it no longer exists in the archive)
...
- `libsvn1:amd64=1.14.5-2+b2`
- `subversion=1.14.5-2+b2`
...
```console
$ apt-get source -qq --print-uris subversion=1.14.5-2
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.5-2.dsc' subversion_1.14.5-2.dsc 4080 SHA256:12a6c28905b845d7600c98f78d5cddb2b66efa38b82cced003f6a3cfc5e72f32
...
'http://deb.debian.org/debian/pool/main/s/subversion/subversion_1.14.5-2.debian.tar.xz' subversion_1.14.5-2.debian.tar.xz 297456 SHA256:ea3c6398725284e72cce87d65866710352622807a323800e56030556fb64a987
```

Other potentially useful URLs:

- https://sources.debian.net/src/subversion/1.14.5-2/ (for browsing the source)
- https://sources.debian.net/src/subversion/1.14.5-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/subversion/1.14.5-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `sysprof=47.2-1`

Binary Packages:

- `libsysprof-capture-4-dev:amd64=47.2-1`
...
```console
$ apt-get source -qq --print-uris sysprof=47.2-1
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.2-1.dsc' sysprof_47.2-1.dsc 3059 SHA256:eae202b47dd6f952daf3fa4a535b8ca306fd06f440f47d48692907bd6f098777
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.2.orig.tar.xz' sysprof_47.2.orig.tar.xz 1192172 SHA256:e4b5ede9fd978ec3f0d5a0d44d0429a6d201c362bf6cb4527319031ae462c54f
'http://deb.debian.org/debian/pool/main/s/sysprof/sysprof_47.2-1.debian.tar.xz' sysprof_47.2-1.debian.tar.xz 16688 SHA256:b68f0621e16314d997374e16a84031c539a482021c3a65bd5f119d103f864729
```

Other potentially useful URLs:

- https://sources.debian.net/src/sysprof/47.2-1/ (for browsing the source)
- https://sources.debian.net/src/sysprof/47.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/sysprof/47.2-1/ (for access to the source package after it no longer exists in the archive)
...
- `libtiff-dev:amd64=4.5.1+git230720-5`
- `libtiff6:amd64=4.5.1+git230720-5`
- `libtiffxx6:amd64=4.5.1+git230720-5`
...
```console
$ apt-get source -qq --print-uris ucf=3.0049
'http://deb.debian.org/debian/pool/main/u/ucf/ucf_3.0049.dsc' ucf_3.0049.dsc 1512 SHA256:87e770afc9f4bb2cee0fa4dcb7c07d92e1c0867970db11926992f83fa7f8feef
'http://deb.debian.org/debian/pool/main/u/ucf/ucf_3.0049.tar.xz' ucf_3.0049.tar.xz 70588 SHA256:63eb1c0e81c7309d83acb84f98a5cf97c6610b97b87ed1db5e759bd43359d1a1
```

Other potentially useful URLs:

- https://sources.debian.net/src/ucf/3.0049/ (for browsing the source)
- https://sources.debian.net/src/ucf/3.0049/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ucf/3.0049/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `unbound=1.22.0-1`

Binary Packages:

- `libunbound8:amd64=1.22.0-1+b1`
...
- `bsdutils=1:2.40.4-2`
- `libblkid-dev:amd64=2.40.4-2`
- `libblkid1:amd64=2.40.4-2`
- `libmount-dev:amd64=2.40.4-2`
