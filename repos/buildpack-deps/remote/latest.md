...
```console
$ docker pull buildpack-deps@sha256:799b36b514dfc01f31b17d0a96070d3c09184915a913e7880424c1dd50e8e17c
```
...
```console
$ docker pull buildpack-deps@sha256:de72421c110f9356f33aeeb09d4f81bc30e7472efff0ae08794ac360a8435a98
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **384.2 MB (384243271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6514af8bc7a3f246d397f130c8e3c659d77eecfa01e95f29d555da710423057c`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:c7ae52debc8577603644e6d092a148b51760c6908961d0b95a35c368438a8318
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.2 MB (17203430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:764667f1e1cd345766ec7a0941895467aab07ed2b57fcf16c57601d721ec20e0`

```dockerfile
```

-	Layers:
	-	`sha256:cc5dd96ca7ceaeccfb83a6265c9d943eca93d5e6abd86f86c8aee85e9688ebfb`  
		Last Modified: Tue, 30 Dec 2025 11:21:10 GMT  
		Size: 17.2 MB (17192930 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a7de64f2e5c3ee386525916324ed164334e098882d2a6594d35600b298103388`  
		Last Modified: Tue, 30 Dec 2025 11:21:11 GMT  
...
```console
$ docker pull buildpack-deps@sha256:21ebfab2cc8110e3c965c164b7b6e995522f4c94881607cb8f73c2abe56a98af
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **462.3 MB (462272180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67b72e51b1bf6d5dca8080010076429dec996ebaa10a0737d44876cf10d32a18`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:6a8ebef94345d06bb4cec0035f574d59e5148141b8b7a0ca8930c05d6011ad2c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.3 MB (17274019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72f318823ae21ba04d0128600eae82625ede222c108a9ae8b80a2a34011de873`

```dockerfile
```

-	Layers:
	-	`sha256:8e6cc701cc2704b91bc19265be670dfe5e11a5377ab7347f35eec1d815d71bee`  
		Last Modified: Fri, 02 Jan 2026 23:21:18 GMT  
		Size: 17.3 MB (17263519 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b58fe1434f108ae5ffc1e72638e198f01bd19d6e7d4ea32285520b80e316dc19`  
		Last Modified: Fri, 02 Jan 2026 23:21:19 GMT  
		Size: 10.5 KB (10500 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull buildpack-deps@sha256:168c65678a236fde9fbfe9d8308e82eaa1a90701f87ab1a5cd275361fd55dcf5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **351.2 MB (351233655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:258808145baa2eadd0db26ae297ea00d95a1f62971ac4f92de926c83869c9be8`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:833253abade984d6b6d70162f4347b860cdec53efd1d39f2f009010feaac41b2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.0 MB (16995076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c734d8c8a8f6bb177b7729d42ef0a353cff751a0e57791df14004e6fc80d1b9`

```dockerfile
```

-	Layers:
	-	`sha256:d60be3d4a8cf81e3c486ea5245be668469a1bce5ffae39e4caf29762e6d47b8a`  
		Last Modified: Tue, 30 Dec 2025 08:21:36 GMT  
		Size: 17.0 MB (16984614 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:30244a7f77383cb1cccee9eee1be26d2f77875c0da6fc475cf5a13f4ea1e0633`  
		Last Modified: Tue, 30 Dec 2025 08:21:37 GMT  
		Size: 10.5 KB (10462 bytes)  
		MIME: application/vnd.in-toto+json
