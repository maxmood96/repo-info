...
```console
$ docker pull buildpack-deps@sha256:3d3221765220f09813ae9d512204a97a6af9a50598f33772e3be423ab21cd22b
```
...
```console
$ docker pull buildpack-deps@sha256:ca8811aabc590408dd8c92aed474d70d7f0c280f229f45f116af0fe78f594fe1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.0 MB (120028178 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:468624c16b4f5ef7f6ed3351dc5ebf8c8cd2bc153a56b502dacee68fd15f37ad`
...
```console
$ docker pull buildpack-deps@sha256:7c728c13c034f626a9f4d2acd963e3ae3416fb7acfbd2847fca3062c13048901
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.7 MB (114727617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61f8b15e4ea2d1606b8eecb8f447c7ca5814f8d4dc9da1f12bbcc64713aaf944`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:9739ae3f4fe8ba07a5bd8c7dea59d8d44bc27dd10f6c80800c51a4688f38ab61
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.7 MB (109665066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb0bb17d3fe573f11375944ff0adc3aed0ce04672ea24d13ea7eb379b9d37b94`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:1ec4634b14c5495e999d612130be41edada5b0f5dfd2f7bd1b5adc5de401e0c8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (118989945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:082f2a98b88fe4dc9d2f91ba1d727a0915139a91c1c1995279176e3720d03698`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:8216aa17b9cf87fc25ea0ffefbd723b9ceba03bf062bef9d66786a3b5363b3c2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.9 MB (122906193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9eff7043231521197c8120a40cfd2ac1492f22c99ba8f91d178f28b8c63844f`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:8c9731c4bc9a36e008418b6a3584d3261c13bdbc0f02136c606c9844b4b42041
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.1 MB (117105613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e36698fedd07ac99d576b0faf45b292ff787013cd186884b9785696f390bf386`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:b68bcb6617b76b3ba42889a9c7d11ca439deba4bae70db6e45efd698922c805b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.6 MB (130586045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e07c9a37e86d6a24dda9e37a98e54f4091d25b64737664464e48fdf8eb708130`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:868ef5a549bbbf3e2f42032aa2936e3d36242f8c7cc3c16d095adac90996de48
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.6 MB (117613505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abb0eeadf6e3e7d62f4d8429f98d5159c27de04d5391fb937247f6ee380b5ac6`
-	Default Command: `["bash"]`
