...
```console
$ docker pull buildpack-deps@sha256:9c347037b75b3dd56d972c4b89fb07db3f4ee4c75206f84f15aa462d7b880cb7
```
...
```console
$ docker pull buildpack-deps@sha256:996e52b4b36754d5f4a69eca558335dab93acd00e4937409443ebe4962cd614e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.0 MB (120018271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a23ec82284b583a19ed7134d40ffa68bf65737dd7ddb2703de9a6266ca86a860`
...
```console
$ docker pull buildpack-deps@sha256:4c9add36d8a4c49227ffb2207f2c2484a2ec7bb31e8963e2f88c759413ec8c33
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.7 MB (114714528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b8df4444ca46c6a14e9656d38be5a6af6aa2926292b9e2c33143cf562855ceb`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:636730fb56b815c8401e9e2e241d2757b2ef63479435668789f771eee0cada1e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.7 MB (109661329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4564f11b3b69ad45e52ba0046f3842a74950997e72d406d944da0b5f09700c56`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:5cde3c25e3917991b5fcdd37ad428bd4afd841f4b6e2e050eb28f83ef6dd3c1f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (118992168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6eadc5d2d417b6a4cfbaffed6bd7d4293b08d42626d4fd3c4903c498b2a65478`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:ea7d97ae6ec77c31101b8a6aab2bdee7aef68f9f37fc5f664403dd20b1152fc6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.9 MB (122893279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d1b2e92dc6408b2f431063e1aecbd580cf94d3a2989412a1a9e5371b8458d4d`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:9f796674d151ce2d9fc1864170c1903db315bd9b213aa6c2f1dced01ab0f477e
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.1 MB (117103381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8417b67ab188035e5685ff597485d9c22bd7f45ea69ed7c391c91c5083609c99`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:8682757e04b0617659cace85f5ea651651f2cceb7fcfecc9adfef72e1b0964d8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.6 MB (130579096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cb936ff652869f9d1a56934ff1c48544b4c57098b671e2e9b2ec5b4dafd6e50`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:9b1105f59ca44c636666849e1799c38134ab1e9f0cfba0e5e1f646b4b1567483
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.6 MB (117593989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8098351212e2cacab981b0708f2f2bfbcb7805e6c9f836b55f81a4ecadeb7a5c`
-	Default Command: `["bash"]`
