...
```console
$ docker pull buildpack-deps@sha256:32af903fd613bc8b58ce9e2b2b49d37490bf3e26f4968cdb4e16dda7f46d97a2
```
...
```console
$ docker pull buildpack-deps@sha256:238cbb1c4381f21d35228593283f3a7f2d1f68dc0d5640f46a87d4b140b79fde
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.5 MB (60513404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74d4bce9719f5816419885eec84869868cd1357c2c207c0f4d66e9de8b935517`
...
```console
$ docker pull buildpack-deps@sha256:9945e9998fa283bdcea59aff73b99e90a1a520d6dfe7fd101da57772f64d8eb5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.1 MB (58093662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d953a48ec1511fa57493c3b564163cfe2b7645dc459218d1c43b507d9449296`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:179e7fb60921d9d80d1d3540cad38ccec4eb597a35f333799a22f1425296d20d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 MB (55518201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23bbe33bef441329e94589e6f11d5a2db40b4778afcc3db12fd91bb9d3d0fb3c`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:9eb6ff072e985aab151d355de3be07e8317be69aa49b75f7361013b37b8331bf
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.0 MB (57001998 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0efb36306df751ba39400def4566b13b0e58f647c4fd19963b931b3bb0aa2e82`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:f6451f464d08a82d13485f8105c8a98fd18301305aed0670f052f2a5c8ee5650
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.5 MB (61474660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69606406695895ca32f1ee93b4c5876f9e4caf8288360d84d147975908f4f5dc`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:03e8bbdecd8906effedcd0592d8d89c8a4045ac503879bb6d6a87f663cdbb8b5
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.3 MB (59269890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d8f0a1c7a6c759a4420c53a972758c43c52bd34c989d00bea7bdbd099a8c744`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:34dcbf22224656aadb5a3e1a631a4c372560514412f942b0feb6d3a910dd4706
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.9 MB (59945189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56e69c1a2dce8bc6ee47afef745913726207b3f24ffe34fd1289a83f5360b9b6`
-	Default Command: `["bash"]`
...
```console
$ docker pull buildpack-deps@sha256:496ce20fdd196f57b943404cd034c86e981b5e3293d66ff2eddbef8dba366f4f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.9 MB (59931101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86050d2e9a70688b5fbfe64b0340ae74a2fe2a071d1b025b388bce3040428c15`
-	Default Command: `["bash"]`
