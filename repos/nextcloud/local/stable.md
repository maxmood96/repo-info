...
- Created: `2026-02-24T20:16:42.070231436Z`
...
### `dpkg` source package: `apache2=2.4.66-1~deb13u1`

Binary Packages:

- `apache2=2.4.66-1~deb13u1`
- `apache2-bin=2.4.66-1~deb13u1`
- `apache2-data=2.4.66-1~deb13u1`
- `apache2-utils=2.4.66-1~deb13u1`
...
```console
$ apt-get source -qq --print-uris apache2=2.4.66-1~deb13u1
'http://deb.debian.org/debian/pool/main/a/apache2/apache2_2.4.66-1%7edeb13u1.dsc' apache2_2.4.66-1~deb13u1.dsc 3526 SHA256:fab2538e4f04d341e7243297e79de00f3313e382c606fc9ce39f88510e1844df
...
'http://deb.debian.org/debian/pool/main/a/apache2/apache2_2.4.66-1%7edeb13u1.debian.tar.xz' apache2_2.4.66-1~deb13u1.debian.tar.xz 827460 SHA256:55e1fa97dcfdcc3dd84d568e63423d5a1a34cac1517acd72bab0bb0c2586ea05
```

Other potentially useful URLs:

- https://sources.debian.net/src/apache2/2.4.66-1~deb13u1/ (for browsing the source)
- https://sources.debian.net/src/apache2/2.4.66-1~deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/apache2/2.4.66-1~deb13u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `busybox=1:1.37.0-6`

Binary Packages:

- `busybox-static=1:1.37.0-6+b5`
...
```console
$ apt-get source -qq --print-uris busybox=1:1.37.0-6
'http://deb.debian.org/debian/pool/main/b/busybox/busybox_1.37.0-6.dsc' busybox_1.37.0-6.dsc 2279 SHA256:3ba2c096eef0c391f744f093edbe0df7b21ab118652487cc076818e92cb57e8e
'http://deb.debian.org/debian/pool/main/b/busybox/busybox_1.37.0.orig.tar.bz2' busybox_1.37.0.orig.tar.bz2 2565764 SHA256:3311dff32e746499f4df0d5df04d7eb396382d7e108bb9250e7b519b837043a4
'http://deb.debian.org/debian/pool/main/b/busybox/busybox_1.37.0-6.debian.tar.xz' busybox_1.37.0-6.debian.tar.xz 65032 SHA256:10b2cd64b41c26ae134e1cd6135b68575bbe79356c20985f35e32f32a1746c34
```

Other potentially useful URLs:

- https://sources.debian.net/src/busybox/1:1.37.0-6/ (for browsing the source)
- https://sources.debian.net/src/busybox/1:1.37.0-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/busybox/1:1.37.0-6/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/imagemagick-7-common/copyright`, `/usr/share/doc/libmagickcore-7.q16-10/copyright`, `/usr/share/doc/libmagickcore-7.q16-10-extra/copyright`, `/usr/share/doc/libmagickwand-7.q16-10/copyright`)
...
Licenses: (parsed from: `/usr/share/doc/libimath-3-1-29t64/copyright`)
...
### `dpkg` source package: `rsync=3.4.1+ds1-5+deb13u1`
...
```console
$ apt-get source -qq --print-uris rsync=3.4.1+ds1-5+deb13u1
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.4.1%2bds1-5%2bdeb13u1.dsc' rsync_3.4.1+ds1-5+deb13u1.dsc 2224 SHA256:7e0d5d074c2c371f38b38a71ebe6a6802c3bee567dbd93d087fc4349e4daca55
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.4.1%2bds1.orig.tar.xz' rsync_3.4.1+ds1.orig.tar.xz 646840 SHA256:bb9e2dda7e79d9639bc04bdafff6bb0b06a606ed915358b574696384215c9e5c
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.4.1%2bds1-5%2bdeb13u1.debian.tar.xz' rsync_3.4.1+ds1-5+deb13u1.debian.tar.xz 36672 SHA256:9aeeaf1688d2d4b6aa252e5399327bba04bc0aed372f84c69f25f22f51ee23f7
```

Other potentially useful URLs:

- https://sources.debian.net/src/rsync/3.4.1+ds1-5+deb13u1/ (for browsing the source)
- https://sources.debian.net/src/rsync/3.4.1+ds1-5+deb13u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rsync/3.4.1+ds1-5+deb13u1/ (for access to the source package after it no longer exists in the archive)
