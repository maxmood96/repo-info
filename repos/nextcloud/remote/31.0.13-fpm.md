...
```console
$ docker pull nextcloud@sha256:03935c210867530da51bf12a4b12771f13b6b11b207f3d6153c2683a31943d03
```
...
### `nextcloud:31.0.13-fpm` - linux; amd64
...
### `nextcloud:31.0.13-fpm` - unknown; unknown
...
### `nextcloud:31.0.13-fpm` - linux; arm variant v5
...
### `nextcloud:31.0.13-fpm` - linux; arm variant v7
...
### `nextcloud:31.0.13-fpm` - linux; arm64 variant v8
...
### `nextcloud:31.0.13-fpm` - linux; 386
...
### `nextcloud:31.0.13-fpm` - linux; ppc64le
...
### `nextcloud:31.0.13-fpm` - linux; s390x
