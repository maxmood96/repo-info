...
```console
$ docker pull nextcloud@sha256:39f2ccf5717ec232b6408754d0aa34b97d5ae6c5a332daefd6124c4adc88681a
```
...
### `nextcloud:18.0.2RC1-apache` - linux; amd64
...
### `nextcloud:18.0.2RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.2RC1-apache` - linux; 386
...
### `nextcloud:18.0.2RC1-apache` - linux; ppc64le
