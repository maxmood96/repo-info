...
```console
$ docker pull nextcloud@sha256:ff59222b422230cecd28df806b9d45e5c16a56c1740cb341c7f8b150df0c5bff
```
...
```console
$ docker pull nextcloud@sha256:22d14c3fe29617428df457eed84116b03b4fc14362b0f58c6917e5ef14479a47
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.9 MB (246894426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01076cc0b06c5e32dc0a62e4e78acfc1c18c09d5a1c55dbc444e05d41969ef5b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 11 Dec 2020 01:41:38 GMT
ENV NEXTCLOUD_VERSION=18.0.12
# Fri, 11 Dec 2020 01:42:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Dec 2020 01:42:49 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 11 Dec 2020 01:42:54 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Fri, 11 Dec 2020 01:42:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:20c8767538ad7b144540bb4d7289e2338971e55294a3a7fe250f9c1cc4240557`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:224a3fbd765cc2e9d639e9c86cba9c6b4470814dc3954c1f387e1fd083ed1c61`  
		Last Modified: Fri, 11 Dec 2020 01:56:07 GMT  
		Size: 103.3 MB (103286396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aea9702915fb34596d2484909fe3b669eb3cb750103f0058f7fb04e7391fcffc`  
		Last Modified: Fri, 11 Dec 2020 01:55:37 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18461ee6210bb1fe751c735107c8d6c9c87ddd551f01c4f6a20aa00a8d01af84`  
		Last Modified: Fri, 11 Dec 2020 01:55:37 GMT  
...
```console
$ docker pull nextcloud@sha256:116c6311c4c0c8747ba5dfd93741825e43b826605b5a3fa4c7c4207e21144601
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.2 MB (251239762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14273e6be6ef8a0d54b4583d8cf3127f1c6f8b0b60c344004c8bc40f34b1cbc8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 11 Dec 2020 01:07:31 GMT
ENV NEXTCLOUD_VERSION=18.0.12
# Fri, 11 Dec 2020 01:09:03 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Dec 2020 01:09:05 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 11 Dec 2020 01:09:07 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Fri, 11 Dec 2020 01:09:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Dec 2020 01:09:07 GMT
...
-	Layers:
	...
	-	`sha256:55e93a7d8babb7a6692b0e03bbdaba42bd7ddaa6b9625f625b3dfdbadbd19008`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eada9605e60484dc001169d2bd1294cbcb56bf4ff9eeea0ecdadc3fa5906f6a2`  
		Last Modified: Fri, 11 Dec 2020 01:20:26 GMT  
		Size: 103.3 MB (103286054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ce4b3080f5544980475479d781a38bf88b93be688b28402a54ecda26ce3ed6d`  
		Last Modified: Fri, 11 Dec 2020 01:19:21 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de6e2f3b35583e46d2a94e7def78eb687c8e4f9f01d7ff63f110ab557b2d33e1`  
		Last Modified: Fri, 11 Dec 2020 01:19:21 GMT  
		Size: 2.0 KB (1963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:1878b206921b8558797873e74a819aa5fb6ec64f23b9244ad94af8083c47a097
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.3 MB (254316912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27aaf5530438948bce09d311ff9b97cd530ffca33dae5615c6735f80faf72182`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Dec 2020 05:49:42 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 11 Dec 2020 01:52:13 GMT
ENV NEXTCLOUD_VERSION=18.0.12
# Fri, 11 Dec 2020 01:52:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Dec 2020 01:52:57 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 11 Dec 2020 01:52:59 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Fri, 11 Dec 2020 01:52:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Dec 2020 01:53:00 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:dc212703463c35be1285422d7dd85acdffb9b07966115d549990bfb70fa46705`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e192809285c98e9ad38426113d0a7f2ff31f58b547ccb31673322070f2371e02`  
		Last Modified: Fri, 11 Dec 2020 02:03:29 GMT  
		Size: 103.3 MB (103286209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31fef91ea3508d645d16cdab6210e51b0c7c11f582031f732ed67f7e940b4574`  
		Last Modified: Fri, 11 Dec 2020 02:03:17 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:054fd400d3a509072c8ee78d56e89b1dc3ff597b97d1001f8d841727471e9321`  
		Last Modified: Fri, 11 Dec 2020 02:03:18 GMT  
