...
```console
$ docker pull nextcloud@sha256:c7cd000f7ba2d14bf85afebdef6e22ee9d1e5182c125899d315800c2889ea862
```
...
```console
$ docker pull nextcloud@sha256:265a81b72031c1abb8de71c6e6eac131fe15403970777ca162ecb8849725718f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.2 MB (246185179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b6630709b6e632c87c614c0d663ea5760891ad0b1ba7fe534d69eeb4d0e8a97`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 19:13:48 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 08 Oct 2020 19:19:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:19:41 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:19:44 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:19:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:19:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:502edbe5badbd72b809c3cd2531471df09f2f34bc48164d7b303d05bc7433477`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b45544e60d50814b4e086b61450f7d41405b1a1ec7607faa37032445bc6f53ac`  
		Last Modified: Thu, 08 Oct 2020 19:53:14 GMT  
		Size: 102.6 MB (102594474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c45cfb89e0b30bdc494e823882cd35c425528b9234d48fc9cb0fe026fd0c75`  
		Last Modified: Thu, 08 Oct 2020 19:51:56 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e402a320930b264066617309916ef13e64650768d999d17cfb5beb4e97f2489d`  
		Last Modified: Thu, 08 Oct 2020 19:51:56 GMT  
		Size: 2.0 KB (1959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2cc0f1e9a8f59a9a448e7bebba7e28aba86827c5c5149761e1d52283fb3713a8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.3 MB (242337105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c36cf8bced256914712a2dc61c158308732ae1adffe06f6ffac32a6854ec980`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Oct 2020 21:22:22 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Fri, 09 Oct 2020 21:23:21 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Oct 2020 21:23:27 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 09 Oct 2020 21:23:31 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Fri, 09 Oct 2020 21:23:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Oct 2020 21:23:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:64452557764e65840f32b91f63493ca44c8de1653ec78e3fba1a7ec093304d16`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df1cb90d7309f45569ca80de0064f9c479878eb43ea8ff11fd7410dbd80e16d1`  
		Last Modified: Fri, 09 Oct 2020 21:50:58 GMT  
		Size: 102.6 MB (102594474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2870cb4a4568cc6fc101d406ad7c3e0afb02be8c9e60eba301a55e196d58e3f0`  
		Last Modified: Fri, 09 Oct 2020 21:50:26 GMT  
		Size: 2.5 KB (2521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b4bf7ea046af384adebebe7546beb7dc8e59f322171f52aff08fc446d9d7ba8`  
		Last Modified: Fri, 09 Oct 2020 21:50:25 GMT  
...
```console
$ docker pull nextcloud@sha256:6553eb4c487085e24511051054604504d35189be05cf36b5f21d969dac9d261a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.7 MB (274736993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf83289ed4c44ae7e8c500b64108046d502aeddacfc3cf16cb515954c4306053`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 19:11:10 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 08 Oct 2020 19:16:30 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:16:31 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:16:32 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:16:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:16:32 GMT
...
-	Layers:
	...
	-	`sha256:7740166b711a99401d5c9542c5715a5deaf6ee9aa9364e63548008d245d7c325`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c8fee0ff191e6522b7e1019387bf3988daff4ce1ebd3600880c7b4153186fda`  
		Last Modified: Thu, 08 Oct 2020 19:50:43 GMT  
		Size: 102.6 MB (102595671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:500d2c3eaf1710a4acd639f3bc677748fcc7e0a099b8cbecd142cd18e697284e`  
		Last Modified: Thu, 08 Oct 2020 19:50:02 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f4ca23e900897b5b6bf3f7d73855d6f0b3382a0067f32bdb757620110545809`  
		Last Modified: Thu, 08 Oct 2020 19:50:01 GMT  
		Size: 2.0 KB (1956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:03666c0251c20fe92920472f15d834313404262f7f40128448ebf15d3ee75a60
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.5 MB (250529689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8070f16855e00ffd15f44a22ac72b0ccc2d068cb888d13125fb1d702329479b8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 19:34:42 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 08 Oct 2020 19:39:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:39:59 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:40:00 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:40:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:40:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d8bf5347dc0a4a4ffb05cbaf79fb9d9f01910dbb7c179d886dbb2df319cfea37`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7deb7e33f85f56fb2a72e16580f3ba28489566d82ba881ba6477c62d732e35e5`  
		Last Modified: Thu, 08 Oct 2020 20:10:36 GMT  
		Size: 102.6 MB (102594236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5154b5477bf124598822f70fccef20539b73ac21d6f4f993ea563f2a623ac67`  
		Last Modified: Thu, 08 Oct 2020 20:09:31 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f95a062290836512b1cc9ed72d99eddfd3073cf17b2f99d3c69c6a883520513f`  
		Last Modified: Thu, 08 Oct 2020 20:09:31 GMT  
...
```console
$ docker pull nextcloud@sha256:abe44576c22d4ab5da539721b610b251f5bda4512aa612a616915e672f6b1ef9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **281.0 MB (280991233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d41fb4059f638cd4246b43e7f9eca5cfa814b110aaa98dc084cd758d0dfa55ca`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 22:09:16 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 08 Oct 2020 22:16:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 22:17:03 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 22:17:08 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 22:17:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 22:17:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9a85d176684f747041b6e135e92c9bb53e4cc1c407a90a1101baa0bb59438270`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e157a0c26fcf163e1db64e25fadf69add95db665742ed31bd863e285de5fd64f`  
		Last Modified: Thu, 08 Oct 2020 23:50:28 GMT  
		Size: 102.6 MB (102599397 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a6c9551e8f67193a5c6332d76e5f24ce43e79e56b5b7ae4c05d063fa7b7234f`  
		Last Modified: Thu, 08 Oct 2020 23:47:32 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a684bf3f90721cd5afdc8fb0b1bd2aa5b6f6e2be14c462dab14a5c409d414dc1`  
		Last Modified: Thu, 08 Oct 2020 23:47:32 GMT  
		Size: 2.0 KB (1956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:b89fd099f3c55934dd450c1dfcd28b404a7ac857cc2f4b753aea3ef0f4cdb4b4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.6 MB (253607496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc9a9ec4c3643c04201fb37d1ceb83a75ab62225ddaf55d2f62b74e0879ca715`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 19:42:20 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 08 Oct 2020 19:43:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:43:10 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:43:11 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:43:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:43:11 GMT
...
-	Layers:
	...
	-	`sha256:b449df9743b7ea17798b111306b303065e662691e99dc4534a0631c97959bce1`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef20330bd8ec4f811421c994ee9da5b04d59f80cae8b9255a3669b558ae1223a`  
		Last Modified: Thu, 08 Oct 2020 19:57:30 GMT  
		Size: 102.6 MB (102594241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:096131157e7a7e6b1c96a888e1e71742aac25e70195d90902788bfc459d07dee`  
		Last Modified: Thu, 08 Oct 2020 19:57:14 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17e2702355cbb5841a5f9326740c72b35cd51f462a59fc450e493d37def4e3ec`  
		Last Modified: Thu, 08 Oct 2020 19:57:15 GMT  
