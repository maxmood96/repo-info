...
```console
$ docker pull nextcloud@sha256:6fc90120733e0bf4500b04790e7cef38c1ef9bc33fe6785f34aa3c05f2dcaf86
```
...
```console
$ docker pull nextcloud@sha256:b2eeb6b02ac94f2b507c59c2b7030b473a433c039bce98b59c27d51312530466
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.4 MB (275428807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b51755b6eb68e4b83556c17a76305613f005174a552672b3e1c3b35c9815647`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Sat, 12 Dec 2020 05:50:46 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Sat, 12 Dec 2020 05:50:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 12 Dec 2020 05:50:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:49391f9d0dd828e670ea9d6690d014b187ca56837864062486a093d5d4a2fe01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5d99363f2d7b7c1d4fa3cb4dcd73ca4593a058056554ba1db38e3fbc26ef5fe`  
		Last Modified: Sat, 12 Dec 2020 06:25:00 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38c8e40a225b6cb5a4bfed38ac2914406907526186745daed2525b59a417973a`  
		Last Modified: Sat, 12 Dec 2020 06:25:00 GMT  
...
```console
$ docker pull nextcloud@sha256:c93c84c10b9122a53906f68a61e70b48b22f2e9cf5d156f6c6bbf6228344de43
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **281.7 MB (281712049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:631cc88857093877955d2aebd657a53c3c1854ed5122a4c596afd0f5fd09b1ad`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 12 Dec 2020 05:19:23 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Sat, 12 Dec 2020 05:19:26 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Sat, 12 Dec 2020 05:19:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 12 Dec 2020 05:19:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6b5f28db88bd803d9b95c2fc611fb87d931a3ad77706f49fb6ac0794ebce47af`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a86cf846e8a556ab69ac176a379cc68ec0267967071dc8c2e2cfb5607ea8103`  
		Last Modified: Sat, 12 Dec 2020 07:14:23 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41e9cffff484078b3e1b023eee00825e2bc6fa296a8cdfe9a5caef0f302c1d7d`  
		Last Modified: Sat, 12 Dec 2020 07:14:24 GMT  
