...
```console
$ docker pull nextcloud@sha256:6d0de15183574139b43182433e0eb4d70e200339e510ba6d6b2eee4a356b9aed
```
...
```console
$ docker pull nextcloud@sha256:f8d7ddd9ac1e52492517abca8ec52b6e108d0a4801a3481ca7accf345df5937e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.7 MB (260706769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de20f437b58d5c715f73440d2ddc45f57747c67ba80f3c234a6e0cabee2a17e7`
...
# Thu, 27 Feb 2020 05:13:04 GMT
ENV NEXTCLOUD_VERSION=18.0.1
# Thu, 27 Feb 2020 05:13:33 GMT
...
-	Layers:
	...
	-	`sha256:5708a3ac918494d8270de82dd627e6a265751b4051657548f7418cd38bfdd7bd`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:467a591b0d7595da78a7883e32e058d883c196d0a9330500854b3782f09f8504`  
		Last Modified: Thu, 27 Feb 2020 05:16:33 GMT  
		Size: 93.9 MB (93883328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327d8e8b1ee269a9e4dd29597e5fd9060ff8ecbd5ea12044e88eec4694fc7ce3`  
		Last Modified: Thu, 27 Feb 2020 05:16:19 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9098ca7f79fc9655b60b06c839cabed9604b4b9069cb274132452d506213cb7a`  
		Last Modified: Thu, 27 Feb 2020 05:16:19 GMT  
...
```console
$ docker pull nextcloud@sha256:f60fb686abc0dec3956cb013bdaef616feb7ca7aee45afa11502f2b04e3cdd10
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.3 MB (272282751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4875ba6ae399cf0be7e2cf7a044765d3304d0910636fca695599c29699eb9a0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 27 Feb 2020 04:32:09 GMT
ENV NEXTCLOUD_VERSION=18.0.1
# Thu, 27 Feb 2020 04:34:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 27 Feb 2020 04:34:39 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Thu, 27 Feb 2020 04:34:41 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Thu, 27 Feb 2020 04:34:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Feb 2020 04:34:48 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c1f3b069e65471b858607374b02f17426fa963dded87dbe72ca1ebac5480a097`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a39c0e9db922114a5c67b1393eaac1f9b5c96edd6d8cb93b4b8d770580f9e572`  
		Last Modified: Thu, 27 Feb 2020 04:41:40 GMT  
		Size: 93.9 MB (93884620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ee67d535b3b92d5cbb4c02a3c0c391dbb0f84333549c3a0f9dc665499d36155`  
		Last Modified: Thu, 27 Feb 2020 04:41:21 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c3521335dbd34c705781075d950767ebea586d36cf548d8c20fa602bcbd7a8d`  
		Last Modified: Thu, 27 Feb 2020 04:41:21 GMT  
		Size: 1.2 KB (1180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
