...
```console
$ docker pull nextcloud@sha256:7cc45e2b1e3fd41e8713084abd73da6ab7b77ee30200a3da8b1ba45aa12da4e2
```
...
```console
$ docker pull nextcloud@sha256:d00bc2a0f29b92e715cb575b15f0828c4a0d4a9dee93497762fa490ae7df7f53
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.1 MB (254101949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e24abfb59eb6c792356e32ed9d56dc20bc4a1dff3fdfde8160d536ef4cbe830`
...
# Tue, 26 Jan 2021 00:25:39 GMT
ENV NEXTCLOUD_VERSION=18.0.14
# Tue, 26 Jan 2021 00:26:13 GMT
...
-	Layers:
	...
	-	`sha256:949e46f3881e818a6cf792fa484c51782a791c3f3f74f51f563856515b8b607e`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3805be9c1ee75b67934a90f010d989596f5b1675e06db9b6555b9421fb52a60`  
		Last Modified: Tue, 26 Jan 2021 00:35:32 GMT  
		Size: 87.3 MB (87254065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17ab403563759e6e80c471ce1c7d8121939040647fbb05b74dafb51f65a4666`  
		Last Modified: Tue, 26 Jan 2021 00:35:09 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c55dbe5ebe934d6df561953fbb82fa32322689532022fb7a6e056fdab350c46a`  
		Last Modified: Tue, 26 Jan 2021 00:35:09 GMT  
...
```console
$ docker pull nextcloud@sha256:a9c03b74f112cbcdae45857665bb73208bb71687b97936052823066e1fbd1c63
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.5 MB (244454054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dfb2026d329df5c89d722e98bf66d683c33b780ec1d00a49a12adea7cd445b6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 01:47:10 GMT
ENV NEXTCLOUD_VERSION=18.0.14
# Tue, 26 Jan 2021 01:47:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 01:47:59 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 01:48:02 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 01:48:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 01:48:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:181a66a90d4b068723073fbaae791b4ebd4f41826429a25115ff89883e20d076`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a8b26257a83f02267bcdba85d60718472856fb960e1f88a7a66d047dcfa816b`  
		Last Modified: Tue, 26 Jan 2021 02:01:43 GMT  
		Size: 87.3 MB (87252960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee445071aa7a7d4888e98227f9a19fade044d86db1e4cd1de4deb6082e9c2d27`  
		Last Modified: Tue, 26 Jan 2021 02:01:18 GMT  
		Size: 2.5 KB (2533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b28f9b0260891205ac10606b5bfb8ac35dd16b37d25efe20132869de940ea9f`  
		Last Modified: Tue, 26 Jan 2021 02:01:17 GMT  
		Size: 2.0 KB (1956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:3ae725b5bbe30538965492c349b258adc836684cad130f6666031b23ff79592f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.4 MB (259406459 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ada3aaf752b108100f7af678b69cbdd75e364ba29ab73e210122256d0d437426`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 00:48:57 GMT
ENV NEXTCLOUD_VERSION=18.0.14
# Tue, 26 Jan 2021 00:49:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 00:49:33 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 00:49:34 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 00:49:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 00:49:35 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:057ac7dc5299a7dee2ef3a18c3f511bf817be51b1eaf7342104429566f8a9420`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a44d89b2208a8a4c3d7868cfc848cb4f87c173b4cf93bc4308968dfbdbe51814`  
		Last Modified: Tue, 26 Jan 2021 00:59:43 GMT  
		Size: 87.3 MB (87253459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e45d0cb339fce5aa5a87c051d3e99b86dfebea11898cbe29dc7cafb672eb5e91`  
		Last Modified: Tue, 26 Jan 2021 00:59:13 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3252586cdddcf80ee53e598707c5837a84c083de2054c2b6082d66004f283b2f`  
		Last Modified: Tue, 26 Jan 2021 00:59:13 GMT  
