...
### `nextcloud:30.0.1-fpm-alpine` - linux; amd64
...
### `nextcloud:30.0.1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:30.0.1-fpm-alpine` - linux; ppc64le
...
### `nextcloud:30.0.1-fpm-alpine` - linux; riscv64
