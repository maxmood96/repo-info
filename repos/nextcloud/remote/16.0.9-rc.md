...
```console
$ docker pull nextcloud@sha256:56628c34142205c0051f60f42a8dc3d1186ee058f0ec083f6f678bb4f2912134
```
...
### `nextcloud:16.0.9-rc` - linux; amd64
...
### `nextcloud:16.0.9-rc` - linux; arm64 variant v8
...
### `nextcloud:16.0.9-rc` - linux; ppc64le
