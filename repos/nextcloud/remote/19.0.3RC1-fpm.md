...
```console
$ docker pull nextcloud@sha256:498522a066e3fe9b126d387da7718a0bd0cd88daff236931ecd536a56eb62c1e
```
...
### `nextcloud:19.0.3RC1-fpm` - linux; arm variant v7
...
### `nextcloud:19.0.3RC1-fpm` - linux; mips64le
