...
```console
$ docker pull nextcloud@sha256:f310583af869bf00ab50bb53a6c763916c63b3312032cb6da6aabb001fcf0da1
```
...
### `nextcloud:33.0.3-fpm` - linux; amd64
...
### `nextcloud:33.0.3-fpm` - linux; arm variant v5
...
### `nextcloud:33.0.3-fpm` - linux; arm64 variant v8
...
### `nextcloud:33.0.3-fpm` - linux; 386
...
### `nextcloud:33.0.3-fpm` - linux; s390x
