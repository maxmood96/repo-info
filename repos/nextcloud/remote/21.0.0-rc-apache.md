...
```console
$ docker pull nextcloud@sha256:5e75c4b64275ff4a230a1ccc40a3aa0be39aa1135d33c0ac0e3ad7a75186d4af
```
...
### `nextcloud:21.0.0-rc-apache` - linux; arm variant v5
...
### `nextcloud:21.0.0-rc-apache` - linux; arm variant v7
...
### `nextcloud:21.0.0-rc-apache` - linux; 386
...
### `nextcloud:21.0.0-rc-apache` - linux; mips64le
...
### `nextcloud:21.0.0-rc-apache` - linux; s390x
