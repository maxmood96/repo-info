...
```console
$ docker pull nextcloud@sha256:21dd1ed5274094d62b67c669722f7a5c89ad72633cdb64af5839fca07ec4f7f9
```
...
```console
$ docker pull nextcloud@sha256:1d9a86c0407bc8e22bd85ef22653ce10cfff2e830b34297599bb0aeb5eee8e86
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.1 MB (312062261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7dd7d47fce523ee481cb6f066662f5d52526d35475b5c9178bc61e35f92f81b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 29 Jun 2021 10:45:20 GMT
ENV NEXTCLOUD_VERSION=21.0.2
# Tue, 29 Jun 2021 10:53:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 29 Jun 2021 10:54:02 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 29 Jun 2021 10:54:06 GMT
COPY multi:cdcd3c6679f774b6e9ec83ab3d5fca01b5ebe1961c10a136e3683d4c475000f0 in /usr/src/nextcloud/config/ 
# Tue, 29 Jun 2021 10:54:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Jun 2021 10:54:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:76a4f285619a204e46876481cf667b6a925f05a1e3c856ad3432fb0812fe0529`  
		...
		Size: 596.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:363afda5b3920819faed10c69837e1cc273dd613667b278a6920195ee386effe`  
		Last Modified: Tue, 29 Jun 2021 11:40:36 GMT  
		Size: 140.4 MB (140361175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be3c08e8ae082a0c950972e609ed08745969e0b31d22b0d9575f6e48d231b614`  
		Last Modified: Tue, 29 Jun 2021 11:36:00 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c892fc030045a1d3509f962880f07ac1d9c70d943761c02b59d632a9453323e`  
		Last Modified: Tue, 29 Jun 2021 11:36:00 GMT  
		Size: 2.0 KB (1997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:d61d4871efbecfe9d56be75e75337ce060af807966f62bc995573dd952d01f22
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **285.1 MB (285101840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a83f95e9e5767fca572ec7f52b1170092ff5268f44d04922581c10960100054c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 29 Jun 2021 09:37:25 GMT
ENV NEXTCLOUD_VERSION=21.0.2
# Tue, 29 Jun 2021 09:39:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 29 Jun 2021 09:39:32 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 29 Jun 2021 09:39:34 GMT
COPY multi:cdcd3c6679f774b6e9ec83ab3d5fca01b5ebe1961c10a136e3683d4c475000f0 in /usr/src/nextcloud/config/ 
# Tue, 29 Jun 2021 09:39:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Jun 2021 09:39:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:48f245e42b8b1a7910db548506f560fe8163275239b4e09e8ca8fc62a0ff43d1`  
		...
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e06c41297c4db795c5e4d576b3a721e122880656d23d9d60486fbfbced03e0c1`  
		Last Modified: Tue, 29 Jun 2021 09:51:18 GMT  
		Size: 140.4 MB (140356817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af152d1fc05a44ba106dea6479e4cbdf601decb313a0463278f82da0c15eda6b`  
		Last Modified: Tue, 29 Jun 2021 09:50:57 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:787b6155cec66b8c04c3aa339854cb90ec3e513fc8b62a83e5988395644787ca`  
		Last Modified: Tue, 29 Jun 2021 09:50:57 GMT  
