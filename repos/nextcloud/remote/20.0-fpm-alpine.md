...
```console
$ docker pull nextcloud@sha256:5553c7c21c87f1f1f96e5ef8f3257fe2011e292b54621f4a33533e49ec8f76aa
```
...
```console
$ docker pull nextcloud@sha256:7251ace06b97fec96c3847be86c624c0af28a402547c8797142169836978f9d0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.7 MB (183718711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b91785d43c0c69623f229cea3988e583ff988d8077d211de1995cceaff968230`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Sep 2021 08:55:37 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 08:55:38 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 24 Sep 2021 08:56:51 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Sep 2021 08:56:54 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 24 Sep 2021 08:56:57 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 24 Sep 2021 08:56:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 08:56:57 GMT
...
-	Layers:
	...
	-	`sha256:a7de5fff20360182bb5929c93f724b1ef42100600e4d876ebcd6eb22b9a65cde`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:563a24b4e9d427cf6e5754922974e524aaa1e64caec2678504cf474b01d2652d`  
		Last Modified: Fri, 24 Sep 2021 09:35:57 GMT  
		Size: 132.4 MB (132350471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39c98d7b499aab3bc8fb625856f584d48817866318735d9b1d228676dddf174b`  
		Last Modified: Fri, 24 Sep 2021 09:34:34 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d918466f53aabe25c662b6ceb9dc341aee44ef0f2659360389a9eb9fec471b62`  
		Last Modified: Fri, 24 Sep 2021 09:34:34 GMT  
...
```console
$ docker pull nextcloud@sha256:efbb4ef5595f38c285dbdf457b2a5e69e783b2a3cb980ad92c2674bef3035b9a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.5 MB (188458190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:346d56fe15845acf9cfb8965e4f834a8c2026e3edece9fd689f5729ded415766`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 24 Sep 2021 05:21:47 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Sep 2021 05:21:49 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 24 Sep 2021 05:21:50 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:88fba4dde7e8f0f58cb445601b5e690fa4f2a9436346caea0e1a032085ac1ee6`  
		...
		Size: 588.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b1195b697b448420934eefc042d3624bc5c50d0980ddfed1759c0f19f0f2b57`  
		Last Modified: Fri, 24 Sep 2021 05:39:38 GMT  
		Size: 132.4 MB (132350437 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8867169bce877f82ababa898bd625cea99bf48146d4ac90845326df68855c1d4`  
		Last Modified: Fri, 24 Sep 2021 05:39:10 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd9142d516eeb71042453e96185e3c08f9ca6ee82014011b8b90ec985c5df088`  
		Last Modified: Fri, 24 Sep 2021 05:39:10 GMT  
...
```console
$ docker pull nextcloud@sha256:cbcf2b9f45c66926c725553af1c183cc15bec8f1e36bf72066f3cd4c5af89631
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189074814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15fb48d4fe3d132d3536869a5ffcc87afd470b764e561375bf26a4867cd5fd24`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 15:42:47 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 24 Sep 2021 15:43:42 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Sep 2021 15:43:53 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 24 Sep 2021 15:43:58 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 24 Sep 2021 15:44:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 15:44:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:42be0939154f2f516f40995abc9ba1f74fc5ac4be27ae542e85cb7e589f21cf3`  
		...
		Size: 588.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f2a8e887a263a25a9620d1300b19fd9a6d1ac73bb8858a4fb4fa9c403639e7e`  
		Last Modified: Fri, 24 Sep 2021 16:24:02 GMT  
		Size: 132.4 MB (132350413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10c1ffc4ea9fa6d98e6cb4cef6feedf993fe8a52de09889456a1826b5d57181c`  
		Last Modified: Fri, 24 Sep 2021 16:23:41 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a904b7d7ba1681ff8db901c01aa7d3891a5a62c788df6b9cb87a461887b89c`  
		Last Modified: Fri, 24 Sep 2021 16:23:40 GMT  
