...
```console
$ docker pull nextcloud@sha256:61f9c77b6a9437163217e6aa748f9da9d88867df4da5e7aaafd109a4a4a0b69c
```
...
```console
$ docker pull nextcloud@sha256:b3e6fceb23fad7d47890449f3d8b0dc46e2a260d2cc12a2d47371d1a20f064d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **388.8 MB (388768582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29f53ded619c949282e7778079b5b2ececa1273d67802e27ad7660b2d96ec48c`
...
-	Layers:
	...
	-	`sha256:0e470b1418e08c0b93bbc7ef8566bad1cfa769c80d0cb26a54e1f1ca96097a23`  
		...
		Size: 766.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f930fd7aafe31ef77a09493d0ab8b849f1fa06d5ae83bd39548c69b8806d94b`  
		Last Modified: Mon, 24 Jul 2023 22:55:31 GMT  
		Size: 170.7 MB (170655293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25b611d24894bc7d855724abf6f6f2f1c539ad6f3103794447edffa2914819d1`  
		Last Modified: Mon, 24 Jul 2023 22:55:10 GMT  
		Size: 3.6 KB (3609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1173b06e5c6086dd24723befc19e504fc7ca20e92b84e78cfc890767cc4cbdb1`  
		Last Modified: Mon, 24 Jul 2023 22:55:11 GMT  
...
```console
$ docker pull nextcloud@sha256:65f7c4ea70e0605546b7aa0f51be8efc683f48d33794e8f3d5fd9d4e78d44120
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.5 MB (358542655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59e8438b94df4ba1216ebec00374f1d4018e662d7f1b70fb2a9d8fe4383e1c1b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 10 Jul 2023 21:57:48 GMT
CMD ["php-fpm"]
# Mon, 24 Jul 2023 23:01:29 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         busybox-static         bzip2         libldap-common         libmagickcore-6.q16-6-extra         rsync     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Mon, 24 Jul 2023 23:01:30 GMT
ENV PHP_MEMORY_LIMIT=512M
# Mon, 24 Jul 2023 23:01:30 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Mon, 24 Jul 2023 23:04:29 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libgmp-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmagickwand-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libwebp-dev         libxml2-dev         libzip-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         gmp         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.22;     pecl install imagick-3.7.0;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;         docker-php-ext-enable         apcu         imagick         memcached         redis     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'         | sort -u         | xargs -r dpkg-query --search         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Mon, 24 Jul 2023 23:04:30 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     mkdir -p /docker-entrypoint-hooks.d/pre-installation              /docker-entrypoint-hooks.d/post-installation              /docker-entrypoint-hooks.d/pre-upgrade              /docker-entrypoint-hooks.d/post-upgrade              /docker-entrypoint-hooks.d/before-starting;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Mon, 24 Jul 2023 23:04:30 GMT
VOLUME [/var/www/html]
# Mon, 24 Jul 2023 23:04:30 GMT
ENV NEXTCLOUD_VERSION=26.0.4
# Mon, 24 Jul 2023 23:05:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 24 Jul 2023 23:05:41 GMT
COPY multi:460d0253b10a0268ebfb8482b4fa36d0d335e8207e35802a68bf2d6134195fbb in / 
# Mon, 24 Jul 2023 23:05:41 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Mon, 24 Jul 2023 23:05:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 24 Jul 2023 23:05:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7110d30a140b894250a50bf6419f088d2b4c42fc9dd8c7cb1ec2c1a60e9e352d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51e3f726d9ef6deeab4bbfe42c43344b7e73a49d43263620cf99e84b9375a8be`  
		Last Modified: Mon, 24 Jul 2023 23:12:00 GMT  
		Size: 20.0 MB (19989880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32f31d57888ea1ed240ae25c9fec371081184c2de5ca1ffc83a1b1a7dc12e589`  
		Last Modified: Mon, 24 Jul 2023 23:11:59 GMT  
		Size: 20.2 MB (20223816 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e646b7a6b668fd2d442064a8460eef0f175db7a9b105231f9752966dc2803e3`  
		Last Modified: Mon, 24 Jul 2023 23:11:53 GMT  
		Size: 760.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2a2d90eb9d05959f2d00b512c35004caf15625f058338bae1c35fbe73ae9674`  
		Last Modified: Mon, 24 Jul 2023 23:12:26 GMT  
		Size: 170.7 MB (170652590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6608777a30ec760cb4d6a047c0aaa49ae240b6674d3eead5d98a275edb02783`  
		Last Modified: Mon, 24 Jul 2023 23:11:53 GMT  
		Size: 3.6 KB (3609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67f50b48e5f0b537fe41b289eeee3360bcfb7d0c790e2f8c7c6d770aa13d6d46`  
		Last Modified: Mon, 24 Jul 2023 23:11:53 GMT  
...
```console
$ docker pull nextcloud@sha256:48a4c2f0da76ff266a2e2b573f9268fa5a4e4bd3b5324b37c1f6935d4ff907f4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **380.1 MB (380106847 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef91d51d5d48f56f49ba492e3ff62ae508a6fd4946ae0cd67a6b80f0ad55829d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 24 Jul 2023 23:00:53 GMT
ENV NEXTCLOUD_VERSION=26.0.4
# Mon, 24 Jul 2023 23:01:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 24 Jul 2023 23:01:44 GMT
COPY multi:460d0253b10a0268ebfb8482b4fa36d0d335e8207e35802a68bf2d6134195fbb in / 
# Mon, 24 Jul 2023 23:01:45 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Mon, 24 Jul 2023 23:01:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 24 Jul 2023 23:01:45 GMT
...
-	Layers:
	...
	-	`sha256:6b3007c31e326bb774a614773bcdae3b83a4db1e8a68a3094d5ca96a8ce1cd50`  
		...
		Size: 762.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6516ca83ff94e3d7a9425e166845d0dae051b91764e0afc9b1075d43595fabb7`  
		Last Modified: Mon, 24 Jul 2023 23:06:48 GMT  
		Size: 170.7 MB (170655135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61b70815f5f29c8a68a559bf35d950722f98839c4902b734a4feda569c8f50a5`  
		Last Modified: Mon, 24 Jul 2023 23:06:32 GMT  
		Size: 3.6 KB (3607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aeae3bf2d9b290a0ae10fe65866625c9592b130c32ca86cef623e59c8e659a0`  
		Last Modified: Mon, 24 Jul 2023 23:06:32 GMT  
...
```console
$ docker pull nextcloud@sha256:d70171e262d0b93bc97d9fa93a2b126ea21652d4d5994e9492700a4e7ed891dc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **387.3 MB (387257382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a2f364274ad1dba8e40635c1726ad13e0da226a0aaa8d367b634efc41c526d8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 24 Jul 2023 22:56:13 GMT
ENV NEXTCLOUD_VERSION=26.0.4
# Mon, 24 Jul 2023 22:57:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 24 Jul 2023 22:57:17 GMT
COPY multi:460d0253b10a0268ebfb8482b4fa36d0d335e8207e35802a68bf2d6134195fbb in / 
# Mon, 24 Jul 2023 22:57:17 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Mon, 24 Jul 2023 22:57:17 GMT
...
-	Layers:
	...
	-	`sha256:75a7dc02473f9fbff009ccc9f89d512b4ecef3290e0359f757886b1b10276729`  
		...
		Size: 762.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16715de8f07baa28565283b2e1f3665973051977da008adec75826e3dfba353f`  
		Last Modified: Mon, 24 Jul 2023 23:03:55 GMT  
		Size: 170.7 MB (170654246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec7780d3b19ef63c9dbd22920c23a0a6661ae8f642b4eb25c8a5217227b26fb1`  
		Last Modified: Mon, 24 Jul 2023 23:03:22 GMT  
		Size: 3.6 KB (3608 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c809fc52ae6a1dc75c4009fb27e46817da787e36d3054785fd0f1c89b85237a5`  
		Last Modified: Mon, 24 Jul 2023 23:03:22 GMT  
		Size: 2.2 KB (2219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:a85afa099a5795e1842ec20c94d2babc8f16e5d4c673c52f28e4cb2aebfd8a66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.2 MB (330248606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68f488004bbb0ca882df4f2e125560074c12805e05edda9b4474d427d1af64d2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 20 Jul 2023 18:19:18 GMT
ENV NEXTCLOUD_VERSION=26.0.4
# Thu, 20 Jul 2023 18:22:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 20 Jul 2023 18:22:25 GMT
COPY multi:460d0253b10a0268ebfb8482b4fa36d0d335e8207e35802a68bf2d6134195fbb in / 
# Thu, 20 Jul 2023 18:22:35 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Thu, 20 Jul 2023 18:22:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Jul 2023 18:22:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:833bdb63fa2ce47a43580c98583f7582110566a77fcb35fb247630be90cd2319`  
		...
		Size: 712.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19002529d8663df9f2e831aef54a87c5480d91a7320a59dc5bad9b79b4dd8ed6`  
		Last Modified: Thu, 20 Jul 2023 18:39:23 GMT  
		Size: 170.4 MB (170411928 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6428a69befec181293b09a9c8b0861f6e3390560406876b179d9d843bdc5042`  
		Last Modified: Thu, 20 Jul 2023 18:37:39 GMT  
		Size: 3.6 KB (3609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22fab6bbe2bac5e4f50a482809303a5f358292e95c007bf156383dc2eec91137`  
		Last Modified: Thu, 20 Jul 2023 18:37:39 GMT  
