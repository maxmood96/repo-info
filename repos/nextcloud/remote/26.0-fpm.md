...
```console
$ docker pull nextcloud@sha256:31e97477dcc4576657556824fa97f61020f67e7d37e161f7842a9b6a3d6e2e49
```
...
```console
$ docker pull nextcloud@sha256:4d9e1c5eac69bea83ded7495b5875426cee41015fbf93411b9b322cf7e64849e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.6 MB (367603061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:292e2a44129814c6e7156cc865e2ff81e235094f809c1afc971b015e501a23fc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Apr 2024 03:47:52 GMT
VOLUME [/var/www/html]
# Tue, 09 Apr 2024 03:47:53 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Tue, 09 Apr 2024 03:49:11 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:49:15 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 09 Apr 2024 03:49:17 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Tue, 09 Apr 2024 03:49:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 03:49:17 GMT
...
-	Layers:
	...
	-	`sha256:7b331da3d7a4e3979354d99e2638d15424bfc5ad585b69fe0d704f299a34a7cb`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e716e4c940b4dac042aa40b55820f70b39e68621c28dffffc8e7a5508469859`  
		Last Modified: Tue, 09 Apr 2024 03:56:59 GMT  
		Size: 177.8 MB (177822159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a76141b91ec6810a0979cc2b815dc38f406ffd6e75a722848c468a2d433150e`  
		Last Modified: Tue, 09 Apr 2024 03:56:24 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8747e59389c87ec67436904abb89e47ca9ed1e0500e82d02477b37924bb53ae`  
		Last Modified: Tue, 09 Apr 2024 03:56:25 GMT  
...
```console
$ docker pull nextcloud@sha256:56a893bc80464e4415431840b05661e29a41578579a1650129c4a7499cc1be6b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **396.7 MB (396731420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fbc8e07e685e0085f80af3a68d78993e68f4f48149d471192724599746214ab1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Apr 2024 04:37:42 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Tue, 09 Apr 2024 04:38:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 04:38:56 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 09 Apr 2024 04:38:56 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Tue, 09 Apr 2024 04:38:56 GMT
...
-	Layers:
	...
	-	`sha256:e7e60e99019fe69af339a436ad98f378f1102124d237e934411ef0f00343fd15`  
		...
		Size: 762.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2b59ddfe1fddc6f3de56eb4a91f4101faac0818305b2517f91b74baf6514d28`  
		Last Modified: Tue, 09 Apr 2024 04:46:58 GMT  
		Size: 177.8 MB (177823196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feeaf81ecaedf8aa793343358cdb6f0e81848987226cb9355c96952da8cc8969`  
		Last Modified: Tue, 09 Apr 2024 04:46:22 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ea2b08154ca2a1bf27ae7cc29bc0becad189d8128863f68fe291fd760ca1f5d`  
		Last Modified: Tue, 09 Apr 2024 04:46:22 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
