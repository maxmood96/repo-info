...
```console
$ docker pull nextcloud@sha256:080720d8d944773ddf251bb706acd36ac9c7f07a6fa109ac15f25a0a5878fc0b
```
...
```console
$ docker pull nextcloud@sha256:cbe96f3f1db74c1b1c2cd1c22db53c5aa278d2012f7af76d3d05f80984b030ce
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.5 MB (349517156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d4b0f611d860aac6ca8fa74f58528da7c2d15e6e5cd5ea4d243df9f3c9efa44`
...
-	Layers:
	...
	-	`sha256:f170f797548770ae5479f91e075b8733395482881eb15344613e8e3f72149a2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e7f4485351edd4ac001bc43c08c08333a14c557d41d7d84e6b039837817113f`  
		Last Modified: Tue, 28 Mar 2023 04:56:43 GMT  
		Size: 4.0 MB (4023904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:963410c55b77193dcec4a4f180abccc1b3cfebe489c722df0aa3862b06877e51`  
		Last Modified: Tue, 28 Mar 2023 04:56:42 GMT  
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e47351cacb90b9c339313d62191d4a8e772f6b471bbb41abf6c5cb5e4e708d4`  
		Last Modified: Tue, 28 Mar 2023 04:57:01 GMT  
		Size: 164.6 MB (164570107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6a93b2b6ca4aa05924abb8700af7d5529c311c18c0a781f0e4a612c67134812`  
		Last Modified: Tue, 28 Mar 2023 04:56:42 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58b329b41dfed06eebc2d2725ea2965d87fec529bcf72289340a1f2c7d3f84f2`  
		Last Modified: Mon, 03 Apr 2023 23:52:15 GMT  
...
```console
$ docker pull nextcloud@sha256:36b519ee010466287dfc960c9f61748a03ed38e9683f75df0e93aa298b7f8775
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.0 MB (325025664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afbb702de9f8bbd26837aec3b594531f73a6c8f825973a3cbb381d2915fe9613`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 05:20:44 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 28 Mar 2023 05:34:01 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libgmp-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmagickwand-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libwebp-dev         libxml2-dev         libzip-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         gmp         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.22;     pecl install imagick-3.7.0;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;         docker-php-ext-enable         apcu         imagick         memcached         redis     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 05:34:02 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 28 Mar 2023 05:34:02 GMT
VOLUME [/var/www/html]
# Tue, 28 Mar 2023 05:34:02 GMT
ENV NEXTCLOUD_VERSION=26.0.0
# Tue, 28 Mar 2023 05:34:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 05:35:02 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Mon, 03 Apr 2023 23:47:06 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Mon, 03 Apr 2023 23:47:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 03 Apr 2023 23:47:06 GMT
...
-	Layers:
	...
	-	`sha256:fa7e038f40ea8fcddc8bfdbba692b8e6c93003d402626ae7056b3cbd1754664e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca292da3362cf8f4cf946fcceada1a5c2f22936e3856aa44291f3e48f2644383`  
		Last Modified: Mon, 03 Apr 2023 23:51:33 GMT  
		Size: 3.5 MB (3451249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de190deba2a79323100285666196b3ba1e63ef798af6b0f022395ee37c5d318f`  
		Last Modified: Mon, 03 Apr 2023 23:51:32 GMT  
		Size: 621.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d3b6007857c9e3b444f71b3809590ea50b938274f699dbda52c6b041295f4c0`  
		Last Modified: Mon, 03 Apr 2023 23:52:04 GMT  
		Size: 164.6 MB (164567742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab79919847f72f92460a7a0c7cdb2041cd82687202daeece60965027151471b6`  
		Last Modified: Mon, 03 Apr 2023 23:51:32 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ead45868491ac9ee03696ab00561c64bcd28f4b0a27334ed16f610e3c524b825`  
		Last Modified: Mon, 03 Apr 2023 23:51:32 GMT  
...
```console
$ docker pull nextcloud@sha256:9e1cc850e054579b44fd896ba512a3205da2f42e2263f856611cdd9ae278ff6f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.8 MB (315828162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae5eab34aed1f0ada91d0c8259b1a30ddc029de7659ece716a7c43c12fe6161f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 28 Mar 2023 06:49:47 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         busybox-static         bzip2         libldap-common         libmagickcore-6.q16-6-extra         rsync     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 28 Mar 2023 06:49:47 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 28 Mar 2023 06:49:47 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 28 Mar 2023 07:01:11 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libgmp-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmagickwand-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libwebp-dev         libxml2-dev         libzip-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         gmp         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.22;     pecl install imagick-3.7.0;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;         docker-php-ext-enable         apcu         imagick         memcached         redis     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 07:01:12 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 28 Mar 2023 07:01:12 GMT
VOLUME [/var/www/html]
# Tue, 28 Mar 2023 07:01:12 GMT
ENV NEXTCLOUD_VERSION=26.0.0
# Tue, 28 Mar 2023 07:02:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 07:02:15 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Tue, 04 Apr 2023 00:38:59 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Tue, 04 Apr 2023 00:38:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 04 Apr 2023 00:38:59 GMT
...
-	Layers:
	...
	-	`sha256:bcd4b30cf63e12a750514a9edc87b3acf2f82a7649d86681cacb3df3ba9b9a7d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d90eb2731ae60259ba42895ed8c30f8f152b31029a217df34c5d64d95eec532f`  
		Last Modified: Tue, 28 Mar 2023 07:08:27 GMT  
		Size: 15.9 MB (15869022 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a36c7872661f9d31fe06a720ca678a9f597fd5512a3be4d351b0457248d2a2c5`  
		Last Modified: Tue, 28 Mar 2023 07:10:25 GMT  
		Size: 3.4 MB (3353983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:227a8cdc242eb5ed3dcd644af454d627e6c3db449ab7b17c1a773a16007a3461`  
		Last Modified: Tue, 28 Mar 2023 07:10:25 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bc1fd981e4c911c69924f800dddef5be77fba24b361171c57dee9df8f40fbe3`  
		Last Modified: Tue, 28 Mar 2023 07:10:49 GMT  
		Size: 164.6 MB (164567860 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32b3fd5387e3e107e02f3b57355fe884c3585da377550424ca9de4f5847634bf`  
		Last Modified: Tue, 28 Mar 2023 07:10:24 GMT  
		Size: 3.1 KB (3056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:023dda61fd1f4ce29d81c513caa3348c2162f11c528592f7a3c685c8f5a30141`  
		Last Modified: Tue, 04 Apr 2023 00:43:04 GMT  
...
```console
$ docker pull nextcloud@sha256:d547512d0d5216637ca18d90122344a7e32f402c318574e11b47561c843f8af0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.4 MB (349413700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2f60bb3b4b7335e9df3144642683a7581ed49e0629bf7fbfb5ae96e539437f8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 05:54:54 GMT
ENV NEXTCLOUD_VERSION=26.0.0
# Tue, 28 Mar 2023 05:56:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 05:56:14 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Tue, 04 Apr 2023 00:19:27 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Tue, 04 Apr 2023 00:19:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 04 Apr 2023 00:19:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:02dc3307920032c5967a92af38d86636dc54678a471513aa29d0c8221fdb107e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3059610f9166382a474c839fe46bb37aa6857d5e69439006247d81993db7eb50`  
		Last Modified: Tue, 28 Mar 2023 06:10:35 GMT  
		Size: 3.8 MB (3838222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:328e7d8b23ee85a1e01d0e25f189cafd7b3996b139b9fab2ec22316ad7a4a8d2`  
		Last Modified: Tue, 28 Mar 2023 06:10:34 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e18dc1214b11584467a14a3254d7c01b3d441a5617b7c3d5f67b925673a2760`  
		Last Modified: Tue, 28 Mar 2023 06:11:09 GMT  
		Size: 164.6 MB (164570491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71491a4b7295e1a91bb9d95bfeea6b457ac5b860e8ec4d4d5d4abf341de34631`  
		Last Modified: Tue, 28 Mar 2023 06:10:34 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce4b6f328eca027d5093fc418f71ece674c44ee5a6a0dcc0ffbb67c4f57daafe`  
		Last Modified: Tue, 04 Apr 2023 00:22:38 GMT  
		Size: 2.2 KB (2225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:bcfcdea0afa48d9063cd5b6bafbc4ae3465e388199306794992f87df03c1da4d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.1 MB (324086899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8b5903f218bf38725d342b9df7c87ca754291ebc258c2ebbd162fc695aaa37d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Mon, 03 Apr 2023 23:15:56 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Mon, 03 Apr 2023 23:15:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 03 Apr 2023 23:15:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5f5fb1c239bdfc30831d21e70c475f1cbbdbadbd21ee498d4d1587f4545be578`  
		...
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ef791944f4794b5add194815ed7056f81dff44b954a5f2822a3aa5bd813074e`  
		Last Modified: Mon, 03 Apr 2023 23:17:41 GMT  
		Size: 2.2 KB (2227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
