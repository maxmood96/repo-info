...
```console
$ docker pull nextcloud@sha256:a7faa890549091c68514e623c477b24ff10448f6b27a713798dc9503d084597f
```
...
```console
$ docker pull nextcloud@sha256:f5ae22c9b9a3a812f723def9b9e22a44a6f9ce212aaa49f9eebc21cc4af8eb99
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **398.1 MB (398075437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f3c5c860834f72c68b814c3d585cabbff729103caee6ee8e221b16556f9fc79`
...
-	Layers:
	...
	-	`sha256:0959832664739f8ec0cdb8cd598a26210927b0d67a4a0b70fa5ea721c2a8f714`  
		...
		Size: 762.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f21da997a868f33f2dd0da816a5b2ddb456e2088c2d0407f835a33ad8db2f6a`  
		Last Modified: Tue, 09 Apr 2024 03:26:46 GMT  
		Size: 177.8 MB (177824142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e3e3cb2f1b721fc835463bea2d7af2d959ecf81c668b51c8c0c32c517c4ea5a`  
		Last Modified: Tue, 09 Apr 2024 03:26:24 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83a7c449b256192888774089f25b52d9d12009a05d175e816b0a23c06b94dea4`  
		Last Modified: Tue, 09 Apr 2024 03:26:24 GMT  
...
```console
$ docker pull nextcloud@sha256:7667a77342de7250e8dd9b32055a75f84b5729da7572697cf82d3d419974123e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.9 MB (355894069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:155b14239106b62de453913c5742822df9c152330061a862c9d3f4f52ab95b19`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Apr 2024 03:14:01 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Tue, 09 Apr 2024 03:15:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:15:23 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 09 Apr 2024 03:15:26 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Tue, 09 Apr 2024 03:15:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 03:15:26 GMT
...
-	Layers:
	...
	-	`sha256:3efb8a2a3dc2c5a9a25b14d1cd2214b0d1d55e64044f76c623e619345054c10b`  
		...
		Size: 764.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:099ccd3cf5dc44ce9f9efa2456b1d34d1392b72aee6d1f044a88d3207fbe7674`  
		Last Modified: Tue, 09 Apr 2024 03:24:57 GMT  
		Size: 177.8 MB (177821876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db7794e65094947dfa4d16744060b6d818c6268792004c91b288175fee88749d`  
		Last Modified: Tue, 09 Apr 2024 03:24:09 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ea2a6f9d236029b33bfeac3b6b3e1ec5ce77417eb985ae1b5b14e29a554fbbf`  
		Last Modified: Tue, 09 Apr 2024 03:24:09 GMT  
...
```console
$ docker pull nextcloud@sha256:83574804f853a5972cbad9042bddab3a5483ce05cb1f0c5408318575402d0a6f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **389.8 MB (389844704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35f7fb406b410c7d0a358d5e17568801f37069eb69cda2c00cc810af23aea697`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:09:57 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 09 Apr 2024 03:09:58 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Tue, 09 Apr 2024 03:09:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 03:09:58 GMT
...
-	Layers:
	...
	-	`sha256:fd8df652861208051f03057a009fe1b99415b988a651b30a32a1431af294fd01`  
		...
		Size: 762.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:323dd32e29208d16536036f68ddbe5abde58cfd11920d95e6ca32d68c4c153be`  
		Last Modified: Tue, 09 Apr 2024 03:16:06 GMT  
		Size: 177.8 MB (177823789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed0ca31b3efcd82a004e064806654019b0d1a607b835f6fceaf76bf8b4b6d8dc`  
		Last Modified: Tue, 09 Apr 2024 03:15:49 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b330283535ccb249d355073f5d3822afb9ce622c199b5b23d636f96cda274e7a`  
		Last Modified: Tue, 09 Apr 2024 03:15:49 GMT  
...
```console
$ docker pull nextcloud@sha256:bab82489705adb29bc40ba40b819dbe235f64c3e4299a6f5d9be0b52cc6c5714
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **403.5 MB (403512417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d67be6cc1699e9cb0981c5eadceb23426f62122094d7a477e54bacff8d77fad3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 09 Apr 2024 03:20:03 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Tue, 09 Apr 2024 03:21:24 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:21:36 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 09 Apr 2024 03:21:37 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Tue, 09 Apr 2024 03:21:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 03:21:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:50a22236bd1add4c8de3d159da2e8416d4b75e1060e96a31f0e587a577186908`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa51588db669434dfb75a09866a4833c3e1b1460b139be09c3ab9201dde7235b`  
		Last Modified: Tue, 09 Apr 2024 03:30:38 GMT  
		Size: 177.8 MB (177825456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6058e7df6b0d9d15065c37b68378fd41f640037d0deb984d88ee5a69a18ed84`  
		Last Modified: Tue, 09 Apr 2024 03:30:13 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89afe52251720a195df3e016b088a2b4e47dc8334264e5f81aa5afe7e7015925`  
		Last Modified: Tue, 09 Apr 2024 03:30:13 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
