...
```console
$ docker pull nextcloud@sha256:29fb6433d64315a27780fe4c0200bb06ece2267ce7a33cfbd665132a3522034f
```
...
### `nextcloud:31.0.10` - unknown; unknown
...
### `nextcloud:31.0.10` - linux; arm variant v5
...
### `nextcloud:31.0.10` - linux; arm variant v7
...
### `nextcloud:31.0.10` - linux; arm64 variant v8
...
### `nextcloud:31.0.10` - linux; ppc64le
