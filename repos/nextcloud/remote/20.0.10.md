...
```console
$ docker pull nextcloud@sha256:c8d87572b9cc85f7a4126cdfbbeec7f119864fa7236a7bece91537e8ff8611c6
```
...
```console
$ docker pull nextcloud@sha256:d2bb17b4ff59511d30b5f37f4669263b0f7b7d5e249b8bcff888efcb737fe9e1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.9 MB (296922853 bytes)**  
...
# Fri, 04 Jun 2021 00:59:40 GMT
ENV NEXTCLOUD_VERSION=20.0.10
# Fri, 04 Jun 2021 01:00:23 GMT
...
-	Layers:
	...
	-	`sha256:b942883838e9aba54411941264326426cc24fbdb68800f097dac950e647ab9e3`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c226bf0f75f7b2342d31f48b9e075f11f3538b42a2bd8318320cdb0aa493a13a`  
		Last Modified: Fri, 04 Jun 2021 01:08:24 GMT  
		Size: 132.5 MB (132536792 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2e3666cf3a42e886b24279015d1481a360ac611301942d8a624e0ca372af864`  
		Last Modified: Fri, 04 Jun 2021 01:08:00 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc1dcf6333349ba0c0dea0c9ff372a43f689fb7837975dfd21fa3343c3915c51`  
...
```console
$ docker pull nextcloud@sha256:94edd5c292589648349851914af8c04ee3eec7369e10bad9acec4f3dcf0e6659
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.7 MB (273734490 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:561c30e97413667ef733580aeea4a980902b32f08c794eea30bd639255087f88`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Jun 2021 02:53:49 GMT
ENV NEXTCLOUD_VERSION=20.0.10
# Fri, 04 Jun 2021 02:54:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 02:54:45 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Jun 2021 02:54:47 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 04 Jun 2021 02:54:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 02:54:47 GMT
...
-	Layers:
	...
	-	`sha256:a6f0955b611cb778ec8a57c061f74d8e857b4532bce4cb8cc01327b298389e55`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac9e671b75dfdd8ce4fc546887ea0f1568773f313bce1511bed959da808b4b26`  
		Last Modified: Fri, 04 Jun 2021 03:02:58 GMT  
		Size: 132.5 MB (132533947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46db9262babdf8f7ce000bc8fdde541c4400615a697bdde2deda18f0367c6e75`  
		Last Modified: Fri, 04 Jun 2021 03:02:30 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e47032a17306ae9c4818ad90b06750ac02d8213919474d14d5f339322b59eb9`  
		Last Modified: Fri, 04 Jun 2021 03:02:30 GMT  
...
```console
$ docker pull nextcloud@sha256:a0b381a95866989a633b65b2632f39c5c1a6220396ed2629e06d446555e0dfc2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.3 MB (302255561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e5f9af89701f999e2a037819e37c7633d396683c321f24d918973762e091633`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Jun 2021 00:54:35 GMT
ENV NEXTCLOUD_VERSION=20.0.10
# Fri, 04 Jun 2021 00:55:25 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 00:55:26 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Jun 2021 00:55:28 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 04 Jun 2021 00:55:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 00:55:28 GMT
...
-	Layers:
	...
	-	`sha256:b729e1ef048d3420b939859530be579d655acf8d05f3528e87232d35195f67bb`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f14863beb2ce2cd47f60bea8f646f65cbb4e1c1adf786249890d25791b5b6b5`  
		Last Modified: Fri, 04 Jun 2021 01:06:14 GMT  
		Size: 132.5 MB (132536057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c76e4b7c6094c3a8a481df567106a0005b51b3fa3b9c837684bcb1b6c4af786`  
		Last Modified: Fri, 04 Jun 2021 01:05:44 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf21297c212d5df323723df66a3376824bf4c1f0e94bd60f711b08209a91cd17`  
		Last Modified: Fri, 04 Jun 2021 01:05:44 GMT  
		Size: 2.1 KB (2059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:52c17088e9e41d10e94182abcb2a74cb7775f4fc6002683c316f7df6976b5d70
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **281.1 MB (281066411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f07032208fb98b4c18f87e9d87bc089b6046b70699ba703ce62ba4f6a3ce155`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Jun 2021 02:20:44 GMT
ENV NEXTCLOUD_VERSION=20.0.10
# Fri, 04 Jun 2021 02:21:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 02:21:47 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Jun 2021 02:21:48 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 04 Jun 2021 02:21:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 02:21:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:893474c894c4246d6a187e065ccb563664a6ad2b31935948fa2d4197e6410f3f`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:011d0ab2a452db38df696d36695f2b8a784558df72048b10ac9e663248d05102`  
		Last Modified: Fri, 04 Jun 2021 02:30:10 GMT  
		Size: 132.5 MB (132534901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7972e2e50e988fc29b9f741e29e30f1354e0d1fdf5d2f0edc3532fcf45eff8a5`  
		Last Modified: Fri, 04 Jun 2021 02:29:55 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6970f9953c35380a1e130e2bb48def9dcb34f85b1204dc70d5aee9b6ce36a9f0`  
		Last Modified: Fri, 04 Jun 2021 02:29:55 GMT  
