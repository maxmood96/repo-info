...
```console
$ docker pull nextcloud@sha256:38c265bae97b8a345c9afb250d2045579600de01632f52136c871cfe4bee8a45
```
...
```console
$ docker pull nextcloud@sha256:d3667c584d049bd6d256f11c2db8a9eaf8bd853e0fccc6a44490da68a1c84e1f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.4 MB (272390261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e3ab18e70dfb81da2a48013e98ba6d32c52ab3105c1e5dec36fa91c4616ec82`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 10:39:07 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Sat, 27 Jan 2024 10:40:24 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 10:40:29 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 27 Jan 2024 10:40:32 GMT
COPY multi:4ab4c3c752902e8e8635c15205bbb9fd1f91fe979fefe0b866b45989933f974c in /usr/src/nextcloud/config/ 
# Sat, 27 Jan 2024 10:40:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 10:40:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1e70a178016138c17eb66b889d6e542a91579f5f9f55dcc1c01734dcdf117225`  
		...
		Size: 756.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db486e3974a41c7ca7d6a4e74bda7863680bf7a1554aa574e72b021be564aaf9`  
		Last Modified: Sat, 27 Jan 2024 10:43:57 GMT  
		Size: 198.9 MB (198919287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99576d13af9b2e466d069baba90e27383b58f63b06993e93d2622a9e9bc7e25d`  
		Last Modified: Sat, 27 Jan 2024 10:43:20 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccf9587a328ed53f2f344c27d1bfff1bb4a4e7825ac47b8e01818281f0fa8b69`  
		Last Modified: Sat, 27 Jan 2024 10:43:20 GMT  
		Size: 2.3 KB (2279 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:9be120f53c77efb39028af9ef208809dc86aac07441b7dc1d5ee1b4a9bfa30a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **281.4 MB (281381189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f476efb2a45e7012b887182e58f7b9271aeda38b346efe5c909b17c4bdffa8dc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 10:42:12 GMT
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 10:44:36 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Sat, 27 Jan 2024 10:45:31 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 10:45:37 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 27 Jan 2024 10:45:37 GMT
COPY multi:4ab4c3c752902e8e8635c15205bbb9fd1f91fe979fefe0b866b45989933f974c in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:eb632d754f0cdffcf145fe4d390ad0ab993c0450d8dad73dd500ee89cb5b0684`  
		...
		Size: 755.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b84d27f42a92fa4085a91ba354601d149dea30b5ffa4ac34901af69a53d81f9f`  
		Last Modified: Sat, 27 Jan 2024 10:47:38 GMT  
		Size: 198.9 MB (198918864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8650a92f0858804386b362b4b821111c8eec817ae04c06c044a1962ecb68fed4`  
		Last Modified: Sat, 27 Jan 2024 10:47:20 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7db5eab39cb42abf0b703738464214edea920fcf2c59d49a30b1ee318f92a25`  
		Last Modified: Sat, 27 Jan 2024 10:47:19 GMT  
		Size: 2.3 KB (2280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
