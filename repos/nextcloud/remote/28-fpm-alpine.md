...
```console
$ docker pull nextcloud@sha256:f6af386bcab50fa10b4205ac45e054d1af3233c135abc0dcbfb957bd420d8731
```
...
```console
$ docker pull nextcloud@sha256:a13cf3e5a907f8cb2b2324b8de02e023c07c4808f670a5146e9501b3e2757ca7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.1 MB (289054407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa2ed2db511fed4902eb53997cd8dc47ad4b828416981cc4c90dd07b3f3bc624`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Oct 2024 19:06:11 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Fri, 11 Oct 2024 19:06:57 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 11 Oct 2024 19:07:01 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 19:07:02 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 19:07:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 19:07:02 GMT
...
-	Layers:
	...
	-	`sha256:b358d176fca44b3a5c1ffa3499e85011d49c50a7891b48a74dbeda5bf47f9d5f`  
		...
		Size: 713.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:947db6815ce199b1d1747c5047d00f5502da04d2895ff29d05d8ea5a88af7d4e`  
		Last Modified: Fri, 11 Oct 2024 19:16:33 GMT  
		Size: 204.6 MB (204627015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82c1873a8b9927ee8ef6c9cc41e7f403e223cde05c1226b2909a9c83ffaebbd4`  
		Last Modified: Fri, 11 Oct 2024 19:16:03 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:440c3033eec7b431ae3f9b4fb3532296d2a1a82ee2719f3988b0dad21e1fa861`  
		Last Modified: Fri, 11 Oct 2024 19:16:03 GMT  
...
```console
$ docker pull nextcloud@sha256:a767fc6acf1f63f58ef7d54ddf5df1d74b78d909b96efdf89dfe2689350ddae1
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **286.0 MB (286011397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e9412204716eb652f8bc0ad6285888e3504e695cfc10ed7fc5e1ea1af6d27f9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Oct 2024 20:21:14 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Fri, 11 Oct 2024 20:22:20 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 11 Oct 2024 20:22:25 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 20:22:25 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 20:22:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 20:22:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f3e838d6f3c058554f04cb46ad76e3c8031d37651ee77e87dd6d66398508c78c`  
		...
		Size: 712.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a1225bbce776a7d8a324989681181b6c37969caf9e549ac6d3a36c3a120b02e`  
		Last Modified: Fri, 11 Oct 2024 20:33:40 GMT  
		Size: 204.6 MB (204626833 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f332ba226047e3d5f6a0eca63799a2c831bd2a494494e3f391aa75abf71a0e2`  
		Last Modified: Fri, 11 Oct 2024 20:33:03 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d0c285b490489d134591b2eb82bb6de67c08b79a88db0b15bde6c778f09b2b1`  
		Last Modified: Fri, 11 Oct 2024 20:33:03 GMT  
		Size: 2.4 KB (2369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:b780cb47f6be9e0cfb230102c3613339b3b19df0fd5048abfe1f3edc47dda74e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.3 MB (290291700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a69255aef1f17c2d1940ad7a1ae80d2e97871826f402abdd419557a1c46417a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Oct 2024 18:46:49 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Fri, 11 Oct 2024 18:48:28 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 11 Oct 2024 18:48:35 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 18:48:36 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 18:48:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 18:48:36 GMT
...
-	Layers:
	...
	-	`sha256:03045188dd01b2e6736b5d662859130ed8ded8d774db589c5012cd1337630b00`  
		...
		Size: 714.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb9b461bc7d3e96495ef2764e6a4ea22510124445192a9ab7d073e0dbc9bf3e1`  
		Last Modified: Fri, 11 Oct 2024 19:02:35 GMT  
		Size: 204.6 MB (204627079 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3982c0d3d2daee53e01da2400dc10f281c8e46be35d9c1724d012a1f050fef4e`  
		Last Modified: Fri, 11 Oct 2024 19:02:04 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8eb1fba2b294694af80f31b2579da6a501c94292e30ed8064fcf7a51f01151d`  
		Last Modified: Fri, 11 Oct 2024 19:02:04 GMT  
		Size: 2.4 KB (2371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
