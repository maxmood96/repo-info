...
```console
$ docker pull nextcloud@sha256:2b06de3ec10c53c6a812e509c9dd38609086438e2568a4030d638368d72113e8
```
...
```console
$ docker pull nextcloud@sha256:58207da0c88c91bd0fa6d9a69cdf7745c761d5ecf1ed4a2ef1a18aad036d012f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.8 MB (397847045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:442cff4562763fd63465a2e076bc4719853e3e7746fa015c2076e446c2186380`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 24 Apr 2024 19:17:29 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Wed, 24 Apr 2024 19:18:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 19:18:43 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 19:18:44 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 19:18:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 19:18:44 GMT
...
-	Layers:
	...
	-	`sha256:8dec0d77baa04d831397adceb2b9c4c1741d8f4bc34dc81fabd616cb13930a8d`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43b499781a4b05d0cc5a5ea8675c4da4cd417c88d4b5713b744bb512ef854aca`  
		Last Modified: Wed, 24 Apr 2024 19:31:31 GMT  
		Size: 177.8 MB (177844596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f4f82728baca531e8fd51d9aacd627e206138e404cf18495dcd8c6e422c1b64`  
		Last Modified: Wed, 24 Apr 2024 19:30:56 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff81cbe9e4ef3e5550ef654e234b643914b2aa2fac0611249d283c4cca68a2f7`  
		Last Modified: Wed, 24 Apr 2024 19:30:56 GMT  
		Size: 2.4 KB (2396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:cd280bbaad203e1e7b42a2b2467336303e38fe7936e2a2f6679cf6530303bf5a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **370.3 MB (370301837 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:027f8c3f7e4ae148bcf90cbad64ced3abc0ad66ecbc93607e630ea17235f87b2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 18:30:10 GMT
ENV NEXTCLOUD_VERSION=26.0.13
# Wed, 24 Apr 2024 18:33:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.13.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 18:33:21 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 18:33:31 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 18:33:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 18:33:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:844007c85a5a63be5c74e0ef993ee54dbbd724a06f17f1da2b9002e006e6f620`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4eafbf84d8c928b8438df43a87c83618d957356f4937fc99e5065dbcf96f1e63`  
		Last Modified: Wed, 24 Apr 2024 19:11:17 GMT  
		Size: 177.6 MB (177617342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c56f99fd25cc3c5091e37eb1c81f8f5671db6d59a1828794269c6e63a2cece4`  
		Last Modified: Wed, 24 Apr 2024 19:09:18 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75fbc08ca12bb5e0fb756c00cd287e9d50bf0aaa7ef5ffa4c43e1a45f707d76f`  
		Last Modified: Wed, 24 Apr 2024 19:09:18 GMT  
		Size: 2.4 KB (2398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
