...
```console
$ docker pull nextcloud@sha256:993f9209fb4af61a687d979f596e4b65975a5e49550cd8a9d2342a1278c37188
```
...
### `nextcloud:30.0.4-fpm-alpine` - linux; amd64
...
### `nextcloud:30.0.4-fpm-alpine` - unknown; unknown
...
### `nextcloud:30.0.4-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:30.0.4-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:30.0.4-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:30.0.4-fpm-alpine` - linux; 386
...
### `nextcloud:30.0.4-fpm-alpine` - linux; ppc64le
...
### `nextcloud:30.0.4-fpm-alpine` - linux; s390x
