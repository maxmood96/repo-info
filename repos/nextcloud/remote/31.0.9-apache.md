...
### `nextcloud:31.0.9-apache` - linux; amd64
...
### `nextcloud:31.0.9-apache` - unknown; unknown
...
### `nextcloud:31.0.9-apache` - linux; arm variant v5
...
### `nextcloud:31.0.9-apache` - linux; arm variant v7
...
### `nextcloud:31.0.9-apache` - linux; arm64 variant v8
...
### `nextcloud:31.0.9-apache` - linux; 386
...
### `nextcloud:31.0.9-apache` - linux; ppc64le
...
### `nextcloud:31.0.9-apache` - linux; riscv64
...
### `nextcloud:31.0.9-apache` - linux; s390x
