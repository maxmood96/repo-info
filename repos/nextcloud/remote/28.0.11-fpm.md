...
```console
$ docker pull nextcloud@sha256:8a0b2c42d9f51c22e676611aefc6a5caf45184f9e4e7af0c9f8d84a9bab8a41d
```
...
```console
$ docker pull nextcloud@sha256:cd90ed9f22c55ecc312e614e21884e64dd86cfda8c19dea464570df835eee1ff
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **392.4 MB (392359244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c04567f476023abd25a2ac35c6fc91e8abf77b93f0096d85af5c240558af8bd8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Oct 2024 05:16:41 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Thu, 17 Oct 2024 05:17:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 05:17:47 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Thu, 17 Oct 2024 05:17:47 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Thu, 17 Oct 2024 05:17:47 GMT
...
-	Layers:
	...
	-	`sha256:6f97c3dea7d372e609233f0a6b8b596d58742f282a60f03b53f3aa90c97b4a58`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf372f6a0b541f2d8b6e9a98bd4ef4ba131f1bdd7f4f879a7a3ed352f667f2d8`  
		Last Modified: Thu, 17 Oct 2024 05:25:04 GMT  
		Size: 204.9 MB (204943080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db79bb144ddd208c083cef9250a59473e5ad52b4365cd98783b3cdb6709d02e2`  
		Last Modified: Thu, 17 Oct 2024 05:24:26 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c7bafcb312b90acb43fef2340a72b24fc897e9340a4af69ab38d8f599a39f7e`  
		Last Modified: Thu, 17 Oct 2024 05:24:26 GMT  
...
```console
$ docker pull nextcloud@sha256:0132028f24be78567f0b8906329a38d9e856045d0a57d78de27862b9cfdb8e54
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **414.0 MB (414045565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89ff5209bf0594793dc6ac840f1bdec34597b5529757031c2775d2e5f820f817`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Oct 2024 05:15:18 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Thu, 17 Oct 2024 05:16:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 05:16:12 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Thu, 17 Oct 2024 05:16:13 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Thu, 17 Oct 2024 05:16:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 17 Oct 2024 05:16:13 GMT
...
-	Layers:
	...
	-	`sha256:d0a88d69771d7bdbe846d9b9763a2d2c2fe50e2c1e24941d9a75f2e0d91aa272`  
		...
		Size: 710.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2129a2d6c01991cead6cee6d93c238c522c2a994450850c915f38aaa7e41caec`  
		Last Modified: Thu, 17 Oct 2024 05:22:00 GMT  
		Size: 204.9 MB (204945004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38360eb0f5158bb57f9948c7c5eb4dc6a296dc983b70acd3baab4ed4be060a26`  
		Last Modified: Thu, 17 Oct 2024 05:21:40 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9735e7d61c0280a1946b841edaaec1e4dc56f80c47c281946313a83c426b232`  
		Last Modified: Thu, 17 Oct 2024 05:21:40 GMT  
...
```console
$ docker pull nextcloud@sha256:67684f147decba386ebe1988fd6e92c3dc1c76d7b398af650ec32867de6ec519
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **392.4 MB (392357560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08d71837cd1efa79135c35a20af70920b1085d7e84dfbf0753519dc7edc6c3e1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Oct 2024 04:36:43 GMT
ENV NEXTCLOUD_VERSION=28.0.11
# Thu, 17 Oct 2024 04:37:20 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 04:37:25 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Thu, 17 Oct 2024 04:37:25 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Thu, 17 Oct 2024 04:37:25 GMT
...
-	Layers:
	...
	-	`sha256:30a3f85d270b23c58da8bbaa20984de005cdcdaca57342fdad1845a553670d86`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d68342072f0632cbb63be401dabad7e4f4d3b761db8f4dcd353ff61cb4f87fe7`  
		Last Modified: Thu, 17 Oct 2024 04:44:58 GMT  
		Size: 204.9 MB (204943311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7857a406f093efe69213b46f0448064fcdd038d873bbc72891d553de410b6b78`  
		Last Modified: Thu, 17 Oct 2024 04:44:35 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:226819995d4dc01342e32355d417f752e41ebfaa5fea416ed7b22a84b6799e61`  
		Last Modified: Thu, 17 Oct 2024 04:44:35 GMT  
