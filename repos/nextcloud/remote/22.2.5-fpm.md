...
```console
$ docker pull nextcloud@sha256:c1f17196af5244c742476139a224941c069daf96f6d7eb24cc1e60fcf4ab2e7f
```
...
### `nextcloud:22.2.5-fpm` - linux; amd64
...
### `nextcloud:22.2.5-fpm` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:e3b35dfc7b8f70fbb4ad07fbaa0bdc28be76e3e2200240d3b7f7d49a39775ea3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.3 MB (298266706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ba72293609de2e1938a83bf6abcb2e97e5e8b5c3e972078d1d87a0b141e414f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 12:45:37 GMT
ENV NEXTCLOUD_VERSION=22.2.5
# Fri, 11 Mar 2022 12:47:28 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 12:47:31 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 11 Mar 2022 12:47:33 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 11 Mar 2022 12:47:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 12:47:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0b565e653f90f1f8bee39671597803ec7dbe69f6161114971c83cadedd4d6d5e`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d8bce2da582f20fee6367274d9ec1c3a95ab1190c13e28b33f5e436934b6486`  
		Last Modified: Fri, 11 Mar 2022 13:03:02 GMT  
		Size: 143.0 MB (143029682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f33e7ecc4dc6dc189f63e0cbccaaca49c9e6a678e10fe40eae190c3d3951b2eb`  
		Last Modified: Fri, 11 Mar 2022 13:01:25 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0974d1e366e05ab054ffa6ec8627bb04b189117c5459ba3132b1afa247d28df6`  
		Last Modified: Fri, 11 Mar 2022 13:01:25 GMT  
		Size: 2.1 KB (2141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.5-fpm` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:cd1c01740b1c0f93f52799b9428fad4d4bf9f13e82446ed27e48afba57c041b1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.5 MB (289471047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45b312d2d4b1aea5ee2625b2e3c0cabb5007defd79bc27354b4a4d0d465f2e8d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 21:36:28 GMT
ENV NEXTCLOUD_VERSION=22.2.5
# Fri, 11 Mar 2022 21:38:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 21:38:13 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 11 Mar 2022 21:38:15 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 11 Mar 2022 21:38:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 21:38:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f3c92b9e0d2d58fd87fe6adaf58ec724ad78b906e6786481079ba70a211f6194`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64ef3b9bc52508cf0af39f13d26d00d9961893e778bbbd0f8242beec0cbb5e1c`  
		Last Modified: Fri, 11 Mar 2022 23:45:39 GMT  
		Size: 143.0 MB (143029661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:616e446f7db68faf471d6972ca805dbfb189e37767d2c21d0286f20cc181ad2b`  
		Last Modified: Fri, 11 Mar 2022 23:44:03 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80b2b798d0455fabf35f03470242b61cdc4d1a6a9ae4cf663a5a16c0bb8ac2b1`  
		Last Modified: Fri, 11 Mar 2022 23:44:03 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.5-fpm` - linux; 386
...
### `nextcloud:22.2.5-fpm` - linux; mips64le

```console
$ docker pull nextcloud@sha256:017cf8314ce628027db9c60b37de9245ed584da9875e44fab5bea3f6e2a3f35a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.1 MB (297050546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3804cef41c99a48a71334c1c30e8575e877bdad6b18dbd07df40afef43a848d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 17:19:17 GMT
ENV NEXTCLOUD_VERSION=22.2.5
# Fri, 11 Mar 2022 17:22:00 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:22:11 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 11 Mar 2022 17:22:19 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 11 Mar 2022 17:22:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 17:22:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:97cc356af101976599434151c23a58c98161266cfc3c8be62cc82075bc88b552`  
		...
		Size: 566.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc889e2b41dbf4efde61a1ab7ef438dca6c0a441e60e40263ca0c6afd52683d`  
		Last Modified: Fri, 11 Mar 2022 17:38:25 GMT  
		Size: 142.8 MB (142793136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a19443fe7dd4cb88c6783912d2094608ef7a6290b24a4a53fb485a4af0891331`  
		Last Modified: Fri, 11 Mar 2022 17:36:47 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6ab92c5589d0b10c6c00fcca12032df8f1a9a266a011103849ce775845ea062`  
		Last Modified: Fri, 11 Mar 2022 17:36:47 GMT  
		Size: 2.1 KB (2142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.5-fpm` - linux; s390x
