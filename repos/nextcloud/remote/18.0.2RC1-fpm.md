...
```console
$ docker pull nextcloud@sha256:2f668cf09571ad7c15ce12425935a30bedf37135f6bd66ff91d1242e54c518dc
```
...
### `nextcloud:18.0.2RC1-fpm` - linux; amd64
...
### `nextcloud:18.0.2RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.2RC1-fpm` - linux; 386
...
### `nextcloud:18.0.2RC1-fpm` - linux; ppc64le
