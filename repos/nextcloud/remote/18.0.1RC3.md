...
```console
$ docker pull nextcloud@sha256:ee6ca005eb05975924b9add2041deaa3c317865f1f2509900a8afb316a586fc3
```
...
### `nextcloud:18.0.1RC3` - linux; amd64
...
### `nextcloud:18.0.1RC3` - linux; arm variant v7
...
### `nextcloud:18.0.1RC3` - linux; arm64 variant v8
...
### `nextcloud:18.0.1RC3` - linux; ppc64le
