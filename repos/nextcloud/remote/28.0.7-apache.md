...
### `nextcloud:28.0.7-apache` - linux; arm variant v5
...
### `nextcloud:28.0.7-apache` - linux; arm64 variant v8
...
### `nextcloud:28.0.7-apache` - linux; 386
...
### `nextcloud:28.0.7-apache` - linux; mips64le
...
### `nextcloud:28.0.7-apache` - linux; s390x
