...
```console
$ docker pull nextcloud@sha256:30bbd7f7d363f0b79028fe82a1f525cc00798352c396d961a8b02e6923a99fdf
```
...
### `nextcloud:32.0.5-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.5-fpm-alpine` - unknown; unknown
...
### `nextcloud:32.0.5-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:32.0.5-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:32.0.5-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.5-fpm-alpine` - linux; 386
...
### `nextcloud:32.0.5-fpm-alpine` - linux; ppc64le
...
### `nextcloud:32.0.5-fpm-alpine` - linux; s390x
