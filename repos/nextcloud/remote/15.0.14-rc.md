...
### `nextcloud:15.0.14-rc` - linux; amd64
...
### `nextcloud:15.0.14-rc` - linux; arm variant v5
...
### `nextcloud:15.0.14-rc` - linux; arm variant v7
...
### `nextcloud:15.0.14-rc` - linux; arm64 variant v8
...
### `nextcloud:15.0.14-rc` - linux; 386
...
### `nextcloud:15.0.14-rc` - linux; ppc64le
