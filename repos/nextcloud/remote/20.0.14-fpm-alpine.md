...
```console
$ docker pull nextcloud@sha256:f25c05d2ed4a22161b1f2cc7100d817af2c638f6aefda4a936e9137483e954ed
```
...
```console
$ docker pull nextcloud@sha256:4d4d10cd5aa1fd6c75dfd1d1cc29ae03057e33b44001d970f3b425a4635bbb47
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172285647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6eb54db3f711e666fa5388d3818117930316b268be86919a91deb1265fddaf6b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 13:10:30 GMT
ENV NEXTCLOUD_VERSION=20.0.14
# Sat, 13 Nov 2021 13:11:42 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 13:11:45 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 13:11:48 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 13:11:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 13:11:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:30673971c9518b81722597d5e8c02e93c70dec4576b10328060a3db392fe00b7`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6efdb83f4836419c62f405ee337d0d706dc0be8fd2bb7816f81b6dde910cb0b7`  
		Last Modified: Sat, 13 Nov 2021 13:23:08 GMT  
		Size: 120.0 MB (119992216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22ac29a5bda91cd6bfd3ebf128bb924d1936474ba68af98e99ba1acb58bf8590`  
		Last Modified: Sat, 13 Nov 2021 13:21:47 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:134995c34811b298d657e111e0e6ef08c226e9711ec92408999bdca30de983d9`  
		Last Modified: Sat, 13 Nov 2021 13:21:47 GMT  
...
```console
$ docker pull nextcloud@sha256:eb796abdd304c8a7d5a5d0d99fe06284c201ccf70f4eb0a87e0e20b8d1f62b56
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170653160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d7bbf97dce772dc8f4792cd8304be4c48361aa4e20dc869af0fc5919fe157e3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 11:55:34 GMT
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 11:55:35 GMT
ENV NEXTCLOUD_VERSION=20.0.14
# Sat, 13 Nov 2021 11:56:44 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 11:56:47 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 11:56:49 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 11:56:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:9ff78be71c62c6509ac7e3c41c680bfd47899d63faf7b282c14a30fc7df5f0b5`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a35b583edb880aa78edfccb2146a85cd2b7aa7be7edf4e688a85bd7b8f3376c7`  
		Last Modified: Sat, 13 Nov 2021 12:20:53 GMT  
		Size: 120.0 MB (119992332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:606922bcd701988e733989c429558283e954a8d16e460f9d75b8bffdc8fd9030`  
		Last Modified: Sat, 13 Nov 2021 12:19:32 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1452f5fdde166f916eaca8b596933e981b1cbb40a2af1b0ed8a8dc048d8f7c99`  
		Last Modified: Sat, 13 Nov 2021 12:19:32 GMT  
...
```console
$ docker pull nextcloud@sha256:afcd1dcdc4008f0d44c95b9c8d04a6e0e3a900aa675b10850880820e225b615a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.9 MB (173905268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8453c0724dd0678bfc73571a477369f753dadee7eca168318b2f044ccd7bdae8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 11:47:58 GMT
ENV NEXTCLOUD_VERSION=20.0.14
# Sat, 13 Nov 2021 11:50:06 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 11:50:08 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
...
-	Layers:
	...
	-	`sha256:31cfe23dd9033cec539565c6947390bbd14f07c84d8e1b1c279e33148836f568`  
		...
		Size: 558.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adc33f331fecef97604fce322eaddb713f116ca8e9401ce1cd75c7232769ff14`  
		Last Modified: Sat, 13 Nov 2021 12:14:05 GMT  
		Size: 120.0 MB (119993743 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25304b863b4716ac0560aee7b23a67f7a02fe4e8e77bf3356fc548e108e15bd9`  
		Last Modified: Sat, 13 Nov 2021 12:13:45 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab2722adce897ff5c89b60b1b4fa3533fc6c7f0b117d8159dd0dc352524bc52d`  
		Last Modified: Sat, 13 Nov 2021 12:13:44 GMT  
...
```console
$ docker pull nextcloud@sha256:0a4a399bf196d181dc03cc5054e9e68d20c46cee286f566493d290fb4aa4a4fc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.0 MB (175956968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67c70aca6fc2231079290c92e13f3b3b9737df28575d44d49b0e0a28a30c5db8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 18:45:23 GMT
ENV NEXTCLOUD_VERSION=20.0.14
# Sat, 13 Nov 2021 18:46:13 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 18:46:24 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 18:46:26 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 18:46:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 18:46:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8c4905e8291225ebb4a74cf1c3df0007e9f9564a18a64c4206d6c565897b9bdb`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa2a4caaad68f22684e67e7cce27c3383015a6f2609a7a32e377942cf17c1f0c`  
		Last Modified: Sat, 13 Nov 2021 18:58:31 GMT  
		Size: 120.0 MB (119992209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e2b2fe9a748f6dc4c9deae2a5472ffbbaf53b6c42090f99522513b996ce5945`  
		Last Modified: Sat, 13 Nov 2021 18:57:32 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f8ec7bcaa47d4f0c126cfa5a98d32115dfdc95c4dfb3c4c48455382a6af8242`  
		Last Modified: Sat, 13 Nov 2021 18:57:32 GMT  
