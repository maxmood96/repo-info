...
```console
$ docker pull nextcloud@sha256:89addf91c6612885575d2087bb7d3587bee28c0f4f2c3f368824bcd2a20c3d8e
```
...
### `nextcloud:20.0.11` - linux; arm variant v5
...
### `nextcloud:20.0.11` - linux; arm variant v7
...
### `nextcloud:20.0.11` - linux; arm64 variant v8
...
### `nextcloud:20.0.11` - linux; mips64le
...
### `nextcloud:20.0.11` - linux; ppc64le
