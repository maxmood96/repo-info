...
```console
$ docker pull nextcloud@sha256:de293fa67a1d4a5cd8378900b8e2d31ba080b35536e58ae7db17647a9b556e22
```
...
### `nextcloud:27.1.0-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:27.1.0-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:27.1.0-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:27.1.0-fpm-alpine` - linux; 386
...
### `nextcloud:27.1.0-fpm-alpine` - linux; s390x
