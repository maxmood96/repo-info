...
```console
$ docker pull nextcloud@sha256:755a55047796ad91ab030bbb50f59970cd6d28bbe3382df32da40572eb0de15e
```
...
### `nextcloud:22.2.10-fpm` - linux; amd64
...
```console
$ docker pull nextcloud@sha256:2acf07fab762bc81aec8fab3bcbbc219ec2090d99b2c865c3e474663af724f1c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.2 MB (298165079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f8c7c8050557f957d89782c4b739b75034190f0576e86371429b7e401996266`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Aug 2022 00:07:48 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Wed, 24 Aug 2022 00:09:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 00:09:10 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 24 Aug 2022 00:09:11 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 24 Aug 2022 00:09:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Aug 2022 00:09:11 GMT
...
-	Layers:
	...
	-	`sha256:bdb47e274bc52e99d0eb9aed8b0540c93b09d210ce74f47ce50dbfc600b20ff1`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c23fff95009fd31972575e37885970a952edabd3bc0bc261ce0b0fdc9c3035aa`  
		Last Modified: Wed, 24 Aug 2022 00:19:22 GMT  
		Size: 143.0 MB (142980737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eddd7bc91508b582c32131cca8fff38341388da225b71eef0370a4378e9c461`  
		Last Modified: Wed, 24 Aug 2022 00:18:40 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb26c202476f2c11e4ae7efd699de7b66da476dfde63c7610f29f1c90d531595`  
		Last Modified: Wed, 24 Aug 2022 00:18:40 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-fpm` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:a481d7a3cc03f1f54a84f1353cb1e8a3b7a02b8f56735803af26c1f06aefa9e9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.4 MB (289370839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06f9d55b626ba41d06b89b85d6b5a0beb0caf67addaf45744c0027c4b788412f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Aug 2022 11:42:05 GMT
VOLUME [/var/www/html]
# Wed, 24 Aug 2022 15:40:51 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Wed, 24 Aug 2022 15:41:42 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 15:41:43 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 24 Aug 2022 15:41:43 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 24 Aug 2022 15:41:43 GMT
...
-	Layers:
	...
	-	`sha256:02aa0e8f6de851162a0a133ed30f12b1028fbe1c04d156e94581f1cf923ca4cb`  
		...
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:674cd457d838cb63c7af6e6bc47659958da196351197c264c8829e64854aa538`  
		Last Modified: Wed, 24 Aug 2022 15:45:46 GMT  
		Size: 143.0 MB (142980716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a17e219d22e45d44295f12e344b5213a40c7b986bdba535c5cad40462052dcd3`  
		Last Modified: Wed, 24 Aug 2022 15:45:19 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d252c69a0318ad78df3a1b11cd08f6d38a3d045f9fdd15d0c741eaa05ac2fbf`  
		Last Modified: Wed, 24 Aug 2022 15:45:19 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-fpm` - linux; arm64 variant v8
...
### `nextcloud:22.2.10-fpm` - linux; mips64le

```console
$ docker pull nextcloud@sha256:648dc92cc949de970fec5645c7fbd6a5009c95e42da525aede978bfce3a62d49
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.7 MB (296741833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59121e0f1267ec0e2cbd36d70b2ef277b112ada87d769faed2f151140236a625`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 24 Aug 2022 00:52:55 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Wed, 24 Aug 2022 00:55:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 00:55:45 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 24 Aug 2022 00:55:54 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 24 Aug 2022 00:56:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Aug 2022 00:56:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5f7e4e84f960366f00c8245bdf05b8d1b4c2bf3a382bf398243f68fcc95560b9`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a091f828b50adaa2bdc6ff01db505780b486794661d4917c30a7c4d631c988bd`  
		Last Modified: Wed, 24 Aug 2022 01:14:34 GMT  
		Size: 142.7 MB (142741591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7f2f79dead7bf1b0086c06e86f8104330a8b353f27ab7ce7860616f6afedbb6`  
		Last Modified: Wed, 24 Aug 2022 01:12:57 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d4a969d99a5156738ba39cac2626fce6c18b25e9e0dc9b2d17ca746a7907217`  
		Last Modified: Wed, 24 Aug 2022 01:12:57 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
