...
```console
$ docker pull nextcloud@sha256:162b8b49def7f50d8862bf55677f86cf5649ccf7b7dfad8e244160b65ed6101a
```
...
### `nextcloud:33.0.5-apache` - linux; amd64
...
### `nextcloud:33.0.5-apache` - unknown; unknown
...
### `nextcloud:33.0.5-apache` - linux; arm variant v5
...
### `nextcloud:33.0.5-apache` - linux; arm variant v7
...
### `nextcloud:33.0.5-apache` - linux; arm64 variant v8
...
### `nextcloud:33.0.5-apache` - linux; 386
...
### `nextcloud:33.0.5-apache` - linux; ppc64le
...
### `nextcloud:33.0.5-apache` - linux; s390x
