...
```console
$ docker pull nextcloud@sha256:46dce4bb2e1995ba31f5c2ceb020e929d4cf3a4b82a73bf44eab6ad5f15bb259
```
...
```console
$ docker pull nextcloud@sha256:f8b4e829057cbf285560820400873670edc0ae7bc3cb61f300fd85a2fa868573
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.3 MB (195255302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fa7568c94ef970dade024536413de631a118dd0e1db13f48f8dca10dc7ff6de`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 13:19:15 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 13:20:40 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 13:20:43 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 13:20:45 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 13:20:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 13:20:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c1f635c0b6ffe8f9911c815671b31284d0f6b0d2ea955a6082c3bd8f0209101b`  
		...
		Size: 588.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:629eb49d47c6256b6802427caaa03d08565af50d4d5281250887c89223d6baf0`  
		Last Modified: Sat, 13 Nov 2021 13:26:45 GMT  
		Size: 142.2 MB (142246714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b62e1cff65ea57366d6bb2c3726a7d6d7bf87a652fb7ef56b72239c290e271a`  
		Last Modified: Sat, 13 Nov 2021 13:25:12 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11af026ca0b4fce8806031a3a4923d5188b06cde8b995214c76320fd3116d1b4`  
		Last Modified: Sat, 13 Nov 2021 13:25:12 GMT  
		Size: 2.0 KB (2049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:80e71bce56da42e3012334dd1b05c653713cd3b61a78d5d9d4c4fa1921ea43a0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.6 MB (193610404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:883d211f009b9170ea3947c1477f54f0587a9441ee3a198d6c03e15519bcfc9a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 12:11:29 GMT
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 12:11:30 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 12:12:48 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 12:12:51 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 12:12:53 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 12:12:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 12:12:53 GMT
...
-	Layers:
	...
	-	`sha256:3a364a7e45667523d10c27ae3645ec274e40c9826f3a6185057ad940fa359096`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a8f2db62c067924cda59fee411e5d8dc32edfbf3a4a6c4c00c2a65c346f632f`  
		Last Modified: Sat, 13 Nov 2021 12:32:41 GMT  
		Size: 142.2 MB (142246770 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3a860ad72052b2cd4c46e9e7e47ea0e1fbadcc1421de49da85edd5162f68d9e`  
		Last Modified: Sat, 13 Nov 2021 12:31:05 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6acd877c84c239ebcfab4cd8dec357502f2621184889e9d63234489d80dfc429`  
		Last Modified: Sat, 13 Nov 2021 12:31:05 GMT  
		Size: 2.1 KB (2053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:97d9dd472d33d2de01727048b5696870e7d7c9489031fc145507f88194af0bac
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.9 MB (196879026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89328f24d12824165407e999b0d5b809a32ca4ddd1db501b1df0019dcfa6e2ec`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 12:08:27 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 12:11:04 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 12:11:06 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 12:11:07 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 12:11:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 12:11:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:56a9c331071a3856edfe6b13e3d024e59116c23b7383643ac69cc62bc25b657e`  
		...
		Size: 557.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a5add69e4e1d7e0825c5acf79528211fed63291a3650f2a5cedf4c029b92711`  
		Last Modified: Sat, 13 Nov 2021 12:18:11 GMT  
		Size: 142.2 MB (142244654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc911e751a90a9d3c76a8251b60b1dfa7ae9bc18361223b630c5f5217fbfa405`  
		Last Modified: Sat, 13 Nov 2021 12:17:51 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4929424360b1d0b9dfd595bb0032238854e9c919162c7e7c151881250e45706`  
		Last Modified: Sat, 13 Nov 2021 12:17:51 GMT  
		Size: 2.1 KB (2053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:da3c22a39e90680c69a793197ee785ba52d06f13969c84cf840b390171517ca0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.0 MB (198981513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b278bbee448bd709d61f83e66385fd07a9cd5c531e315ee33f1357e0f724fa2b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 18:54:35 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 18:55:50 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 18:55:57 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 18:56:00 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 18:56:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 18:56:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9e3a2f5662a4dabcbd8e8bc574b24ce511766b2cccf5e20f44a4b3f671cc7722`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f718837b59040e1f84e6d49292f4a93094d0e7dd840acf29b34cb81f040152e4`  
		Last Modified: Sat, 13 Nov 2021 19:01:03 GMT  
		Size: 142.2 MB (142246654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e99187c3b9a913df713ffa7ce85e58b258838290b3b965a703fe8a1edeceb277`  
		Last Modified: Sat, 13 Nov 2021 19:00:16 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73f03892250a71ca1abd8ad8e6306b07142d5afec553129bded698cdbe9d9da2`  
		Last Modified: Sat, 13 Nov 2021 19:00:16 GMT  
		Size: 2.1 KB (2051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
