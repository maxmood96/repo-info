...
```console
$ docker pull nextcloud@sha256:f9343b0d6c3d7e21a2a77baec99ddb32ba80c09748e7e53e13a61aaff81b2292
```
...
```console
$ docker pull nextcloud@sha256:83f4a0637957fa5830c095dcc3a7160eff45b88b138e2bb78527889e9bb45258
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.8 MB (317757713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc45052d6b456fed23e93a35024b2585e8c893859a187acd973fb82c3d54c745`
...
# Tue, 19 Jul 2022 03:20:04 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 19 Jul 2022 03:20:53 GMT
...
-	Layers:
	...
	-	`sha256:ed0e17b65f65b298a5f3ac918e95470d25c40a58d81a084ef88b4ca2d53a1a58`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fcab34fc18f487899416e4c603406e9106bd3f35cdc714afffb7eb4590ff32a`  
		Last Modified: Tue, 19 Jul 2022 03:25:58 GMT  
		Size: 134.4 MB (134437843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c88a94b0c7e75f0bab7aee103464b1ce753e1ff81974a12e5a9b919a19b938d`  
		Last Modified: Tue, 19 Jul 2022 03:25:41 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90cd38ecea374deddc3ca4b338ffd05d384215b97b3ef00dc05a3ef734e1eccb`  
		Last Modified: Tue, 19 Jul 2022 03:25:40 GMT  
...
```console
$ docker pull nextcloud@sha256:477861120e488c5db5ea0c91113c14b05f0e51ddb50c0b6d6d3ee56854746d6d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.4 MB (293356416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:458b0e9a7f15d15c616e610755c911abd3f24b088591b91f4b450663a0afe0d8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 18 Jul 2022 21:57:23 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Mon, 18 Jul 2022 21:58:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 18 Jul 2022 21:58:57 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Mon, 18 Jul 2022 21:59:00 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Mon, 18 Jul 2022 21:59:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 18 Jul 2022 21:59:00 GMT
...
-	Layers:
	...
	-	`sha256:28b76f90025bca673840c0d175369291d413309e3bfc51730114484bcc38b6de`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b34e74cec47941fca1243d1ea56f957f0cc9940a53d4636aea11c0e714138393`  
		Last Modified: Mon, 18 Jul 2022 22:15:14 GMT  
		Size: 134.4 MB (134436737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d179013054f4e110977b77737b257f4da4d5de520e13535f27263841aa63c380`  
		Last Modified: Mon, 18 Jul 2022 22:13:47 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73fe6e41993352471299b26620b9a5e656b9cdb45b184269486413c6a1d37a03`  
		Last Modified: Mon, 18 Jul 2022 22:13:47 GMT  
...
```console
$ docker pull nextcloud@sha256:0044ba9fda7538f13f64a041f31ce9f89fd2732205d2003480c0c45829162a37
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.0 MB (318996053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4de65f87c5f27af23eca6f39e34308408b9ad94c7d872b8b939e84bbe445118`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 01:47:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 01:47:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:59836d76907551968d52ffb24cf8a9c5b75ce30b640735265bd2ae610e026883`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c02cac239f2ad09344c9391b606d6c5b07903618de0710533c54e188a1e54d6`  
		Last Modified: Tue, 19 Jul 2022 01:55:56 GMT  
		Size: 134.2 MB (134196406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7521f73c72886b3d0ea28ba9c3f6bde3a7eef3fe4810daf0dc99d31c02bc5840`  
		Last Modified: Tue, 19 Jul 2022 01:55:40 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfa73baaea2bc1ff3db499f9f07d4c6cf71feec9263b2ba618323f75f7733d33`  
		Last Modified: Tue, 19 Jul 2022 01:55:40 GMT  
...
```console
$ docker pull nextcloud@sha256:cc5c26e6b23d9bae879b10a6dbd7a7499d42a98a478ff3944c8b0d499e6dc468
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.0 MB (317958670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93955c8575633d7dce7514e247fd26a040b5bf4ddf4cf91353d73ef7fc803485`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 00:04:01 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 19 Jul 2022 00:05:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 00:05:59 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 00:06:02 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 00:06:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 00:06:07 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3704b05a2baff012b098ef6f69405c233df8a3d9487cbd4b22a027b72ec2144c`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec6dc67827ecfcfc30aa95f30c95e97ee2095f38d08611725bf835a693d07be4`  
		Last Modified: Tue, 19 Jul 2022 00:32:46 GMT  
		Size: 134.4 MB (134440511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0977f1941a16418575a41408ae734b67a42ba8f0c125db6f65ede9c7d422deaa`  
		Last Modified: Tue, 19 Jul 2022 00:31:07 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f14e04d089be874432e6b807d49dcba115b38b5fcd22bfd3f44b8675720f2b58`  
		Last Modified: Tue, 19 Jul 2022 00:31:07 GMT  
		Size: 2.2 KB (2200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:e356bef40be902cdaf13914b4f54ba0caebaf51e1388a7e334fc4db1dca92e88
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.6 MB (292550350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36a337f7ef67d23f1ea4d73ff367a749e6e0b927fcc67d20520f5b38689271b0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 07:01:43 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 19 Jul 2022 07:03:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:6cc0b4adf3da21fe642218c630a820b8c767b4ecd62b77685adfc2aefcdae548`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e2715a76c8dc9ab770ee65bde61b9e305897ccebc202e6c2f40032bc184786c`  
		Last Modified: Tue, 19 Jul 2022 07:14:46 GMT  
		Size: 134.4 MB (134437078 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b444ae6b833df4dfd165923e3d4817a6b44be39a1a59a3b42f7e34d3d45a3b06`  
		Last Modified: Tue, 19 Jul 2022 07:14:30 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a20f0c9a4170961d8ad462c9cf0105c53d11c5bbca54c0fc66060d4f27089c29`  
		Last Modified: Tue, 19 Jul 2022 07:14:30 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
