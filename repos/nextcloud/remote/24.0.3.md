...
```console
$ docker pull nextcloud@sha256:d6ed27525a04a1e13010bdf789aa270fb2325013e0a4890f73105d3525b301ba
```
...
### `nextcloud:24.0.3` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:b74efb9da483984a9b358fb0f1d2d00bb11ea3237578984be5affa26e725cca9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.4 MB (293354202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6262027f9a1e595c7869cfb33c41c35d69a1544434e51337c1af17ac6b7a5564`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 03 Aug 2022 18:12:19 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Wed, 03 Aug 2022 18:13:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 18:13:15 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 03 Aug 2022 18:13:15 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 03 Aug 2022 18:13:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 03 Aug 2022 18:13:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bb566fd69b9cd089429d0055bf5ab30b403de4df56ab59b39fb55562f68e86c1`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b526f6ef1639ec8764ce907d1c3cfb9a803471842c3c4ef72215589c3d65970c`  
		Last Modified: Wed, 03 Aug 2022 18:19:52 GMT  
		Size: 134.4 MB (134436167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b3f144a9b90c6bc47c117a8acf60955a3fcfbb6efdc38531da57f50f0796732`  
		Last Modified: Wed, 03 Aug 2022 18:19:18 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9532cda0319560b0e1c4f59720ffdebae018da9b024348f9b3b611576afc5ce`  
		Last Modified: Wed, 03 Aug 2022 18:19:18 GMT  
		Size: 2.2 KB (2200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.3` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:a903e681a423b09b87f9df8028b204e6a05f53d8b4cb288106757e457e537ba1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.3 MB (284318269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fc0ca07ccecc435e419b7102c6480e39f106be3bd36afb4b9bb8d6a512d85f9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 10:49:56 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 19 Jul 2022 10:51:22 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 10:51:25 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 10:51:27 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 10:51:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 10:51:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7091ac56952fadd51ba2bb30ba5f045d2e4bf033f463c3beeec08f838231ff01`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b606d3e0068d94e12fb0fc900beb77eeaac34f307ec39f9421fc18db14245c0`  
		Last Modified: Tue, 19 Jul 2022 11:14:24 GMT  
		Size: 134.4 MB (134436582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2940b2536af16e57f713c4565f2b80e6aa1e326de87cb1380dfe524c7777121e`  
		Last Modified: Tue, 19 Jul 2022 11:12:58 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:830a6a5c619a70377194d0cc4866af15aef81a610eb8e3d1575e6dd20abfd985`  
		Last Modified: Tue, 19 Jul 2022 11:12:57 GMT  
		Size: 2.2 KB (2203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.3` - linux; arm64 variant v8
...
### `nextcloud:24.0.3` - linux; 386

```console
$ docker pull nextcloud@sha256:e089fe2482b9695a9cb21cad0cb0dffdcb773921d02f154a2b32b91e768cbf97
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.0 MB (318996851 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c098ca5b1954dbc1afcc571dac61045f980ca6aa89fe22b9bfa012a0d8c51483`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 02 Aug 2022 19:21:14 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 02 Aug 2022 19:21:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Aug 2022 19:22:00 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 02 Aug 2022 19:22:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 02 Aug 2022 19:22:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Aug 2022 19:22:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6cdf4453104e3ab93e5723d1efc63544dffcf12adbcf3c6cdc8fc0950cef1c8b`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c78b2947daea7244d9a0b9b53aa0b65623cc4efa25ec86b5699dc89b8d466e0`  
		Last Modified: Tue, 02 Aug 2022 19:28:09 GMT  
		Size: 134.2 MB (134196327 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97b6adfc23d691cfe435ad9fcb34ac1642b9565b60cfdf3130ed621b7e7a4db5`  
		Last Modified: Tue, 02 Aug 2022 19:27:50 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28401d1534e514fcbcdca3078987c60a20b8c41e4a07b7d8c5da0cc3f605874b`  
		Last Modified: Tue, 02 Aug 2022 19:27:50 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.3` - linux; mips64le

```console
$ docker pull nextcloud@sha256:b9f3bf3c786e5d87241bbf2d4cca33d57037067ae9431f76f9406bfe1475d2b1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.2 MB (292203250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:426e581b084a8c6a6136e7d60c558fe8cb2c1006041a593241080078ca9f6ae8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 16:16:34 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 19 Jul 2022 16:18:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 16:19:09 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 16:19:18 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 16:19:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 16:19:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:14bba06da0fa9b0f661b88852215534f472a44153f5809c3d5aa17c513b5de55`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b858b8ee12c4a79c7173b8802373a22d91f7faeed74661c888745ffaec1dd40`  
		Last Modified: Tue, 19 Jul 2022 16:32:19 GMT  
		Size: 134.2 MB (134197620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e699394674ec143f44f7291363dd53f587ba6f83175504d111931be2a6b1068`  
		Last Modified: Tue, 19 Jul 2022 16:31:03 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b24b073de9ef5ac0d6b04a4ff4e7cc8215ae36152bfb8e6a998e9e065c1c6bc8`  
		Last Modified: Tue, 19 Jul 2022 16:31:03 GMT  
		Size: 2.2 KB (2204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.3` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:63fc10117995950640e4fe2d7a1fa97a56e02dbb962b5f9b829b56c9cb8f3b72
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.0 MB (317958764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab3a3e92af106ddfb4c41211dda96e7abcf58295a2b0bf7ba30e786c23a515e4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 03 Aug 2022 16:11:29 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Wed, 03 Aug 2022 16:12:30 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 16:12:37 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 03 Aug 2022 16:12:39 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 03 Aug 2022 16:12:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 03 Aug 2022 16:12:39 GMT
...
-	Layers:
	...
	-	`sha256:3ba0c3684f4795343f088990276503c710f01ba1e8318f958c931c47ed708f91`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:140f6ea779e22d93a90d00018b99cb86702b236e78c4acdea76b7684922da7c8`  
		Last Modified: Wed, 03 Aug 2022 16:22:12 GMT  
		Size: 134.4 MB (134438465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2bcd2db3fd5db8ef0a5a0ff924ed93f19e4a68af1f5320327807d817ddd0a6d`  
		Last Modified: Wed, 03 Aug 2022 16:21:44 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7344bf98a9134e0e5d41cd89d60ababc0841e905867d2305f31ca5bef08c7a1`  
		Last Modified: Wed, 03 Aug 2022 16:21:44 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.3` - linux; s390x

```console
$ docker pull nextcloud@sha256:505c2dcfa386010222a717848a2707dfbc946e8e272f6da102ef40c75e9de615
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.5 MB (292547738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c57a73b333abb9d54edcf71054fb0d7e9ac3979d3f51509fcd2d4cc3ba04e0a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 02 Aug 2022 19:59:23 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Tue, 02 Aug 2022 20:00:16 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Aug 2022 20:00:24 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 02 Aug 2022 20:00:25 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 02 Aug 2022 20:00:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Aug 2022 20:00:25 GMT
...
-	Layers:
	...
	-	`sha256:8fa57d59b85f5e387a192318f0eefbb5edcec1dd1f6704512aca1f7458ed2de6`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad3ae6026909ce7087911e76a19f97ccae85bdd71caff5d43a438dd7b5f13885`  
		Last Modified: Tue, 02 Aug 2022 20:08:24 GMT  
		Size: 134.4 MB (134436543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:304ef0361c2fc3b9bfe6570e1cc9772edb9d752d61d670e9f6023c71b782f530`  
		Last Modified: Tue, 02 Aug 2022 20:08:10 GMT  
		Size: 3.1 KB (3060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a308bba6c0fbe04f36cdbee91fb8b1294bfc1c3fd8c8ac5ebad01f7dbaa0b210`  
		Last Modified: Tue, 02 Aug 2022 20:08:10 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
