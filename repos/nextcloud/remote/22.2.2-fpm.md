...
```console
$ docker pull nextcloud@sha256:d72b66f3d9417f98397bc94df2febaf4c7346dac29256643d4c1d6bb023070c2
```
...
### `nextcloud:22.2.2-fpm` - linux; amd64
...
### `nextcloud:22.2.2-fpm` - linux; arm variant v5
...
### `nextcloud:22.2.2-fpm` - linux; arm variant v7
...
### `nextcloud:22.2.2-fpm` - linux; arm64 variant v8
...
### `nextcloud:22.2.2-fpm` - linux; 386
...
### `nextcloud:22.2.2-fpm` - linux; mips64le
