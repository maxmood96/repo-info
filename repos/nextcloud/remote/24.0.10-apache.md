...
```console
$ docker pull nextcloud@sha256:f96a81a24c80eb7bd4a60992ec1630fab8ac92d0fc3b562a5181274a269ea389
```
...
```console
$ docker pull nextcloud@sha256:a89e8792736f5897acdd18abdcd46b7c4f6b94a833adc573da47af5853ec2438
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.0 MB (322969229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa7d811f6822803c5fc38f625569d21d714e4d56a3dd8b8e27964dbcbdc0d536`
...
# Thu, 02 Mar 2023 01:21:20 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Thu, 02 Mar 2023 01:22:03 GMT
...
-	Layers:
	...
	-	`sha256:f66bd4950aa319b76a09bd71a6b32e1ea8e2cfd2535628ce6436c7635c3af043`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1f821f623a0ee62fe88025dc8fd3514c07bc5e70890e77f1354a72e7beb50e5`  
		Last Modified: Thu, 02 Mar 2023 01:33:02 GMT  
		Size: 135.2 MB (135199435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72261e13e876ee83cebed3f0f86a68e4c7a8f5881b836273af5c71031f10bd69`  
		Last Modified: Thu, 02 Mar 2023 01:32:46 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90164b865ae7d41daa57536237a80aa618cb13891c0c23901bd6fc36ea6a7cc6`  
		Last Modified: Thu, 02 Mar 2023 01:32:46 GMT  
...
```console
$ docker pull nextcloud@sha256:fef713ccce44d3d452f980ec1181c272e08886ff71f6ff12daffe026f3d4f86e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **288.9 MB (288851634 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:def1ad268d29d8eeb62903d25f6278ceecd5105dbe54eeea1569027ee3acdfec`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:8fc8d7f9da01562a1d23971ab1073b82b2e523a52ee2ee7991c7afdd39aeb362`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e845124b59f95ccd6e9ae24b84e56da374e7c30f03e36d45ca68921986787521`  
		Last Modified: Thu, 02 Mar 2023 09:31:41 GMT  
		Size: 135.2 MB (135196828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3581153f608704e7d1f42c31a0566f8b29b9516b21a0713855074f5691c8987f`  
		Last Modified: Thu, 02 Mar 2023 09:31:21 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7beb4eb0385e404b924f5b9da82f74eb9f38c495b6d4d2b2fee7eb26f3bf84ac`  
		Last Modified: Thu, 02 Mar 2023 09:31:22 GMT  
...
```console
$ docker pull nextcloud@sha256:5b41daf50c2e149fd9951dcaf79c07800c3f619222366fe209ece8c5a1fd9e20
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.3 MB (325282846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04d300fa8a36966a8a635fff76eef383eb6fe5d251d0e6b769fee593a5efb099`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 02 Mar 2023 09:24:37 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Thu, 02 Mar 2023 09:25:26 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 02 Mar 2023 09:25:29 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Thu, 02 Mar 2023 09:25:29 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 02 Mar 2023 09:25:29 GMT
...
-	Layers:
	...
	-	`sha256:0363dd2fab5c9a2817c62d3050cb3b51eaa52067bb8d6513ddc289fc3c2c762d`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3a21bf10ea45d6b4e48341d0a876a9fb16e9e4f07b598e26911c9c251b8bccd`  
		Last Modified: Thu, 02 Mar 2023 09:45:00 GMT  
		Size: 135.2 MB (135198601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cc1834442efbf01b744fa383b022707f0d5a2cc677f51671e5bf60760e44757`  
		Last Modified: Thu, 02 Mar 2023 09:44:37 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4082d2c2ac2dd41e4ce23be137ca2441f32e081bf8911f8a9ca3c39ccbcded6d`  
		Last Modified: Thu, 02 Mar 2023 09:44:37 GMT  
