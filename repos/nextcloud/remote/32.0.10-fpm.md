...
### `nextcloud:32.0.10-fpm` - linux; amd64
...
### `nextcloud:32.0.10-fpm` - unknown; unknown
...
### `nextcloud:32.0.10-fpm` - linux; arm variant v5
...
### `nextcloud:32.0.10-fpm` - linux; arm variant v7
...
### `nextcloud:32.0.10-fpm` - linux; arm64 variant v8
...
### `nextcloud:32.0.10-fpm` - linux; 386
...
### `nextcloud:32.0.10-fpm` - linux; ppc64le
...
### `nextcloud:32.0.10-fpm` - linux; riscv64
...
### `nextcloud:32.0.10-fpm` - linux; s390x
