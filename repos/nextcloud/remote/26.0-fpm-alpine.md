...
```console
$ docker pull nextcloud@sha256:888d0a0ef8ef23898074e0d053a36c9514d4d1b019c672ecc8ded018972d9cc8
```
...
```console
$ docker pull nextcloud@sha256:57d4740677e4257f63b4d1b44613aac2d9dfed3533a24d4b0c91d87432a239b2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.5 MB (261468165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:067aea6f252a27030f4007e592a3612de4ef8c6ca2de2d07ac33b6d33f2cb2ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 20 Jan 2024 01:53:54 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 20 Jan 2024 01:54:43 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 20 Jan 2024 01:54:49 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 20 Jan 2024 01:54:49 GMT
COPY multi:4ab4c3c752902e8e8635c15205bbb9fd1f91fe979fefe0b866b45989933f974c in /usr/src/nextcloud/config/ 
# Sat, 20 Jan 2024 01:54:49 GMT
...
-	Layers:
	...
	-	`sha256:8f87fba5562f25970e078b48470adf9ea514492e3cfdf500d9ff808af272b250`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e3e3055c9f913f14af5e9c234cdba10e2e14e453efdc269925f7aec76dbd401`  
		Last Modified: Sat, 20 Jan 2024 02:04:02 GMT  
		Size: 176.6 MB (176591428 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b869f51ef4901cf29066d69c5fd41446010f4ce711f7146d5c67804268d7e30`  
		Last Modified: Sat, 20 Jan 2024 02:03:45 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f748f55bf2a8dca5ff922b01ee94d258b0ed3f63d7a0ac3a2c7273c3c0bf0d40`  
		Last Modified: Sat, 20 Jan 2024 02:03:45 GMT  
		Size: 2.3 KB (2281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:0acc668927fb5129f074bc4dd4a0e2a5bfb5cdb4de4a8052d6d63483defad9db
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.8 MB (258833930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8708305c7042fe5f8670fe50d59f83e391068acd076a4c7a3eec6cd2c48ae512`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 20 Jan 2024 03:31:56 GMT
VOLUME [/var/www/html]
# Sat, 20 Jan 2024 03:31:57 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 20 Jan 2024 03:33:01 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 20 Jan 2024 03:33:05 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 20 Jan 2024 03:33:06 GMT
COPY multi:4ab4c3c752902e8e8635c15205bbb9fd1f91fe979fefe0b866b45989933f974c in /usr/src/nextcloud/config/ 
# Sat, 20 Jan 2024 03:33:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 03:33:06 GMT
...
-	Layers:
	...
	-	`sha256:ce4f11576ba76fd65742a876f15cbc70f5af16db492e2ad36785daa602dc5429`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b4961718d767e98c5f82d443fd23c63f8570bea072c079d2f0ad07c05228727`  
		Last Modified: Sat, 20 Jan 2024 03:45:09 GMT  
		Size: 176.6 MB (176591555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34904915534ec8a8137aae80941a6865369ac6ac16b742ec65b48b53ec0217f7`  
		Last Modified: Sat, 20 Jan 2024 03:44:34 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:701c5bc356a2fafa804cd9b7220e9991a5c99586d2c36d1fcecdbb1068727920`  
		Last Modified: Sat, 20 Jan 2024 03:44:33 GMT  
