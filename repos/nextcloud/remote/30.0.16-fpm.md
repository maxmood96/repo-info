...
```console
$ docker pull nextcloud@sha256:3e792ab8868fb065a34d6b6076efa2109ab8b359f6a011e5e193a0b630fc5e4d
```
...
### `nextcloud:30.0.16-fpm` - linux; amd64
...
### `nextcloud:30.0.16-fpm` - unknown; unknown
...
### `nextcloud:30.0.16-fpm` - linux; arm variant v5
...
### `nextcloud:30.0.16-fpm` - linux; arm variant v7
...
### `nextcloud:30.0.16-fpm` - linux; arm64 variant v8
...
### `nextcloud:30.0.16-fpm` - linux; 386
...
### `nextcloud:30.0.16-fpm` - linux; ppc64le
...
### `nextcloud:30.0.16-fpm` - linux; s390x
