...
```console
$ docker pull nextcloud@sha256:836f350f13faf02cb82ffc273392db6de5b2576642ef535f268d24347d3e9fba
```
...
### `nextcloud:17.0.8-fpm` - linux; amd64
...
### `nextcloud:17.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:17.0.8-fpm` - linux; arm variant v7
...
### `nextcloud:17.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.8-fpm` - linux; 386
...
### `nextcloud:17.0.8-fpm` - linux; mips64le
...
### `nextcloud:17.0.8-fpm` - linux; ppc64le
...
### `nextcloud:17.0.8-fpm` - linux; s390x
