...
### `nextcloud:15-rc-apache` - linux; arm variant v5
...
### `nextcloud:15-rc-apache` - linux; arm variant v7
...
### `nextcloud:15-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:15-rc-apache` - linux; 386
...
### `nextcloud:15-rc-apache` - linux; ppc64le
