...
### `nextcloud:33.0.2-apache` - linux; amd64
...
### `nextcloud:33.0.2-apache` - unknown; unknown
...
### `nextcloud:33.0.2-apache` - linux; arm variant v5
...
### `nextcloud:33.0.2-apache` - linux; arm variant v7
...
### `nextcloud:33.0.2-apache` - linux; arm64 variant v8
...
### `nextcloud:33.0.2-apache` - linux; 386
...
### `nextcloud:33.0.2-apache` - linux; ppc64le
...
### `nextcloud:33.0.2-apache` - linux; riscv64
...
### `nextcloud:33.0.2-apache` - linux; s390x
