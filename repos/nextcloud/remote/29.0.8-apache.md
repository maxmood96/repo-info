...
```console
$ docker pull nextcloud@sha256:eba830182bf96e1704678ddcef93cc82b6cbbcadc9adf606dbfbda247214d186
```
...
### `nextcloud:29.0.8-apache` - linux; amd64
...
### `nextcloud:29.0.8-apache` - linux; arm variant v5
...
### `nextcloud:29.0.8-apache` - linux; arm variant v7
...
### `nextcloud:29.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:29.0.8-apache` - linux; mips64le
...
### `nextcloud:29.0.8-apache` - linux; ppc64le
...
### `nextcloud:29.0.8-apache` - linux; s390x
