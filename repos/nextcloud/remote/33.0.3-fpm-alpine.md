...
```console
$ docker pull nextcloud@sha256:7fb51cd37393702c6b5152c35f82207b14d72b1eb42df6a374561253df5369ab
```
...
### `nextcloud:33.0.3-fpm-alpine` - linux; amd64
...
### `nextcloud:33.0.3-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:33.0.3-fpm-alpine` - linux; 386
...
### `nextcloud:33.0.3-fpm-alpine` - linux; s390x
