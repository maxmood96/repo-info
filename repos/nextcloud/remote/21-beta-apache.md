...
```console
$ docker pull nextcloud@sha256:bf050fb7df8fdbf97f62266504a01cec4670b9ffadc90ec9e035b08934eb6f3c
```
...
```console
$ docker pull nextcloud@sha256:4eeb208ef4324444af0b89057a7a7c618db7370ab479474996266e9520a9afbf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.0 MB (284040118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55d27d4200208aa68965f5953945bdedd6952de36360a41c29db6d3c56b598b8`
...
# Tue, 26 Jan 2021 00:31:56 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Tue, 26 Jan 2021 00:32:34 GMT
...
-	Layers:
	...
	-	`sha256:4a826539f3e25208bb1a3d24f15cb1500821ab5b2163081c0c9063e800b18e61`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a5d8c360ffd5c3e35b93f5bcbb2abde36f89070fbd9e3ac9226a97ba76c120f`  
		Last Modified: Tue, 26 Jan 2021 00:40:52 GMT  
		Size: 119.1 MB (119051971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2460ff4670046209f9fcffe2b93794b683ea827398b8e4237e470bfd8cffc8d3`  
		Last Modified: Tue, 26 Jan 2021 00:40:23 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:637466ea0d355237ddd7ad109916a76e6aa4e72aeac4652d2efe8abd67c6a417`  
		Last Modified: Tue, 26 Jan 2021 00:40:23 GMT  
...
```console
$ docker pull nextcloud@sha256:5a4acfe83a7a29989812f7b0faf813804b7a97dfca6b2b1863a574ec99ae694a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.5 MB (274482593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67ccf97b530bdbdf980c4799b04cb6ca025b6d050d680aa83f61b88f55c925d9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 01:57:05 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Tue, 26 Jan 2021 01:57:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 01:58:00 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 01:58:03 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 01:58:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 01:58:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:10137165d72c7f94d7c7ad534ec4ee1ec8c05d189924a0cb0185189522e74deb`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0fd6cc52acb693ceed9896aa38d479d535e26bf9c09a386a74ddb76c924447a`  
		Last Modified: Tue, 26 Jan 2021 02:08:05 GMT  
		Size: 119.1 MB (119051425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cdbba37f3f5fc570f45a48196004041f677aa946e5802fc42d5b75e69334023`  
		Last Modified: Tue, 26 Jan 2021 02:07:35 GMT  
		Size: 2.5 KB (2533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b95ced8560a17997d93279176934038b3a9653bbd1316d52d080f30df8c28987`  
		Last Modified: Tue, 26 Jan 2021 02:07:35 GMT  
...
```console
$ docker pull nextcloud@sha256:833f280492680bba908462166a1b122529522fb7b36478f80196282a6ead47c8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.4 MB (289374538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44361792f4679f9e9a59b555669d12bd2315eccf1b1f52d3cf43026c3f0317b5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 00:55:40 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Tue, 26 Jan 2021 00:56:22 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 00:56:23 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 00:56:24 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 00:56:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 00:56:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:14311a865152935423405d6c183b74fb3257003ea09f8bd45db257c9237f1e64`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e0dccf09a9e5f8c14d698d206a9910ecdb081bcc133289a9b31b5417698c1cf`  
		Last Modified: Tue, 26 Jan 2021 01:05:25 GMT  
		Size: 119.1 MB (119051331 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d24553f8bb7639b4aa6af7c8b76bba873790139edaa3f59f31d2d45fa4485474`  
		Last Modified: Tue, 26 Jan 2021 01:04:51 GMT  
		Size: 2.5 KB (2533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05b6c13d682a058fd93ab9ef30c8a8978cf445307aae3a68c8da353b0dc85458`  
		Last Modified: Tue, 26 Jan 2021 01:04:51 GMT  
		Size: 2.0 KB (1958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
