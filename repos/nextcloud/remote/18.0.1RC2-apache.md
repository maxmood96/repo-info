...
```console
$ docker pull nextcloud@sha256:45f632c5e88843d594e5b3dcba94d905f957320e0e1a70d41cf86138eea702b8
```
...
### `nextcloud:18.0.1RC2-apache` - linux; amd64

```console
$ docker pull nextcloud@sha256:8f0993f556475d6544e3d03f240592ad87f8376e99f2851b23d744300b5809b1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.7 MB (260687779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3773c578cb2c9679ef9a0c59bf23c96c38bfe14cfb5cac265f88123d43040752`
...
# Sat, 08 Feb 2020 00:20:18 GMT
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Sat, 08 Feb 2020 00:20:46 GMT
...
-	Layers:
	...
	-	`sha256:07158f924c2abcb43dafd3c2b46bf9179b4c65433fc5e7f59c18f60fa9281380`  
		...
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3cba4b9e7689540ed128dced824368e2f0ecdb84f3c308d2dc997121681bc98`  
		Last Modified: Sat, 08 Feb 2020 00:23:44 GMT  
		Size: 93.9 MB (93870579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2834ef3d89fd1ae6df1f7c2a168e56fdd35251188692832d16a9a8e83e4956d`  
		Last Modified: Sat, 08 Feb 2020 00:22:33 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93f910ac090d8de70aa489f8f03587d190f071f2e11500423d7b213955cedcd9`  
		Last Modified: Sat, 08 Feb 2020 00:22:33 GMT  
		Size: 1.2 KB (1180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:18.0.1RC2-apache` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:534cf55afab812f45668f10e44a642b329452c16ee4f6639262873f6e3aa4768
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.4 MB (237437464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4caa9d5d592d8d13a8e04c11f8a65d7008349de53edcd274a71d88c63c8bf961`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 08 Feb 2020 00:48:59 GMT
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Sat, 08 Feb 2020 00:50:03 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 08 Feb 2020 00:50:11 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 08 Feb 2020 00:50:13 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Sat, 08 Feb 2020 00:50:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 08 Feb 2020 00:50:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cdc193e71ca1b663e3da40a9f388299905dce0fb6796ae7d990d55b3b77f2ff1`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac905944bfc0c9764343f661432e653a5925632db7c68acf7c3e58954d9e8f24`  
		Last Modified: Sat, 08 Feb 2020 00:53:25 GMT  
		Size: 93.9 MB (93867979 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20189ada41f78ab134f0d8c1fe45ea213827c3292f7b76533d292feeacd6ca91`  
		Last Modified: Sat, 08 Feb 2020 00:52:31 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0802e0013625d5541d6795b9bb5dc1201352641a6990a99b2107920b2f9462a`  
		Last Modified: Sat, 08 Feb 2020 00:52:31 GMT  
		Size: 1.2 KB (1179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:18.0.1RC2-apache` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:a5526761d3c21f8f2e4ffebfdd6116f289c21dd0c72e0bdc3e76799d310b5d81
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **233.6 MB (233587307 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b136018ef7f69f765e276e19316f76f762287219119d6097e05f8cd8f674cf3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 07 Feb 2020 23:58:13 GMT
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Fri, 07 Feb 2020 23:59:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 07 Feb 2020 23:59:12 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Fri, 07 Feb 2020 23:59:14 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Fri, 07 Feb 2020 23:59:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Feb 2020 23:59:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3f0df4187e3c622dc2afe2b643c4f662efd3551592dd3554badb2605e67b43d1`  
		...
		Size: 556.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f339c63f0b32323188f09bb3e57ce8e5825f28777f426bd1a9df1fe9c5429340`  
		Last Modified: Sat, 08 Feb 2020 00:03:57 GMT  
		Size: 93.9 MB (93867914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64a0d42e26ced0691d57e079adc4ff3e3c2c23c395c55e530c558737f83ef57c`  
		Last Modified: Sat, 08 Feb 2020 00:02:39 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12c59a4049dadebcd7d8a356c0f8aa12d283e567e143a586debd2eb843862c42`  
		Last Modified: Sat, 08 Feb 2020 00:02:39 GMT  
		Size: 1.2 KB (1180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:18.0.1RC2-apache` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:45869375be045f3e8b58d9077c224be6ca9cfc38ea06be48db957a0a71b867a5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.0 MB (251011254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8de99a306dec38a31dc66b8c37b981ec770320f7a102fe71908a57f74e638adf`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Sat, 08 Feb 2020 00:41:24 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 08 Feb 2020 00:41:27 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 08 Feb 2020 00:41:28 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Sat, 08 Feb 2020 00:41:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 08 Feb 2020 00:41:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ec3c9c81b56f4a247d9c14e9c33612d9ef813a5a63d4af56cdd37263448bc37a`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4396b88565ebfdb1d39976d6a960289466b396b324a5d76b9033eaa304dcbfbb`  
		Last Modified: Sat, 08 Feb 2020 00:45:33 GMT  
		Size: 93.9 MB (93869621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:613260a2eb6bb94826dc4aa639539db51ed91859e9b451ca47ae7290a9df7c59`  
		Last Modified: Sat, 08 Feb 2020 00:44:14 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d22ae8701592038b83243f802a3453ee6028514f83c21b9ff87fc8de1a9e624`  
		Last Modified: Sat, 08 Feb 2020 00:44:13 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:18.0.1RC2-apache` - linux; 386

```console
$ docker pull nextcloud@sha256:3ab39f272b600083822167322214fbb168e04d4132ad1d71e89f59221c2e0ead
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.0 MB (266008363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c94004f1af95c11478a99ef33b287be73a0c5247ce48cb0c698b574fc8ba8553`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 08 Feb 2020 00:38:56 GMT
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Sat, 08 Feb 2020 00:39:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 08 Feb 2020 00:39:33 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 08 Feb 2020 00:39:34 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Sat, 08 Feb 2020 00:39:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 08 Feb 2020 00:39:34 GMT
...
-	Layers:
	...
	-	`sha256:e2b3bd2bc904542c6a01a02cec666113316374b2d02e93ec27942f8cb93b5acb`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d0ad13f9109b3633e246b81842c66e139722b65e1b755298aa499a4a977185f`  
		Last Modified: Sat, 08 Feb 2020 00:41:58 GMT  
		Size: 93.9 MB (93869918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c231dadf339d0e6a9147bd9dcd08ddacc92718395d9264281260670b041d2a4d`  
		Last Modified: Sat, 08 Feb 2020 00:41:22 GMT  
		Size: 2.2 KB (2160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08fad321debe55594f4f2cb984b9c5bceebf56115ec3f6377fdfa4c32ddb63d7`  
		Last Modified: Sat, 08 Feb 2020 00:41:21 GMT  
		Size: 1.2 KB (1185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:18.0.1RC2-apache` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:7cfd6169603001c0ea6a3073f0c1a302f87b16f1e6e7eb85834f1638508157d7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.3 MB (272261903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfb7ca3df6eae2d7501ea3e0ec33b96ef7bd12cfc3925f30b88d12f86b81316f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 08 Feb 2020 00:17:02 GMT
ENV NEXTCLOUD_VERSION=18.0.1RC2
# Sat, 08 Feb 2020 00:18:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 08 Feb 2020 00:18:40 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 08 Feb 2020 00:18:41 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Sat, 08 Feb 2020 00:18:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 08 Feb 2020 00:18:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3044aa38e8e8133a2f5dbcd4c9846551038908ed387aaf99534037e8c6885c1b`  
		...
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af353ee1caa6b80b9498673376c60b82bfb50855950efa32a3157164ddaa8f06`  
		Last Modified: Sat, 08 Feb 2020 00:24:30 GMT  
		Size: 93.9 MB (93871574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:596d3c2a8ceb28023cba0a2fc718b6f3b56111c6a5e85f163a6eb9e1d177459f`  
		Last Modified: Sat, 08 Feb 2020 00:23:28 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a60456b60aeb41f41f226f12645b5afeea5b3a9939104b7fd35350a1edc830f6`  
		Last Modified: Sat, 08 Feb 2020 00:23:29 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
