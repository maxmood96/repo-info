...
```console
$ docker pull nextcloud@sha256:29959fb82040d9feefb79487ed68d5961c5d4060b0a69b82720191e138db46e2
```
...
```console
$ docker pull nextcloud@sha256:9d587bc60189e085dd27883ef04e804e482d735d5a6530be01d271786c244606
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.8 MB (367750326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:186252df5f20f16d260bb2ba08b7681c81581e256f31855fcea4b65e1307d45c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Dec 2023 14:34:49 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Tue, 19 Dec 2023 14:35:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Dec 2023 14:35:55 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Tue, 19 Dec 2023 14:35:56 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Tue, 19 Dec 2023 14:35:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Dec 2023 14:35:56 GMT
...
-	Layers:
	...
	-	`sha256:3afd27b71ce1a70b609179d958e88b71065eea0a75013ea30244fe0ce834c65b`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55d2a3670ae331effe02f91ab014c6dc9d4abb37560a7eaf65b29d56aff5ac33`  
		Last Modified: Tue, 19 Dec 2023 14:46:21 GMT  
		Size: 176.9 MB (176941322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9867af4db9ba5754db96ee62a462bc40d9d73af412e8c6618a78882c875821c`  
		Last Modified: Tue, 19 Dec 2023 14:45:45 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42522741be4a3ea755bb6fed108928cd3fa363fd0d68db9fab871123938eb32b`  
		Last Modified: Tue, 19 Dec 2023 14:45:45 GMT  
...
```console
$ docker pull nextcloud@sha256:cac298f94d57b4313223848667a5f9bd6001a45ff58e8fdaabd18d43a8ecc142
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **369.4 MB (369377215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:496f98acd24ddb22849e2284bc9ca30381d808fdf084153a692a8e5cb6cb40e2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 17:58:48 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 16 Dec 2023 18:01:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 18:02:04 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 18:02:15 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 18:02:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 16 Dec 2023 18:02:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6d98c313c041d3050071cb4a04dd445a0f5e1b4ed55dfe1cad6ded5b68c0c9f5`  
		...
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58d3275698d187b480ec67dfb39d4ea3b601706ec6809993c9f14491e3b65328`  
		Last Modified: Sat, 16 Dec 2023 18:38:31 GMT  
		Size: 176.7 MB (176720434 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe87931026b1ba068b5bba6ebbef773e04d296d0a29369a95f434ef43862a2cb`  
		Last Modified: Sat, 16 Dec 2023 18:36:24 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1e2ececc6be7244f30585171adfb56b19eb14457a2a7e0b0206fc2124705253`  
		Last Modified: Sat, 16 Dec 2023 18:36:24 GMT  
...
```console
$ docker pull nextcloud@sha256:4ca3667c6a850b6dd39cb29b331876f2a1bab728d14c1b88f22b83ae491b9a1a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.6 MB (367627429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ebef2c2de7746a3789397b2f61279366e1bfe608102c6f4abfb4e4fbded4a71`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Dec 2023 10:53:19 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Tue, 19 Dec 2023 10:53:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Dec 2023 10:54:06 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Tue, 19 Dec 2023 10:54:06 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Tue, 19 Dec 2023 10:54:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Dec 2023 10:54:07 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bd2f2839f8ec8859eec32bc7320ab347b00b8d2748e5e32c6136fd4d70a1df6a`  
		...
		Size: 405.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:026cc41c0e59a6eb3259844bdeeae475fff1ab260745d1b1609006ecedfcb891`  
		Last Modified: Tue, 19 Dec 2023 11:03:03 GMT  
		Size: 176.9 MB (176941483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f64fe3f1be53001a9c1fb71d6e193ecf8e048902541c43b1d12cfa2fdfc2cf1`  
		Last Modified: Tue, 19 Dec 2023 11:02:43 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae9b761fe552b2292adbe48c8ce688ec0f06e23e47ec5f0265078d059be7f548`  
		Last Modified: Tue, 19 Dec 2023 11:02:43 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
