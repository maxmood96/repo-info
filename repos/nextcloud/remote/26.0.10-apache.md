...
```console
$ docker pull nextcloud@sha256:3e20048fdbd742c7c6d716e8a599c3fa4fa305038b79bf0284950c5b3746ac35
```
...
```console
$ docker pull nextcloud@sha256:cbdff203ec4ac10b17210f8c92619552616133aba5bb0c01fb1c4c0a762849d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.2 MB (356161037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f70d1777dc6e676cbd55b7f3ff865f7a8ef59d642d2873b72582f9df07b0ad8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 20 Jan 2024 02:48:52 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 20 Jan 2024 02:50:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 20 Jan 2024 02:50:16 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 20 Jan 2024 02:50:19 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 20 Jan 2024 02:50:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 02:50:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e1ca8733b9bf38efa548d8011ff832fa8a6481e3843b2e196f8b12feb1fa70d0`  
		...
		Size: 405.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bad3391a1356bb3ecac5d7413c1a9f606f8f497998f5d36c30b768cca2c286e8`  
		Last Modified: Sat, 20 Jan 2024 03:16:13 GMT  
		Size: 176.9 MB (176941508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29b4d1a2d284c8a501b7d9f44b0b4603ea78fa2393bba100063a71f15ad607a7`  
		Last Modified: Sat, 20 Jan 2024 03:15:19 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd0098e7d6e457d1742d676857fdfc4795dd5335e8213b38fc04a066839071c4`  
		Last Modified: Sat, 20 Jan 2024 03:15:20 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:05724a857c4a5a21a0e6e94a3d38dfbe4c125f0ea4d8cc9cfd1c73a0bd72c8da
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **396.9 MB (396866046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7254d92c8113e2760ad712ca79550b73d41236b48dc6fc79566fe9e712906f0c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 20 Jan 2024 03:21:40 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 20 Jan 2024 03:22:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 20 Jan 2024 03:22:52 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 20 Jan 2024 03:22:52 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 20 Jan 2024 03:22:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 03:22:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:15d2e118db1272300937597b0f1a31c2479c36d2581b717809b4966bb246364f`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e6527edbede8c4fe74787f984465717d27fb63eb3b71bdbc965df4cb02e18e7`  
		Last Modified: Sat, 20 Jan 2024 03:43:25 GMT  
		Size: 176.9 MB (176943012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65fd1741040ab6f81ccba561113e5157aa954c4223fde90822304cd2d19abe5f`  
		Last Modified: Sat, 20 Jan 2024 03:42:45 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c66d335da9839bb69949ffec68c1b7d4e5c81ad54cc1e9dbb6078cf06a4ce3ee`  
		Last Modified: Sat, 20 Jan 2024 03:42:45 GMT  
...
```console
$ docker pull nextcloud@sha256:58ee31f1e7d478b61fd944333959fabbce34e4c6d58e8b1c0641548a6666b0bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **369.5 MB (369518195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e00cda49dfc6eeafc808c9fb5ce8a7723029d0a307c3b7c62298cf485e7d8041`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 20 Jan 2024 04:21:04 GMT
ENV NEXTCLOUD_VERSION=26.0.10
# Sat, 20 Jan 2024 04:24:02 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 20 Jan 2024 04:24:14 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 20 Jan 2024 04:24:25 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 20 Jan 2024 04:24:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 04:24:43 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:51be99c04dd06ef26166449e6c06bd2845f16100830d82a0e91756b826764627`  
		...
		Size: 405.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:048959a6a3d386df3eeae82ce649a3ce06bba45a05bbbbf661b3cbaf03297f92`  
		Last Modified: Sat, 20 Jan 2024 05:01:14 GMT  
		Size: 176.7 MB (176720677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:830a77e6377415f6af7814ea08d07d84baea2d9a76879d2484d26383b9dc1f61`  
		Last Modified: Sat, 20 Jan 2024 04:59:12 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecf6d0a6652cb6dcbfc6f643888ff2e8a6987f5aaa46e2625fb723f13dfefae7`  
		Last Modified: Sat, 20 Jan 2024 04:59:12 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
