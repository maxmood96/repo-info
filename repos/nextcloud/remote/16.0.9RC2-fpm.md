...
```console
$ docker pull nextcloud@sha256:347d79973a157b6a9f10579fab2deff4956526da4b21dd2c1191fd2326bd4241
```
...
### `nextcloud:16.0.9RC2-fpm` - linux; amd64
...
### `nextcloud:16.0.9RC2-fpm` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:35678206c4bf92334255b195b1a70f71bcfcbf06fb05edab3b3c858217b128e0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.8 MB (208847731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:705f049f050ff8ffdd50ea2d0576c234fecbb49de2be49c10c3e47f8a0076b61`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 26 Feb 2020 15:15:09 GMT
VOLUME [/var/www/html]
# Mon, 09 Mar 2020 23:50:59 GMT
ENV NEXTCLOUD_VERSION=16.0.9RC2
# Mon, 09 Mar 2020 23:51:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 09 Mar 2020 23:51:50 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
...
-	Layers:
	...
	-	`sha256:aff4cee4e36b360c6f912b6ab55f9b095d945a85ec3281ff56abefa72254e2c1`  
		...
		Size: 533.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f6fe6fb01ab65b5276be7a03652cacec53462a9f80266800232c7da759f71e3`  
		Last Modified: Tue, 10 Mar 2020 00:00:51 GMT  
		Size: 69.0 MB (68952068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8edac04d69b6ff0edda8fd28c9ea7f0c0868ec505e09bb4f0d5e6227a3886748`  
		Last Modified: Tue, 10 Mar 2020 00:00:00 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5215c5996be06306e9f28cf77ae56fa2b516237fc9a3ee32289c946e812bd92e`  
		Last Modified: Tue, 10 Mar 2020 00:00:00 GMT  
		Size: 1.1 KB (1120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:16.0.9RC2-fpm` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:05675ec3c4f1d8a7f9bc71210ef6af4a0b2d428bc9808384d81fd7bf3c08837b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **205.2 MB (205231286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd8bf5acf83f6f6b1bf684d753ee26885cded5f943553b2004c8c6fd4304d8b8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 10 Mar 2020 00:03:36 GMT
ENV NEXTCLOUD_VERSION=16.0.9RC2
# Tue, 10 Mar 2020 00:04:27 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 10 Mar 2020 00:04:30 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Tue, 10 Mar 2020 00:04:32 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Tue, 10 Mar 2020 00:04:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 10 Mar 2020 00:04:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:49aa33ff8a289b1d13f6d6c87030b420afb9d3739e12a84144e8923607258caf`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa57d879cf972c8ea1b4c6e8e70ae86ff1e1d4ed42880ded2b00685ebcd59294`  
		Last Modified: Tue, 10 Mar 2020 00:15:00 GMT  
		Size: 69.0 MB (68952209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b02da44e0f26687b4027e6606803e8c430dda41f8eb3716223796e2639be9e04`  
		Last Modified: Tue, 10 Mar 2020 00:14:35 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7faa93c2a0e8f426ae96ee34945c4621a54e6391b7d8c0478f439273a1aa2f31`  
		Last Modified: Tue, 10 Mar 2020 00:14:34 GMT  
		Size: 1.1 KB (1117 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:16.0.9RC2-fpm` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:b3dd29fb432decb7b4308b308fe1a0b4bd7156c7f8a6e04b111a645d009062ac
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.3 MB (222316125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3d3274368a4e2ab41e042285fd849bfa99ac0c36c4884ae5e52a389309c1a35`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 10 Mar 2020 00:28:24 GMT
ENV NEXTCLOUD_VERSION=16.0.9RC2
# Tue, 10 Mar 2020 00:29:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 10 Mar 2020 00:29:09 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Tue, 10 Mar 2020 00:29:10 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Tue, 10 Mar 2020 00:29:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 10 Mar 2020 00:29:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:244544ec6f0258fa79eb2c89357e2a08a758f4dc00bbe98fb7792e3e0565b530`  
		...
		Size: 533.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec400a3e31a96e55f93fc0725bbc466e59173a512b8eb31763c44fe1788a726b`  
		Last Modified: Tue, 10 Mar 2020 00:38:46 GMT  
		Size: 69.0 MB (68952949 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d67b060f1ced0373dece69b5a53b8ff7b8376cad08ee1d269fafef08af8211ee`  
		Last Modified: Tue, 10 Mar 2020 00:38:25 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:618a4eba02593a8c31a270d68d8d736535b981d3fa695fc42d574e50d54d8c0c`  
		Last Modified: Tue, 10 Mar 2020 00:38:25 GMT  
		Size: 1.1 KB (1116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:16.0.9RC2-fpm` - linux; 386

```console
$ docker pull nextcloud@sha256:1f199ea337dc3dc655ecb34efc5b0094b81be47e6689ad046e8abf8123b3489c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.0 MB (237046583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a46d03cce85c05f619c4c751f393f9dec3af63e37624c27806128a031ea386dd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Mon, 09 Mar 2020 23:47:23 GMT
ENV NEXTCLOUD_VERSION=16.0.9RC2
# Mon, 09 Mar 2020 23:47:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 09 Mar 2020 23:47:52 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Mon, 09 Mar 2020 23:47:52 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Mon, 09 Mar 2020 23:47:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 09 Mar 2020 23:47:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d03378c3a7478b1adfce8faab63dadffcedd6b2f8013d46e4b4f3377cc9a56cf`  
		...
		Size: 503.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58a0fb782e55f6a7e02daba77260b977b9040ae483dd5db4beee2e55fa141d11`  
		Last Modified: Mon, 09 Mar 2020 23:55:35 GMT  
		Size: 69.0 MB (68953052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c20ec2a3d931bc051e89da1574fc3b5f0913d59237a85db322bbda321e59ab57`  
		Last Modified: Mon, 09 Mar 2020 23:55:13 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42797ae835bf39f10a970ceb5162fa49d8ac15cbd857ff50233a06d61479a3b2`  
		Last Modified: Mon, 09 Mar 2020 23:55:13 GMT  
		Size: 1.1 KB (1119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:16.0.9RC2-fpm` - linux; ppc64le
