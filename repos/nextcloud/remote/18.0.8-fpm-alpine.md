...
```console
$ docker pull nextcloud@sha256:66473a27a2209c6cdcda1944826107b85aada794d99eb5d1a0b4cd5be25cb492
```
...
### `nextcloud:18.0.8-fpm-alpine` - linux; amd64
...
### `nextcloud:18.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:18.0.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:18.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:18.0.8-fpm-alpine` - linux; 386
...
### `nextcloud:18.0.8-fpm-alpine` - linux; s390x
