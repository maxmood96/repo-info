...
### `nextcloud:29.0.3-fpm-alpine` - linux; amd64
...
### `nextcloud:29.0.3-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:29.0.3-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:29.0.3-fpm-alpine` - linux; 386
...
### `nextcloud:29.0.3-fpm-alpine` - linux; ppc64le
...
### `nextcloud:29.0.3-fpm-alpine` - linux; s390x
