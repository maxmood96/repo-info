...
```console
$ docker pull nextcloud@sha256:124fe023f26d8aaed05a22e46cfda18424a9ebf2840d96ce67cb476c6aa77a41
```
...
```console
$ docker pull nextcloud@sha256:aeb7050b2b87b8133c6cc5bb3ce37c34c8a819132d2a5907217c3add2c54dbdd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **390.7 MB (390702401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:979fbaf8a03da150621d4aef38b1cfd007363630bd87b2d3cb2375537e52c629`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 06:15:00 GMT
ENV NEXTCLOUD_VERSION=28.0.0
# Sat, 16 Dec 2023 06:16:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:16:14 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 06:16:14 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 06:16:14 GMT
...
-	Layers:
	...
	-	`sha256:353a41511b1da1675d3d912f1d1e001b6d30201c332eff906e64dc37a5a6c62a`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:075b01c73dca4959eaece74e0539726f376d6d60b3d6011f73c85c5b562f35e1`  
		Last Modified: Sat, 16 Dec 2023 06:22:07 GMT  
		Size: 199.8 MB (199796388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bede8fb2981c586ce2d99538cea477fb1d89f803991e704189aa04c55408a74`  
		Last Modified: Sat, 16 Dec 2023 06:21:38 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:441046557bbd344b48a3419534b4ff250294ee3086229a887b30e1cb10445c07`  
		Last Modified: Sat, 16 Dec 2023 06:21:38 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:1a46d69ff4f2e2a7bea0a8206ff1cfeb6de43d65101ff09f029b17ce19509ae6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **379.1 MB (379139025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fd64f947684f1537281017c29a11c78314e11083662577aba228fa643ec52d7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 08:15:16 GMT
ENV NEXTCLOUD_VERSION=28.0.0
# Sat, 16 Dec 2023 08:16:25 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 08:16:29 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 08:16:29 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 08:16:29 GMT
...
-	Layers:
	...
	-	`sha256:bb8b535aeb5d3f4112ac5e22de02059baf4d05eb9fba00f2fe7778582ad0fd33`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84fed728b14d4188d3e7f032c7900185927da1ee2dd85b7e9860e357f25b9b78`  
		Last Modified: Sat, 16 Dec 2023 08:25:13 GMT  
		Size: 199.8 MB (199796297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ef200e5cc15effcbd809e6eee446f72f54e16772bd8b266eea1e83e5928d0a7`  
		Last Modified: Sat, 16 Dec 2023 08:24:44 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a4676f7fc902c2e6f557ca94e9168b90585875c64c721f61d16750768d98562`  
		Last Modified: Sat, 16 Dec 2023 08:24:44 GMT  
...
```console
$ docker pull nextcloud@sha256:ab820aaea7ad4cd7628565a65982914943a052266aec3ad26ba7fb37db85b53b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.6 MB (412557359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcc1b317c8c0911d420cec89717ae620a2ed4e474783a25a178f8e78e02a4c5d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 16 Dec 2023 07:37:24 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 07:49:41 GMT
ENV NEXTCLOUD_VERSION=28.0.0
# Sat, 16 Dec 2023 07:50:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 07:50:41 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 07:50:41 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 07:50:41 GMT
...
-	Layers:
	...
	-	`sha256:93b7add647be7ce41c5fbdedeecdb7a063d48afe0c97d37d263ead71dea45c11`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b71235cca386d6cd8e57ef6b20ded1015cab17151defbb8607c2c0a4effb47cd`  
		Last Modified: Sat, 16 Dec 2023 07:57:27 GMT  
		Size: 199.8 MB (199798134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00c195c2a5b3966d54f2bf5cd00764208b05e79a27a835d5f2a8a5afaa0b1d02`  
		Last Modified: Sat, 16 Dec 2023 07:57:08 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88d1dbf92c0d5b6e7e1f7c0aa97dfde0b0da809e0639d5ab9410e31a8252ab4c`  
		Last Modified: Sat, 16 Dec 2023 07:57:08 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:28.0.0` - linux; 386
...
```console
$ docker pull nextcloud@sha256:567af6d84ae3e269b7c028e89385c67891c2f1443b01d3ccc7b1cfe9ed2d7abf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.5 MB (426470231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5569ae066b1700a2f3823284a25ccb572d47454e12f70df843647db3fa8a8c3c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 09:14:50 GMT
ENV NEXTCLOUD_VERSION=28.0.0
# Sat, 16 Dec 2023 09:16:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 09:16:29 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 09:16:30 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 09:16:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 16 Dec 2023 09:16:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:73806acf0b4b4a9db9ddbaad69514e171a3a0c9d2854dfc3ac98e5ff2105d3b0`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83ed77503bb155f9535e12a4d66928dacc964c36d36e8923a0f9d8a6e3b7eb01`  
		Last Modified: Sat, 16 Dec 2023 09:25:22 GMT  
		Size: 199.8 MB (199799260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4cccf8a04aa47709e6b44592f986e988d00181b7e97081764d889a2f0b027e9`  
		Last Modified: Sat, 16 Dec 2023 09:24:54 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19f60ed25cdb89d44c1f546097566ace93fc674cf98546d92b8cdf3f9e86757a`  
		Last Modified: Sat, 16 Dec 2023 09:24:54 GMT  
...
```console
$ docker pull nextcloud@sha256:01545dd211d2143d18108cfe07673062d0903f70e1573d4210d488224fde8ebd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **390.5 MB (390519080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6581a3931e5f44acfe0324fa897f6453473fe70702b772fc923964f02b02fb0d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 16 Dec 2023 06:28:39 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 16 Dec 2023 06:39:49 GMT
ENV NEXTCLOUD_VERSION=28.0.0
# Sat, 16 Dec 2023 06:40:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 16 Dec 2023 06:40:48 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Sat, 16 Dec 2023 06:40:48 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Sat, 16 Dec 2023 06:40:48 GMT
...
-	Layers:
	...
	-	`sha256:526048b31f51fa09c5987188d968bb64e7619e67c682fb66862e7d768930582d`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ec4c1826e07c087d5242571c982d950ad5d0997679f43516cd1a89f1be04c8c`  
		Last Modified: Sat, 16 Dec 2023 06:47:09 GMT  
		Size: 199.8 MB (199796179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33fab55a4ad792864a786ec1ea4c3389c42443c34649b3edfaec4ed2bf6e4ad2`  
		Last Modified: Sat, 16 Dec 2023 06:46:47 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5911c6579975ea4301d486abddd7621f3a6e944c0d5a95db6a3fd8e316a2beed`  
		Last Modified: Sat, 16 Dec 2023 06:46:47 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
