...
### `nextcloud:23.0.8-apache` - linux; amd64
...
### `nextcloud:23.0.8-apache` - linux; arm variant v5
...
### `nextcloud:23.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:23.0.8-apache` - linux; 386
...
### `nextcloud:23.0.8-apache` - linux; s390x
