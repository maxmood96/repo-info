...
```console
$ docker pull nextcloud@sha256:ef9b4c0a82df3071204a819663c02fad3e435e947fbf7a72af5f1e3d55491974
```
...
### `nextcloud:31.0.1-fpm` - linux; amd64
...
### `nextcloud:31.0.1-fpm` - unknown; unknown
...
### `nextcloud:31.0.1-fpm` - linux; arm variant v5
...
### `nextcloud:31.0.1-fpm` - linux; arm variant v7
...
### `nextcloud:31.0.1-fpm` - linux; arm64 variant v8
...
### `nextcloud:31.0.1-fpm` - linux; 386
...
### `nextcloud:31.0.1-fpm` - linux; mips64le
...
### `nextcloud:31.0.1-fpm` - linux; ppc64le
...
### `nextcloud:31.0.1-fpm` - linux; s390x
