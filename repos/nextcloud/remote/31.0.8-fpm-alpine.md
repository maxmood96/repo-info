...
```console
$ docker pull nextcloud@sha256:d406744a3383b23f1ed8611a99ea88f28c17e3c2e2279ce1504576bd481b074f
```
...
### `nextcloud:31.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:31.0.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:31.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:31.0.8-fpm-alpine` - linux; ppc64le
...
### `nextcloud:31.0.8-fpm-alpine` - linux; s390x
