...
### `nextcloud:29.0.0-fpm` - linux; amd64
...
### `nextcloud:29.0.0-fpm` - linux; arm variant v5
...
### `nextcloud:29.0.0-fpm` - linux; arm variant v7
...
### `nextcloud:29.0.0-fpm` - linux; arm64 variant v8
...
### `nextcloud:29.0.0-fpm` - linux; 386
...
### `nextcloud:29.0.0-fpm` - linux; mips64le
...
### `nextcloud:29.0.0-fpm` - linux; ppc64le
...
### `nextcloud:29.0.0-fpm` - linux; s390x
