...
### `nextcloud:16.0.9RC1-apache` - linux; amd64
...
### `nextcloud:16.0.9RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:16.0.9RC1-apache` - linux; 386
...
### `nextcloud:16.0.9RC1-apache` - linux; ppc64le
