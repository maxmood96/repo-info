...
```console
$ docker pull nextcloud@sha256:9ac596ad45705010be276941694adccefc756fefd7670eabe0036e6ca8f7e8f0
```
...
```console
$ docker pull nextcloud@sha256:2ada54e554f66404ea625ea34c98179b568f33e7d309d44ae77e15debfa2d7ab
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **395.5 MB (395541346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2af9f32f7a853c9e2bd2fd27efee33023c6e9a507401779735cf801fb47fceac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 02 Jul 2024 05:00:25 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Tue, 02 Jul 2024 05:05:51 GMT
ENV NEXTCLOUD_VERSION=28.0.7
# Tue, 02 Jul 2024 05:06:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 05:06:56 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Tue, 02 Jul 2024 05:06:57 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Tue, 02 Jul 2024 05:06:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Jul 2024 05:06:57 GMT
...
-	Layers:
	...
	-	`sha256:3d45a82e704adfa1d6e46fd8e391df0d61cb0426e602df0336ae04da938c20f6`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:515380401e04db0e8c0d7c8ed9def7f1f3ea3e64fa3f1a7fbf3774a7a1a8bd09`  
		Last Modified: Tue, 02 Jul 2024 05:13:20 GMT  
		Size: 204.7 MB (204683385 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63dd2458467b74757b1446e0ba90044a94b914e14bd0787bd1a2a932cda3df40`  
		Last Modified: Tue, 02 Jul 2024 05:12:50 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3503e29e891f8219ddbb4ae06eb7e65055018499692bdb8e63eaafaec28c70b`  
		Last Modified: Tue, 02 Jul 2024 05:12:49 GMT  
...
```console
$ docker pull nextcloud@sha256:b6139c6122384c41b08c3b76a829cb5ab4fe4032c88f6219def3faa9d4f661ec
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **417.5 MB (417460244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76e872fd29319065364df7fc58d262f12d6ccad00ae868c4831cde0547357db1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 02 Jul 2024 05:15:53 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Tue, 02 Jul 2024 05:21:08 GMT
ENV NEXTCLOUD_VERSION=28.0.7
# Tue, 02 Jul 2024 06:19:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 06:19:22 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Tue, 02 Jul 2024 06:19:23 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Tue, 02 Jul 2024 06:19:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Jul 2024 06:19:23 GMT
...
-	Layers:
	...
	-	`sha256:c782993cd98f36057b5d067f533cd6e2eef1ac017933bc39fde4ef583ed6b716`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c6e35533a254d63e53e86b6ef106ed7d6fcfa7724934d38623cde6dda00c1b9`  
		Last Modified: Tue, 02 Jul 2024 06:24:39 GMT  
		Size: 204.7 MB (204686155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1c4c8f475186fa2d6a884b5dfa3c3becce01d5a66853015045585684ea0d685`  
		Last Modified: Tue, 02 Jul 2024 06:24:20 GMT  
		Size: 3.9 KB (3872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01eb410045c2bcc450e36504ce760079ff0fd8104bbb5ff89b23938df9ba658c`  
		Last Modified: Tue, 02 Jul 2024 06:24:19 GMT  
...
```console
$ docker pull nextcloud@sha256:8b2577626785eade490b3b9240dd226368fb1eb3cfbcf21df59c554555b9cb5a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.4 MB (431384167 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c358507e9e47123217fdd45d26aa2c144504c3d84ef11393f642b87dafcfd71e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Tue, 02 Jul 2024 06:28:49 GMT
ENV NEXTCLOUD_VERSION=28.0.7
# Tue, 02 Jul 2024 06:29:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 06:30:00 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Tue, 02 Jul 2024 06:30:01 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Tue, 02 Jul 2024 06:30:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Jul 2024 06:30:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b8f90ea0c6a4fad74dbfface7723c72261773b7df3f9c2726d276f2a032f2614`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3c3a781692b4bd6c9ddc42a4226219428675c78159a03b94a60e746bddf587d`  
		Last Modified: Tue, 02 Jul 2024 06:36:46 GMT  
		Size: 204.7 MB (204686489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9159fd70fd54ffb811bdbb2ca8a083aa60af902f05fc07d8425617ce497e17c1`  
		Last Modified: Tue, 02 Jul 2024 06:36:18 GMT  
		Size: 3.9 KB (3872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddcb2b2c2f72ad8a9317b3a9cbc7f9cea5feeb96a68e48e01921e7afa631fb72`  
		Last Modified: Tue, 02 Jul 2024 06:36:18 GMT  
		Size: 2.4 KB (2370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f935faf2eb0546147b23605514e29befe062a752bfa97e8bb2cc7bfc27108bdd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **395.6 MB (395608827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ea1fa97f1c2669b8374694a0ff8ef20283ae237ab812cdd56639bbfad6c980b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 02 Jul 2024 04:21:35 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Tue, 02 Jul 2024 04:25:29 GMT
ENV NEXTCLOUD_VERSION=28.0.7
# Tue, 02 Jul 2024 04:26:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 04:26:12 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Tue, 02 Jul 2024 04:26:13 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Tue, 02 Jul 2024 04:26:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Jul 2024 04:26:13 GMT
...
-	Layers:
	...
	-	`sha256:b45a31693ad37799554b54abafa30f65b030bc2ca0f15336afe265b4fb17a8cc`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e684b39859d0ef460cd8e2df3a5bd1c334874b6339fc4a0adb7b7897b3ff7cff`  
		Last Modified: Tue, 02 Jul 2024 04:31:10 GMT  
		Size: 204.7 MB (204683202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1044eb6d4e314dcc49f6158b8f68e602324d39698124b5644fbd38269094d721`  
		Last Modified: Tue, 02 Jul 2024 04:30:47 GMT  
		Size: 3.9 KB (3872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:766a556f3f30fb5b07f37964c93587c65056f2585d99e5c213c575af84fb3dbf`  
		Last Modified: Tue, 02 Jul 2024 04:30:47 GMT  
		Size: 2.4 KB (2368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
