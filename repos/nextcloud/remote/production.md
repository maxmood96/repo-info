...
```console
$ docker pull nextcloud@sha256:4974c7f3e7e214e804b377329ad101214045ccd578733173a03c7101a9bee7b0
```
...
```console
$ docker pull nextcloud@sha256:06a3e1843eda6cc96e774ec79ca9fd2f0be4cb643492c01c2af1c32b6c150fbf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.6 MB (426551160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1cc213114f27aae2b2dcbc717d9971a09e2dace048fe99d130870a15bdf51d2`
...
# Wed, 24 Apr 2024 17:07:56 GMT
ENV NEXTCLOUD_VERSION=28.0.4
# Wed, 24 Apr 2024 17:08:57 GMT
...
-	Layers:
	...
	-	`sha256:7ec706003200ee7f60df64f0aa8f1ec8c565353108d31d0fc02d4f6ed90584d2`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2177129c61f49a96d34ee9816d8255a74dfc87e0d2a88d6b9706568147f71ab`  
		Last Modified: Wed, 24 Apr 2024 17:13:45 GMT  
		Size: 205.2 MB (205174550 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92b061abf47745b5f5ae4581aa91966bc99f832b581b58b4c1e1e6ad421c8d39`  
		Last Modified: Wed, 24 Apr 2024 17:13:21 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24d2fa67d8b0f0746ba7192e3ee6f9e38199a08f4589bd3b0c22f278383eae69`  
		Last Modified: Wed, 24 Apr 2024 17:13:21 GMT  
...
```console
$ docker pull nextcloud@sha256:2cebb66f91d37b61c5c8d2015b648ed72449c21eb7f251cd60cdf7669d46d20f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **384.5 MB (384479704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c48cb67d18827791236d182d8a6b30ef2d34209c829d0608d922aea1f2b16006`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 14:42:30 GMT
ENV NEXTCLOUD_VERSION=28.0.4
# Wed, 24 Apr 2024 14:43:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 14:43:48 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 14:43:48 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 14:43:48 GMT
...
-	Layers:
	...
	-	`sha256:1fc9ebf0cd6cb473027a3e9b7857a1b79dbc64fb2f2535ff7ad6fd925dcceaf2`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c789f5ff82074e1138f85f95af601f837e148caf10ca9df5c726929049d7fb9e`  
		Last Modified: Wed, 24 Apr 2024 14:50:29 GMT  
		Size: 205.2 MB (205171804 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:922c6fa2b59a3dc4deea08a8b9efa37ffca327ad39753f594e6b192ec6da2088`  
		Last Modified: Wed, 24 Apr 2024 14:49:39 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1fca20a4a138ef2de4fc2fbfa13a451c260e945d72c26b24e8cc5dc0dbf1460`  
		Last Modified: Wed, 24 Apr 2024 14:49:39 GMT  
		Size: 2.4 KB (2396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:8c027b8f1e3f76a10a5dc47b5de48658b84c090e0f91457470207f692fc3de3c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **425.2 MB (425175803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09942016145307f58e998cd20b82fee4885a9672ffdd9cdbfed1b43ff2826341`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 24 Apr 2024 19:17:29 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 19:27:30 GMT
ENV NEXTCLOUD_VERSION=28.0.4
# Wed, 24 Apr 2024 19:28:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 19:28:51 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 19:28:51 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 19:28:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 19:28:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8dec0d77baa04d831397adceb2b9c4c1741d8f4bc34dc81fabd616cb13930a8d`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:695a718100fc9dfb1a5e58bdcf93e87fa370d669f590aa6d7d220e921ae4ff15`  
		Last Modified: Wed, 24 Apr 2024 19:35:20 GMT  
		Size: 205.2 MB (205173355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:308d2cdb424db333b5df4b42bc8b64deda38426e28b6fc1ff9e1b6dd9dcdc41c`  
		Last Modified: Wed, 24 Apr 2024 19:34:40 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18dc312124257197647d6ad0430fbb1f7279cb9573292f8aa28a444e5117e787`  
		Last Modified: Wed, 24 Apr 2024 19:34:40 GMT  
...
```console
$ docker pull nextcloud@sha256:78b40c67628960fdf8e3709faa2b0116a5f6afbd6debf424b205f607ee728f2d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.6 MB (397637295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e492b9c6cd3acfb6e9c8d9d7808a4f5bb488fd3546d938bd006e3246f02c7573`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 19:00:26 GMT
ENV NEXTCLOUD_VERSION=28.0.4
# Wed, 24 Apr 2024 19:03:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 19:04:02 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 19:04:12 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:844007c85a5a63be5c74e0ef993ee54dbbd724a06f17f1da2b9002e006e6f620`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82c44fb8acb8b9f8cb63bbdc4acadd91b6825a48b0e7e84e2dcef46421cc710d`  
		Last Modified: Wed, 24 Apr 2024 19:20:57 GMT  
		Size: 205.0 MB (204952802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22b1d2314f31942953fbf4c964d06808414d250e6f371ff197da4927839aa970`  
		Last Modified: Wed, 24 Apr 2024 19:18:50 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cbb3902404ab3f1d62a3739c680bf42d1d46dd1cdc552434935440b672ea53a`  
		Last Modified: Wed, 24 Apr 2024 19:18:50 GMT  
		Size: 2.4 KB (2396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:550a8f0174b99b27664a004f960baebd404e203d053b811920df712edf5acbe9
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **431.9 MB (431872394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e071f3e05d60a2414fe5a34078ad7200b9758599f912b5e7684524873c49c18`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 15:12:37 GMT
ENV NEXTCLOUD_VERSION=28.0.4
# Wed, 24 Apr 2024 15:14:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.4.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 15:14:20 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 15:14:21 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 15:14:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 15:14:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b7fd4f8babb7faf7030da61601e029ae558f6d71e1b350c91c6b8d2d3b0778ba`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4da239624b07c61c67b26fc50444b29601900b7c5346f56611d635996788df7`  
		Last Modified: Wed, 24 Apr 2024 15:20:17 GMT  
		Size: 205.2 MB (205175258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df533ae6f8b13c616a86afe9ca42df6cdf5ddd2e036b2b3b94d41ac4be8b5ec0`  
		Last Modified: Wed, 24 Apr 2024 15:19:49 GMT  
		Size: 3.6 KB (3610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04c8e5fe263ac6714937d534b67704abaa0a84a052cbfe31c2d9ac02e54196d1`  
		Last Modified: Wed, 24 Apr 2024 15:19:49 GMT  
		Size: 2.4 KB (2395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
