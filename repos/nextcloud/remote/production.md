...
```console
$ docker pull nextcloud@sha256:013a31e424ae9415bff2c013fab5e8bbe0cd571654aa7cb5f414a93b0dc22823
```
...
```console
$ docker pull nextcloud@sha256:e1ea49b724bea979f1b3827be0fb998932b2949e8fd34990af84e46b16704ed2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.5 MB (358460294 bytes)**  
...
-	Layers:
	...
	-	`sha256:b5a3b2cdbc6f4b1da73bc6281b61f40e583b47f89dff72414db8f87666744b2a`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9938e66017f75f9740e0228f8aedff9fd648b87d3e147b4f9244d9ae738a2c6d`  
		Last Modified: Tue, 11 Jul 2023 03:38:24 GMT  
		Size: 168.9 MB (168941671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b11cfce37501d7e49aab620090c4898105a21a3b88ff86d63e740a35e5292817`  
		Last Modified: Tue, 11 Jul 2023 03:38:02 GMT  
		Size: 3.5 KB (3469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1513105cd1f49fb31312cd78b703c8c8a96b1fc42a4f9b8a0e9888f5829436f`  
		Last Modified: Tue, 11 Jul 2023 03:38:02 GMT  
...
```console
$ docker pull nextcloud@sha256:de2937a36f2242699b6218f92f997bb7d4c79eef3bd25e10e24dfe5464a92f03
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.3 MB (324278793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f75bff45cf8cc01c79db0bb71f32bab8a54dddd02cbc42f3e53954d9f53a699`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 11 Jul 2023 03:07:03 GMT
ENV NEXTCLOUD_VERSION=26.0.3
# Tue, 11 Jul 2023 03:08:02 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 03:08:06 GMT
COPY multi:f14917ef3f8441cf73a9faa81b54c7e51061a07185e365974d47ddb315426c8f in / 
# Tue, 11 Jul 2023 03:08:06 GMT
COPY multi:bed047b97a268e53d9af8fc32cf3b9fc25306fd16316e9a09031943c00c6b402 in /usr/src/nextcloud/config/ 
# Tue, 11 Jul 2023 03:08:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Jul 2023 03:08:07 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f048ea366a3d71a05db382fe9c7defb78afddf37c4f570a77159e1e2f98411ad`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b4da274bcb29fe823e3536c1f6c96c9eed4648d2de2e3381701a0d4916bd036`  
		Last Modified: Tue, 11 Jul 2023 03:21:15 GMT  
		Size: 168.9 MB (168940587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9031aad47a54854fa2df5dfdc5e73d1c851dda8a2eb15d9eeea2a911aa7afba`  
		Last Modified: Tue, 11 Jul 2023 03:20:51 GMT  
		Size: 3.5 KB (3469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb87af8251306a59e7d843c3cf5c72b878b95d5a221710b7b857f07f3ff6fa05`  
		Last Modified: Tue, 11 Jul 2023 03:20:51 GMT  
...
```console
$ docker pull nextcloud@sha256:2242113f8d705ba569696d48d1df10192ba43e1bf732e3d608c3be5a8e27ce8e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **359.0 MB (359003965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0a7c7f925ab169e719f35eff3242d870b811351960642096ecbb9afb4bedee2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 11 Jul 2023 05:45:21 GMT
ENV NEXTCLOUD_VERSION=26.0.3
# Tue, 11 Jul 2023 05:46:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 05:46:54 GMT
COPY multi:f14917ef3f8441cf73a9faa81b54c7e51061a07185e365974d47ddb315426c8f in / 
# Tue, 11 Jul 2023 05:46:55 GMT
COPY multi:bed047b97a268e53d9af8fc32cf3b9fc25306fd16316e9a09031943c00c6b402 in /usr/src/nextcloud/config/ 
# Tue, 11 Jul 2023 05:46:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Jul 2023 05:46:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:95972d7f9aef8b620ad83231647e3626a65261fb031bcae5e4123409735f31e0`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0022cfe4fdd7aabd5787a048131c2120f977dab8c3eb68c1de0cad1cd33aeee`  
		Last Modified: Tue, 11 Jul 2023 06:09:34 GMT  
		Size: 168.9 MB (168942775 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c39809189ded25bfdfe506069676dfdb251204e54f97d200d995a675e498a0da`  
		Last Modified: Tue, 11 Jul 2023 06:08:57 GMT  
		Size: 3.5 KB (3469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79a801fc42dbe3a3daa8e9cecfbee34cf3616eb9479af26532c8e13eb321efef`  
		Last Modified: Tue, 11 Jul 2023 06:08:57 GMT  
		Size: 2.3 KB (2284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:ec4ec8bb59a296b0213565c1f394a6e49746964c49c51659253b941c64b84d8b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.9 MB (332943900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2bb625f24fefe23c5dd00253dd8a3cd4116985c0f764ae3d5835e55d1d86d464`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 11 Jul 2023 07:15:26 GMT
ENV NEXTCLOUD_VERSION=26.0.3
# Tue, 11 Jul 2023 07:16:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.3.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 07:16:14 GMT
COPY multi:f14917ef3f8441cf73a9faa81b54c7e51061a07185e365974d47ddb315426c8f in / 
# Tue, 11 Jul 2023 07:16:14 GMT
COPY multi:bed047b97a268e53d9af8fc32cf3b9fc25306fd16316e9a09031943c00c6b402 in /usr/src/nextcloud/config/ 
# Tue, 11 Jul 2023 07:16:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Jul 2023 07:16:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3c220218d640095e8ac421c4a16df314da4ac47a4546af9354f47b0850126559`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:029e037ff667396a332c85ccf5491b164d9e9b8a01642911addccdccbdc6638e`  
		Last Modified: Tue, 11 Jul 2023 07:28:00 GMT  
		Size: 168.9 MB (168940769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03b4a35d681d32a631ccfae616033fe6db970ccb0d17a663979a196d470834f5`  
		Last Modified: Tue, 11 Jul 2023 07:27:41 GMT  
		Size: 3.5 KB (3469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13f7fb8d96adf9f437351b66f245a20d7641f0777127004e948057b85f31a362`  
		Last Modified: Tue, 11 Jul 2023 07:27:41 GMT  
		Size: 2.3 KB (2284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
