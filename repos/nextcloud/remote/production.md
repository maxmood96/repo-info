...
```console
$ docker pull nextcloud@sha256:cca0bdb3b41dbd394cb2f049fb31e9d91cb3e7d523d6e9d718dd74307201128c
```
...
```console
$ docker pull nextcloud@sha256:56ec93fd2b58907b30c5b6b2ed4fdc3ab9559512856d1b5ecf86e88ab672fd03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.4 MB (284408197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a27603fcf8d0748c09df1536e17c8ad4113715ddc4411a57e150ee043310582`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 06 Oct 2022 21:22:02 GMT
ENV NEXTCLOUD_VERSION=24.0.5
# Thu, 06 Oct 2022 21:23:01 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 21:23:01 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Thu, 06 Oct 2022 21:23:02 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 06 Oct 2022 21:23:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Oct 2022 21:23:02 GMT
...
-	Layers:
	...
	-	`sha256:8f2a508e19b50ba4e709a8df51fc2d7f702089b3b91ca3e9669e2f1dad2ac796`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07f243e75c8e295bd0afc88781d451b5dd461a7edf26f95de223f0973720baef`  
		Last Modified: Thu, 06 Oct 2022 21:28:20 GMT  
		Size: 134.4 MB (134396012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d948852912b933556fc80dc76eee99123c7a0b348e8d4f9102974a7e398cebc4`  
		Last Modified: Thu, 06 Oct 2022 21:27:52 GMT  
		Size: 3.2 KB (3248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3dadbf09bc905c5af02510f1c670083df3af59741a7f824b4388b4bd22c0535`  
		Last Modified: Thu, 06 Oct 2022 21:27:52 GMT  
		Size: 2.2 KB (2215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f251d70f1b4d35d80e416424e10f2bc189912d946d26c770fd9076c4caaea0c8
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.1 MB (292089817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfdd5e7e4fba9b55b22625002ec615ff36aa162f2dc3b1f2a567367b975942bb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=24.0.5
# Thu, 06 Oct 2022 10:13:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 10:13:21 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Thu, 06 Oct 2022 10:13:30 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 06 Oct 2022 10:13:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Oct 2022 10:13:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0618c34c288cc417a0aa94f95e2e61c63fdab405f6273c24db45dac9a85f5822`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:345953698e262651f3673593fa80417f7553620a8bbc134dae83d11dab67c07b`  
		Last Modified: Thu, 06 Oct 2022 10:22:55 GMT  
		Size: 134.2 MB (134162187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47a7faf2f847d27cc87df6ddc09252a05f49e0159b9c1c06082871512b917811`  
		Last Modified: Thu, 06 Oct 2022 10:21:37 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49e4cb0195803f03696fc84f4b8f3ced5153165059cdd1c5268f8937ebac4d1d`  
		Last Modified: Thu, 06 Oct 2022 10:21:37 GMT  
		Size: 2.2 KB (2215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
