...
```console
$ docker pull nextcloud@sha256:032809acb52033ece61bd8ad4110a1ca4b70a1854a7575c5fcfd6a5125e7396d
```
...
```console
$ docker pull nextcloud@sha256:61557621750dbef9ac596217c838e1be0c482f02df9bd430eb221e2c11254178
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.4 MB (302414299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d49e36e126a231388c3d5dc4913a6609f3c3738ebc13ac338c556b46423a110`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 30 Mar 2022 07:33:42 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Wed, 30 Mar 2022 07:35:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 07:35:17 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Wed, 30 Mar 2022 07:35:19 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 30 Mar 2022 07:35:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 30 Mar 2022 07:35:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cf98adab98db56b317e96571bc19a68ba8e7e788e5fbb411bf05093e2a5db5f6`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fffea051db78230b60a5958103a66294b1e2acaf7feab4be205c624bec842946`  
		Last Modified: Wed, 30 Mar 2022 07:52:27 GMT  
		Size: 143.5 MB (143519801 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe497dde8294b5b0cd6c8e71ddc57447397692c620c44aca163c2c50939cab14`  
		Last Modified: Wed, 30 Mar 2022 07:50:49 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79d728c29d7dd73ce6d30eda198fe73523f607570926ba070d25fb681bf43fda`  
		Last Modified: Wed, 30 Mar 2022 07:50:49 GMT  
...
```console
$ docker pull nextcloud@sha256:bdf0a6cf7bc28eb0fed741f99e2ff5062b3102b7fb83d42dd47ddd16ca2ca201
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.4 MB (293387433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2663d0df5be1af98fa42ba59674d30ac152e41895d6ba3ff22262b2bdf9d349e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Mar 2022 17:29:41 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Tue, 29 Mar 2022 17:31:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 29 Mar 2022 17:31:18 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 29 Mar 2022 17:31:20 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 29 Mar 2022 17:31:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Mar 2022 17:31:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8cd7937c1bda953a7305e5572829c91a89f3604e8a6d5cdc136d69651c59743d`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dc2c1bdfa57c797f979c160df4c60d9ddb6d7516d838d04d2fe68486b75dc87`  
		Last Modified: Tue, 29 Mar 2022 17:56:51 GMT  
		Size: 143.5 MB (143519925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e34059a056e830dc0ccd808fc1559fc17836af931c65aa8a7c7f1f3d9565f995`  
		Last Modified: Tue, 29 Mar 2022 17:55:24 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b272329d442a613bbf047abacf34369022cf9ac40088300817bd03a4718e2b5`  
		Last Modified: Tue, 29 Mar 2022 17:55:24 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:241e8e16efb3badfed5cc9cf118c3f90aa1ac21d4772b774ba6df5c5a5c113d6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.8 MB (327849824 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0359cde5c68b0e4e16df94b681cdb46006e18cd91899dc8f95cd111a0750a47`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 29 Mar 2022 21:55:49 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Tue, 29 Mar 2022 21:56:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 29 Mar 2022 21:56:39 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 29 Mar 2022 21:56:40 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 29 Mar 2022 21:56:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Mar 2022 21:56:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:78a2a3ed66a709d260ea3c1d861eabe1b2be657a512fc5da151a2d4fc92de3f2`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2e4ee0c5e1a03302d2cff2f3bc179dba3a2a3ebfcb2593badd31e448a400995`  
		Last Modified: Tue, 29 Mar 2022 22:08:21 GMT  
		Size: 143.3 MB (143280042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7668704b24111bb0df071cb0ee46f542ccae9d0696c6e41e2a1f2cce5fa00544`  
		Last Modified: Tue, 29 Mar 2022 22:08:00 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e2e8917f4cb54b65745f3ccc53a4bf459818aca36a0aa1ae1fd22c89313abc`  
		Last Modified: Tue, 29 Mar 2022 22:08:00 GMT  
...
```console
$ docker pull nextcloud@sha256:c9a78056e330d57df9138117705e0049ac6960396125b3e09f3956455a6bfc7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.6 MB (301601165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b951ea379d212f821ffbcf0737e8bbee5f54c96d1f6b97df8f65b657e2e5093`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 30 Mar 2022 06:13:13 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Wed, 30 Mar 2022 06:13:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 06:13:55 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Wed, 30 Mar 2022 06:13:56 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 30 Mar 2022 06:13:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 30 Mar 2022 06:13:56 GMT
...
-	Layers:
	...
	-	`sha256:7c8c1a769a76f8399d3be307b8a6fb5519f59211dbb858dfd5a8d9a00be10f1c`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0539ae78a19a6ac4e74f461e63ac2b0afe8c50c0c28fba46c55c39657a347d59`  
		Last Modified: Wed, 30 Mar 2022 06:21:34 GMT  
		Size: 143.5 MB (143519521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb9e3306b7ffe40b9a2b3b9c3a2110f611af6c75a08dd32094eda1a6ad4c4999`  
		Last Modified: Wed, 30 Mar 2022 06:21:18 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f97e16bbea194d532d3e95afa4767b06fc04f2e7b37d83e44d1a4d217b121e8`  
		Last Modified: Wed, 30 Mar 2022 06:21:18 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
