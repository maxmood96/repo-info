...
```console
$ docker pull nextcloud@sha256:bf1d43de344a3f6b9d09f0aa4b7328e6775e7d1a068c7b045f48997870cf4fdd
```
...
```console
$ docker pull nextcloud@sha256:a49264973bf6965d4fbfa3d281542bafb2ee290356fca1d1abeadb06c88b6d78
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.0 MB (242010677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c31c23bd2c076d513160a086c14ff51c213bf6b7c851a373bdcb39ba4c2918a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 15 May 2020 02:31:18 GMT
ENV NEXTCLOUD_VERSION=19.0.0RC1
# Fri, 15 May 2020 02:32:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 15 May 2020 02:32:24 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 15 May 2020 02:32:27 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Fri, 15 May 2020 02:32:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:5a5cd2e01dfbc7a3e22541477b8adb71092faab1a89cf0f09913880da60110bf`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03f2995a99ef2f22e64f72ea494c0f444d297fab2975b3e2628659423b0ec82d`  
		Last Modified: Fri, 15 May 2020 02:39:05 GMT  
		Size: 98.5 MB (98452362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79e0680ea754ab5fe5f2224254fcfa27873d4049d1f147642c016d4b94b99d0b`  
		Last Modified: Fri, 15 May 2020 02:38:29 GMT  
		Size: 2.6 KB (2554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:008e0ed1fa4b1f991a3a82d3a3a19f46126418a862f7b2b4d7bfc52743fb94ad`  
		Last Modified: Fri, 15 May 2020 02:38:29 GMT  
...
```console
$ docker pull nextcloud@sha256:7e70e27c80f25c541ca9deaffe3999fc5b64911cbfee90310e020ac83b199229
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.2 MB (238166153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f86df437e131ee7d7ac23ba0480e7187387a584e485e828d4f7df814fc5097b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 15 May 2020 08:18:54 GMT
ENV NEXTCLOUD_VERSION=19.0.0RC1
# Fri, 15 May 2020 08:20:01 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 15 May 2020 08:20:06 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 15 May 2020 08:20:08 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Fri, 15 May 2020 08:20:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 15 May 2020 08:20:10 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2f0a38c23b7ecfd1f86c5c61357fa66007379333b98da8f4f1e5db396e1602e3`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40e152c5496d350759b5008d120104462f4a45d8c26e93c0b8a17d11a3ae35dd`  
		Last Modified: Fri, 15 May 2020 08:30:01 GMT  
		Size: 98.5 MB (98452369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:beb3d18d7973af7e46d00b12210cb3f32f2ff3591abd37bc811de0867d9d2d53`  
		Last Modified: Fri, 15 May 2020 08:29:28 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c4fee1df6f1e4ede4aa9d7bfcdab2a2d96b8920fce8851d176f6dfb79788952`  
		Last Modified: Fri, 15 May 2020 08:29:29 GMT  
		Size: 1.4 KB (1427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `nextcloud:19.0.0-rc-apache` - linux; mips64le

```console
$ docker pull nextcloud@sha256:2723c455bc073f85ca901ae1cee8664f2d7931bd1d0ea530f31c34231a7f8e31
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.5 MB (246521444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8af220286a77d1fd58513f5ee01d3088186da4070b3a435bf5c7ac34938d964`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 12 May 2020 02:08:09 GMT
ENV NEXTCLOUD_VERSION=19.0.0RC1
# Tue, 12 May 2020 02:09:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 12 May 2020 02:09:47 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Tue, 12 May 2020 02:09:48 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Tue, 12 May 2020 02:09:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 May 2020 02:09:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:88f46ddbbb42e2052bd07e73b6a33f6c9a76b6fb70f629dd3e2a5979ca3dc656`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52eaf006031f2d0d4b5a1e1b36c1fb778232d63f8341536c7ea605a1a9f4197c`  
		Last Modified: Tue, 12 May 2020 02:15:12 GMT  
		Size: 98.5 MB (98452250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac7a8c601f04eb30536ec04889912ebf8d4d65c4272002363d985766ea2ce83e`  
		Last Modified: Tue, 12 May 2020 02:13:59 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a4a9293a412b274c7ad552b72a860def346c8131a4ea710a516660fa280db8e`  
		Last Modified: Tue, 12 May 2020 02:13:59 GMT  
...
```console
$ docker pull nextcloud@sha256:689c4e1d129a52c9fadcdb4991fbdbbd049b8f116a7db7a99bf160bf1fa55164
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.4 MB (249435922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22c3bf47dcdc3bc13d901a5adcea2caab042c1db52a467ac1d303d1f7ab97156`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 15 May 2020 02:54:24 GMT
ENV NEXTCLOUD_VERSION=19.0.0RC1
# Fri, 15 May 2020 02:54:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 15 May 2020 02:55:01 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 15 May 2020 02:55:03 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Fri, 15 May 2020 02:55:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 15 May 2020 02:55:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6a568c8510c510ee9e79447259bcc63a7882edfb4b2348429c911461ce4e9c28`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab913172f3c1177b790523408d5856cc092cddd2d4f6f8452f56d7200305fbcb`  
		Last Modified: Fri, 15 May 2020 03:01:17 GMT  
		Size: 98.5 MB (98452248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0971987a7543728bb4f472cea693d8f3124b0da9ea678f1bac642dc022a7e615`  
		Last Modified: Fri, 15 May 2020 03:01:19 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:578ada6ef74e1e72e1411008f1e93e34c6dc6c366b82e4637d5028bce0071d4e`  
		Last Modified: Fri, 15 May 2020 03:01:35 GMT  
