...
```console
$ docker pull nextcloud@sha256:2718c4df8b1de3ebde554202444cfdd773d286156e2b61bf6de936ec6e99f979
```
...
### `nextcloud:25.0.4-apache` - linux; amd64
...
### `nextcloud:25.0.4-apache` - linux; arm variant v5
...
### `nextcloud:25.0.4-apache` - linux; arm variant v7
...
### `nextcloud:25.0.4-apache` - linux; arm64 variant v8
...
### `nextcloud:25.0.4-apache` - linux; 386
...
### `nextcloud:25.0.4-apache` - linux; mips64le
...
### `nextcloud:25.0.4-apache` - linux; ppc64le
...
### `nextcloud:25.0.4-apache` - linux; s390x
