...
```console
$ docker pull nextcloud@sha256:cd5e808fd61f9da948bcdd10b14030207458163c3fc1001cef58d4df316c5886
```
...
```console
$ docker pull nextcloud@sha256:1669ade116a31d0c7e184be1e1ca3ae9bfd157bd4441bad34728d127475546f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300315182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:414970af6b050d854c178730a734fe8cc38cb9ab1654fe6759dc60f5170e8588`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 13:43:30 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Sat, 25 Jun 2022 13:43:32 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 25 Jun 2022 13:43:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 25 Jun 2022 13:43:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e767ed34574e2cdb67b8fff13f3832fb0b945ec6d9a9aa7ed5dbec9fa2876850`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3aac9ef717dfba9d9ef72a24e5539defcfc16a1036985f15d07cca70cf3c442`  
		Last Modified: Sat, 25 Jun 2022 13:51:57 GMT  
		Size: 3.0 KB (3012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f300f2fcf6f4f3c61f6d839dc5c66d6ff66fa7323d01107b4faa4ec141bad3fe`  
		Last Modified: Sat, 25 Jun 2022 13:51:56 GMT  
...
```console
$ docker pull nextcloud@sha256:30fd112e3dd8c7001f40b40481f50f0cee582e50603a44afbbfe24f2afa5dedb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.7 MB (307687739 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19b7aeba4e5ac0734ac4e86989a23b47e39eb0a9d9583db54af974b135344ad3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 07:04:04 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Sat, 25 Jun 2022 07:04:13 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 25 Jun 2022 07:04:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 25 Jun 2022 07:04:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:528494aab2ff4f4645ebb2b2b1f2ad08d978f1eddd07fd0487f87dd3634ebc21`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3c291594e7c5abf55f9cbeecd6f419bc6ab9a3b36ae55fe713c781a9d145e9b`  
		Last Modified: Sat, 25 Jun 2022 07:18:02 GMT  
		Size: 3.0 KB (3013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3daa0a926c16ae499e383474a51fe04c574c05d7fee2682ac087e3615e76a42f`  
		Last Modified: Sat, 25 Jun 2022 07:18:01 GMT  
