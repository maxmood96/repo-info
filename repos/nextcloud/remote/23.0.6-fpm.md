...
```console
$ docker pull nextcloud@sha256:6d5192193d83d95fcef9232f18cc35970a0c46668ca7e6f9dcf9bad081636989
```
...
```console
$ docker pull nextcloud@sha256:978ab8e5d7d869fad8f27c1df893b45e8eef2c1a8568edb9a9e7d94919e0d167
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.1 MB (309113517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0351c127f7e312c1ef5452a4559b8b169c12968f1bfb5c4497c169771f13556`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 01:12:59 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 01:13:01 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 01:13:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 01:13:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b833ac7f0c94a7d5d3f3d870c87dd06ce4302021826beef0b557c99996583739`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b1c0c4d8cf0245cee6d87999a4d69fa05b749f422d5715a4358a4e0d6cb19a7`  
		Last Modified: Fri, 01 Jul 2022 01:17:58 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cef8b30bee7f505070803ca9eea70412fc731e8a165917d1c76677a5affa9aca`  
		Last Modified: Fri, 01 Jul 2022 01:17:58 GMT  
...
```console
$ docker pull nextcloud@sha256:9dbf79100eaa3d91e376242a38e558c0abdc48ca71a4fa2c29363689e50e4d82
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300315242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6896b77b5f1f6fc055b29714436063a91f2899a83b4f814080d5bc78c7fcb906`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 25 Jun 2022 13:39:22 GMT
VOLUME [/var/www/html]
# Sat, 25 Jun 2022 13:41:52 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Sat, 25 Jun 2022 13:43:28 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 01:24:08 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 01:24:10 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 01:24:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 01:24:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d1f43bb87ea667060821b11c33416875d4265a57f94af40732b315f9656f5b8c`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e767ed34574e2cdb67b8fff13f3832fb0b945ec6d9a9aa7ed5dbec9fa2876850`  
		Last Modified: Sat, 25 Jun 2022 13:53:40 GMT  
		Size: 153.8 MB (153832960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba4406f13fa62c1659833f16c5ba0917b2e65e38681a377f5e8a66f88cc7bf92`  
		Last Modified: Fri, 01 Jul 2022 01:35:59 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:777017538bd94536b95580ef53f6f3b8969cc77b16c4eee2594724b9674f11f8`  
		Last Modified: Fri, 01 Jul 2022 01:35:59 GMT  
...
```console
$ docker pull nextcloud@sha256:ef69288d4bc464ebedc7898f75529c0b5da0eb0452c6cff2c3649501b5087e17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.1 MB (334086895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4604fe9770220a47f43d1b00539edcd6174ea18f7bf9aac2fc553fc613e1023`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:43:03 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:43:05 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:43:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:43:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:90d5c548910d6c1702fa910def7c45cf76dab42473b86b5aaa757e3682d7f9c7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:034036db2ba533e4f8f07f7b0c38e63f5ab775818729a4040183d0231003ce22`  
		Last Modified: Thu, 30 Jun 2022 23:49:16 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e7563ec356b9b4ad3f1fee9e2c748e6a81b18a60cf50814db0408b4032c8a63`  
		Last Modified: Thu, 30 Jun 2022 23:49:15 GMT  
...
```console
$ docker pull nextcloud@sha256:3b1a726da3fe560c17cddd1d7ec199b97a97290398c6896558f3389e73b3c4b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.7 MB (307687798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86692a30e8ad32a1fd4d0c690ce9c69e050b30b243ed6ca51b891261aeca989b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 25 Jun 2022 06:42:02 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 25 Jun 2022 06:42:05 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 25 Jun 2022 06:42:09 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 25 Jun 2022 06:53:55 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 06:54:02 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 25 Jun 2022 06:54:06 GMT
VOLUME [/var/www/html]
# Sat, 25 Jun 2022 07:01:06 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Sat, 25 Jun 2022 07:03:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 03:47:14 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 03:47:23 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 03:47:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 03:47:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:028c60904806047470c22aaee9294a9b267df9738aadf594057f6051ac41e1f1`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46c31e799bfb4235f0602af051bc5952c1b47aed74eae5cb7614910f8c2edc5d`  
		Last Modified: Sat, 25 Jun 2022 07:13:54 GMT  
		Size: 1.5 MB (1542610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11dad6cd524fe0b1bcdaf2423bd516b7c7235ec3e9c415625cc466be19bb36af`  
		Last Modified: Sat, 25 Jun 2022 07:14:02 GMT  
		Size: 15.1 MB (15136336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc75fd18e9c66d9ba96fbda36e1ba0a6b03bbae470b487b076342125f9960e4c`  
		Last Modified: Sat, 25 Jun 2022 07:13:50 GMT  
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:528494aab2ff4f4645ebb2b2b1f2ad08d978f1eddd07fd0487f87dd3634ebc21`  
		Last Modified: Sat, 25 Jun 2022 07:19:39 GMT  
		Size: 153.6 MB (153597669 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d703043887d8328c53932a8f877f858a3f0ec8634eeffafc4f67fda99eca7fa`  
		Last Modified: Fri, 01 Jul 2022 03:50:58 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91b82581654701f6a9c58510d52d28893cdaa9ae27f533af213be6e2bc9b9047`  
		Last Modified: Fri, 01 Jul 2022 03:50:58 GMT  
		Size: 2.1 KB (2144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:3b14ad239db07382e994c99d7c98da689835de621f9d49271b8ad4178c4d71d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.9 MB (332901887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ac4cf22f98632b2a0354c5c0b3c7d1edf5c9332ae0674d23d659ee9e42a19a6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:34:46 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:34:48 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:34:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:34:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b1a0593d3eb0861daa1948f5981426b9e93b102f3a9caed2c66bcf0ad33438de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f03f3dcf0af97fd95029772fcdc9db2ae2de85aecd176f84f1bae328a0f5e00e`  
		Last Modified: Thu, 30 Jun 2022 23:45:05 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d466ba8125573694cebe39dd6a88d4db1c025d00ae07fa7d138bd20277e958e3`  
		Last Modified: Thu, 30 Jun 2022 23:45:05 GMT  
