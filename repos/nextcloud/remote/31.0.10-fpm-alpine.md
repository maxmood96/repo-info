...
```console
$ docker pull nextcloud@sha256:ab6c92bf39e3e16abc5aa5777b748908c0b1f6427b68a624b1c2730dcb1f2ce4
```
...
### `nextcloud:31.0.10-fpm-alpine` - linux; amd64
...
### `nextcloud:31.0.10-fpm-alpine` - unknown; unknown
...
### `nextcloud:31.0.10-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:31.0.10-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:31.0.10-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:31.0.10-fpm-alpine` - linux; 386
...
### `nextcloud:31.0.10-fpm-alpine` - linux; ppc64le
...
### `nextcloud:31.0.10-fpm-alpine` - linux; s390x
