...
```console
$ docker pull nextcloud@sha256:8f78b6f0d58a2cc70042a66411a4d8f13ec9a446ed4768e74840270440694e23
```
...
### `nextcloud:32.0.7-fpm` - linux; amd64
...
### `nextcloud:32.0.7-fpm` - unknown; unknown
...
### `nextcloud:32.0.7-fpm` - linux; arm variant v5
...
### `nextcloud:32.0.7-fpm` - linux; arm variant v7
...
### `nextcloud:32.0.7-fpm` - linux; arm64 variant v8
...
### `nextcloud:32.0.7-fpm` - linux; 386
...
### `nextcloud:32.0.7-fpm` - linux; ppc64le
...
### `nextcloud:32.0.7-fpm` - linux; s390x
