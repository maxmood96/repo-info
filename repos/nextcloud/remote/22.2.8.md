...
```console
$ docker pull nextcloud@sha256:30151467bb4b4f479a6ce45f8a50c71e30a1d3d17837c8056f8f290e497d3176
```
...
```console
$ docker pull nextcloud@sha256:d1fb304c7514a7f2d31f05ba05f72ea0786804c361cae274a45f6db60b92f488
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.2 MB (302196141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31ad6d1eb8c4644b94a2fc7b8dcdc90a294794474e44ff9f08502e8af322cb2c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 01 Jun 2022 03:11:51 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Wed, 01 Jun 2022 03:13:27 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 01 Jun 2022 03:13:30 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Wed, 01 Jun 2022 03:13:32 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 01 Jun 2022 03:13:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 01 Jun 2022 03:13:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fff48c8d9866cdc8832783027b3a36b17294aa0348b7aecd22f6bf20d7827bf4`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c38139d4141f4d13628f0787dca602e48a0b0bf54c09489372400f9380740b17`  
		Last Modified: Wed, 01 Jun 2022 03:31:39 GMT  
		Size: 143.3 MB (143284761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:444ebd8fa713235a88570b21c61cfa76d1c708577186db7715e4fdf2942208c8`  
		Last Modified: Wed, 01 Jun 2022 03:30:00 GMT  
		Size: 3.0 KB (2965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3acae1eb95cc2bca2b6543c7ea4682fab5cfb849170b7c1b2491492483c1243`  
		Last Modified: Wed, 01 Jun 2022 03:30:00 GMT  
...
```console
$ docker pull nextcloud@sha256:7b20f9299325eda6ca061d3b9d66b6fa8370d4ddfda0a9af2cb1337f81ffa63c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.2 MB (293166758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1293c797216dc898b344e521f2e7e5d4ea3cd1c2564463bf0b7df1356fce663`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 30 May 2022 05:20:42 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Mon, 30 May 2022 05:22:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 30 May 2022 05:22:17 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Mon, 30 May 2022 05:22:19 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Mon, 30 May 2022 05:22:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 30 May 2022 05:22:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2d01cfdd25bec459d20c9fcc4a9d87af5e006b9218546f5b357c142ca6fa5fb6`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e88fec6eb76e70eddb105ae6e6cc258b478ece0901dfdacd0354d467da1026f`  
		Last Modified: Mon, 30 May 2022 05:45:00 GMT  
		Size: 143.3 MB (143284824 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5012058d8cff8cfc38d8db3f7102dec215719b67892679c3653e8f37c9f490a`  
		Last Modified: Mon, 30 May 2022 05:43:23 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:679b4546388d03ed14f9b9b060facd0d0dbfcddf4c8d41d59279cebde5d6181b`  
		Last Modified: Mon, 30 May 2022 05:43:23 GMT  
...
```console
$ docker pull nextcloud@sha256:52fecadf821a075fd10328d962af7720312245909af52178658f7fa3389be79d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.4 MB (316419558 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99095295b725047bcc8ab80fb73c366b74ac1a8d776dfeed7c930dd2fe45f225`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 07 Jun 2022 04:13:55 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Tue, 07 Jun 2022 04:14:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 07 Jun 2022 04:14:38 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
...
-	Layers:
	...
	-	`sha256:8d0467c58b1a88a8692d45ce7feb160c1695085deed384affed1fe0687b8bcae`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fca5bdacafc8e11bd3352f597406bb400c05426148dc6fba96cf4bddd6a8cbc5`  
		Last Modified: Tue, 07 Jun 2022 04:19:31 GMT  
		Size: 143.0 MB (143045553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0aaf0dc6a1fc0d642ee3abec092f37f3e0722cb267bb371bbe4f5d782046c50e`  
		Last Modified: Tue, 07 Jun 2022 04:19:11 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c0cf901a769c21d1e723da84260a6e2e7108b287c7238771c9e1a4e1628285`  
		Last Modified: Tue, 07 Jun 2022 04:19:11 GMT  
...
```console
$ docker pull nextcloud@sha256:fad3d0cdaf9fcb0b3ed16bf92d5a9a6f5bb5db092b567eeed6da4303a097535b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.8 MB (300843747 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02be35954ffc4c87aebdb7832184ee8ac97c7f2e04254822071dc6575e32d367`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 30 May 2022 07:36:36 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Mon, 30 May 2022 07:39:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 30 May 2022 07:39:19 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Mon, 30 May 2022 07:39:28 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Mon, 30 May 2022 07:39:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 30 May 2022 07:39:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:864ad584a69e0ef8e39b185f46458354640b3d39939dc4f0d0f3db8f2e79a666`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a24d56e47b0b23cdca20b30cb9401bb11f337b7f601c8ffd0af592839e09df1`  
		Last Modified: Mon, 30 May 2022 08:11:23 GMT  
		Size: 143.0 MB (143046616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e191700ad1d757ef74bdf05543a230cac640ccb0440721dc57696f1610bbbda`  
		Last Modified: Mon, 30 May 2022 08:09:48 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faa69a90d773e4258b7347016f7069cb4f751bf0b9fa4da2ec8d03be2b2ab358`  
		Last Modified: Mon, 30 May 2022 08:09:48 GMT  
		Size: 2.2 KB (2205 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
