...
```console
$ docker pull nextcloud@sha256:326c3e526a2b57d9b697aa55be938989e62b3bb77dcb4819fddf6d22f98290a3
```
...
```console
$ docker pull nextcloud@sha256:ee6b2654f6992ec6c2f5eec47b3d90a47f879485c0187a2b4525b7433f2beec7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.6 MB (326608909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7dbeeca208737658bef9170cc1c2f9271e335060a15e796ae05d8e55d5e9715`
...
-	Layers:
	...
	-	`sha256:27a9a5e73403915e71b61a14c8e39af96afcbfcc26322607af272b0847c09708`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b63e145c2a4bfbfad2c64cdce763153ba25ec2db1826b4f30ad3a06c62d30c9`  
		Last Modified: Fri, 20 May 2022 21:36:25 GMT  
		Size: 143.3 MB (143285875 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2950c8a5bc9db909dd50a9036c2ebdb369733f8ede66e331a1cdb32fe87712fc`  
		Last Modified: Fri, 20 May 2022 21:36:06 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a8b03aab27cfc55bb265aad15317581c1969ea28eb95cd218dc72f7b6937692`  
		Last Modified: Fri, 20 May 2022 21:36:06 GMT  
...
```console
$ docker pull nextcloud@sha256:3cc4fe9f0494efe656d47942b991458877adbbee3b6f4568959cb0900f2eb2bf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.6 MB (327629731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3653d2ffffa5ff508dfc4a0bce58bbd248c694eca524e0f3c6fa673f01c11cd1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 May 2022 20:38:45 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Fri, 20 May 2022 20:39:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 May 2022 20:39:34 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 20 May 2022 20:39:35 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 20 May 2022 20:39:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 May 2022 20:39:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7f4bfc629c523f77fbe6949b29c3b3956369563886e5bbf5a3c756dd58f2153d`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba362eaeba738e794dc3e7e6159105ebd1db20fc427f1fd4b785918ad83b4f80`  
		Last Modified: Fri, 20 May 2022 20:49:55 GMT  
		Size: 143.0 MB (143045461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780f2d59c92b69b68a63c2c3a1ddcb79bee371bdbb3c56395db191e6b04bb92a`  
		Last Modified: Fri, 20 May 2022 20:49:37 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc2ccff98f91b5d1aad3b5bcc1f44a445c87b91a7c01b49e5bf00c163770909`  
		Last Modified: Fri, 20 May 2022 20:49:37 GMT  
...
```console
$ docker pull nextcloud@sha256:c650eda73697e95c6d305a0504cb71bda53e95975911a242e8ecddfafc2e0df3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.8 MB (326798967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2bfbad6889e86ef36c89ac17c8700bd5efe4182f82e9b0a485082fb5e6706f6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 May 2022 21:51:01 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Fri, 20 May 2022 21:53:30 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 May 2022 21:53:36 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 20 May 2022 21:53:39 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 20 May 2022 21:53:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 May 2022 21:53:43 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1f2f5da07ab640e7a9dea90288123685347cd8990ad6583c3d44dd84d29440eb`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2df0aeaabde12400aa99956155228dd47fe3e91cc58300c5e7c932e95c62204`  
		Last Modified: Fri, 20 May 2022 22:18:20 GMT  
		Size: 143.3 MB (143289248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:553f5ff33e61eacd1dbc57c4163a666ddd6477291b0cf9c131dd3d89776a7a67`  
		Last Modified: Fri, 20 May 2022 22:16:15 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ca348efffa281e4a5c12e9f4da0b14c93ed26c4015e388d007003f05279b11d`  
		Last Modified: Fri, 20 May 2022 22:16:15 GMT  
...
```console
$ docker pull nextcloud@sha256:695fc4d8bbd8106589ff8f82c97314dbbe1009e2867f2892c6a143eba5886a4c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.4 MB (301378726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7e390e542ad860294afcd710e37daa83a333df62649b6d3ff58944f0f46bba2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 May 2022 20:58:54 GMT
ENV NEXTCLOUD_VERSION=22.2.8
# Fri, 20 May 2022 21:00:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 May 2022 21:00:59 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 20 May 2022 21:01:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 20 May 2022 21:01:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 May 2022 21:01:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3cc3edd6248a799c344d59eae6229d2a2a5afa96f6580be9900813606f03799b`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78207c0e1ab2ababc6e04eaca5febf48b4294160c6ae3e46b282c4c33a2fbfc3`  
		Last Modified: Fri, 20 May 2022 21:15:42 GMT  
		Size: 143.3 MB (143284595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60349ecd1e61079cce25fd78e414fa461240bf328b552e54fd1064f4d4e07bc`  
		Last Modified: Fri, 20 May 2022 21:15:26 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e20e02bd6da6684ca33728c8776380b2345f62a5cdca1f04276fb8db8eddbc`  
		Last Modified: Fri, 20 May 2022 21:15:26 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
