...
```console
$ docker pull nextcloud@sha256:2c504be21e786f9af9a5167f3875234d7658603db9f666638c757d5e33402213
```
...
```console
$ docker pull nextcloud@sha256:3df98784f91dba50b992d2d3bdb143c2a766e7a6dd34d35974f55a0837ebb62b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.7 MB (339671172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4efc25834aa234ff895fc7a382e73678b334b27a29df3d33ebf2b1e2ff6c96e4`
...
-	Layers:
	...
	-	`sha256:67ac64d450c282ffd5b99d5e42472e6d9d3350c40e3941d24b604c345735ba84`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a061dafa2327e265df4f334cfa7d10ff8f91642e393306f20cf58fc29e4124ab`  
		Last Modified: Sat, 04 Mar 2023 04:33:53 GMT  
		Size: 19.5 MB (19481922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3a49522856456fd3b63aef4aadd0e813ef32d851450570bda155db6c41ad8e`  
		Last Modified: Sat, 04 Mar 2023 04:33:49 GMT  
		Size: 4.2 MB (4158938 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:843245186fac191a5e09b3e4164503414e29d620816d845a8124c996976dba08`  
		Last Modified: Sat, 04 Mar 2023 04:33:48 GMT  
		Size: 622.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c90061170dd601d38d47ae1f31039923bfe317c87a5c1c1a90db0dfab3cb7425`  
		Last Modified: Sat, 04 Mar 2023 04:34:08 GMT  
		Size: 155.9 MB (155874552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1ea9459a24af56887106d2e3cd369adf8c2cf13164dce597379813d9eba4d99`  
		Last Modified: Sat, 04 Mar 2023 04:33:48 GMT  
		Size: 3.2 KB (3240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ed49c40a99053fcd50ebf57df56ff2bc47651384a17ac9fd8f1936526853d7a`  
		Last Modified: Sat, 04 Mar 2023 04:33:48 GMT  
...
```console
$ docker pull nextcloud@sha256:83e01d3f8f4215ccf46f74718b9c9cacc6b644361982dadfcbfe3d120cb3eee8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.0 MB (306020114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:620ee37a3a294e253d86a9a1192cfba38e3d64a2a9717322706b5663f1f3676e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:09:39 GMT
CMD ["php-fpm"]
# Sat, 04 Mar 2023 04:02:04 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common         libmagickcore-6.q16-6-extra     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 04 Mar 2023 04:02:05 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 04 Mar 2023 04:02:05 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 04 Mar 2023 04:04:18 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 04:04:19 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 04 Mar 2023 04:04:19 GMT
VOLUME [/var/www/html]
# Sat, 04 Mar 2023 04:04:19 GMT
ENV NEXTCLOUD_VERSION=23.0.12
# Sat, 04 Mar 2023 04:05:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 04:05:16 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 04:05:16 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 04:05:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 04 Mar 2023 04:05:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bb3200ec274778d9d9af1976c8be821f6c6f6823263f02f141ea3dbef3e2cfec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6eecb725dfa564bbb6db69b65a33309cc9a313e49d8ba128c027769b345f4f59`  
		Last Modified: Sat, 04 Mar 2023 04:18:55 GMT  
		Size: 15.9 MB (15869134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63c7d5b694319c646999d6b9e9a50bfd0f00abbc7541979ef5473165dd133dc`  
		Last Modified: Sat, 04 Mar 2023 04:18:51 GMT  
		Size: 3.5 MB (3487601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7c9dcb2d4d411513910ada5bbd5d448bbfe5ee53567984a87c7d20040adf0d8`  
		Last Modified: Sat, 04 Mar 2023 04:18:51 GMT  
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbe89387cf1d40c3e7c93411e8ecb991e73113756e3c45fc20599c94ce0118b9`  
		Last Modified: Sat, 04 Mar 2023 04:19:15 GMT  
		Size: 155.9 MB (155872616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18ee3df1d74dc1a837586797240a8c1e902970e8d8c950b30084685540df68fc`  
		Last Modified: Sat, 04 Mar 2023 04:18:51 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52cea8b34467eb7d2bbd724c409fec76221bec051a834513d1176da6be549cd1`  
		Last Modified: Sat, 04 Mar 2023 04:18:51 GMT  
...
```console
$ docker pull nextcloud@sha256:cdf8f33ca9d79d58ab3342574d2f5207048ac30dfa493c380c394f44f5952fce
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.3 MB (330345853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28584e1f99b076bf0b07c8c1efd8a7673da9066deb902bb76470a2c40dd22d38`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:05:10 GMT
CMD ["php-fpm"]
# Sat, 04 Mar 2023 03:45:07 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common         libmagickcore-6.q16-6-extra     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 04 Mar 2023 03:45:07 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 04 Mar 2023 03:45:07 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 04 Mar 2023 03:46:59 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 03:47:00 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 04 Mar 2023 03:47:00 GMT
VOLUME [/var/www/html]
# Sat, 04 Mar 2023 03:47:00 GMT
ENV NEXTCLOUD_VERSION=23.0.12
# Sat, 04 Mar 2023 03:47:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 03:47:48 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 03:47:48 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 03:47:48 GMT
...
-	Layers:
	...
	-	`sha256:2f9b38d0bb2f96e80ccfb176bd06b1cc522ee5f372ac3c213c36e7538be28a93`  
		...
		Size: 8.7 KB (8728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a94a1e6906eb63454f3a5d84f1d4f87d29e40199512ab8a7afaf8b75f5a81fe3`  
		Last Modified: Sat, 04 Mar 2023 04:00:57 GMT  
		Size: 17.2 MB (17187584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cc163ba2e3019c5bff4b6fdf2b4c6e629c79179dd8708fb11ac4df6d34d3377`  
		Last Modified: Sat, 04 Mar 2023 04:00:54 GMT  
		Size: 3.8 MB (3760299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dee639f1d60b1a1cf38f7e605eabb561891bc90797780eb1faca48fbdabbf43e`  
		Last Modified: Sat, 04 Mar 2023 04:00:53 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b6ac026f00b4c4239a0e42daaadf350a72371bf39826778472426d222cdcb77`  
		Last Modified: Sat, 04 Mar 2023 04:01:09 GMT  
		Size: 155.9 MB (155873663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b9cdcb978294a3375d22bacbbc52bd070f4ae18b38ec9f7a1fe3417bdcef746`  
		Last Modified: Sat, 04 Mar 2023 04:00:53 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:568e7416aa0fda1777e5c230d5dafb7f259d936ebd372c4e8a845f361185bdde`  
		Last Modified: Sat, 04 Mar 2023 04:00:53 GMT  
		Size: 2.2 KB (2156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2cc9da2a4bc15ef96b6edac17b694f2745732edea5d8823d564294e4c4623d2f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.7 MB (341745897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01c5b5d6133dfd054b7c2c5e7468b06b1f590f7ac2b47c7d5fdd168406c97af3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 04:15:27 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 04 Mar 2023 04:15:28 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 04 Mar 2023 04:18:10 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 04:18:11 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 04 Mar 2023 04:18:11 GMT
VOLUME [/var/www/html]
# Sat, 04 Mar 2023 04:18:11 GMT
ENV NEXTCLOUD_VERSION=23.0.12
# Sat, 04 Mar 2023 04:19:07 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 04:19:10 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 04:19:10 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 04:19:10 GMT
...
-	Layers:
	...
	-	`sha256:3c4ba1ade17b4733b6f3a140b9a38672a56155b1614b76e57fe97252e29d3243`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c30e83ede3e2553fb23aee5527d05c1a32ef2e5770338188cd57ff2f0004519f`  
		Last Modified: Sat, 04 Mar 2023 04:36:08 GMT  
		Size: 19.1 MB (19085882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:098e08ddc2fb7dd22e46501c3505ed12428726d68dd88438b8338d0fd282f3c7`  
		Last Modified: Sat, 04 Mar 2023 04:36:03 GMT  
		Size: 4.1 MB (4109729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68b9c983b2364448744936704bfc7d4f94ae3b35ec0346081f8cf9cbfe32cf67`  
		Last Modified: Sat, 04 Mar 2023 04:36:02 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6fa468079f9348e09cdf381a290e8266fbdf4db20730f6603a82b08af239518`  
		Last Modified: Sat, 04 Mar 2023 04:36:31 GMT  
		Size: 155.9 MB (155873496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a1f21c653c7dd94222f58a15671f8cbeff8482188b2cdaeb74bf88db35556bb`  
		Last Modified: Sat, 04 Mar 2023 04:36:02 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b59bb32d0170c0a9ced9e1edfb3db7cd043db567fcf9b22a6ba1741ea47b783e`  
		Last Modified: Sat, 04 Mar 2023 04:36:02 GMT  
...
```console
$ docker pull nextcloud@sha256:3d872d4d5356a27ced521fd3971afd47d9d5911b62c8308a013a735a08a5c227
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.3 MB (314277794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:834dfcba9003c4ca98b7d49aab9e782c38688105414e13daa0cb817c9824238a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 01:03:27 GMT
CMD ["php-fpm"]
# Sat, 04 Mar 2023 02:51:30 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common         libmagickcore-6.q16-6-extra     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 04 Mar 2023 02:51:32 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 04 Mar 2023 02:51:32 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 04 Mar 2023 02:53:02 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 02:53:02 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 04 Mar 2023 02:53:02 GMT
...
ENV NEXTCLOUD_VERSION=23.0.12
# Sat, 04 Mar 2023 02:53:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Mar 2023 02:53:48 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 02:53:49 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 02:53:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 04 Mar 2023 02:53:49 GMT
...
-	Layers:
	...
	-	`sha256:a5c279739ab8137ab1576fe3c6b1cd8e53c356752e66aba9cf941f46cf798cd9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60d5cd14123d6e1d67be5a7938c00ab96e658265e587fe8638c717a0fc4f2632`  
		Last Modified: Sat, 04 Mar 2023 03:05:53 GMT  
		Size: 17.2 MB (17163390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34016ccead6fdf0b42962b7c48f04d72f285373aba65f8a105df33faee16da4d`  
		Last Modified: Sat, 04 Mar 2023 03:05:50 GMT  
		Size: 3.8 MB (3787579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfa2dd58a0d2e8ba111a9abc75188d7c5e9a5999cc5e17b69b3ace8d2f670593`  
		Last Modified: Sat, 04 Mar 2023 03:05:50 GMT  
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14b47fe1661d0e7a2d888087535786cba6811fb412ae3899b84eb7c3abd0ad76`  
		Last Modified: Sat, 04 Mar 2023 03:06:08 GMT  
		Size: 155.9 MB (155872815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42eba3dc3fa3b699119add9a8a091304dbc4615e5ca8278a9093c3336c9ae896`  
		Last Modified: Sat, 04 Mar 2023 03:05:50 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fca1b9731f37aad35225c1e931b9ad9f9d57064370d469a79227c0b87a4a7767`  
		Last Modified: Sat, 04 Mar 2023 03:05:50 GMT  
