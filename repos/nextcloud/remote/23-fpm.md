...
```console
$ docker pull nextcloud@sha256:86b7fa649fda818bbef2402734eb7710acd29402300a10029846de58d7cad95a
```
...
```console
$ docker pull nextcloud@sha256:f3b0bf5b6468eec2ffc7eff902b7cb85498b0ce82086c55bf7a8690f6598461a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.2 MB (315191389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad5b08bac39e4272608b19e83f9b2df4ccf2bc8de7c80543f6f05fa05f4d1130`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Mar 2023 14:59:05 GMT
ENV NEXTCLOUD_VERSION=23.0.12
# Wed, 01 Mar 2023 15:00:01 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 15:00:05 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
...
-	Layers:
	...
	-	`sha256:7e422587fe530d86a40e81d700a17d423acdee0befdc531b5a3afd36be7e064d`  
		...
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b192599afb2ffd250e16f9d290a06a4c4e44b0ac771cc7e747380885429e77c1`  
		Last Modified: Wed, 01 Mar 2023 15:13:20 GMT  
		Size: 155.9 MB (155872393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fa4ed171da474cf5e7dc35f95bc2d528781314ba1265c67ab5394e414415d4b`  
		Last Modified: Wed, 01 Mar 2023 15:12:55 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9533be42122cb5897b7a08adb67a867515494c20b3e737807efb6e983147cac9`  
		Last Modified: Wed, 01 Mar 2023 15:12:55 GMT  
...
```console
$ docker pull nextcloud@sha256:7ebe26fb7ee4db9fd78eb39de999ff086ad9890a45786f5897dad5d7600c7177
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.8 MB (313776454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64cba29894908b480e2b193dae99b17752c63f8c035c63133800f6d707f64b1d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 04:31:50 GMT
ENV NEXTCLOUD_VERSION=23.0.12
# Fri, 24 Feb 2023 04:35:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 24 Feb 2023 04:35:53 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 24 Feb 2023 04:36:02 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 24 Feb 2023 04:36:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Feb 2023 04:36:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:027d8bfbabfa326bef71a2dd355fa51a42efe086a1e952af3a84d6edbae2fd1c`  
		...
		Size: 588.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c6744ff4d2836cdee5688729f838d33992a24587aff4256da0c5380855b5c6`  
		Last Modified: Fri, 24 Feb 2023 05:02:32 GMT  
		Size: 155.6 MB (155634774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a086f6ec9df9c2ac4c9e97f69562c638a495f9d02289b6ef1b7ec7b06e243a1a`  
		Last Modified: Fri, 24 Feb 2023 05:00:54 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff9435a2c666eede84cef2af887de661b8092eeffc194270702e3e58c3f3eac9`  
		Last Modified: Fri, 24 Feb 2023 05:00:54 GMT  
