...
```console
$ docker pull nextcloud@sha256:34a24744d82cd8150e347344e6040d881f5a72ca8d8555806d380846d2e0e2ea
```
...
```console
$ docker pull nextcloud@sha256:0f133654e79b377c58e8a359df3ed5a1e22ffb0d8b2c348d36407976e6a55029
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.3 MB (310344538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc63715b5ecccc230425d2e256f4905aad84c6c754a278e58f99e0e5a2a0f1e7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 15 Nov 2022 12:33:51 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Tue, 15 Nov 2022 12:34:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 12:34:42 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 12:34:42 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 12:34:42 GMT
...
-	Layers:
	...
	-	`sha256:e55a26e064b04cad4ac50cf2235a9927fcd5f3e1ff334be673508a3501d6f81d`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a41d5801d5dea19bea0cd95bccf94d1e40b89e915c46f410a47f3fda105b1ae`  
		Last Modified: Tue, 15 Nov 2022 12:48:32 GMT  
		Size: 155.1 MB (155134160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d7c84af99ec410699b97fc2fe3f69770ec9a2bd5534566cb049e27e4e596e3b`  
		Last Modified: Tue, 15 Nov 2022 12:48:03 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef82e3fae21bd3e972de9f0d3369b217610416b3c062dfb93b0985d303bb2920`  
		Last Modified: Tue, 15 Nov 2022 12:48:04 GMT  
...
```console
$ docker pull nextcloud@sha256:a332895f17bbb4cfe37b38097627761c7c66187120d73db02fadef5643f1174a
```
...
-	Total Size: **325.5 MB (325477605 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa1d551862db53b9c1c8eb5d53dee02bf23d88555ffe5d7d768dac4fe323c0ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:77b4c6756aa344ca6eef848414b23ec0f0bb53aba3dfec6e18058db2730db7b8`  
		...
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6de77263576e86d683ccb6102f22d3d06898e00821ad665987daeb9965a1a02c`  
		Last Modified: Tue, 15 Nov 2022 17:48:51 GMT  
		Size: 155.1 MB (155135549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4555f30049643daf4ec180652622e3cc38fb2ca04f14967510cbc26f89c9b4a7`  
		Last Modified: Tue, 15 Nov 2022 17:48:35 GMT  
		Size: 3.3 KB (3255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:061e9b895a6f31a8dfab50b44cb4efe188dd82937bef2e2e164c384a9e7e8362`  
		Last Modified: Tue, 15 Nov 2022 17:48:35 GMT  
...
```console
$ docker pull nextcloud@sha256:0cb1b68acb517c8c88259e4a7eaa72c06da00931f0190cf8a03f823ae3435ea5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.3 MB (335323268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd6ac53e80e5508d47b85b5c791e25aeef377c0f0f026cad8d197dffa14a7a68`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 16 Nov 2022 22:10:19 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Wed, 16 Nov 2022 22:11:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 16 Nov 2022 22:11:12 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Wed, 16 Nov 2022 22:11:13 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Wed, 16 Nov 2022 22:11:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 16 Nov 2022 22:11:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f60f215c46fd090edabb46accd972de45d3769914c5959d789f60517970eccac`  
		...
		Size: 570.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d9269e4a415a49ad9c67f810d9045a22c3db812d9bc1f18c2f4cc94631dfbd5`  
		Last Modified: Wed, 16 Nov 2022 22:15:00 GMT  
		Size: 154.9 MB (154896283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89135fe56524ea30842a4e7a335938f12a978aa937da09a50716c6f176b82f82`  
		Last Modified: Wed, 16 Nov 2022 22:14:39 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bce69d4127f38422199b1280ed8496465772dd75ccc83ef3a18effaab7d799f7`  
		Last Modified: Wed, 16 Nov 2022 22:14:39 GMT  
...
```console
$ docker pull nextcloud@sha256:c623ae443e9df0ad125e1fe2693f9a1cb39a51d41055bf746610f38b4a42a77f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.9 MB (308914222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76cc14e23efaca88123af6c311b5c6625298db7ef974431c865a80781ef81480`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 16 Nov 2022 08:41:18 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Wed, 16 Nov 2022 08:44:03 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 16 Nov 2022 08:44:13 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Wed, 16 Nov 2022 08:44:22 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Wed, 16 Nov 2022 08:44:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 16 Nov 2022 08:44:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8a3cb8589eef1ec3818c6116dfb6ead3dd4b9d4f1bf242abf290e2068e71dbf6`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b408e159a1fda4266902a7db938e527182f8a507137b3e47933d1888fa4b6c6c`  
		Last Modified: Wed, 16 Nov 2022 09:26:27 GMT  
		Size: 154.9 MB (154896068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7f619b70441353bd8711aeb2b9f275cf0230f4171f1041f41299a9358aa0427`  
		Last Modified: Wed, 16 Nov 2022 09:24:40 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6685d1d585ba86981fcb380cc7d7998ba67c7ace354f807f6aff938d25ca3062`  
		Last Modified: Wed, 16 Nov 2022 09:24:40 GMT  
