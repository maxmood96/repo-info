...
```console
$ docker pull nextcloud@sha256:e43138ebd4f29d8daa7eb94e518518d08f5060fe595bcc74e5e5cbcf415cc62b
```
...
```console
$ docker pull nextcloud@sha256:d399c494a3c965e902ae5f5d3abf83d74c316c83cdbdb169effbedb45dfb4fc5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.8 MB (333804047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5040bf769b6d04de966455b25979496d598e3e3cadb085953b7a15d2077a4f2c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=23.0.3
# Thu, 21 Apr 2022 00:27:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 00:27:47 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 21 Apr 2022 00:27:48 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 21 Apr 2022 00:27:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Apr 2022 00:27:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cc86c0e4edd5ab01c3e70c1d08683ea133a892c5a62683985ce62135e2169b2b`  
		...
		Size: 570.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f481c1dd46653aa7a6d9be9b974e479af1ada7ef264a1edd9697dc770780e23`  
		Last Modified: Thu, 21 Apr 2022 00:32:21 GMT  
		Size: 153.2 MB (153227044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0baf5ad536a6ee4fc879b21da1935dcb4d1e82a0423cffaaf92b1fd939d5457e`  
		Last Modified: Thu, 21 Apr 2022 00:32:00 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed6be4ff49ea62231a247a74cb44d26be66fd679c17c12aa71fc040c66805407`  
		Last Modified: Thu, 21 Apr 2022 00:32:00 GMT  
...
```console
$ docker pull nextcloud@sha256:f2093bf8da23779343a8a5bce80af50e893559c33567e6f746874f37aea68f03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.6 MB (332618222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d391b17246de4d77600e212428a9f6eb37971d68145f8f214f5a93c194437df`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 22 Apr 2022 05:07:29 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Fri, 22 Apr 2022 05:09:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 05:09:20 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 22 Apr 2022 05:09:22 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 22 Apr 2022 05:09:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:c2d806f830f79155eca5c7399faf61888be3affae695cd9320fa5a0ad627a852`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8535240c4631a0aaf61ef8fd2ac8f1ee7b2f80d47accf85edb2767a8842048a2`  
		Last Modified: Fri, 22 Apr 2022 05:14:56 GMT  
		Size: 153.5 MB (153469141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70c9a6b27c09b6ca471a9720ccd5f430adfcdc8a0dcd922d4831614eea01ef37`  
		Last Modified: Fri, 22 Apr 2022 05:14:30 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faba2d79e1817eed92ea995f473e88d37dccb3dff2efcb7847796c6a3e731eb8`  
		Last Modified: Fri, 22 Apr 2022 05:14:30 GMT  
...
```console
$ docker pull nextcloud@sha256:003633acded91b6413471ce424d2b69c9df8b1e8d86fe614b0c984efcf76a744
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.9 MB (307875286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbe6c483878d5534c5e366f25b82063c5f532b7bc8f1dd104222c7bcb2d68670`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Apr 2022 12:24:54 GMT
VOLUME [/var/www/html]
# Thu, 21 Apr 2022 12:27:10 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Thu, 21 Apr 2022 12:27:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 12:28:00 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 21 Apr 2022 12:28:01 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 21 Apr 2022 12:28:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Apr 2022 12:28:01 GMT
...
-	Layers:
	...
	-	`sha256:f628e099ec30224d8fde5467e08d8f94caaa24bf5feceee46657875234bb9ed5`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4bc9edb23c5c9b9829a3bfce4e7ac252be6836fecc6ce95c34bb52c1be085b8`  
		Last Modified: Thu, 21 Apr 2022 12:31:29 GMT  
		Size: 153.5 MB (153465360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05f198be6d9df04a3d3a9dfa2c1eefc8b80627b1f25c16908832f149d14beb54`  
		Last Modified: Thu, 21 Apr 2022 12:31:12 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4c2d7dfc438fe53c3e1aef265aa0f434a7ca747f427f6308a69e89e089f8bf6`  
		Last Modified: Thu, 21 Apr 2022 12:31:12 GMT  
