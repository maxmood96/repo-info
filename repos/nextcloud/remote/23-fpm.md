...
```console
$ docker pull nextcloud@sha256:e64e93d5e496c64865c445a1c61bb443527531147565b8895246dd35f7a7de8d
```
...
```console
$ docker pull nextcloud@sha256:d543d0f664adf70b810e228ec010f0ed133ae532db9fdd91a1fba1c59b2603ea
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.8 MB (309815991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81c07b387193dec547285af6b6aa22b447e848b1962d49de08db11c0f9c88aa0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 21 Jan 2022 23:05:51 GMT
VOLUME [/var/www/html]
# Fri, 21 Jan 2022 23:08:14 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Fri, 21 Jan 2022 23:09:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 23:10:03 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 21 Jan 2022 23:10:05 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 21 Jan 2022 23:10:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 21 Jan 2022 23:10:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e90d9495d48f6b270352edb36301f6c6639b9b0436233f586722a7cfd248789e`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:402c0f2bf8bdbff37eba118890920c37c0ec30ceeb2713dc19d6406937be66ba`  
		Last Modified: Fri, 21 Jan 2022 23:17:07 GMT  
		Size: 151.3 MB (151293812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:543926e64f87f29a76f94ea61d05dcf6a4bd866d79361319aef4e7073594edeb`  
		Last Modified: Fri, 21 Jan 2022 23:15:25 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9c9f35f3e3d0e49b2bc88a74eacdf89a09ff36e61c2c990026710999a3209b9`  
		Last Modified: Fri, 21 Jan 2022 23:15:25 GMT  
...
```console
$ docker pull nextcloud@sha256:6703e1b73b7633d424e21dda59046f3c2c06f6041f572200d4ab9f04e5bc57ef
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.8 MB (300808198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21755a94a2427cc49d92ca50dd556ebe45a714384fe8c00f44c295e6cffb8d0b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 21 Jan 2022 00:28:14 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Fri, 21 Jan 2022 00:29:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 00:29:54 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 21 Jan 2022 00:29:56 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 21 Jan 2022 00:29:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 21 Jan 2022 00:29:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:701d338abe5447ace04f55ec058d8e0f15f00718c0ec973ab57cb3697b8b0f45`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:398538e9fba10da3c04c1b8287fe47377fca5f84ae59d21f387c32b495b48a42`  
		Last Modified: Fri, 21 Jan 2022 00:49:36 GMT  
		Size: 151.3 MB (151293688 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:535e7e316492d31b5d52f57547ab1d3caafaf62e821ad29800ac2abee3d27ebc`  
		Last Modified: Fri, 21 Jan 2022 00:47:55 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30cea8fd1deff22e5da03169576720e7f20a8a9fc7884e38db752bbee26b3b92`  
		Last Modified: Fri, 21 Jan 2022 00:47:55 GMT  
		Size: 2.1 KB (2141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:49f07198ef24f12edfdd816f22d6534ff39f1d510cabfb4c2fff748a0362497d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.3 MB (336269674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f14646f61448b9a038715d16db4f79f2ada76b4fac447b9d1f4da21ce9e161a7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 20 Jan 2022 20:07:08 GMT
CMD ["php-fpm"]
# Fri, 21 Jan 2022 00:20:33 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 21 Jan 2022 00:20:33 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 21 Jan 2022 00:20:33 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 21 Jan 2022 00:23:48 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 00:23:49 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 21 Jan 2022 00:23:49 GMT
VOLUME [/var/www/html]
# Fri, 21 Jan 2022 00:33:55 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Fri, 21 Jan 2022 00:34:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 21 Jan 2022 00:34:52 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 21 Jan 2022 00:34:53 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 21 Jan 2022 00:34:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 21 Jan 2022 00:34:53 GMT
...
-	Layers:
	...
	-	`sha256:cf3817e74ed57f082890652db547178fbd415b2a03c71032cc2093cdf693c740`  
		...
		Size: 8.6 KB (8577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12c24b353cffdc4da88eaebf8144a290460aeac45ee7a66c5e7305733df448e2`  
		Last Modified: Fri, 21 Jan 2022 00:42:46 GMT  
		Size: 1.7 MB (1705650 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:168fe662ea18607f9363d4edf6528d2a58c78203e4df63a80754cb06b8ad1fb1`  
		Last Modified: Fri, 21 Jan 2022 00:42:47 GMT  
		Size: 16.8 MB (16801078 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e9b65d374d117ddbadfdaf82cefe333aa014790fbf63477f7af4d043f9b9901`  
		Last Modified: Fri, 21 Jan 2022 00:42:42 GMT  
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f3b9bc4ad2bf7f700080febdfbaf3e401f08bf4cf60c86a1705f6a8942eb13a`  
		Last Modified: Fri, 21 Jan 2022 00:44:15 GMT  
		Size: 151.3 MB (151294413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fe79b2368f97ab88e6f271c541f15c2a728622739c648b58b163ce78b78eb13`  
		Last Modified: Fri, 21 Jan 2022 00:43:48 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cc9cfa7e6a39d94f93ca19863f07cb82071f721971825ceec74017c819c50a6`  
		Last Modified: Fri, 21 Jan 2022 00:43:48 GMT  
...
```console
$ docker pull nextcloud@sha256:df3ae4fbc23328377fb4b3bbedb20afaadbce974af25a1c8eb651fad9e2b554a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.6 MB (309570388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:078a3f70daae293a1115a693e108542137be15fb2bcd7232eb062ee20dad3dde`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 20 Jan 2022 22:12:44 GMT
VOLUME [/var/www/html]
# Thu, 20 Jan 2022 22:17:27 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Thu, 20 Jan 2022 22:19:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 20 Jan 2022 22:19:38 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 20 Jan 2022 22:19:39 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 20 Jan 2022 22:19:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Jan 2022 22:19:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b45a4d80919faa450a48b56b913a654c4417431f3b134820a0f5f8a0858963c4`  
		...
		Size: 566.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bc9e558648d68ed762de9b63fd9ccbd79427218a35c93e9d4334d58b61b1af9`  
		Last Modified: Thu, 20 Jan 2022 22:28:24 GMT  
		Size: 151.3 MB (151293637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:449f11a564e9d3f501e61cff587ad476d7b3a031ba0e23fcc957ecf9f0b4aad4`  
		Last Modified: Thu, 20 Jan 2022 22:26:47 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6f91c8205979a482355a21d1bbec5358e046490cb6c611fd9d9cbffbc9e6896`  
		Last Modified: Thu, 20 Jan 2022 22:26:47 GMT  
		Size: 2.1 KB (2137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
