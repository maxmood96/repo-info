...
```console
$ docker pull nextcloud@sha256:b1a717f1d6d3b5e9464bec85eab85e2e6f0b4250055d7b6dfc10706784738294
```
...
### `nextcloud:31.0.14-fpm-alpine` - linux; amd64
...
### `nextcloud:31.0.14-fpm-alpine` - unknown; unknown
...
### `nextcloud:31.0.14-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:31.0.14-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:31.0.14-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:31.0.14-fpm-alpine` - linux; 386
...
### `nextcloud:31.0.14-fpm-alpine` - linux; ppc64le
...
### `nextcloud:31.0.14-fpm-alpine` - linux; s390x
