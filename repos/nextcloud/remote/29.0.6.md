...
```console
$ docker pull nextcloud@sha256:22a417fee86ba756482c2585f5a2bef3f4fe7c7c2ddea68d8127cdc107fb05e4
```
...
### `nextcloud:29.0.6` - linux; arm variant v5
...
### `nextcloud:29.0.6` - linux; arm64 variant v8
...
### `nextcloud:29.0.6` - linux; mips64le
...
### `nextcloud:29.0.6` - linux; ppc64le
