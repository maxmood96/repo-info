...
```console
$ docker pull nextcloud@sha256:66ca0a880db629345a31e57a96de74d575a46a6687ddb5704833cb9802906432
```
...
```console
$ docker pull nextcloud@sha256:de1581355fe047a106c3bd616d61f4e56e7134ebc69b11b5d3852d29fb198167
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.4 MB (152445502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12636587531a0c4aaf815a98e60a9de349b9de6532a855db47aa15940288f9ef`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 10 Apr 2020 19:49:56 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta2
# Fri, 10 Apr 2020 19:50:50 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 10 Apr 2020 19:50:53 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
...
-	Layers:
	...
	-	`sha256:cfccfb33d84943d564a1e869376f253c063272ec87dbc3236429885bc24cc5af`  
		...
		Size: 526.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3f3282528371880bc7f7902fe39cfad09dbaa941112c28c0c5a066d3151b6df`  
		Last Modified: Fri, 10 Apr 2020 19:52:04 GMT  
		Size: 97.9 MB (97851784 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8794f6ed298cba39be2495aa5f286d27cab7e895f4a34ebe43c89c93f27b123f`  
		Last Modified: Fri, 10 Apr 2020 19:51:30 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ae5eabd1fc6ad5f0408ac6a5c0b9cd1c763f35db912ed1876cf4068c123a21f`  
		Last Modified: Fri, 10 Apr 2020 19:51:30 GMT  
...
```console
$ docker pull nextcloud@sha256:9ad1a4474d93c90f5b21ae7fe9cb256bfca8622fda8ac16476fe67d17bc7d770
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.6 MB (150611018 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a4f3fb442f8e7010e99dbda5a6bf199985fc8a558243d0cb5c989bc684dcd08`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 10 Apr 2020 19:59:47 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta2
# Fri, 10 Apr 2020 20:00:30 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 10 Apr 2020 20:00:33 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 10 Apr 2020 20:00:36 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Fri, 10 Apr 2020 20:00:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Apr 2020 20:00:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c48808220742e57009b2324def0ea4bd6ac8466b7959ff7f58a1ea2d94b28eea`  
		...
		Size: 525.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0ab570b6adecf250ec93bca4c2fbe4097de3056082d4727f91167ae0d15fa17`  
		Last Modified: Fri, 10 Apr 2020 20:04:08 GMT  
		Size: 97.9 MB (97851781 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5aa6ff9fae88cdd6bdfe4920c4234af79b516d4172ccb4c9166e858d5970bf7e`  
		Last Modified: Fri, 10 Apr 2020 20:03:34 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:909f07d16a217c9eedea2b043ec4b3c16138b537f46482fb77c9225e075f5fd7`  
		Last Modified: Fri, 10 Apr 2020 20:03:35 GMT  
...
```console
$ docker pull nextcloud@sha256:dc3000599e71641895b6a5c9ca394b6b7bb668c66328c55e5f728ca214d49886
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.0 MB (153977846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84405f25134c4f39a33edee48824a40a006d910f4f1fb182228debf1a2b9ea54`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 10 Apr 2020 19:54:45 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta2
# Fri, 10 Apr 2020 19:56:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 10 Apr 2020 19:56:26 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 10 Apr 2020 19:56:28 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Fri, 10 Apr 2020 19:56:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Apr 2020 19:56:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5efba24b7a6c0dbdb6a9435a219bfe6564fb795ab98735af0da30330e6b1ffdd`  
		...
		Size: 524.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f395fe1b93b36baf3d890a95aac57abaef3076bc35370d30b66bd43b7454ce6`  
		Last Modified: Fri, 10 Apr 2020 19:59:51 GMT  
		Size: 97.9 MB (97851742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3ff77a52c210f1c4d00461eed5bc4e7806ad716212ef27474d812bd918b62ac`  
		Last Modified: Fri, 10 Apr 2020 19:59:24 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f9f6f1ba720bc1aae78cd1010e7967bc9003916ef4d03bfac46d40fa16aeed`  
		Last Modified: Fri, 10 Apr 2020 19:59:24 GMT  
...
```console
$ docker pull nextcloud@sha256:4d37719077d82b653313b441b092f1a22fed036e3a26f9d7957c00f54343a98c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.4 MB (155429849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a34c56a78b3d635171bec3093c02d7fc823c1085d43b8d2f8a35ff23113ab66`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 24 Mar 2020 06:31:16 GMT
VOLUME [/var/www/html]
# Fri, 10 Apr 2020 19:39:54 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta2
# Fri, 10 Apr 2020 19:40:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 10 Apr 2020 19:40:23 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 10 Apr 2020 19:40:24 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Fri, 10 Apr 2020 19:40:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Apr 2020 19:40:24 GMT
...
-	Layers:
	...
	-	`sha256:3bfe96ab4ab88e333b8f0b914cec6da17a40b7dcb4e3e6f49c8709ce07a884be`  
		...
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07379d66270575998dd056905e5d7ebce71c62af23e8221e4b8a8b4741fb5bb1`  
		Last Modified: Fri, 10 Apr 2020 19:43:15 GMT  
		Size: 97.9 MB (97851873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31ab48bb31b049f0c3cbcdc92b297c06edbf7f7a4cbe0ba069a665456b15ef0d`  
		Last Modified: Fri, 10 Apr 2020 19:42:53 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6143354a702bb2986b31dcd60f073c8fbec1de837ebc4fd6022851f845cd400d`  
		Last Modified: Fri, 10 Apr 2020 19:42:53 GMT  
		Size: 1.3 KB (1253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
