...
```console
$ docker pull nextcloud@sha256:968478289c299c1d96adaaad90c66da7c4022c3a0b46c14ead9fb0639f364f16
```
...
### `nextcloud:30.0.14-fpm` - linux; arm variant v5
...
### `nextcloud:30.0.14-fpm` - linux; arm variant v7
...
### `nextcloud:30.0.14-fpm` - linux; arm64 variant v8
...
### `nextcloud:30.0.14-fpm` - linux; ppc64le
...
### `nextcloud:30.0.14-fpm` - linux; riscv64
...
### `nextcloud:30.0.14-fpm` - linux; s390x
