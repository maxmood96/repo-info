...
```console
$ docker pull nextcloud@sha256:39d9d58f3394425e5b0ca1fed5902a3073850e8d8c128f94c8cd8c968222dc4e
```
...
```console
$ docker pull nextcloud@sha256:063d77816bdbed87bc96299991831e48cd8138a17e3a013e882aaa6c5928ef2d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.6 MB (216597134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97fd18daed6fdae50c646080c3802baa774f8a9d86234dde542921f2777aff9f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 17 Apr 2020 12:06:29 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 12:07:26 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:07:38 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 12:07:40 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 12:07:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 12:07:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f355b5e3af3d222d49bcfd00a16aff697afd57a4ef241b8d6139764a498a44b6`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feded94006e82df965cfbf8352a2ddc9a489b3e973f41dedec879fdb4120aad8`  
		Last Modified: Fri, 17 Apr 2020 12:38:13 GMT  
		Size: 73.0 MB (73043707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bb5ecb0530e1a183e343d2b32f5eeb1a5eafcad43e178f6f2f3615b1269b947`  
		Last Modified: Fri, 17 Apr 2020 12:37:46 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c7f785ad5de267821b4de284e4ca22917373cef17e57f09d80a65250420c0ed`  
		Last Modified: Fri, 17 Apr 2020 12:37:46 GMT  
...
```console
$ docker pull nextcloud@sha256:e10257e2e29c8aa5077346d2917a0c49e9148be7813bf5760136869a29289879
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.8 MB (212780928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b2121fe8f05fd0048fae8a0f586da45ef8dd9debec07c605fad04166a10bfd1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Apr 2020 05:59:31 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 06:00:17 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 06:00:22 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 06:00:25 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 06:00:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 06:00:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d93d4cbc487921afa681f563a41d8ca9508fe62fd3625a77ef435d874c6ba0e4`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51b120530c6370a0da834dfb65bc38c277be33552f3b2a51063927f7ea3f94e4`  
		Last Modified: Fri, 17 Apr 2020 06:34:18 GMT  
		Size: 73.0 MB (73043518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3d3bb7f186d62a794cf2ec455633b45a792053936e1ed490455d7dcb57d25dd`  
		Last Modified: Fri, 17 Apr 2020 06:33:53 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e936114108e9ba68635be0d0ffe8962c51e5f1615d50558cb3a2a97aa47150f`  
		Last Modified: Fri, 17 Apr 2020 06:33:52 GMT  
...
```console
$ docker pull nextcloud@sha256:77ee4c17db278df62cab97cad439052f52d45601b4fc6ea07895a67e50744071
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.2 MB (230207631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:402650af507f1d4d2d0364f71fad088981da5823170c8910fcd0ac15cbcb0bdc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 08:05:26 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 08:05:30 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 08:05:32 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 08:05:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 08:05:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:807ae847ecdf4bcd324784da8267244dece9abca9136244ce0794353bf4b35d3`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a074f45ce0cb6987c7a2743f269412fbb230d87cfadd11f163f0cd06799248d`  
		Last Modified: Fri, 17 Apr 2020 08:51:08 GMT  
		Size: 73.0 MB (73045180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f61c9dd2e1b356e96082090d651b7e7de03956afa6e8cfbb430ce3215bd73dd`  
		Last Modified: Fri, 17 Apr 2020 08:50:33 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c15bcffb48106c1e5297a4ba596769e95129f4a846c5c0df0bf00db655ab0290`  
		Last Modified: Fri, 17 Apr 2020 08:50:34 GMT  
...
```console
$ docker pull nextcloud@sha256:0085b1e2d9fd364e39bda272e703cdb714ba28d608a61581e0d59fb94e347ffa
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.2 MB (245164691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:770ad64aa6aab0584916c2ad4a9b2bcfddbf39fc8def834060ac3ffcb523c9cd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 17 Apr 2020 14:29:10 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 14:29:42 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 14:29:43 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 14:29:44 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 14:29:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 14:29:44 GMT
...
-	Layers:
	...
	-	`sha256:ec12720e90bdc2ce4565f9e676d5091f1833e12ef81317270946fb708dc03a3b`  
		...
		Size: 541.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15cbeb2a07a20833f7ec38eb96dd25c474fb637b9976a6d0a0140821a2b76dac`  
		Last Modified: Fri, 17 Apr 2020 14:48:10 GMT  
		Size: 73.0 MB (73045291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be8f70ff63a293172ed48d36cabdeec2e509094948572c134d133b18bb182b0b`  
		Last Modified: Fri, 17 Apr 2020 14:47:25 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82a74993b1a9e4be50b8d861c6340ac734a7a7d2ff9c9943440bd5e8f033f53c`  
		Last Modified: Fri, 17 Apr 2020 14:47:25 GMT  
...
```console
$ docker pull nextcloud@sha256:d43aaef105f0549167aa864ba4d7dc17ff0ffd86957c7bc96aec13d9dc166aeb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.5 MB (251461751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebe6adb09f709f1d57b3526e46adbb760f752399580d44771cc76070063abb25`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 17 Apr 2020 10:14:08 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 10:15:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 10:15:59 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 10:16:02 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 10:16:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 10:16:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cfae1c58c0d11e05c03b81c382a6b4dabc04774ece134d293dfb9e863ed6ba4a`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a2bda9c28dc8a6a842d8c0d4217a2d98eb25c9357c046afaf4d625d68822db8`  
		Last Modified: Fri, 17 Apr 2020 10:54:41 GMT  
		Size: 73.0 MB (73047889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d22683e07dddcf7bb0ea926d9e97116232ebee50e5c43d018c5101c1aa95b32b`  
		Last Modified: Fri, 17 Apr 2020 10:53:43 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b6e1bf1d1dd3597ae2736b587ce5352a38b07ad0d82a2095419320b5579d16f`  
		Last Modified: Fri, 17 Apr 2020 10:53:44 GMT  
...
```console
$ docker pull nextcloud@sha256:1df6a6b6a90becb923124ad5fbbf7d4f1972f4bf26bba6e2edc7492de607d1dc
```
...
-	Total Size: **224.0 MB (224021155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:899532c620f054bcf9fadc65b5d246d4fd412c07f59c15aeeaa7ed70e2822329`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Apr 2020 12:04:49 GMT
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 17 Apr 2020 12:04:50 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 12:05:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:05:15 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 12:05:15 GMT
COPY multi:246fcf6732b48594cd6179c3083577f9bb876cfb2022ee8408ddd31c0eec582a in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 12:05:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 12:05:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:28f353e8dde4dfc0b9efb2152263488918160b0a1dcf974f9ad2b4ae93c08018`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a1c28d24efc797c9e9707e68fa3cf39f39ece8375c7640c76db6d762e27f756`  
		Last Modified: Fri, 17 Apr 2020 12:26:44 GMT  
		Size: 73.0 MB (73043459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1894c37c556b57087678cdba184f6d72753e961b9f8efda9a95515bb8e175373`  
		Last Modified: Fri, 17 Apr 2020 12:26:49 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8421b17f93735274aaba7d0c0127b12cc6ac36a7499efc081da808de4e671860`  
		Last Modified: Fri, 17 Apr 2020 12:26:49 GMT  
		Size: 1.3 KB (1304 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
