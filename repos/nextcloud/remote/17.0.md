...
```console
$ docker pull nextcloud@sha256:0da58ba6f743e6d67277fc71ff1e1eb3890fe77d817fb73b4b00fdc91dcec8d5
```
...
```console
$ docker pull nextcloud@sha256:15fb5265a8e5276d580807c8428ba0759cfb910b14638cf8a442122b02b97539
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.9 MB (216909117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16fcee42d52fa641f482d24ceba77335c93885d216c9cf20df78f878a200887c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Sep 2020 04:18:18 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Tue, 01 Sep 2020 04:19:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 04:20:08 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 04:21:03 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:393363a17f6e8dbadcab965d3e7583ef253d2860b9b63a85fea6456b067590e8`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:522c04fedb02b7b29d99bbc1f0d81947f5fcb22dcb1b70208ce000b1c502cfdf`  
		Last Modified: Tue, 01 Sep 2020 05:16:52 GMT  
		Size: 73.3 MB (73338469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21a5277c276d7aa1febd865c7602884ebd139d2ca8891767d2a35fa96a28f748`  
		Last Modified: Tue, 01 Sep 2020 05:16:27 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bea9a3f643082e255d05605dc25b51b9a67480575485e1a50eae287e1c6866d`  
		Last Modified: Tue, 01 Sep 2020 05:16:27 GMT  
...
```console
$ docker pull nextcloud@sha256:cee98bc5a8330b6baadb0764245952364b38337693de5bf6dd504e3935443492
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.1 MB (213060292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd952b92aebfb4f836c46173ad8c6be5a5bab486f5bdc1fe5dce4a50a2676d64`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 04:28:50 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 04:28:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 04:29:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a24f215c1f8f006b111492fbd0786273544e88263c7c8b8a7e902fa9d446898b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d5c5c99c56f7de497f9e544f2f732e7bb0029e21a307772f8dafe54eadc96dc`  
		Last Modified: Tue, 01 Sep 2020 04:56:26 GMT  
...
```console
$ docker pull nextcloud@sha256:efc8f7658baad6a5d6c5583f5bd8e85fcaed44879193fe8b88d69d8e13e1308a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221261332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:facfc9def9b892bde8faacb99c85fb5138849e6afd55b3f7ae8f3935d589544f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Sep 2020 06:15:21 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Tue, 01 Sep 2020 06:16:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 06:16:38 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 06:16:40 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 06:16:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 06:16:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:97935f4321e5123432517535f688dd942307fba21428ea54f786684aa09b99cd`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fcca644e603d3698f8f1409f70f1b2649f61565a4977713ceb2bfb8b2019bc9`  
		Last Modified: Tue, 01 Sep 2020 06:54:38 GMT  
		Size: 73.3 MB (73338130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7e05c0adef6e55060bd0be187c2fdb800d584bbf5c80ea3441a118c05cfca51`  
		Last Modified: Tue, 01 Sep 2020 06:53:45 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e82773b196204723a67591c7f567095ec8c33e4f4a2aa7609385ac7c1991a4b`  
		Last Modified: Tue, 01 Sep 2020 06:53:44 GMT  
		Size: 1.7 KB (1715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f38524949544a6f4282b2827fd06db0be529c08509f9807c24f9995bcbbae497
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.3 MB (224334477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11bc648974c99610c409c9ac025befbc91ce93f791776b1527824587d320a6a4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Sep 2020 01:00:14 GMT
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 08:39:04 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 01 Sep 2020 08:41:24 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     if [ ! -e /usr/include/gmp.h ]; then ln -s /usr/include/$debMultiarch/gmp.h /usr/include/gmp.h; fi;    docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure gmp --with-gmp="/usr/include/$debMultiarch";     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 08:41:26 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 01 Sep 2020 08:41:26 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 08:41:28 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Sep 2020 08:41:28 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Tue, 01 Sep 2020 08:41:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 08:42:02 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 08:42:03 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 08:42:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 08:42:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7b36cf1b251ea50bf9ef227bac1048a18ca281efb7fa2247f913c147869e77eb`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd5fec485f6d8722f298beec4a4afbac3070ee455bc92ec09cf67b75f8789aa1`  
		Last Modified: Tue, 01 Sep 2020 09:11:19 GMT  
		Size: 1.6 MB (1618174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99572b9e3f696c0d50abb23b625b67fc6e6e3e3fc955cf34e85c6ec89cecac31`  
		Last Modified: Tue, 01 Sep 2020 09:11:22 GMT  
		Size: 14.7 MB (14678466 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8590f3fd1645fdf347af6788f7f6415ef534035b9510010bdcab03d05c5cad7`  
		Last Modified: Tue, 01 Sep 2020 09:11:17 GMT  
		Size: 536.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9ddac8274da704b58791dc683668fb49d7298e1b35ad8c01f5481a3a438b5ed`  
		Last Modified: Tue, 01 Sep 2020 09:11:17 GMT  
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:825efcb8db4a095f9dda513c6890efb76dcfbe428fb825904af9d037d71c4dc3`  
		Last Modified: Tue, 01 Sep 2020 09:11:27 GMT  
		Size: 73.3 MB (73338097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9243e0fce5a7186ee1f38d4e0e7687a5dbc76e65c45a246cd5364337afb4664e`  
		Last Modified: Tue, 01 Sep 2020 09:11:17 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6099ad43bfb071b956598b27e52bf3fa1b72ec46beb7d592987af979b90fa6c`  
		Last Modified: Tue, 01 Sep 2020 09:11:17 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
