...
```console
$ docker pull nextcloud@sha256:4818794f3955050cc5ec80ae301cbb0029900fc482891b0cbc1373ea48fdeeb3
```
...
```console
$ docker pull nextcloud@sha256:16bf649f5949167d597f4a85bb7ec19922adf30883ab7910846e29834c3a4bc7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.6 MB (216595873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a6b4dd009b9dff448fc72c1709121f4f48464313277c65b9b39c88e32328593`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 23 Apr 2020 11:41:48 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Thu, 23 Apr 2020 11:42:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Apr 2020 11:42:51 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Thu, 23 Apr 2020 11:42:54 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Thu, 23 Apr 2020 11:42:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 23 Apr 2020 11:42:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c3767f5897e5b039d44f04375c3e1ee5f234e0818266ee1c9ab30ea0a60c6697`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e2af227180d614821759cffb2613c8d2dfa20b5799f9fa7517c8b7789782f3`  
		Last Modified: Thu, 23 Apr 2020 11:59:12 GMT  
		Size: 73.0 MB (73043410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f97ff1f66ff6c73a762a487d3cd6d5744b43a2ab1b8cb7205fdafd26b0ce06b`  
		Last Modified: Thu, 23 Apr 2020 11:58:48 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3f4619716f415941c761be60463ac4a6b780ca4c6063272f525e2e5089dc9c`  
		Last Modified: Thu, 23 Apr 2020 11:58:48 GMT  
		Size: 1.4 KB (1417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:d146601af184c48315d8dabeac496eb382f30cb5ecc2c2d401baf792305638ed
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.8 MB (212755940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:304b09693c42fb6c54f7ed1c9b95d0c704a04b8a8f098a578193a832287024e1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 20 Apr 2020 17:13:59 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Mon, 20 Apr 2020 17:14:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 20 Apr 2020 17:14:51 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 20 Apr 2020 17:14:54 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Mon, 20 Apr 2020 17:14:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 20 Apr 2020 17:14:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5ab1a271a60293f17f56a0236dd5cd9af54745188727a809db8feede5e5f142f`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29678cbc048fd83513a164e0d2428ea92ff0e101e0c2944b04f99a8718609a35`  
		Last Modified: Mon, 20 Apr 2020 17:29:35 GMT  
		Size: 73.0 MB (73043569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af2937fddecad69286d2d4fa28d4707f298a7e829c58e05858f1513c8e1d5d95`  
		Last Modified: Mon, 20 Apr 2020 17:29:08 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9c7dede46a4742042f9d14ffe6d5b74981f2fa0afaf796855e5c869668cbc74`  
		Last Modified: Mon, 20 Apr 2020 17:29:08 GMT  
...
```console
$ docker pull nextcloud@sha256:073e7e85e3732d2a0dfa55964ead47da1ad8a28d9003607c3548667b8166f6b6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.2 MB (230175126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a5d09ce61e021bccbc1fe71f13344e6ab7c685e2fa158d46ea8ea09b9b6fa57`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:7bdee629117ed7d204d523f59876f5483d8ec76bc684bf973c93f1cd1dbf2329`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780da499b373f2f4996b0da3c585cecbad976c867c1289bb353973710338e3ef`  
		Last Modified: Mon, 20 Apr 2020 17:04:56 GMT  
		Size: 73.0 MB (73045032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:093337438e67a810a57ef34d5ccea7a3213f33a147b4fb80bc687626d6e7319c`  
		Last Modified: Mon, 20 Apr 2020 17:04:35 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a76ea716fb090b9d5da972e00e70e6f3c343ca491df1cc5d63200a9fc736890`  
		Last Modified: Mon, 20 Apr 2020 17:04:35 GMT  
...
```console
$ docker pull nextcloud@sha256:15ea12a7d47dee8f66dc0c230a7afa376836b24b26f0e3d0f3f3dc35f2014f91
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.2 MB (245164922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10d447dc456c6a3bf45bc963beeffc2962c0079afdacc0537a5e6263b3986a0a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=17.0.5
# Mon, 20 Apr 2020 16:43:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 20 Apr 2020 16:43:56 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 20 Apr 2020 16:43:57 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Mon, 20 Apr 2020 16:43:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 20 Apr 2020 16:43:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:59ada89b9a8a9a5d4e17ef64b146fe525fda4472de2f4551e0b4c0dfa389b13c`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9c7e9910fb7730a2eb03c14ba86a0cac07df62ed831a6ae519a3a7f6eb0fe53`  
		Last Modified: Mon, 20 Apr 2020 16:53:39 GMT  
		Size: 73.0 MB (73045367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c70f09adcf7496e82f467502a89d71a680da252483194e4ff257bae2b1e6ed47`  
		Last Modified: Mon, 20 Apr 2020 16:53:16 GMT  
		Size: 2.6 KB (2554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f41d6ef88169908041484f04f958a7d9af139c1c9fb5ba8e417b833ec1311cd`  
		Last Modified: Mon, 20 Apr 2020 16:53:16 GMT  
		Size: 1.4 KB (1417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:0d301780be9c2968f5586acdb5178afb15e8427455040be7bc3ff46020c5df67
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.9 MB (220942610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5ec0dec7761db733d2b2ca8a3fa153d351c75188c7848762fab2dfa2fe4665c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 20 Apr 2020 20:54:35 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Mon, 20 Apr 2020 20:55:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 20 Apr 2020 20:55:56 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 20 Apr 2020 20:55:58 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Mon, 20 Apr 2020 20:55:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 20 Apr 2020 20:55:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:165cfc3107c5b72ec428fb2b378b022abf46bb77314cc31e900bc750d847dbe9`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18e038eae6c6120c6bd802d38e102c423b391a1bc66b50d89c97e2960f5a2004`  
		Last Modified: Mon, 20 Apr 2020 21:19:00 GMT  
		Size: 73.0 MB (73043325 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a88cd7b7c4d59fe388dca4e7dc319671b4067dedfc5c17801b84e1c9f32efaf`  
		Last Modified: Mon, 20 Apr 2020 21:18:02 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cafb04030f4e9aa25e4a490c27281b83a779514259b95470735ec409534b9d9`  
		Last Modified: Mon, 20 Apr 2020 21:18:02 GMT  
		Size: 1.4 KB (1418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:ad0652129ee1aa70887558660d510d996c648e8c4935793c06590c9c9b206147
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.4 MB (251420901 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8bff23427dfa2cc1c24c2e882ff834514e9c1e7c0635db317d44b64966b6edb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 20 Apr 2020 19:05:19 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Mon, 20 Apr 2020 19:15:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 20 Apr 2020 19:15:17 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 20 Apr 2020 19:15:19 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Mon, 20 Apr 2020 19:15:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 20 Apr 2020 19:15:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bdb3a49810c1d9c63b63d6b0486c52ade532e26f03150d36a72b4083dc5e7c4f`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ba4066f92b6b8a7af784a5d5336012f9c1bdeddf41833a52c262c7a9350b581`  
		Last Modified: Mon, 20 Apr 2020 20:39:41 GMT  
		Size: 73.0 MB (73048195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d11db45c51de6f263f5e6f140d7b5ceb305db42c01f559f27e68746e211f0e55`  
		Last Modified: Mon, 20 Apr 2020 20:38:31 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36f934186cdd60b9e9cab1f44d0c01d44d5df0a0c61872b222bc7709c41d74fc`  
		Last Modified: Mon, 20 Apr 2020 20:38:31 GMT  
...
```console
$ docker pull nextcloud@sha256:8e9198fa9605a7ef00d14e2b452a8191cbe390fb0ee35b89e72e1ec51a2ae717
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.0 MB (224021347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03e2bc879e14c1b199b514c308bbd77366d5d40a6d7667143433127c162e690a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Apr 2020 12:04:49 GMT
VOLUME [/var/www/html]
# Mon, 20 Apr 2020 16:44:15 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 20 Apr 2020 16:46:03 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Mon, 20 Apr 2020 16:46:25 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 20 Apr 2020 16:46:29 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 20 Apr 2020 16:46:30 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Mon, 20 Apr 2020 16:46:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 20 Apr 2020 16:46:30 GMT
...
-	Layers:
	...
	-	`sha256:f795c5b3249d5686e8941c77f4c446b36b5b21e1deda50ff8aac48b386ec2cc7`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c460eb8e82f47020f31be143f5070f95b3e6794ed7d34317d79164dc6de533b4`  
		Last Modified: Mon, 20 Apr 2020 16:53:55 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76f364257a03d2ba79534d8ea56652b3e8f343911b0e580f2b86f0f2c47b58ea`  
		Last Modified: Mon, 20 Apr 2020 16:55:25 GMT  
		Size: 73.0 MB (73043501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7863e65f8ab570e2867767f621898346b5bd7a7f4473fc540c4ef187022fd3b2`  
		Last Modified: Mon, 20 Apr 2020 16:55:31 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55afea509f28a80f7f0003a4a0cd116fa0940fb294648efcb5a1625844f90d63`  
		Last Modified: Mon, 20 Apr 2020 16:55:15 GMT  
		Size: 1.4 KB (1417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
