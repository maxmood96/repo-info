...
```console
$ docker pull nextcloud@sha256:be123f327f5bcf053d2bcba2b8c455dc7663c237a48f55e307d293fb075b85cf
```
...
```console
$ docker pull nextcloud@sha256:8ee8bef40424652898b0825d132f903a0cdb2cd44f29582607f4f123ddbc0f64
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.0 MB (240003229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc714673c099ad27325b997c6a299ebff5876f37208458fbdd6159477b572d15`
...
-	Layers:
	...
	-	`sha256:91bcfb6cb17ab00facd13a23166ae3ca7ce6673be0ed8e576baee97ddd2c5c9e`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa9b0fde80c8df3c8f0c005b00072ac96641eef28aa6a558f93abd8dc4f5583c`  
		Last Modified: Fri, 24 Apr 2020 12:12:11 GMT  
		Size: 73.2 MB (73198151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb51ca2f19f438b533e5b6fffed08b8069c53e7761045f451b909bb33a8832d6`  
		Last Modified: Fri, 24 Apr 2020 12:11:58 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c38877918a6de66b9444f2a94e7317db49017e163a0f7e8dee9a5cbebedf0db4`  
		Last Modified: Fri, 24 Apr 2020 12:11:58 GMT  
...
```console
$ docker pull nextcloud@sha256:1baca41f1f0bbd5c226e6fdf53c409cef0af523d1d4545a51020a98c3a47135a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.9 MB (212909175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dadde7062aab1c5de24c942928d3423ad89ee1b1463f97ac8cfc709498bdc95e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=17.0.6
# Fri, 24 Apr 2020 13:14:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 24 Apr 2020 13:14:55 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 24 Apr 2020 13:14:57 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Fri, 24 Apr 2020 13:14:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Apr 2020 13:14:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7717bd26886a36c192c81224668d1422f1e2af23ac00156f10a5e2acba714b80`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fc8a914579bacd563f1c40e56f602e36d8c81f16fe8fdd45b05d29b29899b66`  
		Last Modified: Fri, 24 Apr 2020 13:36:59 GMT  
		Size: 73.2 MB (73196386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e5dc74afa198fe6936f90a2d983a07db1be22ac54f90606b56edf7b5c5e92d6`  
		Last Modified: Fri, 24 Apr 2020 13:36:33 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ade55b7bae777231ee32c4bea940e32ffcc97e6eb47d73e67eaba9ac8e45a240`  
		Last Modified: Fri, 24 Apr 2020 13:36:33 GMT  
		Size: 1.4 KB (1427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
