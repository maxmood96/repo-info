...
```console
$ docker pull nextcloud@sha256:f7928e25d6abfa50436914568078e685e14d1880828147f77f8cf9578ee93a27
```
...
```console
$ docker pull nextcloud@sha256:77741c99ce8c576a82add4d5ebd5be9da5f03d82585c83394de80ecd7497777f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.5 MB (245534456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36d637b8fdfea07dca9adbaf9533df48aeee92cd56913bc93d82f5482fcdab73`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 16 Jul 2020 21:45:19 GMT
ENV NEXTCLOUD_VERSION=17.0.8
# Thu, 16 Jul 2020 21:45:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 16 Jul 2020 21:45:50 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 16 Jul 2020 21:45:51 GMT
COPY multi:33e77d62bcc8d3785b05ff335da53732e518a402288e1ca59e572a0f6fd75aff in /usr/src/nextcloud/config/ 
# Thu, 16 Jul 2020 21:45:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jul 2020 21:45:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e5f7a1f062eec7b0a8c6e08356e0ffa46f2e399b90b63b1465e03e0e2744588b`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1217037ef7ec06cf799b98d629a756c07d51a72b4c17d88723416dd197e3ccb8`  
		Last Modified: Thu, 16 Jul 2020 21:52:11 GMT  
		Size: 73.4 MB (73414408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61e339ebed655843a3acd3249e34edaa414803973ad6ae65eef0365c63c15979`  
		Last Modified: Thu, 16 Jul 2020 21:51:53 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bec46581c751a69f537847441ee81ddef41b71bab8832ab4f7d0e1918f3aa40`  
		Last Modified: Thu, 16 Jul 2020 21:51:53 GMT  
...
```console
$ docker pull nextcloud@sha256:8612c0729abca8981484c605c17f5789b43fd930522c47f913908e018d31dc26
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221327022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04dd1b042e86a1ec8bd33769f8aa97bd6231ec176c11191cfc0a544586bd79ba`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 16 Jul 2020 22:18:10 GMT
ENV NEXTCLOUD_VERSION=17.0.8
# Thu, 16 Jul 2020 22:19:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 16 Jul 2020 22:19:37 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 16 Jul 2020 22:19:38 GMT
COPY multi:33e77d62bcc8d3785b05ff335da53732e518a402288e1ca59e572a0f6fd75aff in /usr/src/nextcloud/config/ 
# Thu, 16 Jul 2020 22:19:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jul 2020 22:19:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:db635b37f153ccd83afac97da0d6b9b7225ebab3ad88b441e08de1e7b337079e`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d74c0c1c9323d52d2d1badef3a15b230e4b9b1f6fdd0dda211710912bdc6954`  
		Last Modified: Thu, 16 Jul 2020 22:30:03 GMT  
		Size: 73.4 MB (73412436 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d483ddda7ec5dd56fef500b8e0b8cf94c29a29d0ac33473f8e8bf6b6a9915d97`  
		Last Modified: Thu, 16 Jul 2020 22:29:05 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8288960187d3c41916f847ab03685a1b017abf49dedec93456148399f63a1ae`  
		Last Modified: Thu, 16 Jul 2020 22:29:05 GMT  
		Size: 1.4 KB (1395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
