...
```console
$ docker pull nextcloud@sha256:e1d5d542b0676cc903fd1ba9819b4ca3786ebb50ff4b59156cf131f4f4eba807
```
...
```console
$ docker pull nextcloud@sha256:470661c4fb44f9dc1e27c5508fd67b6d4f4c4295770e323e910f61c9972cd128
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.9 MB (216920448 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91aef7959217966aa3d8c9d066e1d88812cd112caabd9cb9fbc4c6bd4a7a487a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 10 Sep 2020 16:54:19 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Thu, 10 Sep 2020 16:54:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 10 Sep 2020 16:54:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ccbce0ed8fac42b621ae5e81b3220ce3a46c3d0ed8bb08604b928c7180492ac4`  
		...
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c76ab252e0cbd18101456b6a8fd4b9e8c5b086d03da3574758ec662cfd5643d`  
		Last Modified: Thu, 10 Sep 2020 17:37:44 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:14e5171fa891bc04243c8a6198d973ac27bd8096e65176f1649026b30c319660
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.1 MB (213070052 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2482d2eb6183de37f0fc43ec0516dedcdeee99dcb7d30b006de5727bf079728`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Sep 2020 04:15:31 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Fri, 04 Sep 2020 04:16:46 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 04:17:14 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 04:18:03 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 04:18:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 04:18:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a797a70c96505dfd838751476943236bf3b5ea44525c0fffcb7b2434eb903ac6`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:303691dad50c633908bb9a49e866dbadc68e97cd0d2958e9497f1abae7ab0652`  
		Last Modified: Fri, 04 Sep 2020 04:55:21 GMT  
		Size: 73.3 MB (73338390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:788b28be689163e9f8e82cb107278eeb8268fa4317230242035dd1a5610fffd3`  
		Last Modified: Fri, 04 Sep 2020 04:54:55 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfa28229a870705acd79870a9e67bb07b9e2eac0a73ee9365a59246a609b7bdf`  
		Last Modified: Fri, 04 Sep 2020 04:54:55 GMT  
...
```console
$ docker pull nextcloud@sha256:fc0c5fe9f8e4abc7bdcbf439ef9e79e167b11f2eacf217a933b9183a94c2670f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.5 MB (230494970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61851f284f09c700d70286846bb522ee3b9e95b5936e4aa09ccf11d093f5faeb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Sep 2020 00:54:42 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Fri, 04 Sep 2020 00:55:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:56:01 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 00:56:19 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 00:56:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 00:56:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:74d01b5bcf9917df7ff089b4a05c9328806cd8d388d0d7edb1ff90d580fa7676`  
		...
		Size: 600.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8530d5f6b7bba952c9dd3ae351427f6165919476a9c70da4ca8312a796333ac8`  
		Last Modified: Fri, 04 Sep 2020 01:44:02 GMT  
		Size: 73.3 MB (73339702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5f4572ceb4dd175cb3f7e56f8e28d7ce5f32ad9173db9b7422eaa255a97f114`  
		Last Modified: Fri, 04 Sep 2020 01:43:43 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed3147af0dc37d85909ed3ef89bdf04237e4c019184f303c5fd893ad66775ab0`  
		Last Modified: Fri, 04 Sep 2020 01:43:43 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:8071eddff14f6868e3a66cc3685ead7fd9b12f787455448e173b4b2f822b72db
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.5 MB (245472489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8b585df3cca8ee81a03aad68241bc267d0796db65f71b90022245cc6669fa56`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Sep 2020 00:54:48 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Fri, 04 Sep 2020 00:55:20 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:55:20 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 00:55:21 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 00:55:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 00:55:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:173ef5e5b0549dd555cea1b2388df514f6030880e7c8ddc9521cb3928ea59a4d`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c28f052c3468b7fb5e14f7ddb01b6c94f2f2a1858643eaedbd4342cefe6dc849`  
		Last Modified: Fri, 04 Sep 2020 01:20:46 GMT  
		Size: 73.3 MB (73339198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e79380c002ae79a44d6e29c3d8d28bf9906591dbf14cac32ebd8c164d61feb6b`  
		Last Modified: Fri, 04 Sep 2020 01:20:22 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33398cdba877ded071eef506728ceefc67a530296fbc592acf9d27668fc8b61f`  
		Last Modified: Fri, 04 Sep 2020 01:20:22 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:e8ae4f12637f0b84645724fcd89bc4c7c3cbb0e78b9f35d6364f3032b40727de
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.7 MB (251737733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77c372836fcf5989f8d61a73054e57a7e99018a8a59cfde8dd0a78778ef449e1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Sep 2020 04:35:10 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Fri, 04 Sep 2020 04:36:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 04:37:05 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 04:37:07 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 04:37:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 04:37:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4dd5c78122d2e2d0c5b388da8cecfb2b5147ae3bf71b00fd23a659202eef4cf5`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:279b748acc4ae73ffe9bc5acf5e325c73574acd6c17a31109b26f682aef67ad3`  
		Last Modified: Fri, 04 Sep 2020 05:48:43 GMT  
		Size: 73.3 MB (73342426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72338399ed866b2ee31198cf66d94588f8b4e880c99bdb2739d5fea467d94269`  
		Last Modified: Fri, 04 Sep 2020 05:46:44 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87b228fa02e69e72d66894b73db2f82a11c6e74ad0dcf31f389bf781f50f73ca`  
		Last Modified: Fri, 04 Sep 2020 05:46:44 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:9fc3bb8bb0b65b24e279eea8f8db4963a870bd921e7b4b3ab46415fd0fcd18d5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.3 MB (224346772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5ee276f50a69522b46db2e3ee53e6311f26c771897f452a0a3cc2a34f64de37`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6609de11bea9898555169411255cf76f8744c52fd5c7296e4cea2d9722eb5395`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04455d748cb9fb1982d873c7a07f97234e9dc9800ed54930978b623218d8524b`  
		Last Modified: Thu, 10 Sep 2020 09:24:23 GMT  
		Size: 1.7 KB (1709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
