...
### `nextcloud:32.0.10-apache` - linux; amd64
...
### `nextcloud:32.0.10-apache` - unknown; unknown
...
### `nextcloud:32.0.10-apache` - linux; arm variant v5
...
### `nextcloud:32.0.10-apache` - linux; arm variant v7
...
### `nextcloud:32.0.10-apache` - linux; arm64 variant v8
...
### `nextcloud:32.0.10-apache` - linux; 386
...
### `nextcloud:32.0.10-apache` - linux; ppc64le
...
### `nextcloud:32.0.10-apache` - linux; riscv64
...
### `nextcloud:32.0.10-apache` - linux; s390x
