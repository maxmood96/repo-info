...
```console
$ docker pull nextcloud@sha256:52fdd7c7fa4e5f85e17841b5eb1c162a5e1fa801ca02f0543cd2c4d6c63047d5
```
...
```console
$ docker pull nextcloud@sha256:6c80fa0bdbb8abdc52fd6f0d5b0a6707857073fcb20570a46fe67cfc0b08333c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **378.3 MB (378276421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93cd3d09db8d75b391631484e159bb12c7f3001dbc09aa68d909df1f9e96777c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 17 Feb 2024 01:44:54 GMT
VOLUME [/var/www/html]
# Sat, 17 Feb 2024 02:00:04 GMT
ENV NEXTCLOUD_VERSION=28.0.2
# Sat, 17 Feb 2024 02:01:29 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 02:01:31 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
...
-	Layers:
	...
	-	`sha256:a52b39eab5b7d0fd8ad4156630f3360c48336cb1b0e51fc29986efe7e008722a`  
		...
		Size: 756.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c9e3b707b25c770043961ed169af5f98d03a192e233c55fc3e0c9fa8485b1cc`  
		Last Modified: Sat, 17 Feb 2024 02:13:22 GMT  
		Size: 202.3 MB (202302895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dda05077c49461cf6f02a3144fea040b8e4c3b69ca39d1cee2d1e543c3621ff`  
		Last Modified: Sat, 17 Feb 2024 02:12:31 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:231e7401f94d428ed08381e1666cd9869dca9b6c870a3b7aea2a2881a666fd5d`  
		Last Modified: Sat, 17 Feb 2024 02:12:31 GMT  
...
```console
$ docker pull nextcloud@sha256:e7c48a150935920efcca46311b8ab6f9eafd983c6009b27ea5e237815e69a6e6
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **424.8 MB (424767050 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9408a70ad4f1ca26fe26cc4859256d21e946f299345b095151304e4866c40df`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 17 Feb 2024 02:07:19 GMT
VOLUME [/var/www/html]
# Sat, 17 Feb 2024 02:18:01 GMT
ENV NEXTCLOUD_VERSION=28.0.2
# Sat, 17 Feb 2024 02:19:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 02:19:15 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 02:19:16 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 02:19:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 02:19:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7da2039ade2eeb69ea97eca0f83edc0d99c3da34c1bc0d1f38deffbc89166205`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf2401ba249ac5b032d2f0b46b7e2016bee4d40f4471f262d4b9222656e5d590`  
		Last Modified: Sat, 17 Feb 2024 02:27:23 GMT  
		Size: 202.3 MB (202304915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a29edd3c8fda91a19488612c71a00094ce918e261dbc6fdb89b0be57521425c2`  
		Last Modified: Sat, 17 Feb 2024 02:26:54 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cf2e02f6e4b5d47f451150aca6e90111f9bf9022b323cbbf114ae9f747815e3`  
		Last Modified: Sat, 17 Feb 2024 02:26:54 GMT  
		Size: 2.3 KB (2335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
