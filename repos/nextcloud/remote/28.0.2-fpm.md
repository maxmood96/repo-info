...
```console
$ docker pull nextcloud@sha256:24e3d19ce514f98ccde8e4e69e0ed1703dd2a3c398acbcfd49725b18498fd212
```
...
```console
$ docker pull nextcloud@sha256:67ec817a8628a0428667241d38d06e0c8dfa614776b7ced13db245dbab3f8e38
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **411.3 MB (411288528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b94f39c9943063b918498573664da36ad5301b1816d6f8ce613fdbabbe4f0a0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=28.0.2
# Sat, 17 Feb 2024 03:33:22 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 03:33:27 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 03:33:28 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 03:33:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 03:33:28 GMT
...
-	Layers:
	...
	-	`sha256:ece8dcbb32990cec1187464ac254dc3cac2ef36a930be8aac782cb4c70e49e5b`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5daea8c2939bf3264fbfc48f640009566117efb651525575ef90e02cfef62e27`  
		Last Modified: Sat, 17 Feb 2024 03:40:02 GMT  
		Size: 202.3 MB (202304563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c6e160e2837349668e09618895358fa85b51ba0e63ac8dacff70564a3d9ed74`  
		Last Modified: Sat, 17 Feb 2024 03:39:41 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07deba793630262daf912e41171c7fa3d4f4330f5c7daae9e1151272e0add1fd`  
		Last Modified: Sat, 17 Feb 2024 03:39:41 GMT  
...
```console
$ docker pull nextcloud@sha256:9f4e368197a8a18cc98ff9ede7bf4febc975e67292cdd90e71b2fab8c41732ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **418.4 MB (418358823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1da7b2c9df884274acf79e7b18437a33131676387afe2248c876c685213258f1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 17 Feb 2024 03:14:38 GMT
VOLUME [/var/www/html]
# Sat, 17 Feb 2024 03:26:47 GMT
ENV NEXTCLOUD_VERSION=28.0.2
# Sat, 17 Feb 2024 03:28:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 03:28:05 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 03:28:05 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 03:28:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 03:28:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:72c9f771609c76e1806ed5a0e1373ad0fccc6430edd1b246cddb372d0977b11b`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:872ec2d1f0e8a8215f0e0c1e323ca84d54da01fbcb97c8be82a6051352d1b775`  
		Last Modified: Sat, 17 Feb 2024 03:38:35 GMT  
		Size: 202.3 MB (202304071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:921c9d111333961983065e2a04c15585b04eabc81a36ad6e1c7d95badce21160`  
		Last Modified: Sat, 17 Feb 2024 03:37:46 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe1442a0f23bf72570f7d45dda0ae96bfca7f1a22833c543b0dcf0486a607e3b`  
		Last Modified: Sat, 17 Feb 2024 03:37:46 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:32d729e5f0c3aa38b88d5e4fbe5e929ea78b2c52c446cbbd2149be8edeaa9e60
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **391.3 MB (391295403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be2e4c7fe80524b68c535a0c348a505ac633fb8375eb6b0389fe6911d8d08ae0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 17 Feb 2024 03:58:27 GMT
ENV NEXTCLOUD_VERSION=28.0.2
# Sat, 17 Feb 2024 04:01:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 04:01:54 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 04:02:04 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 04:02:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:e1fa884b22891ff2e52e9527cd37c6adcf25ca003ccab750daf71de6a90bccad`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bea1db5c54f498345cbe20eb02d40903490ea92daf4b563200d4352ac790e72`  
		Last Modified: Sat, 17 Feb 2024 04:17:35 GMT  
		Size: 202.1 MB (202082548 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:036e040f9178978b98684cd553cabe27fd0b67529f48ee65f2a77e820b22a8af`  
		Last Modified: Sat, 17 Feb 2024 04:15:32 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d33ad99bfee667ff4af43069c9976379257e751cc565b5c41f956b287c45be9`  
		Last Modified: Sat, 17 Feb 2024 04:15:32 GMT  
