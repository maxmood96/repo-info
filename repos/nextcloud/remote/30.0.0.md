...
```console
$ docker pull nextcloud@sha256:277c59344fba0ed38fcfd8f5704f24b85ce8ad5063a6e500ace9430953a31d6e
```
...
### `nextcloud:30.0.0` - linux; arm variant v5
...
### `nextcloud:30.0.0` - linux; arm variant v7
...
### `nextcloud:30.0.0` - linux; arm64 variant v8
