...
```console
$ docker pull nextcloud@sha256:1c6e65d273a26916297dc47058bd72153226df5e37fd7d65eb74cc2061c648ff
```
...
### `nextcloud:17.0.10-rc-fpm` - linux; amd64
...
### `nextcloud:17.0.10-rc-fpm` - linux; arm variant v5
...
### `nextcloud:17.0.10-rc-fpm` - linux; arm variant v7
...
### `nextcloud:17.0.10-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.10-rc-fpm` - linux; 386
...
### `nextcloud:17.0.10-rc-fpm` - linux; mips64le
...
### `nextcloud:17.0.10-rc-fpm` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:92eeedb32a1e250303cc1a42e58298c58720a2df2a5d0edfe23f20f0f2fade9a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.5 MB (247452178 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c523e2412a9d03a7de3ef1eb37631fc8f78572cb73d0267a4d953d032d80100`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 06 Oct 2020 01:37:48 GMT
ENV NEXTCLOUD_VERSION=17.0.10RC1
# Tue, 06 Oct 2020 02:05:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 06 Oct 2020 02:05:55 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 06 Oct 2020 02:05:58 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Tue, 06 Oct 2020 02:06:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 06 Oct 2020 02:06:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:661a0a14b28afd7e55285dcf4eef9c4a8d0c25e505db7af38ce9f3730e7631d9`  
		...
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f479979e9d2f10a151123fa0b744a6507fa27e930bb91ce6e59620d2a24e0b6a`  
		Last Modified: Tue, 06 Oct 2020 09:26:42 GMT  
		Size: 73.4 MB (73377132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa47002edfcc1dcd5da6d044acfe97a452184d5e73826019c6b8a9f4da4be443`  
		Last Modified: Tue, 06 Oct 2020 09:24:38 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e5780e5c746c02bf80e7def8da4a9394729a0a8b5fea96f5c38a55f46f2f8f`  
		Last Modified: Tue, 06 Oct 2020 09:24:39 GMT  
		Size: 1.9 KB (1892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.10-rc-fpm` - linux; s390x
