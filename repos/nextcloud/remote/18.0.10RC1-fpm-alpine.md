## `nextcloud:18.0.10RC1-fpm-alpine`

```console
$ docker pull nextcloud@sha256:aed7b06f2a1728b9f0537907e70bc7c52d4099d36aa45cd291bdf9b4e0ea4f7c
```
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; 386
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; ppc64le
...
### `nextcloud:18.0.10RC1-fpm-alpine` - linux; s390x
