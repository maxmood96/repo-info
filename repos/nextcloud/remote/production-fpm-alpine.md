...
```console
$ docker pull nextcloud@sha256:2b932d6339a7291b34dc4a8e5f94972e9d0c140f84d6ad343391113fb259a3a7
```
...
```console
$ docker pull nextcloud@sha256:cdecbd790e8d275d8ff973a135b4e4e7dfdfaee1f03f18df7160884cd8467379
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.5 MB (251528254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dff3478c69a25f9f08a00d4e2cbad49dce89ed2a1e91ca5e41664a8f3fe6ad63`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 May 2024 00:13:07 GMT
VOLUME [/var/www/html]
# Sat, 11 May 2024 00:17:18 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Sat, 11 May 2024 00:18:27 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 11 May 2024 00:18:30 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 11 May 2024 00:18:31 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 11 May 2024 00:18:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 11 May 2024 00:18:31 GMT
...
-	Layers:
	...
	-	`sha256:602beb0abfada85e39e05a8d41106c20ee2f5ede480697d2ece1139701480f12`  
		...
		Size: 760.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1a127f1953c04aeb97cb49cb17b9084f0edcaa5e7376e5e1a2adeef5be002c6`  
		Last Modified: Sat, 11 May 2024 00:28:44 GMT  
		Size: 206.9 MB (206932842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd9dcaa151878c93d63f11d8f86205d242e01ca8fdc3f71ed51c8083cfe0a20a`  
		Last Modified: Sat, 11 May 2024 00:28:13 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2744572e7576c2763898fa1c5d26891d19b10752964a5a075f5e0635ccb3b79c`  
		Last Modified: Sat, 11 May 2024 00:28:13 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:6b8d291f5e466dab773f2773c248b7dc73e55a9af7ebcc24ed9ee60d3b3248b8
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.9 MB (256872728 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d028e19ff3fd4d7183c62d2ae23aff994414adddb6f91fc466434d405a0efc8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 11 May 2024 00:14:21 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Sat, 11 May 2024 00:15:19 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 11 May 2024 00:15:33 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 11 May 2024 00:15:33 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 11 May 2024 00:15:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 11 May 2024 00:15:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6c24ea4819a41d4ef2c15fa2b44d19e9a1ac7e3d00437bc3aea8cfa96a78a35a`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4326294e8828cfaa680fb2173368037b922613b3a0aa05f389a98603f5c3001e`  
		Last Modified: Sat, 11 May 2024 00:26:28 GMT  
		Size: 206.9 MB (206932975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca555663b561e4fa69c48d018da126053baa8e2565b0de9168fcc660c598ae3a`  
		Last Modified: Sat, 11 May 2024 00:25:59 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a770e39942d49aa0692ae8a9e8d149cbf6106e0f5b436721ff4143f6597e3b72`  
		Last Modified: Sat, 11 May 2024 00:25:59 GMT  
		Size: 2.3 KB (2336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
