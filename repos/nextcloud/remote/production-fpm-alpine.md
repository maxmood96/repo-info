...
```console
$ docker pull nextcloud@sha256:17ece80fe9d0ce184bd7e4d530ca26dc8192213216a35532ce8b5dda5034c946
```
...
```console
$ docker pull nextcloud@sha256:d51b556b7880552f307eaefd3cb9d5464f4b5175a2db83d779ce8f77a42219b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.4 MB (256374107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:469b857fbc6e72b980d4da9f04092ca0e84b0c403f3dc06f13a004143034c652`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 May 2024 02:35:12 GMT
VOLUME [/var/www/html]
# Sat, 11 May 2024 02:38:45 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Sat, 11 May 2024 02:39:41 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 11 May 2024 02:39:46 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 11 May 2024 02:39:46 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 11 May 2024 02:39:46 GMT
...
-	Layers:
	...
	-	`sha256:3c3bff5aa20e8e08e4fd3ac002cfff3bfe35e2b33686ff935be638f2d3b58c11`  
		...
		Size: 760.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:525f48b3fca5699d16e1a6e8baac262ac52fe06e9a2ddaae2fc63b4345cead92`  
		Last Modified: Sat, 11 May 2024 02:47:49 GMT  
		Size: 206.9 MB (206933059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02e084c8cd6716caa366988d2e3472e71f000c3d71ef6d4efea882def3a941c3`  
		Last Modified: Sat, 11 May 2024 02:47:29 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f583f1c31525968d0424388b166f4b0f5a2cfcb84cff349eb4107c46cd279246`  
		Last Modified: Sat, 11 May 2024 02:47:29 GMT  
...
```console
$ docker pull nextcloud@sha256:1af51b1654b8304a59a115b89075eb73465ed655bf110a4c7773c949f6f38f24
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.7 MB (256676388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84f4c0ae882c6c708dd0a39214cac149b3c77021dcff02786797de1d27e2a16e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 May 2024 03:02:32 GMT
VOLUME [/var/www/html]
# Sat, 11 May 2024 03:06:48 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Sat, 11 May 2024 03:08:05 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 11 May 2024 03:08:10 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 11 May 2024 03:08:10 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 11 May 2024 03:08:10 GMT
...
-	Layers:
	...
	-	`sha256:ccc39c2cf0b3f2735cd0d05cbfba82b9c2593bba3b6221f7d978223cdd12fb06`  
		...
		Size: 760.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:884b2b11e5dfbde7eda447e1d8319147004f5cd2635c65da8311aad2a53be70a`  
		Last Modified: Sat, 11 May 2024 03:19:41 GMT  
		Size: 206.9 MB (206933122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97542959bdcc99dbf54c434e18ef727566444991d8d14fdac727036bbb0d0296`  
		Last Modified: Sat, 11 May 2024 03:19:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e552fe2301837c87e459bc1f40922817940a1469c88d83f8f28dde9c212ddd48`  
		Last Modified: Sat, 11 May 2024 03:19:01 GMT  
...
```console
$ docker pull nextcloud@sha256:6a4d2c9a733b2a2f132bdbbb0c65bd2785ad28b866a0a61f2501fec2bca8be7b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.9 MB (255914728 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca8e80f8af7eea3642b344a37711edfd8519699344cd900a65ca1938e4e0d146`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 May 2024 02:22:40 GMT
VOLUME [/var/www/html]
# Sat, 11 May 2024 02:25:51 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Sat, 11 May 2024 02:26:30 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 11 May 2024 02:26:41 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 11 May 2024 02:26:41 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 11 May 2024 02:26:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 11 May 2024 02:26:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:81ac7ddc5a6e4f4fe344e7212a9cef32dbc8783319b5a39a7ce97051d4fd8e78`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e6207ba8eda8e5baca08e4122b6b1a46e6aa9acc1d1353dd1d0f0c5a6429914`  
		Last Modified: Sat, 11 May 2024 02:34:03 GMT  
		Size: 206.9 MB (206933146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fea5e622f36ae5a3855515644e78d3ea6024fb8fedf5cb7699b38fa3bc5a8db`  
		Last Modified: Sat, 11 May 2024 02:33:40 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7e9096f5999951fd350f34e244d87bdd340f2f88cc1dd033f65ef7a0637c37f`  
		Last Modified: Sat, 11 May 2024 02:33:40 GMT  
		Size: 2.3 KB (2338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
