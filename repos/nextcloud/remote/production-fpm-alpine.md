...
```console
$ docker pull nextcloud@sha256:fc3786a964d52d6b65771953b08ff7b622f83bf44ccb6874b3844cdb6fd55c18
```
...
```console
$ docker pull nextcloud@sha256:bceeec85b4ead111120e281bbd8317bb37aacb7b359a672509bd2e0ee9043e85
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.5 MB (209527410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f47b12b67ca4efef654bfb6b9e0154f2e7629283f6ba7f678050af710eb970bc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 07:48:59 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 07:52:07 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 13 May 2022 07:52:22 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 07:52:26 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 07:52:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 07:52:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b50da46c59c722795c279d5e661763f3adc47c5c3b2e18c05703ffa68d0c46fc`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45346cb0fc751e609b795b2e4e42d1f95e28f5e3a8a44d6a691ef4d86ceabd4a`  
		Last Modified: Fri, 13 May 2022 08:36:18 GMT  
		Size: 153.8 MB (153802887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb7bd3e90f623a9364857e8810254234153d7dd80df1814f8387d2dc1f124b54`  
		Last Modified: Fri, 13 May 2022 08:31:21 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:facfeee9584ff509583a54fdea6c5580d8d1be18de9aaaabbaa9f96c5b5d72d8`  
		Last Modified: Fri, 13 May 2022 08:31:21 GMT  
