...
```console
$ docker pull nextcloud@sha256:4ac18a15e90fb38e3e1bc28456ae6397befad9f674b8798bc36be623ccf5c891
```
...
```console
$ docker pull nextcloud@sha256:aefe9369c882181c081c1f0c8794bfd1b28a33cacfbfc8aab72c98283fb60ad9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.0 MB (249037977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6afc5f65ec7722db5a2000a218d7ec6d16572742d1d3665405764a20d520c1d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 18 Jun 2024 23:00:46 GMT
VOLUME [/var/www/html]
# Tue, 18 Jun 2024 23:01:59 GMT
ENV NEXTCLOUD_VERSION=28.0.6
# Tue, 18 Jun 2024 23:02:55 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Tue, 18 Jun 2024 23:03:00 GMT
COPY multi:c8e39871baf1efab774933f35bf66c1fea215c9e9350ee9a43890d8b4411246a in / 
# Tue, 18 Jun 2024 23:03:00 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Tue, 18 Jun 2024 23:03:00 GMT
...
-	Layers:
	...
	-	`sha256:c58d68de5185da48643b2ea47ffaea275bc01fb1e3d6ab29b16b93109f07befe`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:785463c410e1bddb350ab8d7c8b359f5fd22dc104d0fd703c6ef8e5e75fb1205`  
		Last Modified: Tue, 18 Jun 2024 23:10:28 GMT  
		Size: 204.0 MB (203976359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52a7add521d63fb72d018ecfc32f01697ae7b6f6e36f7635937c5d7e967ff5d4`  
		Last Modified: Tue, 18 Jun 2024 23:09:49 GMT  
		Size: 3.7 KB (3723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76c9297abd5bd8e7dd081e80e8de5dc72150d48adfb0a4fb3fcefff620c8e3a9`  
		Last Modified: Tue, 18 Jun 2024 23:09:49 GMT  
		Size: 2.3 KB (2314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
