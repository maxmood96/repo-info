...
```console
$ docker pull nextcloud@sha256:e70052bbbdc5c6b297f8859222e3b61638582173520b9e2d77f55fc7ed3b8a2c
```
...
```console
$ docker pull nextcloud@sha256:678c518aec937b8dbe8583eda26946648f772897bd03ff2933c935d41da72951
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **205.7 MB (205670379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cea54e0a13ded585ffa2712325b9223639fdec1611cceb6996b13b31ec9eca01`
...
# Sat, 07 Aug 2021 03:59:04 GMT
VOLUME [/var/www/html]
# Sat, 07 Aug 2021 04:00:11 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Sat, 07 Aug 2021 04:01:09 GMT
...
-	Layers:
	...
	-	`sha256:866d0ca8a04ae2d2eed7654107c22161ca3cd8d0d58254def4f05d6dbf8a80ff`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd5c67a316ee358c150d955a4daa162bf9e4a336e7227bbc721cdd07fa465bd0`  
		Last Modified: Sat, 07 Aug 2021 04:04:23 GMT  
		Size: 150.8 MB (150778158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac3041f0cbe9dc522e5f950b6813c6782a0d29e47c9ab283ccb346b1591c23a`  
		Last Modified: Sat, 07 Aug 2021 04:04:03 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f94f9ef0785d06b99788901bbf7781b53ca1e892b3b4c463434f246746e9bf92`  
		Last Modified: Sat, 07 Aug 2021 04:04:03 GMT  
...
```console
$ docker pull nextcloud@sha256:96cabcde2a7e4763c11ff3e5639ceb8bc0ced86e84bdfd32c522a008733ab0c7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.9 MB (204931075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ea3e830cfae88d9007c266023827dadf2c3c60a040b8fe7038c5ec3388d18d1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 27 Aug 2021 01:59:54 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 27 Aug 2021 02:05:12 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 27 Aug 2021 02:05:13 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 27 Aug 2021 02:05:14 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 27 Aug 2021 02:05:16 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 27 Aug 2021 02:05:16 GMT
VOLUME [/var/www/html]
# Fri, 27 Aug 2021 02:06:59 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Fri, 27 Aug 2021 02:08:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 27 Aug 2021 02:08:25 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 27 Aug 2021 02:08:27 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 27 Aug 2021 02:08:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 Aug 2021 02:08:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:93d45fb4e2ce13ba7a34c2867679f2492236e2b077a7103e21320234566941e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:854b27db311e816c3b5b83be9a7440306c3051f660d2ea1de904486e699080fc`  
		Last Modified: Fri, 27 Aug 2021 02:11:38 GMT  
		Size: 622.8 KB (622847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8f2f5a98fa8033806f6b76aff800b7637704f77227f80fc24a9e684f488c2d1`  
		Last Modified: Fri, 27 Aug 2021 02:11:49 GMT  
		Size: 24.0 MB (24045398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:547cbf8863a2eb9fcbcf535ab6d9d9b8554c7d9fff2924e7aebfb760f904eb36`  
		Last Modified: Fri, 27 Aug 2021 02:11:36 GMT  
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2bc68ae9a0e9706aa1f3c86225822f25cd38933ec90ac9223a08104826505fe`  
		Last Modified: Fri, 27 Aug 2021 02:15:02 GMT  
		Size: 150.8 MB (150778289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aac96fac1ba2027a1d55159db4911ea59fc93082518dd797e552d92556b55c85`  
		Last Modified: Fri, 27 Aug 2021 02:13:25 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61086fd8b78f9d56fce6839ff21727c57b00a316a2b79f856df5907be488681a`  
		Last Modified: Fri, 27 Aug 2021 02:13:24 GMT  
...
```console
$ docker pull nextcloud@sha256:63c2abb277521aa15dea6eb31c46d9107f7988dbdd3cb2d1082a1ad585858674
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.9 MB (201860243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8ce7910887f6db9d36886d4a7d6fdffa8add4ea19d62aac54b377748796125f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 07 Aug 2021 05:42:29 GMT
VOLUME [/var/www/html]
# Sat, 07 Aug 2021 05:44:28 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Sat, 07 Aug 2021 05:45:47 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 07 Aug 2021 05:45:51 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 07 Aug 2021 05:45:53 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 07 Aug 2021 05:45:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:6b4e4f98867ef031df96320f5b9c26bba37f082b5be4782a3399f2ead7bf5ee7`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0568dd26acac33be5766639d3f47bb7eebd0e40810ef6b1716c01896b5df68f`  
		Last Modified: Sat, 07 Aug 2021 05:55:32 GMT  
		Size: 150.8 MB (150777925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:047f3f84f63502d3d433c0a2316ebca4725814d6177a615c75335ad06824581b`  
		Last Modified: Sat, 07 Aug 2021 05:53:56 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d60e2c091084c1863ac32557474a49f9fd1fbd059e6ef99d0ef6a63836135e40`  
		Last Modified: Sat, 07 Aug 2021 05:53:56 GMT  
...
```console
$ docker pull nextcloud@sha256:a6a9ac0d1cedad28ba09e952eb5e82dfa707b0173d55e4cb4764722f8f3499f8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.7 MB (206663663 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d5ce763a8308c8369763d2f16cdb05d0eecc0b86630be8b8d6a5baa201cf5d5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 27 Aug 2021 05:45:44 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Fri, 27 Aug 2021 05:46:26 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 27 Aug 2021 05:46:28 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 27 Aug 2021 05:46:28 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 27 Aug 2021 05:46:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 Aug 2021 05:46:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6c72d7897a7ab429d1a222cb755ed174e444b8470018be83fa976b9201854968`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fef39700ca8095e49ec74992317d422f1018e3ecbeb6cc36ddbf62ef466c99c2`  
		Last Modified: Fri, 27 Aug 2021 05:55:26 GMT  
		Size: 150.8 MB (150778448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce81f603b597f05384aa8f176deefb149bedb7b5bec4eb196900bae5399aaf48`  
		Last Modified: Fri, 27 Aug 2021 05:55:05 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8014f323ef99e51a9ea71e092c60f3176cd585c846ca491e682e5426af980f97`  
		Last Modified: Fri, 27 Aug 2021 05:55:05 GMT  
...
```console
$ docker pull nextcloud@sha256:37969d958c77c18aa409d589aa7f91638ab69a3817880e22ebccbcd9d806c447
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.5 MB (206535204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:825f43477f6c4d516637fcd2b8916aa6d73939096edd51357ab467ba2662a1bf`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 07 Aug 2021 04:14:17 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Sat, 07 Aug 2021 04:15:15 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 07 Aug 2021 04:15:18 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 07 Aug 2021 04:15:20 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 07 Aug 2021 04:15:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 07 Aug 2021 04:15:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1655b41619f2dc6a99794e387a3e3210cbc28e56ef3f238138fdf85d6df36b1f`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:087c2aa9c5c74a8721482047b46d77524424008e991e60045099577d84073078`  
		Last Modified: Sat, 07 Aug 2021 04:20:09 GMT  
		Size: 150.8 MB (150777922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4211a4c111aed6c18274620acb2374b2a24d4fc685377e12ad5d8e3911f155e`  
		Last Modified: Sat, 07 Aug 2021 04:19:42 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5c22c8b20e028bd8b92cc0e5b3f4f01b58f68310b7bf93ccfa3537fe5201d97`  
		Last Modified: Sat, 07 Aug 2021 04:19:42 GMT  
...
```console
$ docker pull nextcloud@sha256:e064bb75587af53a916786a472b85bdd888b686dad99f10bfbfc03571ec31bcb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207171181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d43d2db8bd25869e684df00725a636c1e3b64a16d7c05bb11f89d232e3391ffb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 07 Aug 2021 09:06:00 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Sat, 07 Aug 2021 09:08:41 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 07 Aug 2021 09:08:50 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 07 Aug 2021 09:08:54 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 07 Aug 2021 09:09:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 07 Aug 2021 09:09:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:40cb73964711ba2e5fec4cbde7069142e5c729af44dbcd81b3b645de2f390872`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:147880621fb24ac70de533d730161dd218593c265be2c66cde80ba96d60f9eb4`  
		Last Modified: Sat, 07 Aug 2021 09:15:22 GMT  
		Size: 150.8 MB (150777962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7345fa0e953aae2a32ec14025be37c7f0deaf21d83ff292f7b4d1a068c022643`  
		Last Modified: Sat, 07 Aug 2021 09:14:57 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6b27fa310dc92924b1f8bb8e77a6f15395fbae95eeccb691107091eb534596b`  
		Last Modified: Sat, 07 Aug 2021 09:14:57 GMT  
...
```console
$ docker pull nextcloud@sha256:65180ae32a7246337a289c2953a5dfbb3ac187c8d44b148f1e98c356c00e8237
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.6 MB (204623889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5483b253e963b8d83fa016b44f26cd60dc576947c06b0938d0157227cc8233b6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 20 Aug 2021 18:34:48 GMT
CMD ["php-fpm"]
# Fri, 20 Aug 2021 21:32:11 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 20 Aug 2021 21:36:43 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 20 Aug 2021 21:36:47 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 20 Aug 2021 21:36:47 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 20 Aug 2021 21:36:49 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 20 Aug 2021 21:36:50 GMT
VOLUME [/var/www/html]
# Fri, 20 Aug 2021 21:38:57 GMT
ENV NEXTCLOUD_VERSION=21.0.4
# Fri, 20 Aug 2021 21:40:00 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 20 Aug 2021 21:40:23 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 20 Aug 2021 21:40:25 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 20 Aug 2021 21:40:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 Aug 2021 21:40:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7a498c224cec0e66c10884292d34fe1190de21c30c7cc75abf92e22ed1bdfc77`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3c655c5016ac8733d7aafc83f0460d4c79bc8738a42ad6b536a4220fbd21874`  
		Last Modified: Fri, 20 Aug 2021 21:44:33 GMT  
		Size: 683.7 KB (683704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e388cd1a2687645a9d4893f938f9480c3ba5e79720d4f7c1d332c943103d5d46`  
		Last Modified: Fri, 20 Aug 2021 21:44:34 GMT  
		Size: 24.7 MB (24701210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:152f72bf48da67c8a9faa2029aa0aa3e51d3b38937fff8206188b1564069d70a`  
		Last Modified: Fri, 20 Aug 2021 21:44:31 GMT  
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f727aeaed043a0d4ebefea87a7fb69d5a161a43ec38ef22a48e6d43cab5790c6`  
		Last Modified: Fri, 20 Aug 2021 21:45:31 GMT  
		Size: 150.8 MB (150777952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1950e5187e0d79b1bff989ef473d3c76d9d4140c76821f5f9edd5fbf299ab852`  
		Last Modified: Fri, 20 Aug 2021 21:45:15 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b2322365eddf4260dc816fe5ee9808ab29e3e2cdcff19ec81b7490d16f6370f`  
		Last Modified: Fri, 20 Aug 2021 21:45:15 GMT  
		Size: 2.1 KB (2054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
