...
```console
$ docker pull nextcloud@sha256:309b47dd866e169789613605213d2799e46b4c356617ee6d8d126a1a7715aebe
```
...
```console
$ docker pull nextcloud@sha256:99ee52a69c4e6404a30b2b9fef4884b51effc106d5c5b337e1d0af40925806af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.3 MB (193254193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54e6cc841d2c0055d300c4dd182c97663f20ee3419a9a5436fda531e76cf0397`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 08 Jul 2022 07:23:36 GMT
VOLUME [/var/www/html]
# Fri, 08 Jul 2022 07:36:30 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Fri, 08 Jul 2022 07:38:10 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 08 Jul 2022 07:38:13 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 08 Jul 2022 07:38:15 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 08 Jul 2022 07:38:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 08 Jul 2022 07:38:15 GMT
...
-	Layers:
	...
	-	`sha256:79d50c6d60cd3541c4d2c37236147ca2c777c1d2a8e76ee47ff49ead6d8b4e4e`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c2ff87029f794d9fdfe440d884a8414922875757013975af45b850842918994`  
		Last Modified: Fri, 08 Jul 2022 07:57:50 GMT  
		Size: 153.5 MB (153476722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6783dbe1b15f996c56ea9c152d57f5434b3541d5c305c4f969361610ecf5a708`  
		Last Modified: Fri, 08 Jul 2022 07:56:05 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59d8475636fccc2a4c1cf05477d8fb1391b085e6b6f6d0d6d45726facce32655`  
		Last Modified: Fri, 08 Jul 2022 07:56:05 GMT  
...
```console
$ docker pull nextcloud@sha256:82da4c53cbcd6d8ab40f23885da2a6a552c235534d29da8e07cbe9ba2c346126
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.0 MB (198016520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b980b72cd36e0a516f28976c9d40e1428105ec1dabf93e875e5348a8aedab36b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=23.0.6
# Fri, 08 Jul 2022 12:32:21 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 08 Jul 2022 12:32:28 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 08 Jul 2022 12:32:30 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 08 Jul 2022 12:32:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 08 Jul 2022 12:32:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3fd1cb648488454c7dacdef56ad9f122318ca58df619110b0b502c816ab0527d`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45bc87d5973a366cfe3f493ea876228122178e109291ec746430a9299232d36c`  
		Last Modified: Fri, 08 Jul 2022 12:55:59 GMT  
		Size: 153.5 MB (153476766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21234730d4c5bcc1c1526e417863777b1042774abaa419bd12baca23c6904fe9`  
		Last Modified: Fri, 08 Jul 2022 12:53:05 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3cd9e0de951b04bc8d6ff275fd23bb4f2b53936c3d2540258371cf96b9077b2`  
		Last Modified: Fri, 08 Jul 2022 12:53:06 GMT  
