...
```console
$ docker pull nextcloud@sha256:52235e820bf0001696d7dc961f095ad1c0413177e98d5870131802ec701b8bc1
```
...
```console
$ docker pull nextcloud@sha256:372859eb91a338187d9a91be78a92266330a442bfd7434c16edfd0dd2ce65b37
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.4 MB (195368771 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1189038d908d1ff91b24574fb99bfc22f3455a82dceee51becc1f93a6f025e5e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 24 Mar 2022 09:52:40 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Thu, 24 Mar 2022 09:53:16 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 24 Mar 2022 09:53:17 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 24 Mar 2022 09:53:18 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 24 Mar 2022 09:53:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 24 Mar 2022 09:53:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d62f6c9faa9f31b6a12fac7154d60edcffd05fc37b293903a9fdc94c66327694`  
		...
		Size: 560.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:380b6128d8b8dc8c7e828e6535457ba68e40878993628b7982b61de1001016b5`  
		Last Modified: Thu, 24 Mar 2022 09:57:47 GMT  
		Size: 143.1 MB (143141704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91f168bf1439d29006f333442f3beb0be64b57422a55e895ea2b713e1ff6b3f2`  
		Last Modified: Thu, 24 Mar 2022 09:57:28 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4cb34b2e9e5655cea49507c949401e756306bb36c115805591572cc07c449f3`  
		Last Modified: Thu, 24 Mar 2022 09:57:28 GMT  
...
```console
$ docker pull nextcloud@sha256:267d6b4e9b2a477309697545b743449cd9255c95f38ac9fb3d53852c597c1852
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.2 MB (197247255 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bcaac4efd49947e8a66599b50680dce54629c24bfe4459d7b08636cf3faef14`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 29 Mar 2022 21:59:57 GMT
ENV NEXTCLOUD_VERSION=22.2.6
# Tue, 29 Mar 2022 22:00:50 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 29 Mar 2022 22:00:51 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 29 Mar 2022 22:00:52 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 29 Mar 2022 22:00:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Mar 2022 22:00:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:458bdaf1548792ee89ed334fe64f65d241464a7f83db6c9b4cede8577cbed4b2`  
		...
		Size: 562.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a74719a256ad867f6f4dc9c21d9de8b541113b2c4b3b72c0a264e0728e263f74`  
		Last Modified: Tue, 29 Mar 2022 22:09:24 GMT  
		Size: 143.1 MB (143141808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41a55ec21659219fbb4b78b446cad8b4d2ad067fd30aae984621da655d1407d`  
		Last Modified: Tue, 29 Mar 2022 22:09:06 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d570f618cc91186306ec03af62265686714e0cc8a22327340a314646cf94472f`  
		Last Modified: Tue, 29 Mar 2022 22:09:06 GMT  
		Size: 2.1 KB (2138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
