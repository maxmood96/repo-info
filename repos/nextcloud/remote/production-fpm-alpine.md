...
```console
$ docker pull nextcloud@sha256:34ffc5280ec0818fc0efa10d7b5ca193165b4cf9dfc6797443add8e5d640cf94
```
...
```console
$ docker pull nextcloud@sha256:7a3a9d6d899211e1a176cbba42c74d915dd028977147783ce4f947d7a4426655
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.3 MB (254272144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88d2736f27a75da6ee047bfabdfb4a030ae4fe65aef6956a8a7029c27c4200f0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 18 Jun 2024 22:42:04 GMT
VOLUME [/var/www/html]
# Tue, 18 Jun 2024 22:43:20 GMT
ENV NEXTCLOUD_VERSION=28.0.6
# Tue, 18 Jun 2024 22:44:23 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Tue, 18 Jun 2024 22:44:26 GMT
COPY multi:c8e39871baf1efab774933f35bf66c1fea215c9e9350ee9a43890d8b4411246a in / 
# Tue, 18 Jun 2024 22:44:27 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Tue, 18 Jun 2024 22:44:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 18 Jun 2024 22:44:27 GMT
...
-	Layers:
	...
	-	`sha256:afee49811dae7ad1f59f080165d1ec5f04751dd9ac44bacd9504f66b710341b7`  
		...
		Size: 712.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40fede9d84b08e7804055ca355aff95591763cae57ddf14a6cbce54da6b2530a`  
		Last Modified: Tue, 18 Jun 2024 22:51:20 GMT  
		Size: 204.0 MB (203976699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fdb9c70800443961f64ab7d079ad31eeeb529f64844e9fba12d59534c8df8b4`  
		Last Modified: Tue, 18 Jun 2024 22:50:45 GMT  
		Size: 3.7 KB (3722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38e3b2b3fa787df2b1ced25d01a3971f802332e2aa58f015142808379a4a4e5c`  
		Last Modified: Tue, 18 Jun 2024 22:50:45 GMT  
...
```console
$ docker pull nextcloud@sha256:5f2c846daba55433c67e5e5b3484e2dadf1068bfaf2cdf26c5387e454fa7ed05
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.4 MB (254437991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b8df5e390b0c25d742f2a33016b0dd7e5530127ae298b4fa5ec8e6569ecae7e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:318cd2eb27a767c8394a2d53d413113fe10fb95a2b14a73f0a85b97b8bb5774e`  
		...
		Size: 712.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c52db1c7039e2f970703db7027c7c7bec22896ff84d641d86e3e2fe4ec5e37b`  
		Last Modified: Tue, 18 Jun 2024 23:31:18 GMT  
		Size: 204.0 MB (203976375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4277c371fbb7214161df291512f2d10d723bbc40e682ca8a2d7a8d6729eebc8`  
		Last Modified: Tue, 18 Jun 2024 23:30:39 GMT  
		Size: 3.7 KB (3723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:865a1b67c5eae717fffb37cda8c32feeaed38339f4f77a4697936eac95a523e9`  
		Last Modified: Tue, 18 Jun 2024 23:30:38 GMT  
		Size: 2.3 KB (2314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
