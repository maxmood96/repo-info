...
```console
$ docker pull nextcloud@sha256:7594d85ec750336438d32bc362e24bd6ca50f56b5fefa4bdc693c3ab1351cb32
```
...
```console
$ docker pull nextcloud@sha256:d866751eb8389a6b9019372122cb85898acb397163c6087aebf1ee330edd986a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (184986622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b1a5687774d7bcf5d0940592df53fba9c91b3ac8aa102fd6a69a7ce6ea698d5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 19:15:14 GMT
VOLUME [/var/www/html]
# Wed, 16 Jun 2021 19:16:10 GMT
ENV NEXTCLOUD_VERSION=20.0.10
# Wed, 16 Jun 2021 19:16:58 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 16 Jun 2021 19:17:00 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
...
-	Layers:
	...
	-	`sha256:9d236a330a2563625c3c4006c0c356417ccf4bfa484d2f14ecd39e30cb59de5b`  
		...
		Size: 589.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ed83fb209036ccc055493aebbd02af7991949cd04fd5ba22434314d49d49fee`  
		Last Modified: Wed, 16 Jun 2021 19:20:21 GMT  
		Size: 132.2 MB (132153349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a098c1e44ce3d0d439e420fa42ff3cc55e9685e1208bcc7271a7f59ff4f0e2`  
		Last Modified: Wed, 16 Jun 2021 19:19:52 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1200229ad0e0319a06ba2247498b31f62596752223b8e0bf100bd0a61c79980e`  
		Last Modified: Wed, 16 Jun 2021 19:19:52 GMT  
