...
```console
$ docker pull nextcloud@sha256:fb7311a4a6193ae8265ddaa59be085dd689830db361206e6b2cc7100b1eaea2b
```
...
```console
$ docker pull nextcloud@sha256:eed9baee7f240e72125f54de8209e68f44e0189b8c2f2f26df55ed4f9b8cd7c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207771937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be3eda0520853ee6492dd4051c0264d8f21bd9168263135f3251d2f3eb0345a2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 12 May 2022 23:49:12 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 23:49:58 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 12 May 2022 23:50:00 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 23:50:02 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 23:50:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 23:50:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0d7ec9ff7c77a9f5920e73add630f07f55fdd57cb972402e11acaf25ee5fffd8`  
		...
		Size: 566.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b17a587fd0ab7b14b1e6800d396d558fb18db2ffb2e13ce4f2d8bab60c8201fc`  
		Last Modified: Thu, 12 May 2022 23:56:10 GMT  
		Size: 153.8 MB (153804531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac16077d91490489271aa8c0d93e22369ce0050f39966270bd03a261d3fd1d7e`  
		Last Modified: Thu, 12 May 2022 23:55:49 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d912f2833b73a1b4206c85ee6efdfe58eccdf5a7c434a9343d1b299abc213dea`  
		Last Modified: Thu, 12 May 2022 23:55:49 GMT  
		Size: 2.1 KB (2137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:8e23d0d09389e8c60505f535ce07ff1c0f86dc2e6f0a03b5d20caa57c6eabf47
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.8 MB (209804360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfc535e71c61b05bc735b75535cea6f3ad3d67deefaabaf280338e10fb0b87a2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 12 May 2022 22:32:44 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 22:33:37 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 12 May 2022 22:33:38 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 22:33:39 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 22:33:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 22:33:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:36001c85833adf3c9019a2894580d27fcf1f392dda54ca733ae81ca4ae3221ab`  
		...
		Size: 565.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6422a4bd90d1bd2765d98b20e0f62af0fbac3a1f660e75e069fae2bf1f96674b`  
		Last Modified: Thu, 12 May 2022 22:42:37 GMT  
		Size: 153.8 MB (153804665 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a34b70c17d1fe2e504397b2eb91bed56a42bcaa6deee58b5bc5b03cef75ffab7`  
		Last Modified: Thu, 12 May 2022 22:42:17 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d05e7af3be4f756a4ab4c1ad0d18afaa4a993422b720aa54fdeb6ae1ea868e5`  
		Last Modified: Thu, 12 May 2022 22:42:17 GMT  
...
```console
$ docker pull nextcloud@sha256:d40bf1295623c97cdb39f40e43dcd5308a631ce3d579c06577de020749a93318
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.3 MB (207257926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d30bc091747a5eb25a2458b633088d45ece380add9fab3a8df81d8895b90f15a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 12 May 2022 23:23:30 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 23:24:10 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 12 May 2022 23:24:22 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 23:24:23 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 23:24:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 23:24:23 GMT
...
-	Layers:
	...
	-	`sha256:94b25a3ad864b6b3a9acee7ada5bc639a5bdb8d89ff3e19b3cfbf20305a44efb`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18334e0e9b8a09933b025e02d1b0d07d5e92eec64613bc0564e069c85b0d887a`  
		Last Modified: Thu, 12 May 2022 23:32:33 GMT  
		Size: 153.8 MB (153802681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d66208d39c47dc42548d97ff103b36cd8262e5c8f042ba901cb0ac30cee08e8`  
		Last Modified: Thu, 12 May 2022 23:32:17 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99332c118d0fcdfacc7666f9bbbb07ea84b1103636677e442cf1ad213da1f965`  
		Last Modified: Thu, 12 May 2022 23:32:17 GMT  
