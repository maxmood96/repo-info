...
```console
$ docker pull nextcloud@sha256:010f2019f8539c4609a3fdd4ac173105de50652206d1d3c26b604169f0955fe5
```
...
```console
$ docker pull nextcloud@sha256:0612deb617b6cd13835f4e548ad117f0f0f0f66a5f972918948e22755e779bc6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **236.5 MB (236492083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e4e8faf8034cd9a9ed3bfc81df851d3a571f40f4458769c94aef250be2aeb5b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 21:20:20 GMT
ENV NEXTCLOUD_VERSION=25.0.5
# Fri, 14 Apr 2023 21:21:11 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 14 Apr 2023 21:21:14 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Fri, 14 Apr 2023 21:21:15 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 14 Apr 2023 21:21:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Apr 2023 21:21:15 GMT
...
-	Layers:
	...
	-	`sha256:2c499310c37f76986fa9c2db03fab1d792dd836eefec439ba0e9edf5413904dd`  
		...
		Size: 609.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11ca3710ee0dad3ea4bdb4fd365a08c56db382e1a33445c17c183dc013fae90d`  
		Last Modified: Fri, 14 Apr 2023 21:33:07 GMT  
		Size: 160.5 MB (160459980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84765ed83dfdd3f47c51ed44b04df229f773af3a29717e83f655cd77228e9cb2`  
		Last Modified: Fri, 14 Apr 2023 21:32:42 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1825982f63243598d00d47f8b1852297fc32b3140519870938b4b03335d70a45`  
		Last Modified: Fri, 14 Apr 2023 21:32:42 GMT  
...
```console
$ docker pull nextcloud@sha256:2b1159d2b56516171c440b8fe89fb59e9cfd22fd16ba739bb512df39d6e4a719
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.9 MB (244928368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da0ce16bf0da7c279fc9c06b168695cc03013777ad6ca7bfb620fe15e8787bba`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:0ea9c174c66168fbfda903e57e0837317d98daee21b3db3c030de4654fb6746b`  
		...
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ba184f36cc8e702d4f6b35e8097b071d11e2b07d37bd2eafa26444c75b7853a`  
		Last Modified: Fri, 14 Apr 2023 21:35:49 GMT  
		Size: 160.5 MB (160460442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc34a82144dde02893dedafda9176dadd60f19824ca8bec6899114fe468cf4ba`  
		Last Modified: Fri, 14 Apr 2023 21:35:34 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4794cae464c167e1956000c5ee16f6cea2926099e9db343ba1a4121bc0948185`  
		Last Modified: Fri, 14 Apr 2023 21:35:33 GMT  
...
```console
$ docker pull nextcloud@sha256:9e6b21b559881088b8580426e7cc9db57cf33d8a56514b6450394f717f95d0bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.4 MB (245416088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc423023b9cd8f9c46012eb4649aea5598a7e3a3e3fcf268cdfa770935c22abe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 21:24:43 GMT
ENV NEXTCLOUD_VERSION=25.0.5
# Fri, 14 Apr 2023 21:25:42 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 14 Apr 2023 21:25:46 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Fri, 14 Apr 2023 21:25:46 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 14 Apr 2023 21:25:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Apr 2023 21:25:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b33bc963a9ebd6204d6ceb3002ed9c45ca47ccf8006420adbff93f222b4f7104`  
		...
		Size: 609.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6386464cf1a3a0cd464c58d04efd9432c0e83e92350522ee344236b0c5d014e`  
		Last Modified: Fri, 14 Apr 2023 21:41:06 GMT  
		Size: 160.5 MB (160460201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:112a7767cdb485e2d871cad14423fb28d1f34de0f11a66d23f24954f3af29976`  
		Last Modified: Fri, 14 Apr 2023 21:40:35 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fbf40e1aa492c2267b32198dc7026210bce79aa17f9ab277cd899e141a7097e`  
		Last Modified: Fri, 14 Apr 2023 21:40:35 GMT  
		Size: 2.2 KB (2223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:fc397755d48f0785ebdce6514450748c76137379f7ac3c390f4f97301419e1f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.7 MB (251686276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e1b2edbcc5ad28be946e159e0261ac16e496857efb5c0e9bdbb54ee00a7cb08`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 21:12:47 GMT
VOLUME [/var/www/html]
# Fri, 14 Apr 2023 21:12:48 GMT
ENV NEXTCLOUD_VERSION=25.0.5
# Fri, 14 Apr 2023 21:13:48 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 14 Apr 2023 21:13:56 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Fri, 14 Apr 2023 21:13:57 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 14 Apr 2023 21:13:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Apr 2023 21:13:57 GMT
...
-	Layers:
	...
	-	`sha256:784466d1a00cbb427c540a89edff0034a4891a13624f2597d09cc7aacdf121ff`  
		...
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9f03be1de6a2812f7937c21c23114deaa76b0a6c945da4d1930f6ef52fd6bac`  
		Last Modified: Fri, 14 Apr 2023 21:35:50 GMT  
		Size: 160.5 MB (160459953 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f92b5d18e5a400cd49cbfda63d1fe2519468ff158e78f22e6f5bae47b9953a6`  
		Last Modified: Fri, 14 Apr 2023 21:35:14 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f5535b00939e82006d9db565b8c0bb88e6f454c9433b7097ea31fd11351954c`  
		Last Modified: Fri, 14 Apr 2023 21:35:14 GMT  
