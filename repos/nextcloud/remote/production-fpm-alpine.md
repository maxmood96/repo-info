...
```console
$ docker pull nextcloud@sha256:03b14f002b79a9464371b65083c3a432df44ec60db9ba4bc61102d87a82147e9
```
...
```console
$ docker pull nextcloud@sha256:2c9025818b08847448c72328467c07da575f4564f9f55e272882040590515789
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157926807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04838589812c1f8ec902fcb4b2b645bfab8f23a50df5f8c33f746a6404c5a83d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 04:30:58 GMT
ENV NEXTCLOUD_VERSION=18.0.8
# Fri, 04 Sep 2020 04:31:47 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 04 Sep 2020 04:31:52 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 04:31:55 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 04:31:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 04:31:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:89a24fd6bb983844c53f257fbb740d1b795a79873225a4c985c0b9a280b9df75`  
		...
		Size: 530.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51935388de6249a68f0e011142497cca667beec65a84bda4cbe8f7c2f6320cb0`  
		Last Modified: Fri, 04 Sep 2020 04:58:12 GMT  
		Size: 104.0 MB (104027020 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1f1f7bd45d4041b7a60d2d84f06cfbdef93c22f2e519bf19aa284ef346b5ff1`  
		Last Modified: Fri, 04 Sep 2020 04:57:40 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef2152792fb19887c3e7fb5274ee6b9740088c91390a25b748e3d8176ec790cd`  
		Last Modified: Fri, 04 Sep 2020 04:57:39 GMT  
...
```console
$ docker pull nextcloud@sha256:569cfd626fafce20a7664640c08b4650980189135dcc1c8a332c50f03aeb96e0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.3 MB (163254384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aea7c1ff70c805535b358b3753c166e71505f3cf7e3899969b98626e13de1fcc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 05:01:31 GMT
ENV NEXTCLOUD_VERSION=18.0.8
# Fri, 04 Sep 2020 05:03:50 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 04 Sep 2020 05:03:55 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 05:03:56 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 05:03:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 05:04:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e5d2830c5ac855b21ea71ff17aa87f42dcce1b5d1751b528a674b57d44c43f3d`  
		...
		Size: 531.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edfa5a4958ea10dc54bd1f01602c015e7c580db66add5f9bd87ac31cad973afe`  
		Last Modified: Fri, 04 Sep 2020 05:57:03 GMT  
		Size: 104.0 MB (104027180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11f134949e0774aff4da2a9af76faa538b67f289b8d8aca9c1578190db2cec30`  
		Last Modified: Fri, 04 Sep 2020 05:55:18 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed2c7b4f01ccd609ca5eddd4ed689740a0c9bdf1702c2ad978018347a3bff65d`  
		Last Modified: Fri, 04 Sep 2020 05:55:21 GMT  
		Size: 1.6 KB (1648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
