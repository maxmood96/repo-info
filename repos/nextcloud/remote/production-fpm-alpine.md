...
```console
$ docker pull nextcloud@sha256:b2600adf261224b39619554293345ccd1ec615cbe505285c7b79b331d8c6676f
```
...
```console
$ docker pull nextcloud@sha256:4fa54d6fa65ea582204477e7d36bbd3a03338072fa9fba5738bffd1acdba84b8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157914570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:026befc52734d8121c9c5b1d3b13c6d03c4d6320e7c9384ff9ffe89dc8edd861`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 27 Aug 2020 22:19:33 GMT
ENV NEXTCLOUD_VERSION=18.0.8
# Thu, 27 Aug 2020 22:20:47 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 27 Aug 2020 22:21:14 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 04:35:45 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 04:35:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 04:36:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c264f5b3d12c497a07df54d2c0fa80e613da42a0ae1d7cf65710b8aaaaabde99`  
		...
		Size: 531.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b1de4b638be1f9f9e6d9e22050e1868c29c293f3ea15dba6a4ea83d44fc193a`  
		Last Modified: Thu, 27 Aug 2020 22:36:29 GMT  
		Size: 104.0 MB (104027026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56576431965d0ca717ec23394ddc9058757038c75c0f65e8c6fc9d963fb62cfc`  
		Last Modified: Thu, 27 Aug 2020 22:35:58 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d3bd38aa354cf20d345448f49acded40def64b3ff3a720f871dad98b18c1516`  
		Last Modified: Tue, 01 Sep 2020 04:58:01 GMT  
		Size: 1.7 KB (1651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:809044d1667d93deea5cd8688568cbaaea82a8da62edef716aa9d3707d434995
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.8 MB (160816346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9427fcfad9cf94b29f272aa11c6dd29d1e4ed5e613254534f2075af41de0732`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Sep 2020 08:44:28 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 08:51:10 GMT
ENV NEXTCLOUD_VERSION=18.0.8
# Tue, 01 Sep 2020 08:51:53 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 01 Sep 2020 08:52:06 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 08:52:07 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 08:52:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 08:52:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6be81053740951082a711771ee0923b023a6a45042616746aa85f4e3098acaac`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22e0ddf5d66dc89ba8861abad64faa6136aff6833316954ede2f945d63ac55f9`  
		Last Modified: Tue, 01 Sep 2020 09:13:05 GMT  
		Size: 104.0 MB (104027235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17653bd8f321a75d0f3baa34d8e9e73feba9262675417de98bcbc6b2d88c1f74`  
		Last Modified: Tue, 01 Sep 2020 09:12:53 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15c5b4354134c52d5b8fb759ecc6a0ac6e9f7a2db0c8ed004b4fc11fce526e64`  
		Last Modified: Tue, 01 Sep 2020 09:12:53 GMT  
