...
```console
$ docker pull nextcloud@sha256:039329386ff59368244fc8d16b3f44d0c574f5ac1ea18b477595d85ce81dc14d
```
...
```console
$ docker pull nextcloud@sha256:0bd807dd45db3cfe88f7dae667b660387fc158f9fcbc3ac8efa4ee779acd781a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159627434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7aab3379287668e2527b2901f1ec5c26f5f68b4555994e039352098b0e8d56d6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 01 Dec 2020 04:03:08 GMT
ENV NEXTCLOUD_VERSION=19.0.5
# Tue, 01 Dec 2020 04:03:57 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 01 Dec 2020 04:04:00 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Dec 2020 04:04:02 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Tue, 01 Dec 2020 04:04:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Dec 2020 04:04:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:adae39e0723188255ebd492966b70952824473f92afd0901c9f6399742931e1e`  
		...
		Size: 523.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9dcbaf699aad632781cda82f8bb15bc1bd7454252552503273c85e4ed77018d`  
		Last Modified: Tue, 01 Dec 2020 04:07:13 GMT  
		Size: 105.8 MB (105754508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd6c8fd764a4f5f02b2a492760e11c7e0472aa3e48342b860393093c22f9ea0e`  
		Last Modified: Tue, 01 Dec 2020 04:06:38 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a9f724827d6cef2fd0f272f30dbd305ae03797f88cde161a216d74d988779b`  
		Last Modified: Tue, 01 Dec 2020 04:06:38 GMT  
...
```console
$ docker pull nextcloud@sha256:bb24d94bf7375650bd1d77bb4c3b300111764969aba318ad19d0313c62c85cb1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.7 MB (162724843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0e10db801bb4d021979802376864f4a777cc294d7d7447025f2042379dfa262`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 19 Nov 2020 23:32:47 GMT
ENV NEXTCLOUD_VERSION=19.0.5
# Thu, 19 Nov 2020 23:35:01 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 19 Nov 2020 23:35:09 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 19 Nov 2020 23:35:15 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Thu, 19 Nov 2020 23:35:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Nov 2020 23:35:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d6ea9457b5d6f5f0ba3aef7f559731986d3bd65179f32e9e4a9cdf8240cb93f`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbbd98578e2461c2122e548fe0528e2d97298eec88bdf7da41c5fc6f1c01299f`  
		Last Modified: Fri, 20 Nov 2020 00:15:09 GMT  
		Size: 105.8 MB (105754424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:605ece17ad31bcd592ae6853832c5a92d7aef9f6d200414edbab956b3f09158f`  
		Last Modified: Fri, 20 Nov 2020 00:13:10 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:950b97e9115621d77c728978c51f9102d93f403b3a93a5b6403b830f7d839ac5`  
		Last Modified: Fri, 20 Nov 2020 00:13:11 GMT  
