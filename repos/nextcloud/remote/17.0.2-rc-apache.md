...
```console
$ docker pull nextcloud@sha256:836f06d851848288bb847753528eaafec0d2103b9eb2866105d640afe356bfb5
```
...
### `nextcloud:17.0.2-rc-apache` - linux; amd64

```console
$ docker pull nextcloud@sha256:ea75b2a7556203e29416da0c3f6f988445f6d458e9f03dd41f4efba795799b3f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.4 MB (238423637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90726f39829065bfebb83df7d049fdc052f9652ec55e3452bf9271e33cb2a80c`
...
-	Layers:
	...
	-	`sha256:dd9ca2253ea8d0ca7bd7b2aefe8315af642006c1a1c287f49f74ba1bbae62a43`  
		...
		Size: 539.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30a65c8b5587523185bb90bdcc8dd9124c4abf6ae204073d4813f08f02caf511`  
		Last Modified: Thu, 19 Dec 2019 05:31:09 GMT  
		Size: 71.6 MB (71617982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8ef82eae8a13bd701cb7d74683cc637ccaab7645aba421761d7f8c09bb4fbbf`  
		Last Modified: Thu, 19 Dec 2019 05:30:48 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a066762ebfeb728384d1de3fda4256d2a2b059f8f277e0e050e5e7d576cf3f29`  
		Last Modified: Thu, 19 Dec 2019 05:30:49 GMT  
		Size: 1.1 KB (1136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.2-rc-apache` - linux; arm variant v5
...
### `nextcloud:17.0.2-rc-apache` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:1b7dd2272841879c6f1a6bb0189b961d88aee7e828568df2ee6c748bdad8aa3a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.3 MB (211330927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19ceb3d204a0f2653815a5a95e83305535bf2754b224c5361e8fcc9910105093`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Dec 2019 04:27:26 GMT
ENV NEXTCLOUD_VERSION=17.0.2RC1
# Thu, 19 Dec 2019 04:28:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 04:28:18 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
...
-	Layers:
	...
	-	`sha256:fa93e838a721287e455fb4099bb0643fb04b2cbaddba73b5f96227d05a525959`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84240d796736793046d08700869a494aa3737f8eeebf2740ff7a6ae2347f717b`  
		Last Modified: Thu, 19 Dec 2019 04:57:26 GMT  
		Size: 71.6 MB (71616348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:761812c0b06783b622d8f345542ddc1c4f9af270feaf88db2293dffa561b0bf7`  
		Last Modified: Thu, 19 Dec 2019 04:56:57 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41b2451a345faa573d380ac4200145286ff73a0253a8f1a27358033fbcb34722`  
		Last Modified: Thu, 19 Dec 2019 04:56:57 GMT  
		Size: 1.1 KB (1137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.2-rc-apache` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:4f8d9df55ec406f439f6c8da4fdc4d2e6d81ece0a82a6f31207e8952c446053f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.8 MB (228751950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea34ef05519f42e20de1f62f5661f8305c4f2d6b9aaba8f0ef9bbc640d540443`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 19 Dec 2019 05:21:34 GMT
ENV NEXTCLOUD_VERSION=17.0.2RC1
# Thu, 19 Dec 2019 05:22:27 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 05:22:32 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
...
-	Layers:
	...
	-	`sha256:53e89a2f9068ea92d782d201f5014863e713ffbb4f1e56ed05dde0ed95db004f`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b60305215a8258f1c5eb6854311b9caa9101bcff84a40680b48b6f499ba284f`  
		Last Modified: Thu, 19 Dec 2019 05:52:20 GMT  
		Size: 71.6 MB (71616960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f28e328c97dc074f9bcf3db4ee737a7b4b1c9ca90d8db096cbe61f99762ca3a`  
		Last Modified: Thu, 19 Dec 2019 05:51:57 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a565fa3233344e62b1365edf7dd91f6a14127634311e52999b7c870686264783`  
		Last Modified: Thu, 19 Dec 2019 05:51:57 GMT  
		Size: 1.1 KB (1138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.2-rc-apache` - linux; 386

```console
$ docker pull nextcloud@sha256:5611fa77aba136935d28739d5bb7c0d65508cea785322942cf8527c81ef12345
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.7 MB (243737410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fab3af49442d6b49933fe13bf4b8135989bf7ac72f636c9b84f2ae24729b0eb0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 19 Dec 2019 05:30:07 GMT
ENV NEXTCLOUD_VERSION=17.0.2RC1
# Thu, 19 Dec 2019 05:30:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 05:30:41 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Thu, 19 Dec 2019 05:30:41 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Thu, 19 Dec 2019 05:30:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Dec 2019 05:30:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2ecf33332b7da48b203093366c9a40ee53cfc1ffe64901805a54f79a728e6229`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52586ff0065da9017c0df07014f7e42a1c673ee9af2315dd9ebb68d40323b575`  
		Last Modified: Thu, 19 Dec 2019 05:50:07 GMT  
		Size: 71.6 MB (71617134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fe14f7227e941de95dde24b37ea578f9c53754dc6054aa55bb3db6c309e0abf`  
		Last Modified: Thu, 19 Dec 2019 05:49:34 GMT  
		Size: 2.1 KB (2097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d194aa95225927b230b680f0357a8e00c8db8a590bd9404689b175860170735c`  
		Last Modified: Thu, 19 Dec 2019 05:49:34 GMT  
		Size: 1.1 KB (1136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.2-rc-apache` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:ea5465c599231ec829c5e1d5f46d094a71bcad31cd14cf234ce739c3a2e1ec8e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.0 MB (250003151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03b30bfb0ff97b7d8a8b8e3146a832523e92dc181566732b7299df044abe2ca8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Dec 2019 05:29:06 GMT
ENV NEXTCLOUD_VERSION=17.0.2RC1
# Thu, 19 Dec 2019 05:30:42 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 05:30:48 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Thu, 19 Dec 2019 05:30:50 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Thu, 19 Dec 2019 05:30:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Dec 2019 05:30:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e3dd35d9d9246e4a1f9aa76c56431c146586c20c3c2154dbbfbe6cf5a7a55d53`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba0d798fc476c7d07350d67d0084fabccbe0fd262f1059e1e09879d789b58b8e`  
		Last Modified: Thu, 19 Dec 2019 06:14:59 GMT  
		Size: 71.6 MB (71618997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12c351f49434c6b542a1f6c867c6fadaa174fcea1b951b1e20abc81c1bceb114`  
		Last Modified: Thu, 19 Dec 2019 06:14:01 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ee9c4b5fa63b91ba0a73d1bf7fa3bf284f47c20e3edec0f6482821045fe2a5c`  
		Last Modified: Thu, 19 Dec 2019 06:14:02 GMT  
		Size: 1.1 KB (1137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
