...
```console
$ docker pull nextcloud@sha256:42f3f42861b7c9678ab91c9ffa7f538139dc3a8f281871dc3a458e8caaa658ea
```
...
### `nextcloud:27.1.9-fpm-alpine` - linux; amd64
...
### `nextcloud:27.1.9-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:27.1.9-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:27.1.9-fpm-alpine` - linux; 386
...
### `nextcloud:27.1.9-fpm-alpine` - linux; ppc64le
...
### `nextcloud:27.1.9-fpm-alpine` - linux; s390x
