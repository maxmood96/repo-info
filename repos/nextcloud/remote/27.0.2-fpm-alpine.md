...
```console
$ docker pull nextcloud@sha256:5cd73a81e4489c5db4b5e44cdafe984b5d1f17819a1e14ed2429415592f61a6e
```
...
```console
$ docker pull nextcloud@sha256:c71aadcf9f39bc29101340b470db54ee9c9c33f9a181afd7dc8ea1dfc4b6cccf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.8 MB (267794013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2a1a59716a8b5b9354807f64e91f45a9acb905bd57ea83940631aef563ef621`
...
# Wed, 09 Aug 2023 12:07:20 GMT
VOLUME [/var/www/html]
# Fri, 11 Aug 2023 18:31:23 GMT
ENV NEXTCLOUD_VERSION=27.0.2
# Fri, 11 Aug 2023 18:32:16 GMT
...
-	Layers:
	...
	-	`sha256:3ab9280a974fc879603406637e7857f5ee99db2e654f3fcafd2ec8ccb6e1a635`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0963a2d2ad47914a03d68f621e7035e75e1acc821854ab64123286f354bf1c7`  
		Last Modified: Wed, 09 Aug 2023 12:10:36 GMT  
		Size: 45.0 MB (45029146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d44dbadc948e940aa6d14945599aedd47d7e32bcd975684fb59f9b7e84adcbf`  
		Last Modified: Wed, 09 Aug 2023 12:10:29 GMT  
		Size: 7.0 MB (6952295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45066c848bc6bf857104e487e9489a5d96a97994dee4ba6bd687929bab336436`  
		Last Modified: Wed, 09 Aug 2023 12:10:27 GMT  
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:580b1e66eabb0f51687fdbf684775482e1cf01c570c71fcce2b0695d190cb24b`  
		Last Modified: Fri, 11 Aug 2023 18:38:25 GMT  
		Size: 185.0 MB (184954963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e57732079cdaf7824176769f00874f79d81b7c5c438bdc2dd8dac82cc09e56e9`  
		Last Modified: Fri, 11 Aug 2023 18:38:04 GMT  
		Size: 3.6 KB (3609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:867da936b3e4cca46ead828948d56baa395ac80b54ecc64b963e85c4d056ca08`  
		Last Modified: Fri, 11 Aug 2023 18:38:04 GMT  
...
```console
$ docker pull nextcloud@sha256:2373cd4ed0416791e586353a97c776568b39a589536f0a51afd4432f8fbb8bb6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.0 MB (273033326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8e8e6340c20169abd2844c0b636156fbcf0a1516844cfdbeea3dcab1c26365f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;         apk add --no-cache         imagemagick         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Wed, 09 Aug 2023 12:27:54 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         gmp-dev         icu-dev         imagemagick-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libwebp-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         gmp         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.22;     pecl install imagick-3.7.0;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;         docker-php-ext-enable         apcu         imagick         memcached         redis     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .nextcloud-phpext-rundeps $runDeps;     apk del --no-network .build-deps
# Wed, 09 Aug 2023 12:27:55 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 09 Aug 2023 12:27:55 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 09 Aug 2023 12:27:56 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     mkdir -p /docker-entrypoint-hooks.d/pre-installation              /docker-entrypoint-hooks.d/post-installation              /docker-entrypoint-hooks.d/pre-upgrade              /docker-entrypoint-hooks.d/post-upgrade              /docker-entrypoint-hooks.d/before-starting;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Wed, 09 Aug 2023 12:27:57 GMT
VOLUME [/var/www/html]
# Fri, 11 Aug 2023 18:30:43 GMT
ENV NEXTCLOUD_VERSION=27.0.2
# Fri, 11 Aug 2023 18:31:55 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 11 Aug 2023 18:32:02 GMT
COPY multi:460d0253b10a0268ebfb8482b4fa36d0d335e8207e35802a68bf2d6134195fbb in / 
# Fri, 11 Aug 2023 18:32:03 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 11 Aug 2023 18:32:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Aug 2023 18:32:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:be4e4a0148839f2ccd0660d29f0f94b7a9f61c6776b18a56710a7d6ce719e234`  
		...
		Size: 9.2 KB (9182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5bee98a3130590d47e7c0882678f16037adeea083fc66357c3a11d3be926779`  
		Last Modified: Wed, 09 Aug 2023 12:33:17 GMT  
		Size: 49.9 MB (49896575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feaed11aece9fb651caced993283dbe7336ed0b8147cf6cce7ab6d0f441ffe3a`  
		Last Modified: Wed, 09 Aug 2023 12:33:05 GMT  
		Size: 6.9 MB (6880444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38df013b648f188ca8d86f619d8691d4510a6bc78d2cc438f89799e3bc22d5e4`  
		Last Modified: Wed, 09 Aug 2023 12:33:02 GMT  
		Size: 760.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e149a10c7403d06889fd3022e773a1966ae1a2e7613142ada93df043c50b418b`  
		Last Modified: Fri, 11 Aug 2023 18:42:29 GMT  
		Size: 185.0 MB (184954921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67a7a4cb8a93da5ec7ef5870250a582b9e3850d51b2a3a0477e6773137bf1fab`  
		Last Modified: Fri, 11 Aug 2023 18:41:52 GMT  
		Size: 3.6 KB (3609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:408bcccd42aca775370dff68a57025aba1c54518c70a1b2c7fe93536033bde33`  
		Last Modified: Fri, 11 Aug 2023 18:41:52 GMT  
