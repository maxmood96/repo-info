...
### `nextcloud:34.0.0-fpm` - linux; amd64
...
### `nextcloud:34.0.0-fpm` - unknown; unknown
...
### `nextcloud:34.0.0-fpm` - linux; arm variant v5
...
### `nextcloud:34.0.0-fpm` - linux; arm variant v7
...
### `nextcloud:34.0.0-fpm` - linux; arm64 variant v8
...
### `nextcloud:34.0.0-fpm` - linux; 386
...
### `nextcloud:34.0.0-fpm` - linux; ppc64le
...
### `nextcloud:34.0.0-fpm` - linux; riscv64
...
### `nextcloud:34.0.0-fpm` - linux; s390x
