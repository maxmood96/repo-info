...
```console
$ docker pull nextcloud@sha256:cce93fcd79a9403864a788e9f66c46a83dec97114e9d35e5853a622d43ba46e9
```
...
### `nextcloud:31.0.11-apache` - linux; amd64
...
### `nextcloud:31.0.11-apache` - unknown; unknown
...
### `nextcloud:31.0.11-apache` - linux; arm variant v5
...
### `nextcloud:31.0.11-apache` - linux; arm variant v7
...
### `nextcloud:31.0.11-apache` - linux; arm64 variant v8
...
### `nextcloud:31.0.11-apache` - linux; 386
...
### `nextcloud:31.0.11-apache` - linux; ppc64le
...
### `nextcloud:31.0.11-apache` - linux; s390x
