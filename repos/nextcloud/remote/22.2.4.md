...
```console
$ docker pull nextcloud@sha256:2c9f924d67a962a53ef151817547e94c901eb8fa7161518032817d4ee5d9fb97
```
...
### `nextcloud:22.2.4` - linux; amd64

```console
$ docker pull nextcloud@sha256:d616d1bf76a1e2025ca75d56bfaacb4c13b9200bd0d4ab0dcb0ac0e9378c80bc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.1 MB (330096170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23aa40f156c700b39ee876ab261d63d62d682a8708d5196b4217ff415ae4f08b`
...
-	Layers:
	...
	-	`sha256:5e5f51ff61eecc2f19f1d583d2b0d96d81d78e6fe654e9150cf2eb6e990dc701`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91247b16b3c22e977a20faf9d13499ee371ed10f6a92e161845112152da624e7`  
		Last Modified: Fri, 04 Feb 2022 05:25:43 GMT  
		Size: 143.0 MB (143036845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7df2e8f3834888d4c3d963f7cd2ec07b8febce24c45495651d7ff42c08851bc8`  
		Last Modified: Fri, 04 Feb 2022 05:25:23 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6179b5c77d66a536ab13e16c516286cd5a2f8628c61cbc669756e052ee9396ed`  
		Last Modified: Fri, 04 Feb 2022 05:25:23 GMT  
		Size: 2.2 KB (2200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:44f69f8e8a32fae550b846cf995e36455de01b3bfc0992645db6bfd547d67056
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **305.4 MB (305371300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c965be7a2bbc6c09c9f8e1709374774e1a6546ca70c304f1cfe4a63f9bcf3863`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Feb 2022 02:16:10 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 02:18:01 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:dd0edc7f5c749084ad7c452b07bf906cb461463b1b9d881c4fa936099812b5b5`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1005356525500396bb59c8453204d4c798b8247224a52bf3fda315234c04689`  
		Last Modified: Fri, 04 Feb 2022 02:39:19 GMT  
		Size: 143.0 MB (143035873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9239d13dc9cbcd1735e64599a28dfd42a62a617a76fdda33ea53943dd658a4e6`  
		Last Modified: Fri, 04 Feb 2022 02:37:43 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:451e4d1cf7e998ef8c21dec15bc5b6061688636653b06f1040e0bf17cc7002bf`  
		Last Modified: Fri, 04 Feb 2022 02:37:43 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:12c0b91f8a6f271991694724876ed0a0a1dce5eb50a6f1e1eec76816b3bbdb4d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.1 MB (296130141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4b87e4e94ddb39397eb2f85e2f254bb64b1a0d96ad9ccacd0278bb31334f66c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Feb 2022 02:30:25 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 02:32:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 02:32:09 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Feb 2022 02:32:11 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 04 Feb 2022 02:32:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Feb 2022 02:32:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e81f67f21351a1ba2f8e1e4d93dbf6b7238e5eef121e02bcd60b2200301fed35`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b985a804036377fb6b2631d823685c45cca611d3c220ea03ea0dce3713ae1a34`  
		Last Modified: Fri, 04 Feb 2022 03:03:45 GMT  
		Size: 143.0 MB (143035892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:755d3c2ac9ebdbac213e95865145c3693d3ae32f195009e3b8c3dec556ff4063`  
		Last Modified: Fri, 04 Feb 2022 03:02:35 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dd5aef0cfd33c5fe6ed711b7cbd74bca7cc631ba3dcc9a136284e00c3ed69e5`  
		Last Modified: Fri, 04 Feb 2022 03:02:34 GMT  
		Size: 2.2 KB (2204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:5610c919ba8c5dee77c4f2e1262743969646bdd8204fb52925d825ac8b1933fb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.1 MB (320051048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba086978106241dfd9b2bc50171c175c9fc48120d9da8daf1957948e13ef7bee`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Feb 2022 03:48:30 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 03:52:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 03:52:11 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Feb 2022 03:52:12 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 04 Feb 2022 03:52:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Feb 2022 03:52:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b63cda99e1ba5edf8e0c2f144800d427c96beaf2109bf2929cc2770d5d3a7431`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7450308fd3d5669c9629df92e70ccbff5f28fe79c3a0c0dfbcc8bd972711a8a8`  
		Last Modified: Fri, 04 Feb 2022 04:10:42 GMT  
		Size: 142.8 MB (142796160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1b3d2f5ccce24c2ff2ced9c1e1952875475a0e92fd626c15862e604775e25b4`  
		Last Modified: Fri, 04 Feb 2022 04:10:21 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7704a40e7864a9319f8c9772c8debeb9b4afc008cbed912efd7cedba205ceaee`  
		Last Modified: Fri, 04 Feb 2022 04:10:21 GMT  
		Size: 2.2 KB (2203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; 386

```console
$ docker pull nextcloud@sha256:af15f8618646f4a2c583eb4b207aace7a8ae1381433692afd973536de46a747e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.3 MB (332292006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3235ed08431e7596a4b1e0e05011e10395ddb226c6fa7a96e16dbe2345108771`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Feb 2022 01:51:43 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 01:52:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 01:52:58 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Feb 2022 01:53:00 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 04 Feb 2022 01:53:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Feb 2022 01:53:00 GMT
...
-	Layers:
	...
	-	`sha256:b9a804abf9cbe00511e2d0bc55c2fb9d732266db734ec2b53101c004442fc062`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8f3a59fe49563772717bac54e0d473a62bc8eda367ace31e76362896eb4e204`  
		Last Modified: Fri, 04 Feb 2022 02:10:58 GMT  
		Size: 143.0 MB (143036509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad849c5f2711eabb868ce01f12435691bf8ed9ed9148d5b9695279349af06e1a`  
		Last Modified: Fri, 04 Feb 2022 02:10:26 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3236826c20532a41a7e7e39e411a623ac28ceeb8dc6f58edf53bfc4d771f7a42`  
		Last Modified: Fri, 04 Feb 2022 02:10:26 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; mips64le

```console
$ docker pull nextcloud@sha256:c50ca7ea00cf4c947f811e0640a8d190451191e2338e91cbfee69412bc27bc6e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **305.2 MB (305208942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6177b58122c45cbe61235b5184debffe525b0a7156ded15b98948ca5cd44a46b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Feb 2022 02:36:18 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 02:38:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 02:38:23 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Feb 2022 02:38:25 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 04 Feb 2022 02:38:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Feb 2022 02:38:25 GMT
...
-	Layers:
	...
	-	`sha256:f1f9ccae9e0cd1c77280271b8f30d13a9ea5c85d036f1d0a8694c9723bddd34b`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fcc2bbea0c746752f5ad7a2bd3b5fce39074f8a33f3730d4f6ed7cef1cbcdc9`  
		Last Modified: Fri, 04 Feb 2022 02:59:33 GMT  
		Size: 143.0 MB (143036005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:997c00efb8775c6b7390b6a8fae93c542f1fc3d093769d5d87b80860c65c8971`  
		Last Modified: Fri, 04 Feb 2022 02:57:59 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a25c12da0d7300848e909a4d35b40b524c958ad807dece47ac2b20df8aba6d0`  
		Last Modified: Fri, 04 Feb 2022 02:57:59 GMT  
		Size: 2.2 KB (2204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.4` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:cdb1db45ccace207af40a07243fea3d072cc157eaa4baa47ce887efa5dece7f7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **330.6 MB (330610170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d93b343c75d54ca8afba1a271faaa31211093f6b28b031d0f0e26194e56cd44`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Feb 2022 04:53:33 GMT
ENV NEXTCLOUD_VERSION=22.2.4
# Fri, 04 Feb 2022 04:55:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Feb 2022 04:55:46 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Feb 2022 04:55:48 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 04 Feb 2022 04:55:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Feb 2022 04:55:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7e37e437b17ddbf42f500cf61f2fc1415d966f872fd853ee37eb465004248bb0`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f61654e523089d362a386c338201b00818e9b7aea3328793af0745500f1c5f5f`  
		Last Modified: Fri, 04 Feb 2022 05:03:16 GMT  
		Size: 143.0 MB (143039165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7815c423c1ac1a216a99e559b0faf6b4ec041f63dc8fe3bbca57d523fde0bad5`  
		Last Modified: Fri, 04 Feb 2022 05:02:51 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c06f831e81d02caac275f08e4f301381d2ec074d051fda4f6563b10a5f34f7b`  
		Last Modified: Fri, 04 Feb 2022 05:02:51 GMT  
		Size: 2.2 KB (2203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
