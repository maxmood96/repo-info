...
```console
$ docker pull nextcloud@sha256:3777f0e5f0b3cb07f27ffee7891a056ace8a2a64cf23c20f4c56af770fc4c97f
```
...
```console
$ docker pull nextcloud@sha256:6531373cc9e256f6e752305992e339dba157ceeda23dd8957cc502892dd815fd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **409.3 MB (409310330 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddf456e71bfe0184ef0a2485ca6446084cb5effe1ec1c98d56d460de3b3d8b11`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Oct 2024 18:55:10 GMT
VOLUME [/var/www/html]
# Fri, 18 Oct 2024 18:58:16 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 18:59:33 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 18:59:34 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 18:59:35 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 18:59:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Oct 2024 18:59:35 GMT
...
-	Layers:
	...
	-	`sha256:97c46815e3e850aaf8c2268bd2b4d8237220816e227abac49878d7a163ec2a2f`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:936e5089644459b16a32981c69a3d90bea399c1a73710ef6f368b17475ca666a`  
		Last Modified: Fri, 18 Oct 2024 19:06:21 GMT  
		Size: 221.9 MB (221891335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48f16136f286f2d2adaf7e10bd65760079138aee9b3214500c0b27f53fd54049`  
		Last Modified: Fri, 18 Oct 2024 19:05:38 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba2220dc045a1346f2e84faf20670b577aeb823156cd21055f5d0038dcfc77ad`  
		Last Modified: Fri, 18 Oct 2024 19:05:38 GMT  
...
```console
$ docker pull nextcloud@sha256:156dfb5ee2c2ee608e34d88498e2ac651b65a05942365ff66784590790da1e71
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **444.5 MB (444486189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d381d243e7539e896f4139ab137bdab01f8ecfe43f2cb1334d56c2345ae84ff2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Oct 2024 19:28:33 GMT
VOLUME [/var/www/html]
# Fri, 18 Oct 2024 19:35:17 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 19:36:24 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 19:36:32 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 19:36:32 GMT
COPY multi:af4bb8c26c1511a6846e44b443f26a7467bec8f794146b4ea5c0522b7d3a37be in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 19:36:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Oct 2024 19:36:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:64f0eebf212a9275d4026219d6a1ddc0361c4c0b673d9ed4a0afbff8ac9dcc53`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab243a87da96556c46cc5fba1963ad46e1dd2c3f15a7aa1807db5abb374bc917`  
		Last Modified: Fri, 18 Oct 2024 19:46:46 GMT  
		Size: 221.9 MB (221894070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:456b0d30b34c94bf9ff1cc2c755069494f04a60977b43fdd007282f086a4f5ce`  
		Last Modified: Fri, 18 Oct 2024 19:46:01 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c1ce7f5e4a87a8d8c2d5d4a8cc0c88607ab53991d53305752ef2788160fffaf`  
		Last Modified: Fri, 18 Oct 2024 19:46:01 GMT  
		Size: 2.4 KB (2369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
