...
```console
$ docker pull nextcloud@sha256:6f6491a30956c34dc9bd3260034a7bd17ee72d81f32eaab5a58544224d0ae08b
```
...
```console
$ docker pull nextcloud@sha256:899bdb61b676b2f19e68b2cfef2fb6b310b4ed1002950430cdeceaf531a5fe46
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.4 MB (199405003 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:735865be9feea34e2d7f9ae7caf7f9af5e2c93f012445f83891e1b833beec77a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 07 Jan 2021 20:05:41 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta2
# Thu, 07 Jan 2021 20:06:52 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 07 Jan 2021 20:06:58 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 07 Jan 2021 20:07:01 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Thu, 07 Jan 2021 20:07:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 07 Jan 2021 20:07:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:629ab022e8fa468888d227e54ca614e2fefc8dd7b303ac461ad1acfd596ae98a`  
		...
		Size: 526.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45e6b551dd33513c76b2fbbcb3a9225e034dbe7e5182a0a2c3a4caf0d131bac9`  
		Last Modified: Thu, 07 Jan 2021 20:10:56 GMT  
		Size: 145.9 MB (145902645 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:906cf116ac77d9144cb5d60a1dc4ad6b5f38ba6509cd05727016bea39cd9581e`  
		Last Modified: Thu, 07 Jan 2021 20:10:04 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87358600d61436d75da606e94689428d5fefdef5a12fe4a90e10cb0fd13d7ee1`  
		Last Modified: Thu, 07 Jan 2021 20:10:04 GMT  
