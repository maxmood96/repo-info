...
```console
$ docker pull nextcloud@sha256:e781844c591f0ae3d8f3da06dfb63a7f00c1cedcdfebc61081003ada9a9328ea
```
...
```console
$ docker pull nextcloud@sha256:ef183adbfa7d547886552412fe876bfafd5c6b5123c5e71d4347b6fd9583a595
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **428.0 MB (428023075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7b2616228297ec7ca2ac84d004437df9cb81eb6ecc5d0e77a60883391f1cc1d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 24 Apr 2024 19:17:29 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 19:24:26 GMT
ENV NEXTCLOUD_VERSION=27.1.8
# Wed, 24 Apr 2024 19:25:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 19:25:48 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 19:25:49 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 19:25:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 19:25:49 GMT
...
-	Layers:
	...
	-	`sha256:8dec0d77baa04d831397adceb2b9c4c1741d8f4bc34dc81fabd616cb13930a8d`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71df286eeeae65cb05176ab8c9f2826779e76c920ccdf2fecec6f466c85ccaae`  
		Last Modified: Wed, 24 Apr 2024 19:33:22 GMT  
		Size: 208.0 MB (208020629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37f6ee7151d1f2916496e30548c914d4794b3d24f13d781e2010829de9e4d22b`  
		Last Modified: Wed, 24 Apr 2024 19:32:43 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f29bf6ff0c3393545500c0ca0fbb6470f85d25f1c9e38ed6d464c02d73f426b`  
		Last Modified: Wed, 24 Apr 2024 19:32:42 GMT  
...
```console
$ docker pull nextcloud@sha256:90a95424ee1ad551c7ca817bb09f4faac109185fcbb6e3c2983a43afaa87cef7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.5 MB (400477763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c904a825f1e1fddd7f20ed5bec1ed46aa28a028385d9dc67e58dfeecd0e919b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 24 Apr 2024 18:51:25 GMT
ENV NEXTCLOUD_VERSION=27.1.8
# Wed, 24 Apr 2024 18:54:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 18:55:02 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Wed, 24 Apr 2024 18:55:12 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Wed, 24 Apr 2024 18:55:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 18:55:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:844007c85a5a63be5c74e0ef993ee54dbbd724a06f17f1da2b9002e006e6f620`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52154dec57d346f75d4cc7f0ce2b221af51bbb0631337d8b211224f75ff38e94`  
		Last Modified: Wed, 24 Apr 2024 19:16:02 GMT  
		Size: 207.8 MB (207793267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b791e8e9bcacefe03362ac59aae133bfaac03aa2d9f1a0989202a3db3366d784`  
		Last Modified: Wed, 24 Apr 2024 19:13:56 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eb5207d5cbdfd8f8f7af37ea17c130379f1498918db084a37bbc71c81f5ef5a`  
		Last Modified: Wed, 24 Apr 2024 19:13:56 GMT  
