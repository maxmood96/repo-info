...
```console
$ docker pull nextcloud@sha256:d4bc80bdd2896b00373d693afd7b491a19143f15bbb56280d826ac9b941d0a41
```
...
```console
$ docker pull nextcloud@sha256:40be11f6b832e1f931ea2da74a70b5778c7f3f68b634b1943bd31de5db1a297b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **427.2 MB (427208127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b4e358c156aedfd19183481314067156806f1a50a6fe4e52dc586a70896b928`
...
-	Layers:
	...
	-	`sha256:8331a04fbad756e0864c8868dd63c71bc121e3a0adcc3b4c9b8e9b3ee7a4cea5`  
		...
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8f4cc3da9bc1a0bec45e8d68361368ba2e265d600fe7c533acfa9840eec1215`  
		Last Modified: Fri, 07 Jun 2024 00:50:34 GMT  
		Size: 205.8 MB (205802231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87c89addf54e79d6a478ffe0c28d306d6d4a48984dba8bb21aeb6cda75c94217`  
		Last Modified: Fri, 07 Jun 2024 00:50:09 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca99a55e81ff96be775b2f643f72a74c35c0e1adc2ccef4c7665f6c688883f7d`  
		Last Modified: Fri, 07 Jun 2024 00:50:09 GMT  
...
```console
$ docker pull nextcloud@sha256:9e463e9dd3a93428db27c406b6175c943673834239038305ba79c8b784151ffc
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **396.8 MB (396753566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:367ea51e2667a62e284a36bfb4ea97c9f674a3fe76d30c33b1fe656194815ce3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 23:49:20 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Thu, 06 Jun 2024 23:50:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:50:14 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 23:50:15 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Thu, 06 Jun 2024 23:50:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Jun 2024 23:50:15 GMT
...
-	Layers:
	...
	-	`sha256:1b86cfad4e0158e00d0f406a41c0256413bcf34cb8c89466b7d01f1fe374c43e`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:307a4dcb7764463979a022ef6d28e4fec4c9820f3e18fb48a419ebac0750f73e`  
		Last Modified: Fri, 07 Jun 2024 00:07:08 GMT  
		Size: 205.8 MB (205799710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8de38aaf990573c2aab0029725979ca7977d1d1cf285fbe8f50ecd837635e276`  
		Last Modified: Fri, 07 Jun 2024 00:06:37 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0dcec4272794215c6846483f3922c54960754fca0aed606240707f8b911b646`  
		Last Modified: Fri, 07 Jun 2024 00:06:37 GMT  
		Size: 2.4 KB (2396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
