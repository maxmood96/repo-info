...
```console
$ docker pull nextcloud@sha256:d7a5e3f4b5c040bc989d51a75630733d29ac72b5275923a0c24538a43df9a7a1
```
...
```console
$ docker pull nextcloud@sha256:94a43d55e978c1d0aa5dd87700a1a7d2dad145a188758d1457e40e2fb32230c4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.1 MB (397090046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae63bb0e57a9514beae870de026dd04f0fb63a1f61ac2054d86d3fa078e35b25`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 26 Jun 2024 19:48:24 GMT
ENV NEXTCLOUD_VERSION=27.1.11
# Wed, 26 Jun 2024 19:49:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 26 Jun 2024 19:49:40 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Wed, 26 Jun 2024 19:49:40 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Wed, 26 Jun 2024 19:49:40 GMT
...
-	Layers:
	...
	-	`sha256:93bc3a07cd8e1200371a8cd921733b775291586ae05a477a75e7e2bf35098989`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ffea7c1163a1e3e6fd43bdc687c139081102c7279217a34a0e3ff1d3c0e870c`  
		Last Modified: Wed, 26 Jun 2024 19:58:04 GMT  
		Size: 206.2 MB (206189852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4176d817801d4144890256344b22f5886df3b6952be102b314cc94c338d0feb7`  
		Last Modified: Wed, 26 Jun 2024 19:57:20 GMT  
		Size: 3.9 KB (3872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19737b59ad96bfee7f2a8a0ed9b66436b8052628249303ef8661b112d99fcce7`  
		Last Modified: Wed, 26 Jun 2024 19:57:20 GMT  
		Size: 2.4 KB (2372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:ef18af5588c6bb1ba8b22ee9eea8407644e9912bdff9b39bf9b5a97d66807b23
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **419.0 MB (419000630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a780cd6c61a890518fc9a75872afda869be13f819e6fdb2147a1a24bfe124420`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 13 Jun 2024 10:06:31 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 26 Jun 2024 19:39:53 GMT
ENV NEXTCLOUD_VERSION=27.1.11
# Wed, 26 Jun 2024 19:40:42 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 26 Jun 2024 19:40:46 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Wed, 26 Jun 2024 19:40:46 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Wed, 26 Jun 2024 19:40:46 GMT
...
-	Layers:
	...
	-	`sha256:945b019dda5472de686849457a035a683180af87458c778b2efe0c1f8dd3fb08`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1012dab010e20762c73422fd61105abfd64bc981b8863ecf8ccfef8bb421c28c`  
		Last Modified: Wed, 26 Jun 2024 19:50:51 GMT  
		Size: 206.2 MB (206192189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3a111b4da79b588dc2926e1ba965ad11226842f12cd748bf6de84b57f5ab5e2`  
		Last Modified: Wed, 26 Jun 2024 19:50:21 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a01ea9da676b27a9d3b274fac5185403ba2bd89cc17bee9690bb6bb98e7ab12`  
		Last Modified: Wed, 26 Jun 2024 19:50:21 GMT  
		Size: 2.4 KB (2370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:19cae7fc6cbb7ede1b74d5ab5da0af5e8e4cd2098837171715b5b54f6077b1e1
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.2 MB (426220856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38c71181f4fb6f6d49c8325ac031b54d44a62630cd40e2162b860f749438c654`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 26 Jun 2024 19:38:29 GMT
ENV NEXTCLOUD_VERSION=27.1.11
# Wed, 26 Jun 2024 19:39:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 26 Jun 2024 19:39:39 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Wed, 26 Jun 2024 19:39:39 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Wed, 26 Jun 2024 19:39:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 26 Jun 2024 19:39:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1918a456364bfb312e3de67d4629211dd2af78ad41bd90a1c07f7dd71218f901`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5d71312cc7951037a55e7de97314beee72c588720775eb4378b6c63aee42409`  
		Last Modified: Wed, 26 Jun 2024 19:52:31 GMT  
		Size: 206.2 MB (206191287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d33fbe8918144338239c93282ab2ba50e41d848a11a891fd8703dbecca30bf98`  
		Last Modified: Wed, 26 Jun 2024 19:51:53 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91bcd9ff4238dd57217a143ad89819374dd2a6c9a134915e23ec56f5453e917a`  
		Last Modified: Wed, 26 Jun 2024 19:51:54 GMT  
		Size: 2.4 KB (2372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:fa11ee5a8a051b1dcfe4a342aae4e6a316f0aefa265c7e4a1252a79d1bb5f6cd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.1 MB (397144365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5b0e8c8d84342485e297237e3d5af01ec0494225d0261db2c0805c0bfdfc6fe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Wed, 26 Jun 2024 19:43:22 GMT
ENV NEXTCLOUD_VERSION=27.1.11
# Wed, 26 Jun 2024 19:44:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 26 Jun 2024 19:44:12 GMT
COPY multi:c7b33cbfd4e0a1d7b33f08bad5ac56355edc93c3e93f0b9ce42611257e828295 in / 
# Wed, 26 Jun 2024 19:44:12 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Wed, 26 Jun 2024 19:44:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 26 Jun 2024 19:44:13 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ec5d1d9b4acf2916258a542aef598b2f50dd13cff2816e19b06692b3a695aaf2`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ada81e7c0b16072b63d7f690207f41bef946636cdb9e9e23d8dd3cffdb2d8260`  
		Last Modified: Wed, 26 Jun 2024 19:53:31 GMT  
		Size: 206.2 MB (206189854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fde0646b373fba34ef596cbc7f95b4cc2142815489fa84b87579eab6ee6797e`  
		Last Modified: Wed, 26 Jun 2024 19:53:05 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84013e3b21ca41af39bccc25351aab0046ee385984f7090bd7446e66615b15e8`  
		Last Modified: Wed, 26 Jun 2024 19:53:05 GMT  
		Size: 2.4 KB (2373 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
