...
```console
$ docker pull nextcloud@sha256:f77a71e5eb909a66b6ffee9d7b18a2b9fc6cf9346c97a6f43249c756c058e9e8
```
...
```console
$ docker pull nextcloud@sha256:907e0da69b3d464ea18ac88417fe36ed116c4ef051e8958a8b79edfe035e34ae
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.1 MB (397055919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:109737aec52e7682c638805c2b89a36d132a6532266b370ab4ed750366a9feff`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 22 Jul 2024 22:00:19 GMT
COPY multi:93e628175b4469d463083705f9db1d7b4d090629cd6c12433f52a951b154a5c4 in / 
# Mon, 22 Jul 2024 22:00:20 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 22:00:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 22:00:20 GMT
...
-	Layers:
	...
	-	`sha256:f4e351f36f17bd8b50395b07fc94243edbdc80519c6af2b3aaa9ffc5712863ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2eaeb9f2171c08a1344771f9f0c6a12870841ab19f0de74d815e6aafceee140c`  
		Last Modified: Mon, 22 Jul 2024 22:06:20 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a9146017b83405867dad2f324b782126c411cffd7f1fce9363135ca730a1d54`  
		Last Modified: Mon, 22 Jul 2024 22:06:20 GMT  
...
```console
$ docker pull nextcloud@sha256:8b7fa64cff7e7458de5ad82ff93716a6b3181bf9f2090259abf18c844c590863
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.1 MB (397124688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64015cb479d37e5b349bea77de953542a1133cb23fa2d1ae11e69807fb2a4c8a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 21:52:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 21:52:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9d8422f6d0daff0be065c85ebabc00a640fdd082686f17e051a83082d8b7171d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf12fbe647fcaf58aa7d0d412e97edb89b8677c702d4a20874791c61d846be34`  
		Last Modified: Mon, 22 Jul 2024 22:08:21 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a8db36f505f3fe2a6dd18fe78f80fb692a17711f4851f47d665cdccdf68e659`  
		Last Modified: Mon, 22 Jul 2024 22:08:21 GMT  
		Size: 2.4 KB (2376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
