...
```console
$ docker pull nextcloud@sha256:075f5005e953186100fdd4b5ba5f0bc920a57c984aeb48093e6e8b588de339f7
```
...
```console
$ docker pull nextcloud@sha256:9ea2232b18dbccc5be3163d0371776391f3a711f7207b1b51d43ea63750f1c6b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **385.1 MB (385131409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:795dbd1bd1d55baf74ea61a8afecce0617d8abd3fde6e603d6dd73ccde1a996f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Jun 2024 00:06:36 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Fri, 07 Jun 2024 00:07:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 00:07:44 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 07 Jun 2024 00:07:44 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Fri, 07 Jun 2024 00:07:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Jun 2024 00:07:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:586d5fe08c127773cda52363c1a87b761dfe66bd8965c967f11e07275912e84e`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d71ce6a1ea5b955e66148a1dd20497b8d6f53c3e1e56f46dc5d0064cb1daf065`  
		Last Modified: Fri, 07 Jun 2024 00:23:52 GMT  
		Size: 205.8 MB (205799861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:068e8983be31177019e380f6b626ddb8c8c7f627bd0be32524cd5cafffa5b6bd`  
		Last Modified: Fri, 07 Jun 2024 00:23:11 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33eb41b8914e85034d238b20ede9e484b0ae874c89ff45ce706ff15f572ccea0`  
		Last Modified: Fri, 07 Jun 2024 00:23:10 GMT  
		Size: 2.4 KB (2394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:31037d4f49db39a0115154102a1a74a965d656b08656016a358708e5e641d53f
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **418.6 MB (418610824 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f04ae5ebcd4ca4decec7553488c92c99bb2d18e34fb00263db8f6cc39714b183`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Jun 2024 00:28:13 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Fri, 07 Jun 2024 00:29:00 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 00:29:05 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 07 Jun 2024 00:29:05 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Fri, 07 Jun 2024 00:29:05 GMT
...
-	Layers:
	...
	-	`sha256:faf1c86b31564a94886fa22a980ee5f2a5e1396e4fa6f634882efa8ff61ac76e`  
		...
		Size: 404.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a631036a12e88392655c83a049599b6d8ed4ada0c8abab210688a41498f4a35f`  
		Last Modified: Fri, 07 Jun 2024 00:44:29 GMT  
		Size: 205.8 MB (205801998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8689df4abd12bce81fb3c8b7471e3cb10b0966c215f4472b9bd51362e44bc9a`  
		Last Modified: Fri, 07 Jun 2024 00:44:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01daaae0134ce73cf6903cc54e80c1b0d5ddda086e1587d6b155fcb9e17f9a35`  
		Last Modified: Fri, 07 Jun 2024 00:44:01 GMT  
		Size: 2.4 KB (2394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:ab6f5f1690f8159767a5148ffb5417514f99f3a9f64f91cdb5e09b4c7c0f8ea4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **425.8 MB (425829781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06e55e321fa5b6890c880852a1c5489bcb16873c6eb1eda777d083914c46f9f1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Jun 2024 03:48:02 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Fri, 07 Jun 2024 03:49:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 03:49:08 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 07 Jun 2024 03:49:09 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Fri, 07 Jun 2024 03:49:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Jun 2024 03:49:09 GMT
...
-	Layers:
	...
	-	`sha256:4dadf3af7f1ce539adc0cb3d8e3f260646025189f3ce60eda8eff7c119ef0684`  
		...
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffcc172abc6e0c68556e64244982d551188aaae4e3b65964f49f36cafcfa3793`  
		Last Modified: Fri, 07 Jun 2024 04:08:29 GMT  
		Size: 205.8 MB (205801353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2d31f93b0bba62f8510d76ff1434a5e2053c0f3bce159d5419414ad429dd95f`  
		Last Modified: Fri, 07 Jun 2024 04:07:46 GMT  
		Size: 3.6 KB (3612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:066d6a00d1180219861c350fde7f2b3c9ffd9c16624a45a7eb275bc31b22bcfe`  
		Last Modified: Fri, 07 Jun 2024 04:07:46 GMT  
...
```console
$ docker pull nextcloud@sha256:6ed066d902743204d51b1efd4531a40e94cab9793ac7255c66fcbe8d8b06c380
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **432.5 MB (432520187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b517e08e87b084b8dbd1e88a79c30a2e716cadafb1c07681fae2e8846e239c5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Jun 2024 00:29:26 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Fri, 07 Jun 2024 00:30:27 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 00:30:34 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 07 Jun 2024 00:30:35 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Fri, 07 Jun 2024 00:30:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Jun 2024 00:30:35 GMT
...
-	Layers:
	...
	-	`sha256:3a21781b0fc007fdccf25371287c96b6c7d0718535b14cd47864e90e3c635179`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bdb7ee2f609c06f59eae97a89d034eb480ca40c01d0561bf6e7bfd671118ab7`  
		Last Modified: Fri, 07 Jun 2024 00:49:21 GMT  
		Size: 205.8 MB (205802285 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79238998776f0b1c693dc7b561a29295e633571ee41e3a30dd5b82f7fdab371c`  
		Last Modified: Fri, 07 Jun 2024 00:48:36 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0795197a745304e17a38d669abb8e23ba231484594f9995259588755c6e5102b`  
		Last Modified: Fri, 07 Jun 2024 00:48:35 GMT  
		Size: 2.4 KB (2394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
