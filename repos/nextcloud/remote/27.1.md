...
```console
$ docker pull nextcloud@sha256:c17db8b8dda331b47e2c039b565cc4feef2e53f2c4c4c477ad00ccfec3a0d7a9
```
...
```console
$ docker pull nextcloud@sha256:0a4266b0b3dc0111dc93edb16a59cbc23ebae971308bd3f7b4b12456af94a8cd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **385.1 MB (385127491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7ba9097e1b2e8c32cca2e41629890567166d534b0b953643ee9a4118e3fea52`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 06:55:51 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Thu, 06 Jun 2024 06:56:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:56:56 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 06:56:56 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Thu, 06 Jun 2024 06:56:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Jun 2024 06:56:57 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9ea81b96ba477ae4638148eb8c4340896acbf28019a966ec928b613813a3b716`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6b5a02d0053a37bcf1d2aec8fa89971d6f249b67c16bc45f8fbb07d47fece7f`  
		Last Modified: Thu, 06 Jun 2024 07:13:18 GMT  
		Size: 205.8 MB (205799808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e458560c8d2039605a35b0ee2c46291463e5d0e282dfeff4684f6f5e34e765b`  
		Last Modified: Thu, 06 Jun 2024 07:12:36 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf65d92cc91cf42f8b29fc93d1f0f9b8982cfb34da14f964b652c14ec29fb754`  
		Last Modified: Thu, 06 Jun 2024 07:12:36 GMT  
...
```console
$ docker pull nextcloud@sha256:9819c2e3724baefaf9d54d9c7f45212c90e3cb7da4d44d42c2f41a194024af5e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **425.8 MB (425825232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58e62bb5022ce855620e8ec85c4cf06affa317bf2f6879bd01cadebe82660a11`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 08:51:31 GMT
ENV NEXTCLOUD_VERSION=27.1.10
# Thu, 06 Jun 2024 08:52:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.10.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 08:52:35 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 08:52:35 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Thu, 06 Jun 2024 08:52:35 GMT
...
-	Layers:
	...
	-	`sha256:e2d3b5b63666f11fbc255df6227eb5fa7a3e8b7f2a39c2a8644f7df02fdf817c`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0351fccaef0e7506725a40a13d022eef2388db8d9e6fe25fa414c15427167c0`  
		Last Modified: Thu, 06 Jun 2024 09:12:12 GMT  
		Size: 205.8 MB (205801269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c889d466ee2dc0a3cbc3ca1812e5f637e4ae3d093ee463acacdcd2fc2eeaafb0`  
		Last Modified: Thu, 06 Jun 2024 09:11:23 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e304a02ee0d89911ff62670eede5772eb6f776a1d6d5b6ff65464be24b0a4750`  
		Last Modified: Thu, 06 Jun 2024 09:11:23 GMT  
