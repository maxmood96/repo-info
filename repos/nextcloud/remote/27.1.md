...
```console
$ docker pull nextcloud@sha256:7365bdcba7023514e097ddd8f546f01662da396e772e331c200a52eb9daeef9f
```
...
```console
$ docker pull nextcloud@sha256:501896a5f86a8a85b2fd9228b66f519794693406e4cd686351ed02930011f39b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **430.2 MB (430244894 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6772020c79cde37fbb598a4b3b423fb44699c343ec9a6b0656efd05bb463f939`
...
-	Layers:
	...
	-	`sha256:dbbbc9a8833202619954978f80ebc0a2284f0e0b248972d29a930f7461853b61`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35129b4567fb01bf2ed62b98beeb738072c263291f0efaf238c50af3dcbb5ee3`  
		Last Modified: Tue, 14 May 2024 19:39:26 GMT  
		Size: 22.8 MB (22781587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccdfd53780b4d34d5cb6ce17495dd3e5a13f585f6fd52f7a05b9aa917cd5b014`  
		Last Modified: Tue, 14 May 2024 19:39:26 GMT  
		Size: 20.9 MB (20934479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b819af798e29a5411463ff791375a52cc270c442dec56cb1fae2365a3033d56`  
		Last Modified: Tue, 14 May 2024 19:39:22 GMT  
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b760377fd0ccbf30765bec3415200ae24b35c6da60725aa6dd49a74b737af10b`  
		Last Modified: Tue, 14 May 2024 19:39:20 GMT  
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d0c9118b5f56bd64e1ff9a579351c1c0cdc78cd5480b421affe8ef4df774970`  
		Last Modified: Tue, 14 May 2024 19:39:20 GMT  
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c45afaa2e7e0dcf6550cb24d449925f774e2b9ceb66ce66c603c4d35bc6000c`  
		Last Modified: Tue, 14 May 2024 19:39:45 GMT  
		Size: 208.8 MB (208841262 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11d025b111b788338650012459d8fc865f892b4a9af764eb2ebdc5dc4515f138`  
		Last Modified: Tue, 14 May 2024 19:39:20 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70b822e2545aad11ba61397cf5a0af70a3ca969772a1ea47fb62ecc63bed3a6d`  
		Last Modified: Tue, 14 May 2024 19:39:20 GMT  
...
```console
$ docker pull nextcloud@sha256:173e1c35075b8018733d4603eac3fb2d0f65c503a5f92b0691fecb791083e9b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **401.3 MB (401304916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2806b892cca0c1da7f55f0251d4ccce7986ac6ae7ccf116905705d6539a5cfa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=27.1.9
# Tue, 14 May 2024 14:50:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.9.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.9.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 14:50:22 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 14 May 2024 14:50:33 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Tue, 14 May 2024 14:50:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 14 May 2024 14:50:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:42aaf577be240909252b586738fb6592a1b9444c9df122a5459a2f7ff17153a6`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47b448b51fc2e9ad8340b96c36a457d827cb253e32e0d9de1bcae0e8a5b8cc0f`  
		Last Modified: Tue, 14 May 2024 15:29:08 GMT  
		Size: 208.6 MB (208612362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06fff44496fac209eced3e24e3ce4d2c6f66f1162b5cabac8c0aab681f608d2d`  
		Last Modified: Tue, 14 May 2024 15:26:49 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b132f78a4fe364dc2b84a3351972cf75b1d23b66ce548c739436acde5db59d3c`  
		Last Modified: Tue, 14 May 2024 15:26:51 GMT  
		Size: 2.4 KB (2393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
