...
```console
$ docker pull nextcloud@sha256:f3cc16b4f569f496fe0b4da0d10ef021694d7f540af473638097c9e064f29345
```
...
```console
$ docker pull nextcloud@sha256:87a4df6e6ec0831067cce703713c60050f9742a402847f3cc8181439ef6f2aa6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.8 MB (194753964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9df9024dfd2f4017d683238632199d824a0063dab2c9794cac5f3af6db18981`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 18 Feb 2022 21:59:14 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 18 Feb 2022 21:59:14 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 18 Feb 2022 21:59:15 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 18 Feb 2022 21:59:16 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 18 Feb 2022 21:59:17 GMT
VOLUME [/var/www/html]
# Fri, 18 Feb 2022 21:59:18 GMT
ENV NEXTCLOUD_VERSION=21.0.9
# Fri, 18 Feb 2022 22:02:25 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 18 Feb 2022 22:02:27 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 18 Feb 2022 22:02:28 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 18 Feb 2022 22:02:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Feb 2022 22:02:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:01ace92543eafdc51b04e3656d3e4081c4d4c3f6f36c6d4a6df62cae6fb4f332`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:874ba33ae0438024fb3d27fd3a7749d7dedcd266140dda35f1bb6b2e5cd5e3f6`  
		Last Modified: Fri, 18 Feb 2022 22:15:28 GMT  
		Size: 24.6 MB (24583765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe5a2ca1f501938cdd3a4ebb953324b9b69f0132f6da1183c629a1a3573a7772`  
		Last Modified: Fri, 18 Feb 2022 22:15:25 GMT  
		Size: 559.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2791573899cdf1245f6aad3c59e9df564734b2a7efbdc0735482e421215e6a16`  
		Last Modified: Fri, 18 Feb 2022 22:15:44 GMT  
		Size: 138.9 MB (138934441 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f31dcc5d9c04dba424db8b507259f090da3b023cee76dee715680ca7f0f74a85`  
		Last Modified: Fri, 18 Feb 2022 22:15:24 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db17a4a837c4efe1d12ebffc0b579953bece228223eecda5b7a525c4770edb91`  
		Last Modified: Fri, 18 Feb 2022 22:15:24 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2fd04aa1d335695ec52119fbbb371fac31b0ee0688bfd40870a1669ccc37df7e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.3 MB (196283713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:663594e0fb20eeee30ff69da877d927ffad38c9636e96be78bd511c685d8d25b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 18 Feb 2022 23:59:42 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 18 Feb 2022 23:59:42 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 18 Feb 2022 23:59:43 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 18 Feb 2022 23:59:44 GMT
VOLUME [/var/www/html]
# Fri, 18 Feb 2022 23:59:44 GMT
ENV NEXTCLOUD_VERSION=21.0.9
...
-	Layers:
	...
	-	`sha256:e06d50382cd0ad2afb3e6325806398511917e6c357d8a7128279fb8037490978`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3314683bea5cbb61f15aa4678d4b02fa0a7cc89257d25d380e61bff41005216e`  
		Last Modified: Sat, 19 Feb 2022 00:31:26 GMT  
		Size: 25.2 MB (25217072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ff98e51deb0612fa167568aee8526a20de37361d235f351f7001a3fe0d623a0`  
		Last Modified: Sat, 19 Feb 2022 00:31:19 GMT  
		Size: 589.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0aca9b38ab05285e80f983ca3d67fbf4f1b7cfdced2db1adda2ca7daf0e319e`  
		Last Modified: Sat, 19 Feb 2022 00:31:55 GMT  
		Size: 138.9 MB (138934089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47b5f1354f66318b78cd358fa8ab882dc67f8054477966676add667490181e07`  
		Last Modified: Sat, 19 Feb 2022 00:31:18 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71b11dda2ba01e08e51d6897d456e02d294d9472a83e6ad0bc7b87b4a3eaf186`  
		Last Modified: Sat, 19 Feb 2022 00:31:18 GMT  
...
```console
$ docker pull nextcloud@sha256:dca98574a1eafc8449ee16d6a0da1f10d4fe1fe5c8a4a6808620d76693bfee6d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.8 MB (196830606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e325a2fb861785fd63765094875d5203828020db927941ac845ad4b91467eaba`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 18 Feb 2022 22:57:09 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 18 Feb 2022 22:57:14 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 18 Feb 2022 22:57:16 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 18 Feb 2022 22:57:23 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 18 Feb 2022 22:57:25 GMT
VOLUME [/var/www/html]
# Fri, 18 Feb 2022 22:57:26 GMT
ENV NEXTCLOUD_VERSION=21.0.9
# Fri, 18 Feb 2022 22:58:54 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 18 Feb 2022 22:59:04 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 18 Feb 2022 22:59:07 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 18 Feb 2022 22:59:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Feb 2022 22:59:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:48f70574c283628b743311d6116d00940bff452cfdcbca62204d02cd0a85ecc4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f20a84657038a77bdac96413a069e18258974c6b30bbd639c9ec4efb6054c322`  
		Last Modified: Fri, 18 Feb 2022 23:15:57 GMT  
		Size: 25.1 MB (25067476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea0d6a6c66676e929403c9bb6d35fbd67d79e3aa7f72566bb2021c96d4207f9b`  
		Last Modified: Fri, 18 Feb 2022 23:15:47 GMT  
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fd9ac4364d1dbb6a84f1683eed129561755d7420d3ccb68b1f4a6fe37b33cce`  
		Last Modified: Fri, 18 Feb 2022 23:17:13 GMT  
		Size: 138.9 MB (138934156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aac80e9be4b02f558f09167759ab73229265c85411132848a14c3e0f5358338e`  
		Last Modified: Fri, 18 Feb 2022 23:15:47 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a152b7605b45a3ec45b7fe0777f309e4220277aa6cec5e2e8db2223788527179`  
		Last Modified: Fri, 18 Feb 2022 23:15:47 GMT  
...
```console
$ docker pull nextcloud@sha256:3c510c976e2e1d5ee0acc0881efb338b77ea518c5e6df65f71dbf1998be1c74b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.1 MB (194060150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dc9f513945fcf8da0dbc17d15ff88b4ee117662773feee0c2e06182c558b707`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Feb 2022 00:41:37 GMT
ENV NEXTCLOUD_VERSION=21.0.9
# Sat, 19 Feb 2022 00:42:53 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 19 Feb 2022 00:43:05 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 19 Feb 2022 00:43:06 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 19 Feb 2022 00:43:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 19 Feb 2022 00:43:06 GMT
...
-	Layers:
	...
	-	`sha256:e83c5818c286859a4d277a3f54cffe77f21dffc87cbd4e0569507f32765dad6b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8556f683a622fae738d960ae3e4a5198f4ee5b02aa3609c89818d3d8443a31bb`  
		Last Modified: Sat, 19 Feb 2022 01:11:36 GMT  
		Size: 24.5 MB (24487830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:931822fe25093a70b1431deeda079aeecd39e27839eb30ca164cf6b353fc1bd6`  
		Last Modified: Sat, 19 Feb 2022 01:11:36 GMT  
		Size: 596.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6497a5aa416feccb8d2cc8c0c9cc8680e3cceee656bc855c3aab1fbe56b204c9`  
		Last Modified: Sat, 19 Feb 2022 01:11:49 GMT  
		Size: 138.9 MB (138934232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02e297c79e33ba5d303ecdf5c7376b9d501a5ce4ecb1d8fad6d201a1f2b60036`  
		Last Modified: Sat, 19 Feb 2022 01:11:36 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b3d7d66ddaa805034babf3ff9fba2595a1440eee8c7bb1de182c622d8b99df7`  
		Last Modified: Sat, 19 Feb 2022 01:11:36 GMT  
		Size: 2.1 KB (2137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
