...
```console
$ docker pull nextcloud@sha256:4113e1a72ac5660b9e9699ccd3fc6087164d651d1b931e50ca9b05c81025a007
```
...
```console
$ docker pull nextcloud@sha256:a565b2edb1ca2d8361f2b9024a0bd2ca7b78fbfa1cdcef48e5293759ea57afe5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.4 MB (190373112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b0f6666584f1aea29df2f79e4bb41dce04833f29d03b77b74500ed498417219`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 13:12:07 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 13:13:24 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 13:13:28 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 13:13:30 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 13:13:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 13:13:30 GMT
...
-	Layers:
	...
	-	`sha256:30673971c9518b81722597d5e8c02e93c70dec4576b10328060a3db392fe00b7`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cf525a15278f02c41d765c4e0ec8ed581db9a9927245b292a0998d893895c8f`  
		Last Modified: Sat, 13 Nov 2021 13:24:55 GMT  
		Size: 138.1 MB (138079678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dcd33e953564132d972894d98a27936af374b6d006edf1db972dd4cbc908ebb`  
		Last Modified: Sat, 13 Nov 2021 13:23:25 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36ff5d31c1ab382bd6cf9af5c05905f21614af0f11d2e6ea7d68f81b3090d84d`  
		Last Modified: Sat, 13 Nov 2021 13:23:25 GMT  
		Size: 2.1 KB (2051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:b40b8297018ee39de1f57ddea81e91fca2c10378a7dabe735f380a166187d86f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188740468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c922cd71d7069602fac80a42b09cffc609cc1921ffbc02eb72c9ad2aa2ecc2e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 11:55:34 GMT
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 12:00:53 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 12:02:11 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 12:02:15 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 12:02:19 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 12:02:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 12:02:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9ff78be71c62c6509ac7e3c41c680bfd47899d63faf7b282c14a30fc7df5f0b5`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd65ecb99fb39fca713c7796ae0051f112ddd908c113296c363c74ba94761ca4`  
		Last Modified: Sat, 13 Nov 2021 12:26:33 GMT  
		Size: 138.1 MB (138079642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2f976de060149d8f563c57930d67af720c98fd85cc8ca215e353fa071084cda`  
		Last Modified: Sat, 13 Nov 2021 12:25:02 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63e33eafe96e52036d2a5498b363a7d378303901a802f10ad32b293bae8dc4fa`  
		Last Modified: Sat, 13 Nov 2021 12:25:02 GMT  
...
```console
$ docker pull nextcloud@sha256:272debb610085e7d678e8cd5fe6b1dd0a37c240a39d447848919a5587860b82f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.0 MB (191995056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f4b3df6ab212358dee2141566c5777a50c6a26920dac2e0322ad981b16f87da`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 11:56:41 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 11:59:26 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 11:59:28 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 11:59:30 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 11:59:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 11:59:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:31cfe23dd9033cec539565c6947390bbd14f07c84d8e1b1c279e33148836f568`  
		...
		Size: 558.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f712770adf6b97853fd59ef2ba3ecc8c14e2ce73cba99fa454dc3b54217f3460`  
		Last Modified: Sat, 13 Nov 2021 12:16:01 GMT  
		Size: 138.1 MB (138083524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6edc54c0a19a9a419f01cd8368756ef776cdcc9c0575724b74a5b2bd97e171e3`  
		Last Modified: Sat, 13 Nov 2021 12:15:42 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7acab2b6be03885dec0ea0164a1ad19082512331e5a5d57243f9cf13effd187`  
		Last Modified: Sat, 13 Nov 2021 12:15:42 GMT  
		Size: 2.1 KB (2052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:215632236edbe58b4c5ae2e7c73e04b362d9b3e1dbf664cd2e5a17052fc654e3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (194044361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f42f0d9fc79e385de2d240a9c14ef269cab9705acc27f71ec7aa9a8eb6564559`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 18:47:02 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 18:49:53 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 13 Nov 2021 18:49:57 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 18:49:59 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 18:50:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 18:50:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8c4905e8291225ebb4a74cf1c3df0007e9f9564a18a64c4206d6c565897b9bdb`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b25d5945705d7a1604054b6a2759eff1dd9beaa0b17973640d65e16efb54776`  
		Last Modified: Sat, 13 Nov 2021 18:59:50 GMT  
		Size: 138.1 MB (138079606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f40335838eff1947cdb48d6b31714ac9ca650b292a18da63c7ef42c19cf1144d`  
		Last Modified: Sat, 13 Nov 2021 18:58:53 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1111a23338dfe1ee1e1df398ac367491949797869f3bd831f661a6058b8d728`  
		Last Modified: Sat, 13 Nov 2021 18:58:53 GMT  
		Size: 2.1 KB (2052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
