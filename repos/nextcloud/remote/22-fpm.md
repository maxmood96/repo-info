...
```console
$ docker pull nextcloud@sha256:8f381f8b3a40928a1580625dcfd96d16cbe1839368ab9e4f10d37b82425920dd
```
...
```console
$ docker pull nextcloud@sha256:18b5e091e8fca069547641d84cda4bcbb8244adb9d5ea37a8c6ccf16867a1b19
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.6 MB (325627459 bytes)**  
...
# Thu, 18 Nov 2021 22:56:04 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 18 Nov 2021 22:58:51 GMT
...
-	Layers:
	...
	-	`sha256:4d7f58d1835d82f38b99f6c96e0d34fd09c244b3d8b3687f41d589a53633a506`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6771a9ecf6a5c4a372f11ef281fe429d79aa4507e8a0653f657c5ba16e24721`  
		Last Modified: Thu, 18 Nov 2021 23:03:50 GMT  
		Size: 1.7 MB (1675784 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8bc08973a9edc7974fd4b399ffa0c0cae17ff47fd674127adca1322aaeefd89`  
		Last Modified: Thu, 18 Nov 2021 23:03:50 GMT  
		Size: 17.5 MB (17507107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2ef41da1497e394354535ef693bfcd8536237f25d6cac047ce877ef4c6ab9b3`  
		Last Modified: Thu, 18 Nov 2021 23:03:47 GMT  
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9a304b3a884d5d9b516c4a7fbe75c092ff48b5d0321d64393b6eef33fae71ae`  
		Last Modified: Thu, 18 Nov 2021 23:04:08 GMT  
		Size: 142.7 MB (142677588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca97c5541b3ebc77b0a2ebf891fae77932783c56b2362269091d5f3954fe92b9`  
		Last Modified: Thu, 18 Nov 2021 23:03:47 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc34bf1d3a52769cff4132e02b08cc320f16290e09a9ceee3e37872445b4e658`  
		Last Modified: Thu, 18 Nov 2021 23:03:47 GMT  
...
```console
$ docker pull nextcloud@sha256:4a6aa9ea283ebd7760eac8ebd38708f4837858543ccef889188353b1fbb6dec0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.9 MB (300907966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b658ee6271796d648f0670adf7384275efa7710ba78d63f9978ae6df126d2b51`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 17 Nov 2021 11:57:33 GMT
CMD ["php-fpm"]
# Thu, 18 Nov 2021 22:37:56 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Thu, 18 Nov 2021 22:37:56 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 18 Nov 2021 22:37:57 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 18 Nov 2021 22:45:50 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 22:45:52 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 18 Nov 2021 22:45:53 GMT
VOLUME [/var/www/html]
# Thu, 18 Nov 2021 22:45:53 GMT
ENV NEXTCLOUD_VERSION=22.2.3
# Thu, 18 Nov 2021 22:47:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 22:47:59 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 18 Nov 2021 22:48:00 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Thu, 18 Nov 2021 22:48:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 18 Nov 2021 22:48:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e76041ef4f5f37073c0a9614657c944b8520cc350b8f2be0be1f4571f43704de`  
		...
		Size: 8.6 KB (8575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ffce37fec2216ce6c3fe0e63dc7c1fb9bb059768bc96cb95b6a8ab08751ccff`  
		Last Modified: Thu, 18 Nov 2021 22:58:16 GMT  
		Size: 1.8 MB (1757813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:373a0e5070e290107e3c18d6504a61ee481fc2d33c909fa0ce2ca9675ce17db7`  
		Last Modified: Thu, 18 Nov 2021 22:58:24 GMT  
		Size: 15.0 MB (15037716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb5036523984f572a348be0fbe211985f2540a669bfc82f76c543609cadb86f`  
		Last Modified: Thu, 18 Nov 2021 22:58:12 GMT  
		Size: 569.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0c7e8943180f039b0ed27478f55804996048846c8ed5472f0ac5abc4d8d603f`  
		Last Modified: Thu, 18 Nov 2021 22:59:44 GMT  
		Size: 142.7 MB (142675859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25691db9295e8aa47b27674ad87c09eee00249da4c366ae1ac24e89c0cf82fc5`  
		Last Modified: Thu, 18 Nov 2021 22:58:12 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f8ff02ecd12c626c16cc112de662e87919f1345820fb2417455acc0283783b`  
		Last Modified: Thu, 18 Nov 2021 22:58:13 GMT  
...
```console
$ docker pull nextcloud@sha256:c8323ac40f2101e99decf77fa918f86cb835dc081d01c86d95eef40e3ba0086b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **325.6 MB (325576187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:294ef02c3d464f6e9f2f827ef0c2c8efa5f91c49a085af05ee66e6b86ce7385e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 19 Nov 2021 01:19:03 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 19 Nov 2021 01:19:32 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 19 Nov 2021 01:19:49 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 19 Nov 2021 02:59:26 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 19 Nov 2021 03:00:10 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 19 Nov 2021 03:00:27 GMT
VOLUME [/var/www/html]
# Fri, 19 Nov 2021 03:00:36 GMT
ENV NEXTCLOUD_VERSION=22.2.3
# Fri, 19 Nov 2021 03:12:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 19 Nov 2021 03:13:09 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 19 Nov 2021 03:14:20 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 19 Nov 2021 03:16:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 19 Nov 2021 03:18:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:277b580bc423a96c2d6a82400fa5d4d0e92c16937ac8b384086f617b20bce75f`  
		...
		Size: 8.6 KB (8573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:248ba22c35b3de7f4fd854486e23b83539ec2c9fed81a429a84bad92abae0567`  
		Last Modified: Fri, 19 Nov 2021 04:38:15 GMT  
		Size: 1.8 MB (1844893 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4b55cba40a79ce8eeb42e7c49be6f5af78e89a634fa1722c4ecada0e11b9d33`  
		Last Modified: Fri, 19 Nov 2021 04:38:34 GMT  
		Size: 17.0 MB (17033650 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ef7653140cb474d63893b2a1fa8dcfaf408e32ba9dc0df4131ccb3d671706a6`  
		Last Modified: Fri, 19 Nov 2021 04:38:11 GMT  
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48aa217c01c54f874f86729bfd9095978eb54463951df56f64c4c0bb45107dfe`  
		Last Modified: Fri, 19 Nov 2021 04:40:46 GMT  
		Size: 142.7 MB (142681367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f33d7d7948886faab687a5c76b9395f144b8d43bbd6f922d68376fc87d1b88`  
		Last Modified: Fri, 19 Nov 2021 04:38:11 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c4878d951fb6593d8a8ccd22a70c7dc9c2487684526a0cff5480655224c9bd2`  
		Last Modified: Fri, 19 Nov 2021 04:38:11 GMT  
