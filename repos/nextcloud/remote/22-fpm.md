...
```console
$ docker pull nextcloud@sha256:7c51c0fd57537d712b68ec7abe65a3b28ffe9333379ddb5b154d5e158b8a9904
```
...
```console
$ docker pull nextcloud@sha256:cbcb3df190260d6b31f3bea589a776e21fd9f2bb3992fd072f54ef1535d2da58
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.1 MB (301098829 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5c853fe71b99fcb69a305d801cd1204a07697530d35a7f038c628b77ae59fad`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Nov 2021 22:43:01 GMT
VOLUME [/var/www/html]
# Mon, 15 Nov 2021 19:52:00 GMT
ENV NEXTCLOUD_VERSION=22.2.2
# Mon, 15 Nov 2021 19:53:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 15 Nov 2021 19:53:35 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Mon, 15 Nov 2021 19:53:37 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Mon, 15 Nov 2021 19:53:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 15 Nov 2021 19:53:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a8f46b06d3952da5b52233549215f223a7a707868e65d0fb640836c98709e30b`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe9092220e38c41f9387d95ade8ff8f6a18c1896fbd3d4a16b37723931c409f`  
		Last Modified: Mon, 15 Nov 2021 20:01:28 GMT  
		Size: 142.6 MB (142635155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:915f88d8996992b5142181466dcfa7e949f645f03259ec0fdf7c620a554d95b8`  
		Last Modified: Mon, 15 Nov 2021 19:59:51 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a99d11cf6b4d95e750f8eb6bd1ebf35fc78ce959ee52cfc24c7a825795a0ac4a`  
		Last Modified: Mon, 15 Nov 2021 19:59:52 GMT  
...
```console
$ docker pull nextcloud@sha256:e50e87113245d4295b7520045223ea6323b5469769e7dbda54a87cc8bb716ffe
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.1 MB (292057831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb8cbe2be731a1fe376256d78bab3c339749ad5e9820f08f2b9d59bd3578b9bd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 22 Oct 2021 00:33:36 GMT
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 12:04:26 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 12:05:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 13 Nov 2021 12:05:58 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 12:06:00 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 12:06:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 12:06:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:18d8f5a6e295afdec5dc9b007fcfd78cbb56785aab64df5f3d2deafa38f1cced`  
		...
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37cef2dd29edfa07c1b222add76c594cf0ad25649474dc725e4ae732360e7fbc`  
		Last Modified: Sat, 13 Nov 2021 12:30:43 GMT  
		Size: 142.6 MB (142601223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cab29dcf3a481f3b6871ebf80b7e2a5dcb292aa7969fc2caf6a9db9fbf27eb3f`  
		Last Modified: Sat, 13 Nov 2021 12:29:06 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:500ef1f2047244233244e42c00e404e682b0d00a0dcfedb28f0c983db715c829`  
		Last Modified: Sat, 13 Nov 2021 12:29:06 GMT  
...
```console
$ docker pull nextcloud@sha256:a5c669726b0a653036123813e46cbfa179d1d67a534f514e7d21162f69b01754
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.5 MB (315546413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28bbf1dbbbc65ba71cb905b21a00648bfaddd7eba6a82284e200412e8d33b174`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Nov 2021 22:38:35 GMT
VOLUME [/var/www/html]
# Sat, 13 Nov 2021 12:02:51 GMT
ENV NEXTCLOUD_VERSION=22.2.1
# Sat, 13 Nov 2021 12:05:22 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 13 Nov 2021 12:05:24 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 12:05:25 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 12:05:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 12:05:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:be6a9c68e973faeee0d2867a73d2cee68084424f8638d3f0b9b3737fd99ba3d2`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9901bb364a0756d139a3d1dac48231cd187853af31f8f01ea1af2d5322c17aa`  
		Last Modified: Sat, 13 Nov 2021 12:17:32 GMT  
		Size: 142.4 MB (142363268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9347eb4ab6b7e23c0a416cec3c97f06d8d91636bf9a26bcf70d6b66cc048b10f`  
		Last Modified: Sat, 13 Nov 2021 12:17:12 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0669771e8d2e183e0489d2df17cd5d39299f2c658a1cf354c2849eee043e179d`  
		Last Modified: Sat, 13 Nov 2021 12:17:12 GMT  
