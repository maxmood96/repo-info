...
```console
$ docker pull nextcloud@sha256:26601381afc516a7a24294f7ce23da97b362d43670a31697a0d7abffe53725f2
```
...
```console
$ docker pull nextcloud@sha256:e63e5b6c48b58f7ea32cb592640867fdbf0e293a794002a48a28d831d6b3fcb5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.4 MB (289425479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e59bc76e3f6f5aea40e3307b55bf247c27de6dcac495993bc5565cba4737494`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e808f5542eaa2dbb1f3b195011143cf2459e3e35e65c5997f386e1538724f0e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f735588f4744f32e839587322dfba936b7549ae1e24f5738d42a11e88a03c54c`  
		Last Modified: Sat, 25 Jun 2022 13:49:41 GMT  
		Size: 3.0 KB (3012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c8d72dfd779bb263ff0d29c634db8ddb95207346eeb22bccb44a969898a1863`  
		Last Modified: Sat, 25 Jun 2022 13:49:41 GMT  
...
```console
$ docker pull nextcloud@sha256:5c7d95525d402be707451481b97d21cf288acef6d86ac5f1c6a4fab50fe0a5fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.8 MB (296792188 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc78908e60587857709cdaf62dafc6663e0cf568000b3394ffc929ab0bba9634`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 06:56:51 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Sat, 25 Jun 2022 06:57:00 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 25 Jun 2022 06:57:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 25 Jun 2022 06:57:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:158ab8b62aa531fbeb72a61b629dc051e884880897188f30fafa6bc444f99766`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:161a74388614c071c74cb6d1a6bc1efed1528fcce125ac9b794da0be794b6d32`  
		Last Modified: Sat, 25 Jun 2022 07:13:50 GMT  
		Size: 3.0 KB (3013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90fc9b79d1d7a6d6c2ed52f2a5b0cd6d66f373285d70c23faca8aa4d50385ddb`  
		Last Modified: Sat, 25 Jun 2022 07:13:50 GMT  
