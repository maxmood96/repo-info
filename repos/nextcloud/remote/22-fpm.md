...
```console
$ docker pull nextcloud@sha256:5462376255550f851500d8552070e65be20532cee9de21a9ca1defdb59c98a48
```
...
```console
$ docker pull nextcloud@sha256:9cb4dbc7fdb42d4d6765bb179ffe21d989ca140f41fd984f6e69c0bedc848c85
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.2 MB (298223865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96adb5363b508a677149feb4210b7c029ac336d68885752587ad594a24a92d63`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d9ef2ea0fd874233adf8a5399224d69bc506fc57e546065ac52dc6fff10b4498`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee50ec0128608ab49a57be001b55ccc519977fbfe6a60f638e4a76fef4aa9f98`  
		Last Modified: Fri, 01 Jul 2022 01:16:54 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecec834e4d95317e27e60f5fdee12e2a66bf32d5cb888f68ebd06b5967abb0df`  
		Last Modified: Fri, 01 Jul 2022 01:16:54 GMT  
...
```console
$ docker pull nextcloud@sha256:01c5a5dbe75ddf1d341fad970d73af99a6b5f1734c1caf93489c6e35f6b76b62
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.2 MB (323191413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:869e6f2e66b4180bfd489f81494d29c1de2a4572a4c097dcd12e03ce33b771f7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:38:58 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:38:59 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:39:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:39:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d31c450463edefaf65b10013d02d02ade330bd40553af7d8eb18256b0761e56`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c13b3268594e03a3157d8113970a22e23dbc3074285551536b6b7abaa70d189e`  
		Last Modified: Thu, 30 Jun 2022 23:47:42 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d04f40466dfc3aabdc6611d2bb22d4fab7a1f182d4d91a62200a1f5d165d93f`  
		Last Modified: Thu, 30 Jun 2022 23:47:42 GMT  
		Size: 2.1 KB (2141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:39bb37cb46b8aee182dfddf75857cd3633461357df9b58556784fc0dded0b86f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.8 MB (296792242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41ec85e90d1a539adbd8bc1f0ea3a0c8e5b8b8eab330f94c80fbd0d42675096e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 25 Jun 2022 06:54:10 GMT
ENV NEXTCLOUD_VERSION=22.2.9
# Sat, 25 Jun 2022 06:56:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 03:45:45 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 03:45:54 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 03:46:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 03:46:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dc75fd18e9c66d9ba96fbda36e1ba0a6b03bbae470b487b076342125f9960e4c`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:158ab8b62aa531fbeb72a61b629dc051e884880897188f30fafa6bc444f99766`  
		Last Modified: Sat, 25 Jun 2022 07:15:22 GMT  
		Size: 142.7 MB (142702113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e97c40d20351e52cedd6c8876535aec574e28fbf9a0760722d42d59ef058f89`  
		Last Modified: Fri, 01 Jul 2022 03:50:02 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7e992989fb29adac20b52652caf016cbc9204c83b5427049408a1838d956108`  
		Last Modified: Fri, 01 Jul 2022 03:50:02 GMT  
...
```console
$ docker pull nextcloud@sha256:f8686a6ad223cf70cb785d20a8c3c3550f0fae2019f86ebfca613e5364da1a75
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.0 MB (322011866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2310f0c9cc9c8d093ac26465c591eec4c1f1467d1f65d18fe740f8a14af465d3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:27:44 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:27:48 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:27:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:27:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:058fba84138a584f7c80fb610d3eb8e663244064c54b33b0b339de9eca7cd903`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65a58bf7280957e627afde9100cf292455b7f072639bd0428cbd1100eddc4425`  
		Last Modified: Thu, 30 Jun 2022 23:43:16 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23d7b2602033aaa1dd480bb274b3559ab38400645979162ce84fc217c7d48f48`  
		Last Modified: Thu, 30 Jun 2022 23:43:16 GMT  
