...
### `nextcloud:22.2.4-apache` - linux; amd64
...
### `nextcloud:22.2.4-apache` - linux; arm variant v5
...
### `nextcloud:22.2.4-apache` - linux; arm variant v7
...
### `nextcloud:22.2.4-apache` - linux; arm64 variant v8
...
### `nextcloud:22.2.4-apache` - linux; 386
...
### `nextcloud:22.2.4-apache` - linux; mips64le
...
### `nextcloud:22.2.4-apache` - linux; ppc64le
