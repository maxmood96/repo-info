...
```console
$ docker pull nextcloud@sha256:b201a13ef07557244ec15b01e3c84102e2a97bdcf4b205beebc12b0170f1e88b
```
...
### `nextcloud:33.0.3-apache` - linux; amd64
...
### `nextcloud:33.0.3-apache` - unknown; unknown
...
### `nextcloud:33.0.3-apache` - linux; arm variant v5
...
### `nextcloud:33.0.3-apache` - linux; arm variant v7
...
### `nextcloud:33.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:33.0.3-apache` - linux; 386
...
### `nextcloud:33.0.3-apache` - linux; ppc64le
...
### `nextcloud:33.0.3-apache` - linux; s390x
