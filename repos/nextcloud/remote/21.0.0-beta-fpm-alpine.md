...
```console
$ docker pull nextcloud@sha256:0cd13cd74c5803c536a65ab3e59e35da31eea95e923ec3d9021f6fe7aadba450
```
...
```console
$ docker pull nextcloud@sha256:09fb284e14a3ea5565bdc24bd1a7cf572045aab7eaf5182a96789849ecdb3737
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175678914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c25eaa581fde3a603c25e1a1444e876e8179a83fe362283284403690090d4bb2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 05 Feb 2021 04:26:10 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Fri, 05 Feb 2021 04:28:23 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 05 Feb 2021 04:28:30 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Fri, 05 Feb 2021 04:28:33 GMT
COPY multi:69a3d18e5826dcf2a02562f59ec38d4047623d6d537d30e24b29faeb8ea43f9d in /usr/src/nextcloud/config/ 
# Fri, 05 Feb 2021 04:28:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Feb 2021 04:28:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5a0e6fc0236330d9e780dbe8fe386e041af42d04ab92fec2efb3d22604da8713`  
		...
		Size: 528.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a42fba7886ee4aeba483513ee715b85ebdca47678dcf7b98e1da406b8e78c9d2`  
		Last Modified: Fri, 05 Feb 2021 05:15:25 GMT  
		Size: 118.7 MB (118670917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7da34bc1261abcb5031065de141a32308b48200ab97f6fa8abf9fb4138917230`  
		Last Modified: Fri, 05 Feb 2021 05:12:21 GMT  
		Size: 2.5 KB (2529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e9339a46d778f5048814c7e63dff84dff19fb38fd224bc2d19cbd64033b99e7`  
		Last Modified: Fri, 05 Feb 2021 05:12:21 GMT  
...
```console
$ docker pull nextcloud@sha256:1de004fcdd4b1e033659b4504c7d44981f77bb17198e1232a0c97e2efdc16238
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173267340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfdae208c0653f485d8ec25b2b2a933950460e9d66e438bfb6c3c1a2dc750708`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Feb 2021 02:59:36 GMT
VOLUME [/var/www/html]
# Fri, 05 Feb 2021 03:07:15 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Fri, 05 Feb 2021 03:07:59 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 05 Feb 2021 03:08:08 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Fri, 05 Feb 2021 03:08:09 GMT
COPY multi:69a3d18e5826dcf2a02562f59ec38d4047623d6d537d30e24b29faeb8ea43f9d in /usr/src/nextcloud/config/ 
# Fri, 05 Feb 2021 03:08:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Feb 2021 03:08:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:41c9fcaa53f7d6257c4b0172c7bba985114535ee536a7e65f415fa3f5f75d24e`  
		...
		Size: 527.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ff4db7928260d1c345b11055f94c22be5ae816b23a265da90b2701985be623b`  
		Last Modified: Fri, 05 Feb 2021 03:59:18 GMT  
		Size: 118.7 MB (118670939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4197d4fb5758c177b3a671109d4114afe468b1a065e11382672ac1469aa2e081`  
		Last Modified: Fri, 05 Feb 2021 03:58:54 GMT  
		Size: 2.5 KB (2530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c1861ba4c9190246409de84753a74a402ec8cc4bfac13da2312be5372735d61`  
		Last Modified: Fri, 05 Feb 2021 03:58:55 GMT  
		Size: 1.9 KB (1895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
