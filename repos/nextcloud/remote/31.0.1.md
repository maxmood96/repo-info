...
### `nextcloud:31.0.1` - unknown; unknown
...
### `nextcloud:31.0.1` - linux; arm variant v5
...
### `nextcloud:31.0.1` - linux; arm variant v7
...
### `nextcloud:31.0.1` - linux; arm64 variant v8
...
### `nextcloud:31.0.1` - linux; mips64le
...
### `nextcloud:31.0.1` - linux; ppc64le
