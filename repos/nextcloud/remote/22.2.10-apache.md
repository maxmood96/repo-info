...
```console
$ docker pull nextcloud@sha256:e5a71d5718ab157f9686eaf8ff60fca9b2691efb7e6bb6b90fb35411474fdb6c
```
...
### `nextcloud:22.2.10-apache` - linux; amd64
...
### `nextcloud:22.2.10-apache` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:e688d633f712b7fcf1ef95c4c965a29bcb56056188a95ae720eec21ad86f13a9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.9 MB (301922892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7842bd951575f585a0779efcfdc9bbb18578823c51e3b157ac63f3766ffd4ae`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 03 Aug 2022 18:04:35 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Wed, 03 Aug 2022 18:05:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 18:05:36 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 03 Aug 2022 18:05:37 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 03 Aug 2022 18:05:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 03 Aug 2022 18:05:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bb566fd69b9cd089429d0055bf5ab30b403de4df56ab59b39fb55562f68e86c1`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2ffc8b5cc0b4f6b3407577191f57dad3902c1f43e5982fec68cbbbd47b14d07`  
		Last Modified: Wed, 03 Aug 2022 18:16:35 GMT  
		Size: 143.0 MB (143004856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8717688b1da4eb2568ca16cdc8d28f00d8f97dbfcf67763d4d3721c9fdcb7be2`  
		Last Modified: Wed, 03 Aug 2022 18:15:57 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d9a18aa1a7de07e8b4f43c35834a2788909d9c4f2acbd38d1407cb6d2d32d24`  
		Last Modified: Wed, 03 Aug 2022 18:15:57 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-apache` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:2f8ff0354091a0837abb3dc4d52c9e25fe533aeaf21378442097a843344d4726
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.9 MB (292886891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8aa2ae3a643c7ed06ed93892fe843577f8fab0e7dd0ee822257b53206f9e783b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 10:32:41 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Tue, 19 Jul 2022 10:34:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 10:34:14 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 10:34:16 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 10:34:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 10:34:17 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7091ac56952fadd51ba2bb30ba5f045d2e4bf033f463c3beeec08f838231ff01`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:649832d8e94245e61cd452e21f2214ab1d857edb32ec6248c7ca24fc64db2eee`  
		Last Modified: Tue, 19 Jul 2022 11:00:32 GMT  
		Size: 143.0 MB (143005207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3a6573ff0042dbe88229f81ee753928d5cfd3dd3980cc376c3afb296c257cd3`  
		Last Modified: Tue, 19 Jul 2022 10:58:55 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:448b1f7b953ba8d8cd76a41465526ec1b88a9f75d369530af41539da4de475ab`  
		Last Modified: Tue, 19 Jul 2022 10:58:55 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-apache` - linux; arm64 variant v8
...
### `nextcloud:22.2.10-apache` - linux; 386

```console
$ docker pull nextcloud@sha256:4d0b0ba09a0a1a25abd105c3da488b13d2cc756b9264d1b1b5c812c1cd182575
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.6 MB (327565594 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5612d4a60b057911e99e29d1fc32c0cb9877cb7e68f593b6ab4fc1c449717c4a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 02 Aug 2022 19:14:10 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Tue, 02 Aug 2022 19:14:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 02 Aug 2022 19:15:00 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 02 Aug 2022 19:15:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 02 Aug 2022 19:15:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Aug 2022 19:15:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6cdf4453104e3ab93e5723d1efc63544dffcf12adbcf3c6cdc8fc0950cef1c8b`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11e25eeb5a8d3241cc7e47ff5c01fde1316ec96c177102df89a16a00c1ebe4a6`  
		Last Modified: Tue, 02 Aug 2022 19:25:14 GMT  
		Size: 142.8 MB (142765069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c55e20ce19beb5e8de0ddd4ab56841c6ca8851531816a8d1fa9aebda11e3bf`  
		Last Modified: Tue, 02 Aug 2022 19:24:54 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9650968470fcfd7872bc11bd67f7241cae746949a4949012f4f14ddfbad714d4`  
		Last Modified: Tue, 02 Aug 2022 19:24:54 GMT  
		Size: 2.2 KB (2198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-apache` - linux; mips64le

```console
$ docker pull nextcloud@sha256:8f9a0b4b9864821bd52290fd7faefd3f782a794b64c23ecef2ff3e654eb2dd1a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.8 MB (300771742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:702eb723d5b6db1f749c8752cd516458fbd3e1aaacfdeafebb21cedd59a52b80`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 19 Jul 2022 16:02:41 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Tue, 19 Jul 2022 16:05:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 16:05:23 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 16:05:31 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 16:05:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 16:05:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:14bba06da0fa9b0f661b88852215534f472a44153f5809c3d5aa17c513b5de55`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00fb0c09937e66beb7a01a19bd0f041c50cbf7ef5f7ef612b509f2c3ead0e0d3`  
		Last Modified: Tue, 19 Jul 2022 16:24:58 GMT  
		Size: 142.8 MB (142766116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c381749fda75f24fce5874c4f5108971d9902c55adfe0a07e67ec29705de775`  
		Last Modified: Tue, 19 Jul 2022 16:23:25 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08c8d1337b428570371d0a4a3b524ea1786c9ba75b10a01f9409c04a9b121e62`  
		Last Modified: Tue, 19 Jul 2022 16:23:25 GMT  
		Size: 2.2 KB (2200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:22.2.10-apache` - linux; ppc64le
...
### `nextcloud:22.2.10-apache` - linux; s390x
