...
```console
$ docker pull nextcloud@sha256:936b94c076d3b2bc9188376197457c203d70fc33b01272003c9ea8c4d0c810b0
```
...
```console
$ docker pull nextcloud@sha256:10e8bdd77b5d4bb8c46568e2b2414e119f8a5757e733a4c845e99e55047ddf16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.3 MB (326326552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e741c0e6e2a45e0c66bedbb35fc554847d8e258a47c7e2c38b4fcac639a38de5`
...
-	Layers:
	...
	-	`sha256:ed0e17b65f65b298a5f3ac918e95470d25c40a58d81a084ef88b4ca2d53a1a58`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25714fba19c97706ec175d9c18bf1cbe5e1aad9249862322e9019be06e96fce2`  
		Last Modified: Tue, 19 Jul 2022 03:23:14 GMT  
		Size: 143.0 MB (143006683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb76ad6458f93a38757ca691f4f458c42c89b93ab0a27311d533427a5e58c564`  
		Last Modified: Tue, 19 Jul 2022 03:22:54 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea51aeaac6d54acb2fd61c4d79e5b116f30491fa9c0919e6c15de417828a81a5`  
		Last Modified: Tue, 19 Jul 2022 03:22:54 GMT  
...
```console
$ docker pull nextcloud@sha256:a851e2c88da66737ee013b1caaaa637041c6f052b39341d1e11810deafe02489
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.1 MB (301119018 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:114af0b41722b72356c55494febf4f9878ffbb6319f6a3b0718f48787f7b35c8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Jul 2022 06:41:14 GMT
ENV NEXTCLOUD_VERSION=22.2.10
# Tue, 19 Jul 2022 06:42:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 19 Jul 2022 06:43:10 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 06:43:12 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 06:43:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 06:43:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6cc0b4adf3da21fe642218c630a820b8c767b4ecd62b77685adfc2aefcdae548`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a724de0badd02fa92b0feb61c2c7aac29ca58524468beeef8ad1d37b8e7bd281`  
		Last Modified: Tue, 19 Jul 2022 07:11:38 GMT  
		Size: 143.0 MB (143005748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0225f5f90901676d2ec258985a1ddf829b2232b126df554b071f4a17189944d6`  
		Last Modified: Tue, 19 Jul 2022 07:11:22 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327791407fa6c547645dc3db1a04a793e7f164a645b1f4dd28fd417a4c46738b`  
		Last Modified: Tue, 19 Jul 2022 07:11:21 GMT  
		Size: 2.2 KB (2200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
