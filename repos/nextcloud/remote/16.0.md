...
```console
$ docker pull nextcloud@sha256:de20d4dfbb2737c4070f3d260edfbd9266135f7dd7f002b3ce26badc15ad1120
```
...
```console
$ docker pull nextcloud@sha256:ef8d53498f1253b97d495eb31672ec40b6a5880151fb606f3aea457a1644c1ef
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.8 MB (235798124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d94ab9538372443802b119b823ff859d98d560abeb45d53039d083a9bc0b40`
...
# Fri, 13 Mar 2020 22:52:58 GMT
ENV NEXTCLOUD_VERSION=16.0.9
# Fri, 13 Mar 2020 22:53:23 GMT
...
-	Layers:
	...
	-	`sha256:ead034211805208728822014a4ea596d433a28a173a35c3dc291cd1e5db1c2a2`  
		...
		Size: 541.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bf385b5ac33191dce6ed0325077b0bcbcda837df8d42f447c28b0de60fbda61`  
		Last Modified: Fri, 13 Mar 2020 22:58:02 GMT  
		Size: 69.0 MB (68974588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c213791787bcb898e4269101d95e1c3b3f3ddf85344845a880bd4d83eb21790c`  
		Last Modified: Fri, 13 Mar 2020 22:57:50 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32ea4d38b70b8cf234b39059ad74cbea6acf60c3cbf322107b72b5b39793c863`  
		Last Modified: Fri, 13 Mar 2020 22:57:50 GMT  
...
```console
$ docker pull nextcloud@sha256:1a4037ecba0e71f55d8d78686dfc7d4f4a2a13e09beaaf561d0fb5083ece463d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.7 MB (208697812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb5c694d8d493550133ab79026a41381c07e1ce1a114570b8223c428038203f5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 13 Mar 2020 21:18:26 GMT
ENV NEXTCLOUD_VERSION=16.0.9
# Fri, 13 Mar 2020 21:19:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 Mar 2020 21:19:16 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Fri, 13 Mar 2020 21:19:18 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Fri, 13 Mar 2020 21:19:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Mar 2020 21:19:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:42853f9cc40c1899b3166badcb423a34ff1cc010ad18060cb5e533678468487f`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2705f8c0d537310d95398a8a160f5c110b7dc8af99428e0db3dddd830ba0d69`  
		Last Modified: Fri, 13 Mar 2020 21:28:20 GMT  
		Size: 69.0 MB (68973082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73d4a30d6632205ee40a08e31999a6e76133402ddb833322b08d2e920ae33f6b`  
		Last Modified: Fri, 13 Mar 2020 21:27:52 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff386457fa1bbc744b9e942168cc6fd8dba405d7c6234c1118036a2417a7dff5`  
		Last Modified: Fri, 13 Mar 2020 21:27:52 GMT  
		Size: 1.2 KB (1181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:b961c181a8dd1f6381bf55d0d3fddba39474281295e4d7ea216c87247998e0be
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.1 MB (226125322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c22710c399e8738da0bb223a9940209fe8a3838f0c098d4067a9892495405dba`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 13 Mar 2020 20:47:25 GMT
ENV NEXTCLOUD_VERSION=16.0.9
# Fri, 13 Mar 2020 20:48:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 Mar 2020 20:48:20 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Fri, 13 Mar 2020 20:48:22 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Fri, 13 Mar 2020 20:48:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Mar 2020 20:48:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:aedda0cf42b808cc2d6daee96c4f1b6a2e5dde000f39f106a2aca71593ec95b0`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f3688d4153f148fe0d59e75ded02bdf60654b6e3a7163926abda87e879a8eb6`  
		Last Modified: Fri, 13 Mar 2020 20:57:29 GMT  
		Size: 69.0 MB (68974128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cdd2da5a212d0a77e2e1a941d022dced3100e381d18049a1a0d04e7fd946131`  
		Last Modified: Fri, 13 Mar 2020 20:57:08 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd2033f5dc612bbd90e57c9cf03fe3d8339e2494fcd6ad4eee77e14a0b0dc3e7`  
		Last Modified: Fri, 13 Mar 2020 20:57:08 GMT  
...
```console
$ docker pull nextcloud@sha256:a0ebedd1cf6ac07a5570601369ce7181a1ae7fff4227eff3464f103d11b68207
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.4 MB (247375170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76a82200478732468f3db76ef691f2db4234cad8bd94e9c57b1521394e0d9e0d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 13 Mar 2020 22:47:10 GMT
ENV NEXTCLOUD_VERSION=16.0.9
# Fri, 13 Mar 2020 22:50:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 Mar 2020 22:50:14 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Fri, 13 Mar 2020 22:50:17 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Fri, 13 Mar 2020 22:50:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Mar 2020 22:50:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:612caee1900a46d22012f791f6ff6f972a617a8d260e5137caa6798bdbff98a7`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96df62bb08fb2425854c39712df66d8a223ee28df21e5c1dbba82af4b66d52f9`  
		Last Modified: Fri, 13 Mar 2020 23:13:45 GMT  
		Size: 69.0 MB (68976723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c02f0fa91fb94a9f993ca1d0625421d55a77094007dcbee0077acfebd889d114`  
		Last Modified: Fri, 13 Mar 2020 23:12:40 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9e6b1256729c4e44759b8177bac68bc37ddfe7d4784375658b8208891cde453`  
		Last Modified: Fri, 13 Mar 2020 23:12:40 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
