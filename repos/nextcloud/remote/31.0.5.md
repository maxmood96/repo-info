...
### `nextcloud:31.0.5` - unknown; unknown
...
### `nextcloud:31.0.5` - linux; arm variant v5
...
### `nextcloud:31.0.5` - linux; arm variant v7
...
### `nextcloud:31.0.5` - linux; arm64 variant v8
...
### `nextcloud:31.0.5` - linux; mips64le
...
### `nextcloud:31.0.5` - linux; ppc64le
