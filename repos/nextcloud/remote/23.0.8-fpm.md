...
### `nextcloud:23.0.8-fpm` - linux; amd64
...
### `nextcloud:23.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:23.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:23.0.8-fpm` - linux; 386
...
### `nextcloud:23.0.8-fpm` - linux; s390x
