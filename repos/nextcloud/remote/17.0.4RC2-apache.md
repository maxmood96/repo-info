...
```console
$ docker pull nextcloud@sha256:bd45cb2c6720e487d6b336ce6550fbb9a30ae1b4cdcfeab7ac69e9b22c86cf2d
```
...
### `nextcloud:17.0.4RC2-apache` - linux; amd64

```console
$ docker pull nextcloud@sha256:e7da20b5ccb720c61338e67b58fd9976511a51856f47463bd173beb846438118
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.3 MB (239279525 bytes)**  
...
# Tue, 10 Mar 2020 00:40:36 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Tue, 10 Mar 2020 00:41:01 GMT
...
-	Layers:
	...
	-	`sha256:5708a3ac918494d8270de82dd627e6a265751b4051657548f7418cd38bfdd7bd`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:304a97291177ac0fd47ff80eef7bb904503bf318a08bc9ea3594071595134e72`  
		Last Modified: Tue, 10 Mar 2020 00:47:13 GMT  
		Size: 72.5 MB (72456082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76695ab7ca273696c854f374e276d350a2af3be4a111cb98e43c1695ff3dc77d`  
		Last Modified: Tue, 10 Mar 2020 00:46:17 GMT  
		Size: 2.2 KB (2160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fee2b3571f80025a2f72e6b34011dbb6615a8a4134de09126717f800e1586548`  
		Last Modified: Tue, 10 Mar 2020 00:46:17 GMT  
		Size: 1.2 KB (1180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.4RC2-apache` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:d08688050d77df0097179318e7315aaae7c3bbb179b2aa4c2e49ddc72988790b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.0 MB (216030678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0243b2204f87265e43dd9d2f83ac75a64e8bceb3be65c261c906e4c17d3c5b69`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 09 Mar 2020 23:52:12 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Mon, 09 Mar 2020 23:53:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 09 Mar 2020 23:53:09 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Mon, 09 Mar 2020 23:53:14 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Mon, 09 Mar 2020 23:53:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 09 Mar 2020 23:53:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:288dcf6c4fc71501765e53a602adb724cdb02481411337072f13f321e185d093`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:effab5cf443857ca64510ba32db0c82ca235ea2f2a0218600464d3a9571ada91`  
		Last Modified: Tue, 10 Mar 2020 00:02:42 GMT  
		Size: 72.5 MB (72453902 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:539485276d570e2506dfbdd0474a49768e4280c4e797a39400ff8fc8cdccce45`  
		Last Modified: Tue, 10 Mar 2020 00:01:03 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:524bd045e9f9453d98d273cfd1d8fa4ca62d258f83ff707569d34ebc2a25b0eb`  
		Last Modified: Tue, 10 Mar 2020 00:01:03 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.4RC2-apache` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:75479ff1b0aa840fe65140f5af35d978d09fdeafcba6b8578b7c51defff070a4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.2 MB (212179082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5981bbc934eda3a1b491aeb2a1c39f9ebb26e4aed0eda4db9eb07d0512777b80`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 10 Mar 2020 00:04:54 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Tue, 10 Mar 2020 00:05:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 10 Mar 2020 00:05:46 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Tue, 10 Mar 2020 00:05:48 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Tue, 10 Mar 2020 00:05:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 10 Mar 2020 00:05:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:50b7025de9cc703cf2d3ab76282c4b7bd805625c7b31257e5ca364769f7582af`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d22e643c288de0004b647bf613274f15e28bc8a93df32c905fb21193a2699ee`  
		Last Modified: Tue, 10 Mar 2020 00:16:01 GMT  
		Size: 72.5 MB (72453993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1a94a95b4638b64449cc1593f9b4a85e008360cd3fb3c88862495f692f879cb`  
		Last Modified: Tue, 10 Mar 2020 00:15:15 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07f743a86b46893aa35cf040329771925fc95ee3d5a44e9478485ed078aba5da`  
		Last Modified: Tue, 10 Mar 2020 00:15:15 GMT  
		Size: 1.2 KB (1180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.4RC2-apache` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:9492dc41181f20b4e913d91eed3f0819374792e5404adc5cc8a4010acd66d87d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.6 MB (229606652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e843c174d36e9f04ebfa8463390fc48a5bc6dbc3f57aa499a8fd205f752bf4dd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 10 Mar 2020 00:29:31 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Tue, 10 Mar 2020 00:30:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 10 Mar 2020 00:30:16 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Tue, 10 Mar 2020 00:30:17 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Tue, 10 Mar 2020 00:30:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 10 Mar 2020 00:30:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:52c403e10e8040b2be17bfe01f6b8a96cf624716aa518f19aef78c82870de8b7`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1963e29df68adfdf0eba686b94681c52c0d9e8ab087ab2038af77213ffde7718`  
		Last Modified: Tue, 10 Mar 2020 00:39:56 GMT  
		Size: 72.5 MB (72455348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:594ea6b07e9e3bc792294fe5ab8afae7a1ecaee8fe4bee0fe39714370aaf939b`  
		Last Modified: Tue, 10 Mar 2020 00:38:58 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c06a72a2dc950731c61a892179a2e0e4bb0cc2542fb2a95e1bf1a922243d830`  
		Last Modified: Tue, 10 Mar 2020 00:38:58 GMT  
		Size: 1.2 KB (1182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.4RC2-apache` - linux; 386

```console
$ docker pull nextcloud@sha256:1e2b328f820ff204eb814e8151f28897a1e2e70bfae651228894dbbf1364bea6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.6 MB (244601300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c4b519e75c9e40c752c2e0fd56f1ed650208d0bc99380e5332859f075e78458`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 09 Mar 2020 23:48:11 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Mon, 09 Mar 2020 23:48:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 09 Mar 2020 23:48:41 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Mon, 09 Mar 2020 23:48:41 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Mon, 09 Mar 2020 23:48:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 09 Mar 2020 23:48:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fd6434df68f16ea44cbf9b77052b956c3a6a726771494500388ed3ba963f6336`  
		...
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7df0829903c7a32943e3d7afc7c71ad06c6d6f3ee4b62b723bb9a7df6f55302`  
		Last Modified: Mon, 09 Mar 2020 23:56:05 GMT  
		Size: 72.5 MB (72455359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32204c7a9b2b188270690f1d89d642724bcc61fb85ab45c04a8f815eda4842b4`  
		Last Modified: Mon, 09 Mar 2020 23:55:43 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2183623147e76bc4ae0ae8c4f5c797ab6ee7d585d369149198d4f4efc7567746`  
		Last Modified: Mon, 09 Mar 2020 23:55:43 GMT  
		Size: 1.2 KB (1185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:17.0.4RC2-apache` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:9d423b18c5b3e1e40e5512864313a8cab2335af83f29df6730db6f431319f624
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.9 MB (250856324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b33ed0edd280d41e7734ae2b91537dc014dd6931c6e841b4232d1f78731c1c54`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 10 Mar 2020 00:58:13 GMT
ENV NEXTCLOUD_VERSION=17.0.4RC2
# Tue, 10 Mar 2020 01:03:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 10 Mar 2020 01:03:41 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Tue, 10 Mar 2020 01:03:44 GMT
COPY multi:6efb371887553e39646d44d52447fb2843cf0432474341096540cffb18b67fde in /usr/src/nextcloud/config/ 
# Tue, 10 Mar 2020 01:03:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 10 Mar 2020 01:03:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c1f3b069e65471b858607374b02f17426fa963dded87dbe72ca1ebac5480a097`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:237bd298cd9bbe9fca5dda601d0c84b5e3fc47cf5d9d2155e3915f2c967b982c`  
		Last Modified: Tue, 10 Mar 2020 01:45:30 GMT  
		Size: 72.5 MB (72458192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f96a4710ab7663a03d92d2ccde7dbb35c3b8a86218e30daab980330be8267edd`  
		Last Modified: Tue, 10 Mar 2020 01:42:57 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e77749501a61b9625b4efd5b78eac3d9cefbda9cc6f408a61c242aa382bbcde`  
		Last Modified: Tue, 10 Mar 2020 01:42:58 GMT  
