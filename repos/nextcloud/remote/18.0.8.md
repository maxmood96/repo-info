...
```console
$ docker pull nextcloud@sha256:987ff23dcb3bc3515407733673128363b1a31e104c1617a3cdedef2e0a43feab
```
...
### `nextcloud:18.0.8` - linux; arm variant v5
...
### `nextcloud:18.0.8` - linux; arm variant v7
...
### `nextcloud:18.0.8` - linux; arm64 variant v8
...
### `nextcloud:18.0.8` - linux; mips64le
