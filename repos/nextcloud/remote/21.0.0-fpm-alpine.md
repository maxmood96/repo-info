...
```console
$ docker pull nextcloud@sha256:3f1f083dffc54ab64b7a99ceded70aad7a8f22db9d9c43638d8a6b4971721465
```
...
```console
$ docker pull nextcloud@sha256:368ae7e56408dd3dd34f3368b8389312e2ebe93fc263b0f38b68d3590745908f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (171986361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8638bd486c5590c37cf67ca1433c7c2c7c472e2c1ac738b8041d22ebd34a649`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 01 Apr 2021 15:00:06 GMT
ENV NEXTCLOUD_VERSION=21.0.0
# Thu, 01 Apr 2021 15:01:08 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Apr 2021 15:01:17 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 15:01:24 GMT
COPY multi:991e3641380f9b3dd060d61dbd55821deb627e5f470e467cf77e4129a01f6d99 in /usr/src/nextcloud/config/ 
# Thu, 01 Apr 2021 15:01:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 15:01:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dbeca0d5c1d4bc1063f68ce20b31044ad8b36fe79af8e9598e9fc48deb1e5419`  
		...
		Size: 587.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42401080d17f1e7ec90e27dc3ecd09df5f93f2f52c2fbcc7d486654b029c80c3`  
		Last Modified: Thu, 01 Apr 2021 15:05:09 GMT  
		Size: 120.6 MB (120554488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e9c58af4f9fb139ed58986b8c49aaf42a0961a660e764d6858ee6d23db992dd`  
		Last Modified: Thu, 01 Apr 2021 15:04:25 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3b0041c65398f93224065ffdbd3e5714fab3c6d31be5ff52044e26ffed2139`  
		Last Modified: Thu, 01 Apr 2021 15:04:25 GMT  
...
```console
$ docker pull nextcloud@sha256:8f1f1bb90f667c5ca75153f86d1805859548495259bf83ee9a101b04c1b1364f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176645854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d33e9c7dbc750a887c8a77d49508553b8afdcd4602791215bc9b1fe5b27a8d3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Apr 2021 10:21:23 GMT
VOLUME [/var/www/html]
# Thu, 01 Apr 2021 10:23:36 GMT
ENV NEXTCLOUD_VERSION=21.0.0
# Thu, 01 Apr 2021 10:24:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Apr 2021 10:24:24 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 10:24:25 GMT
COPY multi:991e3641380f9b3dd060d61dbd55821deb627e5f470e467cf77e4129a01f6d99 in /usr/src/nextcloud/config/ 
# Thu, 01 Apr 2021 10:24:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 10:24:25 GMT
...
-	Layers:
	...
	-	`sha256:a0be095d6ad9284c938bc5a0690d2f74341b7a6ca0d6fc3b7fb8f63ab40fb2f0`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8127ce788e3bfd1237238c76c3d104e2514d98a177696df2e74a445906c29be3`  
		Last Modified: Thu, 01 Apr 2021 10:28:51 GMT  
		Size: 120.6 MB (120554231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54d06aa026b96e827a5d2fad9e4eb6f7951e55a2cd2b1aba796a59da471e2864`  
		Last Modified: Thu, 01 Apr 2021 10:28:25 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0672610679378e842082918b35545c629d4ec3ce9c2c5358a99ea1399a8a5e2`  
		Last Modified: Thu, 01 Apr 2021 10:28:23 GMT  
		Size: 1.9 KB (1948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
