...
```console
$ docker pull nextcloud@sha256:54a661730624d27b876ecf0afea55f81803e96fac8bec4c854bf0ab830d28d20
```
...
```console
$ docker pull nextcloud@sha256:59556f3788d758bd3166945f0ab892a5b2345d6cc57da3d73934ad5d5cbb8d97
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.6 MB (173640425 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d670c45dc97b1ff24e07b269c20f727d03a06eb212338da173b5a8f72c6b67ad`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 01 Apr 2021 05:44:43 GMT
ENV NEXTCLOUD_VERSION=21.0.0
# Thu, 01 Apr 2021 05:45:50 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Apr 2021 05:45:52 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 05:45:55 GMT
COPY multi:991e3641380f9b3dd060d61dbd55821deb627e5f470e467cf77e4129a01f6d99 in /usr/src/nextcloud/config/ 
# Thu, 01 Apr 2021 05:46:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 05:46:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ae0a001fef72d540e1fa078613168f4f8a9541e0b476c93150f1f0fc6faf6ff3`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58bf96e6751d57ef93475bbe3165fee62b0608e6cf8d0c93566f4e4ffc7d1aa5`  
		Last Modified: Thu, 01 Apr 2021 05:48:50 GMT  
		Size: 120.6 MB (120554498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:211ab903edc657509bd78c5622ab2809e374db833e4ed94e6bd020455e171edc`  
		Last Modified: Thu, 01 Apr 2021 05:48:01 GMT  
		Size: 2.5 KB (2531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9bac08e0b7b87b08ba9da4a45f1195dd71cb2175d545e47ad74224740a95907`  
		Last Modified: Thu, 01 Apr 2021 05:48:01 GMT  
...
```console
$ docker pull nextcloud@sha256:63a5dc2c7cedae01eac87697f7004340ad760c106883e62f90ea81420bf5e17b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174742228 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96cd13aa8b5eab4e450116792403f2ae13bd073e1805bdd1cb702d5963acc667`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Apr 2021 05:11:15 GMT
VOLUME [/var/www/html]
# Thu, 01 Apr 2021 05:12:59 GMT
ENV NEXTCLOUD_VERSION=21.0.0
# Thu, 01 Apr 2021 05:13:27 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Apr 2021 05:13:34 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 05:13:34 GMT
COPY multi:991e3641380f9b3dd060d61dbd55821deb627e5f470e467cf77e4129a01f6d99 in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:b4bfba964e359312d46aad077f5523dc136ab4a275f19359968f40d8c718f8e2`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d7b34f02ce4c5a61c4bf4ad824935ea847ed58b8f45975065243ceb5812c609`  
		Last Modified: Thu, 01 Apr 2021 05:15:25 GMT  
		Size: 120.6 MB (120554262 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa28324c1fbe657e9fd31d39580e578211d6ad24773f22c9c127b5283ea0ea7a`  
		Last Modified: Thu, 01 Apr 2021 05:15:10 GMT  
		Size: 2.5 KB (2533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d689cf1da09f9276ef2f6264e080c714b6d9e52d9fed600331f9adac4bf8ab6c`  
		Last Modified: Thu, 01 Apr 2021 05:15:10 GMT  
		Size: 1.9 KB (1947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
