...
```console
$ docker pull nextcloud@sha256:f9e62d3401bc051e462a2879f8336c33f876315ef25ad6590d9ce601325c6192
```
...
### `nextcloud:30.0.7-fpm-alpine` - linux; amd64
...
### `nextcloud:30.0.7-fpm-alpine` - unknown; unknown
...
### `nextcloud:30.0.7-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:30.0.7-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:30.0.7-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:30.0.7-fpm-alpine` - linux; 386
...
### `nextcloud:30.0.7-fpm-alpine` - linux; ppc64le
...
### `nextcloud:30.0.7-fpm-alpine` - linux; s390x
