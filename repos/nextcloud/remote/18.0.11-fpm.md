...
```console
$ docker pull nextcloud@sha256:bccbd7db889c5b08e3386a2f27ede0122bf3129b676dca314781305e0680907e
```
...
```console
$ docker pull nextcloud@sha256:9e338d045133c74d0b483a37ba94988f046f2091d2ed5668ec54a044caa494cb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.0 MB (242031084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb0c69a7eae0879062638ceef7c2a653806e1d28fc29905559bdfa5c2b1c3213`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 19 Nov 2020 19:53:24 GMT
ENV NEXTCLOUD_VERSION=18.0.11
# Thu, 19 Nov 2020 19:56:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Nov 2020 19:57:04 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 19 Nov 2020 19:57:13 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Thu, 19 Nov 2020 19:57:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Nov 2020 19:57:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fbf097035415170d844c66adf2dabe936d1758f290052b76824fd543cbf340d6`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80ec47417b9e6ae37ad9df67f2ef94bd46fa0387e3e382dee69556a65d6924be`  
		Last Modified: Thu, 19 Nov 2020 20:16:56 GMT  
		Size: 102.1 MB (102110502 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a74462cbbf8a32dcaa0da833a44ebb9ae9bd5ac672ae2396ec890beddb63f7b`  
		Last Modified: Thu, 19 Nov 2020 20:16:24 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3100527287a40d7018cb0b432f636feceee405e5c946ba4930b8896c233f10f3`  
		Last Modified: Thu, 19 Nov 2020 20:16:24 GMT  
...
```console
$ docker pull nextcloud@sha256:34d237b62d1457ad57ca1c37dc1ee0055bacee38deaae2097ee089a2fdf7a798
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.3 MB (249345104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70021f5eb058f7a87c8cfac04c4507580d3869df49e82626ca651efce5d6527c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Nov 2020 19:37:30 GMT
VOLUME [/var/www/html]
# Thu, 19 Nov 2020 20:10:34 GMT
ENV NEXTCLOUD_VERSION=18.0.11
# Thu, 19 Nov 2020 20:11:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Nov 2020 20:12:07 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 19 Nov 2020 20:12:09 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Thu, 19 Nov 2020 20:12:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Nov 2020 20:12:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:93345920c7591f1f28b2ac5582a78ec6d4845e2f77968f9d1ef52d3051556c02`  
		...
		Size: 530.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5d69ffe3ebb88deb037a8f7d7eb783bbe79eca67ff17300b6403ca791da3755`  
		Last Modified: Thu, 19 Nov 2020 20:27:57 GMT  
		Size: 102.1 MB (102110603 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaacabdc1a5a5e6833c5d88a945dd47b3fcfa9acacdcb34ad6dfee377e046e26`  
		Last Modified: Thu, 19 Nov 2020 20:27:38 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4df2daf6b21eedee0c0f0544e0a974124c486e795f4fc853239195150751fe31`  
		Last Modified: Thu, 19 Nov 2020 20:27:38 GMT  
		Size: 1.9 KB (1898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
