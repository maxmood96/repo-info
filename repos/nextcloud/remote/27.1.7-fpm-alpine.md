...
```console
$ docker pull nextcloud@sha256:6ec63cbe67efdfe7bf2dfd3b0ee1742b1dc57838c577ad765dc90e12fe5bf99a
```
...
```console
$ docker pull nextcloud@sha256:c397bdc3a05ca636d1eb08e3a85b50175fb3b68ac721fc81bdf976775aada33e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.5 MB (249469629 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:728182e36c91ad3dd118ef193bd1022546aa8f05dc291f129692f3290a8b33d8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 16 Mar 2024 14:01:35 GMT
ENV NEXTCLOUD_VERSION=27.1.7
# Sat, 16 Mar 2024 14:02:59 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 16 Mar 2024 14:03:03 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 16 Mar 2024 14:03:06 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 16 Mar 2024 14:03:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 16 Mar 2024 14:03:06 GMT
...
-	Layers:
	...
	-	`sha256:7fe270f7b9ffabb91fdc795c85d8a15ed8a02968ea1e8630f2fc539f040b9b75`  
		...
		Size: 763.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5ab14665dfe95842c6a911e53f6492ce46f9a2887398897b50a3d1b5a1669ef`  
		Last Modified: Sat, 16 Mar 2024 14:14:52 GMT  
		Size: 207.0 MB (206987039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c65bc0e96a92e00fa31c3287b63acd1988d5fca0f04f8bfcb3d3bd70457249c`  
		Last Modified: Sat, 16 Mar 2024 14:14:13 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c4ee22511a161c642fdd83a547a31e070848cc7db53b478b509a8e5614dc8b9`  
		Last Modified: Sat, 16 Mar 2024 14:14:13 GMT  
...
```console
$ docker pull nextcloud@sha256:331c6e4e55e04c678a94627543ac81353afc02d3680e90a72d65713dd3618dad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.9 MB (253939481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d94db0ac02f86bb95e325b2da57976b86bf453cc8b667c2310a3bc49139ce822`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 16 Mar 2024 12:05:07 GMT
ENV NEXTCLOUD_VERSION=27.1.7
# Sat, 16 Mar 2024 12:06:01 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 16 Mar 2024 12:06:07 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 16 Mar 2024 12:06:07 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sat, 16 Mar 2024 12:06:07 GMT
...
-	Layers:
	...
	-	`sha256:c668279621e4393819c45077af11dbe73d493eff73394430201761076600443d`  
		...
		Size: 756.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:533422d5410f348bf66359e8e61035218222278cd03ad3dce68228c898152f1a`  
		Last Modified: Sat, 16 Mar 2024 12:13:19 GMT  
		Size: 207.0 MB (206986880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1abdf63c2ad6736a95b100a819865540df41ec20ab3258c888c99d38920604a`  
		Last Modified: Sat, 16 Mar 2024 12:12:58 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b4206c0d659e2352ddc74d8fb938c978c7c083fbfd72db03949b05e2e6f6ed6`  
		Last Modified: Sat, 16 Mar 2024 12:12:58 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:e4444969c6f3245661c764c2fd1c638379ce4ef00b0229269812b547b9d8f22e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.6 MB (253590705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a20a336a91c9cbe39c6bb5b0c3b22715bcfd3ec40e27eeeeb54e100a3891127`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 17 Mar 2024 02:43:17 GMT
VOLUME [/var/www/html]
# Sun, 17 Mar 2024 02:49:19 GMT
ENV NEXTCLOUD_VERSION=27.1.7
# Sun, 17 Mar 2024 02:50:03 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.1.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sun, 17 Mar 2024 02:50:14 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sun, 17 Mar 2024 02:50:15 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Sun, 17 Mar 2024 02:50:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 17 Mar 2024 02:50:15 GMT
...
-	Layers:
	...
	-	`sha256:51a24547436dca0f5b866326ad23845ed12e3ad93e385c2739906fd6a116cae9`  
		...
		Size: 758.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdb42cb8d5989f86062fe6bac73817a303d57c2282a41e5a2ab8fb7d461407c7`  
		Last Modified: Sun, 17 Mar 2024 03:01:20 GMT  
		Size: 207.0 MB (206987214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfa7490e69ca1e62db43cae880ed3fb55c13fc32ce632a5d7e8fef9df04ae754`  
		Last Modified: Sun, 17 Mar 2024 03:00:57 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5878347da7b6e7073dc8542a11e4b93312302d05d83194ec066bf0b12a288f2`  
		Last Modified: Sun, 17 Mar 2024 03:00:57 GMT  
