...
```console
$ docker pull nextcloud@sha256:0e8ee7598911ded1d78f98d02efb3dae686c191d4cad249929b604b8fa3e359a
```
...
```console
$ docker pull nextcloud@sha256:9c4099f5dc3f8c66d9ec5bdd1780fce0578016129897b4554b408f6fcb4bca10
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **285.3 MB (285272713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22294d5b431b397c3ac05a8fe78fbd8bac88d52b4dd77ec249711880ec0c8c84`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sun, 05 Feb 2023 07:57:55 GMT
ENV NEXTCLOUD_VERSION=24.0.9
# Sun, 05 Feb 2023 07:58:38 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 05 Feb 2023 07:58:40 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sun, 05 Feb 2023 07:58:40 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sun, 05 Feb 2023 07:58:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 05 Feb 2023 07:58:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1dc71f5535c367dbea6642196a303644ae63d6505f8fa6f2dd79cc6c331859f3`  
		...
		Size: 568.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d4c14cde9568807fe7b6a9e04802c03ec9702183f671b0a20fb6e3947334359`  
		Last Modified: Sun, 05 Feb 2023 08:11:27 GMT  
		Size: 135.1 MB (135074439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a82f9bc1f5538c3c6c8e87493dd314f239d0fbc57ed8edc72172e35e51683e53`  
		Last Modified: Sun, 05 Feb 2023 08:11:03 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fb9938b106899ca34dc9054728ce4ba91fb5a50546188cb06d95fae1337bd10`  
		Last Modified: Sun, 05 Feb 2023 08:11:03 GMT  
		Size: 2.2 KB (2151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:931a06ec69a52d8f41abedda328a866664954d0ff7023fdee06cd00185788458
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.6 MB (309612376 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1e9513b357c2c88b4ea7af9332ac529e7070fc978c3a6ba1e520f36c25ea72b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c61369a07156a8b0ffd7a26427d681b27b5525b27b8fb882d1e54ce17b8d1c3f`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95bc8162191b0d243197cb6d4781ba362821b0d6d20caece175c099f072c54aa`  
		Last Modified: Sat, 04 Feb 2023 23:47:37 GMT  
		Size: 135.1 MB (135076131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fed355dc37d4f2b686a2d38643886279a971548ee999d636a60a5990ab92a435`  
		Last Modified: Sat, 04 Feb 2023 23:47:24 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17529142e93e82635e1aab4bdd916b666f7084be491041fa544558242a5c7e06`  
		Last Modified: Sat, 04 Feb 2023 23:47:24 GMT  
...
```console
$ docker pull nextcloud@sha256:db88ea57eacf93c9564d03fc15b82f85793bd63580920568c1aac8d9156095a3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.1 MB (320092131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:870e0188247ffd9efef0e50c77138f90b1700abd894de9f2ebd7ab6803d49b17`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sun, 05 Feb 2023 01:49:52 GMT
ENV NEXTCLOUD_VERSION=24.0.9
# Sun, 05 Feb 2023 01:50:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 05 Feb 2023 01:50:39 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sun, 05 Feb 2023 01:50:41 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sun, 05 Feb 2023 01:50:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 05 Feb 2023 01:50:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bdc0ff838c040aca9fe5929f434fa3af2677f5d910856af370301ad2367f565f`  
		...
		Size: 571.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbe84ea05036916986d6cd08e1b3c9266585ba64de673e796fda7c33a5a58b33`  
		Last Modified: Sun, 05 Feb 2023 02:02:27 GMT  
		Size: 134.8 MB (134836419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b653ae4965c51604b92b5bebce18384cc5154deb91aa796c82ab25d05948484f`  
		Last Modified: Sun, 05 Feb 2023 02:02:10 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0652f19a348ad894cdfa9567baf247abf9f641e3ed5c3e8dac06092b3c50bc98`  
		Last Modified: Sun, 05 Feb 2023 02:02:10 GMT  
...
```console
$ docker pull nextcloud@sha256:9b723901cc23d2311a1f2548499e9f2d1cf93f0b8c42b5ccb5c1497b445aa464
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.9 MB (318851621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f740fb94b0ea4b24f2885ade7cb36e03b494861411adb7c6e10fbe29339680b8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 00:39:16 GMT
VOLUME [/var/www/html]
# Sun, 05 Feb 2023 00:42:35 GMT
ENV NEXTCLOUD_VERSION=24.0.9
# Sun, 05 Feb 2023 00:43:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 05 Feb 2023 00:43:55 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sun, 05 Feb 2023 00:43:57 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sun, 05 Feb 2023 00:43:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 05 Feb 2023 00:43:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9ac0b099202cfd8d4ca2f3647ac8cfc56276cfedab2ad9cf7a02306e8c0785e0`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ad01d393a44df3b501fd7e63ed322a4086d3deb0ebd9ad806406f0c8091441d`  
		Last Modified: Sun, 05 Feb 2023 01:03:19 GMT  
		Size: 135.1 MB (135077389 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7e80ce6f8d8dac1c05bc27b5d5b0dcd3001985c4c6ac197af9e9e1ee6a57b9b`  
		Last Modified: Sun, 05 Feb 2023 01:02:50 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d37f3e0584d5bf6f47ecefd2f1011ef9b56fce31eb47efb0b10617b5959b5f6c`  
		Last Modified: Sun, 05 Feb 2023 01:02:50 GMT  
