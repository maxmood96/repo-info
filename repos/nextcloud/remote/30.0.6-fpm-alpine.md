...
```console
$ docker pull nextcloud@sha256:9170434e34f1fa13553e4b79b42169d27e63ed5d1d3a9f800b714c542114a51f
```
...
### `nextcloud:30.0.6-fpm-alpine` - linux; amd64
...
### `nextcloud:30.0.6-fpm-alpine` - unknown; unknown
...
### `nextcloud:30.0.6-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:30.0.6-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:30.0.6-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:30.0.6-fpm-alpine` - linux; 386
...
### `nextcloud:30.0.6-fpm-alpine` - linux; ppc64le
...
### `nextcloud:30.0.6-fpm-alpine` - linux; s390x
