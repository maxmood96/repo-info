...
```console
$ docker pull nextcloud@sha256:f7d238f7418db697f7decd668596ede8f9806e92b9f18883e43c5e2c96acf2c7
```
...
```console
$ docker pull nextcloud@sha256:a5c4d20666ec3d88eb9e642609121603405ed6fe66fe6e776b19a81376e9aa6c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.3 MB (260304691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5026b5377593531da29b36e9a8c65730cbe79d6261b1dd63627b4e403b4e4a76`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Feb 2021 02:55:10 GMT
VOLUME [/var/www/html]
# Fri, 05 Feb 2021 03:02:13 GMT
ENV NEXTCLOUD_VERSION=20.0.6
# Fri, 05 Feb 2021 03:03:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 05 Feb 2021 03:03:23 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Fri, 05 Feb 2021 03:03:25 GMT
COPY multi:69a3d18e5826dcf2a02562f59ec38d4047623d6d537d30e24b29faeb8ea43f9d in /usr/src/nextcloud/config/ 
# Fri, 05 Feb 2021 03:03:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Feb 2021 03:03:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1869abcb92dcc5aa1c2e1d7fce68d52e03f61c2fddf4a06a7eb739efef477012`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c69856c22526305d7cd64d69428c8daffde298808ceed2a3338933262d50cdc2`  
		Last Modified: Fri, 05 Feb 2021 03:41:20 GMT  
		Size: 114.7 MB (114733490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90e85412a750b743ea029a4f9b2b1eb1668929a931030eed6f35542ad2677387`  
		Last Modified: Fri, 05 Feb 2021 03:41:02 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b8736388e59dbc15a16741f347e387d625a375a0f45eab32524869b2ea217c3`  
		Last Modified: Fri, 05 Feb 2021 03:41:07 GMT  
		Size: 1.9 KB (1895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
