...
```console
$ docker pull nextcloud@sha256:18e22ad05df6bcf6bf8d9c9e38aa0daa25a322a016fc7fc51b33f2ce99bb1057
```
...
### `nextcloud:19.0.4-fpm-alpine` - linux; amd64
...
### `nextcloud:19.0.4-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:19.0.4-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:19.0.4-fpm-alpine` - linux; 386
...
### `nextcloud:19.0.4-fpm-alpine` - linux; ppc64le
...
### `nextcloud:19.0.4-fpm-alpine` - linux; s390x
