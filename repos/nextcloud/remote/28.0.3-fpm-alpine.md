...
```console
$ docker pull nextcloud@sha256:fa6ea1ced65e6e225621c8fd770c128eb5c9ce901f223567aebbc5086af61ba2
```
...
### `nextcloud:28.0.3-fpm-alpine` - linux; amd64
...
### `nextcloud:28.0.3-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:28.0.3-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:28.0.3-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:28.0.3-fpm-alpine` - linux; ppc64le
...
### `nextcloud:28.0.3-fpm-alpine` - linux; s390x
