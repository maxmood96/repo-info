...
```console
$ docker pull nextcloud@sha256:5013667236c8a6ee74cc266a11b9b07a4ea5efeb961919bc83549b301e1e44a0
```
...
```console
$ docker pull nextcloud@sha256:46ccee626422dcd9a89f56bdf30f3c6832ef5911d66f46f238df2442e2cda00c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.7 MB (183737987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69240462364a87422f1ee3cad912b72cbee75983e32e14a06531b548ffa1e793`
...
VOLUME [/var/www/html]
# Thu, 17 Dec 2020 18:30:42 GMT
ENV NEXTCLOUD_VERSION=20.0.3
# Thu, 17 Dec 2020 18:31:10 GMT
...
-	Layers:
	...
	-	`sha256:cedf62bcaa0243c433b396d0e5afdb84e243b24e451654b778dd71b345ceb200`  
		...
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0edbca421a17d3947b54a8fbd0f2989b43a545418a9d8dd3119fe7e4e567476e`  
		Last Modified: Thu, 17 Dec 2020 18:33:30 GMT  
		Size: 128.1 MB (128149985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:583e78185263be6dc080c7834b7938b3979f6e3fa228afa4ad81e17ec606295c`  
		Last Modified: Thu, 17 Dec 2020 18:33:11 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fa884b1eeeaa16544011073ca294b8bbc9db28a96c97e14c45647ba0af9584e`  
		Last Modified: Thu, 17 Dec 2020 18:33:11 GMT  
...
```console
$ docker pull nextcloud@sha256:bf56a1ef88923ec04bd1f316a05c43b867cf5922f758db571ac3030da87ccf9e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181691587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6224df2df7bf6c4fccee3741a5442790e0c74e4a4404aedc103c710c256ba2e1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Mon, 21 Dec 2020 20:04:15 GMT
ENV NEXTCLOUD_VERSION=20.0.4
# Mon, 21 Dec 2020 20:05:23 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Mon, 21 Dec 2020 20:05:28 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Mon, 21 Dec 2020 20:05:32 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Mon, 21 Dec 2020 20:05:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:38dce89870ba1cc57bf01718a33ffe34c02556dbded1103bcecee6837ef2c27f`  
		...
		Size: 526.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f027ca3ed26547d8f0650d646a86bb034513a0d7e9e840e8b71576d7f3bb17c1`  
		Last Modified: Mon, 21 Dec 2020 20:08:41 GMT  
		Size: 128.2 MB (128198230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c588ee07f1b21b225aa898518c405932f02054dfc81d64aab8a450387523b247`  
		Last Modified: Mon, 21 Dec 2020 20:08:00 GMT  
		Size: 2.5 KB (2531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05276304de8f08ef25d69a9cfb58d9c81e18a3992c3afea2ca52aafd203448b8`  
		Last Modified: Mon, 21 Dec 2020 20:08:00 GMT  
