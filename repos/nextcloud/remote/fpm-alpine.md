...
```console
$ docker pull nextcloud@sha256:19e597a33a553b9b643f8c0890f0a1b0b95a2301865b73bd6b25af3742207409
```
...
```console
$ docker pull nextcloud@sha256:61112ad8953c00b05195f43f98aa81fb32bed4599b84ce564aec514ddd5ca0e0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.0 MB (179988293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bdde223d04c572e5783f58f651ceee23d316f540bae84ba06eaa41c7462c324`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Mon, 21 Dec 2020 21:05:26 GMT
ENV NEXTCLOUD_VERSION=20.0.4
# Mon, 21 Dec 2020 21:06:16 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Mon, 21 Dec 2020 21:06:21 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Mon, 21 Dec 2020 21:06:27 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Mon, 21 Dec 2020 21:06:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 21 Dec 2020 21:06:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6b454cb6b16869af83cd2f116f475f4cfdabf7973a92ac657b8140283c177650`  
		...
		Size: 525.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a079b91de87e5a9de699a5d167740e7c0c3e959b356b6d1b0d8c639e81eb2c37`  
		Last Modified: Mon, 21 Dec 2020 21:16:07 GMT  
		Size: 128.2 MB (128198210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3148baad939c2f6ce345bb600bf2ef71bcc01ab0309178f9829bb345e614a33`  
		Last Modified: Mon, 21 Dec 2020 21:15:27 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:542c95f402ea6e31e129d5edbe6a08cc478fa42353999a3b783aced3d3ae8177`  
		Last Modified: Mon, 21 Dec 2020 21:15:27 GMT  
...
```console
$ docker pull nextcloud@sha256:ba44eef119011be96e608741dbec3ad0fc569d872c27ac50c6216ccc4c042f3a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183336062 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f69e5de306618274e25d412dd82d97bf743ad3ddcab0477c1ca62339d25d078`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Mon, 21 Dec 2020 20:43:39 GMT
ENV NEXTCLOUD_VERSION=20.0.4
# Mon, 21 Dec 2020 20:44:26 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Mon, 21 Dec 2020 20:44:33 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Mon, 21 Dec 2020 20:44:36 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Mon, 21 Dec 2020 20:44:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 21 Dec 2020 20:44:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:57f9d11f647d22941f994f35bb1d933e3bbddb00a047fba51b0895cb5232fb76`  
		...
		Size: 526.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b71609befd11bb7aa2db1a0a55c6a1a5e284850b5145d44736dac3bcb30c333d`  
		Last Modified: Mon, 21 Dec 2020 20:53:55 GMT  
		Size: 128.2 MB (128198113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92f2a7062d5f4c89b973e1032f074df4a8f50622ceb54e31b092253b7cb53ecb`  
		Last Modified: Mon, 21 Dec 2020 20:53:25 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5395e258deb610ae5c531482ee9408c8553cc0b7cd56096298a2de4fbed55b0`  
		Last Modified: Mon, 21 Dec 2020 20:53:25 GMT  
...
```console
$ docker pull nextcloud@sha256:9567162b294d60d06a7d49bbd83114384b400692834947bd2188cf110aa4a8e1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.8 MB (182765675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:292b0cc8fe80480af32b60c3fa8dfa556ef9f4621cf1c4d72cfe606d680e5a5f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Dec 2020 12:08:36 GMT
VOLUME [/var/www/html]
# Mon, 21 Dec 2020 20:38:10 GMT
ENV NEXTCLOUD_VERSION=20.0.4
# Mon, 21 Dec 2020 20:39:23 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Mon, 21 Dec 2020 20:39:34 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Mon, 21 Dec 2020 20:39:36 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Mon, 21 Dec 2020 20:39:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 21 Dec 2020 20:39:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:35611d6ef2cb85cc947dbe14c5a511f36398d353c1b3214154de3840ea1cbe3a`  
		...
		Size: 525.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aca8fd12691074a77498e861f26ecf83eb10557c27d2ececa7ce2008e6c3d30e`  
		Last Modified: Mon, 21 Dec 2020 20:50:26 GMT  
		Size: 128.2 MB (128198136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa0557ff274a93a389771a291dc9017302b4201c81651d84fb1a3b7604e8faaa`  
		Last Modified: Mon, 21 Dec 2020 20:50:09 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaebbcb53f8bcc916fbc403b750144913894a47b85b3b4a2d2140c33568f27d2`  
		Last Modified: Mon, 21 Dec 2020 20:50:09 GMT  
