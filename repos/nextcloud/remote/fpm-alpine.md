...
```console
$ docker pull nextcloud@sha256:7f93d53f1c57b835d51e961a4fc3f2acde6909e6943c0ee374f0971635cdea53
```
...
```console
$ docker pull nextcloud@sha256:2603357b58390c8e605d0a548c96fb0f8340858cdf2fba87e2f6d6fb1d5c6b87
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202612975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c81cdb9805dd3c03e8f47e7ac946b9da1f296f51abfc90aba6dbab2c4b365470`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 14:45:46 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 14:58:22 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Tue, 19 Apr 2022 14:59:46 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Apr 2022 14:59:49 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 19 Apr 2022 14:59:51 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Apr 2022 14:59:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 14:59:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b1e0ae5b5bc971f7b836f271cf21b296b527dbeefae489b0e8b0f08ebe5820fb`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:802697657bfca2043f7b727388fd0851ea3a110f6311680f06dc92ea90ab8514`  
		Last Modified: Tue, 19 Apr 2022 15:13:10 GMT  
		Size: 153.1 MB (153106472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06319932ce9bf6e2f08852e672b876617ad9630021a8534f0c159fd57dbcdc0a`  
		Last Modified: Tue, 19 Apr 2022 15:11:25 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e8ee8bf361bd7c06f6d77aed3b0a7660f7bcfda87341ea1cefdd405afdbb518`  
		Last Modified: Tue, 19 Apr 2022 15:11:25 GMT  
...
```console
$ docker pull nextcloud@sha256:0eedddc580791c2a65538680bf3866aec3b1052e0923fa284c4502fd70edf2ae
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207201013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88ff771d37adc11d07511fe2b5a1426aa9075ab9f2eaf88b370bf4c72c15d55f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 15:44:41 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Tue, 19 Apr 2022 15:45:55 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Apr 2022 15:46:02 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 19 Apr 2022 15:46:05 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Apr 2022 15:46:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 15:46:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:426b2fb655e4e1683edd33b8633f060e13d3975d6dbcb3f68904a55153ada932`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d61d2c4c76111e406e1daa0e72eac0be65661b66cab5ef71613c5ada4e8390df`  
		Last Modified: Tue, 19 Apr 2022 15:55:15 GMT  
		Size: 153.1 MB (153106512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f711b9a1cde4f0c20dea494b7fa0d06a7586de1d97ca351e902c39faf475ff8`  
		Last Modified: Tue, 19 Apr 2022 15:54:49 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4e4851d28f6277fbe945caa2eb406d1c91109583d9128a89f337627e7b800e0`  
		Last Modified: Tue, 19 Apr 2022 15:54:49 GMT  
		Size: 2.1 KB (2139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
