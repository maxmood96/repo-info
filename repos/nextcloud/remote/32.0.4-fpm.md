...
```console
$ docker pull nextcloud@sha256:fa4274c56ea8695133a2d77e1465d677402d25db0860cfc466d0a53f06a613e5
```
...
### `nextcloud:32.0.4-fpm` - linux; amd64
...
### `nextcloud:32.0.4-fpm` - unknown; unknown
...
### `nextcloud:32.0.4-fpm` - linux; arm variant v5
...
### `nextcloud:32.0.4-fpm` - linux; arm variant v7
...
### `nextcloud:32.0.4-fpm` - linux; arm64 variant v8
...
### `nextcloud:32.0.4-fpm` - linux; 386
...
### `nextcloud:32.0.4-fpm` - linux; ppc64le
...
### `nextcloud:32.0.4-fpm` - linux; s390x
