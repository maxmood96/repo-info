## `nextcloud:30.0.8-apache`

```console
$ docker pull nextcloud@sha256:d328982225ca78abed603282e6c2787fee574594e88fab73a4e6d054ce8fb07c
```
...
### `nextcloud:30.0.8-apache` - linux; amd64
...
### `nextcloud:30.0.8-apache` - unknown; unknown
...
### `nextcloud:30.0.8-apache` - linux; arm variant v5
...
### `nextcloud:30.0.8-apache` - linux; arm variant v7
...
### `nextcloud:30.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:30.0.8-apache` - linux; 386
...
### `nextcloud:30.0.8-apache` - linux; mips64le
...
### `nextcloud:30.0.8-apache` - linux; s390x
