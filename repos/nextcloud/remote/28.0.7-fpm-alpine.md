...
### `nextcloud:28.0.7-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:28.0.7-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:28.0.7-fpm-alpine` - linux; 386
...
### `nextcloud:28.0.7-fpm-alpine` - linux; ppc64le
...
### `nextcloud:28.0.7-fpm-alpine` - linux; s390x
