...
```console
$ docker pull nextcloud@sha256:3a583f97aaec9973b69b0f4696d40f8a330a9f1d6066631c1f3902c8c55cd01f
```
...
```console
$ docker pull nextcloud@sha256:bd486f6ef05d1b7bd70c9cc1130040e2a7d34a6fa3dcc6d2fe20b382294cd437
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.1 MB (284074664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:665f73f42e35be27de21c5f4f296af22ef6610b6ca2c4c811caf7c4c152ef44c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 10 Jun 2022 11:13:25 GMT
ENV NEXTCLOUD_VERSION=24.0.1
# Fri, 10 Jun 2022 11:14:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 11:14:53 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 11:14:55 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 11:14:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 11:14:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ea3670d804b1b4c98505f95c96eaaf7737744a4cf912a7b7b73f4f7aa1f8c06d`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a239a1ec7e4e12146da58e10bc180a7cc73b2a8f8ace7b01fa100e7f0bd78ab3`  
		Last Modified: Fri, 10 Jun 2022 11:30:38 GMT  
		Size: 134.1 MB (134092305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57b1037a850eaaa1db6e82c2cb56f48d025ab114e2d7fe2a6e97d535cb4e2cf6`  
		Last Modified: Fri, 10 Jun 2022 11:29:11 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7990745d806cc86d8fb09b3b6b79f84ba775679ba33cb6439d6a1fe86a95ffcb`  
		Last Modified: Fri, 10 Jun 2022 11:29:11 GMT  
...
```console
$ docker pull nextcloud@sha256:5034cf03d79fc82983b89a9925b7bac2ce7d0a89bfdaff5745e00bda1934b053
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.8 MB (291753892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33948f552aff57dbe9134b4b8b108bdb3781dd9fa3b13642fa0fe3bf8dd4cc2a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 10 Jun 2022 09:54:10 GMT
ENV NEXTCLOUD_VERSION=24.0.1
# Fri, 10 Jun 2022 09:56:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 09:56:54 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 09:57:03 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 09:57:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 09:57:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:529abdfd475cf1493c5eb90dcef1764f4c7549e9cf71cd5f1b52a411e0164a63`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63a13fe602b082e0fc068d361227ba0284d0955638b75c8922c51b4ac87be67c`  
		Last Modified: Fri, 10 Jun 2022 10:11:27 GMT  
		Size: 133.9 MB (133855507 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2693ec51563cc82239f3d97e40f26382ed2edeff6093f36611d8f3136706770`  
		Last Modified: Fri, 10 Jun 2022 10:10:04 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5905965c813f42e2666a13e4a547d304ee5cb0728f886d42f4ca93b552a0f1a`  
		Last Modified: Fri, 10 Jun 2022 10:10:04 GMT  
...
```console
$ docker pull nextcloud@sha256:2efb41ff6bcc0beea2f73b6196bc8295ebb86651c8daee6abf350082d91c3ba2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.7 MB (317707807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d933073bd715ca29d5e76f296ba1e0f6f225adbffe6659b3e3000f4a5f6301e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=24.0.1
# Fri, 10 Jun 2022 10:35:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 10:35:56 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 10:35:58 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 10:36:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 10:36:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:34ea585bd0cbd1220cfe70fe4b9c002b84476c4a97866bae5bd499f86caec077`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ff3a9357f89428e2b39b9ea2aab1be174608a826cfc1d3e3447d2a7ec62c852`  
		Last Modified: Fri, 10 Jun 2022 11:00:23 GMT  
		Size: 134.1 MB (134096146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6ecbd1a6d7ce05f115a268dcdf39ac0e7f249ea297cf72bc5b2b206d585bf26`  
		Last Modified: Fri, 10 Jun 2022 10:58:14 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5057e954b621fec9518cc2db1367204d544db3bbb1257b920a23542d6f8cf6d`  
		Last Modified: Fri, 10 Jun 2022 10:58:14 GMT  
