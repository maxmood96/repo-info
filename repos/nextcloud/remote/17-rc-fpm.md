...
```console
$ docker pull nextcloud@sha256:b0b8a2bed30e5544a8ac15fe4a5e8e7e460d49128dd734b570712697085cd609
```
...
```console
$ docker pull nextcloud@sha256:bc4ab46502e9f7e312b6b05fa784bd9bd67428b52b391aae65fc121b896832d1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.0 MB (212979232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a769f03fbc581565340346aba9bd717a334fa8c31a431d3122b5d1bc4c0dd9f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 23 Apr 2020 11:40:34 GMT
ENV NEXTCLOUD_VERSION=17.0.6RC1
# Thu, 23 Apr 2020 11:41:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Apr 2020 11:41:36 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Thu, 23 Apr 2020 11:41:38 GMT
COPY multi:965c5cb843579fcde0cf3c9edb975639cbd2d55de5f645b1061d46855979394d in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:591969bc0da90efb1b101054ebb84712319bcf28a12fc2126807a25f2cd4d8a8`  
		...
		Size: 535.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a99484864f3dba20e543faf5dd1e1d5db6c7d60b1d09ff04dfa6e9aa5ebf548`  
		Last Modified: Thu, 23 Apr 2020 11:58:29 GMT  
		Size: 73.1 MB (73102281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53c87158ffe1e08d58619ea9a11c0ced9006d423a3409110affff2bd92865248`  
		Last Modified: Thu, 23 Apr 2020 11:58:07 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a71f854a660ccb96b5ebed7679b93cac2df37da23759dfba5671f48730c080f`  
		Last Modified: Thu, 23 Apr 2020 11:58:07 GMT  
