...
```console
$ docker pull nextcloud@sha256:c83e6a3bb172b5fe43ab43f553b66d61e3ddba129f378b362fb885ca1813b66c
```
...
```console
$ docker pull nextcloud@sha256:f5b25853f51dacb6a713a9ead70d72799fd760eba9bf5939f60461f7ceacacb5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.2 MB (313178436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04077cad93f7b2158823d03477859982b1cfe0359fbf7847230eb9681f6896e0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 May 2022 11:02:06 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 12 May 2022 11:02:07 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 12 May 2022 11:09:08 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 11:09:10 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 12 May 2022 11:09:10 GMT
VOLUME [/var/www/html]
# Thu, 12 May 2022 11:09:12 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 12 May 2022 11:20:27 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 11:22:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 11:22:11 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 11:22:13 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 11:22:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 11:22:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:aae573efae18113b11d8c07ab71f781b03d24d4b3ad104896ba465b2c2524765`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:998fd074abe28eadf908c6a052bc717625893b4d2683adbe7e09b5d64c3de046`  
		Last Modified: Thu, 12 May 2022 11:31:00 GMT  
		Size: 1.7 MB (1656639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfc25fef245b61e307cea97a34d53283c3aaf8baf99a124cc6db799fc90e4ab`  
		Last Modified: Thu, 12 May 2022 11:31:08 GMT  
		Size: 15.2 MB (15181094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29c1381b0d83576d096ea11df54ab52ddbe42f53b5046dc52df444627075a2de`  
		Last Modified: Thu, 12 May 2022 11:30:57 GMT  
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9b5b53cbca5b4ebea4b4c8d6e1587db245874fbaf28bf19483facd1231740f5`  
		Last Modified: Thu, 12 May 2022 11:30:57 GMT  
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6767fe94e774776771ac8952f7209fc1e179b64e16b3ac2414bcedddf7870c0`  
		Last Modified: Thu, 12 May 2022 11:36:46 GMT  
		Size: 154.2 MB (154181590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d2712a8f5f1cede080ebb7e9ae525a20224c6839022f7cd58e20bfbe27ba8a5`  
		Last Modified: Thu, 12 May 2022 11:35:00 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee3c3290c8a936cb440213f0a263e68c3af332b70f67a02e2e45d9da677de540`  
		Last Modified: Thu, 12 May 2022 11:35:00 GMT  
...
```console
$ docker pull nextcloud@sha256:5c5793d40c3f3e3a5748539787fa0a641a75e22a91c5055fe81639f9a5d04a09
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.6 MB (338616784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a4fdd85027ca6842052d5fba18f7a00a9b8e43c891c7eae9a34c8fc66789a32`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 11 May 2022 17:43:49 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Wed, 11 May 2022 17:44:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 11 May 2022 17:44:42 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Wed, 11 May 2022 17:44:43 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 11 May 2022 17:44:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 11 May 2022 17:44:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:61e4bfb12fbae057bc64b6cc770e3ae75375217dd0d1b5b220931091d8537a95`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58cd3fdf31349eff66f188f3034a843f1c2790ff259d94b75c27213a8557b349`  
		Last Modified: Wed, 11 May 2022 17:51:27 GMT  
		Size: 153.9 MB (153944940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0c3147eb5f848a2f7b9413b47ac4a96ad3ac646a1c0c1a25fe463b3d0c61fa6`  
		Last Modified: Wed, 11 May 2022 17:51:07 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f9a0c3ab92d31c01711a4d2cd53d8e1bb509f662a88025fe36add3ebbe37488`  
		Last Modified: Wed, 11 May 2022 17:51:07 GMT  
		Size: 2.2 KB (2198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2b784aec3bfbe47ce6db4ef74e45edc5e82a1fb8aaedd4ab4b1d8be3705cbf60
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.9 MB (337889512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddbf6e15505220bf90f30e7c4b88eb5537382d58264ae5d1f9cd6dbb93531d35`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 28 Apr 2022 21:50:37 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 28 Apr 2022 21:52:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Apr 2022 21:52:43 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 28 Apr 2022 21:52:46 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 28 Apr 2022 21:52:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 28 Apr 2022 21:52:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0d143d09ebc75fa529cacb4ba56ccc26459943d1648acad04ab98a4651fecd24`  
		...
		Size: 587.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce5c56f68738901d03e764600de0cbe41e668343d9308f5042634a7ab091445d`  
		Last Modified: Thu, 28 Apr 2022 22:10:24 GMT  
		Size: 154.2 MB (154185292 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9cb5947ce8d87db3279149a36e431ccb99b6bfd919d7a309e9ea5b022d8dabb`  
		Last Modified: Thu, 28 Apr 2022 22:08:31 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:071d6ae3704119f1644d24430248f310be5fac9b64b9bc334f356a18562e0173`  
		Last Modified: Thu, 28 Apr 2022 22:08:31 GMT  
