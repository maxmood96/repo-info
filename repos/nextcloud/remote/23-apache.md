...
```console
$ docker pull nextcloud@sha256:b5c4e4b1582ce8f2256b06fc7222d6bce628464171eb6df71e78a19ed3cd0b14
```
...
```console
$ docker pull nextcloud@sha256:f9987869e31751ceb33dce707bd99a381ef80fd3038e5ddb0629701a4460b599
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.1 MB (313093279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b19b274d32a47ffc7d650cefc6426e9805f2ba750b9f37e358911ae68e60da27`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 12 Aug 2022 22:53:09 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Fri, 12 Aug 2022 23:04:21 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 12 Aug 2022 23:04:21 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 12 Aug 2022 23:04:22 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 12 Aug 2022 23:04:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Aug 2022 23:04:22 GMT
...
-	Layers:
	...
	-	`sha256:a497d76d29e0bc328996e6a7a72087a9507e0d3ec3c4aa08c320203145dfdc6f`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e9c37670d8cdfef7d9dd9f6470c7b7d77890a5b36bce983689c1148664a1a02`  
		Last Modified: Fri, 12 Aug 2022 23:10:10 GMT  
		Size: 154.2 MB (154175314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c74b7b8f2230c0a87d0fe13399dd5a6008ba7f8f6fda10b4f6889b3a6734d7d2`  
		Last Modified: Fri, 12 Aug 2022 23:09:40 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b824da45a8f3a52082c075be618879818359a6a374363f62fa9b1bc339550cf7`  
		Last Modified: Fri, 12 Aug 2022 23:09:40 GMT  
...
```console
$ docker pull nextcloud@sha256:8623e63f2226606290d6fed1956d14525045f8a95bcae9cfd2cd095586e1cac0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.5 MB (327521158 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2543306dfbc68e5f3d50dc4a2fa581bae65bec87d1db8b77073d3cf8435698e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 12 Aug 2022 22:52:15 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Fri, 12 Aug 2022 22:52:57 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 12 Aug 2022 22:52:59 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 12 Aug 2022 22:53:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 12 Aug 2022 22:53:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Aug 2022 22:53:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5da0db520dc4e6ba9798e1e9d053a3ab8af6a5d0a8db694cd146e6b91e42e5de`  
		...
		Size: 572.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:746d47ab242c62648cefa532c88889ea90cbc24adf68d5c21be3236163bd637a`  
		Last Modified: Fri, 12 Aug 2022 22:59:56 GMT  
		Size: 153.9 MB (153937258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0ea4b8ef12838b03765fe24b769f5ce1e7ab6bd85b7b84f4b9c66fc3fbe697e`  
		Last Modified: Fri, 12 Aug 2022 22:59:34 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bcfe7eddedd4e75cb585c8add8fb79c2429ffd674b79aa5b15917862fce3d01`  
		Last Modified: Fri, 12 Aug 2022 22:59:34 GMT  
...
```console
$ docker pull nextcloud@sha256:e426214c675ffec632443546bcae3f4290a8e32d354ab2074e9b69d423e0c314
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.7 MB (338738363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0abac7c04e702a86b3e5de7e5098726f86a1540308a56f8ee1aaffef69a97fc0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 12 Aug 2022 22:38:57 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Fri, 12 Aug 2022 22:39:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 12 Aug 2022 22:39:51 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 12 Aug 2022 22:39:53 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 12 Aug 2022 22:39:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Aug 2022 22:39:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8c1b6becfe981a008203c595cc0295ccde6df359c2e526dd9b78e2eae0586f55`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2cf9238e1ec3f96aab01d241dc330f87c0d1fb5b285561476a28deb1a6e4bf8`  
		Last Modified: Fri, 12 Aug 2022 22:47:15 GMT  
		Size: 153.9 MB (153937245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f5e15ae602064d93682180e0058132dcf9827841198f24415806ddf655f2cbe`  
		Last Modified: Fri, 12 Aug 2022 22:46:55 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b9a2c3c65f86a4408d118f91d07f5ae27b6034f62222b08754be70286a3808f`  
		Last Modified: Fri, 12 Aug 2022 22:46:55 GMT  
		Size: 2.2 KB (2198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2c8ff4323e32b46ca706c56c778f4e49d8ed4400778f6fa8afd45d5d3cfbd6ff
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.3 MB (312286723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33fc931c448c84789966ec89fc7acec64b68fc30d4fbc9636c9b8dd7ba51338d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 12 Aug 2022 22:42:17 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Fri, 12 Aug 2022 22:43:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 12 Aug 2022 22:44:18 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 12 Aug 2022 22:44:21 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 12 Aug 2022 22:44:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Aug 2022 22:44:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9a1e751546b546817de309dc5b70cb0b53041a8e0e2443d89d3a0e105aa235e3`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4568324178fbe1e8466925604b3a87e462777a813fd8f3ca0957ca48ebc3ca17`  
		Last Modified: Fri, 12 Aug 2022 22:56:39 GMT  
		Size: 154.2 MB (154175750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1935ed8864f19b7e55b517fa20d5b6dc273c6b4508fa6f2445c1c38bc2ea39a`  
		Last Modified: Fri, 12 Aug 2022 22:56:21 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1289f580aeda278129d8c88dc4419ad6b5f0cb95a0f99901923bd2cd4d772cc`  
		Last Modified: Fri, 12 Aug 2022 22:56:21 GMT  
