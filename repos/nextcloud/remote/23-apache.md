...
```console
$ docker pull nextcloud@sha256:0e999bda56facbbe1f867fdf2a1fd38b9a0195b27dfcab79d0365fadff21e742
```
...
```console
$ docker pull nextcloud@sha256:6a3a983f362357ff3cfa08015348ebc18cf6c08102f36ee8ea50081078bbbf65
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.9 MB (312869700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be7ea0805fc9c9f1fbe2d277e0398b7562872e22cfa89a35ff063127d4fcd308`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:b1069f48797b5f924eef9d4501c0f27f39a1c9c974129e945024e94bf524632e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:563abd704e6ffb908637d613a77c289e1a4ffbf6290940dacfebace01bdbb0f4`  
		Last Modified: Fri, 01 Jul 2022 01:17:10 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a015ca7b4d7bf92461c498bd409cce15eac69e6fd97ba032f7f5c3f094a81a9`  
		Last Modified: Fri, 01 Jul 2022 01:17:10 GMT  
...
```console
$ docker pull nextcloud@sha256:fa35261e8916ef3ce493294c6840c2a967b2505cf9a1ad7da0f135e6571234e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.8 MB (303839174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70c9a319ce9b0e81341d789ab94089930f25897fb7ba0d5c08e094117f480a82`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 01:23:44 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 01:23:46 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 01:23:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 01:23:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:37b437afdc6ffc63e8e17bfd67db849a3ee72ee89ee47818a764cecad93acf4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ce8cff090778f3e1d14c1a5e9aa4fc11dba48ac06c57c64d9def963a7fec073`  
		Last Modified: Fri, 01 Jul 2022 01:35:10 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b143f885370e86f2356152e0060514fd1a6c4bd511774e4abb95ee97ba61a266`  
		Last Modified: Fri, 01 Jul 2022 01:35:09 GMT  
...
```console
$ docker pull nextcloud@sha256:abc4acb45612579d4ca140a687d533cd7905cc0b030ee153932ae139542066e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.5 MB (311520761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0993e2af0933f6402c76f02c0cb13b7323bdd86b3dd19a99eb2ba8e83106314d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 03:46:30 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Fri, 01 Jul 2022 03:46:39 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 01 Jul 2022 03:46:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 01 Jul 2022 03:46:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:842624456c0b47a17c63fe756e5d9041801ab0718ecbd797d4646963f591bb3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9014107fa57a0f3e82cfe1333425855d51daf357332438b681f9406a5a96f14a`  
		Last Modified: Fri, 01 Jul 2022 03:50:17 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c229ae4500c726c47f861b640158f43cdd81d87756a5ae53e841f96fa6c1dbf`  
		Last Modified: Fri, 01 Jul 2022 03:50:17 GMT  
		Size: 2.2 KB (2206 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
