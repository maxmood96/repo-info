...
```console
$ docker pull nextcloud@sha256:73735266528a4ce0393a7bf25f63a5146946c319376fa86134514884f67f89e1
```
...
```console
$ docker pull nextcloud@sha256:8907c70e73f971fb97de652c56a36a4f6931cc27c99dc31899f5e85a1596c092
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.9 MB (312869649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfa6e7f2f66a0b05d24ee88a745734cf71d1b3db80a546f1d4f1f1a2dede0946`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 24 Jun 2022 16:00:00 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Fri, 24 Jun 2022 16:01:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 24 Jun 2022 16:01:54 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Fri, 24 Jun 2022 16:01:59 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 24 Jun 2022 16:02:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Jun 2022 16:02:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c70c632b1f9b838ac992ace460bc0c05a4487a9220d4ae82fb3667b8e032eab1`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1069f48797b5f924eef9d4501c0f27f39a1c9c974129e945024e94bf524632e`  
		Last Modified: Fri, 24 Jun 2022 16:15:24 GMT  
		Size: 153.9 MB (153856742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87923449ebdd8f66837f8acd6a8ee75ba0553a26122cc08fe621443e2740a185`  
		Last Modified: Fri, 24 Jun 2022 16:14:19 GMT  
		Size: 3.0 KB (3013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d7f6d1a8767f34cacfa5bc4560bab639425a36cc389dc80a5938b5c10667e7d`  
		Last Modified: Fri, 24 Jun 2022 16:14:19 GMT  
...
```console
$ docker pull nextcloud@sha256:891e668dc71b1b3ca6420ce03def36afb58d035e3bb652697aa3425afafca36d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.8 MB (303839117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3acd63f3df13c41b5162cbfaa5c5aed529e634c1a4d5564ebe9e6b009b084081`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 25 Jun 2022 04:42:26 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Sat, 25 Jun 2022 04:44:02 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 04:44:05 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Sat, 25 Jun 2022 04:44:07 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Sat, 25 Jun 2022 04:44:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 25 Jun 2022 04:44:08 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:37ec9ae1ed79d16dab244ce374a395906682e941eae943874c19792f5cf1a9f2`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37b437afdc6ffc63e8e17bfd67db849a3ee72ee89ee47818a764cecad93acf4e`  
		Last Modified: Sat, 25 Jun 2022 04:54:58 GMT  
		Size: 153.9 MB (153856741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1e4ec94bb6dffa3d3f8b57966b777cf2f2f56a5cbad94fa9d9ea0bb44ab2c6f`  
		Last Modified: Sat, 25 Jun 2022 04:53:13 GMT  
		Size: 3.0 KB (3011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9b4c7786ef2ec660efe927603970237b6a9d9c155aa1e3703821892a8f5f95f`  
		Last Modified: Sat, 25 Jun 2022 04:53:14 GMT  
...
```console
$ docker pull nextcloud@sha256:a0c33cb7895b4651fa3d70605165b58338f7b7c6e975891d76274e7092e1d9f3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327097996 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99b4a5a405fe9b6244e2a3d6f303cc676e3ffbbaf45b3e27eb80c018e8f1c0d9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 30 Jun 2022 23:45:29 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Thu, 30 Jun 2022 23:46:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:46:12 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:46:13 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:46:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:46:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cc592139aa1c0f40e10891c4b58cdc499a9da726cd33b0bde533cbb00b3ae40f`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33ee86497fb673d9c058e3305672dcd5a39e6516a9efe9e8aa883f31fa46829f`  
		Last Modified: Thu, 30 Jun 2022 23:53:21 GMT  
		Size: 153.6 MB (153621506 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cd161f59fffdbc65e2c2fa3dbf07234364d4d4b41f5c3efee15cebc2def7fca`  
		Last Modified: Thu, 30 Jun 2022 23:53:00 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4fdf4197df9ca34bca6333e3b5c9d8a277ce47cc8f07510f135f20fa26e23ac`  
		Last Modified: Thu, 30 Jun 2022 23:53:00 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:877ca7dd73987150ad99911a78053252fe9e8c65aa7999add58b8ed81d08aeec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.3 MB (338309025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa7c7612d9e83319e866e30c8fb3b43bfb279ba2c4eafabaa99ca24d6445fbaa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 23 Jun 2022 18:06:28 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Thu, 23 Jun 2022 18:07:17 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:42:50 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:42:51 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:42:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:42:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1f94a5d9d564d540412c5ef538b090ee2e294f4e3a6e9b231e57aa0245e31582`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9139113d5310f87d5fd1ccc0b122e3bac7ac90a94125f28adbb499b63bfaa775`  
		Last Modified: Thu, 23 Jun 2022 18:15:59 GMT  
		Size: 153.6 MB (153621271 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52576ffd9c6cd90febd90b0fdad6324f4f6c642f3a88c9ff851c50d6a6ec74e4`  
		Last Modified: Thu, 30 Jun 2022 23:48:31 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2e25e5ab675520d6723676d9309f9dbe96a2210b06b3b22ac17a93637036949`  
		Last Modified: Thu, 30 Jun 2022 23:48:32 GMT  
...
```console
$ docker pull nextcloud@sha256:3778af9244a62d74945f830b695c644f64adf24106cf8d9303f7b932f47f8d32
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.5 MB (311520708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:820b29956579ca135cec505c9789b83b13a0eaedef30c62d5aa3819c5d358711`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 25 Jun 2022 06:57:37 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Sat, 25 Jun 2022 07:00:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Jun 2022 07:00:28 GMT
COPY multi:8757660dcec88b1946ba094c23fe14a1eb69054b1f7ddde5e16899421f67e84a in / 
# Sat, 25 Jun 2022 07:00:37 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Sat, 25 Jun 2022 07:00:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 25 Jun 2022 07:00:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e83e060c46660a423b16c832c5f83524a0a96cccb05ce4a75bddbfb37810c2f9`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:842624456c0b47a17c63fe756e5d9041801ab0718ecbd797d4646963f591bb3d`  
		Last Modified: Sat, 25 Jun 2022 07:17:16 GMT  
		Size: 153.6 MB (153621963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40543dbce15f05a94f9c902d1351270852e5fcec0a880e8185e13678db49519e`  
		Last Modified: Sat, 25 Jun 2022 07:15:38 GMT  
		Size: 3.0 KB (3013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc8c7ea2c54301b6b2edeb526942615d72c96342402fe5efbfc4d44b14b4720a`  
		Last Modified: Sat, 25 Jun 2022 07:15:38 GMT  
...
```console
$ docker pull nextcloud@sha256:de72f3134428fd753d493f3289946dbb1772e86afd8fc3de619fc9d43a6ff5cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.5 MB (337474043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28c401a9eebc915000d6985fbf06aabe2cc78c09a84200eb69be1aa37a7ff1f4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 24 Jun 2022 16:28:53 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Fri, 24 Jun 2022 16:31:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:34:20 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:34:22 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:34:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:34:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:53c945eb11423924cc912f96c9c4a1f2c120bda713adbb191891cffae1100715`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4ed4650e175eead7c5d234676ffca7817b1edc99c6ba716ab5f11dfcb9f71bf`  
		Last Modified: Fri, 24 Jun 2022 16:46:42 GMT  
		Size: 153.9 MB (153860960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8ad364327bc637ac932745731aab9bf2e1adaaf7f6c607b0ca04c3f5e7ab96e`  
		Last Modified: Thu, 30 Jun 2022 23:44:15 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71ecd2a0e5b087f06738e064ef58323bd58251f5d1e961574d91148e04834a11`  
		Last Modified: Thu, 30 Jun 2022 23:44:15 GMT  
		Size: 2.2 KB (2203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:9cad160b4500e875d5a585e3e6e3812684a0cb00fb0d38780156cf7ee1af0c66
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.1 MB (312055295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc1b63deeee06f7c6f54ec42a57c6f87f76747582d52517d099e3b6e66d8afcd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Jun 2022 21:12:24 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 23 Jun 2022 21:18:30 GMT
ENV NEXTCLOUD_VERSION=23.0.6
# Thu, 23 Jun 2022 21:19:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 30 Jun 2022 23:45:35 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Thu, 30 Jun 2022 23:45:35 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 30 Jun 2022 23:45:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 30 Jun 2022 23:45:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e1461643ccd272f9f07ced7ff4b94832b10c69152fca56aa8b10a5fca0654142`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46fac14404ef7eef279ad2fb6fbc92b6e740f0349b75b3e7efa59185b714a7ca`  
		Last Modified: Thu, 23 Jun 2022 21:27:25 GMT  
		Size: 153.9 MB (153857217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:290a5224edfab34f0594ab7c3b91b2cda6afa6b98dfbfa85ebfa9687f06049fc`  
		Last Modified: Thu, 30 Jun 2022 23:50:42 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:913e44c9f705aaaf4fb79d2b0436c1e686ac34a6ae44dd5b3400fd0e79b5434c`  
		Last Modified: Thu, 30 Jun 2022 23:50:42 GMT  
