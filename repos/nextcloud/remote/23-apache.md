...
```console
$ docker pull nextcloud@sha256:de1fa94c461e94a769feb7b11f72239957c499e76579a8fd2ee48554876ec5ea
```
...
```console
$ docker pull nextcloud@sha256:65573cf470ae397dac1a563ad774399fdab3989ce6f6097da47527fa8ad1b269
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.1 MB (337102408 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3951d8f2852e3c9f455bc8d8da441175360ba6b2d400876370fde9305219b4eb`
...
# Fri, 20 May 2022 21:29:55 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 20 May 2022 21:30:42 GMT
...
-	Layers:
	...
	-	`sha256:27a9a5e73403915e71b61a14c8e39af96afcbfcc26322607af272b0847c09708`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb8a4c6bc52efa6b82c9bda13924154095b2c3d0f1f9aa2309e93c90d51437fe`  
		Last Modified: Fri, 20 May 2022 21:38:20 GMT  
		Size: 153.8 MB (153779376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd332446ac98b2e41720dd42cf608352b8efb40aabff274899118a209a3039d3`  
		Last Modified: Fri, 20 May 2022 21:37:59 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1fcceb723294e8acd2a2230cb5c39b85a9b58283493a3533478448c57d8a933`  
		Last Modified: Fri, 20 May 2022 21:38:00 GMT  
...
```console
$ docker pull nextcloud@sha256:dcad7214e24793a61c82191024e76ba0e2b1a26eb58cbd00a90ca521c922ae9f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.7 MB (303658437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3442c90f557bc889ca874128333da04387ad2ace1321e9d7321a8b41c02b650`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:aeb39f260797aa19da0a021bff82a7e5188c26d9ac5928a9938cae826bec52bf`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1309efa722e50dec3626e2a66a2281302a1c91be95017240a11df7728353a23`  
		Last Modified: Fri, 20 May 2022 21:48:35 GMT  
		Size: 153.8 MB (153778850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fc564595fe333573ece0847de66bca2faab3115f7633ad8a9c7c14333b876f2`  
		Last Modified: Fri, 20 May 2022 21:46:51 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8064fcb96a6969953fe7622d07490d8bbb6fa6eaa35599e06eccb98e92a5cd97`  
		Last Modified: Fri, 20 May 2022 21:46:52 GMT  
...
```console
$ docker pull nextcloud@sha256:e1416cce81adb7910bdc8c440320c2843e333b0d39d2471d9dfac55f8c0bea36
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.3 MB (311332857 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fd2b8f8f7fb0d13b95f75cc32acb66969ce34f57412ab625f2d569df1164416`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 May 2022 21:14:32 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 20 May 2022 21:17:07 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 May 2022 21:17:19 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 20 May 2022 21:17:28 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 20 May 2022 21:17:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 May 2022 21:17:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c0d9c3a17cb1c022ca7bf09ff2faa94c98a9d2ab6b7e936f305fd4ab064bcc45`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd75dd6aa180b5e489705d2c3204263cd84d6e8deaf921087428fd2bcd961675`  
		Last Modified: Fri, 20 May 2022 21:33:46 GMT  
		Size: 153.5 MB (153537651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be189d1bf46573b6907d2446e84eea3f2ca65ee4c6ab24876ed0be6c0d058f21`  
		Last Modified: Fri, 20 May 2022 21:32:09 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8f09feb7fc99d956d6922dbd1338dd1da0be18bdc8afa765539622e589d2426`  
		Last Modified: Fri, 20 May 2022 21:32:09 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2db334ae794891df36da253fed583751a201aa61553a4cf928b5e9dd345358d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.3 MB (337293096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36e99d4310a35bc88b3d823a9b9f35f1dc9a8472fc15a1f0d556b86c04149ac0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 May 2022 21:58:33 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 20 May 2022 22:00:46 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 May 2022 22:00:51 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 20 May 2022 22:00:54 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 20 May 2022 22:00:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 May 2022 22:01:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1f2f5da07ab640e7a9dea90288123685347cd8990ad6583c3d44dd84d29440eb`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c521dd92d017d16b65b2c5f61f025ef4cb98cdcc29e8c0a0f631470c7aece5ac`  
		Last Modified: Fri, 20 May 2022 22:26:37 GMT  
		Size: 153.8 MB (153783377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13b4972d12d81c1057a3f7ad79e631b870af01c03bfc4cb8583189f9d561f839`  
		Last Modified: Fri, 20 May 2022 22:24:36 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:582fa6c0961261b2e6d09fccb69d51246bf02d632c22e5021124cec2b326cf82`  
		Last Modified: Fri, 20 May 2022 22:24:36 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
