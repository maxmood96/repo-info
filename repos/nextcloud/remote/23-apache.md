...
```console
$ docker pull nextcloud@sha256:530ce2bb6166707845e467fd214f52938cd23eca50b00e8f493a636ff552affd
```
...
```console
$ docker pull nextcloud@sha256:61bb1a309c5ea454c882f3a8ed822f1a4a7f025ad89cf45581e61bc06ecfb36e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.3 MB (313305560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f137439d93d81d0140cf88ec6571ce5ea5861e9332b680a2e6665df85b6ae4f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 20 Sep 2022 19:52:01 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 20 Sep 2022 19:52:02 GMT
ENV NEXTCLOUD_VERSION=23.0.9
# Tue, 20 Sep 2022 19:52:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 20 Sep 2022 19:53:00 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Tue, 20 Sep 2022 19:53:01 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 20 Sep 2022 19:53:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 20 Sep 2022 19:53:01 GMT
...
-	Layers:
	...
	-	`sha256:17b1d05f686c01509626085166f4a776a8dc127633e88c4c436add33cd826247`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17dbf6ef9ea82170127f227d276cb6867a89d8aa5e7d0c684b99da69f479cbf`  
		Last Modified: Tue, 20 Sep 2022 20:02:15 GMT  
		Size: 154.3 MB (154310382 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c527887f4dd84ec711f509b123131820f00e26e85b0bf594e4efe30cccd34ce`  
		Last Modified: Tue, 20 Sep 2022 20:01:31 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7810b165b77f165dce4526e830ee07fffda64b51f808c34aa77f9921d07cd818`  
		Last Modified: Tue, 20 Sep 2022 20:01:31 GMT  
...
```console
$ docker pull nextcloud@sha256:3e0b8278d31a124f5dd0f38f255f01b7bbd0d18b45a092b75f13128a1c892ed6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.1 MB (339136849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:282d9b8fa490068f39386b1fabb45ef3a9d413fdb728b805f8fc4c8c07859404`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 01 Oct 2022 01:19:25 GMT
ENV NEXTCLOUD_VERSION=23.0.9
# Sat, 01 Oct 2022 01:20:16 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 01 Oct 2022 01:20:18 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Sat, 01 Oct 2022 01:20:19 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Sat, 01 Oct 2022 01:20:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 01 Oct 2022 01:20:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5321382b492d72c6023f1b8cba76d2652086902928733313c97805bbde7b12b0`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e13486a635fe371d3bd117f9bf3926d0e4ca4351a1447111e838e8350dcf7c4c`  
		Last Modified: Sat, 01 Oct 2022 01:32:14 GMT  
		Size: 154.1 MB (154072526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b1bd2d923c31e40e431c0e0a82ed65bfdd1eb32e79b3b160d52ef30b6e32f2`  
		Last Modified: Sat, 01 Oct 2022 01:31:54 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e58788bbb2a46261e9a452e39f45a2d4872757383da717d98458c7e43bb8650d`  
		Last Modified: Sat, 01 Oct 2022 01:31:54 GMT  
		Size: 2.2 KB (2216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:7ef5fadd381eb5b742aca4c96e2309f9b4631c1193d50d17ba14ea9a42ed2b1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.9 MB (337908715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a5e2000a7610548d17c9cf442de88e0890a1ffa5744fa9e8fbfee0b4ea145b5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 20 Sep 2022 20:21:30 GMT
ENV NEXTCLOUD_VERSION=23.0.9
# Tue, 20 Sep 2022 20:22:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 20 Sep 2022 20:22:42 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Tue, 20 Sep 2022 20:22:44 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 20 Sep 2022 20:22:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 20 Sep 2022 20:22:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8bc3fce67c4e63d96853a76c0bc95f4c918a821bfe2552ba8dd22cef18f02164`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0307e3fde980d99b6a2dd1811c9cb63ed417b9963589c3b2e298d770d571a26a`  
		Last Modified: Tue, 20 Sep 2022 20:34:30 GMT  
		Size: 154.3 MB (154312558 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c29c1fe962ed0ae0a090ee4d61551286a198e124b52eec25a7f8cea175c1b3e3`  
		Last Modified: Tue, 20 Sep 2022 20:33:51 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f5461529741129fe642ccf9522d8db2cbca2e630c5d818e711a8a994e599567`  
		Last Modified: Tue, 20 Sep 2022 20:33:51 GMT  
