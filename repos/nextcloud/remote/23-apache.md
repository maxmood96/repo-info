...
```console
$ docker pull nextcloud@sha256:ecb9075ac18eba45e31b511b90f39b59b78326558f04e9df044e549fe03f03c6
```
...
```console
$ docker pull nextcloud@sha256:28771ddca214bca4b551debeddfac5c64c603d0ec94f42feae0b0e42c3e32bda
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.8 MB (337827340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77fc47ef1a7891179bab522acdd5176acde51931188b1809d864f0963a2cfdfa`
...
-	Layers:
	...
	-	`sha256:3294a96a801421f5b9f9759496963f71bd1d85949aff79930f160e63e099f877`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56822a5a0f02842372f6d8e70fbaf5d3067f16e242a496e79da6a4e86e9a8734`  
		Last Modified: Thu, 06 Oct 2022 01:50:09 GMT  
		Size: 154.3 MB (154312253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a470e86f500001a9f2f871c8d408ed3ba7efc1cfa9225c26e7550a90e1ab0f5e`  
		Last Modified: Thu, 06 Oct 2022 01:49:48 GMT  
		Size: 3.2 KB (3246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7da96050c67544bd304af28d696d027cf0ac736e9e2de59180327257e985e603`  
		Last Modified: Thu, 06 Oct 2022 01:49:48 GMT  
...
```console
$ docker pull nextcloud@sha256:ae765ae383312947cb565cf6cd48a3edbc23ce59d9dc80494d3cf480989c5d0a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.3 MB (304322501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b02986df2827e9daeec7a4e58b4fa57687dea0f2b4b3fdc88144b38f9b33ad7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Oct 2022 21:15:19 GMT
ENV NEXTCLOUD_VERSION=23.0.9
# Thu, 06 Oct 2022 21:16:25 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 21:16:26 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
...
-	Layers:
	...
	-	`sha256:8f2a508e19b50ba4e709a8df51fc2d7f702089b3b91ca3e9669e2f1dad2ac796`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ebe624704c13311b737a9521ab9803470b71f2fe637d5842bc09297da91b632`  
		Last Modified: Thu, 06 Oct 2022 21:26:33 GMT  
		Size: 154.3 MB (154310322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e30ee0c37631888777b619462285a89b263d21cdb7f0c31bc1603712d68165e`  
		Last Modified: Thu, 06 Oct 2022 21:25:54 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3277f6e4d87a52e98438cda7bc630eee5e60d272ecda0e98efc97cb6ac5a93`  
		Last Modified: Thu, 06 Oct 2022 21:25:54 GMT  
...
```console
$ docker pull nextcloud@sha256:46b926ef3c84f5cde380ca55916b79e5a4d3bb5185f78e705941fe55d862504a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.0 MB (312001087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f623abb15948007b0ba6499f14fe0e10a99c2ea357a5296a1805e63143abd75`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 06 Oct 2022 09:51:04 GMT
ENV NEXTCLOUD_VERSION=23.0.9
# Thu, 06 Oct 2022 09:53:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 09:54:00 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Thu, 06 Oct 2022 09:54:09 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 06 Oct 2022 09:54:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Oct 2022 09:54:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0618c34c288cc417a0aa94f95e2e61c63fdab405f6273c24db45dac9a85f5822`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ab7f057e28a6ab7a6b6304a6d06d20860b63504c0238a0db283bb3a22f4624b`  
		Last Modified: Thu, 06 Oct 2022 10:19:22 GMT  
		Size: 154.1 MB (154073453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e90697a7512a0de2e16dc993847c291c09cc626103f57858e51986bc2d16c5cb`  
		Last Modified: Thu, 06 Oct 2022 10:17:40 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80c5f03258eac3da349522c6c7fd42424c18ce3660e66c120fd53125ff816a72`  
		Last Modified: Thu, 06 Oct 2022 10:17:40 GMT  
