...
```console
$ docker pull nextcloud@sha256:22b84fe9ade7aa1d0307dbeec7afc00ce2d8b45301f98a8f37f3a9c09146b448
```
...
```console
$ docker pull nextcloud@sha256:eefbcbee1a855cec46aab6ff9fd074a578af265b1e4ff0712f0c31412f9eb6ea
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.4 MB (334359750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c74e76b47c6b1806783dab6dab63c3a29d1b2ba77132c872445ae80fc062613`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:42c8db518e34090d52b63392d0aca387e07e76cd7ef3fe64011fbac7e7e56eca`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d95c46c9233a1e3e8f0b1e2e3077b9091896a42a4ba86834e93041fa8ef6b78e`  
		Last Modified: Fri, 06 Jan 2023 04:14:56 GMT  
		Size: 155.9 MB (155897696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0cb2ed2160efaf131de41edbcbd3b114f7186e3fefd40ba9982d3d48aba7aa0`  
		Last Modified: Fri, 06 Jan 2023 04:14:39 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bef1493781c438ac4aaf5f68fa39f229e9e229d07cd6ed52f295853376b626f7`  
		Last Modified: Fri, 06 Jan 2023 04:14:39 GMT  
...
```console
$ docker pull nextcloud@sha256:befc258c250988b1b369b1e2de9e98a72cb14a9565212311eba1fd8b593082e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.1 MB (345124742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53ccf945dc99a04205b1743dd57d427e614d22a3c000120dc87d87cb2dec1d0c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=23.0.12
# Fri, 06 Jan 2023 05:42:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 06 Jan 2023 05:42:11 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 06 Jan 2023 05:42:12 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Fri, 06 Jan 2023 05:42:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 06 Jan 2023 05:42:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fd98efe0ffa312c1d44afcd3a0a339bdc86de7820d8fbfd25ec50b0965241754`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:654200d320d344fd709fcc3019c46d5de3f0426ba9f2b070038a4131c98ae5ee`  
		Last Modified: Fri, 06 Jan 2023 06:06:44 GMT  
		Size: 155.7 MB (155658175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b98cfb8b1dba039e2135b1eb059ab331c5f30c636fa93226636c9275253477a`  
		Last Modified: Fri, 06 Jan 2023 06:06:24 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d906de63b51e649a218d735535ab9b606934d20993bc68e8466ccbd2f7c9dee1`  
		Last Modified: Fri, 06 Jan 2023 06:06:24 GMT  
		Size: 2.2 KB (2216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:aa35fc2d8481e5e47da444dfa58a1987c824ec287e3d96e8be7fe0f0aeb6c5c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **344.2 MB (344224984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e538173ef9213c065e4f726895ab3df640fd127effe49a2b4dd1d5e6412e305`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:9b981120f06242df8cf177259d81b76fa6a3519f5c9a1f9a626295e52ab18ab1`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360d929a2b3e9ce6f4562d5d79d1a3d9e5bc8fe7a273edc7ddf65fabfd8c2974`  
		Last Modified: Fri, 06 Jan 2023 04:36:16 GMT  
		Size: 155.9 MB (155898939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dba8307611ff22bd32b7e87b984c252205c5c6d406eb53441d026735c81b83cd`  
		Last Modified: Fri, 06 Jan 2023 04:35:39 GMT  
		Size: 3.2 KB (3240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:906893e93361c5eee019a6958fdbef964bc3a3a9557142d51674e6df39e3c2f0`  
		Last Modified: Fri, 06 Jan 2023 04:35:39 GMT  
		Size: 2.2 KB (2217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
