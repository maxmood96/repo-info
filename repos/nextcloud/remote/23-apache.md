...
```console
$ docker pull nextcloud@sha256:b3ea5b6a67e6eb5b632d5b0d09a551cf8aaaffa2f0ba183dc40c637de0f8652b
```
...
```console
$ docker pull nextcloud@sha256:823e7e61a99fb274e7a138bd273764ba318315bd250932fa83ded040e54ac7ed
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.3 MB (338294053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f974665ca82ec404766ad4505a84dedacf418fed11cf4b37ab649827b3d1fc9`
...
# Thu, 27 Jan 2022 22:07:41 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Thu, 27 Jan 2022 22:09:04 GMT
...
-	Layers:
	...
	-	`sha256:a9e44dbb7aabcfbbc81fab6cbdeece243d6baaddbf29783aa969b0a214941525`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5620d1f27a0498f56dd4008d5522959b742d752e90aea5260019bdfe3c01180f`  
		Last Modified: Thu, 27 Jan 2022 22:16:06 GMT  
		Size: 17.4 MB (17388192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c55cd19f92c0caa09349622f4eee447e990a666fa61ffd57838fcc3f9158c6d1`  
		Last Modified: Thu, 27 Jan 2022 22:15:58 GMT  
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c113d6bfc36d0ebc3026348420fe76bbf4f21f4dd2c53da29264325411a0bb52`  
		Last Modified: Thu, 27 Jan 2022 22:15:56 GMT  
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcee8f5239a1b1b33a8aa7818218986b769358593c284ab09a73e5639e17fd2c`  
		Last Modified: Thu, 27 Jan 2022 22:19:09 GMT  
		Size: 151.3 MB (151318154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b27c8af2ba47fa1d387c7fd415a9b5efdb34401d7aaf69fd5232b8e99c758d9`  
		Last Modified: Thu, 27 Jan 2022 22:18:50 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c1242a4faf55777505feb36e6432492cd58032a1824a8ac755bd5ff12c64be`  
		Last Modified: Thu, 27 Jan 2022 22:18:50 GMT  
...
```console
$ docker pull nextcloud@sha256:de4c6c27c45afba9df5115969daf5b4995b2285326e59afc145e27ccd71f520a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.3 MB (304331049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5df68ecf365da6758c0e46ce34add2a2273a1c8cd6514d92032c6cab57594ead`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 27 Jan 2022 11:16:07 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Thu, 27 Jan 2022 11:17:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 11:18:00 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 27 Jan 2022 11:18:02 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 27 Jan 2022 11:18:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 11:18:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:31c80c15ab71e25231b083ac59894816d61b20f11337ccfb1f9ba7208cb9e6b1`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46132ad652d79b177f9b499862f0820c5626ba8612b8574dbd10e10080287ad2`  
		Last Modified: Thu, 27 Jan 2022 11:34:24 GMT  
		Size: 151.3 MB (151316853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52c2abfbc60f7d51b68392562a2e317e8a4cb463ddadc51a7f05ea95746f6c25`  
		Last Modified: Thu, 27 Jan 2022 11:32:41 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9175968daaad385823efe1157426e446416ce35b7a0ba9011ed2247b2f5e3f6`  
		Last Modified: Thu, 27 Jan 2022 11:32:41 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f1782d07f084130c9a5be479c62629dc47fafd33a57305e27567e40f2212abe5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.4 MB (313407167 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d631c5315a7c7c06bd1f443feca02572ec9fe965a6ad97d1b2a2419a961d7bc9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 27 Jan 2022 17:43:17 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Thu, 27 Jan 2022 17:45:23 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 17:45:27 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 27 Jan 2022 17:45:29 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 27 Jan 2022 17:45:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 17:45:29 GMT
...
-	Layers:
	...
	-	`sha256:5d8d3f9a0d34060aaccc1000fa5d6e1f7b74ab34c005475c910f1f938226e55d`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32221c9fa69a27ead015fc717334e8bba5e218ced06a6b8c5bfcae52e39b5b82`  
		Last Modified: Thu, 27 Jan 2022 17:58:22 GMT  
		Size: 151.3 MB (151316743 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:531efce52adce73b473a9c0ec4d70769a3a755c8563aa0b73fb90c3cb2cbcf29`  
		Last Modified: Thu, 27 Jan 2022 17:56:42 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0b3e374db983039f31f950be716acc4497220accb15dc874cbc557c1865a446`  
		Last Modified: Thu, 27 Jan 2022 17:56:42 GMT  
