...
```console
$ docker pull nextcloud@sha256:4c0a6e0819f173c616e4b82af1a77cceea97063c7be5aa2814cac23f6e69323f
```
...
```console
$ docker pull nextcloud@sha256:a37f4efcbe01e26d6e50875f5311f4ce56f1de78a87dcf8a8af076f98379fa2e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.1 MB (314114637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0fd4073821fa6db3fa9640bc14ea19502ebf7a9ba84e89aa7489eb7a560c866`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 12:29:41 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Tue, 15 Nov 2022 12:30:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 12:30:35 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 12:30:36 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 12:30:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 12:30:36 GMT
...
-	Layers:
	...
	-	`sha256:e1fabd41a53ca50e49115bc290a14912641ddbeaa0f6538791a6d5a9b6f222c2`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:156f4fcc944df01277b386e269a077ccaa44479977f570642d5284e7d98b0fba`  
		Last Modified: Tue, 15 Nov 2022 12:47:37 GMT  
		Size: 155.2 MB (155158718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a0ddde486e8d6d2ac99358775a25b742566dc449fe54bec68432a8782893ecd`  
		Last Modified: Tue, 15 Nov 2022 12:47:08 GMT  
		Size: 3.3 KB (3252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2177db64766a93143f9fcd7575089949b0ecf4d37cd604c55551970031f341e9`  
		Last Modified: Tue, 15 Nov 2022 12:47:07 GMT  
		Size: 2.2 KB (2215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:95e7b84c07f658ca2e40808bc3ccb62c84bfcd8570a108f1dab268689961a79c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.4 MB (329431954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:501f5da698f330353c9167bbaa1e683bb3792efd8cb98cc0cf09fc578450549f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 17:34:05 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 17:34:06 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Tue, 15 Nov 2022 17:34:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:36c8bd5f523ab15cc887ebe73815f51f46a7f1a5f7442b639c3bb7cd1922f49a`  
		...
		Size: 568.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96c6fea0818604d9b8b1ad4f8868aad246387fc84096b4ddb43d17acf5972e19`  
		Last Modified: Tue, 15 Nov 2022 17:48:10 GMT  
		Size: 155.2 MB (155159797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f6f059111d8d2a8966d47189af9b5a38838dc159cfa47761eb2e1c24176a9f6`  
		Last Modified: Tue, 15 Nov 2022 17:47:54 GMT  
		Size: 3.3 KB (3255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b45fae2e262eab216fd5f187b68ff8f12a146b79c21da295cda71b2eb90d4a6`  
		Last Modified: Tue, 15 Nov 2022 17:47:53 GMT  
...
```console
$ docker pull nextcloud@sha256:8b6731aa0d4700ca9eeb2bda3608758cde69fda354b2f734363746c4a4d34472
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.3 MB (313304856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63930a17fd191d0a039fc3a290537ae42ff7dba547a36b3101137654cf1bd848`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 17:44:51 GMT
ENV NEXTCLOUD_VERSION=23.0.11
# Tue, 15 Nov 2022 17:46:20 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 17:46:29 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 17:46:30 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 17:46:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 17:46:30 GMT
...
-	Layers:
	...
	-	`sha256:eecbb8403089de74c7f88315af29301a407ee2301f22974220ca69f5f2f1a3ba`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9acec0cd8e20ae686a0acfefbda70e0f223c9bc707684d970684bdd5ed0a0db2`  
		Last Modified: Tue, 15 Nov 2022 17:57:57 GMT  
		Size: 155.2 MB (155159582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0291f0ad66ca94084b6ec35dddb1ff5f2b3dcafd24f8ae5293e8e6f2c2b72727`  
		Last Modified: Tue, 15 Nov 2022 17:57:40 GMT  
		Size: 3.3 KB (3255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bff51a6b8721281a1fbd3d0ea314875c457dd7f0012d80b21d903b71f14b342d`  
		Last Modified: Tue, 15 Nov 2022 17:57:40 GMT  
		Size: 2.2 KB (2213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
