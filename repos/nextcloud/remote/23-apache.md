...
```console
$ docker pull nextcloud@sha256:18647a6f511a6d59939dc977a60f900685c19efeef076946a0d93420534f5d94
```
...
```console
$ docker pull nextcloud@sha256:0c71c50d7a4ef3745dea24a70f613a414e9597c3fd1cc974b128507d69acbb17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.1 MB (313104971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d865f54a60205ae6283396c436c158f7d655d5514733a93b28ab0de32f518f2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 24 Aug 2022 00:09:22 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Wed, 24 Aug 2022 00:10:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 00:10:49 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 24 Aug 2022 00:10:50 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 24 Aug 2022 00:10:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Aug 2022 00:10:50 GMT
...
-	Layers:
	...
	-	`sha256:dfd641fc286686b517eb4a5862fa1e16b45bc2756d313e2e0621143c3517fdab`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45648b394eefc3b3666cebc32e33dbb4f5777dd376f4ae03edf81b0c38f67d84`  
		Last Modified: Wed, 24 Aug 2022 00:20:17 GMT  
		Size: 154.2 MB (154175504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f2768d03fbb238319abde753a39f160b3886aa14691923242bc68a07007b7b8`  
		Last Modified: Wed, 24 Aug 2022 00:19:39 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16629c2aacb847f6b9144ad25add44c977a61c98a0c34609e3e4159d9b76ed35`  
		Last Modified: Wed, 24 Aug 2022 00:19:39 GMT  
...
```console
$ docker pull nextcloud@sha256:43ab96b9ff9a5b83d39d865e6c9417956c7558b289fbcead0f255df0e2d80adb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.1 MB (304069325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad97db6af9643caa04f23b607a0b09d6ad12e1d814f37566616f0755d397c04b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 23 Aug 2022 11:36:20 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Tue, 23 Aug 2022 11:37:21 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 23 Aug 2022 11:37:22 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 23 Aug 2022 11:37:23 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 23 Aug 2022 11:37:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 23 Aug 2022 11:37:23 GMT
...
-	Layers:
	...
	-	`sha256:493d989299a8d14875337632279f2734b7f4860b37b89f2b191fd81a4a9bd494`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10ef1f015c6fed676e1fd22326cf00e146800867137d03197ca5c09e25ae5cdc`  
		Last Modified: Tue, 23 Aug 2022 11:46:46 GMT  
		Size: 154.2 MB (154175288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ceb94da879044527f6a3567cacff68adf62ebd0bbd640978286dbce195af8b5`  
		Last Modified: Tue, 23 Aug 2022 11:46:08 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f5cca59ec299bd7e499b3cdaa6813487438f688f6abaf20dd725d58c0f2f28a`  
		Last Modified: Tue, 23 Aug 2022 11:46:08 GMT  
		Size: 2.2 KB (2199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f342eff2066c33cf96fce5d69504fa997209407d48c70130f14431008b51c67c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **338.5 MB (338548170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b1b31c1eb57e4ec4cf074772c56ff5c19b22957a432d3442fdc795fc81136f8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 23 Aug 2022 18:36:34 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Tue, 23 Aug 2022 18:37:24 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 23 Aug 2022 18:37:26 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 23 Aug 2022 18:37:27 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Tue, 23 Aug 2022 18:37:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 23 Aug 2022 18:37:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bad88245b98136fd961c5ac6f6e8e927e0902a40f380704d22d87a052406ee38`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c26bb49045f450877f665f5a6d9a7bde617ed0e4e131b8864d1522679ee65e6`  
		Last Modified: Tue, 23 Aug 2022 18:43:13 GMT  
		Size: 153.9 MB (153937411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:881d4de5cdd95524eea2bf3436fc96a6fca4764959c645faf3942444e0ffb0f9`  
		Last Modified: Tue, 23 Aug 2022 18:42:50 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86947915116dfe6dc8ee945cd4c85b0f9daf0be7c9b6d011af2614fd0ee71330`  
		Last Modified: Tue, 23 Aug 2022 18:42:49 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:dc0121ba4e1282a53d0416627534d96c96f126fbeb9d17de658e59e71e32477e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.8 MB (311752280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13c6db8866d0aca59886ec6d0e85345167640fbe0adc08c4b72f0c6a6f6645be`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 24 Aug 2022 00:56:24 GMT
ENV NEXTCLOUD_VERSION=23.0.8
# Wed, 24 Aug 2022 00:59:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 24 Aug 2022 00:59:20 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 24 Aug 2022 00:59:29 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Wed, 24 Aug 2022 00:59:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Aug 2022 00:59:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f4493cf31e083c76442c7012b097bea72768a23e8afe9be18e691cb1ee70a281`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27cc77b70016505608623866a0e2846f43e06a70eb9cfcb8666975098a90fdaf`  
		Last Modified: Wed, 24 Aug 2022 01:16:33 GMT  
		Size: 153.9 MB (153938630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05755498f6481075fb918712ec176e705fdd7a24cdd576186dc9dbf88602a6e1`  
		Last Modified: Wed, 24 Aug 2022 01:14:54 GMT  
		Size: 3.1 KB (3061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dbe28fceffe84c8a50bdd28c267c61ce268217600cc748b96b404fcca74f266`  
		Last Modified: Wed, 24 Aug 2022 01:14:54 GMT  
