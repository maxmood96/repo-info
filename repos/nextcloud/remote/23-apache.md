...
```console
$ docker pull nextcloud@sha256:f12a6eed7bcdd9147c4244233388905d5059f92fa9e5d8cd1a3ca4fd878c49c1
```
...
```console
$ docker pull nextcloud@sha256:7555f8e43b2cd4cbc0ae29917bb266797aa119a29f952ec42df0a8be427689e9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.6 MB (312570782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a44fa120a5f8259339f3f2c7dd5662ee9b70e62f959a2925859ed1669a33d496`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 21 Apr 2022 20:14:25 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Thu, 21 Apr 2022 20:16:00 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 20:16:03 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 21 Apr 2022 20:16:05 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 21 Apr 2022 20:16:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Apr 2022 20:16:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a8b30c75c2407a3eb89e4f8b01352a84dac1d8d8d86ac32f58d639587bab81ac`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b0e552baaa829af85787dcaf4b280cecb350c94bec4b633f7ead0cf56e65ba9`  
		Last Modified: Thu, 21 Apr 2022 20:23:02 GMT  
		Size: 153.5 MB (153488628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0000b76db694d2e8f847f82c3a7be6ea756aae628f5c9aab3bd4ab8dd3011fd`  
		Last Modified: Thu, 21 Apr 2022 20:21:18 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0533bd2a59b4e9e84dcec706f6b65de509907402dc6da2c9453cb29d136f1dc`  
		Last Modified: Thu, 21 Apr 2022 20:21:18 GMT  
...
```console
$ docker pull nextcloud@sha256:317ad6d08cfb52b7bc212571c61d9a3216c5c119121aa7bb389c1f7e79aa9e50
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.8 MB (326801222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae08abe1c06ea79fcf994eeec7f2105b07174e9216ae331b0b6f45a1251b0e58`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 21 Apr 2022 12:28:51 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Thu, 21 Apr 2022 12:29:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 12:29:42 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 21 Apr 2022 12:29:43 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 21 Apr 2022 12:29:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Apr 2022 12:29:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e2e8d2db519f7cb56666abd2f5ee311150f466bc5fd15f82517414fe8a273dd1`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9c75f257dbeb77a55fe89c7de78561e83a5d051d6b179700887400f75ff96c8`  
		Last Modified: Thu, 21 Apr 2022 12:32:37 GMT  
		Size: 153.3 MB (153250947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf73fd9c16510dd413e97e48824055e187a5b0f59790a6a75098bdd102480112`  
		Last Modified: Thu, 21 Apr 2022 12:32:15 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a819a23dacf3042a96f49ffb05f89a503fdfe9369b029aba8b895a3e7a2a750f`  
		Last Modified: Thu, 21 Apr 2022 12:32:15 GMT  
		Size: 2.2 KB (2201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:96f4a5c9834d5c159b7e590c749a0afba679567f6c541b631a15b9974621c295
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.8 MB (311763531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79b60ec5503cda328ee74e182a98e54a81e61421c5a3a261503672ba5e9daee0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 21 Apr 2022 12:26:10 GMT
ENV NEXTCLOUD_VERSION=23.0.3
# Thu, 21 Apr 2022 12:26:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 12:27:00 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 21 Apr 2022 12:27:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Thu, 21 Apr 2022 12:27:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Apr 2022 12:27:01 GMT
...
-	Layers:
	...
	-	`sha256:f1fcb44c32612d20c2d867116376038d639694c9a6d99f3789b3d9e1b580e9e7`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a9a1e7c38b715bfd8ded7106a1e5c896c89d23243573e204f9b045db0fae1fb`  
		Last Modified: Thu, 21 Apr 2022 12:30:51 GMT  
		Size: 153.5 MB (153489006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c031f453d88f8ea434cf7b9086a30e7579ecda39c30d24b94a5e0819f2b2909`  
		Last Modified: Thu, 21 Apr 2022 12:30:34 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da5109292fa3c8f4378bf7cfb13c1bbc7e764ab5db213549212fe48a776f34d1`  
		Last Modified: Thu, 21 Apr 2022 12:30:34 GMT  
