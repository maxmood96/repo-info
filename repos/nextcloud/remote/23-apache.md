...
```console
$ docker pull nextcloud@sha256:d8a233d2080c2dc5a591c594021343fe557b385ebd8a40145991cddb99f133b1
```
...
```console
$ docker pull nextcloud@sha256:fa39f07f5d22818685700a057794d9c80cd54ee3bf81e649e4d29009a04ef777
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.8 MB (303761349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f403e2e5db92ab60fae855de2dd8b99432c484a90689bf42181cf4a69ebb7f9c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 10 Jun 2022 11:08:20 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 10 Jun 2022 11:09:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 11:09:58 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 11:10:00 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 11:10:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 11:10:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ea3670d804b1b4c98505f95c96eaaf7737744a4cf912a7b7b73f4f7aa1f8c06d`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:895c69df836603f9dc69ff9a412cc2c97568ca3be0ae36e25ea4723f80b09f44`  
		Last Modified: Fri, 10 Jun 2022 11:26:14 GMT  
		Size: 153.8 MB (153778988 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8c6f122d81fc32dcc45a3ffc7f0496c26406570e2ea8690449431a2162c5a32`  
		Last Modified: Fri, 10 Jun 2022 11:24:30 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de1c912a1e9bb89f40813d97a8ae87f8275e806513b79b1fea37ad0a35faa2ae`  
		Last Modified: Fri, 10 Jun 2022 11:24:30 GMT  
		Size: 2.2 KB (2204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:057220d0634607c49c4c10c0839e00b31edd2f8d64c6a5f3146ab0c6cc3a5411
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.4 MB (311436237 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec933641ba25982611aa83168375e2ebe35696582a25b43fd8b61766c95f3e0a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 10 Jun 2022 09:46:55 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 10 Jun 2022 09:49:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 09:49:52 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 09:50:01 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 09:50:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 09:50:17 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:529abdfd475cf1493c5eb90dcef1764f4c7549e9cf71cd5f1b52a411e0164a63`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9711cbebe746e2615126fbd262b8cc52602b0a13fd7a56f58ed1a254d66e2c8`  
		Last Modified: Fri, 10 Jun 2022 10:07:19 GMT  
		Size: 153.5 MB (153537847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02517ff03c1bbaab89f44958b23c915c00cef0b5919ca842de4c252830854960`  
		Last Modified: Fri, 10 Jun 2022 10:05:41 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f4cd7bc56ef2ac43ab56400dda37bc0cf69d12aa9c438a54a72649fa282702`  
		Last Modified: Fri, 10 Jun 2022 10:05:41 GMT  
...
```console
$ docker pull nextcloud@sha256:fe7689d556e5b6fc044e87f988a7766ff845971a56c09a151bd13bee7322ad53
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.4 MB (337394232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95e76b4b4c8fdeb281ade213c46c239083360c145e9c5151697eb7706c112409`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 10 Jun 2022 10:24:13 GMT
ENV NEXTCLOUD_VERSION=23.0.5
# Fri, 10 Jun 2022 10:27:02 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 10:27:06 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 10 Jun 2022 10:27:09 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Fri, 10 Jun 2022 10:27:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 10:27:13 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:34ea585bd0cbd1220cfe70fe4b9c002b84476c4a97866bae5bd499f86caec077`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c7df7acacbfc908c972a8eec66baba2e6c386fbe5a9932cc190a13bd57a3288`  
		Last Modified: Fri, 10 Jun 2022 10:52:27 GMT  
		Size: 153.8 MB (153782571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2bfe315f74a7cd90d07447f138b4c85bcb1bfc26b55f431276954eb719868dd`  
		Last Modified: Fri, 10 Jun 2022 10:50:35 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1953d0b99479074583bfb2ee66da5214dde80b2851c755ec0046b2e240a5e34d`  
		Last Modified: Fri, 10 Jun 2022 10:50:35 GMT  
		Size: 2.2 KB (2204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
