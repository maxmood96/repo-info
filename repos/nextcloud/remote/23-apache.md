...
```console
$ docker pull nextcloud@sha256:072468e48f6c74d14354232c58d04c6d7f68b5fafeb8b70db85c86e76d63949a
```
...
```console
$ docker pull nextcloud@sha256:2e1a34c2d7516d5759f32d5b85e5e67ece8ad734e16e4d0390b2e7f25609a24d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **304.4 MB (304420310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35680baf63ef6df759b540cb289ddfcfce3be08e469f1317427a9dcb4441d749`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 04 Dec 2021 09:40:24 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Sat, 04 Dec 2021 09:42:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Dec 2021 09:42:07 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 04 Dec 2021 09:42:10 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Sat, 04 Dec 2021 09:42:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 04 Dec 2021 09:42:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:981cc168c516a0e6853a927ded782df73d979d13009e4a2abfb5e65f59cb185b`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4b697239ffa3f24503e26586ad718378b704b5c1dc53d58459d53fb262d4eb1`  
		Last Modified: Sat, 04 Dec 2021 09:58:22 GMT  
		Size: 151.3 MB (151316864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:541eab5c902a3e0020d19ae8ebc6f5a52f63f0512b07d58cd1e2b936909d1967`  
		Last Modified: Sat, 04 Dec 2021 09:56:41 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccf00d389fb27ffca14edc1917a729eae6b9e86cce97595a7cf3f2709db0d325`  
		Last Modified: Sat, 04 Dec 2021 09:56:41 GMT  
...
```console
$ docker pull nextcloud@sha256:4075a46aedd9cf19a858be0726f04db0e9aae5a5d18ed95bccff36d3bd222c22
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **313.5 MB (313491705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:956c64fea2f0877fd9f7b4c665298ae522e0198cb84301a1b5aee4520fec150d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 04 Dec 2021 03:20:20 GMT
ENV NEXTCLOUD_VERSION=23.0.0
# Sat, 04 Dec 2021 03:22:25 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 04 Dec 2021 03:22:29 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 04 Dec 2021 03:22:30 GMT
COPY multi:cc97af471c8139fd0039f75fa22fa380aab666199ee1a1d59d400410f9e63775 in /usr/src/nextcloud/config/ 
# Sat, 04 Dec 2021 03:22:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 04 Dec 2021 03:22:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8ea0d398ba15d422675b8ef3ca8910f35a1584ab6bd4cab0b999975f20d70f05`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:766322655b8e5e6db0bcc4d2eaa31673e1e4f6ee466d7285f5b3ac49cc277e12`  
		Last Modified: Sat, 04 Dec 2021 06:00:14 GMT  
		Size: 151.3 MB (151316770 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7cfa4101f7a2b51c4ba86524b7d27737a9d9caf6f052fe95fbd8b467d81010e`  
		Last Modified: Sat, 04 Dec 2021 04:43:58 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9bbb3e2b8d80318633d3e43db251bc2feb70c82987700d29ba5ff78feaed523`  
		Last Modified: Sat, 04 Dec 2021 04:43:57 GMT  
		Size: 2.2 KB (2202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
