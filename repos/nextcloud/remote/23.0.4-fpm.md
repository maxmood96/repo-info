...
```console
$ docker pull nextcloud@sha256:6e06e181e12b2c93b1896f0f19f15a1875aaf4d25fdd7f871352e597b7d31004
```
...
```console
$ docker pull nextcloud@sha256:b4151bb398b416baf334fca0efd3e1fb140ae5c2cffd6f06558b051592684bce
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.6 MB (300626636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86f01614b5801fd64b4c9c93a3db20a850cd5047461ceee39dfe8f1a160b8e94`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 01:42:18 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 01:43:54 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 May 2022 01:43:58 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 01:43:59 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 01:44:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 01:44:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a915111ec2df7f1ac73741e398aa9c5637b928e1366bd70d39d4f1201c1e727f`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e178400c4a87feec1bb8881bcf29c96795140d49c8dfa92b41d6f9fc08654bd7`  
		Last Modified: Fri, 13 May 2022 02:00:17 GMT  
		Size: 154.2 MB (154158062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4859e31f1424bcea0882388409517d916124e226aee22fab64713f753586f388`  
		Last Modified: Fri, 13 May 2022 01:58:32 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:132802d749d17ffdc7c140861eec9fcef7bb9231da81f19b07960bdd974c3e7e`  
		Last Modified: Fri, 13 May 2022 01:58:32 GMT  
		Size: 2.1 KB (2138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:cb08d91c269b74fe2716ddcaa5d7774f6b3bcd760430023cba2a2e9ea8220c31
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.0 MB (307997505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91021123fca4fa12df44a208b0f5f92bf4398721711735fcb125ce585cc45ac8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 04:56:43 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 04:59:30 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 May 2022 04:59:41 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 04:59:49 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 04:59:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 05:00:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e85b72d6070d1bffa42e5048a2a9a9721a580736e43e01ca8bdf2d7365c76306`  
		...
		Size: 570.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ac1a171930b32111077fc78247c6355c4f821916b149ca4afdd799b993146a4`  
		Last Modified: Fri, 13 May 2022 05:14:56 GMT  
		Size: 153.9 MB (153921531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90d4935873fadf122cee7126216591581bca4aecb6ee4388168a7083ad4a7fe8`  
		Last Modified: Fri, 13 May 2022 05:13:22 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1daf5270ac35715da1e6eb3fddc4c8c1c1772476611ad75ce69cca6ce02d0de2`  
		Last Modified: Fri, 13 May 2022 05:13:22 GMT  
