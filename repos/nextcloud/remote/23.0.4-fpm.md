...
```console
$ docker pull nextcloud@sha256:ba7e04295b08db18388abbbf129e275526f543c55c0ea69570282d8a2ff43361
```
...
### `nextcloud:23.0.4-fpm` - linux; amd64
...
### `nextcloud:23.0.4-fpm` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:aebb0902a529a135e04e896fc1d0646e74b97aef7d434ceeab37eaf38859e46d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.3 MB (309335520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8948c2683d76b5a294df04d045a4bdff3fc91294e35a44597a2539e07ff48df`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 12 May 2022 21:23:05 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 21:24:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 21:24:48 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 21:24:51 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 21:24:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 21:24:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fb61cc2521bd338f6cf53103b406de7ccd722f6eb5741277d1cf7f9a565daa75`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15670a9f86cccd31bbcbd2da19c6ece19db4a8d76dc489f0cdb98989a07d6247`  
		Last Modified: Thu, 12 May 2022 21:39:55 GMT  
		Size: 154.2 MB (154158057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:683fd59b23fe17c32b705a516b3e258d900ae8481ecb50c9b3722d2ee01d5dc7`  
		Last Modified: Thu, 12 May 2022 21:38:09 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a195e471fc00afce01ddbd0ac549b8d090abd680110325a9626fa409b921118d`  
		Last Modified: Thu, 12 May 2022 21:38:09 GMT  
		Size: 2.1 KB (2138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:b550ee5e33a825de49fd5d90165d48fe37ca77ce44b3dfd5bdd771d9357cf497
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.5 MB (300536519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54c123cc5c07fd5de8d6e1e392d786646fd6b465b850da457599afbbbc0748e3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 11:40:59 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 11:42:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 May 2022 11:42:38 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 11:42:40 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 11:42:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 11:42:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8eb45dd3fcac663837c2941a9aa55035152dcef945ff27c53b199b254e91b03b`  
		...
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61d1decb983760da64eb9398fe1d2a2737096316b013f10a788398cef0539a2b`  
		Last Modified: Fri, 13 May 2022 12:04:23 GMT  
		Size: 154.2 MB (154158047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c59429fd6c40e9c21d3dab6207d8741a29537f7f18214764ad58914fc4ffd658`  
		Last Modified: Fri, 13 May 2022 12:02:38 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c9034c18e47fb0f69ce07a1eb326bd2a468276e8fa84484d301f20082e46044`  
		Last Modified: Fri, 13 May 2022 12:02:38 GMT  
		Size: 2.1 KB (2139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:45513bae2666da5635fffe643d17bd7f2a11ae72ddd50d08b02cc831875a6425
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **323.4 MB (323374958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ac31649ba4348353214e0c6c6a04937976783de5b4733cc1630a55a090e8194`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 14 May 2022 01:08:36 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Sat, 14 May 2022 01:09:17 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 14 May 2022 01:09:19 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Sat, 14 May 2022 01:09:21 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 14 May 2022 01:09:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 14 May 2022 01:09:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:689471817107cf078c913da99c0aeb6ad2442e850dd99046aab624032a8a7064`  
		...
		Size: 569.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a347b16233076dd8ac332969733c0958debd4da060618b24de64010d149a6f36`  
		Last Modified: Sat, 14 May 2022 01:13:10 GMT  
		Size: 153.9 MB (153921546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:987a71a106b5c59c36b736b82faefad621e02c7c136df5ab8f9778a5e95367e1`  
		Last Modified: Sat, 14 May 2022 01:12:48 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89c5ebdda57728cb9c96afbe971da7c79593599b1ccee05cd58e7da4cb38a08b`  
		Last Modified: Sat, 14 May 2022 01:12:49 GMT  
		Size: 2.1 KB (2137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; 386

```console
$ docker pull nextcloud@sha256:677f2a92b5dbbbb545d1ae44090a7802de554638a5784e7355eab3fb8645b0eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **334.3 MB (334307846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67d7b21474c86e9bc1d10cfedc939d9b2074c49fe088556211455f1134619edc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 May 2022 22:25:52 GMT
VOLUME [/var/www/html]
# Thu, 12 May 2022 22:31:43 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Thu, 12 May 2022 22:32:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 22:32:34 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Thu, 12 May 2022 22:32:36 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Thu, 12 May 2022 22:32:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 12 May 2022 22:32:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:da6c9637f1a04d8e65b921da2d9af25398421574e6507f4d1e8151ee32a0a136`  
		...
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b94af5a00aeb28606052e6a70f54cacb49b8d583b0a9d73a5517b461997d2b2`  
		Last Modified: Thu, 12 May 2022 22:41:54 GMT  
		Size: 153.9 MB (153921311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:338960ccb6f6e882a21adbaaefae2a1f5d96e35530fdaddb4461dd317e15cb72`  
		Last Modified: Thu, 12 May 2022 22:41:35 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:872a1ab6e4294c0a852296d3694080fc8ae2a396c086e9675d9cb8a5fa10af68`  
		Last Modified: Thu, 12 May 2022 22:41:35 GMT  
		Size: 2.1 KB (2135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; mips64le

```console
$ docker pull nextcloud@sha256:b35cce8716f1e75a738f8acd0af8a208fe77101ef41e3c6e9b30a90c9b8643c6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.9 MB (307909610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99c231a91f5ecfdc2e8ae9e2ba0d342952ba2204bc63311a00336448db15aa6e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 12:18:47 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 12:21:30 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 May 2022 12:21:40 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 12:21:49 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 12:21:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 12:22:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fefce7f0efb6b9e2b7bcf75f1b59de6d111584b29912eb35070a77a8ec1b6f1d`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4c8f2a5dd418383e0ac18690787d058acc514a13b37d480c011aba2359b6fde`  
		Last Modified: Fri, 13 May 2022 12:36:55 GMT  
		Size: 153.9 MB (153921706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf4bcfa625492e806cd7e140f0201f875d445af228c26c5a5d4abadbd26c4b55`  
		Last Modified: Fri, 13 May 2022 12:35:17 GMT  
		Size: 3.0 KB (2964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d7ddfc24f8da4676f17a1535518545b20bfda72b2b348a4d4f2436fbda1fa50`  
		Last Modified: Fri, 13 May 2022 12:35:17 GMT  
		Size: 2.1 KB (2139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:5f44be42cae64f8e6a1c2ec0dea1e13840b8a82e657265b230f788b2f4bbec2f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.1 MB (333123146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dce4d8aa925553eae0196c58e3473cdde30579fbecf702bc89acd0fc156cc4b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 13 May 2022 07:44:47 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Fri, 13 May 2022 07:48:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 May 2022 07:48:23 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Fri, 13 May 2022 07:48:26 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Fri, 13 May 2022 07:48:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 May 2022 07:48:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9993fe43373e83204d34ed50163d7c5f6619f201c41422d53bb24f54fdf4ba99`  
		...
		Size: 599.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c3fbd4f3ff1113336a692f4b8438da80076b461de1e9f366d536e268272aff9`  
		Last Modified: Fri, 13 May 2022 08:30:51 GMT  
		Size: 154.2 MB (154161929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2add0dfa7ef8a5ed029b50a1871bc357b04950aa9a1b0ed59ad137c6f0ddb060`  
		Last Modified: Fri, 13 May 2022 08:27:16 GMT  
		Size: 3.0 KB (2963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:496f1113aa04019f7842a3621e3f6908f862a1cd90b6a7eabaaba847154bf5aa`  
		Last Modified: Fri, 13 May 2022 08:27:16 GMT  
		Size: 2.1 KB (2139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.4-fpm` - linux; s390x

```console
$ docker pull nextcloud@sha256:9c1ef76032119cb36cba1c11b90aec558ec50ec7dcebf63fea57567dbcef9f7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.4 MB (308392029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87eed297d3fa8eb88bd1bd28b7143463e5e7a1355caa18c2f96aac4813fe9262`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 May 2022 23:27:20 GMT
VOLUME [/var/www/html]
# Sat, 14 May 2022 02:54:54 GMT
ENV NEXTCLOUD_VERSION=23.0.4
# Sat, 14 May 2022 02:56:45 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 14 May 2022 02:57:11 GMT
COPY multi:497b8d243f90fa6abd88194ba134de5703abecf47c13a92d2f2fb8210d2cfa77 in / 
# Sat, 14 May 2022 02:57:12 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Sat, 14 May 2022 02:57:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 14 May 2022 02:57:14 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:96dfbbdd369bccb3b64348f9b567274bf08486da8c0887fe20306dfe149811d4`  
		...
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54e00d8c724d666c9fc3d4263ff2f099a80dd8fdb8b1df0acb0b309e4c195675`  
		Last Modified: Sat, 14 May 2022 03:03:23 GMT  
		Size: 154.2 MB (154157809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c0e21e1d035a4a2025af1d3d28f7c9b802262c38630854ae09c46ef156ef85f`  
		Last Modified: Sat, 14 May 2022 03:03:02 GMT  
		Size: 3.0 KB (2962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:644d3119985797fc3eafb47c11711f676f0486d8f04323f78a5826c933c235bd`  
		Last Modified: Sat, 14 May 2022 03:03:06 GMT  
		Size: 2.1 KB (2141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
