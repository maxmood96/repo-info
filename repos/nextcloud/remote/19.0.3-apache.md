...
### `nextcloud:19.0.3-apache` - linux; amd64
...
### `nextcloud:19.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0.3-apache` - linux; mips64le
...
### `nextcloud:19.0.3-apache` - linux; ppc64le
