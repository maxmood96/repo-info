...
### `nextcloud:28.0.8-apache` - linux; arm variant v5
...
### `nextcloud:28.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:28.0.8-apache` - linux; 386
...
### `nextcloud:28.0.8-apache` - linux; mips64le
...
### `nextcloud:28.0.8-apache` - linux; s390x
