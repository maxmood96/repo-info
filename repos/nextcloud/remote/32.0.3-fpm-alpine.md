...
```console
$ docker pull nextcloud@sha256:b323c555f458a5aa22fa9da6b854988bf801e219f0c3ab86a9f8f2e203b31ac9
```
...
### `nextcloud:32.0.3-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.3-fpm-alpine` - unknown; unknown
...
### `nextcloud:32.0.3-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:32.0.3-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:32.0.3-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.3-fpm-alpine` - linux; 386
...
### `nextcloud:32.0.3-fpm-alpine` - linux; ppc64le
...
### `nextcloud:32.0.3-fpm-alpine` - linux; s390x
