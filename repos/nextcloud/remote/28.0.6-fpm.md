...
```console
$ docker pull nextcloud@sha256:3f7d0e0ef8f6f8e616b3111a00d33e6c797458247e0eb829b313fbe820679a3d
```
...
```console
$ docker pull nextcloud@sha256:7970c91ce46dba50764a306da60ffc8e7d365dcb64c83793bc88b7fc3af3fd83
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **422.1 MB (422068779 bytes)**  
...
-	Layers:
	...
	-	`sha256:08eb355faad59e51bc61734448761908bf2d1a178cb453f868a8598f8f4d5264`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f88d82fd10d0ccca0208e80d78638c90eef9c21b21eab4d52a6cd397d4afc370`  
		Last Modified: Tue, 18 Jun 2024 23:30:58 GMT  
		Size: 3.7 KB (3723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44b4b9d7fb01a6bb3277ec397c26fcbfcc4a34463290396dd6b73a99487e13af`  
		Last Modified: Tue, 18 Jun 2024 23:30:58 GMT  
...
```console
$ docker pull nextcloud@sha256:8927d1b9b7053dcc2b3ebd6e8697c3fd69e1f70686c852f1a0e766567333f558
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **426.9 MB (426892024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e8cfdc21a64bbe7f9ba132b862fcef3e0e7d88c8dd636647dbec1c7266a3935`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.6.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 18 Jun 2024 23:22:17 GMT
COPY multi:c8e39871baf1efab774933f35bf66c1fea215c9e9350ee9a43890d8b4411246a in / 
# Tue, 18 Jun 2024 23:22:18 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Tue, 18 Jun 2024 23:22:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 18 Jun 2024 23:22:18 GMT
...
-	Layers:
	...
	-	`sha256:2498f535e3b69e8dad7c8d8d7e0281eda38610b8480c71fcc92a08bd4feba2b2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d97959d9da3cd7a7d16861377364d2d21c448d5c9272d73b211463413d01886b`  
		Last Modified: Tue, 18 Jun 2024 23:30:23 GMT  
		Size: 3.7 KB (3723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b30c409656433f340d796f4f6ab42cc58bda375dfe055d971079e2e2400200d9`  
		Last Modified: Tue, 18 Jun 2024 23:30:23 GMT  
