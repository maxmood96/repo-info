...
```console
$ docker pull nextcloud@sha256:3939bca2707b23118d8ba921e518a2d8703debc95cc72aed54397fe017f62c82
```
...
### `nextcloud:27.1.6-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:27.1.6-fpm-alpine` - linux; ppc64le
...
### `nextcloud:27.1.6-fpm-alpine` - linux; s390x
