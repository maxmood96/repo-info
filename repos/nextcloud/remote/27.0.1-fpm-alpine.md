...
```console
$ docker pull nextcloud@sha256:b21f1ecdecb65cf7d852d9a20cc8a566579a551bb04441769fa5a4908457d3f6
```
...
### `nextcloud:27.0.1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:27.0.1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:27.0.1-fpm-alpine` - linux; 386
...
### `nextcloud:27.0.1-fpm-alpine` - linux; s390x
