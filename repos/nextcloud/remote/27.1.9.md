...
```console
$ docker pull nextcloud@sha256:04cb9d4214024c8929b6b92159bd021b13f1af8d04d9931545f71a98e17965fe
```
...
### `nextcloud:27.1.9` - linux; arm variant v5
...
### `nextcloud:27.1.9` - linux; arm variant v7
...
### `nextcloud:27.1.9` - linux; mips64le
...
### `nextcloud:27.1.9` - linux; ppc64le
