...
```console
$ docker pull nextcloud@sha256:6dc61b14182d52d9d7e9c0167abf16b9dc7c040f99c4b2ff18fc2a33a98f0409
```
...
### `nextcloud:21.0.0-rc-fpm` - linux; arm variant v5
...
### `nextcloud:21.0.0-rc-fpm` - linux; arm variant v7
...
### `nextcloud:21.0.0-rc-fpm` - linux; 386
...
### `nextcloud:21.0.0-rc-fpm` - linux; mips64le
...
### `nextcloud:21.0.0-rc-fpm` - linux; s390x
