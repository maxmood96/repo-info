...
```console
$ docker pull nextcloud@sha256:cf3d1414c875b2a015c2ae806ae9881eea48c266e2bdd77b175e211d6f76856f
```
...
### `nextcloud:18.0.8-fpm` - linux; amd64
...
### `nextcloud:18.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:18.0.8-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.8-fpm` - linux; 386
...
### `nextcloud:18.0.8-fpm` - linux; mips64le
...
### `nextcloud:18.0.8-fpm` - linux; ppc64le
...
### `nextcloud:18.0.8-fpm` - linux; s390x
