...
```console
$ docker pull nextcloud@sha256:f5e0f014d858515b07721bde40d220de63512fe86a9df84534b03a3382e2dda0
```
...
```console
$ docker pull nextcloud@sha256:73209f3ea00a3b18578c438505e3888a0202097a677d7c0ed53cb73bf92ae418
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **416.4 MB (416364401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b5fe00d2683909fee458e65771f104916190f6eb1e07642b98bdf1bf27ebe38`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Apr 2024 12:39:16 GMT
VOLUME [/var/www/html]
# Mon, 29 Apr 2024 20:43:26 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Mon, 29 Apr 2024 20:44:24 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 29 Apr 2024 20:44:29 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Mon, 29 Apr 2024 20:44:30 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Mon, 29 Apr 2024 20:44:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 29 Apr 2024 20:44:30 GMT
...
-	Layers:
	...
	-	`sha256:0845ccaeacbe9fc15df28dbe9423e58aba46c9f405181e7747f0c38fed44359f`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fc3a3bc5af2a0931d95f170ffb3f867151a379e2fa3f395f6a341b2e97e6830`  
		Last Modified: Mon, 29 Apr 2024 20:49:11 GMT  
		Size: 207.3 MB (207303219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:999599d44f1add2e59a158ca71e00f56f1d3d6233702d60977503cca73820557`  
		Last Modified: Mon, 29 Apr 2024 20:48:52 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb55a361166a393e4eb683673cbf8f6077fbc079464e3e1b144828920b181e3a`  
		Last Modified: Mon, 29 Apr 2024 20:48:52 GMT  
...
```console
$ docker pull nextcloud@sha256:3f19a8e26640169877a637acd9b09c029546e8f2f080603f118c0283885ae627
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **423.4 MB (423428863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da642dcc27e9cce9ee6a16cc90fabe0aedbdc7c78ff2cf37071b7b28ee8ce5c8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Apr 2024 19:23:03 GMT
VOLUME [/var/www/html]
# Fri, 26 Apr 2024 21:20:42 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Fri, 26 Apr 2024 21:22:01 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 26 Apr 2024 21:22:04 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 26 Apr 2024 21:22:04 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Fri, 26 Apr 2024 21:22:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 26 Apr 2024 21:22:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b7335bf39739499db095b1c75084845cb27ef85e3202a31144a342f7bf0f58ab`  
		...
		Size: 764.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adc56bee1ff43baffffd8b2fd1159d3662ba84bb899202238df977c0eabc8938`  
		Last Modified: Fri, 26 Apr 2024 21:29:18 GMT  
		Size: 207.3 MB (207301986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f755d559d56f83f5fe84a08c5efe6c3f82ecd1e4373f12829337e0aba42154`  
		Last Modified: Fri, 26 Apr 2024 21:28:39 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:580fa1eeda13215241bdc82467150d865c208a7520d62478b2114478ede58af7`  
		Last Modified: Fri, 26 Apr 2024 21:28:39 GMT  
		Size: 2.3 KB (2342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:978991255cb9b7ff2f24fd063b4ad420fb7bb7428625bccbcebb6ec3cfb2dfb1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **396.2 MB (396152069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2aac0ef962bb589082420b4d50d0feca2d670d5b30a1d330686483d879b2483`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 26 Apr 2024 21:07:56 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Fri, 26 Apr 2024 21:11:21 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 26 Apr 2024 21:11:33 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 26 Apr 2024 21:11:43 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Fri, 26 Apr 2024 21:11:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 26 Apr 2024 21:12:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0048e7e78f70d7e4b5f76f722981d328ff65df0d0ec6996ca286a9d4adf486e1`  
		...
		Size: 717.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:533ebbcf72aaaf997d6daa082b4f1b2de2600f0c89ff2c5ef9e4265f3cc7e7e9`  
		Last Modified: Fri, 26 Apr 2024 21:22:30 GMT  
		Size: 207.1 MB (207073644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:854e4fd386cbf7e1cd28712f8483f4c32c68818053a9aa2705481b491cab7f3c`  
		Last Modified: Fri, 26 Apr 2024 21:20:29 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d4d23cf055185137cf6c1d31e559f178197c677898799911c869ece9f994273`  
		Last Modified: Fri, 26 Apr 2024 21:20:29 GMT  
...
```console
$ docker pull nextcloud@sha256:4d2a7b5a45d32321aeed1766e798c03e976d76eb8ea4ab1c6c3a82e9bf6c5331
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **394.5 MB (394470337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfeea17970d68943e0ba4d7f36560a7a6afdb5a66a152897ca06d77f2e564d6c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Apr 2024 12:06:42 GMT
VOLUME [/var/www/html]
# Fri, 26 Apr 2024 22:02:43 GMT
ENV NEXTCLOUD_VERSION=28.0.5
# Fri, 26 Apr 2024 22:03:23 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.5.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 26 Apr 2024 22:03:34 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 26 Apr 2024 22:03:34 GMT
COPY multi:78125c707b59ef0f6f1ecce97806e1bec0bbbd71be245d580e78e8ceb5133056 in /usr/src/nextcloud/config/ 
# Fri, 26 Apr 2024 22:03:34 GMT
...
-	Layers:
	...
	-	`sha256:71daa6ebdbe66df286e5bc4a8b451f247d029efca7c36313aab02db61f22000c`  
		...
		Size: 759.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7b17ede584a3ae50297c9d6fb2ea6d430d150bc9c402a2aef8a46b57c187fc0`  
		Last Modified: Fri, 26 Apr 2024 22:08:55 GMT  
		Size: 207.3 MB (207300514 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53542677f6b35543e149fad8f05808281925584a722bb944745c8f5778d393f1`  
		Last Modified: Fri, 26 Apr 2024 22:08:32 GMT  
		Size: 3.6 KB (3612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa11b5cca8c438c2e4eedf4e1617158434b1f0e6efe7b941fdf508020082dd8f`  
		Last Modified: Fri, 26 Apr 2024 22:08:32 GMT  
		Size: 2.3 KB (2340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
