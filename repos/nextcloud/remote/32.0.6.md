...
```console
$ docker pull nextcloud@sha256:46968af61c1eceb236857e22981023507fe892ecf7703d7883618d938504df9d
```
...
### `nextcloud:32.0.6` - unknown; unknown
...
### `nextcloud:32.0.6` - linux; arm variant v5
...
### `nextcloud:32.0.6` - linux; arm variant v7
...
### `nextcloud:32.0.6` - linux; arm64 variant v8
...
### `nextcloud:32.0.6` - linux; ppc64le
