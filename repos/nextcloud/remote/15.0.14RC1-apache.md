...
### `nextcloud:15.0.14RC1-apache` - linux; amd64
...
### `nextcloud:15.0.14RC1-apache` - linux; arm variant v5
...
### `nextcloud:15.0.14RC1-apache` - linux; arm variant v7
...
### `nextcloud:15.0.14RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:15.0.14RC1-apache` - linux; 386
...
### `nextcloud:15.0.14RC1-apache` - linux; ppc64le
