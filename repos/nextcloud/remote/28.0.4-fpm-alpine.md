...
```console
$ docker pull nextcloud@sha256:a3e4ff505129633fda4c65992cd5e6ab91900c71be13ef72d0967697fa980edb
```
...
### `nextcloud:28.0.4-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:28.0.4-fpm-alpine` - linux; 386
...
### `nextcloud:28.0.4-fpm-alpine` - linux; ppc64le
