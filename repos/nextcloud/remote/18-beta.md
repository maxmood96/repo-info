...
```console
$ docker pull nextcloud@sha256:5a9be5fa2f6e265a67919bc12b59fb03c69789f20d56ad774fd49fec11ffc141
```
...
```console
$ docker pull nextcloud@sha256:b105d75f834b2e5c0d9e57f55a46cb36e70c40d4e5ce0e81542f28a99dbd0df5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.9 MB (220900000 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e14f5cb1682683186a94ed934dba74d04d24d4cb920bc706a83df7e31f8b3c3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 Dec 2019 00:59:41 GMT
ENV NEXTCLOUD_VERSION=18.0.0beta3
# Fri, 20 Dec 2019 01:01:26 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 Dec 2019 01:01:38 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Fri, 20 Dec 2019 01:01:44 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Fri, 20 Dec 2019 01:01:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 Dec 2019 01:01:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8bd58848bc01d1bb9a203f553e5565d0b4cd4e050cb826f7ccb07f32e9a209af`  
		...
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a39a40b46ac92ff7d1bde43d2f56d0032b1661369cb6eca2defe5dc87cdfa5b`  
		Last Modified: Fri, 20 Dec 2019 01:11:25 GMT  
		Size: 77.3 MB (77335493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b14b714654d4b25497fc6d8f00a8a52909d6a4a5e47b2cd50afe4949ba54b68`  
		Last Modified: Fri, 20 Dec 2019 01:10:55 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d546ab72c56cf8b771157d74a68e4458c9cd4d26f05fc87f9f181badec19b523`  
		Last Modified: Fri, 20 Dec 2019 01:10:55 GMT  
...
```console
$ docker pull nextcloud@sha256:522ca62dc702e763e4ec8d238fbf90279867e2986e4d9ca931dc4e2fe66b910a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.5 MB (249456126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4db1fb4b74edf434b99e29852f2acae62671fe3532a438b2aa4d178ab32368ed`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 20 Dec 2019 01:34:13 GMT
ENV NEXTCLOUD_VERSION=18.0.0beta3
# Fri, 20 Dec 2019 01:34:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 20 Dec 2019 01:34:49 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Fri, 20 Dec 2019 01:34:50 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Fri, 20 Dec 2019 01:34:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 Dec 2019 01:34:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2ecf33332b7da48b203093366c9a40ee53cfc1ffe64901805a54f79a728e6229`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbef3484792ad1280c044e6c78d475d010f5ba14d1f2771e34415636cd3801b0`  
		Last Modified: Fri, 20 Dec 2019 01:42:17 GMT  
		Size: 77.3 MB (77335852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb7365cb8674d62e63d49ee5436bdaa7ac4e155048169c67205002183024a3a5`  
		Last Modified: Fri, 20 Dec 2019 01:41:49 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69acf37d23817ebfc3e4ad5c08a88e0b61142936a6437bec131eeba0659207c6`  
		Last Modified: Fri, 20 Dec 2019 01:41:49 GMT  
