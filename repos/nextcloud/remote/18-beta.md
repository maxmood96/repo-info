...
```console
$ docker pull nextcloud@sha256:4cb219f79be9abd670d9e813a70f6630912a06351e84cceffababa37c86454a4
```
...
```console
$ docker pull nextcloud@sha256:a21827ffdeadabbffa61cc7164d3767efef2c42cd791fa1f4de670af54efc3c2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.0 MB (218995884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed0572f4276dd59b583e1672354003117f8004751e6f141db04bf83091865c06`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 13 Dec 2019 00:49:23 GMT
ENV NEXTCLOUD_VERSION=18.0.0beta1
# Fri, 13 Dec 2019 00:51:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 Dec 2019 00:51:47 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Fri, 13 Dec 2019 00:51:51 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Fri, 13 Dec 2019 00:51:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Dec 2019 00:51:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bc33ce348526c874998c3c8cdbc0eeaef6f7f6385ba89169ab1a589971120f55`  
		...
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0b0972b15a95184fc563046595f2c1b00da32195d5a7df75fb0391454239c67`  
		Last Modified: Fri, 13 Dec 2019 00:55:02 GMT  
		Size: 75.4 MB (75448343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9474a7284d76901ee03e8567a39b693795de468b2b18ea6152764f9e6cae709`  
		Last Modified: Fri, 13 Dec 2019 00:54:34 GMT  
		Size: 2.1 KB (2097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87acef3df77608a47e45a6bdf307a6337d16afb91c0ec658d39d8e9d7252f803`  
		Last Modified: Fri, 13 Dec 2019 00:54:34 GMT  
...
```console
$ docker pull nextcloud@sha256:5ad48f9ae18ee77d6b893bb7776625990ec8ce88c80f0ad2154e3ba06bd18301
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.2 MB (215151840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c235f2e8be34359a0be971e806add6a4f2e3da6acdb9cbc11ea194c3729a208`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 13 Dec 2019 01:01:20 GMT
ENV NEXTCLOUD_VERSION=18.0.0beta1
# Fri, 13 Dec 2019 01:03:42 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 13 Dec 2019 01:04:01 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Fri, 13 Dec 2019 01:04:09 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Fri, 13 Dec 2019 01:04:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 13 Dec 2019 01:04:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:453338f4bddf47fd849465f7bbc19e3cebfb79b42c29c2738c823be7e5f40ff1`  
		...
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11e90cf0929be75996f8116b80183792e80ed02184576633d05d503f3b07cb76`  
		Last Modified: Fri, 13 Dec 2019 01:10:01 GMT  
		Size: 75.4 MB (75448111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15351780f3ea128dc94bbf2b28e36963a75ea8aeaa306f55781d0716619717e4`  
		Last Modified: Fri, 13 Dec 2019 01:09:34 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:945d4b9861ff0fecb1cbd3d52c7ed53058940192ce2ccab6035f200738adde1b`  
		Last Modified: Fri, 13 Dec 2019 01:09:34 GMT  
		Size: 1.1 KB (1136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
