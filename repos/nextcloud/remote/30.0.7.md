...
```console
$ docker pull nextcloud@sha256:5c809c9f1e393b66e09077eb1e56af604c8489a847ab6522783dd69bce169baa
```
...
### `nextcloud:30.0.7` - unknown; unknown
...
### `nextcloud:30.0.7` - linux; arm variant v5
...
### `nextcloud:30.0.7` - linux; arm variant v7
...
### `nextcloud:30.0.7` - linux; mips64le
...
### `nextcloud:30.0.7` - linux; ppc64le
