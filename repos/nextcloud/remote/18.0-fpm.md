...
```console
$ docker pull nextcloud@sha256:40fdcd891c3839b10e6e0b584c5bbefaae8b38befc6d60c7ac1b41a2dc026034
```
...
```console
$ docker pull nextcloud@sha256:7af03f3989f090cb568434ca1c3026bc4ab2f20a516fe5311ca22ca4ebfc5293
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.7 MB (235657014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29ce37d0a665769a4a7f1bbfba4cfd722f7c55e3144fcbb6cb6665a06e46f91c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=18.0.6
# Wed, 10 Jun 2020 23:52:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 10 Jun 2020 23:52:08 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Wed, 10 Jun 2020 23:52:11 GMT
COPY multi:0f9299c697c03625557426785fb6ad8cae5e661ea8ceedf25eb083ff586c1e00 in /usr/src/nextcloud/config/ 
# Wed, 10 Jun 2020 23:52:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 10 Jun 2020 23:52:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:163fbe73e0680a609e79a98244ca359943fd4004725f3650650e398bdf27cf9a`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38dbb6af67cdb930b25b8215425c02537d59e5b1bdfc312759869d7eba78969f`  
		Last Modified: Wed, 10 Jun 2020 23:54:57 GMT  
		Size: 95.8 MB (95773529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6724e11cbd7a33631236534390956472b3b26039d13a678dbcde287f5386833a`  
		Last Modified: Wed, 10 Jun 2020 23:54:25 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a483b071a982be9d437f187c63098fdd03b9f7ddef9dc6c5ce6992a8e8a7f4`  
		Last Modified: Wed, 10 Jun 2020 23:54:25 GMT  
		Size: 1.3 KB (1329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
