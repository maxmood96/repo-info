...
```console
$ docker pull nextcloud@sha256:483d155289dcb69dc37b0f5feabf77986cc08c6c7d0da5c7cf14ce86300f07ae
```
...
```console
$ docker pull nextcloud@sha256:1d4aa1b334f42b24856307790561463ba42ee056fc86eb66703f25b3fc55d5e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.0 MB (368048372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00c66b9e50dd5ccf80db891fc3d03362a12ff39affe7431916647b431fd205b4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 13:53:39 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Tue, 13 Feb 2024 13:54:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 13:55:01 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 13 Feb 2024 13:55:03 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Tue, 13 Feb 2024 13:55:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 13 Feb 2024 13:55:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:50e5024bbc65879fb654c9d34c404dd02d315647b7477fd732e510923c1a4db8`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d58ee0a1c7d0bbd87884ffbc8197983f5dd4143285b8bc8997f49c6bb4c54b4`  
		Last Modified: Tue, 13 Feb 2024 14:09:35 GMT  
		Size: 177.3 MB (177266099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c226d98445b29c65168fbab601dc7685ed989e7a9a2c4a09c14e87bb435f64f6`  
		Last Modified: Tue, 13 Feb 2024 14:09:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62b2a7c81a30cc0a053280436fb6f9895e067ad35fcbb4a30faed69360651ed8`  
		Last Modified: Tue, 13 Feb 2024 14:09:01 GMT  
...
```console
$ docker pull nextcloud@sha256:04f10f98ba1b7c6eb9af7f033886ceb48621b896ecf6c342e2aaaba6f5a162eb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.9 MB (367912540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ed079f35e2c12081426e1dac1a682899f23f1e2c1f9d32712d722404fe33e54`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 14:53:01 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Tue, 13 Feb 2024 14:53:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 14:53:51 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 13 Feb 2024 14:53:52 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Tue, 13 Feb 2024 14:53:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 13 Feb 2024 14:53:52 GMT
...
-	Layers:
	...
	-	`sha256:10a6f02727a47dacb6467dddc23b7034c976f892766e0d8b7161af8d711cba4d`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0599c794f801a3717cd8c0f21338ca2534562d969e06526984316551b7fd7c56`  
		Last Modified: Tue, 13 Feb 2024 15:12:53 GMT  
		Size: 177.3 MB (177265280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:344c9d1019bdc8fa1cdee74856da88cfe33b5af9d2e3e74c70dad095cc0a1f14`  
		Last Modified: Tue, 13 Feb 2024 15:12:33 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f1e1995be6b51fb63ae9654e9cdccfa8105da732d946b9d8e0c29a0aca221ca`  
		Last Modified: Tue, 13 Feb 2024 15:12:33 GMT  
		Size: 2.4 KB (2390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
