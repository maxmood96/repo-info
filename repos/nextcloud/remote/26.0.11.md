...
```console
$ docker pull nextcloud@sha256:0c1e7a0234a253bb1b6608c8c9418fbaf632248790a396343c848f4529a6c749
```
...
```console
$ docker pull nextcloud@sha256:588e1d9a7ca149e54b3568d868e179827ea1bd8afc341733273506b90300b372
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **368.1 MB (368059270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ca5fec483db844438eb1d02da608c2da2e7a4130df90126013af3ab8ccd8b44`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 16 Feb 2024 23:24:47 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Fri, 16 Feb 2024 23:26:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 16 Feb 2024 23:26:12 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Fri, 16 Feb 2024 23:26:14 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Fri, 16 Feb 2024 23:26:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 16 Feb 2024 23:26:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7ef4486cf5aba07d8ab10da9b3ff5e554a78e1095bc0d424c315029559b2ef57`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:329a0b1da978998ea3c1cbb4c07b08361f9a179f54e3418dd0042911f56c75da`  
		Last Modified: Fri, 16 Feb 2024 23:41:50 GMT  
		Size: 177.3 MB (177265965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9ef0be183a48fb3c4b403a7a9e7b1dcd8394d42c19425da0aa2bc7424b4026a`  
		Last Modified: Fri, 16 Feb 2024 23:40:58 GMT  
		Size: 3.6 KB (3614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89841f7a566d300fdd8c43e158813f8d305deb7d2bc4a725a253fc4fe2ad47c5`  
		Last Modified: Fri, 16 Feb 2024 23:40:57 GMT  
...
```console
$ docker pull nextcloud@sha256:b1b386629ff7bc05d8ac2113251473c96c8ed0f5fede460058e59773fd19ccdf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **356.5 MB (356498108 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8aae0928a531949488c8aef9067f2c40c9964c7e669fd2f8b95b0ae58dace56e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Sat, 17 Feb 2024 01:37:15 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Sat, 17 Feb 2024 01:38:34 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 01:38:38 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 01:38:41 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 01:38:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 01:38:41 GMT
...
-	Layers:
	...
	-	`sha256:9be35568c74d5c2e225cb942bf0aa1b0ace42892b388eb6d6d3a3fe81a99dd57`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b31c68c7df91be6ba1c6cf6038ed0658b519ec169cbcb9813c20618e6892b38e`  
		Last Modified: Sat, 17 Feb 2024 02:04:53 GMT  
		Size: 177.3 MB (177265933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d051e2da75b6d09f905d22120fd2f9a5c310f3db0cd08dce74d24e1cc8fd4d5`  
		Last Modified: Sat, 17 Feb 2024 02:04:02 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9689f156347b66aa8cc99d9e64df46ac51551f1683d2875b72ad481242f992dc`  
		Last Modified: Sat, 17 Feb 2024 02:04:01 GMT  
...
```console
$ docker pull nextcloud@sha256:7fbf90e47e1efc85db238b5e589165f51c8e82655e83e2f75b7cfb9f723f877e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **369.8 MB (369834486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d74dc57c3521cd6cfa89ad0f43691e4c458a5245b4d7d1f5bea79a870c26f1c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Tue, 13 Feb 2024 21:54:51 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Tue, 13 Feb 2024 21:57:57 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 21:58:10 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Tue, 13 Feb 2024 21:58:20 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Tue, 13 Feb 2024 21:58:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 13 Feb 2024 21:58:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8f3bc2e320db6734178aa96054e889ef2f02e4f44266e7702b3562910e9719c3`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:666fce451dd758db7ac65123f84bce1c56dcf354fbc50e47674ecacb1b916ec5`  
		Last Modified: Tue, 13 Feb 2024 22:37:47 GMT  
		Size: 177.0 MB (177039468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f422c6538130ceab78d95b7478e6d49dd4fb570ebfb25666ae98079fb5475fc7`  
		Last Modified: Tue, 13 Feb 2024 22:35:14 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5de737f5cf4d632307686c99d8395b63143a7d99543b4e8e075adf3bf7b80a42`  
		Last Modified: Tue, 13 Feb 2024 22:35:15 GMT  
...
```console
$ docker pull nextcloud@sha256:d8175f8d1cf466ea5e389e93eac39aae97c154c1b99aac893e3ded15da73be44
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **403.9 MB (403876141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3dcbcdafe892d7b4ff7a28c98ecfbd243414f1e606f7e12fa49b1516b2f7a08`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 17 Feb 2024 02:01:38 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Sat, 17 Feb 2024 02:02:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 02:02:48 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 02:02:49 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 02:02:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 02:02:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:69e4af27a015406ea220331fa04c25ee6046295184265629b35d9bf8db3a5a68`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd6674ea3a6601bd9432c1a9f92231298f3abd776013bada2b5921dfcee95c8d`  
		Last Modified: Sat, 17 Feb 2024 02:21:25 GMT  
		Size: 177.3 MB (177268654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44569e1ef6d1d513274054a73787453a94442ac238eddcfa8caab6fa0f842b7b`  
		Last Modified: Sat, 17 Feb 2024 02:21:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:158311c5d10f9479456bb90f390b82a3fe88b94c34e08924d2289b77f9a3d462`  
		Last Modified: Sat, 17 Feb 2024 02:21:01 GMT  
		Size: 2.4 KB (2393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
