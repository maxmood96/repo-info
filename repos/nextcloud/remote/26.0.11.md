...
```console
$ docker pull nextcloud@sha256:c48ec725792d53dc6122f94c2d6c6b826563dc8f12824aa3238e982ea53be020
```
...
```console
$ docker pull nextcloud@sha256:b693ca30a8fbaa85feb75bb5bfb7d93ee012df61b02d3a17fab3682f50f4d9e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **398.5 MB (398549087 bytes)**  
...
-	Layers:
	...
	-	`sha256:d2d1ce29b77b862b739a549e9dac7f3e8c7405a91dbabddfc4681805dbda769b`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7756c0f6e2aee96875d4f80e87df993e72cf50c3e600d8eb331fd812ce08b049`  
		Last Modified: Sat, 17 Feb 2024 02:45:58 GMT  
		Size: 177.3 MB (177268257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aa7c7dc541c82fdbd8846a61f269f14ef6d68df55a6fad7f85b5203ab02cf50`  
		Last Modified: Sat, 17 Feb 2024 02:45:36 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ee9d10ed8a98de89e4cf95a4ae4efe7943d22c0989a97ba0018e293038bc0dd`  
		Last Modified: Sat, 17 Feb 2024 02:45:36 GMT  
...
```console
$ docker pull nextcloud@sha256:6f75fdb9667b129c46c77bf5ba2899afb638a3aa4634e521bc61fda61a34e510
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **367.9 MB (367923380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d7ab2c06479945479fe2e5b521d2aba438c27de083b20b4222f11f4e0a60ea1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 17 Feb 2024 02:12:17 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Sat, 17 Feb 2024 02:12:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 17 Feb 2024 02:13:08 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 17 Feb 2024 02:13:09 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Sat, 17 Feb 2024 02:13:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 17 Feb 2024 02:13:09 GMT
...
-	Layers:
	...
	-	`sha256:718abe75be22dd999453100382d2945b30e0be681b635a75a250e20edb94654d`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f41ae613524ff86171a5ae953235ba074b03b23533afe32528bd633cddb04b57`  
		Last Modified: Sat, 17 Feb 2024 02:35:50 GMT  
		Size: 177.3 MB (177265308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:059e7b88d3d77a94ea5f1f2eb70bef1fc30d8a40d591950266cf8be554ae0a0a`  
		Last Modified: Sat, 17 Feb 2024 02:35:30 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:697bac988ed8648448f50002e1ab57d93f50ba72ba4158703d84b316339e6b85`  
		Last Modified: Sat, 17 Feb 2024 02:35:30 GMT  
