...
```console
$ docker pull nextcloud@sha256:affe15e18129609d4ba48904938421fe326926e9b0f30da84c4fc5df7d838977
```
...
### `nextcloud:28.0.8` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:c260ef71bb1282a5f2da20b1c9ffea9397350bb79e297be180ff03566bcd66f7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **394.9 MB (394929362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36ac3d05f944e83c910728e1489c7cc5b35b84edd9f5e22d219e0f7914746f1b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Mon, 22 Jul 2024 22:00:25 GMT
ENV NEXTCLOUD_VERSION=28.0.8
# Mon, 22 Jul 2024 22:01:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 22 Jul 2024 22:01:39 GMT
COPY multi:93e628175b4469d463083705f9db1d7b4d090629cd6c12433f52a951b154a5c4 in / 
# Mon, 22 Jul 2024 22:01:40 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 22:01:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 22:01:40 GMT
...
-	Layers:
	...
	-	`sha256:4ba1758cf6f101a53a9b2a263018271b9c9db0f063c3c03bf78b77903b70b3c9`  
		...
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25d1c016e5ad058bb98b9824a91e09dd71b7be4f7f2b1e1bcc5130e79d023ade`  
		Last Modified: Mon, 22 Jul 2024 22:07:31 GMT  
		Size: 204.1 MB (204061275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ef441f7c7615f123aa87fc3bbc1132aacf0c49feba9a985e1f854b038bbef96`  
		Last Modified: Mon, 22 Jul 2024 22:06:51 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f5bda0a09a24d650345ae86b64b95a22986a1a90a3453e43ba9717f1e78c565`  
		Last Modified: Mon, 22 Jul 2024 22:06:51 GMT  
		Size: 2.4 KB (2371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:28.0.8` - linux; arm variant v7
...
### `nextcloud:28.0.8` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:e4cedb2401034c5de01e851bd8116ea1e5faac488cd7ed9efe44909496237e52
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **416.8 MB (416847071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40be0094b9d1a0032ba31844ea70ca2fc9291f8525a7a777c875fff80b7055a0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Mon, 22 Jul 2024 21:50:46 GMT
ENV NEXTCLOUD_VERSION=28.0.8
# Mon, 22 Jul 2024 21:51:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 22 Jul 2024 21:51:42 GMT
COPY multi:93e628175b4469d463083705f9db1d7b4d090629cd6c12433f52a951b154a5c4 in / 
# Mon, 22 Jul 2024 21:51:43 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 21:51:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 21:51:43 GMT
...
-	Layers:
	...
	-	`sha256:90e36136e507e1fa894b104a84a810ea4375b0a4aa7a1b34d42d2903aa65ab13`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a6ef6b1abd13c1a5e5be71568a8d88e7445c9db9a8888347f11b85edcf67c75`  
		Last Modified: Mon, 22 Jul 2024 21:58:47 GMT  
		Size: 204.1 MB (204062944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6d59e3c1dd191bcfb9ff810ffc6ff26818f93519015e376d32fb12cc2197de7`  
		Last Modified: Mon, 22 Jul 2024 21:58:18 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b69ff498c85bd30713f5003dce6670d0c553d4c052a72ed0320cd1bfeacbea37`  
		Last Modified: Mon, 22 Jul 2024 21:58:17 GMT  
		Size: 2.4 KB (2368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:28.0.8` - linux; 386

```console
$ docker pull nextcloud@sha256:55328798f66470ad6b99075da800786a9977b29f040e41985eced961c763d30a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **424.1 MB (424067311 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68ad390e15be87a0ddc091192049ab2e2b84b9cafe34e387e3793741b515dce3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Mon, 22 Jul 2024 21:39:44 GMT
ENV NEXTCLOUD_VERSION=28.0.8
# Mon, 22 Jul 2024 21:40:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 22 Jul 2024 21:40:52 GMT
COPY multi:93e628175b4469d463083705f9db1d7b4d090629cd6c12433f52a951b154a5c4 in / 
# Mon, 22 Jul 2024 21:40:52 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 21:40:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 21:40:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:867140e6e68f7752840e8f4cccb26db8b8195182c8ee899c99bb1305bd6d4262`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf261f476350bb407368ccfce052339c718135ae9f145352091779b0eed4a09a`  
		Last Modified: Mon, 22 Jul 2024 21:49:25 GMT  
		Size: 204.1 MB (204062393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61eb9db9c3af68d8255384e5575897a54fe5a6d4c9d863eb280e5cc660384fb9`  
		Last Modified: Mon, 22 Jul 2024 21:48:49 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e83ba45863d91bba5b34e97432da8246270cb37310fa9757465454cb2b0b9c4`  
		Last Modified: Mon, 22 Jul 2024 21:48:49 GMT  
		Size: 2.4 KB (2374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:28.0.8` - linux; mips64le
...
### `nextcloud:28.0.8` - linux; ppc64le
...
### `nextcloud:28.0.8` - linux; s390x

```console
$ docker pull nextcloud@sha256:4d04e739b8aa66869dd20d164638115335308c0d8f9fd9f0bed547ee7501988b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **395.0 MB (394998212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69405213d290d1e27b0861a078148ee8a51437c9133411c71245027686b1cee2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=28.0.8
# Mon, 22 Jul 2024 21:54:29 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 22 Jul 2024 21:54:51 GMT
COPY multi:93e628175b4469d463083705f9db1d7b4d090629cd6c12433f52a951b154a5c4 in / 
# Mon, 22 Jul 2024 21:54:54 GMT
COPY multi:26b6011f3864a7a1d1a6de6eafef4f376d2e08f7f7b1ef21b94e6d2658564826 in /usr/src/nextcloud/config/ 
# Mon, 22 Jul 2024 21:54:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 22 Jul 2024 21:54:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d4328a118488a02e5f8297a07cfb754b0794a2e76feb02574d3e3c36f06ec66d`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96b7d9ea9244a95aa24f6237558ac62e286d8940b6f8fc526c683fa731d095b5`  
		Last Modified: Mon, 22 Jul 2024 22:09:58 GMT  
		Size: 204.1 MB (204061242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5c0532d07b3c2d8f223c70e134eeae8d32176bea086b810361a28d8613a9838`  
		Last Modified: Mon, 22 Jul 2024 22:08:53 GMT  
		Size: 3.9 KB (3873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c93013c70b75c526cb1f161fa3fa087eebe75b118d7869bf64c17a564d0027f`  
		Last Modified: Mon, 22 Jul 2024 22:08:53 GMT  
		Size: 2.4 KB (2371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
