...
```console
$ docker pull nextcloud@sha256:ae7f9d2d997472f58ce23f799cf2d257a04b400f99e69346f9312e9de2703e06
```
...
### `nextcloud:30.0.15-fpm` - linux; amd64
...
### `nextcloud:30.0.15-fpm` - unknown; unknown
...
### `nextcloud:30.0.15-fpm` - linux; arm variant v5
...
### `nextcloud:30.0.15-fpm` - linux; arm variant v7
...
### `nextcloud:30.0.15-fpm` - linux; arm64 variant v8
...
### `nextcloud:30.0.15-fpm` - linux; 386
...
### `nextcloud:30.0.15-fpm` - linux; ppc64le
...
### `nextcloud:30.0.15-fpm` - linux; riscv64
...
### `nextcloud:30.0.15-fpm` - linux; s390x
