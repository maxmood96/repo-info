...
```console
$ docker pull nextcloud@sha256:94e2f0f071cd5a6e184808cd8a5f226e65bcad29f079943333ceae6a894fbef5
```
...
### `nextcloud:19.0.2-apache` - linux; arm variant v7
...
### `nextcloud:19.0.2-apache` - linux; 386
