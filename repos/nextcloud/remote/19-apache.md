...
```console
$ docker pull nextcloud@sha256:91d00e407366ce9d9e5119a4c13af6eae4cf8102eaf945c0410766c894353bca
```
...
```console
$ docker pull nextcloud@sha256:cbaefa368a28aa4fb98aecd9e5fcc5b06b229acd4c34b9a504d21ad15c4d8230
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **241.0 MB (241012043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:759520d970ec2a55809583bef000890454e4943081e8f353e0f3c9683de46781`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 25 May 2021 22:29:11 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Tue, 25 May 2021 22:29:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 25 May 2021 22:29:55 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 25 May 2021 22:29:56 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Tue, 25 May 2021 22:29:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 25 May 2021 22:29:56 GMT
...
-	Layers:
	...
	-	`sha256:c0e6a462fc7a91d0fba1323a588404571bd7c5c814828bc1ab52ac15cc86965d`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2509089edc193032d67be2ef5f330cd7a4e8e16a73ffe911ba81dd97f1ad8baf`  
		Last Modified: Tue, 25 May 2021 22:46:33 GMT  
		Size: 103.7 MB (103687416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5238351e0e876396814874a71428297eb7bae04a97919b5b5a4a49028df40ef8`  
		Last Modified: Tue, 25 May 2021 22:46:12 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:417f484dd0c91ef66b989c2cccd4a4637371ceb38c8de08a969e4355bee001f4`  
		Last Modified: Tue, 25 May 2021 22:46:11 GMT  
...
```console
$ docker pull nextcloud@sha256:0d5421981d88ab58ce90c2844a2320195ceda5aa901ff70c03a4477a0249cb65
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.5 MB (258502302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:830083326e56548b0fb291e9e03394cef799ea1fa3efe21884e90f6446ef98c5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 26 May 2021 23:13:15 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Wed, 26 May 2021 23:13:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 26 May 2021 23:13:50 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
...
-	Layers:
	...
	-	`sha256:c0bf7e21864031f2a76938feec72c9518a51ab0486762123358f6ebb5aee2bc1`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b03110a792ea09a2f357ce6da13f8964aff770511f946149ef551716cea43c22`  
		Last Modified: Wed, 26 May 2021 23:27:33 GMT  
		Size: 103.7 MB (103688497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af8334bc55937f53b9697bac79b5ad86961b635074731bd75116f6470e965824`  
		Last Modified: Wed, 26 May 2021 23:27:17 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:418884119b3c7e178f0b8ad45f8a31aaf3c6394a55dfefbedf89e2650dea2829`  
		Last Modified: Wed, 26 May 2021 23:27:17 GMT  
		Size: 2.1 KB (2061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:c41edde4e26eccf5156c61c53e67119a8a2f6792f3ecde22f41766c777702341
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.7 MB (279657743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4364c357198a28eb4b5aa48692516c3a93788982ba9e6ea76f6471fac18ec9fd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 22 May 2021 03:03:58 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Sat, 22 May 2021 03:06:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 22 May 2021 03:06:46 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 22 May 2021 03:06:49 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 22 May 2021 03:06:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 22 May 2021 03:07:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:281d40186f662890d3bc6e54033d45bcd3c3b7c479b5adc5318d7a71e7d1b4f2`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45d33c65558a21e9775f8229ae56a7c916158c200d84c0773d7ec318a57b0bd3`  
		Last Modified: Sat, 22 May 2021 03:38:35 GMT  
		Size: 103.7 MB (103693151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04ee7272e3c38437d1ee87fcae0e045def1993c691a985c2db33662455f40f36`  
		Last Modified: Sat, 22 May 2021 03:36:44 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d8db28f27c4b08544debfb3a2983d79cc18670c27b07c80239268f911631122`  
		Last Modified: Sat, 22 May 2021 03:36:44 GMT  
		Size: 2.1 KB (2059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
