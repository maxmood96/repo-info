...
```console
$ docker pull nextcloud@sha256:37a040525166b3ad4f77fe0d8133707977f72dc76764d439d11f61e28c467f2b
```
...
```console
$ docker pull nextcloud@sha256:cc67ef07cac0a18657e3b8bdb952a7d82b8bf831112393138540e6e32b9d71ab
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.6 MB (243628699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:786f5d3c0d2f4524ac485f9f4f4d2308dc4f50a14171cc39950b24e535122488`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Oct 2020 21:31:18 GMT
ENV NEXTCLOUD_VERSION=19.0.4
# Fri, 09 Oct 2020 21:32:16 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Oct 2020 21:32:23 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 09 Oct 2020 21:32:27 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Fri, 09 Oct 2020 21:32:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Oct 2020 21:32:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ba3080f7f03520b02534336b196d42c299b4b749924c6940bcf522baf2d1baeb`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeea6f56217a8901a436d9daddc59684c993b2763e91d0d27208b75b9a22cf9a`  
		Last Modified: Fri, 09 Oct 2020 21:53:30 GMT  
		Size: 105.7 MB (105717274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8a66d5bfd9fdfa76129787bd82a37ffdb89db43a1fd081c21b0f14d2ac91042`  
		Last Modified: Fri, 09 Oct 2020 21:52:53 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:609bfc918ac035ca932949c8e94e7dbebb17d652a79d9685c2af71a4848534a4`  
		Last Modified: Fri, 09 Oct 2020 21:52:53 GMT  
...
```console
$ docker pull nextcloud@sha256:5e6b9c41cc7540f5685601c2790e74d8a59afabb5495e9689f6a0078afda8fd9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **282.2 MB (282226923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:707f7c5fde45e619721cfd17e899fb3f3aefa8c91834ff88dc915b6275c4a9b1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 08 Oct 2020 22:52:16 GMT
ENV NEXTCLOUD_VERSION=19.0.4
# Thu, 08 Oct 2020 22:55:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 22:55:34 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 22:55:41 GMT
COPY multi:31f90353cab4c23d5f879be122463203247e1fe31c21cedb2b87aa0d906e956c in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 22:55:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 22:55:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:738e3fb61cc144603ec3b34cb91bee9d9c02727ae1d35cd7315dfe33dd223077`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:448900bbdddafd260580ba89089e258327e244eeac798f6f2779dee16e4525f4`  
		Last Modified: Fri, 09 Oct 2020 00:02:09 GMT  
		Size: 105.7 MB (105721798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bab5ea9d3ccb8ef489207ff9b57c4fff5642d9517524e20bae2ba0e9bc51ed4`  
		Last Modified: Thu, 08 Oct 2020 23:57:42 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ea8c9b97f7c1560d7da1c4a78f86f7a935dda7733551f5e06c76c5950cb427a`  
		Last Modified: Thu, 08 Oct 2020 23:57:42 GMT  
		Size: 2.0 KB (1956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
