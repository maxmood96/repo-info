...
```console
$ docker pull nextcloud@sha256:b4ef39468f88b411187a2908638d5b88d10bd3b410e2f5b78ed239394b97eebc
```
...
```console
$ docker pull nextcloud@sha256:14cdc41f8f71cb0012e1098653cdb83dca4df17b56daa5d66fe3624edb29910f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.3 MB (249250475 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:448585bf5b1f555984f99565c4dfdb4772cd662851049eca06a5554535e862c6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Sep 2020 00:04:20 GMT
ENV NEXTCLOUD_VERSION=19.0.2
# Fri, 04 Sep 2020 00:06:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:06:26 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 00:07:25 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 00:07:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 00:07:37 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:066298e68acdd4c8cadedeae94b11672fb2b157ba4571f8d892824bfc8745a3e`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b71417d1afcbdc28ec036c946b76817b76826cae98a1ed038a1c34a7b1d8d70`  
		Last Modified: Fri, 04 Sep 2020 00:30:58 GMT  
		Size: 107.5 MB (107499335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2af6b28f241acb1c62d7cc866331979832e6f66a85d651d5cbaf6ec0922b7839`  
		Last Modified: Fri, 04 Sep 2020 00:30:11 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09457414bc2f586f63ac74c8756ef110ad1409eab509ddeb4537ad65206fb049`  
		Last Modified: Fri, 04 Sep 2020 00:30:12 GMT  
...
```console
$ docker pull nextcloud@sha256:3f9447bd3f56a7f044a20bf41fcdfa73eb5e4c11184b476412779486c1cf5ca0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.4 MB (245402342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd9a02d0a0fd3b97157c64843b63330e01a69e1cbbe694de492ffcf3e0f6cce7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Sep 2020 04:38:05 GMT
ENV NEXTCLOUD_VERSION=19.0.2
# Fri, 04 Sep 2020 04:39:03 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 04:39:08 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 04:39:13 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 04:39:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 04:39:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:590f4af5fbd8d198158ce358862486482952c66fcf2addd7d0349416086e19d3`  
		...
		Size: 585.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92e2444ba339229f413e9e9f57730553bfbb717512d9c5f2c29827d6e94c4313`  
		Last Modified: Fri, 04 Sep 2020 04:59:39 GMT  
		Size: 107.5 MB (107499151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c37339e19939d21835bbb49f8a998f26dac7a0657a7f36ab746403937053fa9`  
		Last Modified: Fri, 04 Sep 2020 04:59:03 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9faeb64f2ca54ad1dc105504146c214cbaec05827559085f2b09ff7add41aea`  
		Last Modified: Fri, 04 Sep 2020 04:59:03 GMT  
...
```console
$ docker pull nextcloud@sha256:6bd4910b281569c2639a6552773c7a10cea4fd20b04b210196a90bab0d3de4b0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **277.8 MB (277751960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14c66be1af42d04b8fb3fe5401115cec24effbb78b9e61a014533e62063ea44e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Sep 2020 01:08:23 GMT
ENV NEXTCLOUD_VERSION=19.0.2
# Fri, 04 Sep 2020 01:09:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 01:09:07 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 01:09:08 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 01:09:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 01:09:08 GMT
...
-	Layers:
	...
	-	`sha256:2768731a5847ed4ee973f397ee9e862776cb58f37f04c01be63385d7151e82fa`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a29c9bd05f8062f5dd09b0012b928bbc6a6fd54be0723d0abae80b9022711b27`  
		Last Modified: Fri, 04 Sep 2020 01:24:39 GMT  
		Size: 107.5 MB (107500092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d1225a4322a00ab88a02d801bc7bb56e9f3735af483311e4b0071af4488ba85`  
		Last Modified: Fri, 04 Sep 2020 01:24:00 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:906a1c163455127de0ff6e3013234aaf887a350a5a5821c83ba5a2d25610cd8d`  
		Last Modified: Fri, 04 Sep 2020 01:24:00 GMT  
...
```console
$ docker pull nextcloud@sha256:199cc21862ae3fe2d1d51b044ab420165d745c56bda47065890bb60b155f7e8a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.6 MB (256585941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be96fd238996bbc4e9944a9c58e2ef4fd069e89339dc615fc84ff6b1e1355353`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 03 Sep 2020 21:31:05 GMT
ENV NEXTCLOUD_VERSION=19.0.2
# Thu, 03 Sep 2020 21:31:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 21:31:36 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 03 Sep 2020 21:31:37 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Thu, 03 Sep 2020 21:31:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Sep 2020 21:31:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:19f0e29e16adbe79f401c78caf60564c12327f62f79bec37c3fa5c97149edb92`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a621f8b4a4cefdfadac3dc9912b55fd13c2f70387d5709f437fb36a788d56b82`  
		Last Modified: Thu, 03 Sep 2020 21:43:31 GMT  
		Size: 107.5 MB (107498813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67a8ddc746fc31b3d4f69ff0071b9a040fa4d50599d276bcc6a544ab2380b875`  
		Last Modified: Thu, 03 Sep 2020 21:43:18 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:925ee45ccb19512f419ec166c955be7a5a08a22ed151e0c10b6b5272831aada0`  
		Last Modified: Thu, 03 Sep 2020 21:43:18 GMT  
		Size: 1.7 KB (1715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
