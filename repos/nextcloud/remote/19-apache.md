...
```console
$ docker pull nextcloud@sha256:ffb907c24e68aafd1ee131f3dfae126fc69f87b919a5da287720c8c4bd3eb200
```
...
```console
$ docker pull nextcloud@sha256:97aad280b97701ca382b0230c2a773d5d06dbf821784d2c90a53a50671e98e6a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.9 MB (267918032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5d426a9328863d94d3d062d3e7f20819b9292e4131c0faee58bfdc312567421`
...
-	Layers:
	...
	-	`sha256:2474535661dca54ad3e333ba8f001141d09df03a8cd8b87a47c0a74584b8b6ae`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39751fbb490aafd0a1279ae0e1efa907ea10fb77fa2638aad759b036bf51d4bf`  
		Last Modified: Fri, 09 Apr 2021 18:37:29 GMT  
		Size: 103.6 MB (103558754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a12824752f622707e63275c52304d20cc3bbb1f90152ce59acd9aaaaa8438737`  
		Last Modified: Fri, 09 Apr 2021 18:37:13 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dac0f7f64db86478a62d070341cdc146be2c7a44a8f0d7b0733970c8ff69111e`  
		Last Modified: Fri, 09 Apr 2021 18:37:13 GMT  
...
```console
$ docker pull nextcloud@sha256:026b0fa2af85c73fa7cc3bc228a76ee0e8d60e5b39387493c782a5bac1ca0ce0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.1 MB (245131750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f15a446f89b4cfb3324e27bea20d905af41f1c686fc8e5aed4d6d855137d5c27`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 09 Apr 2021 17:55:23 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 17:55:26 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 09 Apr 2021 17:55:27 GMT
VOLUME [/var/www/html]
# Fri, 09 Apr 2021 17:55:29 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Apr 2021 17:55:30 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 17:56:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 17:56:40 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 17:56:42 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 17:56:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 17:56:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f517762ebe5b07c06e447fd73943001f3ab763b3169a2795e3afc71f64572494`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:476c7ea48b840fc96fd6818c10bcdbcc8c258d0df6e2f6ecbc882094a71828bd`  
		Last Modified: Fri, 09 Apr 2021 18:12:19 GMT  
		Size: 14.7 MB (14658535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19a4013f107ca89c3a6b2b0bacb226f34119f27ecf5adffc591192d369402971`  
		Last Modified: Fri, 09 Apr 2021 18:12:12 GMT  
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04d370146b3735b9489512a57a9d84c9e5c8c275fb185557576487ab09f62b9a`  
		Last Modified: Fri, 09 Apr 2021 18:12:13 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28e4ed682bb68fac362e832bd7995fb3ca3b18534ef8eb77d432e109d5443695`  
		Last Modified: Fri, 09 Apr 2021 18:12:48 GMT  
		Size: 103.6 MB (103556467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d287e3d63b19379506824727f0b44a459ca9328eb052bee994ae2d3637d3e56e`  
		Last Modified: Fri, 09 Apr 2021 18:12:12 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83be83965517a71578d96c8df68c901398e429b0b887278d8b034bdc3f01be96`  
		Last Modified: Fri, 09 Apr 2021 18:12:14 GMT  
...
```console
$ docker pull nextcloud@sha256:044ac7d486fe0a60eb1e7800cc87f2ab405fc36f31b3e3d1698e4069d03a0fc8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **241.2 MB (241235410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f19af9a521b5e53bc4a27a375905123fa0ebd1c36a6fa830adf2c16049ba913b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Apr 2021 18:07:19 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 18:08:53 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:09:05 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 18:09:14 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 18:09:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 18:09:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ad630c5d51348f91b23513de9b5560dd301befd256670ebd967f7fac5e956c9c`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed601086115365626f2f4d9d4c08f1a283e4b2b0d96e4fc65f586d1a6a8087c1`  
		Last Modified: Fri, 09 Apr 2021 18:32:27 GMT  
		Size: 103.6 MB (103556695 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad44a4169e0719771c0643fbe2abb8a5ff3ad1a9197653c7c2a10d1c537fb7aa`  
		Last Modified: Fri, 09 Apr 2021 18:31:53 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93956ba3dc861bbaebd1a0efb2c91a00473326e4172269239eb7be12965f20ab`  
		Last Modified: Fri, 09 Apr 2021 18:31:54 GMT  
...
```console
$ docker pull nextcloud@sha256:b77a2b79a0caf15095d85793d84ed7c272580a59fc155ac720669bcf7b7e4a36
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.8 MB (258771200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6485100dce132d66754458891acfa28693b8c4f9b6d579e109726b6ca2d2c39f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Apr 2021 18:58:25 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 18:59:12 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:59:16 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 18:59:20 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 18:59:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 18:59:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ba48422901cffe3c8981693749cf98299c55b522629b01794c41253490a651ac`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64641c2cfbdcedf5a16ab045a750ad21aa4dc035a5e7af81c1c6868b5fd756ab`  
		Last Modified: Fri, 09 Apr 2021 19:20:13 GMT  
		Size: 103.6 MB (103558156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ece403b91a3104b4fe30e225cbf7a4e766bf44fe0ce2e43d15abb4b5e540cc2`  
		Last Modified: Fri, 09 Apr 2021 19:19:48 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d53b26bf1c7fdf9e4b136fb3b72128f18b8d59a4e02e627ac7765b5f94482e5`  
		Last Modified: Fri, 09 Apr 2021 19:19:48 GMT  
		Size: 2.1 KB (2060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:0798fc93b305353b9da42febdf8f8f1dffefbdab2fcb13ad3aee147490b6b6cb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.7 MB (273715502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a3a02437974b53fff3b8cfa23970ca1c07ed5c2091d96e58ca241bfc64ff28b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 09 Apr 2021 18:42:15 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 18:42:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:42:58 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 18:42:59 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 18:42:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 18:42:59 GMT
...
-	Layers:
	...
	-	`sha256:c345f118d5fd0aeb911fb02503088f6962d692a9fa9c57c6245f2efcd68f1258`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64a943892240afeef6ded810cd3941202fec4feb968271183adac1c8eaf03c22`  
		Last Modified: Fri, 09 Apr 2021 18:59:00 GMT  
		Size: 103.6 MB (103558119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad30b71c489300295a4197cac3bee8b14fe1b9af8ad0268aa820e310e7d8495c`  
		Last Modified: Fri, 09 Apr 2021 18:58:33 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2c5028ad7c20273668ef419f9f1166a7862f48fca007d6fbdb7c50e397bb7ad`  
		Last Modified: Fri, 09 Apr 2021 18:58:33 GMT  
...
```console
$ docker pull nextcloud@sha256:9fb6a3e7f0727267a50945742cf3478a2afb4177329b58d87f6e97982e27e01b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.5 MB (249463419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:616991fc178025589ba919ad65da03f5edd008e79e35ed83410e3c06c09bc97b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 09 Apr 2021 18:16:11 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:16:13 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 09 Apr 2021 18:16:13 GMT
VOLUME [/var/www/html]
# Fri, 09 Apr 2021 18:16:16 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Apr 2021 18:16:16 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 18:17:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:17:53 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 18:17:54 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 18:17:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 18:17:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:34e3355262ac99cd6275bdfe384cdc57ca215599562c237f5d59828a122c4569`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb3cb79f25c87a2c63fd7c50155abb5e4b74bb6459f1270324084dbac6516e55`  
		Last Modified: Fri, 09 Apr 2021 18:36:50 GMT  
		Size: 14.5 MB (14494197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:487a53de4b41f95a08f9a76689e391baefe7063b55f1117536f1eb6ee702e919`  
		Last Modified: Fri, 09 Apr 2021 18:36:36 GMT  
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e597ffd19842a16dd22d4ca0d9d14476cfadb36bef4f8eb976c1a25c917851c`  
		Last Modified: Fri, 09 Apr 2021 18:36:36 GMT  
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74abd56dee5bbe0137342e3310b93ace537feabf60e9c5c285f9f7b934c4f6ec`  
		Last Modified: Fri, 09 Apr 2021 18:37:45 GMT  
		Size: 103.6 MB (103556457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d737ecd38a3b9062a4efa01a8393fea9002cf37e1bcde7c1d20b5b990e68e637`  
		Last Modified: Fri, 09 Apr 2021 18:36:37 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3678bb709bd54ca372ae0afdda5b7c551ebbf2e55cb61ced06f845c1c4da2578`  
		Last Modified: Fri, 09 Apr 2021 18:36:36 GMT  
		Size: 2.1 KB (2061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:68d5fe8922a5fa663595be6a1fdcb778fe6ba081559dbc7391de77639a10c8e6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.5 MB (279511630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:683a103cc607ad0cc44dcf77c5865020bbbbbd91f3d16e69dde54496057ca13d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 09 Apr 2021 18:46:31 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Fri, 09 Apr 2021 18:48:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Apr 2021 18:48:44 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 09 Apr 2021 18:48:47 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Fri, 09 Apr 2021 18:48:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 09 Apr 2021 18:48:57 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:67f6c32a71b4f1e541b3794788832b9f4893d630ddfafae92711e92c5afc0090`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57568527db08667f771d0c2306195a58bde69012cf0cb09bc47ceedaf9a088db`  
		Last Modified: Fri, 09 Apr 2021 19:59:54 GMT  
		Size: 103.6 MB (103561819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47ed52e3d52de963a21c971137a941f86d7023cc3320cdafe83b0abc3bf59321`  
		Last Modified: Fri, 09 Apr 2021 19:57:25 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ea1ec6e721e15e0fba37181d58971410c1125d2c9ceb4283f8f07832c8dec91`  
		Last Modified: Fri, 09 Apr 2021 19:57:25 GMT  
...
```console
$ docker pull nextcloud@sha256:8e0141213bbf8e4647233148bb0a1e4d3e883dd689a133f8bb73b2e1fa00a1b7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.1 MB (252061765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:430c303aeae24386bbb308bd0030c56b7cc94ecb3b3550419fb20c81aad429cd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 10 Apr 2021 13:42:47 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Sat, 10 Apr 2021 13:43:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 13:44:06 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 10 Apr 2021 13:44:08 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 10 Apr 2021 13:44:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 13:44:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f0ddb3fdc89ecf32fd27ba76105efc9c03dd8faabf8b396f5b4a70b7c48bdeaa`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48eaf03f50c5d9c9f601168a0841fad55bd60365853b38f7ee737b2dc5d27bce`  
		Last Modified: Sat, 10 Apr 2021 13:58:30 GMT  
		Size: 103.6 MB (103556708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ba4cef7fd9fd6d9bb49998cb81fbc7853391637582401746a6089096ecf5479`  
		Last Modified: Sat, 10 Apr 2021 13:58:17 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9632c573ffe85848d565600b287eb7a826f4ae36066ce6405dc57008b569da0`  
		Last Modified: Sat, 10 Apr 2021 13:58:17 GMT  
		Size: 2.1 KB (2059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
