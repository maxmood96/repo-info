...
```console
$ docker pull nextcloud@sha256:4e201c48bbda31b7a053a5784fa590c99bb79cc6fa972d470d64557884209eb6
```
...
```console
$ docker pull nextcloud@sha256:7bfb8549a4c3e8fa19b770794f924dfb8ce0c60be9c1b60cefb504564eeadebe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.9 MB (267917430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7be8a15fe9eaf8d32855dbbc312261fc0b9acbe9426b39ab8e9701b31176941a`
...
-	Layers:
	...
	-	`sha256:48c7febd31c5552ea9b23423b9f9c44d05e05bd366ca65a67a5416f80f5fc306`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8aa721a69d4f1451af03ba83f60b8c8ee9d6f70ae2e97b6e49a92320f279776`  
		Last Modified: Sun, 11 Apr 2021 05:50:43 GMT  
		Size: 103.6 MB (103558684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1595b7f0f629e8809179776083acab7626d3421884352d3b2907350adb4ba9de`  
		Last Modified: Sun, 11 Apr 2021 05:50:28 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d12bc17b5f12c91f10d472d7f6965dadbb6e60608e7bb5fe12b33de7e9092faa`  
		Last Modified: Sun, 11 Apr 2021 05:50:28 GMT  
...
```console
$ docker pull nextcloud@sha256:23ef37040c8dcefd44912a1014d5930960065ee3991ecec15e82d8adc698749e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.9 MB (240865197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f27216be7532ff1b3716dd8615e3bfdbf15db956821f15a24a2c49b55d4f1fb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sun, 11 Apr 2021 02:44:45 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Sun, 11 Apr 2021 02:45:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:45:53 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sun, 11 Apr 2021 02:45:58 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sun, 11 Apr 2021 02:45:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 11 Apr 2021 02:46:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a33f2010b80c0dafbcdb0f25edfd0076f718d779c8723f86821d3ff7bb4e8e77`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b8d3fa80f50da6437289ee5fafb80906169b35558ae09a7a7ec228efc33ac4b`  
		Last Modified: Sun, 11 Apr 2021 03:01:57 GMT  
		Size: 103.6 MB (103556350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78d2497bc76a8442f6d262e63bd41c0cab6682b9ec4170fa89c4df370f145d6f`  
		Last Modified: Sun, 11 Apr 2021 03:01:20 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb5779f91c94017cbc41959074771d570f71a70d06a0f7cce265a53ac5be1439`  
		Last Modified: Sun, 11 Apr 2021 03:01:20 GMT  
...
```console
$ docker pull nextcloud@sha256:e55f1d6e4aac991c5ad1a40a3aaf201189f320dfea2bd1bcf8e13eb4abd7b35f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.4 MB (258351173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65eab750f41f658831aa619cee15d3f67f03a3f707374af14fe812daa353cae3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=19.0.10
# Sun, 11 Apr 2021 02:21:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:21:22 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sun, 11 Apr 2021 02:21:26 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sun, 11 Apr 2021 02:21:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 11 Apr 2021 02:21:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:91388d313ae060be464ef3bf7166e4528a7b8df12263a0be32cf93485f4e46ea`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1a97b6b360ef2b860f9036026c2f1408e2d9976a5802947b23891e780df414d`  
		Last Modified: Sun, 11 Apr 2021 02:37:10 GMT  
		Size: 103.6 MB (103557900 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ade4b4068cb41c935d54f5bd2d363f11076382335aa66a63cddf831988fbfec3`  
		Last Modified: Sun, 11 Apr 2021 02:36:44 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b5a667e4d092b59c4a57da8a4745f7228f9b02fe44064e4426cb9d53ccd64a6`  
		Last Modified: Sun, 11 Apr 2021 02:36:44 GMT  
...
```console
$ docker pull nextcloud@sha256:0b529c533d5a3b96bf0670407931921ecba77f8c2ad9ff0ae00de7bd7d4e4d38
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.5 MB (279508566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00445d812ea01f5d11094a2f8b2738f31eca2b7660c63ea7ce9806a2164d25ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sun, 11 Apr 2021 02:24:09 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Sun, 11 Apr 2021 02:26:40 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:26:53 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sun, 11 Apr 2021 02:26:58 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sun, 11 Apr 2021 02:27:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:9eb8c1675181e237320b38d97d30757caa8d8f4eb74d6b83fb4948aac6eefcf7`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f4664bb8dde09c48620fa6f650ab939956b4c519b011a8811fe8d868f394c55`  
		Last Modified: Sun, 11 Apr 2021 03:05:15 GMT  
		Size: 103.6 MB (103561028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca0e03ca8f4742739f4d3db7a003c6bb0c1d1a64c9b1efd940fc21844f1a0285`  
		Last Modified: Sun, 11 Apr 2021 03:03:18 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5a303e20472f1f44e036f3dbe8c0226f77790b68807999b300993df68fd01a7`  
