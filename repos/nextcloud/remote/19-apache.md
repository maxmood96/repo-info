...
```console
$ docker pull nextcloud@sha256:6eee4bf181e610dc0b1b2c596f86ae4b4ed4f541077b70d2d8fd68fb41336294
```
...
```console
$ docker pull nextcloud@sha256:c81cfebaf617107f9536caa966c6fd3bd67e44d74e083f1718e01074679fb6d6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.1 MB (244081329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53dbe6d97cb31b24f04755d926792ccb37b9a6fb0e2eded33bbcc0b4daad1433`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Nov 2020 21:37:42 GMT
ENV NEXTCLOUD_VERSION=19.0.5
# Thu, 19 Nov 2020 21:38:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Nov 2020 21:38:48 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 19 Nov 2020 21:38:52 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Thu, 19 Nov 2020 21:38:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Nov 2020 21:38:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d36da94a358bad976230cf23bf740c11719f39fc6a754451494c9179dff9fe4d`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f33cadd08cf3e60dde3be9d0dce8e7e7fba693913a2c0686383ede5300827524`  
		Last Modified: Thu, 19 Nov 2020 21:49:53 GMT  
		Size: 106.1 MB (106139935 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2739500a39b3dcce35c41575b18974f52549fcad29a609594a863c6785a2da89`  
		Last Modified: Thu, 19 Nov 2020 21:49:20 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e510e1e4fc1c30bd99e35a70a440f092bd99dc60db7867b2bf643356296a6da`  
		Last Modified: Thu, 19 Nov 2020 21:49:20 GMT  
...
```console
$ docker pull nextcloud@sha256:91761062328fc440169d2310888152c5ab113f8eed7ee2c91112374ad2c1e8f9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.5 MB (261544259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f756d0f43f01800742e02f6cd6c94273635b5ef9a9c717b7b190cad7bc5d253`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Nov 2020 20:49:53 GMT
ENV NEXTCLOUD_VERSION=19.0.5
# Thu, 19 Nov 2020 20:52:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Nov 2020 20:52:22 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 19 Nov 2020 20:52:32 GMT
COPY multi:46df3f6af0ed805f05cfc0de076c4755b38d2fb433df089c1b82ca8366c2d882 in /usr/src/nextcloud/config/ 
# Thu, 19 Nov 2020 20:52:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Nov 2020 20:52:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d9677ef95010b2b71178fe02a4875f1565bef28138b6c4a5899c05c96ed5773f`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04f401d40b1d64f3059fc39f117d868bb557879f77a497c00867eccfaf45f9d1`  
		Last Modified: Thu, 19 Nov 2020 21:08:09 GMT  
		Size: 106.1 MB (106141410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5e610692ea98f23d586416a23dcdb090e9c07475c95869505c978a6edfc9349`  
		Last Modified: Thu, 19 Nov 2020 21:07:39 GMT  
		Size: 2.5 KB (2521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:217f90fbf9df609cacdac8fa174840390ff9848765931b72bb922bd6dad602d8`  
		Last Modified: Thu, 19 Nov 2020 21:07:38 GMT  
