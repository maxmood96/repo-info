...
```console
$ docker pull nextcloud@sha256:4231670e36bd8b2b131040006f2a4cc8e67a477ba6c4da294c90f946c6879c45
```
...
```console
$ docker pull nextcloud@sha256:f3e255c331a27b38211741ecba93972639f1ec765c43107af02d9fdd2ab00339
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.4 MB (255393647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8b080fc5875414f7fd68b6c9f8faca4550b907cea611834b7ac6da42821a3cf`
...
-	Layers:
	...
	-	`sha256:fd045ebb84970156c74f9fadfeb099bf1a403de43be3811c8d27d1c2f49612a0`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6c9781570f2a845ae20a5f8934afde64e652e7f62d95f8c0bb741b946b0f0d1`  
		Last Modified: Thu, 01 Apr 2021 07:40:23 GMT  
		Size: 90.3 MB (90328883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ca91a80e99482ceca780a68928296e1f6d9d6fb46d175fd145dba5413b3c815`  
		Last Modified: Thu, 01 Apr 2021 07:40:03 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1338902d6293bf5903418b1de518b16cafac57e27ef1d722f4890571c085df91`  
		Last Modified: Thu, 01 Apr 2021 07:40:03 GMT  
...
```console
$ docker pull nextcloud@sha256:4e64fb32681dc6472fc645d62861728bb32a187b4ffccef82ec5a77e5fe4e678
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.7 MB (228707945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec4836c8aec74520e32abbadab366c0d19ce19bb21e8f9ddda5f3e85d296e685`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 01 Apr 2021 02:33:58 GMT
ENV NEXTCLOUD_VERSION=19.0.9
# Thu, 01 Apr 2021 02:35:04 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 01 Apr 2021 02:35:11 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 02:35:16 GMT
COPY multi:8fe33713160eb79aae18ddf12940fb599bff4e4514085aecc68afa3935aec08e in /usr/src/nextcloud/config/ 
# Thu, 01 Apr 2021 02:35:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 02:35:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:aeaab4484737fd01140852c781152b542e0f086b59e453f98a1cc6fd3e07e58f`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5951d96ad34a1ae21649d95ff02b15735f320f19a80447207e09d85aa77fef40`  
		Last Modified: Thu, 01 Apr 2021 02:50:31 GMT  
		Size: 90.3 MB (90327057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0c2b37bd7430c945f5f12b70cc096636477d268bef33f4bc2a194c4b83d083f`  
		Last Modified: Thu, 01 Apr 2021 02:50:01 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f6f0c6231488d0a12602259cc8bf4b0760805ff113eeb4e66565cc295c3f9a6`  
		Last Modified: Thu, 01 Apr 2021 02:49:58 GMT  
...
```console
$ docker pull nextcloud@sha256:d73d7e7a8f2f71084de9c30da99724313f632918eff6b90d7ecb905d5b39dbee
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.2 MB (246244674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a38e91e93965abd6aeaeb7b8493908703c4afd69338a2ce6a62d3955b72e296`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=19.0.9
# Thu, 01 Apr 2021 07:30:21 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 01 Apr 2021 07:30:30 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 01 Apr 2021 07:30:34 GMT
COPY multi:8fe33713160eb79aae18ddf12940fb599bff4e4514085aecc68afa3935aec08e in /usr/src/nextcloud/config/ 
# Thu, 01 Apr 2021 07:30:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 07:30:37 GMT
...
-	Layers:
	...
	-	`sha256:fd37bacd24c3508c717cab0ba941b93d438f06cb5608f005d23c092dcc48d73d`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33255ac60631502effc53fefa00b52e6fa400f5661cbedea0b465d0536f56cf9`  
		Last Modified: Thu, 01 Apr 2021 07:44:11 GMT  
		Size: 90.3 MB (90328276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:537714a84909064d4601186b9827183b1011c2f82cf48ede745491bcaec683a2`  
		Last Modified: Thu, 01 Apr 2021 07:43:47 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cd031fb44422b2856df91b4b55c19f525cc6c58659712f8fc7bc9f8985ead8a`  
		Last Modified: Thu, 01 Apr 2021 07:43:47 GMT  
...
```console
$ docker pull nextcloud@sha256:82dca22ab15bd8eca06878e9826deac6b56575a462b8bd988cfdc3ae0338deb4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261188705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8aa0e2e77fdf1c3ae52873b5d0d487ef987cf216eb33978ff877798674d9bfb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 31 Mar 2021 16:37:57 GMT
ENV NEXTCLOUD_VERSION=19.0.9
# Wed, 31 Mar 2021 16:38:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 31 Mar 2021 16:38:36 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Wed, 31 Mar 2021 16:38:37 GMT
COPY multi:8fe33713160eb79aae18ddf12940fb599bff4e4514085aecc68afa3935aec08e in /usr/src/nextcloud/config/ 
# Wed, 31 Mar 2021 16:38:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 31 Mar 2021 16:38:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1413730a2db1ee197f4f44f1effde4e3ea92e4f82fad43ef1019fce71506edab`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:307a94e82117b211f71fd8ca6c712c7522fbe654797cf03222d5213756aeff67`  
		Last Modified: Wed, 31 Mar 2021 16:48:46 GMT  
		Size: 90.3 MB (90328423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39506716c2b541995a39d564d569f8dd4af67137acf03dc12e68ff4871626f7c`  
		Last Modified: Wed, 31 Mar 2021 16:48:27 GMT  
		Size: 2.5 KB (2530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15d98cd43b98eb3bc9e0f7134e9a7cfbf57c2f250b8299774e4d6a0ad6ee81c8`  
		Last Modified: Wed, 31 Mar 2021 16:48:27 GMT  
...
```console
$ docker pull nextcloud@sha256:61bd6b19b10a5d86037cadcff8fbd0a6d1584e368ff7167d85c7fe9b05aecdea
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **236.9 MB (236936437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f45ddf7cc13ae8a75a7ac31b9be4564e701a8d5fcb0bd7a69e59a7c26210edd5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 31 Mar 2021 15:39:02 GMT
ENV NEXTCLOUD_VERSION=19.0.9
# Wed, 31 Mar 2021 15:40:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 31 Mar 2021 15:40:34 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Wed, 31 Mar 2021 15:40:35 GMT
COPY multi:8fe33713160eb79aae18ddf12940fb599bff4e4514085aecc68afa3935aec08e in /usr/src/nextcloud/config/ 
# Wed, 31 Mar 2021 15:40:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 31 Mar 2021 15:40:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e024c6acc0ec03b80c090bc3332d0e07b605d70cea7703266e5dfa6fa5c13462`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f136bae41154b1b2a889825b3d8b6a4f7a4439a2d77fbf02eec9c77d65c4300`  
		Last Modified: Wed, 31 Mar 2021 16:00:32 GMT  
		Size: 90.3 MB (90326749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0153e4fcba24cbb1597c1ce7ec06acce06b6a0caf8fc215b511d734837da5180`  
		Last Modified: Wed, 31 Mar 2021 15:59:24 GMT  
		Size: 2.5 KB (2531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28e93fb07ed75767e6951ac3d296a3af88e01065b35947f0afa7c22ffdf26d2e`  
		Last Modified: Wed, 31 Mar 2021 15:59:24 GMT  
