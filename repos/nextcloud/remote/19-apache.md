...
```console
$ docker pull nextcloud@sha256:4fd5824b127743bf9ce1b9cd815fe4b247e1a17ef664b692edb650c2154ab423
```
...
```console
$ docker pull nextcloud@sha256:d919b5d48e46e769eb31674cedf2cd5f13a8cb2623347407c76969fd569cda19
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.7 MB (244737312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ead1f46e2c2cc1b58613b36bef6b1cd78dc1f4cc11d3215d2cefef6ae6530f5b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=19.0.10
# Sat, 10 Apr 2021 16:21:46 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 16:21:56 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 10 Apr 2021 16:22:07 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 10 Apr 2021 16:22:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 16:22:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d03e76d6590b20e31cac2988010f0535e1359aa753f7b7c6e220a2e8ce304b50`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94f3db691a86017aa5c64535715622f2d8d9cdb1e209f970ba4d390426fbb8c9`  
		Last Modified: Sat, 10 Apr 2021 16:41:03 GMT  
		Size: 103.6 MB (103556308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9fa7ac84bd035db3326889f0f42cd9e6bc6af3c5b24d637e2a203e1767be957`  
		Last Modified: Sat, 10 Apr 2021 16:40:30 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ded49886f3ff37c07b9ae5a351c566c4dddea31c454aef29afde996e7ab10c4e`  
		Last Modified: Sat, 10 Apr 2021 16:40:29 GMT  
...
```console
$ docker pull nextcloud@sha256:d6182af146b41336e955a969b067a5df44de0564aab4bca77e99427042e6a92b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.3 MB (273254850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec63b786c9a5f3d25421cf00aca43d9b616ff794be88bf1bc09c493185331d08`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 10 Apr 2021 13:34:39 GMT
CMD ["apache2-foreground"]
# Sat, 10 Apr 2021 21:01:59 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 10 Apr 2021 21:02:00 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 10 Apr 2021 21:02:00 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 10 Apr 2021 21:07:13 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 21:07:15 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 10 Apr 2021 21:07:15 GMT
VOLUME [/var/www/html]
# Sat, 10 Apr 2021 21:07:18 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 10 Apr 2021 21:07:18 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Sat, 10 Apr 2021 21:08:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 21:08:21 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 10 Apr 2021 21:08:24 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 10 Apr 2021 21:08:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 21:08:24 GMT
...
-	Layers:
	...
	-	`sha256:136e53910d10940cf32f7679556c031a70a01fdbb2dd89b9f30df4ff9a83bb79`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de3740d4ca14d157d97e3ca0d7e59d99501d17debeb3c7ae18d0203fca9a59b1`  
		Last Modified: Sat, 10 Apr 2021 21:26:03 GMT  
		Size: 1.7 MB (1683587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41ffd13de3a55bdff9af3da06a777cd41364c498f5510912798d534c3c21c975`  
		Last Modified: Sat, 10 Apr 2021 21:26:10 GMT  
		Size: 15.0 MB (15027493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c2c93a5b684ad09f29315f7b6fe52334d1933b4d88937aee658ef5c4889490b`  
		Last Modified: Sat, 10 Apr 2021 21:26:00 GMT  
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b21694cb5e82391eda7745ceafb6947b58a7ebb6587be3126eb2c059ea2151d6`  
		Last Modified: Sat, 10 Apr 2021 21:26:00 GMT  
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a4cfe3ab50f1302fd32c5c7b55a88aa3a48469f3c96f17b9ef0edd3cb80c0b`  
		Last Modified: Sat, 10 Apr 2021 21:26:35 GMT  
		Size: 103.6 MB (103558031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c56801148c40c8692b6b60110876a73e4a8dfe142cae72405a8650d7f1527df`  
		Last Modified: Sat, 10 Apr 2021 21:26:00 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c59011064c4802b253f200f3ddeec5dec2d0a5059d4ee006ec17c6ca823214e`  
		Last Modified: Sat, 10 Apr 2021 21:26:00 GMT  
...
```console
$ docker pull nextcloud@sha256:98bbc6fb5f0488b87f77de9dc3779b897ae772f3c6abcd0e9bc8441bfbe2ca87
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.1 MB (249052782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f5e7eeee2b8caf10b482ef2387d26c326c0b52d0e7c2e683e2eee78bb33c937`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 10 Apr 2021 17:48:16 GMT
ENV NEXTCLOUD_VERSION=19.0.10
# Sat, 10 Apr 2021 17:49:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 17:49:50 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
...
-	Layers:
	...
	-	`sha256:6385d15f5be1f2842e2fa424bffcb7ee93abcb4949a0624ad4c62e19cdc75001`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82d43e614ed275f6cf22ce64dfc7250cdd9fe1fdb7f18004f7b7dee27a056606`  
		Last Modified: Sat, 10 Apr 2021 18:09:52 GMT  
		Size: 103.6 MB (103556237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c838dee35f658963645ea5912ee06de150d638a835290d9c56083e4c5549a411`  
		Last Modified: Sat, 10 Apr 2021 18:08:42 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3e691098236f6f1218af997ab34694f798f1c9b23b7603a3f891336bb9aa9af`  
		Last Modified: Sat, 10 Apr 2021 18:08:42 GMT  
