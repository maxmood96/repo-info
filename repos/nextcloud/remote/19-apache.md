...
```console
$ docker pull nextcloud@sha256:bf38b8335aff719b116860c4992ed48b3d8841e3718dff739885c91870bbe5c4
```
...
```console
$ docker pull nextcloud@sha256:35e8de409f1365346ff0f816a0c0b011a770b92c575e53fc733ce995f093fdf7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.1 MB (255106522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1960d163bfedc2d516542abb3e33babe8f24651661ec7cd4302dd10a8f8014b8`
...
-	Layers:
	...
	-	`sha256:4a826539f3e25208bb1a3d24f15cb1500821ab5b2163081c0c9063e800b18e61`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ae18563de82bc523b8eb7983ae5574dc47f2c09fb00ab2a602e35cff59a5639`  
		Last Modified: Fri, 22 Jan 2021 00:04:34 GMT  
		Size: 90.1 MB (90118375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05202f789659193ffbfe667ddd51075b14b800159931a9ece308c299509e6b85`  
		Last Modified: Fri, 22 Jan 2021 00:04:11 GMT  
		Size: 2.5 KB (2531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89d215385701bc9f7ca27fa737994a77eb81543d5cb64c0189f9ec79aedc3e2c`  
		Last Modified: Fri, 22 Jan 2021 00:04:10 GMT  
...
```console
$ docker pull nextcloud@sha256:23c12d005b776234bd0b75377da2e293edac434f593457e28aa5b1d1fc84e408
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.1 MB (228081706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44a9dc917b9d79c7262ad8adcd3f0e529f474080c5ef5c1593fd63b525e86375`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 21 Jan 2021 23:24:59 GMT
ENV NEXTCLOUD_VERSION=19.0.7
# Thu, 21 Jan 2021 23:25:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:26:10 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Thu, 21 Jan 2021 23:26:13 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Thu, 21 Jan 2021 23:26:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Jan 2021 23:26:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fde482c97d0a747456c20931be92d9c82e9f750fcf50b0ce02646b2ef0383b46`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55fd99beda2026cf52711b6403304c9dcb89d764509b7e4a16b886abf478a1cb`  
		Last Modified: Thu, 21 Jan 2021 23:50:07 GMT  
		Size: 90.1 MB (90116858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6db5948c46725f3112342a8552c3addbc03170a908fb69365fc708092c65f690`  
		Last Modified: Thu, 21 Jan 2021 23:49:34 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c92a07fb18dc41aad56463d6072a4faab93c120cd39979a21fc253589c699538`  
		Last Modified: Thu, 21 Jan 2021 23:49:36 GMT  
...
```console
$ docker pull nextcloud@sha256:1ac9c64a57f9654f898c6e17b42469dfe297879a878a2b78f796212d4189acba
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.5 MB (245549254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3c3edc7fcdc6e721d75bb927c682fd99f1dfe5c310d93734d1e22343fc66284`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 22 Jan 2021 00:25:07 GMT
ENV NEXTCLOUD_VERSION=19.0.7
# Fri, 22 Jan 2021 00:25:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 00:25:54 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Fri, 22 Jan 2021 00:25:58 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Fri, 22 Jan 2021 00:25:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Jan 2021 00:25:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:10137165d72c7f94d7c7ad534ec4ee1ec8c05d189924a0cb0185189522e74deb`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec79173f7694c4421837a95f16b5d99f49a79b6825649cca945147874a1794e6`  
		Last Modified: Fri, 22 Jan 2021 00:46:28 GMT  
		Size: 90.1 MB (90118091 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:248629917ef1ebd9211d7354d7183ca5b2f53a43eaa5dcc5bca4b071ce602152`  
		Last Modified: Fri, 22 Jan 2021 00:46:04 GMT  
		Size: 2.5 KB (2530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:028a2d0497fa4ba7b078fd4ac6d87510f7421f3f6d6d9d99d1de85fa4be53593`  
		Last Modified: Fri, 22 Jan 2021 00:46:04 GMT  
		Size: 2.0 KB (1958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
