...
```console
$ docker pull nextcloud@sha256:8a02a16577fb3bb5a32a567374d2242e8dc7491a614879d112251504192e973e
```
...
```console
$ docker pull nextcloud@sha256:0d9ed9cd0aea721eb2c1cf14d4a11b103f1ecb7cde7566946f93aebdb565c40a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.8 MB (290778195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81f54e9c8c78b35c76dbba6ee1ef37fa307fee72aef597079288bbac397ce748`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 13 Nov 2021 11:57:09 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 11:58:38 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 13 Nov 2021 11:58:42 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 11:58:44 GMT
COPY multi:f5bf72b2753669604b49ffdbd465aed9c49b21bdbd491f0b0d1cff5d5260de8c in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 11:58:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 11:58:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ce9e0034dbcfa439696bccc57f59af47f53338b4d8f8983f068103b944ef1340`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac615d1edbc17e8735916761f8c504364038cae0afb020af4531247e7ae99129`  
		Last Modified: Sat, 13 Nov 2021 12:22:42 GMT  
		Size: 138.5 MB (138462793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae44893097c2001010271add25a33f71ffb7d5f0bd87cd70b131d104e3f1aaf3`  
		Last Modified: Sat, 13 Nov 2021 12:21:12 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7188482a9341c6bfda2e4936da98b8d83935d44e723ac75c78a01a480a585913`  
		Last Modified: Sat, 13 Nov 2021 12:21:12 GMT  
...
```console
$ docker pull nextcloud@sha256:4540af4bdd282c7152a7c92c01c80bb99ae13de1f5ecd631b4fe327a2ed2a4c9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.7 MB (314667483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afdba46c337c87f6915a5d2428b7d9072ab377fc6605d8793d06516254d99f35`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 13 Nov 2021 11:50:16 GMT
ENV NEXTCLOUD_VERSION=21.0.6
# Sat, 13 Nov 2021 11:53:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 13 Nov 2021 11:53:06 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 13 Nov 2021 11:53:08 GMT
COPY multi:f5bf72b2753669604b49ffdbd465aed9c49b21bdbd491f0b0d1cff5d5260de8c in /usr/src/nextcloud/config/ 
# Sat, 13 Nov 2021 11:53:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Nov 2021 11:53:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:63e795c8f6bfbcec3c4234405baae3c96d152b1d4721ba1f7daa860ada3b11b5`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a34194fc04a358fd61e8dd0138951493b720b03ba20df51ce9ef09933909dcfe`  
		Last Modified: Sat, 13 Nov 2021 12:14:39 GMT  
		Size: 138.2 MB (138225555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a07d571a3610c391871aed2bf3cf0fe080d2bab16bad09906dfc59777e2752a3`  
		Last Modified: Sat, 13 Nov 2021 12:14:21 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46e0bf93f53c363d7b1122796382242a1d2e2dc588af267157c08f81ee934808`  
		Last Modified: Sat, 13 Nov 2021 12:14:20 GMT  
		Size: 2.1 KB (2116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
