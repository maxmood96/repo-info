...
```console
$ docker pull nextcloud@sha256:f7305e6af45106980aea2ba03abf5356ce360e4a1e70fef13f112a7a6d938b0a
```
...
```console
$ docker pull nextcloud@sha256:b57611d12d5ae425d7fd934618505c403f440f46d08ab4d8e33553640e22ba0a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.8 MB (309763744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ac3a4801ae008f692fa63edf141b52f3c4020876e86918d778d7e481b0bd72f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 10 Apr 2021 21:20:00 GMT
ENV NEXTCLOUD_VERSION=21.0.1
# Sat, 10 Apr 2021 21:21:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 21:21:18 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 10 Apr 2021 21:21:21 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 10 Apr 2021 21:21:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 21:21:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b21694cb5e82391eda7745ceafb6947b58a7ebb6587be3126eb2c059ea2151d6`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3acb42abe68babb1886772dbc92cb7b2e90b6fd2109e3dab657ac0921cab4384`  
		Last Modified: Sat, 10 Apr 2021 21:31:40 GMT  
		Size: 140.1 MB (140066924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47e7a9181954a2b0bc08041d063511b5a0cb5ee90303f26addb206f84b54bd44`  
		Last Modified: Sat, 10 Apr 2021 21:31:11 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:621fe3b863bd18ebd987358643eac320123d34ec1596490bea0b6a52c4fbf542`  
		Last Modified: Sat, 10 Apr 2021 21:31:11 GMT  
...
```console
$ docker pull nextcloud@sha256:22d1e413d52f8f524a4b7efdfcdb9658037db40290353d927bb98c4ab4dcf93f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **285.6 MB (285562157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4889ede941c7236c95a0b7da08fbf15e8b1f77a6940a94b80f207974346ab7c4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 10 Apr 2021 18:03:51 GMT
ENV NEXTCLOUD_VERSION=21.0.1
# Sat, 10 Apr 2021 18:05:46 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 18:05:49 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Sat, 10 Apr 2021 18:05:51 GMT
COPY multi:bb22a87f07ec65f9db22db69c1e13d98d1b6e10d12cf7747d547023b06cd53c6 in /usr/src/nextcloud/config/ 
# Sat, 10 Apr 2021 18:05:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 18:05:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6385d15f5be1f2842e2fa424bffcb7ee93abcb4949a0624ad4c62e19cdc75001`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:677cb0f68a9dec92c594baf450c5db850db9c1a6b346e99c87adcef1e16a2f32`  
		Last Modified: Sat, 10 Apr 2021 18:17:14 GMT  
		Size: 140.1 MB (140065612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbb44e7f5df0c1f10570521dc14bc1f380380d712582bd9bf9737f1a7e08fd55`  
		Last Modified: Sat, 10 Apr 2021 18:15:45 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:169c862d85365f0c0ba778a6840dfff013d9e7c1aec9317c4a280926723b635b`  
		Last Modified: Sat, 10 Apr 2021 18:15:45 GMT  
		Size: 2.1 KB (2061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
