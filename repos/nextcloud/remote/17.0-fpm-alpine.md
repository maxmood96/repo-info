...
```console
$ docker pull nextcloud@sha256:11159ce8548239e085b94cce2dc1b2128cd2c6a1bc5bf1ed84192131c53ffd2a
```
...
```console
$ docker pull nextcloud@sha256:c8396f44cfdf220c50988de771b1082cea096e3d2dc4259134c96d0d7588e541
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.6 MB (128579495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:593aafe761d1c8cd92aed89302ca3ab18c46fb744f1ea1eaeee7da2b5ba6e2ec`
...
-	Layers:
	...
	-	`sha256:3e55056f435969e1593a43ec31b6389526d84f15638605b07bc339c3f0431b02`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90b6d8c5bee567031020465dc49a2a9d7d645cde37afe651b187080197f151b3`  
		Last Modified: Sat, 18 Jan 2020 05:41:00 GMT  
		Size: 315.8 KB (315806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac3fc577adef66dab8ce3ec16651b9a8634bd1e42785fe1dd44f2c68a8e7482d`  
		Last Modified: Sat, 18 Jan 2020 05:41:04 GMT  
		Size: 25.7 MB (25653313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b369d9bcc9a36ee4a601aaa27e293005a97dde8f1748933fd40deea7db2a9dce`  
		Last Modified: Sat, 18 Jan 2020 05:40:59 GMT  
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:269e521f9234d1f85ee04f1ca137cf986f12d8b28b33644502483ff357a491de`  
		Last Modified: Sat, 18 Jan 2020 05:41:14 GMT  
		Size: 71.3 MB (71346939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37a0a9cd8832759348a306eac3b9e1b20dca7f8fddee3f3ff0e19e9d06aad7e0`  
		Last Modified: Sat, 18 Jan 2020 05:40:59 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e578e7d7cc25e861ad3155161b99d3ecbbd6f5debd8b03a9e6911787c81d68`  
		Last Modified: Sat, 18 Jan 2020 05:40:59 GMT  
...
```console
$ docker pull nextcloud@sha256:e673924ea0aa8ef76a3a88e6f1bfeb6bc25bb996acdbd96ca4bf444b1f4a9eb7
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.5 MB (126524005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1769fd043b584a17a0e61c5e9f5c1dfe6fde4ac716bdeddf6bdb3a7105e7c335`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 07:10:23 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 18 Jan 2020 07:14:04 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 18 Jan 2020 07:14:15 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 18 Jan 2020 07:14:16 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 07:14:18 GMT
ENV NEXTCLOUD_VERSION=17.0.2
# Sat, 18 Jan 2020 07:15:06 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 18 Jan 2020 07:15:14 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 18 Jan 2020 07:15:16 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Sat, 18 Jan 2020 07:15:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:058b9eb62675557d4c1f20e1afdd2c299716e7680ffb62b554714845bfba082a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b3b4dba90d509118a316c8b9dcd091917a51ebc88cc1899138699e4a266a42`  
		Last Modified: Sat, 18 Jan 2020 07:17:52 GMT  
		Size: 324.2 KB (324170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77e283024b4f588d899fda37a8b131005e6a3d0698a46e04955837ad43e212e8`  
		Last Modified: Sat, 18 Jan 2020 07:17:58 GMT  
		Size: 24.8 MB (24849061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:565334c7d1f374e5c237a1e017f399e274c3203059a56abc9e4844041e13ce6f`  
		Last Modified: Sat, 18 Jan 2020 07:17:51 GMT  
		Size: 533.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cc4cb5647d33855c61db560546d5b00810ba196e3e8d5b9b41410e0c213154d`  
		Last Modified: Sat, 18 Jan 2020 07:18:19 GMT  
		Size: 71.3 MB (71344764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981c393b80a52a4edf7d3c53f9e44a925fe6fe4491af3f48c12b0d22b8538cf4`  
		Last Modified: Sat, 18 Jan 2020 07:17:51 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c96f34abfd113a5335c160a8087e7eb4021a4137974038d937cef14cd4432af3`  
		Last Modified: Sat, 18 Jan 2020 07:17:51 GMT  
		Size: 1.1 KB (1119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:873d019c2c30ac469ec78567d7c2f7d391551b34892946cf537c5251dae0ab57
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.7 MB (124690582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4569456c940f73927888222a8db7dd3ab660ac6904bf82a0d21008a85168bcd7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 08:09:01 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 18 Jan 2020 08:12:25 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 18 Jan 2020 08:12:30 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 18 Jan 2020 08:12:31 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 08:12:34 GMT
ENV NEXTCLOUD_VERSION=17.0.2
# Sat, 18 Jan 2020 08:13:13 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 18 Jan 2020 08:13:19 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 18 Jan 2020 08:13:21 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Sat, 18 Jan 2020 08:13:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 08:13:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c2120addeaf6498aca9c6d902d8e0b31257c9f9386a8e1c044d39fad8c6de8cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fbcb912810ccfe5f1175bae9337398174e5472bcbc5e46a01bfc23d72a0819c`  
		Last Modified: Sat, 18 Jan 2020 08:16:33 GMT  
		Size: 299.0 KB (298969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d6e2f41969cb04dcd12266b3f9c489e83897679ad3c0130eb23475679cefc7f`  
		Last Modified: Sat, 18 Jan 2020 08:16:38 GMT  
		Size: 24.2 MB (24198328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e48ebe32cfafc6ae8df9bb44c9f4a167b5da40afc41206c90d0fefe8362aeea2`  
		Last Modified: Sat, 18 Jan 2020 08:16:31 GMT  
		Size: 527.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a317965eb43329a138d55201ace86b56869357bf21670f65aa84c1c5092dfa2`  
		Last Modified: Sat, 18 Jan 2020 08:16:56 GMT  
		Size: 71.3 MB (71344794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49ae7f439f6e9600f0e0b1d27f0c790576da757a372bd4ad35a8060e63c774d5`  
		Last Modified: Sat, 18 Jan 2020 08:16:31 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1933acc9bc9f7bd59ebee88084ce271bd9b1a57b821e7a7661cca0bb96f7894b`  
		Last Modified: Sat, 18 Jan 2020 08:16:31 GMT  
		Size: 1.1 KB (1119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:4aac5f01ec06afdb47eabb7852d45a46062053c1da518fb23dadbe73e451a4f7
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.1 MB (128062908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e4e29d5590886e6da3446a95367fc4c1b7d6d7f7a05c6993266734945215bae`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 06:41:52 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 18 Jan 2020 06:46:24 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 18 Jan 2020 06:46:30 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 18 Jan 2020 06:46:32 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 06:46:34 GMT
ENV NEXTCLOUD_VERSION=17.0.2
# Sat, 18 Jan 2020 06:47:04 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 18 Jan 2020 06:47:12 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 18 Jan 2020 06:47:15 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Sat, 18 Jan 2020 06:47:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 06:47:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:36c3082026c709c32df5d328f3e14a69abbd1e1a2a3dfffbe4a7a0570d4e3c36`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57851c111e41cf8ea39c5330f405d097bbc0dd18ba9e20c314f1374987c22ddb`  
		Last Modified: Sat, 18 Jan 2020 06:51:14 GMT  
		Size: 324.9 KB (324947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88c46373a7dd7c6fde675976137ed593c700453ac19a0e6a7dca3084bda322a3`  
		Last Modified: Sat, 18 Jan 2020 06:51:17 GMT  
		Size: 25.5 MB (25475182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe9ecf9534c02f77d5eeef60763ddc3b93fef57f1df4cd36243a64627ceea7e3`  
		Last Modified: Sat, 18 Jan 2020 06:51:12 GMT  
		Size: 525.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4825a7c6a5d4aef52124b66c8dfc6ef821d53098446a2f299a1dde6bff16923f`  
		Last Modified: Sat, 18 Jan 2020 06:51:31 GMT  
		Size: 71.3 MB (71344646 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a666e7ea3a7fcba2c8cd517e73b3173cd8f92f49e9f54d5535483ef1a57ac74`  
		Last Modified: Sat, 18 Jan 2020 06:51:12 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aab82554ef2470342dd9081d264f0f7637adba035d95fcc47e948dd0f4d5e711`  
		Last Modified: Sat, 18 Jan 2020 06:51:12 GMT  
		Size: 1.1 KB (1119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:6142e206a447f221e8e335e82fc51cbfd8f64def1fb3ee5fc1eedb7d2e810ed2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **129.5 MB (129485263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cc598f3fff3d6b46ae519639e48645128eadbbbd1335b38adbd3866c977e95c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 11:01:03 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 18 Jan 2020 11:03:12 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 18 Jan 2020 11:03:12 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 18 Jan 2020 11:03:13 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 11:03:13 GMT
ENV NEXTCLOUD_VERSION=17.0.2
# Sat, 18 Jan 2020 11:03:36 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 18 Jan 2020 11:03:37 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 18 Jan 2020 11:03:37 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Sat, 18 Jan 2020 11:03:37 GMT
...
-	Layers:
	...
	-	`sha256:18791d4e3b2e02956ecbe73180a34af46ba4d799524ff593453877c14e49986a`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:461a8fe0c3f5424a57ab8970a116e8235c4fe998ae5defc96c8518d6856d6725`  
		Last Modified: Sat, 18 Jan 2020 11:05:49 GMT  
		Size: 332.2 KB (332201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3072b9a5dd1d6e416c2e018758309be5e749ed786ac60831c907b063623541f`  
		Last Modified: Sat, 18 Jan 2020 11:05:54 GMT  
		Size: 26.1 MB (26070693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ba24d96163c43f20844639871373d27002381dff8297e4faabe119fabc922d5`  
		Last Modified: Sat, 18 Jan 2020 11:05:47 GMT  
		Size: 496.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:405c6b495fdbe4e56c6fba626ce7fe03d7059c1426456b5a2063fa11058d4938`  
		Last Modified: Sat, 18 Jan 2020 11:06:06 GMT  
		Size: 71.3 MB (71343511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c983ac7d55866d3853ebc167981b9abbbe43089df4980ff4ff85a686b2fddbf4`  
		Last Modified: Sat, 18 Jan 2020 11:05:48 GMT  
		Size: 2.2 KB (2161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fdec8932fc1a429622b392f89f55b6481dc017880667424c90b95e71d69bc43`  
		Last Modified: Sat, 18 Jan 2020 11:05:48 GMT  
...
```console
$ docker pull nextcloud@sha256:73cedd46f7c804791ef1afec2233651708237417fc35ef7af6fff0de0096c775
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.1 MB (130125017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2caeceda2d471c3cfdb1fc2decb7ad904b8f350171704011046c6077a408d416`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 07:14:20 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 18 Jan 2020 07:16:59 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype-dir=/usr --with-png-dir=/usr --with-jpeg-dir=/usr --with-webp-dir=/usr;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-4.3.0;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 18 Jan 2020 07:17:06 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 18 Jan 2020 07:17:10 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 07:17:14 GMT
ENV NEXTCLOUD_VERSION=17.0.2
# Sat, 18 Jan 2020 07:18:15 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 18 Jan 2020 07:18:22 GMT
COPY multi:4c0d5f2638534e3802f1f41694007dfeea41bc4977afff5103eb396d3c7ab26b in / 
# Sat, 18 Jan 2020 07:18:25 GMT
COPY multi:07fbadbda22b19b1f9b8cfc5e833b697afbaa1e602ffea77b26286f5899f86d6 in /usr/src/nextcloud/config/ 
# Sat, 18 Jan 2020 07:18:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 07:18:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c1ae5070553f7529bfb9f86312b845a7d930b4ba0b6e5cee71b177c54e13d1f6`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2acc5847ef3b74a2c472ece212f94d9609b29caa982049386b41283cc27b567b`  
		Last Modified: Sat, 18 Jan 2020 07:22:40 GMT  
		Size: 331.1 KB (331106 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04e0bfdb980c6debb128c63d45227600db4c2d6574652bc5f87dcd9eb58b4085`  
		Last Modified: Sat, 18 Jan 2020 07:22:44 GMT  
		Size: 26.1 MB (26107819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96cf8b1341eead4d5875a7594ca8fb0829789303b6fdfaffa908bd0f552b6a79`  
		Last Modified: Sat, 18 Jan 2020 07:22:38 GMT  
		Size: 524.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:897a0faf3311fbef51f60a61cf1aabdfcffb7175d83fbc8d317f3d801ceefea3`  
		Last Modified: Sat, 18 Jan 2020 07:22:57 GMT  
		Size: 71.3 MB (71346230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981c5229952f421567b17f1b9bb88ab9bcdac7e58b28e118ef9d6d5f7fbfc9b9`  
		Last Modified: Sat, 18 Jan 2020 07:22:38 GMT  
		Size: 2.2 KB (2160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63d0b5660c7d352553a65e5173e37d713a6a3c3a2555de69bedf825cb57e186f`  
		Last Modified: Sat, 18 Jan 2020 07:22:38 GMT  
		Size: 1.1 KB (1119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
