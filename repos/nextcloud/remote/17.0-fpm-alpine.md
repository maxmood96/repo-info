...
```console
$ docker pull nextcloud@sha256:50a5c8215beaa50f6c233aaaaf9ab0aaace7857eb6ee79a3ec4b77716ab26664
```
...
```console
$ docker pull nextcloud@sha256:f7c973857602b947925adb2beb25c2a44205d7bbcd85735ce97408fd5d96a076
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.3 MB (127251362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:693326a2c280cc4558db3210fa8b525e53725ee9eac54343674705cc889fbd6f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 08 Apr 2020 21:07:43 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Wed, 08 Apr 2020 21:07:45 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Wed, 08 Apr 2020 21:07:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 08 Apr 2020 21:07:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:07c2291c1a47a0f0a1060e6dc6f229970cee37b54189008120f2a732e56a3788`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb3779cc78a4d75c746a6345bb0af21d7eb08ebe7972b1284004869c0b59ad5d`  
		Last Modified: Wed, 08 Apr 2020 21:08:14 GMT  
		Size: 2.6 KB (2551 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:099721e24a3b85477bc09811131df47803505e465d03a26e7407f0aa65895986`  
		Last Modified: Wed, 08 Apr 2020 21:08:14 GMT  
...
```console
$ docker pull nextcloud@sha256:ede72c9de40fdef88e57654c04a5bf305fb7aa204f11b17078328b67ae1bb646
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.4 MB (125416849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67175a11e5f9cae88d1756fe040352fefcf6a288920c929245f069155fc9e67c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9b7934b32776c03a0bfb12f512a0c92908fe005639e67c188067fb146e0a6ced`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d83985bb723ab2bf2ef19fc9aba0d0d3c4db736316f583d348fa9ab43ad6a869`  
		Last Modified: Wed, 08 Apr 2020 21:16:06 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a62b7c23b76d7594307c7eda3d5dbec23989f7e57d215b8005bd683b70957ffc`  
		Last Modified: Wed, 08 Apr 2020 21:16:06 GMT  
		Size: 1.2 KB (1248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:0627fdde59a1f90cc4315d9c75a436741379e4f39fa54efe0a0747c0b37f5502
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.8 MB (128783908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:149e536bb29c20cb715cad0f76c4b9cd27afae2a2e4da39de45f07de27db18fe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Wed, 08 Apr 2020 21:46:55 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Wed, 08 Apr 2020 21:46:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 08 Apr 2020 21:46:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6f538caf7e62c18ecc9364f4e0d4d37ad8161c7fdb2f80dc90b381ae48525ac3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa28f6ee6eeb36a218add38178cf7d0fa270176cc95544ae6312fe42dd9e666c`  
		Last Modified: Wed, 08 Apr 2020 21:50:33 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7155d3932ea8edc0249a1e4b4e49ab7c7f1bda8cdbb16cd326d67204ce013568`  
		Last Modified: Wed, 08 Apr 2020 21:50:34 GMT  
		Size: 1.2 KB (1248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:9cc42468e3cb37d26812375610e50a3cb6d1213659da242fcabe404ccaf1e8bc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.2 MB (130235921 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9535f959a82f53673f6004e2f4e4ae0279540574a9dd1b3ccec1449855cbf322`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 08 Apr 2020 21:39:05 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Wed, 08 Apr 2020 21:39:06 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Wed, 08 Apr 2020 21:39:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 08 Apr 2020 21:39:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f8f3464466f1252277f2608d76cd0d647e9d938cd05af26d3867c5dfbab6dbec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:654a0aa0532e80864f3b6f7ceff75d4b3363621642903122204679900f491a15`  
		Last Modified: Wed, 08 Apr 2020 21:40:29 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1684f866ff0cdaae1b5d30179dde2eb3ff5934bde6bfe6dcef363b1c612c1cc9`  
		Last Modified: Wed, 08 Apr 2020 21:40:28 GMT  
