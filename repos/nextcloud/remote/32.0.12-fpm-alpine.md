...
```console
$ docker pull nextcloud@sha256:6213525bafbee75efe1e28fa7fe9ca2ff2684ea0c188879875db13a68f516378
```
...
### `nextcloud:32.0.12-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.12-fpm-alpine` - unknown; unknown
...
### `nextcloud:32.0.12-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:32.0.12-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:32.0.12-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.12-fpm-alpine` - linux; 386
...
### `nextcloud:32.0.12-fpm-alpine` - linux; ppc64le
...
### `nextcloud:32.0.12-fpm-alpine` - linux; s390x
