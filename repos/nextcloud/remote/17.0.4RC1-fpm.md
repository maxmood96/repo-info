...
```console
$ docker pull nextcloud@sha256:79cec5f6b5a936d1848e9aeb5e06247499f01f72959a649894509d391a5994db
```
...
### `nextcloud:17.0.4RC1-fpm` - linux; amd64
...
### `nextcloud:17.0.4RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.4RC1-fpm` - linux; 386
...
### `nextcloud:17.0.4RC1-fpm` - linux; ppc64le
