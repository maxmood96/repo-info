...
```console
$ docker pull nextcloud@sha256:436f01fa3d05f35fe726b922ed2a9d514a3d9222990f1d4b08c93362a9d34de8
```
...
### `nextcloud:22.2.4-fpm` - linux; amd64
...
### `nextcloud:22.2.4-fpm` - linux; arm variant v5
...
### `nextcloud:22.2.4-fpm` - linux; arm variant v7
...
### `nextcloud:22.2.4-fpm` - linux; 386
...
### `nextcloud:22.2.4-fpm` - linux; mips64le
...
### `nextcloud:22.2.4-fpm` - linux; s390x
