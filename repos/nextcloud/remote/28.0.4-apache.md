...
### `nextcloud:28.0.4-apache` - linux; arm variant v5
...
### `nextcloud:28.0.4-apache` - linux; arm variant v7
...
### `nextcloud:28.0.4-apache` - linux; 386
...
### `nextcloud:28.0.4-apache` - linux; mips64le
...
### `nextcloud:28.0.4-apache` - linux; ppc64le
...
### `nextcloud:28.0.4-apache` - linux; s390x
