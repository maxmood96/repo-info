...
```console
$ docker pull nextcloud@sha256:b99b2130d8c2ed88bda740ca03d70d2fa29abb1d19ef3ec68feacb422b6603ec
```
...
### `nextcloud:20.0.12-fpm-alpine` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:a4bd5b9e88d93ffcb1b27fc06f70d9d51e314286efea8efd9f98be460a2f932a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.4 MB (183430974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d74e6ae6f31b2455f94ebd1305f6f0598e0a4713a0845f4c9835f44581a1d7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Aug 2021 01:19:41 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 06 Aug 2021 01:20:52 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 06 Aug 2021 01:20:55 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 06 Aug 2021 01:20:57 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 06 Aug 2021 01:20:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 06 Aug 2021 01:20:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:503d1262af6e2e957d29be934aea84ed6cc49b0755c0086dba79beec4f0fe1a1`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17b7157d9d5ddb2eeccba7f3e1e10567249d187215640a3395244ae20a3bdf40`  
		Last Modified: Fri, 06 Aug 2021 01:40:41 GMT  
		Size: 132.3 MB (132349958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6403b8614e3aef04b44a3453503fcb07dde05be4e70abdbde75a9d8cca6f2df`  
		Last Modified: Fri, 06 Aug 2021 01:39:17 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f2ea83b6cc94d15d4869114fad61adfeb4e07d2e9be0f365811649674655a95`  
		Last Modified: Fri, 06 Aug 2021 01:39:16 GMT  
		Size: 2.1 KB (2052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0.12-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:f54eba9adda6bf5f89fdf4ec142e69503b573008eef02e7059045e8e42b4cab0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186932048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6dc7e3e9f640cdeb95322def221b49e2413913957fc5aa23d5a00613fa76c5d4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:cd047869c533fdb05c040188b4f2d8afda9109ee12cb569196626f6cb46be40c`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ccc009fd0de72abea0b98fce771ce5875ba6433edf1bc00d426da7cc5faaafe`  
		Last Modified: Fri, 06 Aug 2021 00:51:05 GMT  
		Size: 132.4 MB (132350247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b9aa0eb9ea676257bd57297982c146bf077fd63e7ba6f138cdd2d8ab97bb27a`  
		Last Modified: Fri, 06 Aug 2021 00:50:46 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97c7bdabd53374394c7f675567b56419ba96bbc62efcceac2be546c0bafd3ef4`  
		Last Modified: Fri, 06 Aug 2021 00:50:46 GMT  
		Size: 2.1 KB (2052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0.12-fpm-alpine` - linux; 386

```console
$ docker pull nextcloud@sha256:ed43f157e5d345c13eaf1d90ea6bf901ca2aa543515a15679826ef0a54a11cce
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188383881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb454579b0aa420abee9af6b17a8a56f6f849ec8b5774ae207c754c0623e70e2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Aug 2021 00:35:42 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 06 Aug 2021 00:36:46 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 06 Aug 2021 00:36:48 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 06 Aug 2021 00:36:49 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 06 Aug 2021 00:36:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 06 Aug 2021 00:36:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ae89fc4c8de9a4a6ad7425a548e9a77823417e3ae35ea65226a144e2b614ecb5`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6846c21cb5bf830ec44d86b3bb7e77c2fd1795228eb6e31c449a98bf83cfeafb`  
		Last Modified: Fri, 06 Aug 2021 00:48:46 GMT  
		Size: 132.4 MB (132350153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:262193926be57229bffa89163de3aaba239afe9570218dea67ddf9244ee36e0a`  
		Last Modified: Fri, 06 Aug 2021 00:48:19 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9924667f637981ad6c2abfbe0f868c8b8619117a38c9924da656b2a633265f7`  
		Last Modified: Fri, 06 Aug 2021 00:48:19 GMT  
		Size: 2.1 KB (2052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0.12-fpm-alpine` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:12c04cc478d6c136caf5673ce697724046ee4e71f4f0930e254a3e94ef3d16c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188742479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53947b967edce4acc35eca7ad7ba076e4ac3e5a4a3b47a5d4ba9c892e2a0d7b6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 06 Aug 2021 00:56:18 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 06 Aug 2021 00:57:11 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 06 Aug 2021 00:57:20 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 06 Aug 2021 00:57:22 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 06 Aug 2021 00:57:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 06 Aug 2021 00:57:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:784595860f5ec9a2e9b4692fa08f027b19ef83d3b9120c1dc2193c53a31507d2`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6918dadeba2c9e76c648275a83e82fe63ff09315fc7ab84d27e315dc35acb643`  
		Last Modified: Fri, 06 Aug 2021 01:21:54 GMT  
		Size: 132.3 MB (132349999 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7abf5f71d49d58eb4265884f3177ea63357dfc8fcccdaa8ac60f5bd69649c80d`  
		Last Modified: Fri, 06 Aug 2021 01:20:17 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44bbf82d636dc9c2c8ed085d4a2fa1acc5519aaad3ba26cd5b567eccdaf4af23`  
		Last Modified: Fri, 06 Aug 2021 01:20:16 GMT  
