...
```console
$ docker pull nextcloud@sha256:9796791e01ed8d499a386310509bc82d18587c2257bf02bc76c066a178c58ea7
```
...
```console
$ docker pull nextcloud@sha256:7ff621162dc1e3bd1b4a1dc0f8aad87f7be1790ca2955cd358258daf3019d14b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.5 MB (186503259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2a4a03401c4379d0096c1431c4660392f3e17d8f7b95329eb3750224ef95173`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 27 Aug 2021 02:05:16 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 27 Aug 2021 02:06:33 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 27 Aug 2021 02:06:36 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 27 Aug 2021 02:06:38 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 27 Aug 2021 02:06:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 Aug 2021 02:06:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:547cbf8863a2eb9fcbcf535ab6d9d9b8554c7d9fff2924e7aebfb760f904eb36`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a8c3840578156f590b83f4cade3f94261f4e3d0b6690b0e7e65d58b24962356`  
		Last Modified: Fri, 27 Aug 2021 02:13:02 GMT  
		Size: 132.4 MB (132350477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63ec3046bc45805cbe0ec4b5654b11411046ed8c7835018a82951232b6221f0f`  
		Last Modified: Fri, 27 Aug 2021 02:11:36 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68dfa2d3b9267930975395499ec581ac64c7dab547a5df5b8f680d418bdfefb0`  
		Last Modified: Fri, 27 Aug 2021 02:11:36 GMT  
...
### `nextcloud:20.0.12-fpm-alpine` - linux; s390x

```console
$ docker pull nextcloud@sha256:276d3585efac209584667ed630282dc899321fbe5bcb31a1eedb6165ce46967e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.2 MB (186196009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:608339653e807cddbfe09d0c4343aba2b06cc2adb00471dddac17a9d4e6b6716`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 20 Aug 2021 21:36:51 GMT
ENV NEXTCLOUD_VERSION=20.0.12
# Fri, 20 Aug 2021 21:38:02 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 20 Aug 2021 21:38:19 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 20 Aug 2021 21:38:20 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Fri, 20 Aug 2021 21:38:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 20 Aug 2021 21:38:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:152f72bf48da67c8a9faa2029aa0aa3e51d3b38937fff8206188b1564069d70a`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c82179dc4554d995d017f9d192e634ae773e59d4463ba8357589fdaba7bd01e8`  
		Last Modified: Fri, 20 Aug 2021 21:44:46 GMT  
		Size: 132.4 MB (132350074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e357c7b19a5868e786c5e6c29de1fdb652a266485885acf2cbdca8b68dbc570`  
		Last Modified: Fri, 20 Aug 2021 21:44:31 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735b7c1615284c2f925f613154f6e2de64e9446f92a17edfa7cf871f03b46220`  
		Last Modified: Fri, 20 Aug 2021 21:44:31 GMT  
		Size: 2.1 KB (2053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
