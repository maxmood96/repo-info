...
```console
$ docker pull nextcloud@sha256:b9ec2d5ff96071c8cbb675185795ef61878ac99fb527741d38f705862252425c
```
...
### `nextcloud:24.0.1-fpm` - linux; amd64
...
### `nextcloud:24.0.1-fpm` - linux; arm variant v7
...
### `nextcloud:24.0.1-fpm` - linux; mips64le
