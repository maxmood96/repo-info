...
```console
$ docker pull nextcloud@sha256:88cf8abc0b4c503d4fccfcdb55afcd94c8099931a2c5731fe387f346bb2fa212
```
...
### `nextcloud:33.0.6-fpm-alpine` - linux; amd64
...
### `nextcloud:33.0.6-fpm-alpine` - unknown; unknown
...
### `nextcloud:33.0.6-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:33.0.6-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:33.0.6-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:33.0.6-fpm-alpine` - linux; 386
...
### `nextcloud:33.0.6-fpm-alpine` - linux; ppc64le
...
### `nextcloud:33.0.6-fpm-alpine` - linux; s390x
