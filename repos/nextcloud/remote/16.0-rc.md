...
```console
$ docker pull nextcloud@sha256:00cb47537cea3f3b0c279d252738bd60bee742081f6bd605b88de110c21d1f30
```
...
### `nextcloud:16.0-rc` - linux; arm variant v5
...
### `nextcloud:16.0-rc` - linux; arm64 variant v8
...
### `nextcloud:16.0-rc` - linux; mips64le
...
### `nextcloud:16.0-rc` - linux; ppc64le
