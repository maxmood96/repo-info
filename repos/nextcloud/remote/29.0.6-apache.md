...
### `nextcloud:29.0.6-apache` - linux; arm variant v5
...
### `nextcloud:29.0.6-apache` - linux; arm variant v7
...
### `nextcloud:29.0.6-apache` - linux; arm64 variant v8
...
### `nextcloud:29.0.6-apache` - linux; 386
...
### `nextcloud:29.0.6-apache` - linux; s390x
