...
```console
$ docker pull nextcloud@sha256:c03ce7f9ca7592f49f1e0901d2b1521065971b72a7d166925b79543a2ecc63bf
```
...
### `nextcloud:29.0.13` - unknown; unknown
...
### `nextcloud:29.0.13` - linux; arm variant v5
...
### `nextcloud:29.0.13` - linux; arm variant v7
...
### `nextcloud:29.0.13` - linux; mips64le
...
### `nextcloud:29.0.13` - linux; ppc64le
