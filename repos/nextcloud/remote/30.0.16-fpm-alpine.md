...
```console
$ docker pull nextcloud@sha256:e5a6f8934961562123dafc0ee541678b6401854a87295153c5bf7bc92ee2158d
```
...
### `nextcloud:30.0.16-fpm-alpine` - linux; amd64
...
### `nextcloud:30.0.16-fpm-alpine` - unknown; unknown
...
### `nextcloud:30.0.16-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:30.0.16-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:30.0.16-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:30.0.16-fpm-alpine` - linux; 386
...
### `nextcloud:30.0.16-fpm-alpine` - linux; ppc64le
...
### `nextcloud:30.0.16-fpm-alpine` - linux; s390x
