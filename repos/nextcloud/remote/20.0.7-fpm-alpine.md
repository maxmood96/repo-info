...
### `nextcloud:20.0.7-fpm-alpine` - linux; amd64
...
### `nextcloud:20.0.7-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:20.0.7-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:20.0.7-fpm-alpine` - linux; ppc64le
