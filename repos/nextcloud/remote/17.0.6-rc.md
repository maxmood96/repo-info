...
### `nextcloud:17.0.6-rc` - linux; amd64
...
### `nextcloud:17.0.6-rc` - linux; arm variant v5
...
### `nextcloud:17.0.6-rc` - linux; arm variant v7
...
### `nextcloud:17.0.6-rc` - linux; arm64 variant v8
...
### `nextcloud:17.0.6-rc` - linux; mips64le
...
### `nextcloud:17.0.6-rc` - linux; ppc64le
...
### `nextcloud:17.0.6-rc` - linux; s390x
