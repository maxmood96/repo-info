...
```console
$ docker pull nextcloud@sha256:4cb08afe315387fa56927e27a7a838ba4d702988ebbeb051fe6e7a0f0bae8c9b
```
...
### `nextcloud:28.0.5-fpm-alpine` - linux; amd64
...
### `nextcloud:28.0.5-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:28.0.5-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:28.0.5-fpm-alpine` - linux; 386
...
### `nextcloud:28.0.5-fpm-alpine` - linux; ppc64le
...
### `nextcloud:28.0.5-fpm-alpine` - linux; s390x
