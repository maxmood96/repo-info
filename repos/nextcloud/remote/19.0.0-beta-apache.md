...
```console
$ docker pull nextcloud@sha256:fc4d5fb317ccacc73459e0c653bab30e5fce22eb3cda178d283539034e0f6db0
```
...
```console
$ docker pull nextcloud@sha256:0458e89888a38be5358d7716080616a0e8efc1945ef60e36f583d6691530ff55
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.6 MB (264577591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da6fd1deaf38de11d9f3592347b77eeb845b619cb76024c607904293152878f8`
...
# Fri, 24 Apr 2020 12:08:51 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta5
# Fri, 24 Apr 2020 12:09:21 GMT
...
-	Layers:
	...
	-	`sha256:91bcfb6cb17ab00facd13a23166ae3ca7ce6673be0ed8e576baee97ddd2c5c9e`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa575596057976c7c266f3887c0ce7b021fa063571a1f435e4bb575f7908a79f`  
		Last Modified: Fri, 24 Apr 2020 12:14:40 GMT  
		Size: 97.8 MB (97772512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9960c4d5905dbac5f711aa9fc68fa3fe9bdfd73ba5ac2a4d8e25cd435ed48364`  
		Last Modified: Fri, 24 Apr 2020 12:14:24 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c651ce983758f300c43cb83f4b8191b9044bac5f959d06806132e1295e259cb`  
		Last Modified: Fri, 24 Apr 2020 12:14:24 GMT  
...
```console
$ docker pull nextcloud@sha256:a09cd68e28bc85ec7cdfdb248481c97723fb48e04ea73714ec76afe932ee0528
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.5 MB (237483509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da2c11e44878dd346cc25627651979c0e07ab3f774ff46dab729b12370d7b933`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 24 Apr 2020 13:30:16 GMT
ENV NEXTCLOUD_VERSION=19.0.0beta5
# Fri, 24 Apr 2020 13:31:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 24 Apr 2020 13:31:17 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 24 Apr 2020 13:31:19 GMT
COPY multi:641d9647b02e0716fa98d67c2bd719ff1b296a8a83ca009f972756c58c2e5fed in /usr/src/nextcloud/config/ 
# Fri, 24 Apr 2020 13:31:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Apr 2020 13:31:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7717bd26886a36c192c81224668d1422f1e2af23ac00156f10a5e2acba714b80`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86d997e30e6a1709833424475426bad9bb6d92768b7e8e17beb5a715b758300d`  
		Last Modified: Fri, 24 Apr 2020 13:41:25 GMT  
		Size: 97.8 MB (97770723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595bb5570b8f6a1a048d879b8ce979abdf3b9751509d1c726b2cd3153b14eb3e`  
		Last Modified: Fri, 24 Apr 2020 13:40:52 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60f7a3909a4a74b5e080a96aa89bb1981c2da0bbc0c35d62b4f959bb18e18a5d`  
		Last Modified: Fri, 24 Apr 2020 13:40:52 GMT  
