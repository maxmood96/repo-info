...
```console
$ docker pull nextcloud@sha256:5823a4aa5ec2cf03d85543fbe016c6f7d569d8de72da6d7b07fb9c1c3d6b78fe
```
...
### `nextcloud:20.0-beta` - linux; amd64
...
### `nextcloud:20.0-beta` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:57e33b319ebc98c1743109c8d3f9ca9cd99272270ae67a503a5efff7e7b7ff68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.4 MB (270426742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c6043f20215cdf20e88e0ba4adc601939419c8ce3afa807be3ec7ca4aad249e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 10 Sep 2020 17:32:25 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta3
# Thu, 10 Sep 2020 17:33:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 10 Sep 2020 17:34:06 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 10 Sep 2020 17:34:13 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Thu, 10 Sep 2020 17:34:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 10 Sep 2020 17:34:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ac3fda655640effd5dc2bb8bea9c936a87a8bb1b6aea97456abe9dde5b7710e3`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9218ca2a7e9fed2786168098b8dbea479251237de9f46094d4a4abdb9200593`  
		Last Modified: Thu, 10 Sep 2020 17:46:41 GMT  
		Size: 128.7 MB (128675906 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b97a8a1d44b2bec366e315e88ee5850369be71f79cf88d69c8cda46e352ffb90`  
		Last Modified: Thu, 10 Sep 2020 17:45:54 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64671fe6073e4646c4b15b94eb4a34cdd7c7409af3e10ca9094556c84a4e3e41`  
		Last Modified: Thu, 10 Sep 2020 17:45:53 GMT  
		Size: 1.7 KB (1714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0-beta` - linux; arm variant v7
...
### `nextcloud:20.0-beta` - linux; arm64 variant v8
...
### `nextcloud:20.0-beta` - linux; mips64le
...
### `nextcloud:20.0-beta` - linux; ppc64le
...
### `nextcloud:20.0-beta` - linux; s390x

```console
$ docker pull nextcloud@sha256:b52f5d4a659314bdb447094c0beffb5f1e482807032ea28905c14d7c97fe1a4d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **277.8 MB (277763215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75d554a1bbaa32eeeb33e785a69a808f7a1db6f8d9b7af4f74f7cfbcedb7b806`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 10 Sep 2020 09:21:13 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta3
# Thu, 10 Sep 2020 09:21:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 10 Sep 2020 09:22:15 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 10 Sep 2020 09:22:16 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Thu, 10 Sep 2020 09:22:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 10 Sep 2020 09:22:17 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:db2359ddc1b92b02640011a1c85664b53a8f75b07936af024b6748a1d7baadb6`  
		...
		Size: 570.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb1200ded023358e99c772ca8e04724ed43f950365ed326d270edbad212efff1`  
		Last Modified: Thu, 10 Sep 2020 09:28:49 GMT  
		Size: 128.7 MB (128675885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a911feeaa04f1a7eb5421b136729fd29a923852cc1fa9fcea048891b0c05e16`  
		Last Modified: Thu, 10 Sep 2020 09:28:36 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b63bcda0c8988205f8115fbc753e67722cc0a16abc1d8eb5247c602d334a313`  
		Last Modified: Thu, 10 Sep 2020 09:28:36 GMT  
