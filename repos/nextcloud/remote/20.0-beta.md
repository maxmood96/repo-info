...
```console
$ docker pull nextcloud@sha256:167e57c2791912792a6448e89d7e2e761fef747a32e99dfe0933629653ecc810
```
...
```console
$ docker pull nextcloud@sha256:d4e9d78974b7f835253a557b584bd3b246bc6f8bdcfbca06e440a6230d132427
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.6 MB (263609230 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dacc9eda09a73839b3fb3b9a2a7f227147796e8f86d16da5432a92d81c1ba2c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 02 Sep 2020 02:22:32 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta2
# Wed, 02 Sep 2020 02:23:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 02:24:17 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Wed, 02 Sep 2020 02:25:02 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Wed, 02 Sep 2020 02:25:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:9e86accc69ba74c1dbaffc0583d403c7d8557bdf25967b39ccf434de3be48ab8`  
		...
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9d15fb0e690c5dc5aa7c651b42c15c952ee4785d40aa86e67d4127f6e217a22`  
		Last Modified: Wed, 02 Sep 2020 02:38:57 GMT  
		Size: 125.7 MB (125716443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ed7ee7812c623d51361d36f8fb403337292f151706c5b11826ddd20ad609a8d`  
		Last Modified: Wed, 02 Sep 2020 02:38:18 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68a04526f3924a0c227ddc1d1194f937377eb57b211a61ebb1f27e1810d2414c`  
		Last Modified: Wed, 02 Sep 2020 02:38:18 GMT  
...
```console
$ docker pull nextcloud@sha256:969188ddedc3602f3a3ff9eca7b2f1ad160ab89fd28e673fd7cab44401b6baee
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.2 MB (302202892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1176d486cbe0a8d7f96ff279a28f583568916a40a67561c3a5a0e231b1584856`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Sep 2020 18:11:25 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta2
# Tue, 01 Sep 2020 18:16:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 18:17:00 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 18:17:04 GMT
COPY multi:7bd9811210038df1943ff885cd8ece3011135daee5d5badf37c96c7f535af081 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 18:17:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 18:17:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:588081d73f50e6119c8daa91cad0a50429a56d2adf925a0033f583f7d53742fa`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb5bad6416f3c94c42f208ffb801734d215d221eb0a745e5d5b97a1c1a79c8b8`  
		Last Modified: Tue, 01 Sep 2020 19:14:56 GMT  
		Size: 125.7 MB (125720404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd35a072270b00b913a6679dccb86feae56a97d4371a2d36289416efe2dd9d7a`  
		Last Modified: Tue, 01 Sep 2020 19:12:15 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:079f20eb550fda1cd6294316ea36b2af92695ab259ade2bc5116b5fb0930fbec`  
		Last Modified: Tue, 01 Sep 2020 19:12:16 GMT  
		Size: 1.7 KB (1712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
