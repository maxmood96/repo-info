...
```console
$ docker pull nextcloud@sha256:b3b3f0439a386288e042d2680ce9f3966fd93e958910070a60786a4b99ac6b0f
```
...
### `nextcloud:23.0.7-fpm-alpine` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:27f23daa67cfe24cb82464294d3cbccc374073bdafdbfc20c48bf526223cc398
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191820541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10d8f4e02ec15fd29c25114a7340ffef31c4081b464fa38817dbb5196f208aa1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Jul 2022 05:22:52 GMT
CMD ["php-fpm"]
# Tue, 19 Jul 2022 10:36:28 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 19 Jul 2022 10:42:01 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Tue, 19 Jul 2022 10:42:01 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 19 Jul 2022 10:42:02 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 19 Jul 2022 10:42:03 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 19 Jul 2022 10:42:04 GMT
VOLUME [/var/www/html]
# Tue, 19 Jul 2022 10:47:48 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Tue, 19 Jul 2022 10:49:27 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Jul 2022 10:49:30 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 10:49:32 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 10:49:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 10:49:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:030d5c43ce56787eaf64f5c9cb36259164e676a605932a39d450b10f891e8f43`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b9ebd3a466c6ac524795a8f55e5fd3b607c8d31b411fda7743772e52d47ec37`  
		Last Modified: Tue, 19 Jul 2022 11:03:01 GMT  
		Size: 508.3 KB (508316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11acd2ab18f094f770bf143771cd5b41725e4ec0a5b50146f6adc179477da7a0`  
		Last Modified: Tue, 19 Jul 2022 11:03:05 GMT  
		Size: 12.6 MB (12622620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a374f0ed4be1810bb752c2569e6e912ceac4f9633cbd9553cc39685ab62dd2d3`  
		Last Modified: Tue, 19 Jul 2022 11:02:59 GMT  
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d510ad85640cd9fe1ef0e54270ebb89854f2da17a54032920ed0e22d6ed9240e`  
		Last Modified: Tue, 19 Jul 2022 11:12:40 GMT  
		Size: 153.5 MB (153538233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01d8dc05f0df1e6f8fb968d163e0b84d16fd997dc94ddbd7185aad5505d123a1`  
		Last Modified: Tue, 19 Jul 2022 11:10:56 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5f0f036e2c3e721ff79ab94ad2e52cd88d8448a0e71d1b88977f192e9d808ae`  
		Last Modified: Tue, 19 Jul 2022 11:10:56 GMT  
...
```console
$ docker pull nextcloud@sha256:25e7b1610763f9e44d8b55399f6ffff649cbab47fc495b915ecebee678545e2c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.6 MB (194627466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64805453e9c3340838f17bca6e679e46a625fc3c9e6cca705bc0d22e4ebdecc3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 19 Jul 2022 06:57:09 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Tue, 19 Jul 2022 06:57:56 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Jul 2022 06:57:58 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 06:57:59 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 06:58:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:b1899a9100f16ed937f6b5d931da605ba5c878e192a4b6b58a3a58754af10dbb`  
		...
		Size: 563.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d24e7d29f69394c0931fe81b437bdf29483f7172cda89c60be7d4812fc2c27b9`  
		Last Modified: Tue, 19 Jul 2022 07:01:40 GMT  
		Size: 153.5 MB (153540165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1577f4477dba3ffc02caa64d6149680550f51a578df29e9cf37fbb7c61baf8c7`  
		Last Modified: Tue, 19 Jul 2022 07:01:19 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75dd4ce8db73b13a1450e0755840b32d23248b9affaa1adc82b7bf724f408dd9`  
		Last Modified: Tue, 19 Jul 2022 07:01:19 GMT  
...
```console
$ docker pull nextcloud@sha256:73303c7346edbeae3a28997be6adfe122c9ac871d52e01fddce172033a31333e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.3 MB (196296796 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7e763c7fb846dd892d77aef52f545ee1cbb4c5935cf1b693ea1bcaba4167c80`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 19 Jul 2022 09:21:37 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Tue, 19 Jul 2022 09:23:05 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Jul 2022 09:23:10 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 09:23:12 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 09:23:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 09:23:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1e32a5d13708b68acbc621a3c0fc71c001645c3596027eaeb67eefbbf24df26b`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77fa02770dc568e92b64b40c38313e53a52f7bc7bdb8a0592ce4eb2e9cb26741`  
		Last Modified: Tue, 19 Jul 2022 09:29:38 GMT  
		Size: 153.5 MB (153538210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95e2863ba6ca9c7d5c672ea335eb89806637aff8fde1585a678567154171468f`  
		Last Modified: Tue, 19 Jul 2022 09:29:12 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0353d9dad7f868a52b9d62eb25061f55e8d093a4c7bfc9240780ca4809e9a0c6`  
		Last Modified: Tue, 19 Jul 2022 09:29:12 GMT  
		Size: 2.1 KB (2140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:23.0.7-fpm-alpine` - linux; s390x

```console
$ docker pull nextcloud@sha256:7075b00bf9a334a962a687e5edea9be461a0a3437dd5ead7ce7e317559ea358e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.1 MB (194147795 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66df28fc6c16779944ab49153413a3b01f89b46dc30ea1beef4a2e70ee5135f4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 19 Jul 2022 06:59:05 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Tue, 19 Jul 2022 07:00:54 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Tue, 19 Jul 2022 07:01:29 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Tue, 19 Jul 2022 07:01:31 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Tue, 19 Jul 2022 07:01:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 07:01:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3d7b8544df587a3e90f1055856eaa0cf073d3cf269e5dd961033ff208317dec0`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:049904af0898b246233d481b5508154e77a8f24e2841ac546a606a95190d2b97`  
		Last Modified: Tue, 19 Jul 2022 07:14:20 GMT  
		Size: 153.5 MB (153538214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4dd9d6563ae5fd72927976dc424c8cfff7db4d9669884b77cb3f52a00a94753`  
		Last Modified: Tue, 19 Jul 2022 07:14:00 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3670fc591c95338a647622d0c5a04c36c9a7c821373d612d5ad4e68bf4d90916`  
		Last Modified: Tue, 19 Jul 2022 07:14:00 GMT  
		Size: 2.1 KB (2137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
