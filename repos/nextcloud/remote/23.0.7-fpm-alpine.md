...
```console
$ docker pull nextcloud@sha256:04d674ff76cc86dd9e2a80105a1f828a7dc6ec5c62218cd9869f3e070697895c
```
...
```console
$ docker pull nextcloud@sha256:0976564f0487aa1657a1019b9d0634ba66c308e6dab9b34994629cab7e3233d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.9 MB (195851015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a7df1c3a69560ba8831bcf3a770c6f25beda90af9b4a3177727ff902d6bf461`
...
-	Layers:
	...
	-	`sha256:83db60181efdb151f2764a0f3a3d8a24e7da15839ad158c6d6c22547c3ae0066`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68b439aac88dd8868a1a13daa4538719e0fcb437c3340488c4206dd09f47284c`  
		Last Modified: Wed, 10 Aug 2022 05:07:43 GMT  
		Size: 577.2 KB (577245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81e3437679b04a6cda0648fdc53e6ab30267defeb3218293c6c047394c59a4e6`  
		Last Modified: Wed, 10 Aug 2022 05:07:43 GMT  
		Size: 14.3 MB (14289997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe605479e4005baa5b7d4d68fb1d8a6ad8b66452ea860aeddde5ed6e8ff8be52`  
		Last Modified: Wed, 10 Aug 2022 05:07:40 GMT  
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75088afbf97b77057aaff81930a6dc9f28c3942590b00adda469707ea55a2721`  
		Last Modified: Wed, 10 Aug 2022 05:08:34 GMT  
		Size: 153.5 MB (153538820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b30ef5e82a60b46a6ea3e0f289ee879c1a97928c2e45017b41799a27a286efa4`  
		Last Modified: Wed, 10 Aug 2022 05:08:13 GMT  
		Size: 3.1 KB (3063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c96b3cfbb02822a976c992d61a118b99076dcabb0bdb977bb9591bf553113403`  
		Last Modified: Wed, 10 Aug 2022 05:08:13 GMT  
...
```console
$ docker pull nextcloud@sha256:a143b743e04942f3d6a63a62a010b269e8a0536ba0be91fc7ca67c4bf83cca6d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.7 MB (194650806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bce6e78ce53f4591d8f101fafd9122084e6a6c64d4f7940679f4d0ebb0c824b3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 10 Aug 2022 08:29:32 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Wed, 10 Aug 2022 08:32:01 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Wed, 10 Aug 2022 08:32:01 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 10 Aug 2022 08:32:02 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 10 Aug 2022 08:32:03 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Wed, 10 Aug 2022 08:32:04 GMT
VOLUME [/var/www/html]
# Wed, 10 Aug 2022 08:34:20 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Wed, 10 Aug 2022 08:34:58 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 10 Aug 2022 08:34:59 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 10 Aug 2022 08:35:01 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 10 Aug 2022 08:35:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 10 Aug 2022 08:35:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:33e3ec361da227a3cc614ed925dff3779959b20ceb4973228c3a902d1b464362`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc76bd8b14b68c1f0be7a8ad49ba70083e34cca0f80533a886b83daec175729a`  
		Last Modified: Wed, 10 Aug 2022 08:39:15 GMT  
		Size: 580.7 KB (580706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d330022fc9ab203e07db761404c3a4c72f6fa92199c05e7b761ab86a400af5d`  
		Last Modified: Wed, 10 Aug 2022 08:39:15 GMT  
		Size: 13.7 MB (13703011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecee000a567beeda87b5b9d1f29a95a99bf9e3b2515e705c713325e7a69840d0`  
		Last Modified: Wed, 10 Aug 2022 08:39:13 GMT  
		Size: 560.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72f20b2803aa786195c5bcdb35aeb7af39a9f3ad8fd549f4a42dc71df77fdd0b`  
		Last Modified: Wed, 10 Aug 2022 08:41:11 GMT  
		Size: 153.5 MB (153541369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ad77247adcb55b5e260c055963cb62950b48471c4382b60baa5a30892fc98f3`  
		Last Modified: Wed, 10 Aug 2022 08:40:49 GMT  
		Size: 3.1 KB (3062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e4f93b93c4c57a83dabe616690a7974a2757cdea5774c4382a37acd5ee3dc00`  
		Last Modified: Wed, 10 Aug 2022 08:40:49 GMT  
...
```console
$ docker pull nextcloud@sha256:7059bddbc60970e3c52957585ce6fdbaa7ff8917487df8f0eb88c119e6ea172e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.3 MB (196322967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea088b8a1ee19c79464ca55b7ab177061ab3ebb04dedc59823d09c658f99efa2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Aug 2022 20:56:20 GMT
CMD ["php-fpm"]
# Wed, 10 Aug 2022 08:22:42 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Wed, 10 Aug 2022 08:26:32 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.21;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Wed, 10 Aug 2022 08:26:33 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 10 Aug 2022 08:26:33 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 10 Aug 2022 08:26:35 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Wed, 10 Aug 2022 08:26:35 GMT
VOLUME [/var/www/html]
# Wed, 10 Aug 2022 08:29:23 GMT
ENV NEXTCLOUD_VERSION=23.0.7
# Wed, 10 Aug 2022 08:30:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 10 Aug 2022 08:30:30 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 10 Aug 2022 08:30:31 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 10 Aug 2022 08:30:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 10 Aug 2022 08:30:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:aef575bf5cd87128b673428ec92744c60aee800a2f9652bfaa3311d35da7cb14`  
		...
		Size: 8.6 KB (8570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1f97131d8f123b548002fb6a2d7715d4d48a74a528cc8e72965239eb39e06e9`  
		Last Modified: Wed, 10 Aug 2022 08:36:09 GMT  
		Size: 616.6 KB (616622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d60c58ad9db792fad78edb9da36c22254d2c5bbac9785ec69f4a78a1eb34d9c`  
		Last Modified: Wed, 10 Aug 2022 08:36:09 GMT  
		Size: 14.2 MB (14213011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27ae5e0a88857bea0f04a9160d384d8f69ab8b346376e00d76a8f52f332037de`  
		Last Modified: Wed, 10 Aug 2022 08:36:06 GMT  
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4d385fbbed2750f58ce19e3dbb63b6ac8f7cd4b12c729e75d20fe60fc7bbb2f`  
		Last Modified: Wed, 10 Aug 2022 08:38:28 GMT  
		Size: 153.5 MB (153538830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f65dd4ec477384c4819bf157288a9f9cc66566a2586eace3c838cf7af8f4c568`  
		Last Modified: Wed, 10 Aug 2022 08:37:53 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23d37c860b179d8d2619a1b0f8014ea175f7cc64214aa0ed039e03cc7fb57552`  
		Last Modified: Wed, 10 Aug 2022 08:37:53 GMT  
