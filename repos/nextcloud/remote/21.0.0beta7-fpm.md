...
```console
$ docker pull nextcloud@sha256:0697e711d9c91fbe90530a440e734d9dc1db642ec51b1bb01078f3726485605b
```
...
```console
$ docker pull nextcloud@sha256:cb601862680e79024dd28107f10d6521e86b0c2826302ac6d459424de81c4d8a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.6 MB (264600323 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c384ba38d87d30600f16a65391a4a6d19a74b435c745dffe788d10f1fcdb5e3a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Feb 2021 02:55:10 GMT
VOLUME [/var/www/html]
# Fri, 05 Feb 2021 03:05:57 GMT
ENV NEXTCLOUD_VERSION=21.0.0beta7
# Fri, 05 Feb 2021 03:06:56 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 05 Feb 2021 03:07:06 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Fri, 05 Feb 2021 03:07:08 GMT
COPY multi:69a3d18e5826dcf2a02562f59ec38d4047623d6d537d30e24b29faeb8ea43f9d in /usr/src/nextcloud/config/ 
# Fri, 05 Feb 2021 03:07:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Feb 2021 03:07:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:646966913793e821d0741d25c6cf5f263941cbffe38626f56bc018a793e29e53`  
		...
		Size: 8.4 KB (8450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5b4acb69dbe8c8ed98a8682fa60d965ba7987d53e6abb973a5121496ea73aed`  
		Last Modified: Fri, 05 Feb 2021 03:26:45 GMT  
		Size: 1.6 MB (1595089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90d6c28a4902a1c3f4d326acd9d676e99870b1e8f8fc818ac7293deedc240bfa`  
		Last Modified: Fri, 05 Feb 2021 03:26:23 GMT  
		Size: 15.2 MB (15195025 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1869abcb92dcc5aa1c2e1d7fce68d52e03f61c2fddf4a06a7eb739efef477012`  
		Last Modified: Fri, 05 Feb 2021 03:26:23 GMT  
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:066289768838d22c5848df52c9ad3c5a2e24fddfd774ea80d70f0f515857e639`  
		Last Modified: Fri, 05 Feb 2021 03:55:45 GMT  
		Size: 119.0 MB (119029124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa205054731705ab8a2cd42c41260f921260aa6fb485b9ab35e755f6768975cb`  
		Last Modified: Fri, 05 Feb 2021 03:55:32 GMT  
		Size: 2.5 KB (2531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11c4469b12399ad86bc9604d533fb8ccd2c37dde9ab64b080a8e207e84adafea`  
		Last Modified: Fri, 05 Feb 2021 03:55:32 GMT  
		Size: 1.9 KB (1894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
