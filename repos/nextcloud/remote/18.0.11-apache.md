## `nextcloud:18.0.11-apache`

```console
$ docker pull nextcloud@sha256:896c6386e064da3bbd721ef1e899b1a3f1535d892784c592fe51e4dc0506df58
```
...
### `nextcloud:18.0.11-apache` - linux; amd64
...
### `nextcloud:18.0.11-apache` - linux; arm variant v5
...
### `nextcloud:18.0.11-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.11-apache` - linux; 386
...
### `nextcloud:18.0.11-apache` - linux; mips64le
...
### `nextcloud:18.0.11-apache` - linux; s390x
