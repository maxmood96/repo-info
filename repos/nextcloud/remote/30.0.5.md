...
### `nextcloud:30.0.5` - unknown; unknown
...
### `nextcloud:30.0.5` - linux; arm variant v5
...
### `nextcloud:30.0.5` - linux; arm variant v7
...
### `nextcloud:30.0.5` - linux; arm64 variant v8
...
### `nextcloud:30.0.5` - linux; mips64le
...
### `nextcloud:30.0.5` - linux; ppc64le
