...
```console
$ docker pull nextcloud@sha256:a38e11b5c5510a40caf69fb6254a322a0f2e61d560c6cf9dcd8285e7ed803cf3
```
...
### `nextcloud:33.0.6-apache` - linux; amd64
...
### `nextcloud:33.0.6-apache` - unknown; unknown
...
### `nextcloud:33.0.6-apache` - linux; arm variant v5
...
### `nextcloud:33.0.6-apache` - linux; arm variant v7
...
### `nextcloud:33.0.6-apache` - linux; arm64 variant v8
...
### `nextcloud:33.0.6-apache` - linux; 386
...
### `nextcloud:33.0.6-apache` - linux; ppc64le
...
### `nextcloud:33.0.6-apache` - linux; s390x
