...
```console
$ docker pull nextcloud@sha256:70f04f0a54e1e544044fb0df7e6e761b047cd256e93a94cb09dae87bed41e75a
```
...
### `nextcloud:18.0.4RC1-fpm` - linux; amd64
...
### `nextcloud:18.0.4RC1-fpm` - linux; mips64le
...
### `nextcloud:18.0.4RC1-fpm` - linux; ppc64le
