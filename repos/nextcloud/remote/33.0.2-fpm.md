...
```console
$ docker pull nextcloud@sha256:8df4667df5c71edfd3ac7fda2eedd5963a5811ad7b02c63f106a5de99cad2628
```
...
```console
$ docker pull nextcloud@sha256:5602dd311eeffe2345e3f8e75f5e241481566a0e65a805b8df07c4f50c69b769
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **485.6 MB (485630905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cab304ee8cbbb2d56da63c7b7c891055970e1cd44ec5e51c41b1c4a5af27acc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 22 Apr 2026 01:33:39 GMT
CMD ["php-fpm"]
# Wed, 22 Apr 2026 04:02:50 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         busybox-static         bzip2         libldap-common         libmagickcore-7.q16-10-extra         rsync     ;     apt-get dist-clean;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data # buildkit
# Wed, 22 Apr 2026 04:05:59 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 22 Apr 2026 04:05:59 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 22 Apr 2026 04:05:59 GMT
...
-	Layers:
	...
	-	`sha256:ff6ce405333963fdc520e92d36f4d5bb377e38403cfcabaa518f073f5212a153`  
		...
		Size: 9.3 KB (9268 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3979f03755d4ad75d04512e12c0fa6e3275971738e0d608799b9c95c0ed11246`  
		Last Modified: Wed, 22 Apr 2026 04:07:27 GMT  
		Size: 18.1 MB (18092690 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bfb90e355f4d898feece340e789a7d9d44ec310cfc56037d149986a9c9c0f5b1`  
		Last Modified: Wed, 22 Apr 2026 04:07:28 GMT  
		Size: 34.8 MB (34783145 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6aa5b5ee937cdb9ed9e77a4c9ff55629e11af2384770c21669d909771c4f726d`  
		Last Modified: Wed, 22 Apr 2026 04:07:26 GMT  
		Size: 791.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e1698b925345802aed901077aaac69a488ff7a44dadbe7401b64f8ca6ae5df2c`  
		Last Modified: Wed, 22 Apr 2026 04:07:34 GMT  
		Size: 294.9 MB (294861902 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:00c21fe778a455c61848de704367dd04b6b1112fc675e2e196f03f4d789388b0`  
		Last Modified: Wed, 22 Apr 2026 04:07:28 GMT  
		Size: 4.1 KB (4136 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e16ca2cae8a1d8c39e76dabc6eced44428aaf066e31565ebfa3f11a09a881100`  
...
```console
$ docker pull nextcloud@sha256:d3ddeb2914a49891d245b2a52a7324b69d8f9729e38431227cd8d08679c960db
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 KB (46834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:430dbc2ec197ac6183896b775e161253ec610f6cb8043a4e6e383ad115dff7fc`

```dockerfile
```

-	Layers:
	-	`sha256:f079429af1baa5bb18869c77e92dffc72d42f5577cf214a912a7fca6fe41ec0f`  
		Last Modified: Wed, 22 Apr 2026 04:07:26 GMT  
		Size: 46.8 KB (46834 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull nextcloud@sha256:d8f61bf50ceceee2e3760f56f279c9303b4ca7f41c3379b1d777685f8ac186f4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **527.1 MB (527108024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b028639907fe19eaaa134387f810c7a756d1b6f3bea3fcbd11a6820c30206353`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 22 Apr 2026 02:29:01 GMT
CMD ["php-fpm"]
# Wed, 22 Apr 2026 11:31:16 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         busybox-static         bzip2         libldap-common         libmagickcore-7.q16-10-extra         rsync     ;     apt-get dist-clean;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data # buildkit
# Wed, 22 Apr 2026 11:36:28 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 22 Apr 2026 11:36:28 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 22 Apr 2026 11:36:28 GMT
...
# Wed, 22 Apr 2026 11:36:28 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libgmp-dev         libicu-dev         libjpeg-dev         libldap2-dev         liblz4-dev         libmagickwand-dev         libmemcached-dev         libpng-dev         libpq-dev         libwebp-dev         libxml2-dev         libzip-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure ftp --with-ftp-ssl;     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         ftp         gd         gmp         intl         ldap         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.28;     pecl install igbinary-3.2.16;     pecl install imagick-3.8.1;     pecl install --configureoptions 'enable-memcached-igbinary="yes"'         memcached-3.4.0;     pecl install --configureoptions 'enable-redis-igbinary="yes" enable-redis-zstd="yes" enable-redis-lz4="yes"'         redis-6.3.0;         docker-php-ext-enable         apcu         igbinary         imagick         memcached         redis     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'         | sort -u         | xargs -rt dpkg-query --search         | awk 'sub(":$", "", $1) { print $1 }'         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     apt-get dist-clean # buildkit
# Wed, 22 Apr 2026 11:36:30 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=${PHP_OPCACHE_MEMORY_CONSUMPTION}';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=8M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'apc.serializer=igbinary';         echo 'session.serialize_handler=igbinary';     } >> "${PHP_INI_DIR}/conf.d/docker-php-ext-igbinary.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     mkdir -p /docker-entrypoint-hooks.d/pre-installation              /docker-entrypoint-hooks.d/post-installation              /docker-entrypoint-hooks.d/pre-upgrade              /docker-entrypoint-hooks.d/post-upgrade              /docker-entrypoint-hooks.d/before-starting;     chown -R www-data:root /var/www;     chmod -R g=u /var/www # buildkit
# Wed, 22 Apr 2026 11:36:30 GMT
VOLUME [/var/www/html]
# Wed, 22 Apr 2026 11:36:30 GMT
ENV NEXTCLOUD_VERSION=33.0.2
# Wed, 22 Apr 2026 11:37:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://github.com/nextcloud-releases/server/releases/download/v33.0.2/nextcloud-33.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://github.com/nextcloud-releases/server/releases/download/v33.0.2/nextcloud-33.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     apt-get dist-clean # buildkit
# Wed, 22 Apr 2026 11:37:44 GMT
COPY *.sh upgrade.exclude / # buildkit
# Wed, 22 Apr 2026 11:37:45 GMT
COPY config/* /usr/src/nextcloud/config/ # buildkit
# Wed, 22 Apr 2026 11:37:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 22 Apr 2026 11:37:45 GMT
...
-	Layers:
	...
	-	`sha256:a4f1fed36adf60cc812d5d5ac75e5173f419b3ee00d8175c70fe1248910c1870`  
		...
		Size: 9.3 KB (9268 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d40e108778e49c89e4ee71836b7031524ca9af316fc810f57e795618e734d797`  
		Last Modified: Wed, 22 Apr 2026 11:38:35 GMT  
		Size: 22.2 MB (22172307 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a15e652d54a7fef71c68c810b755b429e5a43f0d5b1d85caf050cdd80aa48f9`  
		Last Modified: Wed, 22 Apr 2026 11:38:36 GMT  
		Size: 38.8 MB (38793898 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f822aae91b7b75d1bb77985c087423a3a09514943300c3a95b1481cdc94d486b`  
		Last Modified: Wed, 22 Apr 2026 11:38:34 GMT  
		Size: 790.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3a6239c596c0510e0a6e219681e6f4495684ef2cd09f975a42de571d1bd5c3c9`  
		Last Modified: Wed, 22 Apr 2026 11:38:41 GMT  
		Size: 294.9 MB (294874338 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f4b681b77c1d5ea31fd0f9a717d560ad355a06a6287983f410314c18cf65448a`  
		Last Modified: Wed, 22 Apr 2026 11:38:35 GMT  
		Size: 4.1 KB (4136 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:27ed526b79497785c933edc930c2f207e0d017f2587b2bfa89a32789c28ce30d`  
		Last Modified: Wed, 22 Apr 2026 11:38:37 GMT  
...
```console
$ docker pull nextcloud@sha256:758f1c6ee5777264c49ff14cf2b67e597e717407764470119931e9fa5d7d2d23
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 KB (46772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f75ad8f3fdd19ed84e333513d5dea32f527eed3b780680aa0238d56c0cc1ca1`

```dockerfile
```

-	Layers:
	-	`sha256:dabcb4c5795f48449f9e005ad1436e4aa27798beaff20f9c66ce08d0e122c13d`  
		Last Modified: Wed, 22 Apr 2026 11:38:34 GMT  
...
```console
$ docker pull nextcloud@sha256:613b3b49c17e0dc3968d70cac5d0f650f30f2c325e005f7149cb4472c03fbf93
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **565.3 MB (565270331 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a29e7534cefcc310074abca490b0c0f49eb53ed1b5ac8a34471729fa8fcfd01`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Apr 2026 18:28:23 GMT
CMD ["php-fpm"]
# Sun, 12 Apr 2026 14:45:38 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         busybox-static         bzip2         libldap-common         libmagickcore-7.q16-10-extra         rsync     ;     apt-get dist-clean;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data # buildkit
# Sun, 12 Apr 2026 15:15:19 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sun, 12 Apr 2026 15:15:19 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sun, 12 Apr 2026 15:15:19 GMT
...
# Sun, 12 Apr 2026 15:15:19 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libgmp-dev         libicu-dev         libjpeg-dev         libldap2-dev         liblz4-dev         libmagickwand-dev         libmemcached-dev         libpng-dev         libpq-dev         libwebp-dev         libxml2-dev         libzip-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure ftp --with-ftp-ssl;     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         ftp         gd         gmp         intl         ldap         pcntl         pdo_mysql         pdo_pgsql         sysvsem         zip     ;         pecl install APCu-5.1.28;     pecl install igbinary-3.2.16;     pecl install imagick-3.8.1;     pecl install --configureoptions 'enable-memcached-igbinary="yes"'         memcached-3.4.0;     pecl install --configureoptions 'enable-redis-igbinary="yes" enable-redis-zstd="yes" enable-redis-lz4="yes"'         redis-6.3.0;         docker-php-ext-enable         apcu         igbinary         imagick         memcached         redis     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'         | sort -u         | xargs -rt dpkg-query --search         | awk 'sub(":$", "", $1) { print $1 }'         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     apt-get dist-clean # buildkit
# Sun, 12 Apr 2026 15:15:20 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=${PHP_OPCACHE_MEMORY_CONSUMPTION}';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=8M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'apc.serializer=igbinary';         echo 'session.serialize_handler=igbinary';     } >> "${PHP_INI_DIR}/conf.d/docker-php-ext-igbinary.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     mkdir -p /docker-entrypoint-hooks.d/pre-installation              /docker-entrypoint-hooks.d/post-installation              /docker-entrypoint-hooks.d/pre-upgrade              /docker-entrypoint-hooks.d/post-upgrade              /docker-entrypoint-hooks.d/before-starting;     chown -R www-data:root /var/www;     chmod -R g=u /var/www # buildkit
# Sun, 12 Apr 2026 15:15:20 GMT
VOLUME [/var/www/html]
# Sun, 12 Apr 2026 15:15:20 GMT
ENV NEXTCLOUD_VERSION=33.0.2
# Sun, 12 Apr 2026 15:20:16 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://github.com/nextcloud-releases/server/releases/download/v33.0.2/nextcloud-33.0.2.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://github.com/nextcloud-releases/server/releases/download/v33.0.2/nextcloud-33.0.2.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     apt-get dist-clean # buildkit
# Sun, 12 Apr 2026 15:20:18 GMT
COPY *.sh upgrade.exclude / # buildkit
# Sun, 12 Apr 2026 15:20:18 GMT
COPY config/* /usr/src/nextcloud/config/ # buildkit
# Sun, 12 Apr 2026 15:20:18 GMT
...
-	Layers:
	...
	-	`sha256:ded2ad55814a4f1eb12dee4f88c8e63ff806bcfb57804b4b32b007ddc607fa61`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:93d47c4ac91ac595536c888c2ff8acc51bbecfcb288535a63e531bd6e1dbe911`  
		Last Modified: Sun, 12 Apr 2026 15:27:00 GMT  
		Size: 19.6 MB (19564605 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:16b085af5dca91240cbdf9c24c0de8906f051d1d218b3c0228c30a637be277e2`  
		Last Modified: Sun, 12 Apr 2026 15:27:07 GMT  
		Size: 45.9 MB (45927834 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bc486f51cdec9d26c3641ab7978b92385170eb8ad33812c540f3784851fd5148`  
		Last Modified: Sun, 12 Apr 2026 15:26:51 GMT  
		Size: 795.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:def8e1d2ebf7faf0b081480845938b557a6cacd66a6c99ca7b9965a3d67d8f74`  
		Last Modified: Sun, 12 Apr 2026 15:27:43 GMT  
		Size: 294.9 MB (294865849 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4f1fb37c475a9806c52ffaad04ecbc5230cbaeca9c1ff894a1d1cc58c80610aa`  
		Last Modified: Sun, 12 Apr 2026 15:26:54 GMT  
		Size: 4.1 KB (4134 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2f7053ae48c40fe04ea89abbd84410c869eb23a827ffcaf6351857290f32721a`  
		Last Modified: Sun, 12 Apr 2026 15:26:56 GMT  
		Size: 2.4 KB (2358 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull nextcloud@sha256:b882a20cba8b1f209a349d090462830c7b1e02651053a4ba41be243c57e44f70
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 KB (46772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:482680bd91305a20872ba15e5a74440045ce8aee421c6cfef4d2afdae0a3616e`

```dockerfile
```

-	Layers:
	-	`sha256:d917fada438b96c96b04c845862555aa481994f400b3be16065364f51bf6e371`  
		Last Modified: Sun, 12 Apr 2026 15:26:51 GMT  
		Size: 46.8 KB (46772 bytes)  
		MIME: application/vnd.in-toto+json
