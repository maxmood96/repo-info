...
### `nextcloud:26.0.3-fpm` - linux; arm64 variant v8
...
### `nextcloud:26.0.3-fpm` - linux; 386
...
### `nextcloud:26.0.3-fpm` - linux; mips64le
...
### `nextcloud:26.0.3-fpm` - linux; ppc64le
...
### `nextcloud:26.0.3-fpm` - linux; s390x
