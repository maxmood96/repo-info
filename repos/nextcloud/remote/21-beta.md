...
### `nextcloud:21-beta` - linux; arm variant v5
...
### `nextcloud:21-beta` - linux; arm variant v7
...
### `nextcloud:21-beta` - linux; arm64 variant v8
...
### `nextcloud:21-beta` - linux; mips64le
...
### `nextcloud:21-beta` - linux; ppc64le
