...
```console
$ docker pull nextcloud@sha256:472a4674a93a995fd57e9fd0ad50434e4926c72f772d0b2d07dc04f7d25e1616
```
...
```console
$ docker pull nextcloud@sha256:86b156279352639404a82811b81aeb68bb4d7d10c13bbace46f790847655824a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.8 MB (412822811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a56cbc3c6b78689208c4230de5653116552da03859c7dae4b23db4d99178438`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 18:58:00 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 18:58:05 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 18:58:07 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 18:58:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Oct 2024 18:58:07 GMT
...
-	Layers:
	...
	-	`sha256:9280a244f1131d1d1a66b4a92a9d12d7fe07fd49464faf6db9546b3404b09f20`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:709694ec20480fd5c311aee40e40168528cffd96fea867d63d700d9c3e23df59`  
		Last Modified: Fri, 18 Oct 2024 19:05:18 GMT  
		Size: 221.9 MB (221911384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29af81bd380f0b762be4a6849bffb7cff7976b370b8b02a62f6f0e32748604ba`  
		Last Modified: Fri, 18 Oct 2024 19:04:35 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:906e70885654617f47771be538d8707e635534eb5ecb1ea5c8b2dac69f9ae357`  
		Last Modified: Fri, 18 Oct 2024 19:04:35 GMT  
...
```console
$ docker pull nextcloud@sha256:054de73bdfff6ade4893b49891b84c0dfad9a9b7e93233d48099d1a0c2d69f3a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **434.7 MB (434740733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f277cac3dc0cd5be913afad87f5e2d07fdbf676f31f001ce229398754813a95`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Oct 2024 18:54:16 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 18 Oct 2024 19:04:07 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 19:05:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 19:05:11 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 19:05:11 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 19:05:11 GMT
...
-	Layers:
	...
	-	`sha256:af6fc650c0433d8bf5773ead3eeaad0815bd95a70299919d294fd85d0cf8100b`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f630368b3d96eb4896947d26fc9032cf46651e33079bf2774503046f8fc04af`  
		Last Modified: Fri, 18 Oct 2024 19:14:05 GMT  
		Size: 221.9 MB (221914259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f90678901e29e759b5cf0b6eb2026d5329737b6e893197e771b301e9a7515c9`  
		Last Modified: Fri, 18 Oct 2024 19:13:34 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48f6a9c73bcb6f2a21b425e4fccd3bf248d879fb6d7fc6f86c0900dc31f5388b`  
		Last Modified: Fri, 18 Oct 2024 19:13:34 GMT  
...
```console
$ docker pull nextcloud@sha256:aa917b8fe898256992eba1efa16a99c912124989e6fe67f773731677d859de88
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **442.0 MB (441951244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5bb9c1111d1b9ad13fddb58397cf07e97859983046c23a2e4a5757dee5db1ba`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 18 Oct 2024 19:05:38 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 19:06:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 19:06:53 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 19:06:53 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 19:06:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Oct 2024 19:06:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8ca971c574b51d4a7a144c2ebd7b6a1ae61bb5d564b94054ac91722cd2d92a44`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a292ed143bd792f1276ecee3213ceafd237def86d412f1ffbf8fe2ab6473e2db`  
		Last Modified: Fri, 18 Oct 2024 19:17:37 GMT  
		Size: 221.9 MB (221913019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b2d91a20808d818660e6981cf750fc1a4c74345e8e3741f5d0f7bb53ec9cbeb`  
		Last Modified: Fri, 18 Oct 2024 19:16:56 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9250717bce3a1e634ac8f743554ac23cc2bb91ef161c221d6f0f19b8a3a4fc4`  
		Last Modified: Fri, 18 Oct 2024 19:16:56 GMT  
		Size: 2.4 KB (2425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:342cf7b519190fd7d211454177518ea2c2c5be0801e916fdcfcb453352ac433f
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.9 MB (412895893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de3568fe153138e8d15dfa6c52363c27e38db4a1c43a5c4a65f6fc9e809faf3a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Oct 2024 18:48:55 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 18 Oct 2024 18:57:12 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 18 Oct 2024 18:57:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 18 Oct 2024 18:57:57 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 18 Oct 2024 18:57:58 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 18 Oct 2024 18:57:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 18 Oct 2024 18:57:58 GMT
...
-	Layers:
	...
	-	`sha256:e8977ab9ba414b0c9bffe58de6770c219d654eecaaa9bbe9deb85044c9e4ea8c`  
		...
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1e3621804a1f80e85a1f53518ecce5ccfbce7791985a5e6e4e8c3772236fedc`  
		Last Modified: Fri, 18 Oct 2024 19:06:08 GMT  
		Size: 221.9 MB (221911301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26aaf226c16e456576c7037039f384c072dafba94da2f47ae8e76595a52182e8`  
		Last Modified: Fri, 18 Oct 2024 19:05:40 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:544e33690b857f84e2b3e6a079c3e4171c730ac3c0c3f84f73f947dc72558848`  
		Last Modified: Fri, 18 Oct 2024 19:05:40 GMT  
		Size: 2.4 KB (2426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
