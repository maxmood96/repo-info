...
```console
$ docker pull nextcloud@sha256:4b7385ef60ceaf09bef2ab7a45fb71b6ab34965c792487ad319e81a3f387ae57
```
...
```console
$ docker pull nextcloud@sha256:2f62c68076726559a4284807e8be43a182a18dc8387266df99bad6265a05d697
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.8 MB (412816066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1649b4f127720d5180236b22e393a5bf3f6caffd0e610125bd2d5458ab3ab2ee`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 11 Oct 2024 17:54:04 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 11 Oct 2024 17:55:36 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Oct 2024 17:55:40 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 17:55:41 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 17:55:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 17:55:41 GMT
...
-	Layers:
	...
	-	`sha256:4f72b73036893b8fed472ae91ba1b3ff2c84695a8b5007a929ad81df0b0bb8b7`  
		...
		Size: 404.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:525fa31a4f2a81308e9590196acbfa3285d46049bb1c4d02065d7a104e8d6010`  
		Last Modified: Fri, 11 Oct 2024 18:03:38 GMT  
		Size: 221.9 MB (221911217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0af07310a44d13dc0320001c7b67869e64f988a679294658df08c8c48e0dc76d`  
		Last Modified: Fri, 11 Oct 2024 18:02:50 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c96289fbfa1576dee6969c30bf447eebd7cc46ce809ed7c794032e2d76bdd32`  
		Last Modified: Fri, 11 Oct 2024 18:02:50 GMT  
...
```console
$ docker pull nextcloud@sha256:f136bc47b5a4441c163370a8c9f2b45f0a73361074bb3fbdc8b66a4cbd1274bf
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **434.7 MB (434736595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:725148864930cab7ca512ece929aa3067dff11a8217d12bf63b5a8e5ff834ff3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 11 Oct 2024 19:07:15 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 11 Oct 2024 19:08:11 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Oct 2024 19:08:17 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 19:08:17 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 19:08:17 GMT
...
-	Layers:
	...
	-	`sha256:f0738272192781ce59ac8e7954070e2bd05aca250bbd960281eee154601cfa65`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cab1f352e1c464e12f3b24fecbec1b89e2f5eb3cac073fe49f790740656863c`  
		Last Modified: Fri, 11 Oct 2024 19:17:15 GMT  
		Size: 221.9 MB (221914261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eeed929d947bad010f226edf186b4a4c031c4f1f4cef56e6b3dc435fd041dc48`  
		Last Modified: Fri, 11 Oct 2024 19:16:44 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2378c5d8ce06afb84e450472bd845d6dbec353d5c34d55ef3630112987346ba3`  
		Last Modified: Fri, 11 Oct 2024 19:16:44 GMT  
		Size: 2.4 KB (2430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:31203f585f6545d00361992f7e2c026be9632150e358901ba56c8791508a89a2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **448.7 MB (448658945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:476c43409ae7af965e1c6e1a83b9420e7025dfdf17caebe655e36494ff7091aa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 11 Oct 2024 17:30:01 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 11 Oct 2024 17:31:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Oct 2024 17:31:13 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 17:31:14 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 17:31:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 17:31:14 GMT
...
-	Layers:
	...
	-	`sha256:9223efc0fdc20adace91d5e4a59735cf6b9bc8e53c85013ed48657097d902b03`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec892f46a2e95aa531569c77509e04ca525056a13ccc016978f5f04e17cebda7`  
		Last Modified: Fri, 11 Oct 2024 17:41:55 GMT  
		Size: 221.9 MB (221914954 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39de2b5fc2e361fdcdf542ede1b6e3ee0267acb3d3ebcf4c1ae2f794a8385946`  
		Last Modified: Fri, 11 Oct 2024 17:41:10 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6f8ba77f6f5a0763b192813f97ca8fc2af042cd622d7b6a775b6c93174469fe`  
		Last Modified: Fri, 11 Oct 2024 17:41:10 GMT  
...
```console
$ docker pull nextcloud@sha256:fb1ac83dd4ce7f20bbad1f46d3228baffae7832eeb4211413ca52cbc368443ea
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.9 MB (412891431 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c7dc7b5ebf6bad87c3bda13dae9932027554583f7757853c392d9c94b5b689e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Fri, 11 Oct 2024 18:48:50 GMT
ENV NEXTCLOUD_VERSION=29.0.8
# Fri, 11 Oct 2024 18:49:35 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.8.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 11 Oct 2024 18:49:41 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 11 Oct 2024 18:49:41 GMT
COPY multi:93b01dc08f932ab69c083ab6b8d729980a89506b7e3df93ddfc6a5a00a0106ff in /usr/src/nextcloud/config/ 
# Fri, 11 Oct 2024 18:49:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Oct 2024 18:49:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:dd5f7a0c22a437840e392ddacfac9f1e2db24450539031912597f990ee0c4441`  
		...
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d0d9cad6728e154954d1e70b14326313d60c8827346b8276cefd75a973e17ab`  
		Last Modified: Fri, 11 Oct 2024 19:03:08 GMT  
		Size: 221.9 MB (221911462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dac9b08ba5281b0aa7d244a9d17eed4bb6a91787db9ae5fbc5aaeb1fef2bfa8b`  
		Last Modified: Fri, 11 Oct 2024 19:02:43 GMT  
		Size: 3.9 KB (3879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:837a593f9274ffb92de235634a1a0a10624400b8f66a1b0cdcfacaed1526f105`  
		Last Modified: Fri, 11 Oct 2024 19:02:43 GMT  
