...
```console
$ docker pull nextcloud@sha256:3090a5e446cc273081bcd2e95adc5ebf5d84babf92523bf38dfa8446f25173fc
```
...
```console
$ docker pull nextcloud@sha256:821a56d6c017e18d42cd8338d7a5f05b301ea53d3ae6b0c0d5c0b57d5b32e603
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **443.9 MB (443899657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce6b44db67d5a93eafe0df81567b40f11db2bc96dfd3df9e252517c521db5e71`
...
# Thu, 06 Jun 2024 06:24:37 GMT
ENV NEXTCLOUD_VERSION=29.0.1
# Thu, 06 Jun 2024 06:25:33 GMT
...
-	Layers:
	...
	-	`sha256:6939c66ef76db1fb01bc25b7a318bc9473a16ee9ca8ade94652d0814214f66c7`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b242ed5e3d0e350f128a9246788c595d68104f3ce889dbd29bd07f8c96bee9a0`  
		Last Modified: Thu, 06 Jun 2024 06:33:10 GMT  
		Size: 222.5 MB (222497367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:614f1fb0bd8e1968af17b43b4c7569980a804c3586764dfe85117f00c906070c`  
		Last Modified: Thu, 06 Jun 2024 06:32:43 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:979bc44c7db9edd4f89f660e0e9737feba8fb1814bba346a23b456cc6aacb0ed`  
		Last Modified: Thu, 06 Jun 2024 06:32:43 GMT  
...
```console
$ docker pull nextcloud@sha256:a1ded0ff8a3ab7fca244c5e89d93b31317699df148966ced08318479160e1159
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **435.3 MB (435301231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3080efd0efbecc0b2e93b3d33fd2e4b803241574f435196d1caa2ecc5de24f8d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 06:25:24 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 06 Jun 2024 06:37:49 GMT
ENV NEXTCLOUD_VERSION=29.0.1
# Thu, 06 Jun 2024 06:38:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:38:46 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 06:38:46 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Thu, 06 Jun 2024 06:38:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 06 Jun 2024 06:38:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c025898882e93474c68d2576cf26c826f794d8548b648faab487260505036627`  
		...
		Size: 400.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:319b3c988ad28f680481f46e3a15ff1583a597dd7c57b355132d6f44f11a743b`  
		Last Modified: Thu, 06 Jun 2024 06:46:23 GMT  
		Size: 222.5 MB (222497048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5ca2f4cbeac2f8993df08cbec7858129454f99522ecdc8fb9032bad1929d8bd`  
		Last Modified: Thu, 06 Jun 2024 06:46:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb8c09948b6670f52135280d56f73ae7583ea59de2270a42f7056ec1bb8748aa`  
		Last Modified: Thu, 06 Jun 2024 06:46:02 GMT  
...
```console
$ docker pull nextcloud@sha256:0b90106136b4f2bdec421c2e6030df5782146e814377c084b38a456d919bb884
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **449.2 MB (449211193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb7374e8154493a98737f879d509c49acd21739f123e5662f423548689d94249`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 05:56:04 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 05:56:05 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:38c36350df32be6d103a4d34ace5bcf8fbf5145c53967c256896fe1cd9a8aaf0`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faf840c038dc0150cd37f859caa11a156d74d2f37ff3b5a610bd4e6608739c52`  
		Last Modified: Thu, 06 Jun 2024 06:05:31 GMT  
		Size: 222.5 MB (222498014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ed35c5c15314c4ded98c511822b0b4a4c24f1abb946d5950296f6cf2e3a0deb`  
		Last Modified: Thu, 06 Jun 2024 06:05:01 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d3be962e726cce916d64e0282c219f5a3eb1b791ba75b69cd0ee7193b1d02a4`  
		Last Modified: Thu, 06 Jun 2024 06:05:01 GMT  
...
```console
$ docker pull nextcloud@sha256:0b389565c41461f41a8da221f88a9b58336c6fb0fe9d4577b9826b8804d76f46
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **413.4 MB (413443839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2eb0c81275d7dacd6e3c7e3bb96b2736b0ce8859a9544921e65f2a41cec7d72`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 05:26:05 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 06 Jun 2024 05:35:37 GMT
ENV NEXTCLOUD_VERSION=29.0.1
# Thu, 06 Jun 2024 05:36:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 05:36:23 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Thu, 06 Jun 2024 05:36:24 GMT
COPY multi:325eebb30e6912e4cdbb030d4d22b6dd14fe18ca007f50df3afe27a136e1e383 in /usr/src/nextcloud/config/ 
# Thu, 06 Jun 2024 05:36:24 GMT
...
-	Layers:
	...
	-	`sha256:e742e673e8b3bd9d2a1ea15a64b1562d4c700f80bc8cbef56197309823249be5`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c900ebef40598bd04750c8e18788087bcfd15e932976b86c134c46aac6ae9a4`  
		Last Modified: Thu, 06 Jun 2024 05:43:03 GMT  
		Size: 222.5 MB (222495072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40dbf4c39d8fceb688328c7957ff756a437e12087b7248416a766c808b85ba1a`  
		Last Modified: Thu, 06 Jun 2024 05:42:38 GMT  
		Size: 3.6 KB (3612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a21e8ad53d15659d73540ae04441544f6ba6557b57e5c12cc044513c18152b8`  
		Last Modified: Thu, 06 Jun 2024 05:42:38 GMT  
		Size: 2.4 KB (2391 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
