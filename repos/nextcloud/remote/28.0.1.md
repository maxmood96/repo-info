...
```console
$ docker pull nextcloud@sha256:4bb51030421c1a4799023a85dfcf9990d78f4743cafd7f68fda1510fa1ef7dc8
```
...
```console
$ docker pull nextcloud@sha256:6f92c063ebcf403534f9335f110416540bfda2953f3815dda3c2c52a4ef13f7b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **420.6 MB (420558290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b481b48b2254e18ee9d814b96634dabcbe9e8527551d41bce6ede00f9f8702c7`
...
# Thu, 21 Dec 2023 22:33:28 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 22:34:33 GMT
...
-	Layers:
	...
	-	`sha256:940bc2505805709c793f5235be544ed013fb2f55746fd62dc7a76540c5b152de`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10739a9b66500089be6885a7a7c8fa0d02452a8a8ed2b8b1bdd0cf6cddbebd12`  
		Last Modified: Thu, 21 Dec 2023 22:38:09 GMT  
		Size: 199.3 MB (199264406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e92c349468286ade09fd02b5127ade2d7dc4fb94f95b59c5f54c812a3e473c4`  
		Last Modified: Thu, 21 Dec 2023 22:37:43 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f731643e928989b9ff109c8c8e42cc65333b533c28c97978457deb805a3aecc`  
		Last Modified: Thu, 21 Dec 2023 22:37:43 GMT  
...
```console
$ docker pull nextcloud@sha256:81da572a2437c30a1e263e938168a3f41d09dca06e0e5062b7b2dd8c86490113
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **378.5 MB (378503491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3b924bdb7709c7d3caaa1a425d3420c9e076c98666d0f8bae7b7f3f09985841`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 21 Dec 2023 23:13:17 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 23:14:29 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Dec 2023 23:14:33 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 21 Dec 2023 23:14:33 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 21 Dec 2023 23:14:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Dec 2023 23:14:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0a2e3a9f067e6966416378defc1a465b7886c390f084293aad71a724082c34e0`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6de110677d0cdeac2cd014bd5499c502102a50c3ebd6b0da1e5bc72822d03744`  
		Last Modified: Thu, 21 Dec 2023 23:18:33 GMT  
		Size: 199.3 MB (199261473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10063e01da47065c84bf61429ce9ff316889306df1a81cc57a539164aa7654c4`  
		Last Modified: Thu, 21 Dec 2023 23:18:00 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e594844891bc6bad915af79fffe7c2a21698c03bf44c73c7e88bb98061ee1e85`  
		Last Modified: Thu, 21 Dec 2023 23:18:00 GMT  
		Size: 2.3 KB (2339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:726bb80909e05843db8aa641ef04280c22cc308256d9b7edb1d5fc0168648dda
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **412.0 MB (411985401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cda95d29acb02f35cb7bab5392501d220dbc5e22de5bbec14283d8ee1c54a21`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Dec 2023 12:58:07 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 21 Dec 2023 22:39:58 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 22:40:57 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Dec 2023 22:41:02 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 21 Dec 2023 22:41:02 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 21 Dec 2023 22:41:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Dec 2023 22:41:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4ec34a46fc678ce7d0d6ebe4e49d00557c9cbeaf2809cc9d2c3b3dba1a2df69d`  
		...
		Size: 397.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab08ca91849128044c944d830016da29d8ba196cac4fb922038be936d8aeca80`  
		Last Modified: Thu, 21 Dec 2023 22:44:16 GMT  
		Size: 199.3 MB (199263589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daacca7f7c06ff07aee228b85d90dd68b96a782e41eff552d5f3f35feac4b2ac`  
		Last Modified: Thu, 21 Dec 2023 22:43:56 GMT  
		Size: 3.6 KB (3602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f01a9109c477c7ee924c14cc7f95c889ef66b95d26b91910ff3e1de549acb5a6`  
		Last Modified: Thu, 21 Dec 2023 22:43:56 GMT  
...
```console
$ docker pull nextcloud@sha256:a5a8c01cdbcd069bc38588b8e31272c5e872b082615d14db490338b507249e91
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **419.2 MB (419207950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b87d8e3359fd3b0d6c831308031b7f32bd65c62997473e0251643dfdb8687ed`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 21 Dec 2023 22:38:40 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 22:39:57 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Dec 2023 22:40:01 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 21 Dec 2023 22:40:01 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 21 Dec 2023 22:40:01 GMT
...
-	Layers:
	...
	-	`sha256:15ac4598b753acc323803577074f8ce0eddd484037aa9840c9d2ff71794a5b8f`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65bbd793b9b1f4f005b457519709187c417f1fbde27c887169578417c717f941`  
		Last Modified: Thu, 21 Dec 2023 22:44:03 GMT  
		Size: 199.3 MB (199263087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e33c875406c88812b04eea4f79319d385d3ba16153f0f4556da6c5b0d906928c`  
		Last Modified: Thu, 21 Dec 2023 22:43:24 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42de48b2cdd5a1e8f825bc843fa79dcc230083767f9f16cedeb02e153182bfc7`  
		Last Modified: Thu, 21 Dec 2023 22:43:24 GMT  
...
```console
$ docker pull nextcloud@sha256:73024be08f163b8d4393a93e29a1124005da2be6064d4a6ec76061e514508990
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **391.9 MB (391853030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d83c7863e482833c2cea2868f035eef9f43a08f1a1f4661986b9f8b9989949b2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 21 Dec 2023 22:30:43 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 22:34:08 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Dec 2023 22:34:21 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 21 Dec 2023 22:34:31 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 21 Dec 2023 22:34:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Dec 2023 22:34:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7f5def3b8bd238bdeed4c5831214e2df31e87c14b64c3ba6b198b3e3551bae84`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d206a00cd00da1a4ee6853c0b37f13ea906099f889c3dc5d2d477a9b901d781a`  
		Last Modified: Thu, 21 Dec 2023 22:42:06 GMT  
		Size: 199.0 MB (199033155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b52d220a90da3af536cc4f6134b7d5646dbff11a662efd4862201f5a224cec08`  
		Last Modified: Thu, 21 Dec 2023 22:40:09 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42a858964b2445ac33eef98b37af7bd076c9793c67f02627648c97fe6dd08561`  
		Last Modified: Thu, 21 Dec 2023 22:40:09 GMT  
...
```console
$ docker pull nextcloud@sha256:dfe04d569d0ca8da7975eb672cad5db935cbe2fce6304aa43d331431e77d0791
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **425.9 MB (425902866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c05cbd874ff7c3ab9d2149dbd53677d1e97aed73b73dd2bd1f02e7f08771571b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 21 Dec 2023 22:31:30 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 21 Dec 2023 22:32:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 21 Dec 2023 22:33:02 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 21 Dec 2023 22:33:03 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 21 Dec 2023 22:33:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Dec 2023 22:33:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f9ff5aa33c1edf0c4a61fa1d0cc8c7fb5d7ecfb804b1e6787f8cbb6254ae0e43`  
		...
		Size: 403.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27536aacae014c60fb67c91eef9ff37f7c52afcaa1e1b982aa9379ad4514ef39`  
		Last Modified: Thu, 21 Dec 2023 22:37:43 GMT  
		Size: 199.3 MB (199265560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20a7adeecb43b0b3c40b4f09fa54fbe3e94304e42bc389ef9d9e7a93235ea236`  
		Last Modified: Thu, 21 Dec 2023 22:37:16 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8672e1aa08412d6f09e40665f7312760777b0215d78a1fad6e70d5f03a4978ac`  
		Last Modified: Thu, 21 Dec 2023 22:37:16 GMT  
...
```console
$ docker pull nextcloud@sha256:93199a869b327aad2cd2e77bd26c9db9e68b2090cb88fef4b17baba05fb6639e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **390.5 MB (390457611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cae4a89b5ab54de2812052b9277ad6c5344637de7419c115081a429cce66edd2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 28 Dec 2023 01:16:05 GMT
RUN {      echo 'LimitRequestBody ${APACHE_BODY_LIMIT}';     } > /etc/apache2/conf-available/apache-limits.conf;     a2enconf apache-limits
# Thu, 28 Dec 2023 01:26:32 GMT
ENV NEXTCLOUD_VERSION=28.0.1
# Thu, 28 Dec 2023 01:27:14 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-28.0.1.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Dec 2023 01:27:25 GMT
COPY multi:33245dda9914c697edf261333e6abe0320257de54990d409c7632f9d748706ef in / 
# Thu, 28 Dec 2023 01:27:26 GMT
COPY multi:ffab9c7fb870f8a1f547541da03d0d97f332d340509375f5162b302677413cfc in /usr/src/nextcloud/config/ 
# Thu, 28 Dec 2023 01:27:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 28 Dec 2023 01:27:26 GMT
...
-	Layers:
	...
	-	`sha256:331560373cd5d4033ed00b6e622769991aa80a2395cd26fc6452d860d1c0848f`  
		...
		Size: 402.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:761e89ef4bdc399fca6d58ec868398c349fb31e79624e09353f78015e4cd2cec`  
		Last Modified: Thu, 28 Dec 2023 01:33:44 GMT  
		Size: 199.3 MB (199261790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e10e755e95d1fcb356353350cceb9ee10f0acb22caf326c8cdad7cffa120cb5`  
		Last Modified: Thu, 28 Dec 2023 01:33:22 GMT  
		Size: 3.6 KB (3601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e877d64e9fc697b4d9240f7de8f69a3f65d3804c599b6e7944b918b9952cc439`  
		Last Modified: Thu, 28 Dec 2023 01:33:23 GMT  
		Size: 2.3 KB (2337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
