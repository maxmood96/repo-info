...
```console
$ docker pull nextcloud@sha256:758b8286a5d14cd139fe6af8e02a585b8a7b3fff185f6d6a1ab5e940bad17e90
```
...
```console
$ docker pull nextcloud@sha256:cc1fe8609acf9d279b74fb611531742570ce4a9ea23bab0d9b9295836866abc1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.4 MB (250375894 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc161695e9ae9504bf9edc630d700feb771eefa75b0d89d9e012d1383744bade`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 10:35:43 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Sat, 27 Jan 2024 10:36:56 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 10:37:00 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 27 Jan 2024 10:37:03 GMT
COPY multi:e2108418386ce49b316822e92349de3d16e463b4ec8eff24de2c059d99b38b92 in /usr/src/nextcloud/config/ 
# Sat, 27 Jan 2024 10:37:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 10:37:03 GMT
...
-	Layers:
	...
	-	`sha256:1e70a178016138c17eb66b889d6e542a91579f5f9f55dcc1c01734dcdf117225`  
		...
		Size: 756.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:078b98bce7d5dfcbbd44442e9b00c9739df9d11d9caef3867c272263966fef1c`  
		Last Modified: Sat, 27 Jan 2024 10:42:00 GMT  
		Size: 176.9 MB (176904885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2159833694dd3ec0a2037f243c5958bb308ab41edbcc1a2ec11a517856e2db5a`  
		Last Modified: Sat, 27 Jan 2024 10:41:25 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25cd668fcd343cd0993ad5834b56961fa6e466c1ac8b346ceab13c7064f1d1f3`  
		Last Modified: Sat, 27 Jan 2024 10:41:25 GMT  
		Size: 2.3 KB (2303 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:2f323980e9918520755b863cfcd466f6f39497a0de38c55214db07c4ebee0dab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.4 MB (259368066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4753c21481a68081307893dc97e963d55d30053f9026a4e445fc82605e60fae6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 10:42:12 GMT
ENV NEXTCLOUD_VERSION=26.0.11
# Sat, 27 Jan 2024 10:43:01 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-26.0.11.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 10:43:08 GMT
COPY multi:9585a9602f24ff6c37b7e8821d7e5fca4a450cd9cc8c66163bc629028ca3df5c in / 
# Sat, 27 Jan 2024 10:43:08 GMT
COPY multi:e2108418386ce49b316822e92349de3d16e463b4ec8eff24de2c059d99b38b92 in /usr/src/nextcloud/config/ 
# Sat, 27 Jan 2024 10:43:08 GMT
...
-	Layers:
	...
	-	`sha256:eb632d754f0cdffcf145fe4d390ad0ab993c0450d8dad73dd500ee89cb5b0684`  
		...
		Size: 755.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:349452c3bf881bfbac6e05a16bb037fa2f316a330e61560ff3a0665b74f3d07b`  
		Last Modified: Sat, 27 Jan 2024 10:46:25 GMT  
		Size: 176.9 MB (176905708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e02b1dba04bae601a11ad6aff5778fff87869ab654e017770214c47f28803f`  
		Last Modified: Sat, 27 Jan 2024 10:46:08 GMT  
		Size: 3.6 KB (3613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8b4019db2accc83a9f083769ad012281b7b01023e740ea748a0d344e5c4f3e5`  
		Last Modified: Sat, 27 Jan 2024 10:46:08 GMT  
		Size: 2.3 KB (2302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
