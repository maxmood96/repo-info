...
```console
$ docker pull nextcloud@sha256:8536e8d6c6516e4ce68430f688739427fb835f4dcbb9653a8670d5e5034384df
```
...
```console
$ docker pull nextcloud@sha256:7848438f995334e4831139eace1066bb5a8f20209a791fd8939d7e137150892c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.8 MB (228826146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3be219f3c296ed55bd3ee6695b14e873ce8b85c2775dd306e957578cd827b5f7`
...
-	Layers:
	...
	-	`sha256:570e26dafc693f5754873e637be27ae12fd9cb69b7346a235de42830ed304244`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4728c5872fa86926e70ac13ec312ad771102d05ee73f78b4bd9d93c23233359`  
		Last Modified: Thu, 19 Dec 2019 05:24:52 GMT  
		Size: 62.0 MB (62020543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39d1c4655092e4df00d1c7e2ec831796b820ef8be633ff245d70affea517ebac`  
		Last Modified: Thu, 19 Dec 2019 05:24:35 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c35d67e0b61a64d46f938a2ac7b737f82a0a6700130ae2aa884bb5ae2e99e5b`  
		Last Modified: Thu, 19 Dec 2019 05:24:35 GMT  
...
```console
$ docker pull nextcloud@sha256:df4f24b64c6ae02540709bbe7b45727e4d1a36f0db1478323c6c4f61b7207555
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.7 MB (201735342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ec67a8f8befb543f7c4b39215daa81ddae50c2eed8ad70496be28ad6f2fa8bc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Dec 2019 03:50:27 GMT
ENV NEXTCLOUD_VERSION=15.0.14RC1
# Thu, 19 Dec 2019 03:52:15 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 03:52:21 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
...
-	Layers:
	...
	-	`sha256:11c85cc532f08e51f287ee4c39cf2874ff63f815ec4f994d1cf01b3af4942008`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e27349929f40ac18d5b3dba5130657a9653198d64cea2b21286d781d88ad42cc`  
		Last Modified: Thu, 19 Dec 2019 04:48:46 GMT  
		Size: 62.0 MB (62019941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1088ccfbe93fec9d4f29abcfcf0e4e292c49a63150dbcc747ae6183f5f71c05`  
		Last Modified: Thu, 19 Dec 2019 04:48:25 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:159d20b44e265dc38fa7c924a9d4b502bc76dbbf51ab642069f986c295027607`  
		Last Modified: Thu, 19 Dec 2019 04:48:25 GMT  
...
```console
$ docker pull nextcloud@sha256:8aff272ed18bf0103fc4deb4f934a7242083ea72a1d32a5ab074ef7a6b8a1266
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.2 MB (219155170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:213dec25615173a532cd96b01cdd5f771e6ddb036056f1b09862f0a912fb0e0b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Dec 2019 04:49:08 GMT
ENV NEXTCLOUD_VERSION=15.0.14RC1
# Thu, 19 Dec 2019 04:49:49 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 04:49:54 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Thu, 19 Dec 2019 04:49:56 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Thu, 19 Dec 2019 04:49:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Dec 2019 04:49:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1c3760c7db8d2166d2a7b8974cd9dfb955556fc68ea9e17450b3a4c41ea2292c`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f63196174b37fe622c5e8d4cb1f9d0c7d1e3afcc80b3bb64adabe93009944350`  
		Last Modified: Thu, 19 Dec 2019 05:45:06 GMT  
		Size: 62.0 MB (62020053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f876bb367d8ec0cfc1547c934e0eec76e1a906f1311e3d94bbb72e20fff904`  
		Last Modified: Thu, 19 Dec 2019 05:44:45 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:639bbbc09c47f4d30dcf6349b396c5c5f3977c17f5e56418d1650cd5bb5a2e99`  
		Last Modified: Thu, 19 Dec 2019 05:44:45 GMT  
...
```console
$ docker pull nextcloud@sha256:f72c3b78644cce256e67a801c93fd0c30fd7df66a013866d6847cde8f421c1fe
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.1 MB (234139901 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3876948fc8de80ea3187d81de87dc7ebccbc2c277e5b4773904b5e5f91c2c196`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 19 Dec 2019 05:13:19 GMT
ENV NEXTCLOUD_VERSION=15.0.14RC1
# Thu, 19 Dec 2019 05:13:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 05:13:48 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Thu, 19 Dec 2019 05:13:49 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Thu, 19 Dec 2019 05:13:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Dec 2019 05:13:49 GMT
...
-	Layers:
	...
	-	`sha256:4ad3bc36076c356ff33d35552ef8e7d97df0c3171e683721a9392a8a6510d7b8`  
		...
		Size: 535.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:122b64b792238d1de68215f6409bb7ecf7ac27cdf21efda4e4a6bc9dae98f37e`  
		Last Modified: Thu, 19 Dec 2019 05:43:22 GMT  
		Size: 62.0 MB (62019842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4894f062bd4f693b8861220a8c28ec730f08539230b8cc583d874e5d1189a73`  
		Last Modified: Thu, 19 Dec 2019 05:43:01 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d56b576ba973625883975051f4de475b08a9946c73d456d958c61d9c81f8eb27`  
		Last Modified: Thu, 19 Dec 2019 05:43:01 GMT  
...
```console
$ docker pull nextcloud@sha256:e859804d678477a95444b39a87c756d057ee59da85473a8b26206d9fa48c7d56
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.4 MB (240406197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7918c41e7003eaf0f8f394b291938817c5d220f211c5b2db83524fb27b73d312`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 19 Dec 2019 04:47:46 GMT
ENV NEXTCLOUD_VERSION=15.0.14RC1
# Thu, 19 Dec 2019 04:49:09 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 19 Dec 2019 04:49:13 GMT
COPY multi:c7a3d262688197634c30c3eb0f5c04491be903f7b01bd82d9bb7a16915934dec in / 
# Thu, 19 Dec 2019 04:49:15 GMT
COPY multi:7eb7fef5c035fb14c3e35cf457ad436ecc70d6774faa6fef8a85e74984284c7d in /usr/src/nextcloud/config/ 
# Thu, 19 Dec 2019 04:49:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 19 Dec 2019 04:49:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:462db8047ccbefe6123191cf389802e494b1c52d4fd9f127e9021a181e8d0023`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c7bc64625417e3d900a511c9455c9ac302b5a338fe4e8f55116e78d39566354`  
		Last Modified: Thu, 19 Dec 2019 06:00:47 GMT  
		Size: 62.0 MB (62021992 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f305b6105d74e066da8409155a76a3b93a2add0c69e5b0a0e11cbf98063c1549`  
		Last Modified: Thu, 19 Dec 2019 05:59:47 GMT  
		Size: 2.1 KB (2098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d15b29034d49dc084c73d4e2ef8d87dfbf2e0225a3e4b43a162bfa45b6835d7e`  
		Last Modified: Thu, 19 Dec 2019 05:59:47 GMT  
		Size: 1.1 KB (1137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
