...
```console
$ docker pull nextcloud@sha256:a8dab1c02f3b5aa40abdd12f70a8dec69a998bcf6e63ca024a573a4e59a63be9
```
...
### `nextcloud:29.0.2-apache` - linux; arm variant v5
...
### `nextcloud:29.0.2-apache` - linux; arm variant v7
...
### `nextcloud:29.0.2-apache` - linux; arm64 variant v8
...
### `nextcloud:29.0.2-apache` - linux; 386
...
### `nextcloud:29.0.2-apache` - linux; mips64le
...
### `nextcloud:29.0.2-apache` - linux; s390x
