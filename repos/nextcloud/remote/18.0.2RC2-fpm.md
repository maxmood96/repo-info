...
### `nextcloud:18.0.2RC2-fpm` - linux; amd64
...
### `nextcloud:18.0.2RC2-fpm` - linux; arm variant v5
...
### `nextcloud:18.0.2RC2-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.2RC2-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.2RC2-fpm` - linux; 386
...
### `nextcloud:18.0.2RC2-fpm` - linux; ppc64le
