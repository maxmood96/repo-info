...
```console
$ docker pull nextcloud@sha256:3f9da9de1bb28b07c4a58451ce8faaf9b62c0adc9685652d1d9374318d9c177a
```
...
### `nextcloud:33.0.1` - unknown; unknown
...
### `nextcloud:33.0.1` - linux; arm variant v5
...
### `nextcloud:33.0.1` - linux; arm variant v7
...
### `nextcloud:33.0.1` - linux; arm64 variant v8
...
### `nextcloud:33.0.1` - linux; ppc64le
