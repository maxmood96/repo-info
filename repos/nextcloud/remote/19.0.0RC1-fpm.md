...
```console
$ docker pull nextcloud@sha256:ab04e5d9549324b02f9c00529fb753e557279653df792fe4aecbe4046145ec48
```
...
```console
$ docker pull nextcloud@sha256:c277c49f3f55ca2cc473b16657cb4565482d10910ffa50bf1c68927c3f6f5f77
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.5 MB (272510868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c98f77cc49f4e7c96d7d9beaf071c8bc00ca35acd480d1faf46ccf6e7a21a769`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Mon, 18 May 2020 21:52:34 GMT
ENV NEXTCLOUD_VERSION=19.0.0RC1
# Mon, 18 May 2020 21:56:03 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Mon, 18 May 2020 21:56:12 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Mon, 18 May 2020 21:56:14 GMT
COPY multi:965c5cb843579fcde0cf3c9edb975639cbd2d55de5f645b1061d46855979394d in /usr/src/nextcloud/config/ 
# Mon, 18 May 2020 21:56:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 18 May 2020 21:56:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9d9f7dd9e9515714363529a7f5d66e1792a236e0dd621c2becd1e38e2b95339f`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f060cd2028566ae5cd01963932358b5e5b51cef4a289c64890ba1347909ec04b`  
		Last Modified: Mon, 18 May 2020 22:28:36 GMT  
		Size: 98.4 MB (98434681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6081a85d34449e11e0d786e2f3c517e8a7471407665e4e31b23c49b4fe746ab7`  
		Last Modified: Mon, 18 May 2020 22:26:33 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcb613af0e7421a93159186658f80635284adeda3274a61b4ec1f3703bddc049`  
		Last Modified: Mon, 18 May 2020 22:26:33 GMT  
		Size: 1.4 KB (1368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
