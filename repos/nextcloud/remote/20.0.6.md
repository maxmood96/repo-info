...
```console
$ docker pull nextcloud@sha256:70afa3370ea64aba127f2c2d750ce649300944535e2e1e73b87fa2e1e720f0c4
```
...
### `nextcloud:20.0.6` - linux; arm variant v5
...
### `nextcloud:20.0.6` - linux; arm variant v7
...
### `nextcloud:20.0.6` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:349cc24fa0dd7fd643cc6b3678427867674b06378b728373f593e66c82b934fa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.2 MB (270187972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0cdfe2b05dc000e21bc4867aaeb1e5eed9cb830abbe56ec3caf22ebcfba1acb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 01:53:51 GMT
ENV NEXTCLOUD_VERSION=20.0.6
# Tue, 26 Jan 2021 01:54:43 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 01:54:47 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 01:54:51 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 01:54:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 01:54:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:10137165d72c7f94d7c7ad534ec4ee1ec8c05d189924a0cb0185189522e74deb`  
		...
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b1487035deb4860b66e6604bb82926649f2bccc457de1477a8ab4b07778960c`  
		Last Modified: Tue, 26 Jan 2021 02:05:33 GMT  
		Size: 114.8 MB (114756806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20a90894e0f3904b56b39dffb37a693789e9bfc302d06d824ccdd9a4ec65dfd5`  
		Last Modified: Tue, 26 Jan 2021 02:05:04 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec0fd8794c7867ea6ce1aac0dfb42b365e2dc06304183afc686a1f8b657d1e4d`  
		Last Modified: Tue, 26 Jan 2021 02:05:04 GMT  
		Size: 2.0 KB (1959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0.6` - linux; 386
...
### `nextcloud:20.0.6` - linux; mips64le
...
### `nextcloud:20.0.6` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:e31d7eda0712b8f23d74881907c110b87fd1354d22bc81eae0d1f9fc531bf168
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.3 MB (291348172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:564be142047153e8129b9942b36785cbc7e6d302aa3090c11c0911fb94422562`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 26 Jan 2021 01:58:48 GMT
ENV NEXTCLOUD_VERSION=20.0.6
# Tue, 26 Jan 2021 02:02:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 26 Jan 2021 02:02:36 GMT
COPY multi:735a0b44f536c26b775ae5b6d0dc6331e21972d82c38b6571980561dc6f483ee in / 
# Tue, 26 Jan 2021 02:02:38 GMT
COPY multi:5bcb7c9bf9863967cc233b35fb2aea18e0a08c7b8c47047f1c232bf3c4ef0f76 in /usr/src/nextcloud/config/ 
# Tue, 26 Jan 2021 02:02:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 26 Jan 2021 02:02:48 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:83953fee9bd6d261e7105055c5ca28e095f088284c5fd70fc9256b937d176692`  
		...
		Size: 590.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95d35171dc0717f8c999587231eeb33c08cd09b930c705c83d02a39ae1b555fe`  
		Last Modified: Tue, 26 Jan 2021 02:38:32 GMT  
		Size: 114.8 MB (114760101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec08a56fd209ef7e29cd5a214eb4fe9b823e6d742494524a26b3ad24bac851e7`  
		Last Modified: Tue, 26 Jan 2021 02:36:23 GMT  
		Size: 2.5 KB (2532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:940bd748671b1a7b768751e3cbb0c07b7476ced6e885d849d48c9c9a0403ba8a`  
		Last Modified: Tue, 26 Jan 2021 02:36:23 GMT  
		Size: 2.0 KB (1956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:20.0.6` - linux; s390x
