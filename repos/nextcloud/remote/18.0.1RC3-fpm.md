...
```console
$ docker pull nextcloud@sha256:52e47906ec2db65e7684413ace43778f9b01e4847541e9d0c5ffa13419d31416
```
...
### `nextcloud:18.0.1RC3-fpm` - linux; amd64
...
### `nextcloud:18.0.1RC3-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.1RC3-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.1RC3-fpm` - linux; 386
