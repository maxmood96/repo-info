...
```console
$ docker pull nextcloud@sha256:867b33a5cefc9248b166e456fc689bf914012764d06df0fe74774b9a974edfd9
```
...
### `nextcloud:22.2.2-fpm-alpine` - linux; amd64
...
### `nextcloud:22.2.2-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:22.2.2-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:22.2.2-fpm-alpine` - linux; 386
