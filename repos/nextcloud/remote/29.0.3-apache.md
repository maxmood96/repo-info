...
### `nextcloud:29.0.3-apache` - linux; arm variant v5
...
### `nextcloud:29.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:29.0.3-apache` - linux; 386
...
### `nextcloud:29.0.3-apache` - linux; mips64le
...
### `nextcloud:29.0.3-apache` - linux; ppc64le
...
### `nextcloud:29.0.3-apache` - linux; s390x
