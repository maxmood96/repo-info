...
```console
$ docker pull nextcloud@sha256:2c30538d0558278a6d535896b2201849f45f16d207db0e7e6f7b32d8e7f1b2ab
```
...
```console
$ docker pull nextcloud@sha256:b914d22a8a2a41e60d4e16762c5d764bdfe29432081033aa15a905cff5b300c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.3 MB (219307078 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:751632740b6e0143fdbc73e1603e1d795bb8f7ae60782284a205aa19a02b7900`
...
# Fri, 24 Feb 2023 02:21:52 GMT
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 02:24:26 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Fri, 24 Feb 2023 02:25:08 GMT
...
-	Layers:
	...
	-	`sha256:9ea182ac67a10738a4a4e4aafc7a5c67f60ea775342f7176447864a4480a1f7e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dac69daf66fedd3d0cc79e5ead1e3586c475b2c03eef25b6f1356d08f71929c`  
		Last Modified: Fri, 24 Feb 2023 02:30:10 GMT  
		Size: 612.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:455cba2c3bb8c1a83de6fe38df32a6463050034f0d0518741ce7f1aa9a7acfd5`  
		Last Modified: Fri, 24 Feb 2023 02:32:02 GMT  
		Size: 134.8 MB (134835190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e550a0162426439ba8e2ce65f2d0de3c1c0ce330e0b4fcdbc5a7e30d6d152d8d`  
		Last Modified: Fri, 24 Feb 2023 02:31:47 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9133efca0656cf0c42e958d3e7ddc02078b778d9db0dd63157fd3a36991f80a4`  
		Last Modified: Fri, 24 Feb 2023 02:31:47 GMT  
...
```console
$ docker pull nextcloud@sha256:cf5aa655795346f6e87b519718677d641427e4bcbc9151448fefbc8fa1741ed0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.6 MB (212574477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdea419995a157019ddbc89ca7fc03bdc71f8814000501bab9660fa0ee80bb66`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 24 Feb 2023 01:49:37 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 24 Feb 2023 01:49:38 GMT
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 01:50:39 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Fri, 24 Feb 2023 01:51:17 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Feb 2023 01:51:22 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 24 Feb 2023 01:51:22 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 24 Feb 2023 01:51:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Feb 2023 01:51:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f060142cedb043f6e385be82be4671a6aac4933ecde2e70d91df438bb7f7a0c8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8dd56beedec8bbf27cf20bf6224fea862a27d71147162836e4ee0fd8fbf5e6c`  
		Last Modified: Fri, 24 Feb 2023 01:53:06 GMT  
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9966677e188f4d89ba1ebd26264aa5d80f046180819759d517f8ef967c35fd8c`  
		Last Modified: Fri, 24 Feb 2023 01:54:17 GMT  
		Size: 134.8 MB (134835369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f9b9721d11db42174366675b3fed50586812d4b2cac0b7db695afdc2d123645`  
		Last Modified: Fri, 24 Feb 2023 01:53:52 GMT  
		Size: 3.2 KB (3240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff0da382f0af7c9928beb0394f3b3a54a90242b651341de644af58b6eaed8e6a`  
		Last Modified: Fri, 24 Feb 2023 01:53:52 GMT  
...
```console
$ docker pull nextcloud@sha256:053f059fcf8881978553e6f7ea1d6342e9728d1873e24435fbe2fb15d29981a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.6 MB (209555220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb3ba5b93ffdf0bf6012a0b73e626a2c1d11524def83246a6b58527c0ee898a1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Mar 2023 22:53:17 GMT
CMD ["php-fpm"]
# Thu, 02 Mar 2023 09:11:18 GMT
RUN set -ex;         apk add --no-cache         rsync         imagemagick     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Thu, 02 Mar 2023 09:13:27 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Thu, 02 Mar 2023 09:13:27 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 02 Mar 2023 09:13:27 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 02 Mar 2023 09:13:28 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 02 Mar 2023 09:13:28 GMT
VOLUME [/var/www/html]
# Thu, 02 Mar 2023 09:16:36 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Thu, 02 Mar 2023 09:17:17 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 02 Mar 2023 09:17:20 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Thu, 02 Mar 2023 09:17:20 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 02 Mar 2023 09:17:20 GMT
...
-	Layers:
	...
	-	`sha256:49fd760caa2ac2f75d335377024ca94ec6a52f2a687e2d3d49f27f3dc4916cf6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c688ce301391694679e175c9bcac72bfa4dfb64d7751786c101fb6222918ec9d`  
		Last Modified: Thu, 02 Mar 2023 09:30:50 GMT  
		Size: 41.1 MB (41052894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d602715ad3a9f78396820f50001aad4e25a3178c96d6da919e106fab87bfd4be`  
		Last Modified: Thu, 02 Mar 2023 09:30:44 GMT  
		Size: 8.5 MB (8478835 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c980fc1f6dce1a131a513ad63015ba310b8843a49d14ce9ce3fed427c2bda1bc`  
		Last Modified: Thu, 02 Mar 2023 09:30:43 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca2e7bf3a61d7bdf71eed7f8b8a8501e2fda50de5e21c65d0f82d32850f25961`  
		Last Modified: Thu, 02 Mar 2023 09:33:01 GMT  
		Size: 134.8 MB (134835379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:572e8847f0079ec9c3079a0592aa3740f1bb9373b5f5a31399b981a56c4d81e4`  
		Last Modified: Thu, 02 Mar 2023 09:32:40 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:865ce78c6f842d3e3873e3068fdf4eac10602940530528b9b3a41e67fbd74bc4`  
		Last Modified: Thu, 02 Mar 2023 09:32:40 GMT  
...
```console
$ docker pull nextcloud@sha256:c46014fb5f646ea88335b53868712d0ca1a46dbf430d1f1a8d4c359e102ae9e5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.7 MB (216680778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b875d97ea6ebdd86b43ec272da9e05bc119dc892904ddd1b7ca475df7493a42b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 15 Feb 2023 01:15:58 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 24 Feb 2023 01:41:42 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 24 Feb 2023 01:41:42 GMT
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 01:44:06 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Fri, 24 Feb 2023 01:44:42 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Feb 2023 01:44:45 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 24 Feb 2023 01:44:45 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 24 Feb 2023 01:44:45 GMT
...
-	Layers:
	...
	-	`sha256:52f91491e53862d56e569644e303df78f98c29264123faba3f5befabfa3a5439`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27f4a2568a32df74deade9c7dbd0087358eec388b7d0c90d9a5304d3305191db`  
		Last Modified: Fri, 24 Feb 2023 01:49:43 GMT  
		Size: 610.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b693fff725005c5ce8be087a4c2b2fbe1a4f6cca2be9de345d132083396bee5`  
		Last Modified: Fri, 24 Feb 2023 01:51:31 GMT  
		Size: 134.8 MB (134834911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5c28bd1c3fac4e32220fa12bb9d25581b8d0430cf80104073e65fb1fed92bee`  
		Last Modified: Fri, 24 Feb 2023 01:51:18 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e01e478586ed2c51cc956b445f5e5294b48327d99f7f1b53d7f8f558dac0217`  
		Last Modified: Fri, 24 Feb 2023 01:51:18 GMT  
...
```console
$ docker pull nextcloud@sha256:e362d69cfd8c5cd1cd75184bf4454c008a26e4e8c878622df825e649c977f613
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.3 MB (218331845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c044e228e2f4a407367a23b2f4ec93c26e7babd69e89347fd35013502fb0d74c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Mar 2023 18:04:51 GMT
CMD ["php-fpm"]
# Thu, 02 Mar 2023 09:20:18 GMT
RUN set -ex;         apk add --no-cache         rsync         imagemagick     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Thu, 02 Mar 2023 09:23:32 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Thu, 02 Mar 2023 09:23:33 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 02 Mar 2023 09:23:33 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 02 Mar 2023 09:23:33 GMT
...
# Thu, 02 Mar 2023 09:23:33 GMT
VOLUME [/var/www/html]
# Thu, 02 Mar 2023 09:26:34 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Thu, 02 Mar 2023 09:27:24 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 02 Mar 2023 09:27:27 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Thu, 02 Mar 2023 09:27:27 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 02 Mar 2023 09:27:27 GMT
...
-	Layers:
	...
	-	`sha256:a9eedf77fc2bb8192e0118899721a750ba2ff4b57d5ea399a32fa69463eee9b0`  
		...
		Size: 8.7 KB (8676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da6bb02cc18d6c32941d1db777712a3e14adc5187a10d892e347399eba5a7c8c`  
		Last Modified: Thu, 02 Mar 2023 09:44:04 GMT  
		Size: 46.0 MB (46044709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f48db7ae1f3bad963992a33caf865bf30d2cfccbf4d2828740fe161f7685c52`  
		Last Modified: Thu, 02 Mar 2023 09:43:53 GMT  
		Size: 9.6 MB (9618972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6645577d90e01a33c43da8d8e3abb7c05656c33405282a075c906234ffdcf04e`  
		Last Modified: Thu, 02 Mar 2023 09:43:51 GMT  
		Size: 609.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6531e2248a1471de36ad69efe7928ab4e6a33c8b1fa7afe043538af74081befb`  
		Last Modified: Thu, 02 Mar 2023 09:46:27 GMT  
		Size: 134.8 MB (134835366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d126cc1b8ef5066921d5a888167a9ed465f78112a69488705a9dfe1fb7285fc3`  
		Last Modified: Thu, 02 Mar 2023 09:46:04 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eb3c6cfbbac3254af69dc6397bbac7c6cb6961d539c8eef001a9a63ee0ddfca`  
		Last Modified: Thu, 02 Mar 2023 09:46:04 GMT  
		Size: 2.2 KB (2153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:917d508326423682cc4fd1c2c909ac0c9a4d09b64733ebeac4400bc018419b34
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.7 MB (224688695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:727e2366410d51135f1c4936582d86aec72573a816ffa02935694c42f0efeec0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Feb 2023 22:18:11 GMT
CMD ["php-fpm"]
# Wed, 15 Feb 2023 02:51:49 GMT
RUN set -ex;         apk add --no-cache         rsync         imagemagick     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Wed, 15 Feb 2023 02:55:47 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Wed, 15 Feb 2023 02:55:48 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 15 Feb 2023 02:55:49 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 24 Feb 2023 02:20:24 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 24 Feb 2023 02:20:24 GMT
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 02:24:39 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Fri, 24 Feb 2023 02:25:35 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Feb 2023 02:25:39 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 24 Feb 2023 02:25:40 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 24 Feb 2023 02:25:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Feb 2023 02:25:40 GMT
...
-	Layers:
	...
	-	`sha256:8f2735794ce5bd79c02789da1b681c8a6aa83b5cf09f1ef0faa8743d7cdd58b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e7bb398bcce1bed94b41bb5fae0d0fe1bda77e8ab2522b8fb6474e76771e4ef`  
		Last Modified: Wed, 15 Feb 2023 03:23:59 GMT  
		Size: 52.5 MB (52494639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eabd842ac4a6351b37e0684d9ed9436258dc458df22f828100f8ac2000d17f40`  
		Last Modified: Wed, 15 Feb 2023 03:23:46 GMT  
		Size: 9.4 MB (9388572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:701e93b425c1fa0152a61b77660b8eee26d195d156dff65dc898bc6e18466052`  
		Last Modified: Fri, 24 Feb 2023 02:34:16 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:defc8447443890117134f3cb0c98d20838ddc28ec528b1ca6fe8eeb08099c6ba`  
		Last Modified: Fri, 24 Feb 2023 02:37:20 GMT  
		Size: 134.8 MB (134835137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e4b51e6b43a9720d7d9ab838536062ff06f7145ebbf7f0c76580a804c84fdbf`  
		Last Modified: Fri, 24 Feb 2023 02:36:52 GMT  
		Size: 3.2 KB (3239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:977656bc0302d986beb5ba66c7a9bb433a0aad1c6b60e8559cfb96b3f85ee7c2`  
		Last Modified: Fri, 24 Feb 2023 02:36:52 GMT  
...
```console
$ docker pull nextcloud@sha256:07d81d140bb194799d8ed36ce6e290f4fd6fdb181bdc999fbac55fe91dd41b9a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207837814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34242152e130b0407e55f0c45a08d06ea3b9c44e5f5f8158ecd03841cf8c7780`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 15 Feb 2023 00:04:10 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 24 Feb 2023 01:44:56 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 24 Feb 2023 01:44:56 GMT
VOLUME [/var/www/html]
# Fri, 24 Feb 2023 01:47:23 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Fri, 24 Feb 2023 01:47:52 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 24 Feb 2023 01:47:58 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Fri, 24 Feb 2023 01:47:58 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 24 Feb 2023 01:47:58 GMT
...
-	Layers:
	...
	-	`sha256:d11b502987fd55d5afa4a13e6ba19aa82ef83da2c64fead5ea1dfebb0b16cd17`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de6855fc68cd9ab1901832d5d498ab48ce54a3eb266a5fa0714c09988c7cd1b9`  
		Last Modified: Fri, 24 Feb 2023 01:53:33 GMT  
		Size: 611.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba2846c55913d4b197500692b9260c52a653180183aedd6b8d7d01bd5e49cc40`  
		Last Modified: Fri, 24 Feb 2023 01:55:09 GMT  
		Size: 134.8 MB (134825250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:594462ec7c419e81a627b7c8b698116ac359242d35b1d928c74dff1e4bc79424`  
		Last Modified: Fri, 24 Feb 2023 01:54:54 GMT  
		Size: 3.2 KB (3240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:063f17ddc47a0d543fcf981531a43e64b9662d0d7ce9c5ee6a84adc22b4a2859`  
		Last Modified: Fri, 24 Feb 2023 01:54:54 GMT  
		Size: 2.2 KB (2152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
