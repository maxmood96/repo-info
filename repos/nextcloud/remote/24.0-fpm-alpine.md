...
```console
$ docker pull nextcloud@sha256:d1102ac168a2f164a30eb483b23af3d550b9153331c529beee0d6bd974d1582f
```
...
```console
$ docker pull nextcloud@sha256:9e132134d606758de2265fe0ca558685ebb8826fea1cb24ee33dd340ae4f5c56
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174283581 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09000f31f2b87ce06d529031cc68ebe98b397a834049f960184e28a4b88940b3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 19:51:20 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 03 Nov 2022 19:51:22 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 19:51:23 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 19:51:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 19:51:23 GMT
...
-	Layers:
	...
	-	`sha256:96cb9c48faf8ee07b6a06b1cbb4ce3382a4a7b1b60b8e761d7cd41c25eb07b19`  
		...
		Size: 562.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:199cc461f5fcb48f1930705a941cdc05f05c6a0ee41862c1a7f04b5b76c5171b`  
		Last Modified: Thu, 03 Nov 2022 19:54:15 GMT  
		Size: 134.6 MB (134553958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de64c8d448fbbb60a3f42c22be34f05a211ea3ff46862421c4d3040a31902b71`  
		Last Modified: Thu, 03 Nov 2022 19:53:51 GMT  
		Size: 3.3 KB (3253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61b998ca6c8b676afc4091c0c6724f8f35e074007da345e1e95c6ff574a67680`  
		Last Modified: Thu, 03 Nov 2022 19:53:51 GMT  
...
```console
$ docker pull nextcloud@sha256:8c9abcc399ab985e0abdfc73ac4cc169dec0b818a1150e02c63b50ae05f00b52
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.1 MB (173112586 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29400d46957c3a7993dad3fa8f0630f73f79634e7696ff9262d21d12b2cb3763`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 23:34:49 GMT
VOLUME [/var/www/html]
# Thu, 03 Nov 2022 20:52:58 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 20:53:37 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 03 Nov 2022 20:53:38 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 20:53:38 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 20:53:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 20:53:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c03fcd990059670362973aa21d4005839bd5ecd5b3e307c94dee4cee293e8e41`  
		...
		Size: 565.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:673b4ec367364895e0d77a65e85db56b53f2fa278c8b9b3fb260a7c4d4f62e87`  
		Last Modified: Thu, 03 Nov 2022 21:04:10 GMT  
		Size: 134.6 MB (134554316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e5a4b374c4da15c59558597f8a2a9a2123a320018663f8447fb38df1198d12e`  
		Last Modified: Thu, 03 Nov 2022 21:03:46 GMT  
		Size: 3.3 KB (3253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad1cc51033e584691af0ca5d72f6d3b57827ab70158aeb8da6557211c7e877ab`  
		Last Modified: Thu, 03 Nov 2022 21:03:46 GMT  
...
```console
$ docker pull nextcloud@sha256:3c641ba5f4a7f996f52cabe1ec2c60b3dd0c77e1cf66c4b6be1a886472d34ebe
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.9 MB (175948617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:659b8c16dbed717753377d630047cbd8bda6c4aa3972be117e456e82112a960a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Oct 2022 04:43:06 GMT
VOLUME [/var/www/html]
# Thu, 03 Nov 2022 20:44:30 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 20:45:07 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 03 Nov 2022 20:45:10 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 20:45:10 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 20:45:10 GMT
...
-	Layers:
	...
	-	`sha256:f81e5e6f61861b62032fdb0d76ad8f50f9ff51e2ce7b35bc459a65ed32221086`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28a19a5ef58343e2bda490b4d5d2961b0a2ebb70b8be4c63b781aa05cdce4b91`  
		Last Modified: Thu, 03 Nov 2022 20:52:39 GMT  
		Size: 134.6 MB (134554593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bf091d9f305536e482532fa961b348fde2f3e182daeeda8e76532c6e79a93df`  
		Last Modified: Thu, 03 Nov 2022 20:52:26 GMT  
		Size: 3.3 KB (3253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddde057e0832723a45d930f40eac988213a73e6cf9a8953a782526ad0a4567e4`  
		Last Modified: Thu, 03 Nov 2022 20:52:26 GMT  
...
```console
$ docker pull nextcloud@sha256:09d18ba7e91d87125b01d41f2ed9164df171eea800f6ba2aaa941c08ab7dd1c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.9 MB (177887215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e44145a886b0c414219b11934f7df5eb44ab7c29d3906a5287f93c5f3164b8b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 03 Nov 2022 20:44:22 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 20:45:09 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 03 Nov 2022 20:45:11 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 20:45:12 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 20:45:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 20:45:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ba6d7c2cc8cfdcc5f0c7d3bb6fa5a0f94204237efd0721a3d43b0b7a304faa7c`  
		...
		Size: 564.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5260b6fbb93eaacf73515b103ba46f4f7b70c548b047b1e951f5e24e5f2670ac`  
		Last Modified: Thu, 03 Nov 2022 20:57:06 GMT  
		Size: 134.6 MB (134557904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f0a52d1a192b82e64e6a93ebe46117b5ececcc4dc801962801bb9a8b360b6a6`  
		Last Modified: Thu, 03 Nov 2022 20:56:48 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:346f1079f9da74dd079d8d678a70ae63beb231e7ba33fd1db8fabe2697f3927a`  
		Last Modified: Thu, 03 Nov 2022 20:56:48 GMT  
		Size: 2.2 KB (2153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
