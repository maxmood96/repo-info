...
```console
$ docker pull nextcloud@sha256:7e38a396f480d085675eb3f3fdcac7cc6e1db7008f9382b6c0b4e18114d051f3
```
...
```console
$ docker pull nextcloud@sha256:a80b16e19d6b02dab244df0cbbdcfed0da68e9154690f6cfb087d3f642a35d36
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.8 MB (176821382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f47b99a043eea31ba87d4e8cdfc77ad2ac2983dc84baf3ddfb693ddf4a56339`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 16:06:52 GMT
VOLUME [/var/www/html]
# Wed, 03 Aug 2022 16:13:36 GMT
ENV NEXTCLOUD_VERSION=24.0.3
# Wed, 03 Aug 2022 16:14:27 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Wed, 03 Aug 2022 16:14:33 GMT
COPY multi:d9574764c06aabe0dc7bf27918fb25476f8e6bf8e5d72184f2290e80520ef470 in / 
# Wed, 03 Aug 2022 16:14:35 GMT
COPY multi:7281097c8fd959eff64684726d7707d598f15dc22353d1f6f843624f642bdcd2 in /usr/src/nextcloud/config/ 
# Wed, 03 Aug 2022 16:14:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 03 Aug 2022 16:14:35 GMT
...
-	Layers:
	...
	-	`sha256:34802f0c4d449ce689547ba3c62d477951a1b55226de156ca56b4222d18b6226`  
		...
		Size: 591.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a012b173a518ccd49d3c4a2ed846c0194a160a959935a4a6e50b1ef6257dfb9c`  
		Last Modified: Wed, 03 Aug 2022 16:23:45 GMT  
		Size: 134.1 MB (134052359 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:902ab2a598f8c9d3ac12dfb4b27c35eda1e636abdd4a99a6370e159e6a1a2165`  
		Last Modified: Wed, 03 Aug 2022 16:23:17 GMT  
		Size: 3.1 KB (3064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b1507e555e63f573ac70c4ec971a0b775c293fec5e39870c87a3e26f9eb1c20`  
		Last Modified: Wed, 03 Aug 2022 16:23:17 GMT  
