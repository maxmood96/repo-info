...
```console
$ docker pull nextcloud@sha256:e8a84dd3060002002fe4c50f105dab864af4f32f144fc1b49040374c7d6ccae7
```
...
```console
$ docker pull nextcloud@sha256:b8e832b219830158910ed036e7a59b368817381f210589835b3ec8b2179424a2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.9 MB (176901328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f386dacf097df5df182cf84c7d49227be3eae3a06baf16df67be71a60107efc`
...
# Sat, 29 Oct 2022 04:20:43 GMT
VOLUME [/var/www/html]
# Sat, 29 Oct 2022 13:18:35 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Sat, 29 Oct 2022 14:11:18 GMT
...
-	Layers:
	...
	-	`sha256:ad5c5ac5f4d2880c387e51861315cc95ef5356d88b03ef93a94c78e7496bd476`  
		...
		Size: 596.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9046ed810c0d927e4ada55f6103f2a9a0811de6defbbc2acf122c06a5b26ac33`  
		Last Modified: Sat, 29 Oct 2022 14:24:43 GMT  
		Size: 134.3 MB (134303095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65504e02aebf3bec0b9c8bcd8b8d01a81db424b74574cdbe2b82f8b3d79db395`  
		Last Modified: Sat, 29 Oct 2022 14:24:26 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97db002192fdaf064d92a1f990e18a97f228cf1b9bae61ab58e984618716af21`  
		Last Modified: Sat, 29 Oct 2022 14:24:25 GMT  
...
```console
$ docker pull nextcloud@sha256:c3bad2448f052256a303f52574f6adbb408467ad8bc961034f67fe93aa2b2ed4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (174032746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fa3f0bf1a5a25f15067c372217636d90551f03961561401ed0fa011403ff367`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 19:35:59 GMT
CMD ["php-fpm"]
# Fri, 28 Oct 2022 20:56:10 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 28 Oct 2022 20:58:47 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 28 Oct 2022 20:58:47 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 28 Oct 2022 20:58:47 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 28 Oct 2022 20:58:48 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 28 Oct 2022 20:58:48 GMT
VOLUME [/var/www/html]
# Fri, 28 Oct 2022 20:59:52 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Fri, 28 Oct 2022 21:00:45 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 28 Oct 2022 21:00:48 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Fri, 28 Oct 2022 21:00:49 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 28 Oct 2022 21:00:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 28 Oct 2022 21:00:49 GMT
...
-	Layers:
	...
	-	`sha256:984e9d6314476d8a0d92727d1b57c229424fe94ae1b40b83555206695ed2e1d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d43617633717a00349a4328c5cd4b59b7df16016d30b903880e862a192f3202d`  
		Last Modified: Fri, 28 Oct 2022 21:05:11 GMT  
		Size: 577.2 KB (577236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:517c4abd2cd9a9cd97061674aa7f9242aba696ca60816f4e4a8f7d2bf683e102`  
		Last Modified: Fri, 28 Oct 2022 21:05:10 GMT  
		Size: 13.0 MB (12980137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96cb9c48faf8ee07b6a06b1cbb4ce3382a4a7b1b60b8e761d7cd41c25eb07b19`  
		Last Modified: Fri, 28 Oct 2022 21:05:07 GMT  
		Size: 562.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3721081dd54dfcffa3d81ae7d26faa69e9ec427dd91e193377e527bb4876fc49`  
		Last Modified: Fri, 28 Oct 2022 21:06:17 GMT  
		Size: 134.3 MB (134303131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1b4453132192ba8ba51b78d9f1f5a93b3b20e7e9852e55a28bbd532b7b0a01d`  
		Last Modified: Fri, 28 Oct 2022 21:05:53 GMT  
		Size: 3.2 KB (3248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cf03ff9dc602435040f83bc01141fd1c327dc3eb251c106a3749905860cd46d`  
		Last Modified: Fri, 28 Oct 2022 21:05:53 GMT  
...
```console
$ docker pull nextcloud@sha256:bd9af7f201fe8b9e50dc6442672e4de2ae810acb712a4cdb130afa02e1dc783e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.9 MB (172861345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c533a50ef944a089820fa788013cc44ed868c1dc18dd76f168c50669c713146d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 23:34:48 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 28 Oct 2022 23:34:49 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 28 Oct 2022 23:34:49 GMT
VOLUME [/var/www/html]
# Fri, 28 Oct 2022 23:37:46 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Fri, 28 Oct 2022 23:38:24 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 28 Oct 2022 23:38:25 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Fri, 28 Oct 2022 23:38:25 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 28 Oct 2022 23:38:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 28 Oct 2022 23:38:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9fb17569d7751915a0110d956dcf65a894e1010497557763e756855050d80d79`  
		...
		Size: 8.6 KB (8572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f89106a926a6b614149444476d94d3eea367bc1cf4c7ac1d693d9b058b4f755c`  
		Last Modified: Fri, 28 Oct 2022 23:53:11 GMT  
		Size: 513.1 KB (513092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8de93280c60a8f7c2dc17dd45874e0636c65b6ac20bcc7b567af528b759f7f40`  
		Last Modified: Fri, 28 Oct 2022 23:53:12 GMT  
		Size: 12.6 MB (12632745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c03fcd990059670362973aa21d4005839bd5ecd5b3e307c94dee4cee293e8e41`  
		Last Modified: Fri, 28 Oct 2022 23:53:08 GMT  
		Size: 565.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f22931e5c155dfa10ebb219fba07a27a3fd17234153196590ccff5cbf6a9c23`  
		Last Modified: Fri, 28 Oct 2022 23:56:22 GMT  
		Size: 134.3 MB (134303085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d86694c421fb0988aad42fb56664ef22ae7b947e77a993edb37c4a65361982b`  
		Last Modified: Fri, 28 Oct 2022 23:55:58 GMT  
		Size: 3.2 KB (3248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd1b4e718100e176d5d54c6304b330709c1ca491cb3bc42f1af04c2ff90250aa`  
		Last Modified: Fri, 28 Oct 2022 23:55:59 GMT  
		Size: 2.1 KB (2150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:a62518ca42f1321123d8e14c5af8cad8ddef5a78d41fd117443434729c915b08
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175697138 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f27fa467b390f81a5ab6c05aba730d3f4a2ed1d8d0395dd3436415eed2e48cb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 19:50:56 GMT
CMD ["php-fpm"]
# Sat, 29 Oct 2022 04:41:11 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 29 Oct 2022 04:43:05 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 29 Oct 2022 04:43:06 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 29 Oct 2022 04:43:06 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 29 Oct 2022 04:43:06 GMT
...
# Sat, 29 Oct 2022 04:43:06 GMT
VOLUME [/var/www/html]
# Sat, 29 Oct 2022 13:41:44 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Sat, 29 Oct 2022 14:11:14 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 29 Oct 2022 14:11:17 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Sat, 29 Oct 2022 14:11:17 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 29 Oct 2022 14:11:17 GMT
...
-	Layers:
	...
	-	`sha256:87294bfd00a3dd0d976b2b77defedcbf69ed3ca9bb795cb0e8c7986a41b69fea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc9e99a30da0c297f2779320192f7af04fa273d3e39e7e15d6943d829e696d01`  
		Last Modified: Sat, 29 Oct 2022 14:23:16 GMT  
		Size: 585.3 KB (585329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c5887871b4de7b4012990b9121e7af16a325817f10e94e8ad89d0042d2688b2`  
		Last Modified: Sat, 29 Oct 2022 14:23:16 GMT  
		Size: 13.7 MB (13713901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f81e5e6f61861b62032fdb0d76ad8f50f9ff51e2ce7b35bc459a65ed32221086`  
		Last Modified: Sat, 29 Oct 2022 14:23:13 GMT  
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75fbc4d1178fbb739757f694d1c361057a13ed1be6f9dccfaaaf32af16ff4297`  
		Last Modified: Sat, 29 Oct 2022 14:23:27 GMT  
		Size: 134.3 MB (134303118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46bcd4ac0f42beaf9e18c00166a035676bdc49e408c6c219a8764312f3f606fe`  
		Last Modified: Sat, 29 Oct 2022 14:23:13 GMT  
		Size: 3.2 KB (3249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53e6f9167de1450fcee29fd2efa713cf3ffdb44f516d701db5a92403921fca64`  
		Last Modified: Sat, 29 Oct 2022 14:23:13 GMT  
...
```console
$ docker pull nextcloud@sha256:b2d6b5215f1dc4f70505d03c285442313145046518bf5ecf2a2d1778ea976a02
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.6 MB (177633903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32dae72454b77e77b84e2513930cb151ee3b7213c532a80968b2ed95149bcfc4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 28 Oct 2022 23:05:10 GMT
RUN set -ex;         apk add --no-cache         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Fri, 28 Oct 2022 23:07:49 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         icu-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libpng-dev         libmemcached-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev         imagemagick-dev         libwebp-dev         gmp-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Fri, 28 Oct 2022 23:07:49 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 28 Oct 2022 23:07:50 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 28 Oct 2022 23:07:51 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 28 Oct 2022 23:07:52 GMT
VOLUME [/var/www/html]
# Fri, 28 Oct 2022 23:10:34 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Fri, 28 Oct 2022 23:11:20 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 28 Oct 2022 23:11:22 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Fri, 28 Oct 2022 23:11:23 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 28 Oct 2022 23:11:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 28 Oct 2022 23:11:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3a064e5cb3cee52edd32e7b90f061854d215570366bae1937fa591eb97f9896e`  
		...
		Size: 8.6 KB (8570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:759c3b9133c0917a990728127ddc97318b7a6cb555f17c9262a143eeac19d73d`  
		Last Modified: Fri, 28 Oct 2022 23:17:59 GMT  
		Size: 575.8 KB (575772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a367581b12366bfa5bbdd0bd83f98e8289bd536c28a1afb914e2580983e93eeb`  
		Last Modified: Fri, 28 Oct 2022 23:17:58 GMT  
		Size: 14.6 MB (14633820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba6d7c2cc8cfdcc5f0c7d3bb6fa5a0f94204237efd0721a3d43b0b7a304faa7c`  
		Last Modified: Fri, 28 Oct 2022 23:17:56 GMT  
		Size: 564.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f506eff1b7ffd33f1075f6d9db411029bf824fb3e5d6adcc597ca342159c59e5`  
		Last Modified: Fri, 28 Oct 2022 23:19:28 GMT  
		Size: 134.3 MB (134304602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0c908a65042a82d50d36bfa66ec1f3d0bb554eeb572d386983e53cd0f083c1c`  
		Last Modified: Fri, 28 Oct 2022 23:19:12 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:340ee9667739e2fdfe75b3674716c04fffa3876899b72db73195f37518452e7c`  
		Last Modified: Fri, 28 Oct 2022 23:19:12 GMT  
		Size: 2.1 KB (2150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:740dda7894c74e31e57ade3c9845b2a11283feddd0a847a5aef1e03eef915c86
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.4 MB (177379610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8175bc3db88430bae9a424147e68b26babc231cbd83697fcf3668b1e00a42359`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 23:45:47 GMT
VOLUME [/var/www/html]
# Fri, 28 Oct 2022 23:48:24 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Fri, 28 Oct 2022 23:49:12 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 28 Oct 2022 23:49:19 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
# Fri, 28 Oct 2022 23:49:20 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Fri, 28 Oct 2022 23:49:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 28 Oct 2022 23:49:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bdf1ee2964db6213b6d84b7c6342d55e9ac4a0f5bc49dc6f46df7df1f816af08`  
		...
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35c5b14cee1452443d7e86a8f4e3a2278f74253284640595cbe695f2737e9105`  
		Last Modified: Fri, 28 Oct 2022 23:58:05 GMT  
		Size: 134.3 MB (134303027 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2faddf945678914d43e86fb2df04890de0b125c86b22539341bb596132a4be79`  
		Last Modified: Fri, 28 Oct 2022 23:57:36 GMT  
		Size: 3.2 KB (3248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e841a92c21d319b6e2b173678fac48f3d74b69ffc839e287090016646f1647ad`  
		Last Modified: Fri, 28 Oct 2022 23:57:36 GMT  
		Size: 2.1 KB (2150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:cecd04848ae3049ba5a7ebc4bea6b5abd68d2e4aedeb213360bb743024cb04ba
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175220916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6aaec680940aa175a805e9afc458437d8b5c9478cd4be821494f96a7c0ccac93`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 21:35:19 GMT
VOLUME [/var/www/html]
# Fri, 28 Oct 2022 21:41:20 GMT
ENV NEXTCLOUD_VERSION=24.0.6
# Fri, 28 Oct 2022 21:41:52 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 28 Oct 2022 21:42:00 GMT
COPY multi:812ebb13115fbd5eaadc9d9df89b2bcb886e2ec0d6a45d21b802bc1c2c1d6cb1 in / 
...
-	Layers:
	...
	-	`sha256:801b7caed00ec33a1418e905202eae050f1f4265e6b8ee8be62ef55182cd1094`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dfd242c8f12b845319d5dcd8e69556b4056b2122c820b0f631eed8bc3447bc3`  
		Last Modified: Fri, 28 Oct 2022 21:47:45 GMT  
		Size: 134.3 MB (134303162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9392177aeaf01fed21217baee1788cb7d5a28aab95d5a2aa8abe40e0fbf78874`  
		Last Modified: Fri, 28 Oct 2022 21:47:31 GMT  
		Size: 3.2 KB (3247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec5cf22fb3f7709a733657668345bda1bc14e43ace2a457b1580d823fefaae88`  
		Last Modified: Fri, 28 Oct 2022 21:47:31 GMT  
		Size: 2.1 KB (2150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
