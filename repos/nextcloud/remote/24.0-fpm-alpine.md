...
```console
$ docker pull nextcloud@sha256:2bee1deb7872ecd0c47ce716027218d05c2b16c6de8ead1720c5b3374c20aeeb
```
...
```console
$ docker pull nextcloud@sha256:164099f98062a67de3e10baf33fe52adf8b4047770dde9e94dee7058dda24b91
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.7 MB (209707733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ec4a8f3db8b5e7244719e444af7f7fee6989a265c1a33ecd66457dca3658152`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 01 Apr 2023 00:07:13 GMT
VOLUME [/var/www/html]
# Thu, 20 Apr 2023 21:23:59 GMT
ENV NEXTCLOUD_VERSION=24.0.12
# Thu, 20 Apr 2023 21:24:56 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 20 Apr 2023 21:24:58 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Thu, 20 Apr 2023 21:25:01 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Thu, 20 Apr 2023 21:25:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Apr 2023 21:25:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:26fccc421b7ce064480924a7f41916c1cb2cc76c390524a160ee5bad825b0be9`  
		...
		Size: 611.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b7b96df809114bff3a91cd6c39bf2fcc7ec22c45026c25b352363847a448e8c`  
		Last Modified: Thu, 20 Apr 2023 21:34:51 GMT  
		Size: 135.0 MB (134988893 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a337a057690be24a288fa3ed1eceda3fe2e82fdd08f8b84f63b375669f50404d`  
		Last Modified: Thu, 20 Apr 2023 21:34:24 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a93eb483a9c9eb9de4320fa9933e854ce2403c7b1795a4f4f4250c78ea7b74b`  
		Last Modified: Thu, 20 Apr 2023 21:34:24 GMT  
...
```console
$ docker pull nextcloud@sha256:bcd5719f4646c19276615f6ac4230371f726e4887531c1b9429c241ccb6c6542
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.8 MB (216834472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f83a62f5544ab576f4933eb5c9e88d8a6ada00debf893c2f82970cb9408120ce`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 30 Mar 2023 07:02:44 GMT
VOLUME [/var/www/html]
# Thu, 20 Apr 2023 21:47:17 GMT
ENV NEXTCLOUD_VERSION=24.0.12
# Thu, 20 Apr 2023 21:47:53 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 20 Apr 2023 21:47:56 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Thu, 20 Apr 2023 21:47:56 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Thu, 20 Apr 2023 21:47:56 GMT
...
-	Layers:
	...
	-	`sha256:e401572b5ff4de0b0a6d4b8b9a55e96d20328d57ec8b23e7fa34b001f7c4098b`  
		...
		Size: 612.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5694c93cea329c8d585bb56334cd645a61c72346ff32ff45ed241d1d3f740204`  
		Last Modified: Thu, 20 Apr 2023 21:55:13 GMT  
		Size: 135.0 MB (134989305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a175b25c8a0729f1a3ebba9422cc2f15df673af364203a3292b4e78a63adb4`  
		Last Modified: Thu, 20 Apr 2023 21:55:00 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:050f58524e9d4ca697d1f6b61c0e016ec6001cb2da755998336347630c1bf27c`  
		Last Modified: Thu, 20 Apr 2023 21:55:00 GMT  
...
```console
$ docker pull nextcloud@sha256:ecbbd021c2197c470036c24dac40d89510e8ce6025c16a8ca2a468d62e412904
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.3 MB (208293136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0473bb736e74ebfa65500a4755d4d40f5cc42201dd1bf027e0d50fc30e4e044d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 29 Apr 2023 04:13:26 GMT
RUN set -ex;         apk add --no-cache         imagemagick         rsync     ;         rm /var/spool/cron/crontabs/root;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Sat, 29 Apr 2023 04:15:31 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         $PHPIZE_DEPS         autoconf         freetype-dev         gmp-dev         icu-dev         imagemagick-dev         libevent-dev         libjpeg-turbo-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libwebp-dev         libxml2-dev         libzip-dev         openldap-dev         pcre-dev         postgresql-dev     ;         docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap;     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         gmp         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip     ;         pecl install APCu-5.1.22;     pecl install imagick-3.7.0;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;         docker-php-ext-enable         apcu         imagick         memcached         redis     ;     rm -r /tmp/pear;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --virtual .nextcloud-phpext-rundeps $runDeps;     apk del .build-deps
# Sat, 29 Apr 2023 04:15:32 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 29 Apr 2023 04:15:32 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 29 Apr 2023 04:15:32 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=32';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';         echo 'opcache.jit=1255';         echo 'opcache.jit_buffer_size=128M';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 29 Apr 2023 04:15:33 GMT
VOLUME [/var/www/html]
# Sat, 29 Apr 2023 04:15:33 GMT
ENV NEXTCLOUD_VERSION=24.0.12
# Sat, 29 Apr 2023 04:16:02 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 29 Apr 2023 04:16:09 GMT
COPY multi:38a4739a7ce38db03075117346fff2453db5ff29d27e30f506b9d2fc6a4b4a9a in / 
# Sat, 29 Apr 2023 04:16:09 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Sat, 29 Apr 2023 04:16:09 GMT
...
-	Layers:
	...
	-	`sha256:be255788f36b099ef714bdabbfc5d9c975c0adb36ea8e21f350b0db625ad3d80`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c4a7d710903314b7651c115803fcdd41161fca57d2b7fc00994953f18f1568b`  
		Last Modified: Sat, 29 Apr 2023 04:22:54 GMT  
		Size: 37.7 MB (37739466 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35e545b8ee3e47d92460e774f3668b7135fc3aafa96d2b2fd9d8dc7653dd8b21`  
		Last Modified: Sat, 29 Apr 2023 04:22:49 GMT  
		Size: 8.7 MB (8714398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5eb53116820d96ac31603021ff17f71023b5484e15467495f06f44614c28f81c`  
		Last Modified: Sat, 29 Apr 2023 04:22:47 GMT  
		Size: 609.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d47b60526542f77f21dabe0adaf72730cecd6492934dc09744188e034db47779`  
		Last Modified: Sat, 29 Apr 2023 04:23:03 GMT  
		Size: 135.0 MB (134999711 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9af8a03a780fc9eb994081f01d1be6e0c94d798417484f56c4170c833ea41741`  
		Last Modified: Sat, 29 Apr 2023 04:22:47 GMT  
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f92b71a64ca21a1ec51ee732bae8bcb9eff815b65222f024401a360d36cd3b`  
		Last Modified: Sat, 29 Apr 2023 04:22:47 GMT  
