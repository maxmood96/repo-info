...
```console
$ docker pull nextcloud@sha256:d71d1a0316b25ebb88cc0714e019c0c80cbcca8c3d652fe17dae480d37bea62d
```
...
```console
$ docker pull nextcloud@sha256:dc8b2925326d4d7f8bdc1871b9c7ec9106be7ffc3b780b01e70a04ea8c20cf57
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.6 MB (212576805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cd41597d12cda797e1bfe1284974e6c43593b845a64291125b5e4dee6973cfb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 04 Mar 2023 03:11:48 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Sat, 04 Mar 2023 03:12:30 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 04 Mar 2023 03:12:33 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 03:12:33 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 03:12:33 GMT
...
-	Layers:
	...
	-	`sha256:6369564119970bbd91c5fbf05a6d7ed09767553d84c509346fdda86e3b3f725e`  
		...
		Size: 610.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9abf07945eba849ea097153decbf6f344dfb3af3a20fafcfa3c5a67ecc682a08`  
		Last Modified: Sat, 04 Mar 2023 03:17:15 GMT  
		Size: 134.8 MB (134835206 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c1182957db6c26e81cbb5216560604c7d47287d67d2092d6eefc046f3c7d2d3`  
		Last Modified: Sat, 04 Mar 2023 03:16:56 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaf93b353288767b2e7cbc1d8e0202ec0d442d13a6a0698d52039a8d5b0b92e9`  
		Last Modified: Sat, 04 Mar 2023 03:16:55 GMT  
...
```console
$ docker pull nextcloud@sha256:2ea322b2191d0c601ab4e57ba80ee61b4b99f2f70741f75bbfb3b30976dff173
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207838046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f140549732cbb3df6b2eb41ca9630f0e416c53251113a78720784e81a9befa29`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:55:53 GMT
VOLUME [/var/www/html]
# Sat, 04 Mar 2023 02:57:44 GMT
ENV NEXTCLOUD_VERSION=24.0.10
# Sat, 04 Mar 2023 02:58:18 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Sat, 04 Mar 2023 02:58:25 GMT
COPY multi:6a18c1c6e633992cb8206e6acf4353eeb6ef9c184e76ada9420c1bd01fe25af2 in / 
# Sat, 04 Mar 2023 02:58:25 GMT
COPY multi:e04ec17740bba0827b5de2ec99cdb42bece265a39b1dfe4bab140bca83af17d6 in /usr/src/nextcloud/config/ 
# Sat, 04 Mar 2023 02:58:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 04 Mar 2023 02:58:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:31107ac2e91242b1b9566fbc50e8c1a18b76c0eb27fc7904f2ff8055053e9eab`  
		...
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e197bb5921f00c5f7f5a90d50442e6619b331d52ebcb339bc6156240725c1cf`  
		Last Modified: Sat, 04 Mar 2023 03:07:28 GMT  
		Size: 134.8 MB (134825332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0fb1e58a17ca1f01a509ecdaf168bc421d2fd8f24854e2764b65ef29eff9fa9`  
		Last Modified: Sat, 04 Mar 2023 03:07:14 GMT  
		Size: 3.2 KB (3241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbee1785454195bd4e79f511908e655011ba8762243f2d48196902ca3a708f9d`  
		Last Modified: Sat, 04 Mar 2023 03:07:14 GMT  
		Size: 2.2 KB (2152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
