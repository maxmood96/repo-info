...
### `nextcloud:32.0.8-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.8-fpm-alpine` - unknown; unknown
...
### `nextcloud:32.0.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:32.0.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:32.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.8-fpm-alpine` - linux; 386
...
### `nextcloud:32.0.8-fpm-alpine` - linux; ppc64le
...
### `nextcloud:32.0.8-fpm-alpine` - linux; riscv64
...
### `nextcloud:32.0.8-fpm-alpine` - linux; s390x
