...
```console
$ docker pull nextcloud@sha256:550b7b0d60706c0196dcf195afcf5ff3a149c72e0220b1828601af3d3b79efe8
```
...
### `nextcloud:28.0.11-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:28.0.11-fpm-alpine` - linux; 386
...
### `nextcloud:28.0.11-fpm-alpine` - linux; s390x
