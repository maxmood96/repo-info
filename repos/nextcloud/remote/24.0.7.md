...
```console
$ docker pull nextcloud@sha256:cd39234320e28fc6f35d381567f4111b8721e02d0c08a1b60ce636c70c2e63aa
```
...
### `nextcloud:24.0.7` - linux; amd64

```console
$ docker pull nextcloud@sha256:99005e368ce4606333334fc183d83c249249c05b19f614126f2fd1eea3a07f00
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.4 MB (318354310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f4c48c9f8dea28de345896b49d671ce964b2b64b219b200514323db1b29dbe7`
...
-	Layers:
	...
	-	`sha256:0e65ebf56c16cab584bed327b86472bc4bc4457341192901253945bf5a13188a`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46eca2dd84c9df5335354e6485cf1a472632263b1efad326a773a594b60cb2e4`  
		Last Modified: Tue, 15 Nov 2022 07:56:29 GMT  
		Size: 134.9 MB (134931706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cf41cb92b00c5ceb4bf0a823a20eaf15fbf3a813ceeaf0f4c716bc1333b0658`  
		Last Modified: Tue, 15 Nov 2022 07:56:12 GMT  
		Size: 3.3 KB (3255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93a571a24586094e60413d4de3fdb3257f3e4da008ba7ce198f99cff3d721d35`  
		Last Modified: Tue, 15 Nov 2022 07:56:13 GMT  
		Size: 2.2 KB (2216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; arm variant v5

```console
$ docker pull nextcloud@sha256:269c8d078b512ae938eb7a65375cc3e8e5cd71ea27c298468ace6ca3d41938ab
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.9 MB (293885322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f532d00a748138391cabd3f2074ab68aae860e1987bc0b03352b6d980c3d3009`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 15 Nov 2022 12:26:49 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 15 Nov 2022 12:26:49 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 15 Nov 2022 12:26:49 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 15 Nov 2022 12:29:39 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 12:29:40 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 15 Nov 2022 12:29:40 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 12:29:41 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 12:34:53 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 12:35:38 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:2ffd2abf86d0d3e087cf14c710f0d4880b4b52394fa1f813b2bbdb194a153f00`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d5a01b8f3dddd1cdbe8e814130656b543e9d95d6a5679cff53434191db3d74a`  
		Last Modified: Tue, 15 Nov 2022 12:47:10 GMT  
		Size: 1.7 MB (1657188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:446d0379fa4f7060387f3201479a412c11d8088b70887cb59df5a8f193aebdef`  
		Last Modified: Tue, 15 Nov 2022 12:47:12 GMT  
		Size: 15.2 MB (15186576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60250487384946a605de21f6411f9caa1ab69efc719d3832289084b980783fc`  
		Last Modified: Tue, 15 Nov 2022 12:47:07 GMT  
		Size: 567.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1fabd41a53ca50e49115bc290a14912641ddbeaa0f6538791a6d5a9b6f222c2`  
		Last Modified: Tue, 15 Nov 2022 12:47:07 GMT  
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d795772e461423282521b03c97a3d2783e549a9fe1b71e48bd501eba526a79a`  
		Last Modified: Tue, 15 Nov 2022 12:49:11 GMT  
		Size: 134.9 MB (134929406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ef8262d007096a1c032e22d8c0440ba7b39b99e0751f8491c31874380e6ab77`  
		Last Modified: Tue, 15 Nov 2022 12:48:47 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5d680feeb61b4ebc0390a5dc99ef4ceed2044f0198f47ec78306bac0d86aaa8`  
		Last Modified: Tue, 15 Nov 2022 12:48:47 GMT  
		Size: 2.2 KB (2210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; arm variant v7

```console
$ docker pull nextcloud@sha256:6a174496148c1e6f3fd0dd042ccb4d706611a2c1a744dedac35fb7e4c4ca55ee
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.9 MB (284853157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf7f5cb7eeb5f910bf7492580e0602f601de3e73f69115342f8a445c3fed6219`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 09:58:49 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 09:59:37 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 09:59:39 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 09:59:40 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 09:59:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 09:59:40 GMT
...
-	Layers:
	...
	-	`sha256:6c709f193110b1d194dbc7c4fa2e14e1744b8ec44975865fef0202cbe1e75f70`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42952b047781a7ab1f4271d2fa8770ab7c6bb14507a72fc40cab1feddb71524`  
		Last Modified: Tue, 15 Nov 2022 10:12:33 GMT  
		Size: 134.9 MB (134929393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f70f8145e88dfb91670c917a7183101514b7854e978874db2e2cc3e6e733060`  
		Last Modified: Tue, 15 Nov 2022 10:12:09 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6067a4fe22ad97de9cdeec7d64d2d7490cf843541f74575d873772878a2f6eba`  
		Last Modified: Tue, 15 Nov 2022 10:12:09 GMT  
		Size: 2.2 KB (2213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; arm64 variant v8

```console
$ docker pull nextcloud@sha256:90451b5f8f32b9087e38459336b2a5032ceaca0abef3b51173d4bcdfa2b3abb0
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.2 MB (309203029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f525c2be4624ef4fa1749d300f99bf66b36f4127bf8a3f75dc8fe50c55006a29`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 03:25:07 GMT
CMD ["apache2-foreground"]
# Tue, 15 Nov 2022 17:32:09 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 15 Nov 2022 17:32:09 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 15 Nov 2022 17:32:09 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 15 Nov 2022 17:34:04 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 17:34:05 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 15 Nov 2022 17:34:05 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 17:34:05 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 17:37:53 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 17:38:32 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 17:38:35 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 17:38:35 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 17:38:35 GMT
...
-	Layers:
	...
	-	`sha256:8e2d60949b52fbdb516c2a1971936e074e75f74cc8a94cde3bd0a7f409cfefaf`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5cf5c969bc21576f564956ad5b11296c64df9d24688dca9e4ce731828295756`  
		Last Modified: Tue, 15 Nov 2022 17:47:56 GMT  
		Size: 1.6 MB (1648409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b07996a7c6437afcadcb810ff03bc4ee7e6d041479f2177a9c7f13397c3f2091`  
		Last Modified: Tue, 15 Nov 2022 17:47:58 GMT  
		Size: 15.1 MB (15075562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1620e714392f20b5dd9bcec3aded7eb6d3cd2f9c23d49123a9a5f25bfa13f2ca`  
		Last Modified: Tue, 15 Nov 2022 17:47:53 GMT  
		Size: 596.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c8bd5f523ab15cc887ebe73815f51f46a7f1a5f7442b639c3bb7cd1922f49a`  
		Last Modified: Tue, 15 Nov 2022 17:47:54 GMT  
		Size: 568.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37aa6e4035437520c6fb5fde88be03abac5a07afe298f9beaf1a04a0e8f97df2`  
		Last Modified: Tue, 15 Nov 2022 17:49:18 GMT  
		Size: 134.9 MB (134930872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc99c9cba0c06859265a9624149de978aa82302410371187e9d560ca251dd195`  
		Last Modified: Tue, 15 Nov 2022 17:49:04 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2ea7d08ce3f8f5480766b5e2f6f9e6d7bd0ffb7b8b413e417d8df0e3a03b982`  
		Last Modified: Tue, 15 Nov 2022 17:49:04 GMT  
		Size: 2.2 KB (2214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; 386

```console
$ docker pull nextcloud@sha256:d6262cfa274c6fe3132b7e1735d8e2ed1f6a4c4940bd595daab609a9fe9bba10
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.5 MB (319482993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:335077942189b5373e8f1a0affc01acf7c09caa0fe2e4e900d5cc7f70ae57ca1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 03 Nov 2022 20:42:16 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 20:43:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Nov 2022 20:43:08 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 20:43:09 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 20:43:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 20:43:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3c9f8eb473792962e6347fa3c64b649ce0e56545355cffba96431df3a6c2e8a0`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6559db92388078f87920bacc9ff7cd1688541282a447325e751c84568e35cd1`  
		Last Modified: Thu, 03 Nov 2022 20:55:20 GMT  
		Size: 134.7 MB (134696007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54ba20acc890e015ed88d5d4279e73c82d5f33822501a6649faf9b024211ef04`  
		Last Modified: Thu, 03 Nov 2022 20:55:03 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d6701ef30871a537af1924a0c440ddd121e7f6a0122c3fa4816912dd5189b8d`  
		Last Modified: Thu, 03 Nov 2022 20:55:03 GMT  
		Size: 2.2 KB (2217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; mips64le

```console
$ docker pull nextcloud@sha256:0583d95cb8adb5cae1d8cdcb2dcd005b7df90ab2164e44751717d53713484e13
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.5 MB (292535299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6077d19335a91c1eb05a36d430b68e33bbbe5ec2df687d60054de64333daf73b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 03 Nov 2022 22:08:56 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 22:11:29 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Nov 2022 22:11:40 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 22:11:49 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 22:11:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 22:12:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:882ea22eb57dd8a59bc59c2f77f1b45b8bdec3e6cd10020dafbf31ba94b58a07`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8125a7b25b45b87904a793255057e1b4875faf25b58cb8d9c89dc572ac2249a7`  
		Last Modified: Thu, 03 Nov 2022 22:29:48 GMT  
		Size: 134.7 MB (134696295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee3c5d90576ef95e2eebe12b972b740b0445782d58153ca15774989ebd3e3e4b`  
		Last Modified: Thu, 03 Nov 2022 22:28:25 GMT  
		Size: 3.3 KB (3255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db66411b447f915159dbefb18e3d5b6dc191712d0dc8c396f643516251774a7c`  
		Last Modified: Thu, 03 Nov 2022 22:28:25 GMT  
		Size: 2.2 KB (2216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; ppc64le

```console
$ docker pull nextcloud@sha256:632c55ff46b86409696625661980a91d580e488f750e5fd3ac49680d8d8c6811
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318648470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b5ef22acd0b8b682a5c2d996e7cf9413de59e8ec143d05a00ca532fcb495659`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 03 Nov 2022 19:59:43 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Thu, 03 Nov 2022 20:00:55 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Nov 2022 20:01:03 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Thu, 03 Nov 2022 20:01:05 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Thu, 03 Nov 2022 20:01:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Nov 2022 20:01:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:14b8850e234d3f756abe9e0974c9ec9f521ddce1419ca4d45ce99ed992c04c6e`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ad6df29a4e1a749dfb0c384118cdb9b2dcdef38f6cba20313c5cac2f8e7b67d`  
		Last Modified: Thu, 03 Nov 2022 20:11:25 GMT  
		Size: 134.9 MB (134932624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ed61bbd034d46a7aba319581b156c5cb542c8a912c8203e1dd5cd9d634e7c07`  
		Last Modified: Thu, 03 Nov 2022 20:10:57 GMT  
		Size: 3.3 KB (3254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:176bcd10163e593a1d634e3e5028e22917b574b7f577534edef70ac7faadd44f`  
		Last Modified: Thu, 03 Nov 2022 20:10:57 GMT  
		Size: 2.2 KB (2216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `nextcloud:24.0.7` - linux; s390x

```console
$ docker pull nextcloud@sha256:27159b59cdde9233c365178035c51ade773a9a4a1fa6d3745c2fad07fbfb3d59
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.1 MB (293075615 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:132e2b48aa4393f4a961d327bc06703f99502b51ad2d78a6ccc73054f2948e82`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 04:16:09 GMT
CMD ["apache2-foreground"]
# Tue, 15 Nov 2022 17:41:49 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static         libldap-common     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Tue, 15 Nov 2022 17:41:49 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 15 Nov 2022 17:41:49 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 15 Nov 2022 17:44:48 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 17:44:50 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=16';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=60';     } > "${PHP_INI_DIR}/conf.d/opcache-recommended.ini";         echo 'apc.enable_cli=1' >> "${PHP_INI_DIR}/conf.d/docker-php-ext-apcu.ini";         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > "${PHP_INI_DIR}/conf.d/nextcloud.ini";         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 15 Nov 2022 17:44:50 GMT
VOLUME [/var/www/html]
# Tue, 15 Nov 2022 17:44:51 GMT
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 17:53:08 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 17:53:50 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 17:53:57 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 17:53:58 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 17:53:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 17:53:58 GMT
...
-	Layers:
	...
	-	`sha256:6ef9e7c0d0fe42bc1383d695235550d362d66312dac1c7d9c9380a054f34591e`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95477c10a512a20fd47d96b20e495306db69b9665aaca52837fbe2a593e45d3a`  
		Last Modified: Tue, 15 Nov 2022 17:57:41 GMT  
		Size: 1.7 MB (1660378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d944a5f223102efd8f74fdeeee9c4c590b02ec22d0bf9748f364b735cdb58b3`  
		Last Modified: Tue, 15 Nov 2022 17:57:43 GMT  
		Size: 15.1 MB (15054104 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3000a59b2d90bc816d9bd5f0ef4fbd366798daee4d78aaa32b2b21e99e98a25f`  
		Last Modified: Tue, 15 Nov 2022 17:57:40 GMT  
		Size: 598.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eecbb8403089de74c7f88315af29301a407ee2301f22974220ca69f5f2f1a3ba`  
		Last Modified: Tue, 15 Nov 2022 17:57:40 GMT  
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17b5ec5a092eee3543a74934e9c574fcc3b848fefaab7cd7dc8e66b2e8b7975`  
		Last Modified: Tue, 15 Nov 2022 17:58:56 GMT  
		Size: 134.9 MB (134930342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b49c2dc11afa8ca01293a1602b6d458532fd580f8a5ce4bf197db30149264ae`  
		Last Modified: Tue, 15 Nov 2022 17:58:41 GMT  
		Size: 3.3 KB (3253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aa94a41076e9b231d458e772166a0d731da9d1cefdfc69b7117836ffb148a83`  
		Last Modified: Tue, 15 Nov 2022 17:58:41 GMT  
		Size: 2.2 KB (2214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
