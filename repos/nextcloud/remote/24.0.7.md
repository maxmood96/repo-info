...
```console
$ docker pull nextcloud@sha256:b839e31616f238a44773ead523b50607c1700458c9b8be3aee79eb562d831284
```
...
```console
$ docker pull nextcloud@sha256:1a89aace961e6756daa6401998fa787013a32e2aef10503f3be0971c35487b13
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.3 MB (319334660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a46d0d67a991c9a11a03d255b6dd6aa65518f2a8db743aebfa06204f027d59d4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 21:50:26 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 21:51:10 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 21:51:12 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 21:51:13 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 21:51:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 21:51:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1f0be3e62171ec7332cfc1466cd941f3235090b662532536b0e79bffb1fcdccc`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f02179222a19a40f934f1f1d4a2f2371f4e8b55fd426d894bafeda0541d0a10`  
		Last Modified: Tue, 15 Nov 2022 21:58:54 GMT  
		Size: 134.7 MB (134695767 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b70a874111c0e73dd5f5696b5441b511ac95e9970fa06e1b12397b162789ae6`  
		Last Modified: Tue, 15 Nov 2022 21:58:37 GMT  
		Size: 3.3 KB (3253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e54d5d06d20f390fd47eea1d997c6bff888a0e315a4fedf8411ee8dd888cb18`  
		Last Modified: Tue, 15 Nov 2022 21:58:37 GMT  
...
```console
$ docker pull nextcloud@sha256:6d49ece2d5d2b9b2e08940526ff9b279749546ee7d80e62dc53f55bc258348ec
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.5 MB (292529560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8673ea3b61f909794a253ddcec0d9ea69055ed9fddae331c1bee6f7528973104`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 16 Nov 2022 08:44:58 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Wed, 16 Nov 2022 08:47:26 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 16 Nov 2022 08:47:37 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Wed, 16 Nov 2022 08:47:46 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Wed, 16 Nov 2022 08:47:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 16 Nov 2022 08:48:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:66bfc37b3c908438083ba605ed72e30ea6e571381792c008b16cf97a3695cc49`  
		...
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4573eacb66b73b7ae7f10a3cd61a39b8e56515828d9035dbc42c014a2d0e4a1`  
		Last Modified: Wed, 16 Nov 2022 09:28:04 GMT  
		Size: 134.7 MB (134696254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26d3c31a6df22019d903e720d59091e8d92afd1ed64b1020fe80152e0f4970c6`  
		Last Modified: Wed, 16 Nov 2022 09:26:44 GMT  
		Size: 3.3 KB (3252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9faec3878e3161634e490d56f53d3ba054ee0260af00ff3b878980c21938be3f`  
		Last Modified: Wed, 16 Nov 2022 09:26:40 GMT  
...
```console
$ docker pull nextcloud@sha256:f581a81b2a6fa9bcb25eaf5f3ab1eb8d222b259085b3fb139adab3b7a04ebee0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.5 MB (318493004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a627a5252ae7fc72ed936488120197536f934522a79d0620d751046d78c623a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod headers rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 15 Nov 2022 23:17:27 GMT
ENV NEXTCLOUD_VERSION=24.0.7
# Tue, 15 Nov 2022 23:18:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 23:18:39 GMT
COPY multi:0cccc72c9a4e79ccbe6d278f97f716db21395ef909a9ae529a43f9e88351b897 in / 
# Tue, 15 Nov 2022 23:18:40 GMT
COPY multi:5ae4d3e2c333d07b72b698ef5d54be9ec19b520851d7d23aff0a612bc28d533d in /usr/src/nextcloud/config/ 
# Tue, 15 Nov 2022 23:18:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 15 Nov 2022 23:18:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6dea37347283a6402fed2f4dcf5de83d015c3098900333760c2ceea1091ad774`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df3a80229c28bd8fad397937f9b0cba6b5b8dc050195de21167112967168082b`  
		Last Modified: Tue, 15 Nov 2022 23:23:31 GMT  
		Size: 134.9 MB (134932674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1edf2d13a38e0f5d8da06fb856fa3b0d97ea404b60bd8da10931fe714c96fdfa`  
		Last Modified: Tue, 15 Nov 2022 23:23:02 GMT  
		Size: 3.3 KB (3251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:859e610c52b1011080825148cc5cadcd0e22213b88d4fb41d527a2c7258e30ef`  
		Last Modified: Tue, 15 Nov 2022 23:23:03 GMT  
		Size: 2.2 KB (2215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
