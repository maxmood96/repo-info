...
```console
$ docker pull nextcloud@sha256:fa97ec498d56ffefecd1300ea44d3ff4422862764ac178f20df909d47df81ffa
```
...
### `nextcloud:26.0.13` - linux; arm variant v5
...
### `nextcloud:26.0.13` - linux; arm variant v7
...
### `nextcloud:26.0.13` - linux; mips64le
