...
### `nextcloud:27.1.8-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:27.1.8-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:27.1.8-fpm-alpine` - linux; 386
...
### `nextcloud:27.1.8-fpm-alpine` - linux; ppc64le
...
### `nextcloud:27.1.8-fpm-alpine` - linux; s390x
