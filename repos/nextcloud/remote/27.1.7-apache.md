...
```console
$ docker pull nextcloud@sha256:d806292217003be88bb0d2c1dfd32ae52abff4c6b5bfab0817b2684c98387281
```
...
### `nextcloud:27.1.7-apache` - linux; amd64
...
### `nextcloud:27.1.7-apache` - linux; arm variant v5
...
### `nextcloud:27.1.7-apache` - linux; arm variant v7
...
### `nextcloud:27.1.7-apache` - linux; arm64 variant v8
...
### `nextcloud:27.1.7-apache` - linux; ppc64le
...
### `nextcloud:27.1.7-apache` - linux; s390x
