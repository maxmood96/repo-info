...
```console
$ docker pull nextcloud@sha256:05f50f6d5b901f9ee5d5a18cf67211ce55486f7ad64f0b32753b2b64853e10d1
```
...
```console
$ docker pull nextcloud@sha256:50a8eba500be312c7585c506339f5c5d3d0d3f4e64a19dede169e487b1ce6243
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.7 MB (150699262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f76bf28eb44826e6ac5b06254969857380f159fc4b3d429b8e1c8ed32911d50e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Aug 2020 07:22:37 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 07:22:38 GMT
ENV NEXTCLOUD_VERSION=19.0.1
# Fri, 07 Aug 2020 07:23:28 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 07 Aug 2020 07:23:34 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 07 Aug 2020 07:23:41 GMT
COPY multi:0f9299c697c03625557426785fb6ad8cae5e661ea8ceedf25eb083ff586c1e00 in /usr/src/nextcloud/config/ 
# Fri, 07 Aug 2020 07:23:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Aug 2020 07:23:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8748631c9a380b516f89efccdf6066a28be2266f0f683520f4dbe7f13775a360`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ba5bf677584fe70aaa4fbbc2c8f6510c66ea37fc669857de0f1e2467c681b6f`  
		Last Modified: Fri, 07 Aug 2020 07:36:15 GMT  
		Size: 98.6 MB (98610801 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5e62f110218ef8d0e09344ec534c1865dff6de59d44004ab5380237c06165b1`  
		Last Modified: Fri, 07 Aug 2020 07:35:43 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6e04c3799554477177f2a00d763ef15c1f842966c2dd616bd70ef40c693c65d`  
		Last Modified: Fri, 07 Aug 2020 07:35:43 GMT  
...
```console
$ docker pull nextcloud@sha256:a37d6a5bbafe0cd638169e6faf8a0f68e0054807350804b285e3cceeedb7ece4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.1 MB (154059287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d305c6bd5ca93709062dcedcdca1ef26c652e1de5cc66804eb24e60e15fbd253`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 05:00:00 GMT
ENV NEXTCLOUD_VERSION=19.0.1
# Fri, 07 Aug 2020 05:01:19 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 07 Aug 2020 05:01:25 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 07 Aug 2020 05:01:29 GMT
COPY multi:0f9299c697c03625557426785fb6ad8cae5e661ea8ceedf25eb083ff586c1e00 in /usr/src/nextcloud/config/ 
# Fri, 07 Aug 2020 05:01:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Aug 2020 05:01:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:076bef350e22c1509080a814660e0474f0bfbe6088b08fc13b19ae8b5dd01bc9`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74aceabeceff30ddb0587ae09372f173b84d06301f9471287878da7fa001fd5e`  
		Last Modified: Fri, 07 Aug 2020 05:14:01 GMT  
		Size: 98.6 MB (98611051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:501bb506921c56ac10e88f856e1312f31e51d87567b6d2dd4c626bd0df4770a5`  
		Last Modified: Fri, 07 Aug 2020 05:13:35 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15a73c3e80d7b525eaff7593db5f990ac2e400ce5045bebd8ff6703cc8432d76`  
		Last Modified: Fri, 07 Aug 2020 05:13:35 GMT  
