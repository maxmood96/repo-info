...
```console
$ docker pull nextcloud@sha256:2162a8ec882261015378f8d16eae593b6dbf61a119852c4466ac3e4c8bcd4c3f
```
...
```console
$ docker pull nextcloud@sha256:2b55dd4f5f503e9d075889a439a871ef79b0418ad1bd2e9c7309adbbdb6d3158
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159687633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ede09158b813699a567507d30ea9b2c6483ff4dd22aa0ee9ac670bf299d65472`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=19.0.6
# Fri, 11 Dec 2020 02:07:37 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 11 Dec 2020 02:07:50 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 11 Dec 2020 02:07:53 GMT
COPY multi:c5285e56ce0b7b741771c024a5062676207fdec99e1d8cf9b468b5957f17abb6 in /usr/src/nextcloud/config/ 
# Fri, 11 Dec 2020 02:08:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Dec 2020 02:08:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:adae39e0723188255ebd492966b70952824473f92afd0901c9f6399742931e1e`  
		...
		Size: 523.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3f587c2c1576af33814511c7030945b9324f1bc82f3bf10a7c8f008246c9338`  
		Last Modified: Fri, 11 Dec 2020 02:11:40 GMT  
		Size: 105.8 MB (105814706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:647d4523f2e6e15f84bcb3edff4a954229377b000d6052a00cf31a763c6c0005`  
		Last Modified: Fri, 11 Dec 2020 02:10:57 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a530bd98b4e04ca51d0d5e907673ad558e2f15e04f44ee86b8886e7bbd1b062c`  
		Last Modified: Fri, 11 Dec 2020 02:10:57 GMT  
