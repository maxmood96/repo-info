...
```console
$ docker pull nextcloud@sha256:2d2ca554f8106b58ea3378732409bc4f481ffc8a29be27f61aa2c2606fc71c55
```
...
```console
$ docker pull nextcloud@sha256:27e9cbe774659faabf079b9208883a19bcf09e262855273a54ab92741dae745f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159893459 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:081bba9c43082b4cc3b7de49ae56caee12637c9a7e6a4a0bf20dfe259cd5d45c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 01 Oct 2020 20:36:44 GMT
ENV NEXTCLOUD_VERSION=18.0.9
# Thu, 01 Oct 2020 20:37:35 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Oct 2020 20:37:38 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 01 Oct 2020 20:37:45 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 01 Oct 2020 20:37:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Oct 2020 20:37:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c99a78d2f334653348f2224b6e762150714a77d5da0567f32d384976dfc28ecf`  
		...
		Size: 529.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d52af26c2c7f00cd3817b592dcb192484968002f7af2d27e48cb9e51b68683a1`  
		Last Modified: Thu, 01 Oct 2020 20:47:48 GMT  
		Size: 104.0 MB (104036872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4ce8ca1ec97a63071824c3011aa1a266f1f2cc85379271f13249cf2973ca61c`  
		Last Modified: Thu, 01 Oct 2020 20:47:15 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30020c752c4a5896047feb8d69efe64dced5125f10cf22b7dfb5980e00947317`  
		Last Modified: Thu, 01 Oct 2020 20:47:16 GMT  
...
```console
$ docker pull nextcloud@sha256:d8e9c2524fb2522b90d1dc415912887255dfc6abb3ce8b471e54fbf70195e26c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.5 MB (161531588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f26914b614fb9d9747cc0899a12af87930cd6813c87f2e6eed57f37375ff43c1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=18.0.9
# Thu, 01 Oct 2020 22:13:17 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Oct 2020 22:13:23 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 01 Oct 2020 22:13:28 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 01 Oct 2020 22:13:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Oct 2020 22:13:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:82ff72c6d080de5f6aa2cb30c756cc7d56d0177c5cd57f239d8cf087cc348102`  
		...
		Size: 525.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4e43171f81b83699ba6470a38130a0ba8e1c110d7b6c096baa79619a4198b1`  
		Last Modified: Thu, 01 Oct 2020 22:53:37 GMT  
		Size: 104.0 MB (104036831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7930900686c0bd319cf4ee732ee85fad516b86e74098bd3f13bac25bab282483`  
		Last Modified: Thu, 01 Oct 2020 22:53:09 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:462e41b87466bd630232344a3571db8600737e103a03d38842ca0625461d0b7e`  
		Last Modified: Thu, 01 Oct 2020 22:53:09 GMT  
		Size: 1.9 KB (1890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f2b9cf19f341b04c4d72a5c6753db0679efab3f9eb989ea41e0bb1530ba374fd
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.1 MB (161053957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fd76d915f4175441af456dccb17ad4ee1fbaf8138519cc06a796bf229a72e85`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Oct 2020 20:19:05 GMT
VOLUME [/var/www/html]
# Thu, 01 Oct 2020 20:22:41 GMT
ENV NEXTCLOUD_VERSION=18.0.9
# Thu, 01 Oct 2020 20:23:02 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 01 Oct 2020 20:23:06 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 01 Oct 2020 20:23:07 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 01 Oct 2020 20:23:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Oct 2020 20:23:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9e510ae7e45a070481e3b1d05dc62c4c4498c4d02d905fe00ac52a3b2dbd27ba`  
		...
		Size: 526.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39b58e456a4367a26bb87a952c32806746ae50894b808c99b520531720dea402`  
		Last Modified: Thu, 01 Oct 2020 20:36:19 GMT  
		Size: 104.0 MB (104036802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:390f5340c35f3c78d72acbd8d390305d0e1509b095c6709bc921989c7e426f1c`  
		Last Modified: Thu, 01 Oct 2020 20:36:06 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:686269d4de3d4695aae1f0eaa38dc202f6b30e98c227fc83622ebfb5648a3263`  
		Last Modified: Thu, 01 Oct 2020 20:36:07 GMT  
