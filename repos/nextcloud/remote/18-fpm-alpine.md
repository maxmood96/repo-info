...
```console
$ docker pull nextcloud@sha256:aa6da02f6decd4ca2a41d8e4f19227f26580e9ff217e91d0df734f63698d4a3d
```
...
```console
$ docker pull nextcloud@sha256:af0097747fd0b6118a6b14cd44125bcda026df6722a0e423b29be44b56634a92
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157474725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35330e398789cd9dfac5b945ea1571806bc30a5d5b61450bfb61fb3ae7065c8f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 22 Oct 2020 11:13:30 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Thu, 22 Oct 2020 11:14:14 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Thu, 22 Oct 2020 11:14:19 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 22 Oct 2020 11:14:22 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 22 Oct 2020 11:14:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 22 Oct 2020 11:14:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b8b29f534730fd39fd733e28dbaea1343a2d055d193f62ff785d3a76e0fee6ce`  
		...
		Size: 530.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38cc7ccfbde765edfe6b56524ca929a46bea83fd3bcdb0cae89da1f22ab805ef`  
		Last Modified: Thu, 22 Oct 2020 11:22:13 GMT  
		Size: 102.2 MB (102216440 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdd312bed55aab5c1025d02de430612c163e8f1dc52c4e15a353e6188214979f`  
		Last Modified: Thu, 22 Oct 2020 11:21:38 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4d62710fc472632be5f4a24d29c31fa13ae44eb6248a611ea983aab95c41400`  
		Last Modified: Thu, 22 Oct 2020 11:21:38 GMT  
