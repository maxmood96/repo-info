...
```console
$ docker pull nextcloud@sha256:6d34b940db1a0b605777a8d4de054b366c001070098b4d0ddb324115df81f433
```
...
```console
$ docker pull nextcloud@sha256:80444894ed5df705abd4f90f9e3702b5143e25456cbfa2c7d251d8874a847957
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.1 MB (161052382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e7d24c2911524de3b66ac63aab75087013635cd1edf28fe7bfdcf84013650d2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 07:13:28 GMT
ENV NEXTCLOUD_VERSION=18.0.10
# Fri, 30 Oct 2020 07:14:59 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Fri, 30 Oct 2020 07:15:04 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 30 Oct 2020 07:15:06 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Fri, 30 Oct 2020 07:15:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 30 Oct 2020 07:15:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d6a5d9b7566d53572e11c767f7917831df5e79f162582f891b232ba54eec4026`  
		...
		Size: 528.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360bdd2e9da7666108f2fa70324c9b65645978a62c886026b8b86e6f8eed18cd`  
		Last Modified: Fri, 30 Oct 2020 08:19:02 GMT  
		Size: 102.2 MB (102216477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf2e112f6100b235bc48897e22a8fa395323dc4eb62c5bd9d8569da452aab862`  
		Last Modified: Fri, 30 Oct 2020 08:17:24 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f1d0fc5a8ccf8a50b7fd18fad60689e1f87fefe93eae429fa26f67c90af6329`  
		Last Modified: Fri, 30 Oct 2020 08:17:24 GMT  
		Size: 1.9 KB (1890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
