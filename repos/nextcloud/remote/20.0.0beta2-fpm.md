...
```console
$ docker pull nextcloud@sha256:d35cebd57719278a8a1bc574fb431a1039c443107f4945f1d83de8f270593251
```
...
```console
$ docker pull nextcloud@sha256:16d42123a77e8d72514ea2eeb7fafc1e2875892e7434be1b4bb1677f94e4fd23
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **277.3 MB (277253111 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0216124ee8e750cf60af9fd562f60f1d9a17c0179b4894f38e7e5c1c0f187ee4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Aug 2020 05:07:27 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 03:43:15 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta2
# Tue, 01 Sep 2020 03:44:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 03:45:18 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 03:45:51 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 03:46:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 03:46:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:79644126ed115c618dc408f2a8f5a3b4fcb22f771372cee51bada400f62ec63e`  
		...
		Size: 533.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20061b4ff402530b8a6d529973414b7238cd3bfff6f5d74b4507f399cd06fcea`  
		Last Modified: Tue, 01 Sep 2020 03:53:43 GMT  
		Size: 125.7 MB (125695653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76359583bdd9293ab424d47dc1935ca21a26485debe74507b772998bd1f4bd9b`  
		Last Modified: Tue, 01 Sep 2020 03:53:06 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50ff51e82b80a3e3de5227215130cd0f4defd1e1b16dfdbd1566f28b3db6ba88`  
		Last Modified: Tue, 01 Sep 2020 03:53:06 GMT  
...
```console
$ docker pull nextcloud@sha256:195d094e7951234a71e5a960615c8c152158f7634e29813708b6730dbced229c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.9 MB (297878195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:143e90db81e07ea1b2e95dea5ee42f35cd7b0eb186dc4a5d31b45df1c069fb60`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 03:16:01 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta2
# Tue, 01 Sep 2020 03:20:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 03:20:20 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Tue, 01 Sep 2020 03:20:23 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Tue, 01 Sep 2020 03:20:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 03:20:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6e11bc4553ae71ce766a5346c306aca80a81ea85dabe7ed99919357baa9ab127`  
		...
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5582045a2e85cdd57cbc869e55487137671c3a4aaf2c3d5d1e003024cfc582c2`  
		Last Modified: Tue, 01 Sep 2020 03:29:44 GMT  
		Size: 125.7 MB (125698938 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327285421b88b9c67fd9b0ba9b1f8e71c83658ef758b57ae699583c47f1de5c1`  
		Last Modified: Tue, 01 Sep 2020 03:29:06 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be6259f1343971d5b11dae76416220598579542ac1e963e8db191fdfdd6f5ca9`  
		Last Modified: Tue, 01 Sep 2020 03:29:06 GMT  
		Size: 1.6 KB (1649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
