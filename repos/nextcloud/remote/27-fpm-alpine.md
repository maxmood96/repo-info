...
```console
$ docker pull nextcloud@sha256:d6947b9170b2d93b52c8a7a4d4d486d76eae798b693b14dfccba2f9409112cd5
```
...
```console
$ docker pull nextcloud@sha256:ae5d698b69b719a584d2a300277a4d457f4204da6f523c5b1b0a28826c091ccd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.1 MB (266064849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfe02af891ac819df59e130c866c8d4a03845fd0c886dfd915f7bbfb48bba3e7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 23 Jun 2023 18:44:32 GMT
VOLUME [/var/www/html]
# Fri, 23 Jun 2023 18:47:35 GMT
ENV NEXTCLOUD_VERSION=27.0.0
# Fri, 23 Jun 2023 18:48:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 23 Jun 2023 18:48:27 GMT
COPY multi:f14917ef3f8441cf73a9faa81b54c7e51061a07185e365974d47ddb315426c8f in / 
# Fri, 23 Jun 2023 18:48:27 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 23 Jun 2023 18:48:27 GMT
...
-	Layers:
	...
	-	`sha256:14cccd13d9aceb1bb64c90201855fe66ee324bbefb767a09275642cb1e790050`  
		...
		Size: 761.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d73dda6cc8930cf44f1abfeec7950e12c5c5a2233a1a3cb7f73963944a07d50`  
		Last Modified: Fri, 23 Jun 2023 18:53:57 GMT  
		Size: 183.9 MB (183910279 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:419cfc1038e3e26b9a48c8270e0d560acd819c768f10967d76d66cc68bf16c4c`  
		Last Modified: Fri, 23 Jun 2023 18:53:40 GMT  
		Size: 3.5 KB (3470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:212ce5b185ec365d123b2d6e8a5926f2bbc20518c56a6a0c4f289c688ce940b2`  
		Last Modified: Fri, 23 Jun 2023 18:53:41 GMT  
...
```console
$ docker pull nextcloud@sha256:36883dc83dcb1243f750b9d20a0bef8ec41fe4406840530775a2e990b759ae8c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.5 MB (263490451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95e93d3d70b8972cf69154f003cced1d0a9fe7124a6fce4ad9c562cf6f8963eb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV NEXTCLOUD_VERSION=27.0.0
# Fri, 23 Jun 2023 18:49:22 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-27.0.0.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-27.0.0.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com  --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del --no-network .fetch-deps
# Fri, 23 Jun 2023 18:49:26 GMT
COPY multi:f14917ef3f8441cf73a9faa81b54c7e51061a07185e365974d47ddb315426c8f in / 
# Fri, 23 Jun 2023 18:49:27 GMT
COPY multi:1aa0c68034f207c7e2fb6f047fda45b55878afe2781ef10723107e35ee22547e in /usr/src/nextcloud/config/ 
# Fri, 23 Jun 2023 18:49:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 23 Jun 2023 18:49:27 GMT
...
-	Layers:
	...
	-	`sha256:f3678552253d3aeb343e8099093f0c1ad8649ae444de18ca7bc4024d79101afa`  
		...
		Size: 765.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00d5f1e5588502b3df36801c3c0b1c9f3578403e1e99a74286b6e58a5050ac33`  
		Last Modified: Fri, 23 Jun 2023 18:57:19 GMT  
		Size: 183.9 MB (183910413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56654f4021236c190069b0c61df5dcecf5e01baa143bf5af1cad4dd37452927d`  
		Last Modified: Fri, 23 Jun 2023 18:56:47 GMT  
		Size: 3.5 KB (3470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:879a691975878ac137a885090bdbde8a1818c12881de358366afc238348bd0eb`  
		Last Modified: Fri, 23 Jun 2023 18:56:48 GMT  
