...
```console
$ docker pull nextcloud@sha256:6b8b71c4fc2fa9fe80b983531e8ed6a0ab067a2ac668a3bae9b3ed47cf789923
```
...
### `nextcloud:25.0.11-apache` - linux; amd64
...
### `nextcloud:25.0.11-apache` - linux; arm variant v5
...
### `nextcloud:25.0.11-apache` - linux; arm variant v7
...
### `nextcloud:25.0.11-apache` - linux; arm64 variant v8
...
### `nextcloud:25.0.11-apache` - linux; 386
...
### `nextcloud:25.0.11-apache` - linux; mips64le
...
### `nextcloud:25.0.11-apache` - linux; ppc64le
...
### `nextcloud:25.0.11-apache` - linux; s390x
