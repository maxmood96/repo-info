...
```console
$ docker pull nextcloud@sha256:aeecb414edcfcee04c27a9d4e99040b5e521cb3da8499c97f7acd4bae7da870b
```
...
```console
$ docker pull nextcloud@sha256:36c956470ad048269ad743b66fef19c29da3412185a78b4e526b97710f37e7f1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.3 MB (270341337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7175a67803efc89f036733c9e08c3deca8eec0005206fd8ac13a5fdefc10f1da`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Oct 2021 11:55:22 GMT
CMD ["php-fpm"]
# Wed, 13 Oct 2021 11:29:51 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         busybox-static     ;     rm -rf /var/lib/apt/lists/*;         mkdir -p /var/spool/cron/crontabs;     echo '*/5 * * * * php -f /var/www/html/cron.php' > /var/spool/cron/crontabs/www-data
# Wed, 13 Oct 2021 11:29:51 GMT
ENV PHP_MEMORY_LIMIT=512M
# Wed, 13 Oct 2021 11:29:52 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Wed, 13 Oct 2021 11:36:44 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         libcurl4-openssl-dev         libevent-dev         libfreetype6-dev         libicu-dev         libjpeg-dev         libldap-common         libldap2-dev         libmcrypt-dev         libmemcached-dev         libpng-dev         libpq-dev         libxml2-dev         libmagickwand-dev         libzip-dev         libwebp-dev         libgmp-dev     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";     docker-php-ext-configure gd --with-freetype --with-jpeg --with-webp;     docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch";     docker-php-ext-install -j "$(nproc)"         bcmath         exif         gd         intl         ldap         opcache         pcntl         pdo_mysql         pdo_pgsql         zip         gmp     ;         pecl install APCu-5.1.20;     pecl install memcached-3.1.5;     pecl install redis-5.3.4;     pecl install imagick-3.5.1;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 11:36:46 GMT
RUN {         echo 'opcache.enable=1';         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidate_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/nextcloud.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Wed, 13 Oct 2021 11:36:47 GMT
VOLUME [/var/www/html]
# Wed, 13 Oct 2021 11:36:47 GMT
ENV NEXTCLOUD_VERSION=20.0.13
# Wed, 13 Oct 2021 11:38:05 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 11:38:08 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Wed, 13 Oct 2021 11:38:10 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Wed, 13 Oct 2021 11:38:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 13 Oct 2021 11:38:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:711087a30f3665e0d3908bd057e5687131b2a114c2c3be9c8fcb4cc7159f334d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19b1ca06244a70abe76f5da2e8136b1f12a4a0891a0f1734a6b9416871b66e7b`  
		Last Modified: Wed, 13 Oct 2021 12:05:04 GMT  
		Size: 1.5 MB (1478476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac79b3beab25acbef6f17c5afa7886fabb4f81e0697a13e6fe70dd00a127069a`  
		Last Modified: Wed, 13 Oct 2021 12:05:10 GMT  
		Size: 14.5 MB (14543330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c5be781bef39ca04097d29d9a7c016c5307276fe6faf90f05c67b6ca6107c44`  
		Last Modified: Wed, 13 Oct 2021 12:05:02 GMT  
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:739cd21438afb5ff6df463884c6e6d53d33a1c7657ce6899c38498898eea29d5`  
		Last Modified: Wed, 13 Oct 2021 12:06:22 GMT  
		Size: 120.2 MB (120213003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3be780b130e12ddaee0f295397773130e8b283a39cf3b7ee4cf515aebbd5734`  
		Last Modified: Wed, 13 Oct 2021 12:05:02 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3ab5b94d2e45ad7adeb7b1d17936569468aaa4f3a9b668dec62ac5842307b6f`  
		Last Modified: Wed, 13 Oct 2021 12:05:02 GMT  
...
```console
$ docker pull nextcloud@sha256:eb619d7ae3dbc8e3cb8375015b99c9ea0128044ff5b85d715d3512dd0d89c9b2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.9 MB (278918823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2fad9b1e64cc94f2e010534e6f3da3084692209c7497b618dcb34ddcbe29980`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 06 Oct 2021 06:49:15 GMT
ENV NEXTCLOUD_VERSION=20.0.13
# Wed, 06 Oct 2021 06:51:02 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 06 Oct 2021 06:51:06 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Wed, 06 Oct 2021 06:51:08 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Wed, 06 Oct 2021 06:51:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 06 Oct 2021 06:51:08 GMT
...
-	Layers:
	...
	-	`sha256:f7b54053d2a5c5bf4d42c748409921a13cc93df4cf3b6a7fa045fb2d1209dc91`  
		...
		Size: 568.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae979ac47b077b191f5fe48475c6a02ff4f1fb6f15f7349acf9bd7e62a1fb81a`  
		Last Modified: Wed, 06 Oct 2021 07:20:18 GMT  
		Size: 120.2 MB (120212874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee17565f1b91601928f2f85ae1dd940f4a916ddbba08ef7f08887d8f1a30c7c1`  
		Last Modified: Wed, 06 Oct 2021 07:18:58 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b30c165a559658bbe7354ade795b7f4bb7a3abba052ea58e4eedf3ee9eb27350`  
		Last Modified: Wed, 06 Oct 2021 07:18:58 GMT  
		Size: 2.1 KB (2055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
