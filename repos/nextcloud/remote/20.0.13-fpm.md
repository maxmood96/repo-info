...
```console
$ docker pull nextcloud@sha256:7cc88609e693cb5e3cf2adba12a963f365e80df410b1f7d0c8fa804d04313265
```
...
```console
$ docker pull nextcloud@sha256:a2e5907cfc8b982c8cd4057e7393bdc662cfe66f59f3ac05df5aea9f7e74128e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.0 MB (278042187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4531259223b77ba5fb183a726f9279cc1f96818a389907cc569650244f9a588`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 28 Oct 2021 19:36:47 GMT
VOLUME [/var/www/html]
# Thu, 28 Oct 2021 19:36:48 GMT
ENV NEXTCLOUD_VERSION=20.0.13
# Thu, 28 Oct 2021 19:38:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Oct 2021 19:38:15 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 28 Oct 2021 19:38:17 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Thu, 28 Oct 2021 19:38:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 28 Oct 2021 19:38:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b58150ddddeed1ac5c146be57c7d4a19a49d41d4204b661f6835dd7633cd2115`  
		...
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb2e4b09d2486d16b216d2b1dff222444e55412e47a4266d2c7218a5ddd7f75`  
		Last Modified: Thu, 28 Oct 2021 19:46:15 GMT  
		Size: 120.2 MB (120213133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd0a4138e2dd8cb922435614ac55d4b61a0fe689b25cd1523ba328ac1b5b0216`  
		Last Modified: Thu, 28 Oct 2021 19:44:54 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45902eb9195961bf303ed0460e032a1c685ac83d1b3f2839c241c7082c10dcb3`  
		Last Modified: Thu, 28 Oct 2021 19:44:54 GMT  
...
```console
$ docker pull nextcloud@sha256:7f9af1e820e4f7396521d4ed5acdcec38c1ac48b3515ff514b746ec4ee19ae0c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.9 MB (303873817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1d5192194a4e27ae5e463a95a923aa7829985854c7bd4f4a2c48b90d7d49a2e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Nov 2021 04:06:57 GMT
ENV NEXTCLOUD_VERSION=20.0.13
# Tue, 09 Nov 2021 04:07:46 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 09 Nov 2021 04:07:47 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Tue, 09 Nov 2021 04:07:48 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Tue, 09 Nov 2021 04:07:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Nov 2021 04:07:48 GMT
...
-	Layers:
	...
	-	`sha256:66b47100a9e5ea9254e81af4d3e5daa1439d76ec31035b601c95193f02334fad`  
		...
		Size: 597.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80d6cd884d074cd5d7af3f0073f18332f5856e4404385fc9668782221eefa76b`  
		Last Modified: Tue, 09 Nov 2021 04:11:57 GMT  
		Size: 120.2 MB (120213866 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:915c5670e7c09e84a16112012b0d65c033cb87df38b514bfa58c9981c0d2be24`  
		Last Modified: Tue, 09 Nov 2021 04:11:35 GMT  
		Size: 2.6 KB (2632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:426367a68138058be905b35c306a87837bc750dd453cd33f7a9a7c4fe0c576d6`  
		Last Modified: Tue, 09 Nov 2021 04:11:35 GMT  
...
```console
$ docker pull nextcloud@sha256:cab21b7441104c67d6b1002e7d7090ab31a4f34af8ef4c75f6e3dd4970168738
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **277.1 MB (277128486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96b4a241e22451741a40f3069ad55ffc1e2e298d51b3ba965c4d135c2e5f384e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 28 Oct 2021 18:30:07 GMT
VOLUME [/var/www/html]
# Thu, 28 Oct 2021 18:30:08 GMT
ENV NEXTCLOUD_VERSION=20.0.13
# Thu, 28 Oct 2021 18:30:44 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 28 Oct 2021 18:30:49 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 28 Oct 2021 18:30:50 GMT
COPY multi:d1870de3d4b4de5680360a8bcad7129a7c7615ba76daad773ab1eee24d4a949f in /usr/src/nextcloud/config/ 
# Thu, 28 Oct 2021 18:30:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 28 Oct 2021 18:30:50 GMT
...
-	Layers:
	...
	-	`sha256:73249c64d106c1ebb7549685837eeba6709ad1cd2877b50603510aed369d7225`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:229f67781fc05077631c6e82352a6d12ca50d43d231fe2c2787f597e34a4122c`  
		Last Modified: Thu, 28 Oct 2021 18:34:34 GMT  
		Size: 120.2 MB (120212939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af9c98588551f1d9a4473bdf5574454cbd51c127f9eaaafd7f722c5a0d274ca3`  
		Last Modified: Thu, 28 Oct 2021 18:34:21 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:010a40bfd1622bdc1811e277b0f771f3a249d3e5542d4b9ca3866f2c19057762`  
		Last Modified: Thu, 28 Oct 2021 18:34:25 GMT  
		Size: 2.1 KB (2053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
