...
```console
$ docker pull nextcloud@sha256:b9dc8f6a4fee196abfcb93bd68d0f501d21e5190716ce7518b9f17845bfae5ee
```
...
```console
$ docker pull nextcloud@sha256:0e063390f78cfcaf8ecd839e240b8204c904854dfd37d39780a3da26fd7a973a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.8 MB (408753113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8009aff4f3036a8a61f3b52f5bdcacb9e676302ca8394c64a55744fe46cbeb5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 27 Sep 2024 02:45:26 GMT
VOLUME [/var/www/html]
# Fri, 27 Sep 2024 02:48:06 GMT
ENV NEXTCLOUD_VERSION=29.0.7
# Fri, 27 Sep 2024 02:49:13 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 27 Sep 2024 02:49:18 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 27 Sep 2024 02:49:18 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Fri, 27 Sep 2024 02:49:18 GMT
...
-	Layers:
	...
	-	`sha256:8fb7f22270e596a289d2b970a9ae7986b58d9e18ac790ac1599594ddbd51b9b7`  
		...
		Size: 713.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c35eed629200c11408349ddfeba251f1a517fb32cd95c182fd739fd2bb34731e`  
		Last Modified: Fri, 27 Sep 2024 02:56:03 GMT  
		Size: 221.4 MB (221357346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84706dccd4be7c32f77c1b22f4d157710246329a366f4085ebfb913c24f6d165`  
		Last Modified: Fri, 27 Sep 2024 02:55:31 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:934158ff267acc6ef666e0b2e2ddc667ae56aa4c42ef8a0e7a4f8304d7763cdc`  
		Last Modified: Fri, 27 Sep 2024 02:55:31 GMT  
...
```console
$ docker pull nextcloud@sha256:2829d307988e004c12af85580e1387d0921fbdd063aa07f50c5c1181d2eba16e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **397.4 MB (397388397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a055a140fc2f6c94f9c38af807bc9a8db0e50fc4aa8b173c4028a1de0c818c1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 27 Sep 2024 01:52:43 GMT
ENV NEXTCLOUD_VERSION=29.0.7
# Fri, 27 Sep 2024 01:53:48 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 27 Sep 2024 01:53:53 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 27 Sep 2024 01:53:53 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Fri, 27 Sep 2024 01:53:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 Sep 2024 01:53:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:12a63995281e510ad15aaccd3bc99371223d71f5122f5661596cfb8825b2da5f`  
		...
		Size: 711.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50c128121ec388ed32f368c73b164448ffff2b4038b73371bf23ea73caee8640`  
		Last Modified: Fri, 27 Sep 2024 02:03:54 GMT  
		Size: 221.4 MB (221357177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:837d00e500efec97d1576b6c2cf677ff1450d852659a00d377cfa8f1531693f7`  
		Last Modified: Fri, 27 Sep 2024 02:03:11 GMT  
		Size: 3.9 KB (3877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a16f3d9e836dd30bd7e2b2b7f6373aef61b5bc8461f82a37540603dff487ba4`  
		Last Modified: Fri, 27 Sep 2024 02:03:11 GMT  
...
```console
$ docker pull nextcloud@sha256:f1aa9362605b8e0e5e30429869d03ffadb3a00d85c76ad90628a09fccf447ca8
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.8 MB (408754306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23fea390ad43203a52950bb3f380c0e5efa0809f7012f7fb3ba0812d9295f173`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 27 Sep 2024 02:10:58 GMT
VOLUME [/var/www/html]
# Fri, 27 Sep 2024 02:16:21 GMT
ENV NEXTCLOUD_VERSION=29.0.7
# Fri, 27 Sep 2024 02:16:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2 "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc "https://download.nextcloud.com/server/releases/nextcloud-29.0.7.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 27 Sep 2024 02:17:06 GMT
COPY multi:f3c1a1c702869b782886f0f296503f363039f205d0235bcaa3e4e0fa8b0d1d39 in / 
# Fri, 27 Sep 2024 02:17:07 GMT
COPY multi:aea9ca1c1203dc95e0f5b2d2738e3c7d37564bdb8350411b15d39b9ca1d1fb05 in /usr/src/nextcloud/config/ 
# Fri, 27 Sep 2024 02:17:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 Sep 2024 02:17:07 GMT
...
-	Layers:
	...
	-	`sha256:0d72d18861aff21128df1819cb50cef598dc353483e25f78a85e57d3008da7a5`  
		...
		Size: 712.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e19ccc5db6ecd3ee84984b9639cafee76b30262ae21dfa0fd952b6d2234b6a4`  
		Last Modified: Fri, 27 Sep 2024 02:24:57 GMT  
		Size: 221.4 MB (221357308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:904e83f0fb6341ececd8bd575f0d50c43b7121d121f1c9deb7ab6cbf87fe08ba`  
		Last Modified: Fri, 27 Sep 2024 02:24:31 GMT  
		Size: 3.9 KB (3880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c82ed21ce19f6819b3d909ebe7e708db3e4cca92f784dbe89816690baeeb0b7`  
		Last Modified: Fri, 27 Sep 2024 02:24:31 GMT  
