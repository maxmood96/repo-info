...
### `nextcloud:31.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:31.0.8-fpm` - linux; arm variant v7
...
### `nextcloud:31.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:31.0.8-fpm` - linux; ppc64le
...
### `nextcloud:31.0.8-fpm` - linux; riscv64
...
### `nextcloud:31.0.8-fpm` - linux; s390x
