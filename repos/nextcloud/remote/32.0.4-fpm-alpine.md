...
```console
$ docker pull nextcloud@sha256:5a02882dd9ccf165b64ff93fa0b0f35c287a442ee771c87aa2232ef00c890260
```
...
### `nextcloud:32.0.4-fpm-alpine` - linux; amd64
...
### `nextcloud:32.0.4-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:32.0.4-fpm-alpine` - linux; ppc64le
