...
### `nextcloud:30.0.3-apache` - linux; amd64
...
### `nextcloud:30.0.3-apache` - unknown; unknown
...
### `nextcloud:30.0.3-apache` - linux; arm variant v5
...
### `nextcloud:30.0.3-apache` - linux; arm variant v7
...
### `nextcloud:30.0.3-apache` - linux; arm64 variant v8
...
### `nextcloud:30.0.3-apache` - linux; 386
...
### `nextcloud:30.0.3-apache` - linux; mips64le
...
### `nextcloud:30.0.3-apache` - linux; ppc64le
...
### `nextcloud:30.0.3-apache` - linux; s390x
