...
```console
$ docker pull nextcloud@sha256:ccaa7fea676359a49533dc52bd5ae8f1fec1e4f3d32db46527b20dfe95976e5b
```
...
```console
$ docker pull nextcloud@sha256:347add2804704d24b39824e4cd420a8ce7771a611868a32d05149196ddde703b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.3 MB (213252909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b98832480c4eacdd31941984014659ceef1911bd893c8ce013d4c558530fe85`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 08 Oct 2020 19:06:37 GMT
VOLUME [/var/www/html]
# Thu, 08 Oct 2020 19:06:38 GMT
ENV NEXTCLOUD_VERSION=17.0.10
# Thu, 08 Oct 2020 19:13:31 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:13:36 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:13:38 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:13:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:13:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b00b80d0ad76ecff5c2d092b32ca9fe26749e0b7704e21d8025bcb6ce4ac12e5`  
		...
		Size: 536.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89674ce9ae4f9eab8dc4237e0dd606422155e28a95a00c7407348c0e375cf2f4`  
		Last Modified: Thu, 08 Oct 2020 19:51:47 GMT  
		Size: 73.4 MB (73352061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0ece7104b94c6fdda4ae919b621899f85bee8db9dbc4721ccf16e4de97f867f`  
		Last Modified: Thu, 08 Oct 2020 19:51:21 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fe824dc6181479061a7198e6e0d40519ca12ceccbbeeb31588c30b8f34b5dac`  
		Last Modified: Thu, 08 Oct 2020 19:51:21 GMT  
...
```console
$ docker pull nextcloud@sha256:208d0ef887fbd597f8cf2c4667ba19d94652cdcbc50c7687a896bf7d893a1252
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.6 MB (217572193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9f9b0fb2db5b5afe5b8bb1624d2c970fc57a17c48ceec9aeaacadee6b31cc12`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 08 Oct 2020 19:27:25 GMT
ENV NEXTCLOUD_VERSION=17.0.10
# Thu, 08 Oct 2020 19:34:23 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:34:25 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:34:27 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:34:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:34:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:88d2de9f2a03fa0d86dbe37dc936191da50545c505d1ead2dcc57fce4ad56b20`  
		...
		Size: 509.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8374ddf36cabf719e4874dbcc754778ddbb931388cc935a0c21c45fc263a1a5c`  
		Last Modified: Thu, 08 Oct 2020 20:09:15 GMT  
		Size: 73.4 MB (73351719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e94b48309036e4f787f3b065fdbc9e41e6387f8594e57739f01f842fe4f4ff1`  
		Last Modified: Thu, 08 Oct 2020 20:08:22 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a62eedef70d3fc08b14293f07cee2c6d0e4c0a9d17368c49de84370b52412d`  
		Last Modified: Thu, 08 Oct 2020 20:08:22 GMT  
...
```console
$ docker pull nextcloud@sha256:71a8d5fb136ec1c38753f87041d28e1ffeed0d4fdf9089485a127326266c93b4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.6 MB (220564407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5507bcc941efb8d16cb5593bb8bb6ec0a1bdd73155eb020802a0480b0331c85c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 08 Oct 2020 19:41:05 GMT
ENV NEXTCLOUD_VERSION=17.0.10
# Thu, 08 Oct 2020 19:41:57 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 08 Oct 2020 19:42:02 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 08 Oct 2020 19:42:02 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 08 Oct 2020 19:42:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Oct 2020 19:42:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8bdb2b34cda03c0c9235b66782ec4334ec1eec6d2fd9350a7a7e669085a99f98`  
		...
		Size: 535.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8c8384fd421fdbf2f1110054cc0f246e667e40f6e0d0641b21c76320e62107b`  
		Last Modified: Thu, 08 Oct 2020 19:56:48 GMT  
		Size: 73.4 MB (73351684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d04f02ab779ca5a44eace548d0671081a039882123e077f524821e74fa1b51c7`  
		Last Modified: Thu, 08 Oct 2020 19:56:38 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40a61e0596bc29bef56e93ba6f4bc82513211f14ce2cdfe6f919561238e12f4a`  
		Last Modified: Thu, 08 Oct 2020 19:56:38 GMT  
		Size: 1.9 KB (1894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
