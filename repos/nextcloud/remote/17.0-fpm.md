...
```console
$ docker pull nextcloud@sha256:1d1e88273ecc9e31c2485a96edacf5b0e245edbe513c7ff4799a85f4b6f123d8
```
...
```console
$ docker pull nextcloud@sha256:b28920aee38f24e804f8f6ef4f734c737b20de0752634bb5b293e38f44df55ee
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.6 MB (209588153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60fc28b9aa07a508a5898983ccd770d7a828ad2170be276c5ccde63922366cc5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 01 Oct 2020 22:40:26 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Thu, 01 Oct 2020 22:41:58 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 01 Oct 2020 22:42:30 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 01 Oct 2020 22:43:33 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 01 Oct 2020 22:43:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Oct 2020 22:43:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:95a06f978586c9117e5a19abb41fe866b688c472ce5c4d42cbf62b7f2a8f6334`  
		...
		Size: 536.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62d98b9685f3ed426795910c9c0987a7b3807caa5f097fd72a1843b96a040571`  
		Last Modified: Thu, 01 Oct 2020 23:47:22 GMT  
		Size: 73.3 MB (73316542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad4588654ba75d4ed3d84faa6c2b364788c9060866d85e05261c54427fdf7916`  
		Last Modified: Thu, 01 Oct 2020 23:46:49 GMT  
		Size: 2.5 KB (2525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:776965de9fbfb1d27eda3c4c68dadd2e6708d4901f455b4a56b9bcf026b9751c`  
		Last Modified: Thu, 01 Oct 2020 23:46:50 GMT  
...
```console
$ docker pull nextcloud@sha256:52b0f3dd29c5e84a3090734672166804b6431e7457b974eb1c691a3b23738c8c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.7 MB (226676892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b0a569fb2aa65e2daef6a4a53223d15d92a46b5a721e2869d10d866f7752800`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Oct 2020 22:09:35 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Thu, 01 Oct 2020 22:10:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 01 Oct 2020 22:10:27 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 01 Oct 2020 22:10:31 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 01 Oct 2020 22:10:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Oct 2020 22:10:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cecba9c05afb2e06ebd905218aa6e8df4c8ac8c400e3d9772ab7f88798a0580a`  
		...
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:279e9090a3b7b9d18863df0243526ac5eaf51e1a7987bd813ca7444ce02b44d4`  
		Last Modified: Thu, 01 Oct 2020 22:51:55 GMT  
		Size: 73.3 MB (73317449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61789a1d0202bcf869c05d9d648d033e3d91e3436b15007abf0f6a8f5f9b6aa0`  
		Last Modified: Thu, 01 Oct 2020 22:51:31 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b807acc127653538a47367c6c4dbf585663e0d98b1e5754f953eee3de8c214e`  
		Last Modified: Thu, 01 Oct 2020 22:51:33 GMT  
		Size: 1.9 KB (1897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
