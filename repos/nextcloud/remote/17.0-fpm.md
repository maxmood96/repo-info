...
```console
$ docker pull nextcloud@sha256:9b0e05e1b9469f6b52feaa126936a316fd60ecce956847792a33e2cc1acb27ff
```
...
```console
$ docker pull nextcloud@sha256:3247dd315978a3f150c455058aa0378a2e7dc6dd4c31169f90f1538fbfbf5550
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.3 MB (209313419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:add48e7aadab17d9f7dd8e72f958777e6efde470b4d30ddee2f986b598cdc99e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 06:10:29 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 06:11:18 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 06:11:22 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 06:11:24 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
# Fri, 17 Apr 2020 06:11:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 06:11:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7d4f54d4200f62f5265a09f2377c1331c337ecd7bbef0a79180cbcd282e30173`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5abd528f7784bee866091123e2d73bbbd2db4c31274bbfcfd50cb2bc905acfc6`  
		Last Modified: Fri, 17 Apr 2020 06:35:35 GMT  
		Size: 73.0 MB (73022169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fe243b0a266de8344dade3f800dab9f1d79be4dea86af1c53b1dfd2eeae1000`  
		Last Modified: Fri, 17 Apr 2020 06:35:08 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08a012e7e5fc6ddcc3f7e585472fbba8663bfaf1a1b1fa0093200778269a8993`  
		Last Modified: Fri, 17 Apr 2020 06:35:08 GMT  
...
```console
$ docker pull nextcloud@sha256:78e0fbe102d6734d5bea9210e4771829d200c16c13438d2c2c97d52f041167b9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.4 MB (226400257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e10de32f621679590b945d1bce00af977e8c74f35365e94f6345c5de267e3963`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 08:21:24 GMT
ENV NEXTCLOUD_VERSION=17.0.5
# Fri, 17 Apr 2020 08:24:59 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 08:25:03 GMT
COPY multi:57de70033920dd582f0dbb812d28f0cfdcf6a102d5b4374faf9435d87a0a7585 in / 
# Fri, 17 Apr 2020 08:25:06 GMT
COPY multi:4c50819ead07216fcf185db784fe35e8c1c11499da0123cdfb76c990691c30d3 in /usr/src/nextcloud/config/ 
...
-	Layers:
	...
	-	`sha256:7eda9275f27b042824ca9837de0fb06da63a96ce255e7b5a15042cf5ec0e1696`  
		...
		Size: 533.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d7b4fda4815cb23c3d107bdd1372cb0b23cc2dba12b93f059fcda231f47a392`  
		Last Modified: Fri, 17 Apr 2020 08:52:33 GMT  
		Size: 73.0 MB (73023888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bb4cdbf78f03fe14515309fdcbd170381135f4559b9325e437860fbd2e5359d`  
		Last Modified: Fri, 17 Apr 2020 08:51:56 GMT  
		Size: 2.6 KB (2553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65ca4dcb17a89dd36db88a61bb1aca2a880328b9e6f92d6f2e46a7dedd67a9fb`  
		Last Modified: Fri, 17 Apr 2020 08:51:56 GMT  
