...
```console
$ docker pull nextcloud@sha256:60a90dfec6c5dcf8580c22c7f2e4f761f99e3d492fc6bc10cea71e69fea9ea43
```
...
```console
$ docker pull nextcloud@sha256:f61d04539fb51c8c2f379ca238ba1ae7fccd83f6c1804bcd8f4df9cad6ea6e5d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **236.3 MB (236269363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12a178a235dc580235fa15de9d9f5497e82acfbbbc5cf7de394ccb79c8f1769b`
...
-	Layers:
	...
	-	`sha256:7b8b1ac6bea8578e9e074fe88e890beb1dc2c6d61c3566a7dfc9d247a797bd47`  
		...
		Size: 505.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:459327883f4cf37d89109368383d2d1b7bf397f54d07f9eebb96109fd0dc4340`  
		Last Modified: Tue, 01 Sep 2020 20:54:46 GMT  
		Size: 73.3 MB (73317937 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d89c7c9385826b3e36a3788c3e560db070a14b5f8160faeafab31045b3e142ec`  
		Last Modified: Tue, 01 Sep 2020 20:54:26 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0c4435ce77ecf62a963a0224c7844727c90c974bc175d948a7b1a60c0035bf6`  
		Last Modified: Tue, 01 Sep 2020 20:54:26 GMT  
...
```console
$ docker pull nextcloud@sha256:82cfb996ff40d8b86d9c0add93e09befe37ec153b14cb50111af72d7a3dc5ac5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.6 MB (209581981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e8fdd1f30b5bf997c444da746921dfa8571bc764ba027922be853e2dbbb69e2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 07:43:36 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Wed, 02 Sep 2020 07:44:47 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 07:45:10 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Wed, 02 Sep 2020 07:45:44 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Wed, 02 Sep 2020 07:45:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 02 Sep 2020 07:45:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fbda7a605a59ee81d79800096ec36803e9b26403d9ce259a60ab59f4da50a00b`  
		...
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf2e613a6377d978be123f8151bb8dc340ffdeffc922b6ea00a0d7fa5e660924`  
		Last Modified: Wed, 02 Sep 2020 07:51:04 GMT  
		Size: 73.3 MB (73316203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d2b74d1bd745b300789a1d55ce9aecc7b4c585828275f2ea99d25a2d5f3aca5`  
		Last Modified: Wed, 02 Sep 2020 07:50:42 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60523b3a9c4ef45895688d1a550ffce29e1a5ffbdd766da0e761d1a4df041f8`  
		Last Modified: Wed, 02 Sep 2020 07:50:42 GMT  
