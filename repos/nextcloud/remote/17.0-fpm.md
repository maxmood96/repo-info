...
```console
$ docker pull nextcloud@sha256:0997bab642ea02dc6c222162951c2101b8c798d1d302b47eabde4e51d9b8cd7b
```
...
```console
$ docker pull nextcloud@sha256:560c3cd278573ade62c4bd826129fe9745ce5c4258de870fe7e8f98b1e61dcd2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.2 MB (213224196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38edb5d3574e8d3e794f0b1b259a98c04c80474fa046a68c856ce6ca75288de5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 24 Sep 2020 22:08:01 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 24 Sep 2020 22:08:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 24 Sep 2020 22:08:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:91e54920596da88685ddbb37452042afcbcf87f4558913b78ae4e99e7420c3aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:418d0cac4f47b177c8d6454cdaa49e031828dca79fc96b7ff985a3f04436c587`  
		Last Modified: Thu, 24 Sep 2020 22:10:22 GMT  
...
```console
$ docker pull nextcloud@sha256:7508813e1b56d9cb40518a7d91c3b3b4781c47967bd7be1f6da6e79a624107a4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.5 MB (217540713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df1926efa24e0578c9e93e482c9cc28ea06e5fe8ea81d116f104ecc98abca096`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 15 Sep 2020 16:19:35 GMT
VOLUME [/var/www/html]
# Tue, 15 Sep 2020 16:19:36 GMT
ENV NEXTCLOUD_VERSION=17.0.9
# Tue, 15 Sep 2020 16:20:51 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 15 Sep 2020 16:20:53 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 24 Sep 2020 23:24:28 GMT
COPY multi:c481008845253a7b26785f1b012d068624b67ddaaefbb62c1931fdf56fd06e2a in /usr/src/nextcloud/config/ 
# Thu, 24 Sep 2020 23:24:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 24 Sep 2020 23:24:28 GMT
...
-	Layers:
	...
	-	`sha256:c9d06feb4dd01aab159695bddc9e9b819b62224ae73203e8fb85ca6c80e15033`  
		...
		Size: 506.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:064ff45050943267b4ad85a83f89c428f81cd871d747c52a250b493ca1ba3a80`  
		Last Modified: Tue, 15 Sep 2020 16:50:54 GMT  
		Size: 73.3 MB (73315925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5820919d7fb7999c14b157167d4364a0bec3f76ade0fcefe84ef520826e1e457`  
		Last Modified: Tue, 15 Sep 2020 16:50:01 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65d14f7aa70e76e6e4cce60ebdd80205ea3f989c36c10584a44423a2980e3fb6`  
		Last Modified: Thu, 24 Sep 2020 23:26:05 GMT  
