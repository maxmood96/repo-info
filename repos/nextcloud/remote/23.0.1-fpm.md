...
```console
$ docker pull nextcloud@sha256:b2a24b8c4b50a9b463366f35cff30188fb3a17fe67be57d8db2710adc379b7be
```
...
### `nextcloud:23.0.1-fpm` - linux; amd64
...
### `nextcloud:23.0.1-fpm` - linux; arm variant v5
...
### `nextcloud:23.0.1-fpm` - linux; arm variant v7
...
### `nextcloud:23.0.1-fpm` - linux; 386
...
### `nextcloud:23.0.1-fpm` - linux; mips64le
...
### `nextcloud:23.0.1-fpm` - linux; s390x
