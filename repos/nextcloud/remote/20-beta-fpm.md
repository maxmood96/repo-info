...
```console
$ docker pull nextcloud@sha256:c340d4fb222ec66c581687672bdf8cf873510fef6c5310f14286fb5435848451
```
...
```console
$ docker pull nextcloud@sha256:76c4eda4265d9454cfe5ac980debee35292efb10c2e36bc711ae2b3d8d0c83ba
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.7 MB (266733293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50dae20d66f59bf2ce5bb7c4b6509cf0a7307f5cc313cb71f14bfc36ef99e849`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 00:22:27 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta3
# Fri, 04 Sep 2020 00:24:06 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:24:35 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Fri, 04 Sep 2020 00:25:24 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Fri, 04 Sep 2020 00:25:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 00:25:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1d847b09c64f0706f7ac448c5b1bacacae8c234e41d28283c88dc80e13cccfab`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e9253bb76fbb11b388b669ccc3abff20be8b65b2eba8842e81c30f93fc2f261`  
		Last Modified: Fri, 04 Sep 2020 00:34:17 GMT  
		Size: 128.7 MB (128654532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b36ab8e490cb6734fcbfe285ca11a7d8d2bc3aae463891468319ac7425c954ea`  
		Last Modified: Fri, 04 Sep 2020 00:33:38 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53c39aee9bae6b1a2c9348a10422e56128f181fc4767989ce806c79868cef654`  
		Last Modified: Fri, 04 Sep 2020 00:33:38 GMT  
...
```console
$ docker pull nextcloud@sha256:740db40673ecff7b305a1e0b0cee0e3e0ce27b7703ea1fcb94256b064a2857cb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.8 MB (300838564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dd4fc4aa4aa1a61622d2375d235d191d5ef5642be38af97d952533a99cb6b09`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 18:34:27 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta3
# Thu, 03 Sep 2020 18:41:19 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 18:41:35 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 03 Sep 2020 18:41:41 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Thu, 03 Sep 2020 18:41:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Sep 2020 18:41:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0a19908681240ce84d475a839d176bbb00e2867a6b92acb6176cf9f9b95c102e`  
		...
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4635c1190694e325931a11ff3f6390c3976982797eb4e56797b89e7481b2f50c`  
		Last Modified: Thu, 03 Sep 2020 18:50:16 GMT  
		Size: 128.7 MB (128659137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c01dc25c84a706764dd719973d7c2901cc25793ff5c05c6dd3008dee42b57ca`  
		Last Modified: Thu, 03 Sep 2020 18:49:48 GMT  
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f2ac776038ddad78dd70ed00ad2f2c5945877764b316fd72c6a370829d7d43d`  
		Last Modified: Thu, 03 Sep 2020 18:49:48 GMT  
		Size: 1.6 KB (1649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:f3fad766839c21255d1fa722e7524d6f9ab11664373edc238fed752dbb17f0ba
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.0 MB (273960508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5eccc8cef77f45e84c5a69918cb7bbfb53855e040ff7abf4e416ab8df6c23f39`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 21:38:30 GMT
ENV NEXTCLOUD_VERSION=20.0.0beta3
# Thu, 03 Sep 2020 21:39:39 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/prereleases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 21:39:59 GMT
COPY multi:7396b0dc331ca301e37b57c4af539d58e09521ec7c723e0739e6eca71f90ffb3 in / 
# Thu, 03 Sep 2020 21:40:01 GMT
COPY multi:49104d51f9709571730a3bfbafcf5771111950c152c987a28b39105186d06754 in /usr/src/nextcloud/config/ 
# Thu, 03 Sep 2020 21:40:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Sep 2020 21:40:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:309cc7290ce9bba04ad61c5af68e6e44090539794fdd51da710d10bd3fe4cea4`  
		...
		Size: 532.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef6ab5292153718718c060a170bd82e263d76b6736f3a4894a957be928f73c7b`  
		Last Modified: Thu, 03 Sep 2020 21:45:53 GMT  
		Size: 128.7 MB (128654636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17fb995cd24a869b1a44c35042dbcf806d60ea04d61cb34775f524ffea499b52`  
		Last Modified: Thu, 03 Sep 2020 21:45:38 GMT  
		Size: 2.5 KB (2523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bbc10cc0e5a320a1a5a46e28bf18056c3799a3693ba8d100b8101e1be3d15c6`  
		Last Modified: Thu, 03 Sep 2020 21:45:38 GMT  
