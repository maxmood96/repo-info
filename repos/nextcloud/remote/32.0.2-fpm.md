...
```console
$ docker pull nextcloud@sha256:148c356f39d705fe099fae915084b9545788aa1bb99be8b61e98c2ffc0396f26
```
...
### `nextcloud:32.0.2-fpm` - linux; amd64
...
### `nextcloud:32.0.2-fpm` - unknown; unknown
...
### `nextcloud:32.0.2-fpm` - linux; arm variant v5
...
### `nextcloud:32.0.2-fpm` - linux; arm variant v7
...
### `nextcloud:32.0.2-fpm` - linux; arm64 variant v8
...
### `nextcloud:32.0.2-fpm` - linux; 386
...
### `nextcloud:32.0.2-fpm` - linux; ppc64le
...
### `nextcloud:32.0.2-fpm` - linux; s390x
