...
```console
$ docker pull nextcloud@sha256:9bf569f331abf6622da6f02e9e3887caadcd417f0408e4bff5eee8c64b0fd4c2
```
...
```console
$ docker pull nextcloud@sha256:6f11ed9e99fec45ea08c46f5e473e22fa19748adf4e37595eec8fd76b422dc4a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.4 MB (269363886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9413d110149c45df21c44bd9430336177fe7c0118033f7e9914aa21885078785`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 00:49:53 GMT
VOLUME [/var/www/html]
# Fri, 04 Jun 2021 00:49:54 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Fri, 04 Jun 2021 00:50:41 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 00:50:42 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Jun 2021 00:50:44 GMT
COPY multi:cdcd3c6679f774b6e9ec83ab3d5fca01b5ebe1961c10a136e3683d4c475000f0 in /usr/src/nextcloud/config/ 
# Fri, 04 Jun 2021 00:50:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 00:50:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bd7885fa1c2d37fb755ec4fc6111326093a771c64ebb03ae4875c31e4e99c3db`  
		...
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04dc9a7a6b6bcd812951639b092f3787da6b6faefafc424da0ab3cc0cc7bc19d`  
		Last Modified: Fri, 04 Jun 2021 01:04:42 GMT  
		Size: 103.7 MB (103667432 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2debc84551d4fe21a1d45bc0158d1218f13fb0fb6713f55867740b53e2dc461`  
		Last Modified: Fri, 04 Jun 2021 01:04:17 GMT  
		Size: 2.6 KB (2630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e05c4cc2768d5b887a7b4add1c8d749e4f4f8cba51fdb6d4be72767a4656c942`  
		Last Modified: Fri, 04 Jun 2021 01:04:17 GMT  
		Size: 2.0 KB (1998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:417680549e1633372f6d437bfd74282c9c9154f04a800f591c83d7e283518ec3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.5 MB (245493510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82519b65aebba214eccf9af98463500955434979a516bef8b7039c72d94b3552`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Jun 2021 23:09:55 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Thu, 03 Jun 2021 23:11:28 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Thu, 03 Jun 2021 23:11:31 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Thu, 03 Jun 2021 23:11:32 GMT
COPY multi:cdcd3c6679f774b6e9ec83ab3d5fca01b5ebe1961c10a136e3683d4c475000f0 in /usr/src/nextcloud/config/ 
# Thu, 03 Jun 2021 23:11:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Jun 2021 23:11:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e4adacfde92835b725eccebfe124fd957b0bb6c26e170f9ba314794795859e81`  
		...
		Size: 563.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5fd67d6cc1872787de104a717cba671a92fa274c24000d89c191cd511007d09`  
		Last Modified: Thu, 03 Jun 2021 23:23:41 GMT  
		Size: 103.7 MB (103665508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:455f2ff227ba937b3e7aaa215484d45fb1472118f5bab8b81addd770ade7e5a3`  
		Last Modified: Thu, 03 Jun 2021 23:22:30 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba89b2686d5870ad4d9b19d4d8fad99c074fdd47f4c2c74564456a0a411b5c14`  
		Last Modified: Thu, 03 Jun 2021 23:22:30 GMT  
...
```console
$ docker pull nextcloud@sha256:846105db932dee3f70463a035f6158ffaab01833d1109fae5e21f55d5840134b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.4 MB (248414248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d75b16bdf8cf96cd6ee6b7988f7d09b6b3ff92abf9abbdb54694d0d41f8696fb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 02:16:17 GMT
ENV NEXTCLOUD_VERSION=19.0.12
# Fri, 04 Jun 2021 02:16:52 GMT
RUN set -ex;     fetchDeps="         gnupg         dirmngr     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf "$GNUPGHOME" /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 02:16:59 GMT
COPY multi:5c7d3e21c40c6f3326b9c24bb148355014771883d3bc821f8ada4fed6795cbb4 in / 
# Fri, 04 Jun 2021 02:17:00 GMT
COPY multi:cdcd3c6679f774b6e9ec83ab3d5fca01b5ebe1961c10a136e3683d4c475000f0 in /usr/src/nextcloud/config/ 
# Fri, 04 Jun 2021 02:17:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 02:17:00 GMT
...
-	Layers:
	...
	-	`sha256:1b71ece9b360a4d5c5628fb4057734a4fe1b4c77e3f28452fc50b13b07a5d8fc`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4b43a5e0f7e7f1e101c9546c6665d813100e896ffa092654b053f69b76b070e`  
		Last Modified: Fri, 04 Jun 2021 02:29:17 GMT  
		Size: 103.7 MB (103665813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53e0c819899500617e6ce8f58c628ffdecc5ef58916086c36f8c2930316af00d`  
		Last Modified: Fri, 04 Jun 2021 02:29:06 GMT  
		Size: 2.6 KB (2631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eff1457f9b357426ba8d53724c418dd4fadf2e62db0fd12c0154cb8a8fd8df2`  
		Last Modified: Fri, 04 Jun 2021 02:29:05 GMT  
