...
- Created: `2026-01-16T23:58:31.620837052Z`
- Virtual Size: ~ 777.40 Mb  
...
### `dpkg` source package: `gsasl=2.2.0-1`

Binary Packages:

- `libgsasl18:amd64=2.2.0-1`
...
```console
$ apt-get source -qq --print-uris gsasl=2.2.0-1
'http://deb.debian.org/debian/pool/main/g/gsasl/gsasl_2.2.0-1.dsc' gsasl_2.2.0-1.dsc 2552 SHA256:1324f2c1916ffe2d80e59fa57fdea390be2daf2ffa59c9cd665868e71ba0161f
'http://deb.debian.org/debian/pool/main/g/gsasl/gsasl_2.2.0.orig.tar.gz' gsasl_2.2.0.orig.tar.gz 3290469 SHA256:79b868e3b9976dc484d59b29ca0ae8897be96ce4d36d32aed5d935a7a3307759
'http://deb.debian.org/debian/pool/main/g/gsasl/gsasl_2.2.0.orig.tar.gz.asc' gsasl_2.2.0.orig.tar.gz.asc 228 SHA256:36998dc98f4bb8e4f6ab746d928ac2e662563cfea03a07426f020c01a1869f5a
'http://deb.debian.org/debian/pool/main/g/gsasl/gsasl_2.2.0-1.debian.tar.xz' gsasl_2.2.0-1.debian.tar.xz 14728 SHA256:d7ab7aadcdcc49c9724ce7cb4f8882cfddedfd0301a2b407309704040f71baa9
```

Other potentially useful URLs:

- https://sources.debian.net/src/gsasl/2.2.0-1/ (for browsing the source)
- https://sources.debian.net/src/gsasl/2.2.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gsasl/2.2.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libgssglue=0.7-1.1`

Binary Packages:

- `libgssglue1:amd64=0.7-1.1`
...
```console
$ apt-get source -qq --print-uris libgssglue=0.7-1.1
'http://deb.debian.org/debian/pool/main/libg/libgssglue/libgssglue_0.7-1.1.dsc' libgssglue_0.7-1.1.dsc 1666 SHA256:0ca5217ec2afd271cca78312239aecbd9b9607cf57da4c157486e005e75ef1c8
'http://deb.debian.org/debian/pool/main/libg/libgssglue/libgssglue_0.7.orig.tar.gz' libgssglue_0.7.orig.tar.gz 40258 SHA256:bcd618ae0bc69f12815d77295658a760e7edc20706b9a731a81da8993f5c970a
'http://deb.debian.org/debian/pool/main/libg/libgssglue/libgssglue_0.7-1.1.debian.tar.xz' libgssglue_0.7-1.1.debian.tar.xz 8160 SHA256:fc707b9dfcb79fc6877fe983dea365741a0b5c8d9f03afe724d1a53308a8e9cf
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgssglue/0.7-1.1/ (for browsing the source)
- https://sources.debian.net/src/libgssglue/0.7-1.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgssglue/0.7-1.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libntlm=1.6-4`
...
```console
$ apt-get source -qq --print-uris libntlm=1.6-4
'http://deb.debian.org/debian/pool/main/libn/libntlm/libntlm_1.6-4.dsc' libntlm_1.6-4.dsc 2010 SHA256:8eec2aeb1a690cc1dbb241a4f8341b52e3ece6044198ceb7ac19c510c2d134cb
...
'http://deb.debian.org/debian/pool/main/libn/libntlm/libntlm_1.6-4.debian.tar.xz' libntlm_1.6-4.debian.tar.xz 6228 SHA256:1396008a825d810edc966ad8cc54f7dd4477697326486e27781f1d4744b5220e
```

Other potentially useful URLs:

- https://sources.debian.net/src/libntlm/1.6-4/ (for browsing the source)
- https://sources.debian.net/src/libntlm/1.6-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libntlm/1.6-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `msmtp=1.8.23-1`
...
```console
$ apt-get source -qq --print-uris msmtp=1.8.23-1
'http://deb.debian.org/debian/pool/main/m/msmtp/msmtp_1.8.23-1.dsc' msmtp_1.8.23-1.dsc 2197 SHA256:ff17a6479297bc705d0bad3d6d911a3e8f1bebc31ac5ee66bf998e3d8e32ca34
'http://deb.debian.org/debian/pool/main/m/msmtp/msmtp_1.8.23.orig.tar.xz' msmtp_1.8.23.orig.tar.xz 401656 SHA256:cf04c16b099b3d414db4b5b93fc5ed9d46aad564c81a352aa107a33964c356b8
'http://deb.debian.org/debian/pool/main/m/msmtp/msmtp_1.8.23.orig.tar.xz.asc' msmtp_1.8.23.orig.tar.xz.asc 488 SHA256:9860e0862e86443eeb9157098bfac7744afa46c5505c8ec18280962d48f7f562
'http://deb.debian.org/debian/pool/main/m/msmtp/msmtp_1.8.23-1.debian.tar.xz' msmtp_1.8.23-1.debian.tar.xz 22088 SHA256:e8778ca9d6ade81459e6302d4e5bf78d7dfb469eb19f2b0360d4c0a396783354
```

Other potentially useful URLs:

- https://sources.debian.net/src/msmtp/1.8.23-1/ (for browsing the source)
- https://sources.debian.net/src/msmtp/1.8.23-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/msmtp/1.8.23-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `rsync=3.2.7-1+deb12u4`
...
```console
$ apt-get source -qq --print-uris rsync=3.2.7-1+deb12u4
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.2.7-1%2bdeb12u4.dsc' rsync_3.2.7-1+deb12u4.dsc 2401 SHA256:7cbce0ace45ce5911d6ba0626d26832a472c30ba0b2a1d78af29dd9f27a5480e
...
'http://deb.debian.org/debian/pool/main/r/rsync/rsync_3.2.7-1%2bdeb12u4.debian.tar.xz' rsync_3.2.7-1+deb12u4.debian.tar.xz 38792 SHA256:0b478dd1666ad113f1c551bda83d5dba92b1f732eafd71b7aabd617bdd6b3128
```

Other potentially useful URLs:

- https://sources.debian.net/src/rsync/3.2.7-1+deb12u4/ (for browsing the source)
- https://sources.debian.net/src/rsync/3.2.7-1+deb12u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rsync/3.2.7-1+deb12u4/ (for access to the source package after it no longer exists in the archive)
