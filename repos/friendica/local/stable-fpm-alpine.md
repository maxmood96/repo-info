...
- Image ID: `sha256:944cc0a3323ee3cd8cb0c9e20226bff6dd77d1ab77a8ffb34f5ca699725cc0a2`
- Created: `2020-02-21T05:14:56.731092988Z`
...
```console
git-2.24.1-r0 description:
Distributed version control system

git-2.24.1-r0 webpage:
https://www.git-scm.com/

git-2.24.1-r0 installed size:
14585856

git-2.24.1-r0 license:
GPL-2.0-or-later
...
```console
linux-pam-1.3.1-r1 description:
pluggable authentication modules for linux

linux-pam-1.3.1-r1 webpage:
http://www.kernel.org/pub/linux/libs/pam

linux-pam-1.3.1-r1 installed size:
1081344

linux-pam-1.3.1-r1 license:
BSD-3-Clause
...
```console
shadow-4.7-r1 description:
PAM-using login and passwd utilities (usermod, useradd, ...)

shadow-4.7-r1 webpage:
http://pkg-shadow.alioth.debian.org/

shadow-4.7-r1 installed size:
1667072

shadow-4.7-r1 license:
BSD-3-Clause
