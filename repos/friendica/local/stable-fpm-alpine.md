...
- Image ID: `sha256:87dc3e38fa1b01fef19d6107587985daa00895bec3361f002ec9872306586e05`
- Created: `2024-07-23T04:25:33.145046134Z`
- Virtual Size: ~ 242.19 Mb  
...
- Environment:
  ...
  - `FRIENDICA_VERSION=2024.03`
  - `FRIENDICA_ADDONS=2024.03`
  - `FRIENDICA_DOWNLOAD_SHA256=ea1f1a674b2859a6b6d3ca86b2574fe8f24c38f2bb41224f98eb891126722b1b`
  - `FRIENDICA_DOWNLOAD_ADDONS_SHA256=865f60ffa100574a6bfdd6b3764c96e0d60d0a725b178a331a3cb55ef7e15268`
...
```console
msmtp-1.8.26-r0 description:
SMTP client with a sendmail compatible interface

msmtp-1.8.26-r0 webpage:
https://marlam.de/msmtp/

msmtp-1.8.26-r0 installed size:
156 KiB

msmtp-1.8.26-r0 license:
GPL-3.0-or-later
...
```console
shadow-4.15.1-r0 description:
PAM-using login and passwd utilities (usermod, useradd, ...)

shadow-4.15.1-r0 webpage:
https://github.com/shadow-maint/shadow

shadow-4.15.1-r0 installed size:
1380 KiB

shadow-4.15.1-r0 license:
BSD-3-Clause
