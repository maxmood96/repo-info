...
- Environment:
  ...
  - `FRIENDICA_VERSION=2024.08`
  - `FRIENDICA_ADDONS=2024.08`
  - `FRIENDICA_DOWNLOAD_SHA256=3e93178734bc82abd0c7c8b8b7c13baa4c18ae33a0f07c169518c13c4317717d`
  - `FRIENDICA_DOWNLOAD_ADDONS_SHA256=748d399f64670e37a5afc94ef65483291c52e9374e26c0ee5235f91b55449f54`
...
```console
imagemagick-7.1.1.41-r0 description:
Collection of tools and libraries for many image formats

imagemagick-7.1.1.41-r0 webpage:
https://imagemagick.org/

imagemagick-7.1.1.41-r0 installed size:
3639 KiB

imagemagick-7.1.1.41-r0 license:
ImageMagick
...
```console
imagemagick-jpeg-7.1.1.41-r0 description:
Collection of tools and libraries for many image formats (JPEG support modules)

imagemagick-jpeg-7.1.1.41-r0 webpage:
https://imagemagick.org/

imagemagick-jpeg-7.1.1.41-r0 installed size:
54 KiB

imagemagick-jpeg-7.1.1.41-r0 license:
ImageMagick
...
```console
imagemagick-libs-7.1.1.41-r0 description:
Collection of tools and libraries for many image formats (libraries)

imagemagick-libs-7.1.1.41-r0 webpage:
https://imagemagick.org/

imagemagick-libs-7.1.1.41-r0 installed size:
4233 KiB

imagemagick-libs-7.1.1.41-r0 license:
ImageMagick
...
```console
imagemagick-webp-7.1.1.41-r0 description:
Collection of tools and libraries for many image formats (WebP support modules)

imagemagick-webp-7.1.1.41-r0 webpage:
https://imagemagick.org/

imagemagick-webp-7.1.1.41-r0 installed size:
30 KiB

imagemagick-webp-7.1.1.41-r0 license:
ImageMagick
...
```console
libcom_err-1.47.1-r1 description:
Common error description library

libcom_err-1.47.1-r1 webpage:
https://e2fsprogs.sourceforge.net/

libcom_err-1.47.1-r1 installed size:
17 KiB

libcom_err-1.47.1-r1 license:
...
```console
libgomp-14.2.0-r4 description:
GCC shared-memory parallel programming API library

libgomp-14.2.0-r4 webpage:
https://gcc.gnu.org

libgomp-14.2.0-r4 installed size:
322 KiB
...
```console
libgsasl-2.2.1-r0 description:
An implementation of the Simple Authentication and Security Layer framework

libgsasl-2.2.1-r0 webpage:
https://www.gnu.org/software/gsasl/

libgsasl-2.2.1-r0 installed size:
119 KiB

libgsasl-2.2.1-r0 license:
LGPL-2.0-or-later
...
```console
libwebpdemux-1.4.0-r0 description:
Libraries for working with WebP images (libwebpdemux library)

libwebpdemux-1.4.0-r0 webpage:
https://developers.google.com/speed/webp

libwebpdemux-1.4.0-r0 installed size:
17 KiB

libwebpdemux-1.4.0-r0 license:
BSD-3-Clause
...
```console
libwebpmux-1.4.0-r0 description:
Libraries for working with WebP images (libwebpmux library)

libwebpmux-1.4.0-r0 webpage:
https://developers.google.com/speed/webp

libwebpmux-1.4.0-r0 installed size:
45 KiB

libwebpmux-1.4.0-r0 license:
BSD-3-Clause
...
```console
libzip-1.11.2-r0 description:
C library for manipulating zip archives

libzip-1.11.2-r0 webpage:
https://libzip.org/

libzip-1.11.2-r0 installed size:
102 KiB

libzip-1.11.2-r0 license:
BSD-3-Clause
...
```console
linux-pam-1.6.1-r1 description:
Linux PAM (Pluggable Authentication Modules for Linux)

linux-pam-1.6.1-r1 webpage:
https://www.kernel.org/pub/linux/libs/pam

linux-pam-1.6.1-r1 installed size:
807 KiB

linux-pam-1.6.1-r1 license:
BSD-3-Clause
...
```console
msmtp-1.8.27-r0 description:
SMTP client with a sendmail compatible interface

msmtp-1.8.27-r0 webpage:
https://marlam.de/msmtp/

msmtp-1.8.27-r0 installed size:
137 KiB

msmtp-1.8.27-r0 license:
GPL-3.0-or-later
...
```console
shadow-4.16.0-r1 description:
PAM-using login and passwd utilities (usermod, useradd, ...)

shadow-4.16.0-r1 webpage:
https://github.com/shadow-maint/shadow

shadow-4.16.0-r1 installed size:
1332 KiB

shadow-4.16.0-r1 license:
BSD-3-Clause
