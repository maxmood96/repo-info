## `friendica:2026.04-rc-fpm-alpine`

```console
$ docker pull friendica@sha256:59454c06bfe258bc777529a3beef00571a2fc36aef61020069cd16d0c29e0f38
```
...
### `friendica:2026.04-rc-fpm-alpine` - linux; amd64
...
### `friendica:2026.04-rc-fpm-alpine` - unknown; unknown
...
### `friendica:2026.04-rc-fpm-alpine` - linux; arm variant v6
...
### `friendica:2026.04-rc-fpm-alpine` - linux; arm variant v7
...
### `friendica:2026.04-rc-fpm-alpine` - linux; arm64 variant v8
...
### `friendica:2026.04-rc-fpm-alpine` - linux; 386
...
### `friendica:2026.04-rc-fpm-alpine` - linux; ppc64le
...
### `friendica:2026.04-rc-fpm-alpine` - linux; s390x
