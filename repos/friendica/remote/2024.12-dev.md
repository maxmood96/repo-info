...
### `friendica:2024.12-dev` - linux; amd64
...
### `friendica:2024.12-dev` - unknown; unknown
...
### `friendica:2024.12-dev` - linux; arm variant v7
...
### `friendica:2024.12-dev` - linux; arm64 variant v8
...
### `friendica:2024.12-dev` - linux; 386
