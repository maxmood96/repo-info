...
```console
$ docker pull friendica@sha256:5d6b8129495d1bc27dd08bcbf678fec8deacfa5db811a356f24a7133450e207d
```
...
```console
$ docker pull friendica@sha256:89c5eb373d14df9b0a3f36c2e51b29adc5f52e88f298156de85a996dc1f036c2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.2 MB (201152094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:118e83ffbfc27f9426d68998b38dfde7d88c221b227d1526f4a13c2eeac6ad9d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 02 Jul 2021 00:03:17 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 02 Jul 2021 00:03:17 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 00:03:38 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 00:03:40 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 02 Jul 2021 00:03:41 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 02 Jul 2021 00:03:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Jul 2021 00:03:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7562eb0e5822b392a267f1a97d30e97f3509bc3ef6a1bd0f2f2afbc6128303de`  
		...
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8407f451e713742f1db15d9c7fa95abf562a81344b411c1f9ec70bbf57c96e84`  
		Last Modified: Fri, 02 Jul 2021 00:23:47 GMT  
		Size: 47.7 MB (47686179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36b50029c560ba878bdcd7cc9e77c3a15dc34f7f7cff60675d3a8df7f3888bd0`  
		Last Modified: Fri, 02 Jul 2021 00:23:15 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e676d6533a3c7e1e26b964ceaf20020d6c21237543a1603925ddbd160604339`  
		Last Modified: Fri, 02 Jul 2021 00:23:14 GMT  
...
```console
$ docker pull friendica@sha256:09dd2aa6fabcd12bb442e40ed02f70dcdcd3452bbcfa02fd2bad3d38ac49a8fc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.3 MB (238257536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acd6a30aa63b1e8cd470bd1a49731efc29995087a7b9bb8b23cd12570754a801`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 02 Jul 2021 01:51:19 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 02 Jul 2021 01:51:20 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 01:51:34 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 01:51:36 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 02 Jul 2021 01:51:37 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 02 Jul 2021 01:51:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Jul 2021 01:51:37 GMT
...
-	Layers:
	...
	-	`sha256:624d329be713fcef6ad797dfb0f858bc1cbee2a3b2c006d6cce5a96ea8e5ac7c`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dc668e4604038ab9d61d9e22c526d85fba9260452e0c626bad0e302c258dfb8`  
		Last Modified: Fri, 02 Jul 2021 02:02:23 GMT  
		Size: 47.7 MB (47686169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b691c9a98e7a285decf930a36b1ab97ce89c959b378775ef996102b1f1cf5820`  
		Last Modified: Fri, 02 Jul 2021 02:02:07 GMT  
		Size: 2.6 KB (2627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0634b675e80acca024ca6aacaeee387acb9bc146793e60bd980b0bef6b8f5acb`  
		Last Modified: Fri, 02 Jul 2021 02:02:07 GMT  
