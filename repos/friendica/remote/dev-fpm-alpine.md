...
```console
$ docker pull friendica@sha256:1e171540f2d8dc408b5cefc6cc01be4112b5196e6c50162f7b37b17d7ad855a0
```
...
```console
$ docker pull friendica@sha256:de4c51316e56548b67399f8e15448e9fd562a79b08104491600a7dc645cea125
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.8 MB (39848272 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62c465535fcbb3c5ec3fabe2f140ab01d3ae0fbe92421d95438abaaa1c4eaad4`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 12 Nov 2022 17:07:25 GMT
RUN set -ex;     apk add --no-cache         rsync         msmtp         shadow         tini;
# Sat, 12 Nov 2022 17:07:25 GMT
ENV GOSU_VERSION=1.14
# Sat, 12 Nov 2022 17:07:30 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Sat, 12 Nov 2022 17:09:34 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps;
# Sat, 12 Nov 2022 17:09:34 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 12 Nov 2022 17:09:34 GMT
...
# Sat, 12 Nov 2022 17:09:34 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 12 Nov 2022 17:09:35 GMT
VOLUME [/var/www/html]
# Sat, 12 Nov 2022 17:09:35 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sat, 12 Nov 2022 17:10:19 GMT
ENV FRIENDICA_VERSION=2022.12-dev
# Sat, 12 Nov 2022 17:10:19 GMT
ENV FRIENDICA_ADDONS=2022.12-dev
# Sat, 12 Nov 2022 17:10:20 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;
# Sat, 12 Nov 2022 17:10:21 GMT
COPY multi:f87d330cfcee641708f831c1e9357b18f2b0ed18bc7541fec914e00a972d58a1 in / 
# Sat, 12 Nov 2022 17:10:21 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sat, 12 Nov 2022 17:10:21 GMT
...
-	Layers:
	...
	-	`sha256:9f7f14a94cfbe4184e10ca09f49ac3788e40e34629a9dc87f630c640623f3ebe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bacd9031534859a3e7cb44b98f86bb1465e57d09e49020344f8c8164a962b352`  
		Last Modified: Sat, 12 Nov 2022 17:11:32 GMT  
		Size: 3.6 MB (3595952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d8815b8b8ff3d47d5368501d203eb5d1d510b3358a75fc83571b41e29927a31`  
		Last Modified: Sat, 12 Nov 2022 17:11:32 GMT  
		Size: 910.9 KB (910892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04115d5926df19b8ee7105db15924b9f7457b52b61787ba7b1596b19c17d654a`  
		Last Modified: Sat, 12 Nov 2022 17:11:30 GMT  
		Size: 8.4 MB (8353934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7434552614c546b1826046f6606876049dc8d97915205692a993add1145e778`  
		Last Modified: Sat, 12 Nov 2022 17:11:29 GMT  
		Size: 604.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3dfd8946d4e87e59e3033d5ef5e1d774014861a27ed16dc8246e5325163e85e`  
		Last Modified: Sat, 12 Nov 2022 17:12:00 GMT  
		Size: 2.4 MB (2426874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebb83aa804eb5ddd1f01dbd48c94336ee856a41a13b11de9a0806383c0d4a239`  
		Last Modified: Sat, 12 Nov 2022 17:11:59 GMT  
		Size: 3.6 KB (3625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f4423c36c00a6ff221d0f29c42c6800493d04e7edb9fe38a330d1ea16c00e8`  
		Last Modified: Sat, 12 Nov 2022 17:11:59 GMT  
		Size: 917.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:8ff52741b4d8730074953e526e33ee4478ca17c7b74140d10cf48e6d1d50ba43
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.7 MB (44731426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:079e39cbd351be5b8e67554b584c288413b38e79738bb8249424339480ee2ac7`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 12 Nov 2022 08:14:09 GMT
CMD ["php-fpm"]
# Sat, 12 Nov 2022 15:29:20 GMT
RUN set -ex;     apk add --no-cache         rsync         msmtp         shadow         tini;
# Sat, 12 Nov 2022 15:29:21 GMT
ENV GOSU_VERSION=1.14
# Sat, 12 Nov 2022 15:29:26 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Sat, 12 Nov 2022 15:32:52 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp     ;         pecl install APCu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps;
# Sat, 12 Nov 2022 15:32:52 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 12 Nov 2022 15:32:53 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 12 Nov 2022 15:32:54 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 12 Nov 2022 15:32:54 GMT
VOLUME [/var/www/html]
# Sat, 12 Nov 2022 15:32:55 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sat, 12 Nov 2022 15:33:51 GMT
ENV FRIENDICA_VERSION=2022.12-dev
# Sat, 12 Nov 2022 15:33:52 GMT
ENV FRIENDICA_ADDONS=2022.12-dev
# Sat, 12 Nov 2022 15:33:54 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;
# Sat, 12 Nov 2022 15:33:56 GMT
COPY multi:f87d330cfcee641708f831c1e9357b18f2b0ed18bc7541fec914e00a972d58a1 in / 
# Sat, 12 Nov 2022 15:33:56 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sat, 12 Nov 2022 15:33:57 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Sat, 12 Nov 2022 15:33:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e99ce186252afd14cc2cbc0ebd50d04f0135d797bbf9cc52618d618259f27455`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f057df422b6c202fe143c2877d80ee8ef96fe3a3d12e247834bb68493c2c5c`  
		Last Modified: Sat, 12 Nov 2022 15:34:55 GMT  
		Size: 4.1 MB (4109977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3177e6196aea799f7e9c78fb6cade29dd0b16943bda7359518b5a497adfb7644`  
		Last Modified: Sat, 12 Nov 2022 15:34:54 GMT  
		Size: 857.3 KB (857290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bed3b2d3f2a5301d5c7393024b18e6e9d3d793fc5bd939367b513a4114a1db4`  
		Last Modified: Sat, 12 Nov 2022 15:34:54 GMT  
		Size: 9.5 MB (9466939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:711df65fbf0e3d4480849d75aed598f4af9a20746c3160364c82dfd902eec002`  
		Last Modified: Sat, 12 Nov 2022 15:34:52 GMT  
		Size: 636.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e78704cdaa8e191cc9fc14bfbb77743118cac1f93d576913eca91cba9fc57a05`  
		Last Modified: Sat, 12 Nov 2022 15:35:25 GMT  
		Size: 3.0 MB (3027454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30601518a05bebb2aa038c9f60336f3a88658269cb3f027954b301abf3cc16c5`  
		Last Modified: Sat, 12 Nov 2022 15:35:24 GMT  
		Size: 3.6 KB (3625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01a6fb5d874615c8991e99783845033a749dd2fc40a041cec46efa556537a441`  
		Last Modified: Sat, 12 Nov 2022 15:35:24 GMT  
		Size: 948.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
