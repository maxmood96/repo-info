...
```console
$ docker pull friendica@sha256:047dbf3533d0a5cd10917575ac7763cfe8e47398db5f52f564ccc2471a773325
```
...
```console
$ docker pull friendica@sha256:333c95379adb1ebceba716adca4efc32dab8aa7e8c237f6db294a930961468a4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51533749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d998c22715ebb82fd2e1dd48027219ab234c7600d7dc2a811ecf1560de6821d0`
...
-	Layers:
	...
	-	`sha256:296e28ade8aceb1f50e3a4990db1f26a9423114a84d07a24ea3c4aa25c564683`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36cdb7d1f3c126b1afe2349a514d9a3c3034294017d1b5902640678606c9fdcc`  
		Last Modified: Tue, 27 Oct 2020 02:04:13 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b212bcc8dd6257b0cf248bf3ba83cc212caa3259ec370ddebd4df433abbff9d1`  
		Last Modified: Tue, 27 Oct 2020 02:04:13 GMT  
...
```console
$ docker pull friendica@sha256:c29afa16014d1c90df8089a95dcf5bf22d8bfde65bc1fedf370229bf63c5e0f8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49397313 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b2ee588ebb634340045b123dc75c856e084bc167d752eb9db1db9c7e65d6aaf`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 29 Oct 2020 23:23:02 GMT
RUN set -ex;     apk add --no-cache         rsync         git         msmtp         shadow         tini;
# Thu, 29 Oct 2020 23:26:08 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev     ;         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         pcntl         ldap     ;         pecl install APCu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps;
# Thu, 29 Oct 2020 23:26:10 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 29 Oct 2020 23:26:10 GMT
VOLUME [/var/www/html]
# Thu, 29 Oct 2020 23:26:51 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Thu, 29 Oct 2020 23:26:53 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Thu, 29 Oct 2020 23:27:00 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Thu, 29 Oct 2020 23:27:03 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Thu, 29 Oct 2020 23:27:05 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 29 Oct 2020 23:27:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:689a1cae907a6f08b4e2420ceec20a0f7e0bfa5b10e4422f118fa74fab027b5f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab2eb76091d70615fa85c729d733b64fa96b2d0859b0ce2200f791fb08a17462`  
		Last Modified: Thu, 29 Oct 2020 23:27:23 GMT  
		Size: 10.9 MB (10868694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f51fa004bd6e29a5888255a2f57f56fc01e29133228dc68c3da80906110467b6`  
		Last Modified: Thu, 29 Oct 2020 23:27:22 GMT  
		Size: 9.0 MB (9010911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1799200748ac8983e26525b4f32079a6553e9a6f254ba5be63104db2201a2898`  
		Last Modified: Thu, 29 Oct 2020 23:27:18 GMT  
		Size: 572.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d142b02a604d6e92b73add75f02ac8e31dc812c80063df96b48dfeec972ee99c`  
		Last Modified: Thu, 29 Oct 2020 23:27:42 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3671738103c592ec09678762c975b14d6d498f74ddc48189b1d6d18f7584d33`  
		Last Modified: Thu, 29 Oct 2020 23:27:42 GMT  
...
```console
$ docker pull friendica@sha256:4b92b2360b2d7754a9e54d20b617fead91834e3e419b053900befa0a63684d99
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46708903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a2ef5807ce9b14dfaad31d80139c83b926a6eaeca8898c68061db3bdbca174e`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 01:45:40 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 01:45:41 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 01:45:42 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 01:45:44 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 01:45:45 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 01:45:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e63254bb04b2a452791e12f5a2b8e33fc436fd3ec00d9bbb4f4469bb5cbf1ede`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21bf41574ae0444463036a12b75e3e2c24376f198d90e2550baee3c8ada0a8b4`  
		Last Modified: Tue, 27 Oct 2020 01:48:02 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f552852633f73ebcdfb04c7b081957d5fb396ab37c6cb6507ad8c48cfce3ad04`  
		Last Modified: Tue, 27 Oct 2020 01:48:02 GMT  
		Size: 1.1 KB (1087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:f8bdcaa4c468897b126a8001b9359b1de99439cb47e9752a41ff25c1eeb7578d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51138990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ba3382c92ab8e67e37fcc1acd5e1961b334aa23487fc5c2d7252b4ebed8a97d`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:41:39 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 02:41:40 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 02:41:42 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 02:41:43 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 02:41:44 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 02:41:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:30ade788b305f7623ba665688bae2c74062cc8e2034a9164091ff6f853f0f4c8`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3abd19dd6caf2722494b0fe699d17f2b642b3873c38eb51bd03f51ba1cd7beb3`  
		Last Modified: Tue, 27 Oct 2020 02:43:29 GMT  
		Size: 3.3 KB (3260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04a2634dccdbf488ec7e2788a31eb111e277af8d929158f4132ad21536646941`  
		Last Modified: Tue, 27 Oct 2020 02:43:29 GMT  
...
```console
$ docker pull friendica@sha256:18a0766c82f1b6f25874b75701c629250db8d0061d63b91b880e48f683ffb892
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53354083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e83d6238e55ed94d95421034640bd8cf91c304c9193df27580a640c6f8c2832a`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 27 Oct 2020 02:10:04 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:10:41 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 02:10:41 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 02:10:42 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 02:10:43 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 02:10:43 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 02:10:43 GMT
...
-	Layers:
	...
	-	`sha256:fd719a7750a7e1d676b71b5cc4933a24478709459a55ec6d26ac7576b1534466`  
		...
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b9b3a49ed40e90236b1329766c659235bf473272fd88f4599b7ff65d834b72c`  
		Last Modified: Tue, 27 Oct 2020 02:12:28 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97469dc6248c96cc37e4881653d763dce69876135cc9ff3f53b37750b23a7d9b`  
		Last Modified: Tue, 27 Oct 2020 02:12:28 GMT  
...
```console
$ docker pull friendica@sha256:9f186bbdcf9927525028ed2f07028a752703224e51bcfcd044a5a2e95dacf153
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.6 MB (53564543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed88118da1568a345f6d1d3fc370a33fce8229ba1094e6f67f905d82d62d01bc`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:47:22 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 02:47:29 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 02:47:32 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 02:47:34 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 02:47:39 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 02:47:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e2fef36a426fc9974fa1b547fe233e237818dcc69d72c3c82f125f209dcaa53f`  
		...
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea26df71b716a12cf5c39c592f202232893e48a31a563d74004e22e802e6f1f0`  
		Last Modified: Tue, 27 Oct 2020 02:51:00 GMT  
		Size: 3.3 KB (3260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4df4489afe062e119e5a0d5918258682274160be0d32aa23b6151fbed29a1d9c`  
		Last Modified: Tue, 27 Oct 2020 02:50:59 GMT  
