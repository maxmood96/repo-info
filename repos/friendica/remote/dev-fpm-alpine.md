...
```console
$ docker pull friendica@sha256:c0bce6f818f765b55a298736c754dcd26b13493264025e1f212e1d9df4cee7c4
```
...
```console
$ docker pull friendica@sha256:972efb8e07ae61a58da2d9f91aafa3f1387ade63f038480857b03f182ecc74b3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.3 MB (61295695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27f1e71b27c2a30b7d1cbec9ab9a1c9b6694ac0f095d3ec9987a4d7befc819dd`
...
-	Layers:
	...
	-	`sha256:04771e998c9ccc6689b450b179cd1cdff1bda41cf3ea88cde5e9187cb888f7b7`  
		...
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ad5ced92c93dbb301b52646ab7727de218c6ee9ef139cc6275f060ff4e2db0d0`  
		Last Modified: Thu, 18 Dec 2025 22:06:56 GMT  
		Size: 4.4 MB (4373473 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d83199f4af86e3b9c8979d9fe09ef7565fc6e8c2e258a067412d1b487440af23`  
		Last Modified: Thu, 18 Dec 2025 22:06:55 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:11cae4859920ffb4f6131d0c69b29af36080059eb1ad6772229e0be2bd791f6d`  
		Last Modified: Thu, 18 Dec 2025 22:06:56 GMT  
		Size: 918.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:2cdcb08e1b7853ddc919d44811a8371f8452c6018bfadd6c8575e21e994fb82c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 KB (55533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:558d6459d2fffc02112e1e6630ba78914903f591d25f782bbc8e9fabc3f6b782`

```dockerfile
```

-	Layers:
	-	`sha256:da904935c11b022f20c9af237c4922800bb37ef21de336a3099ebc9231fe2ef7`  
		Last Modified: Fri, 19 Dec 2025 00:29:39 GMT  
...
```console
$ docker pull friendica@sha256:50f23dcc1ea6b8472849b12251ccbc54b7879f04bd2bf2056b422da7e3382f9d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.2 MB (58161352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ad0cf0883f9e7f47f40f99dbf8cc646f191d8d3ece71914c21b8b19067af5c0`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Dec 2025 21:21:50 GMT
CMD ["php-fpm"]
# Thu, 18 Dec 2025 22:16:31 GMT
RUN set -ex;     apk add --no-cache         rsync         imagemagick         msmtp         shadow         tini; # buildkit
# Thu, 18 Dec 2025 22:16:34 GMT
ENV GOSU_VERSION=1.17
# Thu, 18 Dec 2025 22:16:34 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 18 Dec 2025 22:19:03 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp         intl     ;         pecl install APCu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0;     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps; # buildkit
# Thu, 18 Dec 2025 22:19:03 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 18 Dec 2025 22:19:03 GMT
...
-	Layers:
	...
	-	`sha256:a5d4cf262943f4d23f5916986eec9c440fd7df49a2c69d4dd9956cec67a9545d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:185a65795037de4aaaa5315ae9714fa1e232f4342d7c615b1ba8eaa342eacad5`  
		Last Modified: Thu, 18 Dec 2025 22:19:18 GMT  
		Size: 11.8 MB (11770415 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:890fbe62039bcd20f12d1295e130716097f37f6a6ead559458fffa7e62d9a8df`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 1.0 MB (1006386 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:76a9b60cd5d15b2c6cd935cb3b43f2f5ec55ada2d7c8b0382cd8cf87ff81add5`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 9.0 MB (9036980 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:38dc09c8880f3fb87dfdaa6b16c44d5631d135442971a4dfb4b455948d622751`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 582.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9249c8a47b2187871e552ddd8ed835f30d6cd5757cd0fd96521014a63732dc63`  
		Last Modified: Thu, 18 Dec 2025 22:19:18 GMT  
		Size: 512.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:eb715108c2c2063629d78bd091099ee3d01582375bbaba0162b29ca790fac884`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 142.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4fa4364ae4246b44725806f6d679ba4b46c380139bad5819a28fedeefe917517`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 4.4 MB (4440543 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:578068963b9895ffed123388dcef403f2221e9abc8bec8684596e7f00047c41f`  
		Last Modified: Thu, 18 Dec 2025 22:19:17 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:560bcc5a1083e6e6fc0c79ad27847259af4a875fe14cb5f2a2f9e7d045812b24`  
		Last Modified: Thu, 18 Dec 2025 22:19:16 GMT  
		Size: 921.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:f023f759f5d12c5bb4f1865408536b355c64091a2c9def5f4439a08f16686d26
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 KB (55674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfee3c2efb4ac9d302508c25ab076d28afc30f0253b4fd6ffd583c6d45bb01f4`

```dockerfile
```

-	Layers:
	-	`sha256:f51f0aade1a4332c2cb5fd89e1352a9272aac37b4993a33eff9732961beb6d81`  
		Last Modified: Fri, 19 Dec 2025 00:29:43 GMT  
...
```console
$ docker pull friendica@sha256:57fa42e8aa89853353eba6feec40a5545ad70abe3a167eca866d6a484ea549a6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 MB (55464499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9305aa4db9f86be78dde108ebede7d0c49aff5769b626384941edd9a3ccb0bb4`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:4117a2069bbc440f0d12935f59eff1d7889a3966ea22e1b3fae2fa1f632ecf5f`  
		...
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e7d7ecf84c632a115261ceb33766b0fc0a71b3a62e9da996ab0d278ffbac1a57`  
		Last Modified: Thu, 18 Dec 2025 22:16:18 GMT  
		Size: 4.0 MB (3950531 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0e1b1f685cbb8a5388b35405c55cd5fb53a1a52174d6988b2afaf5f24dd7e8e4`  
		Last Modified: Thu, 18 Dec 2025 22:16:16 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:564d235f720e9caa0ab67741299efcd7dfed85d3207ef379b745acab07e69974`  
		Last Modified: Thu, 18 Dec 2025 22:16:16 GMT  
		Size: 919.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:f5c12547aace766db6b4b339775d400f3d4817f70cf79804bbb6a0d674224df7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 KB (55675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dbbbb6d821f8d684bff747eb15cdf51062bb048a2e777818df925af6ac4fc56`

```dockerfile
```

-	Layers:
	-	`sha256:cd15271be9162e9696c59822b9ede9e660e46636714899171503684ec5336809`  
		Last Modified: Fri, 19 Dec 2025 00:29:46 GMT  
...
```console
$ docker pull friendica@sha256:4a1a9d0a786e80518479d9449fdd70620e153304fbc7c49a5c8fda5d92fcf68f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.2 MB (61223894 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:789f223a29ed82a1cea94434f1dc8380b36edd124e85d92327dce391ca99640f`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Dec 2025 21:24:37 GMT
CMD ["php-fpm"]
# Thu, 18 Dec 2025 22:10:54 GMT
RUN set -ex;     apk add --no-cache         rsync         imagemagick         msmtp         shadow         tini; # buildkit
# Thu, 18 Dec 2025 22:10:57 GMT
ENV GOSU_VERSION=1.17
# Thu, 18 Dec 2025 22:10:57 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 18 Dec 2025 22:14:14 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp         intl     ;         pecl install APCu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0;     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps; # buildkit
# Thu, 18 Dec 2025 22:14:14 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 18 Dec 2025 22:14:14 GMT
...
-	Layers:
	...
	-	`sha256:8e1a15e0c4530c42a40d74b4648c6f00cdfb9a45613e1b7e8c604ca11c3c997e`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ca8e4eb6db15b1e788fb32e431f80d3cfe051a43bf281bafbf24ecc4d90d10c8`  
		Last Modified: Thu, 18 Dec 2025 22:14:29 GMT  
		Size: 12.2 MB (12169590 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:040eccb35fa0045db38ca269ebb5e9ce769e2700223284890d7b755b3e45a3a4`  
		Last Modified: Thu, 18 Dec 2025 22:14:28 GMT  
		Size: 970.1 KB (970107 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5fbb1de0da8e96685543c0bc8c3b45c190f442a7b27129a6344f79aca01f9ffc`  
		Last Modified: Thu, 18 Dec 2025 22:14:29 GMT  
		Size: 10.0 MB (9996865 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5748dd95f4cc32b474e2116ab3ce577ddd2330cac98f596089811b4feca9be4e`  
		Last Modified: Thu, 18 Dec 2025 22:14:28 GMT  
		Size: 581.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c7b903a292b628d3b0759e88e8a6968a0cba426440bf0fac959a277ec24cb905`  
		Last Modified: Thu, 18 Dec 2025 22:14:28 GMT  
		Size: 511.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3014078d72da97bc282bd5dfb5fc9ca4f31a5d3895f95a1d42614b6f5c68a007`  
		Last Modified: Thu, 18 Dec 2025 22:14:28 GMT  
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7f764decb26fbad2cdcf5025e885fdf528969208e40350218190299dbbdbb2a2`  
		Last Modified: Thu, 18 Dec 2025 22:14:29 GMT  
		Size: 4.3 MB (4337608 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6730da53c58e49d211e5e8a01d506b818e297396af9a9d535aa095c2f7111ca9`  
		Last Modified: Thu, 18 Dec 2025 22:14:29 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a9859ffd7f90e58446bd21b727aa6cd170777555cde1691d95204b8dc127e591`  
		Last Modified: Thu, 18 Dec 2025 22:14:29 GMT  
		Size: 920.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:2e1c1d46ad9a160fb9e2bafab9867e0719d0c4e3fd7d0d9593e9828baad919e9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 KB (55695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fee6a2674d4d77f4109245d37f44e3ce8485ae4bc88229a7cdafd1f06e98213e`

```dockerfile
```

-	Layers:
	-	`sha256:1e4be0db0c1280a3cde92187c731616b26e44fd2e5194470b8011d8576f65c26`  
		Last Modified: Fri, 19 Dec 2025 00:29:49 GMT  
...
```console
$ docker pull friendica@sha256:f5c5c8d2e7c505bf8681b6e61837c4fd1c45d05c76eb36f79c2ae5344f5896d8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.8 MB (61812677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d3a15d67e65c4d8ce23452d26f5469aa52b4ee1e3a6e77be998c99a8bef80ab`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     apk add --no-cache         rsync         imagemagick         msmtp         shadow         tini; # buildkit
# Thu, 18 Dec 2025 22:09:18 GMT
ENV GOSU_VERSION=1.17
# Thu, 18 Dec 2025 22:09:18 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 18 Dec 2025 22:11:35 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp         intl     ;         pecl install APCu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0;     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps; # buildkit
# Thu, 18 Dec 2025 22:11:35 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 18 Dec 2025 22:11:35 GMT
...
-	Layers:
	...
	-	`sha256:1fd63b063b01c34e2890c5c75a5b4fd52583ad758e910d3ca4b043350d829321`  
		...
		Size: 9.2 KB (9178 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:047a7d02f0092b0cadd032624276b23129f678c649fcb706ee148f0811f95ab4`  
		Last Modified: Thu, 18 Dec 2025 22:11:50 GMT  
		Size: 12.8 MB (12751563 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:37bcc1d411a5c7853b4af2009085b56dc5c7ef54a4f5e73991d53854170006e4`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 1.0 MB (1013868 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4bdb2a8934d5f1a7f64d2be7cda716d2c04f0a0edaee9829715123032face875`  
		Last Modified: Thu, 18 Dec 2025 22:11:51 GMT  
		Size: 10.1 MB (10060671 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1e302b815f18561ceab9a78df717a1fb54704fbf1fc29fa1a2d70a05fbbc0893`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 582.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0a335e62a8c9c92d50c7c908519c15494cb1cf6d6cd48e5bf6ea7eb0b28ccb91`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 512.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:47a14815fdb51808a1e7d0ecec76ab24f9b382cc8cdd5a322f4632a96f922346`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:595a81e7af3d0c54760d7f87844e1a2d9197cd8f9f0795c97d36bc3869ef9d57`  
		Last Modified: Thu, 18 Dec 2025 22:11:50 GMT  
		Size: 4.4 MB (4354422 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2751127b1d9a1b52a0767eb19ff52a5ace897dde77ae9995036a1408c1fc8d42`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0941fa61549c88c3255072781e02d2290e3667d6a994a4667fd1ed345933f460`  
		Last Modified: Thu, 18 Dec 2025 22:11:49 GMT  
		Size: 920.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:d6741d0fd589a59f1dc338697a20901ad5eae121c1d2a8e45542ae6c8ac44449
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 KB (55506 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4e5f40151c3169e6c201e2cd56e44703f9b50984df20f3e7d3241b932607530`

```dockerfile
```

-	Layers:
	-	`sha256:ae5c031f45550a5d9b8ac8973d6905912c15f1f4cdb7e4a68544a6268d61e45f`  
		Last Modified: Fri, 19 Dec 2025 00:29:52 GMT  
...
```console
$ docker pull friendica@sha256:774f24b9733dc7ae859a62b6c3fd46c963dd275740741fe499cac7708f58d8b4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.9 MB (62875849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05d93f3fa3b655c8e77e516e9b65db495027ed4c72d99224ccf9d15103588268`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Dec 2025 22:07:50 GMT
CMD ["php-fpm"]
# Thu, 18 Dec 2025 22:52:10 GMT
RUN set -ex;     apk add --no-cache         rsync         imagemagick         msmtp         shadow         tini; # buildkit
# Thu, 18 Dec 2025 22:52:15 GMT
ENV GOSU_VERSION=1.17
# Thu, 18 Dec 2025 22:52:15 GMT
RUN set -eux; 		apk add --no-cache --virtual .gosu-deps 		ca-certificates 		dpkg 		gnupg 	; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apk del --no-network .gosu-deps; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 18 Dec 2025 22:55:14 GMT
RUN set -ex;         apk add --no-cache --virtual .build-deps         mariadb-client         bash         $PHPIZE_DEPS         libpng-dev         libjpeg-turbo-dev         imagemagick-dev         libtool         libmemcached-dev         cyrus-sasl-dev         libjpeg-turbo-dev         freetype-dev         libwebp-dev         librsvg         pcre-dev         libzip-dev         icu-dev         openldap-dev         gmp-dev     ;         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;         docker-php-ext-install -j "$(nproc)"         pdo_mysql         exif         gd         zip         opcache         pcntl         ldap         gmp         intl     ;         pecl install APCu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0;     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         runDeps="$(         scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions             | tr ',' '\n'             | sort -u             | awk 'system("[ -e /usr/local/lib" $1 " ]") == 0 { next } { print "so:" $1 }'     )";     apk add --no-network --virtual .friendica-phpext-rundeps $runDeps;     apk del --no-network .build-deps; # buildkit
# Thu, 18 Dec 2025 22:55:14 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 18 Dec 2025 22:55:14 GMT
...
-	Layers:
	...
	-	`sha256:1ebb9cbb734a2d045f5fda28e2db1c11ebd42a7b9efdb23bead2c553fa826f9b`  
		...
		Size: 9.2 KB (9182 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9d9e57683da1193a43dd84f65155990a43f0dd5233b912b895239a30c3bc89a7`  
		Last Modified: Thu, 18 Dec 2025 22:55:37 GMT  
		Size: 13.3 MB (13347848 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c166b2ed4bb8dfe5eb5d0becc1e6b78b4d1c1ba8fbd81358a30e831cefb8b27f`  
		Last Modified: Thu, 18 Dec 2025 22:55:36 GMT  
		Size: 958.5 KB (958489 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:443273475d28b55350532a45a9b9fce5878ac6d52e988f9a87066d3254e20566`  
		Last Modified: Thu, 18 Dec 2025 22:55:37 GMT  
		Size: 9.9 MB (9892215 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:888af3e717cf1a916737b8d7e8e407c8f32b9e26b54b9a5f8ef63f5c017aaac3`  
		Last Modified: Thu, 18 Dec 2025 22:55:36 GMT  
		Size: 583.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:08ba4e8f48ca05e52585e070ca626d8ac2a6646f1ede82e4f66246c60593c690`  
		Last Modified: Thu, 18 Dec 2025 22:55:36 GMT  
		Size: 517.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b7258f194088170877a7f9fedd21f70d13b6713d8af38412fdc5f7082d47e0a1`  
		Last Modified: Thu, 18 Dec 2025 22:55:36 GMT  
		Size: 142.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c646899ead77b54549ce7cc3a844493f46abbfa287173d48e5e94e2ae6cd4952`  
		Last Modified: Thu, 18 Dec 2025 22:55:37 GMT  
		Size: 4.5 MB (4456775 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ebfda615bc4c28d1b3298af7d633aab617127f02476c326363223141269a3216`  
		Last Modified: Thu, 18 Dec 2025 22:55:40 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e2a52e2d9463c42ba6f2f44387626d05e6744548a77c1299ebdea87066c055fa`  
		Last Modified: Thu, 18 Dec 2025 22:55:37 GMT  
		Size: 919.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:39817d63aee9129a960e4efe9f3ebf315950cce6d5541354c942bb29ce4bd1fa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.6 KB (55568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcf651c1b78d562d23afd9eef274f86c58edf3d49fdb397f1594fcb6e7039eef`

```dockerfile
```

-	Layers:
	-	`sha256:0e2bd64248ae836641d572156035d1f895414374d691d17f2c0aa559a621f080`  
		Last Modified: Fri, 19 Dec 2025 00:29:55 GMT  
		Size: 55.6 KB (55568 bytes)  
		MIME: application/vnd.in-toto+json

### `friendica:dev-fpm-alpine` - linux; riscv64

```console
$ docker pull friendica@sha256:740d18cd80f22b79647d8426e4d05bfb7fdfdf58284b34dd88deb13a2031b2cc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.0 MB (59951683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dde5b81bd7e4310763c58fc0a3bde705d708f9474a869fffbb76d664680001a0`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 22 Dec 2025 20:30:02 GMT
ENV FRIENDICA_ADDONS=2025.02-dev
# Mon, 22 Dec 2025 20:33:04 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps       gnupg     ; # buildkit
# Mon, 22 Dec 2025 20:33:05 GMT
COPY *.sh upgrade.exclude / # buildkit
# Mon, 22 Dec 2025 20:33:05 GMT
COPY config/* /usr/src/friendica/config/ # buildkit
# Mon, 22 Dec 2025 20:33:05 GMT
...
-	Layers:
	...
	-	`sha256:25dddab24fecbf9b5858ab9fb5512ebeba8a80e480ce1f1ad789c86283ad4289`  
		...
		Size: 142.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1d6bff0b8e9269fd8ce1d9b3dbffafd465f3c72ce932ecc967ae1278f79a4fab`  
		Last Modified: Mon, 22 Dec 2025 20:33:32 GMT  
		Size: 4.4 MB (4408360 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:16dd950d3f8fd1a88148fa0f5d75a51bd55469b83f4774c8075abbec0ecde5fd`  
		Last Modified: Mon, 22 Dec 2025 20:33:32 GMT  
		Size: 3.9 KB (3861 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5882772a789646b27d6fe3258d78f9c26201f7e2e2d1dc607a2eb52610f29aa8`  
		Last Modified: Mon, 22 Dec 2025 20:33:32 GMT  
		Size: 920.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:3ecea7b68dbdc077b175bb68fabf574e31ae333cec421bfc632d56d6dc2df0a7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.6 KB (55577 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f345e768f85fdb15c162956c6766c82a11bd65fe374a5ec193ef0f2d43983aee`

```dockerfile
```

-	Layers:
	-	`sha256:429bc222adb376af8c48aaf1149f7bf11d16ced271a00b5765b83a6ef0add0ad`  
		Last Modified: Mon, 22 Dec 2025 21:27:55 GMT  
...
```console
$ docker pull friendica@sha256:d8f2ada0531d3ae5c0c68225ddfbfdbb854f304e2ec818976d84eafc15bd2701
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.6 MB (61573088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d627d2dcd71d2069ec44b78b151d5f0bd77727cd4e8e23a3644fe97ca37f15cf`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:430a9adc5c55c6a628cc4925937313a8b2433dc2c9452a8e8aafdb2e498e3400`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fd26dde56cd7f7dca7327a97d0c4144cdd9d74562e27e8018604b9658e18f705`  
		Last Modified: Thu, 18 Dec 2025 22:14:48 GMT  
		Size: 9.8 MB (9769919 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c863c981e015499201b7ae00014c6a3ce789e6dcc88ab9f92a8c9edb63547c11`  
		Last Modified: Thu, 18 Dec 2025 22:14:47 GMT  
		Size: 582.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bf81170edfa3ac348271d903848c2e6bdabc8b71ad02861c0d6adb403fa2b50f`  
		Last Modified: Thu, 18 Dec 2025 22:14:47 GMT  
		Size: 513.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:02c82c9981d1cc2dfaa248003cfa434de4a0936f6b5698bc4eb8cef2ab1fa315`  
		Last Modified: Thu, 18 Dec 2025 22:14:46 GMT  
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:742424aa9f3c1a3faac0fe31250e0e9b9b5ab2f1fa4cb7f3b0eee318feb1425b`  
		Last Modified: Thu, 18 Dec 2025 22:14:47 GMT  
		Size: 4.6 MB (4603214 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:28b36f401e1f74bc75ad91aca7b856d5b2afea291414b1833363bf9529841c14`  
		Last Modified: Thu, 18 Dec 2025 22:14:47 GMT  
		Size: 3.9 KB (3860 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:65026bf0ace2afe8eb05efd31bd20c82963c7fbd75a79dd85015c355a87a181d`  
		Last Modified: Thu, 18 Dec 2025 22:14:46 GMT  
		Size: 918.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:9d1c3a27d5899619b6299f7ba5e66c4fe6a6e3995cbdead59450ce7a799f65eb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 KB (55533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81d39b594e7c4af170f9fecf31c8ce6a80ee7f72fc3980e1c11ff3f2c2a13148`

```dockerfile
```

-	Layers:
	-	`sha256:421e6c37910f4439ade63b0dfc5dbc256d76eab1c390c8a53c09e882b12488b0`  
		Last Modified: Fri, 19 Dec 2025 00:30:00 GMT  
		Size: 55.5 KB (55533 bytes)  
		MIME: application/vnd.in-toto+json
