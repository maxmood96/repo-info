...
```console
$ docker pull friendica@sha256:2b8c8c27b1945151f046fd553eec44d8ae05066c35baea225d4e972bcc6e7b9d
```
...
```console
$ docker pull friendica@sha256:faf04fca55d395930d620560b1678b3f5f4d2605f0b1bf029d69d7db994b064f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.6 MB (203592091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d25bc44901e0309e8d2e25ffb66ac815bafbc3a43cb27fbd0c6bb3826cad9517`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 25 May 2021 18:25:16 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 25 May 2021 18:25:30 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 25 May 2021 18:25:31 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Tue, 25 May 2021 18:25:31 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Tue, 25 May 2021 18:25:31 GMT
...
-	Layers:
	...
	-	`sha256:1895006ae7dc55e7d804eef2f0c8f1bb01fa14ae2f16399baa011a11d4adcd0f`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63b0b3b325c924230ae9c935eaf391ac29692654ab21e26d29ce0eb703e46401`  
		Last Modified: Tue, 25 May 2021 18:29:56 GMT  
		Size: 48.4 MB (48419637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77589d15dad5d53d07a58022c92c91f2202c56509bb9b0b2db715a765d7c537c`  
		Last Modified: Tue, 25 May 2021 18:29:47 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6f36fb4511253fcb7b33f192d133a1b32e159eb494115b3d85e3edca62c234b`  
		Last Modified: Tue, 25 May 2021 18:29:47 GMT  
...
```console
$ docker pull friendica@sha256:06e43f856239337bf69b1f130ca196fd2ea777dd8ce0b28d564f2932282e05be
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.4 MB (198422806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c749ca61afc0f7c914938a384076eb9eaab5e306564c3a4462e6d54a2a810181`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 13 May 2021 05:42:48 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 13 May 2021 05:42:49 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 13 May 2021 05:43:09 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 13 May 2021 05:43:14 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
...
-	Layers:
	...
	-	`sha256:3d391aaa140b4c17919faaa360bb557f1f29e15d8941f229c02937c2ebb7cbb3`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f063ed42f50548775bc0e7fd2c55f3cc8edbc5f8322ffb5e7ea5c834a9495470`  
		Last Modified: Thu, 13 May 2021 05:47:29 GMT  
		Size: 48.4 MB (48419648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdf211ce454f150779861302d12194a4021016b34a96a32c0666220ab07276f3`  
		Last Modified: Thu, 13 May 2021 05:47:09 GMT  
		Size: 2.6 KB (2629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba2f6559535b5a31171cb92ce73ba9d3b1d06d178b55213f5b849becb0202f5e`  
		Last Modified: Thu, 13 May 2021 05:47:10 GMT  
...
```console
$ docker pull friendica@sha256:24f42ca5ba68c5ca4797325a80f814f37e25ee9af8f0dbfc8763fc60b906075a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.6 MB (218643034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f71607c73647a576b972252ea16faa785e071931f138c4bfd37e93ac7064db2c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 13 May 2021 05:34:26 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 13 May 2021 05:34:27 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 13 May 2021 05:34:41 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 13 May 2021 05:34:45 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 13 May 2021 05:34:47 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 13 May 2021 05:34:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 13 May 2021 05:34:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:48cd0976518786294fd9bed3af8d49af885345b0d2a1412ea76d3ad9a79676c7`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f9fca2516bcd5936422cfe8da2119fc46cae1c85f0b10d0a193d04e69151f8d`  
		Last Modified: Thu, 13 May 2021 05:38:25 GMT  
		Size: 48.4 MB (48419641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4776ab576b2233312370208c44953a51034e8c597ba8ead31b6e939a384b5627`  
		Last Modified: Thu, 13 May 2021 05:38:13 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:229c0430a67e1d64b8a5475db224701b03b9049eb5b194e2d862afed6b640474`  
		Last Modified: Thu, 13 May 2021 05:38:13 GMT  
