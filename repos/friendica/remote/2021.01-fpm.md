...
```console
$ docker pull friendica@sha256:87ad6f579bda182cb516c577e2e7b567685abc6e321dd089447c396d6e4b8d7d
```
...
```console
$ docker pull friendica@sha256:45d6e81acf17094c4f076589f275c7320d76bbdbed0519415667bccf70c598ec
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.7 MB (218726319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7aed98a2486afc8ae7c33955ea884ece341a92b8e5ac22e337218580f5909bb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 06 Jul 2021 22:45:52 GMT
ENV FRIENDICA_VERSION=2021.01
# Tue, 06 Jul 2021 22:45:52 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 06 Jul 2021 22:46:04 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
...
-	Layers:
	...
	-	`sha256:16d0090430d842cc71366f4413cc1711c2d63f4d8e3e2f911766a5606b77b608`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fe3b602c8a3c3e25e09ae54e720d0ed68d5d1dd7e7fe5a581b644996e674da9`  
		Last Modified: Tue, 06 Jul 2021 22:51:26 GMT  
		Size: 48.4 MB (48419638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9033ade287cace9d548f7272022220ba43fbd30ce5e013f4990b193e8c24a8f9`  
		Last Modified: Tue, 06 Jul 2021 22:51:18 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3801102576bfdd5359e057e64fc614e5a85dd911e49793042cdc0a4802c5a9ef`  
		Last Modified: Tue, 06 Jul 2021 22:51:18 GMT  
...
```console
$ docker pull friendica@sha256:65930f9bac44f6864caa9a3a746e6df235a358d385fe25a5501d6788041f4ccd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.6 MB (243617219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad06eceef0afea5aacf3afe46c2484d1ecd4c656cf208f9111b6d7d880dd33b2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 08 Jul 2021 18:25:57 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 08 Jul 2021 18:26:03 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 08 Jul 2021 18:26:29 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 08 Jul 2021 18:26:38 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 08 Jul 2021 18:26:40 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 08 Jul 2021 18:26:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 08 Jul 2021 18:26:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:77223dd7f6cd049fe6552ed30c826e021e073f0a93f9b58246d8d285fd78d08b`  
		...
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d4e9416fb2277a841c3455c88703bd70ba2a8f8bf39848660e3c99769a698cc`  
		Last Modified: Thu, 08 Jul 2021 18:45:02 GMT  
		Size: 48.4 MB (48419647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f5fb9881a75de87a097b2da1f90d22421e9e316ff3450319f532d3709e734c5`  
		Last Modified: Thu, 08 Jul 2021 18:44:19 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a5b4bc5ce8da698250a9b5c81b357e3e84cd3239fd8afadef5b6f9fa5d30513`  
		Last Modified: Thu, 08 Jul 2021 18:44:18 GMT  
		Size: 1.1 KB (1142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:8868a26da173c33e3b2cdb3c78dd36778842f32e79dc4058a6b8be3d78feb0bf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.5 MB (211456990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ddcc0c95b21b244082fc7371672973679491d5cbdb809e3e7b7be06444637f0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 07 Jul 2021 05:41:55 GMT
VOLUME [/var/www/html]
# Wed, 07 Jul 2021 05:43:11 GMT
ENV FRIENDICA_VERSION=2021.01
# Wed, 07 Jul 2021 05:43:11 GMT
ENV FRIENDICA_ADDONS=2021.01
# Wed, 07 Jul 2021 05:43:24 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Wed, 07 Jul 2021 05:43:28 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Wed, 07 Jul 2021 05:43:28 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Wed, 07 Jul 2021 05:43:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 07 Jul 2021 05:43:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5c5b44ff09e8b859ab86ee33483ea5937628732e0ab935d1e2569e23b3c591f2`  
		...
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f9e96ef54b8b55cb730f12d83ba8f6b6eb1ace510286501195486904a5fbb35`  
		Last Modified: Wed, 07 Jul 2021 05:48:32 GMT  
		Size: 48.4 MB (48419639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e49b9c64a9ac68e2f137bd00210a01d9418083afae92266f7deb0523f7b6336`  
		Last Modified: Wed, 07 Jul 2021 05:48:25 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60b9b881b27e58dfb29ae6c825f5da9b47692576749daa21541a7f67c5448b6e`  
		Last Modified: Wed, 07 Jul 2021 05:48:25 GMT  
		Size: 1.1 KB (1141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
