...
```console
$ docker pull friendica@sha256:aee024462275610b22f9888edf14abdddf00594ea8befae3243cd43e3420fa6c
```
...
```console
$ docker pull friendica@sha256:47c98327d7b2db9e361656f224b0d6c346ac9bbe6a6a8205d9a4eba685defeaf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.6 MB (203593987 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:602721e9434bf815037edfb71324890e0ca2750b1cb369f71aeb9cf4babcaff2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Jul 2021 23:49:02 GMT
VOLUME [/var/www/html]
# Thu, 01 Jul 2021 23:50:19 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 01 Jul 2021 23:50:20 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 01 Jul 2021 23:50:41 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 01 Jul 2021 23:50:43 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 01 Jul 2021 23:50:44 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 01 Jul 2021 23:50:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Jul 2021 23:50:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4b841b269678f7b1e09a915b4ea39a203c5570a18836734e87db9f1dfc385005`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fd498caa3b41525a509ee5a48a0c6e44a6077e424cfba19d807800904078e45`  
		Last Modified: Thu, 01 Jul 2021 23:57:48 GMT  
		Size: 48.4 MB (48419639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cebd422183f4571ec9613c451b33e38ebd1ddd94b973dfc4dabc9e6e83b564c8`  
		Last Modified: Thu, 01 Jul 2021 23:57:25 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9012f54b9c539246b347b4fbf12c27f3e756bcb61e3739f7ac99b339587ffd8`  
		Last Modified: Thu, 01 Jul 2021 23:57:25 GMT  
...
```console
$ docker pull friendica@sha256:56adf27d8a387deca8245a24d5075fd95ddd536e90b82a6eb38317a08b466a11
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.9 MB (234941185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd74e9269532fdb79e98435757b3891820ff81e46bdb26c0fbbefc2dc20afdae`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Jul 2021 01:54:20 GMT
VOLUME [/var/www/html]
# Fri, 02 Jul 2021 01:58:02 GMT
ENV FRIENDICA_VERSION=2021.01
# Fri, 02 Jul 2021 01:58:02 GMT
ENV FRIENDICA_ADDONS=2021.01
# Fri, 02 Jul 2021 01:58:16 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 01:58:18 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 02 Jul 2021 01:58:18 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 02 Jul 2021 01:58:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Jul 2021 01:58:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:92587f7df6f404614eb37d1e6c7c10efc558cb73f724e547ebc1966b6302a868`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0133bd7cbb8c91a3ba01a33fdb823c6d5a545723abedff84303d88f1a6d51151`  
		Last Modified: Fri, 02 Jul 2021 02:03:58 GMT  
		Size: 48.4 MB (48419647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3f98f15246500b418b049b01cd0c191833f73edd3b671c828573304ee0862c7`  
		Last Modified: Fri, 02 Jul 2021 02:03:48 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d128788ac9102e9f5ea0a9acf0e7afd24f02c479e3e7f259f49a4d18c4b014e`  
		Last Modified: Fri, 02 Jul 2021 02:03:48 GMT  
...
```console
$ docker pull friendica@sha256:72176d3cb52b89b6a55bf6ceddc40d8bb90a563e4ddf6f3a4a8899035965de1c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.4 MB (209391488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e14651dc32741703c1dead8ec66dafa850c2ba13bd37805659d745f688d265f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Jul 2021 21:59:37 GMT
VOLUME [/var/www/html]
# Thu, 01 Jul 2021 22:00:47 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 01 Jul 2021 22:00:48 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 01 Jul 2021 22:01:12 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 01 Jul 2021 22:01:14 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 01 Jul 2021 22:01:15 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 01 Jul 2021 22:01:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Jul 2021 22:01:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6653cc69ad39879d0e5d4d923a962b27e9e830d62c134360edbd1acfca5bfc28`  
		...
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:852db609857a179e3e2075ac58dc52dc1e2d7cbd69ee3b5dcc1cd4bf5f47aa5e`  
		Last Modified: Thu, 01 Jul 2021 22:05:55 GMT  
		Size: 48.4 MB (48419594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:657a234fade50573487dfd807203e2961def207af02bcca36639b7e264d3316d`  
		Last Modified: Thu, 01 Jul 2021 22:05:26 GMT  
		Size: 2.6 KB (2627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d54ec9918805275e76730edcd0d517c780f65abaaa0c0248fb74b9a072547b46`  
		Last Modified: Thu, 01 Jul 2021 22:05:26 GMT  
		Size: 1.1 KB (1141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
