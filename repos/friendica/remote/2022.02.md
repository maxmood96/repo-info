...
```console
$ docker pull friendica@sha256:ef4fa96d9a5b324ca96ec4d5d53ca9fbccdd221890b336b9d71847f95462679b
```
...
```console
$ docker pull friendica@sha256:0ed81480bbd4fbd4dd2efcdf8dd7a72db18c92fd7aa4fbcc8e02a06dea5e42e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.3 MB (251315783 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:016de29e05159317dbb5ed3c419c0f53ebe5c46f9af06ca84ea12107a793d7c2`
...
-	Layers:
	...
	-	`sha256:0fe85057aeea7f89c0d4971d9f745aae037b74d7a80e0345cd36f573a4065161`  
		...
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f59dea5744504dfbeb815cbc43e4a919e3242877a19c117e5de9826c885c609`  
		Last Modified: Wed, 30 Mar 2022 06:59:20 GMT  
		Size: 53.9 MB (53907007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7559b761b70c55bfedcf9a3f445958bfe132ff4a386d863d880f3ab656450b03`  
		Last Modified: Wed, 30 Mar 2022 06:59:14 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3d6ab74982483001e04ce7ba55b5186206033f4c973b98efa72ed36080dce76`  
		Last Modified: Wed, 30 Mar 2022 06:59:14 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:e5fc79794acaee64c0275f6878da7ed75fc2dfba7af544371cf4159a1de76b1e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.5 MB (227530984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c5d530ed674df0cf6c12a0b46b5ac7bb02753ca468c9de5cb94e047ca33a90c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Wed, 30 Mar 2022 06:04:09 GMT
ENV FRIENDICA_VERSION=2022.02
# Wed, 30 Mar 2022 06:04:09 GMT
ENV FRIENDICA_ADDONS=2022.02
# Wed, 30 Mar 2022 06:04:10 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Wed, 30 Mar 2022 06:04:10 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Wed, 30 Mar 2022 06:04:55 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 06:04:58 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Wed, 30 Mar 2022 06:04:58 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Wed, 30 Mar 2022 06:04:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 30 Mar 2022 06:04:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c92c214eaf5a95382e39c5db56d23e78233ac1efcfd4ba0f43a1a75577cce704`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cccc0a3cd6d3ec1ce1e546f2ff404f7c9fe9962a3113232eb2b3734ecd3eff7`  
		Last Modified: Wed, 30 Mar 2022 06:13:04 GMT  
		Size: 53.9 MB (53905798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:155b4ad62e1cd72ae312f379ece5af7f203bd765b46cfa812e198d2f2dd73949`  
		Last Modified: Wed, 30 Mar 2022 06:12:33 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b2257ce68e0ec1b801023db705ec2a99cafdcde9c6027c1a513a0d0c1983d9c`  
		Last Modified: Wed, 30 Mar 2022 06:12:33 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:f55a5004c3d7fb28219fcc3404c9ba2dbcc25e68ea024378ef2cee6d5bffd9f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.8 MB (252759001 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fb56c80de96a381f8e1502217f306f6418744f967a278d2c3adbb4075117d84`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Tue, 29 Mar 2022 20:46:35 GMT
ENV FRIENDICA_VERSION=2022.02
# Tue, 29 Mar 2022 20:46:36 GMT
ENV FRIENDICA_ADDONS=2022.02
# Tue, 29 Mar 2022 20:46:37 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Tue, 29 Mar 2022 20:46:38 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Tue, 29 Mar 2022 20:47:00 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Tue, 29 Mar 2022 20:47:01 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Tue, 29 Mar 2022 20:47:02 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Tue, 29 Mar 2022 20:47:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 29 Mar 2022 20:47:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f8a1294dfb3f1fa34b0e9020f44b403eebf59031a27dd3c6967c37d1a52fafb6`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cd917f5aa2a5deda9a470af2a87465f37e9efae4b30ac141fb75b6f26bdb321`  
		Last Modified: Tue, 29 Mar 2022 20:52:01 GMT  
		Size: 53.7 MB (53659345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eaf0bb91fb805262eb68e97398a3f344074742f371b5b6df123e6e9248fb34e`  
		Last Modified: Tue, 29 Mar 2022 20:51:53 GMT  
		Size: 3.0 KB (2953 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6732187e0438020a3d504d59422be9c2e04211128e11fb6a0ef2e2c66fdd25e8`  
		Last Modified: Tue, 29 Mar 2022 20:51:53 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:00a7afae0da22336f51b566a4da62a7cfb7594a44af49347b9b098054a610d60
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.2 MB (226208867 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa0d64c8794792725178da9456588c6fa0f0a76c9146c5043002d85246309f32`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 30 Mar 2022 06:50:28 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Wed, 30 Mar 2022 06:51:52 GMT
ENV FRIENDICA_VERSION=2022.02
# Wed, 30 Mar 2022 06:51:52 GMT
ENV FRIENDICA_ADDONS=2022.02
# Wed, 30 Mar 2022 06:51:53 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Wed, 30 Mar 2022 06:51:53 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Wed, 30 Mar 2022 06:52:10 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 30 Mar 2022 06:52:12 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Wed, 30 Mar 2022 06:52:13 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Wed, 30 Mar 2022 06:52:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 30 Mar 2022 06:52:13 GMT
...
-	Layers:
	...
	-	`sha256:30d73f29d557fdd9d8f320ac02b5badddb797dfcd5524c733f8b074717701a76`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43c95118ea03303895c13d54bde30c8391c6a10c48d53b7d5f65aa0d7c4692f1`  
		Last Modified: Wed, 30 Mar 2022 06:55:49 GMT  
		Size: 53.9 MB (53905525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e054fdc9d7d3eb2cd87ed6c94022720a5b89e5258d78345716ed368978d65ee`  
		Last Modified: Wed, 30 Mar 2022 06:55:44 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf21e08f2d52d9a4a3c6b3c3952fc00601401ec0eb321ed904d28f7a8dd62df6`  
		Last Modified: Wed, 30 Mar 2022 06:55:44 GMT  
		Size: 926.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
