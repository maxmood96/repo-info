...
```console
$ docker pull friendica@sha256:7cd41aa09d5042ade09d6cdb932df30ad4286578685bc688c614a548e3f7a55c
```
...
```console
$ docker pull friendica@sha256:c95033c6cd1aa1b68a670443fe3500f4713141eac77bad9749c09b82de060990
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.4 MB (251354879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82b08139d90bb0b20bca0922e2c2c1743c59560545b90b792fb2721980da6f58`
...
-	Layers:
	...
	-	`sha256:801cc5293f94efeb3c3f81120c53ba13c0e6baed13b67512e044419ec672ae5f`  
		...
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17af5edcf5375488ae72e96b7b5fc11d167499897b07004f384cdbf25daa4012`  
		Last Modified: Thu, 12 May 2022 03:10:36 GMT  
		Size: 53.9 MB (53907241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de18ec6efef61babf4c4d730edd6c536599067a1fbbdc198668bc82f3aadaec0`  
		Last Modified: Thu, 12 May 2022 03:10:30 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6813a5be6b58d21ca3967295ff8137b6d4efa1febc95651c2bf94b6863503473`  
		Last Modified: Thu, 12 May 2022 03:10:30 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:3fb5425d51da5b56e0f345c8e6ec8f760f38170912345882c6e8eb97d5661963
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **241.6 MB (241582291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4690689e848f5622122116f42a5bf455cf3b4301620d9b021cb5dd32db191ce`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 May 2022 22:06:54 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Wed, 11 May 2022 22:08:39 GMT
ENV FRIENDICA_VERSION=2022.02
# Wed, 11 May 2022 22:08:40 GMT
ENV FRIENDICA_ADDONS=2022.02
# Wed, 11 May 2022 22:08:41 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Wed, 11 May 2022 22:08:42 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Wed, 11 May 2022 22:09:05 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Wed, 11 May 2022 22:09:07 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Wed, 11 May 2022 22:09:08 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Wed, 11 May 2022 22:09:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 11 May 2022 22:09:10 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1283237165972d62bad1e4e1e3928a14e1a6e717234565ad5120d721222a2970`  
		...
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60e24c611230d8b865548e23c047a6e5f661a41374442d728f88a13f84091798`  
		Last Modified: Wed, 11 May 2022 22:17:49 GMT  
		Size: 53.7 MB (53659516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47d01f4536849d1652dfd2e741c0f1f3deffbcdd97727ba0cf643609994b8b36`  
		Last Modified: Wed, 11 May 2022 22:17:42 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:830043e10c2cd013a97fbb9536832969ef4b9c795159f03359861e7e23d7e7a9`  
		Last Modified: Wed, 11 May 2022 22:17:42 GMT  
		Size: 928.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
