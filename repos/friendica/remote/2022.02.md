...
```console
$ docker pull friendica@sha256:e2678fc23dbc3264bf5b2c8979f7f78a952ccd8584b58b1ae43c97b9eb004924
```
...
```console
$ docker pull friendica@sha256:ba47867847799f94ff69376b099bd056222ed07ef897c55fb999ec4036fab463
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.7 MB (218728676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0caa0482592f95fc3ddf71519eb7c31bca15523de606ed80d979a513f585e5a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 20 Mar 2022 00:19:40 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sun, 20 Mar 2022 00:19:41 GMT
ENV FRIENDICA_VERSION=2022.02
# Sun, 20 Mar 2022 00:19:41 GMT
ENV FRIENDICA_ADDONS=2022.02
# Sun, 20 Mar 2022 00:19:42 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Sun, 20 Mar 2022 00:19:42 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Sun, 20 Mar 2022 00:20:36 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 00:20:38 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Sun, 20 Mar 2022 00:20:39 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sun, 20 Mar 2022 00:20:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 20 Mar 2022 00:20:39 GMT
...
-	Layers:
	...
	-	`sha256:e030c41317d3d76b60b9a1b425bd7fa8a83029d17f9a75a8d4019d971624510b`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50858a3328d686430073d0ddd7e19f9fcc4f18b5b233c5128c194dfb0aa8865f`  
		Last Modified: Sun, 20 Mar 2022 00:31:31 GMT  
		Size: 53.9 MB (53905291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a00c6d4bc2cf66998e814f40c9e7218d3e0a3989c92dc85774f09b6b1e1d99`  
		Last Modified: Sun, 20 Mar 2022 00:31:00 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69fd70d0c18624510f37b71ea8b00bd4ee9da71f2350e7151f5db8f75eb5c7bc`  
		Last Modified: Sun, 20 Mar 2022 00:31:00 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:fc7896d3fb5155cb827ab4c6e9002e7d99d4e390fee21fd16fa3edb76f4ce1b2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.9 MB (253862901 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a1c7504b6036955054ae3870babc80dfe54cfb2698f38e12693d54a0b6c29c8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:21254b05363a099b25fd72f0311a5710235c0b974b4f5b12d11b0c678ca4a115`  
		...
		Size: 541.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:657657a625962effde6f8c7cf148f6cb649b171dbad58afcaf244bb7d529f9ab`  
		Last Modified: Sat, 19 Mar 2022 07:43:44 GMT  
		Size: 53.9 MB (53905989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc66267ebba2bbb8c7f23a2b9e66248e0c74331b646dc3df332830e19125799d`  
		Last Modified: Sat, 19 Mar 2022 07:43:34 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b38724c453515372cd3e91c5458c276dc88f9fdaa3e0f631f57d3c886f6f1966`  
		Last Modified: Sat, 19 Mar 2022 07:43:34 GMT  
		Size: 926.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:2531f3676985155a83d5d087cd64e727d6aa60f3528a3ec82fd10b49fdeb1f20
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.5 MB (225534990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:157e86a032ba769057166263de2d16525618d561435735153a2a238361db902b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sat, 19 Mar 2022 12:40:32 GMT
ENV FRIENDICA_VERSION=2022.02
# Sat, 19 Mar 2022 12:40:35 GMT
ENV FRIENDICA_ADDONS=2022.02
# Sat, 19 Mar 2022 12:40:39 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Sat, 19 Mar 2022 12:40:43 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Sat, 19 Mar 2022 12:41:58 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Sat, 19 Mar 2022 12:42:06 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Sat, 19 Mar 2022 12:42:12 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sat, 19 Mar 2022 12:42:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 19 Mar 2022 12:42:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b96501c400040781914a61506e16a7ca33b6156c5d02d7ecb37df7d8d8a71589`  
		...
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:541a864028430ab2be0daa37dbf0844e75e3bfce120fbb7f03cf63fe864576a3`  
		Last Modified: Sat, 19 Mar 2022 12:53:44 GMT  
		Size: 53.7 MB (53659730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6774fa3527bbb5c5a6512b7bca14c039729aeaf3865b7891e59b1cb898aa578f`  
		Last Modified: Sat, 19 Mar 2022 12:53:16 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc940d2d862f10a9496ec8126faabb09acf4b401ed6a5da46e148a08f3c62116`  
		Last Modified: Sat, 19 Mar 2022 12:53:16 GMT  
		Size: 932.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
