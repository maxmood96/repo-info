...
```console
$ docker pull friendica@sha256:d9f78a3123fcc86291d90ab5032879a01b3a93dc35956c249dcc642bfda30da9
```
...
```console
$ docker pull friendica@sha256:7877437e01fbb1675af1817be4fec569168488d1e25da88e3f86a775c4f57cfa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.1 MB (223083289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10c34f41433681c28b1531dc0275775d56a1f3dafb0eb2785ea9b553327bf20e`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 20 Nov 2025 20:17:21 GMT
CMD ["apache2-foreground"]
# Thu, 20 Nov 2025 21:47:56 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ; # buildkit
# Thu, 20 Nov 2025 21:48:08 GMT
ENV GOSU_VERSION=1.17
# Thu, 20 Nov 2025 21:48:08 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 20 Nov 2025 21:51:13 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-7.q16-10-extra     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0 --configureoptions 'enable-redis-zstd="yes" enable-redis-lz4="yes"';     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 20 Nov 2025 21:51:13 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 20 Nov 2025 21:51:13 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:baf7e6a6cacaf3613eb20206dede46246ee66a2666483fc4eb0cc5c2519ea138`  
		Last Modified: Thu, 20 Nov 2025 21:51:39 GMT  
		Size: 19.7 MB (19728569 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5d74d6995a8bbaf8abeedd07899a17a275ccc8aeb806ebcff9a6ac6a86d62a02`  
		Last Modified: Thu, 20 Nov 2025 21:51:37 GMT  
		Size: 1.1 MB (1097986 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:619da569b1240cbeac694082c1977b5b5d96e8d586d38406fdc445deeba1adc8`  
		Last Modified: Thu, 20 Nov 2025 21:51:42 GMT  
		Size: 44.8 MB (44798648 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:65d9b81124f7f8431577ae425f653f800a0abba19b0065d52709d8568f866724`  
		Last Modified: Thu, 20 Nov 2025 21:51:36 GMT  
		Size: 591.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:84c2afba026f3aa563613cff3d15b897f69f7352c9e678bdadcd2efc4fd27524`  
		Last Modified: Thu, 20 Nov 2025 21:51:37 GMT  
		Size: 579.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:339a6e7b7355cc5079aa96c9ddb69e079b138d2c85cd6cb17b467b921cbead0b`  
		Last Modified: Thu, 20 Nov 2025 21:51:36 GMT  
		Size: 140.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:31eccd8b54cb27dc43170609befb81ee146a7401eb36ddd78f64adf78a9b50ed`  
		Last Modified: Thu, 20 Nov 2025 21:51:38 GMT  
		Size: 18.4 MB (18400095 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:46fd360b3947069e761c80337560e2892109c68cb441e8c59e696a3cfcbd73b4`  
		Last Modified: Thu, 20 Nov 2025 21:51:37 GMT  
		Size: 3.7 KB (3724 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:da908b7bbfe9c5173e87ed8d02db8efd342b6df297d22de7a07c4a7708917440`  
		Last Modified: Thu, 20 Nov 2025 21:51:37 GMT  
		Size: 923.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:64078c47fd360a3f2f652261d60427a86a2a201d7814acf515f9d73a7de5ee74
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **65.9 KB (65944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e422c0742a6b8738135793e010c7591094d23e7f9ee39fa5db14925c8a3116a`

```dockerfile
```

-	Layers:
	-	`sha256:c962bbe4cc3f302b3fc7ba43ac0e0b39d044ff3248a564eb992b8ab645d542ab`  
		Last Modified: Fri, 21 Nov 2025 00:30:18 GMT  
...
```console
$ docker pull friendica@sha256:75b9525d2281c6c9202b147ece0c8ba5f2a668adc8face5422e1ed54a9a22843
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.5 MB (238501969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c0ca95c4c61f86bcb8a61bc67e6721fa59f2645d682b9656b27a478f228ae4b`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 20 Nov 2025 20:41:59 GMT
CMD ["apache2-foreground"]
# Thu, 20 Nov 2025 21:42:45 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ; # buildkit
# Thu, 20 Nov 2025 21:42:56 GMT
ENV GOSU_VERSION=1.17
# Thu, 20 Nov 2025 21:42:56 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true # buildkit
# Thu, 20 Nov 2025 21:45:54 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-7.q16-10-extra     ;         debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.27;     pecl install memcached-3.3.0;     pecl install redis-6.2.0 --configureoptions 'enable-redis-zstd="yes" enable-redis-lz4="yes"';     pecl install imagick-3.8.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;     rm -r /tmp/pear;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 20 Nov 2025 21:45:54 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 20 Nov 2025 21:45:54 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e5015304c80e8944f4be6b15c9de9464b8ae2e5608b22684be54bdd96b87fadd`  
		Last Modified: Thu, 20 Nov 2025 21:46:39 GMT  
		Size: 19.8 MB (19773657 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4e34aa73d42b55474028f5060075238198e2e37e38fc61370feba49e1501264d`  
		Last Modified: Thu, 20 Nov 2025 21:46:38 GMT  
		Size: 1.1 MB (1097514 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e0102adb768a311f1f0c290bfd89fa8e18ee567a178f913d30945da1733c4428`  
		Last Modified: Thu, 20 Nov 2025 21:46:43 GMT  
		Size: 48.2 MB (48217065 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:42a551e59d45c5f4eb8835ef0b82584f8bfe4f654f7c8d5ffddb31357da411eb`  
		Last Modified: Thu, 20 Nov 2025 21:46:37 GMT  
		Size: 591.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f10a6635b038266d54d81b7e582584c44c2c2eae3fc30b638f947200a0885101`  
		Last Modified: Thu, 20 Nov 2025 21:46:38 GMT  
		Size: 585.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:88d8ee3d3fe50ed378b40726608f1b6a3cfef9ec357ad98c6bea6b8f21b097e5`  
		Last Modified: Thu, 20 Nov 2025 21:46:38 GMT  
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:95eb729fb89aa11d45a296f88ac2131105eb4277c6b5e3f9ae48d9674715504f`  
		Last Modified: Thu, 20 Nov 2025 21:46:40 GMT  
		Size: 18.3 MB (18331973 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7db18ddf62cd0d428ccef3f70bda3207317f7794f0dab02d51d080476d35797d`  
		Last Modified: Thu, 20 Nov 2025 21:46:38 GMT  
		Size: 3.7 KB (3723 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5f7a06f854604eba9a5631e5c47b20e7d72aaee099b9a5d3b620c28b1107ef31`  
		Last Modified: Thu, 20 Nov 2025 21:46:38 GMT  
		Size: 922.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull friendica@sha256:d0f7962f7763ec901ff4aa407458f32c53acbdc861431c02648a9bed2caed239
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **65.8 KB (65786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbf1627dcb78348237e72ed513b16fe9c81d644d094abe937d2b9ae0ffeffa37`

```dockerfile
```

-	Layers:
	-	`sha256:f4672ed8219a4b205a974a29bb570c830caed6a7f3232377f6ebb46a49008c00`  
		Last Modified: Fri, 21 Nov 2025 00:30:29 GMT  
