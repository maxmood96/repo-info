...
```console
$ docker pull friendica@sha256:f075af3c4360a7521465f4e008dc90a260658ce9c53af746dbcbc33aa0d0ad4f
```
...
```console
$ docker pull friendica@sha256:8d6877a5b5ac383e7ac94715515d168c8a91ab62d2e3462f822c05012d65e75d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207239912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab4eba41d85c38c56990c4c81ae7dd2cc6452ebd30dbd90cbe16c9c352503c36`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 29 Mar 2021 18:00:47 GMT
ENV FRIENDICA_VERSION=2021.01
# Mon, 29 Mar 2021 18:00:48 GMT
ENV FRIENDICA_ADDONS=2021.01
# Mon, 29 Mar 2021 18:01:10 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Mon, 29 Mar 2021 18:01:14 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Mon, 29 Mar 2021 18:01:16 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Mon, 29 Mar 2021 18:01:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 29 Mar 2021 18:01:17 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f470c9881921579314c6c419e2abeea681f118817c05b06112c6b25e00c0342f`  
		...
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80d4cba160a141f04f9a59f35a42b4276cc14242a6d65bdeae179fdc4c9d79a2`  
		Last Modified: Mon, 29 Mar 2021 18:04:23 GMT  
		Size: 48.4 MB (48419637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddaa22943b342cca81cb29c54b3de5233de004f6944aec70b855e984a6bd1ae8`  
		Last Modified: Mon, 29 Mar 2021 18:04:06 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bc1dc1aa49daa42a470c1e2ef89647c5ca86e19861361d92263ee95d5047c49`  
		Last Modified: Mon, 29 Mar 2021 18:04:06 GMT  
...
```console
$ docker pull friendica@sha256:4647b6eb77667c2135bbc60e35d1a0f98af8c00c2928cc956afb900a84faec2f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.0 MB (238952570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c468a9b99f3b7b4be844b52380db4adcbd01bc269f09a480d0be9fc119d73af`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 29 Mar 2021 18:47:05 GMT
ENV FRIENDICA_VERSION=2021.01
# Mon, 29 Mar 2021 18:47:05 GMT
ENV FRIENDICA_ADDONS=2021.01
# Mon, 29 Mar 2021 18:47:19 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Mon, 29 Mar 2021 18:47:20 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Mon, 29 Mar 2021 18:47:21 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Mon, 29 Mar 2021 18:47:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 29 Mar 2021 18:47:21 GMT
...
-	Layers:
	...
	-	`sha256:5816b20ce715c20e05ac0cbf480534b442860f2a733a58afd6c5968b227d3bcf`  
		...
		Size: 539.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5baa37f495cca4d4222a4f962589a0c1fa5d4065c2e1dfdacd7ba7b6ab82835f`  
		Last Modified: Mon, 29 Mar 2021 18:51:34 GMT  
		Size: 48.4 MB (48419644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfd8211388915afb913ff27cad2b4130c142e1c36cde1f87a9e8b17e835985cf`  
		Last Modified: Mon, 29 Mar 2021 18:51:26 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a838bd23d13ad8c9184b1f4d90bd527321287f6aec035dc7a660aecf27ea464`  
		Last Modified: Mon, 29 Mar 2021 18:51:26 GMT  
		Size: 1.1 KB (1142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:0df5fe72ffe8eee4b5ecd3f03447a4884fb965bde5def284790f67759e1b2763
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.1 MB (213055540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f278e18aefb9bf2dc6bb93959ab04659458c7726c33ecec07a886b16cc724f92`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 29 Mar 2021 18:22:04 GMT
ENV FRIENDICA_VERSION=2021.01
# Mon, 29 Mar 2021 18:22:04 GMT
ENV FRIENDICA_ADDONS=2021.01
# Mon, 29 Mar 2021 18:22:29 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Mon, 29 Mar 2021 18:22:32 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Mon, 29 Mar 2021 18:22:33 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Mon, 29 Mar 2021 18:22:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 29 Mar 2021 18:22:33 GMT
...
-	Layers:
	...
	-	`sha256:932b3e561f738d08d39459959e1ede5382ab6d5ea05924c998723188a693e0c3`  
		...
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:401a723f54429c4a1d4bffcf7729b497e95390e7248ccb2050c2b2632c67e3b3`  
		Last Modified: Mon, 29 Mar 2021 18:25:54 GMT  
		Size: 48.4 MB (48419607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2de219e0d43aabeaa8527211b465d75757defedb8946318e47732a6823a6a7e`  
		Last Modified: Mon, 29 Mar 2021 18:25:25 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d773fdd1b3fe62dc95ccf5b156274ddb73a4ba26486b75fbca2339fae9cb58c`  
		Last Modified: Mon, 29 Mar 2021 18:25:25 GMT  
...
```console
$ docker pull friendica@sha256:3d4fa200c5886d486e17544d2c47b124a11ee511c5cd47498b57ae7712ef44b7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.2 MB (215153327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0e45edf77a9bae052bd2514289697d88f7787ee31c8b52fc2da245c9817acf9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 29 Mar 2021 18:47:57 GMT
ENV FRIENDICA_VERSION=2021.01
# Mon, 29 Mar 2021 18:47:57 GMT
ENV FRIENDICA_ADDONS=2021.01
# Mon, 29 Mar 2021 18:48:09 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Mon, 29 Mar 2021 18:48:12 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Mon, 29 Mar 2021 18:48:13 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Mon, 29 Mar 2021 18:48:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 29 Mar 2021 18:48:13 GMT
...
-	Layers:
	...
	-	`sha256:a9dd9614bb618b17557aed2ba94fe7efcbdd1fdb4bde0dd868c237bca585b47c`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5491fa22b4db4a21d664adb14c9d8e1a58fc98fe545996798f7c3e8bdbf50fbe`  
		Last Modified: Mon, 29 Mar 2021 18:50:49 GMT  
		Size: 48.4 MB (48419647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bdc64e4f0b2df0887f4f4b8de396d1a33f04e330d41fae2b86b386cdccfd615`  
		Last Modified: Mon, 29 Mar 2021 18:50:43 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f3d5b8babca74287473dfaf270992a9f7b1365b143e07d4bb73c9961f7a40c0`  
		Last Modified: Mon, 29 Mar 2021 18:50:43 GMT  
		Size: 1.1 KB (1144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
