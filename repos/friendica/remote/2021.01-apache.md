...
```console
$ docker pull friendica@sha256:9d116387a59fdf06a517eed3db4a5be0aba5adbe904cb4d9f284a398505d2f95
```
...
```console
$ docker pull friendica@sha256:7f8ec4d6b6888a68d38af19715258ca13d0f3d799e4b89bb67b74b3f6e2d757b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.1 MB (213092785 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdffdc2f3d97693ce029852e78c7e68eaafc7b31dfc8dfa548815b702c2fde62`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 29 Apr 2021 19:45:32 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 29 Apr 2021 19:45:32 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 29 Apr 2021 19:45:57 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 29 Apr 2021 19:45:59 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 29 Apr 2021 19:46:00 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 29 Apr 2021 19:46:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 29 Apr 2021 19:46:00 GMT
...
-	Layers:
	...
	-	`sha256:f492f0c3e148bb6846cbe0e90af449dc26ed188419c7885a565e7db069b2ad1c`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49ce3efdac26d8512f4ae67836e86d2c1980080ab4b846f6b2a5c3734fe595c7`  
		Last Modified: Thu, 29 Apr 2021 19:50:18 GMT  
		Size: 48.4 MB (48419602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:781f1d2b6d8a79e978caab10f8872c9e1b537a7aa6b15ed318d57c3b5e352ff7`  
		Last Modified: Thu, 29 Apr 2021 19:49:49 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfaec01566b1d8c8d90da606048c913b1316a5bfc1ffb9d02f35d9586c77c0f3`  
		Last Modified: Thu, 29 Apr 2021 19:49:49 GMT  
...
```console
$ docker pull friendica@sha256:7bf0664ab3bbfae560f16129330e52f71e41a501f2d9cc1b8002e0bd1beacb6f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.2 MB (215192626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1dc700e314ea9b09050f89eb06a3d7510976ec436812ab8001fc6a221806b21`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 29 Apr 2021 19:41:54 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 29 Apr 2021 19:41:54 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 29 Apr 2021 19:42:15 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 29 Apr 2021 19:42:24 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Thu, 29 Apr 2021 19:42:24 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 29 Apr 2021 19:42:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 29 Apr 2021 19:42:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8de15f7143d92c5d98c36d3e9344d96a23b9e4c00b26ee04172c3ed26843ae4b`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9ba68b7f0780657326a6bd0e1a6a56ed078441cfd5e26cd47a70fd0f190b2e4`  
		Last Modified: Thu, 29 Apr 2021 19:45:53 GMT  
		Size: 48.4 MB (48419639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb988ef2a9fd633065a0852532973d95c0af0f45172b34be9e569d5eebdc2dd0`  
		Last Modified: Thu, 29 Apr 2021 19:45:47 GMT  
		Size: 2.6 KB (2627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e498f9bc68d4b9fd8ad258da4b223f1a7fe6979920af3106f9e05d12a2fcf2e`  
		Last Modified: Thu, 29 Apr 2021 19:45:47 GMT  
