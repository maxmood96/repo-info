...
```console
$ docker pull friendica@sha256:94c42c13c93157b93ac2265d1293d7fd39e82daab699c8dc74f7abd98c265615
```
...
```console
$ docker pull friendica@sha256:8c3a67aeb7129eb48abc10cb2fb7148cfc2ca159bda1de2cb43977ef2f568f28
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.3 MB (207276343 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41b2abb9f9e7911be48204ea709505907ca80ce6646d942c0832b8df32d59ff6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Jun 2021 02:30:17 GMT
ENV FRIENDICA_VERSION=2021.01
# Fri, 04 Jun 2021 02:30:17 GMT
ENV FRIENDICA_ADDONS=2021.01
# Fri, 04 Jun 2021 02:30:36 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 04 Jun 2021 02:30:37 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 04 Jun 2021 02:30:38 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 04 Jun 2021 02:30:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 02:30:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:23864c058f61179364bce26716a022a8387b0adeb1255cab001f6ffccc8fff8e`  
		...
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a57a3de8ff592e9f2ce740918e59fd3d49c65fcbdfe0b4a4d66dac414932269`  
		Last Modified: Fri, 04 Jun 2021 02:35:52 GMT  
		Size: 48.4 MB (48419632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56741a720582d6ed8cd7e9a133f97c5dc7bf8937033dc3637a8690644ae26e63`  
		Last Modified: Fri, 04 Jun 2021 02:35:39 GMT  
		Size: 2.6 KB (2626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44642d7c9b8a0c3b9aac4e76fc8845dbbb0a8be42c5fd004c49dc97fac3d2d65`  
		Last Modified: Fri, 04 Jun 2021 02:35:39 GMT  
...
```console
$ docker pull friendica@sha256:9786b0feee159a614c914108c22158f4e255a50a655b6a2580d31af4efc082ad
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.4 MB (222426745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdc96bbcae6b453aab31b5c09ed5dc8dcc1706f75093a67add438b0477a30203`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 04 Jun 2021 05:09:14 GMT
ENV FRIENDICA_VERSION=2021.01
# Fri, 04 Jun 2021 05:09:14 GMT
ENV FRIENDICA_ADDONS=2021.01
# Fri, 04 Jun 2021 05:09:26 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 04 Jun 2021 05:09:27 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 04 Jun 2021 05:09:27 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 04 Jun 2021 05:09:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 05:09:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:384cbde5cc33ef797e6c52063cf4b6627e594d7251043dccb798de50f1f0294e`  
		...
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c8b79c1ea3035f2f2e33d37412a07951ba8b4feed3db799fe7168b754d7e901`  
		Last Modified: Fri, 04 Jun 2021 05:14:19 GMT  
		Size: 48.4 MB (48419643 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce0f18f05f4d356bed05a20ae82821f74939d1a618f61e95cdd906882eaa0d31`  
		Last Modified: Fri, 04 Jun 2021 05:14:11 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26cdfd1e74e4769314adaf51ce86cdafa97b5fc6049a49c91511bab369447b9b`  
		Last Modified: Fri, 04 Jun 2021 05:14:11 GMT  
		Size: 1.1 KB (1140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
