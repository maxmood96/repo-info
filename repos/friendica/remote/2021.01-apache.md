...
```console
$ docker pull friendica@sha256:3fdce2073bc4e24a2ed4aab5344e711cdfbd7d33745fc77d547b36e3993241be
```
...
```console
$ docker pull friendica@sha256:816d89509f56e1faf47edeaece3f77c50e30bd5e69c62baabae6bd13e19bc0ad
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.8 MB (201841528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f8affd6d1869b8194fbc9420be37d6bba5d398c00c0b4908b9999c5ebcaac92`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 13 Jan 2021 00:02:14 GMT
ENV FRIENDICA_VERSION=2021.01
# Wed, 13 Jan 2021 00:02:15 GMT
ENV FRIENDICA_ADDONS=2021.01
# Wed, 13 Jan 2021 00:02:33 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Wed, 13 Jan 2021 00:02:37 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Wed, 13 Jan 2021 00:02:38 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Wed, 13 Jan 2021 00:02:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 13 Jan 2021 00:02:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:00b8feac075a23c96e4f626d9260a44e4469cb1c33d95637da78af9ea7b4d6a5`  
		...
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a804a567e2370f79e9cbb55a558e15aa9bdcbf74c7b4cbf8dfe271c45341db2c`  
		Last Modified: Wed, 13 Jan 2021 00:05:40 GMT  
		Size: 48.4 MB (48419628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbe5f8a5fbdba4df33f941192b7a77ef0d9d15f1bd05df5baafd2e93040fb50d`  
		Last Modified: Wed, 13 Jan 2021 00:05:26 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7db76a438b1bbac9b101cfc52314cc946d6eca52bd1c99baefcef8d8f15de9b`  
		Last Modified: Wed, 13 Jan 2021 00:05:25 GMT  
		Size: 1.1 KB (1077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:bb3c8632b742e5b2df7434365e5b5fb8e36948677c118f0017e4a63d8dbe9064
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.3 MB (222346295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d6acdbff773fc08b145e4f9a993603ab101c67c351b2531bf9a1cb6d97cbefe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 07 Jan 2021 20:11:35 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 07 Jan 2021 20:11:36 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 07 Jan 2021 20:11:52 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 07 Jan 2021 20:11:56 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Thu, 07 Jan 2021 20:11:58 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Thu, 07 Jan 2021 20:11:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 07 Jan 2021 20:12:00 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4a3714680ef19b635304e5bd15fce33e2dc6ad88c8e951b65dcf2f61db44b8c1`  
		...
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c77a343c74fee620c62d8e4f05702d84b9ff7daa37408ef9898993214f91b8c4`  
		Last Modified: Thu, 07 Jan 2021 20:15:44 GMT  
		Size: 48.4 MB (48419636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a83298f8008569229a6cd507e93808709ced56a4571effa9ef994d4ca1c99b7c`  
		Last Modified: Thu, 07 Jan 2021 20:15:34 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:299522cbfae23b45cb926ba5a1083da1c948fb68f082a4ebd20319243a6a85df`  
		Last Modified: Thu, 07 Jan 2021 20:15:34 GMT  
...
```console
$ docker pull friendica@sha256:8ca940b77ee05ca0f82f755cb335bf0e8a5ca61a4438c81964b1d07bf0d44b05
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.9 MB (238918548 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cca14dfd9cbd1a2f6b892fd27a231a227ebf0f666c6716558cf6ff1545f69a9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 12 Jan 2021 19:41:42 GMT
ENV FRIENDICA_VERSION=2021.01
# Tue, 12 Jan 2021 19:41:42 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 12 Jan 2021 19:41:54 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 12 Jan 2021 19:41:55 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Tue, 12 Jan 2021 19:41:55 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 12 Jan 2021 19:41:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Jan 2021 19:41:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:26a086ef98745e82434b1e4f15adcfce1e6ab177bd38e314b0a4dbef34b8a768`  
		...
		Size: 541.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97499a6c2f258de84cacd94ea6749f98c14242548c582648351c77557f83bdb0`  
		Last Modified: Tue, 12 Jan 2021 19:44:13 GMT  
		Size: 48.4 MB (48419523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:192b6e0888ec8ba7bc0194bf694a3d5cf3b0c5042b81bfeb550b0e2bde416819`  
		Last Modified: Tue, 12 Jan 2021 19:43:59 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9a49d4163f25960c09301da11be86d2e4f2be0b467fcd9859ce608244a62148`  
		Last Modified: Tue, 12 Jan 2021 19:44:00 GMT  
...
```console
$ docker pull friendica@sha256:e0bf4fa04d498dd9c3b206b4a1b62dcc98c78aac189e82659ee4a15618f68975
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **213.0 MB (213047766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7c362f5210a4b5f6aaf8715fd90f9582ba30f5133145b80665df91b6e2abbc0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 12 Jan 2021 17:29:28 GMT
ENV FRIENDICA_VERSION=2021.01
# Tue, 12 Jan 2021 17:29:28 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 12 Jan 2021 17:29:53 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 12 Jan 2021 17:29:55 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
...
-	Layers:
	...
	-	`sha256:ef411e080eb382e46df56b76f1c2bb357d8d58dccf0c5348a35a8f7239d03c9e`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8141ffebda45df517316678a1c8a7c8b25315d625948c02ca9a4be0ed74893c2`  
		Last Modified: Tue, 12 Jan 2021 17:33:30 GMT  
		Size: 48.4 MB (48419531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a11e3d02e57e59a441f7dc9cd4a6720b1ab0e64fa7ffd7106044652ee52f5916`  
		Last Modified: Tue, 12 Jan 2021 17:33:02 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f65f8a95c65db3e162e9ad956792ab8f7e694de7763e4aff75d1c084aedbcc91`  
		Last Modified: Tue, 12 Jan 2021 17:33:00 GMT  
		Size: 1.1 KB (1077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
