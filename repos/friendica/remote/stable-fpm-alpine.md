...
```console
$ docker pull friendica@sha256:2bd8a2056c992dc9484b4bc0d523aa47bcff8cb6cb0604db5d8b602a4dff34fc
```
...
```console
$ docker pull friendica@sha256:314b74314992791be32e923ef66e3532daf2a02c2a1dac43565d7fc0659e6b97
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.1 MB (105069433 bytes)**  
...
-	Layers:
	...
	-	`sha256:e209d10d0e33569de8f692cb3c979fee9191b096de10984d040860ed819447a7`  
		...
		Size: 647.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40a699086efbc33dbb1647b412b4eac6613a9198ee6f821fa4a6e8535ba6a209`  
		Last Modified: Fri, 21 Jun 2024 03:48:52 GMT  
		Size: 54.5 MB (54526843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad2f5b618ed1470849662fa5e7d04a3fbeb43410fc5a028ac19ccd33165a0032`  
		Last Modified: Fri, 21 Jun 2024 03:48:46 GMT  
		Size: 3.2 KB (3179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3be5bcbde8b305e713877acd382a7b9bf23ceca4eca3e18ee3d68e5d654b576f`  
		Last Modified: Fri, 21 Jun 2024 03:48:46 GMT  
		Size: 923.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:65159ca72459080b9dab04f811f30706644437dbecfd0806ede7f2003d1e8222
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.8 MB (105815794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60a11f9781500fc2d5ee4864eb4abae8c344fb2dbd6518912246b547ba5ecce0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 21 Jun 2024 02:54:33 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 21 Jun 2024 03:08:31 GMT
ENV FRIENDICA_VERSION=2024.03
# Fri, 21 Jun 2024 03:08:31 GMT
ENV FRIENDICA_ADDONS=2024.03
# Fri, 21 Jun 2024 03:08:31 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=ea1f1a674b2859a6b6d3ca86b2574fe8f24c38f2bb41224f98eb891126722b1b
# Fri, 21 Jun 2024 03:08:32 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=865f60ffa100574a6bfdd6b3764c96e0d60d0a725b178a331a3cb55ef7e15268
# Fri, 21 Jun 2024 03:08:48 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;             export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apk del .fetch-deps
# Fri, 21 Jun 2024 03:08:49 GMT
COPY multi:f37e2d4be7c850ea45f9f42938fd91e4d01d972686dd3ed0bb53483688609d43 in / 
# Fri, 21 Jun 2024 03:08:49 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 21 Jun 2024 03:08:49 GMT
...
-	Layers:
	...
	-	`sha256:be93bd9924561c7306526c8098a46c98c190835bfd194fbdac03f0c928c46e62`  
		...
		Size: 646.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1be4f1ff2c7a8b0d8d1158ee1af912cc728062c5e8c7a0d564484e0838d8c09b`  
		Last Modified: Fri, 21 Jun 2024 03:09:36 GMT  
		Size: 54.5 MB (54526952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19064885aef3b19634d95e1bdeedd4f8b77c030b6d4458c28c627f017651c40a`  
		Last Modified: Fri, 21 Jun 2024 03:09:31 GMT  
		Size: 3.2 KB (3180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71a5c5f264ef9d3f99c8d219348c3945d7e53e13d0b5883672430bd522de3b53`  
		Last Modified: Fri, 21 Jun 2024 03:09:32 GMT  
		Size: 926.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:b4e0fe6ea94249f30126837daff0edd7efd421540c369b61dd1d8366ca1698a3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.1 MB (105086778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46f963fcb8a1046110ba03750188af734a6e8a9247f7506a6cdf44176c8dd3db`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 21 Jun 2024 02:32:43 GMT
ENV FRIENDICA_VERSION=2024.03
# Fri, 21 Jun 2024 02:32:43 GMT
ENV FRIENDICA_ADDONS=2024.03
# Fri, 21 Jun 2024 02:32:43 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=ea1f1a674b2859a6b6d3ca86b2574fe8f24c38f2bb41224f98eb891126722b1b
# Fri, 21 Jun 2024 02:32:44 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=865f60ffa100574a6bfdd6b3764c96e0d60d0a725b178a331a3cb55ef7e15268
# Fri, 21 Jun 2024 02:32:58 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;             export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apk del .fetch-deps
# Fri, 21 Jun 2024 02:33:00 GMT
COPY multi:f37e2d4be7c850ea45f9f42938fd91e4d01d972686dd3ed0bb53483688609d43 in / 
# Fri, 21 Jun 2024 02:33:00 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 21 Jun 2024 02:33:00 GMT
...
-	Layers:
	...
	-	`sha256:311fac7870f6dcaa667f601ff75e28d02e6768c1d1afd9397a3e2066c71f1b41`  
		...
		Size: 647.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c767f27f6894c7a8f0a77bf525a78fd0d10e4e2c334247fa0a8c775605c066b`  
		Last Modified: Fri, 21 Jun 2024 02:34:06 GMT  
		Size: 54.5 MB (54526763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a4b5e51af8c885af376fbd1bd70566e275e811927065c751b009906174777d8`  
		Last Modified: Fri, 21 Jun 2024 02:34:01 GMT  
		Size: 3.2 KB (3180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c83da530f56c37c26d626a0bf0abac00cbc6c8d43e9fa4fd3327df762b8756d8`  
		Last Modified: Fri, 21 Jun 2024 02:34:01 GMT  
		Size: 924.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
