...
```console
$ docker pull friendica@sha256:c4983fcae32b923e870cf0cb4b7f3d6e49a68be7738edc6716718d5e82ec81aa
```
...
### `friendica:2024.03-rc-apache` - linux; amd64
...
### `friendica:2024.03-rc-apache` - linux; arm variant v5
...
### `friendica:2024.03-rc-apache` - linux; arm variant v7
...
### `friendica:2024.03-rc-apache` - linux; arm64 variant v8
...
### `friendica:2024.03-rc-apache` - linux; 386
...
### `friendica:2024.03-rc-apache` - linux; ppc64le
...
### `friendica:2024.03-rc-apache` - linux; s390x
