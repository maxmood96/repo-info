...
```console
$ docker pull friendica@sha256:ef292da8eff23417cb8ed1e9c37850b4f6011951252b2ffbe9a08a1b92ecd0c4
```
...
```console
$ docker pull friendica@sha256:852862e3af338fc5311eaa5c6f9271bfcfc59bf5d4038f14e787590ac894de99
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190562107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f75e9c388717806dedf4174b08e697539c30406ddfbe16d4527a696fafc3a8d5`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Wed, 31 Mar 2021 15:50:00 GMT
ENV FRIENDICA_VERSION=2021.03-dev
# Wed, 31 Mar 2021 15:50:00 GMT
ENV FRIENDICA_ADDONS=2021.03-dev
# Wed, 31 Mar 2021 15:50:01 GMT
COPY multi:b20e37902564ea2dd022293f7b41911842ada0268aa69dff8006238a11a5b5e0 in / 
# Wed, 31 Mar 2021 15:50:01 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Wed, 31 Mar 2021 15:50:01 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Wed, 31 Mar 2021 15:50:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2233df86ca86d5292e3ccb6937c16415e01cee94e9e369ed972cced06afd9a8c`  
		...
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e8d1248fd72edeb75ddb6ccc8c0fd06ffebfb9948ea7ccc9f167760b8f9f3fb`  
		Last Modified: Wed, 31 Mar 2021 15:54:12 GMT  
		Size: 3.3 KB (3261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:642d07da4d81802ad1c19f4be2a42795596fcfbd39812124800d74affd142290`  
		Last Modified: Wed, 31 Mar 2021 15:54:12 GMT  
		Size: 1.2 KB (1153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
