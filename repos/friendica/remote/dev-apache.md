...
```console
$ docker pull friendica@sha256:b0248ad12d5f2a066d996879162f37096ff13fca23450e2f363b5c2f68b5bf8d
```
...
```console
$ docker pull friendica@sha256:a47be21929a9c447322c453fafca178356824db79acc43b27b97e1d71f47975b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.7 MB (220685072 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22bccd7fa935618d0db87c38ed4232322c94560ef5cc4011305615dfa0cab499`
...
# Fri, 30 Aug 2024 23:09:03 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Fri, 30 Aug 2024 23:09:04 GMT
ENV GOSU_VERSION=1.14
# Fri, 30 Aug 2024 23:09:14 GMT
...
-	Layers:
	...
	-	`sha256:089665f314ea254e689ad796b4af8d5ae11bfc799450b4b9df1b91721b103470`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7163e7db7ddc8bb6292a1846582c526f29e8ae9b66bd48f349549f6eea8ce40`  
		Last Modified: Fri, 30 Aug 2024 23:19:16 GMT  
		Size: 18.3 MB (18281024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13d6f16fde3c7d7e9880d881e09c6d2f83749d0f5cfc358ee54dbf07003bb506`  
		Last Modified: Fri, 30 Aug 2024 23:19:15 GMT  
		Size: 1.3 MB (1288052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2692241e9b67eb449855092b33d05325f2f3e2ebc8057ac00d57394d4e6210a8`  
		Last Modified: Fri, 30 Aug 2024 23:19:15 GMT  
		Size: 5.0 MB (5037161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df5a42d9ba10249b7fc467332583d850df059d6ad61042da8e18d76f089b902`  
		Last Modified: Fri, 30 Aug 2024 23:19:12 GMT  
		Size: 650.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b667edf2998027f5acda0a148f2d90cc993082d188fc24daad2b8973222457f`  
		Last Modified: Fri, 30 Aug 2024 23:19:12 GMT  
		Size: 539.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9af278d9290882dcc6305d2fc00044bc8b08cb48483d5aedccc264870e230ac5`  
		Last Modified: Fri, 30 Aug 2024 23:19:14 GMT  
		Size: 18.4 MB (18402176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ddcf87fb2f05622b450d082304ee307609799caf9b3c510425c9807dedbb216`  
		Last Modified: Fri, 30 Aug 2024 23:19:12 GMT  
		Size: 3.8 KB (3818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e42f1c553944615b504edcceb46f4fd9cbf049d9fd8acaeda224116aab7afea2`  
		Last Modified: Fri, 30 Aug 2024 23:19:12 GMT  
		Size: 925.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:704822a459dd03b6e4bcd7c9596e029daec0ca0e776301a145b0a7869060b474
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.8 MB (183821296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32f0cda92d53e4d6f0319da9ef1e27aad75ebe79525835b1a3c063045538fa2a`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Aug 2024 21:06:14 GMT
CMD ["apache2-foreground"]
# Fri, 30 Aug 2024 23:14:17 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Fri, 30 Aug 2024 23:14:17 GMT
ENV GOSU_VERSION=1.14
# Fri, 30 Aug 2024 23:14:28 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Fri, 30 Aug 2024 23:17:05 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.23;     pecl install memcached-3.2.0RC2;     pecl install redis-6.0.2;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Aug 2024 23:17:05 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 30 Aug 2024 23:17:05 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 30 Aug 2024 23:17:06 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;     ln -s /usr/local/etc/php/php.ini-production /usr/local/etc/php/php.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Aug 2024 23:17:06 GMT
VOLUME [/var/www/html]
# Fri, 30 Aug 2024 23:17:07 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 30 Aug 2024 23:17:07 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 30 Aug 2024 23:17:07 GMT
...
-	Layers:
	...
	-	`sha256:0a2c10c83517e6cea6d559728acb03ae510b4180dd37cac8b6e79d26cb4c25e7`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25205eaf832148b479de75ac0b4696d5786f8b4a0c149b3a20b12580a9baa6a4`  
		Last Modified: Fri, 30 Aug 2024 23:23:43 GMT  
		Size: 17.9 MB (17915990 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f963c4fd25088402cd50b0d78e908327d2752623060199783edb2b627c22d69f`  
		Last Modified: Fri, 30 Aug 2024 23:23:42 GMT  
		Size: 1.2 MB (1242408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:878711f13aed76052c4b0bf20fa68fbe8abe21f6a34491d36267e74d5374d861`  
		Last Modified: Fri, 30 Aug 2024 23:23:41 GMT  
		Size: 4.5 MB (4462053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b49f184db223062815b35130ecca285b3411f7a1969c638ff1a9263c3db39f63`  
		Last Modified: Fri, 30 Aug 2024 23:23:39 GMT  
		Size: 654.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e5cd9caa3fe3cc93b72865d07a994e5c96320f97a708e6ba30a8d9aaaab0853`  
		Last Modified: Fri, 30 Aug 2024 23:23:39 GMT  
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7153ed8b996166be9392a9136d2ca432fa14f6fb57514f2ee40cbc262b8bd130`  
		Last Modified: Fri, 30 Aug 2024 23:23:40 GMT  
		Size: 18.0 MB (17967632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:134c0d78b1e8585ba84a34d45014d20b2ea40cd96488c86b827d6569f56ad766`  
		Last Modified: Fri, 30 Aug 2024 23:23:39 GMT  
		Size: 3.8 KB (3815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ddfb799e5d4f1652dab1698031f4805fe114cb4ae66a0e7732fc9e29b9003b9`  
		Last Modified: Fri, 30 Aug 2024 23:23:39 GMT  
		Size: 922.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:aea0cf36556cb778ce6850c608a38b2534bd9a0b6eaa2a2574e4b124e6048d40
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.7 MB (220652091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a4e2389b85f7c875cf631d7976eaf29fafbdb997e1b4a93d4c8178a5fbba7a7`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Aug 2024 21:55:06 GMT
CMD ["apache2-foreground"]
# Fri, 30 Aug 2024 23:43:12 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Fri, 30 Aug 2024 23:43:12 GMT
ENV GOSU_VERSION=1.14
# Fri, 30 Aug 2024 23:43:24 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Fri, 30 Aug 2024 23:46:54 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.23;     pecl install memcached-3.2.0RC2;     pecl install redis-6.0.2;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Aug 2024 23:46:54 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 30 Aug 2024 23:46:55 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 30 Aug 2024 23:46:55 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;     ln -s /usr/local/etc/php/php.ini-production /usr/local/etc/php/php.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Aug 2024 23:46:55 GMT
VOLUME [/var/www/html]
# Fri, 30 Aug 2024 23:46:56 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 30 Aug 2024 23:46:56 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 30 Aug 2024 23:46:56 GMT
...
# Fri, 30 Aug 2024 23:46:56 GMT
ENV FRIENDICA_ADDONS=2024.09-dev
# Fri, 30 Aug 2024 23:47:03 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 30 Aug 2024 23:47:03 GMT
COPY multi:25ccf1ddc0e0285a533455c8e856fafdfe193ac37a4c3c06069260e518fe72d7 in / 
# Fri, 30 Aug 2024 23:47:04 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 30 Aug 2024 23:47:04 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 30 Aug 2024 23:47:04 GMT
...
-	Layers:
	...
	-	`sha256:16b5421edd630113a9a3e814e98610f750cd99e567b89e2f38e334a505319502`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2fafa86d22bfa248c6caf55898477f8b2cc8c284614260c9a00a6a5e8172649`  
		Last Modified: Fri, 30 Aug 2024 23:54:53 GMT  
		Size: 18.8 MB (18787802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40c9284ab439e1ff6b8382c193cd4c54ae9d39c8f83044a1b5ec23ba9e92b0b8`  
		Last Modified: Fri, 30 Aug 2024 23:54:51 GMT  
		Size: 1.3 MB (1256147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7119caeabf0364abac48de8df0453c99bc058a22f8e01f205ecf11a4f34766ea`  
		Last Modified: Fri, 30 Aug 2024 23:54:51 GMT  
		Size: 4.9 MB (4924509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b05e6aa834d6e6de2d6340a2b09ed6fad1e6c81b10cc0f679d08b1166f745e5`  
		Last Modified: Fri, 30 Aug 2024 23:54:48 GMT  
		Size: 652.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18475c677eabc086b14a55251599b6ad7c41bb2bb993e6c7cbfeba1bb4be2a14`  
		Last Modified: Fri, 30 Aug 2024 23:54:48 GMT  
		Size: 539.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8960590ab5241b62e62d582e5aaced0d10899c96895faa9cf92efc59a8b5d227`  
		Last Modified: Fri, 30 Aug 2024 23:54:51 GMT  
		Size: 19.1 MB (19076469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b874d8edbe2ffe07477ab8191ea38f3cf278b69432c7b2fce974b28cfdb68c8d`  
		Last Modified: Fri, 30 Aug 2024 23:54:48 GMT  
		Size: 3.8 KB (3818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd83115315e74feb74c21627ead5272842c6a81e2950be8a1085ebbb994cdcf8`  
		Last Modified: Fri, 30 Aug 2024 23:54:48 GMT  
		Size: 921.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:d3bf4424d844481b49804603b1e846b62e3432fd57a0038c054f6444703ad911
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.4 MB (193403980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dec1253927e7410c1b07b6c65d137285299091a36b567b2d45606b6556a17975`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 31 Aug 2024 02:59:22 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Sat, 31 Aug 2024 02:59:26 GMT
ENV GOSU_VERSION=1.14
# Sat, 31 Aug 2024 03:00:16 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Sat, 31 Aug 2024 03:13:15 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.23;     pecl install memcached-3.2.0RC2;     pecl install redis-6.0.2;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 31 Aug 2024 03:13:20 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 31 Aug 2024 03:13:24 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 31 Aug 2024 03:13:30 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;     ln -s /usr/local/etc/php/php.ini-production /usr/local/etc/php/php.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Sat, 31 Aug 2024 03:13:34 GMT
VOLUME [/var/www/html]
# Sat, 31 Aug 2024 03:13:41 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Sat, 31 Aug 2024 03:13:45 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sat, 31 Aug 2024 03:13:50 GMT
ENV FRIENDICA_VERSION=2024.09-dev
# Sat, 31 Aug 2024 03:13:54 GMT
ENV FRIENDICA_ADDONS=2024.09-dev
# Sat, 31 Aug 2024 03:14:26 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Sat, 31 Aug 2024 03:14:31 GMT
COPY multi:25ccf1ddc0e0285a533455c8e856fafdfe193ac37a4c3c06069260e518fe72d7 in / 
# Sat, 31 Aug 2024 03:14:35 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sat, 31 Aug 2024 03:14:39 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Sat, 31 Aug 2024 03:14:43 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:96e84d076927aaf13a492fc6f865ffb40b2bbb33b9a63a8e426218e9d08cc712`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98466cbc1f9cbe8f944efe5f3900f1e0f5c5a488ee0c9bade9aa15c024fd614a`  
		Last Modified: Sat, 31 Aug 2024 03:31:18 GMT  
		Size: 17.6 MB (17567088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f90be26a0274266a462ca1d498adacb48e031ec2a852f835b0bdfcbfe9cd8e7`  
		Last Modified: Sat, 31 Aug 2024 03:31:11 GMT  
		Size: 950.7 KB (950721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b1524cd2a7759668faa99cd7b0b7e2de3fe78b3ac5a7dd194b9dd8e22006640`  
		Last Modified: Sat, 31 Aug 2024 03:31:13 GMT  
		Size: 4.6 MB (4559178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:082ee05022cebf05d13381a2fd22d8519af875c0afee5d84d17e1ee7dfdd19fc`  
		Last Modified: Sat, 31 Aug 2024 03:31:07 GMT  
		Size: 656.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5120be978e838a4faa0a0cbd78d354f3787cba5da5726a15df3e01c24a39b81f`  
		Last Modified: Sat, 31 Aug 2024 03:31:07 GMT  
		Size: 561.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f388671e5b7dd2cc7c0637a6b67d6412fbcc56cf27999d94fb5fc4598beb0b5e`  
		Last Modified: Sat, 31 Aug 2024 03:31:18 GMT  
		Size: 17.7 MB (17719929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7eb8fefc27c8620c9303c5577c9364986d1233defc161d212fbed29b82c5a43`  
		Last Modified: Sat, 31 Aug 2024 03:31:07 GMT  
		Size: 3.8 KB (3817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d712c111f8d5c00305645b7d9ca1b9ac0d4eaceb0f15e866c4a0fa1962228051`  
		Last Modified: Sat, 31 Aug 2024 03:31:07 GMT  
		Size: 927.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:65942810a5fb87e03ff0cfe0e8d74b76a8517b5c04366fd15a4a6fd7b033699a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.3 MB (225280121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa889e7fe202547cff6044489eea7ac411a210f240ebde017c92d3bb154192ac`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Aug 2024 20:54:47 GMT
CMD ["apache2-foreground"]
# Fri, 30 Aug 2024 23:53:14 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Fri, 30 Aug 2024 23:53:14 GMT
ENV GOSU_VERSION=1.14
# Fri, 30 Aug 2024 23:53:35 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Fri, 30 Aug 2024 23:58:07 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         zlib1g-dev         libssl-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp         intl     ;         pecl install apcu-5.1.23;     pecl install memcached-3.2.0RC2;     pecl install redis-6.0.2;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Aug 2024 23:58:07 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 30 Aug 2024 23:58:08 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 30 Aug 2024 23:58:09 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;     ln -s /usr/local/etc/php/php.ini-production /usr/local/etc/php/php.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Aug 2024 23:58:10 GMT
VOLUME [/var/www/html]
# Fri, 30 Aug 2024 23:58:11 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
...
# Fri, 30 Aug 2024 23:58:12 GMT
ENV FRIENDICA_ADDONS=2024.09-dev
# Fri, 30 Aug 2024 23:58:23 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 30 Aug 2024 23:58:24 GMT
COPY multi:25ccf1ddc0e0285a533455c8e856fafdfe193ac37a4c3c06069260e518fe72d7 in / 
# Fri, 30 Aug 2024 23:58:24 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 30 Aug 2024 23:58:25 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 30 Aug 2024 23:58:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a3bcb4bd064f4a2d356e5cd224ad8eed8ddbb8682e55b3a55a1d2dcfa5a43953`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ca8e1db3931c787bbd448e49b2ab03baf8f1da7749d715e1e7e0792594a4b03`  
		Last Modified: Sat, 31 Aug 2024 00:07:23 GMT  
		Size: 18.4 MB (18360856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04cf23ec07f94efaee3337acea0afb2875b585fa966fd48d2f1173cea56a3918`  
		Last Modified: Sat, 31 Aug 2024 00:07:22 GMT  
		Size: 1.2 MB (1186533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8fb07d52da4b57efd882a0154697240ba5d784bd82f30d072bd9efb9e73490e`  
		Last Modified: Sat, 31 Aug 2024 00:07:22 GMT  
		Size: 4.8 MB (4803508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5471c0ca4493f2512d0036eb5a3f4aa559560cf8585c07337b3738960253f6dd`  
		Last Modified: Sat, 31 Aug 2024 00:07:19 GMT  
		Size: 650.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85df85b6be329555a5e4b473fff1223c7c2f8ce7f9d7c874ad918a8a9396f0d9`  
		Last Modified: Sat, 31 Aug 2024 00:07:19 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e56a0985c694d5e540c4492a3672bc3604e26a41a7b77493b8d964a6cd4db71`  
		Last Modified: Sat, 31 Aug 2024 00:07:21 GMT  
		Size: 18.7 MB (18687426 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:234c2d49e5fb14aca4d12160aff6bd94976401839aa95fd4b31581530b2fbf83`  
		Last Modified: Sat, 31 Aug 2024 00:07:19 GMT  
		Size: 3.8 KB (3818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c3b21813ee6a0a6bc64937fff3192e9eb4aa301a2e2909a2aa0f91369ee52b8`  
		Last Modified: Sat, 31 Aug 2024 00:07:19 GMT  
		Size: 924.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
