...
```console
$ docker pull friendica@sha256:ae6f4eb88bfb745b9d892ff43b53dfc7a80364b2ed005bb3890dd5ce2eab780f
```
...
```console
$ docker pull friendica@sha256:1756baa6265c27fff0b7b3c4e98575191da248e0439d54ddd5c1f4370f3958f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190487404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1333c217d188d3c38ed793efd7e71e58941f46c8ea3d6dd98c5672290ea890be`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Thu, 21 Apr 2022 17:36:17 GMT
ENV FRIENDICA_VERSION=2022.05-dev
# Thu, 21 Apr 2022 17:36:17 GMT
ENV FRIENDICA_ADDONS=2022.05-dev
# Thu, 21 Apr 2022 17:36:33 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 21 Apr 2022 17:36:34 GMT
COPY multi:505a567dd8f292b590b99a423591dc3d4e2e3b8210cca89d51e9b207c9128e37 in / 
# Thu, 21 Apr 2022 17:36:35 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Thu, 21 Apr 2022 17:36:35 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 21 Apr 2022 17:36:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e73bd5c20b4bc23972d7ee5ee51541cd4c42cec2fb9b2a28741dfee689788c09`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8a43a610ef1c37516e8ef5fae9be3ce2afe815f79d276bd12c0eb961fd8cd24`  
		Last Modified: Thu, 21 Apr 2022 17:47:30 GMT  
		Size: 16.8 MB (16774789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa252af7f0d0d7c1239dd66e62335eb421eddc330f1e742b62a3b0b69a3e61a0`  
		Last Modified: Thu, 21 Apr 2022 17:47:23 GMT  
		Size: 3.6 KB (3588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c77aabe6034c0a547e9064d0ba30c9503a0f4e452ecadd9fe12a15281e5a0b57`  
		Last Modified: Thu, 21 Apr 2022 17:47:23 GMT  
		Size: 949.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:1bfd7f1f23214d6f8acf2e45474570ef836c7f37abc0a4b369ab744907bcefba
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181575903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a51caaa53283fe750858751b8524495d4c116c24e6ce4bcd9c40da804af6be65`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Fri, 22 Apr 2022 15:51:27 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.21;     pecl install memcached-3.2.0RC1;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 15:51:28 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 22 Apr 2022 15:51:28 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 22 Apr 2022 15:51:29 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 22 Apr 2022 15:51:30 GMT
VOLUME [/var/www/html]
# Fri, 22 Apr 2022 15:51:32 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 22 Apr 2022 15:51:32 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 16:04:35 GMT
ENV FRIENDICA_VERSION=2022.05-dev
# Fri, 22 Apr 2022 16:04:35 GMT
ENV FRIENDICA_ADDONS=2022.05-dev
# Fri, 22 Apr 2022 16:04:48 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 22 Apr 2022 16:04:49 GMT
COPY multi:505a567dd8f292b590b99a423591dc3d4e2e3b8210cca89d51e9b207c9128e37 in / 
# Fri, 22 Apr 2022 16:04:50 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 22 Apr 2022 16:04:51 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 22 Apr 2022 16:04:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1466482f5d9d3032dc53e4bb4cf521bcd99fc841efb52e762cf3c870e24e620c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06b58a41a41d6128f7f367e3426acc1c136032340b5553a696295e6a6e6a023a`  
		Last Modified: Fri, 22 Apr 2022 16:07:45 GMT  
		Size: 14.6 MB (14584596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5809baca8ecc7f1bdae819ca3544848f1f42c743c05b5265653b4b40872e53b0`  
		Last Modified: Fri, 22 Apr 2022 16:07:35 GMT  
		Size: 644.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80b651a067e1433d1bdd99f6736eb204be2a26b180c711bfd7005cc52c113be4`  
		Last Modified: Fri, 22 Apr 2022 16:07:35 GMT  
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dac83abbcbcc4ad2181d88a640e4d74f75958cf69ea4abbcd3db1d95e4c1cdb0`  
		Last Modified: Fri, 22 Apr 2022 16:11:53 GMT  
		Size: 16.7 MB (16666913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928cc7804a6bec1e3e3c33bf1e3d8983a3b104f30405d4210240dd09eb781ecc`  
		Last Modified: Fri, 22 Apr 2022 16:11:47 GMT  
		Size: 3.6 KB (3587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7582d9612a6fa487ae4c0d82fdb16a24aec6c15cf7b8ffbd06b33b65d94d50f`  
		Last Modified: Fri, 22 Apr 2022 16:11:47 GMT  
		Size: 949.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:0c87b7701468e18970ef2c2013cd7dc3f75a18bdefb42d13e69dba3ff3240842
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188299858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9c5ea017488dc8f8ea00d3a47ad26ac080624978bcfe4e5990ea8f3a3746e30`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 10:36:38 GMT
ENV FRIENDICA_VERSION=2022.05-dev
# Fri, 22 Apr 2022 10:36:42 GMT
ENV FRIENDICA_ADDONS=2022.05-dev
# Fri, 22 Apr 2022 10:37:14 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 22 Apr 2022 10:37:19 GMT
COPY multi:505a567dd8f292b590b99a423591dc3d4e2e3b8210cca89d51e9b207c9128e37 in / 
# Fri, 22 Apr 2022 10:37:22 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 22 Apr 2022 10:37:26 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 22 Apr 2022 10:37:30 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b3fe48a4000c43a70ed875d22a8a1f6ad6061709f4001b21346b6d9b970ea13d`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:712a0e819a024f115cfb41cbb8c268d689b25e00f80e18cec352c03dc84b6d69`  
		Last Modified: Fri, 22 Apr 2022 10:43:14 GMT  
		Size: 16.3 MB (16320219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43b875e759f6f0022cadabe9b32eec7e1a5d69afd56ccf8d1fd4f8d893bff53a`  
		Last Modified: Fri, 22 Apr 2022 10:43:07 GMT  
		Size: 3.6 KB (3587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4a2347517610d8f706e44775d706d48cc398f74ab650df98e1d1ca1aa761eee`  
		Last Modified: Fri, 22 Apr 2022 10:43:07 GMT  
		Size: 926.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:b69274c8b114394018673aeba7ecb2d04f24740e9593d67fa3c5ffb6f55e90dc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.3 MB (215252861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80cd025318cb2e844f92dd2318cff772eff42644648a4fd11f246537ee7a2052`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 01:31:11 GMT
ENV FRIENDICA_VERSION=2022.05-dev
# Fri, 22 Apr 2022 01:31:16 GMT
ENV FRIENDICA_ADDONS=2022.05-dev
# Fri, 22 Apr 2022 01:32:00 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 22 Apr 2022 01:32:04 GMT
COPY multi:505a567dd8f292b590b99a423591dc3d4e2e3b8210cca89d51e9b207c9128e37 in / 
# Fri, 22 Apr 2022 01:32:05 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 22 Apr 2022 01:32:08 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 22 Apr 2022 01:32:10 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:dbc1d9598cd44ce7e10aea345f279adabebdfd4770969fc06ca731edff9d3d98`  
		...
		Size: 551.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32734b068c7a61d47b54facbc29b21c0116dc9b524f06ac65a178e77dd7e855d`  
		Last Modified: Fri, 22 Apr 2022 01:37:40 GMT  
		Size: 17.3 MB (17310031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54a3d7ab5dee43dd9448a26783130dd9f1890604376c203490e0d7b800e7b7a7`  
		Last Modified: Fri, 22 Apr 2022 01:37:38 GMT  
		Size: 3.6 KB (3587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98d17a225d6ea42e43fef0e34be26f34a61524e7e6caea2d00ec3fc920962f8b`  
		Last Modified: Fri, 22 Apr 2022 01:37:38 GMT  
		Size: 950.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
