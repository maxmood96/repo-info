...
```console
$ docker pull friendica@sha256:f5a9828bf2588270b70ff18e4d2568c6ebbebc334b5654f897f6b9bb4037b245
```
...
```console
$ docker pull friendica@sha256:a99ea5d0b6f0e7fdeda3cbd6e955b774d9980a2b19f09fd1470934a01bf2c543
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183236442 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ffd0d2448a81e5af328d5cccc78c3132b1e538b854f78a08c973d1421d7f175`
...
-	Layers:
	...
	-	`sha256:b8f85552b3fd7d37f6586ce04c5fe6cf6184ebf5860544b9548440e039783e80`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f92b0cef88c0f16c0854b9ee5b9a0bc1b1633af10be2ae8ca3e0758dcb9cdfc5`  
		Last Modified: Mon, 07 Dec 2020 19:28:33 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55ee033927cb322f55686c4c13c25fcc90b796f300b7352da225a634a8d17813`  
		Last Modified: Mon, 07 Dec 2020 19:28:33 GMT  
...
```console
$ docker pull friendica@sha256:b5902576348c5a7a49e229a943e3f51b4a95086009392a0f998425199d8ac20f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159526123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f241db7a63e074d99a316cc571857a3ca8adf02dc4bb6c955a7097e1bf11bd7`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 01 Dec 2020 03:28:39 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Tue, 01 Dec 2020 03:28:41 GMT
ENV TINI_VERSION=v0.19.0
# Tue, 01 Dec 2020 03:28:43 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Mon, 07 Dec 2020 19:53:35 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.19;     pecl install memcached-3.1.5;     pecl install redis-5.3.2;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Mon, 07 Dec 2020 19:53:37 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Mon, 07 Dec 2020 19:53:38 GMT
VOLUME [/var/www/html]
# Mon, 07 Dec 2020 19:53:40 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 07 Dec 2020 20:00:04 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Mon, 07 Dec 2020 20:00:05 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Mon, 07 Dec 2020 20:00:07 GMT
COPY multi:b20e37902564ea2dd022293f7b41911842ada0268aa69dff8006238a11a5b5e0 in / 
# Mon, 07 Dec 2020 20:00:09 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Mon, 07 Dec 2020 20:00:11 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Mon, 07 Dec 2020 20:00:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:36f549e6249d82711047916fac95373dc959fa1f598c75ccd44d0070113173f3`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e35736855b0367e937d03c2506d5272c839a482cf172ee6fbd2be348caef2235`  
		Last Modified: Tue, 01 Dec 2020 03:42:57 GMT  
		Size: 17.7 MB (17665810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7638d2e56ac4b9a5008f1308fd5f54d123e0eadd83f1f37ce7d5f8e95ddb632`  
		Last Modified: Tue, 01 Dec 2020 03:42:52 GMT  
		Size: 15.5 KB (15517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5183c76d3de1367aac9c32ed1e44054ebde06ba268ef5c6885eac18a9de91bb7`  
		Last Modified: Mon, 07 Dec 2020 20:01:36 GMT  
		Size: 14.6 MB (14613482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60206e328836a3350b24d83634ff575ab7eff61f188ae6fbc792722bd9313c61`  
		Last Modified: Mon, 07 Dec 2020 20:01:25 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:182df2c2366d1926d2c881e392b393dab444f8c97e60573024f42a8a74c2fc82`  
		Last Modified: Mon, 07 Dec 2020 20:01:25 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a95a9fff5a863ed9355337d9eea4c61f69c4b7e7864b7bb161eb593f7146aa3`  
		Last Modified: Mon, 07 Dec 2020 20:02:17 GMT  
		Size: 3.3 KB (3261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0f6dc433911adc7c76cddd3e79c3a50365ffd860fdc9734a9926c98df66f230`  
		Last Modified: Mon, 07 Dec 2020 20:02:17 GMT  
...
```console
$ docker pull friendica@sha256:798f4618663af41621e341cb0402fc4f381805faa24c07dcbdabe95ccaa7f030
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153398858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d633c1790ddd2f675fe0d315196593a2c49a30c906ec38c3c472534d7fcee51`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 01 Dec 2020 06:16:03 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 06:16:06 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 01 Dec 2020 06:16:06 GMT
VOLUME [/var/www/html]
# Tue, 01 Dec 2020 06:16:09 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Dec 2020 06:25:14 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 01 Dec 2020 06:25:15 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 01 Dec 2020 06:25:17 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 01 Dec 2020 06:25:18 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 01 Dec 2020 06:25:19 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
...
-	Layers:
	...
	-	`sha256:944b1cb4bdd0615a4c5b4ca9146236c51f642def545dc5698367171063cbc299`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fb46bbb12e9b1f44224803d32a73b036b792ca26b7a219222f00954995bb834`  
		Last Modified: Tue, 01 Dec 2020 06:26:14 GMT  
		Size: 12.9 MB (12868022 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73f56e77498b898002f23bb82827994afd296e41b6e80b70e50f7dd8f0ba1865`  
		Last Modified: Tue, 01 Dec 2020 06:26:08 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:156f100c9b27d0ea28ce33b46f537b40e6360aecc09087cb035451c6ae03171c`  
		Last Modified: Tue, 01 Dec 2020 06:26:08 GMT  
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56dfe83422c6c4580185e0e65c0df49b71cc8587640ef6174c0d919d9415b62c`  
		Last Modified: Tue, 01 Dec 2020 06:27:26 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f07de80a5d54630cf11e2599d3bf764c4af68c522860f8904390dee0fedf805f`  
		Last Modified: Tue, 01 Dec 2020 06:27:26 GMT  
...
```console
$ docker pull friendica@sha256:a8bb38938b93b418d08028116e70d1d16ce8a367de42eb70bc7605fa27d79519
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.9 MB (173922140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:157e0c95d335b03a361fc1c27ac637f59d859f76f41832562a94f937040d04b4`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 07 Dec 2020 19:53:15 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Mon, 07 Dec 2020 19:53:16 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Mon, 07 Dec 2020 19:53:18 GMT
COPY multi:b20e37902564ea2dd022293f7b41911842ada0268aa69dff8006238a11a5b5e0 in / 
# Mon, 07 Dec 2020 19:53:20 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Mon, 07 Dec 2020 19:53:21 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Mon, 07 Dec 2020 19:53:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:312617e539a5a66960ec53195cf597338af7945b611fb1c70924df1f3531aa0d`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5a524eb3d6ae8e2b97a984f3f15d1fb5c5fc97751a99e6711423bdd64c2b0c3`  
		Last Modified: Mon, 07 Dec 2020 19:56:11 GMT  
		Size: 3.3 KB (3261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0470357d883c12b0bbd7f2139ed782af7c535537054230ba807b928f5cd7b6b1`  
		Last Modified: Mon, 07 Dec 2020 19:56:11 GMT  
		Size: 1.1 KB (1091 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:345ee7a5d29f3626273ce646c64eb7eaceffda068667f194d55bc0f62e366826
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191337154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab16f330bb336916ee6fa769ee77bb7045a6ec67bec930a30b1646342ffdb8f8`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:596d979f67e639ff627304a315d2e03cefdf8a36da1eb8da1dfea8ea613effac`  
		...
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37a2b49cd2a0f62b050f286fb78a7e4fd84711dc930239438d2b68e40e9c27f3`  
		Last Modified: Mon, 07 Dec 2020 19:48:21 GMT  
		Size: 3.3 KB (3261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb9781a9c095c8bc8fa147fd6409d8c10d42e504cebcf96b2a73e2fa526eb144`  
		Last Modified: Mon, 07 Dec 2020 19:48:21 GMT  
...
```console
$ docker pull friendica@sha256:607f04acadf87d47da3f97a4c726df29173c199c1b26b57375c4bacd013f794c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.6 MB (164604529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48bc93bef408efc8060f9f2eab035d7486ea86336a11d47acd46cbc01e69b663`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 01 Dec 2020 06:16:31 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 06:16:33 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 01 Dec 2020 06:16:33 GMT
VOLUME [/var/www/html]
# Tue, 01 Dec 2020 06:16:35 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Dec 2020 06:25:02 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 01 Dec 2020 06:25:03 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 01 Dec 2020 06:25:04 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 01 Dec 2020 06:25:04 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 01 Dec 2020 06:25:05 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 01 Dec 2020 06:25:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:61d33fed201960e98aae1ce6c0d0012e23735e23336f53819f7dedeea381f16a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6adc27feb679937ca8ccdfd171facfcd9ae25ababf336f77964ea0769a8dd6`  
		Last Modified: Tue, 01 Dec 2020 06:25:45 GMT  
		Size: 13.7 MB (13696476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b769383471bb339fb6153fa9b5d27a782a5e75b9fad476019dd0c747653bfd25`  
		Last Modified: Tue, 01 Dec 2020 06:25:30 GMT  
		Size: 548.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bfdcacbf4e54d4b286d36e5c54fd442f7b4f554c063d6d1055868a5c46ea737`  
		Last Modified: Tue, 01 Dec 2020 06:25:30 GMT  
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17c529493754faa0a5b708e05370f514849510115045aa70c28460c89702498f`  
		Last Modified: Tue, 01 Dec 2020 06:27:22 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d18f75dd968de4260eb3ae3d63a22624863e360eb5b378283f2180ca174b53e9`  
		Last Modified: Tue, 01 Dec 2020 06:27:22 GMT  
...
```console
$ docker pull friendica@sha256:c8f71566cfc045a44033aefab1bb7276d0b73eeff0b0afcd7eed13676ac97257
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.3 MB (199338961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed267af55d5d605d1b64816315e790ab04546e997191aeabbbb205075474f55e`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 01 Dec 2020 06:36:25 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 06:36:39 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 01 Dec 2020 06:36:45 GMT
VOLUME [/var/www/html]
# Tue, 01 Dec 2020 06:37:01 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 01 Dec 2020 07:04:09 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 01 Dec 2020 07:04:14 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 01 Dec 2020 07:04:16 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 01 Dec 2020 07:04:17 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 01 Dec 2020 07:04:20 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 01 Dec 2020 07:04:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:411f5aa9a0f77445fe27e8b9fed9c3487cad3cb5d83a9990042f1fd7396e36a7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b89d78a45fbca0fca6bdcb1c93d49824d102cfa19d55efac4149b18fc30e1f67`  
		Last Modified: Tue, 01 Dec 2020 07:06:24 GMT  
		Size: 15.4 MB (15410453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65f9791e9a26c01a2ef0c0752cf6851c23a70b8297e9c318903e6f291da20354`  
		Last Modified: Tue, 01 Dec 2020 07:06:16 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ac3503a83a401a2f1a53e6c1dc0b8417b5bf3a10ea3051b127fcb5d816a6292`  
		Last Modified: Tue, 01 Dec 2020 07:06:16 GMT  
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:827607c48728c4932b4f7e6819587e4130179248666cce69773eb02baddb94e1`  
		Last Modified: Tue, 01 Dec 2020 07:07:57 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:311521c298929f25cefb07098e845adc838c4172b2e40debb753e1026824c3a2`  
		Last Modified: Tue, 01 Dec 2020 07:07:56 GMT  
		Size: 1.1 KB (1092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:8eaa833b586f53a71b7b9831c68905636c46270a8fb1dd6fd5f6e2d2d4aa5b24
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.5 MB (167468642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:837aede5516ed2184fefbfa7e590330b8e45246a0dd4e34c2f4a78ca1bc75504`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Mon, 07 Dec 2020 19:51:28 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Mon, 07 Dec 2020 19:51:29 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Mon, 07 Dec 2020 19:51:30 GMT
COPY multi:b20e37902564ea2dd022293f7b41911842ada0268aa69dff8006238a11a5b5e0 in / 
# Mon, 07 Dec 2020 19:51:30 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Mon, 07 Dec 2020 19:51:31 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Mon, 07 Dec 2020 19:51:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a3a263ef0ab91da5bf42979e802814e6d404fa26f068ef0db8e27380070bae08`  
		...
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ab725bf05e862b2cc5427fc6c63db8cad8d94986ddc57d7b3ac36d75e59e5a7`  
		Last Modified: Mon, 07 Dec 2020 19:53:22 GMT  
		Size: 3.3 KB (3261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd9e1906825c5ae73bceb90995c4f746a47cb725d702876fcc5edb631a4f4b12`  
		Last Modified: Mon, 07 Dec 2020 19:53:22 GMT  
