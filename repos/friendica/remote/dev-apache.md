...
```console
$ docker pull friendica@sha256:cbe6f6f81615ad9a4a40f332d6043998957e4451fcbc171ac5144a773bdc75db
```
...
```console
$ docker pull friendica@sha256:b54e3d6499df5ad0206503e5a71b72ace852099ebffa79a4569c48afc7108b12
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183200310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ab0a78084257def7117a12fb2890315219537e663af9ec9c1a95567a986e2c1`
...
-	Layers:
	...
	-	`sha256:a3e267fec438751feafae702a41d8f9308738fcefbb612b1f310d7d52cb56938`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:991e2c259f788bd2470b76eea7db250ab7b31986123617692d94f3c4b661f8ab`  
		Last Modified: Tue, 27 Oct 2020 02:03:16 GMT  
		Size: 19.0 MB (18955491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1ddacec344520baf364f56537d3ede3e0679873d5823a32445397115198ac7b`  
		Last Modified: Tue, 27 Oct 2020 02:03:10 GMT  
		Size: 16.1 KB (16102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93f19d8f1b0c54fbcbe9b648dfb958dfa0791738fca06c291735c789a884324b`  
		Last Modified: Tue, 27 Oct 2020 02:03:16 GMT  
		Size: 15.3 MB (15265164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3af83fdb542e4e322d01a16aaf1fc0b28de7a2abf459550da85707ca3bbca47`  
		Last Modified: Tue, 27 Oct 2020 02:03:09 GMT  
		Size: 551.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45090258fb16b6decef688c149085b4d884c56675facc0f4fc79badd46fbcb1d`  
		Last Modified: Tue, 27 Oct 2020 02:03:10 GMT  
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61a46b55422d2a6c224801b1bdfb66fa1b6d4a941a0312ea9754e44b07af17f3`  
		Last Modified: Tue, 27 Oct 2020 02:04:01 GMT  
		Size: 3.3 KB (3260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e023787ecb1fc3ebcddb456578b88dd66cfd38e8efeb45a147666e9718f146b1`  
		Last Modified: Tue, 27 Oct 2020 02:04:01 GMT  
...
```console
$ docker pull friendica@sha256:f183bb5af3067522df4ec07af7d0f4fe71be2475de40e01d19b6832e76a73826
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158778622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8022852110df876b989aa5b007ec865dac01564fabb372a991a5533a924a078e`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 29 Oct 2020 23:43:33 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Thu, 29 Oct 2020 23:43:33 GMT
ENV TINI_VERSION=v0.19.0
# Thu, 29 Oct 2020 23:43:36 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Thu, 29 Oct 2020 23:48:33 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 29 Oct 2020 23:48:36 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
...
ENV FRIENDICA_ADDONS=2020.12-dev
# Thu, 29 Oct 2020 23:55:25 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Thu, 29 Oct 2020 23:55:26 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Thu, 29 Oct 2020 23:55:27 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 29 Oct 2020 23:55:27 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:349789c3c40300d449be6b1d8377cc748c6444470e5ca30ce303038d9444b2f6`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bbcf43f0f7d9e02569d39caa829fe70b7079b2f00390bdb7d9f45514191c3d7`  
		Last Modified: Thu, 29 Oct 2020 23:56:03 GMT  
		Size: 17.7 MB (17665867 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcf6a51235ef8b8a26340126c52f4000af49f35a3a124d9c48cc94646045c02b`  
		Last Modified: Thu, 29 Oct 2020 23:55:57 GMT  
		Size: 15.5 KB (15518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ff0b2e649120050a3f0e3d4f00939e50a2e45eba9ceb6121d1757bb2854a147`  
		Last Modified: Thu, 29 Oct 2020 23:56:01 GMT  
		Size: 13.9 MB (13879452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:752662ffaba5d4c3d9e6f6eefa4b0e7f2f34580aab2ed31c087101f1734837f1`  
		Last Modified: Thu, 29 Oct 2020 23:55:56 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0bb210e1f24d9f3bb99854383f3eba34b7fba2b4a864e592230b6fb495682c8`  
		Last Modified: Thu, 29 Oct 2020 23:55:55 GMT  
		Size: 552.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:197cb1e59caa22e219b1a21ce356ca0f8953ad159d6a1dcda0ba3a0d09a8883f`  
		Last Modified: Thu, 29 Oct 2020 23:56:50 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9551a73245bbca261e8fcda6597c6c485f4395cefc1c51136e9f881e535c91e9`  
		Last Modified: Thu, 29 Oct 2020 23:56:50 GMT  
...
```console
$ docker pull friendica@sha256:92526eaa6e552ff392fe176859ff98988e5c00cfa929d7b2fab2bce6523024dd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153387608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b6698d604a6986d4c9e809000b924f83c8b82dff402d8dd1a2ea5019a901114`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 30 Oct 2020 00:38:46 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Fri, 30 Oct 2020 00:38:47 GMT
ENV TINI_VERSION=v0.19.0
# Fri, 30 Oct 2020 00:38:50 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Fri, 30 Oct 2020 00:43:54 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 00:43:58 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Oct 2020 00:43:59 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 00:44:02 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 30 Oct 2020 00:54:21 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Fri, 30 Oct 2020 00:54:22 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Fri, 30 Oct 2020 00:54:23 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Fri, 30 Oct 2020 00:54:24 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 30 Oct 2020 00:54:25 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 30 Oct 2020 00:54:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9f69cf825ad8aa93a5b4eea2d05dd00a91758bb9bf220c8b531c560651343a59`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86776cc33ca1e1399810f6df8a31c1f382d1dc2eb1b875b6093655018a0feddc`  
		Last Modified: Fri, 30 Oct 2020 00:55:13 GMT  
		Size: 16.0 MB (15957177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9353de11cc78ff1d3584b7560c258c00b54d7f010e2917fc48d21f341e4540c5`  
		Last Modified: Fri, 30 Oct 2020 00:55:10 GMT  
		Size: 14.8 KB (14755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38e80d2caf422a6d6a3637c689f1edb219532e76584dc8dfaf021c76e495573b`  
		Last Modified: Fri, 30 Oct 2020 00:55:13 GMT  
		Size: 12.9 MB (12868601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4558c4bcdf5e4042ba524e812f09c570385323a3543f6ff799d86c668c8fee48`  
		Last Modified: Fri, 30 Oct 2020 00:55:07 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce80f2d1e1cac3cb2f849301359a1c8d5dcf3745d5831c95514cb05245eaf574`  
		Last Modified: Fri, 30 Oct 2020 00:55:07 GMT  
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d45adee180f3cd17a0f9964ce288442a491976b7653f9a4f209449622d1b65e3`  
		Last Modified: Fri, 30 Oct 2020 00:56:29 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8039b3dc7966badab6be45f8e95afba6beeeb4c1d8b4ec27b3d9d65003aafca9`  
		Last Modified: Fri, 30 Oct 2020 00:56:29 GMT  
		Size: 1.1 KB (1091 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:263ea949d6a744beedaa190be6c4916814ef99e0e453332317223812a84f59a7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.9 MB (173896209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e153ee210e3c467436db6e90f3563b247e45913815cc10e6ee1b099a52d8ad01`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 30 Oct 2020 00:38:32 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Fri, 30 Oct 2020 00:38:33 GMT
ENV TINI_VERSION=v0.19.0
# Fri, 30 Oct 2020 00:38:38 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Fri, 30 Oct 2020 00:43:32 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 00:43:36 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Oct 2020 00:43:37 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 00:43:40 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 30 Oct 2020 00:54:24 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Fri, 30 Oct 2020 00:54:26 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Fri, 30 Oct 2020 00:54:27 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Fri, 30 Oct 2020 00:54:28 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 30 Oct 2020 00:54:29 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 30 Oct 2020 00:54:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:00f4a5053e43bce8c1b290b1380ef3b0e018b6010311117726343fe6659d466e`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:124b5440ae421cdb777ce9a0c8d5c85d1b42a01866391ddda3d4b0a60e35c040`  
		Last Modified: Fri, 30 Oct 2020 00:55:20 GMT  
		Size: 19.3 MB (19265652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4d8d460ad2353aa741bbdaf4f905e9d6a784ba485164c0c0cbfa7e0ef1d7aa1`  
		Last Modified: Fri, 30 Oct 2020 00:55:17 GMT  
		Size: 15.7 KB (15706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf19dc53b53cd883261ac52e89b4adedfa32a74788fa0d216641c3bb5cd4dc6a`  
		Last Modified: Fri, 30 Oct 2020 00:55:20 GMT  
		Size: 13.6 MB (13611871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:719965b0f8f218ecafc15f1a6a8ef9609bba63939be94fbb84f7382f98f93319`  
		Last Modified: Fri, 30 Oct 2020 00:55:14 GMT  
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6847b0f390d70c4709af6d0e0b97ebdc8692be43cdac4fd63771ab00892d6e`  
		Last Modified: Fri, 30 Oct 2020 00:55:14 GMT  
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8da7def819580b15791ce18f8c3a1da4b597f7289835b72a18290d754103185c`  
		Last Modified: Fri, 30 Oct 2020 00:56:20 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97f91c6f1c43d349874c076d9e595f00a5663b45365a9c481bf0fa79f30cab93`  
		Last Modified: Fri, 30 Oct 2020 00:56:20 GMT  
		Size: 1.1 KB (1091 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:d6936e85ea1f1de1363fdfa4f0fbc2133fb5f57c667873e5f1979ec9370a47b9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190475406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50c1539b5bb80ea423eb2764647442f41ccc21d177be1b8d51f0a7c4adba91b3`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 27 Oct 2020 00:45:06 GMT
CMD ["apache2-foreground"]
# Tue, 27 Oct 2020 02:01:32 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Tue, 27 Oct 2020 02:01:32 GMT
ENV TINI_VERSION=v0.19.0
# Tue, 27 Oct 2020 02:01:33 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 27 Oct 2020 02:04:08 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 02:04:09 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 27 Oct 2020 02:04:09 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:04:10 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 27 Oct 2020 02:10:29 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 02:10:29 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 02:10:30 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 02:10:30 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 02:10:30 GMT
...
-	Layers:
	...
	-	`sha256:f5f5b2cb2c5eee30d2a064afd62c23d085715ec820e8b0741603ce5d6de50445`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a476e2dd71f1d2c7a5704a5df7fbc2cbf13f7c2b8266d140ca17acb8ed0fc6f`  
		Last Modified: Tue, 27 Oct 2020 02:11:08 GMT  
		Size: 20.9 MB (20948282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e6d48948468fe74c327f32a044153ab978639c0483f094a2cdbcd46b1be4551`  
		Last Modified: Tue, 27 Oct 2020 02:11:02 GMT  
		Size: 16.1 KB (16119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bf901d6c77f12e914a92b91a87c494e01ee6356a41660c29f861b50ed555a34`  
		Last Modified: Tue, 27 Oct 2020 02:11:08 GMT  
		Size: 14.6 MB (14594764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30628ad79ce06951ac610840403e31c999a59e94449002c74e6117f90d617329`  
		Last Modified: Tue, 27 Oct 2020 02:11:00 GMT  
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f3186fe7638bac4fcda85ad292546d59b0f1374d29d1ae345dd10a551d49fb7`  
		Last Modified: Tue, 27 Oct 2020 02:11:00 GMT  
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184ec9d709f8cb8187463c4a285e237da45f9738a36846c2bfa0d9bed7e49fbb`  
		Last Modified: Tue, 27 Oct 2020 02:12:15 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fa076199eef6b1cb2ac26b601aea2c0d3a9bafd66ed34b71404fa76efaf3187`  
		Last Modified: Tue, 27 Oct 2020 02:12:15 GMT  
		Size: 1.1 KB (1065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:352447c4071f5d7c6a96fa617c55b606d1f039fc48e808a63660c759152032d4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.6 MB (164585468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a937adc5f26518010caeef9be6f7f644c561f24affd1ec74fbaa3b49aaccf559`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 27 Oct 2020 00:08:51 GMT
CMD ["apache2-foreground"]
# Tue, 27 Oct 2020 00:33:44 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Tue, 27 Oct 2020 00:33:44 GMT
ENV TINI_VERSION=v0.19.0
# Tue, 27 Oct 2020 00:33:48 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 27 Oct 2020 00:40:22 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 00:40:24 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 27 Oct 2020 00:40:25 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 00:40:27 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 27 Oct 2020 00:48:48 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 00:48:48 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 00:48:49 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 00:48:50 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 00:48:50 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 00:48:50 GMT
...
-	Layers:
	...
	-	`sha256:5afb1881851463e749fe509fbaa798e6775c7346c2b00f2f5ee69cdfc42a9239`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:370b76f5073c021435a8f1bc54b03796cad07819bdf4d36902581ab18e0ef7e5`  
		Last Modified: Tue, 27 Oct 2020 00:49:33 GMT  
		Size: 19.3 MB (19302285 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d18834b811bc49bb14090ebabaf464bed83e253480685b14433c8e66513ed118`  
		Last Modified: Tue, 27 Oct 2020 00:49:18 GMT  
		Size: 15.9 KB (15895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f655db18dae9c78fdcb673ed06d8e5db9c53a0ad91527eaebaa2c789c8ce126`  
		Last Modified: Tue, 27 Oct 2020 00:49:29 GMT  
		Size: 13.7 MB (13696467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e976612dbe869a21a3826233d35cd27b5b21ca688a4169fb6c4be1836d79753c`  
		Last Modified: Tue, 27 Oct 2020 00:49:14 GMT  
		Size: 554.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0b81b509f83952689b6a34c407c3d3717cc804f14291e3491d836ed21b54490`  
		Last Modified: Tue, 27 Oct 2020 00:49:15 GMT  
		Size: 543.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4790ac2ca9e6865b2c64c31443374a43c46cfb8e91a06da65f37b03e1c5d5090`  
		Last Modified: Tue, 27 Oct 2020 00:51:09 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e78d0af6409aa5165d9090a6cffa2835caa86fe8cf3d0063611e631c9b410d0`  
		Last Modified: Tue, 27 Oct 2020 00:51:09 GMT  
...
```console
$ docker pull friendica@sha256:615c8db2ed89d26da7628c72536df741dd1726a3ea9cd5c2d20677f19b182753
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.3 MB (199322162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c0966e733111fce0a3088699ecbcae9b66d54415e3f2fd88a851b6a50e6c263`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 27 Oct 2020 02:06:16 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Tue, 27 Oct 2020 02:06:21 GMT
ENV TINI_VERSION=v0.19.0
# Tue, 27 Oct 2020 02:06:34 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Tue, 27 Oct 2020 02:21:08 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 02:21:21 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 27 Oct 2020 02:21:26 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:21:36 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Tue, 27 Oct 2020 02:46:18 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Tue, 27 Oct 2020 02:46:21 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Tue, 27 Oct 2020 02:46:24 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Tue, 27 Oct 2020 02:46:26 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 27 Oct 2020 02:46:29 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 27 Oct 2020 02:46:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:df6b4b8f49d1b8ec15f1523e279439bc4ca58f78954baaea28f860e76ff8aede`  
		...
		Size: 899.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0064e980d8014f825691cb88b575582fd61bed79e7b8f981b083d7e3fc6e490f`  
		Last Modified: Tue, 27 Oct 2020 02:48:26 GMT  
		Size: 23.7 MB (23723583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcf283741ba0600769c126f371dbf299c3edeb6cb03f79388a3837a2a787829c`  
		Last Modified: Tue, 27 Oct 2020 02:48:20 GMT  
		Size: 16.3 KB (16332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff08dcda1459e39ff46db2f49d817cd6bfbb8898783730d6f7ae771b5016e5cc`  
		Last Modified: Tue, 27 Oct 2020 02:48:25 GMT  
		Size: 15.4 MB (15410283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1c1847cee3fc2d97c30d2141cfe9043829ea4c8a098b5cab183e4b4c4883937`  
		Last Modified: Tue, 27 Oct 2020 02:48:17 GMT  
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c5e7deb30786eb183105c2ff0161038b795f6132b0c157bbabd2f770942365a`  
		Last Modified: Tue, 27 Oct 2020 02:48:17 GMT  
		Size: 553.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3dbe1bf182eadec2225fd7bedaaab402ba6c2057e347963b692b9897dae725d`  
		Last Modified: Tue, 27 Oct 2020 02:50:15 GMT  
		Size: 3.3 KB (3259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04aea303df101fd5cd4134c2dbbcca47f469ed049e8bd02c19c13d8fa61e7c7d`  
		Last Modified: Tue, 27 Oct 2020 02:50:15 GMT  
...
```console
$ docker pull friendica@sha256:be6b780201f28398407fb28b16d2521b2164b4ec615250b205c74052abff5c5d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.7 MB (166713253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ea62157212938c88b31c2d247dca0546a1a4919194010e7563308cafe896d63`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 30 Oct 2020 00:29:13 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         msmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Fri, 30 Oct 2020 00:29:15 GMT
ENV TINI_VERSION=v0.19.0
# Fri, 30 Oct 2020 00:29:23 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && mkdir ~/.gnupg  && echo "disable-ipv6" >> ~/.gnupg/dirmngr.conf  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Fri, 30 Oct 2020 00:33:11 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.3.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 00:33:15 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 30 Oct 2020 00:33:16 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 00:33:17 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Fri, 30 Oct 2020 00:40:22 GMT
ENV FRIENDICA_VERSION=2020.12-dev
# Fri, 30 Oct 2020 00:40:22 GMT
ENV FRIENDICA_ADDONS=2020.12-dev
# Fri, 30 Oct 2020 00:40:23 GMT
COPY multi:79fafe1f110f1d1a4fd44f7b958b2a83de813fc7f8cfcefe662a6fa6e275cf3e in / 
# Fri, 30 Oct 2020 00:40:24 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 30 Oct 2020 00:40:25 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Fri, 30 Oct 2020 00:40:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2ecb6d6733ff3f0356811943c39126c335444d105b6ed991496b500cd7cc989b`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c894ce22844e4393cfc36ace11816b68ae03eef002a94ee855c996803b2ec3cf`  
		Last Modified: Fri, 30 Oct 2020 00:41:21 GMT  
		Size: 18.2 MB (18232521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4ed24aa1d9ca218643a650271df3b8e7ecb288abd300e59624e632b107ee602`  
		Last Modified: Fri, 30 Oct 2020 00:41:17 GMT  
		Size: 16.4 KB (16429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8a10a3ee3bcfff27761b4515e9efb421300359fc4023003204470507b660208`  
		Last Modified: Fri, 30 Oct 2020 00:41:20 GMT  
		Size: 13.8 MB (13756685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9874819c5da7a59ef1f1b786f7effc0c9c41cfe897de023a213c2e5a2e90945`  
		Last Modified: Fri, 30 Oct 2020 00:41:14 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8331b6764030443d319b6b72fd66c54b4b06b787ed6fb9404fc2ccac8ba62fb4`  
		Last Modified: Fri, 30 Oct 2020 00:41:15 GMT  
		Size: 551.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2335b17ef14ed91b9f6150bfe5a834dfdc61264471e4d403c9f1447481e40bbe`  
		Last Modified: Fri, 30 Oct 2020 00:42:00 GMT  
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66cf2db46b8d676724d3562cd0df91dc03265c13929b25cc8d7d3986adf7fcdb`  
		Last Modified: Fri, 30 Oct 2020 00:42:00 GMT  
