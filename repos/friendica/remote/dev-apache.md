...
```console
$ docker pull friendica@sha256:a55f71e4b194181156dea18d85ed614c8bf2e5602778c29f37c1cbf11a4a9381
```
...
```console
$ docker pull friendica@sha256:f1517fffe56b10df6347c5bd10ece6f6865fe360d21d067a49d85196a553b608
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.7 MB (135690992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f086746f1e7507959a4f290f9a224f1ba1cd39d14f0870b86b0207c6d9d641e`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 27 Feb 2020 01:00:39 GMT
ENV FRIENDICA_VERSION=2020.03-dev
# Thu, 27 Feb 2020 01:00:41 GMT
ENV FRIENDICA_ADDONS=2020.03-dev
# Thu, 27 Feb 2020 01:00:43 GMT
COPY multi:ce949e8666c62782a06c25e3afd3e51e12d00621028524d4cfb00c86f0d07b9b in / 
# Thu, 27 Feb 2020 01:00:44 GMT
COPY multi:ccf608c3083a2548ed80248e6308632e395ce7dfbcb83d73bfba22293ecd8ffd in /usr/src/friendica/config/ 
# Thu, 27 Feb 2020 01:00:44 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 27 Feb 2020 01:00:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:995ddb3d66ba1b8e986df8d45786cd68864ff341ec3379c7d659e05d81ae0150`  
		...
		Size: 544.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97b25e944d183da16b6d8d360f5529b214f75a9f3011d3f34cca78e633892c56`  
		Last Modified: Thu, 27 Feb 2020 01:02:37 GMT  
		Size: 2.8 KB (2844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:710ee2043a612585fdb8985bf3b9093a8f93bb10ebab0128c4256972c92ab9ca`  
		Last Modified: Thu, 27 Feb 2020 01:02:36 GMT  
...
```console
$ docker pull friendica@sha256:393980b16b1069a0d0ca739a1f196023e52f2a86816cf927ee9e6e177f764e9f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.6 MB (142605626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78b36ba5dfc45d6e9e62ed8feb28e0f81f5ce97948b6dd85f13305d18e539317`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 27 Feb 2020 01:35:20 GMT
ENV FRIENDICA_VERSION=2020.03-dev
# Thu, 27 Feb 2020 01:35:20 GMT
ENV FRIENDICA_ADDONS=2020.03-dev
# Thu, 27 Feb 2020 01:35:22 GMT
COPY multi:ce949e8666c62782a06c25e3afd3e51e12d00621028524d4cfb00c86f0d07b9b in / 
# Thu, 27 Feb 2020 01:35:23 GMT
COPY multi:ccf608c3083a2548ed80248e6308632e395ce7dfbcb83d73bfba22293ecd8ffd in /usr/src/friendica/config/ 
# Thu, 27 Feb 2020 01:35:24 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 27 Feb 2020 01:35:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2ff17ceb9d4eb4d4978d7ac077aef8358eaabe455c49ced08a94cd7ae031a16b`  
		...
		Size: 540.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cf93b0e82b7451eef32c458f628e6904b104bdf483fdd185081048012333084`  
		Last Modified: Thu, 27 Feb 2020 01:36:59 GMT  
		Size: 2.8 KB (2844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99d1b8b5a764b653642f1a63d60286120a170bf5c8e31da60d408e8127583552`  
		Last Modified: Thu, 27 Feb 2020 01:36:59 GMT  
