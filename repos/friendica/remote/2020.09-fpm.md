...
```console
$ docker pull friendica@sha256:5a4e145a9b35ea19e7fffd83269806af69a7cb0f2d4a12ac261f2c8e7d8b8762
```
...
```console
$ docker pull friendica@sha256:42fc80e5b2cfde02db4b787d3d0908662134dbfc6d0e809d54e497b549319491
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.8 MB (202821365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c13306e81c1f29f5ea966128828eacbf187285a0e0be97ab02ffad22b2fc6a0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 12 Mar 2021 15:43:57 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 12 Mar 2021 15:43:58 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 12 Mar 2021 15:44:21 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 12 Mar 2021 15:44:25 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Fri, 12 Mar 2021 15:44:26 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 12 Mar 2021 15:44:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Mar 2021 15:44:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c663491f501395b66d2b2642b7346a3727f36d5e0457e0732b9917bbcf0d988d`  
		...
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e5ffd2cd35ad8755438430cbe5a5c043c52057993007879d63d4f53b17adbe9`  
		Last Modified: Fri, 12 Mar 2021 15:47:37 GMT  
		Size: 47.7 MB (47686164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b85b529dceb25d419bdee0aebd6a81b68b76245fdd6a3d4722c141df30a5099`  
		Last Modified: Fri, 12 Mar 2021 15:47:23 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7118dc793c26e881073e6d805e979636d58c1295634176a1db423a164457026`  
		Last Modified: Fri, 12 Mar 2021 15:47:23 GMT  
...
```console
$ docker pull friendica@sha256:66f0b94e3340479965016b15ebc0846e08397fd8259c64d1959d5b731028f475
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.6 MB (208610501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f12d62e9f3d222b44f17a8d18f340339e247994233067220cb05c3f69699e462`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 12 Mar 2021 17:43:31 GMT
VOLUME [/var/www/html]
# Fri, 12 Mar 2021 17:43:32 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 12 Mar 2021 17:43:32 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 12 Mar 2021 17:43:58 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 12 Mar 2021 17:44:00 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Fri, 12 Mar 2021 17:44:00 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
...
-	Layers:
	...
	-	`sha256:2486aa3ed5be3fbb6d23fd1be0f368133cf5769126d81de3cfbc516a6db787a7`  
		...
		Size: 545.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b978baa4c414f5ee179d5e5e4d318d02a76723150d82f159f6a3c033a4d21e1e`  
		Last Modified: Fri, 12 Mar 2021 17:47:15 GMT  
		Size: 47.7 MB (47686148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59770a62d01dad6b335389c3afa6180d19ace1baf0f167b6f4a77d8528e53ee5`  
		Last Modified: Fri, 12 Mar 2021 17:46:44 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a570d1c3ba6ff8a523f3fde74022addfdc94f2241d5cb35815fa812f37605d60`  
		Last Modified: Fri, 12 Mar 2021 17:46:44 GMT  
...
```console
$ docker pull friendica@sha256:7fe1b7371b8054168080530c2a925bd9d3ecbfb31c7a891be771180206a38df6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.6 MB (210617575 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89ce81d0c97cfa4ba10ceddfc058266d6f1d2dfef820f8236657072c99f493fa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 12 Mar 2021 14:24:47 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 12 Mar 2021 14:24:48 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 12 Mar 2021 14:25:01 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 12 Mar 2021 14:25:07 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Fri, 12 Mar 2021 14:25:07 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 12 Mar 2021 14:25:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Mar 2021 14:25:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b593b06f03ff3b1a08821b7f7e2dcf90ed071955d5a30fe7fc6447fcaa0ac343`  
		...
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fefd060525dd5fce3d66578c5e09dae91392d105c5d7ee78d06ec8a826b5c05f`  
		Last Modified: Fri, 12 Mar 2021 14:27:33 GMT  
		Size: 47.7 MB (47686167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a27d7a6f317e9b41db0c2cb13d15c36acf111a6b486b822c3529e0ae68a90f7`  
		Last Modified: Fri, 12 Mar 2021 14:27:28 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d100342e40ebc297f84bb141913203aad2f5c6f9f2b0f8d64113bb592f169d53`  
		Last Modified: Fri, 12 Mar 2021 14:27:28 GMT  
		Size: 1.1 KB (1077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
