...
```console
$ docker pull friendica@sha256:b5dabf017b40e1cd6423623ab13554978fcc0761895aa1f135ddc3340936643b
```
...
```console
$ docker pull friendica@sha256:f44332bb3a5160e92207745944aaa557ea3be045184480e978d3937a70f6720d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.7 MB (197690449 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d36e6665b7bbb0cf6b0b710b1d72aa5df953cafdb10f6256956e8d5c574d095`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Jul 2021 00:09:50 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 02 Jul 2021 00:09:51 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 00:10:11 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
...
-	Layers:
	...
	-	`sha256:879dcf82a6795a863bfd7328832fd0fd40c31d3ff8c6da1c074582b443185c72`  
		...
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe93e09985be9f64d9edf789d62fe5f834740614fe6a2a43a15d7cf2926661cd`  
		Last Modified: Fri, 02 Jul 2021 00:24:33 GMT  
		Size: 47.7 MB (47686157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cacc5ed79d5de5c6e70e1bcf6f9857e58eecc13222a28c4d9e7fea3427e3521`  
		Last Modified: Fri, 02 Jul 2021 00:24:00 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbd69cefc4ab3778e9abbefa7520051b0d180a69e96a6c15283a92bd0cfbaf93`  
		Last Modified: Fri, 02 Jul 2021 00:24:00 GMT  
...
```console
$ docker pull friendica@sha256:e97e4ff004be63546d0e2d749bc87608a71a0060a7cb119b0a2d2d99a41e106e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.2 MB (234207705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bbef14860c6e3bbe15be4e3def820b5ec85b8fddd0f60d3f3197355dafd4f32`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Jul 2021 01:54:20 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 02 Jul 2021 01:54:21 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 01:54:36 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 01:54:37 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
...
-	Layers:
	...
	-	`sha256:92587f7df6f404614eb37d1e6c7c10efc558cb73f724e547ebc1966b6302a868`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:534c1e76045c261de891283113fe664ac9288d2741a704261ab9556e602a51d0`  
		Last Modified: Fri, 02 Jul 2021 02:02:56 GMT  
		Size: 47.7 MB (47686165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aab4dbe9652599b94f810e5fb9d5f6dc35c5da94a871d1c8d7fe7da4d233613`  
		Last Modified: Fri, 02 Jul 2021 02:02:42 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bc18ed3c92dc1d886fd3a739b944e2e952edb1b59554d2172bb571f433d799c`  
		Last Modified: Fri, 02 Jul 2021 02:02:41 GMT  
		Size: 1.1 KB (1142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
