...
```console
$ docker pull friendica@sha256:f008684ce92dc665f01eb540615b2272be9cbf4be6222cda1b7d72c665d750ad
```
...
```console
$ docker pull friendica@sha256:01a32420e1031140c669747c499c691209abb6f8f7a8e47a14ccdb41f5c39775
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.1 MB (228104330 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8702f3aea2ceddaf3745f057d2f036dcc8ace7e13b3a3220e31e22375a7ad17a`
...
-	Layers:
	...
	-	`sha256:d38406169abb3124f2f17147cd707c1b34607ae7aea3caf368b862b8b0ecf6e0`  
		...
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d786a5bd18e0b0cab196dbd3cd705cc60a1450c944bbe48c2c31235d06fdcff`  
		Last Modified: Wed, 10 Feb 2021 09:44:56 GMT  
		Size: 48.4 MB (48419598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e642ad07e75c5308423c6adefa171c40e3bfec74b4f4dc4dad7a577db6f85ffd`  
		Last Modified: Wed, 10 Feb 2021 09:44:50 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3fe6603d2fd49fb1f3a00868e9c705d75987abd5960d3830da0ed55b8479b90`  
		Last Modified: Wed, 10 Feb 2021 09:44:49 GMT  
...
```console
$ docker pull friendica@sha256:838e8a2bab934a343afe97523a463032ff2ef5588b380e610a0469e5466e396b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.5 MB (203549154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13b9b3a6665982080332c51e5b37fffc46626c5b1812a33131ee79251d70016f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_ADDONS=2021.01
# Tue, 09 Feb 2021 17:08:02 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 09 Feb 2021 17:08:06 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Tue, 09 Feb 2021 17:08:08 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 09 Feb 2021 17:08:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Feb 2021 17:08:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1fb59b982bbf658e4a161575859d724c0cf26c51cb696d572eabbdf1a97cc718`  
		...
		Size: 573.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56c76422027cf72aaae9d460edb7c8726312275ce6c658525c9238695eebf6bd`  
		Last Modified: Tue, 09 Feb 2021 17:10:46 GMT  
		Size: 48.4 MB (48419643 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1eb6a1ad7eca2506d138326f7369032a4613bf1fa7f78dd0569338a776486a2f`  
		Last Modified: Tue, 09 Feb 2021 17:10:32 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369e85e15969dceb579f9565667874aa05e796397e2635a1be2a1e471e87a36b`  
		Last Modified: Tue, 09 Feb 2021 17:10:32 GMT  
...
```console
$ docker pull friendica@sha256:b5f5730fe05dca549859aa028eb5d4d1b73bb2519b66303478ed37fa511fdbf2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.9 MB (234876245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05e81f4b7b9d8c25f99dd582ead719547b48de747bdd1205ef2204ea92ebf0d9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Feb 2021 21:51:41 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 09 Feb 2021 21:51:53 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 09 Feb 2021 21:51:54 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Tue, 09 Feb 2021 21:51:55 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Tue, 09 Feb 2021 21:51:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Feb 2021 21:51:55 GMT
...
-	Layers:
	...
	-	`sha256:38deb9610bcfb2484de319820d02e72684d36773361dfd112c6a45ae7d891134`  
		...
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bbe1ea034f97fa3085e40da9f289fa246623f765955aa5c4a5f184f44c52436`  
		Last Modified: Tue, 09 Feb 2021 21:54:26 GMT  
		Size: 48.4 MB (48419593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08e1ac2a32db02fa1a2b11682e5a4e25fddd11e17fc3b3afb2f698a81a518578`  
		Last Modified: Tue, 09 Feb 2021 21:54:09 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f56468c3f90ad176a27ae78f480969c9a9b28b9cec6e32f98cf319b0e8880097`  
		Last Modified: Tue, 09 Feb 2021 21:54:09 GMT  
...
```console
$ docker pull friendica@sha256:040fb9fcecc3e0fdc1fbaecab8745d1232b748430a2cd8146724b4000f212298
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **209.3 MB (209336058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d25bedf3043c3504c091d8c5d009a6c53b09152f9f0d9be2b1ffe158c60a59a5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Feb 2021 19:22:45 GMT
VOLUME [/var/www/html]
# Tue, 09 Feb 2021 19:24:06 GMT
ENV FRIENDICA_VERSION=2021.01
# Tue, 09 Feb 2021 19:24:06 GMT
ENV FRIENDICA_ADDONS=2021.01
# Tue, 09 Feb 2021 19:24:31 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Tue, 09 Feb 2021 19:24:33 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
...
-	Layers:
	...
	-	`sha256:355701c2209de790c948d57183090ec4bc9d4582ccdebedceb0d5e86b3c8aa50`  
		...
		Size: 546.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52e3dfaa28e854b6ba1f343022e7c414ae1d6bac40d269fc165de4afb625e1d8`  
		Last Modified: Tue, 09 Feb 2021 19:28:09 GMT  
		Size: 48.4 MB (48419600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b92683521b41572903ddd219011fd7701bdc7a0ac09ad591b7aceec5b4b1f12`  
		Last Modified: Tue, 09 Feb 2021 19:27:40 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef9d75e598edc411ce7abcb20281a4ca917da6f119306b097b2d79c3fd9c3c1b`  
		Last Modified: Tue, 09 Feb 2021 19:27:40 GMT  
...
```console
$ docker pull friendica@sha256:c28dbbfc340ef63199fb5a01f03567f698cbb8f66126245f817d587c06154f7e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.3 MB (211343452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:010e72e1b30d71b2c0ad2302dd88d091f638fba0a27b50058fd0e77fe0468980`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:ca36045e9d50e0b498883a83c6d161b370bad3f3793dc5cc5dea1b9e1dca8122`  
		...
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fdacbfc5974a2847f5a0724628c523c57692d6b9e10e77e1894521bd06f3f5d`  
		Last Modified: Tue, 09 Feb 2021 12:19:28 GMT  
		Size: 48.4 MB (48419648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ab11e3fd3faceff6c39f2c29c6654c142e8ae6dc4b7f2f6757ffcf5b23154e8`  
		Last Modified: Tue, 09 Feb 2021 12:19:22 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ca4729c0abcbd5af30743490d1827a86a93c733836fcce50d72fef730c3f461`  
		Last Modified: Tue, 09 Feb 2021 12:19:22 GMT  
		Size: 1.1 KB (1074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
