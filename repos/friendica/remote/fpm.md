...
```console
$ docker pull friendica@sha256:066fd9cf27f21296dd76a5ed1f33599cc82d59629a5658e229cfb61ae7e6e086
```
...
```console
$ docker pull friendica@sha256:c5f2fee33907e67f25942ea661e04bbb6e97c1a7b95eeaba51a9f99fc34ecf1b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.9 MB (200947198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43c1065954645e5b4457cd996dc361c910e503b858be1a5806cfb47681bcbca3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 17 Apr 2020 10:18:22 GMT
ENV FRIENDICA_VERSION=2020.03
# Fri, 17 Apr 2020 10:18:24 GMT
ENV FRIENDICA_ADDONS=2020.03
# Fri, 17 Apr 2020 10:18:58 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://github.com/friendica/friendica/archive/${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://github.com/friendica/friendica-addons/archive/${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;     /usr/src/friendica/bin/composer.phar install --no-dev -d /usr/src/friendica;
# Fri, 17 Apr 2020 10:19:04 GMT
COPY multi:4ce6218883572e2819aeaf93851e15069cd19fdc80ac04b89a1c335ca7e4d501 in / 
# Fri, 17 Apr 2020 10:19:05 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 17 Apr 2020 10:19:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 10:19:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1f8bba6e8082d2c6a812d455b0a51c3a79f373f9afa99323bc8d865f6221db50`  
		...
		Size: 595.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f51d0dbf26889d992c740546c5c711ff4dc693247fcb1fba2d2be6d628d24ad6`  
		Last Modified: Fri, 17 Apr 2020 10:21:07 GMT  
		Size: 57.8 MB (57783652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27e5abc4138e8fc89d66e74306e0cd7c0eec650cc99f6b6cef2c165cfc2fb503`  
		Last Modified: Fri, 17 Apr 2020 10:20:49 GMT  
		Size: 2.2 KB (2193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7abddb52e6fe6a8cf8c5c6148ea6523edb258bc34b76e755e3ac6b0201af6fd1`  
		Last Modified: Fri, 17 Apr 2020 10:20:49 GMT  
		Size: 1.1 KB (1075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:50a11b341d677bc93607618f40128097a59382b9bf2549beae49399bc934f70e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.1 MB (199112918 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba330f9b9650c68dd0b4d2c746702bde6e7efea9c648744c562af2696a7efcdb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 17 Apr 2020 06:14:00 GMT
CMD ["php-fpm"]
# Fri, 17 Apr 2020 07:12:20 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         ssmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Fri, 17 Apr 2020 07:12:21 GMT
ENV TINI_VERSION=v0.18.0
# Fri, 17 Apr 2020 07:12:26 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Fri, 17 Apr 2020 07:17:07 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mysql-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         	--with-libdir=lib/$debMultiarch/ 	;     docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.2.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so       | awk '/=>/ { print $3 }'       | sort -u       | xargs -r dpkg-query -S       | cut -d: -f1       | sort -u       | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 07:17:09 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/sbin/sendmail -t -i";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 17 Apr 2020 07:17:10 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 07:17:11 GMT
ENV FRIENDICA_VERSION=2020.03
# Fri, 17 Apr 2020 07:17:11 GMT
ENV FRIENDICA_ADDONS=2020.03
# Fri, 17 Apr 2020 07:17:38 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://github.com/friendica/friendica/archive/${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://github.com/friendica/friendica-addons/archive/${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;     /usr/src/friendica/bin/composer.phar install --no-dev -d /usr/src/friendica;
# Fri, 17 Apr 2020 07:17:41 GMT
COPY multi:4ce6218883572e2819aeaf93851e15069cd19fdc80ac04b89a1c335ca7e4d501 in / 
# Fri, 17 Apr 2020 07:17:42 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 17 Apr 2020 07:17:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 07:17:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:78f3272e3e532e7d69c4895d51011dad59a036a87cf728aae155e4a03b82d8a5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e9497f45254c6d952c3217861f6359219af8c365a7ffdab25390d79528bd113`  
		Last Modified: Fri, 17 Apr 2020 07:22:46 GMT  
		Size: 13.7 MB (13718746 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c7ada611d28cd7165a4e621150ec49949d2fb6dfecc80336dcc649268222777`  
		Last Modified: Fri, 17 Apr 2020 07:22:42 GMT  
		Size: 15.9 KB (15904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5d6962acb85fcfd3d8c969a9b53bcf83e25fafa892bb9b049fbcecbd57c9cac`  
		Last Modified: Fri, 17 Apr 2020 07:22:44 GMT  
		Size: 10.7 MB (10663251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69ba969fa2d521161efbee7db7226b9b51052d6f55df351a51b226e4496f721a`  
		Last Modified: Fri, 17 Apr 2020 07:22:41 GMT  
		Size: 594.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a6eefe2dae1aa953d2a7e4b11aba107eae8848efd9cad8bd830b9b560c1e4c4`  
		Last Modified: Fri, 17 Apr 2020 07:22:54 GMT  
		Size: 57.8 MB (57783216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98a3d0db8d01305b1a0867f2b6c755f5be1866c2b6f215ff958a042a55225338`  
		Last Modified: Fri, 17 Apr 2020 07:22:41 GMT  
		Size: 2.2 KB (2193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7adc94ad5758e1e14729ef5787b6fcd876a05c776443ae78aa04de4fd5d4e365`  
		Last Modified: Fri, 17 Apr 2020 07:22:41 GMT  
...
```console
$ docker pull friendica@sha256:a23ed1612b4e2c14a7a700dacccd607fc0941161cd84bb1b2924119127261422
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.7 MB (221738773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55ad8a09d3f4b5325db1740571cab7b6de560f64c819265bc97ad8c5af421e4a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 17 Apr 2020 13:06:41 GMT
ENV FRIENDICA_ADDONS=2020.03
# Fri, 17 Apr 2020 13:07:07 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://github.com/friendica/friendica/archive/${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://github.com/friendica/friendica-addons/archive/${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;     /usr/src/friendica/bin/composer.phar install --no-dev -d /usr/src/friendica;
# Fri, 17 Apr 2020 13:07:08 GMT
COPY multi:4ce6218883572e2819aeaf93851e15069cd19fdc80ac04b89a1c335ca7e4d501 in / 
# Fri, 17 Apr 2020 13:07:09 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 17 Apr 2020 13:07:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 13:07:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:248656684563a7798c3c967caefe59db902ebef822988d83fd6c5ec482d53b37`  
		...
		Size: 564.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:300dee94137a3329ce112dfb65ca69c5e1637aa89170e379453a534343d82e08`  
		Last Modified: Fri, 17 Apr 2020 13:12:11 GMT  
		Size: 57.8 MB (57782944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7b56f80ab1957c877b959311b5de1a5ad5b55c3c88413787d4bc377d085701`  
		Last Modified: Fri, 17 Apr 2020 13:11:45 GMT  
		Size: 2.2 KB (2193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80bc7a22c6faabca77c065b8fa9d6d821c4e56d747e97b08daf6b9ca801a6c3b`  
		Last Modified: Fri, 17 Apr 2020 13:11:45 GMT  
...
```console
$ docker pull friendica@sha256:28b4bcf487b2df91000ba10af1df36fe01466333b7fbf7abd9ee01251ff5342a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.8 MB (208829748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c96ba33bf331089934dba246012d42f6cdf56994646abc7cd8fa896ca8445408`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 17 Apr 2020 09:03:21 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         git         ssmtp         gnupg dirmngr     ;     rm -rf /var/lib/apt/lists/*;
# Fri, 17 Apr 2020 09:03:32 GMT
ENV TINI_VERSION=v0.18.0
# Fri, 17 Apr 2020 09:03:49 GMT
RUN export BUILD_ARCH=$(dpkg-architecture --query DEB_BUILD_ARCH)  && curl -L -o /sbin/tini https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}  && curl -L -o /tini.asc https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini-${BUILD_ARCH}.asc  && gpg --batch --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7  && gpg --batch --verify /tini.asc /sbin/tini  && chmod +x /sbin/tini
# Fri, 17 Apr 2020 09:14:57 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mysql-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         librsvg2-2         libzip-dev         libldap2-dev     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-gd         --with-freetype-dir=/usr/include/         --with-png-dir=/usr/include/         --with-jpeg-dir=/usr/include/     ;     docker-php-ext-configure ldap         	--with-libdir=lib/$debMultiarch/ 	;     docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         zip         opcache         ctype         pcntl         ldap     ;         pecl install apcu-5.1.18;     pecl install memcached-3.1.5;     pecl install redis-5.2.1;     pecl install imagick-3.4.4;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so       | awk '/=>/ { print $3 }'       | sort -u       | xargs -r dpkg-query -S       | cut -d: -f1       | sort -u       | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 09:15:14 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/sbin/sendmail -t -i";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         echo 'memory_limit=512M' > /usr/local/etc/php/conf.d/memory-limit.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 17 Apr 2020 09:15:18 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 09:15:23 GMT
ENV FRIENDICA_VERSION=2020.03
# Fri, 17 Apr 2020 09:15:30 GMT
ENV FRIENDICA_ADDONS=2020.03
# Fri, 17 Apr 2020 09:16:14 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://github.com/friendica/friendica/archive/${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://github.com/friendica/friendica-addons/archive/${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;     /usr/src/friendica/bin/composer.phar install --no-dev -d /usr/src/friendica;
# Fri, 17 Apr 2020 09:16:21 GMT
COPY multi:4ce6218883572e2819aeaf93851e15069cd19fdc80ac04b89a1c335ca7e4d501 in / 
# Fri, 17 Apr 2020 09:16:23 GMT
COPY multi:923de5042cde61ed518a7067985e18cb873d0cd10946593bfb44de6ba9e078ed in /usr/src/friendica/config/ 
# Fri, 17 Apr 2020 09:16:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 09:16:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f4d1011b1b86af9aeda899a45f6e061f5d5ee0ab51a582d4ab5925301c6c4932`  
		...
		Size: 8.4 KB (8430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c47574436dc8d20330d99f61bf07128d398ad6b80927178ae51b86e29adf6b7`  
		Last Modified: Fri, 17 Apr 2020 09:24:17 GMT  
		Size: 15.1 MB (15055633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c57762d1439306a88af08bcaeb135bd8685e778babe08385f1d48302119b6c8f`  
		Last Modified: Fri, 17 Apr 2020 09:24:11 GMT  
		Size: 16.5 KB (16516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6711c78eedc11b04620af1d2708b155feeb9be8f0490c632a01aad28d0f80c93`  
		Last Modified: Fri, 17 Apr 2020 09:24:11 GMT  
		Size: 11.4 MB (11412399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59f22f712dff5c5cd21ff82ce7c16c21772692614a87c99a5536ea130ca35583`  
		Last Modified: Fri, 17 Apr 2020 09:24:07 GMT  
		Size: 593.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6b7780e00f7eef4400559c10022977115b230af8cf7a241557e489d833784ab`  
		Last Modified: Fri, 17 Apr 2020 09:24:18 GMT  
		Size: 57.8 MB (57783419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33d47ec0bb78e723e14096ac45ab02f3fd271127e29a63715f96b0f827dc8ea2`  
		Last Modified: Fri, 17 Apr 2020 09:24:07 GMT  
		Size: 2.2 KB (2192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2c299bd25b9ae02326399d54e70bb3ca82ef9ba4f7522f8f3aaf4bf7c6e4076`  
		Last Modified: Fri, 17 Apr 2020 09:24:07 GMT  
		Size: 1.1 KB (1072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
