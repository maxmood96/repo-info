...
```console
$ docker pull friendica@sha256:d2daa86e3f5d9cfdbc3668744e06d222f912e5497bb1ac2fde95aefe36bf4498
```
...
```console
$ docker pull friendica@sha256:69520ff5936d4cad78544caa1b13cb371354005fd262c27662e10a608cdb808b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.6 MB (203585772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73c336bed77a345c9d439777625a805ff78011570e1126d7bb62280185a4fa67`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6834e7c7f1b3525a36bc6594c7054ef01fe75e66c451fb7384be5f21ef1d855a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9822035ab9ff62e113b0fda31aff2c27265387e7d80c2f19a63bb8e87556bdc`  
		Last Modified: Sat, 10 Apr 2021 15:06:03 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6703c24e30e850ed582cf5cbed4723f45d4d0aed8c8902efb4531ce7b9e7772d`  
		Last Modified: Sat, 10 Apr 2021 15:06:03 GMT  
...
```console
$ docker pull friendica@sha256:1f318700a5631ea792eb98676f4787e185119d2a5de0804aec02e17b87d8c85f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.5 MB (243524770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c947034532a76b8dc3506db482775c84d0e6552621819c70aa51bb4c8de4b9ae`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 01 Apr 2021 10:23:23 GMT
ENV FRIENDICA_VERSION=2021.01
# Thu, 01 Apr 2021 10:23:27 GMT
ENV FRIENDICA_ADDONS=2021.01
# Thu, 01 Apr 2021 10:24:48 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Thu, 01 Apr 2021 10:24:55 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Thu, 01 Apr 2021 10:24:58 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Thu, 01 Apr 2021 10:25:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Apr 2021 10:25:10 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:55f10183573bb1254e42f9fc624982ade5750793468d1a7a876397da9217e8a0`  
		...
		Size: 582.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed2a5a1e837e6e18a80847a37b711e4d7831b6c9a96b7b8b7c157e15b6088ae4`  
		Last Modified: Thu, 01 Apr 2021 10:29:46 GMT  
		Size: 48.4 MB (48419639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65feb576da79449d4a53f655d8c466ee5f5f2f24b9d327c99825ac16b644f72d`  
		Last Modified: Thu, 01 Apr 2021 10:29:37 GMT  
		Size: 2.6 KB (2612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed3307378742df25218789b83112e24a6b75b8f0d98b016c8ff035545d71db16`  
		Last Modified: Thu, 01 Apr 2021 10:29:35 GMT  
		Size: 1.1 KB (1141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:736a3c29efb760f215cd9a87a9fffbc52f010b50fff0213f92f99dc8247cdb4d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.4 MB (211394620 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0751ae62f60a4a826df5f7ace64a6e605f86d3c9051bb1104970e9d484326ff`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Sat, 10 Apr 2021 13:06:19 GMT
COPY multi:683edb2173fa9ade72120054f2aab622e849a6a462582bb77922587d42883d18 in / 
# Sat, 10 Apr 2021 13:06:20 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Sat, 10 Apr 2021 13:06:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 10 Apr 2021 13:06:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f43b95e4ce9e4e287755063e1a479ddb452b419f56297666c410e14c201d4259`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b777ef6d4a32c20344e07db0448aff78aa249e88e095d7961bd847267aa3dee`  
		Last Modified: Sat, 10 Apr 2021 13:09:12 GMT  
		Size: 2.6 KB (2611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c058c06e81c01741d72f4afe318d3e71bdcd420e8da0242c3d7dfe30a8337a37`  
		Last Modified: Sat, 10 Apr 2021 13:09:12 GMT  
		Size: 1.1 KB (1141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
