...
```console
$ docker pull friendica@sha256:f3d7e458267eaefecac3d5f7beaa23e6d393423830f38cabb896d66500cf7029
```
...
```console
$ docker pull friendica@sha256:8ef1f9706ca604d155c7a4923472137cfa3733afe77c8835b7510ff12e9ac8d2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.3 MB (215271064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:961f67cdf04435f2667c5f538a2aac3199e5c1fd5475b2d3df7b6358e0415dc0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 22 Apr 2022 16:01:09 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 16:01:10 GMT
ENV FRIENDICA_VERSION=2022.02
# Fri, 22 Apr 2022 16:01:10 GMT
ENV FRIENDICA_ADDONS=2022.02
# Fri, 22 Apr 2022 16:01:10 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Fri, 22 Apr 2022 16:01:11 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Fri, 22 Apr 2022 16:01:52 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 16:01:54 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Fri, 22 Apr 2022 16:01:55 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 22 Apr 2022 16:01:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Apr 2022 16:01:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9d2f2b0fd0a9aa8b7874fb9b305756e4e0f26f1b714ed82b3f330e776d786adf`  
		...
		Size: 641.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06fa692ddaa20017934c16660ff9f337f293b260af3466bf67e1d3244745f112`  
		Last Modified: Fri, 22 Apr 2022 16:09:36 GMT  
		Size: 53.9 MB (53882094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d69886a74e85407646c9387d47472d5d0cb73cc27ee9cc9bf6fde9b91f438689`  
		Last Modified: Fri, 22 Apr 2022 16:09:04 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d343f86c05ea949d5346099b507da428ef3d5ffa99b41ec8ae1c3e416187c47`  
		Last Modified: Fri, 22 Apr 2022 16:09:04 GMT  
		Size: 928.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:6b930cd4c1640fdb108e9dd429230bcc7b477251ed3c65e491ac7dca1e604db2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.8 MB (221776956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f15254bc7140b4cc64a591c3911222c5ac3b2f6594a3fabe1dcb2310ae837a39`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 10:29:57 GMT
ENV FRIENDICA_VERSION=2022.02
# Fri, 22 Apr 2022 10:30:01 GMT
ENV FRIENDICA_ADDONS=2022.02
# Fri, 22 Apr 2022 10:30:05 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Fri, 22 Apr 2022 10:30:09 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Fri, 22 Apr 2022 10:31:31 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 10:31:40 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Fri, 22 Apr 2022 10:31:46 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 22 Apr 2022 10:31:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Apr 2022 10:31:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:549d8c13ac9f3ed8028180bb9d66f767808ffaf84b338b605a0e23b59a8d39af`  
		...
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1146370d11386849dfbbf314c71354da141e111982824bce7bdb00a047ab2e4`  
		Last Modified: Fri, 22 Apr 2022 10:41:22 GMT  
		Size: 53.6 MB (53636314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1714d7def8695a539f0e73be859f85a60d5db907063957909330e74639f48b9a`  
		Last Modified: Fri, 22 Apr 2022 10:40:54 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e0ed0154ba69a92ee81ec6c6605d68a7535e555a3ba0d9707c0159a20e1afa4`  
		Last Modified: Fri, 22 Apr 2022 10:40:54 GMT  
		Size: 931.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:e01714682dfe465357862b678bc571662397b1bbd2f3a1b2d413871671bce244
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.3 MB (247253137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e0856a0d2fdb40e8be3cc4b316f400ac2cc95c3b09089ea7ee9871c6c90501c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 22 Apr 2022 01:25:05 GMT
ENV FRIENDICA_VERSION=2022.02
# Fri, 22 Apr 2022 01:25:10 GMT
ENV FRIENDICA_ADDONS=2022.02
# Fri, 22 Apr 2022 01:25:15 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Fri, 22 Apr 2022 01:25:18 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
...
-	Layers:
	...
	-	`sha256:b5b97fa1428fc57031f0aa5220e24f88c430b20a3d1d74e84a518acd019b27d4`  
		...
		Size: 641.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edb9c295255c9a52e109f675addf86a837375713cfc86986436226aef7f0ac72`  
		Last Modified: Fri, 22 Apr 2022 01:36:13 GMT  
		Size: 53.9 MB (53885491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b67bea5ac9e9dcffdcb1ab1f51cce9c75ac94f41c4db215416f96a4a538c6696`  
		Last Modified: Fri, 22 Apr 2022 01:36:05 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f15fca60bcb647043d96584483a0008136f735f1a1bada1973751f97a85a628f`  
		Last Modified: Fri, 22 Apr 2022 01:36:05 GMT  
		Size: 928.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
