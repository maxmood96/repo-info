...
```console
$ docker pull friendica@sha256:959a528e0ef2637665680aa4e80ca10739aa2dca7ab1f46d3c339db25e1d9ed2
```
...
### `friendica:2026.04-rc-apache` - linux; amd64
...
### `friendica:2026.04-rc-apache` - unknown; unknown
...
### `friendica:2026.04-rc-apache` - linux; arm variant v5
...
### `friendica:2026.04-rc-apache` - linux; arm variant v7
...
### `friendica:2026.04-rc-apache` - linux; arm64 variant v8
...
### `friendica:2026.04-rc-apache` - linux; 386
...
### `friendica:2026.04-rc-apache` - linux; ppc64le
...
### `friendica:2026.04-rc-apache` - linux; s390x
