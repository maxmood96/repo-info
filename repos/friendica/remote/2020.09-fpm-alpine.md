...
```console
$ docker pull friendica@sha256:d0166481d7cce17fbbe9ccfd034e51ff9b2dd3a58f4113fb178dc43941bee848
```
...
```console
$ docker pull friendica@sha256:f0dcbfd2adf197445b97b013730a4db1780dc4123a677284869a746290d85ad4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.6 MB (92604211 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a86c36938fab21a72dd29f989e7252b9c625093b550b035d7c7b13901057b578`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Jul 2021 00:14:49 GMT
ENV FRIENDICA_VERSION=2020.09-1
# Fri, 02 Jul 2021 00:14:50 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 00:15:11 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 00:15:13 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 02 Jul 2021 00:15:14 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 02 Jul 2021 00:15:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Jul 2021 00:15:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ddaf82e7c27a1b285b9f0d1e362787ed8cd19dcbc1f0d308e43a23f9a6bbdcb4`  
		...
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b51b6c057efc0db9d52dc2278233cd646e613d7b5a7280e3d99744be5377598`  
		Last Modified: Fri, 02 Jul 2021 00:25:14 GMT  
		Size: 47.7 MB (47686163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1950861511a6bf04ffd52f37dee323dafe5f6f7e599afd44def9eaa43896bf6`  
		Last Modified: Fri, 02 Jul 2021 00:24:42 GMT  
		Size: 2.6 KB (2628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65132f683873d633d9a57131f2eba9da16f1da9c5af541288f2c5998822a03d2`  
		Last Modified: Fri, 02 Jul 2021 00:24:42 GMT  
		Size: 1.1 KB (1143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:f705182028a2a7c073bf811491590b33a6d3ed1d1af9eb03fb780efc251a58e0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **98.6 MB (98571141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06e265a8e601a90ffec1d671190c3db7db6c1658be7628680bfb05f8ac69f029`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Jul 2021 01:57:10 GMT
ENV FRIENDICA_ADDONS=2020.09-1
# Fri, 02 Jul 2021 01:57:25 GMT
RUN set -ex;     curl -fsSL -o friendica.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     tar -xzf friendica.tar.gz -C /usr/src/;     rm friendica.tar.gz;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;     curl -fsSL -o friendica_addons.tar.gz         "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica_addons.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica_addons.tar.gz;
# Fri, 02 Jul 2021 01:57:26 GMT
COPY multi:3209742e8a927dbca8685b55decf65ccc1e1ba0dc4386b61a0e5c04e963d86c1 in / 
# Fri, 02 Jul 2021 01:57:27 GMT
COPY multi:33c6df8ca48b360ac89b7ca8e8b370fe30a626687aacfad3b3c3d5c1924a5777 in /usr/src/friendica/config/ 
# Fri, 02 Jul 2021 01:57:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Jul 2021 01:57:27 GMT
...
-	Layers:
	...
	-	`sha256:588b47c4103a4bbdcabd667d9d74eb3fded160b8cefbc8b51ab46d1fa18bfe40`  
		...
		Size: 570.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fec7537730905ba07de471b48cd6f9b85d259284f026e59d685fe9e7f2e99c9`  
		Last Modified: Fri, 02 Jul 2021 02:03:17 GMT  
		Size: 47.7 MB (47686179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e84c20b7ff16daf299040b7ce78db6eee0731d34f3aca525608c1bb10c42576`  
		Last Modified: Fri, 02 Jul 2021 02:03:04 GMT  
		Size: 2.6 KB (2627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43863313c0105eb2ab939089971144f48b44bcaf834c78a28e6e1025668a5340`  
		Last Modified: Fri, 02 Jul 2021 02:03:05 GMT  
		Size: 1.1 KB (1143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
