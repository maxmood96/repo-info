...
```console
$ docker pull friendica@sha256:fd272b2b4e70c365dd92e530a85ee3b85d514534aba4f1bc7ece62137d132cee
```
...
```console
$ docker pull friendica@sha256:8294788b693b55e33a5030430842574e213c4ffa448060d083ffd484683c6df7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.1 MB (216098827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8b07116a904a026a370e93bdeb33f2063b12673e33053309e8b6d01de0ed0b5`
...
# Wed, 01 Mar 2023 23:45:17 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Wed, 01 Mar 2023 23:45:17 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Wed, 01 Mar 2023 23:45:22 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Wed, 15 Mar 2023 22:24:52 GMT
...
-	Layers:
	...
	-	`sha256:38a219ec9b1cccabb303a9f134bf199a9de437eddf44c1d69e65ca051f47a4f6`  
		...
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17562fe79c0078784fd43b047db6f9ee128277091ffb81d9ac46d6279efdf17a`  
		Last Modified: Wed, 01 Mar 2023 23:45:52 GMT  
		Size: 17.2 MB (17178767 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a58424db4c2f05879f0e3b5079d2e16a9ffd1dca6bf6e0472eb64c1fce0d517`  
		Last Modified: Wed, 15 Mar 2023 22:26:36 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eaa0a6f38605ee4cc7adea56c694c7ed24d3deaaf70327260d8cff12576a19e`  
		Last Modified: Wed, 15 Mar 2023 22:26:36 GMT  
		Size: 946.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:d1d15a89e07f3a60044fde662d51b7e6e5aa27a85a28ffa563aa702babcb7ef2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.3 MB (191326226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0f130f2bb0164901f27696075554389bdb20ee41ddf55706249dec18bfeb3fc`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Wed, 15 Mar 2023 21:48:29 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Wed, 15 Mar 2023 21:48:29 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Wed, 15 Mar 2023 21:48:29 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Wed, 15 Mar 2023 21:48:30 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:460af11470117f7885eea55a847b59df508d1f706211efa0622524e00562f44c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9f1f93a692a69e19dd51c6fb6046f464c5bac46399c24e28ca1a3de7f6bb55e`  
		Last Modified: Wed, 15 Mar 2023 21:50:33 GMT  
		Size: 3.6 KB (3615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0db1a74c369690cf96f75f5538a00fea66f33b65d34ead66efcd5717013a958`  
		Last Modified: Wed, 15 Mar 2023 21:50:33 GMT  
		Size: 948.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:d19fa59bb07b26fdba5befa32b99a70dcd12ce1892efe48d73820ebeb22a6960
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.5 MB (182474619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cda7d2f29f389f6d829f2187a4332ed29a5bc15329f3b4bc279dbfa65334a67`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 18:03:11 GMT
ENV GOSU_VERSION=1.14
# Thu, 23 Mar 2023 18:03:22 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Thu, 23 Mar 2023 18:05:30 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 18:05:30 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 23 Mar 2023 18:05:30 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 23 Mar 2023 18:05:31 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 23 Mar 2023 18:05:31 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 18:05:31 GMT
...
# Thu, 23 Mar 2023 18:09:04 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Thu, 23 Mar 2023 18:09:09 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 23 Mar 2023 18:09:10 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Thu, 23 Mar 2023 18:09:10 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Thu, 23 Mar 2023 18:09:10 GMT
...
-	Layers:
	...
	-	`sha256:c9c7c54ead6be1f4f2bef6d16e5f23b7e0308ecb30c0d22dbbc329285b726322`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44459a88ec240c604fb03a8d6d726271ab10f81fd45b3d4fdc9533fc7d7d9e5f`  
		Last Modified: Thu, 23 Mar 2023 18:09:55 GMT  
		Size: 15.5 MB (15514697 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91c7e1116d28217181286ae53ac52726175bbf0203500fcac99e4bae6677d9cb`  
		Last Modified: Thu, 23 Mar 2023 18:09:53 GMT  
		Size: 1.3 MB (1252119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae59a181993add1d7ed8c29ec9bb857274962e05869e79aa648f62f1ba033339`  
		Last Modified: Thu, 23 Mar 2023 18:09:55 GMT  
		Size: 14.5 MB (14490073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5865a8db553e3efe83ad9554ce7a0d3139d50af2b0bb1d2ad0a24862c2477d02`  
		Last Modified: Thu, 23 Mar 2023 18:09:51 GMT  
		Size: 639.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73b0e6cabecb7af67f21242917e2db38dafe4a73317d28b1e4115c5d5a36831b`  
		Last Modified: Thu, 23 Mar 2023 18:09:51 GMT  
		Size: 535.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:006e392ddb722a432b5881c14ef328eb7ff1ae146cff3a1e495a7c3d3e5b2add`  
		Last Modified: Thu, 23 Mar 2023 18:10:50 GMT  
		Size: 16.9 MB (16852911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa3985ccdefd7c46751c101167bfd37ac41fda329bf7900a791875b11a9490e9`  
		Last Modified: Thu, 23 Mar 2023 18:10:48 GMT  
		Size: 3.6 KB (3618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f309d9f45669591d77fe507bddca702913da099e67d2906ce8ec46747d9b1a48`  
		Last Modified: Thu, 23 Mar 2023 18:10:48 GMT  
		Size: 945.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:bccb03f594189f9b043dd10db989a9a33e5d107c118f76063a88e653c8b3f1f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.5 MB (206523823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de8b03528ad4cd02312393d5be17b10ac0a3cd9126c73faa69d117f1de052658`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 13:06:05 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 20:13:13 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Thu, 23 Mar 2023 20:13:13 GMT
ENV GOSU_VERSION=1.14
# Thu, 23 Mar 2023 20:13:22 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Thu, 23 Mar 2023 20:15:25 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 20:15:25 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 23 Mar 2023 20:15:25 GMT
...
# Thu, 23 Mar 2023 20:15:25 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 20:15:26 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 23 Mar 2023 20:15:26 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Thu, 23 Mar 2023 20:18:39 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Thu, 23 Mar 2023 20:18:39 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Thu, 23 Mar 2023 20:18:43 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 23 Mar 2023 20:18:44 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Thu, 23 Mar 2023 20:18:44 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Thu, 23 Mar 2023 20:18:44 GMT
...
-	Layers:
	...
	-	`sha256:c2f640e8c30768fa97c8ab1af626e69ba9fbc50376a4c00d57b2b46153f2a705`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74c879e3d7ac55b9c64fde168139a8f69cdf17c714826ee5aedf2e62c5a6df44`  
		Last Modified: Thu, 23 Mar 2023 20:19:24 GMT  
		Size: 15.3 MB (15320921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c57bb5acd093cb777e10d3d0faa8b7e4e83af77ba82d0f516b2712b6f7ba5281`  
		Last Modified: Thu, 23 Mar 2023 20:19:23 GMT  
		Size: 1.2 MB (1223491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7485b028b577dd9fed7b7c61f572842ae008ad8a748b70eacf1b80a3e7449b48`  
		Last Modified: Thu, 23 Mar 2023 20:19:24 GMT  
		Size: 15.4 MB (15449164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:531c7e9c078c65fcba05cf1861030fed4a1c04ed94143b96ab4fa30800f598b4`  
		Last Modified: Thu, 23 Mar 2023 20:19:21 GMT  
		Size: 640.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50a478a5a489f35e176600202770058e487932f27d0d4affba9a165c8bc5428b`  
		Last Modified: Thu, 23 Mar 2023 20:19:21 GMT  
		Size: 538.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae0a8d68f84712ce72194df98aab73d4e83294607c41f4f54ab5147d82b4de37`  
		Last Modified: Thu, 23 Mar 2023 20:20:05 GMT  
		Size: 17.0 MB (16982586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b87acee1b0e75de9f467786e8f3addad9d870c6439f8c194807c344a391e5722`  
		Last Modified: Thu, 23 Mar 2023 20:20:03 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf6f76f5a40f4717419b00b0b79b05c08d1ae7f251a0e7b193f4984dd7e1d36d`  
		Last Modified: Thu, 23 Mar 2023 20:20:03 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:172a5060369c5428a974bd7a1ea4cd2fa8114f56380f854ce0fb8a90d34160cf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.3 MB (219319107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da5a648428424525ab6183d6f022a23486c697c39f53a899e0c2616c48093c42`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 10:20:23 GMT
CMD ["apache2-foreground"]
# Fri, 24 Mar 2023 00:44:37 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Fri, 24 Mar 2023 00:44:37 GMT
ENV GOSU_VERSION=1.14
# Fri, 24 Mar 2023 00:44:48 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Fri, 24 Mar 2023 00:47:36 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Fri, 24 Mar 2023 00:47:36 GMT
ENV PHP_MEMORY_LIMIT=512M
# Fri, 24 Mar 2023 00:47:36 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Fri, 24 Mar 2023 00:47:37 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Fri, 24 Mar 2023 00:47:37 GMT
VOLUME [/var/www/html]
# Fri, 24 Mar 2023 00:47:37 GMT
...
# Fri, 24 Mar 2023 00:47:37 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 24 Mar 2023 00:51:45 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Fri, 24 Mar 2023 00:51:45 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Fri, 24 Mar 2023 00:51:51 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 24 Mar 2023 00:51:52 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Fri, 24 Mar 2023 00:51:52 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 24 Mar 2023 00:51:52 GMT
...
-	Layers:
	...
	-	`sha256:3eb97b2e6fecea075b3ef2ea47f49e4675510ff73e56099e0908a4479d86610e`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43b5429db4e4e8abc657ae813a439bd26dba09b737678ab2321be1d56a05917`  
		Last Modified: Fri, 24 Mar 2023 00:52:44 GMT  
		Size: 16.0 MB (16025330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0e486a87ee44cb0d8819c48f51ab2dcebd130e1786221ca0750ca2cb6d44d9e`  
		Last Modified: Fri, 24 Mar 2023 00:52:42 GMT  
		Size: 1.3 MB (1262378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a52c1b8492dd3f54c2f1523fee7c1108af099f1afad3470d78941a1e2d61320`  
		Last Modified: Fri, 24 Mar 2023 00:52:46 GMT  
		Size: 17.1 MB (17120546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dabeb43be038d32332ca6d5997a2b55ba56505e7647cad25f1de43a7dd9ea594`  
		Last Modified: Fri, 24 Mar 2023 00:52:39 GMT  
		Size: 639.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb7bef523545c98e42e9ee196494efd8d54386076adc54c1659d68492eb29b1a`  
		Last Modified: Fri, 24 Mar 2023 00:52:39 GMT  
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6b5036e6c7636748802d9c87b78b1bac346605a7fa26b61bd860a7354970c36`  
		Last Modified: Fri, 24 Mar 2023 00:53:33 GMT  
		Size: 17.9 MB (17922102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e98c545da623a76bc0107750ff94509473a8b2ccaf4b249b0c4b59691a406965`  
		Last Modified: Fri, 24 Mar 2023 00:53:31 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2e0aca19503cdaa6f2b37f4e22e93f14efff27d8867a89616c5911eaabbe138`  
		Last Modified: Fri, 24 Mar 2023 00:53:31 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:5a493bfb7f9c51d3388f8fd899906b0b9ab3519c184de73a55da3c54779d8f4c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189069830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21aace3a021075ce78a2f62848efe20cd48811a70f674e5423f55ee09824afeb`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Wed, 01 Mar 2023 20:55:26 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Wed, 01 Mar 2023 20:55:30 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Wed, 01 Mar 2023 20:56:02 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Wed, 15 Mar 2023 22:08:41 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Wed, 15 Mar 2023 22:08:45 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Wed, 15 Mar 2023 22:08:49 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Wed, 15 Mar 2023 22:08:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:52109bf0803e6ce5fe59a88f1ecd571e09c61be9744bd1dbad62466e4afb80ae`  
		...
		Size: 542.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f2198a3ae580e77c6707b8ae86b45b016856ce9399855df4860095a95d66244`  
		Last Modified: Wed, 01 Mar 2023 20:57:42 GMT  
		Size: 16.5 MB (16460559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b112f5ed8594e203394b30a016135fd2b25ae1194e116d38a207b2c226ddbcf`  
		Last Modified: Wed, 15 Mar 2023 22:12:21 GMT  
		Size: 3.6 KB (3617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6a0d2e01f45d32d0fe2752b1c99bb9c3b3830899168efd9fa5b2f1e642c8955`  
		Last Modified: Wed, 15 Mar 2023 22:12:22 GMT  
		Size: 920.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:bbc1c1f4ed0482da274b9b4e31d97e1ac33f5d6b0188ea3879b1a5357ae11fa6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.1 MB (216116172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cec6f89934bc32cf9e3fbe8145ca9134554db5aa36ca3ae4d0659fcde3644a14`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 19:32:03 GMT
ENV GOSU_VERSION=1.14
# Thu, 23 Mar 2023 19:32:23 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Thu, 23 Mar 2023 19:36:57 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 19:36:58 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 23 Mar 2023 19:36:58 GMT
ENV PHP_UPLOAD_LIMIT=512M
...
# Thu, 23 Mar 2023 19:36:59 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 19:37:01 GMT
RUN set -ex;    a2enmod rewrite remoteip ;    {     echo RemoteIPHeader X-Real-IP ;     echo RemoteIPTrustedProxy 10.0.0.0/8 ;     echo RemoteIPTrustedProxy 172.16.0.0/12 ;     echo RemoteIPTrustedProxy 192.168.0.0/16 ;    } > /etc/apache2/conf-available/remoteip.conf;    a2enconf remoteip
# Thu, 23 Mar 2023 19:37:01 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Thu, 23 Mar 2023 19:43:57 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Thu, 23 Mar 2023 19:43:57 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Thu, 23 Mar 2023 19:44:09 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 23 Mar 2023 19:44:10 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Thu, 23 Mar 2023 19:44:10 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Thu, 23 Mar 2023 19:44:10 GMT
...
-	Layers:
	...
	-	`sha256:0f09a70c03dc3da3036ae9fbc57c9609dfcd699d83e8ed67f0f124b643bec333`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc3e988a94d85417fd48887db4b373be29514ddae16819ddd7cedbc07b42875e`  
		Last Modified: Thu, 23 Mar 2023 19:45:33 GMT  
		Size: 15.4 MB (15447126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f4312b07c9a923201b0ad23e14d7499fce46cd47da94231c9fafdddf3fc931b`  
		Last Modified: Thu, 23 Mar 2023 19:45:31 GMT  
		Size: 1.2 MB (1196165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8daacfc936054bd2476b8ae40d9b4f14d6dce79abaa32a16b519fd2ae0881555`  
		Last Modified: Thu, 23 Mar 2023 19:45:35 GMT  
		Size: 17.3 MB (17304539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd94a4f5d3854285da9e0cfaf97b4112a9291f5874a4124629a53cb88ee49ab9`  
		Last Modified: Thu, 23 Mar 2023 19:45:28 GMT  
		Size: 641.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d971bb1228ee30cfdbe10bee6f8238bcd0779c6407ae7fc35830c55b17ec9f0f`  
		Last Modified: Thu, 23 Mar 2023 19:45:28 GMT  
		Size: 541.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ba0e0455527830748a04f6a8163066962c33ee0913eaa778909e799d48c9e5a`  
		Last Modified: Thu, 23 Mar 2023 19:46:35 GMT  
		Size: 17.5 MB (17489614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7d9bcdd6fdd31a5d8754388fbf8a91ba51bb1847b56ffe3cbaba2653780b46`  
		Last Modified: Thu, 23 Mar 2023 19:46:33 GMT  
		Size: 3.6 KB (3615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90cd80b2e3ff08655544cff519a6d9c0d30be30cc5dadabe5aa9ff6da43832b7`  
		Last Modified: Thu, 23 Mar 2023 19:46:33 GMT  
		Size: 948.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:0393cbde1652b079d90e5c6244b8d85209c693f6d4295e6ae5ea33ba3a9ea3f0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189598762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:630592afb6146dc6ee94d66a4607bb1180914bfe7594d53863b82ecfc5ba70d1`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 08:59:20 GMT
CMD ["apache2-foreground"]
# Thu, 23 Mar 2023 17:27:22 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Thu, 23 Mar 2023 17:27:22 GMT
ENV GOSU_VERSION=1.14
# Thu, 23 Mar 2023 17:27:29 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Thu, 23 Mar 2023 17:29:02 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Thu, 23 Mar 2023 17:29:03 GMT
ENV PHP_MEMORY_LIMIT=512M
# Thu, 23 Mar 2023 17:29:03 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Thu, 23 Mar 2023 17:29:04 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Thu, 23 Mar 2023 17:29:04 GMT
VOLUME [/var/www/html]
# Thu, 23 Mar 2023 17:29:04 GMT
...
# Thu, 23 Mar 2023 17:29:04 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Thu, 23 Mar 2023 17:32:05 GMT
ENV FRIENDICA_VERSION=2023.03-dev
# Thu, 23 Mar 2023 17:32:05 GMT
ENV FRIENDICA_ADDONS=2023.03-dev
# Thu, 23 Mar 2023 17:32:10 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 23 Mar 2023 17:32:10 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Thu, 23 Mar 2023 17:32:10 GMT
...
-	Layers:
	...
	-	`sha256:3c458f8a720cfd63cc97945f760c3828e1b5226f1c1b0e789eff0255e00f2bcc`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4a58a080931d5ce0cdcce878247a172da82a6120fb34987dbb539f985a2b6f4`  
		Last Modified: Thu, 23 Mar 2023 17:33:19 GMT  
		Size: 15.0 MB (14951780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6488cd0799b26cf324d5a6478894e1f52b2553b8a99e13c1ef1a37bc64be5ea5`  
		Last Modified: Thu, 23 Mar 2023 17:33:19 GMT  
		Size: 1.3 MB (1258227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1e13bf0839b3bd8ca46c01ad38437445b6ed0d98e0d30a528810d83a364c990`  
		Last Modified: Thu, 23 Mar 2023 17:33:20 GMT  
		Size: 15.4 MB (15414872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6ff9a8a7ebd348550dc76f728af2abb9b64ce72ececa42b1c98508a75bb63ac`  
		Last Modified: Thu, 23 Mar 2023 17:33:17 GMT  
		Size: 635.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e848211ab03d15ef82151dc2280aff958eaba79c5b9e6c7a6f3b452966011ff`  
		Last Modified: Thu, 23 Mar 2023 17:33:17 GMT  
		Size: 537.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bc1ea48e8ece39a1bfd2972829d30ba2f226ead3622a4be548d4f5ec3641536`  
		Last Modified: Thu, 23 Mar 2023 17:33:48 GMT  
		Size: 16.5 MB (16544492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59f9dbd5256b67d352f1e9153b5f4d85ab083eaba9e0ef54cfa57c4565bfab1d`  
		Last Modified: Thu, 23 Mar 2023 17:33:47 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc2e58a5d6935815d8550fdd73cc69914aafe2a344c75bc6de2d1f8a96b2cbe5`  
		Last Modified: Thu, 23 Mar 2023 17:33:47 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
