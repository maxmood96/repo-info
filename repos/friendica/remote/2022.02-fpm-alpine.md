...
```console
$ docker pull friendica@sha256:f3904ba473f283de8c56313342b38565549bfe24a472c631fda4559e688bfc1c
```
...
```console
$ docker pull friendica@sha256:588d59489cdb51dc1e3fd23addccda6ccefd3846886912179d06c72b495e4f2b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.0 MB (94013035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f792c4118303b587bcb41cd7b242b0d0e1eb6bfaa44fd6c5ba006a51e4f4d205`
...
-	Layers:
	...
	-	`sha256:0c61da8e24f36170adeabf27ee057df3b607c15208bb6f1c39b7a68d0c3649a5`  
		...
		Size: 636.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b80fbe6fb881853beebaa2c5f9a2be34f910636c0695276b221814838fa7e5c3`  
		Last Modified: Tue, 05 Apr 2022 12:54:26 GMT  
		Size: 53.5 MB (53513835 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c727e0d2c1d6f51e31d3e954df6d70a81d3859aadf628a20e1b80fff4cee7994`  
		Last Modified: Tue, 05 Apr 2022 12:54:20 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b03088ee6f0b5bd8f99aaa5237878873d7aa1547e4692ec182af885e52e5ecf2`  
		Last Modified: Tue, 05 Apr 2022 12:54:20 GMT  
		Size: 925.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:81ceba1a1236c8fd425d8fee45d2f0588dd1f7bbe7400d1d69af114ac8f40d05
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.7 MB (90679456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ace73f27bac56020b9a6ef894f76215597e1bc5cc281aeb983c35eb823bab07`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Tue, 05 Apr 2022 22:45:49 GMT
ENV FRIENDICA_VERSION=2022.02
# Tue, 05 Apr 2022 22:45:50 GMT
ENV FRIENDICA_ADDONS=2022.02
# Tue, 05 Apr 2022 22:45:50 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Tue, 05 Apr 2022 22:45:50 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Tue, 05 Apr 2022 22:46:17 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;             export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apk del .fetch-deps
# Tue, 05 Apr 2022 22:46:19 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Tue, 05 Apr 2022 22:46:20 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Tue, 05 Apr 2022 22:46:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 05 Apr 2022 22:46:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:be65403f6c19037e3ff89ef40ddb87a005f6392ee659be137943d61d03ff6704`  
		...
		Size: 634.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e592ae971a45b4fa0979dcc2eb33c92160acbe67af2c5f5270afacda429b678`  
		Last Modified: Tue, 05 Apr 2022 22:51:35 GMT  
		Size: 53.5 MB (53513934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:591350ee8407672716e0bcf50febbf98cc2b1353729e48de50dd846524d80263`  
		Last Modified: Tue, 05 Apr 2022 22:51:03 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b9ee5db1c4234612d0eac8a43667ff0f083b820d173f00e44be577406b4e27d`  
		Last Modified: Tue, 05 Apr 2022 22:51:03 GMT  
		Size: 923.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:f501356de4c014550cb5989f44b5489c931b6844522c68f6b87528896b5a5a1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.3 MB (93315017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23078a93ebfd8cdf4cc857a586e4ece270bb3138facc7fea83cf6c9c23f697af`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Tue, 05 Apr 2022 15:05:56 GMT
ENV FRIENDICA_VERSION=2022.02
# Tue, 05 Apr 2022 15:05:56 GMT
ENV FRIENDICA_ADDONS=2022.02
# Tue, 05 Apr 2022 15:05:57 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Tue, 05 Apr 2022 15:05:58 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Tue, 05 Apr 2022 15:06:12 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;             export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apk del .fetch-deps
# Tue, 05 Apr 2022 15:06:14 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Tue, 05 Apr 2022 15:06:15 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Tue, 05 Apr 2022 15:06:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 05 Apr 2022 15:06:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:81b7a3523740deb4d843a37f942935e50abd23de61a9c8679c345abaf177726c`  
		...
		Size: 603.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dca2099cf9f77a6dec9fe5527dbcf41815579f4e786c559263d381f90ad7db1`  
		Last Modified: Tue, 05 Apr 2022 15:10:00 GMT  
		Size: 53.5 MB (53511692 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3db0fb062156ae37d8b7a31791c6fb853789226558b6acd9dd01b54b0f584651`  
		Last Modified: Tue, 05 Apr 2022 15:09:53 GMT  
		Size: 3.0 KB (2952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e7529588219016f8ebb4cbaa3b1d5e088aa76d6f70ff23c46595a289188c209`  
		Last Modified: Tue, 05 Apr 2022 15:09:53 GMT  
		Size: 925.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:ef74cb62aabaf51530cccb0cd9c3546bd24e743257ec86cef5448acf3dc90cb4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.7 MB (94651526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be7c2489c0a2062f475e20ddcfff94442f90b403e828ea30a15b53e6e9dbb0a7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV FRIENDICA_SYSLOG_FLAGS=39
# Tue, 05 Apr 2022 08:09:46 GMT
ENV FRIENDICA_VERSION=2022.02
# Tue, 05 Apr 2022 08:09:47 GMT
ENV FRIENDICA_ADDONS=2022.02
# Tue, 05 Apr 2022 08:09:48 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=032be1a8c7e1a82d34eebc95b5bd2f2564a9114834eff45e6b4daa240eab22e8
# Tue, 05 Apr 2022 08:09:49 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=146240e7215d15d743bee4e0d3c084315b5a1778493f400284e80ff84e3cd1ce
# Tue, 05 Apr 2022 08:10:04 GMT
RUN set -ex;      apk add --no-cache --virtual .fetch-deps             gnupg         ;             export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apk del .fetch-deps
# Tue, 05 Apr 2022 08:10:06 GMT
COPY multi:31b45a7507c100b0a9b3decdeeedd3c1880f5c7c482c8e17c6047c00a1ffcb3d in / 
# Tue, 05 Apr 2022 08:10:07 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Tue, 05 Apr 2022 08:10:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 05 Apr 2022 08:10:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f8695ea65e4a8c24c61da09b6c56fedbd7db965b0d2730ee0962b75128355952`  
		...
		Size: 602.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3034a90bc90289dc24045b36a43b4031f3d8e28d775d457979b0fff46117264`  
		Last Modified: Tue, 05 Apr 2022 08:14:14 GMT  
		Size: 53.5 MB (53511467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c22ac468ad7b547e48e64b35bb974ece71fd9087fbe633ba3a56ada6ced8013`  
		Last Modified: Tue, 05 Apr 2022 08:14:05 GMT  
		Size: 3.0 KB (2951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:820a13d0523e7e93d34dbb7b9827d66d88e8f4bdac2024cad3f0bff7e0daad99`  
		Last Modified: Tue, 05 Apr 2022 08:14:06 GMT  
		Size: 924.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
