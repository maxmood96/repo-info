...
```console
$ docker pull friendica@sha256:aef33123cc1d0b5e1990a4ec55d013bc51b7b06cf30ec7d03b023166739437fc
```
...
```console
$ docker pull friendica@sha256:0d7317baad866663c66ea2bcbcc747e7841519aa5290e0e0577eedd86c88e008
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **212.3 MB (212261793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24f22fe59a1d16eab87edc155af4ae708362155d48010cb7f69b1f2541ecafe2`
...
# Tue, 28 Mar 2023 00:21:04 GMT
CMD ["php-fpm"]
# Tue, 28 Mar 2023 03:34:44 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Tue, 28 Mar 2023 03:34:45 GMT
ENV GOSU_VERSION=1.14
# Tue, 28 Mar 2023 03:34:53 GMT
...
-	Layers:
	...
	-	`sha256:392c4babb0eaaa756c8ca9f1c2267d1aa451beb34b8bb2cc0b46af5a11fbd445`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e133ab8382cce5bde0b0f5e2cef1778d595cea56aa422e6e6b4767e7e9b8592`  
		Last Modified: Tue, 28 Mar 2023 03:42:03 GMT  
		Size: 15.5 MB (15531126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbcdd8537fa4ff89cc44d89a3d10f9d574735f2f7c591f41e89bc07333f78a29`  
		Last Modified: Tue, 28 Mar 2023 03:42:02 GMT  
		Size: 1.3 MB (1270118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e481b646b65bcd11360de6442911d470fb1f6f47fbb8dab82f64d7c5bb2d79d4`  
		Last Modified: Tue, 28 Mar 2023 03:42:03 GMT  
		Size: 18.0 MB (17967501 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:023fcbb9350366f3e212c2bd32034658ff7adef51512d08ce45bea17691a198a`  
		Last Modified: Tue, 28 Mar 2023 03:42:00 GMT  
		Size: 642.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e69bafde5273352f3148e9d3491d5da60d09aaa39f21bd4cbc8d240d17cab451`  
		Last Modified: Tue, 28 Mar 2023 03:43:27 GMT  
		Size: 17.3 MB (17338272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9825ccbf0459893a8c0511d1c6bb60bcda16d277ad4289c0695c3cf6de0d620`  
		Last Modified: Tue, 28 Mar 2023 03:43:25 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5a6f50860223d71b82546c755480e6f9e1db47e02e4745180a4ef3297ff65c0`  
		Last Modified: Tue, 28 Mar 2023 03:43:25 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:e34a402804fc41ca50366e1a22b21f46517e2de35f3d1acd9650bd337f34e28a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187684350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0284dd30d64714c94125d56cf8435c0b522e58324c80a61d596996d1a245752`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 25 Mar 2023 01:49:17 GMT
CMD ["php-fpm"]
# Sat, 25 Mar 2023 09:02:19 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Sat, 25 Mar 2023 09:02:19 GMT
ENV GOSU_VERSION=1.14
# Sat, 25 Mar 2023 09:02:32 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Sat, 25 Mar 2023 09:04:43 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Sat, 25 Mar 2023 09:04:44 GMT
ENV PHP_MEMORY_LIMIT=512M
# Sat, 25 Mar 2023 09:04:44 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Sat, 25 Mar 2023 09:04:44 GMT
...
# Sat, 25 Mar 2023 09:04:44 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Sat, 25 Mar 2023 09:11:19 GMT
ENV FRIENDICA_VERSION=2023.03-rc
# Sat, 25 Mar 2023 09:11:20 GMT
ENV FRIENDICA_ADDONS=2023.03-rc
# Sat, 25 Mar 2023 09:11:26 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Sat, 25 Mar 2023 09:11:27 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Sat, 25 Mar 2023 09:11:27 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Sat, 25 Mar 2023 09:11:27 GMT
...
-	Layers:
	...
	-	`sha256:e1a7f69288fa32dd1770b539efd1dc6f1a1d5bc7fccc187f2073bd86a9fdb1ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad748c449586b2afcfbacd1cad93a48f38224aa8395fe4fe9593e932ccb539b1`  
		Last Modified: Sat, 25 Mar 2023 09:12:12 GMT  
		Size: 15.4 MB (15403696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c46988778dcfc3406104f983fe16f812d248fae4f4f084bc84665fab98b0ccbc`  
		Last Modified: Sat, 25 Mar 2023 09:12:11 GMT  
		Size: 1.2 MB (1233113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:066f2ca745d4ca6dd5f440ec1340d4a5d94b08fb6b78bd83b2ee30f7d5162720`  
		Last Modified: Sat, 25 Mar 2023 09:12:11 GMT  
		Size: 15.7 MB (15693752 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3a83e785429e12ac3a2c289b070a33205b37096a995b63bbac5b603fcf98c95`  
		Last Modified: Sat, 25 Mar 2023 09:12:08 GMT  
		Size: 640.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5087952f42a12bf50137936013b5a844819b249d047569120dde51f99c9d5fe6`  
		Last Modified: Sat, 25 Mar 2023 09:13:10 GMT  
		Size: 17.1 MB (17067592 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a92d38f4eab9215f29429935738ed320594bc46b2c42f04fdc30d37ad87751a7`  
		Last Modified: Sat, 25 Mar 2023 09:13:08 GMT  
		Size: 3.6 KB (3617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dc3dc924cf32ea796b0692f31b6ceaadb1250d309306ab80488be014007ecdc`  
		Last Modified: Sat, 25 Mar 2023 09:13:08 GMT  
		Size: 945.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:d9221827e5caa573eb369e084fd83a39f7f8bec419771b92812dfc60fc9c4055
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.0 MB (179037787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e61dddbf48a9e585a25d52d6ec7ef91d6586c7ad238bca6f174c694f16be13bb`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Mar 2023 18:08:29 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Thu, 23 Mar 2023 18:09:28 GMT
ENV FRIENDICA_VERSION=2023.03-rc
# Thu, 23 Mar 2023 18:09:28 GMT
ENV FRIENDICA_ADDONS=2023.03-rc
# Thu, 23 Mar 2023 18:09:33 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Thu, 23 Mar 2023 18:09:33 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Thu, 23 Mar 2023 18:09:34 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Thu, 23 Mar 2023 18:09:34 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Thu, 23 Mar 2023 18:09:34 GMT
...
-	Layers:
	...
	-	`sha256:e0d39ac1d4d9a45da24fa016d7a3754d22536cc1c1fdd9537ac2583917cf35b1`  
		...
		Size: 639.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b6e2916907641bb27f95d8cb2b7b155dca579472455a8e83ef18ecb06d28a0b`  
		Last Modified: Thu, 23 Mar 2023 18:11:43 GMT  
		Size: 17.0 MB (16960140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c318cb00a9db50f19bfe82ff63de9081a54ac7c6ad0a82b1a4995c6ada3a309`  
		Last Modified: Thu, 23 Mar 2023 18:11:42 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:961f4bcf3610ef2a02d49e1c1b830b28b82902ae34d571f5e6b6707ea4efa280`  
		Last Modified: Thu, 23 Mar 2023 18:11:42 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:19abab6ca5d5735d0660c3bbafebb6623132b23d9c678b5a60f18928120a8874
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.7 MB (202702077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bc826f17874131898765e6153af9a835cce9e9bf53a12e64ae44c605a4e58c4`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:600366f13a7a83097de9341c540f4735fa4fb1c088996da287f2957014dbde86`  
		...
		Size: 638.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e145837fa159d548c21045607e86dbde0ec2a5704c50261d881f1fcf9c990c8`  
		Last Modified: Thu, 23 Mar 2023 20:20:46 GMT  
		Size: 17.1 MB (17130564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c02625c432f91a04956249082905db4616d8dd38abb7c861d1841005867f8e8c`  
		Last Modified: Thu, 23 Mar 2023 20:20:45 GMT  
		Size: 3.6 KB (3616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:402fbe46edb0411e9166a83e9a9b8186c444f5607c093ccd81bdb1eae52aaa86`  
		Last Modified: Thu, 23 Mar 2023 20:20:45 GMT  
		Size: 947.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:4f5b97173068511e563bad55ea261ec75dc8ec21984fa86051e35ba552958f90
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.2 MB (215235597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d54ea4f05b9a84bf79089c952282174b2c32081cf1c300bf8a8487945331c6a`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:51:10 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Fri, 24 Mar 2023 00:52:14 GMT
ENV FRIENDICA_VERSION=2023.03-rc
# Fri, 24 Mar 2023 00:52:14 GMT
ENV FRIENDICA_ADDONS=2023.03-rc
# Fri, 24 Mar 2023 00:52:20 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Fri, 24 Mar 2023 00:52:21 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Fri, 24 Mar 2023 00:52:21 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 24 Mar 2023 00:52:21 GMT
...
-	Layers:
	...
	-	`sha256:b37cfc783c2e12a2bc1a81b8b9ed436f3153ee939727d97c69a7a3e95a45e434`  
		...
		Size: 637.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47697e52e8d28ff13fdf525c4262bef95af2fa001579cc4416d9b8947c36ad22`  
		Last Modified: Fri, 24 Mar 2023 00:54:17 GMT  
		Size: 18.1 MB (18087641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c2626c77c87f42782ab8e1f92ec9e14bade5e93493797b3374416037a0391cf`  
		Last Modified: Fri, 24 Mar 2023 00:54:15 GMT  
		Size: 3.6 KB (3618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5829ef73ef279070f71ed33da04c7ca76e29db283222f4d16aa6b41f89be134`  
		Last Modified: Fri, 24 Mar 2023 00:54:15 GMT  
		Size: 948.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:8fa7931df9cc27059fae271201b8516a77e3860e1bb6901a21a79ccb9cd08456
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.7 MB (211717417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39d74c785a4b839b4693b2c103c613d4e8307ff5e0d21bdd7b9333b76afeab15`
-	Entrypoint: `["\/entrypoint-dev.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 00:18:38 GMT
CMD ["php-fpm"]
# Tue, 28 Mar 2023 03:22:07 GMT
RUN set -ex;         apt-get update;     apt-get install -y --no-install-recommends         rsync         bzip2         msmtp         tini     ;
# Tue, 28 Mar 2023 03:22:07 GMT
ENV GOSU_VERSION=1.14
# Tue, 28 Mar 2023 03:22:26 GMT
RUN set -eux; 	savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends ca-certificates wget; 	if ! command -v gpg; then 		apt-get install -y --no-install-recommends gnupg2 dirmngr; 	elif gpg --version | grep -q '^gpg (GnuPG) 1\.'; then 		apt-get install -y --no-install-recommends gnupg-curl; 	fi; 	rm -rf /var/lib/apt/lists/*; 		dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')"; 	wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch"; 	wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4; 	gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME" /usr/local/bin/gosu.asc; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		chmod +x /usr/local/bin/gosu; 	gosu --version; 	gosu nobody true
# Tue, 28 Mar 2023 03:27:03 GMT
RUN set -ex;         savedAptMark="$(apt-mark showmanual)";         apt-get update;     apt-get install -y --no-install-recommends         mariadb-client         bash         libpng-dev         libjpeg62-turbo-dev         libtool         libmagick++-dev         libmemcached-dev         libgraphicsmagick1-dev         libfreetype6-dev         libwebp-dev         librsvg2-2         libzip-dev         libldap2-dev         libgmp-dev         libmagickcore-6.q16-6-extra     ;             debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)";         docker-php-ext-configure gd         --with-freetype         --with-jpeg         --with-webp     ;     docker-php-ext-configure ldap         --with-libdir=lib/$debMultiarch/     ;    docker-php-ext-install -j "$(nproc)"         pdo_mysql         gd         exif         zip         opcache         ctype         pcntl         ldap         gmp     ;         pecl install apcu-5.1.22;     pecl install memcached-3.2.0RC2;     pecl install redis-5.3.7;     pecl install imagick-3.7.0;         docker-php-ext-enable         apcu         memcached         redis         imagick     ;         apt-mark auto '.*' > /dev/null;     apt-mark manual $savedAptMark;     ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so         | awk '/=>/ { print $3 }'         | sort -u         | xargs -r dpkg-query -S         | cut -d: -f1         | sort -u         | xargs -rt apt-mark manual;         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false;     rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 03:27:04 GMT
ENV PHP_MEMORY_LIMIT=512M
# Tue, 28 Mar 2023 03:27:05 GMT
ENV PHP_UPLOAD_LIMIT=512M
# Tue, 28 Mar 2023 03:27:06 GMT
RUN set -ex;     {         echo 'opcache.enable=1' ;         echo 'opcache.interned_strings_buffer=8';         echo 'opcache.max_accelerated_files=10000';         echo 'opcache.memory_consumption=128';         echo 'opcache.save_comments=1';         echo 'opcache.revalidte_freq=1';     } > /usr/local/etc/php/conf.d/opcache-recommended.ini;         {         echo sendmail_path = "/usr/bin/msmtp -t";     } > /usr/local/etc/php/conf.d/sendmail.ini;         echo 'apc.enable_cli=1' >> /usr/local/etc/php/conf.d/docker-php-ext-apcu.ini;         {         echo 'memory_limit=${PHP_MEMORY_LIMIT}';         echo 'upload_max_filesize=${PHP_UPLOAD_LIMIT}';         echo 'post_max_size=${PHP_UPLOAD_LIMIT}';     } > /usr/local/etc/php/conf.d/friendica.ini;         mkdir /var/www/data;     chown -R www-data:root /var/www;     chmod -R g=u /var/www
# Tue, 28 Mar 2023 03:27:06 GMT
VOLUME [/var/www/html]
# Tue, 28 Mar 2023 03:27:06 GMT
ENV FRIENDICA_SYSLOG_FLAGS=39
# Tue, 28 Mar 2023 03:32:57 GMT
ENV FRIENDICA_VERSION=2023.03-rc
# Tue, 28 Mar 2023 03:32:57 GMT
ENV FRIENDICA_ADDONS=2023.03-rc
# Tue, 28 Mar 2023 03:33:09 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;
# Tue, 28 Mar 2023 03:33:09 GMT
COPY multi:2f4e03736ca9442228cc94182c2079247804f23bfe4331d8374052b1309b7647 in / 
# Tue, 28 Mar 2023 03:33:10 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Tue, 28 Mar 2023 03:33:10 GMT
ENTRYPOINT ["/entrypoint-dev.sh"]
# Tue, 28 Mar 2023 03:33:10 GMT
...
-	Layers:
	...
	-	`sha256:1c77056ff7b9af94e29861f40b95e7d3eade4c45012946173b694dacc9ce37e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:626e01d483302a06e7fba88bd5a9c2cb3c86803c8d2ad33e03cf115f9deb6350`  
		Last Modified: Tue, 28 Mar 2023 03:34:15 GMT  
		Size: 15.4 MB (15420642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23bc073bfb28a169a1ab55687dd40ccc4d23f37e69fbc41ca0a4a6552c025468`  
		Last Modified: Tue, 28 Mar 2023 03:34:13 GMT  
		Size: 1.2 MB (1169070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92d37d1d36bfa8a31d876e55aac3d853082453f2f39d7b6c01e0fe8da79a0e4b`  
		Last Modified: Tue, 28 Mar 2023 03:34:15 GMT  
		Size: 17.4 MB (17438686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:059931e17de6510800beb267f05476fadde28f9f14f98a89cbdb792ff2e14f5f`  
		Last Modified: Tue, 28 Mar 2023 03:34:11 GMT  
		Size: 641.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b6d77711f45587f319ec76842fb430f156c46d8c96c5da97e6d2576bf8f1742`  
		Last Modified: Tue, 28 Mar 2023 03:36:05 GMT  
		Size: 17.7 MB (17670131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb90210cecdb2c019fb87082114b50299ed2f6de7ae0992d970401e658bf4547`  
		Last Modified: Tue, 28 Mar 2023 03:36:03 GMT  
		Size: 3.6 KB (3617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bbaed821983a22294a9acc6eecace160351143013092ba5c093c6bfd35976f6`  
		Last Modified: Tue, 28 Mar 2023 03:36:03 GMT  
		Size: 949.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
