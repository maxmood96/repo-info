...
```console
$ docker pull friendica@sha256:79ec263a096c5ba6f28f9f2a27aada7fb19a29fd40cb18a854a9ba9a5b6bbce3
```
...
```console
$ docker pull friendica@sha256:11c435b8c87bccbecf271d7a9d9b4b7569b3ccab78291e080ca5ddf8559bbf9c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.9 MB (226909403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b06e48d6355e66f50804a4e014afeeba5492979118f514706a997e3e6ae002d2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:ef5f69ade106db3f7f66a0df904a0ab0904f018c49881cbe5b6400b6ecd3024b`  
		...
		Size: 640.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92411827864b4001ecb2039af4188bd72beceaef076236555580db729cfae27e`  
		Last Modified: Fri, 09 Jun 2023 01:56:04 GMT  
		Size: 54.7 MB (54662520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af706cf56d3d4619c3dabd45d1a3c31a08c75f10185736adb66e29973f641c9b`  
		Last Modified: Fri, 09 Jun 2023 01:55:57 GMT  
		Size: 3.1 KB (3136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76914289cc0545553b91b3bfd4eb88b6b44ad7f9dd2c486cac9b82cae459b234`  
		Last Modified: Fri, 09 Jun 2023 01:55:57 GMT  
		Size: 932.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull friendica@sha256:9053d01c2decae48b3f291210f5fe5045a228a097ff2c7af7da680689704adfd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.0 MB (242011738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a9e8bd85e09e5d65cbc77bc3ba57621c4bbda68cc03b725ba720d21aa7be035`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 09 Jun 2023 06:30:06 GMT
ENV FRIENDICA_ADDONS=2023.05
# Fri, 09 Jun 2023 06:30:07 GMT
ENV FRIENDICA_DOWNLOAD_SHA256=333e63c0aaea24a072c21393de3a1ac5b66e6cb25158db668417b842bedcdee7
# Fri, 09 Jun 2023 06:30:07 GMT
ENV FRIENDICA_DOWNLOAD_ADDONS_SHA256=6b6f486532a995f67bf6bc0d459ee371a2bfd2ba9b95c84dac49193cdfe76ea8
# Fri, 09 Jun 2023 06:30:27 GMT
RUN set -ex;     fetchDeps="         gnupg     ";     apt-get update;     apt-get install -y --no-install-recommends $fetchDeps;         export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 08656443618E6567A39524083EE197EF3F9E4287;         curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz";     curl -fsSL -o friendica-full-${FRIENDICA_VERSION}.tar.gz.asc         "https://files.friendi.ca/friendica-full-${FRIENDICA_VERSION}.tar.gz.asc";     gpg --batch --verify friendica-full-${FRIENDICA_VERSION}.tar.gz.asc friendica-full-${FRIENDICA_VERSION}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_SHA256} *friendica-full-${FRIENDICA_VERSION}.tar.gz" | sha256sum -c;     tar -xzf friendica-full-${FRIENDICA_VERSION}.tar.gz -C /usr/src/;     rm friendica-full-${FRIENDICA_VERSION}.tar.gz friendica-full-${FRIENDICA_VERSION}.tar.gz.asc;     mv -f /usr/src/friendica-full-${FRIENDICA_VERSION}/ /usr/src/friendica;     chmod 777 /usr/src/friendica/view/smarty3;         curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz";     curl -fsSL -o friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc             "https://files.friendi.ca/friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc";     gpg --batch --verify friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc friendica-addons-${FRIENDICA_ADDONS}.tar.gz;     echo "${FRIENDICA_DOWNLOAD_ADDONS_SHA256} *friendica-addons-${FRIENDICA_ADDONS}.tar.gz" | sha256sum -c;     mkdir -p /usr/src/friendica/proxy;     mkdir -p /usr/src/friendica/addon;     tar -xzf friendica-addons-${FRIENDICA_ADDONS}.tar.gz -C /usr/src/friendica/addon --strip-components=1;     rm friendica-addons-${FRIENDICA_ADDONS}.tar.gz friendica-addons-${FRIENDICA_ADDONS}.tar.gz.asc;         gpgconf --kill all;     rm -rf "$GNUPGHOME";         apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps;     rm -rf /var/lib/apt/lists/*
# Fri, 09 Jun 2023 06:30:28 GMT
COPY multi:ecba68c67f63e55d0b2b18cd57f1ecbe17d7d27bf9cb241b343fd490f8745145 in / 
# Fri, 09 Jun 2023 06:30:28 GMT
COPY multi:201dba5df7e408009a8882797a28095a47753a2db673a80c99e898e88501c42e in /usr/src/friendica/config/ 
# Fri, 09 Jun 2023 06:30:28 GMT
...
-	Layers:
	...
	-	`sha256:2bcb0eaef03b060cd4ef57f2710a6771bd52b38fb50f3547d78a500c07c44285`  
		...
		Size: 644.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57c7328d37ddb65d4122e9b21535fa9922cfcf39cc8e8b73951c59792eeb5184`  
		Last Modified: Fri, 09 Jun 2023 06:33:48 GMT  
		Size: 54.7 MB (54663568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b055c4e701c8e02d80d025bd137b130f838e072b2be47f7a0fcfd232d59758c2`  
		Last Modified: Fri, 09 Jun 2023 06:33:43 GMT  
		Size: 3.1 KB (3136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dd819560d1bf133adb5bbf9fa1bee0608e0e6eb5d69aeb682bed755128cf01c`  
		Last Modified: Fri, 09 Jun 2023 06:33:43 GMT  
		Size: 928.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
