## `drupal:10.5.5-php8.3-fpm-alpine3.22`
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; amd64
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - unknown; unknown
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; 386
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; riscv64
...
### `drupal:10.5.5-php8.3-fpm-alpine3.22` - linux; s390x
