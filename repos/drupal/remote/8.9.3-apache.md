...
```console
$ docker pull drupal@sha256:6945194cbe3e973bf0b1cb8b5f11f0344cf51841d0ae44c08cc54b2b3e98997f
```
...
### `drupal:8.9.3-apache` - linux; amd64

```console
$ docker pull drupal@sha256:2f0b16778c4d0074e40cb41c15bb1fea8b446b1c64006733f4917d3f7bc2ff83
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.8 MB (169816134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edfb5f82a0c1b19d6cbfec6c726b0afc06166f90f807cc2f968acbbf9a21d662`
...
# Fri, 07 Aug 2020 18:20:56 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:20:56 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:21:14 GMT
...
-	Layers:
	...
	-	`sha256:a5c6d0204bd7fe6c287b696d8e687389c5438d58db435d0ca8b85970af43d9d4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e5fec101af487cbfb6bda7fae777251c7cf553b6446aaee8460bc688ef3a913`  
		Last Modified: Fri, 07 Aug 2020 18:24:56 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce8019e0f7fdb8cdd0033febf49bdd75630780cd707bc93a72103f91a5b814ff`  
		Last Modified: Fri, 07 Aug 2020 18:25:04 GMT  
		Size: 20.8 MB (20752572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.3-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:33b1b43420ace44b91eb7e094d1978c82c295a407b0a54720da09c830ef48ee8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.3 MB (145251087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:639064a4ec6ebde738fe240f55c2d32e42caeb2d46ab48a86d1b5ead3d5d39fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:02:53 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:02:54 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:03:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:54e4cf3e6c179e27604dc7a6f36885da1c729234be48776400e4f31a0bff15d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c2b075295cc67405d36c15e45694030303a59cd183878f9b3da1fdb57c4b0a2`  
		Last Modified: Fri, 07 Aug 2020 18:12:30 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bb7b6a41c74f16d9b053eb61cc050a97f53e4a081d92c9161aecd25ecb0d556`  
		Last Modified: Fri, 07 Aug 2020 18:12:43 GMT  
		Size: 20.8 MB (20752486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.3-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:c075855cbf097720cf595d4a89a65763f1a0dad2b94ac6d33314cf0147c0f85a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161932945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ee4d62705bb32d0ff6cfff4fcfe534982a60ea61b5e8d9ce06165c494026578`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:41:58 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:41:58 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:42:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:6730ae5e2f0338adb60efb212889edd874f7e950404b8a52358502e6266b48f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f152bd0e7c1929319e51bfe02cf4c1c7bf9d661511fbdfa5d1d010d4f880f479`  
		Last Modified: Fri, 07 Aug 2020 18:50:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:855b010ddda57ef5f08748db18350bcf071c903f7ed1eda869574516ad20f449`  
		Last Modified: Fri, 07 Aug 2020 18:50:18 GMT  
		Size: 20.8 MB (20752526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.3-apache` - linux; 386

```console
$ docker pull drupal@sha256:084e81d472d7002fe149e72e8f66aa1273c89469ceaf4bd3756d85d266acc125
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.9 MB (175872132 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d53175614ef994f97332c3aa9f7737f9a59503c74494e21a7c5bf5e9cf905ea0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:39:50 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:39:50 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:40:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:b1e5bfdb4573f04cc8a3428fe2ca0db1a0ce3c0fdb5f4904b1a5cc73508f352e`  
		...
		Size: 505.0 KB (504971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55839176aff259a769244abb29014f7a4d5794654bf6dce77f0dbf5adc6d171b`  
		Last Modified: Fri, 07 Aug 2020 18:44:21 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c825cb202467bd5fe1609fefa5b7f87305b1baa88d39b3ea73df42bd429037e`  
		Last Modified: Fri, 07 Aug 2020 18:44:30 GMT  
		Size: 20.8 MB (20752189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.3-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:dff3a02a0ee9681c1d7c94d315e86cffcf0ae45d05b72b1c5113caca5b0c634e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181250269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ee2a2d6e5ab85db267ca9304455b44ddf06108cc5b4722a8a080c57be4b2a99`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:20:33 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:20:36 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:21:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:a8672b39ddb85e2630cde1ae956dc474de93ac8cf21824353dfcdd64650cc725`  
		...
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e85f9c57401768742cc5f02accb352a2ec2008fa4a45b9a0e4f85321b0beacf`  
		Last Modified: Fri, 07 Aug 2020 18:32:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e97117a4de4fd652549d0bab2724152fd52b014c6c4b91d92358a803e6d0a6a8`  
		Last Modified: Fri, 07 Aug 2020 18:33:49 GMT  
		Size: 20.8 MB (20752504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.3-apache` - linux; s390x

```console
$ docker pull drupal@sha256:a435ec881c988456b05dd124adc00e2949f20934d068e491b2c9641080098683
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155546726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0142fa8574f6c1841025840ae0a940e4ebc38a1155992042b1b467026ce2fd4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 17:43:43 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 17:43:43 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 17:44:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:696ca3926346fc670b60755e45375e4829a8bdae3c22189a05aa6996df1ee80c`  
		...
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0fbcb51d42eb7fc36e0aafb58c088a9524c0c6524a08d22e9e3693350cd3a51`  
		Last Modified: Fri, 07 Aug 2020 17:49:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb11b2c903019d6cbc72545fc14691ef7099140eaa3474a222d381ee76d44a6e`  
		Last Modified: Fri, 07 Aug 2020 17:49:05 GMT  
		Size: 20.8 MB (20752345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
