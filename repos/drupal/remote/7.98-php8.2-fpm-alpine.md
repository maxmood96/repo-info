...
```console
$ docker pull drupal@sha256:36b6e95bcad014e86b3c55ba5097fbcf9eb47c6c8cc6eb8b1d087e2a868ed091
```
...
```console
$ docker pull drupal@sha256:b0c395554f1dbfaf3d987bca5c56146f9ca79c009b60856ecd7f4820858801ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.0 MB (36981337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee5fa33d6d0d27fbdbb7808341e79ad0b966c08f4fef57384a915890f535f557`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:36e00b023cb139a3da16b0dc656a124477efdfa6e33eea2db247994783daf9a8`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa2dad7b8f4a8defb50be443b5ac2e490082ab0f4a45b6ea25e4ec07e34486a5`  
		Last Modified: Fri, 23 Jun 2023 00:21:07 GMT  
...
```console
$ docker pull drupal@sha256:3e99d361a8f14a6b0c232b2708d6ad1f51816ac02a820fea5d709817262b7167
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.9 MB (36933854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee0017f5252523d1c08e8d18eb02b9d2bccd1c57f0ca08902df1ab38e1add8ed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Jun 2023 23:52:28 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:52:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:52:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f6de0601a7e7fb1ad7f1965bdc12c8f0562ba0e8eff8f471bfa4666fe092f29d`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b7934345d9c28fc5551fa734695abf3253a662a200979c294ba8ea080b960d`  
		Last Modified: Fri, 23 Jun 2023 00:32:16 GMT  
		Size: 3.4 MB (3411137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
