...
```console
$ docker pull drupal@sha256:73c8cf7b84215f886deeeb084c16dedd4a003c70a81645ff03dbfb22b489fdd1
```
...
```console
$ docker pull drupal@sha256:a4009e0497b1c8b80b91c4e11ba0f9bb58b46b05f0d20d20727b3c4ab0fe87f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.3 MB (35338263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee75bebae55dfb2df156caf55537992a609c6450effa50c303c441c6cf11612c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 06:44:39 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 06:44:39 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 06:44:40 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d9762aa2aee7a6e32231974e9f24c811159dd832c3296888f7cfd8117d819241`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19bb4c1c8d265dd5587b7359124727548f536a27d99ebfd4cb0980d45db04863`  
		Last Modified: Tue, 11 Jul 2023 06:59:59 GMT  
		Size: 3.4 MB (3411145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
