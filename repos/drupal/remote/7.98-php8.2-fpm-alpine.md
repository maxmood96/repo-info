...
```console
$ docker pull drupal@sha256:e96814baa1e5fc2f5881ee94873f6a00e6967453a0bdd7d45c5804ca8e4c0062
```
...
```console
$ docker pull drupal@sha256:afa7eca2c3131a47d0878bbd3b8c8a1aada6d2cc6e838469a012272c2680dc11
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.7 MB (36734595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6dd3b2ac76b888094d550f81f5847e8d6b4b10180965d6cf5e5d0bbf3bce5dca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:41 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:41 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e0350dffd62d6dc9d9fb52992d3fc7c910248f60945d2d96ff1fcfb565077de1`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d88405ebfd3287ecdafcfd5a904ca5fb53a6fa6b8c52f91d45b4231508306c9`  
		Last Modified: Fri, 23 Jun 2023 00:25:47 GMT  
		Size: 3.4 MB (3411148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
