...
```console
$ docker pull drupal@sha256:52f11ac96c0c4ba4d6687a2bbdcc30745c8c56e2aec3c4f230d9c8fd42edf846
```
...
```console
$ docker pull drupal@sha256:2f864c316373442993a361c76ee84d298883ac71371096889c365408e000c71b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.7 MB (36694852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0e3d29a06e77a1e8b6b8213fdfc3c61ba46e567a9534be8445f8f48ab39b765`
...
-	Layers:
	...
	-	`sha256:a554972f328434e6ee02139b59b65489f6dae70d4b286967dc06b95e7a3addfd`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e365687bdab0ccb739a43155e0dee509b0abd57534e8729f57e9bbc4958a430c`  
		Last Modified: Tue, 11 Jul 2023 01:44:09 GMT  
...
```console
$ docker pull drupal@sha256:7cb9822d065fbe1b236fc6b456a860f8bd55dc9c5c5479403fab788cf5c30ab2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34772471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c2d6b9e08f1dc92c7f4f10d4bd415115730b84d79459e4ed78d62ad2e31674f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 00:12:03 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 00:12:03 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 00:12:05 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e979241d9c27c3bebb09d8f9fc392e81cdbdc998edfeb5c806296fcc57fdf947`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:229db6a657c91b228efbcf8a4935a66349e6105b3ca5a1b66c77da83672182f2`  
		Last Modified: Tue, 11 Jul 2023 00:18:30 GMT  
...
```console
$ docker pull drupal@sha256:d614a96e74229a5ea4036072c097415e7945a0c63cc38d9efbc76dfc5cbbdf24
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33475803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7818791eceb0a28c658809a1112b71daff3114b271eb972ba103e0748a37cb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 00:46:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 01:00:07 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 01:00:07 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 01:00:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:97e78c9798e650b5d1d4f627b4ca3c9698c3d9407c12b5e6447e7f10ad3a4fb4`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:276bd79fee4573d27e450cf568e834a4a76e42994b0cc06eb72cdba1f47425b7`  
		Last Modified: Tue, 11 Jul 2023 01:27:03 GMT  
...
```console
$ docker pull drupal@sha256:959947ce010c5993bd932a16f03be71fc1621b1621b40cb4e491f5ded278ae7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.8 MB (36760359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8dbd637004306f379368df85ad0cb4e7e4f862e96bb5f8613a5e8a56fdfd822`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 01:43:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 02:00:29 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 02:00:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 02:00:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e0da34de8fc3345367329ca4024d1fdc56f458e317493189bf23220bfb0fd04c`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:062225cc41f5c0032cef497bc85dbfa4fb26e93b2ea9db1a73c1411daf10c919`  
		Last Modified: Tue, 11 Jul 2023 02:23:58 GMT  
		Size: 3.4 MB (3411150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:dd958fe724bf85c83c17607169b2d7e7150d44b036ef9b4fa34792d2abcc3b0a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.3 MB (35315908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9eb37aae44208f0146446ca7b69122464b56a030d3ed1d76fac0a9b1a1fd315`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:05:09 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:05:10 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:05:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:75f4c67f20139ef417bbbe15d0fda1c820869d212614cabaad09220bb8695144`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bef694bc152b02ede9ae2fffdb2394dfd363f0bc0181bfa111643471ad74edba`  
		Last Modified: Fri, 23 Jun 2023 00:20:47 GMT  
		Size: 3.4 MB (3411145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
