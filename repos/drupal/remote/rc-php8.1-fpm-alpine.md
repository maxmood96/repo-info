...
```console
$ docker pull drupal@sha256:558936b5d3e58b79b9507f53bd7110b225e5f69ed763ce93facb1d00b395f5b6
```
...
```console
$ docker pull drupal@sha256:6af5827d5a55d3ff556fcb98f751ff0bc332f94032f2a2635b35f6e66802d878
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50741460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:969a12e66ad9a8f4cd614829624a6a66774b64d89eb88e4ef610247b3eb297dd`
...
# Mon, 25 Jul 2022 18:43:11 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 18:43:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 18:43:22 GMT
...
-	Layers:
	...
	-	`sha256:f7322f38cf6fc348836e43135d50fc0f6035321f22d4cbd5bd25fb60dcc5b7df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d1556ec79a5090279694cc85dfce0c99480ac919ca04988c60a3952eeb3d881`  
		Last Modified: Mon, 25 Jul 2022 19:01:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3657d808358acbcb70e9712101f6c3945d72bd48d0be9810c064faee00da7eb`  
		Last Modified: Mon, 25 Jul 2022 19:01:50 GMT  
		Size: 19.2 MB (19232134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:8a2c84945363866494bf70fc0c72f4181173123b8ae20b339c4875889a731e7a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48872997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffbc69e12675730a62cfa3eb5f3f54d2d228cc4a4eb11db01c296f3b1cc8d4a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 19 Jul 2022 05:12:23 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 19 Jul 2022 05:12:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:10:19 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:10:20 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 19:10:20 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:10:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:10:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2658eb413ff42e22304f6ade566204bfaa2720ed577dce41e3bf88ba6b23c35`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69b157233e883efd4a5fbcd045a5c442063b9258688677a794fd646bf5b156b0`  
		Last Modified: Tue, 19 Jul 2022 05:32:41 GMT  
		Size: 1.7 MB (1657013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c02e6795c30b671cd7168d28512f7f9d132d56f2a4c39d902b079442d20189e`  
		Last Modified: Tue, 19 Jul 2022 05:32:40 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56df0ff83414ad3c397ffdb73ba442625862c92e407ab157bea978db8c994e2f`  
		Last Modified: Mon, 25 Jul 2022 19:30:27 GMT  
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ff1ff2e67ea3ceb408359cca06bc5f7cee65b28f53c1b3c43237f7419383e7a`  
		Last Modified: Mon, 25 Jul 2022 19:30:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b692733e88355f0a0d6d714d7c2b7fd90ada7e93dfeeadd4b42f9848fb1a3c7a`  
		Last Modified: Mon, 25 Jul 2022 19:30:55 GMT  
		Size: 19.2 MB (19231267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7ba1b296847e6ba63418f2edd8abc8e8b3b2df803da1e225b820e63cff6f798b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.7 MB (47721491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86aea8f5857f8a1551ed68b3d01da8f46c5b8d647dae65621d77684e523f0627`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Jul 2022 05:05:40 GMT
CMD ["php-fpm"]
# Tue, 19 Jul 2022 12:18:58 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 19 Jul 2022 12:19:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:29:56 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:29:57 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 19:29:57 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:30:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:30:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95d59bb43d51aeeb445703ae3bd3875ba6ec7daa716d25631e59af9902e1f975`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c1c69aeccf9f51f0066f81b777ed0810100ee8f5fb6664be80ecc1c939729dd`  
		Last Modified: Tue, 19 Jul 2022 13:05:35 GMT  
		Size: 1.5 MB (1517908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab7acf8afccc9166544327d0ee203fe8aba54b2679b6f2e55699597dc33da003`  
		Last Modified: Tue, 19 Jul 2022 13:05:34 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc7b8a4ef9e6bb0bceac77c681d20f30b1865f73f658072051c909df6839a74b`  
		Last Modified: Mon, 25 Jul 2022 20:35:46 GMT  
		Size: 670.4 KB (670422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1e987c30c6cb6ee739ba9b958fa06e90c038cab4f3880e3646624c18734b4e8`  
		Last Modified: Mon, 25 Jul 2022 20:35:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea25625a32aa075fea9d3cd34842f4dc52f3aafbd1625b27651bf46ec961d063`  
		Last Modified: Mon, 25 Jul 2022 20:36:13 GMT  
		Size: 19.2 MB (19231917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9d364272c69fc5a22338701c92207d77ac3ebe31e555ca1ac0ad6c47a6263415
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50920545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a66d61226be79265903023719603707a1e58fec7ded31dd6acbde3e82c7bb6e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 25 Jul 2022 19:04:14 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 19:04:15 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:04:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:04:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d3778db1f7cbafac41fd5edce5ab11d6856e57cc6d515ba3a3d149685d56cc73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b44792d5e438ae2f0e9a1b3ca24245f1a370158e920c5da059e01792c4a536`  
		Last Modified: Mon, 25 Jul 2022 19:36:09 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35f4bc1ed768974bdec1f8931c7649f213eca9481fbf4a28f252cf8a60eccb68`  
		Last Modified: Mon, 25 Jul 2022 19:36:13 GMT  
		Size: 19.2 MB (19232568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:045051138eb8cec048b6cf369a36ce48424bd6a91e0b524b94b990f379bfb942
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51212122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ab203867d831e0864976be0a662b5508a437ddce80f5be61c811519d2e3837a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 25 Jul 2022 18:58:33 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 18:58:34 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 18:58:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 18:58:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:059b7d218bbbf41f78bc126a4227aba8039ac470875a64180966c22b4e47c9b2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a4f4bf63cf3824d2ea4ac88c59036c452b9d7bd7fd1fd362be63dd0286c6133`  
		Last Modified: Mon, 25 Jul 2022 19:28:37 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ec3642ccdfa0208581918e42e93b04a208c92b3ac9f4131177ed20f03246e45`  
		Last Modified: Mon, 25 Jul 2022 19:28:42 GMT  
		Size: 19.2 MB (19232473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:df3add3055aa50d56eaa1c816e7f36977741c67ca6c659d164844e984791d622
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50950305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1e839ccebcdc35b9349e00c9afbee92789808f895212b8d74c6382b7179e769`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 19 Jul 2022 11:37:50 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 19 Jul 2022 11:37:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:43:10 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:43:14 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 19:43:18 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:44:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:44:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e8c1c7a49f551e445152c51e590abddd920be962316097f84ce2bb39be6b204d`  
		...
		Size: 8.6 KB (8621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e28f7c56edbde8495b65554f5486f55db01d42c4cd35309d08cab1f5b84bb1c`  
		Last Modified: Tue, 19 Jul 2022 12:09:08 GMT  
		Size: 1.9 MB (1914881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b680df260e49adb20f6dd00800b475add97c91d0a024d2c7dfc314bad52052fa`  
		Last Modified: Tue, 19 Jul 2022 12:09:07 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da683f6b9ecd30fbe4daf5f32f1f0dabd6ae9ef44f1fe0be2952710c8a755fea`  
		Last Modified: Mon, 25 Jul 2022 21:10:12 GMT  
		Size: 670.4 KB (670415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:898f3faf53e2da96ba6178cfff1171db1615e428257abe05bb23035b791131e2`  
		Last Modified: Mon, 25 Jul 2022 21:10:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1c9ef6f9c266af2415e06ef1592b3d8ed71f0bb9bf3fdc15581eb561b54b070`  
		Last Modified: Mon, 25 Jul 2022 21:11:40 GMT  
		Size: 19.2 MB (19232332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:2dc71984db4bc35fcd4e61cf913009ec904416f45936345690bb5845b0c3d52d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49396237 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:404d995f34baf2b611da8a64226f70f63d349605676e4a8133eb84b647f65612`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:03:09 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Mon, 25 Jul 2022 19:03:09 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:03:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:03:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8f20dc670979c7afcf3b8e8d36cb429619be718d43d63e1c4917d1e63b256eae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bbfd19e51fc12e73a0b0e3fb8c26a5441fa108f5c83bc17ca386d59e9825613`  
		Last Modified: Mon, 25 Jul 2022 19:46:11 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d32e90a8e19ef531fb43699c841470f94ff2421ac610ac787c872f4327ba584`  
		Last Modified: Mon, 25 Jul 2022 19:46:15 GMT  
		Size: 19.2 MB (19231690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
