...
```console
$ docker pull drupal@sha256:c8230c33a76e9952fc53022c0a5a2d74ec5ece3dcaef2286fb85c58a0c13057b
```
...
```console
$ docker pull drupal@sha256:db4254b9016dd538601946283dafc22cc21496e31a76350d1300d0f1eef38f69
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48743762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0b189a2aad5972685eed993add6693e05ffc3eabe38cb5fca7109298a038b13`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 08 Jun 2022 23:51:42 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:51:42 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:52:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:52:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:548a2520971d97d8191e9d00327b870d8b215bf29a8d9fd49925f514d95b841f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc8ea8bd3c9d10665036924540370c2342cc7174417bd576fd56d6c455befb24`  
		Last Modified: Thu, 09 Jun 2022 00:02:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c57f192573bb67e932488062d5a7b0282b6307cce4b7df0231732052b5deab48`  
		Last Modified: Thu, 09 Jun 2022 00:02:51 GMT  
		Size: 19.1 MB (19137339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
