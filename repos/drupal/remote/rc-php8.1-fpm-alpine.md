...
```console
$ docker pull drupal@sha256:c49a9aad03701b27d05f06b9df25a0fb411b9a6ef2aa6f986828fe9a7e0c05a2
```
...
```console
$ docker pull drupal@sha256:dca730e7a8b1df79f85a62f9bb5796166bb3fa1f93a422d0cb8da35b7ad0cad6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50160778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b460a1dc8c0d749d9ad94b27550d03fb6af1339d33314e79eb6cef03bbe8e626`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:27:59 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:28:00 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:28:00 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:28:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:28:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9b7149dff7aeee402b780cf998f694c7e7fae3545823e61094fce07e6a3bbe45`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64c456acf582a838d85ec3b73aa770d83f50e4f1ecd9ea8db591f43f22d5c940`  
		Last Modified: Wed, 16 Mar 2022 18:42:05 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9d46668367c6ffb9ce5f51414937f6973277341a21435f760e37a17bc1f5461`  
		Last Modified: Wed, 16 Mar 2022 18:42:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7351602af044f08088f262d6baf514e8aeca36ea00d8891aab276cefae50d73`  
		Last Modified: Wed, 16 Mar 2022 18:42:34 GMT  
		Size: 19.1 MB (19129517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f385296f6d515d53af3c09fe9ebc2a6f77cc95b995f601ce0f5e0c4b100efe5d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50711790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7cdc934898d2b69ff984bf00c443c89c6813e355849af66c4db50a373640778`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:08:37 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:08:37 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:08:37 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:08:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:08:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae5516b44dc513f0673808e4e3a24152341948e5c91167203cc0242af4443c02`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0713db5608a51cf3851a52ed799365814027d2e9d66fd9a768b9431cad9fef92`  
		Last Modified: Wed, 16 Mar 2022 18:30:13 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7a25a509f9220b13b79d6e602eaca89a14a30476878fc897d12da9ba294561d`  
		Last Modified: Wed, 16 Mar 2022 18:30:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd7ae3a51367552c3a454c54a9f20c7a8ad17880229a8556ba1c45f5d96fc312`  
		Last Modified: Wed, 16 Mar 2022 18:30:17 GMT  
		Size: 19.1 MB (19129411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
