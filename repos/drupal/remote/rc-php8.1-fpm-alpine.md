...
```console
$ docker pull drupal@sha256:e2f9b920327e812525d2d9e1582e146270c980332c63c07087a21f0f70869730
```
...
```console
$ docker pull drupal@sha256:ec3b6861d6bac3c6ee56cd39a79d54347a6a4c821e198d28c7a10af7f1c4fb0c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49235145 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76baba1472bb4db5db68b26c3c4108eb5c9e01d4396173ac4d2bb0f64c6b2ca5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:14:16 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Tue, 07 Jun 2022 04:14:16 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:14:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:14:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d5a534e60d128eb35b95e067376eff23b2f639d5cb3002af4ad3294c70683011`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7190f50118c245cd536993592069cb09a9fcefecf077673fde6524cabcc9bd0`  
		Last Modified: Tue, 07 Jun 2022 04:45:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c14e5bc910398d35db07b6cd4bd270d4b0950fec888f0f88c2ee74086cdb040`  
		Last Modified: Tue, 07 Jun 2022 04:45:13 GMT  
		Size: 19.1 MB (19101750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
