...
```console
$ docker pull drupal@sha256:4da71c825b6904653a4826302526fa7a17793d0910c066b20c7fd2370153803f
```
...
```console
$ docker pull drupal@sha256:c6ef744c4b9aeb5102166754c6d3b76a6d28261cdba04cf66676ced677ea93cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50941283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77097940d0b18aabfdf562785b41241f185fe134c40526cb5df04ae15626bf91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:14:37 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:14:37 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 15:14:38 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:14:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:14:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c93812c1beb043e226914cc7f229e3ebe54aa9e6f455d9b3414c1ce18fc4879`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cf829c96e3b1d1ef7f19d494bac8e4f524261e92a93fc225eb77de519ea726d`  
		Last Modified: Wed, 30 Mar 2022 15:47:34 GMT  
		Size: 575.7 KB (575713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cc7fd3efadae2affbc77eb75a98d9cf2903f956487c3d881c4ff472e9b2f2de`  
		Last Modified: Wed, 30 Mar 2022 15:47:34 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65887aafdcf832b0436d588d4eae4747b23bacdfa0c2db882e5805e576811795`  
		Last Modified: Wed, 30 Mar 2022 15:47:39 GMT  
		Size: 19.1 MB (19129352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:367702323afbd610bd37bad1f9707422769116981c1903a728c6d06a4f84d53f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (51006946 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c856f5b08621e7f11febfa03dfbfc375d62ee58870bbb4d972f13c2c91b07015`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:02:39 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:02:48 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 18:02:56 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:03:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:03:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:382e499b6f5e785536a4d0fa063153ce30b2d2d3fcdfed76d9d8cd728b45fab1`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c36061749ef276e519c8cec52c93b5e93c83613a615b799230a126dd7af582dd`  
		Last Modified: Wed, 30 Mar 2022 19:42:36 GMT  
		Size: 575.7 KB (575717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51b1df7ad7b4871029fd61bf8b5c98e7d6d3ef63169ccfdf40b0b11ea60aaad2`  
		Last Modified: Wed, 30 Mar 2022 19:42:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f83a3e3bf2cf402812c3971b341746994442122c01114f42b94e8b94ae3808b7`  
		Last Modified: Wed, 30 Mar 2022 19:46:18 GMT  
		Size: 19.1 MB (19129609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
