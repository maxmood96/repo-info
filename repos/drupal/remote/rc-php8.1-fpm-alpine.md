...
```console
$ docker pull drupal@sha256:b62e1b6a44fa635aeec0b7c90642a537494b8da3a5386eef3e8ad1f814cc04d8
```
...
```console
$ docker pull drupal@sha256:e4128d87d8b10e20e6ee4638eb15a71427d1bae46d0f97d1b7fc3df4ef3c9119
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.6 MB (47576968 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3690cf1f9b9369ee38af52131145826d84ae338615eef925efcf9b4cd17d8dbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 21:14:28 GMT
ENV DRUPAL_VERSION=10.0.0-beta2
# Thu, 29 Sep 2022 21:14:29 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 21:14:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 21:14:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:16abf28505a961cd0c3f84cedf7eaea62f1a23b37b787af46a72450c6802cef9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86d6e453c668d564b0e2cef45a7409e8587cd20ac90559754898ad722c7208a2`  
		Last Modified: Thu, 29 Sep 2022 21:29:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87d0dd099e19772c13157fc94d22b4d71c52433df3e6ceae387a52fa0c397413`  
		Last Modified: Thu, 29 Sep 2022 21:29:42 GMT  
		Size: 17.6 MB (17568610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b5d8015c1069fb348f4695e3bd4a351a65148d218a30c4da4e6fb03fc5541aec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.4 MB (46395141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c0f2c91ce91cccbafed2b8bd59f3331e47cf8ebe1ebd105f8e55b1623a31353`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 21:46:28 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 21:46:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 21:46:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dafe7d44a1e85b6aa97caba9cbc62590bd532e0d9fa70fe9b212daaa26d995a9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e02e26dd1f8438cd71739bd9769cf2ed2101db3e719cad1c5f4ec7ca38ece31d`  
		Last Modified: Thu, 29 Sep 2022 22:34:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7199cf8dcf09cf40b6236726f731f03fc085f9d472c095c0646069094f15abf`  
		Last Modified: Thu, 29 Sep 2022 22:34:29 GMT  
		Size: 17.6 MB (17568351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
