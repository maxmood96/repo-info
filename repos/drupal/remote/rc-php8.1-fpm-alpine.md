...
```console
$ docker pull drupal@sha256:bed5e35d5c6de3a7293902628597dd0c0a3fb043c56aa1c8811f0d251a692e6c
```
...
```console
$ docker pull drupal@sha256:0e393a96ad06f0f2182b7924603949267d2737fe3374e5fbe87211cafc178e33
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48873377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:079a6d328371c8d345dd3c076a21c0ca49bd1d414f143241cbe5102d62a6bcb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:21:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:21:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc2e6d69b052aed3502f2c5ab4d1f093b48f236f98eac84a51ad8cec83ab7829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8be352651aaae782b6cff243e23a13af3445cf1ce5a173771ac19518c22b372`  
		Last Modified: Fri, 29 Jul 2022 01:47:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:944abc33cbc54d9edf7b843e99d083018da8c823133aed3d6a15e8f28caf8d66`  
		Last Modified: Fri, 29 Jul 2022 01:47:18 GMT  
		Size: 19.2 MB (19231628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6334319ccbaedbfa2f2d76feb96afec5961843fda857e27e2083d1c7ba16282a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.7 MB (47736360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e17ab314d7a37735167571d6134a4e2e1f991f32823759ac78f0eba4c2f3fc1c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:05:08 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:05:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:05:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b824af9a67013f89ccd77575e5c128aa4f70aa1c18b2786fcdf65019479f1804`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31031b1eab37252e3c28bc607e2240772a21d484f3e49984c7afe87af6d45d1e`  
		Last Modified: Thu, 04 Aug 2022 09:50:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61db7032e42e46a9c6460fdb56578136d6d36b1beb1a8727f1b0173a2315b2db`  
		Last Modified: Thu, 04 Aug 2022 09:50:47 GMT  
		Size: 19.2 MB (19232082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d693af2dd5a38ffe75eda23f71d0f877eaa3b8d648b66924dab57c24bbd042ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50962722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4bb4222aba0e1242c62b7e4a25fb21dbcf7da4593961ae32319aa593abdd0f5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:04:50 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:04:51 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Wed, 03 Aug 2022 12:04:51 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:05:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:05:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bcfcd8c14a26005b8d4738e7771c2b770b208b4780ae39b16d8182b50879b6e9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c415cbd3e8083c4080db51282fe89f4e31da82ff96a2f1a90af97c01134a4a9c`  
		Last Modified: Wed, 03 Aug 2022 13:01:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb965141c1d0a11cced601439aab2e369fb4ee798b12b6055e40ab45fa93ce18`  
		Last Modified: Wed, 03 Aug 2022 13:02:16 GMT  
		Size: 19.2 MB (19231761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
