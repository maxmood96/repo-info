...
```console
$ docker pull drupal@sha256:6ddd40334697bc29e07f3a248d1a13ee000aa6b3f0b2501c5d5a421e28636441
```
...
```console
$ docker pull drupal@sha256:01dfd7b19e6893ae759bb2f99a870166aade7866fc654d5439df66419390472c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.5 MB (46500668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f9080c223219fbd2ed148f85a6e31a671dad541ece36bb642dabe8e66f9990b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 12 Nov 2022 16:29:57 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 16:30:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 16:30:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:113898370ae99b41ebd615f2d3869ace6de8ac015eef0cdd173f98d6ead36911`  
		...
		Size: 695.2 KB (695187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665e5fc59392ec222c966aa158cab60cbea546ceeaaeceb55d49ea90ea831d0b`  
		Last Modified: Sat, 12 Nov 2022 16:56:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d5953766fbfa5b1c2fbced7039978bd34b2e7aee37a1347f01ba456ed5951be`  
		Last Modified: Sat, 12 Nov 2022 16:56:48 GMT  
		Size: 17.6 MB (17568702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:51bfe61bd4b5d18774863c027c7fd650cac0df7a6242d00c0bdfe1084d558a76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49761958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e90126b307fd750e59fa374620ed1a744abde8e427e3aea93d4ee5d8c1487d99`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 12 Nov 2022 14:01:36 GMT
ENV DRUPAL_VERSION=10.0.0-beta2
# Sat, 12 Nov 2022 14:01:37 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 14:01:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 14:02:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aca744de4604e33cc719f8d03a01970a414665077b1b0752b77f5661335544c3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7b7fa4b34c93e5b76b800bdeaa87ef8c511d2be7a8be454431ed5a1c0a11d64`  
		Last Modified: Sat, 12 Nov 2022 14:21:29 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07ec39794aa25662daf9fb4b28c66ef916a199d813172fc67dd26bf776aed0ad`  
		Last Modified: Sat, 12 Nov 2022 14:21:37 GMT  
		Size: 17.6 MB (17568860 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
