...
```console
$ docker pull drupal@sha256:fce39ee3e478a03560d4a55bd9a7eea6dcf3594d0b5e8f6bf97ceb77b36f9887
```
...
```console
$ docker pull drupal@sha256:708c18de7e3e9f8ba845872b5298936f6d21d9b6e93f114393bd69044050eeb2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.6 MB (47567982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:567a3453aa5482019eaa279c1e3bcdffd608281b593c3318c2560044bc19d2c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 17:02:48 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:03:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:03:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f69cfe522cf560e4dbdcdb90ece8b210a1ee58b0c95541d16599cbe1c27ac847`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fcc8205bf71ce072fadcd4410e744074840504d0716ccfb82094930d607be8f`  
		Last Modified: Wed, 01 Jun 2022 17:55:51 GMT  
		Size: 661.6 KB (661583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c96996795c9ad6fc234dc3b2391a0cfbee5b6a15e1c73d7541cdb79c064139d`  
		Last Modified: Wed, 01 Jun 2022 17:55:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8812524afdee1788ad6864ed6e6bb6372ffd28b07e2144aa2398e1de14be17f`  
		Last Modified: Wed, 01 Jun 2022 17:56:20 GMT  
		Size: 19.1 MB (19101429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
