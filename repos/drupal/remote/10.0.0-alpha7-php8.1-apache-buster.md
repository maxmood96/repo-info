...
```console
$ docker pull drupal@sha256:8dfea4261a1446a3917b01b5c2283863f0a4f85a5d64596556e35097ca6a4662
```
...
### `drupal:10.0.0-alpha7-php8.1-apache-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha7-php8.1-apache-buster` - linux; s390x
