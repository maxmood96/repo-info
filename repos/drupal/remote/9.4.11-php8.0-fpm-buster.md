...
```console
$ docker pull drupal@sha256:79366faed658425059c3e580efaea8ccb1f538e50f988359b5b9f9c98c805bbd
```
...
```console
$ docker pull drupal@sha256:d9a71e5ba04efdbf993106de57e4886be5e6eaa3b8a9c7ac503caf4330ebd1bb
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140867303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ba96abe11c06154a183086ebde1fc533a363645c87db1834cfb0e1d983bcf2f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:06:43 GMT
ENV DRUPAL_VERSION=9.4.11
# Sun, 05 Feb 2023 09:06:43 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:07:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:07:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d2f2fa8f71fbef0cd5da2f5a1c4e3c120b6c4e523741885cbe78fbc456de08b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1ff3ff5ddf214b3f9d960ac312fa2b6c8f9d74a4350f516a570d9432b9bbf89`  
		Last Modified: Sun, 05 Feb 2023 09:36:58 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bae48941723d11dadbbe6ef7751983dc23dfe933ed07cbb43c0a7c266aa333e5`  
		Last Modified: Sun, 05 Feb 2023 09:37:06 GMT  
		Size: 21.9 MB (21910245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
