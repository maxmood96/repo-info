...
```console
$ docker pull drupal@sha256:1c78636cd9db81c0c963bf270e64573b6f59fabdb9d17857ab3860e154d5ad39
```
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.3.16-php7.4-fpm-alpine3.15` - linux; s390x
