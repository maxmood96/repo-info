...
```console
$ docker pull drupal@sha256:85100bb4d89f39bf50cd15d182bf900b758698d14b42431d047bc70644c385ad
```
...
### `drupal:10.6.7-php8.3-apache` - linux; amd64
...
### `drupal:10.6.7-php8.3-apache` - unknown; unknown
...
### `drupal:10.6.7-php8.3-apache` - linux; arm variant v7
...
### `drupal:10.6.7-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.6.7-php8.3-apache` - linux; 386
...
### `drupal:10.6.7-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.7-php8.3-apache` - linux; s390x
