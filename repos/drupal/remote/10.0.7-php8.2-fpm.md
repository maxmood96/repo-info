...
```console
$ docker pull drupal@sha256:e2093412d505b4eb9c946ec77fadee33075c306b90da6ba032c72105b66a3983
```
...
### `drupal:10.0.7-php8.2-fpm` - linux; amd64

```console
$ docker pull drupal@sha256:cce857145ff1f9c421c92d36a9800343b51eb07f2035b95573403c3fdcd48b24
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.4 MB (182404932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96f481be36c5c3ee901558d93338bb4df30cb7e0dc762a4364764d0db4299a60`
...
-	Layers:
	...
	-	`sha256:28ae380ad6def7bf08d362684950329c7bf8d9812fec228b6338e28f5cb5983a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9f3f175c7c24f0cd028946faafaa0dffdfde150e30e4280dfcd93e662af9353`  
		Last Modified: Fri, 14 Apr 2023 19:54:18 GMT  
		Size: 2.1 MB (2116783 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0945845e0315ddd3863c31b1868a1dbca440452adeea33ad4335e7cdf15bdf13`  
		Last Modified: Fri, 14 Apr 2023 19:54:17 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:026ecf18321cbad6626bef876931e6e65259c41d89ca2805c42aaf07ce8df0d0`  
		Last Modified: Fri, 14 Apr 2023 19:54:18 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:427644b6d9ee8c53b87fbf01873d30a3698c888f40ea92fa1c2e6f65754e47e5`  
		Last Modified: Fri, 14 Apr 2023 19:50:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec7bcb1967ad45eb10d2b47895917817e1f5e6eb89eacf1317cefb9d06f3de57`  
		Last Modified: Fri, 14 Apr 2023 19:54:21 GMT  
		Size: 17.7 MB (17671235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:88037b0d1934388134f45aa87a8067128c7ab8859b7c7e3ff645392784bcd44a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.3 MB (152349764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4816926b95a52b1fb9e6e9617cbaa19f6f20ef374ad093b57d794afe1b7c974`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 14 Apr 2023 20:06:18 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Apr 2023 20:06:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 14 Apr 2023 20:06:19 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:06:19 GMT
...
-	Layers:
	...
	-	`sha256:887e966ef0be27657705063f66dcf7117a9f5e7a287a4dcfc2249fbbb623a814`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c92b581077e88603cc636720e0236f94b7b7e3c246ea12d5ac0433aea2f3e98`  
		Last Modified: Fri, 14 Apr 2023 20:23:32 GMT  
		Size: 1.5 MB (1497597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f236601ecc65d7baeacf1d6f8e19daf4ae57a9306568ca2dcb01e9b78f8db713`  
		Last Modified: Fri, 14 Apr 2023 20:23:31 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4244f1eab2dbb4aba06852e59b0cb5e54a23bf0b064e2c861ecd9a59421e06`  
		Last Modified: Fri, 14 Apr 2023 20:23:32 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8318bbb7dfdb3262fb09b00b2856bad259366d384251795d36b7e76394d96a0e`  
		Last Modified: Fri, 14 Apr 2023 20:23:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3952ad6a58dc3955367a70c5ff182b19662794da0684d38527857d7fea7da2f9`  
		Last Modified: Fri, 14 Apr 2023 20:23:37 GMT  
		Size: 17.7 MB (17671038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d490f4270885992069993b28c3b3252f6600098b5570691adeddf9fd79734191
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176641617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:745dc0ee67d47c61f9ddc9691c028e0e011bd2aaddcf9f6a214820ee1fc7f120`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c6a7671d735df82693f53bb2566d4a4ba7b740f5349ede05e33d44f366f56121`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:797931b4d4b5d1300553254ff1e26768792b3e0bf621bec7943c981e67c06db7`  
		Last Modified: Wed, 12 Apr 2023 17:47:19 GMT  
		Size: 2.4 MB (2380718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fddf0706b8ac8923a95c1e9cb428a7e1939d971653e40e559e7a777b77062506`  
		Last Modified: Wed, 12 Apr 2023 17:47:19 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:838eb1a82c87d1e1f412c1dde764ad41288f03141fdc22a8417bb399ed0480d6`  
		Last Modified: Wed, 12 Apr 2023 17:47:19 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f8024bba2dbfc28d7ba28019e1c162dcc3c3711072a62bda99622607f75ee7d`  
		Last Modified: Wed, 12 Apr 2023 17:47:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a67d0a5f108dccf2462eb46fcbe2d60a0e5f1e9d9b3eaf46bdf03de1b462e9`  
		Last Modified: Wed, 12 Apr 2023 17:47:22 GMT  
		Size: 17.7 MB (17670786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-fpm` - linux; 386

```console
$ docker pull drupal@sha256:6a61adb4c780c8e9c47e293815fe5980c1c32fbaa8ba929f9b677ede843119fe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (184999897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:768e9353704f9a613dd9e4920a54633a86c1b46e5515909bfbd42174e4f11419`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 06:10:01 GMT
CMD ["php-fpm"]
# Wed, 12 Apr 2023 23:12:17 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 23:12:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 23:12:17 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:12:18 GMT
ENV DRUPAL_VERSION=10.0.7
# Wed, 12 Apr 2023 23:12:18 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:12:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:12:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6b2674f8ab630089ce2f8d151aef93b9b3fc9f20b4a0940fe0f01fccb40fd0f0`  
		...
		Size: 9.2 KB (9182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9031395ecfd319555a970270271c199ec4a76b49c278cc68790f2708206d51a6`  
		Last Modified: Wed, 12 Apr 2023 23:33:13 GMT  
		Size: 2.2 MB (2180861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3d5ca2631d9008fe7af13df45c191a5c0aad67ca6de290d057f73fc85ad23d7`  
		Last Modified: Wed, 12 Apr 2023 23:33:12 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a682eba0856c19dde0835d5750ba4cb6dce9a58d1300ac3b0759e993eac328de`  
		Last Modified: Wed, 12 Apr 2023 23:33:12 GMT  
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6eef48db5a65de2b32377f851bb0779266b868b1773c65628578a45b49b8ee3`  
		Last Modified: Wed, 12 Apr 2023 23:33:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87cb8aef7c3afa06bd945f4d52ba2c9d27402b9caf8d85a35e43a90c178d5b8a`  
		Last Modified: Wed, 12 Apr 2023 23:33:23 GMT  
		Size: 17.7 MB (17671158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:c2e07b49416c834f9e5e21e53f56353125e43cae77ab011c621afb9598395b56
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.2 MB (182230782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c23e70d21de6b79d7a8c1a68631849c18349716ca36fec333598e510bdba359e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 14 Apr 2023 19:28:36 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Apr 2023 19:28:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 14 Apr 2023 19:28:37 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 19:28:38 GMT
ENV DRUPAL_VERSION=10.0.7
# Fri, 14 Apr 2023 19:28:38 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:28:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:29:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1482ac31c2dc21354ffb87689d69790f575c484df76b3bb35b4add8afb251845`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56c71d332a4cfed47ddd45a85a75e7b826ab469e567ef51023cc5f119a54c416`  
		Last Modified: Fri, 14 Apr 2023 19:47:10 GMT  
		Size: 2.0 MB (1983858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f10683a71efe31d9273d35540ec0e70dbd522ca46a61e43bd0e23886a54071ce`  
		Last Modified: Fri, 14 Apr 2023 19:47:09 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80f2e2a375bf453624a70bdae30e93ad21ffeaefedd0f6c4f56acb4314b3cae3`  
		Last Modified: Fri, 14 Apr 2023 19:47:09 GMT  
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b938a062894633553c4c983319fa3d72c323ae288156d1dbdf436b83d699970f`  
		Last Modified: Fri, 14 Apr 2023 19:47:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c20ef5d0c3b930bbb742cf2de3c5aff70719b2ccefe5e7ad3bae2f39d1ca5a0`  
		Last Modified: Fri, 14 Apr 2023 19:47:17 GMT  
		Size: 17.7 MB (17671188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:328245a0737fbe5d2b0da57270836257715a18c97a7925c9c2e57554b92ee6cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159271291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d48175d2c0d3ce929e409f292ff281d4b8c58f2fe70ec325c5aaaf0dcb05e1ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 14 Apr 2023 20:05:12 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Apr 2023 20:05:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 14 Apr 2023 20:05:13 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:05:13 GMT
ENV DRUPAL_VERSION=10.0.7
# Fri, 14 Apr 2023 20:05:13 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:05:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:05:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6de8b82725bb3cdb115402b08fef3d6b5643575f536245f4f46c8411e20224af`  
		...
		Size: 9.2 KB (9182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a0fe5f85cdf143b14f66b61615c2666e90a65275b227e0f74e4d11ccfbdd6ad`  
		Last Modified: Fri, 14 Apr 2023 20:19:09 GMT  
		Size: 1.7 MB (1711167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e81b933c5b91e55748e0207f6c057ce00a236630070df701c74bd1adeedc9b7`  
		Last Modified: Fri, 14 Apr 2023 20:19:08 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4fd070158cbe51a4f24610fb117de85dd35433c83e493d05d220717c88ccc8b`  
		Last Modified: Fri, 14 Apr 2023 20:19:08 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4551b8d9d91edccc47a4ebf12793f312e293f2be8169f14eb7a0794b74987220`  
		Last Modified: Fri, 14 Apr 2023 20:19:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5154959dccc494c1b32ab591272bee738dfd84793f58e5b018f22d88c6be6033`  
		Last Modified: Fri, 14 Apr 2023 20:19:13 GMT  
