...
```console
$ docker pull drupal@sha256:7bdd3a4e6a33154667ca0be3baf3e8734c2c1b9eed56e0b0278a7e7b5b6005ed
```
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.3.1-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.1-php8.4-fpm-trixie` - linux; s390x
