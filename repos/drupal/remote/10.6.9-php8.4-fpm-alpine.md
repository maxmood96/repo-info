...
```console
$ docker pull drupal@sha256:ec6b094b9b346e20735ae5225cbd867a066edb856c02a3aba6b66aa9e6af35be
```
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:10.6.9-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; 386
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:10.6.9-php8.4-fpm-alpine` - linux; s390x
