...
```console
$ docker pull drupal@sha256:9f0b4ac3366c880aa215ad567fdfba0265ea21a6b2c283fb106f547b7dfc0dd0
```
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; 386
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; riscv64
...
### `drupal:11.1.6-php8.3-fpm-alpine3.21` - linux; s390x
