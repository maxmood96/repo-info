...
```console
$ docker pull drupal@sha256:88f2c44047b60f2018ea8c24cd563831140ded34b007eebb18c7e3dc4b436294
```
...
```console
$ docker pull drupal@sha256:181b45cc0ff9e216c0739969f40cd5f222e84f56065e0661586dac78a24f0146
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48898532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28a3b64ff16e2e6a7d33279a2724b812ea81d508dd719e18e29dc0ed1b74e4f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Jul 2022 11:30:40 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 11:38:49 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 20 Jul 2022 11:38:49 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 11:39:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 11:39:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15dae352df3645edc3b5df9f12bf9f6c220451ccbcfab7ef518eded869b8c3b1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:146d3eabc3f5824bb064519a449358cf7575eaba4db94bb5e6475466272b7542`  
		Last Modified: Wed, 20 Jul 2022 12:18:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38292d4dd51a922e2f13ee74a9ea55e5ff9e9fb18cb4d80a35c2004003a3ab1e`  
		Last Modified: Wed, 20 Jul 2022 12:18:37 GMT  
