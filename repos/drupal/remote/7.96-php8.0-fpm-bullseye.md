...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; amd64
...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; arm variant v7
...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; 386
...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; ppc64le
...
### `drupal:7.96-php8.0-fpm-bullseye` - linux; s390x
