...
```console
$ docker pull drupal@sha256:cb08deff2091d3d759daa2ad2f84961f31219a588a0ca3cc1b3cc40bffc2627e
```
...
```console
$ docker pull drupal@sha256:8c8abf07ba166d5d3c8c220cdf6136f4eec6723bc1b83576a838ecd2824523b5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.5 MB (47509874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50b884a1068b061bdd56ba2c75cc6909fd846a52ad80f2a99b304462e8c5baf7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 01:18:18 GMT
ENV DRUPAL_VERSION=10.0.10
# Fri, 18 Aug 2023 01:18:18 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:18:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:18:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5cd99e2f8662e786b17185a37ce9c8bf13d753600f486dce37de548d8690e829`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1bd8ed4c79ce8fceb016b96e1d7c076c91f6973d444ea106c258b87fa99470e`  
		Last Modified: Fri, 18 Aug 2023 01:31:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7dc22638289f6a58c03fdb665d166fa59b6e6c2902d445c9fee8eac5a3b008d`  
		Last Modified: Fri, 18 Aug 2023 01:31:09 GMT  
