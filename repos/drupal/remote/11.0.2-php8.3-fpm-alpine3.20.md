...
### `drupal:11.0.2-php8.3-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:11.0.2-php8.3-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:11.0.2-php8.3-fpm-alpine3.20` - linux; s390x
