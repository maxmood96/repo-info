...
```console
$ docker pull drupal@sha256:8223cd1359af77ad34532ffac51cbb62cfaa794b83359f1b2c8befa170d51afb
```
...
```console
$ docker pull drupal@sha256:4b0d6183e3562de4f3fea560895cb97435e8a9491b88ea857f8e80f69f5bebdc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33542180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6f8767141ddb2de7aff12f3b98a796d7a658b168972332a6fc380cb48db91b2`
...
-	Layers:
	...
	-	`sha256:ae784f0e4e9bf25cd127dea1aa51fdc75462551f6f721c77681fa523d7421c98`  
		...
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:818a96a188db65a6df6ced58ba0ad767bd41fb0c3b4fc39ec911d08c2bbf7e29`  
		Last Modified: Sat, 01 Oct 2022 01:22:42 GMT  
...
```console
$ docker pull drupal@sha256:76c17f4c8541cf1cf36c5b9aad380f2cf91c6de68b3405d0b2cf3f5526450ed2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.7 MB (31726875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13cf3c9d3b7a43a98800dc8898feefdee3441cd44021186776ea48536c0d5642`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 01 Oct 2022 03:30:44 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 03:34:42 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 03:34:42 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 03:34:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5dc5c0bec58a8b49a0966d7d31ae6dfa9a1f2f593527d7919c0c7759f39e3395`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:669b1a031ded016656f0f73f75032712099ab48c22310c4a40c210a2b27739a1`  
		Last Modified: Sat, 01 Oct 2022 03:43:26 GMT  
...
```console
$ docker pull drupal@sha256:33d02497a9ce9853ff0f7249e3c024352c25de48f8dbc442d904a09e606b7527
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30531001 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2a3f1be10c74a823692aa1999d3e58a51b5ff176bd98f7d5ed122f6f0f7e4bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Sep 2022 06:51:11 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 07 Sep 2022 21:10:54 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 07 Sep 2022 21:10:55 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 07 Sep 2022 21:10:57 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:365267c889cc69e2a955d2cf4d70c566acae7849eb69425f24d5f7d6fe6b469a`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb46aae76c94c259e3fa5e10eb5bd372e9601001c4b0d0856fe8570e55351fe1`  
		Last Modified: Wed, 07 Sep 2022 21:38:41 GMT  
		Size: 3.4 MB (3397085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:af396866f5e7052140feb5ac2a271336e49eb40627daa2e18f14d75a2f63e23f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32535730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d804adc7edf5524f072906a99fc8bbae39533acf7f09fc981a542d5f923a03c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 01:42:07 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 01:42:08 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 01:42:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c010e7e160c0d115fd41065ab8b14f8e0eaad15ff42c55653480e34adcdce2cc`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6c31dc76994c44be595bbc8ca3470f746b10bd49291d4af0a876b421a6be5eb`  
		Last Modified: Sat, 01 Oct 2022 02:05:20 GMT  
...
```console
$ docker pull drupal@sha256:779534f2d8245fb06137b4873b0a044f2196cc9e2dc6bc53a8b5d25cbcc4dd3b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.0 MB (34017164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41af069b82a224bc6fabca9ee49db45c27196a1b1be10767fea55387106b8f16`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 01 Oct 2022 00:15:32 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 01 Oct 2022 00:15:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:22:36 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 00:22:37 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 00:22:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3783550e3c5c6fc6aad9f7d2c4a2167de7a2b9ff7c2e64ad068a5baa02a54cb5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b84992f3ce79365a4d90994dede06f6a1f7cc33be0c194dd7a3674a9ad734af6`  
		Last Modified: Sat, 01 Oct 2022 00:39:34 GMT  
		Size: 2.4 MB (2413942 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78b1d374d0e44e76b8d7f53977779a1c2da523331865f4d6de5fb3c86f9b0612`  
		Last Modified: Sat, 01 Oct 2022 00:39:33 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1350324ca61c827ae5824d2cd8cd6567216a2101b81c371f8514e5601b9704e9`  
		Last Modified: Sat, 01 Oct 2022 00:46:53 GMT  
		Size: 3.4 MB (3396797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a68a4ffb02511f9c28bfcedab84d69ef3a695766836690640ab64d9074b71e27
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33835250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe53d0766c7bb388276a48d5dcbc504a8afbf5e900e853da32ed6761a5cc0139`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6d0ae95814775b097a93cfa5c0f24999946d3454c305c4305b223808efaaa02b`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a6439c97e652ad12da533627841df002bac078a70ee6767006971702a195edb`  
		Last Modified: Sat, 01 Oct 2022 01:25:23 GMT  
...
```console
$ docker pull drupal@sha256:5acb7a7bd6071603395bb3772df041119387b69178b88bb08a6f56633a8b468b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32289932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3c299da1e84fbdc794283ca6cf86c6a7babd0549a62d58de2d9459baf8a2ba9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:04:40 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 00:04:40 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 00:04:41 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b600bb1cfbadc5116f624172ef2071d90941bddf271171b5028c2754d3d26315`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:988a78108773a1fed4bbcaef813489d04402e11c755cc32152e73406fffb3dcb`  
		Last Modified: Sat, 01 Oct 2022 00:20:14 GMT  
		Size: 3.4 MB (3397085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
