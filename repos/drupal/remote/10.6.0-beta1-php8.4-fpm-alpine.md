...
```console
$ docker pull drupal@sha256:d6a8edb5d36acf0c67371d0d80ef625c083cd5d7485e7864f44c59aceb1769cb
```
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; 386
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:10.6.0-beta1-php8.4-fpm-alpine` - linux; s390x
