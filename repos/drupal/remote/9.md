...
```console
$ docker pull drupal@sha256:e26680771056742ea226c1250fc613dd3cba763c1b7e9378da57fd7bbeb63d4f
```
...
```console
$ docker pull drupal@sha256:64ee9551a6ad91f559f41a89982fb5354eded686566388735e843fd07f5a1f54
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191548427 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5d2c64d2d4d1956e3558a9b617c23b968365b3458ae3a6fc0b94528304d63de`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 May 2023 07:21:24 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:25:35 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 07:25:35 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:26:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:26:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:36017ac9e55dc0373a624fac06b06bd08c3a6377408d42a350d5c04698184033`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c49f8d809df1f4fb509b723488418847054fd177cb111fb621ac99b9f10336c`  
		Last Modified: Thu, 04 May 2023 07:51:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76d5cc498fd625216653bef926144a9ba72a15b91b5a7f3147d5910d26665f74`  
		Last Modified: Thu, 04 May 2023 07:51:46 GMT  
		Size: 22.9 MB (22878248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
