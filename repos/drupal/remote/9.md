...
```console
$ docker pull drupal@sha256:4ec113c242b521ae1621abf3f6ea4e406d9da8f73671fc4c67a578231bf999cc
```
...
```console
$ docker pull drupal@sha256:16b28f69a798cc06e449651fb0559f2d4b48c9280a9e2aab5c0bdc6d30ac198b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (194049123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40fcb9a3c51fff7039dbbafa46c047390c6ac805e7ae4bda278b917a986f891c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Mar 2023 00:15:35 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:20:09 GMT
ENV DRUPAL_VERSION=9.5.5
# Fri, 24 Mar 2023 00:20:09 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:20:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:20:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fec8de5c8fe2e353dc9f86a02a1e737b98501f21e5562acdf27530c3b380bcfd`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ff641a8dff5bc0c67677beaf5e6987757297f8ee0725f756e6a90a239f0eb7f`  
		Last Modified: Fri, 24 Mar 2023 00:35:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:948862cdeada740518e15cf81d3a9e40e05034529ee6af43d1ed7c97280b179c`  
		Last Modified: Fri, 24 Mar 2023 00:35:44 GMT  
		Size: 22.9 MB (22850109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
