...
### `drupal:11.2.9-apache` - linux; amd64
...
### `drupal:11.2.9-apache` - unknown; unknown
...
### `drupal:11.2.9-apache` - linux; arm variant v7
...
### `drupal:11.2.9-apache` - linux; arm64 variant v8
...
### `drupal:11.2.9-apache` - linux; 386
...
### `drupal:11.2.9-apache` - linux; ppc64le
...
### `drupal:11.2.9-apache` - linux; riscv64
...
### `drupal:11.2.9-apache` - linux; s390x
