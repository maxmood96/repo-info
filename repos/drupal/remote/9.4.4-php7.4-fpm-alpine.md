...
```console
$ docker pull drupal@sha256:af4771ac80a7986c3dda4415309f8c83ac05b356853f4828e6190b633163587a
```
...
### `drupal:9.4.4-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.4.4-php7.4-fpm-alpine` - linux; ppc64le
...
### `drupal:9.4.4-php7.4-fpm-alpine` - linux; s390x
