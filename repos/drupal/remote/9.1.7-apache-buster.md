## `drupal:9.1.7-apache-buster`

```console
$ docker pull drupal@sha256:a7f87d30491d86c4c6fd269a5e0476d9db3b3774a08d0b7493a4b639f6612c78
```
...
### `drupal:9.1.7-apache-buster` - linux; amd64
...
### `drupal:9.1.7-apache-buster` - linux; arm variant v7
...
### `drupal:9.1.7-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.1.7-apache-buster` - linux; 386
...
### `drupal:9.1.7-apache-buster` - linux; ppc64le
...
### `drupal:9.1.7-apache-buster` - linux; s390x
