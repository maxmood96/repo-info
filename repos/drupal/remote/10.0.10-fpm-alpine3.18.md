...
```console
$ docker pull drupal@sha256:92e7194d8ecc5cc090f018f1eda9a95bc578bc40b8ac1322921dd7fe985ddd3e
```
...
```console
$ docker pull drupal@sha256:d952b5d84ef3008a9536ddc4a1af235398b00d83d2daf149cb1a68fcbe587d2c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51675124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15690f6594723173141e7226601ec3fc147b8eb9e7d743f83b5d942eaec70ec1`
...
# Wed, 09 Aug 2023 10:43:39 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 09 Aug 2023 10:43:39 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 10:43:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 10:43:54 GMT
...
-	Layers:
	...
	-	`sha256:fff58cee92a35dcb2d7f126581f46f137aa22893ae17f7731cd179f7af8cf5f8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96cc2685ff0f0a7e9aa8d58c010d364dcb9e00319a723c61e6bc2f8ec1ca62cd`  
		Last Modified: Wed, 09 Aug 2023 10:58:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c927a60be1c4248f611057073533b4277af79026c5f29c685f55fcfd35207d32`  
		Last Modified: Wed, 09 Aug 2023 10:58:21 GMT  
...
```console
$ docker pull drupal@sha256:ee0d4eadaf5c257a32db649ecda6e02945b18df77e04952c565c712f3239cd89
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50319225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d972f4bc81271be70f8fe726a24ce318b355671a13166f3838637c951026f88c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 05:21:58 GMT
CMD ["php-fpm"]
# Wed, 09 Aug 2023 09:07:58 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Wed, 09 Aug 2023 09:07:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 09:07:59 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 09 Aug 2023 09:11:52 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 09 Aug 2023 09:11:52 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 09:12:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 09:12:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0488671e66ede0f655e258313e9190a9efd778178b3ed2704246ca94f26ccd55`  
		...
		Size: 9.2 KB (9178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1d8ec391a654d77e0764e7ab1f4d3f6497e1b50d960c71e9ced4fb669429e96`  
		Last Modified: Wed, 09 Aug 2023 09:25:39 GMT  
		Size: 2.0 MB (1998977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f721fd28f77c2c670879c3fae1696a29b18403815ca8efa087706e1fe581844`  
		Last Modified: Wed, 09 Aug 2023 09:25:39 GMT  
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ece78e013418f146cf09d81652f4d825b354d4fd2c0fe8d4547c8e26c3af19f`  
		Last Modified: Wed, 09 Aug 2023 09:25:39 GMT  
		Size: 698.2 KB (698231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:712a9b4a580e66d39dd8ad25502d70ce4666106e69361ddfb222bf2b5e4c42f6`  
		Last Modified: Wed, 09 Aug 2023 09:27:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee540897f7e3c8afe814d35cdc28ef505b75881d0a3216692dec42aba28e11d1`  
		Last Modified: Wed, 09 Aug 2023 09:27:39 GMT  
