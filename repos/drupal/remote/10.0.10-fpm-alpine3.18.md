...
```console
$ docker pull drupal@sha256:24cf16b3fbb7c24e339eac7c3fddee4473a13607159dc075311c2920360bea2f
```
...
```console
$ docker pull drupal@sha256:0c5c8ef8340f31f518f6d958031111ca3b4eacc58673dc51dbd5a1e13f8fc512
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49725246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45bb9719fef7095d5ee453bff109c48472b03359d029f4436bcf948fc5814b2f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 07:36:11 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 06 Jul 2023 21:50:20 GMT
ENV DRUPAL_VERSION=10.0.10
# Thu, 06 Jul 2023 21:50:20 GMT
WORKDIR /opt/drupal
# Thu, 06 Jul 2023 21:50:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jul 2023 21:50:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cc96958b49f44229c081ec279752671aa08572b2a3e115d57ac1c84b7f280034`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbde92c30f75c69e62e5bef7af3c702533234bb534c2995459262f6180c73c18`  
		Last Modified: Thu, 06 Jul 2023 21:56:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23ad1237d6c7382a6ed53fb4a30c232e0a32c2911afe542ebb0a0975a837ac6c`  
		Last Modified: Thu, 06 Jul 2023 21:56:22 GMT  
