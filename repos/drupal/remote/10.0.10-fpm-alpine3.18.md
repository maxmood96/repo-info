...
```console
$ docker pull drupal@sha256:c38884ebc86eb3de72a51a31cdc372cfe706c0aa2605fb57ba78ed6f819c2aa7
```
...
```console
$ docker pull drupal@sha256:514676c6231727a3ae35e14494fe52f4fbdaa5764886959d12faa62d270f9a7f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51741936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0d7806411436710e31aa15e0a564cdb7e200d912205048d228f612dff57cabf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 07:52:15 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:05:35 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:05:35 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:05:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:05:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22790b861bade2131f11bf3e71cb7bbee1dba691fdefaefb899ca42b6855b5f3`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d51627d5cec3efc5389748fcf645b7bf71a59336ad2f1d3d1c1b4045b694ccb5`  
		Last Modified: Sat, 02 Sep 2023 08:24:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76b3f5f9bfc2664efc8a0c0ce244e127871c053194fa2a46f8e218f2eb1baa9c`  
		Last Modified: Sat, 02 Sep 2023 08:24:46 GMT  
		Size: 17.7 MB (17688274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
