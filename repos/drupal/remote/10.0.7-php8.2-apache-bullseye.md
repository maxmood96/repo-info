...
```console
$ docker pull drupal@sha256:ac4965ed49d51c4252eb834c305adce4e643518a83f20c1b0655416a6baf988e
```
...
```console
$ docker pull drupal@sha256:6fde74501add9efba276aa7821dbfe24f82aa1c163fc8977ea78d661bcdca414
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180696459 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:477be38aa15d35fa84accc7c7ef8a42fcd173ef241e6ed77ceaf88b0732f5ac9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 17:24:49 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:25:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:25:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8283e7544f5370959f290dbe9b44cebb224545f2f8257df2544e6efbcbcdee5b`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fe9bb2e11ec41aabc3ded7c8de45894ad48e40563b246821c11820940964630`  
		Last Modified: Wed, 12 Apr 2023 17:46:14 GMT  
		Size: 2.4 MB (2407066 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89906941a2400ef61a31a53515ead39abe8cf7333a8ac2fa025d78f86af53d09`  
		Last Modified: Wed, 12 Apr 2023 17:46:14 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8309b88ae64da6cdb26b060abb398e7c0227fd90f0977dcaacbd03926931c407`  
		Last Modified: Wed, 12 Apr 2023 17:46:14 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf1daa8e078e14efc930635938e99c35540e0b0822d117d636515b4dd4e8b112`  
		Last Modified: Wed, 12 Apr 2023 17:46:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f50cdd9a01533643e370ab665c539c74c446eb74670fbd2dab5a947f2d91a52`  
		Last Modified: Wed, 12 Apr 2023 17:46:17 GMT  
		Size: 17.7 MB (17671072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.2-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:01d5bafb6f942868832e6b532ccab7222633554373b314041669763effbc0a90
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189351955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:049a4f3369840772dca45479090140a2cdac83534f4365b1b436506a7d18433a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 06:04:55 GMT
CMD ["apache2-foreground"]
# Wed, 12 Apr 2023 23:10:58 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 23:10:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 23:10:59 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:10:59 GMT
...
# Wed, 12 Apr 2023 23:10:59 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:11:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:11:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a13535e8f511327c7ed44d2d12065a5c9c802ec366d0a45e1f3c80e4c1fd7398`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f3b17b49dac585f69511e14be4deb7f1459bf9917eb0f8386508364c6ff569e`  
		Last Modified: Wed, 12 Apr 2023 23:32:02 GMT  
		Size: 2.2 MB (2207070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b7f45d8b1bf09a991665bc4b24b9cb5b4396df6b862c1a8f33c78842cc190f4`  
		Last Modified: Wed, 12 Apr 2023 23:32:02 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d560520709b0e61fe06b5b288d06734d24dac1b120c5e85787fb776f75c64d53`  
		Last Modified: Wed, 12 Apr 2023 23:32:02 GMT  
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b36a65595e0e2c6beec72ce93cfafcaba024f6b8dfb89e34568f54e5e33d088d`  
		Last Modified: Wed, 12 Apr 2023 23:32:02 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65f35cfab1924ee8ae5fe548080d2d77a0d8dc79988fad972062f0494fdd140c`  
		Last Modified: Wed, 12 Apr 2023 23:32:10 GMT  
