...
```console
$ docker pull drupal@sha256:9371f8937585814a4cb4f1e1e2a892238c3721dd63840ed4e96510b832eaef68
```
...
```console
$ docker pull drupal@sha256:3bcf4f05608bdfb9e7e6ec76dd0bfe698544a2f4541e15354d571883a2628a2e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155937092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05d424ede069e95af387baaddf299d90d2a35a7ccf486e2bf776701925beeebc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 28 Mar 2023 00:12:46 GMT
CMD ["apache2-foreground"]
# Tue, 28 Mar 2023 07:26:35 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Mar 2023 07:26:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 28 Mar 2023 07:26:36 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 07:26:36 GMT
...
-	Layers:
	...
	-	`sha256:c36370c786f018380269a6df62989745a65dfd146634e460f186e0215d816119`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2210f4d06b591990855eb94ea2f9fca2fb22e81ae8efa1596859633e4338c73`  
		Last Modified: Tue, 28 Mar 2023 07:50:17 GMT  
		Size: 1.5 MB (1523165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:502dff10edb522376a7ad46f0b7148d8ac391bb8433bbbfaf997be9007f0da07`  
		Last Modified: Tue, 28 Mar 2023 07:50:17 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8fabe305c72f1636bf2952ca41ae6a1b6cf0d61df1bacf7448c04aa5b4657fa`  
		Last Modified: Tue, 28 Mar 2023 07:50:17 GMT  
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:817655b0b4451de7143b60a57c48ddc7dd5389682fd30fa3e41a0307c5e2144f`  
		Last Modified: Tue, 28 Mar 2023 07:50:17 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d827bfe737f0f0a9e3bed8acf621548e9d71fc58f9a32d4abb0631a8050ec9e1`  
		Last Modified: Tue, 28 Mar 2023 07:50:24 GMT  
		Size: 17.7 MB (17670234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
