...
```console
$ docker pull drupal@sha256:0a0ad4c573e731537a0a454f020596e6255247f2a227b3e359b01bee37e17613
```
...
```console
$ docker pull drupal@sha256:580fb22a4e951fec12bc3877460f29972ef04f66b5e05a3f4e158ecf45b2e016
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.9 MB (35850772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9f82ec23826c3e930d7a0caba1a2ee782d7340b68bda109f0a975e4b04ebfc3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6ea64a11e58a30836d21ebec69e813fdb47519a48f320354daf080b933ef49d3`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6da7c5c68ebd277c15da075571e6badad32c3df2a2a5361cad2e4fe17d6d346`  
		Last Modified: Fri, 23 Jun 2023 00:21:21 GMT  
...
```console
$ docker pull drupal@sha256:5ef6d9bfeb8b3ae2195667cf1f171e1b3c0ba590927950baddd76404c7436b9f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.3 MB (36264157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fc743c1d5627a8c52a3756aef77941af26f36c0d835dea847e93ff472dab832`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:45 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:45 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0ba0e28a39186404bf26205ec0cbaa2f5b30a97ef54576da99106bd0dc43fa68`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9865545660a4a984739f5ccac5d233b3849e1b973ab8caf79dba92829d18b47`  
		Last Modified: Fri, 23 Jun 2023 00:26:19 GMT  
...
```console
$ docker pull drupal@sha256:21478d9d63f78ce9d2c6a0466de7361e9d6e5fbba2ac978bebdf65199e6f3216
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (35970398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8b47544f4766e5db2fe64d2c28487a77d903babd2339d56574e40d2b1759809`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:52:38 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:52:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d122cdcc7af94728eb3eb2b2d9b74424f1a7f5f080caedf4d401c5885b362dd0`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d727a5f69d7ff3ceb49e3bf065a0617dda342f191822cd6ab70ba826634944d`  
		Last Modified: Fri, 23 Jun 2023 00:32:36 GMT  
...
```console
$ docker pull drupal@sha256:81ed82da3e8dacb66b5bebf0c5bc0454602012c410cced9016a9a95309996136
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34310140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ab43506d19d9b13fd664dc7a4dc9968ba504a9e48bb971eb97197224033c258`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:05:19 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:05:19 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:05:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:97168fcc7fa2ab8fde351340bd959ffe5cdc123c598828fe456b601b293af594`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df074fa8e8fff11328cc6735a498d72b0700900fb8de14b1be0defdf5751f63d`  
