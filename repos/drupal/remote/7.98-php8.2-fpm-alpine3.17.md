...
```console
$ docker pull drupal@sha256:2048f8bdf61b6ed0480118a555c32c0dd81cb2e564e56c3949ad2a35196d1130
```
...
```console
$ docker pull drupal@sha256:2a3d05607cceb7aafdd9a56574ba55b4a4d3102b95659046568b199daca39f79
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.8 MB (35759344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acbbdae0e46d395c279732387e41a9f31e54a3cc19c68d0b3d3c6e318ef5bfc6`
...
# Sat, 02 Sep 2023 09:36:15 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 09:36:15 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 09:36:16 GMT
...
-	Layers:
	...
	-	`sha256:cce1476afb0350c21d3bc49e22620ab75ba897b8dd203e3bb1f5ff72687c79ba`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:838467c26a4ded1f39d803d80542f6664801fd4790669d2ef3ff3af5947ab1e4`  
		Last Modified: Sat, 02 Sep 2023 09:55:34 GMT  
		Size: 3.4 MB (3411171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5fded8185dee4ff7ac49549b4662d4f3fd3eab4ca511d12579ca40e447978669
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.9 MB (35872225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4379d9911ba0571e3d9d83024d7cb1f6b96cf13ddd9e68c38f42f7fdcfd7c0d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 08:15:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:30:41 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 08:30:41 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 08:30:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:69f9efbbe5a89a26c0f33765fe3366d30da7cc08a818a4f870353dc67b46c23e`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:351a36dc66a48b4c0964cf1e224d1bfb426d288ed6586387ae9d083712e01095`  
		Last Modified: Sat, 02 Sep 2023 08:49:48 GMT  
...
```console
$ docker pull drupal@sha256:32a147ec8bb2cae5c87d333b29083daf14b9f9dd99d72d1d4391fd613528efd4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.3 MB (36297886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:addbb7dab190c7af9dd4c8fc98240195987455f7872263a6f522d1a5dbb5dfa3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:12:08 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 08:12:09 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 08:12:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:daedfd1944104df08637d0c1f9c57daeaa7688b561d34d969b0fc8e0fcbdb270`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f012b464a7f99fbec582e8b6b0cbcda9cc8197e1ba3cafbf4bf66553a1b556db`  
		Last Modified: Sat, 02 Sep 2023 08:35:27 GMT  
