...
```console
$ docker pull drupal@sha256:9f7a1a0cb8971e55c4636b245082556b7203d0c115c7552ea024f74c874539ee
```
...
```console
$ docker pull drupal@sha256:7b690eb349e9609a28e93d5fdc379fd9aa08618a2e29a2eb85482515ed7bdd20
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33760289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c022c89d1a3a7fbf1670a1faa9605f8657eb464884c96b677c6783fed2d53a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Aug 2023 23:38:15 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 17 Aug 2023 23:38:15 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 17 Aug 2023 23:38:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7c004c6cb0c3d076dfb1c2cf51bc33322b9abca283439c90b6740ec1a83001c7`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:827bd2a91d0cb83ef1882c7a1198c6f2fb304d8c10bf17b8981be1506c73fde1`  
		Last Modified: Thu, 17 Aug 2023 23:42:30 GMT  
...
```console
$ docker pull drupal@sha256:ac1478f397b94d6be46bc66a1c085b4e480e15051ea98d6128a562f115d858d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32534281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa294802f7e1928322589a4a376ffba8d767706d708fecdcb3fbb018a2838bc1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 01:16:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 01:21:07 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 18 Aug 2023 01:21:08 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 18 Aug 2023 01:21:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3f1aea389ddce98313b8587ce3bc315af7ad9c47e79e8eea92c9fffad8910ad4`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68177d30aaccb99ae4faca6459988389ecbc30ec0d3448ede5fe590e31e87924`  
		Last Modified: Fri, 18 Aug 2023 01:35:19 GMT  
...
```console
$ docker pull drupal@sha256:7a9c77c982d0aef0be865d81b20a57b5a6f85a630c24291540d936c710e22cab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34334415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab17253e3ba6a36667ad191c4e9cabc835e8b01a4420c517bcb64d864832c224`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:713f77fb55dffcb5c507753834ccce088ad6da770aa05740051187b8149d1952`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04865563c18dc4e84a938f7aa0dd3d7b5f5f509b14a712ee293bf96b28943175`  
		Last Modified: Fri, 18 Aug 2023 01:08:33 GMT  
		Size: 3.4 MB (3411153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
