...
```console
$ docker pull drupal@sha256:0038771d3a1bee02dac8b90a5dcf46b60b7c85162f4b1747a8792e774716f504
```
...
```console
$ docker pull drupal@sha256:7dac242daebf9b67cca3ba5ee8af30bd184f4a3effc63dad7af61b624d1e1587
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.6 MB (38586713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17fd71cdd87649785ae2182622e13a81beb78b63fcf9eb8f9a6277ad0de17e7d`
...
# Sat, 30 Sep 2023 05:29:24 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:29:24 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:29:25 GMT
...
-	Layers:
	...
	-	`sha256:da133f281834656554a4bc08f74ea70c3ef6fa0c3a79fb691ea9cbbd7860776b`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6a8f3f9c92568babeb0e68c979dfbe4f918b0598c9370731d2ec5952c3ff0d7`  
		Last Modified: Sat, 30 Sep 2023 05:50:05 GMT  
		Size: 3.4 MB (3411159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.98-php8.2-fpm-alpine3.17` - linux; arm variant v6

```console
$ docker pull drupal@sha256:dcd2153a07153a93efb7ca6a368a750385c3cd42f12e9cd1a131b30c2cdace0a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.2 MB (36246157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:703b0774ea33af3a5588279b05175cba1620267fdb5e18cd1de91d542010fc29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 03:03:12 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 03:03:12 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 03:03:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1f0a73cd70b641a523b6759dc9619d96fd5f30f277e7e7a79b6edda416db82b3`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8620dee149e8591db2dc6fc268e45ba94815a75ead1b9a9177af7d0901ab7020`  
		Last Modified: Sat, 30 Sep 2023 03:11:13 GMT  
...
```console
$ docker pull drupal@sha256:3bf2809a3ca38e844dfafa6dfa223d20b23e868726bb7c0c16133c94fa671f67
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34838553 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30cd90c702d2721034c207228a14ae9d981f0740f0c003feb3c6cc172690990b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:19:42 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:19:42 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:19:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d36c9243b035a29a593db6b6e6b0f6ff07c8a184598793bff27d4d3fa8ab96aa`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:416cc0b292d64b87461d13d841130a75adbd545207b1c5b2e61bdf73125074b6`  
		Last Modified: Sat, 30 Sep 2023 05:44:49 GMT  
...
```console
$ docker pull drupal@sha256:98d7b58a4458e76975b6ee4ec03e8d849529d26df83ec754ba23d974d2fe9bb6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.5 MB (38534377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab3781c7b495235a62091d93cfad8870967dcf3dd7df8dcc39333fb429299380`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:15:59 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:15:59 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:16:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a038e5c100f7492f19f7762b6b0f94f2dd0a4c429ecef59e709ef8aca1908f06`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c68eaac053e53d050d7b090f03bf56fd642f5ad55725ecdd493ef5c930ff3c7b`  
		Last Modified: Sat, 30 Sep 2023 05:38:08 GMT  
		Size: 3.4 MB (3411156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:1994d5f207b9fa054db0e1a1645dbf22047f98e9ad04688806d6c4d7a7cafae7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.2 MB (39200965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d831d4c323a9527c11d99bc8c4ac6716b5a1eab9c0ca737aac3ca4ffc986d68e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 06:19:29 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 06:19:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 06:19:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:004ca1a31aaddaeed0537b634b11b854809c47ddd512a1db78259827c47c04da`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42b08f6abd005fb7c698c41d34df42508734ff21d8442eabaa39b6ed76ccb635`  
		Last Modified: Sat, 30 Sep 2023 06:44:46 GMT  
...
```console
$ docker pull drupal@sha256:6687c846dd5bd6484bc8c57c1af02fa1391a881b0ee93b4b542d80bc0ec3058d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (35998333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e44e0579250e8789cb8f65d12a2590d94d5bb6627f5419a27e05b073650e2d04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 11:26:23 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 11:26:24 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 11:26:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e5dd57596a9b119c36ff00f97c3b012789cac36d4ab62467713c663f2f64580d`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c27a75f8e3b785f9f5b0162926211de1c4c59795da5b9f6037b0bfc12ab91575`  
		Last Modified: Sat, 02 Sep 2023 12:14:18 GMT  
