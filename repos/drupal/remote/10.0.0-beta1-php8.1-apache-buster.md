...
```console
$ docker pull drupal@sha256:507ace7d6cd6c432ee112dbd80daee292397e3b30f6b226084a1f6f836bd634b
```
...
### `drupal:10.0.0-beta1-php8.1-apache-buster` - linux; amd64
...
### `drupal:10.0.0-beta1-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta1-php8.1-apache-buster` - linux; 386
