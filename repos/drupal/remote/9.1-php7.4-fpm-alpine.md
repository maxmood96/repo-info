...
```console
$ docker pull drupal@sha256:0d60c0b5737f18c6e206cd925b90031faf7cebc6452593225a33e8a21cfa2d6b
```
...
```console
$ docker pull drupal@sha256:eb795615d9aa3defef87d2cf32897364d7629adb76f90ee9a1ad726f7c286494
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.6 MB (49630506 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6543e7bb80cfd09536746886fa9e37eaf45d7be8b063341bfb01e47da4321170`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Fri, 27 Aug 2021 05:56:17 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 27 Aug 2021 05:56:18 GMT
WORKDIR /opt/drupal
# Fri, 27 Aug 2021 05:56:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 27 Aug 2021 05:56:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:604e7ae7b2297c4f50ef40832e2b336ff90c3f6f50e8ce9206ba9c47e98c4ec8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72ecc6ff7fa908d83c31210478b168587284d32ddc1bd5f671b8c07cd8b86eb2`  
		Last Modified: Fri, 27 Aug 2021 06:33:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c77b51f285e393296750cc59dd1606f4e37a1685e438e89bc104d41631244d4d`  
		Last Modified: Fri, 27 Aug 2021 06:33:56 GMT  
		Size: 18.9 MB (18875833 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f194e1d2f757271219f972ece25d9a63fc057e7ec41633d2cae0bd61230f85dc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53837863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad069fdfdf34c8f902fc6baf3d1fafde23e0d38bdabaa13e0a1ad0c67b586e26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Fri, 27 Aug 2021 09:26:20 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 27 Aug 2021 09:26:24 GMT
WORKDIR /opt/drupal
# Fri, 27 Aug 2021 09:27:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 27 Aug 2021 09:27:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4165a9c38d2fada2dc2dc48ba29edbfc89d71b4ed783636a4f76fc80db91def2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1584185367dc7d2d3b39a64579ae6c3fb7c293479988ff139e70a958c400882f`  
		Last Modified: Fri, 27 Aug 2021 10:30:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d819449352943d096dfd436c11149838baace9671c19d2ded1be7ceb14c3977`  
		Last Modified: Fri, 27 Aug 2021 10:33:05 GMT  
		Size: 18.9 MB (18875676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
