...
```console
$ docker pull drupal@sha256:6c453c38499232f07a60979efa8918932b1786de678bd650aa612a88d44e35d7
```
...
```console
$ docker pull drupal@sha256:92e6892eb654a78927df85fa35f753dcdb79bae2cc19dc1a059d7e7bbaa3708b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48282008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56c659fef9ab352364fa9e1d39ca8e1ef296ca33562a954fea019508baa8164f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 13:55:45 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 13:55:46 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 13:56:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 13:56:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d18bae0c60b738500f216f1be33c8b84565929446799ed8609eda46de835fb0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c87a36cbd9644066c6be28cfe37e831ab798eddd1fcd68b4343d0ffa18e38334`  
		Last Modified: Sat, 31 Jul 2021 14:22:05 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d04e8ec5334027196b35129b1b041cb2868a65b59e98217c84feb92ec18b91e`  
		Last Modified: Sat, 31 Jul 2021 14:22:32 GMT  
		Size: 18.9 MB (18873520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
