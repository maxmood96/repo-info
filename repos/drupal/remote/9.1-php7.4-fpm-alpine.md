...
```console
$ docker pull drupal@sha256:23d2ef80b2321bdb82c2cfdcf7874cfb2a4c2bdc433e1561c8488345c3862d61
```
...
```console
$ docker pull drupal@sha256:c32beb39ed217e21e080840352509af4ecd6668353c6cc9b2cfb0360691ab2d5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49654830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a5bcec091c91166ac11706b0e3618f62410829531b609c52ea9ac4d82f05edc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 Aug 2021 01:23:25 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 13 Aug 2021 01:23:26 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 01:23:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 01:23:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd471a5d53c2161e0dba00864ad85465d14487845a8d860bfd395298b0f2b07c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c511f8884a9f744a6294edf05bde6517146ecc130256c3c02f0c4fea7dd88934`  
		Last Modified: Fri, 13 Aug 2021 01:36:53 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d26fe318ece17bf00b201965382eef246ed180503b18de8fe8057cf939172353`  
		Last Modified: Fri, 13 Aug 2021 01:37:19 GMT  
		Size: 18.9 MB (18875931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:c10cb417bebe62220f58d8fb0f79c2bffd030eb8f7e78d1e844b627cbc970ce7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50908281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4778e0ae359dcc9bbdbbf605f576fd531aa9c323bfb3d06b282f3443440b5dd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 01:38:38 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 13 Aug 2021 04:38:17 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 13 Aug 2021 04:38:17 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 04:38:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 04:38:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:91913ca8f90d5f013e928175db7d9cad78e893845499e208f3e2e23e69479e76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b80f72a3926f85aa76f45665d871fb2176c8b5043026602e8f8acaa87eb0db06`  
		Last Modified: Fri, 13 Aug 2021 04:58:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a017701771d1d5f5835b8e75539aa91177e4953c5ba3d117853b3c990f981b`  
		Last Modified: Fri, 13 Aug 2021 04:58:43 GMT  
...
```console
$ docker pull drupal@sha256:39739cfa929fd128c86a1ddc7f7e5b77d080f1560a37c30b2d15f2e3bd04f933
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50235507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:141814ad7fb37761a4bd25248b52b5b0a3dc8c76d3ccc0ad61d569c0a25fd724`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 06:28:07 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 13 Aug 2021 03:22:10 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 13 Aug 2021 03:22:10 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 03:22:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 03:22:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2538520c83fd3489c2071cbba958c8db364b91684c868e50b76344cc53eab7d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95c9e87827cad3853aabb7bd8501801f25cf09a639668f405cdec20d72d491ce`  
		Last Modified: Fri, 13 Aug 2021 03:40:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bac4832324e9fa87246c00e416f2299a415b2b2f5f940ec52228b3aec090f61`  
		Last Modified: Fri, 13 Aug 2021 03:40:51 GMT  
		Size: 18.9 MB (18875669 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
