...
```console
$ docker pull drupal@sha256:29c50e1ff1aca4b1d044db2471cc341dd82b3ca131d763b70f42e64d5596241a
```
...
```console
$ docker pull drupal@sha256:e8ea7a2cebee75e962958626eef7642132f9063bb679158eab6bf74711f7838e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49652444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28409f8a5b1e115479753b9d3fad7a33dd578a95cd5eef6d7018798cee6fdee6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 10:10:24 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 10:10:25 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 10:10:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 10:10:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd471a5d53c2161e0dba00864ad85465d14487845a8d860bfd395298b0f2b07c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e536c5e2589ba9ea9fc7f9a0b8f9b7d0f1517d837ec469f8f1a7f36b8e32c27f`  
		Last Modified: Sat, 31 Jul 2021 10:24:18 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e7dacf4c33cff0d6b22cb5ea3e01fe123c19aa6e61d1714970be31325b2db3c`  
		Last Modified: Sat, 31 Jul 2021 10:24:44 GMT  
		Size: 18.9 MB (18873545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1d9a955c0c6dac0a3ad7964da1281003b46f6d865f63d10b0400c578874e0d47
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48489657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0887e9d1e6448083fcd09272f90ebfcd55e1b1fc4bb0bc6b0147b4ff4519c06d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:13:24 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:13:25 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:13:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:13:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cb82ee46f9471b6e0bad2176f65c895a0e5921f2f1e8763ede9ce39b25217039`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a235d4b35b308674bf9a87ea5c5c0965acaa2f28eab2220b367bb8febaa36c0`  
		Last Modified: Fri, 30 Jul 2021 04:50:11 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13a7646054f9a44af3e14aa288b38b751a819419a5d882de980c87092db3d170`  
		Last Modified: Fri, 30 Jul 2021 04:50:39 GMT  
		Size: 18.9 MB (18872789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:61c4279cf8d9e28d4c4c8491e5972f1be962890e4206a0a9431bae4fd7b70a57
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52230419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f008a758601baeeccd098990c384ff6d7652334c8715316fa6b036896d39f803`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 11:24:00 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 11:24:12 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 11:24:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 11:24:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:939d771a259baac9ebf6ce2957e2c3b790807c2662524fa7417e56a6428a4100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb5203b8442c4eda9b5f8d8e40cbdf106405bf329f319b9a17c3a70849a5e205`  
		Last Modified: Sat, 31 Jul 2021 11:43:11 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed82e3b6920c551f0d49a9d07a22802ad3cacaf54c4994a82d4a7546d5dd732f`  
		Last Modified: Sat, 31 Jul 2021 11:43:42 GMT  
		Size: 18.9 MB (18873364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:b3a24d3aec515bd4aca7e17831e1510e5e9dbe562916eaafaf19b2e22fe9300b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50233054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0e1d97fc01c9d22c5a978be9f4573dca52c9bdaf7064ad63b43d3055d59bbcd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 06:28:07 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 06:29:46 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 06:29:47 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 06:29:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 06:30:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2538520c83fd3489c2071cbba958c8db364b91684c868e50b76344cc53eab7d3`  
		...
		Size: 553.9 KB (553915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdffc0aa61c76cae360b0788fd54b811a1fe64dde1170dede45af2889ee03e44`  
		Last Modified: Sat, 31 Jul 2021 06:39:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9653122a4131f1ef4d18bed1a42e4a71f57f034a8aa66391eba485af0c1f6ad3`  
		Last Modified: Sat, 31 Jul 2021 06:39:45 GMT  
		Size: 18.9 MB (18873216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
