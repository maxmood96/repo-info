...
```console
$ docker pull drupal@sha256:60359f3dd4ed753bd5c9df4e18b5b91e80adc16e38acae5b709b90aa3e6384ae
```
...
```console
$ docker pull drupal@sha256:2b83a573ae44c0cacc0d847cb15399410d01483521e8972a551c001bebb00d8d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49370970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4ac4457196cb5749243bd02254fbbf02467d8e65dfdb283df2cd4244c647574`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 07:02:35 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 07:02:36 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:03:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:03:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:42b593e0e7893a3d84ad8e115ce16f80b8ec35614a8b41dbd8262d0bf5e3873c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:768b0fb68191a16be8004eaf75b9fd91eb89841bd5513cfc5137218de43d245f`  
		Last Modified: Thu, 02 Dec 2021 07:14:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce51f4b4e4df5e2bf92f7407a91617af23254ea6569f5300a687fc71e3a3377b`  
		Last Modified: Thu, 02 Dec 2021 07:15:05 GMT  
		Size: 18.9 MB (18880149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:374dc8a11f83bcf860eea0b3b7026993479ab7c46d87a96562595486713d614c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (48008919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10e0f197c8c59c9226afafac6d216e87e6a0ca1185ed069f7a1aeaf6321379d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Nov 2021 21:57:19 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 21:57:20 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 21:57:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 21:57:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ecc16118d699618d456f4c43e25cbf332922467181f4dff3703dc1fdfb86e9f7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41a8fa76a3c34d2709968ad6e9881fc679ab34b56dacfcb6fe93ae6e9adf44de`  
		Last Modified: Wed, 24 Nov 2021 22:30:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6be229433c297816dc9cab2731e85b440c6bd038f5b7212c7017bbb494d60f0`  
		Last Modified: Wed, 24 Nov 2021 22:30:47 GMT  
		Size: 18.9 MB (18880117 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:189814acb49dc296ae328d761af160bdb2cc52b7ba5c16527168c6496269ec36
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49945153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fecfebfd5e37323efd4af8f2d2ffc56733366f96c8f52f25d9b187ba1c87eba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 07:03:01 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 07:03:01 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:03:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:03:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ced35e36c4d94777f3360e8538815197a22f203a8fd082ad872ef358f5f6f970`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf28bcc3bc0221fadf07b7c3e7f83024511bd1fac5c115628e2fa4e6757ec798`  
		Last Modified: Thu, 02 Dec 2021 07:16:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afdf888fdd6b5a9c455ad24fb1e003b4e6b3db6a410ecef3bbf080a357c0dd92`  
		Last Modified: Thu, 02 Dec 2021 07:16:47 GMT  
		Size: 18.9 MB (18880063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
