...
```console
$ docker pull drupal@sha256:7ce55b311c88799c7f370a0d45090377c583cf8fce669753b7d1f8ed4eac6c4c
```
...
```console
$ docker pull drupal@sha256:693153375fd422dbc2c1ab95fa332fcceeacdaf5958e4c087505e642ee37a07c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51714234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7e77f2e08d6f3c523d8ffe88788702f582f320bd44fd724390c5fbedede934d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 06 Mar 2021 06:16:33 GMT
ENV DRUPAL_VERSION=9.1.5
# Sat, 06 Mar 2021 06:16:34 GMT
WORKDIR /opt/drupal
# Sat, 06 Mar 2021 06:16:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 06 Mar 2021 06:16:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3aeeb08c0ff7a624480bae5f69d102cd46647f5696bfe27f1e1ab11a0b91569`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c127a9990b8546e787deb0cf989efa4b051d5b4f225853caa98b49fad39ae8c5`  
		Last Modified: Sat, 06 Mar 2021 06:37:29 GMT  
		Size: 551.8 KB (551812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:147c8ceefcc855219b771b257199641bb797420f8e4eee4507b20426a61120f9`  
		Last Modified: Sat, 06 Mar 2021 06:37:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94486dc7de713e5a77a9dfceab6dc5abc1ff140293f7577fbb35d26a3c6793f2`  
		Last Modified: Sat, 06 Mar 2021 06:37:36 GMT  
		Size: 18.8 MB (18827368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
