...
```console
$ docker pull drupal@sha256:a02e1b0926037ff9fe5d0cd4228beddd34c71da53830ed4cf6efe0385ff33b58
```
...
```console
$ docker pull drupal@sha256:277e85dcae042b8e6b97094dfb389744437b87fee2addf5c1760da4cd9a3a867
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.5 MB (47518704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c4b62319bb1559a0cb9163c03e5d337ffb12d1b8f07c4726daa50470b9cb9b5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 20:08:20 GMT
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Mon, 01 Feb 2021 20:08:21 GMT
ENV DRUPAL_VERSION=9.1.3
# Mon, 01 Feb 2021 20:08:22 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 20:08:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 20:08:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba9d485f9cc6d9f3a769143de8c2fa273a2267beb6648d183234f8fe532744cf`  
		...
		Size: 332.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a8413ad43f36948b20fe125fb96fbc117ee862d1878d7c2cc7a58fce481cc19`  
		Last Modified: Mon, 01 Feb 2021 20:17:17 GMT  
		Size: 550.5 KB (550531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09504e2beb1d446aa99371ece9209460e7bbc181a43d42ce9955709aa138c8cd`  
		Last Modified: Mon, 01 Feb 2021 20:17:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01c670bfddb96e6d4fd5510bdf1ee86160b71d692a2f1417547299a649c458d2`  
		Last Modified: Mon, 01 Feb 2021 20:17:29 GMT  
		Size: 18.1 MB (18070055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:65f82bd935896213b3ea598a81252eb18c06cd1bbe149322f564556449df0d49
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51479080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fc27edbe2914bdc419254d7f73cb1dd1a66a0a1193ffdd93f61fd4d3ba105ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Mon, 01 Feb 2021 20:33:45 GMT
ENV DRUPAL_VERSION=9.1.3
# Mon, 01 Feb 2021 20:33:57 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 20:34:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 20:34:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15bfec3c006c343571670f25d661063e419c224070e8d2142f7b80f73e9a0dbb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ebe8a74abbf5bf34b2df9ff35899c8bafac12aaf793115eb7d352635bbc4a00`  
		Last Modified: Mon, 01 Feb 2021 20:48:36 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29b586e96a463df37cc39df08fd41f75543340f6d693562011eac68b1bbb1007`  
		Last Modified: Mon, 01 Feb 2021 20:48:42 GMT  
		Size: 18.1 MB (18069798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
