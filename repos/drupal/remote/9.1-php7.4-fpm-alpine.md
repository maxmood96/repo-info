...
```console
$ docker pull drupal@sha256:72d54752733eef44ea5177aea77adcd93241edfd57a0128012a632da8a88a160
```
...
```console
$ docker pull drupal@sha256:dee7a8f0cf463781c8cb7fd7f29eacad4a624f07e67d6dd7507cabeb1e06343d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51915850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4674b1c410555a47be1ca51dba4e0566a2a1e2e6a4ece06dc73da9bfaf3ea046`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Wed, 15 Sep 2021 20:29:15 GMT
ENV DRUPAL_VERSION=9.1.12
# Wed, 15 Sep 2021 20:29:21 GMT
WORKDIR /opt/drupal
# Wed, 15 Sep 2021 20:30:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Sep 2021 20:30:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d8b388830c8619a36700d6daabbecdc7b2d343eaea9dde0a4e2b6e9c0c690824`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1ab3b7a7db832b03f338b69f62940d3f1748e5d5719240c1238aa5d12e64aa1`  
		Last Modified: Wed, 15 Sep 2021 21:23:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d2e2dec9cf9424fd810aabe57398a0d34c775a99f1734e460284460be0284c5`  
		Last Modified: Wed, 15 Sep 2021 21:25:30 GMT  
		Size: 18.9 MB (18876024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
