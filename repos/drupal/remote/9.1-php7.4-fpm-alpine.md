...
```console
$ docker pull drupal@sha256:3b3e774918fd1f883726a84301fb39a8e3a20be4da8f53c6cf681332ce65bcb0
```
...
```console
$ docker pull drupal@sha256:5d6df5e0436025b97e37e38d1778fabfcb35522a5ce8700dc8b24e97d1f4964f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50419997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:420c04cb8cc04fcbc3504dab95bed3cfda07fa3a6ad9cefb7ad636a75a09999e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Fri, 03 Dec 2021 12:25:57 GMT
ENV DRUPAL_VERSION=9.1.15
# Fri, 03 Dec 2021 12:25:58 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 12:26:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 12:26:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a971fb39c476e9231ac88348ba48ac60d470de44888786a4d56646b3469141c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27cb7748c172b85e6a71ba9dcca19b7967ec45b6932a0b3eae867522a80f3054`  
		Last Modified: Fri, 03 Dec 2021 12:56:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d790f9b2645457b147c17ebf14935b41362b85f5ca3711f24ddc90e5a99ebd8`  
		Last Modified: Fri, 03 Dec 2021 12:56:41 GMT  
		Size: 18.9 MB (18881163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
