...
```console
$ docker pull drupal@sha256:ee6165acf8b8260820606145f50a87891f23ffd52ff4768a71cb6ccbb60e6f72
```
...
```console
$ docker pull drupal@sha256:895acf2e4bdb9da19b74a43cdd432c3eb259935be825732ffc5ed24bc1a7e490
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51210383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74d5b6057017ce4ac9df569eb575ab97cae83453eb322e03f64231c1aef87b41`
...
-	Layers:
	...
	-	`sha256:ae662f4e61c60afe048d3aa700fcb13a9dd8c5653dc1dbe300389f432c8cc136`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16ef4ea1612217ba6be4605fa41775bde3d27605fc82ed2a7ce538c5c2d2025c`  
		Last Modified: Tue, 24 Aug 2021 21:52:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e314246cd930c6fe3a504a477ef4e11930549f33d6d6f9d2d551b1ad7b9a033`  
		Last Modified: Tue, 24 Aug 2021 21:52:58 GMT  
		Size: 18.9 MB (18874939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:27d7abc4ff5f535cb78e2edefef78fea3c03fb9e76e49d3495a27aef28f61123
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49655147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20e4a13cc6ef2b37f7dbc06fa877ec1eaef0b0fc108db522df56484a515b6de6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 22:13:10 GMT
ENV DRUPAL_VERSION=9.1.12
# Tue, 24 Aug 2021 22:13:11 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 22:13:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 22:13:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf246a9a34bcc91382a9313ba7115cf10d6b13fe390f9df37d2d935dbd5b7970`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f1e241d06f5cc9f6f5221529bd8042df2faf61d7299ba2f51ee9ac1b19faa02`  
		Last Modified: Tue, 24 Aug 2021 22:25:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d87aa632dd8511016f72b931cea8f456e964038bc223d9c15111b8a81b6990bd`  
		Last Modified: Tue, 24 Aug 2021 22:26:00 GMT  
		Size: 18.9 MB (18875577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:bf1bcea20dd08b00ede7607c23b40a0775e8d1eb7ad03bc5fc2c2e89cf5174a1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48284219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1c0875ee0ea0d86d8cdb11f1d217c1e082646404d76082535691c67d2a9a7e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 Aug 2021 07:13:14 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 13 Aug 2021 07:13:15 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 07:13:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 07:13:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d18bae0c60b738500f216f1be33c8b84565929446799ed8609eda46de835fb0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:001e6b01bccc7571ab76eea6a2cbe2490029eb88266d68d2df33d6dc6e630dc5`  
		Last Modified: Fri, 13 Aug 2021 07:49:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:682eedf8df741328bdbdd8b2350b4842baa2f09d0bbf3a83331cfa5cae4713f9`  
		Last Modified: Fri, 13 Aug 2021 07:49:57 GMT  
		Size: 18.9 MB (18875730 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:09b7bb1ed666cc8a701e7d7e5c3fb82087885f75dbac2220903556d3f00890b6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50908872 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52252ae3a83a5617a6bc3c5c05eb9cab042f81eee6a8185a05b1a0140bda6254`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 22:03:50 GMT
ENV DRUPAL_VERSION=9.1.12
# Tue, 24 Aug 2021 22:03:50 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 22:03:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 22:04:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c831317725481d0c26ab1eccdf61daf426f12bda222357137a383b690ccd79bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfec740bd096f069a75fe76b07686a600a7cc0cc534e27897281c9b3655a9975`  
		Last Modified: Tue, 24 Aug 2021 22:22:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6442d54b8b21cbb6ee352ab7e57c62b32cde9732c5bb142f5d62df9f8858ccde`  
		Last Modified: Tue, 24 Aug 2021 22:22:27 GMT  
		Size: 18.9 MB (18875644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:606d89cfa0438cb3aab9cffa10c3322ea266285387088f4ac562e9f278a4ae21
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52232754 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7590b6f674bb2445dd28adeabf0cc57943a2d3b0af5e56f0ccd302f03e4ad023`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 13 Aug 2021 02:34:49 GMT
ENV DRUPAL_VERSION=9.1.12
# Fri, 13 Aug 2021 02:34:54 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 02:35:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 02:35:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:939d771a259baac9ebf6ce2957e2c3b790807c2662524fa7417e56a6428a4100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bfc85a130241b209a961ea0a1cd64c3f6ea010b4fd4fc2c8f2440b4cefe1352`  
		Last Modified: Fri, 13 Aug 2021 03:26:28 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea7cd5fbde8d0fd52a90c9561bb8ecd4c6c1d084e80715a11cb2ac5bbea5fef1`  
		Last Modified: Fri, 13 Aug 2021 03:28:58 GMT  
		Size: 18.9 MB (18875698 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:e89e9080bbfc485be2f8a70565808ca7115496cab8ac322489a12543e00e32f7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50236169 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4467b27264f0f0f4d0ad986120d8126b8fb307c6b9ce9ec73414cc4e20cd9aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 22:06:56 GMT
ENV DRUPAL_VERSION=9.1.12
# Tue, 24 Aug 2021 22:06:56 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 22:07:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 22:07:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:13c5f0d0e547ab1f8742b7beb0e05906f7611aafd942f7db2101f9f363de3742`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ece284df5d63930fd4185affac1c237e555d6e9826ee48d908e353ec6ac41dc`  
		Last Modified: Tue, 24 Aug 2021 22:20:32 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dac6b11a15c41f196cb2d8a2cbd2284ddce50a959db6421b293d757289e3d9cb`  
		Last Modified: Tue, 24 Aug 2021 22:20:36 GMT  
		Size: 18.9 MB (18875671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
