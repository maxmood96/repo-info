...
```console
$ docker pull drupal@sha256:430f098a0b73c81468efdfe1ee7845fe5b0f5f23bffe0b137a1e08bd185a3ec6
```
...
### `drupal:11.0.8-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.0.8-fpm-alpine` - linux; s390x
