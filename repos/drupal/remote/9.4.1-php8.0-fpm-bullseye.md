...
```console
$ docker pull drupal@sha256:1f8856cc5c02391c4e43f18df3eb1bbec011fbb0d320f6cd6999f6954017c187
```
...
### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; amd64
...
### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:726bfe724b69e33282b3cac84a5db7d82593d5a9237bc3f7530e41677cf5a7c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154921697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edf8444067555453debde909a0a95657e04ab58587c7187896a0909ab7e9bdca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 25 Jun 2022 00:10:22 GMT
ENV DRUPAL_VERSION=9.4.1
# Sat, 25 Jun 2022 00:10:23 GMT
WORKDIR /opt/drupal
# Sat, 25 Jun 2022 00:10:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Jun 2022 00:10:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4701f0c534fd6033c214507234850311965d252317124a8f5091e1683fd7a3c2`  
		...
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee5bcb6abbcb64f42fedb04c79bd4f295d915f0453be5ff3b6389fa262780795`  
		Last Modified: Sat, 25 Jun 2022 01:20:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae2549400676dcfd540a73b87dd997c0413897c5e802b2f4b898547927d2929c`  
		Last Modified: Sat, 25 Jun 2022 01:20:43 GMT  
		Size: 21.8 MB (21753056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; 386
...
### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; ppc64le
...
### `drupal:9.4.1-php8.0-fpm-bullseye` - linux; s390x
