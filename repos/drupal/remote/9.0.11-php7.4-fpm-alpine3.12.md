...
```console
$ docker pull drupal@sha256:e20d62bdc9b21de334749f1f380e163e54d4505db081603eed259453e84c398d
```
...
```console
$ docker pull drupal@sha256:5584df7ee208c59574b061880f72408fbc9d7825fbe78cae4648cbec8fe312a0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49406279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b695745053e3c6fa86056a2918c8f73eabc007cabbbf06fa614cabbc5d3d7cd`
...
# Thu, 25 Feb 2021 04:25:24 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 04:25:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 04:25:42 GMT
...
-	Layers:
	...
	-	`sha256:66bd8bfd94b6d1e7ceda473cc6c25de813f5d944649263e716f8e3973833b630`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b5c69e1c14b4d0b95252ba3e51ce87e3df7bfa233779043b99129a4cd5f6c1f`  
		Last Modified: Thu, 25 Feb 2021 04:29:59 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c060d5aa60af82998ba34779bb493c2924f0164587dfc427cbcb31b406d56df`  
		Last Modified: Thu, 25 Feb 2021 04:30:04 GMT  
...
```console
$ docker pull drupal@sha256:3df6baf19c0ceb929af73d958b5731858b02c97b34a9de148563832ff7121431
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46666817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7880df60affb5032828b7e2a8b4c65a2bf460d96a1b51dd544f798cd088db49`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Thu, 25 Feb 2021 03:07:10 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 25 Feb 2021 03:07:11 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 03:07:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 03:08:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:40d8669f27460905d78781bf5eef97cb50f5093caf78dd857e5e6e25c8ea2f14`  
		...
		Size: 507.4 KB (507413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a9d4f43f7fa7a1b706f3859331f8055aaa1427624c3a5983d38c0365069db32`  
		Last Modified: Thu, 25 Feb 2021 03:13:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbcc8af9deb038e57a573daa7064acae3d4ef1eb214334c1906f44dddeefe7ca`  
...
```console
$ docker pull drupal@sha256:122c5a655f656106241368c14262a2d4298af15a5c22de0dcb915a8d8792585c
```
...
-	Total Size: **49.1 MB (49131439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e644834705d5f10b260b19f6bff855bdf19128882fd8c5cfec1dbd2c9d1f15bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 25 Feb 2021 05:33:09 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 25 Feb 2021 05:33:10 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 05:33:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 05:33:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:403887fd3f9edba3db3dc575e2a6bba68d63bee68854800f3dcdd14957740e10`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e93a1794c1262b8ce36d67146ef6e676f85f26368bfda1340e1c6c75ef8040d2`  
		Last Modified: Thu, 25 Feb 2021 05:39:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e96b2b4d478e0c0805c45fd313d1168d4cce24d10ee2b73cb3120534660a03b`  
		Last Modified: Thu, 25 Feb 2021 05:39:45 GMT  
...
```console
$ docker pull drupal@sha256:a60923373e169e098aafd5fae746ccce6b24882e2a09692a904e6351c3a9fb92
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50081749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c9f406f9fa837da14e8107dc939f8f9edf5c31bde08542d2000761e00506712`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Thu, 25 Feb 2021 02:39:24 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 25 Feb 2021 02:39:24 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 02:39:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 02:40:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:773e47d3e251be5300a38ee2fc4a920f8496f1ce8eb7cb853176cb8f913b8968`  
		...
		Size: 507.4 KB (507418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f143d16281203f7188e3ac9c10ed826430ebe8aa7d0b6008e348a97fbcb659ae`  
		Last Modified: Thu, 25 Feb 2021 02:46:48 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95c411051c25a91a1930bb2be7b93bbe637acd6e976859e8cf1c542de9fe21bc`  
		Last Modified: Thu, 25 Feb 2021 02:47:02 GMT  
...
```console
$ docker pull drupal@sha256:165456c6ff1a93121377aa821ce98d67d880b564fb7a68e2ca6545fe6bd1348d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50625764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f16f9c10eb3f486a78e107a492b10deee0ddf3ce0457182266ae414a5f01d9c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Thu, 25 Feb 2021 05:13:33 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 25 Feb 2021 05:13:37 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 05:14:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 05:14:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:527b12775f6c1b67443a8d91f329ff32fc8f873b550ccf01ba117c29d0bb7ea3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b453c9788244af4163bdbdff45031f09e0cb436b91aa2f2a1da9c903d0ddb521`  
		Last Modified: Thu, 25 Feb 2021 05:24:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7969648484907c5b78f5e78f249edc0abdcd214d4b8bf166ab23cc809bab601`  
		Last Modified: Thu, 25 Feb 2021 05:24:27 GMT  
...
```console
$ docker pull drupal@sha256:9ecb62850a2a07a516cd683f1ce41161b65930dd53e9d68992022ab1c7b75f50
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48554973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c2afddafbe37b643088b71484595f033bc4b8555582e97b0915f611de711133`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 25 Feb 2021 06:43:15 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 25 Feb 2021 06:43:16 GMT
WORKDIR /opt/drupal
# Thu, 25 Feb 2021 06:44:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 25 Feb 2021 06:44:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:daf76a1ceeb43dc7433203045b6b3c2e37724a191a15570ffb21b80c1008951d`  
		...
		Size: 507.4 KB (507418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3235fc06ed52667e3fa7068cd14bdfe27794722ae633c991be5efce7c442da1e`  
		Last Modified: Thu, 25 Feb 2021 06:49:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6ce9547fd2b8cc2b15a6054e3a8d022dd41f205284dc7bda6d91762e300df3b`  
		Last Modified: Thu, 25 Feb 2021 06:49:56 GMT  
