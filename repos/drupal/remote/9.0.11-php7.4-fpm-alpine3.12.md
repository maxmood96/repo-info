...
```console
$ docker pull drupal@sha256:f9537a81153dd4b9e140077b46507124f4597876aab5025b4f7c0659d03a4ce3
```
...
```console
$ docker pull drupal@sha256:401b36891c16f120f3df1bf90f3d2185d7dab72eaa8d2aaf3fe85f7fe77e1ada
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (48038531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c04635f05e0377315900e41d0a4d50dacf8d7216852ec638f1852fd129ace8c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Mon, 01 Feb 2021 19:53:38 GMT
ENV DRUPAL_VERSION=9.0.11
# Mon, 01 Feb 2021 19:53:38 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 19:54:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 19:54:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1728e6f5b09e90fe9f5db11b6c2504f03b71cda4d563ee2c891468962c5b1be6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f0ee005999cc00c0743e77bba7768ce65e8060d78523e640c3b93c20758e248`  
		Last Modified: Mon, 01 Feb 2021 19:57:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4868b8641b1afc4bb4cf1ea2122166199d3c4a24d5417a0e4274341cbbf4ceb3`  
		Last Modified: Mon, 01 Feb 2021 19:57:46 GMT  
...
```console
$ docker pull drupal@sha256:e073cf4947cc179bdd9bf19221c2b3b9e938dcbdc45af3d7aa263b65d9c637d4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.6 MB (46646361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1751bbb129eb591614ea3d891ac5024c9b47dd2bf56228d47a9a2ec644634811`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Mon, 01 Feb 2021 20:09:20 GMT
ENV DRUPAL_VERSION=9.0.11
# Mon, 01 Feb 2021 20:09:20 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 20:10:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 20:10:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2ff8d5a4290668d73f06119f8220df5021b64db9f24e4fac42c8e16cd6427ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2adfe7c1ff13e86a862ca1b112a3c54fff68fdcba7895d4327be45a057b249a2`  
		Last Modified: Mon, 01 Feb 2021 20:18:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0b938432537bedc374d1b22f99bee582e4bbac356b155bdc9a9a46654a61bcc`  
		Last Modified: Mon, 01 Feb 2021 20:18:17 GMT  
		Size: 17.2 MB (17240816 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.11-php7.4-fpm-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:3f8c32b8fb96b9a57810db69d70d441b5c44469a4a8b37a41fe96c75dea6348e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49117238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:633fb8ded3e9559d41b782f71e387ada0f292486b62ebc554289ded7f36ab4c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Mon, 01 Feb 2021 19:45:13 GMT
ENV DRUPAL_VERSION=9.0.11
# Mon, 01 Feb 2021 19:45:14 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 19:45:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 19:45:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1520728f8f45c8277f9e5b6fc7c7ddbd6a7cf7a07bff8569f5cf392c58d7ba88`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fedfc56a0edcef9cfca6c0eb7651eafb56b033b0e98dc6f3421c758eba938a61`  
		Last Modified: Mon, 01 Feb 2021 19:52:11 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1db6590a8cb6a968482cd8ba82471d5c1f3be35322f323ea51ae1545acb3c346`  
		Last Modified: Mon, 01 Feb 2021 19:52:19 GMT  
		Size: 17.2 MB (17240839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
