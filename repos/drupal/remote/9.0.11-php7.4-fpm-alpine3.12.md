...
```console
$ docker pull drupal@sha256:a99f4fe6ebb95435142322b12c7e05cb4e8f31298f41417403ed1ffd69552035
```
...
```console
$ docker pull drupal@sha256:690fa8f8180ae42e348f806fd21ff12cdf36bcf12b713b61990b5ef7feb13820
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49441042 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0b980e1d3c76a9937731bc0f6938e22ef6cc7fba4ee43ae30965711844a178b`
...
# Thu, 15 Apr 2021 10:20:11 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 15 Apr 2021 10:20:11 GMT
WORKDIR /opt/drupal
# Thu, 15 Apr 2021 10:20:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Apr 2021 10:20:46 GMT
...
-	Layers:
	...
	-	`sha256:73bbb37df00b201b77e5afc9f5ef6982fd4f28a8e22d5879e57a3c28aac96994`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29f64460768d21c0065538c27bd8e694111a5aa58470508e4d997968174a2fd2`  
		Last Modified: Thu, 15 Apr 2021 10:26:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d4fbc29185fa657fe2b391f04fe9a0f3adee7964eac47b57453040f9ba4a572`  
		Last Modified: Thu, 15 Apr 2021 10:26:46 GMT  
...
```console
$ docker pull drupal@sha256:a5b8f89cfc7def2c6fd768669e357da1e5956f9464e3d428a9c29fa1eced15e7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.1 MB (48090444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba54f011cc9ca7896f01859b84a2ec5143646164429538e5174d613755394b6d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Thu, 15 Apr 2021 07:27:08 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 15 Apr 2021 07:27:11 GMT
WORKDIR /opt/drupal
# Thu, 15 Apr 2021 07:27:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Apr 2021 07:28:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:433d2db39f18fa4d5a331327720c8ef9e9c30b95006705dec4c3b11adbe27d22`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42f8fff7c856faed6cf1c6ff717811b2c6b926fb66a4d7b27403f8e40eaa67a`  
		Last Modified: Thu, 15 Apr 2021 07:31:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e7a547e376a72aca129df4e064b7128985d380be1d74a2f657583148b6facc8`  
		Last Modified: Thu, 15 Apr 2021 07:31:39 GMT  
		Size: 17.2 MB (17240895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.11-php7.4-fpm-alpine3.12` - linux; arm variant v7

```console
$ docker pull drupal@sha256:df4e3528afda34d9964a73551fb7852473adcffd1208f36b8abce21904574ad9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46693530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b7d7a0ad1b0a764da312e9855918da3795226bccd8e185f775c203218cb565b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Thu, 15 Apr 2021 08:10:53 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 15 Apr 2021 08:10:55 GMT
WORKDIR /opt/drupal
# Thu, 15 Apr 2021 08:11:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Apr 2021 08:11:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab5dc982eb2a0d9cf36646d328360c04a4ee8b3f3b6718b760fda97b8af37813`  
		...
		Size: 507.5 KB (507535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b331fa04683a1e5088beb3c17adb4ca338e78fed682aef08825bb663db82f5f2`  
		Last Modified: Thu, 15 Apr 2021 08:17:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d632827aef1cb1f22eece5d0c2b241016e95b65fcb3950b993e96ea8fdacbec`  
		Last Modified: Thu, 15 Apr 2021 08:17:50 GMT  
		Size: 17.2 MB (17240903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
