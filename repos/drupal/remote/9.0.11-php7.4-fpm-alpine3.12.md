...
```console
$ docker pull drupal@sha256:635bb1cd56fbff0a0f51c36bd633f8eba25786a385c8cfff803e0ea3bee379df
```
...
```console
$ docker pull drupal@sha256:c1ab0ad69caa36bb714bc4fb0bdee50c1598b688d7b9a0685c9ed7c68ca99a1c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49384430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8fe8879e7edc85af549acc459a2c9e5c05c45b17ab7ed0cc9cf2a40e78d58c7`
...
# Mon, 01 Feb 2021 19:27:13 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 19:27:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 19:27:40 GMT
...
-	Layers:
	...
	-	`sha256:bc2ad6cb202274198fd3e7793b6b3a1689a0a1cb33aa7e15c1764b1faee23990`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c79a83886f579687ff3662d4f87c89a4e977087cd5368de6428266a27be60a9c`  
		Last Modified: Mon, 01 Feb 2021 19:33:05 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21a73f916c279ecda87e24718504f6d5f1f3a139d69100bb3b7c072e6fcc27ff`  
		Last Modified: Mon, 01 Feb 2021 19:33:17 GMT  
...
```console
$ docker pull drupal@sha256:07b7e31c729472d87c1b9b359d30e94c857e08f5c83ffbf8af5bdd2063bce382
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50057174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45e4a471563d6a61320bbe5cef41466966e0d2dc2211e18d3b3d75ee0ffba05d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Mon, 01 Feb 2021 19:42:29 GMT
ENV DRUPAL_VERSION=9.0.11
# Mon, 01 Feb 2021 19:42:29 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 19:42:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 19:42:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b8b999b7f6371796217106f965df26291b994bff9f34865bf6a0ed52ca0fb7b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5502b4746d2e4c4c7dce362432ad3a4b84880cf0dff6dab0af5963d2f29fefa7`  
		Last Modified: Mon, 01 Feb 2021 19:48:29 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa7cfb036c926e07429e212fac792aaf2913cade47016a509f66fac9514d42f7`  
		Last Modified: Mon, 01 Feb 2021 19:48:45 GMT  
...
```console
$ docker pull drupal@sha256:014c1ff14c41ff307dd575fd2118c45af19590cf77cc97f47005ab57fa21e105
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50606952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f6686fcbdeae853f5592bd7765abdbe39e27176824a765c114678340e82bc96`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Mon, 01 Feb 2021 20:35:26 GMT
ENV DRUPAL_VERSION=9.0.11
# Mon, 01 Feb 2021 20:35:36 GMT
WORKDIR /opt/drupal
# Mon, 01 Feb 2021 20:36:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 01 Feb 2021 20:36:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dce461bb26f802eeeaa25984a3955d6b5a8278729129b3c8a9ddee909f2f34bd`  
		...
		Size: 507.4 KB (507425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe12386d054375d3b2c8873a4ec79ccc1cd30882450ffaabf3f79fb437007eb0`  
		Last Modified: Mon, 01 Feb 2021 20:49:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21a76968e8cc58caf9b070a7361741a7608c17ce65b1f30e6060c41b5d9ccc23`  
		Last Modified: Mon, 01 Feb 2021 20:49:49 GMT  
		Size: 17.2 MB (17240775 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
