...
```console
$ docker pull drupal@sha256:2a59940c8d1194f52e79aceda9b846985a8bd60b115d2247632b0058aeec9d10
```
...
```console
$ docker pull drupal@sha256:fe0953a3f6d6ebd376fd6122b393d374473ccf479e663af91d6a2ef191b89d08
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49411396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99363310bd60ab542d8291eff53d4f0f29bd8a42cd7fca2552ef3e9769b5da03`
...
# Sat, 06 Mar 2021 07:00:16 GMT
WORKDIR /opt/drupal
# Sat, 06 Mar 2021 07:00:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 06 Mar 2021 07:00:51 GMT
...
-	Layers:
	...
	-	`sha256:4f420a09c40e7e3c90cc08ba804a8e5a8b30f93f2a8b4a2683be8d8e51705187`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63f83261629ff5f0848a72ea2b7b1160062cc8bda4461e399c9897e071fa0da`  
		Last Modified: Sat, 06 Mar 2021 07:14:37 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8d8843a12b596e96180f8e536bab54c7be861c8a308cb7629ab8bfee4f9879c`  
		Last Modified: Sat, 06 Mar 2021 07:14:42 GMT  
		Size: 17.2 MB (17240820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9a642bb4292e0be49a29a78bf9dd239d01c607fae4dbde9da56cba8779b544d0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50083314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7bb02623ba2ecc720973c969ae09ed1600f4f789ff9564eb688208d8986034bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 06 Mar 2021 06:19:19 GMT
ENV DRUPAL_VERSION=9.0.11
# Sat, 06 Mar 2021 06:19:20 GMT
WORKDIR /opt/drupal
# Sat, 06 Mar 2021 06:19:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 06 Mar 2021 06:19:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c67246ad3895f3a73d65eb9e7f7bdce6f3449ca7ca348d5f523aad8a95e88572`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d8b25c8d5025ad2babb17482dd5a1afef25bd31c4d18602519eb0e58c88dd1b`  
		Last Modified: Sat, 06 Mar 2021 06:40:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59a27e270923f65df562867506e40b00accbde5609016cc4056c82b32e220c68`  
		Last Modified: Sat, 06 Mar 2021 06:40:07 GMT  
