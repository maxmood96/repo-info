...
```console
$ docker pull drupal@sha256:86b9ff9d6f075b8b6734c6da0a657a44693a2a17bcb5b59816de70270df94318
```
...
### `drupal:11.3.1-fpm` - unknown; unknown
...
### `drupal:11.3.1-fpm` - linux; arm variant v7
...
### `drupal:11.3.1-fpm` - linux; arm64 variant v8
...
### `drupal:11.3.1-fpm` - linux; ppc64le
