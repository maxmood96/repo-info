...
```console
$ docker pull drupal@sha256:a92f5e2d6142d6e38b9c0456985d23c274e0119a724f1b71ee952e304d6d6d1a
```
...
### `drupal:10.1.2-php8.1-apache` - linux; amd64
...
### `drupal:10.1.2-php8.1-apache` - linux; arm variant v7
...
### `drupal:10.1.2-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:10.1.2-php8.1-apache` - linux; 386
...
### `drupal:10.1.2-php8.1-apache` - linux; ppc64le
...
### `drupal:10.1.2-php8.1-apache` - linux; s390x
