...
```console
$ docker pull drupal@sha256:626482be55e995417259d84371e862dbf6c7ea30f2cf6e51ac0bea1566a10ee0
```
...
### `drupal:9.4.15-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:9.4.15-php8.1-apache-bullseye` - linux; 386
...
### `drupal:9.4.15-php8.1-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:aa4f43fb16044a83e09e7deb4a931fd6ef501c010ac8279c757126e8eb61efbb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190609046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22f8f994e4c2a1970dda1160574a65d68611c7597db6cda35393d3874bd52141`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:48:39 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 05 Jul 2023 09:48:41 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:49:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:49:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3b9e3bb7f3bb157a347c7646e7c4d749aa7152fe160b85f066940b109485bec8`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6094907efeb0f556a1d907f5338f42bd4ce51c678caec8236288b6c21668103`  
		Last Modified: Wed, 05 Jul 2023 10:31:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcc3a9a8213879ef78fb865f6329fdc4ccdc78fc7359aca3c337a843a3de25e5`  
		Last Modified: Wed, 05 Jul 2023 10:32:22 GMT  
		Size: 21.9 MB (21915401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.15-php8.1-apache-bullseye` - linux; s390x
