...
```console
$ docker pull drupal@sha256:75e80120898e3fc37ba99a508cad27ebe0f9c64d2db05e6667c981b2ec4450cf
```
...
### `drupal:7.102-php8.1-apache` - linux; arm variant v5
...
### `drupal:7.102-php8.1-apache` - linux; arm variant v7
...
### `drupal:7.102-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:7.102-php8.1-apache` - linux; mips64le
...
### `drupal:7.102-php8.1-apache` - linux; ppc64le
