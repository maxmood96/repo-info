...
```console
$ docker pull drupal@sha256:8043c96b17356b98bee1cc38f232cee1d911fd5ce79b23402df91b3c95e75d1b
```
...
```console
$ docker pull drupal@sha256:4af98e69716aafb6f967db8bd801a9e74e92927ff75655aa5298b078d19b2d5e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158024505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e171da50633982a3f7285b5ecd3dab7f50840d9cde21b5747c7c4d33226f29a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b9e93388e851504ea0f34082c4b0b210b66f030e9cd4fc9ea5e4262509bf582e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de1297a0a51e6b00eed309ae5a819a43af8c4e191ab795ce31102d97409a2efc`  
		Last Modified: Fri, 07 Aug 2020 18:50:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34b6f7b7d8e9ef3c43f8b11e58cc4f5703222526f34ca7dce21eae2ffc5627fd`  
		Last Modified: Fri, 07 Aug 2020 18:50:50 GMT  
		Size: 20.8 MB (20752552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:bbe9762812b9702b61cd43da291309ac6ac4a6c90044e5422b2690fcb59ce62b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171707277 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc86d9bd97d57b2b6d861d334af12d8cce745e7cb35630fed2b738eb41039ec2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:40:15 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:40:16 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:40:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:091ec86564217a452bf2f727fa97292b29a857df50ae7c7ec5f0454a72378d01`  
		...
		Size: 505.0 KB (504971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b711165aae220de9a8eafa1d65be55a1e77e957d682cd711026508fdd980ec2`  
		Last Modified: Fri, 07 Aug 2020 18:44:40 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9acd407651f593daa1f53da0db4e8af42607a6433f6b6ee6d98f1ffe76dc16df`  
		Last Modified: Fri, 07 Aug 2020 18:44:49 GMT  
		Size: 20.8 MB (20752376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:cc58af3d1939c09147dd9c2619b0db0d4ac7cc114bf4dbc7c555d129fb3759e9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.8 MB (176785653 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f37bc575d7c1829a73d7aabc029d25a99b7716a8f0e8af6ccee91a1549e19e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:21:47 GMT
ENV DRUPAL_VERSION=8.9.3
# Fri, 07 Aug 2020 18:21:51 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:22:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:c8e5701c27c5067e2ae2f73ccc29bef8d02a8d36628dd7ff5ed96a9392bee60b`  
		...
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95b1574cd3826fa38fea2999aa6362ed44abdac10e273b32eb0ff3cb4d76a2a5`  
		Last Modified: Fri, 07 Aug 2020 18:34:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ba41ce6e6ad4099da82df3d9411d0a6a23510ed12906baae4974d0d93f8ef39`  
		Last Modified: Fri, 07 Aug 2020 18:35:11 GMT  
		Size: 20.8 MB (20752675 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
