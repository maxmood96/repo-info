...
```console
$ docker pull drupal@sha256:a2d96cbf619a9d04444ffa19e77a5fa2e6d2bcb46038c125efe06ca130f2616b
```
...
```console
$ docker pull drupal@sha256:473e75a83cbd6d21ac85180ba94920d8cf2799e07b460a338ccec893b304e73e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171771953 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b753291ec7bd3b369eb33b4a3bcae8376c180b7f73a74ffd39806bbf6782250`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Nov 2020 16:47:40 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 16:49:21 GMT
ENV DRUPAL_VERSION=8.9.8
# Wed, 18 Nov 2020 16:49:21 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 16:49:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 16:49:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d408f78dbec0922b7b30746563ffe2b22a188c757a8dba63b77f21e8e1699043`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0439411a4f1b900602cf35349813788725af3cd8329c345b731ddde8dca34ae1`  
		Last Modified: Wed, 18 Nov 2020 16:52:48 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dceced430aa383b27f680d5056c5d5d2d8ec6fb7c4fc08c06eb23aa83faacd97`  
		Last Modified: Wed, 18 Nov 2020 16:53:03 GMT  
		Size: 20.8 MB (20765442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:32ae9af21274d89a955144904ca84dbdeb50c41955c6222a7a7c8086cc582df3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.7 MB (151681317 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f74f02eb80023dbeb2d41761dc3c9e9e57036d99f1430002ee1bbf7950d3f740`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Nov 2020 18:30:40 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 18:32:37 GMT
ENV DRUPAL_VERSION=8.9.8
# Wed, 18 Nov 2020 18:32:38 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 18:33:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 18:33:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8ddc96794a4d9342762929b97c90fcb65c9f7d7d318e99dd9d8bde80474db4aa`  
		...
		Size: 508.3 KB (508281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e06a1a43a5d4a2b8681d6926937b42d72e9e7ad488c164f9810ea16ea2ae9e8`  
		Last Modified: Wed, 18 Nov 2020 18:38:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eae539982c6500e3019a1b31767ed7be0a922c73b7fbf35d61834cff4156775d`  
		Last Modified: Wed, 18 Nov 2020 18:38:44 GMT  
		Size: 20.8 MB (20765570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
