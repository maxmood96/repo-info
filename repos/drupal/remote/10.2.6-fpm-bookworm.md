...
```console
$ docker pull drupal@sha256:9c0d9c3501002bd32109d3b31f63b5884e9fdd39a0a4eaa600bf635cb2e16440
```
...
### `drupal:10.2.6-fpm-bookworm` - linux; amd64
...
### `drupal:10.2.6-fpm-bookworm` - unknown; unknown
...
### `drupal:10.2.6-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.2.6-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.2.6-fpm-bookworm` - linux; 386
...
### `drupal:10.2.6-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.2.6-fpm-bookworm` - linux; s390x
