...
```console
$ docker pull drupal@sha256:6c558b6f992925357582138b0bd0e2fc128110cd95ccb26844d5a205d2b3178b
```
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; 386
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:9.4.14-php8.1-fpm-alpine` - linux; s390x
