...
```console
$ docker pull drupal@sha256:7482740fa9b339271fbfaf798377fc984d68b876e19077c3375c87969cb83624
```
...
```console
$ docker pull drupal@sha256:3c6fe5eaa387cda944c0437cf3bc5473ee86229cab485ae980f16f50f2e8526e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.9 MB (54863750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d60a552ab5831baa954edc731a4166ebcbf17b7b7c3d54063a545e26e01e12f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Tue, 14 Feb 2023 23:53:57 GMT
ENV DRUPAL_VERSION=9.4.11
# Tue, 14 Feb 2023 23:53:57 GMT
WORKDIR /opt/drupal
# Tue, 14 Feb 2023 23:54:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:ac48cd339838ec675b6522669233b66412c7852090353f57e6ccdc605d364c2a`  
		...
		Size: 697.1 KB (697130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:927c8c370052209201699a6b88b90e4468230f70226b7ca2f634e7a40036382a`  
		Last Modified: Wed, 15 Feb 2023 00:14:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1a73512aaf834a331a5e111291c9492fe947f6bd0ab72af7994cc8cea55044c`  
		Last Modified: Wed, 15 Feb 2023 00:14:44 GMT  
		Size: 21.9 MB (21901610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
