...
```console
$ docker pull drupal@sha256:31596d380bf119570671f7d9553ecfb2968b10dd6caf0c1eec9cb83f6339fad5
```
...
```console
$ docker pull drupal@sha256:3101948177e3ada31dd4ef300bc65d81396fcd02ab65fcc7fec5daca571bedfc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52332279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed613ac8095390f0aa12135ec2534b455f0234f9ae01de130baa114fa5d6de34`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:11:13 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 02:14:03 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 02:14:03 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:14:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:14:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6de2d2cd3b234a08f448a6e00e541c4e09883c6251ed914d4fd040d25a348118`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f30cc840dead4988fa11e77d8ff702bc9b080bd9945c2915bb1ae21359c1ffe`  
		Last Modified: Sat, 04 Mar 2023 02:22:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60e16f348a05fd63bcf3a12f563a702e757f1fb9976612d69e470067c7967b1e`  
		Last Modified: Sat, 04 Mar 2023 02:22:22 GMT  
		Size: 21.9 MB (21901571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
