...
```console
$ docker pull drupal@sha256:044a9c443a4f78d5238f7f21a06ee5deb0d294ef91d946688c3fb1a7d4efe436
```
...
```console
$ docker pull drupal@sha256:9a6c84ae052f335277bb0d7ef5d992afb5dcaece0822cc1cf18fa91195f9495f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51550393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e32fddeca532a8ed7203e743af65e3e12f63eae7b735661bcc7ccc69ddba0df4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:22:53 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:22:53 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:23:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:bdce06feb92561db5f0feff0cc285d8708f855114c3a2cc684a4836baf41a535`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25938a04ae6b0936d510bb4d2c65e8921136bb8ec9ff02f4fc1133b003fca7aa`  
		Last Modified: Wed, 15 Feb 2023 23:57:34 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e85a9ba8e1b5e0506cc31a20ef4deb1cc75bf1c1e9274ce136c3c7ae300ec2d`  
		Last Modified: Wed, 15 Feb 2023 23:57:41 GMT  
