...
```console
$ docker pull drupal@sha256:009b9b455f1f930539eced3535877053bb983d680fac4d1db48e5313af215030
```
...
```console
$ docker pull drupal@sha256:825657f13f4fa4307be5eb3e62193fc20c30e2e438b759a0264787963ed13300
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52332390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe2db6d4b3bbaed55228d53d1b2497ee9b1f16dbe5bf367f40d8f3ecd68aeb81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 03:09:22 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Tue, 14 Mar 2023 03:12:26 GMT
ENV DRUPAL_VERSION=9.4.11
# Tue, 14 Mar 2023 03:12:26 GMT
WORKDIR /opt/drupal
# Tue, 14 Mar 2023 03:12:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 14 Mar 2023 03:12:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3c500682181f320d48b10937ed78f513776b4b7de55242cc4507f80e5321ee7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab705587bad6c9643a0ecd77a78be49841966a5f3bf48104005fd783064dfa7f`  
		Last Modified: Tue, 14 Mar 2023 03:20:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38bccc6b8a2df3bf007c5ff826334afde16ea420ee31269319f683273e8e921f`  
		Last Modified: Tue, 14 Mar 2023 03:20:39 GMT  
		Size: 21.9 MB (21901699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
