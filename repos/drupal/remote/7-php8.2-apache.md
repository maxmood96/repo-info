...
```console
$ docker pull drupal@sha256:aeece1159e1db01d2b4018481e782151393d45d1799ef7e4e1db419c414e601c
```
...
```console
$ docker pull drupal@sha256:5ae0d2e6c4c457f164f27388c044adc1a227aab6615da050dc83445d4cbb59a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183176034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0758c7ca3ac8462834d08d302d54a0f6ef313cfb44022c9799fe6932365e9eab`
...
# Fri, 18 Aug 2023 01:38:30 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 18 Aug 2023 01:38:30 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 18 Aug 2023 01:38:32 GMT
...
-	Layers:
	...
	-	`sha256:b5d89cbdc7e2b40d1cc26d4975e32df9957b596580522bc316129d32ba5070fa`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0b58267c1f2c8d0e8ad216f5c83188f555f4fa0c49ada9f5653bfdf1e188057`  
		Last Modified: Fri, 18 Aug 2023 01:50:59 GMT  
...
```console
$ docker pull drupal@sha256:7ee394d6390a505cdd9f59fb16d6b1495921a930448c0db7ad722c2e09aff29e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156490616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1081e7fbef8d0774f7479591793e5e5e79ad8711af70276e0770c3192b5a01a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 04:59:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 04:59:35 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 04:59:35 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 04:59:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:21aa994fca220f7b9b2c44a73a27d1c1992cf527cf920320bb7e6818465b61c4`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:520b3c761732bd8e4207756a547a27777426efafe17fa3bdc9a9d598524b5cc8`  
		Last Modified: Sat, 02 Sep 2023 05:04:48 GMT  
		Size: 1.7 MB (1676124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:398547037105256f732bfce129a295d1f63dd5b1bed617b6e2f9296ccd7a1706`  
		Last Modified: Sat, 02 Sep 2023 05:04:47 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de596ba5d621bfb827e816c496f4afeeab11664de76e83756efcc47fa809d318`  
		Last Modified: Sat, 02 Sep 2023 05:04:49 GMT  
...
```console
$ docker pull drupal@sha256:56e99995534cb1e96609440583259c31468e3f203849ef44004d1ddb3c3da4a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147247823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a7dc17920ab9f1f27f8f52a396f47ee8c30715f67b6a7b049b66bf1d763a099`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e01311a74363773d5c79b9613c75994ae6d42b3aa8fcfba104561a4210cfefdc`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81b8907515150c8fdac80ec5f90be41785428f9e7f78f77ac0c8d022e2ebc85b`  
		Last Modified: Fri, 18 Aug 2023 01:34:12 GMT  
...
```console
$ docker pull drupal@sha256:ceea74ad54bf8d858b7d353fa606d4906b3fd946bd9ec031a65f8563a42f5b6f
```
...
-	Total Size: **177.2 MB (177248162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fcf3783881a27d219afa380eed18849f24b1f34ccc6a2dc6b05ccc2c5c4c7ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:ec815a448ec1d7432a71db210e4a53606d5c7ce50e30b60e93d7fe0842da5458`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47cf3373f2e366d4d28061eae40541e669b3c44b98fd985789092aa54b8d2466`  
		Last Modified: Fri, 18 Aug 2023 01:02:43 GMT  
...
```console
$ docker pull drupal@sha256:d866456958c553c973ba7b356f845c964f24ea8bfe4ff8824800fded686930aa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.2 MB (182165619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c140b47e42a191cdb9b170a867b59576fe71c7e2f64dc00e85569d5dd34e7c6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:deda8e87d138f58e144abda5da19d3fdbaa46f0bd2af61b885806e9047212d79`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be752811eab0283a951fc978b6f3f053930b4d9c3168d0099f7b1a2a52a56c0d`  
		Last Modified: Fri, 18 Aug 2023 01:15:22 GMT  
...
```console
$ docker pull drupal@sha256:e22190e88c57a531a7a1ba0d0f9472f695518d7167dc2899d2d39a48b4795ed7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157496494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:048cde107f1d391b68290136a50ffd5793830d401914e6391c5a924a72ec1921`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 18 Aug 2023 04:24:15 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Aug 2023 04:24:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 04:24:25 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 18 Aug 2023 04:24:28 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 18 Aug 2023 04:24:38 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3008681728414d90d0b793f8833f739d19a26d2faf11e317108ae5b02c0f835d`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d70393d10cce04f2eb5fa618dcbf22471d5bc05c28c8378efde21d3e02c02278`  
		Last Modified: Fri, 18 Aug 2023 04:34:24 GMT  
		Size: 1.6 MB (1571006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fa1e1ad7ee2d2ad36ea80ecf7a7ac4f031bebf822861f81a0eb032ee71f84da`  
		Last Modified: Fri, 18 Aug 2023 04:34:23 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0da76e4eda8d6b3668ff1f950a2e5af15282aa4d72e970912c8cfee3521f9388`  
		Last Modified: Fri, 18 Aug 2023 04:34:26 GMT  
...
```console
$ docker pull drupal@sha256:19e659107d9d8be329853552339c27c60be01caa451b78036d398487d038c4ab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187594372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a39af055c46db0ae9dcced698f269777804622beb0412bceb10cb4d4106ff997`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 01:53:57 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 18 Aug 2023 01:53:57 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 18 Aug 2023 01:53:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:db7d03802e35271822b8e15ae8d927be624fdd4507b4344fa7b09f33e20d6f3a`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04cfe23b91dd4aaee5ca6a36555a4ed5fa0012f52cfe9a94c67c04d36b30093d`  
		Last Modified: Fri, 18 Aug 2023 02:15:56 GMT  
		Size: 3.4 MB (3410781 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:622ad93cdc81baced09c4e5a01ff7ca52fb91dbc160598f9216e90c477ab9cc9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156391358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d3e6de8d7f7bd3ee4e39ece891a53fceb53903877428d42165d3be578d953fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:ba250f1ad89cb4a3aefdef74a969efa23bbf0aa80a0027fe52b2761433494dc5`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35304ef068c1bd827634e37647390933e502146b59c318f8467bf060048d848a`  
		Last Modified: Fri, 18 Aug 2023 01:07:53 GMT  
