...
```console
$ docker pull drupal@sha256:ab77c0d1d791a69fa7469bf7b8cdd4056f4972cc4f30afc764b5b34b8eec7b4e
```
...
```console
$ docker pull drupal@sha256:3477f8390bebe12983efe263a26f3bd9723d7740df12cecea68c5f0478a4b734
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187608534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5cc7444e91a912d3aec8228273ffc43c5b7d4948b16eb060f7d7f5b2e025481`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 09:22:41 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 09:22:42 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 09:22:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c4cf5dd3d690712871464f66b24e25b9fa5452352a52633846141211c81d1d98`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f051c420d0763f0f630f908f6eaee019151d1ca9499cbf22f30d4760559b1cd0`  
		Last Modified: Sat, 30 Sep 2023 10:00:21 GMT  
		Size: 3.4 MB (3410788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
