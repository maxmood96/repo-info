...
```console
$ docker pull drupal@sha256:6c3ee5430c91889d74801e5ccffbfc3fb277cb88d707a53f0946ea68e20eb20b
```
...
```console
$ docker pull drupal@sha256:86e4b4cfc1096b194a0e110b3e1733bbf4e8c4aa43461a9eb1084a51345fa400
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.2 MB (177217980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d678278d2aeb907164ace1f10f14e1a463304ab44c6814b22d85cb8d35dc744`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:01:23 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:01:23 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:01:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e0768e39fa560c7f10a025c092baff6fe59928577f5254123d169f2a9adc2ceb`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc5aaaaee7bbb8f6c92336b3711d16eff1f4d16e7d7e651a74fd9328a2042d08`  
		Last Modified: Fri, 23 Jun 2023 00:20:14 GMT  
		Size: 3.4 MB (3410782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5151f583d9dce39b96f05b12807638340fb18a77ef6c0afcc335d929f7800cab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182146834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c0fddd046712904975f98e52bf27ceafc0c8216c54bc9f4a3f2df4cd3c08eb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:28 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:28 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b0e011bc3cd29fcbf8fd2794d4799622276201193bbdfa091d62a3796850e4ff`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c9671bc16b4efead35816b42b1a41f51b52ce32800c42b09f934c60493bbcae`  
		Last Modified: Fri, 23 Jun 2023 00:24:50 GMT  
...
```console
$ docker pull drupal@sha256:a3e20e81af00caecc86a94a876e4db1a19b1afbf21a799e40aa740e47134a3f9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156368012 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17c87687abd2980432ae1a9f1efb52ef15c5072b4d0b6b5b4bb124cb064f5d33`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:04:27 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:04:27 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:04:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b453e6079592c27a7dfebf5dd2f049cec376d3c02d4e039d39acf1874cc9264f`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33fa50e01e25b5d0afb8c3e7a1ca64b78b8ce67607e784bd16a22d4e3218b8cd`  
		Last Modified: Fri, 23 Jun 2023 00:20:13 GMT  
