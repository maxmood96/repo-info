...
```console
$ docker pull drupal@sha256:9e370f5a4c286d83d0987e4a4f8e58049ce50aad85c2d422677d7600db328313
```
...
```console
$ docker pull drupal@sha256:a6293c35e8e282aa146e147128fc39d7e3cd7656fa5abdbb48e84ec929cb7706
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183189377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06ae32f997f519eca877cb77423427cf04c59ef0e665a513e1ec508c2f5d7d50`
...
# Sat, 30 Sep 2023 05:29:04 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:29:04 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:29:05 GMT
...
-	Layers:
	...
	-	`sha256:a13670fa8c8a556083abff53f75bd0ac6ab3d592446ad618fd44a0a551313184`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afb659bb03bf2f1b9f1823b77c20dcfa9c739c42bd9865c9f681d40c14351ca9`  
		Last Modified: Sat, 30 Sep 2023 05:48:58 GMT  
...
```console
$ docker pull drupal@sha256:cf36719152cdab85958e849b24f940a43defd0d4949723c24974d70f704461ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156498463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cefe8d062462e55f24f47fbebb7d1af25ad855186de2c76020676766bf238bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 01:28:09 GMT
CMD ["apache2-foreground"]
# Sat, 30 Sep 2023 04:32:51 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 30 Sep 2023 04:32:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 04:32:52 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 04:32:52 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 04:32:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:aedbe00fbcf0eb4face5fa9385fe018040c0372df344d047a82e58aaf7d513dc`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a12f5f0999757e1b7a3d3dbb3d4329320e53b40bd72a36b3716c0e06aa384127`  
		Last Modified: Sat, 30 Sep 2023 04:38:40 GMT  
		Size: 1.7 MB (1676814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1568cf3dd939bb6fefde508a5102d50ba8d97aa94be778b88e1d85647f279dd3`  
		Last Modified: Sat, 30 Sep 2023 04:38:39 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d6c9f5d3e97fa0562db430ccb0539065bbf4ba34288b323293d54359c42d11e`  
		Last Modified: Sat, 30 Sep 2023 04:38:40 GMT  
...
```console
$ docker pull drupal@sha256:47401687002ec58f96d53e15bd4f6da2583f4caaef11e27c37d40b3ffc9e43ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.3 MB (147260865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:251f0f9300c27594b0d0d0dee79dd7da18b04b71c3cb975d843434adb6cfe457`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:03:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:19:26 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:19:26 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:19:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b3c447295e6caf66777a5482284656e0fdfc02a13547c5366a19392a2668e6a2`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62d29a864c54039f4289c353f5a2f3b72e2abf67c16f682c0b0bf95ea8d91faf`  
		Last Modified: Sat, 30 Sep 2023 05:43:39 GMT  
		Size: 3.4 MB (3410789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:c36ddc14c0bb6bd995e57fa4a94d2185e4307dd21644affc639ce690f17483c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177262611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f28fb07ee63bd37db92aeb12cd884cd4ca43acf01b8c477f8c5f158c23ad3a37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:15:45 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:15:45 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:15:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:aff2485944468b7dfeebf4fb9af6f68de96a0b360e4e4324dfe1b42658980cb4`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb92ea7462894eb3ae7ac599f2f310754a6520b4bf94adf52e7a40eb96b3c931`  
		Last Modified: Sat, 30 Sep 2023 05:37:04 GMT  
		Size: 3.4 MB (3410789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:27e0c55c55728e02668adba79ba0c9250d55f9d7674fa4c5c71c8c451d910fa0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.2 MB (182179340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2ca7cfe88d4cebf17652decfd0f7ddfc4d897a7cb9b9bc968cac73bbd23dba3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:54:47 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 06:19:12 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 06:19:12 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 06:19:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:239ae76f0e0a3e4b0dd1e4dc25a621c425269bca2e63ccf15e768a74eee1ff92`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ed1e0011cd74d42f10538efc1329b7107939ff7d3a50d9d62da8adcd4d33b24`  
...
```console
$ docker pull drupal@sha256:c70e048c2ebcbf8007f8d858e58f80b840d0e2a4715f16eacb6c89716c87aa98
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157502385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7c4f59fd4188d05d8184a43e06256f507fc51b4414229a99524b9bb99cb7d5d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 21 Sep 2023 22:18:13 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 22:18:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 22:18:23 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 22:18:26 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 22:18:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e19fca0609df3058afd752c476d131ca596b7961609819df49d333d8f1ee8ada`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e86d5db90066ac8d582c7cf45f453e7c9776957cc58b9d8c28d5aae15862f3e9`  
		Last Modified: Thu, 21 Sep 2023 22:45:49 GMT  
		Size: 1.6 MB (1571079 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73f25d210db4aff96ae63a581fdabdbb9d18435fd1f1f2c3f248e1255bae0063`  
		Last Modified: Thu, 21 Sep 2023 22:45:48 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:106cd56d7c78e9925878e568ff088cc81dc4fa8109fa32e7899bbacc101fdf01`  
		Last Modified: Thu, 21 Sep 2023 22:45:51 GMT  
...
```console
$ docker pull drupal@sha256:2402902a146eed08989334438e2995db0f46e0af59de640a96120843a4c3f2ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187600418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40216c8ad6fba78720ac6439cd3f115ff16acdf6568a23457034ec994dabfee8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e1a8d9bd949e9afefcf0ad4dce01b9a9789e31cde8b80f5632d02ed08d94ebc3`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1597e522a6c7a19ab6c3307c72df167c3f3c9b26edb885570281c6cf56af96fb`  
		Last Modified: Thu, 21 Sep 2023 10:24:22 GMT  
