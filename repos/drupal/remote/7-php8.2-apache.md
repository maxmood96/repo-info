...
```console
$ docker pull drupal@sha256:f14102e0e57d16ec02e92436e3f2da5f233320254ce49e2cfabf1382cff42928
```
...
```console
$ docker pull drupal@sha256:3b8dfe95e4df4c6124d9de58874e76740e77a18e1ae83521a17b63c95f0da227
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.2 MB (177243867 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:013577655e9f9808df2e1d78c7ca91f08a8eb8ba9af18bf48b5c07a9cb88f639`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:28da4d1e95987606a68f316e1cc765f257711681f64fb822056d637f3bd96e7c`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d0c8acef8b65dc3cfbae968dac311d7bac3f5a246dbe85f860715b70461ef13`  
		Last Modified: Tue, 11 Jul 2023 03:37:55 GMT  
		Size: 3.4 MB (3410777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:951637a67ca3e55c1f868a21ba76a16a2ef9533df02845476c1099a54fd57f38
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.2 MB (182168204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dda6713b7bd9a96778dca95e30785f80863334cb34acff640198df4b7177140`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 11 Jul 2023 01:37:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 02:00:15 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 02:00:16 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 02:00:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:75ba05fd56f15ae3f26bed3fdd300c9458ce711eb54db8ace69ccbce36551b19`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40d568b441359f34094b6d36faedcd11e1d24ebf10ef502be8e63a2e726bca56`  
		Last Modified: Tue, 11 Jul 2023 02:23:04 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
