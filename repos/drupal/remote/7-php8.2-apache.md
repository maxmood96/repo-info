...
```console
$ docker pull drupal@sha256:c5dfa22aeaa19de1e05bc8980a434133bafd5e84f5384ed55751d737fb9fd1fa
```
...
```console
$ docker pull drupal@sha256:445897da9d30070977a94e2af8437697d4de7d47ccefaa9a06a37b5d92d6a148
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183179674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eadf7820fa85aa8a4963c92dc3f109c698f272f9ea41f9100200ed9fc50d8513`
...
-	Layers:
	...
	-	`sha256:32e3395afdd2ac1d78381699e135b9bdb0dd1f870b60614385eafc021890d528`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aa5e999df07b05ccf5d1d41ed1cae446dd9251774b676bf4b6aa4b58afe6155`  
		Last Modified: Tue, 11 Jul 2023 01:43:18 GMT  
...
```console
$ docker pull drupal@sha256:470e15789c3f3036963790c5a920c6b5cd6c30911392c60f48492928e4e6bbee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156490641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fba77894295aea00e88e5f2d8a1df9b1de019eb3774cfd549eb15a8f7e3f946b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 09:28:26 GMT
CMD ["apache2-foreground"]
# Fri, 28 Jul 2023 20:29:33 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 20:29:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 28 Jul 2023 20:29:33 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 28 Jul 2023 20:29:34 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 28 Jul 2023 20:29:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:748fac2561d7700f446beef6c5fde68c2adc7d35901b7d55f63190939aec58f0`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55f0978990bc841a2ac1216b4edf694046586a2c6f62f6fc5dfb9a0d713f75fe`  
		Last Modified: Fri, 28 Jul 2023 20:38:43 GMT  
		Size: 1.7 MB (1675912 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb0209ddc0f32f050da7ec6ba1965ea49661005367c30c0ab5f2a7f33ac71429`  
		Last Modified: Fri, 28 Jul 2023 20:38:43 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb72540fe22f23a9a5b9cbddad63af3274ce76d34d0fae6afda9e213e7cecd40`  
		Last Modified: Fri, 28 Jul 2023 20:38:44 GMT  
...
```console
$ docker pull drupal@sha256:8e1a01d1ac30cdee75c9d11171b6d23ab04fa08fbe35a9c519773a2c7e52e886
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147243305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3728381d69d05f941e206cbb9f37cf98c0e30a6890b38e712c4da8fc64b5ca70`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 11 Jul 2023 00:43:01 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 00:59:54 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 00:59:55 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 00:59:56 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:97fa3f36fbb756f80c885c21abb195e5d11a0b7b9dfd4cf59fd6eaec5bab1a6e`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a47838993f930cd6c611b1efa95419f292c48c78f4471e4b8d4a11d869dbb795`  
		Last Modified: Tue, 11 Jul 2023 01:26:07 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:80054dee7c34efbd50d9a17817adfcceed36781d447bf38365d40eceea7938e6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157483248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea2dc1067c391bae04ade93dd49e58aa836c3f1b511250a2edb0b2da301a7afc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 11 Jul 2023 02:00:46 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jul 2023 02:00:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 02:00:55 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 02:00:58 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 02:01:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5029bd5e7eca28a36667bf7039751dd754adf5a89adb137e89845728df166880`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3c63b2acb8b42169297c36e7517874a12f517116d67b890fc74c6fbe056fc6c`  
		Last Modified: Tue, 11 Jul 2023 02:21:00 GMT  
		Size: 1.6 MB (1570636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee29b57f42b61477d7a67563a32116e9a4a4f6dc6cc23ceb6f846aed9f7e79b9`  
		Last Modified: Tue, 11 Jul 2023 02:20:59 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6549d170871501425f02c072b375cedfcf87f5ebd9e40876240ce4d421579e47`  
		Last Modified: Tue, 11 Jul 2023 02:21:02 GMT  
...
```console
$ docker pull drupal@sha256:ab21e0fd9bd559f9fd500692d1fe91bc64499b4ff5139bbd2d123cdc9287fa81
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187603509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b3e92e1e1f8e3ed2846deca97eba83a1bf2ce0d6e601ce86548c45ff60910c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 02:55:38 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 02:55:40 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 02:55:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b34882a144f428804ee63d0f8f6a44f9a8e5fc95a86679e14082e0f8b7c7e24f`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da823ee75768af551f6687c767d9ec1fe98b923ff5646492c9245f35aaa5486d`  
		Last Modified: Tue, 11 Jul 2023 03:42:11 GMT  
...
```console
$ docker pull drupal@sha256:ead4906d89b337b48ae3dab5095c74f59062d09612ee347701284e3531d8c984
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156391508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bdf2a67e9c9d0f91c7b1a276decbf77345a1543f587c2dff9c201624c259a8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 06:44:08 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 06:44:09 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 06:44:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:42fd77fc0ddbdfab9a11a238df4d019fb926ff36725cd96df496c47cb97e29c6`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb0af2eb6d50dc261908c242a387e5ed8d87757414f462d8308f86903c5b5695`  
		Last Modified: Tue, 11 Jul 2023 06:59:20 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
