...
```console
$ docker pull drupal@sha256:0c7def9ab2a74e37c456dcb7950a35bf21495e49e295e5ca960de1a32a13f90c
```
...
```console
$ docker pull drupal@sha256:2a7b81b5d75685c1f8f2c393d235483cf9b63f066873efa004dcba22d5b78db9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158781953 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32639998c6d8ef750ff3e30f885321d5990216451a4a80704e3efbbe127f56f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 28 Oct 2023 01:28:21 GMT
CMD ["apache2-foreground"]
# Sat, 28 Oct 2023 02:59:43 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 02:59:44 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Oct 2023 02:59:44 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 28 Oct 2023 02:59:44 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 28 Oct 2023 02:59:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:93a63c7b206e01acd295419f7bb5acee6b9b51a864c15de3c1bbeb1a0a332657`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10139f6948d327d8d79a11990ff911cbade2c17640f214daca07cdb60ddad42c`  
		Last Modified: Sat, 28 Oct 2023 03:06:39 GMT  
		Size: 1.7 MB (1679314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b26cab004eb392d1e6832b3bea8788ede402a10a4643c80ae00722203415adda`  
		Last Modified: Sat, 28 Oct 2023 03:06:39 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dab24bce871db427efead16ab5dbdceb04045353f3d0272ebe040d9bb14d7fb4`  
		Last Modified: Sat, 28 Oct 2023 03:06:40 GMT  
...
```console
$ docker pull drupal@sha256:43b506662aa56426bcd3d3c2f38cdbe7114e134b4d6429c797db191462d93850
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157341600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f261280ecd78bc2d6c1df7ed745ad3eec12d565c1cbf701cdc9f3cfde082219d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 13 Oct 2023 02:02:46 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 02:02:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 02:02:56 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 02:03:00 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 02:03:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:caa61d1c0ade2c58cff524c74d567ac81fb89f4422f3b8e9fa8574ea49ab699e`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:524901522dc3eb9a621c752fc861312de69f5cdbc473f67cfaf08503cb856258`  
		Last Modified: Fri, 13 Oct 2023 02:30:12 GMT  
		Size: 1.6 MB (1571142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d6b911fe675019362f92449cfe5d4fb2a6c28ac83b536940fd10787ac54ab32`  
		Last Modified: Fri, 13 Oct 2023 02:30:10 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04ec82eeba4932b4229e58e4e11ad548375d930cb0b1cf98a269dc0dff95afa9`  
		Last Modified: Fri, 13 Oct 2023 02:30:14 GMT  
...
```console
$ docker pull drupal@sha256:5280ec106e435bc7c6afe4ede34e1d830e760510684a8f331ce471fc5796c824
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156452396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83be627608b035126e205c6b14a8e62c590ee5084f6e03ca6985693362201ef5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:28:30 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:28:31 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:28:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:900b2e0a0bf0a3c63f4b6a3fdd5813e06a4f90c583ff716726ce62636ddf6fd7`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fa2bf962148241721c1dac2e22a2e5b25bd8a8df5b9e9048b714f5c61aef743`  
		Last Modified: Fri, 13 Oct 2023 03:42:16 GMT  
		Size: 3.4 MB (3410788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
