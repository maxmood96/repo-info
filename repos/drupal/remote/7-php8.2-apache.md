...
```console
$ docker pull drupal@sha256:2ecec236ff93efe2d60252d99ea32f86a2ab5edc6bdc45626db4b61d7173c5ad
```
...
```console
$ docker pull drupal@sha256:bd0fb817e23323520360e7c12ba34e1663b90ebbd6c32ac917a79edf7c5b7b65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187600971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2c7976e2c3e979e88d05ddb31525357f6c967bd75645f9caf7ae70967ab7ed1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 11:25:44 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 11:25:44 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 11:25:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:25e07aadb1aa0b14e3afe190c3f4009307e305f5e8682443a1d01146afa72eb2`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a63fb2bedd125e4c18f4ab7128f95a9b3002dabc191bb3b012ee699f8d6478d`  
		Last Modified: Sat, 02 Sep 2023 12:12:27 GMT  
		Size: 3.4 MB (3410779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
