...
```console
$ docker pull drupal@sha256:069423f94ddc388bb6fa407987d0d689d5d993f5e2c9357d9674bd30b0c61e2b
```
...
### `drupal:10.6.9-fpm` - unknown; unknown
...
### `drupal:10.6.9-fpm` - linux; arm variant v7
...
### `drupal:10.6.9-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.9-fpm` - linux; ppc64le
