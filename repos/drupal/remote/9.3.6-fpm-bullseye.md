...
```console
$ docker pull drupal@sha256:ee6e9b316555839020afeb5cbf061b6befdf41d958df63b9f141cd4c8049b7a7
```
...
```console
$ docker pull drupal@sha256:ff8b2fb66e341f825012eec061923156a31bb36f744b247f5f0174327655bbb9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.8 MB (186791630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e70478f151c6fb6ed5fc96cd67e79c4743d4a14fb236c34d4266e4733d0d63c7`
...
# Thu, 17 Feb 2022 23:26:25 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:26:25 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:26:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:26:36 GMT
...
-	Layers:
	...
	-	`sha256:8702d4c558b2d75be75f9156eb0c020298c9b234e3b671b7851570d561b87db4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3f1aa1b103aabe70b28123a6d65073d6344cef79272065b3553f08679c8819c`  
		Last Modified: Thu, 17 Feb 2022 23:38:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a46cb02c59ef5056f3e2a5dace34bc30498150ecc389d2a602771a94d39f85ba`  
		Last Modified: Thu, 17 Feb 2022 23:38:37 GMT  
		Size: 20.1 MB (20130245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6aae982f887b83679a819bd2ff2bd6071c8dac2f07c2379705a1fc987ccb44d6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156332085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e58d90219882fc65d40fb4456dc72516d7d27ea90cd518660a6b4fba4d0ecc4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 21:57:31 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 21:57:32 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 21:58:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 21:58:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b09bfeb017f616d9357d85edb4889312b5f376c34b955ef15fd408f37a0789f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc29a8935fcd759ee674e90bade82151eb72d877d9da60f87cd52508b460656f`  
		Last Modified: Thu, 17 Feb 2022 22:52:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ef25d10f877565092624034725e9edde5742dceb637d8ad8497b644405c31b0`  
		Last Modified: Thu, 17 Feb 2022 22:53:03 GMT  
		Size: 20.1 MB (20130047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a08ebc05cc7829e693c07afe92a31dd3dc0ea112a26cb39062d41060a115bd3e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.1 MB (179149776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3796c7352904c8aff7c59c0b4c875601dfef59e07718850a62804d7fde684d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 22:16:23 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 22:16:24 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:16:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:16:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:288f3dcfb108ed7c367af69e928af32651d92f34e69b804a78202d1e60753ebf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b79c6055aa3385443686fd445188a16ba1f9ba7f260d493fe8b8c80217417f5b`  
		Last Modified: Thu, 17 Feb 2022 22:52:29 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9944ec5c742f4532ec18fe0160cc090c9fe5fb915c9a6a99c508d4dfba8b97be`  
		Last Modified: Fri, 18 Feb 2022 00:38:41 GMT  
		Size: 20.1 MB (20130951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:d3111bb7c1a4f2d854d0ad6a4a6c4fbf3d2c9dc319c32747bbe1956f900e30d2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189503338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1edd3cd66c704aaeda0f15fe3c4b42bb9cbf6ce213de70cf03cdc0c0928196c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 14 Feb 2022 21:42:48 GMT
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 23:38:31 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:38:32 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:38:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:38:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00117253e37a79b151e3e2d4f4170fc5a5621c13ca86614b6573bce54b00427b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0616c6c18bd4439e21b4491492313e1d6696792a43b6cab48f1e8d3ffe6cb6e`  
		Last Modified: Thu, 17 Feb 2022 23:59:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c13f56dc1636ce62f387cb4fcb35c925db388e25ac4f0552cb701a3a340b73d`  
		Last Modified: Fri, 18 Feb 2022 00:00:10 GMT  
		Size: 20.1 MB (20130115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:d41a9879ce386a0a012d1ca803b247bbbb3a432a5e0422df17b0909026735941
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186941118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1983a466631ad4913762160f58941edeba4e41d0e51224b76e025ae9401ae3d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Fri, 18 Feb 2022 01:28:09 GMT
ENV DRUPAL_VERSION=9.3.6
# Fri, 18 Feb 2022 01:28:15 GMT
WORKDIR /opt/drupal
# Fri, 18 Feb 2022 01:29:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Feb 2022 01:29:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7aaa441d32a97c9e08e594834c3c1dfa9adda03afb64028afc97e9ef3780a37f`  
		...
		Size: 575.1 KB (575057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efc61452f58c3e3c9c04ed597e86721df4544ce28bf50af0f2b87c75896904fb`  
		Last Modified: Fri, 18 Feb 2022 02:38:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ffe19774d1bce29821395e7f09375d2a672061c360e1879a8bf995d8ffb5b75`  
		Last Modified: Fri, 18 Feb 2022 02:41:35 GMT  
		Size: 20.1 MB (20129544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:d5687105583eb8f231bd77f2973e9b9be6190580ccc8e7bb9e76881b375768de
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163509988 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ca6eca626028a88097f88c24e11387aa9502641b4ab1130bd8967c837b55ace`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 14 Feb 2022 21:44:21 GMT
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 22:43:54 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 22:43:54 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:44:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:44:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:85a98c7379bdfe5eaa35f76a9da07ad5010353b3351c4727a30b8637303653cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3e300fc2216173a152ff15fb13172e1a70f0704d15cb1260bb8091721c05f1c`  
		Last Modified: Thu, 17 Feb 2022 23:10:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:869b9b4bae6b06061f1193f6fd44f8fbd54323b4c589c593175623c9252c5c13`  
		Last Modified: Thu, 17 Feb 2022 23:11:03 GMT  
		Size: 20.1 MB (20128944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
