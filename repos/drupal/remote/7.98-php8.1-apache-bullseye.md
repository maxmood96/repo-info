...
```console
$ docker pull drupal@sha256:f8a3d518ea1234d9a82cb2f383d0e948fe718352a98465bb7c54271e1cbce898
```
...
```console
$ docker pull drupal@sha256:9dd2c0ee921c76beadd3b3956201317418693d43cc9ebfff2abe2317db6f6d6d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.1 MB (171082227 bytes)**  
...
# Thu, 12 Oct 2023 19:56:55 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 19:56:55 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 19:56:56 GMT
...
-	Layers:
	...
	-	`sha256:57b9d2fd26aadae74e211b9eff46088ed41ef95ba05f0e1765039cd8958d9126`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35e6fc0cbb10542f038704cd6c23abaa91a6dabf13e3069c9b7d8dcf58c90419`  
		Last Modified: Thu, 12 Oct 2023 20:16:37 GMT  
...
```console
$ docker pull drupal@sha256:79e61348b03eea41a1cfc323bb1efe62e728792a01e8ab6e2984c3070f241e84
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.3 MB (165273030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8faca6200e4e2f1f1b2d47e05cde09f4c60b7660302a8ddd9e8adbdf50d41250`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 17:29:49 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 17:29:49 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 17:29:50 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:82dec517e7d7b7d09dd7e0e7881ffbaf6df193da999450359212f2cfde0e6cf3`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b733101b9f8bebc53bd10bfe903c8002ec7d085991cea469787441b8d8372e48`  
		Last Modified: Thu, 12 Oct 2023 17:48:06 GMT  
...
```console
$ docker pull drupal@sha256:a4e5cedcdbb925c93ead07bf11db9db6359e53614264e8a21afb07046743fd72
```
...
-	Total Size: **171.4 MB (171444696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5edd41c3e9d2253d402755dc4fc031f35a3bf9d0b6952f5f249a614d055ec7aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:37:01 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 21:37:02 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 21:37:05 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e68497745a2d72dbe60f53eab6b7cb24cf0e2b940f03558125df69b026eeef5c`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:274a300eb7facba4212d164deff87e8e32c431451f884b5b92203c7154d497f8`  
		Last Modified: Thu, 12 Oct 2023 22:21:52 GMT  
...
```console
$ docker pull drupal@sha256:339698f68202c044c8bcd45e08bb2c8738c62cc036cbb42784862ac36985892b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.9 MB (147867393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:986da696c62eac0bfa2aaf5d294aa488aa9a23382a967445839c5bbf69e45c81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:29:42 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:29:42 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:29:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:741626fb50dfebd6552b24d2b14eb977c2afe8023b813db0de1a4156c7fd223f`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fe804c0e9b8dfe613bbd3902720d7c5e9ba8aff400af01ff7c15f1d952b2694`  
