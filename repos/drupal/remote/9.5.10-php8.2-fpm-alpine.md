...
```console
$ docker pull drupal@sha256:6224991f3c5826339f94b3ee0c84407c415ed4af596fc53e6673f789f0d13f4b
```
...
```console
$ docker pull drupal@sha256:4e3cf8fb15c3eb760b8e218f6c48f056798235755c4408c36c0d9fd3e80758ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.1 MB (57123156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13fde707d90cc18071f7ae2f5e415665723fc236231157ccf401126fe6bd9a27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:20:29 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 11:20:29 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:20:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:20:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d3078c5802af2ca41d598319cc6b545d6f8620e1081573429f44a420da91ced4`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2b790a9f068253e8a5b3367ec12b815758fadac815ab60555116d6058f6fedf`  
		Last Modified: Sat, 02 Sep 2023 12:01:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e377454a6e109348d4c18b4d9aacdb12a13a1c6f3b29eb15d7f2cf32b351504`  
		Last Modified: Sat, 02 Sep 2023 12:02:14 GMT  
		Size: 22.9 MB (22874473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
