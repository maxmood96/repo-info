## `drupal:10.2.1-php8.2-fpm-alpine3.19`

```console
$ docker pull drupal@sha256:4d664c114931a7130e0224376b72fa84425e4318499392d32a3888f3f979f5ad
```
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; amd64
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - unknown; unknown
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; arm variant v6
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; 386
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:10.2.1-php8.2-fpm-alpine3.19` - linux; s390x
