...
```console
$ docker pull drupal@sha256:d50e04333c7f14e99d3b3e6f825c3c11c238f2838694ae955dbefa8ad5e5eb30
```
...
```console
$ docker pull drupal@sha256:5cb4609160cf751784ec6635778c3b620247d6e7c22b1ca7cd8c1bca816c58ed
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.4 MB (140384025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc76cb8c1359d875ff72c6f2dc3f3a98c477756247bfcb7fc259199c7a11b9b5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Fri, 17 Dec 2021 02:33:24 GMT
ENV DRUPAL_VERSION=9.2.10
# Fri, 17 Dec 2021 02:33:24 GMT
WORKDIR /opt/drupal
# Fri, 17 Dec 2021 02:33:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Dec 2021 02:33:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5987f79d9d35bc01b46d8541e82c6a5b35d4c5bf002af09b8f990e8ddca5f60c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a066615291ba5a47ae2880f2a4a1b49afcbe94ae3dfe6dacb396a53ba5740662`  
		Last Modified: Fri, 17 Dec 2021 03:08:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d11e494b8cc529347c47c4c115b15ed5bd456ba2856fa19291cc5131c768ee07`  
		Last Modified: Fri, 17 Dec 2021 03:09:15 GMT  
		Size: 19.2 MB (19192024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ee25870ffbc00b2cdafb61d0c2accc7a2d8d82410411270cb0e625eb76be074b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170432474 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58aa0bacbcbcb552760f4222204b4a001f22a982972b924a618361651e67b89b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Dec 2021 23:53:27 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:58:52 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 16 Dec 2021 23:58:52 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:59:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:59:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c6972373ff4372f61d52e274c3a5e191aff76d3444f47ef811cad66702af602`  
		...
		Size: 564.7 KB (564658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ff8d48aa4c2f5a30d49d14fbdaea920ddaf77fcc3eb658181a3254aac8b30c5`  
		Last Modified: Fri, 17 Dec 2021 00:20:40 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf800c48b1b05138a8f3e300eddc5802a808cf62dc20936047eb5dafff67434a`  
		Last Modified: Fri, 17 Dec 2021 00:20:47 GMT  
		Size: 19.2 MB (19191684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7d0d24052cfa19f31cf4befff77199a8d4676d6764b7d002691655331e8ccf42
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.3 MB (150332557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:078c30e56103089717545f20e8337d162412399ce34effb3d8726ac7da491dbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 21 Dec 2021 16:56:04 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Tue, 21 Dec 2021 17:00:30 GMT
ENV DRUPAL_VERSION=9.2.10
# Tue, 21 Dec 2021 17:00:30 GMT
WORKDIR /opt/drupal
# Tue, 21 Dec 2021 17:00:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Dec 2021 17:00:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5276d6195b5aeb3c20e9d6da31af2c87d73ab2f1a1e1823ab7d134acaad9c777`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:318bfc795d9a0f167ce10c0363a37332cd1d4848ab4d11c4fbc4221910a34633`  
		Last Modified: Tue, 21 Dec 2021 17:15:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f49b1d9a1bfa292927b607a5e17cf6550574dbdeaaa7386522e1c482ce8bcc63`  
		Last Modified: Tue, 21 Dec 2021 17:16:02 GMT  
		Size: 19.2 MB (19191363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
