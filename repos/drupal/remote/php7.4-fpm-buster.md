...
```console
$ docker pull drupal@sha256:36d060239c5184f1cdcae87eab22b437bae92482562a8c8032b544566b097ba1
```
...
```console
$ docker pull drupal@sha256:1b5b44df96c61c3ae2ceefd6fb8d290931170bdbd06eeb99e1efdba0264d99ce
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169943831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eeb0bc0fd1526f1764808c04e3f77865da7030b6b0581a5fcdd454f2f8e99a47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 06 Mar 2021 06:14:37 GMT
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Sat, 06 Mar 2021 06:14:37 GMT
ENV DRUPAL_VERSION=9.1.5
# Sat, 06 Mar 2021 06:14:38 GMT
WORKDIR /opt/drupal
# Sat, 06 Mar 2021 06:14:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 06 Mar 2021 06:14:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:784950bd448760ad6ae8acac643a3469ae4e49cfa38f450f50c781e490ff0381`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:129618a74854b94fe076d9ae496edec69792f5f6ce4dd946874ac4245eb39882`  
		Last Modified: Sat, 06 Mar 2021 06:36:40 GMT  
		Size: 551.8 KB (551808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e23d9a20847bdbd08e77d8578864aa2825c4aaec292ef5890f372fb02cb3aafd`  
		Last Modified: Sat, 06 Mar 2021 06:36:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1eb2ff8cde150be105b6a9c61ba21ff1854f989470eefb077dd6188c8f35f71`  
		Last Modified: Sat, 06 Mar 2021 06:36:52 GMT  
		Size: 18.8 MB (18827156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
