...
```console
$ docker pull drupal@sha256:93201e639a87678942dfa68fa55fdb134beb41133e18ccb728fa2b4d8126631b
```
...
```console
$ docker pull drupal@sha256:27ae3153833370c838b35804573fb33c62239853f0e9b4a2e77a81f3a46b8ad9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.2 MB (149201359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4132e8989c2d439df0610f9545c1900e1fe8d3aa59c06b15a217e11e549e9dae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 07 Jun 2022 04:24:45 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:24:46 GMT
ENV DRUPAL_VERSION=9.3.15
# Tue, 07 Jun 2022 04:24:46 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:25:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:25:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e99e089f40ffe3d76091726cbcf6b5c7095d4ce4c9236feb3c7fcf32e823e2c5`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c98bb472ce1cc5463ab44d27df6f809be316ddce50b9efc1c62cea4ae404cb1`  
		Last Modified: Tue, 07 Jun 2022 04:53:21 GMT  
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15cb55e24709e44dd445e441efed932faeb52137b777c32cba7b6c24dc7763d9`  
		Last Modified: Tue, 07 Jun 2022 04:53:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8567c8702590dbf7f6f09d9952e6279fc577328c9bb1de6eec7744c0eae65cb6`  
		Last Modified: Tue, 07 Jun 2022 04:53:25 GMT  
		Size: 21.2 MB (21200948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
