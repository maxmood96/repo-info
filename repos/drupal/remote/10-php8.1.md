...
```console
$ docker pull drupal@sha256:fb68712808827feec4cce749f8de89eb7f7e71b4c4f96a46d064314af36d75c2
```
...
```console
$ docker pull drupal@sha256:39b674cae78d1c0870cd8afb56554b101288eeb6ff8cc597e0a5c5e5a25a6b0a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.9 MB (202851432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e4212112d8b832d7dec51868a6713b55191d0a7e2b9b6e4ccc25acd9a60326c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 06 Oct 2023 18:37:59 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:38:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:38:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9386e150dd501cac750da4efe70431ee5914e0f2bd9acbf22353da97131dbb4`  
		...
		Size: 705.0 KB (705006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8a0e73f776398504ff4b2cfef65b57e62ea668b14ac0c977370facd9a6c38ad`  
		Last Modified: Fri, 06 Oct 2023 19:08:14 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e82c5b002e63695236cc24413c0c50efdd5261cdec625383e10f2c0d3a791b3f`  
		Last Modified: Fri, 06 Oct 2023 19:08:35 GMT  
		Size: 18.5 MB (18527379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
