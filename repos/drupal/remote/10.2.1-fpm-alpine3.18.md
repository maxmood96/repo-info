...
```console
$ docker pull drupal@sha256:a2fd53addbbc4760d3d1262fdfd04ed20300f8702e0f5c1c0fd3455e949ddc51
```
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; amd64
...
### `drupal:10.2.1-fpm-alpine3.18` - unknown; unknown
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; 386
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; ppc64le
...
### `drupal:10.2.1-fpm-alpine3.18` - linux; s390x
