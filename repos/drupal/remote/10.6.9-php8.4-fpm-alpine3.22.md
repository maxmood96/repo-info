## `drupal:10.6.9-php8.4-fpm-alpine3.22`

```console
$ docker pull drupal@sha256:12a7cad98e453519265b1c6c5df505c300c5e1e8da52b52406625fa1654d9fd4
```
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; amd64
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - unknown; unknown
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; 386
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.6.9-php8.4-fpm-alpine3.22` - linux; s390x
