...
```console
$ docker pull drupal@sha256:b8cadfed7b849e2c487466f5f504cd83806dd491abd429340675e627b58dd53b
```
...
### `drupal:11.2.4-php8.3` - linux; amd64
...
### `drupal:11.2.4-php8.3` - unknown; unknown
...
### `drupal:11.2.4-php8.3` - linux; arm variant v7
...
### `drupal:11.2.4-php8.3` - linux; arm64 variant v8
...
### `drupal:11.2.4-php8.3` - linux; 386
...
### `drupal:11.2.4-php8.3` - linux; ppc64le
...
### `drupal:11.2.4-php8.3` - linux; s390x
