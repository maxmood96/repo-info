...
```console
$ docker pull drupal@sha256:5ef5ff56279adcec267839c223b9652995744e56c1ab8ba0074da82941e3d41a
```
...
```console
$ docker pull drupal@sha256:3ca0d2b19b7b58b1358713ce7ce092fa51c5accf77f66c7dff6ec4f662912e09
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.7 MB (184652177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0f570c4fb0748ae4264541e3b829fb268c5b50ca62f45d975cfbaa1d9499b61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:45:25 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:45:25 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:45:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:45:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6096c3944c03b74b794f7b3942fc955ca65b7cdf0debc3b05c54c53efd2ad1c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc999eaa7f264998a20acb821aa0c43a82ac634fdf656904438e6f0778869d9f`  
		Last Modified: Tue, 22 Mar 2022 23:10:12 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7768f25af4ae43fc561a9425e7ae2a87a27acacc234d6aa53c98d18828f9c9c1`  
		Last Modified: Tue, 22 Mar 2022 23:10:18 GMT  
		Size: 19.1 MB (19125658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
