...
```console
$ docker pull drupal@sha256:9948a533662d95251137bd8686c26ab1f4ef5083797d3d599ea56412a1dc7c5a
```
...
```console
$ docker pull drupal@sha256:08bbd604799c3bd03db8d404b1977d01c86054580e656734c50b63f6f70b1117
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182095742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:542aed7a38ff33e3064a3164589bf577ac29cb0236f59fe9325e1c9791466e53`
...
# Fri, 08 Apr 2022 20:56:26 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:56:26 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:56:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:56:36 GMT
...
-	Layers:
	...
	-	`sha256:d71bcc54de60ade44f1d15fd2cdb85147db408a8ebaf813d58372f54b1b1e872`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d9ca62f26b440631ffe58073dc94d7779edb6ab11fa51e38d6ccc2991b03199`  
		Last Modified: Fri, 08 Apr 2022 22:54:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51fe4db3a7a97f3f04b7b5a53a4b2511bc170d38d19a8f3e7acef6a9d30028ea`  
		Last Modified: Fri, 08 Apr 2022 22:54:46 GMT  
		Size: 19.1 MB (19127255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php8.0-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d19866a97a2c865aae2007b04d06599002c71c36198d07cd6c302e9c9bc9c475
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152170117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2aef9c3aac9310e4133b57e680ef231e4ce4b42e181f3aabfcbbaf57a254f265`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 08 Apr 2022 21:34:31 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:34:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:35:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b09ee2f44ecd97f0c7c9d43149d2dc8834946e5a2def634042e78e2d741c581d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:630a3e55f53ed28b1d3f8bff8cc90cd8a5bff739b6a8e6f3075c0d9555e009c7`  
		Last Modified: Sat, 09 Apr 2022 00:03:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f48ba1b0529a6634de2f3bae4b84314a64ba4d200df2a3f5d915fba648a6ad3`  
		Last Modified: Sat, 09 Apr 2022 00:04:25 GMT  
		Size: 19.1 MB (19126528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php8.0-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6facf95f1f06f0f7c140119c9bab8f16aa6083190491bcf08d94000b0b862e2f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174318892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56d2273dec51d53307f56a8aa64e3c3eef8bf18f558ee823639711a2090e2a8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:11:47 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:11:48 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:12:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:12:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aa00afb5b5e6ca07325025cd1cc4706fbed7b05d6ef8d88b114dd5561f4c1613`  
		...
		Size: 660.9 KB (660930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efb8c76dc98db31b3566ac6dfcd84b8cea9a1b275c26e03000072a5fbcb4fc29`  
		Last Modified: Fri, 08 Apr 2022 21:36:50 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88eaa402ae009174aeb379b9c3cd1e1fcd2f2ed57f0348910bbb8f546074bd8b`  
		Last Modified: Fri, 08 Apr 2022 21:36:51 GMT  
		Size: 19.1 MB (19126253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php8.0-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:cab10879d50f4755291f28284feb36616a7fd208de23ed81ba0959e75070c68f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.9 MB (183885581 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb05b1efad7b05989c17e2e78ca323853f6da9e90491d735a1c9de83097c6cdc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:03:46 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:03:46 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:03:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:03:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:996b66e1dde8caa4ad5394415c31d2eb800d4c96a9991dce49b855603d56f0b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7647b0b2f3283309d611c76bbea6ee2d4d967106e3564f1c61097ffcfc7398dd`  
		Last Modified: Fri, 08 Apr 2022 21:28:55 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f18141a5a5028cb10d7f0b9a71568e07d5e05ed20da3e7a84836bfae975734bb`  
		Last Modified: Fri, 08 Apr 2022 21:29:00 GMT  
		Size: 19.1 MB (19126278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php8.0-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:be615c0e4a92f85c6d218eb5b1409cc72729bd76e6152ecc5914f60b4e856c2f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181926166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ae6d69b25c85f50e8ce1d27a51e6dc59d2967a70f30a4919aaf524276c64578`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 20:55:15 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:55:18 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:55:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:99fcbaa327168dbe8442509af5cce55ca1ba592473b191d4d4b98b19198a5284`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:647110b6faff7389318068374e66430cd4e9d0ce7ec6cd01f3629cb25c36c083`  
		Last Modified: Fri, 08 Apr 2022 21:51:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:920ed91ebf16d99254de2aa6e66d139279ccddf2c03c174c372f3e4de7cf8a12`  
		Last Modified: Fri, 08 Apr 2022 21:52:53 GMT  
		Size: 19.1 MB (19126484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php8.0-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:324773c45fa246c94005382c8a3237097bdea5ae17890cabdae0d84ef54e7e96
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159080882 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a02b56596543286bfa231866c72d994b3db03a9c10e4f4cfd76c045a17ecd02d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:11:01 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:11:01 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:11:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:11:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:48027c1897ccfeb009980f2429fc5f2210c86ecfc101d248f3b9340dad2fc237`  
		...
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c741626aaaf61735c7371c4c154a0afa0b9fef2cbc3fbb6d99f7c68327855d7b`  
		Last Modified: Fri, 08 Apr 2022 23:13:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7cad07da289145f4476dfa2dd4202e947b9fca1aef8316d851987125eac67df`  
		Last Modified: Fri, 08 Apr 2022 23:13:11 GMT  
		Size: 19.1 MB (19127117 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
