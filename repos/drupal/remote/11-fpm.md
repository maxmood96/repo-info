...
```console
$ docker pull drupal@sha256:0c81a2d36879fda194fc8d741ebf92d35aef188a73d98c6846de7bbbfc62f0b9
```
...
```console
$ docker pull drupal@sha256:628b08cb59eb0dac687037114c616805d24170923ad1d34779f983f37200101f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.7 MB (224742708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c0606a121b542e34575331a7d5a06e1eb0045341a090cdd4d4f6bcee78f0a71`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e5ea855c55cadf5c408444ca53efa39a605490865cbfed355964bfaffb7720b2`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e52ffe85fa44aeec02a9c16eb5cde250f31c02a8cefd6420e4c9de2d0373c536`  
		Last Modified: Sat, 08 Nov 2025 05:17:06 GMT  
		Size: 20.6 MB (20643185 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11-fpm` - unknown; unknown

```console
$ docker pull drupal@sha256:656f3123ee8215f76c0194a9cc63834c75189615b799079f3c243e53b0c41260
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.9 MB (6923210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4a8448a20bbf4fd4517fe14a11ec912c3e7dce63f09d95a7bd91174a49eff85`

```dockerfile
```

-	Layers:
	-	`sha256:a61a8d5e05d00d05424d58a9d7fe2d39487f7e2bfe5c35567d872c69e0163572`  
		Last Modified: Sat, 08 Nov 2025 08:58:59 GMT  
		Size: 6.9 MB (6884771 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c127452ea8890b464972c7a409cfb9e20033a5deaeaceaaa56345fef7da966a0`  
		Last Modified: Sat, 08 Nov 2025 08:59:00 GMT  
		Size: 38.4 KB (38439 bytes)  
		MIME: application/vnd.in-toto+json
