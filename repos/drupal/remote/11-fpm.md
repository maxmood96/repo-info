...
```console
$ docker pull drupal@sha256:da6ce567c4b1435ac099081da51ed243eb45ad2b2f181c047587b8e790e86e3b
```
...
```console
$ docker pull drupal@sha256:b00c784e48f8cb3f413f3a6d71b1eb1a6d28fbb43fc95434d27bb1b4e75b55aa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189671044 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee19fc1e8f51166b4cc99f0cb98bb6db0b40fb413be3ff2a018d90cfdba96f69`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6cb0c7dca1b6576931d1cb94233e8b99e9a9f908984f130b435eba1f5330a790`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b2355cb2e88f21b658c1b49ed83a43fa809daa46cfa1a1973bb2360d59757040`  
		Last Modified: Thu, 03 Apr 2025 17:24:57 GMT  
...
```console
$ docker pull drupal@sha256:c337e4271f47da2e1bb11cf31ec6e3bcba6bdf4da90bb09c9700bd0422b3371d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.4 MB (6406212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10567cb8a48f3adfb9d274b8e880915119aa86f3feb416d3a8fcd386486c0679`

```dockerfile
```

-	Layers:
	-	`sha256:f983d910ce6d23570117e3274930381f21c871b4133f5cf2e9d9c7364e0886e7`  
		Last Modified: Thu, 03 Apr 2025 17:24:57 GMT  
		Size: 6.4 MB (6370729 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7c37b6425909b80d82ff7ce563cbfb0ab187de8a70005b6bc494263e248157d8`  
		Last Modified: Thu, 03 Apr 2025 17:24:56 GMT  
