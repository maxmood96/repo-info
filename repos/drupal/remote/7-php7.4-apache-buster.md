...
```console
$ docker pull drupal@sha256:392b696762e8df31b1fd0e2089f03c3e8fe6a737682be5e952b444747213b43b
```
...
```console
$ docker pull drupal@sha256:a3d65f3b5a432e0fd952da32ea4e30b9ec5b6a3bc3f31897c641fe06b77520e0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.8 MB (130842490 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87493d6ce0ec25736d06dacf37f851da6a11a69e0c5ad45d8d2e3c65a6693de9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:59870b1b3d219394b961f2d78f7add9b6ffb724a373521dcd45544db9ebfc8b7`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41c0dbfea71d2685a8e91fcc69e9bb5ba213d08e5501667d574e5f49c35796f8`  
		Last Modified: Wed, 13 Oct 2021 05:43:26 GMT  
		Size: 1.6 MB (1594486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93c49537e5f91f2442d7d238e5263df54aa4aad4781a77c376ddbd4ccd0ee895`  
		Last Modified: Wed, 13 Oct 2021 05:43:25 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd7fb8a6c197f8eeeb01f380649587d214f6d072abd6d8e327abe6f15cb9888c`  
		Last Modified: Wed, 13 Oct 2021 05:43:29 GMT  
...
```console
$ docker pull drupal@sha256:eaff9e3a30ea82a8794aa2ab000e527e75ebc5fddab330347da7a96c8259a0d9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.0 MB (128047885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f4c33d5af115cfba4abed3b62b4636c924abbddab6579c30708cb3d55e36ac0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:26cb3403044f553249b4ffd8f76a6caf2f458f2e31bc877efb222aa92dc982e9`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04e2fde432762ad249c76c67dcc84f2a031657b8160c4ce9a27256d50936af0a`  
		Last Modified: Wed, 13 Oct 2021 09:09:23 GMT  
		Size: 3.4 MB (3373708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a330590d1570822d4f9111135cbd44c9f9c5aedf3060bebcb40818c972070911
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.5 MB (144468416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:773b91906238d057eafc31e065376567690f3acc8f7111486fe28aa56da654cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:1ab973e3bb15b349191e12e2cbc69163abf18908a581af0afb13ad953617609c`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7ae8d99e28b2d20796085321725d00288f940af64f28bb1ebb26cbf1d11e785`  
		Last Modified: Wed, 13 Oct 2021 14:06:00 GMT  
...
```console
$ docker pull drupal@sha256:3fe7063f37f9b518434c06563e1db0e7d44282454c46b728c147bf782d061e28
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135176670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23b21a12f21dd952ba100ffa4d44512e9248c5144823e3284406534a88b636ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 13 Oct 2021 13:20:14 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Oct 2021 13:20:16 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Oct 2021 13:20:16 GMT
ENV DRUPAL_VERSION=7.82
# Wed, 13 Oct 2021 13:20:17 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Wed, 13 Oct 2021 13:20:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4dda9b9a8086d8b4e3e4f3daa53e493381bc4d30cbb6a907a61121a4ec032e5d`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54cef879e75dfa59f6cbc9f6a9381659971813fb62c88e26be13cdf66812d514`  
		Last Modified: Wed, 13 Oct 2021 13:23:14 GMT  
		Size: 1.7 MB (1691845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27c0ce46cb1d98f365bc60bc936484313fdd1235aa96052a1521181ab2f23d48`  
		Last Modified: Wed, 13 Oct 2021 13:23:13 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:102a72b33aec4bdf6bd3b682acea1f978ed4958af880693f6fc7d0f04eee413f`  
		Last Modified: Wed, 13 Oct 2021 13:23:17 GMT  
...
```console
$ docker pull drupal@sha256:d5253d71a7b9f8ca8a956d8d6ecf0ee1d117bfa8292cee7a4eea0e91391881d3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (163999743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a62f412d7ae9ad1bb5bf067c3038cff2e191824e108dacd2c9a37db19004f8ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Oct 2021 15:26:08 GMT
ENV DRUPAL_VERSION=7.82
# Wed, 13 Oct 2021 15:26:12 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Wed, 13 Oct 2021 15:26:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:78bd4dcd014ff09e161f882e6936870e96af427bb7d1a170c3f5d64c2098fff5`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0937b350da14e3a54f4cff5aa9ebeac94050bab6a95c00a2cf215a4ccde784c`  
		Last Modified: Wed, 13 Oct 2021 15:57:54 GMT  
...
```console
$ docker pull drupal@sha256:033d24af3d7ddf24b4a5ab37c87e989287cd8984a086018a660889611d93f768
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.8 MB (137799883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:999c02b78ee6781dc6afec8c3ab6beee0acc8a03f8e028b3fc5c772c9cbe7210`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 15 Oct 2021 00:18:21 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 15 Oct 2021 00:18:21 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 15 Oct 2021 00:18:22 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fb138716b3b32ee89e72c846ddad0caeee9de22eefff35d3304ba9e6d9e24860`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e0cf2ac5052bc5b69846f3887bfdcfc5b12aaadc32684fea6d562f215648a28`  
		Last Modified: Fri, 15 Oct 2021 00:32:43 GMT  
