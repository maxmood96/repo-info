...
```console
$ docker pull drupal@sha256:053ddd2c0b9c44c974fc1d351a477089d0cebe697a87ae80d9e42cf8c44dbaf1
```
...
```console
$ docker pull drupal@sha256:c91caea502411ed64e4d9ddbd8e0912d7d452e16aebf6874345cb7d3ff8e9581
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.2 MB (132235775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:073721b67bcce7d4e742ee9bf8939b18b4cadc21c781ea3e5d0d70fd54d95055`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 27 Aug 2021 00:19:25 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 27 Aug 2021 00:19:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 27 Aug 2021 00:19:28 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 27 Aug 2021 00:19:28 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 27 Aug 2021 00:19:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c1f1b2117f912edb5c8c509527d6190034b38fe3127ff757dc28ca5ef8892065`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bca27312398fbe1924d74f209373bf73c805f4ebfff2f580695d4ef74968141b`  
		Last Modified: Fri, 27 Aug 2021 00:23:41 GMT  
		Size: 1.6 MB (1594294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdf3ddde9e07b3b355954a39c010d4b99537afed052cb9672c1729d195ae6402`  
		Last Modified: Fri, 27 Aug 2021 00:23:40 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc05b2b77d40e00ffba33ba6c0d228e1266d364b957012e79a6b072eb65a875e`  
		Last Modified: Fri, 27 Aug 2021 00:23:43 GMT  
		Size: 3.4 MB (3373708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8e8c771b88c05142d5e452ce52cd7ac04eb87d3e9fc4bd2fdcb4423f1f03c1ef
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.5 MB (127505859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e70ed771db7d7482906163e9a54a5be1ebc3a5d2559dcbd221ece9a1f29bac8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 19 Aug 2021 00:23:49 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 19 Aug 2021 00:23:49 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 19 Aug 2021 00:23:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5cb8f288ea5349af663b7d9218490dfb4f292a00d04cd8d2ef2b8dad786d43d6`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea48710f10cb2c0a58f72d7e795936ca0759415b6919146a351fa1dec285b490`  
		Last Modified: Thu, 19 Aug 2021 00:54:08 GMT  
		Size: 3.4 MB (3373708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:826544261e517deac5bb3823b791568648c211fb22942ed0acfde4e66c416ae7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.7 MB (134733191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e77ab0df3f71278629f53a01f2282727c00f4ce5afca811a5af328488b115f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 18 Aug 2021 01:35:10 GMT
CMD ["apache2-foreground"]
# Wed, 18 Aug 2021 13:56:24 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 13:56:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 13:56:26 GMT
ENV DRUPAL_VERSION=7.82
# Wed, 18 Aug 2021 13:56:26 GMT
...
-	Layers:
	...
	-	`sha256:7d154040ea6db210f00bfd501a464efef50023358c07a18bb31a91eec938bffe`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e11d65dea3c834f1493cc7ee67b62517fd52a87d3c1165d0bee3b9cb87ea368c`  
		Last Modified: Wed, 18 Aug 2021 13:59:20 GMT  
		Size: 1.7 MB (1692620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be4f120c0a88821f9efaa34e367acb4c6ed41f2d992fbe5658ce93d21c92fd30`  
		Last Modified: Wed, 18 Aug 2021 13:59:18 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de8c65623e27cf3ccb8a54aa1b0bb5c6c307a511d242d61ede9d43216b94baae`  
		Last Modified: Wed, 18 Aug 2021 13:59:22 GMT  
...
```console
$ docker pull drupal@sha256:66e0236d469148e32e54a607844c56a281e93eab620caa899a372171133c58c1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163552642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3d6916d8bf1c100678f2919e8f64e6814e27a3df0772dc2b2a99633050e5747`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 20:20:30 GMT
ENV DRUPAL_VERSION=7.82
# Wed, 18 Aug 2021 20:20:33 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Wed, 18 Aug 2021 20:20:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9f25a0c603889d12aeb282629056d15cfda4af2e200a2590a9d272e17b2df03d`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d1414fedc15987e15f006794c416c403ba3f58bd4dc81a8aaeb8297f8f9ca74`  
		Last Modified: Wed, 18 Aug 2021 20:58:58 GMT  
