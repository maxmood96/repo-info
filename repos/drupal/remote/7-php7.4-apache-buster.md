...
```console
$ docker pull drupal@sha256:601b5d32c80bc070c34eac0c61080b944b0d1046efd8a84d7e29824940a01854
```
...
```console
$ docker pull drupal@sha256:2b831320388d080c5b6d7b8d4f85a2106ffd8b7838a3e238f7623f88924c4106
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152031700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e747deddb38e5f58abd510b2863c151556b027387e5fdaa00d33ed22ba6c0ce4`
...
-	Layers:
	...
	-	`sha256:93853a58571922a55f7f4867671ffd6e18a04cff1f9bb7de4bce7aa2088662ee`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:163c9afddc4c8b5f75a9d555462d9da6fc1477bedd5b436b45b66d42baa9c5e6`  
		Last Modified: Sat, 13 Mar 2021 16:41:54 GMT  
...
```console
$ docker pull drupal@sha256:329eb34efcfd01848bafe39ffe13225b82c3065ab8ff13327996e5d08f7abc83
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.2 MB (130241296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e058e612770aa0ca3bbc823e5c21d1d935bc89ab8fe50e7119253d78ed2911b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 26 Mar 2021 21:51:05 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 26 Mar 2021 21:51:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 26 Mar 2021 21:51:09 GMT
ENV DRUPAL_VERSION=7.78
# Fri, 26 Mar 2021 21:51:10 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Fri, 26 Mar 2021 21:51:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d3d621335d059d6b7a1f58b3c21d3ec6349f40f92d7c3e465dc8d8db4f5826b2`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c96417d7d665dc385b4bdcbd3a87dca8bd129e6f21365e02852aeb2228d8e549`  
		Last Modified: Fri, 26 Mar 2021 21:53:20 GMT  
		Size: 1.6 MB (1594770 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa7123df335afd0241cd95374f5a6d0837bf63d9761b38d81f1eebd7815340a9`  
		Last Modified: Fri, 26 Mar 2021 21:53:19 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e98fe4c3be15723a6dc49debd9af27366b8c28a8c45ef32a476a5b7f3fea448d`  
		Last Modified: Fri, 26 Mar 2021 21:53:25 GMT  
		Size: 3.4 MB (3359593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:96ccfe431893ca4414107bfaac73698a725cb566f44b52afc2dfcd43b79c9c68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.4 MB (127433577 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e8508dc6c4c48da83415cb92b69f55fc25a804f4b2b7e35a194463c95025d16`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 00:49:05 GMT
ENV DRUPAL_VERSION=7.78
# Sat, 13 Mar 2021 00:49:06 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
...
-	Layers:
	...
	-	`sha256:69553b9a871c45ba49ccfa4cca28758b75603ec3a097899277e18048f5d919a4`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f3be2b63a527a1bf778e5636260ab1ec8f82cdea9b38909d2488e25312bcaeb`  
		Last Modified: Sat, 13 Mar 2021 00:57:19 GMT  
		Size: 3.4 MB (3359593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8e74f514bc3590af63ca6b5b127b77cb0e3c51752d2b162996dd882bcbbc57a9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144131664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79b08e25281ac71f8c92e80c9651593225e673941a6f834ff85700bbce1ca322`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 03:39:04 GMT
ENV DRUPAL_VERSION=7.78
# Sat, 13 Mar 2021 03:39:05 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Sat, 13 Mar 2021 03:39:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:db2f72b46fa8ed428cea1904f59cd9ce9c967df849143c9816042988abf92ff5`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70516d20d847c5966f4201324363e799edbeb03b5174f5be8f8620efda0b7ccb`  
		Last Modified: Sat, 13 Mar 2021 03:46:08 GMT  
...
```console
$ docker pull drupal@sha256:a991f5cd4894e331ee847ae3d3cb8a4b99fd005b4583a55fa311b5b9a7743d59
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158097969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51b7461f387634bac473e22873b87ac97355c63ec31efb1587167efa5dfdac91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 01:49:13 GMT
ENV DRUPAL_VERSION=7.78
# Sat, 13 Mar 2021 01:49:14 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Sat, 13 Mar 2021 01:49:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:639d6c31bf655ee7d8ecea96dce8ea1e81fd25db59945ad245fc967f6853bfd0`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:699daab5d83e193a5fd5511408f71fd23ea5af367394dd7b3390b43587e2e88c`  
		Last Modified: Sat, 13 Mar 2021 02:10:44 GMT  
...
```console
$ docker pull drupal@sha256:3100aff0e483a2e4ac56add2f07f916e63bc10e95073588dbe0af80b2c1d1f59
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.7 MB (134659295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93537d228371eaf6ea2c78a891eeb766ad89dbcecfbbc26cf92d5f6b4214fc0b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 26 Mar 2021 09:56:11 GMT
CMD ["apache2-foreground"]
# Fri, 26 Mar 2021 19:24:23 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 26 Mar 2021 19:24:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 26 Mar 2021 19:24:25 GMT
ENV DRUPAL_VERSION=7.78
# Fri, 26 Mar 2021 19:24:26 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Fri, 26 Mar 2021 19:24:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0d60c3030fd63ebe645cb9feb04b11d034d775c29a8b9c5e34c8bd0b8f61fbd2`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3ffd7b994b7bab61c8907249cf8f0f3f6e7cd6f1f794e4614ab65a4684ae97`  
		Last Modified: Fri, 26 Mar 2021 19:27:19 GMT  
		Size: 1.7 MB (1691276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06d95857d2669f65e6af422b9cf4adf61518a559c88fb4a3e4f22c2ee5a74f34`  
		Last Modified: Fri, 26 Mar 2021 19:27:18 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9667286da858d8d3c39535a99ce6445a311e7fb6cc77162609f309772c9ced8`  
		Last Modified: Fri, 26 Mar 2021 19:27:22 GMT  
...
```console
$ docker pull drupal@sha256:9f9bb8d25734521cb3c0e3ac3cb7b76102d5949ffd94addd7268fe278faa4340
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163492041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a49236b27e7a0d86190b69851f7d89019b01ac51e6307e2581e0bdf9a1d73a69`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 05:59:11 GMT
ENV DRUPAL_VERSION=7.78
# Sat, 13 Mar 2021 05:59:19 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Sat, 13 Mar 2021 05:59:37 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:39f17ab36dd0bfe716814589eb707a7d266fd292ca14d015a78dbc5368265660`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b993a86c5b70320c8257021b541fd25e7b6e8a24fe54d5af1994dc616949a1f9`  
		Last Modified: Sat, 13 Mar 2021 06:22:58 GMT  
		Size: 3.4 MB (3359594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b565c4db9d2cf7dca914882b3ee1a4b877382ec368da71b6433349278cf1f973
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.7 MB (137725344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c38004d3f69f8e499f5e74bfc7cea500d0d1969e7613fae9498b450c35eb876`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Mar 2021 13:26:18 GMT
ENV DRUPAL_VERSION=7.78
# Fri, 12 Mar 2021 13:26:18 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Fri, 12 Mar 2021 13:26:20 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:490120dd0368c97a8fe9d7df0ff1031d180e2a8f695b59a09d374dc674b86568`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63de40a267c3c55d36466ccd1b9dec437f4a93a3f0f6164224b08c9b4e6a8958`  
		Last Modified: Fri, 12 Mar 2021 13:32:49 GMT  
		Size: 3.4 MB (3359596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
