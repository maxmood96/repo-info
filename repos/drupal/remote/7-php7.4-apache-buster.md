...
```console
$ docker pull drupal@sha256:a543c290c229a6be574f890d137906cb7dd40575ff663aef658d838fbf95f066
```
...
```console
$ docker pull drupal@sha256:6d13bec048243cc3a7701379b0f59ac0da171f45afd36c3845e93f62aeea9849
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.3 MB (130346802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5936b191a6c9d317e1bf059e1bb50f644ea1294658b745abf3fe619f995daf1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 18 Nov 2021 16:26:33 GMT
CMD ["apache2-foreground"]
# Thu, 18 Nov 2021 23:50:25 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 23:50:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:50:27 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 18 Nov 2021 23:50:28 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 18 Nov 2021 23:50:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:195ffa749ab3b3e3dc416fd5813d9e0244fd5faeee8d0853e7305acf1427e747`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c04bc8daffbc41ba9a42d20020f8c693b5139366c86ab5c2d4048268e67b9013`  
		Last Modified: Thu, 18 Nov 2021 23:54:37 GMT  
		Size: 1.6 MB (1557036 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31a89c6a3875eddbfe667961684b28669e735a2a7692818fcbf1e144f346f254`  
		Last Modified: Thu, 18 Nov 2021 23:54:36 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ad5382bb307216ae8665985180946269fa72ed97c168ab95165b9eddf20ec23`  
		Last Modified: Thu, 18 Nov 2021 23:54:39 GMT  
...
```console
$ docker pull drupal@sha256:b9513034fe69783c383d05713ea5bd59e3d86239159a08989b138fc0c4586468
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.5 MB (127539032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddffbcb6b91de576152c95ac59affba3d2a82f723de99b5fb9d0f6ce938abe05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 03:17:44 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 03:17:44 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 03:17:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:34cdeefe288941694759cc140268d845d4d2ac5fd3cab594b782997a6ab7aa0b`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9308eb289a38a06f36f8d6870dacc7e2ef5c957d79b57bcb9be8476edcbb8ffd`  
		Last Modified: Fri, 19 Nov 2021 03:54:59 GMT  
...
```console
$ docker pull drupal@sha256:3391c8c0822a188bb93e6f468c45b54be631f6cdd344c6b7155bf9e780f2df88
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143642518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:307209cc15f012316baa95ad99022a1abe5bbb156420ea8855e206e9654e6ed8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 00:00:19 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 00:00:20 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 00:00:22 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:48d1a170002de871d88f40ac827e75e9ec04133a723a9c373d9c6ffdc0421277`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc00aa20e6649d79463772d014ce43e975e4766cb4f852357137d37d00a86263`  
		Last Modified: Fri, 19 Nov 2021 00:20:11 GMT  
...
```console
$ docker pull drupal@sha256:0130b14f2ba5fb59919704b11f758ce55fba455b66c272289ff2d25a2bf09c73
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.2 MB (158210107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7597af0f81d22d06fdfc17c98e0b0dbd94e151237147f87d620d19c665a12fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:58:18 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 18 Nov 2021 23:58:19 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 18 Nov 2021 23:58:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d30ceb5bd26e34241669d886b56efef3b26a8019d25d4976065fd7e94fb9763d`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbe07fcffd68aa426acee8f4af6fa16b3a6d5f82c774c1308986fcc050f01498`  
		Last Modified: Fri, 19 Nov 2021 00:12:12 GMT  
		Size: 1.7 MB (1748984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bea543b5854fc125f992fd3c2920700482d376575adf8098437f28cffa0af69`  
		Last Modified: Fri, 19 Nov 2021 00:12:12 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aed84db7dc0f13c787eb0df1fd99e404809f95083d28d95b06a69ccbe14345a9`  
		Last Modified: Fri, 19 Nov 2021 00:23:04 GMT  
...
```console
$ docker pull drupal@sha256:3d30ccddf1a1677ea0694a1cc8d50f4851fc92a3b51f4f3d885b95db8300201e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.8 MB (134789744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cca16211ca06f428f64dc58650227897232dc08c0c8bbb468c17136dfb7211f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 19 Nov 2021 04:32:21 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 19 Nov 2021 04:32:23 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 04:32:23 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 04:32:24 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 04:32:28 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:40b6de1b7b21707d6a00d30a9b49f71f8a35eecf72d1970d168dc5ff78846c5e`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f79a87ab1dd6b8fc1fd116a2f6fee9064830014221edc8323bfef96abc70636f`  
		Last Modified: Fri, 19 Nov 2021 04:35:23 GMT  
		Size: 1.7 MB (1661149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55a48f1880bad19e6f2b5e2811de1e7f5c97b27f2d6ed54dabf7ae81eb3f7bea`  
		Last Modified: Fri, 19 Nov 2021 04:35:22 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8630309a1de53dc035fcb731262d5155b8371846e9dd9852428c7b8185db9ee`  
		Last Modified: Fri, 19 Nov 2021 04:35:25 GMT  
...
```console
$ docker pull drupal@sha256:a3b194c83638c6df12beb27694f8363b6d3dec982550500d2b896105dd618c66
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163584671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:404a819d215989a6237e315dcbc28676a7d17fd6a6d240318475d2c3607d4b9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 08:19:48 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 08:19:52 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 08:20:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9d327baa847b3bb4ec085b7eed56d3e36befff71df2c1dd42a05e1d259c6a807`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:084b5595306ada5510a7ea2a7cf7fc8c698db688a82473ec62c1759f05b8fa65`  
		Last Modified: Fri, 19 Nov 2021 09:09:34 GMT  
