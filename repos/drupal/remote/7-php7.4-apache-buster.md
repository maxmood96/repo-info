...
```console
$ docker pull drupal@sha256:3d47c926ec9c8e002fb08b8ba88c39e5d28b0cccf5d55eb0d4f62c45fffd2cfc
```
...
```console
$ docker pull drupal@sha256:e1ca5557438ecd4c75f0227438d83aca22fee201b82afa4561c685be8b8a74cc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.7 MB (148730510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa3a4c54e1c7b29a90daebb7c49dbd1fbcc034c7f69db3c6e219599f7f0c88ea`
...
-	Layers:
	...
	-	`sha256:ec9ff418dbd74278241eb0b7a454be5d43a753cbe9761874ccd78bf64a4020e5`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7af3eeafd542aeac75d1e484048061312c57adc9bae8a46c40e36a41d494015`  
		Last Modified: Wed, 26 Oct 2022 17:44:42 GMT  
...
```console
$ docker pull drupal@sha256:6d612f99ab9182d7884c654d7e155adb00617be8786e40caf03cb89390b4b9de
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.6 MB (124587672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:044f29cd6c3f32ca7fae0d749ffe1b56e2927b85e9afd28eabe3cd310147c59d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 26 Oct 2022 17:46:57 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 26 Oct 2022 17:46:57 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 26 Oct 2022 17:46:58 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d2dfd26dfb55c6b45e9fa7ed97e0ee23a6bf2629c946bc288839ed3455ac8734`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7327507b2f6ca996757942906ad947f50aa7842059a6a695f1ea1dba03f2cfb0`  
		Last Modified: Wed, 26 Oct 2022 18:36:06 GMT  
