...
```console
$ docker pull drupal@sha256:a6bcf6a9a4026c83e7be7c9280de35166494935c772c1a05de764f522437a03d
```
...
```console
$ docker pull drupal@sha256:b7292c035240e33611efec939e74b8a6c603bc90fb2a4e7777041ea2e25e0b39
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.2 MB (130238733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5e5122354effdb43f9dca094f3bb19e5a015b65ecaeb996fc264cd7af5a5595`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Mar 2021 07:18:46 GMT
CMD ["apache2-foreground"]
# Fri, 12 Mar 2021 15:29:52 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Mar 2021 15:29:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Mar 2021 15:29:55 GMT
ENV DRUPAL_VERSION=7.78
# Fri, 12 Mar 2021 15:29:55 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Fri, 12 Mar 2021 15:29:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d1eaac2965fc9a9bfacccbd01e82afbccf1838795a2de473eb3b928606f1d8d4`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c4dd4bd4bdda2c5689346bdc9f1ac06fc07e201d2ab439151fb61fe8a2bddb3`  
		Last Modified: Fri, 12 Mar 2021 15:32:04 GMT  
		Size: 1.6 MB (1594693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:298a3bd9e2aefe3dc979e7ef0524ef05c7e7741c9e0d08094f546331a00162ab`  
		Last Modified: Fri, 12 Mar 2021 15:32:03 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee94bf7b38cd15911f15144a56fc0030276b662d5fd58f874244ac11cdefdcda`  
		Last Modified: Fri, 12 Mar 2021 15:32:04 GMT  
...
```console
$ docker pull drupal@sha256:6a38be0c1643e5a11eedfcfbfd915219ccf9ef01663fb2f5dbfcad56dba3515f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.7 MB (134658839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad3fd12b082e9f7597d71a3c94954f0b066857fa9a95b29da51885485156a0c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Mar 2021 05:36:51 GMT
CMD ["apache2-foreground"]
# Fri, 12 Mar 2021 17:24:05 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Mar 2021 17:24:07 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Mar 2021 17:24:07 GMT
ENV DRUPAL_VERSION=7.78
# Fri, 12 Mar 2021 17:24:08 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Fri, 12 Mar 2021 17:24:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:071bf08b88bc8e7fc7a4d1c6ca49ae9d93864c556179725421fa48871a917e1e`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65b48f4505735dc5e36fefeec6c66ed6eb0d27a5d0234c97762201c302cbf02c`  
		Last Modified: Fri, 12 Mar 2021 17:27:03 GMT  
		Size: 1.7 MB (1691321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ceb74ea56eaea9f454b2c5ac90aa0648b64190bf134633c306ddb33aea9ddaef`  
		Last Modified: Fri, 12 Mar 2021 17:27:03 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aaf7e4de11b88f205d74e6cfd7d0ad6bbe0ae011febf06dda0bbb6fe13bf5e1`  
		Last Modified: Fri, 12 Mar 2021 17:27:05 GMT  
		Size: 3.4 MB (3359342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
