...
```console
$ docker pull drupal@sha256:b9ff35ed45cf186556aeb695605ad2d385250574ff7455581e7e815d93a17c66
```
...
```console
$ docker pull drupal@sha256:38a8b29961f34650e992081b3c9d0c033bb015c2105cb8de96745bff2eb667ce
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152020532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a50244f49f9a0c46053d2c7c80729d58ebd964bbed1142d1bac8a042e69ba889`
...
-	Layers:
	...
	-	`sha256:1074669ba4fe77ef6d839897907fe09d83c78808da3146885de303bcb8a3aaee`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424b2825b385391cd0af0b5937edf7a3c4c60cfecf62f2f6abd53bfc89000e04`  
		Last Modified: Wed, 10 Feb 2021 09:58:28 GMT  
...
```console
$ docker pull drupal@sha256:4562b3ea8bf0f148a219edc2dfb245bc2d3701d29272336d8941c3eca5a665b2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.2 MB (130227961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cd68888cd876593f31051d654a1581422565203a11c03d5830ad795f7515916`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 09 Feb 2021 10:05:38 GMT
CMD ["apache2-foreground"]
# Tue, 09 Feb 2021 16:35:20 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Feb 2021 16:35:22 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 09 Feb 2021 16:35:24 GMT
ENV DRUPAL_VERSION=7.78
# Tue, 09 Feb 2021 16:35:24 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Tue, 09 Feb 2021 16:35:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:624a4eea2db5fe273c5e8b656e5f2e58453fc148c8b2aa4883fcdf0d68a933c1`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc67876c50b143bbccbd412a2b5f0be199c0f18f05501cacac19ef90d6ff4eef`  
		Last Modified: Tue, 09 Feb 2021 16:37:36 GMT  
		Size: 1.6 MB (1594537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47d88ca2d6179239c37352c7dcaaf86b4330b247c6e49d96bc57f1e610c9ef16`  
		Last Modified: Tue, 09 Feb 2021 16:37:35 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a99d629bafc4ea9df984e10b5c825e64f6a1e71621ef4ed40f8f1b0d7b2aec7b`  
		Last Modified: Tue, 09 Feb 2021 16:37:40 GMT  
...
```console
$ docker pull drupal@sha256:45b741636c4274b80805d865c0c21ca2254ced4d161e2a896dd56438cf1ea480
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.4 MB (127419824 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd4063dc3cb917d25ee031444fc1c5918332b62ada0e323383a896efa711ea22`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 02:21:08 GMT
ENV DRUPAL_VERSION=7.78
# Wed, 10 Feb 2021 02:21:09 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Wed, 10 Feb 2021 02:21:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:078236a16f4ed67123bc16bb86d95d904ee8cc23d5d1a0aff8dad37aa1686b93`  
		...
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17f6afe40f910681ec22d1685aa9f69be217aac56797e0a30655bda6c19130bb`  
		Last Modified: Wed, 10 Feb 2021 02:29:37 GMT  
		Size: 3.4 MB (3359595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0c82c40b7d2ef637eb740833be10aed4e05688ffd011b2c47f6750b46aa40468
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144124276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d2121017be842f696889e39ba7a74396070d4d40c40a0906540fa75a315f9a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 04:43:48 GMT
ENV DRUPAL_VERSION=7.78
# Wed, 10 Feb 2021 04:43:48 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Wed, 10 Feb 2021 04:43:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2073ddc34f28a48255d4ea3b87fa14dc32488e2b5e13e047c7c8bdfafdc518f3`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c1b1d6c526ebe1079c00c9079a0371197be2e5ab0642e9094b6d6b013853f9c`  
		Last Modified: Wed, 10 Feb 2021 04:50:51 GMT  
		Size: 3.4 MB (3359595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:230e9395496315ee557b0eea5a367b5bc84fe6ab062a31e680fb6179f348d4da
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158071864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c4f8f3bb546cecb5c0f332d10df6b6b13857c2f58677c1cd8f4748a5bdd2cd0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 09 Feb 2021 21:19:53 GMT
ENV DRUPAL_VERSION=7.78
# Tue, 09 Feb 2021 21:19:53 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Tue, 09 Feb 2021 21:19:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a35f8ab237a4aad94bb11e6b9c5f567e55359bde88d81bb8e615508c84b9a06a`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e54563ab0e7b19e570e4eae15a5e90c7c29a0704fee8d2c50364d6f2a4e5f628`  
		Last Modified: Tue, 09 Feb 2021 21:29:04 GMT  
...
```console
$ docker pull drupal@sha256:571fd6cc81759ea8d8b502c80040933d0c97c78ce239eaed1a4da71d40f3a8bc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.6 MB (134646408 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2ad72955ece0bf964d934a60e9e9ac28c16bfbb6361d897002a35febe8583c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 09 Feb 2021 19:03:28 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Feb 2021 19:03:30 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 09 Feb 2021 19:03:30 GMT
ENV DRUPAL_VERSION=7.78
# Tue, 09 Feb 2021 19:03:30 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Tue, 09 Feb 2021 19:03:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:53b8c398f58cbcaa581cc01b8ee1292389485dcfb9c6b5e77bd7af12c4692a86`  
		...
		Size: 889.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5746899b912bbe7fdf2360ecbdaa7325843a2dff7c9e86de0302f36fadaec8c0`  
		Last Modified: Tue, 09 Feb 2021 19:06:26 GMT  
		Size: 1.7 MB (1691002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:075cc1b119fb06f1e2e2ca504fb17803204eefb1d132d0ef717cef10154bdd35`  
		Last Modified: Tue, 09 Feb 2021 19:06:24 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:571219aaf1f19bb4ace36c7e29ff25b56e6294ef15e4d3b0e6394668fc257d90`  
		Last Modified: Tue, 09 Feb 2021 19:06:28 GMT  
		Size: 3.4 MB (3359335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9a8a9b1d9b7a3f3f6d66aa23051b179951801d8ea04eb6e78095b30aae7e9a98
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163479739 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a6d6253bcec2d41d378308937dca3a3c2df387814a2e82200127c3936d6689a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 07:19:23 GMT
ENV DRUPAL_VERSION=7.78
# Wed, 10 Feb 2021 07:19:26 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Wed, 10 Feb 2021 07:19:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7b6b7d177c3ee4bae04da95e2a1d02962d5090331a2eaa4ee77a966139c8c339`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10120fe4492c05cb7a63bcf9c7878130dc0cfe4e9b29e7ac5bf80bd9b96bf189`  
		Last Modified: Wed, 10 Feb 2021 07:46:30 GMT  
