...
```console
$ docker pull drupal@sha256:383a326ec07f6e1f3ce4490eae9dc9477c5c8852fc4b61b59b59f3f9bd6660ba
```
...
```console
$ docker pull drupal@sha256:45949da8fc1bf88d0819888ac1930137d5221aaae392028927262e52d85a1bb3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163549368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96021b2e87e45304225fd72172590a4d81e95553c481e73ca3282b1601a625b6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 10 Jul 2021 02:44:41 GMT
ENV DRUPAL_VERSION=7.81
# Sat, 10 Jul 2021 02:44:45 GMT
ENV DRUPAL_MD5=ca21e214b3de1453e71f2eb1ab182c3d
# Sat, 10 Jul 2021 02:45:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a6204b45fa8b06556b4ef6dedcffe47b57e5b95da769375596d2b9165b957394`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61dd392cad662eef076cfcf8b4f18ea7d136c1b438087741cf5abddfe62e45de`  
		Last Modified: Sat, 10 Jul 2021 03:17:59 GMT  
		Size: 3.4 MB (3373144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9625ed79f10c8fa0b504e07b8ee7402762bee5d5ffaa887e95cfdb2faee0c961
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.8 MB (137806724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56c39c9ab704d60e937f8883d24ae33c8e2ad8b79dba829e4ce8fad7b7780e72`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 10 Jul 2021 05:12:27 GMT
ENV DRUPAL_VERSION=7.81
# Sat, 10 Jul 2021 05:12:28 GMT
ENV DRUPAL_MD5=ca21e214b3de1453e71f2eb1ab182c3d
# Sat, 10 Jul 2021 05:12:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1ec4d84b564da9d1bd50a701d16d49036521dc374ad8d844cae1039f7772fe64`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8084a7c781472942ddfc4c7d81b0179ecf38ff08369d2a96abc3a97dbdf4e5aa`  
		Last Modified: Sat, 10 Jul 2021 05:24:23 GMT  
		Size: 3.4 MB (3373151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
