...
```console
$ docker pull drupal@sha256:e9d387ab1fe19b5bcc430979672ebc6baf7c9e4192406b7f66215ffdf423022e
```
...
```console
$ docker pull drupal@sha256:b5d37b33d11d0daa51cd7ea383d815fb98b6b42fca5bcfd4674bcbaeb9a436b0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152077630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8654d68a223d86cd69b54e8dbe849f4ce8ec2434c767f68335ca9db555a8716`
...
-	Layers:
	...
	-	`sha256:2e0e1912192c16352588a18bd3c084de76c38cd531ea1d1aa1587f62cf61bcb4`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2545b86722d58d51eeb4b76b37819dfb752ee884de3bee4491e812f7adfd80e3`  
		Last Modified: Thu, 22 Apr 2021 01:39:12 GMT  
...
```console
$ docker pull drupal@sha256:5e47b98a9ca2507134adc6a9e5c81d7e1c462d9268b2486b711f7cc9ada986e7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.3 MB (130285853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ec9c2e1ab96b28af63e7c7e1fb090a7bb67355886dce6b35c31fb6c4db26852`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 01 May 2021 03:31:08 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 01 May 2021 03:31:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 May 2021 03:31:11 GMT
ENV DRUPAL_VERSION=7.80
# Sat, 01 May 2021 03:31:12 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Sat, 01 May 2021 03:31:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:35c2389b69b19e80854dc1dd3bf685782220f3b2e6f431bd9a5d346153ff49b4`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e6c0eb08ab69084638ddbd2b3d1fd761a7834bf4ab1a486a26a7a00f0764908`  
		Last Modified: Sat, 01 May 2021 03:33:44 GMT  
		Size: 1.6 MB (1595537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccabf45ec5b8db51f1800686665573f840760157362ef8d1e3ffd27ea61bafdf`  
		Last Modified: Sat, 01 May 2021 03:33:44 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:918283bf60111e96e96cf421fcd79e93a4aedc11facec1c8a361fb38cafab233`  
		Last Modified: Sat, 01 May 2021 03:33:46 GMT  
...
```console
$ docker pull drupal@sha256:83266f7d38b05c0ce10a4f3549dd05641e1e1ca854754425ea1ba4412402a844
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.5 MB (127480118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a839a2da41f38c9713aa28242bcc8a8dc06f7ebb4c23d3b74d24b58332df1141`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 May 2021 04:09:57 GMT
ENV DRUPAL_VERSION=7.80
# Sat, 01 May 2021 04:09:58 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Sat, 01 May 2021 04:10:04 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:33ce0b5cbe2e5c48be9c5c83f7c30fb182eaf22bd342474f6af636c3a907c18f`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1625605fd62e9594388cc5574eaedc253733d43eb27aca7d6f3d2861017b1df6`  
		Last Modified: Sat, 01 May 2021 04:17:57 GMT  
...
```console
$ docker pull drupal@sha256:714a81afddb44d78abe9df406d291f58d127b04de3ad922e532b1da2c4c051f4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144202221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63fb29765f4ee1358b4ee918285403d2f75c644649a29e550a523a71c957c7b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=7.80
# Sat, 01 May 2021 04:49:07 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Sat, 01 May 2021 04:49:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6ae83938ee919fa7370f836da9f1b211b01cc89dd3c2fb8e56ec0022b854d596`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e84daca60ec442b5dd66cd183a9d63d2b1ecaa07d7d472d63f8c210e688495a5`  
		Last Modified: Sat, 01 May 2021 04:58:12 GMT  
...
```console
$ docker pull drupal@sha256:33a5ef6029083d133ef1d7d3e3fad11a247d04fd18ae50800779000a8c9ef806
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158142274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7a09bdfbbc8281638b7c82dd52ae06683e85565c22bca8f1e50c6905aeb3867`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 May 2021 00:59:25 GMT
ENV DRUPAL_VERSION=7.80
# Sat, 01 May 2021 00:59:25 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Sat, 01 May 2021 00:59:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a841d4ada4b793554f44f1e7951a64bf81c63dee5e446b2be13b76fb3d5aaee3`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9afcdf3e74ba5b9b988b21ed824505a105d7b15c93ec3e036f0a25ecb3236b2e`  
		Last Modified: Sat, 01 May 2021 01:22:09 GMT  
...
```console
$ docker pull drupal@sha256:fed3c96dd0969e36f674cdcea8a38a943280455f9b6492e6a14b14ea9c3e8de2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.7 MB (134708075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e1ed51b5169ef83f4c1b7dff7850c222f41da81e6aef358509a051e0225dd8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 30 Apr 2021 23:30:01 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Apr 2021 23:30:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Apr 2021 23:30:03 GMT
ENV DRUPAL_VERSION=7.80
# Fri, 30 Apr 2021 23:30:03 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Fri, 30 Apr 2021 23:30:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:88005236dcd841973daec3b8c929857a0eb38198c921495363627ad63e936990`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08dbace6e3b6705901f5152f7f882900fe97713b1d6e50d6e29e8b65cf403fcb`  
		Last Modified: Fri, 30 Apr 2021 23:32:58 GMT  
		Size: 1.7 MB (1692980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8384c8e177310f43c9d740a9ebda035218d6114b586a1527b7101a967bcb7711`  
		Last Modified: Fri, 30 Apr 2021 23:32:56 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2556f42dc62e011efcca3ecb0365c1bee4bbba67c27b4b8e0f7c774a196ea768`  
		Last Modified: Fri, 30 Apr 2021 23:33:00 GMT  
		Size: 3.4 MB (3365591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:1730b261a996a4220f8911f7f91e69292079ee1c1662b8689a748e3e2ba9be82
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163518348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65e9750ef82dc2dbb959f0167f6464978e0b703a41fde7c72a472587030301af`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Apr 2021 01:44:29 GMT
ENV DRUPAL_VERSION=7.80
# Thu, 22 Apr 2021 01:44:44 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Thu, 22 Apr 2021 01:45:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c1a6e5ff99d979083256b34d3c852d37c46e512e22e070cdc177a0561763b34d`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:def48d1847704eb2e46bf8c0696f4ff32de33c6ce55fc762bf6c8a94c8554946`  
		Last Modified: Thu, 22 Apr 2021 02:25:03 GMT  
		Size: 3.4 MB (3365843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:107df47f8fe0dee254dc30ac5f581d27d1cbc5b107e530e325971de81cce3bd5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.8 MB (137781679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb4f19b1518d002435e91b4ec345e0da9e5ca15b16c3c5a9c64303d9d891bc0c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 May 2021 04:02:08 GMT
ENV DRUPAL_VERSION=7.80
# Sat, 01 May 2021 04:02:09 GMT
ENV DRUPAL_MD5=cfbbc4cde2782f4e7298db3991ca6f56
# Sat, 01 May 2021 04:02:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f9200e9467142b4428a68d53ed5dab6d89b819cbbf80fb52026fad27574f2a95`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:409a9e853bc2e855ceb1353c667e9cc80bb3568b77331c362d841d9ee00dd36a`  
		Last Modified: Sat, 01 May 2021 04:08:57 GMT  
		Size: 3.4 MB (3365846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
