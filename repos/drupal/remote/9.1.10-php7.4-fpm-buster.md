...
```console
$ docker pull drupal@sha256:24d26245fa974cc1603b37a598b5d59c79240a2c4027ba232078714da17a466d
```
...
```console
$ docker pull drupal@sha256:b3bcc304fced5ccf5da312b0b67b8dac6472417191a5118e688bd409502f862b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.9 MB (149926838 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63c4af47fde9fd82590dbb7aca8fd60122e359f8bacc26da6780085a43f6da87`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 10 Jun 2021 18:01:06 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 10 Jun 2021 18:01:07 GMT
ENV DRUPAL_VERSION=9.1.10
# Thu, 10 Jun 2021 18:01:07 GMT
WORKDIR /opt/drupal
# Thu, 10 Jun 2021 18:01:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Jun 2021 18:01:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:51f254b4e6c90713af7e1ac86d4da394b6add27099ba3154570008a8b26d2213`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15dab48c59aef5aa2d55d266c23f5dd0eea39b178298095707e6b05c23a9158b`  
		Last Modified: Thu, 10 Jun 2021 18:08:17 GMT  
		Size: 553.2 KB (553186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5806a67a9aa631a3ac5c17298b80155d67f8636c4e02143e9f50c8d8d7c162d`  
		Last Modified: Thu, 10 Jun 2021 18:08:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb37825995655328c63d684a60dec3424a031b30ce40730b4962f48e1ca4cae5`  
		Last Modified: Thu, 10 Jun 2021 18:08:20 GMT  
