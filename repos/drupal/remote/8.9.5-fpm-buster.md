...
```console
$ docker pull drupal@sha256:26fb891b0d0414e7e9f1aaa407fd0e8a8aac93fe44897095af93c1fb9fb3086b
```
...
```console
$ docker pull drupal@sha256:4d12cd3fa04a5373453f9eaab6a0d4a13ae26b76a2174f36d0e18aec6e2741f6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141721913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f44d2b82744dca2106cdc956fc3cf9dbe984fe18d76181432c57f069eb9e8087`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Sep 2020 20:35:55 GMT
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:38:30 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:38:30 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:39:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:39:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c7b4a5aeb1583452563a8be2b03d5dc50cfde91b5a3a3f01a2aecf43880323ee`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c58659f9b4c26c8a03f07fdbf08e52154682cb25df4efa7f9703e6265776ed0`  
		Last Modified: Wed, 09 Sep 2020 20:44:43 GMT  
		Size: 507.9 KB (507870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36465e473b2a4e57366f87b89b0b7adf5d7abb8c16f1971f766bb414ff8bacf2`  
		Last Modified: Wed, 09 Sep 2020 20:46:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b34cc287359f3e25df9bec060b81c3c4a7e523d05368f6129047fe6ea238758`  
		Last Modified: Wed, 09 Sep 2020 20:46:20 GMT  
		Size: 20.8 MB (20758277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9.5-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:8aa304d845f3b84daf2217f2a5d2a6eb15fc8a9fbf7da4fc88a9cdc191cefc4b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158048973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96d097ad23f37320428a96ec3fdb8b4ae1057fc4d83a1122d79630e0b2d301d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Sep 2020 20:22:42 GMT
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:25:39 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:25:40 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:26:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:26:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:429fb95b51cbb7d3a0f0c0bc5067af947c1218260941d860ed2e8a5ba3076ca9`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:936982e28c99636c503cd58893bd2b42d47b494e6d0ac71fcabb919a4654fe29`  
		Last Modified: Wed, 09 Sep 2020 20:31:08 GMT  
		Size: 507.9 KB (507870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b95cf2a139605d76aefc03847653b66defee53861a5ba633a584ddd6f088877`  
		Last Modified: Wed, 09 Sep 2020 20:32:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d3eb9bbbdc138e35e63e55f8e070beea53ab5dfe689060e9e78b71b9295030a`  
		Last Modified: Wed, 09 Sep 2020 20:32:34 GMT  
		Size: 20.8 MB (20758109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
