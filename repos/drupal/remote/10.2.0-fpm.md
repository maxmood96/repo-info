...
### `drupal:10.2.0-fpm` - unknown; unknown
...
### `drupal:10.2.0-fpm` - linux; arm variant v7
...
### `drupal:10.2.0-fpm` - linux; arm64 variant v8
...
### `drupal:10.2.0-fpm` - linux; ppc64le
