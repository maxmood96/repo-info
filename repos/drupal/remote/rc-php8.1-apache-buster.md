...
```console
$ docker pull drupal@sha256:9d8f978020a7f4276edb0c4c0e8ab5148ac6a42c5f63403fb51219d2b58a79b7
```
...
```console
$ docker pull drupal@sha256:40135ac9b57aa6c11a52fac14997600800272c80b1e7ee81b10b5b27c2fa4c1c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.6 MB (142601667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1946a555547d672670b1d5386a5678fd7e3e6969b735725fbffb71c501219d7e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Thu, 09 Jun 2022 00:01:40 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Thu, 09 Jun 2022 00:01:41 GMT
WORKDIR /opt/drupal
# Thu, 09 Jun 2022 00:02:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 09 Jun 2022 00:02:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72cd120ffd857c755141babaf2972156b3ec53bb2ed80aab1561597b59da164e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7409b3dbbcbedb70cda165317e9b010ad4fe4c048b1207ac363931ef52278c0`  
		Last Modified: Thu, 09 Jun 2022 00:35:49 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5bafbeec2e25f2b4d41602a41e6df55708fbf16f9e0382209cc3fb63bf2ff1d`  
		Last Modified: Thu, 09 Jun 2022 00:36:15 GMT  
		Size: 19.1 MB (19148779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
