...
```console
$ docker pull drupal@sha256:058e1cb79f1f8520210da77d3b4d6fd959b406acea973ac5d951060e92ae3593
```
...
```console
$ docker pull drupal@sha256:1eb3d8f9bc866e68e1af997417dfb5aaf17a5f477f838dfcb96669bdcbe5859f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167383693 bytes)**  
...
# Fri, 11 Mar 2022 12:01:33 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:01:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:01:47 GMT
...
-	Layers:
	...
	-	`sha256:f131e588a69fe3f05652da184140794e9cffd9b83ecaa361bd932cf34fa2ba69`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e7b509f25213541ccd3f20039349fe17ee1b758a08821f93d3b5bcd0adaa109`  
		Last Modified: Fri, 11 Mar 2022 12:28:31 GMT  
		Size: 575.3 KB (575347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b44d8b58707bf24350d3957009441555e15de00cd70595df8907a24433fb11d`  
		Last Modified: Fri, 11 Mar 2022 12:28:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aff992af8c4b1069a3ee65a2b4560f87a49eb1ec4c25c756382e2cae92df9949`  
		Last Modified: Fri, 11 Mar 2022 12:28:41 GMT  
		Size: 19.1 MB (19137013 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7eb81d59dc7fbcd42d3f5131d628c77327467befcc2f6c249225594c84c19795
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.5 MB (142514457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2b6af2df8cef613472cd04b616f7b58f65646c2c0e54dea75d10f116e2e117f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 12:31:43 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 12:31:44 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Fri, 11 Mar 2022 12:31:44 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:32:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:32:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:008f48698c8e3bc9d227cc7c94ebd039d52f595e66d2740eaf55925ee907c3af`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85b93cd6d1249619a8e684b470e74b01c480690aa13fd9062572fe9ee58a2e2`  
		Last Modified: Fri, 11 Mar 2022 15:21:07 GMT  
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bff2fe3b5251b3037c10d49954668464e46fad8651bfdff330a80f96d43acc3`  
		Last Modified: Fri, 11 Mar 2022 15:21:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:396215b04a2954f9a78bcd7bfa0ade5b9507fd910fdeb9db0f57928541a1fbef`  
		Last Modified: Fri, 11 Mar 2022 15:21:33 GMT  
		Size: 19.1 MB (19136469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:38ed6265d031ffea0ce5ba8b34e5d06c6efa45329949a568f32495c4e0f5570a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173304420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edd72de109869853b043e98a2ca7bb45b8b371c42476faa7207ef29148e4e5fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:36:26 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 14:36:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 14:36:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e096dd66dbe705f2fa6eb46e3b9dcc78765a27480d809cdf84f87c3af30981de`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1171af124570c0d49f782784a81d11249218c067a9d54f3e8f3cfe0f1929359d`  
		Last Modified: Fri, 11 Mar 2022 15:14:34 GMT  
		Size: 575.3 KB (575347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4f4fea92df91b726b2ba8f2f58b2a8934797c71e1eed74ab8a13fa6fe755a1`  
		Last Modified: Fri, 11 Mar 2022 15:14:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4505a909e74b9b9f21e72b847fb02728945261a3e2b4a2e356eadf3a188e010`  
		Last Modified: Fri, 11 Mar 2022 15:14:49 GMT  
		Size: 19.1 MB (19135882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:bb0a74f9cece55628cc79523618fca08445862775e71ee7211b378b8b21c2e56
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177798032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc1cae14c80353e6a9e2a422728469695cebaec471f0ca0f80a75322b48714d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 11:12:38 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 11:12:45 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Fri, 11 Mar 2022 11:12:50 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 11:13:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 11:13:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:be4d4b7fa158694a3ed3cd9686d8f0b2409991cb25a542db11b9338f6975a03a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9310cc4d1f91e099f6d0b2fb8292462de88c750def6404c38ce65e082b9b94cd`  
		Last Modified: Fri, 11 Mar 2022 12:41:22 GMT  
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cbda054e74f7b9e568b3c34d0dab4eed3ebf68b546b2d99375867ba5d97bbc8`  
		Last Modified: Fri, 11 Mar 2022 12:41:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5068c56767f597e11f10921accebd590bf910244dccec63b789a0662904c3a14`  
		Last Modified: Fri, 11 Mar 2022 12:43:33 GMT  
		Size: 19.1 MB (19136652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
