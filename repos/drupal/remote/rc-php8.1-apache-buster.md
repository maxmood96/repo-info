...
```console
$ docker pull drupal@sha256:83640207426ae48eec73210dd27820e3188f74a0b2a19a2b9c3835b21d2995f9
```
...
```console
$ docker pull drupal@sha256:7409763cdabf14d75d0e11feb4b7806777ecd4cdee0d0c50b1109d49a6969d06
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.2 MB (171248680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cd16def9029ba36b03ec48a92fd537b58cebd6e4c73f79eaac67a9dc9158726`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 15 Nov 2022 18:41:09 GMT
ENV DRUPAL_VERSION=10.0.0-beta2
# Tue, 15 Nov 2022 18:41:10 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:41:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:41:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:595c1a9eb5123d58e50d02164a4d28e6aba48cab3a99fd4a88933f496d08a957`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c98ddeefc57f54845ed7af9e757f75e3187c5e3afdbdc8ab7873a696564ca63a`  
		Last Modified: Wed, 16 Nov 2022 22:39:53 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4281a03a9c0daf103a55f1d37ee08368272e5e4a26ddabde9040043e23cf47bc`  
		Last Modified: Wed, 16 Nov 2022 22:40:06 GMT  
		Size: 17.6 MB (17578622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
