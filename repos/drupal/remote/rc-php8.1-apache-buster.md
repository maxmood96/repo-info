...
```console
$ docker pull drupal@sha256:68b1c845b0262b7ed865a260ca1786fd3a0d07adebf670323ecdfa48df78eb21
```
...
```console
$ docker pull drupal@sha256:63df9f6f9a15b9fa13eb47b17aefd240cfc7dcd2e13dbeb20bf22e142dfd6df6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167333279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:162e349749b39db1d4e741dd523b94811eed1a12227ed7554660d50829743a45`
...
# Thu, 31 Mar 2022 05:42:45 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 05:42:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 05:42:57 GMT
...
-	Layers:
	...
	-	`sha256:74d3f50862bdaf3072d53234b338080ddca6313f3c79d755197ebe4c4b6d8b21`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53f0e1eb973adb6317eab0471015281ec22db605241bd6c146ab7abaf079aad5`  
		Last Modified: Thu, 31 Mar 2022 05:54:48 GMT  
		Size: 576.1 KB (576057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d51374ca386171a86435febbf7c03bf3dc36cd586847d952a31782b644ae75d2`  
		Last Modified: Thu, 31 Mar 2022 05:54:48 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8d4e95eeb5871adc3a5a42c6d93a1d9af669f3b7b687ca71fb8b3008429f9ed`  
		Last Modified: Thu, 31 Mar 2022 05:55:00 GMT  
...
```console
$ docker pull drupal@sha256:9289da7522df50daad2926338f76b4f60d5b61689de14b08fcef2fcbafb3cf4e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.4 MB (159377860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11a6fc7489d4b1cce4c41ec45655f7d68b5b2d9b9e9859b0d0cb7c9d28ed154a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:09:49 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:09:49 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 15:09:50 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:10:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:10:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:87676351fad48ecd3623fe4720b50a22744fc25f82e0cf6014a42cefdb8826d1`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df534f2547af3aaf00ff17c6d9acc267d0f5b7a7198c977e90559a0cb8790cb5`  
		Last Modified: Wed, 30 Mar 2022 15:46:50 GMT  
		Size: 575.7 KB (575713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbbd343bf7133ab68feac2c4a81cfaf4bf7675bf52c6180d2d3c88e3c5b6f4f5`  
		Last Modified: Wed, 30 Mar 2022 15:46:50 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a756a560916ce47f3c8556bcfd2164690cba60c928ae14e900a4eccfac682fff`  
		Last Modified: Wed, 30 Mar 2022 15:46:55 GMT  
		Size: 19.1 MB (19135877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:3dba1a8076aa8799b823aabd1086d602ec8c3ac435b055db76916a24968cc014
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.6 MB (172608866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dff69721cc312c914d5eb03594cbe3498008a5b86ab6d3895add71ea39147c92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Mar 2022 18:50:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:19:57 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:19:57 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 18:19:58 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:20:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:20:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f8debc7f5f9fc2cefc737f0457d46be79a24d6b6f2f750f92b31df908e606e08`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6903b3a4fe2b499da1671167fa71616e9c3d72866b1031c35cf8bf263d852df`  
		Last Modified: Wed, 30 Mar 2022 18:41:48 GMT  
		Size: 576.1 KB (576059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:659f2949b1540f25039971903cc2726e3b76066ee8192bbda84091c47520fd5a`  
		Last Modified: Wed, 30 Mar 2022 18:41:48 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faf45670efe7cc25e986e28aad541bb07215941ba500cb40eda3583aa5b9ef14`  
		Last Modified: Wed, 30 Mar 2022 18:41:53 GMT  
		Size: 19.1 MB (19136083 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:850e6625c986f42da5b9e749acc3d7887432ec5e78051ac04edb831d69534f7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.7 MB (177745129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:008b4d077c14dc7d78720e4998674972609f1465cace9e71303040919faa925b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 17:55:19 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 17:55:22 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 17:55:27 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 17:56:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 17:56:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:35eb0bd75d8ffc4a6fa6beb02a37c97dfc77e85827141457e0259dcc2c44577f`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41caf5d7013c374fb559651fe85eef8a7f603868e56986a258911888dbf68376`  
		Last Modified: Wed, 30 Mar 2022 19:37:34 GMT  
		Size: 575.7 KB (575717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d2131ec1596c78088ff8d933fae33850256680d1b1cc9192f14bbb3a2062d34`  
		Last Modified: Wed, 30 Mar 2022 19:37:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f993fafcd9b2e8cd9c7f59b150448fd28c1378a895d6cb6eec94a4774e924e4`  
		Last Modified: Wed, 30 Mar 2022 19:39:18 GMT  
		Size: 19.1 MB (19136747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:4cc89265eb4d7857b023c46fb219385bde1b62bd24729713e7064e2ca0551b78
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.5 MB (152540544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07bcc7fdc2a1c08841bd68eefd77edc87cf9cac0e8135c134feb36370c6024ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 30 Mar 2022 05:17:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 21:17:41 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 21:17:41 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 21:17:41 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 21:18:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 21:18:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ccaea167709a432ecf1772680111acc76657b7b38a903675c1d4051f238424d7`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a1933af5058900dcfab6bf74edd2db4d6a2bac29bd67ba8156ba0ebd305f778`  
		Last Modified: Wed, 30 Mar 2022 21:40:47 GMT  
		Size: 576.1 KB (576059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35cae000841d16d4493d842852a2585f6c2ba9401cd164f9b83e3337b6d2b4d9`  
		Last Modified: Wed, 30 Mar 2022 21:40:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:030ced346f55ac02c48b7fee9e37b55fb874680abe6a76f2e40ab868930818d0`  
		Last Modified: Wed, 30 Mar 2022 21:40:50 GMT  
		Size: 19.1 MB (19136588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
