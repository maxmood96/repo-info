...
```console
$ docker pull drupal@sha256:8af1d33e6435c1b9b4be1264d1d198e921152e5d616bef194ecb44275173b6a0
```
...
```console
$ docker pull drupal@sha256:eb3cc6ebab0612f71e52dd664c0c3f6e55d85d3fef8a2b212f4bdfa50a81b29e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.6 MB (152581710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39d19d85a97851921e9334dc536bcde61cd5f12217625360964c4eeb4174001e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 06:28:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:07:25 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:07:25 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:07:26 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:07:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:0bfc4c41c5cc54d6c8c465096f1f1750d726bc1df68cc66ac0deeb3aba47ccf6`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad9dd083871e564c96a3cc69af120d0049aca91961fae89a62470b19a00f2297`  
		Last Modified: Wed, 16 Mar 2022 18:29:46 GMT  
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369ae2aef931061f23dc06336ebed3080b21bd49194e27e73a3a8f830dfbc4d5`  
		Last Modified: Wed, 16 Mar 2022 18:29:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5aa333101ccd63ce6e894ac42cdf83e099a47e6ac54c38c6e2cf7a99ccd8b586`  
		Last Modified: Wed, 16 Mar 2022 18:29:50 GMT  
		Size: 19.1 MB (19136750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
