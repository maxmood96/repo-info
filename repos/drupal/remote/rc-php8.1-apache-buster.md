...
```console
$ docker pull drupal@sha256:bb137e221f349c1a8972949d743dbec111a6c2b44329c8776f9a32cb7762982c
```
...
```console
$ docker pull drupal@sha256:8add0a9668f6ef7d9d42a95352b130191d1df7b856d087e13f60e03baa2705ea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177832837 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b66fb070af2c70567ebd10557aa06b5f07bc39507527a2e0b32091d6793212f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 13:01:58 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Sun, 29 May 2022 13:02:02 GMT
WORKDIR /opt/drupal
# Sun, 29 May 2022 13:02:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 29 May 2022 13:02:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0a6022dfb28a488eb528baf1aee477ef06f775c0c3e1352313f23433fc2b5de5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8ee7ae8710f9bc8b8a7e053edf8f2a9c0c5d831c197824b31c62a255515f190`  
		Last Modified: Sun, 29 May 2022 14:02:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecfd408ce8f2bf69ba5f60dcbb8ec7db2dbbc7563ff17edb8946d736cdcbdd4c`  
		Last Modified: Sun, 29 May 2022 14:03:42 GMT  
		Size: 19.1 MB (19118607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:ff3d59649539216437a1861a25e651e15331add44514068c45dccf46c3907fb8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.6 MB (152616423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7310dd4cdea727e9e8ede1b03d1071e06c64841f32362a06f3d5df3b799a660`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Sun, 29 May 2022 04:56:08 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Sun, 29 May 2022 04:56:08 GMT
WORKDIR /opt/drupal
# Sun, 29 May 2022 04:56:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 29 May 2022 04:56:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d677803b38b4af585a8d9cf9838277defcb582aa22966df884b8f146c8b3f29f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36121a03bb02f915034842ff84345328b7b66a016a198d2691cf3579f4b04931`  
		Last Modified: Sun, 29 May 2022 05:31:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61d7f9b1da405eebe37d646ec42d7adeebe09728eee9d6a17090d27fab107a62`  
		Last Modified: Sun, 29 May 2022 05:31:36 GMT  
		Size: 19.1 MB (19118249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
