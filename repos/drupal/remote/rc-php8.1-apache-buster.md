...
```console
$ docker pull drupal@sha256:7af80196d93fa1c377a4868562a912b7e245644e5c05d4b2dd64d85bbae23db9
```
...
```console
$ docker pull drupal@sha256:483500b7e11fbab517dcda0b2edf74f56a789531648c119cd4a49b241be49bf0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167441373 bytes)**  
...
# Wed, 08 Jun 2022 23:20:29 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:20:29 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:20:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:20:39 GMT
...
-	Layers:
	...
	-	`sha256:eb7696cdfefaf74b66cc41197d62fde1a9c2fdcba205d67d7ecd255ce04608b7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:243b602717a7252f25fd059ceee867a4efedd409f4e0f7dbcfab4aa8eb780f3c`  
		Last Modified: Wed, 08 Jun 2022 23:28:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2f256b039b3419dabc625241b592dab9ca73175ad25b90b13ccf7a0040f8f93`  
		Last Modified: Wed, 08 Jun 2022 23:28:22 GMT  
		Size: 19.1 MB (19148755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c5b42ebda338f953157308aca72b14f84b3357b7e7e7ef68b134f146b21d36c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.6 MB (142571375 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ced7f7a94c609283d774ca0cb560d1e974388f602a365fe28174115a35836a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Jun 2022 18:14:44 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:15:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:15:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72cd120ffd857c755141babaf2972156b3ec53bb2ed80aab1561597b59da164e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fd17e8d20ca9e29ef13da0d3b8ab7faacd817298190bda489926650f68a840a`  
		Last Modified: Mon, 06 Jun 2022 19:10:04 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81ec22930d710bb7eac3fcbe10cc8e97741abfe621a085930ea2f2d5e29c33f8`  
		Last Modified: Mon, 06 Jun 2022 19:10:20 GMT  
		Size: 19.1 MB (19118488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:2aea598ab91dd79c310bb3bc70f06e7663d62de27024af813b1272ba4b6bb2f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159493021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac2bda7ad22a097a1e4984e6312a0bc0b1e5f1f804b4e709b89e5aaa884bd4fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 08 Jun 2022 23:41:25 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:41:26 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:41:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:42:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7deb4ca10da69fdde008aa797787142f3cf6ad11c64116dd504f768ba0e5481d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a82d377f0059773f581a45c7d183153b082bd72fdc8d5eed924e8f9bf706a863`  
		Last Modified: Wed, 08 Jun 2022 23:56:52 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5214ea0ec91a1304f32eb21517c3d1496c3b3df4e34fd2e8af6adaca9f8f6596`  
		Last Modified: Wed, 08 Jun 2022 23:56:57 GMT  
		Size: 19.1 MB (19148356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:c55b672eb4b5dd296196075580ad8f86f3398f2fff5923da7417b5b72a2bc10f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172727499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:597f13733a6696824ba90bf4c7a62e9f36ec4f0455a45fbf4895df0908d65c70`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 08 Jun 2022 23:40:13 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:40:13 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:40:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:40:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:76eb58e985a42c5ac68e93cdd6f7032638c7eb75c495461bc709890463914e34`  
		...
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd2ba3e835035f638936ecbf64c0709f9890bd8f4eb7e4c9476ff1928a75a496`  
		Last Modified: Wed, 08 Jun 2022 23:55:59 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4688d1d2d948ddefcf3e1422b16fa060422d4120769ec3a10f6beea83a0fd274`  
		Last Modified: Wed, 08 Jun 2022 23:56:05 GMT  
		Size: 19.1 MB (19148599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:20230f61960036a9c4fd52e56b1e283006641c112c69aa4ee67a37e13885b42e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.9 MB (177871606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1d0e621e1c17c944d3393e71bfe6c59d09302b29ed28644e68a3ff9057fcb1a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 08 Jun 2022 23:20:36 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:20:39 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:21:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:21:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7503ecf0e1e89cc2660adabadd6c650f4730f35b6b17c98244a31eee89bc9c24`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca3f987823838233bb9051ddaa82612d796d5fd7ddc2a12e0c54ff0ba42906b2`  
		Last Modified: Wed, 08 Jun 2022 23:39:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c815f315e14336e45427da10dce560fac5efafccc216eeb4758be7abbc7480e5`  
		Last Modified: Wed, 08 Jun 2022 23:39:45 GMT  
		Size: 19.1 MB (19149121 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:a2d9e68b1c0132dc43ff0428a77ccd0b49a1e3da6c1399e99cc781fa003976c3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.7 MB (152655461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06e862e2a6958c950b77b8342a7a3f85d5c29a3dd8944d6a5b6f85a3bb4ab03c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 07 Jun 2022 04:12:59 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 08 Jun 2022 23:44:05 GMT
ENV DRUPAL_VERSION=10.0.0-alpha5
# Wed, 08 Jun 2022 23:44:05 GMT
WORKDIR /opt/drupal
# Wed, 08 Jun 2022 23:44:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 08 Jun 2022 23:44:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:61ee4cc3cf13cfc36af0d17c1834154bd1d97063907ad35e9804d509af64a000`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dd76e94e666f42e3fd9433fdda282fc48ba62b4bf899a5b16baac8a834d2d78`  
		Last Modified: Tue, 07 Jun 2022 04:44:42 GMT  
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cb1e9d3ca47c14c4bd52b6d1c262e361943afde85a16798be0a31598b498f1d`  
		Last Modified: Thu, 09 Jun 2022 00:02:24 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc2d934e09c9129c1ef9eeee8e1ff94ff3de86ff6251ba4c2dc5d00a502997c0`  
		Last Modified: Thu, 09 Jun 2022 00:02:28 GMT  
