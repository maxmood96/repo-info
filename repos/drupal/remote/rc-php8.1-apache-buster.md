...
```console
$ docker pull drupal@sha256:66b177d2908d3255170094880b9cf33b7887dedf4ccd0af61e3c219ea421c580
```
...
```console
$ docker pull drupal@sha256:6cd7d4e488f5a6470aaf92bbf609e0ca9a9c313ae5c3c1645c39a24c0790d0ac
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141266297 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69a559e9dfaea07905f88b5812158006d5a571bd82097c57e907d6706c2aa347`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 06:33:10 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:33:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:33:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7fd48956fd823a05fc3f9880cd0e4cf0a700d5b6cf6be0d78b0d66d96ab1f476`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:385eed6aef6735af667a689f1dc750c8b90f696c2ddd68039d688e75ed551ea2`  
		Last Modified: Tue, 29 Nov 2022 07:13:12 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2292b38ac55836874d6ad2f2648a8d006cd8e5e0610a18b7b2a5454b252abe3`  
		Last Modified: Tue, 29 Nov 2022 07:13:18 GMT  
		Size: 17.7 MB (17669130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
