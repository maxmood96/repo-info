...
```console
$ docker pull drupal@sha256:253d52fd5599b43d919fa69fe3382f03746a34f62e5e596b3c030047c8b5faa7
```
...
```console
$ docker pull drupal@sha256:d33c693e0cf6b0792a5f5e3d0cb2a16e4255dba6f59b15321dd28e3c925910eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.7 MB (186731923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25a672a8cf34e63ae14a5ef18988d0be3e706f310816b4f524f6d0b1bdfee4bd`
...
-	Layers:
	...
	-	`sha256:784fc415cf40b4d69c431dec1a4f9b7b7405404fcaa4ab92aa95bdcb743ac017`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d9f4d936953fcf5aa70d25fc2ffc63f4b26a69661777401483a14fc61ff6612`  
		Last Modified: Fri, 08 Apr 2022 21:10:35 GMT  
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c91b7108c5c252306767337807ef51dd688e81c4f6128ddba7ccc95e4e1956a3`  
		Last Modified: Fri, 08 Apr 2022 21:10:35 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d708e0e8eed638de084711066e65f62a7041e41430cd323f2004ea77cb19206`  
		Last Modified: Fri, 08 Apr 2022 21:10:40 GMT  
		Size: 20.9 MB (20937628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e164b123d780441ed1e3cf1c2b5b5feea065aa2c841ce010ae4a08b158ae9753
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (156979505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39ba1f324732bb2492d2446fbf815c660d0de7311cb0d89b735c63655934604f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Apr 2022 21:28:26 GMT
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:28:27 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 08 Apr 2022 21:28:27 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:28:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:28:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:824380bc82239af62ed65c9d1bf9f76da1b028b3fa0c00db4c9020b8700c08d3`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8169af5d9f5b15f4e569f3a48bcd7fd4692c2caa385914a1d8bf4b22200ebd8`  
		Last Modified: Fri, 08 Apr 2022 23:56:22 GMT  
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:297776e59ab4db150dbce040cadaffec859fcc52fb3282d35320836311d44768`  
		Last Modified: Fri, 08 Apr 2022 23:56:21 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76fc16df10b6848ab4f39da6f69a8807debae3b13e942894ffa559c51e84a367`  
		Last Modified: Fri, 08 Apr 2022 23:56:50 GMT  
		Size: 20.9 MB (20937708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5936008f75ae014627d5953baef4d2022816b1946abe496f27d301cd57fa457a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179573599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:084bfb83c5188e92f3289f693b7840e568798041f7bcd0624220088a0f62b102`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Apr 2022 21:08:28 GMT
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:08:28 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 08 Apr 2022 21:08:29 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:08:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:08:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3dc35a66d2cd3d46a0d50db012d53cf9654f482ff0487fe001ca5abfba65ac3`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd2033a3f8b353cc70de6c3fe795e72b6d41f5d5a5e7b10ffe6309b8228c7d0f`  
		Last Modified: Fri, 08 Apr 2022 21:32:27 GMT  
		Size: 660.9 KB (660930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00eab052c5c0b0cc1d225ef5a7fd5d20ffb51496b036dbdbe471d237380c2945`  
		Last Modified: Fri, 08 Apr 2022 21:32:26 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14d8dd16fd9659b7bea3d6c84b9ecdcae721e68f21cdb5f629fe43efdb030f14`  
		Last Modified: Fri, 08 Apr 2022 21:32:32 GMT  
		Size: 20.9 MB (20938344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:c01e37da9de43bd5bb52f161060993863c3eaa7b699a3ce8f536a779f3ffbfeb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188805903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d32510026920aefa3e0d67be9bac61c6d4d69bebbef5f56e39dae92eaeea4df3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Apr 2022 21:01:01 GMT
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:01:01 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 08 Apr 2022 21:01:02 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:01:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:01:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bcde69de946a64ea35814d6ff5e358f70b5260299fd276a1a18b020c1496e570`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9167a369e2b80773d13e7d2a455cf8070e7e14b42e9f5d7d60d991de7e6ece0d`  
		Last Modified: Fri, 08 Apr 2022 21:24:31 GMT  
		Size: 660.9 KB (660931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a85fbddc4555436802a7264fd9ef5ae396a953d4100797aba6b79c7f8cde4889`  
		Last Modified: Fri, 08 Apr 2022 21:24:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e02bd585d96efa9b5898cd15a7eb2cf0397dd13789bdfe35d563eb4d9db5c82`  
		Last Modified: Fri, 08 Apr 2022 21:24:36 GMT  
		Size: 20.9 MB (20938201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:e5fcc9f5e0d88f0049de18bde111e742762cc0da8e4a6ebf372ed66b4a674f50
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.8 MB (187795083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd898d0723e72998b690c18e7bf58c634e1b1cc96201cc1d8c3ae8bf2e13ad40`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Apr 2022 20:48:47 GMT
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 20:48:55 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 08 Apr 2022 20:48:59 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:49:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:49:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8730c837026d00e31c500350c351be8ce3915c0f24080af13fc707218a4d73b5`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:863177290ab15e0864a66ff2b2550201a5ade421c1495234c617318c5f52837e`  
		Last Modified: Fri, 08 Apr 2022 21:39:31 GMT  
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e36327bca13aa034959f7d3a80112bac6022344017ad8d21b0cb2601876ed0`  
		Last Modified: Fri, 08 Apr 2022 21:39:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6d3ab3531ee3dfe182717e04307dce341d0c8e794d950375742d5e8c3c40c79`  
		Last Modified: Fri, 08 Apr 2022 21:41:03 GMT  
		Size: 20.9 MB (20937722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:cbb97eefc4182388c4b798d6a546fa51bc6c2e6156d12859b82fde251c0447bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.3 MB (164269577 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1968cb70757f5c64af90f88b79aa852f776cc9e0ad27073aa048d0ecfee8a728`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Apr 2022 21:07:28 GMT
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:07:28 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 08 Apr 2022 21:07:28 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:07:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:07:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ef1f3180aed03ca8c343b08dabdac4dae943955f31f244cfbd23d4d3f8acef9`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b47d06d7c7107a954665c40587ba3ef4fc3945fa49c8654bfdcfa7b492397ee7`  
		Last Modified: Fri, 08 Apr 2022 21:30:09 GMT  
		Size: 660.9 KB (660925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6b56a34fa8caa2ad9f1bd912f3d0737a60e5a7d348a1c5f01fa3f900342d958`  
		Last Modified: Fri, 08 Apr 2022 21:30:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75b1d7563c929657626a5b5b0eb7938f984985d577cd59ae61a89b5580e4c203`  
		Last Modified: Fri, 08 Apr 2022 21:30:13 GMT  
		Size: 20.9 MB (20937707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
