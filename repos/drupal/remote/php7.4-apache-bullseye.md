...
```console
$ docker pull drupal@sha256:1131be36c51cd70047b626615fbef0818ec1bfc0eb76ee43261f17ccf986c24c
```
...
```console
$ docker pull drupal@sha256:1fcf4b87db32b3df57e23e951470c9ce5f586ce759b79b1bf11a0969eafbb2da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186629857 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4774acac4ff37fd9b5b8c38b8d8bb5ef9291413b17e5457ddeeb899370056cbd`
...
# Fri, 11 Mar 2022 12:15:23 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 12:15:23 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:15:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:15:33 GMT
...
-	Layers:
	...
	-	`sha256:acb4f8c13d848619314e459a36bf623830e8431c9ca103ca3893543cf5143eec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:599f8b84bfe766fd3cd405f02f357f7385122f3c9234811c41548fd8bd4a95db`  
		Last Modified: Fri, 11 Mar 2022 12:35:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14e9971f55cda6a85734e54b0d31a0e8f656b435bafe8fc74a849723104c13d2`  
		Last Modified: Fri, 11 Mar 2022 12:35:13 GMT  
...
```console
$ docker pull drupal@sha256:8dfe77386666601f786f8d7782272a9c428ee97b9e4e2aaa2610bf809ca983e9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156876602 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab102147c5ad14e8de5e5a4a2d91368a65806c4b374b5dbeebf849934dddd0ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 04 Mar 2022 23:40:00 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 04 Mar 2022 23:40:01 GMT
WORKDIR /opt/drupal
# Fri, 04 Mar 2022 23:40:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Mar 2022 23:40:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26cfc5049e15f4eec268b8deafff74575824cdeb55309b664d9e97869402f905`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4e15850bd782fb30a622c93b740f4e15e52ccc69baddffbbe59109624a0aa22`  
		Last Modified: Sat, 05 Mar 2022 00:18:15 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89934809ad3b43cc2ceec602af11d404e82ca0c26e7b2241db8b54867928b8cc`  
		Last Modified: Sat, 05 Mar 2022 00:18:44 GMT  
		Size: 20.9 MB (20933911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:45d133a982c07918bf80e10c8b78a74b881456415c63406112b118550ff79781
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.7 MB (179680679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:819b20293c16e87dff8903d1faa8f0de7e6e11d3a03ac9798c602d4a81e94bd5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 10:59:37 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 10:59:38 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 10:59:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 10:59:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:61c304f916461f44e902a8b1f70a0f7b87370febcf0cfba1f92595528e3b2915`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b14eeaf88ce04355fdc94a273f0715cf3714e268d58cee2807707b054f5ea9b5`  
		Last Modified: Fri, 11 Mar 2022 11:28:08 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f449a9fd17bf20d1e0591849cc6679dd76a61015f0d05c1d84d676b3afa6c10c`  
		Last Modified: Fri, 11 Mar 2022 11:28:13 GMT  
		Size: 20.9 MB (20935261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:139674ed4a0ea527753fa3d49e6e1a07369401b97052ebb238a4060a18af75c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189553076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82140332ac6a7f9f3a1f6ee6511dca17928e3311f5de884243d2f6b20a1716aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 03 Mar 2022 01:40:33 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Sat, 05 Mar 2022 01:53:26 GMT
ENV DRUPAL_VERSION=9.3.7
# Sat, 05 Mar 2022 01:53:26 GMT
WORKDIR /opt/drupal
# Sat, 05 Mar 2022 01:53:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Mar 2022 01:53:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e4ca8f0660bb639b3d94b1d70cdb4b325692c7b25b9a6f06f44f8eb6783d3e99`  
		...
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a093af62cd97616f5c876272cd17a0bd87a0bb74339194aa5180d2f6bad2679`  
		Last Modified: Sat, 05 Mar 2022 02:14:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f688c11da4a501284c5a16befa37d20ddaa543f8b51a6d90fac0f5d9429794d5`  
		Last Modified: Sat, 05 Mar 2022 02:14:55 GMT  
		Size: 20.9 MB (20933670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:0694e0877717677dfb2913e6cb1815537e85d82090c2ce509a014cd7005fbe88
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187693805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1130063ead0109235014e1a3c0c7e8bae22e5dd104cfb00f1466cb9f01a1101a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 11:48:30 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 11:48:35 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 11:49:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 11:49:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:63d97ecb62a61a0319b033a5cd11a0ecbfbb542434cbb3dcdaae690c1230e899`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b56121c058024724d9a147ef7e0a54b8898961ce69c8fafdcbf93e02da197eed`  
		Last Modified: Fri, 11 Mar 2022 13:15:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adab19fea2fd26421337ea67e5ea14a45bc35ee1a468caec1a813f703ead75e4`  
		Last Modified: Fri, 11 Mar 2022 13:18:30 GMT  
		Size: 20.9 MB (20933892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:36d6cbab71db3aa1e653dbdf3e162bcf0832d5aa6afa153396d9549dac82298f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164168687 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e731aa437fd6bf14579f35c0e7f713a678f3f8d0d4ed300420232f041a75013`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 06:37:45 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 06:37:46 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 06:37:46 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 06:37:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 06:37:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:18f8b3533de727b23e0d310961bc6e58242f81350e3e778c548d26fea5912e1e`  
		...
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c053d26469fffdd12096fd8810725f4ab776ce1fabee96cfe8f68e8eac7e98ae`  
		Last Modified: Fri, 11 Mar 2022 08:41:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1192fe783aed22ed401ffcfecd29b83ac23868516080731b671c66b18a378d68`  
		Last Modified: Fri, 11 Mar 2022 08:42:02 GMT  
		Size: 20.9 MB (20934050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
