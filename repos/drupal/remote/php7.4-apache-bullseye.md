...
```console
$ docker pull drupal@sha256:255bd4c3f43d241d18d9f5b27c616dc10602bdb242b78b87a787efaf97794a4b
```
...
```console
$ docker pull drupal@sha256:4c133b69ba9ba3b5aab70da0feaa7945946129a462722a42ca5a11132adfec46
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187556139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb85708fa3b79b4140b3c935c13e93f4d2f18e1ce1d2f5153d8c3236030a4858`
...
-	Layers:
	...
	-	`sha256:aba927d2c0fa3a828a751421291bef8a4f5fefd12c94f014299d0c2393cd92ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0b6a4cebd7650db77bce599a39c470375f1ecba101a64f6f1292078cf6fe0fc`  
		Last Modified: Wed, 22 Jun 2022 01:02:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d72180b2b0a45983475f56ab46d339981e1fa6d83dcbbc9ca44e96ac6600b9b`  
		Last Modified: Wed, 22 Jun 2022 01:02:51 GMT  
...
```console
$ docker pull drupal@sha256:0d6752c5b9213e78cf85a8f0de7117a6605081189647fc6082e99090f7f4d2a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157806224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b38a31dd5874c348f9d9628c713fe4292a9a76e3b380a6ec6f1e376f9146a559`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:29:41 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 01:52:54 GMT
ENV DRUPAL_VERSION=9.4.1
# Wed, 22 Jun 2022 01:52:55 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 01:53:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 01:53:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b161dd9a040560b40456a14e0dc3ca7f0eb106fecd2edf815e66d74e7fef4889`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2eb02078cf24d8212f4a5f90530296d0247ccb2e830330582493199383e4b5e9`  
		Last Modified: Wed, 22 Jun 2022 02:55:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26afda6220ca329f84a9d32d984849de87fc976deadd4630ffc310805f9f2a8f`  
		Last Modified: Wed, 22 Jun 2022 02:55:58 GMT  
...
```console
$ docker pull drupal@sha256:1116d4ed38385c5fb051c4edd17012f72752b74eadcf20015e72088d7c0c74fe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180401177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8379741d50ce2b8cfc3935acb75094d5d73ccdc18c20de8dde9d142e162c55d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 01:20:15 GMT
ENV DRUPAL_VERSION=9.4.1
# Wed, 22 Jun 2022 01:20:15 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 01:20:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 01:20:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4e69dac71944c13d1da115d9f42452d9881236f09d7473bed74ba9201cc32d91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73c1173b19a4d1c77e3dc8e7a4a5c0aaba76c8d178990edd4e30c787011a034c`  
		Last Modified: Wed, 22 Jun 2022 01:51:27 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e79141cf4bfb551c2d9a899d7033ec6965d2fe1ac8df3b8095774d1b20cadcb3`  
		Last Modified: Wed, 22 Jun 2022 01:51:33 GMT  
		Size: 21.8 MB (21751843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:ebdf23a72f3c40488df35d974eb85ae589240d4ae384abaee022dd036aa82371
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189632537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5ffc31db5b7af858ce01316613915208e6e4f8f47bf7683a66f077ee99f3997`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Jun 2022 16:42:08 GMT
ENV DRUPAL_VERSION=9.4.1
# Thu, 23 Jun 2022 16:42:09 GMT
WORKDIR /opt/drupal
# Thu, 23 Jun 2022 16:42:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Jun 2022 16:42:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ceda05458943d42806234efa6845f8e3b441405f2e0a27e1d00d161ce320eea2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15f4e616cd3b87d32126cc810937f26c3fc46fb9442bbffe1b8af24b37a9967c`  
		Last Modified: Thu, 23 Jun 2022 17:14:25 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cb7543723989f6c0021b92fe3df2a96543fac59043647bbc5a25ba35f1f6b19`  
		Last Modified: Thu, 23 Jun 2022 17:14:30 GMT  
		Size: 21.8 MB (21751671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:1b8ecc98687a1bddc33e1cdda3c3c85f514db9227ffa96b31bff953d192d76cd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188625417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cdc4f7fc88a7393bb3e7afbe56db36b37460cc585d2fa6fb37bb1f98f08f059`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 00:50:06 GMT
ENV DRUPAL_VERSION=9.4.1
# Wed, 22 Jun 2022 00:50:10 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 00:50:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:7c443f4f6001ce9e2170dda837b280ae363d780322dc8b51a43cac05fae09a02`  
		...
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a8b87b35ceb19bb62a4fd7bc910202b279e33f6cd03c54c23aaa7c6919918cd`  
		Last Modified: Wed, 22 Jun 2022 02:09:09 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d04aa9094d51e80f12e78381f5079617504f812beaa39109a9cf286036d12d28`  
		Last Modified: Wed, 22 Jun 2022 02:10:59 GMT  
		Size: 21.8 MB (21750007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:c9300f6e46b5bcc6d98c30547baf9ab73713fbda0db4d4758d046e769bb993e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.1 MB (165095129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07d44b67398b3c4d34b14f15c39a9176c11b59c8d0898fbbd097c0250e772b05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Jun 2022 19:37:39 GMT
ENV DRUPAL_VERSION=9.4.1
# Thu, 23 Jun 2022 19:37:40 GMT
WORKDIR /opt/drupal
# Thu, 23 Jun 2022 19:37:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Jun 2022 19:37:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:94a193c29cd3929afa75ef094c65d9d9237847a37fcdc0bb0d3bad1933b78c10`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0c62d2f62ec47ec1289dcbc7e300f61ecc92a42e4cf471bf6c9df70c94b7ee5`  
		Last Modified: Thu, 23 Jun 2022 20:13:35 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bed540eb08415541e9bd4f33ee60fadd00880f12835af6b30e38749d80cce0a`  
		Last Modified: Thu, 23 Jun 2022 20:13:39 GMT  
		Size: 21.7 MB (21749186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
