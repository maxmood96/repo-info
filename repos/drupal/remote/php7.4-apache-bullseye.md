...
```console
$ docker pull drupal@sha256:afdb9dcd5883e2ac3f2f603f948ab1b74c07bc7e03054798d09ebb466f7fc7c0
```
...
```console
$ docker pull drupal@sha256:713ff0d291af75cceff11ed0480996710c2595877415a1d6d084b8fd01478bd6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165679763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:066f2a7bb930cd7693c2c4a937debd685ed63963fb7ffc301f9482d987061e9f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Tue, 21 Dec 2021 16:59:06 GMT
ENV DRUPAL_VERSION=9.2.10
# Tue, 21 Dec 2021 16:59:06 GMT
WORKDIR /opt/drupal
# Tue, 21 Dec 2021 16:59:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Dec 2021 16:59:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f039e8ded7488ed8cbe7b027acf47d31c2f5ef6fc94a6a580c3e0a04b3833d0b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c4220511ba05c5cb84e167757c6d528bc57d071bf58e55871e1b43c58a130ff`  
		Last Modified: Tue, 21 Dec 2021 17:14:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c12312e21469ca54f717ba4c992d461f7a8c664359846a6bac07845e4165735a`  
		Last Modified: Tue, 21 Dec 2021 17:14:48 GMT  
		Size: 19.2 MB (19191822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
