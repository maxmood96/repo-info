...
```console
$ docker pull drupal@sha256:fa918a65135b12abc1baa976672bd525273c6d84f8a1d72a80d96e79ea72d7b4
```
...
```console
$ docker pull drupal@sha256:a2cbe46e4aa565e03293629b212a7e4f388eab21411bf64be51148517abc7fe3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189825362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c9fe236345d9c3a8238e2308704f08f16ee9c40489d4788b55110898b019d50`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 15 Nov 2022 18:51:10 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:51:10 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 15 Nov 2022 18:51:11 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:51:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:51:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e5207024af17fc56209b791d72c20a9fc46597e05a8bca361640b605895a539e`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1d737a0dd43bef89ff138335fa3bb0fb9c028b84b92c700fb9728665583a457`  
		Last Modified: Wed, 16 Nov 2022 22:48:54 GMT  
		Size: 695.2 KB (695198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e865bd7ccb7cd6e3c6415b8fa091cc3b9694b139f35cbc739007894e983225f1`  
		Last Modified: Wed, 16 Nov 2022 22:48:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ea7c5cd8af017e55d1671cdf1510566c7f45e7bc5536f74887ef3e171fbdb3`  
		Last Modified: Wed, 16 Nov 2022 22:49:08 GMT  
		Size: 21.9 MB (21899078 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
