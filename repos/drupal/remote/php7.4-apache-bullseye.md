...
```console
$ docker pull drupal@sha256:e8c3b713f452206fdba9a78b3ddc54acc1ca7e7b48d16c1306cc8489be37cec7
```
...
```console
$ docker pull drupal@sha256:7131e615f9b157a01596546047bcdd64a232e751c8d6828f75d192813e270d6a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.2 MB (157215592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b90a7a709e85e9948ab8cbbb563b124a71aa96c201a9f76456dc882aeb1ebb9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Jun 2022 17:16:40 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 17:16:40 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:17:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:17:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3171bfd0761f1c2b55c28119fb2393c414795376fd39737783ede3bc84f26956`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73ec4685513028969e9822a71890ffc4bb53ac138057e1e05ed46ef98501472e`  
		Last Modified: Wed, 01 Jun 2022 18:13:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ddf62b595b6646f52c4d2f490f5e3012e251876a234b22240c57e12294fd11b`  
		Last Modified: Wed, 01 Jun 2022 18:13:32 GMT  
		Size: 21.2 MB (21167986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e00ae8b00312f5ba9de51f9ec45244d0db55595dcf9bcd64cefc00402d3305af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.0 MB (188034404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:250f1ad4a56d498126cd62400444d35302a8c08fa06ce4d913d8dab1adb5774a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:32:24 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:32:25 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:32:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:32:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:14caf0ae3f7a9357d3725fdd788feac11e8be3098ebbb2cbfb4b632167d625d8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1b9bc6d4fe16df7f5e904418342de6542ec53695cc18b4cd9db6db193aed2d3`  
		Last Modified: Wed, 01 Jun 2022 17:25:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bef420474d9513157f64fdc1a9fbfbde28eae2b3e50136808e10b05a520ca0f9`  
		Last Modified: Wed, 01 Jun 2022 17:27:07 GMT  
		Size: 21.2 MB (21168038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:99a3da212843795a17fd5f2671356e934a53234640ade05beaf6023f7894ef6b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.5 MB (164538282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cc6df04ca08df66dc32cc6aef6531e413ddfd6b97e4954f46586441518a14b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 05:07:55 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:00:03 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:00:03 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:00:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:00:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:27375c7341b3755bae62c2634deeba05002b82b00507eb54d07f53c63e145c15`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d93b3cf0248ad720cbc3462c2301f6b9e4499408a8345b6674dfd36b72f6995c`  
		Last Modified: Mon, 06 Jun 2022 18:29:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9f060dc042f6bb72b23695016fc51b05f82f9de5679ec68732107083df4e792`  
		Last Modified: Mon, 06 Jun 2022 18:29:16 GMT  
		Size: 21.2 MB (21200915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
