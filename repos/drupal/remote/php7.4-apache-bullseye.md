...
```console
$ docker pull drupal@sha256:251329f890486f51abbd49e380d7236b5e8e6a15f7456b1750b23ae1e1eb12cd
```
...
```console
$ docker pull drupal@sha256:705052155a808e57eb9ee928c5084978c4e4cd7a1c5cd096520fb30ba83f9f3d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188711245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe2e929ba909a3947a88e1f58102df391cd82694daf01120396306f2a9e113d8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 24 Mar 2022 07:14:13 GMT
ENV DRUPAL_VERSION=9.3.9
# Thu, 24 Mar 2022 07:14:14 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 07:14:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 07:14:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5a84c46fc2c0742c6e04c5892534e263a0c874fbdf9bcd8bcfecffffd748d770`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3661f55c0741a1ff287961695bdf0a28facc11ec90861ee62949ddbcdb3c03e9`  
		Last Modified: Thu, 24 Mar 2022 09:21:44 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2094ae6404154dc680989fe06862ac0bd7c3f12ff39a2162305ea758c7b896c1`  
		Last Modified: Thu, 24 Mar 2022 09:21:49 GMT  
		Size: 20.9 MB (20938422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
