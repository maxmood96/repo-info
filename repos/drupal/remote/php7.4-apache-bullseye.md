...
```console
$ docker pull drupal@sha256:d6346917b11e2fb93ba9fdd5f85fc2fe312f2e48c1a9f8c299efa558e93de2e4
```
...
```console
$ docker pull drupal@sha256:9b2c2911e68b7f0435a084384f3e7dd8961cc457430e3ad1fcceb401a47e7db5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188655354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:371ff385242bc019347bf6241c79ae22ff4361f7765869aa0de8bef7b5060060`
...
# Tue, 01 Mar 2022 05:53:33 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 05:53:33 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 05:53:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 05:53:43 GMT
...
-	Layers:
	...
	-	`sha256:2bb0bf21cd05adc05f41784121ae379a322038b86c68b8158bb19077de17fd8e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3bc762d5dbf68fdfc1015415a86d126d1512db07a69f3e6a1e86f28f2d0ead7`  
		Last Modified: Tue, 01 Mar 2022 06:15:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4836afe57b71023285a24a356e2393ed0d9799dd65699d3718f347bfa8cfe866`  
		Last Modified: Tue, 01 Mar 2022 06:15:53 GMT  
		Size: 19.1 MB (19109936 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1e352d29f275ac8f59ecfd21fe61c314c2e126d96651602d2471e1c8be75f41a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.4 MB (158350536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:350ffddff73548b46f9c6bf2f0af79bc640b9e58db3ef4e19fda78a2dfce6cd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 06:43:29 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 06:43:29 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 06:43:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 06:43:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26fe1428eb5d7fb50c78e84866088a476b69674e354e1abc2ddb4bdd37ffffcc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eda815f211a1d9f4230b35c6008c25236e74781ae32378336fc0c81490ad0b03`  
		Last Modified: Tue, 01 Mar 2022 09:14:50 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5030cc3827d800677a5097f35ff3d19f1c524dd12ed18fdb5576716db98fba6e`  
		Last Modified: Tue, 01 Mar 2022 09:15:17 GMT  
...
```console
$ docker pull drupal@sha256:59fe194b3a627c41e3e4639bcaa1584a89e536cb4ee99437336b94ea8bf512ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.5 MB (181504207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5377df8822102f1b14299ac4a0f9275ca6d0fef19b3bba20a26f3d492c1a34b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Wed, 02 Mar 2022 12:52:09 GMT
ENV DRUPAL_VERSION=9.2.13
# Wed, 02 Mar 2022 12:52:10 GMT
WORKDIR /opt/drupal
# Wed, 02 Mar 2022 12:52:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 02 Mar 2022 12:52:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e559b035e95d1085a00c47b7f1d23f2603706bc4b40c1f0755850e914957ce67`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c918694c451879220be412bddbc5b8bacdf4e1a078c149b57b966c81d9e5f45`  
		Last Modified: Wed, 02 Mar 2022 13:16:47 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5085f1084578d5375bc19823beeb32168f2ae701bfae7e2ff45ffa8328ae48ca`  
		Last Modified: Wed, 02 Mar 2022 13:16:53 GMT  
...
```console
$ docker pull drupal@sha256:b5324fca082ed53985cbc8fccf068319d228369f915427c936562e73197b283d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191521275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0721a9f68d1719a34f36cf575a8aeb6b17eb74d3d0719952d723057373ba2dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 06:20:57 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Wed, 02 Mar 2022 06:27:30 GMT
ENV DRUPAL_VERSION=9.2.13
# Wed, 02 Mar 2022 06:27:31 GMT
WORKDIR /opt/drupal
# Wed, 02 Mar 2022 06:27:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 02 Mar 2022 06:27:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:34baf8d6f228245ce90053fe0756757b79be2c321a757477b750e9307d25a82e`  
		...
		Size: 575.3 KB (575345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2397e0032b72eca8d1244df761e07e0d6f31b560e9ce2a46fc5edb8fcf7647e3`  
		Last Modified: Wed, 02 Mar 2022 07:01:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae2121a7b2f0827868e994171c8342d1a0a5621961f3bd520952cd7becb6d08e`  
		Last Modified: Wed, 02 Mar 2022 07:01:48 GMT  
		Size: 19.1 MB (19109985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:2c3be4c999c67db132ef774c127f0b79c1fb768b40fa7381f66a70a8fc701b6e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.0 MB (190046827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f704bd540391950178e4c3909460ca7e1cdcf60be380dcd711db63c4cbea87a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 05:23:30 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 05:23:32 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 05:23:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 05:24:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:30f69aba86e693e52ed7257b1d44832d6f13bf222cef9bdabb1cc2ae9fd0da7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74989fe1e111b4244241727a7ee90583a3adf2da44e604748ccaa91d4074df3a`  
		Last Modified: Tue, 01 Mar 2022 06:35:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d1574d480dc36f3b4507f46cdd77839a9fb215fb681650af771480ebbc40435`  
		Last Modified: Tue, 01 Mar 2022 06:37:47 GMT  
		Size: 19.1 MB (19109959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:bedf875c1da6b76f8cf329e0e30031a5d1fa92e05d1b24827913c7a4bf4b302c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165801864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6835a5cf1fc174f7609937499bb5fe9a426596d32986f738fede2c78ab8e54e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 22:15:55 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 22:21:50 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 22:21:50 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:21:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:22:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1ada950771668810a7ddab152968a41fc6146796cdf8dbbb3dd35d571ad1917b`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01e3458966796df8a118ffc3cde480d7fa558c05f11139434f32c25fd6ace361`  
		Last Modified: Tue, 01 Mar 2022 22:37:03 GMT  
		Size: 575.3 KB (575348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6f392bc3fe720785ec224a7694015bb07a7854f701a62a7bee4a28ce1ffb91f`  
		Last Modified: Tue, 01 Mar 2022 22:40:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24209717667d86320958a61bf8f5f550d215cf1080a1df49818d142ef50bbd16`  
		Last Modified: Tue, 01 Mar 2022 22:40:51 GMT  
		Size: 19.1 MB (19110024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
