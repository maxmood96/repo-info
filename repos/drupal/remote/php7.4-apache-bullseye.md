...
```console
$ docker pull drupal@sha256:5200a1be856a3bb4b1724e42e873a27b900d3e2acae067827f60a3ac2849934c
```
...
```console
$ docker pull drupal@sha256:0c3c840bfd99677f2c0b990a03160ad4cd57dfa467615b696830653abd1762b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165394379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e821c8058a8b05aed4f362f929a9168af8e0b5be7e6e2b73532f963d5c1bf3a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 16:09:23 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 19:49:49 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 29 Sep 2022 19:49:49 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 19:50:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 19:50:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ea26d3fd1e75706bab2f71c0dacebdd621758f53b1c7cdc23292fccd97c288dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7456178adc78e135268a9cfccfa5e6a12d55b0c96152e4a6768e6a8c00c51513`  
		Last Modified: Thu, 29 Sep 2022 20:11:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60c653551a61318c633b79fb23a2b33c2b0492432032b873314f24a1a3c67ad`  
		Last Modified: Thu, 29 Sep 2022 20:12:03 GMT  
		Size: 21.9 MB (21880855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
