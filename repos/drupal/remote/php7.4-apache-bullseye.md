...
```console
$ docker pull drupal@sha256:2c12c1e1283552ee75143748aa119d5e3d297436280e682977a38df1f4ddc8b3
```
...
```console
$ docker pull drupal@sha256:eca920cca9c039e8690179c22eb532f8f406d9e01a0b48d51bad4723e1413f74
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186647234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60146a6d818e98b2abec872034bcd23f8154b9531aae2fcc4be8730b38e1351e`
...
-	Layers:
	...
	-	`sha256:784fc415cf40b4d69c431dec1a4f9b7b7405404fcaa4ab92aa95bdcb743ac017`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96b605f8e712c02f0872c5e1551907058c89cceae6d51eb0d76d7428fef89c5e`  
		Last Modified: Thu, 31 Mar 2022 06:02:36 GMT  
		Size: 576.1 KB (576053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94afabd030522667a4e2f00472c75111e38cd818b4c196a6797c9b7df5c5d234`  
		Last Modified: Thu, 31 Mar 2022 06:02:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60c8d0b88c0152cd5477563b602b12389fe7a3cefa6761c8d3b29f73ef7b2558`  
		Last Modified: Thu, 31 Mar 2022 06:02:40 GMT  
		Size: 20.9 MB (20937819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:024cb3ec9288a2896864ca136b00f906ace9c2b465776ae0b7d6fc749b0edea3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.5 MB (179488470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f9a2e2345a0f8112caec437ab5cb829091743a158cd69f3b50e842bd422af14`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:25:42 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:25:42 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 15:25:43 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:25:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b3dc35a66d2cd3d46a0d50db012d53cf9654f482ff0487fe001ca5abfba65ac3`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee5422b853f3e33392da5bf779df80d0597812970cfbd73a92f9fb2383030974`  
		Last Modified: Wed, 30 Mar 2022 15:54:45 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48bd198844cd31d50ad57d2c0b42a6625327fc0061a4e27a9c8a99af558be34d`  
		Last Modified: Wed, 30 Mar 2022 15:54:44 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0da3d58913608ed59631dd5d26e797821c531af82fa0c7dfe4a6aa15294b11e1`  
		Last Modified: Wed, 30 Mar 2022 15:54:50 GMT  
		Size: 20.9 MB (20938430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:a3f880ae108615df5e04abe313684569be80a575d079030c7687af05aaf9e609
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188721165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14fc17e67962126f2ca58ba143dc98aa8bdb048190ca350def8965338189638`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:25:47 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:25:47 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 18:25:48 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:26:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:26:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bcde69de946a64ea35814d6ff5e358f70b5260299fd276a1a18b020c1496e570`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9776f3eec4fa8a79cf52dfd341d2aea0017d129737b7eedd033b8b9229195d7`  
		Last Modified: Wed, 30 Mar 2022 18:49:40 GMT  
		Size: 576.1 KB (576059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32ddce9f896e6c55541919af9cb7ce2efa17374ec068e52f6c4a15038108918b`  
		Last Modified: Wed, 30 Mar 2022 18:49:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f83b4d057a8187741fdedee032e44e73afb38611ea77b1a967bab47f0eab371`  
		Last Modified: Wed, 30 Mar 2022 18:49:45 GMT  
		Size: 20.9 MB (20938336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:16f7095998a66d25c4212f3a7357ad10629f76c779667135822dadf2991f5e39
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187709895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:086fc725eeca1f8a5551d5bdd2238c48c9fd6c5df7955e169d27d2819d00cb32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:38:22 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:38:33 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 18:38:43 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:39:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:8730c837026d00e31c500350c351be8ce3915c0f24080af13fc707218a4d73b5`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd080f32b64b8f417fbdc958277385b7010f4e5bc3989865c0e59fdc27f1f7b`  
		Last Modified: Wed, 30 Mar 2022 20:12:23 GMT  
		Size: 575.7 KB (575716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7582b6529f4abd1aca160f1df72c9f2014f80a51bda4b499e166f585f852682f`  
		Last Modified: Wed, 30 Mar 2022 20:12:21 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a54b0d52976a9f557fcb6753c508aa430aafa9a37a7edf7f69af122b23e806bb`  
		Last Modified: Wed, 30 Mar 2022 20:14:55 GMT  
...
```console
$ docker pull drupal@sha256:d0e91ae9ba99d7d74c8cf6c96c6470f15abdcaf7af07486cd74fc07e2debf40c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164184672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3674b07eb8ead84f3c3fde43d89e51b0cd3a4a9daedc6c7551f368e49f9d417f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 21:23:12 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 21:23:12 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 21:23:12 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 21:23:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 21:23:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ef1f3180aed03ca8c343b08dabdac4dae943955f31f244cfbd23d4d3f8acef9`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f375cb6be40c3060f614829fa94c8a0b0fbcd7a139f0c3dcee1d83af6218844c`  
		Last Modified: Wed, 30 Mar 2022 22:11:53 GMT  
		Size: 576.1 KB (576052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c07abd48dc89157961f95383b429c4b9ba081778ea3dd1d1b7039233cdd242c5`  
		Last Modified: Wed, 30 Mar 2022 22:11:53 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40ea822b708f244456350720d9ee69ba4036114cada4633443c6a4099e6e3f54`  
		Last Modified: Wed, 30 Mar 2022 22:11:57 GMT  
		Size: 20.9 MB (20937679 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
