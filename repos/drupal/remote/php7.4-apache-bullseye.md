...
```console
$ docker pull drupal@sha256:9003c6fad3bcde6a20d085f3df5cb3f09f7bcfa311c577094c42b386fed0af90
```
...
```console
$ docker pull drupal@sha256:c91b26d945fef7a01697abf0fed878959f40aaa3e4948ecedfbe79ab469e88d8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186629835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e6fb5e853a8f5e85d470ac71ec9b11eceea3dbe782eeb84ad3f709dac541094`
...
# Wed, 16 Mar 2022 19:38:37 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 19:38:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 19:38:47 GMT
...
-	Layers:
	...
	-	`sha256:eedb64e7213bdd5f8bf38a1c3fc55d0c67893f385b3d4048db9950e81c7c6ff8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5483e1b5666916e057f61023b1abc8f88357cf7fe8117b8273a33f913dce187d`  
		Last Modified: Wed, 16 Mar 2022 19:54:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc9b9ae12f21b6bd43cb8855c7224543a5cc1ac055ac987107746ddd80bc569`  
		Last Modified: Wed, 16 Mar 2022 19:55:04 GMT  
		Size: 20.9 MB (20933487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:0a7126f043d1e09ca72852cc7ae9f97ca38ad281ab943f0a14c7ebe208a0e27c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156877120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30a4e4d2ccc2dfa692f944cb3f820afd3828f4a2ef74e9945499b0e52f79d5f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Mar 2022 19:06:09 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 19:06:10 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 19:06:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 19:06:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:123ba1a40ee6bce038b8794b6bd9f25aaa31d69d55b86fac4206d19d1b6a22e9`  
		...
		Size: 575.7 KB (575718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e7de8bae33026a28c997fe34754967fa1da5a2b4a34e87e0ff1c67d5bc5288e`  
		Last Modified: Wed, 16 Mar 2022 19:53:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1a314b72a9fb0153050374971bd81e3018dc1845a42a16f4b1bd43435e3081a`  
		Last Modified: Wed, 16 Mar 2022 19:53:37 GMT  
		Size: 20.9 MB (20933846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:8de18624d32e9372dfa614f562d71da6d2b1157dcf2b35782f9620e1c806def9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.7 MB (179681031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf994013bfb1306e8a930037b3af3eb9e194136fd46bd86afc2cfa9116c0a891`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:23:14 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:23:14 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:23:15 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:23:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:23:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d390d06ce6168f5392b5c7327b9a769d25822f97ea2781bf64299b99763f47aa`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf682149e3187362dc0585ec1dcee9d41ae56491a4cbd634e7dcd9f2c6f2e259`  
		Last Modified: Wed, 16 Mar 2022 18:48:00 GMT  
		Size: 575.7 KB (575719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dfd5a79d8cbd6100e7f3b8c2aee80dd7c21e6de9a2115fb3b37628a2a893fb9`  
		Last Modified: Wed, 16 Mar 2022 18:47:59 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e18cacc3f38fa1fcb201eef11f4314fefdc334956590527ede9f5a42398d314f`  
		Last Modified: Wed, 16 Mar 2022 18:48:05 GMT  
		Size: 20.9 MB (20935244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:76b411559e66946e213f3a8427987fe79816391fdc5c9a0af78d55fd69690474
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189553648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebc9a1deed3f3404ee19dbc54f03cc21a9e6492b56a664217821ee3eb5a3d57b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:52:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:28:44 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:28:44 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:28:45 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:29:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:29:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b7880f63ca27c8198aeb401d120d32aa4aec8c2f4c626aea19417962f69c3eb`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44e0ed564f33705618343032a6a191858a144894af8a157f006c9a9c872bd3ba`  
		Last Modified: Wed, 16 Mar 2022 19:02:28 GMT  
		Size: 575.7 KB (575710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0b2d75da9dcfa3894d1d7331e8f31c25d43e8aeff123d60f44a18a7a51ea443`  
		Last Modified: Wed, 16 Mar 2022 19:02:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62779b24e73e282a0b0720962e5104c95719c292f943b5426d9aa2ec53746c6b`  
		Last Modified: Wed, 16 Mar 2022 19:02:42 GMT  
		Size: 20.9 MB (20933724 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:789fedd5d3d9209f523ce1550d76a9deb4c4895d4bae4172cb54595c6592c53d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187694335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:131fc33fc51dca4eb7b23852282d4caeaedb755e285c5df2865c52e58b90c08b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 20:38:41 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 20:38:49 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 20:39:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 20:39:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f6f5fbaaad8d96510ea906422dc6375eb541e70c71a01c9c98f8a1435a033a3c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca84a353707c306b9624ccababf17badfa4835d4f8947286881ef9e1b199ba8d`  
		Last Modified: Wed, 16 Mar 2022 23:53:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a887a6c30cd9e0e228129db49598dc795b11ee3433d0e2c18209e7b4f53a5392`  
		Last Modified: Wed, 16 Mar 2022 23:56:30 GMT  
		Size: 20.9 MB (20934049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:e2528a2ac6f1f998d1ede8d2f232840034fde8783f8f9a5104cb153504bcf95f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164169005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a77305f47ed81ef49472deeb437b55022f57843a162b2d4851cd6ac212a76e4f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 06:37:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:12:10 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:12:11 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:12:11 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:12:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:12:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1674a8a6645792b4c842c6297d2a485d2c222e115c3ce8937a4372e9e403375`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:207a9ec4c484d6b4694cbd819e03d5e4f8d803222ee85af4af6ed7007894b629`  
		Last Modified: Wed, 16 Mar 2022 18:34:34 GMT  
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1b6f26581ef4825fe69aec4c562c702bab19b1061e10950ef274fb7dd7e6643`  
		Last Modified: Wed, 16 Mar 2022 18:34:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cdcd1c32335ffdc7f22f734a5210edc245bcc68dc441d6edf3233408d34fb41`  
		Last Modified: Wed, 16 Mar 2022 18:34:37 GMT  
		Size: 20.9 MB (20934002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
