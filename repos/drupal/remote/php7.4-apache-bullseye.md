...
```console
$ docker pull drupal@sha256:339d71ded90370b16f874ddbe7e37920063b65ad91f496c9eff7bb092b2183c6
```
...
```console
$ docker pull drupal@sha256:183c96227484347a146713ac2502fd9d7675502fa92dedbfb4db26dd28b3a60b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188356180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e987d86669a3b673e9a97e05a51592dc75e9834383b3487ffe50b56a20ca6c54`
...
-	Layers:
	...
	-	`sha256:94b5ef7eeeff3a3e797984443e2d27925e8f9497cec3e427d1bfdd8a75936b9e`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df52e294db51f4a41d68e530922d9f9d436a1d0d46865256166c57338c89a2c`  
		Last Modified: Mon, 03 Jan 2022 19:53:19 GMT  
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bc1c20d6299d4a678bc3ea8f0537674944b9f572fcdc8a55a03920382588b19`  
		Last Modified: Mon, 03 Jan 2022 20:00:44 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fd16909ecbd27534ff60191b25a26e61ddeb233556eee9b5a3b6c234119774e`  
		Last Modified: Mon, 03 Jan 2022 20:00:49 GMT  
		Size: 19.2 MB (19192868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:37fb916b409837d0e27cbd06e2980f150b9f6b3f291c9c54075567254486369a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158141860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a17ebda96fba379655daa283daf19946b73314349def6418f08b038ab430a887`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 20:56:39 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:08:03 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:08:03 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:08:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:08:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:521772f3ea72ded66b0fb5032a96239fafd3ae273c171b3fbeb7865f1dce655a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63f1c7c0aefd1dd736a296a4a7371ef0df3616390b73e51315a6e66a28ddd55`  
		Last Modified: Mon, 03 Jan 2022 21:35:23 GMT  
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85976599851dd83e96ed8720abb449635e673e97897fd8f1a820d74cc11f057d`  
		Last Modified: Mon, 03 Jan 2022 21:49:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f8a01501bb1d284b4e3ebd2ae31920e84cf3049b43db3e538a8a12cc389592a`  
		Last Modified: Mon, 03 Jan 2022 21:49:42 GMT  
		Size: 19.2 MB (19193283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6104a31f42c9e8c59cd2ac02abac932f3f98c244b1f03700859c0e062f9d8bfc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.4 MB (181354860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10c6092731a44ee3c88abbe41f04903c365e6522d2984b798b32acc1e384be54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:38:48 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:46:03 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:46:04 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:46:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:46:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f77513a6099f38795c3317dcc355a7e48bcf0ffb8142ced41f90ddcbbcc5770d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0efcfceac5bb677e825c9bc085f93ac363296a3fec874cb05767924f2a9f2e6a`  
		Last Modified: Mon, 03 Jan 2022 21:59:38 GMT  
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ec067cb1253f64c892289738cea24c2c87ef6364eff6846519391ff6aeebbc4`  
		Last Modified: Mon, 03 Jan 2022 22:07:40 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13487c012dce7e81933e6dc5f3e44e76c573010b8dffe405f39fb047cbff7e92`  
		Last Modified: Mon, 03 Jan 2022 22:07:46 GMT  
		Size: 19.2 MB (19194686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:6c9848a64a56a8964734fad4c6f491cdfb4fa246fb90d1eb9fa5b7dcbbcff960
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.4 MB (191359886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20104bfe45396a56279519b98bf22fe4d6f6c9401f7bc0ae344058dbb68f8244`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 19:57:56 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:03:01 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 20:03:01 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:03:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:03:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f1089212a58d1d614eb96cdef6c6de23288638d864ae37f07128adece3a779b0`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9a3b22a0f1fd6e2d77af2d28f6c31cbe5b06e09720673edb638f079554c962e`  
		Last Modified: Mon, 03 Jan 2022 20:18:08 GMT  
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0d454487baa71dfc8dffecae7dc1229dd6df9449b7d6c0c287cae63e3490821`  
		Last Modified: Mon, 03 Jan 2022 20:27:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39add4907ecd4c182635031470fe1519c644f68d6014909f1349a2b4d0a252cc`  
		Last Modified: Mon, 03 Jan 2022 20:27:26 GMT  
		Size: 19.2 MB (19193232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:d17a36c5b7eca330a0120624c9f2b9ac62d0dc3b48bb1a97239cde7496d62796
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189732100 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffc8659543dce972181fc21fdb79bfa336899f9779bfc66d69ce9b11f1391246`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:26:22 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:36:05 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:36:06 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:36:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:36:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f23083cce011286b45434474bf9d15cac65b24ea15ebc6e69c2991d5207e4d53`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b27b115ecb16a529e87d1adf7fe79535648ad747b4dbeb1ed0e20361b86fb91`  
		Last Modified: Mon, 03 Jan 2022 21:57:10 GMT  
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ebbb2c3ddff53677fb9d5236fa681d847c321e4808f9e4b8fb386e5494808b2`  
		Last Modified: Mon, 03 Jan 2022 22:14:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bf6603f4a4cc0325da102e4d33661de6fa900d3d7a34ced0a5f58617fd3c6e6`  
		Last Modified: Mon, 03 Jan 2022 22:15:26 GMT  
		Size: 19.2 MB (19193118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:24dc5159be862a365927cba491731d06da46e747d8a27e2f8e717228f97d6ea7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165690130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afcd51f44a5f26b8920d439aea310fdc6e9f87dfd50e340cd1ad06f92a39c493`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Dec 2021 16:53:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:52:27 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:57:39 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:57:39 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:57:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:57:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b7130d3448f59794098da7893773191ed538176ac5717c99ca548246ade98eff`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef764983b12c1feb55b8ec0f26992bcadadce21444aabc70ca3c1579e444f044`  
		Last Modified: Mon, 03 Jan 2022 22:09:25 GMT  
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccaeb86f2a7f4841dc7defd359cda1f702ba114359795ca8d0f42a5ca0b9ee85`  
		Last Modified: Mon, 03 Jan 2022 22:14:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:872c09924b713871293528db30f32e93e24993646aca0d36a34d017c8a7f152d`  
		Last Modified: Mon, 03 Jan 2022 22:14:30 GMT  
		Size: 19.2 MB (19193214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
