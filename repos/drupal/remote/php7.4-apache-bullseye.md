...
```console
$ docker pull drupal@sha256:587a4c889a072b2cd82d8418ad8f885753d6cffaf07b852d1544824ab198d729
```
...
```console
$ docker pull drupal@sha256:09973c53388f0f56cb13c146e9bb84af4a9e8f0273b73fabe2ec9835c29dd316
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157804046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebb83d05f29e123f111f94e8719d1ffcaf5316edbb11fe947ca5123fa13ed2cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:17:22 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:17:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:17:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1198c3dd380075026e2b50e0b2eb744897976ec9563e839a70ad178f90dbebe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c861c2592e557787ac1363aff624c537f8ff18c31d7f76ab30b975e9915c8ecf`  
		Last Modified: Thu, 04 Aug 2022 10:05:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83d6d3622c9e6b07c5544ca85f0870f1c6a643e13b5eb1c0e9504087cff50dcb`  
		Last Modified: Thu, 04 Aug 2022 10:05:54 GMT  
...
```console
$ docker pull drupal@sha256:4814f40aa7c37551eff9fcd4a608fbcdbdfd709c56872ab76cba15cd20531990
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188633694 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77b06b1fbd90715ab1fcbc5afbe4420759a1aa7ddde91749d2cbfccdb66a1167`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 03 Aug 2022 12:22:34 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:22:35 GMT
ENV DRUPAL_VERSION=9.4.4
# Wed, 03 Aug 2022 12:22:35 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:22:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:23:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:668f2d31ab9286e2f704eb50a3518b38981e3576e2a187bf5078b6b8cb85940a`  
		...
		Size: 670.4 KB (670415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:621387c368eb9dbcf1f0cbdf1104a9a1888bb70806ea5a14d073ac4e4761ad1c`  
		Last Modified: Wed, 03 Aug 2022 13:17:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a42c48f60620e4d53f2885150e7be9d1cd688fea2375fc9278475bb3e7bd3ee2`  
		Last Modified: Wed, 03 Aug 2022 13:18:20 GMT  
		Size: 21.8 MB (21758151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
