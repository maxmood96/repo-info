...
```console
$ docker pull drupal@sha256:d3d5b80c630cf9f4bfcd61c16da0c4cbd4388d1d1acf3ccc82bdb9fd3ec020cb
```
...
```console
$ docker pull drupal@sha256:864a11bb1e09e8c5478a9f61467afa666151c356a4dcd83d76b5b0c780ab60b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.8 MB (187777818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96218247e6da7e975f8ba73d07c9da6bb0bd44c8a612b3d7fb027bf0f9061145`
...
# Fri, 07 Oct 2022 06:59:13 GMT
WORKDIR /opt/drupal
# Fri, 07 Oct 2022 06:59:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 Oct 2022 06:59:25 GMT
...
-	Layers:
	...
	-	`sha256:ae9b250f2d1f2317f6763875652c3d8f1543e225797ec0eb6511a88bf86bb0ec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38b0cd1ce8505a3629ad353ee53982e0418f90624669e22e1b1ec060dc598e92`  
		Last Modified: Fri, 07 Oct 2022 07:25:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c263fe485305e45991b26b9dbacaa00c3868b0b420d860468f7863cd6e78f7d`  
		Last Modified: Fri, 07 Oct 2022 07:25:09 GMT  
		Size: 21.9 MB (21880793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:cd628e04d090edad5be06e5cce8d4df771da384e327630a1b028f1cd5d317f27
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157968064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3df2da04a28433451024989f43f6e9cec67299a9c9368c856450999deede6b63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Oct 2022 18:28:19 GMT
WORKDIR /opt/drupal
# Thu, 06 Oct 2022 18:28:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Oct 2022 18:28:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0f59f681bfcd9ccd1cd8f3e313fc2ad7a03c11d867fcfab78f3d40bd1e964dcd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2c87f836004ac580a5bff3bf50f19f10211678bf51da1819911cbb23317f364`  
		Last Modified: Thu, 06 Oct 2022 19:06:36 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cedb1b7f8a1a0da42cfc1a1ac56a1dd8548ad93759fd344fb4e72e1e92f7747`  
		Last Modified: Thu, 06 Oct 2022 19:06:48 GMT  
		Size: 21.9 MB (21880614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e5b2d239c03c2aea4645e37104099308de55404b24ecafda709e3b24754023bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.6 MB (180565097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b4481aaa1742fd6c8e66a680cf16d14e54d5d6ed7330dc0c7385a3ed0a1ca46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 05 Oct 2022 22:58:33 GMT
ENV DRUPAL_VERSION=9.4.7
# Wed, 05 Oct 2022 22:58:34 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 22:58:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 22:58:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:09d7757a185b079b44d99e4a68e7e26774ce23e4d045ebe950ead3be4f5f9b47`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d0801d3e1354f030f6e6490e1dac2d57b0eb9ce40dbfd0d93d3dbcbedc8823`  
		Last Modified: Wed, 05 Oct 2022 23:32:51 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70d462cc5f11d7f540ba5dc78cd194edd363ec6303728f77991cb81a9db481a9`  
		Last Modified: Wed, 05 Oct 2022 23:32:56 GMT  
		Size: 21.9 MB (21882548 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:b30e7368c549d1bf2a6aa47ea2fc308808ad1d764b975dff52926e5ed383dcb7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189805542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55577dda141f39cb14a515e03f281d7ad65e3dbdd2474e34bd6e243a4dedf866`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Oct 2022 03:02:13 GMT
ENV DRUPAL_VERSION=9.4.7
# Fri, 07 Oct 2022 03:02:14 GMT
WORKDIR /opt/drupal
# Fri, 07 Oct 2022 03:02:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 Oct 2022 03:02:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:14eacef7dffcc9c684e1a150cfeaa3dea21fd977b7fdb04a1ff941c3bdb971ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00d8bea72e4a802d5df50721ba4c1c2f55d5862aec92550b566f570f440b0146`  
		Last Modified: Fri, 07 Oct 2022 03:39:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cc1f0b5b30061d1f283d20f8297ed064ddb818f3c355043cd0c702a80a72f1c`  
		Last Modified: Fri, 07 Oct 2022 03:39:42 GMT  
		Size: 21.9 MB (21882350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:4f9d83de806a88bfecb5fe84291436e8eec1ccc1010fce7a33919f694f888b98
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188793922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd8076b8b3203d1dbe8e9d27ef0c3d82f57d98997863ef7f413b5a6eee301f4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 05 Oct 2022 16:47:53 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 05 Oct 2022 16:47:54 GMT
ENV DRUPAL_VERSION=9.4.7
# Wed, 05 Oct 2022 16:47:54 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 16:48:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 16:48:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4748ed1e750b81506ace4f3a522302777e8b1547ad0acc4791a16cdb2e9c3ac8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba3bbdaf4fc224420fcde998f451c0335e06d20b5f34d0cfe68468e0b6d3b358`  
		Last Modified: Wed, 05 Oct 2022 17:14:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eae6298720d908922221c97f52caad18b2124cd0f3db8ee0d8c1ccc7daee93a`  
		Last Modified: Wed, 05 Oct 2022 17:14:16 GMT  
		Size: 21.9 MB (21880534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
