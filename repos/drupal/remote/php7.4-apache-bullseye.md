...
```console
$ docker pull drupal@sha256:51af60760803a1639a47ff166663b20e13dd03673cb7d9daf8be082ae705a432
```
...
```console
$ docker pull drupal@sha256:86dbab4bf91a75875cf78c6548b04935bb1daed3470b40caa9663e17185f78b8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188355912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fb7d500f7941fe923bd4c674328ef90288046fb0414c0de02860fdfe746fda6`
...
# Wed, 29 Dec 2021 19:51:44 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 19:51:44 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:51:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:51:55 GMT
...
-	Layers:
	...
	-	`sha256:94b5ef7eeeff3a3e797984443e2d27925e8f9497cec3e427d1bfdd8a75936b9e`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62a8f8b995d22d81c382980c8ace9aeaa0d8bca22716375544b5c5a0c4c6f67c`  
		Last Modified: Wed, 29 Dec 2021 19:59:35 GMT  
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c07a9cf88718dcbaf227621d1ea1a2bbed9bd5921b0d417c2c089d858f2ed0f`  
		Last Modified: Wed, 29 Dec 2021 20:06:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b889494ca8ad859eee1b998cc6a9e477241e63f8ba3e08db60ab5d120222b7ad`  
		Last Modified: Wed, 29 Dec 2021 20:06:51 GMT  
		Size: 19.2 MB (19192751 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d94f945c34d09aa091a3093a9f616342a12ad07084a02d2a921a3b830358d13d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158141507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02e73857d3b0e18683c587c4322ba85e624714c20280501dbb9b8c9101f9feff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 20:03:16 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:13:59 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 20:13:59 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:14:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:14:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:521772f3ea72ded66b0fb5032a96239fafd3ae273c171b3fbeb7865f1dce655a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f32bd00a5919b2908c78d04af3e97931f03386fdddc5c769b965ab65aa0392f`  
		Last Modified: Wed, 29 Dec 2021 20:41:02 GMT  
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1460e102adafa0fa2dd56dff862f7fe3be86cef2d6570f3bcbe88df83c2eb1f4`  
		Last Modified: Wed, 29 Dec 2021 20:54:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f89e30740a825e13a4c2eeb4f8338ba785999b9dfb7766ab20557c41acf60fcd`  
		Last Modified: Wed, 29 Dec 2021 20:55:14 GMT  
...
```console
$ docker pull drupal@sha256:59b2c91e6b9531ac9027648153e4518015d0be601f5954e5f77de809ee79253e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.4 MB (181354062 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4fba91f57c052ca081bdf3cd1b17dfffe809b0d08bff92b7e3c1949e2a412f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:00:12 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:06:59 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 19:07:00 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:07:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:07:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f77513a6099f38795c3317dcc355a7e48bcf0ffb8142ced41f90ddcbbcc5770d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0684014d0ced878125799d85a40bb18ec340ac43ff3432d76b3d9ab20938024`  
		Last Modified: Wed, 29 Dec 2021 19:20:24 GMT  
		Size: 573.5 KB (573476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:439df386a8628fdca6437c8f07ff3c6719a99e5b0276c1dd15bbf5fb0e944807`  
		Last Modified: Wed, 29 Dec 2021 19:28:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0069ea033badd5b9a397f9b879bc70e8551d78a669783691ee8c0ae30d616d3b`  
		Last Modified: Wed, 29 Dec 2021 19:28:36 GMT  
		Size: 19.2 MB (19194036 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:0df49e4e567e3e9dd0a12d522299ec75fff6617fadfd6cd7e245784ce4d5c76b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.4 MB (191359128 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59000a7fa3d522956b32a0c950b3748514701a8aea8e8ce83d84fe62edf9d54f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:04:26 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:09:18 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 19:09:19 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:09:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:09:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f1089212a58d1d614eb96cdef6c6de23288638d864ae37f07128adece3a779b0`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:308e0f89ded06b2ec5cb5236b8686161b7468a2111cf98d0a141ad81a6dc5c52`  
		Last Modified: Wed, 29 Dec 2021 19:24:16 GMT  
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9de673f9f47c885b16ff4d7b5b05f393d0d27a72b24332e52809cc928db39ed5`  
		Last Modified: Wed, 29 Dec 2021 19:34:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddb4e3fd66079511f6d56ff65c7e8f67568b98b99f4ccb6bceb3525ffb2d7090`  
		Last Modified: Wed, 29 Dec 2021 19:34:24 GMT  
		Size: 19.2 MB (19192627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:d6c14598ba34aa2a90878b7c9b9d811b347ae066c2083cacedfa69fc117df003
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189731897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fedabef449fb713932f5934751f986492b24265619b047539226664c4e8df730`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:59:21 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:08:58 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 20:08:59 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:09:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:09:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f23083cce011286b45434474bf9d15cac65b24ea15ebc6e69c2991d5207e4d53`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:799c8ea613b6a6cb39bef54fc5c3558fa5c131aa13a6c6a78aae965f748cb0d3`  
		Last Modified: Wed, 29 Dec 2021 20:27:01 GMT  
		Size: 573.5 KB (573477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b29a4346ca77d8709c28cbade77c6139355e5173e6cf08d87af4782b4b344f9e`  
		Last Modified: Wed, 29 Dec 2021 20:41:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41e226b6ac210ed595d7065456f265293571847a58031f0af7eaa41d1bf8b553`  
		Last Modified: Wed, 29 Dec 2021 20:42:23 GMT  
...
```console
$ docker pull drupal@sha256:5f0c69597b4d53231a97e25194e50e417939e0fda9246b99e06becafbb32aa54
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165689661 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90e46871476778e0e805958b805601fd53eca86a7759a52f3ebcc2f3c73b7b27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Dec 2021 16:53:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:01:12 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:07:16 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 19:07:16 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:07:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b7130d3448f59794098da7893773191ed538176ac5717c99ca548246ade98eff`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25bc57cc4c04cad28e85ea4183dae416aca01941f25b384bdaf8d7b994ec8346`  
		Last Modified: Wed, 29 Dec 2021 19:19:19 GMT  
		Size: 573.5 KB (573472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:722b5225896a998bef657b6fed0244347dc4a59f8f1ac9b4639160d47688628d`  
		Last Modified: Wed, 29 Dec 2021 19:24:21 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5428e74578e1d4f1dcba302357ed2af415255e4dfd054bd76ccbd3a7186e554`  
		Last Modified: Wed, 29 Dec 2021 19:24:25 GMT  
		Size: 19.2 MB (19192901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
