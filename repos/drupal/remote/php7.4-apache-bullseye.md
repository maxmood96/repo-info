...
```console
$ docker pull drupal@sha256:43712e6d9d3c02842ecf32bdbc1dc02944e7b410a6d777420ead2740f2e1593a
```
...
```console
$ docker pull drupal@sha256:0ee5eb799a6e507f68b39e2099ffc2df1acbfcbd263cc37c268c82a386cb6de6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187006330 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fb2963c4d320bb71610f50c5bd7f75103ccd820da92cb5e1c01675281efc3f8`
...
-	Layers:
	...
	-	`sha256:cb2ac8f3dc7ed50afe112a3abcb24b7cb1a3518f84ed1b88edf2837e85d5174b`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f7ee0db61087850cd0b99604069a12925676b04139596b43d99c078b4676397`  
		Last Modified: Mon, 06 Jun 2022 18:52:54 GMT  
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdc9151e6ad37b3f71bf0d40e6d9f1eef88a0fb08b813dae01ba18085cfbc304`  
		Last Modified: Mon, 06 Jun 2022 18:52:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0cf36aa70a03d6adc355c1fc11c6212f14f8e703cf1b4f856525632d9a61bec`  
		Last Modified: Mon, 06 Jun 2022 18:52:59 GMT  
		Size: 21.2 MB (21200651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c0700fe4b6d780da4b21517250f6c1af95ea447f6d5cfb9ce74523da3215830a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157256684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1d0405d375a124c081367aea88615ecd8084900da906b666cb315a9b081778a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:29:12 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:29:12 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:29:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:c331bdf79c1b6911c40e6f66c14e5df6f8a595ac1990269f5224f66e7bf3bce9`  
		...
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:754553fd228f32dd69fa36f95bcae05a7ec83c2b95acdda005e41ac7d53a0d09`  
		Last Modified: Mon, 06 Jun 2022 19:26:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d6684587fc0089910320845694b2ba8b0d981f75e96650eb5b626d9a654941f`  
		Last Modified: Mon, 06 Jun 2022 19:27:18 GMT  
		Size: 21.2 MB (21200820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a7b0c5cedb17655b8b4973ec9ce1e7cce1e31630f780759d606b546c3d042052
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179850336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3883f7bb01186c83c27bdafa3b5c15dfa53177cf36916674f68d8ade8e131ac5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Jun 2022 17:57:26 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:57:27 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:57:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:57:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f482286b59ef24df157906d4d8930b7f090157a11522386a4d178be84f70a6e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5e9e51cb7db4d41162586fc19dce2bbc39f21b20b23acaa6127ab6a31eb3356`  
		Last Modified: Mon, 06 Jun 2022 18:27:04 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83aa60eedb77e4713df443581d4be991b3dd4d5c38209c1625f4b5dd3005e260`  
		Last Modified: Mon, 06 Jun 2022 18:27:09 GMT  
		Size: 21.2 MB (21201118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:b5f0a1180ec2d9556d9c844d357b3f7e5872d8b5fccd69258017b3bd744f0b29
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189081700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d440e66e7bbf1fbf2d678c7934bba067dfe282b465334b6d46fddcc2b59c02ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 06 Jun 2022 17:52:01 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:52:01 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:52:02 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:52:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:52:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf54f0cf936873832b6b336db51b759cec6c3732948f9b699dc6f2f58126fe46`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c3b8f24686350eb81046cd55278e9a188c4fba09c40f1c05ea8e46bc6e10fd6`  
		Last Modified: Mon, 06 Jun 2022 18:20:50 GMT  
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1bbb43287906c4ce0ac9ea8bff9915eb63129757b8fd79667e56fa08a130f67`  
		Last Modified: Mon, 06 Jun 2022 18:20:50 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:280c453d66a650d30b99b0b60708cdf63bae2067f7c17da2ece4e3b604e1b681`  
		Last Modified: Mon, 06 Jun 2022 18:20:55 GMT  
		Size: 21.2 MB (21201201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:b22142e8d766048a1721d771a043087e1eb9f723eea7d5b8fb1e2652232df616
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188075836 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db27d85228bf902782e7b4491e83806265978fff6f97a5b40ce53056f53116e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:58:51 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:58:57 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:59:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:59:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95cd78e49858b207b0ba56399d6c64d36842e3c58a4e340549c06e21a0d28265`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d596894b7c15419959ea6fab707d0dadfc1ccec4f37d0dee694b645e8a922df`  
		Last Modified: Mon, 06 Jun 2022 20:04:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8842386f2b6f8005c798ba2cca8bc8a4e8feb014443f0a07e9fe3c6ea788adc9`  
		Last Modified: Mon, 06 Jun 2022 20:06:32 GMT  
		Size: 21.2 MB (21201214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:f996bbef3271390f417ea140422f25a298557c83f7d55fc81321c18dfa71e566
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.5 MB (164546555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:635aec4bf0e57dc02b05fbbeda9b9523d01024b5adfddc568c8a1c657f891caa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 07 Jun 2022 04:23:00 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:23:00 GMT
ENV DRUPAL_VERSION=9.3.15
# Tue, 07 Jun 2022 04:23:01 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:23:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:23:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15ac4ccdc1f8e208bc2188f34d76e6b8ea7759cd17e89dbbad1fecf8a8614e46`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ffb25af8a220bed38e4e8c216f6949b95fad34aead68cc44be790848bf43aab`  
		Last Modified: Tue, 07 Jun 2022 04:51:58 GMT  
		Size: 669.8 KB (669847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:131f3e2067e6ee85a4824b8516234d0969880d3cf339effdabe122b22ba89b9b`  
		Last Modified: Tue, 07 Jun 2022 04:51:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8cb59f0e752d8361103eeb153868ce174cb9bb98597b1ac0eba87bc914fe2aa`  
		Last Modified: Tue, 07 Jun 2022 04:52:02 GMT  
		Size: 21.2 MB (21200932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
