...
```console
$ docker pull drupal@sha256:975f7a2a2f90b3d45d652c5f7163af087dbc62767fe8d66baba5023833a83d6d
```
...
```console
$ docker pull drupal@sha256:c9b645d1a90f9e527424c852d08b47058225d73ce079b93cd3d565dff0f2d5ba
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156876739 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8bbfa54cbe9ef7683284e140f6ced9068443339e4e15193ff3cad6a34b3c82f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 12:57:41 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 12:57:42 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:58:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:58:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1264f5d2e11aeace61ed311991897da2366c4a4cd20f2941cac2b6b870dcf8d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f09cbf9a592aba8814badf1dc16dde6104d50281a3fc224a5f8c3459e4778ef`  
		Last Modified: Fri, 11 Mar 2022 15:33:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c2c95030dbcea446502de18cf68416fdde41bebff850b71aa0f4e09253e62c4`  
		Last Modified: Fri, 11 Mar 2022 15:34:01 GMT  
		Size: 20.9 MB (20933837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:41377b72d50ae490eb765fb2e0065a98ae6bff5d066952f70e889b7174ca54e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189553337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff715703ff4e182df21b6687cb889aab43536c88baa334ab929ccb96b13cff55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:52:11 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 14:52:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 14:52:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:756f655c7ff6353b58442e08931c7c39a5f56361b42d9d5da60d71503e8cadbc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e04460ed84996aae4070b9b99ff96b02b21d65629f25874fe70c167951cd4fa2`  
		Last Modified: Fri, 11 Mar 2022 15:24:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b430f75b65e711f70eef9fba75630503359e48c2d01f47b608ad229e5a39f79f`  
		Last Modified: Fri, 11 Mar 2022 15:24:56 GMT  
		Size: 20.9 MB (20933779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
