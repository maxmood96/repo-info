...
```console
$ docker pull drupal@sha256:a9bdc3cd2f8670e501db73819178cc69a73d4f6250542370b96b1918bfc944e4
```
...
```console
$ docker pull drupal@sha256:a0acd19360a9419da832c29efa96dfc70abf1861ff1f092223b01566089f6b18
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187694035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7925159bca5f6a76ec392d9791064370511de767154272a0c4ecdc4360e8cd67`
...
# Tue, 23 Aug 2022 22:00:44 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 22:00:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 22:00:55 GMT
...
-	Layers:
	...
	-	`sha256:0c16b04e9c7d248a4009fde7ec156bbc0a9ce290843aa5324006c089f474291f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb8e2a5719c7b3c114c0a0e26239ddfcc2c4ffc3ccd4be430da96513e77f2621`  
		Last Modified: Tue, 23 Aug 2022 22:22:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f95f7cf8c7fcd5d7d9ea7ed3a1721fc9a89426dc6fd5a20c451217a75cc4aa9d`  
		Last Modified: Tue, 23 Aug 2022 22:22:27 GMT  
		Size: 21.9 MB (21866718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:f88912450789e6d39245bd39b7b2b1d02c6052f9fa68e1d9dddfc004959d2a5c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157947477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57bfa113dceb2f0e0b5d09bb0c50138403514f4d27c202bfbd0f12ec9a4e87ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Aug 2022 09:28:30 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 09:28:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 09:28:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e0158247ab6f8dc6748fbb60c53520aeb5d8e82386480b3f1af6a7fae32e565c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6634e5d83cc05b1f78a6b10e607537b0a7b40e1948b3b3155f535c1e69c9c0ef`  
		Last Modified: Tue, 23 Aug 2022 10:11:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a54539a270b228ef9f9d7aa5e31cd0d7ec4eef8b8078cb3889375f7e0ccdedc`  
		Last Modified: Tue, 23 Aug 2022 10:12:14 GMT  
		Size: 21.9 MB (21866719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:b12264341bd84b0bebb4aba71dffb985995eafc9f1f89d6059beee08b1d0babb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.5 MB (180543862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e2ded2aed9349af3e066b588b8b50e8eb476800110c509aa01a0e9b322e20ed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Aug 2022 23:45:08 GMT
ENV DRUPAL_VERSION=9.4.5
# Tue, 23 Aug 2022 23:45:09 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 23:45:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 23:45:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0348733af53079d2df15155d1ae0e18b8a75d34fef71d510158d7845a9b291d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02579f68565208f14441df18040d8d50b56a7c269184aaf1c1d1552ab16eac87`  
		Last Modified: Wed, 24 Aug 2022 00:18:12 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d23e1167e66eed4b2e715521838290e504b60937ff7e1d0bbc304ad089781413`  
		Last Modified: Wed, 24 Aug 2022 00:18:18 GMT  
		Size: 21.9 MB (21866674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:8144f269d4d283216ff75c161f5f049777725dbc012462124bc6767990d9491e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189783507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88e11f3b3c62715b678f93865403476919e50d06b3c01d64d627bd0f0b051b30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Aug 2022 19:05:37 GMT
ENV DRUPAL_VERSION=9.4.5
# Tue, 23 Aug 2022 19:05:38 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 19:05:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 19:05:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8fbe41ae2b627ca25269334bb4908aa57bca51570d6052452645c2d2c63ae3a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77d270dc0771b4541142bc8579aaf33e49951d8c80fd1eff027cfe81a912c2be`  
		Last Modified: Tue, 23 Aug 2022 19:37:56 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f226984926d685fd1ff77b634550d86604c5d3271f71376c705fdc9fe382d35`  
		Last Modified: Tue, 23 Aug 2022 19:38:01 GMT  
		Size: 21.9 MB (21866636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:9bf793f623de24dad587e4610db9c1eafc87706f5bb19637d2d443d710a5149a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188776995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03aa9a30aa1ab838900443ce052278c44c6a3f6a0d53db4a6a1ac421da699034`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Aug 2022 16:57:29 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 16:57:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 16:57:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f884eab14f620be2dbd7083153ad824471ee36db16dd54926c19e27c0f7569f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f028ffdb55076b2923faf13011817279689b2958154e283fe7ebbbdcbbab41ae`  
		Last Modified: Tue, 23 Aug 2022 17:30:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f0553ca9aafe61d38a3204048b066775161c84a6ee8fb835c98e7df327863ff`  
		Last Modified: Tue, 23 Aug 2022 17:30:51 GMT  
		Size: 21.9 MB (21866716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
