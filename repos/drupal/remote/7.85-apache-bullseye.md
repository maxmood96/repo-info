## `drupal:7.85-apache-bullseye`

```console
$ docker pull drupal@sha256:40e2aa5e01641ce8342e2834cfe8b15b62480e4073f118b14621c2507a2bc8ff
```
...
### `drupal:7.85-apache-bullseye` - linux; amd64
...
### `drupal:7.85-apache-bullseye` - linux; arm variant v5
...
### `drupal:7.85-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:7.85-apache-bullseye` - linux; 386
...
### `drupal:7.85-apache-bullseye` - linux; mips64le
...
### `drupal:7.85-apache-bullseye` - linux; ppc64le
...
### `drupal:7.85-apache-bullseye` - linux; s390x
