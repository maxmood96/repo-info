...
```console
$ docker pull drupal@sha256:e57b6bdba09f7449017c8d448386e35e77eb0713dc1dad90f48e866b2795ae77
```
...
```console
$ docker pull drupal@sha256:45efe3e88692a37a93052a567bdac67b70a965ce0e16fba541230d4c102f02a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165828395 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55b22c408e6aece5a10dcd5fbab66742a426c841c273de6e9627a9fb3ebb88e6`
...
-	Layers:
	...
	-	`sha256:1c830bc000592d152683950e5226e53060970eed2be4bccf4d8f2b0da7f04239`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd76bba8fa272a9433b977b9d537b8b7c41532b91b5342283d2c705e7b870f25`  
		Last Modified: Thu, 20 Apr 2023 22:46:16 GMT  
...
```console
$ docker pull drupal@sha256:0e1705758e5534238b352af17e299a6fc43790a41fe73c7484c19126cfe30c33
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135831926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5562eb0952a6c5e7781b776605ef0e52e2bcd965a1bb3e14e712512d9f346833`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 10:49:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 23:39:16 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 23:39:16 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 23:39:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c29686554672200f2db52fad5173243d380ae08888e28ba74ac0f2c5b3e5f6ba`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a76524bbb3c9e4a3584aa57bb31954cfd0c8fb26bf6a1d6a64f52aa1fbc75cb`  
		Last Modified: Thu, 20 Apr 2023 23:58:17 GMT  
		Size: 3.4 MB (3403818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:002b67fd8b2aa1deb15bb3c9d6946bb75ee2845f16541ac051f14ca1edf05029
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158835430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3c2659154ce17f05c99908cd9e7db43a507f49e503a0b9295711086615df15d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:47:59 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:47:59 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:48:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cd8a08ecd3eed5496145243b5800e2a5c1648ca19a541f5ce470377fb3f21516`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:237fc83b441aa1641c0b2a8d1d0976b8e6c5b9b90c3478481b843d9b7c6bd4ef`  
		Last Modified: Thu, 20 Apr 2023 23:05:29 GMT  
...
```console
$ docker pull drupal@sha256:0d56e4d86e9337f6b7ab387a00b0af2975e8b2ee42c78df2364771f23a947f6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168410703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68c25d4d29928803265ca6ddae4fc00c44f1e4473e3329b2d61d008099c19acd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 23:24:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:47:36 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:47:36 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:47:37 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7508b50a724deab3550684df1e8d396ad26128bec156c80dc2f7ff2c772fd609`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:305e31770660d3ea3276d78aa402923a0e221d259c76d6c9d501e777fe6517e2`  
		Last Modified: Thu, 20 Apr 2023 23:08:07 GMT  
		Size: 3.4 MB (3403817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8df2747cb9d3e00afa3c31b024c7f6450f833bbb26be17808205771d0b609104
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165597333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2649b77ff547238f39c9b08971b03ad37952d7faeafedc968bd515c9c3a5f3a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:33:09 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:33:10 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:33:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2c910446313c4f5663c5c80e3fe19a7a67501b6ea70f957d8684dcf49d1a4469`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c87c96150b3080a2f5b2961df37db3fb28f31425b2aabd9dd265962e820c318`  
		Last Modified: Thu, 20 Apr 2023 22:58:52 GMT  
		Size: 3.4 MB (3403811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php8.0-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:385270fc24770c6834f4ae1274e6d4972ba67fe152e92a7ab20bc90a14b99a5d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.7 MB (142740805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c00f79a9a1b62e2dce243655927e06876d4bc74662a553621c0713bc0670e5fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 11:59:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:53:58 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:53:59 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:54:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cd55b283ac8087869d60d12b854e3949cddec94d9807adc6254f696254440caf`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01a27f75b27263583a3589f51ca2aa1023d926311380f45b012e19295bd4b4b`  
		Last Modified: Thu, 20 Apr 2023 23:02:36 GMT  
		Size: 3.4 MB (3403819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
