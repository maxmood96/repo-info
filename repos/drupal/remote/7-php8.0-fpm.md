...
```console
$ docker pull drupal@sha256:8ab91bcb84b706db65726dba1856f09caaaea79fd8b77fa9ea1ff09d9ad2942a
```
...
```console
$ docker pull drupal@sha256:ce60acd6bbf693aec728532029fa4ae78e3cf183b359253c3c6c5a59b6dfeac2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.9 MB (135872151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dea242fe333c99169c5969a4173352a0493dae712a8df6bc0f0d4d076b9b3865`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 15 Sep 2022 00:15:35 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 15 Sep 2022 00:15:35 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 15 Sep 2022 00:15:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:93e00882ec5bdb875cccf40cf0d4646d539b85c03a72a763f8a5cd90001d205e`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:072339bf24f49e5933b0cefb5e910d26acbfb4b34b36122207c846663a6d6c6b`  
		Last Modified: Thu, 15 Sep 2022 00:53:59 GMT  
...
```console
$ docker pull drupal@sha256:f7b11fa02d62da6e1dee8af8845ffff974b3e3c3bcd6ab14914560700cee339d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142811455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38df8785edc3b85a2ad03b01080512af4c18b1b0d7f0118da5d2a326e013b869`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:04:31 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 00:04:31 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 00:04:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:492b10cf2358658d31805ec25e624efcf224b64a5f8738f59edb6d60aad1b326`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a3dc120c1535292bb486bbf392075032e388863ec3676d1a0582690241ad1b`  
		Last Modified: Sat, 01 Oct 2022 00:20:03 GMT  
