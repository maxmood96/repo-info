...
```console
$ docker pull drupal@sha256:e6beb7705085bf25c1038991eb9e0a1ce47e2cd53c0e93cff6e00d5c8edcb9fd
```
...
```console
$ docker pull drupal@sha256:4f306ec8ded58bf30198d493ce3353fe64e762dca039ebbfebcc9e8d934a441d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165889170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03a45630c87cf576e6736a0909cec405e4e05f888c0236f8a651883384557045`
...
-	Layers:
	...
	-	`sha256:b497df5979f8e7b150649561c16a61f9430ff0e3e7036b106fa31203731b6c5f`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79f1c5cc3c5e3373a54ab388c87506f529e5c76fde8d9045a12806944e0e856b`  
		Last Modified: Thu, 08 Dec 2022 05:00:22 GMT  
...
```console
$ docker pull drupal@sha256:cd71c651a7d68458cb4658076515a8fc24c64174796700c66e4f5de4b9be768e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143524530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab63bca77131203f8a611fcccb67920ef9c18176b9c6ce9d8be227e350340645`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 01:48:34 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 01:48:35 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 01:48:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6051511d6d82f022325c18f7e3047d57776b3b5d7a0b6c6b8269a7695f79ed2b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:672462ce3340a45365c030f8a78dc0a0fcce48aaa4dfd875f689666a16a487ca`  
		Last Modified: Thu, 08 Dec 2022 01:50:35 GMT  
...
```console
$ docker pull drupal@sha256:77d30ce8efbd090447b66fd7ad2aabc0d3e9c6c70dd2f359463becd420551de1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.9 MB (135894873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e7e09fca86f1f895060e3379626e4977687010201dffed0cf424435a1d08e2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 06:54:29 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 06:54:29 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 06:54:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:060a50efd550ba0c5746819966c2b34c9bf8889678e09b7a6e901c8e44aab899`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa31b9d9a70e7bc252e87169552077529926900f07875d85ace2b97be49b68d7`  
		Last Modified: Thu, 08 Dec 2022 07:16:25 GMT  
		Size: 3.4 MB (3402247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php8.0-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:326b1539e2f64c8ea31fbccf8de4b81ad65b41628d5207cf7e8531cd2b006549
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158897606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d6d1506169f661793b9210f2897c10de685eea5b914481ef43dff766df4cae9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 03:35:48 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 03:35:48 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 03:35:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7a7bf7bd9f7123a6c7aa9d7672f0aab5f0ef4dd01a9b5d56daa6e51e9dc75032`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2b1a8b29881dc865ba3036d3c5622ec4f1c16b61e71f9254f42dbf322898150`  
		Last Modified: Thu, 08 Dec 2022 03:47:26 GMT  
...
```console
$ docker pull drupal@sha256:b9104de4a5fc8ad1e85b63bb72a42389d3810d306af6d8f2ad87b448a6a92f12
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167611626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b3fe324329c5ad8e213bed8a7aed6a9d094666830369ad4520d879abc3b0802`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 05:05:10 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 05:05:11 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 05:05:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9eba783fff7db7af6c888b3f20eb12df9083840bcddd54eaa945655d2f6b4a53`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:864c3db0c6b4956db25a0b1846cfe9e52dfa78331d683ed4634d94d0150fe00f`  
		Last Modified: Thu, 08 Dec 2022 05:22:58 GMT  
		Size: 3.4 MB (3402257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:65fae17f17460aeac56bbb755b02aba938cc42d2276937aac42535546ff28fe4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.5 MB (142458864 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8644dbcbc53734420e27ae7b9cd95a09eb1196e5aed49ee20cf53bffdd3b7fdd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2ad8d1ba82f32ba68ccc225097cebce29125843d9ffb4a04b34b7ded85f26112`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d05e2c39547a3afb99fac509538a1c7d73102fe5dcda6cdf4eaac9a9145b9096`  
		Last Modified: Thu, 08 Dec 2022 04:50:23 GMT  
		Size: 3.4 MB (3402250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php8.0-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:d986236a3f37394a7fcf5a601095b0444afee275c80813b05dcafb091d222cf7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165651107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f77307e1a9c70e04ea3a44c4ef919a509792755393904c3dee2c86ccf6d79e10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6db8ee6f1de1ea6448902cd06b34e8193ed6585f14b28a98975ed63fb5ad8dc0`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa0576940ddd66851236640b0c86ce9ee9610e5cd25f73ba1ef908bb276759e5`  
		Last Modified: Tue, 06 Dec 2022 19:28:29 GMT  
...
```console
$ docker pull drupal@sha256:8e26080ba00a05ebf7febf08bbcaee92f9c2e0fedfb33e403e9ca34bd091e8b0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142798077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8853d13e10922996fb93cbcce49f075698b4702ffafbac63704c3a70252a7c96`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 01:59:31 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 01:59:31 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 01:59:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b5a08fa73a8e84c6764ed8715df43bfed2d4323f41fa0c7c917ce4e8ca853508`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29dcd5eafad41bc91162a73602d70808db305e124b77f72e80711f8df88bc398`  
		Last Modified: Thu, 08 Dec 2022 02:10:52 GMT  
