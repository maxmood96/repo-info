...
```console
$ docker pull drupal@sha256:0ff9a4f6ebd7b119b85d1d071a5074e85ab03321fb159dee4bf88798dadb4507
```
...
```console
$ docker pull drupal@sha256:a1295bdf5cb1f942a62849a332c0ad17d5c3ee96c619b2a4ea9d92f56461b9f8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165814657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fede4e67124c3a110d6069bdb99d7b54ab0366c0672425f58b3ae5d08fb133dd`
...
-	Layers:
	...
	-	`sha256:ccde8c9788f451d9cb6a2b3ea0c67e08275985bd56b5733fe287f52e8bd13f31`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd4dfb2469617446cdb2a3088718948a998a28f475b680c746363efae531fa8c`  
		Last Modified: Fri, 24 Jun 2022 00:46:03 GMT  
...
```console
$ docker pull drupal@sha256:fc6bd31a6f90f7eb431469ef8f0fcc796b98f0e792c5408561523423b0daaae6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143522058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9640a31ca8699f61f90b24760d3ca2c44c678bc31b84aef113c1b39487e314dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 24 Jun 2022 13:04:53 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Jun 2022 13:04:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Jun 2022 13:04:55 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 24 Jun 2022 13:04:56 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 24 Jun 2022 13:05:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:be9a084b3d4d562f5842bfeb99bd8a0e74b0d207066d4d1cbf46fcaf35ad80b2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c73522d362efe0c3bb5661d9083f431f905417208e29a6a7ee22c24615e5bb1`  
		Last Modified: Fri, 24 Jun 2022 13:22:48 GMT  
		Size: 1.8 MB (1769492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:882858f911a9e3a97fc413197cee4f96915117fd6d78c6e6df57ceb5cccd7901`  
		Last Modified: Fri, 24 Jun 2022 13:22:47 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ceee4958bdbf94bac3ed8af83b59714d9d25ee3c1f462535e0c334e696538ea0`  
		Last Modified: Fri, 24 Jun 2022 13:22:51 GMT  
...
```console
$ docker pull drupal@sha256:551581b53b1e0eb8e42ef36c9356cf35528067f0d9d164caf9ad11cb474ab632
```
...
-	Total Size: **135.9 MB (135887284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53d2fde200903822e78a32d0dea24ba626707456d975a6673307ab154e2197a8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Jun 2022 00:11:10 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 14 Jun 2022 00:11:11 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 14 Jun 2022 00:11:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e5cd1dadf1831c3f97df87712da91b0f4568fab9bd4e68fd044be008f8b4ed7b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc8c2e0d33aa0d6efc150e4f0d35ef943f15fc9054edd2b064f34eeee053150`  
		Last Modified: Tue, 14 Jun 2022 00:44:22 GMT  
...
```console
$ docker pull drupal@sha256:4aefb7f20b38e0a97cf8cd71fa28859543ca52527b76ede319a4211694c37165
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158039755 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79e37a4b9b9d8c33c317847290ccc861fcb0689b46a52d3ec396d1c549ee0c9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Jun 2022 22:04:44 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 23 Jun 2022 22:04:45 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 23 Jun 2022 22:04:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ebeeea44b6541d37d660af8aee824ea02ea50c3806f9ec82a0631d892efcad14`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9beac3581ed2b3bd2948975043f5eb6871031efe4565f8a7c340c939705f631e`  
		Last Modified: Thu, 23 Jun 2022 22:35:31 GMT  
...
```console
$ docker pull drupal@sha256:be16fbb3ec2baace4c15d251816fdf9eeabe1aacbc5260e66516846c135630c6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167601494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c0d6bbb1ea2848281b826c3b8c117b56b58a6a7f7336542e42c234d3994b652`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Jun 2022 16:38:16 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Jun 2022 16:50:57 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 23 Jun 2022 16:50:57 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 23 Jun 2022 16:50:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:21509a9a4bd6b0d6e58f2fded6fa229042ca3d3bc9071dfe4e0fc283e288e149`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20e218b2a58896da3ddc734a0522e607755d77b7f69061b530f9f9a644f470ea`  
		Last Modified: Thu, 23 Jun 2022 17:23:42 GMT  
...
```console
$ docker pull drupal@sha256:cf986b71b0233c85ccf29827c559bb6abfc700fa66d911e4839322b6d82d7633
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142798109 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:968e9e146335173206a2ae5e478e4c44975158383ab32b6b553783d21cbcc190`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Jun 2022 19:48:37 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 23 Jun 2022 19:48:37 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 23 Jun 2022 19:48:38 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:76c9bec14a262668bd04e11f79fcaaac79c9b3282620c94d9c394a2a80e664ba`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5c91981851cf77fe849d072ebf0a69da28213fbb7f36d940ffad440bc18df48`  
		Last Modified: Thu, 23 Jun 2022 20:24:54 GMT  
