...
```console
$ docker pull drupal@sha256:b942f5ad19c389812edeb66693d8eda64a40185ede6bf48b71c2ce2adc777718
```
...
```console
$ docker pull drupal@sha256:8b3d1b0c6d73bc98f74e1877eb245280ebd2da2265b107fc8675bdcdc773acc4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158891874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:696724c34797253babab0eb28ca779ac7e67d335764b6586148595aef457e8c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:7a7bf7bd9f7123a6c7aa9d7672f0aab5f0ef4dd01a9b5d56daa6e51e9dc75032`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e66b0667e42ae658c4595bd5490458cb55722b3ae8bf7437dddc40be6b1cb49`  
		Last Modified: Tue, 06 Dec 2022 18:35:06 GMT  
...
```console
$ docker pull drupal@sha256:228f08c11c8ba04652fea21c46b7d7ac10a10d7ac96c3d155dc8bbc391e61951
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167605930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb3429d024839dc8b6710e692d37794b2dead16eb8142801d745c001bc4a4801`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 06 Dec 2022 17:23:24 GMT
ENV DRUPAL_VERSION=7.92
# Tue, 06 Dec 2022 17:23:25 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Tue, 06 Dec 2022 17:23:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9eba783fff7db7af6c888b3f20eb12df9083840bcddd54eaa945655d2f6b4a53`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5befd4d864492ac393925acf00d34e5aa926fd4a51b638a358e06f0f7b7ae746`  
		Last Modified: Tue, 06 Dec 2022 17:45:16 GMT  
		Size: 3.4 MB (3396561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
