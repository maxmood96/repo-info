...
```console
$ docker pull drupal@sha256:525889024af72dee013d39f1d2cd07e438ee52c9042f10e7008e298e8a660a77
```
...
```console
$ docker pull drupal@sha256:4852f88d73a23424f86218a296fd7160bfc1ba5fdfe336eeee79be507bb62a06
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165827351 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f33c8b29d70d4626ac71a25bf0d9db3734bbfaf2089052319be262c6d95a6a97`
...
-	Layers:
	...
	-	`sha256:1c830bc000592d152683950e5226e53060970eed2be4bccf4d8f2b0da7f04239`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e1c1134738bf0a812bac33d73c50f8859a48ece40043887c1fe80f7e7a554a8`  
		Last Modified: Wed, 12 Apr 2023 11:56:54 GMT  
...
```console
$ docker pull drupal@sha256:e165307604b83edbc7e8e05af486ee78b22b2838f9b66690ebca6dcaf46458de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143458717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d3da5d52a089b56de76f6e72a43771c372546cad8a9788b7fea543309c1e42d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 10:27:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 10:27:42 GMT
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 10:27:42 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 10:27:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:63f5cae02a6a92dd0b03413638684c2d086b894e3b81e95b72dfedc4df08dbe0`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f087fc3b066c113f8b5c9cf28a06e231a37ef46b1d48707b2359970c0cb750ba`  
		Last Modified: Wed, 12 Apr 2023 10:28:38 GMT  
...
```console
$ docker pull drupal@sha256:b7566f7110eb89dc163d1a59bf3cf1b61e5fd152adbfad8e5e6dd9f073747039
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135830888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e50f31295779e0f8db47b4151b6de3ca8eccf5b7b880c7e51a1e97a2eeeeb1d9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 10:49:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 10:55:35 GMT
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 10:55:35 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 10:55:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c29686554672200f2db52fad5173243d380ae08888e28ba74ac0f2c5b3e5f6ba`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a418de08f7a4ad57a2f5199c536bc348665881c2b54f215e4f1740b6538b632`  
...
```console
$ docker pull drupal@sha256:82dc9f7c3e3b470debe35a8adec12b1bc362f79f5f1203d9d1db74d7f127e95f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158834393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac055b96afcc345ba0e295a46c79dd2c24e2d6736e22569a188e2b79712ec19a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 17:44:34 GMT
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 17:44:34 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 17:44:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cd8a08ecd3eed5496145243b5800e2a5c1648ca19a541f5ce470377fb3f21516`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa934abf8b04a0552bdbcfaa3248886d7946af4c79ee057f43b57050710d6ac6`  
		Last Modified: Wed, 12 Apr 2023 17:57:31 GMT  
		Size: 3.4 MB (3402780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:503343393aca4bc2fae4256a13eba0d9b051651805ddf8a28b765c92a82725c9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168409685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adfcd50a58d0b4024634685f8238a9f0f4bba378673738f29cbd2e06d4b23302`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 23:24:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 23:30:17 GMT
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 23:30:17 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 23:30:18 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7508b50a724deab3550684df1e8d396ad26128bec156c80dc2f7ff2c772fd609`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f40bc9010c26c196f505a85da80fc492b681a74268e6c3454b4056d00c52797`  
		Last Modified: Wed, 12 Apr 2023 23:45:09 GMT  
...
```console
$ docker pull drupal@sha256:d58d90aa9636d343ce34675c9549b752dec4a70f74af6a8cd77d9fc5f85c3943
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165596320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b16d56d4aeaf26d0482a77ecf52f95a947f0b954aec9ccbc8c869c8b73ccac8a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 12:13:28 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 12:13:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2c910446313c4f5663c5c80e3fe19a7a67501b6ea70f957d8684dcf49d1a4469`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e98d55f0ac8322c30b1515590710f123ddb9a01334d8d36cacf53ac8a985ab0d`  
		Last Modified: Wed, 12 Apr 2023 12:26:00 GMT  
...
```console
$ docker pull drupal@sha256:c3359a7fd9804589c128e6ce386aad149ab621ffa5254421b798d70b0c0d9548
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.7 MB (142739762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc00d2092bc878a8da013a535b3c2f56f1f826c70992cd1277a8a863c535545c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 11:59:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 12:02:41 GMT
ENV DRUPAL_VERSION=7.95
# Wed, 12 Apr 2023 12:02:42 GMT
ENV DRUPAL_MD5=ebd3b1ef8605585d703c13552f841731
# Wed, 12 Apr 2023 12:02:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cd55b283ac8087869d60d12b854e3949cddec94d9807adc6254f696254440caf`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b093e2b5b03a08270a9b1769091442afa8e5447a7482897b384012667fcadfdc`  
		Last Modified: Wed, 12 Apr 2023 12:09:16 GMT  
