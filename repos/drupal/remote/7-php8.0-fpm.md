...
```console
$ docker pull drupal@sha256:1aedfb8fa17fcb644ea0c0ab6dab58ff2fbbb67429df48a75467597f9c83467e
```
...
```console
$ docker pull drupal@sha256:c05af098f619f6b2ed197d9ec5be62cc0ed59ebc624c195e0b4f84e9b9cf8f8a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165836245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4dc45e5ad765aeacfeceb32399425a3fa928cae9c786cc9fca52f9c7f44be77`
...
# Tue, 13 Jun 2023 20:57:30 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 13 Jun 2023 20:57:30 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 13 Jun 2023 20:57:31 GMT
...
-	Layers:
	...
	-	`sha256:a398093708dae3da685005b462f01ec6cb8c4d4404cd11881d79b8a9f593ed75`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ae53b6b8f8ef0d320e0a1a2a37c4e51bed7f83a3a80393d07b8b5dc601da1f9`  
		Last Modified: Tue, 13 Jun 2023 21:12:15 GMT  
...
```console
$ docker pull drupal@sha256:b4d393e5f4548ee8503b92d8ea6a33a25a79e003c2853acd54a453a82e557a48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135838610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:677a1c73669c1db4a9d21f988960b02f18f72852a961411bb57d961d1b8d231b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 14 Jun 2023 02:08:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 14 Jun 2023 02:15:32 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 14 Jun 2023 02:15:33 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 14 Jun 2023 02:15:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7036b7fc36ca7fb544bc368a02b0c2a345276d040a4be179f6f971e924cfb705`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f04a0b46cc4df6c42552adb7743daeb453e22777f3a0b644fa6edbdd7c94d1f0`  
		Last Modified: Wed, 14 Jun 2023 02:32:22 GMT  
...
```console
$ docker pull drupal@sha256:8e05e5887f10de4f3f011efaee491abb823f71c2e6cb7e48151c1a9a278e302e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168418229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b747243e54360a957d748e2bca0fe770e542378145a2dbb59da85fd15537a40`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 22:40:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Jun 2023 22:46:13 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 13 Jun 2023 22:46:14 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 13 Jun 2023 22:46:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:52500d41d74b2f1df601ab1c38006a036bc1b85780e9c5326dbc879e44ba28b3`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc66b6838e3cacd335c15c9e3221627c6e964717a056f1dbec8f9f728cc8a3fc`  
		Last Modified: Tue, 13 Jun 2023 23:02:18 GMT  
		Size: 3.4 MB (3410779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9ca56820071480688d238cca1cf02590f6df6ddfe8fcefb0f4468721ea5e8972
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165606206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:407cc20496438a826c1229068ca270735987d0e173f299a6150f8d2588e4c039`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Jun 2023 23:57:19 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 13 Jun 2023 23:57:19 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 13 Jun 2023 23:57:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cf97cba30640b60db18cfd7e75da8ae7d48e89f712b9afea9a33ad2b52253616`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14f8d4c6b5bdf69d68208d66f989bda67270bd2912910107a9366550183a9052`  
		Last Modified: Wed, 14 Jun 2023 00:10:23 GMT  
