...
```console
$ docker pull drupal@sha256:341ced5691dc8b59c8c18bed83a4388559cf5ab95fb9df1e0dee8897cdbe5e5a
```
...
```console
$ docker pull drupal@sha256:7941fb8c2550fd6f1e2bae47bad73530966722deb4250b3658de1ceff30fd727
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165713267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba9fe239e95f570b6b9d3d402db9df8a46c997f644a77573285749c5544ffd41`
...
-	Layers:
	...
	-	`sha256:9808252615e390fb8f1315fd4315aaf9043de7bf9b3ccc9159c60960a5fad1e7`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b032b40d0a7030ec362f89193ee17ab835c946cb1bd0162757425b5ddbab9fc`  
		Last Modified: Wed, 13 Jul 2022 02:17:10 GMT  
...
```console
$ docker pull drupal@sha256:7fc33acda3a09f1c8f05ae1d2848154de07a01c90b960430096584ee57529069
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.4 MB (143415066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:808413195e7ae5560bc3aaa2e401c6e9b213e5b77ea6e86809ac956103453ae9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 13:15:48 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 13:15:48 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 13:15:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5bcc1c4fe06cd3227648862d14da5381db9d8cc9faaf754e2f848d803e3eb621`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3520c55b489b51a36f853ec7a49a07c26a8f57565fb91c3dc5ca93a5c0167990`  
		Last Modified: Wed, 13 Jul 2022 13:33:41 GMT  
...
```console
$ docker pull drupal@sha256:217a954b237f9477370283823197fa7089e7d4850d12498dc3d2e33746d4fdc1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135782777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7deba3c1ecfb1e87cd7c126a2080310808f1f07125785f94d138b86851d220db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:7c1910ea35b05542b30eb5f920fbd5e661b824d25306cf346738ca623cbb4262`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e571fc444d0b733c2c191784f48cfd7629c517b85ad74a0987ae8817ef47bb7`  
		Last Modified: Wed, 13 Jul 2022 15:51:14 GMT  
		Size: 3.4 MB (3388626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:76841d24006b85658fa74d6ad00fb892bb8a047b1f4b7a20dd331a95196d0148
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158141755 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98df1b4135e20f5f7022eff94335589dfd3bcb980cf23564bb44ecdf02c19e90`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 16:01:03 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 16:01:04 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 16:01:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:651002c68a6c8b38f9000e4d7c62dfc4d85cbf3acfcfd2e3d7effe2320179d2d`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24336502e189fb44bc38a0b09f88a71fb454379f0fcc9a89d04e86145444c906`  
		Last Modified: Tue, 12 Jul 2022 16:34:38 GMT  
...
```console
$ docker pull drupal@sha256:161cdcd8108a09227fbfe29c7a01b6cdc73bb99f1257008cb6b4534afecbfbc9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.7 MB (167702906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad1951d72c5cceccc5a32386fae6b8ec835004b494c29bd2e9ddeccf13e757cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6f9db432d3aec12790dd56b6b3ffdb652c6c37d205ee059dc816c767ad024fc2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a3257776c64022732ed79ed0ba9cde2d392d6948813cab93d1118f325f0b833`  
		Last Modified: Tue, 12 Jul 2022 16:28:35 GMT  
...
```console
$ docker pull drupal@sha256:21716bbe0a97ecc59bc03b479c632ca99dd595a81f632a4a6f00ae0fd6fbecf1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.3 MB (144303545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:294cd72b29c205b4d8dfb825159547bb486b3e768170d6f090b205855c8fd946`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Jul 2022 01:34:06 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 01:34:09 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 01:34:12 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 01:34:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b89f2b5cc18a5779d799eb243c179920c8de5f6d7bf428a17b19e62a4ff5d5ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8459e25a3c75ead6f370df608fca71fb89f2fa7a2925bd8bc772331c61cbd3bd`  
		Last Modified: Tue, 12 Jul 2022 01:42:16 GMT  
		Size: 1.7 MB (1664886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d61eb65f653c0373f50eccf2e5c9a0049a1dc70084a5c01a7d41d5ff67c108e`  
		Last Modified: Tue, 12 Jul 2022 01:42:15 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d58c4e046c250de788d0a71d91caf67e932edf714e228f2fadc788abb09d045d`  
		Last Modified: Tue, 12 Jul 2022 01:42:18 GMT  
...
```console
$ docker pull drupal@sha256:2690ed3c4ed24292b0892971913c8a84ec952a8b24e126305f4eee29b588de83
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165540772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e6a8ce8e1f4cb0eaef8ae2d49cd7928e2b3b3496a81e3e2918ce6f324a9de59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 09:04:36 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 09:04:38 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 09:04:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:88bcbf5fe95cbb14d9a39e4390cf980435570eb1bf2e91bd6e696cd298b4aa06`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6324962b5fb2243c49c270a7b94ea0df1f85c119ac85703e6b9cbb4964d2329`  
		Last Modified: Wed, 13 Jul 2022 10:32:11 GMT  
...
```console
$ docker pull drupal@sha256:a780e64511557962c154d840ed80d6d1f6e4a437076229f71dddd3318305e4dc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.7 MB (142695744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a16a90b525522300ae0a3bfff25739e5169f207c7c469b829215d4b604c02d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 20:22:13 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 20:22:14 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 20:22:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f30dccee587cc49b749c0cff92596b1eeee87a4278f653e1f12f42fc84b2cee7`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37a518198da0150d437d91f21c723ab133477cbbccb281272a56b5cb9d616639`  
		Last Modified: Tue, 12 Jul 2022 21:03:03 GMT  
