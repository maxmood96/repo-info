...
```console
$ docker pull drupal@sha256:a70d459ffcf4b68c2e420d987d9036b5b17eca67960e1470431ec838cb696d12
```
...
```console
$ docker pull drupal@sha256:acb54e5d003cec9f34f0c0381df285a2164ef97d92d94319a95621e3865dc6b1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.5 MB (54507197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:676a7b7972896f5cf8b5c5122a48735a88bfc31f064bc1aee21f84cf7f35f9f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 18:41:09 GMT
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:45:57 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:45:58 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:46:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:b4f374249ef1aeca91913d8d9aa71767c6de3481e9fe7794ba704adca5d2bf7e`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13bd0c6a533bd71374b71c1e8f5b6203b0701f00894d94693a876776f9d31cc5`  
		Last Modified: Fri, 07 Aug 2020 18:49:31 GMT  
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6b546f6e9953266117f0328ff11ebcf5688ad733e792cdfa4bc82b76dea990e`  
		Last Modified: Fri, 07 Aug 2020 18:52:11 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02b75f0e12cd067c9a92feddaa637d76f77ef23083c79a8443483a46f5c0dc6f`  
		Last Modified: Fri, 07 Aug 2020 18:52:22 GMT  
		Size: 20.5 MB (20535259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.8-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:c6fb4391795a9aa251e9ca02a35f342acc064b3a6e055a6e16016dc23518a9d0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.4 MB (55425158 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:668e65291415aeacbcd365e7d70d05b687cd16588c465a019bcd5ca1f7ee301b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 18:39:25 GMT
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:41:59 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:42:00 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:42:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:5df2e3ed89b1f2c7c0abe4063adc1f20bb07ad7227a368998841f674f69525f6`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93a7329a1c409d3069efb16315fee5cf336586f127c16a184dc0490ea2bd4af9`  
		Last Modified: Fri, 07 Aug 2020 18:44:05 GMT  
		Size: 505.0 KB (504969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:348ae89c9eff30e497075bb8ee86b10dbc37b6fb0db3c9e51c8346256162cd4e`  
		Last Modified: Fri, 07 Aug 2020 18:45:45 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26b464dc3aadaa12209726e132cad0777a178dbdd42cbfbf6080da5a0f318935`  
		Last Modified: Fri, 07 Aug 2020 18:45:53 GMT  
		Size: 20.5 MB (20535503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.8-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:ef096a243c361cd577efaf794b2848808555864e7c8d0b784fd7cd9a76de2163
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.9 MB (55924955 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:720e12115a9c2f3c0df9be98793e2afb170bad5c8a5958d3abe9361e53697400`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 18:19:29 GMT
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:26:20 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:26:22 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:27:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:5a43021e5d919503c16ab7d0b634fb632ba925a69127edf92197f2a2d69884c1`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a660a321a89e83c1d9fd52c54ac5899c2a9e4ca3db8fcd0805430606e6baa718`  
		Last Modified: Fri, 07 Aug 2020 18:31:38 GMT  
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac6959ddfe046d4ecf2bbb0c70af654056ffd6cfec6e941dccdbb1e473839303`  
		Last Modified: Fri, 07 Aug 2020 18:39:06 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17ac4a07a856f58790f768d6a5f818f0f159fb5605e2fd4dacaa78c94a9279b7`  
		Last Modified: Fri, 07 Aug 2020 18:40:11 GMT  
		Size: 20.5 MB (20535203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
