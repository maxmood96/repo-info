...
```console
$ docker pull drupal@sha256:ff5c4e6823f716361d22644160e31f9b74bfdab9be5635a834efbe9d6ed8cd7a
```
...
```console
$ docker pull drupal@sha256:2b3f8246596dd02872402eb90173d5a82c6849865c824431f1a924cb5f97220d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53384726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e017fa37f9e3c46b77ffa30db761bfa5c5368c470aa970e7bd976679b8dd702`
...
# Fri, 07 Aug 2020 01:20:40 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 01:21:22 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 01:21:22 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Fri, 07 Aug 2020 01:21:29 GMT
...
-	Layers:
	...
	-	`sha256:41cac44ade56068772f9faa19b8720710262735c5dd1c36453e15c2d8823734f`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8cfe25188caa33da7c439eec74bbc4b19ad0c6bd8232b1cd9fe0df7b3c509ba`  
		Last Modified: Fri, 07 Aug 2020 01:23:26 GMT  
		Size: 19.6 MB (19637757 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.8-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:2bc2b3dccd4176c4da26b841c21f972afce0141757eb5849aae130be2df2d323
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51813825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:311b3e7878d9531756d3feb56a538195675c331560109f945c1a092335d76c51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 00:57:55 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 00:58:45 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 00:58:49 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Fri, 07 Aug 2020 00:59:25 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ae9028df1df01690ff9bdfecce1b4a985f18894f9a1abeb62f689b904a43958f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d7c5002230d6aa1ced88e529f19a42619774df21392f7c567d3e3343e561d89`  
		Last Modified: Fri, 07 Aug 2020 01:00:46 GMT  
...
```console
$ docker pull drupal@sha256:8b3c9ddf8de4702f82c6d636c73d5b8f2a0d25a10a92fdd6078818df4eb930e0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50547226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:813fd09fe45e75a1e925c196b2c460a83bf94c2409f988f5e7c6daefb1de28ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 06:10:52 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 06:13:12 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 06:13:14 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Fri, 07 Aug 2020 06:13:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f84303067df8fd137c4489e065b5301f43f1b1a03c062b5085619a8a3c0e2040`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c4de0d6bb062cfc67180fe13ad6f2d5006e8a2044870e0bc80356bd46771ee0`  
		Last Modified: Fri, 07 Aug 2020 06:17:46 GMT  
...
```console
$ docker pull drupal@sha256:c397269b8ba0eb0d6cf96d95ee5eca17108fcf69dc658f95e583b857182c1965
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53104874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f12556cb903afcf748706a21efcfbc11879e840c0f04aae2244c891d0fd8e5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Aug 2020 00:52:55 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 00:54:10 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 00:54:11 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Fri, 07 Aug 2020 00:54:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b4f374249ef1aeca91913d8d9aa71767c6de3481e9fe7794ba704adca5d2bf7e`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd9f9c80a966f2abb61adfbfbecd78ba2bd177b6d004b88da04350632498019c`  
		Last Modified: Fri, 07 Aug 2020 00:57:39 GMT  
		Size: 19.6 MB (19638053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d416ac3db50c5508bb7cc2f6250a7921dab07b50e4602ab5183d446f798e1e11
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (54022328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43ae403b4ed3bf7cd5a9f8758200fcdd1393ad401e18eb193ae929b336069097`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Aug 2020 02:57:14 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 02:58:14 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 02:58:14 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Fri, 07 Aug 2020 02:58:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5df2e3ed89b1f2c7c0abe4063adc1f20bb07ad7227a368998841f674f69525f6`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e2e1c30ef478b381a332b6e86f40ed2a0f7a6214c0d222ba3f918af72a079f`  
		Last Modified: Fri, 07 Aug 2020 03:00:37 GMT  
...
```console
$ docker pull drupal@sha256:620a5f5ffe0284a95e08f0c1d102c298ac4d2e2e4d7f721ea54b39684e01c36e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.5 MB (54522680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdac28b4dcf6e75aa2af83947e6756746bc08fd890db98e847a1ba8c691e3159`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 06 Aug 2020 23:32:56 GMT
WORKDIR /var/www/html
# Thu, 06 Aug 2020 23:35:47 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 06 Aug 2020 23:35:52 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 06 Aug 2020 23:36:38 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5a43021e5d919503c16ab7d0b634fb632ba925a69127edf92197f2a2d69884c1`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fc908bb16b26bd2517531ee1b0f105155f0f6cc56e09c0cd9b7c84728137766`  
		Last Modified: Thu, 06 Aug 2020 23:41:32 GMT  
...
```console
$ docker pull drupal@sha256:5af03d1d8d7bf760baa80928a6a98d0f91c1d5164cc3af020b48ff6cf915615c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52327342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4928c9f493230cbf84546f10b8798040fcb867b6859468acb0837eff7618491c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:a60ead41dcee78fb2039764dbe5cd28abb582d225f26ba69db5f55c1be97e826`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7df6e4195d4648c85926c7ae1ea7ae2386c0e413d28e2b41c8966dea87e01b6`  
		Last Modified: Thu, 06 Aug 2020 20:21:15 GMT  
		Size: 19.6 MB (19638052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
