...
```console
$ docker pull drupal@sha256:d4fac919ec69637dd20714e40e67797e9a4e77b9bd25d12c35b5b722e3511ba0
```
...
```console
$ docker pull drupal@sha256:fe2f588d7180e4a4476080633a951eb38d69748bbba22763c9b16ac64bfc52c9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53220118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:148cbf2f5906d9c2d008d0f475504a12d64af4fb3178f2c45943f2deb29a43ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 18:12:34 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 18:16:22 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 18:16:29 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:17:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:51:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae9028df1df01690ff9bdfecce1b4a985f18894f9a1abeb62f689b904a43958f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3041ecc95eecf4c8fd375b92b1888be62154fbb80778d4b82dfff1317b80f8b`  
		Last Modified: Mon, 10 Aug 2020 18:18:30 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8be9ee157ba8f3c1a63f6a09c82aed01d38519f66905e58147fb45c36098350`  
		Last Modified: Mon, 10 Aug 2020 18:19:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61ce528700bb7acacef5e248685dc2f50d7343768639ae08a2568bba02cc9790`  
		Last Modified: Mon, 10 Aug 2020 18:19:56 GMT  
