...
```console
$ docker pull drupal@sha256:ea53c7c3e139bc4bab59807dafd2dd940a90efb0613e45aadec51aadd21081e3
```
...
```console
$ docker pull drupal@sha256:bed75c4d63dc8d6966188dda931cbbf7f2935ae1f8f37b2c933390ce891652b2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53228502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffb01522a2074a26f7ea07d963a007ef43a21838122f61ca1c83a9ad75ebc5aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Thu, 03 Sep 2020 21:37:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Sep 2020 21:38:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5699a6d9f692ec530fd901fca7e775124ecfe3e8b152af24ed70bf0a019d97b0`  
		...
		Size: 508.8 KB (508759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:849839d8c61b5a383795a7af585d18bf448c9eb248c33236950d54d458d05baf`  
		Last Modified: Thu, 03 Sep 2020 21:41:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4074d8cda9cdb0b714031baea6987597515a7fc99ab9698bca580a0edb5d4ed0`  
		Last Modified: Thu, 03 Sep 2020 21:41:45 GMT  
		Size: 20.5 MB (20535215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3580308c5b422733e7f5fcc18a2b65021f439011c25fcdd5fdac96cfd5cc64e0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53743954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b86b9557b1f80338c1e35c408fe67f72d971c72f2d68f93815fdbfa318af930c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Sep 2020 20:46:36 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Thu, 03 Sep 2020 20:50:01 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 03 Sep 2020 20:50:02 GMT
WORKDIR /opt/drupal
# Thu, 03 Sep 2020 20:50:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Sep 2020 20:50:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0b3ee62b939d194e56b6d9337a403e9556caa1d48d08083a8c7548144dab55ee`  
		...
		Size: 508.8 KB (508758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42785600d8ff5779609ed0a39fbe64ddc7972bd9d89864814dcc193959be2c17`  
		Last Modified: Thu, 03 Sep 2020 20:53:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d89ce78f453d50ef9b2419ee50b8861b79c309ffae8b42ee1b367f8364a647fd`  
		Last Modified: Thu, 03 Sep 2020 20:53:50 GMT  
		Size: 20.5 MB (20535294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
