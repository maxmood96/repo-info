...
```console
$ docker pull drupal@sha256:9500aa3e8015b9eef39a928a1b7afa73ed62020a60346af123de217b736c2d92
```
...
```console
$ docker pull drupal@sha256:bc507a6ec6b5270f02d1e0ece558ba49b15758c6b6600b783fc95fdfe62e7f33
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51418576 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13882d5666966a47d6348e0ad21c24516b74d2b534d2fffd8f527b2f6d865bbc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 01:02:37 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 01:02:39 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 01:03:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8db8586df856db82f20e94158ba38294d6111809c21b2b33e59789dec6bfa02b`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:953777285c2f633ee9c6904aaaaf28b73085ab3a16e51c78d9ed1cce7756f143`  
		Last Modified: Thu, 18 Jun 2020 01:04:18 GMT  
...
```console
$ docker pull drupal@sha256:2c40f3ec260f0446158061e724361615a87b4817b114040db17648df9c65b00a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50187582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76997e7b9c7f522c389e8f6ed174532126c517c4447566558e1e518e59665529`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 01:01:57 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 01:02:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3eb829aa283c4b7ef959c04f062a9b91857abc944fc18b3b4e4d55e73a0f1340`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e2b8dddc77e005ac4911cef1eee1f1865ac99caaa9b56e3aef5007551c26905`  
		Last Modified: Thu, 18 Jun 2020 01:06:38 GMT  
		Size: 19.6 MB (19638046 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:34f03bd49519c090d42cd6ab99b5013fb5ab299513a1f54e00363a54542504ca
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51924911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:136b1dc51bcc29d98ea97a4849c560d7bb24a768ff0f231e0bc731c3d21cad88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Jun 2020 21:19:08 GMT
WORKDIR /var/www/html
# Thu, 18 Jun 2020 00:44:01 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 00:44:01 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 00:44:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5d44ebf0145f9350d69d979ed104112edb39d6d933d8d96ad920247382fdc4f4`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e6835c91cf5829308455e676d99f39ffb1841bc0f3568c7300c9c274fb3b650`  
		Last Modified: Thu, 18 Jun 2020 00:46:51 GMT  
		Size: 19.6 MB (19638052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
