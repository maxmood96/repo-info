...
```console
$ docker pull drupal@sha256:02933fffce2ea0120e3e0bd5fa5dfa384980037418fbd20124fc8bca57df2c4b
```
...
```console
$ docker pull drupal@sha256:b195974e7bb0d79b392fa4bcada7a179c0c6846fc4a818229f6a4a80be34b096
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.4 MB (127377859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2b0ef8a0521f068ba9e79f34e67b341959cd9ea45cf7e3edc2e0ee3cd3b2bc1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Nov 2020 20:04:34 GMT
ENV DRUPAL_VERSION=7.73
# Wed, 18 Nov 2020 20:04:36 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Wed, 18 Nov 2020 20:04:41 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:94499ea781dfe02f3a7c7a783c874398c75058f562b23dd343f59591c72aec88`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53fa949befec71e6b6e55a3f9449f27f2a4be784165a3ba44fc4599701fa748e`  
		Last Modified: Wed, 18 Nov 2020 20:09:02 GMT  
		Size: 3.3 MB (3344564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:89870bdf02273e1c5ea565ff60ab701499e023d5ba0a7818187505b3e0b8ae36
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (158008534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ac7d83546ecdbb00e105dd5e9e6d453867bbd68406569d0f080b6c61b0e8344`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Nov 2020 16:50:44 GMT
ENV DRUPAL_VERSION=7.73
# Wed, 18 Nov 2020 16:50:45 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Wed, 18 Nov 2020 16:50:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e06ada71d1a4ed2d32f150fdfb6d07ce963a73657adcc49293f9a7432cc35f88`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e905a35cbc2aa00dc54a2fe815c31a49377197bb43552f9deec30f350fbaff95`  
		Last Modified: Wed, 18 Nov 2020 16:54:05 GMT  
...
```console
$ docker pull drupal@sha256:71ac1a12a137213df96ed56308f60e85824609f0df346fa77fea5b475310c16f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.7 MB (137676278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9e11b53325e83af41c61534a76c411d567343c0bceb563cff6e21366e560479`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:71ff67ceca6912e2bc98c17c5decffed624280f54f90459bf8b0e2825abc7a4f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab488aa1262a676caa31d1d81487b1f666be6bb68995653c7bcfe3574fda353d`  
		Last Modified: Wed, 18 Nov 2020 18:39:44 GMT  
