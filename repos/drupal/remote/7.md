...
```console
$ docker pull drupal@sha256:fb64bbca81b3dc641274c7ef0325025b87e8db5b2c55a01b53d59d893af6c604
```
...
```console
$ docker pull drupal@sha256:bbb70e7ddbfd4f7c9f5f77fd8c62cef358ad1277f510ca0ade4fad6263ebcd3a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (151964610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a401cad19e049c7055647de30c29ad50789e9bcabbbf65af375df4fb2978406`
...
-	Layers:
	...
	-	`sha256:66039d4aaee0f6ecdc13d66e6c693796b468f44d134c3496013dbc1237c469c5`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c53fd3cf0a18cfb28cbe0e91984448be132acada70163fb94eedc54640a0767`  
		Last Modified: Thu, 19 Nov 2020 04:05:32 GMT  
...
```console
$ docker pull drupal@sha256:2c37c06c30cfea5c5ce8bf1990c33dc21c03445b6e4cb37d8e5eda8db6bb3825
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144073649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a386274724da60eccc473bfc72f412c194740e5ad22a9fb72e03c79aec6eac5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 19 Nov 2020 05:00:11 GMT
ENV DRUPAL_VERSION=7.74
# Thu, 19 Nov 2020 05:00:12 GMT
ENV DRUPAL_MD5=85d6033ff4bb1b5eed88909ff692c775
# Thu, 19 Nov 2020 05:00:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ab3f5918750b8629b0493051b1d4f90922bd7b7d86ebc93f2556eb4fa0112b72`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9f13196a49e234ae2259e1a082d41a5f232a982632f3d1805f353759a4afb23`  
		Last Modified: Thu, 19 Nov 2020 05:05:47 GMT  
...
```console
$ docker pull drupal@sha256:c62d83762bb64ec85442b659e4ca3b8d56766f70882e1b8d4873e75511ae075c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163391984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:206386a39e8338e242cf0ddde9c3a1b3461831e8569c8fcddd48ec34fb1834a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=7.74
# Thu, 19 Nov 2020 03:05:05 GMT
ENV DRUPAL_MD5=85d6033ff4bb1b5eed88909ff692c775
# Thu, 19 Nov 2020 03:05:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:550331f09cae48ca93855ee510675854f0db06868df45ecc6b1131394e84d826`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78b97c9a2eb3335a307a9ff39aca1a8d228bbc982b2a665d01cb4565928ce819`  
		Last Modified: Thu, 19 Nov 2020 03:33:06 GMT  
		Size: 3.3 MB (3346312 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
