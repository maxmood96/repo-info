...
```console
$ docker pull drupal@sha256:6d31cdfaafd7884085ddf67100ec6e864b95104cd0f40d4966cd3a04ef77d5d6
```
...
```console
$ docker pull drupal@sha256:73c62b261709f0804d8a08ce9b4b64bc4981fea2e189a19ad0e791337b1b3f38
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168496053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9e5048fe64c418c7971fd7d49a5b70e7bfea50f898aa3fd2eb932e32542fcac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:13:16 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:13:16 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:13:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:13:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf0dfd6400264a5c98ad3aa69a2670d551f3b6d9a90734ef8106a0643c663f14`  
		...
		Size: 692.1 KB (692052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb34f954f46885dd5fa0d1900e3427ffb38c7cd828d6d7aba3b9993200dd726d`  
		Last Modified: Mon, 22 Aug 2022 19:51:47 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6059de78fa4d4ab68109b7c3755d16ef164760f0753fa050da6e1eace0955e8`  
		Last Modified: Mon, 22 Aug 2022 19:51:52 GMT  
