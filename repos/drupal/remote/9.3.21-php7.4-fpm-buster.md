...
```console
$ docker pull drupal@sha256:7a9b4a95a759558f73e5071be1d22615a621d2a65f6c213306e7b70adb1e4048
```
...
```console
$ docker pull drupal@sha256:b9de72d87dae5df31dc7e5a1676f68f679416db42212f5f6b7c7eeb095023c3f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154924463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28bf85f3142adf3c0d9823671fd020dbc6318eb75b5fe787681fd1d9fa75c46b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:16:50 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:16:50 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:17:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:17:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c64d7855fb1cb1d6cef307b17f0438a1e8a9aa8a748c8b355d4d447a6ce6167`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8d9ccd51bfc054e1b68450ff8b377df93e4db7d2c6d8ff0dda065e781ac5d76`  
		Last Modified: Wed, 17 Aug 2022 23:54:11 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61f02776b679a540636a57cb56648382ff78480b8fe66322e6fa9cfc578ab4b2`  
		Last Modified: Wed, 17 Aug 2022 23:54:16 GMT  
