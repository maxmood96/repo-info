...
```console
$ docker pull drupal@sha256:e3800989a989304b213d91d56fa4707e251a2bf7add31441a310fb42e1e80dac
```
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.2.5-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; 386
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.5-fpm-alpine3.21` - linux; s390x
