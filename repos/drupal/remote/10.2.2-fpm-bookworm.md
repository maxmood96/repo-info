...
```console
$ docker pull drupal@sha256:fca557570747a98b3843165b4998cdb4c34e2a56ed5698611f3929ae5e7390f6
```
...
### `drupal:10.2.2-fpm-bookworm` - linux; amd64
...
### `drupal:10.2.2-fpm-bookworm` - unknown; unknown
...
### `drupal:10.2.2-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.2.2-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.2.2-fpm-bookworm` - linux; 386
...
### `drupal:10.2.2-fpm-bookworm` - linux; ppc64le
