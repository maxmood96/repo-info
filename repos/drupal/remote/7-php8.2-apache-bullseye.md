...
```console
$ docker pull drupal@sha256:6e885538d59a28b9730dbabfee6eaa643de2b2479b90dbad9cdf8a2042600b81
```
...
```console
$ docker pull drupal@sha256:01660cd93a51ed83d58b2e005ca54ef5429fa890d5c4b64031c5f5e8cf653b1b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.9 MB (148937236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe558ebbd83a1406e4ce52e88ba2adb3a8d80688720c0370196c87161727cea6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:5b47954f1018580bd81cdbf13e2fb863001a8264190d8c1d8bd5345ba1040e66`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c30d99886e490ebcb842b2e1d193c94c3200856a25042705098ca4440179db0f`  
		Last Modified: Thu, 22 Jun 2023 23:56:42 GMT  
		Size: 1.6 MB (1634135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc98578f90cd4fc66e8144f1a321e3be2ec58353e61012b40098325823efa102`  
		Last Modified: Thu, 22 Jun 2023 23:56:41 GMT  
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:440572974a7cead4e1a1b9f47d2fd1b9d5bd5825d7258d231eb6b48cd0ea609a`  
		Last Modified: Thu, 22 Jun 2023 23:56:42 GMT  
		Size: 3.4 MB (3410781 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3a25ace99e97f07fdccf88d01ce7e15d0372fb2b6bcb3b1e64fc3a88ad750c64
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.0 MB (141018168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7e8f330cac3266a6c74e2ff1ffcbf342434892dc964915703036af716d8f23c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:9e30c917a5b81b8614b61b24ab34fa1779b12e7f6a1453c4c7755defce6cf7a3`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5b5705bf2ddb9910a9cbccdd002963b502f47ff3c7099682167891f33260d64`  
		Last Modified: Thu, 22 Jun 2023 23:38:09 GMT  
...
```console
$ docker pull drupal@sha256:e1f7ae073fddd18349431072d919252a8cd6f024cb0353e6ac2483ecf1eec2b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165784233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c8029ac4a1f3d648fa196006a990ad38b5f3667796fec739c35ed8363a5b94c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:01:28 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:01:28 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:01:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e22e2865de3133dcace3ec7041921fd71e05a326b422a8f1bae3b6bdaf036438`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0aad899ca2c8f0b1d8e8eb1d6d729f6eb959a12df0423ce300973bf2c649f208`  
...
```console
$ docker pull drupal@sha256:a5ad426dda2797f1d29ba76b8cb57e0f0bb985a9a212f72b9a8aab88cbf74553
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.4 MB (174426503 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d3153db1477104350600cbe5dd100d1ca97075e48a71dd338aab1b5abad26ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:35 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:35 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:58ec350cd67e0fef4e8956cad1cb9da06ccd35b33a00781581cd4a24f884975c`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f0cee0e585424ae3145c2646a256fe8ce5a9a1af3f01e4dd674c1dc293f573a`  
...
```console
$ docker pull drupal@sha256:b45635eb1c81cbd4bfbcd8c5f9ac36585db479b2f6588c82cb412d39b6438ddd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.3 MB (148347161 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f817e1d562a2c652f15845e2f5f9c2d9179b131e4d16e0303bf5714c943c6f62`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:04:49 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:04:49 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:04:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:208bb4775137ec3900b525ba96f4ef2bcca177d42b765d29d38615fc8f3a998d`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:916f81d61e8b00db9d0df8743e4798f2f5c7d990146c7d0b84802006a9817105`  
		Last Modified: Fri, 23 Jun 2023 00:20:35 GMT  
		Size: 3.4 MB (3410776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
