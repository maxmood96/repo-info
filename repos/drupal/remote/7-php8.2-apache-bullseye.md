...
```console
$ docker pull drupal@sha256:cf8762760f6c6edd1e0b15a280e01785f5c90901d2df92293f5e590046be56b7
```
...
```console
$ docker pull drupal@sha256:1b60846c7d55fed098c5d372a1f42e6a65f2c6d6995131cdbd99783889abad07
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.0 MB (148986152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2c60f42221dc374c6ffe8250954dd6ef84b7a1b44dde59f888ee83d6892f3e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 01:42:15 GMT
CMD ["apache2-foreground"]
# Sat, 30 Sep 2023 04:34:21 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 30 Sep 2023 04:34:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 04:34:21 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 04:34:22 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 04:34:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fb066a4737bb2ebd57f91b776aea9cc2a00252ccb867da13779538e46ae3057e`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424dee9f0c5838f74b2a1dac644c0403e6709e9aea6fa139f3dae50795abea66`  
		Last Modified: Sat, 30 Sep 2023 04:39:48 GMT  
		Size: 1.6 MB (1634515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a579560935df85e5ed0d593ce31f7d7193b2ddf05f0ca20197c764fab2acd50`  
		Last Modified: Sat, 30 Sep 2023 04:39:48 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0101aa064143a7db6edb9be48ec1567db1629fb5412076fc31d0488682eb5469`  
		Last Modified: Sat, 30 Sep 2023 04:39:49 GMT  
...
```console
$ docker pull drupal@sha256:1ac4e5d148b803468a9e42c0218065ca4d0b7a0a4dba3f4e82316e68ded03f0b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141059556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:700583935fce04cfedbe34b6484a76e4bb3fee98e0fd5382e489e95e4789e807`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:19:32 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:19:32 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:19:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:16606a284f41092974a3ed3fffdc8c3f482f866b9c15cc32cc0f7c06e3e2e030`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e83b15403ce7e6f81f5ab5988739d64ca140444c092c9163f2e8d6209ea777be`  
		Last Modified: Sat, 30 Sep 2023 05:44:17 GMT  
		Size: 3.4 MB (3410788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5df9a33f347bbc6ceb7586395ec09453db4db2803bf7469dc8ae06d944a0baef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.0 MB (147983190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:095c7517b3ba69e0bdff679102c14c7423452b4fcb90e6018c68dc5296951cfd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 21 Sep 2023 22:24:01 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 22:24:07 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 22:24:10 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 22:24:14 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 22:24:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:572a696f153e2659917c3f0e104912ea837de8fe9784ad49c899ebb7fdde8264`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5bbad6c669d7bded841c9f8aab8bc97080185611083f016c1316ba90adce565`  
		Last Modified: Thu, 21 Sep 2023 22:46:37 GMT  
		Size: 1.5 MB (1517571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6a043a38cfec03233284f5964f49c29917073ad1fd098304021854ad275da98`  
		Last Modified: Thu, 21 Sep 2023 22:46:35 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56db494d0a69d1a69ec2167186a5102240debed5fb1a0542f46615aef42d19cb`  
		Last Modified: Thu, 21 Sep 2023 22:46:39 GMT  
...
```console
$ docker pull drupal@sha256:221eba9439620e13a03ff8a8e6dc08c13eda14f228a0994be8582324d6acadbd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172026318 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aecd56d64755b29a952c4a9a72e1a1a81d2854d3354c9ead2ca029783e7ce1d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 10:01:21 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 10:01:21 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 10:01:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d9c8c89c6d40bda2b5ef832bf72c68289e54e643f51b65ca6ae7b4c1f63bd5a4`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f17330d97124e9d356ab3a78af78566e674921a8eba138d1790fb0c04c21ab23`  
		Last Modified: Thu, 21 Sep 2023 10:25:02 GMT  
...
```console
$ docker pull drupal@sha256:a98217feca61fd4c5af3f0c3f86955f6eb9ce31228cceaea86177cf4b8c139c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.4 MB (148381973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cad3a6b59cfc048d8ad39e8ccadd22edbcc602515b595a6348e658b4ed38e9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 20 Sep 2023 13:12:10 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 20 Sep 2023 13:12:10 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 20 Sep 2023 13:12:11 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:73160cf4e0598f43486089cabf2cc3029b6411cb0c5af725926ac359c03ce691`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:707fd871482a65fc6de6c371cd9c07347e87198a1ace1d2ebe9961d80de22052`  
		Last Modified: Wed, 20 Sep 2023 13:25:50 GMT  
		Size: 3.4 MB (3410786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
