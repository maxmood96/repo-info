...
```console
$ docker pull drupal@sha256:071336fa98cada5d4941558b36683719ebc92098e4745f82ada312768561cd96
```
...
```console
$ docker pull drupal@sha256:06dbdca141a7407607d54c2da51dc44167d30ec5afa012764aff237fd23d672f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172012668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b400288983f2a55b700b9ca2e0810ae5848e48e92c8c1b80fabd162e85a095a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 29 Jul 2023 05:48:37 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 29 Jul 2023 05:48:38 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 29 Jul 2023 05:48:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ab536422857c09dc320dd80fb88d8fc43cdae28749ca93285a5df574ec0b1a10`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc0ce659729c06418005a8c59602c6c140401dc9b269ae81fe3a1be20d5dd165`  
		Last Modified: Sat, 29 Jul 2023 06:26:03 GMT  
