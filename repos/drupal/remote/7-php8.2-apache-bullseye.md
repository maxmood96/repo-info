...
```console
$ docker pull drupal@sha256:c504126a6bbda560f674406d7a3ba3069afe8de9ab28b8f4b29ed0c776dc93d3
```
...
```console
$ docker pull drupal@sha256:c35a677ca9048b7a7d5d0ef0be940810e2f32fad414f3a17b479781c1a45debd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172024619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c198f3b749fadf3ccef907bc7ff793493e6471ddf046b70becbd83dcabdbe7cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 11:26:00 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 11:26:01 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 11:26:04 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b23c9df8201454c766d81f0d4dca12febbb3cb677161028f3e403a03808cacc1`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6173031b6ed15a87bba4d04be53f194de0d56a36e8dac7d63c8f85891b7b2c0e`  
		Last Modified: Sat, 02 Sep 2023 12:13:26 GMT  
