...
```console
$ docker pull drupal@sha256:d035fc7ea8f8612f3a4ffe7ce29a6a9cde2b309e4097b2d2421442d426daa062
```
...
```console
$ docker pull drupal@sha256:d6f0f6a463e47a18e94cd494ec0ac0fccb224556b9f04612e95f1103eae85039
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.6 MB (171629066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78d2748332d534e0e87e2f8e5eb72810ecf7a232d19bbe9d44900b90b3ba878d`
...
# Thu, 12 Oct 2023 19:56:36 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 19:56:36 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 19:56:37 GMT
...
-	Layers:
	...
	-	`sha256:24cfc9f1bcd5d90a155dc42d01dd19f86af81c912c53332a891cd86d0ee6de93`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32470c1ebd5ba699545cef83038be68bc6af9c9faab0a3b6a3697ee4a2bce5d3`  
		Last Modified: Thu, 12 Oct 2023 20:15:39 GMT  
...
```console
$ docker pull drupal@sha256:58771ab238114162510eb524ceb0412277afba48a31b2611e1f8fb7ac5f0f32b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.0 MB (148004166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13d0684d4a860259696ae43942640e1489ce50817974fe546e777183394151a9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 13 Oct 2023 02:08:41 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 02:08:47 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 02:08:51 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 02:08:54 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 02:09:04 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9a53e378b6fb632a6faf7ae9f5cba71a9facaf57c6a99c553a057a0a4e88e901`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7d711b505dc652253f633f0ac4edd6e147d57ff69311990d462a34a6a30ce2c`  
		Last Modified: Fri, 13 Oct 2023 02:31:04 GMT  
		Size: 1.5 MB (1517556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7812cd826c0f3bb40db50fbd83f50abeebc5c794d1d8a9ff71da10258674499b`  
		Last Modified: Fri, 13 Oct 2023 02:31:03 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b17767eade4778994bdcfdbb47a081d764d835d20d60b854dbbf585e059ff020`  
		Last Modified: Fri, 13 Oct 2023 02:31:06 GMT  
...
```console
$ docker pull drupal@sha256:e44ed43b031882754dff8aa829c1e592530e8f110c283e38954c2b7be409f23c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.1 MB (172057650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7c5e6847d2c1612427c97d86057efaa56e06183adbbdeedc07a897e77ed2de2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:36:17 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 21:36:18 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 21:36:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:41cbaee0afd6c042039da2b203f668bc91057a6f25259022361688e498158361`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:537a078f46d8d8f4c0e6dd6cd9fb3232bfe5b7fee4bf8c63a834a5e9f8617a1b`  
...
```console
$ docker pull drupal@sha256:b0d1173d077e5826158765931d766575eee1d8fab2b5cd5fa49a794ae553c1b4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.4 MB (148402221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a075c6d02f75941b1489c54464ddd2a1d8c64a4f682b7097018161fffab348ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:28:50 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:28:51 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:28:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7e3af5c0b4b9718b51b57a0528c6cc7a5fd384d0bb7ff7b46f5ddc6c7dc62acd`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e653250be93dc66b49bdfffd5de4361bc8b9b1e316cb63bbabafc53b760e981`  
		Last Modified: Fri, 13 Oct 2023 03:42:36 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
