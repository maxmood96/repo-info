...
```console
$ docker pull drupal@sha256:a3431eb566af94790907f556c682850e19a2c29fb79e88c61615fe754f49985a
```
...
```console
$ docker pull drupal@sha256:fbebd9b17798a19557854d96e0c12a301dcb3d73001de5c47bba4e98fa245e98
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.6 MB (171607241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63a76e2f17c5ae4463e3ad1b116cd02d97a2738928dddd1170a139abb8ad3ee9`
...
# Sat, 02 Sep 2023 09:36:03 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 09:36:03 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 09:36:05 GMT
...
-	Layers:
	...
	-	`sha256:2e2b35f7ba34fa29ffb924a3b53262eea387396949c6a56e4947ff540a3f3482`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:833a21b1deb4163172c34459ff353cf9ac59ce28075c0839b917fee7ff57b613`  
		Last Modified: Sat, 02 Sep 2023 09:55:04 GMT  
...
```console
$ docker pull drupal@sha256:72ddbd1020c56ca657742806b1ab7201464064da3fa17c1aa213a825f8ceb013
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.0 MB (148971916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c965dc12de06107ac4ee7d25615939bef1281ede1d9bcf3cbead56752662a54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 03:17:51 GMT
CMD ["apache2-foreground"]
# Sat, 02 Sep 2023 05:01:00 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 05:01:01 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 05:01:01 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 05:01:01 GMT
...
-	Layers:
	...
	-	`sha256:b76e879c7d6223d8e6539a39a966e3651dd2a935221e40fec6cb89fb9e98fd3c`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:378361134ca7c6193cfd35a59ab85a358ae0f6c6bd4ad3466909345c89b34c01`  
		Last Modified: Sat, 02 Sep 2023 05:05:23 GMT  
		Size: 1.6 MB (1634235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd05a3c79a65c56234e0021fb5e06c55a6395a8695c30bf4eb1d920e5a797418`  
		Last Modified: Sat, 02 Sep 2023 05:05:22 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ede371670f643227ddce31d1b64f72ddfbb9649b19bdb8ddbbb2c8280463203e`  
		Last Modified: Sat, 02 Sep 2023 05:05:23 GMT  
...
```console
$ docker pull drupal@sha256:ae1e85c2629b7926d4ad78d1825d4209cad469a20941ff19ca973535066e0353
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141054200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:063bf48d5b5255e72c843b39540d1341a49ccec7be7714445558c9a42d7e2dd6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:7c878e39f73f95d780982c4e41b40af146cacff85a789d062e9c0b30e4019426`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4ab1e564c5d44709aba2d91e90c8a977cff87ec24372059f2bf324d9fb388f2`  
		Last Modified: Sat, 02 Sep 2023 06:02:26 GMT  
...
```console
$ docker pull drupal@sha256:b5ba5287c124e46007ce6160a7347ae265f4811e760d63df38adf71ef9120134
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165817004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:012fad17ff15df5662792e86d12a32d9bd5d5218cd2ccce931525b0216612511`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:30:33 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 08:30:33 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 08:30:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4b4b861a0ddcd3ef1d6a5c8552a0235a67820a7ec1894b613299e23a1a0273c8`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:454f61bbc768f5c272b14f4bbb6a3092105a1ac46c03207149bbe9bde95fdc8c`  
...
```console
$ docker pull drupal@sha256:9f0b2b7d6285acc2a46c52568a6f8326474d8756016eadf014058d9beaac2c10
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.5 MB (174473248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bed65e8f730ffbfbab1140eadab2be35bffd4edbc802d2562f8d27767d720932`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:11:57 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 08:11:57 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 08:11:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d75d7a44cacb93cb3a9af152f3e453e88d2bcbce497aa489b45c3a06d29a535b`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b0653d4648a4eefe9fe4983cd6658c29f5ded0be0210e43ee45bcaaef9256bd`  
		Last Modified: Sat, 02 Sep 2023 08:34:54 GMT  
...
```console
$ docker pull drupal@sha256:4da32b07b13297adae8699e52e99eea45f6418de024bd31c7f069043a3a4b09e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.0 MB (147985898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:309f7f9f6bae84c22c9b5c6e94315ba103a479ace7d1aee4332a1865a646b1e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 02 Sep 2023 10:35:40 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 10:35:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 10:35:50 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 10:35:53 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 10:36:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:849be6d54bd205bb41729785d1439f01b2af6da2f5e39aab96c5fffd6c5d572c`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a526a611c60ac2925c6451475e36efbc3a4f326d1bc510125d623eead5e272c8`  
		Last Modified: Sat, 02 Sep 2023 10:51:12 GMT  
		Size: 1.5 MB (1517183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e7ee3606a2fd66a2b2b3b12e8be7a6f781f7eb30c74a78c8d0b1eab7caf9b1b`  
		Last Modified: Sat, 02 Sep 2023 10:51:11 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5670e111a6a355330de8f06cad76d02cd5a794c80cbeefdf23ce8af5652ef527`  
		Last Modified: Sat, 02 Sep 2023 10:51:15 GMT  
...
```console
$ docker pull drupal@sha256:225233934b668795efa0ca17706788e140c684d9fd329a92b20b1ce9b223a6fa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.4 MB (148379118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31abb82bffaf31c029616500dcbc9f49dc34e338ae567b65bbe85ffcd2f7e850`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 05:35:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 05:52:16 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 02 Sep 2023 05:52:16 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 02 Sep 2023 05:52:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:227a8214533a4c49a61ee8397c0e7a60d3cdef01a4e5bfe69292ddceb7bfe501`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9d6e56111004df6255d723b808c56d44d3bcc43eefd0e394a2a6d3760bca0de`  
		Last Modified: Sat, 02 Sep 2023 06:05:33 GMT  
		Size: 3.4 MB (3410783 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
