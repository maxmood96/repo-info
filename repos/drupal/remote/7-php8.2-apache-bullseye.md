...
```console
$ docker pull drupal@sha256:c94111f5c6fc8ede2a7d56bfb558ae5cbbf30b91daddb227d76db320ae4b8653
```
...
```console
$ docker pull drupal@sha256:ec5567a3bd8fc82a88a89922aab8201f34cf1a6e69c066e71dd3760889c4397b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.6 MB (171569638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28209f294b1616e6353aa6f9218f346382b41d9b0d5a6589cbcf55d94cd9bad9`
...
# Wed, 05 Jul 2023 06:21:52 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 05 Jul 2023 06:21:52 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 05 Jul 2023 06:21:53 GMT
...
-	Layers:
	...
	-	`sha256:5090d7b2e2e46d8f152500d6074ed94a65de238c551b4c9e10dd6cfdd1d20310`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32f0996c74c86f785b09a06cc27369a4542b43406c2bed80a0ddf9fd4035f1e3`  
		Last Modified: Wed, 05 Jul 2023 06:39:36 GMT  
...
```console
$ docker pull drupal@sha256:09876bc2b8ea90ed72698965a8420bdec0f063950d022ee6316ccd9ae7c0e74f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (171988822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:612b10d6e0d9b169b6f9a285e93e3a8c3967d6466ea0c366627937252db8172e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 05 Jul 2023 09:54:04 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 05 Jul 2023 09:54:05 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 05 Jul 2023 09:54:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:945e5a1e038212b4548e4c850e76608e9be723b48c786151423a494e84f373fe`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb792d1b6572ca96f134c401796bea2c2e7534ecef9a2e7b321a7a4e6f0dbc19`  
		Last Modified: Wed, 05 Jul 2023 10:37:11 GMT  
