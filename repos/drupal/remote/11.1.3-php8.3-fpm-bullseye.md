...
```console
$ docker pull drupal@sha256:18a710f618637624776fa62abe91946909fbb387b207d26307acccf3cbf6723f
```
...
### `drupal:11.1.3-php8.3-fpm-bullseye` - linux; arm variant v7
...
### `drupal:11.1.3-php8.3-fpm-bullseye` - unknown; unknown
...
### `drupal:11.1.3-php8.3-fpm-bullseye` - linux; arm64 variant v8
