...
```console
$ docker pull drupal@sha256:53dbab2bf57098e2fad09831077cd0640cec9fc71b4c6eb00ff05601455c91c4
```
...
```console
$ docker pull drupal@sha256:8e2f9b099e93b1f6b28dfae715c4813600fb93d32942d1b3a42cc29aadf39a4c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141127390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40b1ec687755db41e7325ff0feeff102a8f70ccb287ff3fd18e1259f80f1733b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 05:59:59 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 02:00:36 GMT
ENV DRUPAL_VERSION=9.3.17
# Wed, 22 Jun 2022 02:00:36 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 02:01:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 02:01:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb54a89a46d483ddc1b4a5a9eee70df125aa5db8582e5be864102a65e754512d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20bc78ff4771e9268981a17b3d10f19684c41f1ba9fd5ad3eb55651a9b91dd2c`  
		Last Modified: Wed, 22 Jun 2022 03:04:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:257394956e5e9e16f1f706f38058fe09dd5c649857a07853bf6e601d71f20af4`  
		Last Modified: Wed, 22 Jun 2022 03:04:46 GMT  
		Size: 21.2 MB (21215250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
