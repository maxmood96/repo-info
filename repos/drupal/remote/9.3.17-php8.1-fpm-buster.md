...
```console
$ docker pull drupal@sha256:62dd27a0001efdab4cb0fa802b9019a8c64ac84d27cfb35b0b7f0a38d70217cd
```
...
```console
$ docker pull drupal@sha256:e30b2c950a4511f73b8186b7bbd3d6f6f8e22b29f071bc54bbbe0aa8d37ab39f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175462736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd043bed49fc9216faf0279b995d3449494310948959565c4b56e03a03725ee4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 01:01:52 GMT
ENV DRUPAL_VERSION=9.3.17
# Wed, 22 Jun 2022 01:01:55 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 01:02:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:dc98765904568aeadfa5401cebb16f839c4f5fdf4df4f2340fea21fdcdd4fbfb`  
		...
		Size: 669.8 KB (669843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c9550ba592fa851292dc4bdea9dbbe3fb746a3f2badf4968450662576134e8f`  
		Last Modified: Wed, 22 Jun 2022 02:28:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:608734be3b384cba87ffd229a14b4b564edc2fa79eb2c4335b6fa153c67ef06f`  
		Last Modified: Wed, 22 Jun 2022 02:30:06 GMT  
		Size: 21.2 MB (21214182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
