...
```console
$ docker pull drupal@sha256:3c3f38c0c459629e751776149d801578bf469b848a534e7f7d94d3ae9817fcd8
```
...
```console
$ docker pull drupal@sha256:d9e20507d718cb394054163621725cd44f39f2879e463dc326790d70c966c2fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180783341 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8d2a336e6c2e03cbe1d38ec3ea9a28c3ca44234cbd1b3da6614fb2d91a0f640`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 04 Mar 2022 22:22:42 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Mar 2022 22:22:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Mar 2022 22:22:45 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 04 Mar 2022 22:22:45 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Fri, 04 Mar 2022 22:22:46 GMT
WORKDIR /opt/drupal
# Fri, 04 Mar 2022 22:23:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Mar 2022 22:23:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:46f65587c3ab4c811cd32a0bf8f323df1318fce4d7fccf0e1e9b84f4933150a2`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:188237c54670f5a4c37d9b410e0ebc61bf1307a05f58dadcf84c9cfa0c0d2a3c`  
		Last Modified: Sat, 05 Mar 2022 00:31:29 GMT  
		Size: 2.2 MB (2180476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6209be273f7d03f056cd70b434d96c6817e23b9be63d220900f51a626df2245`  
		Last Modified: Sat, 05 Mar 2022 00:31:29 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb5f0da901e17aefadddd7ae64f0fc187597dbd12b753940cdd8ea72b9dde1f6`  
		Last Modified: Sat, 05 Mar 2022 00:31:29 GMT  
		Size: 575.3 KB (575347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3888b17803399a56aa562b8bcae066f98c79065a03e3ab340f226080e04fc90c`  
		Last Modified: Sat, 05 Mar 2022 00:31:29 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df5b3bd8329588ef0ea8789b06f52bdd247597eb9660827a705f7f8b602cb2e`  
		Last Modified: Sat, 05 Mar 2022 00:31:35 GMT  
		Size: 19.1 MB (19136559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:4816b5cf9dcc2780eb8b6f1e2818b580bb1bc68653087f9553ab4b03b54f82b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164015438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24a0654770ea86aabd42e66285463a3356436773444647e7cf18a7fb893785b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Mar 2022 22:02:49 GMT
WORKDIR /opt/drupal
# Fri, 04 Mar 2022 22:03:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Mar 2022 22:03:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3fa9f5980984816229d1fad9583bca6a5eedcbcc8348ceff799f44df3283f3de`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6ef721ba24589800db5fd6afa0ae7cb094ae460f030bb4083ad2d14948b7f9a`  
		Last Modified: Fri, 04 Mar 2022 22:22:47 GMT  
		Size: 1.7 MB (1727409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32b2693d74897d1cb3a6f83cb50acf013e441e7bfba0513461aee43279ab806d`  
		Last Modified: Fri, 04 Mar 2022 22:22:47 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f9f96e8d92f1018e3a79cc5c6618482dc0f78936914e3b61ef1ddd64ed7e2d8`  
		Last Modified: Fri, 04 Mar 2022 22:22:47 GMT  
		Size: 575.3 KB (575348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f28158947935cf0dfcc085b528fb94865aa1b05fd2afcbe025bff9bd48cd0ce6`  
		Last Modified: Fri, 04 Mar 2022 22:22:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e37ed85bc49873ac3467c5f5a783eb3fc1b2ac5173a46e34fabf88fea06c0fe3`  
		Last Modified: Fri, 04 Mar 2022 22:22:50 GMT  
		Size: 19.1 MB (19136401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
