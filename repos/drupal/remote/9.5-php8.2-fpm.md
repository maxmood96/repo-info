...
```console
$ docker pull drupal@sha256:3c047eab86f6121eb1193688238c4eca232565cb2997f4d8bc85d3177d793d2a
```
...
```console
$ docker pull drupal@sha256:bef196323a7b3d523723b3c09baa876ce31b06d5eb2353df45529c4a7ef2c632
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.3 MB (203274206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d302f56c1e9b443d42daa2f2851aae42eff56289a44ff77dcb35163cf26e2a7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:36:19 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 05 Sep 2023 23:36:19 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:36:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:36:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c605553684d588ff61cd0d0706c198e5a597eb86926995bac2a1156d99af5452`  
		...
		Size: 703.4 KB (703372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1beab63f61c1a3064cf8e92a830ddbd6a2d644a49b1cdaa208e543041203845`  
		Last Modified: Wed, 06 Sep 2023 00:07:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2910d8c0476d157859f7895ff40fa8b25e9b312ce49212af4ab3fa72ef971ebf`  
		Last Modified: Wed, 06 Sep 2023 00:07:55 GMT  
...
```console
$ docker pull drupal@sha256:60970243ff357fa5a2ddf6dd3d3293ec1ce70ef34d75886574cb65f706f5b38d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172709608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57e006f280a5fa6cf58060e8c1f0a5913769d5f4d75b8abfcdc5470806bd73b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:33:25 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 05 Sep 2023 23:33:25 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:33:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:16724098c1e8eb4a802ea702e6d3e1df05a8eb6d0a6f7eed544c5a4ad8889825`  
		...
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:672972ac5b434adceb8e9dfeebdceb0569c789d650a2f86e5031ee66e862a6bc`  
		Last Modified: Tue, 05 Sep 2023 23:54:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d707058c627f4a587f8c56e40e53ac7efaed799dd5f998eedfff37c2f55618`  
		Last Modified: Tue, 05 Sep 2023 23:54:11 GMT  
