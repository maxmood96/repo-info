...
```console
$ docker pull drupal@sha256:e5748f6f8ad951dc06bf87a8b88093c0e5216adc27af387dd6713533cb53eb88
```
...
```console
$ docker pull drupal@sha256:4a58b01e091784453359ed66594d3d28b9907d545ded8ff574e5d2ec338e731c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.3 MB (203276257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57beca577fa1769b064128b236f8d9d3bf46b3e5efcf199bac0de39308b7436c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:46:31 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 29 Sep 2023 20:46:32 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:47:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:47:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:08f421449f174c6fa083dd94dcf03a2ab00a95d9a22334443f3425c901d448d5`  
		...
		Size: 704.9 KB (704944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cb5afa4569d303fcd5a76df15ba7a6d481c85244c336e1a62df748698695ca9`  
		Last Modified: Fri, 29 Sep 2023 21:21:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2776756b15f544c0822e5444d7a4e29e63107c97f717a3f1a89fe312c7308404`  
		Last Modified: Fri, 29 Sep 2023 21:21:58 GMT  
		Size: 22.9 MB (22880417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5-php8.2-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:a0012fd028696e553b0df0b8cc484cb18e83cf1177e4ca4f4c4a9d612736c8ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172713367 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf3e800a0fe530c76af00629f0979c81e33c4d5f7708c28fae3b54e0cac4652f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:59:15 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 29 Sep 2023 22:59:15 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 22:59:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 22:59:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eca634f27eae239bf840aa82058168ec459d1601815b470dc4436d2bbebe07ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d474ead4712dfde6215ef52558f80d44d22afe2e93245ec07ec6531f9b1f34b`  
		Last Modified: Sat, 30 Sep 2023 00:00:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cc5116d27894e1c9be6c721741a376b38bc55c8f7d6e6b19691a4b429891bc9`  
		Last Modified: Sat, 30 Sep 2023 00:00:40 GMT  
