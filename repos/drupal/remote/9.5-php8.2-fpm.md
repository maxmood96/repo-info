...
```console
$ docker pull drupal@sha256:d3d7dc2ea2f4e2c3de8ca2fc5cd30f25f903e59df1bb82026ddb595b192fc00a
```
...
```console
$ docker pull drupal@sha256:cc2186a80363786e6f20c36afe8b4d4a340179b007d505c9e91a43f8b7bac1f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.4 MB (193404640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd0ce5eef292e1fd9f23e2773d976fd90badb4e6dd24aaab174f1ba5f95e86ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 21:15:24 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 21:26:28 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 21:26:28 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:26:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:26:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:51d34e09f12ed7555ceb46a26a42bfaa3d4c05127b8215f0cc72777b5ac78443`  
		...
		Size: 698.2 KB (698243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e6c1f7943de4edff8fe808aaeda2347be47ef032995a24e3288a99cb34da2de`  
		Last Modified: Wed, 16 Aug 2023 21:43:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3c730040f5dc2ba30d7faf8c0316f922e48fd4fe00eeade2815edd865faf14c`  
		Last Modified: Wed, 16 Aug 2023 21:43:29 GMT  
...
```console
$ docker pull drupal@sha256:13c6870e63f8624ca6f53cabac2ffcda2a22025a30e9274caa36c8315dd5ca7c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.1 MB (198141456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af14c2d71d853b2b09dbb6414e56c97216bc41537fd2819b84c7453cf4b8cfcc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:06:25 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:17:59 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 19:17:59 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:18:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:18:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2afc62fb1c0023e37038049977b29fdee44082c3074bf3d9632ae02eeacc3ab7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15039c930dbaf24f15cfd7bbe3af49f1f62b89e65799f2f4d0a32ce6a32768d2`  
		Last Modified: Wed, 16 Aug 2023 19:38:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04b3a2db61eb6e120b30e85b17e0cb6a761560505919d8c030024e96e39b17f5`  
		Last Modified: Wed, 16 Aug 2023 19:38:58 GMT  
...
```console
$ docker pull drupal@sha256:a5a7d2ced5d2114ec77d8894528e5beee19a238658f373869be5725353f83ed3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.3 MB (203272402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f8b3be446c41468bcfddc667e58df64d8817c2902f2cc52a6bbe87a1fb8d15d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 23:07:57 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 23:23:29 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 23:23:29 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 23:23:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 23:23:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:10ed528da83d67e661ed27fa60209687ffc26691c2995aea7a763497b812b431`  
		...
		Size: 698.2 KB (698243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:068b510e5571a53f51f144cb42a33d6fcb978c76c6596f3cb1cf965af7c85151`  
		Last Modified: Wed, 16 Aug 2023 23:53:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c13e36ef627c131ed7f55d017b4b10263ecf6defabf77cb16aa57beb8c804fe5`  
		Last Modified: Wed, 16 Aug 2023 23:53:27 GMT  
		Size: 22.9 MB (22880403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5-php8.2-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:5a60faed2d1565b99be6d8da8dd69c00947274b2ddbaf8df6c433097fd5e50be
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172704016 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e37e9eb725e65a1aa074db2fd28005fb1876efe2f0d788829f44eca2fde6010`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:50:12 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:59:36 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 19:59:37 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:59:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:59:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c194479b88a34fac443f85e0192defad4e3b906a2c650538b35418c4505380dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42c8e935339bf0a8ee8998f0e98665c01de3bdb176aaf15b98a59be9cdd8b21b`  
		Last Modified: Wed, 16 Aug 2023 20:16:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a9cd0aca00f7caeca1f718511dda8c31961e217182466e70431733f9dbb8c8`  
		Last Modified: Wed, 16 Aug 2023 20:16:09 GMT  
