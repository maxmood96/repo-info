...
```console
$ docker pull drupal@sha256:8e0e2568cc63cbade876b2bb48a73aa09f68552fd6b7259d6872c53544fbdde3
```
...
### `drupal:7.85-fpm-alpine` - linux; amd64
...
### `drupal:7.85-fpm-alpine` - linux; arm variant v6
...
### `drupal:7.85-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:7.85-fpm-alpine` - linux; 386
...
### `drupal:7.85-fpm-alpine` - linux; ppc64le
...
### `drupal:7.85-fpm-alpine` - linux; s390x
