...
```console
$ docker pull drupal@sha256:1fc171dc3fe7f7f3093d60f19653d2ab9b786e278e9a02feed0a311d695242d2
```
...
### `drupal:11.0.2-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:11.0.2-fpm-alpine3.19` - linux; s390x
