...
```console
$ docker pull drupal@sha256:171b8861508e75af98a0f491596a96bb4ae0a4e20dcc451f63e33de493a7d4ef
```
...
```console
$ docker pull drupal@sha256:f8fc6c21d32e27990718eb2b3fac04863f08d248acbf253ebed691afff91b401
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.6 MB (140641436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4735f781153cd2f8e8067e50828e78059b52ffb8ed90c9e4fb1596fad7d22c10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:10:05 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:10:06 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:10:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:10:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb9b3c2f2b7b22ff23c2e853388c19bfdb4ecf5ef660b73a5b1f4bbf6ddfe22d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:565d98be6e995da92c8d961f9f356e1de14fbc4aa5281d6c35dbf7b13e3564cd`  
		Last Modified: Fri, 30 Jul 2021 04:46:24 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9be9c34d432fea7935f69ff5ee52e9d1c67db5f4a57226efd576f64715ecc995`  
		Last Modified: Fri, 30 Jul 2021 04:46:51 GMT  
		Size: 18.9 MB (18880342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9879ba5c02c088652f89a63035ec1bf59b4b2e00375df4a73df2ecfa1ae79608
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.6 MB (150579726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:107c9af187d13b25546a184d898b9f2f3c591f78a00f3fe0f0803e9429e9f2c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 03:26:31 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 03:39:25 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 03:39:25 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:39:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:40:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fae7f3d5a8ee71a7e8f57dfd15e29d526578ea619e3e2ef389b02c60b11931ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faddd5dafbee9f33ade4e96c6cd330ae9474254ef75306f427ba7d0e67f1a397`  
		Last Modified: Fri, 30 Jul 2021 03:58:29 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:003630446096f4fecc659b930ad0af36a7762d0ee2b7e95e59df5ecba8733269`  
		Last Modified: Fri, 30 Jul 2021 03:58:33 GMT  
		Size: 18.9 MB (18880088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
