...
```console
$ docker pull drupal@sha256:5a15eedf3e31fb39028f502ee4ee5f2b73743c95037a5a47c8d2443f1a993ef3
```
...
### `drupal:9.1.11-fpm` - linux; amd64

```console
$ docker pull drupal@sha256:724d03833a5366c5933419114e04cf90189ca1695b0ca8532accb1e9d09bc257
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165518802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2f082fbdc29e0c5f61ffa2452cd84d03db49109a42bd4c4443dae7e95eb46df`
...
# Fri, 23 Jul 2021 18:39:16 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 18:39:17 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 18:39:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 18:39:36 GMT
...
-	Layers:
	...
	-	`sha256:d25766b0d1ea8009f894b459466e6c57d9fc9d0837c97d115a183cba69a0b0a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95991cbc924e607f4916678cfc7ab6af83c38ad9b58d3b2f04b7eb211a3d1c62`  
		Last Modified: Fri, 23 Jul 2021 18:53:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:096e567366649ec915fda11136b7b7952a625ba0db5174df0171b5c35212e43a`  
		Last Modified: Fri, 23 Jul 2021 18:53:55 GMT  
		Size: 18.9 MB (18880153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-fpm` - linux; arm variant v7
...
### `drupal:9.1.11-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ba66e51f0c6933ebb149d86af9c3d5df3c773ecaef8593fac7756cf3de063237
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (157035533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:978fffb4d996eb32aaf96051834df163dbe1b913fd957989eae16d9cf918677f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 19:30:34 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 19:30:34 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 19:30:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 19:30:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d49b21162b0cf3af8c033a7d3cf574b6452ff4183d579880a67b7519ead4019f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9ccb6e3406ef9a85bd4c4b8a3bdb8bd70a47310b23cf09419aa6a70c641b8fd`  
		Last Modified: Fri, 23 Jul 2021 19:49:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7fedfc7ad5f857dacbb3a89abea1f2156cffd1103e1d8732305a13c1a8216c6`  
		Last Modified: Fri, 23 Jul 2021 19:49:11 GMT  
		Size: 18.9 MB (18880141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-fpm` - linux; 386
...
### `drupal:9.1.11-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:b474eb9ae37feac1f863298d7088045f062dd2bb90f49d2f2e73afb0e3a4686a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175810817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21d75b069372f43fa123bc948548db94806de4fa1f2848b64e850086187266fe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 24 Jul 2021 05:58:02 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 24 Jul 2021 06:06:23 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 24 Jul 2021 06:06:26 GMT
WORKDIR /opt/drupal
# Sat, 24 Jul 2021 06:06:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 24 Jul 2021 06:07:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:341c7872f1c7318f0071216770839903cd394fbe0ab36fa10a75c4b1b8663813`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e15bb5d78b0f535536ef92dfe7c25099640821993bd09463df2b624ae7b5917`  
		Last Modified: Sat, 24 Jul 2021 06:21:27 GMT  
		Size: 553.9 KB (553917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc12c59ea70e38cf35c6fe16866668e65c7f9f0ba26dd2c46eaf64e7b10a489c`  
		Last Modified: Sat, 24 Jul 2021 06:38:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20e7361cd5d5c424150e2eb26f80baa28eb2b8dee5a92ee5284378846e35967e`  
		Last Modified: Sat, 24 Jul 2021 06:40:39 GMT  
		Size: 18.9 MB (18880164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-fpm` - linux; s390x
