...
```console
$ docker pull drupal@sha256:042ceac13c5190c8b7b663d0fa21eacfbd8e85c0fcef5b07a1056c1cda1c9051
```
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; amd64
...
### `drupal:10.2.0-php8.2-fpm-alpine` - unknown; unknown
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; 386
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; ppc64le
...
### `drupal:10.2.0-php8.2-fpm-alpine` - linux; s390x
