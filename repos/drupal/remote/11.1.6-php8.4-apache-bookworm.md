...
```console
$ docker pull drupal@sha256:ca0503e9fbd99a62b7aa6d3d0259e4cc5cb8183a499a2e3706415ccdea053c95
```
...
### `drupal:11.1.6-php8.4-apache-bookworm` - linux; amd64
...
### `drupal:11.1.6-php8.4-apache-bookworm` - unknown; unknown
...
### `drupal:11.1.6-php8.4-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.1.6-php8.4-apache-bookworm` - linux; 386
...
### `drupal:11.1.6-php8.4-apache-bookworm` - linux; ppc64le
...
### `drupal:11.1.6-php8.4-apache-bookworm` - linux; s390x
