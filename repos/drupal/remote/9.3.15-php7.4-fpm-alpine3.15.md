...
```console
$ docker pull drupal@sha256:e9c25421f2b6ed7df7c09c2a1386bc47106d53fe2e0894f3de2c6c37de0a6adf
```
...
```console
$ docker pull drupal@sha256:16a684c4b646b132325833183534d3952e3142ee816ba9c7af31af4098afee67
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49436263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6cb1cd89288e4e4d15096d7d4ad937f9d542b613d774f7dfe1538cabebba1048`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:58:00 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:58:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:58:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7914bfec43885ec7e801fbd0e544a01376980fb6ca66b76b40fbbcbac0608589`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:089a66bb0e9d33dc1ec2bccc10ec2882f89901e4c7affb4550f931355cc40fa7`  
		Last Modified: Mon, 06 Jun 2022 18:12:08 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e809f8f38cb5094fe77c43cdd57d1ced235f175dde70d9b53c420762d132818e`  
		Last Modified: Mon, 06 Jun 2022 18:12:37 GMT  
		Size: 21.2 MB (21201184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:048bd2f8381e70d50024ecd0b06b44f2bf216e02b41819f0112e455d8b3c5b4a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (50040045 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d40bbfab4830128d33e1bc49a29126895dbf449aeedf875810e95f92c5325510`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:03:50 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:03:50 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:04:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:04:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae73bb04865ad38a7e98d11159227b71fc9d23b3ad9fd415b0c5a134a6c9400e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0bd1412aa688504d5846f624a25fc0b5156c4b9fb05f4b8fdb034f4c244a63f`  
		Last Modified: Mon, 06 Jun 2022 18:31:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:844c4a247e82143a6cc7cca3e371b2594a037a3adbd0f63ed098449c58d3e9aa`  
		Last Modified: Mon, 06 Jun 2022 18:31:44 GMT  
		Size: 21.2 MB (21201194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
