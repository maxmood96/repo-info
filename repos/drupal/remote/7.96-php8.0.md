...
```console
$ docker pull drupal@sha256:8055471344645d4c663e689c08f73cffe055c6288aba0413f3e30644cc4ca6e7
```
...
### `drupal:7.96-php8.0` - linux; amd64

```console
$ docker pull drupal@sha256:a625826f9831152d46587d0747329fb62dc6a4d97bd6651cdae5eb39c5b6dfeb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169924973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee7de3f37628fa71a6ef0acaf89d4e991236c6308bdd1cc578cdaefe3c96131a`
...
-	Layers:
	...
	-	`sha256:26d393a03a2062629d45328ff88f5306e48960723c09c5f49967b73b846cc04d`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b22fed53c2380107e6f81b0d1692b8ca349d1e174d1925ca5bfa9bc293fbf8b2`  
		Last Modified: Thu, 20 Apr 2023 22:45:41 GMT  
...
### `drupal:7.96-php8.0` - linux; arm variant v7

```console
$ docker pull drupal@sha256:a42b2aa51622a88bace4873611df17344f99712c36f4d83596c1d8a90e520652
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.4 MB (139432660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ac43bb35ffda12376f3a0e7aed05816310e39f6020664366e3a4348c4b0ca5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 23:39:13 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 23:39:13 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 23:39:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:38d3d7d03527db87c5c5a6dd54b7d21ed7dd5f38c29bf259d126868e72839fd8`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d84992a0f54af553c2f49c47fdfa88130b0a1bc7227fbb61a687750982f3282`  
		Last Modified: Thu, 20 Apr 2023 23:57:41 GMT  
		Size: 3.4 MB (3403812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.96-php8.0` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:c41997a4e2bee7fbcf82cc4de59146ef81bf072ac2b341fd17ce721b3f08fe16
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162885501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee72b61e40a733ef673a8a94c1d8f0640fa38991ba37be836a81f918dbcdf635`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:47:56 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:47:56 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:47:57 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:97fa4bf711cebb96f903dcc6f08ebe271587c7b66e8281c1bb5720c3f26caa70`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e3069fe0c60e5d9dd39c10c63c929b8a36f206572f87e5a60dbc10d91001bf9`  
		Last Modified: Thu, 20 Apr 2023 23:04:55 GMT  
		Size: 3.4 MB (3403811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.96-php8.0` - linux; 386

```console
$ docker pull drupal@sha256:053d5bd437ff2480848bb93cd4bb88a178cedb1df7de9ccdac58ff2669e41464
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172749164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5979c82d89d31665e0aa6430e71c96132d99042d5f6c0053b0bee3d7a09d701`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 23:23:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:47:33 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:47:33 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:47:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:107ae7e2c14ac14259290b6ccea0567d8ff7c42fb229198a89f14343fde24830`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10421eb972fd015ddf3491063d81f572efb97f1cd85f658d0b2a1355ce2a50f5`  
		Last Modified: Thu, 20 Apr 2023 23:07:31 GMT  
...
### `drupal:7.96-php8.0` - linux; ppc64le

```console
$ docker pull drupal@sha256:f8cf7da113149d8e6c31d4e529e6417a0dfc0c67fe8d761e84b67f2e93c0c480
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170282812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b792a3fe8fc3c150d65738edfa276306be3257da2317ecd50726f340a66b33c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:32:55 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:32:57 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:33:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a8c4084ef4c915c8e66307720a1e02b177565b354485ec940c1598a30d3d46a6`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f398c5a73f5bd793460b26aed8af0e3afe81af4b2487b8a8768f97687568798`  
		Last Modified: Thu, 20 Apr 2023 22:58:09 GMT  
		Size: 3.4 MB (3403811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.96-php8.0` - linux; s390x

```console
$ docker pull drupal@sha256:dbf639113bdee6c4182f5d627d9dd4284f88d31cf1c67744ed2c64bde3b9aafb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146742892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:292c617138f26c2cf6b5c39240df13e5d2d23c4968002f95e46fd0253bff7c9f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 11:58:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Apr 2023 22:53:52 GMT
ENV DRUPAL_VERSION=7.96
# Thu, 20 Apr 2023 22:53:52 GMT
ENV DRUPAL_MD5=4aa685e8eca141505867f8cbab48b72b
# Thu, 20 Apr 2023 22:53:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fa04125de1324853eba122cc3aea6111e248400ee8f39ef4fe33c0d95639e54d`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1799b1430f5bd6cf866b80461f0e1fee4be5e3c166b53e342940849c24d9ae67`  
		Last Modified: Thu, 20 Apr 2023 23:02:20 GMT  
		Size: 3.4 MB (3403811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
