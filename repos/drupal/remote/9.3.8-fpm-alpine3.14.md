...
```console
$ docker pull drupal@sha256:a518f53603d2a4860fd5d688cc7722530bbbe57134e55efce76662c8ea05f1e6
```
...
### `drupal:9.3.8-fpm-alpine3.14` - linux; amd64
...
### `drupal:9.3.8-fpm-alpine3.14` - linux; 386
