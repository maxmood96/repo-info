...
```console
$ docker pull drupal@sha256:1c74baf59a4dde68b34fff6165a62c1ef9dcf4057381d1e089bd426bb428dae3
```
...
### `drupal:11.2.1-php8.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.1-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.1-php8.3-fpm-alpine3.21` - linux; s390x
