...
```console
$ docker pull drupal@sha256:cd0bbdc5d2bd285e9eab68e1acd07513f50bd9656ea906fc346e73a0bb3102b6
```
...
```console
$ docker pull drupal@sha256:b16ce6346d22ea7efbcc0eb9a9530a98a557d5dfa26f8efd654a4958d6d25876
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145627295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa453b6e425674a837d9e11f8e6870a4de661e9c487892207cb882b11a131290`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 20:53:09 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:53:09 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 20:53:10 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:53:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:53:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bd3a67fcae564c08467cd6bff65f21d5dddef0a11fdd3965b6d34213439bcb29`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fea1382bc83e7cd506f768382c3af06399039ec6e4e9b9d0bdf1faa11001409d`  
		Last Modified: Mon, 03 Jan 2022 21:31:47 GMT  
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:206e95a46052471d588862d489d463eac39067301ea9c9b3f9e240c3363a4c87`  
		Last Modified: Mon, 03 Jan 2022 21:31:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f03fb543a9387d9543bcc320a4760bb04578edc61f6e18908574d91fa4c1c7e6`  
		Last Modified: Mon, 03 Jan 2022 21:32:14 GMT  
...
```console
$ docker pull drupal@sha256:1b03823d3469e5a6b72c48355efff6772a365f3bf7d1e77fb630795aa99feb80
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161750688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b65b3ca5df37552a5d66582773996cfcdbdc382b4559883b1895dbc34f4ba29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:36:33 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:36:33 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:36:34 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:36:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:37:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b130d0076332d2e6df7ed09eee4f90f6638d8911e453f7fe85c72121ba4bd6c7`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f58a17ca272ff95f870624e051352ce953fc550b2d586704b5c209a358d28c9`  
		Last Modified: Mon, 03 Jan 2022 21:57:49 GMT  
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:273925b732f602d648ffec5156c872d25e57f74a625fcbd2f96400e7dbbb702d`  
		Last Modified: Mon, 03 Jan 2022 21:57:48 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f00fb403b8ea4843771c8a3346154b37225fcba625c2120af51811ba15bf584f`  
		Last Modified: Mon, 03 Jan 2022 21:57:54 GMT  
		Size: 20.1 MB (20144306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0266e2a633bfa068bf6e6482eb200561b89bdf565c8e02658172b4efe65126cf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181727040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b93caed9f9c2d11814b31c35ee8e95afa3b3b032a9a36867e3f127a0729440f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:22:35 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:22:37 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:22:39 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:23:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:23:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0106855ded658602d1b2a9ce898b1b23f3d0eaa69ce75617e93af55c3a16f511`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b3626bb3bd94556564af3105d8e7cbc396d4552529d38c8e9ba9400418f7a9c`  
		Last Modified: Mon, 03 Jan 2022 21:51:46 GMT  
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11ca523fd1e1c5a575d7bbdf3522ab777f92883330bc247fcda6f8499a840931`  
		Last Modified: Mon, 03 Jan 2022 21:51:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e14cefbc3e4c67524bfb182ff7d11b1dc53364c427d3ad8f47959b5cc78e307`  
		Last Modified: Mon, 03 Jan 2022 21:52:55 GMT  
		Size: 20.1 MB (20141824 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:82be40e139305b817a1b30d568a555661d8db2cadee1e70e58b7f7975500fc10
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155970199 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:473f2ce6bb4c7e9285c096b32f4e1f6efb07d7bb57939d45ce31667de30a4a23`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:50:39 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:50:39 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:50:40 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:50:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:50:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:08c1d0420ab65fdd3d6643443c6de0c109ea063a53fc6d2864006294e083b07b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ef2c21e60ec5b8cbd06982c2187887c073ef07419054dc29e982521fd9411a0`  
		Last Modified: Mon, 03 Jan 2022 22:08:12 GMT  
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3126497f3fb2ecb23ef11d689f90a7030d3c80f382ac354637ae498101faccf0`  
		Last Modified: Mon, 03 Jan 2022 22:08:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fab3397092a5c3172e0d8a43db321426421ebe6956667a222c99071e30e1b6d`  
		Last Modified: Mon, 03 Jan 2022 22:08:16 GMT  
		Size: 20.1 MB (20142001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
