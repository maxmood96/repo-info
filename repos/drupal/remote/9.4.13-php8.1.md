...
```console
$ docker pull drupal@sha256:9d0f856426963b6f32deabdd4be3022d14a7bf97f642d47cf428ef37a1d10344
```
...
```console
$ docker pull drupal@sha256:f79d2dd35ba659e7370ac160e8c2320b73c621238a58a1e6bdaade7bf7f31b26
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.2 MB (190244426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7350dede0df7a5f0800998a32ae37d1a37ca002146a2be8a79befe35d7d2c14`
...
-	Layers:
	...
	-	`sha256:d2f1aed646bc4579c7b83cfbb3ea5e3f6465882807476d46b6f15e024886397c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bd6bde72c71b3ee4bb06f5b077ed54cbed380a53b09bc2e2618b0e19996db01`  
		Last Modified: Fri, 14 Apr 2023 20:02:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c08a5ce147124a3dc3d4b5e63d7e5e6f91c7178016a5a7a9d39e4ad2a4ca2ac8`  
		Last Modified: Fri, 14 Apr 2023 20:02:57 GMT  
		Size: 21.9 MB (21916904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f3f2449ccc48b781ea293fe3bcd537e8219995bc3ae3c1ea35b57e6656ea42d7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.5 MB (184459234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1002259c42036370f8e9b378074488a79ae392ccf234cca6c1094ae94f3fdc43`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 09:17:10 GMT
CMD ["apache2-foreground"]
# Wed, 12 Apr 2023 17:31:06 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 17:31:07 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 17:31:07 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 17:41:13 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 17:41:13 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:41:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:41:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:480fd68ec41eea8116617989eac3adec0a4ba98c0bf7b0463f80b287834c720f`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3de7b83520c89b420e985a533b55e8f81bbe64c03c36331c6d4b06d7292b89a6`  
		Last Modified: Wed, 12 Apr 2023 17:49:02 GMT  
		Size: 2.4 MB (2398133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3682301ba75adc8e5d4cc0c7e5c4095ff216c74d33bccca74b2a3351e8c3f51f`  
		Last Modified: Wed, 12 Apr 2023 17:49:02 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd4fff43509cc000c5a03a29a4f9f0bb47e90c7ddfadb24eacf8d932d25646c0`  
		Last Modified: Wed, 12 Apr 2023 17:49:02 GMT  
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfd17f978f703848fabce4da79cd9169a9accb166063d2db4f16075c9bfdd427`  
		Last Modified: Wed, 12 Apr 2023 17:54:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a254272f10dacb794fc1efa5c898be941b1439e9be995960ef5759f803dd1255`  
		Last Modified: Wed, 12 Apr 2023 17:54:17 GMT  
		Size: 21.9 MB (21916660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:df9ede5633912b39d68781db9e273034d560f788d277a170a342ef5ce075d58f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.1 MB (193119179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:758bb1b7cabd73459bdba13cbac3bef3aca429193f3ee0915fc259efd7b597e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:27:47 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 23:27:47 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:28:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:e765119355ee48779edfb77cffb144a3373864b3e0ad91e81aadb8efa7f18b7b`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10779825146d566c8f31df9473876dd39f4f7e11e45e6004319b6c15ced63613`  
		Last Modified: Wed, 12 Apr 2023 23:41:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f26c9147941ed06d8d4b3d4d72647967276e11ae82b0a70001e365c102a1c96`  
		Last Modified: Wed, 12 Apr 2023 23:41:21 GMT  
		Size: 21.9 MB (21917054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:8b3687b5ba6e24e4045f4637d8d19c121a97491f99eb5cd30732498fee28730e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190596545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcf0f584482bf9e13c0b05f29b86fea98384ffa8aa64ea30db3f1a0ed4937df6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 19:41:38 GMT
ENV DRUPAL_VERSION=9.4.13
# Fri, 14 Apr 2023 19:41:38 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:42:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:42:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d92a0532bc3a9037cf789faf430ac032b14d76fdd7b6bac6f0a42ff93134146f`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf3dfec59d7f99deef34de82d3c07e7e3c030c8459b44e9b4e872ad94b8bde25`  
		Last Modified: Fri, 14 Apr 2023 19:54:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d935dc9089d3451de347cc2ce8a437691770edfced9fb885e5dc90fe90e31125`  
		Last Modified: Fri, 14 Apr 2023 19:55:06 GMT  
		Size: 21.9 MB (21917120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:2df107bd99e92bdafd5f790dc4cfbd77ab21268d6729d4125544d44f81068dd1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167056112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b793c9b1c9264b2d748c350dcadcb740fe252e724562da6ccb09f9e8f4dfc937`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 11:54:16 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 12:00:29 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 12:00:30 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:00:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 12:00:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:340867a4cc36b6a1188ee1668f0947e73d0de0d4c331f0d5ecf7d869ba4eb23a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f99d66e50c9423ab0b0e71872bb0277e9dabbf52e9ed8c2a6b87e7e6083b04c`  
		Last Modified: Wed, 12 Apr 2023 12:07:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3edccc75bc33d09c54f44bd7d874e245945a59a32bfc1b89905474ff170bfa54`  
		Last Modified: Wed, 12 Apr 2023 12:07:54 GMT  
		Size: 21.9 MB (21917003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
