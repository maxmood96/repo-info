...
```console
$ docker pull drupal@sha256:c495f079c9570b4e4b6d4ae8d6539ef37dd17d79ab4da62bc8b2f3461a598367
```
...
```console
$ docker pull drupal@sha256:5d419e48f908f4dd483034519254fcba0ac96d406b0373f1b39378156b2e2d2e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159740071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6cdf421b5df35caa97226da28fa6238fdc0e3c222718e70d2600c3c1dad47fe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 28 Mar 2023 07:32:15 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 07:44:16 GMT
ENV DRUPAL_VERSION=9.4.13
# Tue, 28 Mar 2023 07:44:16 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:44:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:44:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a1b1d9d38d7d136249569b345960f2b18800c8c68dd616afaeb489872384b6d1`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4603db024bce19a9234ed771b0fa02d43788d8188e90d4bc4143933b20b09ac7`  
		Last Modified: Tue, 28 Mar 2023 08:02:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f95d514edb718037edd37fa1ed8d91cb0e2ed556da681e1c8871ff4684dbbbe`  
		Last Modified: Tue, 28 Mar 2023 08:02:20 GMT  
		Size: 21.9 MB (21917027 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
