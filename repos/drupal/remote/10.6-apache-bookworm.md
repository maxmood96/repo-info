...
```console
$ docker pull drupal@sha256:1d49f50293e38a1ec61c695efe809766e9d0c6581977818c19c5794bb838de0f
```
...
```console
$ docker pull drupal@sha256:7a32a4366b84f2243ba1661b3dc51ae23de34550eb0f2db4b7b015eb0ac266e6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168288990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:432bc770ddf84568cbe7de5cb39e11cbb807fef325c77be3f289ca3c869f0c37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:b332fd0604e577f1f2c9f44d200a583f04dda474b6f9ad4d8d504465d188e011`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:104fc61902b845435c6c7f25dcbfef5b79948f812d7f0ce8e7fe076cd6bfb53c`  
		Last Modified: Tue, 24 Feb 2026 21:37:43 GMT  
		Size: 21.9 MB (21857842 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6-apache-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:75a2ff7049e5a093fec9825e87dd2f7e26681fad68c5a4e498fba508854e864e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.9 MB (6900169 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14b51ed0a98d634864a9fe8fc325c04105c4986195a053c346860c119047e32a`

```dockerfile
```

-	Layers:
	-	`sha256:7938057b958089c4a9fbf9cf1f8baa1b004f3b0208eb932d4c3efe6160bc1bca`  
		Last Modified: Tue, 24 Feb 2026 21:37:42 GMT  
		Size: 6.9 MB (6856735 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1ad7068253706cabfda8a2849b6b2eb10e648367e0cc290be416d93b25d486f6`  
		Last Modified: Tue, 24 Feb 2026 21:37:42 GMT  
...
```console
$ docker pull drupal@sha256:972ac0058b6438367d38868c5075be9a67c1c82d23c6a88cd681a70c4892276d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.2 MB (178152748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5222c3b9aca527ad37ba9675c6b8aca77ead263913ceca79f2693b90cbac79c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Wed, 25 Feb 2026 00:03:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Wed, 25 Feb 2026 00:03:27 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Wed, 25 Feb 2026 00:03:27 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Wed, 25 Feb 2026 00:03:28 GMT
ENV DRUPAL_VERSION=10.6.3
# Wed, 25 Feb 2026 00:03:28 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Wed, 25 Feb 2026 00:03:28 GMT
WORKDIR /opt/drupal
# Wed, 25 Feb 2026 00:03:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Wed, 25 Feb 2026 00:03:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d18c0c5c7e36465e6c470d23116bea07fb42fe248b440c7889dc059760e99cdc`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
		Size: 1.5 MB (1486591 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bf14f95a99c467d804a8149a0c097ae7b5570e7d4eba84c2c62d52f527d304b2`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6246d5c3d331348ae6f582182f45fd79f02451e3a6fb759b40f6a9ae1ee19b2f`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
		Size: 257.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4457aa99b08d882d6ff09fd11629638adb8904807f641ad55e3334559f2cbdb4`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
		Size: 777.5 KB (777548 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:18e35f80019c673e8ffe24a832a32549e5c412955664d91106267d9ceab39cbe`  
		Last Modified: Wed, 25 Feb 2026 00:04:16 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7e08222226ac8bfde59e30f8341c9af521837a7929909d35430337c46bfbb92c`  
		Last Modified: Wed, 25 Feb 2026 00:04:17 GMT  
		Size: 21.9 MB (21857930 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6-apache-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:1e9674c9c7b42472a431aaef13ff583f219b63cb6b03a0a6367e72880169c025
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.9 MB (6923861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:016975375f508c052151adea0448b0424ee23e38b347d24f561a06f66ecaca7c`

```dockerfile
```

-	Layers:
	-	`sha256:03682057fe437e259d0b1d39fc04c5f7b056805f9442d7de7dc863f1f38316b7`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
		Size: 6.9 MB (6880585 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:04ecd47121db7c318b6b0bf0fbb5274c8fa23fc9952b3e11a784cfaf15f743c5`  
		Last Modified: Wed, 25 Feb 2026 00:04:15 GMT  
