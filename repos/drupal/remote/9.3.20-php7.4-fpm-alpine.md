...
```console
$ docker pull drupal@sha256:02fc699a269d41cab95f1d329784e111529773421959b4604236382dc9998e55
```
...
### `drupal:9.3.20-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1a970c06da93ed370331d442cc92ccb0aa8f88e97c1d4f499cab9ab32704f363
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.1 MB (48087088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82043c696dfcdce49c881afcbbeac5fdfe061442349ef92237ea469485cd17ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:22:11 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:31:01 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:31:02 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:31:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:31:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d92dcf89d000984a54f1ba675c10ec675f66a59a5d56352e36c2c6b20a540404`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27a749eeb62142457f0151460cb00b89057096dc2e0f23905aebe921a2dd9bf1`  
		Last Modified: Thu, 04 Aug 2022 10:21:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83bec9f9d2d8010db23807d8434770d7b9a8498468d475d4418c7f61fe12bb12`  
		Last Modified: Thu, 04 Aug 2022 10:21:32 GMT  
		Size: 21.2 MB (21214742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:53423f0c0bea18b3c136cd07e952b6b7e99b3b783ef7ee0f58ce9479c9544d7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (49981239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:188d9bca560563b5bb482117f4b14f7cf6a36b3e6ffa8ff841ac9a3cd4e879da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:56:40 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:56:41 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:56:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:df976a143f5918b0c5053b3dd7c5c74e00624834c114045dff0753473f82a405`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97148141f0be376f9995668f78bfb50bfee8e771db19275cece0f76a467a9e61`  
		Last Modified: Fri, 29 Jul 2022 02:30:49 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32e5c5128167a83a8ec3a8c59bf6810405a40dc1a7090a4f9bc3f1fb09b16e3d`  
		Last Modified: Fri, 29 Jul 2022 02:30:55 GMT  
		Size: 21.2 MB (21218113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:eba81411fe700830182fe53c6aa76ae2599d1e3b7dd9bcfc315cc93d3a32a4e0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50818675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a56930ac0b190bddc889b02f7ca59fcdb2c084c4f1777b7e6ffeded39181dbb6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:53:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:53:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f29bca2e3b671ffa71c16985576c57bf3caef646707df71aa4f50efeace002e7`  
		...
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff85a9a2f6218eb933b9f24a7373a6dd4e61d36bf098ff9afcf95bfa92cab27b`  
		Last Modified: Fri, 29 Jul 2022 02:27:01 GMT  
		Size: 21.2 MB (21218063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:28f3fcf1a0a5aba6d650c1730e979c33a4423b6b46bb4fe728f1198316ef6afb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51232257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e3573e94b06e6ad0bb98cb7790699721c40a0ac6aaf0ecace0f3ba134567ff0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:29:32 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:41:13 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:41:13 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:41:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:41:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8258e33741813a65ffe0a858e5bd55f262a86ced7ecb86d7507f575a227d44d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaebd78f712e1b288a32abd85462a518e19218b65a2a722412b5241afcebd6de`  
		Last Modified: Wed, 03 Aug 2022 13:36:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2018f0aacbae7f1811b500e726f6a5523e4588c5bb4b3ea1792a1ff91e7e5337`  
		Last Modified: Wed, 03 Aug 2022 13:36:22 GMT  
		Size: 21.2 MB (21214968 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:69e045b51ad45e2cb1fce73fe2b20083d94714fd4e2d6118fbe4fd815a2b2129
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49723596 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4122875d83471a64ed261ae10250daade0235638c56712826d39b711bfbacd53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 02:00:34 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 02:00:34 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 02:00:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 02:00:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cbbb4696c88d19d45b07050f75a8eaed0693f3c4a045332ddbc1fd2b255791a5`  
		...
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10a07ac7c0cda12010c984a06c4f57aeeb061f4dea2d71235f53a2981e13265a`  
		Last Modified: Fri, 29 Jul 2022 02:25:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a61e6c9caf29db13d2ce09efa3a62b7426bafa22b24afddec462098ea734200d`  
		Last Modified: Fri, 29 Jul 2022 02:25:56 GMT  
		Size: 21.2 MB (21215278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
