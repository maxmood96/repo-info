...
```console
$ docker pull drupal@sha256:d1e3e7b9ee957de03396a1ab23787e7561c5cde5e94324bf170c58a7b234f234
```
...
```console
$ docker pull drupal@sha256:62f6e71fecd959d4b5ba3b53d861f07a775b67677d6de0f5050fe43ca5b2b8f3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51218270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be441a59226ff53063fae22a0d09fedcebc42e99db57881d89480a943f34da3f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 02:02:01 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 02:02:01 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 02:02:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 02:02:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2f6460b5cf829043d45f13864f549775700f4c6d36b1fa04db3908263c1ef14f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4ba25f530b9a8969589d10a5bb83be5e106606fb3015ab3f780c31012903a93`  
		Last Modified: Fri, 29 Jul 2022 02:54:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d9053c49ae1bcac8fb85530fbc8d2003b13795bd25f51f6400a5984d4d3f3f9`  
		Last Modified: Fri, 29 Jul 2022 02:54:21 GMT  
