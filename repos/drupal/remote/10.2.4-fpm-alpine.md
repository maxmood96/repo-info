...
### `drupal:10.2.4-fpm-alpine` - linux; amd64
...
### `drupal:10.2.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.2.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.2.4-fpm-alpine` - linux; s390x
