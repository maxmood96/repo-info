...
```console
$ docker pull drupal@sha256:c3005a81617dc45f7281efc4fe542d2f6c6ad61e7e13501ef2931482539aba2f
```
...
### `drupal:10.2.5-php8.2-fpm-alpine` - linux; amd64
...
### `drupal:10.2.5-php8.2-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.2.5-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.2.5-php8.2-fpm-alpine` - linux; s390x
