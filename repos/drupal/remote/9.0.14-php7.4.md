...
```console
$ docker pull drupal@sha256:fbb9fcb2fec9b37e5e47c946b5ea7e08c59ca9551ed05e12c9c83e1c5a8b2e6f
```
...
```console
$ docker pull drupal@sha256:374728554fdad8c6d19f24bd2ee3f257af4dae9c0d54a362df1a2af3030e15f1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158638842 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ddc8e91356dd0afd95297480c2b9111c1d3724d14a3556b9d5071149d8a4794`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 04 Jun 2021 03:09:16 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 03:09:17 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 03:09:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 03:10:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:628961aa75b2db90cbf4cac2382bad778c864b14d1c0cd3ba0c20250f854bfaf`  
		...
		Size: 507.6 KB (507623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fa9b947d0c7d362debf65230104960a95ff6cdd423e57e3c733227af2ffa7d8`  
		Last Modified: Fri, 04 Jun 2021 03:27:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d3792f10b4f9ee23f9d04e9ed9d88ffac43422cbb5bdfe8609f1716ab79f2d2`  
		Last Modified: Fri, 04 Jun 2021 03:27:29 GMT  
		Size: 17.3 MB (17273877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ca6edf49baa46af8fc54c1bf4cbd8261a3b3887c5757b9157b768a972315e9e3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152211754 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:087c87ac5d89a805ccbeca644aeed9532121a150dfae3b2cf235086fad3e365b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 04 Jun 2021 00:51:20 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 00:51:20 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 00:51:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 00:52:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2cb46bbab716c45ab21ff79b86789a559ebc1b10ce9eb33cf3d3cbdba66306fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12597575dc953ea097c3951639d27ed79577799b3bfaa54bb2a5299472a735fc`  
		Last Modified: Fri, 04 Jun 2021 00:59:48 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b4e5693d7ee3388a4def841be67ecd5401088559be95e0a370bc12088638583`  
		Last Modified: Fri, 04 Jun 2021 00:59:52 GMT  
		Size: 17.3 MB (17274010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
