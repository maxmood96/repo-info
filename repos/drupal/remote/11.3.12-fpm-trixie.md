...
### `drupal:11.3.12-fpm-trixie` - linux; amd64
...
### `drupal:11.3.12-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.12-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.12-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.12-fpm-trixie` - linux; 386
...
### `drupal:11.3.12-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.12-fpm-trixie` - linux; riscv64
...
### `drupal:11.3.12-fpm-trixie` - linux; s390x
