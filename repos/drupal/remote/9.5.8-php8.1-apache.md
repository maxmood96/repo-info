...
```console
$ docker pull drupal@sha256:81ce1c01507a627b8e3895bdee643235cf8282bc8cc66ba9185e661048c531fb
```
...
### `drupal:9.5.8-php8.1-apache` - linux; amd64
...
### `drupal:9.5.8-php8.1-apache` - linux; arm variant v7
...
### `drupal:9.5.8-php8.1-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:223fab2d775d51c59518cba0408368072aa4aa0b5958603cf77e855cf7723663
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.4 MB (185384692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52e278f3e0a1e9152bcbb7373d6c8c486d4eae10da1509a4115e78556403371f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:17:20 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:40:48 GMT
ENV DRUPAL_VERSION=9.5.8
# Thu, 20 Apr 2023 22:40:48 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:40:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:40:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26e7f2323119ab2c8ef73af48bc4fb56e5b95f475893208b2064597da1052ef2`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c5d3eb18b43738615bed71b3a6fd90cef44ca373a72b84218f5b8c951cb62bb`  
		Last Modified: Thu, 20 Apr 2023 22:56:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91c5e1d7f4855d8584c72fea63ae203c74aabc459eb1f3fae048967822c701f1`  
		Last Modified: Thu, 20 Apr 2023 22:56:21 GMT  
		Size: 22.9 MB (22867080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.8-php8.1-apache` - linux; 386
...
### `drupal:9.5.8-php8.1-apache` - linux; ppc64le
...
### `drupal:9.5.8-php8.1-apache` - linux; s390x

```console
$ docker pull drupal@sha256:212c11a75d2aca159eb220ba6ebc3613795df8fd835d2bdf4b2c65a95ea5a8ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.0 MB (167980644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5df3ae7136bc05a9928c434b612ba561c167c2daff7051734aadb76037889436`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:10:06 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:48:40 GMT
ENV DRUPAL_VERSION=9.5.8
# Thu, 20 Apr 2023 22:48:40 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:48:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:48:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:235713481276484f3fb1bf780287449016fcef4592f34ffaffc64aafeb59223d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12cc36b255d8af194004015060793bb5fd56b1bcaf1687b0a1878eca9387e02d`  
		Last Modified: Thu, 20 Apr 2023 22:58:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:611fedcf316e53b6f252c93bfb641cb42a4c52b296a5b6ad9f6c55207c5719e8`  
		Last Modified: Thu, 20 Apr 2023 22:58:21 GMT  
		Size: 22.9 MB (22867142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
