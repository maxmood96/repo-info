...
### `drupal:11.0-php8.2-fpm-bullseye` - linux; amd64
...
### `drupal:11.0-php8.2-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:11.0-php8.2-fpm-bullseye` - linux; 386
...
### `drupal:11.0-php8.2-fpm-bullseye` - linux; s390x
