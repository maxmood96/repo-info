...
```console
$ docker pull drupal@sha256:6f0bb83f444b2e546a1ae97c3ec5c9e8d82d262c3e8dfbb1b7b239e5f4ef7948
```
...
### `drupal:9.2.21-php7.4-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull drupal@sha256:a34edcc0c28090a8bd744005e5ac46e5d467369724c8bfb0b45b4f64ad0e26fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (45977485 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:571bde42f983348bd7b0807aded4a58ec281e824db4cdb8410bdbfe529032590`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:25:37 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:25:38 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:26:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:26:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:54e9d57104e030f79a34331d8ae442e8044c17074d5e82db3ab2ad753043ed47`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a9607d0c5132d3e7e392786883deee632605f3675b52fdf0bc23cbedb55be89`  
		Last Modified: Mon, 13 Jun 2022 21:18:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7ce15031b4d09f0f8b0c5eb822ce3e721cbfa4a3c9feef2e4ab7ee5b53395be`  
		Last Modified: Mon, 13 Jun 2022 21:19:13 GMT  
		Size: 19.1 MB (19122221 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:9.2.21-php7.4-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull drupal@sha256:3d735201fd4f1f2add0326d4438fc4f0dbf57aaebbe44180d2992f556dd04529
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49120880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98b2461d589196635c46f0ee43dc372311008c5866aa4b1e7fa3fea9fa8cf8f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:20:41 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:20:44 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:21:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:21:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15b871803c9bc00631d038a245faf95b2cf38b51b3922ec9c69eee8ca646c9cb`  
		...
		Size: 669.8 KB (669840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35c10d7d186ff417a2ed6d41e130e6752a267ce9cfaa2dec696f2577c67dd368`  
		Last Modified: Mon, 13 Jun 2022 21:36:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fb2e437b04a17dedad4d38531b31f3ab8f5de6581cddac86b9656afbd5a1c69`  
		Last Modified: Mon, 13 Jun 2022 21:37:55 GMT  
		Size: 19.1 MB (19122111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
