...
```console
$ docker pull drupal@sha256:12fa5916499bd343363a6928f2f835ec860d99a8b3b0606abed96a34ad8ecb8b
```
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.9-php8.0-fpm-alpine3.16` - linux; s390x
