...
```console
$ docker pull drupal@sha256:0b056b28ebc104d6cb569a2db34666b3be1d39e7bec4915d7be8c343288f7a1f
```
...
```console
$ docker pull drupal@sha256:7e9b9778af6ae2b20f1b3270531b237197f0914268b03792d51644ce3d428a68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175659112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1cc459871f8b737007799ea68d14fb6f77588fdb90c0033fe68af0fb7376aa0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Tue, 01 Sep 2020 14:32:32 GMT
ENV DRUPAL_VERSION=8.8.8
# Tue, 01 Sep 2020 14:32:32 GMT
WORKDIR /opt/drupal
# Tue, 01 Sep 2020 14:33:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Sep 2020 14:33:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3fabeef6070f971c38848590f11bd1e7687d0b961d7b7c28961724d7423a70c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a57a149957a9a97bf2a6bc7bf7ad71a054b6e00fc71a14059e33aad06174661`  
		Last Modified: Tue, 01 Sep 2020 14:39:44 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:113c96b20b927faddf66e5bffec69c0996a560698c735395a2eea78fd448445b`  
		Last Modified: Tue, 01 Sep 2020 14:40:01 GMT  
		Size: 20.5 MB (20535355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:74cc71e7bf4666131af3c3ffc81d2974c65ffd1add9a52357c6260d478ad69ca
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155333793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cff553c911e7e1553a5a53074eab830dd1cc51cebd20378984183dbd5ca25b32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Sep 2020 08:13:10 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Tue, 01 Sep 2020 08:18:16 GMT
ENV DRUPAL_VERSION=8.8.8
# Tue, 01 Sep 2020 08:18:16 GMT
WORKDIR /opt/drupal
# Tue, 01 Sep 2020 08:18:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Sep 2020 08:18:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2a739f0f7c4d345431516f9ff1cdf03babe9999085bfd43b75584ff7811f2bb1`  
		...
		Size: 508.8 KB (508763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13d916edab633cdfb94a670d66d5fd6131ddd705d65a202358d7c0e7c37da303`  
		Last Modified: Tue, 01 Sep 2020 08:22:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aceb3a30ea66f793a4d6dca1776ef82409ded0813e1b1ece6cc07d4930c80ad8`  
