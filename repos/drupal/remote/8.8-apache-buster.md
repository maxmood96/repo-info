...
```console
$ docker pull drupal@sha256:4ea48686d02b62bed5c9cd0b480f0049f8018c1bb52008b8d5552a6778997e43
```
...
```console
$ docker pull drupal@sha256:455c279593777f6bc589082422b8b09f37e72e24e653113f0e7f4b2c5b3d796b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.7 MB (169683807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d3446504dcd564b05b1e8fa9c31c0d3d526b0b70529841c702fdf567aaf7117`
...
# Tue, 01 Dec 2020 23:32:20 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:32:20 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:32:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:32:42 GMT
...
-	Layers:
	...
	-	`sha256:511430c6c13260eee123c89f8fa5fd20ae101260e14f44e351577fcf046de30f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cb04390565beb17674983f87c2416abd074ec7e657488250d14f47fac41be77`  
		Last Modified: Tue, 01 Dec 2020 23:36:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a75c29dc79283e1ba98463e96eafd945a06fd2908079b55cc90f3a9938f65e25`  
		Last Modified: Tue, 01 Dec 2020 23:36:53 GMT  
		Size: 20.5 MB (20546734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6b7952853cc8e11fa5336345cf88c81f0fce7693d5e757c85556364ef7241c54
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145096637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:baeb856ae29d40cf5e082c2c90706d5b91f969d680186f24ec579fd5581bb9a7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:07:28 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:07:29 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:08:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:08:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eef0d5e796a64a3f83f6bec66ffc81f73663e3a996b0f00b6ef61f4655a1be1c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:458953ab31b4f80d6507c4f8e66fa063a8ed2cca7bee05e61ac14f7e74d4a8c0`  
		Last Modified: Tue, 01 Dec 2020 23:14:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af567ad2cc2e97d8256236ebe0fa9a674a9dc6363ecf8d30d1d22532ea85b40a`  
		Last Modified: Tue, 01 Dec 2020 23:15:13 GMT  
		Size: 20.5 MB (20547336 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:aab2bfa7a907d39f01afebf27ff1d9094c8bb68f94be96985de0422264d9a0af
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161790688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f19f97151a401a598d0e6a402657e3868c4705ba70b77f6926115cba36d922d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:47:31 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:47:32 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:48:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:48:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6b32c5890bf9003e9a7d9f11b56490ab08cdd8301a25bbe5a20d5a015425b4f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cd18a87e685b07ff8ea39a8ca58e00826cd37b7af41b600dad2bf48085f7d9c`  
		Last Modified: Tue, 01 Dec 2020 23:53:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f3ccc530b46161c0a3dd941d7d037314488ecf7037729fd2e8455262187368f`  
		Last Modified: Tue, 01 Dec 2020 23:53:49 GMT  
		Size: 20.5 MB (20547082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:7dfbf91c3e9fd9d30f2acadf1594a8b963755887ab6d91f817dd69e266497f2e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175730299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:599c365225a6d7559e8141de5beab13c383c8ba6ae6d9e7d14dacd05c6d787bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 10 Dec 2020 16:00:04 GMT
ENV DRUPAL_VERSION=8.8.12
# Thu, 10 Dec 2020 16:00:04 GMT
WORKDIR /opt/drupal
# Thu, 10 Dec 2020 16:00:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Dec 2020 16:00:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3abb5e5a61d980071d185b0f2d0880eff773b252fce185d32a7fa57b2dcc20b2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cef964535d3a30ab32f56550806222afdf8bdde745cc1e4165bac0a4925225ae`  
		Last Modified: Thu, 10 Dec 2020 16:05:56 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f70e6cd65d7059cc254da91c94db8957fa5bf5a8a5446b75a2dbe59296d0d055`  
		Last Modified: Thu, 10 Dec 2020 16:06:04 GMT  
		Size: 20.5 MB (20546874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:0c0b496e81e46183fdb03230147479b28e45a311a9745dd047dea34c6b7137b7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181108411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd83ee824e36674ad0dea7a60e00e7a4ed0ac11f9248ca422ad0f843399e663b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:35:15 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:35:19 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:36:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:36:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7f62660473cd99274c559bc8e8945dcfacc306a840b7fc96af07883a4a82bda7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81deb55342f7a2688901035441dc7e7f49af0e7b7ed4a6c48475042c617958b2`  
		Last Modified: Tue, 01 Dec 2020 23:56:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e292682eb0c3b83fb57d0d41d9438ffe2fda827328950acdb48945f3e0268c47`  
		Last Modified: Tue, 01 Dec 2020 23:59:14 GMT  
		Size: 20.5 MB (20546876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:45c2c72d6df4d80f4b87b6e9324a490cb35ceaadc137b2fef7cf1095121a7fb8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.4 MB (155394841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22053ab6caef09d1e2fb6252b3dc3078d70e701a67c296c2a9334bd9cb8d7a1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Dec 2020 05:22:11 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:47:54 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:47:54 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:48:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:48:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bbc8464de44de406eb2cfe63a215f447e53e67f80e654530f3be7eb252e8c3bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc89ab5226ab520c751a0aad206131381f2313d3c2ae4cc9b29206a3923e30eb`  
		Last Modified: Tue, 01 Dec 2020 23:52:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c24b4b0d2ada53c117c7c5458a8b5a263e2f88cd33da767945ca559e7599b164`  
		Last Modified: Tue, 01 Dec 2020 23:52:32 GMT  
		Size: 20.5 MB (20547174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
