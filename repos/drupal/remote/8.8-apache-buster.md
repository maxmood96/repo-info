...
```console
$ docker pull drupal@sha256:29ef94162da1156622b37f8cceb3c14fbd0b5a757c84b3415e59dcb7f68d64c3
```
...
```console
$ docker pull drupal@sha256:3aa06d644fa85dadd3dbcb9ae77569daab32cbc70fc0146b094a3f272194fce9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169602691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cd3e13a72a194af480871e1ca6ceeb4509b2aff3ad64b81d0aeca7671de259c`
...
# Tue, 01 Sep 2020 22:18:54 GMT
ENV DRUPAL_VERSION=8.8.8
# Tue, 01 Sep 2020 22:18:54 GMT
WORKDIR /opt/drupal
# Tue, 01 Sep 2020 22:19:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Sep 2020 22:19:16 GMT
...
-	Layers:
	...
	-	`sha256:ed27dae404bdaeba8573c295d628f01d61939b59dbc2f34289e9b2925a2e3335`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9284f5a4e20954284ea7590b0132dd359252b62e236e3bdcd7e3b61f40593df6`  
		Last Modified: Tue, 01 Sep 2020 22:23:12 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd56e5eed8967da32e45cd90dbc25ab0b7fc08b6d9c606dc05fb770106b834d9`  
		Last Modified: Tue, 01 Sep 2020 22:23:27 GMT  
		Size: 20.5 MB (20535273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:3a3e8485c69130d060681ea9b08033ddbe7802447114f3198b334014f2acad74
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.0 MB (145037609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a6d16868036010d8c02e1505c0ac02350966ba66ff78334f638075f65818a98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Wed, 02 Sep 2020 05:12:18 GMT
ENV DRUPAL_VERSION=8.8.8
# Wed, 02 Sep 2020 05:12:23 GMT
WORKDIR /opt/drupal
# Wed, 02 Sep 2020 05:13:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 02 Sep 2020 05:13:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c6cfd0aeb6c52ba0d9e0ab5f8638fa4580d60dbe10885e7a0f6038be371ca50e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0affaaaa2abc870e7896cc5d4ddafa891df788d5d419a52ec4a68a55b181116e`  
		Last Modified: Wed, 02 Sep 2020 05:22:40 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fd18ea47065812bee7d1fe39d7e18a290ba9742d63c1178f176d8682ff10fab`  
		Last Modified: Wed, 02 Sep 2020 05:22:52 GMT  
		Size: 20.5 MB (20535129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:bf401cea8d917bda4b28dac91bc8a1c9d15b6dc89bf4defeac3ee04cb73093e4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.0 MB (181036816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c88be34528fbe302c008e76fd65278662533ddae2aa4e64d3bb1adde4df5e9d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Tue, 01 Sep 2020 20:16:42 GMT
ENV DRUPAL_VERSION=8.8.8
# Tue, 01 Sep 2020 20:16:54 GMT
WORKDIR /opt/drupal
# Tue, 01 Sep 2020 20:18:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Sep 2020 20:18:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8f1f185f6128852da0ab3ca18f3632aeec2dfa5b8781eaba78e2390d13571ec7`  
		...
		Size: 508.8 KB (508765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e7f06f48bb1cad0a7a4ce5d0aaa0d6df449479ce20ee4dcf693abc62844ab60`  
		Last Modified: Tue, 01 Sep 2020 20:52:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:382d7577e66be45187f960c447a969fbf9f68db603fafb7628f651fe39e0e1b4`  
		Last Modified: Tue, 01 Sep 2020 20:57:26 GMT  
		Size: 20.5 MB (20535298 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:bd3066141ffba6104fc7e109be4539d2c3c9de807f2203e68c2c323a585c6b23
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155344051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd26a61e0299a876e8fce4f097a5301843f62d4b753fb67ad9c8b1feabaf6d0a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 03 Sep 2020 20:44:23 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Thu, 03 Sep 2020 20:48:46 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 03 Sep 2020 20:48:46 GMT
WORKDIR /opt/drupal
# Thu, 03 Sep 2020 20:49:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Sep 2020 20:49:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2dcb56b2f4d1af6dff46240f3806359bab6a33a3e30cc604f0d7a3109a1a54eb`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e746eb78350876b1599fb3ddfe6742d6d4fad295f8b55315e3fcb6155a32d088`  
		Last Modified: Thu, 03 Sep 2020 20:51:40 GMT  
		Size: 508.8 KB (508758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c538d33fb151d2f4f62b74291f6015b8623ef83db1a66c98c22f6815e5d87217`  
		Last Modified: Thu, 03 Sep 2020 20:53:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:745607769a601b834ebf1caf04e5258c0e136d337b26e1659bc8f42777465ff6`  
		Last Modified: Thu, 03 Sep 2020 20:53:22 GMT  
		Size: 20.5 MB (20535329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
