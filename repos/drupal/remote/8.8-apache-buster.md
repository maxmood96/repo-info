...
```console
$ docker pull drupal@sha256:0cac76e45eaafa547293c2a24d668b43b2fb4ef79d865d0af0e5028bec544d01
```
...
```console
$ docker pull drupal@sha256:2e4f5bc0023494b92d16fd4197ffc539b4b055af73df30050f83261ee53cf1ba
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161719590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a27adbf7ff76a38c36a94db5672231392b823b9ae39e817744ef4f58de0eab57`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Tue, 01 Sep 2020 17:44:16 GMT
ENV DRUPAL_VERSION=8.8.8
# Tue, 01 Sep 2020 17:44:17 GMT
WORKDIR /opt/drupal
# Tue, 01 Sep 2020 17:44:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Sep 2020 17:44:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3dc128b68beae74e74742d741a690caf5b20cdbae378cc1c42af3a87a321d5b9`  
		...
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b31b3709c20de4cbf09a4a6f5d8f5bea16d405061fdf114798fe9ae01d0268e`  
		Last Modified: Tue, 01 Sep 2020 17:50:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7d2251c0218722b5cf79e37615aa925b9bc532da71c26144bffc30118260632`  
		Last Modified: Tue, 01 Sep 2020 17:51:01 GMT  
		Size: 20.5 MB (20535307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
