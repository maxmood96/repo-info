...
```console
$ docker pull drupal@sha256:84a34626a4fa4216841564ff52a9767f08e7faa48a89eff6995baa80d00aefca
```
...
```console
$ docker pull drupal@sha256:9bd22ea4fbefd5b6e5ca03e34d080b276d3e849de2b88804c15f898cbd24db02
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169618863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dc0b3bf8ddb4058b927fd3e8c8a1c63508a5534e64e0105fd2981764c6533e8`
...
# Fri, 02 Oct 2020 03:35:01 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 02 Oct 2020 03:35:01 GMT
WORKDIR /opt/drupal
# Fri, 02 Oct 2020 03:35:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Oct 2020 03:35:21 GMT
...
-	Layers:
	...
	-	`sha256:66210a6933fa1bb2d092d448229806011e5dd7ee8707f43b212cff99278e710b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a0250dc84f8df6d53f51f59d3498e4a293e72af1d4231ef41610e102301fcc1`  
		Last Modified: Fri, 02 Oct 2020 03:39:43 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68b7dd15b17edcef558711513d33c2c3d16105076d845cf810626ab7a101ae69`  
		Last Modified: Fri, 02 Oct 2020 03:39:59 GMT  
		Size: 20.5 MB (20537180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:4c30780dce921be4e1103c77b8b67a09af1c87c54ccf9e022d44b82612469501
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145051568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2e0114fa321c6ac16a61dfb805b2856d93a19ecbe779bb5535bb565a408cf49`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Fri, 02 Oct 2020 00:53:10 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 02 Oct 2020 00:53:27 GMT
WORKDIR /opt/drupal
# Fri, 02 Oct 2020 00:55:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:9c99d1f9ab8ffef14e832c883296046ddd764fbd05afe4bbcc9b0b83524aeddd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3fc4e4d6af554b9f34937ce09ffda396c6260205da91a1efa93d682e049ac69`  
		Last Modified: Fri, 02 Oct 2020 01:09:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36e05f66f63dca2630f22c472f1b206c74a82cd71338b30adff43bd4cca91fc4`  
		Last Modified: Fri, 02 Oct 2020 01:10:03 GMT  
		Size: 20.5 MB (20538101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:3ca0c7593da2dc6389c118ec1b3d6ecdef9fe7dc8ee83e9206c6ce64ece2f3da
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161735931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74ac96253063f86dd4df35f39cc309dea05eec52dba6ab8bab553866dfcef02c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Fri, 02 Oct 2020 02:58:42 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 02 Oct 2020 02:58:43 GMT
WORKDIR /opt/drupal
# Fri, 02 Oct 2020 02:59:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Oct 2020 02:59:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7233c12cb1be65a657d59afcdfe4db7fc92161193132d37199b90dffe8a78dea`  
		...
		Size: 508.0 KB (507964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbea5eb113db19e9a078cf30b5fc1aff783ca273dfe33b5fbd16a2cd56c8abf8`  
		Last Modified: Fri, 02 Oct 2020 03:07:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f84716db65d353df5bbe95ee3609365303b92334d8d0058afc71e7b7c99ee45`  
		Last Modified: Fri, 02 Oct 2020 03:07:25 GMT  
		Size: 20.5 MB (20537562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:aa508b0827d6177b215716ad2003ccb7e5018b955aa6d81082b8e0cdf2c10b34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175671869 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5243f01c908fd4fd1853e50ad31faf92e87a9edaa98a542f68a209972b163c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Oct 2020 22:00:19 GMT
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 22:03:25 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 13 Oct 2020 22:03:25 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 22:03:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Oct 2020 22:03:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:441ad3990af29ed4b80232d1023a0b14a54f9e2774443e54e773d5426e16340a`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02dd1c4af64afc483a46fdd7ebfac5c803e45368f2001a84ea6a123eb8b3110a`  
		Last Modified: Tue, 13 Oct 2020 22:07:33 GMT  
		Size: 110.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f52a4e99f6e816410f1b0d9dc2c3f1379634d6fa6a81f45625b9c8c1fffdde5d`  
		Last Modified: Tue, 13 Oct 2020 22:07:47 GMT  
		Size: 20.5 MB (20537217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:8bbe77458a89db4c4d44e938565c4b6eec43a604b1a35e42fc1344df2d26e44a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181052687 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64a6d661b2fefb940361da73917af98d68361330ac58b6d482f426b4287faad7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 19:16:50 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 13 Oct 2020 19:16:59 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 19:19:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:e7ddba57da16dac7d1049107d637c5a3e65fcd5d850fb0a0ec73ef75695a1488`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bedf9ab96461c424059b5072799378a940d86629e2c2b154205a3db7f2d269a`  
		Last Modified: Tue, 13 Oct 2020 19:39:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00d5c1d72481e1e8642e2f86a00be2757381cc220152bf7ed2e7c646c583db4`  
		Last Modified: Tue, 13 Oct 2020 19:41:06 GMT  
		Size: 20.5 MB (20537701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:a000af7c86c1af711916c0f38ce55636c8603d70114d8cb346350de6f6af0f78
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155345190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abc5166d5c4ab24f49e1183c9d36cc06424fa3864c3a88bc06fca2bce776e23e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Oct 2020 12:23:13 GMT
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 12:28:11 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 13 Oct 2020 12:28:11 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 12:28:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Oct 2020 12:28:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:585300dc592f906d2e2974eb69f7e2202a8076713532758278c18c745be99623`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6fed11cdea8533fedf036bcff0988c88a965ec270fd1381c1d235155f2b56fc`  
		Last Modified: Tue, 13 Oct 2020 12:32:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab61d9e60565eb85123dfd6562c986440c64e5cbc645ca9fdf5c1467659659db`  
		Last Modified: Tue, 13 Oct 2020 12:32:25 GMT  
		Size: 20.5 MB (20537534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
