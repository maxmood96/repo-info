...
```console
$ docker pull drupal@sha256:f14b44dfd97bda18adb16728a840226535baa8d2d5de891995ac7a7cf34ebce8
```
...
```console
$ docker pull drupal@sha256:153b9aae6606dfd9e9f5e22262a79b39da4e7e0ccf050870bbd0089bc35be3ea
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.7 MB (169679061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07930c8032d19e7c1c3a3cc99db18c128da04392ddcf7baf8e932397b9ed5928`
...
# Tue, 01 Dec 2020 07:56:22 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 07:56:22 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 07:56:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 07:56:46 GMT
...
-	Layers:
	...
	-	`sha256:511430c6c13260eee123c89f8fa5fd20ae101260e14f44e351577fcf046de30f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d37beb6bfa95dcba3e8eb38fed02b61354caf0a1958a807d95960b3b46076c6`  
		Last Modified: Tue, 01 Dec 2020 08:00:47 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f2e8b355d65d724b76bc9343d65eaf0ad54609cbbf4dff45377d8f88329a900`  
		Last Modified: Tue, 01 Dec 2020 08:00:53 GMT  
		Size: 20.5 MB (20541988 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:81f342f3e25610381317a712e711a3c296d7e617a7ef6a4011bb7f9ec9183bff
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145092382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1b89ab3ea3b9aeedc0da114c64b19e4dbc33d353d99ab52b4dca3b9512fac5e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:26:35 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:26:36 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:27:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:27:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eef0d5e796a64a3f83f6bec66ffc81f73663e3a996b0f00b6ef61f4655a1be1c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:570e88d849bf9ef9c2180f18ff7993436363ced727a701e4db3ce536d90ff16b`  
		Last Modified: Tue, 01 Dec 2020 05:33:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98971f56b11ec0b0340cee8f530b98742d0a2cc29ab786718ab3a032616e77ac`  
		Last Modified: Tue, 01 Dec 2020 05:34:05 GMT  
		Size: 20.5 MB (20543081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9bd7a4daf87d0bc1516b4ef0ce8cacbfb617178a42e1ce68045ddbfa490ce97e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161786121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bff3b116ca1cb399c99b2b92c84947c96c2459cfbb35d3934952d5ac8cc87fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:29:23 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:29:24 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:29:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:30:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6b32c5890bf9003e9a7d9f11b56490ab08cdd8301a25bbe5a20d5a015425b4f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10cd6bb2fcaf26e352c643c1297f91685ad6aa7e391e7bf8c8f9714c68387698`  
		Last Modified: Tue, 01 Dec 2020 05:36:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbe8aa4b3ba280032ab86d50f14f7da1a612f902374f58b77c7ab32f526d4c75`  
		Last Modified: Tue, 01 Dec 2020 05:36:37 GMT  
		Size: 20.5 MB (20542515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:8f78825ef758a0041f538dd2dcd54e52bd59dc7b7bf466f901d95bb4ccbd8c82
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175725555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6a87deb537cd4cdfd7007c92ac637c71d52eb240fbba44fa4a4e714520e10ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 09:17:54 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 09:17:54 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 09:18:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 09:18:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9c8733619b54c79ed01b8ea42d61dcfa4cd044585eee2c2e2b5daf8855c2c0b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3de73f0da2e67d4d38a1ec5d6a0f07e21a514ddf1a63d3acc795511863e21d51`  
		Last Modified: Tue, 01 Dec 2020 09:22:57 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e048d6c7ff6d5f6ed595ec7f686600a1e0277f65e7eb6cbd6dc531594e40ef25`  
		Last Modified: Tue, 01 Dec 2020 09:23:07 GMT  
		Size: 20.5 MB (20542232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:cdc1f5fd3124e19da197922279aa4fb51e54dc0548309d9520539e9563c99b82
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181104104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74f58d510e299d00eb3809d1bb0b274b64a0a4d36c299400bb770fc19f2d9654`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 07:32:08 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 07:32:16 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 07:34:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 07:34:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7f62660473cd99274c559bc8e8945dcfacc306a840b7fc96af07883a4a82bda7`  
		...
		Size: 508.3 KB (508284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d94d4fe8a39317957a63986c1c4262bfed05b4ad4939eb3530dabe784dd9ac85`  
		Last Modified: Tue, 01 Dec 2020 07:55:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca265b76f7a048529d850497aa99663e6a9f4bca8fe3d7dd3fabc51e96eab76b`  
		Last Modified: Tue, 01 Dec 2020 07:57:17 GMT  
		Size: 20.5 MB (20542569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:39502281221245afb50dc2679db2e6d5d128d17fa3430b0d0c355bb69474ff14
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.4 MB (155389861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d93ab430373283799f76e8f958cc48686851d356bda2c3f6e9d69a2fa035fcb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Dec 2020 05:22:11 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:26:50 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:26:51 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:27:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:27:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bbc8464de44de406eb2cfe63a215f447e53e67f80e654530f3be7eb252e8c3bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afced54517781e4cc55b75cdd83a1837c2ee46e13e6292af158f4f05ebad59e3`  
		Last Modified: Tue, 01 Dec 2020 05:31:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38442f07f5bc9af41435ba1b557a210580f0bb989e8e178e26845110a4b8cb4c`  
		Last Modified: Tue, 01 Dec 2020 05:31:24 GMT  
		Size: 20.5 MB (20542196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
