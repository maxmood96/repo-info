...
```console
$ docker pull drupal@sha256:4792b4d16590aec1ab5691f253b499d4d080de29ba95fc89281c051bcd58ceb0
```
...
```console
$ docker pull drupal@sha256:be2d454361f81a52367bac69b016d07aab04a74eca2d685a567cb36edfd95595
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175670394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d8e230b1f028e557a51cfb3e610bc9a8f4e3c45eeb3ead23ce85675cfc5aa12`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 10 Sep 2020 18:59:00 GMT
ENV DRUPAL_VERSION=8.8.9
# Thu, 10 Sep 2020 18:59:00 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:59:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:59:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:18ef56808227236e0852cdd85eacf29906a857d8297eca2aae0a339b9464bdea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5b5357090dfced5b7aa21ad7bd22a01ac3fb5e8c979e67b3b1b6335e5ff2e97`  
		Last Modified: Thu, 10 Sep 2020 19:05:06 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0106e0abf0e37bf7a950f8678a01764debffce245e94e57e608c6d5854f119ad`  
		Last Modified: Thu, 10 Sep 2020 19:05:23 GMT  
		Size: 20.5 MB (20536744 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e9d6b41c3ebef1d0bf1ca78c90d07bbcb9998262bd6d7543c0facf73987c3028
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155345004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3a7c5105ecec734caee4cc5b96ebd2354343ba2f1e9a5e5a2f6299bffe5db3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 10 Sep 2020 18:00:55 GMT
ENV DRUPAL_VERSION=8.8.9
# Thu, 10 Sep 2020 18:00:55 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:01:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:af768f53c87ee1cffdbdead9d67dd26b2aa366641db92a322f4a01804a184267`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:535880c48483b89902c8aabf977eb5b7aa7f36737ee6249b9c74edd50befbf36`  
		Last Modified: Thu, 10 Sep 2020 18:05:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0575825d7209b737d4372b3cdee8acd4bc548e50b56789380dbfca22b1036cc`  
		Last Modified: Thu, 10 Sep 2020 18:06:02 GMT  
		Size: 20.5 MB (20536811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
