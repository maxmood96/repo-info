...
```console
$ docker pull drupal@sha256:bf0d73b1c27635952ed11f53659a694c1287d6242ec39cd977b3c0e508217ceb
```
...
```console
$ docker pull drupal@sha256:ac39714eee2a512a599b1df1a214cea3d48bc42c45cc304271207d422b92f89d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.0 MB (145047804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9f880af7d7bbe18ba4bffb2badc6c7627bad9eb3a5d692d995c25baf94a33d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 00:04:44 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 04 Sep 2020 00:04:48 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 00:05:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 00:06:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89ca13c86690204fa39ef6750a2b0327c7ce82bd5b8d22e3d9d7eec9da904dcf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:717557552ccaf6e26c14774110dae4fe600dd21ad224f522c3515312283caf3e`  
		Last Modified: Fri, 04 Sep 2020 00:18:56 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19231235fd84bd33b480c7bff9c3ff3104c5570e61b0b4addab114ef6d379208`  
		Last Modified: Fri, 04 Sep 2020 00:19:08 GMT  
