...
```console
$ docker pull drupal@sha256:aef3b7db2d6f6206b0480e6dd0262acfe9afbe5a2eefd2034370c820e9928a6f
```
...
```console
$ docker pull drupal@sha256:b387589b16861d0873ac3f48867c7b6f7bbdba1bf976015b4c663d43f30665fb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175671941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74d347c97ebd06977cb5f6de4787c72110408bea1ac51c26aebec560e3cfc4a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 02 Oct 2020 02:07:45 GMT
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Fri, 02 Oct 2020 02:14:30 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 02 Oct 2020 02:14:31 GMT
WORKDIR /opt/drupal
# Fri, 02 Oct 2020 02:14:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:a12547af4d88b61c80fe5a8303ffc4d90e88e48940083d0469403d38e661070d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2187484634761533c086e644473a3710e9d72c16206d8ee4420cdd6b85f3ec0b`  
		Last Modified: Fri, 02 Oct 2020 02:20:49 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2f12df0dd37d051415d573de936cd05920c4fdc3db315567b8f9619fdc5c2a6`  
		Last Modified: Fri, 02 Oct 2020 02:21:04 GMT  
		Size: 20.5 MB (20537493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:8e2da95edae8e13700c8aedf333a7e608c9b4b4efbf767253dc5d099a450bc44
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181051305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:000eb2e693f678f32a056692e96cf2e9e6539265ed61f3b758bbff2da62aa23b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Fri, 02 Oct 2020 03:23:07 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 02 Oct 2020 03:23:10 GMT
WORKDIR /opt/drupal
# Fri, 02 Oct 2020 03:24:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Oct 2020 03:24:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f49b05d79b961433cd638c8c8553fe3838e1a91f2f69986c23ea547ada5e3ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3ffd0c3edf075843a9159495064b95d74c916dd962890482c1e6dc9312062b0`  
		Last Modified: Fri, 02 Oct 2020 03:37:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e4dee0cc91b55f1fd823b575e22214df012f6bce5d88967cfab0df12255d6e6`  
		Last Modified: Fri, 02 Oct 2020 03:37:44 GMT  
		Size: 20.5 MB (20537579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:675be173724f488793ec8a6567c0d3f6aff6196f4fb6ba5059e4d9c690f44aa1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155345271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:346a43e2ece24abd8105f5102590c792cd3451f6394cbc95e4924141b9adf438`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 01 Oct 2020 21:53:45 GMT
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 01 Oct 2020 21:58:17 GMT
ENV DRUPAL_VERSION=8.8.10
# Thu, 01 Oct 2020 21:58:17 GMT
WORKDIR /opt/drupal
# Thu, 01 Oct 2020 21:58:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Oct 2020 21:58:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c6bee8cdde33a2d6a69b47ff97a2d2101654449f46de12f2bbe5ffbba12d7fa4`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d0643a6b9b0a3adb01d292b4054c09170584e4bb51d6d88b64b3862b7f1f175`  
		Last Modified: Thu, 01 Oct 2020 22:04:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1af757a324840cd2952788202efca2f4b2c63dbf0af8f24e7d57b583deb16936`  
		Last Modified: Thu, 01 Oct 2020 22:04:05 GMT  
		Size: 20.5 MB (20537543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
