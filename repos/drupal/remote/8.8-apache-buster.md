...
```console
$ docker pull drupal@sha256:34a18d59f33a19d8bac82bc4f78eecf2afce9dea2b65d9003f2c4568bf960771
```
...
```console
$ docker pull drupal@sha256:ef4445f4cb650f8bda6fc6db27656357a25eb34db2eb56eef9d5ad227e895682
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169602606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67498c8db9e1106e08ac5bc4ae3fff6961452ed295120fbb8bcc910adb770802`
...
# Mon, 10 Aug 2020 19:04:04 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 19:04:05 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 19:04:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 13 Aug 2020 00:20:02 GMT
...
-	Layers:
	...
	-	`sha256:7a2dfd067aa5d980aebb1a4eea5fa1e7891d1666c1ae1c4a29b04e9729cd0981`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6422684889f65f37305246dff9c6cae6a3262f5ead7abab94d5e431b1a5ced80`  
		Last Modified: Fri, 07 Aug 2020 01:22:15 GMT  
		Size: 1.7 MB (1702637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:445284e754b8d473f5791ba50ac70c87f9d0212fe19325585c0994284116ebed`  
		Last Modified: Fri, 07 Aug 2020 01:22:15 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b58e7bc9d758455e58cc4c0ec52454c2a26d986b7efb4223518427f9798777c9`  
		Last Modified: Mon, 10 Aug 2020 19:06:40 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff48d0969d1ec10e09d5bb8c5fcc271e49014fa255a1f553c665ce3f5a19309a`  
		Last Modified: Mon, 10 Aug 2020 19:08:35 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d53c9ceb5d53f4efa338087bf6157930b100fe18636a53314bf702cd593a84a`  
		Last Modified: Mon, 10 Aug 2020 19:08:41 GMT  
		Size: 20.5 MB (20535252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:cf2530a9070b2b5bd37a68446420395e0629c4e5ae5cde671a823193e1891756
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.0 MB (145037528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f524156346f54f7bdba85dd438c73a08beb17f7fc71438ec0245cb53cbdb3f6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 18:17:53 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 18:29:23 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 18:29:32 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:30:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:59:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7a590d779587fe2c3a212c8c8ac8572a2bb20243bc703eb82797e97091ab6abb`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:128083402ec91de9a983054fcd15a0024883bd1d8319f6ba6b7d4ca028b5cfb7`  
		Last Modified: Mon, 10 Aug 2020 18:36:07 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b71c8a67b74829ed3b2e5a2376b1c3ff8d54e980de43200d7dbed5535b24db3`  
		Last Modified: Mon, 10 Aug 2020 18:40:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9d31bbd4f431d5cc8fe708098c2177cbdfd9307436045c36fd668b0694eed1a`  
		Last Modified: Mon, 10 Aug 2020 18:40:28 GMT  
		Size: 20.5 MB (20535132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:2e12c23a87830e38de90c17312e20f19e8acdb8cf3a6278bbd9c17bab6baaaaf
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161719460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e90de93e4afb84ce13f491a36c9fcf06a7c34d8ad03204a33d53c5d0fb071fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 00:48:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 19:07:37 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 19:12:58 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 19:12:58 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 19:13:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:40:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f87e6420b853d978471b2d662b1df21a30beaf8a2c665f9a1aec70e9ed4de2b6`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d431a62332cf7b5255db98e3d810dd49df0a104f9ec145408a31eef5c137b39`  
		Last Modified: Fri, 07 Aug 2020 00:55:40 GMT  
		Size: 1.7 MB (1683429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b1f2b0a789f26388082178113c8218b043e04df816ed7c138c54f868f764e9b`  
		Last Modified: Fri, 07 Aug 2020 00:55:40 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aba6fe8305d8fcd0e8550c96a11258f7cb11f6d7934708fecd7a58d01206f3d0`  
		Last Modified: Mon, 10 Aug 2020 19:17:07 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8886c78e931525f5861dd8e0dae8f629db093f7da55a5ee0072b37480b530b98`  
		Last Modified: Mon, 10 Aug 2020 19:19:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55c5327575a7f92e80ab7db7046ff14e8fd1d55143c9bda1670dfe76ec543da5`  
		Last Modified: Mon, 10 Aug 2020 19:19:54 GMT  
		Size: 20.5 MB (20535247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:ee34e6838ea04d233dba334b4c99a7a9812a23c00f91378f2bb4249883689185
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175659032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b96b0ddfe18b66ef97820a4e8833b5bad12431e2bd6575a50bb3943af8c3fd5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 02:54:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 18:55:46 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 18:58:57 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 18:58:57 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:59:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:38:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:76142efc04958617b4f7c97b86be82a6d9a1a9df937a2df5ba3bd062f1c4b969`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a9b03084b3dcae3d997ecede6b6720a7d4f1b6c1f4fd5709b024f3394614b62`  
		Last Modified: Fri, 07 Aug 2020 02:59:10 GMT  
		Size: 1.8 MB (1784925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07c43b5d502d528055f2da7f4ec7cc4d492b35a35ce97ded91c87ac2d9778c41`  
		Last Modified: Fri, 07 Aug 2020 02:59:09 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb26bb3b56db8c9775fe130e5444b726ad4f9536e229142b684c924b72ac922f`  
		Last Modified: Mon, 10 Aug 2020 19:01:37 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82618793a09fbdc9b3a7f07001a9fb5a8b49c3cc7a1b76bbc42a1eb834532b05`  
		Last Modified: Mon, 10 Aug 2020 19:04:33 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6870c60d9f6a09bc47618107ad880fdf9810dc15ad19c43e2abbdccfdac4685c`  
		Last Modified: Mon, 10 Aug 2020 19:04:51 GMT  
		Size: 20.5 MB (20535296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:f2817e2807c3559e71433e8494ffd6d696a93d9d85aa13dedc08a0026cd6d028
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.0 MB (181036868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f39ea33a7909f110e1ad4b864cbdef2c1cda4efb42fa49efd82a0db7691afe7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 06 Aug 2020 23:27:52 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Aug 2020 23:28:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 18:36:04 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 18:45:13 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 18:45:16 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:46:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 13 Aug 2020 00:18:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:471606332039ae568a67cc8f1ef301b63c3dcdea476721c7e31254cf8c2fa3ee`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dceb7d73deb522ab34ee7a7cb15a2a9b8685e9da9e455acf949c676d5495238`  
		Last Modified: Thu, 06 Aug 2020 23:39:12 GMT  
		Size: 1.9 MB (1922077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e55e1e30dc453c01b432ec801632aa923a920d1c12e48c8e981da11ebab96f4a`  
		Last Modified: Thu, 06 Aug 2020 23:39:10 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ba20982161cc6830cfb8250771dd3c267bf1ddbe5bf2ae864ab1b295a349a4a`  
		Last Modified: Mon, 10 Aug 2020 18:53:29 GMT  
		Size: 508.8 KB (508762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a553356998c75a2138cd539236ec1ce2ed2f7f565454b57ad15fe15a32adb1b`  
		Last Modified: Mon, 10 Aug 2020 19:07:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aafdfe314d690cd7a8c08ae781fb8bf3b45afbcb8c129f3de948c3095d6eb7da`  
		Last Modified: Mon, 10 Aug 2020 19:09:24 GMT  
		Size: 20.5 MB (20535311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:d53fb08022c402f6c719b9c40e5a0b7be31f6b93ea42b627b834f7efd0aa51d2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155333439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:995f4cfc0942d51bf0562fd2ffcff76205ad242b812709896d731d3a4c0b00e9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 10 Aug 2020 18:57:25 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 19:00:51 GMT
ENV DRUPAL_VERSION=8.8.8
# Mon, 10 Aug 2020 19:00:51 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 19:01:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:41:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b62eeec2c657f6213797cf6a26ecec1d16493d2627de08d08af4b2155f7169e1`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd8db4c6c431af622b276a6d2f66351bcf1c7c3be40a486f5b20f9be9487ba37`  
		Last Modified: Mon, 10 Aug 2020 19:03:54 GMT  
		Size: 508.8 KB (508764 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34ce1623db3da6664264d2d168421c8df7da90c7eab92b2cc3a6febe4f3dc324`  
		Last Modified: Mon, 10 Aug 2020 19:05:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3ad791461c73ecf259c256c29658c9d3e58b72e24c03d7c9afb2929f0321491`  
		Last Modified: Mon, 10 Aug 2020 19:05:52 GMT  
		Size: 20.5 MB (20535264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
