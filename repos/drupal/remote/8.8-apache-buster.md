...
```console
$ docker pull drupal@sha256:11e4c6076b1ac60330d7d25529558357fbb6a420e65105f87a0b755b1a95cf2c
```
...
```console
$ docker pull drupal@sha256:a33c646ab848203c2ef2864542a5d2f95c28b9fc573853da784bb8ac0967c6ca
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.8 MB (169829023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27acdb4a715c7500c6b8551ebeb109eb502a7b3ec18e3ac2777f61a35af3433e`
...
# Fri, 06 Nov 2020 02:56:29 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 06 Nov 2020 02:56:29 GMT
WORKDIR /opt/drupal
# Fri, 06 Nov 2020 02:56:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Nov 2020 02:56:48 GMT
...
-	Layers:
	...
	-	`sha256:162e2df8986776428b070fd64c6fbde6c2fc14dc1a6cb19ad28826f5dd07c668`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01f73461a926e2ffb6e3b1540c0edf02821647e550d01da578547023109a2b20`  
		Last Modified: Fri, 06 Nov 2020 03:01:08 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac83f655c6e1aa0dbf678224bc0095983e593b9d76d79497783ad0036e2fda9b`  
		Last Modified: Fri, 06 Nov 2020 03:01:17 GMT  
		Size: 20.5 MB (20537082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b2c318aeabbcf097958b56248ccb8609d883e1de95f80b7654194e1cb3002c54
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145079136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:427d9f0ea03f0a38a03e16dec94020e1fb55063667b924c35ee559340a3e7341`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 20:02:22 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 20:02:22 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 20:03:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 20:03:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:efff0c09bdc7c99db064cc0eff5023aafc53967d43575e26f05cca84929f24b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adc71d94e2e054d106716b5e86c0f0711d163bc04dbddb9719fe6855ba547a40`  
		Last Modified: Wed, 18 Nov 2020 20:08:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:413e0201b917bfa1e1c7f69e2c0669762402666de2770ae6900b656ea3d0e2c1`  
		Last Modified: Wed, 18 Nov 2020 20:08:13 GMT  
		Size: 20.5 MB (20537408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9f4c591a28599ca51fcefc79a92b36448b7d5bffd573b12101d0c8b0e892df8d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161773249 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7c1a892bf15fd202d43bb6377666222a165577c78c4de803ddc46a588a76449`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 23:34:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 23:34:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0a1004de4cdc71183b18af5375d70785a47d5ccab7aeabe7875ef58fe70bce0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8a80116b0112e5867454006197edac8e5acb4f33c2e66521065f5c280223173`  
		Last Modified: Wed, 18 Nov 2020 23:38:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:843c8ed974e1f2a0a3a1aaa63154a756a3474cefddf0e29b5028adec2eb61d17`  
		Last Modified: Wed, 18 Nov 2020 23:38:28 GMT  
		Size: 20.5 MB (20537484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:c468f83dd25e6b9d100fff1770678243d105261358d896755ddcdcf3c44f9ffa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175710088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4ef156e871189a83c273712eb68c3a3830cd685bc73ff5119119efc5bc852b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 16:49:50 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 16:49:50 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 16:50:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 16:50:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f22592de3126196ba47ddf35d1984b28cb0c16e460527cecb517c767767f7902`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a545c2b9eee0b0cc4e313f9f36b1fff6749a421e2c636404b7ba5b3ad85bcf5`  
		Last Modified: Wed, 18 Nov 2020 16:53:14 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7ccff297b8772868176b82836075f7962ac45834f6347a0f2ec3e9ac7abfa0c`  
		Last Modified: Wed, 18 Nov 2020 16:53:30 GMT  
		Size: 20.5 MB (20537274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:79228e47b29004c0416cb12e57eeec7de3f0bbd4427ae1f5f7c6520b7136a420
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181299807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ca2791f6c65f97c1eed93f800f819b23db21858a14d7dc30e903476d54e68b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Fri, 06 Nov 2020 00:40:01 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 06 Nov 2020 00:40:08 GMT
WORKDIR /opt/drupal
# Fri, 06 Nov 2020 00:41:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Nov 2020 00:41:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84105e8c5a135c6309b0db0d7e1d7de55d4a7d9f376e23f5b9b1c66eceb2aab2`  
		...
		Size: 508.3 KB (508283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8dec5c6d217d4835cb09edbece318c57ece721ae83eb7271b29c03f4be25f08d`  
		Last Modified: Fri, 06 Nov 2020 01:13:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f13e4f5eaef557724f17a7896113e0d1118faa9ff0063f8149bb3fe1d7bcc79e`  
		Last Modified: Fri, 06 Nov 2020 01:15:36 GMT  
		Size: 20.5 MB (20537755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:6777b67d221a7de4d1246cda416cae0f2f091a465a8463a1a414c85ae299b7cc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.4 MB (155377766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1312715f08755006924ad1e0ac43fc1cac0409280d573e1abb1d28626e4dda0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 18:33:40 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 18:33:41 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 18:34:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 18:34:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b2b5f2181748049f3e5bcf2a63365fc65be772722279af1a6ec9e28a0dbe846`  
		...
		Size: 508.3 KB (508282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ae8d708b6d71754dc460059328fd31deeba9480bd87424a714807c02dea0736`  
		Last Modified: Wed, 18 Nov 2020 18:39:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b600a956b346c4add9087767fb6f6f6407e85407d7f296cb2f8d27e3db67ae01`  
		Last Modified: Wed, 18 Nov 2020 18:39:10 GMT  
		Size: 20.5 MB (20537618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
