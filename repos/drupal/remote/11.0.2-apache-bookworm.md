...
```console
$ docker pull drupal@sha256:262fbd768cda68f07786e0d8124e50a047511c325b4ead88b138e0629f011bf6
```
...
### `drupal:11.0.2-apache-bookworm` - linux; amd64
...
### `drupal:11.0.2-apache-bookworm` - unknown; unknown
...
### `drupal:11.0.2-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.0.2-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.2-apache-bookworm` - linux; 386
...
### `drupal:11.0.2-apache-bookworm` - linux; ppc64le
...
### `drupal:11.0.2-apache-bookworm` - linux; s390x
