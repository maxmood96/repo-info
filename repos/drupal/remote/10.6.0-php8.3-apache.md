## `drupal:10.6.0-php8.3-apache`

```console
$ docker pull drupal@sha256:9e452635fbac5877178b4dfe6f0047005608b8f1c48299b6213ab4219faa3d78
```
...
### `drupal:10.6.0-php8.3-apache` - linux; amd64
...
### `drupal:10.6.0-php8.3-apache` - unknown; unknown
...
### `drupal:10.6.0-php8.3-apache` - linux; arm variant v7
...
### `drupal:10.6.0-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.6.0-php8.3-apache` - linux; 386
...
### `drupal:10.6.0-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.0-php8.3-apache` - linux; s390x
