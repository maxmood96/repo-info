...
```console
$ docker pull drupal@sha256:d49ce9553851d8dccff2e782e7c519ec714a253c989daae847f267109b70d598
```
...
```console
$ docker pull drupal@sha256:57f7dc9c2eeb0e4bd7c7a3655da22ff276ddba6dae44f57c446901dee7efbc52
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (157002415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ae4fe7451f5e39e84dec8ebd462464d3be927713e170f25f7b15861439ebc08`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 07:00:43 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 02 Mar 2023 07:05:17 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 07:05:17 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:05:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 07:05:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f69f9968757775e81b070e4a76257ad6f7d29aaae1bd984586e3a48a8af79c19`  
		...
		Size: 697.1 KB (697149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00bc8067cd0dbebace5e180460f4b8f9773d59676b1c94a36c498620553bd65`  
		Last Modified: Thu, 02 Mar 2023 07:38:27 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c13646f7848d9ecadaceda42208f268af5f45dfbb93c3073420f7a2cb7132f6`  
		Last Modified: Thu, 02 Mar 2023 07:38:33 GMT  
...
```console
$ docker pull drupal@sha256:60a0a15ea9cf24013ae367614ce2bb0b6c52939bd6eed144062c8cc4b38280a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.6 MB (189642830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f676b2e64a4e1f2b6cef7575986513937f7baa34276ac24db7822f24de9eb1c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 06:59:16 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 06:59:16 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 06:59:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 06:59:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1eefddca71fc94623bb355a3ed75884ce7105b4bf7c488a90563c80de267ff8f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66a90f3886cf878bcae810936add6d3166c220159966473f546240fcbc7fa93e`  
		Last Modified: Thu, 02 Mar 2023 07:31:55 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78a7860d19c8359303d28fbd0fcff428f7661376dba2fb057aa8fe946b21f71d`  
		Last Modified: Thu, 02 Mar 2023 07:32:02 GMT  
		Size: 22.8 MB (22844604 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
