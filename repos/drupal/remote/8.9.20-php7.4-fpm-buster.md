...
```console
$ docker pull drupal@sha256:aa08415c60fb1a317256074d05f1421bb29c77c28ddbdac58efcb2d80102d531
```
...
### `drupal:8.9.20-php7.4-fpm-buster` - linux; amd64
...
### `drupal:8.9.20-php7.4-fpm-buster` - linux; arm variant v7
...
### `drupal:8.9.20-php7.4-fpm-buster` - linux; arm64 variant v8
...
### `drupal:8.9.20-php7.4-fpm-buster` - linux; 386
...
### `drupal:8.9.20-php7.4-fpm-buster` - linux; s390x
