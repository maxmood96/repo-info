...
```console
$ docker pull drupal@sha256:f51c66efb1718b8bdece37200387006f78faeaff41caadc2fdf155c752b1ae00
```
...
```console
$ docker pull drupal@sha256:314d046f584e1b2c1482d36c427bb206c0ac2b0a00d9d38fd6faf61bdbbf991f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160634966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:174ac3b0a0497bce30cba78a265bd24d5cf0ad6c2af3d5d88a80642861e3fc00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 08:56:15 GMT
ENV DRUPAL_VERSION=9.5.3
# Sun, 05 Feb 2023 08:56:16 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 08:56:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 08:56:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3bc241651e99ac2dc0e3411e90895a962a9d74faa6a650a1c8926c70ae0a84ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5035e33ca5d6e9585417dc5059cdca65c7b28e1fcddd86217bae28322b523717`  
		Last Modified: Sun, 05 Feb 2023 09:26:58 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1b5fcf2e4eb9621999c48a90f3dbba74006b14d17599d3622e805f163587f39`  
		Last Modified: Sun, 05 Feb 2023 09:27:05 GMT  
		Size: 22.8 MB (22844352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
