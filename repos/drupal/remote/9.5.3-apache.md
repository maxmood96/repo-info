...
```console
$ docker pull drupal@sha256:b0c3d5bf3abbfc9ae3b9772fbd76dd5f20e4ef0202c9eed2aaf732401a691f7c
```
...
```console
$ docker pull drupal@sha256:6145877b4b1809f3453a219e6554e624043875961b927bc8ac0eccc7284ce3e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.1 MB (191130770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c908df8961a92ad9606a3e9f5e3f9aad2e669318d7e62021ad3cc25496c3c70`
...
# Thu, 02 Mar 2023 00:46:03 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 00:46:03 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 00:46:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 00:46:15 GMT
...
-	Layers:
	...
	-	`sha256:3681526a3655f1cfeaa085e2cdbcc9de88b2fbad59237c8bc226ada63f0042ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cc5b55b065bb278787e2b0cf96b782da4b117a9a8e995f8b13ad6db25a07cb4`  
		Last Modified: Thu, 02 Mar 2023 01:04:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a45ce0deb1e5cb30ab768d01cef508e3414348dc239fc9232a2fa4c18ff08403`  
		Last Modified: Thu, 02 Mar 2023 01:04:30 GMT  
		Size: 22.8 MB (22844976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:44172bdaf5dd0d30b729fbe89c780cd01de22b2b1970eb538666af6630ff2ba4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160599281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd1bbddc2733d7687d872205c42fad04983bcf83c0eb30f415bd14087ed361af`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 02 Mar 2023 07:04:58 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 07:04:58 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:05:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 07:05:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9dfc4e8e6c918ce6b6d57dd2cca052df4862246c470427414820942f20d0d78a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12d6ae73f802096bd2bde50e4b03609d0eaf328c42a3c70c8754ea93aca6d106`  
		Last Modified: Thu, 02 Mar 2023 07:37:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e73c7d980a47fb3fcb7d2f7921cf08211a8c80ac11ced8891ad890813ddd344c`  
		Last Modified: Thu, 02 Mar 2023 07:37:19 GMT  
		Size: 22.8 MB (22844798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:52fef65b500dfb4a27154500f0fb3ec24ec5d8f542e53b7f948c462eb1d8475c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185318966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fcb6cb3e2301cb37b6d372cf3e7b5fbc35284ca090f46786e4b0759741d5b32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 18:19:26 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 01 Mar 2023 18:24:12 GMT
ENV DRUPAL_VERSION=9.5.3
# Wed, 01 Mar 2023 18:24:12 GMT
WORKDIR /opt/drupal
# Wed, 01 Mar 2023 18:24:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Mar 2023 18:24:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:78979f8034e927838eba92f11c1155d2c07143455ace611682f1b4f80c9d1f4d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40c171cdf183914b92737d493e18215594380a7d676fad4a0d2aed949cfb0e79`  
		Last Modified: Wed, 01 Mar 2023 18:41:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b361f00fb188a0169b439511dda36382e6bd60d074436ddd9d394061eac7f46c`  
		Last Modified: Wed, 01 Mar 2023 18:41:41 GMT  
		Size: 22.8 MB (22844658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-apache` - linux; 386

```console
$ docker pull drupal@sha256:5e21f80993c9bf31aabae91d948374165bc6714833c9815616a0f8a661f326fd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (193980444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:423665e2656441298374faf749352187fa84aa096c4690beb1169eaef60be3ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Mar 2023 06:58:54 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 06:58:54 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 06:59:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:31e27eff331165d3b0791317cc7d9e5a69ec364e3987fce8429b09dbe1bce703`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c72342c60099dc6f487307df32aaa3c61f65777dc9da1e34063733ae6368af9e`  
		Last Modified: Thu, 02 Mar 2023 07:30:42 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:547db0aacfa3101ce4e6b346d8d8ffd65c48911b318f38e8ee64969325ef1601`  
		Last Modified: Thu, 02 Mar 2023 07:30:49 GMT  
		Size: 22.8 MB (22844574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:4d285cb0e84610739344b38f88c9906a60829e4d70cf1c6e3e39845d5e538c0d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191482729 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c300f746f1d008218c0c4032f46230cb4996fe6a844171d9e8a90474295c60b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Mar 2023 01:05:46 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 02 Mar 2023 01:08:27 GMT
ENV DRUPAL_VERSION=9.5.3
# Thu, 02 Mar 2023 01:08:28 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 01:08:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 01:08:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e4831b9bfdc8767e686d8ef8f29e8680878acd4bc842953a138ba8883ac6f11`  
		...
		Size: 697.2 KB (697152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d8e78fb61e139826b5138e5cb9dc53d702696a988a8233d8ba7ab84af8f1041`  
		Last Modified: Thu, 02 Mar 2023 01:28:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c49b670439c967b5350587830d0be53bd54a4cea18912b7ad61730b68e279f8`  
		Last Modified: Thu, 02 Mar 2023 01:28:42 GMT  
		Size: 22.8 MB (22844911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-apache` - linux; s390x

```console
$ docker pull drupal@sha256:f54851041eaac19c1196820c6f0ed748969e9cecc6d1274ff893be87ed502d45
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.9 MB (167909545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a74e93591562aba8071673fa0e6e8cad0e9aa65f014be22a383ea7f3709f0894`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 13:45:58 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 01 Mar 2023 13:47:42 GMT
ENV DRUPAL_VERSION=9.5.3
# Wed, 01 Mar 2023 13:47:42 GMT
WORKDIR /opt/drupal
# Wed, 01 Mar 2023 13:47:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Mar 2023 13:47:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:597babfbd6d152b71fc066456dadbe2183a4b67113aaa94110473db47995c0f4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:513990de337255de9fc60ed0c329e72d40cd99cad65e9fdf1e518b20cbc130f0`  
		Last Modified: Wed, 01 Mar 2023 14:02:05 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2634d2482648100fac51b8a949ef62885cc01222b8a114459665d1abb61b643b`  
		Last Modified: Wed, 01 Mar 2023 14:02:10 GMT  
