...
```console
$ docker pull drupal@sha256:19113a8ba3b0ec236744c055363eb4395a5af1e55b31774766c378b78a4a1bc5
```
...
```console
$ docker pull drupal@sha256:bb5c61b788ca659d5177e3eac60515803004a3a018c874f912d7a11b46cd8e77
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.3 MB (189302484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4b3266b9aaa5dfc9e1885f1bced9d68554885872af283d649d0d94eed2f3ead`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:51:48 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:51:49 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:52:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:74dae80b4d85a7cae5a97bed3a81459047d8199e9147a7ad8eb177a3afb9b9a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae7479a44fb40049f12bdb73f2e0a3bd975e74010ef8bf2f486ce371260b9a5b`  
		Last Modified: Fri, 29 Jul 2022 02:25:17 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f425b66c43277b58406c86347d0fdfadd2a30f24e392829e35623522f0fb13`  
		Last Modified: Fri, 29 Jul 2022 02:25:22 GMT  
		Size: 21.2 MB (21217778 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
