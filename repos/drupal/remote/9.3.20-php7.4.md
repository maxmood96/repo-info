...
```console
$ docker pull drupal@sha256:349c429fb74c054498d8370f5791fd308191f95ffb13d47dc06504a6d0cad54b
```
...
### `drupal:9.3.20-php7.4` - linux; amd64
...
### `drupal:9.3.20-php7.4` - linux; arm variant v7

```console
$ docker pull drupal@sha256:04a9ea84e397fb647d970f02da2f87f33f2d3cb20bf2e5312414faecddc2e676
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157260238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6127f19a9bfb70fbf7e03d948516b1614ea380171e9cbae59f607dea91baf44`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:17:22 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:29:13 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:29:13 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:29:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:29:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1198c3dd380075026e2b50e0b2eb744897976ec9563e839a70ad178f90dbebe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc01b00a1c3b212c1a54d1db3bef1aa48d1670dc33cfa6a363eb3665d1bbdde2`  
		Last Modified: Thu, 04 Aug 2022 10:19:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0903ca7b3cb12f6fec06eb1f1e17f21b0c221c1d01980ca13f167d3479d53470`  
		Last Modified: Thu, 04 Aug 2022 10:19:15 GMT  
		Size: 21.2 MB (21214265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4` - linux; arm64 variant v8
...
### `drupal:9.3.20-php7.4` - linux; 386
...
### `drupal:9.3.20-php7.4` - linux; ppc64le
...
### `drupal:9.3.20-php7.4` - linux; s390x
