...
```console
$ docker pull drupal@sha256:a88eea7f7e51263e827b456030f6bae41bd3fbda4e75e8917bebb4f77df79c5c
```
...
```console
$ docker pull drupal@sha256:5905acd80866ce80ac1b6973a17cc74590c4565d5828aebf5463a95482d3452d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182138859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:107f4bd063b637364e495e29c8abe79fcf409ad6c767269124c2adb5949eca4d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 21 Dec 2022 20:03:14 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Wed, 21 Dec 2022 20:07:59 GMT
ENV DRUPAL_VERSION=9.4.9
# Wed, 21 Dec 2022 20:07:59 GMT
WORKDIR /opt/drupal
# Wed, 21 Dec 2022 20:08:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Dec 2022 20:08:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:65edafb435743208d6a1bb29f761fe1c0f407c35985a51cf071b2b83222779a1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88479647e323958789331f306d5b0d2639f55d57c2bd013f5069064aadd7a373`  
		Last Modified: Wed, 21 Dec 2022 20:24:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc93bd4b5181759e1675017a1ce43d104e957eb751aa993d9d1946f0a683d054`  
		Last Modified: Wed, 21 Dec 2022 20:24:23 GMT  
		Size: 21.9 MB (21921807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
