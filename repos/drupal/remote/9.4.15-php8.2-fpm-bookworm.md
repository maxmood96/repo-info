...
```console
$ docker pull drupal@sha256:897bac1a575962f37e3368f54bde448836ea007010cf7d97abb863bde8caee28
```
...
```console
$ docker pull drupal@sha256:da34a6b3b1e7894e74052102d56a90fe6565c78cd237080eb16be52ca85a5a53
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171712597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:392d6b94a1aaeaf1990ab739e02f37bbd7220a07bea1699331ebcfcc4b2cdf25`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:43:57 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:57:24 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 22 Jun 2023 23:57:25 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:57:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:57:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:30a99a93f8a26cc84d2033ea0e9f0731a3afc15a624de5f9b18ea59f49496416`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15ec303636085ae997f10bab4ceb31d7d4328de0f49536058bce7efc06eb6514`  
		Last Modified: Fri, 23 Jun 2023 00:17:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:190f1a1d45441d7802060532396dd279dd2c1fbea0389464d1cd498908e0a5af`  
		Last Modified: Fri, 23 Jun 2023 00:17:37 GMT  
		Size: 21.9 MB (21915442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
