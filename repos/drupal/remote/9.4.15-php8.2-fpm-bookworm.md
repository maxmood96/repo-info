...
```console
$ docker pull drupal@sha256:1d9cac22f65af73e27619495b1607c9978a27ba6457a91dfedb202c21b1720c0
```
...
```console
$ docker pull drupal@sha256:efb050486a945af4bf47454a8dce99f76108aded6a285c3eeb8a4d113d5466de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202281313 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c21d7ca8c96ba6c5085d3969769c8c0f9a8fb3ba3effcb8800751528a4f2cbc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:43:44 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 05 Jul 2023 09:43:45 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:44:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:44:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:598068247e676a42af789083b30a99b104f81a6f07206be5051f2ec211858f11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5de7d4e0a918a34d3593ca5cb73d71f83c7b0b4f0859c095fd7d491621ae89b7`  
		Last Modified: Wed, 05 Jul 2023 10:25:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a5ae82d79ba4fc2fb120d09afcf26d8532904698938fa567da4b097f1320825`  
		Last Modified: Wed, 05 Jul 2023 10:26:16 GMT  
		Size: 21.9 MB (21915497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
