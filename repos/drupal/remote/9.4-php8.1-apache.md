...
```console
$ docker pull drupal@sha256:3725492513e2eb5e361a9a454aec9acfca1d410bae38d2713a2d7e644ebcb53a
```
...
```console
$ docker pull drupal@sha256:da56593c97f80760eef41bb523bc282eb29bf199eac6754847802927b6f17c5f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.4 MB (184358371 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79974485742a67de08a03b14c9abdca7b5968a4c878190dc84bb746df587176a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 16:03:26 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 15 Nov 2022 16:03:26 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 16:03:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 16:03:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:201031906b2088293d8dac69108794d8099d6ca1980f3f31af717776cd17cf7b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48c4a28f60fb6ba5daac038e3c2740c423fd2c44b0fa810cbd4b07c9519621f9`  
		Last Modified: Tue, 15 Nov 2022 16:26:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30de8e2b32c1b7a4bf5824b8577a13bc8459b63b20d39b2a43c6444a89efd21a`  
		Last Modified: Tue, 15 Nov 2022 16:26:29 GMT  
		Size: 21.9 MB (21903536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-apache` - linux; 386

```console
$ docker pull drupal@sha256:8a05240ba0c6ac3f591051953c96dab32edf448107f4dcf5ac7cebfa5ac7606a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.2 MB (192155565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e42e4b81f44074dd00f98d51e7d8978f60e8e7ffb1ea4d5c01c8e609a94a76e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:43:05 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 15 Nov 2022 18:43:05 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:43:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:43:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e65a046f1d3a137a4391f13642ce1b6e922ed0cac427730eb4575309ca3a5b02`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e04e393048b26efe25ccb5297d72c6812c5a321ad4b96caeb44316bb035dab2b`  
		Last Modified: Wed, 16 Nov 2022 22:41:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afde41c57c208524494da649f1a751ad5fdd4644cff66ae65e88cfe086a96c98`  
		Last Modified: Wed, 16 Nov 2022 22:41:35 GMT  
		Size: 21.9 MB (21906653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:392f7b6edba2e035ce90caab0a982a4aac740f1da75f93d5d032bd8f4b454d26
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166945025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d78f3656a075c15bba1ebc938ab116f655886d4797ba1a01b0f3932ce4ac66c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 15:11:31 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 15 Nov 2022 15:11:32 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 15:12:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 15:12:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7e0737aa6105bdefe8e6760fe85bd91805200c07f010c91cfeafad6ee187cd5c`  
		...
		Size: 695.2 KB (695197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:733839dd203841734842b076934d2a890202cd36151c5deb0cb76fc8544f9026`  
		Last Modified: Tue, 15 Nov 2022 15:50:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea9b0786c0f452fb907ee872b8061b24638961ced6715dd3551660040dcb05e2`  
		Last Modified: Tue, 15 Nov 2022 15:50:27 GMT  
		Size: 21.9 MB (21903556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
