...
```console
$ docker pull drupal@sha256:92863b37ca42b05811317d2c8e86eec3e9ae89e5a41a32aa85d7072852aefbeb
```
...
```console
$ docker pull drupal@sha256:3074f436df7106654c5f8bbe2d60ddbbfea69d4fe6b61e06b1dc3d72c41ea1b5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.1 MB (175057006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b967aa3e5d09c24695e58d8f7bd1239f9f5a8e1fe07dcb3fc755e03b66397d8a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jun 2023 23:47:00 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 23 Jun 2023 00:00:05 GMT
ENV DRUPAL_VERSION=9.4.15
# Fri, 23 Jun 2023 00:00:05 GMT
WORKDIR /opt/drupal
# Fri, 23 Jun 2023 00:00:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:966e729370707baefdab4538f4c14d577fc36471b516f02bf22d3dcf97f777f2`  
		...
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2fd49fd1b85dbc6f328e97b56095c502ae334639b73808ec8739363455214a8`  
		Last Modified: Fri, 23 Jun 2023 00:18:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6021601d4d1003a74366a8a4a8969e8baea23e4e692cbb6827eff45fd3e2725f`  
		Last Modified: Fri, 23 Jun 2023 00:18:32 GMT  
		Size: 21.9 MB (21915342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
