...
```console
$ docker pull drupal@sha256:6f5a34b80d12bec105b0a0b82fb08f32e33c4ff52f271c5aee735baf545a1410
```
...
```console
$ docker pull drupal@sha256:92fc584e7325c2e2b18aa977ec613f5aba9a9cca94dd315cd126aa22dcda245b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160102745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3072fb12a808c41d5e00de9c4d84399e20d113912b6d972eeec0e87f617e6ed4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:20:44 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:20:44 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:21:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 23:21:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f2d42f4209d46e0dc9b145f90b9c729f45aac19e2785582a0606a2c45ce3cab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ce63a1f5d5cdb8ca251d0f4be502a494d80f4e155f495b4d8d21055cbd6098e`  
		Last Modified: Wed, 15 Feb 2023 23:55:02 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b43c51c146a03ac21bd1a8d9c0a0eea9bcfdbd5c345a00bac84a2a84073dbd49`  
		Last Modified: Wed, 15 Feb 2023 23:55:10 GMT  
		Size: 21.9 MB (21911400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
