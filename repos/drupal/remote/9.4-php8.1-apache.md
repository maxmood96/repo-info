...
```console
$ docker pull drupal@sha256:267156a9581b6bfeb8ab452fb7a4e9839f5f729eccf638eb93deb196529390ae
```
...
```console
$ docker pull drupal@sha256:f79d65b879f582c499d16108962d0a0c2ea831d8a194c6c2a5f2788833d74c01
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167110639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fa54fc8bb76914fb03bd695a6f66cf9383f3782c423153c72adf8dba3c3a724`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 19:42:39 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 19:45:53 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 29 Sep 2022 19:45:53 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 19:46:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 19:46:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:12b6bf49cba60ade424edda8f137ac9641a7cdac771c67f9bc6d6d1dfb04825e`  
		...
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b734bd556596fe9fa5264d266c9dfab5c3c091d8691696acb1ca892e58f55564`  
		Last Modified: Thu, 29 Sep 2022 20:07:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:042ac0cca680e39835e894b092a6fce788620540fa05272e09054a5c13e3f932`  
		Last Modified: Thu, 29 Sep 2022 20:07:44 GMT  
		Size: 21.9 MB (21893590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
