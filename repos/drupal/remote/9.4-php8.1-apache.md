...
```console
$ docker pull drupal@sha256:3a2d8f81697fbeb6c4705a3ce33036c0da88f98f9aaeffb6d0b7e4b2d2e628fa
```
...
```console
$ docker pull drupal@sha256:74c3e9024042c9bcbbda351ae35aa6a4305baccb0352b44c3fe9aff2b3ca1ac3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.2 MB (190249310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccb78e8c8c29022decb09e7c740efb4c4a8d60626ad4dbf22660370269da4d81`
...
# Sat, 11 Feb 2023 14:29:14 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 11 Feb 2023 14:29:14 GMT
WORKDIR /opt/drupal
# Sat, 11 Feb 2023 14:29:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 11 Feb 2023 14:29:29 GMT
...
-	Layers:
	...
	-	`sha256:c06f759972869e0bca0f4a9e2541dcb1a660c64ecef65042b2cc19fd63d8c171`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbf74c042f6f27b4f53949d92efaa0b2ce972bf407dcd056558a78cb4466e68b`  
		Last Modified: Sat, 11 Feb 2023 14:48:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:883c0ae1e85e7f521abc1652ab8c171e7200606eb997b161189051cfe0755993`  
		Last Modified: Sat, 11 Feb 2023 14:48:45 GMT  
		Size: 21.9 MB (21909882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
