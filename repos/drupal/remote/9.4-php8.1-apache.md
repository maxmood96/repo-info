...
```console
$ docker pull drupal@sha256:3f163cb41c6a16767c8e7247d378d3b4c0023e6422c934d1dc895780c4e41788
```
...
```console
$ docker pull drupal@sha256:e196a2d98f6bf5e55537b0dc543d04acf764227a120ceff53330ea13e4f95e21
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190584885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c918bcdb1bab6fc698774c221a8cd6f2c83054a9e27321b2f04228e90343e97`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 May 2023 07:21:24 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:33:28 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:33:28 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:33:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:34:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:36017ac9e55dc0373a624fac06b06bd08c3a6377408d42a350d5c04698184033`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffeffc8e264cf9e84789930624e10442877e0ceee52ec32a2c061ac17e8385fd`  
		Last Modified: Thu, 04 May 2023 07:58:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0fcd6ec3e94b04c314c895b82c9974065a245f2585950ad73a9119fd6ff170d`  
		Last Modified: Thu, 04 May 2023 07:59:01 GMT  
		Size: 21.9 MB (21914706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
