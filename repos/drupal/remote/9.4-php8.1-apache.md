...
```console
$ docker pull drupal@sha256:209bac7f1e020688e4ec5e965d8f7ddc4414bb4abe877cb15d908f29640758e4
```
...
```console
$ docker pull drupal@sha256:cbc69afddfa515bafbadb4e0b1d92c2c18d1235e889600c540b959aa34abe728
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.2 MB (192188292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:696413aa99a8fc67e047f8fa7410184ed8e4f040ed1611f4bfc70db9542c1979`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 05 Oct 2022 15:18:00 GMT
ENV DRUPAL_VERSION=9.4.7
# Wed, 05 Oct 2022 15:18:00 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 15:18:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 15:18:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a9b99d230134217753ec9ea6359e304b8ac6c4385edc5c19eb860ddb0849fc2b`  
		...
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:236c1aec595019721e33a49444b1522813ced74f613e5cef8117854e64d97cf7`  
		Last Modified: Wed, 05 Oct 2022 15:51:05 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2d7f9bbe3784e8e53a84304de7164335fea4865563e8e50b9fe4e3fb880e91c`  
		Last Modified: Wed, 05 Oct 2022 15:51:11 GMT  
		Size: 21.9 MB (21892763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
