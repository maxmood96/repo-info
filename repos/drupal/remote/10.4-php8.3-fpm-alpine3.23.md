...
```console
$ docker pull drupal@sha256:e194a643f88c65db7123ac6519558379e05c7c94879022846dc3ad7a39335e9b
```
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; amd64
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - unknown; unknown
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; 386
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:10.4-php8.3-fpm-alpine3.23` - linux; s390x
