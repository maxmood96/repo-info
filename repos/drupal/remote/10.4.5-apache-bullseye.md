...
### `drupal:10.4.5-apache-bullseye` - linux; amd64
...
### `drupal:10.4.5-apache-bullseye` - unknown; unknown
...
### `drupal:10.4.5-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.4.5-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.4.5-apache-bullseye` - linux; 386
