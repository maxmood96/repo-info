...
```console
$ docker pull drupal@sha256:6eecf70232b062280467fb968833fcf12e33fbf308a6c05165f4cefe582fde41
```
...
### `drupal:9.3.8-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.3.8-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.3.8-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.8-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.3.8-php7.4-fpm-alpine` - linux; s390x
