...
```console
$ docker pull drupal@sha256:7f2cf4456f6fa0ea415b00abd9cab657b5dec97b44e80685e6aff0c3e176325c
```
...
```console
$ docker pull drupal@sha256:b8590032f51e599d245cdc657ccf37c4f4850660cb1ff573b703a72374589d6e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52400480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf8335873b0912a04662cb3d842c7a9c2f8819fb55f6a806ec16d265e0c721ec`
...
# Thu, 16 Mar 2023 00:31:07 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:31:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Mar 2023 00:31:20 GMT
...
-	Layers:
	...
	-	`sha256:ed68936477730381a8ed6ce22b14649f2e7f1c4b854a2436352044e93b2cedb1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:719177609b6988a10e1704142d25c01fbb82c826beaf1ad6891fe0a4d88abd5d`  
		Last Modified: Thu, 16 Mar 2023 00:52:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4125720fd3664cdce03074464f89f7bcbaa81740f0f6d430d489e24fcd9ebace`  
		Last Modified: Thu, 16 Mar 2023 00:52:24 GMT  
		Size: 21.9 MB (21901618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f153fda9ad56d1a2f3d04a06a89a1e999111e5407f67e47399e395eaa52e48d7
```
...
-	Total Size: **49.5 MB (49452795 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e48f3ebb3c0f0045feaecd770b5429ce273865fdee2257d998f5b96a6a633718`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Mar 2023 00:18:00 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 00:18:00 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:18:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Mar 2023 00:18:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26480e0bfc68bf429c98565f795c3a499d3cd7c0dbeeeb28d01d8531f4ec2866`  
		...
		Size: 697.1 KB (697146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cdb70312a904d8cd8da959bdb558f48909fdd5d53ff61d7c06caa4d2e652b4e`  
		Last Modified: Thu, 16 Mar 2023 00:51:36 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0938645bc01b1ad850e709ec65b006a248590cf93b7da37199ef5d7a6e18bb9e`  
		Last Modified: Thu, 16 Mar 2023 00:51:42 GMT  
		Size: 21.9 MB (21901671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.0-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ef7c436d196af7cde557d485b5b8e9fa393aa578f2e4b338bf29c236897f4767
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51391485 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68dbd10faa4b3622a71e24352b6ba73b6ef537a3e3561f5a2d640c92c585d761`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:58:53 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Mar 2023 00:52:54 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 00:52:54 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:53:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Mar 2023 00:53:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3d88f6692ec4be3dcbd33e301bc5f4822589dfa6d2fbe46ab2f489928aab7c01`  
		...
		Size: 697.1 KB (697143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de9a49c296a08c3c9835462428db1e2dd19826857b0cefb233fd9bbe4a19d950`  
		Last Modified: Thu, 16 Mar 2023 01:14:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20016e9ddf03987c397cdaacb3a2aaa0ddf50ff604eb8db488ae05d11846c984`  
		Last Modified: Thu, 16 Mar 2023 01:14:15 GMT  
...
```console
$ docker pull drupal@sha256:4a7f51d355e413e6f2cf7b570ed03b7baa02f647fd4df70d5b9e7fbb95142fa5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52838671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91415501ca73746845f35368dc0b9690f2efeddb3d10de37be07e8aacce8a855`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Mar 2023 00:52:15 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 00:52:15 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:52:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Mar 2023 00:52:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b077ec6f394bd96d7e7a9ad9c0e933d2a0a165c218d735bf6fa83956e9eb7404`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad38e328337677fc1201d9f380ca70650574b0d5f301061873ad9be913091f9b`  
		Last Modified: Thu, 16 Mar 2023 01:25:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c668784e4978025f486ca6294654eed352202094345f388631b93ea429538e5`  
		Last Modified: Thu, 16 Mar 2023 01:25:11 GMT  
...
```console
$ docker pull drupal@sha256:d1b884c0b18e9abcade47bd85a165d5d4cc52a9537c6c189097431eebf2294de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52682182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7923a059d1b8e62821729bbc2d02509d098baf6604cd7863fdd8a398d5f782bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 03:11:47 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Mar 2023 00:36:32 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 00:36:33 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:36:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Mar 2023 00:37:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ecc5d33d45b85d922fbcae15439085453f36eeaaaa5de3504274daf08415f1b`  
		...
		Size: 697.1 KB (697146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca0514d5fe81f93d34be221a5d8e090987e473cfb5483f9a541b9dadd0a18838`  
		Last Modified: Thu, 16 Mar 2023 01:10:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:793d998a1de59c9289ab3114f149aab64c7f4be26fc169a19660295f56de7c7e`  
		Last Modified: Thu, 16 Mar 2023 01:11:29 GMT  
		Size: 21.9 MB (21901308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.0-fpm-alpine3.16` - linux; s390x

```console
$ docker pull drupal@sha256:298eae1703139d4760df92679ca02088d927aa69dbb9f46388023b5f6e4ed691
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51137497 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be8b396f196bc12c7813c9df180be95d19e192d0c312b40f3349378f4b3824a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 01:49:37 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Mar 2023 00:54:14 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 00:54:15 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 00:54:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:ff9fce1dd024e0b06bacd7fabf89773b30a835e3bbda64831707a6c9fc1b39dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0aee1ad87f2a593d166274db961e95db01f8d3aeacd1fc983ba481f3d7b80ca2`  
		Last Modified: Thu, 16 Mar 2023 01:10:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c109fa95361a0ae89be74845768357038cfc63648d9fcbffe6e44d202575e02`  
		Last Modified: Thu, 16 Mar 2023 01:10:39 GMT  
