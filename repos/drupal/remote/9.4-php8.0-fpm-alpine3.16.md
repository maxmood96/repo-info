...
```console
$ docker pull drupal@sha256:85475188242393aaa9171d614d775bbaa7f2d02b7cc8e89a728947db96ed7f30
```
...
```console
$ docker pull drupal@sha256:e2d46827fd79d58fc73d7301ad2b09326013612bdbdeb866075d47c4523d145f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50589808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8852f4a3812f633aff06bd6d28d585dc4bf386cdcaa9fb45d9ea73d9c6d90eb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:13:40 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 02:14:48 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 02:14:48 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:15:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:15:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ed6eaa323c0aab5d53a28db4903f03cf096e02c336eabff9313dec5041771b8`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f7d07984da7805caba52ca236622824a60263a1307198dcbd32e782f57fd5ce`  
		Last Modified: Sat, 04 Mar 2023 02:21:56 GMT  
		Size: 697.1 KB (697145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a0b3f8339be93703920c88164a1010cb42eaa2aa58dc6999d50d464a462a84e`  
		Last Modified: Sat, 04 Mar 2023 02:23:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd4380ecfc0e9e1c39eb8967949c3a9c45ae67926ecb99ef14c226f6ec6234b2`  
		Last Modified: Sat, 04 Mar 2023 02:23:24 GMT  
		Size: 21.9 MB (21901631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
