...
```console
$ docker pull drupal@sha256:0b921312acb15aa4eaf658b56986296fb0d5e061e6db524cb5a7bc08685e2930
```
...
```console
$ docker pull drupal@sha256:2e75e57db859b62853af87ab4c8e3201dfea4927aeee0784a1d50be9d33aca48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50590032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:029aa18239f11329922f643872953edd96b507da03004ccf9d9a494c8d1d319a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 03:13:07 GMT
WORKDIR /opt/drupal
# Tue, 14 Mar 2023 03:13:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 14 Mar 2023 03:13:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1d00bfca403c019cca95dd7f6ebcbdad794720a28394041a6b9c7f775e52f568`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9919b5661f2518db2bc49ce04e53c83c6677343d35a685f5d018539382011ad`  
		Last Modified: Tue, 14 Mar 2023 03:21:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8e73975cf9b3f3a12d715eb29c61bd85b7bee01310f62effb85d72e72aad21b`  
		Last Modified: Tue, 14 Mar 2023 03:21:40 GMT  
		Size: 21.9 MB (21901817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
