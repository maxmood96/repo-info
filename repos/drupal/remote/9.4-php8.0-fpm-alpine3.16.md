...
```console
$ docker pull drupal@sha256:220a10c309df5dd50ebd2920265684c48307492eb8ba169b612aaa767949eb08
```
...
```console
$ docker pull drupal@sha256:335b9d42c67d947ae5a23b7a0d7661a9f3fcb1be4c10d83fc7a26eacf31b76dd
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49452282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:391bab0c648c666ce2a7e5dc90293d01b08387c671c4eb67eb6613ce87cc394b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 23:20:19 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:25:37 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:25:37 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:25:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 23:25:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0e09cb1a0ed4f063f4372d37a077da61e3aa77e4528c3c35d258daea3b5d76b5`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b91cf6cd2554d498f20b6df8bc1f9057ce4c925f6a78eba8b767e87a980e864`  
		Last Modified: Wed, 15 Feb 2023 23:54:40 GMT  
		Size: 697.2 KB (697151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f95e7140541e963daa707edea9a5d12570c6bbd662309b0044f50e44ebd5ff6f`  
		Last Modified: Thu, 16 Feb 2023 00:00:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7902815d2a02bc29ceabbbb53a792c3b8e3b79cba44845e65005505660cfe3fc`  
		Last Modified: Thu, 16 Feb 2023 00:00:29 GMT  
		Size: 21.9 MB (21901834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
