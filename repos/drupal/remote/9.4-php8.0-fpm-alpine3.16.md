...
```console
$ docker pull drupal@sha256:e6505d283342251f4710cb47a2906f6093f91abcfbad656d79e715541fbcdc7d
```
...
```console
$ docker pull drupal@sha256:ea7afed8e2d19c2b85b34602ed4cde2cd62f896ba544eb925a0111f124668af6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50596548 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39348db8bca0bfda6fdc51589b9a6faca648e6896345ee5ded8b2f24877a531f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 04 Apr 2023 01:49:36 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:30:33 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:30:34 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:30:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:30:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a90fc392f7dee9b633ac7e33bde0ba12745bfc6538fbb33bb0d97d4f1683e6d1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ad7c1e041d4e8ea9ba90c65ab3e7b8ab990e8ba597e4699006feb77dd7b07e4`  
		Last Modified: Thu, 20 Apr 2023 22:36:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e427df5a625b2ec945c3bbcdf0833a5b3a8d1b6ba527d8fee230a531469c254`  
		Last Modified: Thu, 20 Apr 2023 22:36:42 GMT  
...
```console
$ docker pull drupal@sha256:deb6c9d54eff9457a987db197d98891284b48c359df52d0f4871e8db4409144f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51143761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbad4c9575668c68f831a251b74bb7bba8915fcb78e88f02e2c471a30dfc7e3f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 30 Mar 2023 03:55:42 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:53:32 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:53:32 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:53:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:53:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1e4721acdf96929d35df1825042831a271278c3790103ae59e7311b096b96ef`  
		...
		Size: 697.5 KB (697529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e0f2365449bf78c99d59acb0fbbd11b377f28f12dcd3bebff27e034745ce59`  
		Last Modified: Thu, 20 Apr 2023 23:02:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e94266c6508a63dc1574c458764548331bcea490a1524d2c156a8dcef4864456`  
		Last Modified: Thu, 20 Apr 2023 23:02:13 GMT  
		Size: 21.9 MB (21907531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
