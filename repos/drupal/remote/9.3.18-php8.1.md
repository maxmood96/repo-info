...
```console
$ docker pull drupal@sha256:9f63e2b6a4ee6dc92cc2fd5eddbb1407a903cee3e52c843a2a3372b9b633b676
```
...
```console
$ docker pull drupal@sha256:5aaba9b83b04fc178a8539531f5ab5ba281b0110c81a801ce5df6c1a76df7294
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191816626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89c61506fc4edc101b27dbff173915cbc7a9bb0d6eeff156cd8a77f07b471371`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:52:30 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:52:35 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:53:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:53:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c0ca471d0b9de94d73de4af4a1f48518d4bb95d7a4368bd1f671a81d34ca0719`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a51b5272009cd2d1e9b7c2b8b9b8ef896aaf6b8450a9cb327c6f183b46b5346`  
		Last Modified: Tue, 12 Jul 2022 02:33:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13ba7044e75fe445cc9919cfa8717ca6f46ef7d182e21e4589f9bf087ca91b1f`  
		Last Modified: Tue, 12 Jul 2022 02:34:08 GMT  
		Size: 21.2 MB (21216756 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
