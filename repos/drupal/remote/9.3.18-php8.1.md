...
```console
$ docker pull drupal@sha256:798f97aed4255bf2fbf081a222586170979d4adf51e3ea3989bb0c145ee3169d
```
...
### `drupal:9.3.18-php8.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d36b279a8f06fc543acc7bf85b8082f4fb65f043f5e3297430eb5481f12d962c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158878498 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c4ae0055dc8ed428e80945a3f9e41edd21564a31ceb85fdabc925927e392490`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 13 Jul 2022 14:01:30 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Jul 2022 14:01:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 14:01:32 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 14:39:08 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 14:39:09 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 14:39:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 14:39:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73ef52b4c2269803cc300680cc7038cef1458d74789ad6bfd3ebc1e14cec430b`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b9cbf19aad0c1a6bde60295cb697a84d1d6b5a2961f6e400f83c92c5bfb283c`  
		Last Modified: Wed, 13 Jul 2022 15:17:23 GMT  
		Size: 1.5 MB (1514283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc4340af4401b90d54183c73d23e7c0cd44cb3d25e18f553b531f6b409d50492`  
		Last Modified: Wed, 13 Jul 2022 15:17:18 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc3c3e017e349430e6cb6ccf2d21b23b825853fa678cc0eb02c983062bdcca0d`  
		Last Modified: Wed, 13 Jul 2022 15:17:19 GMT  
		Size: 670.1 KB (670052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d256ad08c12b758da0a51a148d0cff31bc589e89115b86caa5297f3aeebffe7`  
		Last Modified: Wed, 13 Jul 2022 15:39:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3cbcb55c21883eaa97efacf2cbf409483260b7c929d830e548013e2c1b705b0`  
		Last Modified: Wed, 13 Jul 2022 15:39:50 GMT  
		Size: 21.2 MB (21216784 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:9.3.18-php8.1` - linux; ppc64le
