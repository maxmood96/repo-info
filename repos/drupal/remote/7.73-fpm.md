...
```console
$ docker pull drupal@sha256:f8b070edbb0ca61a670c31dbd399de30f99d779e4c4b2550cddb7a09f77859a3
```
...
```console
$ docker pull drupal@sha256:6812d1414e2d8b7e4523b72373dac7fd0111f7582c0321b1daf8cc9c56329001
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **123.8 MB (123803436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e77ad4a9e5853e414808e44246707bf04c47894c8803dc66a34f4841723b5f80`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 01:02:11 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 01:02:17 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 01:02:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:257664c33a7414041096ae77f53bef8cf34d7148eb5f72785bf0c95ed27c1535`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7814dfec58ab7748a250873704d128ac4d77076eb1845550bc06df9421c1e14`  
		Last Modified: Fri, 02 Oct 2020 01:12:08 GMT  
...
```console
$ docker pull drupal@sha256:26f4c93a03430de1f66f845effb8316d059b22857e9cafe73148ce75c983cb5e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140132922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7bf50ec752f165a059e86340fa03f174aa0043db00e30f373eedfcb25b41357`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 03:03:01 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 03:03:05 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 03:03:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:79b27c2e7cff7504685f8cc8062c974b25927e1abf94ee8bfa57396dde1f17ac`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41e1d51bc4fbcc62c76537449381e643ee8b7a5d9bbd3f32d40c514f845e3c93`  
		Last Modified: Fri, 02 Oct 2020 03:08:41 GMT  
		Size: 3.3 MB (3344571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:aaae92a9e6a0713684a1e1097270ccf25c9833c8bba32cc29bee4d04371f78d3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.8 MB (153806862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68472cdb7c22bc92104498bd9a8f5efeb67b5e71f811964d8615203c51c0a2ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 02:16:15 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 02:16:15 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 02:16:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fc351e156ea86dca9f875a900124d93b08530c5ab6baaf7411443c3d34a8f33a`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50698435c17970b33cf3c73660fb732f2d29fe4eb4d805e5c67793da17cfbddf`  
		Last Modified: Fri, 02 Oct 2020 02:22:02 GMT  
...
```console
$ docker pull drupal@sha256:22f25afd711e454f6709acf1a1f74e9306d358ea4c32620bc88c6db8c9c98ad0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.7 MB (130707683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d2bca6252d3b7dbc9065977c01e7f92b56a003f436751653a64ec85c6c446fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:ddc3de7851c539bfeb6a33d074cc6874874c2f1e0685cdd93e5eec184e5bef61`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cb81ee915469d90e47e7d43dae54c75bf66a9b418cd50d52858204dff777d34`  
		Last Modified: Thu, 01 Oct 2020 23:23:02 GMT  
		Size: 1.7 MB (1666710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec3baa08539566cdb71f2ec7f6ac7d7cc164e3b9010a8fdb34485122e5a1964d`  
		Last Modified: Thu, 01 Oct 2020 23:23:03 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a45b8a5be6b411bda54f9e543d0fae56ef754fef81513264d5b1e30723dde4c`  
		Last Modified: Thu, 01 Oct 2020 23:23:04 GMT  
...
```console
$ docker pull drupal@sha256:bc25ad90528cb6856676d71aec97683b18a4b17f06bfafb0c525f2030d6f8594
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158883660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77bdde38e87ba24d21d15e6e6a8e271be787bc3f6ac99367103eab21d9feb28c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 03:28:26 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 03:28:27 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 03:28:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:44eee7dc5fce612453bc8a71c46cd67943fdb76efed6dff9cdb9f3898c8c8dee`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35a5f8816478a31d9adf4070f5397db34c86ecf814319de8558bcb2c388a982f`  
		Last Modified: Fri, 02 Oct 2020 03:40:43 GMT  
