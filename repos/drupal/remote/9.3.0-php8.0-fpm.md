...
```console
$ docker pull drupal@sha256:2ca1e9abacda206fa7dcf0264b4c79848f63902af4a9d78f89531f727353c72c
```
...
```console
$ docker pull drupal@sha256:53f839b3f1cd5d54b27f609a6b5a200b448c26c055e670bb88e1ac0c0ceffac1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.7 MB (186663305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5356bddec8e4fb240381c44ca717624eb65004b979e7d5382b0b777d603495c4`
...
# Thu, 23 Dec 2021 20:36:00 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:36:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:36:11 GMT
...
-	Layers:
	...
	-	`sha256:eb8ca4f9d920972117b7a34d4f0ffcca612cee046d98463b24cfead177d50555`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:246bbfae4be6ed5c442e5105f1f1eb2c93d769994e838729a75c23d9748827fe`  
		Last Modified: Thu, 23 Dec 2021 20:46:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af40efd47b7ccaca052cac95503182e78c7cded0d8c8a09b14b0d0a17ba0360a`  
		Last Modified: Thu, 23 Dec 2021 20:46:34 GMT  
		Size: 20.1 MB (20141894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6b13efdfaf9caa04568437815df78978d694d93e72a9664febea0f8d3478cdae
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156253275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b942ce8149cd44e1766fd5daedf87395f42ef7f787224325e58bba40d229264f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:17:45 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:17:45 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:18:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:18:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7bde01e20dcfd998254b679976f5fd1cbb21196d3e3c279c7cb8a848814f1143`  
		...
		Size: 573.3 KB (573318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8883d0590188d2ee79e0e7d31da532f82473b606ef001fa8a1a6ce56a719db8`  
		Last Modified: Thu, 23 Dec 2021 20:55:07 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:301a873140ea36d720e718990de251ed51812ba7b7b9610be85920baf6f06636`  
		Last Modified: Thu, 23 Dec 2021 20:55:36 GMT  
...
```console
$ docker pull drupal@sha256:6ffaf70e7ff3ebd3515d24a7ca93bbb084d6500c0ef86c6ba74a565f1699091a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.0 MB (179020992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2135e80721e91e6a9f4d48f3d7b2ad149a49967bf2ba222244bc00a8bd926989`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Dec 2021 19:56:59 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:57:00 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:57:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:57:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1c3077404ec82515a720f49fbcf9fcb20d53c530317ea9fe10f088491b6a0c1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20981388b08334ad65ad3f1931126e6d38fa54b1baa18ee60a0e5d1602c55c88`  
		Last Modified: Thu, 23 Dec 2021 20:18:00 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f42537c25ca1868c0856fd7c4f017ff1b466f5ba151bc2db02f8a42ed54f1c07`  
		Last Modified: Thu, 23 Dec 2021 20:18:06 GMT  
		Size: 20.1 MB (20143288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-fpm` - linux; 386

```console
$ docker pull drupal@sha256:c6adf75667fbd3e5c75088a2c33009abab15e96df3de56c1940f5d830c14fbd4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189366360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51007f5e4b897c0ae404dbb2ef9b296733df976bea5eea93ce637573638e5a1c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Dec 2021 19:56:09 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:56:10 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:56:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:56:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3526470da0b7d69651ceb5afbb11bc3ec1b7528f6960d592cc2b6bd07119bf70`  
		...
		Size: 573.3 KB (573317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bdeb287b4a82b1c33def983910a977e589b9ec7aeaa20a961f6be67ab5895e0`  
		Last Modified: Thu, 23 Dec 2021 20:14:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7726e2cdf6ddc2cb4378cfdf20ce95986f7dfd316315218b2a6642be2faba88`  
		Last Modified: Thu, 23 Dec 2021 20:14:31 GMT  
...
```console
$ docker pull drupal@sha256:d2030bede6000b7c7e34725acc90868a793f805a7938c2d1cc2af38cfce0c686
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.8 MB (186807779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:581d6a55e435f7524d5d578ea23490071e98cfb0ab1c4477f3df226f2ecee6f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:35:16 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:35:18 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:35:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:36:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6836940ce733a1b81f11eebbb099513a760aad7d4e04127736d9b5a0cd463622`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bddeaea798d8e8f0a680353ea53a166ada7443de0ad2819254e31ee072e8599d`  
		Last Modified: Thu, 23 Dec 2021 21:06:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87680ae08895eb41c00e2274f83a77d819315a7afc411b97dd719e17c99260e9`  
		Last Modified: Thu, 23 Dec 2021 21:07:27 GMT  
...
```console
$ docker pull drupal@sha256:8a8c2663d36f7d197b7050fe9ebfd1cce04fb27d01671b1fdc8fc237fcdb53f3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163422017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2211d7b01c6321733e9425d9ada383f6815d7449d716ffd45e14326dfe292fc7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Dec 2021 19:58:35 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:58:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:58:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f3e71d94d16f4219417a456630a6ccc25d63853a3c30e740c88ca60e2645634b`  
		...
		Size: 573.3 KB (573317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30b71971ab73dff4ac479a6da016e4ace66ac2f908205e8bbae2fbcb949535d9`  
		Last Modified: Thu, 23 Dec 2021 20:16:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0f1fe6ef6e5ae083309c451f99cfa0e29386e1d0c5cfa99113b33367cd999e3`  
		Last Modified: Thu, 23 Dec 2021 20:16:44 GMT  
		Size: 20.1 MB (20141330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
