...
```console
$ docker pull drupal@sha256:3037db6595c3332f9162a38d133b968f27b023d28f0d4499de3304e437e71252
```
...
### `drupal:10.5.11-apache` - linux; amd64
...
### `drupal:10.5.11-apache` - unknown; unknown
...
### `drupal:10.5.11-apache` - linux; arm variant v7
...
### `drupal:10.5.11-apache` - linux; arm64 variant v8
...
### `drupal:10.5.11-apache` - linux; 386
...
### `drupal:10.5.11-apache` - linux; ppc64le
...
### `drupal:10.5.11-apache` - linux; s390x
