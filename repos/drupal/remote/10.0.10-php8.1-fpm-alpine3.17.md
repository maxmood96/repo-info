...
```console
$ docker pull drupal@sha256:3fb2e24d903e7921d25f3783329db07e6e2fd8ed5365f9bc9b773b5608550d48
```
...
```console
$ docker pull drupal@sha256:30384706c9dcd3b41dc94a3108ef9832c8a771fd477ad6457c423a36940bb450
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50293759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c340fc36d615b90a6a1ec2cac7bc72182d4a500c04a38ecca66feab3faece9d`
...
# Sat, 02 Sep 2023 09:32:12 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 09:32:12 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 09:32:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 09:32:22 GMT
...
-	Layers:
	...
	-	`sha256:ac7c940d49d4709a910ef0a1ae3839a87936834f72c308a272b90d7523d4e816`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d21f97caca03f00c314920fe30820cc545f08e41f184db30cfb4284803ccd34`  
		Last Modified: Sat, 02 Sep 2023 09:48:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48722834f1188b60f5dfae9bb1f20a1023fb8a306612c58cd1c9aa38eb4c2597`  
		Last Modified: Sat, 02 Sep 2023 09:48:59 GMT  
		Size: 17.7 MB (17688202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e45b22b35cbcc943e2edf02ccb79b7822d8425a85ac14670d9c0cbf9abdde88c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50388491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1490867ef0e76dc6e778610636d7be6e92decba3bc4fa8c57bbad2e84aa9ef95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 08:24:57 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:27:30 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:27:30 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:27:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:27:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a3cd5e46fc1a3ffabb1a9e32c3faa4c309eb67901356393ee571b96e99da9560`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8d94e9f0ddaf91238b78ad88b58f26ff21fb8fd1c9549042351732f62809308`  
		Last Modified: Sat, 02 Sep 2023 08:43:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee75290b5411a74ff0e965728c58d32ed84aa13ee52f6c47e77ca633a4698bd6`  
		Last Modified: Sat, 02 Sep 2023 08:43:28 GMT  
