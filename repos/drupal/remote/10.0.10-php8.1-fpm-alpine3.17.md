...
```console
$ docker pull drupal@sha256:f0ac6866760fa03f262cdf48620d7493baf7be2e27072e734f26c086261b243a
```
...
```console
$ docker pull drupal@sha256:48ebf3083e7a6ba2f3a675a0ef6e6b8bc5d950f0fd6fa02aac63a2ca50c87d22
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50809248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30343d6dddd09ac7940611ebe017f6e5f8b4c19569b125c0ee46e8473c363e65`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:07:37 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:07:37 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:07:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:07:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9945f4fc0dee36b26f0b173f145fcd9199e983cb2f9222a8228d20e2d81d862e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:464f6f79bec5215b8d37e0868d4ef6b531bcb84349567cec859f65a97bf0b4e2`  
		Last Modified: Sat, 02 Sep 2023 08:27:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44e7dbf5a42f11b513eda4b0e8e70b2560e32865ae36e8be963af2aa406499fe`  
		Last Modified: Sat, 02 Sep 2023 08:28:01 GMT  
