...
```console
$ docker pull drupal@sha256:bf2b6ed3fa756cb2992d8d9b4b04f215d03ae7017ee07a935d4c3b3e99f8ccc5
```
...
```console
$ docker pull drupal@sha256:69fa03e0fa9f7f7cd32c945e5d088ec62bd003297bdc5741fe9130588be847e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167327870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a3b17cccfb30c744dc090218719446b364c6afd47d1466e1e409f7fcc463b69`
...
# Wed, 17 Aug 2022 22:11:35 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 22:11:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 22:11:47 GMT
...
-	Layers:
	...
	-	`sha256:11ab7b9c79f7741d35de3d7da45065aea5ffe676be6071e21f3b54fce98d2489`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be3eb5b57204f2bb02c18df14dc3a6b4b79ae8859c5922baecdd4f93599abbe2`  
		Last Modified: Wed, 17 Aug 2022 22:39:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20fa89815367d2697c030de74e12070749a5b943330eda03d2c9c5792c0fdc47`  
		Last Modified: Wed, 17 Aug 2022 22:39:12 GMT  
		Size: 21.3 MB (21312630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:353555c7d439a8c1b157dab04bfce5a27d6fc1e2d9c6b0a09cd323d7d872d95b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.2 MB (143183701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c72208bedde5f8267661c5fc3f9a2e25646763db174729d6f2bdea112f0a106`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 21:50:31 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 21:50:31 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 21:51:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 21:51:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed9fb8a521ecbd5cb4489f18f3b102459f731aab32911e1b2d5a2e707637fff6`  
		...
		Size: 691.9 KB (691870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e300e40815f59abcd9386ec5a1e540f3f52b36cee9857051bc31a289435190`  
		Last Modified: Wed, 17 Aug 2022 22:38:31 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0478c9937dab2e2f65ffe468967e4d902a5d9e36d8a40d8cec1092d4f9dfe1a`  
		Last Modified: Wed, 17 Aug 2022 22:38:45 GMT  
		Size: 21.3 MB (21312524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9196c5100fa6ed43cc3a592df4946581e1588b31866f4633a0b7fe86e4040258
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158830140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce65d0b85cdeb41c599a8f2ec578de4d8fae02a787e73b35f980c22913ed6845`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:16:17 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:16:18 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:16:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:16:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01f8d8b3f8dafacb9a63fa645291c79955a9286a64251886946e29549c8db81f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:697b3d089661ffecab6ad2491e3e3f941ea7d0590c7e970bc20aa89edbd48919`  
		Last Modified: Wed, 17 Aug 2022 23:53:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:950f4ca91bcd27592cbb6ae96778d53795568b3bebccffe7d07df5cfcc7a9bc6`  
		Last Modified: Wed, 17 Aug 2022 23:53:59 GMT  
		Size: 21.3 MB (21312036 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:d5f98eaba79ee0142b24e13ab7c771c5a9382d64c239ecde4339041ee264e153
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172652692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68869a23f594ef329732d8b5d29fd200af64c1038ee37d788c47ea01f67b9c62`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 22:11:59 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 22:12:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 22:12:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:800d2274c63a96f40424c4e2233d3d024827d9a829005694d259617e32fcab9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:397743d186bab6e53b28187e1b29732d591cce97eb76b99d3211d7fba8fcccb5`  
		Last Modified: Wed, 17 Aug 2022 23:09:01 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0200b232518cc3181aeb96dc2d18c2c5b98a893a468a17605af210a53919913b`  
		Last Modified: Wed, 17 Aug 2022 23:09:07 GMT  
		Size: 21.3 MB (21312093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:39ba8965629d062480ed0639652b5c0dac80a8ebe0a75a0e97aecd70971303ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.4 MB (178396320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d906aedd4f8894efc50e6cab352dbcfea71fa2a100f70a7eece703e38567e06`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 22:16:25 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 22:16:26 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 22:16:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 22:16:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:55779353641d36d260fa42e7d3168912d6396be97df8c41abbfd684db1c03b48`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2a9506852241b38dd94fb5e75af19041318aeb345ec63a248eac28195bd02c3`  
		Last Modified: Wed, 17 Aug 2022 23:08:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11787c0df9405c977ca070c356d32ce055da2896cd97c66d719b784b05b6e204`  
		Last Modified: Wed, 17 Aug 2022 23:09:19 GMT  
		Size: 21.3 MB (21312712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:2a0990eced429545f5c8d20b84a124c4bc372ea6196a696a26d6da15e9044327
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153245136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da11d19e302a5aad3a11571762d4a9c9e8b3778bf05946aa08bf14ae248a079f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 22:26:25 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 22:26:26 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 22:26:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 22:26:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a775742325ce1757e54bcec35b10b8f72d8522ad0414af255d35a12e5073798`  
		...
		Size: 691.9 KB (691864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d260c09e713696233bf5cec471a27eda8352c0c8baf2f285625ccbf356ba62c`  
		Last Modified: Wed, 17 Aug 2022 22:55:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8ba71f77f221baf3bec1db64318faa83c702290269c751b7e11e14aae1f3c33`  
		Last Modified: Wed, 17 Aug 2022 22:55:16 GMT  
		Size: 21.3 MB (21312487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
