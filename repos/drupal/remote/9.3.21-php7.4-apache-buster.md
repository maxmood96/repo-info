...
```console
$ docker pull drupal@sha256:9acf0ec56dd8e0cc1eb4fe55362202f2778f63445f5b5187185f1e2d755acd2d
```
...
```console
$ docker pull drupal@sha256:af204939fb4d965a7fd860e68d887ebad2c808aff1453cbcafbac355dc1664b2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167326116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afa2c8a295b5bef46caf82e6b629beb501daec9c58e0648e4954d0ab1596e1bb`
...
# Tue, 23 Aug 2022 22:07:16 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 23 Aug 2022 22:07:16 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 22:07:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 22:07:29 GMT
...
-	Layers:
	...
	-	`sha256:17d095e114f6229851e928e5fa7f282ccbe962ed76a0a9201c2ef9b3ef5ffb64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79c520ec064e0225d6d6bfd66e75b4395f7d8fadf8faea4fc7723cd3a48b550d`  
		Last Modified: Tue, 23 Aug 2022 22:29:00 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3443a0646a0769f047076677a9c548deef77c84b0e3b52171f28ff246b701271`  
		Last Modified: Tue, 23 Aug 2022 22:29:05 GMT  
...
```console
$ docker pull drupal@sha256:5b65d5f8696a60cad6b9d96e6a569a4ba18a94918fed1d44d34dfbd716508115
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158828182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:414c0a0bc57d32ae33e4eab97087893e17dfd9b2c9eb00808d7b02ba0514287a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 23 Aug 2022 23:54:47 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 23 Aug 2022 23:54:48 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 23:55:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 23:55:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:baf23b461e2bff9ebec892f4311ab2cb6ec98aed4643a5885490b0428d73010a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a6ab4dfd0f5b22670bdd2ac0193fbbb06484c36850e1cb2cf034382359da65`  
		Last Modified: Wed, 24 Aug 2022 00:25:55 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdb32324bc73e8ee204bef172ebc283a40cedb663039452544d30ec85d5d92bb`  
		Last Modified: Wed, 24 Aug 2022 00:26:00 GMT  
...
```console
$ docker pull drupal@sha256:2f4a4068cc127b82a59797cfadf8158f952348176b1d188dcb5a06fea2109787
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172651203 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16dede2cd7756841dd11965483da3f97db9041b0f98df358d4cf01d0792be1ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 23 Aug 2022 19:13:55 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 23 Aug 2022 19:13:55 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 19:14:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 19:14:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6abebff5bec59ee864c628976914e9f579cc4001f60a908669204cb249b16d8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24e1f67b376bdbd3cdd814bb7fcce4ea1752a3f114af7752888ade97c17e12a5`  
		Last Modified: Tue, 23 Aug 2022 19:45:56 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58d410d780e6e1bac178d1d5cefecf6edc8fc0af61ce7b9edb7ecabc314fb805`  
		Last Modified: Tue, 23 Aug 2022 19:46:01 GMT  
