...
```console
$ docker pull drupal@sha256:ef4ddc314eea3aaaf9c0133f15c0a040e216a76769bf111f3124cba18cae2a8f
```
...
```console
$ docker pull drupal@sha256:441088f9be86c2d219db7845055bc60a2a87e5eadb05321655c8fc34d76e13cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141140946 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc7050aabac873ca8fd0fffde2ba860fdc39864ce2a3b0f82101790166682bb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:25:03 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:25:03 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:25:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:25:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:04092e2e9c98045db412fe415e56bfa172c4d926f6628832230ad5798c2738d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:411b33a6fada0c0990eac91bd6d3ac842f4b1659ce9531c6fe5fa2e6f910f247`  
		Last Modified: Thu, 04 Aug 2022 10:12:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ba4fc4a1ce274c4e12edf7e9d79767e284d5609e1b36821635dcf5bb96077ff`  
		Last Modified: Thu, 04 Aug 2022 10:12:49 GMT  
		Size: 21.2 MB (21223908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a974f645999f7edc63239f1503dc5af2fb5501bc30da7a90fa3f8666c090c7d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175477207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76403d1209b5ebce9b5c9310cf68926ca8d9ff837044fc719239fa4f67e62e32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:03:06 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:33:48 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:33:48 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:34:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:34:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2543928d3c53279e6d7abaa7b33cd8af607889045069dab7f4608106c7e28ac6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbf9bb1ec8d77fedb87946118a4af458447bde3e8a8d7f217da0528f7c353924`  
		Last Modified: Wed, 03 Aug 2022 13:25:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d34f31e20aaf73daeae42904cacbc5f69108a95fee1a4d2bf04938720dc510c4`  
		Last Modified: Wed, 03 Aug 2022 13:26:10 GMT  
		Size: 21.2 MB (21224228 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
