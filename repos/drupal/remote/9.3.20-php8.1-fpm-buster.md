...
```console
$ docker pull drupal@sha256:6a9788b4713cfcbc579cacc5c6752cb2ad1b8f306f3ba9d28095ce22b8f973f2
```
...
```console
$ docker pull drupal@sha256:f27b468544648de02c96e52cb56f265044380d71596307c373e85cd7c14b922d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.7 MB (157682710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf6b4c78ab9f638c513de7f3837d41f3a06bc9c23c178979a639822b53c7771e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:51:14 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:51:15 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:51:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:51:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:76673c8b5167a49e17c08a6d6c48e46444a04a2748f30a0ee016f14532d0a7c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09b97d03522b7705c138b34cb7087d511f117f792610bba29bd4763c3d2fe2da`  
		Last Modified: Fri, 29 Jul 2022 02:22:58 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60d3b33610475a7eebac465e86af54e91dadb4be431c6bfb10f5a3b63b678d2f`  
		Last Modified: Fri, 29 Jul 2022 02:23:03 GMT  
...
```console
$ docker pull drupal@sha256:2875f511ec92f2bc10aa63f3ab617039e874e674103a8cd98d1ca71b6ba715a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170658703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fe3b62332cf70e9a4945103725a70e034990ea2c21f9923e693b801ce3b6a06`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:48:31 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:48:31 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:48:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:48:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:42af4de23ca053d972d18702054929a6b60698203599975027c20881bb45eed6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fc4ca0551a48e44cc1607cf4b158a423bfe05a65e1735ed22b6dd520577628f`  
		Last Modified: Fri, 29 Jul 2022 02:20:45 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdf4aebb7761e87c5561f2282819f1d4faf62fa407dcf52649d3657fc325f785`  
		Last Modified: Fri, 29 Jul 2022 02:20:50 GMT  
		Size: 21.2 MB (21225263 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:92c478b156da38a911d722773863ce84db4c82b978272a67a22d2b78683f1814
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.8 MB (150828458 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b516c6936a9d0a4544bb0ac1370bf01c0d307c3ed7b3b8aa8902f56a1d076cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:54:20 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:54:20 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:54:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:54:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aa9ef35ba09805b6c55dd9bfb4060212f375c78b74be6adc0ac7c0836e38f878`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4013f2435d4f1dd1c4b21f039dc4a7741be5c50ae2a8fb883f78953ae83d2eb1`  
		Last Modified: Fri, 29 Jul 2022 02:22:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dc5187acc434e98435368170fb8aff6c745eba9b922721ed44314d7c8ea2038`  
		Last Modified: Fri, 29 Jul 2022 02:22:13 GMT  
