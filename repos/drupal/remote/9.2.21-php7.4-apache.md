...
```console
$ docker pull drupal@sha256:178153ea2c65041ca217f8bce780da6addb0e0c25c8517355b8a524b1759b09d
```
...
### `drupal:9.2.21-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6ce9d3321bd8471c8e72e2729cacdbd18f66065b065ce92922aacdf70d7dde03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155177589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58b23456363bb0869094211732bf3418343e8b92015393f822b04a55a1a302e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:29:41 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:22:32 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:22:32 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:22:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:23:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b161dd9a040560b40456a14e0dc3ca7f0eb106fecd2edf815e66d74e7fef4889`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:964eb7785a6b19cfbf65e6f5f4899dcadd7dceafab2faa8c39d0d2e5186c9071`  
		Last Modified: Mon, 13 Jun 2022 21:15:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0c6699c3260f567d83b77840d1d481d588d96185f5c85114506b27fb60ebb74`  
		Last Modified: Mon, 13 Jun 2022 21:16:02 GMT  
		Size: 19.1 MB (19121585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:9.2.21-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:95d79717f4790e7263035f92a895779c226158bf1cf5c856b1d3bc3b94af5e2c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185997439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c73f84c13eef6a5494d7c629a55b8a1e7f0dc7f9bcb50fc2ec56d50464c5b0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:16:10 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:16:18 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:16:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:17:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c443f4f6001ce9e2170dda837b280ae363d780322dc8b51a43cac05fae09a02`  
		...
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cab056f615ec74b93901d53cb3b112a3342823c0c5da281324dc92558587967f`  
		Last Modified: Mon, 13 Jun 2022 21:28:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e49811a5506e710c5f80f8cd27ec53898973a1a45da05cf631caf335cde07f99`  
		Last Modified: Mon, 13 Jun 2022 21:30:53 GMT  
		Size: 19.1 MB (19122025 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
