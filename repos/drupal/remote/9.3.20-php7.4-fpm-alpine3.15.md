...
```console
$ docker pull drupal@sha256:9cd5c5bea8df91b6b2efe3c833d416aef30aa2b77fd18109cf215bad0603ad33
```
...
### `drupal:9.3.20-php7.4-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:5d6299155a381b1733d05635f85eb541963a46eeb0279ddce7436d4cbe38868d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48275387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9523736f9fcae30d5670fa861bfdd9292c4675cf061b64050d2b28d065d3a7e7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:23:21 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:31:22 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:31:22 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:31:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:31:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b4320fc45372fc83abd7ee81828ce838994f2bb458745a422101ecea47359bb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbe953c614f32d6f952d289b1f7baa52a41b9bfcde1ec69305f28a7b00c27507`  
		Last Modified: Thu, 04 Aug 2022 10:21:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49f0125d7aaacaa7e2307893cb239867f268237873d4718be6a41fb633a9b9b7`  
		Last Modified: Thu, 04 Aug 2022 10:22:08 GMT  
		Size: 21.2 MB (21214834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:449efdbf1c458d609132f08cbac0a86ebe0a370484da61f9112a1ccee6f05031
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50236434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:575a48705d996d549fb374395eb4b6897e8b3e1c5a31f9cc60d8fa99cb2b7f92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:57:01 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:57:02 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:57:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:57:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b84107b9742fafd631d448eeb5eb8fb5cf4a4aacdb2e03d9677758c4b74f8085`  
		...
		Size: 670.4 KB (670423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdcc611a92aec3b3c8288aad883337a8ad63bb250cbc20c761a4c8bc2a6f916a`  
		Last Modified: Fri, 29 Jul 2022 02:31:15 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11044fba74070d0d54d9066b35ad770a40675a297885ecf1124f1328913154d8`  
		Last Modified: Fri, 29 Jul 2022 02:31:19 GMT  
		Size: 21.2 MB (21218042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:c0a7e9df98a4c200d1d2d4e39ce0f487eb3375ff13d63f18a0136cba9d374f65
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (51017513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef41d8bf05fa7a571ffc1be24c36a5381223488999b442fd6558d20b732a3637`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:53:32 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:53:33 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:53:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:35c5a0274bfbf49fac3d536c8fff5c1fe77d834b9d3fac8a04141a83b18b2b0f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0def948db6543199d61522bd5ebdcd9985e4f8c582fc22d7e806ef39bc1e5c7f`  
		Last Modified: Fri, 29 Jul 2022 02:27:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:902f4f03d12251761ee4bebc19e8ac130b9063ecdb8e07cdb1746290f0b711e2`  
		Last Modified: Fri, 29 Jul 2022 02:27:26 GMT  
		Size: 21.2 MB (21218174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:f8ffd9cc539db03391cd4d349ac5703e83b5eeded0c7203c0dfb03bc229ef5ba
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51527792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef2f9cbf14f96c70e080b9eab41dcc0ec943d10fc025f96fa52dfa74b2249ca2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:41:46 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:41:46 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:42:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:42:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73f84c275bddee0774f25042f9a321e5b8125cb2d0b3f480790698b4ec5ca21b`  
		...
		Size: 670.4 KB (670409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca0a24a59e76867d2b56559bed2c32a2af7dbefaad3f7aad5188afd84a4b03cb`  
		Last Modified: Wed, 03 Aug 2022 13:36:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7a5197ab7cdda118640e512486d493c19cac07369ab05edbca74577b164676e`  
		Last Modified: Wed, 03 Aug 2022 13:37:06 GMT  
		Size: 21.2 MB (21214932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:a842d06350011e68602e3dfe8f7ed0a126d40d215631a414f11bdf505f5b8bc8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (49988155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:503ab0d6507495efd908ae82a87ba2ff7e8d0ee0d3b5073e246c3e89a6c581ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 02:01:03 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 02:01:03 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 02:01:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:6d9d254ced73c92d527ac55d16a2e36fd3b27eb59f86d0d46c676bcc0c48c17c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea0b348a539fef2f53997dfdb71874c6170b09da6f0dca1327dbb23bb37e7ff9`  
		Last Modified: Fri, 29 Jul 2022 02:26:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da73314213094cf76dd7cd94fb8b13a9550581bbb4e0935402da5829f734322e`  
		Last Modified: Fri, 29 Jul 2022 02:26:11 GMT  
		Size: 21.2 MB (21215014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
