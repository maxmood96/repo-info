...
```console
$ docker pull drupal@sha256:36ddf171e22d00536d56cc900d683789aa27220a7eec8da91d2fb3267e838618
```
...
```console
$ docker pull drupal@sha256:869515850e74cee49a0c0e65740b7b888b9a8fcd8a4fa5175d34caee90c48436
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51511123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa1e8bcb491da4ba6d3eea6b55ac0ddac15ae819a81d9b3b13c317c939a15042`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 29 Jul 2022 01:52:40 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 02:02:38 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 02:02:38 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 02:02:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 02:03:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:54ee335585fbdfa2319a132a5bd3de98a5f8867a14e0bdf84b74da36f411051d`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f0ca6b2ca1dd70a6b32a3e2485b0adec438004c0f4843e4aa0ffb8aab8d4a77`  
		Last Modified: Fri, 29 Jul 2022 02:41:40 GMT  
		Size: 670.4 KB (670419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95cefeaa1a8e1af96e52af640591b337ee2112d076c57ec9afdcd20f9c1fd132`  
		Last Modified: Fri, 29 Jul 2022 02:54:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd6a13f2578f8c0ed2c4c4c5843d57e1cca915552a84f9d17bc6af8b250f6547`  
		Last Modified: Fri, 29 Jul 2022 02:55:01 GMT  
		Size: 21.2 MB (21215500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
