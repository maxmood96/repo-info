...
```console
$ docker pull drupal@sha256:1af3bf20f3b5ba8b401bc70c6dff76b02b1d437a921516a37a5061c2b98f6ad4
```
...
```console
$ docker pull drupal@sha256:3ab89567f6739db19d7aa70b3d68cbf82a9d52c3da6e222dd1c4f50fec10735f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.2 MB (164213610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe5717465af07aad02977b7401a2ebdbec18f03a352cc1800c7c2fb1b69ac4b2`
...
-	Layers:
	...
	-	`sha256:562e25c72992f4204a5454a19dc0df66e85c1c82223f3709e5de33c1292e9313`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61e29a3805534b37254b307ac8fb6dc29c49a7f33434600097ecb4d1d4b97121`  
		Last Modified: Thu, 18 Jun 2020 00:22:29 GMT  
		Size: 19.6 MB (19637732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm` - linux; arm variant v5

```console
$ docker pull drupal@sha256:d6051fabf6413f1bf6bc5225a9a7b78be334f79da415b6d8c9762b3a365bb4fe
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.6 MB (142617952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74a8337ea9785e9d3084184b6d0fdb409e10f0b787e9559e922febd4fb2d3e61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 00:52:21 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 00:52:27 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 00:53:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0c68ee134ffc07490f97c345b19cbec509ac4b51d45d9aac471cb7498762c51e`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e1962b5fab742142fb1921376f01903bf7f58b587d4c31298566086c97c4062`  
		Last Modified: Thu, 18 Jun 2020 00:56:03 GMT  
...
```console
$ docker pull drupal@sha256:098ca7b73403aa0fbc56d0a8924111d3895034dc3235b23142406f3f1b14ac49
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140082075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:712f14f1fa69782bc6af905da437691f222f85cc53db72c914d1d6e30a655657`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 01:00:56 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 01:00:58 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 01:01:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ad5ebcb5464fb378636fcdb02aa908a769eae6cfd9ab1f3d3bccf7db67e25c36`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf7e1dc9ea33adfc19cd49e5593a2acd71a1597c96666e4249ff686ce5fcc7c0`  
		Last Modified: Thu, 18 Jun 2020 01:06:16 GMT  
...
```console
$ docker pull drupal@sha256:15dce12e4142de54042d7b22fecc1ff0635d16040629ae22ebcaf03340634cd1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156405434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c93807fad35736f98a3c6e312870c2e3531367c30f7f9b239decbe109c6b3558`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 00:43:44 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 00:43:44 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 00:43:57 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4902787961a58d140326050f87c881556cd9aa77eb95840378322a580be125a3`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ad2de173d9a173731afb3b9128fbd5f0fc47ea52ab69c9faa3988add9d6201a`  
		Last Modified: Thu, 18 Jun 2020 00:46:57 GMT  
...
```console
$ docker pull drupal@sha256:44d85c72b1e720e36d8da94f3137c18b41fc070b7193022f3b32e4b130dc61e6
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.0 MB (146980842 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7053dd965c1ef90841cef362162cf31a6caa882f374baa9e1424acd7e10066a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 01:09:07 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 01:09:07 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 01:09:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:752777a86c747b62f9c6a33c0c97738436847a7f6011903b437f877999c39f35`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ddcd67f9293a7591fbd48d172314995d97e56b7d55297e3dcc495ef0ce38bfe`  
		Last Modified: Thu, 18 Jun 2020 01:13:27 GMT  
...
```console
$ docker pull drupal@sha256:ce4d59d81f0f151fef9eceb823fd5bc3a6ece81efaaa40f6cae38d3df748e49f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175171896 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:283dfc3759f1d154e5d6c4bab123b76df09991c3bd2f62511b628443505be42a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 18 Jun 2020 00:21:01 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 00:21:05 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 00:21:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8ab136c0fe728d705b7fa2ece17f9394f3100637e70cf4d243733f063823e3a5`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79a778a685eab83a69ba9ed93a146158b0ff9184c23c815b89ae585268327f3b`  
		Last Modified: Thu, 18 Jun 2020 00:32:56 GMT  
...
```console
$ docker pull drupal@sha256:6196f87975677edb466fe8c77cd0a3c8d21ebd81401a00231f6f4334a6e1bd06
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (149993459 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:096aad0377e96b3eae118534a3be22bf9e077f0f86a0ed9cef1868d5e63245e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Jun 2020 21:18:11 GMT
WORKDIR /var/www/html
# Thu, 18 Jun 2020 00:43:23 GMT
ENV DRUPAL_VERSION=8.8.8
# Thu, 18 Jun 2020 00:43:23 GMT
ENV DRUPAL_MD5=c8265f0228ca0306de7b2755e4731a3d
# Thu, 18 Jun 2020 00:43:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:57eaa721824e923a26c2f7113855aa1ade9f6e25091b93513be7b934bffff060`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c418ae1e254adbe95966022875d77d8eb9efe05b653c149fae5622b34a7878f4`  
		Last Modified: Thu, 18 Jun 2020 00:46:42 GMT  
		Size: 19.6 MB (19638021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
