...
```console
$ docker pull drupal@sha256:eae4ac0e9699d94f79a76b70a86807e9e04e49ab00219373c8f5581bd6f8dc29
```
...
### `drupal:10.3.3-php8.3-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:10.3.3-php8.3-fpm-alpine3.19` - linux; s390x
