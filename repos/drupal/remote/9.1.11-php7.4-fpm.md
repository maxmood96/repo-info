...
```console
$ docker pull drupal@sha256:27191ac24ebf98e43b508da8ec0314157f87049b626a4721fca601f1b3f7c6ea
```
...
```console
$ docker pull drupal@sha256:b7427bb57b6a4a47d5be74bbcf8a15e4efaf79de937a0b352aacf06c52cd3044
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.0 MB (140019908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b142b9c85f71c473bb2a6a4a128b5944058485736237a3da4c236811894b243`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:12:36 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:12:36 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:13:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:13:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:946c3f5e8662556fbf940bc56f4b80b12f28de2eb97bf4e866d2f2870fd89f8f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d84801d3e7f2533cd4f2cf4803a0e744f3e897f9ca8522e21071d36ea2e62455`  
		Last Modified: Fri, 30 Jul 2021 04:49:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a513bc777bac057e6c4ebafed5cc9b116fbf9aa64b35ef5dbe9faf5518cf4e5`  
		Last Modified: Fri, 30 Jul 2021 04:49:49 GMT  
		Size: 18.9 MB (18872544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7567038cfbab7f1ec0d01264e75616c4f9c4b26babf7fd0cead7fe926c542ba4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.9 MB (149930873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5d540faa196d94f41e2abe43aacbb03c5a1436be8086d6836e62e8e7dc41bd1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 03:42:12 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 03:42:13 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:42:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:42:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f79f4864608d54dd001abd02d8005d527d45a8998c0293cc1972b6c94335aff2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a34e8b91d091f0e6b38798b2871ddfa1118f4430ba0394fe54efcae30b7a16b`  
		Last Modified: Fri, 30 Jul 2021 03:59:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:995323231854709603949d9c3cbdcaf356faed333291eb2562a76d26d717e0bd`  
		Last Modified: Fri, 30 Jul 2021 03:59:39 GMT  
		Size: 18.9 MB (18872607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
