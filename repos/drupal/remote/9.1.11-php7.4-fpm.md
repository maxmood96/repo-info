...
```console
$ docker pull drupal@sha256:0dd9f4a9fcc7f72aa99b7ba998c07619f6faccda78e0c9ecfac394d63379d553
```
...
```console
$ docker pull drupal@sha256:4efed84e766d7a8719b38020c91e6618f23f70450dde2aa124477d4550e5e75e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156385450 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7efdef47f7b9469343b70a189215ea139a6da7ee3e1bbf4c41ff37268c11289e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 19:31:52 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 19:31:53 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 19:32:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 19:32:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb5546a9be25c49bb97879f3b5b02fbcb16dd08fd773ec896c9d0a0208a48b85`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c55186f2c7c5b71b22ba064577eb26b7592441224255d02783b665f2f9b06578`  
		Last Modified: Fri, 23 Jul 2021 19:50:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72e1d0f6116d97a9098aa4ea0fa7addc3e6379a734ce1268592de3efd3dd496d`  
		Last Modified: Fri, 23 Jul 2021 19:51:01 GMT  
		Size: 18.9 MB (18873456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ceb103c9dcaf34ff971fcc001c080c7271056e94df92d216b0a5e8b6ef7c4af4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.1 MB (175130464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bff8aeb5a2176c9745c59e2ac0617f98a87072c629e51744037c9424e40858fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 24 Jul 2021 06:02:24 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 24 Jul 2021 06:09:54 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 24 Jul 2021 06:09:56 GMT
WORKDIR /opt/drupal
# Sat, 24 Jul 2021 06:10:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 24 Jul 2021 06:10:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b0dd3b1432d5064bb0ecd6b29ccca9b875f223a1403266351cb880a4629292c4`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6800ab36bfc337ee7a2638f0f4814faffebca39606d105eaf359cdab3c666139`  
		Last Modified: Sat, 24 Jul 2021 06:30:47 GMT  
		Size: 553.9 KB (553916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38faaa16fb400bbb343e5a40345e99d5ab3812369139f12e3ecdbf25066b20a0`  
		Last Modified: Sat, 24 Jul 2021 06:45:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f04968b9ed375ac80a450d6a36a45136d4087b5868992f4bfdac7b8e08ce8f4`  
		Last Modified: Sat, 24 Jul 2021 06:47:05 GMT  
		Size: 18.9 MB (18873366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
