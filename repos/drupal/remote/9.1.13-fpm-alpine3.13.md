...
```console
$ docker pull drupal@sha256:e19d6ea1ff0a9e9458102d4e7a077d409cae157b4d4651bf886f5f5f04fc0892
```
...
```console
$ docker pull drupal@sha256:664dc61812135badd9ab2acae5267191dc99f4b06996919f6f07c588eb0d4fe8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50328202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e5aa1e7f86b10071e06fb61982f3ff415e8bb12aa6293ad5cf1e9ff4878e797`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Fri, 15 Oct 2021 00:20:33 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 15 Oct 2021 00:20:33 GMT
WORKDIR /opt/drupal
# Fri, 15 Oct 2021 00:21:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 15 Oct 2021 00:21:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6d701a243dea638a462a452edb45da20c28ac95152f362164cc52e60a495b71f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5edb2bc69cfd26bcf92b6a8efeeb2c1cf0e1f24ed0fc896b75a2493d1d63b37`  
		Last Modified: Fri, 15 Oct 2021 00:33:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:886112a933180ea0e8bd8eba70578b4240b2c5ad490adafd9fdc589b61aac4e2`  
		Last Modified: Fri, 15 Oct 2021 00:34:24 GMT  
...
```console
$ docker pull drupal@sha256:5e1c6cccb41bb7f712680ce7ba6ecc47113b139068f281930537e0133faff086
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50939794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ad64b2d42a1132cb87f5d164e60900c092af975ab811328210c16cb1edd0576`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Fri, 15 Oct 2021 00:14:24 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 15 Oct 2021 00:14:24 GMT
WORKDIR /opt/drupal
# Fri, 15 Oct 2021 00:14:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 15 Oct 2021 00:14:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b32d7f1b8fb9c27434645660516d5ffc7453d28328cc32c05cdbc457536540b6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fc6c5b009d749eaf7c9cee81c7736d7e052197e1f49a32b01fd864e58dd576a`  
		Last Modified: Fri, 15 Oct 2021 00:29:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424a0d1d70715d147927580a37c9bff5e1209b8bcabf80d39fc16774a8c0b5fe`  
		Last Modified: Fri, 15 Oct 2021 00:29:58 GMT  
		Size: 18.9 MB (18879060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
