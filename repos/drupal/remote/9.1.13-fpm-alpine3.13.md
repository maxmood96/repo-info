...
```console
$ docker pull drupal@sha256:5cb70dc4e9bc0ccb34521cfa4995e58887763d0a9a09c39260277a39c07b04e9
```
...
```console
$ docker pull drupal@sha256:c96d554cb8fd4abea7e0c81c69bb35e0e65d6c5edf2d605a135cbfc8d3a7d5f6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52659216 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddf2a3dcd0d4d952fc15f7e881bbd9bf6d1ee13bf8958b6cc25f70ce9a3e9f0f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 13 Nov 2021 19:30:43 GMT
ENV DRUPAL_VERSION=9.1.13
# Sat, 13 Nov 2021 19:30:46 GMT
WORKDIR /opt/drupal
# Sat, 13 Nov 2021 19:31:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 13 Nov 2021 19:31:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2d4c3ee79cf2237b6f9c3d7c8f4deb1eced6a3100cef84ecb314c915d7eb3bb9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3104a1360379689c0770202d17ec609e98dfdc46604befb6cb0b09915afde953`  
		Last Modified: Sat, 13 Nov 2021 19:57:02 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:636024d9507bb9b286d58fbd0133651ae7c7267dae71052a7a5891319486855a`  
		Last Modified: Sat, 13 Nov 2021 19:59:12 GMT  
		Size: 18.9 MB (18879143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
