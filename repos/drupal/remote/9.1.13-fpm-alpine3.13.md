...
```console
$ docker pull drupal@sha256:9919b77f090e7c06fbae52060ad35483baf0d10f35af25f937e8b4939b33d179
```
...
```console
$ docker pull drupal@sha256:1d7e074b04655a7f9d4eb0d0e3482a89b4e91b1cc9a4ec568feaa790c764c5ed
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52052018 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:667e97f7a993bfc9187b0011224049d5a92ba6da52018bebeaa4a23f82a7b70b`
...
# Fri, 17 Sep 2021 18:25:40 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:25:40 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:25:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:25:53 GMT
...
-	Layers:
	...
	-	`sha256:79867fce0c27c62eda89f1e52a018e152aff8572dcf7127259fbffe958a3a072`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3df9bc15e81069c80b4ca115888d0bb63ad35e4cd380005a53d5715326d92b41`  
		Last Modified: Fri, 17 Sep 2021 18:39:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd481942f95b15877d00205614656da6fea71dad9967fc557d9ddd0d84610789`  
		Last Modified: Fri, 17 Sep 2021 18:39:37 GMT  
		Size: 18.9 MB (18878985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-fpm-alpine3.13` - linux; arm variant v6

```console
$ docker pull drupal@sha256:8414662a6cd6840a2322b40631bcd8b4f7366fbb21d0b2b3c8ecf4c7073c513b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (50042224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aa62cf72de781ce828953862ca8b754c8b0e2e8f89bf01cb55cb261fcf6c6b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:53:25 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:53:26 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:53:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:53:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:166f1e0e2ab83bfcb033063c2b65ead8b7896bfb072f311c5a86674de3830944`  
		...
		Size: 555.2 KB (555171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4ca894a198bd3186fdf53c425748744de868da025853a8f5f5867c2446646de`  
		Last Modified: Fri, 17 Sep 2021 19:06:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64438a4628aec7bb4cb137c73c71f2471469c43b4121c87870fd482f4f48bd08`  
		Last Modified: Fri, 17 Sep 2021 19:07:06 GMT  
		Size: 18.9 MB (18879171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-fpm-alpine3.13` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1450af358a57e833a06cab4e223181991d960877761cfe6a4c134e69134bf23a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48668838 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abe223d5e105d06337c68a0dcad7e6633b3945689584c9d0a5eb6a1fc2846787`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:07:49 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:07:50 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:08:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:08:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bd9313096f8e581fdc9a70484dbb649fbd5c6a4ab19c871cd39e50c5ca697d6a`  
		...
		Size: 555.2 KB (555171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02647ecde573f832955095d8036bf0672cdb1cadeb8ff88712444f65bf9006c0`  
		Last Modified: Fri, 17 Sep 2021 18:44:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:102e66e54ab936b518bff4ca1016ae79ac9ff5358591e1dfec1ea7104a80e179`  
		Last Modified: Fri, 17 Sep 2021 18:44:38 GMT  
		Size: 18.9 MB (18879028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-fpm-alpine3.13` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:1c80facd03762bb544e7b338dbdb181d8119cf1ab867309f3138cb66827ced2a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (51049616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd89b343e45babe13913a108020d2c4ecf496fed8c58b146c3d27a1b5bb958d0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 17 Sep 2021 18:47:21 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:47:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:47:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3d363649d37528f83a038f8506e5e0e65556bf4d66ce15798058a3a1a53fb9bf`  
		...
		Size: 555.2 KB (555171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b84902788d58f96d0d2ce9a2733ebf6edec7b7d54088d406962aca9f5e9f2d71`  
		Last Modified: Fri, 17 Sep 2021 19:07:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7c890036023473206abe899175989f904cdb49841a131e551d49df9c5a606c`  
		Last Modified: Fri, 17 Sep 2021 19:07:26 GMT  
		Size: 18.9 MB (18879243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-fpm-alpine3.13` - linux; 386

```console
$ docker pull drupal@sha256:5652324d3d52c605eb0140e4837b5dc423f9afbcdf22193eb522322170710d10
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52598966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b9e71039b8866a151a6f3c093d4592131d3155a455593b6039ed176e31aacc4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 17 Sep 2021 18:44:09 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:44:09 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:44:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:44:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e5362a3183eada69f3b38c5a75191b1258f6b73427d67ba413e91e4ec0684db3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d681f120d0dec332567c97ef61d83633a275193a16b370f7ba56ed271c9eb885`  
		Last Modified: Fri, 17 Sep 2021 19:06:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fceb25abbc7587640e57e9cb0b600a9ee1de950106f47c2216ac172ffb470de6`  
		Last Modified: Fri, 17 Sep 2021 19:06:21 GMT  
		Size: 18.9 MB (18877993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-fpm-alpine3.13` - linux; s390x

```console
$ docker pull drupal@sha256:bce66df9aad58ba667087a9b4914d3776485c135adbb60529041490bc62cce0b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50625194 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aa501ab54d297acfad0948cdeb3a9c18b9024cce3849be10ec6bb4ec05318b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:47:23 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:47:23 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:47:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:47:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d9b879e199655a6533740db26141a5e1a64cb0360199de615ef8eceedcd0a183`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08238296ca9abae6cc43f2d54bcff90ef4534cab98c61c1e256b67aae1168dc1`  
		Last Modified: Fri, 17 Sep 2021 19:03:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ccaf6ef11f12f88cb32918209bb973b8c1e72a0c5995a0924a50ca031fc638a`  
		Last Modified: Fri, 17 Sep 2021 19:03:05 GMT  
		Size: 18.9 MB (18878734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
