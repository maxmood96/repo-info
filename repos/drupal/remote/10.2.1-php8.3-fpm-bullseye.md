...
```console
$ docker pull drupal@sha256:a85de8efb3033f7e5ff1612d7aaa372a16d5f8ae6b2621266d68c852020501c7
```
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; amd64
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - unknown; unknown
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:2031f5bf67f5b984a3456b59da801be205c6dc09a05783ad8cafeb21adb60645
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154746840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ce5c0c9b00a26af39680b776510ce7dd8e1e4b7aa5d68c055b4a378d6518f53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:0a43c88d02209af66be8a55425d05f7839594745bff9a6a92f2dadba4593a053`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:79630b72e086878aefe18a9606f7fd2dd9b9653097fc2bdaa49b081897234604`  
		Last Modified: Sat, 06 Jan 2024 00:31:50 GMT  
		Size: 19.2 MB (19220635 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2.1-php8.3-fpm-bullseye` - unknown; unknown

```console
$ docker pull drupal@sha256:941b01bc3b6d4c637220af594a24125c68cbc804ce231718ced9aad6b23178b9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5368283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7897c1ec29989f6c46c530145b75c894e7897c21978ee5c75703a555195458d0`

```dockerfile
```

-	Layers:
	-	`sha256:84d55f4086a3df751ad11de842835e84c4d4918c86f011338685f254aea72b2d`  
		Last Modified: Sat, 06 Jan 2024 00:31:49 GMT  
		Size: 5.3 MB (5338592 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:19f7ece308c6d4d054e467cad827d15f971155bff3dce0980340588c14d0b6c8`  
		Last Modified: Sat, 06 Jan 2024 00:31:48 GMT  
		Size: 29.7 KB (29691 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; 386
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.2.1-php8.3-fpm-bullseye` - linux; s390x
