...
```console
$ docker pull drupal@sha256:32aac39590a8c36350098bb5fea0ba512580a6fca1d1acfaf968440cbb8ebd55
```
...
```console
$ docker pull drupal@sha256:99b2d3cc715d1291f26ca9ada3b04ff3acb163954411de658a994b0c05e434af
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.9 MB (142902672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c10e36a974dd1facea0070e0dacac9eb5dc2474652f9108dbd34e5085ae4c7f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 08:55:37 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 08:57:44 GMT
ENV DRUPAL_VERSION=9.5.3
# Sun, 05 Feb 2023 08:57:45 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 08:58:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 08:58:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a1a6afd549e8bc92f2b4b1049a6950675b37d13e82a21924c9cda2f1c5dfc97b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e53bcd8884c6cd03b79a398c820d23a01d23acec786b22dd370df808eee934`  
		Last Modified: Sun, 05 Feb 2023 09:29:48 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8e5f01adf2b408f73a8e1c50121bf988b4c0fccbdfdc1e191caf4f7ce6ef686`  
		Last Modified: Sun, 05 Feb 2023 09:29:55 GMT  
		Size: 22.8 MB (22844328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
