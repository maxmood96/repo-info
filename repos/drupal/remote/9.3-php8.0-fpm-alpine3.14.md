...
```console
$ docker pull drupal@sha256:57a595a4e5c74d170519c49105d083449db2f776334c7f004ca544674c609420
```
...
```console
$ docker pull drupal@sha256:6a91d363cfd936f2cd8da008e1b1d196c0e09eb00499a81f4bd8d334e8c245f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.0 MB (47038212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7437e6b2a2ba4c2ec49c582dff44f16270737d2143d0ab9c3e270f3c6ce73866`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 18:07:23 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Thu, 03 Mar 2022 18:12:29 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 03 Mar 2022 18:12:29 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:12:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:13:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b6e5be746f2fada2be724d64202a0d9915abae2c3728c7a04fe7a0687b157585`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:937bfa1f3262371bb934993422ede0c0971e7ad4e7c177507d1d88837dbea549`  
		Last Modified: Thu, 03 Mar 2022 19:13:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b064e9b1a14479e6314c7430b6b7109ab0d96a1e2ec40ac16b0c6f67491d4568`  
		Last Modified: Thu, 03 Mar 2022 19:14:10 GMT  
		Size: 20.1 MB (20119145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
