...
```console
$ docker pull drupal@sha256:9f9b7529d34d4aaac4af1f7a2f16bd6cd698bfba5072affe1a12784ce6257758
```
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.1.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; riscv64
...
### `drupal:11.1.3-fpm-alpine3.21` - linux; s390x
