...
```console
$ docker pull drupal@sha256:a5ee85d382e16e9e6982fdb09d562b15c9fd1be9ce58c1ac95acb8f7ce1ed1bc
```
...
```console
$ docker pull drupal@sha256:ac75ad1c1a5be8b2459bd906eb96ea75e33ab0f9956735a6c90b080a4ae80fa6
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46772092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4bf4a88bf7adbfc92cb0f6872fb0adb1600b30bc42c56d6061efb849d505c4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 15 Feb 2023 01:53:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 23:13:07 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:13:08 GMT
ENV DRUPAL_VERSION=10.0.3
# Wed, 15 Feb 2023 23:13:08 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:13:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 23:13:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:28dff2190a165c7ef58bf93a303aaf9cffe66ad9e6b50a44860a4e141c4ee88d`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31ce9ed6952f040b0351811549e020a40b548e9297be65106948f217c070a1df`  
		Last Modified: Wed, 15 Feb 2023 23:43:26 GMT  
		Size: 697.2 KB (697151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43ea908279ce23bd92345fed44cb17c2bd59894b344ca8d26eebdaccaeafcea`  
		Last Modified: Wed, 15 Feb 2023 23:43:26 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c100b94b4dc6c0ea18a8385a031072fe02a571bfdf7aa1fbba8584dc9fa4ab2`  
		Last Modified: Wed, 15 Feb 2023 23:43:33 GMT  
