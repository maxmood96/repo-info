...
### `drupal:11.3.2-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.2-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; riscv64
...
### `drupal:11.3.2-fpm-alpine3.23` - linux; s390x
