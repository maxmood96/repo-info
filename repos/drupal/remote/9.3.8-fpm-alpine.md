...
```console
$ docker pull drupal@sha256:f8fc67d2b0f9e88c0e31026e1e7dd7548e85295da08328b324849a8720a824c3
```
...
### `drupal:9.3.8-fpm-alpine` - linux; amd64
...
### `drupal:9.3.8-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.8-fpm-alpine` - linux; 386
...
### `drupal:9.3.8-fpm-alpine` - linux; s390x
