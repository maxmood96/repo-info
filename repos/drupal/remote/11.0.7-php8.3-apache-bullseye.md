...
```console
$ docker pull drupal@sha256:8da6fd7178a79281caa8e40743156dcbb8c8712d88851b00ab93d8f2bed1b776
```
...
### `drupal:11.0.7-php8.3-apache-bullseye` - linux; amd64
...
### `drupal:11.0.7-php8.3-apache-bullseye` - unknown; unknown
...
### `drupal:11.0.7-php8.3-apache-bullseye` - linux; arm variant v7
...
### `drupal:11.0.7-php8.3-apache-bullseye` - linux; arm64 variant v8
