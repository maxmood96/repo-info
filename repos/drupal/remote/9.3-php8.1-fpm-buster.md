...
```console
$ docker pull drupal@sha256:09dee075617d07668e3488b85fb5c309546c61108444052c0c1d97d3bb0efac7
```
...
```console
$ docker pull drupal@sha256:b6e0de61c09412f92355651849c5f0d596f1492b205e22b437fb3b9ed922ef42
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165542793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe2ab449b19f581d577ceafde7745993fed8d012f3ddad22b59784a23347abfa`
...
# Wed, 20 Jul 2022 23:37:34 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:37:35 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:37:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:37:45 GMT
...
-	Layers:
	...
	-	`sha256:21b603498329327f37fa0cfd89ebb0a247ffa6e7ee06970b9fd1d096aeddfadb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24caa65d03ed851b750406f69c3d6ad4a7b1b767fcbd343d7230f7f0b5a4b2cc`  
		Last Modified: Wed, 20 Jul 2022 23:59:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0668257bcc758c5ba6f9a37e29cd60b2bbb63cf6ed50d299335c9e07e86f6129`  
		Last Modified: Wed, 20 Jul 2022 23:59:38 GMT  
		Size: 21.2 MB (21217852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:bb844ed1bc54ba2ff022a13ea0932e9bb152d47315f66865ca7eb78472c72452
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141134601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:472b8d45aa6e71d42c0c2f11c10d3cfb262561e7d4a03e9ae345bbbd2f0ca85b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 13 Jul 2022 14:09:44 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:34:43 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:34:43 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:35:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:35:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f283d266465567d8c2add15427bc644670cfe5a86494faedf4b93a26587ee53c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b62a761672f27480f94da4550407785bee986de08bbd5e82c169cdf76bf1a25f`  
		Last Modified: Thu, 21 Jul 2022 01:40:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67e4d66813c2c8055757d55b9545636326c6c0a6321a05cca3dadf0eb2dc92c9`  
		Last Modified: Thu, 21 Jul 2022 01:41:02 GMT  
		Size: 21.2 MB (21217420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f5e761511ff104b98dfdd954006dee72fde0610396650034c9026538acd33509
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.7 MB (157674770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a4c6e196edf0e4634b2b467c4d7b7d297fe9b98c9b699192348c9c18f5176d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:07:06 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:07:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:07:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b00d0f9a642570505f1434c8f567efaa14bb1a5a9f10f36ea46286a2e632f941`  
		...
		Size: 670.1 KB (670055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebefcefe9f8b5143fb636bbf9f48247a9843abaf1a51e84d72ea5bef3a2e779d`  
		Last Modified: Thu, 21 Jul 2022 00:41:12 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1072962b7279276bc566efb36c2809af618c96d98843eea72e1a6f7c5a8ea98f`  
		Last Modified: Thu, 21 Jul 2022 00:41:17 GMT  
		Size: 21.2 MB (21217695 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:57fe4ffd334370e36dbca9a6b291a6933a0bc8a81dd22cdbca652f30d63f65bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170651632 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e80b6097ec0824fff3886d56d5603fcc1888a9f8e1cd449a0786e11f93157ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:53:58 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:53:59 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:54:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:54:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6982edb36f93ee58ea97b10a11dc206899b1b81a8e894c21beb387d0b83791ef`  
		...
		Size: 670.1 KB (670055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9b99abaf5a9b8d94e15dd0cfea21991e08293dc45c357e50ee72d1681f51360`  
		Last Modified: Thu, 21 Jul 2022 00:27:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5d1ed5e2950b0a5b5ce7a6c31c559611c6e85005d1ccfba5d61d4d001658d83`  
		Last Modified: Thu, 21 Jul 2022 00:27:26 GMT  
		Size: 21.2 MB (21218555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:3d63c6a94a7379ccfce1d7b8ac846b78219bdeefeae2d3aac1e83fadb0f8257f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175471682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60ac6dc58dcca4885502f3340d9cba4b74f0b973c2598bd3ab2536a2860edd27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:48:07 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:48:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:e235ab3572e2565821ea41ca0ef1ed91894865b90ca7ba562fcf45848bea0820`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f84048cc8a7b654db1d9be79f5978160690c7b155c0799a5770e18910b128488`  
		Last Modified: Thu, 21 Jul 2022 00:55:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2eacbab9192d5238228da1b35f26a79173dad87ad1b52337849f8cdc861af5c`  
		Last Modified: Thu, 21 Jul 2022 00:56:18 GMT  
		Size: 21.2 MB (21217424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:25c2414aa081296aa7b699ce7ad6f68a4305618b00f673e8d9830fc3fc912d50
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.8 MB (150822821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d70b2c363b0afe63829f6bd7e78923f40ffbc77ee7e3a59c3376d3802b231592`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Jul 2022 19:37:46 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:09:12 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:09:13 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:09:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:10:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1ae59942d35c76ff8faffca1cd08a9d9f6ddaa80ef0d3f10237c209cd0ed724`  
		...
		Size: 670.1 KB (670055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae57323330df978aecd9ce7a852ea5ad4d0bd9b97cd0faa507b768a21fc0b3d2`  
		Last Modified: Thu, 21 Jul 2022 00:53:12 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b2608bf623ed93d65ee5873e4924342e6562c740b98a5c24db0f0a36e99c825`  
		Last Modified: Thu, 21 Jul 2022 00:53:16 GMT  
		Size: 21.2 MB (21217348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
