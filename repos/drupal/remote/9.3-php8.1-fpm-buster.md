...
```console
$ docker pull drupal@sha256:47c3733991d632333592c8166b37bf99f3ae178dc86f400dc66be7e9245178d3
```
...
```console
$ docker pull drupal@sha256:1f902d121821135d02b1b61e7677528502b47d328ab17612e008a9b236ad2cb3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170843039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adf8ec44a3391399b4d0b7cac48744fecab54acfb0080700ade1b67784a726e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 23 Aug 2022 19:10:40 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 23 Aug 2022 19:10:41 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 19:10:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 19:10:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f037058b7ac26ca2f8d4cc1509e1cc7c4835a62fcc526f71db698a81f3f03967`  
		...
		Size: 692.1 KB (692053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f1ae596cfce606b080880571fe7ff8fa78cdabf6ecb871fcd8e4ffadd90b720`  
		Last Modified: Tue, 23 Aug 2022 19:42:05 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02dec73d493954fc710ce7996e65a782a0333b8545785faf3bb6a44089b0a308`  
		Last Modified: Tue, 23 Aug 2022 19:42:10 GMT  
		Size: 21.3 MB (21322566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
