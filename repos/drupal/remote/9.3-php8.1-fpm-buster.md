...
```console
$ docker pull drupal@sha256:e51f975035efc1069552844da510ddcc3fb1ea458be55327c0bc145336f873b0
```
...
```console
$ docker pull drupal@sha256:a3cdfe2d227eaff1c09fbcb0fe9f7e5a3d3defb95aefed6ccaff7e129aee09fe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165735812 bytes)**  
...
# Wed, 28 Sep 2022 00:57:48 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:57:48 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:57:59 GMT
...
-	Layers:
	...
	-	`sha256:1c000e6d3b6b3c97b290c535140be28f1439fa7299caa70368d736437890868c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:231ac3b7c60a7e494b1699f9952bfe28c3fa9507f459aaf8cd77fd21b456cc08`  
		Last Modified: Wed, 28 Sep 2022 01:23:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01cbf4e955011f16882996ba46752549bc5acc8f6c3c5e79d33ddbd78383a9cc`  
		Last Modified: Wed, 28 Sep 2022 01:23:13 GMT  
		Size: 21.3 MB (21322183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:dfe94888824b22e783548b378df2fad16c88f0175163094c11813adf5c3a4cdd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141329026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2faf64017360dd4e08b922c067fe635f145f7e923d42c85494b31d0bf57440e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:34:46 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:34:46 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:35:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:35:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4a75dcaf8adfcb70e98f2599616b5264fa2f05607ac91897d3818ed05f407cce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:574f36514a275774a4f0f84aebb7c93d10fadce84434612eb86d3e69dae699d2`  
		Last Modified: Wed, 28 Sep 2022 01:30:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a6a56da5e12d6cedba4b6333b9f1fa924906c762ce783c0ca5fe53213ab305`  
		Last Modified: Wed, 28 Sep 2022 01:30:23 GMT  
		Size: 21.3 MB (21322487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d9c17a0bd1abd34aee748a73885724ecd4374352c560b5577233b3138e4f4a5b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157889473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e4fc5226f82fbb82fb3cecf3f57690923c9ac11f5dec015ebab0cf2f122c9cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:12:55 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:12:56 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:13:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:13:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bab55dcf6dabf3328e60fd5fbb7e9630065b327d168d2481126ba4403f603410`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:470a0547560372b795a8ba2aa3707ef48eb2788490e4ed861ca45282bcc71ea7`  
		Last Modified: Wed, 28 Sep 2022 00:50:32 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abab6d2c51ad909fcfc1d704fa3d790b5da1c783b3cdee023c6c9b1029b7fb9b`  
		Last Modified: Wed, 28 Sep 2022 00:50:38 GMT  
		Size: 21.3 MB (21322394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:88488cca90aaa7df8bd2e28b77e28861af596985fb9b14e94977e0d578a9079a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170842204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26adefe4dd0fb6a37529682279ef3a65163b6381e43487dd8bfcb7d4d9b205f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:08:21 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:08:21 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:08:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:08:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0caa33794dd12fd553aefcbac16282d409d2d4f373c46d04869b0d1c594ac045`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2473fae3f137049c9026548ac80e769731f4b0d19439c18d5ca983384ccd4ef`  
		Last Modified: Wed, 28 Sep 2022 00:45:50 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5510b472601c1ee184d4d2ca15aebfc30ae66bc1bc7a529111884f47f1a9691`  
		Last Modified: Wed, 28 Sep 2022 00:45:55 GMT  
