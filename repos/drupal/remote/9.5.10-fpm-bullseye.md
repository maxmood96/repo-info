...
```console
$ docker pull drupal@sha256:0e1337c13ad8a228dc0d2ff5a63f247323b29e0d65d84ea88e7e98f4f4324818
```
...
```console
$ docker pull drupal@sha256:a34d61d3df7402b781cc0a2b0f9f8af4aff000aadd446bd27e8780beb6663d3c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189755835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17434f8d2b75cf8c13d4a95f4c6ba44bfbbaa7c9d00b5691a829928c383fbe63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 02:57:49 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 03:04:20 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 03:04:20 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 03:04:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 03:04:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8a73919946a6e148de98b6be5c0ccf80bc048e7e65df53efc96fdf893c82531b`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b6d7d8b05d8f8821280010b641ad619878da33f410eefc898c38d3db43826e8`  
		Last Modified: Sat, 05 Aug 2023 03:16:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eadb77f838f0f95e20366b01a93a8ae953adb0fe6b401ce90cf666d191f925e`  
		Last Modified: Sat, 05 Aug 2023 03:16:46 GMT  
		Size: 22.9 MB (22879957 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6a704e5074b3f70d32b3b9a9a065da41944bf4ce429c479bd9d6c07dced9e716
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164021961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cda88046f2d4ca9111fba531881a9c908f5e91ac7fd81937dce47bc9373da65`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 00:30:24 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:37:14 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 00:37:15 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:37:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:37:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:37a048aab451a686af9a5d880849dec6fecf09e522c975c33a7ff7da9e042cb9`  
		...
		Size: 698.2 KB (698241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96774ca50b698e92c7a7f13358110d37519d70cd0a8ac5e76c344c77ad989276`  
		Last Modified: Sat, 05 Aug 2023 00:48:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25c975df6aec01a7d6505503cec57ba43fd4bd4e7189bb209b9890406093e27e`  
		Last Modified: Sat, 05 Aug 2023 00:48:35 GMT  
