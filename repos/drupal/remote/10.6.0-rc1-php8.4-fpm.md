...
```console
$ docker pull drupal@sha256:caf67a738f8f293bf95b94918a9855eee06ce0b6d83c50ca1d64460547aab21a
```
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; amd64
...
### `drupal:10.6.0-rc1-php8.4-fpm` - unknown; unknown
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; arm variant v7
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; 386
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; ppc64le
...
### `drupal:10.6.0-rc1-php8.4-fpm` - linux; riscv64

```console
$ docker pull drupal@sha256:64df2e4d5db93277a802acd5afd37ca263739fcacee5f48141aa6bcf910192c3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.0 MB (226002566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db228fd13d508b14de13f8038fa16f0e0537e6a21fb8d83b93a1a7f1c437e55e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f8cae36c0500b32b38364fcfffca5da61f00c31ef659737473c9643f7ce40709`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b03f700771392334d1bc69eab419510523e5091563d637db5e5dffcd8e718715`  
		Last Modified: Thu, 11 Dec 2025 10:14:45 GMT  
		Size: 21.8 MB (21846878 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.0-rc1-php8.4-fpm` - unknown; unknown

```console
$ docker pull drupal@sha256:d883eac3d5955170eb1e299df77a233b1a684ea48d8ddc9696efb7655f85838b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.9 MB (6907973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b9a2659a2303a95e0adae13af4bc36bf12e158ec7f2f725488d2c3900d652b0`

```dockerfile
```

-	Layers:
	-	`sha256:42a887bf21503cda5b27c9c3e21be94a6cbaa63d80cf7deee4ce1ea208878ba9`  
		Last Modified: Thu, 11 Dec 2025 12:00:11 GMT  
		Size: 6.9 MB (6872130 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e6d67edf6f215b5794757b8e05174fd590d485473d20bb88fabc50b0742d9c0e`  
		Last Modified: Thu, 11 Dec 2025 12:00:12 GMT  
		Size: 35.8 KB (35843 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.0-rc1-php8.4-fpm` - linux; s390x
