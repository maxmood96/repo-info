...
```console
$ docker pull drupal@sha256:5017924b7c80b20bbbf955408c8ae9d432309d6e3af5c840dfcb952ab10041db
```
...
### `drupal:10.5.7-php8.4-fpm` - linux; amd64
...
### `drupal:10.5.7-php8.4-fpm` - unknown; unknown
...
### `drupal:10.5.7-php8.4-fpm` - linux; arm variant v7
...
### `drupal:10.5.7-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:10.5.7-php8.4-fpm` - linux; 386
...
### `drupal:10.5.7-php8.4-fpm` - linux; ppc64le
...
### `drupal:10.5.7-php8.4-fpm` - linux; riscv64
...
### `drupal:10.5.7-php8.4-fpm` - linux; s390x
