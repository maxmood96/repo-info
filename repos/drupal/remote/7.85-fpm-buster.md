...
```console
$ docker pull drupal@sha256:b742328067df25b94f84d31ef137daca238e140caddae978e68113b3e6834579
```
...
### `drupal:7.85-fpm-buster` - linux; amd64
...
### `drupal:7.85-fpm-buster` - linux; arm variant v5
...
### `drupal:7.85-fpm-buster` - linux; arm64 variant v8
...
### `drupal:7.85-fpm-buster` - linux; 386
...
### `drupal:7.85-fpm-buster` - linux; mips64le
...
### `drupal:7.85-fpm-buster` - linux; ppc64le
...
### `drupal:7.85-fpm-buster` - linux; s390x
