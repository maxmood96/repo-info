...
```console
$ docker pull drupal@sha256:590e83b9027f7fb61cf4986e3a0897a508db0d4aa29ba17ee0becfaa679c188c
```
...
### `drupal:9.3.19-php7.4-apache` - linux; amd64
...
### `drupal:9.3.19-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1474aaf64d2aa330129170f0dd8ed0ad5231e6fb6cea5561722b97ec2b91f965
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157255564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24ea997fe8eb2cd8bc2249db1c05ed5b2c790adc7d2a9b6b210d12574f3970da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:42:19 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:42:19 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:42:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:42:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d91d39bc7768938a39337d6393af7d40bda41ceabf6caf6b16d620436d551a90`  
		...
		Size: 670.1 KB (670060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8f37da1a2ab7cc481b768a4875e6e3a08b5c952e21e536c1298e886203f8331`  
		Last Modified: Thu, 21 Jul 2022 01:48:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13e3bf9f0ef2709e874434fa683e03e3577db0337e7c005229bf0e48020e3a72`  
		Last Modified: Thu, 21 Jul 2022 01:49:26 GMT  
		Size: 21.2 MB (21209988 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a45ce44dabd1cc447b46b6ca521e4aa235e6ccc7249f00ac6492c50271391b12
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.1 MB (180058184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3321c8fd6351bf306cbc2171b809c1ab2cea57eddc49166abc315c9a4ff6206a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:10:46 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:10:46 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:11:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:2d2c433f259752f80a5981da95b0229a3147a16c4d4ebbd0ba5f4bbfbc664d2b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89e704aa535891c629d6960cbbb6b29c99d49e0c8741ac950911eaf3ae701902`  
		Last Modified: Thu, 21 Jul 2022 00:49:11 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e394d8d1691dbe5cb93c5a98dda3d6bdf5c2d1ab045931fd949840f443b20af8`  
		Last Modified: Thu, 21 Jul 2022 00:49:16 GMT  
		Size: 21.2 MB (21209187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-php7.4-apache` - linux; 386
...
### `drupal:9.3.19-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:3a3d5178035bb7cdc606b34bd8e3c9b3d0ee82d53285978da2cf71acf2a38754
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188080775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84305101812074d411107b7d54457d716ff8e71186dd9b77c2f00a3a8d0323ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:55:17 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:55:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:55:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9953b3e93444148396d770efaa312f2d3362ab9fd2acaec9bc8e041fcc7e72d6`  
		...
		Size: 670.1 KB (670060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1413d72f23352d133d98c9cdc58760bd780987db90e320301e5c66c5deaaffda`  
		Last Modified: Thu, 21 Jul 2022 01:10:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b113c884cfd4784549acc4b8edc29191b99fad08a5c0e4bffdc51cdbd78c302`  
		Last Modified: Thu, 21 Jul 2022 01:11:38 GMT  
		Size: 21.2 MB (21210016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-php7.4-apache` - linux; s390x

```console
$ docker pull drupal@sha256:c898b96d06d647054f57f39dcd7fccd37ebb2e63f3015ef700213fb7eacb409d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.6 MB (164559662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75d8525d6bcd95c67dbc8b2eb5d3e8bda0c92ba145b1db9ddbb0fb3d3174830f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:18:47 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:18:47 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:19:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:19:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:67bd64d0118b374bc11fb63ba566a132610b321833e05856ba37ad23bc98f897`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb17912e0f9b964b8e43521847e2f1eb394f0e64c9db3c6010414828a569751f`  
		Last Modified: Thu, 21 Jul 2022 00:56:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b221234d7a182fa3aabf6d36ed87125403931e673fc88526c2b5a0224bcf402a`  
		Last Modified: Thu, 21 Jul 2022 00:56:30 GMT  
		Size: 21.2 MB (21209929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
