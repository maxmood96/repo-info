...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; amd64
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - unknown; unknown
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; 386
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.2.0-php8.4-fpm-bookworm` - linux; s390x
