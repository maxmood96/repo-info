...
```console
$ docker pull drupal@sha256:f56844a25eb5fde9ca0f4a521cf3eb965abb0d81dff9826729b05d32658c75b9
```
...
```console
$ docker pull drupal@sha256:7ff03120931d0be4d7e49c948e9b486d865f26fb72e281a4dcaeb832aec384b8
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53275124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dafda3d30198b5aac5d4b99abddfe63e1f630ecacee24e0a4957cc80b03d549a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:52:47 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 12:52:48 GMT
ENV DRUPAL_VERSION=9.4.8
# Fri, 11 Nov 2022 12:52:48 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 12:52:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 12:52:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e6301330e0d357cebbfea47731c545b658c07dc8b267357a7ec3b84068787c8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d37b7d4b07771762f6b3553ac16c54c3dc7d517043bf6751695e2eafbc3598a`  
		Last Modified: Fri, 11 Nov 2022 13:06:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b01cdfaba80d5f0cfb30179ba0ce191ba8b03e9bdc89016d91c2dce6773cf93`  
		Last Modified: Fri, 11 Nov 2022 13:06:28 GMT  
