...
```console
$ docker pull drupal@sha256:ca1630462f8c333903bf3315c8126815a9e00ecd85cb4bf2f94a0f110edf5cbc
```
...
```console
$ docker pull drupal@sha256:4bf3025945784cf3e540e47434982786c4802ca89eca1082fc9546df29221c65
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160078107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:318eca38ebc564eb57328ff3015c2500b26d0f3488515b77d022f0659703baaf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 07 Jun 2022 04:12:13 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Tue, 07 Jun 2022 04:12:14 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:12:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:12:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ff6f877f66d877f25c468e69b65fa71948122804354dfff19f39089d1a26a774`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c23fb2364558d32271dd46b1a72f9b673b545450b65231a7dfc128a7874afe5d`  
		Last Modified: Tue, 07 Jun 2022 04:44:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1071a0ed09013042d72adf2947c6989529dbbcd75515aa6eeee05c00cc29fdb0`  
		Last Modified: Tue, 07 Jun 2022 04:44:26 GMT  
