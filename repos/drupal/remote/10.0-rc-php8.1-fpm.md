...
```console
$ docker pull drupal@sha256:de1d6337a6296cecf0b29041fb01971f6d6a7d27568fec023cef5829b3161d05
```
...
```console
$ docker pull drupal@sha256:52c68c5afbea1e7ff06fc681f1ed3151ac64922a7c54e51cb58f73075ccb1b47
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (184974764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d72722eed2b4c306639e4c22ae8f0089e5777ae57a64e63e3223d79f323b0357`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 10 May 2022 16:39:49 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Tue, 10 May 2022 16:39:50 GMT
WORKDIR /opt/drupal
# Tue, 10 May 2022 16:40:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 May 2022 16:40:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:935fe54aab56c3970e3d75a405801910f93d39cd8d2bffb13aa433a9a65c0db3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15249efcae81198dfd4e68ff824652dd10c40f10eb98e6713fca8b88c55553c5`  
		Last Modified: Tue, 10 May 2022 16:55:37 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:562362a8824acf7621c04674399017e8edd2da8100832e18694ebe9739c4564d`  
		Last Modified: Tue, 10 May 2022 16:55:43 GMT  
		Size: 19.1 MB (19118762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:eaba3e61e430f96b1c23548a56432699675ab9fb3fc7b16fb1e03ef1625e55f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160109856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d99f57e65adeeb47df54e6113e89f439696845df4250069611f2433f51837de2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Apr 2022 07:30:33 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 10 May 2022 16:42:41 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Tue, 10 May 2022 16:42:41 GMT
WORKDIR /opt/drupal
# Tue, 10 May 2022 16:42:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 May 2022 16:42:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4a58dbb54e688001ebd800860cf84761d3d820da29057bfcc1ac0e2e9fdfbb2a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e09f656efe6de9deadb601729a43308f0d8ecb142c0b4a4ac30472c3832fcfc6`  
		Last Modified: Tue, 10 May 2022 16:58:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84296e7954d1b0e42030ad601e68730f0ca31d86b8d81eb48765b707ebd9c394`  
		Last Modified: Tue, 10 May 2022 16:58:50 GMT  
		Size: 19.1 MB (19117476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
