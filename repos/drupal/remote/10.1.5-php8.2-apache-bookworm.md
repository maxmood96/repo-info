...
```console
$ docker pull drupal@sha256:5dbf84c2d28447af4557417c01a2ca51b4bfa6c064ebc88456d29399e5182f57
```
...
### `drupal:10.1.5-php8.2-apache-bookworm` - linux; amd64
...
### `drupal:10.1.5-php8.2-apache-bookworm` - linux; arm variant v7
...
### `drupal:10.1.5-php8.2-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.5-php8.2-apache-bookworm` - linux; 386
...
### `drupal:10.1.5-php8.2-apache-bookworm` - linux; ppc64le
