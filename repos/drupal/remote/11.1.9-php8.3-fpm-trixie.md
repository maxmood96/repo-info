...
```console
$ docker pull drupal@sha256:bbdd13569d381ddbf2e8a9dc861b12ae2795ee6e70a41a31891b5e7f3050cada
```
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; amd64
...
### `drupal:11.1.9-php8.3-fpm-trixie` - unknown; unknown
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; 386
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; ppc64le
...
### `drupal:11.1.9-php8.3-fpm-trixie` - linux; s390x
