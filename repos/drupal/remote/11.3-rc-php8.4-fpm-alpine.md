...
```console
$ docker pull drupal@sha256:9f18767cfe2d3ac0fc4858301b3ed312bd00ebbc954c95ec0d9d322b105d7588
```
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; 386
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; riscv64

```console
$ docker pull drupal@sha256:0ed231fbda7b153b32ed40587b9ce600669c78d8ef55cb5114a5cdd3b6be9d1b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.0 MB (58999819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b6ec60aafecf662c158b346a319a47a0971968e35055f4bb6a153cd58bb143e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3fed8e664c87d218e1a3f5bb6c2b5e253037c9bcbc461a321f591b9d2390f424`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a589f84fc9983c58dc37165048c720d3325d95b55cc2d86b307a40a5cd671e0e`  
		Last Modified: Tue, 16 Dec 2025 13:01:49 GMT  
		Size: 21.3 MB (21292927 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.3-rc-php8.4-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:32a1170f49a485de22cc63ed144e5b94a707ad36cc85479cf5af90c663f9788f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **407.9 KB (407872 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57e1c3db36f7fbadfbce55081760d61ae26990e6422d07dfabce2c1c987b3f11`

```dockerfile
```

-	Layers:
	-	`sha256:7d7f4d3f34a5fe0e6af2c77eb1c32f088573efe4d7ef207ee5adc4c7739846b5`  
		Last Modified: Tue, 16 Dec 2025 15:01:43 GMT  
		Size: 375.4 KB (375411 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:33f233d8951f61efb675d36512738f1e8977b5b380c952ae4f274d3530414f23`  
		Last Modified: Tue, 16 Dec 2025 15:01:44 GMT  
		Size: 32.5 KB (32461 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.3-rc-php8.4-fpm-alpine` - linux; s390x
