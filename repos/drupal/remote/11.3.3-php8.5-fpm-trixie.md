## `drupal:11.3.3-php8.5-fpm-trixie`

```console
$ docker pull drupal@sha256:2f591ad90f081b3fbb10614a2509fd38b9b8bb8c95f645004609033eb37a1144
```
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; amd64
...
### `drupal:11.3.3-php8.5-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; 386
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.3-php8.5-fpm-trixie` - linux; s390x
