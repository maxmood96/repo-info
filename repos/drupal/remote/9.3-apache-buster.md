...
```console
$ docker pull drupal@sha256:62c1889d2c45dccdf0852c27af0a608ddf7615ef7b5009ca83711578eb044666
```
...
```console
$ docker pull drupal@sha256:db09132ffa425be9004a0f912613fc50de0e1c26bd01cadf7591fd2809311e33
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143894186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9ab4d681fb2705e5ff151087501397fb7112ccf66a454d311289ff86a716f6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 06:52:02 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:52:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:52:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d2ea3359e1034b9cb39449505fdad8dc4152571621b05cccb65716346905bd0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9341e5a3456b01521bb9bdf5f89ec49275a9abf51632881d6f2b004016cc743`  
		Last Modified: Tue, 29 Nov 2022 07:30:00 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d150254c7196e0c2ff0701838db016ec007c1092dc75dc1e3c231a5db56bdf35`  
		Last Modified: Tue, 29 Nov 2022 07:30:07 GMT  
