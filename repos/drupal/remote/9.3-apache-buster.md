...
```console
$ docker pull drupal@sha256:d670d52661a950189a0af6b4e72d23035773677e04327d9c272dabf4b82358bb
```
...
```console
$ docker pull drupal@sha256:f7bb09d8aa6735d0efb8991e0a8359758f75ad1de9f4cacfe5969aacdc78f173
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.9 MB (173932290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1af469ca9ee6f052eed24317656c9f3c0222b337d8d551f236ed8466ab6095d8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:57:32 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:57:33 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:57:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:57:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68d07465ccfb8edbd4552081c8b45d523f621b5d8ce101d0d9f9f5b604db2176`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f636cb135cbb645adcb983b49f3bd8f60b23aba0705bb50cd5ceb7d1af97e39`  
		Last Modified: Wed, 16 Nov 2022 22:55:32 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d5b0464e362cd46f5e0d1190b236a37a8460cdb5e3d229658d9cc7b9cd40f5b`  
		Last Modified: Wed, 16 Nov 2022 22:55:46 GMT  
		Size: 21.3 MB (21323814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
