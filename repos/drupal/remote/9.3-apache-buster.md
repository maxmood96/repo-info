...
```console
$ docker pull drupal@sha256:af87a968baed582175016cad8fa10f26b53e6188766849290581c893a9ee22c6
```
...
```console
$ docker pull drupal@sha256:35ea9659a0f1d4879c914948402341c9de461bc8922cd31f7e7cbac1a55066a3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156149986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4736ea4eae8dca9516e767439066b410b30f16a3b2d7cf36fbe5cdf06eda7fe1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 22:11:30 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 22:14:08 GMT
ENV DRUPAL_VERSION=9.3.6
# Tue, 01 Mar 2022 22:14:08 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:14:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:14:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:81edfeb01b1580eee425de8c4938621d475fc713af5cecaaebaca83202590bfc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d81ffde5852ec6d9c8d260126ea1822f4038820c91b9b940a5512c16a14bc008`  
		Last Modified: Tue, 01 Mar 2022 22:36:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e8c2d977a323037c13e1524a729b3a401e01f43c61cf7b494db5e37d7976af8`  
		Last Modified: Tue, 01 Mar 2022 22:36:26 GMT  
