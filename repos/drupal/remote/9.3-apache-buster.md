...
```console
$ docker pull drupal@sha256:a547da7cb18a1c2d1da52f5a9cc64e286048d2aae977704ba383267b2eddbd79
```
...
```console
$ docker pull drupal@sha256:91ef7d1bfcc776f16c6d8c62d644727ff505b79d211bb19e0705f251619cf455
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143678215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff58ad8327f0ed2dd76ffb2af13409e48857a891a50243b0c8164e6af7ff7b7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:12:17 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:27:02 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:27:03 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:27:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:27:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9ea36d2bc7dacf43a8924ee5d1db8b20e74d0851254e4731f1d625f26e3223b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:719ad092c16ac0b7fe68782e4b8a9dd9b2ac85db0d58b8170721d5a690d13af3`  
		Last Modified: Thu, 04 Aug 2022 10:16:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93ff9ff9a6f6ab8fddac3da108906c5b8ae9992cc4d95c8da0165f1541512e76`  
		Last Modified: Thu, 04 Aug 2022 10:16:30 GMT  
		Size: 21.2 MB (21224021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
