...
```console
$ docker pull drupal@sha256:b08d82667378567d608d4ca40d1cdff6a67ded7b33c98e086f8d7a1d3aff037f
```
...
```console
$ docker pull drupal@sha256:3c89cfd8cc72978bfded0e9303e263ef5216e8aacc6327cea388c05f8cba4831
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.8 MB (173777644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c60d84a99ac1557c9402e1455384491f4e4ccdce05e550de09ed085ea8a74488`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:50:22 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:50:23 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:50:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:50:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c8c34a1eb24c2fcd03259104b833b7a728b3115dbc4023689b7dbe5e62676b0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2667424f719d30cb991f24785bd96be94136c41217734f220d08dd826d1ba13d`  
		Last Modified: Fri, 29 Jul 2022 02:23:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43db94631d970c91bb02a06934a958db0d73e33a80c5ef52891d1391d60377bd`  
		Last Modified: Fri, 29 Jul 2022 02:23:26 GMT  
		Size: 21.2 MB (21224826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
