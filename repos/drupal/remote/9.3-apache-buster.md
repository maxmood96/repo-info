...
```console
$ docker pull drupal@sha256:d54e29ce61a337cb79abfd670be6231e83da1cd201575c72499b66ed7cd521c7
```
...
```console
$ docker pull drupal@sha256:bdee3bc101c3464591532ad66c35d8bb0d544c25a0e7e0688a776020a495e811
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.0 MB (170955480 bytes)**  
...
-	Layers:
	...
	-	`sha256:4960d24ff9e782b60a31088a70182f9a7cc45c098f2f50b8d8f51fa437249ed3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fac840e9cad4c1ff552f60be0c534fbd2f78292540d4c3f735f2d43b7732fcba`  
		Last Modified: Thu, 06 Jan 2022 20:32:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0baa32dcc992e5cd9f39e329287797cfa1d3dc98caa111ac9f03529208b3342f`  
		Last Modified: Thu, 06 Jan 2022 20:32:18 GMT  
		Size: 20.1 MB (20143653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b203c827c0729022d4df8998183bfaf1fdeba2c763441de1f4a478be1a24942a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145628886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab686d9229be288edd5c31b276a91572b5d89b8ca5e56acb9f14876abe096ec7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:10:32 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:10:32 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:11:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:11:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fea1382bc83e7cd506f768382c3af06399039ec6e4e9b9d0bdf1faa11001409d`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c551d34c614b594881555c31b9ef6c539112fb164eaada1529494050e61f8c00`  
		Last Modified: Thu, 06 Jan 2022 20:41:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9380bf35f21e89b755c5f4d91bf2c7b0cab02716f73fbf054bc9b2acce6a9236`  
		Last Modified: Thu, 06 Jan 2022 20:41:48 GMT  
		Size: 20.1 MB (20143109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:cb5e69e0e85b8c415042069a269d5a3bbd617f5f3192a932e46d4edde0a1b0df
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161752776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:133efe03e39f25f771997ed9e1071e5ceca3e2e2b84cad39435019e5142fcd63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:46:06 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:46:06 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:46:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:46:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5f58a17ca272ff95f870624e051352ce953fc550b2d586704b5c209a358d28c9`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:209f5a09a3c187c3fa447169bcafa089a7c7781873ce31449686e4e6ec7bc55b`  
		Last Modified: Thu, 06 Jan 2022 20:03:21 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81f93490136abb8ce464f189c113ddb738f6735420a68ee38bc381aa2ea8e3b1`  
		Last Modified: Thu, 06 Jan 2022 20:03:26 GMT  
		Size: 20.1 MB (20146395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:acf8bdec7788b40537f1d43adfd2d7d55aff0cb8bb8da315efeb5f462ca49a30
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.9 MB (176931851 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:201e6faed0be9b6fc6df6d74deb812a2a7b1bb2df4015b387b901eafa518f91f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:7b4809332fc5fc403ab7d01347d5169ab379cd10beb2c32367e7fcd9eaea2b00`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1919d1028a04ae981029034132e9a8fcb981c0dfeac7aa12617e93ed5f2a8658`  
		Last Modified: Thu, 06 Jan 2022 20:03:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d5e663829c9ab0e4df9b10e4252f5e2a2a86c824ae91ed9f4367c35a953351d`  
		Last Modified: Thu, 06 Jan 2022 20:04:02 GMT  
		Size: 20.1 MB (20143133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:1bfa1dbb38d234e8bf833a8c2277a6471c6ff6f85e36b661e8b937d0fbb344bc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181728693 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63e9ff279fac6e116b1e40fd9b8beb8e59e025e18c0c0fe6126783d2dd5aa6ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:24:23 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:24:27 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:25:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:25:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b3626bb3bd94556564af3105d8e7cbc396d4552529d38c8e9ba9400418f7a9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e20b5b98919aad1f0fe765a8023be53043de60d2e32e7f755983e1886b58e24d`  
		Last Modified: Thu, 06 Jan 2022 20:44:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9dee84c2d91b14f4ad9c76fffb6b90e7e4bcdddc0ed8c3ca516756012f6141a`  
		Last Modified: Thu, 06 Jan 2022 20:44:48 GMT  
		Size: 20.1 MB (20143477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:56773368b2c1d5d9dbacd860bb1a4295b20fb66569a0436b8f71fe55c3f37c5b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155971885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62d8a4341ea7b86fd1eceec12abffa1ac62b22d227881f198cf9255d44bb3291`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:53:24 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:53:24 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:53:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:53:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ef2c21e60ec5b8cbd06982c2187887c073ef07419054dc29e982521fd9411a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9145635b6c9bd550f1c1d176ce10fb883081ef374afd60b72130f590924e3468`  
		Last Modified: Thu, 06 Jan 2022 20:07:37 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df7d88460f4459c8af26d2a6e3dbd2732f51bf4551b58dd516255e9bd0b18171`  
		Last Modified: Thu, 06 Jan 2022 20:07:40 GMT  
		Size: 20.1 MB (20143689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
