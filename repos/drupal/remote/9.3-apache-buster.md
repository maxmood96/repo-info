...
```console
$ docker pull drupal@sha256:257ee485c587ee95a0433af2d9f314c64c8555c99f864c6679dee5f117ba6bb1
```
...
```console
$ docker pull drupal@sha256:7a050db6d978a62f7095041b56dfa24ab58a9745a6519134d51f2cc2d62962c2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.5 MB (142543429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b13bc2eb7150198954bf73f03236540ff015c5a49ad36eb899e8b9b74b4a25d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Thu, 03 Mar 2022 18:10:02 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 03 Mar 2022 18:10:02 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:10:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:10:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:949891c73411502ed31f5df24983611e7ca89716709070937a0b827b686bb2a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b67a19778c546a35d3bf523f4bf363b571bbe52a3410879d68d9c5c254b14b98`  
		Last Modified: Thu, 03 Mar 2022 19:10:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:443db974761e8e6879ca24d52c66709614cb9e41921e530af0645b524ab8139c`  
		Last Modified: Thu, 03 Mar 2022 19:11:07 GMT  
		Size: 20.1 MB (20129876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
