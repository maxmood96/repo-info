...
```console
$ docker pull drupal@sha256:cdae33ab18485853384a4e070dbbc1432753f3be6063e7d3df80c3a5202d9d08
```
...
```console
$ docker pull drupal@sha256:9dbfdc83c2f679a21659132348be1e6d8843b81f424bca96c676c8f9f0663a3a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143923292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e2c706ec23c3a16ac004843d0ca2071ea1a30ae4c021e5dde612ef3d139b6bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:09:52 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 22:09:52 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 22:10:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 22:10:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bd408c017cab64704bd53bfa96a6fc6ba619355dd635bd2f587b94181b83c56`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c15c85801bfe295f44d4b63a0a206ba64d59d6cbe5ecd1447360a6715b5258cc`  
		Last Modified: Thu, 29 Sep 2022 22:59:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff7a9aefe901eead0c45b2563d6112a48e471aa28727fc08cb4c379858d7a3f1`  
		Last Modified: Thu, 29 Sep 2022 22:59:42 GMT  
		Size: 21.3 MB (21323431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f54cd96920f3c46a27d343482ad34b82a7424b2ec1b2e975854a0b300de9bc03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.9 MB (174923816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aa1e9f2166ffe81a810dfa5e7751bc1e883b5a73971c4a2f2d37b45c8004a78`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Sat, 01 Oct 2022 00:19:53 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 01 Oct 2022 00:19:54 GMT
WORKDIR /opt/drupal
# Sat, 01 Oct 2022 00:20:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 Oct 2022 00:20:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0cec6fd3f45bcdfdcd7b40c3316929cc3f35efa0f46dcdf37d9f6d5ffed3fb0b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cef0276efbb3aca1c9fcca996f1fc2385e1dacc4e96b9c6f8a934252f2610526`  
		Last Modified: Sat, 01 Oct 2022 00:43:38 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb817e2d338dd073f515e8f975703caeff1ea94f384e756af4391c6113e0ae57`  
		Last Modified: Sat, 01 Oct 2022 00:43:43 GMT  
		Size: 21.3 MB (21323576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
