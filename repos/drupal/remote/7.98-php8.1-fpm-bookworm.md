...
```console
$ docker pull drupal@sha256:98580737dbbef126e44a53b2f40f0139cf08ec999044a6e4e29f70b7739f1cf5
```
...
```console
$ docker pull drupal@sha256:6816318367cf200aa071611a1e64e5aa6942b73d08b0df9e658b48c172baace4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152170615 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d22d5e793713f60f75c586ec7a9604ed879c8009758b89d76f23f0d8a5fcbaa2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 23:11:46 GMT
CMD ["php-fpm"]
# Thu, 22 Jun 2023 23:52:34 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 22 Jun 2023 23:52:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Jun 2023 23:52:35 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:52:35 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:52:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6085091cb6a937f9e612934aa359f73d065b79a8fe0817ae5545a9a6d8b7afdf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54ff91b372d146b912b8bcfec8823bd5409758f7e7725ed3ae0b4863fbb998c8`  
		Last Modified: Thu, 22 Jun 2023 23:57:26 GMT  
		Size: 1.6 MB (1641478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad86e581c2ecc9e0ac4c582092b7890c38b65aadd814179529d7fe9c691cd259`  
		Last Modified: Thu, 22 Jun 2023 23:57:25 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf465a80d47e79c4b3f850ce864a7ab7473cba3a80ddaa5d94b3ba0ec363e5f4`  
		Last Modified: Thu, 22 Jun 2023 23:57:26 GMT  
		Size: 3.4 MB (3410782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3fa381e5b2b096c657df16f70fe1d0033be0a5d11ea7b46eaf0239c749c6f0e0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.2 MB (143204802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b433843050f08eb4e0bba96a2b07aafbc37c3dac7bd538fcfdcf57f9d1fb120`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:02:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Jun 2023 23:16:27 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:16:27 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:16:28 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5e4b3751892d966334c21be5729d6d1c457e1b05a7508059d3dce87fab781e76`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b53580823f766df44d460cdd1d09fe72a84f3165dbaf1532c848031d2974ce3`  
		Last Modified: Thu, 22 Jun 2023 23:39:11 GMT  
...
```console
$ docker pull drupal@sha256:c908697ceb90c2ffb1f9cdf95667eaeb8f3c93bcae2aa163020008dfe1f14987
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172679519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79c804530eb6445b25d25774b81a49e8ac4f534b655933bdb59e844932aa07f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:48:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:01:43 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:01:43 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:01:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:da564b538ddf64a073d24e548864bb9d789302b61268eae13ae61640f6e80a8a`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10d21c1a33976de36d81e9a4f6549514d00b13c3a58ac45483faabdcfcfd7e4d`  
		Last Modified: Fri, 23 Jun 2023 00:21:50 GMT  
...
```console
$ docker pull drupal@sha256:d206890f04f8ff75955e9259cc35e3e2486767a55efbfa9291b9ea5ad385f5ab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.4 MB (177422104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52128595e16004fefec9956c106cffe2d751dc5fb2b24e08beb0f9ae715448f5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:46:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:51 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:51 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:faffad07dbeb9028b770b534280230db03d26afa4186e571743c6aa0a0f1e3c7`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ed937b1b85893e8f6465adfe347c35122b927ca8d547939b4523b70f9a47ffb`  
		Last Modified: Fri, 23 Jun 2023 00:27:02 GMT  
...
```console
$ docker pull drupal@sha256:708169fb80c65e1e12bf115c9e74bb38044dd10ef393f752c491f78b530d9a30
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152001527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eba1125f1558d9e2330995f3c9648204c6945270a0176fc91742f02b9017ef83`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:05:38 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:05:38 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:05:40 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1d5da98b74eda6eecf9e1ac1dbbc4f5cf1d8ed8c1bd671ae62d2f775e79c774e`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2953e371ccfcd9babab815d7922eb558693514e5f1f9d4ef2517a38618f839b3`  
		Last Modified: Fri, 23 Jun 2023 00:21:16 GMT  
		Size: 3.4 MB (3410782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
