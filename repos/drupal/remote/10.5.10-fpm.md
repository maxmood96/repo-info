...
### `drupal:10.5.10-fpm` - linux; amd64
...
### `drupal:10.5.10-fpm` - unknown; unknown
...
### `drupal:10.5.10-fpm` - linux; arm variant v7
...
### `drupal:10.5.10-fpm` - linux; arm64 variant v8
...
### `drupal:10.5.10-fpm` - linux; ppc64le
...
### `drupal:10.5.10-fpm` - linux; riscv64
...
### `drupal:10.5.10-fpm` - linux; s390x
