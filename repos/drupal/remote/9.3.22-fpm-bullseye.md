...
```console
$ docker pull drupal@sha256:d657c3ecdb3d88f5f3ea0c6deb9e689dc708571ad86fa83ac1fbb8ce6bf09121
```
...
```console
$ docker pull drupal@sha256:a9d1e692dcd1c36af73ffc1f592445b58433ceda02b2f071b3c41f9326c6d216
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154512048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2671c854e1348e7625d9dd7e4bd46dab850d8249fd9ded384a9c1a230851a45c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:41:51 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:51:36 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:51:36 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:51:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:51:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fb8b1c18e4410ea4772380c9b9867a3ef6746263f7b8e9eb5ad4f6ed3a2b0103`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66e4ab691ae5b0ba9bef6ea60b8a68a69c0ee4f8da10389bca3e4acbaf3eeaed`  
		Last Modified: Tue, 29 Nov 2022 07:29:20 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8261f0a0bc04619fb2fb477001507a171715677e849a21108569cb09291c7800`  
		Last Modified: Tue, 29 Nov 2022 07:29:28 GMT  
...
```console
$ docker pull drupal@sha256:1e09d4c0ab6c4a61d3cf66931f70ca272c737cd81f39a9d661791108ed240e5c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161414804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78338c2a9c9e70cbc61ec03e91102351195fce85a248daada879624e853e9859`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 04:04:51 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 04:10:12 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 04:10:12 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 04:10:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 04:10:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6cb5a428b8b814de2d58333da6569c30e45cf59bdbbc404468004aaf0fe7ba64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1ddc79c8c82da3e311219c8ea79af1e5da4e544a11c6057449e3f57b4f6bddb`  
		Last Modified: Tue, 29 Nov 2022 04:29:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:811c7a585c81ac25b3805d58ef17facb9fb1ac84a30763ce6f39118e8e0797c2`  
		Last Modified: Tue, 29 Nov 2022 04:29:27 GMT  
		Size: 21.3 MB (21324263 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
