...
```console
$ docker pull drupal@sha256:15839e6d62b13dc8be8c12d46232613c4a6a59ade9ca737ed8d527ea17819147
```
...
```console
$ docker pull drupal@sha256:89b3711bb1e2b5adb698642fd6b304f1e1ccb18cab40a383ee26dbe00a6740eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.2 MB (186168337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a962045ec633eb2c97f6797b10610b0bbd424cf64f376b0f7c8f21cdba8da5e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:57:07 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:57:08 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:57:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:57:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:07c1a9862833bbebac2ad300132bdab7132ad98f227393f7bf222ccf7ef45b3f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5968332d891f76a4def095a9a1e26957426053ee0602e4aeec85a829f110723`  
		Last Modified: Wed, 16 Nov 2022 22:54:48 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:349f544cb259f26f03735aef34cefcff2b8cc2e44ef9cd0692e6ea4559e68fe4`  
		Last Modified: Wed, 16 Nov 2022 22:55:03 GMT  
		Size: 21.3 MB (21323876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
