...
```console
$ docker pull drupal@sha256:e9be6ceee854bc81f904f4e41ce8db00716e8c0a0f8d2d7f2c63bfefd1ee81be
```
...
```console
$ docker pull drupal@sha256:77cb3715acd9bc623eec5af945c0560b83eba1a560b1b86e5105c8102fca7d27
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.4 MB (47392881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a385ebcc64a30e22b03c6d25db687f3a49dd166309e8086b85148d645bb3eeb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:12:04 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:12:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:12:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d7fdb1f4f79723871b3aa65bfe2027cb7faeb825232fdc77c8c7e0ab4d31c6c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be224d8f0d0bc47383d77d3c664190ad232055e0fe303ff2b93ec55f1bd6ec69`  
		Last Modified: Sat, 04 Mar 2023 02:20:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25bc4e169421690217a046ce8719174c04141a66ef01f66cc34c57edb7f9056e`  
		Last Modified: Sat, 04 Mar 2023 02:20:17 GMT  
		Size: 17.6 MB (17649804 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
