...
```console
$ docker pull drupal@sha256:9fa56779ddd765d6aeaecbb21fb9a8549e07a94ccd7895de941a9d5abd067ce7
```
...
```console
$ docker pull drupal@sha256:497eae1f00a1cc5c2c027076662f62ad6f0b296b8e25506c4e19fabc0e5e4162
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.0 MB (199012013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3828bd0619c8024646f22116e0a57829043aef47383bd986e5bb1a3865a03c64`
...
# Wed, 01 Nov 2023 19:28:48 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 19:28:48 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 19:28:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 19:29:00 GMT
...
-	Layers:
	...
	-	`sha256:657580d7c84ba16e7d4c2b0021a9232e3103472027fcfd65956b177c3c8855ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b08b99b83c366d52b0e8b2ba82bef6b57efdb7bd709d8f7144d1d820909af13b`  
		Last Modified: Wed, 01 Nov 2023 19:49:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:560da23df03041189f0bcf182ccdb2ff8c4e5b14e5f5a434b754beb29dbd63ee`  
		Last Modified: Wed, 01 Nov 2023 19:49:13 GMT  
		Size: 22.9 MB (22879977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:409c8e23ec7a202d84aac297776f130302022a0224660a07882459bd136dd72e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163450228 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7312024d2e49c12a18562d096027c72ad2ebd6f786eaf4153f03321961cd8431`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:46:27 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:46:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:46:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:11a951f58d51ce15e6e3dc836a9915d917dcdc06f9d59770a44c3d6e14412f6f`  
		...
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11824923bf1d23ce863d4f682e7ee3676a506acbd0556592c4bd019a2bbdf341`  
		Last Modified: Wed, 01 Nov 2023 18:11:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:772e0398002ae4ff7e69aca9b13bdd74f142017c229cc058802ba316e48ca56d`  
		Last Modified: Wed, 01 Nov 2023 18:11:17 GMT  
		Size: 22.9 MB (22878923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:741d6f123f7580c6b776c5d3d345c44cb9658f99043f819af6641d9f9de00e1a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.0 MB (193028552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6da0eed7739172e4d2c666907ed6ad9901760bd6f425b9498ea7c9cb4170fba4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Nov 2023 17:41:00 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:48:22 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:48:22 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:48:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:48:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:33083918b0ce7c3b2d7840db1459303be0b3883fd656ddc40a0f54615a1b1c50`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1630c702b629c5118a791daf1b4cadeb59a489cd191e22a8eddc31ab0c51b9f5`  
		Last Modified: Wed, 01 Nov 2023 18:07:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fabafe4b5da9afc7badfb685a0c68d059c61acac6bc7d2c8bc78c8dc04330930`  
		Last Modified: Wed, 01 Nov 2023 18:07:36 GMT  
		Size: 22.9 MB (22880613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-fpm` - linux; 386

```console
$ docker pull drupal@sha256:b01e7f465a876192566a1aa72ea3c042adc74739a0e88b88cd1146c60291d6a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.8 MB (197763398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9f250151be0b8391bc6e1435bee7f89b9a1a3c9103de34c5b9a6855a318e3a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Nov 2023 14:28:56 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 14:36:20 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 14:36:20 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 14:36:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 14:36:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b4c15a636f3ad2b14bf83bba9c0d836c38937e226a32926f2262ebea5f994c2a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1577f51a63b45d0724814f69cd5e4c4a32a81de42c3d00250ec1be36bc3ad0e6`  
		Last Modified: Wed, 01 Nov 2023 15:00:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed5bbfccfca957bbb878b45b7320f63c6da68a8f663ae49ee1a2c4cf870c03cf`  
		Last Modified: Wed, 01 Nov 2023 15:00:11 GMT  
		Size: 22.9 MB (22878684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:de580970c5ff4c6298a0af42507edb5ef65ca56e337d0626c85f60d159e93731
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.8 MB (202840515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea7d3da1fe4b47c86d8152c02b79423e06646bd7feab4ea2afaec3090e72e2f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 16:10:33 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 16:10:38 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 16:11:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 16:11:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:49a43646c412db8828ed31577b247ac18e28b40485874f19f1cc254542dc7b58`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f24a1b4ae0dd94398e9316f3add649c764415f439e072c086957e822df92573f`  
		Last Modified: Wed, 01 Nov 2023 18:24:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ccbb6f00a79433d26ca103533f184653fe504e3a38955a9dad5eb247067302a`  
		Last Modified: Wed, 01 Nov 2023 18:25:01 GMT  
...
```console
$ docker pull drupal@sha256:e85b5168a1ed7bf50c0e69875ab0c8ae3cbdd6753a231c0e1a9c5fa9db78721e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172334455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77ba7465a1e6cac2e83b516d5a869ae74b23b93cbf552e1233f9bf9a2f898986`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Nov 2023 13:37:21 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 13:44:45 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 13:44:45 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 13:44:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 13:45:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5e139309bfb0013eebdd3fb5f07e013db764032e7d9696c8c5a3bd8ae66edd9c`  
		...
		Size: 705.0 KB (705005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56e201f1cfc3128bf315620ae4dcfeb7d25e1e11d672bdc820abfc0ff198c848`  
		Last Modified: Wed, 01 Nov 2023 14:00:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65d466be9a44e5ddffd28759a0ea4ba5a45c18b2b16ef9f639cfb8d372a39b13`  
		Last Modified: Wed, 01 Nov 2023 14:00:30 GMT  
		Size: 22.9 MB (22878835 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
