...
```console
$ docker pull drupal@sha256:afebcee9d0275590d1b2f4a1398c939c8b8df8b194a33debcfcfc177192181e1
```
...
```console
$ docker pull drupal@sha256:440c390115645a03e4fa11806e4358eda0ecfe94a5f1ba329e53b7b875c36c8b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163355676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:889dfd66e289a7b931d043ee6c2f6f5834f02471963e3f08a3fb9888a45f3500`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 05:01:35 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 05:01:35 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 05:01:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 05:01:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9185aaf15825ed9422320daf714abdd0654ca6e0c450eeb8f9a7297b1218ef4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57e41caad7dd2775d7288dc35ea859d4b80b269b48121e41fa8d4627c7abc760`  
		Last Modified: Thu, 12 Oct 2023 05:28:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f642f1635d30492c13edd259df30dc8589a264a70c7c784651ef840920e62cc`  
		Last Modified: Thu, 12 Oct 2023 05:28:41 GMT  
		Size: 22.9 MB (22879493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:94311d00ca3070955f59224c90ac7aa90be14ef82ede327bebb921ad69c6b497
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.7 MB (202742895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f55f7cd6b0981071690082de13a8e70b31e3360e9adb925e0350d3637e9c2fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:29:40 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 21:29:41 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:30:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:30:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f18903018279a78215696a1264f2e6601a4e97804516f08c43458e863d9d213d`  
		...
		Size: 705.0 KB (705009 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1ffe6ad653bdc6ecb1995171c03aef72569f3569cbe2ef23d6078b96cd4230b`  
		Last Modified: Thu, 12 Oct 2023 21:58:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bd3aa964e335b220aeea1e69193fb3104ab635567a8d3d8439245d006f2acd7`  
		Last Modified: Thu, 12 Oct 2023 21:59:21 GMT  
...
```console
$ docker pull drupal@sha256:a032f4d224449b851f7830cce100d2342cd03dfb3bf0563582e13edf98a9ca66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.2 MB (172235608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0c9323b0927d794384eea53a23c4f6c9af904cdf35cafd1b186850ca1d96a7a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 Oct 2023 03:09:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:09:50 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 13 Oct 2023 03:22:08 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 13 Oct 2023 03:22:08 GMT
WORKDIR /opt/drupal
# Fri, 13 Oct 2023 03:22:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Oct 2023 03:23:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a5c6b73b6d9c39f63ae93d24bdb417012c8500c4efb038d2669cfd7a81a576d8`  
		...
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaa886a0c7d8405d178561daf0ea432ff5abda78a23fdcab68f525eda36ef463`  
		Last Modified: Fri, 13 Oct 2023 03:36:01 GMT  
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80936aa54173ad37c9a50d5d495fa48cb270ad22db7629403681cbbefc881f02`  
		Last Modified: Fri, 13 Oct 2023 03:40:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b6de72d3536b7335299f1d4cfe52840da62f2fa230ddf6bd52da36f7763a246`  
		Last Modified: Fri, 13 Oct 2023 03:40:43 GMT  
		Size: 22.9 MB (22879006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
