...
```console
$ docker pull drupal@sha256:3d8d202978f4d383692150cd4bf34f0792dd76d0c6e0f45df9047f7e89707492
```
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; 386
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.7-php8.3-fpm-alpine3.21` - linux; s390x
