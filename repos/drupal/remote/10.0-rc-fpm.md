...
```console
$ docker pull drupal@sha256:f28390bda82fe0007c63eba3b9edbc7a2e5958a27d1a5ebdccdf8c04285faccb
```
...
```console
$ docker pull drupal@sha256:e489d4fa547c82871482ec4514c6ba1af9117b1dddf19387ba18d204b1e28f81
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176132935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d98681501b157e24395aadef0ed3fe9f8e95abfb4104acfdfe329033a05989d8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 18:07:20 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 06 Dec 2022 18:07:21 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 18:07:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 18:07:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c6c813c8aea0d43eda810ba62213ea2dbd1fcd1e6b0b59093319eff58824b3e`  
		...
		Size: 695.2 KB (695196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:410a789561dc4c4288ad76e6bcab2214bfd50a743ae4b01767be7688525140b4`  
		Last Modified: Tue, 06 Dec 2022 18:24:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f44e557b09a59e31781db90a9ae5e3664332369da0ef321def5dc04d05f31f4`  
		Last Modified: Tue, 06 Dec 2022 18:24:46 GMT  
		Size: 17.7 MB (17669004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-fpm` - linux; 386

```console
$ docker pull drupal@sha256:19afb88b87155e7b8b8122bda4fba16e9ea7e09bd7b021dfe9217ca9726727fb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.6 MB (183641568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfecdf0e4d91e990e95167ffcc33a52af6048719cbdddb9f8f1177bad124fd0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 17:09:11 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 06 Dec 2022 17:09:12 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 17:09:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:32519337204ec8b6f80900dd62e87b6b8c3cb505686f73c5558636f80d00bf7d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eb566ddfbfcdde0a088bba791d8b200cd3a4b323f3caa42bc2b11dd7192cd3e`  
		Last Modified: Tue, 06 Dec 2022 17:32:50 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9781dc42b106ab363d1880431623c766c5d570a1305c116372f09e80320cac10`  
		Last Modified: Tue, 06 Dec 2022 17:32:54 GMT  
		Size: 17.7 MB (17670611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
