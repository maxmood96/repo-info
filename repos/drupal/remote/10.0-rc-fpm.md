...
```console
$ docker pull drupal@sha256:afb925c7ab280dea21e57e73f53fa5ae6e15ddf82a6ffcee6dd7e60ce561cfa9
```
...
```console
$ docker pull drupal@sha256:d8d13311179b7f572e3ea8e1a50b7f4c5b0af378ddabbeda10a3b9c3f5854390
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.3 MB (153311008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a9c71c8632cfb94ac70f89f5437bd53782b279e0a2e90853f69cdc8ee622de1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Jul 2022 03:08:53 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Sat, 30 Jul 2022 03:08:54 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Sat, 30 Jul 2022 03:08:54 GMT
WORKDIR /opt/drupal
# Sat, 30 Jul 2022 03:09:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Jul 2022 03:09:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:db9eb259135efb6930b703bfd7ef78ebf6aab713ed4bb096f4d70efca07bbed5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13fcec86c9bd12025ee46f2e34077efcfef1cdf27a5eb1cc69f9cf5dec50ac95`  
		Last Modified: Sat, 30 Jul 2022 03:54:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfeb569a72678969bac9ba4924418df345862dee4d7e891e9cbb0abb2ccdb60c`  
		Last Modified: Sat, 30 Jul 2022 03:54:32 GMT  
		Size: 19.2 MB (19248000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7c466eaf845bcbc58f427028c426b42c3ed7300f441711aa1ee6d869a8903518
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185286643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65237bf1f784414ab89a50bebcfb7526e66bbd497c6556b2ce4b443ac7804189`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Aug 2022 18:15:54 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Tue, 02 Aug 2022 18:15:55 GMT
WORKDIR /opt/drupal
# Tue, 02 Aug 2022 18:16:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Aug 2022 18:16:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:03773cc91093ed3e27bf4699f812bf9c79603668a775e6b946fb43a90d8075d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f0aeaba2f8fd6cc4196701ef862b358cbf054537aa7cb5ae58272b642cacab6`  
		Last Modified: Tue, 02 Aug 2022 18:49:51 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d67dc9443039a04eec91d5c3f4a05c2ef58af2a389b80e68b750b0d2f79b061`  
		Last Modified: Tue, 02 Aug 2022 18:49:55 GMT  
		Size: 19.2 MB (19248605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
