...
```console
$ docker pull drupal@sha256:f1fa3a4d81516a067e0bd48e9d5d69da40b7021030e621fd363b7178f1c52559
```
...
```console
$ docker pull drupal@sha256:960eba8c2f0244196ad040f99cfa71ef05b7c1af439f23a7a03ce944d4259498
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.3 MB (193254693 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28db78f73ea468ee648b224b1f4a098b8bc922067500d6bda96b5b298f794535`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 02:55:06 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 02:55:07 GMT
ENV DRUPAL_VERSION=10.1.2
# Sat, 05 Aug 2023 02:55:07 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 02:55:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:fb65352df331e5ad937a926a38d158f2a8395717ac3f27f3e9b5853d03af81e9`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43df0e8a6553c119cab92980600528ea7837161d29d73807afc228a2c8c6645d`  
		Last Modified: Sat, 05 Aug 2023 03:09:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:791a39046736d3e5c2a9f865a781de9414f33ca066be4b33661c9c1ec1d349a1`  
		Last Modified: Sat, 05 Aug 2023 03:09:52 GMT  
		Size: 18.5 MB (18511515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
