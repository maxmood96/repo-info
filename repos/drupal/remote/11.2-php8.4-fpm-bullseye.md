...
```console
$ docker pull drupal@sha256:54d57a2a044143f248c7f644c373f31ae5ee67abac3ec96ea9213e37eaffa74a
```
...
### `drupal:11.2-php8.4-fpm-bullseye` - linux; amd64
...
### `drupal:11.2-php8.4-fpm-bullseye` - unknown; unknown
...
### `drupal:11.2-php8.4-fpm-bullseye` - linux; arm variant v7
...
### `drupal:11.2-php8.4-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:11.2-php8.4-fpm-bullseye` - linux; 386
