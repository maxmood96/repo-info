...
```console
$ docker pull drupal@sha256:ccace4a435027ff6dcb6e6d3c81536e45519045e0c9bdfae3633eaea33eba5d6
```
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.1-php8.4-fpm-alpine3.22` - linux; s390x
