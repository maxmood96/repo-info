...
```console
$ docker pull drupal@sha256:7e057c5b8d33f42b81bc966ce8dfab321c2bb9eed5e8dcdbf5c60541ab45d69e
```
...
### `drupal:9.5.8-php8.1-fpm` - linux; amd64
...
### `drupal:9.5.8-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.5.8-php8.1-fpm` - linux; 386
...
### `drupal:9.5.8-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.5.8-php8.1-fpm` - linux; s390x
