...
```console
$ docker pull drupal@sha256:fbf691950d7d89fe1fa211884b17b2e88b384c6b215e6636d7a8350d29990751
```
...
```console
$ docker pull drupal@sha256:bff38672769998e9bc5989aefc6908d7f2265157977d3256e71574464aaef391
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.2 MB (148210941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afe3ff0d207d8b57bf25dc7428a486b84543a7d977d93e1bb77f35c8afdcab85`
...
-	Layers:
	...
	-	`sha256:8ad888f64f71be9492d34cd0f56d7ddce0e8da8afb7cae3be58ed5cf59324b52`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e5f0c8e75e0eee694341003948605b89ccbc4e591bdc9a9ba2b5567fcc19456`  
		Last Modified: Fri, 03 Dec 2021 18:12:23 GMT  
...
```console
$ docker pull drupal@sha256:b7516bd02e13ea297b274ee196ca901812d06eaff02327afb2edac00850ee0b9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.0 MB (124008136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a7e1e5ac766216670c5d907b3d17e29e4ce926d9d8f2113b58b2d41cb94cebf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Dec 2021 05:28:48 GMT
ENV DRUPAL_VERSION=7.83
# Sat, 04 Dec 2021 05:28:48 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
# Sat, 04 Dec 2021 05:28:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d5fd30c03c2fee4211392b827c81b5e5e5593c4aa4fba70214f889db99c3dfd6`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acb802654d293e6e932434c1b2504e27ca8a172ca9055582ba0e99624c641c85`  
		Last Modified: Sat, 04 Dec 2021 06:10:33 GMT  
...
```console
$ docker pull drupal@sha256:701867f7faecb794d944d96aee723ef4732933d2d89994976993b6b41403fad8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.9 MB (130931351 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dcbf63fb6894d9b6166c862a7d6b4d6a854d09aca489b694de3a2a88be5109a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:8d356aeff8ad1aed2b1c9fcd2f95b371b3ac61a1e87522790ecf7600c9568ed0`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1a574e350244da09568ade774d0d4315484c298d303d8a0701c6f8303ba9936`  
		Last Modified: Sat, 04 Dec 2021 01:07:39 GMT  
		Size: 3.4 MB (3380054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
