## `drupal:10.4.2-php8.3-apache-bullseye`

```console
$ docker pull drupal@sha256:e878a1e9228b9d047650cbd317905c619865455e46bd82516a17b560c5fdd211
```
...
### `drupal:10.4.2-php8.3-apache-bullseye` - linux; amd64
...
### `drupal:10.4.2-php8.3-apache-bullseye` - unknown; unknown
...
### `drupal:10.4.2-php8.3-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.4.2-php8.3-apache-bullseye` - linux; 386
