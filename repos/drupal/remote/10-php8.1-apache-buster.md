...
```console
$ docker pull drupal@sha256:f1598a20440446c6300e6f18fe41104218d5f20c5ccd1a6470c85a95f9eaafae
```
...
```console
$ docker pull drupal@sha256:2ce45f911d30a1a0cfbd25463820f4efcd579306f016f18655b088f70fe009ae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141266201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06e33d212168340bf7407a4ec65c7b9a96213943d92363f68449c285b148cba7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:12:57 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 23:28:25 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 23:28:25 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 23:28:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 23:28:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89b625fac27d3ba24f1c2ae6863dc3905dcefa3e20af20ecad4cb6507413a595`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6ec8c664cf2f94125461acb8dc2ba79ddf3b4a8be174b82419f6fa85f39c45d`  
		Last Modified: Thu, 20 Apr 2023 23:46:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4aaf74d89d24e9783bf909c9fa462c1038cda8356e8aaa5eaae03f2d92a5872`  
		Last Modified: Thu, 20 Apr 2023 23:46:47 GMT  
		Size: 17.7 MB (17673421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a74b5dd86b1d26c9300f82676f6d8b6923b41a8ba46047452955a12431d311d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158818787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3aa37c1330c3c53fc4a104054f9395fce14758616400a595ef427d8a3f72441`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:20:34 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:39:26 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:39:26 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:39:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:39:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:45794d899717d28bb59fdea67b5984499170c394d7bed1a58006640627eab3e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d904f22b1a0b2c4e1c1b5498bf30e6d6fa8e3d46759ba53659466fcb4540af15`  
		Last Modified: Thu, 20 Apr 2023 22:55:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4a11264103268f6050366d069cfdc22693d6b1f4c39740eb859147e2ba84d97`  
		Last Modified: Thu, 20 Apr 2023 22:55:06 GMT  
		Size: 17.7 MB (17672863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:27d4c0a34e939cfe8a08f5be3e2cbd60f898ba01bbc10d8ff8fa2a1e4312de86
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.1 MB (172058109 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f59683414c0efc4d044329ea41ec09dde924fadf9dfb68dae15520fbba6f5dda`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 22:15:09 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:40:28 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:40:28 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:40:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:40:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:70c3402cd8e227ce9f9ad1f3d3c4a27c05bdd4b22fee369ba81af8c1de22bfc7`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc5f9f2b3742d9419046a5908955699eff7ef1d7c5d8d4e771c854cac498bcc8`  
		Last Modified: Thu, 20 Apr 2023 22:55:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eeb7d4cd9408ee2e7ab02294b04870945b251ca9bf815eea231b176f4b1abad1`  
		Last Modified: Thu, 20 Apr 2023 22:55:53 GMT  
		Size: 17.7 MB (17672889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
