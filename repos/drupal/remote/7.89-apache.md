...
```console
$ docker pull drupal@sha256:9a54297befd2d13dcb75e5bc67350accda223e58dbfd757a942baca1aa60041d
```
...
### `drupal:7.89-apache` - linux; amd64
...
### `drupal:7.89-apache` - linux; arm variant v5
...
### `drupal:7.89-apache` - linux; arm variant v7
...
### `drupal:7.89-apache` - linux; arm64 variant v8
...
### `drupal:7.89-apache` - linux; ppc64le
...
### `drupal:7.89-apache` - linux; s390x
