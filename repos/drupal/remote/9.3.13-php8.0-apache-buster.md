...
### `drupal:9.3.13-php8.0-apache-buster` - linux; amd64
...
### `drupal:9.3.13-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.3.13-php8.0-apache-buster` - linux; 386
...
### `drupal:9.3.13-php8.0-apache-buster` - linux; s390x
