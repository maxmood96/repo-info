...
```console
$ docker pull drupal@sha256:9ec7dad404f2fe06c49381a7db03223c481f8ad72b924b7f28892e947354e99f
```
...
### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; amd64

```console
$ docker pull drupal@sha256:f30427e3b83421258895d66d53edaacb5e84be8bdb14adc334561d637db10d09
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (185039244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed963f4b152ff8ea89d05f2e01d8f8ff5432514f97570a29c88e4db7a33c31d2`
...
# Wed, 12 Apr 2023 11:42:36 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 11:42:36 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 11:42:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 11:42:46 GMT
...
-	Layers:
	...
	-	`sha256:16613c342e82732065468078b8327ae99cef7c8b11d777bd19b2e072f90e0864`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aac4b44f81e927e30cabed1ead39a0670eaded3ba88ec5eddac38f4e1896bfc6`  
		Last Modified: Wed, 12 Apr 2023 11:55:33 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:693182e3dbd09ab424b3815e37d318d0aaf363201a998c611f4effe3987858f9`  
		Last Modified: Wed, 12 Apr 2023 11:55:38 GMT  
		Size: 21.9 MB (21916989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:2c2dee3790cb38b2bc148d800a79946b34bc639424d8ba52f9f6a62daddd8c43
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155042788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eaa5b88312933d5994aa1a9d5059bc47ad21a02e3f76e4d0af51f2cb8c792e3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 10:54:14 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 10:54:14 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 10:54:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 10:54:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c88fbe035e53ff7a68c1847e1123be2fba659d64eaa899378655b1318fefcf34`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03346f4aef4f889f76fb6876f3f638487aebdaaf1145e839e487d158eba58564`  
		Last Modified: Wed, 12 Apr 2023 11:08:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:550b27e9b478bccd9a2d9f98cc16483b0259629c26dfcb809b22ad1c90c68799`  
		Last Modified: Wed, 12 Apr 2023 11:08:21 GMT  
		Size: 21.9 MB (21916999 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:4692f5add7394e800c79b5a692d9fe7a6af03a09180d18079d058a1ac95492dc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.0 MB (178046324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:486fc31e5ed9ad8ae0575f689e59009a2ca9aa00f23f2ee9e6710787d32a4b7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 17:38:47 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 17:43:17 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 17:43:17 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:43:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:43:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab0ba14d46b47af291c724e338dfb115e4c2e95e07bdc177c7ce9757970c131d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:361a26d7a830599547169f35fff2f1c3027092d374aeb6ed1289acfec81eda27`  
		Last Modified: Wed, 12 Apr 2023 17:56:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15588a33cd2bb9d4224461bbc56fbdf76b3c78068180a92f71446024f317021b`  
		Last Modified: Wed, 12 Apr 2023 17:56:18 GMT  
		Size: 21.9 MB (21917029 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:0f0af712c93ce33c4cb30c744943033c885ce33ee56e01463439fcfde7a1fbf5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187621615 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2eadcde48fd3b27e88a8a400a2280a88c7e28cc6cea7f77ba1d6a1a5de2c85a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:29:25 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 23:29:25 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:29:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:29:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d41233b0a9da8cb9ae79c93993915b5ddb43fa66bb3f64bbfd8e674b182d5383`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e6bf734fcc6059a19a5b9c1cac1750665b637814bacdf669ac5b43c183e0c65`  
		Last Modified: Wed, 12 Apr 2023 23:43:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16873332c1a974b56dfb3b81fd8b47fef872181927ecfeeedaac68a5a8c9f2a4`  
		Last Modified: Wed, 12 Apr 2023 23:43:41 GMT  
		Size: 21.9 MB (21917049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:a44db4e6d106c4da35a307ec0291294a82bcd6d960d4b38d2b9b20a246b8d3af
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.8 MB (184808128 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44ba0c84219fc90667db4bcba33f945cc75adfd394dd7491a3f5b218f567f0ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 12:12:26 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:12:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 12:13:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:41a8caec662e280f641859d8367dca1046da25c3e40d1c209c0e9a81b4b23a08`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5aa78ba25250dca8912c7283b026164ac96ab4d1fd7074d38df4856d8d22bb2e`  
		Last Modified: Wed, 12 Apr 2023 12:24:52 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99a7722073f138c52e7e2c2e4d9b2c0575490ac3c80e97c77c0d675fd7e17194`  
		Last Modified: Wed, 12 Apr 2023 12:25:02 GMT  
		Size: 21.9 MB (21916927 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:a6952192547ee7102a2d1dddaed72bc5c9d4bdd81f9bd7d520dfb343fbe21b8c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (161951686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360f85e7ec5b2fe3b1f017ee82bba64a9f6b827b81bd746e5a82c48e8adc624b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 11:59:49 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 12:02:00 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 12:02:00 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:02:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 12:02:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bb0d8e9f5b557b8cc1c6cdc0856ccba5e414d7ac8db4c5fa3beff78ea13c1278`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d5d978495169423ad949c153b2db78abfa0ca5315197fda30a9a8b36303c85f`  
		Last Modified: Wed, 12 Apr 2023 12:08:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a8a1bbf158faa7ec33ac14b7a8a0171a4a0af10f062d0dd6b85e6006179a26a`  
		Last Modified: Wed, 12 Apr 2023 12:08:50 GMT  
		Size: 21.9 MB (21917020 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
