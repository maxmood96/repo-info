...
```console
$ docker pull drupal@sha256:cb0c2d6e68a4b9d960a7b9cc285746da81ec8a7798c616a9f1f3f39b195430c7
```
...
```console
$ docker pull drupal@sha256:0fbdb041b7331e658799abc65aca6a41f8c0d366d686cb160e1be708fddd710a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (185030557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:869fa632dc4fab8720f7d815d13edfd4c038d3d6a06c055a807a1c6bf2ec7879`
...
# Sat, 25 Mar 2023 00:27:20 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 00:27:20 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 00:27:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 00:27:31 GMT
...
-	Layers:
	...
	-	`sha256:fcc8a0ee4cdaf61754f848fa5d9651fe0db9d3b009a2689c08fa56b7761c6d03`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de00e430563a922dac2a45b81c02ff4a22164dceec2827ed8670f5abea2b8f05`  
		Last Modified: Sat, 25 Mar 2023 00:44:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:751d492e3ae01a1bcea2d3a736abf0b7c55fa47148668bf2c913001c1703afc0`  
		Last Modified: Sat, 25 Mar 2023 00:44:34 GMT  
...
```console
$ docker pull drupal@sha256:8298f8b9f835f23252a4832a9c7c1ecc31091e9e58d44c37565d2d0e4462786d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155038586 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85dee241a45c11b4d059b03dc1d15698f72cf1328a864faa69f7d2d818127ecf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Mar 2023 17:41:14 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 06:15:54 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 06:15:54 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 06:16:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 06:16:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:375f85e7116083fb6c8d2b96b4cbf43c0d434f0dba8f2cdcc8d728422962e3dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcd8fb4da195ec752dd496fb030c077e370c8ea228612b2fab714e960637a0ef`  
		Last Modified: Sat, 25 Mar 2023 07:16:15 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8385f46f553b977902aefc65ca92aaf45ea3cd61de7aa24845497afedfd25a0`  
		Last Modified: Sat, 25 Mar 2023 07:16:26 GMT  
		Size: 21.9 MB (21915818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:db29e726c07887d591e0dcecaa165f52c9dbfb1898c2cba6687aa3ae7291141d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.0 MB (178043227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2abbf46ccb4931fb5a0a0f49211eab9336b7d71779a072be53cac50db648989b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Mar 2023 19:54:14 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 00:48:18 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 00:48:18 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 00:48:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 00:48:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e4603345b67ab2733bb0a15aa8e2c0cdab78eb470272e61ca0ca926d03fad816`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:709c96eb444935303380b76ea1511b4df2512f6198357bfa96965223030d23f8`  
		Last Modified: Sat, 25 Mar 2023 01:09:14 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3b27d52910381cae32bc34aae6e1ebdfdb372e29f861d2e25c1e28d89c999ba`  
		Last Modified: Sat, 25 Mar 2023 01:09:18 GMT  
		Size: 21.9 MB (21915746 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:c77da4d211118a9a04c66ddfb1762db9433b89b17459ec3f6e79f9f73d8420a6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187617315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efecb4e5270d6b3b8b35fceb95bdf2d4a6a676be4366e25554ce76ec42661eb3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:23:38 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 00:46:45 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 00:46:45 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 00:46:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 00:46:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:71a95ba68eae76ad8c22e5de71249e67b689a87c3be5a65d169272470afa0042`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6a3c5d59efad3b90e59a7e7e9b38c0e8696102f73bf9cd7bb2f33f92943618b`  
		Last Modified: Sat, 25 Mar 2023 01:06:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:632e95e43898094f16432bd9580cc1a40e295651928ef472fd033b32756cd519`  
		Last Modified: Sat, 25 Mar 2023 01:06:14 GMT  
		Size: 21.9 MB (21915810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:f42f6694efc76a6b61b389dfbd480725a72ac03ef6ede0b46c3e48eefbefebdb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.8 MB (184801858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:490a3dabcbfedd2b57e04a11cc0b97db869bdefba1f6bfb03f34e1674d89a119`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Mar 2023 19:17:14 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 00:27:53 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 00:27:53 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 00:28:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 00:28:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a449695e58a12c415a42a118634df51e5fb362ee9c9dab391a13a8ebb5715f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2970fa435c2ddcec14818542ba9490da1f13434dc83cdb9435eae5b0117f269`  
		Last Modified: Sat, 25 Mar 2023 00:49:16 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e884c265651f23748552f8a8d69594662f0642ba2e4f0ac13f44534c0790b6c0`  
		Last Modified: Sat, 25 Mar 2023 00:49:38 GMT  
		Size: 21.9 MB (21915834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.0-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:f03a6e0a1878123df759414f618996cd8f2e67af5b5a9578b036256898880045
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161943672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1599154ee5cbb221bdc7252b293cf09e26cf075b266cef7208be643c5dcd2e49`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Mar 2023 16:17:27 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 13:45:06 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 13:45:06 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 13:45:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 13:45:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a04baac6bc8ccc22639f32a6e90b2f068ef346d1a3badcc55eb829cfdc3ccd9d`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e71e4505519b8112c13770489594096f784a07804892e49640d4a4d98a1e3d62`  
		Last Modified: Sat, 25 Mar 2023 13:53:28 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ff7e145bed15ec54aba2177013cdd74ddb9d5800fc642e263c558e8fd421b20`  
		Last Modified: Sat, 25 Mar 2023 13:53:32 GMT  
		Size: 21.9 MB (21916070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
