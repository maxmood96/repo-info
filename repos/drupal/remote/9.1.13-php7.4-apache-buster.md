...
```console
$ docker pull drupal@sha256:06b70214d1f1b112e656b69e3b2656699ee3c672fe53b341f79d7a4ca5f051aa
```
...
```console
$ docker pull drupal@sha256:a65d9ec4b3c57db0a8c76daf25a9bc458b802e78767fba9d91838bd9098db916
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.7 MB (168700951 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d25a488666f1e6693634f5fdd109f6d7113efcf90ef7bee6e944d2db8d163ef4`
...
# Fri, 17 Sep 2021 18:25:58 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:25:59 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:26:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:26:10 GMT
...
-	Layers:
	...
	-	`sha256:c1aa32e14b5376d36992f87f63b9bf23585c7733f753c05b70b84c29f4241535`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1750da00811ff13058192092a1071de444d01b3bb2e980ade8388cc639964db1`  
		Last Modified: Fri, 17 Sep 2021 18:40:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48a0b6cce9cc4eedf0435b7e9506daa7034b841749638eb14d5f3f388b1fb880`  
		Last Modified: Fri, 17 Sep 2021 18:40:10 GMT  
...
```console
$ docker pull drupal@sha256:b038f8a4612a5a211684fe3df035793c02823ea68ad0b1394fe89a3e2953298f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.7 MB (160742539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae05ef5e01154366fa2cade5f9c1910990ccd8ae0fab786c73d29e635b7bee88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:47:42 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:47:42 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:47:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:47:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a1c6fc50243060ae8ea262d40b26aec9b33547da00a42c776e955c67134c195`  
		...
		Size: 555.2 KB (555165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a24e6ce43a5155bad6522b803768cbb248f0c8fc6f5554314d5163fce59a30a`  
		Last Modified: Fri, 17 Sep 2021 19:08:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfd46a3424e133d58f0dfdc573aff13c8f9b1396c2d7d27e5b21aaaddd8f3dd7`  
		Last Modified: Fri, 17 Sep 2021 19:08:06 GMT  
		Size: 18.9 MB (18878895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:7311f14777b4f289c8be7053fc7f46f1dc5a9483a79fb64458d1fa3685357144
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.8 MB (174823921 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17dea5302f01847e9ce5de8fb02c8717db78612b9995f7e13c5cba96736de15f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Sep 2021 18:44:35 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:44:36 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:44:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:44:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f6a8185fe35aa848570a6121eee3ce9a041ebd12b35a22e3fdc88525abee5c64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02a1e07d5b1894fd1e23438fa76234225df6f9143aee78475a533a1a143a7126`  
		Last Modified: Fri, 17 Sep 2021 19:06:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74e66a451bbb63579660262ea68c1f290831b11eb9634444965464c7591b4eb3`  
		Last Modified: Fri, 17 Sep 2021 19:07:05 GMT  
		Size: 18.9 MB (18878581 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:4a279b1416cd881703c9201f45092f16a65d0edc262dd545ac4acaa7bd7518b7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154348561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a41f628dc90b393ab09a90e71fe5b31cf6aa31100563f24de52b148ac0d0972`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:47:50 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:47:50 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:48:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:48:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95a15150ed86769815155c20364f76406a577d98626a177ab03761f57bc204de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abadd9bfde4aef72933e5ba1f3523d43796e40ed62f120461da7747b40bce183`  
		Last Modified: Fri, 17 Sep 2021 19:03:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1b3849d5477daace739fab346088bd7ca1a4515e23d0b40f42d6989ee90e1fd`  
		Last Modified: Fri, 17 Sep 2021 19:03:29 GMT  
		Size: 18.9 MB (18878776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
