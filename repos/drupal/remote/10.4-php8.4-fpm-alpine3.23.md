...
```console
$ docker pull drupal@sha256:fd66be70185cc6f8b7d735d08051888d94cee26366ea9c07148985a0e617828e
```
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; riscv64

```console
$ docker pull drupal@sha256:0b766d0e4d5fcc4d65a60506a1784701612b7d31b867b2bcedeffd81f495ff3e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.3 MB (59302608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50667904ab4a9d8da466a1eb22b1eab9432a7cf3c5efea4477ffcf8cea5de83b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3fed8e664c87d218e1a3f5bb6c2b5e253037c9bcbc461a321f591b9d2390f424`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c0ceaf9cb69d0830fde8ebe7828923e4c4df87d498cb30cdaa6a3108947a43c4`  
		Last Modified: Fri, 05 Dec 2025 11:13:06 GMT  
		Size: 21.6 MB (21595716 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.4-php8.4-fpm-alpine3.23` - unknown; unknown

```console
$ docker pull drupal@sha256:236a77ac8f68e87580eb599bd81e46b6a17aa763ae3fb07b97a65327c5733e04
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **402.3 KB (402281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19bb8016cc50f4b80afe23cd775b0cb164ac9a1dab06f4f8c988ee7abe14375b`

```dockerfile
```

-	Layers:
	-	`sha256:1e5dd07968f8060e9150a6c37a83b1855c07e77fde39f43bcfebe17f5f228fdc`  
		Last Modified: Fri, 05 Dec 2025 14:55:24 GMT  
		Size: 369.0 KB (369007 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4db38f47e3b56ac9b80d57dbd346468e96130ae7fbf890a42fb808f1780c69ff`  
		Last Modified: Fri, 05 Dec 2025 14:55:25 GMT  
		Size: 33.3 KB (33274 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.4-php8.4-fpm-alpine3.23` - linux; s390x
