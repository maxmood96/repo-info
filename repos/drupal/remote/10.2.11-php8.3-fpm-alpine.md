...
### `drupal:10.2.11-php8.3-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.2.11-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.2.11-php8.3-fpm-alpine` - linux; riscv64
...
### `drupal:10.2.11-php8.3-fpm-alpine` - linux; s390x
