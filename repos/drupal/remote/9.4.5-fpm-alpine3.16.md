...
```console
$ docker pull drupal@sha256:1f7420dcec6e825f45b193ed26a434e9189f1d50a20234da529135251591f3f8
```
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:0083f48525a75ae8968370a83286fe655ac84d660ed1f07ba821605edbb2ff45
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51337227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44ba0d73ba346a262328e87f1a4b867a38936f90878e13b228d76743c121a9cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 17 Aug 2022 23:05:44 GMT
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:05:44 GMT
ENV DRUPAL_VERSION=9.4.5
# Wed, 17 Aug 2022 23:05:45 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:06:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:06:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b500f48648c70b06b4900a2a352a073ca900c10eb558dd0996ea0428b36a97fe`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ae9ad708eafbc25a0f2ec04a84d8c4dce9a786d292fd0bb144c4750c7ac5829`  
		Last Modified: Wed, 17 Aug 2022 23:41:48 GMT  
		Size: 691.9 KB (691870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:658c6feb75cd5af616b55d18d9c3cd2ecc5fce9099d3a57b8986eccb8908ea56`  
		Last Modified: Wed, 17 Aug 2022 23:41:48 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa2ff8adbb37c0939b7d27e367adef428831e2f72843ce61dd6e17eb9bea272b`  
		Last Modified: Wed, 17 Aug 2022 23:41:54 GMT  
		Size: 21.9 MB (21866943 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.5-fpm-alpine3.16` - linux; s390x
