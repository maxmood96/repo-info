...
```console
$ docker pull drupal@sha256:a1fae4d1c8e813688dbc96c97f93d86f90a19d2228c584cd4d8bb11dae57bf2c
```
...
```console
$ docker pull drupal@sha256:72cee7f9af77a14967fc0a12bc53a3cfecc9bf735c8e148a8e247ec682f341f3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.3 MB (126329862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2c3a203bac2e236298006a69653685ae7e353acb906091407625c12a4517a32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:84115021d396549599fc3a238fac88ae55fa8bc63882195012b2407d6d71ee03`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a8c5b9e1743cdb59d1e1bc7d234ad518f76033e94ec33048c6a5b92006f1980`  
		Last Modified: Thu, 06 Aug 2020 23:53:30 GMT  
...
```console
$ docker pull drupal@sha256:0282b1615cf9e58aa1d0f0fd4c77baa69a3c067d7e9004fd6309e9d91a3d603f
```
...
-	Total Size: **123.8 MB (123789602 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8eea13decf2c7ac3951e7c0e2ac7119e62aca4daa95868bd2ec07be584d7f079`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Aug 2020 06:09:03 GMT
WORKDIR /var/www/html
# Fri, 07 Aug 2020 06:14:21 GMT
ENV DRUPAL_VERSION=7.72
# Fri, 07 Aug 2020 06:14:23 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Fri, 07 Aug 2020 06:14:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:357b3bb5608dfe8ed543acdfb3d6c8932644c9b348d33f38d92eefb7e2467369`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3a892e8f0a5d3b92e745e93b1fa2d4010b8ad6a546ed6ff89cc06a4470fa299`  
		Last Modified: Fri, 07 Aug 2020 06:18:07 GMT  
...
```console
$ docker pull drupal@sha256:abdca34a1647cc185c8cd334e53cfeec28850a085bc23732390c167f94b211b4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.7 MB (130699459 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a11ae9cb598cbb634e010adb7e79a072c84108f423e8c384fe5a06ef2761ce32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 22:08:24 GMT
WORKDIR /var/www/html
# Thu, 06 Aug 2020 22:10:14 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 06 Aug 2020 22:10:14 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 06 Aug 2020 22:10:18 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6a5e56f91f3efd83675e859984f5b2aae61bc40996bbcaaabb6c19e7125e02ea`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2dae2e2623bd1c7d00b9548d10cd4940f6985d674a38a9518c8a219c53d79a0`  
		Last Modified: Thu, 06 Aug 2020 22:13:58 GMT  
...
```console
$ docker pull drupal@sha256:d2e394197be8bc28549b62e14d9d7aa76d37ab4ec6af437ff09a4222ae2b159a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.7 MB (133710441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc86c0f4eb3d36caa946b07e60a02b0f5ebef1ac434748a477992bc4f5f71036`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 20:17:46 GMT
WORKDIR /var/www/html
# Thu, 06 Aug 2020 20:19:33 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 06 Aug 2020 20:19:33 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 06 Aug 2020 20:19:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:769926b29e5b640bc84321c1efa09b0bc65559407acc7f1c22345aecf5a58b17`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f19d37f882409069d4917259abe7a16f2e70eb2ec21ca2b8464e55f6d6b1dd02`  
		Last Modified: Thu, 06 Aug 2020 20:21:32 GMT  
		Size: 3.3 MB (3344257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
