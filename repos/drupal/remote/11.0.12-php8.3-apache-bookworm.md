...
```console
$ docker pull drupal@sha256:6275bd24098b31258d6cf1cf75fe1a8115d5e18e6d40d146f265509b88f9a9ba
```
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; amd64
...
### `drupal:11.0.12-php8.3-apache-bookworm` - unknown; unknown
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; 386
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; ppc64le
...
### `drupal:11.0.12-php8.3-apache-bookworm` - linux; s390x
