...
```console
$ docker pull drupal@sha256:3089c3eb9c6a96b1e15281aa1ce058ec65f227fcedf16d9b0d4bf1a810e4db9a
```
...
```console
$ docker pull drupal@sha256:dfdb3807e630115ee8fe31dd1afe1d938c90ea9a4eefa40233a07c0aae5a3fae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (50041401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864f4d30ecb7efb974037e292b2892a15cf6032002a8d874845801af14f963d6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3b2d4c2fe4e91cdef4023457b1624c3931b107ee42425fa3ed529959f8e6b651`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4aab8c93a734dd6dbacdef99b4342c47dc0905021d1e031fa27136979c95a625`  
		Last Modified: Wed, 09 Aug 2023 03:56:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:618eb72ab7d05f0be26be2beb3b494282ae87e34dcbf87cb03da19524dcaf4eb`  
		Last Modified: Wed, 09 Aug 2023 03:56:47 GMT  
		Size: 18.5 MB (18507037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:81fff522336b16cb0fea5577695d992ef4f90708a6c7e17ee598a014d95e1bb9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50631708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f971de3a5af73345810138d7052338ad382e67f7d52477ef849ec0c16aed492`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 09:10:07 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 09:10:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 09:10:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7aeee8ac36c2d5bef9c386c35645fcbe39d88620dbb6256005a63a4402b5bd3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f324e03cd07af8eea66fc1afb1bd5520391de2460715d5d7989b40746680afa`  
		Last Modified: Wed, 09 Aug 2023 09:26:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06dd88bc554880519458b1fa6f1541656f5ce7e6fcccbc2c0a83512d99534154`  
		Last Modified: Wed, 09 Aug 2023 09:26:54 GMT  
		Size: 18.5 MB (18506924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
