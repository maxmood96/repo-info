...
```console
$ docker pull drupal@sha256:5a76537804d9e12fa28b952ca24852b9e903c7f1b03457106a62aa7ec2a3e1f2
```
...
```console
$ docker pull drupal@sha256:234c7579002bda0b8f4a6202a084b493dfbfb34134cd82c6666836dc6757d94f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51101517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b66cbd950645c6d747c32a274ac0149c284a890b40515be22c06afb1217f3583`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 01:18:20 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 19:50:41 GMT
ENV DRUPAL_VERSION=9.3.13
# Thu, 12 May 2022 19:50:41 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 19:51:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:60807cd90ccbb3fb5fcb48b093a0d234d74fb35d2544f43ed206cf7800640a6b`  
		...
		Size: 661.6 KB (661582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e85f104e5823be5ed1da0fd8919357e01321df5f83fea3449b07037a13530490`  
		Last Modified: Thu, 12 May 2022 20:09:33 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfd03afb71ed9f8279f7b2698960a2704e9ecc862cce85322d47e06cde3dcd3b`  
		Last Modified: Thu, 12 May 2022 20:09:48 GMT  
		Size: 21.2 MB (21166828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
