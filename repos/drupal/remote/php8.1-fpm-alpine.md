...
```console
$ docker pull drupal@sha256:032dc41fcd74434770a8aae7899bf7315f5a6deaa63e46ba1b0b27ac1ea742c9
```
...
```console
$ docker pull drupal@sha256:95d8d90ab7e3bdac55cf9829f04cac5c79751e2e49d0b5d394f70cc80297c526
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52229761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcd1feffb442edf86da622e1bc9a0a93b3bcdb3395f2b1384e0e5d387052707e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 02:32:03 GMT
ENV DRUPAL_VERSION=10.1.1
# Tue, 11 Jul 2023 02:32:04 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 02:32:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:45a01bbb67816d57015c79f2c0d74563d016d2ffdc23904df83f5de7167c1f9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a253da0068b6a162d19c5f9cf515f597e79b05b8daaa0ef3eb6afdefa0e1d88b`  
		Last Modified: Tue, 11 Jul 2023 03:14:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7344b9a461c250432cb3ca44394dcf1cf9975435bcb6fc2409d6b1dacdfe726`  
		Last Modified: Tue, 11 Jul 2023 03:15:27 GMT  
		Size: 18.5 MB (18494838 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
