...
```console
$ docker pull drupal@sha256:31de1f41d6efd8ecc35e976253f2b02cb540885d2ae8a8184e22a23bd1252599
```
...
```console
$ docker pull drupal@sha256:b39ad0de47bbcc6bd9e9d5ccc1af66399c15bc8aed2f5f53945231c1f803d2c7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50651534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb1479f19916b9cd429b623627ed0c2bfc34ac22dc8c993e225d8403ac39d2bf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 21 Mar 2023 21:05:02 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 21:05:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 21:05:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bd0e3ad35cde50aa9c8d1b24f3ca62aae8c63e3a5a0deac106fac0a92cb8fa48`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c67d7e1c7ebabde70d70a2513a7f7dfeab25c6bb6e7e4e711cabe4f93a4ba145`  
		Last Modified: Tue, 21 Mar 2023 21:20:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05722e11ec9251237cf9a128d46144af05acc3b7e4d7e3b854968ab8c0703778`  
		Last Modified: Tue, 21 Mar 2023 21:20:24 GMT  
		Size: 17.7 MB (17651133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
