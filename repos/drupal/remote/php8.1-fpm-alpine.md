...
```console
$ docker pull drupal@sha256:d711cd8a4276a96101f7c73a533c20203e5273fa5b3e9e7cb4697a1672033b15
```
...
```console
$ docker pull drupal@sha256:b1fb5280f3bdf87871b91ea33cf1f12cc3510be3bfc237d0595fa82b3fcbfba8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48642032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f02be8022b7fda9962c2ebab12a0763ee4ac34cda1a29dd1d4702b5f29c765b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Tue, 10 Jan 2023 02:51:35 GMT
ENV DRUPAL_VERSION=10.0.1
# Tue, 10 Jan 2023 02:51:35 GMT
WORKDIR /opt/drupal
# Tue, 10 Jan 2023 02:52:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Jan 2023 02:52:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:16c4e2991a0385d397ada91e2922b466ad2c171a454b2128dbd4d20f18426684`  
		...
		Size: 700.1 KB (700096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd46bc9cf21c87bad5f60b510d5ec877adb659bb609550101a969deff5db97a`  
		Last Modified: Tue, 10 Jan 2023 03:05:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3169d8e25d0bf0ea862906f19aa45d55cbbf761dc72e0943568cc7628ca96c2c`  
		Last Modified: Tue, 10 Jan 2023 03:05:41 GMT  
		Size: 17.6 MB (17639021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
