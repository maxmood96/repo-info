...
```console
$ docker pull drupal@sha256:d987b010b55f5c40f23fb4b652362bbc01afa1f2854a76e01cfa1d9b24611b1b
```
...
```console
$ docker pull drupal@sha256:e6915cb54c8f70b097deab17e7faed45abcd96d02c38362d7230ec90ebebe119
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (52048845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:122c76a9eec75cab9de125bcbaa9193546c06bfcab6252170f7a343bd734dbf0`
...
-	Layers:
	...
	-	`sha256:25f9a20fb65416deb2a7e8603ccb5d04ba7b96089858f77afcc007f0aaa0b904`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23807c7150d81f8348d256cbdb4cd69b25cf4dcba3b2ad0fd44aa13fe47fba30`  
		Last Modified: Sat, 02 Sep 2023 09:44:25 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3bcf4399e360e8e33c9fc088a41b34b083c8176071802e7cc6efc28b57fe7ef`  
		Last Modified: Sat, 02 Sep 2023 09:44:29 GMT  
...
```console
$ docker pull drupal@sha256:55d7c909e1049aedb7024b23e95b454630b0c30722d48c36eeaebdcb02380f3c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52350997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbafed627abf5da6ad7ec22cbf7bdc5a11e6663185b09f9c1500bf72b540abe2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 08:23:17 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:23:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:23:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2ef3892497dcbfb50b05aaecd93ac90ee64cc50ed8fb6986761814bd2fa384e9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff74ef474f2870503329083fb9fe1f861316499d789757c2f5a5f91d2826e329`  
		Last Modified: Sat, 02 Sep 2023 08:39:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8282ce5c9d0b6cc76dbe9f55b9f5600a3608d9b0035da868cef28ddfdcae160d`  
		Last Modified: Sat, 02 Sep 2023 08:39:12 GMT  
		Size: 18.5 MB (18507081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:f03c73b60125c24cd0d498c5a6f742bb188975aa9b385710a9add8a7b6a1db84
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52100362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6280e9315000a72304cda50c3a3006def0083122bb7174fd424776bfacebe05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 08:02:18 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:02:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:02:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77d53f4c4eac56023c66b82c6abaa645478154b659568c84f71a48356ec1433b`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5be43ff2a2c1bdf45b91b17e3f17be137021ab60b618177dcec24996974bc6e4`  
		Last Modified: Sat, 02 Sep 2023 08:21:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aace4fd8029cb0bfaadaa852e86b6ae1b7dce6d68e1eff14f2b12d482220cff5`  
		Last Modified: Sat, 02 Sep 2023 08:21:51 GMT  
		Size: 18.5 MB (18507332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
