...
```console
$ docker pull drupal@sha256:e1d496da7665cbf0c5e3347194499473d6262e78f7cf61d3e60597212c9cda6e
```
...
### `drupal:9.0.7` - linux; amd64

```console
$ docker pull drupal@sha256:a0455e88f08a23e0cb9fb8b55f255ee072d7ab374788f6ac188002b7596296ab
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.5 MB (166519437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d6aa037d10c2e7194e0820789d34500ef4e8e0989d061cfcdab7828b8becbf6`
...
# Fri, 06 Nov 2020 02:51:43 GMT
WORKDIR /opt/drupal
# Fri, 06 Nov 2020 02:52:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Nov 2020 02:52:06 GMT
...
-	Layers:
	...
	-	`sha256:162e2df8986776428b070fd64c6fbde6c2fc14dc1a6cb19ad28826f5dd07c668`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36445c5f48ddd1338d89cc2266d73362b75edffac3393d7bfce82e5f8ca5f933`  
		Last Modified: Fri, 06 Nov 2020 02:58:50 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43ff40c1ac869ec749399564096303d8e0fb38de1714ad119827d87ad67d069`  
		Last Modified: Fri, 06 Nov 2020 02:58:57 GMT  
		Size: 17.2 MB (17227497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.7` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e93d4bc14e66e0c86bee7821ee57eda2f94e41d6efb7a295bd0d2463add9ee3b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141769523 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85f392f6a6fe65da95af63c65757b655fb72e30f2e2848219fb72ba4f8974506`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 18 Nov 2020 19:56:22 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 19:57:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 19:57:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:efff0c09bdc7c99db064cc0eff5023aafc53967d43575e26f05cca84929f24b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a81a72e3b13036d40a6a219aea86b0f5769a762fea09ab96aadd5d0b7389d500`  
		Last Modified: Wed, 18 Nov 2020 20:05:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b557a3e94e2c30862dd16e8134c29e9d2605d225354e360a836bbd4b51444d6`  
		Last Modified: Wed, 18 Nov 2020 20:05:58 GMT  
		Size: 17.2 MB (17227795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.7` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e6fb40033680fbdc5bc07aa8e52a8e0a3cf95dcb2c43fc4064b3638846488f51
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.5 MB (158463643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf3dd76251735806826f10d8427965038204fca95405fea38b93fba3da0905c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 18 Nov 2020 23:28:39 GMT
ENV DRUPAL_VERSION=9.0.7
# Wed, 18 Nov 2020 23:28:40 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 23:29:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 23:29:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0a1004de4cdc71183b18af5375d70785a47d5ccab7aeabe7875ef58fe70bce0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6842df90f1b8614229c822178759022d4b3d10cfdfc7d81cde6f57a5d70aa13b`  
		Last Modified: Wed, 18 Nov 2020 23:36:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99b51919d686a2e6aa8165b7763d80a5835d5a52f4892fb778c72dc6e5f7aa01`  
		Last Modified: Wed, 18 Nov 2020 23:36:35 GMT  
		Size: 17.2 MB (17227876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.7` - linux; 386

```console
$ docker pull drupal@sha256:630966f38ad7ed809d1f11f924aa5f756348d22577127e1bc5debf001bb89279
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172399919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afccd1cdcc216fc75322d31eeefad621528c7d897b81b79bafcf6deed0a4aa76`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 18 Nov 2020 16:46:25 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 16:46:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 16:46:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f22592de3126196ba47ddf35d1984b28cb0c16e460527cecb517c767767f7902`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:506b7eb083a34d0df608d2ecc30b176473af70b2f7703e45ad607e06169846b7`  
		Last Modified: Wed, 18 Nov 2020 16:51:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0b7dec4558e9df82a1a69f305d641f3f667a4b82b1fc19aa0926aeff437f4c9`  
		Last Modified: Wed, 18 Nov 2020 16:51:47 GMT  
		Size: 17.2 MB (17227106 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.7` - linux; ppc64le

```console
$ docker pull drupal@sha256:3528bd41d42841e693a3809bb8cce16d5a1c66ccd2f2c86012c07fe7fb1b72f3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.0 MB (177989976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f10b473a22202074e473e30c53bb046d5b62206801c2d538b9bf66988aa05c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Fri, 06 Nov 2020 00:25:20 GMT
ENV DRUPAL_VERSION=9.0.7
# Fri, 06 Nov 2020 00:25:26 GMT
WORKDIR /opt/drupal
# Fri, 06 Nov 2020 00:26:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Nov 2020 00:26:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84105e8c5a135c6309b0db0d7e1d7de55d4a7d9f376e23f5b9b1c66eceb2aab2`  
		...
		Size: 508.3 KB (508283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80018ac7e88866d6d60624aaeca6f8f70f52adc35172624c704255b9842d9c80`  
		Last Modified: Fri, 06 Nov 2020 00:49:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84c54ae860f0f6f849cb3c2e2e6dd7c3bd5372a21a8b7510b46ba12415f0f2fa`  
		Last Modified: Fri, 06 Nov 2020 00:51:18 GMT  
		Size: 17.2 MB (17227924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.7` - linux; s390x

```console
$ docker pull drupal@sha256:15f5bfdaab9de7e1c45b03513cca72a965351a862a6d2963b2e0061235c22623
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152068159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f283c50b8c2ac9528b29e87e437deedb2474c2e83e6cda0ce97339868db03072`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 18 Nov 2020 18:28:13 GMT
ENV DRUPAL_VERSION=9.0.7
# Wed, 18 Nov 2020 18:28:14 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 18:28:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 18:29:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b2b5f2181748049f3e5bcf2a63365fc65be772722279af1a6ec9e28a0dbe846`  
		...
		Size: 508.3 KB (508282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:948d9acf7fd4ddb7c7c527cd6bf217b18bab950c677e52f19b8a09fbc315e76a`  
		Last Modified: Wed, 18 Nov 2020 18:37:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92c77045c218ac8746732627a1d0f7fe30a80e921958cbc435399649b6ef147c`  
		Last Modified: Wed, 18 Nov 2020 18:37:06 GMT  
		Size: 17.2 MB (17228011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
