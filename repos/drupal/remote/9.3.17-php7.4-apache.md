...
```console
$ docker pull drupal@sha256:32ed2495f19c9fbb6310eb1368544ed0805328c84d567ad049a72eabb2da85a2
```
...
```console
$ docker pull drupal@sha256:58acfb6c61ea095e25cf88cf3fdb2ace90c0fe97a5559af8d0f84b9384494caa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157264153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a267e32a46cb62c4c63cac080ba999375da5a04354923d6b84a416fc890adb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:29:41 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 02:08:10 GMT
ENV DRUPAL_VERSION=9.3.17
# Wed, 22 Jun 2022 02:08:11 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 02:08:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 02:08:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4aa5847ccc055f2b6a98d87355beb28de30009f3fe3a83e5ffff323a09b44c64`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b161dd9a040560b40456a14e0dc3ca7f0eb106fecd2edf815e66d74e7fef4889`  
		Last Modified: Fri, 10 Jun 2022 07:35:20 GMT  
		Size: 669.8 KB (669841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02c0df304cfb0e5b349e2efb98f0c51b7fb1f760131be6976d246759226d977a`  
		Last Modified: Wed, 22 Jun 2022 03:12:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffe4d2053f9c9a9826cc051cb4608fa3efe35317933749787f294f82c32be8e7`  
		Last Modified: Wed, 22 Jun 2022 03:13:11 GMT  
		Size: 21.2 MB (21208149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
