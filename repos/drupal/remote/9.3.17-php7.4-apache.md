...
```console
$ docker pull drupal@sha256:a7345f5b7628420587e501218f6ce137463411421bb1522a8a23f3b0ed18eed3
```
...
```console
$ docker pull drupal@sha256:28738103f15c1f2f7c43af2d69afb9f971caeff6737465134fff77084fa2ab98
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179856924 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:261a83dbf6487dae19d1ef24b1085612396a661c47a8cc39702898bc6e0284e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 06:09:50 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 01:28:14 GMT
ENV DRUPAL_VERSION=9.3.17
# Wed, 22 Jun 2022 01:28:14 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 01:28:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 01:28:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5056a4686b21f34385dfeaf590d444b575e8ea628283edde8e4527fbe165bf71`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e69dac71944c13d1da115d9f42452d9881236f09d7473bed74ba9201cc32d91`  
		Last Modified: Fri, 10 Jun 2022 06:43:15 GMT  
		Size: 669.8 KB (669840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e4c93c94717712a061072a726ef2160c6976b93e6538354a2cb99cba13788f`  
		Last Modified: Wed, 22 Jun 2022 02:00:39 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e62d0b2dc46224eaa8c49ec85cbb9b1bd7c964e012c32191841aeca3e2c70cf`  
		Last Modified: Wed, 22 Jun 2022 02:00:45 GMT  
		Size: 21.2 MB (21207591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
