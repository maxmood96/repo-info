...
```console
$ docker pull drupal@sha256:9f08306a7c4fe0bbc9f401d749a1d1c0e878b36f8a04a0b86bdac30bc0de49f2
```
...
```console
$ docker pull drupal@sha256:bce3c57cded37723702ea647d8488fb797e75f87f2ece920f82d56a6654e540c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188083473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5a82de00cd6d780102265307272d9a03204e6392974023c1571bb40ab3bbb8f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 06:42:06 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Wed, 22 Jun 2022 01:12:32 GMT
ENV DRUPAL_VERSION=9.3.17
# Wed, 22 Jun 2022 01:12:36 GMT
WORKDIR /opt/drupal
# Wed, 22 Jun 2022 01:13:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 22 Jun 2022 01:13:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a427206b52d545be0f20de10692e0f5c83bf9153df0efadfe86684fd1c4ce79a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c443f4f6001ce9e2170dda837b280ae363d780322dc8b51a43cac05fae09a02`  
		Last Modified: Fri, 10 Jun 2022 07:59:14 GMT  
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96ef169b2594c67e14aa9a773e5a62f83cac1587998eb9059b74592dffb4c969`  
		Last Modified: Wed, 22 Jun 2022 02:48:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:737fda79a1140237d91d405487765ae33bbac44452c53ed0280b617d52954411`  
		Last Modified: Wed, 22 Jun 2022 02:50:38 GMT  
		Size: 21.2 MB (21208059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
